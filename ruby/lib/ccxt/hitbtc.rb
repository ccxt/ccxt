...
module Ccxt
  class Hitbtc < Exchange
    ...
    def fetch_markets(params = {})
      ...
      result = []
      for p in (0...markets['symbols'].length)
    ...
    def fetch_balance(params = {})
      ...
      response = self.send_wrapper(method, query)
    ...
    def fetch_order_book(symbol, limit = nil, params = {})
      self.load_markets
      orderbook = self.publicGetSymbolOrderbook(self.shallow_extend({
    ...
    def fetch_ticker(symbol, params = {})
      ...
      ticker = self.publicGetSymbolTicker(self.shallow_extend({
        'symbol' => market['id']
      }, params))
      if ticker.include?('message')
    ...
    def parse_public_trade(trade, market = nil)
      symbol = nil
      if market
        symbol = market['symbol']
      end
    ...
    def parse_order_trade(trade, market = nil)
      symbol = nil
      if market
        symbol = market['symbol']
      end
    ...
    def fetch_trades(symbol, since = nil, limit = nil, params = {})
      ...
      response = self.publicGetSymbolTrades(self.shallow_extend(request, params))
    ...
    def create_order(symbol, type, side, amount, price = nil, params = {})
      ...
      quantity = parse_float(amount) / market['lot']
      wholeLots = quantity.round
      difference = quantity - wholeLots
      if difference.abs > market['step']
        raise(ExchangeError, self.id + ' order amount should be evenly divisible by lot unit size of ' + market['lot'].to_s)
      end
      clientOrderId = self.milliseconds
      request = {
        'clientOrderId' => clientOrderId.to_s,
        'symbol' => market['id'],
        'side' => side,
        'quantity' => wholeLots.to_s, # quantity in integer lot units
        'type' => type
      }
      if type == 'limit'
      ...
      response = self.tradingPostNewOrder(self.shallow_extend(request, params))
    ...
    def cancel_order(id, symbol = nil, params = {})
      self.load_markets
      return self.tradingPostCancelOrder(self.shallow_extend({
        'clientOrderId' => id
      }, params))
    end
    ...
    def parse_order(order, market = nil)
      ...
      filled = nil
      cost = nil
      amountDefined = (amount != nil)
      remainingDefined = (remaining != nil)
      if market != nil
        symbol = market['symbol']
        if amountDefined
          amount *= market['lot']
    ...
    def fetch_order(id, symbol = nil, params = {})
      self.load_markets
      response = self.tradingGetOrder(self.shallow_extend({
        'clientOrderId' => id
      }, params))
    ...
    def fetch_open_orders(symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = self.tradingGetOrdersActive(self.shallow_extend(request, params))
    ...
    def fetch_closed_orders(symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = self.tradingGetOrdersRecent(self.shallow_extend(request, params))
      return self.parse_orders(response['orders'], market, since, limit)
    end
    ...
    def fetch_order_trades(id, symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = self.tradingGetTradesByOrder(self.shallow_extend({
        'clientOrderId' => id
      }, params))
      return self.parse_trades(response['trades'], market, since, limit)
    end
    ...
    def withdraw(code, amount, address, tag = nil, params = {})
      ...
      response = self.paymentPostPayout(self.shallow_extend(request, params))
      return {
        'info' => response,
    ...
    def sign(path, api = 'public', method = 'GET', params = {}, headers = nil, body = nil)
      ...
      if api == 'public'
        ...
        query = self.shallow_extend(payload, query)
        if method == 'GET'
          url += '?' + self.urlencode(query)
        else
        ...
        headers = {
          ...
          'X-Signature' => self.hmac(self.encode(auth), self.encode(self.secret), 'sha512').downcase
        }
      end
    ...
    def request(path, api = 'public', method = 'GET', params = {}, headers = nil, body = nil)
      ...
      if response.include?('code')
        if response.include?('ExecutionReport')
