  ...
  class Hitbtc2 < Hitbtc
    ...
    def fetch_markets(params = {})
      ...
      for i in (0...markets.length)
        ...
        precision = {
          ...
          'amount' => -1 * parse_int(Math.log10(lot))
        }
    ...
    def fetch_currencies(params = {})
      ...
      for i in (0...currencies.length)
        ...
        if currency.include?('disabled')
          if currency['disabled']
            active = false
          end
        end
        type = 'fiat'
        if currency.include?(('crypto')) && currency['crypto']
          type = 'crypto'
        end
        result[code] = {
          'id' => id,
    ...
    def fetch_balance(params = {})
      ...
      balances = self.send_wrapper(method, query)
      ...
      for b in (0...balances.length)
        ...
        account = {
          ...
          'used' => parse_float(balance['reserved']),
          'total' => 0.0
        }
    ...
    def parse_ohlcv(ohlcv, market = nil, timeframe = '1d', since = nil, limit = nil)
      ...
      return [
        ...
        parse_float(ohlcv['max']),
        parse_float(ohlcv['min']),
    ...
    def fetch_ohlcv(symbol, timeframe = '1m', since = nil, limit = nil, params = {})
      ...
      response = self.publicGetCandlesSymbol(self.shallow_extend(request, params))
    ...
    def fetch_order_book(symbol, limit = nil, params = {})
      ...
      if limit != nil
        request['limit'] = limit
      end # default = 100, 0 = unlimited
      orderbook = self.publicGetOrderbookSymbol(self.shallow_extend(request, params))
      return self.parse_order_book(orderbook, nil, 'bid', 'ask', 'price', 'size')
    end
    ...
    def parse_trade(trade, market = nil)
      ...
      orderId = nil
      if trade.include?('clientOrderId')
    ...
    def fetch_transactions(code = nil, since = nil, limit = nil, params = {})
      ...
      response = self.privateGetAccountTransactions(self.shallow_extend(request, params))
    ...
    def edit_order(id, symbol, type, side, amount = nil, price = nil, params = {})
      ...
      response = self.privatePatchOrderClientOrderId(self.shallow_extend(request, params))
      order = self.parse_order(response)
    ...
    def cancel_order(id, symbol = nil, params = {})
      self.load_markets
      response = self.privateDeleteOrderClientOrderId(self.shallow_extend({
        'clientOrderId' => id
      }, params))
    ...
    def fetch_order(id, symbol = nil, params = {})
      self.load_markets
      response = self.privateGetHistoryOrder(self.shallow_extend({
        'clientOrderId' => id
      }, params))
    ...
    def fetch_open_order(id, symbol = nil, params = {})
      self.load_markets
      response = self.privateGetOrderClientOrderId(self.shallow_extend({
        'clientOrderId' => id
      }, params))
      return self.parse_order(response)
    end
    ...
    def fetch_closed_orders(symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = self.privateGetHistoryOrder(self.shallow_extend(request, params))
    ...
    def fetch_my_trades(symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = self.privateGetHistoryTrades(self.shallow_extend(request, params))
      #
      #     [
      #         {
      #         "id" => 9535486,
    ...
    def fetch_order_trades(id, symbol = nil, since = nil, limit = nil, params = {})
      ...
      response = self.privateGetHistoryOrderIdTrades(self.shallow_extend({
        'id' => id
      }, params))
      numOrders = response.length
      if numOrders > 0
    ...
    def withdraw(code, amount, address, tag = nil, params = {})
      ...
      response = self.privatePostAccountCryptoWithdraw(self.shallow_extend(request, params))
      return {
        'info' => response,
        'id' => response['id']
      }
