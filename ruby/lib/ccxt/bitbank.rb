...
module Ccxt
  class Bitbank < Exchange
    ...
    def fetch_order_book(symbol, limit = nil, params = {})
      self.load_markets
      response = self.publicGetPairDepth(self.shallow_extend({
    ...
    def parse_trade(trade, market = nil)
      ...
      fee = nil
      if trade.include?('fee_amount_quote')
        fee = {
    ...
    def fetch_trades(symbol, since = nil, limit = nil, params = {})
      self.load_markets
      market = self.market(symbol)
      trades = self.publicGetPairTransactions(self.shallow_extend({
        'pair' => market['id']
      }, params))
    ...
    def fetch_ohlcv(symbol, timeframe = '5m', since = nil, limit = nil, params = {})
      ...
      date = self.ymd(date)
      date = date.split('-')
      response = self.publicGetPairCandlestickCandletypeYyyymmdd(self.shallow_extend({
        'pair' => market['id'],
    ...
    def fetch_balance(params = {})
      ...
      for i in (0...balances.length)
        ...
        account = {
          'free' => parse_float(balance['free_amount']),
          'used' => parse_float(balance['locked_amount']),
          'total' => parse_float(balance['onhand_amount'])
        }
        result[code] = account
      end
    ...
    def parse_order(order, market = nil)
      ...
      symbol = nil
      if marketId && !market && (self.marketsById.include?(marketId))
      ...
      if status == 'FULLY_FILLED'
        status = 'closed'
      elsif status == 'CANCELED_UNFILLED' || status == 'CANCELED_PARTIALLY_FILLED'
        status = 'canceled'
      else
        status = 'open'
      end
    ...
    def create_order(symbol, type, side, amount, price = nil, params = {})
      ...
      response = self.privatePostUserSpotOrder(self.shallow_extend(request, params))
    ...
    def cancel_order(id, symbol = nil, params = {})
      self.load_markets
      market = self.market(symbol)
      response = self.privatePostUserSpotCancelOrder(self.shallow_extend({
        'order_id' => id,
        'pair' => market['id']
      }, params))
    ...
    def fetch_order(id, symbol = nil, params = {})
      self.load_markets
      market = self.market(symbol)
      response = self.privateGetUserSpotOrder(self.shallow_extend({
        'order_id' => id,
        'pair' => market['id']
      }, params))
    ...
    def fetch_open_orders(symbol = nil, since = nil, limit = nil, params = {})
      ...
      orders = self.privateGetUserSpotActiveOrders(self.shallow_extend(request, params))
    ...
    def fetch_my_trades(symbol = nil, since = nil, limit = nil, params = {})
      ...
      trades = self.privateGetUserSpotTradeHistory(self.shallow_extend(request, params))
    ...
    def fetch_deposit_address(code, params = {})
      ...
      response = self.privateGetUserWithdrawalAccount(self.shallow_extend({
        'asset' => currency['id']
      }, params))
    ...
    def withdraw(code, amount, address, tag = nil, params = {})
      if params.include?(!('uuid'))
        raise(ExchangeError, self.id + ' uuid is required for withdrawal')
      end
      self.load_markets
      currency = self.currency(code)
      response = self.privatePostUserRequestWithdrawal(self.shallow_extend({
        'asset' => currency['id'],
        'amount' => amount
      }, params))
      return {
