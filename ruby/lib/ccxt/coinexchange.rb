...
module Ccxt
  class Coinexchange < Exchange
    ...
    def fetch_ticker(symbol, params = {})
      ...
      ticker = self.publicGetGetmarketsummary(self.shallow_extend({
        'market_id' => market['id']
      }, params))
    ...
    def fetch_order_book(symbol, limit = nil, params = {})
      self.load_markets
      orderbook = self.publicGetGetorderbook(self.shallow_extend({
        'market_id' => self.market_id(symbol)
      }, params))
      return self.parse_order_book(orderbook['result'], nil, 'BuyOrders', 'SellOrders', 'Price', 'Quantity')
    end
