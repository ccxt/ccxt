...
To fetch historical orders or trades, the user will need to traverse the data in portions or “pages” or objects. Pagination often implies *“fetching portions of data one by one”* in a loop.
