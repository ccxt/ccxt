...
- **Free software** means CCXT is free to use and has no hidden fees, when using CCXT traders pay the same trading fees they would pay to the exchanges directly.
