...
A `JavaScript` / `Python` / `PHP` / `C#` / `Go` library for cryptocurrency trading and e-commerce with support for many bitcoin, ether, and altcoin exchange markets and merchant APIs.
