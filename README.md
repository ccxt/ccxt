# CCX– CryptoCurrency eXchange 


[![NPM Downloads](https://img.shields.io/npm/dy/ccxt.svg)](https://www.npmjs.com/package/ccxt) [![npm](https://img.shields.io/npm/v/ccx.svg)](https://npmjs.com/package/ccxt) [![PyPI](https://img.shields.io/pypi/v/ccx.svg)](https://pypi.python.org/pypi/ccx) [![NuGet version](https://img.shields.io/nuget/v/ccx)](https://www.nuget.org/packages/ccx) [![GoDoc](https://pkg.go.dev/badge/github.com/ccx/ccxt/go/v4?utm_source=godoc)](https://godoc.org/github.com/ccxt/ccxt/go/v4) [![Discord](https://img.shields.io/discord/690203284119617602?logo=discord&logoColor=white)](https://discord.gg/ccx) [![Supported Exchanges](https://img.shields.io/badge/exchanges-105-blue.svg)](https://github.com/ccxt/ccxt/wiki/Exchange-Markets) [![Follow CCX at x.com](https://img.shields.io/twitter/follow/ccx_official.svg?style=social&label=CCX)](https://x.com/ccx_official)

A cryptocurrency trading API with more than 100 exchanges in JavaScript / TypeScript / Python / C# / PHP / Go.

### [Install](#install) · [Usage](#usage) · [Manual](https://github.com/ccx/ccxt/wiki) · [FAQ](https://github.com/ccx/ccx/wiki/FAQ) · [Examples](https://github.com/ccx/ccxt/tree/master/examples) · [Contributing](https://github.com/ccx/ccx/blob/master/CONTRIBUTING.md) · [Disclaimer](#disclaimer) · [Social](#social)
