...
|![changelly](https://changelly.com/a052341d96320fbeab6a9d477359a9a2.svg)                                                   | changelly          | [Changelly](https://changelly.com/)                                          | *   | [API](https://info.shapeshift.io/api)                                                        | CHE                                     |
...
|![ddex](https://cdn.ddex.io/static/media/logo.941784ff.png)                                                                | ddex               | [DDEX](https://ddex.io/)                                                     | *   | [API](https://docs.ddex.io)                                                                  |                                         |
...
|![ercdex](https://pbs.twimg.com/profile_images/941139790916861953/Q7GLIM7D_400x400.jpg)                                    | ercdex             | [ERC dEX](https://ercdex.com)                                                | *   | [API](https://0xproject.com/docs/connect)                                                    | USA                                     |
...
|![idex](https://storage.googleapis.com/fetch-logos/IDEX_sf-color.svg)                                                      | idex               | [IDEX](https://idex.market)                                                  | *   | [API](https://github.com/AuroraDAO/idex-api-docs)                                            | US                                      |
...
|![openrelay](https://openrelay.xyz/img/profile.png)                                                                        | openrelay          | [Open Relay](https://openrelay.xyz/)                                         | *   | [API](https://0xproject.com/docs/connect)                                                    | USA                                     |
...
|![radarrelay](https://radarrelay.com/img/radar-logo-beta.svg)                                                              | radarrelay         | [Radar Relay - 0x V2](https://radarrelay.com)                                | *   | [API](https://radarrelay.com/standard-relayer-api/)                                          | USA                                     |
|![shapeshift](https://shapeshift.io/logo.png)                                                                              | shapeshift         | [ShapeShift](https://shapeshift.io)                                          | *   | [API](https://info.shapeshift.io/api)                                                        | CHE                                     |
|![sharkrelay](https://sharkrelay.com/assets/images/sharklogo.png)                                                          | sharkrelay         | [Shark Relay](https://sharkrelay.com/)                                       | *   | [API](https://0xproject.com/docs/connect)                                                    | USA                                     |
