...
[Installation](#installation) | [Usage](#usage) | [Documentation](https://github.com/kroitor/ccxt/wiki) | [Public Offer](https://github.com/kroitor/ccxt/blob/master/OFFER.md)
...
- `ccxt.py` in Python (works in both Python 2 and 3)
- `ccxt.php` in PHP
