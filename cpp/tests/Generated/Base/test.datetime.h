...
void testIso8601() {
  ...
  assertTrue(isEqual(exchange.iso8601(514862627000),
                     std::string("1986-04-26T01:23:47.000Z")));
  assertTrue(isEqual(exchange.iso8601(514862627559),
                     std::string("1986-04-26T01:23:47.559Z")));
  assertTrue(isEqual(exchange.iso8601(514862627062),
  ...
  assertTrue(
      isEqual(exchange.iso8601(1000), std::string("1970-01-01T00:00:01.000Z")));
  assertTrue(
      isEqual(exchange.iso8601(1001), std::string("1970-01-01T00:00:01.001Z")));
  assertTrue(isEqual(exchange.iso8601(86399999),
                     std::string("1970-01-01T23:59:59.999Z")));
  assertTrue(isEqual(exchange.iso8601(86400000),
                     std::string("1970-01-02T00:00:00.000Z")));
  // millisecond zero-padding
  assertTrue(isEqual(exchange.iso8601(1755432123005),
                     std::string("2025-08-17T12:02:03.005Z")));
  assertTrue(isEqual(exchange.iso8601(1755432123050),
                     std::string("2025-08-17T12:02:03.050Z")));
  assertTrue(isEqual(exchange.iso8601(1755432123099),
                     std::string("2025-08-17T12:02:03.099Z")));
  assertTrue(isEqual(exchange.iso8601(1755432123500),
                     std::string("2025-08-17T12:02:03.500Z")));
  assertTrue(isEqual(exchange.iso8601(1755432123999),
                     std::string("2025-08-17T12:02:03.999Z")));
  // year rollovers, incl. out of a 366-day leap year
  assertTrue(isEqual(exchange.iso8601(1704067199999),
                     std::string("2023-12-31T23:59:59.999Z")));
  assertTrue(isEqual(exchange.iso8601(1704067200000),
                     std::string("2024-01-01T00:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1735689599999),
                     std::string("2024-12-31T23:59:59.999Z")));
  assertTrue(isEqual(exchange.iso8601(1735689600000),
                     std::string("2025-01-01T00:00:00.000Z")));
  // month lengths and boundaries
  assertTrue(isEqual(exchange.iso8601(1706702400000),
                     std::string("2024-01-31T12:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1706788800000),
                     std::string("2024-02-01T12:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1677585600000),
                     std::string("2023-02-28T12:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1677672000000),
                     std::string("2023-03-01T12:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1714521599999),
                     std::string("2024-04-30T23:59:59.999Z")));
  assertTrue(isEqual(exchange.iso8601(1714521600000),
                     std::string("2024-05-01T00:00:00.000Z")));
  // leap days: regular leap years, leap centuries and non-leap centuries
  assertTrue(isEqual(exchange.iso8601(68169600000),
                     std::string("1972-02-29T00:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1709164799999),
                     std::string("2024-02-28T23:59:59.999Z")));
  assertTrue(isEqual(exchange.iso8601(1709164800000),
                     std::string("2024-02-29T00:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(1709251199999),
                     std::string("2024-02-29T23:59:59.999Z")));
  assertTrue(isEqual(exchange.iso8601(1709251200000),
                     std::string("2024-03-01T00:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(951782400000),
                     std::string("2000-02-29T00:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(951868800000),
                     std::string("2000-03-01T00:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(4107499200000),
                     std::string("2100-02-28T12:00:00.000Z")));
  assertTrue(isEqual(exchange.iso8601(4107585600000),
                     std::string("2100-03-01T12:00:00.000Z")));
  // others
  // zero is a valid timestamp
  assertTrue(
      isEqual(exchange.iso8601(0), std::string("1970-01-01T00:00:00.000Z")));
...
void testParse8601() {
  ...
  assertTrue(
      isEqual(exchange.parse8601(std::string("1986-04-26T01:23:47.000Z")),
              514862627000));
  assertTrue(
      isEqual(exchange.parse8601(std::string("1986-04-26T01:23:47.559Z")),
              514862627559));
  assertTrue(
      isEqual(exchange.parse8601(std::string("1986-04-26T01:23:47.062Z")),
              514862627062));
  assertTrue(isEqual(exchange.parse8601(std::string("1986-04-26T01:23:47.06Z")),
                     514862627060));
...
void testParseDate() {
  ...
  assertTrue(isEqual(exchange.parseDate(std::string("1986-04-26 00:00:00")),
                     514857600000));
  assertTrue(
...
void testYyyymmdd() {
  ...
  assertTrue(
      isTrue(isGreaterThan(intNum, 20260000)) &&
      isTrue(isLessThan(intNum, 20360000))); // date between 2026 and 2036
}
void testYmd() {
  ccxt::Exchange exchange = ccxt::Exchange(ccxt::dict{
      {std::string("id"), std::string("sampleexchange")},
...
void testYmdhms() {
  ...
  assertTrue(
      ...
      isTrue(isEqual(
          value,
          std::string("2025-06-17_01:24:17")))); // todo: php/py rounds up to 17
}
void testDatetime() {
  testIso8601();
  testParse8601();
