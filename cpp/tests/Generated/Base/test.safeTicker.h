...
void testSafeTicker() {
  ...
  assertTrue(preciseEqualStr(exchange, result1, std::string("average"),
                             std::string("5.5")));
  assertTrue(preciseEqualStr(exchange, result1, std::string("close"),
                             std::string("6.0")));
  ...
  assertTrue(preciseEqualStr(exchange, result2, std::string("average"),
                             std::string("5.5")));
  assertTrue(preciseEqualStr(exchange, result2, std::string("close"),
                             std::string("6.0")));
  ...
  assertTrue(preciseEqualStr(exchange, result3, std::string("percentage"),
                             std::string("20.0")));
  assertTrue(preciseEqualStr(exchange, result3, std::string("average"),
                             std::string("5.5")));
  ...
  assertTrue(preciseEqualStr(exchange, result4, std::string("change"),
                             std::string("1.0")));
  assertTrue(preciseEqualStr(exchange, result4, std::string("average"),
                             std::string("5.5")));
  ...
  assertTrue(preciseEqualStr(exchange, result5, std::string("change"),
                             std::string("1.0")));
  assertTrue(preciseEqualStr(exchange, result5, std::string("close"),
                             std::string("6.0")));
  ...
  assertTrue(preciseEqualStr(exchange, result6, std::string("percentage"),
                             std::string("20.0")));
  assertTrue(preciseEqualStr(exchange, result6, std::string("close"),
                             std::string("6.0")));
  ...
  assertTrue(preciseEqualStr(exchange, result7, std::string("percentage"),
                             std::string("20.0")));
  assertTrue(preciseEqualStr(exchange, result7, std::string("average"),
                             std::string("5.5")));
  ...
  assertTrue(preciseEqualStr(exchange, result8, std::string("high"),
                             std::string("6.5")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("low"),
                             std::string("4.5")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("close"),
                             std::string("6.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("last"),
                             std::string("6.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("change"),
                             std::string("1.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("percentage"),
                             std::string("20.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("average"),
                             std::string("5.5")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("bid"),
                             std::string("5.9")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("bidVolume"),
                             std::string("100.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("ask"),
                             std::string("6.1")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("askVolume"),
                             std::string("200.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("vwap"),
                             std::string("5.75")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("baseVolume"),
                             std::string("1000.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("quoteVolume"),
                             std::string("5750.0")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("previousClose"),
                             std::string("4.9")));
  assertTrue(preciseEqualStr(exchange, result8, std::string("indexPrice"),
                             std::string("5.8")));
  ...
  assertTrue(preciseEqualStr(exchange, result9, std::string("percentage"),
                             std::string("0")));
  assertTrue(preciseEqualStr(exchange, result9, std::string("open"),
                             std::string("6.0")));
