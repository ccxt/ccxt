...
void testUuid() {
  ...
  assertTrue(isEqual(toString(id1), id1),
             std::string("uuid() must return a string"));
  assertTrue(isEqual(toString(id2), id2),
             std::string("uuid() must return a string"));
  assertTrue(
      isEqual(getStringLength(id1), 36),
      add(std::string(
              "uuid() must return a 36-character string, returned id1: "),
          id1));
  assertTrue(
      isEqual(getStringLength(id2), 36),
      add(std::string(
              "uuid() must return a 36-character string, returned id2: "),
          id2));
  ...
  assertTrue(!isEqual(id16a, id16b),
             add(add(add(std::string("uuid16() must return unique values on "
                                     "each call, returned id16a: "),
                         id16a),
                     std::string(", id16b: ")),
                 id16b));
  assertTrue(isEqual(toString(id16a), id16a),
             add(std::string("uuid16() must return a string, returned id16a: "),
                 id16a));
  assertTrue(isEqual(toString(id16b), id16b),
             add(std::string("uuid16() must return a string, returned id16b: "),
                 id16b));
  assertTrue(
      isEqual(getStringLength(id16a), 16),
      add(std::string(
              "uuid16() must return a 16-character string, returned id16a: "),
          id16a));
  assertTrue(
      isEqual(getStringLength(id16b), 16),
      add(std::string(
  ...
  assertTrue(isEqual(toString(id22a), id22a),
             add(std::string("uuid22() must return a string, returned id22a: "),
                 id22a));
  assertTrue(isEqual(toString(id22b), id22b),
             add(std::string("uuid22() must return a string, returned id22b: "),
                 id22b));
  assertTrue(
      isEqual(getStringLength(id22a), 22),
      add(std::string(
              "uuid22() must return a 22-character string, returned id22a: "),
          id22a));
  assertTrue(
      isEqual(getStringLength(id22b), 22),
      add(std::string(
              "uuid22() must return a 22-character string, returned id22b: "),
          id22b));
}
