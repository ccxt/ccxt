...
void testExtend() {
  ...
  assertTrue(isEqual(::getValue(obj1, std::string("a")), obj1SnapshotA),
             std::string("obj1.a was mutated after extend"));
  assertTrue(isEqual(::getValue(::getValue(obj1, std::string("b")), 0),
                     obj1SnapshotB0),
             std::string("obj1.b[0] was mutated after extend"));
  assertTrue(
      isEqual(::getValue(obj1, std::string("other1")), obj1SnapshotOther1),
      std::string("obj1['other1'] was mutated after extend"));
  // --- mutation check: obj2 must NOT be mutated ---
  assertTrue(isEqual(::getValue(obj2, std::string("a")), obj2SnapshotA),
             std::string("obj2.a was mutated after extend"));
  assertTrue(isEqual(::getValue(::getValue(obj2, std::string("b")), 0),
                     obj2SnapshotB0),
             std::string("obj2.b[0] was mutated after extend"));
  assertTrue(
      isEqual(::getValue(obj2, std::string("other2")), obj2SnapshotOther2),
  ...
  assertTrue(isEqual(::getValue(::getValue(extended2, std::string("b")), 0), 5),
             std::string("step2: b[0]"));
  assertTrue(isEqual(::getValue(::getValue(extended2, std::string("b")), 1), 6),
             std::string("step2: b[1]"));
  assertTrue(
      isEqual(::getValue(::getValue(::getValue(extended2, std::string("c")), 0),
                         std::string("test1")),
              3),
      std::string("step2: c[0].test1"));
  assertTrue(
      !isTrue((inOp(::getValue(::getValue(extended2, std::string("c")), 0),
                    std::string("test2")))),
      std::string("step2: c[0] should not have test2"));
  assertTrue(
      !isTrue((inOp(::getValue(::getValue(extended2, std::string("c")), 0),
                    std::string("test3")))),
      std::string("step2: c[0] should not have test3"));
  assertTrue(
      isEqual(::getValue(::getValue(::getValue(extended2, std::string("c")), 0),
                         std::string("test4")),
              4),
      std::string("step2: c[0].test4"));
  assertTrue(
      isEqual(::getValue(extended2, std::string("d")), std::string("step3")),
      std::string("step2: d"));
  assertTrue(isEqual(::getValue(extended2, std::string("e")),
                     std::string("back_to_string")),
             std::string("step2: e"));
  assertTrue(
      isEqual(::getValue(extended2, std::string("other1")), std::string("x")),
      std::string("step2: extended2['other1'] preserved"));
  assertTrue(
      isEqual(::getValue(extended2, std::string("other2")), std::string("y")),
      std::string("step2: extended2['other2'] preserved"));
  assertTrue(
      isEqual(::getValue(extended2, std::string("other3")), std::string("z")),
      std::string("step2: extended2['other3'] added"));
  // --- mutation check: first result must NOT be mutated by second extend ---
  assertTrue(isEqual(::getValue(extended, std::string("a")), 2),
             std::string("extended['a'] was mutated by second extend"));
  assertTrue(isEqual(::getValue(::getValue(extended, std::string("b")), 0), 3),
             std::string("extended['b'][0] was mutated by second extend"));
  assertTrue(
  ...
  assertTrue(isEqual(::getValue(r3, std::string("keep")), std::string("yes")),
             std::string("chain: r3['keep'] should be preserved"));
  assertTrue(isEqual(::getValue(r3, std::string("p1")), true),
             std::string("chain: r3['p1'] should be present"));
  assertTrue(isEqual(::getValue(r3, std::string("p2")), true),
             std::string("chain: r3['p2'] should be present"));
  assertTrue(isEqual(::getValue(r3, std::string("p3")), true),
             std::string("chain: r3['p3'] should be present"));
  // --- mutation check: each intermediate must be unaffected ---
  assertTrue(isEqual(::getValue(base, std::string("x")), 0),
             std::string("base['x'] was mutated during chain"));
  assertTrue(isEqual(::getValue(r1, std::string("x")), 1),
             std::string("r1['x'] was mutated during chain"));
  assertTrue(isEqual(::getValue(r2, std::string("x")), 2),
             std::string("r2['x'] was mutated during chain"));
  assertTrue(!isTrue((inOp(r1, std::string("p3")))),
             std::string("r1['p3'] leaked into r1"));
  assertTrue(!isTrue((inOp(base, std::string("p2")))),
  ...
  assertTrue(
      ...
      std::string("extend: extUndef['newKey'] should be added"));
  // original must not be touched
  assertTrue(
      isEqual(::getValue(withValues, std::string("keep1")), std::string("A")),
      std::string("withValues['keep1'] was mutated"));
  assertTrue(
...
void tbfeCheckExtended(ccxt::any extended, ccxt::any hasSub) {
  ...
  assertTrue(
      isEqual(::getValue(::getValue(::getValue(extended, std::string("c")), 0),
                         std::string("test1")),
              2));
  assertTrue(
      !isTrue((inOp(::getValue(::getValue(extended, std::string("c")), 0),
                    std::string("test2")))));
  assertTrue(
      isEqual(::getValue(::getValue(::getValue(extended, std::string("c")), 0),
                         std::string("test3")),
  ...
  assertTrue(
      isEqual(::getValue(extended, std::string("other2")), std::string("y")));
  if (isTrue(hasSub)) {
