...
ccxt::any helperStrToBinary(ccxt::any exchange, ccxt::any str);
...
void testBinaryToBase64() {
  ...
  ccxt::any binary9 = helperStrToBinary(exchange, std::string("123456"));
  assertTrue(
