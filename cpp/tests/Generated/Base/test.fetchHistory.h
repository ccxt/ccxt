...
std::shared_future<ccxt::any> testFetchHistoryBase() {
  return std::async(
             ...
             [=]() mutable -> ccxt::any {
               ...
               assertTrue(
                   isEqual(getArrayLength((exchange.getFetchCache())), 1),
                   std::string(
               ...
               assertTrue(
                   isEqual(getArrayLength((exchange.getFetchCache())), 2),
                   std::string(
...
//     https://api.coinbase.com/api/v3/brokerage/time assert
//     ((exchange.getFetchCache ()).length === 1, 'fetchHistoryCache should be
...
//     assert ((exchange.getFetchCache ()).length === 2, 'fetchHistoryCache
//     should be an array with 2 elements');
//     // third
//     await exchange.fetchTrades ('BTC/USD'); //
//     https://api.coinbase.com/api/v3/brokerage/market/products/BTC-USD/ticker
//     assert ((exchange.getFetchCache ()).length === 2, 'fetchHistoryCache
//     should be an array with 2 elements'); const finalCache =
//     exchange.getFetchCache (); assert
//     (finalCache[0]['request']['url'].toString () ===
//     'https://api.coinbase.com/api/v3/brokerage/market/product_book?product_id=BTC-USD',
//     'The first element in fetchHistoryCache is : ' +
//     finalCache[0]['request']['url']); assert
//     (finalCache[1]['request']['url'].toString () ===
//     'https://api.coinbase.com/api/v3/brokerage/market/products/BTC-USD/ticker',
