...
public:
  ...
  std::any sign(std::any path, std::any api = std::string("public"),
    ...
    if (isTrue(isEqual(api, std::string("private")))) {
      ...
      // the signed urlpath is the path relative to the base url of the product,
      // the spot and futures apis of every generation mount under /spot and
      // /futures and sign the /api/v... remainder, while the public-api wallet,
      // otc and markets endpoints mount on the bare host and sign the full path
