...
public:
  ...
  fetchMarkets(std::any params = ccxt::dict{}) override {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> std::any {
                 std::any response = awaitValue(this->publicGetCoins(params));
                 //
                 //     [
                 //         "BCH",
                 //         "BTC",
  ...
  fetchOrderBook(std::any symbol, std::any limit = std::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any response = awaitValue(this->publicGetCoinOrderbook(
  ...
  std::any parseTrade(std::any trade, std::any market = std::any{}) override {
    ...
    std::any id = this->safeString2(trade, std::string("tid"),
    ...
    std::any amount = this->safeString2(trade, std::string("amount"),
                                        std::string("quantity"));
    std::any feeCost = this->safeString(trade, std::string("fee_rate"));
    std::any fee = std::any{};
  ...
  fetchTrades(std::any symbol, std::any since = std::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any to = this->safeInteger(params, std::string("to"));
                 std::any response = std::any{};
                 if (isTrue(isTrue((!isEqual(since, std::any{}))) &&
                            isTrue((!isEqual(to, std::any{}))))) {
               ...
               [=]() mutable -> std::any {
                 ...
                 if (isTrue(isEqual(type, std::string("limit")))) {
                   ...
                   if (isTrue(isEqual(side, std::string("buy")))) {
                     ...
                     std::any cost = this->parseToNumeric(
  ...
  cancelOrder(std::any id, std::any symbol = std::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 //     }
                 //
                 std::any responseData = this->safeValue(
  ...
  std::any parseOrder(std::any order, std::any market = std::any{}) override {
    ...
    std::any order_type = this->safeString(order, std::string("order_type"));
    ...
    std::any marketId = this->safeString(order, std::string("coin_pair"));
    ...
    std::any filled = this->safeString(order, std::string("executed_quantity"));
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 if (isTrue(isEqual(code, std::string("BRL")))) {
                   ...
                   std::any tx_fee = (inOp(params, std::string("tx_fee")));
                   if (!isTrue(tx_fee)) {
                     throw ArgumentsRequired(toString(
                         add(add(this->id,
   ...
   */
  std::shared_future<std::any>
  fetchOHLCV(std::any symbol, std::any timeframe = std::string("15m"),
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any response = awaitValue(this->v4PublicNetGetCandles(
                     this->extend(request, params)));
  ...
  fetchOrders(std::any symbol = std::any{}, std::any since = std::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any response = awaitValue(this->privatePostListOrders(
                     this->extend(request, params)));
                 std::any responseData = this->safeValue(
                     response, std::string("response_data"), ccxt::dict{});
  ...
  fetchMyTrades(std::any symbol = std::any{}, std::any since = std::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any responseData = this->safeValue(
                     response, std::string("response_data"), ccxt::dict{});
                 std::any ordersRaw = this->safeValue(
                     responseData, std::string("orders"), ccxt::list{});
                 std::any orders =
                     this->parseOrders(ordersRaw, market, since, limit);
                 std::any trades = this->ordersToTrades(orders);
  ...
  virtual std::any ordersToTrades(std::any orders) {
    std::any result = ccxt::list{};
    for (std::any i = 0; isLessThan(i, getArrayLength(orders));
         postFixIncrement(i)) {
      std::any trades = this->safeValue(::getValue(orders, i),
                                        std::string("trades"), ccxt::list{});
      for (std::any y = 0; isLessThan(y, getArrayLength(trades));
           postFixIncrement(y)) {
