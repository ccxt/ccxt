...
#include "../api/bybitid.h"
#include "../base/Exchange.h"

namespace ccxt {

class bybitid : public bybitidApi {
public:
  using bybitidApi::bybitidApi;
  ccxt::any describe() override {
    ...
    return this->deepExtend(
        bybit::describe(),
        ccxt::dict{
            {std::string("id"), std::string("bybitid")},
            {std::string("name"), std::string("Bybit Indonesia")},
            {std::string("countries"), ccxt::list{std::string("ID")}},
            {std::string("hostname"), std::string("bybit.id")},
            ...
            {std::string("urls"),
             ccxt::dict{
                 ...
                 {std::string("www"), std::string("https://www.bybit.id")},
                 {std::string("doc"),
                  ccxt::list{
                      std::string(
