...
public:
  ...
  std::any describe() override {
    return this->deepExtend(
        blockchaincomApi::describe(),
        ccxt::dict{
            {std::string("id"), std::string("blockchaincom")},
            {std::string("secret"), std::any{}},
  ...
  fetchMarkets(std::any params = ccxt::dict{}) override {
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 //     }
                 //
                 std::any markets = awaitValue(this->publicGetSymbols(params));
                 ...
                 for (std::any i = 0; isLessThan(i, getArrayLength(marketIds));
                   ...
                   std::any market = this->safeValue(markets, marketId);
                   std::any baseId =
   ...
   */
  std::shared_future<std::any>
  fetchL3OrderBook(std::any symbol, std::any limit = std::any{},
                   std::any params = ccxt::dict{}) override {
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        ...
                        std::any response = awaitValue(this->publicGetL3Symbol(
  ...
  std::shared_future<std::any>
  fetchL2OrderBook(std::any symbol, std::any limit = std::any{},
                   std::any params = ccxt::dict{}) override {
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        if (isTrue(isEqual(this->markets, std::any{}))) {
                        ...
                        std::any response = awaitValue(this->publicGetL2Symbol(
                            this->extend(request, params)));
                        return this->parseOrderBook(
                            response, ::getValue(market, std::string("symbol")),
                            std::any{}, std::string("bids"),
  ...
  std::any parseTicker(std::any ticker, std::any market = std::any{}) override {
    ...
    std::any open = this->safeString(ticker, std::string("price_24h"));
  ...
  virtual std::any parseOrderState(std::any state) {
  ...
  std::any parseOrder(std::any order, std::any market = std::any{}) override {
    ...
    std::any type = this->safeStringLower(order, std::string("ordType"));
    std::any statusId = this->safeString(order, std::string("ordStatus"));
    std::any state = this->parseOrderState(statusId);
    std::any side = this->safeStringLower(order, std::string("side"));
    std::any marketId = this->safeString(order, std::string("symbol"));
    std::any symbol = this->safeSymbol(marketId, market, std::string("-"));
    std::any exchangeOrderId = this->safeString(order, std::string("exOrdId"));
    std::any price =
        (isTrue((!isEqual(type, std::string("market"))))
             ? std::any(this->safeString(order, std::string("price")))
             : std::any(std::any{}));
    std::any average = this->safeNumber(order, std::string("avgPx"));
    std::any timestamp = this->safeInteger(order, std::string("timestamp"));
    std::any datetime = this->iso8601(timestamp);
    std::any filled = this->safeString(order, std::string("cumQty"));
    std::any remaining = this->safeString(order, std::string("leavesQty"));
    std::any result = this->safeOrder(ccxt::dict{
  ...
  createOrder(std::any symbol, std::any type, std::any side, std::any amount,
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any uppercaseOrderType = toUpperCase(orderType);
                 ...
                 std::any priceRequired = false;
                 std::any stopPriceRequired = false;
  ...
  fetchCanceledOrders(std::any symbol = std::any{}, std::any since = std::any{},
    ...
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        std::any state = std::string("CANCELED");
  ...
  fetchClosedOrders(std::any symbol = std::any{}, std::any since = std::any{},
    ...
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        std::any state = std::string("FILLED");
                        return awaitValue(this->fetchOrdersByState(
                            state, symbol, since, limit, params));
                      })
        .share();
  ...
  std::any parseTrade(std::any trade, std::any market = std::any{}) override {
    ...
    //     }
    //
    std::any orderId = this->safeString(trade, std::string("exOrdId"));
  ...
  fetchMyTrades(std::any symbol = std::any{}, std::any since = std::any{},
    ...
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        ...
                        std::any trades = awaitValue(this->privateGetFills(
                            this->extend(request, params)));
  ...
  fetchDepositAddress(std::any code, std::any params = ccxt::dict{}) override {
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        ...
                        if (isTrue(!isEqual(rawAddress, std::any{}))) {
                          std::any addressParts =
  ...
  virtual std::any parseTransactionState(std::any state) {
    std::any states = ccxt::dict{
  ...
  std::any parseTransaction(std::any transaction,
    ...
    std::any state = this->safeString(transaction, std::string("state"));
    ...
    std::any feeCost =
        (isTrue((isEqual(type, std::string("withdrawal"))))
             ? std::any(this->safeNumber(transaction, std::string("fee")))
             : std::any(std::any{}));
    std::any fee = std::any{};
  ...
  fetchDeposit(std::any id, std::any code = std::any{},
    ...
    return std::async(std::launch::deferred,
                      [=]() mutable -> std::any {
                        ...
                        std::any depositId = this->safeString(
  ...
  fetchBalance(std::any params = ccxt::dict{}) override {
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any accountName = this->safeString(
                 ...
                 //     }
                 //
                 std::any balances = this->safeValue(response, accountName);
  ...
  std::any handleErrors(std::any code, std::any reason, std::any url,
    ...
    std::any text = this->safeString(response, std::string("text"));
    if (isTrue(!isEqual(text, std::any{}))) {
      if (isTrue(isEqual(text, std::string("Insufficient Balance")))) {
        throw InsufficientFunds(
            toString(add(add(this->id, std::string(" ")), body)));
      }
    }
    std::any errorCode = this->safeString(response, std::string("status"));
    std::any errorMessage = this->safeString(response, std::string("error"));
    if (isTrue(!isEqual(code, std::any{}))) {
      std::any feedback =
