...
public:
  ...
  std::any describe() override {
    return this->deepExtend(
        independentreserveApi::describe(),
        ccxt::dict{
  ...
  fetchMarkets(std::any params = ccxt::dict{}) override {
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any baseCurrencyIds = this->toArray(baseCurrencies);
                 std::any quoteCurrencyIds = this->toArray(quoteCurrencies);
                 for (std::any i = 0;
                      isLessThan(i, getArrayLength(baseCurrencyIds));
                      postFixIncrement(i)) {
                   std::any baseId = ::getValue(baseCurrencyIds, i);
                   std::any base = this->safeCurrencyCode(baseId);
                   std::any minAmount = this->safeNumber(limits, baseId);
                   for (std::any j = 0;
                        isLessThan(j, getArrayLength(quoteCurrencyIds));
                        postFixIncrement(j)) {
                     std::any quoteId = ::getValue(quoteCurrencyIds, j);
                     std::any quote = this->safeCurrencyCode(quoteId);
                     std::any id = add(add(baseId, std::string("/")), quoteId);
                     arrayPush(result,
                               ccxt::dict{
                                   {std::string("id"), id},
                                   {std::string("symbol"),
  ...
  std::any parseTicker(std::any ticker, std::any market = std::any{}) override {
    ...
    std::any defaultMarketId = std::any{};
  ...
  std::any parseOrder(std::any order, std::any market = std::any{}) override {
    ...
    } else if (isTrue(!isEqual(market, std::any{}))) {
    ...
    std::any filled = this->safeString(order, std::string("VolumeFilled"));
    std::any feeRate = this->safeString(order, std::string("FeePercent"));
    std::any feeCost = std::any{};
    if (isTrue(isTrue(!isEqual(feeRate, std::any{})) &&
  ...
  fetchOpenOrders(std::any symbol = std::any{}, std::any since = std::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> std::any {
                 ...
                 std::any response = awaitValue(this->privatePostGetOpenOrders(
                     this->extend(request, params)));
  ...
  fetchMyTrades(std::any symbol = std::any{}, std::any since = std::any{},
                std::any limit = 50, std::any params = ccxt::dict{}) override {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> std::any {
                 if (isTrue(isEqual(this->markets, std::any{}))) {
  ...
  std::any parseTrade(std::any trade, std::any market = std::any{}) override {
    ...
    std::any id = this->safeString(trade, std::string("TradeGuid"));
    std::any orderId = this->safeString(trade, std::string("OrderGuid"));
    std::any priceString =
    ...
    std::any price = this->parseNumber(priceString);
    ...
    std::any side = this->safeString(trade, std::string("OrderType"));
  ...
  std::any parseTransaction(std::any transaction,
    ...
    //    }
    //
    std::any amount = this->safeDict(transaction, std::string("Amount"));
    std::any destination =
    ...
    std::any address = this->safeString(destination, std::string("Address"));
    std::any tag = this->safeString(destination, std::string("Tag"));
  ...
  std::any sign(std::any path, std::any api = std::string("public"),
    ...
    if (isTrue(isEqual(api, std::string("public")))) {
      ...
      std::any auth = ccxt::list{url, add(std::string("apiKey="), this->apiKey),
      ...
      for (std::any i = 0; isLessThan(i, getArrayLength(keys));
        ...
        std::any value = toString(::getValue(params, key));
        arrayPush(auth, add(add(key, std::string("=")), value));
      }
      std::any message = join(auth, std::string(","));
      std::any signature =
