...
public:
  ...
  fetchCurrenciesFromWeb(ccxt::any params = ccxt::dict{}) {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> ccxt::any {
                 ccxt::any data = awaitValue(
  ...
  ccxt::any parseCurrency(ccxt::any rawCurrency) override {
    ccxt::any id = this->safeString(rawCurrency, 0);
    ...
    ccxt::any networkId = this->safeString(rawCurrency, 9);
  ...
  virtual std::shared_future<ccxt::any>
  fetchMarketsFromWeb(ccxt::any params = ccxt::dict{}) {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> ccxt::any {
                 ...
                 ccxt::any tables = split(data, std::string("tbody>"));
                 ccxt::any numTables = getArrayLength(tables);
                 ...
                 for (ccxt::any i = 1; isLessThan(i, numRows);
                      postFixIncrement(i)) {
                   ccxt::any row = ::getValue(rows, i);
                   ccxt::any cells = split(
                       row,
                       std::string("</td>\n")); // eslint-disable-line quotes
                   ccxt::any numCells = getArrayLength(cells);
                   ...
                   ccxt::any minAmountString =
                       replace(::getValue(cells, 1), std::string("<td>"),
                               std::string(""));
                   ccxt::any minAmountParts =
                       split(minAmountString, std::string(" "));
                   ccxt::any minAmount = this->safeNumber(minAmountParts, 0);
                   ccxt::any amountPrecisionString =
                       replace(::getValue(cells, 2), std::string("<td>"),
                               std::string(""));
                   ccxt::any amountPrecisionParts =
                       split(amountPrecisionString, std::string(" "));
                   ccxt::any idLength = subtract(getArrayLength(marketId), 0);
                   ccxt::any startingIndex = subtract(idLength, 3);
                   ccxt::any pricePrecisionString =
                       replace(::getValue(cells, 3), std::string("<td>"),
                               std::string(""));
                   ccxt::any pricePrecisionParts =
                       split(pricePrecisionString, std::string(" "));
                   ccxt::any quoteId = this->safeStringLower(
                       pricePrecisionParts, 1,
                       slice(marketId, startingIndex, idLength));
                   ccxt::any baseId = this->safeStringLower(
  ...
  virtual ccxt::any parseMarketActive(ccxt::any status) {
  ...
  virtual std::shared_future<ccxt::any>
  fetchUSDTMarkets(ccxt::any params = ccxt::dict{}) {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> ccxt::any {
                 ...
                 for (ccxt::any i = 0;
                      ...
                      postFixIncrement(i)) {
                   ccxt::any marketId = ::getValue(fetchUsdtMarkets, i);
  ...
  virtual std::shared_future<ccxt::any>
  fetchMarketsFromAPI(ccxt::any params = ccxt::dict{}) {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> ccxt::any {
                 ccxt::any marketIdsRaw =
                 ...
                 if (isTrue(this->safeBool(
                   ...
                   ccxt::any tradingPairs = this->safeList(
                       this->options, std::string("tradingPairs"));
                   if (isTrue(!isEqual(tradingPairs, ccxt::any{}))) {
                     ccxt::any indexedTradingPairs =
                         this->indexBy(tradingPairs, 0);
                     for (ccxt::any i = 0;
                          isLessThan(i, getArrayLength(marketIds));
                          postFixIncrement(i)) {
                       ccxt::any marketId = ::getValue(marketIds, i);
                       ccxt::any pairInfo = this->safeList(
  ...
  ccxt::any parseMarket(ccxt::any response) override {
    //
    // response might be:
    //
    //     btcusd
    ...
    if (isTrue(!isTrue(isString) && !isTrue(isArrayFlag))) {
      ...
      ccxt::any marketIdUpper = toUpperCase(marketId);
      ccxt::any isPerp = (isGreaterThanOrEqual(
          getIndexOf(marketIdUpper, std::string("PERP")), 0));
      ccxt::any marketIdWithoutPerp =
          replace(marketIdUpper, std::string("PERP"), std::string(""));
      ccxt::any conflictingMarkets = this->safeDict(
          this->options, std::string("conflictingMarkets"), ccxt::dict{});
      ccxt::any lowerCaseId = toLowerCase(marketIdWithoutPerp);
      if (isTrue(inOp(conflictingMarkets, lowerCaseId))) {
        ccxt::any conflictingMarket =
        ...
        for (ccxt::any i = 0; isLessThan(i, getArrayLength(quoteCurrencies));
             postFixIncrement(i)) {
          ccxt::any quoteCurrency = ::getValue(quoteCurrencies, i);
          if (isTrue(endsWith(marketIdWithoutPerp, quoteCurrency))) {
            ccxt::any quoteLength =
  ...
  fetchOrderBook(ccxt::any symbol, ccxt::any limit = ccxt::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> ccxt::any {
                 ...
                 ccxt::any response = awaitValue(this->publicGetV1BookSymbol(
                     this->extend(request, params)));
  ...
  virtual std::shared_future<ccxt::any>
  fetchTickerV1(ccxt::any symbol, ccxt::any params = ccxt::dict{}) {
    return std::async(std::launch::deferred,
                      [=]() mutable -> ccxt::any {
                        if (isTrue(isEqual(this->markets, ccxt::any{}))) {
                          awaitValue(this->loadMarkets());
  ...
  virtual std::shared_future<ccxt::any>
  fetchTickerV1AndV2(ccxt::any symbol, ccxt::any params = ccxt::dict{}) {
    return std::async(
               std::launch::deferred,
               [=]() mutable -> ccxt::any {
                 ccxt::any tickerPromiseA = this->fetchTickerV1(symbol, params);
                 ccxt::any tickerPromiseB = this->fetchTickerV2(symbol, params);
                 ccxt::any tickerAtickerBVariable = awaitValue(
                     promiseAll(ccxt::list{tickerPromiseA, tickerPromiseB}));
                 ccxt::any tickerA = ::getValue(tickerAtickerBVariable, 0);
                 ccxt::any tickerB = ::getValue(tickerAtickerBVariable, 1);
                 return this->deepExtend(
                     tickerA,
                     ccxt::dict{
                         {std::string("open"),
  ...
  ccxt::any parseTicker(ccxt::any ticker,
    ...
    ccxt::any baseVolume = this->safeString(volume, baseId);
    ccxt::any quoteVolume = this->safeString(volume, quoteId);
  ...
  fetchTickers(ccxt::any symbols = ccxt::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> ccxt::any {
                 ...
                 //     ]
                 //
                 ccxt::any result = this->parseTickers(response, symbols);
                 ccxt::any brokenPairs = this->safeList(
                     this->options, std::string("brokenPairs"), ccxt::list{});
  ...
  ccxt::any parseTrade(ccxt::any trade,
    ...
    //      }
    //
    ccxt::any timestamp = this->safeInteger(trade, std::string("timestampms"));
  ...
  fetchTrades(ccxt::any symbol, ccxt::any since = ccxt::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> ccxt::any {
                 ...
                 ccxt::any response = awaitValue(this->publicGetV1TradesSymbol(
                     this->extend(request, params)));
                 //
                 //     [
                 //         {
  ...
  fetchTradingFees(ccxt::any params = ccxt::dict{}) override {
    return std::async(
               ...
               [=]() mutable -> ccxt::any {
                 ...
                 //     }
                 //
                 ccxt::any makerBps = this->safeString(
                     response, std::string("api_maker_fee_bps"));
                 ccxt::any takerBps = this->safeString(
                 ...
                 ccxt::any maker = this->parseNumber(makerString);
                 ccxt::any taker = this->parseNumber(takerString);
                 ccxt::any result = ccxt::dict{};
  ...
  ccxt::any parseOrder(ccxt::any order,
    ...
    //      }
    //
    ccxt::any timestamp = this->safeInteger(order, std::string("timestampms"));
    ...
    if (isTrue(!isEqual(option, ccxt::any{}))) {
  ...
  fetchMyTrades(ccxt::any symbol = ccxt::any{}, ccxt::any since = ccxt::any{},
    ...
    return std::async(
               ...
               [=]() mutable -> ccxt::any {
                 ...
                 ccxt::any response = awaitValue(this->privatePostV1Mytrades(
                     this->extend(request, params)));
                 return this->parseTrades(response, market, since, limit);
               })
        .share();
  ...
  ccxt::any nonce() override {
    ccxt::any nonceMethod = this->safeString(
        this->options, std::string("nonce"), std::string("milliseconds"));
  ...
  std::shared_future<ccxt::any> fetchDepositsWithdrawals(
    ...
    return std::async(
               ...
               [=]() mutable -> ccxt::any {
                 ...
                 ccxt::any response = awaitValue(this->privatePostV1Transfers(
                     this->extend(request, params)));
  ...
  ccxt::any parseTransaction(ccxt::any transaction,
    ...
    ccxt::any statusRaw = this->safeString(transaction, std::string("status"));
    ccxt::any fee = ccxt::any{};
    ccxt::any feeAmount =
  ...
  ccxt::any sign(ccxt::any path, ccxt::any api = std::string("public"),
    ...
    if (isTrue(isEqual(api, std::string("private")))) {
      ...
      ccxt::any request = this->extend(
          ...
          query);
      ccxt::any payload = this->json(request);
  ...
  ccxt::any handleErrors(ccxt::any httpCode, ccxt::any reason, ccxt::any url,
    ...
    //     }
    //
    ccxt::any result = this->safeString(response, std::string("result"));
    if (isTrue(isEqual(result, std::string("error")))) {
      ccxt::any reasonInner = this->safeString(response, std::string("reason"));
