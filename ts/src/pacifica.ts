            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'info/fees': { 'cost': 1, 'returnType': 'Dict' },
                        'info/prices': { 'cost': 1, 'returnType': 'Dict' },
                        'kline': { 'cost': 12, 'returnType': 'Dict' },
                        'kline/mark': { 'cost': 12, 'returnType': 'Dict' },
                        'book': { 'cost': 1, 'returnType': 'Dict' },
                        'trades': { 'cost': 1, 'returnType': 'Dict' }, // Recent
                        'funding_rate/history': { 'cost': 1, 'returnType': 'Dict' },
                        'loan_pool': { 'cost': 1, 'returnType': 'Dict' },
                        'account': { 'cost': 1, 'returnType': 'Dict' },
                        'account/loan': { 'cost': 1, 'returnType': 'Dict' },
                        'account/settings': { 'cost': 1, 'returnType': 'Dict' },
                        'positions': { 'cost': 1, 'returnType': 'Dict' },
                        'trades/history': { 'cost': 12, 'returnType': 'Dict' },
                        'funding/history': { 'cost': 1, 'returnType': 'Dict' },
                        'portfolio': { 'cost': 1, 'returnType': 'Dict' },
                        'account/balance/history': { 'cost': 12, 'returnType': 'Dict' },
                        'account/spot_balance/history': { 'cost': 1, 'returnType': 'Dict' },
                        'account/spot_asset/deposit/history': { 'cost': 1, 'returnType': 'Dict' },
                        'account/spot_asset/withdraw/history': { 'cost': 1, 'returnType': 'Dict' },
                        'account/spot_asset/withdraw/pending': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/history': { 'cost': 12, 'returnType': 'Dict' },
                        'orders/history_by_id': { 'cost': 1, 'returnType': 'Dict' },
                        'spot_assets': { 'cost': 1, 'returnType': 'Dict' },
                        'spot_assets/bridge/info': { 'cost': 1, 'returnType': 'Dict' },
                        'spot_assets/bridge/parameters/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/list': { 'cost': 1, 'returnType': 'Dict' },
                        'account/builder_codes/approvals': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'private': {
                    'post': {
                        'account/leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'account/margin': { 'cost': 1, 'returnType': 'Dict' },
                        'account/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'account/settings/auto_lend_disabled': { 'cost': 1, 'returnType': 'Dict' },
                        'account/settings/spot': { 'cost': 1, 'returnType': 'Dict' },
                        'account/spot_asset/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'account/subaccount/create': { 'cost': 1, 'returnType': 'Dict' },
                        'account/subaccount/list': { 'cost': 1, 'returnType': 'Dict' },
                        'account/subaccount/transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'account/subaccount/spot_asset/transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/add_isolated_margin': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/create': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/create_market': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/stop/create': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/tpsl': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/cancel': { 'cost': 0.5, 'returnType': 'Dict' },
                        'orders/cancel_all': { 'cost': 0.5, 'returnType': 'Dict' },
                        'orders/stop/cancel': { 'cost': 0.5, 'returnType': 'Dict' },
                        'orders/edit': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/batch': { 'cost': 1, 'returnType': 'Dict' },
                        'account/builder_codes/approve': { 'cost': 1, 'returnType': 'Dict' },
                        'account/builder_codes/revoke': { 'cost': 1, 'returnType': 'Dict' },
                        'agent/bind': { 'cost': 1, 'returnType': 'Dict' },
                        'account/api_keys/create': { 'cost': 1, 'returnType': 'Dict' },
                        'account/api_keys/revoke': { 'cost': 1, 'returnType': 'Dict' },
                        'account/api_keys': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/add_blacklist': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/add_max_leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/add_whitelist': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/claim_manager': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/claim_referral_code': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/create': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/deposit': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/remove_blacklist': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/remove_max_leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/remove_whitelist': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/update_deposit_cap': { 'cost': 1, 'returnType': 'Dict' },
                        'lake/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
