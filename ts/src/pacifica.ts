...
import type { Market, TransferEntry, Balances, Int, OrderBook, OHLCV, Str, FundingRateHistory, Order, OrderType, OrderSide, Trade, Strings, Position, OrderRequest, Dict, NullableDict, Num, Bool, int, Transaction, Currency, TradingFeeInterface, LedgerEntry, FundingRates, FundingRate, OpenInterests, Leverage, MarginMode, Tickers, Ticker, FundingHistory, EndpointSpec, List } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'info/fees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'info/prices': { 'cost': 1 } as EndpointSpec<Dict>,
                        'kline': { 'cost': 12 } as EndpointSpec<Dict>,
                        'kline/mark': { 'cost': 12 } as EndpointSpec<Dict>,
                        'book': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades': { 'cost': 1 } as EndpointSpec<Dict>, // Recent
                        'funding_rate/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loan_pool': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/loan': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/settings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades/history': { 'cost': 12 } as EndpointSpec<Dict>,
                        'funding/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'portfolio': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/balance/history': { 'cost': 12 } as EndpointSpec<Dict>,
                        'account/spot_balance/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/spot_asset/deposit/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/spot_asset/withdraw/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/spot_asset/withdraw/pending': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/history': { 'cost': 12 } as EndpointSpec<Dict>,
                        'orders/history_by_id': { 'cost': 1 } as EndpointSpec<Dict>,
                        'spot_assets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'spot_assets/bridge/info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'spot_assets/bridge/parameters/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/builder_codes/approvals': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'post': {
                        'account/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/margin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/settings/auto_lend_disabled': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/settings/spot': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/spot_asset/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/subaccount/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/subaccount/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/subaccount/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/subaccount/spot_asset/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions/add_isolated_margin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/create_market': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/stop/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions/tpsl': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/cancel': { 'cost': 0.5 } as EndpointSpec<Dict>,
                        'orders/cancel_all': { 'cost': 0.5 } as EndpointSpec<Dict>,
                        'orders/stop/cancel': { 'cost': 0.5 } as EndpointSpec<Dict>,
                        'orders/edit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/builder_codes/approve': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/builder_codes/revoke': { 'cost': 1 } as EndpointSpec<Dict>,
                        'agent/bind': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/api_keys/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/api_keys/revoke': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/api_keys': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/add_blacklist': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/add_max_leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/add_whitelist': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/claim_manager': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/claim_referral_code': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/deposit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/remove_blacklist': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/remove_max_leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/remove_whitelist': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/update_deposit_cap': { 'cost': 1 } as EndpointSpec<Dict>,
                        'lake/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
