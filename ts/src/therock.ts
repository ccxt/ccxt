...
import { ExchangeError, ArgumentsRequired, BadRequest, OrderNotFound, InvalidAddress } from './base/errors.js';
...
export default class therock extends Exchange {
    ...
    async fetchOHLCV (symbol, timeframe = '1m', since = undefined, limit = undefined, params = {}) {
        ...
        const periodInMinutes = this.parseToInt (periodInSeconds / 60);
        const request = {
            'id': market['id'],
