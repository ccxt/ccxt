            ...
            'api': {
                'common': {
                    'get': {
                        ...
                        'api/v1/exchangeInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'quote/v1/depth': { 'cost': 1 } as EndpointSpec<Dict>, // todo: by limit 1-10
                        ...
                        'quote/v1/index/klines': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/indexPriceComponents': { 'cost': 1 } as EndpointSpec<Dict>,
                        'quote/v1/markPrice/klines': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/markPrice': { 'cost': 10 } as EndpointSpec<Dict>, // 5 requests per second
                        'quote/v1/index': { 'cost': 1 } as EndpointSpec<Dict>,
                        'quote/v1/ticker/24hr': { 'cost': 40 } as EndpointSpec<List>, // todo: 1-40 depending noSymbol
                        'quote/v1/contract/ticker/24hr': { 'cost': 40 } as EndpointSpec<List>, // todo: 1-40 depending noSymbol
                        'quote/v1/ticker/price': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/contract/ticker/price': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/ticker/bookTicker': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/contract/ticker/bookTicker': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/fundingRate': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/historyFundingRate': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/riskLimits': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'api/v1/account': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/account/checkApiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/spot/order': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/spot/openOrders': { 'cost': 1 * 1.67 } as EndpointSpec<List>,
                        'api/v1/futures/openOrders': { 'cost': 1 * 1.67 } as EndpointSpec<List>,
                        'api/v1/spot/tradeOrders': { 'cost': 5 * 1.67 } as EndpointSpec<List>,
                        'api/v1/futures/historyOrders': { 'cost': 5 * 1.67 } as EndpointSpec<List>,
                        'api/v1/account/trades': { 'cost': 5 * 1.67 } as EndpointSpec<List>,
                        'api/v1/account/balanceFlow': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/account/depositOrders': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/account/withdrawOrders': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/account/deposit/address': { 'cost': 1 } as EndpointSpec<Dict>,
                        // contracts
                        'api/v1/subAccount': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/account/subAccount': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/subAccount/list': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/futures/accountLeverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/order': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/positions': { 'cost': 5 * 1.67 } as EndpointSpec<List>,
                        'api/v1/futures/historyPositions': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/futures/balance': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/futures/userTrades': { 'cost': 5 * 1.67 } as EndpointSpec<List>,
                        'api/v1/futures/balanceFlow': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/futures/commissionRate': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/futures/todayPnl': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/account/download/detail': { 'cost': 10 } as EndpointSpec<Dict>,
                        'api/v1/agent/inviteUserList': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/commissionDataList': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/commissionDataInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/inviteRelationCheck': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/depositDetailList': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/querySubAgentData': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/spotOrdersList': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/futuresOrdersList': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/futuresPositionsList': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/invite-commission-detail': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/user/export': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/export-list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/agent/export-url': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'api/v1/spot/orderTest': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/spot/order': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/order': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/spot/batchOrders': { 'cost': 2 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/subAccount/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        ...
                        'api/v1/futures/batchOrders': { 'cost': 2 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/position/trading-stop': { 'cost': 3 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/positionMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/order/update': { 'cost': 2 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/autoAddMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/flashClose': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/reversePosition': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/account/download/apply': { 'cost': 1000 } as EndpointSpec<Dict>,
                        'api/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'api/v1/spot/order': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/order': { 'cost': 1 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/spot/openOrders': { 'cost': 5 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/batchOrders': { 'cost': 3 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/spot/cancelOrderByIds': { 'cost': 5 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/futures/cancelOrderByIds': { 'cost': 3 * 1.67 } as EndpointSpec<Dict>,
                        'api/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
