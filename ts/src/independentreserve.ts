    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'GetValidPrimaryCurrencyCodes': { 'cost': 1, 'returnType': 'List' },
                        'GetValidSecondaryCurrencyCodes': { 'cost': 1, 'returnType': 'List' },
                        'GetValidLimitOrderTypes': { 'cost': 1, 'returnType': 'List' },
                        'GetValidMarketOrderTypes': { 'cost': 1, 'returnType': 'List' },
                        'GetValidOrderTypes': { 'cost': 1, 'returnType': 'List' },
                        'GetValidTransactionTypes': { 'cost': 1, 'returnType': 'List' },
                        'GetMarketSummary': { 'cost': 1, 'returnType': 'Dict' },
                        'GetOrderBook': { 'cost': 1, 'returnType': 'Dict' },
                        'GetAllOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'GetTradeHistorySummary': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'private': {
                    'post': {
                        'GetOpenOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'GetClosedOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'GetClosedFilledOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'GetOrderDetails': { 'cost': 1, 'returnType': 'Dict' },
                        'GetAccounts': { 'cost': 1, 'returnType': 'Dict' },
                        'GetTransactions': { 'cost': 1, 'returnType': 'Dict' },
                        'GetFiatBankAccounts': { 'cost': 1, 'returnType': 'List' },
                        'GetDigitalCurrencyDepositAddress': { 'cost': 1, 'returnType': 'Dict' },
                        'GetDigitalCurrencyDepositAddress2': { 'cost': 1, 'returnType': 'List' },
                        'GetDigitalCurrencyDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'GetDigitalCurrencyDepositAddresses2': { 'cost': 1, 'returnType': 'Dict' },
                        'GetTrades': { 'cost': 1, 'returnType': 'Dict' },
                        'GetBrokerageFees': { 'cost': 1, 'returnType': 'List' },
                        'GetDigitalCurrencyWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'PlaceLimitOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'PlaceMarketOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'SynchDigitalCurrencyDepositAddressWithBlockchain': { 'cost': 1, 'returnType': 'Dict' },
                        'RequestFiatWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'WithdrawFiatCurrency': { 'cost': 1, 'returnType': 'Dict' },
                        'WithdrawDigitalCurrency': { 'cost': 1, 'returnType': 'Dict' },
                        'WithdrawCrypto': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
