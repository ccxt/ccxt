...
import type { Balances, Currency, Dict, Int, List, Market, NullableDict, Num, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, TradingFees, Transaction, DepositAddress, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'GetValidPrimaryCurrencyCodes': { 'cost': 1 } as EndpointSpec<List>,
                        'GetValidSecondaryCurrencyCodes': { 'cost': 1 } as EndpointSpec<List>,
                        'GetValidLimitOrderTypes': { 'cost': 1 } as EndpointSpec<List>,
                        'GetValidMarketOrderTypes': { 'cost': 1 } as EndpointSpec<List>,
                        'GetValidOrderTypes': { 'cost': 1 } as EndpointSpec<List>,
                        'GetValidTransactionTypes': { 'cost': 1 } as EndpointSpec<List>,
                        'GetMarketSummary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetOrderBook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetAllOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetTradeHistorySummary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetRecentTrades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetFxRates': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOrderMinimumVolumes': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetCryptoWithdrawalFees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetCryptoWithdrawalFees2': { 'cost': 1 } as EndpointSpec<List>,
                        'GetNetworks': { 'cost': 1 } as EndpointSpec<List>,
                        'GetPrimaryCurrencyConfig2': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'post': {
                        'GetOpenOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetClosedOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetClosedFilledOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetOrderDetails': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetAccounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetTransactions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetFiatBankAccounts': { 'cost': 1 } as EndpointSpec<List>,
                        'GetDigitalCurrencyDepositAddress': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetDigitalCurrencyDepositAddress2': { 'cost': 1 } as EndpointSpec<List>,
                        'GetDigitalCurrencyDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetDigitalCurrencyDepositAddresses2': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetTrades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetBrokerageFees': { 'cost': 1 } as EndpointSpec<List>,
                        'GetDigitalCurrencyWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'PlaceLimitOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'PlaceMarketOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SynchDigitalCurrencyDepositAddressWithBlockchain': { 'cost': 1 } as EndpointSpec<Dict>,
                        'RequestFiatWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'WithdrawFiatCurrency': { 'cost': 1 } as EndpointSpec<Dict>,
                        'WithdrawDigitalCurrency': { 'cost': 1 } as EndpointSpec<Dict>,
                        'WithdrawCrypto': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
