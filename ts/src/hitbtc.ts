    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'public/currency': { 'cost': 10, 'returnType': 'List' },
                        'public/currency/{currency}': { 'cost': 10, 'returnType': 'Dict' },
                        'public/symbol': { 'cost': 10, 'returnType': 'Dict' },
                        'public/symbol/{symbol}': { 'cost': 10, 'returnType': 'Dict' },
                        'public/ticker': { 'cost': 10, 'returnType': 'Dict' },
                        'public/ticker/{symbol}': { 'cost': 10, 'returnType': 'Dict' },
                        'public/price/rate': { 'cost': 10, 'returnType': 'Dict' },
                        'public/price/history': { 'cost': 10, 'returnType': 'Dict' },
                        'public/price/ticker': { 'cost': 10, 'returnType': 'Dict' },
                        'public/price/ticker/{symbol}': { 'cost': 10, 'returnType': 'Dict' },
                        'public/trades': { 'cost': 10, 'returnType': 'Dict' },
                        'public/trades/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/orderbook': { 'cost': 10, 'returnType': 'Dict' },
                        'public/orderbook/{symbol}': { 'cost': 10, 'returnType': 'Dict' },
                        'public/candles': { 'cost': 10, 'returnType': 'Dict' },
                        'public/candles/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/converted/candles': { 'cost': 10, 'returnType': 'Dict' },
                        'public/converted/candles/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/futures/info': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/info/{symbol}': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/history/funding': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/history/funding/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/futures/candles/index_price': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/candles/index_price/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/futures/candles/mark_price': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/candles/mark_price/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/futures/candles/premium_index': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/candles/premium_index/{symbol}': { 'cost': 10, 'returnType': 'List' },
                        'public/futures/candles/open_interest': { 'cost': 10, 'returnType': 'Dict' },
                        'public/futures/candles/open_interest/{symbol}': { 'cost': 10, 'returnType': 'List' },
                    },
                },
                'private': {
                    'get': {
                        'spot/balance': { 'cost': 15, 'returnType': 'Dict' },
                        'spot/balance/{currency}': { 'cost': 15, 'returnType': 'Dict' },
                        'spot/order': { 'cost': 1, 'returnType': 'List' },
                        'spot/order/{client_order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'spot/fee': { 'cost': 15, 'returnType': 'List' },
                        'spot/fee/{symbol}': { 'cost': 15, 'returnType': 'Dict' },
                        'spot/history/order': { 'cost': 15, 'returnType': 'List' },
                        'spot/history/trade': { 'cost': 15, 'returnType': 'List' },
                        'margin/account': { 'cost': 1, 'returnType': 'List' },
                        'margin/account/isolated/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/account/cross/{currency}': { 'cost': 1, 'returnType': 'List' },
                        'margin/order': { 'cost': 1, 'returnType': 'List' },
                        'margin/order/{client_order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/config': { 'cost': 15, 'returnType': 'Dict' },
                        'margin/history/order': { 'cost': 15, 'returnType': 'List' },
                        'margin/history/trade': { 'cost': 15, 'returnType': 'List' },
                        'margin/history/positions': { 'cost': 15, 'returnType': 'List' },
                        'margin/history/clearing': { 'cost': 15, 'returnType': 'List' },
                        'futures/balance': { 'cost': 15, 'returnType': 'Dict' },
                        'futures/balance/{currency}': { 'cost': 15, 'returnType': 'Dict' },
                        'futures/account': { 'cost': 1, 'returnType': 'List' },
                        'futures/account/isolated/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'futures/order': { 'cost': 1, 'returnType': 'List' },
                        'futures/order/{client_order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'futures/config': { 'cost': 15, 'returnType': 'Dict' },
                        'futures/fee': { 'cost': 15, 'returnType': 'List' },
                        'futures/fee/{symbol}': { 'cost': 15, 'returnType': 'Dict' },
                        'futures/history/order': { 'cost': 15, 'returnType': 'List' },
                        'futures/history/trade': { 'cost': 15, 'returnType': 'List' },
                        'futures/history/positions': { 'cost': 15, 'returnType': 'List' },
                        'futures/history/clearing': { 'cost': 15, 'returnType': 'List' },
                        'wallet/balance': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/balance/{currency}': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/crypto/address': { 'cost': 30, 'returnType': 'List' },
                        'wallet/crypto/address/recent-deposit': { 'cost': 30, 'returnType': 'List' },
                        'wallet/crypto/address/recent-withdraw': { 'cost': 30, 'returnType': 'List' },
                        'wallet/crypto/address/check-mine': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/transactions': { 'cost': 30, 'returnType': 'List' },
                        'wallet/transactions/{tx_id}': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/crypto/fee/estimate': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/airdrops': { 'cost': 30, 'returnType': 'List' },
                        'wallet/amount-locks': { 'cost': 30, 'returnType': 'List' },
                        'sub-account': { 'cost': 15, 'returnType': 'List' },
                        'sub-account/acl': { 'cost': 15, 'returnType': 'List' },
                        'sub-account/balance/{subAccID}': { 'cost': 15, 'returnType': 'Dict' },
                        'sub-account/crypto/address/{subAccID}/{currency}': { 'cost': 15, 'returnType': 'Dict' },
                    },
                    'post': {
                        'spot/order': { 'cost': 1, 'returnType': 'Dict' },
                        'spot/order/list': { 'cost': 1, 'returnType': 'List' },
                        'margin/order': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/order/list': { 'cost': 1, 'returnType': 'List' },
                        'futures/order': { 'cost': 1, 'returnType': 'Dict' },
                        'futures/order/list': { 'cost': 1, 'returnType': 'List' },
                        'wallet/crypto/address': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/crypto/withdraw': { 'cost': 30, 'returnType': 'Dict' },
                        'wallet/convert': { 'cost': 30, 'returnType': 'List' },
                        'wallet/transfer': { 'cost': 30, 'returnType': 'Dict' },
                    ...
                    'delete': {
                        'spot/order': { 'cost': 1, 'returnType': 'List' },
                        'spot/order/{client_order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/position': { 'cost': 1, 'returnType': 'List' },
                        'margin/position/isolated/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/order': { 'cost': 1, 'returnType': 'List' },
                        'margin/order/{client_order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'futures/position': { 'cost': 1, 'returnType': 'List' },
                        'futures/position/{margin_mode}/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'futures/order': { 'cost': 1, 'returnType': 'List' },
                        'futures/order/{client_order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet/crypto/withdraw/{id}': { 'cost': 30, 'returnType': 'Dict' },
                    },
                    'put': {
                        'margin/account/isolated/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'futures/account/isolated/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
