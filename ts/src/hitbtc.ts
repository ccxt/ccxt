    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'public/currency': { 'cost': 10 } as EndpointSpec<List>,
                        'public/currency/{currency}': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/symbol': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/symbol/{symbol}': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/ticker': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/ticker/{symbol}': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/price/rate': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/price/history': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/price/ticker': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/price/ticker/{symbol}': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/trades': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/trades/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/orderbook': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/orderbook/{symbol}': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/candles': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/candles/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/converted/candles': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/converted/candles/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/futures/info': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/info/{symbol}': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/history/funding': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/history/funding/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/futures/candles/index_price': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/candles/index_price/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/futures/candles/mark_price': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/candles/mark_price/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/futures/candles/premium_index': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/candles/premium_index/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                        'public/futures/candles/open_interest': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/futures/candles/open_interest/{symbol}': { 'cost': 10 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'spot/balance': { 'cost': 15 } as EndpointSpec<Dict>,
                        'spot/balance/{currency}': { 'cost': 15 } as EndpointSpec<Dict>,
                        'spot/order': { 'cost': 1 } as EndpointSpec<List>,
                        'spot/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'spot/fee': { 'cost': 15 } as EndpointSpec<List>,
                        'spot/fee/{symbol}': { 'cost': 15 } as EndpointSpec<Dict>,
                        'spot/history/order': { 'cost': 15 } as EndpointSpec<List>,
                        'spot/history/trade': { 'cost': 15 } as EndpointSpec<List>,
                        'margin/account': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/account/isolated/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/account/cross/{currency}': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/order': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/config': { 'cost': 15 } as EndpointSpec<Dict>,
                        'margin/history/order': { 'cost': 15 } as EndpointSpec<List>,
                        'margin/history/trade': { 'cost': 15 } as EndpointSpec<List>,
                        'margin/history/positions': { 'cost': 15 } as EndpointSpec<List>,
                        'margin/history/clearing': { 'cost': 15 } as EndpointSpec<List>,
                        'futures/balance': { 'cost': 15 } as EndpointSpec<Dict>,
                        'futures/balance/{currency}': { 'cost': 15 } as EndpointSpec<Dict>,
                        'futures/account': { 'cost': 1 } as EndpointSpec<List>,
                        'futures/account/isolated/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'futures/order': { 'cost': 1 } as EndpointSpec<List>,
                        'futures/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'futures/config': { 'cost': 15 } as EndpointSpec<Dict>,
                        'futures/fee': { 'cost': 15 } as EndpointSpec<List>,
                        'futures/fee/{symbol}': { 'cost': 15 } as EndpointSpec<Dict>,
                        'futures/history/order': { 'cost': 15 } as EndpointSpec<List>,
                        'futures/history/trade': { 'cost': 15 } as EndpointSpec<List>,
                        'futures/history/positions': { 'cost': 15 } as EndpointSpec<List>,
                        'futures/history/clearing': { 'cost': 15 } as EndpointSpec<List>,
                        'wallet/balance': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/balance/{currency}': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/crypto/address': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/crypto/address/recent-deposit': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/crypto/address/recent-withdraw': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/crypto/address/check-mine': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/transactions': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/transactions/{tx_id}': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/crypto/fee/estimate': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/airdrops': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/amount-locks': { 'cost': 30 } as EndpointSpec<List>,
                        'sub-account': { 'cost': 15 } as EndpointSpec<List>,
                        'sub-account/acl': { 'cost': 15 } as EndpointSpec<List>,
                        'sub-account/balance/{subAccID}': { 'cost': 15 } as EndpointSpec<Dict>,
                        'sub-account/crypto/address/{subAccID}/{currency}': { 'cost': 15 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'spot/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'spot/order/list': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/order/list': { 'cost': 1 } as EndpointSpec<List>,
                        'futures/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'futures/order/list': { 'cost': 1 } as EndpointSpec<List>,
                        'wallet/crypto/address': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/crypto/withdraw': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/convert': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/transfer': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/internal/withdraw': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/crypto/check-offchain-available': { 'cost': 30 } as EndpointSpec<Dict>,
                        'wallet/crypto/fees/estimate': { 'cost': 30 } as EndpointSpec<List>,
                        'wallet/airdrops/{id}/claim': { 'cost': 30 } as EndpointSpec<Dict>,
                        'sub-account/freeze': { 'cost': 15 } as EndpointSpec<Dict>,
                        'sub-account/activate': { 'cost': 15 } as EndpointSpec<Dict>,
                        'sub-account/transfer': { 'cost': 15 } as EndpointSpec<Dict>,
                        'sub-account/acl': { 'cost': 15 } as EndpointSpec<List>,
                    },
                    'patch': {
                        'spot/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'delete': {
                        'spot/order': { 'cost': 1 } as EndpointSpec<List>,
                        'spot/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/position': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/position/isolated/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/order': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'futures/position': { 'cost': 1 } as EndpointSpec<List>,
                        'futures/position/{margin_mode}/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'futures/order': { 'cost': 1 } as EndpointSpec<List>,
                        'futures/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallet/crypto/withdraw/{id}': { 'cost': 30 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'margin/account/isolated/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'futures/account/isolated/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
