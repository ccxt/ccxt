        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        // Authentication
                        'auth': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange_token': { 'cost': 1, 'returnType': 'Dict' },
                        'fork_token': { 'cost': 1, 'returnType': 'Dict' },
                        // Session management
                        'set_heartbeat': { 'cost': 1, 'returnType': 'Dict' },
                        'disable_heartbeat': { 'cost': 1, 'returnType': 'Dict' },
                        // Supporting
                        'get_time': { 'cost': 1, 'returnType': 'Dict' },
                        'hello': { 'cost': 1, 'returnType': 'Dict' },
                        'status': { 'cost': 1, 'returnType': 'Dict' },
                        'test': { 'cost': 1, 'returnType': 'Dict' },
                        // Subscription management
                        'subscribe': { 'cost': 1, 'returnType': 'Dict' },
                        'unsubscribe': { 'cost': 1, 'returnType': 'Dict' },
                        'unsubscribe_all': { 'cost': 1, 'returnType': 'Dict' },
                        // Account management
                        'get_announcements': { 'cost': 1, 'returnType': 'Dict' },
                        // Market data
                        'get_book_summary_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_book_summary_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_contract_size': { 'cost': 1, 'returnType': 'Dict' },
                        'get_currencies': { 'cost': 1, 'returnType': 'Dict' },
                        'get_delivery_prices': { 'cost': 1, 'returnType': 'Dict' },
                        'get_funding_chart_data': { 'cost': 1, 'returnType': 'Dict' },
                        'get_funding_rate_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_funding_rate_value': { 'cost': 1, 'returnType': 'Dict' },
                        'get_historical_volatility': { 'cost': 1, 'returnType': 'Dict' },
                        'get_index': { 'cost': 1, 'returnType': 'Dict' },
                        'get_index_price': { 'cost': 1, 'returnType': 'Dict' },
                        'get_index_price_names': { 'cost': 1, 'returnType': 'Dict' },
                        'get_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_instruments': { 'cost': 1, 'returnType': 'List' },
                        'get_last_settlements_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_last_settlements_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_last_trades_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_last_trades_by_currency_and_time': { 'cost': 1, 'returnType': 'Dict' },
                        'get_last_trades_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_last_trades_by_instrument_and_time': { 'cost': 1, 'returnType': 'Dict' },
                        'get_mark_price_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order_book': { 'cost': 1, 'returnType': 'Dict' },
                        'get_trade_volumes': { 'cost': 1, 'returnType': 'Dict' },
                        'get_tradingview_chart_data': { 'cost': 1, 'returnType': 'Dict' },
                        'get_volatility_index_data': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'private': {
                    'get': {
                        // Authentication
                        'logout': { 'cost': 1, 'returnType': 'Dict' },
                        // Session management
                        'enable_cancel_on_disconnect': { 'cost': 1, 'returnType': 'Dict' },
                        'disable_cancel_on_disconnect': { 'cost': 1, 'returnType': 'Dict' },
                        'get_cancel_on_disconnect': { 'cost': 1, 'returnType': 'Dict' },
                        // Subscription management
                        'subscribe': { 'cost': 1, 'returnType': 'Dict' },
                        'unsubscribe': { 'cost': 1, 'returnType': 'Dict' },
                        'unsubscribe_all': { 'cost': 1, 'returnType': 'Dict' },
                        // Account management
                        'change_api_key_name': { 'cost': 1, 'returnType': 'Dict' },
                        'change_scope_in_api_key': { 'cost': 1, 'returnType': 'Dict' },
                        'change_subaccount_name': { 'cost': 1, 'returnType': 'Dict' },
                        'create_api_key': { 'cost': 1, 'returnType': 'Dict' },
                        'create_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'disable_api_key': { 'cost': 1, 'returnType': 'Dict' },
                        'disable_tfa_for_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'enable_affiliate_program': { 'cost': 1, 'returnType': 'Dict' },
                        'enable_api_key': { 'cost': 1, 'returnType': 'Dict' },
                        'get_access_log': { 'cost': 1, 'returnType': 'Dict' },
                        'get_account_summary': { 'cost': 1, 'returnType': 'Dict' },
                        'get_account_summaries': { 'cost': 1, 'returnType': 'Dict' },
                        'get_affiliate_program_info': { 'cost': 1, 'returnType': 'Dict' },
                        'get_email_language': { 'cost': 1, 'returnType': 'Dict' },
                        'get_new_announcements': { 'cost': 1, 'returnType': 'Dict' },
                        'get_portfolio_margins': { 'cost': 1, 'returnType': 'Dict' },
                        'get_position': { 'cost': 1, 'returnType': 'Dict' },
                        'get_positions': { 'cost': 1, 'returnType': 'Dict' },
                        'get_subaccounts': { 'cost': 1, 'returnType': 'Dict' },
                        'get_subaccounts_details': { 'cost': 1, 'returnType': 'Dict' },
                        'get_transaction_log': { 'cost': 1, 'returnType': 'Dict' },
                        'list_api_keys': { 'cost': 1, 'returnType': 'Dict' },
                        'remove_api_key': { 'cost': 1, 'returnType': 'Dict' },
                        'remove_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'reset_api_key': { 'cost': 1, 'returnType': 'Dict' },
                        'set_announcement_as_read': { 'cost': 1, 'returnType': 'Dict' },
                        'set_api_key_as_default': { 'cost': 1, 'returnType': 'Dict' },
                        'set_email_for_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'set_email_language': { 'cost': 1, 'returnType': 'Dict' },
                        'set_password_for_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'toggle_notifications_from_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'toggle_subaccount_login': { 'cost': 1, 'returnType': 'Dict' },
                        // Block Trade
                        'execute_block_trade': { 'cost': 4, 'returnType': 'Dict' },
                        'get_block_trade': { 'cost': 1, 'returnType': 'Dict' },
                        'get_last_block_trades_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'invalidate_block_trade_signature': { 'cost': 1, 'returnType': 'Dict' },
                        'verify_block_trade': { 'cost': 4, 'returnType': 'Dict' },
                        // Trading
                        'buy': { 'cost': 4, 'returnType': 'Dict' },
                        'sell': { 'cost': 4, 'returnType': 'Dict' },
                        'edit': { 'cost': 4, 'returnType': 'Dict' },
                        'edit_by_label': { 'cost': 4, 'returnType': 'Dict' },
                        'cancel': { 'cost': 4, 'returnType': 'Dict' },
                        'cancel_all': { 'cost': 4, 'returnType': 'Dict' },
                        'cancel_all_by_currency': { 'cost': 4, 'returnType': 'Dict' },
                        'cancel_all_by_instrument': { 'cost': 4, 'returnType': 'Dict' },
                        'cancel_by_label': { 'cost': 4, 'returnType': 'Dict' },
                        'close_position': { 'cost': 4, 'returnType': 'Dict' },
                        'get_margins': { 'cost': 1, 'returnType': 'Dict' },
                        'get_mmp_config': { 'cost': 1, 'returnType': 'Dict' },
                        'get_open_orders_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_open_orders_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order_history_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order_history_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order_margin_by_ids': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order_state': { 'cost': 1, 'returnType': 'Dict' },
                        'get_stop_order_history': { 'cost': 1, 'returnType': 'Dict' }, // deprecated
                        'get_trigger_order_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_user_trades_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_user_trades_by_currency_and_time': { 'cost': 1, 'returnType': 'Dict' },
                        'get_user_trades_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_user_trades_by_instrument_and_time': { 'cost': 1, 'returnType': 'Dict' },
                        'get_user_trades_by_order': { 'cost': 1, 'returnType': 'Dict' },
                        'reset_mmp': { 'cost': 1, 'returnType': 'Dict' },
                        'set_mmp_config': { 'cost': 1, 'returnType': 'Dict' },
                        'get_settlement_history_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_settlement_history_by_currency': { 'cost': 1, 'returnType': 'Dict' },
                        // Wallet
                        'cancel_transfer_by_id': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'create_deposit_address': { 'cost': 1, 'returnType': 'Dict' },
                        'get_current_deposit_address': { 'cost': 1, 'returnType': 'Dict' },
                        'get_deposits': { 'cost': 1, 'returnType': 'Dict' },
                        'get_transfers': { 'cost': 1, 'returnType': 'Dict' },
                        'get_withdrawals': { 'cost': 1, 'returnType': 'Dict' },
                        'submit_transfer_to_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'submit_transfer_to_user': { 'cost': 1, 'returnType': 'Dict' },
