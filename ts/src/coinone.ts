...
import type { Balances, Currencies, CurrencyInterface, DepositAddress, Dict, Int, List, Market, NullableDict, FeeString, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, int, EndpointSpec } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'ticker_utc': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'v2Public': {
                    'get': {
                        'range_units': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{quote_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbook/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ticker_new/{quote_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ticker_new/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ticker_utc_new/{quote_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ticker_utc_new/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'currencies': { 'cost': 1 } as EndpointSpec<Dict>,
                        'currencies/{currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'chart/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'post': {
                        'account/deposit_address': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/btc_deposit_address': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/daily_balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/user_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/virtual_account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/cancel_all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/limit_buy': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/limit_sell': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/complete_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/limit_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/order_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/auth_number': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/krw/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/btc': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/coin': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'v2Private': {
                    'post': {
                        ...
                        'order/limit_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/complete_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/query_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/auth_number': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/btc': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/krw/history': { 'cost': 1 } as EndpointSpec<Dict>,
                ...
                'v2_1Private': {
                    'post': {
                        'account/balance/all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/trade_fee': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/trade_fee/{quote_currency}/{target_currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/limit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/cancel/all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/open_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/open_orders/all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/complete_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/complete_orders/all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/krw/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/coin/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transaction/coin/withdrawal/limit': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
