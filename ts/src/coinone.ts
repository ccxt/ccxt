            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'ticker_utc': { 'cost': 1, 'returnType': 'Dict' },
                        'trades': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'v2Public': {
                    'get': {
                        'range_units': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{quote_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbook/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'trades/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'ticker_new/{quote_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'ticker_new/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'ticker_utc_new/{quote_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'ticker_utc_new/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'currencies': { 'cost': 1, 'returnType': 'Dict' },
                        'currencies/{currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'chart/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'post': {
                        'account/deposit_address': { 'cost': 1, 'returnType': 'Dict' },
                        'account/btc_deposit_address': { 'cost': 1, 'returnType': 'Dict' },
                        'account/balance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/daily_balance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/user_info': { 'cost': 1, 'returnType': 'Dict' },
                        'account/virtual_account': { 'cost': 1, 'returnType': 'Dict' },
                        'order/cancel_all': { 'cost': 1, 'returnType': 'Dict' },
                        'order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'order/limit_buy': { 'cost': 1, 'returnType': 'Dict' },
                        'order/limit_sell': { 'cost': 1, 'returnType': 'Dict' },
                        'order/complete_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/limit_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/order_info': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/auth_number': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/history': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/krw/history': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/btc': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/coin': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'v2Private': {
                    'post': {
                        ...
                        'order/limit_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/complete_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/query_order': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/auth_number': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/btc': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/history': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/krw/history': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'v2_1Private': {
                    'post': {
                        'account/balance/all': { 'cost': 1, 'returnType': 'Dict' },
                        'account/balance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/trade_fee': { 'cost': 1, 'returnType': 'Dict' },
                        'account/trade_fee/{quote_currency}/{target_currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'order/limit': { 'cost': 1, 'returnType': 'Dict' },
                        'order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'order/cancel/all': { 'cost': 1, 'returnType': 'Dict' },
                        'order/open_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/open_orders/all': { 'cost': 1, 'returnType': 'Dict' },
                        'order/complete_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/complete_orders/all': { 'cost': 1, 'returnType': 'Dict' },
                        'order/info': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/krw/history': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/coin/history': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction/coin/withdrawal/limit': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
