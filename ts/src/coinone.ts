        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                ...
                'v2Public': {
                    'get': {
                        'range_units': 1,
                        'markets/{quote_currency}': 1,
                        'markets/{quote_currency}/{target_currency}': 1,
                        ...
                        'ticker_utc_new/{quote_currency}': 1,
                        'ticker_utc_new/{quote_currency}/{target_currency}': 1,
                        'currencies': { 'cost': 1, 'returnType': 'Dict' },
                        'currencies/{currency}': 1,
                        'chart/{quote_currency}/{target_currency}': 1,
                    },
                },
                'private': {
                    'post': {
                ...
                'v2_1Private': {
                    'post': {
                        'account/balance/all': 1,
                        'account/balance': 1,
                        'account/trade_fee': 1,
                        'account/trade_fee/{quote_currency}/{target_currency}': 1,
                        'order/limit': { 'cost': 1, 'returnType': 'Dict' },
                        'order/cancel': 1,
                        'order/cancel/all': 1,
                        'order/open_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order/open_orders/all': 1,
                        'order/complete_orders': 1,
                        'order/complete_orders/all': 1,
                        'order/info': 1,
                        'transaction/krw/history': 1,
                        'transaction/coin/history': 1,
                        'transaction/coin/withdrawal/limit': 1,
                    },
                },
            },
            'fees': {
