        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'myriad': {
                    'public': {
                        'get': {
                            'questions': { 'cost': 1, 'returnType': 'Dict' },
                            ...
                            'markets/{id}/holders': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{id}/referrals': { 'cost': 1, 'returnType': 'Dict' },
                            'events': { 'cost': 1, 'returnType': 'Dict' },
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/{hash}': { 'cost': 1, 'returnType': 'Dict' },
                            'users/{address}/events': { 'cost': 1, 'returnType': 'Dict' },
                            'users/{address}/referrals': { 'cost': 1, 'returnType': 'Dict' },
                            'users/{address}/portfolio': { 'cost': 1, 'returnType': 'Dict' },
                            'users/{address}/markets': { 'cost': 1, 'returnType': 'Dict' },
                            'tags': { 'cost': 1, 'returnType': 'Dict' },
                            'topics': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'markets/quote': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/claim': { 'cost': 1, 'returnType': 'Dict' },
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/cancel-batch': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/cancel-all': { 'cost': 1, 'returnType': 'Dict' },
                            'positions/split': { 'cost': 1, 'returnType': 'Dict' },
                            'positions/merge': { 'cost': 1, 'returnType': 'Dict' },
                            'positions/redeem': { 'cost': 1, 'returnType': 'Dict' },
                            'positions/redeem-voided': { 'cost': 1, 'returnType': 'Dict' },
                            'positions/neg-risk/split': { 'cost': 1, 'returnType': 'Dict' },
                            'positions/neg-risk/merge': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'delete': {
                            'orders/{hash}': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    ...
                    'private': {
                        'post': {
                            'markets/quote_with_fee': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
            },
