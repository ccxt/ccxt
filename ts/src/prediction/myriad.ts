...
import type {
    ...
    PredictionTicker, PredictionTickers, PredictionOrder, PredictionTrade, PredictionPosition, Bool, NullableDict, EndpointSpec, List } from '../base/types.js';
...
export default class myriad extends Exchange {
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'myriad': {
                    'public': {
                        'get': {
                            'questions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'questions/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{networkId}/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}/events': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}/orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}/trades': { 'cost': 1 } as EndpointSpec<List>,
                            'markets/{id}/holders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}/referrals': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/{hash}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'users/{address}/events': { 'cost': 1 } as EndpointSpec<Dict>,
                            'users/{address}/referrals': { 'cost': 1 } as EndpointSpec<Dict>,
                            'users/{address}/portfolio': { 'cost': 1 } as EndpointSpec<Dict>,
                            'users/{address}/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tags': { 'cost': 1 } as EndpointSpec<Dict>,
                            'topics': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'markets/quote': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/claim': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/cancel-batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/cancel-all': { 'cost': 1 } as EndpointSpec<Dict>,
                            'positions/split': { 'cost': 1 } as EndpointSpec<Dict>,
                            'positions/merge': { 'cost': 1 } as EndpointSpec<Dict>,
                            'positions/redeem': { 'cost': 1 } as EndpointSpec<Dict>,
                            'positions/redeem-voided': { 'cost': 1 } as EndpointSpec<Dict>,
                            'positions/neg-risk/split': { 'cost': 1 } as EndpointSpec<Dict>,
                            'positions/neg-risk/merge': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'orders/{hash}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    ...
                    'private': {
                        'post': {
                            'markets/quote_with_fee': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
     ...
     */
    parseMyriadMarket (raw: Dict, eventSlug: Str = undefined): Market {
        const networkId = this.safeString (raw, 'networkId');
        const marketId = this.safeString (raw, 'id');
