                ...
                'kalshi': {
                    'public': {
                        'get': {
                            ...
                            'events/multivariate': { 'cost': 1, 'returnType': 'Dict' },
                            'events/fee_changes': { 'cost': 1, 'returnType': 'Dict' },
                            'events/{event_ticker}': { 'cost': 1, 'returnType': 'Dict' },
                            'events/{event_ticker}/metadata': { 'cost': 1, 'returnType': 'Dict' },
                            'series': { 'cost': 1, 'returnType': 'Dict' },
                            'series/fee_changes': { 'cost': 1, 'returnType': 'Dict' },
                            'series/{series_ticker}': { 'cost': 1, 'returnType': 'Dict' },
                            'series/{series_ticker}/markets/{ticker}/candlesticks': { 'cost': 1, 'returnType': 'Dict' },
                            'series/{series_ticker}/events/{ticker}/candlesticks': { 'cost': 1, 'returnType': 'Dict' },
                            'series/{series_ticker}/events/{ticker}/forecast_percentile_history': { 'cost': 1, 'returnType': 'Dict' },
                            'markets': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/orderbooks': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/candlesticks': { 'cost': 1, 'returnType': 'Dict' },
                            ...
                            'exchange/schedule': { 'cost': 1, 'returnType': 'Dict' },
                            'exchange/announcements': { 'cost': 1, 'returnType': 'Dict' },
                            'exchange/user_data_timestamp': { 'cost': 1, 'returnType': 'Dict' },
                            'milestones': { 'cost': 1, 'returnType': 'Dict' },
                            'milestones/{milestone_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'structured_targets': { 'cost': 1, 'returnType': 'Dict' },
                            'structured_targets/{structured_target_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'search/filters_by_sport': { 'cost': 1, 'returnType': 'Dict' },
                            'search/tags_by_categories': { 'cost': 1, 'returnType': 'Dict' },
                            'live_data/batch': { 'cost': 1, 'returnType': 'Dict' },
                            'live_data/milestone/{milestone_id}': { 'cost': 1, 'returnType': 'Dict' },
                            ...
                            'incentive_programs': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            ...
                            'portfolio/orders/{order_id}/queue_position': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/orders/queue_positions': { 'cost': 1, 'returnType': 'Dict' },
                            ...
                            'portfolio/deposits': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/withdrawals': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/order_groups': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/order_groups/{order_group_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/summary/total_resting_order_value': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/subaccounts/balances': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/subaccounts/netting': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/subaccounts/transfers': { 'cost': 1, 'returnType': 'Dict' },
                            'historical/fills': { 'cost': 1, 'returnType': 'Dict' },
                            'historical/orders': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'portfolio/orders': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/events/orders': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/orders/batched': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/orders/{order_id}/amend': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/orders/{order_id}/decrease': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/order_groups/create': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/subaccounts': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/subaccounts/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'multivariate_event_collections/{collection_ticker}': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'put': {
