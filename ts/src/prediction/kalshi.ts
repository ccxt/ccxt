...
import type {
    ...
    fetchEventsParams,Bool, Fee, OrderSide, EndpointSpec } from '../base/types.js';
...
export default class kalshi extends Exchange {
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'kalshi': {
                    'public': {
                        'get': {
                            ...
                            'events/multivariate': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/fee_changes': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/{event_ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/{event_ticker}/metadata': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/fee_changes': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/{series_ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/{series_ticker}/markets/{ticker}/candlesticks': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/{series_ticker}/events/{ticker}/candlesticks': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/{series_ticker}/events/{ticker}/forecast_percentile_history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/orderbooks': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/candlesticks': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{ticker}/orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                            'exchange/status': { 'cost': 1 } as EndpointSpec<Dict>,
                            'exchange/schedule': { 'cost': 1 } as EndpointSpec<Dict>,
                            'exchange/announcements': { 'cost': 1 } as EndpointSpec<Dict>,
                            'exchange/user_data_timestamp': { 'cost': 1 } as EndpointSpec<Dict>,
                            'milestones': { 'cost': 1 } as EndpointSpec<Dict>,
                            'milestones/{milestone_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'structured_targets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'structured_targets/{structured_target_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'search/filters_by_sport': { 'cost': 1 } as EndpointSpec<Dict>,
                            'search/tags_by_categories': { 'cost': 1 } as EndpointSpec<Dict>,
                            'live_data/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'live_data/milestone/{milestone_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'historical/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'historical/markets/{ticker}/candlesticks': { 'cost': 1 } as EndpointSpec<Dict>,
                            'historical/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'historical/cutoff_timestamps': { 'cost': 1 } as EndpointSpec<Dict>,
                            'multivariate_event_collections': { 'cost': 1 } as EndpointSpec<Dict>,
                            'multivariate_event_collections/{collection_ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'multivariate_event_collections/{collection_ticker}/lookup': { 'cost': 1 } as EndpointSpec<Dict>,
                            'incentive_programs': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'portfolio/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/{order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/{order_id}/queue_position': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/queue_positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/fills': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/settlements': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/deposits': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/withdrawals': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/order_groups': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/order_groups/{order_group_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/summary/total_resting_order_value': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/subaccounts/balances': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/subaccounts/netting': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/subaccounts/transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                            'historical/fills': { 'cost': 1 } as EndpointSpec<Dict>,
                            'historical/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'portfolio/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/events/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/batched': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/{order_id}/amend': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/{order_id}/decrease': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/order_groups/create': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/subaccounts': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/subaccounts/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'multivariate_event_collections/{collection_ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'put': {
                            'portfolio/order_groups/{order_group_id}/reset': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/order_groups/{order_group_id}/trigger': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/order_groups/{order_group_id}/limit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/subaccounts/netting': { 'cost': 1 } as EndpointSpec<Dict>,
                            'multivariate_event_collections/{collection_ticker}/lookup': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'portfolio/orders/{order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/orders/batched': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/events/orders/{order_id}': { 'cost': 1 } as EndpointSpec<Dict>, // v2 cancel (the non-v2 paths above are 410 Gone)
                            'portfolio/order_groups/{order_group_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
                'elections': {
                    'public': {
                        'get': {
                            'search/series': { 'cost': 1 } as EndpointSpec<Dict>,   // free-text series/event search — elections web host only
                        },
                    },
                },
            },
    ...
    override async fetchMyTrades (outcome: Str = undefined, since: Int = undefined, limit: Int = undefined, params = {}): Promise<PredictionTrade[]> {
        ...
        return this.filterBySinceLimit (result, since, limit, 'timestamp') as PredictionTrade[];
    }
