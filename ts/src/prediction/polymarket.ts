        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'gamma': {
                    'public': {
                        'get': {
                            'status': { 'cost': 1, 'returnType': 'string' },
                            'comments': { 'cost': 1, 'returnType': 'List' },
                            'comments/{id}': { 'cost': 1, 'returnType': 'List' },
                            'comments/user_address/{user_address}': { 'cost': 1, 'returnType': 'List' },
                            'events': { 'cost': 1, 'returnType': 'List' },
                            'events/creators': { 'cost': 1, 'returnType': 'List' },
                            'events/creators/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'events/keyset': { 'cost': 1, 'returnType': 'Dict' },
                            'events/pagination': { 'cost': 1, 'returnType': 'Dict' },
                            'events/results': { 'cost': 1, 'returnType': 'List' },
                            'events/slug/{slug}': { 'cost': 1, 'returnType': 'Dict' },
                            'events/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'events/{id}/comments/count': { 'cost': 1, 'returnType': 'Dict' },
                            'events/{id}/tags': { 'cost': 1, 'returnType': 'List' },
                            'events/{id}/tweet-count': { 'cost': 1, 'returnType': 'Dict' },
                            'markets': { 'cost': 1, 'returnType': 'List' },
                            'markets/keyset': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/slug/{slug}': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{id}/description': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{id}/tags': { 'cost': 1, 'returnType': 'List' },
                            'profiles/user_address/{user_address}': { 'cost': 1, 'returnType': 'Dict' },
                            'public-profile': { 'cost': 1, 'returnType': 'Dict' },
                            'public-search': { 'cost': 1, 'returnType': 'Dict' },
                            'series': { 'cost': 1, 'returnType': 'List' },
                            'series-summary/slug/{slug}': { 'cost': 1, 'returnType': 'Dict' },
                            'series-summary/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'series/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'series/{id}/comments/count': { 'cost': 1, 'returnType': 'Dict' },
                            'sports': { 'cost': 1, 'returnType': 'List' },
                            'sports/market-types': { 'cost': 1, 'returnType': 'Dict' },
                            'tags': { 'cost': 1, 'returnType': 'List' },
                            'tags/slug/{slug}': { 'cost': 1, 'returnType': 'Dict' },
                            'tags/slug/{slug}/related-tags': { 'cost': 1, 'returnType': 'List' },
                            'tags/slug/{slug}/related-tags/tags': { 'cost': 1, 'returnType': 'List' },
                            'tags/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'tags/{id}/related-tags': { 'cost': 1, 'returnType': 'List' },
                            'tags/{id}/related-tags/tags': { 'cost': 1, 'returnType': 'List' },
                            'teams': { 'cost': 1, 'returnType': 'List' },
                            'teams/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'markets/abridged': { 'cost': 1, 'returnType': 'List' },
                            'markets/information': { 'cost': 1, 'returnType': 'List' },
                        },
                    },
                },
                'clob': {
                    'public': {
                        'get': {
                            ...
                            'books': { 'cost': 1, 'returnType': 'List' },
                            'builder/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'clob-markets/{condition_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'fee-rate': { 'cost': 1, 'returnType': 'Dict' },
                            'fee-rate/{token_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'last-trade-price': { 'cost': 1, 'returnType': 'Dict' },
                            'last-trades-prices': { 'cost': 1, 'returnType': 'List' },
                            'markets-by-token/{token_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/live-activity/{condition_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'midpoint': { 'cost': 1, 'returnType': 'Dict' },
                            'midpoints': { 'cost': 1, 'returnType': 'Dict' },
                            'neg-risk': { 'cost': 1, 'returnType': 'Dict' },
                            'neg-risk/{token_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'price': { 'cost': 1, 'returnType': 'Dict' },
                            'prices': { 'cost': 1, 'returnType': 'Dict' },
                            'prices-history': { 'cost': 1, 'returnType': 'Dict' },
                            'rebates/current': { 'cost': 1, 'returnType': 'List' },
                            'rewards/markets/current': { 'cost': 1, 'returnType': 'Dict' },
                            'rewards/markets/multi': { 'cost': 1, 'returnType': 'Dict' },
                            'rewards/markets/{condition_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'sampling-markets': { 'cost': 1, 'returnType': 'Dict' },
                            'sampling-simplified-markets': { 'cost': 1, 'returnType': 'Dict' },
                            'simplified-markets': { 'cost': 1, 'returnType': 'Dict' },
                            'spread': { 'cost': 1, 'returnType': 'Dict' },
                            'tick-size': { 'cost': 1, 'returnType': 'Dict' },
                            'tick-size/{token_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'time': { 'cost': 1, 'returnType': 'string' },
                        },
                        'post': {
                            'batch-prices-history': { 'cost': 1, 'returnType': 'Dict' },
                            'books': { 'cost': 1, 'returnType': 'List' },
                            'last-trades-prices': { 'cost': 1, 'returnType': 'List' },
                            'markets/live-activity': { 'cost': 1, 'returnType': 'List' },
                            'midpoints': { 'cost': 1, 'returnType': 'Dict' },
                            'prices': { 'cost': 1, 'returnType': 'Dict' },
                            'spreads': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            'auth/api-keys': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/ban-status/closed-only': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/builder-api-key': { 'cost': 1, 'returnType': 'List' },
                            'auth/derive-api-key': { 'cost': 1, 'returnType': 'Dict' },
                            'balance-allowance': { 'cost': 1, 'returnType': 'Dict' },
                            'balance-allowance/update': { 'cost': 1, 'returnType': 'Dict' },
                            'data/order/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'data/orders': { 'cost': 1, 'returnType': 'Dict' },
                            'data/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'notifications': { 'cost': 1, 'returnType': 'List' },
                            'order-scoring': { 'cost': 1, 'returnType': 'Dict' },
                            'orders-scoring': { 'cost': 1, 'returnType': 'Dict' },
                            'rewards/user': { 'cost': 1, 'returnType': 'Dict' },
                            'rewards/user/markets': { 'cost': 1, 'returnType': 'Dict' },
                            'rewards/user/percentages': { 'cost': 1, 'returnType': 'Dict' },
                            'rewards/user/total': { 'cost': 1, 'returnType': 'List' },
                        },
                        'post': {
                            'auth/api-key': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/builder-api-key': { 'cost': 1, 'returnType': 'Dict' },
                            'heartbeats': { 'cost': 1, 'returnType': 'Dict' },
                            'order': { 'cost': 1, 'returnType': 'Dict' },
                            'orders': { 'cost': 1, 'returnType': 'List' },
                            'v1/heartbeats': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'delete': {
                            'auth/api-key': { 'cost': 1, 'returnType': 'string' },
                            'auth/builder-api-key': { 'cost': 1, 'returnType': 'string' },
                            'cancel-all': { 'cost': 1, 'returnType': 'Dict' },
                            'cancel-market-orders': { 'cost': 1, 'returnType': 'Dict' },
                            'notifications': { 'cost': 1, 'returnType': 'string' },
                            'order': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'data': {
                    'public': {
                        'get': {
                            'activity': { 'cost': 1, 'returnType': 'List' },
                            'closed-positions': { 'cost': 1, 'returnType': 'List' },
                            'holders': { 'cost': 1, 'returnType': 'List' },
                            'live-volume': { 'cost': 1, 'returnType': 'List' },
                            'oi': { 'cost': 1, 'returnType': 'List' },
                            'other': { 'cost': 1, 'returnType': 'List' },
                            ...
                            'v1/leaderboard': { 'cost': 1, 'returnType': 'List' },
                            'v1/market-positions': { 'cost': 1, 'returnType': 'List' },
                            'v1/positions/combos': { 'cost': 1, 'returnType': 'Dict' },
                            'value': { 'cost': 1, 'returnType': 'List' },
                        },
                    },
                },
                'combos': {
                    'public': {
                        'get': {
                            'v1/rfq/combo-markets': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'post': {
                            'v1/maker/confirmations': { 'cost': 1, 'returnType': 'Dict' },
                            'v1/maker/quotes': { 'cost': 1, 'returnType': 'Dict' },
                            'v1/maker/quotes/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
            },
