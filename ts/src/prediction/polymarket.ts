...
import type {
    ...
    fetchEventsParams,Bool, NullableDict, EndpointSpec, List } from '../base/types.js';
...
export default class polymarket extends Exchange {
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'gamma': {
                    'public': {
                        'get': {
                            'status': { 'cost': 1 } as EndpointSpec<string>,
                            'comments': { 'cost': 1 } as EndpointSpec<List>,
                            'comments/{id}': { 'cost': 1 } as EndpointSpec<List>,
                            'comments/user_address/{user_address}': { 'cost': 1 } as EndpointSpec<List>,
                            'events': { 'cost': 1 } as EndpointSpec<List>,
                            'events/creators': { 'cost': 1 } as EndpointSpec<List>,
                            'events/creators/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/keyset': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/pagination': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/results': { 'cost': 1 } as EndpointSpec<List>,
                            'events/slug/{slug}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/{id}/comments/count': { 'cost': 1 } as EndpointSpec<Dict>,
                            'events/{id}/tags': { 'cost': 1 } as EndpointSpec<List>,
                            'events/{id}/tweet-count': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets': { 'cost': 1 } as EndpointSpec<List>,
                            'markets/keyset': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/slug/{slug}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}/description': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{id}/tags': { 'cost': 1 } as EndpointSpec<List>,
                            'profiles/user_address/{user_address}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public-profile': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public-search': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series': { 'cost': 1 } as EndpointSpec<List>,
                            'series-summary/slug/{slug}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series-summary/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'series/{id}/comments/count': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sports': { 'cost': 1 } as EndpointSpec<List>,
                            'sports/market-types': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tags': { 'cost': 1 } as EndpointSpec<List>,
                            'tags/slug/{slug}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tags/slug/{slug}/related-tags': { 'cost': 1 } as EndpointSpec<List>,
                            'tags/slug/{slug}/related-tags/tags': { 'cost': 1 } as EndpointSpec<List>,
                            'tags/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tags/{id}/related-tags': { 'cost': 1 } as EndpointSpec<List>,
                            'tags/{id}/related-tags/tags': { 'cost': 1 } as EndpointSpec<List>,
                            'teams': { 'cost': 1 } as EndpointSpec<List>,
                            'teams/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'markets/abridged': { 'cost': 1 } as EndpointSpec<List>,
                            'markets/information': { 'cost': 1 } as EndpointSpec<List>,
                        },
                    },
                },
                'clob': {
                    'public': {
                        'get': {
                            ...
                            'books': { 'cost': 1 } as EndpointSpec<List>,
                            'builder/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'clob-markets/{condition_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'fee-rate': { 'cost': 1 } as EndpointSpec<Dict>,
                            'fee-rate/{token_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'last-trade-price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'last-trades-prices': { 'cost': 1 } as EndpointSpec<List>,
                            'markets-by-token/{token_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/live-activity/{condition_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'midpoint': { 'cost': 1 } as EndpointSpec<Dict>,
                            'midpoints': { 'cost': 1 } as EndpointSpec<Dict>,
                            'neg-risk': { 'cost': 1 } as EndpointSpec<Dict>,
                            'neg-risk/{token_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'prices': { 'cost': 1 } as EndpointSpec<Dict>,
                            'prices-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebates/current': { 'cost': 1 } as EndpointSpec<List>,
                            'rewards/markets/current': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rewards/markets/multi': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rewards/markets/{condition_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sampling-markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sampling-simplified-markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'simplified-markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'spread': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tick-size': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tick-size/{token_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'time': { 'cost': 1 } as EndpointSpec<string>,
                        },
                        'post': {
                            'batch-prices-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'books': { 'cost': 1 } as EndpointSpec<List>,
                            'last-trades-prices': { 'cost': 1 } as EndpointSpec<List>,
                            'markets/live-activity': { 'cost': 1 } as EndpointSpec<List>,
                            'midpoints': { 'cost': 1 } as EndpointSpec<Dict>,
                            'prices': { 'cost': 1 } as EndpointSpec<Dict>,
                            'spreads': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'auth/api-keys': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/ban-status/closed-only': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/builder-api-key': { 'cost': 1 } as EndpointSpec<List>,
                            'auth/derive-api-key': { 'cost': 1 } as EndpointSpec<Dict>,
                            'balance-allowance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'balance-allowance/update': { 'cost': 1 } as EndpointSpec<Dict>,
                            'data/order/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'data/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'data/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'notifications': { 'cost': 1 } as EndpointSpec<List>,
                            'order-scoring': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders-scoring': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rewards/user': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rewards/user/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rewards/user/percentages': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rewards/user/total': { 'cost': 1 } as EndpointSpec<List>,
                        },
                        'post': {
                            'auth/api-key': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/builder-api-key': { 'cost': 1 } as EndpointSpec<Dict>,
                            'heartbeats': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders': { 'cost': 1 } as EndpointSpec<List>,
                            'v1/heartbeats': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'auth/api-key': { 'cost': 1 } as EndpointSpec<string>,
                            'auth/builder-api-key': { 'cost': 1 } as EndpointSpec<string>,
                            'cancel-all': { 'cost': 1 } as EndpointSpec<Dict>,
                            'cancel-market-orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'notifications': { 'cost': 1 } as EndpointSpec<string>,
                            'order': { 'cost': 1 } as EndpointSpec<Dict>,
                ...
                'data': {
                    'public': {
                        'get': {
                            'activity': { 'cost': 1 } as EndpointSpec<List>,
                            'closed-positions': { 'cost': 1 } as EndpointSpec<List>,
                            'holders': { 'cost': 1 } as EndpointSpec<List>,
                            'live-volume': { 'cost': 1 } as EndpointSpec<List>,
                            'oi': { 'cost': 1 } as EndpointSpec<List>,
                            'other': { 'cost': 1 } as EndpointSpec<List>,
                            'positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'revisions': { 'cost': 1 } as EndpointSpec<List>,
                            'traded': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'v1/accounting/snapshot': { 'cost': 1 } as EndpointSpec<Dict>,
                            'v1/activity/combos': { 'cost': 1 } as EndpointSpec<Dict>,
                            'v1/builders/leaderboard': { 'cost': 1 } as EndpointSpec<List>,
                            'v1/builders/volume': { 'cost': 1 } as EndpointSpec<List>,
                            'v1/leaderboard': { 'cost': 1 } as EndpointSpec<List>,
                            'v1/market-positions': { 'cost': 1 } as EndpointSpec<List>,
                            'v1/positions/combos': { 'cost': 1 } as EndpointSpec<Dict>,
                            'value': { 'cost': 1 } as EndpointSpec<List>,
                        },
                    },
                },
                'combos': {
                    'public': {
                        'get': {
                            'v1/rfq/combo-markets': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'post': {
                            'v1/maker/confirmations': { 'cost': 1 } as EndpointSpec<Dict>,
                            'v1/maker/quotes': { 'cost': 1 } as EndpointSpec<Dict>,
                            'v1/maker/quotes/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
    ...
    async fetchRawEventsList (params = {}): Promise<any[]> {
        ...
        if (requestedTagsLength > 0) {
            ...
            baseRequest['tag_slug'] = this.tagToSlug (this.safeString (requestedTags, 0) as string);
        }
        if (status === 'active') {
    ...
    override async fetchTicker (outcome: string, params = {}): Promise<PredictionTicker> {
        ...
        //     }
        //
        return this.parsePredictionTicker (
            response,
            outcomeObj
        );
    }
    ...
    override async fetchTickers (outcomes: Strings = undefined, params = {}): Promise<PredictionTickers> {
        ...
        while (startIndex < tokenIdsLength) {
            ...
            for (let i = 0; i < booksLength; i++) {
                ...
                const tickerInput: Dict = { 'midpoint': { 'mid': mid }, 'book': book, 'lastTrade': this.safeDict (lastTradesByTokenId, tokenId, {}) };
    ...
    override async createOrder (outcome: string, type: Str, side: Str, amount: Num, price: Num = undefined, params = {}): Promise<PredictionOrder> {
        ...
        const order = this.parsePredictionOrder (enriched, this.safeDict (built, 'outcome') as any);
    ...
    override async createOrders (orders: PredictionOrderRequest[], params = {}): Promise<PredictionOrder[]> {
        ...
        if (Array.isArray (response)) {
            for (let i = 0; i < response.length; i++) {
                ...
                const parsedItem = this.parsePredictionOrder (enriched, outcomes[i] as any);
