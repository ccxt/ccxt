...
import type {
    ...
    PredictionEvent, PredictionTicker, PredictionTickers, PredictionOrder, PredictionTrade, PredictionPosition, Fee, NullableDict, EndpointSpec } from '../base/types.js';
...
export default class limitless extends Exchange {
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'limitless': {
                    'public': {
                        'get': {
                            'markets/active': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/active/{categoryId}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'categories': { 'cost': 1 } as EndpointSpec<List>,
                            'markets/{addressOrSlug}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/categories/count': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/active/slugs': { 'cost': 1 } as EndpointSpec<List>,
                            'markets/search': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/historical-price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/signing-message': { 'cost': 1 } as EndpointSpec<string>,
                            'markets/{addressOrSlug}/oracle-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/get-feed-events': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/events': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/timeline': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/timeline': { 'cost': 1 } as EndpointSpec<Dict>,
                            'navigation': { 'cost': 1 } as EndpointSpec<List>,
                            'market-pages/by-path': { 'cost': 1 } as EndpointSpec<Dict>,
                            'market-pages/{id}/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'property-keys': { 'cost': 1 } as EndpointSpec<List>,
                            'property-keys/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'property-keys/{id}/options': { 'cost': 1 } as EndpointSpec<List>,
                            'portfolio/{account}/traded-volume': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/{account}/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/{account}/pnl-chart': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'auth/api-keys': { 'cost': 1 } as EndpointSpec<Dict>,
                            'profiles/partner-accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/user-orders': { 'cost': 1 } as EndpointSpec<List>,
                            'portfolio/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'markets/{slug}/locked-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'profiles/me': { 'cost': 1 } as EndpointSpec<Dict>,
                            'profiles/{account}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/pnl-chart': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/points': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/trading/allowance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/api-tokens/capabilities': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/api-tokens': { 'cost': 1 } as EndpointSpec<List>,
                            'profiles/partner-accounts/{profileId}/allowances': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'auth/logout': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/api-keys': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/login': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/cancel-batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/batch-cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/status/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/redeem': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/withdrawal-addresses': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/api-tokens/derive': { 'cost': 1 } as EndpointSpec<Dict>,
                            'profiles/partner-accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                            'profiles/partner-accounts/{profileId}/allowances/retry': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'auth/api-keys': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/{order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders/all/{slug}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'auth/api-tokens/{tokenId}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/withdrawal-addresses/{address}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
     ...
     */
    override async fetchOHLCV (outcome: Str, timeframe = '1d', since: Int = undefined, limit: Int = undefined, params = {}): Promise<OHLCV[]> {
        await this.loadOutcome (outcome);
        const outcomeObj = this.outcome (outcome);
        const slug = this.safeString (outcomeObj['info'], 'slug');
     ...
     */
    async redeem (outcome: Str = undefined, params = {}): Promise<any> {
