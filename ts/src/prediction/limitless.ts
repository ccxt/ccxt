        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'limitless': {
                    'public': {
                        'get': {
                            'markets/active': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/active/{categoryId}': { 'cost': 1, 'returnType': 'Dict' },
                            'categories': { 'cost': 1, 'returnType': 'List' },
                            'markets/{addressOrSlug}': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/categories/count': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/active/slugs': { 'cost': 1, 'returnType': 'List' },
                            'markets/search': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/orderbook': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/historical-price': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/signing-message': { 'cost': 1, 'returnType': 'string' },
                            'markets/{addressOrSlug}/oracle-candles': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/get-feed-events': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/events': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/timeline': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/timeline': { 'cost': 1, 'returnType': 'Dict' },
                            'navigation': { 'cost': 1, 'returnType': 'List' },
                            'market-pages/by-path': { 'cost': 1, 'returnType': 'Dict' },
                            'market-pages/{id}/markets': { 'cost': 1, 'returnType': 'Dict' },
                            'property-keys': { 'cost': 1, 'returnType': 'List' },
                            'property-keys/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'property-keys/{id}/options': { 'cost': 1, 'returnType': 'List' },
                            'portfolio/{account}/traded-volume': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/{account}/positions': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/{account}/pnl-chart': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            'auth/api-keys': { 'cost': 1, 'returnType': 'Dict' },
                            'profiles/partner-accounts': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/user-orders': { 'cost': 1, 'returnType': 'List' },
                            'portfolio/positions': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'markets/{slug}/locked-balance': { 'cost': 1, 'returnType': 'Dict' },
                            'profiles/me': { 'cost': 1, 'returnType': 'Dict' },
                            'profiles/{account}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/pnl-chart': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/history': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/points': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/trading/allowance': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/api-tokens/capabilities': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/api-tokens': { 'cost': 1, 'returnType': 'List' },
                            'profiles/partner-accounts/{profileId}/allowances': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'auth/logout': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/api-keys': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/login': { 'cost': 1, 'returnType': 'Dict' },
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/cancel': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/cancel-batch': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/batch-cancel': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/status/batch': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/redeem': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/withdrawal-addresses': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/api-tokens/derive': { 'cost': 1, 'returnType': 'Dict' },
                            'profiles/partner-accounts': { 'cost': 1, 'returnType': 'Dict' },
                            'profiles/partner-accounts/{profileId}/allowances/retry': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'delete': {
                            'auth/api-keys': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/{order_id}': { 'cost': 1, 'returnType': 'Dict' },
                            'orders/all/{slug}': { 'cost': 1, 'returnType': 'Dict' },
                            'auth/api-tokens/{tokenId}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/withdrawal-addresses/{address}': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
            },
