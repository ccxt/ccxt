    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'book/{currency}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'chart/week': { 'cost': 1, 'returnType': 'Dict' },
                        'chart/week/{currency}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'currency': { 'cost': 1, 'returnType': 'List' },
                        'currency/available': { 'cost': 1, 'returnType': 'List' },
                        'currency/quotes': { 'cost': 1, 'returnType': 'List' },
                        'currency/{currency}': { 'cost': 1, 'returnType': 'Dict' },
                        'pair': { 'cost': 1, 'returnType': 'List' },
                        'pair/available': { 'cost': 1, 'returnType': 'List' },
                        'ticker': { 'cost': 1, 'returnType': 'List' },
                        'ticker/{base}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'time': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/history/{currency}/{quote}': { 'cost': 1, 'returnType': 'List' },
                        'trade/fee/{currency}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/feeLevels': { 'cost': 1, 'returnType': 'List' },
                        'transaction/bindings': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'private': {
                    'get': {
                        'auth/account': { 'cost': 1, 'returnType': 'List' },
                        'auth/account/currency/{currency}/{type}': { 'cost': 1, 'returnType': 'List' },
                        'auth/order': { 'cost': 1, 'returnType': 'List' },
                        'auth/order/getOrder/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/order/pair/{currency}/{quote}': { 'cost': 1, 'returnType': 'List' },
                        'auth/order/pair/{currency}/{quote}/active': { 'cost': 1, 'returnType': 'List' },
                        'auth/stopOrder': { 'cost': 1, 'returnType': 'List' },
                        'auth/stopOrder/getOrder/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/stopOrder/pair/{currency}/{quote}': { 'cost': 1, 'returnType': 'List' },
                        'auth/stopOrder/pair/{currency}/{quote}/active': { 'cost': 1, 'returnType': 'List' },
                        'auth/trade': { 'cost': 1, 'returnType': 'List' },
                        'auth/trade/pair/{currency}/{quote}': { 'cost': 1, 'returnType': 'List' },
                        'auth/trade/fee/{currency}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/bindings': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/bindings/{currency}': { 'cost': 1, 'returnType': 'List' },
                        'auth/transaction/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transfer': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'auth/order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/order/cancelAll': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/order/cancelAll/{currency}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/order/place': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/spot/deposit': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/spot/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/stopOrder/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/stopOrder/cancelAll': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/stopOrder/cancelAll/{currency}/{quote}': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/stopOrder/place': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/depositAddress': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/withdraw/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/withdraw/confirm': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transaction/withdraw/resendCode': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transfer/email': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transfer/id': { 'cost': 1, 'returnType': 'Dict' },
                        'auth/transfer/phone': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
