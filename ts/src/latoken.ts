...
import type { TransferEntry, Balances, Currency, CurrencyInterface, Int, Market, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, Num, TradingFeeInterface, Currencies, Dict, NullableDict, FeeString, List, FeeInterface, int, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'book/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'chart/week': { 'cost': 1 } as EndpointSpec<Dict>,
                        'chart/week/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'currency': { 'cost': 1 } as EndpointSpec<List>,
                        'currency/available': { 'cost': 1 } as EndpointSpec<List>,
                        'currency/quotes': { 'cost': 1 } as EndpointSpec<List>,
                        'currency/{currency}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'pair': { 'cost': 1 } as EndpointSpec<List>,
                        'pair/available': { 'cost': 1 } as EndpointSpec<List>,
                        'ticker': { 'cost': 1 } as EndpointSpec<List>,
                        'ticker/{base}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/history/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<List>,
                        'trade/fee/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/feeLevels': { 'cost': 1 } as EndpointSpec<List>,
                        'transaction/bindings': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'auth/account': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/account/currency/{currency}/{type}': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/order': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/order/getOrder/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/order/pair/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/order/pair/{currency}/{quote}/active': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/stopOrder': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/stopOrder/getOrder/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/stopOrder/pair/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/stopOrder/pair/{currency}/{quote}/active': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/trade': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/trade/pair/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/trade/fee/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/bindings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/bindings/{currency}': { 'cost': 1 } as EndpointSpec<List>,
                        'auth/transaction/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'auth/order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/order/cancelAll': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/order/cancelAll/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/order/place': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/spot/deposit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/spot/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/stopOrder/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/stopOrder/cancelAll': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/stopOrder/cancelAll/{currency}/{quote}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/stopOrder/place': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/depositAddress': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/withdraw/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/withdraw/confirm': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transaction/withdraw/resendCode': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transfer/email': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transfer/id': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth/transfer/phone': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
