            ...
            'api': {
                ...
                'private': {
                    'get': {
                        ...
                        'accounts/leverage_balance': 1,
                        'bank_accounts': 1,
                        'deposit_money': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/{id}': 1,
                        'exchange/orders/opens': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/cancel_status': 1,
                        'exchange/orders/transactions': 1,
                        'exchange/orders/transactions_pagination': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/leverage/positions': 1,
                        'lending/borrows/matches': 1,
                        'send_money': 1,
                        'withdraws': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'bank_accounts': 1,
                        'deposit_money/{id}/fast': 1,
                        'exchange/orders': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/transfers/to_leverage': 1,
                        'exchange/transfers/from_leverage': 1,
                        'lending/borrows': 1,
                        'lending/borrows/{id}/repay': 1,
                        'send_money': 1,
                        'withdraws': 1,
                    },
                    'delete': {
