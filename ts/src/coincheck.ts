...
import type { Balances, Currency, Dict, Fee, FeeString, Int, Market, NullableDict, Num, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, TradingFees, Transaction, int, Status } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'exchange/orders/rate': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange_status': { 'cost': 1, 'returnType': 'Dict' },
                        'order_books': { 'cost': 1, 'returnType': 'Dict' },
                        'rate/{pair}': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'private': {
                    'get': {
                        ...
                        'accounts/balance': { 'cost': 1, 'returnType': 'Dict' },
                        'accounts/leverage_balance': { 'cost': 1, 'returnType': 'Dict' },
                        'bank_accounts': { 'cost': 1, 'returnType': 'Dict' },
                        'deposit_money': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/opens': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/cancel_status': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/transactions_pagination': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/leverage/positions': { 'cost': 1, 'returnType': 'Dict' },
                        'lending/borrows/matches': { 'cost': 1, 'returnType': 'Dict' },
                        'send_money': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraws': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'bank_accounts': { 'cost': 1, 'returnType': 'Dict' },
                        'deposit_money/{id}/fast': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/transfers/to_leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/transfers/from_leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'lending/borrows': { 'cost': 1, 'returnType': 'Dict' },
                        'lending/borrows/{id}/repay': { 'cost': 1, 'returnType': 'Dict' },
                        'send_money': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraws': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'delete': {
                        'bank_accounts/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'exchange/orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraws/{id}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'markets': {
