...
import _Exchange from './abstract/mercado.js';
...
// @ts-ignore
export default class mercado extends _Exchange {
    describe () {
    ...
    async fetchOHLCV (symbol, timeframe = '15m', since: any = undefined, limit: any = undefined, params = {}) {
        /**
         * @method
