...
export default class extended extends Exchange {
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'v1': {
                    'public': {
                        'get': {
                            'info/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/assets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/assets/{asset}/price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/markets/{market}/stats': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/markets/{market}/orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/markets/{market}/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/candles/{market}/{candleType}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/{market}/funding': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/{market}/open-interests': { 'cost': 1 } as EndpointSpec<Dict>,
                            'info/builder/dashboard': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'user/accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/account/info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/spot/balances': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/assetOperations': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/positions/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/orders/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/orders/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/orders/external/{externalId}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/funding/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/rebates/stats': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/fees': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/bridge/config': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/bridge/quote': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/affiliate': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/referrals/status': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/referrals/links': { 'cost': 1 } as EndpointSpec<List>,
                            'user/referrals/dashboard': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/rewards/earned': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/rewards/leaderboard/stats': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/charts/equities': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolio/charts/pnl': { 'cost': 1 } as EndpointSpec<Dict>,
                            'vault/public/performance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'vault/public/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                            'builder/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'user/order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/order/massCancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/deadmanswitch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/bridge/quote': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/referrals/use': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/referrals': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'put': {
                            'user/referrals': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        ...
                        'delete': {
                            'user/order/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
     ...
     */
    override async fetchOpenInterestHistory (symbol: string, timeframe: string = '1h', since: Int = undefined, limit: Int = undefined, params = {}) {
        await this.loadMarkets ();
        const market = this.market (symbol);
