                ...
                'v1': {
                    ...
                    'private': {
                        'get': {
                            ...
                            'user/rebates/stats': 1,
                            'user/leverage': { 'cost': 1, 'returnType': 'Dict' },
                            'user/fees': { 'cost': 1, 'returnType': 'Dict' },
                            'user/bridge/config': 1,
                            'user/bridge/quote': 1,
                            'user/affiliate': 1,
                            'user/referrals/status': 1,
                            'user/referrals/links': 1,
                            'user/referrals/dashboard': 1,
                            'user/rewards/earned': 1,
                            'user/rewards/leaderboard/stats': 1,
                            'portfolio/charts/equities': 1,
                            'portfolio/charts/pnl': 1,
                            'vault/public/performance': 1,
                            'vault/public/summary': 1,
                            'builder/trades': 1,
                        },
                        'post': {
                            'user/order': { 'cost': 1, 'returnType': 'Dict' },
                            'user/order/massCancel': 1,
                            'user/deadmanswitch': 1,
                            'user/bridge/quote': 1,
                            'user/withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                            'user/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'user/referrals/use': 1,
                            'user/referrals': 1,
                        },
                        'put': [
                            'user/referrals',
