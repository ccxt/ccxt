        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'v1': {
                    'public': {
                        'get': {
                            'info/markets': { 'cost': 1, 'returnType': 'Dict' },
                            'info/assets': { 'cost': 1, 'returnType': 'Dict' },
                            'info/assets/{asset}/price': { 'cost': 1, 'returnType': 'Dict' },
                            'info/markets/{market}/stats': { 'cost': 1, 'returnType': 'Dict' },
                            'info/markets/{market}/orderbook': { 'cost': 1, 'returnType': 'Dict' },
                            'info/markets/{market}/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'info/candles/{market}/{candleType}': { 'cost': 1, 'returnType': 'Dict' },
                            'info/{market}/funding': { 'cost': 1, 'returnType': 'Dict' },
                            'info/{market}/open-interests': { 'cost': 1, 'returnType': 'Dict' },
                            'info/builder/dashboard': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            'user/accounts': { 'cost': 1, 'returnType': 'Dict' },
                            'user/account/info': { 'cost': 1, 'returnType': 'Dict' },
                            'user/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'user/spot/balances': { 'cost': 1, 'returnType': 'Dict' },
                            'user/assetOperations': { 'cost': 1, 'returnType': 'Dict' },
                            'user/positions': { 'cost': 1, 'returnType': 'Dict' },
                            'user/positions/history': { 'cost': 1, 'returnType': 'Dict' },
                            'user/orders': { 'cost': 1, 'returnType': 'Dict' },
                            'user/orders/history': { 'cost': 1, 'returnType': 'Dict' },
                            'user/orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'user/orders/external/{externalId}': { 'cost': 1, 'returnType': 'Dict' },
                            'user/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'user/funding/history': { 'cost': 1, 'returnType': 'Dict' },
                            'user/rebates/stats': { 'cost': 1, 'returnType': 'Dict' },
                            'user/leverage': { 'cost': 1, 'returnType': 'Dict' },
                            'user/fees': { 'cost': 1, 'returnType': 'Dict' },
                            'user/bridge/config': { 'cost': 1, 'returnType': 'Dict' },
                            'user/bridge/quote': { 'cost': 1, 'returnType': 'Dict' },
                            'user/affiliate': { 'cost': 1, 'returnType': 'Dict' },
                            'user/referrals/status': { 'cost': 1, 'returnType': 'Dict' },
                            'user/referrals/links': { 'cost': 1, 'returnType': 'List' },
                            'user/referrals/dashboard': { 'cost': 1, 'returnType': 'Dict' },
                            'user/rewards/earned': { 'cost': 1, 'returnType': 'Dict' },
                            'user/rewards/leaderboard/stats': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/charts/equities': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolio/charts/pnl': { 'cost': 1, 'returnType': 'Dict' },
                            'vault/public/performance': { 'cost': 1, 'returnType': 'Dict' },
                            'vault/public/summary': { 'cost': 1, 'returnType': 'Dict' },
                            'builder/trades': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'user/order': { 'cost': 1, 'returnType': 'Dict' },
                            'user/order/massCancel': { 'cost': 1, 'returnType': 'Dict' },
                            'user/deadmanswitch': { 'cost': 1, 'returnType': 'Dict' },
                            'user/bridge/quote': { 'cost': 1, 'returnType': 'Dict' },
                            'user/withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                            'user/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'user/referrals/use': { 'cost': 1, 'returnType': 'Dict' },
                            'user/referrals': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'put': {
                            'user/referrals': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        ...
                        'delete': {
                            'user/order/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'user/order': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
