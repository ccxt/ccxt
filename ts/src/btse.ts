...
export default class btse extends Exchange {
    ...
    override async fetchOHLCV (symbol: string, timeframe: string = '1m', since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<OHLCV[]> {
        ...
        const [ until, paramsUntil ] = this.handleOptionAndParams (paramsPaginate, 'fetchOHLCV', 'until');
        if (until !== undefined) {
            if (since !== undefined) {
    ...
    async requestWalletHistoryRows (methodName: string, historyTypes: string[], code: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}) {
        ...
        const [ until, paramsUntil ] = this.handleOptionAndParams (paramsOmitted, methodName, 'until');
        if (until !== undefined) {
    ...
    override async fetchLedger (code: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<LedgerEntry[]> {
        ...
        const [ until, paramsUntil ] = this.handleOptionAndParams (paramsOmitted, 'fetchLedger', 'until');
        if (until !== undefined) {
            request['endTime'] = until;
        }
        const response = await this.privateGetPublicApiWalletV1UserWalletHistory (this.extend (request, paramsUntil));
