...
import Exchange from './abstract/dzengi.js';
 ...
 * @augments Exchange
 */
export default class dzengi extends Exchange {
    describe (): any {
    ...
    /**
     * @method
     * @name dzengi#fetchMarkets
     * @description retrieves data on all markets for dzengi
    ...
    async fetchMarkets (params = {}): Promise<Market[]> {
        ...
        for (let i = 0; i < markets.length; i++) {
            ...
            result.push ({
                ...
                'contractSize': isContract ? 1.0 : undefined,
                'expiry': undefined,
    ...
    /**
     * @method
     * @name dzengi#fetchDepositsWithdrawals
    ...
    /**
     * @method
     * @name dzengi#fetchDepositAddress
