            ...
            'api': {
                ...
                'private': {
                    'post': {
                        ...
                        'my/sell/cancel': 1,
                        'ro/my/balances': 1,
                        'ro/my/balances/{cointype}': 1,
                        'ro/my/deposits': 1,
                        'ro/my/withdrawals': 1,
                        'ro/my/transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'ro/my/transactions/{cointype}': 1,
                        'ro/my/transactions/open': 1,
                        'ro/my/transactions/{cointype}/open': 1,
                        'ro/my/sendreceive': 1,
                        'ro/my/affiliatepayments': 1,
                        'ro/my/referralpayments': 1,
                    },
                },
                'v2': {
                    'public': {
