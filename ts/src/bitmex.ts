    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'announcement': { 'cost': 5, 'returnType': 'List' },
                        'announcement/urgent': { 'cost': 5, 'returnType': 'List' },
                        'chat': { 'cost': 5, 'returnType': 'List' },
                        'chat/channels': { 'cost': 5, 'returnType': 'List' },
                        'chat/connected': { 'cost': 5, 'returnType': 'Dict' },
                        'chat/pinned': { 'cost': 5, 'returnType': 'Dict' },
                        'funding': { 'cost': 5, 'returnType': 'List' },
                        'guild': { 'cost': 5, 'returnType': 'List' },
                        'instrument': { 'cost': 5, 'returnType': 'List' },
                        'instrument/active': { 'cost': 5, 'returnType': 'List' },
                        'instrument/activeAndIndices': { 'cost': 5, 'returnType': 'List' },
                        'instrument/activeIntervals': { 'cost': 5, 'returnType': 'Dict' },
                        'instrument/compositeIndex': { 'cost': 5, 'returnType': 'List' },
                        'instrument/indices': { 'cost': 5, 'returnType': 'List' },
                        'instrument/usdVolume': { 'cost': 5, 'returnType': 'List' },
                        'insurance': { 'cost': 5, 'returnType': 'List' },
                        'leaderboard': { 'cost': 5, 'returnType': 'List' },
                        'liquidation': { 'cost': 5, 'returnType': 'List' },
                        'orderBook/L2': { 'cost': 5, 'returnType': 'List' },
                        'porl/nonce': { 'cost': 5, 'returnType': 'Dict' },
                        'quote': { 'cost': 5, 'returnType': 'List' },
                        'quote/bucketed': { 'cost': 5, 'returnType': 'List' },
                        'schema': { 'cost': 5, 'returnType': 'Dict' },
                        'schema/websocketHelp': { 'cost': 5, 'returnType': 'Dict' },
                        'settlement': { 'cost': 5, 'returnType': 'List' },
                        'stats': { 'cost': 5, 'returnType': 'List' },
                        'stats/history': { 'cost': 5, 'returnType': 'List' },
                        'stats/historyUSD': { 'cost': 5, 'returnType': 'List' },
                        'trade': { 'cost': 5, 'returnType': 'List' },
                        'trade/bucketed': { 'cost': 5, 'returnType': 'List' },
                        'wallet/assets': { 'cost': 5, 'returnType': 'List' },
                        'wallet/networks': { 'cost': 5, 'returnType': 'List' },
                    },
                },
                'private': {
                    'get': {
                        'address': { 'cost': 5, 'returnType': 'List' },
                        'apiKey': { 'cost': 5, 'returnType': 'List' },
                        'execution': { 'cost': 5, 'returnType': 'List' },
                        'execution/tradeHistory': { 'cost': 5, 'returnType': 'List' },
                        'globalNotification': { 'cost': 5, 'returnType': 'List' },
                        'leaderboard/name': { 'cost': 5, 'returnType': 'Dict' },
                        'order': { 'cost': 5, 'returnType': 'List' },
                        'porl/snapshots': { 'cost': 5, 'returnType': 'List' },
                        'position': { 'cost': 5, 'returnType': 'List' },
                        'user': { 'cost': 5, 'returnType': 'Dict' },
                        'user/affiliateStatus': { 'cost': 5, 'returnType': 'Dict' },
                        'user/checkReferralCode': { 'cost': 5, 'returnType': 'Dict' },
                        'user/commission': { 'cost': 5, 'returnType': 'Dict' },
                        'user/csa': { 'cost': 5, 'returnType': 'Dict' },
                        'user/depositAddress': { 'cost': 5, 'returnType': 'string' },
                        'user/executionHistory': { 'cost': 5, 'returnType': 'List' },
                        'user/getWalletTransferAccounts': { 'cost': 5, 'returnType': 'List' },
                        'user/margin': { 'cost': 5, 'returnType': 'Dict' },
                        'user/quoteFillRatio': { 'cost': 5, 'returnType': 'Dict' },
                        ...
                        'user/walletHistory': { 'cost': 5, 'returnType': 'List' },
                        'user/walletSummary': { 'cost': 5, 'returnType': 'List' },
                        'userAffiliates': { 'cost': 5, 'returnType': 'List' },
                        'userEvent': { 'cost': 5, 'returnType': 'List' },
                    },
                    'post': {
                        'address': { 'cost': 5, 'returnType': 'Dict' },
                        'chat': { 'cost': 5, 'returnType': 'Dict' },
                        'guild': { 'cost': 5, 'returnType': 'Dict' },
                        'guild/archive': { 'cost': 5, 'returnType': 'Dict' },
                        'guild/join': { 'cost': 5, 'returnType': 'Dict' },
                        'guild/kick': { 'cost': 5, 'returnType': 'Dict' },
                        'guild/leave': { 'cost': 5, 'returnType': 'Dict' },
                        'guild/sharesTrades': { 'cost': 5, 'returnType': 'Dict' },
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                        'order/cancelAllAfter': { 'cost': 5, 'returnType': 'Dict' },
                        'order/closePosition': { 'cost': 5, 'returnType': 'Dict' },
                        'position/isolate': { 'cost': 1, 'returnType': 'Dict' },
                        'position/leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'position/riskLimit': { 'cost': 5, 'returnType': 'Dict' },
                        'position/transferMargin': { 'cost': 1, 'returnType': 'Dict' },
                        'user/addSubaccount': { 'cost': 5, 'returnType': 'Dict' },
                        'user/cancelWithdrawal': { 'cost': 5, 'returnType': 'Dict' },
                        'user/communicationToken': { 'cost': 5, 'returnType': 'string' },
                        'user/confirmEmail': { 'cost': 5, 'returnType': 'Dict' },
                        'user/confirmWithdrawal': { 'cost': 5, 'returnType': 'Dict' },
                        'user/logout': { 'cost': 5, 'returnType': 'string' },
                        'user/preferences': { 'cost': 5, 'returnType': 'Dict' },
                        'user/requestWithdrawal': { 'cost': 5, 'returnType': 'Dict' },
                        'user/unstakingRequests': { 'cost': 5, 'returnType': 'Dict' },
                        'user/updateSubaccount': { 'cost': 5, 'returnType': 'Dict' },
                        'user/walletTransfer': { 'cost': 5, 'returnType': 'Dict' },
                    },
                    'put': {
                        'guild': { 'cost': 5, 'returnType': 'Dict' },
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                    ...
                    'delete': {
                        'order': { 'cost': 1, 'returnType': 'List' },
                        'order/all': { 'cost': 1, 'returnType': 'List' },
                        'user/unstakingRequests': { 'cost': 5, 'returnType': 'Dict' },
                    },
                },
            },
