...
import type { Int, OrderSide, OrderType, Trade, OHLCV, Order, Liquidation, OrderBook, Balances, Str, Dict, Transaction, Ticker, Tickers, Market, Strings, Currency, Leverage, Leverages, Num, Currencies, int, LedgerEntry, FundingRate, FundingRates, DepositAddress, Position, MarginMode, OpenInterests, ADL } from './base/types.js';
...
export default class bitmex extends Exchange {
    ...
    parseLeverage (leverage: Dict, market: Market = undefined): Leverage {
        ...
        if (marginMode === undefined) {
            const isCrossMargin = this.safeBool (leverage, 'crossMargin');
            if (isCrossMargin !== undefined) {
                marginMode = isCrossMargin ? 'cross' : 'isolated';
            }
        }
        return {
            'info': leverage,
