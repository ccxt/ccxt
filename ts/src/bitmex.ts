    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'announcement': { 'cost': 5 } as EndpointSpec<List>,
                        'announcement/urgent': { 'cost': 5 } as EndpointSpec<List>,
                        'chat': { 'cost': 5 } as EndpointSpec<List>,
                        'chat/channels': { 'cost': 5 } as EndpointSpec<List>,
                        'chat/connected': { 'cost': 5 } as EndpointSpec<Dict>,
                        'chat/pinned': { 'cost': 5 } as EndpointSpec<Dict>,
                        'funding': { 'cost': 5 } as EndpointSpec<List>,
                        'guild': { 'cost': 5 } as EndpointSpec<List>,
                        'instrument': { 'cost': 5 } as EndpointSpec<List>,
                        'instrument/active': { 'cost': 5 } as EndpointSpec<List>,
                        'instrument/activeAndIndices': { 'cost': 5 } as EndpointSpec<List>,
                        'instrument/activeIntervals': { 'cost': 5 } as EndpointSpec<Dict>,
                        'instrument/compositeIndex': { 'cost': 5 } as EndpointSpec<List>,
                        'instrument/indices': { 'cost': 5 } as EndpointSpec<List>,
                        'instrument/usdVolume': { 'cost': 5 } as EndpointSpec<List>,
                        'insurance': { 'cost': 5 } as EndpointSpec<List>,
                        'leaderboard': { 'cost': 5 } as EndpointSpec<List>,
                        'liquidation': { 'cost': 5 } as EndpointSpec<List>,
                        'orderBook/L2': { 'cost': 5 } as EndpointSpec<List>,
                        'porl/nonce': { 'cost': 5 } as EndpointSpec<Dict>,
                        'quote': { 'cost': 5 } as EndpointSpec<List>,
                        'quote/bucketed': { 'cost': 5 } as EndpointSpec<List>,
                        'schema': { 'cost': 5 } as EndpointSpec<Dict>,
                        'schema/websocketHelp': { 'cost': 5 } as EndpointSpec<Dict>,
                        'settlement': { 'cost': 5 } as EndpointSpec<List>,
                        'stats': { 'cost': 5 } as EndpointSpec<List>,
                        'stats/history': { 'cost': 5 } as EndpointSpec<List>,
                        'stats/historyUSD': { 'cost': 5 } as EndpointSpec<List>,
                        'trade': { 'cost': 5 } as EndpointSpec<List>,
                        'trade/bucketed': { 'cost': 5 } as EndpointSpec<List>,
                        'wallet/assets': { 'cost': 5 } as EndpointSpec<List>,
                        'wallet/networks': { 'cost': 5 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'address': { 'cost': 5 } as EndpointSpec<List>,
                        'apiKey': { 'cost': 5 } as EndpointSpec<List>,
                        'execution': { 'cost': 5 } as EndpointSpec<List>,
                        'execution/tradeHistory': { 'cost': 5 } as EndpointSpec<List>,
                        'globalNotification': { 'cost': 5 } as EndpointSpec<List>,
                        'leaderboard/name': { 'cost': 5 } as EndpointSpec<Dict>,
                        'order': { 'cost': 5 } as EndpointSpec<List>,
                        'porl/snapshots': { 'cost': 5 } as EndpointSpec<List>,
                        'position': { 'cost': 5 } as EndpointSpec<List>,
                        'user': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/affiliateStatus': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/checkReferralCode': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/commission': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/csa': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/depositAddress': { 'cost': 5 } as EndpointSpec<string>,
                        'user/executionHistory': { 'cost': 5 } as EndpointSpec<List>,
                        'user/getWalletTransferAccounts': { 'cost': 5 } as EndpointSpec<List>,
                        'user/margin': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/quoteFillRatio': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/quoteValueRatio': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/staking': { 'cost': 5 } as EndpointSpec<List>,
                        'user/staking/instruments': { 'cost': 5 } as EndpointSpec<List>,
                        'user/staking/tiers': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/tradingVolume': { 'cost': 5 } as EndpointSpec<List>,
                        'user/unstakingRequests': { 'cost': 5 } as EndpointSpec<List>,
                        'user/wallet': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/walletHistory': { 'cost': 5 } as EndpointSpec<List>,
                        'user/walletSummary': { 'cost': 5 } as EndpointSpec<List>,
                        'userAffiliates': { 'cost': 5 } as EndpointSpec<List>,
                        'userEvent': { 'cost': 5 } as EndpointSpec<List>,
                    },
                    'post': {
                        'address': { 'cost': 5 } as EndpointSpec<Dict>,
                        'chat': { 'cost': 5 } as EndpointSpec<Dict>,
                        'guild': { 'cost': 5 } as EndpointSpec<Dict>,
                        'guild/archive': { 'cost': 5 } as EndpointSpec<Dict>,
                        'guild/join': { 'cost': 5 } as EndpointSpec<Dict>,
                        'guild/kick': { 'cost': 5 } as EndpointSpec<Dict>,
                        'guild/leave': { 'cost': 5 } as EndpointSpec<Dict>,
                        'guild/sharesTrades': { 'cost': 5 } as EndpointSpec<Dict>,
                        'order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/cancelAllAfter': { 'cost': 5 } as EndpointSpec<Dict>,
                        'order/closePosition': { 'cost': 5 } as EndpointSpec<Dict>,
                        'position/isolate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'position/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'position/riskLimit': { 'cost': 5 } as EndpointSpec<Dict>,
                        'position/transferMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'user/addSubaccount': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/cancelWithdrawal': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/communicationToken': { 'cost': 5 } as EndpointSpec<string>,
                        'user/confirmEmail': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/confirmWithdrawal': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/logout': { 'cost': 5 } as EndpointSpec<string>,
                        'user/preferences': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/requestWithdrawal': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/unstakingRequests': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/updateSubaccount': { 'cost': 5 } as EndpointSpec<Dict>,
                        'user/walletTransfer': { 'cost': 5 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'guild': { 'cost': 5 } as EndpointSpec<Dict>,
                        'order': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'delete': {
                        'order': { 'cost': 1 } as EndpointSpec<List>,
