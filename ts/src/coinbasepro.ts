...
import { Int, OrderSide, OrderType, Trade, OHLCV, Order, Balances, String, Transaction, Ticker, OrderBook, Tickers } from './base/types.js';
...
export default class coinbasepro extends Exchange {
    ...
    async deposit (code: string, amount, address, params = {}) {
        /**
         * @method
