...
import type{ Balances, Currency, CurrencyInterface, Greeks, Int, Market, MarketInterface, NullableDict, FeeString, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Position, Leverage, MarginMode, Num, Option, MarginModification, Currencies, Dict, int, LedgerEntry, FundingRate, FundingRates, DepositAddress, ADL, Status, EndpointSpec, List } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'indices': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tickers/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'l2orderbook/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'stats': { 'cost': 1 } as EndpointSpec<List>,
                        'history/candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'history/sparklines': { 'cost': 1 } as EndpointSpec<Dict>,
                        'settings': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        ...
                        'orders/client_order_id/{client_oid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{product_id}/orders/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions/margined': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills/history/download/csv': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallet/balances': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallet/transactions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallet/transactions/download': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallets/sub_accounts_transfer_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/trading_preferences': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sub_accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'profile': { 'cost': 1 } as EndpointSpec<Dict>,
                        'rate_limits/quota': { 'cost': 1 } as EndpointSpec<Dict>,
                        'heartbeat': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deposits/address': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/bracket': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{product_id}/orders/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions/change_margin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions/close_all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallets/sub_account_balance_transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'heartbeat/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'heartbeat': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/cancel_after': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/bracket': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions/auto_topup': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/update_mmp': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/reset_mmp': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/margin_mode': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
