...
import type{ Balances, Currency, CurrencyInterface, Greeks, Int, Market, MarketInterface, NullableDict, FeeString, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Position, Leverage, MarginMode, Num, Option, MarginModification, Currencies, Dict, int, LedgerEntry, FundingRate, FundingRates, DepositAddress, ADL, Status } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'indices': { 'cost': 1, 'returnType': 'Dict' },
                        'products': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'tickers': { 'cost': 1, 'returnType': 'Dict' },
                        'tickers/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'l2orderbook/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'trades/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'stats': { 'cost': 1, 'returnType': 'List' },
                        'history/candles': { 'cost': 1, 'returnType': 'Dict' },
                        'history/sparklines': { 'cost': 1, 'returnType': 'Dict' },
                        'settings': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        ...
                        'orders/client_order_id/{client_oid}': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{product_id}/orders/leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/margined': { 'cost': 1, 'returnType': 'Dict' },
                        'positions': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/history': { 'cost': 1, 'returnType': 'Dict' },
                        'fills': { 'cost': 1, 'returnType': 'Dict' },
                        'fills/history/download/csv': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet/balances': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet/transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet/transactions/download': { 'cost': 1, 'returnType': 'Dict' },
                        'wallets/sub_accounts_transfer_history': { 'cost': 1, 'returnType': 'Dict' },
                        'users/trading_preferences': { 'cost': 1, 'returnType': 'Dict' },
                        'sub_accounts': { 'cost': 1, 'returnType': 'Dict' },
                        'profile': { 'cost': 1, 'returnType': 'Dict' },
                        'rate_limits/quota': { 'cost': 1, 'returnType': 'Dict' },
                        'heartbeat': { 'cost': 1, 'returnType': 'Dict' },
                        'deposits/address': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/bracket': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/batch': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{product_id}/orders/leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/change_margin': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/close_all': { 'cost': 1, 'returnType': 'Dict' },
                        'wallets/sub_account_balance_transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'heartbeat/create': { 'cost': 1, 'returnType': 'Dict' },
                        'heartbeat': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/cancel_after': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/leverage': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'put': {
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/bracket': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/batch': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/auto_topup': { 'cost': 1, 'returnType': 'Dict' },
                        'users/update_mmp': { 'cost': 1, 'returnType': 'Dict' },
                        'users/reset_mmp': { 'cost': 1, 'returnType': 'Dict' },
                        'users/margin_mode': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'delete': {
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/all': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/batch': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
