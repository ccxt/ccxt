            ...
            'api': {
                ...
                'private': {
                    'get': {
                        ...
                        'fills/history/download/csv': 1,
                        'wallet/balances': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet/transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet/transactions/download': 1,
                        'wallets/sub_accounts_transfer_history': 1,
                        'users/trading_preferences': 1,
                        'sub_accounts': 1,
                    ...
                    'post': {
                        ...
                        'products/{product_id}/orders/leverage': 1,
                        'positions/change_margin': { 'cost': 1, 'returnType': 'Dict' },
                        'positions/close_all': { 'cost': 1, 'returnType': 'Dict' },
                        'wallets/sub_account_balance_transfer': 1,
                        'heartbeat/create': 1,
                        'heartbeat': 1,
                        'orders/cancel_after': 1,
                        'orders/leverage': 1,
                    },
                    'put': {
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
