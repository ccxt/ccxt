                ...
                'trader': {
                    'private': {
                        'get': {
                            ...
                            'v2/positions': 1,
                            'v2/positions/{symbol_or_asset_id}': 1,
                            'v2/account/portfolio/history': 1,
                            'v2/watchlists': 1,
                            'v2/watchlists/{watchlist_id}': 1,
                            'v2/watchlists:by_name': 1,
                            'v2/account/configurations': 1,
                            ...
                            'v2/assets/{symbol_or_asset_id}': 1,
                            'v2/corporate_actions/announcements/{id}': 1,
                            'v2/corporate_actions/announcements': 1,
                        ...
                        'delete': {
                            ...
                            'v2/watchlists/{watchlist_id}': 1,
                            'v2/watchlists:by_name': 1,
                            'v2/watchlists/{watchlist_id}/{symbol}': 1,
                        },
                    },
                },
                'market': {
                    'public': {
                        'get': {
                            ...
                            'v1beta3/crypto/{loc}/latest/quotes': 1,
                            'v1beta3/crypto/{loc}/latest/trades': { 'cost': 1, 'returnType': 'Dict' },
                            'v1beta3/crypto/{loc}/quotes': 1,
