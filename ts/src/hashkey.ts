...
export default class hashkey extends Exchange {
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'api/v1/exchangeInfo': { 'cost': 5 } as EndpointSpec<Dict>,
                        'quote/v1/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'quote/v1/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/klines': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/ticker/24hr': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/ticker/price': { 'cost': 1 } as EndpointSpec<List>,
                        'quote/v1/ticker/bookTicker': { 'cost': 1 } as EndpointSpec<List>, // not unified
                        'quote/v1/depth/merged': { 'cost': 1 } as EndpointSpec<Dict>,
                        'quote/v1/markPrice': { 'cost': 1 } as EndpointSpec<Dict>,
                        'quote/v1/index': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/fundingRate': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/historyFundingRate': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/ping': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/time': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        'api/v1/spot/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/spot/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/spot/tradeOrders': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/futures/leverage': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/userTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/positions': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/historyOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/balance': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/liquidationAssignStatus': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/riskLimit': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/commissionRate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/getBestOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/coinInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/account/vipInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/account': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/account/trades': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/account/type': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/account/chainType': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/account/checkApiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/account/balanceFlow': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/spot/subAccount/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/spot/subAccount/tradeOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/subAccount/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/subAccount/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/subAccount/historyOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/futures/subAccount/userTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/account/deposit/address': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/account/depositOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'api/v1/account/withdrawOrders': { 'cost': 1 } as EndpointSpec<List>,
                    },
                    'post': {
                        'api/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/spot/orderTest': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/spot/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1.1/spot/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/spot/batchOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/futures/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/marginType': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/positionMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/position/trading-stop': { 'cost': 3 } as EndpointSpec<Dict>,
                        'api/v1/futures/batchOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/account/assetTransfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/account/authAddress': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/account/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'api/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'api/v1/spot/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/spot/openOrders': { 'cost': 5 } as EndpointSpec<List>,
                        'api/v1/spot/cancelOrderByIds': { 'cost': 5 } as EndpointSpec<Dict>,
                        'api/v1/futures/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/batchOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/futures/cancelOrderByIds': { 'cost': 1 } as EndpointSpec<Dict>,
                        'api/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
    ...
    override parseOrder (order: Dict, market: Market = undefined): Order {
        ...
        return this.safeOrder ({
            ...
            'price': price,
            'average': average,
            'amount': this.omitZero (this.safeString (order, 'origQty') as string),
            'filled': this.safeString (order, 'executedQty'),
            'remaining': undefined,
            'triggerPrice': this.omitZero (this.safeString (order, 'stopPrice') as string),
            'takeProfitPrice': undefined,
            'stopLossPrice': undefined,
            'cost': this.omitZero (this.safeString2 (order, 'cumulativeQuoteQty', 'cummulativeQuoteQty') as string),
            'trades': undefined,
            'fee': {
                'currency': this.safeCurrencyCode (feeCurrncyId),
    ...
    override async fetchLeverage (symbol: string, params = {}): Promise<Leverage> {
        ...
        //     ]
        //
        const leverage = this.safeDict (response, 0, {}) as Dict;
    ...
    override handleErrors (code: int, reason: string, url: any, method: any, headers: any, body: any, response: any, requestHeaders: any, requestBody: any) {
        ...
        if (responseCodeInteger === 0) {
            const result = this.safeList (response, 'result', []) as List; // for batch methods
            for (let i = 0; i < result.length; i++) {
