        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'spot': {
                    'public': {
                        'get': {
                            ...
                            'defaultSymbols': { 'cost': 1, 'returnType': 'Dict' },
                            'symbol/offline': { 'cost': 10, 'returnType': 'Dict' },
                            'exchangeInfo': { 'cost': 25, 'returnType': 'Dict' },
                            'depth': { 'cost': 3, 'returnType': 'Dict' },
                            'trades': { 'cost': 5, 'returnType': 'List' },
                            'historicalTrades': { 'cost': 1, 'returnType': 'List' },
                    ...
                    'private': {
                        'get': {
                            'kyc/status': { 'cost': 1, 'returnType': 'Dict' },
                            'uid': { 'cost': 1, 'returnType': 'Dict' },
                            'order': { 'cost': 2, 'returnType': 'Dict' },
                            'openOrders': { 'cost': 3, 'returnType': 'List' },
                            'allOrders': { 'cost': 10, 'returnType': 'Dict' },
                            'account': { 'cost': 10, 'returnType': 'Dict' },
                            'myTrades': { 'cost': 10, 'returnType': 'List' },
                            'strategy/group': { 'cost': 20, 'returnType': 'Dict' },
                            'strategy/group/uid': { 'cost': 20, 'returnType': 'Dict' },
                            'tradeFee': { 'cost': 20, 'returnType': 'Dict' },
                            'sub-account/list': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/apiKey': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/asset': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/config/getall': { 'cost': 10, 'returnType': 'List' },
                            'capital/deposit/hisrec': { 'cost': 10, 'returnType': 'List' },
                            'capital/withdraw/history': { 'cost': 1, 'returnType': 'List' },
                            'capital/withdraw/address': { 'cost': 10, 'returnType': 'Dict' },
                            'capital/deposit/address': { 'cost': 10, 'returnType': 'List' },
                            'capital/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/transfer/tranId': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/transfer/internal': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/sub-account/universalTransfer': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/convert': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/convert/list': { 'cost': 1, 'returnType': 'List' },
                            'margin/loan': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/allOrders': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/myTrades': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/openOrders': { 'cost': 1, 'returnType': 'List' },
                            'margin/maxTransferable': { 'cost': 1, 'returnType': 'Dict' },
                            ...
                            'margin/forceLiquidationRec': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/isolatedMarginData': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/isolatedMarginTier': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/taxQuery': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/detail': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/detail/kickback': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/referCode': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/commission': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/commission/detail': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/campaign': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/referral': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/subaffiliates': { 'cost': 1, 'returnType': 'Dict' },
                            'rebate/affiliate/list': { 'cost': 1, 'returnType': 'Dict' },
                            'mxDeduct/enable': { 'cost': 1, 'returnType': 'Dict' },
                            'userDataStream': { 'cost': 1, 'returnType': 'Dict' },
                            'selfSymbols': { 'cost': 1, 'returnType': 'Dict' },
                            'asset/internal/transfer/record': { 'cost': 10, 'returnType': 'Dict' },
                        },
                        'post': {
                            'order': { 'cost': 1, 'returnType': 'Dict' },
                            'order/test': { 'cost': 1, 'returnType': 'Dict' },
                            'apiKeyInfo': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/virtualSubAccount': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/apiKey': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/futures': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/margin': { 'cost': 1, 'returnType': 'Dict' },
                            'batchOrders': { 'cost': 10, 'returnType': 'List' },
                            'strategy/group': { 'cost': 20, 'returnType': 'Dict' },
                            'capital/withdraw/apply': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/transfer': { 'cost': 50, 'returnType': 'Dict' },
                            'capital/transfer/internal': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/deposit/address': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/sub-account/universalTransfer': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/convert': { 'cost': 10, 'returnType': 'Dict' },
                            'mxDeduct/enable': { 'cost': 1, 'returnType': 'Dict' },
                            'userDataStream': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'put': {
                        ...
                        'delete': {
                            ...
                            'order/all': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/apiKey': { 'cost': 1, 'returnType': 'Dict' },
                            'strategy/group': { 'cost': 1, 'returnType': 'Dict' },
                            'strategy/group/uid': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/order': { 'cost': 1, 'returnType': 'List' },
                            'margin/openOrders': { 'cost': 1, 'returnType': 'Dict' }, // deprecated
                            'userDataStream': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                ...
                'contract': {
                    'public': {
                        'get': {
                            'ping': { 'cost': 2, 'returnType': 'Dict' },
                            'detail': { 'cost': 100, 'returnType': 'Dict' },
                            'support_currencies': { 'cost': 2, 'returnType': 'Dict' },
                            'depth/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'depth_commits/{symbol}/{limit}': { 'cost': 2, 'returnType': 'Dict' },
                            'index_price/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'fair_price/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'funding_rate/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'kline/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'kline/index_price/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'kline/fair_price/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'deals/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'ticker': { 'cost': 2, 'returnType': 'Dict' },
                            'risk_reverse': { 'cost': 2, 'returnType': 'Dict' },
                            'risk_reverse/history': { 'cost': 2, 'returnType': 'Dict' },
                            'funding_rate/history': { 'cost': 2, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            'account/assets': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/{currency}': { 'cost': 2, 'returnType': 'Dict' },
                            'account/transfer_record': { 'cost': 2, 'returnType': 'Dict' },
                            'account/profit_rate/{type}': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/{type}': { 'cost': 2, 'returnType': 'Dict' },
                            'account/feeDeductConfigs': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/yesterday_pnl': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/today_pnl': { 'cost': 2, 'returnType': 'Dict' },
                            'account/config/contractFeeDiscountConfig': { 'cost': 2, 'returnType': 'Dict' },
                            'order/fee_details': { 'cost': 2, 'returnType': 'Dict' },
                            'account/discountType': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/export': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset_book/order_deal_fee/total': { 'cost': 2, 'returnType': 'Dict' },
                            'account/contract/fee_rate': { 'cost': 2, 'returnType': 'Dict' },
                            'account/contract/zero_fee_rate': { 'cost': 2, 'returnType': 'Dict' }, // documentation removed 2026-05-22
                            'position/list/history_positions': { 'cost': 2, 'returnType': 'Dict' },
                            'position/open_positions': { 'cost': 2, 'returnType': 'Dict' },
                            'position/funding_records': { 'cost': 2, 'returnType': 'Dict' },
                            'position/position_mode': { 'cost': 2, 'returnType': 'Dict' },
                            'order/list/open_orders/{symbol}': { 'cost': 2, 'returnType': 'Dict' },
                            'order/list/open_orders': { 'cost': 2, 'returnType': 'Dict' },
                            'order/list/history_orders': { 'cost': 2, 'returnType': 'Dict' },
                            'order/list/order_deals/v3': { 'cost': 2, 'returnType': 'Dict' },
                            'order/external/{symbol}/{external_oid}': { 'cost': 2, 'returnType': 'Dict' },
                            'order/get/{order_id}': { 'cost': 2, 'returnType': 'Dict' },
                            'order/batch_query': { 'cost': 8, 'returnType': 'Dict' },
                            'order/deal_details/{order_id}': { 'cost': 2, 'returnType': 'Dict' },
                            'order/list/order_deals': { 'cost': 2, 'returnType': 'Dict' },
                            'order/list/close_orders': { 'cost': 2, 'returnType': 'Dict' },
                            'planorder/list/orders': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/list/orders': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/open_orders': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/order_details/{stop_order_id}': { 'cost': 2, 'returnType': 'Dict' },
                            'account/risk_limit': { 'cost': 2, 'returnType': 'Dict' }, // TO_DO: gets max/min position size, allowed sides, leverage, maintenance margin, initial margin, etc...
                            'account/tiered_fee_rate': { 'cost': 2, 'returnType': 'Dict' }, // TO_DO: taker/maker fees for account
                            'position/leverage': { 'cost': 2, 'returnType': 'Dict' },
                            'account/tiered_fee_rate/v2': { 'cost': 2, 'returnType': 'Dict' },
                            'trackorder/list/orders': { 'cost': 2, 'returnType': 'Dict' },
                            'market_maker/self_trade/blacklist': { 'cost': 2, 'returnType': 'Dict' },
                            'market_maker/self_trade/blacklist/search': { 'cost': 2, 'returnType': 'Dict' },
                        },
                        'post': {
                            'account/asset/analysis/v3': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/calendar/daily/v3': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/calendar/monthly/v3': { 'cost': 2, 'returnType': 'Dict' },
                            'account/asset/analysis/recent/v3': { 'cost': 2, 'returnType': 'Dict' },
                            'position/change_margin': { 'cost': 2, 'returnType': 'Dict' },
                            'position/change_auto_add_im': { 'cost': 2, 'returnType': 'Dict' },
                            'position/change_leverage': { 'cost': 2, 'returnType': 'Dict' },
                            'position/change_position_mode': { 'cost': 2, 'returnType': 'Dict' },
                            'position/reverse': { 'cost': 2, 'returnType': 'Dict' },
                            'position/close_all': { 'cost': 10, 'returnType': 'Dict' },
                            'order/create': { 'cost': 2, 'returnType': 'Dict' },
                            'order/submit': { 'cost': 2, 'returnType': 'Dict' },
                            'order/submit_batch': { 'cost': 40, 'returnType': 'Dict' },
                            'order/chase_limit_order': { 'cost': 40, 'returnType': 'Dict' },
                            'order/change_limit_order': { 'cost': 40, 'returnType': 'Dict' },
                            'order/cancel': { 'cost': 2, 'returnType': 'Dict' },
                            'order/batch_cancel_with_external': { 'cost': 2, 'returnType': 'Dict' },
                            'order/cancel_with_external': { 'cost': 2, 'returnType': 'Dict' },
                            'order/cancel_all': { 'cost': 2, 'returnType': 'Dict' },
                            'order/open_order_total_count': { 'cost': 2, 'returnType': 'Dict' },
                            'order/batch_query_with_external': { 'cost': 2, 'returnType': 'Dict' },
                            'account/change_risk_level': { 'cost': 2, 'returnType': 'Dict' },
                            'planorder/place': { 'cost': 2, 'returnType': 'Dict' },
                            'planorder/place/v2': { 'cost': 2, 'returnType': 'Dict' },
                            'planorder/cancel': { 'cost': 2, 'returnType': 'Dict' },
                            'planorder/cancel_all': { 'cost': 2, 'returnType': 'Dict' },
                            'planorder/change_stop_order': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/place': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/cancel': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/cancel_all': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/change_price': { 'cost': 2, 'returnType': 'Dict' },
                            'stoporder/change_plan_price': { 'cost': 2, 'returnType': 'Dict' },
                            'trackorder/place': { 'cost': 2, 'returnType': 'Dict' },
                            'trackorder/cancel': { 'cost': 2, 'returnType': 'Dict' },
                            'trackorder/change_order': { 'cost': 2, 'returnType': 'Dict' },
                            'market_maker/self_trade/blacklist/create': { 'cost': 2, 'returnType': 'Dict' },
                            'market_maker/self_trade/blacklist/update': { 'cost': 2, 'returnType': 'Dict' },
                            'market_maker/self_trade/blacklist/delete': { 'cost': 2, 'returnType': 'Dict' },
                        },
                    },
                },
                'spot2': {
                    'public': {
                        'get': {
                            'market/symbols': { 'cost': 1, 'returnType': 'Dict' },
                            'market/coin/list': { 'cost': 2, 'returnType': 'Dict' },
                            'common/timestamp': { 'cost': 1, 'returnType': 'Dict' },
                            'common/ping': { 'cost': 2, 'returnType': 'Dict' },
                            ...
                            'market/api_default_symbols': { 'cost': 2, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            ...
                            'order/query': { 'cost': 1, 'returnType': 'Dict' },
                            'order/deals': { 'cost': 1, 'returnType': 'Dict' },
                            'order/deal_detail': { 'cost': 1, 'returnType': 'Dict' },
                            'asset/deposit/address/list': { 'cost': 2, 'returnType': 'Dict' },
                            'asset/deposit/list': { 'cost': 2, 'returnType': 'Dict' },
                            'asset/address/list': { 'cost': 2, 'returnType': 'Dict' },
                            'asset/withdraw/list': { 'cost': 2, 'returnType': 'Dict' },
                            'asset/internal/transfer/record': { 'cost': 10, 'returnType': 'Dict' },
                            'account/balance': { 'cost': 10, 'returnType': 'Dict' },
                            'asset/internal/transfer/info': { 'cost': 10, 'returnType': 'Dict' },
                            'market/api_symbols': { 'cost': 2, 'returnType': 'Dict' },
                        },
                        'post': {
                            'order/place': { 'cost': 1, 'returnType': 'Dict' },
                            'order/place_batch': { 'cost': 1, 'returnType': 'Dict' },
                            'order/advanced/place_batch': { 'cost': 1, 'returnType': 'Dict' },
                            'asset/withdraw': { 'cost': 2, 'returnType': 'Dict' },
                            'asset/internal/transfer': { 'cost': 10, 'returnType': 'Dict' },
                        },
                        'delete': {
                            'order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                            'order/cancel_by_symbol': { 'cost': 1, 'returnType': 'Dict' },
                            'asset/withdraw': { 'cost': 2, 'returnType': 'Dict' },
                        },
                    },
                },
                'broker': {
                    'private': {
                        'get': {
                            'sub-account/universalTransfer': { 'cost': 1, 'returnType': 'List' },
                            'sub-account/list': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/status': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/apiKey': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/deposit/subAddress': { 'cost': 1, 'returnType': 'List' },
                            'capital/deposit/subHisrec': { 'cost': 1, 'returnType': 'List' },
                            'capital/deposit/subHisrec/getall': { 'cost': 1, 'returnType': 'List' },
                            'rebate/taxQuery': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'sub-account/virtualSubAccount': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/apiKey': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/deposit/subAddress': { 'cost': 1, 'returnType': 'Dict' },
                            'capital/withdraw/apply': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/universalTransfer': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/futures': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'delete': {
                            'sub-account/apiKey': { 'cost': 1, 'returnType': 'Dict' },
