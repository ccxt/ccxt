        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'spot': {
                    'public': {
                        'get': {
                            ...
                            'defaultSymbols': { 'cost': 1 } as EndpointSpec<Dict>,
                            'symbol/offline': { 'cost': 10 } as EndpointSpec<Dict>,
                            'exchangeInfo': { 'cost': 25 } as EndpointSpec<Dict>,
                            'depth': { 'cost': 3 } as EndpointSpec<Dict>,
                            'trades': { 'cost': 5 } as EndpointSpec<List>,
                            'historicalTrades': { 'cost': 1 } as EndpointSpec<List>,
                            'aggTrades': { 'cost': 1 } as EndpointSpec<List>,
                            'klines': { 'cost': 1 } as EndpointSpec<Dict>,
                            'avgPrice': { 'cost': 1 } as EndpointSpec<Dict>,
                            'ticker/24hr': { 'cost': 25 } as EndpointSpec<List>,
                            'ticker/price': { 'cost': 10 } as EndpointSpec<Dict>,
                            'ticker/bookTicker': { 'cost': 10 } as EndpointSpec<List>,
                            'etf/info': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'kyc/status': { 'cost': 1 } as EndpointSpec<Dict>,
                            'uid': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order': { 'cost': 2 } as EndpointSpec<Dict>,
                            'openOrders': { 'cost': 3 } as EndpointSpec<List>,
                            'allOrders': { 'cost': 10 } as EndpointSpec<Dict>,
                            'account': { 'cost': 10 } as EndpointSpec<Dict>,
                            'myTrades': { 'cost': 10 } as EndpointSpec<List>,
                            'strategy/group': { 'cost': 20 } as EndpointSpec<Dict>,
                            'strategy/group/uid': { 'cost': 20 } as EndpointSpec<Dict>,
                            'tradeFee': { 'cost': 20 } as EndpointSpec<Dict>,
                            'sub-account/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/apiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/asset': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/config/getall': { 'cost': 10 } as EndpointSpec<List>,
                            'capital/deposit/hisrec': { 'cost': 10 } as EndpointSpec<List>,
                            'capital/withdraw/history': { 'cost': 1 } as EndpointSpec<List>,
                            'capital/withdraw/address': { 'cost': 10 } as EndpointSpec<Dict>,
                            'capital/deposit/address': { 'cost': 10 } as EndpointSpec<List>,
                            'capital/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/transfer/tranId': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/transfer/internal': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/sub-account/universalTransfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/convert': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/convert/list': { 'cost': 1 } as EndpointSpec<List>,
                            'margin/loan': { 'cost': 1 } as EndpointSpec<Dict>,
                            'margin/allOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'margin/myTrades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'margin/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                            'margin/maxTransferable': { 'cost': 1 } as EndpointSpec<Dict>,
                            ...
                            'margin/forceLiquidationRec': { 'cost': 1 } as EndpointSpec<Dict>,
                            'margin/isolatedMarginData': { 'cost': 1 } as EndpointSpec<Dict>,
                            'margin/isolatedMarginTier': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/taxQuery': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/detail/kickback': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/referCode': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/commission': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/commission/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/campaign': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/referral': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/subaffiliates': { 'cost': 1 } as EndpointSpec<Dict>,
                            'rebate/affiliate/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'mxDeduct/enable': { 'cost': 1 } as EndpointSpec<Dict>,
                            'userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                            'selfSymbols': { 'cost': 1 } as EndpointSpec<Dict>,
                            'asset/internal/transfer/record': { 'cost': 10 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/test': { 'cost': 1 } as EndpointSpec<Dict>,
                            'apiKeyInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/virtualSubAccount': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/apiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/futures': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/margin': { 'cost': 1 } as EndpointSpec<Dict>,
                            'batchOrders': { 'cost': 10 } as EndpointSpec<List>,
                            'strategy/group': { 'cost': 20 } as EndpointSpec<Dict>,
                            'capital/withdraw/apply': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/transfer': { 'cost': 50 } as EndpointSpec<Dict>,
                            'capital/transfer/internal': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/deposit/address': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/sub-account/universalTransfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/convert': { 'cost': 10 } as EndpointSpec<Dict>,
                            'mxDeduct/enable': { 'cost': 1 } as EndpointSpec<Dict>,
                            'userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'put': {
                        ...
                        'delete': {
                            ...
                            'order/all': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/apiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                            'strategy/group': { 'cost': 1 } as EndpointSpec<Dict>,
                            'strategy/group/uid': { 'cost': 1 } as EndpointSpec<Dict>,
                            'margin/order': { 'cost': 1 } as EndpointSpec<List>,
                            'margin/openOrders': { 'cost': 1 } as EndpointSpec<Dict>, // deprecated
                            'userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                ...
                'contract': {
                    'public': {
                        'get': {
                            'ping': { 'cost': 2 } as EndpointSpec<Dict>,
                            'detail': { 'cost': 100 } as EndpointSpec<Dict>,
                            'support_currencies': { 'cost': 2 } as EndpointSpec<Dict>,
                            'depth/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'depth_commits/{symbol}/{limit}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'index_price/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'fair_price/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'funding_rate/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'kline/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'kline/index_price/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'kline/fair_price/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'deals/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'ticker': { 'cost': 2 } as EndpointSpec<Dict>,
                            'risk_reverse': { 'cost': 2 } as EndpointSpec<Dict>,
                            'risk_reverse/history': { 'cost': 2 } as EndpointSpec<Dict>,
                            'funding_rate/history': { 'cost': 2 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'account/assets': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/{currency}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/transfer_record': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/profit_rate/{type}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/{type}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/feeDeductConfigs': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/yesterday_pnl': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/today_pnl': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/config/contractFeeDiscountConfig': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/fee_details': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/discountType': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/export': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset_book/order_deal_fee/total': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/contract/fee_rate': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/contract/zero_fee_rate': { 'cost': 2 } as EndpointSpec<Dict>, // documentation removed 2026-05-22
                            'position/list/history_positions': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/open_positions': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/funding_records': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/position_mode': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/list/open_orders/{symbol}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/list/open_orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/list/history_orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/list/order_deals/v3': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/external/{symbol}/{external_oid}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/get/{order_id}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/batch_query': { 'cost': 8 } as EndpointSpec<Dict>,
                            'order/deal_details/{order_id}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/list/order_deals': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/list/close_orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'planorder/list/orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/list/orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/open_orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/order_details/{stop_order_id}': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/risk_limit': { 'cost': 2 } as EndpointSpec<Dict>, // TO_DO: gets max/min position size, allowed sides, leverage, maintenance margin, initial margin, etc...
                            'account/tiered_fee_rate': { 'cost': 2 } as EndpointSpec<Dict>, // TO_DO: taker/maker fees for account
                            'position/leverage': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/tiered_fee_rate/v2': { 'cost': 2 } as EndpointSpec<Dict>,
                            'trackorder/list/orders': { 'cost': 2 } as EndpointSpec<Dict>,
                            'market_maker/self_trade/blacklist': { 'cost': 2 } as EndpointSpec<Dict>,
                            'market_maker/self_trade/blacklist/search': { 'cost': 2 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'account/asset/analysis/v3': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/calendar/daily/v3': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/calendar/monthly/v3': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/asset/analysis/recent/v3': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/change_margin': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/change_auto_add_im': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/change_leverage': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/change_position_mode': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/reverse': { 'cost': 2 } as EndpointSpec<Dict>,
                            'position/close_all': { 'cost': 10 } as EndpointSpec<Dict>,
                            'order/create': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/submit': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/submit_batch': { 'cost': 40 } as EndpointSpec<Dict>,
                            'order/chase_limit_order': { 'cost': 40 } as EndpointSpec<Dict>,
                            'order/change_limit_order': { 'cost': 40 } as EndpointSpec<Dict>,
                            'order/cancel': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/batch_cancel_with_external': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/cancel_with_external': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/cancel_all': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/open_order_total_count': { 'cost': 2 } as EndpointSpec<Dict>,
                            'order/batch_query_with_external': { 'cost': 2 } as EndpointSpec<Dict>,
                            'account/change_risk_level': { 'cost': 2 } as EndpointSpec<Dict>,
                            'planorder/place': { 'cost': 2 } as EndpointSpec<Dict>,
                            'planorder/place/v2': { 'cost': 2 } as EndpointSpec<Dict>,
                            'planorder/cancel': { 'cost': 2 } as EndpointSpec<Dict>,
                            'planorder/cancel_all': { 'cost': 2 } as EndpointSpec<Dict>,
                            'planorder/change_stop_order': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/place': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/cancel': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/cancel_all': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/change_price': { 'cost': 2 } as EndpointSpec<Dict>,
                            'stoporder/change_plan_price': { 'cost': 2 } as EndpointSpec<Dict>,
                            'trackorder/place': { 'cost': 2 } as EndpointSpec<Dict>,
                            'trackorder/cancel': { 'cost': 2 } as EndpointSpec<Dict>,
                            'trackorder/change_order': { 'cost': 2 } as EndpointSpec<Dict>,
                            'market_maker/self_trade/blacklist/create': { 'cost': 2 } as EndpointSpec<Dict>,
                            'market_maker/self_trade/blacklist/update': { 'cost': 2 } as EndpointSpec<Dict>,
                            'market_maker/self_trade/blacklist/delete': { 'cost': 2 } as EndpointSpec<Dict>,
                        },
                    },
                },
                'spot2': {
                    'public': {
                        'get': {
                            'market/symbols': { 'cost': 1 } as EndpointSpec<Dict>,
                            'market/coin/list': { 'cost': 2 } as EndpointSpec<Dict>,
                            'common/timestamp': { 'cost': 1 } as EndpointSpec<Dict>,
                            'common/ping': { 'cost': 2 } as EndpointSpec<Dict>,
                            ...
                            'market/api_default_symbols': { 'cost': 2 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            ...
                            'order/query': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/deals': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/deal_detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'asset/deposit/address/list': { 'cost': 2 } as EndpointSpec<Dict>,
                            'asset/deposit/list': { 'cost': 2 } as EndpointSpec<Dict>,
                            'asset/address/list': { 'cost': 2 } as EndpointSpec<Dict>,
                            'asset/withdraw/list': { 'cost': 2 } as EndpointSpec<Dict>,
                            'asset/internal/transfer/record': { 'cost': 10 } as EndpointSpec<Dict>,
                            'account/balance': { 'cost': 10 } as EndpointSpec<Dict>,
                            'asset/internal/transfer/info': { 'cost': 10 } as EndpointSpec<Dict>,
                            'market/api_symbols': { 'cost': 2 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'order/place': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/place_batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/advanced/place_batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'asset/withdraw': { 'cost': 2 } as EndpointSpec<Dict>,
                            'asset/internal/transfer': { 'cost': 10 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/cancel_by_symbol': { 'cost': 1 } as EndpointSpec<Dict>,
                            'asset/withdraw': { 'cost': 2 } as EndpointSpec<Dict>,
                        },
                    },
                },
                'broker': {
                    'private': {
                        'get': {
                            'sub-account/universalTransfer': { 'cost': 1 } as EndpointSpec<List>,
                            'sub-account/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/status': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/apiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/deposit/subAddress': { 'cost': 1 } as EndpointSpec<List>,
                            'capital/deposit/subHisrec': { 'cost': 1 } as EndpointSpec<List>,
                            'capital/deposit/subHisrec/getall': { 'cost': 1 } as EndpointSpec<List>,
                            'rebate/taxQuery': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'sub-account/virtualSubAccount': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/apiKey': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/deposit/subAddress': { 'cost': 1 } as EndpointSpec<Dict>,
                            'capital/withdraw/apply': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/universalTransfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/futures': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'sub-account/apiKey': { 'cost': 1 } as EndpointSpec<Dict>,
