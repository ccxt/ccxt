        ...
        return this.deepExtend (super.describe (), {
            ...
            'options': {
                ...
                'networks': {
                    ...
                    'FANTOM': 'FTM',
                    'WAVES': 'WAVES',
                    'CHILIZ': 'Chiliz Chain(CHZ)',
                    'HRC20': 'HECO',
                    'DASH': 'DASH',
                    'LTC': 'LTC',
                    // 'DOGECOIN': [ 'DOGE', 'DOGECHAIN' ], // todo after unification
                    'AVALANCHE_X': 'AVAX_XCHAIN',
                    'TEZOS': 'XTZ',
                    'OMNI': 'OMNI',
                    'APTOS': 'APTOS',
                    'ONTOLOGY': 'ONT',
                    ...
                    'ZCASH': 'ZEC',
                    'ACALA': 'ACALA',
                    'ASTAR': 'ASTAR', // ASTAREVM is different
                    'FILECOIN': 'FIL',
                    'NEAR': 'NEAR',
                    'OSMOSIS': 'OSMO',
                    'SHIDEN': 'SDN',
                    ...
                    'WAX': 'WAX',
                    'KARURA': 'KAR',
                    // the below will be uncommented will be exposed later, after unification
                    // 'KUJIRA': 'KUJI',
                    // 'HUAHUA': 'HUAHUA',
                    // 'CARDANO': 'ADA',
                    // 'WEMIX': 'WEMIX',
                ...
                'networksById': {
                    ...
                    'FTM': 'FANTOM',
                    'WAVES': 'WAVES',
                    'Chiliz Chain(CHZ)': 'CHILIZ',
                    'HECO': 'HRC20',
                    'DASH': 'DASH',
                    'LTC': 'LTC',
                    'AVAX_XCHAIN': 'AVALANCHE_X',
                    'XTZ': 'TEZOS',
                    'OMNI': 'OMNI',
                    'APTOS': 'APTOS',
                    'ONT': 'ONTOLOGY',
