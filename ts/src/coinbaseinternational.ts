                ...
                'v1': {
                    'public': {
                        'get': {
                            ...
                            'assets/{assets}': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/{asset}/networks': { 'cost': 1, 'returnType': 'List' },
                            'instruments': { 'cost': 1, 'returnType': 'List' },
                            'instruments/{instrument}': { 'cost': 1, 'returnType': 'Dict' },
                            'instruments/{instrument}/quote': { 'cost': 1, 'returnType': 'Dict' },
                            'instruments/{instrument}/funding': { 'cost': 1, 'returnType': 'Dict' },
                            'instruments/{instrument}/candles': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            ...
                            'portfolios': { 'cost': 1, 'returnType': 'List' },
                            'portfolios/{portfolio}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/detail': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/summary': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/balances': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/balances/{asset}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/positions': { 'cost': 1, 'returnType': 'List' },
                            'portfolios/{portfolio}/positions/{instrument}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/fills': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/fills': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/{transfer_uuid}': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/margin': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/address': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/create-counterparty-id': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/validate-counterparty-id': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/withdraw/counterparty': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'put': {
                            'orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}': { 'cost': 1, 'returnType': 'Dict' },
