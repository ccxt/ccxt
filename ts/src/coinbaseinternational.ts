...
import type { Int, Num, OrderSide, OrderType, Order, Trade, Ticker, Str, Transaction, Balances, Bool, Tickers, Strings, List, Market, Currency, CurrencyInterface, TransferEntry, Position, FundingRateHistory, Currencies, Dict, NullableDict, int, OHLCV, DepositAddress, MarginModification, EndpointSpec } from './base/types.js';
...
export default class coinbaseinternational extends Exchange {
                ...
                'v1': {
                    'public': {
                        'get': {
                            ...
                            'assets/{assets}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'assets/{asset}/networks': { 'cost': 1 } as EndpointSpec<List>,
                            'instruments': { 'cost': 1 } as EndpointSpec<List>,
                            'instruments/{instrument}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'instruments/{instrument}/quote': { 'cost': 1 } as EndpointSpec<Dict>,
                            'instruments/{instrument}/funding': { 'cost': 1 } as EndpointSpec<Dict>,
                            'instruments/{instrument}/candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            ...
                            'portfolios': { 'cost': 1 } as EndpointSpec<List>,
                            'portfolios/{portfolio}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}/balances': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}/balances/{asset}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}/positions': { 'cost': 1 } as EndpointSpec<List>,
                            'portfolios/{portfolio}/positions/{instrument}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/fills': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}/fills': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers/{transfer_uuid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/margin': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers/address': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers/create-counterparty-id': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers/validate-counterparty-id': { 'cost': 1 } as EndpointSpec<Dict>,
                            'transfers/withdraw/counterparty': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'put': {
                            'orders/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'portfolios/{portfolio}': { 'cost': 1 } as EndpointSpec<Dict>,
     ...
     */
    override async fetchAccounts (params = {}) {
