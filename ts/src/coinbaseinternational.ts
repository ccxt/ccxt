                ...
                'v1': {
                    ...
                    'private': {
                        'get': {
                            ...
                            'portfolios/{portfolio}/detail': 1,
                            'portfolios/{portfolio}/summary': 1,
                            'portfolios/{portfolio}/balances': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}/balances/{asset}': 1,
                            ...
                            'portfolios/{portfolio}/fills': 1,
                            'transfers': { 'cost': 1, 'returnType': 'Dict' },
                            'transfers/{transfer_uuid}': 1,
                        },
                        'post': {
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios': 1,
                            ...
                            'transfers/withdraw': 1,
                            'transfers/address': 1,
                            'transfers/create-counterparty-id': 1,
                            'transfers/validate-counterparty-id': 1,
                            'transfers/withdraw/counterparty': 1,
                        },
                        'put': {
                            'orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                            'portfolios/{portfolio}': 1,
