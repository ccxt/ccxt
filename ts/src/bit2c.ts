    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'Exchanges/{pair}/Ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'Exchanges/{pair}/orderbook': { 'cost': 1, 'returnType': 'Dict' },
                        'Exchanges/{pair}/trades': { 'cost': 1, 'returnType': 'List' },
                        'Exchanges/{pair}/lasttrades': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'private': {
                    'post': {
                        'Merchant/CreateCheckout': { 'cost': 1, 'returnType': 'Dict' },
                        'Funds/AddCoinFundsRequest': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AddFund': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AddOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/GetById': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AddOrderMarketPriceBuy': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AddOrderMarketPriceSell': { 'cost': 1, 'returnType': 'Dict' },
                    ...
                    'get': {
                        ...
                        'Account/Balance/v2': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/MyOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/GetById': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AccountHistory': { 'cost': 1, 'returnType': 'List' },
                        'Order/OrderHistory': { 'cost': 1, 'returnType': 'List' },
                    },
                },
            },
            'markets': {
