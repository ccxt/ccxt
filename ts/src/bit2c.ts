            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'Exchanges/{pair}/trades': 1,
                        'Exchanges/{pair}/lasttrades': 1,
                    },
                },
                'private': {
                    'post': {
                        'Merchant/CreateCheckout': 1,
                        'Funds/AddCoinFundsRequest': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AddFund': 1,
                        'Order/AddOrder': 1,
                        'Order/GetById': 1,
                        'Order/AddOrderMarketPriceBuy': 1,
                        'Order/AddOrderMarketPriceSell': 1,
                        'Order/CancelOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'Order/AddCoinFundsRequest': 1,
                        'Order/AddStopOrder': 1,
                        'Payment/GetMyId': 1,
                        'Payment/Send': 1,
                        'Payment/Pay': 1,
                    },
