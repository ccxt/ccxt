...
import { AuthenticationError, ExchangeError, ArgumentsRequired, PermissionDenied, InvalidOrder, OrderNotFound, InsufficientFunds, BadRequest, RateLimitExceeded, InvalidNonce, NotSupported, RequestTimeout, BadSymbol, MarginModeAlreadySet } from './base/errors.js';
        ...
        return this.deepExtend (super.describe (), {
            ...
            'exceptions': {
                ...
                'exact': {
                    ...
                    '110025': BadRequest, // Position mode is not modified
                    '110026': BadRequest, // Cross/isolated margin mode is not modified
                    '110027': MarginModeAlreadySet, // Margin is not modified
