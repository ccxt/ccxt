...
export default class bybit extends Exchange {
     ...
     * @param {boolean} [params.rpiTakerAccess] set to true to let a taker order match against retail price improvement quotes (https://announcements.bybit.com/en/article/rpi-liquidity-now-available-to-api-taker-orders-bltb943887bfa4c4d17/), supported order combinations: (1) orderType=Market; (2) orderType=Limit with timeInForce=IOC or FOK
     * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
     */
