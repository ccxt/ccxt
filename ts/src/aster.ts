    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'fapiPublic': {
                    'get': {
                        'v1/ping': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/ping': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/exchangeInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/exchangeInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/depth': { 'cost': 2 } as EndpointSpec<Dict>, // dynamic: 5, 10, 20, 50->2, 100->5, 500->10, 1000->20
                        'v1/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/historicalTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/historicalTrades': { 'cost': 20 } as EndpointSpec<List>,
                        'v1/aggTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/aggTrades': { 'cost': 20 } as EndpointSpec<List>,
                        'v1/klines': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/klines': { 'cost': 1 } as EndpointSpec<List>, // dynamic [1,100) ->1,  [100, 500)->2, [500, 1000]->5, [1000 -> 10
                        'v1/indexPriceKlines': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/indexPriceKlines': { 'cost': 1 } as EndpointSpec<List>, // same as klines
                        'v1/markPriceKlines': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/markPriceKlines': { 'cost': 1 } as EndpointSpec<List>, // same as klines
                        'v1/premiumIndex': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/premiumIndex': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fundingRate': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/fundingRate': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/fundingInfo': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/fundingInfo': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/ticker/24hr': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/ticker/24hr': { 'cost': 1 } as EndpointSpec<List>, // 1 single-symbol, otherwise 40
                        'v1/ticker/price': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/ticker/price': { 'cost': 1 } as EndpointSpec<List>, // 1 single-symbol, otherwise 2
                        'v1/ticker/bookTicker': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/ticker/bookTicker': { 'cost': 1 } as EndpointSpec<List>, // 1 single-symbol, otherwise 2
                        // different endpoints
                        'v1/adlQuantile': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/forceOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/indexreferences': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'fapiPrivate': {
                    'get': {
                        'v1/positionSide/dual': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/positionSide/dual': { 'cost': 30 } as EndpointSpec<Dict>,
                        'v1/multiAssetsMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/multiAssetsMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/openOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/openOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/allOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/allOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v2/balance': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/positionMargin/history': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/positionMargin/history': { 'cost': 1 } as EndpointSpec<List>,
                        'v2/positionRisk': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/positionRisk': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/userTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/userTrades': { 'cost': 5 } as EndpointSpec<List>,
                        'v1/income': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/income': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/leverageBracket': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/leverageBracket': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/commissionRate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/commissionRate': { 'cost': 1 } as EndpointSpec<Dict>,
                        // others
                        'v3/adlQuantile': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/forceOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/mmp': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/accountWithJoinMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v4/account': { 'cost': 1 } as EndpointSpec<Dict>,
                        // builder
                        'v3/agent': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/builder': { 'cost': 1 } as EndpointSpec<List>,
                    },
                    'post': {
                        'v1/positionSide/dual': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/positionSide/dual': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/multiAssetsMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/multiAssetsMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/order/test': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/order/test': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/batchOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/batchOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/asset/wallet/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/asset/wallet/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/countdownCancelAll': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/countdownCancelAll': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/marginType': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/marginType': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/positionMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/positionMargin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        // others
                        'v3/mmp': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/mmpReset': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/noop': { 'cost': 1 } as EndpointSpec<Dict>,
                        // builder
                        'v3/approveAgent': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/updateAgent': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/approveBuilder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/updateBuilder': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'delete': {
                        'v1/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/allOpenOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/allOpenOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/batchOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/batchOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/mmp': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        // builder
                        'v3/agent': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/builder': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'sapiPublic': {
                    'get': {
                        ...
                        'v1/ticker/price': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/ticker/bookTicker': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/aster/withdraw/estimateFee': { 'cost': 1 } as EndpointSpec<Dict>,
                        // v3
                        'v3/ping': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/exchangeInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/depth': { 'cost': 2, 'byLimit': [ [ 50, 2 ], [ 100, 5 ], [ 500, 10 ], [ 1000, 20 ] ] } as EndpointSpec<Dict>,
                        'v3/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/historicalTrades': { 'cost': 20 } as EndpointSpec<List>,
                        'v3/aggTrades': { 'cost': 20 } as EndpointSpec<List>,
                        'v3/klines': { 'cost': 1, 'byLimit': [ [ 99, 1 ], [ 499, 2 ], [ 1000, 5 ], [ 10000, 10 ] ] } as EndpointSpec<List>, // todo: not specified in docs
                        'v3/ticker/24hr': { 'cost': 1, 'noSymbol': 40 } as EndpointSpec<List>,
                        'v3/ticker/price': { 'cost': 1, 'noSymbol': 2 } as EndpointSpec<List>,
                        'v3/ticker/bookTicker': { 'cost': 1, 'noSymbol': 2 } as EndpointSpec<List>,
                        'v3/aster/withdraw/estimateFee': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'sapiPrivate': {
                    'get': {
                        ...
                        'v1/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/allOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/transactionHistory': { 'cost': 1 } as EndpointSpec<List>,
                        'v1/account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/userTrades': { 'cost': 1 } as EndpointSpec<List>,
                        // v3
                        'v3/commissionRate': { 'cost': 1, 'noSymbol': 2 } as EndpointSpec<Dict>,
                        'v3/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/openOrders': { 'cost': 1 } as EndpointSpec<List>, // with symbol 1, otherwise 40
                        'v3/allOrders': { 'cost': 5 } as EndpointSpec<List>,
                        'v3/account': { 'cost': 5 } as EndpointSpec<Dict>,
                        'v3/userTrades': { 'cost': 5 } as EndpointSpec<List>,
                        'v3/openOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        // v1
                        'v1/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/asset/wallet/transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                        'v1/asset/sendToAddress': { 'cost': 1 } as EndpointSpec<Dict>, // inexistent in v3
                        'v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        // v3
                        'v3/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/asset/wallet/transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                        'v3/aster/user-withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'delete': {
                        ...
                        'v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                        // v3
                        'v3/allOpenOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'v3/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v3/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
