        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'spot': {
                    'public': {
                        'get': {
                            'currencyPairs': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'accuracy': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'usdToCny': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'assetConfigs': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'withdrawConfigs': { 'cost': 2.5 * 1.5 } as EndpointSpec<Dict>, // frequently rate-limits, so increase this endpoint RL
                            'timestamp': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'ticker/24hr': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'ticker': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'depth': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'incrDepth': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'trades': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'kline': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            // new quote endpoints
                            'supplement/system_ping': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/incrDepth': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/trades': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/ticker/price': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/ticker/bookTicker': { 'cost': 2.5 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'supplement/system_status': { 'cost': 2.5 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'post': {
                            // account
                            'user_info': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'subscribe/get_key': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'subscribe/refresh_key': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'subscribe/destroy_key': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'get_deposit_address': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'deposit_history': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            // order
                            'create_order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'batch_create_order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'cancel_order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'cancel_clientOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders_info': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'orders_info_history': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'order_transaction_detail': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'transaction_history': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'orders_info_no_deal': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            // withdraw
                            'withdraw': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'withdrawCancel': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'withdraws': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/user_info': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/withdraw': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/deposit_history': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/withdraws': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/get_deposit_address': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/asset_detail': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/customer_trade_fee': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/api_Restrictions': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            // new quote endpoints
                            'supplement/system_ping': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            // new order endpoints
                            'supplement/create_order_test': { 'cost': 1 } as EndpointSpec<Dict>,
                            'supplement/create_order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'supplement/cancel_order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'supplement/cancel_order_by_symbol': { 'cost': 1 } as EndpointSpec<Dict>,
                            'supplement/orders_info': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/orders_info_no_deal': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/orders_info_history': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/user_info_account': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'supplement/transaction_history': { 'cost': 2.5 } as EndpointSpec<Dict>,
                        },
                    },
                },
                'contract': {
                    'public': {
                        'get': {
                            'cfd/openApi/v1/pub/getTime': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'cfd/openApi/v1/pub/instrument': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'cfd/openApi/v1/pub/marketData': { 'cost': 2.5 } as EndpointSpec<Dict>,
                            'cfd/openApi/v1/pub/marketOrder': { 'cost': 2.5 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
