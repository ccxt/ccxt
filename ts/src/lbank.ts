        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'spot': {
                    'public': {
                        'get': {
                            'currencyPairs.do': 2.5,
                            'accuracy.do': 2.5,
                            'usdToCny.do': 2.5,
                            'assetConfigs.do': 2.5,
                            'withdrawConfigs.do': 2.5,
                            'timestamp.do': 2.5,
                            'ticker/24hr.do': 2.5,
                            'ticker.do': 2.5,
                            'depth.do': 2.5,
                            ...
                            'kline.do': 2.5,
                            // new quote endpoints
                            'supplement/system_ping.do': 2.5,
                            'supplement/incrDepth.do': 2.5,
                            'supplement/trades.do': 2.5,
                            'supplement/ticker/price.do': 2.5,
                            'supplement/ticker/bookTicker.do': 2.5,
                        },
                        'post': {
                            'supplement/system_status.do': 2.5,
                        },
                    },
                    'private': {
                        'post': {
                            // account
                            'user_info.do': 2.5,
                            'subscribe/get_key.do': 2.5,
                            'subscribe/refresh_key.do': 2.5,
                            'subscribe/destroy_key.do': 2.5,
                            'get_deposit_address.do': 2.5,
                            'deposit_history.do': 2.5,
                            // order
                            'create_order.do': 1,
                            'batch_create_order.do': 1,
                            'cancel_order.do': 1,
                            'cancel_clientOrders.do': 1,
                            'orders_info.do': 2.5,
                            'orders_info_history.do': 2.5,
                            'order_transaction_detail.do': 2.5,
                            'transaction_history.do': 2.5,
                            'orders_info_no_deal.do': 2.5,
                            // withdraw
                            'withdraw.do': 2.5,
                            'withdrawCancel.do': 2.5,
                            'withdraws.do': 2.5,
                            'supplement/user_info.do': 2.5,
                            'supplement/withdraw.do': 2.5,
                            'supplement/deposit_history.do': 2.5,
                            'supplement/withdraws.do': 2.5,
                            'supplement/get_deposit_address': 2.5,
                            'supplement/asset_detail.do': 2.5,
                            'supplement/customer_trade_fee.do': 2.5,
                            'supplement/api_Restrictions.do': 2.5,
                            // new quote endpoints
                            'supplement/system_ping.do': 2.5,
                            // new order endpoints
                            'supplement/create_order_test.do': 1,
                            'supplement/create_order.do': 1,
                            'supplement/cancel_order.do': 1,
                            'supplement/cancel_order_by_symbol.do': 1,
                            'supplement/orders_info.do': 2.5,
                            'supplement/orders_info_no_deal.do': 2.5,
                            'supplement/orders_info_history.do': 2.5,
                            'supplement/user_info_account.do': 2.5,
                            'supplement/transaction_history.do': 2.5,
                        },
                    },
                },
                'contract': {
