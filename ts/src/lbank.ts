        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'spot': {
                    'public': {
                        'get': {
                            ...
                            'usdToCny': { 'cost': 2.5, 'returnType': 'Dict' },
                            ...
                            'ticker': { 'cost': 2.5, 'returnType': 'Dict' },
                            'depth': { 'cost': 2.5, 'returnType': 'Dict' },
                            'incrDepth': { 'cost': 2.5, 'returnType': 'Dict' },
                            'trades': { 'cost': 2.5, 'returnType': 'Dict' },
                            'kline': { 'cost': 2.5, 'returnType': 'Dict' },
                            // new quote endpoints
                            'supplement/system_ping': { 'cost': 2.5, 'returnType': 'Dict' },
                            'supplement/incrDepth': { 'cost': 2.5, 'returnType': 'Dict' },
                    ...
                    'private': {
                        'post': {
                            // account
                            'user_info': { 'cost': 2.5, 'returnType': 'Dict' },
                            ...
                            'deposit_history': { 'cost': 2.5, 'returnType': 'Dict' },
                            // order
                            'create_order': { 'cost': 1, 'returnType': 'Dict' },
                            'batch_create_order': { 'cost': 1, 'returnType': 'Dict' },
                            'cancel_order': { 'cost': 1, 'returnType': 'Dict' },
                            'cancel_clientOrders': { 'cost': 1, 'returnType': 'Dict' },
                            'orders_info': { 'cost': 2.5, 'returnType': 'Dict' },
                            'orders_info_history': { 'cost': 2.5, 'returnType': 'Dict' },
                            'order_transaction_detail': { 'cost': 2.5, 'returnType': 'Dict' },
                            'transaction_history': { 'cost': 2.5, 'returnType': 'Dict' },
                            'orders_info_no_deal': { 'cost': 2.5, 'returnType': 'Dict' },
                            // withdraw
                            'withdraw': { 'cost': 2.5, 'returnType': 'Dict' },
                            'withdrawCancel': { 'cost': 2.5, 'returnType': 'Dict' },
                            'withdraws': { 'cost': 2.5, 'returnType': 'Dict' },
                            'supplement/user_info': { 'cost': 2.5, 'returnType': 'Dict' },
                            'supplement/withdraw': { 'cost': 2.5, 'returnType': 'Dict' },
                ...
                'contract': {
                    'public': {
                        'get': {
                            'cfd/openApi/v1/pub/getTime': { 'cost': 2.5, 'returnType': 'Dict' },
                            'cfd/openApi/v1/pub/instrument': { 'cost': 2.5, 'returnType': 'Dict' },
                            'cfd/openApi/v1/pub/marketData': { 'cost': 2.5, 'returnType': 'Dict' },
                            'cfd/openApi/v1/pub/marketOrder': { 'cost': 2.5, 'returnType': 'Dict' },
                        },
                    },
                },
            },
