...
export default class bitstamp extends Exchange {
    ...
    override parseTransfer (transfer: Dict, currency: Currency = undefined) {
        //
        //    { status: 'ok' }
        //
