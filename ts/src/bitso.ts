    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'available_books': { 'cost': 1, 'returnType': 'Dict' },
                        'catalogues': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'private': {
                    'get': {
                        'account_status': { 'cost': 1, 'returnType': 'Dict' },
                        'balance': { 'cost': 1, 'returnType': 'Dict' },
                        'fees': { 'cost': 1, 'returnType': 'Dict' },
                        'fundings': { 'cost': 1, 'returnType': 'Dict' },
                        'fundings/{fid}': { 'cost': 1, 'returnType': 'Dict' },
                        'funding_destination': { 'cost': 1, 'returnType': 'Dict' },
                        'kyc_documents': { 'cost': 1, 'returnType': 'Dict' },
                        'ledger': { 'cost': 1, 'returnType': 'Dict' },
                        'ledger/trades': { 'cost': 1, 'returnType': 'Dict' },
                        'ledger/fees': { 'cost': 1, 'returnType': 'Dict' },
                        'ledger/fundings': { 'cost': 1, 'returnType': 'Dict' },
                        'ledger/withdrawals': { 'cost': 1, 'returnType': 'Dict' },
                        'mx_bank_codes': { 'cost': 1, 'returnType': 'Dict' },
                        'open_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'order_trades/{oid}': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/{oid}': { 'cost': 1, 'returnType': 'Dict' },
                        'user_trades': { 'cost': 1, 'returnType': 'Dict' },
                        'user_trades/{tid}': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/{wid}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'bitcoin_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'debit_card_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'ether_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'phone_number': { 'cost': 1, 'returnType': 'Dict' },
                        'phone_verification': { 'cost': 1, 'returnType': 'Dict' },
                        'phone_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'spei_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'ripple_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'bcash_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'litecoin_withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'delete': {
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/{oid}': { 'cost': 1, 'returnType': 'Dict' },
