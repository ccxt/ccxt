...
import type { Balances, Currency, CurrencyInterface, Dict, Int, Market, NullableDict, FeeString, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Trade, TradingFees, Transaction, Currencies, int, LedgerEntry, DepositAddress, List, DepositWithdrawFees, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'available_books': { 'cost': 1 } as EndpointSpec<Dict>,
                        'catalogues': { 'cost': 1 } as EndpointSpec<Dict>,
                ...
                'private': {
                    'get': {
                        'account_status': { 'cost': 1 } as EndpointSpec<Dict>,
                        'balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fundings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fundings/{fid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'funding_destination': { 'cost': 1 } as EndpointSpec<Dict>,
                        'kyc_documents': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ledger': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ledger/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ledger/fees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ledger/fundings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ledger/withdrawals': { 'cost': 1 } as EndpointSpec<Dict>,
                        'mx_bank_codes': { 'cost': 1 } as EndpointSpec<Dict>,
                        'open_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order_trades/{oid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/{oid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'user_trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'user_trades/{tid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/{wid}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'bitcoin_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'debit_card_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ether_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'phone_number': { 'cost': 1 } as EndpointSpec<Dict>,
                        'phone_verification': { 'cost': 1 } as EndpointSpec<Dict>,
                        'phone_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'spei_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ripple_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bcash_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'litecoin_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/{oid}': { 'cost': 1 } as EndpointSpec<Dict>,
