...
import type { Balances, Currency, Dict, Fee, FundingRate, Int, Market, MarketInterface, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Trade, TradingFeeInterface, Transaction, Position, int, List, NullableDict, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'getmarkets/usa': { 'cost': 1 } as EndpointSpec<List>,
                        'getmarkets/eu': { 'cost': 1 } as EndpointSpec<List>,
                        'getmarkets': { 'cost': 1 } as EndpointSpec<List>,
                        'getboard': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getexecutions': { 'cost': 1 } as EndpointSpec<List>,
                        'gethealth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getboardstate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getchats': { 'cost': 1 } as EndpointSpec<List>,
                        'getfundingrate': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        'getpermissions': { 'cost': 1 } as EndpointSpec<List>,
                        'getbalance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getbalancehistory': { 'cost': 1 } as EndpointSpec<List>,
                        'getcollateral': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getcollateralhistory': { 'cost': 1 } as EndpointSpec<List>,
                        'getcollateralaccounts': { 'cost': 1 } as EndpointSpec<List>,
                        'getaddresses': { 'cost': 1 } as EndpointSpec<List>,
                        'getcoinins': { 'cost': 1 } as EndpointSpec<List>,
                        'getcoinouts': { 'cost': 1 } as EndpointSpec<List>,
                        'getbankaccounts': { 'cost': 1 } as EndpointSpec<List>,
                        'getdeposits': { 'cost': 1 } as EndpointSpec<List>,
                        'getwithdrawals': { 'cost': 1 } as EndpointSpec<List>,
                        'getchildorders': { 'cost': 1 } as EndpointSpec<List>,
                        'getparentorders': { 'cost': 1 } as EndpointSpec<List>,
                        'getparentorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getexecutions': { 'cost': 1 } as EndpointSpec<List>,
                        'getpositions': { 'cost': 1 } as EndpointSpec<List>,
                        'gettradingcommission': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'sendcoin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sendchildorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelchildorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sendparentorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelparentorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelallchildorders': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
