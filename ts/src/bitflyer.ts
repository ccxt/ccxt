    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'getmarkets/usa': { 'cost': 1, 'returnType': 'List' },
                        'getmarkets/eu': { 'cost': 1, 'returnType': 'List' },
                        'getmarkets': { 'cost': 1, 'returnType': 'List' },
                        'getboard': { 'cost': 1, 'returnType': 'Dict' },
                        'getticker': { 'cost': 1, 'returnType': 'Dict' },
                        'getexecutions': { 'cost': 1, 'returnType': 'List' },
                        'gethealth': { 'cost': 1, 'returnType': 'Dict' },
                        'getboardstate': { 'cost': 1, 'returnType': 'Dict' },
                        'getchats': { 'cost': 1, 'returnType': 'List' },
                        'getfundingrate': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        'getpermissions': { 'cost': 1, 'returnType': 'List' },
                        'getbalance': { 'cost': 1, 'returnType': 'Dict' },
                        'getbalancehistory': { 'cost': 1, 'returnType': 'List' },
                        'getcollateral': { 'cost': 1, 'returnType': 'Dict' },
                        'getcollateralhistory': { 'cost': 1, 'returnType': 'List' },
                        'getcollateralaccounts': { 'cost': 1, 'returnType': 'List' },
                        'getaddresses': { 'cost': 1, 'returnType': 'List' },
                        'getcoinins': { 'cost': 1, 'returnType': 'List' },
                        'getcoinouts': { 'cost': 1, 'returnType': 'List' },
                        'getbankaccounts': { 'cost': 1, 'returnType': 'List' },
                        'getdeposits': { 'cost': 1, 'returnType': 'List' },
                        'getwithdrawals': { 'cost': 1, 'returnType': 'List' },
                        'getchildorders': { 'cost': 1, 'returnType': 'List' },
                        'getparentorders': { 'cost': 1, 'returnType': 'List' },
                        'getparentorder': { 'cost': 1, 'returnType': 'Dict' },
                        'getexecutions': { 'cost': 1, 'returnType': 'List' },
                        'getpositions': { 'cost': 1, 'returnType': 'List' },
                    ...
                    'post': {
                        ...
                        'sendparentorder': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelparentorder': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelallchildorders': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
