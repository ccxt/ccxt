...
export default class htx extends Exchange {
    ...
    async fetchBorrowRatesPerSymbol (params = {}) {
         ...
         * @param {object} [params] extra parameters specific to the huobi api endpoint
         * @returns {object} a dictionary of [borrow rate structures]{https://docs.ccxt.com/#/?id=borrow-rate-structure} indexed by market symbol
         */
        await this.loadMarkets ();
    ...
    async fetchOpenInterestHistory (symbol: string, timeframe = '1h', since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @returns {object} an array of [open interest structures]{https://docs.ccxt.com/#/?id=open-interest-structure}
         */
