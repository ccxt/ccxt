    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'ticker/ALL_{quoteId}': 1,
                        'ticker/{baseId}_{quoteId}': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbook/ALL_{quoteId}': 1,
                        'orderbook/{baseId}_{quoteId}': { 'cost': 1, 'returnType': 'Dict' },
                        'transaction_history/{baseId}_{quoteId}': { 'cost': 1, 'returnType': 'Dict' },
                        'network-info': 1,
                        'assetsstatus/multichain/ALL': 1,
                        'assetsstatus/multichain/{currency}': 1,
                        'withdraw/minimum/ALL': 1,
                        'withdraw/minimum/{currency}': 1,
                        'assetsstatus/ALL': 1,
                        'assetsstatus/{baseId}': 1,
