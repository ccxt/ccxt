...
import type { Balances, Bool, Currency, Dict, Fee, FeeString, FundingRate, FundingRateHistory, Int, int, Leverage, List, MarginMode, Market, Num, OHLCV, Order, OrderBook, OrderRequest, OrderSide, OrderType, Position, Str, Strings, Trade, Transaction, TransferEntry, Ticker, Tickers, PositionModeInfo, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'v1/public/api_limits': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/public#inquiry-into-api-rate-limit-configuration
                        'v1/fapi/market/exchange_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/klines': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/ticker/24hr': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/ticker/price': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/futures/market#latest-price
                        'v1/fapi/market/mark_price': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/futures/market#mark-price
                        'v1/fapi/market/funding_rate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/funding_rate_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/market/risk_limit': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/futures/market#risk-limit
                    },
                },
                'private': {
                    'get': {
                        'v1/account/assets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/account/transfer_records': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/spot/deposit_records': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/spot/withdraw_records': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/open_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/plan_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/history_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/history_trade': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/position_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/account/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/user_data/assets_margin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/user_data/position_side/dual': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/agent/teams': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#query-kol-subordinate-team-information
                        'v1/agent/agent_links': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#query-kol-invitation-code-list
                        'v1/agent/regular_overview': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#query-kol-direct-client-data-list
                        'v1/agent/agent_sub_overview': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#query-kol-subordinate-affiliate-list
                        'v1/agent/partener_user_deposit': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#check-the-recharge-amount-of-kol-within-one-year
                        'v1/agent/partener_users_data': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#query-kol-subordinate-deposit-and-trading-data
                        'v1/agent/affiliate_uids': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#get-affiliate-uids
                        'v1/agent/affiliate_commission': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#get-affiliate-commission
                        'v1/agent/internal_withdrawal_status': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#get-internal-withdrawal-status
                    },
                    'post': {
                        'v1/account/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/place_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/batch_place_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/edit_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/batch_edit_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/cancel_all_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/trade/batch_leverage_margin': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/futures/trade#modify-leverage-and-margin-type-with-one-click
                        'v1/fapi/user_data/margin_type': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/fapi/user_data/position_side/dual': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v1/agent/internal_withdrawal': { 'cost': 1 } as EndpointSpec<Dict>, // https://developers.bydfi.com/en/agent/#internal-withdrawal
                    },
                },
            },
            'features': {
