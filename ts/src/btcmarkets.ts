...
import type{ Balances, Currency, Dict, NullableDict, FeeString, List, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, Transaction, int, EndpointSpec } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'markets/{marketId}/ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{marketId}/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/{marketId}/orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{marketId}/candles': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/tickers': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/orderbooks': { 'cost': 1 } as EndpointSpec<List>,
                ...
                'private': {
                    'get': {
                        ...
                        'batchorders/{ids}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades': { 'cost': 1 } as EndpointSpec<List>,
                        'trades/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals': { 'cost': 1 } as EndpointSpec<List>,
                        'withdrawals/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deposits': { 'cost': 1 } as EndpointSpec<List>,
                        'deposits/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers': { 'cost': 1 } as EndpointSpec<List>,
                        'transfers/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawal-fees': { 'cost': 1 } as EndpointSpec<List>,
                        'assets': { 'cost': 1 } as EndpointSpec<List>,
                        'accounts/me/trading-fees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'accounts/me/withdrawal-limits': { 'cost': 1 } as EndpointSpec<List>,
                        'accounts/me/balances': { 'cost': 1 } as EndpointSpec<Dict>,
                        'accounts/me/transactions': { 'cost': 1 } as EndpointSpec<List>,
                        'reports/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'batchorders': { 'cost': 1 } as EndpointSpec<Dict>,
