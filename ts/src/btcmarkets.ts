            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'markets/{marketId}/ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{marketId}/trades': { 'cost': 1, 'returnType': 'List' },
                        'markets/{marketId}/orderbook': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{marketId}/candles': { 'cost': 1, 'returnType': 'List' },
                        'markets/tickers': { 'cost': 1, 'returnType': 'List' },
                        'markets/orderbooks': { 'cost': 1, 'returnType': 'List' },
                ...
                'private': {
                    'get': {
                        ...
                        'deposits/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'transfers': { 'cost': 1, 'returnType': 'List' },
                        'transfers/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawal-fees': { 'cost': 1, 'returnType': 'List' },
                        'assets': { 'cost': 1, 'returnType': 'List' },
                        'accounts/me/trading-fees': { 'cost': 1, 'returnType': 'Dict' },
                        'accounts/me/withdrawal-limits': { 'cost': 1, 'returnType': 'List' },
                        'accounts/me/balances': { 'cost': 1, 'returnType': 'Dict' },
                        'accounts/me/transactions': { 'cost': 1, 'returnType': 'List' },
                        'reports/{id}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'batchorders': { 'cost': 1, 'returnType': 'Dict' },
