...
export default class bitget extends Exchange {
    ...
    async handleUTAAndParams (params: Dict, methodName: Str, defaultValue: boolean = false): Promise<[Bool, Dict]> {
        const [ uta, paramsUta ]: [ Bool, Dict ] = this.handleOptionAndParams (params, methodName, 'uta');
        if (uta !== undefined) {
    ...
    override async fetchDeposits (code: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Transaction[]> {
        ...
        const [ paginate, paramsPaginate ]: [ boolean, Dict ] = this.handleOptionAndParams (paramsUTA, 'fetchDeposits', 'paginate');
        if (paginate) {
            if (uta === true) {
    ...
    override async fetchWithdrawals (code: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Transaction[]> {
        ...
        const [ paginate, paramsPaginate ]: [ boolean, Dict ] = this.handleOptionAndParams (paramsUTA, 'fetchWithdrawals', 'paginate');
        if (paginate) {
            if (uta === true) {
    ...
    override async fetchOHLCV (symbol: string, timeframe: string = '1m', since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<OHLCV[]> {
        ...
        // make request
        let response = undefined;
        const [ priceType, paramsPrice ]: [ Str, Dict ] = this.handleParamString (paramsOmitted, 'price');
    ...
    createUtaOrderRequest (symbol: Str, type: Str, side: Str, amount: Num, price: Num = undefined, params: Dict = {}): Dict {
        ...
        const market = this.market (symbol);
        let productType: Str = undefined;
        let paramsProductType: Dict = undefined;
        ...
        if (isStopLossOrTakeProfitTrigger) {
            ...
            [ timeInForce, paramsProductType ] = this.handleOptionAndParams (paramsProductType, 'createOrder', 'timeInForce');
    ...
    createOrderRequest (symbol: Str, type: Str, side: Str, amount: Num, price: Num = undefined, params: Dict = {}): Dict {
        ...
        let timeInForce: Str = undefined;
        [ timeInForce, paramsMarketType ] = this.handleOptionAndParams (paramsMarketType, 'createOrder', 'timeInForce');
        if (timeInForce !== undefined) {
            timeInForce = timeInForce.toUpperCase ();
        }
        if (postOnly === true) {
        ...
        if ((marketType === 'swap') || (marketType === 'future')) {
            ...
            [ createMarketBuyOrderRequiresPrice, paramsMarketType ] = this.handleOptionAndParams (paramsMarketType, 'createOrder', 'createMarketBuyOrderRequiresPrice', true);
    ...
    override async fetchOpenOrders (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Order[]> {
        ...
        let paginate = false;
        [ paginate, paramsMarginMode ] = this.handleOptionAndParams (paramsMarginMode, 'fetchOpenOrders', 'paginate');
        if (paginate) {
    ...
    override async fetchCanceledAndClosedOrders (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Order[]> {
        ...
        let paginate = false;
        [ paginate, paramsUTA ] = this.handleOptionAndParams (paramsUTA, 'fetchCanceledAndClosedOrders', 'paginate');
        if (paginate) {
            let cursorReceived: Str = undefined;
            if (marketType === 'spot') {
                if (marginMode !== undefined) {
    ...
    async fetchUtaCanceledAndClosedOrders (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Order[]> {
        ...
        let paginate = false;
        [ paginate, paramsProductType ] = this.handleOptionAndParams (paramsProductType, 'fetchCanceledAndClosedOrders', 'paginate');
        if (paginate) {
    ...
    override async fetchLedger (code: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<LedgerEntry[]> {
        ...
        let paginate = false;
        [ paginate, paramsOmitted ] = this.handleOptionAndParams (paramsOmitted, 'fetchLedger', 'paginate');
        if (paginate) {
            if (uta === true) {
    ...
    override async fetchMyTrades (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Trade[]> {
        ...
        let paginate = false;
        let marginMode: Str = undefined;
        [ paginate, paramsUTA ] = this.handleOptionAndParams (paramsUTA, 'fetchMyTrades', 'paginate');
    ...
    override async fetchPositions (symbols: Strings = undefined, params: Dict = {}): Promise<Position[]> {
        ...
        if (useHistoryEndpoint === true) {
            ...
            [ method, paramsPaginate ] = this.handleOptionAndParams (paramsPaginate, 'fetchPositions', 'method', 'privateMixGetV2MixPositionAllPosition');
        }
        let market: Market = undefined;
        if (symbols !== undefined) {
    ...
    override async fetchFundingRateHistory (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<FundingRateHistory[]> {
        ...
        if (uta === true) {
            ...
            let paginate = false;
            [ paginate, paramsProductType ] = this.handleOptionAndParams (paramsProductType, 'fetchFundingRateHistory', 'paginate');
            if (paginate) {
    ...
    override async fetchFundingRate (symbol: string, params: Dict = {}): Promise<FundingRate> {
        ...
        if (uta === true) {
            ...
            request['productType'] = productType;
            let method: Str = undefined;
            [ method, paramsProductType ] = this.handleOptionAndParams (paramsProductType, 'fetchFundingRate', 'method', 'publicMixGetV2MixMarketCurrentFundRate');
    ...
    override async fetchFundingRates (symbols: Strings = undefined, params: Dict = {}): Promise<FundingRates> {
        ...
        const [ methodOption, paramsMethod ] = this.handleOptionAndParams (paramsProductType, 'fetchFundingRates', 'method', method);
        let response = undefined;
        request['productType'] = productType;
    ...
    override async fetchFundingHistory (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<FundingHistory[]> {
        ...
        const [ paginate, paramsPaginate ]: [ boolean, Dict ] = this.handleOptionAndParams (paramsUTA, 'fetchFundingHistory', 'paginate');
        if (paginate) {
            if (uta === true) {
    ...
    override async fetchMyLiquidations (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<Liquidation[]> {
        ...
        let response = undefined;
        const [ marginMode, paramsMarginMode ]: [ Str, Dict ] = this.handleMarginModeAndParams ('fetchMyLiquidations', paramsUntil, 'cross');
        if (marginMode === 'isolated') {
            if (symbol === undefined) {
    ...
    override async fetchBorrowInterest (code: Str = undefined, symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params: Dict = {}): Promise<BorrowInterest[]> {
        ...
        const [ paginate, paramsPaginate ]: [ boolean, Dict ] = this.handleOptionAndParams (params, 'fetchBorrowInterest', 'paginate');
        if (paginate) {
        ...
        let response = undefined;
        const [ marginMode, paramsMarginMode ]: [ Str, Dict ] = this.handleMarginModeAndParams ('fetchBorrowInterest', paramsPaginate, 'cross');
        if (marginMode === 'isolated') {
            if (symbol === undefined) {
