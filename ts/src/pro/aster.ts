...
export default class aster extends asterRest {
    ...
    async authenticate (type = 'spot', params = {}) {
        ...
        if (time - lastAuthenticatedTime > listenKeyRefreshRate) {
            ...
            // the flight settles. the registration flag lives in
            // client.subscriptions and the shared future is only minted by the
            // first waiter, so an alone leader can reject without any
            // unhandled rejection
