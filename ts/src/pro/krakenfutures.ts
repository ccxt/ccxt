        ...
        if (order !== undefined) {
            ...
            if ((previousOrder === undefined) || (reason === 'edited_by_user')) {
                ...
                for (let i = 0; i < trades.length; i++) {
                    ...
                    totalCost = Precise.stringAdd (this.zeroIfUndefined (totalCost), this.zeroIfUndefined (this.numberToString (currentTrade['cost'])));
                    totalAmount = Precise.stringAdd (this.zeroIfUndefined (totalAmount), this.zeroIfUndefined (this.numberToString (currentTrade['amount'])));
                }
                ...
                const totalFilled = Precise.stringAdd (this.zeroIfUndefined (stringOrderFilled), this.zeroIfUndefined (filledString));
