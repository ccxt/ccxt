...
export default class timex extends timexRest {
    ...
    async watchBalance (params = {}) {
         ...
         * @param {string|undefined} symbol not used by timex watchBalance
         * @param {int|undefined} since not used by timex watchBalance
         * @param {int|undefined} limit not used by timex watchBalance
         * @param {object} params extra parameters specific to the timex api endpoint
