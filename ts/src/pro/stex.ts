...
export default class stex extends stexRest {
    describe () {
    ...
    async subscribe (name: string, symbol: string = undefined, params = {}) {
         ...
         * @param {Object} params extra parameters specific to the stex api
         * @returns {Object} data from the websocket stream
         */
        await this.loadMarkets ();
        if (symbol !== undefined) {
            const market = this.market (symbol);
            name = name + market['numericId'];
        }
        const url = this.urls['api']['ws'];
        const subscribe = {
        };
    ...
    async watchTicker (symbol: string, params = {}) {
         ...
         */
        await this.loadMarkets ();
        return await this.subscribe ('rate_', symbol, params);
    }
    ...
    async watchTickers (symbols: string[] = undefined, params = {}) {
         ...
         * @name stex#watchTicker
         * @description watches a price ticker, a statistical calculation with the information calculated over the past 24 hours for a specific market
         * @param {string} symbol not used by stex watchTickers
         * @param {object} params extra parameters specific to the stex api endpoint
         * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/en/latest/manual.html#ticker-structure}
         */
        await this.loadMarkets ();
        return await this.subscribe ('rate', undefined, params);
    }

    async watchTrades (symbol: string = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
        /**
         * @method
         * @name stex#watchTrades
        ...
        await this.loadMarkets ();
        const market = this.market (symbol);
        const name = 'trade_c' + market['numericId'];
    ...
    async watchOrderBook (symbol: string, limit: Int = undefined, params = {}) {
        /**
         * @method
         * @name stex#watchOrderBook
         * @description watches information on open orders with bid (buy) and ask (sell) prices, volumes and other data
         * @param {string} symbol unified symbol of the market to fetch the order book for
         * @param {int|undefined} limit not used by stex watchOrderBook
         * @param {object} params extra parameters specific to the stex api endpoint
         * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/en/latest/manual.html#order-book-structure} indexed by market symbols
         */
        const orderbook = await this.subscribe ('orderbook_data', symbol, params);
    ...
    async watchOrders (symbol: string = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
        /**
         * @method
         * @name stex#watchOrders
         * @description watches information on multiple orders made by the user
         * @param {string|undefined} symbol not used by stex watchOrders
         * @param {int|undefined} since not used by stex watchOrders
         * @param {int|undefined} limit not used by stex watchOrders
         * @param {object} params extra parameters specific to the stex api endpoint
    ...
    async watchMyTrades (symbol: string = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
        ...
        await this.loadMarkets ();
        const userId = ''; // TODO: get userId
        const name = 'private-trade_u' + userId + 'c';
        const trades = await this.subscribe (name, symbol, params);
        if (this.newUpdates) {
            limit = trades.getLimit (symbol, limit);
        }
    ...
    async watchBalance (params = {}) {
         ...
         * @name stex#watchOrders
         * @description watches information on multiple orders made by the user
         * @param {string|undefined} symbol not used by stex watchBalance
         * @param {int|undefined} since not used by stex watchBalance
         * @param {int|undefined} limit not used by stex watchBalance
         * @param {object} params extra parameters specific to the stex api endpoint
        ...
        // }
        const walletId = ''; // TODO: Get wallet id
        const name = 'private-balance_changed_w_' + walletId;
        // for all wallets private-balance_changed_u_{user_id}
        return await this.subscribe (name, undefined, params);
    }
    ...
    async watchOHLCV (symbol: string, timeframe = '1m', since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         */
        await this.loadMarkets ();
        const name = 'stats_data_' + this.timeframes[timeframe];
