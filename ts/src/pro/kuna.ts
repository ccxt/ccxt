...
export default class kuna extends kunaRest {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                'api': {
                    'ws': 'wss://ws-pro.kuna.io/socketcluster/',
                },
            },
            'options': {
                'tradesLimit': 1000,
    ...
    async authenticate () {
         ...
         * @see https://api.kuna.com/#socket-authentication
    ...
    async subscribePublic (name: string, symbols: string[] = undefined, params = {}) {
         ...
         * @param {object} [params] extra parameters specific to the kuna api
         * @returns
         */
    ...
    async watchOrderBook (symbol: string, limit: Int = undefined, params = {}) {
        /**
         * @method
         * @name kuna#watchOrderBook
         * @description watches information on open orders with bid (buy) and ask (sell) prices, volumes and other data
         * @see https://docs.kuna.io/reference/market-streams#order-book
         * @param {string} symbol unified symbol of the market to fetch the order book for
         * @param {int} [limit] not used by kuna watchOrderBook
         * @param {object} [params] extra parameters specific to the kuna api endpoint
         * @param {int} [params.level] 5, 10, or 25
         * @param {int} [params.speed] 100, or 1000 (default)
         * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
         */
        const depth = this.safeString (params, 'depth', '5');
        const speed = this.safeString (params, 'depth', '100');
        const market = this.market (symbol);
        let name = market['id'] + '@depth';
        if (depth !== undefined) {
            name += depth;
        }
        if (speed !== undefined) {
    ...
    async watchTicker (symbol: string, params = {}) {
         ...
         * TODO
         * @method
         * @name kuna#watchTicker
         * @description watches a price ticker, a statistical calculation with the information calculated over the past 24 hours for a specific market
         * @see https://api.kuna.com/#subscribe-to-ticker
         * @see https://api.kuna.com/#subscribe-to-ticker-in-batches
         * @see https://api.kuna.com/#subscribe-to-mini-ticker
         * @see https://api.kuna.com/#subscribe-to-mini-ticker-in-batches
    ...
    async watchTrades (symbol: string, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * TODO
         * @method
         * @name kuna#watchTrades
         * @description get the list of most recent trades for a particular symbol
         * @see https://api.kuna.com/#subscribe-to-trades
    ...
    async watchOHLCV (symbol: string, timeframe = '1m', since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * TODO
         * @method
         * @name kuna#watchOHLCV
         * @description watches historical candlestick data containing the open, high, low, and close price, and the volume of a market
         * @see https://api.kuna.com/#subscribe-to-candles
         * @param {string} symbol unified symbol of the market to fetch OHLCV data for
         * @param {string} [timeframe] the length of time each candle represents
         * @param {int} [since] not used by kuna watchOHLCV
    ...
    async watchOrders (symbol: string = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * TODO
         * @method
         * @name kuna#watchOrders
         * @description watches information on multiple orders made by the user
         * @see https://api.kuna.com/#subscribe-to-reports
         * @see https://api.kuna.com/#subscribe-to-reports-2
         * @see https://api.kuna.com/#subscribe-to-reports-3
    ...
    async watchBalance (params = {}) {
         ...
         * TODO
         * @method
         * @name kuna#watchBalance
         * @description watches balance updates, cannot subscribe to margin account balances
         * @see https://api.kuna.com/#subscribe-to-spot-balances
         * @see https://api.kuna.com/#subscribe-to-futures-balances
         * @param {object} [params] extra parameters specific to the kuna api endpoint
