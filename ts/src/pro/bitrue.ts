...
import type { Balances, Dict, Int, Market, OHLCV, Order, OrderBook, Str, Ticker, Trade, List, EndpointSpec } from '../base/types.js';
            ...
            'api': {
                'open': {
                    'v1': {
                        'private': {
                            'post': {
                                'poseidon/api/v1/listenKey': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                            'put': {
                                'poseidon/api/v1/listenKey/{listenKey}': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                            'delete': {
                                'poseidon/api/v1/listenKey/{listenKey}': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
