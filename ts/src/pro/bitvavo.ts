...
import { Int, Str, OrderSide, OrderType, OrderBook, Ticker, Trade, Order, OHLCV, Balances, Num, TradingFeeInterface, Dictionary } from '../base/types.js';
...
export default class bitvavo extends bitvavoRest {
    ...
    async fetchTradingFeesWs (params = {}): Promise<Dictionary<TradingFeeInterface>> {
        /**
         * @method
