...
import type { Balances, Currency, CurrencyInterface, FundingHistory, FundingRateHistory, Int, Market, OHLCV, Order, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, OrderRequest, TransferEntry, Leverage, Num, MarginModification, TradingFeeInterface, Currencies, TradingFees, Position, IsolatedBorrowRate, Dict, NullableDict, FeeString, List, LeverageTiers, LeverageTier, int, FundingRate, FundingRates, DepositAddress, BorrowInterest, DepositWithdrawFee, DepositWithdrawFees, MarginLoan } from './base/types.js';
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'v1': {
                    'public': {
                        'get': {
                            'amm/market': { 'cost': 1, 'returnType': 'Dict' },
                            'common/currency/rate': { 'cost': 1, 'returnType': 'Dict' },
                            'common/asset/config': { 'cost': 1, 'returnType': 'Dict' },
                            'common/maintain/info': { 'cost': 1, 'returnType': 'Dict' },
                            'common/temp-maintain/info': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/market': { 'cost': 1, 'returnType': 'Dict' },
                            'market/info': { 'cost': 1, 'returnType': 'Dict' },
                            'market/list': { 'cost': 1, 'returnType': 'Dict' },
                            'market/ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'market/ticker/all': { 'cost': 1, 'returnType': 'Dict' },
                            'market/depth': { 'cost': 1, 'returnType': 'Dict' },
                            'market/deals': { 'cost': 1, 'returnType': 'Dict' },
                            'market/kline': { 'cost': 1, 'returnType': 'Dict' },
                            'market/detail': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            'account/amm/balance': { 'cost': 40, 'returnType': 'Dict' },
                            'account/investment/balance': { 'cost': 40, 'returnType': 'Dict' },
                            'account/balance/history': { 'cost': 40, 'returnType': 'Dict' },
                            'account/market/fee': { 'cost': 40, 'returnType': 'Dict' },
                            'balance/coin/deposit': { 'cost': 40, 'returnType': 'Dict' },
                            'balance/coin/withdraw': { 'cost': 40, 'returnType': 'Dict' },
                            'balance/info': { 'cost': 40, 'returnType': 'Dict' },
                            'balance/deposit/address/{coin_type}': { 'cost': 40, 'returnType': 'Dict' },
                            'contract/transfer/history': { 'cost': 40, 'returnType': 'Dict' },
                            'credit/info': { 'cost': 40, 'returnType': 'Dict' },
                            'credit/balance': { 'cost': 40, 'returnType': 'Dict' },
                            'investment/transfer/history': { 'cost': 40, 'returnType': 'Dict' },
                            'margin/account': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/config': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/loan/history': { 'cost': 40, 'returnType': 'Dict' },
                            'margin/transfer/history': { 'cost': 40, 'returnType': 'Dict' },
                            'order/deals': { 'cost': 40, 'returnType': 'Dict' },
                            'order/finished': { 'cost': 40, 'returnType': 'Dict' },
                            'order/pending': { 'cost': 8, 'returnType': 'Dict' },
                            'order/status': { 'cost': 8, 'returnType': 'Dict' },
                            'order/status/batch': { 'cost': 8, 'returnType': 'Dict' },
                            'order/user/deals': { 'cost': 40, 'returnType': 'Dict' },
                            'order/stop/finished': { 'cost': 40, 'returnType': 'Dict' },
                            'order/stop/pending': { 'cost': 8, 'returnType': 'Dict' },
                            'order/user/trade/fee': { 'cost': 1, 'returnType': 'Dict' },
                            'order/market/trade/info': { 'cost': 1, 'returnType': 'Dict' },
                            'sub_account/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'sub_account/transfer/history': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/auth/api': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/auth/api/{user_auth_id}': { 'cost': 40, 'returnType': 'Dict' },
                        },
                        'post': {
                            'balance/coin/withdraw': { 'cost': 40, 'returnType': 'Dict' },
                            'contract/balance/transfer': { 'cost': 40, 'returnType': 'Dict' },
                            'margin/flat': { 'cost': 40, 'returnType': 'Dict' },
                            'margin/loan': { 'cost': 40, 'returnType': 'Dict' },
                            'margin/transfer': { 'cost': 40, 'returnType': 'Dict' },
                            'order/limit/batch': { 'cost': 40, 'returnType': 'Dict' },
                            'order/ioc': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/limit': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/market': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/modify': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/stop/limit': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/stop/market': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/stop/modify': { 'cost': 13.334, 'returnType': 'Dict' },
                            'sub_account/transfer': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/register': { 'cost': 1, 'returnType': 'Dict' },
                            'sub_account/unfrozen': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/frozen': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/auth/api': { 'cost': 40, 'returnType': 'Dict' },
                        },
                        'put': {
                            'balance/deposit/address/{coin_type}': { 'cost': 40, 'returnType': 'Dict' },
                            ...
                            'sub_account/frozen': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/auth/api/{user_auth_id}': { 'cost': 40, 'returnType': 'Dict' },
                            'v1/account/settings': { 'cost': 40, 'returnType': 'Dict' },
                        },
                        'delete': {
                            'balance/coin/withdraw': { 'cost': 40, 'returnType': 'Dict' },
                            'order/pending/batch': { 'cost': 40, 'returnType': 'Dict' },
                            'order/pending': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/stop/pending': { 'cost': 40, 'returnType': 'Dict' },
                            'order/stop/pending/{id}': { 'cost': 13.334, 'returnType': 'Dict' },
                            'order/pending/by_client_id': { 'cost': 40, 'returnType': 'Dict' },
                            'order/stop/pending/by_client_id': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/auth/api/{user_auth_id}': { 'cost': 40, 'returnType': 'Dict' },
                            'sub_account/authorize/{id}': { 'cost': 40, 'returnType': 'Dict' },
                        },
                    },
                    'perpetualPublic': {
                        'get': {
                            ...
                            'market/list': { 'cost': 1, 'returnType': 'Dict' },
                            'market/limit_config': { 'cost': 1, 'returnType': 'Dict' },
                            'market/ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'market/ticker/all': { 'cost': 1, 'returnType': 'Dict' },
                            'market/depth': { 'cost': 1, 'returnType': 'Dict' },
                            'market/deals': { 'cost': 1, 'returnType': 'Dict' },
                            'market/funding_history': { 'cost': 1, 'returnType': 'Dict' },
                            'market/kline': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'perpetualPrivate': {
                        'get': {
                            'market/user_deals': { 'cost': 1, 'returnType': 'Dict' },
                            'asset/query': { 'cost': 40, 'returnType': 'Dict' },
                            'order/pending': { 'cost': 8, 'returnType': 'Dict' },
                            'order/finished': { 'cost': 40, 'returnType': 'Dict' },
                            'order/stop_finished': { 'cost': 40, 'returnType': 'Dict' },
                            'order/stop_pending': { 'cost': 8, 'returnType': 'Dict' },
                            'order/status': { 'cost': 8, 'returnType': 'Dict' },
                            'order/stop_status': { 'cost': 8, 'returnType': 'Dict' },
                            'position/finished': { 'cost': 40, 'returnType': 'Dict' },
                            'position/pending': { 'cost': 40, 'returnType': 'Dict' },
                            'position/funding': { 'cost': 40, 'returnType': 'Dict' },
                            'position/adl_history': { 'cost': 40, 'returnType': 'Dict' },
                            'market/preference': { 'cost': 40, 'returnType': 'Dict' },
                            'position/margin_history': { 'cost': 40, 'returnType': 'Dict' },
                            'position/settle_history': { 'cost': 40, 'returnType': 'Dict' },
                        },
                        'post': {
                            'market/adjust_leverage': { 'cost': 1, 'returnType': 'Dict' },
                            'market/position_expect': { 'cost': 1, 'returnType': 'Dict' },
                            'order/put_limit': { 'cost': 20, 'returnType': 'Dict' },
                            'order/put_market': { 'cost': 20, 'returnType': 'Dict' },
                            'order/put_stop_limit': { 'cost': 20, 'returnType': 'Dict' },
                            'order/put_stop_market': { 'cost': 20, 'returnType': 'Dict' },
                            'order/modify': { 'cost': 20, 'returnType': 'Dict' },
                            'order/modify_stop': { 'cost': 20, 'returnType': 'Dict' },
                            'order/cancel': { 'cost': 20, 'returnType': 'Dict' },
                            'order/cancel_all': { 'cost': 40, 'returnType': 'Dict' },
                            'order/cancel_batch': { 'cost': 40, 'returnType': 'Dict' },
                            'order/cancel_stop': { 'cost': 20, 'returnType': 'Dict' },
                            'order/cancel_stop_all': { 'cost': 40, 'returnType': 'Dict' },
                            'order/close_limit': { 'cost': 20, 'returnType': 'Dict' },
                            'order/close_market': { 'cost': 20, 'returnType': 'Dict' },
                            'position/adjust_margin': { 'cost': 20, 'returnType': 'Dict' },
                            'position/stop_loss': { 'cost': 20, 'returnType': 'Dict' },
                            'position/take_profit': { 'cost': 20, 'returnType': 'Dict' },
                            'position/market_close': { 'cost': 20, 'returnType': 'Dict' },
                            'order/cancel/by_client_id': { 'cost': 20, 'returnType': 'Dict' },
                            'order/cancel_stop/by_client_id': { 'cost': 20, 'returnType': 'Dict' },
                            'market/preference': { 'cost': 20, 'returnType': 'Dict' },
                        },
                    },
                },
                'v2': {
                    'public': {
                        'get': {
                            'maintain/info': { 'cost': 1, 'returnType': 'Dict' },
                            'ping': { 'cost': 1, 'returnType': 'Dict' },
                            'time': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/market': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/depth': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/deals': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/kline': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/index': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/market': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/depth': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/deals': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/kline': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/index': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/funding-rate': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/funding-rate-history': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/premium-index-history': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/position-level': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/liquidation-history': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/basis-history': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/deposit-withdraw-config': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/all-deposit-withdraw-config': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'get': {
                            'account/subs': { 'cost': 1, 'returnType': 'Dict' },
                            'account/subs/api-detail': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/info': { 'cost': 1, 'returnType': 'Dict' },
                            'account/subs/api': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/transfer-history': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'account/subs/spot-balance': { 'cost': 1, 'returnType': 'Dict' },
                            'account/trade-fee-rate': { 'cost': 40, 'returnType': 'Dict' },
                            'account/futures-market-settings': { 'cost': 1, 'returnType': 'Dict' },
                            'account/info': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/spot/balance': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/futures/balance': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/margin/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/financial/balance': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/amm/liquidity': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/credit/info': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/spot/transcation-history': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/margin/borrow-history': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/margin/interest-limit': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/deposit-address': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/deposit-history': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/withdraw': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/transfer-history': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/amm/liquidity-pool': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/amm/income-history': { 'cost': 40, 'returnType': 'Dict' },
                            'spot/order-status': { 'cost': 8, 'returnType': 'Dict' },
                            'spot/batch-order-status': { 'cost': 8, 'returnType': 'Dict' },
                            'spot/pending-order': { 'cost': 8, 'returnType': 'Dict' },
                            'spot/finished-order': { 'cost': 40, 'returnType': 'Dict' },
                            'spot/pending-stop-order': { 'cost': 8, 'returnType': 'Dict' },
                            'spot/finished-stop-order': { 'cost': 40, 'returnType': 'Dict' },
                            'spot/user-deals': { 'cost': 40, 'returnType': 'Dict' },
                            'spot/order-deals': { 'cost': 40, 'returnType': 'Dict' },
                            'futures/order-status': { 'cost': 8, 'returnType': 'Dict' },
                            'futures/batch-order-status': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/pending-order': { 'cost': 8, 'returnType': 'Dict' },
                            'futures/finished-order': { 'cost': 40, 'returnType': 'Dict' },
                            'futures/pending-stop-order': { 'cost': 8, 'returnType': 'Dict' },
                            'futures/finished-stop-order': { 'cost': 40, 'returnType': 'Dict' },
                            'futures/user-deals': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/order-deals': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/pending-position': { 'cost': 40, 'returnType': 'Dict' },
                            'futures/finished-position': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/position-margin-history': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/position-funding-history': { 'cost': 40, 'returnType': 'Dict' },
                            'futures/position-adl-history': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/position-settle-history': { 'cost': 1, 'returnType': 'Dict' },
                            'refer/referee': { 'cost': 1, 'returnType': 'Dict' },
                            'refer/referee-rebate/record': { 'cost': 1, 'returnType': 'Dict' },
                            'refer/referee-rebate/detail': { 'cost': 1, 'returnType': 'Dict' },
                            'refer/agent-referee': { 'cost': 1, 'returnType': 'Dict' },
                            'refer/agent-rebate/record': { 'cost': 1, 'returnType': 'Dict' },
                            'refer/agent-rebate/detail': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'account/subs': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/frozen': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/unfrozen': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/api': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/edit-api': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/delete-api': { 'cost': 40, 'returnType': 'Dict' },
                            'account/subs/transfer': { 'cost': 40, 'returnType': 'Dict' },
                            'account/settings': { 'cost': 40, 'returnType': 'Dict' },
                            'account/futures-market-settings': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/margin/borrow': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/margin/repay': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/renewal-deposit-address': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/withdraw': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/cancel-withdraw': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/transfer': { 'cost': 40, 'returnType': 'Dict' },
                            'assets/amm/add-liquidity': { 'cost': 1, 'returnType': 'Dict' },
                            'assets/amm/remove-liquidity': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/order': { 'cost': 13.334, 'returnType': 'Dict' },
                            'spot/stop-order': { 'cost': 13.334, 'returnType': 'Dict' },
                            'spot/batch-order': { 'cost': 40, 'returnType': 'Dict' },
                            'spot/batch-stop-order': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/modify-order': { 'cost': 13.334, 'returnType': 'Dict' },
                            'spot/modify-stop-order': { 'cost': 13.334, 'returnType': 'Dict' },
                            'spot/batch-modify-order': { 'cost': 13.334, 'returnType': 'Dict' },
                            'spot/cancel-all-order': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/cancel-order': { 'cost': 6.667, 'returnType': 'Dict' },
                            'spot/cancel-stop-order': { 'cost': 6.667, 'returnType': 'Dict' },
                            'spot/cancel-batch-order': { 'cost': 10, 'returnType': 'Dict' },
                            'spot/cancel-batch-stop-order': { 'cost': 10, 'returnType': 'Dict' },
                            'spot/cancel-order-by-client-id': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/cancel-stop-order-by-client-id': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/stop-order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/batch-order': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/batch-stop-order': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/cancel-position-stop-loss': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/cancel-position-take-profit': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/modify-order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/modify-stop-order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/batch-modify-order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/cancel-all-order': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/cancel-order': { 'cost': 10, 'returnType': 'Dict' },
                            'futures/cancel-stop-order': { 'cost': 10, 'returnType': 'Dict' },
                            'futures/cancel-batch-order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/cancel-batch-stop-order': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/cancel-order-by-client-id': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/cancel-stop-order-by-client-id': { 'cost': 1, 'returnType': 'Dict' },
                            'futures/close-position': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/adjust-position-margin': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/adjust-position-leverage': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/set-position-stop-loss': { 'cost': 20, 'returnType': 'Dict' },
                            'futures/set-position-take-profit': { 'cost': 20, 'returnType': 'Dict' },
                        },
                    },
                },
            },
