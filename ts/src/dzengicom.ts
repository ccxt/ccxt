...
import Exchange from './abstract/dzengicom.js';
 ...
 * @augments Exchange
 */
export default class dzengicom extends Exchange {
    describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'www': 'https://www.dzengi.com',
                'referral': 'https://dzengi.com/trading/signup?c=362jaimv&pid=referral',
                'doc': [
                    'https://dzengi.com/api',
                ],
                'fees': 'https://dzengi.com/fees-charges',
            },
            // rate-limits are described at: https://dzengi.com/api-get-started
            'api': {
                'public': {
                    'get': {
                        'v1/time': 1,
    ...
    /**
     * @method
     * @name dzengicom#fetchTime
     * @description fetches the current integer timestamp in milliseconds from the exchange server
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/timeUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchCurrencies
     * @description fetches all available currencies on an exchange
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getCurrenciesUsingGET
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name dzengicom#fetchMarkets
     * @description retrieves data on all markets for dzengicom
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/exchangeInfoUsingGET
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name dzengicom#fetchAccounts
     * @description fetch all the accounts associated with a profile
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/accountUsingGET
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name dzengicom#fetchTradingFees
    ...
    /**
     * @method
     * @name dzengicom#fetchOrderBook
     * @description fetches information on open orders with bid (buy) and ask (sell) prices, volumes and other data
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/depthUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchTicker
     * @description fetches a price ticker, a statistical calculation with the information calculated over the past 24 hours for a specific market
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/ticker_24hrUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchOHLCV
     * @description fetches historical candlestick data containing the open, high, low, and close price, and the volume of a market
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/klinesUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchTrades
     * @description get the list of most recent trades for a particular symbol
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/aggTradesUsingGET
    ...
    /**
     * @method
     * @name dzengicom#createOrder
     * @description create a trade order
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/orderUsingPOST
    ...
    /**
     * @method
     * @name dzengicom#fetchOrder
     * @description fetches information on an order made by the user
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getOrderUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchOpenOrders
     * @description fetch all unfilled currently open orders
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/openOrdersUsingGET
    ...
    /**
     * @method
     * @name dzengicom#cancelOrder
     * @description cancels an open order
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/cancelOrderUsingDELETE
     * @param {string} id order id
     * @param {string} symbol unified symbol of the market the order was made in
     * @param {object} [params] extra parameters specific to the exchange API endpoint
     * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
    ...
    /**
     * @method
     * @name dzengicom#fetchMyTrades
     * @description fetch all trades made by the user
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/myTradesUsingGET
     * @param {string} symbol unified market symbol
    ...
    /**
     * @method
     * @name dzengicom#fetchDeposits
     * @description fetch all deposits made to an account
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getDepositsUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchWithdrawals
     * @description fetch all withdrawals made from an account
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getWithdrawalsUsingGET
     * @param {string} code unified currency code
    ...
    /**
     * @method
     * @name dzengicom#fetchDepositsWithdrawals
     * @description fetch history of deposits and withdrawals
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getTransactionsUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchLedger
     * @description fetch the history of changes, actions done by the user or operations that altered the balance of the user
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getLedgerUsingGET
    ...
    /**
     * @method
     * @name dzengicom#fetchLeverage
     * @description fetch the set leverage for a market
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/leverageSettingsUsingGET
     * @param {string} symbol unified market symbol
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name dzengicom#fetchDepositAddress
     * @description fetch the deposit address for a currency associated with this account
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/getDepositAddressUsingGET
     * @param {string} code unified currency code
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name dzengicom#fetchPositions
     * @description fetch all open positions
     * @see https://apitradedoc.dzengi.com/swagger-ui.html#/rest-api/tradingPositionsUsingGET
