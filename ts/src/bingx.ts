            ...
            'api': {
                ...
                'spot': {
                    'v1': {
                        'public': {
                            'get': {
                                'server/time': { 'cost': 1 } as EndpointSpec<Dict>,
                                'common/symbols': { 'cost': 1 } as EndpointSpec<Dict>,
                                ...
                                'ticker/24hr': { 'cost': 1 } as EndpointSpec<Dict>,
                                'ticker/price': { 'cost': 1 } as EndpointSpec<Dict>, // deprecated, still can be used
                                'ticker/bookTicker': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                        },
                        'private': {
                            'get': {
                                'trade/query': { 'cost': 1 } as EndpointSpec<Dict>,
                                'trade/openOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                                'trade/historyOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                                'trade/myTrades': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/commissionRate': { 'cost': 5 } as EndpointSpec<Dict>,
                                'account/balance': { 'cost': 2 } as EndpointSpec<Dict>,
                                'oco/orderList': { 'cost': 5 } as EndpointSpec<Dict>,
                                'oco/openOrderList': { 'cost': 5 } as EndpointSpec<Dict>,
                                'oco/historyOrderList': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'trade/order': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/cancel': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/batchOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/order/cancelReplace': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/cancelOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/cancelOpenOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/cancelAllAfter': { 'cost': 5 } as EndpointSpec<Dict>,
                                'oco/order': { 'cost': 5 } as EndpointSpec<Dict>,
                                'oco/cancel': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                    'v2': {
                        'public': {
                            'get': {
                                'market/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/kline': { 'cost': 1 } as EndpointSpec<Dict>,
                                'ticker/price': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                    'v3': {
                        'private': {
                            'get': {
                                'get/asset/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            ...
                            'post': {
                                'post/asset/transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
                'swap': {
                    'v1': {
                        'public': {
                            'get': {
                                'ticker/price': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/historicalTrades': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/markPriceKlines': { 'cost': 1 } as EndpointSpec<Dict>,
                                'trade/multiAssetsRules': { 'cost': 1 } as EndpointSpec<Dict>,
                                'tradingRules': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                        },
                        'private': {
                            'get': {
                                'positionSide/dual': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/batchCancelReplace': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/fullOrder': { 'cost': 2 } as EndpointSpec<Dict>,
                                'maintMarginRatio': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/positionHistory': { 'cost': 2 } as EndpointSpec<Dict>,
                                'positionMargin/history': { 'cost': 2 } as EndpointSpec<Dict>,
                                'twap/openOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                                'twap/historyOrders': { 'cost': 5 } as EndpointSpec<Dict>,
                                'twap/orderDetail': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/assetMode': { 'cost': 5 } as EndpointSpec<Dict>,
                                'user/marginAssets': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'trade/amend': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/cancelReplace': { 'cost': 2 } as EndpointSpec<Dict>,
                                'positionSide/dual': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/batchCancelReplace': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/closePosition': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/getVst': { 'cost': 5 } as EndpointSpec<Dict>, // deprecated
                                'twap/order': { 'cost': 5 } as EndpointSpec<Dict>,
                                'twap/cancelOrder': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/assetMode': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/reverse': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/autoAddMargin': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                    'v2': {
                        'public': {
                            'get': {
                                'server/time': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/contracts': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/price': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/premiumIndex': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/fundingRate': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/klines': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/openInterest': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                                'quote/bookTicker': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                        },
                        'private': {
                            'get': {
                                'user/balance': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/positions': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/income': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/openOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/openOrder': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/order': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/marginType': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/leverage': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/forceOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                                'trade/allOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/allFillOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/fillHistory': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/income/export': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/commissionRate': { 'cost': 2 } as EndpointSpec<Dict>,
                                'quote/bookTicker': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'trade/getVst': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/order': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/batchOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/closeAllPositions': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/cancelAllAfter': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/marginType': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/leverage': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/positionMargin': { 'cost': 5 } as EndpointSpec<Dict>,
                                'trade/order/test': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'delete': {
                                'trade/order': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/batchOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/allOpenOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                    'v3': {
                ...
                'cswap': {
                    'v1': {
                        'public': {
                            'get': {
                                'market/contracts': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/premiumIndex': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/openInterest': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/klines': { 'cost': 1 } as EndpointSpec<Dict>,
                                'market/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                        ...
                        'private': {
                            'get': {
                                'trade/leverage': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/forceOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/allFillOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/openOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/orderDetail': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/orderHistory': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/marginType': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/commissionRate': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/positions': { 'cost': 2 } as EndpointSpec<Dict>,
                                'user/balance': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                ...
                                'trade/closeAllPositions': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/marginType': { 'cost': 2 } as EndpointSpec<Dict>,
                                'trade/positionMargin': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'delete': {
                                'trade/allOpenOrders': { 'cost': 2 } as EndpointSpec<Dict>, // post method in doc
                                'trade/cancelOrder': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
                'contract': {
                    'v1': {
                        'private': {
                            'get': {
                                'allPosition': { 'cost': 2 } as EndpointSpec<Dict>,
                                'allOrders': { 'cost': 2 } as EndpointSpec<Dict>,
                                'balance': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
                'wallets': {
                    'v1': {
                        'private': {
                            'get': {
                                'capital/config/getall': { 'cost': 5 } as EndpointSpec<Dict>,
                                'capital/deposit/address': { 'cost': 5 } as EndpointSpec<Dict>,
                                'capital/innerTransfer/records': { 'cost': 1 } as EndpointSpec<Dict>,
                                'capital/subAccount/deposit/address': { 'cost': 5 } as EndpointSpec<Dict>,
                                'capital/deposit/subHisrec': { 'cost': 2 } as EndpointSpec<Dict>,
                                'capital/subAccount/innerTransfer/records': { 'cost': 1 } as EndpointSpec<Dict>,
                                'capital/deposit/riskRecords': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'capital/withdraw/apply': { 'cost': 5 } as EndpointSpec<Dict>,
                                'capital/innerTransfer/apply': { 'cost': 5 } as EndpointSpec<Dict>,
                                'capital/subAccountInnerTransfer/apply': { 'cost': 2 } as EndpointSpec<Dict>,
                                'capital/deposit/createSubAddress': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
                'subAccount': {
                    'v1': {
                        'private': {
                            'get': {
                                'list': { 'cost': 10 } as EndpointSpec<Dict>,
                                'assets': { 'cost': 2 } as EndpointSpec<Dict>,
                                'allAccountBalance': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'create': { 'cost': 10 } as EndpointSpec<Dict>,
                                'apiKey/create': { 'cost': 2 } as EndpointSpec<Dict>,
                                'apiKey/edit': { 'cost': 2 } as EndpointSpec<Dict>,
                                'apiKey/del': { 'cost': 2 } as EndpointSpec<Dict>,
                                'updateStatus': { 'cost': 10 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
                'account': {
                    'v1': {
                        'private': {
                            'get': {
                                'uid': { 'cost': 1 } as EndpointSpec<Dict>,
                                'apiKey/query': { 'cost': 2 } as EndpointSpec<Dict>,
                                'account/apiPermissions': { 'cost': 5 } as EndpointSpec<Dict>,
                                'allAccountBalance': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'innerTransfer/authorizeSubAccount': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                    'transfer': {
                        'v1': {
                            'private': {
                                'get': {
                                    'subAccount/asset/transferHistory': { 'cost': 1 } as EndpointSpec<Dict>,
                                },
                                'post': {
                                    'subAccount/transferAsset/supportCoins': { 'cost': 1 } as EndpointSpec<Dict>,
                                    'subAccount/transferAsset': { 'cost': 1 } as EndpointSpec<Dict>,
                                },
                            },
                        },
                    },
                ...
                'user': {
                    'auth': {
                        'private': {
                            'post': {
                                'userDataStream': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'put': {
                                'userDataStream': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                ...
                'copyTrading': {
                    'v1': {
                        'private': {
                            'get': {
                                'swap/trace/currentTrack': { 'cost': 2 } as EndpointSpec<Dict>,
                                'PFutures/traderDetail': { 'cost': 2 } as EndpointSpec<Dict>,
                                'PFutures/profitHistorySummarys': { 'cost': 2 } as EndpointSpec<Dict>,
                                'PFutures/profitDetail': { 'cost': 2 } as EndpointSpec<Dict>,
                                'PFutures/tradingPairs': { 'cost': 2 } as EndpointSpec<Dict>,
                                'spot/traderDetail': { 'cost': 2 } as EndpointSpec<Dict>,
                                'spot/profitHistorySummarys': { 'cost': 2 } as EndpointSpec<Dict>,
                                'spot/profitDetail': { 'cost': 2 } as EndpointSpec<Dict>,
                                'spot/historyOrder': { 'cost': 2 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'swap/trace/closeTrackOrder': { 'cost': 2 } as EndpointSpec<Dict>,
                                'swap/trace/setTPSL': { 'cost': 2 } as EndpointSpec<Dict>,
                                'PFutures/setCommission': { 'cost': 2 } as EndpointSpec<Dict>,
                                'spot/trader/sellOrder': { 'cost': 10 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
                'api': {
                    'v3': {
                        'private': {
                            'get': {
                                'asset/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                                'asset/transferRecord': { 'cost': 5 } as EndpointSpec<Dict>,
                                'capital/deposit/hisrec': { 'cost': 1 } as EndpointSpec<Dict>,
                                'capital/withdraw/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                            'post': {
                                'post/asset/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                    'asset': {
                        'v1': {
                            'private': {
                                'post': {
                                    'transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                                },
                            },
                            'public': {
                                'get': {
                                    'transfer/supportCoins': { 'cost': 5 } as EndpointSpec<Dict>,
                                },
                            },
                        },
                    },
                ...
                'agent': {
                    'v1': {
                        'private': {
                            'get': {
                                'account/inviteAccountList': { 'cost': 5 } as EndpointSpec<Dict>,
                                'reward/commissionDataList': { 'cost': 5 } as EndpointSpec<Dict>,
                                'account/inviteRelationCheck': { 'cost': 5 } as EndpointSpec<Dict>,
                                'asset/depositDetailList': { 'cost': 5 } as EndpointSpec<Dict>,
                                'reward/third/commissionDataList': { 'cost': 5 } as EndpointSpec<Dict>,
                                'asset/partnerData': { 'cost': 5 } as EndpointSpec<Dict>,
                                'commissionDataList/referralCode': { 'cost': 5 } as EndpointSpec<Dict>,
                                'account/superiorCheck': { 'cost': 5 } as EndpointSpec<Dict>,
                            },
                        },
                    },
                },
