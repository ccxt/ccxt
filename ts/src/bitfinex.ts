...
import type { TransferEntry, Int, OrderSide, OrderType, Trade, OHLCV, Order, FundingRateHistory, OrderBook, Str, Transaction, Ticker, Balances, Tickers, Strings, Currency, Market, OpenInterest, Liquidation, OrderRequest, Num, MarginModification, Currencies, TradingFees, Dict, LedgerEntry, List, FundingRate, FundingRates, DepositAddress, OpenInterests, Position, IndexType, NullableDict, FeeString, int, Status, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'conf/{config}': { 'cost': 2.7 } as EndpointSpec<List>, // 90 requests a minute, 90/60 = 1.5, 1000 / (250 * 2.66) = 1.503, use 2.7 instead of 2.66 to ensure rateLimitExceeded is not triggered
                        'conf/pub:{action}:{object}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:{action}:{object}:{detail}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:map:{object}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:map:{object}:{detail}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:map:currency:{detail}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:map:currency:sym': { 'cost': 2.7 } as EndpointSpec<List>, // maps symbols to their API symbols, BAB > BCH
                        'conf/pub:map:currency:label': { 'cost': 2.7 } as EndpointSpec<List>, // verbose friendly names, BNT > Bancor
                        'conf/pub:map:currency:unit': { 'cost': 2.7 } as EndpointSpec<List>, // maps symbols to unit of measure where applicable
                        'conf/pub:map:currency:undl': { 'cost': 2.7 } as EndpointSpec<List>, // maps derivatives symbols to their underlying currency
                        'conf/pub:map:currency:pool': { 'cost': 2.7 } as EndpointSpec<List>, // maps symbols to underlying network/protocol they operate on
                        'conf/pub:map:currency:explorer': { 'cost': 2.7 } as EndpointSpec<List>, // maps symbols to their recognised block explorer URLs
                        'conf/pub:map:currency:tx:fee': { 'cost': 2.7 } as EndpointSpec<List>, // maps currencies to their withdrawal fees https://github.com/ccxt/ccxt/issues/7745
                        'conf/pub:map:tx:method': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:{object}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:{object}:{detail}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:currency': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:pair:exchange': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:pair:margin': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:pair:futures': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:list:competitions': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:info:{object}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:info:{object}:{detail}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:info:pair': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:info:pair:futures': { 'cost': 2.7 } as EndpointSpec<List>,
                        'conf/pub:info:tx:status': { 'cost': 2.7 } as EndpointSpec<List>, // [ deposit, withdrawal ] statuses 1 = active, 0 = maintenance
                        'conf/pub:fees': { 'cost': 2.7 } as EndpointSpec<List>,
                        'platform/status': { 'cost': 8 } as EndpointSpec<List>, // 30 requests per minute = 0.5 requests per second => ( 1000ms / rateLimit ) / 0.5 = 8
                        'tickers': { 'cost': 2.7 } as EndpointSpec<List>, // 90 requests a minute = 1.5 requests per second => ( 1000 / rateLimit ) / 1.5 = 2.666666666
                        'ticker/{symbol}': { 'cost': 2.7 } as EndpointSpec<Dict>,
                        'tickers/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'trades/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'book/{symbol}/{precision}': { 'cost': 1 } as EndpointSpec<List>, // 240 requests a minute
                        'book/{symbol}/P0': { 'cost': 1 } as EndpointSpec<List>,
                        'book/{symbol}/P1': { 'cost': 1 } as EndpointSpec<List>,
                        'book/{symbol}/P2': { 'cost': 1 } as EndpointSpec<List>,
                        'book/{symbol}/P3': { 'cost': 1 } as EndpointSpec<List>,
                        'book/{symbol}/R0': { 'cost': 1 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:{side}/{section}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:{side}/last': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:{side}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}/{section}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}/last': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:long/last': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:long/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:short/last': { 'cost': 2.7 } as EndpointSpec<List>,
                        'stats1/{key}:{size}:{symbol}:short/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'candles/trade:{timeframe}:{symbol}:{period}/{section}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'candles/trade:{timeframe}:{symbol}/{section}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'candles/trade:{timeframe}:{symbol}/last': { 'cost': 2.7 } as EndpointSpec<List>,
                        'candles/trade:{timeframe}:{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'status/{type}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'status/deriv': { 'cost': 2.7 } as EndpointSpec<List>,
                        'status/deriv/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'liquidations/hist': { 'cost': 80 } as EndpointSpec<List>, // 3 requests a minute = 0.05 requests a second => ( 1000ms / rateLimit ) / 0.05 = 80
                        'rankings/{key}:{timeframe}:{symbol}/{section}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'rankings/{key}:{timeframe}:{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'pulse/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'pulse/profile/{nickname}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'funding/stats/{symbol}/hist': { 'cost': 10 } as EndpointSpec<List>, // ratelimit not in docs
                        'ext/vasps': { 'cost': 1 } as EndpointSpec<List>,
                    },
                    'post': {
                        'calc/trade/avg': { 'cost': 2.7 } as EndpointSpec<List>,
                        'calc/fx': { 'cost': 2.7 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'post': {
                        ...
                        'auth/r/wallets': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/wallets/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/orders': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/orders/{symbol}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/order/submit': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/order/update': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/order/cancel': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/order/multi': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/order/cancel/multi': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/orders/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/orders/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/order/{symbol}:{id}/trades': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/trades/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/trades/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/ledgers/{currency}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/ledgers/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/info/margin/{key}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/info/margin/base': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/info/margin/sym_all': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/positions': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/position/claim': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/position/increase:': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/position/increase/info': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/positions/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/positions/audit': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/positions/snap': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/deriv/collateral/set': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/deriv/collateral/limits': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/offers': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/offers/{symbol}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/funding/offer/submit': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/funding/offer/cancel': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/funding/offer/cancel/all': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/funding/close': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/funding/auto': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/funding/keep': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/offers/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/offers/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/loans': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/loans/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/loans/{symbol}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/loans/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/credits': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/credits/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/credits/{symbol}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/credits/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/trades/{symbol}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/funding/trades/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/info/funding/{key}': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/info/user': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/summary': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/logins/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/permissions': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/token': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/audit/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/transfer': { 'cost': 2.7 } as EndpointSpec<List>, // ratelimit not in docs...
                        'auth/w/deposit/address': { 'cost': 24 } as EndpointSpec<List>, // 10 requests a minute = 0.166 requests per second => ( 1000ms / rateLimit ) / 0.166 = 24
                        'auth/w/deposit/invoice': { 'cost': 24 } as EndpointSpec<List>, // ratelimit not in docs
                        'auth/w/withdraw': { 'cost': 24 } as EndpointSpec<List>, // ratelimit not in docs
                        'auth/r/movements/{currency}/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/movements/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/alerts': { 'cost': 5.34 } as EndpointSpec<List>, // 45 requests a minute = 0.75 requests per second => ( 1000ms / rateLimit ) / 0.749 => 5.34
                        'auth/w/alert/set': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/alert/price:{symbol}:{price}/del': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/alert/{type}:{symbol}:{price}/del': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/calc/order/avail': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/settings/set': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/settings': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/settings/del': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/r/pulse/hist': { 'cost': 2.7 } as EndpointSpec<List>,
                        'auth/w/pulse/add': { 'cost': 16 } as EndpointSpec<List>, // 15 requests a minute = 0.25 requests per second => ( 1000ms / rateLimit ) / 0.25 => 16
                        'auth/w/pulse/del': { 'cost': 2.7 } as EndpointSpec<List>,
                    },
                },
            },
            'fees': {
