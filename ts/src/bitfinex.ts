            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'conf/pub:{action}:{object}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:{action}:{object}:{detail}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:map:{object}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:map:{object}:{detail}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:map:currency:{detail}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:map:currency:sym': { 'cost': 2.7, 'returnType': 'List' }, // maps symbols to their API symbols, BAB > BCH
                        'conf/pub:map:currency:label': { 'cost': 2.7, 'returnType': 'List' }, // verbose friendly names, BNT > Bancor
                        'conf/pub:map:currency:unit': { 'cost': 2.7, 'returnType': 'List' }, // maps symbols to unit of measure where applicable
                        'conf/pub:map:currency:undl': { 'cost': 2.7, 'returnType': 'List' }, // maps derivatives symbols to their underlying currency
                        'conf/pub:map:currency:pool': { 'cost': 2.7, 'returnType': 'List' }, // maps symbols to underlying network/protocol they operate on
                        'conf/pub:map:currency:explorer': { 'cost': 2.7, 'returnType': 'List' }, // maps symbols to their recognised block explorer URLs
                        'conf/pub:map:currency:tx:fee': { 'cost': 2.7, 'returnType': 'List' }, // maps currencies to their withdrawal fees https://github.com/ccxt/ccxt/issues/7745
                        'conf/pub:map:tx:method': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:{object}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:{object}:{detail}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:currency': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:pair:exchange': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:pair:margin': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:pair:futures': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:list:competitions': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:info:{object}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:info:{object}:{detail}': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:info:pair': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:info:pair:futures': { 'cost': 2.7, 'returnType': 'List' },
                        'conf/pub:info:tx:status': { 'cost': 2.7, 'returnType': 'List' }, // [ deposit, withdrawal ] statuses 1 = active, 0 = maintenance
                        'conf/pub:fees': { 'cost': 2.7, 'returnType': 'List' },
                        ...
                        'tickers/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'trades/{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'book/{symbol}/{precision}': { 'cost': 1, 'returnType': 'List' }, // 240 requests a minute
                        'book/{symbol}/P0': { 'cost': 1, 'returnType': 'List' },
                        'book/{symbol}/P1': { 'cost': 1, 'returnType': 'List' },
                        'book/{symbol}/P2': { 'cost': 1, 'returnType': 'List' },
                        'book/{symbol}/P3': { 'cost': 1, 'returnType': 'List' },
                        'book/{symbol}/R0': { 'cost': 1, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:{side}/{section}': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:{side}/last': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:{side}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}/{section}': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}/last': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:long/last': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:long/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:short/last': { 'cost': 2.7, 'returnType': 'List' },
                        'stats1/{key}:{size}:{symbol}:short/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'candles/trade:{timeframe}:{symbol}:{period}/{section}': { 'cost': 2.7, 'returnType': 'List' },
                        'candles/trade:{timeframe}:{symbol}/{section}': { 'cost': 2.7, 'returnType': 'List' },
                        'candles/trade:{timeframe}:{symbol}/last': { 'cost': 2.7, 'returnType': 'List' },
                        'candles/trade:{timeframe}:{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'status/{type}': { 'cost': 2.7, 'returnType': 'List' },
                        ...
                        'rankings/{key}:{timeframe}:{symbol}/{section}': { 'cost': 2.7, 'returnType': 'List' },
                        'rankings/{key}:{timeframe}:{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'pulse/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'pulse/profile/{nickname}': { 'cost': 2.7, 'returnType': 'List' },
                        'funding/stats/{symbol}/hist': { 'cost': 10, 'returnType': 'List' }, // ratelimit not in docs
                        'ext/vasps': { 'cost': 1, 'returnType': 'List' },
                    },
                    'post': {
                        'calc/trade/avg': { 'cost': 2.7, 'returnType': 'List' },
                        'calc/fx': { 'cost': 2.7, 'returnType': 'List' },
                    },
                },
                'private': {
                    'post': {
                        ...
                        'auth/r/wallets/hist': { 'cost': 2.7, 'returnType': 'List' },
                        ...
                        'auth/r/info/margin/{key}': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/info/margin/base': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/info/margin/sym_all': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/positions': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/position/claim': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/position/increase:': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/position/increase/info': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/positions/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/positions/audit': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/positions/snap': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/deriv/collateral/set': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/deriv/collateral/limits': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/offers': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/offers/{symbol}': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/funding/offer/submit': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/funding/offer/cancel': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/funding/offer/cancel/all': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/funding/close': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/funding/auto': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/funding/keep': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/offers/{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/offers/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/loans': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/loans/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/loans/{symbol}': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/loans/{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/credits': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/credits/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/credits/{symbol}': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/credits/{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/trades/{symbol}/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/funding/trades/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/info/funding/{key}': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/info/user': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/summary': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/logins/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/permissions': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/token': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/audit/hist': { 'cost': 2.7, 'returnType': 'List' },
                        ...
                        'auth/w/deposit/invoice': { 'cost': 24, 'returnType': 'List' }, // ratelimit not in docs
                        ...
                        'auth/r/alerts': { 'cost': 5.34, 'returnType': 'List' }, // 45 requests a minute = 0.75 requests per second => ( 1000ms / rateLimit ) / 0.749 => 5.34
                        'auth/w/alert/set': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/alert/price:{symbol}:{price}/del': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/alert/{type}:{symbol}:{price}/del': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/calc/order/avail': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/settings/set': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/settings': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/settings/del': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/r/pulse/hist': { 'cost': 2.7, 'returnType': 'List' },
                        'auth/w/pulse/add': { 'cost': 16, 'returnType': 'List' }, // 15 requests a minute = 0.25 requests per second => ( 1000ms / rateLimit ) / 0.25 => 16
                        'auth/w/pulse/del': { 'cost': 2.7, 'returnType': 'List' },
                    },
                },
            },
            'fees': {
