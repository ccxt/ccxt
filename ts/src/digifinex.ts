                ...
                'private': {
                    'spot': {
                        'get': {
                            ...
                            '{market}/mytrades': 1,
                            '{market}/order': 1,
                            '{market}/order/detail': 1,
                            '{market}/order/current': 1,
                            '{market}/order/history': 1,
                    ...
                    'swap': {
                        ...
                        'post': {
                            ...
                            'account/leverage': 1,
                            'account/position_mode': 1,
                            'account/position_margin': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/batch_cancel_order': 1,
                            ...
                            'follow/sponsor_order': 1,
                            'follow/close_order': 1,
                            'follow/cancel_order': 1,
                            'follow/user_center_current': 1,
                            'follow/user_center_history': 1,
                            'follow/expert_current_open_order': 1,
                            'follow/add_algo': 1,
                            'follow/cancel_algo': 1,
                            'follow/account_available': 1,
                            'follow/plan_task': 1,
