                ...
                'public': {
                    'spot': {
                        'get': {
                            ...
                            'margin/currencies': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/symbols': { 'cost': 1, 'returnType': 'Dict' },
                            'markets': { 'cost': 1, 'returnType': 'Dict' },
                            'order_book': { 'cost': 1, 'returnType': 'Dict' },
                            'ping': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/symbols': { 'cost': 1, 'returnType': 'Dict' },
                            'time': { 'cost': 1, 'returnType': 'Dict' },
                            'trades': { 'cost': 1, 'returnType': 'Dict' },
                            'trades/symbols': { 'cost': 1, 'returnType': 'Dict' },
                    ...
                    'swap': {
                        'get': {
                            'public/api_weight': { 'cost': 1, 'returnType': 'Dict' },
                            'public/candles': { 'cost': 1, 'returnType': 'Dict' },
                            'public/candles_history': { 'cost': 1, 'returnType': 'Dict' },
                            'public/depth': { 'cost': 1, 'returnType': 'Dict' },
                            'public/funding_rate': { 'cost': 1, 'returnType': 'Dict' },
                            'public/funding_rate_history': { 'cost': 1, 'returnType': 'Dict' },
                            'public/instrument': { 'cost': 1, 'returnType': 'Dict' },
                            'public/instruments': { 'cost': 1, 'returnType': 'Dict' },
                            'public/ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'public/tickers': { 'cost': 1, 'returnType': 'Dict' },
                            'public/time': { 'cost': 1, 'returnType': 'Dict' },
                            'public/trades': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
                'private': {
                    'spot': {
                        'get': {
                            '{market}/financelog': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/mytrades': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/order': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/order/detail': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/order/current': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/order/history': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/assets': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/financelog': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/mytrades': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/order': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/order/current': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/order/history': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/positions': { 'cost': 1, 'returnType': 'Dict' },
                            'otc/financelog': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/assets': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/financelog': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/mytrades': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/order': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/order/current': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/order/history': { 'cost': 1, 'returnType': 'Dict' },
                            'deposit/address': { 'cost': 1, 'returnType': 'Dict' },
                            'deposit/history': { 'cost': 1, 'returnType': 'Dict' },
                            'withdraw/history': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            '{market}/order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/order/new': { 'cost': 1, 'returnType': 'Dict' },
                            '{market}/order/batch_new': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/order/new': { 'cost': 1, 'returnType': 'Dict' },
                            'margin/position/close': { 'cost': 1, 'returnType': 'Dict' },
                            'spot/order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                    ...
                    'swap': {
                        'get': {
                            ...
                            'account/finance_record': { 'cost': 1, 'returnType': 'Dict' },
                            'account/trading_fee_rate': { 'cost': 1, 'returnType': 'Dict' },
                            'account/transfer_record': { 'cost': 1, 'returnType': 'Dict' },
                            'account/funding_fee': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/history_orders': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/history_trades': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/open_orders': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/order_info': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'account/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'account/leverage': { 'cost': 1, 'returnType': 'Dict' },
                            'account/position_mode': { 'cost': 1, 'returnType': 'Dict' },
                            'account/position_margin': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/batch_cancel_order': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/batch_order': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/cancel_order': { 'cost': 1, 'returnType': 'Dict' },
                            'trade/order_place': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/sponsor_order': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/close_order': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/cancel_order': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/user_center_current': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/user_center_history': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/expert_current_open_order': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/add_algo': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/cancel_algo': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/account_available': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/plan_task': { 'cost': 1, 'returnType': 'Dict' },
                            'follow/instrument_list': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
            },
