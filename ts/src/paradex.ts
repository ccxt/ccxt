    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'bbo/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'bbo/{market}/interactive': { 'cost': 1, 'returnType': 'Dict' },
                        'funding/data': { 'cost': 1, 'returnType': 'Dict' },
                        'markets': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/history': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/klines': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/settlement-price': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/summary': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbook/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbook/{market}/impact-price': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbook/{market}/interactive': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'system/portfolio-margin-config': { 'cost': 1, 'returnType': 'Dict' },
                        'system/state': { 'cost': 1, 'returnType': 'Dict' },
                        'system/time': { 'cost': 1, 'returnType': 'Dict' },
                        'system/volume-tiers': { 'cost': 1, 'returnType': 'Dict' },
                        'trades': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/balance': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/config': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/history': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/positions': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/summary': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/transfers': { 'cost': 1, 'returnType': 'Dict' },
                        'xp/fee-config': { 'cost': 1, 'returnType': 'Dict' },
                        'xp/public-transfers': { 'cost': 1, 'returnType': 'Dict' },
                        'xp/transfer/{transfer_id}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        'account': { 'cost': 1, 'returnType': 'List' },
                        'account/compliance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/history': { 'cost': 1, 'returnType': 'Dict' },
                        'account/info': { 'cost': 1, 'returnType': 'Dict' },
                        'account/margin': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile': { 'cost': 1, 'returnType': 'Dict' },
                        'account/settings': { 'cost': 1, 'returnType': 'Dict' },
                        'account/subaccounts': { 'cost': 1, 'returnType': 'Dict' },
                        'account/summary': { 'cost': 1, 'returnType': 'Dict' },
                        'balance': { 'cost': 1, 'returnType': 'Dict' },
                        'fills': { 'cost': 1, 'returnType': 'Dict' },
                        'funding/payments': { 'cost': 1, 'returnType': 'Dict' },
                        'positions': { 'cost': 1, 'returnType': 'Dict' },
                        'tradebusts': { 'cost': 1, 'returnType': 'Dict' },
                        'transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'account/keys/subkeys': { 'cost': 1, 'returnType': 'Dict' },
                        'account/keys/subkeys/{public_key}': { 'cost': 1, 'returnType': 'Dict' },
                        'account/tokens': { 'cost': 1, 'returnType': 'Dict' },
                        'algo/orders': { 'cost': 1, 'returnType': 'Dict' },
                        'algo/orders-history': { 'cost': 1, 'returnType': 'Dict' },
                        'algo/orders/{algo_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades/{block_trade_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades/{block_trade_id}/offers': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'orders/by_client_id/{client_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/{order_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'referrals/qr-code': { 'cost': 1, 'returnType': 'Dict' },
                        'referrals/summary': { 'cost': 1, 'returnType': 'Dict' },
                        'staking/history': { 'cost': 1, 'returnType': 'Dict' },
                        'staking/summary': { 'cost': 1, 'returnType': 'Dict' },
                        'transfers': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/account-summary': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults/mine': { 'cost': 1, 'returnType': 'Dict' },
                        'xp/account-balance': { 'cost': 1, 'returnType': 'Dict' },
                        'xp/transfers': { 'cost': 1, 'returnType': 'Dict' },
                        // 'points_data/{market}/{program}': 1,
                    },
                    'post': {
                        'account/compliance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/margin/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/market_max_slippage/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/notifications': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/notifications/last_seen': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/referral_code': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/refresh_inventory': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/size_currency_display': { 'cost': 1, 'returnType': 'Dict' },
                        'account/profile/username': { 'cost': 1, 'returnType': 'Dict' },
                        'account/referrer': { 'cost': 1, 'returnType': 'Dict' },
                        'account/settings/trading_value_display': { 'cost': 1, 'returnType': 'Dict' },
                        'account/keys/subkeys/activate': { 'cost': 1, 'returnType': 'Dict' },
                        'account/keys/subkeys': { 'cost': 1, 'returnType': 'Dict' },
                        'account/tokens': { 'cost': 1, 'returnType': 'Dict' },
                        'algo/orders': { 'cost': 1, 'returnType': 'Dict' },
                        'auth': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades/{block_trade_id}/execute': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades/{block_trade_id}/offers': { 'cost': 1, 'returnType': 'Dict' },
                        'block-trades/{block_trade_id}/offers/{offer_id}/execute': { 'cost': 1, 'returnType': 'Dict' },
                        'onboarding': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/batch': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/auth': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/onboarding': { 'cost': 1, 'returnType': 'Dict' },
                        'vaults': { 'cost': 1, 'returnType': 'Dict' },
                        'xp/transfer': { 'cost': 1, 'returnType': 'Dict' },
