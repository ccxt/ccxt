    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'bbo/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bbo/{market}/interactive': { 'cost': 1 } as EndpointSpec<Dict>,
                        'funding/data': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/klines': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/settlement-price': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbook/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbook/{market}/impact-price': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbook/{market}/interactive': { 'cost': 1 } as EndpointSpec<Dict>,
                        'insurance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'jwks.json': { 'cost': 1 } as EndpointSpec<Dict>,
                        'onboarding': { 'cost': 1 } as EndpointSpec<Dict>,
                        'referrals/config': { 'cost': 1 } as EndpointSpec<Dict>,
                        'staking/config': { 'cost': 1 } as EndpointSpec<Dict>,
                        'system/announcements': { 'cost': 1 } as EndpointSpec<Dict>,
                        'system/config': { 'cost': 1 } as EndpointSpec<Dict>,
                        'system/portfolio-margin-config': { 'cost': 1 } as EndpointSpec<Dict>,
                        'system/state': { 'cost': 1 } as EndpointSpec<Dict>,
                        'system/time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'system/volume-tiers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/config': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'xp/fee-config': { 'cost': 1 } as EndpointSpec<Dict>,
                        'xp/public-transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'xp/transfer/{transfer_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        'account': { 'cost': 1 } as EndpointSpec<List>,
                        'account/compliance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/margin': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/settings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/subaccounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills': { 'cost': 1 } as EndpointSpec<Dict>,
                        'funding/payments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradebusts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transactions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/keys/subkeys': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/keys/subkeys/{public_key}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/tokens': { 'cost': 1 } as EndpointSpec<Dict>,
                        'algo/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'algo/orders-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'algo/orders/{algo_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}/offers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}/offers/{offer_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'liquidations': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/by_client_id/{client_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/{order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'referrals/qr-code': { 'cost': 1 } as EndpointSpec<Dict>,
                        'referrals/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'staking/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'staking/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/account-summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults/mine': { 'cost': 1 } as EndpointSpec<Dict>,
                        'xp/account-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'xp/transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        // 'points_data/{market}/{program}': 1,
                    },
                    'post': {
                        'account/compliance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/margin/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/market_max_slippage/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/notifications': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/notifications/last_seen': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/referral_code': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/refresh_inventory': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/size_currency_display': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/profile/username': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/referrer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/settings/trading_value_display': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/keys/subkeys/activate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/keys/subkeys': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/tokens': { 'cost': 1 } as EndpointSpec<Dict>,
                        'algo/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'auth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}/execute': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}/offers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}/offers/{offer_id}/execute': { 'cost': 1 } as EndpointSpec<Dict>,
                        'onboarding': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v2/auth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'v2/onboarding': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vaults': { 'cost': 1 } as EndpointSpec<Dict>,
                        'xp/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'delete': {
                        'account/keys/subkeys/{public_key}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/tokens/{lookup_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'algo/orders/{algo_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block-trades/{block_trade_id}/offers/{offer_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
