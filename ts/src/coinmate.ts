            ...
            'api': {
                ...
                'private': {
                    'post': {
                        ...
                        'bitcoinCashWithdrawal': 1,
                        'bitcoinCashDepositAddresses': 1,
                        'bitcoinDepositAddresses': 1,
                        'bitcoinWithdrawal': 1,
                        'bitcoinWithdrawalFees': 1,
                        'buyInstant': 1,
                        'buyLimit': 1,
                        'cancelOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelOrderWithInfo': { 'cost': 1, 'returnType': 'Dict' },
                        'createVoucher': 1,
                        'dashDepositAddresses': 1,
                        'dashWithdrawal': 1,
                        'ethereumWithdrawal': 1,
                        'ethereumDepositAddresses': 1,
                        'litecoinWithdrawal': 1,
                        'litecoinDepositAddresses': 1,
                        ...
                        'redeemVoucher': 1,
                        'replaceByBuyLimit': 1,
                        'replaceByBuyInstant': 1,
                        'replaceBySellLimit': 1,
                        'replaceBySellInstant': 1,
                        'rippleDepositAddresses': 1,
                        'rippleWithdrawal': 1,
                        'sellInstant': 1,
                        'sellLimit': 1,
                        ...
                        'unconfirmedBitcoinDeposits': 1,
                        'unconfirmedBitcoinCashDeposits': 1,
                        'unconfirmedDashDeposits': 1,
                        'unconfirmedEthereumDeposits': 1,
                        'unconfirmedLitecoinDeposits': 1,
                        'unconfirmedRippleDeposits': 1,
                        'cancelAllOpenOrders': 1,
                        'withdrawVirtualCurrency': 1,
                        'virtualCurrencyDepositAddresses': 1,
                        'unconfirmedVirtualCurrencyDeposits': 1,
                        'adaWithdrawal': 1,
                        'adaDepositAddresses': 1,
                        'unconfirmedAdaDeposits': 1,
                        'solWithdrawal': 1,
                        'solDepositAddresses': 1,
                        'unconfirmedSolDeposits': 1,
                        'bankWireWithdrawal': 1,
                    },
                },
            },
            'fees': {
