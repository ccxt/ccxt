            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'tickerAll': { 'cost': 1, 'returnType': 'Dict' },
                        'products': { 'cost': 1, 'returnType': 'Dict' },
                        'transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingPairs': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'private': {
                    'post': {
                        ...
                        'bitcoinCashWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'bitcoinCashDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'bitcoinDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'bitcoinWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'bitcoinWithdrawalFees': { 'cost': 1, 'returnType': 'Dict' },
                        'buyInstant': { 'cost': 1, 'returnType': 'Dict' },
                        'buyLimit': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelOrderWithInfo': { 'cost': 1, 'returnType': 'Dict' },
                        'createVoucher': { 'cost': 1, 'returnType': 'Dict' },
                        'dashDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'dashWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'ethereumWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'ethereumDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'litecoinWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'litecoinDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'openOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                        'orderHistory': { 'cost': 1, 'returnType': 'Dict' },
                        'orderById': { 'cost': 1, 'returnType': 'Dict' },
                        'pusherAuth': { 'cost': 1, 'returnType': 'Dict' },
                        'redeemVoucher': { 'cost': 1, 'returnType': 'Dict' },
                        'replaceByBuyLimit': { 'cost': 1, 'returnType': 'Dict' },
                        'replaceByBuyInstant': { 'cost': 1, 'returnType': 'Dict' },
                        'replaceBySellLimit': { 'cost': 1, 'returnType': 'Dict' },
                        'replaceBySellInstant': { 'cost': 1, 'returnType': 'Dict' },
                        'rippleDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'rippleWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'sellInstant': { 'cost': 1, 'returnType': 'Dict' },
                        'sellLimit': { 'cost': 1, 'returnType': 'Dict' },
                        'transactionHistory': { 'cost': 1, 'returnType': 'Dict' },
                        'traderFees': { 'cost': 1, 'returnType': 'Dict' },
                        'tradeHistory': { 'cost': 1, 'returnType': 'Dict' },
                        'transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'transferHistory': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedBitcoinDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedBitcoinCashDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedDashDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedEthereumDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedLitecoinDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedRippleDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelAllOpenOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawVirtualCurrency': { 'cost': 1, 'returnType': 'Dict' },
                        'virtualCurrencyDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedVirtualCurrencyDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'adaWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'adaDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedAdaDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'solWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'solDepositAddresses': { 'cost': 1, 'returnType': 'Dict' },
                        'unconfirmedSolDeposits': { 'cost': 1, 'returnType': 'Dict' },
                        'bankWireWithdrawal': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
