...
import type { Balances, Currency, Dict, List, Int, Market, NullableDict, FeeString, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, Transaction, int, EndpointSpec } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'tickerAll': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transactions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingPairs': { 'cost': 1 } as EndpointSpec<Dict>,
                ...
                'private': {
                    'post': {
                        ...
                        'bitcoinCashWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bitcoinCashDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bitcoinDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bitcoinWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bitcoinWithdrawalFees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'buyInstant': { 'cost': 1 } as EndpointSpec<Dict>,
                        'buyLimit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelOrderWithInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'createVoucher': { 'cost': 1 } as EndpointSpec<Dict>,
                        'dashDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'dashWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ethereumWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ethereumDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'litecoinWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'litecoinDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderHistory': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderById': { 'cost': 1 } as EndpointSpec<Dict>,
                        'pusherAuth': { 'cost': 1 } as EndpointSpec<Dict>,
                        'redeemVoucher': { 'cost': 1 } as EndpointSpec<Dict>,
                        'replaceByBuyLimit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'replaceByBuyInstant': { 'cost': 1 } as EndpointSpec<Dict>,
                        'replaceBySellLimit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'replaceBySellInstant': { 'cost': 1 } as EndpointSpec<Dict>,
                        'rippleDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'rippleWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sellInstant': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sellLimit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transactionHistory': { 'cost': 1 } as EndpointSpec<Dict>,
                        'traderFees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradeHistory': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transferHistory': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedBitcoinDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedBitcoinCashDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedDashDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedEthereumDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedLitecoinDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedRippleDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelAllOpenOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawVirtualCurrency': { 'cost': 1 } as EndpointSpec<Dict>,
                        'virtualCurrencyDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedVirtualCurrencyDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'adaWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'adaDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedAdaDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'solWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'solDepositAddresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'unconfirmedSolDeposits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'bankWireWithdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
