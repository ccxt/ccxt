...
export default class exmo extends Exchange {
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'web': {
                    'get': {
                        'ctrl/feesAndLimits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'en/docs/fees': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'public': {
                    'get': {
                        'currency': { 'cost': 1 } as EndpointSpec<List>,
                        'currency/list/extended': { 'cost': 1 } as EndpointSpec<List>,
                        'order_book': { 'cost': 1 } as EndpointSpec<Dict>,
                        'pair_settings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'candles_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'required_amount': { 'cost': 1 } as EndpointSpec<Dict>,
                        'payments/providers/crypto/list': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'post': {
                        'user_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order_create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order_cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'stop_market_order_create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'stop_market_order_cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'user_open_orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'user_trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'user_cancelled_orders': { 'cost': 1 } as EndpointSpec<List>,
                        'order_trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deposit_address': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdraw_crypt': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdraw_get_txid': { 'cost': 1 } as EndpointSpec<Dict>,
                        'excode_create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'excode_load': { 'cost': 1 } as EndpointSpec<Dict>,
                        'code_check': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallet_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'wallet_operations': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/update': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/position/close': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/position/margin_add': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/position/margin_remove': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/currency/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/pair/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/settings': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/funding/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/order/max_quantity': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/position/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/position/margin_remove_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/position/margin_add_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/wallet/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/wallet/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/user/trade/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/liquidation/feed': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
    ...
    override parseTrade (trade: Dict, market: Market = undefined): Trade {
        ...
        let takerOrMakerDefault: Str = undefined;
