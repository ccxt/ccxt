    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                ...
                'public': {
                    'get': {
                        'currency': { 'cost': 1, 'returnType': 'List' },
                        'currency/list/extended': { 'cost': 1, 'returnType': 'List' },
                        'order_book': { 'cost': 1, 'returnType': 'Dict' },
                        'pair_settings': { 'cost': 1, 'returnType': 'Dict' },
                        'ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'trades': { 'cost': 1, 'returnType': 'Dict' },
                        'candles_history': { 'cost': 1, 'returnType': 'Dict' },
                        'required_amount': { 'cost': 1, 'returnType': 'Dict' },
                        'payments/providers/crypto/list': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'post': {
                        'user_info': { 'cost': 1, 'returnType': 'Dict' },
                        'order_create': { 'cost': 1, 'returnType': 'Dict' },
                        'order_cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'stop_market_order_create': { 'cost': 1, 'returnType': 'Dict' },
                        'stop_market_order_cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'user_open_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'user_trades': { 'cost': 1, 'returnType': 'Dict' },
                        'user_cancelled_orders': { 'cost': 1, 'returnType': 'List' },
                        'order_trades': { 'cost': 1, 'returnType': 'Dict' },
                        'deposit_address': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraw_crypt': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraw_get_txid': { 'cost': 1, 'returnType': 'Dict' },
                        'excode_create': { 'cost': 1, 'returnType': 'Dict' },
                        'excode_load': { 'cost': 1, 'returnType': 'Dict' },
                        'code_check': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet_history': { 'cost': 1, 'returnType': 'Dict' },
                        'wallet_operations': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/create': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/update': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/position/close': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/position/margin_add': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/position/margin_remove': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/currency/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/pair/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/settings': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/funding/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/info': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/history': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/trades': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/order/max_quantity': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/position/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/position/margin_remove_info': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/position/margin_add_info': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/wallet/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/wallet/history': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/trade/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/trades': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/liquidation/feed': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
