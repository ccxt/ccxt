            ...
            'api': {
                ...
                'private': {
                    'post': {
                        ...
                        'margin/user/order/max_quantity': 1,
                        'margin/user/position/list': 1,
                        'margin/user/position/margin_remove_info': 1,
                        'margin/user/position/margin_add_info': 1,
                        'margin/user/wallet/list': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/user/wallet/history': 1,
                        'margin/user/trade/list': 1,
                        'margin/trades': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/liquidation/feed': 1,
                    },
                },
            },
            'fees': {
