    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        '{market}/book': { 'cost': 1, 'returnType': 'Dict' },
                        'report/{market}/book': { 'cost': 1, 'returnType': 'Dict' },
                        '{market}/trades': { 'cost': 5, 'returnType': 'List' },
                        'report/{market}/trades': { 'cost': 5, 'returnType': 'List' },
                        'ticker/price': { 'cost': 1, 'returnType': 'List' },
                        'ticker/book': { 'cost': 1, 'returnType': 'List' },
                        '{market}/candles': { 'cost': 1, 'returnType': 'List' },
                        'ticker/24h': { 'cost': 1, 'noMarket': 25, 'returnType': 'List' },
                        'time': { 'cost': 1, 'returnType': 'Dict' },
                        'markets': { 'cost': 1, 'returnType': 'List' },
                        'assets': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'private': {
                    'get': {
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                        'ordersOpen': { 'cost': 5, 'noMarket': 100, 'returnType': 'List' },
                        'trades': { 'cost': 5, 'returnType': 'List' },
                        'orders': { 'cost': 5, 'returnType': 'List' },
                        'deposit': { 'cost': 1, 'returnType': 'Dict' },
                        'depositHistory': { 'cost': 5, 'returnType': 'List' },
                        'withdrawalHistory': { 'cost': 5, 'returnType': 'List' },
                        'account': { 'cost': 1, 'returnType': 'List' },
                        'balance': { 'cost': 5, 'returnType': 'Dict' },
                        'stakingBalance': { 'cost': 1, 'returnType': 'List' },
                        'account/fees': { 'cost': 1, 'returnType': 'Dict' },
                        'account/history': { 'cost': 1, 'returnType': 'Dict' },
                        'subaccounts': { 'cost': 5, 'returnType': 'Dict' },
                        'subaccounts/transfers': { 'cost': 5, 'returnType': 'Dict' },
                        'subaccounts/transfers/{transferId}': { 'cost': 5, 'returnType': 'Dict' },
                        'institutional/subaccounts/balance': { 'cost': 5, 'returnType': 'Dict' },
                        'institutional/subaccounts/history': { 'cost': 5, 'returnType': 'Dict' },
                        'institutional/subaccounts/orders/open': { 'cost': 5, 'noMarket': 100, 'returnType': 'List' },
                    },
                    'post': {
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelOrdersAfter': { 'cost': 5, 'returnType': 'Dict' },
                        'withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'crypto/withdrawal': { 'cost': 25, 'returnType': 'Dict' },
                        'subaccounts': { 'cost': 5, 'returnType': 'Dict' },
                        'subaccounts/transfers': { 'cost': 5, 'returnType': 'Dict' },
                    },
                    'put': {
                    ...
                    'delete': {
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 25, 'noMarket': 100, 'returnType': 'List' },
                        'atomic/orders': { 'cost': 100, 'returnType': 'List' },
                        'institutional/subaccounts/order': { 'cost': 1, 'returnType': 'Dict' },
                        'institutional/subaccounts/orders': { 'cost': 25, 'noMarket': 100, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
