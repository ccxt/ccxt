    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        '{market}/book': { 'cost': 1 } as EndpointSpec<Dict>,
                        'report/{market}/book': { 'cost': 1 } as EndpointSpec<Dict>,
                        '{market}/trades': { 'cost': 5 } as EndpointSpec<List>,
                        'report/{market}/trades': { 'cost': 5 } as EndpointSpec<List>,
                        'ticker/price': { 'cost': 1 } as EndpointSpec<List>,
                        'ticker/book': { 'cost': 1 } as EndpointSpec<List>,
                        '{market}/candles': { 'cost': 1 } as EndpointSpec<List>,
                        'ticker/24h': { 'cost': 1, 'noMarket': 25 } as EndpointSpec<List>,
                        'time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets': { 'cost': 1 } as EndpointSpec<List>,
                        'assets': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ordersOpen': { 'cost': 5, 'noMarket': 100 } as EndpointSpec<List>,
                        'trades': { 'cost': 5 } as EndpointSpec<List>,
                        'orders': { 'cost': 5 } as EndpointSpec<List>,
                        'deposit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'depositHistory': { 'cost': 5 } as EndpointSpec<List>,
                        'withdrawalHistory': { 'cost': 5 } as EndpointSpec<List>,
                        'account': { 'cost': 1 } as EndpointSpec<List>,
                        'balance': { 'cost': 5 } as EndpointSpec<Dict>,
                        'stakingBalance': { 'cost': 1 } as EndpointSpec<List>,
                        'account/fees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'subaccounts': { 'cost': 5 } as EndpointSpec<Dict>,
                        'subaccounts/transfers': { 'cost': 5 } as EndpointSpec<Dict>,
                        'subaccounts/transfers/{transferId}': { 'cost': 5 } as EndpointSpec<Dict>,
                        'institutional/subaccounts/balance': { 'cost': 5 } as EndpointSpec<Dict>,
                        'institutional/subaccounts/history': { 'cost': 5 } as EndpointSpec<Dict>,
                        'institutional/subaccounts/orders/open': { 'cost': 5, 'noMarket': 100 } as EndpointSpec<List>,
                    },
                    'post': {
                        'order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelOrdersAfter': { 'cost': 5 } as EndpointSpec<Dict>,
                        'withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'crypto/withdrawal': { 'cost': 25 } as EndpointSpec<Dict>,
                        'subaccounts': { 'cost': 5 } as EndpointSpec<Dict>,
                        'subaccounts/transfers': { 'cost': 5 } as EndpointSpec<Dict>,
                    },
                    'put': {
                    ...
                    'delete': {
                        'order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 25, 'noMarket': 100 } as EndpointSpec<List>,
                        'atomic/orders': { 'cost': 100 } as EndpointSpec<List>,
                        'institutional/subaccounts/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'institutional/subaccounts/orders': { 'cost': 25, 'noMarket': 100 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
