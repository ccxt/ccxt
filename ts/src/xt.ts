...
export default class xt extends Exchange {
                ...
                'public': {
                    'spot': {
                        'get': {
                            ...
                            'depth': { 'cost': 10 } as EndpointSpec<Dict>,
                            'kline': { 'cost': 1 } as EndpointSpec<Dict>,
                            'symbol': { 'cost': 1 } as EndpointSpec<Dict>, // 1 for a single symbol
                            'ticker': { 'cost': 1 } as EndpointSpec<Dict>, // 1 for a single symbol
                            'ticker/book': { 'cost': 1 } as EndpointSpec<Dict>, // 1 for a single symbol
                            'ticker/price': { 'cost': 1 } as EndpointSpec<Dict>, // 1 for a single symbol
                            'ticker/24h': { 'cost': 1 } as EndpointSpec<Dict>, // 1 for a single symbol
                            'time': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade/recent': { 'cost': 1 } as EndpointSpec<Dict>,
                            'wallet/support/currency': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'linear': {
                        'get': {
                            'future/market/v1/public/contract/risk-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/contract/open-interest': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/leverage/bracket/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/leverage/bracket/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/agg-ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/agg-tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/deal': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/depth': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/funding-rate': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/funding-rate-record': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/index-price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/kline': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/mark-price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/symbol-index-price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/symbol-mark-price': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/ticker/books': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/q/tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/market/v1/public/symbol/coins': { 'cost': 3.33 } as EndpointSpec<Dict>,
                            'future/market/v1/public/symbol/detail': { 'cost': 3.33 } as EndpointSpec<Dict>,
                            'future/market/v1/public/symbol/list': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'inverse': {
                        'get': {
                ...
                'private': {
                    'spot': {
                        'get': {
                            ...
                            'balances': { 'cost': 1 } as EndpointSpec<Dict>,
                            'batch-order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'deposit/address': { 'cost': 1 } as EndpointSpec<Dict>,
                            'deposit/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'history-order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'open-order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/{orderId}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade': { 'cost': 1 } as EndpointSpec<Dict>,
                            'withdraw/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'order': { 'cost': 0.2 } as EndpointSpec<Dict>,
                            'withdraw': { 'cost': 10 } as EndpointSpec<Dict>,
                            'balance/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'balance/account/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'ws-token': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'delete': {
                            'batch-order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'open-order': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'linear': {
                        'get': {
                            'future/trade/v1/entrust/plan-detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/plan-list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/plan-list-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/profit-detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/profit-list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/list-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/trade-list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/account/info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/balance/bills': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/balance/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/balance/funding-rate-list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/balance/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/adl': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/break-list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/user/collection/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/user/listen-key': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'future/trade/v1/entrust/cancel-all-plan': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/cancel-all-profit-stop': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/cancel-plan': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/cancel-profit-stop': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/create-plan': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/create-profit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/entrust/update-profit-stop': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/cancel-all': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/create': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/create-batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/trade/v1/order/update': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/account/open': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/adjust-leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/auto-margin': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/close-all': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/margin': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/user/collection/add': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/user/collection/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'future/user/v1/position/change-type': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'inverse': {
                        'get': {
                    ...
                    'user': {
                        'get': {
                            'user/account': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/account/api-key': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'user/account': { 'cost': 1 } as EndpointSpec<Dict>,
                            'user/account/api-key': { 'cost': 1 } as EndpointSpec<Dict>,
                        ...
                        'delete': {
                            'user/account/{apiKeyId}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
     ...
     */
    override async fetchTicker (symbol: string, params = {}) {
        if (this.markets === undefined) {
            await this.loadMarkets ();
        }
        const market = this.market (symbol);
     ...
     * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/en/latest/manual.html#transaction-structure}
     */
    override async fetchWithdrawals (code: Str = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
        if (this.markets === undefined) {
            await this.loadMarkets ();
        }
        const request: Dict = {};
     ...
     */
    override async addMargin (symbol: string, amount: number, params = {}) {
     ...
     * @returns {object} a [margin structure]{@link https://docs.ccxt.com/?id=margin-structure}
     */
    override async reduceMargin (symbol: string, amount: number, params = {}) {
    ...
    override sign (path: any, api: any = [], method = 'GET', params = {}, headers: NullableDict = undefined, body: any = undefined) {
        ...
        if (signed) {
            ...
            let payloadString: Str = undefined;
            if ((endpoint === 'spot') || (endpoint === 'user')) {
