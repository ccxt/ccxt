...
import type { IndexType, Balances, Currency, CurrencyInterface, Int, List, Market, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, Num, Account, Currencies, Dict, int, LedgerEntry, DepositAddress, NullableDict, Status, EndpointSpec } from './base/types.js';
// ---------------------------------------------------------------------------
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'Activate2FA': { 'cost': 1 } as EndpointSpec<Dict>,
                        'Authenticate2FA': { 'cost': 1 } as EndpointSpec<Dict>,
                        'AuthenticateUser': { 'cost': 1 } as EndpointSpec<Dict>,
                        'EnableXP2FA': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetL2Snapshot': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetLevel1': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetValidate2FARequiredEndpoints': { 'cost': 1 } as EndpointSpec<List>,
                        'LogOut': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetTickerHistory': { 'cost': 1 } as EndpointSpec<List>,
                        'GetProduct': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetProducts': { 'cost': 1 } as EndpointSpec<List>,
                        'GetInstrument': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetInstruments': { 'cost': 1 } as EndpointSpec<List>,
                        'GetEarliestTickTime': { 'cost': 1 } as EndpointSpec<List>,
                        ...
                        'summary': { 'cost': 1 } as EndpointSpec<List>,
                        'trades': { 'cost': 1 } as EndpointSpec<List>, // undocumented
                        'GetLastTrades': { 'cost': 1 } as EndpointSpec<List>, // undocumented
                        'ConfirmWithdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SubscribeLevel1': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SubscribeLevel2': { 'cost': 1 } as EndpointSpec<List>,
                        'SubscribeTicker': { 'cost': 1 } as EndpointSpec<List>,
                        'SubscribeTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'SubscribeBlockTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'UnsubscribeBlockTrades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'UnsubscribeLevel1': { 'cost': 1 } as EndpointSpec<Dict>,
                        'UnsubscribeLevel2': { 'cost': 1 } as EndpointSpec<Dict>,
                        'UnsubscribeTicker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'UnsubscribeTrades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'Authenticate': { 'cost': 1 } as EndpointSpec<Dict>, // undocumented
                    },
                },
                'private': {
                    'get': {
                        'GetUserAccountInfos': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUserAccounts': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUserAffiliateCount': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetUserAffiliateTag': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUserConfig': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAllUnredactedUserConfigsForUser': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUnredactedUserConfigByKey': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUserDevices': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUserReportTickets': { 'cost': 1 } as EndpointSpec<List>,
                        'GetUserReportWriterResultRecords': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAccountInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetAccountPositions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetAllAccountConfigs': { 'cost': 1 } as EndpointSpec<List>,
                        'GetTreasuryProductsForAccount': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAccountTrades': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAccountTransactions': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOpenTradeReports': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAllOpenTradeReports': { 'cost': 1 } as EndpointSpec<List>,
                        'GetTradesHistory': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOpenOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOpenQuotes': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetOrderFee': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetOrderHistory': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOrdersHistory': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOrderStatus': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetOmsFeeTiers': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAccountDepositTransactions': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAccountWithdrawTransactions': { 'cost': 1 } as EndpointSpec<List>,
                        'GetAllDepositRequestInfoTemplates': { 'cost': 1 } as EndpointSpec<List>,
                        'GetDepositInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetDepositRequestInfoTemplate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetDeposits': { 'cost': 1 } as EndpointSpec<List>,
                        'GetDepositTicket': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetDepositTickets': { 'cost': 1 } as EndpointSpec<List>,
                        'GetOMSWithdrawFees': { 'cost': 1 } as EndpointSpec<List>,
                        'GetWithdrawFee': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetWithdraws': { 'cost': 1 } as EndpointSpec<List>,
                        'GetWithdrawTemplate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetWithdrawTemplateTypes': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetWithdrawTicket': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetWithdrawTicketAttachment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetWithdrawTickets': { 'cost': 1 } as EndpointSpec<List>,
                        'GetDepositTicketAttachment': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'AddUserAffiliateTag': { 'cost': 1 } as EndpointSpec<Dict>,
                        'AddDepositTicketAttachment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'AddWithdrawTicketAttachment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelUserReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'RegisterNewDevice': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SubscribeAccountEvents': { 'cost': 1 } as EndpointSpec<Dict>,
                        'UpdateUserAffiliateTag': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GenerateTradeActivityReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GenerateTransactionActivityReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GenerateTreasuryActivityReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ScheduleTradeActivityReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ScheduleTransactionActivityReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ScheduleTreasuryActivityReport': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelAllOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelQuote': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelReplaceOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CreateQuote': { 'cost': 1 } as EndpointSpec<Dict>,
                        'ModifyOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SendOrder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SubmitBlockTrade': { 'cost': 1 } as EndpointSpec<Dict>,
                        'UpdateQuote': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CancelWithdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CreateDepositTicket': { 'cost': 1 } as EndpointSpec<Dict>,
                        'CreateWithdrawTicket': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SubmitDepositTicketComment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'SubmitWithdrawTicketComment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'GetOrderHistoryByOrderId': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
            },
            'features': {
