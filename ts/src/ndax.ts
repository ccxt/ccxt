    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'Activate2FA': { 'cost': 1, 'returnType': 'Dict' },
                        'Authenticate2FA': { 'cost': 1, 'returnType': 'Dict' },
                        'AuthenticateUser': { 'cost': 1, 'returnType': 'Dict' },
                        'EnableXP2FA': { 'cost': 1, 'returnType': 'Dict' },
                        'GetL2Snapshot': { 'cost': 1, 'returnType': 'Dict' },
                        'GetLevel1': { 'cost': 1, 'returnType': 'Dict' },
                        'GetValidate2FARequiredEndpoints': { 'cost': 1, 'returnType': 'List' },
                        'LogOut': { 'cost': 1, 'returnType': 'Dict' },
                        'GetTickerHistory': { 'cost': 1, 'returnType': 'List' },
                        'GetProduct': { 'cost': 1, 'returnType': 'Dict' },
                        'GetProducts': { 'cost': 1, 'returnType': 'List' },
                        'GetInstrument': { 'cost': 1, 'returnType': 'Dict' },
                        'GetInstruments': { 'cost': 1, 'returnType': 'List' },
                        'GetEarliestTickTime': { 'cost': 1, 'returnType': 'List' },
                        'Ping': { 'cost': 1, 'returnType': 'Dict' },
                        'assets': { 'cost': 1, 'returnType': 'List' },
                        'orderbook': { 'cost': 1, 'returnType': 'Dict' },
                        'ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'summary': { 'cost': 1, 'returnType': 'List' },
                        'trades': { 'cost': 1, 'returnType': 'List' }, // undocumented
                        'GetLastTrades': { 'cost': 1, 'returnType': 'List' }, // undocumented
                        'ConfirmWithdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'SubscribeLevel1': { 'cost': 1, 'returnType': 'Dict' },
                        'SubscribeLevel2': { 'cost': 1, 'returnType': 'List' },
                        'SubscribeTicker': { 'cost': 1, 'returnType': 'List' },
                        'SubscribeTrades': { 'cost': 1, 'returnType': 'List' },
                        'SubscribeBlockTrades': { 'cost': 1, 'returnType': 'List' },
                        'UnsubscribeBlockTrades': { 'cost': 1, 'returnType': 'Dict' },
                        'UnsubscribeLevel1': { 'cost': 1, 'returnType': 'Dict' },
                        'UnsubscribeLevel2': { 'cost': 1, 'returnType': 'Dict' },
                        'UnsubscribeTicker': { 'cost': 1, 'returnType': 'Dict' },
                        'UnsubscribeTrades': { 'cost': 1, 'returnType': 'Dict' },
                        'Authenticate': { 'cost': 1, 'returnType': 'Dict' }, // undocumented
                    },
                },
                'private': {
                    'get': {
                        'GetUserAccountInfos': { 'cost': 1, 'returnType': 'List' },
                        'GetUserAccounts': { 'cost': 1, 'returnType': 'List' },
                        'GetUserAffiliateCount': { 'cost': 1, 'returnType': 'Dict' },
                        'GetUserAffiliateTag': { 'cost': 1, 'returnType': 'List' },
                        'GetUserConfig': { 'cost': 1, 'returnType': 'List' },
                        'GetAllUnredactedUserConfigsForUser': { 'cost': 1, 'returnType': 'List' },
                        'GetUnredactedUserConfigByKey': { 'cost': 1, 'returnType': 'List' },
                        'GetUserDevices': { 'cost': 1, 'returnType': 'List' },
                        'GetUserReportTickets': { 'cost': 1, 'returnType': 'List' },
                        'GetUserReportWriterResultRecords': { 'cost': 1, 'returnType': 'List' },
                        'GetAccountInfo': { 'cost': 1, 'returnType': 'Dict' },
                        'GetAccountPositions': { 'cost': 1, 'returnType': 'Dict' },
                        'GetAllAccountConfigs': { 'cost': 1, 'returnType': 'List' },
                        'GetTreasuryProductsForAccount': { 'cost': 1, 'returnType': 'List' },
                        'GetAccountTrades': { 'cost': 1, 'returnType': 'List' },
                        'GetAccountTransactions': { 'cost': 1, 'returnType': 'List' },
                        'GetOpenTradeReports': { 'cost': 1, 'returnType': 'List' },
                        'GetAllOpenTradeReports': { 'cost': 1, 'returnType': 'List' },
                        'GetTradesHistory': { 'cost': 1, 'returnType': 'List' },
                        'GetOpenOrders': { 'cost': 1, 'returnType': 'List' },
                        'GetOpenQuotes': { 'cost': 1, 'returnType': 'Dict' },
                        'GetOrderFee': { 'cost': 1, 'returnType': 'Dict' },
                        'GetOrderHistory': { 'cost': 1, 'returnType': 'List' },
                        'GetOrdersHistory': { 'cost': 1, 'returnType': 'List' },
                        'GetOrderStatus': { 'cost': 1, 'returnType': 'Dict' },
                        'GetOmsFeeTiers': { 'cost': 1, 'returnType': 'List' },
                        'GetAccountDepositTransactions': { 'cost': 1, 'returnType': 'List' },
                        'GetAccountWithdrawTransactions': { 'cost': 1, 'returnType': 'List' },
                        'GetAllDepositRequestInfoTemplates': { 'cost': 1, 'returnType': 'List' },
                        'GetDepositInfo': { 'cost': 1, 'returnType': 'Dict' },
                        'GetDepositRequestInfoTemplate': { 'cost': 1, 'returnType': 'Dict' },
                        'GetDeposits': { 'cost': 1, 'returnType': 'List' },
                        'GetDepositTicket': { 'cost': 1, 'returnType': 'Dict' },
                        'GetDepositTickets': { 'cost': 1, 'returnType': 'List' },
                        'GetOMSWithdrawFees': { 'cost': 1, 'returnType': 'List' },
                        'GetWithdrawFee': { 'cost': 1, 'returnType': 'Dict' },
                        'GetWithdraws': { 'cost': 1, 'returnType': 'List' },
                        'GetWithdrawTemplate': { 'cost': 1, 'returnType': 'Dict' },
                        'GetWithdrawTemplateTypes': { 'cost': 1, 'returnType': 'Dict' },
                        'GetWithdrawTicket': { 'cost': 1, 'returnType': 'Dict' },
                        'GetWithdrawTicketAttachment': { 'cost': 1, 'returnType': 'Dict' },
                        'GetWithdrawTickets': { 'cost': 1, 'returnType': 'List' },
                        'GetDepositTicketAttachment': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'AddUserAffiliateTag': { 'cost': 1, 'returnType': 'Dict' },
                        'AddDepositTicketAttachment': { 'cost': 1, 'returnType': 'Dict' },
                        'AddWithdrawTicketAttachment': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelUserReport': { 'cost': 1, 'returnType': 'Dict' },
                        'RegisterNewDevice': { 'cost': 1, 'returnType': 'Dict' },
                        'SubscribeAccountEvents': { 'cost': 1, 'returnType': 'Dict' },
                        'UpdateUserAffiliateTag': { 'cost': 1, 'returnType': 'Dict' },
                        'GenerateTradeActivityReport': { 'cost': 1, 'returnType': 'Dict' },
                        'GenerateTransactionActivityReport': { 'cost': 1, 'returnType': 'Dict' },
                        'GenerateTreasuryActivityReport': { 'cost': 1, 'returnType': 'Dict' },
                        'ScheduleTradeActivityReport': { 'cost': 1, 'returnType': 'Dict' },
                        'ScheduleTransactionActivityReport': { 'cost': 1, 'returnType': 'Dict' },
                        'ScheduleTreasuryActivityReport': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelAllOrders': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelQuote': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelReplaceOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'CreateQuote': { 'cost': 1, 'returnType': 'Dict' },
                        'ModifyOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'SendOrder': { 'cost': 1, 'returnType': 'Dict' },
                        'SubmitBlockTrade': { 'cost': 1, 'returnType': 'Dict' },
                        'UpdateQuote': { 'cost': 1, 'returnType': 'Dict' },
                        'CancelWithdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'CreateDepositTicket': { 'cost': 1, 'returnType': 'Dict' },
                        'CreateWithdrawTicket': { 'cost': 1, 'returnType': 'Dict' },
                        'SubmitDepositTicketComment': { 'cost': 1, 'returnType': 'Dict' },
                        'SubmitWithdrawTicketComment': { 'cost': 1, 'returnType': 'Dict' },
                        'GetOrderHistoryByOrderId': { 'cost': 1, 'returnType': 'List' },
                    },
                },
            },
            'features': {
