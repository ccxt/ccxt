    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'deepcoin/market/books': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/instruments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/index-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/mark-price-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deepcoin/market/step-margin': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/funding-rate': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/fund-rate/current-funding-rate': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/fund-rate/history': { 'cost': 5 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        'deepcoin/account/balances': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/account/bills': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/account/positions': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/fills': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/orderByID': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/finishOrderByID': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/orders-history': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/v2/orders-pending': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/trigger-orders-pending': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/trigger-orders-history': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/support-contracts': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/leader-position': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/estimate-profit': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/history-profit': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/follower-rank': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/internal-transfer/support': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/internal-transfer/history-order': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/rebate/config': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/agents/users': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/agents/users/rebate-list': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/agents/users/rebates': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/asset/deposit-list': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/asset/withdraw-list': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/asset/recharge-chain-list': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/listenkey/acquire': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/listenkey/extend': { 'cost': 5 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'deepcoin/account/set-leverage': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/order': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/replace-order': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/cancel-order': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/batch-cancel-order': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/cancel-trigger-order': { 'cost': 1 / 6 } as EndpointSpec<Dict>,
                        'deepcoin/trade/swap/cancel-all': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/trigger-order': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/batch-close-position': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/replace-order-sltp': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/trade/close-position-by-ids': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/leader-settings': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/copytrading/set-contracts': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/internal-transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/rebate/config': { 'cost': 5 } as EndpointSpec<Dict>,
                        'deepcoin/asset/transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
