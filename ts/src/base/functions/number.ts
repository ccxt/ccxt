...
export {
    ...
    PAD_WITH_ZERO, ROUND, ROUND_DOWN, ROUND_UP, SIGNIFICANT_DIGITS,
    TICK_SIZE, TRUNCATE, decimalToPrecision, numberToString, omitZero,
    precisionConstants, precisionFromString, truncate, truncate_to_string
};
