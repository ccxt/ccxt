    ...
    setProxyAgents (httpProxy, httpsProxy, socksProxy) {
        ...
        if (httpProxy) {
            if (this.httpProxyAgentModule === undefined) {
                throw new NotSupported (this.id + ' you need to load JS proxy modules with `await exchange.loadProxyModules()` method at first to use proxies');
            }
            ...
            if (this.socksProxyAgentModule === undefined) {
                throw new NotSupported (this.id + ' - to use SOCKS proxy with ccxt, at first you need install module "npm i socks-proxy-agent" and then initialize proxies with `await exchange.loadProxyModules()` method');
            }
