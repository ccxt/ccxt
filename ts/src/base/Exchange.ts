...
export default class Exchange {
    ...
    parseOrders (orders: ObjectOrObjectList, market: Market = undefined, since: Int = undefined, limit: Int = undefined, params = {}): Order[] {
        //
    ...
    parseOHLCV (ohlcv: ObjectOrObjectList, market: Market = undefined) : OHLCV {
    ...
    parsePositions (positions: ObjectOrObjectList, symbols: string[] = undefined, params = {}): Position[] {
        symbols = this.marketSymbols (symbols);
    ...
    parseAccounts (accounts: ObjectOrObjectList, params = {}): Account[] {
    ...
    parseTrades (trades: ObjectOrObjectList, market: Market = undefined, since: Int = undefined, limit: Int = undefined, params = {}): Trade[] {
    ...
    parseTransactions (transactions: ObjectOrObjectList, currency: Currency = undefined, since: Int = undefined, limit: Int = undefined, params = {}): Transaction[] {
    ...
    parseTransfers (transfers: ObjectOrObjectList, currency: Currency = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
    ...
    parseLedger (data: ObjectOrObjectList, currency: Currency = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
        let result = [];
    ...
    parseTickers (tickers: ObjectOrObjectList, symbols: string[] = undefined, params = {}): Dictionary<Ticker> {
        //
        // the value of tickers is either a dict or a list
        //
        // dict
    ...
    parseDepositWithdrawFees (response: ObjectOrObjectList, codes: string[] = undefined, currencyIdKey = undefined): any {
        /**
         * @ignore
         * @method
