...
export default class Exchange {
    ...
    async fetchLeverageTiers (symbols: Strings = undefined, params = {}): Promise<Dictionary<LeverageTier[]>> {
    ...
    safeNumber (obj = undefined, key: IndexType, defaultNumber: Num = undefined): Num {
