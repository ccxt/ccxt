...
export default class Exchange {
    ...
    parseAccount (account): AccountStructure {
    ...
    parseAccounts (accounts: any[], params = {}): AccountStructure[] {
