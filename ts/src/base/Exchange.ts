...
export default class Exchange {
    ...
    async fetchPositionsBySymbol (symbol: string, params = {}): Promise<Position[]> {
         ...
         * @returns {object[]} a list of [position structure]{https://docs.ccxt.com/#/?id=position-structure} with maximum 3 items - one position for "one-way" mode, and two positions (long & short) for "two-way" (a.k.a. hedge) mode
         */
    ...
    parseIncomes (incomes, market = undefined, since: Int = undefined, limit: Int = undefined): FundingHistory[] {
         ...
         * @returns {object[]} an array of [funding history structures]{https://docs.ccxt.com/#/?id=funding-history-structure}
         */
        const result = [];
