...
import type { Currency, CurrencyInterface, Currencies, Dict, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, TradingFeeInterface, int, Account, Balances, LedgerEntry, Transaction, TransferEntry, DepositAddress, NullableDict, EndpointSpec } from './base/types.js';
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {},
                    'post': {
                        'get_server_time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_pairs_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_currencies_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_processing_info': { 'cost': 10 } as EndpointSpec<Dict>,
                        ...
                        'get_candles': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {},
                    'post': {
                        'get_my_current_fee': { 'cost': 5 } as EndpointSpec<Dict>,
                        'get_fee_strategy': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_my_volume': { 'cost': 5 } as EndpointSpec<Dict>,
                        'do_create_account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_my_account_status_v3': { 'cost': 5 } as EndpointSpec<Dict>,
                        'get_my_wallet_balance': { 'cost': 5 } as EndpointSpec<Dict>,
                        'get_my_orders': { 'cost': 5 } as EndpointSpec<Dict>,
                        'do_my_new_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'do_cancel_my_order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'do_cancel_all_orders': { 'cost': 5 } as EndpointSpec<Dict>,
                        'get_order_book': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_trade_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_my_transaction_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_my_funding_history': { 'cost': 5 } as EndpointSpec<Dict>,
                        'do_my_internal_transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'get_processing_info': { 'cost': 10 } as EndpointSpec<Dict>,
                        'get_deposit_address': { 'cost': 5 } as EndpointSpec<Dict>,
                        'do_deposit_funds_from_wallet': { 'cost': 1 } as EndpointSpec<Dict>,
                        'do_withdrawal_funds_to_wallet': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'features': {
