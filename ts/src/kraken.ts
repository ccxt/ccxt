...
;
import type { IndexType, Int, OrderSide, OrderType, OHLCV, Trade, Order, Balances, Str, Dict, Transaction, Ticker, OrderBook, Tickers, Strings, Currency, CurrencyInterface, Market, TransferEntry, Num, Bool, TradingFeeInterface, Currencies, int, LedgerEntry, List, DepositAddress, Position, OrderRequest, NullableDict, FeeString, NullableList, Status } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'zendesk': {
                    'get': {
                        '360000292886': { 'cost': 1, 'returnType': 'Dict' },
                        '201893608': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'public': {
                    'get': {
                        ...
                        'SystemStatus': { 'cost': 1, 'returnType': 'Dict' },
                        'Assets': { 'cost': 1, 'returnType': 'Dict' },
                        'AssetPairs': { 'cost': 1, 'returnType': 'Dict' },
                        'Ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'OHLC': { 'cost': 1.2, 'returnType': 'Dict' }, // 1.2 because 1 triggers too many requests immediately
                        'Depth': { 'cost': 1.2, 'returnType': 'Dict' },
                        'GroupedBook': { 'cost': 1.2, 'returnType': 'Dict' },
                        'Trades': { 'cost': 1.2, 'returnType': 'Dict' },
                        'Spread': { 'cost': 1, 'returnType': 'Dict' },
                        'PreTrade': { 'cost': 1, 'returnType': 'Dict' },
                        'PostTrade': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'post': {
                        'Level3': { 'cost': 1.2, 'returnType': 'Dict' },
                        // account
                        'Balance': { 'cost': 3, 'returnType': 'Dict' },
                        'BalanceEx': { 'cost': 3, 'returnType': 'Dict' },
                        'CreditLines': { 'cost': 3, 'returnType': 'Dict' },
                        'TradeBalance': { 'cost': 3, 'returnType': 'Dict' },
                        'OpenOrders': { 'cost': 3, 'returnType': 'Dict' },
                        'ClosedOrders': { 'cost': 3, 'returnType': 'Dict' },
                        'QueryOrders': { 'cost': 3, 'returnType': 'Dict' },
                        'OrderAmends': { 'cost': 3, 'returnType': 'Dict' },
                        'TradesHistory': { 'cost': 6, 'returnType': 'Dict' },
                        'QueryTrades': { 'cost': 3, 'returnType': 'Dict' },
                        'OpenPositions': { 'cost': 3, 'returnType': 'Dict' },
                        'Ledgers': { 'cost': 6, 'returnType': 'Dict' },
                        'QueryLedgers': { 'cost': 3, 'returnType': 'Dict' },
                        'TradeVolume': { 'cost': 3, 'returnType': 'Dict' },
                        'AddExport': { 'cost': 3, 'returnType': 'Dict' },
                        'ExportStatus': { 'cost': 3, 'returnType': 'Dict' },
                        'RetrieveExport': { 'cost': 3, 'returnType': 'Dict' },
                        'RemoveExport': { 'cost': 3, 'returnType': 'Dict' },
                        'GetApiKeyInfo': { 'cost': 3, 'returnType': 'Dict' },
                        // trading
                        'AddOrder': { 'cost': 0, 'returnType': 'Dict' },
                        'AmendOrder': { 'cost': 0, 'returnType': 'Dict' },
                        'CancelOrder': { 'cost': 0, 'returnType': 'Dict' },
                        'CancelAll': { 'cost': 3, 'returnType': 'Dict' },
                        'CancelAllOrdersAfter': { 'cost': 3, 'returnType': 'Dict' },
                        'GetWebSocketsToken': { 'cost': 3, 'returnType': 'Dict' },
                        'AddOrderBatch': { 'cost': 0, 'returnType': 'Dict' },
                        'CancelOrderBatch': { 'cost': 0, 'returnType': 'Dict' },
                        'EditOrder': { 'cost': 0, 'returnType': 'Dict' },
                        // funding
                        'DepositMethods': { 'cost': 3, 'returnType': 'Dict' },
                        'DepositAddresses': { 'cost': 3, 'returnType': 'Dict' },
                        'DepositStatus': { 'cost': 3, 'returnType': 'Dict' },
                        'WithdrawMethods': { 'cost': 3, 'returnType': 'Dict' },
                        'WithdrawAddresses': { 'cost': 3, 'returnType': 'Dict' },
                        'WithdrawInfo': { 'cost': 3, 'returnType': 'Dict' },
                        'Withdraw': { 'cost': 3, 'returnType': 'Dict' },
                        'WithdrawStatus': { 'cost': 3, 'returnType': 'Dict' },
                        'WithdrawCancel': { 'cost': 3, 'returnType': 'Dict' },
                        'WalletTransfer': { 'cost': 3, 'returnType': 'Dict' },
                        // sub accounts
                        'CreateSubaccount': { 'cost': 3, 'returnType': 'Dict' },
                        'AccountTransfer': { 'cost': 3, 'returnType': 'Dict' },
                        // earn
                        'Earn/Allocate': { 'cost': 3, 'returnType': 'Dict' },
                        'Earn/Deallocate': { 'cost': 3, 'returnType': 'Dict' },
                        'Earn/AllocateStatus': { 'cost': 3, 'returnType': 'Dict' },
                        'Earn/DeallocateStatus': { 'cost': 3, 'returnType': 'Dict' },
                        'Earn/Strategies': { 'cost': 3, 'returnType': 'Dict' },
                        'Earn/Allocations': { 'cost': 3, 'returnType': 'Dict' },
                    },
                },
            },
            'commonCurrencies': {
