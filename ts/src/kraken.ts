...
;
import type { IndexType, Int, OrderSide, OrderType, OHLCV, Trade, Order, Balances, Str, Dict, Transaction, Ticker, OrderBook, Tickers, Strings, Currency, CurrencyInterface, Market, TransferEntry, Num, Bool, TradingFeeInterface, Currencies, int, LedgerEntry, List, DepositAddress, Position, OrderRequest, NullableDict, FeeString, NullableList, Status, EndpointSpec } from './base/types.js';
...
export default class kraken extends Exchange {
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'zendesk': {
                    'get': {
                        '360000292886': { 'cost': 1 } as EndpointSpec<Dict>,
                        '201893608': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'public': {
                    'get': {
                        ...
                        'SystemStatus': { 'cost': 1 } as EndpointSpec<Dict>,
                        'Assets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'AssetPairs': { 'cost': 1 } as EndpointSpec<Dict>,
                        'Ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'OHLC': { 'cost': 1.2 } as EndpointSpec<Dict>, // 1.2 because 1 triggers too many requests immediately
                        'Depth': { 'cost': 1.2 } as EndpointSpec<Dict>,
                        'GroupedBook': { 'cost': 1.2 } as EndpointSpec<Dict>,
                        'Trades': { 'cost': 1.2 } as EndpointSpec<Dict>,
                        'Spread': { 'cost': 1 } as EndpointSpec<Dict>,
                        'PreTrade': { 'cost': 1 } as EndpointSpec<Dict>,
                        'PostTrade': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'post': {
                        'Level3': { 'cost': 1.2 } as EndpointSpec<Dict>,
                        // account
                        'Balance': { 'cost': 3 } as EndpointSpec<Dict>,
                        'BalanceEx': { 'cost': 3 } as EndpointSpec<Dict>,
                        'CreditLines': { 'cost': 3 } as EndpointSpec<Dict>,
                        'TradeBalance': { 'cost': 3 } as EndpointSpec<Dict>,
                        'OpenOrders': { 'cost': 3 } as EndpointSpec<Dict>,
                        'ClosedOrders': { 'cost': 3 } as EndpointSpec<Dict>,
                        'QueryOrders': { 'cost': 3 } as EndpointSpec<Dict>,
                        'OrderAmends': { 'cost': 3 } as EndpointSpec<Dict>,
                        'TradesHistory': { 'cost': 6 } as EndpointSpec<Dict>,
                        'QueryTrades': { 'cost': 3 } as EndpointSpec<Dict>,
                        'OpenPositions': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Ledgers': { 'cost': 6 } as EndpointSpec<Dict>,
                        'QueryLedgers': { 'cost': 3 } as EndpointSpec<Dict>,
                        'TradeVolume': { 'cost': 3 } as EndpointSpec<Dict>,
                        'AddExport': { 'cost': 3 } as EndpointSpec<Dict>,
                        'ExportStatus': { 'cost': 3 } as EndpointSpec<Dict>,
                        'RetrieveExport': { 'cost': 3 } as EndpointSpec<Dict>,
                        'RemoveExport': { 'cost': 3 } as EndpointSpec<Dict>,
                        'GetApiKeyInfo': { 'cost': 3 } as EndpointSpec<Dict>,
                        // trading
                        'AddOrder': { 'cost': 0 } as EndpointSpec<Dict>,
                        'AmendOrder': { 'cost': 0 } as EndpointSpec<Dict>,
                        'CancelOrder': { 'cost': 0 } as EndpointSpec<Dict>,
                        'CancelAll': { 'cost': 3 } as EndpointSpec<Dict>,
                        'CancelAllOrdersAfter': { 'cost': 3 } as EndpointSpec<Dict>,
                        'GetWebSocketsToken': { 'cost': 3 } as EndpointSpec<Dict>,
                        'AddOrderBatch': { 'cost': 0 } as EndpointSpec<Dict>,
                        'CancelOrderBatch': { 'cost': 0 } as EndpointSpec<Dict>,
                        'EditOrder': { 'cost': 0 } as EndpointSpec<Dict>,
                        // funding
                        'DepositMethods': { 'cost': 3 } as EndpointSpec<Dict>,
                        'DepositAddresses': { 'cost': 3 } as EndpointSpec<Dict>,
                        'DepositStatus': { 'cost': 3 } as EndpointSpec<Dict>,
                        'WithdrawMethods': { 'cost': 3 } as EndpointSpec<Dict>,
                        'WithdrawAddresses': { 'cost': 3 } as EndpointSpec<Dict>,
                        'WithdrawInfo': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Withdraw': { 'cost': 3 } as EndpointSpec<Dict>,
                        'WithdrawStatus': { 'cost': 3 } as EndpointSpec<Dict>,
                        'WithdrawCancel': { 'cost': 3 } as EndpointSpec<Dict>,
                        'WalletTransfer': { 'cost': 3 } as EndpointSpec<Dict>,
                        // sub accounts
                        'CreateSubaccount': { 'cost': 3 } as EndpointSpec<Dict>,
                        'AccountTransfer': { 'cost': 3 } as EndpointSpec<Dict>,
                        // earn
                        'Earn/Allocate': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Earn/Deallocate': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Earn/AllocateStatus': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Earn/DeallocateStatus': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Earn/Strategies': { 'cost': 3 } as EndpointSpec<Dict>,
                        'Earn/Allocations': { 'cost': 3 } as EndpointSpec<Dict>,
                    },
                },
            },
            'commonCurrencies': {
    ...
    override safeCurrencyCode (currencyId: Str, currency: Currency = undefined): Str {
