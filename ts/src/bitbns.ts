            ...
            'api': {
                'www': {
                    'get': {
                        ...
                        'order/getTickerWithVolume': 1,
                        'exchangeData/ohlc': 1,
                        'exchangeData/orderBook': 1,
                ...
                'v1': {
                    'get': {
                        ...
                        'tickers': 1,
                        'orderbook/sell/{symbol}': 1,
                        'orderbook/buy/{symbol}': 1,
                    },
                    'post': {
                        'currentCoinBalance/EVERYTHING': { 'cost': 1, 'returnType': 'Dict' },
                        'getApiUsageStatus/USAGE': 1,
                        'getOrderSocketToken/USAGE': 1,
                        'currentCoinBalance/{symbol}': 1,
                        ...
                        'withdrawHistoryAll/{symbol}': 1,
                        'depositHistoryAll/{symbol}': 1,
                        'listOpenOrders/{symbol}': 1,
                        'listOpenStopOrders/{symbol}': 1,
                        'getCoinAddress/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'placeSellOrder/{symbol}': 1,
                        'placeBuyOrder/{symbol}': 1,
                        'buyStopLoss/{symbol}': 1,
                        'sellStopLoss/{symbol}': 1,
                        'cancelOrder/{symbol}': 1,
                        'cancelStopLossOrder/{symbol}': 1,
                        'listExecutedOrders/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'placeMarketOrder/{symbol}': 1,
                        'placeMarketOrderQnty/{symbol}': 1,
                    },
                },
                'v2': {
                    'post': {
