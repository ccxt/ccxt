...
import type { Balances, Currency, Dict, NullableDict, Int, List, Market, Num, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, int, DepositAddress, Fee, FeeString, Status, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'www': {
                    'get': {
                        'order/fetchMarkets': { 'cost': 1 } as EndpointSpec<List>,
                        'order/fetchTickers': { 'cost': 1 } as EndpointSpec<List>,
                        'order/fetchOrderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'order/getTickerWithVolume': { 'cost': 1 } as EndpointSpec<Dict>,
                        'exchangeData/ohlc': { 'cost': 1 } as EndpointSpec<List>,
                        'exchangeData/orderBook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'exchangeData/tradedetails': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'v1': {
                    'get': {
                        ...
                        'orderbook/sell/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbook/buy/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'currentCoinBalance/EVERYTHING': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getApiUsageStatus/USAGE': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getOrderSocketToken/USAGE': { 'cost': 1 } as EndpointSpec<Dict>,
                        'currentCoinBalance/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderStatus/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'depositHistory/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawHistory/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawHistoryAll/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'depositHistoryAll/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'listOpenOrders/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'listOpenStopOrders/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'getCoinAddress/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'placeSellOrder/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'placeBuyOrder/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'buyStopLoss/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sellStopLoss/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelOrder/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelStopLossOrder/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'listExecutedOrders/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'placeMarketOrder/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'placeMarketOrderQnty/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'v2': {
                    'post': {
                        ...
                        'getordersnew': { 'cost': 1 } as EndpointSpec<Dict>,
                        'marginOrders': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
