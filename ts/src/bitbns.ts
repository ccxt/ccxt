    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'www': {
                    'get': {
                        'order/fetchMarkets': { 'cost': 1, 'returnType': 'List' },
                        'order/fetchTickers': { 'cost': 1, 'returnType': 'List' },
                        'order/fetchOrderbook': { 'cost': 1, 'returnType': 'Dict' },
                        'order/getTickerWithVolume': { 'cost': 1, 'returnType': 'Dict' },
                        'exchangeData/ohlc': { 'cost': 1, 'returnType': 'List' },
                        'exchangeData/orderBook': { 'cost': 1, 'returnType': 'Dict' },
                        'exchangeData/tradedetails': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'v1': {
                    'get': {
                        ...
                        'orderbook/sell/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbook/buy/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'currentCoinBalance/EVERYTHING': { 'cost': 1, 'returnType': 'Dict' },
                        'getApiUsageStatus/USAGE': { 'cost': 1, 'returnType': 'Dict' },
                        'getOrderSocketToken/USAGE': { 'cost': 1, 'returnType': 'Dict' },
                        'currentCoinBalance/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'orderStatus/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'depositHistory/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawHistory/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawHistoryAll/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'depositHistoryAll/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'listOpenOrders/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'listOpenStopOrders/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'getCoinAddress/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'placeSellOrder/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'placeBuyOrder/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'buyStopLoss/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'sellStopLoss/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelOrder/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'cancelStopLossOrder/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'listExecutedOrders/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'placeMarketOrder/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'placeMarketOrderQnty/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'v2': {
                    'post': {
                        ...
                        'getordersnew': { 'cost': 1, 'returnType': 'Dict' },
                        'marginOrders': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
