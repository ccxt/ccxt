...
export default class bibox extends Exchange {
    ...
    async fetchTickers (symbols = undefined, params = {}) {
        ...
        const request = {};
        const response = await (this as any).v3PublicGetMdataMarketAll (this.extend (request, params));
        //
        //    {
        //        state: '0',
        //        result: [
    ...
    async fetchTrades (symbol, since = undefined, limit = undefined, params = {}) {
        ...
        const response = await (this as any).v4PublicGetMarketdataTrades (this.extend (request, params));
        //
        //    [
        //        {
        //          "i": "17122255",        // transaction id
    ...
    async fetchOrderBook (symbol, limit = undefined, params = {}) {
        ...
        const response = await (this as any).v4PublicGetMarketdataOrderBook (this.extend (request, params));
        //
        //    {
    ...
    async fetchLedger (code = undefined, since = undefined, limit = undefined, params = {}) {
        ...
        const response = await (this as any).v4PrivateGetUserdataLedger (this.extend (request, params));
        //
        //    [
        //        {
        //            "i": 1125899918063693495,     // entry id
    ...
    async cancelAllOrders (symbol = undefined, params = {}) {
        ...
        const response = await (this as any).v4PrivateDeleteUserdataOrders (this.extend (request, params));
        //
        // []
        //
    ...
    async cancelOrder (id, symbol = undefined, params = {}) {
        ...
        const response = await (this as any).v4PrivateDeleteUserdataOrder (this.extend (request, params));
        //
        //    {
    ...
    async fetchOrder (id, symbol = undefined, params = {}) {
        ...
        const response = await (this as any).v4PrivateGetUserdataOrder (this.extend (request, params));
        //
        //    {
    ...
    async fetchOrdersByStatus (status, symbol = undefined, since = undefined, limit = undefined, params = {}) {
        ...
        const response = await (this as any).v4PrivateGetUserdataOrders (this.extend (request, params));
        //
        //    [
        //        {
        //            "i": 14589419788970785,
    ...
    async fetchMyTrades (symbol = undefined, since = undefined, limit = undefined, params = {}) {
        ...
        const response = await (this as any).v4PrivateGetUserdataFills (this.extend (request, params));
        //
        //    [
        //        {
        //            "i": 452361213188,
