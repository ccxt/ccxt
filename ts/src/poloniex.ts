...
import type { TransferEntry, Int, Bool, Leverage, OrderSide, OrderType, OHLCV, Trade, OrderBook, Order, Balances, Str, MarginModification, Transaction, Ticker, Tickers, Market, Strings, Currency, CurrencyInterface, Num, Currencies, TradingFees, Dict, int, DepositAddress, Position, NullableDict, FeeString, List, DepositWithdrawFees, PositionModeInfo, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'markets': { 'cost': 20 } as EndpointSpec<List>,
                        'markets/{symbol}': { 'cost': 1 } as EndpointSpec<List>,
                        'currencies': { 'cost': 20 } as EndpointSpec<List>,
                        'currencies/{currency}': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v2/currencies': { 'cost': 20 } as EndpointSpec<List>,
                        'v2/currencies/{currency}': { 'cost': 20 } as EndpointSpec<Dict>,
                        'timestamp': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/price': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/{symbol}/price': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/markPrice': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/{symbol}/markPrice': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{symbol}/markPriceComponents': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{symbol}/orderBook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/{symbol}/candles': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/{symbol}/trades': { 'cost': 20 } as EndpointSpec<List>,
                        'markets/ticker24h': { 'cost': 20 } as EndpointSpec<List>,
                        'markets/{symbol}/ticker24h': { 'cost': 20 } as EndpointSpec<Dict>,
                        'markets/collateralInfo': { 'cost': 1 } as EndpointSpec<List>,
                        'markets/{currency}/collateralInfo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'markets/borrowRatesInfo': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'accounts': { 'cost': 4 } as EndpointSpec<Dict>,
                        'accounts/balances': { 'cost': 4 } as EndpointSpec<Dict>,
                        'accounts/{id}/balances': { 'cost': 4 } as EndpointSpec<List>,
                        'accounts/activity': { 'cost': 20 } as EndpointSpec<List>,
                        'accounts/transfer': { 'cost': 20 } as EndpointSpec<List>,
                        'accounts/transfer/{id}': { 'cost': 4 } as EndpointSpec<Dict>,
                        'feeinfo': { 'cost': 20 } as EndpointSpec<Dict>,
                        'accounts/interest/history': { 'cost': 1 } as EndpointSpec<List>,
                        'subaccounts': { 'cost': 4 } as EndpointSpec<Dict>,
                        'subaccounts/balances': { 'cost': 20 } as EndpointSpec<List>,
                        'subaccounts/{id}/balances': { 'cost': 4 } as EndpointSpec<List>,
                        'subaccounts/transfer': { 'cost': 20 } as EndpointSpec<List>,
                        'subaccounts/transfer/{id}': { 'cost': 4 } as EndpointSpec<Dict>,
                        'wallets/addresses': { 'cost': 20 } as EndpointSpec<Dict>,
                        'wallets/addresses/{currency}': { 'cost': 20 } as EndpointSpec<Dict>,
                        'wallets/activity': { 'cost': 20 } as EndpointSpec<Dict>,
                        'margin/accountMargin': { 'cost': 4 } as EndpointSpec<Dict>,
                        'margin/borrowStatus': { 'cost': 4 } as EndpointSpec<List>,
                        'margin/maxSize': { 'cost': 4 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 20 } as EndpointSpec<List>,
                        'orders/{id}': { 'cost': 4 } as EndpointSpec<List>,
                        'orders/killSwitchStatus': { 'cost': 4 } as EndpointSpec<Dict>,
                        'smartorders': { 'cost': 20 } as EndpointSpec<List>,
                        'smartorders/{id}': { 'cost': 4 } as EndpointSpec<List>,
                        'orders/history': { 'cost': 20 } as EndpointSpec<Dict>,
                        'smartorders/history': { 'cost': 20 } as EndpointSpec<List>,
                        'trades': { 'cost': 20 } as EndpointSpec<List>,
                        'orders/{id}/trades': { 'cost': 4 } as EndpointSpec<List>,
                    },
                    'post': {
                        'accounts/transfer': { 'cost': 4 } as EndpointSpec<Dict>,
                        'subaccounts/transfer': { 'cost': 20 } as EndpointSpec<Dict>,
                        'wallets/address': { 'cost': 20 } as EndpointSpec<Dict>,
                        'wallets/withdraw': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v2/wallets/withdraw': { 'cost': 20 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 4 } as EndpointSpec<Dict>,
                        'orders/batch': { 'cost': 20 } as EndpointSpec<Dict>,
                        'orders/killSwitch': { 'cost': 4 } as EndpointSpec<Dict>,
                        'smartorders': { 'cost': 4 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'orders/{id}': { 'cost': 4 } as EndpointSpec<Dict>,
                        'orders/cancelByIds': { 'cost': 20 } as EndpointSpec<List>,
                        'orders': { 'cost': 20 } as EndpointSpec<List>,
                        'smartorders/{id}': { 'cost': 4 } as EndpointSpec<Dict>,
                        'smartorders/cancelByIds': { 'cost': 20 } as EndpointSpec<List>,
                        'smartorders': { 'cost': 20 } as EndpointSpec<List>,
                    },
                    'put': {
                        'orders/{id}': { 'cost': 20 } as EndpointSpec<Dict>,
                        'smartorders/{id}': { 'cost': 20 } as EndpointSpec<Dict>,
                    },
                },
                'swapPublic': {
                    'get': {
                        // 300 calls / second
                        'v3/market/allInstruments': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/instruments': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/orderBook': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/candles': { 'cost': 10 } as EndpointSpec<Dict>, // candles have different RL
                        'v3/market/indexPriceCandlesticks': { 'cost': 10 } as EndpointSpec<Dict>,
                        'v3/market/premiumIndexCandlesticks': { 'cost': 10 } as EndpointSpec<Dict>,
                        'v3/market/markPriceCandlesticks': { 'cost': 10 } as EndpointSpec<Dict>,
                        'v3/market/trades': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/liquidationOrder': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/tickers': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/markPrice': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/indexPrice': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/indexPriceComponents': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/fundingRate': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/openInterest': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/insurance': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                        'v3/market/riskLimit': { 'cost': 2 / 3 } as EndpointSpec<Dict>,
                    },
                },
                'swapPrivate': {
                    'get': {
                        'v3/account/balance': { 'cost': 4 } as EndpointSpec<Dict>,
                        'v3/account/bills': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/order/opens': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/order/trades': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/order/history': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/position/opens': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/position/history': { 'cost': 20 } as EndpointSpec<Dict>, // todo: method for this
                        'v3/position/leverages': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/position/mode': { 'cost': 20 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'v3/trade/order': { 'cost': 4 } as EndpointSpec<Dict>,
                        'v3/trade/orders': { 'cost': 40 } as EndpointSpec<Dict>,
                        'v3/trade/position': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/positionAll': { 'cost': 100 } as EndpointSpec<Dict>,
                        'v3/position/leverage': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/position/mode': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/position/margin': { 'cost': 20 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'v3/trade/order': { 'cost': 2 } as EndpointSpec<Dict>,
                        'v3/trade/batchOrders': { 'cost': 20 } as EndpointSpec<Dict>,
                        'v3/trade/allOrders': { 'cost': 20 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
