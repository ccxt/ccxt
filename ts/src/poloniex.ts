...
import type { TransferEntry, Int, Bool, Leverage, OrderSide, OrderType, OHLCV, Trade, OrderBook, Order, Balances, Str, MarginModification, Transaction, Ticker, Tickers, Market, Strings, Currency, CurrencyInterface, Num, Currencies, TradingFees, Dict, int, DepositAddress, Position, NullableDict, FeeString, List, DepositWithdrawFees, PositionModeInfo } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'markets': { 'cost': 20, 'returnType': 'List' },
                        'markets/{symbol}': { 'cost': 1, 'returnType': 'List' },
                        'currencies': { 'cost': 20, 'returnType': 'List' },
                        'currencies/{currency}': { 'cost': 20, 'returnType': 'Dict' },
                        'v2/currencies': { 'cost': 20, 'returnType': 'List' },
                        'v2/currencies/{currency}': { 'cost': 20, 'returnType': 'Dict' },
                        'timestamp': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/price': { 'cost': 1, 'returnType': 'List' },
                        'markets/{symbol}/price': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/markPrice': { 'cost': 1, 'returnType': 'List' },
                        'markets/{symbol}/markPrice': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{symbol}/markPriceComponents': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{symbol}/orderBook': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/{symbol}/candles': { 'cost': 1, 'returnType': 'List' },
                        'markets/{symbol}/trades': { 'cost': 20, 'returnType': 'List' },
                        'markets/ticker24h': { 'cost': 20, 'returnType': 'List' },
                        'markets/{symbol}/ticker24h': { 'cost': 20, 'returnType': 'Dict' },
                        'markets/collateralInfo': { 'cost': 1, 'returnType': 'List' },
                        'markets/{currency}/collateralInfo': { 'cost': 1, 'returnType': 'Dict' },
                        'markets/borrowRatesInfo': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'private': {
                    'get': {
                        'accounts': { 'cost': 4, 'returnType': 'Dict' },
                        'accounts/balances': { 'cost': 4, 'returnType': 'Dict' },
                        'accounts/{id}/balances': { 'cost': 4, 'returnType': 'List' },
                        'accounts/activity': { 'cost': 20, 'returnType': 'List' },
                        'accounts/transfer': { 'cost': 20, 'returnType': 'List' },
                        'accounts/transfer/{id}': { 'cost': 4, 'returnType': 'Dict' },
                        'feeinfo': { 'cost': 20, 'returnType': 'Dict' },
                        'accounts/interest/history': { 'cost': 1, 'returnType': 'List' },
                        'subaccounts': { 'cost': 4, 'returnType': 'Dict' },
                        'subaccounts/balances': { 'cost': 20, 'returnType': 'List' },
                        'subaccounts/{id}/balances': { 'cost': 4, 'returnType': 'List' },
                        'subaccounts/transfer': { 'cost': 20, 'returnType': 'List' },
                        'subaccounts/transfer/{id}': { 'cost': 4, 'returnType': 'Dict' },
                        'wallets/addresses': { 'cost': 20, 'returnType': 'Dict' },
                        'wallets/addresses/{currency}': { 'cost': 20, 'returnType': 'Dict' },
                        'wallets/activity': { 'cost': 20, 'returnType': 'Dict' },
                        'margin/accountMargin': { 'cost': 4, 'returnType': 'Dict' },
                        'margin/borrowStatus': { 'cost': 4, 'returnType': 'List' },
                        'margin/maxSize': { 'cost': 4, 'returnType': 'Dict' },
                        'orders': { 'cost': 20, 'returnType': 'List' },
                        'orders/{id}': { 'cost': 4, 'returnType': 'List' },
                        'orders/killSwitchStatus': { 'cost': 4, 'returnType': 'Dict' },
                    ...
                    'post': {
                        'accounts/transfer': { 'cost': 4, 'returnType': 'Dict' },
                        'subaccounts/transfer': { 'cost': 20, 'returnType': 'Dict' },
                        'wallets/address': { 'cost': 20, 'returnType': 'Dict' },
                        'wallets/withdraw': { 'cost': 20, 'returnType': 'Dict' },
                        'v2/wallets/withdraw': { 'cost': 20, 'returnType': 'Dict' },
                        'orders': { 'cost': 4, 'returnType': 'Dict' },
                        'orders/batch': { 'cost': 20, 'returnType': 'Dict' },
                        'orders/killSwitch': { 'cost': 4, 'returnType': 'Dict' },
                        'smartorders': { 'cost': 4, 'returnType': 'Dict' },
                    },
                    'delete': {
                        'orders/{id}': { 'cost': 4, 'returnType': 'Dict' },
                        'orders/cancelByIds': { 'cost': 20, 'returnType': 'List' },
                        'orders': { 'cost': 20, 'returnType': 'List' },
                        'smartorders/{id}': { 'cost': 4, 'returnType': 'Dict' },
                        'smartorders/cancelByIds': { 'cost': 20, 'returnType': 'List' },
                        'smartorders': { 'cost': 20, 'returnType': 'List' },
                    },
                    'put': {
                        'orders/{id}': { 'cost': 20, 'returnType': 'Dict' },
                        'smartorders/{id}': { 'cost': 20, 'returnType': 'Dict' },
                    },
                },
                'swapPublic': {
                    'get': {
                        // 300 calls / second
                        'v3/market/allInstruments': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/instruments': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/orderBook': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/candles': { 'cost': 10, 'returnType': 'Dict' }, // candles have different RL
                        'v3/market/indexPriceCandlesticks': { 'cost': 10, 'returnType': 'Dict' },
                        'v3/market/premiumIndexCandlesticks': { 'cost': 10, 'returnType': 'Dict' },
                        'v3/market/markPriceCandlesticks': { 'cost': 10, 'returnType': 'Dict' },
                        'v3/market/trades': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/liquidationOrder': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/tickers': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/markPrice': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/indexPrice': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/indexPriceComponents': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/fundingRate': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/openInterest': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/insurance': { 'cost': 2 / 3, 'returnType': 'Dict' },
                        'v3/market/riskLimit': { 'cost': 2 / 3, 'returnType': 'Dict' },
                    },
                },
                'swapPrivate': {
                    'get': {
                        'v3/account/balance': { 'cost': 4, 'returnType': 'Dict' },
                        'v3/account/bills': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/order/opens': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/order/trades': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/order/history': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/position/opens': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/position/history': { 'cost': 20, 'returnType': 'Dict' }, // todo: method for this
                        'v3/position/leverages': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/position/mode': { 'cost': 20, 'returnType': 'Dict' },
                    },
                    'post': {
                        'v3/trade/order': { 'cost': 4, 'returnType': 'Dict' },
                        'v3/trade/orders': { 'cost': 40, 'returnType': 'Dict' },
                        'v3/trade/position': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/positionAll': { 'cost': 100, 'returnType': 'Dict' },
                        'v3/position/leverage': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/position/mode': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/position/margin': { 'cost': 20, 'returnType': 'Dict' },
                    },
                    'delete': {
                        'v3/trade/order': { 'cost': 2, 'returnType': 'Dict' },
                        'v3/trade/batchOrders': { 'cost': 20, 'returnType': 'Dict' },
                        'v3/trade/allOrders': { 'cost': 20, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
