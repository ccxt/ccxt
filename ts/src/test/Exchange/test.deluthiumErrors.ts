...
function testStringErrorCodeDetection(exchange: Exchange) {
...
function testNumericErrorCodeDetection(exchange: Exchange) {
...
function testSuccessCodeHandling(exchange: Exchange) {
...
function testDualFormatDistinction(exchange: Exchange) {
...
function testErrorExceptionMapping(exchange: Exchange) {
...
function testMixedResponseHandling(exchange: Exchange) {
    console.log('  Testing mixed response handling...');
    
    // Response with both potential formats (should pick one)
    const ambiguousResponse1 = {
        code: 'INVALID_INPUT',  // String takes precedence when checking string first
        message: 'Invalid',
    };
...
// Main Test Runner
// ============================================================================
async function testDeluthiumErrors(exchange: Exchange, skippedProperties: object = {}) {
    console.log('\n========================================');
...
export {
    STRING_ERROR_MAPPINGS,
    NUMERIC_ERROR_MAPPINGS,
    testStringErrorCodeDetection,
    testNumericErrorCodeDetection,
    testSuccessCodeHandling,
    testDualFormatDistinction,
};
