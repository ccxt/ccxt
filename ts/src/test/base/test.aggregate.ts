...
function testAggregate () {
    ...
    const result1 = exchange.aggregate ([ [ 100, 1.01 ], [ 101, 2.01 ], [ 100, 0.5 ] ]);
    testSharedMethods.assertDeepEqual (exchange, undefined, 'testAggregate', result1, [ [ 100, 1.51 ], [ 101, 2.01 ] ]);

    // Test 2: With extra fields (should be ignored)
    const result2 = exchange.aggregate ([ [ 100, 1.01, 'extra' ], [ 101, 2.01, 'data', 'more' ] ]);
    testSharedMethods.assertDeepEqual (exchange, undefined, 'testAggregate', result2, [ [ 100, 1.01 ], [ 101, 2.01 ] ]);

    // Test 3: Zero volumes should be skipped
    const result3 = exchange.aggregate ([ [ 100, 1.01 ], [ 101, 0 ], [ 102, 2.01 ] ]);
    testSharedMethods.assertDeepEqual (exchange, undefined, 'testAggregate', result3, [ [ 100, 1.01 ], [ 102, 2.01 ] ]);
    ...
    // Test 5: Single entry
    const result5 = exchange.aggregate ([ [ 100, 1.01 ] ]);
    ...
    const result10 = exchange.aggregate ([ [ 100, 1.04 ], [ 100, 0 ], [ 100, 2.04 ] ]);
    testSharedMethods.assertDeepEqual (exchange, undefined, 'testAggregate', result10, [ [ 100, 3.08 ] ]);
}
