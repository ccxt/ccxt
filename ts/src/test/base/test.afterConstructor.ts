...
function helperTestProperties () {
    ...
    const recentRequestsCache = testSharedMethods.exchangeProp (exchange, 'recentRequestsCache');
    assert (recentRequestsCache.length === 0, 'recentRequestsCache should be an empty array');
}
