...
function testBase64ToBinary () {
    ...
    assert (exchange.decode (binary1) === 'hello');
    ...
    assert (exchange.decode (binary7) === 'abc');
    ...
    assert (exchange.decode (binary8) === '{"key":"value"}');
    ...
    assert (exchange.decode (binary9) === '123456');
    ...
    assert (exchange.decode (binary10) === 'hello+world/test');
