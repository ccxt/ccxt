import Exchange from './abstract/mandala.js';
 ...
 * @augments Exchange
 */
export default class mandala extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                'logo': 'https://api.trade.mandala.exchange/images/logo.png',
                'api': {
                    'public': 'https://api.trade.mandala.exchange/api/3',
                    'private': 'https://api.trade.mandala.exchange/api/3',
                },
                'www': 'https://mandala.exchange/',
                'doc': [
                    'https://api.trade.mandala.exchange/',
                    'https://api.trade.mandala.exchange/api/3/explore/',
                ],
                'fees': [
                    'https://trade.mandala.exchange/trading-fees',
                ],
            },
            'api': {
                'public': {
            ...
            'options': {
                ...
                'defaultNetworks': {
                    'BTC': 'BTC',
                    'ETH': 'ETH',
                    'USDT': 'TRC20', // TRC20 typically has lower fees
                    'ADA': 'ADA',
                    'ARDR': 'ARDR',
                    'AVAX': 'AVAX',
                    'BCH': 'BCH',
    ...
    /**
     * @method
     * @name mandala#fetchMarkets
     * @description retrieves data on all markets for mandala
     * @see https://api.trade.mandala.exchange/#symbols
    ...
    /**
     * @method
     * @name mandala#fetchCurrencies
     * @description fetches all available currencies on an exchange
     * @see https://api.trade.mandala.exchange/#currencies
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name mandala#createDepositAddress
     * @description create a currency deposit address
     * @see https://api.trade.mandala.exchange/#generate-deposit-crypto-address
    ...
    /**
     * @method
     * @name mandala#fetchDepositAddress
     * @description fetch the deposit address for a currency associated with this account
     * @see https://api.trade.mandala.exchange/#get-deposit-crypto-address
    ...
    /**
     * @method
     * @name mandala#fetchBalance
     * @description query for balance and get the amount of funds available for trading or funds locked in orders
     * @see https://api.trade.mandala.exchange/#wallet-balance
     * @see https://api.trade.mandala.exchange/#get-spot-trading-balance
     * @see https://api.trade.mandala.exchange/#get-trading-balance
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name mandala#fetchTicker
     * @description fetches a price ticker, a statistical calculation with the information calculated over the past 24 hours for a specific market
     * @see https://api.trade.mandala.exchange/#tickers
    ...
    /**
     * @method
     * @name mandala#fetchTrades
     * @description get the list of most recent trades for a particular symbol
     * @see https://api.trade.mandala.exchange/#trades
    ...
    /**
     * @method
     * @name mandala#fetchMyTrades
     * @description fetch all trades made by the user
     * @see https://api.trade.mandala.exchange/#spot-trades-history
     * @see https://api.trade.mandala.exchange/#futures-trades-history
     * @see https://api.trade.mandala.exchange/#margin-trades-history
    ...
    parseTransaction (transaction: Dict, currency: Currency = undefined): Transaction {
        ...
        // https://api.trade.mandala.exchange/#check-if-offchain-is-available
        const fee = {
            'currency': undefined,
            'cost': undefined,
            'rate': undefined,
    ...
    /**
     * @method
     * @name mandala#fetchDepositsWithdrawals
     * @description fetch history of deposits and withdrawals
     * @see https://api.trade.mandala.exchange/#get-transactions-history
    ...
    /**
     * @method
     * @name mandala#fetchOrderBooks
     * @description fetches information on open orders with bid (buy) and ask (sell) prices, volumes and other data for multiple markets
     * @see https://api.trade.mandala.exchange/#order-books
    ...
    /**
     * @method
     * @name mandala#fetchTradingFee
     * @description fetch the trading fees for a market
     * @see https://api.trade.mandala.exchange/#get-trading-commission
     * @see https://api.trade.mandala.exchange/#get-trading-commission-2
     * @param {string} symbol unified market symbol
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name mandala#fetchTradingFees
     * @description fetch the trading fees for multiple markets
     * @see https://api.trade.mandala.exchange/#get-all-trading-commissions
     * @see https://api.trade.mandala.exchange/#get-all-trading-commissions-2
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name mandala#fetchOHLCV
     * @description fetches historical candlestick data containing the open, high, low, and close price, and the volume of a market
     * @see https://api.trade.mandala.exchange/#candles
     * @see https://api.trade.mandala.exchange/#futures-index-price-candles
     * @see https://api.trade.mandala.exchange/#futures-mark-price-candles
     * @see https://api.trade.mandala.exchange/#futures-premium-index-candles
    ...
    /**
     * @method
     * @name mandala#fetchClosedOrders
     * @description fetches information on multiple closed orders made by the user
     * @see https://api.trade.mandala.exchange/#spot-orders-history
     * @see https://api.trade.mandala.exchange/#futures-orders-history
     * @see https://api.trade.mandala.exchange/#margin-orders-history
    ...
    /**
     * @method
     * @name mandala#fetchOpenOrders
     * @description fetch all unfilled currently open orders
     * @see https://api.trade.mandala.exchange/#get-all-active-spot-orders
     * @see https://api.trade.mandala.exchange/#get-active-futures-orders
     * @see https://api.trade.mandala.exchange/#get-active-margin-orders
     * @param {string} symbol unified market symbol
    ...
    /**
     * @method
     * @name mandala#fetchOpenOrder
     * @description fetch an open order by it's id
     * @see https://api.trade.mandala.exchange/#get-active-spot-order
     * @see https://api.trade.mandala.exchange/#get-active-futures-order
     * @see https://api.trade.mandala.exchange/#get-active-margin-order
     * @param {string} id order id
    ...
    /**
     * @method
     * @name mandala#cancelAllOrders
     * @description cancel all open orders
     * @see https://api.trade.mandala.exchange/#cancel-all-spot-orders
     * @see https://api.trade.mandala.exchange/#cancel-futures-orders
     * @see https://api.trade.mandala.exchange/#cancel-all-margin-orders
    ...
    /**
     * @method
     * @name mandala#cancelOrder
     * @description cancels an open order
     * @see https://api.trade.mandala.exchange/#cancel-spot-order
     * @see https://api.trade.mandala.exchange/#cancel-futures-order
     * @see https://api.trade.mandala.exchange/#cancel-margin-order
     * @param {string} id order id
     * @param {string} symbol unified symbol of the market the order was made in
     * @param {object} [params] extra parameters specific to the exchange API endpoint
     * @param {string} [params.marginMode] 'cross' or 'isolated' only 'isolated' is supported
    ...
    /**
     * @method
     * @name mandala#createOrder
     * @description create a trade order
     * @see https://api.trade.mandala.exchange/#create-new-spot-order
     * @see https://api.trade.mandala.exchange/#create-margin-order
     * @see https://api.trade.mandala.exchange/#create-futures-order
    ...
    /**
     * @method
     * @name mandala#fetchMarginModes
     * @description fetches margin mode of the user
     * @see https://api.trade.mandala.exchange/#get-margin-position-parameters
     * @see https://api.trade.mandala.exchange/#get-futures-position-parameters
    ...
    /**
     * @method
     * @name mandala#transfer
     * @description transfer currency internally between wallets on the same account
     * @see https://api.trade.mandala.exchange/#transfer-between-wallet-and-exchange
     * @param {string} code unified currency code
    ...
    /**
     * @method
     * @name mandala#withdraw
     * @description make a withdrawal
     * @see https://api.trade.mandala.exchange/#withdraw-crypto
     * @param {string} code unified currency code
    ...
    /**
     * @method
     * @name mandala#fetchFundingRates
     * @description fetches funding rates for multiple markets
     * @see https://api.trade.mandala.exchange/#futures-info
    ...
    /**
     * @method
     * @name mandala#fetchFundingRateHistory
     * @see https://api.trade.mandala.exchange/#funding-history
    ...
    /**
     * @method
     * @name mandala#fetchPositions
     * @description fetch all open positions
     * @see https://api.trade.mandala.exchange/#get-futures-margin-accounts
     * @see https://api.trade.mandala.exchange/#get-all-margin-accounts
     * @param {string[]|undefined} symbols not used by mandala fetchPositions ()
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name mandala#fetchPosition
     * @description fetch data on a single open contract trade position
     * @see https://api.trade.mandala.exchange/#get-futures-margin-account
     * @see https://api.trade.mandala.exchange/#get-isolated-margin-account
    ...
    /**
     * @method
     * @name mandala#fetchOpenInterests
    ...
    /**
     * @method
     * @name mandala#fetchOpenInterest
    ...
    /**
     * @method
     * @name mandala#reduceMargin
     * @description remove margin from a position
     * @see https://api.trade.mandala.exchange/#create-update-margin-account-2
     * @see https://api.trade.mandala.exchange/#create-update-margin-account
     * @param {string} symbol unified market symbol
    ...
    async reduceMargin (symbol: string, amount: number, params = {}): Promise<MarginModification> {
        if (this.numberToString (amount) !== '0') {
            throw new BadRequest (this.id + ' reduceMargin() on mandala requires the amount to be 0 and that will remove the entire margin amount');
        }
    ...
    /**
     * @method
     * @name mandala#fetchDepositWithdrawFees
    ...
    /**
     * @method
     * @name mandala#closePosition
     * @description closes open positions for a market
     * @see https://api.trade.mandala.exchange/#close-all-futures-margin-positions
     * @param {string} symbol unified ccxt market symbol
     * @param {string} side 'buy' or 'sell'
