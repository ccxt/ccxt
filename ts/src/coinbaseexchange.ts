            ...
            'api': {
                ...
                'private': {
                    'get': {
                        ...
                        'margin/profile_information': 1,
                        'margin/buying_power': 1,
                        'margin/withdrawal_power': 1,
                        'margin/withdrawal_power_all': 1,
                        'margin/exit_plan': 1,
                        'margin/liquidation_history': 1,
                        'margin/position_refresh_amounts': 1,
                        'margin/status': 1,
