            ...
            'api': {
                ...
                'private': {
                    'get': {
                        ...
                        'transfers/{transfer_id}': 1,
                        'users/self/exchange-limits': 1,
                        'users/self/hold-balances': 1,
                        'users/self/trailing-volume': 1,
                        'withdrawals/fee-estimate': 1,
                        'conversions/{conversion_id}': 1,
                        'conversions': 1,
                        'conversions/fees': 1,
                        'loans/lending-overview': 1,
                        'loans/lending-overview-xm': 1,
                        'loans/loan-preview': 1,
                        'loans/loan-preview-xm': 1,
                        'loans/repayment-preview': 1,
                        'loans/repayment-preview-xm': 1,
                        'loans/interest/{loan_id}': 1,
                        'loans/interest/history/{loan_id}': 1,
                        'loans/interest': 1,
                        'loans/assets': 1,
                        'loans': 1,
                    },
                    'post': {
                        'conversions': 1,
                        'deposits/coinbase-account': 1,
                        'deposits/payment-method': 1,
                        ...
                        'withdrawals/coinbase-account': 1,
                        'withdrawals/crypto': 1,
                        'withdrawals/payment-method': 1,
                        'loans/open': 1,
                        'loans/repay-interest': 1,
                        'loans/repay-principal': 1,
                    },
                    'delete': {
                        'orders': 1,
                        'orders/client:{client_oid}': 1,
