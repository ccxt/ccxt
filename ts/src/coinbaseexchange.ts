            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'products': { 'cost': 1, 'returnType': 'List' },
                        'products/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{id}/book': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{id}/candles': { 'cost': 1, 'returnType': 'List' },
                        'products/{id}/stats': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{id}/ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'products/{id}/trades': { 'cost': 1, 'returnType': 'List' },
                        'time': { 'cost': 1, 'returnType': 'Dict' },
                        'products/spark-lines': { 'cost': 1, 'returnType': 'Dict' },
                        'products/volume-summary': { 'cost': 1, 'returnType': 'List' },
                    },
                },
                'private': {
                    'get': {
                        'address-book': { 'cost': 1, 'returnType': 'List' },
                        'accounts': { 'cost': 1, 'returnType': 'Dict' },
                        'accounts/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'accounts/{id}/holds': { 'cost': 1, 'returnType': 'List' },
                        'accounts/{id}/ledger': { 'cost': 1, 'returnType': 'List' },
                        'accounts/{id}/transfers': { 'cost': 1, 'returnType': 'List' },
                        'coinbase-accounts': { 'cost': 1, 'returnType': 'List' },
                        'fills': { 'cost': 1, 'returnType': 'List' },
                        'funding': { 'cost': 1, 'returnType': 'Dict' },
                        'fees': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/profile_information': { 'cost': 1, 'returnType': 'List' },
                        'margin/buying_power': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/withdrawal_power': { 'cost': 1, 'returnType': 'List' },
                        'margin/withdrawal_power_all': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/exit_plan': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/liquidation_history': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/position_refresh_amounts': { 'cost': 1, 'returnType': 'Dict' },
                        'margin/status': { 'cost': 1, 'returnType': 'Dict' },
                        'oracle': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 1, 'returnType': 'List' },
                        'orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/client:{client_oid}': { 'cost': 1, 'returnType': 'Dict' },
                        'otc/orders': { 'cost': 1, 'returnType': 'List' },
                        'payment-methods': { 'cost': 1, 'returnType': 'List' },
                        'position': { 'cost': 1, 'returnType': 'List' },
                        'profiles': { 'cost': 1, 'returnType': 'List' },
                        'profiles/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'reports/{report_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'transfers': { 'cost': 1, 'returnType': 'List' },
                        'transfers/{transfer_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'users/self/exchange-limits': { 'cost': 1, 'returnType': 'Dict' },
                        'users/self/hold-balances': { 'cost': 1, 'returnType': 'Dict' },
                        'users/self/trailing-volume': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/fee-estimate': { 'cost': 1, 'returnType': 'Dict' },
                        'conversions/{conversion_id}': { 'cost': 1, 'returnType': 'Dict' },
                        'conversions': { 'cost': 1, 'returnType': 'List' },
                        'conversions/fees': { 'cost': 1, 'returnType': 'List' },
                        'loans/lending-overview': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/lending-overview-xm': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/loan-preview': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/loan-preview-xm': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/repayment-preview': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/repayment-preview-xm': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/interest/{loan_id}': { 'cost': 1, 'returnType': 'List' },
                        'loans/interest/history/{loan_id}': { 'cost': 1, 'returnType': 'List' },
                        'loans/interest': { 'cost': 1, 'returnType': 'List' },
                        'loans/assets': { 'cost': 1, 'returnType': 'Dict' },
                        'loans': { 'cost': 1, 'returnType': 'List' },
                    },
                    'post': {
                        'conversions': { 'cost': 1, 'returnType': 'Dict' },
                        'deposits/coinbase-account': { 'cost': 1, 'returnType': 'Dict' },
                        'deposits/payment-method': { 'cost': 1, 'returnType': 'Dict' },
                        'coinbase-accounts/{id}/addresses': { 'cost': 1, 'returnType': 'Dict' },
                        'funding/repay': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 1, 'returnType': 'Dict' },
                        'position/close': { 'cost': 1, 'returnType': 'Dict' },
                        'profiles': { 'cost': 1, 'returnType': 'Dict' },
                        'profiles/margin-transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'profiles/transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'reports': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/coinbase': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/coinbase-account': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/crypto': { 'cost': 1, 'returnType': 'Dict' },
                        'withdrawals/payment-method': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/open': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/repay-interest': { 'cost': 1, 'returnType': 'Dict' },
                        'loans/repay-principal': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'delete': {
                        'orders': { 'cost': 1, 'returnType': 'List' },
                        'orders/client:{client_oid}': { 'cost': 1, 'returnType': 'string' },
                        'orders/{id}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'put': {
                        'profiles/{id}/deactivate': { 'cost': 1, 'returnType': 'Dict' },
                        'profiles/{id}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
