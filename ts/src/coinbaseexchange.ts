...
import type { Int, OrderSide, OrderType, Trade, OHLCV, Order, Balances, Str, Transaction, Ticker, OrderBook, Tickers, Strings, Market, Currency, CurrencyInterface, Num, Account, Currencies, TradingFees, Dict, Fee, int, List, LedgerEntry, DepositAddress, NullableDict, EndpointSpec } from './base/types.js';
            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'products': { 'cost': 1 } as EndpointSpec<List>,
                        'products/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{id}/book': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{id}/candles': { 'cost': 1 } as EndpointSpec<List>,
                        'products/{id}/stats': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{id}/ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/{id}/trades': { 'cost': 1 } as EndpointSpec<List>,
                        'time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/spark-lines': { 'cost': 1 } as EndpointSpec<Dict>,
                        'products/volume-summary': { 'cost': 1 } as EndpointSpec<List>,
                    },
                },
                'private': {
                    'get': {
                        'address-book': { 'cost': 1 } as EndpointSpec<List>,
                        'accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'accounts/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'accounts/{id}/holds': { 'cost': 1 } as EndpointSpec<List>,
                        'accounts/{id}/ledger': { 'cost': 1 } as EndpointSpec<List>,
                        'accounts/{id}/transfers': { 'cost': 1 } as EndpointSpec<List>,
                        'coinbase-accounts': { 'cost': 1 } as EndpointSpec<List>,
                        'fills': { 'cost': 1 } as EndpointSpec<List>,
                        'funding': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fees': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/profile_information': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/buying_power': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/withdrawal_power': { 'cost': 1 } as EndpointSpec<List>,
                        'margin/withdrawal_power_all': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/exit_plan': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/liquidation_history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/position_refresh_amounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'margin/status': { 'cost': 1 } as EndpointSpec<Dict>,
                        'oracle': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<List>,
                        'orders/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/client:{client_oid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'otc/orders': { 'cost': 1 } as EndpointSpec<List>,
                        'payment-methods': { 'cost': 1 } as EndpointSpec<List>,
                        'position': { 'cost': 1 } as EndpointSpec<List>,
                        'profiles': { 'cost': 1 } as EndpointSpec<List>,
                        'profiles/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'reports/{report_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers': { 'cost': 1 } as EndpointSpec<List>,
                        'transfers/{transfer_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/self/exchange-limits': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/self/hold-balances': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/self/trailing-volume': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/fee-estimate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'conversions/{conversion_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'conversions': { 'cost': 1 } as EndpointSpec<List>,
                        'conversions/fees': { 'cost': 1 } as EndpointSpec<List>,
                        'loans/lending-overview': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/lending-overview-xm': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/loan-preview': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/loan-preview-xm': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/repayment-preview': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/repayment-preview-xm': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/interest/{loan_id}': { 'cost': 1 } as EndpointSpec<List>,
                        'loans/interest/history/{loan_id}': { 'cost': 1 } as EndpointSpec<List>,
                        'loans/interest': { 'cost': 1 } as EndpointSpec<List>,
                        'loans/assets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans': { 'cost': 1 } as EndpointSpec<List>,
                    },
                    'post': {
                        'conversions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deposits/coinbase-account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'deposits/payment-method': { 'cost': 1 } as EndpointSpec<Dict>,
                        'coinbase-accounts/{id}/addresses': { 'cost': 1 } as EndpointSpec<Dict>,
                        'funding/repay': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'position/close': { 'cost': 1 } as EndpointSpec<Dict>,
                        'profiles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'profiles/margin-transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'profiles/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'reports': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/coinbase': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/coinbase-account': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/crypto': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawals/payment-method': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/open': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/repay-interest': { 'cost': 1 } as EndpointSpec<Dict>,
                        'loans/repay-principal': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'orders': { 'cost': 1 } as EndpointSpec<List>,
                        'orders/client:{client_oid}': { 'cost': 1 } as EndpointSpec<string>,
                        'orders/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'profiles/{id}/deactivate': { 'cost': 1 } as EndpointSpec<Dict>,
                        'profiles/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
