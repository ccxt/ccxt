    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'indexer': {
                    'get': {
                        'addresses/{address}': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses/{address}/parentSubaccountNumber/{number}': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses/{address}/subaccountNumber/{subaccountNumber}': { 'cost': 1, 'returnType': 'Dict' },
                        'assetPositions': { 'cost': 1, 'returnType': 'Dict' },
                        'assetPositions/parentSubaccountNumber': { 'cost': 1, 'returnType': 'Dict' },
                        'candles/perpetualMarkets/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'compliance/screen/{address}': { 'cost': 1, 'returnType': 'Dict' },
                        'fills': { 'cost': 1, 'returnType': 'Dict' },
                        'fills/parentSubaccountNumber': { 'cost': 1, 'returnType': 'Dict' },
                        'fundingPayments': { 'cost': 1, 'returnType': 'Dict' },
                        'fundingPayments/parentSubaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'height': { 'cost': 0.1, 'returnType': 'Dict' },
                        'historical-pnl': { 'cost': 1, 'returnType': 'Dict' },
                        'historical-pnl/parentSubaccountNumber': { 'cost': 1, 'returnType': 'Dict' },
                        'historicalBlockTradingRewards/{address}': { 'cost': 1, 'returnType': 'Dict' },
                        'historicalFunding/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'historicalTradingRewardAggregations/{address}': { 'cost': 1, 'returnType': 'Dict' },
                        'orderbooks/perpetualMarket/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'orders': { 'cost': 1, 'returnType': 'List' },
                        'orders/parentSubaccountNumber': { 'cost': 1, 'returnType': 'Dict' },
                        'orders/{orderId}': { 'cost': 1, 'returnType': 'Dict' },
                        'perpetualMarkets': { 'cost': 1, 'returnType': 'Dict' },
                        'perpetualPositions': { 'cost': 1, 'returnType': 'Dict' },
                        'perpetualPositions/parentSubaccountNumber': { 'cost': 1, 'returnType': 'Dict' },
                        'screen': { 'cost': 1, 'returnType': 'Dict' },
                        'sparklines': { 'cost': 1, 'returnType': 'Dict' },
                        'time': { 'cost': 1, 'returnType': 'Dict' },
                        'trades/perpetualMarket/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        'transfers': { 'cost': 1, 'returnType': 'Dict' },
                        'transfers/between': { 'cost': 1, 'returnType': 'Dict' },
                        'transfers/parentSubaccountNumber': { 'cost': 1, 'returnType': 'Dict' },
                        'vault/v1/megavault/historicalPnl': { 'cost': 1, 'returnType': 'Dict' },
                        'vault/v1/megavault/positions': { 'cost': 1, 'returnType': 'Dict' },
                        'vault/v1/vaults/historicalPnl': { 'cost': 1, 'returnType': 'Dict' },
                        //
                        'perpetualMarketSparklines': { 'cost': 1, 'returnType': 'Dict' },
                        'perpetualMarkets/{ticker}': { 'cost': 1, 'returnType': 'Dict' },
                        'perpetualMarkets/{ticker}/orderbook': { 'cost': 1, 'returnType': 'Dict' },
                        'trades/perpetualMarket/{ticker}': { 'cost': 1, 'returnType': 'Dict' },
                        'historicalFunding/{ticker}': { 'cost': 1, 'returnType': 'Dict' },
                        'candles/{ticker}/{resolution}': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses/{address}/subaccounts': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses/{address}/subaccountNumber/{subaccountNumber}/assetPositions': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses/{address}/subaccountNumber/{subaccountNumber}/perpetualPositions': { 'cost': 1, 'returnType': 'Dict' },
                        'addresses/{address}/subaccountNumber/{subaccountNumber}/orders': { 'cost': 1, 'returnType': 'Dict' },
                        'fills/parentSubaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'historical-pnl/parentSubaccount': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'nodeRpc': {
                    'get': {
                        'abci_info': { 'cost': 1, 'returnType': 'Dict' },
                        'block': { 'cost': 1, 'returnType': 'Dict' },
                        'broadcast_tx_async': { 'cost': 1, 'returnType': 'Dict' },
                        'broadcast_tx_sync': { 'cost': 1, 'returnType': 'Dict' },
                        'tx': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'nodeRest': {
                    'get': {
                        'cosmos/auth/v1beta1/account_info/{dydxAddress}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'cosmos/tx/v1beta1/encode': { 'cost': 1, 'returnType': 'Dict' },
                        'cosmos/tx/v1beta1/simulate': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
