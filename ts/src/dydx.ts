...
import type { Account, Balances, Currency, Dict, FundingRateHistory, Int, LedgerEntry, List, Market, NullableDict, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Position, Str, Strings, Trade, Transaction, TransferEntry, int, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'indexer': {
                    'get': {
                        'addresses/{address}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses/{address}/parentSubaccountNumber/{number}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses/{address}/subaccountNumber/{subaccountNumber}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'assetPositions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'assetPositions/parentSubaccountNumber': { 'cost': 1 } as EndpointSpec<Dict>,
                        'candles/perpetualMarkets/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'compliance/screen/{address}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills/parentSubaccountNumber': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fundingPayments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fundingPayments/parentSubaccount': { 'cost': 1 } as EndpointSpec<Dict>,
                        'height': { 'cost': 0.1 } as EndpointSpec<Dict>,
                        'historical-pnl': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historical-pnl/parentSubaccountNumber': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historicalBlockTradingRewards/{address}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historicalFunding/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historicalTradingRewardAggregations/{address}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbooks/perpetualMarket/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders': { 'cost': 1 } as EndpointSpec<List>,
                        'orders/parentSubaccountNumber': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/{orderId}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'perpetualMarkets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'perpetualPositions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'perpetualPositions/parentSubaccountNumber': { 'cost': 1 } as EndpointSpec<Dict>,
                        'screen': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sparklines': { 'cost': 1 } as EndpointSpec<Dict>,
                        'time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades/perpetualMarket/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers/between': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers/parentSubaccountNumber': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vault/v1/megavault/historicalPnl': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vault/v1/megavault/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'vault/v1/vaults/historicalPnl': { 'cost': 1 } as EndpointSpec<Dict>,
                        //
                        'perpetualMarketSparklines': { 'cost': 1 } as EndpointSpec<Dict>,
                        'perpetualMarkets/{ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'perpetualMarkets/{ticker}/orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trades/perpetualMarket/{ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historicalFunding/{ticker}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'candles/{ticker}/{resolution}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses/{address}/subaccounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses/{address}/subaccountNumber/{subaccountNumber}/assetPositions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses/{address}/subaccountNumber/{subaccountNumber}/perpetualPositions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'addresses/{address}/subaccountNumber/{subaccountNumber}/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills/parentSubaccount': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historical-pnl/parentSubaccount': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'nodeRpc': {
                    'get': {
                        'abci_info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'block': { 'cost': 1 } as EndpointSpec<Dict>,
                        'broadcast_tx_async': { 'cost': 1 } as EndpointSpec<Dict>,
                        'broadcast_tx_sync': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tx': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'nodeRest': {
                    'get': {
                        'cosmos/auth/v1beta1/account_info/{dydxAddress}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'cosmos/tx/v1beta1/encode': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cosmos/tx/v1beta1/simulate': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
