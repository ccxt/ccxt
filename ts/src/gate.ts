...
export default class gate extends Exchange {
     ...
     * @param {object} [params] extra parameters specific to the exchange API endpoint
     * @param {string} [params.network] unified network code used to filter the response
    ...
    override async fetchDepositAddresses (codes: Strings = undefined, params = {}): Promise<DepositAddress[]> {
        ...
        for (let i = 0; i < codes.length; i++) {
            ...
            let parsed = this.parseDepositAddresses (successfulChains, [ currency['code'] ], false, {
    ...
    override async fetchDepositAddressesByNetwork (code: string, params: Dict = {}): Promise<DepositAddresses> {
        ...
        // Preserve the existing by-network response shape used by fetchDepositAddress.
        const parsed = this.parseDepositAddresses (successfulChains, undefined, false);
