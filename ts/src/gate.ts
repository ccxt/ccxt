        ...
        return this.deepExtend (super.describe (), {
            ...
            'options': {
                ...
                'networks': {
                    ...
                    'VET': 'VET',
                    'AR': 'AR',
                    'ASTR': 'ASTR', // ASTREVM is different
                    'INJ': 'INJ',
                    'ACA': 'ACA',
                    'TON': 'TONCOIN',
                    'FIL': 'FIL',
                    ...
                    'THETA': 'THETA',
                    'CKB': 'CKB',
                    'XCH': 'XCH', // XCH_OLD is different
                    'TLOS': 'TLOS', // TLOSEVM is different
                    'PDEX': 'PDEX',
                    'CLV': 'CLV', // CLVEVM is different
                    'XVG': 'XVG',
                    'CALLISTO': 'CLO',
                    'MONEROCLASSIC': 'XMC',
                    'QTUM': 'QTUM',
