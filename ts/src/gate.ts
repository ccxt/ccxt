...
export default class gate extends Exchange {
    ...
    parseContractMarket (market, settleId) {
        ...
        const maxMultiplier = Precise.stringAdd ('1', this.zeroIfUndefined (priceDeviate));
    ...
    parsePosition (position: Dict, market: Market = undefined) {
        ...
        if (feePaid === undefined) {
            ...
            initialMarginString = Precise.stringAdd (this.zeroIfUndefined (Precise.stringDiv (notional, leverage)), this.zeroIfUndefined (feePaid));
        }
    ...
    parseEmulatedLeverageTiers (info, market = undefined): LeverageTier[] {
        ...
        while (Precise.stringLt (floor, riskLimitMax)) {
            ...
            maintenanceMarginRate = Precise.stringAdd (this.zeroIfUndefined (maintenanceMarginRate), this.zeroIfUndefined (maintenanceMarginUnit));
            initialMarginRatio = Precise.stringAdd (this.zeroIfUndefined (initialMarginRatio), this.zeroIfUndefined (initialMarginUnit));
            floor = cap;
        }
