    ...
    override describe (): any {
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                ...
                'privateEdge': {
                    'post': {
                        'auth/api_key/login': { 'cost': 100, 'returnType': 'Dict' },
                        'auth/wallet/login': { 'cost': 100, 'returnType': 'Dict' },
                    },
                },
                'publicMarket': {
                    'post': {
                        'full/v1/instrument': { 'cost': 4, 'returnType': 'Dict' },
                        'full/v1/all_instruments': { 'cost': 4, 'returnType': 'Dict' },
                        'full/v1/instruments': { 'cost': 4, 'returnType': 'Dict' },
                        'full/v1/currency': { 'cost': 12, 'returnType': 'Dict' },
                        'full/v1/margin_rules': { 'cost': 12, 'returnType': 'Dict' },
                        'full/v1/mini': { 'cost': 4, 'returnType': 'Dict' },
                        'full/v1/ticker': { 'cost': 4, 'returnType': 'Dict' },
                        'full/v1/book': { 'cost': 12, 'returnType': 'Dict' },
                        'full/v1/trade': { 'cost': 12, 'returnType': 'Dict' },
                        'full/v1/trade_history': { 'cost': 12, 'returnType': 'Dict' },
                        'full/v1/kline': { 'cost': 12, 'returnType': 'Dict' },
                        'full/v1/funding': { 'cost': 12, 'returnType': 'Dict' },
                    },
                },
                'privateTrading': {
                    'post': {
                        'full/v1/create_order': { 'cost': 5, 'returnType': 'Dict' },
                        'full/v1/cancel_order': { 'cost': 5, 'returnType': 'Dict' },
                        'full/v1/cancel_on_disconnect': { 'cost': 100, 'returnType': 'Dict' },
                        'full/v1/cancel_all_orders': { 'cost': 50, 'returnType': 'Dict' },
                        'full/v1/order': { 'cost': rlOrders, 'returnType': 'Dict' },
                        'full/v1/order_history': { 'cost': rlOrders, 'returnType': 'Dict' },
                        'full/v1/open_orders': { 'cost': rlOrders, 'returnType': 'Dict' },
                        'full/v1/fill_history': { 'cost': rlOrders, 'returnType': 'Dict' },
                        'full/v1/positions': { 'cost': rlOrders, 'returnType': 'Dict' },
                        ...
                        'full/v1/deposit_history': { 'cost': 100, 'returnType': 'Dict' },
                        'full/v1/transfer_history': { 'cost': 100, 'returnType': 'Dict' },
                        'full/v1/withdrawal': { 'cost': 100, 'returnType': 'Dict' },
                        'full/v1/withdrawal_history': { 'cost': 100, 'returnType': 'Dict' },
                        'full/v1/add_position_margin': { 'cost': rlOthers, 'returnType': 'Dict' }, // addMargin
                        'full/v1/get_position_margin_limits': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/set_position_config': { 'cost': rlOthers, 'returnType': 'Dict' },  // setPositionMode/setMarginMode
                        'full/v1/set_initial_leverage': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/get_all_initial_leverage': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/set_derisk_mm_ratio': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_burn_tokens': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_invest': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_investor_summary': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_redeem': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_redeem_cancel': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_view_redemption_queue': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/vault_manager_investor_history': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/authorize_builder': { 'cost': rlOthers, 'returnType': 'Dict' }, // https://pastebin(dot)com/0Mb8cFhN
                        'full/v1/get_authorized_builders': { 'cost': rlOthers, 'returnType': 'Dict' },
                        'full/v1/builder_fill_history': { 'cost': rlOthers, 'returnType': 'Dict' },
                    },
                },
            },
