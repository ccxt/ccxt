import Exchange from './abstract/gleec.js';
 ...
 * @augments Exchange
 */
export default class gleec extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                'logo': 'https://exchange.gleec.com/blocks/logo/gleec-logo-day.svg',
                'api': {
                    'public': 'https://api.exchange.gleec.com/api/3',
                    'private': 'https://api.exchange.gleec.com/api/3',
                },
                'www': 'https://exchange.gleec.com/',
                'doc': [
                    'https://api.exchange.gleec.com/',
                    'https://api.exchange.gleec.com/api/3/explore/',
                ],
                'fees': [
                    'https://exchange.gleec.com/trading-fees',
                ],
            },
            'api': {
                'public': {
    ...
    /**
     * @method
     * @name gleec#fetchMarkets
     * @description retrieves data on all markets for gleec
     * @see https://api.exchange.gleec.com/#symbols
    ...
    /**
     * @method
     * @name gleec#fetchCurrencies
     * @description fetches all available currencies on an exchange
     * @see https://api.exchange.gleec.com/#currencies
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name gleec#createDepositAddress
     * @description create a currency deposit address
     * @see https://api.exchange.gleec.com/#generate-deposit-crypto-address
    ...
    /**
     * @method
     * @name gleec#fetchDepositAddress
     * @description fetch the deposit address for a currency associated with this account
     * @see https://api.exchange.gleec.com/#get-deposit-crypto-address
    ...
    /**
     * @method
     * @name gleec#fetchBalance
     * @description query for balance and get the amount of funds available for trading or funds locked in orders
     * @see https://api.exchange.gleec.com/#wallet-balance
     * @see https://api.exchange.gleec.com/#get-spot-trading-balance
     * @see https://api.exchange.gleec.com/#get-trading-balance
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name gleec#fetchTicker
     * @description fetches a price ticker, a statistical calculation with the information calculated over the past 24 hours for a specific market
     * @see https://api.exchange.gleec.com/#tickers
    ...
    /**
     * @method
     * @name gleec#fetchTrades
     * @description get the list of most recent trades for a particular symbol
     * @see https://api.exchange.gleec.com/#trades
    ...
    /**
     * @method
     * @name gleec#fetchMyTrades
     * @description fetch all trades made by the user
     * @see https://api.exchange.gleec.com/#spot-trades-history
     * @see https://api.exchange.gleec.com/#futures-trades-history
     * @see https://api.exchange.gleec.com/#margin-trades-history
    ...
    parseTransaction (transaction: Dict, currency: Currency = undefined): Transaction {
        ...
        // https://api.exchange.gleec.com/#check-if-offchain-is-available
        const fee = {
            'currency': undefined,
            'cost': undefined,
            'rate': undefined,
    ...
    /**
     * @method
     * @name gleec#fetchDepositsWithdrawals
     * @description fetch history of deposits and withdrawals
     * @see https://api.exchange.gleec.com/#get-transactions-history
    ...
    /**
     * @method
     * @name gleec#fetchOrderBooks
     * @description fetches information on open orders with bid (buy) and ask (sell) prices, volumes and other data for multiple markets
     * @see https://api.exchange.gleec.com/#order-books
    ...
    /**
     * @method
     * @name gleec#fetchTradingFee
     * @description fetch the trading fees for a market
     * @see https://api.exchange.gleec.com/#get-trading-commission
     * @see https://api.exchange.gleec.com/#get-trading-commission-2
     * @param {string} symbol unified market symbol
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name gleec#fetchTradingFees
     * @description fetch the trading fees for multiple markets
     * @see https://api.exchange.gleec.com/#get-all-trading-commissions
     * @see https://api.exchange.gleec.com/#get-all-trading-commissions-2
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name gleec#fetchOHLCV
     * @description fetches historical candlestick data containing the open, high, low, and close price, and the volume of a market
     * @see https://api.exchange.gleec.com/#candles
     * @see https://api.exchange.gleec.com/#futures-index-price-candles
     * @see https://api.exchange.gleec.com/#futures-mark-price-candles
     * @see https://api.exchange.gleec.com/#futures-premium-index-candles
    ...
    /**
     * @method
     * @name gleec#fetchClosedOrders
     * @description fetches information on multiple closed orders made by the user
     * @see https://api.exchange.gleec.com/#spot-orders-history
     * @see https://api.exchange.gleec.com/#futures-orders-history
     * @see https://api.exchange.gleec.com/#margin-orders-history
    ...
    /**
     * @method
     * @name gleec#fetchOpenOrders
     * @description fetch all unfilled currently open orders
     * @see https://api.exchange.gleec.com/#get-all-active-spot-orders
     * @see https://api.exchange.gleec.com/#get-active-futures-orders
     * @see https://api.exchange.gleec.com/#get-active-margin-orders
     * @param {string} symbol unified market symbol
    ...
    /**
     * @method
     * @name gleec#fetchOpenOrder
     * @description fetch an open order by it's id
     * @see https://api.exchange.gleec.com/#get-active-spot-order
     * @see https://api.exchange.gleec.com/#get-active-futures-order
     * @see https://api.exchange.gleec.com/#get-active-margin-order
     * @param {string} id order id
    ...
    /**
     * @method
     * @name gleec#cancelAllOrders
     * @description cancel all open orders
     * @see https://api.exchange.gleec.com/#cancel-all-spot-orders
     * @see https://api.exchange.gleec.com/#cancel-futures-orders
     * @see https://api.exchange.gleec.com/#cancel-all-margin-orders
    ...
    /**
     * @method
     * @name gleec#cancelOrder
     * @description cancels an open order
     * @see https://api.exchange.gleec.com/#cancel-spot-order
     * @see https://api.exchange.gleec.com/#cancel-futures-order
     * @see https://api.exchange.gleec.com/#cancel-margin-order
     * @param {string} id order id
     * @param {string} symbol unified symbol of the market the order was made in
     * @param {object} [params] extra parameters specific to the exchange API endpoint
     * @param {string} [params.marginMode] 'cross' or 'isolated' only 'isolated' is supported
    ...
    /**
     * @method
     * @name gleec#createOrder
     * @description create a trade order
     * @see https://api.exchange.gleec.com/#create-new-spot-order
     * @see https://api.exchange.gleec.com/#create-margin-order
     * @see https://api.exchange.gleec.com/#create-futures-order
    ...
    /**
     * @method
     * @name gleec#fetchMarginModes
     * @description fetches margin mode of the user
     * @see https://api.exchange.gleec.com/#get-margin-position-parameters
     * @see https://api.exchange.gleec.com/#get-futures-position-parameters
     ...
     * @see https://api.exchange.gleec.com/#transfer-between-wallet-and-exchange
     * @param {string} code unified currency code
     ...
     * @see https://api.exchange.gleec.com/#withdraw-crypto
     * @param {string} code unified currency code
    ...
    /**
     * @method
     * @name gleec#fetchFundingRates
     * @description fetches funding rates for multiple markets
     * @see https://api.exchange.gleec.com/#futures-info
    ...
    /**
     * @method
     * @name gleec#fetchFundingRateHistory
     * @see https://api.exchange.gleec.com/#funding-history
    ...
    /**
     * @method
     * @name gleec#fetchPositions
     * @description fetch all open positions
     * @see https://api.exchange.gleec.com/#get-futures-margin-accounts
     * @see https://api.exchange.gleec.com/#get-all-margin-accounts
     * @param {string[]|undefined} symbols not used by gleec fetchPositions ()
     * @param {object} [params] extra parameters specific to the exchange API endpoint
    ...
    /**
     * @method
     * @name gleec#fetchPosition
     * @description fetch data on a single open contract trade position
     * @see https://api.exchange.gleec.com/#get-futures-margin-account
     * @see https://api.exchange.gleec.com/#get-isolated-margin-account
    ...
    /**
     * @method
     * @name gleec#reduceMargin
     * @description remove margin from a position
     * @see https://api.exchange.gleec.com/#create-update-margin-account-2
     * @see https://api.exchange.gleec.com/#create-update-margin-account
     * @param {string} symbol unified market symbol
    ...
    async reduceMargin (symbol: string, amount: number, params = {}): Promise<MarginModification> {
        if (this.numberToString (amount) !== '0') {
            throw new BadRequest (this.id + ' reduceMargin() on gleec requires the amount to be 0 and that will remove the entire margin amount');
        }
    ...
    /**
     * @method
     * @name gleec#fetchDepositWithdrawFees
    ...
    /**
     * @method
     * @name gleec#closePosition
     * @description closes open positions for a market
     * @see https://api.exchange.gleec.com/#close-all-futures-margin-positions
     * @param {string} symbol unified ccxt market symbol
     * @param {string} side 'buy' or 'sell'
