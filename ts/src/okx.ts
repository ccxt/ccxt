...
export default class okx extends Exchange {
    ...
    async fetchIsolatedMarginAdjustmentHistory (symbol: Str = undefined, type: Str = undefined, since: Num = undefined, limit: Num = undefined, params = {}): Promise<object[]> {
         ...
         * @see https://www.okx.com/docs-v5/en/#trading-account-rest-api-get-bills-details-last-3-months
         * @param {string} [symbol] not used by okx fetchIsolatedMarginAdjustmentHistory
        ...
        if (type === undefined) {
            throw new ArgumentsRequired (this.id + ' fetchIsolatedMarginAdjustmentHistory () requires a type argument');
        }
        ...
        if ((since > oneWeekAgo) || (since === undefined)) {
            ...
            throw new BadRequest (this.id + ' fetchIsolatedMarginAdjustmentHistory () cannot fetch margin adjustments older than 3 months');
        }
        //
        //    {
        //        code: '0',
