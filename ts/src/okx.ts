...
export default class okx extends Exchange {
    ...
    async fetchOrder (id, symbol: string = undefined, params = {}) {
         ...
         * @returns [an order structure]{@link https://docs.ccxt.com/#/README?id=order-structure}
        */
        if (symbol === undefined) {
    ...
    async fetchBorrowRateHistories (codes = undefined, since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @param {object} params extra parameters specific to the okx api endpoint
         * @returns {object} a dictionary of [borrow rate structures]{@link https://docs.ccxt.com/#/README?id=borrow-rate-structure} indexed by the market symbol
         */
        await this.loadMarkets ();
        const request = {
            // 'ccy': currency['id'],
    ...
    async fetchBorrowInterest (code: string = undefined, symbol: string = undefined, since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @param {int|undefined} limit the number of [borrow interest structures]{@link https://docs.ccxt.com/#/README?id=borrow-interest-structure} to retrieve
         * @param {object} params exchange specific parameters
         * @param {int|undefined} params.type Loan type 1 - VIP loans 2 - Market loans *Default is Market loans*
         * @param {string} params.marginMode 'cross' or 'isolated'
         * @returns {[object]} An list of [borrow interest structures]{@link https://docs.ccxt.com/#/README?id=borrow-interest-structure}
         */
        await this.loadMarkets ();
        let marginMode = undefined;
    ...
    async fetchOpenInterestHistory (symbol, timeframe = '5m', since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @returns An array of [open interest structures]{@link https://docs.ccxt.com/#/README?id=interest-history-structure}
         */
