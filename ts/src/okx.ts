            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'market/books': { 'cost': 1 / 2 } as EndpointSpec<Dict>,
                        'market/books-full': { 'cost': 2 } as EndpointSpec<Dict>,
                        'market/candles': { 'cost': 1 / 2 } as EndpointSpec<Dict>,
                        'market/history-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/trades': { 'cost': 1 / 5 } as EndpointSpec<Dict>,
                        'market/history-trades': { 'cost': 2 } as EndpointSpec<Dict>,
                        'market/option/instrument-family-trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/platform-24-volume': { 'cost': 10 } as EndpointSpec<Dict>,
                        'market/call-auction-detail': { 'cost': 1 } as EndpointSpec<Dict>, // deprecated, use call-auction-details
                        'market/call-auction-details': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/books-sbe': { 'cost': 10 } as EndpointSpec<Dict>,
                        'market/block-tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/block-ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/sprd-ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/sprd-candles': { 'cost': 1 / 2 } as EndpointSpec<Dict>,
                        'market/sprd-history-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/index-tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/index-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/history-index-candles': { 'cost': 2 } as EndpointSpec<Dict>,
                        'market/mark-price-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/history-mark-price-candles': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/exchange-rate': { 'cost': 20 } as EndpointSpec<Dict>,
                        'market/index-components': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/open-oracle': { 'cost': 50 } as EndpointSpec<Dict>, // not documented
                        'market/books-lite': { 'cost': 5 / 3 } as EndpointSpec<Dict>, // deprecated
                        // public
                        'public/option-trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/block-trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/instruments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/estimated-price': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/delivery-exercise-history': { 'cost': 1 / 2 } as EndpointSpec<Dict>,
                        'public/estimated-settlement-info': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/settlement-history': { 'cost': 1 / 2 } as EndpointSpec<Dict>,
                        'public/funding-rate': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/funding-rate-history': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/open-interest': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/price-limit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/opt-summary': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/discount-rate-interest-free-quota': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/time': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/mark-price': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/position-tiers': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/interest-rate-loan-quota': { 'cost': 10 } as EndpointSpec<Dict>,
                        'public/underlying': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/insurance-fund': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/convert-contract-coin': { 'cost': 2 } as EndpointSpec<Dict>,
                        'public/instrument-tick-bands': { 'cost': 4 } as EndpointSpec<Dict>,
                        'public/premium-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/economic-calendar': { 'cost': 50 } as EndpointSpec<Dict>,
                        'public/market-data-history': { 'cost': 4 } as EndpointSpec<Dict>,
                        'public/event-contract/events': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/event-contract/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/event-contract/series': { 'cost': 1 } as EndpointSpec<Dict>,
                        'public/vip-interest-rate-loan-quota': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        // rubik
                        'rubik/stat/trading-data/support-coin': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/contracts/open-interest-history': { 'cost': 2 } as EndpointSpec<Dict>,
                        'rubik/stat/taker-volume': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/taker-volume-contract': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/margin/loan-ratio': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/contracts/long-short-account-ratio-contract-top-trader': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/contracts/long-short-position-ratio-contract-top-trader': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/contracts/long-short-account-ratio-contract': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/contracts/long-short-account-ratio': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/contracts/open-interest-volume': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/option/open-interest-volume': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/option/open-interest-volume-ratio': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/option/open-interest-volume-expiry': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/option/open-interest-volume-strike': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rubik/stat/option/taker-block-volume': { 'cost': 4 } as EndpointSpec<Dict>,
                        // system
                        'system/status': { 'cost': 50 } as EndpointSpec<Dict>,
                        // sprd
                        'sprd/spreads': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/books': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/public-trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/ticker': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'tradingBot/grid/ai-param': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/min-investment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/public/rsi-back-testing': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/grid-quantity': { 'cost': 4 } as EndpointSpec<Dict>,
                        'asset/exchange-list': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/eth/apy-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/apy-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/savings/lending-rate-summary': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/savings/lending-rate-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/fixed-loan/lending-offers': { 'cost': 10 / 3 } as EndpointSpec<Dict>, // not documented
                        'finance/fixed-loan/lending-apy-history': { 'cost': 10 / 3 } as EndpointSpec<Dict>, // not documented
                        'finance/fixed-loan/pending-lending-volume': { 'cost': 10 / 3 } as EndpointSpec<Dict>, // not documented
                        // public broker
                        'finance/sfp/dcd/products': { 'cost': 2 / 3 } as EndpointSpec<Dict>, // not documented
                        // copytrading
                        'copytrading/public-config': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-lead-traders': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-weekly-pnl': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-pnl': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-stats': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-preference-currency': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-current-subpositions': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-subpositions-history': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/public-copy-traders': { 'cost': 4 } as EndpointSpec<Dict>,
                        'support/announcements': { 'cost': 4 } as EndpointSpec<Dict>,
                        'support/announcements-types': { 'cost': 20 } as EndpointSpec<Dict>, // typo, use announcement-types
                        'support/announcement-types': { 'cost': 20 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'tradingBot/grid/min-investment': { 'cost': 1 } as EndpointSpec<Dict>, // public
                    },
                },
                'private': {
                    'get': {
                        // rfq
                        'rfq/counterparties': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/maker-instrument-settings': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/mmp-config': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/rfqs': { 'cost': 10 } as EndpointSpec<Dict>,
                        'rfq/quotes': { 'cost': 10 } as EndpointSpec<Dict>,
                        'rfq/trades': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/public-trades': { 'cost': 4 } as EndpointSpec<Dict>,
                        // sprd
                        'sprd/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/orders-pending': { 'cost': 2 } as EndpointSpec<Dict>,
                        'sprd/orders-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/orders-history-archive': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                        // trade
                        'trade/order': { 'cost': 1 / 3 } as EndpointSpec<Dict>,
                        'trade/orders-pending': { 'cost': 1 / 3 } as EndpointSpec<Dict>,
                        'trade/orders-history': { 'cost': 1 / 2 } as EndpointSpec<Dict>,
                        'trade/orders-history-archive': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/fills': { 'cost': 1 / 3 } as EndpointSpec<Dict>,
                        'trade/fills-history': { 'cost': 2 } as EndpointSpec<Dict>,
                        'trade/fills-archive': { 'cost': 2 } as EndpointSpec<Dict>, // not documented
                        'trade/order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/orders-algo-pending': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/orders-algo-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/easy-convert-currency-list': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/easy-convert-history': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/one-click-repay-currency-list': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/one-click-repay-currency-list-v2': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/one-click-repay-history': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/one-click-repay-history-v2': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/account-rate-limit': { 'cost': 1 } as EndpointSpec<Dict>,
                        // asset
                        'asset/currencies': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/balances': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/non-tradable-assets': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/asset-valuation': { 'cost': 10 } as EndpointSpec<Dict>,
                        'asset/transfer-state': { 'cost': 1 } as EndpointSpec<Dict>,
                        'asset/bills': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/bills-history': { 'cost': 10 } as EndpointSpec<Dict>,
                        'asset/deposit-lightning': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'asset/deposit-address': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/deposit-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/withdrawal-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/deposit-withdraw-status': { 'cost': 20 } as EndpointSpec<Dict>,
                        'asset/monthly-statement': { 'cost': 2 } as EndpointSpec<Dict>,
                        'asset/convert/currencies': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/convert/currency-pair': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/convert/history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        // account
                        'account/instruments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/balance': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/positions': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/positions-history': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/account-position-risk': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/bills': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/bills-archive': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/bills-history-archive': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/config': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/subtypes': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/max-size': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/max-avail-size': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/leverage-info': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/adjust-leverage-info': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/max-loan': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/trade-fee': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/interest-accrued': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/interest-rate': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/max-withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/risk-state': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/interest-limits': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/spot-borrow-repay-history': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/greeks': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/position-tiers': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/set-account-switch-precheck': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/collateral-assets': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/mmp-config': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/move-positions-history': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/precheck-set-delta-neutral': { 'cost': 20 } as EndpointSpec<Dict>,
                        'account/quick-margin-borrow-repay-history': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/borrow-repay-history': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/vip-interest-accrued': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'account/vip-interest-deducted': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'account/vip-loan-order-list': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'account/vip-loan-order-detail': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'account/fixed-loan/borrowing-limit': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'account/fixed-loan/borrowing-quote': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'account/fixed-loan/borrowing-orders-list': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'account/spot-manual-borrow-repay': { 'cost': 30 } as EndpointSpec<Dict>, // not documented
                        'account/set-auto-repay': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        // subaccount
                        'users/subaccount/list': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/subaccount/balances': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        'asset/subaccount/balances': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        'account/subaccount/max-withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'asset/subaccount/bills': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/subaccount/managed-subaccount-bills': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'users/entrust-subaccount-list': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/subaccount/interest-limits': { 'cost': 4 } as EndpointSpec<Dict>,
                        'users/subaccount/apikey': { 'cost': 10 } as EndpointSpec<Dict>,
                        // grid trading
                        'tradingBot/grid/orders-algo-pending': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/orders-algo-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/orders-algo-details': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/sub-orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/ai-param': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/signals': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/orders-algo-details': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/orders-algo-pending': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/orders-algo-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/positions-history': { 'cost': 2 } as EndpointSpec<Dict>,
                        'tradingBot/signal/sub-orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/event-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/orders-algo-pending': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/orders-algo-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/orders-algo-details': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/sub-orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/ongoing-list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/history-list': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/position-details': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/cycle-list': { 'cost': 1 } as EndpointSpec<Dict>,
                        // earn
                        'finance/savings/balance': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/savings/lending-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/offers': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/orders-active': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/orders-history': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        // eth staking
                        'finance/staking-defi/eth/product-info': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/eth/balance': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/eth/purchase-redeem-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/product-info': { 'cost': 10 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/balance': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/purchase-redeem-history': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/borrow-currencies': { 'cost': 4 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/collateral-assets': { 'cost': 4 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/max-collateral-redeem-amount': { 'cost': 4 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/loan-info': { 'cost': 4 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/loan-history': { 'cost': 4 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/interest-accrued': { 'cost': 4 } as EndpointSpec<Dict>,
                        // copytrading
                        'copytrading/current-subpositions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'copytrading/subpositions-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'copytrading/instruments': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/profit-sharing-details': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/total-profit-sharing': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/unrealized-profit-sharing-details': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/total-unrealized-profit-sharing': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/config': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/copy-settings': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/current-lead-traders': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/batch-leverage-info': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'copytrading/lead-traders-history': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        // broker
                        'broker/dma/subaccount-info': { 'cost': 2 } as EndpointSpec<Dict>,
                        'broker/dma/subaccount-trade-fee': { 'cost': 10 } as EndpointSpec<Dict>,
                        'broker/dma/subaccount/apikey': { 'cost': 10 } as EndpointSpec<Dict>,
                        'broker/dma/rebate-per-orders': { 'cost': 300 } as EndpointSpec<Dict>,
                        'broker/fd/rebate-per-orders': { 'cost': 300 } as EndpointSpec<Dict>,
                        'broker/fd/if-rebate': { 'cost': 5 } as EndpointSpec<Dict>,
                        'broker/nd/info': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/subaccount-info': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/subaccount/apikey': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'asset/broker/nd/subaccount-deposit-address': { 'cost': 5 / 3 } as EndpointSpec<Dict>, // not documented
                        'asset/broker/nd/subaccount-deposit-history': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'asset/broker/nd/subaccount-withdrawal-history': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/rebate-daily': { 'cost': 100 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/rebate-per-orders': { 'cost': 300 } as EndpointSpec<Dict>, // not documented
                        'finance/sfp/dcd/order': { 'cost': 2 } as EndpointSpec<Dict>, // not documented
                        'finance/sfp/dcd/orders': { 'cost': 2 } as EndpointSpec<Dict>, // not documented
                        'finance/sfp/dcd/currency-pair': { 'cost': 2 } as EndpointSpec<Dict>,
                        'finance/sfp/dcd/order-status': { 'cost': 2 } as EndpointSpec<Dict>,
                        'finance/sfp/dcd/order-history': { 'cost': 2 } as EndpointSpec<Dict>,
                        // affiliate
                        'affiliate/invitee/detail': { 'cost': 1 } as EndpointSpec<Dict>,
                        'users/partner/if-rebate': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'support/announcements': { 'cost': 4 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        // rfq
                        'rfq/create-rfq': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/cancel-rfq': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/cancel-batch-rfqs': { 'cost': 10 } as EndpointSpec<Dict>,
                        'rfq/cancel-all-rfqs': { 'cost': 10 } as EndpointSpec<Dict>,
                        'rfq/execute-quote': { 'cost': 15 } as EndpointSpec<Dict>,
                        'rfq/maker-instrument-settings': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/mmp-reset': { 'cost': 4 } as EndpointSpec<Dict>,
                        'rfq/mmp-config': { 'cost': 100 } as EndpointSpec<Dict>,
                        'rfq/create-quote': { 'cost': 0.4 } as EndpointSpec<Dict>,
                        'rfq/cancel-quote': { 'cost': 0.4 } as EndpointSpec<Dict>,
                        'rfq/cancel-batch-quotes': { 'cost': 10 } as EndpointSpec<Dict>,
                        'rfq/cancel-all-quotes': { 'cost': 10 } as EndpointSpec<Dict>,
                        'rfq/cancel-all-after': { 'cost': 10 } as EndpointSpec<Dict>,
                        // sprd
                        'sprd/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/cancel-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/mass-cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/amend-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'sprd/cancel-all-after': { 'cost': 10 } as EndpointSpec<Dict>,
                        // trade
                        'trade/order': { 'cost': 1 / 3 } as EndpointSpec<Dict>,
                        'trade/batch-orders': { 'cost': 1 / 15 } as EndpointSpec<Dict>,
                        'trade/cancel-order': { 'cost': 1 / 3 } as EndpointSpec<Dict>,
                        'trade/cancel-batch-orders': { 'cost': 1 / 15 } as EndpointSpec<Dict>,
                        'trade/amend-order': { 'cost': 1 / 3 } as EndpointSpec<Dict>,
                        'trade/amend-batch-orders': { 'cost': 1 / 150 } as EndpointSpec<Dict>,
                        'trade/close-position': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/fills-archive': { 'cost': 172800 } as EndpointSpec<Dict>, // not documented
                        'trade/cancel-advance-algos': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'trade/easy-convert': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/one-click-repay': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/one-click-repay-v2': { 'cost': 20 } as EndpointSpec<Dict>,
                        'trade/mass-cancel': { 'cost': 4 } as EndpointSpec<Dict>,
                        'trade/cancel-all-after': { 'cost': 10 } as EndpointSpec<Dict>,
                        'trade/order-precheck': { 'cost': 4 } as EndpointSpec<Dict>,
                        'trade/order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/cancel-algos': { 'cost': 1 } as EndpointSpec<Dict>,
                        'trade/amend-algos': { 'cost': 1 } as EndpointSpec<Dict>,
                        // asset
                        'asset/transfer': { 'cost': 5 } as EndpointSpec<Dict>,
                        'asset/withdrawal': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/withdrawal-lightning': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'asset/cancel-withdrawal': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'asset/convert-dust-assets': { 'cost': 10 } as EndpointSpec<Dict>,
                        'asset/monthly-statement': { 'cost': 1296000 } as EndpointSpec<Dict>, // 20 req/month, 10/20*30*24*60*60 = 1296000
                        'asset/convert/estimate-quote': { 'cost': 50 } as EndpointSpec<Dict>,
                        'asset/convert/trade': { 'cost': 1 } as EndpointSpec<Dict>,
                        // account
                        'account/bills-history-archive': { 'cost': 72000 } as EndpointSpec<Dict>, // 12 req/day
                        'account/set-position-mode': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/set-leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/position/margin-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/set-fee-type': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/set-greeks': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/set-isolated-mode': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/spot-manual-borrow-repay': { 'cost': 30 } as EndpointSpec<Dict>,
                        'account/set-auto-repay': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/quick-margin-borrow-repay': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'account/borrow-repay': { 'cost': 5 / 3 } as EndpointSpec<Dict>, // not documented
                        'account/simulated_margin': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'account/position-builder': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/position-builder-graph': { 'cost': 50 } as EndpointSpec<Dict>,
                        'account/set-riskOffset-type': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/set-riskOffset-amt': { 'cost': 2 } as EndpointSpec<Dict>,
                        'account/activate-option': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/set-auto-loan': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/account-level-switch-preset': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/set-account-level': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/set-collateral-assets': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/mmp-reset': { 'cost': 4 } as EndpointSpec<Dict>,
                        'account/mmp-config': { 'cost': 50 } as EndpointSpec<Dict>,
                        'account/fixed-loan/borrowing-order': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'account/fixed-loan/amend-borrowing-order': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'account/fixed-loan/manual-reborrow': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'account/fixed-loan/repay-borrowing-order': { 'cost': 5 } as EndpointSpec<Dict>, // not documented
                        'account/move-positions': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/set-auto-earn': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/set-settle-currency': { 'cost': 1 } as EndpointSpec<Dict>,
                        'account/set-trading-config': { 'cost': 20 } as EndpointSpec<Dict>,
                        'account/demo-adjust-balance': { 'cost': 20 } as EndpointSpec<Dict>, // 3 requests per day but we don't use that weight for now, set to 20 to be safe
                        // subaccount
                        'asset/subaccount/transfer': { 'cost': 10 } as EndpointSpec<Dict>,
                        'account/subaccount/set-loan-allocation': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'users/subaccount/create-subaccount': { 'cost': 10 } as EndpointSpec<Dict>,
                        'users/subaccount/apikey': { 'cost': 10 } as EndpointSpec<Dict>,
                        'users/subaccount/modify-apikey': { 'cost': 10 } as EndpointSpec<Dict>,
                        'users/subaccount/subaccount-apikey': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'users/subaccount/delete-apikey': { 'cost': 10 } as EndpointSpec<Dict>,
                        'users/subaccount/set-transfer-out': { 'cost': 10 } as EndpointSpec<Dict>,
                        // grid trading
                        'tradingBot/grid/order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/copy-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/amend-algo-basic-param': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/amend-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/stop-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/close-position': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/cancel-close-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/order-instant-trigger': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/withdraw-income': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/compute-margin-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/margin-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/grid/min-investment': { 'cost': 1 } as EndpointSpec<Dict>, // public
                        'tradingBot/grid/adjust-investment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/create-signal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/stop-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/margin-balance': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/amendTPSL': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/set-instruments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/close-position': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/sub-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/signal/cancel-sub-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/amend-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/stop-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/create': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/amend-order-algo': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/stop': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/orders/manual-buy': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/settings/reinvestment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/settings/take-profit': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/margin/add': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/dca/margin/reduce': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/add-investment': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/amend-price-range': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/amend-recurring-amount': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/amend-recurring-time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/pause': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tradingBot/recurring/restart': { 'cost': 1 } as EndpointSpec<Dict>,
                        // earn
                        'finance/savings/purchase-redempt': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/savings/set-lending-rate': { 'cost': 5 / 3 } as EndpointSpec<Dict>,
                        'finance/staking-defi/purchase': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/redeem': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/cancel': { 'cost': 5 } as EndpointSpec<Dict>,
                        // eth staking
                        'finance/staking-defi/eth/purchase': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/eth/redeem': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/eth/cancel-redeem': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/purchase': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/redeem': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/staking-defi/sol/cancel-redeem': { 'cost': 5 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/max-loan': { 'cost': 4 } as EndpointSpec<Dict>,
                        'finance/flexible-loan/adjust-collateral': { 'cost': 4 } as EndpointSpec<Dict>,
                        // copytrading
                        'copytrading/algo-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'copytrading/close-subposition': { 'cost': 1 } as EndpointSpec<Dict>,
                        'copytrading/set-instruments': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/amend-profit-sharing-ratio': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/first-copy-settings': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/amend-copy-settings': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/stop-copy-trading': { 'cost': 4 } as EndpointSpec<Dict>,
                        'copytrading/batch-set-leverage': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        // broker
                        'broker/nd/create-subaccount': { 'cost': 0.25 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/delete-subaccount': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/subaccount/apikey': { 'cost': 0.25 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/subaccount/modify-apikey': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/subaccount/delete-apikey': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/set-subaccount-level': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/set-subaccount-fee-rate': { 'cost': 4 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/set-subaccount-assets': { 'cost': 0.25 } as EndpointSpec<Dict>, // not documented
                        'asset/broker/nd/subaccount-deposit-address': { 'cost': 1 } as EndpointSpec<Dict>, // not documented
                        'asset/broker/nd/modify-subaccount-deposit-address': { 'cost': 5 / 3 } as EndpointSpec<Dict>, // not documented
                        'broker/nd/rebate-per-orders': { 'cost': 36000 } as EndpointSpec<Dict>, // not documented
                        'finance/sfp/dcd/quote': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'finance/sfp/dcd/order': { 'cost': 10 } as EndpointSpec<Dict>, // not documented
                        'finance/sfp/dcd/trade': { 'cost': 10 } as EndpointSpec<Dict>,
                        'finance/sfp/dcd/redeem-quote': { 'cost': 10 } as EndpointSpec<Dict>,
                        'finance/sfp/dcd/redeem': { 'cost': 10 } as EndpointSpec<Dict>,
                        'broker/nd/report-subaccount-ip': { 'cost': 0.25 } as EndpointSpec<Dict>, // not documented
                        'broker/dma/subaccount/apikey': { 'cost': 1 / 4 } as EndpointSpec<Dict>,
                        'broker/dma/trades': { 'cost': 36000 } as EndpointSpec<Dict>,
                        'broker/fd/rebate-per-orders': { 'cost': 36000 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
