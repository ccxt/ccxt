        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        // market
                        'market/tickers': { 'cost': 1, 'returnType': 'Dict' },
                        'market/ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'market/books': { 'cost': 1 / 2, 'returnType': 'Dict' },
                        'market/books-full': { 'cost': 2, 'returnType': 'Dict' },
                        'market/candles': { 'cost': 1 / 2, 'returnType': 'Dict' },
                        'market/history-candles': { 'cost': 1, 'returnType': 'Dict' },
                        'market/trades': { 'cost': 1 / 5, 'returnType': 'Dict' },
                        'market/history-trades': { 'cost': 2, 'returnType': 'Dict' },
                        'market/option/instrument-family-trades': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'market/sprd-candles': { 'cost': 1 / 2, 'returnType': 'Dict' },
                        'market/sprd-history-candles': { 'cost': 1, 'returnType': 'Dict' },
                        'market/index-tickers': { 'cost': 1, 'returnType': 'Dict' },
                        'market/index-candles': { 'cost': 1, 'returnType': 'Dict' },
                        'market/history-index-candles': { 'cost': 2, 'returnType': 'Dict' },
                        'market/mark-price-candles': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'public/instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'public/estimated-price': { 'cost': 2, 'returnType': 'Dict' },
                        'public/delivery-exercise-history': { 'cost': 1 / 2, 'returnType': 'Dict' },
                        'public/estimated-settlement-info': { 'cost': 2, 'returnType': 'Dict' },
                        'public/settlement-history': { 'cost': 1 / 2, 'returnType': 'Dict' },
                        'public/funding-rate': { 'cost': 2, 'returnType': 'Dict' },
                        'public/funding-rate-history': { 'cost': 2, 'returnType': 'Dict' },
                        'public/open-interest': { 'cost': 1, 'returnType': 'Dict' },
                        'public/price-limit': { 'cost': 1, 'returnType': 'Dict' },
                        'public/opt-summary': { 'cost': 1, 'returnType': 'Dict' },
                        'public/discount-rate-interest-free-quota': { 'cost': 10, 'returnType': 'Dict' },
                        'public/time': { 'cost': 2, 'returnType': 'Dict' },
                        'public/mark-price': { 'cost': 2, 'returnType': 'Dict' },
                        'public/position-tiers': { 'cost': 2, 'returnType': 'Dict' },
                        'public/interest-rate-loan-quota': { 'cost': 10, 'returnType': 'Dict' },
                        'public/underlying': { 'cost': 1, 'returnType': 'Dict' },
                        'public/insurance-fund': { 'cost': 2, 'returnType': 'Dict' },
                        'public/convert-contract-coin': { 'cost': 2, 'returnType': 'Dict' },
                        'public/instrument-tick-bands': { 'cost': 4, 'returnType': 'Dict' },
                        'public/premium-history': { 'cost': 1, 'returnType': 'Dict' },
                        'public/economic-calendar': { 'cost': 50, 'returnType': 'Dict' },
                        'public/market-data-history': { 'cost': 4, 'returnType': 'Dict' },
                        'public/event-contract/events': { 'cost': 1, 'returnType': 'Dict' },
                        'public/event-contract/markets': { 'cost': 1, 'returnType': 'Dict' },
                        'public/event-contract/series': { 'cost': 1, 'returnType': 'Dict' },
                        'public/vip-interest-rate-loan-quota': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        // rubik
                        'rubik/stat/trading-data/support-coin': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/contracts/open-interest-history': { 'cost': 2, 'returnType': 'Dict' },
                        'rubik/stat/taker-volume': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/taker-volume-contract': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/margin/loan-ratio': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/contracts/long-short-account-ratio-contract-top-trader': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/contracts/long-short-position-ratio-contract-top-trader': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/contracts/long-short-account-ratio-contract': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/contracts/long-short-account-ratio': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/contracts/open-interest-volume': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/option/open-interest-volume': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/option/open-interest-volume-ratio': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/option/open-interest-volume-expiry': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/option/open-interest-volume-strike': { 'cost': 4, 'returnType': 'Dict' },
                        'rubik/stat/option/taker-block-volume': { 'cost': 4, 'returnType': 'Dict' },
                        // system
                        'system/status': { 'cost': 50, 'returnType': 'Dict' },
                        // sprd
                        'sprd/spreads': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/books': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/public-trades': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/ticker': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'tradingBot/grid/ai-param': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/min-investment': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/public/rsi-back-testing': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/grid-quantity': { 'cost': 4, 'returnType': 'Dict' },
                        'asset/exchange-list': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/eth/apy-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/apy-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/savings/lending-rate-summary': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/savings/lending-rate-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/fixed-loan/lending-offers': { 'cost': 10 / 3, 'returnType': 'Dict' }, // not documented
                        'finance/fixed-loan/lending-apy-history': { 'cost': 10 / 3, 'returnType': 'Dict' }, // not documented
                        'finance/fixed-loan/pending-lending-volume': { 'cost': 10 / 3, 'returnType': 'Dict' }, // not documented
                        // public broker
                        'finance/sfp/dcd/products': { 'cost': 2 / 3, 'returnType': 'Dict' }, // not documented
                        // copytrading
                        'copytrading/public-config': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/public-lead-traders': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/public-weekly-pnl': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/public-pnl': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/public-stats': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/public-preference-currency': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/public-current-subpositions': { 'cost': 4, 'returnType': 'Dict' },
                    ...
                    'post': {
                        'tradingBot/grid/min-investment': { 'cost': 1, 'returnType': 'Dict' }, // public
                    },
                },
                'private': {
                    'get': {
                        // rfq
                        'rfq/counterparties': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/maker-instrument-settings': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/mmp-config': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/rfqs': { 'cost': 10, 'returnType': 'Dict' },
                        'rfq/quotes': { 'cost': 10, 'returnType': 'Dict' },
                        'rfq/trades': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/public-trades': { 'cost': 4, 'returnType': 'Dict' },
                        // sprd
                        'sprd/order': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/orders-pending': { 'cost': 2, 'returnType': 'Dict' },
                        'sprd/orders-history': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/orders-history-archive': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/trades': { 'cost': 1, 'returnType': 'Dict' },
                        // trade
                        'trade/order': { 'cost': 1 / 3, 'returnType': 'Dict' },
                        'trade/orders-pending': { 'cost': 1 / 3, 'returnType': 'Dict' },
                        'trade/orders-history': { 'cost': 1 / 2, 'returnType': 'Dict' },
                        'trade/orders-history-archive': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/fills': { 'cost': 1 / 3, 'returnType': 'Dict' },
                        'trade/fills-history': { 'cost': 2, 'returnType': 'Dict' },
                        'trade/fills-archive': { 'cost': 2, 'returnType': 'Dict' }, // not documented
                        'trade/order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-algo-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-algo-history': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/easy-convert-currency-list': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/easy-convert-history': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/one-click-repay-currency-list': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/one-click-repay-currency-list-v2': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/one-click-repay-history': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/one-click-repay-history-v2': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/account-rate-limit': { 'cost': 1, 'returnType': 'Dict' },
                        // asset
                        'asset/currencies': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/balances': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/non-tradable-assets': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/asset-valuation': { 'cost': 10, 'returnType': 'Dict' },
                        'asset/transfer-state': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/bills': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/bills-history': { 'cost': 10, 'returnType': 'Dict' },
                        'asset/deposit-lightning': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'asset/deposit-address': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/deposit-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/withdrawal-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/deposit-withdraw-status': { 'cost': 20, 'returnType': 'Dict' },
                        'asset/monthly-statement': { 'cost': 2, 'returnType': 'Dict' },
                        'asset/convert/currencies': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/convert/currency-pair': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/convert/history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        // account
                        'account/instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'account/balance': { 'cost': 2, 'returnType': 'Dict' },
                        'account/positions': { 'cost': 2, 'returnType': 'Dict' },
                        'account/positions-history': { 'cost': 2, 'returnType': 'Dict' },
                        'account/account-position-risk': { 'cost': 2, 'returnType': 'Dict' },
                        'account/bills': { 'cost': 2, 'returnType': 'Dict' },
                        'account/bills-archive': { 'cost': 4, 'returnType': 'Dict' },
                        'account/bills-history-archive': { 'cost': 2, 'returnType': 'Dict' },
                        'account/config': { 'cost': 4, 'returnType': 'Dict' },
                        'account/subtypes': { 'cost': 4, 'returnType': 'Dict' },
                        'account/max-size': { 'cost': 1, 'returnType': 'Dict' },
                        'account/max-avail-size': { 'cost': 1, 'returnType': 'Dict' },
                        'account/leverage-info': { 'cost': 1, 'returnType': 'Dict' },
                        'account/adjust-leverage-info': { 'cost': 4, 'returnType': 'Dict' },
                        'account/max-loan': { 'cost': 1, 'returnType': 'Dict' },
                        'account/trade-fee': { 'cost': 4, 'returnType': 'Dict' },
                        'account/interest-accrued': { 'cost': 4, 'returnType': 'Dict' },
                        'account/interest-rate': { 'cost': 4, 'returnType': 'Dict' },
                        'account/max-withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'account/risk-state': { 'cost': 2, 'returnType': 'Dict' },
                        'account/interest-limits': { 'cost': 4, 'returnType': 'Dict' },
                        'account/spot-borrow-repay-history': { 'cost': 4, 'returnType': 'Dict' },
                        'account/greeks': { 'cost': 2, 'returnType': 'Dict' },
                        'account/position-tiers': { 'cost': 2, 'returnType': 'Dict' },
                        'account/set-account-switch-precheck': { 'cost': 4, 'returnType': 'Dict' },
                        'account/collateral-assets': { 'cost': 4, 'returnType': 'Dict' },
                        'account/mmp-config': { 'cost': 4, 'returnType': 'Dict' },
                        'account/move-positions-history': { 'cost': 10, 'returnType': 'Dict' },
                        'account/precheck-set-delta-neutral': { 'cost': 20, 'returnType': 'Dict' },
                        'account/quick-margin-borrow-repay-history': { 'cost': 4, 'returnType': 'Dict' },
                        'account/borrow-repay-history': { 'cost': 4, 'returnType': 'Dict' },
                        'account/vip-interest-accrued': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'account/vip-interest-deducted': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'account/vip-loan-order-list': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'account/vip-loan-order-detail': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'account/fixed-loan/borrowing-limit': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'account/fixed-loan/borrowing-quote': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'account/fixed-loan/borrowing-orders-list': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'account/spot-manual-borrow-repay': { 'cost': 30, 'returnType': 'Dict' }, // not documented
                        'account/set-auto-repay': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        // subaccount
                        'users/subaccount/list': { 'cost': 10, 'returnType': 'Dict' },
                        'account/subaccount/balances': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        'asset/subaccount/balances': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        'account/subaccount/max-withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/subaccount/bills': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/subaccount/managed-subaccount-bills': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'users/entrust-subaccount-list': { 'cost': 10, 'returnType': 'Dict' },
                        'account/subaccount/interest-limits': { 'cost': 4, 'returnType': 'Dict' },
                        'users/subaccount/apikey': { 'cost': 10, 'returnType': 'Dict' },
                        // grid trading
                        'tradingBot/grid/orders-algo-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/orders-algo-history': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/orders-algo-details': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/sub-orders': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/positions': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/ai-param': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/signals': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/orders-algo-details': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/orders-algo-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/orders-algo-history': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/positions': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/positions-history': { 'cost': 2, 'returnType': 'Dict' },
                        'tradingBot/signal/sub-orders': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/event-history': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/orders-algo-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/orders-algo-history': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/orders-algo-details': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/sub-orders': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/ongoing-list': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/history-list': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/orders': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/position-details': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/cycle-list': { 'cost': 1, 'returnType': 'Dict' },
                        // earn
                        'finance/savings/balance': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/savings/lending-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/offers': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/orders-active': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/orders-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        // eth staking
                        'finance/staking-defi/eth/product-info': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/eth/balance': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/eth/purchase-redeem-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/product-info': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/balance': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/purchase-redeem-history': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/flexible-loan/borrow-currencies': { 'cost': 4, 'returnType': 'Dict' },
                        'finance/flexible-loan/collateral-assets': { 'cost': 4, 'returnType': 'Dict' },
                        'finance/flexible-loan/max-collateral-redeem-amount': { 'cost': 4, 'returnType': 'Dict' },
                        'finance/flexible-loan/loan-info': { 'cost': 4, 'returnType': 'Dict' },
                        'finance/flexible-loan/loan-history': { 'cost': 4, 'returnType': 'Dict' },
                        'finance/flexible-loan/interest-accrued': { 'cost': 4, 'returnType': 'Dict' },
                        // copytrading
                        'copytrading/current-subpositions': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/subpositions-history': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/instruments': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/profit-sharing-details': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/total-profit-sharing': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/unrealized-profit-sharing-details': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/total-unrealized-profit-sharing': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/config': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/copy-settings': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/current-lead-traders': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/batch-leverage-info': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'copytrading/lead-traders-history': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        // broker
                        'broker/dma/subaccount-info': { 'cost': 2, 'returnType': 'Dict' },
                        'broker/dma/subaccount-trade-fee': { 'cost': 10, 'returnType': 'Dict' },
                        'broker/dma/subaccount/apikey': { 'cost': 10, 'returnType': 'Dict' },
                        'broker/dma/rebate-per-orders': { 'cost': 300, 'returnType': 'Dict' },
                        'broker/fd/rebate-per-orders': { 'cost': 300, 'returnType': 'Dict' },
                        'broker/fd/if-rebate': { 'cost': 5, 'returnType': 'Dict' },
                        'broker/nd/info': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'broker/nd/subaccount-info': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'broker/nd/subaccount/apikey': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'asset/broker/nd/subaccount-deposit-address': { 'cost': 5 / 3, 'returnType': 'Dict' }, // not documented
                        'asset/broker/nd/subaccount-deposit-history': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'asset/broker/nd/subaccount-withdrawal-history': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'broker/nd/rebate-daily': { 'cost': 100, 'returnType': 'Dict' }, // not documented
                        'broker/nd/rebate-per-orders': { 'cost': 300, 'returnType': 'Dict' }, // not documented
                        'finance/sfp/dcd/order': { 'cost': 2, 'returnType': 'Dict' }, // not documented
                        'finance/sfp/dcd/orders': { 'cost': 2, 'returnType': 'Dict' }, // not documented
                        'finance/sfp/dcd/currency-pair': { 'cost': 2, 'returnType': 'Dict' },
                        'finance/sfp/dcd/order-status': { 'cost': 2, 'returnType': 'Dict' },
                        'finance/sfp/dcd/order-history': { 'cost': 2, 'returnType': 'Dict' },
                        // affiliate
                        'affiliate/invitee/detail': { 'cost': 1, 'returnType': 'Dict' },
                        'users/partner/if-rebate': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'support/announcements': { 'cost': 4, 'returnType': 'Dict' },
                    },
                    'post': {
                        // rfq
                        'rfq/create-rfq': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/cancel-rfq': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/cancel-batch-rfqs': { 'cost': 10, 'returnType': 'Dict' },
                        'rfq/cancel-all-rfqs': { 'cost': 10, 'returnType': 'Dict' },
                        'rfq/execute-quote': { 'cost': 15, 'returnType': 'Dict' },
                        'rfq/maker-instrument-settings': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/mmp-reset': { 'cost': 4, 'returnType': 'Dict' },
                        'rfq/mmp-config': { 'cost': 100, 'returnType': 'Dict' },
                        'rfq/create-quote': { 'cost': 0.4, 'returnType': 'Dict' },
                        'rfq/cancel-quote': { 'cost': 0.4, 'returnType': 'Dict' },
                        'rfq/cancel-batch-quotes': { 'cost': 10, 'returnType': 'Dict' },
                        'rfq/cancel-all-quotes': { 'cost': 10, 'returnType': 'Dict' },
                        'rfq/cancel-all-after': { 'cost': 10, 'returnType': 'Dict' },
                        // sprd
                        'sprd/order': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/cancel-order': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/mass-cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/amend-order': { 'cost': 1, 'returnType': 'Dict' },
                        'sprd/cancel-all-after': { 'cost': 10, 'returnType': 'Dict' },
                        // trade
                        'trade/order': { 'cost': 1 / 3, 'returnType': 'Dict' },
                        'trade/batch-orders': { 'cost': 1 / 15, 'returnType': 'Dict' },
                        'trade/cancel-order': { 'cost': 1 / 3, 'returnType': 'Dict' },
                        'trade/cancel-batch-orders': { 'cost': 1 / 15, 'returnType': 'Dict' },
                        'trade/amend-order': { 'cost': 1 / 3, 'returnType': 'Dict' },
                        'trade/amend-batch-orders': { 'cost': 1 / 150, 'returnType': 'Dict' },
                        'trade/close-position': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/fills-archive': { 'cost': 172800, 'returnType': 'Dict' }, // not documented
                        'trade/cancel-advance-algos': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'trade/easy-convert': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/one-click-repay': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/one-click-repay-v2': { 'cost': 20, 'returnType': 'Dict' },
                        'trade/mass-cancel': { 'cost': 4, 'returnType': 'Dict' },
                        'trade/cancel-all-after': { 'cost': 10, 'returnType': 'Dict' },
                        'trade/order-precheck': { 'cost': 4, 'returnType': 'Dict' },
                        'trade/order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/cancel-algos': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/amend-algos': { 'cost': 1, 'returnType': 'Dict' },
                        // asset
                        'asset/transfer': { 'cost': 5, 'returnType': 'Dict' },
                        'asset/withdrawal': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/withdrawal-lightning': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'asset/cancel-withdrawal': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'asset/convert-dust-assets': { 'cost': 10, 'returnType': 'Dict' },
                        'asset/monthly-statement': { 'cost': 1296000, 'returnType': 'Dict' }, // 20 req/month, 10/20*30*24*60*60 = 1296000
                        'asset/convert/estimate-quote': { 'cost': 50, 'returnType': 'Dict' },
                        'asset/convert/trade': { 'cost': 1, 'returnType': 'Dict' },
                        // account
                        'account/bills-history-archive': { 'cost': 72000, 'returnType': 'Dict' }, // 12 req/day
                        'account/set-position-mode': { 'cost': 4, 'returnType': 'Dict' },
                        'account/set-leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'account/position/margin-balance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/set-fee-type': { 'cost': 4, 'returnType': 'Dict' },
                        'account/set-greeks': { 'cost': 4, 'returnType': 'Dict' },
                        'account/set-isolated-mode': { 'cost': 4, 'returnType': 'Dict' },
                        'account/spot-manual-borrow-repay': { 'cost': 30, 'returnType': 'Dict' },
                        'account/set-auto-repay': { 'cost': 4, 'returnType': 'Dict' },
                        'account/quick-margin-borrow-repay': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'account/borrow-repay': { 'cost': 5 / 3, 'returnType': 'Dict' }, // not documented
                        'account/simulated_margin': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'account/position-builder': { 'cost': 10, 'returnType': 'Dict' },
                        'account/position-builder-graph': { 'cost': 50, 'returnType': 'Dict' },
                        'account/set-riskOffset-type': { 'cost': 2, 'returnType': 'Dict' },
                        'account/set-riskOffset-amt': { 'cost': 2, 'returnType': 'Dict' },
                        'account/activate-option': { 'cost': 4, 'returnType': 'Dict' },
                        'account/set-auto-loan': { 'cost': 4, 'returnType': 'Dict' },
                        'account/account-level-switch-preset': { 'cost': 4, 'returnType': 'Dict' },
                        'account/set-account-level': { 'cost': 4, 'returnType': 'Dict' },
                        'account/set-collateral-assets': { 'cost': 4, 'returnType': 'Dict' },
                        'account/mmp-reset': { 'cost': 4, 'returnType': 'Dict' },
                        'account/mmp-config': { 'cost': 50, 'returnType': 'Dict' },
                        'account/fixed-loan/borrowing-order': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'account/fixed-loan/amend-borrowing-order': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'account/fixed-loan/manual-reborrow': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'account/fixed-loan/repay-borrowing-order': { 'cost': 5, 'returnType': 'Dict' }, // not documented
                        'account/move-positions': { 'cost': 10, 'returnType': 'Dict' },
                        'account/set-auto-earn': { 'cost': 10, 'returnType': 'Dict' },
                        'account/set-settle-currency': { 'cost': 1, 'returnType': 'Dict' },
                        'account/set-trading-config': { 'cost': 20, 'returnType': 'Dict' },
                        'account/demo-adjust-balance': { 'cost': 20, 'returnType': 'Dict' }, // 3 requests per day but we don't use that weight for now, set to 20 to be safe
                        // subaccount
                        'asset/subaccount/transfer': { 'cost': 10, 'returnType': 'Dict' },
                        'account/subaccount/set-loan-allocation': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'users/subaccount/create-subaccount': { 'cost': 10, 'returnType': 'Dict' },
                        'users/subaccount/apikey': { 'cost': 10, 'returnType': 'Dict' },
                        'users/subaccount/modify-apikey': { 'cost': 10, 'returnType': 'Dict' },
                        'users/subaccount/subaccount-apikey': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'users/subaccount/delete-apikey': { 'cost': 10, 'returnType': 'Dict' },
                        'users/subaccount/set-transfer-out': { 'cost': 10, 'returnType': 'Dict' },
                        // grid trading
                        'tradingBot/grid/order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/copy-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/amend-algo-basic-param': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/amend-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/stop-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/close-position': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/cancel-close-order': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/order-instant-trigger': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/withdraw-income': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/compute-margin-balance': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/margin-balance': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/grid/min-investment': { 'cost': 1, 'returnType': 'Dict' }, // public
                        'tradingBot/grid/adjust-investment': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/create-signal': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/stop-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/margin-balance': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/amendTPSL': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/set-instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/close-position': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/sub-order': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/signal/cancel-sub-order': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/amend-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/stop-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/create': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/amend-order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/stop': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/orders/manual-buy': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/settings/reinvestment': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/settings/take-profit': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/margin/add': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/dca/margin/reduce': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/add-investment': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/amend-price-range': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/amend-recurring-amount': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/amend-recurring-time': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/pause': { 'cost': 1, 'returnType': 'Dict' },
                        'tradingBot/recurring/restart': { 'cost': 1, 'returnType': 'Dict' },
                        // earn
                        'finance/savings/purchase-redempt': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/savings/set-lending-rate': { 'cost': 5 / 3, 'returnType': 'Dict' },
                        'finance/staking-defi/purchase': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/redeem': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/cancel': { 'cost': 5, 'returnType': 'Dict' },
                        // eth staking
                        'finance/staking-defi/eth/purchase': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/eth/redeem': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/eth/cancel-redeem': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/purchase': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/redeem': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/staking-defi/sol/cancel-redeem': { 'cost': 5, 'returnType': 'Dict' },
                        'finance/flexible-loan/max-loan': { 'cost': 4, 'returnType': 'Dict' },
                        'finance/flexible-loan/adjust-collateral': { 'cost': 4, 'returnType': 'Dict' },
                        // copytrading
                        'copytrading/algo-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/close-subposition': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/set-instruments': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/amend-profit-sharing-ratio': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/first-copy-settings': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/amend-copy-settings': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/stop-copy-trading': { 'cost': 4, 'returnType': 'Dict' },
                        'copytrading/batch-set-leverage': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        // broker
                        'broker/nd/create-subaccount': { 'cost': 0.25, 'returnType': 'Dict' }, // not documented
                        'broker/nd/delete-subaccount': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'broker/nd/subaccount/apikey': { 'cost': 0.25, 'returnType': 'Dict' }, // not documented
                        'broker/nd/subaccount/modify-apikey': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'broker/nd/subaccount/delete-apikey': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'broker/nd/set-subaccount-level': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'broker/nd/set-subaccount-fee-rate': { 'cost': 4, 'returnType': 'Dict' }, // not documented
                        'broker/nd/set-subaccount-assets': { 'cost': 0.25, 'returnType': 'Dict' }, // not documented
                        'asset/broker/nd/subaccount-deposit-address': { 'cost': 1, 'returnType': 'Dict' }, // not documented
                        'asset/broker/nd/modify-subaccount-deposit-address': { 'cost': 5 / 3, 'returnType': 'Dict' }, // not documented
                        'broker/nd/rebate-per-orders': { 'cost': 36000, 'returnType': 'Dict' }, // not documented
                        'finance/sfp/dcd/quote': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'finance/sfp/dcd/order': { 'cost': 10, 'returnType': 'Dict' }, // not documented
                        'finance/sfp/dcd/trade': { 'cost': 10, 'returnType': 'Dict' },
                        'finance/sfp/dcd/redeem-quote': { 'cost': 10, 'returnType': 'Dict' },
                        'finance/sfp/dcd/redeem': { 'cost': 10, 'returnType': 'Dict' },
                        'broker/nd/report-subaccount-ip': { 'cost': 0.25, 'returnType': 'Dict' }, // not documented
                        'broker/dma/subaccount/apikey': { 'cost': 1 / 4, 'returnType': 'Dict' },
                        'broker/dma/trades': { 'cost': 36000, 'returnType': 'Dict' },
                        'broker/fd/rebate-per-orders': { 'cost': 36000, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
