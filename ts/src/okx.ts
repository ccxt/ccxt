...
export default class okx extends Exchange {
    ...
    async fetchOpenInterestHistory (symbol: string, timeframe = '1d', since: Int = undefined, limit: Int = undefined, params = {}): Promise<OpenInterest[]> {
        /**
         * @method
