...
export default class okx extends Exchange {
    ...
    async fetchBorrowRateHistories (codes = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @param {object} [params] extra parameters specific to the okx api endpoint
         * @returns {object} a dictionary of [borrow rate structures]{https://docs.ccxt.com/#/?id=borrow-rate-structure} indexed by the market symbol
         */
        await this.loadMarkets ();
        const request = {
            // 'ccy': currency['id'],
    ...
    async fetchBorrowInterest (code: Str = undefined, symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @param {string} [params.marginMode] 'cross' or 'isolated'
         * @returns {object[]} An list of [borrow interest structures]{https://docs.ccxt.com/#/?id=borrow-interest-structure}
         */
        await this.loadMarkets ();
        let marginMode = undefined;
    ...
    async fetchUnderlyingAssets (params = {}) {
         ...
         * @returns {object[]} a list of [underlying assets]{https://docs.ccxt.com/#/?id=underlying-assets-structure}
         */
        await this.loadMarkets ();
