...
export default class okx extends Exchange {
    ...
    handleMarketTypeAndParams (methodName: string, market: Market = undefined, params: Dict = {}, defaultValue: any = undefined): any {
    ...
    async fetchDepositAddress (code: string, params = {}): Promise<DepositAddress> {
        ...
        const response = await this.fetchDepositAddressesByNetwork (code, params) as any;
    ...
    parseDepositWithdrawFees (response: any, codes: Strings = undefined, currencyIdKey: any = undefined) {
        //
        // [
        //   {
        //       "canDep": true,
