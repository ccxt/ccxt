...
export default class kucoin extends Exchange {
    ...
    sign (path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (isPrivate || isFuturePrivate) {
            ...
            if (apiKeyVersion === '2') {
                const passphrase = this.hmac (this.encode (this.password), this.encode (this.secret), Hmac.Sha256, Digest.Base64);
            ...
            if ((partnerId !== undefined) && (partnerSecret !== undefined)) {
                ...
                const partnerSignature = this.hmac (this.encode (partnerPayload), this.encode (partnerSecret), Hmac.Sha256, Digest.Base64);
