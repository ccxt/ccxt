        ...
        return this.deepExtend (super.describe (), {
            ...
            'exceptions': {
                ...
                'exact': {
                    ...
                    'api-not-support-temp-addr': PermissionDenied, // {"status":"error","err-code":"api-not-support-temp-addr","err-msg":"API withdrawal does not support temporary addresses","data":null} // the user has to add the withdrawal address exempt for API withdrawals with the exchange website first
            ...
            'options': {
                ...
                'networks': {
                    ...
                    'ERC20': 'ERC20',
                    'ETH': 'ERC20ETH', // 'ERC20ETH' is used by houbi only for ETH coin
                    'ETC': 'ETC',
                    'ETHW': 'ETHW',
                    'FILECOIN': 'FIL',
