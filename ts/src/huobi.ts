        ...
        return this.deepExtend (super.describe (), {
            ...
            'options': {
                ...
                'networks': {
                    ...
                    'BSC': 'BEP20',
                    'ERC20': 'ERC20',
                    'ETH': 'ERC20', // 'ERC20ETH' is used by houbi only for ETH coin, not 'ERC20' //  todo: after unification
                    ...
                    'TRC20': 'TRC20',
                    'TRX': 'TRC20', // todo: after unification, change to TRX network-name is only used for TRX coin
                    'BTC': 'BTC',
                    'BITCOIN': 'BTC',
                    'ARBITRUM': 'ARB',
                    'ARB': 'ARB',
