...
export default class huobi extends Exchange {
    ...
    async createSpotOrder (symbol: string, type: string, side: string, amount, price = undefined, params = {}) {
        /**
         * @ignore
         * @method
        ...
        params = this.omit (params, [ 'stopPrice', 'stop-price', 'clientOrderId', 'client-order-id', 'postOnly' ]);
    ...
    async createContractOrder (symbol: string, type: string, side: string, amount, price = undefined, params = {}) {
        /**
         * @ignore
         * @method
