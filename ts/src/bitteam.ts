            ...
            'api': {
                'public': {
                    'get': {
                        ...
                        'trade/api/login-confirmation': 1,
                    ...
                    'post': {
                        'trade/api/login-oauth': 1,
                        'trade/api/reset-password': 1, // not unified looks like a private endpoint
                    },
                },
                'private': {
                    'get': {
                        'trade/api/address/wallets': 1,
                        'trade/api/ccxt/balance': 1,
                        'trade/api/ccxt/order/{id}': 1,
                        'trade/api/ccxt/ordersOfUser': 1,
                        'trade/api/ccxt/tradesOfUser': 1,
                        'trade/api/discount': 1,
                        'trade/api/discounts': 1,
                        'trade/api/forgot-2fa': 1,
                        'trade/api/get-options': 1,
                        'trade/api/get-session-status': 1,
                        'trade/api/get-user-data': 1,
                        'trade/api/ordersByUser': 1,
                        'trade/api/phone/checkValidation': 1,
                        'trade/api/rate-wallbtc': 1,
                        'trade/api/sumsub/create': 1,
                        'trade/api/sumsub/data': 1,
                        'trade/api/sumsub/obtain': 1,
                        'trade/api/sumsub/status': 1,
                        'trade/api/tradesByUser': 1,
                        'trade/api/transactionsByUser': 1,
                        'trade/api/transactionsOfUser': 1,
                        'trade/api/transaction/{id}': 1,
                        'trade/api/user/api-keys': 1,
                        'trade/api/user/stats': 1,
                        'trade/api/user/stats/all': 1,
                        'trade/api/user/stats/ref': 1,
                        'trade/api/user/stats/ref/table': 1, // not unified returns 401000
                    },
                    'post': {
                        'trade/api/access-check': 1,
                        'trade/api/all-orders/cancel': 1,
                        'trade/api/before-transaction-email': 1,
                        'trade/api/ccxt/cancel-all-order': 1,
                        'trade/api/ccxt/cancelorder': 1,
                        'trade/api/ccxt/ordercreate': 1,
                        'trade/api/confirm-email': 1,
                        'trade/api/disable-2fa': 1,
                        'trade/api/enable-2fa': 1,
                        'trade/api/logout': 1,
                        'trade/api/order/cancel': 1,
                        'trade/api/order/conditional/create': 1,
                        'trade/api/order/create': 1,
                        'trade/api/p2p/create-transaction': 1,
                        'trade/api/p2p/get-balance': 1,
                        'trade/api/p2p/set-token': 1,
                        'trade/api/password-change': 1,
                        'trade/api/pay-build': 1,
                        'trade/api/phone/add': 1,
                        'trade/api/refresh-logout': 1,
                        'trade/api/refresh-token': 1,
                        'trade/api/register-wallbtc': 1,
                        'trade/api/send-email': 1,
                        'trade/api/set-2fa': 1,
                        'trade/api/set-options': 1,
                        'trade/api/user/api-keys/redeem': 1,
                        'trade/api/user/api-keys/reset': 1,
                        'trade/api/user/api-keys/update': 1,
                        'trade/api/user/favourite/add-pair': 1,
                        'trade/api/user/favourite/remove-pair': 1,
                        'trade/api/user/pay-fee-btt': 1,
                        'trade/api/webhook/deposit': 1,
