    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                ...
                'public': {
                    'get': {
                        'v1/symbols': { 'cost': 5, 'returnType': 'List' },
                        'v1/symbols/details/{symbol}': { 'cost': 5, 'returnType': 'Dict' },
                        'v1/network/{token}': { 'cost': 5, 'returnType': 'Dict' },
                        'v1/staking/rates': { 'cost': 5, 'returnType': 'Dict' },
                        'v1/pubticker/{symbol}': { 'cost': 5, 'returnType': 'Dict' },
                        'v1/feepromos': { 'cost': 5, 'returnType': 'Dict' },
                        ...
                        'v1/book/{symbol}': { 'cost': 5, 'returnType': 'Dict' },
                        'v1/earn/rates': { 'cost': 5, 'returnType': 'Dict' },
                        'v2/derivatives/candles/{symbol}/{time_frame}': { 'cost': 5, 'returnType': 'List' },
                        'v2/fxrate/{symbol}/{timestamp}': { 'cost': 5, 'returnType': 'Dict' },
                        'v1/riskstats/{symbol}': { 'cost': 5, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        'v1/perpetuals/fundingpaymentreport/records.xlsx': { 'cost': 1, 'returnType': 'string' },
                    },
                    'post': {
                        'v1/staking/unstake': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/staking/stake': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/staking/rewards': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/staking/history': { 'cost': 1, 'returnType': 'List' },
                        'v1/order/new': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/order/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/wrap/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/order/cancel/session': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/order/cancel/all': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/order/status': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/orders': { 'cost': 1, 'returnType': 'List' },
                        'v1/mytrades': { 'cost': 1, 'returnType': 'List' },
                        'v1/notionalvolume': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/tradevolume': { 'cost': 1, 'returnType': 'List' },
                        'v1/clearing/new': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/status': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/confirm': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/balances': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/balances/staking': { 'cost': 1, 'returnType': 'List' },
                        'v1/notionalbalances/{currency}': { 'cost': 1, 'returnType': 'List' },
                        'v1/transfers': { 'cost': 1, 'returnType': 'List' },
                        'v1/addresses/{network}': { 'cost': 1, 'returnType': 'List' },
                        'v1/deposit/{network}/newAddress': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/deposit/{currency}/newAddress': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/withdraw/{currency}': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'v1/approvedAddresses/{network}/request': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/approvedAddresses/account/{network}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/approvedAddresses/{network}/remove': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/account': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/account/create': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/account/list': { 'cost': 1, 'returnType': 'List' },
                        'v1/heartbeat': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/roles': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/custodyaccountfees': { 'cost': 1, 'returnType': 'List' },
                        'v1/withdraw/{currencyCodeLowerCase}/feeEstimate': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/payments/addbank/cad': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/margin/account': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/margin/rates': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/margin/order/preview': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/list': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/broker/list': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/broker/new': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/clearing/trades': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/instant/quote': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/instant/execute': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/account/rename': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/oauth/revokeByToken': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/margin': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/perpetuals/fundingPayment': { 'cost': 1, 'returnType': 'List' },
                        'v1/perpetuals/fundingpaymentreport/records.json': { 'cost': 1, 'returnType': 'List' },
                        'v1/positions': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
