...
import type { Balances, Currencies, Currency, CurrencyInterface, Dict, Dictionary, Int, List, Market, NullableDict, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFees, Transaction, int, DepositAddress, OrderBooks, DepositWithdrawFee, DepositWithdrawFees } from './base/types.js';
...
export default class hollaex extends Exchange {
    ...
    override parseTickers (tickers, symbols: Strings = undefined, params = {}): Tickers {
        const result: Dict = {};
