...
export default class hollaex extends Exchange {
     ...
     * @param symbols not used by hollaex fetchOrderBooks ()
     * @param [limit] not used by hollaex fetchOrderBooks ()
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbol
     */
     ...
     * @param symbol unified symbol of the market to fetch the order book for
     * @param [limit] the maximum amount of order book entries to return
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns A dictionary of [order book structures]{@link https://docs.ccxt.com/#/?id=order-book-structure} indexed by market symbols
     */
     ...
     * @param symbol unified symbol of the market to fetch the ticker for
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a [ticker structure]{@link https://docs.ccxt.com/#/?id=ticker-structure}
     */
     ...
     * @param symbols unified symbols of the markets to fetch the ticker for, all market tickers are returned if not assigned
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a dictionary of [ticker structures]{@link https://docs.ccxt.com/#/?id=ticker-structure}
     */
     ...
     * @param symbol unified symbol of the market to fetch trades for
     * @param [since] timestamp in ms of the earliest trade to fetch
     * @param [limit] the maximum amount of trades to fetch
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [trade structures]{@link https://docs.ccxt.com/#/?id=public-trades}
     */
     ...
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a dictionary of [fee structures]{@link https://docs.ccxt.com/#/?id=fee-structure} indexed by market symbols
     */
     ...
     * @param symbol unified symbol of the market to fetch OHLCV data for
     * @param timeframe the length of time each candle represents
     * @param [since] timestamp in ms of the earliest candle to fetch
     * @param [limit] the maximum amount of candles to fetch
     * @param [params] extra parameters specific to the exchange API endpoint
     ...
     * @param id order id
     * @param symbol not used by hollaex fetchOpenOrder ()
     * @param [params] extra parameters specific to the exchange API endpoint
     ...
     * @param symbol unified market symbol
     * @param [since] the earliest time in ms to fetch open orders for
     * @param [limit] the maximum number of  open orders structures to retrieve
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
     */
     ...
     * @see https://apidocs.hollaex.com/#get-all-orders
     * @param symbol unified market symbol of the market orders were made in
     ...
     * @see https://apidocs.hollaex.com/#get-order
     * @param id
     * @param symbol unified symbol of the market the order was made in
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
     */
     ...
     * @param symbol unified symbol of the market to create an order in
     * @param type 'market' or 'limit'
     * @param side 'buy' or 'sell'
     * @param amount how much of currency you want to trade in units of base currency
     * @param [price] the price at which the order is to be fulfilled, in units of the quote currency, ignored in market orders
     * @param [params] extra parameters specific to the exchange API endpoint
     * @param [params.triggerPrice] the price at which a trigger order is triggered at
     * @param [params.postOnly] if true, the order will only be posted to the order book and not executed immediately
     * @returns an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
     */
     ...
     * @param symbol unified market symbol of the market to cancel orders in
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
     */
     ...
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [trade structures]{@link https://docs.ccxt.com/#/?id=trade-structure}
     */
     ...
     * @param codes list of unified currency codes, default is undefined
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [address structures]{@link https://docs.ccxt.com/#/?id=address-structure}
     */
     ...
     * @param code unified currency code
     * @param [since] the earliest time in ms to fetch deposits for
     * @param [limit] the maximum number of deposits structures to retrieve
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
     */
     ...
     * @param code unified currency code of the currency withdrawn, default is undefined
     * @param [params] extra parameters specific to the exchange API endpoint
     ...
     * @see https://apidocs.hollaex.com/#get-withdrawals
     * @param code unified currency code
     * @param [since] the earliest time in ms to fetch withdrawals for
     * @param [limit] the maximum number of withdrawals structures to retrieve
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [transaction structures]{@link https://docs.ccxt.com/#/?id=transaction-structure}
     */
     ...
     * @see https://apidocs.hollaex.com/#constants
     * @param codes list of unified currency codes
     * @param [params] extra parameters specific to the exchange API endpoint
     * @returns a list of [fee structures]{@link https://docs.ccxt.com/#/?id=fee-structure}
     */
