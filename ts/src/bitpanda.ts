            ...
            'api': {
                ...
                'private': {
                    'get': [
                        ...
                        'account/funding/payout-accounts',
                        'account/funding/deposit/details/{transfer_method_type}/{currency_code}',
                        'account/funding/transactions',
                        'account/funding/transactions/{transaction_id}',
                    ],
                    'post': [
                        'account/orders',
                        'account/orders/cancel-all-after',
