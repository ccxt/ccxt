...
export default class binance extends Exchange {
    ...
    async futuresTransfer (code: string, amount, type, params = {}) {
         ...
         * @returns {object} a [transfer structure]{https://docs.ccxt.com/#/?id=futures-transfer-structure}
         */
        if ((type < 1) || (type > 4)) {
    ...
    async fetchFundingRates (symbols: Strings = undefined, params = {}) {
         ...
         * @param {object} [params] extra parameters specific to the binance api endpoint
         * @returns {object} a dictionary of [funding rates structures]{https://docs.ccxt.com/#/?id=funding-rates-structure}, indexe by market symbols
         */
        await this.loadMarkets ();
        symbols = this.marketSymbols (symbols);
        let method = undefined;
    ...
    async fetchLeverageTiers (symbols: Strings = undefined, params = {}) {
         ...
         * @param {string[]|undefined} symbols list of unified market symbols
         * @param {object} [params] extra parameters specific to the binance api endpoint
         * @returns {object} a dictionary of [leverage tiers structures]{https://docs.ccxt.com/#/?id=leverage-tiers-structure}, indexed by market symbols
         */
        await this.loadMarkets ();
    ...
    async fetchFundingHistory (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @param {object} [params] extra parameters specific to the binance api endpoint
         * @returns {object} a [funding history structure]{https://docs.ccxt.com/#/?id=funding-history-structure}
         */
        await this.loadMarkets ();
        let market = undefined;
        let method = undefined;
    ...
    async fetchSettlementHistory (symbol: Str = undefined, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @returns {object[]} a list of [settlement history objects]{https://docs.ccxt.com/#/?id=settlement-history-structure}
         */
        await this.loadMarkets ();
    ...
    async fetchBorrowRateHistory (code: string, since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @param {object} [params] extra parameters specific to the exchange api endpoint
         * @returns {object[]} an array of [borrow rate structures]{https://docs.ccxt.com/#/?id=borrow-rate-structure}
         */
        await this.loadMarkets ();
        if (limit === undefined) {
            limit = 93;
    ...
    async fetchOpenInterestHistory (symbol: string, timeframe = '5m', since: Int = undefined, limit: Int = undefined, params = {}) {
         ...
         * @returns {object} an array of [open interest structure]{https://docs.ccxt.com/#/?id=open-interest-structure}
         */
        if (timeframe === '1m') {
    ...
    async fetchGreeks (symbol: string, params = {}): Promise<Greeks> {
         ...
         * @param {object} [params] extra parameters specific to the binance api endpoint
         * @returns {object} a [greeks structure]{https://docs.ccxt.com/#/?id=greeks-structure}
         */
        await this.loadMarkets ();
        const market = this.market (symbol);
        const request = {
