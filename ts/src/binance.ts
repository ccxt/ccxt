...
export default class binance extends Exchange {
    ...
    async fetchMyDustTrades (symbol: string = undefined, since: any = undefined, limit: any = undefined, params = {}) {
        /**
         * @method
    ...
    async fetchTransactionFees (codes = undefined, params = {}) {
         ...
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {[object]} a list of [fee structures]{@link https://docs.ccxt.com/#/README?id=fee-structure}
         */
        await this.loadMarkets ();
        const response = await (this as any).sapiGetCapitalConfigGetall (params);
        //
    ...
    async futuresTransfer (code, amount, type, params = {}) {
         ...
         * @returns {object} a [transfer structure]{@link https://docs.ccxt.com/#/README?id=futures-transfer-structure}
         */
        if ((type < 1) || (type > 4)) {
    ...
    async fetchFundingRates (symbols: string[] = undefined, params = {}) {
         ...
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {object} a dictionary of [funding rates structures]{@link https://docs.ccxt.com/#/README?id=funding-rates-structure}, indexe by market symbols
         */
        await this.loadMarkets ();
        symbols = this.marketSymbols (symbols);
        let method = undefined;
    ...
    async fetchLeverageTiers (symbols: string[] = undefined, params = {}) {
         ...
         * @param {[string]|undefined} symbols list of unified market symbols
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {object} a dictionary of [leverage tiers structures]{@link https://docs.ccxt.com/#/README?id=leverage-tiers-structure}, indexed by market symbols
         */
        await this.loadMarkets ();
    ...
    async fetchFundingHistory (symbol: string = undefined, since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {object} a [funding history structure]{@link https://docs.ccxt.com/#/README?id=funding-history-structure}
         */
        await this.loadMarkets ();
        let market = undefined;
        let method = undefined;
    ...
    async fetchSettlementHistory (symbol: string = undefined, since: any = undefined, limit: any = undefined, params = {}) {
        /**
         * @method
    ...
    async fetchBorrowRate (code, params = {}) {
         ...
         * @param {string} code unified currency code
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {object} a [borrow rate structure]{@link https://docs.ccxt.com/#/README?id=borrow-rate-structure}
         */
        await this.loadMarkets ();
        const currency = this.currency (code);
        const request = {
    ...
    async fetchBorrowRateHistory (code, since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @param {int|undefined} limit the maximum number of [borrow rate structures]{@link https://docs.ccxt.com/#/README?id=borrow-rate-structure} to retrieve
         * @param {object} params extra parameters specific to the exchange api endpoint
         * @returns {[object]} an array of [borrow rate structures]{@link https://docs.ccxt.com/#/README?id=borrow-rate-structure}
         */
        await this.loadMarkets ();
        if (limit === undefined) {
            limit = 93;
    ...
    async fetchBorrowInterest (code: string = undefined, symbol: string = undefined, since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {[object]} a list of [borrow interest structures]{@link https://docs.ccxt.com/#/README?id=borrow-interest-structure}
         */
        await this.loadMarkets ();
        const request = {};
        let market = undefined;
    ...
    async repayMargin (code, amount, symbol: string = undefined, params = {}) {
         ...
         * @param {object} params extra parameters specific to the binance api endpoint
         * @returns {object} a [margin loan structure]{@link https://docs.ccxt.com/#/README?id=margin-loan-structure}
         */
    ...
    async fetchOpenInterestHistory (symbol, timeframe = '5m', since: any = undefined, limit: any = undefined, params = {}) {
         ...
         * @returns {object} an array of [open interest history structure]{@link https://docs.ccxt.com/#/README?id=interest-history-structure}
         */
        if (timeframe === '1m') {
