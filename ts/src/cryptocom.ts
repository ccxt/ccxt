        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'base': {
                    'public': {
                        'get': {
                            'v1/public/get-announcements': { 'cost': 1, 'returnType': 'Dict' }, // no description of rate limit
                        },
                    },
                },
                'v1': {
                    'public': {
                        'get': {
                            'public/auth': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'public/get-instruments': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'public/get-book': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-candlestick': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-trades': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-tickers': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-valuations': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-expired-settlement-price': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'public/get-insurance': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-announcements': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-risk-parameters': { 'cost': 1, 'returnType': 'Dict' },
                        },
                        'post': {
                            'public/staking/get-conversion-rate': { 'cost': 2, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'post': {
                            'private/set-cancel-on-disconnect': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-cancel-on-disconnect': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/user-balance': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/user-balance-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-positions': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/create-order': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/amend-order': { 'cost': 4 / 3, 'returnType': 'Dict' }, // no description of rate limit
                            'private/create-order-list': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/cancel-order': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/cancel-order-list': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/cancel-all-orders': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/close-position': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-history': { 'cost': 100, 'returnType': 'Dict' },
                            'private/get-open-orders': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-detail': { 'cost': 1 / 3, 'returnType': 'Dict' },
                            'private/get-trades': { 'cost': 100, 'returnType': 'Dict' },
                            'private/change-account-leverage': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-transactions': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/create-subaccount-transfer': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-subaccount-balances': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-list': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/create-withdrawal': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-currency-networks': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-deposit-address': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-accounts': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-withdrawal-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-deposit-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-fee-rate': { 'cost': 2, 'returnType': 'Dict' },
                            'private/get-instrument-fee-rate': { 'cost': 2, 'returnType': 'Dict' },
                            'private/fiat/fiat-deposit-info': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/fiat/fiat-deposit-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/fiat/fiat-withdraw-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/fiat/fiat-create-withdraw': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/fiat/fiat-transaction-quota': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/fiat/fiat-transaction-limit': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/fiat/fiat-get-bank-accounts': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/staking/stake': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/unstake': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-staking-position': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-staking-instruments': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-open-stake': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-stake-history': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-reward-history': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/convert': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-open-convert': { 'cost': 2, 'returnType': 'Dict' },
                            'private/staking/get-convert-history': { 'cost': 2, 'returnType': 'Dict' },
                            'private/create-isolated-margin-transfer': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/change-isolated-margin-leverage': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        },
                    },
                },
                'v2': {
                    'public': {
                        'get': {
                            'public/auth': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-instruments': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-book': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-candlestick': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'public/get-trades': { 'cost': 1, 'returnType': 'Dict' },
                    ...
                    'private': {
                        'post': {
                            ...
                            'private/get-deposit-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-deposit-address': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/export/create-export-request': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/export/get-export-requests': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/export/download-export-output': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-account-summary': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/create-order': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/cancel-order': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/cancel-all-orders': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/create-order-list': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-open-orders': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-detail': { 'cost': 1 / 3, 'returnType': 'Dict' },
                            'private/get-trades': { 'cost': 100, 'returnType': 'Dict' },
                            'private/get-accounts': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-subaccount-balances': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/create-subaccount-transfer': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/otc/get-otc-user': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/otc/get-instruments': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/otc/request-quote': { 'cost': 100, 'returnType': 'Dict' },
                            'private/otc/accept-quote': { 'cost': 100, 'returnType': 'Dict' },
                            'private/otc/get-quote-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/otc/get-trade-history': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/otc/create-order': { 'cost': 10 / 3, 'returnType': 'Dict' },
                        },
                    },
                },
                'derivatives': {
                    ...
                    'private': {
                        'post': {
                            ...
                            'private/cancel-all-orders': { 'cost': 2 / 3, 'returnType': 'Dict' },
                            'private/close-position': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/convert-collateral': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-history': { 'cost': 100, 'returnType': 'Dict' },
                            'private/get-open-orders': { 'cost': 10 / 3, 'returnType': 'Dict' },
                            'private/get-order-detail': { 'cost': 1 / 3, 'returnType': 'Dict' },
                            'private/get-trades': { 'cost': 100, 'returnType': 'Dict' },
