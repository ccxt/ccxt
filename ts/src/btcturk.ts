...
import _Exchange from './abstract/btcturk.js';
...
// @ts-ignore
export default class btcturk extends _Exchange {
    describe () {
    ...
    async fetchOHLCV (symbol, timeframe = '1h', since: any = undefined, limit: any = undefined, params = {}) {
        /**
         * @method
