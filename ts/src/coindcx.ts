...
export default class coindcx extends Exchange {
            ...
            'api': {
                ...
                'private': {
                    'post': {
                        ...
                        'exchange/v1/orders/active_orders': 6.66,
                        'exchange/v1/orders/trade_history': 1,
                        'exchange/v1/orders/active_orders_count': 1,
                        'exchange/v1/orders/cancel_all': 66.66,
                        'exchange/v1/orders/cancel_by_ids': 6.66,
                        ...
                        'exchange/v1/derivatives/futures/positions/add_margin': 1,
                        'exchange/v1/derivatives/futures/positions/remove_margin': 1,
    ...
    async test () {
        return await this.fetchPositions (['ETH/USDT:USDT'])
    }
    ...
    handleMarketTypeMarginAndParams(methodName, market = undefined, params = {}, defaultValue = undefined) {
    ...
    async editSpotOrder(id, symbol, type, side, amount = undefined, price = undefined, params = {}) {
        /**
         * @method
    ...
    async editMarginOrder(id, symbol, type, side, amount = undefined, price = undefined, params = {}) {
        /**
         * @method
         * @name coindcx#editSpotOrder
         * @description edit a trade order
    ...
    parsePosition(position, market = undefined) {
        ...
        return this.safePosition({
            ...
            'percentage': undefined,
            'contracts': this.parseNumber(baseAmount),
