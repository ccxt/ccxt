    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'web': {
                    'get': {
                        'v1/healthcheck': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'v1': {
                    'public': {
                        'get': {
                            ...
                            'symbols': { 'cost': 1 } as EndpointSpec<Dict>,
                    ...
                    'private': {
                        'post': {
                            ...
                            'account/executed_history/all': { 'cost': 1 } as EndpointSpec<Dict>,
                ...
                'v2': {
                    'public': {
                        'get': {
                            ...
                            'depth/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trades/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
                'v4': {
                    'public': {
                        'get': {
                            'assets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'collateral/markets': { 'cost': 1 } as EndpointSpec<Dict>,
                            'fee': { 'cost': 1 } as EndpointSpec<Dict>,
                            'funding-history/{market}': { 'cost': 1 } as EndpointSpec<List>,
                            'orderbook/depth/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orderbook/{market}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'ticker': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trades/{market}': { 'cost': 1 } as EndpointSpec<List>,
                            'time': { 'cost': 1 } as EndpointSpec<Dict>,
                            'ping': { 'cost': 1 } as EndpointSpec<List>,
                            'markets': { 'cost': 1 } as EndpointSpec<List>,
                            'futures': { 'cost': 1 } as EndpointSpec<Dict>,
                            'platform/status': { 'cost': 1 } as EndpointSpec<Dict>,
                            'mining-pool': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'post': {
                            'collateral-account/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'collateral-account/balance-summary': { 'cost': 1 } as EndpointSpec<List>,
                            'collateral-account/positions/history': { 'cost': 1 } as EndpointSpec<List>,
                            'collateral-account/leverage': { 'cost': 1 } as EndpointSpec<Dict>,
                            'collateral-account/positions/open': { 'cost': 1 } as EndpointSpec<List>,
                            'collateral-account/summary': { 'cost': 1 } as EndpointSpec<Dict>,
                            'collateral-account/funding-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/address': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/create-new-address': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/codes': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/codes/apply': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/codes/my': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/codes/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/fiat-deposit-url': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/withdraw': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/withdraw-pay': { 'cost': 1 } as EndpointSpec<List>,
                            'main-account/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/smart/plans': { 'cost': 1 } as EndpointSpec<List>,
                            'main-account/smart/investment': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/smart/investment/close': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/smart/investments': { 'cost': 1 } as EndpointSpec<Dict>,
                            'main-account/fee': { 'cost': 1 } as EndpointSpec<List>,
                            'main-account/smart/interest-payment-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade-account/balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade-account/executed-history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade-account/order/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade-account/order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/collateral/limit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/collateral/market': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/collateral/stop-limit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/collateral/trigger-market': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/collateral/bulk': { 'cost': 1 } as EndpointSpec<List>,
                            'order/new': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/market': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/stock_market': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/stop_limit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/stop_market': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/cancel/all': { 'cost': 1 } as EndpointSpec<List>,
                            'order/kill-switch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/kill-switch/status': { 'cost': 1 } as EndpointSpec<List>,
                            'order/bulk': { 'cost': 1 } as EndpointSpec<List>,
                            'order/modify': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/conditional-cancel': { 'cost': 1 } as EndpointSpec<List>,
                            'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'oco-orders': { 'cost': 1 } as EndpointSpec<List>,
                            'order/collateral/oco': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/oco-cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/oto-cancel': { 'cost': 1 } as EndpointSpec<List>,
                            'profile/websocket_token': { 'cost': 1 } as EndpointSpec<Dict>,
                            'convert/estimate': { 'cost': 1 } as EndpointSpec<Dict>,
                            'convert/confirm': { 'cost': 1 } as EndpointSpec<Dict>,
                            'convert/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/create': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/delete': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/edit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/list': { 'cost': 1 } as EndpointSpec<List>,
                            'sub-account/transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/block': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/unblock': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/balances': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/transfer/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/create': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/edit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/delete': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/reset': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/ip-address/list': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/ip-address/create': { 'cost': 1 } as EndpointSpec<Dict>,
                            'sub-account/api-key/ip-address/delete': { 'cost': 1 } as EndpointSpec<Dict>,
                            'mining/rewards': { 'cost': 1 } as EndpointSpec<Dict>,
                            'market/fee': { 'cost': 1 } as EndpointSpec<Dict>,
                            'conditional-orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
