                ...
                'v1': {
                    ...
                    'private': {
                        'post': {
                            ...
                            'account/executed_history/all': 1,
                            'account/order': 1,
                        },
                    },
                },
                ...
                'v4': {
                    ...
                    'private': {
                        'post': {
                            ...
                            'main-account/codes': 1,
                            'main-account/codes/apply': 1,
                            'main-account/codes/my': 1,
                            'main-account/codes/history': 1,
                            ...
                            'main-account/withdraw-pay': 1,
                            'main-account/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/smart/plans': 1,
                            'main-account/smart/investment': 1,
                            'main-account/smart/investment/close': 1,
                            'main-account/smart/investments': 1,
                            'main-account/fee': 1,
                            'main-account/smart/interest-payment-history': 1,
                            ...
                            'order/kill-switch': 1,
                            'order/kill-switch/status': 1,
                            'order/bulk': 1,
                            'order/modify': { 'cost': 1, 'returnType': 'Dict' },
                            'order/conditional-cancel': 1,
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'oco-orders': 1,
                            'order/collateral/oco': 1,
                            'order/oco-cancel': 1,
                            'order/oto-cancel': 1,
                            ...
                            'sub-account/create': 1,
                            'sub-account/delete': 1,
                            'sub-account/edit': 1,
                            'sub-account/list': { 'cost': 1, 'returnType': 'List' },
                            'sub-account/transfer': 1,
                            'sub-account/block': 1,
                            'sub-account/unblock': 1,
                            'sub-account/balances': 1,
                            'sub-account/transfer/history': 1,
                            'sub-account/api-key/create': 1,
                            'sub-account/api-key/edit': 1,
                            'sub-account/api-key/delete': 1,
                            'sub-account/api-key/list': 1,
                            'sub-account/api-key/reset': 1,
                            'sub-account/api-key/ip-address/list': 1,
                            'sub-account/api-key/ip-address/create': 1,
                            'sub-account/api-key/ip-address/delete': 1,
                            'mining/rewards': 1,
                            'market/fee': 1,
                            'conditional-orders': 1,
                        },
                    },
                },
            },
