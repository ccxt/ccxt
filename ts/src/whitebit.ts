                ...
                'v1': {
                    'public': {
                        'get': {
                            ...
                            'symbols': { 'cost': 1, 'returnType': 'Dict' },
                    ...
                    'private': {
                        'post': {
                            ...
                            'account/executed_history/all': { 'cost': 1, 'returnType': 'Dict' },
                ...
                'v2': {
                    'public': {
                        'get': {
                            ...
                            'depth/{market}': { 'cost': 1, 'returnType': 'Dict' },
                            'trades/{market}': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
                'v4': {
                    'public': {
                        'get': {
                            'assets': { 'cost': 1, 'returnType': 'Dict' },
                            'collateral/markets': { 'cost': 1, 'returnType': 'Dict' },
                            'fee': { 'cost': 1, 'returnType': 'Dict' },
                            'funding-history/{market}': { 'cost': 1, 'returnType': 'List' },
                            'orderbook/depth/{market}': { 'cost': 1, 'returnType': 'Dict' },
                            'orderbook/{market}': { 'cost': 1, 'returnType': 'Dict' },
                            'ticker': { 'cost': 1, 'returnType': 'Dict' },
                            'trades/{market}': { 'cost': 1, 'returnType': 'List' },
                            'time': { 'cost': 1, 'returnType': 'Dict' },
                            'ping': { 'cost': 1, 'returnType': 'List' },
                            'markets': { 'cost': 1, 'returnType': 'List' },
                            'futures': { 'cost': 1, 'returnType': 'Dict' },
                            'platform/status': { 'cost': 1, 'returnType': 'Dict' },
                            'mining-pool': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                    'private': {
                        'post': {
                            'collateral-account/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'collateral-account/balance-summary': { 'cost': 1, 'returnType': 'List' },
                            'collateral-account/positions/history': { 'cost': 1, 'returnType': 'List' },
                            'collateral-account/leverage': { 'cost': 1, 'returnType': 'Dict' },
                            'collateral-account/positions/open': { 'cost': 1, 'returnType': 'List' },
                            'collateral-account/summary': { 'cost': 1, 'returnType': 'Dict' },
                            'collateral-account/funding-history': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/address': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/create-new-address': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/codes': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/codes/apply': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/codes/my': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/codes/history': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/fiat-deposit-url': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/history': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/withdraw': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/withdraw-pay': { 'cost': 1, 'returnType': 'List' },
                            'main-account/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/smart/plans': { 'cost': 1, 'returnType': 'List' },
                            'main-account/smart/investment': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/smart/investment/close': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/smart/investments': { 'cost': 1, 'returnType': 'Dict' },
                            'main-account/fee': { 'cost': 1, 'returnType': 'List' },
                            'main-account/smart/interest-payment-history': { 'cost': 1, 'returnType': 'Dict' },
                            'trade-account/balance': { 'cost': 1, 'returnType': 'Dict' },
                            'trade-account/executed-history': { 'cost': 1, 'returnType': 'Dict' },
                            'trade-account/order/history': { 'cost': 1, 'returnType': 'Dict' },
                            'trade-account/order': { 'cost': 1, 'returnType': 'Dict' },
                            'order/collateral/limit': { 'cost': 1, 'returnType': 'Dict' },
                            'order/collateral/market': { 'cost': 1, 'returnType': 'Dict' },
                            'order/collateral/stop-limit': { 'cost': 1, 'returnType': 'Dict' },
                            'order/collateral/trigger-market': { 'cost': 1, 'returnType': 'Dict' },
                            'order/collateral/bulk': { 'cost': 1, 'returnType': 'List' },
                            'order/new': { 'cost': 1, 'returnType': 'Dict' },
                            'order/market': { 'cost': 1, 'returnType': 'Dict' },
                            'order/stock_market': { 'cost': 1, 'returnType': 'Dict' },
                            'order/stop_limit': { 'cost': 1, 'returnType': 'Dict' },
                            ...
                            'order/conditional-cancel': { 'cost': 1, 'returnType': 'List' },
                            'orders': { 'cost': 1, 'returnType': 'Dict' },
                            'oco-orders': { 'cost': 1, 'returnType': 'List' },
                            'order/collateral/oco': { 'cost': 1, 'returnType': 'Dict' },
                            'order/oco-cancel': { 'cost': 1, 'returnType': 'Dict' },
                            'order/oto-cancel': { 'cost': 1, 'returnType': 'List' },
                            'profile/websocket_token': { 'cost': 1, 'returnType': 'Dict' },
                            'convert/estimate': { 'cost': 1, 'returnType': 'Dict' },
                            'convert/confirm': { 'cost': 1, 'returnType': 'Dict' },
                            'convert/history': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/create': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/delete': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/edit': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/list': { 'cost': 1, 'returnType': 'List' },
                            'sub-account/transfer': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/block': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/unblock': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/balances': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/transfer/history': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/create': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/edit': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/delete': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/list': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/reset': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/ip-address/list': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/ip-address/create': { 'cost': 1, 'returnType': 'Dict' },
                            'sub-account/api-key/ip-address/delete': { 'cost': 1, 'returnType': 'Dict' },
                            'mining/rewards': { 'cost': 1, 'returnType': 'Dict' },
                            'market/fee': { 'cost': 1, 'returnType': 'Dict' },
                            'conditional-orders': { 'cost': 1, 'returnType': 'Dict' },
                        },
                    },
                },
            },
