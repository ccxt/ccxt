    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'market/instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'market/tickers': { 'cost': 1, 'returnType': 'Dict' },
                        'market/books': { 'cost': 1, 'returnType': 'Dict' },
                        'market/trades': { 'cost': 1, 'returnType': 'Dict' },
                        'market/mark-price': { 'cost': 1, 'returnType': 'Dict' },
                        'market/funding-rate': { 'cost': 1, 'returnType': 'Dict' },
                        'market/funding-rate-history': { 'cost': 1, 'returnType': 'Dict' },
                        'market/candles': { 'cost': 1, 'returnType': 'Dict' },
                        'market/index-candles': { 'cost': 1, 'returnType': 'Dict' },
                        'market/mark-price-candles': { 'cost': 1, 'returnType': 'Dict' },
                        'market/position-tiers': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        // account
                        'asset/balances': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/bills': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/withdrawal-history': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/deposit-history': { 'cost': 1, 'returnType': 'Dict' },
                        'account/config': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/currencies': { 'cost': 1, 'returnType': 'Dict' },
                        // trading
                        'account/balance': { 'cost': 1, 'returnType': 'Dict' },
                        'account/positions': { 'cost': 1, 'returnType': 'Dict' },
                        'account/positions-history': { 'cost': 1, 'returnType': 'Dict' },
                        'account/margin-mode': { 'cost': 1, 'returnType': 'Dict' },
                        'account/position-mode': { 'cost': 1, 'returnType': 'Dict' },
                        'account/leverage-info': { 'cost': 1, 'returnType': 'Dict' },
                        'account/batch-leverage-info': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/order-detail': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-tpsl-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/order-tpsl-detail': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-algo-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-history': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-tpsl-history': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/orders-algo-history': { 'cost': 1, 'returnType': 'Dict' }, // todo new
                        'trade/fills-history': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/order/price-range': { 'cost': 1, 'returnType': 'Dict' },
                        // affiliate
                        'affiliate/basic': { 'cost': 1, 'returnType': 'Dict' },
                        'affiliate/referral-code': { 'cost': 1, 'returnType': 'Dict' },
                        'affiliate/invitees': { 'cost': 1, 'returnType': 'Dict' },
                        'affiliate/sub-invitees': { 'cost': 1, 'returnType': 'Dict' },
                        'affiliate/sub-affiliates': { 'cost': 1, 'returnType': 'Dict' },
                        'affiliate/invitees/daily/info': { 'cost': 1, 'returnType': 'Dict' },
                        // copy trading
                        'copytrading/instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/config': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/balance': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/positions-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/positions-details-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/positions-by-contract': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/position-mode': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/leverage-info': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/orders-pending': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/pending-tpsl-by-contract': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/position-history-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/orders-history': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/pending-tpsl-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        // user
                        'user/query-apikey': { 'cost': 1, 'returnType': 'Dict' },
                        // tax
                        'spot/trade/fills-history': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        // account
                        'asset/transfer': { 'cost': 1, 'returnType': 'Dict' },
                        'asset/demo-apply-money': { 'cost': 1, 'returnType': 'Dict' },
                        // trading
                        'account/set-margin-mode': { 'cost': 1, 'returnType': 'Dict' },
                        'account/set-position-mode': { 'cost': 1, 'returnType': 'Dict' },
                        'account/set-leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/order': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/batch-orders': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/order-tpsl': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/order-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/cancel-order': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/cancel-batch-orders': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/cancel-tpsl': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/cancel-algo': { 'cost': 1, 'returnType': 'Dict' },
                        'trade/close-position': { 'cost': 1, 'returnType': 'Dict' },
                        // copy trading
                        'copytrading/account/set-position-mode': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/account/set-leverage': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/place-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/cancel-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/place-tpsl-by-contract': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/cancel-tpsl-by-contract': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/place-tpsl-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/cancel-tpsl-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/close-position-by-order': { 'cost': 1, 'returnType': 'Dict' },
                        'copytrading/trade/close-position-by-contract': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
