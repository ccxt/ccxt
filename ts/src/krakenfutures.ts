    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'feeschedules': { 'cost': 1 } as EndpointSpec<Dict>,
                        'instruments': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orderbook': { 'cost': 1 } as EndpointSpec<Dict>,
                        'tickers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'historicalfundingrates': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        'feeschedules/volumes': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openpositions': { 'cost': 1 } as EndpointSpec<List>,
                        'notifications': { 'cost': 1 } as EndpointSpec<Dict>,
                        'accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openorders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'recentorders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'fills': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'leveragepreferences': { 'cost': 1 } as EndpointSpec<Dict>,
                        'pnlpreferences': { 'cost': 1 } as EndpointSpec<Dict>,
                        'assignmentprogram/current': { 'cost': 1 } as EndpointSpec<Dict>,
                        'assignmentprogram/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'orders/status': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'sendorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'editorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'transfer': { 'cost': 1 } as EndpointSpec<Dict>,
                        'batchorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelallorders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'cancelallordersafter': { 'cost': 1 } as EndpointSpec<Dict>,
                        'withdrawal': { 'cost': 1 } as EndpointSpec<Dict>,
                        'assignmentprogram/add': { 'cost': 1 } as EndpointSpec<Dict>,
                        'assignmentprogram/delete': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'leveragepreferences': { 'cost': 1 } as EndpointSpec<Dict>,
                        'pnlpreferences': { 'cost': 1 } as EndpointSpec<Dict>,
                ...
                'charts': {
                    'get': {
                        '{price_type}/{symbol}/{interval}': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'history': {
                    'get': {
                        'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'executions': { 'cost': 1 } as EndpointSpec<Dict>,
                        'triggers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'accountlogcsv': { 'cost': 1 } as EndpointSpec<string>,
                        'account-log': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/{symbol}/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                        'market/{symbol}/executions': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
            'fees': {
