...
export default class krakenfutures extends Exchange {
    ...
    parseTicker (ticker: Dict, market: Market = undefined): Ticker {
        ...
        const average = Precise.stringDiv (Precise.stringAdd (this.zeroIfUndefined (open), this.zeroIfUndefined (last)), '2');
    ...
    parseOrder (order: Dict, market: Market = undefined): Order {
        ...
        if (tradesLength > 0) {
            ...
            for (let i = 0; i < trades.length; i++) {
                ...
                filled2 = Precise.stringAdd (this.zeroIfUndefined (filled2), this.zeroIfUndefined (tradeAmount));
                vwapSum = Precise.stringAdd (this.zeroIfUndefined (vwapSum), this.zeroIfUndefined (Precise.stringMul (tradeAmount, tradePrice)));
            }
            ...
            if (isPrior) {
                filled = Precise.stringAdd (this.zeroIfUndefined (filled), this.zeroIfUndefined (filled2));
            } else {
