        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    ...
                    'post': {
                        'build_register_session_key_tx': 1,
                        'register_session_key': 1,
                        'deregister_session_key': 1,
                        'login': 1,
                        'statistics': 1,
                        'get_all_currencies': 1,
                        'get_currency': 1,
                        'get_instrument': 1,
                        'get_all_instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'get_instruments': 1,
                        'get_ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'get_latest_signed_feeds': 1,
                        'get_option_settlement_prices': 1,
                        'get_spot_feed_history': 1,
                        'get_spot_feed_history_candles': 1,
                        'get_funding_rate_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_trade_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_option_settlement_history': 1,
                        'get_liquidation_history': 1,
                        'get_interest_rate_history': 1,
                        'get_transaction': 1,
                        'get_margin': 1,
                        'margin_watch': 1,
                        'validate_invite_code': 1,
                        'get_points': 1,
                        'get_all_points': 1,
                        'get_points_leaderboard': 1,
                        'get_descendant_tree': 1,
                        'get_tree_roots': 1,
                        'get_swell_percent_points': 1,
                        'get_vault_assets': 1,
                        'get_etherfi_effective_balances': 1,
                        'get_kelp_effective_balances': 1,
                        'get_bridge_balances': 1,
                        'get_ethena_participants': 1,
                        'get_vault_share': 1,
                        'get_vault_statistics': 1,
                        'get_vault_balances': 1,
                        'estimate_integrator_points': 1,
                        'create_subaccount_debug': 1,
                        'deposit_debug': 1,
                        'withdraw_debug': 1,
                        'send_quote_debug': 1,
                        'execute_quote_debug': 1,
                        'get_invite_code': 1,
                        'register_invite': 1,
                        'get_time': { 'cost': 1, 'returnType': 'Dict' },
                        'get_live_incidents': 1,
                        'get_maker_programs': 1,
                        'get_maker_program_scores': 1,
                    },
                },
                'private': {
                    'post': {
                        ...
                        'change_subaccount_label': 1,
                        'get_notificationsv': 1,
                        ...
                        'send_quote': 1,
                        'cancel_quote': 1,
                        'cancel_batch_quotes': 1,
                        'get_quotes': 1,
                        'poll_quotes': 1,
                        'execute_quote': 1,
                        'rfq_get_best_quote': 1,
                        'get_margin': 1,
                        'get_collaterals': 1,
                        'get_positions': { 'cost': 1, 'returnType': 'Dict' },
                        'get_option_settlement_history': 1,
                        'get_subaccount_value_history': 1,
                        'expired_and_cancelled_history': 1,
                        'get_funding_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_interest_history': 1,
                        'get_erc20_transfer_history': 1,
                        'get_liquidation_history': 1,
                        'liquidate': 1,
                        'get_liquidator_history': 1,
                        'session_keys': 1,
                        'edit_session_key': 1,
                        'register_scoped_session_key': 1,
                        'get_mmp_config': 1,
                        'set_mmp_config': 1,
                        'reset_mmp': 1,
                        'set_cancel_on_disconnect': 1,
                        'get_invite_code': 1,
                        'register_invite': 1,
                    },
                },
