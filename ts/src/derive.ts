    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'get_all_currencies': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'build_register_session_key_tx': { 'cost': 1, 'returnType': 'Dict' },
                        'register_session_key': { 'cost': 1, 'returnType': 'Dict' },
                        'deregister_session_key': { 'cost': 1, 'returnType': 'Dict' },
                        'login': { 'cost': 1, 'returnType': 'Dict' },
                        'statistics': { 'cost': 1, 'returnType': 'Dict' },
                        'get_all_currencies': { 'cost': 1, 'returnType': 'Dict' },
                        'get_currency': { 'cost': 1, 'returnType': 'Dict' },
                        'get_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'get_all_instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'get_instruments': { 'cost': 1, 'returnType': 'Dict' },
                        'get_ticker': { 'cost': 1, 'returnType': 'Dict' },
                        'get_latest_signed_feeds': { 'cost': 1, 'returnType': 'Dict' },
                        'get_option_settlement_prices': { 'cost': 1, 'returnType': 'Dict' },
                        'get_spot_feed_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_spot_feed_history_candles': { 'cost': 1, 'returnType': 'Dict' },
                        'get_funding_rate_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_trade_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_option_settlement_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_liquidation_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_interest_rate_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_transaction': { 'cost': 1, 'returnType': 'Dict' },
                        'get_margin': { 'cost': 1, 'returnType': 'Dict' },
                        'margin_watch': { 'cost': 1, 'returnType': 'Dict' },
                        'validate_invite_code': { 'cost': 1, 'returnType': 'Dict' },
                        'get_points': { 'cost': 1, 'returnType': 'Dict' },
                        'get_all_points': { 'cost': 1, 'returnType': 'Dict' },
                        'get_points_leaderboard': { 'cost': 1, 'returnType': 'Dict' },
                        'get_descendant_tree': { 'cost': 1, 'returnType': 'Dict' },
                        'get_tree_roots': { 'cost': 1, 'returnType': 'Dict' },
                        'get_swell_percent_points': { 'cost': 1, 'returnType': 'Dict' },
                        'get_vault_assets': { 'cost': 1, 'returnType': 'Dict' },
                        'get_etherfi_effective_balances': { 'cost': 1, 'returnType': 'Dict' },
                        'get_kelp_effective_balances': { 'cost': 1, 'returnType': 'Dict' },
                        'get_bridge_balances': { 'cost': 1, 'returnType': 'Dict' },
                        'get_ethena_participants': { 'cost': 1, 'returnType': 'Dict' },
                        'get_vault_share': { 'cost': 1, 'returnType': 'Dict' },
                        'get_vault_statistics': { 'cost': 1, 'returnType': 'Dict' },
                        'get_vault_balances': { 'cost': 1, 'returnType': 'Dict' },
                        'estimate_integrator_points': { 'cost': 1, 'returnType': 'Dict' },
                        'create_subaccount_debug': { 'cost': 1, 'returnType': 'Dict' },
                        'deposit_debug': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraw_debug': { 'cost': 1, 'returnType': 'Dict' },
                        'send_quote_debug': { 'cost': 1, 'returnType': 'Dict' },
                        'execute_quote_debug': { 'cost': 1, 'returnType': 'Dict' },
                        'get_invite_code': { 'cost': 1, 'returnType': 'Dict' },
                        'register_invite': { 'cost': 1, 'returnType': 'Dict' },
                        'get_time': { 'cost': 1, 'returnType': 'Dict' },
                        'get_live_incidents': { 'cost': 1, 'returnType': 'Dict' },
                        'get_maker_programs': { 'cost': 1, 'returnType': 'Dict' },
                        'get_maker_program_scores': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'post': {
                        'get_account': { 'cost': 1, 'returnType': 'Dict' },
                        'create_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'get_subaccount': { 'cost': 1, 'returnType': 'Dict' },
                        'get_subaccounts': { 'cost': 1, 'returnType': 'Dict' },
                        'get_all_portfolios': { 'cost': 1, 'returnType': 'Dict' },
                        'change_subaccount_label': { 'cost': 1, 'returnType': 'Dict' },
                        'get_notificationsv': { 'cost': 1, 'returnType': 'Dict' },
                        'update_notifications': { 'cost': 1, 'returnType': 'Dict' },
                        'deposit': { 'cost': 1, 'returnType': 'Dict' },
                        'withdraw': { 'cost': 1, 'returnType': 'Dict' },
                        'transfer_erc20': { 'cost': 1, 'returnType': 'Dict' },
                        'transfer_position': { 'cost': 1, 'returnType': 'Dict' },
                        'transfer_positions': { 'cost': 1, 'returnType': 'Dict' },
                        'order': { 'cost': 1, 'returnType': 'Dict' },
                        'replace': { 'cost': 1, 'returnType': 'Dict' },
                        'order_debug': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order': { 'cost': 1, 'returnType': 'Dict' },
                        'get_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'get_open_orders': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_by_label': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_by_nonce': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_by_instrument': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_all': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_trigger_order': { 'cost': 1, 'returnType': 'Dict' },
                        'get_order_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_trade_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_deposit_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_withdrawal_history': { 'cost': 1, 'returnType': 'Dict' },
                        'send_rfq': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_rfq': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_batch_rfqs': { 'cost': 1, 'returnType': 'Dict' },
                        'get_rfqs': { 'cost': 1, 'returnType': 'Dict' },
                        'poll_rfqs': { 'cost': 1, 'returnType': 'Dict' },
                        'send_quote': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_quote': { 'cost': 1, 'returnType': 'Dict' },
                        'cancel_batch_quotes': { 'cost': 1, 'returnType': 'Dict' },
                        'get_quotes': { 'cost': 1, 'returnType': 'Dict' },
                        'poll_quotes': { 'cost': 1, 'returnType': 'Dict' },
                        'execute_quote': { 'cost': 1, 'returnType': 'Dict' },
                        'rfq_get_best_quote': { 'cost': 1, 'returnType': 'Dict' },
                        'get_margin': { 'cost': 1, 'returnType': 'Dict' },
                        'get_collaterals': { 'cost': 1, 'returnType': 'Dict' },
                        'get_positions': { 'cost': 1, 'returnType': 'Dict' },
                        'get_option_settlement_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_subaccount_value_history': { 'cost': 1, 'returnType': 'Dict' },
                        'expired_and_cancelled_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_funding_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_interest_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_erc20_transfer_history': { 'cost': 1, 'returnType': 'Dict' },
                        'get_liquidation_history': { 'cost': 1, 'returnType': 'Dict' },
                        'liquidate': { 'cost': 1, 'returnType': 'Dict' },
                        'get_liquidator_history': { 'cost': 1, 'returnType': 'Dict' },
                        'session_keys': { 'cost': 1, 'returnType': 'Dict' },
                        'edit_session_key': { 'cost': 1, 'returnType': 'Dict' },
                        'register_scoped_session_key': { 'cost': 1, 'returnType': 'Dict' },
                        'get_mmp_config': { 'cost': 1, 'returnType': 'Dict' },
                        'set_mmp_config': { 'cost': 1, 'returnType': 'Dict' },
                        'reset_mmp': { 'cost': 1, 'returnType': 'Dict' },
                        'set_cancel_on_disconnect': { 'cost': 1, 'returnType': 'Dict' },
                        'get_invite_code': { 'cost': 1, 'returnType': 'Dict' },
                        'register_invite': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
