...
export default class astralx extends Exchange {
    ...
    parseTicker (ticker, market = undefined) {
        ...
        return this.safeTicker ({
            ...
            'high': undefined, // API可能不提供最高价
            'low': undefined,   // API可能不提供最低价
            'bid': undefined,   // API可能不提供买价
            'bidVolume': undefined,
            'ask': undefined,   // API可能不提供卖价
            'askVolume': undefined,
            'vwap': undefined,
            'open': undefined, // API可能不提供开盘价
            'close': last,
            'last': last,
            'previousClose': undefined,
            'change': undefined, // 由于缺少开盘价，无法计算涨跌
    ...
    parseFundingRate (contract, market = undefined) {
        ...
        return {
            'info': contract,
            'symbol': symbol,
            'markPrice': undefined, // API没有提供标记价格
            'indexPrice': undefined, // API没有提供指数价格
