...
import type { Balances, Currency, CurrencyInterface, Currencies, Dict, Fee, Int, List, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, TradingFeeInterface, TradingFees, Transaction, int, DepositAddress, NullableDict, Status, EndpointSpec } from './base/types.js';
    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'openapi/v1/ping': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/time': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/user/ip': { 'cost': 1 } as EndpointSpec<Dict>,
                        ...
                        'openapi/quote/v1/ticker/24hr': { 'cost': 1, 'noSymbolAndNoSymbols': 40, 'byNumberOfSymbols': [ [ 101, 40 ], [ 21, 20 ], [ 0, 1 ] ] } as EndpointSpec<List>,
                        ...
                        'openapi/quote/v1/ticker/price': { 'cost': 1, 'noSymbol': 2 } as EndpointSpec<Dict>,
                        // cost 1 if 'symbol' param defined (one market symbol)
                        // cost 2 if 'symbols' param is a list of 1 or more market symbols or if both 'symbol' and 'symbols' params are omitted
                        'openapi/quote/v1/ticker/bookTicker': { 'cost': 1, 'noSymbol': 2 } as EndpointSpec<List>,
                        'openapi/v1/exchangeInfo': { 'cost': 10 } as EndpointSpec<Dict>,
                        // cost 1 if limit <= 100; 5 if limit > 100.
                        'openapi/quote/v1/depth': { 'cost': 1, 'byLimit': [ [ 101, 5 ], [ 0, 1 ] ] } as EndpointSpec<Dict>,
                        'openapi/quote/v1/klines': { 'cost': 1 } as EndpointSpec<List>, // default limit 500; max 1000.
                        'openapi/quote/v1/trades': { 'cost': 1 } as EndpointSpec<List>, // default limit 500; max 1000. if limit <=0 or > 1000 then return 1000
                        'openapi/v1/pairs': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/quote/v1/avgPrice': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
                'private': {
                    'get': {
                        'openapi/v1/check-sys-status': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/wallet/v1/config/getall': { 'cost': 10 } as EndpointSpec<List>,
                        'openapi/wallet/v1/deposit/address': { 'cost': 10 } as EndpointSpec<Dict>,
                        'openapi/wallet/v1/deposit/history': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/wallet/v1/withdraw/history': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/wallet/v1/withdraw/address-whitelist': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/v1/account': { 'cost': 10 } as EndpointSpec<Dict>,
                        'openapi/v1/api-keys': { 'cost': 1 } as EndpointSpec<List>,
                        // cost 3 for a single symbol; 40 when the symbol parameter is omitted
                        'openapi/v1/openOrders': { 'cost': 3, 'noSymbol': 40 } as EndpointSpec<List>,
                        'openapi/v1/asset/tradeFee': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/v1/order': { 'cost': 2 } as EndpointSpec<Dict>,
                        // cost 10 with symbol, 40 when the symbol parameter is omitted;
                        'openapi/v1/historyOrders': { 'cost': 10, 'noSymbol': 40 } as EndpointSpec<List>,
                        'openapi/v1/myTrades': { 'cost': 10 } as EndpointSpec<List>,
                        'openapi/v1/capital/deposit/history': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/v1/capital/withdraw/history': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/v3/payment-request/get-payment-request': { 'cost': 1 } as EndpointSpec<Dict>,
                        'merchant-api/v1/get-invoices': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/account/v3/crypto-accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/transfer/v3/transfers/{id}': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/list': { 'cost': 10 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/asset': { 'cost': 10 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/transfer/universal-transfer-history': { 'cost': 10 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/transfer/sub-history': { 'cost': 10 } as EndpointSpec<List>,
                        'openapi/v1/sub-account/apikey/ip-restriction': { 'cost': 10 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/wallet/deposit/address': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/wallet/deposit/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/fund-collect/get-fund-record': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/v1/asset/transaction/history': { 'cost': 20 } as EndpointSpec<Dict>,
                    },
                    'post': {
                        'openapi/wallet/v1/withdraw/apply': { 'cost': 600 } as EndpointSpec<Dict>,
                        'openapi/v1/order/test': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/order/cancelReplace': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/capital/withdraw/apply': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/capital/deposit/apply': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v3/payment-request/payment-requests': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v3/payment-request/delete-payment-request': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v3/payment-request/payment-request-reminder': { 'cost': 1 } as EndpointSpec<string>,
                        'openapi/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                        'merchant-api/v1/invoices': { 'cost': 1 } as EndpointSpec<Dict>,
                        'merchant-api/v1/invoices-cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/convert/v1/get-supported-trading-pairs': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/convert/v1/get-quote': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/convert/v1/accept-quote': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/convert/v1/query-order-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/otc-trade/v1/get-supported-trading-pairs': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/otc-trade/v1/create-rfq': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/otc-trade/v1/accept-rfq': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/otc-trade/v1/manual-settle': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/otc-trade/v1/query-order-history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/fiat/v1/support-channel': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/fiat/v1/cash-out': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/fiat/v1/history': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/migration/v4/sellorder': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/migration/v4/validate-field': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/transfer/v3/transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/transfer/v4/transfers': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/create': { 'cost': 30 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/transfer/universal-transfer': { 'cost': 100 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/transfer/sub-to-master': { 'cost': 100 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/apikey/add-ip-restriction': { 'cost': 30 } as EndpointSpec<Dict>,
                        'openapi/v1/sub-account/apikey/delete-ip-restriction': { 'cost': 30 } as EndpointSpec<Dict>,
                        'openapi/v1/fund-collect/collect-from-sub-account': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'put': {
                        'openapi/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                    'delete': {
                        'openapi/v1/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        'openapi/v1/openOrders': { 'cost': 1 } as EndpointSpec<List>,
                        'openapi/v1/userDataStream': { 'cost': 1 } as EndpointSpec<Dict>,
                    },
                },
            },
