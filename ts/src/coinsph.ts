    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'openapi/v1/ping': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/v1/time': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/v1/user/ip': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'openapi/v1/pairs': { 'cost': 1, 'returnType': 'List' },
                        'openapi/quote/v1/avgPrice': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        'openapi/v1/check-sys-status': { 'cost': 1, 'returnType': 'List' },
                        ...
                        'openapi/wallet/v1/withdraw/address-whitelist': { 'cost': 1, 'returnType': 'List' },
                        'openapi/v1/account': { 'cost': 10, 'returnType': 'Dict' },
                        'openapi/v1/api-keys': { 'cost': 1, 'returnType': 'List' },
                        ...
                        'openapi/v1/capital/deposit/history': { 'cost': 1, 'returnType': 'List' },
                        'openapi/v1/capital/withdraw/history': { 'cost': 1, 'returnType': 'List' },
                        'openapi/v3/payment-request/get-payment-request': { 'cost': 1, 'returnType': 'Dict' },
                        'merchant-api/v1/get-invoices': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/account/v3/crypto-accounts': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/transfer/v3/transfers/{id}': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/list': { 'cost': 10, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/asset': { 'cost': 10, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/transfer/universal-transfer-history': { 'cost': 10, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/transfer/sub-history': { 'cost': 10, 'returnType': 'List' },
                        'openapi/v1/sub-account/apikey/ip-restriction': { 'cost': 10, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/wallet/deposit/address': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/wallet/deposit/history': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/v1/fund-collect/get-fund-record': { 'cost': 1, 'returnType': 'List' },
                        'openapi/v1/asset/transaction/history': { 'cost': 20, 'returnType': 'Dict' },
                    },
                    'post': {
                        ...
                        'openapi/convert/v1/get-supported-trading-pairs': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/convert/v1/get-quote': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/convert/v1/accept-quote': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/convert/v1/query-order-history': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/otc-trade/v1/get-supported-trading-pairs': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/otc-trade/v1/create-rfq': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/otc-trade/v1/accept-rfq': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/otc-trade/v1/manual-settle': { 'cost': 1, 'returnType': 'Dict' },
                        'openapi/otc-trade/v1/query-order-history': { 'cost': 1, 'returnType': 'Dict' },
                        ...
                        'openapi/v1/sub-account/transfer/universal-transfer': { 'cost': 100, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/transfer/sub-to-master': { 'cost': 100, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/apikey/add-ip-restriction': { 'cost': 30, 'returnType': 'Dict' },
                        'openapi/v1/sub-account/apikey/delete-ip-restriction': { 'cost': 30, 'returnType': 'Dict' },
                        'openapi/v1/fund-collect/collect-from-sub-account': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'put': {
                        'openapi/v1/userDataStream': { 'cost': 1, 'returnType': 'Dict' },
                    },
