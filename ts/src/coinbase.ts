...
export default class coinbase extends Exchange {
    ...
    async fetchMarketsV2 (params = {}): Promise<Market[]> {
        ...
        const data = this.safeList (currencies, 'data', []) as any[];
    ...
    async fetchMarketsV3 (params = {}): Promise<Market[]> {
        ...
        const data = this.safeList (spot, 'products', []) as any[];
        const result: any[] = [];
    ...
    async fetchTickersV3 (symbols: Strings = undefined, params = {}): Promise<Tickers> {
        ...
        //     }
        //
        const data = this.safeList (response, 'products', []) as any[];
        const result: Dict = {};
        for (let i = 0; i < data.length; i++) {
            const entry = data[i];
    ...
    async fetchTickerV3 (symbol: string, params = {}) {
        ...
        //     }
        //
        const data = this.safeList (response, 'trades', []) as any[];
