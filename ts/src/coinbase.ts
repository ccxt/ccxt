...
import { Int, OrderSide, OrderType, Order, Trade, OHLCV, Ticker, OrderBook, String, Transaction, Balances, Tickers } from './base/types.js';
...
export default class coinbase extends Exchange {
    ...
    async fetchOrders (symbol: String = undefined, since: Int = undefined, limit = 100, params = {}): Promise<Order[]> {
        /**
         * @method
