        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'v2': {
                    'public': {
                        'get': {
                            'currencies': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'currencies/crypto': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'time': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'exchange-rates': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'users/{user_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'prices/{symbol}/buy': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'prices/{symbol}/sell': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'prices/{symbol}/spot': { 'cost': 10.6 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'accounts': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/addresses': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/addresses/{address_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/addresses/{address_id}/transactions': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/transactions': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/transactions/{transaction_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/buys': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/buys/{buy_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/sells': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/sells/{sell_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/deposits': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/deposits/{deposit_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/withdrawals': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/withdrawals/{withdrawal_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'payment-methods': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'payment-methods/{payment_method_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'user': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'user/auth': { 'cost': 10.6 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'accounts': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/primary': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/addresses': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/transactions': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/transactions/{transaction_id}/complete': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/transactions/{transaction_id}/resend': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/buys': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/buys/{buy_id}/commit': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/sells': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/sells/{sell_id}/commit': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/deposits': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/deposits/{deposit_id}/commit': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/withdrawals': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/withdrawals/{withdrawal_id}/commit': { 'cost': 10.6 } as EndpointSpec<Dict>,
                        },
                        'put': {
                            'accounts/{account_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'user': { 'cost': 10.6 } as EndpointSpec<Dict>,
                        ...
                        'delete': {
                            'accounts/{id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                            'accounts/{account_id}/transactions/{transaction_id}': { 'cost': 10.6 } as EndpointSpec<Dict>,
                        },
                    },
                },
                'v3': {
                    'public': {
                        'get': {
                            'brokerage/time': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/market/product_book': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/market/products': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/market/products/{product_id}': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/market/products/{product_id}/candles': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/market/products/{product_id}/ticker': { 'cost': 3 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'brokerage/accounts': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/accounts/{account_uuid}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/historical/batch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/historical/fills': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/historical/{order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/products': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/products/{product_id}': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/products/{product_id}/candles': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/products/{product_id}/ticker': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/best_bid_ask': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/product_book': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/transaction_summary': { 'cost': 3 } as EndpointSpec<Dict>,
                            'brokerage/portfolios': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/portfolios/{portfolio_uuid}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/convert/trade/{trade_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/cfm/balance_summary': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/cfm/positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/cfm/positions/{product_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/cfm/sweeps': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/intx/portfolio/{portfolio_uuid}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/intx/positions/{portfolio_uuid}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/intx/positions/{portfolio_uuid}/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/payment_methods': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/payment_methods/{payment_method_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/key_permissions': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'brokerage/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/batch_cancel': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/edit': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/edit_preview': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/orders/preview': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/portfolios': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/portfolios/move_funds': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/convert/quote': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/convert/trade/{trade_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/cfm/sweeps/schedule': { 'cost': 1 } as EndpointSpec<Dict>,
                            'brokerage/intx/allocate': { 'cost': 1 } as EndpointSpec<Dict>,
                            // futures
                            'brokerage/orders/close_position': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'put': {
                            'brokerage/portfolios/{portfolio_uuid}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
