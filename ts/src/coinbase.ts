            ...
            'api': {
                'v2': {
                    'public': {
                        'get': {
                            'currencies': 36,
                            'currencies/crypto': 36,
                            'time': 36,
                            'exchange-rates': 36,
                            'users/{user_id}': 36,
                            'prices/{symbol}/buy': 36,
                            'prices/{symbol}/sell': 36,
                            'prices/{symbol}/spot': 36,
                        },
                    },
                    'private': {
                        'get': {
                            'accounts': 36,
                            'accounts/{account_id}': 36,
                            'accounts/{account_id}/addresses': 36,
                            'accounts/{account_id}/addresses/{address_id}': 36,
                            'accounts/{account_id}/addresses/{address_id}/transactions': 36,
                            'accounts/{account_id}/transactions': 36,
                            'accounts/{account_id}/transactions/{transaction_id}': 36,
                            'accounts/{account_id}/buys': 36,
                            'accounts/{account_id}/buys/{buy_id}': 36,
                            'accounts/{account_id}/sells': 36,
                            'accounts/{account_id}/sells/{sell_id}': 36,
                            'accounts/{account_id}/deposits': 36,
                            'accounts/{account_id}/deposits/{deposit_id}': 36,
                            'accounts/{account_id}/withdrawals': 36,
                            'accounts/{account_id}/withdrawals/{withdrawal_id}': 36,
                            'payment-methods': 36,
                            'payment-methods/{payment_method_id}': 36,
                            'user': 36,
                            'user/auth': 36,
                        },
                        'post': {
                            'accounts': 36,
                            'accounts/{account_id}/primary': 36,
                            'accounts/{account_id}/addresses': 36,
                            'accounts/{account_id}/transactions': 36,
                            'accounts/{account_id}/transactions/{transaction_id}/complete': 36,
                            'accounts/{account_id}/transactions/{transaction_id}/resend': 36,
                            'accounts/{account_id}/buys': 36,
                            'accounts/{account_id}/buys/{buy_id}/commit': 36,
                            'accounts/{account_id}/sells': 36,
                            'accounts/{account_id}/sells/{sell_id}/commit': 36,
                            'accounts/{account_id}/deposits': 36,
                            'accounts/{account_id}/deposits/{deposit_id}/commit': 36,
                            'accounts/{account_id}/withdrawals': 36,
                            'accounts/{account_id}/withdrawals/{withdrawal_id}/commit': 36,
                        },
                        'put': {
                            'accounts/{account_id}': 36,
                            'user': 36,
                ...
                'v3': {
                    ...
                    'private': {
                        'get': {
                            'brokerage/accounts': 3.34,
                            'brokerage/accounts/{account_uuid}': 3.34,
                            'brokerage/orders/historical/batch': 3.34,
                            'brokerage/orders/historical/fills': 3.34,
                            'brokerage/orders/historical/{order_id}': 3.34,
                            'brokerage/products': 10,
                            'brokerage/products/{product_id}': 10,
                            'brokerage/products/{product_id}/candles': 10,
                            'brokerage/products/{product_id}/ticker': 10,
                            'brokerage/best_bid_ask': 10,
                            'brokerage/product_book': 10,
                            'brokerage/transaction_summary': 10,
                            'brokerage/portfolios': 3.34,
                            'brokerage/portfolios/{portfolio_uuid}': 3.34,
                            'brokerage/convert/trade/{trade_id}': 3.34,
                            'brokerage/cfm/balance_summary': 3.34,
                            'brokerage/cfm/positions': 3.34,
                            'brokerage/cfm/positions/{product_id}': 3.34,
                            'brokerage/cfm/sweeps': 3.34,
                            'brokerage/intx/portfolio/{portfolio_uuid}': 3.34,
                            'brokerage/intx/positions/{portfolio_uuid}': 3.34,
                            'brokerage/intx/positions/{portfolio_uuid}/{symbol}': 3.34,
                        },
                        'post': {
                            'brokerage/orders': 3.34,
                            'brokerage/orders/batch_cancel': 3.34,
                            'brokerage/orders/edit': 3.34,
                            'brokerage/orders/edit_preview': 3.34,
                            'brokerage/orders/preview': 3.34,
                            'brokerage/portfolios': 3.34,
                            'brokerage/portfolios/move_funds': 3.34,
                            'brokerage/convert/quote': 3.34,
                            'brokerage/convert/trade/{trade_id}': 3.34,
                            'brokerage/cfm/sweeps/schedule': 3.34,
                            'brokerage/intx/allocate': 3.34,
                        },
                        'put': {
                            'brokerage/portfolios/{portfolio_uuid}': 3.34,
                        },
