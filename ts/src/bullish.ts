    ...
    override describe (): any {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'public': {
                    'get': {
                        'v1/nonce': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/time': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/assets': { 'cost': 1, 'returnType': 'List' },
                        'v1/assets/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/markets': { 'cost': 1, 'returnType': 'List' },
                        'v1/markets/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/history/markets/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/markets/{symbol}/orderbook/hybrid': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/markets/{symbol}/trades': { 'cost': 1, 'returnType': 'List' },
                        'v1/markets/{symbol}/tick': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/markets/{symbol}/candle': { 'cost': 1, 'returnType': 'List' },
                        'v1/history/markets/{symbol}/trades': { 'cost': 1, 'returnType': 'List' },
                        'v1/history/markets/{symbol}/funding-rate': { 'cost': 1, 'returnType': 'List' },
                        'v1/index-prices': { 'cost': 1, 'returnType': 'List' },
                        'v1/index-prices/{assetSymbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/expiry-prices/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/option-ladder': { 'cost': 1, 'returnType': 'List' },
                        'v1/option-ladder/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
                'private': {
                    'get': {
                        'v2/orders': { 'cost': 1, 'returnType': 'List' },
                        'v2/history/orders': { 'cost': 1, 'returnType': 'List' },
                        'v2/orders/{orderId}': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/amm-instructions': { 'cost': 1, 'returnType': 'List' },
                        'v2/amm-instructions/{instructionId}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/wallets/transactions': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/wallets/limits/{symbol}': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/wallets/deposit-instructions/crypto/{symbol}': { 'cost': 1, 'returnType': 'List' },
                        'v1/wallets/withdrawal-instructions/crypto/{symbol}': { 'cost': 1, 'returnType': 'List' },
                        'v1/wallets/deposit-instructions/fiat/{symbol}': { 'cost': 1, 'returnType': 'List' },
                        'v1/wallets/withdrawal-instructions/fiat/{symbol}': { 'cost': 1, 'returnType': 'List' },
                        'v1/wallets/self-hosted/verification-attempts': { 'cost': 1, 'returnType': 'List' },
                        'v1/trades': { 'cost': 5, 'returnType': 'List' },
                        'v1/history/trades': { 'cost': 5, 'returnType': 'List' },
                        'v1/trades/{tradeId}': { 'cost': 5, 'returnType': 'Dict' },
                        ...
                        'v1/derivatives-positions': { 'cost': 1, 'returnType': 'List' },
                        'v1/history/derivatives-settlement': { 'cost': 1, 'returnType': 'List' },
                        'v1/history/transfer': { 'cost': 1, 'returnType': 'List' },
                        'v1/history/borrow-interest': { 'cost': 1, 'returnType': 'List' },
                        'v2/mmp-configuration': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/otc-trades': { 'cost': 1, 'returnType': 'List' },
                        'v2/otc-trades/{otcTradeId}': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/otc-trades/unconfirmed-trade': { 'cost': 1, 'returnType': 'Dict' },
                    },
                    'post': {
                        'v2/orders': { 'cost': 5, 'returnType': 'Dict' },
                        'v2/command': { 'cost': 5, 'returnType': 'Dict' },
                        'v2/amm-instructions': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/wallets/withdrawal': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/users/login': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/simulate-portfolio-margin': { 'cost': 1, 'returnType': 'Dict' },
                        'v1/wallets/self-hosted/initiate': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/mmp-configuration': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/otc-trades': { 'cost': 1, 'returnType': 'Dict' },
                        'v2/otc-command': { 'cost': 1, 'returnType': 'Dict' },
                    },
                },
            },
            'fees': {
