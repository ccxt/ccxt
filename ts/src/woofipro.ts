...
import type { Balances, Currency, CurrencyInterface, FundingRateHistory, Int, Market, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Trade, Transaction, Leverage, Currencies, TradingFees, OrderRequest, Dict, int, LedgerEntry, FundingRate, FundingRates, FundingHistory, Position, NullableDict, FeeString, Status, EndpointSpec, List } from './base/types.js';
        ...
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                'v1': {
                    'public': {
                        'get': {
                            'public/volume/stats': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/broker/name': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/chain_info/{broker_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/system_info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/vault_balance': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/insurancefund': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/chain_info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'faucet/usdc': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/account': { 'cost': 1 } as EndpointSpec<Dict>,
                            'get_account': { 'cost': 1 } as EndpointSpec<Dict>,
                            'registration_nonce': { 'cost': 1 } as EndpointSpec<Dict>,
                            'get_orderly_key': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/liquidation': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/liquidated_positions': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/config': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/campaign/ranking': { 'cost': 10 } as EndpointSpec<Dict>,
                            'public/campaign/stats': { 'cost': 10 } as EndpointSpec<Dict>,
                            'public/campaign/user': { 'cost': 10 } as EndpointSpec<Dict>,
                            'public/campaign/stats/details': { 'cost': 10 } as EndpointSpec<Dict>,
                            'public/campaigns': { 'cost': 10 } as EndpointSpec<Dict>,
                            'public/points/leaderboard': { 'cost': 1 } as EndpointSpec<Dict>,
                            'client/points': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/points/epoch': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/points/epoch_dates': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/referral/check_ref_code': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/referral/verify_ref_code': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/admin_info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/referee_info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/referee_rebate_summary': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/referee_history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/referral_history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'referral/rebate_summary': { 'cost': 1 } as EndpointSpec<Dict>,
                            'client/distribution_history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tv/config': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tv/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'tv/symbol_info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/funding_rate_history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/funding_rate/{symbol}': { 'cost': 0.33 } as EndpointSpec<Dict>,
                            'public/funding_rates': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/info': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/info/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/market_trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/token': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/futures': { 'cost': 1 } as EndpointSpec<Dict>,
                            'public/futures/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'register_account': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                    'private': {
                        'get': {
                            'client/key_info': { 'cost': 6 } as EndpointSpec<Dict>,
                            'client/orderly_key_ip_restriction': { 'cost': 6 } as EndpointSpec<Dict>,
                            ...
                            'algo/client/order/{client_order_id}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'algo/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trade/{tid}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'order/{oid}/trades': { 'cost': 1 } as EndpointSpec<Dict>,
                            'client/liquidator_liquidations': { 'cost': 1 } as EndpointSpec<Dict>,
                            ...
                            'withdraw_nonce': { 'cost': 1 } as EndpointSpec<Dict>,
                            'settle_nonce': { 'cost': 1 } as EndpointSpec<Dict>,
                            'pnl_settlement/history': { 'cost': 1 } as EndpointSpec<Dict>,
                            'volume/user/daily': { 'cost': 60 } as EndpointSpec<Dict>,
                            'volume/user/stats': { 'cost': 60 } as EndpointSpec<Dict>,
                            'client/statistics': { 'cost': 60 } as EndpointSpec<Dict>,
                            'client/info': { 'cost': 60 } as EndpointSpec<Dict>,
                            'client/statistics/daily': { 'cost': 60 } as EndpointSpec<Dict>,
                            ...
                            'notification/inbox/notifications': { 'cost': 60 } as EndpointSpec<Dict>,
                            'notification/inbox/unread': { 'cost': 60 } as EndpointSpec<Dict>,
                            'volume/broker/daily': { 'cost': 60 } as EndpointSpec<Dict>,
                            'broker/fee_rate/default': { 'cost': 10 } as EndpointSpec<Dict>,
                            'broker/user_info': { 'cost': 10 } as EndpointSpec<Dict>,
                            'orderbook/{symbol}': { 'cost': 1 } as EndpointSpec<Dict>,
                            'kline': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                        'post': {
                            'orderly_key': { 'cost': 1 } as EndpointSpec<Dict>,
                            'client/set_orderly_key_ip_restriction': { 'cost': 6 } as EndpointSpec<Dict>,
                            'client/reset_orderly_key_ip_restriction': { 'cost': 6 } as EndpointSpec<Dict>,
                            'order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'batch-order': { 'cost': 10 } as EndpointSpec<Dict>,
                            'algo/order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'liquidation': { 'cost': 1 } as EndpointSpec<Dict>,
                            'claim_insurance_fund': { 'cost': 1 } as EndpointSpec<Dict>,
                            'withdraw_request': { 'cost': 1 } as EndpointSpec<Dict>,
                            'settle_pnl': { 'cost': 1 } as EndpointSpec<Dict>,
                            'notification/inbox/mark_read': { 'cost': 60 } as EndpointSpec<Dict>,
                            'notification/inbox/mark_read_all': { 'cost': 60 } as EndpointSpec<Dict>,
                            'client/leverage': { 'cost': 120 } as EndpointSpec<Dict>,
                            'client/maintenance_config': { 'cost': 60 } as EndpointSpec<Dict>,
                            'delegate_signer': { 'cost': 10 } as EndpointSpec<Dict>,
                            'delegate_orderly_key': { 'cost': 10 } as EndpointSpec<Dict>,
                            'delegate_settle_pnl': { 'cost': 10 } as EndpointSpec<Dict>,
                            'delegate_withdraw_request': { 'cost': 10 } as EndpointSpec<Dict>,
                            'broker/fee_rate/set': { 'cost': 10 } as EndpointSpec<Dict>,
                            'broker/fee_rate/set_default': { 'cost': 10 } as EndpointSpec<Dict>,
                            'broker/fee_rate/default': { 'cost': 10 } as EndpointSpec<Dict>,
                            'referral/create': { 'cost': 10 } as EndpointSpec<Dict>,
                            'referral/update': { 'cost': 10 } as EndpointSpec<Dict>,
                            'referral/bind': { 'cost': 10 } as EndpointSpec<Dict>,
                            'referral/edit_split': { 'cost': 10 } as EndpointSpec<Dict>,
                        },
                        'put': {
                            'order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'algo/order': { 'cost': 1 } as EndpointSpec<Dict>,
                        ...
                        'delete': {
                            ...
                            'algo/client/order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'algo/orders': { 'cost': 1 } as EndpointSpec<Dict>,
                            'orders': { 'cost': 1 } as EndpointSpec<List>,
                            'batch-order': { 'cost': 1 } as EndpointSpec<Dict>,
                            'client/batch-order': { 'cost': 1 } as EndpointSpec<Dict>,
                        },
                    },
                },
            },
