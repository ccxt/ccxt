...
import { ExchangeError, ArgumentsRequired, BadSymbol, InsufficientFunds, OrderNotFound, InvalidOrder, AuthenticationError, PermissionDenied, ExchangeNotAvailable, RequestTimeout, BadRequest, RateLimitExceeded } from './base/errors';
...
export default class coinex extends Exchange {
    ...
    async transfer (code, amount, fromAccount, toAccount, params = {}) {
        ...
        if ((fromAccount === 'spot') && (toAccount === 'swap')) {
            ...
            request['from_account'] = this.parseInt (fromId);
            request['to_account'] = this.parseInt (toId);
