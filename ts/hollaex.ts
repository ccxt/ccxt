...
import { BadRequest, AuthenticationError, NetworkError, ArgumentsRequired, OrderNotFound, InsufficientFunds, OrderImmediatelyFillable } from './base/errors';
...
export default class hollaex extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'options': {
                ...
                'api-expires': this.parseInt (this.timeout / 1000),
                'networks': {
                    'BTC': 'btc',
                    'ETH': 'eth',
                    'ERC20': 'eth',
    ...
    sign (path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'private') {
            ...
            const defaultExpires = this.safeInteger2 (this.options, 'api-expires', 'expires', this.parseInt (this.timeout / 1000));
