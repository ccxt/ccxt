...
class NewTranspiler {
    ...
    setupTranspiler() {
        ...
        // sign (+ crypto helpers) is async only in JS; in C# it is synchronous, so make
        // every byPath transpile strip sign->sync first (originals restored afterwards).
        patchTranspileByPathWithSyncSign (this.transpiler, 'transpileCSharpByPath');
    }
...
async function runMain () {
    ...
    // sign is synchronous in C#; the AST transpiler resolves the base Exchange.ts +
