...
`   public class BaseError : Exception
    ...
    transpileBaseMethods(baseExchangeFile: string, force = true) {
        ...
        if (parts.length > 1) {
            ...
            if (exchangeClassMatch) {
                ...
                const tradingFile = tradingHeader + this.dropIdentityStringCasts (this.stripRedundantStringCasts (this.retypeStringReceiverCasts (this.foldIdentityStringCasts (this.nativeListHelperCalls (this.retypeParseMarketParams (this.retypeParameterArgs (this.typeVenueStringArgs (this.pascalizeTypedCores (this.dropStringTimeframeCasts (this.retypeSignatureArgs (this.finalizeCoreArgTypes (this.castCoreArgCallSites (this.typeCoreArgs (this.typeCollectionReturns (this.typeCores (this.typeSyncCores (exchangeBody), false))))))), false), 'Exchange')))))))) + "\n}\n";
    ...
    transpilePredictionBaseMethods (predictionBaseFile = './ts/src/base/PredictionExchange.ts', force = true) {
        ...
        if (parts.length > 1) {
            ...
            const file = fileHeader + fields + this.dropIdentityStringCasts (this.retypeStringReceiverCasts (this.foldIdentityStringCasts (this.nativeListHelperCalls (this.retypeParseMarketParams (this.typeVenueStringArgs (this.pascalizeTypedCores (this.dropStringTimeframeCasts (this.retypeSignatureArgs (this.finalizeCoreArgTypes (this.castCoreArgCallSites (this.typeCoreArgs (this.typeCollectionReturns (this.typeCores (this.typeSyncCores (baseMethods), true))))))), true), 'PredictionExchange')))))) + "\n";
    ...
    createCSharpClass(csharpVersion: any, ws = false, prediction = false) {
        ...
        content = this.dropIdentityStringCasts (this.typeVenueStringArgs (this.stripRedundantStringCasts (this.retypeStringReceiverCasts (this.foldIdentityStringCasts (this.nativeListHelperCalls (this.retypeParseMarketParams (this.retypeWsHandlerMessages (this.retypeParameterArgs (this.pascalizeTypedCores (this.dropStringTimeframeCasts (this.retypeSignatureArgs (this.finalizeCoreArgTypes (this.castCoreArgCallSites (this.typeCoreArgs (this.typeCollectionReturns (this.typeCores (this.typeSyncCores (content)))))))))))))))), venueKey));
