...
`   public class BaseError : Exception
    ...
    async webworkerTranspile (allFiles: any[], parserConfig: any) {
        ...
        // (a slow exchange can't stall a whole chunk). CCXT_TRANSPILE_CHUNK only exists
        // to A/B fewer, coarser task round-trips; it never changes what the worker
        // compiles, only how many files one task prints.
