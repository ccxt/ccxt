...
git add php/*.php php/async/*.php php/async_implementation/*.php php/test/*.php python/ccxt/test/*.py python/ccxt/async_support/*.py python/ccxt/*.py python/ccxt/async_implementation/*.py wiki/*
