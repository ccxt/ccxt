...
git add CHANGELOG.md dist/cjs/**/* dist/ccxt.browser.js dist/ccxt.browser.min.js ts/ccxt.ts js/**/** php/*.php php/async/*.php php/pro/*.php php/test/*.php python/ccxt/test/*.py python/ccxt/async_support/*.py python/ccxt/*.py python/ccxt/pro/*.py python/ccxt/pro/test/*.py python/ccxt/pro/test/exchange/*.py wiki/*
