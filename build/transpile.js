...
// insert common regexes in the middle (critical)
    ...
    [ /\.totp/g, '.class.totp'],
    [ /\.json/g, '.class.json'],
    [ /\.unjson/g, '.class.unjson'],
    [ /\.binary_concat/g, '.class.binary_concat'],
    [ /\.binary_to_string/g, '.class.binary_to_string'],
    [ /\.rawencode/g, '.class.rawencode'],
    [ /\.base64urlencode/g, '.class.base64urlencode'],
    [ /\.aggregate/g, '.class.aggregate'],
    [ /\.array_concat/g, '.class.array_concat'],
    [ /\.deep_extend/g, '.class.deep_extend'],
    [ /\.encode/g, '.class.encode'],
    [ /\.decode/g, '.class.decode'],
    [ /\.encode_uri_component/g, '.class.encode_uri_component'],
    [ /\.extract_params/g, '.class.extract_params'],
    [ /\.implode_params/g, '.class.implode_params'],
    [ /\.filterBy/g, '.class.filterBy'],
    [ /\.filter_by/g, '.class.filter_by'],
    [ /\.groupBy/g, '.class.groupBy'],
    [ /\.group_by/g, '.class.group_by'],
    [ /\.in_array/g, '.class.in_array'],
    [ /\.index_by/g, '.class.index_by'],
    [ /\.is_empty/g, '.class.is_empty'],
    [ /\.is_json_encoded_object/g, '.class.is_json_encoded_object'],
    [ /\.keysort/g, '.class.keysort'],
    [ /\.omit/g, '.class.omit'],
    [ /\.ordered/g, '.class.ordered'],
    [ /\.pluck/g, '.class.pluck'],
    ...
    [ /\.sort_by/g, '.class.sort_by'],
    [ /\.sum/g, '.class.sum'],
    [ /\.to_array/g, '.class.to_array'],
    [ /\.truncate/g, '.class.truncate'],
    [ /\.truncate_to_string/g, '.class.truncate_to_string'],
    [ /\.unique/g, '.class.unique'],
    [ /\.url/g, '.class.url'],
    [ /\.urlencode/g, '.class.urlencode'],
    [ /\.iso8601/g, '.class.iso8601'],
    [ /\.dmy/g, '.class.dmy'],
    [ /\.parse8601/g, '.class.parse8601'],
    [ /\.parse_date/g, '.class.parse_date'],
    [ /\.ymd/g, '.class.ymd'],
    [ /\.ymdhms/g, '.class.ymdhms'],
    [ /\.capitalize/g, '.class.capitalize'],
    [ /\.raise_error/g, '.class.raise_error'],
    [ /\.safe_currency_code/g, '.class.safe_currency_code'],
    [ /\.common_currency_code/g, '.class.common_currency_code'],
    [ /\.currency_id/g, '.class.currency_id'],
    [ /\.decimal_to_precision/g, '.class.decimal_to_precision'],
    [ /\.precision_from_string/g, '.class.precision_from_string'],
    [ /\.cost_to_precision/g, '.class.cost_to_precision'],
    [ /\.price_to_precision/g, '.class.price_to_precision'],
    [ /\.amount_to_precision/g, '.class.amount_to_precision'],
    [ /\.fee_to_precision/g, '.class.fee_to_precision'],
    [ /\.currency_to_precision/g, '.class.currency_to_precision'],
    [ /\.find_broadly_matched_key/g, '.class.find_broadly_matched_key'],
    [ /\.check_required_credentials/g, '.class.check_required_credentials'],
    [ /\.check_address/g, '.class.check_address'],
    [ /\.find_market/g, '.class.find_market'],
    [ /\.find_symbol/g, '.class.find_symbol'],
    [ /\.market_ids/g, '.class.market_ids'],
    [ /\.market_id/g, '.class.market_id'],
    [ /\.calculate_fee/g, '.class.calculate_fee'],
    [ /\.edit_limit_buy_order/g, '.class.edit_limit_buy_order'],
    [ /\.edit_limit_sell_order/g, '.class.edit_limit_sell_order'],
    [ /\.edit_limit_order/g, '.class.edit_limit_order'],
    [ /\.edit_order/g, '.class.edit_order'],
    [ /\.create_limit_order/g, '.class.create_limit_order'],
    [ /\.create_market_order/g, '.class.create_market_order'],
    [ /\.create_limit_buy_order/g, '.class.create_limit_buy_order'],
    [ /\.create_limit_sell_order/g, '.class.create_limit_sell_order'],
    [ /\.create_market_buy_order/g, '.class.create_market_buy_order'],
    [ /\.create_market_sell_order/g, '.class.create_market_sell_order'],
    [ /\.parse_trades/g, '.class.parse_trades'],
    [ /\.parse_ledger/g, '.class.parse_ledger'],
    [ /\.parse_transactions/g, '.class.parse_transactions'],
    [ /\.parse_orders/g, '.class.parse_orders'],
    [ /\.filter_by_value_since_limit/g, '.class.filter_by_value_since_limit'],
    [ /\.filter_by_symbol_since_limit/g, '.class.filter_by_symbol_since_limit'],
    [ /\.filter_by_currency_since_limit/g, '.class.filter_by_currency_since_limit'],
    [ /\.filter_by_since_limit/g, '.class.filter_by_since_limit'],
    [ /\.filter_by_symbol/g, '.class.filter_by_symbol'],
    [ /\.filter_by_array/g, '.class.filter_by_array'],
    [ /\.currency/g, '.class.currency'],
    [ /\.decrypt_account_from_private_key/g, '.class.decrypt_account_from_private_key'],
    [ /\.decrypt_account/g, '.class.decrypt_account'],
    [ /\.decrypt_account_from_json/g, '.class.decrypt_account_from_json'],
    [ /\.eth_decimals/g, '.class.eth_decimals'],
    [ /\.eth_unit/g, '.class.eth_unit'],
    [ /\.fromWei/g, '.class.fromWei'],
    [ /\.toWei/g, '.class.toWei'],
