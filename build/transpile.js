...
class Transpiler {
    ...
    createPythonImports (baseClass, bodyAsString, className, async = false) {
        ...
        const matchAgainst = [ /-> Balances/, /-> Order:/, /-> OrderBook/, /: OrderSide/, /: OrderType/, /: IndexType/, /\[FundingHistory/, /-> Ticker/, /-> (?:List\[)?Trade/, /-> (?:List\[)?Transaction/, /-> Greeks/ ]
        const objects = [ 'Balances', 'Order', 'OrderBook', 'OrderSide', 'OrderType', 'IndexType', 'FundingHistory', 'Ticker', 'Trade', 'Transaction', 'Greeks' ]
        const matches = []
        let match
