...
class Transpiler {
    ...
    getCommonRegexes () {
        return [
            ...
            [ /\.setProperty\s/g, '.set_property'],
            [ /\.propertyExists\s/g, '.property_exists'],
    ...
    getPythonRegexes () {
        ...
        // insert common regexes in the middle (critical)
            ...
            [ /([^\s\(]+) in this/g, 'hasattr(self, $1)' ],
            [ /this\[\([^\s\(]+)\] = (.*?);/g, 'setattr(self, $1, $2)' ],
            [ /this\[\([^\s\(]+)\]/g, 'getattr(self, $1)' ],
            [ /this\./g, 'self.' ],
    ...
    getPHPRegexes () {
        ...
        // insert common regexes in the middle (critical)
            ...
            [ /([^\s\(]+) in this/g, 'property_exists($this, $1)' ],
            [ /this\[\([^\s\(]+)\]/g, '$this->$1' ],
            [ /this\./g, '$this->' ],
            [ / this;/g, ' $this;' ],
            [ /([^'])this_\./g, '$1$this_->' ],
