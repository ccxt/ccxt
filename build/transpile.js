...
class Transpiler {
    ...
    getCommonRegexes () {
        return [
            ...
            [ /\.createNetworksDataContainer\s/g, '.create_networks_data_container'],
            [ /\.setNetworkMappingForCurrencyNetworkJunction\s/g, '.set_network_mapping_for_currency_network_junction'],
            [ /\.setNetworkMappingForNetworkCurrencyJunction\s/g, '.set_network_mapping_for_network_currency_junction'],
            [ /\.handleNetworkIdAndParams\s/g, '.handle_network_id_and_params'],
            [ /\.handleCurrencyIdAndParams\s/g, '.handle_currency_id_and_params'],
            [ /\.extractNetworkCodeFromNetworkId\s/g, '.extract_network_code_from_network_id'],
            [ /\.extractCurrencyCodeAndNetworkCodeFromCurrencyId\s/g, '.extract_currency_code_and_network_code_from_currency_id'],
