...
// ---------------------------------------------------------------------------------------------
// java.util import collapsing, shared by every generator that writes Java under java/lib and
// java/tests (this file, build/generateJavaWrappers.ts, build/generateImplicitAPI.ts).
//
...
// that habit. Across the generated tree that was ~110k fully-qualified occurrences. The
// helpers below rewrite those references to their simple names and add the matching
// single-type `import` declarations once at the top of the file instead.
//
            ...
            `public class BaseError extends RuntimeException
{
    ...
    // shortened to simple `java.util.*` names first (see shortenJavaUtilReferences above) and the
