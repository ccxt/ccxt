...
async function vssEverything () {
    ...
    vss ('./c#/ccxt/base/Exchange.MetaData.cs',          "public static string ccxtVersion = \"{version}\";",      version)
    vss ('./c#/ccxt/ccxt.csproj',                         "<PackageVersion>{version}</PackageVersion>",            version)
    vss ('./c#/ccxt/ccxt.csproj',                         "<AssemblyVersion>{version}</AssemblyVersion>",          version)
    vss ('./c#/ccxt/ccxt.csproj',                         "<FileVersion>{version}</FileVersion>",                  version)
