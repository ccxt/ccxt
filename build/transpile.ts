...
class Transpiler {
    ...
    createPythonImports (baseClass: string, bodyAsString: string, className: string, async = false) {
        ...
        const matchObject = {
            ...
            'PredictionOutcomeInterface': /: (?:List\[)?PredictionOutcomeInterface/,
