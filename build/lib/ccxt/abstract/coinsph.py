...
class ImplicitAPI:
    ...
    private_post_openapi_v1_order_cancelreplace = privatePostOpenapiV1OrderCancelReplace = Entry('openapi/v1/order/cancelReplace', 'private', 'POST', {'cost': 1})
    ...
    private_post_openapi_convert_v1_accept_quote = privatePostOpenapiConvertV1AcceptQuote = Entry('openapi/convert/v1/accept-quote', 'private', 'POST', {'cost': 1})
    ...
    private_post_openapi_otc_trade_v1_get_supported_trading_pairs = privatePostOpenapiOtcTradeV1GetSupportedTradingPairs = Entry('openapi/otc-trade/v1/get-supported-trading-pairs', 'private', 'POST', {'cost': 1})
    private_post_openapi_otc_trade_v1_create_rfq = privatePostOpenapiOtcTradeV1CreateRfq = Entry('openapi/otc-trade/v1/create-rfq', 'private', 'POST', {'cost': 1})
    private_post_openapi_otc_trade_v1_accept_rfq = privatePostOpenapiOtcTradeV1AcceptRfq = Entry('openapi/otc-trade/v1/accept-rfq', 'private', 'POST', {'cost': 1})
    private_post_openapi_otc_trade_v1_manual_settle = privatePostOpenapiOtcTradeV1ManualSettle = Entry('openapi/otc-trade/v1/manual-settle', 'private', 'POST', {'cost': 1})
    private_post_openapi_otc_trade_v1_query_order_history = privatePostOpenapiOtcTradeV1QueryOrderHistory = Entry('openapi/otc-trade/v1/query-order-history', 'private', 'POST', {'cost': 1})
    ...
    private_post_openapi_transfer_v4_transfers = privatePostOpenapiTransferV4Transfers = Entry('openapi/transfer/v4/transfers', 'private', 'POST', {'cost': 1})
