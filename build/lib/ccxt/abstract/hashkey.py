...
class ImplicitAPI:
    ...
    private_get_api_v1_coininfo = privateGetApiV1CoinInfo = Entry('api/v1/coinInfo', 'private', 'GET', {'cost': 1})
    ...
    private_get_api_v1_account_chaintype = privateGetApiV1AccountChainType = Entry('api/v1/account/chainType', 'private', 'GET', {'cost': 1})
