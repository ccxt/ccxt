...
class ImplicitAPI:
    ...
    contract_public_get_v5_market_funding_rate = contractPublicGetV5MarketFundingRate = Entry('v5/market/funding_rate', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_funding_rate_history = contractPublicGetV5MarketFundingRateHistory = Entry('v5/market/funding_rate_history', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_open_interest = contractPublicGetV5MarketOpenInterest = Entry('v5/market/open_interest', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_liquidation_orders = contractPublicGetV5MarketLiquidationOrders = Entry('v5/market/liquidation_orders', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_settlement_history = contractPublicGetV5MarketSettlementHistory = Entry('v5/market/settlement_history', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_elite_account_ratio = contractPublicGetV5MarketEliteAccountRatio = Entry('v5/market/elite_account_ratio', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_elite_position_ratio = contractPublicGetV5MarketElitePositionRatio = Entry('v5/market/elite_position_ratio', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_estimated_settlement_price = contractPublicGetV5MarketEstimatedSettlementPrice = Entry('v5/market/estimated_settlement_price', ['contract', 'public'], 'GET', {'cost': 0.125})
    contract_public_get_v5_market_price_limit = contractPublicGetV5MarketPriceLimit = Entry('v5/market/price_limit', ['contract', 'public'], 'GET', {'cost': 0.125})
    ...
    contract_private_get_v5_account_asset_mode = contractPrivateGetV5AccountAssetMode = Entry('v5/account/asset_mode', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_account_balance = contractPrivateGetV5AccountBalance = Entry('v5/account/balance', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_account_bills = contractPrivateGetV5AccountBills = Entry('v5/account/bills', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_account_fee_deduction_currency = contractPrivateGetV5AccountFeeDeductionCurrency = Entry('v5/account/fee_deduction_currency', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_trade_position_opens = contractPrivateGetV5TradePositionOpens = Entry('v5/trade/position/opens', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_trade_order_opens = contractPrivateGetV5TradeOrderOpens = Entry('v5/trade/order/opens', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_trade_order_details = contractPrivateGetV5TradeOrderDetails = Entry('v5/trade/order/details', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_trade_order_history = contractPrivateGetV5TradeOrderHistory = Entry('v5/trade/order/history', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_trade_order = contractPrivateGetV5TradeOrder = Entry('v5/trade/order', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_position_lever = contractPrivateGetV5PositionLever = Entry('v5/position/lever', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_position_mode = contractPrivateGetV5PositionMode = Entry('v5/position/mode', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_position_risk_limit = contractPrivateGetV5PositionRiskLimit = Entry('v5/position/risk/limit', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_position_risk_limit_tier = contractPrivateGetV5PositionRiskLimitTier = Entry('v5/position/risk/limit_tier', ['contract', 'private'], 'GET', {'cost': 0.20834})
    contract_private_get_v5_market_risk_limit = contractPrivateGetV5MarketRiskLimit = Entry('v5/market/risk/limit', ['contract', 'private'], 'GET', {'cost': 0.125})
    contract_private_get_v5_market_assets_deduction_currency = contractPrivateGetV5MarketAssetsDeductionCurrency = Entry('v5/market/assets_deduction_currency', ['contract', 'private'], 'GET', {'cost': 0.125})
    contract_private_get_v5_market_multi_assets_margin = contractPrivateGetV5MarketMultiAssetsMargin = Entry('v5/market/multi_assets_margin', ['contract', 'private'], 'GET', {'cost': 0.125})
    contract_private_get_v5_algo_order_opens = contractPrivateGetV5AlgoOrderOpens = Entry('v5/algo/order/opens', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_algo_order = contractPrivateGetV5AlgoOrder = Entry('v5/algo/order', ['contract', 'private'], 'GET', {'cost': 0.41679})
    contract_private_get_v5_algo_order_history = contractPrivateGetV5AlgoOrderHistory = Entry('v5/algo/order/history', ['contract', 'private'], 'GET', {'cost': 0.41679})
    ...
    contract_private_post_v5_account_asset_mode = contractPrivatePostV5AccountAssetMode = Entry('v5/account/asset_mode', ['contract', 'private'], 'POST', {'cost': 100})
    contract_private_post_v5_trade_order = contractPrivatePostV5TradeOrder = Entry('v5/trade/order', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_batch_orders = contractPrivatePostV5TradeBatchOrders = Entry('v5/trade/batch_orders', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_cancel_order = contractPrivatePostV5TradeCancelOrder = Entry('v5/trade/cancel_order', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_cancel_batch_orders = contractPrivatePostV5TradeCancelBatchOrders = Entry('v5/trade/cancel_batch_orders', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_cancel_all_orders = contractPrivatePostV5TradeCancelAllOrders = Entry('v5/trade/cancel_all_orders', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_cancel_after = contractPrivatePostV5TradeCancelAfter = Entry('v5/trade/cancel-after', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_position = contractPrivatePostV5TradePosition = Entry('v5/trade/position', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_trade_position_all = contractPrivatePostV5TradePositionAll = Entry('v5/trade/position_all', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_position_lever = contractPrivatePostV5PositionLever = Entry('v5/position/lever', ['contract', 'private'], 'POST', {'cost': 0.20834})
    contract_private_post_v5_position_mode = contractPrivatePostV5PositionMode = Entry('v5/position/mode', ['contract', 'private'], 'POST', {'cost': 0.20834})
    contract_private_post_v5_position_margin = contractPrivatePostV5PositionMargin = Entry('v5/position/margin', ['contract', 'private'], 'POST', {'cost': 0.20834})
    contract_private_post_v5_account_fee_deduction_currency = contractPrivatePostV5AccountFeeDeductionCurrency = Entry('v5/account/fee_deduction_currency', ['contract', 'private'], 'POST', {'cost': 0.20834})
    contract_private_post_v5_algo_order = contractPrivatePostV5AlgoOrder = Entry('v5/algo/order', ['contract', 'private'], 'POST', {'cost': 0.41679})
    contract_private_post_v5_algo_cancel_orders = contractPrivatePostV5AlgoCancelOrders = Entry('v5/algo/cancel_orders', ['contract', 'private'], 'POST', {'cost': 0.41679})
