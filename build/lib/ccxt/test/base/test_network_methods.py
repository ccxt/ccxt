...
def helper_test_network_code_to_id(networks_map):
    ...
    exchange.currencies = exchange.map_to_safe_map({})  # go fix + c# uninitialized prop fix
    #
    #
...
def helper_test_network_id_to_code(networks_map):
    # we should conduct tests with such example configuration
    exchange = ccxt.Exchange({
        'id': 'sampleexchange',
        'options': {
...
def helper_batch_network_tests():
    exchange = ccxt.Exchange({
        'id': 'sampleexchange',
    })
    #
