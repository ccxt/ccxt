...
function localInitializerType (printer, declaration, isProFile, narrowed) {
    ...
    if (!isThisCall (initializer)) {
        ...
        // JN-27: the test harness's non-this calls (section 5 concrete base methods,
        // Object.keys, bare harness helpers) sit behind the receiver families
    ...
    // section 5 (JN-27): the test harness's own `this.<helper>(...)` calls (ts/src/test/**)
    return concreteCallLocalType (printer, initializer);
}
