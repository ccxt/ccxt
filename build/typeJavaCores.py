...
def main():
    ...
    # JN-2 slice: the prediction tier is untouched (PredictionExchange extends
    # BaseExchange, a sibling of Exchange, so the crypto-tier retype cannot reach
    # it). PREDICTION_TYPED_CORES is deliberately empty -- keep the list empty.
    pred = []
