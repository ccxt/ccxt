...
export const GENERATED_BANNER_LINES = [
    'This file is generated from ts/src/base/types.ts by build/transpileTypes.ts.',
    'PLEASE DO NOT EDIT IT BY HAND — run `npm run transpile-types` instead.',
];
