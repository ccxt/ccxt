...
(function () {
    ...
    var btcchina = {
        ...
        createOrder: function createOrder(product, type, side, amount) {
            ...
            var p = this.product(product);
            var method = 'privatePost' + side.toUpperCase() + 'Order2';
            var order = {};
