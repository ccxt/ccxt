...
(function () {
        ...
        fetchOrderBook: function fetchOrderBook(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                for (s = 0; s < sides.length; s++) {
                    ...
                    for (i = 0; i < orders.length; i++) {
                        order = orders[i];
                        _timestamp2 = parseInt(order[2]) * 1000;
    ...
    var bitbay = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this19.publicGetIdTicker({
    ...
    var bitbays = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this20.publicGetTicker({
    ...
    var bitcoincoid = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                pair = _this21.product(product);
                return _this21.publicGetPairTicker({
                    'pair': pair['id']
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var bitfinex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this22.publicGetSymbolsDetails();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this23.publicGetPubtickerSymbol({
    ...
    var bitlish = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                p = _this25.product(product);
                return _this25.publicGetTickers();
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[p['id']];
    ...
    var bitmarket = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this26.publicGetJsonMarketTicker({
                    'market': _this26.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var bitmex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this27.publicGetInstrumentActive();
            }).then(function (_resp) {
                products = _resp;
                result = [];
                ...
                for (p = 0; p < products.length; p++) {
                    ...
                    base = _this27.commonCurrencyCode(base);
                    quote = _this27.commonCurrencyCode(quote);
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                request = {
                    'symbol': _this28.productId(product),
                    'binSize': '1d',
                    'partial': true,
                    'count': 1,
                    'reverse': true
                };
                return _this28.publicGetQuoteBucketed(request);
            }).then(function (_resp) {
                quotes = _resp;
                quotesLength = quotes.length;
                quote = quotes[quotesLength - 1];
                return _this28.publicGetTradeBucketed(request);
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[0];
    ...
    var bitso = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this29.publicGetAvailableBooks();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this30.publicGetTicker({
                    'book': _this30.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['payload'];
                timestamp = _this30.parse8601(ticker['created_at']);
    ...
    var bittrex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this32.publicGetMarkets();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this33.publicGetMarketsummary({
    ...
    var btcx = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this38.publicGetTickerId({
                    'id': _this38.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var bxinth = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this39.publicGetPairing();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this40.publicGet({ 'pairing': p['id'] });
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[p['id']];
    ...
    var ccex = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this42.tickersGetMarket({
                    'market': _this42.productId(product).toLowerCase()
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['ticker'];
    ...
    var cex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this43.publicGetCurrencyLimits();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this44.publicGetTickerPair({
                    'pair': _this44.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = parseInt(ticker['timestamp']) * 1000;
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this46.publicGetTicker({
                    'currencyPair': _this46.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['data'];
    ...
    var coinsecure = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this47.publicGetExchangeTicker();
            }).then(function (_resp) {
                response = _resp;
    ...
    var exmo = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this48.publicGetPairSettings();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
    ...
    var fyb = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this50.publicGetTickerdetailed();
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var gdax = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this51.publicGetProducts();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this52.publicGetProductsIdTicker({
                    'id': p['id']
                });
            }).then(function (_resp) {
                ticker = _resp;
                return _this52.publicGetProductsIdStats({
                    'id': p['id']
                });
            }).then(function (_resp) {
                quote = _resp;
                timestamp = _this52.parse8601(ticker['time']);
    ...
    var gemini = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this53.publicGetSymbols();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this54.publicGetPubtickerSymbol({
                    'symbol': p['id']
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var hitbtc = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this55.publicGetSymbols();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this56.publicGetSymbolTicker({
                    'symbol': _this56.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = ticker['timestamp'];
    ...
    var itbit = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this58.publicGetMarketsSymbolTicker({
                    'symbol': _this58.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = _this58.parse8601(ticker['serverTimeUTC']);
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this59.publicGetTicker({
                    'coin': _this59.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var kraken = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this60.publicGetAssetPairs();
            }).then(function (_resp) {
                products = _resp;
                ...
                for (p = 0; p < keys.length; p++) {
                    ...
                    if (base[0] == 'X' || base[0] == 'Z') {
                        ...
                        quote = quote.slice(1);
                    }base = _this60.commonCurrencyCode(base);
                    quote = _this60.commonCurrencyCode(quote);
    ...
    var luno = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this62.publicGetTickers();
            }).then(function (_resp) {
                products = _resp;
                result = [];
                ...
                for (p = 0; p < products['tickers'].length; p++) {
                    ...
                    base = _this62.commonCurrencyCode(base);
                    quote = _this62.commonCurrencyCode(quote);
                    symbol = base + '/' + quote;
    ...
    var mercado = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                p = _this64.product(product);
                method = 'publicGetV2Ticker' + _this64.capitalize(p['suffix']);
                return _this64[method]();
            }).then(function (_resp) {
                response = _resp;
                ticker = response['ticker'];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this65.publicGetTicker({
                    'symbol': _this65.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['ticker'];
    ...
    var paymium = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this66.publicGetDataIdTicker({
    ...
    var poloniex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this67.publicGetReturnTicker();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this68.publicGetReturnTicker();
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[p['id']];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this69.publicGetTicker({
                    'book': _this69.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = parseInt(ticker['timestamp']) * 1000;
    ...
    var quoine = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this70.publicGetProducts();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this71.publicGetProductsId({
    ...
    var therock = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this72.publicGetFundsTickers();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this73.publicGetFundsIdTicker({
                    'id': _this73.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = _this73.parse8601(ticker['date']);
    ...
    var vaultoro = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                result = [];
                return _this74.publicGetMarkets();
            }).then(function (_resp) {
                products = _resp;
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this75.publicGetBidandask();
            }).then(function (_resp) {
                quote = _resp;
                bidsLength = quote['bids'].length;
                bid = quote['bids'][bidsLength - 1];
                ask = quote['asks'][0];
                return _this75.publicGetMarkets();
            }).then(function (_resp) {
                response = _resp;
                ticker = response['data'];
    ...
    var virwox = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this76.publicGetInstruments();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products['result']);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                end = _this77.milliseconds();
                start = end - 86400000;
                return _this77.publicGetTradedPriceVolume({
                    'instrument': _this77.symbol(product),
                    'endDate': _this77.yyyymmddhhmmss(end),
                    'startDate': _this77.yyyymmddhhmmss(start),
                    'HLOC': 1
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var yobit = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this79.apiGetTickerPairs({
                    'pairs': p['id']
                });
            }).then(function (_resp) {
                tickers = _resp;
    ...
    var zaif = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this80.apiGetCurrencyPairsAll();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this81.apiGetTickerPair({
                    'pair': _this81.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,