...
(function () {
    ...
    var coinsecure = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this39.publicGetExchangeTicker();
            }).then(function (_resp) {
                response = _resp;
    ...
    var exmo = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this40.publicGetPairSettings();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
    ...
    var fyb = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this42.publicGetTickerdetailed();
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var gdax = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this43.publicGetProducts();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this44.publicGetProductsIdTicker({
                    'id': p['id']
                });
            }).then(function (_resp) {
                ticker = _resp;
                return _this44.publicGetProductsIdStats({
                    'id': p['id']
                });
            }).then(function (_resp) {
                quote = _resp;
                timestamp = _this44.parse8601(ticker['time']);
    ...
    var hitbtc = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this45.publicGetSymbols();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this46.publicGetSymbolTicker({
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this48.publicGetTicker({
                    'coin': _this48.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var kraken = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this49.publicGetAssetPairs();
            }).then(function (_resp) {
                products = _resp;
                ...
                for (p = 0; p < keys.length; p++) {
                    ...
                    if (base[0] == 'X' || base[0] == 'Z') {
                        ...
                        quote = quote.slice(1);
                    }base = _this49.commonCurrencyCode(base);
                    quote = _this49.commonCurrencyCode(quote);
    ...
    var luno = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this51.publicGetTickers();
            }).then(function (_resp) {
                products = _resp;
                result = [];
                ...
                for (p = 0; p < products['tickers'].length; p++) {
                    ...
                    base = _this51.commonCurrencyCode(base);
                    quote = _this51.commonCurrencyCode(quote);
                    symbol = base + '/' + quote;
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this52.publicGetTicker({
                    'pair': _this52.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = ticker['timestamp'];
    ...
    var paymium = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this54.publicGetDataIdTicker({
    ...
    var poloniex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this55.publicGetReturnTicker();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this57.publicGetTicker({
                    'book': _this57.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = parseInt(ticker['timestamp']) * 1000;
    ...
    var quoine = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this58.publicGetProducts();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this59.publicGetProductsId({
    ...
    var therock = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this60.publicGetFundsTickers();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this61.publicGetFundsIdTicker({
                    'id': _this61.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = _this61.parse8601(ticker['date']);
    ...
    var vaultoro = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                result = [];
                return _this62.publicGetMarkets();
            }).then(function (_resp) {
                products = _resp;
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this63.publicGetBidandask();
            }).then(function (_resp) {
                quote = _resp;
    ...
    var virwox = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this64.publicGetInstruments();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products['result']);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                end = _this65.milliseconds();
                start = end - 86400000;
                return _this65.publicGetTradedPriceVolume({
                    'instrument': _this65.symbol(product),
                    'endDate': _this65.yyyymmddhhmmss(end),
                    'startDate': _this65.yyyymmddhhmmss(start),
                    'HLOC': 1
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var yobit = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this67.apiGetTickerPairs({
                    'pairs': p['id']
                });
            }).then(function (_resp) {
                tickers = _resp;
    ...
    var zaif = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this68.apiGetCurrencyPairsAll();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this69.apiGetTickerPair({
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,