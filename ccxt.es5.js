...
(function () {
    ...
    var _1broker = {
        ...
        fetchOrderBook: function fetchOrderBook(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                timestamp = _this11.parse8601(book['updated']);
                bidPrice = parseFloat(book['bid']);
                askPrice = parseFloat(book['ask']);
                bid = [bidPrice];
                ask = [askPrice];
    ...
    var anxpro = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this14.publicGetCurrencyPairMoneyTicker({
                    'currency_pair': _this14.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var bit2c = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this15.publicGetExchangesPairTicker({
                    'pair': _this15.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var bitbay = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this16.publicGetIdTicker({
                    'id': _this16.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var bitbays = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this17.publicGetTicker({
                    'market': _this17.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var bitcoincoid = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                pair = _this18.product(product);
                return _this18.publicGetPairTicker({
                    'pair': pair['id']
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var bitfinex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this19.publicGetSymbolsDetails();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this20.publicGetPubtickerSymbol({
    ...
    var bitlish = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                p = _this22.product(product);
                return _this22.publicGetTickers();
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[p['id']];
    ...
    var bitmarket = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this23.publicGetJsonMarketTicker({
                    'market': _this23.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var bitmex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this24.publicGetInstrumentActive();
            }).then(function (_resp) {
                products = _resp;
                result = [];
                ...
                for (p = 0; p < products.length; p++) {
                    ...
                    base = _this24.commonCurrencyCode(base);
                    quote = _this24.commonCurrencyCode(quote);
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                request = {
                    'symbol': _this25.productId(product),
                    'binSize': '1d',
                    'partial': true,
                    'count': 1,
                    'reverse': true
                };
                return _this25.publicGetQuoteBucketed(request);
            }).then(function (_resp) {
                quotes = _resp;
                quotesLength = quotes.length;
                quote = quotes[quotesLength - 1];
                return _this25.publicGetTradeBucketed(request);
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[0];
    ...
    var bitso = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this26.publicGetAvailableBooks();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this27.publicGetTicker({
                    'book': _this27.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['payload'];
                timestamp = _this27.parse8601(ticker['created_at']);
    ...
    var bittrex = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this30.publicGetMarketsummary({
                    'market': _this30.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var btcchina = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this31.publicGetTicker({
                    'market': 'all'
                });
            }).then(function (_resp) {
                products = _resp;
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this32.publicGetTicker({
                    'market': p['id']
                });
            }).then(function (_resp) {
                tickers = _resp;
    ...
    var btcx = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this35.publicGetTickerId({
                    'id': _this35.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var bxinth = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this36.publicGetPairing();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this37.publicGet({ 'pairing': p['id'] });
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[p['id']];
    ...
    var ccex = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this39.tickersGetMarket({
                    'market': _this39.productId(product).toLowerCase()
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['ticker'];
    ...
    var cex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this40.publicGetCurrencyLimits();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this41.publicGetTickerPair({
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this43.publicGetTicker({
                    'currencyPair': _this43.productId(product)
                });
            }).then(function (_resp) {
                response = _resp;
                ticker = response['data'];
    ...
    var coinsecure = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this44.publicGetExchangeTicker();
            }).then(function (_resp) {
                response = _resp;
    ...
    var exmo = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this45.publicGetPairSettings();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
    ...
    var fyb = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this47.publicGetTickerdetailed();
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var gdax = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this48.publicGetProducts();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this49.publicGetProductsIdTicker({
                    'id': p['id']
                });
            }).then(function (_resp) {
                ticker = _resp;
                return _this49.publicGetProductsIdStats({
                    'id': p['id']
                });
            }).then(function (_resp) {
                quote = _resp;
                timestamp = _this49.parse8601(ticker['time']);
    ...
    var gemini = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this51.publicGetPubtickerSymbol({
                    'symbol': p['id']
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var hitbtc = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this52.publicGetSymbols();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this53.publicGetSymbolTicker({
    ...
    var itbit = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this55.publicGetMarketsSymbolTicker({
                    'symbol': _this55.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = _this55.parse8601(ticker['serverTimeUTC']);
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this56.publicGetTicker({
                    'coin': _this56.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
    ...
    var kraken = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this57.publicGetAssetPairs();
            }).then(function (_resp) {
                products = _resp;
    ...
    var luno = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this59.publicGetTickers();
            }).then(function (_resp) {
                products = _resp;
                result = [];
                ...
                for (p = 0; p < products['tickers'].length; p++) {
                    ...
                    base = _this59.commonCurrencyCode(base);
                    quote = _this59.commonCurrencyCode(quote);
                    symbol = base + '/' + quote;
    ...
    var mercado = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                method = 'publicGetV2Ticker' + _this61.capitalize(p['suffix']);
                return _this61[method]();
            }).then(function (_resp) {
                response = _resp;
                ticker = response['ticker'];
    ...
    var paymium = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this63.publicGetDataIdTicker({
    ...
    var poloniex = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this64.publicGetReturnTicker();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this65.publicGetReturnTicker();
            }).then(function (_resp) {
                tickers = _resp;
                ticker = tickers[p['id']];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this66.publicGetTicker({
                    'book': _this66.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = parseInt(ticker['timestamp']) * 1000;
    ...
    var quoine = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this68.publicGetProductsId({
    ...
    var therock = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this69.publicGetFundsTickers();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this70.publicGetFundsIdTicker({
                    'id': _this70.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
                timestamp = _this70.parse8601(ticker['date']);
    ...
    var vaultoro = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this72.publicGetBidandask();
            }).then(function (_resp) {
                quote = _resp;
    ...
    var virwox = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this73.publicGetInstruments();
            }).then(function (_resp) {
                products = _resp;
                keys = Object.keys(products['result']);
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                end = _this74.milliseconds();
                start = end - 86400000;
                return _this74.publicGetTradedPriceVolume({
                    'instrument': _this74.symbol(product),
                    'endDate': _this74.yyyymmddhhmmss(end),
                    'startDate': _this74.yyyymmddhhmmss(start),
                    'HLOC': 1
                });
            }).then(function (_resp) {
                response = _resp;
    ...
    var yobit = {
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                ...
                return _this76.apiGetTickerPairs({
                    'pairs': p['id']
                });
            }).then(function (_resp) {
                tickers = _resp;
    ...
    var zaif = {
        ...
        fetchProducts: function fetchProducts() {
            ...
            return Promise.resolve().then(function () {
                return _this77.apiGetCurrencyPairsAll();
            }).then(function (_resp) {
                products = _resp;
                result = [];
        ...
        fetchTicker: function fetchTicker(product) {
            ...
            return Promise.resolve().then(function () {
                return _this78.apiGetTickerPair({
                    'pair': _this78.productId(product)
                });
            }).then(function (_resp) {
                ticker = _resp;
...
//# sourceMappingURL=data:application/json;charset=utf-8;base64,