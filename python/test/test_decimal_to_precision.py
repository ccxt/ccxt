...
assert decimal_to_precision('12.3456000', TRUNCATE, 10, AFTER_DOT, NO_PADDING) == '12.3456'
assert decimal_to_precision('12.3456', TRUNCATE, 27, AFTER_DOT, NO_PADDING) == '12.3456'
assert decimal_to_precision('12.3456', TRUNCATE, 4, AFTER_DOT, NO_PADDING) == '12.3456'
assert decimal_to_precision('12.3456', TRUNCATE, 3, AFTER_DOT, NO_PADDING) == '12.345'
assert decimal_to_precision('12.3456', TRUNCATE, 2, AFTER_DOT, NO_PADDING) == '12.34'
assert decimal_to_precision('12.3456', TRUNCATE, 1, AFTER_DOT, NO_PADDING) == '12.3'
assert decimal_to_precision('12.3456', TRUNCATE, 0, AFTER_DOT, NO_PADDING) == '12'
...
assert decimal_to_precision('12.3456000', ROUND, 27, AFTER_DOT, NO_PADDING) == '12.3456'
assert decimal_to_precision('12.3456', ROUND, 27, AFTER_DOT, NO_PADDING) == '12.3456'
assert decimal_to_precision('12.3456', ROUND, 4, AFTER_DOT, NO_PADDING) == '12.3456'
assert decimal_to_precision('12.3456', ROUND, 3, AFTER_DOT, NO_PADDING) == '12.346'
assert decimal_to_precision('12.3456', ROUND, 2, AFTER_DOT, NO_PADDING) == '12.35'
assert decimal_to_precision('12.3456', ROUND, 1, AFTER_DOT, NO_PADDING) == '12.3'
assert decimal_to_precision('12.3456', ROUND, 0, AFTER_DOT, NO_PADDING) == '12'
assert decimal_to_precision('9.999', ROUND, 3, AFTER_DOT, NO_PADDING) == '9.999'
assert decimal_to_precision('9.999', ROUND, 2, AFTER_DOT, NO_PADDING) == '10'
assert decimal_to_precision('9.999', ROUND, 2, AFTER_DOT, PAD_WITH_ZERO) == '10.00'
assert decimal_to_precision('99.999', ROUND, 2, AFTER_DOT, PAD_WITH_ZERO) == '100.00'
assert decimal_to_precision('-99.999', ROUND, 2, AFTER_DOT, PAD_WITH_ZERO) == '-100.00'
...
assert decimal_to_precision('-0.123456', TRUNCATE, 5, AFTER_DOT, NO_PADDING) == '-0.12345'
assert decimal_to_precision('-0.123456', ROUND, 5, AFTER_DOT, NO_PADDING) == '-0.12346'
