...
class quadency(Exchange):
    ...
    def fetch_markets(self, params={}):
        response = self.publicGetFrontofficeApiInfo()
        # Response
        # {
    ...
    def fetch_order_book(self, symbol='BTC/USDT', limit=50, params={}):
        ...
        response = self.publicGetMarketdataInstrumentsIdDepth(self.extend(request, params))
    ...
    def fetch_ohlcv(self, symbol, timeframe='1h', since=None, limit=1000, params={}):
        # Response
        # {
        #     "success": True,
        #     "instrument": "btc_usdt",
        ...
        response = self.publicGetMarketdataInstrumentsIdHistory(self.extend(request, params))
    ...
    def fetch_trades(self, symbol='BTC/USDT', since=None, limit=None, params={}):
        ...
        response = self.publicbase2GetTradesId(self.extend(request, params))
    ...
    def fetch_ticker(self, symbol, params={}):
        ...
        # }
        self.load_markets()
        response = self.publicbase2GetSummary(params)
