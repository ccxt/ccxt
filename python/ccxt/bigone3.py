...
class bigone3 (Exchange):
    ...
    def fetch_tickers(self, symbols=None, params={}):
        ...
        response = self.publicGetAssetPairsTickers(params)
    ...
    def cancel_all_orders(self, symbol=None, params={}):
        self.load_markets()
        response = self.privatePostOrdersCancel(params)
        # {
        #     "code": 0,
        #     "data": {
        #         "cancelled": [
    ...
    def fetch_orders(self, symbol=None, since=None, limit=20, params={}):
        if symbol is None:
