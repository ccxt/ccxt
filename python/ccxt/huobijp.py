...
class huobijp(Exchange, ImplicitAPI):
    ...
    def fetch_orders_by_states(self, states, symbol: String = None, since: Int = None, limit: Int = None, params={}):
        self.load_markets()
        request = {
            'states': states,
        }
    ...
    def fetch_open_orders_v1(self, symbol: String = None, since: Int = None, limit: Int = None, params={}):
    ...
    def fetch_open_orders_v2(self, symbol: String = None, since: Int = None, limit: Int = None, params={}):
        self.load_markets()
        request = {}
        market = None
        if symbol is not None:
