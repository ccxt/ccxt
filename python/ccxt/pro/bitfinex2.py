...
from ccxt.rest.async_support.bitfinex2 import bitfinex2 as bitfinex2Rest
...
class bitfinex2(Exchange, bitfinex2Rest):
    ...
    def handle_checksum(self, client, message, subscription):
        #
        # [173904, 'cs', -890884919]
        #
        marketId = self.safe_string(subscription, 'symbol')
