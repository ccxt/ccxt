...
class derive(ccxt.async_support.derive):
    ...
    async def watch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        await self.load_markets()
        subaccountId = None
        subaccountId, params = self.handle_option_and_params(params, 'watchOrders', 'subaccount_id')
    ...
    async def watch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        await self.load_markets()
        subaccountId = None
        subaccountId, params = self.handle_option_and_params(params, 'watchMyTrades', 'subaccount_id')
