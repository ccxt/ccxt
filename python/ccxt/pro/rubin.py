...
class rubin(ccxt.async_support.rubin):
    ...
    def describe(self) -> Any:
        return self.deep_extend(super(rubin, self).describe(), {
            ...
            'urls': {
                'test': {
                    'ws': 'wss://indexer.testnet.rubin.trade/v4/ws',
                },
                'api': {
                    'ws': 'wss://indexer.mainnet.rubin.trade/v4/ws',
                },
            },
            'options': {},
            'streaming': {},
    ...
    async def watch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        https://docs.rubin.xyz/indexer-client/websockets#trades
    ...
    async def watch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        https://docs.rubin.xyz/indexer-client/websockets#orders
    ...
    async def watch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        https://docs.rubin.xyz/indexer-client/websockets#candles
