...
class coinsph(Exchange, ImplicitAPI):
    ...
    def fetch_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {}) -> list[list]:
        ...
        response = self.publicGetOpenapiQuoteV1Klines(self.extend(request, paramsOmitted))
        #
        #     [
        #         [
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params: dict = {}) -> Order:
        ...
        if testOrder is True:
            response = self.privatePostOpenapiV1OrderTest(self.extend(request, paramsRequest))
        else:
            response = self.privatePostOpenapiV1Order(self.extend(request, paramsRequest))
        #
        #     {
        #         "symbol": "ETHUSDT",
    ...
    def fetch_order(self, id: str, symbol: Str = None, params: dict = {}) -> Order:
        ...
        response = self.privateGetOpenapiV1Order(self.extend(request, paramsOmitted))
    ...
    def cancel_order(self, id: str, symbol: Str = None, params: dict = {}) -> Order:
        ...
        if clientOrderId is not None:
            ...
            request['orderId'] = id
        paramsOmitted = self.omit(params, ['clientOrderId', 'origClientOrderId'])
        response = self.privateDeleteOpenapiV1Order(self.extend(request, paramsOmitted))
        return self.parse_order(response)
    ...
    def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params: dict = {}) -> Transaction:
        ...
        response = self.privatePostOpenapiWalletV1WithdrawApply(self.extend(request, paramsOmitted))
    ...
    def fetch_deposit_address(self, code: str, params: dict = {}) -> DepositAddress:
        ...
        paramsOmitted = self.omit(params, 'network')
        response = self.privateGetOpenapiWalletV1DepositAddress(self.extend(request, paramsOmitted))
        #
        #     {
        #         "coin": "ETH",
