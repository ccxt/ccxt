...
class btcturk(Exchange):
    ...
    def fetch_markets(self, params={}):
        ...
        for i in range(0, len(data)):
            market = data[i]
            id = self.safe_string(market, 'pairNormalized')
            baseId = id.split('_')[0]
    ...
    def fetch_tickers(self, symbols=None, params={}):
        self.load_markets()
        response = self.publicGetTicker(params)
        tickers = self.safeValue(response, 'data', [])
        result = {}
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        #id = self.safe_string(response['data'], ['id'])
        return {
            'info': response,
            'id': response['data']['id'],
        }
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        if api == 'public':
            ...
            headers = {
                'X-PCK': self.apiKey,
                'X-Stamp': nonce,
                'X-Signature': self.decode(base64.b64encode(self.hmac(self.encode(auth), secret, hashlib.sha256, 'binary'))),
