...
from ccxt.base.types import Account, Currency, IndexType, OrderSide, OrderType, Trade, OrderRequest, Market, Str, Num, ApiKeyPermission
...
class Exchange(object):
    ...
    def watch_funding_fee(self, params={}):
