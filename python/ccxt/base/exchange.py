...
class Exchange(object):
    ...
    def parse_transactions(self, transactions, currency=None, since=None, limit=None, side=None):
        array = self.to_array(transactions)
        if side:
            array = [self.parse_transaction(transaction, currency, side) for transaction in array]
        else:
