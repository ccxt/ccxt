...
class Exchange(object):
    ...
    def parse_bids_asks(self, bidasks, price_key=0, amount_key=1):
        return [self.parse_bid_ask(bidask, price_key, amount_key) for bidask in bidasks if price_key in bidask and amount_key in bidask and bidask[price_key] and bidask[amount_key]]
