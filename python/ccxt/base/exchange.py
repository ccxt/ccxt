...
class Exchange(object):
    ...
    def currency_to_precision(self, currencyCode, fee):
        return self.decimal_to_precision(fee, ROUND, self.currencies[currencyCode]['precision'], self.precisionMode, self.paddingMode)
