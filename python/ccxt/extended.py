...
class extended(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = self.v1PublicGetInfoMarkets(params)
        #
        #     {
        #       "status": "OK",
        #       "data": [
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response = self.v1PublicGetInfoAssets(params)
        #
        #     {
        #       "status": "OK",
        #       "data": [
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = self.v1PublicGetInfoMarketsMarketStats(self.extend(request, params))
        #
        #     {
        #       "status": "OK",
        #       "data": {
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        response = self.v1PublicGetInfoMarketsMarketOrderbook(self.extend(request, params))
        #
        #     {
        #       "status": "OK",
        #       "data": {
    ...
    def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        response = self.v1PublicGetInfoMarketsMarketTrades(self.extend(request, params))
        #
        #     {
        #       "status": "OK",
        #       "data": [
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        """
        self.load_markets()
        response = self.v1PrivateGetUserSpotBalances(params)
        #
        #     {
        #         "status": "OK",
        #         "data": [
    ...
    def fetch_trading_fee(self, symbol: str, params={}) -> TradingFeeInterface:
        ...
        response = self.v1PrivateGetUserFees(self.extend(request, params))
        #
        #     {
        #         "status": "OK",
        #         "data": [
    ...
    def fetch_trading_fees(self, params={}) -> TradingFees:
        ...
        """
        self.load_markets()
        response = self.v1PrivateGetUserFees(params)
        #
        #     {
        #         "status": "OK",
        #         "data": [
    ...
    def fetch_leverage(self, symbol: str, params={}) -> Leverage:
        ...
        response = self.v1PrivateGetUserLeverage(self.extend(request, params))
        #
        #     {
        #         "status": "OK",
        #         "data": [
    ...
    def set_leverage(self, leverage: int, symbol: Str = None, params={}) -> Leverage:
        ...
        response = self.v1PrivatePatchUserLeverage(self.extend(request, params))
        #
        #     {
        #         "status": "OK",
        #         "data": {}
    ...
    def fetch_positions(self, symbols: Strings = None, params={}) -> List[Position]:
        ...
        if symbols is not None:
            ...
            request['market'] = marketIds
        response = self.v1PrivateGetUserPositions(self.extend(request, params))
        #
        #     {
        #         "status": "OK",
        #         "data": [
    ...
    def fetch_extended_account(self, params={}) -> Any:
        ...
        if account is not None:
            return account
        accountData = self.fetch_account(params)
