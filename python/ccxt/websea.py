...
class websea(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = self.openApiPublicGetOpenApiMarketSymbols(params)
        #
        #     {
        #         "errno": 0,
        #         "errmsg": "success",
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response = self.openApiPublicGetOpenApiMarketCurrencies(params)
        #
        #     {
        #         "errno": 0,
        #         "errmsg": "success",
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.openApiPublicGetOpenApiMarketDepth(self.extend(request, params))
        #
        # {
        #     "errno": 0,
        #     "errmsg": "success",
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = self.openApiPublicGetOpenApiMarket24kline(self.extend(request, params))
        result = self.safe_value(response, 'result', [])
    ...
    def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        """
        self.load_markets()
        response = self.openApiPublicGetOpenApiMarket24kline(params)
        result = self.safe_value(response, 'result', [])
        tickers = []
        for i in range(0, len(result)):
    ...
    def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.openApiPublicGetOpenApiMarketKline(self.extend(request, params))
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', {})
    ...
    def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.openApiPublicGetOpenApiMarketTrade(self.extend(request, params))
        #
        # {
        #     "errno": 0,
        #     "errmsg": "success",
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        """
        self.load_markets()
        response = self.openApiPrivatePostOpenApiWalletList(params)
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', [])
    ...
    def fetch_positions(self, symbols: Strings = None, params={}) -> List[Position]:
        ...
        """
        self.load_markets()
        response = self.openApiPrivatePostOpenApiFuturesPositionList(params)
        #
        # 需要根据实际API响应结构调整
        #
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        response = self.openApiPrivatePostOpenApiEntrustAdd(self.extend(request, params))
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', {})
    ...
    def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = self.openApiPrivatePostOpenApiEntrustCancel(self.extend(request, params))
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', {})
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        if symbol is not None:
            market = self.market(symbol)
            request['symbol'] = market['id']
        response = self.openApiPrivatePostOpenApiEntrustOrderDetail(self.extend(request, params))
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', {})
    ...
    def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.openApiPrivatePostOpenApiEntrustOrderList(self.extend(request, params))
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', [])
    ...
    def fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.openApiPrivatePostOpenApiEntrustHistoryList(self.extend(request, params))
        #
        # 需要根据实际API响应结构调整
        #
        result = self.safe_value(response, 'result', [])
