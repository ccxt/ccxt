    ...
    def describe(self):
        return self.deep_extend(super(okex, self).describe(), {
            ...
            'markets': {
                ...
                'LTC/USDT': {'id': 'ltc_usdt', 'symbol': 'LTC/USDT', 'base': 'LTC', 'quote': 'USDT', 'type': 'spot', 'spot': True, 'future': False},
                'ETH/USDT': {'id': 'eth_usdt', 'symbol': 'ETH/USDT', 'base': 'ETH', 'quote': 'USDT', 'type': 'spot', 'spot': True, 'future': False},
                'ETC/USDT': {'id': 'etc_usdt', 'symbol': 'ETC/USDT', 'base': 'ETC', 'quote': 'USDT', 'type': 'spot', 'spot': True, 'future': False},
                'BCH/USDT': {'id': 'bch_usdt', 'symbol': 'BCH/USDT', 'base': 'BCH', 'quote': 'USDT', 'type': 'spot', 'spot': True, 'future': False},
