...
from ccxt.abstract.alp import ImplicitAPI
import hashlib
...
class alp(Exchange, ImplicitAPI):

    def describe(self) -> Any:
        return self.deep_extend(super(alp, self).describe(), {
            'id': 'alp',
            'name': 'Alp',
            'countries': ['US'],
            'version': 'v1',
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-all-currencies
    ...
    def fetch_tickers(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        https://alpcomdev.github.io/alp-api-docs/#tickers
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        https://alpcomdev.github.io/alp-api-docs/#get-orderbook
    ...
    def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-all-exchanges
    ...
    def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-own-deposits
    ...
    def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-own-made-withdraws
    ...
    def fetch_ohlcv(self, symbol: str, timeframe: str = '5m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        https://alpcomdev.github.io/alp-api-docs/#charts
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-own-wallets
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        https://alpcomdev.github.io/alp-api-docs/#create-order
    ...
    def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        https://alpcomdev.github.io/alp-api-docs/#cancel-order
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}):
        ...
        https://alpcomdev.github.io/alp-api-docs/#retrieve-single-order

        fetches information on an order made by the user
        :param str id: the order id
        :param str symbol: not used by alp fetchOrder
        :param dict [params]: extra parameters specific to the exchange API endpoint
        :returns dict: An `order structure <https://docs.ccxt.com/?id=order-structure>`
        """
        self.load_markets()
    ...
    def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-own-orders
    ...
    def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        https://alpcomdev.github.io/alp-api-docs/#list-own-exchanges
