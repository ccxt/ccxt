...
class luno(Exchange, ImplicitAPI):
    ...
    def fetch_orders_by_state(self, state=None, symbol: String = None, since: Int = None, limit: Int = None, params={}):
        self.load_markets()
        request = {}
        market = None
    ...
    def fetch_ledger_by_entries(self, code: String = None, entry=None, limit=None, params={}):
