...
class gateio(Exchange):
    ...
    def parse_ticker(self, ticker, market=None):
        ...
        baseVolume = self.safe_number(ticker, 'base_volume', self.safe_number(ticker, 'volume_24h_base'))
        quoteVolume = self.safe_number(ticker, 'quote_volume', self.safe_number(ticker, 'volume_24h_quote'))
