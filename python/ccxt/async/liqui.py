...
class liqui (Exchange):
    ...
    async def fetch_markets_from_web(self):
        method = self.options['fetchMarketsFromWebMethod']
        markets = await getattr(self, method)()
        result = []
    ...
    async def fetch_currencies_from_web(self, params={}):
        ...
        currencies = await getattr(self, method)(params)
        result = {}
    ...
    async def activate_session(self, session, twofa, params={}):
        ...
        response = await self.webPostUserSessionActivate(request)
