...
class ImplicitAPI:
    ...
    private_wallet_get_getlowcapexchangelist = privateWalletGetGetLowCapExchangeList = Entry('getLowCapExchangeList', ['private', 'wallet'], 'GET', {'cost': 1})
    ...
    private_futures_get_settle_get_leverage_contract = privateFuturesGetSettleGetLeverageContract = Entry('{settle}/get_leverage/{contract}', ['private', 'futures'], 'GET', {'cost': 1})
    ...
    private_futures_post_settle_positions_contract_set_leverage = privateFuturesPostSettlePositionsContractSetLeverage = Entry('{settle}/positions/{contract}/set_leverage', ['private', 'futures'], 'POST', {'cost': 1})
    ...
    private_futures_post_settle_set_position_mode = privateFuturesPostSettleSetPositionMode = Entry('{settle}/set_position_mode', ['private', 'futures'], 'POST', {'cost': 1})
    ...
    private_futures_put_settle_price_orders_order_id = privateFuturesPutSettlePriceOrdersOrderId = Entry('{settle}/price_orders/{order_id}', ['private', 'futures'], 'PUT', {'cost': 1})
    ...
    private_earn_get_dual_balance = privateEarnGetDualBalance = Entry('dual/balance', ['private', 'earn'], 'GET', {'cost': 1.3333333333333333})
    ...
    private_otc_get_get_user_def_bank = privateOtcGetGetUserDefBank = Entry('get_user_def_bank', ['private', 'otc'], 'GET', {'cost': 1})
    private_otc_get_order_list = privateOtcGetOrderList = Entry('order/list', ['private', 'otc'], 'GET', {'cost': 1})
    private_otc_get_stable_coin_order_list = privateOtcGetStableCoinOrderList = Entry('stable_coin/order/list', ['private', 'otc'], 'GET', {'cost': 1})
    private_otc_get_order_detail = privateOtcGetOrderDetail = Entry('order/detail', ['private', 'otc'], 'GET', {'cost': 1})
    private_otc_post_quote = privateOtcPostQuote = Entry('quote', ['private', 'otc'], 'POST', {'cost': 1})
    private_otc_post_order_create = privateOtcPostOrderCreate = Entry('order/create', ['private', 'otc'], 'POST', {'cost': 1})
    private_otc_post_stable_coin_order_create = privateOtcPostStableCoinOrderCreate = Entry('stable_coin/order/create', ['private', 'otc'], 'POST', {'cost': 1})
    private_otc_post_order_paid = privateOtcPostOrderPaid = Entry('order/paid', ['private', 'otc'], 'POST', {'cost': 1})
    private_otc_post_order_cancel = privateOtcPostOrderCancel = Entry('order/cancel', ['private', 'otc'], 'POST', {'cost': 1})
