...
class ImplicitAPI:
    ...
    private_get_account_orders_client_client_id = privateGetAccountOrdersClientClientId = Entry('account/orders/client/{client_id}', 'private', 'GET', {})
    ...
    private_get_account_trade_trade_id = privateGetAccountTradeTradeId = Entry('account/trade/{trade_id}', 'private', 'GET', {})
