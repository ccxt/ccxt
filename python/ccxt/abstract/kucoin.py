...
class ImplicitAPI:
    ...
    private_get_user_api_key = privateGetUserApiKey = Entry('user/api-key', 'private', 'GET', {'cost': 30})
    ...
    private_get_earn_redeem_preview = privateGetEarnRedeemPreview = Entry('earn/redeem-preview', 'private', 'GET', {'cost': 5})
    ...
    earn_get_otc_loan_discount_rate_configs = earnGetOtcLoanDiscountRateConfigs = Entry('otc-loan/discount-rate-configs', 'earn', 'GET', {'cost': 10})
    ...
    earn_get_struct_earn_dual_products = earnGetStructEarnDualProducts = Entry('struct-earn/dual/products', 'earn', 'GET', {'cost': 4.5})
    earn_get_struct_earn_orders = earnGetStructEarnOrders = Entry('struct-earn/orders', 'earn', 'GET', {'cost': 7.5})
    earn_post_earn_orders = earnPostEarnOrders = Entry('earn/orders', 'earn', 'POST', {'cost': 7.5})
    earn_post_struct_earn_orders = earnPostStructEarnOrders = Entry('struct-earn/orders', 'earn', 'POST', {'cost': 7.5})
    ...
    uta_get_market_currencies = utaGetMarketCurrencies = Entry('market/currencies', 'uta', 'GET', {'cost': 3})
    ...
    uta_get_market_collateral_discount_ratio = utaGetMarketCollateralDiscountRatio = Entry('market/collateral-discount-ratio', 'uta', 'GET', {'cost': 10})
    uta_get_market_index_price = utaGetMarketIndexPrice = Entry('market/index-price', 'uta', 'GET', {'cost': 20})
    uta_get_market_position_tiers = utaGetMarketPositionTiers = Entry('market/position-tiers', 'uta', 'GET', {'cost': 20})
    uta_get_market_open_interest = utaGetMarketOpenInterest = Entry('market/open-interest', 'uta', 'GET', {'cost': 10})
    uta_get_server_status = utaGetServerStatus = Entry('server/status', 'uta', 'GET', {'cost': 3})
    utaprivate_get_market_orderbook = utaPrivateGetMarketOrderbook = Entry('market/orderbook', 'utaPrivate', 'GET', {'cost': 3})
    utaprivate_get_account_balance = utaPrivateGetAccountBalance = Entry('account/balance', 'utaPrivate', 'GET', {'cost': 5})
    utaprivate_get_account_transfer_quota = utaPrivateGetAccountTransferQuota = Entry('account/transfer-quota', 'utaPrivate', 'GET', {'cost': 20})
    utaprivate_get_account_mode = utaPrivateGetAccountMode = Entry('account/mode', 'utaPrivate', 'GET', {'cost': 30})
    utaprivate_get_account_ledger = utaPrivateGetAccountLedger = Entry('account/ledger', 'utaPrivate', 'GET', {'cost': 2})
    utaprivate_get_account_interest_history = utaPrivateGetAccountInterestHistory = Entry('account/interest-history', 'utaPrivate', 'GET', {'cost': 15})
    ...
    utaprivate_get_accountmode_account_balance = utaPrivateGetAccountModeAccountBalance = Entry('{accountMode}/account/balance', 'utaPrivate', 'GET', {'cost': 5})
    utaprivate_get_accountmode_account_overview = utaPrivateGetAccountModeAccountOverview = Entry('{accountMode}/account/overview', 'utaPrivate', 'GET', {'cost': 5})
    utaprivate_get_accountmode_order_detail = utaPrivateGetAccountModeOrderDetail = Entry('{accountMode}/order/detail', 'utaPrivate', 'GET', {'cost': 4})
    utaprivate_get_accountmode_order_open_list = utaPrivateGetAccountModeOrderOpenList = Entry('{accountMode}/order/open-list', 'utaPrivate', 'GET', {'cost': 4})
    utaprivate_get_accountmode_order_history = utaPrivateGetAccountModeOrderHistory = Entry('{accountMode}/order/history', 'utaPrivate', 'GET', {'cost': 4})
    utaprivate_get_accountmode_order_execution = utaPrivateGetAccountModeOrderExecution = Entry('{accountMode}/order/execution', 'utaPrivate', 'GET', {'cost': 4})
    utaprivate_get_accountmode_position_open_list = utaPrivateGetAccountModePositionOpenList = Entry('{accountMode}/position/open-list', 'utaPrivate', 'GET', {'cost': 3})
    utaprivate_get_accountmode_position_history = utaPrivateGetAccountModePositionHistory = Entry('{accountMode}/position/history', 'utaPrivate', 'GET', {'cost': 2})
    utaprivate_get_accountmode_position_tiers = utaPrivateGetAccountModePositionTiers = Entry('{accountMode}/position/tiers', 'utaPrivate', 'GET', {'cost': 20})
    utaprivate_get_sub_account_balance = utaPrivateGetSubAccountBalance = Entry('sub-account/balance', 'utaPrivate', 'GET', {'cost': 5})
    utaprivate_get_user_fee_rate = utaPrivateGetUserFeeRate = Entry('user/fee-rate', 'utaPrivate', 'GET', {'cost': 3})
    utaprivate_get_dcp_query = utaPrivateGetDcpQuery = Entry('dcp/query', 'utaPrivate', 'GET', {'cost': 2})
    utaprivate_post_account_transfer = utaPrivatePostAccountTransfer = Entry('account/transfer', 'utaPrivate', 'POST', {'cost': 4})
    utaprivate_post_account_mode = utaPrivatePostAccountMode = Entry('account/mode', 'utaPrivate', 'POST', {'cost': 30})
    utaprivate_post_accountmode_account_modify_leverage = utaPrivatePostAccountModeAccountModifyLeverage = Entry('{accountMode}/account/modify-leverage', 'utaPrivate', 'POST', {'cost': 20})
    utaprivate_post_accountmode_order_place = utaPrivatePostAccountModeOrderPlace = Entry('{accountMode}/order/place', 'utaPrivate', 'POST', {'cost': 1})
    utaprivate_post_accountmode_order_place_batch = utaPrivatePostAccountModeOrderPlaceBatch = Entry('{accountMode}/order/place-batch', 'utaPrivate', 'POST', {'cost': 4})
    utaprivate_post_accountmode_order_cancel = utaPrivatePostAccountModeOrderCancel = Entry('{accountMode}/order/cancel', 'utaPrivate', 'POST', {'cost': 1})
    utaprivate_post_accountmode_order_cancel_batch = utaPrivatePostAccountModeOrderCancelBatch = Entry('{accountMode}/order/cancel-batch', 'utaPrivate', 'POST', {'cost': 4})
    utaprivate_post_sub_account_cantransferout = utaPrivatePostSubAccountCanTransferOut = Entry('sub-account/canTransferOut', 'utaPrivate', 'POST', {'cost': 5})
    utaprivate_post_dcp_set = utaPrivatePostDcpSet = Entry('dcp/set', 'utaPrivate', 'POST', {'cost': 2})
