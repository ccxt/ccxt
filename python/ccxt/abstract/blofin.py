...
class ImplicitAPI:
    ...
    public_get_market_position_tiers = publicGetMarketPositionTiers = Entry('market/position-tiers', 'public', 'GET', {'cost': 1})
    ...
    private_get_account_config = privateGetAccountConfig = Entry('account/config', 'private', 'GET', {'cost': 1})
    private_get_asset_currencies = privateGetAssetCurrencies = Entry('asset/currencies', 'private', 'GET', {'cost': 1})
    ...
    private_get_account_positions_history = privateGetAccountPositionsHistory = Entry('account/positions-history', 'private', 'GET', {'cost': 1})
    ...
    private_get_affiliate_referral_code = privateGetAffiliateReferralCode = Entry('affiliate/referral-code', 'private', 'GET', {'cost': 1})
    private_get_affiliate_invitees = privateGetAffiliateInvitees = Entry('affiliate/invitees', 'private', 'GET', {'cost': 1})
    private_get_affiliate_sub_invitees = privateGetAffiliateSubInvitees = Entry('affiliate/sub-invitees', 'private', 'GET', {'cost': 1})
    private_get_affiliate_sub_affiliates = privateGetAffiliateSubAffiliates = Entry('affiliate/sub-affiliates', 'private', 'GET', {'cost': 1})
    private_get_affiliate_invitees_daily_info = privateGetAffiliateInviteesDailyInfo = Entry('affiliate/invitees/daily/info', 'private', 'GET', {'cost': 1})
    private_get_copytrading_instruments = privateGetCopytradingInstruments = Entry('copytrading/instruments', 'private', 'GET', {'cost': 1})
    private_get_copytrading_config = privateGetCopytradingConfig = Entry('copytrading/config', 'private', 'GET', {'cost': 1})
    ...
    private_post_asset_demo_apply_money = privatePostAssetDemoApplyMoney = Entry('asset/demo-apply-money', 'private', 'POST', {'cost': 1})
