...
class ImplicitAPI:
    ...
    public_get_openapi_v1_user_ip = publicGetOpenapiV1UserIp = Entry('openapi/v1/user/ip', 'public', 'GET', {'cost': 1})
    ...
    private_get_openapi_v1_check_sys_status = privateGetOpenapiV1CheckSysStatus = Entry('openapi/v1/check-sys-status', 'private', 'GET', {'cost': 1})
    ...
    private_get_openapi_wallet_v1_withdraw_address_whitelist = privateGetOpenapiWalletV1WithdrawAddressWhitelist = Entry('openapi/wallet/v1/withdraw/address-whitelist', 'private', 'GET', {'cost': 1})
    private_get_openapi_v1_account = privateGetOpenapiV1Account = Entry('openapi/v1/account', 'private', 'GET', {'cost': 10})
    private_get_openapi_v1_api_keys = privateGetOpenapiV1ApiKeys = Entry('openapi/v1/api-keys', 'private', 'GET', {'cost': 1})
    ...
    private_get_openapi_v1_sub_account_list = privateGetOpenapiV1SubAccountList = Entry('openapi/v1/sub-account/list', 'private', 'GET', {'cost': 10})
    private_get_openapi_v1_sub_account_asset = privateGetOpenapiV1SubAccountAsset = Entry('openapi/v1/sub-account/asset', 'private', 'GET', {'cost': 10})
    private_get_openapi_v1_sub_account_transfer_universal_transfer_history = privateGetOpenapiV1SubAccountTransferUniversalTransferHistory = Entry('openapi/v1/sub-account/transfer/universal-transfer-history', 'private', 'GET', {'cost': 10})
    private_get_openapi_v1_sub_account_transfer_sub_history = privateGetOpenapiV1SubAccountTransferSubHistory = Entry('openapi/v1/sub-account/transfer/sub-history', 'private', 'GET', {'cost': 10})
    private_get_openapi_v1_sub_account_apikey_ip_restriction = privateGetOpenapiV1SubAccountApikeyIpRestriction = Entry('openapi/v1/sub-account/apikey/ip-restriction', 'private', 'GET', {'cost': 10})
    private_get_openapi_v1_sub_account_wallet_deposit_address = privateGetOpenapiV1SubAccountWalletDepositAddress = Entry('openapi/v1/sub-account/wallet/deposit/address', 'private', 'GET', {'cost': 1})
    private_get_openapi_v1_sub_account_wallet_deposit_history = privateGetOpenapiV1SubAccountWalletDepositHistory = Entry('openapi/v1/sub-account/wallet/deposit/history', 'private', 'GET', {'cost': 1})
    private_get_openapi_v1_fund_collect_get_fund_record = privateGetOpenapiV1FundCollectGetFundRecord = Entry('openapi/v1/fund-collect/get-fund-record', 'private', 'GET', {'cost': 1})
    private_get_openapi_v1_asset_transaction_history = privateGetOpenapiV1AssetTransactionHistory = Entry('openapi/v1/asset/transaction/history', 'private', 'GET', {'cost': 20})
    ...
    private_post_openapi_convert_v1_query_order_history = privatePostOpenapiConvertV1QueryOrderHistory = Entry('openapi/convert/v1/query-order-history', 'private', 'POST', {'cost': 1})
    ...
    private_post_openapi_v1_sub_account_create = privatePostOpenapiV1SubAccountCreate = Entry('openapi/v1/sub-account/create', 'private', 'POST', {'cost': 30})
    private_post_openapi_v1_sub_account_transfer_universal_transfer = privatePostOpenapiV1SubAccountTransferUniversalTransfer = Entry('openapi/v1/sub-account/transfer/universal-transfer', 'private', 'POST', {'cost': 100})
    private_post_openapi_v1_sub_account_transfer_sub_to_master = privatePostOpenapiV1SubAccountTransferSubToMaster = Entry('openapi/v1/sub-account/transfer/sub-to-master', 'private', 'POST', {'cost': 100})
    private_post_openapi_v1_sub_account_apikey_add_ip_restriction = privatePostOpenapiV1SubAccountApikeyAddIpRestriction = Entry('openapi/v1/sub-account/apikey/add-ip-restriction', 'private', 'POST', {'cost': 30})
    private_post_openapi_v1_sub_account_apikey_delete_ip_restriction = privatePostOpenapiV1SubAccountApikeyDeleteIpRestriction = Entry('openapi/v1/sub-account/apikey/delete-ip-restriction', 'private', 'POST', {'cost': 30})
    private_post_openapi_v1_fund_collect_collect_from_sub_account = privatePostOpenapiV1FundCollectCollectFromSubAccount = Entry('openapi/v1/fund-collect/collect-from-sub-account', 'private', 'POST', {'cost': 1})
    private_put_openapi_v1_userdatastream = privatePutOpenapiV1UserDataStream = Entry('openapi/v1/userDataStream', 'private', 'PUT', {'cost': 1})
