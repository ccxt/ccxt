...
class ImplicitAPI:
    ...
    v2public_get_market_all = v2publicGetMarketAll = Entry('market/all', 'v2public', 'GET', {})
    v2public_get_ticker = v2publicGetTicker = Entry('ticker', 'v2public', 'GET', {})
    v2public_get_orderbook = v2publicGetOrderbook = Entry('orderbook', 'v2public', 'GET', {})
    v2public_get_trades_ticks = v2publicGetTradesTicks = Entry('trades/ticks', 'v2public', 'GET', {})
    v2public_get_candles_minutes_unit = v2publicGetCandlesMinutesUnit = Entry('candles/minutes/{unit}', 'v2public', 'GET', {})
    v2public_get_candles_interval = v2publicGetCandlesInterval = Entry('candles/{interval}', 'v2public', 'GET', {})
    v2public_get_candlestick_market_interval = v2publicGetCandlestickMarketInterval = Entry('candlestick/{market}/{interval}', 'v2public', 'GET', {})
    v2private_get_accounts = v2privateGetAccounts = Entry('accounts', 'v2private', 'GET', {})
    v2private_get_orders_chance = v2privateGetOrdersChance = Entry('orders/chance', 'v2private', 'GET', {})
    v2private_get_order = v2privateGetOrder = Entry('order', 'v2private', 'GET', {})
    v2private_get_orders = v2privateGetOrders = Entry('orders', 'v2private', 'GET', {})
    v2private_post_orders = v2privatePostOrders = Entry('orders', 'v2private', 'POST', {})
    v2private_delete_order = v2privateDeleteOrder = Entry('order', 'v2private', 'DELETE', {})
