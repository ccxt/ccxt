...
class ImplicitAPI:
    ...
    private_post_trade_market_buy = privatePostTradeMarketBuy = Entry[_Dict]('trade/market_buy', 'private', 'POST', {'cost': 5})
    private_post_trade_market_sell = privatePostTradeMarketSell = Entry[_Dict]('trade/market_sell', 'private', 'POST', {'cost': 5})
    private_post_trade_stop_limit = privatePostTradeStopLimit = Entry[_Dict]('trade/stop_limit', 'private', 'POST', {'cost': 5})
