...
class ImplicitAPI:
    ...
    sapi_get_margin_dust = sapiGetMarginDust = Entry('margin/dust', 'sapi', 'GET', {'cost': 20})
    ...
    sapi_get_loan_vip_request_data = sapiGetLoanVipRequestData = Entry('loan/vip/request/data', 'sapi', 'GET', {'cost': 40})
    ...
    sapi_post_margin_dust = sapiPostMarginDust = Entry('margin/dust', 'sapi', 'POST', {'cost': 20})
    ...
    sapi_post_loan_vip_renew = sapiPostLoanVipRenew = Entry('loan/vip/renew', 'sapi', 'POST', {'cost': 40})
    ...
    fapiprivate_get_order_asyn = fapiPrivateGetOrderAsyn = Entry('order/asyn', 'fapiPrivate', 'GET', {'cost': 5})
    fapiprivate_get_order_asyn_id = fapiPrivateGetOrderAsynId = Entry('order/asyn/id', 'fapiPrivate', 'GET', {'cost': 5})
    fapiprivate_get_trade_asyn = fapiPrivateGetTradeAsyn = Entry('trade/asyn', 'fapiPrivate', 'GET', {'cost': 5})
    fapiprivate_get_trade_asyn_id = fapiPrivateGetTradeAsynId = Entry('trade/asyn/id', 'fapiPrivate', 'GET', {'cost': 5})
    ...
    private_get_myallocations = privateGetMyAllocations = Entry('myAllocations', 'private', 'GET', {'cost': 10})
    private_post_order_oco = privatePostOrderOco = Entry('order/oco', 'private', 'POST', {'cost': 1})
    private_post_sor_order = privatePostSorOrder = Entry('sor/order', 'private', 'POST', {'cost': 1})
    private_post_sor_order_test = privatePostSorOrderTest = Entry('sor/order/test', 'private', 'POST', {'cost': 1})
