...
class ImplicitAPI:
    ...
    sapi_get_portfolio_delta_mode = sapiGetPortfolioDeltaMode = Entry('portfolio/delta-mode', 'sapi', 'GET', {'cost': 150})
    ...
    sapi_get_accumulator_product_list = sapiGetAccumulatorProductList = Entry('accumulator/product/list', 'sapi', 'GET', {'cost': 0.1})
    sapi_get_accumulator_product_position_list = sapiGetAccumulatorProductPositionList = Entry('accumulator/product/position/list', 'sapi', 'GET', {'cost': 0.1})
    sapi_get_accumulator_product_sum_holding = sapiGetAccumulatorProductSumHolding = Entry('accumulator/product/sum-holding', 'sapi', 'GET', {'cost': 0.1})
    ...
    sapi_post_portfolio_delta_mode = sapiPostPortfolioDeltaMode = Entry('portfolio/delta-mode', 'sapi', 'POST', {'cost': 150})
    ...
    sapi_post_accumulator_product_subscribe = sapiPostAccumulatorProductSubscribe = Entry('accumulator/product/subscribe', 'sapi', 'POST', {'cost': 0.1})
    ...
    dapiprivate_get_openalgoorders = dapiPrivateGetOpenAlgoOrders = Entry('openAlgoOrders', 'dapiPrivate', 'GET', {'cost': 1, 'noSymbol': 40})
    dapiprivate_get_allorders = dapiPrivateGetAllOrders = Entry('allOrders', 'dapiPrivate', 'GET', {'cost': 5})
    ...
    dapiprivate_get_usertrades = dapiPrivateGetUserTrades = Entry('userTrades', 'dapiPrivate', 'GET', {'cost': 5})
    dapiprivate_get_income = dapiPrivateGetIncome = Entry('income', 'dapiPrivate', 'GET', {'cost': 20})
    dapiprivate_get_leveragebracket = dapiPrivateGetLeverageBracket = Entry('leverageBracket', 'dapiPrivate', 'GET', {'cost': 2, 'noSymbol': 2})
    ...
    dapiprivate_post_algoorder = dapiPrivatePostAlgoOrder = Entry('algoOrder', 'dapiPrivate', 'POST', {'cost': 1})
    ...
    dapiprivate_delete_algoorder = dapiPrivateDeleteAlgoOrder = Entry('algoOrder', 'dapiPrivate', 'DELETE', {'cost': 1})
    ...
    fapipublic_get_symboladlrisk = fapiPublicGetSymbolAdlRisk = Entry('symbolAdlRisk', 'fapiPublic', 'GET', {'cost': 1})
    fapipublic_get_tradingschedule = fapiPublicGetTradingSchedule = Entry('tradingSchedule', 'fapiPublic', 'GET', {'cost': 5})
    ...
    fapiprivate_get_stock_contract = fapiPrivateGetStockContract = Entry('stock/contract', 'fapiPrivate', 'GET', {'cost': 50})
    ...
    fapiprivate_post_order_test = fapiPrivatePostOrderTest = Entry('order/test', 'fapiPrivate', 'POST', {'cost': 1})
    ...
    fapiprivate_post_algoorder = fapiPrivatePostAlgoOrder = Entry('algoOrder', 'fapiPrivate', 'POST', {'cost': 1})
    ...
    fapiprivate_delete_algoorder = fapiPrivateDeleteAlgoOrder = Entry('algoOrder', 'fapiPrivate', 'DELETE', {'cost': 1})
    fapiprivate_delete_algoopenorders = fapiPrivateDeleteAlgoOpenOrders = Entry('algoOpenOrders', 'fapiPrivate', 'DELETE', {'cost': 1})
