...
class ImplicitAPI:
    ...
    sapi_get_loan_flexible_loanable_data = sapiGetLoanFlexibleLoanableData = Entry('loan/flexible/loanable/data', 'sapi', 'GET', {'cost': 40})
    sapi_get_loan_flexible_collateral_data = sapiGetLoanFlexibleCollateralData = Entry('loan/flexible/collateral/data', 'sapi', 'GET', {'cost': 40})
    ...
    sapi_post_loan_flexible_borrow = sapiPostLoanFlexibleBorrow = Entry('loan/flexible/borrow', 'sapi', 'POST', {'cost': 40.002})
    ...
    public_get_depth = publicGetDepth = Entry('depth', 'public', 'GET', {'cost': 0.4, 'byLimit': [[100, 0.4], [500, 2], [1000, 4], [5000, 20]]})
    public_get_trades = publicGetTrades = Entry('trades', 'public', 'GET', {'cost': 0.4})
