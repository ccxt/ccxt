...
class ImplicitAPI:
    ...
    exchangeprivate_get_move = exchangePrivateGetMove = Entry('move', 'exchangePrivate', 'GET', {'cost': 1})
    exchangeprivate_get_move_list_moves = exchangePrivateGetMoveListMoves = Entry('move/list_moves', 'exchangePrivate', 'GET', {'cost': 1})
    exchangeprivate_get_transfers = exchangePrivateGetTransfers = Entry('transfers', 'exchangePrivate', 'GET', {'cost': 1})
    exchangeprivate_post_convert = exchangePrivatePostConvert = Entry('convert', 'exchangePrivate', 'POST', {'cost': 1})
    exchangeprivate_post_move = exchangePrivatePostMove = Entry('move', 'exchangePrivate', 'POST', {'cost': 1})
    ...
    private_get_users_linked = privateGetUsersLinked = Entry('users/linked', 'private', 'GET', {'cost': 1})
