...
class ImplicitAPI:
    ...
    private_get_quotes_id = privateGetQuotesId = Entry('quotes/{id}', 'private', 'GET', {'cost': 1})
    ...
    private_post_accounts_id_name = privatePostAccountsIdName = Entry('accounts/{id}/name', 'private', 'POST', {'cost': 1})
    ...
    private_post_quotes = privatePostQuotes = Entry('quotes', 'private', 'POST', {'cost': 1})
    ...
    private_put_quotes_id = privatePutQuotesId = Entry('quotes/{id}', 'private', 'PUT', {'cost': 1})
    private_delete_quotes_id = privateDeleteQuotesId = Entry('quotes/{id}', 'private', 'DELETE', {'cost': 1})
