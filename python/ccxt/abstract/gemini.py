...
class ImplicitAPI:
    webexchange_get = webExchangeGet = Entry('', 'webExchange', 'GET', {'cost': 1})
    web_get_rest_api = webGetRestApi = Entry('rest-api', 'web', 'GET', {'cost': 1})
    ...
    public_get_v1_network_token = publicGetV1NetworkToken = Entry('v1/network/{token}', 'public', 'GET', {'cost': 5})
    ...
    public_get_v1_feepromos = publicGetV1Feepromos = Entry('v1/feepromos', 'public', 'GET', {'cost': 5})
    ...
    public_get_v1_fundingamount_symbol = publicGetV1FundingamountSymbol = Entry('v1/fundingamount/{symbol}', 'public', 'GET', {'cost': 5})
    public_get_v1_fundingamountreport_records_xlsx = publicGetV1FundingamountreportRecordsXlsx = Entry('v1/fundingamountreport/records.xlsx', 'public', 'GET', {'cost': 5})
    ...
    public_get_v2_derivatives_candles_symbol_time_frame = publicGetV2DerivativesCandlesSymbolTimeFrame = Entry('v2/derivatives/candles/{symbol}/{time_frame}', 'public', 'GET', {'cost': 5})
    public_get_v2_fxrate_symbol_timestamp = publicGetV2FxrateSymbolTimestamp = Entry('v2/fxrate/{symbol}/{timestamp}', 'public', 'GET', {'cost': 5})
    public_get_v1_riskstats_symbol = publicGetV1RiskstatsSymbol = Entry('v1/riskstats/{symbol}', 'public', 'GET', {'cost': 5})
    private_get_v1_perpetuals_fundingpaymentreport_records_xlsx = privateGetV1PerpetualsFundingpaymentreportRecordsXlsx = Entry('v1/perpetuals/fundingpaymentreport/records.xlsx', 'private', 'GET', {'cost': 1})
    ...
    private_post_v1_custodyaccountfees = privatePostV1Custodyaccountfees = Entry('v1/custodyaccountfees', 'private', 'POST', {'cost': 1})
    private_post_v1_withdraw_currencycodelowercase_feeestimate = privatePostV1WithdrawCurrencyCodeLowerCaseFeeEstimate = Entry('v1/withdraw/{currencyCodeLowerCase}/feeEstimate', 'private', 'POST', {'cost': 1})
    private_post_v1_payments_addbank_cad = privatePostV1PaymentsAddbankCad = Entry('v1/payments/addbank/cad', 'private', 'POST', {'cost': 1})
    private_post_v1_transactions = privatePostV1Transactions = Entry('v1/transactions', 'private', 'POST', {'cost': 1})
    private_post_v1_margin_account = privatePostV1MarginAccount = Entry('v1/margin/account', 'private', 'POST', {'cost': 1})
    private_post_v1_margin_rates = privatePostV1MarginRates = Entry('v1/margin/rates', 'private', 'POST', {'cost': 1})
    private_post_v1_margin_order_preview = privatePostV1MarginOrderPreview = Entry('v1/margin/order/preview', 'private', 'POST', {'cost': 1})
    private_post_v1_clearing_list = privatePostV1ClearingList = Entry('v1/clearing/list', 'private', 'POST', {'cost': 1})
    private_post_v1_clearing_broker_list = privatePostV1ClearingBrokerList = Entry('v1/clearing/broker/list', 'private', 'POST', {'cost': 1})
    private_post_v1_clearing_broker_new = privatePostV1ClearingBrokerNew = Entry('v1/clearing/broker/new', 'private', 'POST', {'cost': 1})
    private_post_v1_clearing_trades = privatePostV1ClearingTrades = Entry('v1/clearing/trades', 'private', 'POST', {'cost': 1})
    private_post_v1_instant_quote = privatePostV1InstantQuote = Entry('v1/instant/quote', 'private', 'POST', {'cost': 1})
    private_post_v1_instant_execute = privatePostV1InstantExecute = Entry('v1/instant/execute', 'private', 'POST', {'cost': 1})
    private_post_v1_account_rename = privatePostV1AccountRename = Entry('v1/account/rename', 'private', 'POST', {'cost': 1})
    private_post_v1_oauth_revokebytoken = privatePostV1OauthRevokeByToken = Entry('v1/oauth/revokeByToken', 'private', 'POST', {'cost': 1})
    private_post_v1_margin = privatePostV1Margin = Entry('v1/margin', 'private', 'POST', {'cost': 1})
    private_post_v1_perpetuals_fundingpayment = privatePostV1PerpetualsFundingPayment = Entry('v1/perpetuals/fundingPayment', 'private', 'POST', {'cost': 1})
    private_post_v1_perpetuals_fundingpaymentreport_records_json = privatePostV1PerpetualsFundingpaymentreportRecordsJson = Entry('v1/perpetuals/fundingpaymentreport/records.json', 'private', 'POST', {'cost': 1})
    private_post_v1_positions = privatePostV1Positions = Entry('v1/positions', 'private', 'POST', {'cost': 1})
