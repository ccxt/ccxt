...
class ImplicitAPI:
    ...
    public_get_v1_perpetuals_fundingpaymentreport_records_xlsx = publicGetV1PerpetualsFundingpaymentreportRecordsXlsx = Entry('v1/perpetuals/fundingpaymentreport/records.xlsx', 'public', 'GET', {'cost': 5})
