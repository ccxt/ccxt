...
class ImplicitAPI:
    ...
    public_get_info_fees = publicGetInfoFees = Entry('info/fees', 'public', 'GET', {'cost': 1})
    ...
    public_get_loan_pool = publicGetLoanPool = Entry('loan_pool', 'public', 'GET', {'cost': 1})
    public_get_account = publicGetAccount = Entry('account', 'public', 'GET', {'cost': 1})
    public_get_account_loan = publicGetAccountLoan = Entry('account/loan', 'public', 'GET', {'cost': 1})
    ...
    public_get_account_spot_balance_history = publicGetAccountSpotBalanceHistory = Entry('account/spot_balance/history', 'public', 'GET', {'cost': 1})
    public_get_account_spot_asset_deposit_history = publicGetAccountSpotAssetDepositHistory = Entry('account/spot_asset/deposit/history', 'public', 'GET', {'cost': 1})
    public_get_account_spot_asset_withdraw_history = publicGetAccountSpotAssetWithdrawHistory = Entry('account/spot_asset/withdraw/history', 'public', 'GET', {'cost': 1})
    public_get_account_spot_asset_withdraw_pending = publicGetAccountSpotAssetWithdrawPending = Entry('account/spot_asset/withdraw/pending', 'public', 'GET', {'cost': 1})
    ...
    public_get_spot_assets = publicGetSpotAssets = Entry('spot_assets', 'public', 'GET', {'cost': 1})
    public_get_spot_assets_bridge_info = publicGetSpotAssetsBridgeInfo = Entry('spot_assets/bridge/info', 'public', 'GET', {'cost': 1})
    public_get_spot_assets_bridge_parameters_symbol = publicGetSpotAssetsBridgeParametersSymbol = Entry('spot_assets/bridge/parameters/{symbol}', 'public', 'GET', {'cost': 1})
    public_get_lake_list = publicGetLakeList = Entry('lake/list', 'public', 'GET', {'cost': 1})
    ...
    private_post_account_settings_auto_lend_disabled = privatePostAccountSettingsAutoLendDisabled = Entry('account/settings/auto_lend_disabled', 'private', 'POST', {'cost': 1})
    private_post_account_settings_spot = privatePostAccountSettingsSpot = Entry('account/settings/spot', 'private', 'POST', {'cost': 1})
    private_post_account_spot_asset_withdraw = privatePostAccountSpotAssetWithdraw = Entry('account/spot_asset/withdraw', 'private', 'POST', {'cost': 1})
    ...
    private_post_account_subaccount_spot_asset_transfer = privatePostAccountSubaccountSpotAssetTransfer = Entry('account/subaccount/spot_asset/transfer', 'private', 'POST', {'cost': 1})
    private_post_positions_add_isolated_margin = privatePostPositionsAddIsolatedMargin = Entry('positions/add_isolated_margin', 'private', 'POST', {'cost': 1})
    ...
    private_post_lake_add_blacklist = privatePostLakeAddBlacklist = Entry('lake/add_blacklist', 'private', 'POST', {'cost': 1})
    private_post_lake_add_max_leverage = privatePostLakeAddMaxLeverage = Entry('lake/add_max_leverage', 'private', 'POST', {'cost': 1})
    private_post_lake_add_whitelist = privatePostLakeAddWhitelist = Entry('lake/add_whitelist', 'private', 'POST', {'cost': 1})
    private_post_lake_claim_manager = privatePostLakeClaimManager = Entry('lake/claim_manager', 'private', 'POST', {'cost': 1})
    private_post_lake_claim_referral_code = privatePostLakeClaimReferralCode = Entry('lake/claim_referral_code', 'private', 'POST', {'cost': 1})
    private_post_lake_create = privatePostLakeCreate = Entry('lake/create', 'private', 'POST', {'cost': 1})
    private_post_lake_deposit = privatePostLakeDeposit = Entry('lake/deposit', 'private', 'POST', {'cost': 1})
    private_post_lake_remove_blacklist = privatePostLakeRemoveBlacklist = Entry('lake/remove_blacklist', 'private', 'POST', {'cost': 1})
    private_post_lake_remove_max_leverage = privatePostLakeRemoveMaxLeverage = Entry('lake/remove_max_leverage', 'private', 'POST', {'cost': 1})
    private_post_lake_remove_whitelist = privatePostLakeRemoveWhitelist = Entry('lake/remove_whitelist', 'private', 'POST', {'cost': 1})
    private_post_lake_update_deposit_cap = privatePostLakeUpdateDepositCap = Entry('lake/update_deposit_cap', 'private', 'POST', {'cost': 1})
    private_post_lake_withdraw = privatePostLakeWithdraw = Entry('lake/withdraw', 'private', 'POST', {'cost': 1})
