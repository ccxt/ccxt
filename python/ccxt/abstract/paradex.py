...
class ImplicitAPI:
    ...
    public_get_markets_history = publicGetMarketsHistory = Entry('markets/history', 'public', 'GET', {'cost': 1})
    public_get_markets_klines = publicGetMarketsKlines = Entry('markets/klines', 'public', 'GET', {'cost': 1})
    public_get_markets_settlement_price = publicGetMarketsSettlementPrice = Entry('markets/settlement-price', 'public', 'GET', {'cost': 1})
