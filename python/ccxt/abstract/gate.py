...
class ImplicitAPI:
    ...
    private_portfolio_get_spot_currency_pairs = privatePortfolioGetSpotCurrencyPairs = Entry('spot/currency_pairs', ['private', 'portfolio'], 'GET', {'cost': 1.3333333333333333})
    private_portfolio_get_spot_currency_pairs_currency_pair = privatePortfolioGetSpotCurrencyPairsCurrencyPair = Entry('spot/currency_pairs/{currency_pair}', ['private', 'portfolio'], 'GET', {'cost': 1.3333333333333333})
    ...
    private_portfolio_get_spot_orders = privatePortfolioGetSpotOrders = Entry('spot/orders', ['private', 'portfolio'], 'GET', {'cost': 1.3333333333333333})
    private_portfolio_get_spot_orders_order_id = privatePortfolioGetSpotOrdersOrderId = Entry('spot/orders/{order_id}', ['private', 'portfolio'], 'GET', {'cost': 1.3333333333333333})
    ...
    private_portfolio_post_spot_orders = privatePortfolioPostSpotOrders = Entry('spot/orders', ['private', 'portfolio'], 'POST', {'cost': 1.3333333333333333})
    private_portfolio_delete_spot_orders_order_id = privatePortfolioDeleteSpotOrdersOrderId = Entry('spot/orders/{order_id}', ['private', 'portfolio'], 'DELETE', {'cost': 1.3333333333333333})
    private_portfolio_patch_spot_orders_order_id = privatePortfolioPatchSpotOrdersOrderId = Entry('spot/orders/{order_id}', ['private', 'portfolio'], 'PATCH', {'cost': 1.3333333333333333})
