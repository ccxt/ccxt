...
class ImplicitAPI:
    ...
    public_mix_get_v2_mix_market_union_interest_rate_history = publicMixGetV2MixMarketUnionInterestRateHistory = Entry('v2/mix/market/union-interest-rate-history', ['public', 'mix'], 'GET', {'cost': 4})
    public_mix_get_v2_mix_market_exchange_rate = publicMixGetV2MixMarketExchangeRate = Entry('v2/mix/market/exchange-rate', ['public', 'mix'], 'GET', {'cost': 4})
    public_mix_get_v2_mix_market_discount_rate = publicMixGetV2MixMarketDiscountRate = Entry('v2/mix/market/discount-rate', ['public', 'mix'], 'GET', {'cost': 4})
    ...
    public_mix_get_v2_mix_market_oi_limit = publicMixGetV2MixMarketOiLimit = Entry('v2/mix/market/oi-limit', ['public', 'mix'], 'GET', {'cost': 2})
    ...
    public_uta_get_v3_market_proof_of_reserves = publicUtaGetV3MarketProofOfReserves = Entry('v3/market/proof-of-reserves', ['public', 'uta'], 'GET', {'cost': 1})
    ...
    public_uta_get_v3_market_index_components = publicUtaGetV3MarketIndexComponents = Entry('v3/market/index-components', ['public', 'uta'], 'GET', {'cost': 2})
    ...
    private_spot_get_v2_spot_account_upgrade_status = privateSpotGetV2SpotAccountUpgradeStatus = Entry('v2/spot/account/upgrade-status', ['private', 'spot'], 'GET', {'cost': 20})
    ...
    private_spot_post_v2_spot_account_upgrade = privateSpotPostV2SpotAccountUpgrade = Entry('v2/spot/account/upgrade', ['private', 'spot'], 'POST', {'cost': 20})
    ...
    private_mix_get_v2_mix_account_interest_history = privateMixGetV2MixAccountInterestHistory = Entry('v2/mix/account/interest-history', ['private', 'mix'], 'GET', {'cost': 4})
    private_mix_get_v2_mix_account_max_open = privateMixGetV2MixAccountMaxOpen = Entry('v2/mix/account/max-open', ['private', 'mix'], 'GET', {'cost': 1})
    private_mix_get_v2_mix_account_liq_price = privateMixGetV2MixAccountLiqPrice = Entry('v2/mix/account/liq-price', ['private', 'mix'], 'GET', {'cost': 1})
    ...
    private_mix_get_v2_mix_account_transfer_limits = privateMixGetV2MixAccountTransferLimits = Entry('v2/mix/account/transfer-limits', ['private', 'mix'], 'GET', {'cost': 20})
    private_mix_get_v2_mix_account_union_config = privateMixGetV2MixAccountUnionConfig = Entry('v2/mix/account/union-config', ['private', 'mix'], 'GET', {'cost': 20})
    private_mix_get_v2_mix_account_switch_union_usdt = privateMixGetV2MixAccountSwitchUnionUsdt = Entry('v2/mix/account/switch-union-usdt', ['private', 'mix'], 'GET', {'cost': 20})
    private_mix_get_v2_mix_account_isolated_symbols = privateMixGetV2MixAccountIsolatedSymbols = Entry('v2/mix/account/isolated-symbols', ['private', 'mix'], 'GET', {'cost': 2})
    ...
    private_mix_get_v2_mix_position_adlrank = privateMixGetV2MixPositionAdlRank = Entry('v2/mix/position/adlRank', ['private', 'mix'], 'GET', {'cost': 4})
    ...
    private_mix_get_v2_mix_order_plan_sub_order = privateMixGetV2MixOrderPlanSubOrder = Entry('v2/mix/order/plan-sub-order', ['private', 'mix'], 'GET', {'cost': 2})
    ...
    private_mix_post_v2_mix_account_set_auto_margin = privateMixPostV2MixAccountSetAutoMargin = Entry('v2/mix/account/set-auto-margin', ['private', 'mix'], 'POST', {'cost': 4})
    ...
    private_mix_post_v2_mix_account_set_all_leverage = privateMixPostV2MixAccountSetAllLeverage = Entry('v2/mix/account/set-all-leverage', ['private', 'mix'], 'POST', {'cost': 4})
    ...
    private_mix_post_v2_mix_account_set_asset_mode = privateMixPostV2MixAccountSetAssetMode = Entry('v2/mix/account/set-asset-mode', ['private', 'mix'], 'POST', {'cost': 10})
    ...
    private_mix_post_v2_mix_account_union_convert = privateMixPostV2MixAccountUnionConvert = Entry('v2/mix/account/union-convert', ['private', 'mix'], 'POST', {'cost': 20})
    ...
    private_mix_post_v2_mix_order_cancel_all_orders = privateMixPostV2MixOrderCancelAllOrders = Entry('v2/mix/order/cancel-all-orders', ['private', 'mix'], 'POST', {'cost': 20})
    ...
    private_mix_post_v2_mix_order_place_pos_tpsl = privateMixPostV2MixOrderPlacePosTpsl = Entry('v2/mix/order/place-pos-tpsl', ['private', 'mix'], 'POST', {'cost': 2})
    ...
    private_uta_get_v3_account_funding_assets = privateUtaGetV3AccountFundingAssets = Entry('v3/account/funding-assets', ['private', 'uta'], 'GET', {'cost': 1})
    ...
    private_uta_get_v3_account_deduct_info = privateUtaGetV3AccountDeductInfo = Entry('v3/account/deduct-info', ['private', 'uta'], 'GET', {'cost': 20})
    private_uta_get_v3_account_fee_rate = privateUtaGetV3AccountFeeRate = Entry('v3/account/fee-rate', ['private', 'uta'], 'GET', {'cost': 6.6667})
    private_uta_get_v3_account_switch_status = privateUtaGetV3AccountSwitchStatus = Entry('v3/account/switch-status', ['private', 'uta'], 'GET', {'cost': 4})
    private_uta_get_v3_account_max_transferable = privateUtaGetV3AccountMaxTransferable = Entry('v3/account/max-transferable', ['private', 'uta'], 'GET', {'cost': 6.6667})
    private_uta_get_v3_account_open_interest_limit = privateUtaGetV3AccountOpenInterestLimit = Entry('v3/account/open-interest-limit', ['private', 'uta'], 'GET', {'cost': 4})
    private_uta_get_v3_account_sub_unified_assets = privateUtaGetV3AccountSubUnifiedAssets = Entry('v3/account/sub-unified-assets', ['private', 'uta'], 'GET', {'cost': 20})
    ...
    private_uta_get_v3_account_deposit_address = privateUtaGetV3AccountDepositAddress = Entry('v3/account/deposit-address', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_account_sub_deposit_address = privateUtaGetV3AccountSubDepositAddress = Entry('v3/account/sub-deposit-address', ['private', 'uta'], 'GET', {'cost': 2})
    ...
    private_uta_get_v3_account_sub_deposit_records = privateUtaGetV3AccountSubDepositRecords = Entry('v3/account/sub-deposit-records', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_account_withdrawal_records = privateUtaGetV3AccountWithdrawalRecords = Entry('v3/account/withdrawal-records', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_broker_sub_list = privateUtaGetV3BrokerSubList = Entry('v3/broker/sub-list', ['private', 'uta'], 'GET', {'cost': 1})
    private_uta_get_v3_broker_all_sub_deposit_withdrawal = privateUtaGetV3BrokerAllSubDepositWithdrawal = Entry('v3/broker/all-sub-deposit-withdrawal', ['private', 'uta'], 'GET', {'cost': 1})
    private_uta_get_v3_broker_commission = privateUtaGetV3BrokerCommission = Entry('v3/broker/commission', ['private', 'uta'], 'GET', {'cost': 1})
    private_uta_get_v3_broker_query_sub_apikey = privateUtaGetV3BrokerQuerySubApikey = Entry('v3/broker/query-sub-apikey', ['private', 'uta'], 'GET', {'cost': 1})
    ...
    private_uta_get_v3_loan_coins = privateUtaGetV3LoanCoins = Entry('v3/loan/coins', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_interest = privateUtaGetV3LoanInterest = Entry('v3/loan/interest', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_borrow_ongoing = privateUtaGetV3LoanBorrowOngoing = Entry('v3/loan/borrow-ongoing', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_borrow_history = privateUtaGetV3LoanBorrowHistory = Entry('v3/loan/borrow-history', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_repay_history = privateUtaGetV3LoanRepayHistory = Entry('v3/loan/repay-history', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_pledge_rate_history = privateUtaGetV3LoanPledgeRateHistory = Entry('v3/loan/pledge-rate-history', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_debts = privateUtaGetV3LoanDebts = Entry('v3/loan/debts', ['private', 'uta'], 'GET', {'cost': 2})
    private_uta_get_v3_loan_reduces = privateUtaGetV3LoanReduces = Entry('v3/loan/reduces', ['private', 'uta'], 'GET', {'cost': 2})
    ...
    private_uta_get_v3_position_adlrank = privateUtaGetV3PositionAdlRank = Entry('v3/position/adlRank', ['private', 'uta'], 'GET', {'cost': 20})
    private_uta_get_v3_tax_records = privateUtaGetV3TaxRecords = Entry('v3/tax/records', ['private', 'uta'], 'GET', {'cost': 20})
    ...
    private_uta_post_v3_account_switch_deduct = privateUtaPostV3AccountSwitchDeduct = Entry('v3/account/switch-deduct', ['private', 'uta'], 'POST', {'cost': 20})
    private_uta_post_v3_account_deposit_account = privateUtaPostV3AccountDepositAccount = Entry('v3/account/deposit-account', ['private', 'uta'], 'POST', {'cost': 20})
    private_uta_post_v3_account_switch = privateUtaPostV3AccountSwitch = Entry('v3/account/switch', ['private', 'uta'], 'POST', {'cost': 20})
    private_uta_post_v3_account_adjust_account_mode = privateUtaPostV3AccountAdjustAccountMode = Entry('v3/account/adjust-account-mode', ['private', 'uta'], 'POST', {'cost': 20})
    ...
    private_uta_post_v3_account_sub_master_transfer = privateUtaPostV3AccountSubMasterTransfer = Entry('v3/account/sub-master-transfer', ['private', 'uta'], 'POST', {'cost': 4})
    ...
    private_uta_post_v3_account_withdrawal = privateUtaPostV3AccountWithdrawal = Entry('v3/account/withdrawal', ['private', 'uta'], 'POST', {'cost': 20})
    private_uta_post_v3_broker_create_sub = privateUtaPostV3BrokerCreateSub = Entry('v3/broker/create-sub', ['private', 'uta'], 'POST', {'cost': 1})
    private_uta_post_v3_broker_modify_sub = privateUtaPostV3BrokerModifySub = Entry('v3/broker/modify-sub', ['private', 'uta'], 'POST', {'cost': 1})
    private_uta_post_v3_broker_sub_withdrawal = privateUtaPostV3BrokerSubWithdrawal = Entry('v3/broker/sub-withdrawal', ['private', 'uta'], 'POST', {'cost': 1})
    private_uta_post_v3_broker_sub_deposit_address = privateUtaPostV3BrokerSubDepositAddress = Entry('v3/broker/sub-deposit-address', ['private', 'uta'], 'POST', {'cost': 1})
    private_uta_post_v3_broker_create_sub_apikey = privateUtaPostV3BrokerCreateSubApikey = Entry('v3/broker/create-sub-apikey', ['private', 'uta'], 'POST', {'cost': 1})
    private_uta_post_v3_broker_modify_sub_apikey = privateUtaPostV3BrokerModifySubApikey = Entry('v3/broker/modify-sub-apikey', ['private', 'uta'], 'POST', {'cost': 1})
    private_uta_post_v3_broker_delete_sub_apikey = privateUtaPostV3BrokerDeleteSubApikey = Entry('v3/broker/delete-sub-apikey', ['private', 'uta'], 'POST', {'cost': 1})
    ...
    private_uta_post_v3_loan_borrow = privateUtaPostV3LoanBorrow = Entry('v3/loan/borrow', ['private', 'uta'], 'POST', {'cost': 2})
    private_uta_post_v3_loan_repay = privateUtaPostV3LoanRepay = Entry('v3/loan/repay', ['private', 'uta'], 'POST', {'cost': 2})
    private_uta_post_v3_loan_revise_pledge = privateUtaPostV3LoanRevisePledge = Entry('v3/loan/revise-pledge', ['private', 'uta'], 'POST', {'cost': 2})
    ...
    private_uta_post_v3_trade_countdown_cancel_all = privateUtaPostV3TradeCountdownCancelAll = Entry('v3/trade/countdown-cancel-all', ['private', 'uta'], 'POST', {'cost': 20})
