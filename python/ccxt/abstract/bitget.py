...
class ImplicitAPI:
    ...
    public_spot_get_market_merge_depth = publicSpotGetMarketMergeDepth = Entry('market/merge-depth', ['public', 'spot'], 'GET', {'cost': 1})
    ...
    public_spot_get_public_loan_coininfos = publicSpotGetPublicLoanCoinInfos = Entry('public/loan/coinInfos', ['public', 'spot'], 'GET', {'cost': 2})
    public_spot_get_public_loan_hour_interest = publicSpotGetPublicLoanHourInterest = Entry('public/loan/hour-interest', ['public', 'spot'], 'GET', {'cost': 2})
    ...
    public_mix_get_market_merge_depth = publicMixGetMarketMergeDepth = Entry('market/merge-depth', ['public', 'mix'], 'GET', {'cost': 1})
    ...
    private_spot_get_convert_currencies = privateSpotGetConvertCurrencies = Entry('convert/currencies', ['private', 'spot'], 'GET', {'cost': 2})
    private_spot_get_convert_convert_record = privateSpotGetConvertConvertRecord = Entry('convert/convert-record', ['private', 'spot'], 'GET', {'cost': 2})
    private_spot_get_loan_ongoing_orders = privateSpotGetLoanOngoingOrders = Entry('loan/ongoing-orders', ['private', 'spot'], 'GET', {'cost': 2})
    private_spot_get_loan_repay_history = privateSpotGetLoanRepayHistory = Entry('loan/repay-history', ['private', 'spot'], 'GET', {'cost': 2})
    private_spot_get_loan_revise_history = privateSpotGetLoanReviseHistory = Entry('loan/revise-history', ['private', 'spot'], 'GET', {'cost': 2})
    private_spot_get_loan_borrow_history = privateSpotGetLoanBorrowHistory = Entry('loan/borrow-history', ['private', 'spot'], 'GET', {'cost': 2})
    private_spot_get_loan_debts = privateSpotGetLoanDebts = Entry('loan/debts', ['private', 'spot'], 'GET', {'cost': 2})
    ...
    private_spot_post_loan_borrow = privateSpotPostLoanBorrow = Entry('loan/borrow', ['private', 'spot'], 'POST', {'cost': 2})
    private_spot_post_loan_repay = privateSpotPostLoanRepay = Entry('loan/repay', ['private', 'spot'], 'POST', {'cost': 2})
    private_spot_post_loan_revise_pledge = privateSpotPostLoanRevisePledge = Entry('loan/revise-pledge', ['private', 'spot'], 'POST', {'cost': 2})
    ...
    private_broker_get_account_subaccount_transfer = privateBrokerGetAccountSubaccountTransfer = Entry('account/subaccount-transfer', ['private', 'broker'], 'GET', {'cost': 1})
    private_broker_get_account_subaccount_deposit = privateBrokerGetAccountSubaccountDeposit = Entry('account/subaccount-deposit', ['private', 'broker'], 'GET', {'cost': 1})
    private_broker_get_account_subaccount_withdrawal = privateBrokerGetAccountSubaccountWithdrawal = Entry('account/subaccount-withdrawal', ['private', 'broker'], 'GET', {'cost': 1})
    ...
    private_margin_get_cross_account_assets = privateMarginGetCrossAccountAssets = Entry('cross/account/assets', ['private', 'margin'], 'GET', {'cost': 2})
    private_margin_get_isolated_account_assets = privateMarginGetIsolatedAccountAssets = Entry('isolated/account/assets', ['private', 'margin'], 'GET', {'cost': 2})
    ...
    private_margin_post_isolated_account_flashrepay = privateMarginPostIsolatedAccountFlashRepay = Entry('isolated/account/flashRepay', ['private', 'margin'], 'POST', {'cost': 2})
    private_margin_post_isolated_account_queryflashrepaystatus = privateMarginPostIsolatedAccountQueryFlashRepayStatus = Entry('isolated/account/queryFlashRepayStatus', ['private', 'margin'], 'POST', {'cost': 2})
    private_margin_post_cross_account_flashrepay = privateMarginPostCrossAccountFlashRepay = Entry('cross/account/flashRepay', ['private', 'margin'], 'POST', {'cost': 2})
    private_margin_post_cross_account_queryflashrepaystatus = privateMarginPostCrossAccountQueryFlashRepayStatus = Entry('cross/account/queryFlashRepayStatus', ['private', 'margin'], 'POST', {'cost': 2})
