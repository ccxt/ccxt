...
class ImplicitAPI:
    ...
    public_get_groupedbook = publicGetGroupedBook = Entry('GroupedBook', 'public', 'GET', {'cost': 1.2})
    ...
    public_get_pretrade = publicGetPreTrade = Entry('PreTrade', 'public', 'GET', {'cost': 1})
    public_get_posttrade = publicGetPostTrade = Entry('PostTrade', 'public', 'GET', {'cost': 1})
    private_post_level3 = privatePostLevel3 = Entry('Level3', 'private', 'POST', {'cost': 1.2})
    ...
    private_post_creditlines = privatePostCreditLines = Entry('CreditLines', 'private', 'POST', {'cost': 3})
    ...
    private_post_orderamends = privatePostOrderAmends = Entry('OrderAmends', 'private', 'POST', {'cost': 3})
    ...
    private_post_getapikeyinfo = privatePostGetApiKeyInfo = Entry('GetApiKeyInfo', 'private', 'POST', {'cost': 3})
