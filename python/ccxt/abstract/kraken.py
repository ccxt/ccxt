...
class ImplicitAPI:
    ...
    public_get_maintenanceschedule = publicGetMaintenanceSchedule = Entry[_Dict]('MaintenanceSchedule', 'public', 'GET', {'cost': 1})
    ...
    private_post_listwalletaccounts = privatePostListWalletAccounts = Entry[_Dict]('ListWalletAccounts', 'private', 'POST', {'cost': 3})
