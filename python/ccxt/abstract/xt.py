...
class ImplicitAPI:
    ...
    public_linear_get_future_market_v1_public_q_ticker_books = publicLinearGetFutureMarketV1PublicQTickerBooks = Entry('future/market/v1/public/q/ticker/books', ['public', 'linear'], 'GET', {'cost': 1})
    ...
    public_inverse_get_future_market_v1_public_q_ticker_books = publicInverseGetFutureMarketV1PublicQTickerBooks = Entry('future/market/v1/public/q/ticker/books', ['public', 'inverse'], 'GET', {'cost': 1})
    ...
    private_linear_get_future_user_v1_position_break_list = privateLinearGetFutureUserV1PositionBreakList = Entry('future/user/v1/position/break-list', ['private', 'linear'], 'GET', {'cost': 1})
    ...
    private_inverse_get_future_user_v1_position_break_list = privateInverseGetFutureUserV1PositionBreakList = Entry('future/user/v1/position/break-list', ['private', 'inverse'], 'GET', {'cost': 1})
