...
class ImplicitAPI:
    ...
    public_get_market_call_auction_details = publicGetMarketCallAuctionDetails = Entry('market/call-auction-details', 'public', 'GET', {'cost': 1})
    ...
    public_get_public_event_contract_events = publicGetPublicEventContractEvents = Entry('public/event-contract/events', 'public', 'GET', {'cost': 1})
    public_get_public_event_contract_markets = publicGetPublicEventContractMarkets = Entry('public/event-contract/markets', 'public', 'GET', {'cost': 1})
    public_get_public_event_contract_series = publicGetPublicEventContractSeries = Entry('public/event-contract/series', 'public', 'GET', {'cost': 1})
    ...
    public_get_rubik_stat_contracts_long_short_position_ratio_contract_top_trader = publicGetRubikStatContractsLongShortPositionRatioContractTopTrader = Entry('rubik/stat/contracts/long-short-position-ratio-contract-top-trader', 'public', 'GET', {'cost': 4})
    ...
    public_get_support_announcement_types = publicGetSupportAnnouncementTypes = Entry('support/announcement-types', 'public', 'GET', {'cost': 20})
    ...
    private_get_account_subtypes = privateGetAccountSubtypes = Entry('account/subtypes', 'private', 'GET', {'cost': 4})
    ...
    private_get_tradingbot_dca_ongoing_list = privateGetTradingBotDcaOngoingList = Entry('tradingBot/dca/ongoing-list', 'private', 'GET', {'cost': 1})
    private_get_tradingbot_dca_history_list = privateGetTradingBotDcaHistoryList = Entry('tradingBot/dca/history-list', 'private', 'GET', {'cost': 1})
    private_get_tradingbot_dca_orders = privateGetTradingBotDcaOrders = Entry('tradingBot/dca/orders', 'private', 'GET', {'cost': 1})
    private_get_tradingbot_dca_position_details = privateGetTradingBotDcaPositionDetails = Entry('tradingBot/dca/position-details', 'private', 'GET', {'cost': 1})
    private_get_tradingbot_dca_cycle_list = privateGetTradingBotDcaCycleList = Entry('tradingBot/dca/cycle-list', 'private', 'GET', {'cost': 1})
    ...
    private_get_finance_sfp_dcd_currency_pair = privateGetFinanceSfpDcdCurrencyPair = Entry('finance/sfp/dcd/currency-pair', 'private', 'GET', {'cost': 2})
    private_get_finance_sfp_dcd_order_status = privateGetFinanceSfpDcdOrderStatus = Entry('finance/sfp/dcd/order-status', 'private', 'GET', {'cost': 2})
    private_get_finance_sfp_dcd_order_history = privateGetFinanceSfpDcdOrderHistory = Entry('finance/sfp/dcd/order-history', 'private', 'GET', {'cost': 2})
    ...
    private_post_account_set_riskoffset_amt = privatePostAccountSetRiskOffsetAmt = Entry('account/set-riskOffset-amt', 'private', 'POST', {'cost': 2})
    ...
    private_post_tradingbot_grid_copy_order_algo = privatePostTradingBotGridCopyOrderAlgo = Entry('tradingBot/grid/copy-order-algo', 'private', 'POST', {'cost': 1})
    ...
    private_post_tradingbot_dca_create = privatePostTradingBotDcaCreate = Entry('tradingBot/dca/create', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_amend_order_algo = privatePostTradingBotDcaAmendOrderAlgo = Entry('tradingBot/dca/amend-order-algo', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_stop = privatePostTradingBotDcaStop = Entry('tradingBot/dca/stop', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_orders_manual_buy = privatePostTradingBotDcaOrdersManualBuy = Entry('tradingBot/dca/orders/manual-buy', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_settings_reinvestment = privatePostTradingBotDcaSettingsReinvestment = Entry('tradingBot/dca/settings/reinvestment', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_settings_take_profit = privatePostTradingBotDcaSettingsTakeProfit = Entry('tradingBot/dca/settings/take-profit', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_margin_add = privatePostTradingBotDcaMarginAdd = Entry('tradingBot/dca/margin/add', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_dca_margin_reduce = privatePostTradingBotDcaMarginReduce = Entry('tradingBot/dca/margin/reduce', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_recurring_add_investment = privatePostTradingBotRecurringAddInvestment = Entry('tradingBot/recurring/add-investment', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_recurring_amend_price_range = privatePostTradingBotRecurringAmendPriceRange = Entry('tradingBot/recurring/amend-price-range', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_recurring_amend_recurring_amount = privatePostTradingBotRecurringAmendRecurringAmount = Entry('tradingBot/recurring/amend-recurring-amount', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_recurring_amend_recurring_time = privatePostTradingBotRecurringAmendRecurringTime = Entry('tradingBot/recurring/amend-recurring-time', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_recurring_pause = privatePostTradingBotRecurringPause = Entry('tradingBot/recurring/pause', 'private', 'POST', {'cost': 1})
    private_post_tradingbot_recurring_restart = privatePostTradingBotRecurringRestart = Entry('tradingBot/recurring/restart', 'private', 'POST', {'cost': 1})
    ...
    private_post_finance_sfp_dcd_trade = privatePostFinanceSfpDcdTrade = Entry('finance/sfp/dcd/trade', 'private', 'POST', {'cost': 10})
    private_post_finance_sfp_dcd_redeem_quote = privatePostFinanceSfpDcdRedeemQuote = Entry('finance/sfp/dcd/redeem-quote', 'private', 'POST', {'cost': 10})
    private_post_finance_sfp_dcd_redeem = privatePostFinanceSfpDcdRedeem = Entry('finance/sfp/dcd/redeem', 'private', 'POST', {'cost': 10})
