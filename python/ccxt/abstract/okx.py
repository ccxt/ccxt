...
class ImplicitAPI:
    ...
    public_get_market_block_trades = publicGetMarketBlockTrades = Entry('market/block-trades', 'public', 'GET', {'cost': 1})
    ...
    private_get_copytrading_current_subpositions = privateGetCopytradingCurrentSubpositions = Entry('copytrading/current-subpositions', 'private', 'GET', {'cost': 4})
    ...
    private_post_copytrading_close_subposition = privatePostCopytradingCloseSubposition = Entry('copytrading/close-subposition', 'private', 'POST', {'cost': 4})
