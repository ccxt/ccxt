...
class ImplicitAPI:
    ...
    public_get_ticker_currency = publicGetTickerCurrency = Entry[_Dict]('ticker/currency', 'public', 'GET', {'cost': 0.1})
    ...
    private_get_order_orderid = privateGetOrderOrderId = Entry[_Dict]('order/{orderId}', 'private', 'GET', {'cost': 1})
    ...
    private_get_users_transactions_crypto = privateGetUsersTransactionsCrypto = Entry[_Dict]('users/transactions/crypto', 'private', 'GET', {'cost': 1})
    private_get_users_transactions_fiat = privateGetUsersTransactionsFiat = Entry[_Dict]('users/transactions/fiat', 'private', 'GET', {'cost': 1})
    private_get_crypto_deposit_declarations = privateGetCryptoDepositDeclarations = Entry[_List]('crypto-deposit-declarations', 'private', 'GET', {'cost': 1})
    ...
    private_post_crypto_deposit_declarations_confirm = privatePostCryptoDepositDeclarationsConfirm = Entry[_Dict]('crypto-deposit-declarations/confirm', 'private', 'POST', {'cost': 1})
