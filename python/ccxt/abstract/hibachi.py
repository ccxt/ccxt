...
class ImplicitAPI:
    ...
    public_get_market_inventory = publicGetMarketInventory = Entry('market/inventory', 'public', 'GET', {'cost': 1})
    ...
    private_get_capital_balance = privateGetCapitalBalance = Entry('capital/balance', 'private', 'GET', {'cost': 1})
    ...
    private_get_trade_account_settlements_history = privateGetTradeAccountSettlementsHistory = Entry('trade/account/settlements_history', 'private', 'GET', {'cost': 1})
    ...
    private_post_capital_transfer = privatePostCapitalTransfer = Entry('capital/transfer', 'private', 'POST', {'cost': 1})
    private_post_trade_account_leverage = privatePostTradeAccountLeverage = Entry('trade/account/leverage', 'private', 'POST', {'cost': 1})
