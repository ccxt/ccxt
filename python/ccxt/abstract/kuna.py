...
class ImplicitAPI:
    ...
    v4_private_get_me = v4PrivateGetMe = Entry('me', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_getbalance = v4PrivateGetGetBalance = Entry('getBalance', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_active = v4PrivateGetActive = Entry('active', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_order_history = v4PrivateGetOrderHistory = Entry('order/history', ['v4', 'private'], 'GET', {'cost': 1})
    ...
    v4_private_get_order_details_id_withtrades_withtrades = v4PrivateGetOrderDetailsIdWithTradesWithTrades = Entry('order/details/{id}?withTrades={withTrades}', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_trade_history = v4PrivateGetTradeHistory = Entry('trade/history', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_transaction_hash = v4PrivateGetTransactionHash = Entry('transaction/{hash}', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_deposit_prerequest = v4PrivateGetDepositPreRequest = Entry('deposit/preRequest', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_deposit_crypto_address = v4PrivateGetDepositCryptoAddress = Entry('deposit/crypto/address', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_deposit_crypto_getmerchantaddress = v4PrivateGetDepositCryptoGetMerchantAddress = Entry('deposit/crypto/getMerchantAddress', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_deposit_history = v4PrivateGetDepositHistory = Entry('deposit/history', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_deposit_details_depositid = v4PrivateGetDepositDetailsDepositId = Entry('deposit/details/{depositId}', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_withdraw_prerequest = v4PrivateGetWithdrawPreRequest = Entry('withdraw/preRequest', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_withdraw_history = v4PrivateGetWithdrawHistory = Entry('withdraw/history', ['v4', 'private'], 'GET', {'cost': 1})
    v4_private_get_withdraw_details_withdrawid = v4PrivateGetWithdrawDetailsWithdrawId = Entry('withdraw/details/{withdrawId}', ['v4', 'private'], 'GET', {'cost': 1})
    ...
    v4_private_post_order_create = v4PrivatePostOrderCreate = Entry('order/create', ['v4', 'private'], 'POST', {'cost': 1})
    v4_private_post_order_cancel = v4PrivatePostOrderCancel = Entry('order/cancel', ['v4', 'private'], 'POST', {'cost': 1})
    v4_private_post_order_cancel_multi = v4PrivatePostOrderCancelMulti = Entry('order/cancel/multi', ['v4', 'private'], 'POST', {'cost': 1})
    v4_private_post_deposit_crypto_generateaddress = v4PrivatePostDepositCryptoGenerateAddress = Entry('deposit/crypto/generateAddress', ['v4', 'private'], 'POST', {'cost': 1})
    v4_private_post_deposit_crypto_generatemerchantaddress = v4PrivatePostDepositCryptoGenerateMerchantAddress = Entry('deposit/crypto/generateMerchantAddress', ['v4', 'private'], 'POST', {'cost': 1})
    v4_private_post_withdraw_create = v4PrivatePostWithdrawCreate = Entry('withdraw/create', ['v4', 'private'], 'POST', {'cost': 1})
    ...
    v4_public_get_timestamp = v4PublicGetTimestamp = Entry('timestamp', ['v4', 'public'], 'GET', {'cost': 1})
    v4_public_get_fees = v4PublicGetFees = Entry('fees', ['v4', 'public'], 'GET', {'cost': 1})
    v4_public_get_currencies_type_type = v4PublicGetCurrenciesTypeType = Entry('currencies?type={type}', ['v4', 'public'], 'GET', {'cost': 1})
    v4_public_get_markets_getall = v4PublicGetMarketsGetAll = Entry('markets/getAll', ['v4', 'public'], 'GET', {'cost': 1})
    v4_public_get_markets_tickers_pairs_pairs = v4PublicGetMarketsTickersPairsPairs = Entry('markets/tickers?pairs={pairs}', ['v4', 'public'], 'GET', {'cost': 1})
    v4_public_get_order_book_pairs = v4PublicGetOrderBookPairs = Entry('order/book/{pairs}', ['v4', 'public'], 'GET', {'cost': 1})
