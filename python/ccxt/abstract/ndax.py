...
class ImplicitAPI:
    ...
    public_get_enablexp2fa = publicGetEnableXP2FA = Entry('EnableXP2FA', 'public', 'GET', {'cost': 1})
    ...
    public_get_getearliestticktime = publicGetGetEarliestTickTime = Entry('GetEarliestTickTime', 'public', 'GET', {'cost': 1})
    ...
    public_get_summary = publicGetSummary = Entry('summary', 'public', 'GET', {'cost': 1})
    ...
    public_get_confirmwithdraw = publicGetConfirmWithdraw = Entry('ConfirmWithdraw', 'public', 'GET', {'cost': 1})
    ...
    private_get_getwithdrawticketattachment = privateGetGetWithdrawTicketAttachment = Entry('GetWithdrawTicketAttachment', 'private', 'GET', {'cost': 1})
    private_get_getwithdrawtickets = privateGetGetWithdrawTickets = Entry('GetWithdrawTickets', 'private', 'GET', {'cost': 1})
    private_get_getdepositticketattachment = privateGetGetDepositTicketAttachment = Entry('GetDepositTicketAttachment', 'private', 'GET', {'cost': 1})
    private_post_adduseraffiliatetag = privatePostAddUserAffiliateTag = Entry('AddUserAffiliateTag', 'private', 'POST', {'cost': 1})
    private_post_adddepositticketattachment = privatePostAddDepositTicketAttachment = Entry('AddDepositTicketAttachment', 'private', 'POST', {'cost': 1})
    private_post_addwithdrawticketattachment = privatePostAddWithdrawTicketAttachment = Entry('AddWithdrawTicketAttachment', 'private', 'POST', {'cost': 1})
