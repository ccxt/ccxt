...
class ImplicitAPI:
    ...
    public_get_v5_system_status = publicGetV5SystemStatus = Entry('v5/system/status', 'public', 'GET', {'cost': 5})
    ...
    public_get_v5_market_rpi_orderbook = publicGetV5MarketRpiOrderbook = Entry('v5/market/rpi_orderbook', 'public', 'GET', {'cost': 5})
    public_get_v5_market_full_orderbook = publicGetV5MarketFullOrderbook = Entry('v5/market/full_orderbook', 'public', 'GET', {'cost': 5})
    ...
    public_get_v5_market_new_delivery_price = publicGetV5MarketNewDeliveryPrice = Entry('v5/market/new-delivery-price', 'public', 'GET', {'cost': 5})
    public_get_v5_market_account_ratio = publicGetV5MarketAccountRatio = Entry('v5/market/account-ratio', 'public', 'GET', {'cost': 5})
    public_get_v5_market_index_price_components = publicGetV5MarketIndexPriceComponents = Entry('v5/market/index-price-components', 'public', 'GET', {'cost': 5})
    public_get_v5_market_price_limit = publicGetV5MarketPriceLimit = Entry('v5/market/price-limit', 'public', 'GET', {'cost': 5})
    public_get_v5_market_adlalert = publicGetV5MarketAdlAlert = Entry('v5/market/adlAlert', 'public', 'GET', {'cost': 5})
    public_get_v5_market_fee_group_info = publicGetV5MarketFeeGroupInfo = Entry('v5/market/fee-group-info', 'public', 'GET', {'cost': 5})
    ...
    private_get_v5_position_get_closed_positions = privateGetV5PositionGetClosedPositions = Entry('v5/position/get-closed-positions', 'private', 'GET', {'cost': 5})
    private_get_v5_position_move_history = privateGetV5PositionMoveHistory = Entry('v5/position/move-history', 'private', 'GET', {'cost': 5})
    private_get_v5_position_symbol_info = privateGetV5PositionSymbolInfo = Entry('v5/position/symbol-info', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_account_option_asset_info = privateGetV5AccountOptionAssetInfo = Entry('v5/account/option-asset-info', 'private', 'GET', {'cost': 1})
    ...
    private_get_v5_account_query_dcp_info = privateGetV5AccountQueryDcpInfo = Entry('v5/account/query-dcp-info', 'private', 'GET', {'cost': 5})
    private_get_v5_account_user_setting_config = privateGetV5AccountUserSettingConfig = Entry('v5/account/user-setting-config', 'private', 'GET', {'cost': 5})
    private_get_v5_account_pay_info = privateGetV5AccountPayInfo = Entry('v5/account/pay-info', 'private', 'GET', {'cost': 5})
    private_get_v5_account_trade_info_for_analysis = privateGetV5AccountTradeInfoForAnalysis = Entry('v5/account/trade-info-for-analysis', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_asset_asset_overview = privateGetV5AssetAssetOverview = Entry('v5/asset/asset-overview', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_asset_fundinghistory = privateGetV5AssetFundinghistory = Entry('v5/asset/fundinghistory', 'private', 'GET', {'cost': 5})
    private_get_v5_asset_portfolio_margin = privateGetV5AssetPortfolioMargin = Entry('v5/asset/portfolio-margin', 'private', 'GET', {'cost': 5})
    private_get_v5_asset_total_members_assets = privateGetV5AssetTotalMembersAssets = Entry('v5/asset/total-members-assets', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_asset_covert_small_balance_list = privateGetV5AssetCovertSmallBalanceList = Entry('v5/asset/covert/small-balance-list', 'private', 'GET', {'cost': 5})
    private_get_v5_asset_covert_small_balance_history = privateGetV5AssetCovertSmallBalanceHistory = Entry('v5/asset/covert/small-balance-history', 'private', 'GET', {'cost': 5})
    private_get_v5_asset_convert_small_balance_list = privateGetV5AssetConvertSmallBalanceList = Entry('v5/asset/convert/small-balance-list', 'private', 'GET', {'cost': 5})
    private_get_v5_asset_convert_small_balance_history = privateGetV5AssetConvertSmallBalanceHistory = Entry('v5/asset/convert/small-balance-history', 'private', 'GET', {'cost': 5})
    private_get_v5_fiat_query_coin_list = privateGetV5FiatQueryCoinList = Entry('v5/fiat/query-coin-list', 'private', 'GET', {'cost': 5})
    private_get_v5_fiat_reference_price = privateGetV5FiatReferencePrice = Entry('v5/fiat/reference-price', 'private', 'GET', {'cost': 5})
    private_get_v5_fiat_trade_query = privateGetV5FiatTradeQuery = Entry('v5/fiat/trade-query', 'private', 'GET', {'cost': 5})
    private_get_v5_fiat_query_trade_history = privateGetV5FiatQueryTradeHistory = Entry('v5/fiat/query-trade-history', 'private', 'GET', {'cost': 5})
    private_get_v5_fiat_balance_query = privateGetV5FiatBalanceQuery = Entry('v5/fiat/balance-query', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_user_escrow_sub_members = privateGetV5UserEscrowSubMembers = Entry('v5/user/escrow_sub_members', 'private', 'GET', {'cost': 5})
    private_get_v5_user_invitation_referrals = privateGetV5UserInvitationReferrals = Entry('v5/user/invitation/referrals', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_spot_margin_trade_currency_data = privateGetV5SpotMarginTradeCurrencyData = Entry('v5/spot-margin-trade/currency-data', 'private', 'GET', {'cost': 5})
    private_get_v5_spot_margin_trade_fixedborrow_contract_info = privateGetV5SpotMarginTradeFixedborrowContractInfo = Entry('v5/spot-margin-trade/fixedborrow-contract-info', 'private', 'GET', {'cost': 5})
    private_get_v5_spot_margin_trade_fixedborrow_order_info = privateGetV5SpotMarginTradeFixedborrowOrderInfo = Entry('v5/spot-margin-trade/fixedborrow-order-info', 'private', 'GET', {'cost': 5})
    private_get_v5_spot_margin_trade_fixedborrow_order_quote = privateGetV5SpotMarginTradeFixedborrowOrderQuote = Entry('v5/spot-margin-trade/fixedborrow-order-quote', 'private', 'GET', {'cost': 5})
    private_get_v5_spot_margin_trade_liability = privateGetV5SpotMarginTradeLiability = Entry('v5/spot-margin-trade/liability', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_spot_margin_trade_get_auto_repay_mode = privateGetV5SpotMarginTradeGetAutoRepayMode = Entry('v5/spot-margin-trade/get-auto-repay-mode', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_ins_loan_ensure_tokens = privateGetV5InsLoanEnsureTokens = Entry('v5/ins-loan/ensure-tokens', 'private', 'GET', {'cost': 5})
    ...
    private_get_v5_ins_loan_ltv = privateGetV5InsLoanLtv = Entry('v5/ins-loan/ltv', 'private', 'GET', {'cost': 5})
    private_get_v5_ins_loan_ltv_convert = privateGetV5InsLoanLtvConvert = Entry('v5/ins-loan/ltv-convert', 'private', 'GET', {'cost': 5})
    private_get_v5_ins_loan_coin_delta_amount = privateGetV5InsLoanCoinDeltaAmount = Entry('v5/ins-loan/coin-delta-amount', 'private', 'GET', {'cost': 5})
    ...
    private_post_v5_order_pre_check = privatePostV5OrderPreCheck = Entry('v5/order/pre-check', 'private', 'POST', {'cost': 5})
    ...
    private_post_v5_account_set_limit_px_action = privatePostV5AccountSetLimitPxAction = Entry('v5/account/set-limit-px-action', 'private', 'POST', {'cost': 5})
    private_post_v5_account_set_delta_mode = privatePostV5AccountSetDeltaMode = Entry('v5/account/set-delta-mode', 'private', 'POST', {'cost': 5})
    ...
    private_post_v5_asset_travel_rule_deposit_submit = privatePostV5AssetTravelRuleDepositSubmit = Entry('v5/asset/travel-rule/deposit/submit', 'private', 'POST', {'cost': 5})
    ...
    private_post_v5_asset_covert_get_quote = privatePostV5AssetCovertGetQuote = Entry('v5/asset/covert/get-quote', 'private', 'POST', {'cost': 10})
    private_post_v5_asset_covert_small_balance_execute = privatePostV5AssetCovertSmallBalanceExecute = Entry('v5/asset/covert/small-balance-execute', 'private', 'POST', {'cost': 10})
    private_post_v5_fiat_quote_apply = privatePostV5FiatQuoteApply = Entry('v5/fiat/quote-apply', 'private', 'POST', {'cost': 10})
    private_post_v5_fiat_trade_execute = privatePostV5FiatTradeExecute = Entry('v5/fiat/trade-execute', 'private', 'POST', {'cost': 10})
    ...
    private_post_v5_user_agreement = privatePostV5UserAgreement = Entry('v5/user/agreement', 'private', 'POST', {'cost': 10})
    private_post_v5_user_create_demo_member = privatePostV5UserCreateDemoMember = Entry('v5/user/create-demo-member', 'private', 'POST', {'cost': 10})
    ...
    private_post_v5_spot_margin_trade_set_auto_repay_mode = privatePostV5SpotMarginTradeSetAutoRepayMode = Entry('v5/spot-margin-trade/set-auto-repay-mode', 'private', 'POST', {'cost': 5})
    private_post_v5_spot_margin_trade_fixedborrow = privatePostV5SpotMarginTradeFixedborrow = Entry('v5/spot-margin-trade/fixedborrow', 'private', 'POST', {'cost': 5})
    private_post_v5_spot_margin_trade_fixedborrow_renew = privatePostV5SpotMarginTradeFixedborrowRenew = Entry('v5/spot-margin-trade/fixedborrow-renew', 'private', 'POST', {'cost': 5})
    ...
    private_post_v5_ins_loan_repay_loan = privatePostV5InsLoanRepayLoan = Entry('v5/ins-loan/repay-loan', 'private', 'POST', {'cost': 5})
