...
class ImplicitAPI:
    ...
    spot_public_get_symbol_offline = spotPublicGetSymbolOffline = Entry('symbol/offline', ['spot', 'public'], 'GET', {'cost': 10})
    spot_public_get_exchangeinfo = spotPublicGetExchangeInfo = Entry('exchangeInfo', ['spot', 'public'], 'GET', {'cost': 25})
    spot_public_get_depth = spotPublicGetDepth = Entry('depth', ['spot', 'public'], 'GET', {'cost': 3})
    ...
    spot_public_get_ticker_24hr = spotPublicGetTicker24hr = Entry('ticker/24hr', ['spot', 'public'], 'GET', {'cost': 25})
    spot_public_get_ticker_price = spotPublicGetTickerPrice = Entry('ticker/price', ['spot', 'public'], 'GET', {'cost': 10})
    spot_public_get_ticker_bookticker = spotPublicGetTickerBookTicker = Entry('ticker/bookTicker', ['spot', 'public'], 'GET', {'cost': 10})
    spot_public_get_etf_info = spotPublicGetEtfInfo = Entry('etf/info', ['spot', 'public'], 'GET', {'cost': 1})
    spot_private_get_kyc_status = spotPrivateGetKycStatus = Entry('kyc/status', ['spot', 'private'], 'GET', {'cost': 1})
    spot_private_get_uid = spotPrivateGetUid = Entry('uid', ['spot', 'private'], 'GET', {'cost': 1})
    ...
    spot_private_get_strategy_group = spotPrivateGetStrategyGroup = Entry('strategy/group', ['spot', 'private'], 'GET', {'cost': 20})
    spot_private_get_strategy_group_uid = spotPrivateGetStrategyGroupUid = Entry('strategy/group/uid', ['spot', 'private'], 'GET', {'cost': 20})
    spot_private_get_tradefee = spotPrivateGetTradeFee = Entry('tradeFee', ['spot', 'private'], 'GET', {'cost': 20})
    ...
    spot_private_get_sub_account_asset = spotPrivateGetSubAccountAsset = Entry('sub-account/asset', ['spot', 'private'], 'GET', {'cost': 1})
    ...
    spot_private_get_capital_deposit_hisrec = spotPrivateGetCapitalDepositHisrec = Entry('capital/deposit/hisrec', ['spot', 'private'], 'GET', {'cost': 10})
    ...
    spot_private_get_rebate_affiliate_campaign = spotPrivateGetRebateAffiliateCampaign = Entry('rebate/affiliate/campaign', ['spot', 'private'], 'GET', {'cost': 1})
    spot_private_get_rebate_affiliate_referral = spotPrivateGetRebateAffiliateReferral = Entry('rebate/affiliate/referral', ['spot', 'private'], 'GET', {'cost': 1})
    spot_private_get_rebate_affiliate_subaffiliates = spotPrivateGetRebateAffiliateSubaffiliates = Entry('rebate/affiliate/subaffiliates', ['spot', 'private'], 'GET', {'cost': 1})
    spot_private_get_rebate_affiliate_list = spotPrivateGetRebateAffiliateList = Entry('rebate/affiliate/list', ['spot', 'private'], 'GET', {'cost': 1})
    ...
    spot_private_post_apikeyinfo = spotPrivatePostApiKeyInfo = Entry('apiKeyInfo', ['spot', 'private'], 'POST', {'cost': 1})
    ...
    spot_private_post_strategy_group = spotPrivatePostStrategyGroup = Entry('strategy/group', ['spot', 'private'], 'POST', {'cost': 20})
    ...
    spot_private_post_capital_transfer = spotPrivatePostCapitalTransfer = Entry('capital/transfer', ['spot', 'private'], 'POST', {'cost': 50})
    ...
    spot_private_delete_order_all = spotPrivateDeleteOrderAll = Entry('order/all', ['spot', 'private'], 'DELETE', {'cost': 1})
    ...
    spot_private_delete_strategy_group = spotPrivateDeleteStrategyGroup = Entry('strategy/group', ['spot', 'private'], 'DELETE', {'cost': 1})
    spot_private_delete_strategy_group_uid = spotPrivateDeleteStrategyGroupUid = Entry('strategy/group/uid', ['spot', 'private'], 'DELETE', {'cost': 1})
    ...
    contract_private_get_account_profit_rate_type = contractPrivateGetAccountProfitRateType = Entry('account/profit_rate/{type}', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_asset_analysis_type = contractPrivateGetAccountAssetAnalysisType = Entry('account/asset/analysis/{type}', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_feedeductconfigs = contractPrivateGetAccountFeeDeductConfigs = Entry('account/feeDeductConfigs', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_asset_analysis_yesterday_pnl = contractPrivateGetAccountAssetAnalysisYesterdayPnl = Entry('account/asset/analysis/yesterday_pnl', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_asset_analysis_today_pnl = contractPrivateGetAccountAssetAnalysisTodayPnl = Entry('account/asset/analysis/today_pnl', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_config_contractfeediscountconfig = contractPrivateGetAccountConfigContractFeeDiscountConfig = Entry('account/config/contractFeeDiscountConfig', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_order_fee_details = contractPrivateGetOrderFeeDetails = Entry('order/fee_details', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_discounttype = contractPrivateGetAccountDiscountType = Entry('account/discountType', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_asset_analysis_export = contractPrivateGetAccountAssetAnalysisExport = Entry('account/asset/analysis/export', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_asset_book_order_deal_fee_total = contractPrivateGetAccountAssetBookOrderDealFeeTotal = Entry('account/asset_book/order_deal_fee/total', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_contract_fee_rate = contractPrivateGetAccountContractFeeRate = Entry('account/contract/fee_rate', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_account_contract_zero_fee_rate = contractPrivateGetAccountContractZeroFeeRate = Entry('account/contract/zero_fee_rate', ['contract', 'private'], 'GET', {'cost': 2})
    ...
    contract_private_get_order_list_close_orders = contractPrivateGetOrderListCloseOrders = Entry('order/list/close_orders', ['contract', 'private'], 'GET', {'cost': 2})
    ...
    contract_private_get_stoporder_open_orders = contractPrivateGetStoporderOpenOrders = Entry('stoporder/open_orders', ['contract', 'private'], 'GET', {'cost': 2})
    ...
    contract_private_get_account_tiered_fee_rate_v2 = contractPrivateGetAccountTieredFeeRateV2 = Entry('account/tiered_fee_rate/v2', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_trackorder_list_orders = contractPrivateGetTrackorderListOrders = Entry('trackorder/list/orders', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_market_maker_self_trade_blacklist = contractPrivateGetMarketMakerSelfTradeBlacklist = Entry('market_maker/self_trade/blacklist', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_get_market_maker_self_trade_blacklist_search = contractPrivateGetMarketMakerSelfTradeBlacklistSearch = Entry('market_maker/self_trade/blacklist/search', ['contract', 'private'], 'GET', {'cost': 2})
    contract_private_post_account_asset_analysis_v3 = contractPrivatePostAccountAssetAnalysisV3 = Entry('account/asset/analysis/v3', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_account_asset_analysis_calendar_daily_v3 = contractPrivatePostAccountAssetAnalysisCalendarDailyV3 = Entry('account/asset/analysis/calendar/daily/v3', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_account_asset_analysis_calendar_monthly_v3 = contractPrivatePostAccountAssetAnalysisCalendarMonthlyV3 = Entry('account/asset/analysis/calendar/monthly/v3', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_account_asset_analysis_recent_v3 = contractPrivatePostAccountAssetAnalysisRecentV3 = Entry('account/asset/analysis/recent/v3', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_position_change_auto_add_im = contractPrivatePostPositionChangeAutoAddIm = Entry('position/change_auto_add_im', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_position_reverse = contractPrivatePostPositionReverse = Entry('position/reverse', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_position_close_all = contractPrivatePostPositionCloseAll = Entry('position/close_all', ['contract', 'private'], 'POST', {'cost': 10})
    contract_private_post_order_create = contractPrivatePostOrderCreate = Entry('order/create', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_order_chase_limit_order = contractPrivatePostOrderChaseLimitOrder = Entry('order/chase_limit_order', ['contract', 'private'], 'POST', {'cost': 40})
    contract_private_post_order_change_limit_order = contractPrivatePostOrderChangeLimitOrder = Entry('order/change_limit_order', ['contract', 'private'], 'POST', {'cost': 40})
    contract_private_post_order_cancel = contractPrivatePostOrderCancel = Entry('order/cancel', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_order_batch_cancel_with_external = contractPrivatePostOrderBatchCancelWithExternal = Entry('order/batch_cancel_with_external', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_order_open_order_total_count = contractPrivatePostOrderOpenOrderTotalCount = Entry('order/open_order_total_count', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_order_batch_query_with_external = contractPrivatePostOrderBatchQueryWithExternal = Entry('order/batch_query_with_external', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_planorder_place_v2 = contractPrivatePostPlanorderPlaceV2 = Entry('planorder/place/v2', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_planorder_change_stop_order = contractPrivatePostPlanorderChangeStopOrder = Entry('planorder/change_stop_order', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_stoporder_place = contractPrivatePostStoporderPlace = Entry('stoporder/place', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    contract_private_post_trackorder_place = contractPrivatePostTrackorderPlace = Entry('trackorder/place', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_trackorder_cancel = contractPrivatePostTrackorderCancel = Entry('trackorder/cancel', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_trackorder_change_order = contractPrivatePostTrackorderChangeOrder = Entry('trackorder/change_order', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_market_maker_self_trade_blacklist_create = contractPrivatePostMarketMakerSelfTradeBlacklistCreate = Entry('market_maker/self_trade/blacklist/create', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_market_maker_self_trade_blacklist_update = contractPrivatePostMarketMakerSelfTradeBlacklistUpdate = Entry('market_maker/self_trade/blacklist/update', ['contract', 'private'], 'POST', {'cost': 2})
    contract_private_post_market_maker_self_trade_blacklist_delete = contractPrivatePostMarketMakerSelfTradeBlacklistDelete = Entry('market_maker/self_trade/blacklist/delete', ['contract', 'private'], 'POST', {'cost': 2})
    ...
    broker_private_get_sub_account_status = brokerPrivateGetSubAccountStatus = Entry('sub-account/status', ['broker', 'private'], 'GET', {'cost': 1})
    ...
    broker_private_get_rebate_taxquery = brokerPrivateGetRebateTaxQuery = Entry('rebate/taxQuery', ['broker', 'private'], 'GET', {'cost': 1})
