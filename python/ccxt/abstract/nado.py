...
class ImplicitAPI:
    ...
    gateway_public_post_edge_query = gatewayPublicPostEdgeQuery = Entry[_Dict]('edge/query', ['gateway', 'public'], 'POST', {'cost': 1})
    ...
    archivev2_public_get_symbols = archiveV2PublicGetSymbols = Entry[_Dict]('symbols', ['archiveV2', 'public'], 'GET', {'cost': 1})
