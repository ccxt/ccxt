...
class ImplicitAPI:
    ...
    private_get_trade_history_pair = privateGetTradeHistoryPair = Entry('trade_history/{pair}', 'private', 'GET', {'cost': 1})
    ...
    private_post_replace_order = privatePostReplaceOrder = Entry('replace_order/', 'private', 'POST', {'cost': 1})
    ...
    private_post_revoke_all_api_keys = privatePostRevokeAllApiKeys = Entry('revoke_all_api_keys/', 'private', 'POST', {'cost': 1})
    private_post_get_max_order_amount = privatePostGetMaxOrderAmount = Entry('get_max_order_amount/', 'private', 'POST', {'cost': 1})
