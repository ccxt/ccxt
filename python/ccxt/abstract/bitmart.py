...
class ImplicitAPI:
    ...
    private_post_spot_v4_algo_submit_order = privatePostSpotV4AlgoSubmitOrder = Entry('spot/v4/algo/submit_order', 'private', 'POST', {'cost': 6})
    private_post_spot_v4_algo_cancel_order = privatePostSpotV4AlgoCancelOrder = Entry('spot/v4/algo/cancel_order', 'private', 'POST', {'cost': 6})
    private_post_spot_v4_algo_cancel_all = privatePostSpotV4AlgoCancelAll = Entry('spot/v4/algo/cancel_all', 'private', 'POST', {'cost': 12})
    private_post_spot_v4_query_algo_order = privatePostSpotV4QueryAlgoOrder = Entry('spot/v4/query/algo/order', 'private', 'POST', {'cost': 1.5})
    private_post_spot_v4_query_algo_client_order = privatePostSpotV4QueryAlgoClientOrder = Entry('spot/v4/query/algo/client-order', 'private', 'POST', {'cost': 1.5})
    private_post_spot_v4_query_algo_open_orders = privatePostSpotV4QueryAlgoOpenOrders = Entry('spot/v4/query/algo/open-orders', 'private', 'POST', {'cost': 3})
    private_post_spot_v4_query_algo_history_orders = privatePostSpotV4QueryAlgoHistoryOrders = Entry('spot/v4/query/algo/history-orders', 'private', 'POST', {'cost': 3})
