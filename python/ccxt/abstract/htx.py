...
class ImplicitAPI:
    ...
    contract_private_get_v5_account_balance = contractPrivateGetV5AccountBalance = Entry('v5/account/balance', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_account_asset_mode = contractPrivateGetV5AccountAssetMode = Entry('v5/account/asset_mode', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_trade_position_opens = contractPrivateGetV5TradePositionOpens = Entry('v5/trade/position/opens', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_trade_order_opens = contractPrivateGetV5TradeOrderOpens = Entry('v5/trade/order/opens', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_trade_order_details = contractPrivateGetV5TradeOrderDetails = Entry('v5/trade/order/details', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_trade_order_history = contractPrivateGetV5TradeOrderHistory = Entry('v5/trade/order/history', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_trade_order = contractPrivateGetV5TradeOrder = Entry('v5/trade/order', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_position_lever = contractPrivateGetV5PositionLever = Entry('v5/position/lever', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_position_mode = contractPrivateGetV5PositionMode = Entry('v5/position/mode', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_position_risk_limit = contractPrivateGetV5PositionRiskLimit = Entry('v5/position/risk/limit', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_position_risk_limit_tier = contractPrivateGetV5PositionRiskLimitTier = Entry('v5/position/risk/limit_tier', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_market_risk_limit = contractPrivateGetV5MarketRiskLimit = Entry('v5/market/risk/limit', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_market_assets_deduction_currency = contractPrivateGetV5MarketAssetsDeductionCurrency = Entry('v5/market/assets_deduction_currency', ['contract', 'private'], 'GET', {'cost': 1})
    contract_private_get_v5_market_multi_assets_margin = contractPrivateGetV5MarketMultiAssetsMargin = Entry('v5/market/multi_assets_margin', ['contract', 'private'], 'GET', {'cost': 1})
    ...
    contract_private_post_v5_account_asset_mode = contractPrivatePostV5AccountAssetMode = Entry('v5/account/asset_mode', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_order = contractPrivatePostV5TradeOrder = Entry('v5/trade/order', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_batch_orders = contractPrivatePostV5TradeBatchOrders = Entry('v5/trade/batch_orders', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_cancel_order = contractPrivatePostV5TradeCancelOrder = Entry('v5/trade/cancel_order', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_cancel_batch_orders = contractPrivatePostV5TradeCancelBatchOrders = Entry('v5/trade/cancel_batch_orders', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_cancel_all_orders = contractPrivatePostV5TradeCancelAllOrders = Entry('v5/trade/cancel_all_orders', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_position = contractPrivatePostV5TradePosition = Entry('v5/trade/position', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_trade_position_all = contractPrivatePostV5TradePositionAll = Entry('v5/trade/position_all', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_position_lever = contractPrivatePostV5PositionLever = Entry('v5/position/lever', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_position_mode = contractPrivatePostV5PositionMode = Entry('v5/position/mode', ['contract', 'private'], 'POST', {'cost': 1})
    contract_private_post_v5_account_fee_deduction_currency = contractPrivatePostV5AccountFeeDeductionCurrency = Entry('v5/account/fee_deduction_currency', ['contract', 'private'], 'POST', {'cost': 1})
