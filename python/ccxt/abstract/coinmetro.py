...
class ImplicitAPI:
    ...
    public_get_exchange_candles_pair_timeframe_from_to = publicGetExchangeCandlesPairTimeframeFromTo = Entry('exchange/candles/{pair}/{timeframe}/{from}/{to}', 'public', 'GET', {'cost': 1})
    public_get_exchange_prices = publicGetExchangePrices = Entry('exchange/prices', 'public', 'GET', {'cost': 1})
    public_get_exchange_ticks_pair_from = publicGetExchangeTicksPairFrom = Entry('exchange/ticks/{pair}/{from}', 'public', 'GET', {'cost': 1})
    ...
    public_get_exchange_book_pair = publicGetExchangeBookPair = Entry('exchange/book/{pair}', 'public', 'GET', {'cost': 1})
    ...
    private_get_users_wallets_history_since = privateGetUsersWalletsHistorySince = Entry('users/wallets/history/{since}', 'private', 'GET', {'cost': 1})
    ...
    private_get_exchange_orders_history_since = privateGetExchangeOrdersHistorySince = Entry('exchange/orders/history/{since}', 'private', 'GET', {'cost': 1})
    private_get_exchange_fills_since = privateGetExchangeFillsSince = Entry('exchange/fills/{since}', 'private', 'GET', {'cost': 1})
