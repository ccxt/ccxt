...
class ImplicitAPI:
    ...
    sapi_get_asset_ledger_transfer_cloud_mining_querybypage = sapiGetAssetLedgerTransferCloudMiningQueryByPage = Entry(
        'asset/ledger-transfer/cloud-mining/queryByPage', 'sapi', 'GET', {'cost': 4}
    )
    sapi_get_asset_convert_transfer_querybypage = sapiGetAssetConvertTransferQueryByPage = Entry(
        'asset/convert-transfer/queryByPage', 'sapi', 'GET', {'cost': 0.033335}
    )
    ...
    sapi_get_margin_interesthistory = sapiGetMarginInterestHistory = Entry(
        'margin/interestHistory', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_margin_forceliquidationrec = sapiGetMarginForceLiquidationRec = Entry(
    ...
    sapi_get_margin_maxborrowable = sapiGetMarginMaxBorrowable = Entry(
        'margin/maxBorrowable', 'sapi', 'GET', {'cost': 5}
    )
    sapi_get_margin_maxtransferable = sapiGetMarginMaxTransferable = Entry(
    ...
    sapi_get_margin_isolated_transfer = sapiGetMarginIsolatedTransfer = Entry(
        'margin/isolated/transfer', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_margin_isolated_account = sapiGetMarginIsolatedAccount = Entry(
        'margin/isolated/account', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_margin_isolated_pair = sapiGetMarginIsolatedPair = Entry(
        'margin/isolated/pair', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_margin_isolated_allpairs = sapiGetMarginIsolatedAllPairs = Entry(
        'margin/isolated/allPairs', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_margin_isolated_accountlimit = sapiGetMarginIsolatedAccountLimit = Entry(
        'margin/isolated/accountLimit', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_margin_interestratehistory = sapiGetMarginInterestRateHistory = Entry(
    ...
    sapi_get_margin_openorderlist = sapiGetMarginOpenOrderList = Entry(
        'margin/openOrderList', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_margin_crossmargindata = sapiGetMarginCrossMarginData = Entry(
        'margin/crossMarginData', 'sapi', 'GET', {'cost': 0.1, 'noCoin': 0.5}
    )
    sapi_get_margin_isolatedmargindata = sapiGetMarginIsolatedMarginData = Entry(
        'margin/isolatedMarginData', 'sapi', 'GET', {'cost': 0.1, 'noCoin': 1}
    )
    sapi_get_margin_isolatedmargintier = sapiGetMarginIsolatedMarginTier = Entry(
        'margin/isolatedMarginTier', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_margin_ratelimit_order = sapiGetMarginRateLimitOrder = Entry(
    ...
    sapi_get_margin_crossmargincollateralratio = sapiGetMarginCrossMarginCollateralRatio = Entry(
        'margin/crossMarginCollateralRatio', 'sapi', 'GET', {'cost': 10}
    )
    sapi_get_margin_exchange_small_liability = sapiGetMarginExchangeSmallLiability = Entry(
        'margin/exchange-small-liability', 'sapi', 'GET', {'cost': 0.6667}
    )
    sapi_get_margin_exchange_small_liability_history = sapiGetMarginExchangeSmallLiabilityHistory = Entry(
        'margin/exchange-small-liability-history', 'sapi', 'GET', {'cost': 0.6667}
    )
    ...
    sapi_get_loan_vip_collateral_data = sapiGetLoanVipCollateralData = Entry(
        'loan/vip/collateral/data', 'sapi', 'GET', {'cost': 40}
    )
    sapi_get_loan_vip_request_data = sapiGetLoanVipRequestData = Entry(
        'loan/vip/request/data', 'sapi', 'GET', {'cost': 40}
    )
    ...
    sapi_get_loan_ltv_adjustment_history = sapiGetLoanLtvAdjustmentHistory = Entry(
    ...
    sapi_get_loan_collateral_data = sapiGetLoanCollateralData = Entry(
        'loan/collateral/data', 'sapi', 'GET', {'cost': 40}
    )
    sapi_get_loan_repay_collateral_rate = sapiGetLoanRepayCollateralRate = Entry(
        'loan/repay/collateral/rate', 'sapi', 'GET', {'cost': 600}
    )
    sapi_get_loan_vip_ongoing_orders = sapiGetLoanVipOngoingOrders = Entry(
        'loan/vip/ongoing/orders', 'sapi', 'GET', {'cost': 40}
    )
    sapi_get_loan_vip_repay_history = sapiGetLoanVipRepayHistory = Entry(
        'loan/vip/repay/history', 'sapi', 'GET', {'cost': 40}
    )
    sapi_get_loan_vip_collateral_account = sapiGetLoanVipCollateralAccount = Entry(
    ...
    sapi_get_futures_loan_borrow_history = sapiGetFuturesLoanBorrowHistory = Entry(
        'futures/loan/borrow/history', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_futures_loan_repay_history = sapiGetFuturesLoanRepayHistory = Entry(
        'futures/loan/repay/history', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_futures_loan_wallet = sapiGetFuturesLoanWallet = Entry('futures/loan/wallet', 'sapi', 'GET', {'cost': 1})
    sapi_get_futures_loan_adjustcollateral_history = sapiGetFuturesLoanAdjustCollateralHistory = Entry(
        'futures/loan/adjustCollateral/history', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_futures_loan_liquidationhistory = sapiGetFuturesLoanLiquidationHistory = Entry(
        'futures/loan/liquidationHistory', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_rebate_taxquery = sapiGetRebateTaxQuery = Entry('rebate/taxQuery', 'sapi', 'GET', {'cost': 20.001})
    sapi_get_capital_config_getall = sapiGetCapitalConfigGetall = Entry(
        'capital/config/getall', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_capital_deposit_address = sapiGetCapitalDepositAddress = Entry(
        'capital/deposit/address', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_capital_deposit_hisrec = sapiGetCapitalDepositHisrec = Entry(
        'capital/deposit/hisrec', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_capital_deposit_subaddress = sapiGetCapitalDepositSubAddress = Entry(
        'capital/deposit/subAddress', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_capital_deposit_subhisrec = sapiGetCapitalDepositSubHisrec = Entry(
        'capital/deposit/subHisrec', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_capital_withdraw_history = sapiGetCapitalWithdrawHistory = Entry(
        'capital/withdraw/history', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_capital_contract_convertible_coins = sapiGetCapitalContractConvertibleCoins = Entry(
        'capital/contract/convertible-coins', 'sapi', 'GET', {'cost': 4.0002}
    )
    sapi_get_convert_tradeflow = sapiGetConvertTradeFlow = Entry('convert/tradeFlow', 'sapi', 'GET', {'cost': 20.0001})
    sapi_get_convert_exchangeinfo = sapiGetConvertExchangeInfo = Entry(
    ...
    sapi_get_convert_orderstatus = sapiGetConvertOrderStatus = Entry(
    ...
    sapi_get_account_apitradingstatus = sapiGetAccountApiTradingStatus = Entry(
        'account/apiTradingStatus', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_account_apirestrictions_iprestriction = sapiGetAccountApiRestrictionsIpRestriction = Entry(
        'account/apiRestrictions/ipRestriction', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_bnbburn = sapiGetBnbBurn = Entry('bnbBurn', 'sapi', 'GET', {'cost': 0.1})
    sapi_get_sub_account_futures_account = sapiGetSubAccountFuturesAccount = Entry(
        'sub-account/futures/account', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_sub_account_futures_accountsummary = sapiGetSubAccountFuturesAccountSummary = Entry(
        'sub-account/futures/accountSummary', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_sub_account_futures_positionrisk = sapiGetSubAccountFuturesPositionRisk = Entry(
        'sub-account/futures/positionRisk', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_sub_account_futures_internaltransfer = sapiGetSubAccountFuturesInternalTransfer = Entry(
        'sub-account/futures/internalTransfer', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_sub_account_list = sapiGetSubAccountList = Entry('sub-account/list', 'sapi', 'GET', {'cost': 0.1})
    sapi_get_sub_account_margin_account = sapiGetSubAccountMarginAccount = Entry(
        'sub-account/margin/account', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_sub_account_margin_accountsummary = sapiGetSubAccountMarginAccountSummary = Entry(
        'sub-account/margin/accountSummary', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_sub_account_spotsummary = sapiGetSubAccountSpotSummary = Entry(
    ...
    sapi_get_sub_account_sub_transfer_history = sapiGetSubAccountSubTransferHistory = Entry(
        'sub-account/sub/transfer/history', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_sub_account_transfer_subuserhistory = sapiGetSubAccountTransferSubUserHistory = Entry(
        'sub-account/transfer/subUserHistory', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_sub_account_universaltransfer = sapiGetSubAccountUniversalTransfer = Entry(
        'sub-account/universalTransfer', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_sub_account_apirestrictions_iprestriction_thirdpartylist = (
        sapiGetSubAccountApiRestrictionsIpRestrictionThirdPartyList
    ) = Entry('sub-account/apiRestrictions/ipRestriction/thirdPartyList', 'sapi', 'GET', {'cost': 1})
    sapi_get_sub_account_transaction_tatistics = sapiGetSubAccountTransactionTatistics = Entry(
        'sub-account/transaction-tatistics', 'sapi', 'GET', {'cost': 0.4}
    )
    sapi_get_managed_subaccount_asset = sapiGetManagedSubaccountAsset = Entry(
        'managed-subaccount/asset', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_managed_subaccount_accountsnapshot = sapiGetManagedSubaccountAccountSnapshot = Entry(
        'managed-subaccount/accountSnapshot', 'sapi', 'GET', {'cost': 240}
    )
    sapi_get_managed_subaccount_querytranslogforinvestor = sapiGetManagedSubaccountQueryTransLogForInvestor = Entry(
        'managed-subaccount/queryTransLogForInvestor', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_managed_subaccount_querytranslogfortradeparent = sapiGetManagedSubaccountQueryTransLogForTradeParent = (
        Entry('managed-subaccount/queryTransLogForTradeParent', 'sapi', 'GET', {'cost': 0.1})
    )
    sapi_get_managed_subaccount_fetch_future_asset = sapiGetManagedSubaccountFetchFutureAsset = Entry(
        'managed-subaccount/fetch-future-asset', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_managed_subaccount_marginasset = sapiGetManagedSubaccountMarginAsset = Entry(
        'managed-subaccount/marginAsset', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_managed_subaccount_info = sapiGetManagedSubaccountInfo = Entry(
        'managed-subaccount/info', 'sapi', 'GET', {'cost': 0.4}
    )
    sapi_get_managed_subaccount_deposit_address = sapiGetManagedSubaccountDepositAddress = Entry(
        'managed-subaccount/deposit/address', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_managed_subaccount_query_trans_log = sapiGetManagedSubaccountQueryTransLog = Entry(
        'managed-subaccount/query-trans-log', 'sapi', 'GET', {'cost': 0.40002}
    )
    sapi_get_lending_daily_product_list = sapiGetLendingDailyProductList = Entry(
        'lending/daily/product/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_daily_userleftquota = sapiGetLendingDailyUserLeftQuota = Entry(
        'lending/daily/userLeftQuota', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_daily_userredemptionquota = sapiGetLendingDailyUserRedemptionQuota = Entry(
        'lending/daily/userRedemptionQuota', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_daily_token_position = sapiGetLendingDailyTokenPosition = Entry(
        'lending/daily/token/position', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_union_account = sapiGetLendingUnionAccount = Entry(
        'lending/union/account', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_union_purchaserecord = sapiGetLendingUnionPurchaseRecord = Entry(
        'lending/union/purchaseRecord', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_union_redemptionrecord = sapiGetLendingUnionRedemptionRecord = Entry(
        'lending/union/redemptionRecord', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_union_interesthistory = sapiGetLendingUnionInterestHistory = Entry(
        'lending/union/interestHistory', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_project_list = sapiGetLendingProjectList = Entry(
        'lending/project/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_project_position_list = sapiGetLendingProjectPositionList = Entry(
    ...
    sapi_get_mining_worker_detail = sapiGetMiningWorkerDetail = Entry(
    ...
    sapi_get_mining_statistics_user_status = sapiGetMiningStatisticsUserStatus = Entry(
        'mining/statistics/user/status', 'sapi', 'GET', {'cost': 0.5}
    )
    sapi_get_mining_statistics_user_list = sapiGetMiningStatisticsUserList = Entry(
    ...
    sapi_get_bswap_liquidity = sapiGetBswapLiquidity = Entry(
        'bswap/liquidity', 'sapi', 'GET', {'cost': 0.1, 'noPoolId': 1}
    )
    sapi_get_bswap_liquidityops = sapiGetBswapLiquidityOps = Entry(
    ...
    sapi_get_bswap_poolconfigure = sapiGetBswapPoolConfigure = Entry(
        'bswap/poolConfigure', 'sapi', 'GET', {'cost': 1.00005}
    )
    sapi_get_bswap_addliquiditypreview = sapiGetBswapAddLiquidityPreview = Entry(
        'bswap/addLiquidityPreview', 'sapi', 'GET', {'cost': 1.00005}
    )
    sapi_get_bswap_removeliquiditypreview = sapiGetBswapRemoveLiquidityPreview = Entry(
        'bswap/removeLiquidityPreview', 'sapi', 'GET', {'cost': 1.00005}
    )
    sapi_get_bswap_unclaimedrewards = sapiGetBswapUnclaimedRewards = Entry(
        'bswap/unclaimedRewards', 'sapi', 'GET', {'cost': 6.667}
    )
    sapi_get_bswap_claimedhistory = sapiGetBswapClaimedHistory = Entry(
    ...
    sapi_get_blvt_subscribe_record = sapiGetBlvtSubscribeRecord = Entry(
    ...
    sapi_get_apireferral_ifnewuser = sapiGetApiReferralIfNewUser = Entry(
        'apiReferral/ifNewUser', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_apireferral_customization = sapiGetApiReferralCustomization = Entry(
        'apiReferral/customization', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_apireferral_usercustomization = sapiGetApiReferralUserCustomization = Entry(
        'apiReferral/userCustomization', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_apireferral_rebate_recentrecord = sapiGetApiReferralRebateRecentRecord = Entry(
        'apiReferral/rebate/recentRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_apireferral_rebate_historicalrecord = sapiGetApiReferralRebateHistoricalRecord = Entry(
        'apiReferral/rebate/historicalRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_apireferral_kickback_recentrecord = sapiGetApiReferralKickbackRecentRecord = Entry(
        'apiReferral/kickback/recentRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_apireferral_kickback_historicalrecord = sapiGetApiReferralKickbackHistoricalRecord = Entry(
        'apiReferral/kickback/historicalRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccountapi = sapiGetBrokerSubAccountApi = Entry(
    ...
    sapi_get_broker_subaccountapi_commission_futures = sapiGetBrokerSubAccountApiCommissionFutures = Entry(
        'broker/subAccountApi/commission/futures', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccountapi_commission_coinfutures = sapiGetBrokerSubAccountApiCommissionCoinFutures = Entry(
        'broker/subAccountApi/commission/coinFutures', 'sapi', 'GET', {'cost': 1}
    )
    ...
    sapi_get_broker_transfer_futures = sapiGetBrokerTransferFutures = Entry(
        'broker/transfer/futures', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_rebate_recentrecord = sapiGetBrokerRebateRecentRecord = Entry(
        'broker/rebate/recentRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_rebate_historicalrecord = sapiGetBrokerRebateHistoricalRecord = Entry(
        'broker/rebate/historicalRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccount_bnbburn_status = sapiGetBrokerSubAccountBnbBurnStatus = Entry(
        'broker/subAccount/bnbBurn/status', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccount_deposithist = sapiGetBrokerSubAccountDepositHist = Entry(
        'broker/subAccount/depositHist', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccount_spotsummary = sapiGetBrokerSubAccountSpotSummary = Entry(
        'broker/subAccount/spotSummary', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccount_marginsummary = sapiGetBrokerSubAccountMarginSummary = Entry(
        'broker/subAccount/marginSummary', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccount_futuressummary = sapiGetBrokerSubAccountFuturesSummary = Entry(
        'broker/subAccount/futuresSummary', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_rebate_futures_recentrecord = sapiGetBrokerRebateFuturesRecentRecord = Entry(
        'broker/rebate/futures/recentRecord', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_subaccountapi_iprestriction = sapiGetBrokerSubAccountApiIpRestriction = Entry(
        'broker/subAccountApi/ipRestriction', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_broker_universaltransfer = sapiGetBrokerUniversalTransfer = Entry(
        'broker/universalTransfer', 'sapi', 'GET', {'cost': 1}
    )
    sapi_get_account_apirestrictions = sapiGetAccountApiRestrictions = Entry(
        'account/apiRestrictions', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_c2c_ordermatch_listuserorderhistory = sapiGetC2cOrderMatchListUserOrderHistory = Entry(
        'c2c/orderMatch/listUserOrderHistory', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_nft_history_transactions = sapiGetNftHistoryTransactions = Entry(
        'nft/history/transactions', 'sapi', 'GET', {'cost': 20.001}
    )
    sapi_get_nft_history_deposit = sapiGetNftHistoryDeposit = Entry(
        'nft/history/deposit', 'sapi', 'GET', {'cost': 20.001}
    )
    sapi_get_nft_history_withdraw = sapiGetNftHistoryWithdraw = Entry(
    ...
    sapi_get_giftcard_cryptography_rsa_public_key = sapiGetGiftcardCryptographyRsaPublicKey = Entry(
        'giftcard/cryptography/rsa-public-key', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_giftcard_buycode_token_limit = sapiGetGiftcardBuyCodeTokenLimit = Entry(
        'giftcard/buyCode/token-limit', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_algo_futures_openorders = sapiGetAlgoFuturesOpenOrders = Entry(
        'algo/futures/openOrders', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_algo_futures_historicalorders = sapiGetAlgoFuturesHistoricalOrders = Entry(
        'algo/futures/historicalOrders', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_algo_futures_suborders = sapiGetAlgoFuturesSubOrders = Entry(
    ...
    sapi_get_portfolio_balance = sapiPostPortfolioBalance = Entry('portfolio/balance', 'sapi', 'GET', {'cost': 0.1})
    sapi_get_portfolio_collateralrate = sapiGetPortfolioCollateralRate = Entry(
    ...
    sapi_get_portfolio_interest_history = sapiGetPortfolioInterestHistory = Entry(
        'portfolio/interest-history', 'sapi', 'GET', {'cost': 0.6667}
    )
    sapi_get_portfolio_asset_index_price = sapiGetPortfolioAssetIndexPrice = Entry(
        'portfolio/asset-index-price', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_portfolio_repay_futures_switch = sapiGetPortfolioRepayFuturesSwitch = Entry(
        'portfolio/repay-futures-switch', 'sapi', 'GET', {'cost': 3}
    )
    sapi_get_staking_productlist = sapiGetStakingProductList = Entry(
    ...
    sapi_get_staking_stakingrecord = sapiGetStakingStakingRecord = Entry(
        'staking/stakingRecord', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_staking_personalleftquota = sapiGetStakingPersonalLeftQuota = Entry(
        'staking/personalLeftQuota', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_target_asset_list = sapiGetLendingAutoInvestTargetAssetList = Entry(
        'lending/auto-invest/target-asset/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_target_asset_roi_list = sapiGetLendingAutoInvestTargetAssetRoiList = Entry(
        'lending/auto-invest/target-asset/roi/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_all_asset = sapiGetLendingAutoInvestAllAsset = Entry(
        'lending/auto-invest/all/asset', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_source_asset_list = sapiGetLendingAutoInvestSourceAssetList = Entry(
        'lending/auto-invest/source-asset/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_plan_list = sapiGetLendingAutoInvestPlanList = Entry(
        'lending/auto-invest/plan/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_plan_id = sapiGetLendingAutoInvestPlanId = Entry(
        'lending/auto-invest/plan/id', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_lending_auto_invest_history_list = sapiGetLendingAutoInvestHistoryList = Entry(
        'lending/auto-invest/history/list', 'sapi', 'GET', {'cost': 0.1}
    )
    sapi_get_simple_earn_flexible_list = sapiGetSimpleEarnFlexibleList = Entry(
        'simple-earn/flexible/list', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_locked_list = sapiGetSimpleEarnLockedList = Entry(
        'simple-earn/locked/list', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_flexible_personalleftquota = sapiGetSimpleEarnFlexiblePersonalLeftQuota = Entry(
        'simple-earn/flexible/personalLeftQuota', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_locked_personalleftquota = sapiGetSimpleEarnLockedPersonalLeftQuota = Entry(
        'simple-earn/locked/personalLeftQuota', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_flexible_subscriptionpreview = sapiGetSimpleEarnFlexibleSubscriptionPreview = Entry(
        'simple-earn/flexible/subscriptionPreview', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_locked_subscriptionpreview = sapiGetSimpleEarnLockedSubscriptionPreview = Entry(
        'simple-earn/locked/subscriptionPreview', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_flexible_history_ratehistory = sapiGetSimpleEarnFlexibleHistoryRateHistory = Entry(
        'simple-earn/flexible/history/rateHistory', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_flexible_position = sapiGetSimpleEarnFlexiblePosition = Entry(
        'simple-earn/flexible/position', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_locked_position = sapiGetSimpleEarnLockedPosition = Entry(
    ...
    sapi_get_simple_earn_flexible_history_subscriptionrecord = sapiGetSimpleEarnFlexibleHistorySubscriptionRecord = (
        Entry('simple-earn/flexible/history/subscriptionRecord', 'sapi', 'GET', {'cost': 15})
    )
    sapi_get_simple_earn_locked_history_subscriptionrecord = sapiGetSimpleEarnLockedHistorySubscriptionRecord = Entry(
        'simple-earn/locked/history/subscriptionRecord', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_flexible_history_redemptionrecord = sapiGetSimpleEarnFlexibleHistoryRedemptionRecord = Entry(
        'simple-earn/flexible/history/redemptionRecord', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_locked_history_redemptionrecord = sapiGetSimpleEarnLockedHistoryRedemptionRecord = Entry(
        'simple-earn/locked/history/redemptionRecord', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_flexible_history_rewardsrecord = sapiGetSimpleEarnFlexibleHistoryRewardsRecord = Entry(
        'simple-earn/flexible/history/rewardsRecord', 'sapi', 'GET', {'cost': 15}
    )
    sapi_get_simple_earn_locked_history_rewardsrecord = sapiGetSimpleEarnLockedHistoryRewardsRecord = Entry(
        'simple-earn/locked/history/rewardsRecord', 'sapi', 'GET', {'cost': 15}
    )
    ...
    sapi_post_asset_get_funding_asset = sapiPostAssetGetFundingAsset = Entry(
        'asset/get-funding-asset', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_asset_convert_transfer = sapiPostAssetConvertTransfer = Entry(
        'asset/convert-transfer', 'sapi', 'POST', {'cost': 0.033335}
    )
    sapi_post_account_disablefastwithdrawswitch = sapiPostAccountDisableFastWithdrawSwitch = Entry(
        'account/disableFastWithdrawSwitch', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_account_enablefastwithdrawswitch = sapiPostAccountEnableFastWithdrawSwitch = Entry(
        'account/enableFastWithdrawSwitch', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_capital_withdraw_apply = sapiPostCapitalWithdrawApply = Entry(
        'capital/withdraw/apply', 'sapi', 'POST', {'cost': 4.0002}
    )
    sapi_post_capital_contract_convertible_coins = sapiPostCapitalContractConvertibleCoins = Entry(
        'capital/contract/convertible-coins', 'sapi', 'POST', {'cost': 4.0002}
    )
    sapi_post_capital_deposit_credit_apply = sapiPostCapitalDepositCreditApply = Entry(
    ...
    sapi_post_margin_borrow_repay = sapiPostMarginBorrowRepay = Entry(
        'margin/borrow-repay', 'sapi', 'POST', {'cost': 150}
    )
    ...
    sapi_post_margin_exchange_small_liability = sapiPostMarginExchangeSmallLiability = Entry(
        'margin/exchange-small-liability', 'sapi', 'POST', {'cost': 20.001}
    )
    sapi_post_margin_isolated_transfer = sapiPostMarginIsolatedTransfer = Entry(
        'margin/isolated/transfer', 'sapi', 'POST', {'cost': 4.0002}
    )
    sapi_post_margin_isolated_account = sapiPostMarginIsolatedAccount = Entry(
        'margin/isolated/account', 'sapi', 'POST', {'cost': 2.0001}
    )
    sapi_post_margin_max_leverage = sapiPostMarginMaxLeverage = Entry(
        'margin/max-leverage', 'sapi', 'POST', {'cost': 300}
    )
    sapi_post_bnbburn = sapiPostBnbBurn = Entry('bnbBurn', 'sapi', 'POST', {'cost': 0.1})
    sapi_post_sub_account_virtualsubaccount = sapiPostSubAccountVirtualSubAccount = Entry(
        'sub-account/virtualSubAccount', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_margin_transfer = sapiPostSubAccountMarginTransfer = Entry(
        'sub-account/margin/transfer', 'sapi', 'POST', {'cost': 4.0002}
    )
    sapi_post_sub_account_margin_enable = sapiPostSubAccountMarginEnable = Entry(
        'sub-account/margin/enable', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_futures_enable = sapiPostSubAccountFuturesEnable = Entry(
        'sub-account/futures/enable', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_futures_transfer = sapiPostSubAccountFuturesTransfer = Entry(
        'sub-account/futures/transfer', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_futures_internaltransfer = sapiPostSubAccountFuturesInternalTransfer = Entry(
        'sub-account/futures/internalTransfer', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_transfer_subtosub = sapiPostSubAccountTransferSubToSub = Entry(
        'sub-account/transfer/subToSub', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_transfer_subtomaster = sapiPostSubAccountTransferSubToMaster = Entry(
        'sub-account/transfer/subToMaster', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_universaltransfer = sapiPostSubAccountUniversalTransfer = Entry(
        'sub-account/universalTransfer', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_sub_account_options_enable = sapiPostSubAccountOptionsEnable = Entry(
        'sub-account/options/enable', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_managed_subaccount_deposit = sapiPostManagedSubaccountDeposit = Entry(
        'managed-subaccount/deposit', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_managed_subaccount_withdraw = sapiPostManagedSubaccountWithdraw = Entry(
    ...
    sapi_post_userdatastream_isolated = sapiPostUserDataStreamIsolated = Entry(
    ...
    sapi_post_lending_customizedfixed_purchase = sapiPostLendingCustomizedFixedPurchase = Entry(
        'lending/customizedFixed/purchase', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_lending_daily_purchase = sapiPostLendingDailyPurchase = Entry(
        'lending/daily/purchase', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_lending_daily_redeem = sapiPostLendingDailyRedeem = Entry(
    ...
    sapi_post_bswap_liquidityremove = sapiPostBswapLiquidityRemove = Entry(
        'bswap/liquidityRemove', 'sapi', 'POST', {'cost': 60}
    )
    sapi_post_bswap_swap = sapiPostBswapSwap = Entry('bswap/swap', 'sapi', 'POST', {'cost': 60})
    sapi_post_bswap_claimrewards = sapiPostBswapClaimRewards = Entry(
    ...
    sapi_post_apireferral_customization = sapiPostApiReferralCustomization = Entry(
        'apiReferral/customization', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_apireferral_usercustomization = sapiPostApiReferralUserCustomization = Entry(
        'apiReferral/userCustomization', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_apireferral_rebate_historicalrecord = sapiPostApiReferralRebateHistoricalRecord = Entry(
        'apiReferral/rebate/historicalRecord', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_apireferral_kickback_historicalrecord = sapiPostApiReferralKickbackHistoricalRecord = Entry(
        'apiReferral/kickback/historicalRecord', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccount = sapiPostBrokerSubAccount = Entry('broker/subAccount', 'sapi', 'POST', {'cost': 1})
    sapi_post_broker_subaccount_margin = sapiPostBrokerSubAccountMargin = Entry(
        'broker/subAccount/margin', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccount_futures = sapiPostBrokerSubAccountFutures = Entry(
        'broker/subAccount/futures', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi = sapiPostBrokerSubAccountApi = Entry(
        'broker/subAccountApi', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_permission = sapiPostBrokerSubAccountApiPermission = Entry(
        'broker/subAccountApi/permission', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_commission = sapiPostBrokerSubAccountApiCommission = Entry(
        'broker/subAccountApi/commission', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_commission_futures = sapiPostBrokerSubAccountApiCommissionFutures = Entry(
        'broker/subAccountApi/commission/futures', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_commission_coinfutures = sapiPostBrokerSubAccountApiCommissionCoinFutures = Entry(
        'broker/subAccountApi/commission/coinFutures', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_transfer = sapiPostBrokerTransfer = Entry('broker/transfer', 'sapi', 'POST', {'cost': 1})
    sapi_post_broker_transfer_futures = sapiPostBrokerTransferFutures = Entry(
        'broker/transfer/futures', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_rebate_historicalrecord = sapiPostBrokerRebateHistoricalRecord = Entry(
        'broker/rebate/historicalRecord', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccount_bnbburn_spot = sapiPostBrokerSubAccountBnbBurnSpot = Entry(
        'broker/subAccount/bnbBurn/spot', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccount_bnbburn_margininterest = sapiPostBrokerSubAccountBnbBurnMarginInterest = Entry(
        'broker/subAccount/bnbBurn/marginInterest', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccount_blvt = sapiPostBrokerSubAccountBlvt = Entry(
        'broker/subAccount/blvt', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_iprestriction = sapiPostBrokerSubAccountApiIpRestriction = Entry(
        'broker/subAccountApi/ipRestriction', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_iprestriction_iplist = sapiPostBrokerSubAccountApiIpRestrictionIpList = Entry(
        'broker/subAccountApi/ipRestriction/ipList', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_universaltransfer = sapiPostBrokerUniversalTransfer = Entry(
        'broker/universalTransfer', 'sapi', 'POST', {'cost': 1}
    )
    sapi_post_broker_subaccountapi_permission_universaltransfer = (
        sapiPostBrokerSubAccountApiPermissionUniversalTransfer
    ) = Entry('broker/subAccountApi/permission/universalTransfer', 'sapi', 'POST', {'cost': 1})
    sapi_post_broker_subaccountapi_permission_vanillaoptions = sapiPostBrokerSubAccountApiPermissionVanillaOptions = (
        Entry('broker/subAccountApi/permission/vanillaOptions', 'sapi', 'POST', {'cost': 1})
    )
    sapi_post_giftcard_createcode = sapiPostGiftcardCreateCode = Entry(
        'giftcard/createCode', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_giftcard_redeemcode = sapiPostGiftcardRedeemCode = Entry(
    ...
    sapi_post_algo_futures_newordervp = sapiPostAlgoFuturesNewOrderVp = Entry(
        'algo/futures/newOrderVp', 'sapi', 'POST', {'cost': 20.001}
    )
    sapi_post_algo_futures_newordertwap = sapiPostAlgoFuturesNewOrderTwap = Entry(
    ...
    sapi_post_staking_setautostaking = sapiPostStakingSetAutoStaking = Entry(
    ...
    sapi_post_loan_customize_margin_call = sapiPostLoanCustomizeMarginCall = Entry(
        'loan/customize/margin_call', 'sapi', 'POST', {'cost': 40}
    )
    ...
    sapi_post_convert_acceptquote = sapiPostConvertAcceptQuote = Entry(
        'convert/acceptQuote', 'sapi', 'POST', {'cost': 3.3335}
    )
    sapi_post_portfolio_auto_collection = sapiPostPortfolioAutoCollection = Entry(
        'portfolio/auto-collection', 'sapi', 'POST', {'cost': 150}
    )
    sapi_post_portfolio_asset_collection = sapiPostPortfolioAssetCollection = Entry(
        'portfolio/asset-collection', 'sapi', 'POST', {'cost': 6}
    )
    sapi_post_portfolio_bnb_transfer = sapiPostPortfolioBnbTransfer = Entry(
        'portfolio/bnb-transfer', 'sapi', 'POST', {'cost': 150}
    )
    sapi_post_portfolio_repay_futures_switch = sapiPostPortfolioRepayFuturesSwitch = Entry(
        'portfolio/repay-futures-switch', 'sapi', 'POST', {'cost': 150}
    )
    sapi_post_portfolio_repay_futures_negative_balance = sapiPostPortfolioRepayFuturesNegativeBalance = Entry(
        'portfolio/repay-futures-negative-balance', 'sapi', 'POST', {'cost': 150}
    )
    sapi_post_lending_auto_invest_plan_add = sapiPostLendingAutoInvestPlanAdd = Entry(
        'lending/auto-invest/plan/add', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_lending_auto_invest_plan_edit = sapiPostLendingAutoInvestPlanEdit = Entry(
        'lending/auto-invest/plan/edit', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_lending_auto_invest_plan_edit_status = sapiPostLendingAutoInvestPlanEditStatus = Entry(
        'lending/auto-invest/plan/edit-status', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_simple_earn_flexible_subscribe = sapiPostSimpleEarnFlexibleSubscribe = Entry(
        'simple-earn/flexible/subscribe', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_simple_earn_locked_subscribe = sapiPostSimpleEarnLockedSubscribe = Entry(
        'simple-earn/locked/subscribe', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_simple_earn_flexible_redeem = sapiPostSimpleEarnFlexibleRedeem = Entry(
        'simple-earn/flexible/redeem', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_simple_earn_locked_redeem = sapiPostSimpleEarnLockedRedeem = Entry(
        'simple-earn/locked/redeem', 'sapi', 'POST', {'cost': 0.1}
    )
    sapi_post_simple_earn_flexible_setautosubscribe = sapiPostSimpleEarnFlexibleSetAutoSubscribe = Entry(
        'simple-earn/flexible/setAutoSubscribe', 'sapi', 'POST', {'cost': 15}
    )
    ...
    sapi_put_userdatastream_isolated = sapiPutUserDataStreamIsolated = Entry(
    ...
    sapi_delete_margin_openorders = sapiDeleteMarginOpenOrders = Entry(
    ...
    sapi_delete_margin_orderlist = sapiDeleteMarginOrderList = Entry(
        'margin/orderList', 'sapi', 'DELETE', {'cost': 0.0066667}
    )
    sapi_delete_margin_isolated_account = sapiDeleteMarginIsolatedAccount = Entry(
    ...
    sapi_delete_userdatastream_isolated = sapiDeleteUserDataStreamIsolated = Entry(
        'userDataStream/isolated', 'sapi', 'DELETE', {'cost': 0.1}
    )
    sapi_delete_broker_subaccountapi = sapiDeleteBrokerSubAccountApi = Entry(
        'broker/subAccountApi', 'sapi', 'DELETE', {'cost': 1}
    )
    sapi_delete_broker_subaccountapi_iprestriction_iplist = sapiDeleteBrokerSubAccountApiIpRestrictionIpList = Entry(
        'broker/subAccountApi/ipRestriction/ipList', 'sapi', 'DELETE', {'cost': 1}
    )
    sapi_delete_algo_futures_order = sapiDeleteAlgoFuturesOrder = Entry(
        'algo/futures/order', 'sapi', 'DELETE', {'cost': 0.1}
    )
    sapiv2_get_sub_account_futures_account = sapiV2GetSubAccountFuturesAccount = Entry(
        'sub-account/futures/account', 'sapiV2', 'GET', {'cost': 0.1}
    )
    sapiv2_get_sub_account_futures_positionrisk = sapiV2GetSubAccountFuturesPositionRisk = Entry(
        'sub-account/futures/positionRisk', 'sapiV2', 'GET', {'cost': 0.1}
    )
    sapiv2_get_portfolio_collateralrate = sapiV2GetPortfolioCollateralRate = Entry(
        'portfolio/collateralRate', 'sapiV2', 'GET', {'cost': 5}
    )
    sapiv3_get_sub_account_assets = sapiV3GetSubAccountAssets = Entry(
        'sub-account/assets', 'sapiV3', 'GET', {'cost': 1}
    )
    sapiv3_post_asset_getuserasset = sapiV3PostAssetGetUserAsset = Entry(
        'asset/getUserAsset', 'sapiV3', 'POST', {'cost': 0.5}
    )
    sapiv4_get_sub_account_assets = sapiV4GetSubAccountAssets = Entry(
        'sub-account/assets', 'sapiV4', 'GET', {'cost': 1}
    )
    wapi_post_withdraw = wapiPostWithdraw = Entry('withdraw', 'wapi', 'POST', {'cost': 1})
    wapi_post_sub_account_transfer = wapiPostSubAccountTransfer = Entry(
        'sub-account/transfer', 'wapi', 'POST', {'cost': 1}
    )
    ...
    wapi_get_userassetdribbletlog = wapiGetUserAssetDribbletLog = Entry(
        'userAssetDribbletLog', 'wapi', 'GET', {'cost': 1}
    )
    ...
    wapi_get_sub_account_transfer_history = wapiGetSubAccountTransferHistory = Entry(
        'sub-account/transfer/history', 'wapi', 'GET', {'cost': 1}
    )
    ...
    dapipublic_get_depth = dapiPublicGetDepth = Entry(
        'depth', 'dapiPublic', 'GET', {'cost': 2, 'byLimit': [[50, 2], [100, 5], [500, 10], [1000, 20]]}
    )
    dapipublic_get_trades = dapiPublicGetTrades = Entry('trades', 'dapiPublic', 'GET', {'cost': 5})
    dapipublic_get_historicaltrades = dapiPublicGetHistoricalTrades = Entry(
    ...
    dapipublic_get_klines = dapiPublicGetKlines = Entry(
        'klines', 'dapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    dapipublic_get_continuousklines = dapiPublicGetContinuousKlines = Entry(
        'continuousKlines', 'dapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    dapipublic_get_indexpriceklines = dapiPublicGetIndexPriceKlines = Entry(
        'indexPriceKlines', 'dapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    dapipublic_get_markpriceklines = dapiPublicGetMarkPriceKlines = Entry(
        'markPriceKlines', 'dapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    dapipublic_get_ticker_24hr = dapiPublicGetTicker24hr = Entry(
        'ticker/24hr', 'dapiPublic', 'GET', {'cost': 1, 'noSymbol': 40}
    )
    dapipublic_get_ticker_price = dapiPublicGetTickerPrice = Entry(
        'ticker/price', 'dapiPublic', 'GET', {'cost': 1, 'noSymbol': 2}
    )
    dapipublic_get_ticker_bookticker = dapiPublicGetTickerBookTicker = Entry(
        'ticker/bookTicker', 'dapiPublic', 'GET', {'cost': 1, 'noSymbol': 2}
    )
    dapipublic_get_openinterest = dapiPublicGetOpenInterest = Entry('openInterest', 'dapiPublic', 'GET', {'cost': 1})
    dapidata_get_openinteresthist = dapiDataGetOpenInterestHist = Entry(
        'openInterestHist', 'dapiData', 'GET', {'cost': 1}
    )
    dapidata_get_toplongshortaccountratio = dapiDataGetTopLongShortAccountRatio = Entry(
        'topLongShortAccountRatio', 'dapiData', 'GET', {'cost': 1}
    )
    dapidata_get_toplongshortpositionratio = dapiDataGetTopLongShortPositionRatio = Entry(
        'topLongShortPositionRatio', 'dapiData', 'GET', {'cost': 1}
    )
    dapidata_get_globallongshortaccountratio = dapiDataGetGlobalLongShortAccountRatio = Entry(
    ...
    dapiprivate_get_positionside_dual = dapiPrivateGetPositionSideDual = Entry(
    ...
    dapiprivate_get_openorders = dapiPrivateGetOpenOrders = Entry(
        'openOrders', 'dapiPrivate', 'GET', {'cost': 1, 'noSymbol': 5}
    )
    dapiprivate_get_allorders = dapiPrivateGetAllOrders = Entry(
    ...
    dapiprivate_get_positionmargin_history = dapiPrivateGetPositionMarginHistory = Entry(
    ...
    dapiprivate_get_usertrades = dapiPrivateGetUserTrades = Entry(
    ...
    dapiprivate_get_leveragebracket = dapiPrivateGetLeverageBracket = Entry(
        'leverageBracket', 'dapiPrivate', 'GET', {'cost': 1}
    )
    dapiprivate_get_forceorders = dapiPrivateGetForceOrders = Entry(
    ...
    dapiprivate_get_orderamendment = dapiPrivateGetOrderAmendment = Entry(
        'orderAmendment', 'dapiPrivate', 'GET', {'cost': 1}
    )
    dapiprivate_get_pmaccountinfo = dapiPrivateGetPmAccountInfo = Entry(
        'pmAccountInfo', 'dapiPrivate', 'GET', {'cost': 5}
    )
    dapiprivate_post_positionside_dual = dapiPrivatePostPositionSideDual = Entry(
    ...
    dapiprivate_post_countdowncancelall = dapiPrivatePostCountdownCancelAll = Entry(
    ...
    dapiprivate_post_positionmargin = dapiPrivatePostPositionMargin = Entry(
    ...
    dapiprivate_delete_allopenorders = dapiPrivateDeleteAllOpenOrders = Entry(
        'allOpenOrders', 'dapiPrivate', 'DELETE', {'cost': 1}
    )
    dapiprivate_delete_batchorders = dapiPrivateDeleteBatchOrders = Entry(
    ...
    dapiprivatev2_get_leveragebracket = dapiPrivateV2GetLeverageBracket = Entry(
    ...
    fapipublic_get_depth = fapiPublicGetDepth = Entry(
        'depth', 'fapiPublic', 'GET', {'cost': 2, 'byLimit': [[50, 2], [100, 5], [500, 10], [1000, 20]]}
    )
    fapipublic_get_trades = fapiPublicGetTrades = Entry('trades', 'fapiPublic', 'GET', {'cost': 5})
    fapipublic_get_historicaltrades = fapiPublicGetHistoricalTrades = Entry(
    ...
    fapipublic_get_klines = fapiPublicGetKlines = Entry(
        'klines', 'fapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    fapipublic_get_continuousklines = fapiPublicGetContinuousKlines = Entry(
        'continuousKlines', 'fapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    fapipublic_get_markpriceklines = fapiPublicGetMarkPriceKlines = Entry(
        'markPriceKlines', 'fapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    fapipublic_get_indexpriceklines = fapiPublicGetIndexPriceKlines = Entry(
        'indexPriceKlines', 'fapiPublic', 'GET', {'cost': 1, 'byLimit': [[99, 1], [499, 2], [1000, 5], [10000, 10]]}
    )
    ...
    fapipublic_get_ticker_24hr = fapiPublicGetTicker24hr = Entry(
        'ticker/24hr', 'fapiPublic', 'GET', {'cost': 1, 'noSymbol': 40}
    )
    fapipublic_get_ticker_price = fapiPublicGetTickerPrice = Entry(
        'ticker/price', 'fapiPublic', 'GET', {'cost': 1, 'noSymbol': 2}
    )
    fapipublic_get_ticker_bookticker = fapiPublicGetTickerBookTicker = Entry(
        'ticker/bookTicker', 'fapiPublic', 'GET', {'cost': 1, 'noSymbol': 2}
    )
    ...
    fapipublic_get_apitradingstatus = fapiPublicGetApiTradingStatus = Entry(
        'apiTradingStatus', 'fapiPublic', 'GET', {'cost': 1, 'noSymbol': 10}
    )
    fapipublic_get_lvtklines = fapiPublicGetLvtKlines = Entry('lvtKlines', 'fapiPublic', 'GET', {'cost': 1})
    fapidata_get_openinteresthist = fapiDataGetOpenInterestHist = Entry(
        'openInterestHist', 'fapiData', 'GET', {'cost': 1}
    )
    fapidata_get_toplongshortaccountratio = fapiDataGetTopLongShortAccountRatio = Entry(
        'topLongShortAccountRatio', 'fapiData', 'GET', {'cost': 1}
    )
    fapidata_get_toplongshortpositionratio = fapiDataGetTopLongShortPositionRatio = Entry(
        'topLongShortPositionRatio', 'fapiData', 'GET', {'cost': 1}
    )
    fapidata_get_globallongshortaccountratio = fapiDataGetGlobalLongShortAccountRatio = Entry(
        'globalLongShortAccountRatio', 'fapiData', 'GET', {'cost': 1}
    )
    fapidata_get_takerlongshortratio = fapiDataGetTakerlongshortRatio = Entry(
        'takerlongshortRatio', 'fapiData', 'GET', {'cost': 1}
    )
    fapiprivate_get_forceorders = fapiPrivateGetForceOrders = Entry(
    ...
    fapiprivate_get_leveragebracket = fapiPrivateGetLeverageBracket = Entry(
        'leverageBracket', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_positionmargin_history = fapiPrivateGetPositionMarginHistory = Entry(
    ...
    fapiprivate_get_positionside_dual = fapiPrivateGetPositionSideDual = Entry(
    ...
    fapiprivate_get_commissionrate = fapiPrivateGetCommissionRate = Entry(
        'commissionRate', 'fapiPrivate', 'GET', {'cost': 20}
    )
    fapiprivate_get_apitradingstatus = fapiPrivateGetApiTradingStatus = Entry(
        'apiTradingStatus', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_multiassetsmargin = fapiPrivateGetMultiAssetsMargin = Entry(
        'multiAssetsMargin', 'fapiPrivate', 'GET', {'cost': 30}
    )
    fapiprivate_get_apireferral_ifnewuser = fapiPrivateGetApiReferralIfNewUser = Entry(
        'apiReferral/ifNewUser', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_customization = fapiPrivateGetApiReferralCustomization = Entry(
        'apiReferral/customization', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_usercustomization = fapiPrivateGetApiReferralUserCustomization = Entry(
        'apiReferral/userCustomization', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_tradernum = fapiPrivateGetApiReferralTraderNum = Entry(
        'apiReferral/traderNum', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_overview = fapiPrivateGetApiReferralOverview = Entry(
        'apiReferral/overview', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_tradevol = fapiPrivateGetApiReferralTradeVol = Entry(
        'apiReferral/tradeVol', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_rebatevol = fapiPrivateGetApiReferralRebateVol = Entry(
        'apiReferral/rebateVol', 'fapiPrivate', 'GET', {'cost': 1}
    )
    fapiprivate_get_apireferral_tradersummary = fapiPrivateGetApiReferralTraderSummary = Entry(
    ...
    fapiprivate_get_orderamendment = fapiPrivateGetOrderAmendment = Entry(
    ...
    fapiprivate_get_order_asyn_id = fapiPrivateGetOrderAsynId = Entry(
        'order/asyn/id', 'fapiPrivate', 'GET', {'cost': 5}
    )
    fapiprivate_get_trade_asyn = fapiPrivateGetTradeAsyn = Entry('trade/asyn', 'fapiPrivate', 'GET', {'cost': 5})
    fapiprivate_get_trade_asyn_id = fapiPrivateGetTradeAsynId = Entry(
    ...
    fapiprivate_post_positionmargin = fapiPrivatePostPositionMargin = Entry(
    ...
    fapiprivate_post_countdowncancelall = fapiPrivatePostCountdownCancelAll = Entry(
        'countdownCancelAll', 'fapiPrivate', 'POST', {'cost': 10}
    )
    fapiprivate_post_multiassetsmargin = fapiPrivatePostMultiAssetsMargin = Entry(
        'multiAssetsMargin', 'fapiPrivate', 'POST', {'cost': 1}
    )
    fapiprivate_post_apireferral_customization = fapiPrivatePostApiReferralCustomization = Entry(
        'apiReferral/customization', 'fapiPrivate', 'POST', {'cost': 1}
    )
    fapiprivate_post_apireferral_usercustomization = fapiPrivatePostApiReferralUserCustomization = Entry(
        'apiReferral/userCustomization', 'fapiPrivate', 'POST', {'cost': 1}
    )
    ...
    fapiprivate_delete_batchorders = fapiPrivateDeleteBatchOrders = Entry(
    ...
    fapiprivate_delete_allopenorders = fapiPrivateDeleteAllOpenOrders = Entry(
    ...
    fapiprivatev2_get_positionrisk = fapiPrivateV2GetPositionRisk = Entry(
    ...
    eapipublic_get_historicaltrades = eapiPublicGetHistoricalTrades = Entry(
        'historicalTrades', 'eapiPublic', 'GET', {'cost': 20}
    )
    eapipublic_get_exercisehistory = eapiPublicGetExerciseHistory = Entry(
    ...
    eapiprivate_get_openorders = eapiPrivateGetOpenOrders = Entry(
        'openOrders', 'eapiPrivate', 'GET', {'cost': 1, 'noSymbol': 40}
    )
    eapiprivate_get_historyorders = eapiPrivateGetHistoryOrders = Entry(
    ...
    eapiprivate_get_exerciserecord = eapiPrivateGetExerciseRecord = Entry(
    ...
    eapiprivate_get_income_asyn_id = eapiPrivateGetIncomeAsynId = Entry(
        'income/asyn/id', 'eapiPrivate', 'GET', {'cost': 5}
    )
    eapiprivate_get_marginaccount = eapiPrivateGetMarginAccount = Entry(
        'marginAccount', 'eapiPrivate', 'GET', {'cost': 3}
    )
    eapiprivate_get_mmp = eapiPrivateGetMmp = Entry('mmp', 'eapiPrivate', 'GET', {'cost': 1})
    eapiprivate_get_countdowncancelall = eapiPrivateGetCountdownCancelAll = Entry(
    ...
    eapiprivate_post_countdowncancelall = eapiPrivatePostCountdownCancelAll = Entry(
        'countdownCancelAll', 'eapiPrivate', 'POST', {'cost': 1}
    )
    eapiprivate_post_countdowncancelallheartbeat = eapiPrivatePostCountdownCancelAllHeartBeat = Entry(
    ...
    eapiprivate_delete_batchorders = eapiPrivateDeleteBatchOrders = Entry(
        'batchOrders', 'eapiPrivate', 'DELETE', {'cost': 1}
    )
    eapiprivate_delete_allopenorders = eapiPrivateDeleteAllOpenOrders = Entry(
        'allOpenOrders', 'eapiPrivate', 'DELETE', {'cost': 1}
    )
    eapiprivate_delete_allopenordersbyunderlying = eapiPrivateDeleteAllOpenOrdersByUnderlying = Entry(
    ...
    public_get_depth = publicGetDepth = Entry(
        'depth', 'public', 'GET', {'cost': 1, 'byLimit': [[100, 1], [500, 5], [1000, 10], [5000, 50]]}
    )
    ...
    public_get_ticker_bookticker = publicGetTickerBookTicker = Entry(
        'ticker/bookTicker', 'public', 'GET', {'cost': 1, 'noSymbol': 2}
    )
    ...
    private_get_mypreventedmatches = privateGetMyPreventedMatches = Entry(
        'myPreventedMatches', 'private', 'GET', {'cost': 1}
    )
    ...
    private_post_order_cancelreplace = privatePostOrderCancelReplace = Entry(
        'order/cancelReplace', 'private', 'POST', {'cost': 1}
    )
    ...
    papi_get_margin_maxborrowable = papiGetMarginMaxBorrowable = Entry(
        'margin/maxBorrowable', 'papi', 'GET', {'cost': 5}
    )
    ...
    papi_get_um_positionside_dual = papiGetUmPositionSideDual = Entry(
        'um/positionSide/dual', 'papi', 'GET', {'cost': 30}
    )
    papi_get_cm_positionside_dual = papiGetCmPositionSideDual = Entry(
        'cm/positionSide/dual', 'papi', 'GET', {'cost': 30}
    )
    ...
    papi_get_margin_margininteresthistory = papiGetMarginMarginInterestHistory = Entry(
        'margin/marginInterestHistory', 'papi', 'GET', {'cost': 0.1}
    )
    ...
    papi_post_um_positionside_dual = papiPostUmPositionSideDual = Entry(
        'um/positionSide/dual', 'papi', 'POST', {'cost': 1}
    )
    papi_post_cm_positionside_dual = papiPostCmPositionSideDual = Entry(
        'cm/positionSide/dual', 'papi', 'POST', {'cost': 1}
    )
    ...
    papi_post_repay_futures_switch = papiPostRepayFuturesSwitch = Entry(
        'repay-futures-switch', 'papi', 'POST', {'cost': 150}
    )
    papi_post_repay_futures_negative_balance = papiPostRepayFuturesNegativeBalance = Entry(
    ...
    papi_delete_margin_allopenorders = papiDeleteMarginAllOpenOrders = Entry(
