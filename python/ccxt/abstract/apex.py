...
class ImplicitAPI:
    ...
    private_get_v3_stock_account = privateGetV3StockAccount = Entry[_Dict]('v3/stock/account', 'private', 'GET', {'cost': 1})
    ...
    private_post_v3_contract_transfer_to = privatePostV3ContractTransferTo = Entry[_Dict]('v3/contract-transfer-to', 'private', 'POST', {'cost': 1})
    private_post_v3_submit_withdraw_claim = privatePostV3SubmitWithdrawClaim = Entry[_Dict]('v3/submit-withdraw-claim', 'private', 'POST', {'cost': 1})
    private_post_v3_stock_register_account = privatePostV3StockRegisterAccount = Entry[_Dict]('v3/stock/register-account', 'private', 'POST', {'cost': 1})
    private_post_v3_stock_generate_api = privatePostV3StockGenerateApi = Entry[_Dict]('v3/stock/generate-api', 'private', 'POST', {'cost': 1})
