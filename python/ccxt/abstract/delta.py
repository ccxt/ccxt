...
class ImplicitAPI:
    ...
    private_get_rate_limits_quota = privateGetRateLimitsQuota = Entry('rate_limits/quota', 'private', 'GET', {})
    ...
    private_put_users_margin_mode = privatePutUsersMarginMode = Entry('users/margin_mode', 'private', 'PUT', {})
