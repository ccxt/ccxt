...
class ImplicitAPI:
    ...
    fapipublic_post_v1_listenkey = fapiPublicPostV1ListenKey = Entry('v1/listenKey', 'fapiPublic', 'POST', {})
    fapipublic_put_v1_listenkey = fapiPublicPutV1ListenKey = Entry('v1/listenKey', 'fapiPublic', 'PUT', {})
    fapipublic_delete_v1_listenkey = fapiPublicDeleteV1ListenKey = Entry('v1/listenKey', 'fapiPublic', 'DELETE', {})
    ...
    sapipublic_post_v1_getnonce = sapiPublicPostV1GetNonce = Entry('v1/getNonce', 'sapiPublic', 'POST', {})
    sapipublic_post_v1_createapikey = sapiPublicPostV1CreateApiKey = Entry('v1/createApiKey', 'sapiPublic', 'POST', {})
    sapipublic_post_v1_listenkey = sapiPublicPostV1ListenKey = Entry('v1/listenKey', 'sapiPublic', 'POST', {})
    sapipublic_put_v1_listenkey = sapiPublicPutV1ListenKey = Entry('v1/listenKey', 'sapiPublic', 'PUT', {})
    sapipublic_delete_v1_listenkey = sapiPublicDeleteV1ListenKey = Entry('v1/listenKey', 'sapiPublic', 'DELETE', {})
