...
class fswap(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        #
        response = self.fswapPublicGetCmcPairs(params)
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        #
        response = self.fswapPublicGetAssets(params)
        data = self.safe_value(response, 'data', {})
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        #
        response = self.mixinPrivateGetSafeSnapshots(params)
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        #
        response = self.fswapPrivateGetOrdersFollowId(
            self.extend({
                'follow_id': id,
            }, params)
        )
    ...
    def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        # Fetch the trades
        response = self.fswapPrivateGetTransactionsBaseQuoteMine(self.extend(request, params))
        data = self.safe_value(response, 'data', {})
    ...
    def get_safe_tx(self, asset_id: str, amount: str, memo: str) -> str:
        ...
        resp = self.mixinPrivateGetSafeSnapshots({
            'asset': asset_id,
            'state': 'unspent',
        })
        ...
        ghosts = self.mixinPrivatePostSafeKeys(recipientDetails)
        print('utxos', utxos)
        print('ghosts', ghosts)
    ...
    def get_safe_tx_raw(self, hexTx: str, signaturesMap: List[dict] = []):
        encodeResp = self.ccxtProxyPostMixinEncodetx({
            'tx': hexTx,
    ...
    def verify_safe_tx(self, hexTx: str):
        ...
        raw = self.get_safe_tx_raw(hexTx)
        request_id = self.uuid()
        # Verify tx
        verifyResp = self.mixinPrivatePostSafeTransactionRequests([{
            raw,
            request_id,
        }])
    ...
    def sign_safe_tx(self, tx: dict, views: List[str], privateKey: str) -> str:
        index = 0
    ...
    def send_safe_tx(self, signedRaw: str, request_id: str):
        resp = self.mixinPrivatePostSafeTransactions({
            'raw': signedRaw,
    ...
    def safe_transfer(self, asset_id: str, amount: str, memo: str):
        hexTx = self.get_safe_tx(asset_id, amount, memo)
        ...
        signedTx = self.sign_safe_tx(verifiedTx, views, self.privateKey)
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num, params: {}) -> Order:
        ...
        print('memo:', memo)
        # 3. Init safe tx
        resp = self.safe_transfer(payAssetId, str(amount), memo)
