...
class cryptocom(Exchange):
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        return await self.privatePostPrivateCancelAllOrders(self.extend(request, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.privatePostPrivateCancelOrder(self.extend(request, params))
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = await self.privatePostPrivateCreateWithdrawal(self.extend(request, params))
        #
        #    {
        #        "id":-1,
    ...
    async def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['page_size'] = limit
        response = await self.privatePostPrivateGetWithdrawalHistory(self.extend(request, params))
        #
        #     {
        #       id: 1640704829096,
