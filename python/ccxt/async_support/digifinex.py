...
class digifinex(Exchange):
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        response = await self.publicSpotGetTicker(params)
        #
        #    {
        #        "ticker": [{
        #            "vol": 40717.4461,
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = await self.privateSpotPostMarketOrderNew(self.extend(request, params))
        #
        #     {
        #         "code": 0,
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.privateSpotPostMarketOrderCancel(self.extend(request, params))
        #
        #     {
        #         "code": 0,
        #         "success": [
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.privateSpotGetMarketOrderCurrent(self.extend(request, params))
        #
        #     {
        #         "code": 0,
        #         "data": [
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.privateSpotGetMarketOrderHistory(self.extend(request, params))
        #
        #     {
        #         "code": 0,
        #         "data": [
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.privateSpotGetMarketOrder(self.extend(request, params))
        #
        #     {
        #         "code": 0,
        #         "data": [
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit  # default 10, max 100
        response = await self.privateSpotGetMarketMytrades(self.extend(request, params))
        #
        #      {
        #          "list":[
        #              {
    ...
    async def fetch_ledger(self, code=None, since=None, limit=None, params={}):
        ...
        response = await self.privateSpotGetMarketFinancelog(self.extend(request, params))
        #
        #     {
        #         "code": 0,
        #         "data": {
