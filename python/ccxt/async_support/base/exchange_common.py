...
async def edit_limit_buy_order(self, id, symbol, amount, price, params={}):
    return await self.edit_limit_order(id, symbol, 'buy', amount, price, params)


async def edit_limit_sell_order(self, id, symbol, amount, price, params={}):
    return await self.edit_limit_order(id, symbol, 'sell', amount, price, params)


async def edit_limit_order(self, id, symbol, amount, price, params={}):
