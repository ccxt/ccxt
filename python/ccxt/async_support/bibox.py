...
class bibox(Exchange):
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.v4PublicGetMarketdataTicker(self.extend(request, params))
        #
        #    [
        #        {
        #            "s": "ADA_USDT",             # trading pair code
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        if limit is not None:
            ...
            request['level'] = limit
        response = await self.v4PublicGetMarketdataOrderBook(self.extend(request, params))
        #
        #    {
    ...
    async def fetch_ledger(self, code=None, since=None, limit=None, params={}):
        ...
        if until is not None:
            request['end_time'] = until
        response = await self.v4PrivateGetUserdataLedger(self.extend(request, params))
        #
        #    [
        #        {
        #            "i": 1125899918063693495,     # entry id
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        ...
        response = await self.v4PrivateDeleteUserdataOrders(self.extend(request, params))
        #
        # []
        #
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.v4PrivateDeleteUserdataOrder(self.extend(request, params))
        #
        #    {
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        response = await self.v4PrivateGetUserdataOrder(self.extend(request, params))
        #
        #    {
    ...
    async def fetch_orders_by_status(self, status, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.v4PrivateGetUserdataOrders(self.extend(request, params))
        #
        #    [
        #        {
        #            "i": 14589419788970785,
