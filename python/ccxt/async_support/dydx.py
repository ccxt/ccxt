...
class dydx(Exchange, ImplicitAPI):
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params: dict = {}) -> list[list]:
        ...
        response = await self.indexerGetCandlesPerpetualMarketsMarket(self.extend(request, paramsOmitted))
        #
        # {
        #     "candles": [
        #         {
    ...
    async def fetch_positions(self, symbols: Strings = None, params: dict = {}) -> list[Position]:
        ...
        response = await self.indexerGetPerpetualPositions(self.extend(request, paramsSubAccountNumber))
        #
        # {
        #     "positions": [
        #         {
    ...
    async def fetch_balance(self, params: dict = {}) -> Balances:
        ...
        response = await self.indexerGetAddressesAddressSubaccountNumberSubaccountNumber(self.extend(request, paramsSubaccountNumber))
        #
        # {
        #     "subaccount": {
        #         "address": "dydx14zzueazeh0hj67cghhf9jypslcf9sh2n5k6art",
