...
class ataix(Exchange):
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        await self.load_markets()
        response = await self.publicGetBookSymbol(self.extend({
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.publicGetPricesSymbol(self.extend(request, params))
        tickers = self.safe_value(response, 'result', [])
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        await self.load_markets()
        response = await self.privateGetOrdersOrderID({'orderID': id})
    ...
    async def fetch_deposit_address(self, code, params={}):
        ...
        response = await self.privateGetUserDepositCurrency(self.extend(request, params))
    ...
    async def create_deposit_address(self, code, params={}):
        ...
        response = await self.privatePostUserDepositCurrency(self.extend(request, params))
        address = self.safe_value(response, 'result')['address']
        self.check_address(address)
        return {
            'currency': code,
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = await self.privatePostUserWithdraw(self.extend(request, params))
        return {
            'info': response,
