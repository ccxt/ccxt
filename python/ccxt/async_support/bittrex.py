...
class bittrex(Exchange):
    ...
    async def fetch_markets(self, params={}):
        ...
        for i in range(0, len(response)):
            ...
            id = baseId + self.options['symbolSeparator'] + quoteId
    ...
    async def fetch_balance(self, params={}):
        ...
        balances = await self.v3GetBalances(params)
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        response = await self.v3publicGetMarketsMarketSymbolOrderbook(self.extend(request, params))
    ...
    def parse_ticker(self, ticker, market=None):
        ...
        previous = self.safe_float(ticker, 'percentChange')
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        await self.load_markets()
        response = await self.v3GetMarketsSummaries(params)
        tickers = []
        for i in range(0, len(response)):
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        response = await self.v3GetMarketsMarketSymbolSummary(self.extend(request, params))
        ticker = response[0]
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        response = await self.v3GetOrdersOpen(self.extend(request, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.v3DeleteOrdersOrderId(self.extend(request, params))
    ...
    async def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        response = await self.v3GetDepositsClosed(self.extend(request, params))
    ...
    async def fetch_withdrawals(self, code=None, since=None, limit=None, params={}):
        ...
        if code is not None:
            currency = self.currency(code)
            request['currencySymbol'] = currency['id']
        response = await self.v3GetWithdrawalsClosed(self.extend(request, params))
        return self.parse_transactions(response, currency, since, limit)
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        try:
            ...
            response = await self.v3GetOrdersOrderId(self.extend(request, params))
    ...
    async def fetch_deposit_address(self, code, params={}):
        ...
        response = await self.v3GetAddressesCurrencySymbol(self.extend(request, params))
        # {
        #     "status": "PROVISIONED",
        #     "currencySymbol": "BTC",
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        response = await self.v3PostWithdrawals(self.extend(request, params))
    ...
    async def request(self, path, api='v3', method='GET', params={}, headers=None, body=None):
