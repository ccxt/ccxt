...
class rubin(Exchange, ImplicitAPI):
    ...
    async def fetch_rubin_account(self):
        # required in js
        ...
        # }
        #
        response = await self.nodeRestGetCosmosAuthV1beta1AccountInfoRubinAddress(request)
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        account = await self.fetch_rubin_account()
