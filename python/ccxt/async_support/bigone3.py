...
class bigone3 (Exchange):
    ...
    async def describe(self):
        return self.deep_extend(super(bigone, self).describe(), {
            ...
            'urls': {
                ...
                'referral': 'https://b1.run/users/new?code=R6RQCVMH',
            },
            'api': {
                'public': {
                    'get': [
    ...
    async def parse_ticker(self, ticker, market=None):
        #
        #     [
        #         {
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        response = await self.publicGetAssetPairsTickers(params)
    ...
    async def fetch_balance(self, params={}):
        ...
        for i in range(0, len(balances)):
            balance = balances[i]
            currencyId = self.safe_string(balance, 'asset_symbol')
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        request = {
            'asset_pair_name': market['id'],  # market uuid d2185614-50c3-4588-b146-b8afe7534da6, required
    ...
    async def cancel_all_orders(self, symbol=None, params={}):
        await self.load_markets()
        response = await self.privatePostOrdersCancel(params)
        # {
        #     "code": 0,
        #     "data": {
        #         "cancelled": [
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=20, params={}):
        if symbol is None:
        ...
        request = {
            ...
            # asset_pair_name  asset_pair_name                                             ETH-BTC         True
            # page_token     ask for the server to return orders after the cursor  dGVzdGN1cmVzZQo False
            # side      order side one of                                     "ASK"/"BID"     False
            # state     order state one of                      "CANCELED"/"FILLED"/"PENDING" False
            # limit     default 20; max 200.                      20 False
    ...
    async def parse_order_status(self, status):
        statuses = {
            'PENDING': 'open',
            'FILLED': 'closed',
            'CANCELED': 'canceled',
    ...
    async def handle_errors(self, httpCode, reason, url, method, headers, body, response, requestHeaders, requestBody):
        if response is None:
