...
class gateio(Exchange):
    ...
    async def fetch_markets(self, params={}):
        response = await self.publicSpotGetCurrencyPairs(params)
        #
        #     {
        #       "id": "DEGO_USDT",
        #       "base": "DEGO",
    ...
    async def fetch_balance(self, params={}):
        await self.load_markets()
        response = await self.privateSpotGetAccounts(params)
        #
        #     [
        #       {
        #         "currency": "DBC",
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        response = await self.privateSpotPostOrders(self.extend(request, params))
    ...
    async def cancel_order(self, id, symbol=None, params={}):
        ...
        response = await self.privateSpotDeleteOrdersOrderId(self.extend(request, params))
