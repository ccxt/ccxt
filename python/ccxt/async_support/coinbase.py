...
class coinbase(Exchange, ImplicitAPI):
    ...
    async def fetch_time(self, params: dict = {}) -> Int:
        ...
        if method == 'v2PublicGetTime':
            response = await self.v2PublicGetTime(paramsOmitted)
            #
            #     {
            #         "data": {
            #             "epoch": 1589295679,
            ...
            response = await self.v3PublicGetBrokerageTime(paramsOmitted)
            #
            #     {
    ...
    async def fetch_accounts_v2(self, params: dict = {}) -> list[Account]:
        ...
        response = await self.v2PrivateGetAccounts(self.extend(request, paramsPaginate))
        #
        #     {
        #         "pagination": {
        #             "ending_before": null,
    ...
    async def fetch_accounts_v3(self, params: dict = {}) -> list[Account]:
        ...
        response = await self.v3PrivateGetBrokerageAccounts(self.extend(request, paramsPaginate))
        #
        #     {
        #         "accounts": [
        #             {
    ...
    async def fetch_portfolios(self, params: dict = {}) -> list[Account]:
        """
    ...
    async def create_deposit_address(self, code: str, params: dict = {}) -> DepositAddress:
        ...
        response = await self.v2PrivatePostAccountsAccountIdAddresses(self.extend(request, paramsOmitted))
        #
        #     {
        #         "data": {
    ...
    async def fetch_my_sells(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Trade]:
        """
 @ignore
        fetch sells
    ...
    async def fetch_my_buys(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Trade]:
        """
 @ignore
        fetch buys
    ...
    async def fetch_transactions_with_method(self, method: str, code: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Transaction]:
        request, paramsValue = await self.prepare_account_request_with_currency_code(code, limit, params)
        if self.markets is None:
            await self.load_markets()
        response = None
        if method == 'v2PrivateGetAccountsAccountIdTransactions':
            response = await self.v2PrivateGetAccountsAccountIdTransactions(self.extend(request, paramsValue))
        elif method == 'v2PrivateGetAccountsAccountIdWithdrawals':
            response = await self.v2PrivateGetAccountsAccountIdWithdrawals(self.extend(request, paramsValue))
        else:
            response = await self.v2PrivateGetAccountsAccountIdDeposits(self.extend(request, paramsValue))
    ...
    async def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Transaction]:
        ...
        if currencyType == 'crypto':
            results = await self.fetch_transactions_with_method('v2PrivateGetAccountsAccountIdTransactions', code, since, limit, paramsCurrencyType)
            return self.filter_by_array(results, 'type', 'withdrawal', False)
        return await self.fetch_transactions_with_method('v2PrivateGetAccountsAccountIdWithdrawals', code, since, limit, paramsCurrencyType)
    ...
    async def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Transaction]:
        ...
        return await self.fetch_transactions_with_method('v2PrivateGetAccountsAccountIdDeposits', code, since, limit, paramsCurrencyType)
    ...
    async def fetch_markets_v2(self, params: dict = {}) -> list[Market]:
    ...
    async def fetch_currencies_from_cache(self, params: dict = {}) -> dict:
    ...
    async def fetch_tickers_v2(self, symbols: Strings = None, params: dict = {}) -> Tickers:
        if self.markets is None:
            await self.load_markets()
    ...
    async def fetch_tickers_v3(self, symbols: Strings = None, params: dict = {}) -> Tickers:
        if self.markets is None:
            await self.load_markets()
        symbolsNormalized = self.market_symbols(symbols)
        request = {}
        ...
        if usePrivate:
            response = await self.v3PrivateGetBrokerageProducts(self.extend(request, paramsUsePrivate))
        else:
            response = await self.v3PublicGetBrokerageMarketProducts(self.extend(request, paramsUsePrivate))
        #
        #     {
        #         "products": [
        #             {
    ...
    async def fetch_ticker_v3(self, symbol: str, params: dict = {}) -> Ticker:
        if self.markets is None:
            await self.load_markets()
        market = self.market(symbol)
        request = {
        ...
        response = None
        if usePrivate:
            response = await self.v3PrivateGetBrokerageProductsProductIdTicker(self.extend(request, paramsUsePrivate))
        else:
            response = await self.v3PublicGetBrokerageMarketProductsProductIdTicker(self.extend(request, paramsUsePrivate))
        #
        #     {
        #         "trades": [
        #             {
    ...
    async def fetch_balance(self, params: dict = {}) -> Balances:
        ...
        if marketType == 'future':
            response = await self.v3PrivateGetBrokerageCfmBalanceSummary(self.extend(request, paramsMarketType))
        elif (isV3 is True) or (method == 'v3PrivateGetBrokerageAccounts'):
            request['limit'] = 250
            response = await self.v3PrivateGetBrokerageAccounts(self.extend(request, paramsMarketType))
        else:
            request['limit'] = 250
            response = await self.v2PrivateGetAccounts(self.extend(request, paramsMarketType))
        #
    ...
    async def fetch_ledger(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[LedgerEntry]:
        ...
        request, paramsValue = await self.prepare_account_request_with_currency_code(code, limit, paramsPaginate)
    ...
    async def prepare_account_request_with_currency_code(self, code: Str = None, limit: Int = None, params: dict = {}) -> list:
        accountId = self.safe_string_2(params, 'account_id', 'accountId')
        ...
        if accountId is None:
            ...
            accountId = await self.find_account_id(code, paramsOmitted)
            if accountId is None:
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params: dict = {}) -> Order:
        ...
        if reduceOnly is True:
            ...
            return await self.close_position(symbol, side, paramsClose)
        ...
        if preview is True:
            ...
            response = await self.v3PrivatePostBrokerageOrdersPreview(self.extend(request, self.omit(paramsOmitted, ['preview', 'test'])))
        else:
            response = await self.v3PrivatePostBrokerageOrders(self.extend(request, paramsOmitted))
        #
        # successful order
        #
        #     {
    ...
    async def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {}) -> Order:
        ...
        response = None
        if preview is True:
            response = await self.v3PrivatePostBrokerageOrdersEditPreview(self.extend(request, self.omit(params, ['preview', 'test'])))
        else:
    ...
    async def fetch_orders(self, symbol: Str = None, since: Int = None, limit: Int = 100, params: dict = {}) -> list[Order]:
        ...
        response = await self.v3PrivateGetBrokerageOrdersHistoricalBatch(self.extend(request, paramsOmitted))
        #
        #     {
        #         "orders": [
        #             {
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Order]:
        ...
        return await self.fetch_orders_by_status('OPEN', symbol, since, limit, paramsPaginate)
    ...
    async def fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Order]:
        ...
        return await self.fetch_orders_by_status('FILLED', symbol, since, limit, paramsPaginate)
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe: str = '1m', since: Int = None, limit: Int = None, params: dict = {}) -> list[list]:
        ...
        if paginate:
            return await self.fetch_paginated_call_deterministic('fetchOHLCV', symbol, since, limitValue, timeframe, paramsPaginate, maxLimit - 1)
        market = self.market(symbol)
        request = {
            'product_id': market['id'],
        ...
        if usePrivate:
            response = await self.v3PrivateGetBrokerageProductsProductIdCandles(self.extend(request, paramsUsePrivate))
        else:
            response = await self.v3PublicGetBrokerageMarketProductsProductIdCandles(self.extend(request, paramsUsePrivate))
        #
        #     {
        #         "candles": [
        #             {
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Trade]:
        ...
        paramsOmitted = self.omit(paramsPaginate, ['until']) if (until is not None) else paramsPaginate
        response = await self.v3PrivateGetBrokerageOrdersHistoricalFills(self.extend(request, paramsOmitted))
        #
        #     {
        #         "fills": [
        #             {
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params: dict = {}) -> OrderBook:
        ...
        if usePrivate:
            response = await self.v3PrivateGetBrokerageProductBook(self.extend(request, paramsUsePrivate))
        else:
            response = await self.v3PublicGetBrokerageMarketProductBook(self.extend(request, paramsUsePrivate))
        #
        #     {
        #         "pricebook": {
        #             "product_id": "BTC-USDT",
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params: dict = {}) -> Transaction:
        ...
        response = await self.v2PrivatePostAccountsAccountIdTransactions(self.extend(request, paramsOmitted))
        #
        #     {
        #         "data": {
        #             "id": "a1794ecf-5693-55fa-70cf-ef731748ed82",
    ...
    async def deposit(self, code: str, amount: float, id: str, params: dict = {}) -> Transaction:
        """
        make a deposit
        ...
        response = await self.v2PrivatePostAccountsAccountIdDeposits(self.extend(request, paramsOmitted))
        #
        #     {
        #         "data": {
        #             "id": "67e0eaec-07d7-54c4-a72c-2e92826897df",
    ...
    async def fetch_deposit(self, id: str, code: Str = None, params: dict = {}) -> Transaction:
        ...
        response = await self.v2PrivateGetAccountsAccountIdDepositsDepositId(self.extend(request, paramsOmitted))
        #
        #     {
        #         "data": {
        #             "id": "67e0eaec-07d7-54c4-a72c-2e92826897df",
    ...
    async def fetch_deposit_method_ids(self, params: dict = {}) -> list[dict]:
        """
    ...
    async def fetch_deposit_method_id(self, id: str, params: dict = {}) -> dict:
        """
        fetch the deposit id for a fiat currency associated with self account
    ...
    async def fetch_convert_trade(self, id: str, code: Str = None, params: dict = {}) -> Conversion:
        ...
        response = await self.v3PrivateGetBrokerageConvertTradeTradeId(self.extend(request, paramsOmitted))
        data = self.safe_dict(response, 'trade', {})
        return self.parse_conversion(data)
 ...
 @param {str}  params.clientOrderId *mandatory* the client order id of the position to close
        ...
        response = await self.v3PrivatePostBrokerageOrdersClosePosition(self.extend(request, paramsOmitted))
    ...
    async def fetch_positions(self, symbols: Strings = None, params: dict = {}) -> list[Position]:
        ...
        response = None
        if marketType == 'future':
            response = await self.v3PrivateGetBrokerageCfmPositions(paramsMarketType)
        else:
            ...
            response = await self.v3PrivateGetBrokerageIntxPositionsPortfolioUuid(self.extend(request, paramsPortfolio))
    ...
    async def fetch_position(self, symbol: str, params: dict = {}) -> Position:
        ...
        if market['future'] is True:
            ...
            response = await self.v3PrivateGetBrokerageIntxPositionsPortfolioUuidSymbol(self.extend(request, paramsPortfolio))
    ...
    async def fetch_trading_fees(self, params: dict = {}) -> TradingFees:
        ...
        response = await self.v3PrivateGetBrokerageTransactionSummary(self.extend(request, paramsMarketType))
        #
        # {
        #     total_volume: '0',
        #     total_fees: '0',
    ...
    async def fetch_portfolio_details(self, portfolioUuid: str, params: dict = {}) -> list[object]:
        """
