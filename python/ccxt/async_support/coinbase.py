...
class coinbase(Exchange, ImplicitAPI):
    ...
    async def fetch_my_sells(self, symbol: String = None, since: Int = None, limit: Int = None, params={}):
        """
        fetch sells
    ...
    async def fetch_my_buys(self, symbol: String = None, since: Int = None, limit: Int = None, params={}):
        """
        fetch buys
    ...
    async def fetch_tickers_v2(self, symbols: List[str] = None, params={}):
        await self.load_markets()
    ...
    async def fetch_tickers_v3(self, symbols: List[str] = None, params={}):
        await self.load_markets()
        symbols = self.market_symbols(symbols)
        response = await self.v3PrivateGetBrokerageProducts(params)
        #
    ...
    async def prepare_account_request_with_currency_code(self, code: String = None, limit: Int = None, params={}):
        accountId = self.safe_string_2(params, 'account_id', 'accountId')
        if accountId is None:
            if code is None:
