...
class lighter(Exchange, ImplicitAPI):
    ...
    async def load_account(self, chainId: Any, privateKey: Any, apiKeyIndex: str, accountIndex: str, params={}):
 ...
 @ignore
    ...
    async def fetch_nonce(self, accountIndex: Any, apiKeyIndex: Any, params={}):
