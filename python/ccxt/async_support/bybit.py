...
class bybit(Exchange):
    ...
    async def fetch_currencies(self, params={}):
        ...
        if not self.check_required_credentials(False):
            return None
        response = await self.privateGetAssetV3PrivateCoinInfoQuery(params)
        #
        #    {
        #        "retCode": "0",
        #        "retMsg": "OK",
    ...
    async def fetch_spot_tickers(self, symbols=None, params={}):
        await self.load_markets()
        symbols = self.market_symbols(symbols)
        response = await self.publicGetSpotV3PublicQuoteTicker24hr(params)
        #
        #     {
        #         "ret_code":0,
        #         "ret_msg":null,
    ...
    async def fetch_derivatives_tickers(self, symbols=None, params={}):
        await self.load_markets()
        symbols = self.market_symbols(symbols)
        request = {}
        ...
        response = await self.publicGetDerivativesV3PublicTickers(self.extend(request, query))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        if type == 'spot':
            ...
            return await self.fetch_derivatives_tickers(symbols, query)
    ...
    async def fetch_derivatives_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        await self.load_markets()
        market = self.market(symbol)
        if market['option']:
    ...
    async def fetch_ohlcv(self, symbol, timeframe='1m', since=None, limit=None, params={}):
        ...
        if market['spot']:
            ...
            return await self.fetch_derivatives_ohlcv(symbol, timeframe, since, limit, params)
    ...
    async def fetch_funding_rates(self, symbols=None, params={}):
        ...
        if type != 'swap':
            ...
            request['category'] = subType
        response = await self.publicGetDerivativesV3PublicTickers(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_funding_rate_history(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetDerivativesV3PublicFundingHistoryFundingRate(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_spot_trades(self, symbol, since=None, limit=None, params={}):
        await self.load_markets()
        market = self.market(symbol)
        request = {
            'symbol': market['id'],
        ...
        response = await self.publicGetSpotV3PublicQuoteTrades(self.extend(request, params))
        #
        # spot
        #
        #    {
    ...
    async def fetch_derivatives_trades(self, symbol, since=None, limit=None, params={}):
        await self.load_markets()
        market = self.market(symbol)
        request = {
            'symbol': market['id'],
        ...
        if market['option']:
            ...
            request['category'] = 'inverse'
        response = await self.publicGetDerivativesV3PublicRecentTrade(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        market = self.market(symbol)
        if market['type'] == 'spot':
            return await self.fetch_spot_trades(symbol, since, limit, params)
        else:
            return await self.fetch_derivatives_trades(symbol, since, limit, params)

    async def fetch_spot_order_book(self, symbol, limit=None, params={}):
        await self.load_markets()
        market = self.market(symbol)
        request = {
            'symbol': market['id'],
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetSpotV3PublicQuoteDepth(self.extend(request, params))
        #
        # spot
        #
        #    {
    ...
    async def fetch_derivatives_order_book(self, symbol, limit=None, params={}):
        await self.load_markets()
        market = self.market(symbol)
        request = {
            'symbol': market['id'],
        ...
        if market['option']:
            ...
            request['category'] = 'inverse'
        response = await self.publicGetDerivativesV3PublicOrderBookL2(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "success",
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        market = self.market(symbol)
        if market['spot']:
            return await self.fetch_spot_order_book(symbol, limit, params)
        else:
            return await self.fetch_derivatives_order_book(symbol, limit, params)
    ...
    async def fetch_derivatives_balance(self, params={}):
        await self.load_markets()
        request = {}
        response = await self.privateGetContractV3PrivateAccountWalletBalance(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_balance(self, params={}):
        ...
        if enableUnifiedMargin:
            return await self.fetch_unified_margin_balance(params)
        else:
    ...
    async def fetch_derivatives_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if isStop:
            request['orderFilter'] = 'StopOrder'
        response = await self.privateGetContractV3PrivateOrderList(self.extend(request, params))
        #
        # contract v3
        #
        #     {
    ...
    async def fetch_derivatives_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        if isStop:
            request['orderFilter'] = 'StopOrder'
        response = await self.privateGetContractV3PrivateOrderUnfilledOrders(self.extend(request, params))
        #
        # contract v3
        #
        #     {
    ...
    async def fetch_my_contract_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit  # default 20, max 50
        response = await self.privateGetContractV3PrivateExecutionList(self.extend(request, params))
        #
        # contract v3
        #
        #     {
    ...
    async def fetch_deposit_addresses_by_network(self, code, params={}):
        ...
        response = await self.privateGetAssetV3PrivateDepositAddressQuery(self.extend(request, params))
        #
        #    {
        #         "retCode": "0",
        #         "retMsg": "success",
    ...
    async def fetch_deposit_address(self, code, params={}):
        ...
        response = await self.privateGetAssetV3PrivateDepositAddressQuery(self.extend(request, query))
        #
        #    {
        #         "retCode": "0",
        #         "retMsg": "success",
    ...
    async def fetch_deposits(self, code=None, since=None, limit=None, params={}):
       ...
       """
        ...
        response = await self.privateGetAssetV3PrivateDepositRecordQuery(self.extend(request, params))
        #
        #    {
        #         "retCode": "0",
        #         "retMsg": "success",
    ...
    async def fetch_unified_margin_positions(self, symbols=None, params={}):
        ...
        if type == 'option':
            request['category'] = 'option'
        response = await self.privateGetUnifiedV3PrivatePositionList(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "Success",
    ...
    async def fetch_derivatives_positions(self, symbols=None, params={}):
        ...
        if settle is not None:
            request['settleCoin'] = settle
        response = await self.privateGetContractV3PrivatePositionList(self.extend(request, params))
        #
        # contract v3
        #
        #     {
    ...
    async def fetch_positions(self, symbols=None, params={}):
        ...
        if enableUnifiedMargin and not isInverse:
            return await self.fetch_unified_margin_positions(symbols, query)
        elif isUsdcSettled:
    ...
    async def fetch_transfers(self, code=None, since=None, limit=None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetAssetV3PrivateTransferInterTransferListQuery(self.extend(request, params))
        #
        #    {
        #         "retCode": "0",
        #         "retMsg": "success",
    ...
    async def fetch_derivatives_market_leverage_tiers(self, symbol, params={}):
        ...
        if market['linear']:
            ...
            request['category'] = 'inverse'
        response = await self.publicGetDerivativesV3PublicRiskLimitList(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_trading_fee(self, symbol, params={}):
        ...
        response = await self.privateGetContractV3PrivateAccountFeeRate(self.extend(request, params))
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
    ...
    async def fetch_trading_fees(self, params={}):
        ...
        response = await self.privateGetContractV3PrivateAccountFeeRate(params)
        #
        #     {
        #         "retCode": 0,
        #         "retMsg": "OK",
