...
class astralx(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        response = await self.publicGetOpenapiSymbol(params)
    ...
    async def fetch_ticker(self, symbol: str, params={}):
        ...
        response = await self.publicGetOpenapiQuoteTicker(params)
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetOpenapiQuoteDepth(self.extend(request, params))
    ...
    async def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetOpenapiQuoteKlines(self.extend(request, params))
    ...
    async def fetch_time(self, params={}):
        ...
        """
        response = await self.publicGetOpenapiTime(params)
    ...
    async def fetch_funding_rate(self, symbol: str, params={}) -> FundingRate:
        ...
        response = await self.publicGetOpenapiContractFundingRate(self.extend(request, params))
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.publicGetOpenapiQuoteTrades(self.extend(request, params))
    ...
    async def fetch_balance(self, params={}):
        ...
        """
        await self.load_markets()
        response = await self.privateGetOpenapiContractAccount(params)
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        if apiType == 'MARKET':
            ...
            priceType = 'INPUT'
        quantityInContracts = self.amount_to_precision(symbol, amount)
        request = {
            'symbol': market['id'],
            'side': apiSide,
            'orderType': 'LIMIT',
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = await self.privateDeleteOpenapiContractOrderCancel(self.extend(request, params))
    ...
    async def fetch_order(self, id: str, symbol: Str = None, params={}):
        ...
        response = await self.privateGetOpenapiContractOrder(self.extend(request, params))
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if symbol is not None:
            market = self.market(symbol)
            request['symbol'] = market['id']
        response = await self.privatePostOpenapiContractOpenOrders(self.extend(request, params))
    ...
    async def fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privatePostOpenapiContractHistoryOrders(self.extend(request, params))
        # API直接返回订单数组，没有data字段包装
        orders = self.safe_value(response, 'data', response)
        return self.parse_orders(orders, None, since, limit)
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = await self.privateGetOpenapiContractMyTrades(self.extend(request, params))
