...
class hyperliquid(Exchange, ImplicitAPI):
    ...
    async def fetch_hip3_markets(self, params: dict = {}) -> list[Market]:
        """
    ...
    async def is_unified_enabled(self, method: str, address: Str = None, shouldRefresh: bool = False, params: dict = {}) -> list:
        """
        ...
        enableUnifiedMargin, params = self.handle_option_bool_and_params(params, method, 'enableUnifiedMargin')
    ...
    async def set_user_abstraction(self, abstraction: str, params: dict = {}):
        """
    ...
    async def enable_user_dex_abstraction(self, enabled: bool, params: dict = {}):
        """
    ...
    async def set_agent_abstraction(self, abstraction: str, params: dict = {}):
        """
    ...
    async def cancel_twap_order(self, id: str, symbol: Str = None, params: dict = {}) -> Order:
        """
        ...
        market = self.market(symbol)
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params(params, 'cancelTwapOrder', 'vaultAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        action = {
            'type': 'twapCancel',
            'a': self.parse_to_int(market['baseId']),
    ...
    def cancel_orders_request(self, ids: list[str], symbol: Str = None, params: dict = {}) -> dict:
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'cancelOrders', 'vaultAddress', 'subAccountAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
    ...
    async def cancel_orders_for_symbols(self, orders: list[CancellationRequest], params: dict = {}) -> list[Order]:
        ...
        cancelAction['cancels'] = cancelReq
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'cancelOrdersForSymbols', 'vaultAddress', 'subAccountAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        signature = self.sign_l1_action(cancelAction, nonce, vaultAddress)
        request['action'] = cancelAction
        request['signature'] = signature
    ...
    async def cancel_all_orders_after(self, timeout: Int, params: dict = {}):
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'cancelAllOrdersAfter', 'vaultAddress', 'subAccountAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        signature = self.sign_l1_action(cancelAction, nonce, vaultAddress)
        request['action'] = cancelAction
        request['signature'] = signature
    ...
    def edit_orders_request(self, orders: list, params: dict = {}) -> dict:
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params(params, 'editOrder', 'vaultAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
    ...
    async def create_vault(self, name: str, description: str, initialUsd: int, params: dict = {}):
        """
        creates a value
    ...
    async def set_margin_mode(self, marginMode: str, symbol: Str = None, params: dict = {}):
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'setMarginMode', 'vaultAddress', 'subAccountAddress')
        if vaultAddress is not None:
    ...
    async def set_leverage(self, leverage: int, symbol: Str = None, params: dict = {}):
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'setLeverage', 'vaultAddress', 'subAccountAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        signature = self.sign_l1_action(updateAction, nonce, vaultAddress)
        request = {
            'action': updateAction,
    ...
    async def modify_margin_helper(self, symbol: str, amount: object, type: str, params: dict = {}) -> MarginModification:
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'modifyMargin', 'vaultAddress', 'subAccountAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        signature = self.sign_l1_action(updateAction, nonce, vaultAddress)
        request = {
            'action': updateAction,
    ...
    async def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params: dict = {}) -> Transaction:
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params(params, 'withdraw', 'vaultAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        params = self.omit(params, 'vaultAddress')
        nonce = self.incrementing_nonce()
        action = {}
    ...
    async def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params: dict = {}) -> list[Transaction]:
        ...
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params(params, 'fetchDepositsWithdrawals', 'vaultAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        deposits = []
        if vaultAddress is not None:
    ...
    async def reserve_request_weight(self, weight: Num, params: dict = {}) -> dict:
        """
    ...
    def parse_create_edit_order_args(self, id: Str, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params: dict = {}) -> list:
        market = self.market(symbol)
        vaultAddress = None
        vaultAddress, params = self.handle_option_string_and_params_2(params, 'createOrder', 'vaultAddress', 'subAccountAddress')
        vaultAddress = self.format_vault_address(vaultAddress)
        symbol = market['symbol']
        order = {
            'symbol': symbol,
