 ...
 @ignore
    ...
    async def edit_order(self, id: str, symbol: str, type: OrderType, side: OrderSide, amount: Num = None, price: Num = None, params: dict = {}) -> Order:
        ...
        if isConditional:
            ...
            # request['symbol'] = market['id'];
            response = await self.v1PrivatePutOrder(self.extend(request, paramsOrder))
        #
        # {
        #     "success": true,
        #     "timestamp": 1702989203989,
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params: dict = {}) -> Order:
        ...
        if trigger is True:
            if isByClientOrder:
                ...
                response = await self.v1PrivateDeleteAlgoClientOrder(self.extend(request, paramsClientOrder))
            else:
                request['order_id'] = id
            ...
            if isByClientOrder:
                request['client_order_id'] = clientOrderIdExchangeSpecific
                response = await self.v1PrivateDeleteClientOrder(self.extend(request, paramsClientOrder))
            else:
                request['order_id'] = id
    ...
    async def get_asset_history_rows(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> object:
        if self.markets is None:
            await self.load_markets()
        request = {}
        currency = None
