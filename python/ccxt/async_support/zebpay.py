...
class zebpay(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> List[Market]:
        ...
        spotMarkets: List = self.safe_list(promises, 0, [])
        futureMarkets: List = self.safe_list(promises, 1, [])
    ...
    async def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response = await self.publicSpotGetV2ExCurrencies(params)
        #
        #     {
        #             "data": [
        #                 {
    ...
    def parse_currency(self, rawCurrency: dict) -> Currency:
        ...
        networks: dict = {}
        minWithdrawFeeString: Str = None
        minWithdrawString: Str = None
        minDepositString: Str = None
        deposit = False
        withdraw = False
    ...
    async def fetch_trading_fee(self, symbol: str, params={}) -> TradingFeeInterface:
        ...
        if market['spot']:
            response = await self.privateSpotGetV2ExTradefee(self.extend(request, params))
            #
            # {
            ...
            response = await self.publicSwapGetV1ExchangeTradefee(self.extend(request, params))
            #
            # {
            #     "statusDescription": "OK",
            #     "data":
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        if market['spot']:
            ...
            #       }
            # }
            response = await self.publicSpotGetV2MarketOrderbook(self.extend(request, params))
        else:
            response = await self.publicSwapGetV1MarketOrderBook(self.extend(request, params))
    ...
    async def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response: NullableDict = None
        if market['spot']:
            response = await self.publicSpotGetV2MarketTicker(self.extend(request, params))
            #
            #     [
            #        {
            #            "symbol": "BTC-INR",
            ...
            response = await self.publicSwapGetV1MarketTicker24Hr(self.extend(request, params))
    ...
    async def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        response: NullableDict = None
        if market['spot']:
            response = await self.publicSpotGetV2MarketTrades(self.extend(request, params))
        else:
            response = await self.publicSwapGetV1MarketAggTrade(self.extend(request, params))
        #
        #     [
        #         {
        #             "id" : "60014521",
    ...
    async def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        data = self.safe_dict(response, 'data', {})
        items: List = self.safe_list(data, 'items', [])
    ...
    async def cancel_order(self, id: str, symbol: Str = None, params={}):
        ...
        if market['spot']:
            request['orderId'] = id
            response = await self.privateSpotDeleteV2ExOrder(self.extend(request, params))
        else:
    ...
    async def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if market['spot']:
            ...
            response = await self.privateSpotGetV2ExOrders(self.extend(request, params))
            ...
            if limit is not None:
                request['limit'] = limit
            response = await self.privateSwapGetV1TradeOrderOpenOrders(self.extend(request, params))
            responseData = self.safe_dict(response, 'data', {})
    ...
    async def fetch_order(self, id: Str, symbol: Str = None, params={}):
        ...
        if market['spot']:
            request['orderId'] = id
            response = await self.privateSpotGetV2ExOrder(self.extend(request, params))
        else:
            request['id'] = id
            response = await self.privateSwapGetV1TradeOrder(self.extend(request, params))
        #
        #     {
        #         "data": {
        #             "nextTimeStamp": null,
        ...
        #     }
        #
        responseData: dict = self.safe_dict(response, 'data', {})
    ...
    async def close_position(self, symbol: str, side: OrderSide = None, params={}) -> Order:
        ...
        response = await self.privateSwapPostV1TradePositionClose(self.extend(request, params))
        data: dict = self.safe_dict(response, 'data', {})
        return self.parse_order(data, market)
    ...
    async def fetch_leverages(self, symbols: Strings = None, params={}) -> Leverages:
        ...
        """
        await self.load_markets()
        response = await self.privateSwapGetV1TradeUserLeverages(params)
        #
        #     {
        #         "leveragePreferences": [
        #             {
        ...
        #     }
        #
        leveragePreferences: List = self.safe_list(response, 'data', [])
    ...
    async def fetch_positions(self, symbols: Strings = None, params={}):
        ...
        response = await self.privateSwapGetV1TradePositions(self.extend(request, params))
        #
        #    {
        #        "data": [
        #            {
        ...
        #    }
        #
        positions: List = self.safe_list(response, 'data', [])
    ...
    async def add_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        response = await self.privateSwapPostV1TradeAddMargin(self.extend(request, params))
        #
        #    {
        #        "code": "200000",
        #        "data": {
    ...
    async def reduce_margin(self, symbol: str, amount: float, params={}) -> MarginModification:
        ...
        response = await self.privateSwapPostV1TradeReduceMargin(self.extend(request, params))
        #
        #    {
        #        "code": "200000",
        #        "data": {
