...
class nobitex(Exchange, ImplicitAPI):
    ...
    async def fetch_markets(self, params={}) -> list[Market]:
        ...
        """
        response = await self.publicGetV2Options(params)
        #
        #     {
        #         "status": "ok",
        #         "nobitex": {
    ...
    async def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        response = await self.publicGetV3OrderbookSymbol(self.extend(request, params))
        #
        #     {
        #         "status": "ok",
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}) -> Order:
        ...
        response = await self.privatePostMarketOrdersAdd(self.extend(request, params))
        #
        #     {
        #         "status": "ok",
        #         "order": {
