...
class ftx(Exchange):
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the ftx api endpoint
        :param int|float|None params['until']: timestamp in ms of the latest trade
        :returns [dict]: a list of `trade structures <https://docs.ccxt.com/en/latest/manual.html#trade-structure>`
        """
        await self.load_markets()
        market, marketId = self.get_market_params(symbol, 'market', params)
    ...
    async def fetch_borrow_rate_histories(self, codes=None, since=None, limit=None, params={}):
        ...
        :param int|float|None since: timestamp in ms of the earliest borrowRate, default is None
        :param int|float|None limit: max number of borrow rate prices to return, default is None
        :param dict params: extra parameters specific to the ftx api endpoint
    ...
    async def fetch_borrow_rate_history(self, code, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the exchange api endpoint
        :param int|float|None params['till']: Timestamp in ms of the latest time to fetch the borrow rate
