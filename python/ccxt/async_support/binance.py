...
class binance(Exchange, ImplicitAPI):
    ...
    async def futures_transfer(self, code: str, amount, type, params={}):
        ...
        :returns dict: a `transfer structure <https://github.com/ccxt/ccxt/wiki/Manual#futures-transfer-structure>`
        """
        if (type < 1) or (type > 4):
    ...
    async def fetch_option_positions(self, symbols: List[str] = None, params={}):
        """
        :see: https://binance-docs.github.io/apidocs/voptions/en/#option-position-information-user_data
    ...
    async def fetch_account_positions(self, symbols: List[str] = None, params={}):
        """
