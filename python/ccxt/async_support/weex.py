...
class weex(Exchange, ImplicitAPI):
    ...
    async def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        response = await self.publicGetApiV3Coins(params)
        #
        #     [
        #         {
        #             "coin": "BTC",
    ...
    async def fetch_markets(self, params={}) -> list[Market]:
        ...
        spotResponse, contractResponse = await asyncio.gather(*promises)
 ...
 Check createSpotOrder() and createContractOrder() for more details on the extra parameters that can be used in params
    ...
    async def fetch_canceled_and_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> list[Order]:
        ...
        maxLimit = 1000
        if paginate:
            return await self.fetch_paginated_call_dynamic('fetchCanceledAndClosedOrders', symbol, since, limit, params, maxLimit)
        request = {}
        if symbol is not None:
