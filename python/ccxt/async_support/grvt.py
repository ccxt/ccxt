...
from c.python.build.lib.ccxt.static_dependencies.ethereum import account
    ...
    async def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        request = {
            ...
            'signature': {
                ...
                's': '',
                'v': 0,
                'expiration': '1765389092000000000',  #(self.milliseconds() * 1000000 + str(1000000000)),
        ...
        privateKey = self.secret[2:]  # .substring(2)  # remove first two characters '0x'
        ...
        signature = self.ecdsa(ethEncodedMessageHashed[2:], privateKey, 'secp256k1', None)
