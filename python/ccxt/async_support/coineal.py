...
class coineal(Exchange):
    ...
    async def fetch_ohlcv(self, symbol='BTC/USDT', timeframe='1m', since=None, limit=None, params={}):
    ...
    async def fetch_common_orders(self, symbol, limit, params):
        ...
        response = await self.privateGetOpenApiAllOrder(self.extend(request, params))
        result = self.safe_value(response, 'data')
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=100, params={}):
        ...
        for i in range(0, len(symbolsToFetch)):
            ...
            orders = await self.fetch_common_orders(market['id'], limit, params)
