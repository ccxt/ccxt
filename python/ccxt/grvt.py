...
class grvt(Exchange, ImplicitAPI):
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        """
        self.sign_in()
        response = self.privateMarketPostFullV1AllInstruments(params)
        #
        #    {
        #        "result": [
        #            {
    ...
    def fetch_currencies(self, params={}) -> Currencies:
        ...
        """
        self.sign_in()
        response = self.privateMarketPostFullV1Currency(params)
        #
        #    {
        #        "result": [
        #            {
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = self.privateMarketPostFullV1Ticker(self.extend(request, params))
        #
        #    {
        #        "result": {
    ...
    def fetch_order_book(self, symbol: str, limit: Int = None, params={}) -> OrderBook:
        ...
        response = self.privateMarketPostFullV1Book(self.extend(request, params))
        #
        #    {
        #        "result": {
    ...
    def fetch_trades(self, symbol: str, since: Int = None, limit: Int = None, params={}) -> List[Trade]:
        ...
        response = self.privateMarketPostFullV1TradeHistory(self.extend(request, params))
        #
        #    {
    ...
    def fetch_funding_rate_history(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            request['limit'] = min(limit, 1000)
        response = self.privateMarketPostFullV1Funding(self.extend(request, params))
        #
        #    {
        #        "result": [
        #            {
    ...
    def load_aggregated_account_summary(self):
        if self.safe_string(self.options, 'userMainAccountId') is not None:
            return
        response = self.privateTradingPostFullV1AggregatedAccountSummary()
        result = self.safe_dict(response, 'result', {})
    ...
    def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params={}) -> Transaction:
        ...
        [self.load_markets(), self.load_aggregated_account_summary()]
        currency = self.currency(code)
        request: dict = {
            'currency': currency['id'],
            'num_tokens': self.currency_to_precision(code, amount),
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        response = self.privateTradingPostFullV1CreateOrder(self.extend(fullRequest, params))
