...
def decimal_to_precision_test(expectedResult, x, roundingMode, numPrecisionDigits, countingMode=DECIMAL_PLACES, paddingMode=NO_PADDING):
    assert isinstance(x, str)
    assert isinstance(numPrecisionDigits, float) or isinstance(numPrecisionDigits, int)
    # assert decimal_to_precision (x, roundingMode, str(numPrecisionDigits), countingMode, paddingMode) == expectedResult
    assert decimal_to_precision(x, roundingMode, numPrecisionDigits, countingMode, paddingMode) == expectedResult
    # assert decimal_to_precision (float(x), roundingMode, str(numPrecisionDigits), countingMode, paddingMode) == expectedResult
    # assert decimal_to_precision (float(x), roundingMode, numPrecisionDigits, countingMode, paddingMode) == expectedResult


def testDecimalToPrecisionTruncationToNDigitsAfterDot():
...
def testDecimalToPrecisionTruncationToNSignificantDigits():
...
def testDecimalToPrecisionRoundingToNDigitsAfterDot():
...
def testDecimalToPrecisionRoundingToNSignificantDigits():
...
def testDecimalToPrecisionRoundingToTickSize():
...
def testDecimalToPrecisionNegativeNumbers():
...
def testDecimalToPrecisionWithoutDotTrailingDot():
...
def testDecimalToPrecisionRoundingForEquidistantDigits():
...
def testDecimalToPrecisionNegativeDecimalPlaces():
...
def testDecimalToPrecisionNegativeSignificantDigits():
