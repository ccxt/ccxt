...
def test_decimal_to_precision():
    ...
    assert exchange.decimal_to_precision('0.0000571495257361', TRUNCATE, 1e-8, TICK_SIZE) == '0.00005714'
    ...
    assert exchange.decimal_to_precision('0.00000001', TRUNCATE, 1e-8, TICK_SIZE) == '0.00000001'
    assert exchange.decimal_to_precision('0.000000123', TRUNCATE, 1e-8, TICK_SIZE) == '0.00000012'
    assert exchange.decimal_to_precision('0.0000009', TRUNCATE, 1e-7, TICK_SIZE) == '0.0000009'
    assert exchange.decimal_to_precision('0.0000005', TRUNCATE, 1e-7, TICK_SIZE) == '0.0000005'
    assert exchange.decimal_to_precision('0.00000001', TRUNCATE, 1e-8, TICK_SIZE, PAD_WITH_ZERO) == '0.00000001'
