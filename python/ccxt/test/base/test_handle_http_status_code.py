...
def test_handle_http_status_code():
    ...
    skip = exchange.handle_errors(406, 'Not Acceptable', 'url', 'GET', {}, '{"success":false}', {
        'success': False,
    }, {}, '')
    assert skip is None, 'the base handleErrors stub should return undefined'
