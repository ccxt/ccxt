...
def test_fetch_trades(exchange, skipped_properties, symbol):
    method = 'fetchTrades'
    trades = exchange.fetch_trades(symbol, None, 12000)  # test with unrealistically high amount
...
def helper_test_fetch_trades_side_sequence(exchange, skipped_properties, symbol, method, trades):
    #
