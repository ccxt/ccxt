...
class dx (Exchange):
    ...
    def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        openOrders = self.fetch_open_orders(symbol, since, limit, params)
    ...
    def sign_in(self, params={}):
        ...
        result = self.publicPostAuthorizationLoginByToken(self.extend({
            'token': self.apiKey,
            'secret': self.secret,
        }, params))
    ...
    def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        result = self.privatePostOrderManagementCreate(self.extend(order, params))
        return {
            'info': result,
    ...
    def cancel_order(self, id, symbol=None, params={}):
        return self.privatePostOrderManagementCancel({'externalOrderId': id})
