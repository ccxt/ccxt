...
class deepcoin(Exchange, ImplicitAPI):
    ...
    def fetch_my_trades(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}):
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.v1PrivateGetDeepcoinTradeFills(self.extend(request, params))
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        response = self.v1PrivateGetDeepcoinAccountBalances(self.extend(request, params))
    ...
    def fetch_order(self, id: str, symbol: Str = None, params={}) -> Order:
        ...
        response = self.v1PrivateGetDeepcoinTradeOrder(self.extend(request, params))
    ...
    def fetch_closed_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.v1PrivateGetDeepcoinTradeOrdersHistory(self.extend(request, params))
        data = self.safe_list(response, 'data', [])
        result = []
    ...
    def fetch_open_orders(self, symbol: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Order]:
        ...
        response = self.v1PrivateGetDeepcoinTradeOrdersPending(self.extend(request, params))
        data = self.safe_list(response, 'data', [])
        result = []
        for i in range(0, len(data)):
            result.append(self.parse_order(self.extend(request, params, data[i])))
    ...
    def fetch_ohlcv(self, symbol: str, timeframe='1m', since: Int = None, limit: Int = None, params={}) -> List[list]:
        ...
        if limit is not None:
            request['limit'] = limit
        response = self.v1PublicGetDeepcoinMarketCandles(self.extend(request, params))
        result = self.safe_list(response, 'data', [])
        return self.parse_ohlcvs(result, market, timeframe, since, limit)

    def fetch_order_book(self, symbol: str, limit: Int = 10, params={}) -> OrderBook:
        """
        ...
        response = self.v1PublicGetDeepcoinMarketBooks(self.extend(request, params))
    ...
    def fetch_ticker(self, symbol: str, params={}) -> Ticker:
        ...
        response = self.v1PublicGetDeepcoinMarketTickers(self.extend(request, params))
    ...
    def fetch_markets(self, params={}) -> List[Market]:
        ...
        for j in range(0, len(instTypes)):
            ...
            response = self.v1PublicGetDeepcoinMarketInstruments(self.extend(request, params))
    ...
    def create_order(self, symbol: str, type: OrderType, side: OrderSide, amount: float, price: Num = None, params={}):
        ...
        response = self.v1PrivatePostDeepcoinTradeOrder(self.extend(request, params))
        result = self.safe_dict(response, 'data', {})
    ...
    def cancel_order(self, id: str, symbol: str = None, params={}):
        ...
        response = self.v1PrivatePostDeepcoinTradeCancelOrder(self.extend(request, params))
