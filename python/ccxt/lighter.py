...
class lighter(Exchange, ImplicitAPI):
 ...
 @ignore
        ...
        orderTypeNum: Int = None
        timeInForceNum: Int = None
        if isMarketOrder:
            orderTypeNum = 1
            timeInForceNum = 0
        else:
