...
class huobipro (Exchange):
    ...
    def parse_trade(self, trade, market=None):
        ...
        if price is not None:
            if amount is not None:
                cost = self.value_to_precision(symbol, amount * price)
        fee = None
    ...
    def value_to_precision(self, symbol, cost):
        return self.decimal_to_precision(cost, ROUND, self.markets[symbol]['info']['value-precision'],
                                         self.precisionMode)
