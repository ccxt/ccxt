...
import hashlib
from ccxt.base.types import Any, Balances, Currencies, Currency, DepositAddress, Int, MarginModification, Market, Num, Order, OrderSide, OrderType, Position, Str, Strings, Ticker, Tickers, Trade, Transaction, TransferEntry
...
class coinbaseinternational(Exchange, ImplicitAPI):
    ...
    def handle_portfolio_and_params(self, methodName: str, params={}) -> list:
        portfolio = None
    ...
    def handle_network_id_and_params(self, currencyCode: str, methodName: str, params={}) -> list:
        networkId = None
