...
from ccxt.abstract.cexc import ImplicitAPI
import hashlib
import math
import json
...
class cexc(Exchange, ImplicitAPI):

    def describe(self) -> Any:
        return self.deep_extend(super(cexc, self).describe(), {
            'id': 'cexc',
            'name': 'Cexc',
            'countries': ['SC'],
    ...
    def load_migration_status(self, force: bool = False):
        ...
        https://cexc.io/docs/rest/spot-trading/spot-hf-trade-pro-account/get-user-type
    ...
    def fetch_mark_prices(self, symbols: Strings = None, params={}) -> Tickers:
        ...
        https://cexc.io/docs/rest/margin-trading/margin-info/get-all-margin-trading-pairs-mark-prices
    ...
    def fetch_mark_price(self, symbol: str, params={}) -> Ticker:
        ...
        https://cexc.io/docs/rest/margin-trading/margin-info/get-mark-price
    ...
    def create_deposit_address(self, code: str, params={}) -> DepositAddress:
        ...
        https://cexc.io/docs/rest/funding/deposit/create-deposit-address-v3-
 ...
 margin orders --------------------------------------------------
    ...
    def create_market_order_with_cost(self, symbol: str, side: OrderSide, cost: float, params={}):
        ...
        https://cexc.io/docs/rest/spot-trading/orders/place-order
    ...
    def create_orders(self, orders: List[OrderRequest], params={}):
        ...
        https://cexc.io/docs/rest/spot-trading/orders/place-multiple-orders
        https://cexc.io/docs/rest/spot-trading/spot-hf-trade-pro-account/place-multiple-hf-orders
        https://cexc.io/docs/rest/spot-trading/spot-hf-trade-pro-account/sync-place-multiple-hf-orders
    ...
    def fetch_trading_fee(self, symbol: str, params={}) -> TradingFeeInterface:
        ...
        https://cexc.io/docs/rest/funding/trade-fee/trading-pair-actual-fee-spot-margin-trade_hf
    ...
    def withdraw(self, code: str, amount: float, address: str, tag: Str = None, params={}) -> Transaction:
        ...
        https://cexc.io/docs/rest/funding/withdrawals/apply-withdraw-v3-
    ...
    def fetch_deposits(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        https://cexc.io/docs/rest/funding/deposit/get-deposit-list
        https://cexc.io/docs/rest/funding/deposit/get-v1-historical-deposits-list
    ...
    def fetch_withdrawals(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[Transaction]:
        ...
        https://cexc.io/docs/rest/funding/withdrawals/get-withdrawals-list
        https://cexc.io/docs/rest/funding/withdrawals/get-v1-historical-withdrawals-list
    ...
    def fetch_balance(self, params={}) -> Balances:
        ...
        https://cexc.io/docs/rest/account/basic-info/get-account-list-spot-margin-trade_hf
        https://cexc.io/docs/rest/funding/funding-overview/get-account-detail-margin
        https://cexc.io/docs/rest/funding/funding-overview/get-account-detail-isolated-margin
    ...
    def fetch_ledger(self, code: Str = None, since: Int = None, limit: Int = None, params={}) -> List[LedgerEntry]:
        ...
        https://cexc.io/docs/rest/account/basic-info/get-account-ledgers-spot-margin
        https://cexc.io/docs/rest/account/basic-info/get-account-ledgers-trade_hf
        https://cexc.io/docs/rest/account/basic-info/get-account-ledgers-margin_hf
    ...
    def fetch_borrow_rate_histories(self, codes=None, since: Int = None, limit: Int = None, params={}):
        ...
        https://cexc.io/docs/rest/margin-trading/margin-trading-v3-/get-cross-isolated-margin-interest-records
    ...
    def set_leverage(self, leverage: int, symbol: Str = None, params={}):
        ...
        https://cexc.io/docs/rest/margin-trading/margin-trading-v3-/modify-leverage-multiplier
    ...
    def sign(self, path, api='public', method='GET', params={}, headers=None, body=None):
        ...
        self.log({'url': url, 'method': method, 'body': body, 'headers': headers})
