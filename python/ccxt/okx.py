...
class okx(Exchange):
    ...
    def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the okx api endpoint
        :param int|float params['till']: Timestamp in ms of the latest time to retrieve orders for
    ...
    def fetch_borrow_interest(self, code=None, symbol=None, since=None, limit=None, params={}):
        ...
        :param int|float|None since: timestamp in ms of the earliest time to receive interest records for
        :param int|float|None limit: the number of `borrow interest structures <https://docs.ccxt.com/en/latest/manual.html#borrow-interest-structure>` to retrieve
        :param dict params: exchange specific parameters
        :param int|float|None params['type']: Loan type 1 - VIP loans 2 - Market loans *Default is Market loans*
    ...
    def fetch_open_interest_history(self, symbol, timeframe='5m', since=None, limit=None, params={}):
        ...
        :param int|float|None since: The time in ms of the earliest record to retrieve as a unix timestamp
        :param int|float|None limit: Not used by okx, but parsed internally by CCXT
        :param dict params: Exchange specific parameters
        :param int|float|None params['until']: The time in ms of the latest record to retrieve as a unix timestamp
