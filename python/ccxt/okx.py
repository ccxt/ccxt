        ...
        return self.deep_extend(super(okx, self).describe(), {
            ...
            'exceptions': {
                'exact': {
                    ...
                    '51155': BadSymbol,  # {"code":"1","data":[{"clOrdId":"e847xxx","ordId":"","sCode":"51155","sMsg":"You can't trade self pair or borrow self crypto due to local compliance restrictions. ","tag":"e847xxx","ts":"1753979177157"}],"inTime":"1753979177157408","msg":"All operations failed","outTime":"1753979177157874"}
