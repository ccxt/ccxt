...
class coinex extends \ccxt\async\coinex {
    ...
    public function watch_balance($params = array ()) {
        ...
        $messageHash = 'balance';
        $type = null;
        [$type, $params] = $this->handle_market_type_and_params('watchBalance', null, $params);
    ...
    public function watch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) {
        ...
        $messageHash = 'ohlcv';
        $type = null;
        [$type, $params] = $this->handle_market_type_and_params('watchOHLCV', $market, $params);
        if ($type !== 'swap') {
    ...
    public function authenticate($params = array ()) {
        $type = null;
        [$type, $params] = $this->handle_market_type_and_params('authenticate', null, $params);
        $url = $this->urls['api']['ws'][$type];
