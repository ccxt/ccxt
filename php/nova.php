        ...
        return array_replace_recursive (parent::describe (), array (
            ...
            'api' => array (
                'public' => array (
                    'get' => array (
                        'markets/',
                        'markets/array (basecurrency)/',
                        'market/info/array (pair)/',
                        'market/orderhistory/array (pair)/',
                        'market/openorders/array (pair)/buy/',
                        'market/openorders/array (pair)/sell/',
                        'market/openorders/array (pair)/both/',
                        'market/openorders/array (pair)/array (ordertype)/',
                    ),
                ),
                'private' => array (
                    'post' => array (
                        'getbalances/',
                        'getbalance/array (currency)/',
                        'getdeposits/',
                        'getwithdrawals/',
                        'getnewdepositaddress/array (currency)/',
                        'getdepositaddress/array (currency)/',
                        'myopenorders/',
                        'myopenorders_market/array (pair)/',
                        'cancelorder/array (orderid)/',
