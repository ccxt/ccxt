...
class rubin extends Exchange {
    ...
    public function create_order_request(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()) {
        ...
        $orderPayload = array(
            'order' => array(
                ...
                'side' => $sideNumber,
                'quantums' => $this->to_v4_long($quantums),
                'subticks' => $this->to_v4_long($subticks),
    ...
    public function estimate_tx_fee(mixed $message, string $memo, mixed $account): mixed {
        $txBytes = $this->encode_v4_tx_for_simulation($message, $memo, $account['sequence'], $account['pub_key']);
        $request = array(
            'txBytes' => $txBytes,
        );
