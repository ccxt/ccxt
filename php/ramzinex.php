...
use ccxt\abstract\ramzinex as Exchange;

class ramzinex extends Exchange {
    ...
    public function parse_market($market): array {
        ...
        // }
        $baseAsset = $this->safe_dict($market, 'base_currency_symbol');
        $quoteAsset = $this->safe_dict($market, 'quote_currency_symbol');
        $baseId = $this->safe_string_upper($baseAsset, 'en');
        $quoteId = $this->safe_string_upper($quoteAsset, 'en');
        $id = $this->safe_value($market, 'pair_id');
    ...
    public function parse_ticker($ticker, ?array $market = null): array {
        ...
        //     'web_link' => 'https://ramzinex.com/exchange/orderbook/2',
        // }
        $tickerinfo = $this->safe_dict($ticker, 'financial');
        $tickerinfo = $this->safe_dict($tickerinfo, 'last24h');
        $marketType = 'spot';
        $marketId = $this->safe_value($ticker, 'pair_id');
        $marketinfo = $this->market($marketId);
        $symbol = $this->safe_symbol($marketId, $market, null, $marketType);
        $high = $this->safe_float($tickerinfo, 'highest');
        $low = $this->safe_float($tickerinfo, 'lowest');
