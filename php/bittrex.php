...
class bittrex extends Exchange {
    ...
    public function fetch_markets ($params = array ()) {
        ...
        for ($i = 0; $i < count($response); $i++) {
            ...
            $id = $baseId . $this->options['symbolSeparator'] . $quoteId;
    ...
    public function fetch_balance ($params = array ()) {
        $this->load_markets();
        $balances = $this->v3GetBalances ($params);
    ...
    public function fetch_order_book ($symbol, $limit = null, $params = array ()) {
        ...
        $response = $this->v3publicGetMarketsMarketSymbolOrderbook (array_merge($request, $params));
    ...
    public function parse_ticker ($ticker, $market = null) {
        ...
        $previous = $this->safe_float($ticker, 'percentChange');
    ...
    public function fetch_tickers ($symbols = null, $params = array ()) {
        $this->load_markets();
        $response = $this->v3GetMarketsSummaries ($params);
        $tickers = array();
        for ($i = 0; $i < count($response); $i++) {
    ...
    public function fetch_ticker ($symbol, $params = array ()) {
        ...
        $response = $this->v3GetMarketsMarketSymbolSummary (array_merge($request, $params));
        $ticker = $response[0];
    ...
    public function fetch_trades ($symbol, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->v3publicGetMarketsMarketSymbolTrades (array_merge($request, $params));
    ...
    public function fetch_open_orders ($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->v3GetOrdersOpen (array_merge($request, $params));
    ...
    public function cancel_order ($id, $symbol = null, $params = array ()) {
        ...
        $response = $this->v3DeleteOrdersOrderId (array_merge($request, $params));
    ...
    public function fetch_deposits ($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->v3GetDepositsClosed (array_merge($request, $params));
    ...
    public function fetch_withdrawals ($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->v3GetWithdrawalsClosed (array_merge($request, $params));
        return $this->parse_transactions($response, $currency, $since, $limit);
    }
    ...
    public function fetch_order ($id, $symbol = null, $params = array ()) {
        ...
        try {
            ...
            $response = $this->v3GetOrdersOrderId (array_merge($request, $params));
        } catch (Exception $e) {
    ...
    public function fetch_deposit_address ($code, $params = array ()) {
        ...
        $response = $this->v3GetAddressesCurrencySymbol (array_merge($request, $params));
        // {
        //     "status" => "PROVISIONED",
        //     "currencySymbol" => "BTC",
    ...
    public function withdraw ($code, $amount, $address, $tag = null, $params = array ()) {
        ...
        $response = $this->v3PostWithdrawals (array_merge($request, $params));
    ...
    public function request ($path, $api = 'v3', $method = 'GET', $params = array (), $headers = null, $body = null) {
