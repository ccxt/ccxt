...
use ccxt\abstract\astralx as Exchange;
...
class astralx extends Exchange {
    ...
    public function fetch_markets($params = array ()): array {
         ...
         */
        $response = $this->publicGetOpenapiSymbol ($params);
    ...
    public function fetch_ticker(string $symbol, $params = array ()) {
        ...
        $response = $this->publicGetOpenapiQuoteTicker ($params);
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->publicGetOpenapiQuoteDepth ($this->extend($request, $params));
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->publicGetOpenapiQuoteKlines ($this->extend($request, $params));
    ...
    public function fetch_time($params = array ()) {
         ...
         */
        $response = $this->publicGetOpenapiTime ($params);
    ...
    public function fetch_funding_rate(string $symbol, $params = array ()): array {
        ...
        $response = $this->publicGetOpenapiContractFundingRate ($this->extend($request, $params));
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->publicGetOpenapiQuoteTrades ($this->extend($request, $params));
    ...
    public function fetch_balance($params = array ()) {
         ...
         */
        $this->load_markets();
        $response = $this->privateGetOpenapiContractAccount ($params);
    ...
    public function create_reduce_only_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()) {
        ...
        $this->load_markets();
        $market = $this->market($symbol);
        // 处理$side参数映射：buy/sell -> BUY_CLOSE/SELL_CLOSE (平仓方向)
        $apiSide = strtoupper($side);
        if ($apiSide === 'BUY') {
            $apiSide = 'BUY_CLOSE';
        } elseif ($apiSide === 'SELL') {
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()) {
        ...
        $response = $this->privateGetOpenapiContractOrder ($this->extend($request, $params));
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetOpenapiContractMyTrades ($this->extend($request, $params));
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()): array {
        ...
        $response = $this->privateGetOpenapiContractPositions ($this->extend($request, $params));
        // API直接返回数组格式的仓位数据
        $positions = $response;
        $result = array();
