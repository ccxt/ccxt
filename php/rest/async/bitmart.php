...
class bitmart extends Exchange {
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetSpotV1Trades (array_merge($request, $query)));
            //
            // spot
            //
            //     {
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->privatePostSpotV2CancelOrder (array_merge($request, $params)));
            //
            // spot
            //
            //     {
    ...
    public function fetch_orders_by_status($status, $symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($status, $symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->privateGetSpotV2Orders (array_merge($request, $query)));
            //
            // spot
            //
            //     {
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->privateGetSpotV1OrderDetail (array_merge($request, $query)));
            //
            // spot
            //
            //     {
