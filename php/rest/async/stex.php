...
class stex extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->publicGetCurrencyPairsListCode (array_merge($request, $params)));
            //
            //     {
            //         "success":true,
            //         "data":array(
    ...
    public function fetch_ticker($symbol, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->publicGetTickerCurrencyPairId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetOrderbookCurrencyPairId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_trading_fee($symbol, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->tradingGetFeesCurrencyPairId (array_merge($request, $params)));
            //
            //     {
            //         success => true,
    ...
    public function fetch_balance($params = array ()) {
        return Async\async(function () use ($params) {
            ...
            $response = Async\await($this->profileGetWallets ($params));
            //
            //     {
            //         "success" => true,
            //         "data" => array(
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            $response = Async\await($this->tradingPostOrdersCurrencyPairId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->tradingGetOrderOrderId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_closed_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->reportsGetOrdersOrderId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->tradingDeleteOrderOrderId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->reportsGetTradesCurrencyPairId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => array(
    ...
    public function create_deposit_address($code, $params = array ()) {
        return Async\async(function () use ($code, $params) {
            ...
            $response = Async\await($this->profilePostWalletsCurrencyId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_deposit_address($code, $params = array ()) {
        return Async\async(function () use ($code, $params) {
            ...
            $response = Async\await($this->profileGetWalletsWalletId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_deposit($id, $code = null, $params = array ()) {
        return Async\async(function () use ($id, $code, $params) {
            ...
            $response = Async\await($this->profileGetDepositsId (array_merge($request, $params)));
            //
            //     {
            //         success => true,
            //         $data => array(
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->profileGetDeposits (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => array(
    ...
    public function fetch_withdrawal($id, $code = null, $params = array ()) {
        return Async\async(function () use ($id, $code, $params) {
            ...
            $response = Async\await($this->profileGetWithdrawalsId (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->profileGetWithdrawals (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => array(
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) {
        return Async\async(function () use ($code, $amount, $address, $tag, $params) {
            ...
            $response = Async\await($this->profilePostWithdraw (array_merge($request, $params)));
            //
            //     {
            //         "success" => true,
            //         "data" => {
