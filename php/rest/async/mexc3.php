...
class mexc3 extends Exchange {
    ...
    public function fetch_currencies($params = array ()) {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->spot2PublicGetMarketCoinList ($params));
            //
            //     {
            //         "code":200,
            //         "data":array(
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            if ($marketType === 'spot') {
                ...
                $response = Async\await($this->spotPrivateGetAllOrders (array_merge($request, $query)));
                //
                //     array(
                //         array(
                //             "symbol" => "BTCUSDT",
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            if ($marketType === 'spot') {
                ...
                $data = Async\await($this->spotPrivateDeleteOrder (array_merge($request, $params)));
                //
                //     {
                //         "symbol" => "BTCUSDT",
    ...
    public function fetch_deposit_addresses_by_network($code, $params = array ()) {
        return Async\async(function () use ($code, $params) {
            ...
            $response = Async\await($this->spot2PrivateGetAssetDepositAddressList (array_merge($request, $params)));
            //
            //     {
            //         "code":200,
            //         "data":{
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->spot2PrivateGetAssetDepositList (array_merge($request, $params)));
            //
            //     {
            //         "code":200,
            //         "data":{
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            $response = Async\await($this->spot2PrivateGetAssetWithdrawList (array_merge($request, $params)));
            //
            //     {
            //         "code":200,
            //         "data":{
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) {
        return Async\async(function () use ($code, $amount, $address, $tag, $params) {
            ...
            $response = Async\await($this->spot2PrivatePostAssetWithdraw (array_merge($request, $params)));
            //
            //     {
            //         "code":200,
            //         "data" => {
