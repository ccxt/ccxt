...
class cex extends Exchange {
    ...
    public function fetch_currencies_from_cache($params = array ()) {
        ...
        if (($timestamp === null) || (($now - $timestamp) > $expires)) {
            $response = yield $this->publicGetCurrencyProfile ($params);
    ...
    public function fetch_markets($params = array ()) {
        ...
        $response = yield $this->publicGetCurrencyLimits ($params);
        //
        //     {
        //         "e":"currency_limits",
        //         "ok":"ok",
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        ...
        $response = yield $this->publicGetTickersCurrencies (array_merge($request, $params));
    ...
    public function fetch_trading_fees($params = array ()) {
         ...
         */
        yield $this->load_markets();
        $response = yield $this->privatePostGetMyfee ($params);
        //
        //      {
        //          e => 'get_myfee',
        //          ok => 'ok',
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        ...
        $response = yield $this->privatePostPlaceOrderPair (array_merge($request, $params));
        //
        //     {
        //         "id" => "12978363524",
        //         "time" => 1586610022259,
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        ...
        $response = yield $this->privatePostGetOrderTx (array_merge($request, $params));
        $data = $this->safe_value($response, 'data', array());
        //
        //     {
        //         "id" => "5442731603",
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->privatePostArchivedOrdersPair (array_merge($request, $params));
        $results = array();
    ...
    public function edit_order($id, $symbol, $type, $side, $amount = null, $price = null, $params = array ()) {
        ...
        $response = yield $this->privatePostCancelReplaceOrderPair (array_merge($request, $params));
    ...
    public function fetch_deposit_address($code, $params = array ()) {
        ...
        $response = yield $this->privatePostGetAddress (array_merge($request, $params));
