            ...
            'api' => array (
                'public' => array (
                    'get' => array (
                        'products',
                        'products/array (id)',
                        'products/array (id)/price_levels',
                        'executions',
                        'ir_ladders/array (currency)',
                    ),
                ),
                'private' => array (
                    'get' => array (
                        ...
                        'orders',
                        'orders/array (id)',
                        'orders/array (id)/trades',
                        'trades',
                        'trades/array (id)/loans',
                        'trading_accounts',
                        'trading_accounts/array (id)',
                    ),
                    'post' => array (
                        'fiat_accounts',
                        'loan_bids',
                    ...
                    'put' => array (
                        'loan_bids/array (id)/close',
                        'loans/array (id)',
                        'orders/array (id)',
                        'orders/array (id)/cancel',
                        'trades/array (id)',
                        'trades/array (id)/close',
                        'trades/close_all',
                        'trading_accounts/array (id)',
                    ),
                ),
