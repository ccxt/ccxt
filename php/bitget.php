...
class bitget extends Exchange {
    ...
    public function fetch_time($params = array ()) {
         ...
         */
        $response = $this->publicSpotGetSpotV1PublicTime ($params);
        //
        //     {
        //       "code" => "00000",
        //       "msg" => "success",
    ...
    public function fetch_markets_by_type($type, $params = array ()) {
        $response = null;
        if ($type === 'spot') {
            $response = $this->publicSpotGetSpotV1PublicProducts ($params);
        } elseif ($type === 'swap') {
            $response = $this->publicMixGetMixV1MarketContracts ($params);
        } else {
    ...
    public function fetch_currencies($params = array ()) {
         ...
         */
        $response = $this->publicSpotGetSpotV1PublicCurrencies ($params);
        //
        //     {
        //       "code" => "00000",
        //       "msg" => "success",
    ...
    public function fetch_market_leverage_tiers(string $symbol, $params = array ()) {
        ...
        if (($type === 'swap') || ($type === 'future')) {
            ...
            $response = $this->publicMixGetMixV1MarketQueryPositionLever (array_merge($request, $params));
            ...
            $response = $this->publicMarginGetMarginV1CrossPublicTierData (array_merge($request, $params));
        } else {
    ...
    public function fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->privateSpotGetSpotV1WalletDepositList (array_merge($request, $params));
        //
        //      {
        //          "code" => "00000",
        //          "msg" => "success",
    ...
    public function withdraw(string $code, $amount, $address, $tag = null, $params = array ()) {
        ...
        $response = $this->privateSpotPostSpotV1WalletWithdrawalV2 (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->privateSpotGetSpotV1WalletWithdrawalList (array_merge($request, $params));
        //
        //      {
        //          "code" => "00000",
        //          "msg" => "success",
    ...
    public function fetch_deposit_address(string $code, $params = array ()) {
        ...
        $response = $this->privateSpotGetSpotV1WalletDepositAddress (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): array {
        ...
        $response = null;
        if ($market['spot']) {
            $response = $this->publicSpotGetSpotV1MarketDepth (array_merge($request, $params));
        } else {
            $response = $this->publicMixGetMixV1MarketDepth (array_merge($request, $params));
        }
        //
        //     {
        //       "code" => "00000",
    ...
    public function fetch_ticker(string $symbol, $params = array ()): array {
        ...
        if ($market['spot']) {
            $response = $this->publicSpotGetSpotV1MarketTicker ($extended);
        } else {
            $response = $this->publicMixGetMixV1MarketTicker ($extended);
        }
        //
        //     {
        //         "code" => "00000",
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): array {
        ...
        $response = null;
        if ($type === 'spot') {
            $response = $this->publicSpotGetSpotV1MarketTickers ($extended);
        } else {
            $response = $this->publicMixGetMixV1MarketTickers ($extended);
        }
        //
        // spot
        //
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        if ($paginate) {
            return $this->fetch_paginated_call_cursor('fetchTrades', $symbol, $since, $limit, $params, 'tradeId', 'tradeId');
        }
        $market = $this->market($symbol);
        $request = array(
            'symbol' => $market['id'],
        ...
        if ($market['spot']) {
            ...
            $defaultSpotMethod = $this->safe_string($spotOptions, 'method', 'publicSpotGetSpotV1MarketFillsHistory');
            $spotMethod = $this->safe_string($params, 'method', $defaultSpotMethod);
            $params = $this->omit($params, 'method');
            if ($spotMethod === 'publicSpotGetSpotV1MarketFillsHistory') {
                $response = $this->publicSpotGetSpotV1MarketFillsHistory (array_merge($request, $params));
            } elseif ($spotMethod === 'publicSpotGetSpotV1MarketFills') {
                $response = $this->publicSpotGetSpotV1MarketFills (array_merge($request, $params));
            }
        } else {
            $swapOptions = $this->safe_value($options, 'swap', array());
            $defaultSwapMethod = $this->safe_string($swapOptions, 'method', 'publicMixGetMixV1MarketFillsHistory');
            $swapMethod = $this->safe_string($params, 'method', $defaultSwapMethod);
            $params = $this->omit($params, 'method');
            if ($swapMethod === 'publicMixGetMixV1MarketFillsHistory') {
                $response = $this->publicMixGetMixV1MarketFillsHistory (array_merge($request, $params));
                //
                //     {
                ...
                //     }
                //
            } elseif ($swapMethod === 'publicMixGetMixV1MarketFills') {
                $response = $this->publicMixGetMixV1MarketFills (array_merge($request, $params));
            }
        }
        //
        // spot
    ...
    public function fetch_trading_fee(string $symbol, $params = array ()) {
        ...
        $response = $this->publicSpotGetSpotV1PublicProduct (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        if ($market['spot']) {
            $spotOptions = $this->safe_value($options, 'spot', array());
            $defaultSpotMethod = $this->safe_string($spotOptions, 'method', 'publicSpotGetSpotV1MarketCandles');
            ...
            if ($method === 'publicSpotGetSpotV1MarketCandles') {
                ...
                $response = $this->publicSpotGetSpotV1MarketCandles (array_merge($request, $params));
            } elseif ($method === 'publicSpotGetSpotV1MarketHistoryCandles') {
                $response = $this->publicSpotGetSpotV1MarketHistoryCandles (array_merge($request, $params));
            }
        } else {
            $swapOptions = $this->safe_value($options, 'swap', array());
            $defaultSwapMethod = $this->safe_string($swapOptions, 'method', 'publicMixGetMixV1MarketCandles');
            $swapMethod = $this->safe_string($params, 'method', $defaultSwapMethod);
            ...
            if (($priceType === 'mark') || ($swapMethod === 'publicMixGetMixV1MarketHistoryMarkCandles')) {
                $response = $this->publicMixGetMixV1MarketHistoryMarkCandles (array_merge($request, $params));
            } elseif (($priceType === 'index') || ($swapMethod === 'publicMixGetMixV1MarketHistoryIndexCandles')) {
                $response = $this->publicMixGetMixV1MarketHistoryIndexCandles (array_merge($request, $params));
            } elseif ($swapMethod === 'publicMixGetMixV1MarketCandles') {
                if ($limitIsUndefined) {
                    $request['limit'] = 1000;
                }
                $response = $this->publicMixGetMixV1MarketCandles (array_merge($request, $params));
            } elseif ($swapMethod === 'publicMixGetMixV1MarketHistoryCandles') {
                $response = $this->publicMixGetMixV1MarketHistoryCandles (array_merge($request, $params));
            }
        }
        if ($response === '') {
    ...
    public function fetch_balance($params = array ()): array {
        ...
        if (($marketType === 'swap') || ($marketType === 'future')) {
            ...
            $request['productType'] = $productType;
            $response = $this->privateMixGetMixV1AccountAccounts (array_merge($request, $params));
        } elseif ($marginMode === 'isolated') {
            ...
            $response = $this->privateSpotGetSpotV1AccountAssets (array_merge($request, $params));
        } else {
    ...
    public function create_order(string $symbol, string $type, string $side, $amount, $price = null, $params = array ()) {
        ...
        if ($market['spot']) {
            if ($isTriggerOrder) {
                $response = $this->privateSpotPostSpotV1PlanPlacePlan ($request);
            } elseif ($marginMode === 'isolated') {
                $response = $this->privateMarginPostMarginV1IsolatedOrderPlaceOrder ($request);
            } elseif ($marginMode === 'cross') {
                $response = $this->privateMarginPostMarginV1CrossOrderPlaceOrder ($request);
            } else {
                $response = $this->privateSpotPostSpotV1TradeOrders ($request);
            }
        } else {
            if ($isTriggerOrder) {
                $response = $this->privateMixPostMixV1PlanPlacePlan ($request);
            } elseif ($isStopLossOrTakeProfitTrigger) {
                $response = $this->privateMixPostMixV1PlanPlacePositionsTPSL ($request);
            } else {
                $response = $this->privateMixPostMixV1OrderPlaceOrder ($request);
            }
        }
        //
        //     {
    ...
    public function create_orders(array $orders, $params = array ()) {
        ...
        if (($market['swap']) || ($market['future'])) {
            ...
            $request['marginCoin'] = $market['settleId'];
            $response = $this->privateMixPostMixV1OrderBatchOrders ($request);
        } elseif ($marginMode === 'isolated') {
            $response = $this->privateMarginPostMarginV1IsolatedOrderBatchPlaceOrder ($request);
        } elseif ($marginMode === 'cross') {
            $response = $this->privateMarginPostMarginV1CrossOrderBatchPlaceOrder ($request);
        } else {
            $response = $this->privateSpotPostSpotV1TradeBatchOrders ($request);
        }
        //
        // {
        //     "code" => "00000",
    ...
    public function edit_order(string $id, $symbol, $type, $side, $amount = null, $price = null, $params = array ()) {
        ...
        if ($marketType === 'spot') {
            ...
            $response = $this->privateSpotPostSpotV1PlanModifyPlan (array_merge($request, $omitted));
        } else {
            ...
            if ($isStopOrder) {
                ...
                $response = $this->privateMixPostMixV1PlanModifyTPSLPlan (array_merge($request, $omitted));
            } else {
                $response = $this->privateMixPostMixV1PlanModifyPlan (array_merge($request, $omitted));
            }
        }
        //
        // spot
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()) {
        ...
        if (($marketType === 'swap') || ($marketType === 'future')) {
            ...
            if ($stop) {
                ...
                $response = $this->privateMixPostMixV1PlanCancelPlan (array_merge($request, $params));
            } else {
                $response = $this->privateMixPostMixV1OrderCancelOrder (array_merge($request, $params));
            }
        } elseif ($marketType === 'spot') {
            if ($marginMode !== null) {
                if ($marginMode === 'isolated') {
                    $response = $this->privateMarginPostMarginV1IsolatedOrderCancelOrder (array_merge($request, $params));
                } elseif ($marginMode === 'cross') {
                    $response = $this->privateMarginPostMarginV1CrossOrderCancelOrder (array_merge($request, $params));
                }
            } else {
                if ($stop) {
                    $response = $this->privateSpotPostSpotV1PlanCancelPlan (array_merge($request, $params));
                } else {
                    $response = $this->privateSpotPostSpotV1TradeCancelOrder (array_merge($request, $params));
                }
            }
        } else {
    ...
    public function cancel_orders($ids, ?string $symbol = null, $params = array ()) {
        ...
        if ($type === 'spot') {
            ...
            if ($marginMode !== null) {
                ...
                $response = $this->privateSpotPostSpotV1TradeCancelBatchOrdersV2 (array_merge($request, $params));
            }
        } else {
            $request['symbol'] = $market['id'];
            $request['marginCoin'] = $market['quote'];
            $request['orderIds'] = $ids;
            $response = $this->privateMixPostMixV1OrderCancelBatchOrders (array_merge($request, $params));
        }
        //
        //     spot
        //
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array ()) {
        ...
        if ($marketType === 'spot') {
            ...
            if ($marginMode === 'cross') {
                return $this->privateMarginPostMarginV1CrossOrderBatchCancelOrder (array_merge($spotMarginRequest, $params));
            } else {
                return $this->privateMarginPostMarginV1IsolatedOrderBatchCancelOrder (array_merge($spotMarginRequest, $params));
            }
        }
        $request = array(
        ...
        if ($stop !== null || $planType !== null) {
            ...
            $response = $this->privateMixPostMixV1PlanCancelAllPlan (array_merge($request, $params));
        } else {
            $response = $this->privateMixPostMixV1OrderCancelAllOrders (array_merge($request, $params));
        }
        //
        //     {
        //         "code" => "00000",
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()) {
        ...
        $response = null;
        if ($marketType === 'spot') {
            $response = $this->privateSpotPostSpotV1TradeOrderInfo (array_merge($request, $query));
        } elseif (($marketType === 'swap') || ($marketType === 'future')) {
            $response = $this->privateMixGetMixV1OrderDetail (array_merge($request, $query));
        } else {
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        if ($stop) {
            ...
            if ($marketType === 'spot') {
                ...
                $response = $this->privateSpotPostSpotV1PlanCurrentPlan (array_merge($request, $params));
            } else {
                $response = $this->privateMixGetMixV1PlanCurrentPlan (array_merge($request, $params));
            }
        } else {
            if ($marketType === 'spot') {
                if ($marginMode !== null) {
                    ...
                    if ($marginMode === 'isolated') {
                        $response = $this->privateMarginGetMarginV1IsolatedOrderOpenOrders (array_merge($request, $params));
                    } elseif ($marginMode === 'cross') {
                        $response = $this->privateMarginGetMarginV1CrossOrderOpenOrders (array_merge($request, $params));
                    }
                } else {
                    $response = $this->privateSpotPostSpotV1TradeOpenOrders (array_merge($request, $params));
                }
            } else {
                if ($market === null) {
                    $subType = null;
    ...
    public function fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        if ($paginate) {
            ...
            return $this->fetch_paginated_call_cursor('fetchClosedOrders', $symbol, $since, $limit, $params, $cursorReceived, $cursorSent, null, 50);
        }
    ...
    public function fetch_canceled_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($paginate) {
            ...
            $cursorReceived = ($market['spot'] && !$isStop) ? 'orderId' : 'endId';
            $cursorSent = ($market['spot'] && !$isStop) ? 'after' : 'lastEndId';
            return $this->fetch_paginated_call_cursor('fetchCanceledOrders', $symbol, $since, $limit, $params, $cursorReceived, $cursorSent, null, 50);
        }
        $response = $this->fetch_canceled_and_closed_orders($symbol, $since, $limit, $params);
        $result = array();
        for ($i = 0; $i < count($response); $i++) {
    ...
    public function fetch_canceled_and_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($stop) {
            if ($marketType === 'spot') {
                $response = $this->privateSpotPostSpotV1PlanHistoryPlan (array_merge($request, $params));
            } else {
                $response = $this->privateMixGetMixV1PlanHistoryPlan (array_merge($request, $params));
            }
        } else {
            if (($marketType === 'swap') || ($marketType === 'future')) {
                $response = $this->privateMixGetMixV1OrderHistory (array_merge($request, $params));
            } else {
                if ($marginMode !== null) {
                    if ($since === null) {
                        $since = $now - 7776000000;
                    ...
                    if ($marginMode === 'isolated') {
                        $response = $this->privateMarginGetMarginV1IsolatedOrderHistory (array_merge($request, $params));
                    } elseif ($marginMode === 'cross') {
                        $response = $this->privateMarginGetMarginV1CrossOrderHistory (array_merge($request, $params));
                    }
                } else {
                    if ($limit !== null) {
                        $request['limit'] = $limit;
                    ...
                    $response = $this->privateSpotPostSpotV1TradeHistory (array_merge($request, $params));
                }
            }
        }
        //
    ...
    public function fetch_ledger(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        $response = $this->privateSpotPostSpotV1AccountBills (array_merge($request, $params));
        //
        //     {
        //       "code" => "00000",
        //       "msg" => "success",
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($paginate) {
            if ($market['spot']) {
                return $this->fetch_paginated_call_cursor('fetchMyTrades', $symbol, $since, $limit, $params, 'orderId', 'after', null, 50);
            } else {
        ...
        if ($market['spot']) {
            if ($marginMode !== null) {
                ...
                if ($marginMode === 'isolated') {
                    $response = $this->privateMarginGetMarginV1IsolatedOrderFills (array_merge($request, $params));
                } elseif ($marginMode === 'cross') {
                    $response = $this->privateMarginGetMarginV1CrossOrderFills (array_merge($request, $params));
                }
            } else {
                ...
                $response = $this->privateSpotPostSpotV1TradeFills (array_merge($request, $params));
            }
        } else {
            ...
            $response = $this->privateMixGetMixV1OrderFills (array_merge($request, $params));
        }
        //
        // spot
        //
    ...
    public function fetch_order_trades(string $id, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        $response = null;
        if ($marketType === 'spot') {
            $response = $this->privateSpotPostSpotV1TradeFills (array_merge($request, $query));
        } elseif (($marketType === 'swap') || ($marketType === 'future')) {
            $response = $this->privateMixGetMixV1OrderFills (array_merge($request, $query));
        } else {
    ...
    public function fetch_position(string $symbol, $params = array ()) {
        ...
        $response = $this->privateMixGetMixV1PositionSinglePositionV2 (array_merge($request, $params));
        //
        //     {
        //       "code" => "00000",
        //       "msg" => "success",
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()) {
        ...
        $method = $this->safe_string($fetchPositionsOptions, 'method', 'privateMixGetMixV1PositionAllPositionV2');
        $market = null;
        if ($symbols !== null) {
        ...
        if ($method === 'privateMixGetMixV1PositionAllPositionV2') {
            $response = $this->privateMixGetMixV1PositionAllPositionV2 (array_merge($request, $params));
        } else {
            $isHistory = true;
            $response = $this->privateMixGetMixV1PositionHistoryPosition (array_merge($request, $params));
        }
        //
        //     {
        //       "code" => "00000",
    ...
    public function fetch_funding_rate_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($paginate) {
            return $this->fetch_paginated_call_incremental('fetchFundingRateHistory', $symbol, $since, $limit, $params, 'pageNo', 50);
        }
        $market = $this->market($symbol);
        $request = array(
            'symbol' => $market['id'],
        ...
        $response = $this->publicMixGetMixV1MarketHistoryFundRate (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_funding_rate(string $symbol, $params = array ()) {
        ...
        $response = $this->publicMixGetMixV1MarketCurrentFundRate (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_funding_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        $response = $this->privateMixGetMixV1AccountAccountBill (array_merge($request, $params));
        //
        //    {
        //        "code" => "00000",
        //        "msg" => "success",
    ...
    public function modify_margin_helper(string $symbol, $amount, $type, $params = array ()) {
        ...
        $response = $this->privateMixPostMixV1AccountSetMargin (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_leverage(string $symbol, $params = array ()) {
        ...
        $response = $this->privateMixGetMixV1AccountAccount (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function set_leverage($leverage, ?string $symbol = null, $params = array ()) {
        ...
        return $this->privateMixPostMixV1AccountSetLeverage (array_merge($request, $params));
    }
    ...
    public function set_margin_mode($marginMode, ?string $symbol = null, $params = array ()) {
        ...
        return $this->privateMixPostMixV1AccountSetMarginMode (array_merge($request, $params));
    }
    ...
    public function set_position_mode($hedged, ?string $symbol = null, $params = array ()) {
        ...
        $request['productType'] = $productType;
        $response = $this->privateMixPostMixV1AccountSetPositionMode (array_merge($request, $params));
        //
        //    {
        //         "code" => "40919",
    ...
    public function fetch_open_interest(string $symbol, $params = array ()) {
        ...
        $response = $this->publicMixGetMixV1MarketOpenInterest (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_transfers(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        list($request, $params) = $this->handle_until_option('after', $request, $params);
        $response = $this->privateSpotGetSpotV1AccountTransferRecords (array_merge($request, $params));
        //
        //     {
        //         "code":"00000",
        //         "message":"success",
    ...
    public function transfer(string $code, $amount, $fromAccount, $toAccount, $params = array ()) {
        ...
        $response = $this->privateSpotPostSpotV1WalletTransferV2 (array_merge($request, $params));
        //
        //    {
        //        "code" => "00000",
        //        "msg" => "success",
    ...
    public function fetch_my_liquidations(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($marginMode === 'isolated') {
            ...
            $response = $this->privateMarginGetMarginV1CrossLiquidationList (array_merge($request, $params));
        }
        //
        // isolated
        //
    ...
    public function fetch_isolated_borrow_rate(string $symbol, $params = array ()) {
        ...
        $response = $this->publicMarginGetMarginV1IsolatedPublicInterestRateAndLimit (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_cross_borrow_rate(string $code, $params = array ()) {
        ...
        $response = $this->publicMarginGetMarginV1CrossPublicInterestRateAndLimit (array_merge($request, $params));
        //
        //     {
        //         "code" => "00000",
        //         "msg" => "success",
    ...
    public function fetch_borrow_interest(?string $code = null, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        if ($marginMode === 'isolated') {
            ...
            $response = $this->privateMarginGetMarginV1CrossInterestList (array_merge($request, $params));
        }
        //
        // isolated
        //
    ...
    public function close_all_positions($params = array ()): array {
        ...
        $response = $this->privateMixPostMixV1OrderCloseAllPositions (array_merge($request, $params));
        //
        //    {
        //        "code" => "00000",
        //        "msg" => "success",
