...
abstract class bithumb extends \ccxt\Exchange {
    ...
    public function public_get_ticker_all_quoteid($params = array()) {
        return $this->request('ticker/ALL_{quoteId}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_ticker_baseid_quoteid($params = array()) {
        return $this->request('ticker/{baseId}_{quoteId}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_orderbook_all_quoteid($params = array()) {
        return $this->request('orderbook/ALL_{quoteId}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_orderbook_baseid_quoteid($params = array()) {
        return $this->request('orderbook/{baseId}_{quoteId}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_transaction_history_baseid_quoteid($params = array()) {
        return $this->request('transaction_history/{baseId}_{quoteId}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_network_info($params = array()) {
        return $this->request('network-info', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_assetsstatus_multichain_all($params = array()) {
        return $this->request('assetsstatus/multichain/ALL', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_assetsstatus_multichain_currency($params = array()) {
        return $this->request('assetsstatus/multichain/{currency}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_withdraw_minimum_all($params = array()) {
        return $this->request('withdraw/minimum/ALL', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_withdraw_minimum_currency($params = array()) {
        return $this->request('withdraw/minimum/{currency}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_assetsstatus_all($params = array()) {
        return $this->request('assetsstatus/ALL', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_assetsstatus_baseid($params = array()) {
        return $this->request('assetsstatus/{baseId}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
    public function public_get_candlestick_baseid_quoteid_interval($params = array()) {
        return $this->request('candlestick/{baseId}_{quoteId}/{interval}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return array<string, mixed>
     */
