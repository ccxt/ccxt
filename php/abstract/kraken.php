...
abstract class kraken extends \ccxt\Exchange {
    ...
    public function public_get_pretrade($params = array()) {
        return $this->request('PreTrade', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_post_creditlines($params = array()) {
        return $this->request('CreditLines', 'private', 'POST', $params, null, null, array("cost" => 3));
    }
    ...
    public function private_post_orderamends($params = array()) {
        return $this->request('OrderAmends', 'private', 'POST', $params, null, null, array("cost" => 3));
    }
    ...
    public function publicGetPreTrade($params = array()) {
        return $this->request('PreTrade', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function privatePostCreditLines($params = array()) {
        return $this->request('CreditLines', 'private', 'POST', $params, null, null, array("cost" => 3));
    }
    ...
    public function privatePostOrderAmends($params = array()) {
        return $this->request('OrderAmends', 'private', 'POST', $params, null, null, array("cost" => 3));
    }
