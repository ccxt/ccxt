...
abstract class coinmetro extends \ccxt\Exchange {
    ...
    public function public_get_exchange_candles_pair_timeframe_from_to($params = array()) {
        return $this->request('exchange/candles/{pair}/{timeframe}/{from}/{to}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function public_get_exchange_ticks_pair_from($params = array()) {
        return $this->request('exchange/ticks/{pair}/{from}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function public_get_exchange_book_pair($params = array()) {
        return $this->request('exchange/book/{pair}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_get_users_wallets_history_since($params = array()) {
        return $this->request('users/wallets/history/{since}', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_get_exchange_orders_history_since($params = array()) {
        return $this->request('exchange/orders/history/{since}', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function private_get_exchange_fills_since($params = array()) {
        return $this->request('exchange/fills/{since}', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
