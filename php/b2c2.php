...
class b2c2 extends Exchange {
    ...
    public function fetch_currencies($params = array ()) {
        $ccys = $this->privateGetCurrency ($params);
        $account_info = $this->privateGetAccountInfo ($params);
        //
        // currencies endpoint
        // {
        //     "AUD" => array(
    ...
    public function fetch_markets($params = array ()) {
        ...
        $response = $this->privateGetInstruments ($params);
        //
        // [
        //     array(
        //       "name" => "LTCUSD.SPOT",
    ...
    public function create_quote($symbol, $side, $amount, $params = array ()) {
        ...
        $response = $this->privatePostRequestForQuote (array_merge($request, $params));
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        ...
        $response = $this->privateGetOrderOrderIdOrClientOrderId (array_merge($request, $params));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response_next = $this->fetch_recursively();
    ...
    public function fetch_recursively() {
        ...
        var_dump ($next);
        if ($next !== null) {
            $response = $this->request($next, 'private', 'GET');
            $response_next = $this->fetch_recursively();
            if ($response_next !== null) {
                $response[] = $response_next;
            }
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetTrade (array_merge($request, $params));
        $response_next = $this->fetch_recursively();
        if ($response_next !== null) {
            $response[] = $response_next;
        }
    ...
    public function fetch_ledger($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetLedger (array_merge($request, $params));
        $response_next = $this->fetch_recursively();
        if ($response_next !== null) {
            $response[] = $response_next;
        }
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = $this->privateGetWithdrawal (array_merge($request, $params));
        $response_next = $this->fetch_recursively();
        if ($response_next !== null) {
            $response[] = $response_next;
        }
