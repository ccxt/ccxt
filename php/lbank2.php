...
class lbank2 extends Exchange {
    ...
    public function fetch_ticker($symbol, $params = array ()) {
        ...
        //      }
        //
        $result = $this->safe_value($response, 'data')[0];
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        ...
        $response = $this->publicGetSupplementIncrDepth (array_merge($request, $params));
    ...
    public function fetch_closed_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $this->load_markets();
        $market = $this->market($symbol);
        $since = $this->safe_value($params, 'startTime', $since);
        ...
        $response = $this->privatePostSupplementTransactionHistory (array_merge($request, $params));
        //
        //      {
        //          "result":true,
        //          "data":array(
    ...
    public function sign($path, $api = 'public', $method = 'GET', $params = array (), $headers = null, $body = null) {
        ...
        if ($api === 'public') {
            ...
            $hash = strtoupper($this->hash($auth));
            $sign = null;
            if ($signatureMethod === 'RSA') {
                ...
                $sign = $this->binary_to_base64($this->rsa($hash, $this->encode($pem), 'RS256'));
                // TODO fix RSA signing
