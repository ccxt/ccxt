...
class p2b extends \ccxt\async\p2b {
    ...
    private function do_watch_ohlcv(string $symbol, string $timeframe = '15m', ?int $since = null, ?int $limit = null, $params = array()) {
        /**
    ...
    private function do_watch_ticker(string $symbol, $params = array()) {
        ...
        list($name, $params) = $this->handle_option_string_and_params($params, 'watchTicker', 'name', $name);
        $market = $this->market($symbol);
    ...
    private function do_watch_tickers(?array $symbols = null, $params = array()) {
        ...
        $watchTickerOptions = $this->safe_dict($this->options, 'watchTicker');
        $name = $this->safe_string($watchTickerOptions, 'name', 'state');  // or price
        list($name, $params) = $this->handle_option_string_and_params($params, 'watchTickers', 'name', $name);
        $messageHashes = array();
        $args = array();
