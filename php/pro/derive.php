...
class derive extends \ccxt\async\derive {
    ...
    public function watch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            Async\await($this->load_markets());
            $subaccountId = null;
            list($subaccountId, $params) = $this->handle_option_and_params($params, 'watchOrders', 'subaccount_id');
    ...
    public function watch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            Async\await($this->load_markets());
            $subaccountId = null;
            list($subaccountId, $params) = $this->handle_option_and_params($params, 'watchMyTrades', 'subaccount_id');
