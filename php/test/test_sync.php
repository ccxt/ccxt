...
class testMainClass extends baseMainTestClass {
    ...
    public function init($exchangeId, $symbol) {
        $this->parseCliArgs();
        if ($this->staticTests) {
            $this->runStaticTests($exchangeId, $symbol); // symbol here is the testname
            return;
        }
        if ($this->idTests) {
    ...
    public function loadExchange($exchange) {
        $result = $this->testSafe('loadMarkets', $exchange, [], true);
        if (!$result) {
            return false;
        }
    ...
    public function testMethodStatically($exchange, $method, $data, $type, $skipKeys) {
        ...
        $requestUrl = null;
        try {
            call_exchange_method_dynamically($exchange, $method, $this->sanitizeDataInput($data['input']));
        } catch(Exception $e) {
    ...
    public function testExchangeStatically($exchangeName, $exchangeData, $testName = null) {
        ...
        for ($i = 0; $i < count($methodsNames); $i++) {
            ...
            for ($j = 0; $j < count($results); $j++) {
                ...
                $this->testMethodStatically($exchange, $method, $result, $type, $skipKeys);
            }
        }
        close($exchange);
    }
    ...
    public function testBinance() {
        ...
        try {
            $binance->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
        ...
        try {
            $binance->createOrder('BTC/USDT:USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
            $swapOrderRequest = $this->urlencodedToDict($binance->last_request_body);
        }
        $swapInverseOrderRequest = null;
        try {
            $binance->createOrder('BTC/USD:BTC', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testOkx() {
        ...
        $spotOrderRequest = null;
        try {
            $okx->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
        ...
        $swapOrderRequest = null;
        try {
            $okx->createOrder('BTC/USDT:USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testCryptocom() {
        ...
        $id = 'CCXT';
        $cryptocom->loadMarkets();
        $request = null;
        try {
            $cryptocom->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testBybit() {
        ...
        try {
            $bybit->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testKucoin() {
        ...
        try {
            $kucoin->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
            // we expect an error here, we're only interested in the headers
    ...
    public function testKucoinfutures() {
        ...
        try {
            $kucoin->createOrder('BTC/USDT:USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
            $reqHeaders = $kucoin->last_request_headers;
        }
        assert($reqHeaders['KC-API-PARTNER'] === $id, 'id not in headers');
    ...
    public function testBitget() {
        ...
        try {
            $bitget->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testMexc() {
        ...
        $mexc->loadMarkets();
        try {
            $mexc->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testHuobi() {
        ...
        $spotOrderRequest = null;
        try {
            $huobi->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
        ...
        $swapOrderRequest = null;
        try {
            $huobi->createOrder('BTC/USDT:USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
            $swapOrderRequest = json_parse($huobi->last_request_body);
        }
        $swapInverseOrderRequest = null;
        try {
            $huobi->createOrder('BTC/USD:BTC', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
    ...
    public function testWoo() {
        ...
        $spotOrderRequest = null;
        try {
            $woo->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
        ...
        try {
            $woo->createOrder('BTC/USDT:USDT', 'limit', 'buy', 1, 20000, array(
                'stopPrice' => 30000,
            ));
        } catch(Exception $e) {
    ...
    public function testBitmart() {
        ...
        $bitmart->loadMarkets();
        try {
            $bitmart->createOrder('BTC/USDT', 'limit', 'buy', 1, 20000);
        } catch(Exception $e) {
