...
function test_decimal_to_precision() {
    ...
    assert($exchange->decimal_to_precision('0.000123456789', TRUNCATE, 1e-8, \ccxt\TICK_SIZE) === '0.00012345');
    // ----------------------------------------------------------------------------
    // Negative Numbers
    ...
    assert($exchange->decimal_to_precision('1.2345', ROUND, 0.0001, \ccxt\TICK_SIZE) === '1.2345');
    assert($exchange->decimal_to_precision('1.23456', ROUND, 0.0001, \ccxt\TICK_SIZE) === '1.2346');
    assert($exchange->decimal_to_precision('1.23454', ROUND, 0.0001, \ccxt\TICK_SIZE) === '1.2345');
    assert($exchange->decimal_to_precision('1.23444', TRUNCATE, 0.0001, \ccxt\TICK_SIZE) === '1.2344');
    // \ccxt\TICK_SIZE with numbers smaller than tick
    assert($exchange->decimal_to_precision('0.05', ROUND, 0.1, \ccxt\TICK_SIZE) === '0.1');
    assert($exchange->decimal_to_precision('0.04', ROUND, 0.1, \ccxt\TICK_SIZE) === '0');
    assert($exchange->decimal_to_precision('0.04', TRUNCATE, 0.1, \ccxt\TICK_SIZE) === '0');
    assert($exchange->decimal_to_precision('0.049999', ROUND, 0.1, \ccxt\TICK_SIZE) === '0');
    ...
    assert($exchange->decimal_to_precision('1.2', TRUNCATE, 0.1, \ccxt\TICK_SIZE) === '1.2');
    assert($exchange->decimal_to_precision('1.2', ROUND, 0.1, \ccxt\TICK_SIZE) === '1.2');
    assert($exchange->decimal_to_precision('12', TRUNCATE, 4, \ccxt\TICK_SIZE) === '12');
    assert($exchange->decimal_to_precision('12', ROUND, 4, \ccxt\TICK_SIZE) === '12');
    ...
    assert($exchange->decimal_to_precision('123456.12345678912', TRUNCATE, 1e-8, \ccxt\TICK_SIZE) === '123456.12345678');
    // todo: not sure about below
    assert($exchange->decimal_to_precision('123456.12345674999', TRUNCATE, 5e-8, \ccxt\TICK_SIZE) === '123456.1234567');
    assert($exchange->decimal_to_precision('123456.12345674999', TRUNCATE, 5e-8, \ccxt\TICK_SIZE, PAD_WITH_ZERO) === '123456.12345670');
    assert($exchange->decimal_to_precision('123456.12345675001', TRUNCATE, 5e-8, \ccxt\TICK_SIZE) === '123456.12345675');
    assert($exchange->decimal_to_precision('123456.50000000001', TRUNCATE, 0.5, \ccxt\TICK_SIZE, PAD_WITH_ZERO) === '123456.5');
    assert($exchange->decimal_to_precision('123456.49999999999', TRUNCATE, 0.5, \ccxt\TICK_SIZE, PAD_WITH_ZERO) === '123456.0');
    assert($exchange->decimal_to_precision('123456.12345678912', TRUNCATE, '0.00000001', \ccxt\TICK_SIZE) === '123456.12345678');
}
