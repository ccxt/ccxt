...
// decimal_to_precision.profile.php
// This program tests all parts of Precise and Exchange::decimal_to_precision API
...
// [ccxt]$ php php/test/decimal_to_precision.profile.php
//
// To run tests with timing measurements (runs each test many times for precision timing):
// [ccxt]$ php php/test/decimal_to_precision.profile.php -t
...
$testPrecise = function() {
    ...
    assert (Precise::string_pow10('-4') == '0.0001');
    assert (Precise::string_pow10('-3') == '0.001');
    assert (Precise::string_pow10('-2') == '0.01');
    assert (Precise::string_pow10('-1') == '0.1');
    assert (Precise::string_pow10('0') == '1');
    assert (Precise::string_pow10('1') == '10');
    assert (Precise::string_pow10('2') == '100');
    assert (Precise::string_pow10('3') == '1000');
    assert (Precise::string_pow10('4') == '10000');
    ...
    assert (Precise::string_round('1.0000') === '1');
    assert (Precise::string_round('2') === '2');
    assert (Precise::string_round('3.1415') === '3');
    assert (Precise::string_round('-3.1415') === '-3');
    assert (Precise::string_round('0.000') === '0');
    assert (Precise::string_round('3.5415') === '4');
    assert (Precise::string_round('-3.5415') === '-4');
    assert (Precise::string_round('314.15') === '314');
    assert (Precise::string_round('-314.15') === '-314');
    assert (Precise::string_round('314.55') === '315');
    assert (Precise::string_round('-314.55') === '-315');
    assert (Precise::string_round('0.499999999999999999999999999') === '0');
    assert (Precise::string_round('0.5') === '1');
    assert (Precise::string_round('0.500000000000000000000000001') === '1');
    assert (Precise::string_round('-0.499999999999999999999999999') === '0');
    assert (Precise::string_round('-0.5') === '-1');
    assert (Precise::string_round('-0.500000000000000000000000001') === '-1');
    
    assert (Precise::string_floor('1.0000') === '1');
    assert (Precise::string_floor('2') === '2');
    assert (Precise::string_floor('3.1415') === '3');
    assert (Precise::string_floor('-3.1415') === '-4');
    assert (Precise::string_floor('0.000') === '0');
    assert (Precise::string_floor('3.5415') === '3');
    assert (Precise::string_floor('-3.5415') === '-4');
    assert (Precise::string_floor('314.15') === '314');
    assert (Precise::string_floor('-314.15') === '-315');
    assert (Precise::string_floor('314.55') === '314');
    assert (Precise::string_floor('-314.55') === '-315');
    
    assert (Precise::string_ceil('1.0000') === '1');
    assert (Precise::string_ceil('2') === '2');
    assert (Precise::string_ceil('3.1415') === '4');
    assert (Precise::string_ceil('-3.1415') === '-3');
    assert (Precise::string_ceil('0.000') === '0');
    assert (Precise::string_ceil('3.5415') === '4');
    assert (Precise::string_ceil('-3.5415') === '-3');
    assert (Precise::string_ceil('314.15') === '315');
    assert (Precise::string_ceil('-314.15') === '-314');
    assert (Precise::string_ceil('314.55') === '315');
    assert (Precise::string_ceil('-314.55') === '-314');
