...
class websea extends Exchange {
    ...
    public function fetch_markets($params = array ()): array {
         ...
         */
        $response = $this->openApiPublicGetOpenApiMarketSymbols ($params);
        //
        //     {
        //         "errno" => 0,
        //         "errmsg" => "success",
    ...
    public function fetch_currencies($params = array ()): ?array {
         ...
         */
        $response = $this->openApiPublicGetOpenApiMarketCurrencies ($params);
        //
        //     {
        //         "errno" => 0,
        //         "errmsg" => "success",
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->openApiPublicGetOpenApiMarketDepth ($this->extend($request, $params));
        //
        // {
        //     "errno" => 0,
        //     "errmsg" => "success",
    ...
    public function fetch_ticker(string $symbol, $params = array ()): array {
        ...
        $response = $this->openApiPublicGetOpenApiMarket24kline ($this->extend($request, $params));
        $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): array {
         ...
         */
        $this->load_markets();
        $response = $this->openApiPublicGetOpenApiMarket24kline ($params);
        $result = $this->safe_value($response, 'result', array());
        $tickers = array();
        for ($i = 0; $i < count($result); $i++) {
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->openApiPublicGetOpenApiMarketKline ($this->extend($request, $params));
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->openApiPublicGetOpenApiMarketTrade ($this->extend($request, $params));
        //
        // {
        //     "errno" => 0,
        //     "errmsg" => "success",
    ...
    public function fetch_balance($params = array ()): array {
         ...
         */
        $this->load_markets();
        $response = $this->openApiPrivatePostOpenApiWalletList ($params);
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()): array {
         ...
         */
        $this->load_markets();
        $response = $this->openApiPrivatePostOpenApiFuturesPositionList ($params);
        //
        // 需要根据实际API响应结构调整
        //
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()): array {
        ...
        $response = $this->openApiPrivatePostOpenApiEntrustAdd ($this->extend($request, $params));
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()) {
        ...
        $response = $this->openApiPrivatePostOpenApiEntrustCancel ($this->extend($request, $params));
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()): array {
        ...
        $response = $this->openApiPrivatePostOpenApiEntrustOrderDetail ($this->extend($request, $params));
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->openApiPrivatePostOpenApiEntrustOrderList ($this->extend($request, $params));
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
    ...
    public function fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): array {
        ...
        $response = $this->openApiPrivatePostOpenApiEntrustHistoryList ($this->extend($request, $params));
        //
        // 需要根据实际API响应结构调整
        //
        $result = $this->safe_value($response, 'result', array());
