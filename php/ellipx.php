...
use ccxt\abstract\ellipx as Exchange;
...
class ellipx extends Exchange {
    ...
    public function fetch_currencies($params = array ()): ?array {
         ...
         */
        $response = $this->_restGetCryptoTokenInfo ($this->extend(array(
            'Can_Deposit' => 'Y',
    ...
    public function fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        ...
        return $this->fetch_orders_by_status(null, $symbol, $since, $limit, $params);
    }
    ...
    public function withdraw(string $code, float $amount, string $address, $tag = null, $params = array ()): array {
        ...
        $chainsResponse = $this->privateGetUnitCurrency (array( 'currency' => $currency['code'] )); // fetch Unit__ $params for $currency
