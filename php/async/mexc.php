...
class mexc extends Exchange {
    ...
    public function fetch_funding_rate_history($symbol = null, $since = null, $limit = null, $params = array ()) {
         ...
         * @param {int|float|null} $since not used by mexc, but filtered internally by ccxt
         * @param {int|float|null} $limit mexc $limit is page_size default 20, maximum is 100
         * @param {array} $params extra parameters specific to the mexc api endpoint
    ...
    public function set_position_mode($hedged, $symbol = null, $params = array ()) {
        ...
        $response = yield $this->contractPrivatePostPositionChangePositionMode (array_merge($request, $params));
        //
        //     {
        //         "success":true,
        //         "code":0
