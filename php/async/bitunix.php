...
use ccxt\async\abstract\bitunix as Exchange;
use \React\Async;
...
class bitunix extends Exchange {
    ...
    public function fetch_markets($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->publicGetApiSpotV1CommonCoinPairList ($params));
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->publicGetWebApiV1CommonTickers ());
            $markets = $this->safe_list($response, 'data');
            $result = array();
            for ($i = 0; $i < count($markets); $i++) {
