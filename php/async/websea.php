...
class websea extends Exchange {
    ...
    public function fetch_balance($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            if ($marketType === 'swap') {
                // 全仓资产查询 - 使用合约全仓资产列表接口
                $response = Async\await($this->privateGetOpenApiContractWalletListFull ($query));
    ...
    public function fetch_positions(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->privateGetOpenApiContractPosition ($this->extend($request, $params)));
            //
            // Websea API响应格式 (实际文档):
            // {
            //     "errno" => 0,
    ...
    public function fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            if ($marketType === 'swap') {
                ...
                $response = Async\await($this->privateGetOpenApiContractHistoryList ($this->extend($request, $query)));
            } else {
                // 现货历史订单列表
