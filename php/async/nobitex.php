...
class nobitex extends Exchange {
    ...
    private function do_fetch_markets($params = array()) {
         ...
         */
        $response = Async\await($this->publicGetV2Options($params));
        //
        //     {
        //         "status": "ok",
        //         "nobitex": {
    ...
    private function do_fetch_order_book(string $symbol, ?int $limit = null, $params = array()) {
        ...
        $response = Async\await($this->publicGetV3OrderbookSymbol($this->extend($request, $params)));
        //
        //     {
        //         "status": "ok",
    ...
    private function do_create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        ...
        $response = Async\await($this->privatePostMarketOrdersAdd($this->extend($request, $params)));
        //
        //     {
        //         "status": "ok",
        //         "order": {
