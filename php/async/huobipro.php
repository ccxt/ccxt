...
class huobipro extends Exchange {
    ...
    public function fetch_trading_limits($symbols = null, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_trading_limits_by_id($id, $params = array ()) : Generator {
        yield;
        $request = array(
            'symbol' => $id,
        );
    ...
    public function fetch_trades($symbol, $since = null, $limit = 1000, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = 1000, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function fetch_accounts($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->privateGetAccountAccounts ($params);
    ...
    public function fetch_orders_by_states($states, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
            'states' => $states,
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrderOrdersId (array_merge($request, $params));
    ...
    public function fetch_open_orders_v1($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        if ($symbol === null) {
            throw new ArgumentsRequired($this->id . ' fetchOpenOrdersV1 requires a $symbol argument');
        }
        return yield $this->fetch_orders_by_states('pre-submitted,submitted,partial-filled', $symbol, $since, $limit, $params);
    }
    ...
    public function fetch_open_orders_v2($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        if ($symbol === null) {
        ...
        $response = yield $this->privateGetOrderOpenOrders (array_merge($request, $omitted));
        //
        //     {
        //         "status":"ok",
        //         "$data":array(
    ...
    public function fetch_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->v2PrivateGetAccountDepositAddress (array_merge($request, $params));
        //
        //     {
        //         $code => 200,
        //         $data => array(
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetQueryDepositWithdraw (array_merge($request, $params));
        // return $response
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $this->check_address($address);
        $currency = $this->currency($code);
