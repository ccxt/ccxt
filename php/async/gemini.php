...
class gemini extends Exchange {
    ...
    public function fetch_markets_from_web($symbols = null, $params = array ()) : Generator {
        yield;
        ...
        $apiSymbols = yield $this->fetch_markets_from_api($params);
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $ticker = yield $this->publicGetV1PubtickerSymbol (array_merge($request, $params));
