...
class currencycom extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        $response = yield $this->publicGetV1ExchangeInfo ($params);
        //
        //     {
        //         "timezone":"UTC",
    ...
    public function fetch_accounts($params = array ()) {
        $response = yield $this->privateGetV1Account ($params);
        //
        //     {
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        yield $this->load_markets();
        $response = yield $this->publicGetV1Ticker24hr ($params);
        //
        //     array(
        //         {
        //             "symbol":"EVK",
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        ...
        $response = yield $this->privatePostV1Order (array_merge($request, $params));
        //
        //     {
        //         "symbol" => "BTC/USD",
        //         "orderId" => "00000000-0000-0000-0000-0000000c0263",
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->privateGetV1OpenOrders (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        ...
        $response = yield $this->privateDeleteV1Order (array_merge($request, $params));
        //
        //     {
        //         "symbol":"ETH/USD",
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->privateGetV1MyTrades (array_merge($request, $params));
        //
        //     array(
        //         {
        //             "symbol" => "BNBBTC",
