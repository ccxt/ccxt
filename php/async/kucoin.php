...
class kucoin extends Exchange {
    ...
    private function do_fetch_contract_markets($params = array()) {
    ...
    private function do_fetch_uta_markets($params = array()) {
        $promises = array();
    ...
    private function do_load_migration_status(bool $force = false) {
        /**
    ...
    public function fetch_contract_tickers(?array $symbols = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_contract_tickers(...))($symbols, $params);
    }
    ...
    public function fetch_utaohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_utaohlcv(...))($symbol, $timeframe, $since, $limit, $params);
    }

    private function do_fetch_utaohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array()) {
        /**
         * @ignore
    ...
    public function fetch_contract_deposit_address(string $code, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_contract_deposit_address(...))($code, $params);
    }

    private function do_fetch_contract_deposit_address(string $code, $params = array()) {
        /**
         * fetch the deposit $address for a $currency associated with this account
         *
    ...
    private function do_create_uta_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        /**
    ...
    private function do_create_spot_orders(array $orders, $params = array()) {
        /**
    ...
    private function do_create_contract_orders(array $orders, $params = array()) {
        /**
    ...
    private function do_cancel_spot_order(string $id, ?string $symbol = null, $params = array()) {
        /**
    ...
    private function do_cancel_contract_order(string $id, ?string $symbol = null, $params = array()) {
        /**
    ...
    private function do_cancel_uta_order(string $id, ?string $symbol = null, $params = array()) {
        /**
    ...
    private function do_cancel_all_spot_orders(?string $symbol = null, $params = array()) {
        /**
    ...
    private function do_cancel_all_contract_orders(?string $symbol = null, $params = array()) {
        /**
    ...
    private function do_cancel_all_uta_orders(?string $symbol = null, $params = array()) {
        /**
    ...
    private function do_fetch_spot_orders_by_status(mixed $status, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
    ...
    private function do_fetch_uta_orders_by_status(mixed $status, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
    ...
    private function do_fetch_spot_order(string $id, ?string $symbol = null, $params = array()) {
        /**
         * fetch a spot order
         *
         * @see https://www.kucoin.com/docs-new/rest/spot-trading/orders/get-order-by-orderld
    ...
    private function do_fetch_contract_order(?string $id, ?string $symbol = null, $params = array()) {
        /**
         * fetc contract order
         *
         * @see https://www.kucoin.com/docs-new/rest/futures-trading/orders/get-order-by-orderld
    ...
    private function do_fetch_uta_order(?string $id, ?string $symbol = null, $params = array()) {
        /**
         * fetch uta order
         *
         * @see https://www.kucoin.com/docs-new/rest/ua/get-order-details
    ...
    private function do_fetch_my_spot_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
         *
         * @see https://www.kucoin.com/docs-new/rest/spot-trading/orders/get-trade-history
         * @see https://www.kucoin.com/docs-new/rest/margin-trading/orders/get-trade-history
    ...
    private function do_fetch_my_contract_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
         *
         * @see https://www.kucoin.com/docs-new/rest/futures-trading/orders/get-trade-history
         *
    ...
    private function do_fetch_my_uta_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
         *
         * @see https://www.kucoin.com/docs-new/rest/ua/get-trade-history
         *
    ...
    public function fetch_contract_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_contract_deposits(...))($code, $since, $limit, $params);
    }

    private function do_fetch_contract_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
    ...
    public function fetch_contract_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_contract_withdrawals(...))($code, $since, $limit, $params);
    }

    private function do_fetch_contract_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
    ...
    public function fetch_contract_balance($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_contract_balance(...))($params);
    }

    private function do_fetch_contract_balance($params = array()) {
        /**
         * query for balance and get the amount of funds available for trading or funds locked in orders
         *
         * @see https://www.kucoin.com/docs-new/rest/account-info/account-funding/get-$account-futures
    ...
    public function fetch_uta_balance($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_uta_balance(...))($params);
    }

    private function do_fetch_uta_balance($params = array()) {
        /**
    ...
    public function transfer_uta(string $code, float $amount, string $fromAccount, string $toAccount, $params = array()): PromiseInterface {
        return Async\async(self::do_transfer_uta(...))($code, $amount, $fromAccount, $toAccount, $params);
    }

    private function do_transfer_uta(string $code, float $amount, string $fromAccount, string $toAccount, $params = array()) {
        /**
    ...
    public function transfer_classic(string $code, float $amount, string $fromAccount, string $toAccount, $params = array()): PromiseInterface {
        return Async\async(self::do_transfer_classic(...))($code, $amount, $fromAccount, $toAccount, $params);
    }

    private function do_transfer_classic(string $code, float $amount, string $fromAccount, string $toAccount, $params = array()) {
        /**
    ...
    private function do_set_contract_leverage(int $leverage, ?string $symbol = null, $params = array()) {
        /**
         * set the level of $leverage for a $market
         *
    ...
    public function is_uta_enabled($params = array()): PromiseInterface {
        return Async\async(self::do_is_uta_enabled(...))($params);
    }

    private function do_is_uta_enabled($params = array()) {
        /**
         *
        ...
        if ($uta === null) {
            $response = Async\await($this->utaPrivateGetAccountMode($params));
            $data = $this->safe_dict($response, 'data', array());
