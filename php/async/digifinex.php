...
class digifinex extends Exchange {
    ...
    public function fetch_markets_by_type($type, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        ...
        $response = yield $this->v2GetTicker (array_merge($request, $params));
        //
        //     {
        //         "$ticker":{
        //             "btc_eth":array(
    ...
    public function cancel_orders($ids, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $defaultType = $this->safe_string($this->options, 'defaultType', 'spot');
        $orderType = $this->safe_string($params, 'type', $defaultType);
