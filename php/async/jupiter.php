...
use ccxt\async\abstract\jupiter as Exchange;
...
class jupiter extends Exchange {
    ...
    private function do_fetch_markets($params = array()) {
        ...
        $response = Async\await($this->publicGetTokensV2Tag($this->extend($request, $params)));
        //
        //     [
    ...
    private function do_fetch_ticker(string $symbol, $params = array()) {
        ...
        $response = Async\await($this->publicGetPriceV3($this->extend($request, $params)));
        //
        //     {
    ...
    private function do_create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        ...
        $quote = Async\await($this->publicGetSwapV1Quote($quoteRequest));
        $swap = Async\await($this->publicPostSwapV1Swap(array(
            'quoteResponse' => $quote,
