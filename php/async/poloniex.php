...
class poloniex extends Exchange {
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $orders = yield $this->fetch_orders($symbol, $since, $limit, $request);
        for ($i = 0; $i < count($orders); $i++) {
            if ($orders[$i]['id'] === $id) {
                return $orders[$i];
            }
    ...
    public function fetch_open_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        yield $this->load_markets();
        $id = (string) $id;
        $response = yield $this->privatePostReturnOrderStatus (array_merge(array(
            'orderNumber' => $id,
        ), $params));
        //
        //     {
    ...
    public function fetch_transactions_helper($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
