...
class bitir extends Exchange {
    ...
    public function parse_market($market): array {
        ...
        //     'liked_by_user' => false,
        // ),
        $baseCurrency = $this->safe_dict($market, 'base_currency');
        $quoteCurrency = $this->safe_dict($market, 'quote_currency');
        $id = $this->safe_string($market, 'id');
        $baseId = $this->safe_string($baseCurrency, 'id');
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetV1MarketIdOrder ($request));
            $orderbookList = $this->safe_list($response, 'data');
    ...
    public function sign($path, $api = 'public', $method = 'GET', $params = array (), $headers = null, $body = null) {
        ...
        if ($path === 'v1/market' && $params['id'] !== null) {
            $url = $url . '/' . $params['id'];
        }
