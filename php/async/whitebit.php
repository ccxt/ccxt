...
class whitebit extends Exchange {
    ...
    public function fetch_trades_v1($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function fetch_trades_v2($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
