...
class bittrex extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->v3publicGetMarkets ($params);
        //
        //     array(
        //         array(
        //             "$symbol":"LTC-BTC",
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->accountGetBalances ($params);
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->publicGetMarketsummaries ($params);
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketsummary (array_merge($request, $params));
        //
        //     {
        //         "success":true,
        //         "message":"",
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarkethistory (array_merge($request, $params));
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->v2GetMarketGetTicks (array_merge($request, $params));
        if (is_array($response) && array_key_exists('result', $response)) {
            if ($response['result']) {
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetOpenorders (array_merge($request, $params));
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        return yield $this->$method ($symbol, $type, $side, $amount, $price, $params);
    }

    public function create_order_v3($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        yield;
        ...
        $response = yield $this->v3PostOrders (array_merge($request, $params));
        //
        //     {
    ...
    public function create_order_v1($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        yield;
        if ($type !== 'limit') {
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetCancel (array_merge($request, $params));
        //
        //     {
        //         "success" => true,
        //         "message" => "''",
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->accountGetDeposithistory (array_merge($request, $params));
        //
        //     { success =>    true,
        //       message =>   "",
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->accountGetWithdrawalhistory (array_merge($request, $params));
        //
        //     {
        //         "success" : true,
        //         "message" : "",
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        try {
            ...
            $request = array();
            $request[$orderIdField] = $id;
            $response = yield $this->accountGetOrder (array_merge($request, $params));
        } catch (Exception $e) {
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        $orders = yield $this->fetch_closed_orders($symbol, $since, $limit, $params);
    ...
    public function fetch_closed_orders_v2($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array();
        $market = null;
        ...
        $response = yield $this->accountGetOrderhistory (array_merge($request, $params));
        $result = $this->safe_value($response, 'result', array());
        $orders = $this->parse_orders($result, $market, $since, $limit);
        if ($symbol !== null) {
            return $this->filter_by_symbol($orders, $symbol);
    ...
    public function fetch_closed_orders_v3($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array();
        if ($limit !== null) {
        ...
        $response = yield $this->v3GetOrdersClosed (array_merge($request, $params));
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->accountGetWithdraw (array_merge($request, $params));
        $result = $this->safe_value($response, 'result', array());
