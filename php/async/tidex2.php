...
class tidex2 extends Exchange {
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        ...
        $response = yield $this->publicGetDepthResult (array_merge($request, $params));
        //
        //     {
        //         "asks":[
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->publicGetHistoryResult (array_merge($request, $params));
        //
        //     array(
        //         {
        //             "tid":135762344,
    ...
    public function fetch_balance($params = array ()) {
        yield $this->load_markets();
        $response = yield $this->privatePostAccountBalances ($params);
        //
        //     {
        //         "success":1,
        //         "return":array(
