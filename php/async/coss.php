...
class coss extends Exchange {
    ...
    public function fetch_currencies($params = array ()) : Generator {
        yield;
        $response = yield $this->webGetCoinsGetinfoAll ($params);
        //
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->tradeGetAccountBalances ($params);
        //
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->engineGetCs (array_merge($request, $params));
        //
        //     {       tt =>   "1m",
        //         $symbol =>   "ETH_BTC",
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->engineGetDp (array_merge($request, $params));
        //
        //     { $symbol =>   "COSS_ETH",
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->exchangeGetGetmarketsummaries ($params);
        //
        //     { success =>    true,
        //       message =>   "",
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->engineGetHt (array_merge($request, $params));
        //
        //     {  $symbol =>   "COSS_ETH",
        //         $limit =>    100,
    ...
    public function fetch_closed_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_orders_by_type('Completed', $symbol, $since, $limit, $params);
    }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostOrderDetails (array_merge($request, $params));
    ...
    public function fetch_order_trades($id, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostOrderTradeDetail (array_merge($request, $params));
        //
        //     array( {         hex_id =>  null,
        //                 $symbol => "COSS_ETH",
        //               order_id => "ad6f6b47-3def-4add-a5d5-2549a9df1593",
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradePostOrderAdd (array_merge($request, $params));
        //
        //     {
        //         "order_id" => "9e5ae4dd-3369-401d-81f5-dff985e1c4ty",
        //         "account_id" => "9e5ae4dd-3369-401d-81f5-dff985e1c4a6",
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->tradeDeleteOrderCancel (array_merge($request, $params));
        //
        //     { order_symbol => "COSS_ETH",
