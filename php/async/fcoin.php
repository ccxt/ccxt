...
class fcoin extends Exchange {
    ...
    public function fetch_markets_from_open_api($params = array ()) : Generator {
        yield;
        // https://github.com/ccxt/ccxt/issues/5648
        $response = yield $this->openapiGetSymbols ($params);
        //
        //     {
        //         "status":"ok",
        //         "$data":{
    ...
    public function fetch_markets_from_api($params = array ()) : Generator {
        yield;
    ...
    public function fetch_order_book($symbol = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        if ($limit !== null) {
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $ticker = yield $this->marketGetTickerSymbol (array_merge($request, $params));
    ...
    public function fetch_trades($symbol, $since = null, $limit = 50, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetTradesSymbol (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostOrdersOrderIdSubmitCancel (array_merge($request, $params));
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->marketGetCandlesTimeframeSymbol (array_merge($request, $params));
