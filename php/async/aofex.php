...
class aofex extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $markets = yield $this->publicGetMarketSymbols ($params);
        //
        //     {
        //         errno => 0,
        //         errmsg => 'success',
        ...
        //     }
        //
        $precisions = yield $this->publicGetMarketPrecision ();
        //
        //     {
        //         errno => 0,
        //         errmsg => 'success',
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->privateGetWalletList (array_merge($request, $params));
        //
        //     {
        //         "errno" => 0,
        //         "errmsg" => "success",
    ...
    public function fetch_trading_fee($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetEntrustRate (array_merge($request, $params));
        //
        //     {
        //         "errno":0,
        //         "errmsg":"success",
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarket24kline (array_merge($request, $params));
        //
        //     {
        //         errno => 0,
        //         errmsg => "success",
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketTrade (array_merge($request, $params));
        //
        //     {
        //         errno => 0,
        //         errmsg => "success",
    ...
    public function fetch_closed_order($id, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
            'order_sn' => $id,
        );
        $response = yield $this->privateGetEntrustDetail (array_merge($request, $params));
        //
        //     {
        //         "errno" => 0,
        //         "errmsg" => "success",
    ...
    public function fetch_order_trades($id, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        $response = yield $this->fetch_closed_order($id, $symbol, $params);
        return $this->safe_value($response, 'trades', array());
    }

    public function fetch_orders_with_method($method, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_orders_with_method('privateGetEntrustCurrentList', $symbol, $since, $limit, $params);
    }

    public function fetch_closed_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_orders_with_method('privateGetEntrustHistoryList', $symbol, $since, $limit, $params);
    }
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostEntrustAdd (array_merge($request, $params));
        //
        //     {
        //         errno => 0,
        //         errmsg => 'success',
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostEntrustCancel (array_merge($request, $params));
        //
        //     {
        //         "errno" => 0,
        //         "errmsg" => "$success",
