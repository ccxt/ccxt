...
class lbank extends Exchange {
    ...
    public function fetch_order_book($symbol, $limit = 60, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $size = 60;
        if ($limit !== null) {
    ...
    public function fetch_ohlcv($symbol, $timeframe = '5m', $since = null, $limit = 1000, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        if ($since === null) {
