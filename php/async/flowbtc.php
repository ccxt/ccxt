...
class flowbtc extends Exchange {
    ...
    public function fetch_markets($params = array ()) {
        $response = yield $this->publicPostGetProductPairs ($params);
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->publicPostGetTrades (array_merge($request, $params));
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
        ...
        $response = yield $this->privatePostCreateOrder (array_merge($request, $params));
        return array(
            'info' => $response,
