...
use ccxt\async\abstract\aster as Exchange;
...
class aster extends Exchange {
    ...
    public function fetch_time($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->fapiPublicGetV1Time ($params));
            //
            //     {
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            if ($isMark) {
                ...
                $response = Async\await($this->fapiPublicGetV1MarkPriceKlines ($this->extend($request, $params)));
            } elseif ($isIndex) {
                $request['pair'] = $market['id'];
                $response = Async\await($this->fapiPublicGetV1IndexPriceKlines ($this->extend($request, $params)));
            } else {
                $request['symbol'] = $market['id'];
                if ($market['linear']) {
                    $response = Async\await($this->fapiPublicGetV1Klines ($this->extend($request, $params)));
                } else {
                    $response = Async\await($this->sapiPublicGetV1Klines ($this->extend($request, $params)));
                }
            }
            //
            //     array(
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPublicGetV1Trades ($this->extend($request, $params)));
                //
                //     array(
                //         {
                //             "id" => 3913206,
                ...
                $response = Async\await($this->sapiPublicGetV1Trades ($this->extend($request, $params)));
                //     array(
                //         {
                //             "id" => 657,
                //             "price" => "1.01000000",
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPrivateGetV1UserTrades ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPrivateGetV1UserTrades ($this->extend($request, $params)));
            }
            //
            //     array(
            //         {
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPublicGetV1Depth ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPublicGetV1Depth ($this->extend($request, $params)));
            }
            //
            //     {
    ...
    public function fetch_funding_rate_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            list($request, $params) = $this->handle_until_option('endTime', $request, $params);
            $response = Async\await($this->fapiPublicGetV1FundingRate ($this->extend($request, $params)));
            //
            //     array(
            //         {
            //             "symbol" => "BTCUSDT",
    ...
    public function fetch_ticker(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPublicGetV1Ticker24hr ($this->extend($request, $params)));
                //
                //     {
                //         "symbol" => "BTCUSDT",
                //         "priceChange" => "1845.7",
                ...
                $response = Async\await($this->sapiPublicGetV1Ticker24hr ($this->extend($request, $params)));
                //     {
                //         "symbol" => "BTCUSDT",
                //         "priceChange" => "-2274.38",
                //         "priceChangePercent" => "-2.049",
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            if ($this->is_linear($type, $subType)) {
                $response = Async\await($this->fapiPublicGetV1Ticker24hr ($params));
            } elseif ($type === 'spot') {
                $response = Async\await($this->sapiPublicGetV1Ticker24hr ($params));
            } else {
    ...
    public function fetch_funding_rate(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = Async\await($this->fapiPublicGetV1PremiumIndex ($this->extend($request, $params)));
            //
            //     {
            //         "symbol" => "BTCUSDT",
            //         "markPrice" => "106729.84047826",
    ...
    public function fetch_funding_rates(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->fapiPublicGetV1PremiumIndex ($this->extend($params)));
            //
            //     array(
            //         {
            //             "symbol" => "BTCUSDT",
    ...
    public function fetch_funding_intervals(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            $response = Async\await($this->fapiPublicGetV1FundingInfo ($params));
            //
            //     array(
            //         {
            //             "symbol" => "INJUSDT",
    ...
    public function fetch_balance($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            if ($this->is_linear($type, $subType)) {
                ...
                $response = Async\await($this->sapiPrivateGetV1Account ($params));
    ...
    public function set_margin_mode(string $marginMode, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($marginMode, $symbol, $params) {
            ...
            $response = Async\await($this->fapiPrivatePostV1MarginType ($this->extend($request, $params)));
            //
            //     {
            //         "amount" => 100.0,
            //         "code" => 200,
    ...
    public function fetch_position_mode(?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
             ...
             */
            $response = Async\await($this->fapiPrivateGetV1PositionSideDual ($params));
            //
            //     {
    ...
    public function set_position_mode(bool $hedged, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($hedged, $symbol, $params) {
            ...
            //     }
            //
            return Async\await($this->fapiPrivatePostV1PositionSideDual ($this->extend($request, $params)));
        }) ();
    }
    ...
    public function fetch_trading_fee(string $symbol, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPrivateGetV1CommissionRate ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPrivateGetV1CommissionRate ($this->extend($request, $params)));
            }
            //
            //     {
            //         "symbol" => "BTCUSDT",
    ...
    public function fetch_order(string $id, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPrivateGetV1Order ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPrivateGetV1Order ($this->extend($request, $params)));
            }
    ...
    public function fetch_open_order(string $id, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = Async\await($this->fapiPrivateGetV1OpenOrder ($this->extend($request, $params)));
            return $this->parse_order($response, $market);
        }) ();
    }
    ...
    public function fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPrivateGetV1AllOrders ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPrivateGetV1AllOrders ($this->extend($request, $params)));
            }
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = null;
            if ($this->is_linear($type, $subType)) {
                $response = Async\await($this->fapiPrivateGetV1OpenOrders ($this->extend($request, $params)));
            } elseif ($type === 'spot') {
                $response = Async\await($this->sapiPrivateGetV1OpenOrders ($this->extend($request, $params)));
            } else {
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array ()) {
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            if ($market['swap']) {
                if ($test) {
                    $response = Async\await($this->fapiPrivatePostV1OrderTest ($request));
                } else {
                    $response = Async\await($this->fapiPrivatePostV1Order ($request));
                }
            } else {
                $response = Async\await($this->sapiPrivatePostV1Order ($request));
            }
            return $this->parse_order($response, $market);
        }) ();
    }
    ...
    public function create_orders(array $orders, $params = array ()) {
        return Async\async(function () use ($orders, $params) {
            ...
            $response = Async\await($this->fapiPrivatePostV1BatchOrders ($this->extend($request, $params)));
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($symbol, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPrivateDeleteV1AllOpenOrders ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPrivateDeleteV1AllOpenOrders ($this->extend($request, $params)));
            }
            //
            //     {
            //         "code" => "200",
    ...
    public function cancel_order(string $id, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            $response = null;
            if ($market['swap']) {
                $response = Async\await($this->fapiPrivateDeleteV1Order ($this->extend($request, $params)));
            } else {
                $response = Async\await($this->sapiPrivateDeleteV1Order ($this->extend($request, $params)));
            }
            return $this->parse_order($response, $market);
        }) ();
    }
    ...
    public function cancel_orders(array $ids, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($ids, $symbol, $params) {
            ...
            $response = Async\await($this->fapiPrivateDeleteV1BatchOrders ($this->extend($request, $params)));
            //
            //    array(
            //        array(
    ...
    public function set_leverage(int $leverage, ?string $symbol = null, $params = array ()) {
        return Async\async(function () use ($leverage, $symbol, $params) {
            ...
            $response = Async\await($this->fapiPrivatePostV1Leverage ($this->extend($request, $params)));
            //
            //     {
            //         "leverage" => 21,
    ...
    public function fetch_leverages(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
             ...
             */
            Async\await($this->load_markets());
            $response = Async\await($this->fapiPrivateGetV2PositionRisk ($params));
            //
            //     array(
            //         {
            //             "symbol" => "INJUSDT",
    ...
    public function fetch_margin_adjustment_history(?string $symbol = null, ?string $type = null, ?float $since = null, ?float $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $type, $since, $limit, $params) {
            ...
            $response = Async\await($this->fapiPrivateGetV1PositionMarginHistory ($this->extend($request, $params)));
            //
            //     array(
            //         {
            //             "amount" => "23.36332311",
    ...
    public function modify_margin_helper(string $symbol, $amount, $addOrReduce, $params = array ()) {
        return Async\async(function () use ($symbol, $amount, $addOrReduce, $params) {
            ...
            $code = $market['quote'];
            $response = Async\await($this->fapiPrivatePostV1PositionMargin ($this->extend($request, $params)));
            //
            //     {
            //         "amount" => 100.0,
            //         "code" => 200,
    ...
    public function fetch_funding_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            $response = Async\await($this->fapiPrivateGetV1Income ($this->extend($request, $params)));
    ...
    public function fetch_positions_risk(?array $symbols = null, $params = array ()) {
        return Async\async(function () use ($symbols, $params) {
            ...
            $request = array();
            $response = Async\await($this->fapiPrivateGetV2PositionRisk ($this->extend($request, $params)));
            //
            //     array(
            //         {
            //             "entryPrice" => "6563.66500",
    ...
    public function load_leverage_brackets($reload = false, $params = array ()) {
        return Async\async(function () use ($reload, $params) {
            ...
            if (($leverageBrackets === null) || ($reload)) {
                $response = Async\await($this->fapiPrivateGetV1LeverageBracket ($params));
    ...
    public function withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $amount, $address, $tag, $params) {
            ...
            $response = Async\await($this->sapiPrivatePostV1AsterUserWithdraw ($this->extend($request, $params)));
            return array(
                'info' => $response,
    ...
    public function transfer(string $code, float $amount, string $fromAccount, string $toAccount, $params = array ()): PromiseInterface {
        return Async\async(function () use ($code, $amount, $fromAccount, $toAccount, $params) {
            ...
            if ($type !== null) {
                ...
                $response = Async\await($this->fapiPrivatePostV1AssetWalletTransfer ($this->extend($request, $params)));
            } else {
                // transfer asset to other address
                $request['toAddress'] = $toAccount;
                $response = Async\await($this->sapiPrivatePostV1AssetSendToAddress ($this->extend($request, $params)));
            }
            //
            //     {
            //         "tranId":13526853623,
