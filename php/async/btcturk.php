...
class btcturk extends Exchange {
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $tickers = yield $this->publicGetTicker ($params);
        $result = array();
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        yield $this->load_markets();
        $market = $this->market($symbol);
        $tickers = yield $this->fetch_tickers($params);
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1d', $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array();
        ...
        $response = yield $this->publicGetOhlcdata (array_merge($request, $params));
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostExchange (array_merge($request, $params));
