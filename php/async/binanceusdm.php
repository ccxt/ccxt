...
class binanceusdm extends binance {
    ...
    public function fetch_funding_rates($symbols = null, $params = array ()) {
        yield $this->load_markets();
        $response = yield $this->fapiPublicGetPremiumIndex ($params);
        $result = array();
    ...
    public function fetch_positions($symbols = null, $params = array ()) {
        ...
        $account = yield $this->fapiPrivateGetAccount ($params);
    ...
    public function fetch_isolated_positions($symbol = null, $params = array ()) {
        ...
        $response = yield $this->fapiPrivateGetPositionRisk (array_merge($request, $params));
        if ($symbol === null) {
            $result = array();
            for ($i = 0; $i < count($response); $i++) {
    ...
    public function fetch_funding_history($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->fapiPrivateGetIncome (array_merge($request, $params));
    ...
    public function set_margin_mode($symbol, $marginType, $params = array ()) {
        ...
        return yield $this->fapiPrivatePostMarginType (array_merge($request, $params));
    }
}
