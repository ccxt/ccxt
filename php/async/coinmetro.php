...
class coinmetro extends Exchange {
    ...
    public function describe() {
        return $this->deep_extend(parent::describe(), array(
            'id' => 'coinmetro',
            'name' => 'Coinmetro',
            'countries' => array( 'EE' ), // Republic of Estonia todo => check
            ...
            'exceptions' => array(
                ...
                'exact' => array(
                    ...
                    // todo => add this one - 422 Unprocessable Entity array("message":"Invalid 'from'")
                ...
                'broad' => array(
                    ...
                    'available to allocate' => '\\ccxt\\InsufficientFunds', // todo => check 403 Forbidden array("message":"Insufficient EUR available to allocate")
                    ...
                    'Insufficient liquidity' => '\\ccxt\\InvalidOrder', // todo => check 503 Service Unavailable array("message":"Insufficient liquidity to fill the FOK order completely.")
                    ...
                    'Not enough margin' => '\\ccxt\\InsufficientFunds', // todo => check 422 Unprocessable Entity array("message":"Not enough margin!")
                    'orderType missing' => '\\ccxt\\BadRequest', // 422 Unprocessable Entity array("message":"orderType missing!")
                    'Server Timeout' => '\\ccxt\\ExchangeError', // todo => check 503 Service Unavailable array("message":"Server Timeout!")
    ...
    public function parse_ohlcv($ohlcv, ?array $market = null): array {
        return array(
            $this->safe_number($ohlcv, 'timestamp'),
    ...
    public function fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $since, $limit, $params) {
            ...
            return $this->parse_trades($tickHistory, $market, $since, $limit);  // todo = 0
        }) ();
    }
    ...
    public function parse_trade($trade, ?array $market = null): array {
        ...
        $id = $this->safe_string_n($trade, array( '_id', 'seqNum', 'seqNumber' )); // todo => check
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $orderbook['nonce'] = $this->safe_integer($book, 'checksum'); // todo => check
            return $orderbook;
        }) ();
    }
    ...
    public function parse_ticker($ticker, ?array $market = null): array {
        ...
        $close = $this->safe_string($ticker, 'price'); // todo => check the GUI shows it last price
    ...
    public function fetch_ledger(?string $code = null, ?int $since = null, ?int $limit = null, $params = array ()) {
        return Async\async(function () use ($code, $since, $limit, $params) {
            ...
            return $this->parse_ledger($ledger, $currency, $since, $limit); // todo = 0
        }) ();
    }
        ...
        return Async\async(function () use ($symbol, $type, $side, $amount, $price, $params) {
            ...
            if ($type === 'limit') {
                if (($price === null) && ($cost === null)) {
                    ...
                    $costString = (string) Precise::string_mul($price, (string) $precisedAmount);
            ...
            if ($side === 'sell') {
                $this->handle_create_order_side($market['baseId'], $market['quoteId'], $precisedAmount, $precisedCost, $request);
            } elseif ($side === 'buy') {
                $this->handle_create_order_side($market['quoteId'], $market['baseId'], $precisedCost, $precisedAmount, $request);
            }
            ...
            $expirationTime = $this->safe_integer($params, 'expirationTime');
            ...
            $margin = $this->safe_value($params, 'margin');
            $params = $this->omit($params, 'margin'); // if $request has property 'margin' with any value, the exchange counts the order
            if ($margin === true) {
                $request['margin'] = true;
            }
            ...
            if ($comment !== null) {
                $params = $this->omit($params, array( 'clientOrderId', 'comment' ));
    ...
    public function parse_order($order, ?array $market = null): array {
        ...
        if ($isCanceled === true) {
            if ($timestamp === null) {
                $timestamp = $this->safe_integer($order, 'completionTime'); // todo => check - $market orders with bad $price gain IOC - should we mark them as 'rejected'?
