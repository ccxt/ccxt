...
class bitso extends Exchange {
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = 25, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = 25, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        // the don't support fetching trades starting from a date yet
