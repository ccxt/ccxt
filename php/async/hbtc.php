...
class hbtc extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetBrokerInfo ($params);
        //
        //     {
        //         "timezone":"UTC",
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->quoteGetDepth (array_merge($request, $params));
        //
        //     {
        //         "time":1588068913453,
        //         "bids":[
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->quoteGetTicker24hr (array_merge($request, $params));
        //
        //     {
        //         "time":1588069860794,
        //         "$symbol":"BNB0501PS16",
    ...
    public function fetch_bid_ask($symbol, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
        ...
        $response = yield $this->quoteGetTickerBookTicker (array_merge($request, $params));
        //
        //     {
        //         "$symbol" => "LTCBTC",
        //         "bidPrice" => "4.00000000",
    ...
    public function fetch_bids_asks($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->quoteGetTickerBookTicker ($params);
        //
        //     array(
        //         array(
        //             "symbol" => "LTCBTC",
    ...
    public function fetch_trades($symbol, $since = null, $limit = 50, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
        ...
        $response = yield $this->quoteGetTrades (array_merge($request, $params));
        //
        //     array(
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->quoteGetKlines (array_merge($request, $params));
        //
        //     [
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetDepositOrders (array_merge($request, $params));
        //
        //     array(
        //         array(
        //             'time' => '1565769575929',
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetWithdrawalOrders (array_merge($request, $params));
        //
        //     array(
        //         {
        //             "time":"1536232111669",
    ...
    public function fetch_accounts($params = array ()) : Generator {
        yield;
        $response = yield $this->privatePostSubAccountQuery ($params);
        //
        //     array(
        //         array(
    ...
    public function fetch_ledger($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetBalanceFlow (array_merge($request, $params));
        //
        //     array(
        //         array(
