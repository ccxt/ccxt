...
class alpaca extends Exchange {
    ...
    private function do_fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($method === 'marketPublicGetV1beta3CryptoLocTrades') {
            ...
            $response = Async\await($this->marketPublicGetV1beta3CryptoLocTrades($this->extend($request, $paramsOmitted)));
            //
            //    {
            ...
            $response = Async\await($this->marketPublicGetV1beta3CryptoLocLatestTrades($this->extend($request, $paramsOmitted)));
            //
            //    {
            //       "trades": {
            //            "BTC/USD": {
    ...
    private function do_fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($method === 'marketPublicGetV1beta3CryptoLocBars') {
            ...
            $response = Async\await($this->marketPublicGetV1beta3CryptoLocBars($this->extend($request, $query)));
            //
            //    {
            //        "bars": {
            //           "BTC/USD": [
            ...
            $response = Async\await($this->marketPublicGetV1beta3CryptoLocLatestBars($this->extend($request, $query)));
            //
            //    {
            //        "bars": {
            //           "BTC/USD": {
    ...
    private function do_fetch_tickers(?array $symbols = null, $params = array()) {
        ...
        $response = Async\await($this->marketPublicGetV1beta3CryptoLocSnapshots($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "snapshots": {
        //             "BTC/USD": {
    ...
    private function do_create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        ...
        $order = Async\await($this->traderPrivatePostV2Orders($this->extend($request, $this->omit($paramsOmitted, array( 'clientOrderId' )))));
        //
        //   {
    ...
    private function do_fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $response = Async\await($this->traderPrivateGetV2Orders($this->extend($request, $paramsOmitted)));
        //
        //     [
        //         {
    ...
    private function do_edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array()) {
        ...
        $response = Async\await($this->traderPrivatePatchV2OrdersOrderId($this->extend($request, $this->omit($paramsTimeInForce, array( 'clientOrderId' )))));
    ...
    private function do_fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $response = Async\await($this->traderPrivateGetV2AccountActivitiesActivityType($this->extend($requestUntil, $paramsUntil)));
        //
        //     [
        //         {
    ...
    private function do_withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array()) {
        ...
        $response = Async\await($this->traderPrivatePostV2WalletsTransfers($this->extend($request, $paramsWithdrawTag)));
        //
        //     {
