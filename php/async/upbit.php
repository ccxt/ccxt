...
class upbit extends Exchange {
    ...
    public function fetch_currency($code, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_currency_by_id($id, $params = array ()) : Generator {
        yield;
        // this method is for retrieving funding fees and limits per currency
        // it requires private access and API keys properly set up
        $request = array(
    ...
    public function fetch_market($symbol, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_market_by_id($id, $params = array ()) : Generator {
        yield;
        // this method is for retrieving trading fees and limits per market
        // it requires private access and API keys properly set up
        $request = array(
    ...
    public function fetch_orders_by_state($state, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
    ...
    public function fetch_canceled_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_deposit_addresses($codes = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function create_deposit_address($code, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $currency = $this->currency($code);
        $request = array(
