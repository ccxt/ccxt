...
class latoken extends Exchange {
    ...
    public function fetch_time($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetExchangeInfoTime ($params);
        //
        //     {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetExchangeInfoPairs ($params);
        //
        //     array(
        //         {
        //             "pairId" => 502,
    ...
    public function fetch_currencies($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetExchangeInfoCurrencies ($params);
        //
        //     array(
        //         {
        //             "currencyId" => 102,
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketDataOrderBookSymbolLimit (array_merge($request, $params));
        //
        //     {
        //         "pairId" => 502,
        //         "$symbol" => "LAETH",
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketDataTickerSymbol (array_merge($request, $params));
        //
        //     {
        //         "pairId" => 502,
        //         "$symbol" => "LAETH",
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->publicGetMarketDataTickers ($params);
        //
        //     array(
        //         {
        //             "pairId" => 502,
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketDataTradesSymbol (array_merge($request, $params));
        //
        //     {
        //         "pairId":370,
        //         "$symbol":"ETHBTC",
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrderTrades (array_merge($request, $params));
        //
        //     {
        //         "pairId" => 502,
        //         "$symbol" => "LAETH",
    ...
    public function fetch_orders_by_status($status, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        $request = array(
            'status' => $status,
        );
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrderGetOrder (array_merge($request, $params));
        //
        //     {
        //         "orderId" => "1555492358.126073.126767@0502:2",
        //         "cliOrdId" => "myNewOrder",
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostOrderCancelAll (array_merge($request, $params));
        //
        //     {
        //         "pairId" => 502,
        //         "$symbol" => "LAETH",
