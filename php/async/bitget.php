...
class bitget extends Exchange {
    ...
    private function do_fetch_markets($params = array()) {
        ...
        if ($uta === true) {
            return Async\await($this->fetch_uta_markets($paramsUTA));
        }
        return Async\await($this->fetch_default_markets($paramsUTA));
    }

    public function fetch_default_markets(mixed $params): PromiseInterface {
        return Async\async(self::do_fetch_default_markets(...))($params);
    }

    private function do_fetch_default_markets(mixed $params) {
        $types = null;
    ...
    public function fetch_uta_markets(mixed $params): PromiseInterface {
        return Async\async(self::do_fetch_uta_markets(...))($params);
    }

    private function do_fetch_uta_markets(mixed $params) {
    ...
    private function do_fetch_market_leverage_tiers(string $symbol, $params = array()) {
        ...
        list($uta, $paramsMarginMode) = Async\await($this->handle_uta_and_params($paramsMarginMode, 'fetchMarketLeverageTiers', false));
        if ($uta === true) {
            if ($productType === 'SPOT') {
                if ($marginMode !== null) {
                    $productType = 'MARGIN';
            ...
            $response = Async\await($this->publicUtaGetV3MarketPositionTier($this->extend($request, $paramsMarginMode)));
        } elseif (($market['swap'] === true) || ($market['future'] === true)) {
            $request['productType'] = $productType;
            $request['symbol'] = $market['id'];
            $response = Async\await($this->publicMixGetV2MixMarketQueryPositionLever($this->extend($request, $paramsMarginMode)));
        } elseif ($marginMode === 'isolated') {
            $request['symbol'] = $market['id'];
            $response = Async\await($this->privateMarginGetV2MarginIsolatedTierData($this->extend($request, $paramsMarginMode)));
    ...
    private function do_fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            if ($uta === true) {
                return Async\await($this->fetch_paginated_call_cursor('fetchDeposits', null, $since, $limit, $paramsPaginate, 'orderId', 'cursor', null, 100));
            }
            return Async\await($this->fetch_paginated_call_cursor('fetchDeposits', null, $since, $limit, $paramsPaginate, 'idLessThan', 'idLessThan', null, 100));
        }
        ...
        $response = null;
        if ($uta === true) {
            $response = Async\await($this->privateUtaGetV3AccountDepositRecords($this->extend($requestUntil, $paramsUntil)));
        } else {
            $response = Async\await($this->privateSpotGetV2SpotWalletDepositRecords($this->extend($requestUntil, $paramsUntil)));
        }
        //
        //     {
        //         "code": "00000",
    ...
    private function do_withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array()) {
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsNetworkCode, 'withdraw', false));
        $currency = $this->currency($code);
        ...
        $response = null;
        if ($uta === true) {
            $response = Async\await($this->privateUtaPostV3AccountWithdrawal($this->extend($request, $paramsUTA)));
        } else {
            $response = Async\await($this->privateSpotPostV2SpotWalletWithdrawal($this->extend($request, $paramsUTA)));
        }
        //
        //     {
        //          "code":"00000",
    ...
    private function do_fetch_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            if ($uta === true) {
                return Async\await($this->fetch_paginated_call_cursor('fetchWithdrawals', null, $since, $limit, $paramsPaginate, 'orderId', 'cursor', null, 100));
            }
            return Async\await($this->fetch_paginated_call_cursor('fetchWithdrawals', null, $since, $limit, $paramsPaginate, 'idLessThan', 'idLessThan', null, 100));
        }
        $currency = null;
        if ($code !== null) {
            $currency = $this->currency($code);
        ...
        $response = null;
        if ($uta === true) {
            $response = Async\await($this->privateUtaGetV3AccountWithdrawalRecords($this->extend($requestUntil, $paramsUntil)));
        } else {
            $response = Async\await($this->privateSpotGetV2SpotWalletWithdrawalRecords($this->extend($requestUntil, $paramsUntil)));
        }
        //
        //     {
        //         "code": "00000",
    ...
    private function do_fetch_deposit_address(string $code, $params = array()) {
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'fetchDepositAddress', false));
        ...
        $response = null;
        if ($uta === true) {
            $response = Async\await($this->privateUtaGetV3AccountDepositAddress($this->extend($request, $paramsNetworkCode)));
        } else {
            $response = Async\await($this->privateSpotGetV2SpotWalletDepositAddress($this->extend($request, $paramsNetworkCode)));
        }
        //
        //     {
        //         "code": "00000",
    ...
    private function do_fetch_order_book(string $symbol, ?int $limit = null, $params = array()) {
        ...
        $response = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchOrderBook', false));
        if ($uta === true) {
            $request['category'] = $productType;
            $response = Async\await($this->publicUtaGetV3MarketOrderbook($this->extend($request, $paramsUTA)));
        } elseif ($market['spot'] === true) {
            $response = Async\await($this->publicSpotGetV2SpotMarketOrderbook($this->extend($request, $paramsUTA)));
        } else {
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketMergeDepth($this->extend($request, $paramsUTA)));
        }
        //
        //     {
        //       "code": "00000",
    ...
    private function do_fetch_ticker(string $symbol, $params = array()) {
        ...
        list($productType, $paramsProductType) = $this->handle_product_type_and_params($market, $params);
        $response = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchTicker', false));
        if ($uta === true) {
            $request['category'] = $productType;
            $response = Async\await($this->publicUtaGetV3MarketTickers($this->extend($request, $paramsUTA)));
        } elseif ($market['spot'] === true) {
            $response = Async\await($this->publicSpotGetV2SpotMarketTickers($this->extend($request, $paramsUTA)));
        } else {
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketTicker($this->extend($request, $paramsUTA)));
        }
        //
        // spot
        //
    ...
    private function do_fetch_mark_price(string $symbol, $params = array()) {
        ...
        if ($market['spot'] === true) {
            ...
            list($productType, $paramsProductType) = $this->handle_product_type_and_params($market, $params);
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketSymbolPrice($this->extend($request, $paramsProductType)));
        }
        $data = $this->safe_list($response, 'data', array());
        return $this->parse_ticker($data[0], $market);
    }
    ...
    private function do_fetch_tickers(?array $symbols = null, $params = array()) {
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchTickers', false));
        if ($uta === true) {
            if ($symbols !== null) {
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketTickers($this->extend($request, $paramsUTA)));
        }
        //
        // spot
        //
    ...
    private function do_fetch_trades(string $symbol, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchTrades', $symbol, $since, $limit, $paramsPaginate, 'idLessThan', 'idLessThan'));
        }
        $market = $this->market($symbol);
        $request = array(
            'symbol' => $market['id'],
        ...
        $uta = null;
        list($uta, $paramsPaginate) = Async\await($this->handle_uta_and_params($paramsPaginate, 'fetchTrades', false));
        if ($limit !== null) {
            if ($uta === true) {
        ...
        if ($uta === true) {
            ...
            $request['category'] = $productType;
            $response = Async\await($this->publicUtaGetV3MarketFills($this->extend($request, $paramsPaginate)));
        } elseif ($market['spot'] === true) {
            ...
            if ($spotMethod === 'publicSpotGetV2SpotMarketFillsHistory') {
                ...
                $response = Async\await($this->publicSpotGetV2SpotMarketFillsHistory($this->extend($request, $paramsPaginate)));
            } elseif ($spotMethod === 'publicSpotGetV2SpotMarketFills') {
                $response = Async\await($this->publicSpotGetV2SpotMarketFills($this->extend($request, $paramsPaginate)));
            }
        } else {
            ...
            if ($swapMethod === 'publicMixGetV2MixMarketFillsHistory') {
                ...
                $response = Async\await($this->publicMixGetV2MixMarketFillsHistory($this->extend($request, $paramsPaginate)));
            } elseif ($swapMethod === 'publicMixGetV2MixMarketFills') {
                $response = Async\await($this->publicMixGetV2MixMarketFills($this->extend($request, $paramsPaginate)));
            }
        }
        //
        // spot
    ...
    private function do_fetch_trading_fee(string $symbol, $params = array()) {
        ...
        $uta = null;
        $paramsUTA = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'fetchTradingFee', false));
        if ($uta === true) {
            $productType = null;
            list($productType, $paramsUTA) = $this->handle_product_type_and_params($market, $paramsUTA);
            $request['category'] = $productType;
            $utaResponse = Async\await($this->privateUtaGetV3AccountFeeRate($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
        ...
        $response = Async\await($this->privateCommonGetV2CommonTradeRate($this->extend($request, $paramsUTA)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_fetch_trading_fees($params = array()) {
        ...
        $uta = null;
        list($uta, $paramsMarginMode) = Async\await($this->handle_uta_and_params($paramsMarginMode, 'fetchTradingFees', false));
        if ($uta === true) {
            ...
            $utaResponse = Async\await($this->privateUtaGetV3AccountAllFeeRate($this->extend($request, $paramsMarginMode)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
        ...
        if ($marketType === 'spot') {
            ...
            if (($marginMode !== null) || ($margin === true)) {
                $response = Async\await($this->publicMarginGetV2MarginCurrencies($paramsMarginMode));
            } else {
                $response = Async\await($this->publicSpotGetV2SpotPublicSymbols($paramsMarginMode));
            }
        } elseif (($marketType === 'swap') || ($marketType === 'future')) {
            $productType = null;
            ...
            $response = Async\await($this->publicMixGetV2MixMarketContracts($paramsMarginMode));
        } else {
            throw new NotSupported($this->id . ' does not support ' . $marketType . ' market');
        }
        //
    ...
    private function do_fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            ...
            return Async\await($this->fetch_paginated_call_deterministic('fetchOHLCV', $symbol, $since, $limit, $timeframe, $paramsPaginate, $limitForPagination));
        }
        $market = $this->market($symbol);
        $request = array(
            'symbol' => $market['id'],
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsPaginate, 'fetchOHLCV', false));
        if ($uta === true) {
        ...
        if ($uta === true) {
            ...
            $request['category'] = $productType;
            $response = Async\await($this->publicUtaGetV3MarketCandles($this->extend($request, $paramsProductType)));
        } elseif ($market['spot'] === true) {
            // checks if we need history endpoint
            if ($historicalEndpointNeeded) {
                $response = Async\await($this->publicSpotGetV2SpotMarketHistoryCandles($this->extend($request, $paramsProductType)));
            } else {
                if (!$limitDefined) {
                    $request['limit'] = 1000;
                    $limitResolved = 1000;
                }
                $response = Async\await($this->publicSpotGetV2SpotMarketCandles($this->extend($request, $paramsProductType)));
            }
        } else {
            $request['productType'] = $productType;
            ...
            if (!$historicalEndpointNeeded && ($priceType === 'mark' || $priceType === 'index')) {
                ...
                $response = Async\await($this->publicMixGetV2MixMarketCandles($this->extend(array( 'kLineType' => $priceType ), $extended)));
    ...
    private function do_fetch_balance($params = array()) {
        ...
        $uta = null;
        $paramsUTA = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'fetchBalance', false));
        ...
        if ($uta === true) {
            ...
            if ($marketType === 'funding') {
                $response = Async\await($this->privateUtaGetV3AccountFundingAssets($this->extend($request, $paramsUTA)));
                $assets = $this->safe_list($response, 'data', array());
            } else {
                $response = Async\await($this->privateUtaGetV3AccountAssets($this->extend($request, $paramsUTA)));
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixGetV2MixAccountAccounts($this->extend($request, $paramsUTA)));
        } elseif ($marginMode === 'isolated') {
            $response = Async\await($this->privateMarginGetV2MarginIsolatedAccountAssets($this->extend($request, $paramsUTA)));
            //
            //    {
            //        "code": "00000",
            //        "msg": "success",
            ...
            $response = Async\await($this->privateMarginGetV2MarginCrossedAccountAssets($this->extend($request, $paramsUTA)));
            //
            //    {
            //        "code": "00000",
            //        "msg": "success",
            ...
            $response = Async\await($this->privateSpotGetV2SpotAccountAssets($this->extend($request, $paramsUTA)));
        } else {
    ...
    private function do_create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        ...
        $response = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'createOrder', false));
        if ($uta === true) {
            $request = $this->create_uta_order_request($symbol, $type, $side, $amount, $price, $paramsUTA);
            if ($isStopLossOrTakeProfitTrigger) {
                $response = Async\await($this->privateUtaPostV3TradePlaceStrategyOrder($request));
            } else {
                $response = Async\await($this->privateUtaPostV3TradePlaceOrder($request));
            }
        } else {
    ...
    private function do_create_uta_orders(array $orders, $params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        ...
        $market = $this->market($symbol);
        $response = Async\await($this->privateUtaPostV3TradePlaceBatch($ordersRequests));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_create_orders(array $orders, $params = array()) {
        ...
        $uta = null;
        $paramsUTA = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'createOrders', false));
        if ($uta === true) {
            return Async\await($this->create_uta_orders($orders, $paramsUTA));
        }
        $ordersRequests = array();
        $symbol = null;
        $marginMode = null;
    ...
    private function do_edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array()) {
        ...
        list($uta, $paramsOmitted) = Async\await($this->handle_uta_and_params($paramsOmitted, 'editOrder', false));
        if ($uta === true) {
            if ($amount !== null) {
            ...
            if ($isStopLossOrder || $isTakeProfitOrder) {
                ...
                $response = Async\await($this->privateUtaPostV3TradeModifyStrategyOrder($this->extend($request, $paramsOmitted)));
            } else {
                if ($price !== null) {
                    $request['price'] = $this->price_to_precision($symbol, $price);
                }
                $response = Async\await($this->privateUtaPostV3TradeModifyOrder($this->extend($request, $paramsOmitted)));
            }
        } elseif ($market['spot'] === true) {
            ...
            if ($triggerPrice !== null) {
                $response = Async\await($this->privateSpotPostV2SpotTradeModifyPlanOrder($this->extend($request, $paramsOmitted)));
            } else {
                $request['symbol'] = $market['id'];
                $response = Async\await($this->privateSpotPostV2SpotTradeCancelReplaceOrder($this->extend($request, $paramsOmitted)));
            }
        } else {
            if (($market['swap'] !== true) && ($market['future'] !== true)) {
            ...
            if ($isTrailingPercentOrder) {
                ...
                $response = Async\await($this->privateMixPostV2MixOrderModifyPlanOrder($this->extend($request, $paramsOmitted)));
                ...
                $response = Async\await($this->privateMixPostV2MixOrderModifyTpslOrder($this->extend($request, $paramsOmitted)));
            } elseif ($isTriggerOrder) {
                ...
                $response = Async\await($this->privateMixPostV2MixOrderModifyOrder($this->extend($request, $paramsOmitted)));
            }
        }
        //
        //     {
    ...
    private function do_cancel_order(string $id, ?string $symbol = null, $params = array()) {
        ...
        $uta = null;
        list($uta, $paramsMarginMode) = Async\await($this->handle_uta_and_params($paramsMarginMode, 'cancelOrder', false));
        ...
        if ($uta === true) {
            if ($trigger === true) {
                $response = Async\await($this->privateUtaPostV3TradeCancelStrategyOrder($this->extend($request, $paramsMarginMode)));
            } else {
                $response = Async\await($this->privateUtaPostV3TradeCancelOrder($this->extend($request, $paramsMarginMode)));
            }
        } elseif (($market['swap'] === true) || ($market['future'] === true)) {
            $productType = null;
            list($productType, $paramsMarginMode) = $this->handle_product_type_and_params($market, $paramsMarginMode);
            ...
            if ($trailing === true) {
                ...
                $request['planType'] = $planType;
                $response = Async\await($this->privateMixPostV2MixOrderCancelPlanOrder($this->extend($request, $paramsMarginMode)));
            } elseif ($trigger === true) {
                $response = Async\await($this->privateMixPostV2MixOrderCancelPlanOrder($this->extend($request, $paramsMarginMode)));
            } else {
                $response = Async\await($this->privateMixPostV2MixOrderCancelOrder($this->extend($request, $paramsMarginMode)));
            }
        } elseif ($market['spot'] === true) {
            if ($marginMode !== null) {
                if ($marginMode === 'isolated') {
                    $response = Async\await($this->privateMarginPostV2MarginIsolatedCancelOrder($this->extend($request, $paramsMarginMode)));
                } elseif ($marginMode === 'cross') {
                    $response = Async\await($this->privateMarginPostV2MarginCrossedCancelOrder($this->extend($request, $paramsMarginMode)));
                }
            } else {
                if ($trigger === true) {
                    $response = Async\await($this->privateSpotPostV2SpotTradeCancelPlanOrder($this->extend($request, $paramsMarginMode)));
                } else {
                    $response = Async\await($this->privateSpotPostV2SpotTradeCancelOrder($this->extend($request, $paramsMarginMode)));
                }
            }
        } else {
    ...
    private function do_cancel_uta_orders(array $ids, ?string $symbol = null, $params = array()) {
        ...
        $response = Async\await($this->privateUtaPostV3TradeCancelBatch($requestList));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_cancel_orders(array $ids, ?string $symbol = null, $params = array()) {
        ...
        $uta = null;
        $paramsUTA = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'cancelOrders', false));
        if ($uta === true) {
            return Async\await($this->cancel_uta_orders($ids, $symbol, $paramsUTA));
        }
        $marginMode = null;
        ...
        if ($market['spot'] === true) {
            if ($marginMode !== null) {
                if ($marginMode === 'cross') {
                    $response = Async\await($this->privateMarginPostV2MarginCrossedBatchCancelOrder($this->extend($request, $paramsUTA)));
                } else {
                    $response = Async\await($this->privateMarginPostV2MarginIsolatedBatchCancelOrder($this->extend($request, $paramsUTA)));
                }
            } else {
                $response = Async\await($this->privateSpotPostV2SpotTradeBatchCancelOrder($this->extend($request, $paramsUTA)));
            }
        } else {
            $productType = null;
            list($productType, $paramsUTA) = $this->handle_product_type_and_params($market, $paramsUTA);
            $request['productType'] = $productType;
            if ($trigger === true) {
                $response = Async\await($this->privateMixPostV2MixOrderCancelPlanOrder($this->extend($request, $paramsUTA)));
            } else {
                $response = Async\await($this->privateMixPostV2MixOrderBatchCancelOrders($this->extend($request, $paramsUTA)));
            }
        }
        //
        //     {
    ...
    private function do_cancel_all_orders(?string $symbol = null, $params = array()) {
        ...
        $response = null;
        $uta = null;
        list($uta, $paramsMarginMode) = Async\await($this->handle_uta_and_params($paramsMarginMode, 'cancelAllOrders', false));
        if ($uta === true) {
            if ($productType === 'SPOT') {
                if ($marginMode !== null) {
                    $productType = 'MARGIN';
            ...
            $request['category'] = $productType;
            $response = Async\await($this->privateUtaPostV3TradeCancelSymbolOrder($this->extend($request, $paramsMarginMode)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            if ($marginMode !== null) {
                ...
                if ($trigger === true) {
                    ...
                    $response = Async\await($this->privateSpotPostV2SpotTradeBatchCancelPlanOrder($this->extend($stopRequest, $paramsMarginMode)));
                } else {
                    $response = Async\await($this->privateSpotPostV2SpotTradeCancelSymbolOrder($this->extend($request, $paramsMarginMode)));
                }
                //
                //     {
                //         "code": "00000",
            ...
            if ($trigger === true) {
                ...
                $response = Async\await($this->privateMixPostV2MixOrderBatchCancelOrders($this->extend($request, $paramsMarginMode)));
            }
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_fetch_order(string $id, ?string $symbol = null, $params = array()) {
        ...
        $response = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsOmitted, 'fetchOrder', false));
        if ($uta === true) {
            $response = Async\await($this->privateUtaGetV3TradeOrderInfo($this->extend($request, $paramsUTA)));
        } elseif ($market['spot'] === true) {
            $response = Async\await($this->privateSpotGetV2SpotTradeOrderInfo($this->extend($request, $paramsUTA)));
        } elseif (($market['swap'] === true) || ($market['future'] === true)) {
            $request['symbol'] = $market['id'];
            list($productType, $paramsProductType) = $this->handle_product_type_and_params($market, $paramsUTA);
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixGetV2MixOrderDetail($this->extend($request, $paramsProductType)));
        } else {
    ...
    private function do_fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $uta = null;
        list($uta, $paramsMarginMode) = Async\await($this->handle_uta_and_params($paramsMarginMode, 'fetchOpenOrders', false));
        if ($symbol !== null) {
            $market = $this->market($symbol);
            $request['symbol'] = $market['id'];
        ...
        if ($paginate) {
            ...
            return Async\await($this->fetch_paginated_call_cursor('fetchOpenOrders', $symbol, $since, $limit, $paramsMarginMode, $cursorReceived, $cursorSent));
        }
        $response = null;
        $trailing = $this->safe_bool($paramsMarginMode, 'trailing');
        $trigger = $this->safe_bool_2($paramsMarginMode, 'stop', 'trigger');
        ...
        if ($uta === true) {
            ...
            $request['category'] = $productType;
            if ($trigger === true) {
                $response = Async\await($this->privateUtaGetV3TradeUnfilledStrategyOrders($this->extend($request, $paramsMarginMode)));
            } else {
                $response = Async\await($this->privateUtaGetV3TradeUnfilledOrders($this->extend($request, $paramsMarginMode)));
            }
        } elseif ($type === 'spot') {
            if ($marginMode !== null) {
                if ($since === null) {
                ...
                if ($marginMode === 'isolated') {
                    $response = Async\await($this->privateMarginGetV2MarginIsolatedOpenOrders($this->extend($request, $paramsMarginMode)));
                } elseif ($marginMode === 'cross') {
                    $response = Async\await($this->privateMarginGetV2MarginCrossedOpenOrders($this->extend($request, $paramsMarginMode)));
                }
            } else {
                if ($trigger === true) {
                    $response = Async\await($this->privateSpotGetV2SpotTradeCurrentPlanOrder($this->extend($request, $paramsMarginMode)));
                } else {
                    $response = Async\await($this->privateSpotGetV2SpotTradeUnfilledOrders($this->extend($request, $paramsMarginMode)));
                }
            }
        } else {
            $request['productType'] = $productType;
            if ($trailing === true) {
                $planType = $this->safe_string($paramsMarginMode, 'planType', 'track_plan');
                $request['planType'] = $planType;
                $response = Async\await($this->privateMixGetV2MixOrderOrdersPlanPending($this->extend($request, $paramsMarginMode)));
            } elseif ($isTrigger) {
                $planType = $this->safe_string($paramsMarginMode, 'planType', 'normal_plan');
                $request['planType'] = $planType;
                $response = Async\await($this->privateMixGetV2MixOrderOrdersPlanPending($this->extend($request, $paramsMarginMode)));
            } else {
                $response = Async\await($this->privateMixGetV2MixOrderOrdersPending($this->extend($request, $paramsMarginMode)));
            }
        }
    ...
    private function do_fetch_canceled_and_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $uta = null;
        $paramsUTA = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'fetchCanceledAndClosedOrders', false));
        if ($uta === true) {
            return Async\await($this->fetch_uta_canceled_and_closed_orders($symbol, $since, $limit, $paramsUTA));
        }
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        ...
        if ($paginate) {
            ...
            return Async\await($this->fetch_paginated_call_cursor('fetchCanceledAndClosedOrders', $symbol, $since, $limit, $paramsUTA, $cursorReceived, 'idLessThan'));
        }
        $response = null;
        ...
        if ($marketType === 'spot') {
            if ($marginMode !== null) {
                ...
                if ($marginMode === 'isolated') {
                    $response = Async\await($this->privateMarginGetV2MarginIsolatedHistoryOrders($this->extend($request, $paramsUTA)));
                } elseif ($marginMode === 'cross') {
                    $response = Async\await($this->privateMarginGetV2MarginCrossedHistoryOrders($this->extend($request, $paramsUTA)));
                }
            } elseif ($trigger === true) {
                if ($symbol === null) {
                ...
                $response = Async\await($this->privateSpotGetV2SpotTradeHistoryPlanOrder($this->extend($request, $paramsUTA)));
            } else {
                $response = Async\await($this->privateSpotGetV2SpotTradeHistoryOrders($this->extend($request, $paramsUTA)));
            }
        } else {
            $productType = null;
            list($productType, $paramsUTA) = $this->handle_product_type_and_params($market, $paramsUTA);
            ...
            if ($trailing === true) {
                ...
                $request['planType'] = $planType;
                $response = Async\await($this->privateMixGetV2MixOrderOrdersPlanHistory($this->extend($request, $paramsUTA)));
            } elseif (($trigger === true) || $planTypeDefined) {
                $planType = $this->safe_string($paramsUTA, 'planType', 'normal_plan');
                $request['planType'] = $planType;
                $response = Async\await($this->privateMixGetV2MixOrderOrdersPlanHistory($this->extend($request, $paramsUTA)));
            } else {
                $response = Async\await($this->privateMixGetV2MixOrderOrdersHistory($this->extend($request, $paramsUTA)));
            }
        }
        $sinceResolved = ($sinceDefault === null) ? $since : $sinceDefault;
        //
    ...
    private function do_fetch_uta_canceled_and_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        $market = null;
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchCanceledAndClosedOrders', $symbol, $since, $limit, $paramsProductType, 'cursor', 'cursor'));
        }
        ...
        if ($trigger === true) {
            $response = Async\await($this->privateUtaGetV3TradeHistoryStrategyOrders($this->extend($request, $paramsProductType)));
        } else {
            $response = Async\await($this->privateUtaGetV3TradeHistoryOrders($this->extend($request, $paramsProductType)));
        }
        //
        // uta
        //
    ...
    private function do_fetch_ledger(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $uta = null;
        list($uta, $paramsOmitted) = Async\await($this->handle_uta_and_params($paramsOmitted, 'fetchLedger', false));
        $paginate = false;
        ...
        if ($paginate) {
            if ($uta === true) {
                ...
                return Async\await($this->fetch_paginated_call_cursor('fetchLedger', $code, $since, $limit, $paramsOmitted, 'id', 'cursor', null, 100));
            }
            $cursorReceived = null;
            if ($marketType !== 'spot') {
                $cursorReceived = 'endId';
            ...
            return Async\await($this->fetch_paginated_call_cursor('fetchLedger', $code, $since, $limit, $paramsOmitted, $cursorReceived, 'idLessThan'));
        }
        $currency = null;
        $request = array();
        if ($code !== null) {
        ...
        if ($uta === true) {
            if ($marketType === 'funding') {
                $response = Async\await($this->privateUtaGetV3AccountFundingFinancialRecords($this->extend($request, $paramsOmitted)));
                //
                //     {
                //         "code": "00000",
                //         "msg": "success",
                ...
                $response = Async\await($this->privateUtaGetV3AccountFinancialRecords($this->extend($request, $paramsOmitted)));
                //
                //     {
                //         "code": "00000",
                //         "msg": "success",
        ...
        if ($marketType === 'spot') {
            $response = Async\await($this->privateSpotGetV2SpotAccountBills($this->extend($request, $paramsOmitted)));
        } else {
            if ($symbol !== null) {
                $request['symbol'] = $this->safe_string($market, 'id');
            }
            ...
            list($productType, $paramsOmitted) = $this->handle_product_type_and_params($market, $paramsOmitted);
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixGetV2MixAccountBill($this->extend($request, $paramsOmitted)));
        }
        //
        // spot
        //
    ...
    private function do_fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            ...
            return Async\await($this->fetch_paginated_call_cursor('fetchMyTrades', $symbol, $since, $limit, $paramsUTA, $cursorReceived, $cursorSent));
        }
        $response = null;
        if ($uta === true) {
            $response = Async\await($this->privateUtaGetV3TradeFills($this->extend($request, $paramsUTA)));
        } else {
            $request['symbol'] = $market['id'];
            if ($market['spot'] === true) {
                if ($marginMode !== null) {
                    ...
                    if ($marginMode === 'isolated') {
                        $response = Async\await($this->privateMarginGetV2MarginIsolatedFills($this->extend($request, $paramsUTA)));
                    } elseif ($marginMode === 'cross') {
                        $response = Async\await($this->privateMarginGetV2MarginCrossedFills($this->extend($request, $paramsUTA)));
                    }
                } else {
                    $response = Async\await($this->privateSpotGetV2SpotTradeFills($this->extend($request, $paramsUTA)));
                }
            } else {
                $productType = null;
                list($productType, $paramsUTA) = $this->handle_product_type_and_params($market, $paramsUTA);
                $request['productType'] = $productType;
                $response = Async\await($this->privateMixGetV2MixOrderFills($this->extend($request, $paramsUTA)));
            }
        }
        //
        // spot
    ...
    private function do_fetch_position(string $symbol, $params = array()) {
        ...
        $response = null;
        $result = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchPosition', false));
        if ($uta === true) {
            $request['category'] = $productType;
            $response = Async\await($this->privateUtaGetV3PositionCurrentPosition($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $request['marginCoin'] = $market['settleId'];
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixGetV2MixPositionSinglePosition($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_fetch_positions(?array $symbols = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchPositions', null, null, null, $paramsPaginate, 'endId', 'idLessThan'));
        }
        $method = null;
        ...
        $isHistory = false;
        $uta = null;
        list($uta, $paramsPaginate) = Async\await($this->handle_uta_and_params($paramsPaginate, 'fetchPositions', false));
        if ($uta === true) {
            $request['category'] = $productType;
            $response = Async\await($this->privateUtaGetV3PositionCurrentPosition($this->extend($request, $paramsPaginate)));
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixGetV2MixPositionAllPosition($this->extend($request, $paramsPaginate)));
        } else {
            $isHistory = true;
            if ($market !== null) {
                $request['symbol'] = $market['id'];
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixGetV2MixPositionHistoryPosition($this->extend($request, $paramsPaginate)));
        }
        //
    ...
    private function do_fetch_funding_rate_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $paramsProductType = null;
        list($productType, $paramsProductType) = $this->handle_product_type_and_params($market, $params);
        list($uta, $paramsProductType) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchFundingRateHistory', false));
        if ($uta === true) {
            if ($limit !== null) {
                $request['limit'] = $limit;
            }
            $request['category'] = $productType;
            $response = Async\await($this->publicUtaGetV3MarketHistoryFundRate($this->extend($request, $paramsProductType)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            if ($paginate) {
                return Async\await($this->fetch_paginated_call_incremental('fetchFundingRateHistory', $symbol, $since, $limit, $paramsProductType, 'pageNo', 100));
            }
            if ($limit !== null) {
                $request['pageSize'] = $limit;
            }
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketHistoryFundRate($this->extend($request, $paramsProductType)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_fetch_funding_rate(string $symbol, $params = array()) {
        ...
        $uta = null;
        $response = null;
        list($uta, $paramsProductType) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchFundingRate', false));
        if ($uta === true) {
            $response = Async\await($this->publicUtaGetV3MarketCurrentFundRate($this->extend($request, $paramsProductType)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            if ($method === 'publicMixGetV2MixMarketCurrentFundRate') {
                $response = Async\await($this->publicMixGetV2MixMarketCurrentFundRate($this->extend($request, $paramsProductType)));
                //
                //     {
                //         "code": "00000",
                //         "msg": "success",
                ...
                $response = Async\await($this->publicMixGetV2MixMarketFundingTime($this->extend($request, $paramsProductType)));
                //
                //     {
                //         "code": "00000",
                //         "msg": "success",
    ...
    private function do_fetch_funding_rates(?array $symbols = null, $params = array()) {
        ...
        if ($methodOption === 'publicMixGetV2MixMarketTickers') {
            ...
            //     ]
            // }
            $response = Async\await($this->publicMixGetV2MixMarketTickers($this->extend($request, $paramsMethod)));
            ...
            //     }
            //
            $response = Async\await($this->publicMixGetV2MixMarketCurrentFundRate($this->extend($request, $paramsMethod)));
        }
        $symbolsNormalized = $this->market_symbols($symbols);
        $data = $this->safe_list($response, 'data', array());
    ...
    private function do_fetch_funding_intervals(?array $symbols = null, $params = array()) {
        ...
        return Async\await($this->fetch_funding_rates($symbols, $paramsExtended));
    }
    ...
    private function do_fetch_funding_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            if ($uta === true) {
                return Async\await($this->fetch_paginated_call_cursor('fetchFundingHistory', $symbol, $since, $limit, $paramsPaginate, 'cursor', 'cursor'));
            }
            return Async\await($this->fetch_paginated_call_cursor('fetchFundingHistory', $symbol, $since, $limit, $paramsPaginate, 'endId', 'idLessThan'));
        }
        $market = $this->market($symbol);
        if ($market['swap'] !== true) {
        ...
        if ($uta === true) {
            ...
            $response = Async\await($this->privateUtaGetV3AccountFinancialRecords($this->extend($requestUntil, $paramsUntil)));
            //
            // {
            //     "code": "00000",
            //     "msg": "success",
            ...
            $response = Async\await($this->privateMixGetV2MixAccountBill($this->extend($requestUntil, $paramsUntil)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_modify_margin_helper(string $symbol, ?float $amount, ?string $type, $params = array()) {
        ...
        $response = Async\await($this->privateMixPostV2MixAccountSetMargin($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_fetch_leverage(string $symbol, $params = array()) {
        ...
        $response = Async\await($this->privateMixGetV2MixAccountAccount($this->extend($request, $paramsProductType)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_set_leverage(int $leverage, ?string $symbol = null, $params = array()) {
        ...
        $uta = null;
        $response = array();
        list($uta, $paramsProductType) = Async\await($this->handle_uta_and_params($paramsProductType, 'setLeverage', false));
        if ($uta === true) {
            if ($productType === 'SPOT') {
                $marginMode = null;
            ...
            $request['category'] = $productType;
            $response = Async\await($this->privateUtaPostV3AccountSetLeverage($this->extend($request, $paramsProductType)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $request['marginCoin'] = $market['settleId'];
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixPostV2MixAccountSetLeverage($this->extend($request, $paramsProductType)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_set_margin_mode(string $marginMode, ?string $symbol = null, $params = array()) {
        ...
        $response = Async\await($this->privateMixPostV2MixAccountSetMarginMode($this->extend($request, $paramsProductType)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_set_position_mode(bool $hedged, ?string $symbol = null, $params = array()) {
        ...
        $response = array();
        list($productType, $paramsProductType) = $this->handle_product_type_and_params($market, $params);
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'setPositionMode', false));
        if ($uta === true) {
            $request['holdMode'] = $posMode;
            $response = Async\await($this->privateUtaPostV3AccountSetHoldMode($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixPostV2MixAccountSetPositionMode($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_fetch_open_interest(string $symbol, $params = array()) {
        ...
        $response = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchOpenInterest', false));
        if ($uta === true) {
            $request['category'] = $productType;
            $response = Async\await($this->publicUtaGetV3MarketOpenInterest($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketOpenInterest($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_fetch_transfers(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $response = Async\await($this->privateSpotGetV2SpotAccountTransferRecords($this->extend($request, $paramsMarketType)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_transfer(string $code, float $amount, string $fromAccount, string $toAccount, $params = array()) {
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'transfer', false));
        $currency = $this->currency($code);
        $accountsByType = $this->safe_dict($this->options, 'accountsByType', array());
        ...
        $response = null;
        if ($uta === true) {
            $response = Async\await($this->privateUtaPostV3AccountTransfer($this->extend($request, $paramsOmitted)));
        } else {
            $response = Async\await($this->privateSpotPostV2SpotWalletTransfer($this->extend($request, $paramsOmitted)));
        }
        //
        //     {
        //         "code": "00000",
    ...
    private function do_fetch_my_liquidations(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($marginMode === 'isolated') {
            ...
            $response = Async\await($this->privateMarginGetV2MarginCrossedLiquidationHistory($this->extend($requestUntil, $paramsMarginMode)));
        }
        //
        // isolated
        //
    ...
    private function do_fetch_cross_borrow_rate(string $code, $params = array()) {
        ...
        $response = null;
        $result = array();
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($params, 'fetchCrossBorrowRate', false));
        if ($uta === true) {
            $response = Async\await($this->publicUtaGetV3MarketMarginLoans($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $response = Async\await($this->privateMarginGetV2MarginCrossedInterestRateAndLimit($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_fetch_borrow_interest(?string $code = null, ?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($marginMode === 'isolated') {
            ...
            $response = Async\await($this->privateMarginGetV2MarginCrossedInterestHistory($this->extend($request, $paramsMarginMode)));
        }
        //
        // isolated
        //
    ...
    private function do_close_position(string $symbol, ?string $side = null, $params = array()) {
        ...
        $response = null;
        list($productType, $paramsProductType) = $this->handle_product_type_and_params($market, $params);
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'closePosition', false));
        if ($uta === true) {
            if ($side !== null) {
                $request['posSide'] = $side;
            }
            $request['category'] = $productType;
            $response = Async\await($this->privateUtaPostV3TradeClosePositions($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->privateMixPostV2MixOrderClosePositions($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
    ...
    private function do_close_all_positions($params = array()) {
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'closeAllPositions', false));
        if ($uta === true) {
            $request['category'] = $productType;
            $response = Async\await($this->privateUtaPostV3TradeClosePositions($this->extend($request, $paramsUTA)));
            //
    ...
    private function do_fetch_positions_history(?array $symbols = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchPositionsHistory', false));
        if ($uta === true) {
            $requestUntil['category'] = $productType;
            $response = Async\await($this->privateUtaGetV3PositionHistoryPosition($this->extend($requestUntil, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $response = Async\await($this->privateMixGetV2MixPositionHistoryPosition($this->extend($requestUntil, $paramsUTA)));
            //
            //    {
            //        code: '00000',
            //        msg: 'success',
    ...
    private function do_create_convert_trade(string $id, string $fromCode, string $toCode, ?float $amount = null, $params = array()) {
        ...
        $response = Async\await($this->privateConvertPostV2ConvertTrade($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_fetch_convert_trade_history(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $response = Async\await($this->privateConvertGetV2ConvertConvertRecord($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "code": "00000",
        //         "msg": "success",
    ...
    private function do_fetch_funding_interval(string $symbol, $params = array()) {
        ...
        $response = null;
        list($uta, $paramsUTA) = Async\await($this->handle_uta_and_params($paramsProductType, 'fetchFundingInterval', false));
        if ($uta === true) {
            $response = Async\await($this->publicUtaGetV3MarketCurrentFundRate($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
            ...
            $request['productType'] = $productType;
            $response = Async\await($this->publicMixGetV2MixMarketFundingTime($this->extend($request, $paramsUTA)));
            //
            //     {
            //         "code": "00000",
            //         "msg": "success",
