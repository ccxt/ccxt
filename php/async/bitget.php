...
class bitget extends Exchange {
    ...
    public function fetch_time($params = array ()) {
        $response = yield $this->dataGetCommonTimestamp ($params);
        //
        //     {
        //         "status":"ok",
        //         "data":"1595525139400"
    ...
    public function fetch_markets_by_type($type, $params = array ()) {
        if ($type === 'spot') {
            $response = yield $this->dataGetCommonSymbols ($params);
            //
            //     {
            //         "status":"ok",
            //         "ts":1595526622408,
            ...
            $response = yield $this->capiGetMarketContracts ($params);
            //
            //     {
            //         "data":array(
            //             "contractApis":[
    ...
    public function fetch_currencies($params = array ()) {
        $response = yield $this->dataGetCommonCurrencys ($params);
        //
        //     {
        //         "status":"ok",
        //         "ts":1595537740466,
    ...
    public function fetch_accounts($params = array ()) {
        ...
        $response = yield $this->apiGetAccountAccounts (array_merge($request, $params));
        //
        //     {
        //         "status":"ok",
        //         "ts":1595679591824,
    ...
    public function fetch_balance($params = array ()) {
        ...
        if ($marketType === 'spot') {
            $accountId = yield $this->get_account_id($query);
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->apiGetOrderDepositWithdraw (array_merge($request, $params));
        //
        //     {
        //         "status" => "ok",
        //         "data" => array(
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->apiPostOrderMatchresults (array_merge($request, $query));
        //
        //     {
        //         "status" => "ok",
        //         "data" => array(
    ...
    public function fetch_position($symbol, $params = array ()) {
        ...
        $response = yield $this->swapGetPositionSinglePosition (array_merge($request, $params));
        //
        //     {
