...
class coinbase extends Exchange {
    ...
    public function fetch_my_sells($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_my_buys($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        // they don't have an endpoint for all historical trades
        $request = yield $this->prepare_account_request($limit, $params);
        yield $this->load_markets();
    ...
    public function fetch_transactions_with_method($method, $code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
    ...
    public function find_account_id($code) : Generator {
        yield;
        yield $this->load_markets();
        yield $this->load_accounts();
        for ($i = 0; $i < count($this->accounts); $i++) {
    ...
    public function prepare_account_request_with_currency_code($code = null, $limit = null, $params = array ()) : Generator {
        yield;
        $accountId = $this->safe_string_2($params, 'account_id', 'accountId');
        if ($accountId === null) {
            if ($code === null) {
