...
class coinbase extends Exchange {
        ...
        return $this->deep_extend(parent::describe(), array(
            ...
            'exceptions' => array(
                'exact' => array(
                    ...
                    'unauthorized' => '\\ccxt\\AuthenticationError', // 401 Not authorized to perform this operation
                    ...
                    'resource_exhausted' => '\\ccxt\\RateLimitExceeded', // 429 Resource has been exhausted
    ...
    private function do_fetch_time($params = array()) {
        ...
        if ($method === 'v2PublicGetTime') {
            $response = Async\await($this->v2PublicGetTime($paramsOmitted));
            //
            //     {
            //         "data": {
            //             "epoch": 1589295679,
            ...
            $response = Async\await($this->v3PublicGetBrokerageTime($paramsOmitted));
            //
            //     {
    ...
    public function fetch_accounts_v2($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_accounts_v2(...))($params);
    }

    private function do_fetch_accounts_v2($params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        list($paginate, $paramsPaginate) = $this->handle_option_bool_and_params($params, 'fetchAccounts', 'paginate', false);
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchAccounts', null, null, null, $paramsPaginate, 'next_starting_after', 'starting_after', null, 100));
        }
        $request = array(
            'limit' => 100,
        );
        $response = Async\await($this->v2PrivateGetAccounts($this->extend($request, $paramsPaginate)));
        //
        //     {
        //         "pagination": {
        //             "ending_before": null,
    ...
    public function fetch_accounts_v3($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_accounts_v3(...))($params);
    }

    private function do_fetch_accounts_v3($params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        list($paginate, $paramsPaginate) = $this->handle_option_bool_and_params($params, 'fetchAccounts', 'paginate', false);
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchAccounts', null, null, null, $paramsPaginate, 'cursor', 'cursor', null, 250));
        }
        $request = array(
            'limit' => 250,
        );
        $response = Async\await($this->v3PrivateGetBrokerageAccounts($this->extend($request, $paramsPaginate)));
        //
        //     {
        //         "accounts": [
        //             {
    ...
    public function fetch_portfolios($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_portfolios(...))($params);
    }

    private function do_fetch_portfolios($params = array()) {
        /**
    ...
    private function do_create_deposit_address(string $code, $params = array()) {
        ...
        $response = Async\await($this->v2PrivatePostAccountsAccountIdAddresses($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "data": {
    ...
    public function fetch_my_sells(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_my_sells(...))($symbol, $since, $limit, $params);
    }

    private function do_fetch_my_sells(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
         * @ignore
         * fetch $sells
         *
    ...
    public function fetch_my_buys(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_my_buys(...))($symbol, $since, $limit, $params);
    }

    private function do_fetch_my_buys(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        /**
         * @ignore
         * fetch $buys
         *
    ...
    private function do_fetch_transactions_with_method(string $method, ?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        list($request, $paramsValue) = Async\await($this->prepare_account_request_with_currency_code($code, $limit, $params));
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        $response = null;
        if ($method === 'v2PrivateGetAccountsAccountIdTransactions') {
            $response = Async\await($this->v2PrivateGetAccountsAccountIdTransactions($this->extend($request, $paramsValue)));
        } elseif ($method === 'v2PrivateGetAccountsAccountIdWithdrawals') {
            $response = Async\await($this->v2PrivateGetAccountsAccountIdWithdrawals($this->extend($request, $paramsValue)));
        } else {
            $response = Async\await($this->v2PrivateGetAccountsAccountIdDeposits($this->extend($request, $paramsValue)));
        }
    ...
    private function do_fetch_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($currencyType === 'crypto') {
            $results = Async\await($this->fetch_transactions_with_method('v2PrivateGetAccountsAccountIdTransactions', $code, $since, $limit, $paramsCurrencyType));
            return $this->filter_by_array($results, 'type', 'withdrawal', false);
        }
        return Async\await($this->fetch_transactions_with_method('v2PrivateGetAccountsAccountIdWithdrawals', $code, $since, $limit, $paramsCurrencyType));
    }
    ...
    private function do_fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        return Async\await($this->fetch_transactions_with_method('v2PrivateGetAccountsAccountIdDeposits', $code, $since, $limit, $paramsCurrencyType));
    }
    ...
    public function fetch_markets_v2($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_markets_v2(...))($params);
    }

    private function do_fetch_markets_v2($params = array()) {
    ...
    public function fetch_markets_v3($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_markets_v3(...))($params);
    }
    ...
    private function do_fetch_currencies_from_cache($params = array()) {
    ...
    public function fetch_tickers_v2(?array $symbols = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_tickers_v2(...))($symbols, $params);
    }

    private function do_fetch_tickers_v2(?array $symbols = null, $params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
    ...
    public function fetch_tickers_v3(?array $symbols = null, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_tickers_v3(...))($symbols, $params);
    }

    private function do_fetch_tickers_v3(?array $symbols = null, $params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        $symbolsNormalized = $this->market_symbols($symbols);
        ...
        if ($usePrivate) {
            $response = Async\await($this->v3PrivateGetBrokerageProducts($this->extend($request, $paramsUsePrivate)));
        } else {
            $response = Async\await($this->v3PublicGetBrokerageMarketProducts($this->extend($request, $paramsUsePrivate)));
        }
        //
        //     {
        //         "products": [
    ...
    private function do_fetch_ticker_v2(string $symbol, $params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
    ...
    private function do_fetch_ticker_v3(string $symbol, $params = array()) {
        if ($this->markets === null) {
            Async\await($this->load_markets());
        }
        $market = $this->market($symbol);
        ...
        $response = null;
        if ($usePrivate) {
            $response = Async\await($this->v3PrivateGetBrokerageProductsProductIdTicker($this->extend($request, $paramsUsePrivate)));
        } else {
            $response = Async\await($this->v3PublicGetBrokerageMarketProductsProductIdTicker($this->extend($request, $paramsUsePrivate)));
        }
        //
        //     {
        //         "trades": [
    ...
    private function do_fetch_balance($params = array()) {
        ...
        if ($marketType === 'future') {
            $response = Async\await($this->v3PrivateGetBrokerageCfmBalanceSummary($this->extend($request, $paramsMarketType)));
        } elseif (($isV3 === true) || ($method === 'v3PrivateGetBrokerageAccounts')) {
            $request['limit'] = 250;
            $response = Async\await($this->v3PrivateGetBrokerageAccounts($this->extend($request, $paramsMarketType)));
        } else {
            $request['limit'] = 250;
            $response = Async\await($this->v2PrivateGetAccounts($this->extend($request, $paramsMarketType)));
        }
        //
    ...
    private function do_fetch_ledger(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchLedger', $code, $since, $limit, $paramsPaginate, 'next_starting_after', 'starting_after', null, 100));
        }
        $currency = null;
        if ($code !== null) {
            $currency = $this->currency($code);
        }
        list($request, $paramsValue) = Async\await($this->prepare_account_request_with_currency_code($code, $limit, $paramsPaginate));
    ...
    private function do_prepare_account_request_with_currency_code(?string $code = null, ?int $limit = null, $params = array()) {
        $accountId = $this->safe_string_2($params, 'account_id', 'accountId');
        ...
        if ($accountId === null) {
            ...
            $accountId = Async\await($this->find_account_id($code, $paramsOmitted));
            if ($accountId === null) {
    ...
    private function do_create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        ...
        if ($reduceOnly === true) {
            ...
            return Async\await($this->close_position($symbol, $side, $paramsClose));
        }
        ...
        if ($preview === true) {
            ...
            $response = Async\await($this->v3PrivatePostBrokerageOrdersPreview($this->extend($request, $this->omit($paramsOmitted, array( 'preview', 'test' )))));
        } else {
            $response = Async\await($this->v3PrivatePostBrokerageOrders($this->extend($request, $paramsOmitted)));
        }
        //
        // successful order
        //
    ...
    private function do_edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array()) {
        ...
        $response = null;
        if ($preview === true) {
            $response = Async\await($this->v3PrivatePostBrokerageOrdersEditPreview($this->extend($request, $this->omit($params, array( 'preview', 'test' )))));
        } else {
    ...
    private function do_fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = 100, $params = array()) {
        /**
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchOrders', $symbol, $since, $limit, $paramsPaginate, 'cursor', 'cursor', null, 1000));
        }
        $market = null;
        if ($symbol !== null) {
            $market = $this->market($symbol);
        ...
        $response = Async\await($this->v3PrivateGetBrokerageOrdersHistoricalBatch($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "orders": [
        //             {
    ...
    private function do_fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchOpenOrders', $symbol, $since, $limit, $paramsPaginate, 'cursor', 'cursor', null, 100));
        }
        return Async\await($this->fetch_orders_by_status('OPEN', $symbol, $since, $limit, $paramsPaginate));
    }
    ...
    private function do_fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchClosedOrders', $symbol, $since, $limit, $paramsPaginate, 'cursor', 'cursor', null, 1000));
        }
        return Async\await($this->fetch_orders_by_status('FILLED', $symbol, $since, $limit, $paramsPaginate));
    }
    ...
    private function do_fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_deterministic('fetchOHLCV', $symbol, $since, $limitValue, $timeframe, $paramsPaginate, $maxLimit - 1));
        }
        $market = $this->market($symbol);
        $request = array(
            'product_id' => $market['id'],
        ...
        if ($usePrivate) {
            $response = Async\await($this->v3PrivateGetBrokerageProductsProductIdCandles($this->extend($request, $paramsUsePrivate)));
        } else {
            $response = Async\await($this->v3PublicGetBrokerageMarketProductsProductIdCandles($this->extend($request, $paramsUsePrivate)));
        }
        //
        //     {
        //         "candles": [
    ...
    private function do_fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_cursor('fetchMyTrades', $symbol, $since, $limit, $paramsPaginate, 'cursor', 'cursor', null, 250));
        }
        $market = null;
        if ($symbol !== null) {
            $market = $this->market($symbol);
        ...
        $paramsOmitted = ($until !== null) ? $this->omit($paramsPaginate, array( 'until' )) : $paramsPaginate;
        $response = Async\await($this->v3PrivateGetBrokerageOrdersHistoricalFills($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "fills": [
        //             {
    ...
    private function do_fetch_order_book(string $symbol, ?int $limit = null, $params = array()) {
        ...
        if ($usePrivate) {
            $response = Async\await($this->v3PrivateGetBrokerageProductBook($this->extend($request, $paramsUsePrivate)));
        } else {
            $response = Async\await($this->v3PublicGetBrokerageMarketProductBook($this->extend($request, $paramsUsePrivate)));
        }
        //
        //     {
        //         "pricebook": {
    ...
    private function do_withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array()) {
        ...
        $response = Async\await($this->v2PrivatePostAccountsAccountIdTransactions($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "data": {
        //             "id": "a1794ecf-5693-55fa-70cf-ef731748ed82",
    ...
    public function deposit(string $code, float $amount, string $id, $params = array()): PromiseInterface {
        return Async\async(self::do_deposit(...))($code, $amount, $id, $params);
    }

    private function do_deposit(string $code, float $amount, string $id, $params = array()) {
        /**
         * make a deposit
         *
         * @see https://docs.cdp.coinbase.com/coinbase-app/transfer-apis/deposit-fiat
        ...
        $response = Async\await($this->v2PrivatePostAccountsAccountIdDeposits($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "data": {
        //             "id": "67e0eaec-07d7-54c4-a72c-2e92826897df",
    ...
    private function do_fetch_deposit(string $id, ?string $code = null, $params = array()) {
        ...
        $response = Async\await($this->v2PrivateGetAccountsAccountIdDepositsDepositId($this->extend($request, $paramsOmitted)));
        //
        //     {
        //         "data": {
        //             "id": "67e0eaec-07d7-54c4-a72c-2e92826897df",
    ...
    private function do_fetch_deposit_method_ids($params = array()) {
        /**
    ...
    public function fetch_deposit_method_id(string $id, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_deposit_method_id(...))($id, $params);
    }

    private function do_fetch_deposit_method_id(string $id, $params = array()) {
        /**
         * fetch the deposit $id for a fiat currency associated with this account
         *
    ...
    private function do_fetch_convert_trade(string $id, ?string $code = null, $params = array()) {
        ...
        $response = Async\await($this->v3PrivateGetBrokerageConvertTradeTradeId($this->extend($request, $paramsOmitted)));
        $data = $this->safe_dict($response, 'trade', array());
        return $this->parse_conversion($data);
    }
    ...
    private function do_close_position(string $symbol, ?string $side = null, $params = array()) {
        ...
        $response = Async\await($this->v3PrivatePostBrokerageOrdersClosePosition($this->extend($request, $paramsOmitted)));
    ...
    private function do_fetch_positions(?array $symbols = null, $params = array()) {
        ...
        $response = null;
        if ($marketType === 'future') {
            $response = Async\await($this->v3PrivateGetBrokerageCfmPositions($paramsMarketType));
        } else {
            ...
            $response = Async\await($this->v3PrivateGetBrokerageIntxPositionsPortfolioUuid($this->extend($request, $paramsPortfolio)));
        }
    ...
    private function do_fetch_position(string $symbol, $params = array()) {
        ...
        if ($market['future'] === true) {
            ...
            $response = Async\await($this->v3PrivateGetBrokerageIntxPositionsPortfolioUuidSymbol($this->extend($request, $paramsPortfolio)));
        }
    ...
    private function do_fetch_trading_fees($params = array()) {
        ...
        $response = Async\await($this->v3PrivateGetBrokerageTransactionSummary($this->extend($request, $paramsMarketType)));
        //
        // {
        //     total_volume: '0',
        //     total_fees: '0',
    ...
    public function fetch_portfolio_details(string $portfolioUuid, $params = array()): PromiseInterface {
        return Async\async(self::do_fetch_portfolio_details(...))($portfolioUuid, $params);
    }

    private function do_fetch_portfolio_details(string $portfolioUuid, $params = array()) {
        /**
