...
class livecoin extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetExchangeTicker ($params);
        $restrictions = yield $this->publicGetExchangeRestrictions ();
    ...
    public function fetch_currencies($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetInfoCoinInfo ($params);
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->privateGetPaymentBalances ($params);
    ...
    public function fetch_trading_fees($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->privateGetExchangeCommissionCommonInfo ($params);
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetExchangeOrderBook (array_merge($request, $params));
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $ticker = yield $this->publicGetExchangeTicker (array_merge($request, $params));
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetExchangeTrades (array_merge($request, $params));
        //
        //     array(
        //         array(
        //             "datetime" => 1435844369,
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetExchangeLastTrades (array_merge($request, $params));
        //
        //     array(
        //         array(
        //             "time" => 1409935047,
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetExchangeOrder (array_merge($request, $params));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetExchangeClientOrders (array_merge($request, $params));
        $result = array();
        $rawOrders = array();
        if ($response['data']) {
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostExchangeCancellimit (array_merge($request, $params));
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostPaymentOutCoin (array_merge($request, $params));
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetPaymentHistoryTransactions (array_merge($request, $params));
    ...
    public function fetch_deposit_address($currency, $params = array ()) : Generator {
        yield;
        $request = array(
            'currency' => $currency,
        );
        $response = yield $this->privateGetPaymentGetAddress (array_merge($request, $params));
