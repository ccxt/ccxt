...
class stronghold extends Exchange {
    ...
    public function get_active_account() : Generator {
        yield;
    ...
    public function fetch_accounts($params = array ()) : Generator {
        ...
        $response = yield $this->privateGetVenuesVenueIdAccounts (array_merge($request, $params));
        //
    ...
    public function fetch_time($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetUtilitiesTime ($params);
        //
        //     {
    ...
    public function fetch_markets($params = array ()) : Generator {
        ...
        $response = yield $this->publicGetVenuesVenueIdMarkets (array_merge($request, $params));
    ...
    public function fetch_currencies($params = array ()) : Generator {
        ...
        $response = yield $this->publicGetVenuesVenueIdAssets (array_merge($request, $params));
        //
        //     array(
        //         array(
        //             id => 'XLM/native',
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetVenuesVenueIdMarketsMarketIdOrderbook (array_merge($request, $params));
        //
        //     {
        //         $marketId => 'ETHBTC',
        //         bids => array(
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetVenuesVenueIdMarketsMarketIdTrades (array_merge($request, $params));
        //
        //     {
    ...
    public function fetch_transactions($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $request = array_merge(array(
            'venueId' => $this->options['venueId'],
            'accountId' => yield $this->get_active_account(),
        ), $params);
        ...
        $response = yield $this->privateGetVenuesVenueIdAccountsAccountIdTransactions ($request);
        $currency = null;
        if ($code !== null) {
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostVenuesVenueIdAccountsAccountIdOrders ($request);
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateDeleteVenuesVenueIdAccountsAccountIdOrdersOrderId ($request);
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetVenuesVenueIdAccountsAccountIdOrders ($request);
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->privateGetVenuesVenueIdAccountsAccountId ($request);
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetVenuesVenueIdAccountsAccountIdTrades ($request);
        $market = null;
        if ($symbol !== null) {
            $market = $this->market($symbol);
        }
    ...
    public function create_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostVenuesVenueIdAccountsAccountIdDeposit ($request);
        //
        //     {
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostVenuesVenueIdAccountsAccountIdWithdrawal ($request);
        //
        //     {
