...
use ccxt\async\abstract\uniswapv4 as Exchange;
...
class uniswapv4 extends Exchange {
    ...
    private function do_fetch_markets($params = array()) {
        ...
        $response = Async\await($this->subgraphPostGraphql($this->extend($request, $params)));
    ...
    private function do_create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        ...
        $quote = Async\await($this->tradingPostQuote($quoteRequest));
        ...
        $swap = Async\await($this->tradingPostSwap($swapRequest));
        //
