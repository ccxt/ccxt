...
class kraken extends Exchange {
    ...
    public function fetch_min_order_amounts($params = array ()) : Generator {
        yield;
        $response = yield $this->zendeskGet205893708 ($params);
    ...
    public function fetch_markets($params = array ()) : Generator {
        ...
        if ($fetchMinOrderAmounts) {
            $limits = yield $this->fetch_min_order_amounts();
        }
    ...
    public function fetch_ledger_entries_by_ids($ids, $code = null, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_ledger_entry($id, $code = null, $params = array ()) : Generator {
        yield;
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostAddOrder (array_merge($request, $query));
    ...
    public function fetch_orders_by_ids($ids, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function fetch_closed_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostClosedOrders (array_merge($request, $params));
    ...
    public function fetch_deposit_methods($code, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $currency = $this->currency($code);
        $request = array(
