...
class theocean extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $markets = yield $this->publicGetTokenPairs ($params);
        //
        //     array(
        //       "$baseToken" => array(
        //         "$symbol" => "ZRX",
    ...
    public function fetch_ohlcv($symbol, $timeframe = '5m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetCandlesticks (array_merge($request, $params));
        //
        //   array(
        //     array(
        //         "high" => "100.52",
    ...
    public function fetch_balance_by_code($code, $params = array ()) : Generator {
        yield;
        ...
        $response = yield $this->privateGetBalance (array_merge($request, $params));
        //
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        for ($i = 0; $i < count($codes); $i++) {
            $code = $codes[$i];
            $result[$code] = yield $this->fetch_balance_by_code($code);
        }
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetTradeHistory (array_merge($request, $params));
        //
        //     array(
        //       {
        //         "id" => "37212",
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $orderParams = yield $this->fetch_order_params_to_sign($symbol, $type, $side, $amount, $price, $params);
        ...
        $signedOrder = yield $this->sign_zero_ex_order_v2($unsignedOrder, $this->privateKey);
        $id = $this->safe_string($signedOrder, 'orderHash');
        yield $this->post_signed_order($signedOrder, $orderParams, $params);
        $order = yield $this->fetch_order($id);
        $order['type'] = $type;
        return $order;
    }

    public function fetch_order_params_to_sign($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        yield;
    ...
    public function post_signed_order($signedOrder, $requestParams, $params = array ()) : Generator {
        yield;
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateDeleteOrderOrderHash (array_merge($request, $params));
        //
        //     {
        //       "canceledOrder" => {
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) : Generator {
        yield;
        $response = yield $this->privateDeleteOrder ($params);
        //
        //     [{
        //       "canceledOrder" => array(
        //         "orderHash" => "0x3d6b287c1dc79262d2391ae2ca9d050fdbbab2c8b3180e4a46f9f321a7f1d7a9",
    ...
    public function fetch_open_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        return yield $this->$method ($id, $symbol, array_merge(array(
            'openAmount' => 1,
        ), $params));
    }
    ...
    public function fetch_closed_order($id, $symbol = null, $params = array ()) : Generator {
        yield;
        $method = $this->options['fetchOrderMethod'];
        return yield $this->$method ($id, $symbol, array_merge($params));
    }

    public function fetch_order_from_history($id, $symbol = null, $params = array ()) : Generator {
        yield;
        $request = array(
            'orderHash' => $id,
        );
    ...
    public function fetch_order_by_id($id, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
            'orderHash' => $id,
        );
        $response = yield $this->publicGetOrderOrderHash (array_merge($request, $params));
        //  {
