...
class coinbasepro extends Exchange {
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        return yield $this->privateDeleteOrdersId (array( 'id' => $id ));
    }

    public function cancel_all_orders($symbol = null, $params = array ()) : Generator {
        yield;
        return yield $this->privateDeleteOrders ($params);
    }
    ...
    public function fetch_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetCoinbaseAccountsIdAddresses (array_merge($request, $params));
