...
class bitvavo extends Exchange {
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) {
         ...
         * @param {int|float} $params->triggerPrice The $price at which a trigger order is triggered at
         * @param {bool} $params->postOnly If true, the order will only be posted to the order book and not executed immediately
         * @param {int|float} $params->stopLossPrice The $price at which a stop loss order is triggered at
         * @param {int|float} $params->takeProfitPrice The $price at which a take profit order is triggered at
