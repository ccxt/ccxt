...
class deepwaters extends Exchange {
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            Async\await($this->load_markets()); // this will load only the first time
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) {
        return Async\async(function () use ($id, $symbol, $params) {
            ...
            if ($isVenueId) {
                $response = Async\await($this->privateGetOrdersByVenueOrderIdId (array_merge($request, $params)));
            } else {
                $response = Async\await($this->privateGetOrdersByCustomerObjectIdId (array_merge($request, $params)));
            }
            $success = $this->safe_value($response, 'success', false);
            if (!$success) {
                return $this->handle_error($response);
