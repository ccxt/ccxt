...
class bitmart extends Exchange {
    ...
    public function sign_in($params = array ()) : Generator {
        ...
        $response = yield $this->tokenPostAuthentication (array_merge($data, $params));
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $markets = yield $this->publicGetSymbolsDetails ($params);
        //
        //     array(
        //         {
        //             "$id":"1SG_BTC",
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetSymbolsSymbolOrders (array_merge($request, $params));
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetSymbolsSymbolTrades (array_merge($request, $params));
        //
        //     array(
        //         {
        //             "amount":"2.29275119",
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetSymbolsSymbolKline (array_merge($request, $params));
        //
        //     array(
        //         {
    ...
    public function fetch_balance($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $balances = yield $this->privateGetWallet ($params);
        //
        //     array(
        //         {
        //             "name":"Bitcoin",
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateDeleteOrdersId (array_merge($request, $params));
        //
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        return yield $this->fetch_orders_by_status(5, $symbol, $since, $limit, $params);
    }

    public function fetch_closed_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        // 3 = closed orders
        return yield $this->fetch_orders_by_status(3, $symbol, $since, $limit, $params);
    }

    public function fetch_canceled_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        // 4 = canceled orders
        return yield $this->fetch_orders_by_status(4, $symbol, $since, $limit, $params);
    }
