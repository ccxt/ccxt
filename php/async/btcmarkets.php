...
class btcmarkets extends Exchange {
    ...
    public function fetch_transactions($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetFundtransferHistory (array_merge($request, $params));
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetV2MarketActive ($params);
        $result = array();
    ...
    public function fetch_balance($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $balances = yield $this->privateGetAccountBalance ($params);
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetV2MarketIdTickByTimeTimeframe (array_merge($request, $params));
        //
        //     {
        //         "success":true,
        //         "paging":array(
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketIdOrderbook (array_merge($request, $params));
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetMarketIdTrades (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        return yield $this->cancel_orders(array( $id ));
    }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostOrderDetail (array_merge($request, $params));
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $market = $this->market($symbol);
        $request = $this->create_paginated_request($market, $since, $limit);
        $response = yield $this->privatePostOrderOpen (array_merge($request, $params));
        return $this->parse_orders($response['orders'], $market);
    }
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $market = $this->market($symbol);
        $request = $this->create_paginated_request($market, $since, $limit);
        $response = yield $this->privatePostOrderTradeHistory (array_merge($request, $params));
