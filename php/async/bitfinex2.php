...
class bitfinex2 extends bitfinex {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->v1GetSymbolsDetails ($params);
        $result = array();
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->privatePostAuthRWallets ($params);
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = 100, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        if ($limit === null) {
