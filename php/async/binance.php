...
class binance extends Exchange {
    ...
    public function fetch_permissions($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
            ...
            // }
            return array(
                'spotEnabled' => $this->safe_value($response, 'enableSpotAndMarginTrading', false),
                'marginEnabled' => $this->safe_value($response, 'enableSpotAndMarginTrading', false),
                'withdrawlsEnabled' => $this->safe_value($response, 'enableWithdrawals', false),
                'futuresEnabled' => $this->safe_value($response, 'enableFutures', false),
            );
        }) ();
    }
}
