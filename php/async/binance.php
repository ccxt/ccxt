...
class binance extends Exchange {
    ...
    public function fetch_my_dust_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        //
    ...
    public function fetch_deposits($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->wapiGetDepositHistory (array_merge($request, $params));
        //
        //     {     success =>    true,
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->wapiGetWithdrawHistory (array_merge($request, $params));
        //
    ...
    public function fetch_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->wapiGetDepositAddress (array_merge($request, $params));
    ...
    public function fetch_funding_fees($codes = null, $params = array ()) : Generator {
        yield;
        $response = yield $this->wapiGetAssetDetail ($params);
        //
        //     {
        //         "success" => true,
        //         "assetDetail" => {
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->wapiPostWithdraw (array_merge($request, $params));
        return array(
            'info' => $response,
    ...
    public function fetch_trading_fee($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->wapiGetTradeFee (array_merge($request, $params));
        //
        //     {
        //         "$tradeFee" => array(
        //             {
    ...
    public function fetch_trading_fees($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->wapiGetTradeFee ($params);
        //
        //     {
        //         "$tradeFee" => array(
        //             {
