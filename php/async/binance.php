...
class binance extends Exchange {
        ...
        return $this->deep_extend(parent::describe (), array(
            ...
            'exceptions' => array(
                'exact' => array(
                    ...
                    '-1004' => '\\ccxt\\ExchangeError', // array("code":-1004,"msg":"Server is busy, please wait and try again")
                    '-1005' => '\\ccxt\\ExchangeError', // array("code":-1005,"msg":"No such IP has been white listed")
                    '-1006' => '\\ccxt\\ExchangeError', // array("code":-1006,"msg":"An unexpected response was received from the message bus. Execution status unknown.")
                    '-1007' => '\\ccxt\\ExchangeError', // array("code":-1007,"msg":"Timeout waiting for response from backend server. Send status unknown; execution status unknown.")
                    '-1010' => '\\ccxt\\ExchangeError', // array("code":-1010,"msg":"ERROR_MSG_RECEIVED.")
                    '-1011' => '\\ccxt\\ExchangeError', // array("code":-1011,"msg":"This IP cannot access this route.")
                    ...
                    '-1023' => '\\ccxt\\ExchangeError', // array("code":-1023,"msg":"Start time is greater than end time.")
                    ...
                    '-2020' => '\\ccxt\\ExchangeError', // array("code":-2020,"msg":"Unable to fill.")
                    '-2021' => '\\ccxt\\InvalidOrder', // array("code":-2021,"msg":"Order would immediately trigger.")
                    ...
                    '-3001' => '\\ccxt\\ExchangeError', // array("code":-3001,"msg":"Please enable 2FA first.")
                    '-3002' => '\\ccxt\\BadRequest', // array("code":-3002,"msg":"We don't have this asset.")
                    ...
                    '-3024' => '\\ccxt\\BadRequest', // array("code":-3024,"msg":"The unpaid debt is too small after this repayment.")
                    ...
                    '-3027' => '\\ccxt\\BadRequest', // array("code":-3027,"msg":"Not a valid margin asset.")
                    '-3028' => '\\ccxt\\BadRequest', // array("code":-3028,"msg":"Not a valid margin pair.")
                    ...
                    '-3044' => '\\ccxt\\ExchangeError', // array("code":-3044,"msg":"System busy.")
                    ...
                    '-4014 ' => '\\ccxt\\BadRequest', // array("code":-4014 ,"msg":"Withdraw is not allowed within 2 min login.")
                    '-4015 ' => '\\ccxt\\ExchangeError', // array("code":-4015 ,"msg":"Withdraw is limited.")
                    '-4016 ' => '\\ccxt\\BadRequest', // array("code":-4016 ,"msg":"Within 24 hours after password modification, withdrawal is prohibited.")
                    '-4017 ' => '\\ccxt\\BadRequest', // array("code":-4017 ,"msg":"Within 24 hours after the release of 2FA, withdrawal is prohibited.")
                    '-4018' => '\\ccxt\\BadRequest', // array("code":-4018,"msg":"We don't have this asset.")
                    ...
                    '-4024' => '\\ccxt\\BadRequest', // array("code":-4024,"msg":"You don't have this asset.")
                    '-4025' => '\\ccxt\\BadRequest', // array("code":-4025,"msg":"The number of hold asset is less than zero.")
                    ...
                    '-4035' => '\\ccxt\\BadRequest', // array("code":-4035,"msg":"This address is not on the whitelist. Please join and try again.")
    ...
    public function fetch_status($params = array ()) {
        $response = yield $this->sapiGetSystemStatus ($params);
    ...
    public function fetch_my_dust_trades($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->sapiGetAssetDribblet (array_merge($request, $params));
        //     {
        //       "total" => "4",
    ...
    public function fetch_positions($symbols = null, $params = array ()) {
        ...
        if ($defaultMethod === 'positionRisk') {
            return yield $this->fetch_positions_risk($symbols, $params);
        } else if ($defaultMethod === 'account') {
            return yield $this->fetch_account_positions($symbols, $params);
        } else {
    ...
    public function fetch_borrow_rate($code, $params = array ()) {
        ...
        $response = yield $this->sapiGetMarginInterestRateHistory (array_merge($request, $params));
        //
        // array(
        //     array(
        //         "asset" => "USDT",
