...
class nado extends Exchange {
    ...
    public function create_order_request(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()): PromiseInterface {
        return Async\async(self::do_create_order_request(...))($symbol, $type, $side, $amount, $price, $params);
    }

    private function do_create_order_request(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()) {
        /**
         * @ignore
    ...
    public function edit_order_request(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array()): PromiseInterface {
        return Async\async(self::do_edit_order_request(...))($id, $symbol, $type, $side, $amount, $price, $params);
    }

    private function do_edit_order_request(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array()) {
        /**
         * @ignore
    ...
    public function cancel_all_orders_request(?string $symbol = null, $params = array()): PromiseInterface {
        return Async\async(self::do_cancel_all_orders_request(...))($symbol, $params);
    }

    private function do_cancel_all_orders_request(?string $symbol = null, $params = array()) {
        /**
         * @ignore
    ...
    public function cancel_orders_request(array $ids, ?string $symbol = null, $params = array()): PromiseInterface {
        return Async\async(self::do_cancel_orders_request(...))($ids, $symbol, $params);
    }

    private function do_cancel_orders_request(array $ids, ?string $symbol = null, $params = array()) {
        /**
         * @ignore
    ...
    private function do_fetch_deposits(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
         ...
         */
        return Async\await($this->query_transactions_by_event_type('deposit_collateral', 'deposit', 'fetchDeposits', $code, $since, $limit, $params));
    }
    ...
    private function do_fetch_withdrawals(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
         ...
         * @return {array[]} a list of ~@link https://docs.ccxt.com/#/?id=transaction-structure transaction structures~
         */
        return Async\await($this->query_transactions_by_event_type('withdraw_collateral', 'withdrawal', 'fetchWithdrawals', $code, $since, $limit, $params));
    }

    public function query_transactions_by_event_type(string $eventType, string $transactionType, string $methodName, ?string $code = null, ?int $since = null, ?int $limit = null, $params = array()): PromiseInterface {
        return Async\async(self::do_query_transactions_by_event_type(...))($eventType, $transactionType, $methodName, $code, $since, $limit, $params);
    }

    private function do_query_transactions_by_event_type(string $eventType, string $transactionType, string $methodName, ?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        if ($this->walletAddress === null) {
    ...
    private function do_fetch_markets($params = array()) {
        ...
        $responses = Async\await(Promise\all(array( $symbolsRequest, $pairsRequest, $assetsRequest )));
    ...
    private function do_fetch_currencies($params = array()) {
         ...
         */
        $response = Async\await($this->gatewayV2PublicGetAssets($params));
        $result = array();
    ...
    private function do_query_contracts($params = array()) {
