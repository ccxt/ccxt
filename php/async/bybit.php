...
class bybit extends Exchange {
    ...
    public function load_time_difference() : Generator {
        yield;
        $serverTime = yield $this->fetch_time();
        $after = $this->milliseconds();
        $this->options['timeDifference'] = $after - $serverTime;
        return $this->options['timeDifference'];
    }

    public function fetch_time($params = array ()) : Generator {
        yield;
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->privateGetWalletBalance (array_merge($request, $params));
        //
        //     {
        //         ret_code => 0,
        //         ret_msg => 'OK',
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $market = $this->market($symbol);
        $request = array(
    ...
    public function edit_order($id, $symbol, $type, $side, $amount = null, $price = null, $params = array ()) : Generator {
        yield;
        if ($symbol === null) {
    ...
    public function cancel_all_orders($symbol = null, $params = array ()) : Generator {
        yield;
        if ($symbol === null) {
    ...
    public function fetch_order_trades($id, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        $request = array(
            'order_id' => $id,
        );
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->openapiGetWalletWithdrawList (array_merge($request, $params));
        //
        //     {
        //         "ret_code" => 0,
        //         "ret_msg" => "ok",
    ...
    public function fetch_ledger($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array(
            // 'coin' => $currency['id'],
        ...
        $response = yield $this->openapiGetWalletFundRecords (array_merge($request, $params));
        //
        //     {
        //         "ret_code" => 0,
        //         "ret_msg" => "ok",
