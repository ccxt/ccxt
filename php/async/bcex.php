...
class bcex extends Exchange {
    ...
    public function fetch_trading_limits_by_id($id, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostApiOrderTicker (array_merge($request, $params));
        //
        //     {  code =>    0,
        //         msg =>   "获取牌价信息成功",
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetApiMarketGetPriceList ($params);
        $result = array();
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostApiOrderMarketOrder (array_merge($request, $params));
    ...
    public function fetch_balance($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->privatePostApiUserUserBalance ($params);
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostApiMarketGetCoinTrade (array_merge($request, $params));
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostApiOrderDepth (array_merge($request, $params));
        $data = $this->safe_value($response, 'data');
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostApiOrderOrderList (array_merge($request, $params));
        return $this->parse_trades($response['data'], $market, $since, $limit);
    }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostApiOrderOrderInfo (array_merge($request, $params));
    ...
    public function fetch_orders_by_type($type, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostApiOrderTradeList (array_merge($request, $params));
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostApiOrderCoinTrust (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        return yield $this->privatePostApiOrderCancel (array_merge($request, $params));
    }
