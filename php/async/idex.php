...
class idex extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        ...
        $markets = yield $this->publicPostReturnCurrenciesWithPairs (array_merge($request, $params));
    ...
    public function fetch_tickers($symbols = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnTicker ($params);
        //  { ETH_BOUNCY:
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnTicker (array_merge($request, $params));
        // { last => '0.0016550916',
        //   high => 'N/A',
        //   low => 'N/A',
        //   lowestAsk => '0.0016743368',
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnOrderBook (array_merge($request, $params));
        //
        //     {
        //         "asks" => array(
        //             {
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnCompleteBalances (array_merge($request, $params));
        //
        //     {
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        if ($type === 'limit') {
            $expires = 100000;
            $contractAddress = yield $this->get_contract_address();
            $tokenBuy = null;
            $tokenSell = null;
            $amountBuy = null;
            $amountSell = null;
            ...
            $response = yield $this->privatePostOrder (array_merge($request, $signature)); // array_merge($request, $params) will cause invalid $signature
            ...
            $signedOrder['nonce'] = yield $this->get_nonce();
            //   array( {
            //     "$amount" => "0.07",
            ...
            //   } )
            $response = yield $this->privatePostTrade ($signedOrder);
            return $this->parse_orders($response, $market);
        }
    }

    public function get_nonce() : Generator {
        yield;
        if ($this->options['orderNonce'] === null) {
            $response = yield $this->publicPostReturnNextNonce (array(
                'address' => $this->walletAddress,
            ));
    ...
    public function get_contract_address() : Generator {
        yield;
        if ($this->options['contractAddress'] !== null) {
            return $this->options['contractAddress'];
        }
        $response = yield $this->publicPostReturnContractAddress ();
        $this->options['contractAddress'] = $this->safe_string($response, 'address');
        return $this->options['contractAddress'];
    }

    public function cancel_order($orderId, $symbol = null, $params = array ()) : Generator {
        yield;
        $nonce = yield $this->get_nonce();
        $orderToHash = array(
            'orderHash' => $orderId,
        ...
        $response = yield $this->privatePostCancel (array_merge($request, $signature));
        // array( success => 1 )
    ...
    public function fetch_transactions($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnDepositsWithdrawals (array_merge($request, $params));
        // { $deposits:
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnOpenOrders (array_merge($request, $params));
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnOrderStatus (array_merge($request, $params));
        // { filled => '0',
        //   initialAmount => '210',
        //   timestamp => 1564041428,
        //   orderHash:
    ...
    public function fetch_my_trades($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicPostReturnTradeHistory (array_merge($request, $params));
        // { ETH_IDEX:
        //    array( { type => 'buy',
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostWithdraw (array_merge($request, $signature));
        // array( $amount => '0' )
        return array(
            'info' => $response,
            'id' => null,
