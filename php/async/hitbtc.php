...
class hitbtc extends Exchange {
    ...
    public function fetch_markets($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetSymbol ($params);
        //
        //     array(
        //         {
        //             "$id":"BCNBTC",
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetCandlesSymbol (array_merge($request, $params));
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetTickerSymbol (array_merge($request, $params));
    ...
    public function fetch_transactions($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetAccountTransactions (array_merge($request, $params));
    ...
    public function edit_order($id, $symbol, $type, $side, $amount = null, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePatchOrderClientOrderId (array_merge($request, $params));
        $order = $this->parse_order($response);
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateDeleteOrderClientOrderId (array_merge($request, $params));
    ...
    public function fetch_open_order($id, $symbol = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        // we use clientOrderId as the order $id with this exchange intentionally
        // because most of their endpoints will require clientOrderId
        ...
        $response = yield $this->privateGetOrderClientOrderId (array_merge($request, $params));
        return $this->parse_order($response);
    }
    ...
    public function create_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostAccountCryptoAddressCurrency (array_merge($request, $params));
    ...
    public function fetch_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetAccountCryptoAddressCurrency (array_merge($request, $params));
        $address = $this->safe_string($response, 'address');
        $this->check_address($address);
        $tag = $this->safe_string($response, 'paymentId');
        return array(
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostAccountCryptoWithdraw (array_merge($request, $params));
        return array(
            'info' => $response,
            'id' => $response['id'],
        );
