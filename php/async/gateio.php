...
class gateio extends Exchange {
    ...
    public function fetch_currencies($params = array ()) : Generator {
        yield;
        $response = yield $this->publicGetCoininfo ($params);
        //
        //     {
        //         "$result":"true",
        //         "$coins":array(
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetOrderBookId (array_merge($request, $params));
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        yield $this->load_markets();
        $market = $this->market($symbol);
        $ticker = yield $this->publicGetTickerId (array_merge(array(
            'id' => $market['id'],
        ), $params));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        $response = yield $this->privatePostOpenOrders ($params);
    ...
    public function query_deposit_address($method, $code, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
    ...
    public function create_deposit_address($code, $params = array ()) : Generator {
        yield;
        return yield $this->query_deposit_address('New', $code, $params);
    }

    public function fetch_deposit_address($code, $params = array ()) : Generator {
        yield;
        return yield $this->query_deposit_address('Deposit', $code, $params);
    }
    ...
    public function fetch_transactions_by_type($type = null, $code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $request = array();
        if ($since !== null) {
        ...
        $response = yield $this->privatePostDepositsWithdrawals (array_merge($request, $params));
        $transactions = null;
        if ($type === null) {
    ...
    public function fetch_transactions($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_transactions_by_type(null, $code, $since, $limit, $params);
    }
    ...
    public function fetch_withdrawals($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        yield;
        return yield $this->fetch_transactions_by_type('withdraws', $code, $since, $limit, $params);
    }
