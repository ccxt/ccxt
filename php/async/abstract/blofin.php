...
abstract class blofin extends \ccxt\async\Exchange {
    ...
    public function public_get_market_position_tiers($params = array()) {
        return $this->request('market/position-tiers', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_get_account_config($params = array()) {
        return $this->request('account/config', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function private_get_asset_currencies($params = array()) {
        return $this->request('asset/currencies', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_get_affiliate_referral_code($params = array()) {
        return $this->request('affiliate/referral-code', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function private_get_affiliate_invitees($params = array()) {
        return $this->request('affiliate/invitees', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function private_get_affiliate_sub_invitees($params = array()) {
        return $this->request('affiliate/sub-invitees', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function private_get_affiliate_sub_affiliates($params = array()) {
        return $this->request('affiliate/sub-affiliates', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function private_get_affiliate_invitees_daily_info($params = array()) {
        return $this->request('affiliate/invitees/daily/info', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_get_copytrading_config($params = array()) {
        return $this->request('copytrading/config', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function publicGetMarketPositionTiers($params = array()) {
        return $this->request('market/position-tiers', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function privateGetAffiliateReferralCode($params = array()) {
        return $this->request('affiliate/referral-code', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function privateGetAffiliateInvitees($params = array()) {
        return $this->request('affiliate/invitees', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function privateGetAffiliateSubInvitees($params = array()) {
        return $this->request('affiliate/sub-invitees', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function privateGetAffiliateSubAffiliates($params = array()) {
        return $this->request('affiliate/sub-affiliates', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function privateGetAffiliateInviteesDailyInfo($params = array()) {
        return $this->request('affiliate/invitees/daily/info', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function privateGetCopytradingInstruments($params = array()) {
        return $this->request('copytrading/instruments', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    public function privateGetCopytradingConfig($params = array()) {
        return $this->request('copytrading/config', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
