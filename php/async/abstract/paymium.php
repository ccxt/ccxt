...
abstract class paymium extends \ccxt\async\Exchange {
    ...
    public function public_get_countries($params = array()) {
        return $this->request('countries', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
    ...
    public function public_get_data_currency_ticker($params = array()) {
        return $this->request('data/{currency}/ticker', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
    public function public_get_data_currency_trades($params = array()) {
        return $this->request('data/{currency}/trades', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function public_get_data_currency_depth($params = array()) {
        return $this->request('data/{currency}/depth', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
    public function public_get_bitcoin_charts_id_trades($params = array()) {
        return $this->request('bitcoin_charts/{id}/trades', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function public_get_bitcoin_charts_id_depth($params = array()) {
        return $this->request('bitcoin_charts/{id}/depth', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    ...
    public function private_get_user_addresses($params = array()) {
        return $this->request('user/addresses', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_get_user_addresses_address($params = array()) {
        return $this->request('user/addresses/{address}', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
    public function private_get_user_orders($params = array()) {
        return $this->request('user/orders', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_get_user_orders_uuid($params = array()) {
        return $this->request('user/orders/{uuid}', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
    ...
    public function private_get_merchant_get_payment_uuid($params = array()) {
        return $this->request('merchant/get_payment/{uuid}', 'private', 'GET', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_post_user_addresses($params = array()) {
        return $this->request('user/addresses', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_post_user_orders($params = array()) {
        return $this->request('user/orders', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_post_user_withdrawals($params = array()) {
        return $this->request('user/withdrawals', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_post_user_email_transfers($params = array()) {
        return $this->request('user/email_transfers', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
    public function private_post_user_payment_requests($params = array()) {
        return $this->request('user/payment_requests', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_post_user_price_alerts($params = array()) {
        return $this->request('user/price_alerts', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_post_merchant_create_payment($params = array()) {
        return $this->request('merchant/create_payment', 'private', 'POST', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_delete_user_orders_uuid($params = array()) {
        return $this->request('user/orders/{uuid}', 'private', 'DELETE', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_delete_user_orders_uuid_cancel($params = array()) {
        return $this->request('user/orders/{uuid}/cancel', 'private', 'DELETE', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<array<string, mixed>>
     */
    public function private_delete_user_price_alerts_id($params = array()) {
        return $this->request('user/price_alerts/{id}', 'private', 'DELETE', $params, null, null, array("cost" => 1));
    }
    /**
     * @return \React\Promise\PromiseInterface<list<mixed>>
     */
