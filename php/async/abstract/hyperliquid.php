...
abstract class hyperliquid extends \ccxt\async\Exchange {
    public function public_post_info($params = array()) {
        return $this->request('info', 'public', 'POST', $params, null, null, array("cost" => 20, "byType" => array("l2Book" => 2, "allMids" => 2, "clearinghouseState" => 2, "orderStatus" => 2, "spotClearinghouseState" => 2, "exchangeStatus" => 2, "candleSnapshot" => 3)));
    }
