...
abstract class alp extends \ccxt\async\Exchange {
    ...
    public function public_get_pairs($params = array()) {
        return $this->request('pairs/', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    public function public_get_orderbook_pair_name($params = array()) {
        return $this->request('orderbook/{pair_name}', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    public function public_get_exchanges($params = array()) {
        return $this->request('exchanges/', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    public function public_get_charts_pair_type_chart($params = array()) {
        return $this->request('charts/{pair}/{type}/chart/', 'public', 'GET', $params, null, null, array("cost" => 1));
    }
    ...
    public function private_get_wallets($params = array()) {
        return $this->request('wallets/', 'private', 'GET', $params, null, null, array("cost" => 50));
    }
    public function private_get_orders_own($params = array()) {
        return $this->request('orders/own/', 'private', 'GET', $params, null, null, array("cost" => 50));
    }
    public function private_get_order_id($params = array()) {
        return $this->request('order/{id}/', 'private', 'GET', $params, null, null, array("cost" => 50));
    }
    public function private_get_exchanges_own($params = array()) {
        return $this->request('exchanges/own/', 'private', 'GET', $params, null, null, array("cost" => 50));
    }
    public function private_get_deposits($params = array()) {
        return $this->request('deposits/', 'private', 'GET', $params, null, null, array("cost" => 50));
    }
    public function private_get_withdraws($params = array()) {
        return $this->request('withdraws/', 'private', 'GET', $params, null, null, array("cost" => 50));
    }
    public function private_post_order($params = array()) {
        return $this->request('order/', 'private', 'POST', $params, null, null, array("cost" => 50));
    }
    public function private_post_order_cancel($params = array()) {
        return $this->request('order-cancel/', 'private', 'POST', $params, null, null, array("cost" => 50));
    }
