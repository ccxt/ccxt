...
class anxpro extends Exchange {
    ...
    public function fetch_transactions($code = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->v3privatePostTransactionList (array_merge($request, $params));
        //
        //     {
        //         $transactions => array(
        //             array(
    ...
    public function fetch_currencies($params = array ()) : Generator {
        yield;
        $response = yield $this->v3publicGetCurrencyStatic ($params);
        //
        //   {
    ...
    public function fetch_balance($params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $response = yield $this->privatePostMoneyInfo ($params);
    ...
    public function fetch_order_book($symbol, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetCurrencyPairMoneyDepthFull (array_merge($request, $params));
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetCurrencyPairMoneyTicker (array_merge($request, $params));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->v3privatePostOrderList (array_merge($request, $params));
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostCurrencyPairMoneyOrders (array_merge($request, $params));
        //
        //     {
        //         "result" => "success",
        //         "data" => array(
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostCurrencyPairMoneyOrderAdd (array_merge($request, $params));
        return array(
            'info' => $response,
            'id' => $response['data'],
        );
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        yield;
        return yield $this->privatePostCurrencyPairMoneyOrderCancel (array( 'oid' => $id ));
    }
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostMoneyCurrencySendSimple (array_merge($request, $params));
        return array(
            'info' => $response,
    ...
    public function fetch_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostMoneyCurrencyAddress (array_merge($request, $params));
