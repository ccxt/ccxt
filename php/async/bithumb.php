...
class bithumb extends Exchange {
    ...
    public function cancel_unified_order(array $order, $params = array()): PromiseInterface {
        return Async\async(self::do_cancel_unified_order(...))($order, $params);
    }

    private function do_cancel_unified_order(array $order, $params = array()) {
        $request = array(
            'side' => $order['side'],
        );
    ...
    public function fetch_withdrawal_whitelist($params = array()): PromiseInterface {
        return Async\async(self::do_fetch_withdrawal_whitelist(...))($params);
    }

    private function do_fetch_withdrawal_whitelist($params = array()) {
        /**
