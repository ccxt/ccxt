...
use ccxt\async\abstract\mazdax as Exchange;
use \React\Async;
...
class mazdax extends Exchange {
    ...
    public function fetch_markets($params = array ()): PromiseInterface {
        return Async\async(function () use ($params) {
             ...
             */
            $response = Async\await($this->publicGetMarketSymbols ($params));
    ...
    public function fetch_tickers(?array $symbols = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbols, $params) {
            ...
            for ($i = 0; $i < count($markets); $i++) {
                ...
                try {
                    $response = Async\await($this->publicGetMarketRollingprice ($request));
                    // {
                    //   "AHRM1IRR" => {
                    //     "symbol" => "AHRM1IRR",
                    //     "priceChange" => "525",
    ...
    public function fetch_ohlcv(string $symbol, $timeframe = '1d', ?int $since = null, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $timeframe, $since, $limit, $params) {
            ...
            $response = Async\await($this->publicGetMarketCandle ($request));
            // {
            //   "Candles" => array(
            //     array(
    ...
    public function fetch_order_book(string $symbol, ?int $limit = null, $params = array ()): PromiseInterface {
        return Async\async(function () use ($symbol, $limit, $params) {
            ...
            $response = Async\await($this->publicGetMarketOrder ($request));
            // {
