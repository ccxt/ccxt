...
class zb extends Exchange {
    ...
    public function fetch_deposit_address($code, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetGetUserAddress (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        return yield $this->privateGetCancelOrder (array_merge($request, $params));
    }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetGetOrder (array_merge($request, $params));
        //
        //     {
        //         'total_amount' => 0.01,
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = 50, $params = array ()) : Generator {
        yield;
        if ($symbol === null) {
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = 10, $params = array ()) : Generator {
        yield;
        if ($symbol === null) {
