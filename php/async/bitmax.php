...
class bitmax extends Exchange {
    ...
    public function fetch_accounts($params = array ()) : Generator {
        ...
        if ($accountGroup === null) {
            $response = yield $this->privateGetUserInfo ($params);
            //
            //     {
            //         "$accountGroup" => 5
            //     }
    ...
    public function fetch_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrderCoid (array_merge($request, $params));
        //
        //     {
        //         'code' => 0,
        //         'status' => 'success', // this field will be deprecated soon
    ...
    public function fetch_order_trades($id, $symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrderFillsCoid (array_merge($request, $params));
        //
        //     {
        //         'code' => 0,
        //         'status' => 'success', // this field will be deprecated soon
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privateGetOrderOpen (array_merge($request, $params));
        //
        //     {
        //         'code' => 0,
        //         'status' => 'success', // this field will be deprecated soon
