...
class coinfloor extends Exchange {
    ...
    public function fetch_balance($params = array ()) {
        ...
        $response = yield $this->privatePostIdBalance (array_merge($request, $query));
        $result = array(
            'info' => $response,
        );
    ...
    public function fetch_trades($symbol, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->publicGetIdTransactions (array_merge($request, $params));
    ...
    public function fetch_ledger($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->privatePostIdUserTransactions (array_merge($request, $params));
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) {
        ...
        $response = yield $this->privatePostSymbolCancelOrder ($request);
        if ($response === 'false') {
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->privatePostIdOpenOrders (array_merge($request, $params));
        //   {
        //     "amount" => "1.0000",
