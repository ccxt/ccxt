...
class kuna extends acx {
    ...
    public function fetch_l3_order_book($symbol, $limit = null, $params = array ()) : Generator {
        yield;
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1m', $since = null, $limits = null, $params = array ()) : Generator {
        yield;
        yield $this->load_markets();
        $trades = yield $this->fetch_trades($symbol, $since, $limits, $params);
