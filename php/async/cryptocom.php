...
class cryptocom extends Exchange {
    ...
    public function fetch_tickers($symbols = null, $params = array ()) {
        ...
        for ($i = 0; $i < count($symbols); $i++) {
            ...
            if ($market !== null) {
                $unifiedSymbols[] = $market['symbol'];
            }
        }
        return $this->filter_by_array($result, 'symbol', $unifiedSymbols);
    }
    ...
    public function fetch_transfers($code = null, $since = null, $limit = null, $params = array ()) {
        ...
        $response = yield $this->spotPrivatePostPrivateDerivGetTransferHistory (array_merge($request, $params));
        //
        //     {
        //       id => '1641032709328',
