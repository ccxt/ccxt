...
class _1btcxe extends Exchange {
    ...
    public function fetch_balance($params = array ()) : Generator {
        ...
        $response = yield $this->privatePostBalancesAndInfo ($params);
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetStats (array_merge($request, $params));
    ...
    public function fetch_ohlcv($symbol, $timeframe = '1d', $since = null, $limit = null, $params = array ()) : Generator {
        ...
        $response = yield $this->publicGetHistoricalPrices (array_merge(array(
            'currency' => $market['id'],
    ...
    public function create_order($symbol, $type, $side, $amount, $price = null, $params = array ()) : Generator {
        ...
        $result = yield $this->privatePostOrdersNew (array_merge($request, $params));
        return array(
            'info' => $result,
            'id' => $result,
        );
    ...
    public function cancel_order($id, $symbol = null, $params = array ()) : Generator {
        ...
        return yield $this->privatePostOrdersCancel (array_merge($request, $params));
    }
    ...
    public function withdraw($code, $amount, $address, $tag = null, $params = array ()) : Generator {
        ...
        $response = yield $this->privatePostWithdrawalsNew (array_merge($request, $params));
        return array(
            'info' => $response,
