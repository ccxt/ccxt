...
class blofin extends Exchange {
    ...
    private function do_fetch_ohlcv(string $symbol, string $timeframe = '1m', ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_deterministic('fetchOHLCV', $symbol, $since, $limit, $timeframe, $query, 100));
        }
        ...
        $response = Async\await($this->publicGetMarketCandles($this->extend($request, $query)));
        $data = $this->safe_list($response, 'data', array());
    ...
    private function do_fetch_funding_rate_history(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($paginate) {
            return Async\await($this->fetch_paginated_call_deterministic('fetchFundingRateHistory', $symbol, $since, $limit, '8h', $query, 100));
        }
        $market = $this->market($symbol);
        $request = array(
            'instId' => $market['id'],
        ...
        $response = Async\await($this->publicGetMarketFundingRateHistory($this->extend($request, $query)));
        $rates = array();
        $data = $this->safe_list($response, 'data', array());
    ...
    private function do_fetch_balance($params = array()) {
        ...
        if ($accountType !== null && $accountType !== 'swap') {
            ...
            $response = Async\await($this->privateGetAssetBalances($this->extend($request, $paramsAccountType)));
        } else {
            $response = Async\await($this->privateGetAccountBalance($this->extend($request, $paramsAccountType)));
        }
    ...
    private function do_fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        if ($typeMarketType === 'spot') {
            ...
            //     }
            //
            $response = Async\await($this->privateGetSpotTradeFillsHistory($this->extend($requestUntil, $paramsMarketType)));
        } else {
            $response = Async\await($this->privateGetTradeFillsHistory($this->extend($requestUntil, $paramsMarketType)));
        }
        $data = $this->safe_list($response, 'data', array());
        return $this->parse_trades($data, $market, $since, $limit);
    }
    ...
    private function do_withdraw(string $code, float $amount, string $address, ?string $tag = null, $params = array()) {
        ...
        $response = Async\await($this->privatePostAssetWithdrawalApply($this->extend($request, $query)));
        //
        //     {
        //         "code": "0",
        //         "msg": "success",
    ...
    private function do_fetch_ledger(?string $code = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        list($requestUntil, $paramsUntil) = $this->handle_until_option('end', $request, $paramsPaginate);
        $response = Async\await($this->privateGetAssetBills($this->extend($requestUntil, $paramsUntil)));
        $data = $this->safe_list($response, 'data', array());
    ...
    private function do_fetch_positions_history(?array $symbols = null, ?int $since = null, ?int $limit = null, $params = array()) {
        ...
        $response = Async\await($this->privateGetAccountPositionsHistory($this->extend($requestUntil, $paramsUntil)));
        //
        //    {
        //        "code": "0",
        //        "msg": "success",
    ...
    private function do_fetch_leverages(?array $symbols = null, $params = array()) {
        ...
        $response = Async\await($this->privateGetAccountBatchLeverageInfo($this->extend($request, $query)));
        //
        //     {
        //         "code": "0",
        //         "msg": "success",
    ...
    private function do_fetch_leverage(string $symbol, $params = array()) {
        ...
        $response = Async\await($this->privateGetAccountLeverageInfo($this->extend($request, $query)));
        //
        //     {
        //         "code": "0",
        //         "msg": "success",
