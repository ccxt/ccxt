...
class bitflyer extends Exchange {
    ...
    public function fetch_ticker($symbol, $params = array ()) : Generator {
        ...
        $ticker = yield $this->publicGetGetticker (array_merge($request, $params));
    ...
    public function fetch_orders($symbol = null, $since = null, $limit = 100, $params = array ()) : Generator {
        yield;
        if ($symbol === null) {
    ...
    public function fetch_open_orders($symbol = null, $since = null, $limit = 100, $params = array ()) : Generator {
        yield;
        $request = array(
    ...
    public function fetch_closed_orders($symbol = null, $since = null, $limit = 100, $params = array ()) : Generator {
        yield;
        $request = array(
