...
use ccxt\abstract\revolutx as Exchange;
...
class revolutx extends Exchange {
    ...
    public function create_order(string $symbol, string $type, string $side, float $amount, ?float $price = null, $params = array()): array {
        ...
        $response = $this->privatePost10Orders($this->extend($request, $this->omit($params, array( 'cost', 'quote_size', 'clientOrderId', 'client_order_id', 'timeInForce', 'time_in_force', 'executionInstructions', 'execution_instructions' ))));
        //
        //     {
        //         "data" => array(
    ...
    public function cancel_all_orders(?string $symbol = null, $params = array()): array {
        ...
        $this->privateDelete10Orders($params);
        return array();
    }
    ...
    public function fetch_open_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()): array {
        ...
        $response = $this->privateGet10OrdersActive($this->extend($request, $this->omit($params, array( 'cursor', 'orderStates', 'order_states', 'orderTypes', 'order_types', 'side' ))));
        //
        //     {
    ...
    public function fetch_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()): array {
        ...
        $response = $this->privateGet10OrdersHistorical($this->extend($request, $this->omit($params, array( 'until', 'cursor', 'orderStates', 'order_states', 'orderTypes', 'order_types' ))));
        $data = $this->safe_list($response, 'data', array());
        $result = array();
        for ($i = 0; $i < count($data); $i++) {
            $order = $this->safe_dict($data, $i, array());
    ...
    public function fetch_closed_orders(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()): array {
        ...
        return $this->fetch_orders($symbol, $since, $limit, $requestParams);
    }
    ...
    public function fetch_my_trades(?string $symbol = null, ?int $since = null, ?int $limit = null, $params = array()): array {
        ...
        $response = $this->privateGet10TradesPrivateSymbol($this->extend($request, $this->omit($params, array( 'until' ))));
        //
        //     {
        //         "data" => array(
    ...
    public function edit_order(string $id, string $symbol, string $type, string $side, ?float $amount = null, ?float $price = null, $params = array()): array {
        ...
        $response = $this->privatePut10OrdersVenueOrderId($this->extend($request, $this->omit($params, array( 'clientOrderId', 'client_order_id', 'cost', 'quote_size', 'timeInForce', 'time_in_force', 'executionInstructions', 'execution_instructions' ))));
        //
        //     {
        //         "data" => array(
        //             array( "venue_order_id" => "7a52e92e-8639-4fe1-abaa-68d3a2d5234b", "client_order_id" => "...", "state" => "new" )
