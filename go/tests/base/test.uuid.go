...
func TestUuid() {
	...
	assert((ccxt.GetLength(id1) == 36), ccxt.Add("uuid() must return a 36-character string, returned id1: ", id1))
	assert((ccxt.GetLength(id2) == 36), ccxt.Add("uuid() must return a 36-character string, returned id2: ", id2))
	...
	assert((ccxt.GetLength(id16a) == 16), ccxt.Add("uuid16() must return a 16-character string, returned id16a: ", id16a))
	assert((ccxt.GetLength(id16b) == 16), ccxt.Add("uuid16() must return a 16-character string, returned id16b: ", id16b))
	...
	assert((ccxt.GetLength(id22a) == 22), ccxt.Add("uuid22() must return a 22-character string, returned id22a: ", id22a))
	assert((ccxt.GetLength(id22b) == 22), ccxt.Add("uuid22() must return a 22-character string, returned id22b: ", id22b))
}
