...
func HelperDefaultInputDict() any {
	return map[string]any{
		...
		"listOfDicts": []any{map[string]any{
			"a": 1,
		}},
		"str":          "heLlo",
		"strNumber":    "3",
...
func TestSafeValue() {
	...
	var dictObject any = exchange.SafeValue(inputDict, "dict")
	...
	// safeValueN
	Assert(ccxt.IsEqual(exchange.SafeValueN(inputDict, []any{"a", "b", "i"}), 1))
	Assert(ccxt.IsEqual(exchange.SafeValueN(inputDict, []any{"a", "b", "f"}), 0.123))
	Assert(ccxt.IsEqual(exchange.SafeValueN(inputDict, []any{"a", "b", "bool"}), true))
	Assert(Equals(exchange.SafeValueN(inputDict, []any{"a", "b", "list"}), compareList))
	dictObject = exchange.SafeValueN(inputDict, []any{"a", "b", "dict"})
	Assert(Equals(dictObject, compareDict))
	Assert(ccxt.IsEqual(exchange.SafeValueN(inputDict, []any{"a", "b", "str"}), "heLlo"))
	Assert(ccxt.IsEqual(exchange.SafeValueN(inputDict, []any{"a", "b", "strNumber"}), "3"))
	Assert(ccxt.IsEqual(exchange.SafeValueN(inputList, []any{3, 2, 0}), "Hi"))
}
func TestSafeDict() {
	exchange := ccxt.NewExchange().(*ccxt.Exchange)
	exchange.DerivedExchange = exchange
	...
	// safeDict
	var dictObject any = exchange.SafeDict(inputDict, "dict")
	Assert(Equals(dictObject, compareDict))
	var listObject any = exchange.SafeDict(inputDict, "list")
	...
	// safeDictN
	dictObject = exchange.SafeDictN(inputDict, []any{"a", "b", "dict"})
	Assert(Equals(dictObject, compareDict))
	listObject = exchange.SafeDictN(inputDict, []any{"a", "b", "list"})
	Assert(ccxt.IsEqual(listObject, nil))
	Assert(ccxt.IsEqual(exchange.SafeDictN(inputList, []any{3, 2, 1}), nil))
}
func TestSafeList() {
	exchange := ccxt.NewExchange().(*ccxt.Exchange)
	exchange.DerivedExchange = exchange
	...
	var arrayOfDicts any = exchange.SafeList(inputDict, "listOfDicts")
	Assert(Equals(ccxt.GetValue(arrayOfDicts, 0), map[string]any{
		"a": 1,
	}))
	// safeList2
	...
	// safeListN
	Assert(ccxt.IsEqual(exchange.SafeListN(inputDict, []any{"a", "b", "dict"}), nil))
	Assert(ccxt.IsEqual(exchange.SafeListN(inputList, []any{3, 2, 1}), nil))
}
func TestSafeInteger() {
	...
	// safeIntegerN
	Assert(ccxt.IsEqual(exchange.SafeIntegerN(inputDict, []any{"a", "b", "i"}), 1))
	Assert(ccxt.IsEqual(exchange.SafeIntegerN(inputDict, []any{"a", "b", "f"}), 0))
	Assert(ccxt.IsEqual(exchange.SafeIntegerN(inputDict, []any{"a", "b", "strNumber"}), 3))
	Assert(ccxt.IsEqual(exchange.SafeIntegerN(inputList, []any{3, 2, 1}), 2))
	// safeIntegerOmitZero
...
func TestSafeFloat() {
	...
	// safeFloatN
	// @ts-expect-error
	Assert(ccxt.IsEqual(exchange.SafeFloatN(inputDict, []any{"a", "b", "i"}), ccxt.ParseFloat(1)))
	Assert(ccxt.IsEqual(exchange.SafeFloatN(inputDict, []any{"a", "b", "f"}), 0.123))
	// @ts-expect-error
...
func TestSafeBool() {
	...
	// safeBoolN
	Assert(ccxt.IsEqual(exchange.SafeBoolN(inputDict, []any{"a", "b", "bool"}), true))
	Assert(ccxt.IsEqual(exchange.SafeBoolN(inputList, []any{3, 2, 1}), nil))
}
func TestCacheSafeCalls() {
	exchange := ccxt.NewExchange().(*ccxt.Exchange)
	exchange.DerivedExchange = exchange
	exchange.InitParent(map[string]any{
		"id": "sampleex",
	...
	var arrayCacheBySymbolByIdHashmap any = arrayCacheBySymbolById.Hashmap
	...
	var nestedMap any = arrayCacheHashmapDirect
	Assert(ccxt.IsEqual(exchange.SafeValue(nestedMap, "NONEXISTENT"), nil))
	// Test map[string]*ccxt.ArrayCache (Trades structure)
	var tradesMap map[string]any = map[string]any{
		"BTC/USDT": arrayCache,
		"ETH/USDT": arrayCacheBySymbolById,
	}
	var stored any = exchange.SafeValue(tradesMap, "BTC/USDT")
	Assert(!ccxt.IsEqual(stored, nil))
	// Use direct property access for hashmap (object attribute)
	var retrievedArrayCacheHashmap any = stored.(*ccxt.ArrayCache).Hashmap
	Assert(!ccxt.IsEqual(retrievedArrayCacheHashmap, nil))
	var retrievedArrayCacheBySymbolById any = exchange.SafeValue(tradesMap, "ETH/USDT")
	Assert(!ccxt.IsEqual(retrievedArrayCacheBySymbolById, nil))
	// Use direct property access for hashmap (object attribute)
	var retrievedArrayCacheBySymbolByIdHashmap any = retrievedArrayCacheBySymbolById.(*ccxt.ArrayCacheBySymbolById).Hashmap
	...
	var ohlcvInnerMap map[string]any = map[string]any{
		"1m": arrayCacheByTimestamp,
		"5m": ccxt.NewArrayCacheByTimestamp(100),
	}
	var retrievedArrayCacheByTimestamp any = exchange.SafeValue(ohlcvInnerMap, "1m")
	Assert(!ccxt.IsEqual(retrievedArrayCacheByTimestamp, nil))
	// Use direct property access for object attributes
	var retrievedArrayCacheByTimestampHashmap any = retrievedArrayCacheByTimestamp.(*ccxt.ArrayCacheByTimestamp).Hashmap
	...
	var cacheBySideMap map[string]any = map[string]any{
		"BTC/USDT": arrayCacheBySymbolBySide,
	}
	var retrievedArrayCacheBySymbolBySide any = exchange.SafeValue(cacheBySideMap, "BTC/USDT")
	Assert(!ccxt.IsEqual(retrievedArrayCacheBySymbolBySide, nil))
	var retrievedArrayCacheBySymbolBySideHashmap any = retrievedArrayCacheBySymbolBySide.(*ccxt.ArrayCacheBySymbolBySide).Hashmap
