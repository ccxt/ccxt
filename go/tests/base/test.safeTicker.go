...
func PreciseEqualStr(exchange *ccxt.Exchange, result any, key any, expected any) any  {
...
func TestSafeTicker()  {
    ...
    // CASE 1 - by open
    var ticker1 map[string]any = map[string]any {
        "open": 5,
        "change": 1,
    }
    ...
    // CASE 2 - by open
    var ticker2 map[string]any = map[string]any {
        "open": 5,
        "percentage": 20,
    }
    ...
    // CASE 3 - by close
    var ticker3 map[string]any = map[string]any {
        "close": 6,
        "change": 1,
    }
    ...
    // CASE 4 - by close
    var ticker4 map[string]any = map[string]any {
        "close": 6,
        "percentage": 20,
    }
    ...
    // CASE 5 - by average
    var ticker5 map[string]any = map[string]any {
        "average": 5.5,
        "percentage": 20,
    }
    ...
    // CASE 6
    var ticker6 map[string]any = map[string]any {
        "average": 5.5,
        "change": 1,
    }
    ...
    var ticker7 map[string]any = map[string]any {
        "open": 5,
        "close": 6,
    }
    ...
    // CASE 8 - full ticker
    var ticker8 map[string]any = map[string]any {
        "open": 5,
        "close": 6,
        "last": 6,
        "high": 6.5,
