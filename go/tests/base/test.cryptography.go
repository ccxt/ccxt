...
func TestCryptography() {
	...
	// ---------------------------------------------------------------------------------------------------------------------
	var privateKey any = "1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a"
	Assert(Equals(Ecdsa("1a", privateKey, secp256k1, sha256), map[string]any{
	...
	Assert(Equals(Ecdsa(privateKey, privateKey, secp256k1, nil), map[string]any{
	...
	Assert(IsEqual(Jwt(map[string]any{
		"chicken": "salad",
