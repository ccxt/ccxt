...
func TestCryptography()  {
    ...
    // ---------------------------------------------------------------------------------------------------------------------
    var privateKey interface{} = "1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a"
    Assert(Equals(Ecdsa("1a", privateKey, secp256k1, sha256), map[string]interface{} {
    ...
    Assert(Equals(Ecdsa(privateKey, privateKey, secp256k1, nil), map[string]interface{} {
    ...
    Assert(IsEqual(Jwt(map[string]interface{} {
    "chicken": "salad",
