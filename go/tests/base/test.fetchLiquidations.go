...
func TestFetchLiquidationsAsync(exchange ccxt.ICoreExchange, skippedProperties any, code any) <-chan any {
	ch := make(chan any, 1)
...
func testFetchLiquidationsBody(ch chan any, exchange ccxt.ICoreExchange, skippedProperties any, code any) any {
	...
	if IsEqual(GetValue(exchange.GetHas(), "fetchLiquidations"), nil) || IsEqual(GetValue(exchange.GetHas(), "fetchLiquidations"), false) {
