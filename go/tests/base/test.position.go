...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestPosition(exchange ccxt.ICoreExchange, skippedProperties any, method any, entry any, symbol any, now any)  {
        ...
        AssertInArray(exchange, skippedProperties, method, entry, "side", []any{"long", "short"})
        AssertInArray(exchange, skippedProperties, method, entry, "marginMode", []any{"cross", "isolated"})
