...
func TestStringToBase16() {
	...
	assert((result1 == expected1), ccxt.Add("stringToBase16 failed for \"hello\", expected: " + expected1 + ", got: ", result1))
	var result2 any = exchange.StringToBase16("world 1!@#$%^&*()")
	var expected2 string = "0x776f726c64203121402324255e262a2829"
	assert((result2 == expected2), ccxt.Add("stringToBase16 failed for \"world 1!@#$%^&*()\", expected: " + expected2 + ", got: ", result2))
}
