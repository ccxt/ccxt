...
func TestMicroseconds() {
	...
	var valueString string = strconv.FormatInt(value, 10)
	Assert((value > 0))
	Assert((len(valueString) == 16))
}
...
func TestYyyymmdd() {
	...
	var intNum any = exchange.ParseToInt(strings.Replace((strings.Replace(value2, "-", "", 1)), "-", "", 1))
