...
func TestFetchMarginModesAsync(exchange ccxt.ICoreExchange, skippedProperties any, symbol any) <-chan any {
	ch := make(chan any, 1)
...
func testFetchMarginModesBody(ch chan any, exchange ccxt.ICoreExchange, skippedProperties any, symbol any) any {
	...
	marginModes := (<-exchange.FetchMarginModesAsync([]any{symbol}))
