...
func TestOptionsNetworks(exchange ccxt.ICoreExchange, skippedProperties any) {
	if !IsTrue((InOp(skippedProperties, "networks"))) {
		...
		var allowedUnifiedAliases any = []any{"BTC", "ERC20", "ETH", "TRX", "TRC20", "BRC20", "CRONOS", "CRC20", "CRO", "BEP20", "BSC", "HECO", "HRC20", "HT", "OP", "OPTIMISM", "SPL", "SOL", "POLYGON", "MATIC", "CARDANO", "ADA", "ATOM", "COSMOS"}
