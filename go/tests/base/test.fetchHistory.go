...
func TestFetchHistoryBaseAsync() <-chan any {
	ch := make(chan any, 1)
...
func testFetchHistoryBaseBody(ch chan any) any {
...

	{
		func() (ret_ any) {
			...
			ccxt.PanicOnError((<-exchange.Fetch2Async("sample1")))
			return nil
		}()
...

	{
		func() (ret_ any) {
			...
			ccxt.PanicOnError((<-exchange.Fetch2Async("sample2")))
			return nil
		}()
...

	{
		func() (ret_ any) {
			...
			ccxt.PanicOnError((<-exchange.Fetch2Async("sample3")))
			return nil
		}()
...
func testFetchHistoryBody(ch chan any) any {
	...
	ccxt.PanicOnError((<-TestFetchHistoryBaseAsync()))
	return nil
}
