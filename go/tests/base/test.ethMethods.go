...
func TestEthMethods() {
	...
	assert((ccxt.ToLower(generatedAddress) == ccxt.ToLower(publicKey)), "ethGetAddressFromPrivateKey did not generate the expected address: " + generatedAddress + " != " + publicKey)
}
