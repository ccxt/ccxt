...
func TestFetchLeverageTiersAsync(exchange ccxt.ICoreExchange, skippedProperties any, symbol any) <-chan any {
	ch := make(chan any, 1)
...
func testFetchLeverageTiersBody(ch chan any, exchange ccxt.ICoreExchange, skippedProperties any, symbol any) any {
	...
	tiers := (<-exchange.FetchLeverageTiersAsync([]any{symbol}))
	PanicOnError(tiers)
	// const format = {
	//     'RAY/USDT': [
	//       {},
