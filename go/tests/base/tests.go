...
func  (this *testMainClass) AssertPredictionEvent(exchange ccxt.ICoreExchange, event any) any  {
    ...
    if IsTrue(!IsEqual(active, nil)) {
        Assert(IsTrue((IsEqual(active, true))) || IsTrue((IsEqual(active, false))), Add(Add(exchange.GetId(), " event active must be a bool"), logText))
    }
...
func  (this *testMainClass) TestPredictionCreateCancelOrder(exchange ccxt.ICoreExchange, outcome any) <- chan any {
            ...
            retRes10528 := (<-this.CancelPredictionOrder(exchange, placedId, outcome))
            ...
            go func() any {
            ...
            
                {
                     func(this *testMainClass) (ret_ any) {
                        ...
                        retRes106616 := (<-CallExchangeMethodDynamically(exchange, "cancelOrder", []any{orderId, outcome}))
                        PanicOnError(retRes106616)
                    } else {
            
                        retRes106816 := (<-CallExchangeMethodDynamically(exchange, "cancelAllOrders", []any{outcome}))
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.ICoreExchange, symbol any) <- chan any {
            ...
            retRes11668 := (<-this.RunTests(exchange, tests, false))
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                
                    {
                         func(this *testMainClass) (ret_ any) {
                            ...
                            retRes118616 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes118616)
                                        return nil
                                    }(this)
                                }
                            }()
                            ...
                            retRes118216 := (<-this.TestMethod(proxyTestName, exchange, []any{}, true))
                            PanicOnError(retRes118216)
            ...
            
                {
                    ...
                    if !IsTrue(result) {
                        if !IsTrue(IsSync()) {
                            ...
                            retRes124420 := (<-Close(exchange))
                            PanicOnError(retRes124420)
                        }
                    ...
                    retRes125212 := (<-this.TestExchange(exchange, symbolArgv))
                    PanicOnError(retRes125212)
                    if !IsTrue(IsSync()) {
            
                        retRes125416 := (<-Close(exchange))
            ...
            if IsTrue(this.Info) {
            ...
            
                {
                    ...
                    requestUrl = exchange.GetLast_request_url()
                        ...
                        retRes161516 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName any, exchangeData any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes184116 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes184116)
                    // reset options
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName any, exchangeData any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes191616 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes191616)
                    // reset options
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...any) <- chan any {
            ...
            retRes19828 := (<-this.RunStaticTests("request", targetExchange, testName))
...
func  (this *testMainClass) RunStaticTests(typeVar any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(exchanges)); i++ {
            ...
            
                {
                    ...
                    retRes202312 := (<-promiseAll(promises))
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...any) <- chan any {
            ...
            retRes20478 := (<-this.RunStaticTests("response", exchangeName, test))
...
func  (this *testMainClass) RunBrokerIdTests() <- chan any {
        ...
        retRes20858 := (<-promiseAll(promises))
...
func  (this *testMainClass) TestBinance() <- chan any {
        ...
        var spotOrderRequest any = map[string]any {}
            ...
            retRes209912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = map[string]any {}
            ...
            retRes210912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes210912)
        		    return nil
        	    }(this)
        ...
        var swapInverseOrderRequest any = map[string]any {}
            ...
            retRes211512 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
        ...
        var swapAlgoOrderRequest any = map[string]any {}
            ...
            retRes212912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 0.002, 102000, map[string]any {
                "triggerPrice": 101000,
            }))
        ...
        var createOrdersRequest any = map[string]any {}
            ...
            retRes215612 := (<-exchange.CreateOrders(orders))
...
func  (this *testMainClass) TestOkx() <- chan any {
        ...
        var spotOrderRequest any = map[string]any {}
            ...
            retRes217712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = map[string]any {}
            ...
            retRes218812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptocom() <- chan any {
        ...
        retRes22058 := (<-exchange.LoadMarkets())
        ...
        var request any = map[string]any {}
            ...
            retRes220812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBybit() <- chan any {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "brokerId"), id), "id not in options")
            ...
            retRes222612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestKucoin() <- chan any {
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoin - key: ", futureKey), " not in options."))
            ...
            retRes225112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for spot orders."))
            ...
            retRes225912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000, map[string]any {
                "uta": true,
            }))
        ...
        id = "ccxtfutures"
            ...
            retRes226612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for swap orders."))
            ...
            retRes227212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any {
                "uta": true,
            }))
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes227812 := (<-Close(exchange))
            PanicOnError(retRes227812)
        }
...
func  (this *testMainClass) TestKucoinfutures() <- chan any {
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoinfutures - key: ", futureKey), " not in options."))
            ...
            retRes229312 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoinfutures - id: ", id), " not in headers."))
            ...
            retRes230012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestMexc() <- chan any {
        ...
        retRes23338 := (<-exchange.LoadMarkets())
        PanicOnError(retRes23338)
            ...
            retRes233512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestHtx() <- chan any {
        ...
        var spotOrderRequest any = map[string]any {}
            ...
            retRes235212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest any = map[string]any {}
            ...
            retRes236812 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoo() <- chan any {
        ...
        var stopOrderRequest any = map[string]any {}
            ...
            retRes239812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any {
                "stopPrice": 30000,
            }))
...
func  (this *testMainClass) TestBitmart() <- chan any {
        ...
        retRes24158 := (<-exchange.LoadMarkets())
        PanicOnError(retRes24158)
            ...
            retRes241712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBlofin() <- chan any {
        ...
        var request any = map[string]any {}
            ...
            retRes248812 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan any {
        ...
        var request any = map[string]any {}
            ...
            retRes252512 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan any {
        ...
        var request any = map[string]any {}
            ...
            retRes254312 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoofiPro() <- chan any {
        ...
        retRes25628 := (<-exchange.LoadMarkets())
        ...
        var request any = map[string]any {}
            ...
            retRes256512 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestParadex() <- chan any {
        ...
        PanicOnError(retRes26158)
            ...
            retRes261712 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptomus() <- chan any {
        ...
        var request any = map[string]any {}
            ...
            retRes264912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "sell", 1, 20000))
...
func  (this *testMainClass) TestDerive() <- chan any {
        ...
        var request any = map[string]any {}
            ...
            retRes267712 := (<-exchange.CreateOrder("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func  (this *testMainClass) TestModeTrade() <- chan any {
        ...
        retRes26958 := (<-exchange.LoadMarkets())
        ...
        var request any = map[string]any {}
            ...
            retRes269812 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBackpack() <- chan any {
        ...
        var id any = "1400"
            ...
            retRes271712 := (<-exchange.CreateOrder("ETH/USDC", "limit", "buy", 1, 5000))
...
func  (this *testMainClass) TestWeex() <- chan any {
        ...
        var request any = map[string]any {}
            ...
            retRes275212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
