...
type testMainClass struct {
    ...
    StaticTests bool `default:"false"`
...
func  (this *testMainClass) Init(exchangeId interface{}, symbolArgv interface{}, methodArgv interface{}) <- chan interface{} {
            ...
            if IsTrue(IsTrue(this.RequestTests) && IsTrue(this.ResponseTests)) {
                ...
                retRes655 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
                PanicOnError(retRes655)
        
                retRes292 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
                PanicOnError(retRes292)
            ...
            if IsTrue(this.ResponseTests) {
                ...
                retRes531 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
                PanicOnError(retRes531)
            ...
            if IsTrue(this.RequestTests) {
                ...
                retRes498 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
                PanicOnError(retRes498) // symbol here is the testname
            ...
            if IsTrue(this.IdTests) {
                ...
                retRes631 := (<-this.RunBrokerIdTests())
                PanicOnError(retRes631)
            ...
            retRes637 := (<-this.ImportFiles(exchange))
            PanicOnError(retRes637)
            ...
            retRes906 := (<-this.StartTest(exchange, symbolArgv))
            PanicOnError(retRes906)
...
func  (this *testMainClass) ExpandSettings(exchange ccxt.IExchange)  {
    ...
    var globalSettings interface{} = Ternary(IsTrue(keysGlobalExists), IoFileRead(keysGlobal), map[string]interface{} {})
    var localSettings interface{} = Ternary(IsTrue(keysLocalExists), IoFileRead(keysLocal), map[string]interface{} {})
...
func  (this *testMainClass) TestMethod(methodName interface{}, exchange ccxt.IExchange, args interface{}, isPublic interface{}) <- chan interface{} {
            ...
            if IsTrue(isLoadMarkets) {
                ...
                retRes529 := (<-exchange.LoadMarkets(true))
                PanicOnError(retRes529)
            }
            ...
            if IsTrue(IsSync()) {
                ...
                retRes156 := (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
                PanicOnError(retRes156)
            }
            if IsTrue(this.Info) {
            ...
            for i := 0; IsLessThan(i, maxRetries); i++ {
                ...
                {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                		defer func() {
                            ...
                            if IsTrue(isOperationFailed) {
                                ...
                                if IsTrue(IsEqual(i, Subtract(maxRetries, 1))) {
                                    ...
                                    retRes91 := (<-exchange.Sleep(Multiply((Add(i, 1)), 1000)))
                                    PanicOnError(retRes91)
                                }
                            } else {
                		...
                		// try block:
                            ...
                            retRes90 := (<-this.TestMethod(methodName, exchange, args, isPublic))
                            PanicOnError(retRes90)
...
func  (this *testMainClass) RunPublicTests(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
            ...
            retRes930 := (<-this.RunTests(exchange, tests, true))
            PanicOnError(retRes930)
...
func  (this *testMainClass) TestExchange(exchange ccxt.IExchange, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    retRes779 := (<-this.RunPublicTests(exchange, spotSymbol))
                    PanicOnError(retRes779)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    ...
                    retRes903 := (<-this.RunPublicTests(exchange, swapSymbol))
                    PanicOnError(retRes903)
                }
            }
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    retRes904 := (<-this.RunPrivateTests(exchange, spotSymbol))
                    PanicOnError(retRes904)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
        
                    retRes629 := (<-this.RunPrivateTests(exchange, swapSymbol))
                    PanicOnError(retRes629)
                }
            }
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
            ...
            retRes727 := (<-this.RunTests(exchange, tests, false))
            PanicOnError(retRes727)
                return nil
            }()
            return ch
        }
func  (this *testMainClass) TestProxies(exchange ccxt.IExchange) <- chan interface{} {
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                ...
                {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                		defer func() {
                            ...
                            retRes797 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes797)
                                    return nil
                				}(this)
                			}
                		}()
                		// try block:
                            ...
                            retRes529 := (<-this.TestMethod(proxyTestName, exchange, []interface{}{}, true))
                            PanicOnError(retRes529)
            ...
            if IsTrue(!IsEqual(exception, nil)) {
                ...
                Dump(Add("[TEST_WARNING]", ToString(errorMessage)))
            }
...
func  (this *testMainClass) StartTest(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		defer func() {
                        ...
                        retRes568 := (<-Close(exchange))
                        PanicOnError(retRes568)
                    }
                    panic(e)
                                return nil
            				}(this)
                    ...
                    if !IsTrue(result) {
                        if !IsTrue(IsSync()) {
                            ...
                            retRes474 := (<-Close(exchange))
                            PanicOnError(retRes474)
                        }
                    ...
                    retRes649 := (<-this.TestExchange(exchange, symbol))
                    PanicOnError(retRes649)
                    if !IsTrue(IsSync()) {
            
                        retRes798 := (<-Close(exchange))
                        PanicOnError(retRes798)
                    }
            		return nil
            	}(this)
            	if ret__ != nil {
...
func  (this *testMainClass) AssertStaticError(cond interface{}, message interface{}, calculatedOutput interface{}, storedOutput interface{}, optionalArgs ...interface{})  {
    ...
    var errorMessage interface{} = Add(Add(Add(Add(message, " computed "), storedString), " stored: "), calculatedString)
...
func  (this *testMainClass) AssertNewAndStoredOutput(exchange ccxt.IExchange, skipKeys interface{}, newOutput interface{}, storedOutput interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    if IsTrue(IsTrue((IsObject(storedOutput))) && IsTrue((IsObject(newOutput)))) {
        ...
        if IsTrue(IsTrue(strictTypeCheck) && IsTrue((!IsEqual(this.Lang, "C#")))) {
            ...
            var isBoolean interface{} = IsTrue((IsBool(sanitizedNewOutput))) || IsTrue((IsBool(sanitizedStoredOutput)))
            var isString interface{} = IsTrue((IsString(sanitizedNewOutput))) || IsTrue((IsString(sanitizedStoredOutput)))
            var isUndefined interface{} = IsTrue((IsEqual(sanitizedNewOutput, nil))) || IsTrue((IsEqual(sanitizedStoredOutput, nil))) // undefined is a perfetly valid value
...
func  (this *testMainClass) TestRequestStatically(exchange ccxt.IExchange, method interface{}, data interface{}, typeVar interface{}, skipKeys interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		...
            		// try block:
                        ...
                        retRes466 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
                        PanicOnError(retRes466)
                    } else {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                    ...
                    var errorMessage interface{} = Add(Add(Add(Add(Add(Add(Add(Add(Add(Add(Add(Add("[", this.Lang), "][STATIC_REQUEST_TEST_FAILURE]"), "["), exchange.GetId()), "]"), "["), method), "]"), "["), GetValue(data, "description")), "]"), ToString(e))
...
func  (this *testMainClass) TestResponseStatically(exchange ccxt.IExchange, method interface{}, skipKeys interface{}, data interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                    ...
                    var errorMessage interface{} = Add(Add(Add(Add(Add(Add(Add(Add(Add(Add(Add(Add("[", this.Lang), "][STATIC_RESPONSE_TEST_FAILURE]"), "["), exchange.GetId()), "]"), "["), method), "]"), "["), GetValue(data, "description")), "]"), ToString(e))
                    Dump(Add("[TEST_FAILURE]", errorMessage))
                                return nil
            				}(this)
            			}
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                fmt.Println("method:" + ToString(method))
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    fmt.Println("before testing" + ToString(description))
                    retRes549 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes549)
                    fmt.Println("after testing" + ToString(method))
                    // reset options
                    ...
                    fmt.Println("after resetting options")
                }
            }
            if !IsTrue(IsSync()) {
                fmt.Println("before closing exchange")
                retRes177 := (<-Close(exchange))
                PanicOnError(retRes177)
            }
            fmt.Println(("after testing the entire exhchange"))
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes498 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes498)
                    // reset options
                    // exchange.Setoptions(exchange.GetdeepExtend() (oldExchangeOptions, {});)
                    exchange.ExtendExchangeOptions(exchange.DeepExtend(oldExchangeOptions, map[string]interface{} {}))
                }
            ...
            if !IsTrue(IsSync()) {
                ...
                retRes955 := (<-Close(exchange))
                PanicOnError(retRes955)
            }
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835 := (<-this.RunStaticTests("request", targetExchange, testName))
            PanicOnError(retRes835)
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes149 := (<-this.RunStaticTests("response", exchangeName, test))
            PanicOnError(retRes149)
...
func  (this *testMainClass) TestBinance() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes747 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes747)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes718 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes718)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes239 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
            PanicOnError(retRes239)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes374 := (<-Close(exchange))
            PanicOnError(retRes374)
        }
...
func  (this *testMainClass) TestOkx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes981 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes981)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes662 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes662)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes898 := (<-Close(exchange))
            PanicOnError(retRes898)
        }
...
func  (this *testMainClass) TestCryptocom() <- chan interface{} {
        ...
        retRes551 := (<-exchange.LoadMarkets())
        PanicOnError(retRes551)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes859 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes859)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes970 := (<-Close(exchange))
            PanicOnError(retRes970)
        }
...
func  (this *testMainClass) TestBybit() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes547 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes547)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes919 := (<-Close(exchange))
            PanicOnError(retRes919)
        }
...
func  (this *testMainClass) TestKucoin() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes497 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes497)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
...
func  (this *testMainClass) TestKucoinfutures() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes156 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes156)
        		return nil
        	}(this)
        	if ret__ != nil {
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes325 := (<-Close(exchange))
            PanicOnError(retRes325)
        }
...
func  (this *testMainClass) TestBitget() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes222 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes222)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes696 := (<-Close(exchange))
            PanicOnError(retRes696)
        }
...
func  (this *testMainClass) TestMexc() <- chan interface{} {
        ...
        retRes992 := (<-exchange.LoadMarkets())
        PanicOnError(retRes992)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes360 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes360)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes179 := (<-Close(exchange))
            PanicOnError(retRes179)
        }
...
func  (this *testMainClass) TestHtx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes507 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes507)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes870 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes870)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes979 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
            PanicOnError(retRes979)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes494 := (<-Close(exchange))
            PanicOnError(retRes494)
        }
...
func  (this *testMainClass) TestWoo() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes292 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes292)
        		return nil
        	}(this)
        	if ret__ != nil {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes686 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "stopPrice": 30000,
            }))
            PanicOnError(retRes686)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes670 := (<-Close(exchange))
            PanicOnError(retRes670)
        }
...
func  (this *testMainClass) TestBitmart() <- chan interface{} {
        ...
        retRes824 := (<-exchange.LoadMarkets())
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes587 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes587)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes308 := (<-Close(exchange))
            PanicOnError(retRes308)
        }
...
func  (this *testMainClass) TestCoinex() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes638 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes638)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes228 := (<-Close(exchange))
            PanicOnError(retRes228)
        }
...
func  (this *testMainClass) TestBingx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes633 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes633)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
...
func  (this *testMainClass) TestPhemex() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes700 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes700)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes490 := (<-Close(exchange))
            PanicOnError(retRes490)
        }
...
func  (this *testMainClass) TestBlofin() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes909 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
            PanicOnError(retRes909)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes197 := (<-Close(exchange))
            PanicOnError(retRes197)
        }
...
func  (this *testMainClass) TestHyperliquid() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes961 := (<-exchange.CreateOrder("SOL/USDC:USDC", "limit", "buy", 1, 100))
            PanicOnError(retRes961)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes262 := (<-Close(exchange))
            PanicOnError(retRes262)
        }
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes486 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes486)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes767 := (<-Close(exchange))
            PanicOnError(retRes767)
        }
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes103 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes103)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
...
func  (this *testMainClass) TestWoofiPro() <- chan interface{} {
        ...
        retRes959 := (<-exchange.LoadMarkets())
        PanicOnError(retRes959)
        var request interface{} = nil
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes332 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes332)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes105 := (<-Close(exchange))
            PanicOnError(retRes105)
        }
...
func  (this *testMainClass) TestOxfun() <- chan interface{} {
        ...
        retRes300 := (<-exchange.LoadMarkets())
        PanicOnError(retRes300)
        var request interface{} = nil
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes647 := (<-exchange.CreateOrder("BTC/USD:OX", "limit", "buy", 1, 20000))
            PanicOnError(retRes647)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
...
func  (this *testMainClass) TestXT() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes559 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes559)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes878 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes934 := (<-Close(exchange))
            PanicOnError(retRes934)
        }
...
func  (this *testMainClass) TestVertex() <- chan interface{} {
        ...
        retRes775 := (<-exchange.LoadMarkets())
        PanicOnError(retRes775)
        var request interface{} = nil
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes632 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes632)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes905 := (<-Close(exchange))
            PanicOnError(retRes905)
        }
...
func  (this *testMainClass) TestParadex() <- chan interface{} {
        ...
        retRes789 := (<-exchange.LoadMarkets())
        PanicOnError(retRes789)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes319 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes319)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes401 := (<-Close(exchange))
            PanicOnError(retRes401)
        }
...
func  (this *testMainClass) TestHashkey() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes610 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes610)
        		return nil
        	}(this)
        	if ret__ != nil {
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes31 := (<-Close(exchange))
            PanicOnError(retRes31)
        }
