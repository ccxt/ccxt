	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes10212 := (<-this.InitInner(exchangeId, symbolArgv, methodArgv))
...
func (this *testMainClass) InitInner(exchangeId any, symbolArgv any, methodArgv any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(this.RequestTests) && IsTrue(this.ResponseTests)) {
			...
			retRes11412 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
			PanicOnError(retRes11412)

			retRes11512 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
		...
		if IsTrue(this.StaticWsTests) {
			...
			retRes12312 := (<-this.RunStaticWsTests(exchangeId, symbolArgv))
		...
		if IsTrue(this.RequestTests) {
			...
			retRes12712 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
			PanicOnError(retRes12712) // symbol here is the testname
		...
		if IsTrue(this.IdTests) {
			...
			retRes13112 := (<-this.RunBrokerIdTests())
			PanicOnError(retRes13112)
		...
		retRes1478 := (<-this.ImportFiles(exchange))
		PanicOnError(retRes1478)
		...
		retRes1528 := (<-this.StartTest(exchange, symbolArgv))
...
func (this *testMainClass) TestMethod(methodName any, exchange ccxt.ICoreExchange, args any, isPublic any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(isLoadMarkets) {
			...
			retRes31312 := (<-exchange.LoadMarkets(true))
			PanicOnError(retRes31312)
		...
		if IsTrue(IsSync()) {
			...
			retRes32712 := (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
			PanicOnError(retRes32712)
		}
		Dump(this.AddPadding("[INFO] TESTING DONE", 25), name, methodName)
		...
		for i := 0; IsLessThan(i, maxRetries); i++ {

			{
				func(this *testMainClass) (ret_ any) {
							...
							ret_ = func(this *testMainClass) any {
								...
								if IsTrue(isOperationFailed) {
									...
									if IsTrue(IsEqual(i, Subtract(maxRetries, 1))) {
										...
										retRes45024 := (<-exchange.Sleep(Multiply((Add(i, 1)), 1000)))
										PanicOnError(retRes45024)
									}
								} else {
					...
					retRes40016 := (<-this.TestMethod(methodName, exchange, args, isPublic))
					PanicOnError(retRes40016)
...
func (this *testMainClass) RunPublicTests(exchange ccxt.ICoreExchange, symbols any) <-chan any {
	...
	go func() any {
		...
		retRes5368 := (<-this.RunTests(exchange, tests, true))
...
func (this *testMainClass) TestExchange(exchange ccxt.ICoreExchange, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(exchange.SafeBool(exchange.GetHas(), "prediction", false)) {
			...
			retRes74212 := (<-this.RunPredictionTests(exchange))
		...
		if !IsTrue(this.PrivateTestOnly) {
			...
			if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
				...
				retRes78816 := (<-this.RunPublicTests(exchange, spotSymbols))
				PanicOnError(retRes78816)
			}
			if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
				...
				retRes79516 := (<-this.RunPublicTests(exchange, swapSymbols))
				PanicOnError(retRes79516)
			}
		}
		if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
			if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
				...
				retRes80116 := (<-this.RunPrivateTests(exchange, spotSymbols))
				PanicOnError(retRes80116)
			}
			if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
				AddElementToObject(exchange.GetOptions(), "defaultType", "swap")

				retRes80516 := (<-this.RunPrivateTests(exchange, swapSymbols))
...
func (this *testMainClass) RunPredictionTests(exchange ccxt.ICoreExchange) <-chan any {
	...
	go func() any {
					...
					if !IsTrue(allowUnscopedFetchEvents) {
...

						{
							func(this *testMainClass) (ret_ any) {
								...
								retRes87624 := (<-CallExchangeMethodDynamically(exchange, "fetchEvents", []any{map[string]any{}}))
								PanicOnError(retRes87624)
								return nil
							}(this)
			...
			if IsTrue(!IsTrue(canServeAllTickers) && IsTrue(exchange.SafeBool(exchange.GetHas(), "fetchTickers", false))) {
...

				{
					func(this *testMainClass) (ret_ any) {
						...
						retRes95820 := (<-CallExchangeMethodDynamically(exchange, "fetchTickers", []any{}))
						PanicOnError(retRes95820)
						return nil
					}(this)
		...
		if !IsTrue(this.PrivateTestOnly) {
			...
			retRes98612 := (<-this.RunTests(exchange, publicTests, true))
		...
		if IsTrue(IsTrue((IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly))) && !IsTrue(this.WsTests)) {
			...
			retRes99812 := (<-this.RunTests(exchange, privateTests, false))
			...
			if IsTrue(GetCliArgValue("--fundedTests")) {
				...
				retRes100116 := (<-this.TestPredictionCreateCancelOrder(exchange, outcomeSymbol))
				PanicOnError(retRes100116)
			}
		}
...
func (this *testMainClass) TestPredictionCreateCancelOrder(exchange ccxt.ICoreExchange, outcome any) <-chan any {
	...
	go func() any {
		...
		retRes11128 := (<-this.CancelPredictionOrder(exchange, placedId, outcome))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				if IsTrue(exchange.SafeBool(exchange.GetHas(), "cancelOrder", false)) {
					...
					retRes112616 := (<-CallExchangeMethodDynamically(exchange, "cancelOrder", []any{orderId, outcome}))
					PanicOnError(retRes112616)
				} else {

					retRes112816 := (<-CallExchangeMethodDynamically(exchange, "cancelAllOrders", []any{outcome}))
...
func (this *testMainClass) RunPrivateTests(exchange ccxt.ICoreExchange, symbol any) <-chan any {
	...
	go func() any {
		...
		retRes12268 := (<-this.RunTests(exchange, tests, false))
		...
		for j := 0; IsLessThan(j, maxRetries); j++ {

			{
				func(this *testMainClass) (ret_ any) {
					defer func() {
						if e := recover(); e != nil {
							...
							ret_ = func(this *testMainClass) any {
								...
								retRes124616 := (<-exchange.Sleep(Multiply(j, 1000)))
								PanicOnError(retRes124616)
								return nil
							}(this)
						}
					}()
					...
					retRes124216 := (<-this.TestMethod(proxyTestName, exchange, []any{}, true))
			...
			func(this *testMainClass) (ret_ any) {
					...
					if e := recover(); e != nil {
						...
						ret_ = func(this *testMainClass) any {
							...
							if !IsTrue(IsSync()) {
								...
								retRes131816 := (<-Close(exchange))
								PanicOnError(retRes131816)
							}
							panic(e)
				...
				if !IsTrue(result) {
					if !IsTrue(IsSync()) {
						...
						retRes130420 := (<-Close(exchange))
						PanicOnError(retRes130420)
					}
				...
				retRes131212 := (<-this.TestExchange(exchange, symbolArgv))
				PanicOnError(retRes131212)
				if !IsTrue(IsSync()) {

					retRes131416 := (<-Close(exchange))
					PanicOnError(retRes131416)
				}
				return nil
			}(this)
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				if !IsTrue(IsSync()) {
					...
					retRes167816 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
					PanicOnError(retRes167816)
				} else {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				if IsTrue(!IsEqual(expectedResults, nil)) {
					...
					retRes178616 := (<-promiseAll(promises))
					PanicOnError(retRes178616)
				} else {
	...
	go func() any {
		...
		for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
			...
			for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
				...
				retRes185316 := (<-this.TestWsStatically(exchange, method, skipKeys, result))
				PanicOnError(retRes185316)
				if !IsTrue(IsSync()) {

					retRes185520 := (<-Close(exchange))
					PanicOnError(retRes185520)
				}
			}
		}
	...
	go func() any {
		...
		for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
			...
			for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
				...
				retRes204816 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
				PanicOnError(retRes204816)
				// reset options
	...
	go func() any {
		...
		for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
			...
			for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
				...
				retRes212316 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
				PanicOnError(retRes212316)
				// reset options
...
func (this *testMainClass) RunStaticRequestTests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes21898 := (<-this.RunStaticTests("request", targetExchange, testName))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes223212 := (<-promiseAll(promises))
...
func (this *testMainClass) RunStaticResponseTests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22588 := (<-this.RunStaticTests("response", exchangeName, test))
...
func (this *testMainClass) RunStaticWsTests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22718 := (<-this.RunStaticTests("ws", exchangeName, test))
...
func (this *testMainClass) RunBrokerIdTests() <-chan any {
	...
	go func() any {
		...
		retRes23098 := (<-promiseAll(promises))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes232312 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes233312 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes233912 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes235312 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 0.002, 102000, map[string]any{
					"triggerPrice": 101000,
				}))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes238012 := (<-exchange.CreateOrders(orders))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes240112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes241212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) TestCryptocom() <-chan any {
	...
	go func() any {
		...
		retRes24298 := (<-exchange.LoadMarkets())
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes243212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes245012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes247512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes248312 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000, map[string]any{
					"uta": true,
				}))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes249012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes249612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any{
					"uta": true,
				}))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes252412 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
				PanicOnError(retRes252412)
				return nil
			}(this)
...
func (this *testMainClass) TestMexc() <-chan any {
	...
	go func() any {
		...
		retRes25578 := (<-exchange.LoadMarkets())
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes255912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes257612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes258612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes259212 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes261212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes262212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any{
					"stopPrice": 30000,
				}))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes264012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes265912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes267612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
		...
		if !IsTrue(IsSync()) {
			...
			retRes268412 := (<-Close(exchange))
			PanicOnError(retRes268412)
		}
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes269412 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes273112 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes274912 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
...
func (this *testMainClass) TestWoofiPro() <-chan any {
	...
	go func() any {
		...
		retRes27688 := (<-exchange.LoadMarkets())
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes277112 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes278812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes279612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) TestParadex() <-chan any {
	...
	go func() any {
		...
		retRes28218 := (<-exchange.LoadMarkets())
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes282312 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes283912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes285512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "sell", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes288312 := (<-exchange.CreateOrder("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func (this *testMainClass) TestModeTrade() <-chan any {
	...
	go func() any {
		...
		retRes29018 := (<-exchange.LoadMarkets())
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes292312 := (<-exchange.CreateOrder("ETH/USDC", "limit", "buy", 1, 5000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes295812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes296512 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
	...
	go func() any {
...

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes297812 := (<-exchange.CreateOrder("BTC/BRL", "limit", "buy", 1, 20000))
