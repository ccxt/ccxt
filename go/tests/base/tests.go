...
func  (this *testMainClass) TestExchange(exchange ccxt.ICoreExchange, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    retRes72716 := (<-this.RunPublicTests(exchange, spotSymbol))
                    PanicOnError(retRes72716)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    ...
                    retRes73416 := (<-this.RunPublicTests(exchange, swapSymbol))
                    PanicOnError(retRes73416)
                }
            }
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    retRes74016 := (<-this.RunPrivateTests(exchange, spotSymbol))
                    PanicOnError(retRes74016)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
        
                    retRes74416 := (<-this.RunPrivateTests(exchange, swapSymbol))
                    PanicOnError(retRes74416)
                }
            }
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.ICoreExchange, symbol interface{}) <- chan interface{} {
            ...
            retRes8388 := (<-this.RunTests(exchange, tests, false))
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                
                    {
                         func(this *testMainClass) (ret_ interface{}) {
                            ...
                            retRes85816 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes85816)
                                        return nil
                                    }(this)
                                }
                            }()
                            ...
                            retRes85416 := (<-this.TestMethod(proxyTestName, exchange, []interface{}{}, true))
                            PanicOnError(retRes85416)
            ...
            if IsTrue(IsTrue(this.Sandbox) || IsTrue(GetExchangeProp(exchange, "sandbox"))) {
            ...
            
                {
                     func(this *testMainClass) (ret_ interface{}) {
                        ...
                        retRes92916 := (<-Close(exchange))
                        PanicOnError(retRes92916)
                    }
                    panic(e)
                    ...
                    if !IsTrue(result) {
                        if !IsTrue(IsSync()) {
                            ...
                            retRes91520 := (<-Close(exchange))
                            PanicOnError(retRes91520)
                        }
                    ...
                    retRes92312 := (<-this.TestExchange(exchange, symbol))
                    PanicOnError(retRes92312)
                    if !IsTrue(IsSync()) {
            
                        retRes92516 := (<-Close(exchange))
            ...
            if IsTrue(this.Info) {
            ...
            
                {
                    ...
                    requestUrl = exchange.GetLast_request_url()
                        ...
                        retRes123616 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes136016 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes136016)
                    // reset options
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes143116 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes143116)
                    // reset options
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes14858 := (<-this.RunStaticTests("request", targetExchange, testName))
...
func  (this *testMainClass) RunStaticTests(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(exchanges)); i++ {
            ...
            
                {
                    ...
                    retRes152112 := (<-promiseAll(promises))
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes15458 := (<-this.RunStaticTests("response", exchangeName, test))
...
func  (this *testMainClass) RunBrokerIdTests() <- chan interface{} {
        ...
        retRes15848 := (<-promiseAll(promises))
...
func  (this *testMainClass) TestBinance() <- chan interface{} {
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes159812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes160812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest interface{} = nil
            ...
            retRes161412 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
        ...
        var createOrdersRequest interface{} = nil
            ...
            retRes164212 := (<-exchange.CreateOrders(orders))
...
func  (this *testMainClass) TestOkx() <- chan interface{} {
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes166312 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes167412 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptocom() <- chan interface{} {
        ...
        retRes16918 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes169412 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBybit() <- chan interface{} {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "brokerId"), id), "id not in options")
            ...
            retRes171212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestKucoin() <- chan interface{} {
        ...
        Assert(IsEqual(spotKey, "9e58cc35-5b5e-4133-92ec-166e3f077cb8"), Add(Add("kucoin - key: ", spotKey), " not in options."))
            ...
            retRes173212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestKucoinfutures() <- chan interface{} {
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoinfutures - key: ", futureKey), " not in options."))
            ...
            retRes175412 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBitget() <- chan interface{} {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "broker"), id), Add(Add("bitget - id: ", id), " not in options"))
            ...
            retRes177112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestMexc() <- chan interface{} {
        ...
        retRes17878 := (<-exchange.LoadMarkets())
        PanicOnError(retRes17878)
            ...
            retRes178912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestHtx() <- chan interface{} {
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes180612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes181612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest interface{} = nil
            ...
            retRes182212 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoo() <- chan interface{} {
        ...
        var stopOrderRequest interface{} = nil
            ...
            retRes185212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "stopPrice": 30000,
            }))
...
func  (this *testMainClass) TestBitmart() <- chan interface{} {
        ...
        retRes18698 := (<-exchange.LoadMarkets())
        PanicOnError(retRes18698)
            ...
            retRes187112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinex() <- chan interface{} {
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes188812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBlofin() <- chan interface{} {
        ...
        var request interface{} = nil
            ...
            retRes194212 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan interface{} {
        ...
        var request interface{} = nil
            ...
            retRes197912 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan interface{} {
        ...
        var request interface{} = nil
            ...
            retRes199712 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoofiPro() <- chan interface{} {
        ...
        retRes20138 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes201612 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestOxfun() <- chan interface{} {
        ...
        retRes20328 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes203512 := (<-exchange.CreateOrder("BTC/USD:OX", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestXT() <- chan interface{} {
        ...
        var spotOrderRequest interface{} = nil
            ...
            retRes205112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest interface{} = nil
            ...
            retRes205912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestParadex() <- chan interface{} {
        ...
        retRes20818 := (<-exchange.LoadMarkets())
        PanicOnError(retRes20818)
            ...
            retRes208312 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoincatch() <- chan interface{} {
        ...
        var id interface{} = "47cfy"
            ...
            retRes211612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestDefx() <- chan interface{} {
        ...
        var reqHeaders interface{} = nil
            ...
            retRes213312 := (<-exchange.CreateOrder("DOGE/USDC:USDC", "limit", "buy", 100, 1))
...
func  (this *testMainClass) TestCryptomus() <- chan interface{} {
        ...
        var request interface{} = nil
            ...
            retRes215012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "sell", 1, 20000))
...
func  (this *testMainClass) TestDerive() <- chan interface{} {
        ...
        var request interface{} = nil
            ...
            retRes217512 := (<-exchange.CreateOrder("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func  (this *testMainClass) TestModeTrade() <- chan interface{} {
        ...
        retRes21908 := (<-exchange.LoadMarkets())
        ...
        var request interface{} = nil
            ...
            retRes219312 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBackpack() <- chan interface{} {
        ...
        var id interface{} = "1400"
            ...
            retRes221212 := (<-exchange.CreateOrder("ETH/USDC", "limit", "buy", 1, 5000))
