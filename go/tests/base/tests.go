...
func  (this *testMainClass) InitInner(exchangeId any, symbolArgv any, methodArgv any) <- chan any {
            ...
            retRes1388 := (<-this.StartTest(exchange, symbolArgv))
            PanicOnError(retRes1388)
...
func  (this *testMainClass) TestMethod(methodName any, exchange ccxt.ICoreExchange, args any, isPublic any) <- chan any {
            ...
            // exchange — it's not advertised via exchange.Gethas() and shouldn't be gated on it.
            var isCloseTest any =     (IsEqual(methodName, "close"))
...
func  (this *testMainClass) RunPublicTests(exchange ccxt.ICoreExchange, symbols any) <- chan any {
            ...
            retRes5188 := (<-this.RunTests(exchange, tests, true))
...
func  (this *testMainClass) GetValidSymbol(exchange ccxt.ICoreExchange, optionalArgs ...any) any  {
    ...
    var swapSymbols any = []any{"BTC/USDT:USDT", "BTC/USDC:USDC", "BTC/USD:USD", "ETH/USDT:USDT", "ETH/USDC:USDC", "ETH/USD:USD", "BTC/USD:BTC", "ETH/USD:ETH"}
...
func  (this *testMainClass) TestExchange(exchange ccxt.ICoreExchange, optionalArgs ...any) <- chan any {
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
                    ...
                    retRes76016 := (<-this.RunPublicTests(exchange, spotSymbols))
                    PanicOnError(retRes76016)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
                    ...
                    retRes76716 := (<-this.RunPublicTests(exchange, swapSymbols))
                    PanicOnError(retRes76716)
                }
                ...
                if IsTrue(this.WsTests) {
                    var closeSymbol any = Ternary(IsTrue((!IsEqual(spotSymbols, nil))), GetValue(spotSymbols, 0), (Ternary(IsTrue(!IsEqual(swapSymbols, nil)), GetValue(swapSymbols, 0), nil)))
                    if IsTrue(!IsEqual(closeSymbol, nil)) {
        
                        retRes77620 := (<-this.TestSafe("close", exchange, []any{closeSymbol}, true))
                        PanicOnError(retRes77620)
                    }
                }
            }
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
                    ...
                    retRes78316 := (<-this.RunPrivateTests(exchange, spotSymbols))
                    PanicOnError(retRes78316)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
        
                    retRes78716 := (<-this.RunPrivateTests(exchange, swapSymbols))
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.ICoreExchange, symbol any) <- chan any {
            ...
            retRes8818 := (<-this.RunTests(exchange, tests, false))
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                
                    {
                         func(this *testMainClass) (ret_ any) {
                            ...
                            retRes90116 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes90116)
                                        return nil
                                    }(this)
                                }
                            }()
                            ...
                            retRes89716 := (<-this.TestMethod(proxyTestName, exchange, []any{}, true))
            ...
            if IsTrue(IsTrue(this.Sandbox) || IsTrue(GetExchangeProp(exchange, "sandbox"))) {
            ...
            
                {
                     func(this *testMainClass) (ret_ any) {
                        ...
                        retRes97216 := (<-Close(exchange))
                        PanicOnError(retRes97216)
                    }
                    panic(e)
                    ...
                    retRes96612 := (<-this.TestExchange(exchange, symbolArgv))
                    PanicOnError(retRes96612)
                    if !IsTrue(IsSync()) {
            
                        retRes96816 := (<-Close(exchange))
                        PanicOnError(retRes96816)
                    }
            		    return nil
            	    }(this)
            ...
            if IsTrue(this.Info) {
            ...
            
                {
                    ...
                    requestUrl = exchange.GetLast_request_url()
                        ...
                        retRes128616 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
                        PanicOnError(retRes128616)
                    } else {
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName any, exchangeData any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes148416 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes148416)
                    // reset options
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName any, exchangeData any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes155916 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes155916)
                    // reset options
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...any) <- chan any {
            ...
            retRes16188 := (<-this.RunStaticTests("request", targetExchange, testName))
...
func  (this *testMainClass) RunStaticTests(typeVar any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(exchanges)); i++ {
            ...
            
                {
                    ...
                    retRes165412 := (<-promiseAll(promises))
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...any) <- chan any {
            ...
            retRes16788 := (<-this.RunStaticTests("response", exchangeName, test))
...
func  (this *testMainClass) RunBrokerIdTests() <- chan any {
        ...
        retRes17178 := (<-promiseAll(promises))
...
func  (this *testMainClass) TestBinance() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes173112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = nil
            ...
            retRes174112 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest any = nil
            ...
            retRes174712 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
        ...
        var swapAlgoOrderRequest any = nil
            ...
            retRes176112 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 0.002, 102000, map[string]any {
                "triggerPrice": 101000,
            }))
        ...
        var createOrdersRequest any = nil
            ...
            retRes178812 := (<-exchange.CreateOrders(orders))
...
func  (this *testMainClass) TestOkx() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes180912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = nil
            ...
            retRes182012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptocom() <- chan any {
        ...
        retRes18378 := (<-exchange.LoadMarkets())
...
func  (this *testMainClass) TestBybit() <- chan any {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "brokerId"), id), "id not in options")
            ...
            retRes185812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestKucoin() <- chan any {
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for spot orders."))
            ...
            retRes189112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000, map[string]any {
                "uta": true,
            }))
        ...
        id = "ccxtfutures"
            ...
            retRes189812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for swap orders."))
            ...
            retRes190412 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any {
                "uta": true,
            }))
...
func  (this *testMainClass) TestKucoinfutures() <- chan any {
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoinfutures - key: ", futureKey), " not in options."))
            ...
            retRes192512 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoinfutures - id: ", id), " not in headers."))
            ...
            retRes193212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBitget() <- chan any {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "broker"), id), Add(Add("bitget - id: ", id), " not in options"))
            ...
            retRes194912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes195512 := (<-Close(exchange))
            PanicOnError(retRes195512)
        }
...
func  (this *testMainClass) TestMexc() <- chan any {
        ...
        retRes19658 := (<-exchange.LoadMarkets())
        PanicOnError(retRes19658)
            ...
            retRes196712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestHtx() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes198412 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = nil
            ...
            retRes199412 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest any = nil
            ...
            retRes200012 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoo() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes202012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var stopOrderRequest any = nil
            ...
            retRes203012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any {
                "stopPrice": 30000,
            }))
...
func  (this *testMainClass) TestBitmart() <- chan any {
        ...
        retRes20478 := (<-exchange.LoadMarkets())
...
func  (this *testMainClass) TestCoinex() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes206612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBingx() <- chan any {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "broker"), id), Add(Add("bingx - id: ", id), " not in options"))
            ...
            retRes208512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestPhemex() <- chan any {
        ...
        var request any = nil
            ...
            retRes210212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBlofin() <- chan any {
        ...
        var request any = nil
            ...
            retRes212012 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan any {
        ...
        var request any = nil
            ...
            retRes215712 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan any {
        ...
        var request any = nil
            ...
            retRes217512 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoofiPro() <- chan any {
        ...
        retRes21948 := (<-exchange.LoadMarkets())
        ...
        var request any = nil
            ...
            retRes219712 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestOxfun() <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
        ...
        retRes22138 := (<-exchange.LoadMarkets())
        ...
        var request any = nil
            ...
            retRes221612 := (<-exchange.CreateOrder("BTC/USD:OX", "limit", "buy", 1, 20000))
            PanicOnError(retRes221612)
        		    return nil
        	    }(this)
            
                }
        var orders any = GetValue(request, "orders")
        var first any = GetValue(orders, 0)
        var brokerId any = GetValue(first, "source")
...
func  (this *testMainClass) TestXT() <- chan any {
        ...
        var swapOrderRequest any = nil
            ...
            retRes224012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestParadex() <- chan any {
        ...
        retRes22658 := (<-exchange.LoadMarkets())
        PanicOnError(retRes22658)
            ...
            retRes226712 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestHashkey() <- chan any {
        ...
        var id any = "10000700011"
            ...
            retRes228312 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptomus() <- chan any {
        ...
        var request any = nil
            ...
            retRes229912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "sell", 1, 20000))
...
func  (this *testMainClass) TestDerive() <- chan any {
        ...
        var request any = nil
            ...
            retRes232712 := (<-exchange.CreateOrder("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func  (this *testMainClass) TestModeTrade() <- chan any {
        ...
        retRes23458 := (<-exchange.LoadMarkets())
        ...
        var request any = nil
            ...
            retRes234812 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBackpack() <- chan any {
        ...
        var id any = "1400"
            ...
            retRes236712 := (<-exchange.CreateOrder("ETH/USDC", "limit", "buy", 1, 5000))
...
func  (this *testMainClass) TestToobit() <- chan any {
        ...
        var id any = "177321641268789"
            ...
            retRes238412 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWeex() <- chan any {
        ...
        var request any = nil
            ...
            retRes240212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        Assert(StartsWith(clientOrderId, id), Add(Add(Add("weex - newClientOrderId: ", clientOrderId), " for spot order does not start with id: "), id))
            ...
            retRes240912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
