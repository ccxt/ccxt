...
func  (this *testMainClass) Init(exchangeId interface{}, symbolArgv interface{}, methodArgv interface{}) <- chan interface{} {
            ...
            if IsTrue(IsTrue(this.RequestTests) && IsTrue(this.ResponseTests)) {
                ...
                retRes385165 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
                PanicOnError(retRes385165)
        
                retRes210902 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
                PanicOnError(retRes210902)
            ...
            if IsTrue(this.ResponseTests) {
                ...
                retRes106600 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
                PanicOnError(retRes106600)
            ...
            if IsTrue(this.RequestTests) {
                ...
                retRes255591 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
                PanicOnError(retRes255591) // symbol here is the testname
            ...
            if IsTrue(this.IdTests) {
                ...
                retRes549618 := (<-this.RunBrokerIdTests())
                PanicOnError(retRes549618)
            ...
            retRes566055 := (<-this.ImportFiles(exchange))
            PanicOnError(retRes566055)
            ...
            retRes679116 := (<-this.StartTest(exchange, symbolArgv))
            PanicOnError(retRes679116)
...
func  (this *testMainClass) TestMethod(methodName interface{}, exchange ccxt.IExchange, args interface{}, isPublic interface{}) <- chan interface{} {
            ...
            if IsTrue(isLoadMarkets) {
                ...
                retRes849537 := (<-exchange.LoadMarkets(true))
                PanicOnError(retRes849537)
            }
            ...
            if IsTrue(IsSync()) {
                ...
                retRes649145 := (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
                PanicOnError(retRes649145)
            }
            if IsTrue(this.Info) {
            ...
            for i := 0; IsLessThan(i, maxRetries); i++ {
                ...
                {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                		defer func() {
                            ...
                            if IsTrue(isOperationFailed) {
                                ...
                                if IsTrue(IsEqual(i, Subtract(maxRetries, 1))) {
                                    ...
                                    retRes629257 := (<-exchange.Sleep(Multiply((Add(i, 1)), 1000)))
                                    PanicOnError(retRes629257)
                                }
                            } else {
                		...
                		// try block:
                            ...
                            retRes651537 := (<-this.TestMethod(methodName, exchange, args, isPublic))
                            PanicOnError(retRes651537)
...
func  (this *testMainClass) RunPublicTests(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
            ...
            retRes314472 := (<-this.RunTests(exchange, tests, true))
            PanicOnError(retRes314472)
...
func  (this *testMainClass) TestExchange(exchange ccxt.IExchange, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    retRes633048 := (<-this.RunPublicTests(exchange, spotSymbol))
                    PanicOnError(retRes633048)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    ...
                    retRes186994 := (<-this.RunPublicTests(exchange, swapSymbol))
                    PanicOnError(retRes186994)
                }
            }
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    retRes236874 := (<-this.RunPrivateTests(exchange, spotSymbol))
                    PanicOnError(retRes236874)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
        
                    retRes935951 := (<-this.RunPrivateTests(exchange, swapSymbol))
                    PanicOnError(retRes935951)
                }
            }
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
            ...
            retRes368405 := (<-this.RunTests(exchange, tests, false))
            PanicOnError(retRes368405)
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                ...
                {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                		defer func() {
                            ...
                            retRes49154 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes49154)
                                    return nil
                				}(this)
                			}
                		}()
                		// try block:
                            ...
                            retRes321948 := (<-this.TestMethod(proxyTestName, exchange, []interface{}{}, true))
...
func  (this *testMainClass) StartTest(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		defer func() {
                        ...
                        retRes207465 := (<-Close(exchange))
                        PanicOnError(retRes207465)
                    }
                    panic(e)
                                return nil
            				}(this)
                    ...
                    if !IsTrue(result) {
                        if !IsTrue(IsSync()) {
                            ...
                            retRes638375 := (<-Close(exchange))
                            PanicOnError(retRes638375)
                        }
                    ...
                    retRes886922 := (<-this.TestExchange(exchange, symbol))
                    PanicOnError(retRes886922)
                    if !IsTrue(IsSync()) {
            
                        retRes219132 := (<-Close(exchange))
                        PanicOnError(retRes219132)
                    }
            		return nil
            	}(this)
            	if ret__ != nil {
...
func  (this *testMainClass) TestRequestStatically(exchange ccxt.IExchange, method interface{}, data interface{}, typeVar interface{}, skipKeys interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		...
            		// try block:
                        ...
                        retRes337759 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
                        PanicOnError(retRes337759)
                    } else {
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes377626 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes377626)
                    // reset options
            ...
            if !IsTrue(IsSync()) {
                ...
                retRes665160 := (<-Close(exchange))
                PanicOnError(retRes665160)
            }
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName interface{}, exchangeData interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes201103 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes201103)
                    // reset options
                    // exchange.Setoptions(exchange.GetdeepExtend() (oldExchangeOptions, {});)
                    exchange.ExtendExchangeOptions(exchange.DeepExtend(oldExchangeOptions, map[string]interface{} {}))
                }
            ...
            if !IsTrue(IsSync()) {
                ...
                retRes870588 := (<-Close(exchange))
                PanicOnError(retRes870588)
            }
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes191295 := (<-this.RunStaticTests("request", targetExchange, testName))
            PanicOnError(retRes191295)
...
func  (this *testMainClass) RunStaticTests(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                    ...
                    retRes19882 := (<-promiseAll(promises))
                    PanicOnError(retRes19882)
            		return nil
            	}(this)
            	if ret__ != nil {
            		return ret__
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes213086 := (<-this.RunStaticTests("response", exchangeName, test))
            PanicOnError(retRes213086)
...
func  (this *testMainClass) RunBrokerIdTests() <- chan interface{} {
        ...
        retRes965965 := (<-promiseAll(promises))
...
func  (this *testMainClass) TestBinance() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes462319 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes162902 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes162902)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes320762 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
            PanicOnError(retRes320762)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes15495 := (<-Close(exchange))
            PanicOnError(retRes15495)
        }
...
func  (this *testMainClass) TestOkx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes723411 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes723411)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes538126 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes538126)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes33950 := (<-Close(exchange))
            PanicOnError(retRes33950)
        }
...
func  (this *testMainClass) TestCryptocom() <- chan interface{} {
        ...
        retRes691835 := (<-exchange.LoadMarkets())
        PanicOnError(retRes691835)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes584678 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes584678)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes115989 := (<-Close(exchange))
            PanicOnError(retRes115989)
        }
...
func  (this *testMainClass) TestBybit() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes726586 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes726586)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes856839 := (<-Close(exchange))
            PanicOnError(retRes856839)
        }
...
func  (this *testMainClass) TestKucoin() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes262812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes767870 := (<-Close(exchange))
            PanicOnError(retRes767870)
        }
...
func  (this *testMainClass) TestKucoinfutures() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes749232 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes749232)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes186224 := (<-Close(exchange))
            PanicOnError(retRes186224)
        }
...
func  (this *testMainClass) TestBitget() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes682496 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes682496)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes122503 := (<-Close(exchange))
            PanicOnError(retRes122503)
        }
...
func  (this *testMainClass) TestMexc() <- chan interface{} {
        ...
        retRes684736 := (<-exchange.LoadMarkets())
        PanicOnError(retRes684736)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes680154 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes680154)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes835448 := (<-Close(exchange))
            PanicOnError(retRes835448)
        }
...
func  (this *testMainClass) TestHtx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes819 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes819)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes485391 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes485391)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes662250 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
            PanicOnError(retRes662250)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes609264 := (<-Close(exchange))
            PanicOnError(retRes609264)
        }
...
func  (this *testMainClass) TestWoo() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes491605 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes491605)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes99977 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "stopPrice": 30000,
            }))
            PanicOnError(retRes99977)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes677977 := (<-Close(exchange))
            PanicOnError(retRes677977)
        }
...
func  (this *testMainClass) TestBitmart() <- chan interface{} {
        ...
        retRes575453 := (<-exchange.LoadMarkets())
        PanicOnError(retRes575453)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes201919 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes201919)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes382556 := (<-Close(exchange))
            PanicOnError(retRes382556)
        }
...
func  (this *testMainClass) TestCoinex() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes30872 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes30872)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes611694 := (<-Close(exchange))
            PanicOnError(retRes611694)
        }
...
func  (this *testMainClass) TestBingx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes810655 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes810655)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes720650 := (<-Close(exchange))
            PanicOnError(retRes720650)
        }
...
func  (this *testMainClass) TestPhemex() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes308910 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes308910)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes365284 := (<-Close(exchange))
            PanicOnError(retRes365284)
        }
...
func  (this *testMainClass) TestBlofin() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes292738 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
            PanicOnError(retRes292738)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes232265 := (<-Close(exchange))
            PanicOnError(retRes232265)
        }
...
func  (this *testMainClass) TestHyperliquid() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes112012 := (<-exchange.CreateOrder("SOL/USDC:USDC", "limit", "buy", 1, 100))
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes815938 := (<-Close(exchange))
            PanicOnError(retRes815938)
        }
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes887244 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes887244)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes139871 := (<-Close(exchange))
            PanicOnError(retRes139871)
        }
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes208099 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes208099)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes946896 := (<-Close(exchange))
            PanicOnError(retRes946896)
        }
...
func  (this *testMainClass) TestWoofiPro() <- chan interface{} {
        ...
        retRes585361 := (<-exchange.LoadMarkets())
        PanicOnError(retRes585361)
        var request interface{} = nil
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes126640 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes126640)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes875532 := (<-Close(exchange))
            PanicOnError(retRes875532)
        }
...
func  (this *testMainClass) TestOxfun() <- chan interface{} {
        ...
        retRes741648 := (<-exchange.LoadMarkets())
        PanicOnError(retRes741648)
        var request interface{} = nil
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes76419 := (<-exchange.CreateOrder("BTC/USD:OX", "limit", "buy", 1, 20000))
            PanicOnError(retRes76419)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
...
func  (this *testMainClass) TestXT() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes394764 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes394764)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes942686 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes942686)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes276596 := (<-Close(exchange))
            PanicOnError(retRes276596)
        }
...
func  (this *testMainClass) TestVertex() <- chan interface{} {
        ...
        retRes12810 := (<-exchange.LoadMarkets())
        PanicOnError(retRes12810)
        var request interface{} = nil
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes172554 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes172554)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
...
func  (this *testMainClass) TestParadex() <- chan interface{} {
        ...
        retRes770544 := (<-exchange.LoadMarkets())
        PanicOnError(retRes770544)
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes795361 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
            PanicOnError(retRes795361)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes961012 := (<-Close(exchange))
            PanicOnError(retRes961012)
        }
...
func  (this *testMainClass) TestHashkey() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes458102 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes458102)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes915298 := (<-Close(exchange))
            PanicOnError(retRes915298)
        }
...
func  (this *testMainClass) TestCoincatch() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes470208 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
            PanicOnError(retRes470208)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes411180 := (<-Close(exchange))
            PanicOnError(retRes411180)
        }
...
func  (this *testMainClass) TestDefx() <- chan interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            ...
            retRes245521 := (<-exchange.CreateOrder("DOGE/USDC:USDC", "limit", "buy", 100, 1))
            PanicOnError(retRes245521)
        		return nil
        	}(this)
        	if ret__ != nil {
        		return ret__
        ...
        if !IsTrue(IsSync()) {
            ...
            retRes392465 := (<-Close(exchange))
            PanicOnError(retRes392465)
        }
