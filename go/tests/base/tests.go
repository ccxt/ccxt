...
func  (this *testMainClass) InitInner(exchangeId any, symbolArgv any, methodArgv any) <- chan any {
            ...
            if IsTrue(IsTrue(this.RequestTests) && IsTrue(this.ResponseTests)) {
                ...
                retRes10512 := (<-this.RunStaticRequestTests(exchangeId, symbolArgv))
            ...
            if IsTrue(this.ResponseTests) {
                ...
                retRes11012 := (<-this.RunStaticResponseTests(exchangeId, symbolArgv))
                PanicOnError(retRes11012)
            ...
            if IsTrue(this.RequestTests) {
                ...
                PanicOnError(retRes11412) // symbol here is the testname
            ...
            if IsTrue(this.IdTests) {
                ...
                retRes11812 := (<-this.RunBrokerIdTests())
            ...
            retRes1348 := (<-this.ImportFiles(exchange))
            ...
            retRes1398 := (<-this.StartTest(exchange, symbolArgv))
            PanicOnError(retRes1398)
...
func  (this *testMainClass) TestMethod(methodName any, exchange ccxt.ICoreExchange, args any, isPublic any) <- chan any {
            ...
            if IsTrue(isLoadMarkets) {
                ...
                retRes29512 := (<-exchange.LoadMarkets(true))
                PanicOnError(retRes29512)
            }
            ...
            if IsTrue(IsSync()) {
                ...
                retRes31112 := (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
                PanicOnError(retRes31112)
            }
            if IsTrue(this.Info) {
                         ...
                         func(this *testMainClass) (ret_ any) {
                            ...
                            if IsTrue(isOperationFailed) {
                                ...
                                if IsTrue(IsEqual(i, Subtract(maxRetries, 1))) {
                                    ...
                                    retRes43324 := (<-exchange.Sleep(Multiply((Add(i, 1)), 1000)))
                                    PanicOnError(retRes43324)
                                }
                            } else {
                            ...
                            retRes38616 := (<-this.TestMethod(methodName, exchange, args, isPublic))
                            PanicOnError(retRes38616)
...
func  (this *testMainClass) RunPublicTests(exchange ccxt.ICoreExchange, symbols any) <- chan any {
            ...
            retRes5198 := (<-this.RunTests(exchange, tests, true))
...
func  (this *testMainClass) TestExchange(exchange ccxt.ICoreExchange, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(exchange.SafeBool(exchange.GetHas(), "prediction", false)) {
                ...
                retRes72512 := (<-this.RunPredictionTests(exchange))
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
                    ...
                    retRes77116 := (<-this.RunPublicTests(exchange, spotSymbols))
                    PanicOnError(retRes77116)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
                    ...
                    retRes77816 := (<-this.RunPublicTests(exchange, swapSymbols))
            ...
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbols, nil))) {
                    ...
                    retRes78416 := (<-this.RunPrivateTests(exchange, spotSymbols))
                    PanicOnError(retRes78416)
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbols, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
        
                    retRes78816 := (<-this.RunPrivateTests(exchange, swapSymbols))
...
func  (this *testMainClass) RunPredictionTests(exchange ccxt.ICoreExchange) <- chan any {
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                retRes89712 := (<-this.RunTests(exchange, publicTests, true))
            ...
            if IsTrue(IsTrue((IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly))) && !IsTrue(this.WsTests)) {
                ...
                retRes90912 := (<-this.RunTests(exchange, privateTests, false))
                ...
                if IsTrue(GetCliArgValue("--fundedTests")) {
                    ...
                    retRes91216 := (<-this.TestPredictionCreateCancelOrder(exchange, outcomeSymbol))
...
func  (this *testMainClass) TestPredictionCreateCancelOrder(exchange ccxt.ICoreExchange, outcome any) <- chan any {
            ...
            retRes10138 := (<-this.CancelPredictionOrder(exchange, placedId, outcome))
            ...
            go func() any {
            ...
            
                {
                     func(this *testMainClass) (ret_ any) {
                        ...
                        retRes102716 := (<-CallExchangeMethodDynamically(exchange, "cancelOrder", []any{orderId, outcome}))
                        PanicOnError(retRes102716)
                    } else {
            
                        retRes102916 := (<-CallExchangeMethodDynamically(exchange, "cancelAllOrders", []any{outcome}))
                        PanicOnError(retRes102916)
                    }
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.ICoreExchange, symbol any) <- chan any {
            ...
            retRes11278 := (<-this.RunTests(exchange, tests, false))
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                
                    {
                         func(this *testMainClass) (ret_ any) {
                            ...
                            retRes114716 := (<-exchange.Sleep(Multiply(j, 1000)))
                            PanicOnError(retRes114716)
                                        return nil
                                    }(this)
                                }
                            }()
                            ...
                            retRes114316 := (<-this.TestMethod(proxyTestName, exchange, []any{}, true))
                            PanicOnError(retRes114316)
            ...
            
                {
                    ...
                    if !IsTrue(result) {
                        if !IsTrue(IsSync()) {
                            ...
                            retRes120520 := (<-Close(exchange))
                            PanicOnError(retRes120520)
                        }
                    ...
                    retRes121312 := (<-this.TestExchange(exchange, symbolArgv))
                    PanicOnError(retRes121312)
                    if !IsTrue(IsSync()) {
            
                        retRes121516 := (<-Close(exchange))
            ...
            if IsTrue(this.Info) {
            ...
            
                {
                    ...
                    requestUrl = exchange.GetLast_request_url()
                        ...
                        retRes154616 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
                        PanicOnError(retRes154616)
                    } else {
...
func  (this *testMainClass) InitOfflineExchange(exchangeName any) ccxt.ICoreExchange {
    var markets any = this.LoadMarketsFromFile(exchangeName)
    var currencies any = this.LoadCurrenciesFromFile(exchangeName)
...
func  (this *testMainClass) TestExchangeRequestStatically(exchangeName any, exchangeData any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes174616 := (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    PanicOnError(retRes174616)
                    // reset options
...
func  (this *testMainClass) TestExchangeResponseStatically(exchangeName any, exchangeData any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    retRes182116 := (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    PanicOnError(retRes182116)
                    // reset options
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...any) <- chan any {
            ...
            retRes18878 := (<-this.RunStaticTests("request", targetExchange, testName))
...
func  (this *testMainClass) RunStaticTests(typeVar any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(exchanges)); i++ {
            ...
            
                {
                    ...
                    retRes192312 := (<-promiseAll(promises))
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...any) <- chan any {
            ...
            retRes19478 := (<-this.RunStaticTests("response", exchangeName, test))
...
func  (this *testMainClass) RunBrokerIdTests() <- chan any {
        ...
        retRes19858 := (<-promiseAll(promises))
...
func  (this *testMainClass) TestBinance() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes199912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = nil
            ...
            retRes200912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest any = nil
            ...
            retRes201512 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
        ...
        var swapAlgoOrderRequest any = nil
            ...
            retRes202912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 0.002, 102000, map[string]any {
                "triggerPrice": 101000,
            }))
        ...
        var createOrdersRequest any = nil
            ...
            retRes205612 := (<-exchange.CreateOrders(orders))
...
func  (this *testMainClass) TestOkx() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes207712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = nil
            ...
            retRes208812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptocom() <- chan any {
        ...
        var request any = nil
            ...
            retRes210812 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBybit() <- chan any {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "brokerId"), id), "id not in options")
            ...
            retRes212612 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestKucoin() <- chan any {
        ...
        Assert(IsEqual(futureKey, "1b327198-f30c-4f14-a0ac-918871282f15"), Add(Add("kucoin - key: ", futureKey), " not in options."))
            ...
            retRes215112 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for spot orders."))
            ...
            retRes215912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000, map[string]any {
                "uta": true,
            }))
        ...
        id = "ccxtfutures"
            ...
            retRes216612 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoin - id: ", id), " not in headers for swap orders."))
            ...
            retRes217212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any {
                "uta": true,
            }))
...
func  (this *testMainClass) TestKucoinfutures() <- chan any {
        ...
        Assert(IsEqual(GetValue(reqHeaders, "KC-API-PARTNER"), id), Add(Add("kucoinfutures - id: ", id), " not in headers."))
            ...
            retRes220012 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBitget() <- chan any {
        ...
        Assert(IsEqual(GetValue(exchange.GetOptions(), "broker"), id), Add(Add("bitget - id: ", id), " not in options"))
            ...
            retRes221712 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestMexc() <- chan any {
        ...
        retRes22338 := (<-exchange.LoadMarkets())
        PanicOnError(retRes22338)
            ...
            retRes223512 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestHtx() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes225212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        var swapOrderRequest any = nil
            ...
            retRes226212 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
        ...
        var swapInverseOrderRequest any = nil
            ...
            retRes226812 := (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoo() <- chan any {
        ...
        var stopOrderRequest any = nil
            ...
            retRes229812 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any {
                "stopPrice": 30000,
            }))
...
func  (this *testMainClass) TestBitmart() <- chan any {
        ...
        retRes23158 := (<-exchange.LoadMarkets())
...
func  (this *testMainClass) TestCoinex() <- chan any {
        ...
        var spotOrderRequest any = nil
            ...
            retRes233412 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestPhemex() <- chan any {
        ...
        var request any = nil
            ...
            retRes237012 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBlofin() <- chan any {
        ...
        var request any = nil
            ...
            retRes238812 := (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan any {
        ...
        var request any = nil
            ...
            retRes242512 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan any {
        ...
        var request any = nil
            ...
            retRes244312 := (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestWoofiPro() <- chan any {
        ...
        var request any = nil
            ...
            retRes246512 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestParadex() <- chan any {
        ...
        retRes25158 := (<-exchange.LoadMarkets())
        PanicOnError(retRes25158)
            ...
            retRes251712 := (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestCryptomus() <- chan any {
        ...
        var request any = nil
            ...
            retRes254912 := (<-exchange.CreateOrder("BTC/USDT", "limit", "sell", 1, 20000))
...
func  (this *testMainClass) TestDerive() <- chan any {
        ...
        var request any = nil
            ...
            retRes257712 := (<-exchange.CreateOrder("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func  (this *testMainClass) TestModeTrade() <- chan any {
        ...
        retRes25958 := (<-exchange.LoadMarkets())
        ...
        var request any = nil
            ...
            retRes259812 := (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func  (this *testMainClass) TestBackpack() <- chan any {
        ...
        var id any = "1400"
            ...
            retRes261712 := (<-exchange.CreateOrder("ETH/USDC", "limit", "buy", 1, 5000))
...
func  (this *testMainClass) TestWeex() <- chan any {
        ...
        var request any = nil
            ...
            retRes265212 := (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
        ...
        Assert(StartsWith(clientOrderId, id), Add(Add(Add("weex - newClientOrderId: ", clientOrderId), " for spot order does not start with id: "), id))
            ...
            retRes265912 := (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
