...
type testMainClass struct {
    IsSynchronous bool `default:"IS_SYNCHRONOUS"`
    ...
    ProxyTestFileName string `default:"PROXY_TEST_FILE_NAME"`
    ...
    NewLine string `default:"NEW_LINE"`
    RootDir string `default:"ROOT_DIR"`
    EnvVars interface{} `default:"ENV_VARS"`
...
func  (this *testMainClass) ParseCliArgs()  {
    ...
    go func() interface{} {
        ...
        ch <-true
            ...
            if IsTrue(this.RequestTests) {
                (<-this.RunStaticRequestTests(exchangeId, symbolArgv)) // symbol here is the testname
        ch <-true
            }
            if IsTrue(this.IdTests) {
                (<-this.RunBrokerIdTests())
        ch <-true
            }
            Dump(Add(Add(Add(Add(this.NewLine, ""), this.NewLine), ""), "[INFO] TESTING "), this.Ext, map[string]interface{} {
                "exchange": exchangeId,
                "symbol": symbolArgv,
                "method": methodArgv,
                "isWs": this.WsTests,
            ...
            (<-this.StartTest(exchange, symbolArgv))
...
func  (this *testMainClass) LoadCredentialsFromEnv(exchange ccxt.IExchange)  {
    ...
    for i := 0; IsLessThan(i, GetArrayLength(objkeys)); i++ {
        ...
        if IsTrue(IsTrue(isRequired) && IsTrue(IsEqual(GetExchangeProp(exchange, credential), nil))) {
            ...
            var credentialValue interface{} = Ternary(IsTrue((InOp(this.EnvVars, credentialEnvName))), GetValue(this.EnvVars, credentialEnvName), nil)
...
func  (this *testMainClass) ExpandSettings(exchange ccxt.IExchange)  {
    var exchangeId interface{} = exchange.GetId()
    var keysGlobal interface{} = Add(this.RootDir, "keys.json")
    var keysLocal interface{} = Add(this.RootDir, "keys.local.json")
    ...
    // skipped tests
    var skippedFile interface{} = Add(this.RootDir, "skip-tests.json")
    ...
    go func() interface{} {
        ...
        ch <-true
            ...
            if IsTrue(this.IsSynchronous) {
                ...
                (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
            }
            if IsTrue(this.Info) {
                ...
                {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                		defer func() {
                            ...
                            ch <-retSuccess
                                    ...
                                    (<-exchange.Sleep(Multiply((Add(i, 1)), 1000)))
                                }
                            } else {
...
func  (this *testMainClass) RunPublicTests(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
    ...
    go func() interface{} {
        defer close(ch)
            ...
            (<-this.RunTests(exchange, tests, true))
    ch <-true
        return nil
    }()
    return ch
...
func  (this *testMainClass) RunTests(exchange ccxt.IExchange, tests interface{}, isPublicTest interface{}) <- chan interface{} {
    ...
    go func() interface{} {
        defer close(ch)
            ...
            var results interface{} = (<-promiseAll(promises))
...
func  (this *testMainClass) LoadExchange(exchange ccxt.IExchange) <- chan interface{} {
    ...
    go func() interface{} {
        defer close(ch)
            var result interface{} = (<-this.TestSafe("loadMarkets", exchange, []interface{}{}, true))
            if !IsTrue(result) {
        ch <-false
            }
        ...
        defer close(ch)
            ...
            if !IsTrue(this.PrivateTestOnly) {
                ...
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    ...
                    (<-this.RunPublicTests(exchange, spotSymbol))
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    ...
                    (<-this.RunPublicTests(exchange, swapSymbol))
                }
            }
            if IsTrue(IsTrue(this.PrivateTest) || IsTrue(this.PrivateTestOnly)) {
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "spot")) && IsTrue(!IsEqual(spotSymbol, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "spot")
                    (<-this.RunPrivateTests(exchange, spotSymbol))
                }
                if IsTrue(IsTrue(GetValue(exchange.GetHas(), "swap")) && IsTrue(!IsEqual(swapSymbol, nil))) {
                    AddElementToObject(exchange.GetOptions(), "defaultType", "swap")
                    (<-this.RunPrivateTests(exchange, swapSymbol))
                }
            }
    ch <-true
        return nil
...
func  (this *testMainClass) RunPrivateTests(exchange ccxt.IExchange, symbol interface{}) <- chan interface{} {
    ...
    go func() interface{} {
        ...
        ch <-true
            ...
            (<-this.RunTests(exchange, tests, false))
        return nil
    }()
    return ch
}
        ...
        ch <-true
            ...
            for j := 0; IsLessThan(j, maxRetries); j++ {
                ...
                {		ret__ := func(this *testMainClass) (ret_ interface{}) {
                		defer func() {
                			if e := recover().(interface{}); e != nil {
                				...
                				ret_ = func(this *testMainClass) interface{} {
                					// catch block:
                                                exception = e
                            (<-exchange.Sleep(Multiply(j, 1000)))
                            ch <- nil
                            return nil
                				}(this)
                			}
                		...
                		// try block:
                                    (<-this.TestMethod(proxyTestName, exchange, []interface{}{}, true))
    ...
    go func() interface{} {
        ...
        ch <-true
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		...
            		// try block:
                            var result interface{} = (<-this.LoadExchange(exchange))
                    if !IsTrue(result) {
                        if !IsTrue(this.IsSynchronous) {
                            (<-Close(exchange))
                        }
                ch <-true
                    ...
                    // }
                    (<-this.TestExchange(exchange, symbol))
                    if !IsTrue(this.IsSynchronous) {
                        (<-Close(exchange))
                    }
    ch <- nil
...
func  (this *testMainClass) LoadMarketsFromFile(id interface{}) interface{}  {
    ...
    var filename interface{} = Add(Add(Add(this.RootDir, "./ts/src/test/static/markets/"), id), ".json")
    var content interface{} = IoFileRead(filename)
    return content
}
func  (this *testMainClass) LoadCurrenciesFromFile(id interface{}) interface{}  {
    var filename interface{} = Add(Add(Add(this.RootDir, "./ts/src/test/static/currencies/"), id), ".json")
    var content interface{} = IoFileRead(filename)
    return content
}
    ...
    go func() interface{} {
        defer close(ch)
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		...
            		// try block:
                            if !IsTrue(this.IsSynchronous) {
                        (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
                    } else {
    ...
    go func() interface{} {
        defer close(ch)
            ...
            {		ret__ := func(this *testMainClass) (ret_ interface{}) {
            		...
            		// try block:
                            if !IsTrue(this.IsSynchronous) {
                        var unifiedResult interface{} = (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
        ...
        defer close(ch)
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    (<-this.TestRequestStatically(exchange, method, result, typeVar, skipKeys))
                    // reset options
        ...
        defer close(ch)
            ...
            for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
                    ...
                    var skipKeys interface{} = exchange.SafeValue(exchangeData, "skipKeys", []interface{}{})
                    (<-this.TestResponseStatically(exchange, method, skipKeys, result))
                    // reset options
                    // exchange.Setoptions(exchange.GetdeepExtend() (oldExchangeOptions, {});)
                    exchange.ExtendExchangeOptions(exchange.DeepExtend(oldExchangeOptions, map[string]interface{} {}))
                }
...
func  (this *testMainClass) RunStaticRequestTests(optionalArgs ...interface{}) <- chan interface{} {
    ...
    go func() interface{} {
        defer close(ch)
            ...
            _ = testName
            (<-this.RunStaticTests("request", targetExchange, testName))
    ch <-true
        return nil
    }()
    return ch
...
func  (this *testMainClass) RunStaticTests(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
    ...
    go func() interface{} {
        defer close(ch)
            ...
            testName := GetArg(optionalArgs, 1, nil)
            _ = testName
            var folder interface{} = Add(Add(Add(this.RootDir, "./ts/src/test/static/"), typeVar), "/")
        ...
        ch <-true
            ...
            if IsTrue(IsTrue(this.RequestTestsFailed) || IsTrue(this.ResponseTestsFailed)) {
                ...
                var prefix interface{} = Ternary(IsTrue((this.IsSynchronous)), "[SYNC]", "")
...
func  (this *testMainClass) RunStaticResponseTests(optionalArgs ...interface{}) <- chan interface{} {
    ...
    go func() interface{} {
        defer close(ch)
            ...
            _ = test
            (<-this.RunStaticTests("response", exchangeName, test))
    ch <-true
        return nil
    }()
    return ch
...
func  (this *testMainClass) TestBinance() <- chan interface{} {
    ...
    go func() interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USDT", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
ch <-ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
ch <-ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USD:BTC", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
...
ch <-ret__
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]interface{} {
                "stopPrice": 30000,
            }))
ch <- nil
return nil
...
func  (this *testMainClass) TestBlofin() <- chan interface{} {
    ...
    go func() interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("LTC/USDT:USDT", "market", "buy", 1))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
...
func  (this *testMainClass) TestCoinbaseinternational() <- chan interface{} {
    ...
    go func() interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USDC:USDC", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
...
func  (this *testMainClass) TestCoinbaseAdvanced() <- chan interface{} {
    ...
    go func() interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USDC", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
...
func  (this *testMainClass) TestOxfun() <- chan interface{} {
    ...
    go func() interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USD:OX", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
...
func  (this *testMainClass) TestParadex() <- chan interface{} {
    ...
    go func() interface{} {
        ...
        {		ret__ := func(this *testMainClass) (ret_ interface{}) {
        		...
        		// try block:
                    (<-exchange.CreateOrder("BTC/USD:USDC", "limit", "buy", 1, 20000))
ch <- nil
return nil
        	}(this)
        	if ret__ != nil {
