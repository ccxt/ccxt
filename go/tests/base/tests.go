...
func (this *testMainClass) initBody(ch chan any, exchangeId any, symbolArgv any, methodArgv any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes10712 := (<-this.InitInnerAsync(exchangeId, symbolArgv, methodArgv))
...
func (this *testMainClass) initInnerBody(ch chan any, exchangeId any, symbolArgv any, methodArgv any) any {
	...
	if EvalTruthy(this.RequestTests) && EvalTruthy(this.ResponseTests) {
		...
		retRes11912 := (<-this.RunStaticRequestTestsAsync(exchangeId, symbolArgv))
		PanicOnError(retRes11912)

		retRes12012 := (<-this.RunStaticResponseTestsAsync(exchangeId, symbolArgv))
		PanicOnError(retRes12012)
	...
	if EvalTruthy(this.ResponseTests) {
		...
		retRes12412 := (<-this.RunStaticResponseTestsAsync(exchangeId, symbolArgv))
		PanicOnError(retRes12412)
	...
	if EvalTruthy(this.StaticWsTests) {
		...
		retRes12812 := (<-this.RunStaticWsTestsAsync(exchangeId, symbolArgv))
	...
	if EvalTruthy(this.RequestTests) {
		...
		retRes13212 := (<-this.RunStaticRequestTestsAsync(exchangeId, symbolArgv))
		PanicOnError(retRes13212) // symbol here is the testname
	...
	if EvalTruthy(this.IdTests) {
		...
		retRes13612 := (<-this.RunBrokerIdTestsAsync())
		PanicOnError(retRes13612)
	...
	retRes1538 := (<-this.ImportFilesAsync(exchange))
	...
	retRes1588 := (<-this.StartTestAsync(exchange, symbolArgv))
	PanicOnError(retRes1588)
...
func (this *testMainClass) LoadCredentialsFromEnv(exchange ccxt.ICoreExchange) {
	...
	for i := 0; IsLessThan(i, GetArrayLength(objkeys)); i++ {
		...
		if (IsEqual(isRequired, true)) && (IsEqual(GetExchangeProp(exchange, credential), nil)) {
			...
			var credentialValue any = Ternary((InOp(envVars, credentialEnvName)), GetValue(envVars, credentialEnvName), nil)
			if !IsEqual(credentialValue, nil) && !IsEqual(credentialValue, "") {
...
func (this *testMainClass) ExpandSettings(exchange ccxt.ICoreExchange) {
	...
	if !IsEqual(exchangeSettings, nil) {
		...
		for i := 0; IsLessThan(i, GetArrayLength(settingKeys)); i++ {
			...
			var settingIsEmpty bool = (IsEqual(settingValue, nil)) || (IsEqual(settingValue, nil)) || (IsEqual(settingValue, "")) || (IsEqual(settingValue, false)) || (IsEqual(settingValue, 0))
			if !settingIsEmpty {
...
func (this *testMainClass) testMethodBody(ch chan any, methodName any, exchange ccxt.ICoreExchange, args any, isPublic any) any {
	...
	if IsGreaterThanOrEqual(GetIndexOf(methodName, "OrderBook"), 0) && (this.Ext == "cs") {
		AddElementToObject(exchange.GetOptions(), "checksum", false)
	}
	// todo: temporary skip for php
	if IsGreaterThanOrEqual(GetIndexOf(methodName, "OrderBook"), 0) && (this.Ext == "php") {
	...
	if !isLoadMarkets && ((IsGreaterThan(GetArrayLength(this.OnlySpecificTests), 0)) && (!IsEqual(exchange.InArray(methodName, this.OnlySpecificTests), true))) {
	...
	if isLoadMarkets {
		...
		retRes32112 := (<-exchange.LoadMarketsAsync(true))
		PanicOnError(retRes32112)
		Dump(this.AddPadding("[INFO] TESTING DONE", 25), name, methodName)
	}
	if !IsEqual(skipMessage, nil) && !IsEqual(skipMessage, "") {
	...
	if EvalTruthy(IsSync()) {
		...
		retRes33512 := (<-CallMethod(this.TestFiles, methodName, exchange, skippedPropertiesForMethod, args))
		PanicOnError(retRes33512)
	}
	Dump(this.AddPadding("[INFO] TESTING DONE", 25), name, methodName)
	...
	for i := 0; IsLessThan(i, maxRetries); i++ {

		{
			func(this *testMainClass) (ret_ any) {
				defer func() {
					if ex := recover(); ex != nil {
						...
						ret_ = func(this *testMainClass) any {
							...
							var lastUrlMsg any = Ternary(EvalTruthy(this.WsTests), "", Add(Add(" (Last url: ", this.GetLastRequestUrl(exchange)), " )"))
							if isOperationFailed {
								...
								if i == Subtract(maxRetries, 1) {
									...
									// output the message
									var failType string = Ternary(EvalTruthy(shouldFail), "[TEST_FAILURE]", "[TEST_WARNING]").(string)
				...
				retRes40816 := (<-this.TestMethodAsync(methodName, exchange, args, isPublic))
				PanicOnError(retRes40816)
...
func (this *testMainClass) runPublicTestsBody(ch chan any, exchange ccxt.ICoreExchange, symbols any) any {
	...
	retRes5578 := (<-this.RunTestsAsync(exchange, tests, true))
...
func (this *testMainClass) runTestsBody(ch chan any, exchange ccxt.ICoreExchange, tests any, isPublicTest any) any {
	...
	var testPrefixString string = Ternary(EvalTruthy(isPublicTest), "PUBLIC_TESTS", "PRIVATE_TESTS").(string)
	if IsGreaterThan(GetArrayLength(failedMethods), 0) {
...
func (this *testMainClass) GetTestSymbol(exchange ccxt.ICoreExchange, isSpot any, symbols any) any {
	...
	if (IsEqual(isSpot, true)) && (!IsEqual(preferredSpotSymbol, nil)) && (!IsEqual(preferredSpotSymbol, "")) {
		return preferredSpotSymbol
	} else if (!IsEqual(isSpot, true)) && (!IsEqual(preferredSwapSymbol, nil)) && (!IsEqual(preferredSwapSymbol, "")) {
	...
	for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
		...
		if !IsEqual(market, nil) {
			...
			if (IsEqual(active, true)) || (IsEqual(active, nil)) {
				symbol = s
				break
			}
		}
...
func (this *testMainClass) GetValidSymbol(exchange ccxt.ICoreExchange, optionalArgs ...any) any {
	...
	var targetSymbols any = Ternary(EvalTruthy(spot), spotSymbols, swapSymbols)
...
func (this *testMainClass) getMostActiveSymbolsBody(ch chan any, exchange ccxt.ICoreExchange, defaultSymbols any) any {
	...
	var preferredKey string = Ternary((IsEqual(isSpot, true)), "preferredSpotSymbol", "preferredSwapSymbol").(string)
...
func (this *testMainClass) testExchangeBody(ch chan any, exchange ccxt.ICoreExchange, optionalArgs ...any) any {
	...
	if IsEqual(exchange.SafeBool(exchange.GetHas(), "prediction", false), true) {
		...
		retRes85912 := (<-this.RunPredictionTestsAsync(exchange))
	...
	if !EvalTruthy(this.PrivateTestOnly) {
		...
		if hasSpot && (!IsEqual(spotSymbols, nil)) {
			...
			retRes91916 := (<-this.RunPublicTestsAsync(exchange, spotSymbols))
		...
		if hasSwap && (!IsEqual(swapSymbols, nil)) {
			...
			retRes92616 := (<-this.RunPublicTestsAsync(exchange, swapSymbols))
	...
	if EvalTruthy(this.PrivateTest) || EvalTruthy(this.PrivateTestOnly) {
		if hasSpot && (!IsEqual(spotSymbols, nil)) {
			...
			retRes93216 := (<-this.RunPrivateTestsAsync(exchange, spotSymbols))
			PanicOnError(retRes93216)
		}
		if hasSwap && (!IsEqual(swapSymbols, nil)) {
			AddElementToObject(exchange.GetOptions(), "defaultType", "swap")

			retRes93616 := (<-this.RunPrivateTestsAsync(exchange, swapSymbols))
...
func (this *testMainClass) runPredictionTestsBody(ch chan any, exchange ccxt.ICoreExchange) any {
	...
	if !EvalTruthy(this.WsTests) {
				...
				if !IsEqual(allowUnscopedFetchEvents, true) {
...

					{
						func(this *testMainClass) (ret_ any) {
							...
							retRes100724 := (<-CallExchangeMethodDynamically(exchange, "fetchEvents", []any{map[string]any{}}))
							PanicOnError(retRes100724)
							return nil
						}(this)
		...
		if (!IsEqual(canServeAllTickers, true)) && (IsEqual(exchange.SafeBool(exchange.GetHas(), "fetchTickers", false), true)) {
...

			{
				func(this *testMainClass) (ret_ any) {
					...
					retRes108920 := (<-CallExchangeMethodDynamically(exchange, "fetchTickers", []any{}))
					PanicOnError(retRes108920)
					return nil
				}(this)
				if chSent {
					return nil
	...
	if !EvalTruthy(this.PrivateTestOnly) {
		...
		retRes111712 := (<-this.RunTestsAsync(exchange, publicTests, true))
	...
	if (EvalTruthy(this.PrivateTest) || EvalTruthy(this.PrivateTestOnly)) && !EvalTruthy(this.WsTests) {
		...
		retRes112912 := (<-this.RunTestsAsync(exchange, privateTests, false))
		...
		if EvalTruthy(GetCliArgValue("--fundedTests")) {
			...
			retRes113216 := (<-this.TestPredictionCreateCancelOrderAsync(exchange, outcomeSymbol))
...
func (this *testMainClass) testPredictionCreateCancelOrderBody(ch chan any, exchange ccxt.ICoreExchange, outcome any) any {
	...
	retRes12438 := (<-this.CancelPredictionOrderAsync(exchange, placedId, outcome))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			if IsEqual(exchange.SafeBool(exchange.GetHas(), "cancelOrder", false), true) {
				...
				retRes125716 := (<-CallExchangeMethodDynamically(exchange, "cancelOrder", []any{orderId, outcome}))
				PanicOnError(retRes125716)
			} else {

				retRes125916 := (<-CallExchangeMethodDynamically(exchange, "cancelAllOrders", []any{outcome}))
				PanicOnError(retRes125916)
			}
...
func (this *testMainClass) runPrivateTestsBody(ch chan any, exchange ccxt.ICoreExchange, symbols any) any {
	...
	retRes13618 := (<-this.RunTestsAsync(exchange, tests, false))
	...
	for j := 0; IsLessThan(j, maxRetries); j++ {

		{
			func(this *testMainClass) (ret_ any) {
				...
				retRes137716 := (<-this.TestMethodAsync(proxyTestName, exchange, []any{}, true))
...
func (this *testMainClass) startTestBody(ch chan any, exchange ccxt.ICoreExchange, symbolArgv any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
				...
				if e := recover(); e != nil {
					...
					ret_ = func(this *testMainClass) any {
						...
						if !EvalTruthy(IsSync()) {
							...
							retRes145316 := (<-Close(exchange))
							PanicOnError(retRes145316)
						}
						panic(e)
			...
			retRes144712 := (<-this.TestExchangeAsync(exchange, symbolArgv))
			PanicOnError(retRes144712)
			if !EvalTruthy(IsSync()) {

				retRes144916 := (<-Close(exchange))
				PanicOnError(retRes144916)
			}
			return nil
		}(this)
		if chSent {
...
func (this *testMainClass) LoadStaticData(folder any, optionalArgs ...any) any {
	...
	if !IsEqual(targetExchange, nil) && !IsEqual(targetExchange, "") {
...
func (this *testMainClass) RemoveHostnamefromUrl(url any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(urlParts)); i++ {
		if IsGreaterThan(i, 2) {
			...
			if IsGreaterThan(GetIndexOf(current, "?"), OpNeg(1)) {
...
func (this *testMainClass) UrlencodedToDict(url any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(parts)); i++ {
		...
		if (!IsEqual(value, nil)) && ((StartsWith(value, "[")) || (StartsWith(value, "{"))) {
...
func (this *testMainClass) IsEmptyOutputValue(exchange ccxt.ICoreExchange, value any) any {
	if (IsEqual(value, nil)) || (IsEqual(value, false)) || (IsEqual(value, "")) {
		return true
	}
...
func (this *testMainClass) AssertNewAndStoredOutputInner(exchange ccxt.ICoreExchange, skipKeys any, newOutput any, storedOutput any, optionalArgs ...any) any {
	...
	if EvalTruthy(exchange.IsDictionary(storedOutput)) && EvalTruthy(exchange.IsDictionary(newOutput)) {
		...
		var sanitizedNewOutput any = Ternary(EvalTruthy((IsNullValue(newOutput))), nil, newOutput) // we store undefined as nulls in the json file so we need to convert it back
		var sanitizedStoredOutput any = Ternary(EvalTruthy((IsNullValue(storedOutput))), nil, storedOutput)
		...
		var newOutputString any = Ternary((!IsEqual(sanitizedNewOutput, nil)), ToString(sanitizedNewOutput), "undefined")
		var storedOutputString any = Ternary((!IsEqual(sanitizedStoredOutput, nil)), ToString(sanitizedStoredOutput), "undefined")
...
func (this *testMainClass) AssertStaticRequestOutput(exchange ccxt.ICoreExchange, typeVar any, skipKeys any, storedUrl any, requestUrl any, storedOutput any, newOutput any) any {
	...
	if (IsEqual(storedOutput, nil)) && (IsEqual(newOutput, nil)) {
		if (!IsEqual(storedUrl, nil)) && (!IsEqual(requestUrl, nil)) {
	...
	if IsEqual(typeVar, "json") && (!IsEqual(storedOutput, nil)) && (!IsEqual(newOutput, nil)) {
	...
	} else if IsEqual(typeVar, "urlencoded") && (!IsEqual(storedOutput, nil)) && (!IsEqual(newOutput, nil)) {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			if !EvalTruthy(IsSync()) {
				...
				retRes193616 := (<-CallExchangeMethodDynamically(exchange, method, this.SanitizeDataInput(GetValue(data, "input"))))
				PanicOnError(retRes193616)
			} else {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			if !IsEqual(storedHeaders, nil) {
				var sentHeaders any = Ternary((!IsEqual(exchange.GetLast_request_headers(), nil)), exchange.GetLast_request_headers(), map[string]any{})
				var storedHeaderKeys []string = ObjectKeys(storedHeaders)
				for i := 0; IsLessThan(i, GetArrayLength(storedHeaderKeys)); i++ {
...
func (this *testMainClass) injectWsMessagesBody(ch chan any, exchange ccxt.ICoreExchange, url any, messages any, optionalArgs ...any) any {
	...
	_ = sequential
	var resolvedOnce bool = false
	for i := 0; IsLessThan(i, GetArrayLength(messages)); i++ {
		var waited any = 0
		var waitLimit int = 5000
		if !EvalTruthy(sequential) && resolvedOnce {
			waitLimit = 100
		}
		for !EvalTruthy(WsClientHasPendingFutures(exchange, url)) && (IsLessThan(waited, waitLimit)) && !EvalTruthy(IsWsTestCompleted(exchange, url)) {

			retRes202416 := (<-exchange.Sleep(5))
			PanicOnError(retRes202416)
			waited = Add(waited, 5)
		}
		var wasPending any = WsClientHasPendingFutures(exchange, url)
		...
		for EvalTruthy(WsClientHasPendingFutures(exchange, url)) && (IsLessThan(settled, 500)) {
			...
			retRes203616 := (<-exchange.Sleep(5))
			PanicOnError(retRes203616)
			settled = Add(settled, 5)
		}
		if EvalTruthy(wasPending) && !EvalTruthy(WsClientHasPendingFutures(exchange, url)) {
			resolvedOnce = true
		}
	}

	retRes20438 := (<-exchange.Sleep(5))
	...
	if EvalTruthy(sequential) {
		...
		for !EvalTruthy(IsWsTestCompleted(exchange, url)) && (IsLessThan(waitedDone, 30000)) {
			...
			retRes205516 := (<-exchange.Sleep(50))
			PanicOnError(retRes205516)
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			if !IsEqual(expectedResults, nil) {
				...
				retRes213616 := (<-promiseAll(promises))
				PanicOnError(retRes213616)
...
func (this *testMainClass) testExchangeWsStaticallyBody(ch chan any, exchangeName any, exchangeData any, optionalArgs ...any) any {
	...
	_ = testName
	var globalOptions any = Ternary(IsEqual(GetValue(exchangeData, "options"), nil), map[string]any{}, GetValue(exchangeData, "options"))
	var methods any = Ternary(IsEqual(GetValue(exchangeData, "methods"), nil), map[string]any{}, GetValue(exchangeData, "methods"))
	...
	for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
		...
		for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
			...
			retRes220916 := (<-this.TestWsStaticallyAsync(exchange, method, skipKeys, result))
			PanicOnError(retRes220916)
			if !EvalTruthy(IsSync()) {

				retRes221120 := (<-Close(exchange))
				PanicOnError(retRes221120)
			}
		}
	}
...
func (this *testMainClass) InitOfflineExchange(exchangeName any, optionalArgs ...any) ccxt.ICoreExchange {
	...
	if !IsEqual(predictionEvents, nil) {
		...
		if IsGreaterThan(GetArrayLength(eventMarkets), 0) {
...
func (this *testMainClass) testExchangeRequestStaticallyBody(ch chan any, exchangeName any, exchangeData any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
		...
		for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
			...
			if (IsEqual(isDisabledCSharp, true)) && (this.Lang == "C#") {
				continue
			}
			var isDisabledGo any = ccxt.DerefScalar(exchange.SafeBool(result, "disabledGO", false))
			if (IsEqual(isDisabledGo, true)) && (this.Lang == "GO") {
				continue
			}
			...
			if (IsEqual(isDisabledJava, true)) && (this.Lang == "java") {
				continue
			}
			var typeVar any = exchange.SafeString(exchangeData, "outputType")
			var skipKeys any = exchange.SafeValue(exchangeData, "skipKeys", []any{})

			retRes240816 := (<-this.TestRequestStaticallyAsync(exchange, method, result, typeVar, skipKeys))
...
func (this *testMainClass) testExchangeResponseStaticallyBody(ch chan any, exchangeName any, exchangeData any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(methodsNames)); i++ {
		...
		for j := 0; IsLessThan(j, GetArrayLength(results)); j++ {
			...
			if (IsEqual(isDisabledPHP, true)) && (this.Lang == "PHP") {
				continue
			}
			if (!IsEqual(testName, nil)) && (!IsEqual(testName, description)) {
				continue
			...
			retRes248716 := (<-this.TestResponseStaticallyAsync(exchange, method, skipKeys, result))
			PanicOnError(retRes248716)
			// reset options
...
func (this *testMainClass) CheckIfExchangeIsDisabled(exchangeName any, exchangeData any) any {
	...
	if (IsEqual(isAsyncOnly, true)) && EvalTruthy(IsSync()) {
	...
	if (IsEqual(isDisabledPy, true)) && (this.Lang == "PY") {
...
func (this *testMainClass) runStaticRequestTestsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes25588 := (<-this.RunStaticTestsAsync("request", targetExchange, testName))
...
func (this *testMainClass) runStaticTestsBody(ch chan any, typeVar any, optionalArgs ...any) any {
	...
	if !IsEqual(testName, nil) && !IsEqual(testName, "") {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes260112 := (<-promiseAll(promises))
			PanicOnError(retRes260112)
			return nil
		}(this)
	...
	if EvalTruthy(this.RequestTestsFailed) || EvalTruthy(this.ResponseTestsFailed) || EvalTruthy(this.StaticWsTestsFailed) {
		...
		var prefix string = Ternary(EvalTruthy((IsSync())), "[SYNC]", "").(string)
...
func (this *testMainClass) runStaticResponseTestsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes26278 := (<-this.RunStaticTestsAsync("response", exchangeName, test))
...
func (this *testMainClass) runStaticWsTestsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes26408 := (<-this.RunStaticTestsAsync("ws", exchangeName, test))
...
func (this *testMainClass) runBrokerIdTestsBody(ch chan any) any {
	...
	retRes26798 := (<-promiseAll(promises))
...
func (this *testMainClass) testBinanceBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes269312 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes270312 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes270912 := (<-exchange.CreateOrderAsync("BTC/USD:BTC", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes272312 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 0.002, 102000, map[string]any{
				"triggerPrice": 101000,
			}))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes275012 := (<-exchange.CreateOrdersAsync(orders))
...
func (this *testMainClass) testOkxBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes277112 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes278212 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testCryptocomBody(ch chan any) any {
	...
	retRes27998 := (<-exchange.LoadMarketsAsync())
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes280212 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testBybitBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					...
					ret_ = func(this *testMainClass) any {
						...
						reqHeaders = Ternary((!IsEqual(exchange.GetLast_request_headers(), nil) && !IsEqual(exchange.GetLast_request_headers(), nil)), exchange.GetLast_request_headers(), map[string]any{})
						return nil
					}(this)
				}
			}()
			...
			retRes282012 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testBithumbBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes283812 := (<-exchange.CreateOrderAsync("BTC/KRW", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes284712 := (<-exchange.CreateOrderAsync("BTC/KRW", "limit", "buy", 1, 20000, map[string]any{
				"generation": 1,
			}))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes285512 := (<-exchange.FetchTickerAsync("BTC/KRW"))
...
func (this *testMainClass) testKucoinBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes287912 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
			PanicOnError(retRes287912)
			return nil
		}(this)
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes288712 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000, map[string]any{
				"uta": true,
			}))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes289412 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes290012 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any{
				"uta": true,
			}))
...
func (this *testMainClass) testKucoinfuturesBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes292112 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes292812 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testBitgetBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes294512 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testMexcBody(ch chan any) any {
	...
	retRes29618 := (<-exchange.LoadMarketsAsync())
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes296312 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testHtxBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes298012 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes299012 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes299612 := (<-exchange.CreateOrderAsync("BTC/USD:BTC", "limit", "buy", 1, 20000))
	...
	if !EvalTruthy(IsSync()) {
		...
		retRes300512 := (<-Close(exchange))
		PanicOnError(retRes300512)
	}
...
func (this *testMainClass) testWooBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes301612 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes302612 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000, map[string]any{
				"stopPrice": 30000,
			}))
...
func (this *testMainClass) testCoinexBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes304412 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testBingxBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes306312 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testPhemexBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes308012 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
			PanicOnError(retRes308012)
			return nil
		}(this)
...
func (this *testMainClass) testBlofinBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes309812 := (<-exchange.CreateOrderAsync("LTC/USDT:USDT", "market", "buy", 1))
...
func (this *testMainClass) testCoinbaseinternationalBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes313512 := (<-exchange.CreateOrderAsync("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testCoinbaseAdvancedBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes315312 := (<-exchange.CreateOrderAsync("BTC/USDC", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testWoofiProBody(ch chan any) any {
	...
	retRes31728 := (<-exchange.LoadMarketsAsync())
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes317512 := (<-exchange.CreateOrderAsync("BTC/USDC:USDC", "limit", "buy", 1, 20000))
			PanicOnError(retRes317512)
			return nil
		}(this)
...
func (this *testMainClass) testXTBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes319212 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes320012 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testParadexBody(ch chan any) any {
	...
	retRes32258 := (<-exchange.LoadMarketsAsync())
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes322712 := (<-exchange.CreateOrderAsync("BTC/USD:USDC", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testHashkeyBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes324312 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testCryptomusBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes325912 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "sell", 1, 20000))
...
func (this *testMainClass) testDeriveBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes328712 := (<-exchange.CreateOrderAsync("LBTC/USDC", "limit", "sell", 0.01, 3000, params))
...
func (this *testMainClass) testModeTradeBody(ch chan any) any {
	...
	retRes33058 := (<-exchange.LoadMarketsAsync())
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes330812 := (<-exchange.CreateOrderAsync("BTC/USDC:USDC", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testBackpackBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes332712 := (<-exchange.CreateOrderAsync("ETH/USDC", "limit", "buy", 1, 5000))
...
func (this *testMainClass) testToobitBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes334412 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
	...
	if !EvalTruthy(IsSync()) {
		...
		retRes335112 := (<-Close(exchange))
		PanicOnError(retRes335112)
	}
...
func (this *testMainClass) testWeexBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes336212 := (<-exchange.CreateOrderAsync("BTC/USDT", "limit", "buy", 1, 20000))
			PanicOnError(retRes336212)
			return nil
		}(this)
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes336912 := (<-exchange.CreateOrderAsync("BTC/USDT:USDT", "limit", "buy", 1, 20000))
...
func (this *testMainClass) testFoxbitBody(ch chan any) any {
...

	{
		func(this *testMainClass) (ret_ any) {
			...
			retRes338212 := (<-exchange.CreateOrderAsync("BTC/BRL", "limit", "buy", 1, 20000))
			PanicOnError(retRes338212)
			return nil
		}(this)
