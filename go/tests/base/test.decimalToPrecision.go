...
func TestDecimalToPrecision() {
	...
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("12.3456", ccxt.TRUNCATE, int64(-1), ccxt.DECIMAL_PLACES), "10")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("123.456", ccxt.TRUNCATE, int64(-1), ccxt.DECIMAL_PLACES), "120")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("123.456", ccxt.TRUNCATE, int64(-2), ccxt.DECIMAL_PLACES), "100")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("9.99999", ccxt.TRUNCATE, int64(-1), ccxt.DECIMAL_PLACES), "0")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("99.9999", ccxt.TRUNCATE, int64(-1), ccxt.DECIMAL_PLACES), "90")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("99.9999", ccxt.TRUNCATE, int64(-2), ccxt.DECIMAL_PLACES), "0")))
	...
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("12.3456", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "10")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("123.456", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "120")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("123.456", ccxt.ROUND, int64(-2), ccxt.DECIMAL_PLACES), "100")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("9.99999", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "10")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("99.9999", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "100")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("99.9999", ccxt.ROUND, int64(-2), ccxt.DECIMAL_PLACES), "100")))
	...
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("5", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "10")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("4.999", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "0")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("0.0431531423", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "0")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("-69.3", ccxt.ROUND, int64(-1), ccxt.DECIMAL_PLACES), "-70")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("5001", ccxt.ROUND, int64(-4), ccxt.DECIMAL_PLACES), "10000")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("4999.999", ccxt.ROUND, int64(-4), ccxt.DECIMAL_PLACES), "0")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("69.3", ccxt.TRUNCATE, int64(-2), ccxt.DECIMAL_PLACES), "0")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("-69.3", ccxt.TRUNCATE, int64(-2), ccxt.DECIMAL_PLACES), "0")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("69.3", ccxt.TRUNCATE, int64(-1), ccxt.SIGNIFICANT_DIGITS), "60")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("-69.3", ccxt.TRUNCATE, int64(-1), ccxt.SIGNIFICANT_DIGITS), "-60")))
	Assert((ccxt.IsEqual(exchange.DecimalToPrecision("69.3", ccxt.TRUNCATE, int64(-2), ccxt.SIGNIFICANT_DIGITS), "0")))
