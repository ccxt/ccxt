...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestOrder(exchange ccxt.ICoreExchange, skippedProperties any, method any, entry any, symbol any, now any)  {
        ...
        //
        AssertInArray(exchange, skippedProperties, method, entry, "timeInForce", []any{"GTC", "GTK", "IOC", "FOK", "PO"})
        AssertInArray(exchange, skippedProperties, method, entry, "status", []any{"open", "closed", "canceled"})
        AssertInArray(exchange, skippedProperties, method, entry, "side", []any{"buy", "sell"})
        AssertInArray(exchange, skippedProperties, method, entry, "postOnly", []any{true, false})
