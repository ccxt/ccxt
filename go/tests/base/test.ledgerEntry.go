...
// https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code
    ...
    func TestLedgerEntry(exchange ccxt.ICoreExchange, skippedProperties any, method any, entry any, requestedCode any, now any)  {
        ...
        //
        AssertInArray(exchange, skippedProperties, method, entry, "direction", []any{"in", "out"})
        AssertInArray(exchange, skippedProperties, method, entry, "type", []any{"trade", "transaction", "margin", "cashback", "referral", "transfer", "fee"})
