...
func (this *Whitebit) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < len(symbols); i++ {
		...
		var fee map[string]any = this.SafeDictMap(response, market["baseId"], map[string]any{})
 ...
 */
func (this *Whitebit) FetchFundingLimitsAsync(optionalArgs ...any) <-chan EndpointResult[map[string]any] {
	ch := make(chan EndpointResult[map[string]any], 1)
	go this.fetchFundingLimitsBody(ch, optionalArgs...)
	return ch
}
func (this *Whitebit) fetchFundingLimitsBody(ch chan EndpointResult[map[string]any], optionalArgs ...any) any {
	defer close(ch)
 ...
 */
func (this *Whitebit) FetchStatusAsync(optionalArgs ...any) <-chan EndpointResult[map[string]any] {
	ch := make(chan EndpointResult[map[string]any], 1)
	go this.fetchStatusBody(ch, optionalArgs...)
	return ch
}
func (this *Whitebit) fetchStatusBody(ch chan EndpointResult[map[string]any], optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicErrorT(ch)
	var params map[string]any = GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Whitebit) fetchAccountsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < len(subAccounts); i++ {
		var subAccount map[string]any = this.SafeDictMap(subAccounts, i, map[string]any{})
...
func (this *Whitebit) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if since != nil {
		request["startDate"] = math.Round(float64(*since) / 1000)
	}
	...
	if response != nil {
		...
		if hasErrorStatus || (codeNew != nil) {
			...
			if hasErrorStatus {
				...
				var errorKeys []string = nil
				if errorObject != nil {
					errorKeys = make([]string, 0, len(errorObject))
					for objectKey := range errorObject {
						errorKeys = append(errorKeys, objectKey)
					}
				}
		...
		if success == nil || *success != true {
			...
			var errKeys []string = nil
			if errMsg != nil {
				errKeys = make([]string, 0, len(errMsg))
				for objectKey := range errMsg {
					errKeys = append(errKeys, objectKey)
				}
			}
