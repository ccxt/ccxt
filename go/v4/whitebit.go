...
func (this *Whitebit) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PublicGetAssets(params)).Raw))
	//
	//      {
	//          "1INCH": {
	//              "name": "1inch",
		...
		if !IsEqual(feeData, nil) {
			...
			if (!IsEqual(depositFee, nil)) && (!IsEqual(depositFee, nil)) {
				...
				if (!IsEqual(GetValue(depositFee, "flex"), nil)) && (!IsEqual(GetValue(depositFee, "flex"), nil)) {
					depositFeeData["flex"] = map[string]any{
			...
			if (!IsEqual(withdrawFee, nil)) && (!IsEqual(withdrawFee, nil)) {
				...
				if (!IsEqual(GetValue(withdrawFee, "flex"), nil)) && (!IsEqual(GetValue(withdrawFee, "flex"), nil)) {
					withdrawFeeData["flex"] = map[string]any{
...
func (this *Whitebit) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetTicker(this.Extend(request, params))).Raw))
	//
	//      {
	//         "success":true,
	//         "message":"",
...
func (this *Whitebit) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if checkExecuted != nil && *checkExecuted == true {
...
func (this *Whitebit) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if method == nil {
		...
		if onlyContractSymbols || (marketType != nil && *marketType == "swap") {
			method = SafeStringPtr("v4PublicGetFutures")
		} else {
			method = SafeStringPtr("v4PublicGetTicker")
		}
	}
	var response any = nil
	if method != nil && *method == "v4PublicGetTicker" {
		//
		//      "BCH_RUB": {
		//          "base_id":1831,
		//          "quote_id":0,
...
func (this *Whitebit) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetKline(this.Extend(request, params))).Raw))
	//
	//     {
	//         "success":true,
	//         "message":"",
...
func (this *Whitebit) fetchTimeBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PublicGetTime(params)).Raw))
...
func (this *Whitebit) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	...
	var clientOrderId *string = this.SafeString2(paramsCost, "clOrdId", "clientOrderId")
	...
	var triggerPrice *float64 = this.SafeNumberN(paramsOmitted, []any{"triggerPrice", "stopPrice", "activation_price"})
	...
	var postOnly bool = this.IsPostOnly(isMarketOrder, false, paramsOmitted)
	var ioc bool = (timeInForce != nil && *timeInForce == "IOC")
	if isStopOrder && (postOnly || ioc) {
		panic(NotSupported(this.Id + " createOrder() does not support postOnly or timeInForce IOC for stop orders"))
	}
	if ioc && !isLimitOrder {
	...
	if isStopOrder {
		...
		if isLimitOrder {
			...
			response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderStopLimit(this.Extend(request, orderParams))).Raw))
		} else {
			// stop market order
			if useCollateralEndpoint {

				response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderCollateralTriggerMarket(this.Extend(request, orderParams))).Raw))
			} else {

				response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderStopMarket(this.Extend(request, orderParams))).Raw))
			}
		}
	} else {
		if isLimitOrder {
			...
			if useCollateralEndpoint {
				...
				response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderCollateralLimit(this.Extend(request, orderParams))).Raw))
			} else {

				response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderNew(this.Extend(request, orderParams))).Raw))
			}
		} else {
			// market order
			if useCollateralEndpoint {

				response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderCollateralMarket(this.Extend(request, orderParams))).Raw))
			} else {
				if !IsEqual(cost, nil) {

					response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderMarket(this.Extend(request, orderParams))).Raw))
				} else {

					response = MapTyped(PanicOnError((<-this.V4PrivatePostOrderStockMarket(this.Extend(request, orderParams))).Raw))
				}
			}
		}
	}
...
func (this *Whitebit) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var triggerPrice *float64 = this.SafeNumberN(params, []any{"triggerPrice", "stopPrice", "activationPrice"})
	var isStopOrder bool = (triggerPrice != nil)
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PrivatePostOrderModify(this.Extend(request, paramsOmitted))).Raw))
...
func (this *Whitebit) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "spot" {
		...
		panic(NotSupported(this.Id + " cancelAllOrders() does not support " + *marketType + " type"))
	}
	request["type"] = requestType

	var response []any = ListTyped(PanicOnError((<-this.V4PrivatePostOrderCancelAll(this.Extend(request, requestParams))).Raw))
...
func (this *Whitebit) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "swap" {
		...
		response = MapTyped(PanicOnError((<-this.V4PrivatePostCollateralAccountBalance(paramsMarketType)).Raw))
	} else {
		...
		if (account != nil && *account == "main") || (account != nil && *account == "funding") {
			...
			response = MapTyped(PanicOnError((<-this.V4PrivatePostMainAccountBalance(paramsOmitted)).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.V4PrivatePostTradeAccountBalance(paramsOmitted)).Raw))
		}
	}
...
func (this *Whitebit) ParseOrder(order any, optionalArgs ...any) any {
	...
	var triggerPrice *float64 = this.SafeNumber(order, "activation_price")
	var orderId *string = this.SafeString2(order, "orderId", "id")
	var typeVar *string = this.SafeString(order, "type")
	var orderType *string = this.ParseOrderType(typeVar)
...
func (this *Whitebit) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PrivatePostTradeAccountOrder(this.Extend(request, params))).Raw))
	//
	//     {
	//         "records": [
	//             {
...
func (this *Whitebit) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PrivatePostMainAccountHistory(this.Extend(request, params))).Raw))
...
func (this *Whitebit) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if EvalTruthy(this.IsFiat(code)) {
		...
		if amount == nil {
			panic(ArgumentsRequired(this.Id + " fetchDepositAddress() requires an amount when the ticker is fiat"))
		}
...
func (this *Whitebit) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PrivatePostMainAccountCreateNewAddress(this.Extend(request, params))).Raw))
	//
	//     {
	//         "account": {
	//             "address": "GDTSOI56XNVAKJNJBLJGRNZIVOCIZJRBIDKTWSCYEYNFAZEMBLN75RMN",
...
func (this *Whitebit) fetchAccountsBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V4PrivatePostSubAccountList(params)).Raw))
	//
	//     {
	//         "offset": 0,
	//         "limit": 100,
...
func (this *Whitebit) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var interestRate *float64 = this.SafeNumber(contract, "interestRate")
...
func (this *Whitebit) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes422219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchFundingRateHistory", symbol, since, limit, "8h", paramsPaginate, maxLimit))))
		ch <- BoxAbsent(retRes422219)
		return nil
	}
	if this.Markets == nil {
	...
	var response []any = ListTyped(PanicOnError((<-this.V4PublicGetFundingHistoryMarket(this.Extend(requestUntil, paramsUntil))).Raw))
...
func (this *Whitebit) Sign(path string, optionalArgs ...any) any {
	...
	if IsEqual(accessibility, "private") {
		...
		var payload string = this.StringToBase64(privateBody)
	...
	var requestHeaders any = publicHeaders
	if isPrivate {
...
func (this *Whitebit) FetchFundingLimits(options ...FetchFundingLimitsOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchFundingLimitsAsync(opts.Codes, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value, nil
