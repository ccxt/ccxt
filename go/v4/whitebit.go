...
func (this *WhitebitCore) ParseMarket(market any) any {
	...
	var margin bool = EvalTruthy(isCollateral) && !swap
...
func (this *WhitebitCore) fetchTradingLimitsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(marketIds)); i++ {
		...
		if !EvalTruthy(market) || !EvalTruthy(GetValue(market, "symbol")) {
			continue
		}
		var symbol any = GetValue(market, "symbol")
		// Filter by symbols if specified
		if EvalTruthy(symbols) {
		...
		var hasAmountLimits bool = EvalTruthy(amountLimits) && !IsEqual(this.SafeNumber(amountLimits, "min"), nil) && !IsEqual(this.SafeNumber(amountLimits, "max"), nil)
		var hasPriceLimits bool = EvalTruthy(priceLimits) && !IsEqual(this.SafeNumber(priceLimits, "min"), nil) && !IsEqual(this.SafeNumber(priceLimits, "max"), nil)
		var hasCostLimits bool = EvalTruthy(costLimits) && !IsEqual(this.SafeNumber(costLimits, "min"), nil) && !IsEqual(this.SafeNumber(costLimits, "max"), nil)
...
func (this *WhitebitCore) fetchFundingLimitsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(currencyKeys)); i++ {
		...
		for j := 0; IsLessThan(j, GetArrayLength(feeKeys)); j++ {
			...
			if EvalTruthy(fee) && IsEqual(GetValue(fee, "ticker"), code) {
				feeData = fee
				break
			}
		}
		...
		if EvalTruthy(GetValue(currency, "networks")) {
