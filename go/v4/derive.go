...
func (this *Derive) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes126812 := (<-this.LoadMarketsAsync())
	...
	if reduceOnly != nil {
		...
		if (reduceOnly != nil && *reduceOnly) && (postOnly != nil && *postOnly == true) {
			panic(InvalidOrder(this.Id + " cannot use reduce only with post only time in force"))
		}
	}
	if postOnly != nil {
...
func (this *Derive) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes163512 := (<-this.LoadMarketsAsync())
...
func (this *Derive) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes172612 := (<-this.LoadMarketsAsync())
...
func (this *Derive) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes177612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes177612)
	}
	...
	if paginate == true {
		...
		retRes178119 := (<-this.FetchPaginatedCallIncrementalAsync("fetchOrders", symbol, since, limit, params, "page", 500))
		PanicOnError(retRes178119)
		ch <- retRes178119
		return nil
	}
	var isTrigger *bool = this.SafeBool2(params, "trigger", "stop", false)
...
func (this *Derive) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes187915 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
...
func (this *Derive) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes189612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes189612)
	}
	var extendedParams map[string]any = this.Extend(params, map[string]any{
		"status": "filled",
	})

	retRes189915 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
	PanicOnError(retRes189915)
	ch <- retRes189915
	return nil
}
...
func (this *Derive) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes191915 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
	PanicOnError(retRes191915)
	ch <- retRes191915
	return nil
}
...
func (this *Derive) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes216719 := (<-this.FetchPaginatedCallIncrementalAsync("fetchMyTrades", symbol, since, limit, params, "page", 500))
		PanicOnError(retRes216719)
		ch <- retRes216719
		return nil
	}
	var subaccountId any = nil
...
func (this *Derive) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes224712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes224712)
	}
	var subaccountId any = nil
...
func (this *Derive) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes239519 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingHistory", symbol, since, limit, params, "page", 500))
		PanicOnError(retRes239519)
		ch <- retRes239519
		return nil
	}
	var subaccountId any = nil
...
func (this *Derive) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes249412 := (<-this.LoadMarketsAsync())
...
func (this *Derive) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes259412 := (<-this.LoadMarketsAsync())
