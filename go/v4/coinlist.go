...
func  (this *coinlist) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(currencies)); i++ {
                ...
                var isFiat interface{} = IsEqual(code, "USD")
...
func  (this *coinlist) ParseMarket(market interface{}) interface{}  {
    ...
    //        "index_price": null
    //    }
    var isSwap interface{} = IsEqual(this.SafeString(market, "type"), "perp-swap")
    ...
    var settledId interface{} = nil
    var settled interface{} = nil
    ...
    var typeVar interface{} = Ternary(IsTrue(isSwap), "swap", "spot")
...
func  (this *coinlist) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes139815 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes139815)
                ch <- retRes139815
                return nil
