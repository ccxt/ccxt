...
func  (this *DeepcoinCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                params = this.Extend(params, map[string]any {
                    ...
                    retRes65219 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
                    PanicOnError(retRes65219)
                    ch <- retRes65219
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *DeepcoinCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes99219 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "code", nil, 1, 50))
                    PanicOnError(retRes99219)
                    ch <- retRes99219
                    return nil
            }
            var request any = map[string]any {}
...
func  (this *DeepcoinCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes103819 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "code", nil, 1, 50))
...
func  (this *DeepcoinCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <- chan any {
            ...
            params = this.Extend(params, map[string]any {
                ...
                retRes174015 :=  (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
                PanicOnError(retRes174015)
                ch <- retRes174015
                return nil
...
func  (this *DeepcoinCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            params = this.Extend(params, map[string]any {
                ...
                retRes175415 :=  (<-this.CreateOrder(symbol, "market", "buy", 0, nil, params))
                PanicOnError(retRes175415)
                ch <- retRes175415
                return nil
...
func  (this *DeepcoinCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            params = this.Extend(params, map[string]any {
                ...
                retRes176815 :=  (<-this.CreateOrder(symbol, "market", "sell", 0, nil, params))
...
func  (this *DeepcoinCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes189519 :=  (<-this.FetchPaginatedCallDynamic("fetchCanceledAndClosedOrders", symbol, since, limit, params))
...
func  (this *DeepcoinCore) FetchCanceledOrders(optionalArgs ...any) <- chan any {
            ...
            params = this.Extend(params, map[string]any {
                ...
                retRes201915 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, params))
                PanicOnError(retRes201915)
                ch <- retRes201915
                return nil
...
func  (this *DeepcoinCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            params = this.Extend(params, map[string]any {
                ...
                retRes203815 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, params))
...
func  (this *DeepcoinCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes288019 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func  (this *DeepcoinCore) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
            ...
            params = this.Extend(map[string]any {
                ...
                retRes295515 :=  (<-this.FetchMyTrades(symbol, since, limit, params))
                PanicOnError(retRes295515)
                ch <- retRes295515
                return nil
