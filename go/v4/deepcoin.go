...
func (this *DeepcoinCore) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	network = Ternary((!IsEqual(network, nil) && (network != "")), network, defaultNetwork)
...
func (this *DeepcoinCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	userId = Ternary((!IsEqual(userId, nil) && (userId != "")), userId, this.SafeString(params, "uid"))
...
func (this *DeepcoinCore) HandleTypePostOnlyAndTimeInForce(typeVar any, params any) any {
	...
	if (!IsEqual(timeInForce, nil)) && (timeInForce == "IOC") {
		typeVar = "ioc"
	}
...
func (this *DeepcoinCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if isTPSL {
		...
		if !IsEqual(stopLossPrice, nil) {
			AddElementToObject(request, "slTriggerPx", Ternary((symbol != ""), this.PriceToPrecision(symbol, stopLossPrice), this.NumberToString(stopLossPrice)))
		}
		if !IsEqual(takeProfitPrice, nil) {
			AddElementToObject(request, "tpTriggerPx", Ternary((symbol != ""), this.PriceToPrecision(symbol, takeProfitPrice), this.NumberToString(takeProfitPrice)))
		}
...
func (this *DeepcoinCore) HandleErrors(code any, reason any, url any, method any, headers any, body any, response any, requestHeaders any, requestBody any) any {
	...
	if (!IsEqual(msg, nil)) && (msg == "") && (sMsg != nil) {
		msg = sMsg
	}
	...
	if (code != 200) || (messageCode == nil || *messageCode != "0") || (!IsEqual(sCode, nil) && (sCode != "0")) {
