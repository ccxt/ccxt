...
func (this *DeepcoinCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12588 := (<-this.LoadMarkets())
		PanicOnError(retRes12588)
...
func (this *DeepcoinCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes173915 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes173915)
		ch <- retRes173915
		return nil
...
func (this *DeepcoinCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes175315 := (<-this.CreateOrder(symbol, "market", "buy", 0, nil, params))
		PanicOnError(retRes175315)
		ch <- retRes175315
		return nil
...
func (this *DeepcoinCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes176715 := (<-this.CreateOrder(symbol, "market", "sell", 0, nil, params))
...
func (this *DeepcoinCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes189419 := (<-this.FetchPaginatedCallDynamic("fetchCanceledAndClosedOrders", symbol, since, limit, params))
...
func (this *DeepcoinCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes201815 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, params))
...
func (this *DeepcoinCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes203715 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, params))
		PanicOnError(retRes203715)
		ch <- retRes203715
		return nil
...
func (this *DeepcoinCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes295415 := (<-this.FetchMyTrades(symbol, since, limit, params))
		PanicOnError(retRes295415)
		ch <- retRes295415
		return nil
