 ...
 */
func (this *Paymium) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Paymium) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
...
func (this *Paymium) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if (!IsEqual(code, "BTC")) && (!IsEqual(code, "EUR")) {
		panic(ExchangeError(this.Id + " transfer() only allows BTC or EUR"))
	}
	var request map[string]any = map[string]any{
