...

			{
				func(this *BullishCore) (ret_ any) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes130927 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes130927)
						ch <- retRes130927
						return nil
					} else {

						retRes131127 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes131127)
						ch <- retRes131127
						return nil
					}
...
func (this *BullishCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes134919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
...
func (this *BullishCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes142519 := (<-this.FetchPaginatedCallDynamic("fetchFundingRateHistory", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes142519)
			ch <- retRes142519
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BullishCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14878 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
		...
		if IsTrue(paginate) {
			...
			retRes149219 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
...
func (this *BullishCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes161415 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BullishCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes163415 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes163415)
		ch <- retRes163415
		return nil
...
func (this *BullishCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes165415 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes165415)
		ch <- retRes165415
		return nil
...
func (this *BullishCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes167415 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BullishCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes16898 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes17508 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18128 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18558 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18908 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchDepositsWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20508 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes21198 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchAccounts(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22758 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes23798 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes24508 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes25218 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes26318 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
		...
		if IsTrue(paginate) {
			...
			retRes263819 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params, maxLimit))
			PanicOnError(retRes263819)
			ch <- retRes263819
			return nil
		}
		var request any = map[string]any{
...
func (this *BullishCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes26918 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes27858 := (<-promiseAll([]any{this.LoadMarkets(), this.HandleToken()}))
...
func (this *BullishCore) HandleToken(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(IsTrue((IsEqual(token, nil))) || IsTrue((IsEqual(tokenExpires, nil)))) || IsTrue((IsGreaterThan(now, tokenExpires)))) {
			...
			retRes304419 := (<-this.SignIn())
			PanicOnError(retRes304419)
			ch <- retRes304419
			return nil
		} else {
