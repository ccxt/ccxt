...
func (this *GrvtCore) EipMessageForOrder(order interface{}, optionalArgs ...interface{}) interface{} {
	...
	for i := 0; IsLessThan(i, GetArrayLength(orderLegs)); i++ {
		...
		var size_int interface{} = Divide(Multiply(this.ConvertToBigIntCustom(Replace(size, ".", "")), sizeMultiplier), (MathPow(bigInt10, this.ConvertToBigIntCustom(sizeDecLengthStr))))
		...
		var price_int interface{} = (Divide(Multiply(this.ConvertToBigIntCustom(Replace(price, ".", "")), this.ConvertToBigIntCustom(priceMultiplier)), (MathPow(bigInt10, this.ConvertToBigIntCustom(limitDecLengthStr)))))
		AppendToArray(&legs, map[string]interface{}{
...
func (this *GrvtCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes19248 := (<-this.LoadMarketsAndSignIn())
		...
		if IsTrue(paginate) {
			...
			retRes192819 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes192819)
			ch <- retRes192819
			return nil
		}
		var request interface{} = map[string]interface{}{
		...
		if IsTrue(!IsEqual(symbol, nil)) {
			...
			retRes193712 := GetValue(request, "base")
			AppendToArray(&retRes193712, GetValue(market, "baseId"))
			AddElementToObject(request, "quote", []interface{}{})
			retRes193912 := GetValue(request, "quote")
			AppendToArray(&retRes193912, GetValue(market, "quoteId"))
		}
		if IsTrue(!IsEqual(limit, nil)) {
			AddElementToObject(request, "limit", mathMin(limit, 1000))
		}
...
func (this *GrvtCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes19948 := (<-this.LoadMarketsAndSignIn())
		...
		if IsTrue(!IsEqual(symbols, nil)) {
			...
			for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
				...
				retRes200816 := GetValue(request, "base")
				AppendToArray(&retRes200816, GetValue(market, "baseId"))
				retRes200916 := GetValue(request, "quote")
				AppendToArray(&retRes200916, GetValue(market, "quoteId"))
			}
		}
...
func (this *GrvtCore) FetchLeverages(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes21108 := (<-this.LoadMarketsAndSignIn())
...
func (this *GrvtCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes21448 := (<-this.LoadMarketsAndSignIn())
...
func (this *GrvtCore) FetchMarginModes(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes22008 := (<-this.LoadMarketsAndSignIn())
...
func (this *GrvtCore) FetchFundingHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes22548 := (<-this.LoadMarketsAndSignIn())
		...
		if IsTrue(paginate) {
			...
			retRes225819 := (<-this.FetchPaginatedCallDynamic("fetchFundingHistory", symbol, since, limit, params, 1000))
			PanicOnError(retRes225819)
			ch <- retRes225819
			return nil
		}
		var request interface{} = map[string]interface{}{
		...
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
			AddElementToObject(request, "base", []interface{}{})
			retRes226712 := GetValue(request, "base")
			AppendToArray(&retRes226712, GetValue(market, "baseId"))
			AddElementToObject(request, "quote", []interface{}{})
			retRes226912 := GetValue(request, "quote")
			AppendToArray(&retRes226912, GetValue(market, "quoteId"))
		}
		if IsTrue(!IsEqual(limit, nil)) {
			AddElementToObject(request, "limit", mathMin(limit, 1000))
		}
...
func (this *GrvtCore) FetchOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes23378 := (<-this.LoadMarketsAndSignIn())
		...
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
			AddElementToObject(request, "base", []interface{}{})
			retRes234512 := GetValue(request, "base")
			AppendToArray(&retRes234512, GetValue(market, "baseId"))
			AddElementToObject(request, "quote", []interface{}{})
			retRes234712 := GetValue(request, "quote")
			AppendToArray(&retRes234712, GetValue(market, "quoteId"))
		}
		if IsTrue(!IsEqual(limit, nil)) {
			AddElementToObject(request, "limit", mathMin(limit, 1000))
		}
...
func (this *GrvtCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes25168 := (<-this.LoadMarketsAndSignIn())
...
func (this *GrvtCore) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes27518 := (<-this.LoadMarketsAndSignIn())
		...
		if IsTrue(!IsEqual(symbol, nil)) {
			var market interface{} = this.Market(symbol)
			AddElementToObject(request, "base", []interface{}{})
			retRes275812 := GetValue(request, "base")
			AppendToArray(&retRes275812, GetValue(market, "baseId"))
			AddElementToObject(request, "quote", []interface{}{})
			retRes276012 := GetValue(request, "quote")
			AppendToArray(&retRes276012, GetValue(market, "quoteId"))
		}
		...
		if IsTrue(run) {

			{
				func(this *GrvtCore) (ret_ interface{}) {
					...
					retRes284516 := (<-this.PrivateTradingPostFullV1AuthorizeBuilder(this.Extend(request, params)))
					PanicOnError(retRes284516)
					//
					// {
					//     "result": {
					//         "ack": "true"
