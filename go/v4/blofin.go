...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes492736 := (<-this.LoadMarkets())
            PanicOnError(retRes492736)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes942894 := (<-this.LoadMarkets())
            PanicOnError(retRes942894)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes173440 := (<-this.LoadMarkets())
            PanicOnError(retRes173440)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes632850 := (<-this.LoadMarkets())
            PanicOnError(retRes632850)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes230814 := (<-this.LoadMarkets())
            PanicOnError(retRes230814)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes741970 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes741970)
                    ch <- retRes741970
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes53841 := (<-this.LoadMarkets())
            PanicOnError(retRes53841)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes208006 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes208006)
                    ch <- retRes208006
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes99428 := (<-this.LoadMarkets())
            PanicOnError(retRes99428)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes95148 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes95148)
                    ch <- retRes95148
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes948575 := (<-this.LoadMarkets())
            PanicOnError(retRes948575)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928778 := (<-this.LoadMarkets())
            PanicOnError(retRes928778)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes345911 := (<-this.LoadMarkets())
            PanicOnError(retRes345911)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980637 := (<-this.LoadMarkets())
            PanicOnError(retRes980637)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631143 := (<-this.LoadMarkets())
            PanicOnError(retRes631143)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes652114 := (<-this.LoadMarkets())
            PanicOnError(retRes652114)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes438647 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes438647)
                    ch <- retRes438647
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes862641 := (<-this.LoadMarkets())
            PanicOnError(retRes862641)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes658893 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes658893)
                    ch <- retRes658893
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes68779 := (<-this.LoadMarkets())
            PanicOnError(retRes68779)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes562033 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes562033)
                    ch <- retRes562033
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes641433 := (<-this.LoadMarkets())
            PanicOnError(retRes641433)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes125198 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes125198)
                    ch <- retRes125198
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes252088 := (<-this.LoadMarkets())
            PanicOnError(retRes252088)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes654245 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes654245)
                    ch <- retRes654245
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes8049 := (<-this.LoadMarkets())
            PanicOnError(retRes8049)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes681972 := (<-this.LoadMarkets())
            PanicOnError(retRes681972)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872855 := (<-this.LoadMarkets())
            PanicOnError(retRes872855)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes538326 := (<-this.LoadMarkets())
            PanicOnError(retRes538326)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes280705 := (<-this.LoadMarkets())
            PanicOnError(retRes280705)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes111022 := (<-this.LoadMarkets())
            PanicOnError(retRes111022)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes885973 := (<-this.LoadMarkets())
            PanicOnError(retRes885973)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes531868 := (<-this.LoadMarkets())
            PanicOnError(retRes531868)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes910510 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes910510)
                    ch <- retRes910510
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes531236 := (<-this.LoadMarkets())
            PanicOnError(retRes531236)
            var market interface{} = this.Market(symbol)
