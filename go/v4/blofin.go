...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50942 := (<-this.LoadMarkets())
            PanicOnError(retRes50942)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes869634 := (<-this.LoadMarkets())
            PanicOnError(retRes869634)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes548893 := (<-this.LoadMarkets())
            PanicOnError(retRes548893)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes816425 := (<-this.LoadMarkets())
            PanicOnError(retRes816425)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes720868 := (<-this.LoadMarkets())
            PanicOnError(retRes720868)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes412311 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes412311)
                    ch <- retRes412311
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes748047 := (<-this.LoadMarkets())
            PanicOnError(retRes748047)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes862476 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes862476)
                    ch <- retRes862476
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes99622 := (<-this.LoadMarkets())
            PanicOnError(retRes99622)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes487568 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes487568)
                    ch <- retRes487568
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes925904 := (<-this.LoadMarkets())
            PanicOnError(retRes925904)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980903 := (<-this.LoadMarkets())
            PanicOnError(retRes980903)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes852665 := (<-this.LoadMarkets())
            PanicOnError(retRes852665)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633553 := (<-this.LoadMarkets())
            PanicOnError(retRes633553)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515110 := (<-this.LoadMarkets())
            PanicOnError(retRes515110)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes726975 := (<-this.LoadMarkets())
            PanicOnError(retRes726975)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes792489 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes792489)
                    ch <- retRes792489
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes769188 := (<-this.LoadMarkets())
            PanicOnError(retRes769188)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes814882 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes814882)
                    ch <- retRes814882
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes897405 := (<-this.LoadMarkets())
            PanicOnError(retRes897405)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes451596 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes451596)
                    ch <- retRes451596
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451513 := (<-this.LoadMarkets())
            PanicOnError(retRes451513)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes497646 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes497646)
                    ch <- retRes497646
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244427 := (<-this.LoadMarkets())
            PanicOnError(retRes244427)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes970162 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes970162)
                    ch <- retRes970162
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937606 := (<-this.LoadMarkets())
            PanicOnError(retRes937606)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164057 := (<-this.LoadMarkets())
            PanicOnError(retRes164057)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes504808 := (<-this.LoadMarkets())
            PanicOnError(retRes504808)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes205288 := (<-this.LoadMarkets())
            PanicOnError(retRes205288)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes82787 := (<-this.LoadMarkets())
            PanicOnError(retRes82787)
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes26547 := (<-this.LoadMarkets())
            PanicOnError(retRes26547)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes838987 := (<-this.LoadMarkets())
            PanicOnError(retRes838987)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133253 := (<-this.LoadMarkets())
            PanicOnError(retRes133253)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes379923 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes379923)
                    ch <- retRes379923
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes995790 := (<-this.LoadMarkets())
            PanicOnError(retRes995790)
            var market interface{} = this.Market(symbol)
