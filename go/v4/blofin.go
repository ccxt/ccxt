...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes537387 := (<-this.LoadMarkets())
            PanicOnError(retRes537387)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes925042 := (<-this.LoadMarkets())
            PanicOnError(retRes925042)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes320860 := (<-this.LoadMarkets())
            PanicOnError(retRes320860)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes658169 := (<-this.LoadMarkets())
            PanicOnError(retRes658169)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes465853 := (<-this.LoadMarkets())
            PanicOnError(retRes465853)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes585326 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674718 := (<-this.LoadMarkets())
            PanicOnError(retRes674718)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes843892 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes843892)
                    ch <- retRes843892
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403682 := (<-this.LoadMarkets())
            PanicOnError(retRes403682)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes145953 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes145953)
                    ch <- retRes145953
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes122096 := (<-this.LoadMarkets())
            PanicOnError(retRes122096)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes822648 := (<-this.LoadMarkets())
            PanicOnError(retRes822648)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes482865 := (<-this.LoadMarkets())
            PanicOnError(retRes482865)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes261198 := (<-this.LoadMarkets())
            PanicOnError(retRes261198)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915141 := (<-this.LoadMarkets())
            PanicOnError(retRes915141)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes910762 := (<-this.LoadMarkets())
            PanicOnError(retRes910762)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes374355 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes374355)
                    ch <- retRes374355
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes152728 := (<-this.LoadMarkets())
            PanicOnError(retRes152728)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes515746 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes515746)
                    ch <- retRes515746
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes228357 := (<-this.LoadMarkets())
            PanicOnError(retRes228357)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes306293 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes306293)
                    ch <- retRes306293
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes274768 := (<-this.LoadMarkets())
            PanicOnError(retRes274768)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes944056 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes944056)
                    ch <- retRes944056
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603585 := (<-this.LoadMarkets())
            PanicOnError(retRes603585)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes901030 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes901030)
                    ch <- retRes901030
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes260477 := (<-this.LoadMarkets())
            PanicOnError(retRes260477)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes203164 := (<-this.LoadMarkets())
            PanicOnError(retRes203164)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes394713 := (<-this.LoadMarkets())
            PanicOnError(retRes394713)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937990 := (<-this.LoadMarkets())
            PanicOnError(retRes937990)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes626967 := (<-this.LoadMarkets())
            PanicOnError(retRes626967)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40355 := (<-this.LoadMarkets())
            PanicOnError(retRes40355)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes871384 := (<-this.LoadMarkets())
            PanicOnError(retRes871384)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes44259 := (<-this.LoadMarkets())
            PanicOnError(retRes44259)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568891 := (<-this.LoadMarkets())
            PanicOnError(retRes568891)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes564757 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes564757)
                    ch <- retRes564757
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes395240 := (<-this.LoadMarkets())
            PanicOnError(retRes395240)
            var market interface{} = this.Market(symbol)
