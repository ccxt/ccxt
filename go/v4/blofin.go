...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes243148 := (<-this.LoadMarkets())
            PanicOnError(retRes243148)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes540994 := (<-this.LoadMarkets())
            PanicOnError(retRes540994)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes259309 := (<-this.LoadMarkets())
            PanicOnError(retRes259309)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes544529 := (<-this.LoadMarkets())
            PanicOnError(retRes544529)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes266430 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes266430)
                    ch <- retRes266430
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes820000 := (<-this.LoadMarkets())
            PanicOnError(retRes820000)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes783554 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes783554)
                    ch <- retRes783554
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes413704 := (<-this.LoadMarkets())
            PanicOnError(retRes413704)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes309371 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes309371)
                    ch <- retRes309371
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes323944 := (<-this.LoadMarkets())
            PanicOnError(retRes323944)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes587257 := (<-this.LoadMarkets())
            PanicOnError(retRes587257)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes862491 := (<-this.LoadMarkets())
            PanicOnError(retRes862491)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes28124 := (<-this.LoadMarkets())
            PanicOnError(retRes28124)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes369764 := (<-this.LoadMarkets())
            PanicOnError(retRes369764)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes467301 := (<-this.LoadMarkets())
            PanicOnError(retRes467301)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes332444 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes332444)
                    ch <- retRes332444
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes912282 := (<-this.LoadMarkets())
            PanicOnError(retRes912282)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes906886 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes906886)
                    ch <- retRes906886
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes919824 := (<-this.LoadMarkets())
            PanicOnError(retRes919824)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes573138 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes573138)
                    ch <- retRes573138
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes392323 := (<-this.LoadMarkets())
            PanicOnError(retRes392323)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes68427 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes68427)
                    ch <- retRes68427
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes124065 := (<-this.LoadMarkets())
            PanicOnError(retRes124065)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes291173 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes291173)
                    ch <- retRes291173
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes103398 := (<-this.LoadMarkets())
            PanicOnError(retRes103398)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638217 := (<-this.LoadMarkets())
            PanicOnError(retRes638217)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes20879 := (<-this.LoadMarkets())
            PanicOnError(retRes20879)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes469858 := (<-this.LoadMarkets())
            PanicOnError(retRes469858)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes250696 := (<-this.LoadMarkets())
            PanicOnError(retRes250696)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes21300 := (<-this.LoadMarkets())
            PanicOnError(retRes21300)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes911078 := (<-this.LoadMarkets())
            PanicOnError(retRes911078)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes474708 := (<-this.LoadMarkets())
            PanicOnError(retRes474708)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes155285 := (<-this.LoadMarkets())
            PanicOnError(retRes155285)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes182170 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes182170)
                    ch <- retRes182170
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes750940 := (<-this.LoadMarkets())
            PanicOnError(retRes750940)
            var market interface{} = this.Market(symbol)
