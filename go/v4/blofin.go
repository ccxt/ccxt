...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes678630 := (<-this.LoadMarkets())
            PanicOnError(retRes678630)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes326787 := (<-this.LoadMarkets())
            PanicOnError(retRes326787)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes646917 := (<-this.LoadMarkets())
            PanicOnError(retRes646917)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes826254 := (<-this.LoadMarkets())
            PanicOnError(retRes826254)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes142717 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes142717)
                    ch <- retRes142717
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834925 := (<-this.LoadMarkets())
            PanicOnError(retRes834925)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes909978 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes909978)
                    ch <- retRes909978
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes755423 := (<-this.LoadMarkets())
            PanicOnError(retRes755423)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes351227 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes351227)
                    ch <- retRes351227
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes233964 := (<-this.LoadMarkets())
            PanicOnError(retRes233964)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes280709 := (<-this.LoadMarkets())
            PanicOnError(retRes280709)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes523501 := (<-this.LoadMarkets())
            PanicOnError(retRes523501)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33095 := (<-this.LoadMarkets())
            PanicOnError(retRes33095)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes237532 := (<-this.LoadMarkets())
            PanicOnError(retRes237532)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes122050 := (<-this.LoadMarkets())
            PanicOnError(retRes122050)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes335974 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes335974)
                    ch <- retRes335974
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83213 := (<-this.LoadMarkets())
            PanicOnError(retRes83213)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes616998 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes616998)
                    ch <- retRes616998
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102504 := (<-this.LoadMarkets())
            PanicOnError(retRes102504)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes359042 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes359042)
                    ch <- retRes359042
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917892 := (<-this.LoadMarkets())
            PanicOnError(retRes917892)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes427922 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes427922)
                    ch <- retRes427922
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes734835 := (<-this.LoadMarkets())
            PanicOnError(retRes734835)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes940236 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes940236)
                    ch <- retRes940236
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes550753 := (<-this.LoadMarkets())
            PanicOnError(retRes550753)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes322540 := (<-this.LoadMarkets())
            PanicOnError(retRes322540)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes207332 := (<-this.LoadMarkets())
            PanicOnError(retRes207332)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes873189 := (<-this.LoadMarkets())
            PanicOnError(retRes873189)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes450627 := (<-this.LoadMarkets())
            PanicOnError(retRes450627)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes833355 := (<-this.LoadMarkets())
            PanicOnError(retRes833355)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73704 := (<-this.LoadMarkets())
            PanicOnError(retRes73704)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493845 := (<-this.LoadMarkets())
            PanicOnError(retRes493845)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes247769 := (<-this.LoadMarkets())
            PanicOnError(retRes247769)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes436366 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes436366)
                    ch <- retRes436366
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes680129 := (<-this.LoadMarkets())
            PanicOnError(retRes680129)
            var market interface{} = this.Market(symbol)
