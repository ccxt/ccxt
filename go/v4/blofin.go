...
func (this *Blofin) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes170912 := (<-this.LoadMarketsAsync())
...
func (this *Blofin) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes175612 := (<-this.LoadMarketsAsync())
...
func (this *Blofin) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes179312 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes179819 := (<-this.FetchPaginatedCallDynamicAsync("fetchOpenOrders", symbol, since, limit, params))
...
func (this *Blofin) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes185019 := (<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params))
...
func (this *Blofin) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes191212 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes191719 := (<-this.FetchPaginatedCallDynamicAsync("fetchDeposits", code, since, limit, params))
...
func (this *Blofin) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes195312 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes195819 := (<-this.FetchPaginatedCallDynamicAsync("fetchWithdrawals", code, since, limit, params))
...
func (this *Blofin) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	retRes20528 := (<-this.LoadMarketsAsync())
...
func (this *Blofin) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes212719 := (<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params))
		PanicOnError(retRes212719)
		ch <- retRes212719
		return nil
	}
	var request any = map[string]any{}
...
func (this *Blofin) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes244812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes244812)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"instId": market["id"],
...
func (this *Blofin) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes250012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes250012)
	}
	var request any = map[string]any{}
	var market any = nil
	if symbols != nil {
...
func (this *Blofin) fetchLeveragesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes270312 := (<-this.LoadMarketsAsync())
...
func (this *Blofin) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes286312 := (<-this.LoadMarketsAsync())
...
func (this *Blofin) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes290119 := (<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params))
...
func (this *Blofin) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes294112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes294112)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Blofin) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes305315 := (<-this.PrivatePostAccountSetPositionMode(this.Extend(request, params)))
...
func (this *Blofin) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes306712 := (<-this.LoadMarketsAsync())
