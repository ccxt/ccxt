...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes479404 := (<-this.LoadMarkets())
            PanicOnError(retRes479404)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518516 := (<-this.LoadMarkets())
            PanicOnError(retRes518516)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes85818 := (<-this.LoadMarkets())
            PanicOnError(retRes85818)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46703 := (<-this.LoadMarkets())
            PanicOnError(retRes46703)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375838 := (<-this.LoadMarkets())
            PanicOnError(retRes375838)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes380068 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes380068)
                    ch <- retRes380068
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes951094 := (<-this.LoadMarkets())
            PanicOnError(retRes951094)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes690447 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes690447)
                    ch <- retRes690447
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes843339 := (<-this.LoadMarkets())
            PanicOnError(retRes843339)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes195145 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes195145)
                    ch <- retRes195145
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes824844 := (<-this.LoadMarkets())
            PanicOnError(retRes824844)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes876565 := (<-this.LoadMarkets())
            PanicOnError(retRes876565)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470321 := (<-this.LoadMarkets())
            PanicOnError(retRes470321)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes605777 := (<-this.LoadMarkets())
            PanicOnError(retRes605777)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes780361 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes780361)
                    ch <- retRes780361
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687175 := (<-this.LoadMarkets())
            PanicOnError(retRes687175)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes920301 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes920301)
                    ch <- retRes920301
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes607835 := (<-this.LoadMarkets())
            PanicOnError(retRes607835)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes466252 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes466252)
                    ch <- retRes466252
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes907077 := (<-this.LoadMarkets())
            PanicOnError(retRes907077)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes599011 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes599011)
                    ch <- retRes599011
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes424676 := (<-this.LoadMarkets())
            PanicOnError(retRes424676)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes513878 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes513878)
                    ch <- retRes513878
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes798663 := (<-this.LoadMarkets())
            PanicOnError(retRes798663)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes709454 := (<-this.LoadMarkets())
            PanicOnError(retRes709454)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes461223 := (<-this.LoadMarkets())
            PanicOnError(retRes461223)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470305 := (<-this.LoadMarkets())
            PanicOnError(retRes470305)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes822445 := (<-this.LoadMarkets())
            PanicOnError(retRes822445)
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes435614 := (<-this.LoadMarkets())
            PanicOnError(retRes435614)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes252966 := (<-this.LoadMarkets())
            PanicOnError(retRes252966)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192757 := (<-this.LoadMarkets())
            PanicOnError(retRes192757)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes698383 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes698383)
                    ch <- retRes698383
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes464068 := (<-this.LoadMarkets())
            PanicOnError(retRes464068)
            var market interface{} = this.Market(symbol)
