...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes476934 := (<-this.LoadMarkets())
            PanicOnError(retRes476934)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes224918 := (<-this.LoadMarkets())
            PanicOnError(retRes224918)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes607528 := (<-this.LoadMarkets())
            PanicOnError(retRes607528)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929128 := (<-this.LoadMarkets())
            PanicOnError(retRes929128)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes730259 := (<-this.LoadMarkets())
            PanicOnError(retRes730259)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes496917 := (<-this.LoadMarkets())
            PanicOnError(retRes496917)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes82133 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes82133)
                    ch <- retRes82133
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes573490 := (<-this.LoadMarkets())
            PanicOnError(retRes573490)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes661626 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes661626)
                    ch <- retRes661626
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes427524 := (<-this.LoadMarkets())
            PanicOnError(retRes427524)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes627695 := (<-this.LoadMarkets())
            PanicOnError(retRes627695)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes167309 := (<-this.LoadMarkets())
            PanicOnError(retRes167309)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes157971 := (<-this.LoadMarkets())
            PanicOnError(retRes157971)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes331176 := (<-this.LoadMarkets())
            PanicOnError(retRes331176)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes551931 := (<-this.LoadMarkets())
            PanicOnError(retRes551931)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes304723 := (<-this.LoadMarkets())
            PanicOnError(retRes304723)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes332476 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes332476)
                    ch <- retRes332476
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes398462 := (<-this.LoadMarkets())
            PanicOnError(retRes398462)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes305574 := (<-this.LoadMarkets())
            PanicOnError(retRes305574)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38562 := (<-this.LoadMarkets())
            PanicOnError(retRes38562)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes70103 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes70103)
                ch <- retRes70103
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes364889 := (<-this.LoadMarkets())
            PanicOnError(retRes364889)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614987 := (<-this.LoadMarkets())
            PanicOnError(retRes614987)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes763929 := (<-this.LoadMarkets())
            PanicOnError(retRes763929)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes209454 := (<-this.LoadMarkets())
            PanicOnError(retRes209454)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes721825 := (<-this.LoadMarkets())
            PanicOnError(retRes721825)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631161 := (<-this.LoadMarkets())
            PanicOnError(retRes631161)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes491987 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes491987)
                    ch <- retRes491987
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752003 := (<-this.LoadMarkets())
            PanicOnError(retRes752003)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes902733 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes902733)
                    ch <- retRes902733
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes837811 := (<-this.LoadMarkets())
            PanicOnError(retRes837811)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes125814 := (<-this.LoadMarkets())
            PanicOnError(retRes125814)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes530693 := (<-this.LoadMarkets())
            PanicOnError(retRes530693)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes659899 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes659899)
                    ch <- retRes659899
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes57611 := (<-this.LoadMarkets())
            PanicOnError(retRes57611)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes134646 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes134646)
                    ch <- retRes134646
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes833222 := (<-this.LoadMarkets())
            PanicOnError(retRes833222)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes452223 := (<-this.LoadMarkets())
            PanicOnError(retRes452223)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes415548 := (<-this.LoadMarkets())
            PanicOnError(retRes415548)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
