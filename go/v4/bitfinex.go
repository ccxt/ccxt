...
func (this *Bitfinex) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes153619 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, params, 10000))))
		ch <- BoxAbsent(retRes153619)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	var sort string = "-1"
...
func (this *Bitfinex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes159319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))))
		ch <- BoxAbsent(retRes159319)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	if limit == nil {
...
func (this *Bitfinex) ParseOrder(order any, optionalArgs ...any) any {
	...
	if !IsEqual(flags, nil) {
		for i := 0; i < GetArrayLength(flags); i++ {
...
func (this *Bitfinex) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if (ioc || fok) && (IsEqual(typeVar, "market")) {
		panic(InvalidOrder(this.Id + " createOrder() does not allow market IOC and FOK orders"))
	}
	...
	params = MapTyped(this.Omit(params, []any{"triggerPrice", "stopPrice", "timeInForce", "postOnly", "reduceOnly", "trailingAmount", "clientOrderId"}))
 ...
 */
func (this *Bitfinex) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Bitfinex) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	var price *float64 = GetArgFloat64Ptr(optionalArgs, 0, nil)
	_ = price
...
func (this *Bitfinex) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if !IsEqual(cid, nil) {
		...
		if IsEqual(cidDate, nil) {
			panic(InvalidOrder(this.Id + " canceling an order by clientOrderId ('cid') requires both 'cid' and 'cid_date' ('YYYY-MM-DD')"))
		}
		request = map[string]any{
			"cid":      cid,
			"cid_date": cidDate,
		}
		params = MapTyped(this.Omit(params, []any{"cid", "clientOrderId"}))
	} else {
		request = map[string]any{
			"id": ParseInt(id),
		}
...
func (this *Bitfinex) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes229819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params))))
		ch <- BoxAbsent(retRes229819)
		return nil
	}
	var request map[string]any = map[string]any{}
	if since != nil {
...
func (this *Bitfinex) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var retRes245415 map[string]any = MapTyped(PanicOnError((<-this.FetchDepositAddressAsync(code, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes245415)
	return nil
}
...
func (this *Bitfinex) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, "network", "wallet"))
	var request map[string]any = map[string]any{
		"method":   networkId,
		"wallet":   wallet,
		"op_renew": 0,
...
func (this *Bitfinex) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	var takerFee *float64 = this.SafeNumber(takerData, 0)
...
func (this *Bitfinex) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes323419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params, 2500))))
		ch <- BoxAbsent(retRes323419)
		return nil
	}
	var currency map[string]any = nil
	var request map[string]any = map[string]any{}
...
func (this *Bitfinex) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes335319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))))
		ch <- BoxAbsent(retRes335319)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *Bitfinex) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes364519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))))
...
func (this *Bitfinex) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes378419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchLiquidations", symbol, since, limit, "8h", params, 500))))
		ch <- BoxAbsent(retRes378419)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{}
...
func (this *Bitfinex) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"triggerPrice", "stopPrice", "timeInForce", "postOnly", "reduceOnly", "trailingAmount", "clientOrderId", "leverage"}))
...
func (this *Bitfinex) FetchClosedOrder(id string, options ...FetchClosedOrderOptions) (Order, error) {
	...
	var res AsyncResult[Order] = AwaitResult(NewOrder, this.FetchClosedOrderAsync(id, opts.Symbol, opts.Params))
	if res.Err != nil {
		return Order{}, res.Err
	}
	return res.Value, nil
