...
func (this *BitfinexCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes145619 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
			PanicOnError(retRes145619)
			ch <- retRes145619
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitfinexCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes151019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
			PanicOnError(retRes151019)
			ch <- retRes151019
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitfinexCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes219219 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
			PanicOnError(retRes219219)
			ch <- retRes219219
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *BitfinexCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes23018 := (<-this.LoadMarkets())
		PanicOnError(retRes23018)
		var market interface{} = nil
		var request interface{} = map[string]interface{}{
...
func (this *BitfinexCore) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes234115 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func (this *BitfinexCore) FetchDepositsWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes26898 := (<-this.LoadMarkets())
		PanicOnError(retRes26898)
...
func (this *BitfinexCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes310119 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
...
func (this *BitfinexCore) FetchFundingRates(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes31568 := (<-this.LoadMarkets())
		PanicOnError(retRes31568)
...
func (this *BitfinexCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes321619 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes321619)
			ch <- retRes321619
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitfinexCore) FetchOpenInterests(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes33898 := (<-this.LoadMarkets())
		PanicOnError(retRes33898)
		symbols = this.MarketSymbols(symbols)
...
func (this *BitfinexCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes350119 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes350119)
			ch <- retRes350119
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitfinexCore) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes363819 := (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
			PanicOnError(retRes363819)
			ch <- retRes363819
			return nil
		}
		var market interface{} = this.Market(symbol)
