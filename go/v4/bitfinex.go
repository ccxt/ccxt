...
func (this *BitfinexCore) ParseCurrencyCustom(id any, indexed any, indexedNetworks any) any {
	...
	var precision any = this.HandleOption("fetchCurrencies", "defaultPrecision", defaultCurrencyPrecision)
...
func (this *BitfinexCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes101612 := (<-this.LoadMarkets())
			PanicOnError(retRes101612)
		}
		var accountsByType any = this.SafeValue(this.Options, "v2AccountsByType", map[string]any{})
...
func (this *BitfinexCore) FetchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		for i := 0; IsLessThan(i, GetArrayLength(orderbook)); i++ {
			...
			retRes119212 := GetValue(result, side)
			AppendToArray(&retRes119212, []any{price, this.ParseNumber(amount)})
		}
...
func (this *BitfinexCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes149619 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
			PanicOnError(retRes149619)
			ch <- retRes149619
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes155219 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
			PanicOnError(retRes155219)
			ch <- retRes155219
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes200112 := (<-this.LoadMarkets())
			PanicOnError(retRes200112)
		}
...
func (this *BitfinexCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes225419 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func (this *BitfinexCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes240915 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
		PanicOnError(retRes240915)
		ch <- retRes240915
		return nil
...
func (this *BitfinexCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes318119 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
...
func (this *BitfinexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes330019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes330019)
			ch <- retRes330019
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes352912 := (<-this.LoadMarkets())
			PanicOnError(retRes352912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BitfinexCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes359119 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes359119)
			ch <- retRes359119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes372512 := (<-this.LoadMarkets())
			PanicOnError(retRes372512)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes373019 := (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
			PanicOnError(retRes373019)
			ch <- retRes373019
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) SetMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes381912 := (<-this.LoadMarkets())
			PanicOnError(retRes381912)
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes388012 := (<-this.LoadMarkets())
			PanicOnError(retRes388012)
		}
		var request any = map[string]any{
