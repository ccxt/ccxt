...
func (this *Bitfinex) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < len(markets); i++ {
		...
		AppendToArray(&result, map[string]any{
			...
			"active":         true,
			"contract":       !spot,
			"linear":         func() any { if swap { return true }; return nil }(),
			"inverse":        func() any { if swap { return false }; return nil }(),
			"contractSize":   func() any { if swap { return this.ParseNumber("1") }; return nil }(),
			"expiry":         nil,
			"expiryDatetime": nil,
			"strike":         nil,
			"optionType":     nil,
...
func (this *Bitfinex) ParseCurrencyCustom(id any, indexed any, indexedNetworks any) any {
	...
	var typeVar any = func() any { if isCryptoCoin { return "crypto" }; return nil }()
...
func (this *Bitfinex) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if accountType == nil {
		...
		panic(ExchangeError(this.Id + " fetchBalance() type parameter must be one of " + Join(keys, ", ")))
	}
...
func (this *Bitfinex) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if fromId == nil {
		var keys []string = ObjectKeys(accountsByType)
		panic(ArgumentsRequired(this.Id + " transfer() fromAccount must be one of " + Join(keys, ", ")))
	}
...
func (this *Bitfinex) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var priceIndex any = func() any { if (IsEqual(fullRequest["precision"], "R0")) { return 1 }; return 0 }()
	...
	for i := 0; i < len(orders); i++ {
		...
		var side any = func() any { if Precise.StringGt(signedAmount, "0") { return "bids" }; return "asks" }()
...
func (this *Bitfinex) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var amountIndex any = func() any { if isPrivate { return 4 }; return 2 }()
	var side string
	var amountString *string = this.SafeString(tradeList, amountIndex)
	var priceIndex any = func() any { if isPrivate { return 5 }; return 3 }()
	...
	var timestampIndex any = func() any { if isPrivate { return 2 }; return 1 }()
	...
	if isPrivate {
		...
		takerOrMaker = func() any { if (maker != nil && *maker == 1) { return "maker" }; return "taker" }()
...
func (this *Bitfinex) ParseOrder(order any, optionalArgs ...any) any {
	...
	var amount *string = Precise.StringAbs(signedAmount)
	var side any = func() any { if Precise.StringLt(signedAmount, "0") { return "sell" }; return "buy" }()
...
func (this *Bitfinex) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	amountString = func() any { if (IsEqual(side, "buy")) { return amountString }; return Precise.StringNeg(amountString) }()
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
		"amount": amountString,
	}
	...
	if (IsEqual(GetValue(market, "spot"), true)) && (marginMode == nil) {
...
func (this *Bitfinex) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var address any = func() any { if (poolAddress == nil) { return this.SafeString(result, 4) }; return poolAddress }()
	var tag any = func() any { if (poolAddress == nil) { return nil }; return this.SafeString(result, 4) }()
...
func (this *Bitfinex) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var openInterestIndex any = func() any { if (IsEqual(interestLength, 23)) { return 17 }; return 18 }()
...
func (this *Bitfinex) ParseLiquidation(liquidation any, optionalArgs ...any) any {
	...
	var side any = func() any { if (sideFlag != nil && *sideFlag == 1) { return "buy" }; return "sell" }()
...
func (this *Bitfinex) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	var marginStatus any = func() any { if (IsEqual(marginStatusRaw, 1)) { return "ok" }; return "failed" }()
	return map[string]any{
		"info":       data,
