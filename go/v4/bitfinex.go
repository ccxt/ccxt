...
func (this *BitfinexCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes147419 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
			PanicOnError(retRes147419)
			ch <- retRes147419
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes152819 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
...
func (this *BitfinexCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes221019 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
			PanicOnError(retRes221019)
			ch <- retRes221019
			return nil
		}
		var request any = map[string]any{}
...
func (this *BitfinexCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes235915 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func (this *BitfinexCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes23728 := (<-this.LoadMarkets())
		PanicOnError(retRes23728)
		var currency any = this.Currency(code)
...
func (this *BitfinexCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31158 := (<-this.LoadMarkets())
		PanicOnError(retRes31158)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes311919 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
			PanicOnError(retRes311919)
			ch <- retRes311919
			return nil
		}
		var currency any = nil
...
func (this *BitfinexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes32308 := (<-this.LoadMarkets())
		PanicOnError(retRes32308)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes323419 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes323419)
			ch <- retRes323419
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes351919 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes351919)
			ch <- retRes351919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes365619 := (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
			PanicOnError(retRes365619)
			ch <- retRes365619
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitfinexCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes38038 := (<-this.LoadMarkets())
		PanicOnError(retRes38038)
		var request any = map[string]any{
...
func (this *BitfinexCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes38818 := (<-this.LoadMarkets())
		PanicOnError(retRes38818)
		var market any = this.Market(symbol)
		var request any = map[string]any{
