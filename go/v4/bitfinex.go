...
func (this *BitfinexCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes219619 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
			PanicOnError(retRes219619)
			ch <- retRes219619
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *BitfinexCore) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes234515 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
		PanicOnError(retRes234515)
		ch <- retRes234515
		return nil
...
func (this *BitfinexCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes310519 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
			PanicOnError(retRes310519)
			ch <- retRes310519
			return nil
		}
		var currency interface{} = nil
...
func (this *BitfinexCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes322019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
...
func (this *BitfinexCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes350519 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
			PanicOnError(retRes350519)
			ch <- retRes350519
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitfinexCore) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes36388 := (<-this.LoadMarkets())
		PanicOnError(retRes36388)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes364219 := (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
			PanicOnError(retRes364219)
			ch <- retRes364219
			return nil
		}
		var market interface{} = this.Market(symbol)
