...
func (this *BitfinexCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes152319 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
...
func (this *BitfinexCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes158019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
...
func (this *BitfinexCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes228219 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func (this *BitfinexCore) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	retRes243815 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func (this *BitfinexCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes321319 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
...
func (this *BitfinexCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes333219 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
...
func (this *BitfinexCore) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes362419 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
...
func (this *BitfinexCore) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes376319 := (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
