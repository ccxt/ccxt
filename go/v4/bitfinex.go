...
func (this *Bitfinex) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes153019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, params, 10000))))
		ch <- BoxAbsent(retRes153019)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var sort string = "-1"
...
func (this *Bitfinex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes158719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))))
		ch <- BoxAbsent(retRes158719)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	if limit == nil {
...
func (this *Bitfinex) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes228919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params))))
...
func (this *Bitfinex) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var retRes244515 map[string]any = MapTyped(PanicOnError((<-this.FetchDepositAddressAsync(code, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes244515)
	return nil
}
...
func (this *Bitfinex) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes322019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params, 2500))))
		ch <- BoxAbsent(retRes322019)
		return nil
	}
	var currency map[string]any = nil
	var request any = map[string]any{}
...
func (this *Bitfinex) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes333919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))))
		ch <- BoxAbsent(retRes333919)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request any = map[string]any{
...
func (this *Bitfinex) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes363119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))))
		ch <- BoxAbsent(retRes363119)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request any = map[string]any{
...
func (this *Bitfinex) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes377019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchLiquidations", symbol, since, limit, "8h", params, 500))))
		ch <- BoxAbsent(retRes377019)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request any = map[string]any{}
