...
func (this *Coinmate) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if method == nil {
		...
		panic(ExchangeError(this.Id + " withdraw() only allows withdrawing the following currencies: " + Join(allowedCurrencies, ", ")))
	}
	var request map[string]any = map[string]any{
...
func (this *Coinmate) ParseOrder(order any, optionalArgs ...any) any {
	...
	var side *string = this.SafeStringLower(order, "type")
