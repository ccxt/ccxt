...
func (this *Xt) fetchOrderBookBody(ch chan any, symbol string, optionalArgs ...any) any {
	...
	//     }
	//
	var orderBook map[string]any = this.SafeDictMap(response, "result", map[string]any{})
 ...
 * @returns {object} a [margin structure]{@link https://docs.ccxt.com/?id=margin-structure}
 */
func (this *Xt) ReduceMarginAsync(symbol string, amount any, optionalArgs ...any) <-chan EndpointResult[map[string]any] {
	ch := make(chan EndpointResult[map[string]any], 1)
	go this.reduceMarginBody(ch, symbol, amount, optionalArgs...)
	return ch
}
func (this *Xt) reduceMarginBody(ch chan EndpointResult[map[string]any], symbol string, amount any, optionalArgs ...any) any {
	defer close(ch)
	...
	if retRes453015 == nil {
		...
		ch <- EndpointResult[map[string]any]{Value: retRes453015, Raw: retRes453015}
	}
	return nil
}
...
func (this *Xt) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	//
	var fee map[string]any = this.SafeDictMap(response, "result", map[string]any{})
	var result map[string]any = map[string]any{}
