...
func (this *XtCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes103612 := (<-this.LoadTimeDifference())
...
func (this *XtCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes146119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *XtCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes253115 := (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
...
func (this *XtCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes257419 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes257419)
			ch <- retRes257419
			return nil
		} else {

			retRes257619 := (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
...
func (this *XtCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes346715 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes346715)
		ch <- retRes346715
		return nil
...
func (this *XtCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes348915 := (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
		PanicOnError(retRes348915)
		ch <- retRes348915
		return nil
...
func (this *XtCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes351115 := (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
...
func (this *XtCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes363312 := (<-this.LoadMarkets())
			PanicOnError(retRes363312)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *XtCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes413312 := (<-this.LoadMarkets())
			PanicOnError(retRes413312)
		}
		var request any = map[string]any{}
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
...
func (this *XtCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes443715 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes443715)
		ch <- retRes443715
		return nil
...
func (this *XtCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes445215 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
		PanicOnError(retRes445215)
		ch <- retRes445215
		return nil
...
func (this *XtCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes446012 := (<-this.LoadMarkets())
			PanicOnError(retRes446012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":       GetValue(market, "id"),
...
func (this *XtCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes451412 := (<-this.LoadMarkets())
			PanicOnError(retRes451412)
		}
		var subType any = nil
...
func (this *XtCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes470019 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "id", "id", 1, 200))
...
func (this *XtCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes477215 := (<-this.FetchFundingRate(symbol, params))
...
func (this *XtCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes478612 := (<-this.LoadMarkets())
			PanicOnError(retRes478612)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
...
func (this *XtCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes516612 := (<-this.LoadMarkets())
			PanicOnError(retRes516612)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *XtCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes525212 := (<-this.LoadMarkets())
			PanicOnError(retRes525212)
		}
		var subType any = nil
...
func (this *XtCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes550812 := (<-this.LoadMarkets())
			PanicOnError(retRes550812)
		}
		var currency any = this.Currency(code)
