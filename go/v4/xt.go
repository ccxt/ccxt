...
func (this *XtCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes99412 := (<-this.LoadTimeDifference())
...
func (this *XtCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes141919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *XtCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes244115 := (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
		PanicOnError(retRes244115)
		ch <- retRes244115
		return nil
...
func (this *XtCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes247419 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes247419)
			ch <- retRes247419
			return nil
		} else {

			retRes247619 := (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
...
func (this *XtCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes326515 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes326515)
		ch <- retRes326515
		return nil
...
func (this *XtCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes328515 := (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
...
func (this *XtCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes330515 := (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
...
func (this *XtCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes348512 := (<-this.LoadMarkets())
			PanicOnError(retRes348512)
		}
		var request any = map[string]any{
			"orderIds": ids,
		}
...
func (this *XtCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes390712 := (<-this.LoadMarkets())
			PanicOnError(retRes390712)
		}
		var request any = map[string]any{}
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
...
func (this *XtCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes421115 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func (this *XtCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes422615 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
...
func (this *XtCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes447319 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "id", "id", 1, 200))
...
func (this *XtCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes454515 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes454515)
		ch <- retRes454515
		return nil
...
func (this *XtCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes455912 := (<-this.LoadMarkets())
			PanicOnError(retRes455912)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
...
func (this *XtCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes497312 := (<-this.LoadMarkets())
			PanicOnError(retRes497312)
		}
		var market any = this.Market(symbol)
		if IsTrue(GetValue(market, "spot")) {
...
func (this *XtCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes503512 := (<-this.LoadMarkets())
			PanicOnError(retRes503512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		var stopLoss any = this.SafeNumber2(params, "stopLoss", "triggerStopPrice")
