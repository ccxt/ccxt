...
func  (this *XtCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes241415 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes241415)
                ch <- retRes241415
                return nil
...
func  (this *XtCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes244519 :=  (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
                    PanicOnError(retRes244519)
                    ch <- retRes244519
                    return nil
            } else {
        
                    retRes244719 :=  (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
...
func  (this *XtCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes322615 :=  (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
                PanicOnError(retRes322615)
                ch <- retRes322615
                return nil
...
func  (this *XtCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes324615 :=  (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
                PanicOnError(retRes324615)
                ch <- retRes324615
                return nil
...
func  (this *XtCore) FetchCanceledOrders(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes326615 :=  (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
                PanicOnError(retRes326615)
                ch <- retRes326615
                return nil
...
func  (this *XtCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            retRes38998 := (<-this.LoadMarkets())
            PanicOnError(retRes38998)
            var request any = map[string]any {}
            var currency any = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.Currency(code)
...
func  (this *XtCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes413915 :=  (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func  (this *XtCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes415415 :=  (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
