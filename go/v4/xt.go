...
func (this *XtCore) FetchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes155812 := (<-this.LoadMarkets())
			PanicOnError(retRes155812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *XtCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes244915 := (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
		PanicOnError(retRes244915)
		ch <- retRes244915
		return nil
...
func (this *XtCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes248219 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes248219)
			ch <- retRes248219
			return nil
		} else {

			retRes248419 := (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes248419)
			ch <- retRes248419
			return nil
		}
...
func (this *XtCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes327315 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes327315)
		ch <- retRes327315
		return nil
...
func (this *XtCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes329315 := (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
...
func (this *XtCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes331315 := (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
		PanicOnError(retRes331315)
		ch <- retRes331315
		return nil
...
func (this *XtCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes349312 := (<-this.LoadMarkets())
			PanicOnError(retRes349312)
		}
		var request any = map[string]any{
			"orderIds": ids,
		}
...
func (this *XtCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes373812 := (<-this.LoadMarkets())
			PanicOnError(retRes373812)
		}
		var request any = map[string]any{}
...
func (this *XtCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes403512 := (<-this.LoadMarkets())
			PanicOnError(retRes403512)
		}
		var currency any = this.Currency(code)
...
func (this *XtCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes421915 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func (this *XtCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes448119 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "id", "id", 1, 200))
			PanicOnError(retRes448119)
			ch <- retRes448119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *XtCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes455315 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes455315)
		ch <- retRes455315
		return nil
