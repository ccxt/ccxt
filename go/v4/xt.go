...
func  (this *xt) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes241715 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes241715)
                ch <- retRes241715
                return nil
...
func  (this *xt) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes244819 :=  (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
                    PanicOnError(retRes244819)
                    ch <- retRes244819
                    return nil
            } else {
        
                    retRes245019 :=  (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
...
func  (this *xt) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes321815 :=  (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
                PanicOnError(retRes321815)
                ch <- retRes321815
                return nil
...
func  (this *xt) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes323815 :=  (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
                PanicOnError(retRes323815)
                ch <- retRes323815
                return nil
...
func  (this *xt) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes325815 :=  (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
                PanicOnError(retRes325815)
                ch <- retRes325815
                return nil
...
func  (this *xt) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes413115 :=  (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func  (this *xt) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes414615 :=  (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
...
func  (this *xt) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes444815 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *xt) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes48068 := (<-this.LoadMarkets())
            PanicOnError(retRes48068)
            var currency interface{} = this.Currency(code)
...
func  (this *xt) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes48658 := (<-this.LoadMarkets())
            PanicOnError(retRes48658)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
