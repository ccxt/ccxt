...
func (this *XtCore) ParseMarket(market any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(filters)); i++ {
		...
		if filter != nil && *filter == "QUANTITY" {
			minAmount = DerefScalar(this.SafeNumber(entry, "min"))
			maxAmount = DerefScalar(this.SafeNumber(entry, "max"))
			amountPrecision = DerefScalar(this.SafeNumber(entry, "tickSize"))
		}
		if filter != nil && *filter == "QUOTE_QTY" {
			minCost = DerefScalar(this.SafeNumber(entry, "min"))
		}
		if filter != nil && *filter == "PRICE" {
			minPrice = DerefScalar(this.SafeNumber(entry, "min"))
			maxPrice = DerefScalar(this.SafeNumber(entry, "max"))
		}
	}
	...
	if underlyingType != nil {
		...
		minAmount = DerefScalar(this.SafeNumber(market, "minQty"))
		minCost = DerefScalar(this.SafeNumber(market, "minNotional"))
		maxCost = DerefScalar(this.SafeNumber(market, "maxNotional"))
		minPrice = DerefScalar(this.SafeNumber(market, "minPrice"))
		maxPrice = DerefScalar(this.SafeNumber(market, "maxPrice"))
		contract = true
		spot = false
	}
...
func (this *XtCore) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	_ = market
	var isInverse any = DerefScalar(this.SafeBool(market, "inverse"))
	var volumeIndex any = Ternary((IsEqual(isInverse, true)), "v", "a")
...
func (this *XtCore) fetchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(tickers)); i++ {
		...
		var marketType any = Ternary(isContract, "contract", "spot")
...
func (this *XtCore) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var marketType any = Ternary((!IsEqual(market, nil)), GetValue(market, "type"), nil)
	var hasSpotKeys bool = (InOp(ticker, "cv")) || (InOp(ticker, "aq"))
	if IsEqual(marketType, nil) {
		marketType = Ternary(hasSpotKeys, "spot", "contract")
	}
...
func (this *XtCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	subType = GetValue(subTypeparamsVariable, 0)
	params = GetValue(subTypeparamsVariable, 1)
	if (!IsEqual(subType, nil)) || (IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future")) {
		if !IsEqual(limit, nil) {
		...
		var marginOrSpotRequest any = Ternary((!IsEqual(marginMode, nil)), "LEVER", "SPOT")
...
func (this *XtCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var isBuyerMaker any = DerefScalar(this.SafeBool(trade, "b"))
	if !IsEqual(isBuyerMaker, nil) {
		side = Ternary(EvalTruthy(isBuyerMaker), "sell", "buy")
		...
		if orderSide != nil {
			...
			if bidOrAsk != nil {
				side = Ternary((bidOrAsk != nil && *bidOrAsk == "BID"), "buy", "sell")
			}
		}
	}
...
func (this *XtCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if (!IsEqual(subType, nil)) || isContractWallet {
...
func (this *XtCore) createSpotOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(typeVar, "market") {
		...
		if IsEqual(side, "buy") {
			...
			var createMarketBuyOrderRequiresPrice any = DerefScalar(this.SafeBool(this.Options, "createMarketBuyOrderRequiresPrice", true))
			if createMarketBuyOrderRequiresPrice == true {
				...
				var amountCost any = Ternary((cost != nil), cost, amount)
...
func (this *XtCore) createContractOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(side, "buy") {
		var requestType any = Ternary((reduceOnly == true), "SHORT", "LONG")
		AddElementToObject(request, "positionSide", requestType)
	} else {
		var requestType any = Ternary((reduceOnly == true), "LONG", "SHORT")
		AddElementToObject(request, "positionSide", requestType)
	}
	var response any = map[string]any{}
	var triggerPrice any = DerefScalar(this.SafeNumber2(params, "triggerPrice", "stopPrice"))
	var stopLoss any = DerefScalar(this.SafeNumber2(params, "stopLoss", "triggerStopPrice"))
	var takeProfit any = DerefScalar(this.SafeNumber2(params, "takeProfit", "triggerProfitPrice"))
	...
	var trailingTriggerPrice any = DerefScalar(this.SafeNumber(params, "trailingTriggerPrice"))
	var isTrigger bool = (!IsEqual(triggerPrice, nil))
	var isStopLoss bool = (!IsEqual(stopLoss, nil))
	var isTakeProfit bool = (!IsEqual(takeProfit, nil))
	var isTrailing bool = (trailingPercent != nil) || (trailingAmount != nil)
	if isTrailing && (!IsEqual(GetValue(market, "swap"), true)) {
		panic(NotSupported(Add(this.Id, " createOrder() trailing orders are only supported on swap markets")))
	}
	if (!IsEqual(trailingTriggerPrice, nil)) && !isTrailing {
		panic(ArgumentsRequired(Add(this.Id, " createOrder() trailingTriggerPrice requires trailingPercent or trailingAmount")))
	}
	if !IsEqual(price, nil) {
		if !EvalTruthy((isStopLoss)) && !EvalTruthy((isTakeProfit)) && !EvalTruthy((isTrailing)) {
			AddElementToObject(request, "price", this.PriceToPrecision(symbol, price))
		}
	}
	if isTrailing {
		...
		marginMode = GetValue(marginModeparamsVariable, 0)
		params = GetValue(marginModeparamsVariable, 1)
		AddElementToObject(request, "positionType", Ternary((IsEqual(marginMode, "isolated")), "ISOLATED", "CROSSED"))
		...
		AddElementToObject(request, "timeInForce", Ternary((IsEqual(timeInForce, nil)), "GTC", timeInForce))
		AddElementToObject(request, "triggerPriceType", this.SafeString(params, "triggerPriceType", "LATEST_PRICE"))
		AddElementToObject(request, "orderSide", ToUpper(side))
		AddElementToObject(request, "stopPrice", this.PriceToPrecision(symbol, triggerPrice))
		var entrustType any = Ternary((IsEqual(typeVar, "market")), "STOP_MARKET", "STOP")
...
func (this *XtCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(trailing, true) {
		var isContract bool = (!IsEqual(subType, nil)) || (IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future"))
		if !isContract {
...
func (this *XtCore) fetchOrdersByStatusBody(ch chan any, status any, optionalArgs ...any) any {
	...
	if IsEqual(trailing, true) {
		...
		if (IsEqual(trigger, true)) || (IsEqual(stopLossTakeProfit, true)) {
	...
	if (IsEqual(trigger, true)) || (IsEqual(stopLossTakeProfit, true)) || (!IsEqual(subType, nil)) || (IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future")) {
		if !IsEqual(since, nil) {
			AddElementToObject(request, "startTime", since)
		}
		if (!IsEqual(limit, nil)) && (!IsEqual(trailing, true)) {
			AddElementToObject(request, "size", limit)
		}
	}
	if IsEqual(trigger, true) {
	...
	} else if (!IsEqual(subType, nil)) || (IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future")) {
		if IsEqual(subType, "inverse") {
...
func (this *XtCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	//     }
	//
	var isContractResponse bool = ((!IsEqual(subType, nil)) || (IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future")))
	var order any = Ternary(isContractResponse, response, this.SafeDict(response, "result", map[string]any{}))
...
func (this *XtCore) ParseOrder(order any, optionalArgs ...any) any {
	...
	var marketType any = Ternary((InOp(order, "result")) || (InOp(order, "positionSide")), "contract", "spot")
	...
	var quantity any = DerefScalar(this.SafeNumber(order, "origQty"))
	var amount any = Ternary((IsEqual(marketType, "spot")), quantity, Precise.StringMul(this.NumberToString(quantity), this.NumberToString(GetValue(market, "contractSize"))))
	var filledQuantity any = DerefScalar(this.SafeNumber(order, "executedQty"))
	var filled any = Ternary((IsEqual(marketType, "spot")), filledQuantity, Precise.StringMul(this.NumberToString(filledQuantity), this.NumberToString(GetValue(market, "contractSize"))))
...
func (this *XtCore) ParseLedgerEntry(item any, optionalArgs ...any) any {
	...
	var direction any = Ternary((side != nil && *side == "ADD"), "in", "out")
...
func (this *XtCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	currency := GetArg(optionalArgs, 0, nil)
	_ = currency
	var typeVar any = Ternary((InOp(transaction, "fromAddr")), "deposit", "withdraw")
	...
	var fee any = DerefScalar(this.SafeNumber(transaction, "fee"))
	var feeCurrency any = Ternary((!IsEqual(fee, nil)), currencyCode, nil)
...
func (this *XtCore) modifyMarginHelperBody(ch chan any, symbol any, amount any, addOrReduce any, optionalArgs ...any) any {
	...
	_ = params
	var positionSide *string = this.SafeString(params, "positionSide")
	var methodName any = Ternary((IsEqual(addOrReduce, "ADD")), "addMargin", "reduceMargin")
...
func (this *XtCore) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
		...
		var market any = this.Market(symbol)
		var matchesSubType any = Ternary(EvalTruthy((isInverse)), GetValue(market, "inverse"), GetValue(market, "linear"))
...
func (this *XtCore) ParseTradingFee(fee any, optionalArgs ...any) any {
	market := GetArg(optionalArgs, 0, nil)
	_ = market
	var symbol any = Ternary((!IsEqual(market, nil)), GetValue(market, "symbol"), nil)
	return map[string]any{
		"info":       fee,
		"symbol":     symbol,
...
func (this *XtCore) ParsePosition(position any, optionalArgs ...any) any {
	...
	var marginMode any = Ternary(EvalTruthy((isCross)), "cross", "isolated")
	var collateral any = DerefScalar(this.SafeNumber(position, "isolatedMargin"))
...
func (this *XtCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var result any = Ternary((IsEqual(GetValue(market, "swap"), true)), response, this.SafeDict(response, "result", map[string]any{}))
...
func (this *XtCore) Sign(path any, optionalArgs ...any) any {
	...
	if signed {
		...
		if (IsEqual(payload, "/v4/order")) || (IsEqual(payload, "/future/trade/v1/order/create")) || (IsEqual(payload, "/future/trade/v1/entrust/create-plan")) || (IsEqual(payload, "/future/trade/v1/entrust/create-profit")) || (IsEqual(payload, "/future/trade/v1/order/create-batch")) {
			...
			if IsGreaterThan(GetIndexOf(payload, "future"), OpNeg(1)) {
		...
		var isUndefinedBody bool = ((IsEqual(method, "GET")) || (IsEqual(path, "order/{orderId}")) || (IsEqual(path, "ws-token")))
		if (IsEqual(method, "PUT")) && (IsEqual(endpoint, "spot")) {
			isUndefinedBody = false
		}
		body = Ternary(isUndefinedBody, nil, this.Json(body))
