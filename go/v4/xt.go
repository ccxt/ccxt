...
func (this *XtCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes99612 := (<-this.LoadTimeDifference())
...
func (this *XtCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes142119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
			PanicOnError(retRes142119)
			ch <- retRes142119
			return nil
		}
...
func (this *XtCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes244315 := (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
		PanicOnError(retRes244315)
		ch <- retRes244315
		return nil
...
func (this *XtCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes247619 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes247619)
			ch <- retRes247619
			return nil
		} else {

			retRes247819 := (<-this.CreateContractOrder(symbol, typeVar, side, amount, price, params))
...
func (this *XtCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes326715 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
...
func (this *XtCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes328715 := (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
...
func (this *XtCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes330715 := (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
		PanicOnError(retRes330715)
		ch <- retRes330715
		return nil
...
func (this *XtCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes341112 := (<-this.LoadMarkets())
			PanicOnError(retRes341112)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *XtCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes348712 := (<-this.LoadMarkets())
			PanicOnError(retRes348712)
		}
		var request any = map[string]any{
			"orderIds": ids,
		}
...
func (this *XtCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes390912 := (<-this.LoadMarkets())
			PanicOnError(retRes390912)
		}
		var request any = map[string]any{}
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
...
func (this *XtCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes402912 := (<-this.LoadMarkets())
			PanicOnError(retRes402912)
		}
		var currency any = this.Currency(code)
...
func (this *XtCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes417112 := (<-this.LoadMarkets())
			PanicOnError(retRes417112)
		}
		var market any = this.Market(symbol)
...
func (this *XtCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes421315 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func (this *XtCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes422815 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
		PanicOnError(retRes422815)
		ch <- retRes422815
		return nil
...
func (this *XtCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes447519 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "id", "id", 1, 200))
...
func (this *XtCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes454715 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes454715)
		ch <- retRes454715
		return nil
...
func (this *XtCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes456112 := (<-this.LoadMarkets())
			PanicOnError(retRes456112)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
...
func (this *XtCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes480212 := (<-this.LoadMarkets())
			PanicOnError(retRes480212)
		}
		var subType any = nil
...
func (this *XtCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes504312 := (<-this.LoadMarkets())
			PanicOnError(retRes504312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		var stopLoss any = this.SafeNumber2(params, "stopLoss", "triggerStopPrice")
