...
func (this *Xt) ParseMarket(market any) any {
	...
	for i := 0; i < len(filters); i++ {
		var entry map[string]any = SafeMapTyped(filters, i)
...
func (this *Xt) ParseLedgerEntryType(typeVar *string) *string {
...
func (this *Xt) ParseLeverageTiers(response any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(response); i++ {
		...
		var market map[string]any = this.SafeMarket(marketId, nil, "_", "contract")
...
func (this *Xt) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var result []any = []any{}
	for i := 0; i < len(items); i++ {
		var entry map[string]any = SafeMapTyped(items, i)
