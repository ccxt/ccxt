...
func CreateExchange(exchangeId string, options map[string]interface{}) IExchange {
    ...
    case "exchange":
        ...
        return itf
    case "abantether":
        itf := NewAbantether(options)
        return itf
    case "ace":
        itf := NewAce(options)
        return itf
    case "afratether":
        itf := NewAfratether(options)
        return itf
    case "alpaca":
        itf := NewAlpaca(options)
        return itf
    case "arzinja":
        itf := NewArzinja(options)
        return itf
    case "arzplus":
        itf := NewArzplus(options)
        return itf
    case "ascendex":
    ...
    case "bitbank":
        ...
        return itf
    case "bitbay":
        itf := NewBitbay(options)
        return itf
    case "bitbns":
        itf := NewBitbns(options)
        return itf
    case "bitcoincom":
        itf := NewBitcoincom(options)
        return itf
    case "bitfinex":
        itf := NewBitfinex(options)
        return itf
    case "bitfinex2":
        itf := NewBitfinex2(options)
        return itf
    case "bitflyer":
    ...
    case "bithumb":
        ...
        return itf
    case "bitimen":
        itf := NewBitimen(options)
        return itf
    case "bitir":
        itf := NewBitir(options)
        return itf
    case "bitmart":
    ...
    case "bitopro":
        ...
        return itf
    case "bitpanda":
        itf := NewBitpanda(options)
        return itf
    case "bitpin":
        itf := NewBitpin(options)
        return itf
    case "bitrue":
    ...
    case "digifinex":
        ...
        return itf
    case "eterex":
        itf := NewEterex(options)
        return itf
    case "excoino":
        itf := NewExcoino(options)
        return itf
    case "exir":
        itf := NewExir(options)
        return itf
    case "exmo":
        ...
        return itf
    case "exnovin":
        itf := NewExnovin(options)
        return itf
    case "farhadexchange":
        itf := NewFarhadexchange(options)
        return itf
    case "fmfwio":
    ...
    case "hitbtc":
        ...
        return itf
    case "hitbtc3":
        itf := NewHitbtc3(options)
        return itf
    case "hitobit":
        itf := NewHitobit(options)
        return itf
    case "hollaex":
    ...
    case "okcoin":
        ...
        return itf
    case "okexchange":
        itf := NewOkexchange(options)
        return itf
    case "okx":
        itf := NewOkx(options)
        return itf
    case "ompfinex":
        itf := NewOmpfinex(options)
        return itf
    case "onetrading":
    ...
    case "poloniexfutures":
        itf := NewPoloniexfutures(options)
        return itf
    case "probit":
        itf := NewProbit(options)
        return itf
    case "ramzinex":
        itf := NewRamzinex(options)
        return itf
    case "sarmayex":
        itf := NewSarmayex(options)
        return itf
    case "sarrafex":
        itf := NewSarrafex(options)
        return itf
    case "tabdeal":
        itf := NewTabdeal(options)
        return itf
    case "tetherland":
        itf := NewTetherland(options)
        return itf
    case "timex":
    ...
    case "twox":
        ...
        return itf
    case "ubitex":
        itf := NewUbitex(options)
        return itf
    case "upbit":
        itf := NewUpbit(options)
        return itf
    case "wallex":
        itf := NewWallex(options)
        return itf
    case "wavesexchange":
        itf := NewWavesexchange(options)
        return itf
    case "wazirx":
        itf := NewWazirx(options)
        return itf
    case "whitebit":
