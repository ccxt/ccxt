...
type IExchange interface {
    ...
    WatchOrderBookForSymbols(symbols []string, options ...WatchOrderBookForSymbolsOptions) (IOrderBook, error)
    ...
    WatchOrderBook(symbol string, options ...WatchOrderBookOptions) (IOrderBook, error)
    ...
    CancelOrderWs(id string, options ...CancelOrderWsOptions) (map[string]interface{}, error)
    CancelOrdersWs(ids []string, options ...CancelOrdersWsOptions) (map[string]interface{}, error)
    ...
    CancelAllOrdersWs(options ...CancelAllOrdersWsOptions) (map[string]interface{}, error)
