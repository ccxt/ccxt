...
func (this *Coinbaseinternational) handlePortfolioAndParamsBody(ch chan any, methodName any, optionalArgs ...any) any {
	...
	var portfolioparamsVariable []any = this.HandleOptionStringAndParams(params, methodName, "portfolio")
	portfolio = SafeStringPtr(GetValue(portfolioparamsVariable, 0))
	params = MapTyped(GetValue(portfolioparamsVariable, 1))
...
func (this *Coinbaseinternational) handleNetworkIdAndParamsBody(ch chan any, currencyCode any, methodName any, optionalArgs ...any) any {
	...
	var networkIdparamsVariable []any = this.HandleOptionAndParams(params, methodName, "network_arn_id")
	networkId = GetValue(networkIdparamsVariable, 0)
	params = MapTyped(GetValue(networkIdparamsVariable, 1))
	if networkId == nil {
...
func (this *Coinbaseinternational) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes48119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))))
	...
	var unitl *int64 = this.SafeInteger(params, "until")
	if unitl != nil {
		params = MapTyped(this.Omit(params, "until"))
		request["end"] = this.Iso8601(unitl)
	}

	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetInstrumentsInstrumentCandles(this.Extend(request, params))).Raw))
	//
	//   {
	//       "aggregations": [
	//         {
...
func (this *Coinbaseinternational) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes56319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))))
		ch <- BoxAbsent(retRes56319)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetInstrumentsInstrumentFunding(this.Extend(request, params))).Raw))
	//
	//    {
	//        "pagination":{
	//           "result_limit":"25",
...
func (this *Coinbaseinternational) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var fundingDatetime *string = this.SafeString2(contract, "event_time", "time")
	return map[string]any{
		"info":                     contract,
...
func (this *Coinbaseinternational) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetTransfers(this.Extend(request, params))).Raw))
...
func (this *Coinbaseinternational) ParseIncome(income any, optionalArgs ...any) any {
	...
	var datetime *int64 = this.SafeInteger(income, "created_at")
...
func (this *Coinbaseinternational) FindDefaultNetwork(networks any) any {
	...
	for i := 0; i < len(networksArray); i++ {
		var info map[string]any = SafeMapTyped(func() any {
...
func (this *Coinbaseinternational) ParseNetworks(networks any, optionalArgs ...any) map[string]any {
	...
	for i := 0; i < GetArrayLength(networks); i++ {
		...
		AddElementToObject(result, network["network"], network)
	}
	return result
}
func (this *Coinbaseinternational) ParseNetwork(network any, optionalArgs ...any) any {
	...
	var networkId *string = this.SafeString(network, "network_arn_id")
	var networkIdForCode *string = this.SafeStringN(network, []any{"network_name", "display_name", "network_arn_id"}, "")
...
func (this *Coinbaseinternational) setMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	_ = params
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("setMargin", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	...
	response := (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params))).Raw
...
func (this *Coinbaseinternational) fetchDepositsWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var paginateparamsVariable []any = this.HandleOptionBoolAndParams(params, "fetchDepositsWithdrawals", "paginate")
	...
	if paginate == true {
		...
		var retRes101319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))))
...
func (this *Coinbaseinternational) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchPosition", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var request map[string]any = map[string]any{
		"portfolio":  portfolio,
...
func (this *Coinbaseinternational) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchPositions", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes122315 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, params))))
	ch <- BoxAbsent(retRes122315)
	return nil
}
...
func (this *Coinbaseinternational) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes124615 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, params))))
...
func (this *Coinbaseinternational) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var datetime *string = this.SafeString(trade, "event_time")
...
func (this *Coinbaseinternational) ParseMarket(market any) any {
	...
	var baseId *string = this.SafeString(market, "base_asset_name")
	var quoteId *string = this.SafeString(market, "quote_asset_name")
	...
	return this.SafeMarketStructure(map[string]any{
		"id":          marketId,
		"lowercaseId": strings.ToLower(*marketId),
		"symbol":      symbol,
		"base":        baseId,
		"quote":       quoteId,
		"settle":      settleId,
...
func (this *Coinbaseinternational) ParseCurrency(currency any) any {
	...
	//    }
	//
	var id *string = this.SafeString(currency, "asset_name")
	var code *string = this.SafeCurrencyCode(id)
	var statusId *string = this.SafeString(currency, "status")
	return this.SafeCurrencyStructure(map[string]any{
		...
		"precision": nil,
		"info":      currency,
		"active":    (statusId != nil && *statusId == "ACTIVE"),
		"deposit":   nil,
		"withdraw":  nil,
		"networks":  nil,
		"fee":       nil,
...
func (this *Coinbaseinternational) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var datetime *string = this.SafeString(ticker, "timestamp")
...
func (this *Coinbaseinternational) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchBalance", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) ParseBalance(response any) any {
	...
	for i := 0; i < GetArrayLength(response); i++ {
		var rawBalance map[string]any = SafeMapTyped(response, i)
...
func (this *Coinbaseinternational) ParseOrder(order any, optionalArgs ...any) any {
	...
	var datetime *string = this.SafeString2(order, "submit_time", "event_time")
...
func (this *Coinbaseinternational) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("cancelOrder", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("cancelAllOrders", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if clientOrderId == nil {
		panic(BadRequest(this.Id + " editOrder() requires a clientOrderId parameter"))
	}
...
func (this *Coinbaseinternational) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchOrder", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var request map[string]any = map[string]any{
		"id":        id,
...
func (this *Coinbaseinternational) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var portfolio any = nil
	var portfolioparamsVariable []any = ListTyped(PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchOpenOrders", params))))
	portfolio = GetValue(portfolioparamsVariable, 0)
	params = GetValue(portfolioparamsVariable, 1)
	var paginate bool = false
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetOrders(this.Extend(request, params))).Raw))
	//
	//    {
	//        "pagination":{
	//           "result_limit":25,
...
func (this *Coinbaseinternational) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetPortfoliosFills(this.Extend(request, params))).Raw))
	//
	//    {
	//        "pagination":{
	//           "result_limit":25,
