...
func (this *Coinbaseinternational) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	portfolios, paramsPortfolios := this.HandleOptionStringAndParams(params, "fetchFundingHistory", "portfolios")
	if portfolios != nil {
...
func (this *Coinbaseinternational) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	portfolios, paramsPortfolios := this.HandleOptionStringAndParams(params, "fetchTransfers", "portfolios")
	if portfolios != nil {
		request["portfolios"] = portfolios
	}
	if since != nil {
...
func (this *Coinbaseinternational) createDepositAddressBody(ch chan any, code string, optionalArgs ...any) any {
	...
	listRecv1054, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("createDepositAddress", paramsMethod))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv1054
	...
	if method != nil && *method == "v1PrivatePostTransfersAddress" {
		...
		listRecv1064, _ := PanicOnError((<-this.HandleNetworkIdAndParamsAsync(code, "createDepositAddress", paramsPortfolio))).([]any)
		var networkIdparamsNetworkIdVariable []any = listRecv1064
...
func (this *Coinbaseinternational) setMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var params map[string]any = GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
	listRecv1251, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("setMargin", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv1251
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
...
func (this *Coinbaseinternational) fetchDepositsWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	portfolios, paramsPortfolios := this.HandleOptionStringAndParams(paramsMaxEntriesPerRequest, "fetchDepositsWithdrawals", "portfolios")
	if portfolios != nil {
		request["portfolios"] = portfolios
	}
...
func (this *Coinbaseinternational) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	listRecv1399, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchPosition", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv1399
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	var request map[string]any = map[string]any{
		"portfolio":  portfolio,
...
func (this *Coinbaseinternational) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	listRecv1505, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchPositions", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv1505
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	listRecv2172, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchBalance", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2172
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) createOrderBody(ch chan any, symbol string, typeVar string, side string, amount any, optionalArgs ...any) any {
	...
	listRecv2357, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("createOrder", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2357
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	if portfolio != nil {
		request["portfolio"] = portfolio
	}
	var postOnly *bool = this.SafeBool2(paramsPortfolio, "postOnly", "post_only")
	var tif *string = this.SafeString2(paramsPortfolio, "tif", "timeInForce")
...
func (this *Coinbaseinternational) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	listRecv2524, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("cancelOrder", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2524
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	listRecv2589, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("cancelAllOrders", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2589
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	var request map[string]any = map[string]any{
		"portfolio": portfolio,
...
func (this *Coinbaseinternational) editOrderBody(ch chan any, id string, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	listRecv2646, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("editOrder", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2646
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	if portfolio != nil {
		request["portfolio"] = portfolio
	...
	var triggerPrice *float64 = this.SafeNumberN(paramsPortfolio, []any{"stopPrice", "stop_price", "triggerPrice"})
	if triggerPrice != nil {
		request["stop_price"] = triggerPrice
	}
	var clientOrderId *string = this.SafeString2(paramsPortfolio, "client_order_id", "clientOrderId")
...
func (this *Coinbaseinternational) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	listRecv2704, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchOrder", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2704
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	var request map[string]any = map[string]any{
		"id":        id,
...
func (this *Coinbaseinternational) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	listRecv2777, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("fetchOpenOrders", params))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv2777
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
...
func (this *Coinbaseinternational) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var until *string = this.SafeString(paramsMaxEntriesPerRequest, "until")
	if until != nil {
		request["ref_datetime"] = this.Iso8601(until)
	}
	var paramsOmitted any = func() any {
		if until != nil {
			return this.Omit(paramsMaxEntriesPerRequest, []any{"until"})
		}
...
func (this *Coinbaseinternational) withdrawBody(ch chan any, code string, amount any, address any, optionalArgs ...any) any {
	...
	var currency map[string]any = this.Currency(code)
	listRecv3008, _ := PanicOnError((<-this.HandlePortfolioAndParamsAsync("withdraw", paramsWithdrawTag))).([]any)
	var portfolioparamsPortfolioVariable []any = listRecv3008
	var portfolio *string = SafeStringPtr(portfolioparamsPortfolioVariable[0])
	var paramsPortfolio map[string]any = MapTyped(portfolioparamsPortfolioVariable[1])
	method, paramsMethod := this.HandleOptionStringAndParams(paramsPortfolio, "withdraw", "method", "v1PrivatePostTransfersWithdraw")
	listRecv3012, _ := PanicOnError((<-this.HandleNetworkIdAndParamsAsync(code, "withdraw", paramsMethod))).([]any)
	var networkIdparamsNetworkIdVariable []any = listRecv3012
	var networkId *string = SafeStringPtr(networkIdparamsNetworkIdVariable[0])
	var paramsNetworkId map[string]any = MapTyped(networkIdparamsNetworkIdVariable[1])
	var request map[string]any = map[string]any{
		"portfolio":      portfolio,
