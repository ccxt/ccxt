...
func (this *Coinbaseinternational) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if since != nil {
		...
		since = this.Sum(this.Milliseconds(), Multiply(Multiply(OpNeg(limit), duration), 1000))
		request["start"] = this.Iso8601(since)
	}
...
func (this *Coinbaseinternational) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes56819 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func (this *Coinbaseinternational) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes82612 := (<-this.LoadMarketsAsync())
...
func (this *Coinbaseinternational) fetchDepositsWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes101819 := (<-this.FetchPaginatedCallIncrementalAsync("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
...
func (this *Coinbaseinternational) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes122512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes122512)
	}
	AddElementToObject(params, "type", "WITHDRAW")

	retRes122815 := (<-this.FetchDepositsWithdrawalsAsync(code, since, limit, params))
...
func (this *Coinbaseinternational) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes125115 := (<-this.FetchDepositsWithdrawalsAsync(code, since, limit, params))
...
func (this *Coinbaseinternational) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes205212 := (<-this.LoadMarketsAsync())
...
func (this *Coinbaseinternational) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes212712 := (<-this.LoadMarketsAsync())
...
func (this *Coinbaseinternational) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes218412 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes219419 := (<-this.FetchPaginatedCallIncrementalAsync("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func (this *Coinbaseinternational) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes227819 := (<-this.FetchPaginatedCallIncrementalAsync("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func (this *Coinbaseinternational) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes236812 := (<-this.LoadMarketsAsync())
