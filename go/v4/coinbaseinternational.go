...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes900857 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes900857)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes952839 := (<-this.LoadMarkets())
            PanicOnError(retRes952839)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes118889 := (<-this.LoadMarkets())
            PanicOnError(retRes118889)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes254762 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes254762)
                    ch <- retRes254762
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes849749 := (<-this.LoadMarkets())
            PanicOnError(retRes849749)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes417833 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes417833)
                    ch <- retRes417833
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes413477 := (<-this.LoadMarkets())
            PanicOnError(retRes413477)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339563 := (<-this.LoadMarkets())
            PanicOnError(retRes339563)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497454 := (<-this.LoadMarkets())
            PanicOnError(retRes497454)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes253786 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes253786)
                ch <- retRes253786
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes301951 := (<-this.LoadMarkets())
            PanicOnError(retRes301951)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes824464 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes856614 := (<-this.LoadMarkets())
            PanicOnError(retRes856614)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes457887 := (<-this.LoadMarkets())
            PanicOnError(retRes457887)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes519675 := (<-this.LoadMarkets())
            PanicOnError(retRes519675)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes665682 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes665682)
                ch <- retRes665682
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes524620 := (<-this.LoadMarkets())
            PanicOnError(retRes524620)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes11402 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes11402)
                ch <- retRes11402
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes598346 := (<-this.LoadMarkets())
            PanicOnError(retRes598346)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes8135 := (<-this.LoadMarkets())
            PanicOnError(retRes8135)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes776431 := (<-this.LoadMarkets())
            PanicOnError(retRes776431)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes682631 := (<-this.LoadMarkets())
            PanicOnError(retRes682631)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes895423 := (<-this.LoadMarkets())
            PanicOnError(retRes895423)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98863 := (<-this.LoadMarkets())
            PanicOnError(retRes98863)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes21959 := (<-this.LoadMarkets())
            PanicOnError(retRes21959)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes108212 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96373 := (<-this.LoadMarkets())
            PanicOnError(retRes96373)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes813138 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes813138)
                    ch <- retRes813138
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes699297 := (<-this.LoadMarkets())
            PanicOnError(retRes699297)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
