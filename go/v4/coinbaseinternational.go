...
func (this *CoinbaseinternationalCore) handleNetworkIdAndParamsBody(ch chan any, currencyCode any, methodName any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(networkId, nil)) {
		...
		retRes36112 := (<-this.LoadCurrencyNetworks(currencyCode))
...
func (this *CoinbaseinternationalCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes45619 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
...
func (this *CoinbaseinternationalCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes119815 := (<-this.FetchDepositsWithdrawals(code, since, limit, params))
...
func (this *CoinbaseinternationalCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes122115 := (<-this.FetchDepositsWithdrawals(code, since, limit, params))
	PanicOnError(retRes122115)
	ch <- retRes122115
	return nil
}
