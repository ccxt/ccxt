...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes395752 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes395752)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83190 := (<-this.LoadMarkets())
            PanicOnError(retRes83190)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes395976 := (<-this.LoadMarkets())
            PanicOnError(retRes395976)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes39953 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes39953)
                    ch <- retRes39953
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621671 := (<-this.LoadMarkets())
            PanicOnError(retRes621671)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes600470 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes600470)
                    ch <- retRes600470
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241099 := (<-this.LoadMarkets())
            PanicOnError(retRes241099)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes861551 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes861551)
                ch <- retRes861551
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes651485 := (<-this.LoadMarkets())
            PanicOnError(retRes651485)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes482541 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes482541)
                    ch <- retRes482541
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes725698 := (<-this.LoadMarkets())
            PanicOnError(retRes725698)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes494832 := (<-this.LoadMarkets())
            PanicOnError(retRes494832)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes699785 := (<-this.LoadMarkets())
            PanicOnError(retRes699785)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes156923 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes156923)
                ch <- retRes156923
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes990606 := (<-this.LoadMarkets())
            PanicOnError(retRes990606)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes255282 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes255282)
                ch <- retRes255282
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes891160 := (<-this.LoadMarkets())
            PanicOnError(retRes891160)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes64887 := (<-this.LoadMarkets())
            PanicOnError(retRes64887)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes796132 := (<-this.LoadMarkets())
            PanicOnError(retRes796132)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes498506 := (<-this.LoadMarkets())
            PanicOnError(retRes498506)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes143257 := (<-this.LoadMarkets())
            PanicOnError(retRes143257)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46779 := (<-this.LoadMarkets())
            PanicOnError(retRes46779)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes393550 := (<-this.LoadMarkets())
            PanicOnError(retRes393550)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490360 := (<-this.LoadMarkets())
            PanicOnError(retRes490360)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192911 := (<-this.LoadMarkets())
            PanicOnError(retRes192911)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes910941 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes786601 := (<-this.LoadMarkets())
            PanicOnError(retRes786601)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes751909 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes751909)
                    ch <- retRes751909
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164640 := (<-this.LoadMarkets())
            PanicOnError(retRes164640)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
