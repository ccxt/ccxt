...
func (this *CoinbaseinternationalCore) SetMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes95415 := (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
...
func (this *CoinbaseinternationalCore) FetchDepositsWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes98319 := (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
...
func (this *CoinbaseinternationalCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes119315 := (<-this.FetchDepositsWithdrawals(code, since, limit, params))
		PanicOnError(retRes119315)
		ch <- retRes119315
		return nil
...
func (this *CoinbaseinternationalCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes121615 := (<-this.FetchDepositsWithdrawals(code, since, limit, params))
		PanicOnError(retRes121615)
		ch <- retRes121615
		return nil
...
func (this *CoinbaseinternationalCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes215219 := (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func (this *CoinbaseinternationalCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes223619 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
			PanicOnError(retRes223619)
			ch <- retRes223619
			return nil
		}
		var market any = nil
