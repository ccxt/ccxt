...
func (this *Coinbaseinternational) ParseMarket(market any) any {
	...
	var isLinear any = Ternary(isSpot, nil, (IsEqual(settleId, quoteId)))
	var isInverse any = Ternary(isSpot, nil, (!IsEqual(settleId, quoteId)))
	if marketId == nil {
	...
	return this.SafeMarketStructure(map[string]any{
		...
		"contractSize":   Ternary(isSpot, nil, 1),
		"expiry":         nil,
		"expiryDatetime": nil,
		"strike":         nil,
		"optionType":     nil,
		...
		"limits": map[string]any{
			...
			"amount": map[string]any{
				"min": nil,
				"max": Ternary(isSpot, nil, this.SafeNumber(market, "position_limit_qty")),
			},
...
func (this *Coinbaseinternational) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if typeId == "MARKET" {
		...
		tif = Ternary((IsEqual(tif, nil)), "GTC", tif)
	}
	if postOnly != nil {
