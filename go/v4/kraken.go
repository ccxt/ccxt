...
func (this *KrakenCore) AddKeyInArrayItems(obj any, keyName any) any {
	var result any = []any{}
...
func (this *KrakenCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes120719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 720))
			PanicOnError(retRes120719)
			ch <- retRes120719
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *KrakenCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes166615 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
		PanicOnError(retRes166615)
		ch <- retRes166615
		return nil
...
func (this *KrakenCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes168115 := (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
...
func (this *KrakenCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes312519 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next_cursor", "cursor"))
...
func (this *KrakenCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes321615 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func (this *KrakenCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes352315 := (<-this.Transfer(code, amount, "spot", "swap", params))
		PanicOnError(retRes352315)
		ch <- retRes352315
		return nil
