...
func  (this *KrakenCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                AddElementToObject(params, "cursor", true)
                    ...
                    retRes311119 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next_cursor", "cursor"))
...
func  (this *KrakenCore) CreateDepositAddress(code any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes320215 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes320215)
                ch <- retRes320215
                return nil
...
func  (this *KrakenCore) TransferOut(code any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes350915 :=  (<-this.Transfer(code, amount, "spot", "swap", params))
