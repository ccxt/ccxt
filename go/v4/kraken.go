...
func (this *KrakenCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes319219 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next_cursor", "cursor"))
...
func (this *KrakenCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes328315 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func (this *KrakenCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes359915 := (<-this.Transfer(code, amount, "spot", "swap", params))
