...
func (this *KrakenCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes311019 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next_cursor", "cursor"))
...
func (this *KrakenCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes320115 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
		PanicOnError(retRes320115)
		ch <- retRes320115
		return nil
...
func (this *KrakenCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes350815 := (<-this.Transfer(code, amount, "spot", "swap", params))
