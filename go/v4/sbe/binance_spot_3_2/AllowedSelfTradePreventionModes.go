...
type AllowedSelfTradePreventionModesChoiceValues struct {
	...
	Transfer         AllowedSelfTradePreventionModesChoiceValue
	NonRepresentable AllowedSelfTradePreventionModesChoiceValue
}

var AllowedSelfTradePreventionModesChoice = AllowedSelfTradePreventionModesChoiceValues{0, 1, 2, 3, 4, 5, 7}
...
func (*AllowedSelfTradePreventionModes) TransferSinceVersion() uint16 {
	return 0
}

func (a *AllowedSelfTradePreventionModes) TransferInActingVersion(actingVersion uint16) bool {
	return actingVersion >= a.TransferSinceVersion()
}

func (*AllowedSelfTradePreventionModes) TransferDeprecated() uint16 {
	return 0
}
