...
func (this *Bithumb) GetGen2MarketId(market any) any {
	...
	if (marketId != nil) && (func() int {
		if marketId == nil {
			return -1
		}
		return strings.Index(*marketId, "-")
	}() >= 0) {
		return marketId
	}
...
func (this *Bithumb) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchMarkets", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
...
func (this *Bithumb) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchBalance", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
...
func (this *Bithumb) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchOrderBook", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{}
...
func (this *Bithumb) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	if (marketId != nil) && (nonZeroOpen != nil) && (close != nil) {
		...
		if (change != nil) && Precise.StringEq(change, "0") && !Precise.StringEq(computedChange, "0") {
			change = computedChange
			percentage = nil
		}
	}
	var high *string = this.SafeString2(ticker, "max_price", "high_price")
	var low *string = this.SafeString2(ticker, "min_price", "low_price")
	// Some generation 2 ticker payloads can contain inconsistent high/low versus last.
	if (close != nil) && (high != nil) && Precise.StringGt(close, high) {
		high = close
	}
	if (close != nil) && (low != nil) && Precise.StringLt(close, low) {
		low = close
	}
...
func (this *Bithumb) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchTickers", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var request map[string]any = map[string]any{}
	var result map[string]any = map[string]any{}
	if IsEqual(generation, 2) {
		...
		for i := 0; i < responsesLength; i++ {
			...
			if this.IsDictionary(response) && (InOp(response, "data")) && (!IsEqual(GetValue(response, "data"), nil)) {
...
func (this *Bithumb) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchTicker", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{}
...
func (this *Bithumb) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchOHLCV", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{}
...
func (this *Bithumb) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchTrades", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{}
...
func (this *Bithumb) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "createOrders", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
	...
	for i := 0; i < GetArrayLength(orders); i++ {
		...
		if typeVar == nil {
			panic(ArgumentsRequired(this.Id + " createOrders() requires each order to have a type"))
		}
		var side *string = this.SafeString(rawOrder, "side")
		if side == nil {
			panic(ArgumentsRequired(this.Id + " createOrders() requires each order to have a side"))
		}
...
func (this *Bithumb) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var paramsTimeInForce any = func() any {
		if timeInForceRaw == nil {
			return params
		}
		return this.Omit(params, "timeInForce")
	}()
...
func (this *Bithumb) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "createOrder", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
...
func (this *Bithumb) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "createMarketBuyOrderWithCost", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) createTwapOrderBody(ch chan any, symbol any, side string, amount any, duration any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "createTwapOrder", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchOrder", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var market any = nil
	if symbol != nil {
	...
	if IsEqual(generation, 2) {
		...
		if (base == nil) || (quote == nil) {
			panic(ArgumentsRequired(this.Id + " fetchOrder() requires a market with defined base and quote"))
		}
		request["order_id"] = id
...
func (this *Bithumb) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchOpenOrders", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
...
func (this *Bithumb) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchOrders", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "cancelOrder", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	var market any = nil
	if symbol != nil {
...
func (this *Bithumb) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "cancelOrders", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "withdraw", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
...
func (this *Bithumb) fetchWithdrawalWhitelistBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchWithdrawalWhitelist", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchWithdrawalBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchWithdrawal", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchWithdrawals", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchDepositBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchDeposit", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchDeposits", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "createDepositAddress", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchDepositAddress", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) fetchDepositAddressesBody(ch chan any, optionalArgs ...any) any {
	...
	var generationparamsGenerationVariable []any = this.HandleOptionIntegerAndParams(params, "fetchDepositAddresses", "generation", 2)
	generation := GetValue(generationparamsGenerationVariable, 0)
	paramsGeneration := GetValue(generationparamsGenerationVariable, 1)
	if !IsEqual(generation, 2) {
...
func (this *Bithumb) ParseDepositAddress(response any, optionalArgs ...any) any {
	...
	if address == nil {
		panic(ExchangeError(this.Id + " parseDepositAddress() could not find deposit_address"))
	}
	this.CheckAddress(address)
	return map[string]any{
		"info":     response,
