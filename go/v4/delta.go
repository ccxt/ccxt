...
func  (this *Delta) CreateExpiredOptionMarket(symbol any) any  {
    ...
    var optionTypeUnified any = Ternary((IsEqual(optionType, "C")), "call", "put")
...
func  (this *Delta) SafeMarket(optionalArgs ...any) any  {
    ...
    _ = marketType
    var isOption bool = (!IsEqual(marketId, nil)) && ((EndsWith(marketId, "-C")) || (EndsWith(marketId, "-P")) || (StartsWith(marketId, "C-")) || (StartsWith(marketId, "P-")))
...
func (this *Delta) fetchStatusBody(ch chan any, optionalArgs ...any) any {
    defer close(ch)
    defer ReturnPanicError(ch)
        params := GetArg(optionalArgs, 0, map[string]any {})
        _ = params
        ...
        var status any = Ternary(((underMaintenance != nil && *underMaintenance == "true")), "maintenance", "ok")
...
func (this *Delta) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        for i := 0; IsLessThan(i, GetArrayLength(markets)); i++ {
            ...
            var baseId *string = this.SafeString(underlyingAsset, "symbol")
            var quoteId *string = this.SafeString(quotingAsset, "symbol")
            ...
            AppendToArray(&result, this.SafeMarketStructure(map[string]any {
                ...
                "contract": !spot,
                "linear": Ternary(spot, nil, linear),
                "inverse": Ternary(spot, nil, !linear),
                "taker": this.SafeNumber(market, "taker_commission_rate"),
                "maker": this.SafeNumber(market, "maker_commission_rate"),
                "contractSize": Ternary(spot, nil, contractSize),
                "expiry": expiry,
...
func  (this *Delta) ParseTicker(ticker any, optionalArgs ...any) any  {
    ...
    var quoteVolume any = Ternary(baseDenominated, this.SafeNumber(ticker, "turnover_usd"), this.SafeNumber(ticker, "turnover"))
...
func (this *Delta) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(since, nil) {
            var end any = Ternary(untilIsDefined, until, this.Seconds())
            ...
            AddElementToObject(request, "end", Ternary(untilIsDefined, until, this.Sum(start, Multiply(limit, duration))))
        }
...
func  (this *Delta) ParseBalance(response any) any  {
    ...
    for i := 0; IsLessThan(i, GetArrayLength(balances)); i++ {
        ...
        var code any = Ternary((IsEqual(currency, nil)), currencyId, GetValue(currency, "code"))
...
func  (this *Delta) ParseOrder(order any, optionalArgs ...any) any  {
    ...
    if (createdAt != nil) {
        if IsGreaterThanOrEqual(GetIndexOf(createdAt, "-"), 0) {
...
func (this *Delta) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
    defer close(ch)
    defer ReturnPanicError(ch)
...
func  (this *Delta) ParseLedgerEntry(item any, optionalArgs ...any) any  {
    ...
    var code any = Ternary((IsEqual(currency, nil)), nil, GetValue(currency, "code"))
...
func  (this *Delta) ParseOpenInterest(interest any, optionalArgs ...any) any  {
    ...
    market := GetArg(optionalArgs, 0, nil)
    _ = market
    var timestamp *int64 = this.SafeIntegerProduct(interest, "timestamp", 0.001)
...
func  (this *Delta) ParseSettlement(settlement any, market any) any  {
    ...
    //     }
    //
    var datetime *string = this.SafeString(settlement, "settlement_time")
...
func (this *Delta) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
    defer close(ch)
    defer ReturnPanicError(ch)
        symbol := GetArg(optionalArgs, 0, nil)
        _ = symbol
        ...
        var subaccountUserId *string = this.SafeString(params, "subaccount_user_id")
...
func  (this *Delta) ParseADLRank(info any, optionalArgs ...any) any  {
    ...
    market := GetArg(optionalArgs, 0, nil)
    _ = market
    var marketId *string = this.SafeString(info, "product_symbol")
    var datetime *string = this.SafeString(info, "created_at")
    return map[string]any {
        "info": info,
...
func (this *Delta) Init(userConfig map[string]any) {
...
func (this *Delta) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Delta) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
...
func (this *Delta) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *Delta) FetchDepositWithdrawFees(options ...FetchDepositWithdrawFeesOptions) (DepositWithdrawFees, error) {return this.exchangeTyped.FetchDepositWithdrawFees(options...)}
...
func (this *Delta) FetchPositionMode(options ...FetchPositionModeOptions) (PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *Delta) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Delta) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
