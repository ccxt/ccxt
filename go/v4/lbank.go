...
func (this *LbankCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes163815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes163815)
		ch <- retRes163815
		return nil
...
func (this *LbankCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchOrderSupplement")) {
			...
			retRes192319 := (<-this.FetchOrderSupplement(id, symbol, params))
			PanicOnError(retRes192319)
			ch <- retRes192319
			return nil
		}

		retRes192515 := (<-this.FetchOrderDefault(id, symbol, params))
		PanicOnError(retRes192515)
		ch <- retRes192515
		return nil
...
func (this *LbankCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes203112 := (<-this.LoadMarkets())
			PanicOnError(retRes203112)
		}
		var market any = this.Market(symbol)
...
func (this *LbankCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes230812 := (<-this.LoadMarkets())
			PanicOnError(retRes230812)
		}
...
func (this *LbankCore) FetchPublicTransactionFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes278812 := (<-this.LoadMarkets())
			PanicOnError(retRes278812)
		}
