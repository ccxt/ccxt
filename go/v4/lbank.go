...
func (this *LbankCore) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var data any = Ternary(EvalTruthy((GetValue(market, "contract"))), ticker, tickerData)
...
func (this *LbankCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var maker bool = (EvalTruthy(postOnly) || (timeInForce != nil && *timeInForce == "PO"))
...
func (this *LbankCore) Sign(path any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(api, 1), "public") {
		...
		if IsEqual(signatureMethod, "RSA") {
			...
			var pem any = nil
			if EvalTruthy(cacheSecretAsPem) {
...
func (this *LbankCore) HandleErrors(httpCode any, reason any, url any, method any, headers any, body any, response any, requestHeaders any, requestBody any) any {
	...
	if IsEqual(success, "false") || !EvalTruthy(success) {
