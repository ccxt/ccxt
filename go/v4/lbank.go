...
func (this *LbankCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes159815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes159815)
		ch <- retRes159815
		return nil
...
func (this *LbankCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchOrderSupplement")) {
			...
			retRes187919 := (<-this.FetchOrderSupplement(id, symbol, params))
			PanicOnError(retRes187919)
			ch <- retRes187919
			return nil
		}

		retRes188115 := (<-this.FetchOrderDefault(id, symbol, params))
		PanicOnError(retRes188115)
		ch <- retRes188115
		return nil
...
func (this *LbankCore) FetchDepositAddressDefault(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22648 := (<-this.LoadMarkets())
		PanicOnError(retRes22648)
...
func (this *LbankCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes25698 := (<-this.LoadMarkets())
		PanicOnError(retRes25698)
		var request any = map[string]any{}
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
			currency = this.Currency(code)
...
func (this *LbankCore) FetchPrivateTransactionFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes26488 := (<-this.LoadMarkets())
		PanicOnError(retRes26488)
...
func (this *LbankCore) FetchPrivateDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes27968 := (<-this.LoadMarkets())
		PanicOnError(retRes27968)
