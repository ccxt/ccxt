...
func (this *LbankCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes145112 := (<-this.LoadMarkets())
			PanicOnError(retRes145112)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{
			"productGroup": "SwapU",
...
func (this *LbankCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes162215 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes162215)
		ch <- retRes162215
		return nil
...
func (this *LbankCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchOrderSupplement")) {
			...
			retRes190719 := (<-this.FetchOrderSupplement(id, symbol, params))
			PanicOnError(retRes190719)
			ch <- retRes190719
			return nil
		}

		retRes190915 := (<-this.FetchOrderDefault(id, symbol, params))
		PanicOnError(retRes190915)
		ch <- retRes190915
		return nil
...
func (this *LbankCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes283512 := (<-this.LoadMarkets())
			PanicOnError(retRes283512)
		}
		var isAuthorized any = this.CheckRequiredCredentials(false)
		var response any = nil
		if IsTrue(IsEqual(isAuthorized, true)) {
...
func (this *LbankCore) FetchPrivateDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes285912 := (<-this.LoadMarkets())
			PanicOnError(retRes285912)
		}
