 ...
 */
func (this *LbankCore) FetchTime(optionalArgs ...any) <-chan Res[*int64] {
...
func (this *LbankCore) FetchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes92512 := (<-this.LoadMarkets())
			PanicOnError(retRes92512)
		}
		var market any = this.Market(symbol)
...
func (this *LbankCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes145912 := (<-this.LoadMarkets())
			PanicOnError(retRes145912)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{
			"productGroup": "SwapU",
...
func (this *LbankCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes163515 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *LbankCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchOrderSupplement")) {
			...
			retRes192019 := (<-this.FetchOrderSupplement(id, symbol, params))
			PanicOnError(retRes192019)
			ch <- retRes192019
			return nil
		}

		retRes192215 := (<-this.FetchOrderDefault(id, symbol, params))
		PanicOnError(retRes192215)
		ch <- retRes192215
		return nil
...
func (this *LbankCore) FetchDepositAddressSupplement(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes236212 := (<-this.LoadMarkets())
			PanicOnError(retRes236212)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *LbankCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes257912 := (<-this.LoadMarkets())
			PanicOnError(retRes257912)
		}
		var request any = map[string]any{}
...
func (this *LbankCore) FetchTransactionFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes269412 := (<-this.LoadMarkets())
			PanicOnError(retRes269412)
		}
...
func (this *LbankCore) FetchPrivateTransactionFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes271812 := (<-this.LoadMarkets())
			PanicOnError(retRes271812)
		}
...
func (this *LbankCore) FetchPrivateDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes288212 := (<-this.LoadMarkets())
			PanicOnError(retRes288212)
		}
