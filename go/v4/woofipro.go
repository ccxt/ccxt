...
func (this *Woofipro) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes100115 := (<-this.FetchFundingRateAsync(symbol, params))
...
func (this *Woofipro) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var amount *float64 = this.SafeNumber2(interest, "open_interest", "openInterest")
...
func (this *Woofipro) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes135919 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
		PanicOnError(retRes135919)
		ch <- retRes135919
		return nil
	}
...
func (this *Woofipro) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes146219 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *Woofipro) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes202012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes202012)
	}
...
func (this *Woofipro) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes208712 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes217412 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes228912 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes242212 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes242919 := (<-this.FetchPaginatedCallIncrementalAsync("fetchOrders", symbol, since, limit, params, "page", maxLimit))
		PanicOnError(retRes242919)
		ch <- retRes242919
		return nil
	}
	var request any = map[string]any{}
...
func (this *Woofipro) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes251715 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
	PanicOnError(retRes251715)
	ch <- retRes251715
	return nil
}
...
func (this *Woofipro) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes254215 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
	PanicOnError(retRes254215)
	ch <- retRes254215
	return nil
}
...
func (this *Woofipro) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes255912 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes261519 := (<-this.FetchPaginatedCallIncrementalAsync("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *Woofipro) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes269212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes269212)
	}
...
func (this *Woofipro) ParseLedgerEntryType(typeVar *string) *string {
	var types map[string]any = map[string]any{
		"BALANCE":    "transaction",
		"COLLATERAL": "transfer",
	}
...
func (this *Woofipro) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes288015 := (<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))
...
func (this *Woofipro) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes289815 := (<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))
	PanicOnError(retRes289815)
	ch <- retRes289815
	return nil
}
...
func (this *Woofipro) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes298012 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes310812 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes313412 := (<-this.LoadMarketsAsync())
	...
	retRes315115 := (<-this.V1PrivatePostClientMarginMode(this.Extend(request, params)))
	PanicOnError(retRes315115)
	//
	// {
	//     "success": true,
	//     "timestamp": 1702989203989
...
func (this *Woofipro) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	_ = market
	var timestamp *int64 = this.SafeInteger(data, "timestamp")
	var success *bool = this.SafeBool(data, "success", false)
	return map[string]any{
		"info":       data,
...
func (this *Woofipro) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes322315 := (<-this.ModifyMarginHelperAsync(symbol, amount, "ADD", params))
	PanicOnError(retRes322315)
	ch <- retRes322315
	return nil
}
...
func (this *Woofipro) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes323715 := (<-this.ModifyMarginHelperAsync(symbol, amount, "REDUCE", params))
	PanicOnError(retRes323715)
	ch <- retRes323715
	return nil
}
...
func (this *Woofipro) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes326212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes326212)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Woofipro) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	retRes331715 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
...
func (this *Woofipro) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes345012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes345012)
	}
