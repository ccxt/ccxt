...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes715261 := (<-this.LoadMarkets())
            PanicOnError(retRes715261)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes657418 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes657418)
                ch <- retRes657418
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83363 := (<-this.LoadMarkets())
            PanicOnError(retRes83363)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes939622 := (<-this.LoadMarkets())
            PanicOnError(retRes939622)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes830028 := (<-this.LoadMarkets())
            PanicOnError(retRes830028)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes513731 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes513731)
                    ch <- retRes513731
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes155364 := (<-this.LoadMarkets())
            PanicOnError(retRes155364)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes831081 := (<-this.LoadMarkets())
            PanicOnError(retRes831081)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes715680 := (<-this.LoadMarkets())
            PanicOnError(retRes715680)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes596278 := (<-this.LoadMarkets())
            PanicOnError(retRes596278)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes287508 := (<-this.LoadMarkets())
            PanicOnError(retRes287508)
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes12949 := (<-this.LoadMarkets())
            PanicOnError(retRes12949)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes593259 := (<-this.LoadMarkets())
            PanicOnError(retRes593259)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes485957 := (<-this.LoadMarkets())
            PanicOnError(retRes485957)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes51670 := (<-this.LoadMarkets())
            PanicOnError(retRes51670)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes538843 := (<-this.LoadMarkets())
            PanicOnError(retRes538843)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes52341 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes52341)
                    ch <- retRes52341
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes648362 := (<-this.LoadMarkets())
            PanicOnError(retRes648362)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes345402 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes345402)
                ch <- retRes345402
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes960415 := (<-this.LoadMarkets())
            PanicOnError(retRes960415)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes904411 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes904411)
                ch <- retRes904411
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes887137 := (<-this.LoadMarkets())
            PanicOnError(retRes887137)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782473 := (<-this.LoadMarkets())
            PanicOnError(retRes782473)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes16029 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes16029)
                    ch <- retRes16029
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes777891 := (<-this.LoadMarkets())
            PanicOnError(retRes777891)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes331310 := (<-this.LoadMarkets())
            PanicOnError(retRes331310)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes13369 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes13369)
                ch <- retRes13369
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes242470 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes242470)
                ch <- retRes242470
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes485098 := (<-this.LoadMarkets())
            PanicOnError(retRes485098)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes632753 := (<-this.LoadMarkets())
            PanicOnError(retRes632753)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes949201 := (<-this.LoadMarkets())
            PanicOnError(retRes949201)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes389925 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes389925)
                ch <- retRes389925
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes36997 := (<-this.LoadMarkets())
            PanicOnError(retRes36997)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98934 := (<-this.LoadMarkets())
            PanicOnError(retRes98934)
