...
func (this *Woofipro) ParseCurrency(rawCurrency any) any {
	...
	for j := 0; j < len(networks); j++ {
		...
		var networkRow map[string]any = SafeMapTyped(indexedChains, networkId)
...
func (this *Woofipro) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes136119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))))
		ch <- BoxAbsent(retRes136119)
		return nil
	}
	var request map[string]any = map[string]any{}
	if symbol != nil {
...
func (this *Woofipro) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes146419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchFundingHistory", symbol, since, limit, params, "page", 500))))
		ch <- BoxAbsent(retRes146419)
		return nil
	}
	var request map[string]any = map[string]any{}
...
func (this *Woofipro) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if limit != nil {
		limit = Int64PtrTyped(mathMin(limit, 1000))
...
func (this *Woofipro) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"reduceOnly", "reduce_only", "clOrdID", "clientOrderId", "client_order_id", "postOnly", "timeInForce", "stopPrice", "triggerPrice", "stopLoss", "takeProfit"}))
 ...
 */
func (this *Woofipro) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Woofipro) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	var price *float64 = GetArgFloat64Ptr(optionalArgs, 0, nil)
	_ = price
...
func (this *Woofipro) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if isConditional {
		...
		var clientOrderId *string = this.SafeStringN(params, []any{"clOrdID", "clientOrderId", "client_order_id"})
		params = MapTyped(this.Omit(params, []any{"clOrdID", "clientOrderId", "client_order_id", "postOnly", "timeInForce"}))
		if clientOrderId != nil {
			request["client_order_id"] = clientOrderId
		}
...
func (this *Woofipro) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes242919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchOrders", symbol, since, limit, params, "page", maxLimit))))
		ch <- BoxAbsent(retRes242919)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market map[string]any = nil
...
func (this *Woofipro) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes251715 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))))
	ch <- BoxAbsent(retRes251715)
	return nil
}
...
func (this *Woofipro) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes254215 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))))
	ch <- BoxAbsent(retRes254215)
	return nil
}
...
func (this *Woofipro) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes261519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchMyTrades", symbol, since, limit, params, "page", 500))))
...
func (this *Woofipro) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes288015 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes288015)
	return nil
}
...
func (this *Woofipro) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes289815 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes289815)
	return nil
}
 ...
 */
func (this *Woofipro) ModifyMarginHelperAsync(symbol any, amount any, typeVar string, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.modifyMarginHelperBody(ch, symbol, amount, typeVar, optionalArgs...)
	return ch
}
func (this *Woofipro) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar string, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	var params map[string]any = GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Woofipro) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes322415 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, "ADD", params))))
	ch <- BoxAbsent(retRes322415)
	return nil
}
...
func (this *Woofipro) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes323815 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, "REDUCE", params))))
	ch <- BoxAbsent(retRes323815)
	return nil
}
