...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes230848 := (<-this.LoadMarkets())
            PanicOnError(retRes230848)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes775990 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes775990)
                ch <- retRes775990
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes584250 := (<-this.LoadMarkets())
            PanicOnError(retRes584250)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes193774 := (<-this.LoadMarkets())
            PanicOnError(retRes193774)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478361 := (<-this.LoadMarkets())
            PanicOnError(retRes478361)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes765231 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes765231)
                    ch <- retRes765231
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes32245 := (<-this.LoadMarkets())
            PanicOnError(retRes32245)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes457158 := (<-this.LoadMarkets())
            PanicOnError(retRes457158)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes686084 := (<-this.LoadMarkets())
            PanicOnError(retRes686084)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes254704 := (<-this.LoadMarkets())
            PanicOnError(retRes254704)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes832704 := (<-this.LoadMarkets())
            PanicOnError(retRes832704)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes343956 := (<-this.LoadMarkets())
            PanicOnError(retRes343956)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes851009 := (<-this.LoadMarkets())
            PanicOnError(retRes851009)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872308 := (<-this.LoadMarkets())
            PanicOnError(retRes872308)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568352 := (<-this.LoadMarkets())
            PanicOnError(retRes568352)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes956103 := (<-this.LoadMarkets())
            PanicOnError(retRes956103)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38866 := (<-this.LoadMarkets())
            PanicOnError(retRes38866)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes567126 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes567126)
                    ch <- retRes567126
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes561371 := (<-this.LoadMarkets())
            PanicOnError(retRes561371)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes30266 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes30266)
                ch <- retRes30266
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes700207 := (<-this.LoadMarkets())
            PanicOnError(retRes700207)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes290885 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes290885)
                ch <- retRes290885
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes476567 := (<-this.LoadMarkets())
            PanicOnError(retRes476567)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes456309 := (<-this.LoadMarkets())
            PanicOnError(retRes456309)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes367272 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes367272)
                    ch <- retRes367272
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451269 := (<-this.LoadMarkets())
            PanicOnError(retRes451269)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes361259 := (<-this.LoadMarkets())
            PanicOnError(retRes361259)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes880069 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes880069)
                ch <- retRes880069
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes876751 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes876751)
                ch <- retRes876751
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes866986 := (<-this.LoadMarkets())
            PanicOnError(retRes866986)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes995900 := (<-this.LoadMarkets())
            PanicOnError(retRes995900)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999425 := (<-this.LoadMarkets())
            PanicOnError(retRes999425)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes693912 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes693912)
                ch <- retRes693912
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes656208 := (<-this.LoadMarkets())
            PanicOnError(retRes656208)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes676094 := (<-this.LoadMarkets())
            PanicOnError(retRes676094)
