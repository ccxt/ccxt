...
func (this *Woofipro) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	listRecv3693, _ := PanicOnError((<-this.GetAssetHistoryRowsAsync(code, since, limit, params))).([]any)
	var currencyRows []any = listRecv3693
...
func (this *Woofipro) fetchDepositsWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	listRecv3848, _ := PanicOnError((<-this.GetAssetHistoryRowsAsync(code, since, limit, this.Extend(request, params)))).([]any)
	var currencyRows []any = listRecv3848
	var currency any = this.SafeValue(currencyRows, 0)
...
func (this *Woofipro) HandleErrors(httpCode any, reason any, url any, method any, headers any, body string, response any, requestHeaders any, requestBody any) any {
	if response == nil {
