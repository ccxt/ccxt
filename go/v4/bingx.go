...
func (this *BingxCore) ParseMarket(market any) any {
	...
	var minTickSize any = DerefScalar(this.SafeNumber(market, "minTickSize"))
	if !IsEqual(minTickSize, nil) {
		// inverse swap market
		currency = baseId
		checkIsInverse = true
		checkIsLinear = false
	...
	var contractSize any = Ternary(EvalTruthy((swap)), this.ParseNumber("1"), nil)
...
func (this *BingxCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes119019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
...
func (this *BingxCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if (!IsEqual(market, nil)) && (IsEqual(GetValue(market, "swap"), true)) && (InOp(trade, "volume")) {
		if IsEqual(GetValue(market, "linear"), true) {
			...
			var contractSize *string = this.SafeString(GetValue(market, "info"), "tradeMinQuantity")
			var volume *string = this.SafeString(trade, "volume")
...
func (this *BingxCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes184019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *BingxCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes190819 := (<-this.FetchPaginatedCallDeterministic("fetchFundingHistory", symbol, since, limit, "24h", params))
...
func (this *BingxCore) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
	...
	retRes307115 := (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
...
func (this *BingxCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes308515 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *BingxCore) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes309915 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
	PanicOnError(retRes309915)
	ch <- retRes309915
	return nil
}
...
func (this *BingxCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes337312 := (<-this.LoadMarkets())
		PanicOnError(retRes337312)
	}
	var market any = this.Market(symbol)
...
func (this *BingxCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes403412 := (<-this.LoadMarkets())
		PanicOnError(retRes403412)
	}
...
func (this *BingxCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes532619 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
...
func (this *BingxCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsEqual(subType, "inverse") {
		...
		retRes575519 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes575519)
		ch <- retRes575519
		return nil
	} else {

		retRes575719 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func (this *BingxCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes576515 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func (this *BingxCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes577215 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func (this *BingxCore) setMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes579412 := (<-this.LoadMarkets())
		PanicOnError(retRes579412)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BingxCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(market, "inverse"), true) {
		...
		retRes596819 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes596819)
		ch <- retRes596819
		return nil
	} else {

		retRes598619 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func (this *BingxCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes645112 := (<-this.LoadMarkets())
		PanicOnError(retRes645112)
	}
	var market any = this.Market(symbol)
...
func (this *BingxCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes652512 := (<-this.LoadMarkets())
		PanicOnError(retRes652512)
	}
	var defaultRecvWindow *int64 = this.SafeInteger(this.Options, "recvWindow")
	var recvWindow *int64 = this.SafeInteger(params, "recvWindow", defaultRecvWindow)
	var marketType any = nil
...
func (this *BingxCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if !IsEqual(symbol, nil) {
		...
		retRes663112 := (<-this.LoadMarkets())
		PanicOnError(retRes663112)
		market = this.Market(symbol)
	}
	var subType any = nil
	...
	retRes665615 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func (this *BingxCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes669212 := (<-this.LoadMarkets())
		PanicOnError(retRes669212)
	}
	var market any = this.Market(symbol)
	var request any = this.CreateOrderRequest(symbol, typeVar, side, amount, price, params)
