...
func (this *Bingx) ParseMarket(market any) any {
	...
	var typeVar string = Ternary((settle != nil), "swap", "spot").(string)
	...
	if swap {
		contractSize = Ternary(EvalTruthy((checkIsInverse)), inverseContractSize, this.ParseNumber("1"))
	}
	...
	var isInverse any = Ternary(EvalTruthy((spot)), nil, checkIsInverse)
	var isLinear any = Ternary(EvalTruthy((spot)), nil, checkIsLinear)
...
func (this *Bingx) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var maxLimit int = Ternary((IsEqual(GetValue(market, "inverse"), true)), 1000, 1440).(int)
	...
	var requestLimit any = Ternary((IsEqual(limit, nil)), 500, mathMin(limit, maxLimit))
...
func (this *Bingx) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if !IsEqual(limit, nil) {
		var maxLimit int = Ternary((IsEqual(marketType, "spot")), 500, 1000).(int)
...
func (this *Bingx) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if (isBuyerMaker != nil) || (m != nil) {
		takeOrMaker = Ternary(isMakerSide, "maker", "taker")
	}
	var side any = this.SafeStringLower2(trade, "side", "S")
	if IsEqual(side, nil) {
		if (isBuyerMaker != nil) || (m != nil) {
			side = Ternary(isMakerSide, "sell", "buy")
			takeOrMaker = "taker"
		}
	}
	...
	if isMaker != nil {
		takeOrMaker = Ternary((isMaker != nil && *isMaker), "maker", "taker")
	}
...
func (this *Bingx) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes186419 := (<-this.FetchPaginatedCallDeterministicAsync("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *Bingx) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes192812 := (<-this.LoadMarketsAsync())
	...
	subType = GetValue(subTypeparamsVariable, 0)
	params = GetValue(subTypeparamsVariable, 1)
	var isInverse any = Ternary((!IsEqual(market, nil)), (IsEqual(GetValue(market, "inverse"), true)), (IsEqual(subType, "inverse")))
	...
	if EvalTruthy(paginate) {
		...
		retRes194319 := (<-this.FetchPaginatedCallDeterministicAsync("fetchFundingHistory", symbol, since, limit, "24h", params))
		PanicOnError(retRes194319)
		ch <- retRes194319
		return nil
	}
	var request map[string]any = map[string]any{
...
func (this *Bingx) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var openInterestAmount any = Ternary(isInverse, openInterest, nil)
	var openInterestValue any = Ternary(isInverse, nil, openInterest)
...
func (this *Bingx) fetchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes225712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchMarkPricesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes231812 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var typeVar string = Ternary((lastQty == nil), "spot", "swap").(string)
...
func (this *Bingx) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes248712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchPositionHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes272712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes279412 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) ParsePosition(position any, optionalArgs ...any) any {
	...
	if isolated != nil {
		marginMode = Ternary((isolated != nil && *isolated), "isolated", "cross")
	}
...
func (this *Bingx) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
	...
	retRes310415 := (<-this.CreateOrderAsync(symbol, "market", side, cost, nil, params))
...
func (this *Bingx) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes311815 := (<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))
...
func (this *Bingx) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes313215 := (<-this.CreateOrderAsync(symbol, "market", "sell", cost, nil, params))
...
func (this *Bingx) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var exchangeClientOrderId string = Ternary(isSpot, "newClientOrderId", "clientOrderID").(string)
	...
	if (IsEqual(postOnly, true)) || (timeInForce != nil && *timeInForce == "PostOnly") {
	...
	if isSpot {
		...
		if triggerPrice != nil {
			...
			var stopTakePrice any = Ternary((stopLossPrice != nil), stopLossPrice, takeProfitPrice)
			if IsEqual(typeVar, "LIMIT") {
		...
		if isTwapOrder {
			var twapRequest map[string]any = map[string]any{
				...
				"positionSide": Ternary((IsEqual(side, "buy")), "LONG", "SHORT"),
...
func (this *Bingx) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes341812 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes355212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes355212)
	}
...
func (this *Bingx) ParseOrder(order any, optionalArgs ...any) any {
	...
	var marketType string = Ternary((positionSide == nil), "spot", "swap").(string)
	...
	if IsEqual(feeCurrencyCode, nil) {
		if IsEqual(GetValue(market, "spot"), true) {
			...
			feeCurrencyCode = Ternary((IsEqual(GetValue(market, "inverse"), true)), GetValue(market, "settle"), GetValue(market, "quote"))
		}
	}
	...
	if !IsEqual(stopPrice, nil) {
		if (IsGreaterThan(GetIndexOf(rawType, "stop"), OpNeg(1))) && (IsEqual(stopLossPrice, nil)) {
			stopLossPrice = stopPrice
			triggerPrice = nil
		}
		if (IsGreaterThan(GetIndexOf(rawType, "take"), OpNeg(1))) && (IsEqual(takeProfitPrice, nil)) {
...
func (this *Bingx) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes408312 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes426512 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes441712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes441712)
	}
	var market any = this.Market(symbol)
	if IsEqual(GetValue(market, "inverse"), true) {
	...
	var response any = nil
	if IsEqual(GetValue(market, "spot"), true) {
		var spotReqKey string = Ternary(areClientOrderIds, "clientOrderIDs", "orderIds").(string)
...
func (this *Bingx) cancelAllOrdersAfterBody(ch chan any, timeout any, optionalArgs ...any) any {
	...
	var request map[string]any = map[string]any{
		"type":    Ternary(EvalTruthy((isActive)), "ACTIVATE", "CLOSE"),
		"timeOut": Ternary(EvalTruthy((isActive)), (this.ParseToInt(Divide(timeout, 1000))), 0),
	}
	var response any = nil
	var typeVar any = nil
...
func (this *Bingx) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes457812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes457812)
	}
	var isTwapOrder *bool = this.SafeBool(params, "twap", false)
	params = this.Omit(params, "twap")
	var response any = nil
...
func (this *Bingx) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes504012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes504012)
	}
...
func (this *Bingx) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes506412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes506412)
	}
...
func (this *Bingx) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes509012 := (<-this.LoadMarketsAsync())
	...
	if EvalTruthy(standard) {
		...
		if isTwapOrder != nil && *isTwapOrder == true {
			...
			AddElementToObject(request, "pageSize", Ternary((IsEqual(limit, nil)), 100, limit))
			AddElementToObject(request, "startTime", Ternary((IsEqual(since, nil)), 1, since))
...
func (this *Bingx) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes528212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes528212)
	}
...
func (this *Bingx) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes535412 := (<-this.LoadMarketsAsync())
	...
	if EvalTruthy(paginate) {
		...
		retRes538019 := (<-this.FetchPaginatedCallDynamicAsync("fetchTransfers", code, since, limit, params, maxLimit))
...
func (this *Bingx) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes556712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes561812 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var dataId any = Ternary((IsEqual(data, nil)), nil, this.SafeString(data, "id"))
	...
	if (!IsEqual(code, nil)) && (network != nil) && (!IsEqual(code, network)) && IsGreaterThanOrEqual(GetIndexOf(code, network), 0) {
		if network != nil {
			code = Replace(code, network, "")
		}
	}
	var rawType *string = this.SafeString(transaction, "transferType")
	var typeVar string = Ternary((rawType != nil && *rawType == "0"), "deposit", "withdrawal").(string)
	return map[string]any{
		"info":        transaction,
		"id":          id,
...
func (this *Bingx) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes579012 := (<-this.LoadMarketsAsync())
	...
	if IsEqual(subType, "inverse") {
		...
		retRes581019 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes581019)
		ch <- retRes581019
		return nil
	} else {

		retRes581219 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes581219)
		ch <- retRes581219
		return nil
	}
}
...
func (this *Bingx) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes582015 := (<-this.SetMarginAsync(symbol, amount, this.Extend(request, params)))
	PanicOnError(retRes582015)
	ch <- retRes582015
	return nil
}
...
func (this *Bingx) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes582715 := (<-this.SetMarginAsync(symbol, amount, this.Extend(request, params)))
...
func (this *Bingx) setMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes584912 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	return map[string]any{
		...
		"type":       Ternary((typeVar != nil && *typeVar == "1"), "add", "reduce"),
		"marginMode": "isolated",
...
func (this *Bingx) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes590512 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes601412 := (<-this.LoadMarketsAsync())
	...
	if IsEqual(GetValue(market, "inverse"), true) {
		...
		retRes602319 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes602319)
		ch <- retRes602319
		return nil
	} else {

		retRes604119 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func (this *Bingx) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(subType, "inverse") {
		...
		if !IsEqual(since, nil) {
			var startTimeReq string = Ternary((IsEqual(GetValue(market, "spot"), true)), "startTime", "startTs").(string)
		...
		params = this.Omit(params, "until")
		if until != nil {
			var endTimeReq string = Ternary((IsEqual(GetValue(market, "spot"), true)), "endTime", "endTs").(string)
...
func (this *Bingx) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes625012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes625012)
	}
...
func (this *Bingx) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes628212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes628212)
	}
	var currency any = this.Currency(code)
...
func (this *Bingx) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes636112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes636112)
	}
	var request any = map[string]any{
...
func (this *Bingx) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes650612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes650612)
	}
	var market any = this.Market(symbol)
...
func (this *Bingx) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes658012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes658012)
	}
	var defaultRecvWindow *int64 = this.SafeInteger(this.Options, "recvWindow")
	var recvWindow *int64 = this.SafeInteger(params, "recvWindow", defaultRecvWindow)
	var marketType any = nil
...
func (this *Bingx) fetchPositionModeBody(ch chan any, optionalArgs ...any) any {
	...
	if !IsEqual(symbol, nil) {
		...
		retRes664612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes664612)
		market = this.Market(symbol)
	}
	var subType any = nil
...
func (this *Bingx) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if !IsEqual(symbol, nil) {
		...
		retRes668612 := (<-this.LoadMarketsAsync())
	...
	retRes671115 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
	PanicOnError(retRes671115)
	//
	//     {
	//         code: '0',
	//         msg: '',
...
func (this *Bingx) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes674712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes686912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes686912)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *Bingx) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes693112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes693112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *Bingx) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes705812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes705812)
	}
	var market any = this.Market(symbol)
	if !IsEqual(GetValue(market, "swap"), true) {
...
func (this *Bingx) Sign(path any, optionalArgs ...any) any {
	...
	if (isSandbox != nil && *isSandbox == true) && IsEqual(url, nil) {
	...
	if IsEqual(access, "public") {
		...
		var encodeRequestSafe any = Ternary((IsEqual(encodeRequest, nil)), "", encodeRequest)
