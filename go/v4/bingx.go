...
func (this *BingxCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes119319 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
		PanicOnError(retRes119319)
		ch <- retRes119319
		return nil
	}
...
func (this *BingxCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes184319 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *BingxCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes192219 := (<-this.FetchPaginatedCallDeterministic("fetchFundingHistory", symbol, since, limit, "24h", params))
...
func (this *BingxCore) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
	...
	retRes308315 := (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
...
func (this *BingxCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes309715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
	PanicOnError(retRes309715)
	ch <- retRes309715
	return nil
}
...
func (this *BingxCore) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes311115 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BingxCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes351612 := (<-this.LoadMarkets())
		PanicOnError(retRes351612)
	}
...
func (this *BingxCore) cancelAllOrdersAfterBody(ch chan any, timeout any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes448612 := (<-this.LoadMarkets())
		PanicOnError(retRes448612)
	}
...
func (this *BingxCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes481212 := (<-this.LoadMarkets())
		PanicOnError(retRes481212)
	}
	var market any = nil
	var request map[string]any = map[string]any{}
	if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BingxCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes500012 := (<-this.LoadMarkets())
		PanicOnError(retRes500012)
	}
...
func (this *BingxCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes502412 := (<-this.LoadMarkets())
		PanicOnError(retRes502412)
	}
...
func (this *BingxCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes534119 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
		PanicOnError(retRes534119)
		ch <- retRes534119
		return nil
	}
	if IsTrue(!IsEqual(since, nil)) {
...
func (this *BingxCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(subType, "inverse")) {
		...
		retRes577019 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes577019)
		ch <- retRes577019
		return nil
	} else {

		retRes577219 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func (this *BingxCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes578015 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func (this *BingxCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes578715 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
	PanicOnError(retRes578715)
	ch <- retRes578715
	return nil
}
...
func (this *BingxCore) setMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes580912 := (<-this.LoadMarkets())
		PanicOnError(retRes580912)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BingxCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(market, "inverse"), true)) {
		...
		retRes598319 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes598319)
		ch <- retRes598319
		return nil
	} else {

		retRes600119 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func (this *BingxCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes621012 := (<-this.LoadMarkets())
		PanicOnError(retRes621012)
	}
...
func (this *BingxCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes646612 := (<-this.LoadMarkets())
		PanicOnError(retRes646612)
	}
	var market any = this.Market(symbol)
...
func (this *BingxCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes654012 := (<-this.LoadMarkets())
		PanicOnError(retRes654012)
	}
	var defaultRecvWindow any = this.SafeInteger(this.Options, "recvWindow")
	var recvWindow any = this.SafeInteger(params, "recvWindow", defaultRecvWindow)
	var marketType any = nil
...
func (this *BingxCore) fetchPositionModeBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(!IsEqual(symbol, nil)) {
		...
		retRes660612 := (<-this.LoadMarkets())
		PanicOnError(retRes660612)
		market = this.Market(symbol)
	}
	var subType any = nil
...
func (this *BingxCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes667115 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func (this *BingxCore) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes688812 := (<-this.LoadMarkets())
		PanicOnError(retRes688812)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
