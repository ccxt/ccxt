...
func (this *BingxCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes530319 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
		PanicOnError(retRes530319)
		ch <- retRes530319
		return nil
	}
	if IsTrue(!IsEqual(since, nil)) {
...
func (this *BingxCore) fetchDepositAddressesByNetworkBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes537512 := (<-this.LoadMarkets())
		PanicOnError(retRes537512)
	}
	var currency any = this.Currency(code)
...
func (this *BingxCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes548912 := (<-this.LoadMarkets())
		PanicOnError(retRes548912)
	}
	var request any = map[string]any{}
	var currency any = nil
	if IsTrue(!IsEqual(code, nil)) {
...
func (this *BingxCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(subType, "inverse")) {
		...
		retRes573219 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes573219)
		ch <- retRes573219
		return nil
	} else {

		retRes573419 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func (this *BingxCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes574915 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func (this *BingxCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(market, "inverse"), true)) {
		...
		retRes594519 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes594519)
		ch <- retRes594519
		return nil
	} else {

		retRes596319 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func (this *BingxCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes617212 := (<-this.LoadMarkets())
		PanicOnError(retRes617212)
	}
...
func (this *BingxCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes628312 := (<-this.LoadMarkets())
		PanicOnError(retRes628312)
	}
	var request any = map[string]any{
...
func (this *BingxCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes663315 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func (this *BingxCore) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes678812 := (<-this.LoadMarkets())
		PanicOnError(retRes678812)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
