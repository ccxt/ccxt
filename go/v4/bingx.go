 ...
 */
func  (this *Bingx) FetchTime(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchCurrencies(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchCurrenciesBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var isSandbox any = DerefScalar(this.SafeBool(this.Options, "sandboxMode", false))
        if (isSandbox == true) {
...
func  (this *Bingx) FetchSpotMarkets(params any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) FetchSwapMarkets(params any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) FetchInverseSwapMarkets(params any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) ParseMarket(market any) any  {
    ...
    var typeVar any = Ternary((!IsEqual(settle, nil)), "swap", "spot")
 ...
 */
func  (this *Bingx) FetchMarkets(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var maxLimit any = Ternary((IsEqual(GetValue(market, "inverse"), true)), 1000, 1440)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes121419 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
 ...
 */
func  (this *Bingx) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if !IsEqual(limit, nil) {
            var maxLimit any = Ternary(((IsEqual(marketType, "spot"))), 500, 1000)
...
func  (this *Bingx) ParseTrade(trade any, optionalArgs ...any) any  {
    ...
    var m any = DerefScalar(this.SafeBool(trade, "m"))
    var marketId *string = this.SafeString2(trade, "s", "symbol")
    var isBuyerMaker any = DerefScalar(this.SafeBoolN(trade, []any{"buyerMaker", "isBuyerMaker", "maker"}))
    var takeOrMaker any = nil
    var isMakerSide bool = (IsEqual(isBuyerMaker, true)) || (IsEqual(m, true))
    if (!IsEqual(isBuyerMaker, nil)) || (!IsEqual(m, nil)) {
 ...
 */
func  (this *Bingx) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchFundingRate(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchFundingRates(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes186419 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
 ...
 */
func  (this *Bingx) FetchFundingHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes194319 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingHistory", symbol, since, limit, "24h", params))
 ...
 */
func  (this *Bingx) FetchOpenInterest(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) ParseOpenInterest(interest any, optionalArgs ...any) any  {
    ...
    var inverse any = DerefScalar(this.SafeBool(market, "inverse", false))
    var isInverse bool =     ((inverse == true))
 ...
 */
func  (this *Bingx) FetchTicker(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchTickers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a dictionary of [ticker structures]{@link https://docs.ccxt.com/?id=ticker-structure}
 */
func  (this *Bingx) FetchMarkPrice(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a dictionary of [ticker structures]{@link https://docs.ccxt.com/?id=ticker-structure}
 */
func  (this *Bingx) FetchMarkPrices(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) ParseTicker(ticker any, optionalArgs ...any) any  {
    ...
    var typeVar any = Ternary(((lastQty == nil)), "spot", "swap")
 ...
 */
func  (this *Bingx) FetchBalance(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchPositionHistory(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [position structures]{@link https://docs.ccxt.com/?id=position-structure}
 */
func  (this *Bingx) FetchPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) ParsePosition(position any, optionalArgs ...any) any  {
    ...
    if !IsEqual(isolated, nil) {
        marginMode = Ternary(EvalTruthy(isolated), "isolated", "cross")
    }
 ...
 */
func  (this *Bingx) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        AddElementToObject(params, "quoteOrderQty", cost)
            ...
            retRes310415 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        AddElementToObject(params, "quoteOrderQty", cost)
            ...
            retRes311815 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        AddElementToObject(params, "quoteOrderQty", cost)
            ...
            retRes313215 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func  (this *Bingx) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any  {
    ...
    var exchangeClientOrderId any = Ternary(isSpot, "newClientOrderId", "clientOrderID")
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(test) && ((!IsEqual(GetValue(market, "swap"), true)) || (IsEqual(GetValue(market, "inverse"), true))) {
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) CreateOrders(orders any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        response = (<-this.SwapV2PrivatePostTradeBatchOrders(request))
            ...
            var sync any = DerefScalar(this.SafeBool(params, "sync", false))
            if (sync == true) {
...
func  (this *Bingx) ParseOrder(order any, optionalArgs ...any) any  {
    ...
    var marketType any = Ternary(((positionSide == nil)), "spot", "swap")
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) CancelOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var isTwapOrder any = DerefScalar(this.SafeBool(params, "twap", false))
 ...
 */
func  (this *Bingx) CancelAllOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) CancelOrders(ids any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var response any = nil
        if IsEqual(GetValue(market, "spot"), true) {
            var spotReqKey any = Ternary(areClientOrderIds, "clientOrderIDs", "orderIds")
 ...
 */
func  (this *Bingx) CancelAllOrdersAfter(timeout any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) FetchOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) FetchOpenOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) FetchClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) FetchCanceledOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) FetchCanceledAndClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchTransfers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes538019 :=  (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params, maxLimit))
 ...
 */
func  (this *Bingx) FetchDepositAddressesByNetwork(code any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchDepositAddress(code any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchDeposits(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/?id=transaction-structure}
 */
func  (this *Bingx) FetchWithdrawals(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) ParseTransaction(transaction any, optionalArgs ...any) any  {
    ...
    var typeVar any = Ternary(((rawType != nil && *rawType == "0")), "deposit", "withdrawal")
    return map[string]any {
        "info": transaction,
        "id": id,
 ...
 */
func  (this *Bingx) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var request map[string]any = map[string]any {
            ...
            retRes582015 :=  (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
            PanicOnError(retRes582015)
            ch <- retRes582015
            return nil
}
func  (this *Bingx) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var request map[string]any = map[string]any {
            ...
            retRes582715 :=  (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
 ...
 */
func  (this *Bingx) SetMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchLeverage(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} response from the exchange
 */
func  (this *Bingx) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bingx) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        response = (<-this.CswapV1PrivateGetTradeAllFillOrders(this.Extend(request, params)))
            ...
            if !IsEqual(since, nil) {
                var startTimeReq any = Ternary((IsEqual(GetValue(market, "spot"), true)), "startTime", "startTs")
            ...
            params = this.Omit(params, "until")
            if (until != nil) {
                var endTimeReq any = Ternary((IsEqual(GetValue(market, "spot"), true)), "endTime", "endTs")
 ...
 */
func  (this *Bingx) FetchDepositWithdrawFees(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) Withdraw(code any, amount any, address any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchMyLiquidations(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) ClosePosition(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} [a list of position structures]{@link https://docs.ccxt.com/?id=position-structure}
 */
func  (this *Bingx) CloseAllPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchPositionMode(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} response from the exchange
 */
func  (this *Bingx) SetPositionMode(hedged any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bingx) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchMarginMode(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchTradingFee(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bingx) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bingx) Sign(path any, optionalArgs ...any) any  {
    ...
    if ((isSandbox == true)) && IsEqual(url, nil) {
...
func (this *Bingx) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Bingx) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
...
func (this *Bingx) FetchStatus(params ...any) (Status, error) {return this.exchangeTyped.FetchStatus(params...)}
...
func (this *Bingx) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Bingx) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
