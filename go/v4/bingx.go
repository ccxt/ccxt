...
func (this *BingxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes117719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1440))
...
func (this *BingxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes179819 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *BingxCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes187119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingHistory", symbol, since, limit, "24h", params))
...
func (this *BingxCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes302615 := (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
		PanicOnError(retRes302615)
		ch <- retRes302615
		return nil
...
func (this *BingxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes304015 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes304015)
		ch <- retRes304015
		return nil
...
func (this *BingxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes305415 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BingxCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes397812 := (<-this.LoadMarkets())
			PanicOnError(retRes397812)
		}
...
func (this *BingxCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes431212 := (<-this.LoadMarkets())
			PanicOnError(retRes431212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BingxCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes446412 := (<-this.LoadMarkets())
			PanicOnError(retRes446412)
		}
		var isTwapOrder any = this.SafeBool(params, "twap", false)
		params = this.Omit(params, "twap")
		var response any = nil
...
func (this *BingxCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes516812 := (<-this.LoadMarkets())
			PanicOnError(retRes516812)
		}
...
func (this *BingxCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes523212 := (<-this.LoadMarkets())
			PanicOnError(retRes523212)
		}
		var request any = map[string]any{}
		...
		if IsTrue(paginate) {
			...
			retRes525819 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
...
func (this *BingxCore) FetchDepositAddressesByNetwork(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes533012 := (<-this.LoadMarkets())
			PanicOnError(retRes533012)
		}
		var currency any = this.Currency(code)
...
func (this *BingxCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes565412 := (<-this.LoadMarkets())
			PanicOnError(retRes565412)
		}
		var market any = this.Market(symbol)
		...
		if IsTrue(IsEqual(subType, "inverse")) {
			...
			retRes567419 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
			PanicOnError(retRes567419)
			ch <- retRes567419
			return nil
		} else {

			retRes567619 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func (this *BingxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes568415 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
		PanicOnError(retRes568415)
		ch <- retRes568415
		return nil
...
func (this *BingxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes569115 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
...
func (this *BingxCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes576912 := (<-this.LoadMarkets())
			PanicOnError(retRes576912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BingxCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "inverse")) {
			...
			retRes588619 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
			PanicOnError(retRes588619)
			ch <- retRes588619
			return nil
		} else {

			retRes590419 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func (this *BingxCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes622412 := (<-this.LoadMarkets())
			PanicOnError(retRes622412)
		}
		var request any = map[string]any{
...
func (this *BingxCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes655115 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func (this *BingxCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes689512 := (<-this.LoadMarkets())
			PanicOnError(retRes689512)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
