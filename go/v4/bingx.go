...
func (this *BingxCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if !IsEqual(limit, nil) {
		var maxLimit any = Ternary((marketType == "spot"), 500, 1000)
...
func (this *BingxCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes183619 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *BingxCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes190419 := (<-this.FetchPaginatedCallDeterministic("fetchFundingHistory", symbol, since, limit, "24h", params))
...
func (this *BingxCore) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
	...
	retRes306715 := (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
...
func (this *BingxCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes308115 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *BingxCore) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes309515 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BingxCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var isTwapOrder bool = (typeVar == "TWAP")
	...
	if isSpot {
		...
		if triggerPrice != nil {
			if isMarketOrder && (side == "buy") && (this.SafeString(request, "quoteOrderQty") == nil) {
		...
		if isTwapOrder {
			var twapRequest map[string]any = map[string]any{
				...
				"positionSide": Ternary((side == "buy"), "LONG", "SHORT"),
		...
		if hedged == true {
			...
			if reduceOnly == true {
				positionSide = Ternary((side == "buy"), "SHORT", "LONG")
			} else {
				positionSide = Ternary((side == "buy"), "LONG", "SHORT")
			}
		} else {
...
func (this *BingxCore) cancelAllOrdersAfterBody(ch chan any, timeout any, optionalArgs ...any) any {
	...
	subType = GetValue(subTypeparamsVariable, 0)
	params = GetValue(subTypeparamsVariable, 1)
	if (typeVar == "swap") && (IsEqual(subType, "inverse")) {
...
func (this *BingxCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes498412 := (<-this.LoadMarkets())
		PanicOnError(retRes498412)
	}
...
func (this *BingxCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes500812 := (<-this.LoadMarkets())
		PanicOnError(retRes500812)
	}
...
func (this *BingxCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes522612 := (<-this.LoadMarkets())
		PanicOnError(retRes522612)
	}
...
func (this *BingxCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes529612 := (<-this.LoadMarkets())
		PanicOnError(retRes529612)
	}
	var request any = map[string]any{}
	...
	if EvalTruthy(paginate) {
		...
		retRes532219 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", nil, since, limit, params, maxLimit))
		PanicOnError(retRes532219)
		ch <- retRes532219
		return nil
	}
	if !IsEqual(since, nil) {
...
func (this *BingxCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsEqual(subType, "inverse") {
		...
		retRes575119 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes575119)
		ch <- retRes575119
		return nil
	} else {

		retRes575319 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func (this *BingxCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes576115 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
	PanicOnError(retRes576115)
	ch <- retRes576115
	return nil
}
...
func (this *BingxCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes576815 := (<-this.SetMargin(symbol, amount, this.Extend(request, params)))
	PanicOnError(retRes576815)
	ch <- retRes576815
	return nil
}
...
func (this *BingxCore) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes584612 := (<-this.LoadMarkets())
		PanicOnError(retRes584612)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BingxCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(market, "inverse"), true) {
		...
		retRes596419 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes596419)
		ch <- retRes596419
		return nil
	} else {

		retRes598219 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes598219)
		ch <- retRes598219
		return nil
	}
}
...
func (this *BingxCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes619112 := (<-this.LoadMarkets())
		PanicOnError(retRes619112)
	}
...
func (this *BingxCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes644712 := (<-this.LoadMarkets())
		PanicOnError(retRes644712)
	}
	var market any = this.Market(symbol)
...
func (this *BingxCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes652112 := (<-this.LoadMarkets())
		PanicOnError(retRes652112)
	}
	var defaultRecvWindow *int64 = this.SafeInteger(this.Options, "recvWindow")
	var recvWindow *int64 = this.SafeInteger(params, "recvWindow", defaultRecvWindow)
	var marketType any = nil
...
func (this *BingxCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes665215 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func (this *BingxCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes668812 := (<-this.LoadMarkets())
		PanicOnError(retRes668812)
	}
	var market any = this.Market(symbol)
	var request any = this.CreateOrderRequest(symbol, typeVar, side, amount, price, params)
...
func (this *BingxCore) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes699612 := (<-this.LoadMarkets())
		PanicOnError(retRes699612)
	}
	var market any = this.Market(symbol)
	if !IsEqual(GetValue(market, "swap"), true) {
