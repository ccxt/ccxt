...
func (this *Bingx) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes187719 := (<-this.FetchPaginatedCallDeterministicAsync("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *Bingx) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes194112 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes195619 := (<-this.FetchPaginatedCallDeterministicAsync("fetchFundingHistory", symbol, since, limit, "24h", params))
...
func (this *Bingx) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes203412 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes213512 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes220112 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchPositionHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes274012 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes280712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes290512 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
	...
	retRes311715 := (<-this.CreateOrderAsync(symbol, "market", side, cost, nil, params))
...
func (this *Bingx) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes313115 := (<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))
...
func (this *Bingx) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes314515 := (<-this.CreateOrderAsync(symbol, "market", "sell", cost, nil, params))
	PanicOnError(retRes314515)
	ch <- retRes314515
	return nil
}
...
func (this *Bingx) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes356512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes356512)
	}
...
func (this *Bingx) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes409612 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes427812 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes459112 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes477012 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes486512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes486512)
	}
	var market any = nil
	var request map[string]any = map[string]any{}
	if symbol != nil {
...
func (this *Bingx) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes507712 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes510312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes510312)
	}
	var market any = nil
	var request map[string]any = map[string]any{}
	if symbol != nil {
...
func (this *Bingx) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes529512 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes536712 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes539319 := (<-this.FetchPaginatedCallDynamicAsync("fetchTransfers", code, since, limit, params, maxLimit))
		PanicOnError(retRes539319)
		ch <- retRes539319
		return nil
	}
...
func (this *Bingx) fetchDepositAddressesByNetworkBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes546612 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes563112 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes580312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes580312)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	...
	if IsEqual(subType, "inverse") {
		...
		retRes582319 := (<-this.CswapV1PrivatePostTradeMarginType(this.Extend(request, params)))
		PanicOnError(retRes582319)
		ch <- retRes582319
		return nil
	} else {

		retRes582519 := (<-this.SwapV2PrivatePostTradeMarginType(this.Extend(request, params)))
...
func (this *Bingx) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes583315 := (<-this.SetMarginAsync(symbol, amount, this.Extend(request, params)))
...
func (this *Bingx) setMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes586212 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes591812 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes602712 := (<-this.LoadMarketsAsync())
	...
	if GetValue(market, "inverse") == true {
		...
		retRes603619 := (<-this.CswapV1PrivatePostTradeLeverage(this.Extend(request, params)))
		PanicOnError(retRes603619)
		ch <- retRes603619
		return nil
	} else {

		retRes605419 := (<-this.SwapV2PrivatePostTradeLeverage(this.Extend(request, params)))
...
func (this *Bingx) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes609512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes609512)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{}
	var fills any = nil
...
func (this *Bingx) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes626312 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes629512 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes637412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes637412)
	}
	var request any = map[string]any{
...
func (this *Bingx) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes659312 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchPositionModeBody(ch chan any, optionalArgs ...any) any {
	...
	if symbol != nil {
		...
		retRes665912 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if symbol != nil {
		...
		retRes669912 := (<-this.LoadMarketsAsync())
	...
	retRes672415 := (<-this.SwapV1PrivatePostPositionSideDual(this.Extend(request, params)))
...
func (this *Bingx) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes676012 := (<-this.LoadMarketsAsync())
...
func (this *Bingx) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes688212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes688212)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Bingx) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes694412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes694412)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Bingx) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes707112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes707112)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	if GetValue(market, "swap") != true {
