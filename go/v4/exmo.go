...
func (this *ExmoCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes36415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *ExmoCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes37815 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *ExmoCore) FetchTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchPrivateTradingFees")) {
			...
			retRes39619 := (<-this.FetchPrivateTradingFees(params))
			PanicOnError(retRes39619)
			ch <- retRes39619
			return nil
		}

		retRes39815 := (<-this.FetchPublicTradingFees(params))
		PanicOnError(retRes39815)
		ch <- retRes39815
		return nil
...
func (this *ExmoCore) FetchPublicTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes45912 := (<-this.LoadMarkets())
			PanicOnError(retRes45912)
		}
...
func (this *ExmoCore) FetchTransactionFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes52812 := (<-this.LoadMarkets())
			PanicOnError(retRes52812)
		}
