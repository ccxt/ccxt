...
func (this *GateCore) upgradeUnifiedTradeAccountBody(ch chan any, optionalArgs ...any) any {
	...
	retRes121115 := (<-this.PrivateUnifiedPutUnifiedMode(params))
	PanicOnError(retRes121115)
	ch <- retRes121115
	return nil
}
...
func (this *GateCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true)) {
		...
		retRes132012 := (<-this.LoadTimeDifference())
		PanicOnError(retRes132012)
	}
	if IsTrue(this.CheckRequiredCredentials(false)) {

		retRes132312 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes132312)
	}
...
func (this *GateCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes312612 := (<-this.LoadMarkets())
		PanicOnError(retRes312612)
	}

	retRes31288 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes342219 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
		PanicOnError(retRes342219)
		ch <- retRes342219
		return nil
	}
	if IsTrue(IsEqual(GetValue(market, "option"), true)) {

		retRes342519 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
		PanicOnError(retRes342519)
		ch <- retRes342519
		return nil
	}
...
func (this *GateCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes351119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *GateCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes361812 := (<-this.LoadMarkets())
		PanicOnError(retRes361812)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes362319 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
		PanicOnError(retRes362319)
		ch <- retRes362319
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *GateCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes378612 := (<-this.LoadMarkets())
		PanicOnError(retRes378612)
	}

	retRes37888 := (<-this.LoadUnifiedStatus())
	...
	if IsTrue(paginate) {
		...
		retRes379219 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
		PanicOnError(retRes379219)
		ch <- retRes379219
		return nil
	}
	var typeVar any = nil
...
func (this *GateCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes408919 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
		PanicOnError(retRes408919)
		ch <- retRes408919
		return nil
	}
	var request any = map[string]any{}
...
func (this *GateCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes412512 := (<-this.LoadMarkets())
		PanicOnError(retRes412512)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes413019 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
		PanicOnError(retRes413019)
		ch <- retRes413019
		return nil
	}
	var request any = map[string]any{}
...
func (this *GateCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes437412 := (<-this.LoadMarkets())
		PanicOnError(retRes437412)
	}

	retRes43768 := (<-this.LoadUnifiedStatus())
	PanicOnError(retRes43768)
	var market any = this.Market(symbol)
...
func (this *GateCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes452412 := (<-this.LoadMarkets())
		PanicOnError(retRes452412)
	}

	retRes45268 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes481112 := (<-this.LoadMarkets())
		PanicOnError(retRes481112)
	}

	retRes48138 := (<-this.LoadUnifiedStatus())
	PanicOnError(retRes48138)
	var market any = this.Market(symbol)
	if IsTrue(!IsEqual(GetValue(market, "spot"), true)) {
	...
	retRes481915 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *GateCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes488212 := (<-this.LoadMarkets())
		PanicOnError(retRes488212)
	}

	retRes48848 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes534312 := (<-this.LoadMarkets())
		PanicOnError(retRes534312)
	}
...
func (this *GateCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes539415 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
	PanicOnError(retRes539415)
	ch <- retRes539415
	return nil
}
...
func (this *GateCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes54258 := (<-this.LoadUnifiedStatus())
	...
	if IsTrue(paginate) {
		...
		retRes543019 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
		PanicOnError(retRes543019)
	...
	if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
		...
		retRes544319 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
...
func (this *GateCore) fetchOrdersByStatusBody(ch chan any, status any, optionalArgs ...any) any {
	...
	retRes55068 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes572812 := (<-this.LoadMarkets())
		PanicOnError(retRes572812)
	}

	retRes57308 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes585912 := (<-this.LoadMarkets())
		PanicOnError(retRes585912)
	}

	retRes58618 := (<-this.LoadUnifiedStatus())
	PanicOnError(retRes58618)
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
		market = this.Market(symbol)
	}
	...
	if IsTrue(isSpot) {
		...
		retRes588419 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
		PanicOnError(retRes588419)
		ch <- retRes588419
		return nil
	}
	var request map[string]any = map[string]any{
...
func (this *GateCore) cancelOrdersForSymbolsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	retRes59128 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes595812 := (<-this.LoadMarkets())
		PanicOnError(retRes595812)
	}

	retRes59608 := (<-this.LoadUnifiedStatus())
	PanicOnError(retRes59608)
	var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func (this *GateCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes603612 := (<-this.LoadMarkets())
		PanicOnError(retRes603612)
	}
	var currency any = this.Currency(code)
...
func (this *GateCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes612912 := (<-this.LoadMarkets())
		PanicOnError(retRes612912)
	}
	var market any = this.Market(symbol)
	requestqueryVariable := this.PrepareRequest(market, nil, params)
	request := GetValue(requestqueryVariable, 0)
...
func (this *GateCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes634312 := (<-this.LoadMarkets())
		PanicOnError(retRes634312)
	}
	var market any = this.Market(symbol)
	if IsTrue(!IsEqual(GetValue(market, "contract"), true)) {
...
func (this *GateCore) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes667112 := (<-this.LoadMarkets())
		PanicOnError(retRes667112)
	}
	var market any = this.Market(symbol)
...
func (this *GateCore) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes677912 := (<-this.LoadMarkets())
		PanicOnError(retRes677912)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
...
func (this *GateCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	retRes68138 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes691012 := (<-this.LoadMarkets())
		PanicOnError(retRes691012)
	}

	retRes69128 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	retRes70198 := (<-this.LoadUnifiedStatus())
	PanicOnError(retRes70198)
	var isUnifiedAccount any = false
...
func (this *GateCore) modifyMarginHelperBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes717512 := (<-this.LoadMarkets())
		PanicOnError(retRes717512)
	}
	var market any = this.Market(symbol)
	requestqueryVariable := this.PrepareRequest(market, nil, params)
	request := GetValue(requestqueryVariable, 0)
...
func (this *GateCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes724815 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
...
func (this *GateCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes726315 := (<-this.ModifyMarginHelper(symbol, amount, params))
	PanicOnError(retRes726315)
	ch <- retRes726315
	return nil
}
...
func (this *GateCore) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes728619 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *GateCore) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes737412 := (<-this.LoadMarkets())
		PanicOnError(retRes737412)
	}
	var market any = this.Market(symbol)
	var typeVar any = nil
...
func (this *GateCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes761219 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *GateCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes784815 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
	PanicOnError(retRes784815)
	ch <- retRes784815
	return nil
}
...
func (this *GateCore) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes786212 := (<-this.LoadMarkets())
		PanicOnError(retRes786212)
	}
	var marketType any = nil
...
func (this *GateCore) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes790712 := (<-this.LoadMarkets())
		PanicOnError(retRes790712)
	}
	var market any = this.Market(symbol)
	if IsTrue(!IsEqual(GetValue(market, "swap"), true)) {
...
func (this *GateCore) fetchGreeksBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes811512 := (<-this.LoadMarkets())
		PanicOnError(retRes811512)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *GateCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes822415 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
	PanicOnError(retRes822415)
	ch <- retRes822415
	return nil
}
...
func (this *GateCore) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes824012 := (<-this.LoadMarkets())
		PanicOnError(retRes824012)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *GateCore) fetchLeveragesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes834812 := (<-this.LoadMarkets())
		PanicOnError(retRes834812)
	}
	symbols = this.MarketSymbols(symbols)
	var response any = nil
	var isUnified any = this.SafeBool(params, "unified")
...
func (this *GateCore) fetchOptionChainBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes847412 := (<-this.LoadMarkets())
		PanicOnError(retRes847412)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
...
func (this *GateCore) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes861112 := (<-this.LoadMarkets())
		PanicOnError(retRes861112)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
		var symbolsLength int = GetArrayLength(symbols)
