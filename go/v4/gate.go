...
func (this *GateCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes30618 := (<-this.LoadMarkets())
		PanicOnError(retRes30618)

		retRes30628 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes335919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
		...
		if IsTrue(GetValue(market, "option")) {
			...
			retRes336219 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
...
func (this *GateCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes34408 := (<-this.LoadMarkets())
		PanicOnError(retRes34408)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes344419 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *GateCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes355419 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes355419)
			ch <- retRes355419
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes37148 := (<-this.LoadMarkets())
		PanicOnError(retRes37148)

		retRes37158 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes37158)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes371919 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *GateCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes401419 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes401419)
			ch <- retRes401419
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes40498 := (<-this.LoadMarkets())
		PanicOnError(retRes40498)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes405319 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes405319)
			ch <- retRes405319
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes42958 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes44438 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47228 := (<-this.LoadUnifiedStatus())
		...
		retRes472815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *GateCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47918 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes47918)
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes52498 := (<-this.LoadMarkets())
		PanicOnError(retRes52498)

		retRes52508 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes529915 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes529915)
		ch <- retRes529915
		return nil
...
func (this *GateCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53268 := (<-this.LoadMarkets())
		PanicOnError(retRes53268)

		retRes53278 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes53278)
		var until any = this.SafeInteger(params, "until")
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes533919 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
			PanicOnError(retRes533919)
			ch <- retRes533919
			return nil
		}
...
func (this *GateCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53998 := (<-this.LoadMarkets())
		PanicOnError(retRes53998)

		retRes54008 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes56208 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57498 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes57498)
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
		...
		if IsTrue(isSpot) {
			...
			retRes577219 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
...
func (this *GateCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57988 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes58448 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes64178 := (<-this.LoadMarkets())
		PanicOnError(retRes64178)
...
func (this *GateCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66748 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67238 := (<-this.LoadMarkets())
		PanicOnError(retRes67238)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67698 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes67698)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes68738 := (<-this.LoadMarkets())
		PanicOnError(retRes68738)

		retRes68748 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) ModifyMarginHelper(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes70298 := (<-this.LoadMarkets())
		PanicOnError(retRes70298)
		var market any = this.Market(symbol)
		requestqueryVariable := this.PrepareRequest(market, nil, params)
		request := GetValue(requestqueryVariable, 0)
		query := GetValue(requestqueryVariable, 1)
...
func (this *GateCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes710115 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
...
func (this *GateCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes711615 := (<-this.ModifyMarginHelper(symbol, amount, params))
		PanicOnError(retRes711615)
		ch <- retRes711615
		return nil
...
func (this *GateCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes713719 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
			PanicOnError(retRes713719)
			ch <- retRes713719
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes72738 := (<-this.LoadMarkets())
		PanicOnError(retRes72738)
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
			symbol = GetValue(market, "symbol")
...
func (this *GateCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes745719 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes745719)
			ch <- retRes745719
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes769315 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
...
func (this *GateCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes805815 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes805815)
		ch <- retRes805815
		return nil
...
func (this *GateCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes81798 := (<-this.LoadMarkets())
		PanicOnError(retRes81798)
		symbols = this.MarketSymbols(symbols)
		var response any = nil
		var isUnified any = this.SafeBool(params, "unified")
		params = this.Omit(params, "unified")
