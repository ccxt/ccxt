...
func (this *GateCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes542212 := (<-this.LoadMarkets())
			PanicOnError(retRes542212)
		}

		retRes54248 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(paginate) {
			...
			retRes542919 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes544219 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
			PanicOnError(retRes544219)
			ch <- retRes544219
			return nil
		}
...
func (this *GateCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes55058 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes572512 := (<-this.LoadMarkets())
			PanicOnError(retRes572512)
		}

		retRes57278 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes57278)
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func (this *GateCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes58588 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(isSpot) {
			...
			retRes588119 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
...
func (this *GateCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59098 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59578 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes634012 := (<-this.LoadMarkets())
			PanicOnError(retRes634012)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "contract")) {
...
func (this *GateCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes666812 := (<-this.LoadMarkets())
			PanicOnError(retRes666812)
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes677612 := (<-this.LoadMarkets())
			PanicOnError(retRes677612)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *GateCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes68108 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes690712 := (<-this.LoadMarkets())
			PanicOnError(retRes690712)
		}

		retRes69098 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes69098)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes701412 := (<-this.LoadMarkets())
			PanicOnError(retRes701412)
		}

		retRes70168 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes70168)
		var isUnifiedAccount any = false
...
func (this *GateCore) ModifyMarginHelper(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes717212 := (<-this.LoadMarkets())
			PanicOnError(retRes717212)
		}
		var market any = this.Market(symbol)
		requestqueryVariable := this.PrepareRequest(market, nil, params)
		request := GetValue(requestqueryVariable, 0)
...
func (this *GateCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes724515 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
		PanicOnError(retRes724515)
		ch <- retRes724515
		return nil
...
func (this *GateCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes726015 := (<-this.ModifyMarginHelper(symbol, amount, params))
...
func (this *GateCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes728319 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *GateCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes737112 := (<-this.LoadMarkets())
			PanicOnError(retRes737112)
		}
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *GateCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes742212 := (<-this.LoadMarkets())
			PanicOnError(retRes742212)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *GateCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes760412 := (<-this.LoadMarkets())
			PanicOnError(retRes760412)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes760919 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes760919)
			ch <- retRes760919
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes784515 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
		PanicOnError(retRes784515)
		ch <- retRes784515
		return nil
...
func (this *GateCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes811212 := (<-this.LoadMarkets())
			PanicOnError(retRes811212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *GateCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes822115 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes822115)
		ch <- retRes822115
		return nil
...
func (this *GateCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes823712 := (<-this.LoadMarkets())
			PanicOnError(retRes823712)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *GateCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes834512 := (<-this.LoadMarkets())
			PanicOnError(retRes834512)
		}
		symbols = this.MarketSymbols(symbols)
		var response any = nil
		var isUnified any = this.SafeBool(params, "unified")
