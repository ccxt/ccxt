...
func (this *GateCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes30598 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes335619 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
			PanicOnError(retRes335619)
			ch <- retRes335619
			return nil
		}
		if IsTrue(GetValue(market, "option")) {

			retRes335919 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
...
func (this *GateCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes344119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes344119)
			ch <- retRes344119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes355119 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes355119)
			ch <- retRes355119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes37128 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(paginate) {
			...
			retRes371619 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *GateCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes401119 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *GateCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes405019 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes405019)
			ch <- retRes405019
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes44398 := (<-this.LoadMarkets())
		PanicOnError(retRes44398)

		retRes44408 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes44408)
...
func (this *GateCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47198 := (<-this.LoadUnifiedStatus())
		...
		retRes472515 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes472515)
		ch <- retRes472515
		return nil
...
func (this *GateCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47878 := (<-this.LoadMarkets())
		PanicOnError(retRes47878)

		retRes47888 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes52468 := (<-this.LoadMarkets())
		PanicOnError(retRes52468)

		retRes52478 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes529615 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
...
func (this *GateCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes533619 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
			PanicOnError(retRes533619)
			ch <- retRes533619
			return nil
		}
...
func (this *GateCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53978 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes56178 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57458 := (<-this.LoadMarkets())
		PanicOnError(retRes57458)

		retRes57468 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(isSpot) {
			...
			retRes576919 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
...
func (this *GateCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57948 := (<-this.LoadMarkets())
		PanicOnError(retRes57948)

		retRes57958 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes58418 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes58418)
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func (this *GateCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes62168 := (<-this.LoadMarkets())
		PanicOnError(retRes62168)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "contract")) {
...
func (this *GateCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes65318 := (<-this.LoadMarkets())
		PanicOnError(retRes65318)
		var market any = this.Market(symbol)
...
func (this *GateCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66378 := (<-this.LoadMarkets())
		PanicOnError(retRes66378)
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *GateCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66678 := (<-this.LoadMarkets())
		PanicOnError(retRes66678)

		retRes66688 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67178 := (<-this.LoadMarkets())
		PanicOnError(retRes67178)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67648 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes68698 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes709615 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
		PanicOnError(retRes709615)
		ch <- retRes709615
		return nil
...
func (this *GateCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes711115 := (<-this.ModifyMarginHelper(symbol, amount, params))
...
func (this *GateCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes713219 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *GateCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes72688 := (<-this.LoadMarkets())
		PanicOnError(retRes72688)
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
			symbol = GetValue(market, "symbol")
...
func (this *GateCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes745219 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes745219)
			ch <- retRes745219
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes768815 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
...
func (this *GateCore) FetchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes77448 := (<-this.LoadMarkets())
		PanicOnError(retRes77448)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
...
func (this *GateCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes77938 := (<-this.LoadMarkets())
		PanicOnError(retRes77938)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
		}
...
func (this *GateCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes805315 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes805315)
		ch <- retRes805315
		return nil
...
func (this *GateCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes80688 := (<-this.LoadMarkets())
		PanicOnError(retRes80688)
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *GateCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes82358 := (<-this.LoadMarkets())
		PanicOnError(retRes82358)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
		}
