...
func (this *GateCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31228 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes342119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
		...
		if IsTrue(GetValue(market, "option")) {
			...
			retRes342419 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
...
func (this *GateCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes351019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *GateCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes361712 := (<-this.LoadMarkets())
			PanicOnError(retRes361712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes362219 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes362219)
			ch <- retRes362219
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes378512 := (<-this.LoadMarkets())
			PanicOnError(retRes378512)
		}

		retRes37878 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(paginate) {
			...
			retRes379119 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes379119)
			ch <- retRes379119
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes408312 := (<-this.LoadMarkets())
			PanicOnError(retRes408312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes408819 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes408819)
			ch <- retRes408819
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes412919 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes412919)
			ch <- retRes412919
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes437312 := (<-this.LoadMarkets())
			PanicOnError(retRes437312)
		}

		retRes43758 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes45258 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes481012 := (<-this.LoadMarkets())
			PanicOnError(retRes481012)
		}

		retRes48128 := (<-this.LoadUnifiedStatus())
		...
		retRes481815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *GateCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes488112 := (<-this.LoadMarkets())
			PanicOnError(retRes488112)
		}

		retRes48838 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes48838)
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53448 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes539315 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes539315)
		ch <- retRes539315
		return nil
...
func (this *GateCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes542112 := (<-this.LoadMarkets())
			PanicOnError(retRes542112)
		}

		retRes54238 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(paginate) {
			...
			retRes542819 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes544119 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
...
func (this *GateCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes550212 := (<-this.LoadMarkets())
			PanicOnError(retRes550212)
		}

		retRes55048 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57268 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes57268)
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func (this *GateCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes585512 := (<-this.LoadMarkets())
			PanicOnError(retRes585512)
		}

		retRes58578 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(isSpot) {
			...
			retRes588019 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
...
func (this *GateCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes590612 := (<-this.LoadMarkets())
			PanicOnError(retRes590612)
		}

		retRes59088 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59568 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes603212 := (<-this.LoadMarkets())
			PanicOnError(retRes603212)
		}
		var currency any = this.Currency(code)
...
func (this *GateCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes654512 := (<-this.LoadMarkets())
			PanicOnError(retRes654512)
		}
...
func (this *GateCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes666712 := (<-this.LoadMarkets())
			PanicOnError(retRes666712)
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes677512 := (<-this.LoadMarkets())
			PanicOnError(retRes677512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *GateCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes680712 := (<-this.LoadMarkets())
			PanicOnError(retRes680712)
		}

		retRes68098 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes69088 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes69088)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes701312 := (<-this.LoadMarkets())
			PanicOnError(retRes701312)
		}

		retRes70158 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes70158)
		var isUnifiedAccount any = false
...
func (this *GateCore) ModifyMarginHelper(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes717112 := (<-this.LoadMarkets())
			PanicOnError(retRes717112)
		}
		var market any = this.Market(symbol)
		requestqueryVariable := this.PrepareRequest(market, nil, params)
		request := GetValue(requestqueryVariable, 0)
...
func (this *GateCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes724415 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
...
func (this *GateCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes725915 := (<-this.ModifyMarginHelper(symbol, amount, params))
		PanicOnError(retRes725915)
		ch <- retRes725915
		return nil
...
func (this *GateCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes727712 := (<-this.LoadMarkets())
			PanicOnError(retRes727712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes728219 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *GateCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes742112 := (<-this.LoadMarkets())
			PanicOnError(retRes742112)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *GateCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes760312 := (<-this.LoadMarkets())
			PanicOnError(retRes760312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes760819 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes760819)
			ch <- retRes760819
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes784415 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
		PanicOnError(retRes784415)
		ch <- retRes784415
		return nil
...
func (this *GateCore) FetchUnderlyingAssets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes785812 := (<-this.LoadMarkets())
			PanicOnError(retRes785812)
		}
		var marketType any = nil
...
func (this *GateCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes795412 := (<-this.LoadMarkets())
			PanicOnError(retRes795412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
...
func (this *GateCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes811112 := (<-this.LoadMarkets())
			PanicOnError(retRes811112)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *GateCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes822015 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes822015)
		ch <- retRes822015
		return nil
...
func (this *GateCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes823612 := (<-this.LoadMarkets())
			PanicOnError(retRes823612)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *GateCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes834412 := (<-this.LoadMarkets())
			PanicOnError(retRes834412)
		}
		symbols = this.MarketSymbols(symbols)
		var response any = nil
		var isUnified any = this.SafeBool(params, "unified")
...
func (this *GateCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes840712 := (<-this.LoadMarkets())
			PanicOnError(retRes840712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
...
func (this *GateCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes847012 := (<-this.LoadMarkets())
			PanicOnError(retRes847012)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *GateCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes860712 := (<-this.LoadMarkets())
			PanicOnError(retRes860712)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbolsLength any = GetArrayLength(symbols)
