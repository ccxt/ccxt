...
func (this *Gate) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes243512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes243512)
	}
...
func (this *Gate) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes247812 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes251212 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchTransactionFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes258612 := (<-this.LoadMarketsAsync())
	...
	for i := 0; i < GetArrayLength(response); i++ {
		...
		var withdrawFixOnChains any = this.SafeDict(entry, "withdraw_fix_on_chains")
...
func (this *Gate) ParseDepositWithdrawFee(fee any, optionalArgs ...any) any {
	...
	currency := GetArg(optionalArgs, 0, nil)
	_ = currency
	var withdrawFixOnChains any = this.SafeDict(fee, "withdraw_fix_on_chains")
	var result map[string]any = map[string]any{
		"info": fee,
		"withdraw": map[string]any{
...
func (this *Gate) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes274312 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes318712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes318712)
	}

	retRes31898 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes347712 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes348319 := (<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
		PanicOnError(retRes348319)
		ch <- retRes348319
		return nil
	}
	if GetValue(market, "option") == true {

		retRes348619 := (<-this.FetchOptionOHLCVAsync(symbol, timeframe, since, limit, params))
...
func (this *Gate) fetchOptionOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes353912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes353912)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request any = map[string]any{}
	requestparamsVariable := this.PrepareRequest(market, nil, params)
...
func (this *Gate) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes357219 := (<-this.FetchPaginatedCallDeterministicAsync("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *Gate) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes367912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes367912)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes368419 := (<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, params))
		PanicOnError(retRes368419)
		ch <- retRes368419
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Gate) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes379512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes379512)
	}
	//
	//      [
	//          {
...
func (this *Gate) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes384712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes384712)
	}

	retRes38498 := (<-this.LoadUnifiedStatusAsync())
	...
	if paginate == true {
		...
		retRes385319 := (<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params))
		PanicOnError(retRes385319)
		ch <- retRes385319
		return nil
	}
	var typeVar any = nil
...
func (this *Gate) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes414512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes414512)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes415019 := (<-this.FetchPaginatedCallDynamicAsync("fetchDeposits", code, since, limit, params))
...
func (this *Gate) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes419119 := (<-this.FetchPaginatedCallDynamicAsync("fetchWithdrawals", code, since, limit, params))
		PanicOnError(retRes419119)
		ch <- retRes419119
		return nil
	}
	var request any = map[string]any{}
...
func (this *Gate) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes44378 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes458512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes458512)
	}

	retRes45878 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if contract == true {
		...
		if isClose == true {
			...
			var signedAmount any = func() any {
				if IsEqual(side, "sell") {
					return Precise.StringNeg(amountToPrecision)
				}
				return amountToPrecision
			}()
...
func (this *Gate) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes487212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes487212)
	}

	retRes48748 := (<-this.LoadUnifiedStatusAsync())
	...
	retRes488015 := (<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))
	PanicOnError(retRes488015)
	ch <- retRes488015
	return nil
}
...
func (this *Gate) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes494312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes494312)
	}

	retRes49458 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes49458)
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Gate) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes540412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes540412)
	}

	retRes54068 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes545515 := (<-this.FetchOrdersByStatusAsync("open", symbol, since, limit, params))
...
func (this *Gate) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes54868 := (<-this.LoadUnifiedStatusAsync())
	...
	if paginate == true {
		...
		retRes549119 := (<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params))
		PanicOnError(retRes549119)
	...
	if !(useHistorical == true) && (((since == nil) && (until == nil)) || (typeVar == nil || *typeVar != "swap")) {
		...
		retRes550419 := (<-this.FetchOrdersByStatusAsync("finished", symbol, since, limit, params))
...
func (this *Gate) PrepareOrdersByStatusRequest(status any, optionalArgs ...any) any {
	...
	var request any = map[string]any{}
	requestparamsVariable := func() any {
		if spot {
			return this.MultiOrderSpotPrepareRequest(market, trigger, params)
		}
		return this.PrepareRequest(market, typeVar, params)
	}()
	request = GetValue(requestparamsVariable, 0)
	params = GetValue(requestparamsVariable, 1)
...
func (this *Gate) fetchOrdersByStatusBody(ch chan any, status any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes556512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes556512)
	}

	retRes55678 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes55678)
	var market any = nil
	if symbol != nil {
		market = this.Market(symbol)
		symbol = GetValue(market, "symbol")
...
func (this *Gate) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes578912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes578912)
	}

	retRes57918 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes592012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes592012)
	}

	retRes59228 := (<-this.LoadUnifiedStatusAsync())
	...
	if isSpot {
		...
		retRes594519 := (<-this.CancelOrdersForSymbolsAsync(ordersRequests, params))
...
func (this *Gate) cancelOrdersForSymbolsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes597112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes597112)
	}

	retRes59738 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes601912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes601912)
	}

	retRes60218 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes60218)
	var market any = func() any {
		if symbol == nil {
			return nil
		}
...
func (this *Gate) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes609712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes609712)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
...
func (this *Gate) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes619012 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes640412 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes649812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes649812)
	}
	var market any = nil
...
func (this *Gate) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes661012 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes673212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes673212)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Gate) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes684012 := (<-this.LoadMarketsAsync())
...
func (this *Gate) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes687212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes687212)
	}

	retRes68748 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes68748)
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"currency": ToUpper(currency["id"]),
		"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *Gate) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes692412 := (<-this.LoadMarketsAsync())
...
func (this *Gate) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes697112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes697112)
	}

	retRes69738 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes69738)
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"currency": ToUpper(currency["id"]),
		"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *Gate) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	retRes70808 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) modifyMarginHelperBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes723612 := (<-this.LoadMarketsAsync())
...
func (this *Gate) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes730915 := (<-this.ModifyMarginHelperAsync(symbol, OpNeg(amount), params))
	PanicOnError(retRes730915)
	ch <- retRes730915
	return nil
}
...
func (this *Gate) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes732415 := (<-this.ModifyMarginHelperAsync(symbol, amount, params))
...
func (this *Gate) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes734212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes734212)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes734719 := (<-this.FetchPaginatedCallDeterministicAsync("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
		PanicOnError(retRes734719)
		ch <- retRes734719
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Gate) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes743512 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchMySettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes748612 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes766812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes766812)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes767319 := (<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params))
...
func (this *Gate) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes790915 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
	PanicOnError(retRes790915)
	ch <- retRes790915
	return nil
}
...
func (this *Gate) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes792312 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes796812 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchGreeksBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes817612 := (<-this.LoadMarketsAsync())
...
func (this *Gate) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes828515 := (<-this.CreateOrderAsync(symbol, "market", side, 0, nil, params))
	PanicOnError(retRes828515)
	ch <- retRes828515
	return nil
}
...
func (this *Gate) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes830112 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchLeveragesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes840912 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchOptionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes847212 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchOptionChainBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes853512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes853512)
	}
...
func (this *Gate) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes867212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes867212)
	}
	var market any = nil
	if symbols != nil {
		var symbolsLength int = GetArrayLength(symbols)
