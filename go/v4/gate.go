...
func (this *GateCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes258112 := (<-this.LoadMarkets())
			PanicOnError(retRes258112)
		}
...
func (this *GateCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes305812 := (<-this.LoadMarkets())
			PanicOnError(retRes305812)
		}
		symbols = this.MarketSymbols(symbols)
...
func (this *GateCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31218 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes342019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
		...
		if IsTrue(GetValue(market, "option")) {
			...
			retRes342319 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
			PanicOnError(retRes342319)
			ch <- retRes342319
			return nil
		}
...
func (this *GateCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes350919 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes350919)
			ch <- retRes350919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes362119 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *GateCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes373212 := (<-this.LoadMarkets())
			PanicOnError(retRes373212)
		}
		//
		//      [
		//          {
...
func (this *GateCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes37868 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(paginate) {
			...
			retRes379019 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes379019)
			ch <- retRes379019
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes408719 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *GateCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes412312 := (<-this.LoadMarkets())
			PanicOnError(retRes412312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes412819 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes412819)
			ch <- retRes412819
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes437212 := (<-this.LoadMarkets())
			PanicOnError(retRes437212)
		}

		retRes43748 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes45248 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes45248)
...
func (this *GateCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes480912 := (<-this.LoadMarkets())
			PanicOnError(retRes480912)
		}

		retRes48118 := (<-this.LoadUnifiedStatus())
		...
		retRes481715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *GateCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes488012 := (<-this.LoadMarkets())
			PanicOnError(retRes488012)
		}

		retRes48828 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53438 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes539215 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes539215)
		ch <- retRes539215
		return nil
...
func (this *GateCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes542012 := (<-this.LoadMarkets())
			PanicOnError(retRes542012)
		}

		retRes54228 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes543419 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
...
func (this *GateCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57198 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes57198)
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func (this *GateCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes584812 := (<-this.LoadMarkets())
			PanicOnError(retRes584812)
		}

		retRes58508 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes58508)
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
		...
		if IsTrue(isSpot) {
			...
			retRes587319 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
			PanicOnError(retRes587319)
			ch <- retRes587319
			return nil
		}
		var request any = map[string]any{
...
func (this *GateCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59018 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59498 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes602512 := (<-this.LoadMarkets())
			PanicOnError(retRes602512)
		}
		var currency any = this.Currency(code)
...
func (this *GateCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes611812 := (<-this.LoadMarkets())
			PanicOnError(retRes611812)
		}
		var market any = this.Market(symbol)
		requestqueryVariable := this.PrepareRequest(market, nil, params)
		request := GetValue(requestqueryVariable, 0)
...
func (this *GateCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes642612 := (<-this.LoadMarkets())
			PanicOnError(retRes642612)
		}
		var market any = nil
...
func (this *GateCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes653812 := (<-this.LoadMarkets())
			PanicOnError(retRes653812)
		}
...
func (this *GateCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes666012 := (<-this.LoadMarkets())
			PanicOnError(retRes666012)
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes676812 := (<-this.LoadMarkets())
			PanicOnError(retRes676812)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *GateCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes680012 := (<-this.LoadMarkets())
			PanicOnError(retRes680012)
		}

		retRes68028 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes689912 := (<-this.LoadMarkets())
			PanicOnError(retRes689912)
		}

		retRes69018 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes70088 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes70088)
		var isUnifiedAccount any = false
...
func (this *GateCore) ModifyMarginHelper(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes716412 := (<-this.LoadMarkets())
			PanicOnError(retRes716412)
		}
		var market any = this.Market(symbol)
		requestqueryVariable := this.PrepareRequest(market, nil, params)
		request := GetValue(requestqueryVariable, 0)
...
func (this *GateCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes723715 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
		PanicOnError(retRes723715)
		ch <- retRes723715
		return nil
...
func (this *GateCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes725215 := (<-this.ModifyMarginHelper(symbol, amount, params))
...
func (this *GateCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes727012 := (<-this.LoadMarkets())
			PanicOnError(retRes727012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes727519 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *GateCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes736312 := (<-this.LoadMarkets())
			PanicOnError(retRes736312)
		}
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *GateCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes741412 := (<-this.LoadMarkets())
			PanicOnError(retRes741412)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *GateCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes760119 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *GateCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes783715 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
		PanicOnError(retRes783715)
		ch <- retRes783715
		return nil
...
func (this *GateCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes794712 := (<-this.LoadMarkets())
			PanicOnError(retRes794712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
...
func (this *GateCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes810412 := (<-this.LoadMarkets())
			PanicOnError(retRes810412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *GateCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes821315 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes821315)
		ch <- retRes821315
		return nil
...
func (this *GateCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes822912 := (<-this.LoadMarkets())
			PanicOnError(retRes822912)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *GateCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes833712 := (<-this.LoadMarkets())
			PanicOnError(retRes833712)
		}
		symbols = this.MarketSymbols(symbols)
		var response any = nil
		var isUnified any = this.SafeBool(params, "unified")
