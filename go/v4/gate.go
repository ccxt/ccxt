...
func (this *Gate) loadUnifiedStatusBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	var unifiedAccount *bool = this.SafeBool(this.Options, "unifiedAccount")
	if unifiedAccount == nil {
...
func (this *Gate) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true) {
		...
		retRes138312 := (<-this.LoadTimeDifferenceAsync())
		PanicOnError(retRes138312)
	}
	if this.CheckRequiredCredentials(false) {

		retRes138612 := (<-this.LoadUnifiedStatusAsync())
		PanicOnError(retRes138612)
	}
...
func (this *Gate) fetchOptionMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(underlyings)); i++ {
		...
		for j := 0; IsLessThan(j, GetArrayLength(response)); j++ {
			...
			var optionLetter string = Ternary((IsEqual(isCall, true)), "C", "P").(string)
			var optionType string = Ternary((IsEqual(isCall, true)), "call", "put").(string)
...
func (this *Gate) PrepareRequest(optionalArgs ...any) any {
	...
	if !IsEqual(market, nil) {
		...
		if swap || future {
			var defaultSettle string = Ternary(swap, "usdt", "btc").(string)
...
func (this *Gate) ParseCurrency(rawCurrency any) any {
	...
	var typeVar string = Ternary(EvalTruthy(this.IsLeveragedCurrency(currencyId)), "leveraged", "crypto").(string)
...
func (this *Gate) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes221612 := (<-this.LoadMarketsAsync())
...
func (this *Gate) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var markPrice *float64 = this.SafeNumber(contract, "mark_price")
	var indexPrice *float64 = this.SafeNumber(contract, "index_price")
	var interestRate *float64 = this.SafeNumber(contract, "interest_rate")
	var fundingRate *float64 = this.SafeNumber(contract, "funding_rate")
	var fundingTime *int64 = this.SafeTimestamp(contract, "funding_next_apply")
	var fundingRateIndicative *float64 = this.SafeNumber(contract, "funding_rate_indicative")
...
func (this *Gate) fetchNetworkDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes236012 := (<-this.LoadMarketsAsync())
	...
	code = DerefScalar(this.SafeCurrencyCode(currencyId))
...
func (this *Gate) ParseTradingFee(info any, optionalArgs ...any) any {
	...
	var taker string = Ternary((IsEqual(gtDiscount, true)), "gt_taker_fee", "taker_fee").(string)
	var maker string = Ternary((IsEqual(gtDiscount, true)), "gt_maker_fee", "maker_fee").(string)
...
func (this *Gate) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var marketType string = Ternary((InOp(ticker, "mark_price")), "contract", "spot").(string)
	var symbol *string = this.SafeSymbol(marketId, market, "_", marketType)
...
func (this *Gate) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes313012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes313012)
	}
	symbols = this.MarketSymbols(symbols)
...
func (this *Gate) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes31938 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes31938)
	var symbol *string = this.SafeString(params, "symbol")
	params = this.Omit(params, "symbol")
	var isUnifiedAccount any = false
	var isUnifiedAccountparamsVariable []any = this.HandleOptionAndParams(params, "fetchBalance", "unifiedAccount")
	isUnifiedAccount = GetValue(isUnifiedAccountparamsVariable, 0)
	params = GetValue(isUnifiedAccountparamsVariable, 1)
	...
	for i := 0; IsLessThan(i, GetArrayLength(data)); i++ {
		...
		if isolated {
			...
			var code *string = this.SafeCurrencyCode(this.SafeString(entry, "currency"))
...
func (this *Gate) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes348112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes348112)
	}
	var market any = this.Market(symbol)
	...
	if IsEqual(GetValue(market, "option"), true) {
		...
		retRes349019 := (<-this.FetchOptionOHLCVAsync(symbol, timeframe, since, limit, params))
	...
	var maxLimit int = Ternary((IsEqual(GetValue(market, "contract"), true)), 1999, 1000).(int)
...
func (this *Gate) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes357112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes357112)
	}
	var paginate any = false
...
func (this *Gate) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes368312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes368312)
	}
	var paginate any = false
	...
	if EvalTruthy(paginate) {
		...
		retRes368819 := (<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, params))
		PanicOnError(retRes368819)
		ch <- retRes368819
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *Gate) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes385112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes385112)
	}

	retRes38538 := (<-this.LoadUnifiedStatusAsync())
	...
	if EvalTruthy(paginate) {
		...
		retRes385719 := (<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params))
		PanicOnError(retRes385719)
		ch <- retRes385719
		return nil
	}
	var typeVar any = nil
...
func (this *Gate) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var marketType string = Ternary((InOp(trade, "contract")), "contract", "spot").(string)
	market = this.SafeMarket(marketId, market, "_", marketType)
	var amountString *string = this.SafeString2(trade, "amount", "size")
	var priceString *string = this.SafeString(trade, "price")
	var contractSide string = Ternary(Precise.StringLt(amountString, "0"), "sell", "buy").(string)
...
func (this *Gate) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes415419 := (<-this.FetchPaginatedCallDynamicAsync("fetchDeposits", code, since, limit, params))
		PanicOnError(retRes415419)
		ch <- retRes415419
		return nil
	}
	var request any = map[string]any{}
...
func (this *Gate) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes419519 := (<-this.FetchPaginatedCallDynamicAsync("fetchWithdrawals", code, since, limit, params))
		PanicOnError(retRes419519)
		ch <- retRes419519
		return nil
	}
	var request any = map[string]any{}
...
func (this *Gate) ParseTransactionType(typeVar any) *string {
...
func (this *Gate) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var status *string = this.ParseTransactionStatus(rawStatus)
...
func (this *Gate) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes443912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes443912)
	}

	retRes44418 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes458912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes458912)
	}

	retRes45918 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if nonTriggerOrder {
		...
		if !IsEqual(clientOrderId, nil) {
			...
			if textIsRequired != nil && *textIsRequired == true {
...
func (this *Gate) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes487612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes487612)
	}

	retRes48788 := (<-this.LoadUnifiedStatusAsync())
	...
	retRes488415 := (<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))
	PanicOnError(retRes488415)
	ch <- retRes488415
	return nil
}
...
func (this *Gate) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes494712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes494712)
	}

	retRes49498 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) ParseOrder(order any, optionalArgs ...any) any {
	...
	market := GetArg(optionalArgs, 0, nil)
	_ = market
	var succeeded *bool = this.SafeBool(order, "succeeded", true)
	...
	var symbol *string = this.SafeSymbol(exchangeSymbol, market, "_", marketType)
	var fees any = []any{}
...
func (this *Gate) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes540812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes540812)
	}

	retRes54108 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes545915 := (<-this.FetchOrdersByStatusAsync("open", symbol, since, limit, params))
...
func (this *Gate) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes548812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes548812)
	}

	retRes54908 := (<-this.LoadUnifiedStatusAsync())
	...
	if EvalTruthy(paginate) {
		...
		retRes549519 := (<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params))
	...
	if !EvalTruthy(useHistorical) && ((IsEqual(since, nil) && (until == nil)) || (typeVar == nil || *typeVar != "swap")) {
		...
		retRes550819 := (<-this.FetchOrdersByStatusAsync("finished", symbol, since, limit, params))
		PanicOnError(retRes550819)
		ch <- retRes550819
		return nil
	}
...
func (this *Gate) fetchOrdersByStatusBody(ch chan any, status any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes556912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes556912)
	}

	retRes55718 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes579312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes579312)
	}

	retRes57958 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes592412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes592412)
	}

	retRes59268 := (<-this.LoadUnifiedStatusAsync())
	...
	if isSpot {
		...
		retRes594919 := (<-this.CancelOrdersForSymbolsAsync(ordersRequests, params))
...
func (this *Gate) cancelOrdersForSymbolsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes597512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes597512)
	}

	retRes59778 := (<-this.LoadUnifiedStatusAsync())
...
func (this *Gate) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes60258 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes60258)
	var market any = Ternary((IsEqual(symbol, nil)), nil, this.Market(symbol))
...
func (this *Gate) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes610112 := (<-this.LoadMarketsAsync())
...
func (this *Gate) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes619412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes619412)
	}
	var market any = this.Market(symbol)
	requestqueryVariable := this.PrepareRequest(market, nil, params)
	request := GetValue(requestqueryVariable, 0)
...
func (this *Gate) ParsePosition(position any, optionalArgs ...any) any {
	...
	var collateral *string = marginBalance
...
func (this *Gate) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes640812 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes650212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes650212)
	}
	var market any = nil
...
func (this *Gate) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes661412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes661412)
	}
...
func (this *Gate) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes673612 := (<-this.LoadMarketsAsync())
...
func (this *Gate) ParseEmulatedLeverageTiers(info any, optionalArgs ...any) any {
	...
	var maintenanceMarginRate *string = maintenanceMarginUnit
	var initialMarginRatio *string = initialMarginUnit
	var floor any = "0"
	var tiers any = []any{}
...
func (this *Gate) ParseMarketLeverageTiers(info any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(info)); i++ {
		...
		var maxNotional *float64 = this.SafeNumber(item, "risk_limit")
		AppendToArray(&tiers, map[string]any{
			"tier":                  this.Sum(i, 1),
			"symbol":                this.SafeString(market, "symbol"),
...
func (this *Gate) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes684412 := (<-this.LoadMarketsAsync())
...
func (this *Gate) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	retRes68788 := (<-this.LoadUnifiedStatusAsync())
	...
	var isUnifiedAccount any = false
	var isUnifiedAccountparamsVariable []any = this.HandleOptionAndParams(params, "repayCrossMargin", "unifiedAccount")
	isUnifiedAccount = GetValue(isUnifiedAccountparamsVariable, 0)
	params = GetValue(isUnifiedAccountparamsVariable, 1)
	var response any = nil
	if EvalTruthy(isUnifiedAccount) {
...
func (this *Gate) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes697512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes697512)
	}

	retRes69778 := (<-this.LoadUnifiedStatusAsync())
	...
	var isUnifiedAccount any = false
	var isUnifiedAccountparamsVariable []any = this.HandleOptionAndParams(params, "borrowCrossMargin", "unifiedAccount")
	isUnifiedAccount = GetValue(isUnifiedAccountparamsVariable, 0)
	params = GetValue(isUnifiedAccountparamsVariable, 1)
	var response any = nil
	if EvalTruthy(isUnifiedAccount) {
...
func (this *Gate) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes708212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes708212)
	}

	retRes70848 := (<-this.LoadUnifiedStatusAsync())
	PanicOnError(retRes70848)
	var isUnifiedAccount any = false
...
func (this *Gate) modifyMarginHelperBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes724212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes724212)
	}
	var market any = this.Market(symbol)
	requestqueryVariable := this.PrepareRequest(market, nil, params)
	request := GetValue(requestqueryVariable, 0)
...
func (this *Gate) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes731515 := (<-this.ModifyMarginHelperAsync(symbol, OpNeg(amount), params))
...
func (this *Gate) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes733015 := (<-this.ModifyMarginHelperAsync(symbol, amount, params))
...
func (this *Gate) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes734812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes734812)
	}
	var paginate any = false
...
func (this *Gate) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes744112 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchMySettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes749212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes749212)
	}
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
...
func (this *Gate) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes767412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes767412)
	}
	var paginate any = false
	...
	if EvalTruthy(paginate) {
		...
		retRes767919 := (<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params))
	...
	if (IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future")) {
		var defaultSettle string = Ternary((IsEqual(typeVar, "swap")), "usdt", "btc").(string)
		var settle *string = this.SafeStringLower(params, "settle", defaultSettle)
		params = this.Omit(params, "settle")
		AddElementToObject(request, "settle", settle)
	}
...
func (this *Gate) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	retRes791515 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
...
func (this *Gate) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes792912 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes797412 := (<-this.LoadMarketsAsync())
...
func (this *Gate) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes802512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes802512)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"contract": GetValue(market, "id"),
...
func (this *Gate) fetchGreeksBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes818212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes818212)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *Gate) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes829115 := (<-this.CreateOrderAsync(symbol, "market", side, 0, nil, params))
	PanicOnError(retRes829115)
	ch <- retRes829115
	return nil
}
...
func (this *Gate) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes830712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes830712)
	}
	var market any = nil
	if !IsEqual(symbol, nil) {
...
func (this *Gate) fetchLeveragesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes841512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes841512)
	}
	symbols = this.MarketSymbols(symbols)
	var response any = nil
	var isUnified *bool = this.SafeBool(params, "unified")
...
func (this *Gate) fetchOptionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes847812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes847812)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"contract": GetValue(market, "id"),
...
func (this *Gate) fetchOptionChainBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes854112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes854112)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
...
func (this *Gate) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes867812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes867812)
	}
	var market any = nil
	if !IsEqual(symbols, nil) {
		var symbolsLength int = GetArrayLength(symbols)
