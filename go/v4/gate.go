...
func (this *Gate) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "option") == true {
		...
		var retRes349019 []any = ListTyped(PanicOnError((<-this.FetchOptionOHLCVAsync(symbol, timeframe, since, limit, params))))
		ch <- BoxAbsent(retRes349019)
		return nil
	}
	...
	if GetValue(market, "contract") == true {
		...
		if GetValue(market, "future") == true {
			...
			response = (<-this.PublicDeliveryGetSettleCandlesticks(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else if GetValue(market, "swap") == true {

			response = (<-this.PublicFuturesGetSettleCandlesticks(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	} else {

		response = (<-this.PublicSpotGetCandlesticks(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
...
func (this *Gate) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicFuturesGetSettleFundingRate(this.Extend(request, params))).Raw))
	//
	//     {
	//         "r": "0.00063521",
	//         "t": "1621267200000",
...
func (this *Gate) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes368819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, params))))
		ch <- BoxAbsent(retRes368819)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	//
...
func (this *Gate) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes385719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params))))
		ch <- BoxAbsent(retRes385719)
		return nil
	}
	var typeVar any = nil
	...
	if (IsEqual(typeVar, "spot")) || (IsEqual(typeVar, "margin")) {
		...
		response = (<-this.PrivateSpotGetMyTrades(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if IsEqual(typeVar, "swap") {

		response = (<-this.PrivateFuturesGetSettleMyTradesTimerange(this.Extend(request, params))).Raw
		PanicOnError(response)
...
func (this *Gate) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes415419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchDeposits", code, since, limit, params))))
...
func (this *Gate) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes419519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchWithdrawals", code, since, limit, params))))
...
func (this *Gate) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var postOnlyparamsVariable []any = this.HandlePostOnly((IsEqual(typeVar, "market")), (exchangeSpecificTimeInForce != nil && *exchangeSpecificTimeInForce == "poc"), params)
	...
	params = MapTyped(this.Omit(params, []any{"stopPrice", "triggerPrice", "stopLossPrice", "takeProfitPrice", "reduceOnly", "timeInForce", "postOnly", "clientOrderId"}))
	...
	if nonTriggerOrder {
		...
		if !IsEqual(clientOrderId, nil) {
			...
			params = MapTyped(this.Omit(params, "textIsRequired"))
		...
		if contract != nil && *contract == true {
			...
			if IsEqual(trigger, nil) {
				...
				params = MapTyped(this.Omit(params, []any{"price_type"}))
...
func (this *Gate) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	var retRes488415 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))))
...
func (this *Gate) FetchOrderRequest(id any, optionalArgs ...any) any {
	...
	var orderId any = id
	if !IsEqual(clientOrderId, nil) {
		params = MapTyped(this.Omit(params, []any{"text", "clientOrderId"}))
		if GetValue(clientOrderId, 0) != "t" {
			clientOrderId = Add("t-", clientOrderId)
		}
...
func (this *Gate) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes545915 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStatusAsync("open", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes545915)
	return nil
}
...
func (this *Gate) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes549519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params))))
	...
	if !(useHistorical == true) && (((since == nil) && (until == nil)) || (typeVar == nil || *typeVar != "swap")) {
		...
		var retRes550819 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStatusAsync("finished", symbol, since, limit, params))))
...
func (this *Gate) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if isSpot {
		...
		var retRes594919 []any = ListTyped(PanicOnError((<-this.CancelOrdersForSymbolsAsync(ordersRequests, params))))
		ch <- BoxAbsent(retRes594919)
		return nil
	}
	var request map[string]any = map[string]any{
		"settle": settle,
...
func (this *Gate) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(typeVar, "swap") {
		...
		response = (<-this.PrivateFuturesGetSettlePositions(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if IsEqual(typeVar, "future") {
...
func (this *Gate) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes731515 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, OpNeg(amount), params))))
	ch <- BoxAbsent(retRes731515)
	return nil
}
...
func (this *Gate) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes733015 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, params))))
	ch <- BoxAbsent(retRes733015)
	return nil
}
...
func (this *Gate) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes767919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params))))
...
func (this *Gate) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicOptionsGetUnderlyings(params)).Raw))
	//
	//    [
	//        {
	//            "index_time": "1646915796",
...
func (this *Gate) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var retRes829115 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, "market", side, 0, nil, params))))
	ch <- BoxAbsent(retRes829115)
	return nil
}
...
func (this *Gate) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, "unified"))
	if IsEqual(this.SafeBool(market, "spot"), true) {
		request["currency_pair"] = this.SafeString(market, "id")
		if isUnified != nil && *isUnified == true {

			response = (<-this.PublicMarginGetUniCurrencyPairsCurrencyPair(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else {

			response = (<-this.PublicMarginGetCurrencyPairsCurrencyPair(this.Extend(request, params))).Raw
...
func (this *Gate) fetchLeveragesBody(ch chan any, optionalArgs ...any) any {
	...
	if isUnified != nil && *isUnified == true {
		...
		response = ListTyped(PanicOnError((<-this.PublicMarginGetUniCurrencyPairs(params)).Raw))
	} else {

		response = ListTyped(PanicOnError((<-this.PublicMarginGetCurrencyPairs(params)).Raw)) // deprecated
	}
...
func (this *Gate) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "swap") {
		...
		response = (<-this.PrivateFuturesGetSettlePositionClose(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if IsEqual(marketType, "future") {
