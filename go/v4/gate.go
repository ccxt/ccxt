...
func (this *GateCore) FetchCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		//    ]
		//
		var indexedCurrencies any = this.IndexBy(response, "currency")
		...
		for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
			...
			var typeVar any = Ternary(IsTrue(this.IsLeveragedCurrency(currencyId, true, indexedCurrencies)), "leveraged", "crypto")
...
func (this *GateCore) ParseDepositWithdrawFee(fee any, optionalArgs ...any) any {
	...
	if IsTrue(!IsEqual(withdrawFixOnChains, nil)) {
		...
		for i := 0; IsLessThan(i, GetArrayLength(chainKeys)); i++ {
			...
			var networkCode any = this.NetworkIdToCode(chainKey, this.SafeString(fee, "currency"))
...
func (this *GateCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes29978 := (<-this.LoadMarkets())
		PanicOnError(retRes29978)
		symbols = this.MarketSymbols(symbols)
...
func (this *GateCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes30578 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes335419 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
			PanicOnError(retRes335419)
			ch <- retRes335419
			return nil
		}
		if IsTrue(GetValue(market, "option")) {

			retRes335719 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
			PanicOnError(retRes335719)
			ch <- retRes335719
			return nil
		}
...
func (this *GateCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes343919 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *GateCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes354919 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes354919)
			ch <- retRes354919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *GateCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes37108 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes37108)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes371419 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *GateCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes400919 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes400919)
			ch <- retRes400919
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes404819 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes404819)
			ch <- retRes404819
			return nil
		}
		var request any = map[string]any{}
...
func (this *GateCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes42908 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes44388 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes44388)
...
func (this *GateCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47178 := (<-this.LoadUnifiedStatus())
		...
		retRes472315 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes472315)
		ch <- retRes472315
		return nil
...
func (this *GateCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47868 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes52458 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes529415 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes529415)
		ch <- retRes529415
		return nil
...
func (this *GateCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53228 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes533419 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
			PanicOnError(retRes533419)
			ch <- retRes533419
			return nil
		}
...
func (this *GateCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53958 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes56158 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57438 := (<-this.LoadMarkets())
		PanicOnError(retRes57438)

		retRes57448 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(isSpot) {
			...
			retRes576719 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
...
func (this *GateCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57938 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes58388 := (<-this.LoadMarkets())
		PanicOnError(retRes58388)

		retRes58398 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes58398)
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func (this *GateCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes64098 := (<-this.LoadMarkets())
		PanicOnError(retRes64098)
...
func (this *GateCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes65298 := (<-this.LoadMarkets())
		PanicOnError(retRes65298)
		var market any = this.Market(symbol)
...
func (this *GateCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66358 := (<-this.LoadMarkets())
		PanicOnError(retRes66358)
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *GateCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66668 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes66668)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67158 := (<-this.LoadMarkets())
		PanicOnError(retRes67158)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *GateCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67628 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes68678 := (<-this.LoadUnifiedStatus())
...
func (this *GateCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes709415 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
...
func (this *GateCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes710915 := (<-this.ModifyMarginHelper(symbol, amount, params))
...
func (this *GateCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes713019 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *GateCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes72668 := (<-this.LoadMarkets())
		PanicOnError(retRes72668)
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
			symbol = GetValue(market, "symbol")
...
func (this *GateCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes74468 := (<-this.LoadMarkets())
		PanicOnError(retRes74468)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes745019 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes745019)
			ch <- retRes745019
			return nil
		}
		var typeVar any = nil
...
func (this *GateCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes768615 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
...
func (this *GateCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes77918 := (<-this.LoadMarkets())
		PanicOnError(retRes77918)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
		}
...
func (this *GateCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes79468 := (<-this.LoadMarkets())
		PanicOnError(retRes79468)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *GateCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes805115 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
		PanicOnError(retRes805115)
		ch <- retRes805115
		return nil
...
func (this *GateCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes81728 := (<-this.LoadMarkets())
		PanicOnError(retRes81728)
		symbols = this.MarketSymbols(symbols)
		var response any = nil
		var isUnified any = this.SafeBool(params, "unified")
		params = this.Omit(params, "unified")
...
func (this *GateCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes82338 := (<-this.LoadMarkets())
		PanicOnError(retRes82338)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"contract": GetValue(market, "id"),
		}
