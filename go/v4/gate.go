...
func (this *gate) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes111815 := (<-this.PrivateUnifiedPutUnifiedMode(params))
...
func (this *gate) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes122712 := (<-this.LoadTimeDifference())
			PanicOnError(retRes122712)
		}
		if IsTrue(this.CheckRequiredCredentials(false)) {

			retRes123012 := (<-this.LoadUnifiedStatus())
...
func (this *gate) FetchBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes29438 := (<-this.LoadUnifiedStatus())
...
func (this *gate) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes324019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
		...
		if IsTrue(GetValue(market, "option")) {
			...
			retRes324319 := (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
			PanicOnError(retRes324319)
			ch <- retRes324319
			return nil
		}
...
func (this *gate) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes332519 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *gate) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes343519 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *gate) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes35958 := (<-this.LoadMarkets())
		PanicOnError(retRes35958)

		retRes35968 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(paginate) {
			...
			retRes360019 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *gate) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes389519 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes389519)
			ch <- retRes389519
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *gate) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes393419 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes393419)
			ch <- retRes393419
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *gate) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes41748 := (<-this.LoadMarkets())
		PanicOnError(retRes41748)

		retRes41758 := (<-this.LoadUnifiedStatus())
...
func (this *gate) CreateOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes43238 := (<-this.LoadMarkets())
		PanicOnError(retRes43238)

		retRes43248 := (<-this.LoadUnifiedStatus())
...
func (this *gate) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes45968 := (<-this.LoadMarkets())
		PanicOnError(retRes45968)

		retRes45978 := (<-this.LoadUnifiedStatus())
		...
		retRes460315 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes460315)
		ch <- retRes460315
		return nil
...
func (this *gate) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes46668 := (<-this.LoadUnifiedStatus())
...
func (this *gate) FetchOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes50328 := (<-this.LoadUnifiedStatus())
...
func (this *gate) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes508215 := (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
		PanicOnError(retRes508215)
		ch <- retRes508215
		return nil
...
func (this *gate) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes51108 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
			...
			retRes512219 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
			PanicOnError(retRes512219)
			ch <- retRes512219
			return nil
		}
...
func (this *gate) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes51838 := (<-this.LoadUnifiedStatus())
		PanicOnError(retRes51838)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
			symbol = GetValue(market, "symbol")
...
func (this *gate) CancelOrders(ids interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes55298 := (<-this.LoadUnifiedStatus())
		...
		if IsTrue(isSpot) {
			...
			retRes555219 := (<-this.CancelOrdersForSymbols(ordersRequests, params))
...
func (this *gate) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes55788 := (<-this.LoadUnifiedStatus())
...
func (this *gate) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes56218 := (<-this.LoadUnifiedStatus())
...
func (this *gate) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes63108 := (<-this.LoadMarkets())
		PanicOnError(retRes63108)
		var market interface{} = this.Market(symbol)
...
func (this *gate) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes64438 := (<-this.LoadUnifiedStatus())
...
func (this *gate) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes64918 := (<-this.LoadMarkets())
		PanicOnError(retRes64918)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"currency": ToUpper(GetValue(currency, "id")),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *gate) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes65388 := (<-this.LoadMarkets())
		PanicOnError(retRes65388)

		retRes65398 := (<-this.LoadUnifiedStatus())
...
func (this *gate) FetchBorrowInterest(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes66428 := (<-this.LoadMarkets())
		PanicOnError(retRes66428)

		retRes66438 := (<-this.LoadUnifiedStatus())
...
func (this *gate) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes686615 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
...
func (this *gate) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes688115 := (<-this.ModifyMarginHelper(symbol, amount, params))
...
func (this *gate) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes690219 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
...
func (this *gate) FetchSettlementHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes69898 := (<-this.LoadMarkets())
		PanicOnError(retRes69898)
		var market interface{} = this.Market(symbol)
		var typeVar interface{} = nil
...
func (this *gate) FetchMySettlementHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes70408 := (<-this.LoadMarkets())
		PanicOnError(retRes70408)
		var market interface{} = this.Market(symbol)
		var typeVar interface{} = nil
...
func (this *gate) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes718019 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes718019)
			ch <- retRes718019
			return nil
		}
		var typeVar interface{} = nil
...
func (this *gate) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes741615 := (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
...
func (this *gate) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes74728 := (<-this.LoadMarkets())
		PanicOnError(retRes74728)
		var market interface{} = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
...
func (this *gate) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes776315 := (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
...
func (this *gate) FetchPositionsHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes81438 := (<-this.LoadMarkets())
		PanicOnError(retRes81438)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbolsLength interface{} = GetArrayLength(symbols)
