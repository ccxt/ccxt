...
func NewToobitFromCore(core *ToobitCore) *Toobit {
	return &Toobit{
		ToobitCore:    core,
		Core:          core,
...
func (this *Toobit) FetchDepositsOrWithdrawalsHelper(typeVar any, code any, since any, limit any, params any) ([]Transaction, error) {
