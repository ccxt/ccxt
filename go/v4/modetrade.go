 ...
 */
func  (this *Modetrade) FetchStatus(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchTime(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchMarkets(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchCurrencies(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) ParseTokenAndFeeTemp(item any, feeTokenKey any, feeAmountKey any) any  {
 ...
 */
func  (this *Modetrade) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) ParseFundingInterval(interval any) any  {
 ...
 */
func  (this *Modetrade) FetchFundingInterval(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a [funding rate structure]{@link https://docs.ccxt.com/?id=funding-rate-structure}
 */
func  (this *Modetrade) FetchFundingRate(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchFundingRates(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchFundingHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchTradingFees(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) ParseTimeInForce(timeInForce any) any  {
...
func  (this *Modetrade) ParseOrderStatus(status any) any  {
    if !IsEqual(status, nil) {
...
func  (this *Modetrade) ParseOrderType(typeVar any) any  {
 ...
 */
func  (this *Modetrade) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
    return ch
}
func (this *Modetrade) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
    defer close(ch)
    defer ReturnPanicError(ch)
        price := GetArg(optionalArgs, 0, nil)
        _ = price
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) CreateOrders(orders any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) CancelOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) CancelOrders(ids any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) CancelAllOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) FetchOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) FetchOpenOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Modetrade) FetchClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchBalance(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) GetAssetHistoryRows(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) ParseLedgerEntryType(typeVar any) any  {
    var types map[string]any = map[string]any {
        "BALANCE": "transaction",
        "COLLATERAL": "transfer",
    }
 ...
 */
func  (this *Modetrade) FetchLedger(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) ParseTransactionStatus(status any) any  {
    var statuses map[string]any = map[string]any {
        "NEW": "pending",
        "CONFIRMING": "pending",
        "PROCESSING": "pending",
 ...
 */
func  (this *Modetrade) FetchDeposits(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/?id=transaction-structure}
 */
func  (this *Modetrade) FetchWithdrawals(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchDepositsWithdrawals(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) GetWithdrawNonce(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) Withdraw(code any, amount any, address any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchLeverage(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Modetrade) FetchPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Modetrade) Sign(path any, optionalArgs ...any) any  {
...
func (this *Modetrade) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Modetrade) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
func (this *Modetrade) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *Modetrade) FetchDepositWithdrawFees(options ...FetchDepositWithdrawFeesOptions) (DepositWithdrawFees, error) {return this.exchangeTyped.FetchDepositWithdrawFees(options...)}
...
func (this *Modetrade) FetchPositionMode(options ...FetchPositionModeOptions) (PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *Modetrade) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Modetrade) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
