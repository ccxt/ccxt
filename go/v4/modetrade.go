...
func (this *Modetrade) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes95015 := (<-this.FetchFundingRateAsync(symbol, params))
...
func (this *Modetrade) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes96412 := (<-this.LoadMarketsAsync())
...
func (this *Modetrade) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes104719 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func (this *Modetrade) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes115019 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *Modetrade) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes132912 := (<-this.LoadMarketsAsync())
...
func (this *Modetrade) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes213119 := (<-this.FetchPaginatedCallIncrementalAsync("fetchOrders", symbol, since, limit, params, "page", maxLimit))
...
func (this *Modetrade) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes221915 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
	PanicOnError(retRes221915)
	ch <- retRes221915
	return nil
}
...
func (this *Modetrade) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes224415 := (<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))
	PanicOnError(retRes224415)
	ch <- retRes224415
	return nil
}
...
func (this *Modetrade) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes226112 := (<-this.LoadMarketsAsync())
...
func (this *Modetrade) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes231719 := (<-this.FetchPaginatedCallIncrementalAsync("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *Modetrade) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes258515 := (<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))
	PanicOnError(retRes258515)
	ch <- retRes258515
	return nil
}
...
func (this *Modetrade) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes260315 := (<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))
	PanicOnError(retRes260315)
	ch <- retRes260315
	return nil
}
...
func (this *Modetrade) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes268112 := (<-this.LoadMarketsAsync())
...
func (this *Modetrade) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes277212 := (<-this.LoadMarketsAsync())
...
func (this *Modetrade) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes281912 := (<-this.LoadMarketsAsync())
	...
	retRes282915 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
