...
func (this *modetrade) FetchOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes193119 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
			PanicOnError(retRes193119)
			ch <- retRes193119
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *modetrade) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes201715 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *modetrade) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes204015 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *modetrade) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes210919 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *modetrade) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes236815 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes236815)
		ch <- retRes236815
		return nil
...
func (this *modetrade) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes238615 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes238615)
		ch <- retRes238615
		return nil
...
func (this *modetrade) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes25528 := (<-this.LoadMarkets())
		PanicOnError(retRes25528)
		var market interface{} = this.Market(symbol)
...
func (this *modetrade) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes260615 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
		PanicOnError(retRes260615)
		ch <- retRes260615
		return nil
