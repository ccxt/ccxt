...
func (this *ModetradeCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes90715 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes90715)
		ch <- retRes90715
		return nil
...
func (this *ModetradeCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes99819 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func (this *ModetradeCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes109919 := (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *ModetradeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes202919 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
			PanicOnError(retRes202919)
			ch <- retRes202919
			return nil
		}
		var request any = map[string]any{}
...
func (this *ModetradeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes211515 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
		PanicOnError(retRes211515)
		ch <- retRes211515
		return nil
...
func (this *ModetradeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes213815 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *ModetradeCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes220719 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *ModetradeCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes246615 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes246615)
		ch <- retRes246615
		return nil
...
func (this *ModetradeCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes248415 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes248415)
		ch <- retRes248415
		return nil
...
func (this *ModetradeCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes270415 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
