...
func (this *ModetradeCore) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes92115 := (<-this.FetchFundingRate(symbol, params))
...
func (this *ModetradeCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes101819 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func (this *ModetradeCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes112119 := (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *ModetradeCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes210219 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
		PanicOnError(retRes210219)
		ch <- retRes210219
		return nil
	}
	var request any = map[string]any{}
...
func (this *ModetradeCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes219015 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
	PanicOnError(retRes219015)
	ch <- retRes219015
	return nil
}
...
func (this *ModetradeCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes221515 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *ModetradeCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes228819 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
		PanicOnError(retRes228819)
		ch <- retRes228819
		return nil
	}
	var request any = map[string]any{}
...
func (this *ModetradeCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes255615 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *ModetradeCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes279012 := (<-this.LoadMarkets())
		PanicOnError(retRes279012)
	}
	...
	retRes280015 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
	PanicOnError(retRes280015)
	ch <- retRes280015
	return nil
}
...
func (this *ModetradeCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes293612 := (<-this.LoadMarkets())
		PanicOnError(retRes293612)
	}
...
func (this *ModetradeCore) Sign(path any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(access, "public")) {
		...
		var isPostOrPut bool = IsTrue(IsEqual(method, "POST")) || IsTrue(IsEqual(method, "PUT"))
