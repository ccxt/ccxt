...
func (this *ModetradeCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes91015 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes91015)
		ch <- retRes91015
		return nil
...
func (this *ModetradeCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes100719 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func (this *ModetradeCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes161412 := (<-this.LoadMarkets())
			PanicOnError(retRes161412)
		}
		var market any = this.Market(symbol)
...
func (this *ModetradeCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes190312 := (<-this.LoadMarkets())
			PanicOnError(retRes190312)
		}
...
func (this *ModetradeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes208219 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
...
func (this *ModetradeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes217015 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
		PanicOnError(retRes217015)
		ch <- retRes217015
		return nil
...
func (this *ModetradeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes219515 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
		PanicOnError(retRes219515)
		ch <- retRes219515
		return nil
...
func (this *ModetradeCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes226819 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *ModetradeCore) GetAssetHistoryRows(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes236712 := (<-this.LoadMarkets())
			PanicOnError(retRes236712)
		}
		var request any = map[string]any{}
...
func (this *ModetradeCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes253415 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *ModetradeCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes255215 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes255215)
		ch <- retRes255215
		return nil
...
func (this *ModetradeCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes277815 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
		PanicOnError(retRes277815)
		ch <- retRes277815
		return nil
