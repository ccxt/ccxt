...
func (this *ModetradeCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes96612 := (<-this.LoadMarkets())
		PanicOnError(retRes96612)
	}
...
func (this *ModetradeCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes101219 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
		PanicOnError(retRes101219)
		ch <- retRes101219
		return nil
	}
...
func (this *ModetradeCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes111519 := (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *ModetradeCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes209319 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
		PanicOnError(retRes209319)
		ch <- retRes209319
		return nil
	}
	var request any = map[string]any{}
...
func (this *ModetradeCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes218115 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *ModetradeCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes220615 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *ModetradeCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes227919 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
		PanicOnError(retRes227919)
		ch <- retRes227919
		return nil
	}
	var request any = map[string]any{}
...
func (this *ModetradeCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	retRes279115 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
