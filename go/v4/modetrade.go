 ...
 */
func (this *ModetradeCore) FetchTime(optionalArgs ...any) <-chan Res[*int64] {
...
func (this *ModetradeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes208819 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
...
func (this *ModetradeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes220115 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *ModetradeCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes227419 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *ModetradeCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes254215 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *ModetradeCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes256015 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes256015)
		ch <- retRes256015
		return nil
...
func (this *ModetradeCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes278615 := (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
