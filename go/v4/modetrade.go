...
func  (this *ModetradeCore) FetchFundingInterval(symbol any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes90815 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *ModetradeCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes99919 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func  (this *ModetradeCore) FetchFundingHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes110019 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
