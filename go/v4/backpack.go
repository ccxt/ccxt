...
func (this *BackpackCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(since, nil) {
		...
		var endTime any = Ternary(EvalTruthy(until), this.ParseToInt(Divide(until, 1000)), this.Seconds())
...
func (this *BackpackCore) Sign(path any, optionalArgs ...any) any {
	...
	if IsEqual(api, "private") {
		...
		if (IsEqual(path, "api/v1/orders")) && (IsEqual(method, "POST")) {
			...
			if IsGreaterThan(GetArrayLength(queryString), 0) {
...
func (this *BackpackCore) GenerateBatchPayload(params any, ts any, recvWindow any, instruction any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(params)); i++ {
		...
		if IsEqual(i, (Subtract(GetArrayLength(params), 1))) {
