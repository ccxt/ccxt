...
func (this *BackpackCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var isBuyerMaker any = DerefScalar(this.SafeBool(trade, "isBuyerMaker"))
	...
	} else if !IsEqual(isBuyerMaker, nil) {
		takerOrMaker = "taker"
...
func (this *BackpackCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var internal any = DerefScalar(this.SafeBool(transaction, "isInternal", false))
	var fee any = nil
...
func (this *BackpackCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var quantityKey any = Ternary(isTriggerOrder, "triggerQuantity", "quantity")
