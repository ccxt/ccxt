...
func DynamicallyCreateInstance(exchangeId string, exchangeArgs map[string]interface{}) (ICoreExchange, bool) {
    ...
    case "arzinja":
        ...
        return arzinjaItf, true
    case "arzplus":
        arzplusItf := &arzplus{}
        arzplusItf.Init(exchangeArgs)
        return arzplusItf, true
    case "ascendex":
    ...
    case "bitimen":
        bitimenItf := &bitimen{}
        bitimenItf.Init(exchangeArgs)
        return bitimenItf, true
    case "bitir":
        bitirItf := &bitir{}
        bitirItf.Init(exchangeArgs)
        return bitirItf, true
    case "bitmart":
        bitmartItf := &bitmart{}
    ...
    case "eterex":
        ...
        return eterexItf, true
    case "excoino":
        excoinoItf := &excoino{}
        excoinoItf.Init(exchangeArgs)
        return excoinoItf, true
    case "exir":
        exirItf := &exir{}
        exirItf.Init(exchangeArgs)
        return exirItf, true
    case "exmo":
        exmoItf := &exmo{}
    ...
    case "exnovin":
        exnovinItf := &exnovin{}
        exnovinItf.Init(exchangeArgs)
        return exnovinItf, true
    case "farhadexchange":
        farhadexchangeItf := &farhadexchange{}
        farhadexchangeItf.Init(exchangeArgs)
        return farhadexchangeItf, true
    case "fmfwio":
        fmfwioItf := &fmfwio{}
    ...
    case "jibitex":
        jibitexItf := &jibitex{}
        jibitexItf.Init(exchangeArgs)
        return jibitexItf, true
    case "kraken":
        krakenItf := &kraken{}
    ...
    case "nobitex":
        nobitexItf := &nobitex{}
        nobitexItf.Init(exchangeArgs)
        return nobitexItf, true
    case "novadax":
        novadaxItf := &novadax{}
    ...
    case "okexchange":
        okexchangeItf := &okexchange{}
        okexchangeItf.Init(exchangeArgs)
        return okexchangeItf, true
    case "okx":
        okxItf := &okx{}
    ...
    case "ramzinex":
        ramzinexItf := &ramzinex{}
        ramzinexItf.Init(exchangeArgs)
        return ramzinexItf, true
    case "sarmayex":
        sarmayexItf := &sarmayex{}
        sarmayexItf.Init(exchangeArgs)
        return sarmayexItf, true
    case "sarrafex":
        sarrafexItf := &sarrafex{}
        sarrafexItf.Init(exchangeArgs)
        return sarrafexItf, true
    case "tabdeal":
        tabdealItf := &tabdeal{}
        tabdealItf.Init(exchangeArgs)
        return tabdealItf, true
    case "tetherland":
        tetherlandItf := &tetherland{}
        tetherlandItf.Init(exchangeArgs)
        return tetherlandItf, true
    case "timex":
        timexItf := &timex{}
    ...
    case "twox":
        twoxItf := &twox{}
        twoxItf.Init(exchangeArgs)
        return twoxItf, true
    case "ubitex":
        ubitexItf := &ubitex{}
        ubitexItf.Init(exchangeArgs)
        return ubitexItf, true
    case "upbit":
        upbitItf := &upbit{}
