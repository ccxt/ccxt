...
func  (this *ascendex) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
                ...
                var statusCode interface{} = this.SafeString(currency, "statusCode")
...
func  (this *ascendex) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes263115 :=  (<-this.FetchTransactions(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes263115)
                ch <- retRes263115
                return nil
...
func  (this *ascendex) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes264815 :=  (<-this.FetchTransactions(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes264815)
                ch <- retRes264815
                return nil
...
func  (this *ascendex) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes305415 :=  (<-this.ModifyMarginHelper(symbol, OpNeg(amount), "reduce", params))
...
func  (this *ascendex) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes306715 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func  (this *ascendex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes310015 :=  (<-this.V2PrivateAccountGroupPostFuturesLeverage(this.Extend(request, params)))
                PanicOnError(retRes310015)
                ch <- retRes310015
                return nil
...
func  (this *ascendex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(market, "swap")) {
                ...
                retRes313715 :=  (<-this.V2PrivateAccountGroupPostFuturesMarginType(this.Extend(request, params)))
                PanicOnError(retRes313715)
                ch <- retRes313715
                return nil
...
func  (this *ascendex) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes339019 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes339019)
                    ch <- retRes339019
                    return nil
            }
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
