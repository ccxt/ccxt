...
func  (this *ascendex) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes260615 :=  (<-this.FetchTransactions(code, since, limit, this.Extend(request, params)))
...
func  (this *ascendex) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes262315 :=  (<-this.FetchTransactions(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes262315)
                ch <- retRes262315
                return nil
...
func  (this *ascendex) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes302915 :=  (<-this.ModifyMarginHelper(symbol, OpNeg(amount), "reduce", params))
...
func  (this *ascendex) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes304215 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes304215)
                ch <- retRes304215
                return nil
...
func  (this *ascendex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes307515 :=  (<-this.V2PrivateAccountGroupPostFuturesLeverage(this.Extend(request, params)))
                PanicOnError(retRes307515)
                ch <- retRes307515
                return nil
...
func  (this *ascendex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(market, "swap")) {
                ...
                retRes311215 :=  (<-this.V2PrivateAccountGroupPostFuturesMarginType(this.Extend(request, params)))
                PanicOnError(retRes311215)
                ch <- retRes311215
                return nil
...
func  (this *ascendex) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes336519 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes336519)
                    ch <- retRes336519
                    return nil
            }
            var account interface{} = this.SafeDict(this.Accounts, 0, map[string]interface{} {})
