...
func (this *AlpacaCore) createMarketOrderWithCostBody(ch chan any, symbol any, side any, cost any, optionalArgs ...any) any {
	...
	retRes103415 := (<-this.CreateOrder(symbol, "market", side, 0, nil, this.Extend(req, params)))
	PanicOnError(retRes103415)
	ch <- retRes103415
	return nil
}
...
func (this *AlpacaCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes105415 := (<-this.CreateOrder(symbol, "market", "buy", 0, nil, this.Extend(req, params)))
	PanicOnError(retRes105415)
	ch <- retRes105415
	return nil
}
...
func (this *AlpacaCore) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes107415 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *AlpacaCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes133715 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
	PanicOnError(retRes133715)
	ch <- retRes133715
	return nil
}
...
func (this *AlpacaCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes135615 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *AlpacaCore) fetchDepositsWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes182815 := (<-this.FetchTransactionsHelper("BOTH", code, since, limit, params))
...
func (this *AlpacaCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes184315 := (<-this.FetchTransactionsHelper("INCOMING", code, since, limit, params))
...
func (this *AlpacaCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes185815 := (<-this.FetchTransactionsHelper("OUTGOING", code, since, limit, params))
