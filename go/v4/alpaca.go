...
func  (this *alpaca) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes98915 :=  (<-this.CreateOrder(symbol, "market", side, 0, nil, this.Extend(req, params)))
...
func  (this *alpaca) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes100715 :=  (<-this.CreateOrder(symbol, "market", "buy", 0, nil, this.Extend(req, params)))
                PanicOnError(retRes100715)
                ch <- retRes100715
                return nil
...
func  (this *alpaca) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes102515 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func  (this *alpaca) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes127915 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *alpaca) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes171415 :=  (<-this.FetchTransactionsHelper("BOTH", code, since, limit, params))
                PanicOnError(retRes171415)
                ch <- retRes171415
                return nil
...
func  (this *alpaca) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes172915 :=  (<-this.FetchTransactionsHelper("INCOMING", code, since, limit, params))
                PanicOnError(retRes172915)
                ch <- retRes172915
                return nil
...
func  (this *alpaca) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes174415 :=  (<-this.FetchTransactionsHelper("OUTGOING", code, since, limit, params))
