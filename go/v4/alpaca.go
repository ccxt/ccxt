...
func (this *AlpacaCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes100415 := (<-this.CreateOrder(symbol, "market", side, 0, nil, this.Extend(req, params)))
...
func (this *AlpacaCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes102415 := (<-this.CreateOrder(symbol, "market", "buy", 0, nil, this.Extend(req, params)))
		PanicOnError(retRes102415)
		ch <- retRes102415
		return nil
...
func (this *AlpacaCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes104415 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *AlpacaCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var defaultTIF any = this.SafeString(this.Options, "defaultTimeInForce")
...
func (this *AlpacaCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130615 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *AlpacaCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes132515 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes132515)
		ch <- retRes132515
		return nil
...
func (this *AlpacaCore) FetchDepositsWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes175115 := (<-this.FetchTransactionsHelper("BOTH", code, since, limit, params))
...
func (this *AlpacaCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes176615 := (<-this.FetchTransactionsHelper("INCOMING", code, since, limit, params))
...
func (this *AlpacaCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes178115 := (<-this.FetchTransactionsHelper("OUTGOING", code, since, limit, params))
