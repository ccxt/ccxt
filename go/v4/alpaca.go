...
func (this *Alpaca) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var timeInForceparamsVariable []any = this.HandleOptionStringAndParams(params, "editOrder", "timeInForce", "gtc")
...
func (this *Alpaca) ParseTimeInForce(timeInForce *string) *string {
...
func (this *Alpaca) ParseTransactionStatus(status *string) *string {
	var statuses map[string]any = map[string]any{
		"PROCESSING": "pending",
		"FAILED":     "failed",
		"COMPLETE":   "ok",
