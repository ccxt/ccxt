...
func (this *HashkeyCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes157219 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *HashkeyCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(market, "spot"), true)) {
		...
		retRes253519 := (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
...
func (this *HashkeyCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes256115 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *HashkeyCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(marketType, "spot")) {
		...
		retRes331319 := (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
		PanicOnError(retRes331319)
		ch <- retRes331319
		return nil
	} else if IsTrue(IsEqual(marketType, "swap")) {

		retRes331519 := (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
...
func (this *HashkeyCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes402612 := (<-this.LoadMarkets())
		PanicOnError(retRes402612)
	}

	retRes402815 := (<-this.FetchPositionsForSymbol(GetValue(symbols, 0), this.Extend(map[string]any{
...
func (this *HashkeyCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes423915 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *HashkeyCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes425415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
