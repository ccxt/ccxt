...
func (this *HashkeyCore) ParseCurrency(rawCurrency any) any {
	...
	var typeVar any = Ternary((rawType != nil && *rawType == "REAL_MONEY"), "fiat", "crypto")
...
func (this *HashkeyCore) CreateSpotOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	postOnlyparamsVariable := this.HandlePostOnly(isMarketOrder, (typeVar == "LIMIT_MAKER"), params)
	postOnly = GetValue(postOnlyparamsVariable, 0)
	params = GetValue(postOnlyparamsVariable, 1)
	if EvalTruthy(postOnly) && (typeVar == "LIMIT") {
