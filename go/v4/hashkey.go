...
func (this *HashkeyCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var isMaker any = DerefScalar(this.SafeBool2(trade, "isMaker", "isMarker"))
...
func (this *HashkeyCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	if IsEqual(status, nil) {
		var success any = DerefScalar(this.SafeBool(transaction, "success", false)) // for withdraw
		if success == true {
			status = "ok"
		} else {
...
func (this *HashkeyCore) ParseTransfer(transfer any, optionalArgs ...any) any {
	...
	var status any = nil
	var success any = DerefScalar(this.SafeBool(transfer, "success", false))
	if success == true {
		status = "ok"
	}
	return map[string]any{
...
func (this *HashkeyCore) createSpotOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var test any = DerefScalar(this.SafeBool(params, "test"))
