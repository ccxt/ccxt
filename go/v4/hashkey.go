...
func (this *HashkeyCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes252519 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes252519)
			ch <- retRes252519
			return nil
		} else if IsTrue(GetValue(market, "swap")) {

			retRes252719 := (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
...
func (this *HashkeyCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes255315 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
		PanicOnError(retRes255315)
		ch <- retRes255315
		return nil
...
func (this *HashkeyCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes330519 := (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
			PanicOnError(retRes330519)
			ch <- retRes330519
			return nil
		} else if IsTrue(IsEqual(marketType, "swap")) {

			retRes330719 := (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
...
func (this *HashkeyCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes386212 := (<-this.LoadMarkets())
			PanicOnError(retRes386212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":    GetValue(market, "id"),
...
func (this *HashkeyCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes402015 := (<-this.FetchPositionsForSymbol(GetValue(symbols, 0), this.Extend(map[string]any{
...
func (this *HashkeyCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes403612 := (<-this.LoadMarkets())
			PanicOnError(retRes403612)
		}
		var market any = this.Market(symbol)
...
func (this *HashkeyCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes421615 := (<-this.PrivatePostApiV1FuturesMarginType(this.Extend(request, params)))
...
func (this *HashkeyCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes423115 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *HashkeyCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes424615 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes424615)
		ch <- retRes424615
		return nil
