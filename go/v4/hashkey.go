...
func  (this *HashkeyCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes155719 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func  (this *HashkeyCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes248419 :=  (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
...
func  (this *HashkeyCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            var req any = map[string]any {
                ...
                retRes250815 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *HashkeyCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes323219 :=  (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
                    PanicOnError(retRes323219)
                    ch <- retRes323219
                    return nil
            } else if IsTrue(IsEqual(marketType, "swap")) {
        
                    retRes323419 :=  (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
...
func  (this *HashkeyCore) FetchPositions(optionalArgs ...any) <- chan any {
            ...
            PanicOnError(retRes39338)
                ...
                retRes393415 :=  (<-this.FetchPositionsForSymbol(GetValue(symbols, 0), this.Extend(map[string]any {
...
func  (this *HashkeyCore) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes412215 :=  (<-this.PrivatePostApiV1FuturesMarginType(this.Extend(request, params)))
                PanicOnError(retRes412215)
                ch <- retRes412215
                return nil
...
func  (this *HashkeyCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes413715 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func  (this *HashkeyCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes415215 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
