 ...
 */
func (this *HashkeyCore) FetchTime(optionalArgs ...any) <-chan Res[*int64] {
...
func (this *HashkeyCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes252319 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes252319)
			ch <- retRes252319
			return nil
		} else if IsTrue(GetValue(market, "swap")) {

			retRes252519 := (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
...
func (this *HashkeyCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes255115 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *HashkeyCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes330319 := (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
			PanicOnError(retRes330319)
			ch <- retRes330319
			return nil
		} else if IsTrue(IsEqual(marketType, "swap")) {

			retRes330519 := (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
...
func (this *HashkeyCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes401815 := (<-this.FetchPositionsForSymbol(GetValue(symbols, 0), this.Extend(map[string]any{
			"methodName": "fetchPositions",
		}, params)))
		PanicOnError(retRes401815)
		ch <- retRes401815
		return nil
...
func (this *HashkeyCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes419712 := (<-this.LoadMarkets())
			PanicOnError(retRes419712)
		}
		...
		retRes421415 := (<-this.PrivatePostApiV1FuturesMarginType(this.Extend(request, params)))
...
func (this *HashkeyCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes422915 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *HashkeyCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes424415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *HashkeyCore) FetchTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes447312 := (<-this.LoadMarkets())
			PanicOnError(retRes447312)
		}
