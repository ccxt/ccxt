...
func (this *Hashkey) FetchOpenSpotOrders(options ...FetchOpenSpotOrdersOptions) ([]Order, error) {
	...
	res := AwaitResult(this.FetchOpenSpotOrdersAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return NewOrderArray(res.Value), nil
...
func (this *Hashkey) FetchOpenSwapOrders(options ...FetchOpenSwapOrdersOptions) ([]Order, error) {
	...
	res := AwaitResult(this.FetchOpenSwapOrdersAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return NewOrderArray(res.Value), nil
