...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes60086 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes60086)
        ch <- retRes60086
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes704204 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes704204)
        ch <- retRes704204
                return nil
