...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes3920 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes3920)
        ch <- retRes3920
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes674843 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes674843)
        ch <- retRes674843
                return nil
