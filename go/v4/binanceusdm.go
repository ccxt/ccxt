...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes987853 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes987853)
        ch <- retRes987853
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes75853 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes75853)
        ch <- retRes75853
                return nil
