...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes448856 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes448856)
        ch <- retRes448856
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes4290 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes4290)
        ch <- retRes4290
                return nil
