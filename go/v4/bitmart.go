...
func  (this *bitmart) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes210819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
                    PanicOnError(retRes210819)
                    ch <- retRes210819
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitmart) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes275415 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func  (this *bitmart) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes31558 := (<-this.LoadMarkets())
            PanicOnError(retRes31558)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitmart) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes359315 :=  (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
...
func  (this *bitmart) FetchTransactionsByType(typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38308 := (<-this.LoadMarkets())
            PanicOnError(retRes38308)
            if IsTrue(IsEqual(limit, nil)) {
                limit = 1000 // max 1000
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bitmart) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes393615 :=  (<-this.FetchTransactionsByType("deposit", code, since, limit, params))
                PanicOnError(retRes393615)
                ch <- retRes393615
                return nil
...
func  (this *bitmart) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes399415 :=  (<-this.FetchTransactionsByType("withdraw", code, since, limit, params))
...
func  (this *bitmart) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes471415 :=  (<-this.PrivatePostContractPrivateSubmitLeverage(this.Extend(request, params)))
...
func  (this *bitmart) FetchWithdrawAddresses(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes54578 := (<-this.LoadMarkets())
            PanicOnError(retRes54578)
...
func  (this *bitmart) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes553115 :=  (<-this.PrivatePostContractPrivateSetPositionMode(this.Extend(request, params)))
                PanicOnError(retRes553115)
                    //
            // {
            //     "code": 1000,
