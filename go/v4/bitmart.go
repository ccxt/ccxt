...
func (this *BitmartCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes213119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *BitmartCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes278915 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *BitmartCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes374115 := (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
...
func (this *BitmartCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes387712 := (<-this.LoadMarkets())
			PanicOnError(retRes387712)
		}
		var currency any = this.Currency(code)
		var network any = nil
		networkparamsVariable := this.HandleNetworkCodeAndParams(params)
...
func (this *BitmartCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes410915 := (<-this.FetchTransactionsByType("deposit", code, since, limit, params))
		PanicOnError(retRes410915)
		ch <- retRes410915
		return nil
...
func (this *BitmartCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes416915 := (<-this.FetchTransactionsByType("withdraw", code, since, limit, params))
		PanicOnError(retRes416915)
		ch <- retRes416915
		return nil
...
func (this *BitmartCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes438512 := (<-this.LoadMarkets())
			PanicOnError(retRes438512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitmartCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes489712 := (<-this.LoadMarkets())
			PanicOnError(retRes489712)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
		...
		retRes490815 := (<-this.PrivatePostContractPrivateSubmitLeverage(this.Extend(request, params)))
...
func (this *BitmartCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes576715 := (<-this.PrivatePostContractPrivateSetPositionMode(this.Extend(request, params)))
