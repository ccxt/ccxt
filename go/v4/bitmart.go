...
func (this *BitmartCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes370115 := (<-this.FetchOrdersByStatus("canceled", symbol, since, limit, params))
...
func (this *BitmartCore) FetchDeposit(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes40148 := (<-this.LoadMarkets())
		PanicOnError(retRes40148)
		var request any = map[string]any{
			"id": id,
		}
...
func (this *BitmartCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes405815 := (<-this.FetchTransactionsByType("deposit", code, since, limit, params))
		PanicOnError(retRes405815)
		ch <- retRes405815
		return nil
...
func (this *BitmartCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes411615 := (<-this.FetchTransactionsByType("withdraw", code, since, limit, params))
...
func (this *BitmartCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes483715 := (<-this.PrivatePostContractPrivateSubmitLeverage(this.Extend(request, params)))
...
func (this *BitmartCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes48508 := (<-this.LoadMarkets())
		PanicOnError(retRes48508)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
...
func (this *BitmartCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes56568 := (<-this.LoadMarkets())
		PanicOnError(retRes56568)
		...
		retRes567615 := (<-this.PrivatePostContractPrivateSetPositionMode(this.Extend(request, params)))
