...
func (this *Woo) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if timestampString != nil {
		if func() int {
			...
			return strings.Index(*timestampString, ".")
		}() > -1 {
...
func (this *Woo) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"reduceOnly", "reduce_only"}))
	...
	if isMarket && !isConditional {
		...
		params = MapTyped(this.Omit(params, []any{"cost", "order_amount", "orderAmount"}))
	...
	if isTrailing {
		if trailingTriggerPrice == nil {
			panic(ArgumentsRequired(this.Id + " createOrder() requires a trailingTriggerPrice parameter for trailing orders"))
		}
	...
	params = MapTyped(this.Omit(params, []any{"clOrdID", "clientOrderId", "client_order_id", "postOnly", "timeInForce", "stopPrice", "triggerPrice", "stopLoss", "takeProfit", "trailingPercent", "trailingAmount", "trailingTriggerPrice"}))
	var response map[string]any = nil
	if isConditional {

		response = MapTyped(PanicOnError((<-this.V3PrivatePostTradeAlgoOrder(this.Extend(request, params))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.V3PrivatePostTradeOrder(this.Extend(request, params))).Raw))
	}
...
func (this *Woo) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var triggerPrice *float64 = this.SafeNumberN(params, []any{"triggerPrice", "stopPrice", "takeProfitPrice", "stopLossPrice"})
	if triggerPrice != nil {
		request["triggerPrice"] = this.PriceToPrecision(symbol, triggerPrice)
	}
	var trailingTriggerPrice *string = this.SafeString2(params, "trailingTriggerPrice", "activatedPrice", this.NumberToString(price))
	...
	params = MapTyped(this.Omit(params, []any{"clOrdID", "clientOrderId", "client_order_id", "stopPrice", "triggerPrice", "takeProfitPrice", "stopLossPrice", "trailingTriggerPrice", "trailingAmount", "trailingPercent", "trigger", "stop"}))
	...
	if isConditional {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivatePutTradeAlgoOrder(this.Extend(request, params))).Raw))
	} else {
		if isByClientOrder {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivatePutTradeOrder(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "success": true,
...
func (this *Woo) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if isTrigger != nil && *isTrigger == true {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivateDeleteTradeAlgoOrder(this.Extend(request, params))).Raw))
	} else {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivateDeleteTradeOrder(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "success": true,
...
func (this *Woo) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if trigger != nil && *trigger == true {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivateDeleteTradeAlgoOrders(params)).Raw))
	} else {
		// cancels both regular and algo orders

		response = MapTyped(PanicOnError((<-this.V3PrivateDeleteTradeAllOrders(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "success": true,
...
func (this *Woo) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if trigger != nil && *trigger == true {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivateGetTradeAlgoOrder(this.Extend(request, params))).Raw))
	} else {
		if clientOrderId != nil {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivateGetTradeOrder(this.Extend(request, params))).Raw))
	}
	var data map[string]any = MapTyped(this.SafeDict(response, "data", map[string]any{}))
...
func (this *Woo) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes194819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchOrders", symbol, since, limit, params, "page", 500))))
		ch <- BoxAbsent(retRes194819)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market map[string]any = nil
	...
	if trigger != nil && *trigger == true {
		...
		response = MapTyped(PanicOnError((<-this.V3PrivateGetTradeAlgoOrders(this.Extend(request, params))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.V3PrivateGetTradeOrders(this.Extend(request, params))).Raw))
	}
	var data map[string]any = SafeMapTyped(response, "data")
...
func (this *Woo) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes208715 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))))
	ch <- BoxAbsent(retRes208715)
	return nil
}
...
func (this *Woo) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes211215 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, extendedParams))))
...
func (this *Woo) ParseOrder(order any, optionalArgs ...any) any {
	...
	if timestrampString != nil {
		if func() int {
			...
			return strings.Index(*timestrampString, ".")
		}() >= 0 {
	...
	var fee *float64 = this.SafeNumber(order, "totalFee")
	...
	if lastUpdateTimestampString != nil {
		if func() int {
			...
			return strings.Index(*lastUpdateTimestampString, ".")
		}() >= 0 {
...
func (this *Woo) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes264519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchMyTrades", symbol, since, limit, params, "page", 500))))
		ch <- BoxAbsent(retRes264519)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market map[string]any = nil
...
func (this *Woo) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes310115 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes310115)
	return nil
}
...
func (this *Woo) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes311915 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes311915)
	return nil
}
...
func (this *Woo) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes364519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchFundingHistory", symbol, since, limit, params, "page", 500))))
...
func (this *Woo) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes386719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))))
		ch <- BoxAbsent(retRes386719)
		return nil
	}
	if symbol == nil {
...
func (this *Woo) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "spot") == true {
		...
		var marginMode any = nil
		var marginModeparamsVariable []any = this.HandleMarginModeAndParams("fetchLeverage", params, "cross")
		marginMode = GetValue(marginModeparamsVariable, 0)
		params = MapTyped(GetValue(marginModeparamsVariable, 1))
		request["marginMode"] = this.EncodeMarginMode(marginMode)

		response = MapTyped(PanicOnError((<-this.V3PrivateGetFuturesLeverage(this.Extend(request, params))).Raw))
	} else {
...
func (this *Woo) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes413915 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, "ADD", params))))
	ch <- BoxAbsent(retRes413915)
	return nil
}
...
func (this *Woo) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes415415 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, "REDUCE", params))))
	ch <- BoxAbsent(retRes415415)
	return nil
}
...
func (this *Woo) ParseConversion(conversion any, optionalArgs ...any) any {
	...
	var fromCode *string = this.SafeCurrencyCode(fromCurr, fromCurrency)
...
func (this *Woo) CreateTrailingAmountOrder(symbol string, typeVar string, side string, amount float64, options ...CreateTrailingAmountOrderOptions) (Order, error) {
	...
	var res AsyncResult[Order] = AwaitResult(NewOrder, this.CreateTrailingAmountOrderAsync(symbol, typeVar, side, amount, opts.Price, opts.TrailingAmount, opts.TrailingTriggerPrice, opts.Params))
	if res.Err != nil {
		return Order{}, res.Err
	}
	return res.Value, nil
...
// nolint
func (this *Woo) LoadMarkets(params ...any) (map[string]MarketInterface, error) {
...
func (this *Woo) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {
...
func (this *Woo) FetchBorrowRate(code string, amount float64, options ...FetchBorrowRateOptions) (map[string]any, error) {
...
func (this *Woo) FetchCrossBorrowRates(params ...any) (CrossBorrowRates, error) {
...
func (this *Woo) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {
	return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)
}
func (this *Woo) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {
	return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)
}
func (this *Woo) FetchDepositWithdrawFees(options ...FetchDepositWithdrawFeesOptions) (DepositWithdrawFees, error) {
	return this.exchangeTyped.FetchDepositWithdrawFees(options...)
}
func (this *Woo) FetchFreeBalance(params ...any) (Balance, error) {
...
func (this *Woo) FetchIsolatedBorrowRates(params ...any) (IsolatedBorrowRates, error) {
...
func (this *Woo) FetchPositionMode(options ...FetchPositionModeOptions) (PositionModeInfo, error) {
...
func (this *Woo) FetchTransactionFee(code string, options ...FetchTransactionFeeOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchTransactionFee(code, options...)
}
func (this *Woo) FetchTransactionFees(options ...FetchTransactionFeesOptions) (map[string]any, error) {
...
func (this *Woo) SetMarginMode(marginMode string, options ...SetMarginModeOptions) (map[string]any, error) {
...
func (this *Woo) FetchBalanceWs(params ...any) (Balances, error) {
...
func (this *Woo) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {
...
func (this *Woo) FetchTradingFeesWs(params ...any) (TradingFees, error) {
	return this.exchangeTyped.FetchTradingFeesWs(params...)
}
func (this *Woo) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {
	return this.exchangeTyped.FetchWithdrawalsWs(options...)
}
func (this *Woo) UnWatchBidsAsks(options ...UnWatchBidsAsksOptions) (any, error) {
	return this.exchangeTyped.UnWatchBidsAsks(options...)
}
func (this *Woo) UnWatchMyTrades(options ...UnWatchMyTradesOptions) (any, error) {
	return this.exchangeTyped.UnWatchMyTrades(options...)
}
func (this *Woo) UnWatchOHLCV(symbol string, options ...UnWatchOHLCVOptions) (any, error) {
	return this.exchangeTyped.UnWatchOHLCV(symbol, options...)
}
func (this *Woo) UnWatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...UnWatchOHLCVForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchOHLCVForSymbols(symbolsAndTimeframes, options...)
}
func (this *Woo) UnWatchOrderBook(symbol string, options ...UnWatchOrderBookOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrderBook(symbol, options...)
}
func (this *Woo) UnWatchOrderBookForSymbols(symbols []string, options ...UnWatchOrderBookForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrderBookForSymbols(symbols, options...)
}
func (this *Woo) UnWatchOrders(options ...UnWatchOrdersOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrders(options...)
}
func (this *Woo) UnWatchTicker(symbol string, options ...UnWatchTickerOptions) (any, error) {
	return this.exchangeTyped.UnWatchTicker(symbol, options...)
}
func (this *Woo) UnWatchTickers(options ...UnWatchTickersOptions) (any, error) {
	return this.exchangeTyped.UnWatchTickers(options...)
}
func (this *Woo) UnWatchTrades(symbol string, options ...UnWatchTradesOptions) (any, error) {
	return this.exchangeTyped.UnWatchTrades(symbol, options...)
}
func (this *Woo) UnWatchTradesForSymbols(symbols []string, options ...UnWatchTradesForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchTradesForSymbols(symbols, options...)
}
func (this *Woo) WatchBalance(params ...any) (Balances, error) {
