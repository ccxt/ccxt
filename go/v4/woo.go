...
func (this *WooCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes72112 := (<-this.LoadTimeDifference())
...
func (this *WooCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes128515 := (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
...
func (this *WooCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130615 := (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
...
func (this *WooCore) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes133315 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
		PanicOnError(retRes133315)
		ch <- retRes133315
		return nil
...
func (this *WooCore) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes136015 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
		PanicOnError(retRes136015)
		ch <- retRes136015
		return nil
...
func (this *WooCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes194019 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
...
func (this *WooCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes207915 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
		PanicOnError(retRes207915)
		ch <- retRes207915
		return nil
...
func (this *WooCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes210415 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *WooCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes247619 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *WooCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes292915 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
		PanicOnError(retRes292915)
		ch <- retRes292915
		return nil
...
func (this *WooCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes294715 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *WooCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes305412 := (<-this.LoadMarkets())
			PanicOnError(retRes305412)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"token":  GetValue(currency, "id"),
...
func (this *WooCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes347319 := (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *WooCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes358815 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes358815)
		ch <- retRes358815
		return nil
...
func (this *WooCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes369012 := (<-this.LoadMarkets())
			PanicOnError(retRes369012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes369519 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
			PanicOnError(retRes369519)
			ch <- retRes369519
			return nil
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *WooCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(this.SafeBool(market, "spot"))) {
			...
			retRes394319 := (<-this.V3PrivatePostSpotMarginLeverage(this.Extend(request, params)))
			...
			retRes394919 := (<-this.V3PrivatePutFuturesLeverage(this.Extend(request, params)))
...
func (this *WooCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes396715 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes396715)
		ch <- retRes396715
		return nil
...
func (this *WooCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes398215 := (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
		PanicOnError(retRes398215)
		ch <- retRes398215
		return nil
...
func (this *WooCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes399615 := (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
		PanicOnError(retRes399615)
		ch <- retRes399615
		return nil
...
func (this *WooCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes401012 := (<-this.LoadMarkets())
			PanicOnError(retRes401012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *WooCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes431012 := (<-this.LoadMarkets())
			PanicOnError(retRes431012)
		}
		var request any = map[string]any{
			"quoteId": id,
		}
...
func (this *WooCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes435812 := (<-this.LoadMarkets())
			PanicOnError(retRes435812)
		}
		var request any = map[string]any{}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
		request = GetValue(requestparamsVariable, 0)
