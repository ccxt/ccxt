...
func (this *WooCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes335715 := (<-this.FetchFundingRate(symbol, params))
...
func (this *WooCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes34548 := (<-this.LoadMarkets())
		PanicOnError(retRes34548)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes345819 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
			PanicOnError(retRes345819)
			ch <- retRes345819
			return nil
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *WooCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes36938 := (<-this.LoadMarkets())
		PanicOnError(retRes36938)
		var request interface{} = map[string]interface{}{
			"leverage": leverage,
		}
		var market interface{} = nil
		...
		if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(GetValue(market, "spot"))) {
			...
			retRes370219 := (<-this.V3PrivatePostSpotMarginLeverage(this.Extend(request, params)))
			PanicOnError(retRes370219)
			ch <- retRes370219
			return nil
		} else if IsTrue(GetValue(market, "swap")) {
			AddElementToObject(request, "symbol", GetValue(market, "id"))
			...
			retRes370819 := (<-this.V3PrivatePutFuturesLeverage(this.Extend(request, params)))
...
func (this *WooCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes372615 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes372615)
		ch <- retRes372615
		return nil
...
func (this *WooCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes374115 := (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
		PanicOnError(retRes374115)
		ch <- retRes374115
		return nil
...
func (this *WooCore) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes375315 := (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
...
func (this *WooCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes37668 := (<-this.LoadMarkets())
		PanicOnError(retRes37668)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *WooCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes38198 := (<-this.LoadMarkets())
		PanicOnError(retRes38198)
...
func (this *WooCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes40958 := (<-this.LoadMarkets())
		PanicOnError(retRes40958)
		var request interface{} = map[string]interface{}{}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
		request = GetValue(requestparamsVariable, 0)
		params = GetValue(requestparamsVariable, 1)
...
func (this *WooCore) FetchConvertCurrencies(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes41948 := (<-this.LoadMarkets())
		PanicOnError(retRes41948)
...
func (this *WooCore) FetchPositionsADLRank(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes42578 := (<-this.LoadMarkets())
		PanicOnError(retRes42578)
