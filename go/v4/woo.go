...
func (this *Woo) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes374915 := (<-this.FetchFundingRateAsync(symbol, params))
...
func (this *Woo) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes376312 := (<-this.LoadMarketsAsync())
...
func (this *Woo) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes380712 := (<-this.LoadMarketsAsync())
...
func (this *Woo) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes385619 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func (this *Woo) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes395612 := (<-this.LoadMarketsAsync())
...
func (this *Woo) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if (symbol == nil) || (IsEqual(this.SafeBool(market, "spot"), true)) {
		...
		retRes410419 := (<-this.V3PrivatePostSpotMarginLeverage(this.Extend(request, params)))
		PanicOnError(retRes410419)
		ch <- retRes410419
		return nil
		...
		retRes411019 := (<-this.V3PrivatePutFuturesLeverage(this.Extend(request, params)))
		PanicOnError(retRes411019)
		ch <- retRes411019
		return nil
	} else {
...
func (this *Woo) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes412815 := (<-this.ModifyMarginHelperAsync(symbol, amount, "ADD", params))
	PanicOnError(retRes412815)
	ch <- retRes412815
	return nil
}
...
func (this *Woo) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes414315 := (<-this.ModifyMarginHelperAsync(symbol, amount, "REDUCE", params))
	PanicOnError(retRes414315)
	ch <- retRes414315
	return nil
}
...
func (this *Woo) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes414812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes414812)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol":        market["id"],
	...
	retRes415715 := (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
	PanicOnError(retRes415715)
	ch <- retRes415715
	return nil
}
...
func (this *Woo) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes417112 := (<-this.LoadMarketsAsync())
...
func (this *Woo) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes439312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes439312)
	}
	var request map[string]any = map[string]any{
...
func (this *Woo) fetchConvertTradeBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes447112 := (<-this.LoadMarketsAsync())
...
func (this *Woo) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes451912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes451912)
	}
	var request any = map[string]any{}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
	request = GetValue(requestparamsVariable, 0)
...
func (this *Woo) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes462012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes462012)
	}
