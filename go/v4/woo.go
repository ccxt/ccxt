...
func (this *WooCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes72212 := (<-this.LoadTimeDifference())
...
func (this *WooCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes128615 := (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
		PanicOnError(retRes128615)
		ch <- retRes128615
		return nil
...
func (this *WooCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130715 := (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
...
func (this *WooCore) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes133415 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
		PanicOnError(retRes133415)
		ch <- retRes133415
		return nil
...
func (this *WooCore) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes136115 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
...
func (this *WooCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes194119 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
...
func (this *WooCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes208015 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *WooCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes210515 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
		PanicOnError(retRes210515)
		ch <- retRes210515
		return nil
...
func (this *WooCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes247719 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
			PanicOnError(retRes247719)
			ch <- retRes247719
			return nil
		}
		var request any = map[string]any{}
...
func (this *WooCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes293015 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *WooCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes294815 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *WooCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes347419 := (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
			PanicOnError(retRes347419)
			ch <- retRes347419
			return nil
		}
		var request any = map[string]any{}
...
func (this *WooCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes358915 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes358915)
		ch <- retRes358915
		return nil
...
func (this *WooCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes364712 := (<-this.LoadMarkets())
			PanicOnError(retRes364712)
		}
...
func (this *WooCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes369619 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
			PanicOnError(retRes369619)
			ch <- retRes369619
			return nil
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *WooCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes379612 := (<-this.LoadMarkets())
			PanicOnError(retRes379612)
		}
		var market any = this.Market(symbol)
		var response any = nil
		if IsTrue(GetValue(market, "spot")) {
...
func (this *WooCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(this.SafeBool(market, "spot"))) {
			...
			retRes394419 := (<-this.V3PrivatePostSpotMarginLeverage(this.Extend(request, params)))
			PanicOnError(retRes394419)
			ch <- retRes394419
			return nil
			...
			retRes395019 := (<-this.V3PrivatePutFuturesLeverage(this.Extend(request, params)))
			PanicOnError(retRes395019)
			ch <- retRes395019
			return nil
		} else {
...
func (this *WooCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes396815 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes396815)
		ch <- retRes396815
		return nil
...
func (this *WooCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes398315 := (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
		PanicOnError(retRes398315)
		ch <- retRes398315
		return nil
...
func (this *WooCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes398812 := (<-this.LoadMarkets())
			PanicOnError(retRes398812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":        GetValue(market, "id"),
		...
		retRes399715 := (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
		PanicOnError(retRes399715)
		ch <- retRes399715
		return nil
...
func (this *WooCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes401112 := (<-this.LoadMarkets())
			PanicOnError(retRes401112)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *WooCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes406612 := (<-this.LoadMarkets())
			PanicOnError(retRes406612)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbols, nil)) {
