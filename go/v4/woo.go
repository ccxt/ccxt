...
func (this *WooCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes192919 := (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
			PanicOnError(retRes192919)
			ch <- retRes192919
			return nil
		}
		var request any = map[string]any{}
...
func (this *WooCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes206815 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func (this *WooCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes209315 := (<-this.FetchOrders(symbol, since, limit, extendedParams))
		PanicOnError(retRes209315)
		ch <- retRes209315
		return nil
...
func (this *WooCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes246019 := (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
...
func (this *WooCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes291015 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func (this *WooCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes346519 := (<-this.FetchPaginatedCallIncremental("fetchFundingHistory", symbol, since, limit, params, "page", 500))
...
func (this *WooCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes358015 := (<-this.FetchFundingRate(symbol, params))
...
func (this *WooCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes363812 := (<-this.LoadMarkets())
			PanicOnError(retRes363812)
		}
...
func (this *WooCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes368719 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func (this *WooCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes392512 := (<-this.LoadMarkets())
			PanicOnError(retRes392512)
		}
		var request any = map[string]any{
			"leverage": leverage,
		}
		...
		if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(this.SafeBool(market, "spot"))) {
			...
			retRes393519 := (<-this.V3PrivatePostSpotMarginLeverage(this.Extend(request, params)))
			...
			retRes394119 := (<-this.V3PrivatePutFuturesLeverage(this.Extend(request, params)))
...
func (this *WooCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes395915 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func (this *WooCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes397415 := (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
		PanicOnError(retRes397415)
		ch <- retRes397415
		return nil
...
func (this *WooCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes398815 := (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
		PanicOnError(retRes398815)
		ch <- retRes398815
		return nil
...
func (this *WooCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes400212 := (<-this.LoadMarkets())
			PanicOnError(retRes400212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *WooCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes421512 := (<-this.LoadMarkets())
			PanicOnError(retRes421512)
		}
		var request any = map[string]any{
...
func (this *WooCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes426112 := (<-this.LoadMarkets())
			PanicOnError(retRes426112)
		}
		var request any = map[string]any{
			"quoteId": id,
		}
