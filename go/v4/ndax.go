...
func (this *NdaxCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes233215 := (<-this.FetchDepositAddress(code, this.Extend(request, params)))
