...
func (this *Ndax) signInBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Login, nil) || IsEqual(this.Password, nil) {
		panic(AuthenticationError(this.Id + " signIn() requires exchange.login, exchange.password"))
	}
...
func (this *Ndax) ParseOrderBook(orderbook any, symbol any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(orderbook); i++ {
		...
		retRes71412 := GetValue(result, side)
		AppendToArray(&retRes71412, bidask)
	}
...
func (this *Ndax) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes86712 := (<-this.LoadMarketsAsync())
...
func (this *Ndax) fetchAccountsBody(ch chan any, optionalArgs ...any) any {
	...
	if (IsEqual(this.Login, nil)) || (this.Login == "") {
		panic(AuthenticationError(this.Id + " fetchAccounts() requires exchange.login email credential"))
	}
	var omsId *int64 = this.SafeInteger(this.Options, "omsId", 1)
	this.CheckRequiredCredentials()
	var request map[string]any = map[string]any{
...
func (this *Ndax) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes129512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes129512)
	}

	retRes12978 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes143312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes143312)
	}

	retRes14358 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes16028 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes16818 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes17478 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes183412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes183412)
	}

	retRes18368 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes18808 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes192112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes192112)
	}

	retRes19238 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes20058 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes21028 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes218212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes218212)
	}

	retRes21848 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes226412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes226412)
	}

	retRes22668 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) createDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	retRes234115 := (<-this.FetchDepositAddressAsync(code, this.Extend(request, params)))
...
func (this *Ndax) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes23608 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes24238 := (<-this.LoadAccountsAsync())
...
func (this *Ndax) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if sessionToken == nil {
		panic(AuthenticationError(this.Id + " call signIn() method to obtain a session token"))
	}
	if IsEqual(this.Twofa, nil) {
		panic(AuthenticationError(this.Id + " withdraw() requires exchange.twofa credentials"))
	}
	this.CheckAddress(address)
	var omsId *int64 = this.SafeInteger(this.Options, "omsId", 1)
	if this.Markets == nil {

		retRes263812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes263812)
	}

	retRes26408 := (<-this.LoadAccountsAsync())
