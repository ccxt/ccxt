...
func (this *ExchangeTyped) FetchDepositWithdrawFees(options ...FetchDepositWithdrawFeesOptions) (map[string]DepositWithdrawFeeNetwork, error) {
	...
	if IsError(res) {
		return map[string]DepositWithdrawFeeNetwork{}, CreateReturnError(res)
	}
	return nil, nil
}
func (this *ExchangeTyped) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFeeNetwork, error) {
	...
	if IsError(res) {
		return DepositWithdrawFeeNetwork{}, CreateReturnError(res)
	}
	return NewDepositWithdrawFeeNetwork(res), nil
}
...
func (this *ExchangeTyped) FetchDeposits(options ...FetchDepositsOptions) ([]Transaction, error) {
	...
	res := <-this.Exchange.FetchDeposits(symbol, since, limit, params)
	if IsError(res) {
		return nil, CreateReturnError(res)
	}
	return NewTransactionArray(res), nil
...
func (this *ExchangeTyped) FetchWithdrawals(options ...FetchWithdrawalsOptions) ([]Transaction, error) {
	...
	res := <-this.Exchange.FetchWithdrawals(symbol, since, limit, params)
	if IsError(res) {
		return nil, CreateReturnError(res)
	}
	return NewTransactionArray(res), nil
