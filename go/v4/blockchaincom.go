...
func (this *Blockchaincom) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var retRes43515 map[string]any = MapTyped(PanicOnError((<-this.FetchL3OrderBookAsync(symbol, limit, params))))
	ch <- BoxAbsent(retRes43515)
	return nil
}
...
func (this *Blockchaincom) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes79415 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStateAsync(state, symbol, since, limit, params))))
	ch <- BoxAbsent(retRes79415)
	return nil
}
...
func (this *Blockchaincom) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes81015 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStateAsync(state, symbol, since, limit, params))))
	ch <- BoxAbsent(retRes81015)
	return nil
}
...
func (this *Blockchaincom) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes82615 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStateAsync(state, symbol, since, limit, params))))
	ch <- BoxAbsent(retRes82615)
	return nil
}
...
func (this *Blockchaincom) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var orderId *string = this.SafeString(trade, "exOrdId")
...
func (this *Blockchaincom) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if rawAddress != nil {
		var addressParts []string = strings.Split(*rawAddress, ";")
