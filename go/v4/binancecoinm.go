...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes354357 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes354357)
        ch <- retRes354357
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes904876 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes904876)
        ch <- retRes904876
                return nil
