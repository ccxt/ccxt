...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes564646 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes564646)
        ch <- retRes564646
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes720501 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes720501)
        ch <- retRes720501
                return nil
