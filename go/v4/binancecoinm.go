...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes493064 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes493064)
        ch <- retRes493064
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes245109 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes245109)
        ch <- retRes245109
                return nil
