...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes271073 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes271073)
        ch <- retRes271073
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes100577 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes100577)
        ch <- retRes100577
                return nil
