...
func (this *PacificaCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes8408 := (<-this.LoadAccountSettings())
...
func (this *PacificaCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes9698 := (<-this.LoadAccountSettings())
...
func (this *PacificaCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes120119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, defaultMaxLimit))
...
func (this *PacificaCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes134619 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
			PanicOnError(retRes134619)
			ch <- retRes134619
			return nil
		}
		var request any = map[string]any{}
...
func (this *PacificaCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14928 := (<-this.InitializeClient())
...
func (this *PacificaCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes172012 := (<-this.LoadMarkets())
			PanicOnError(retRes172012)
		}

		retRes17228 := (<-this.InitializeClient())
...
func (this *PacificaCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes17788 := (<-this.InitializeClient())
...
func (this *PacificaCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18658 := (<-this.InitializeClient())
...
func (this *PacificaCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19208 := (<-this.InitializeClient())
...
func (this *PacificaCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19878 := (<-this.InitializeClient())
...
func (this *PacificaCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes205719 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
			PanicOnError(retRes205719)
			ch <- retRes205719
			return nil
		}
		var request any = map[string]any{
...
func (this *PacificaCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes232119 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
			PanicOnError(retRes232119)
			ch <- retRes232119
			return nil
		}
		var userAddress any = nil
...
func (this *PacificaCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes239712 := (<-this.LoadMarkets())
			PanicOnError(retRes239712)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *PacificaCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes302719 := (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
			PanicOnError(retRes302719)
			ch <- retRes302719
			return nil
		}
		var request any = map[string]any{
...
func (this *PacificaCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes314319 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
			PanicOnError(retRes314319)
			ch <- retRes314319
			return nil
		}
...
func (this *PacificaCore) BindAgentWallet(agentAddress any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes334115 := (<-this.PrivatePostAgentBind(this.Extend(request, params)))
...
func (this *PacificaCore) CreateApiKey(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes334815 := (<-this.PrivatePostAccountApiKeysCreate(this.Extend(request, params)))
...
func (this *PacificaCore) RevokeApiKey(apiKey any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes335715 := (<-this.PrivatePostAccountApiKeysRevoke(this.Extend(request, params)))
		PanicOnError(retRes335715)
		ch <- retRes335715
		return nil
...
func (this *PacificaCore) FetchApiKeys(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes336415 := (<-this.PrivatePostAccountApiKeys(this.Extend(request, params)))
...
func (this *PacificaCore) ApproveBuilderCode(builderCode any, maxFeeRate any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes337415 := (<-this.PrivatePostAccountBuilderCodesApprove(this.Extend(request, params)))
...
func (this *PacificaCore) FetchBuilderApprovals(address any) <-chan any {
	...
	go func() any {
		...
		retRes338115 := (<-this.PublicGetAccountBuilderCodesApprovals(this.Extend(request)))
...
func (this *PacificaCore) RevokeBuilderCode(builderCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes339015 := (<-this.PrivatePostAccountBuilderCodesRevoke(this.Extend(request, params)))
		PanicOnError(retRes339015)
		ch <- retRes339015
		return nil
