...
func (this *Pacifica) bindAgentWalletBody(ch chan any, agentAddress any, optionalArgs ...any) any {
	...
	retRes341215 := (<-this.PrivatePostAgentBind(this.Extend(request, params)))
	PanicOnError(retRes341215)
	ch <- retRes341215
	return nil
}
...
func (this *Pacifica) createApiKeyBody(ch chan any, optionalArgs ...any) any {
	...
	retRes341915 := (<-this.PrivatePostAccountApiKeysCreate(this.Extend(request, params)))
	PanicOnError(retRes341915)
	ch <- retRes341915
	return nil
}
...
func (this *Pacifica) revokeApiKeyBody(ch chan any, apiKey any, optionalArgs ...any) any {
	...
	retRes342815 := (<-this.PrivatePostAccountApiKeysRevoke(this.Extend(request, params)))
...
func (this *Pacifica) fetchApiKeysBody(ch chan any, optionalArgs ...any) any {
	...
	retRes343515 := (<-this.PrivatePostAccountApiKeys(this.Extend(request, params)))
...
func (this *Pacifica) approveBuilderCodeBody(ch chan any, builderCode any, maxFeeRate any, optionalArgs ...any) any {
	...
	retRes344515 := (<-this.PrivatePostAccountBuilderCodesApprove(this.Extend(request, params)))
...
func (this *Pacifica) fetchBuilderApprovalsBody(ch chan any, address any) any {
	...
	retRes345215 := (<-this.PublicGetAccountBuilderCodesApprovals(this.Extend(request)))
	PanicOnError(retRes345215)
	ch <- retRes345215
	return nil
}
...
func (this *Pacifica) revokeBuilderCodeBody(ch chan any, builderCode any, optionalArgs ...any) any {
	...
	retRes346115 := (<-this.PrivatePostAccountBuilderCodesRevoke(this.Extend(request, params)))
