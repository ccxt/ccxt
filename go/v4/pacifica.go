...
func (this *Pacifica) ParseMarket(market any) any {
	...
	if isSpot {
		var idParts []string = func() []string {
			if id == nil {
				return nil
			}
...
func (this *Pacifica) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes273512 := (<-this.LoadMarketsAsync())
...
func (this *Pacifica) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes284012 := (<-this.LoadMarketsAsync())
...
func (this *Pacifica) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes287412 := (<-this.LoadMarketsAsync())
...
func (this *Pacifica) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes290612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes290612)
	}
...
func (this *Pacifica) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes293012 := (<-this.LoadMarketsAsync())
...
func (this *Pacifica) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes309212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes309212)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes310019 := (<-this.FetchPaginatedCallCursorAsync("fetchLedger", code, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
...
func (this *Pacifica) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		retRes321619 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
