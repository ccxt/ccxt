...
func (this *PacificaCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes14978 := (<-this.InitializeClient())
...
func (this *PacificaCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	retRes17338 := (<-this.InitializeClient())
...
func (this *PacificaCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes178712 := (<-this.LoadMarkets())
		PanicOnError(retRes178712)
	}

	retRes17898 := (<-this.InitializeClient())
...
func (this *PacificaCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes187412 := (<-this.LoadMarkets())
		PanicOnError(retRes187412)
	}

	retRes18768 := (<-this.InitializeClient())
...
func (this *PacificaCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes19318 := (<-this.InitializeClient())
...
func (this *PacificaCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes19988 := (<-this.InitializeClient())
...
func (this *PacificaCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes207119 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
		PanicOnError(retRes207119)
		ch <- retRes207119
		return nil
	}
	var request map[string]any = map[string]any{
...
func (this *PacificaCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes233719 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
		PanicOnError(retRes233719)
		ch <- retRes233719
		return nil
	}
	var userAddress any = nil
...
func (this *PacificaCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes304019 := (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
...
func (this *PacificaCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes315619 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "next_cursor", "cursor", nil, defaultLimit))
		PanicOnError(retRes315619)
		ch <- retRes315619
		return nil
	}
...
func (this *PacificaCore) bindAgentWalletBody(ch chan any, agentAddress any, optionalArgs ...any) any {
	...
	retRes335415 := (<-this.PrivatePostAgentBind(this.Extend(request, params)))
...
func (this *PacificaCore) createApiKeyBody(ch chan any, optionalArgs ...any) any {
	...
	retRes336115 := (<-this.PrivatePostAccountApiKeysCreate(this.Extend(request, params)))
...
func (this *PacificaCore) revokeApiKeyBody(ch chan any, apiKey any, optionalArgs ...any) any {
	...
	retRes337015 := (<-this.PrivatePostAccountApiKeysRevoke(this.Extend(request, params)))
	PanicOnError(retRes337015)
	ch <- retRes337015
	return nil
}
...
func (this *PacificaCore) fetchApiKeysBody(ch chan any, optionalArgs ...any) any {
	...
	retRes337715 := (<-this.PrivatePostAccountApiKeys(this.Extend(request, params)))
	PanicOnError(retRes337715)
	ch <- retRes337715
	return nil
}
...
func (this *PacificaCore) approveBuilderCodeBody(ch chan any, builderCode any, maxFeeRate any, optionalArgs ...any) any {
	...
	retRes338715 := (<-this.PrivatePostAccountBuilderCodesApprove(this.Extend(request, params)))
...
func (this *PacificaCore) fetchBuilderApprovalsBody(ch chan any, address any) any {
	...
	retRes339415 := (<-this.PublicGetAccountBuilderCodesApprovals(this.Extend(request)))
...
func (this *PacificaCore) revokeBuilderCodeBody(ch chan any, builderCode any, optionalArgs ...any) any {
	...
	retRes340315 := (<-this.PrivatePostAccountBuilderCodesRevoke(this.Extend(request, params)))
	PanicOnError(retRes340315)
	ch <- retRes340315
	return nil
}
