...
func (this *PoloniexCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var keyStart any = Ternary((IsEqual(GetValue(market, "spot"), true)), "startTime", "sTime")
	var keyEnd any = Ternary((IsEqual(GetValue(market, "spot"), true)), "endTime", "eTime")
...
func (this *PoloniexCore) OrderRequest(symbol any, typeVar any, side any, amount any, request any, optionalArgs ...any) any {
	...
	if isMarket {
		if IsEqual(side, "buy") {
			...
			var amountKey any = Ternary((IsEqual(GetValue(market, "spot"), true)), "amount", "sz")
			AddElementToObject(request, amountKey, quoteAmount)
		} else {
			var amountKey any = Ternary((IsEqual(GetValue(market, "spot"), true)), "quantity", "sz")
			AddElementToObject(request, amountKey, this.AmountToPrecision(symbol, amount))
		}
	} else {
		var amountKey any = Ternary((IsEqual(GetValue(market, "spot"), true)), "quantity", "sz")
		AddElementToObject(request, amountKey, this.AmountToPrecision(symbol, amount))
		var priceKey any = Ternary((IsEqual(GetValue(market, "spot"), true)), "price", "px")
	...
	if clientOrderId != nil {
		...
		var clientOrderIdKey any = Ternary((IsEqual(GetValue(market, "spot"), true)), "clientOrderId", "clOrdId")
