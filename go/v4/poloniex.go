...
func (this *PoloniexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes152219 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *PoloniexCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes35488 := (<-this.LoadMarkets())
		PanicOnError(retRes35488)
		var market any = this.Market(symbol)
...
func (this *PoloniexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes361015 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), "reduce", params))
		PanicOnError(retRes361015)
		ch <- retRes361015
		return nil
...
func (this *PoloniexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes362315 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
