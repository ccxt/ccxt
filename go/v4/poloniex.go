...
func (this *PoloniexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes151319 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *PoloniexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes359715 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), "reduce", params))
...
func (this *PoloniexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes361015 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
