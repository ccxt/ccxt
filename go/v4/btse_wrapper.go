...
func (this *Btse) FetchAllGreeks(options ...FetchAllGreeksOptions) ([]Greeks, error) {
...
func (this *Btse) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) ([]DepositAddress, error) {
