...
func  (this *DydxCore) SignDydxTx(privateKey any, message any, memo any, chainId any, account any, authenticators any, optionalArgs ...any) any  {
    ...
    _ = fee
    encodedTxsignDocVariable := this.EncodeV4TxForSigning(message, memo, chainId, account, authenticators, fee);
...
func  (this *DydxCore) EstimateTxFee(message any, memo any, account any) <- chan any {
            ...
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
                    var txBytes any = this.EncodeV4TxForSimulation(message, memo, GetValue(account, "sequence"), GetValue(account, "pub_key"))
            var request any = map[string]any {
                "txBytes": txBytes,
            }
