...
func (this *Zaif) ParseBalance(response any) any {
	...
	if funds != nil {
		currencyIds = make([]string, 0, len(funds))
		for objectKey := range funds {
...
func (this *Zaif) withdrawBody(ch chan any, code string, amount any, address any, optionalArgs ...any) any {
	...
	if code == "JPY" {
		panic(ExchangeError(this.Id + " withdraw() does not allow " + code + " withdrawals"))
	}
	var request map[string]any = map[string]any{
...
func (this *Zaif) HandleErrors(httpCode any, reason any, url any, method any, headers any, body string, response any, requestHeaders any, requestBody any) any {
	if response == nil {
		return nil
	}
	//
