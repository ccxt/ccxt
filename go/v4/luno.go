...
func (this *Luno) ParseBalance(response any) any {
	...
	for i := 0; i < len(wallets); i++ {
		...
		if (code != nil) && (func() bool {
			...
			AddElementToObject(GetValue(result, code), "used", Precise.StringAdd(GetValue(func() any {
				if code == nil {
					return nil
				}
				return result[*code]
			}(), "used"), reservedUnconfirmed))
			AddElementToObject(GetValue(result, code), "total", Precise.StringAdd(GetValue(func() any {
				if code == nil {
					return nil
				}
				return result[*code]
...
func (this *Luno) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes90415 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStateAsync(nil, symbol, since, limit, params))))
	ch <- BoxAbsent(retRes90415)
	return nil
}
...
func (this *Luno) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes91915 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStateAsync("PENDING", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes91915)
	return nil
}
...
func (this *Luno) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes93415 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStateAsync("COMPLETE", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes93415)
	return nil
}
...
func (this *Luno) fetchLedgerByEntriesBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes141215 []any = ListTyped(PanicOnError((<-this.FetchLedgerAsync(code, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes141215)
	return nil
}
...
func (this *Luno) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsGreaterThan(Subtract(max_row, min_row), 1000) {
		panic(ExchangeError(this.Id + " fetchLedger() requires the params 'max_row' - 'min_row' <= 1000"))
	}
	var request map[string]any = map[string]any{
		"id":      id,
		"min_row": min_row,
