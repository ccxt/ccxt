...
func  (this *luno) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes72415 :=  (<-this.FetchOrdersByState(nil, symbol, since, limit, params))
                PanicOnError(retRes72415)
                ch <- retRes72415
                return nil
...
func  (this *luno) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes73915 :=  (<-this.FetchOrdersByState("PENDING", symbol, since, limit, params))
...
func  (this *luno) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes75415 :=  (<-this.FetchOrdersByState("COMPLETE", symbol, since, limit, params))
...
func  (this *luno) FetchLedgerByEntries(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes120915 :=  (<-this.FetchLedger(code, since, limit, this.Extend(request, params)))
