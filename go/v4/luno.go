...
func  (this *luno) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes725164 := (<-this.LoadMarkets())
            PanicOnError(retRes725164)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *luno) FetchOrdersByState(state interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes793596 := (<-this.LoadMarkets())
            PanicOnError(retRes793596)
            var request interface{} = map[string]interface{} {}
...
func  (this *luno) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes998757 :=  (<-this.FetchOrdersByState(nil, symbol, since, limit, params))
                PanicOnError(retRes998757)
                ch <- retRes998757
                return nil
...
func  (this *luno) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes416437 :=  (<-this.FetchOrdersByState("PENDING", symbol, since, limit, params))
                PanicOnError(retRes416437)
                ch <- retRes416437
                return nil
...
func  (this *luno) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes503426 :=  (<-this.FetchOrdersByState("COMPLETE", symbol, since, limit, params))
                PanicOnError(retRes503426)
                ch <- retRes503426
                return nil
...
func  (this *luno) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes756857 := (<-this.LoadMarkets())
            PanicOnError(retRes756857)
...
func  (this *luno) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes384629 := (<-this.LoadMarkets())
            PanicOnError(retRes384629)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes358668 := (<-this.LoadMarkets())
            PanicOnError(retRes358668)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes567498 := (<-this.LoadMarkets())
            PanicOnError(retRes567498)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *luno) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes750808 := (<-this.LoadMarkets())
            PanicOnError(retRes750808)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes60662 := (<-this.LoadMarkets())
            PanicOnError(retRes60662)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes455608 := (<-this.LoadMarkets())
            PanicOnError(retRes455608)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *luno) FetchLedgerByEntries(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes992676 :=  (<-this.FetchLedger(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes992676)
                ch <- retRes992676
                return nil
...
func  (this *luno) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes371335 := (<-this.LoadMarkets())
            PanicOnError(retRes371335)
        
            retRes369401 := (<-this.LoadAccounts())
            PanicOnError(retRes369401)
