...
func (this *mexc) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes115912 := (<-this.LoadTimeDifference())
			PanicOnError(retRes115912)
		}
...
func (this *mexc) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes176919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
			PanicOnError(retRes176919)
			ch <- retRes176919
			return nil
		}
...
func (this *mexc) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes221115 := (<-this.CreateOrder(symbol, "market", "buy", 0, nil, this.Extend(req, params)))
...
func (this *mexc) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes223315 := (<-this.CreateOrder(symbol, "market", "sell", 0, nil, this.Extend(req, params)))
		PanicOnError(retRes223315)
		ch <- retRes223315
		return nil
...
func (this *mexc) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes226819 := (<-this.CreateSpotOrder(market, typeVar, side, amount, price, marginMode, query))
			PanicOnError(retRes226819)
			ch <- retRes226819
			return nil
		} else {

			retRes227019 := (<-this.CreateSwapOrder(market, typeVar, side, amount, price, marginMode, query))
...
func (this *mexc) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes305419 := (<-this.FetchOrdersByState(2, symbol, since, limit, params))
			PanicOnError(retRes305419)
...
func (this *mexc) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes307215 := (<-this.FetchOrdersByState(3, symbol, since, limit, params))
...
func (this *mexc) FetchCanceledOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes308915 := (<-this.FetchOrdersByState(4, symbol, since, limit, params))
...
func (this *mexc) FetchOrdersByState(state interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes310419 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *mexc) FetchAccountHelper(typeVar interface{}, params interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(typeVar, "spot")) {
			...
			retRes364619 := (<-this.SpotPrivateGetAccount(params))
			PanicOnError(retRes364619)
			ch <- retRes364619
			return nil
...
func (this *mexc) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes41368 := (<-this.LoadMarkets())
		PanicOnError(retRes41368)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *mexc) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes423415 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
...
func (this *mexc) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes424815 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func (this *mexc) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes428115 := (<-this.ContractPrivatePostPositionChangeLeverage(this.Extend(request, params)))
		PanicOnError(retRes428115)
		ch <- retRes428115
		return nil
...
func (this *mexc) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes441715 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes441715)
		ch <- retRes441715
		return nil
...
func (this *mexc) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes44308 := (<-this.LoadMarkets())
		PanicOnError(retRes44308)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *mexc) FetchLeverageTiers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes45358 := (<-this.LoadMarkets())
		PanicOnError(retRes45358)
...
func (this *mexc) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes47518 := (<-this.LoadMarkets())
		PanicOnError(retRes47518)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin": GetValue(currency, "id"),
		}
...
func (this *mexc) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes48948 := (<-this.LoadMarkets())
		PanicOnError(retRes48948)
		var request interface{} = map[string]interface{}{}
		var currency interface{} = nil
		if IsTrue(!IsEqual(code, nil)) {
			currency = this.Currency(code)
...
func (this *mexc) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes50848 := (<-this.LoadMarkets())
		PanicOnError(retRes50848)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *mexc) FetchTransactionFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes56088 := (<-this.LoadMarkets())
		PanicOnError(retRes56088)
...
func (this *mexc) FetchDepositWithdrawFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes57098 := (<-this.LoadMarkets())
		PanicOnError(retRes57098)
...
func (this *mexc) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58008 := (<-this.LoadMarkets())
		PanicOnError(retRes58008)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
