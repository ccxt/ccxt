...
func (this *Mexc) CreateSpotOrderRequest(market any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var postOnlyparamsVariable []any = this.HandlePostOnly((IsEqual(typeVar, "market")), (IsEqual(typeVar, "LIMIT_MAKER")), params)
...
func (this *Mexc) createSwapOrderBody(ch chan any, market any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var postOnly any = nil
	var postOnlyparamsVariable []any = this.HandlePostOnly((IsEqual(typeVar, "market")), IsEqual(typeVar, 2), params)
	postOnly = GetValue(postOnlyparamsVariable, 0)
	params = MapTyped(GetValue(postOnlyparamsVariable, 1))
	if postOnly == true {
		typeVar = 2
	...
	if hedged != nil && *hedged == true {
		if reduceOnly != nil && *reduceOnly == true {
			params = MapTyped(this.Omit(params, "reduceOnly")) // hedged mode does not accept this parameter
...
func (this *Mexc) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		var clientOrderId *string = this.SafeString(params, "clientOrderId")
		if clientOrderId != nil {
			params = MapTyped(this.Omit(query, "clientOrderId"))
...
func (this *Mexc) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"margin", "marginMode"}))
	var response any = nil
	if (marginMode != nil) || (isMargin != nil && *isMargin == true) || (IsEqual(marketType, "margin")) {
		...
		params = MapTyped(this.Omit(params, []any{"symbol", "symbols"}))
...
func (this *Mexc) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if internal != nil && *internal == true {
		params = MapTyped(this.Omit(params, "internal"))
...
func (this *Mexc) CreateMarketSellOrderWithCost(symbol string, cost float64, options ...CreateMarketSellOrderWithCostOptions) (Order, error) {
	...
	res := AwaitResult(this.CreateMarketSellOrderWithCostAsync(symbol, cost, opts.Params))
	if res.Err != nil {
		return Order{}, res.Err
	}
	return NewOrder(res.Value), nil
...
func (this *Mexc) FetchOrdersByIds(ids []string, options ...FetchOrdersByIdsOptions) ([]Order, error) {
	...
	res := AwaitResult(this.FetchOrdersByIdsAsync(ids, opts.Symbol, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return NewOrderArray(res.Value), nil
...
func (this *Mexc) FetchAccountHelper(typeVar string, options ...FetchAccountHelperOptions) (map[string]any, error) {
	...
	res := AwaitResult(this.FetchAccountHelperAsync(typeVar, opts.Params))
	if res.Err != nil {
