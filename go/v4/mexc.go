...
func (this *MexcCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes311719 := (<-this.FetchOrdersByState(2, symbol, since, limit, params))
...
func (this *MexcCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes313515 := (<-this.FetchOrdersByState(3, symbol, since, limit, params))
...
func (this *MexcCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes315215 := (<-this.FetchOrdersByState(4, symbol, since, limit, params))
		PanicOnError(retRes315215)
		ch <- retRes315215
		return nil
...
func (this *MexcCore) FetchOrdersByState(state any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes316719 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *MexcCore) FetchAccountHelper(typeVar any, params any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(typeVar, "spot")) {
			...
			retRes371019 := (<-this.SpotPrivateGetAccount(params))
			PanicOnError(retRes371019)
			ch <- retRes371019
			return nil
...
func (this *MexcCore) FetchTradingFee(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes38048 := (<-this.LoadMarkets())
		PanicOnError(retRes38048)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "spot")) {
...
func (this *MexcCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes42008 := (<-this.LoadMarkets())
		PanicOnError(retRes42008)
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *MexcCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes429815 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
...
func (this *MexcCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes431215 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes431215)
		ch <- retRes431215
		return nil
...
func (this *MexcCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes43268 := (<-this.LoadMarkets())
		PanicOnError(retRes43268)
		var request any = map[string]any{
			"leverage": leverage,
		}
		var positionId any = this.SafeInteger(params, "positionId")
		...
		retRes434515 := (<-this.ContractPrivatePostPositionChangeLeverage(this.Extend(request, params)))
		PanicOnError(retRes434515)
		ch <- retRes434515
		return nil
...
func (this *MexcCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes448915 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes448915)
		ch <- retRes448915
		return nil
...
func (this *MexcCore) FetchDepositAddressesByNetwork(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47728 := (<-this.LoadMarkets())
		PanicOnError(retRes47728)
...
func (this *MexcCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes48228 := (<-this.LoadMarkets())
		PanicOnError(retRes48228)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin": GetValue(currency, "id"),
		}
...
func (this *MexcCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes51618 := (<-this.LoadMarkets())
		PanicOnError(retRes51618)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *MexcCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes51808 := (<-this.LoadMarkets())
		PanicOnError(retRes51808)
...
func (this *MexcCore) FetchTransfer(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53328 := (<-this.LoadMarkets())
		PanicOnError(retRes53328)
		if IsTrue(IsEqual(marketType, "spot")) {
			var request any = map[string]any{
				"transact_id": id,
			}
...
func (this *MexcCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes56408 := (<-this.LoadMarkets())
		PanicOnError(retRes56408)
		var currency any = this.Currency(code)
...
func (this *MexcCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes60398 := (<-this.LoadMarkets())
		PanicOnError(retRes60398)
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *MexcCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes61108 := (<-this.LoadMarkets())
		PanicOnError(retRes61108)
		var market any = this.Market(symbol)
		if IsTrue(GetValue(market, "spot")) {
