...
func (this *MexcCore) FetchCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
			...
			var chains any = this.SafeValue(currency, "networkList", []any{})
...
func (this *MexcCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes121712 := (<-this.LoadTimeDifference())
...
func (this *MexcCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes182719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, maxLimit))
...
func (this *MexcCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes227515 := (<-this.CreateOrder(symbol, "market", "buy", 0, nil, this.Extend(req, params)))
		PanicOnError(retRes227515)
		ch <- retRes227515
		return nil
...
func (this *MexcCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes229715 := (<-this.CreateOrder(symbol, "market", "sell", 0, nil, this.Extend(req, params)))
		PanicOnError(retRes229715)
		ch <- retRes229715
		return nil
...
func (this *MexcCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes233319 := (<-this.CreateSpotOrder(market, typeVar, side, amount, price, marginMode, query))
			PanicOnError(retRes233319)
			ch <- retRes233319
			return nil
		} else {

			retRes233519 := (<-this.CreateSwapOrder(market, typeVar, side, amount, price, marginMode, query))
			PanicOnError(retRes233519)
			ch <- retRes233519
			return nil
		}
...
func (this *MexcCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes314015 := (<-this.FetchOrdersByState(3, symbol, since, limit, params))
		PanicOnError(retRes314015)
		ch <- retRes314015
		return nil
...
func (this *MexcCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes315715 := (<-this.FetchOrdersByState(4, symbol, since, limit, params))
		PanicOnError(retRes315715)
		ch <- retRes315715
		return nil
...
func (this *MexcCore) FetchOrdersByState(state any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes317219 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
			PanicOnError(retRes317219)
			ch <- retRes317219
			return nil
		}
...
func (this *MexcCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes33038 := (<-this.LoadMarkets())
		PanicOnError(retRes33038)
...
func (this *MexcCore) FetchAccountHelper(typeVar any, params any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(typeVar, "spot")) {
			...
			retRes371519 := (<-this.SpotPrivateGetAccount(params))
...
func (this *MexcCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes41098 := (<-this.LoadMarkets())
		PanicOnError(retRes41098)
		var market any = this.Market(symbol)
		var marketType any = nil
...
func (this *MexcCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes42058 := (<-this.LoadMarkets())
		PanicOnError(retRes42058)
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *MexcCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes42778 := (<-this.LoadMarkets())
		PanicOnError(retRes42778)
		var request any = map[string]any{
...
func (this *MexcCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes430315 := (<-this.ModifyMarginHelper(symbol, amount, "SUB", params))
		PanicOnError(retRes430315)
		ch <- retRes430315
		return nil
...
func (this *MexcCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes431715 := (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
		PanicOnError(retRes431715)
		ch <- retRes431715
		return nil
...
func (this *MexcCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes435015 := (<-this.ContractPrivatePostPositionChangeLeverage(this.Extend(request, params)))
		PanicOnError(retRes435015)
		ch <- retRes435015
		return nil
...
func (this *MexcCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes43658 := (<-this.LoadMarkets())
		PanicOnError(retRes43658)
		var market any = nil
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *MexcCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes449415 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes449415)
		ch <- retRes449415
		return nil
...
func (this *MexcCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes46128 := (<-this.LoadMarkets())
		PanicOnError(retRes46128)
...
func (this *MexcCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes49068 := (<-this.LoadMarkets())
		PanicOnError(retRes49068)
		var request any = map[string]any{}
...
func (this *MexcCore) FetchTransfer(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53378 := (<-this.LoadMarkets())
		PanicOnError(retRes53378)
		if IsTrue(IsEqual(marketType, "spot")) {
			var request any = map[string]any{
				"transact_id": id,
			}
...
func (this *MexcCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes61158 := (<-this.LoadMarkets())
		PanicOnError(retRes61158)
		var market any = this.Market(symbol)
		if IsTrue(GetValue(market, "spot")) {
