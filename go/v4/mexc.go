...
func (this *Mexc) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var market any = this.Market(symbol)
	var maxLimit int = Ternary((IsEqual(GetValue(market, "spot"), true)), 500, 2000).(int) // docs say 1000 for spot, but in practice it's 500
...
func (this *Mexc) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var typeVar string = Ternary((id == nil), "deposit", "withdrawal").(string)
...
func (this *Mexc) ParsePosition(position any, optionalArgs ...any) any {
	...
	var side string = Ternary((rawSide != nil && *rawSide == "1"), "long", "short").(string)
	var openType *string = this.SafeString(position, "margin_mode")
	var marginType string = Ternary((openType != nil && *openType == "1"), "isolated", "cross").(string)
