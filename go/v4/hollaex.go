...
func (this *Hollaex) ParseCurrency(rawCurrency any) any {
	...
	if rawNetworks != nil {
		networkIds = make([]string, 0, len(rawNetworks))
...
func (this *Hollaex) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	var fees map[string]any = this.SafeDictMap(firstTier, "fees", map[string]any{})
...
func (this *Hollaex) ParseDepositWithdrawFee(fee any, optionalArgs ...any) any {
	...
	if withdrawalFees != nil {
		var keys []string = nil
		if withdrawalFees != nil {
			keys = make([]string, 0, len(withdrawalFees))
