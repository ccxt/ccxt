...
func (this *Digifinex) fetchMarketsV2Body(ch chan any, optionalArgs ...any) any {
	...
	//     }
	//
	var spotData any = this.SafeList(spotMarkets, "symbol_list", []any{})
	var swapData any = this.SafeList(swapMarkets, "data", []any{})
...
func (this *Digifinex) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var balances any = this.SafeList(response, balanceRequest, []any{})
...
func (this *Digifinex) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	//
	var date *int64 = this.SafeInteger(response, "date")
	var tickers any = this.SafeList(response, "ticker", []any{})
	var data any = this.SafeDict(response, "data", map[string]any{})
	var firstTicker any = this.SafeDict(tickers, 0, map[string]any{})
	var result any = nil
	if GetValue(market, "swap") == true {
		result = data
	} else {
...
func (this *Digifinex) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes373512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes373512)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{}
	var marketType any = nil
...
func (this *Digifinex) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	retRes394815 := (<-this.PrivateSwapPostAccountLeverage(this.Extend(request, params)))
...
func (this *Digifinex) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes397512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes397512)
	}
	var currency any = nil
	var request map[string]any = map[string]any{}
	if code != nil {
...
func (this *Digifinex) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes402312 := (<-this.LoadMarketsAsync())
...
func (this *Digifinex) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes407112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes407112)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	if GetValue(market, "swap") != true {
...
func (this *Digifinex) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes419212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes419212)
	}
...
func (this *Digifinex) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes431615 := (<-this.ModifyMarginHelperAsync(symbol, amount, 1, params))
...
func (this *Digifinex) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes433315 := (<-this.ModifyMarginHelperAsync(symbol, amount, 2, params))
...
func (this *Digifinex) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes440712 := (<-this.LoadMarketsAsync())
...
func (this *Digifinex) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes447812 := (<-this.LoadMarketsAsync())
	...
	retRes448915 := (<-this.PrivateSwapPostAccountPositionMode(this.Extend(request, params)))
