...
func (this *Digifinex) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if typeVar != nil && *typeVar == "swap" {
		...
		response = MapTyped(PanicOnError((<-this.PublicSwapGetPublicTickers(this.Extend(request, params))).Raw))
	} else {
...
func (this *Digifinex) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	//
	var date *int64 = this.SafeInteger(response, "date")
	var tickers []any = SafeListTypedDefault(response, "ticker", []any{})
...
func (this *Digifinex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		response = MapTyped(PanicOnError((<-this.PublicSpotGetKline(this.Extend(request, params))).Raw))
	}
	//
	// spot
	//
...
func (this *Digifinex) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = MapTyped(GetValue(marketTypeparamsVariable, 1))
	var marginModeparamsVariable []any = this.HandleMarginModeAndParams("createOrderRequest", params)
	...
	if swap {
		...
		params = MapTyped(this.Omit(params, []any{"reduceOnly", "timeInForce"}))
	} else {
		...
		var createMarketBuyOrderRequiresPriceparamsVariable []any = this.HandleOptionBoolAndParams(params, "createOrderRequest", "createMarketBuyOrderRequiresPrice", true)
	...
	params = MapTyped(this.Omit(params, []any{"postOnly"}))
...
func (this *Digifinex) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	var retRes196315 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))))
	ch <- BoxAbsent(retRes196315)
	return nil
}
...
func (this *Digifinex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	//     }
	//
	var responseRequest string = func() string {
		if IsEqual(marketType, "swap") {
			return "data"
		}
		return "list"
...
func (this *Digifinex) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	var currencyIdRequest string = func() string {
		if IsEqual(marketType, "swap") {
			return "currency"
		}
...
func (this *Digifinex) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes294315 []any = ListTyped(PanicOnError((<-this.FetchTransactionsByTypeAsync("deposit", code, since, limit, params))))
	ch <- BoxAbsent(retRes294315)
	return nil
}
...
func (this *Digifinex) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes295815 []any = ListTyped(PanicOnError((<-this.FetchTransactionsByTypeAsync("withdrawal", code, since, limit, params))))
	ch <- BoxAbsent(retRes295815)
	return nil
}
...
func (this *Digifinex) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var retRes343715 map[string]any = MapTyped(PanicOnError((<-this.FetchFundingRateAsync(symbol, params))))
	ch <- BoxAbsent(retRes343715)
	return nil
}
...
func (this *Digifinex) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes431415 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, 1, params))))
	ch <- BoxAbsent(retRes431415)
	return nil
}
...
func (this *Digifinex) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes433115 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, 2, params))))
	ch <- BoxAbsent(retRes433115)
	return nil
}
