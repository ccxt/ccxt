...
func (this *DigifinexCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetch_markets_v2")) {
			...
			retRes57719 := (<-this.FetchMarketsV2(params))
			PanicOnError(retRes57719)
			ch <- retRes57719
			return nil
		}

		retRes57915 := (<-this.FetchMarketsV1(params))
		PanicOnError(retRes57915)
		ch <- retRes57915
		return nil
...
func (this *DigifinexCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes190715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *DigifinexCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes286615 := (<-this.FetchTransactionsByType("deposit", code, since, limit, params))
...
func (this *DigifinexCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes288015 := (<-this.FetchTransactionsByType("withdrawal", code, since, limit, params))
...
func (this *DigifinexCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes334315 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes334315)
		ch <- retRes334315
		return nil
...
func (this *DigifinexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes38138 := (<-this.LoadMarkets())
		PanicOnError(retRes38138)
		var market any = this.Market(symbol)
		if IsTrue(!IsEqual(GetValue(market, "type"), "swap")) {
		...
		retRes384115 := (<-this.PrivateSwapPostAccountLeverage(this.Extend(request, params)))
		PanicOnError(retRes384115)
		ch <- retRes384115
		return nil
...
func (this *DigifinexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes419615 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes419615)
		ch <- retRes419615
		return nil
...
func (this *DigifinexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes421315 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
		PanicOnError(retRes421315)
		ch <- retRes421315
		return nil
...
func (this *DigifinexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes436315 := (<-this.PrivateSwapPostAccountPositionMode(this.Extend(request, params)))
