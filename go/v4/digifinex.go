...
func (this *DigifinexCore) fetchMarketsV2Body(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
		...
		var typeVar any = Ternary((defaultType != nil && *defaultType == "margin"), "margin", "spot")
		...
		if swap {
			...
			isLinear = Ternary((!EvalTruthy(isInverse)), true, false)
			var isTrading any = this.SafeValue(market, "isTrading")
			if EvalTruthy(isTrading) {
				isAllowed = 1
			}
		}
		var isActive any = Ternary(EvalTruthy(isAllowed), true, false)
...
func (this *DigifinexCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	//     }
	//
	var balanceRequest any = Ternary((IsEqual(marketType, "swap")), "data", "list")
...
func (this *DigifinexCore) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var marketType any = Ternary((!IsEqual(indexPrice, nil)), "contract", "spot")
...
func (this *DigifinexCore) fetchStatusBody(ch chan any, optionalArgs ...any) any {
	...
	var status any = Ternary((code != nil && *code == 0), "ok", "maintenance")
...
func (this *DigifinexCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var request map[string]any = map[string]any{}
	if !IsEqual(limit, nil) {
		AddElementToObject(request, "limit", Ternary(EvalTruthy(GetValue(market, "swap")), mathMin(limit, 100), limit))
	}
	var response any = nil
	if EvalTruthy(GetValue(market, "swap")) {
		AddElementToObject(request, "instrument_id", GetValue(market, "id"))
...
func (this *DigifinexCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var marketIdRequest any = Ternary(swap, "instrument_id", "symbol")
	...
	if swap {
		...
		if IsEqual(side, "buy") {
			var requestType any = Ternary(EvalTruthy((reduceOnly)), 4, 1)
			AddElementToObject(request, "type", requestType)
		} else {
			var requestType any = Ternary(EvalTruthy((reduceOnly)), 3, 2)
			AddElementToObject(request, "type", requestType)
		}
		if isLimitOrder {
			orderType = 0
		...
		postOnlyParsed = Ternary((IsEqual(postOnly, true)), 1, 2)
...
func (this *DigifinexCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if (IsEqual(marketType, "spot")) || (IsEqual(marketType, "margin")) {
		...
		if !IsEqual(numCanceledOrders, 1) {
...
func (this *DigifinexCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if !IsEqual(market, nil) {
		var marketIdRequest any = Ternary((IsEqual(marketType, "swap")), "instrument_id", "symbol")
		AddElementToObject(request, marketIdRequest, GetValue(market, "id"))
	}
	if !IsEqual(limit, nil) {
		AddElementToObject(request, "limit", limit)
...
func (this *DigifinexCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	//     }
	//
	var responseRequest any = Ternary((IsEqual(marketType, "swap")), "data", "list")
...
func (this *DigifinexCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	var currencyIdRequest any = Ternary((IsEqual(marketType, "swap")), "currency", "currency_mark")
...
func (this *DigifinexCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	//     }
	//
	var positionRequest any = Ternary((IsEqual(marketType, "swap")), "data", "positions")
...
func (this *DigifinexCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	//     }
	//
	var dataRequest any = Ternary((IsEqual(marketType, "swap")), "data", "positions")
...
func (this *DigifinexCore) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	//
	var code *int64 = this.SafeInteger(response, "code")
	var status any = Ternary((code != nil && *code == 0), "ok", "failed")
	var data any = this.SafeValue(response, "data", map[string]any{})
...
func (this *DigifinexCore) Sign(path any, optionalArgs ...any) any {
	...
	var pathPart any = Ternary((IsEqual(endpoint, "spot")), "/v3", "/swap/v2")
