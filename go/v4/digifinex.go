...
func (this *Digifinex) fetchMarketsV2Body(ch chan any, optionalArgs ...any) any {
	...
	//     }
	//
	var spotData []any = SafeListTypedDefault(spotMarkets, "symbol_list", []any{})
	var swapData []any = SafeListTypedDefault(swapMarkets, "data", []any{})
	...
	for i := 0; i < len(response); i++ {
		...
		if swap {
			...
			var isTrading *bool = this.SafeBool(market, "isTrading")
			if isTrading != nil && *isTrading == true {
				isAllowed = 1
			}
		}
...
func (this *Digifinex) fetchMarketsV1Body(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < len(markets); i++ {
		...
		baseIdquoteIdVariable := strings.Split(*id, "_")
...
func (this *Digifinex) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchBalance", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	...
	if (marginMode != nil) || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginAssets(query)).Raw))
	} else if marketType != nil && *marketType == "spot" {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetSpotAssets(query)).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetAccountBalance(query)).Raw))
	} else {
	...
	//     }
	//
	var balanceRequest string = "list"
...
func (this *Digifinex) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "swap" {
		...
		response = MapTyped(PanicOnError((<-this.PublicSwapGetPublicDepth(this.Extend(request, query))).Raw))
	} else {
...
func (this *Digifinex) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if typeVar != nil && *typeVar == "swap" {
		...
		response = MapTyped(PanicOnError((<-this.PublicSwapGetPublicTickers(this.Extend(request, paramsMarketType))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PublicSpotGetTicker(this.Extend(request, paramsMarketType))).Raw))
	}
	//
	// spot
	//
...
func (this *Digifinex) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		response = MapTyped(PanicOnError((<-this.PublicSpotGetTicker(this.Extend(request, params))).Raw))
	}
	//
	// spot
	//
	...
	//
	var date *int64 = this.SafeInteger(response, "date")
	var tickers []any = SafeListTyped(response, "ticker")
...
func (this *Digifinex) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var percentage *string = this.SafeString2(ticker, "change", "price_change_percent")
	if marketResolved["swap"] == true {
...
func (this *Digifinex) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if GetValue(marketResolved, "type") == "swap" {
		...
		if tradeRole != nil && *tradeRole == "1" {
			takerOrMaker = "taker"
		} else if tradeRole != nil && *tradeRole == "2" {
			takerOrMaker = "maker"
		} else {
			takerOrMaker = nil
		}
...
func (this *Digifinex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		response = MapTyped(PanicOnError((<-this.PublicSwapGetPublicCandles(this.Extend(request, params))).Raw))
	} else {
 ...
 */
func (this *Digifinex) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Digifinex) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if GetValue(market, "swap") == true {
		...
		if marginMode != nil {
			...
			response = MapTyped(PanicOnError((<-this.PrivateSpotPostMarginOrderNew(request)).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.PrivateSpotPostSpotOrderNew(request)).Raw))
		}
	}
	//
	// spot and margin
...
func (this *Digifinex) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotPostMarketOrderBatchNew(request)).Raw))
	}
	//
	// spot
	//
...
func (this *Digifinex) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	 ...
	 */
	var market map[string]any = this.Market(symbol)
	var marketTypeRawparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("createOrderRequest", market, params)
	...
	var postOnly bool = this.IsPostOnly(isMarketOrder, false, paramsMarginMode)
	var postOnlyParsed any = nil
	var paramsRequest map[string]any = nil
	if swap {
		var reduceOnly *bool = this.SafeBool(paramsMarginMode, "reduceOnly", false)
		var timeInForce *string = this.SafeString(paramsMarginMode, "timeInForce")
		var orderType any = nil
		if IsEqual(side, "buy") {
			var requestType int = func() int {
		...
		var createMarketBuyOrderRequiresPriceparamsRequiresPriceVariable []any = this.HandleOptionBoolAndParams(paramsMarginMode, "createOrderRequest", "createMarketBuyOrderRequiresPrice", true)
		...
		var isMarketBuy bool = isMarketOrder && (IsEqual(side, "buy"))
		var keysToOmit []any = nil
		if isMarketBuy {
			keysToOmit = []any{"cost", "postOnly"}
		} else {
...
func (this *Digifinex) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivateSpotPostSpotOrderCancel(this.Extend(request, paramsOmitted))).Raw))
...
func (this *Digifinex) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	var request map[string]any = map[string]any{}
	var swap bool = (marketType != nil && *marketType == "swap")
	if swap {
		if since != nil {
	...
	if (marginMode != nil) || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginOrderCurrent(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "spot" {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetSpotOrderCurrent(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetTradeOpenOrders(this.Extend(request, query))).Raw))
	} else {
...
func (this *Digifinex) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	marketType = SafeStringPtr(GetValue(marketTypeparamsMarketTypeVariable, 0))
	paramsMarketType = GetValue(marketTypeparamsMarketTypeVariable, 1)
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchOrders", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	var request map[string]any = map[string]any{}
	if marketType != nil && *marketType == "swap" {
	...
	if (marginMode != nil) || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginOrderHistory(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "spot" {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetSpotOrderHistory(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetTradeHistoryOrders(this.Extend(request, query))).Raw))
	} else {
...
func (this *Digifinex) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	marketType = SafeStringPtr(GetValue(marketTypeparamsMarketTypeVariable, 0))
	paramsMarketType = GetValue(marketTypeparamsMarketTypeVariable, 1)
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchOrder", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	var request map[string]any = map[string]any{
		"order_id": id,
	...
	if (marginMode != nil) || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginOrder(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "spot" {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetSpotOrder(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetTradeOrderInfo(this.Extend(request, query))).Raw))
	} else {
...
func (this *Digifinex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	marketType = SafeStringPtr(GetValue(marketTypeparamsMarketTypeVariable, 0))
	paramsMarketType = GetValue(marketTypeparamsMarketTypeVariable, 1)
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchMyTrades", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	if marketType != nil && *marketType == "swap" {
		if since != nil {
	...
	if (marginMode != nil) || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginMytrades(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "spot" {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetSpotMytrades(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetTradeHistoryTrades(this.Extend(request, query))).Raw))
	} else {
	...
	//     }
	//
	var responseRequest string = "list"
	if marketType != nil && *marketType == "swap" {
...
func (this *Digifinex) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	var marketType *string = nil
	var paramsMarketType any = nil
	var marketTypeparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("fetchLedger", nil, params)
	marketType = SafeStringPtr(GetValue(marketTypeparamsMarketTypeVariable, 0))
	paramsMarketType = GetValue(marketTypeparamsMarketTypeVariable, 1)
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchLedger", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	if marketType != nil && *marketType == "swap" {
		if since != nil {
	...
	if (marginMode != nil) || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginFinancelog(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "spot" {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetSpotFinancelog(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetAccountFinanceRecord(this.Extend(request, query))).Raw))
	} else {
	...
	var ledger any = nil
	if marketType != nil && *marketType == "swap" {
		ledger = this.SafeList(response, "data", []any{})
	} else {
		var data map[string]any = SafeMapTyped(response, "data")
...
func (this *Digifinex) fetchTransactionsByTypeBody(ch chan any, typeVar any, optionalArgs ...any) any {
	...
	if IsEqual(typeVar, "deposit") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetDepositHistory(this.Extend(request, params))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateSpotGetWithdrawHistory(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "code": 200,
...
func (this *Digifinex) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var currency map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = currency
	var id *string = this.SafeString2(transaction, "id", "withdraw_id")
	...
	var network *string = this.SafeString(transaction, "chain")
	return map[string]any{
		"info":        transaction,
		"id":          id,
		"txid":        txid,
...
func (this *Digifinex) ParseTransferStatus(status *string) *string {
	var statuses map[string]any = map[string]any{
		"0": "ok",
	}
	return this.SafeString(statuses, status, status)
...
func (this *Digifinex) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if fromSwap || toSwap {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSwapPostAccountTransfer(this.Extend(request, params))).Raw))
	} else {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotPostTransfer(this.Extend(request, params))).Raw))
	}
	if response == nil {
...
func (this *Digifinex) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivateSpotPostWithdrawNew(this.Extend(request, paramsWithdrawTag))).Raw))
...
func (this *Digifinex) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var marketId *string = this.SafeString(contract, "instrument_id")
	var timestamp *int64 = this.SafeInteger(contract, "funding_time")
...
func (this *Digifinex) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	var paramsMarketType any = nil
	var marketTypeparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("fetchPositions", market, params)
	marketType = SafeStringPtr(GetValue(marketTypeparamsMarketTypeVariable, 0))
	paramsMarketType = GetValue(marketTypeparamsMarketTypeVariable, 1)
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchPositions", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	if marginMode != nil {
		marketType = SafeStringPtr("margin")
	...
	if (marketType != nil && *marketType == "spot") || (marketType != nil && *marketType == "margin") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateSpotGetMarginPositions(this.Extend(request, query))).Raw))
	} else if marketType != nil && *marketType == "swap" {

		response = MapTyped(PanicOnError((<-this.PrivateSwapGetAccountPositions(this.Extend(request, query))).Raw))
	} else {
	...
	//     }
	//
	var positionRequest string = "positions"
	if marketType != nil && *marketType == "swap" {
...
func (this *Digifinex) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var marketType *string = nil
	var paramsMarketType any = nil
	var marketTypeparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("fetchPosition", market, params)
	marketType = SafeStringPtr(GetValue(marketTypeparamsMarketTypeVariable, 0))
	paramsMarketType = GetValue(marketTypeparamsMarketTypeVariable, 1)
	var marginModequeryVariable []any = this.HandleMarginModeAndParams("fetchPosition", paramsMarketType)
	var marginMode *string = SafeStringPtr(GetValue(marginModequeryVariable, 0))
	var query map[string]any = MapTyped(GetValue(marginModequeryVariable, 1))
	if marginMode != nil {
		marketType = SafeStringPtr("margin")
	...
	//     }
	//
	var dataRequest string = "positions"
	if marketType != nil && *marketType == "swap" {
		dataRequest = "data"
	}
...
func (this *Digifinex) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if marginMode != nil {
		omitKeys = append(omitKeys, "marginMode")
		omitKeys = append(omitKeys, "defaultMarginMode")
	}
...
func (this *Digifinex) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if since != nil {
		AddElementToObject(requestUntil, "start_timestamp", since)
	}

	var response map[string]any = MapTyped(PanicOnError((<-this.PrivateSwapGetAccountFundingFee(this.Extend(requestUntil, paramsUntil))).Raw))
	//
	//     {
	//         "code": 0,
	//         "data": [
...
func (this *Digifinex) ParseIncome(income any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var marketId *string = this.SafeString(income, "instrument_id")
...
func (this *Digifinex) Sign(path any, optionalArgs ...any) any {
	...
	if signed {
		...
		var hasPostBody bool = (method == "POST") && (urlencoded != nil) && (!IsEqual(urlencoded, ""))
...
func (this *Digifinex) HandleErrors(statusCode any, statusText any, url any, method any, responseHeaders any, responseBody any, response any, requestHeaders any, requestBody any) any {
	...
	ExceptionClassmessageVariable := this.SafeValue(this.Exceptions["exact"], code, unknownError)
...
func (this *Digifinex) FetchMarketsV2(params ...any) ([]MarketInterface, error) {
	var res AsyncResult[[]MarketInterface] = AwaitResult(NewMarketInterfaceArray, this.FetchMarketsV2Async(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Digifinex) FetchMarketsV1(params ...any) ([]MarketInterface, error) {
	var res AsyncResult[[]MarketInterface] = AwaitResult(NewMarketInterfaceArray, this.FetchMarketsV1Async(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Digifinex) FetchTransactionsByType(typeVar string, options ...FetchTransactionsByTypeOptions) ([]Transaction, error) {
	...
	var res AsyncResult[[]Transaction] = AwaitResult(NewTransactionArray, this.FetchTransactionsByTypeAsync(typeVar, opts.Code, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
