...
func (this *websea) PrivateGetOpenApiContractHistoryList (args ...interface{}) <-chan interface{} {
   return this.callEndpointAsync("privateGetOpenApiContractHistoryList", args...)
}
