...
func (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes250919 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
			PanicOnError(retRes250919)
			ch <- retRes250919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes262319 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes273119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
			PanicOnError(retRes273119)
			ch <- retRes273119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes305715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes308015 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes441519 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes476719 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes494619 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes502115 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes504519 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes549119 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes559919 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes60158 := (<-this.LoadMarkets())
		PanicOnError(retRes60158)
		var request any = map[string]any{}
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes610615 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) FetchTransfer(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes64298 := (<-this.LoadMarkets())
		PanicOnError(retRes64298)
		var request any = map[string]any{
			"transId": id,
		}
...
func (this *OkxCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes64728 := (<-this.LoadMarkets())
		PanicOnError(retRes64728)
		var currency any = nil
		var request any = map[string]any{
			"type": "1",
		}
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes666915 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes67228 := (<-this.LoadMarkets())
		PanicOnError(retRes67228)
...
func (this *OkxCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes71368 := (<-this.LoadMarkets())
		PanicOnError(retRes71368)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
		}
...
func (this *OkxCore) FetchBorrowRateHistories(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes72268 := (<-this.LoadMarkets())
		PanicOnError(retRes72268)
		var request any = map[string]any{}
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes742315 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes743715 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes75578 := (<-this.LoadMarkets())
		PanicOnError(retRes75578)
		var marginMode any = nil
...
func (this *OkxCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes78568 := (<-this.LoadMarkets())
		PanicOnError(retRes78568)
...
func (this *OkxCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes79808 := (<-this.LoadMarkets())
		PanicOnError(retRes79808)
		var request any = map[string]any{}
...
func (this *OkxCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes81148 := (<-this.LoadMarkets())
		PanicOnError(retRes81148)
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *OkxCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes83148 := (<-this.LoadMarkets())
		PanicOnError(retRes83148)
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes85558 := (<-this.LoadMarkets())
		PanicOnError(retRes85558)
		var currency any = this.Currency(code)
		var request any = map[string]any{
