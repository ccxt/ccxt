...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes559012 := (<-this.LoadMarkets())
			PanicOnError(retRes559012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes559519 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchDeposit(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes567112 := (<-this.LoadMarkets())
			PanicOnError(retRes567112)
		}
		var request any = map[string]any{
			"depId": id,
		}
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes570719 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes622515 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes680815 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes682212 := (<-this.LoadMarkets())
			PanicOnError(retRes682212)
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes709412 := (<-this.LoadMarkets())
			PanicOnError(retRes709412)
		}
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *OkxCore) FetchCrossBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes726812 := (<-this.LoadMarkets())
			PanicOnError(retRes726812)
		}
...
func (this *OkxCore) FetchBorrowRateHistories(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes739412 := (<-this.LoadMarkets())
			PanicOnError(retRes739412)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes759615 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes761015 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes773312 := (<-this.LoadMarkets())
			PanicOnError(retRes773312)
		}
		var marginMode any = nil
...
func (this *OkxCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes785612 := (<-this.LoadMarkets())
			PanicOnError(retRes785612)
		}
...
func (this *OkxCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes851412 := (<-this.LoadMarkets())
			PanicOnError(retRes851412)
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes876112 := (<-this.LoadMarkets())
			PanicOnError(retRes876112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *OkxCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes914112 := (<-this.LoadMarkets())
			PanicOnError(retRes914112)
		}
...
func (this *OkxCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes936312 := (<-this.LoadMarkets())
			PanicOnError(retRes936312)
		}
