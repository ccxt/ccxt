...
func (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes250619 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes262019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
			PanicOnError(retRes262019)
			ch <- retRes262019
			return nil
		}
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes272819 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes305415 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes307715 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes441219 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes45718 := (<-this.LoadMarkets())
		PanicOnError(retRes45718)
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes476419 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes49398 := (<-this.LoadMarkets())
		PanicOnError(retRes49398)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes494319 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes494319)
			ch <- retRes494319
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes501815 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes504219 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes548819 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes548819)
			ch <- retRes548819
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes559619 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes610315 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes62928 := (<-this.LoadMarkets())
		PanicOnError(retRes62928)
		var currency any = this.Currency(code)
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes666615 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes70628 := (<-this.LoadMarkets())
		PanicOnError(retRes70628)
		var market any = this.Market(symbol)
...
func (this *OkxCore) FetchCrossBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes71018 := (<-this.LoadMarkets())
		PanicOnError(retRes71018)
...
func (this *OkxCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes73018 := (<-this.LoadMarkets())
		PanicOnError(retRes73018)
		var market any = this.Market(symbol)
		var posSide any = this.SafeString(params, "posSide", "net")
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes742015 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes743415 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes75548 := (<-this.LoadMarkets())
		PanicOnError(retRes75548)
		var marginMode any = nil
...
func (this *OkxCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes76738 := (<-this.LoadMarkets())
		PanicOnError(retRes76738)
...
func (this *OkxCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes81118 := (<-this.LoadMarkets())
		PanicOnError(retRes81118)
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *OkxCore) FetchUnderlyingAssets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes82108 := (<-this.LoadMarkets())
		PanicOnError(retRes82108)
		var marketType any = nil
...
func (this *OkxCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes83118 := (<-this.LoadMarkets())
		PanicOnError(retRes83118)
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes85048 := (<-this.LoadMarkets())
		PanicOnError(retRes85048)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"instId": GetValue(market, "id"),
		}
...
func (this *OkxCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes89228 := (<-this.LoadMarkets())
		PanicOnError(retRes89228)
...
func (this *OkxCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes90318 := (<-this.LoadMarkets())
		PanicOnError(retRes90318)
