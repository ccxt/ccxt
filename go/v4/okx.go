...
func (this *Okx) CreateExpiredOptionMarket(symbol any) any {
	...
	var datetime any = func() any { if (expiry == nil) { return nil }; return this.ConvertExpireDate(expiry) }()
...
func (this *Okx) SafeMarket(optionalArgs ...any) any {
	...
	if isOption && (marketId != nil) && ((IsEqual(this.Markets_by_id, nil)) || !(InOp(this.Markets_by_id, marketId))) {
...
func (this *Okx) fetchStatusBody(ch chan any, optionalArgs ...any) any {
	...
	var update map[string]any = map[string]any{
		"updated": nil,
		"status":  func() any { if (dataLength == 0) { return "ok" }; return "maintenance" }(),
		"eta":     nil,
		"url":     nil,
		"info":    response,
	}
...
func (this *Okx) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true) {
		...
		retRes175512 := (<-this.LoadTimeDifferenceAsync())
...
func (this *Okx) ParseMarket(market any) any {
	...
	if contract {
		...
		if future {
			...
			if !IsEqual(expiry, nil) {
				...
				optionType = func() any { if (IsEqual(optionType, "P")) { return "put" }; return "call" }()
			}
		}
	}
	var feesType any = func() any { if (typeVar == nil) { return "" }; return typeVar }()
	...
	return this.Extend(fees, map[string]any{
		...
		"contract":       contract,
		"linear":         func() any { if contract { return quoteEqualSettle }; return nil }(),
		"inverse":        func() any { if contract { return baseEqualSettle }; return nil }(),
		"contractSize":   func() any { if contract { return this.SafeNumber(market, "ctVal") }; return nil }(),
		"expiry":         expiry,
...
func (this *Okx) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	limit = func() any { if (IsEqual(limit, nil)) { return 100 }; return limit }()
...
func (this *Okx) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	if instType != nil {
		marketType = func() any { if (instType != nil && *instType == "SPOT") { return "spot" }; return "swap" }()
	}
	...
	var quoteVolume any = func() any { if (spot != nil && *spot == true) { return this.SafeString(ticker, "volCcy24h") }; return nil }()
...
func (this *Okx) fetchMarkPricesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes246612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	var volumeIndex any = func() any { if (IsEqual(typeVar, "spot")) { return 5 }; return 6 }()
...
func (this *Okx) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes271412 := (<-this.LoadMarketsAsync())
	...
	if IsEqual(limit, nil) {
		...
		var maxLimit any = func() any { if isMarkOrIndex { return 100 }; return 300 }() // default 300, only 100 if 'mark' or 'index'
	...
	if !IsEqual(since, nil) {
		...
		if IsLessThan(since, historyBorder) {
			...
			var maxLimit any = func() any { if isMarkOrIndex { return 100 }; return 300 }()
			limit = mathMin(limit, maxLimit)
		}
...
func (this *Okx) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes282512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) ParseTradingFee(fee any, optionalArgs ...any) any {
...
func (this *Okx) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes315612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes315612)
	}
	var market any = this.Market(symbol)
	if !IsEqual(GetValue(market, "spot"), true) {
	...
	retRes316615 := (<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *Okx) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes319115 := (<-this.CreateOrderAsync(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *Okx) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if spot == true {
		if margin == true {
			var defaultCurrency any = func() any { if (IsEqual(side, "buy")) { return GetValue(market, "quote") }; return GetValue(market, "base") }()
		...
		var tradeMode any = func() any { if (margin == true) { return marginMode }; return "cash" }()
		...
		if (IsEqual(GetValue(market, "swap"), true)) || (IsEqual(GetValue(market, "future"), true)) {
			...
			if positionSide != nil {
				...
				var hedged any = nil
				var hedgedparamsVariable []any = this.HandleOptionAndParams(params, "createOrder", "hedged")
				...
				if hedged == true {
					...
					if isProtective {
						...
						AddElementToObject(request, "posSide", func() any { if isBuy { return "short" }; return "long" }())
						if isReduceOnly {
							params = this.Omit(params, "reduceOnly")
						}
					} else {
						AddElementToObject(request, "posSide", func() any { if isBuy { return "long" }; return "short" }())
					}
				}
			}
		}
		...
		if (spot == true) && (IsEqual(side, "buy")) {
			...
			if tgtCcy != nil && *tgtCcy == "quote_ccy" {
				...
				if EvalTruthy(createMarketBuyOrderRequiresPrice) {
					...
					notional = func() any { if (IsEqual(notional, nil)) { return amount }; return notional }()
				}
	...
	if trigger {
		...
		AddElementToObject(request, "orderPx", func() any { if isMarketOrder { return "-1" }; return this.PriceToPrecision(symbol, price) }())
	} else if conditional {
...
func (this *Okx) EditOrderRequest(id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if EvalTruthy(isAlgoOrder) {
		...
		if stopLossTriggerPrice != nil {
			...
			request["newSlOrdPx"] = func() any { if (IsEqual(typeVar, "market")) { return "-1" }; return this.PriceToPrecision(symbol, stopLossPrice) }()
		...
		if takeProfitTriggerPrice != nil {
			...
			request["newTpOrdPx"] = func() any { if (IsEqual(typeVar, "market")) { return "-1" }; return this.PriceToPrecision(symbol, takeProfitPrice) }()
		...
		if hasStopLoss {
			...
			request["newSlTriggerPx"] = this.PriceToPrecision(symbol, stopLossTriggerPrice)
			request["newSlOrdPx"] = func() any { if (stopLossType != nil && *stopLossType == "market") { return "-1" }; return this.PriceToPrecision(symbol, stopLossPrice) }()
			request["newSlTriggerPxType"] = stopLossTriggerPriceType
		}
		if hasTakeProfit {
			...
			request["newTpOrdKind"] = func() any { if (takeProfitType != nil && *takeProfitType == "limit") { return takeProfitType }; return "condition" }()
			request["newTpTriggerPx"] = this.PriceToPrecision(symbol, takeProfitTriggerPrice)
			request["newTpOrdPx"] = func() any { if (takeProfitType != nil && *takeProfitType == "market") { return "-1" }; return this.PriceToPrecision(symbol, takeProfitPrice) }()
			request["newTpTriggerPxType"] = takeProfitTriggerPriceType
		}
	}
...
func (this *Okx) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes375512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes375512)
	}
	var market any = this.Market(symbol)
...
func (this *Okx) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if isTrigger || (trailing != nil && *trailing == true) {
		...
		orderInner := (<-this.CancelOrdersAsync([]any{id}, symbol, params))
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes381712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) cancelOrdersForSymbolsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(orders); i++ {
		...
		requestItem[idKey] = func() any { if (clientOrderId != nil) { return clientOrderId }; return id }()
...
func (this *Okx) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes473412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes473412)
	}
	var request map[string]any = map[string]any{}
	var market any = nil
	if symbol != nil {
...
func (this *Okx) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes510712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes510712)
	}
	var paginate any = false
...
func (this *Okx) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes520812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes520812)
	}
	var paginate any = false
...
func (this *Okx) ParseDepositAddress(depositAddress any, optionalArgs ...any) any {
	...
	var networkData any = func() any { if (chain == nil) { return nil }; return this.SafeDict(networksById, chain) }()
...
func (this *Okx) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes555712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if fee == nil {
		...
		var targetNetwork any = func() any { if (networkCodeResolved == nil) { return map[string]any{} }; return this.SafeDict(GetValue(currency, "networks"), networkCodeResolved, map[string]any{}) }()
...
func (this *Okx) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes566412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes566412)
	}
	var paginate any = false
...
func (this *Okx) fetchDepositBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes574512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	tagTo = func() any { if (tagTo == nil) { return this.SafeString(transaction, "pmtId") }; return this.SafeString2(transaction, "pmtId", tagTo) }()
	if withdrawalId != nil {
		typeVar = "withdrawal"
		id = withdrawalId
	} else {
...
func (this *Okx) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes605312 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes612712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes620712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) ParsePosition(position any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(market, "margin"), true) {
		...
		if IsEqual(side, "net") {
			...
			if parsedCurrency != nil {
				side = func() any { if (IsEqual(GetValue(market, "base"), parsedCurrency)) { return "long" }; return "short" }()
			}
		}
		if side == nil {
	...
	if marginMode != nil && *marginMode == "cross" {
		initialMarginString = DerefScalar(this.SafeString(position, "imr"))
...
func (this *Okx) ParseTransfer(transfer any, optionalArgs ...any) any {
	...
	return map[string]any{
		...
		"currency":    code,
		"amount":      amount,
		"fromAccount": func() any { if (fromAccountId == nil) { return nil }; return this.SafeString(accountsById, fromAccountId) }(),
		"toAccount":   func() any { if (toAccountId == nil) { return nil }; return this.SafeString(accountsById, toAccountId) }(),
...
func (this *Okx) fetchTransferBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes663912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes663912)
	}
	var request map[string]any = map[string]any{
		"transId": id,
	}
...
func (this *Okx) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes689612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes716812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes716812)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *Okx) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes730112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes730112)
	}
	var market any = this.Market(symbol)
...
func (this *Okx) fetchBorrowRateHistoriesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes747512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes755712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes755712)
	}
	var market any = this.Market(symbol)
	var posSide *string = this.SafeString(params, "posSide", "net")
	...
	ch <- this.Extend(this.ParseMarginModification(entry, market), map[string]any{
		"status": func() any { if (errorCode != nil && *errorCode == "0") { return "ok" }; return "failed" }(),
	})
	return nil
}
func (this *Okx) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	if typeRaw != nil && *typeRaw == "6" {
		typeVar = func() any { if Precise.StringGt(amountRaw, "0") { return "add" }; return "reduce" }()
	} else {
		typeVar = typeRaw
	}
	...
	var code any = func() any { if (IsEqual(GetValue(responseMarket, "inverse"), true)) { return GetValue(responseMarket, "base") }; return GetValue(responseMarket, "quote") }()
...
func (this *Okx) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes770812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes770812)
	}
	var market any = this.Market(symbol)
	var typeVar any = func() any { if (IsEqual(GetValue(market, "spot"), true)) { return "MARGIN" }; return this.ConvertToInstrumentType(GetValue(market, "type")) }()
	var uly *string = this.SafeString(GetValue(market, "info"), "uly")
...
func (this *Okx) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes781612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes793912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes793912)
	}
...
func (this *Okx) ParseMarginLoan(info any, optionalArgs ...any) any {
	//
	//     {
	//         "amt": "102",
	//         "availLoan": "97",
...
func (this *Okx) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes800912 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchOpenInterestsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes805612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes812512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes812512)
	}
	// handle unified currency code or symbol
	var currencyId any = nil
	var market any = nil
	if ((!IsEqual(this.Markets, nil)) && (InOp(this.Markets, symbol))) || ((!IsEqual(this.Markets_by_id, nil)) && (InOp(this.Markets_by_id, symbol))) {
		market = this.Market(symbol)
...
func (this *Okx) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes825112 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes849212 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchAllGreeksBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes859712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes859712)
	}
	var request map[string]any = map[string]any{}
...
func (this *Okx) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes873312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes873312)
	}
	var market any = this.Market(symbol)
...
func (this *Okx) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes894012 := (<-this.LoadMarketsAsync())
...
func (this *Okx) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes899612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes899612)
	}
	var request map[string]any = map[string]any{
		"quoteId":  id,
		"baseCcy":  fromCode,
...
func (this *Okx) fetchConvertTradeBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes905012 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes910612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes922412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes922412)
	}
...
func (this *Okx) fetchMarginAdjustmentHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes933712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes933712)
	}
	...
	var subType any = func() any { if isAdd { return "160" }; return "161" }()
	if auto != nil && *auto == true {
		if isAdd {
			subType = "162"
		} else {
			panic(BadRequest(Add(this.Id + " cannot fetch margin adjustments for type ", typeVar)))
		}
	}
	var request map[string]any = map[string]any{
		"subType": subType,
...
func (this *Okx) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes944612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes944612)
	}
...
func (this *Okx) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes952412 := (<-this.LoadMarketsAsync())
