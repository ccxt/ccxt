...
func (this *Okx) ParseMarket(market any) any {
	...
	if (underlying != nil) && !spot {
		var parts []string = func() []string {
			...
			return strings.Split(*underlying, "-")
		}()
...
func (this *Okx) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes387212 := (<-this.LoadMarketsAsync())
...
func (this *Okx) cancelOrdersForSymbolsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes398112 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes456612 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes457219 := (<-this.FetchPaginatedCallDynamicAsync("fetchOpenOrders", symbol, since, limit, params, maxLimit))
		PanicOnError(retRes457219)
		ch <- retRes457219
		return nil
	}
	var request map[string]any = map[string]any{}
...
func (this *Okx) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes473312 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes492412 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes493019 := (<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params, maxLimit))
		PanicOnError(retRes493019)
		ch <- retRes493019
		return nil
	}
	var request map[string]any = map[string]any{}
...
func (this *Okx) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes510612 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes511119 := (<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params))
		PanicOnError(retRes511119)
		ch <- retRes511119
		return nil
	}
	var request any = map[string]any{}
...
func (this *Okx) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes520712 := (<-this.LoadMarketsAsync())
	...
	if paginate == true {
		...
		retRes521219 := (<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params))
...
func (this *Okx) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes566312 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchDepositBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes574412 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes577512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchWithdrawalBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes584812 := (<-this.LoadMarketsAsync())
...
func (this *Okx) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	if chain != nil {
		var chainParts []string = func() []string {
			if chain == nil {
				return nil
			}
...
func (this *Okx) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes605212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes605212)
	}
	var marginMode any = nil
...
func (this *Okx) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes612612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes620612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes668312 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes689512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes694012 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes698912 := (<-this.LoadMarketsAsync())
...
func (this *Okx) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes716712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes730012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes730012)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Okx) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes738012 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchBorrowRateHistoriesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes747412 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchBorrowRateHistoryBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes752012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes752012)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"ccy": currency["id"],
...
func (this *Okx) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes755612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes755612)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var posSide *string = this.SafeString(params, "posSide", "net")
...
func (this *Okx) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes770712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes770712)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var typeVar any = func() any {
		if GetValue(market, "spot") == true {
...
func (this *Okx) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes781512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes789612 := (<-this.LoadMarketsAsync())
...
func (this *Okx) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes793812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes793812)
	}
...
func (this *Okx) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes800812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes800812)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	if GetValue(market, "contract") != true {
...
func (this *Okx) fetchOpenInterestsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes805512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes812412 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes825012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes825012)
	}
	var request map[string]any = map[string]any{}
	if codes != nil {
...
func (this *Okx) ParseDepositWithdrawFees(response any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(response); i++ {
		...
		if (code != nil) && ((codes == nil) || (this.InArray(code, codes))) {
			...
			var chainSplit []string = func() []string {
				if chain == nil {
					return nil
				}
				return strings.Split(*chain, "-")
...
func (this *Okx) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes839012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes839012)
	}
	var market any = this.Market(symbol)
	var typeVar any = nil
...
func (this *Okx) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes849112 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchGreeksBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes853212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes853212)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Okx) fetchAllGreeksBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes859612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes859612)
	}
	var request map[string]any = map[string]any{}
...
func (this *Okx) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes873212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes873212)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Okx) fetchOptionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes879312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes879312)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"instId": market["id"],
...
func (this *Okx) fetchOptionChainBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes884312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes884312)
	}
	var currency map[string]any = this.Currency(code).(map[string]any)
	var request map[string]any = map[string]any{
...
func (this *Okx) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes893912 := (<-this.LoadMarketsAsync())
...
func (this *Okx) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes899512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes899512)
	}
	var request map[string]any = map[string]any{
		"quoteId":  id,
		"baseCcy":  fromCode,
...
func (this *Okx) fetchConvertTradeBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes904912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes904912)
	}
	var request map[string]any = map[string]any{
		"clTReqId": id,
	}
...
func (this *Okx) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes910512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes922312 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchMarginAdjustmentHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes933612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes933612)
	}
...
func (this *Okx) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes944512 := (<-this.LoadMarketsAsync())
...
func (this *Okx) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes952312 := (<-this.LoadMarketsAsync())
