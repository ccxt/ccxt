...
func  (this *okx) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes232419 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func  (this *okx) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes243619 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func  (this *okx) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes253619 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
                    PanicOnError(retRes253619)
                    ch <- retRes253619
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *okx) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes286215 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *okx) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes288515 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func  (this *okx) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes409519 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
...
func  (this *okx) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes444619 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *okx) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes462519 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes462519)
                    ch <- retRes462519
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *okx) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes470015 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func  (this *okx) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes472419 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *okx) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes517019 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *okx) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes527819 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *okx) FetchPositionsForSymbol(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes577515 :=  (<-this.FetchPositions([]interface{}{symbol}, params))
...
func  (this *okx) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes633315 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *okx) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes64228 := (<-this.LoadMarkets())
            PanicOnError(retRes64228)
            var request interface{} = map[string]interface{} {
                "type": "8",
            }
            if IsTrue(!IsEqual(limit, nil)) {
...
func  (this *okx) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes67218 := (<-this.LoadMarkets())
            PanicOnError(retRes67218)
            var market interface{} = this.Market(symbol)
...
func  (this *okx) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes707915 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func  (this *okx) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes709315 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func  (this *okx) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes82818 := (<-this.LoadMarkets())
            PanicOnError(retRes82818)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
                "baseCcy": fromCode,
                "quoteCcy": toCode,
...
func  (this *okx) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83878 := (<-this.LoadMarkets())
            PanicOnError(retRes83878)
            var request interface{} = map[string]interface{} {}
            requestparamsVariable := this.HandleUntilOption("after", request, params);
            request = GetValue(requestparamsVariable,0);
            params = GetValue(requestparamsVariable,1)
...
func  (this *okx) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87198 := (<-this.LoadMarkets())
            PanicOnError(retRes87198)
