...
func (this *OkxCore) SafeMarket(optionalArgs ...any) any {
	...
	if IsTrue(IsTrue(IsTrue(isOption) && IsTrue((!IsEqual(marketId, nil)))) && !IsTrue((InOp(this.Markets_by_id, marketId)))) {
...
func (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes254119 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes265719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes276719 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes309915 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes312415 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes449019 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes449019)
			ch <- retRes449019
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes484012 := (<-this.LoadMarkets())
			PanicOnError(retRes484012)
		}
		var maxLimit any = 100
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes484619 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes484619)
			ch <- retRes484619
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes502212 := (<-this.LoadMarkets())
			PanicOnError(retRes502212)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes502719 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes502719)
			ch <- retRes502719
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes510215 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes512819 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes512819)
			ch <- retRes512819
			return nil
		}
...
func (this *OkxCore) FetchDepositAddressesByNetwork(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes542612 := (<-this.LoadMarkets())
			PanicOnError(retRes542612)
		}
...
func (this *OkxCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes547212 := (<-this.LoadMarkets())
			PanicOnError(retRes547212)
		}
...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes558219 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchDeposit(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes565812 := (<-this.LoadMarkets())
			PanicOnError(retRes565812)
		}
		var request any = map[string]any{
			"depId": id,
		}
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes569419 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchWithdrawal(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes576212 := (<-this.LoadMarkets())
			PanicOnError(retRes576212)
		}
		var request any = map[string]any{
			"wdId": id,
		}
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes621215 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes679415 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) FetchBorrowRateHistories(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes736612 := (<-this.LoadMarkets())
			PanicOnError(retRes736612)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes756815 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes758215 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes770512 := (<-this.LoadMarkets())
			PanicOnError(retRes770512)
		}
		var marginMode any = nil
...
func (this *OkxCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes778612 := (<-this.LoadMarkets())
			PanicOnError(retRes778612)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy":  GetValue(currency, "id"),
...
func (this *OkxCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes782812 := (<-this.LoadMarkets())
			PanicOnError(retRes782812)
		}
...
func (this *OkxCore) FetchOpenInterests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes794512 := (<-this.LoadMarkets())
			PanicOnError(retRes794512)
		}
...
func (this *OkxCore) FetchUnderlyingAssets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes837912 := (<-this.LoadMarkets())
			PanicOnError(retRes837912)
		}
		var marketType any = nil
...
func (this *OkxCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes848412 := (<-this.LoadMarkets())
			PanicOnError(retRes848412)
		}
		var request any = map[string]any{}
...
func (this *OkxCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes862012 := (<-this.LoadMarkets())
			PanicOnError(retRes862012)
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes873112 := (<-this.LoadMarkets())
			PanicOnError(retRes873112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *OkxCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes888312 := (<-this.LoadMarkets())
			PanicOnError(retRes888312)
		}
		var request any = map[string]any{
			"quoteId":  id,
			"baseCcy":  fromCode,
...
func (this *OkxCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes893712 := (<-this.LoadMarkets())
			PanicOnError(retRes893712)
		}
		var request any = map[string]any{
			"clTReqId": id,
		}
...
func (this *OkxCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes911112 := (<-this.LoadMarkets())
			PanicOnError(retRes911112)
		}
...
func (this *OkxCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes922212 := (<-this.LoadMarkets())
			PanicOnError(retRes922212)
		}
...
func (this *OkxCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes940912 := (<-this.LoadMarkets())
			PanicOnError(retRes940912)
		}
		if IsTrue(IsEqual(symbol, nil)) {
