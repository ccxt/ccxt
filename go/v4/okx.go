...
func (this *OkxCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true)) {
		...
		retRes175512 := (<-this.LoadTimeDifference())
...
func (this *OkxCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes260419 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func (this *OkxCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes272019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes283019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func (this *OkxCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes316615 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes319115 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes457319 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes493119 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes511219 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *OkxCore) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes518715 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes521319 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes566919 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes578119 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) fetchPositionsForSymbolBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes629915 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes688215 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes767915 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes769315 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
