...
func (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes251319 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes262719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes273519 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
			PanicOnError(retRes273519)
			ch <- retRes273519
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes306115 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes308415 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes441919 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes477119 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes477119)
			ch <- retRes477119
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes49468 := (<-this.LoadMarkets())
		PanicOnError(retRes49468)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes495019 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes502515 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes504919 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
			PanicOnError(retRes504919)
			ch <- retRes504919
			return nil
		}
...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes549519 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes560319 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes611015 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes667315 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes69388 := (<-this.LoadMarkets())
		PanicOnError(retRes69388)
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes742715 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes744115 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes79848 := (<-this.LoadMarkets())
		PanicOnError(retRes79848)
		var request any = map[string]any{}
...
func (this *OkxCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes81188 := (<-this.LoadMarkets())
		PanicOnError(retRes81188)
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *OkxCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes87078 := (<-this.LoadMarkets())
		PanicOnError(retRes87078)
		var request any = map[string]any{
			"quoteId":  id,
			"baseCcy":  fromCode,
			"quoteCcy": toCode,
...
func (this *OkxCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes89298 := (<-this.LoadMarkets())
		PanicOnError(retRes89298)
...
func (this *OkxCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes90388 := (<-this.LoadMarkets())
		PanicOnError(retRes90388)
...
func (this *OkxCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes92218 := (<-this.LoadMarkets())
		PanicOnError(retRes92218)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"instId": GetValue(market, "id"),
		}
