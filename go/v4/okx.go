...
func (this *OkxCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes164812 := (<-this.LoadTimeDifference())
...
func (this *OkxCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes245919 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
			PanicOnError(retRes245919)
			ch <- retRes245919
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *OkxCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes257319 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes268119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes300715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
		PanicOnError(retRes300715)
		ch <- retRes300715
		return nil
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes303015 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes436419 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
			PanicOnError(retRes436419)
			ch <- retRes436419
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *OkxCore) FetchCanceledOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes45238 := (<-this.LoadMarkets())
		PanicOnError(retRes45238)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes471519 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes48908 := (<-this.LoadMarkets())
		PanicOnError(retRes48908)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes489419 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *OkxCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes496915 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes499319 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes543919 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes554719 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes554719)
			ch <- retRes554719
			return nil
		}
		var request interface{} = map[string]interface{}{}
...
func (this *OkxCore) FetchPositionsForSymbol(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes604415 := (<-this.FetchPositions([]interface{}{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes660615 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) FetchBorrowRateHistories(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes71638 := (<-this.LoadMarkets())
		PanicOnError(retRes71638)
		var request interface{} = map[string]interface{}{}
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *OkxCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes736015 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes737415 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchOpenInterests(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes77268 := (<-this.LoadMarkets())
		PanicOnError(retRes77268)
