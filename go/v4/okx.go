...
func (this *OkxCore) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if (method == "publicGetMarketBooksFull") && IsEqual(limit, nil) {
		limit = 5000
	}
	...
	if (method == "publicGetMarketBooksFull") || (IsGreaterThan(limit, 400)) {
...
func (this *OkxCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var conditional bool = (!IsEqual(stopLossPrice, nil)) || (!IsEqual(takeProfitPrice, nil)) || (typeVar == "conditional")
	var request any = map[string]any{
		"instId":  GetValue(market, "id"),
		"side":    side,
		"ordType": typeVar,
	}
	var isConditionalOrOCO bool = conditional || (typeVar == "oco")
	...
	var trigger bool = (!IsEqual(triggerPrice, nil)) || (typeVar == "trigger")
	...
	if (!IsEqual(marginMode, nil)) && (marginMode != "cash") {
		margin = true
	} else {
	...
	if IsEqual(spot, true) {
		if margin == true {
			var defaultCurrency any = Ternary((side == "buy"), GetValue(market, "quote"), GetValue(market, "base"))
	...
	var fok bool = (timeInForce != nil && *timeInForce == "FOK") || (typeVar == "fok")
	// const conditional = (stopLossPrice !== undefined) || (takeProfitPrice !== undefined) || (type === 'conditional');
	var marketIOC bool = (isMarketOrder && ioc) || (typeVar == "optimal_limit_ioc")
...
func (this *OkxCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var isAlgoOrder any = nil
	if (typeVar == "trigger") || (typeVar == "conditional") || (typeVar == "move_order_stop") || (typeVar == "oco") || (typeVar == "iceberg") || (typeVar == "twap") {
		isAlgoOrder = true
	}
	var response any = nil
	if EvalTruthy(isAlgoOrder) {
...
func (this *OkxCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes451819 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
		PanicOnError(retRes451819)
		ch <- retRes451819
		return nil
	}
	var request map[string]any = map[string]any{}
...
func (this *OkxCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes467912 := (<-this.LoadMarkets())
		PanicOnError(retRes467912)
	}
	var request map[string]any = map[string]any{}
	var market any = nil
	if !IsEqual(symbol, nil) {
...
func (this *OkxCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes487619 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes505719 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
		PanicOnError(retRes505719)
		ch <- retRes505719
		return nil
	}
	var request any = map[string]any{}
...
func (this *OkxCore) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes513215 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes515819 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) fetchDepositAddressesByNetworkBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes545612 := (<-this.LoadMarkets())
		PanicOnError(retRes545612)
	}
...
func (this *OkxCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes561419 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes572619 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) fetchPositionsForSymbolBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes624415 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes682715 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes684112 := (<-this.LoadMarkets())
		PanicOnError(retRes684112)
	}
	var market any = this.Market(symbol)
...
func (this *OkxCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes688612 := (<-this.LoadMarkets())
		PanicOnError(retRes688612)
	}
...
func (this *OkxCore) fetchCrossBorrowRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes728712 := (<-this.LoadMarkets())
		PanicOnError(retRes728712)
	}
...
func (this *OkxCore) fetchBorrowRateHistoriesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes742012 := (<-this.LoadMarkets())
		PanicOnError(retRes742012)
	}
	var request map[string]any = map[string]any{}
	if !IsEqual(since, nil) {
...
func (this *OkxCore) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes750212 := (<-this.LoadMarkets())
		PanicOnError(retRes750212)
	}
	var market any = this.Market(symbol)
	var posSide *string = this.SafeString(params, "posSide", "net")
...
func (this *OkxCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes762415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes763815 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes765312 := (<-this.LoadMarkets())
		PanicOnError(retRes765312)
	}
	var market any = this.Market(symbol)
...
func (this *OkxCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes788412 := (<-this.LoadMarkets())
		PanicOnError(retRes788412)
	}
...
func (this *OkxCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes819612 := (<-this.LoadMarkets())
		PanicOnError(retRes819612)
	}
	var request map[string]any = map[string]any{}
...
func (this *OkxCore) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes833612 := (<-this.LoadMarkets())
		PanicOnError(retRes833612)
	}
	var market any = this.Market(symbol)
	var typeVar any = nil
...
func (this *OkxCore) fetchUnderlyingAssetsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes843712 := (<-this.LoadMarkets())
		PanicOnError(retRes843712)
	}
	var marketType any = nil
...
func (this *OkxCore) fetchOptionChainBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes878912 := (<-this.LoadMarkets())
		PanicOnError(retRes878912)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
...
func (this *OkxCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes916912 := (<-this.LoadMarkets())
		PanicOnError(retRes916912)
	}
