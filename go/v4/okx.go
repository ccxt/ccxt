...
func (this *OkxCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes170112 := (<-this.LoadTimeDifference())
...
func (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes252419 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes263819 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes274619 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes307215 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes309515 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes443019 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes478219 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes496119 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes503615 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes506019 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes550619 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes561419 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes612115 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes668415 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) FetchCrossBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes71198 := (<-this.LoadMarkets())
		PanicOnError(retRes71198)
...
func (this *OkxCore) FetchBorrowRateHistories(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes72418 := (<-this.LoadMarkets())
		PanicOnError(retRes72418)
		var request any = map[string]any{}
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *OkxCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes72858 := (<-this.LoadMarkets())
		PanicOnError(retRes72858)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
		}
...
func (this *OkxCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes73198 := (<-this.LoadMarkets())
		PanicOnError(retRes73198)
		var market any = this.Market(symbol)
		var posSide any = this.SafeString(params, "posSide", "net")
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes743815 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes745215 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes76518 := (<-this.LoadMarkets())
		PanicOnError(retRes76518)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy":  GetValue(currency, "id"),
			"amt":  this.CurrencyToPrecision(code, amount),
...
func (this *OkxCore) FetchOpenInterests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes78048 := (<-this.LoadMarkets())
		PanicOnError(retRes78048)
...
func (this *OkxCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes82678 := (<-this.LoadMarkets())
		PanicOnError(retRes82678)
		var market any = this.Market(symbol)
...
func (this *OkxCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes85228 := (<-this.LoadMarkets())
		PanicOnError(retRes85228)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"instId": GetValue(market, "id"),
		}
...
func (this *OkxCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes87188 := (<-this.LoadMarkets())
		PanicOnError(retRes87188)
		var request any = map[string]any{
			"quoteId":  id,
			"baseCcy":  fromCode,
			"quoteCcy": toCode,
...
func (this *OkxCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes88248 := (<-this.LoadMarkets())
		PanicOnError(retRes88248)
		var request any = map[string]any{}
		requestparamsVariable := this.HandleUntilOption("after", request, params)
		request = GetValue(requestparamsVariable, 0)
		params = GetValue(requestparamsVariable, 1)
