...
func (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes253919 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
			PanicOnError(retRes253919)
			ch <- retRes253919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes265519 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
			PanicOnError(retRes265519)
			ch <- retRes265519
			return nil
		}
...
func (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes276519 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
			PanicOnError(retRes276519)
			ch <- retRes276519
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes309715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes312215 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func (this *OkxCore) CancelOrdersForSymbols(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes390012 := (<-this.LoadMarkets())
			PanicOnError(retRes390012)
		}
		var request any = []any{}
...
func (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes448819 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes448819)
			ch <- retRes448819
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes484419 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
			PanicOnError(retRes484419)
			ch <- retRes484419
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes502012 := (<-this.LoadMarkets())
			PanicOnError(retRes502012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes502519 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes502519)
			ch <- retRes502519
			return nil
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes510015 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *OkxCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes512619 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func (this *OkxCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes558019 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *OkxCore) FetchDeposit(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes565612 := (<-this.LoadMarkets())
			PanicOnError(retRes565612)
		}
		var request any = map[string]any{
			"depId": id,
		}
...
func (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes569219 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *OkxCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes596412 := (<-this.LoadMarkets())
			PanicOnError(retRes596412)
		}
		var marginMode any = nil
...
func (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes621015 := (<-this.FetchPositions([]any{symbol}, params))
...
func (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes679215 := (<-this.FetchFundingRate(symbol, params))
...
func (this *OkxCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes680612 := (<-this.LoadMarkets())
			PanicOnError(retRes680612)
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes706412 := (<-this.LoadMarkets())
			PanicOnError(retRes706412)
		}
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *OkxCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes719712 := (<-this.LoadMarkets())
			PanicOnError(retRes719712)
		}
		var market any = this.Market(symbol)
...
func (this *OkxCore) FetchCrossBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes723812 := (<-this.LoadMarkets())
			PanicOnError(retRes723812)
		}
...
func (this *OkxCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes727212 := (<-this.LoadMarkets())
			PanicOnError(retRes727212)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
...
func (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes756615 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes758015 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *OkxCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes770312 := (<-this.LoadMarkets())
			PanicOnError(retRes770312)
		}
		var marginMode any = nil
...
func (this *OkxCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes801212 := (<-this.LoadMarkets())
			PanicOnError(retRes801212)
		}
...
func (this *OkxCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes813812 := (<-this.LoadMarkets())
			PanicOnError(retRes813812)
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes827612 := (<-this.LoadMarkets())
			PanicOnError(retRes827612)
		}
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *OkxCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes848212 := (<-this.LoadMarkets())
			PanicOnError(retRes848212)
		}
		var request any = map[string]any{}
...
func (this *OkxCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes867912 := (<-this.LoadMarkets())
			PanicOnError(retRes867912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"instId": GetValue(market, "id"),
...
func (this *OkxCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes872912 := (<-this.LoadMarkets())
			PanicOnError(retRes872912)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *OkxCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes888112 := (<-this.LoadMarkets())
			PanicOnError(retRes888112)
		}
		var request any = map[string]any{
			"quoteId":  id,
			"baseCcy":  fromCode,
...
func (this *OkxCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes922012 := (<-this.LoadMarkets())
			PanicOnError(retRes922012)
		}
...
func (this *OkxCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes940712 := (<-this.LoadMarkets())
			PanicOnError(retRes940712)
		}
		if IsTrue(IsEqual(symbol, nil)) {
