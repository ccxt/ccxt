...
func  (this *OkxCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes251419 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes251419)
                    ch <- retRes251419
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *OkxCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes262819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
...
func  (this *OkxCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes273619 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func  (this *OkxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            var req any = map[string]any {
                ...
                retRes306215 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *OkxCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            var req any = map[string]any {
                ...
                retRes308515 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, this.Extend(req, params)))
...
func  (this *OkxCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes442019 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, maxLimit))
...
func  (this *OkxCore) FetchCanceledOrders(optionalArgs ...any) <- chan any {
            ...
            retRes45798 := (<-this.LoadMarkets())
            PanicOnError(retRes45798)
            var request any = map[string]any {}
            var market any = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *OkxCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes477219 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, maxLimit))
                    PanicOnError(retRes477219)
                    ch <- retRes477219
                    return nil
            }
            var request any = map[string]any {}
...
func  (this *OkxCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes495119 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes495119)
                    ch <- retRes495119
                    return nil
            }
            var request any = map[string]any {}
...
func  (this *OkxCore) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes502615 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes502615)
                ch <- retRes502615
                return nil
...
func  (this *OkxCore) FetchLedger(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes505019 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *OkxCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes549619 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *OkxCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            retRes56008 := (<-this.LoadMarkets())
            PanicOnError(retRes56008)
            var paginate any = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes560419 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *OkxCore) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes59428 := (<-this.LoadMarkets())
            PanicOnError(retRes59428)
            var market any = this.Market(symbol)
...
func  (this *OkxCore) FetchPositionsForSymbol(symbol any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes611115 :=  (<-this.FetchPositions([]any{symbol}, params))
                PanicOnError(retRes611115)
                ch <- retRes611115
                return nil
...
func  (this *OkxCore) FetchFundingInterval(symbol any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes667415 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *OkxCore) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
            ...
            retRes69398 := (<-this.LoadMarkets())
            PanicOnError(retRes69398)
            var market any = this.Market(symbol)
            var marginMode any = nil
...
func  (this *OkxCore) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
            ...
            retRes70708 := (<-this.LoadMarkets())
            PanicOnError(retRes70708)
            var market any = this.Market(symbol)
...
func  (this *OkxCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes742815 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func  (this *OkxCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes744215 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func  (this *OkxCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes76818 := (<-this.LoadMarkets())
            PanicOnError(retRes76818)
...
func  (this *OkxCore) FetchOpenInterests(optionalArgs ...any) <- chan any {
            ...
            retRes77948 := (<-this.LoadMarkets())
            PanicOnError(retRes77948)
...
func  (this *OkxCore) FetchSettlementHistory(optionalArgs ...any) <- chan any {
            ...
            retRes81198 := (<-this.LoadMarkets())
            PanicOnError(retRes81198)
            var market any = this.Market(symbol)
            var typeVar any = nil
...
func  (this *OkxCore) FetchGreeks(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes82578 := (<-this.LoadMarkets())
            PanicOnError(retRes82578)
            var market any = this.Market(symbol)
...
func  (this *OkxCore) FetchOption(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes85128 := (<-this.LoadMarkets())
            PanicOnError(retRes85128)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "instId": GetValue(market, "id"),
            }
...
func  (this *OkxCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <- chan any {
            ...
            retRes87088 := (<-this.LoadMarkets())
            PanicOnError(retRes87088)
            var request any = map[string]any {
                "quoteId": id,
                "baseCcy": fromCode,
                "quoteCcy": toCode,
...
func  (this *OkxCore) FetchConvertCurrencies(optionalArgs ...any) <- chan any {
            ...
            retRes89308 := (<-this.LoadMarkets())
            PanicOnError(retRes89308)
...
func  (this *OkxCore) FetchLongShortRatioHistory(optionalArgs ...any) <- chan any {
            ...
            retRes92228 := (<-this.LoadMarkets())
            PanicOnError(retRes92228)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "instId": GetValue(market, "id"),
            }
