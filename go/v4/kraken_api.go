...
func (this *KrakenCore) PublicGetLevel3(args ...interface{}) <-chan interface{} {
	return this.callEndpointAsync("publicGetLevel3", args...)
}

func (this *KrakenCore) PublicGetGroupedBook(args ...interface{}) <-chan interface{} {
...
func (this *KrakenCore) PublicGetPreTrade(args ...interface{}) <-chan interface{} {
	return this.callEndpointAsync("publicGetPreTrade", args...)
}

func (this *KrakenCore) PublicGetPostTrade(args ...interface{}) <-chan interface{} {
...
func (this *KrakenCore) PrivatePostCreditLines(args ...interface{}) <-chan interface{} {
...
func (this *KrakenCore) PrivatePostOrderAmends(args ...interface{}) <-chan interface{} {
