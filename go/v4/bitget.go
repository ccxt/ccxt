...
func (this *Bitget) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes931712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes931712)
	}
	if symbol == nil {
	...
	if paginate == true {
		if uta == true {
			...
			retRes932823 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes932823)
			ch <- retRes932823
			return nil
		}

		retRes933019 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
		PanicOnError(retRes933019)
		ch <- retRes933019
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Bitget) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes947112 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes954515 := (<-this.ModifyMarginHelperAsync(symbol, amount, "reduce", params))
	PanicOnError(retRes954515)
	ch <- retRes954515
	return nil
}
...
func (this *Bitget) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes956315 := (<-this.ModifyMarginHelperAsync(symbol, amount, "add", params))
	PanicOnError(retRes956315)
	ch <- retRes956315
	return nil
}
...
func (this *Bitget) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes957712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes957712)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes972812 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes977212 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes982712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes982712)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Bitget) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes994012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes994012)
	}
	var typeVar any = nil
...
func (this *Bitget) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1000412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1000412)
	}
	var uta any = nil
...
func (this *Bitget) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1016712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1016712)
	}
...
func (this *Bitget) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1021512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1021512)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"coin":         currency["id"],
...
func (this *Bitget) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1025212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1025212)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
...
func (this *Bitget) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1029212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1029212)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
...
func (this *Bitget) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1033212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1033212)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"coin":        currency["id"],
...
func (this *Bitget) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1042912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1042912)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes1043419 := (<-this.FetchPaginatedCallCursorAsync("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1043419)
		ch <- retRes1043419
		return nil
	}
	var market any = nil
...
func (this *Bitget) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1058412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1058412)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Bitget) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1070512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1070512)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"coin": currency["id"],
...
func (this *Bitget) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1082412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1082412)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes1082919 := (<-this.FetchPaginatedCallCursorAsync("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1082919)
		ch <- retRes1082919
		return nil
	}
	var market any = nil
...
func (this *Bitget) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1097712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1097712)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Bitget) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1105112 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1111412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1111412)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1118412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1118412)
	}
	var request any = map[string]any{}
	var market any = nil
	var productType any = nil
...
func (this *Bitget) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1129312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1129312)
	}
	var request map[string]any = map[string]any{
		"fromCoin":     fromCode,
		"toCoin":       toCode,
...
func (this *Bitget) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1134112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1134112)
	}
...
func (this *Bitget) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1139312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1139312)
	}
	var request map[string]any = map[string]any{}
	var msInDay int = 86400000
	var now int64 = this.Milliseconds()
...
func (this *Bitget) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1150612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1150612)
	}
...
func (this *Bitget) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1157712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1157712)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1164512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1164512)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
