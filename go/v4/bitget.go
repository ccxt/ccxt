...
func (this *Bitget) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	//
	var data any = this.SafeValue(response, "data", map[string]any{})
	var bidsKey string = Ternary((IsEqual(uta, true)), "b", "bids").(string)
	var asksKey string = Ternary((IsEqual(uta, true)), "a", "asks").(string)
...
func (this *Bitget) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if !IsEqual(feeStructure, nil) {
		...
		var deduction bool = Ternary(IsEqual(this.SafeString(feeStructure, "deduction"), "yes"), true, false).(bool)
		if deduction {
...
func (this *Bitget) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(uta, true) {
		...
		if IsEqual(marketType, "spot") {
			if (!IsEqual(marginMode, nil)) || (utaMargin != nil && *utaMargin == true) {
	...
	if IsEqual(marketType, "spot") {
		...
		params = this.Omit(params, "margin")
		if (!IsEqual(marginMode, nil)) || (margin != nil && *margin == true) {
...
func (this *Bitget) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	var volumeIndex int = Ternary((inverse != nil && *inverse == true), 6, 5).(int)
...
func (this *Bitget) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = GetValue(paginateparamsVariable, 1)
	if EvalTruthy(paginate) {
		var limitForPagination any = Ternary((useHistoryEndpointForPagination != nil && *useHistoryEndpointForPagination == true), maxLimitForHistoryEndpoint, maxLimitForRecentEndpoint)
	...
	var key string = Ternary((IsEqual(GetValue(market, "spot"), true)), "spot", "swap").(string)
...
func (this *Bitget) CreateUtaOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if reduceOnly != nil && *reduceOnly == true {
		if (IsEqual(hedged, true)) || isStopLossOrTakeProfitTrigger {
			var reduceOnlyPosSide string = Ternary((IsEqual(side, "sell")), "long", "short").(string)
		...
		if IsEqual(hedged, true) {
			var posSide string = Ternary((IsEqual(side, "buy")), "long", "short").(string)
...
func (this *Bitget) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if (IsEqual(marketType, "swap")) || (IsEqual(marketType, "future")) {
		...
		if !isStopLossOrTakeProfitTrigger {
			...
			var marginModeRequest string = Ternary((IsEqual(marginMode, "cross")), "crossed", "isolated").(string)
...
func (this *Bitget) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(uta, true) {
		...
		if (!IsEqual(marginMode, nil)) || (trigger != nil && *trigger == true) {
...
func (this *Bitget) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes795912 := (<-this.LoadMarketsAsync())
	...
	if EvalTruthy(paginate) {
		if IsEqual(uta, true) {
			...
			retRes798023 := (<-this.FetchPaginatedCallCursorAsync("fetchLedger", code, since, limit, params, "id", "cursor", nil, 100))
			PanicOnError(retRes798023)
			ch <- retRes798023
			return nil
		}
		var cursorReceived any = nil
		...
		retRes799019 := (<-this.FetchPaginatedCallCursorAsync("fetchLedger", code, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes799019)
		ch <- retRes799019
		return nil
	}
	var currency any = nil
	...
	if IsEqual(uta, true) {
		...
		var utaData any = this.SafeDict(response, "data", map[string]any{})
...
func (this *Bitget) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes845812 := (<-this.LoadMarketsAsync())
	...
	if EvalTruthy(paginate) {
		...
		retRes848819 := (<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes848819)
		ch <- retRes848819
		return nil
	}
	var response any = nil
...
func (this *Bitget) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes867312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes867312)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes878712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes878712)
	}
	var paginate any = false
	...
	if EvalTruthy(paginate) {
		...
		retRes879219 := (<-this.FetchPaginatedCallCursorAsync("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
		PanicOnError(retRes879219)
		ch <- retRes879219
		return nil
	}
	var method any = nil
...
func (this *Bitget) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes920612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes920612)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *Bitget) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes930212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes930212)
	}
	var market any = this.Market(symbol)
...
func (this *Bitget) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes939412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes939412)
	}
	var market any = nil
	if !IsEqual(symbols, nil) {
		var symbol any = this.SafeValue(symbols, 0)
...
func (this *Bitget) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes959012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes959012)
	}
	if IsEqual(symbol, nil) {
	...
	if EvalTruthy(paginate) {
		if IsEqual(uta, true) {
			...
			retRes960123 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes960123)
			ch <- retRes960123
			return nil
		}

		retRes960319 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
		PanicOnError(retRes960319)
		ch <- retRes960319
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *Bitget) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes974412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes974412)
	}
...
func (this *Bitget) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	var status string = Ternary((errorCode != nil && *errorCode == "00000"), "ok", "failed").(string)
	return map[string]any{
		"info":       data,
...
func (this *Bitget) ParseLeverage(leverage any, optionalArgs ...any) any {
	...
	var longLevKey string = Ternary(isCrossMarginMode, "crossedMarginLeverage", "isolatedLongLever").(string)
	var shortLevKey string = Ternary(isCrossMarginMode, "crossedMarginLeverage", "isolatedShortLever").(string)
	return map[string]any{
		"info":          leverage,
		"symbol":        this.SafeString(market, "symbol"),
...
func (this *Bitget) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes992512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes992512)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1000112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1000112)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1004512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1004512)
	}
	var posMode string = Ternary(EvalTruthy(hedged), "hedge_mode", "one_way_mode").(string)
	var request map[string]any = map[string]any{}
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
...
func (this *Bitget) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1010012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1010012)
	}
	var market any = this.Market(symbol)
...
func (this *Bitget) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1021312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1021312)
	}
	var typeVar any = nil
...
func (this *Bitget) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1027712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1027712)
	}
	var uta any = nil
...
func (this *Bitget) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1044012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1044012)
	}
...
func (this *Bitget) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1048812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1048812)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":         GetValue(currency, "id"),
...
func (this *Bitget) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1052512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1052512)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *Bitget) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1056512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1056512)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *Bitget) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1060512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1060512)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":        GetValue(currency, "id"),
...
func (this *Bitget) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1070212 := (<-this.LoadMarketsAsync())
	...
	if EvalTruthy(paginate) {
		...
		retRes1070719 := (<-this.FetchPaginatedCallCursorAsync("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1070719)
		ch <- retRes1070719
		return nil
	}
	var market any = nil
...
func (this *Bitget) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1085712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1085712)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *Bitget) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1097812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1097812)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin": GetValue(currency, "id"),
...
func (this *Bitget) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1109712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1109712)
	}
	var paginate any = false
	...
	if EvalTruthy(paginate) {
		...
		retRes1110219 := (<-this.FetchPaginatedCallCursorAsync("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1110219)
		ch <- retRes1110219
		return nil
	}
	var market any = nil
...
func (this *Bitget) ParseBorrowInterest(info any, optionalArgs ...any) any {
	...
	var marginMode string = Ternary((marketId != nil), "isolated", "cross").(string)
...
func (this *Bitget) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1125012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1125012)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *Bitget) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1132412 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1138712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1138712)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1145712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1145712)
	}
	var request any = map[string]any{}
	var market any = nil
	var productType any = nil
...
func (this *Bitget) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1161412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1161412)
	}
...
func (this *Bitget) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1166612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1166612)
	}
	var request map[string]any = map[string]any{}
	var msInDay int = 86400000
	var now int64 = this.Milliseconds()
...
func (this *Bitget) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1177912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1177912)
	}
...
func (this *Bitget) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1185012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1185012)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *Bitget) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes1191812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1191812)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
