...
func  (this *bitget) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes186712 := (<-this.LoadTimeDifference())
            ...
            if IsTrue(uta) {
                    ...
                    retRes187219 :=  (<-this.FetchUtaMarkets(params))
                    PanicOnError(retRes187219)
                    ch <- retRes187219
                    return nil
            } else {
        
                    retRes187419 :=  (<-this.FetchDefaultMarkets(params))
...
func  (this *bitget) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes271819 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
                    PanicOnError(retRes271819)
                    ch <- retRes271819
                    return nil
            }
...
func  (this *bitget) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes284419 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
                    PanicOnError(retRes284419)
                    ch <- retRes284419
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitget) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes37928 := (<-this.LoadMarkets())
            PanicOnError(retRes37928)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes379619 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
...
func  (this *bitget) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes39268 := (<-this.LoadMarkets())
            PanicOnError(retRes39268)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitget) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                var limitForPagination interface{} = Ternary(IsTrue(useHistoryEndpointForPagination), maxLimitForHistoryEndpoint, maxLimitForRecentEndpoint)
                    ...
                    retRes414819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
                    PanicOnError(retRes414819)
                    ch <- retRes414819
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitget) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes496815 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
                PanicOnError(retRes496815)
                ch <- retRes496815
                return nil
...
func  (this *bitget) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes547219 :=  (<-this.CreateUtaOrders(orders, params))
...
func  (this *bitget) CancelUtaOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes59228 := (<-this.LoadMarkets())
            PanicOnError(retRes59228)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes59768 := (<-this.LoadMarkets())
            PanicOnError(retRes59768)
            var market interface{} = this.Market(symbol)
            var uta interface{} = nil
            ...
            if IsTrue(uta) {
                    ...
                    retRes598119 :=  (<-this.CancelUtaOrders(ids, symbol, params))
...
func  (this *bitget) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62088 := (<-this.LoadMarkets())
            PanicOnError(retRes62088)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bitget) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63818 := (<-this.LoadMarkets())
            PanicOnError(retRes63818)
            var market interface{} = nil
            var typeVar interface{} = nil
            var request interface{} = map[string]interface{} {}
            var marginMode interface{} = nil
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(uta) {
                    ...
                    retRes641619 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
                    PanicOnError(retRes641619)
                    ch <- retRes641619
                    return nil
            }
            var response interface{} = nil
...
func  (this *bitget) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes684419 :=  (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
                    PanicOnError(retRes684419)
                    ch <- retRes684419
                    return nil
            }
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes686819 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes686819)
                    ch <- retRes686819
                    return nil
            }
            var response interface{} = nil
...
func  (this *bitget) FetchUtaCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes714819 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
...
func  (this *bitget) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72708 := (<-this.LoadMarkets())
            PanicOnError(retRes72708)
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(!IsEqual(marketType, "spot")) {
                    ...
                    retRes728619 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func  (this *bitget) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes74978 := (<-this.LoadMarkets())
            PanicOnError(retRes74978)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            requestparamsVariable := this.HandleUntilOption("endTime", request, params);
            request = GetValue(requestparamsVariable,0);
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(uta) {
                    ...
                    retRes752619 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
                    PanicOnError(retRes752619)
                    ch <- retRes752619
                    return nil
            }
            var response interface{} = nil
...
func  (this *bitget) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78208 := (<-this.LoadMarkets())
            PanicOnError(retRes78208)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes782419 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
                    PanicOnError(retRes782419)
                    ch <- retRes782419
                    return nil
            }
...
func  (this *bitget) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81908 := (<-this.LoadMarkets())
            PanicOnError(retRes81908)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
        ...
        response = (<-this.PublicUtaGetV3MarketHistoryFundRate(this.Extend(request, params)))
                ...
                if IsTrue(paginate) {
                        ...
                        retRes822923 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
                        PanicOnError(retRes822923)
                        ch <- retRes822923
                        return nil
                }
                if IsTrue(!IsEqual(limit, nil)) {
...
func  (this *bitget) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83738 := (<-this.LoadMarkets())
            PanicOnError(retRes83738)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                var symbol interface{} = this.SafeValue(symbols, 0)
                market = this.Market(symbol)
...
func  (this *bitget) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes85258 := (<-this.LoadMarkets())
            PanicOnError(retRes85258)
            if IsTrue(IsEqual(symbol, nil)) {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes853219 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func  (this *bitget) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes870015 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes870015)
                ch <- retRes870015
                return nil
...
func  (this *bitget) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes871815 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes871815)
                ch <- retRes871815
                return nil
...
func  (this *bitget) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87318 := (<-this.LoadMarkets())
            PanicOnError(retRes87318)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes88048 := (<-this.LoadMarkets())
            PanicOnError(retRes88048)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes88788 := (<-this.LoadMarkets())
            PanicOnError(retRes88788)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89208 := (<-this.LoadMarkets())
            PanicOnError(retRes89208)
...
func  (this *bitget) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89738 := (<-this.LoadMarkets())
            PanicOnError(retRes89738)
            var market interface{} = this.Market(symbol)
...
func  (this *bitget) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91448 := (<-this.LoadMarkets())
            PanicOnError(retRes91448)
            var currency interface{} = this.Currency(code)
            var accountsByType interface{} = this.SafeValue(this.Options, "accountsByType", map[string]interface{} {})
...
func  (this *bitget) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92968 := (<-this.LoadMarkets())
            PanicOnError(retRes92968)
...
func  (this *bitget) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes93428 := (<-this.LoadMarkets())
            PanicOnError(retRes93428)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bitget) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94158 := (<-this.LoadMarkets())
            PanicOnError(retRes94158)
            var currency interface{} = this.Currency(code)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bitget) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95488 := (<-this.LoadMarkets())
            PanicOnError(retRes95488)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes955219 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes955219)
                    ch <- retRes955219
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitget) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97018 := (<-this.LoadMarkets())
            PanicOnError(retRes97018)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitget) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98208 := (<-this.LoadMarkets())
            PanicOnError(retRes98208)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bitget) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes99378 := (<-this.LoadMarkets())
            PanicOnError(retRes99378)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes994119 :=  (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes994119)
                    ch <- retRes994119
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitget) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100888 := (<-this.LoadMarkets())
            PanicOnError(retRes100888)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitget) CloseAllPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes101608 := (<-this.LoadMarkets())
            PanicOnError(retRes101608)
            var request interface{} = map[string]interface{} {}
            var productType interface{} = nil
            var uta interface{} = nil
            var response interface{} = nil
...
func  (this *bitget) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102218 := (<-this.LoadMarkets())
            PanicOnError(retRes102218)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes103968 := (<-this.LoadMarkets())
            PanicOnError(retRes103968)
            var request interface{} = map[string]interface{} {
                "fromCoin": fromCode,
                "toCoin": toCode,
...
func  (this *bitget) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes104928 := (<-this.LoadMarkets())
            PanicOnError(retRes104928)
            var request interface{} = map[string]interface{} {}
            var msInDay interface{} = 86400000
            var now interface{} = this.Milliseconds()
            if IsTrue(!IsEqual(since, nil)) {
...
func  (this *bitget) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes106038 := (<-this.LoadMarkets())
            PanicOnError(retRes106038)
...
func  (this *bitget) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes106708 := (<-this.LoadMarkets())
            PanicOnError(retRes106708)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
