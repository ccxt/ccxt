...
func (this *BitgetCore) handleUTAAndParamsBody(ch chan any, params any, methodName any, optionalArgs ...any) any {
	defer close(ch)
	...
	if IsTrue(this.CheckRequiredCredentials(false)) {
...

		{
			func(this *BitgetCore) (ret_ any) {
				...
				retRes209316 := (<-this.PrivateUtaGetV3AccountSettings())
				PanicOnError(retRes209316)
				accountIsUTa = true
				return nil
			}(this)
...
func (this *BitgetCore) fetchTimeBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
...
func (this *BitgetCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true)) {
		...
		retRes214212 := (<-this.LoadTimeDifference())
		PanicOnError(retRes214212)
	}
	var uta any = nil
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes214719 := (<-this.FetchUtaMarkets(params))
		PanicOnError(retRes214719)
		ch <- retRes214719
		return nil
	}

	retRes214915 := (<-this.FetchDefaultMarkets(params))
	PanicOnError(retRes214915)
	ch <- retRes214915
	return nil
}
...
func (this *BitgetCore) fetchDefaultMarketsBody(ch chan any, params any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	var types any = nil
...
func (this *BitgetCore) fetchUtaMarketsBody(ch chan any, params any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(markets)); i++ {
		...
		var marginModes any = nil
		var isMarginTradingAllowed bool = false
		var isUtaMargin bool = (IsEqual(category, "MARGIN"))
...
func (this *BitgetCore) fetchCurrenciesBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *BitgetCore) ParseCurrency(rawCurrency any) any {
	...
	var active bool = IsTrue((IsEqual(withdraw, true))) && IsTrue((IsEqual(deposit, true)))
...
func (this *BitgetCore) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *BitgetCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	var uta any = nil
	utaparamsVariable := (<-this.HandleUTAAndParams(params, "fetchDeposits", false))
	uta = GetValue(utaparamsVariable, 0)
	params = GetValue(utaparamsVariable, 1)
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes303423 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "orderId", "cursor", nil, 100))
			PanicOnError(retRes303423)
			ch <- retRes303423
			return nil
		}

		retRes303619 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
		PanicOnError(retRes303619)
		ch <- retRes303619
		return nil
	}
	if IsTrue(IsEqual(since, nil)) {
		if IsTrue(IsEqual(uta, true)) {
			since = Subtract(this.Milliseconds(), 2592000000) // uta allows a window of 30 days at most
		} else {
...
func (this *BitgetCore) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	var uta any = nil
	utaparamsVariable := (<-this.HandleUTAAndParams(params, "withdraw", false))
	uta = GetValue(utaparamsVariable, 0)
	params = GetValue(utaparamsVariable, 1)
	var currency any = this.Currency(code)
...
func (this *BitgetCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	code := GetArg(optionalArgs, 0, nil)
	_ = code
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes320612 := (<-this.LoadMarkets())
		PanicOnError(retRes320612)
	}
	var uta any = nil
	utaparamsVariable := (<-this.HandleUTAAndParams(params, "fetchWithdrawals", false))
	uta = GetValue(utaparamsVariable, 0)
	params = GetValue(utaparamsVariable, 1)
	var paginate any = false
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes321423 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "orderId", "cursor", nil, 100))
			PanicOnError(retRes321423)
			ch <- retRes321423
			return nil
		}

		retRes321619 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
...
func (this *BitgetCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var timestamp any = this.SafeInteger2(transaction, "cTime", "createdTime")
	...
	var txid any = this.SafeString(transaction, "tradeId")
	if IsTrue(IsEqual(txid, nil)) {
		var dest any = this.SafeString(transaction, "dest")
...
func (this *BitgetCore) ParseTransactionType(typeVar any) any {
...
func (this *BitgetCore) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes343212 := (<-this.LoadMarkets())
		PanicOnError(retRes343212)
	}
	var uta any = nil
	utaparamsVariable := (<-this.HandleUTAAndParams(params, "fetchDepositAddress", false))
	uta = GetValue(utaparamsVariable, 0)
	params = GetValue(utaparamsVariable, 1)
	var networkCode any = nil
	networkCodeparamsVariable := this.HandleNetworkCodeAndParams(params)
...
func (this *BitgetCore) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes351012 := (<-this.LoadMarkets())
		PanicOnError(retRes351012)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
	...
	//
	var data any = this.SafeValue(response, "data", map[string]any{})
	var bidsKey any = Ternary(IsTrue((IsEqual(uta, true))), "b", "bids")
	var asksKey any = Ternary(IsTrue((IsEqual(uta, true))), "a", "asks")
...
func (this *BitgetCore) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *BitgetCore) fetchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *BitgetCore) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes391512 := (<-this.LoadMarkets())
		PanicOnError(retRes391512)
	}
	var market any = nil
...
func (this *BitgetCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes424412 := (<-this.LoadMarkets())
		PanicOnError(retRes424412)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes424919 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
		PanicOnError(retRes424919)
		ch <- retRes424919
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes438012 := (<-this.LoadMarkets())
		PanicOnError(retRes438012)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	...
	if IsTrue(IsEqual(marketType, "spot")) {
		...
		if IsTrue(IsTrue((!IsEqual(marginMode, nil))) || IsTrue((IsEqual(margin, true)))) {
...
func (this *BitgetCore) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	var volumeIndex any = Ternary(IsTrue((IsEqual(inverse, true))), 6, 5)
...
func (this *BitgetCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes459612 := (<-this.LoadMarkets())
		PanicOnError(retRes459612)
	}
	...
	params = GetValue(paginateparamsVariable, 1)
	if IsTrue(paginate) {
		var limitForPagination any = Ternary(IsTrue((IsEqual(useHistoryEndpointForPagination, true))), maxLimitForHistoryEndpoint, maxLimitForRecentEndpoint)

		retRes460719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
		PanicOnError(retRes460719)
		ch <- retRes460719
		return nil
	}
	var market any = this.Market(symbol)
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		marketType = Ternary(IsTrue((IsEqual(GetValue(market, "spot"), true))), "spot", "swap")
	...
	var key any = Ternary(IsTrue((IsEqual(GetValue(market, "spot"), true))), "spot", "swap")
	...
	if IsTrue(IsTrue((IsTrue(!IsEqual(calculatedStartTime, nil)) && IsTrue(IsLessThanOrEqual(calculatedStartTime, recentEndpointBoundaryTs)))) || IsTrue((IsEqual(useHistoryEndpoint, true)))) {
...
func (this *BitgetCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes478512 := (<-this.LoadMarkets())
		PanicOnError(retRes478512)
	}
	var request map[string]any = map[string]any{}
	var marketType any = nil
	var marginMode any = nil
...
func (this *BitgetCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes546112 := (<-this.LoadMarkets())
		PanicOnError(retRes546112)
	}
	var market any = this.Market(symbol)
	if IsTrue(!IsEqual(GetValue(market, "spot"), true)) {
	...
	retRes547015 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
	PanicOnError(retRes547015)
	ch <- retRes547015
	return nil
}
...
func (this *BitgetCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes552012 := (<-this.LoadMarkets())
		PanicOnError(retRes552012)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) createUtaOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes595412 := (<-this.LoadMarkets())
		PanicOnError(retRes595412)
	}
...
func (this *BitgetCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes602312 := (<-this.LoadMarkets())
		PanicOnError(retRes602312)
	}
	var uta any = nil
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes602819 := (<-this.CreateUtaOrders(orders, params))
		PanicOnError(retRes602819)
		ch <- retRes602819
		return nil
	}
	var ordersRequests any = []any{}
...
func (this *BitgetCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(IsTrue(IsTrue((IsTrue((IsEqual(editMarketBuyOrderRequiresPrice, true))) || IsTrue((!IsEqual(cost, nil))))) && IsTrue(isMarketOrder)) && IsTrue((IsEqual(side, "buy")))) {
...
func (this *BitgetCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes637512 := (<-this.LoadMarkets())
		PanicOnError(retRes637512)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
	...
	uta = GetValue(utaparamsVariable, 0)
	params = GetValue(utaparamsVariable, 1)
	var isPlanOrder bool = IsTrue((IsEqual(trigger, true))) || IsTrue((IsEqual(trailing, true)))
	var isContract bool = IsTrue((IsEqual(GetValue(market, "swap"), true))) || IsTrue((IsEqual(GetValue(market, "future"), true)))
	var isContractTriggerEndpoint bool = IsTrue(IsTrue(isContract) && IsTrue(isPlanOrder)) && IsTrue((!IsEqual(uta, true)))
	var clientOrderId any = this.SafeString2(params, "clientOrderId", "clientOid")
...
func (this *BitgetCore) cancelUtaOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes651912 := (<-this.LoadMarkets())
		PanicOnError(retRes651912)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes657512 := (<-this.LoadMarkets())
		PanicOnError(retRes657512)
	}
	var market any = this.Market(symbol)
	var uta any = nil
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes658119 := (<-this.CancelUtaOrders(ids, symbol, params))
		PanicOnError(retRes658119)
		ch <- retRes658119
		return nil
	}
	var marginMode any = nil
...
func (this *BitgetCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
...
func (this *BitgetCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes679112 := (<-this.LoadMarkets())
		PanicOnError(retRes679112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{}
	var clientOrderId any = this.SafeString2(params, "clientOrderId", "clientOid")
	...
	//     }
	//
	if IsTrue(IsTrue((!IsEqual(uta, true))) && IsTrue((IsString(response)))) {
...
func (this *BitgetCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(paginate) {
		...
		retRes701319 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes701319)
		ch <- retRes701319
		return nil
	}
	var response any = nil
	...
	var isTrigger bool = IsTrue((IsEqual(trigger, true))) || IsTrue(planTypeDefined)
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
	request = GetValue(requestparamsVariable, 0)
	params = GetValue(requestparamsVariable, 1)
	if IsTrue(!IsEqual(since, nil)) {
	...
	if IsTrue(IsTrue((!IsEqual(uta, true))) && IsTrue((IsTrue(IsTrue((IsEqual(typeVar, "swap"))) || IsTrue((IsEqual(typeVar, "future")))) || IsTrue((!IsEqual(marginMode, nil)))))) {
		var clientOrderId any = this.SafeString2(params, "clientOid", "clientOrderId")
		params = this.Omit(params, "clientOrderId")
		if IsTrue(!IsEqual(clientOrderId, nil)) {
			AddElementToObject(request, "clientOid", clientOrderId)
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(IsTrue((!IsEqual(marginMode, nil))) || IsTrue((IsEqual(trigger, true)))) {
...
func (this *BitgetCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
...
func (this *BitgetCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes741212 := (<-this.LoadMarkets())
		PanicOnError(retRes741212)
	}
...
func (this *BitgetCore) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes744719 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
		PanicOnError(retRes744719)
		ch <- retRes744719
		return nil
	}
	if IsTrue(IsEqual(this.Markets, nil)) {

		retRes745012 := (<-this.LoadMarkets())
		PanicOnError(retRes745012)
	}
	var market any = nil
	var request any = map[string]any{}
	if IsTrue(!IsEqual(symbol, nil)) {
	...
	if IsTrue(paginate) {
		...
		retRes747319 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes747319)
		ch <- retRes747319
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchUtaCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(paginate) {
		...
		retRes775519 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
		PanicOnError(retRes775519)
		ch <- retRes775519
		return nil
	}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	code := GetArg(optionalArgs, 0, nil)
	_ = code
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes787812 := (<-this.LoadMarkets())
		PanicOnError(retRes787812)
	}
	...
	if IsTrue(paginate) {
		...
		retRes789519 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes789519)
		ch <- retRes789519
		return nil
	}
	var currency any = nil
...
func (this *BitgetCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	uta = GetValue(utaparamsVariable, 0)
	params = GetValue(utaparamsVariable, 1)
	if IsTrue(IsTrue((!IsEqual(uta, true))) && IsTrue((IsEqual(symbol, nil)))) {
		panic(ArgumentsRequired(Add(this.Id, " fetchMyTrades() requires a symbol argument")))
	}
	if IsTrue(IsEqual(this.Markets, nil)) {

		retRes810712 := (<-this.LoadMarkets())
		PanicOnError(retRes810712)
	}
	var market any = this.Market(symbol)
	var request any = map[string]any{}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
	...
	if IsTrue(paginate) {
		...
		retRes813719 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes813719)
		ch <- retRes813719
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes832212 := (<-this.LoadMarkets())
		PanicOnError(retRes832212)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbols := GetArg(optionalArgs, 0, nil)
	_ = symbols
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes843612 := (<-this.LoadMarkets())
		PanicOnError(retRes843612)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes844119 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
		PanicOnError(retRes844119)
		ch <- retRes844119
		return nil
	}
	var method any = nil
...
func (this *BitgetCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes885512 := (<-this.LoadMarkets())
		PanicOnError(retRes885512)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(paginate) {
			...
			retRes889523 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
			PanicOnError(retRes889523)
			ch <- retRes889523
			return nil
		}
		if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes895112 := (<-this.LoadMarkets())
		PanicOnError(retRes895112)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbols := GetArg(optionalArgs, 0, nil)
	_ = symbols
...
func (this *BitgetCore) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbols := GetArg(optionalArgs, 0, nil)
	_ = symbols
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes912812 := (<-this.LoadMarkets())
		PanicOnError(retRes912812)
	}
	params = this.Extend(map[string]any{
		"method": "publicMixGetV2MixMarketCurrentFundRate",
	}, params)

	retRes913115 := (<-this.FetchFundingRates(symbols, params))
	PanicOnError(retRes913115)
	ch <- retRes913115
	return nil
}
...
func (this *BitgetCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes923912 := (<-this.LoadMarkets())
		PanicOnError(retRes923912)
	}
	if IsTrue(IsEqual(symbol, nil)) {
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes925023 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes925023)
			ch <- retRes925023
			return nil
		}

		retRes925219 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func (this *BitgetCore) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes939312 := (<-this.LoadMarkets())
		PanicOnError(retRes939312)
	}
...
func (this *BitgetCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	...
	retRes946715 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
	PanicOnError(retRes946715)
	ch <- retRes946715
	return nil
}
...
func (this *BitgetCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	...
	retRes948515 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *BitgetCore) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes949912 := (<-this.LoadMarkets())
		PanicOnError(retRes949912)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes957412 := (<-this.LoadMarkets())
		PanicOnError(retRes957412)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
...
func (this *BitgetCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes969412 := (<-this.LoadMarkets())
		PanicOnError(retRes969412)
	}
...
func (this *BitgetCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes974912 := (<-this.LoadMarkets())
		PanicOnError(retRes974912)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	code := GetArg(optionalArgs, 0, nil)
	_ = code
...
func (this *BitgetCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *BitgetCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1008912 := (<-this.LoadMarkets())
		PanicOnError(retRes1008912)
	}
...
func (this *BitgetCore) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1013712 := (<-this.LoadMarkets())
		PanicOnError(retRes1013712)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1017412 := (<-this.LoadMarkets())
		PanicOnError(retRes1017412)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1021412 := (<-this.LoadMarkets())
...
func (this *BitgetCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1025412 := (<-this.LoadMarkets())
		PanicOnError(retRes1025412)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":        GetValue(currency, "id"),
...
func (this *BitgetCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1035112 := (<-this.LoadMarkets())
		PanicOnError(retRes1035112)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1035619 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1035619)
		ch <- retRes1035619
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1050612 := (<-this.LoadMarkets())
		PanicOnError(retRes1050612)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1062712 := (<-this.LoadMarkets())
		PanicOnError(retRes1062712)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin": GetValue(currency, "id"),
...
func (this *BitgetCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	code := GetArg(optionalArgs, 0, nil)
	_ = code
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1074612 := (<-this.LoadMarkets())
		PanicOnError(retRes1074612)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1075119 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1075119)
		ch <- retRes1075119
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1089912 := (<-this.LoadMarkets())
		PanicOnError(retRes1089912)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1097312 := (<-this.LoadMarkets())
		PanicOnError(retRes1097312)
	}
	var request map[string]any = map[string]any{}
	var productType any = nil
	var uta any = nil
...
func (this *BitgetCore) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1103612 := (<-this.LoadMarkets())
		PanicOnError(retRes1103612)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbols := GetArg(optionalArgs, 0, nil)
	_ = symbols
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1110612 := (<-this.LoadMarkets())
		PanicOnError(retRes1110612)
	}
	var request any = map[string]any{}
	var market any = nil
	var productType any = nil
...
func (this *BitgetCore) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	amount := GetArg(optionalArgs, 0, nil)
	_ = amount
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1121512 := (<-this.LoadMarkets())
...
func (this *BitgetCore) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	amount := GetArg(optionalArgs, 0, nil)
	_ = amount
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1126312 := (<-this.LoadMarkets())
		PanicOnError(retRes1126312)
	}
...
func (this *BitgetCore) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	code := GetArg(optionalArgs, 0, nil)
	_ = code
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1131512 := (<-this.LoadMarkets())
		PanicOnError(retRes1131512)
	}
	var request map[string]any = map[string]any{}
	var msInDay int = 86400000
	var now int64 = this.Milliseconds()
...
func (this *BitgetCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1142812 := (<-this.LoadMarkets())
		PanicOnError(retRes1142812)
	}
...
func (this *BitgetCore) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1149912 := (<-this.LoadMarkets())
		PanicOnError(retRes1149912)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	symbol := GetArg(optionalArgs, 0, nil)
	_ = symbol
...
func (this *BitgetCore) HandleErrors(code any, reason any, url any, method any, headers any, body any, response any, requestHeaders any, requestBody any) any {
	...
	var nonEmptyMessage bool = (IsTrue(IsTrue((!IsEqual(message, nil))) && IsTrue((!IsEqual(message, "")))) && IsTrue((!IsEqual(message, "success"))))
