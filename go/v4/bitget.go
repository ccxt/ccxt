...
func (this *BitgetCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes264112 := (<-this.LoadMarkets())
			PanicOnError(retRes264112)
		}
...
func (this *BitgetCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes285319 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
			PanicOnError(retRes285319)
			ch <- retRes285319
			return nil
		}
...
func (this *BitgetCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes298319 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
...
func (this *BitgetCore) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes342212 := (<-this.LoadMarkets())
			PanicOnError(retRes342212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes394919 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
			PanicOnError(retRes394919)
			ch <- retRes394919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchTradingFee(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes408012 := (<-this.LoadMarkets())
			PanicOnError(retRes408012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes429612 := (<-this.LoadMarkets())
			PanicOnError(retRes429612)
		}
		...
		if IsTrue(paginate) {
			...
			retRes430719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
			PanicOnError(retRes430719)
			ch <- retRes430719
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes447812 := (<-this.LoadMarkets())
			PanicOnError(retRes447812)
		}
		var request any = map[string]any{}
		var marketType any = nil
		var marginMode any = nil
...
func (this *BitgetCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes512012 := (<-this.LoadMarkets())
			PanicOnError(retRes512012)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "spot")) {
		...
		retRes512915 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
		PanicOnError(retRes512915)
		ch <- retRes512915
		return nil
...
func (this *BitgetCore) CreateUtaOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes561312 := (<-this.LoadMarkets())
			PanicOnError(retRes561312)
		}
...
func (this *BitgetCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(uta) {
			...
			retRes568719 := (<-this.CreateUtaOrders(orders, params))
			PanicOnError(retRes568719)
			ch <- retRes568719
			return nil
		}
		var ordersRequests any = []any{}
...
func (this *BitgetCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes581212 := (<-this.LoadMarkets())
			PanicOnError(retRes581212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
...
func (this *BitgetCore) CancelUtaOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes617812 := (<-this.LoadMarkets())
			PanicOnError(retRes617812)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes623412 := (<-this.LoadMarkets())
			PanicOnError(retRes623412)
		}
		var market any = this.Market(symbol)
		var uta any = nil
		...
		if IsTrue(uta) {
			...
			retRes624019 := (<-this.CancelUtaOrders(ids, symbol, params))
			PanicOnError(retRes624019)
			ch <- retRes624019
			return nil
		}
		var marginMode any = nil
...
func (this *BitgetCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes632512 := (<-this.LoadMarkets())
			PanicOnError(retRes632512)
		}
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *BitgetCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes667219 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes667219)
			ch <- retRes667219
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes706912 := (<-this.LoadMarkets())
			PanicOnError(retRes706912)
		}
...
func (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(uta) {
			...
			retRes710419 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
			PanicOnError(retRes710419)
			ch <- retRes710419
			return nil
		}
		if IsTrue(IsEqual(this.Markets, nil)) {

			retRes710712 := (<-this.LoadMarkets())
		...
		if IsTrue(paginate) {
			...
			retRes713019 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes713019)
			ch <- retRes713019
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes739112 := (<-this.LoadMarkets())
			PanicOnError(retRes739112)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes741219 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes741219)
			ch <- retRes741219
			return nil
		}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes753512 := (<-this.LoadMarkets())
			PanicOnError(retRes753512)
		}
		...
		if IsTrue(paginate) {
			...
			retRes755219 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes755219)
			ch <- retRes755219
			return nil
		}
		var currency any = nil
...
func (this *BitgetCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes779419 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes779419)
			ch <- retRes779419
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes809312 := (<-this.LoadMarkets())
			PanicOnError(retRes809312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes809819 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
			PanicOnError(retRes809819)
			ch <- retRes809819
			return nil
		}
		var method any = nil
...
func (this *BitgetCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes851212 := (<-this.LoadMarkets())
			PanicOnError(retRes851212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		...
		if IsTrue(uta) {
			...
			if IsTrue(paginate) {
				...
				retRes855223 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
				PanicOnError(retRes855223)
				ch <- retRes855223
				return nil
			}
			if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes870012 := (<-this.LoadMarkets())
			PanicOnError(retRes870012)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbol any = this.SafeValue(symbols, 0)
...
func (this *BitgetCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes878512 := (<-this.LoadMarkets())
			PanicOnError(retRes878512)
		}
		params = this.Extend(map[string]any{
			"method": "publicMixGetV2MixMarketCurrentFundRate",
		}, params)

		retRes878815 := (<-this.FetchFundingRates(symbols, params))
		PanicOnError(retRes878815)
		ch <- retRes878815
		return nil
...
func (this *BitgetCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes889612 := (<-this.LoadMarkets())
			PanicOnError(retRes889612)
		}
		if IsTrue(IsEqual(symbol, nil)) {
		...
		if IsTrue(paginate) {
			if IsTrue(uta) {
				...
				retRes890723 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
				PanicOnError(retRes890723)
				ch <- retRes890723
				return nil
			}

			retRes890919 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func (this *BitgetCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes905012 := (<-this.LoadMarkets())
			PanicOnError(retRes905012)
		}
...
func (this *BitgetCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes912415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes912415)
		ch <- retRes912415
		return nil
...
func (this *BitgetCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes914215 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes914215)
		ch <- retRes914215
		return nil
...
func (this *BitgetCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes923112 := (<-this.LoadMarkets())
			PanicOnError(retRes923112)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes930712 := (<-this.LoadMarkets())
			PanicOnError(retRes930712)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes940612 := (<-this.LoadMarkets())
			PanicOnError(retRes940612)
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes951912 := (<-this.LoadMarkets())
			PanicOnError(retRes951912)
		}
		var typeVar any = nil
...
func (this *BitgetCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes990212 := (<-this.LoadMarkets())
			PanicOnError(retRes990212)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":        GetValue(currency, "id"),
...
func (this *BitgetCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes1000419 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1000419)
			ch <- retRes1000419
			return nil
		}
		var market any = nil
...
func (this *BitgetCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1015412 := (<-this.LoadMarkets())
			PanicOnError(retRes1015412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1027512 := (<-this.LoadMarkets())
			PanicOnError(retRes1027512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin": GetValue(currency, "id"),
...
func (this *BitgetCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1039412 := (<-this.LoadMarkets())
		...
		if IsTrue(paginate) {
			...
			retRes1039919 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1039919)
			ch <- retRes1039919
			return nil
		}
		var market any = nil
...
func (this *BitgetCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1054712 := (<-this.LoadMarkets())
			PanicOnError(retRes1054712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) CloseAllPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1062112 := (<-this.LoadMarkets())
			PanicOnError(retRes1062112)
		}
		var request any = map[string]any{}
		var productType any = nil
		var uta any = nil
...
func (this *BitgetCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1068412 := (<-this.LoadMarkets())
			PanicOnError(retRes1068412)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1075412 := (<-this.LoadMarkets())
			PanicOnError(retRes1075412)
		}
		var request any = map[string]any{}
		var market any = nil
		var productType any = nil
...
func (this *BitgetCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1086312 := (<-this.LoadMarkets())
			PanicOnError(retRes1086312)
		}
		var request any = map[string]any{
			"fromCoin":     fromCode,
			"toCoin":       toCode,
...
func (this *BitgetCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1107612 := (<-this.LoadMarkets())
			PanicOnError(retRes1107612)
		}
