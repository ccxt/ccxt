...
func  (this *BitgetCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes188912 := (<-this.LoadTimeDifference())
            ...
            if IsTrue(uta) {
                    ...
                    retRes189419 :=  (<-this.FetchUtaMarkets(params))
                    PanicOnError(retRes189419)
                    ch <- retRes189419
                    return nil
            } else {
        
                    retRes189619 :=  (<-this.FetchDefaultMarkets(params))
                    PanicOnError(retRes189619)
                    ch <- retRes189619
                    return nil
            }
...
func  (this *BitgetCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes275219 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
                    PanicOnError(retRes275219)
                    ch <- retRes275219
                    return nil
            }
...
func  (this *BitgetCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes287819 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
...
func  (this *BitgetCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38268 := (<-this.LoadMarkets())
            PanicOnError(retRes38268)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes383019 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
                    PanicOnError(retRes383019)
                    ch <- retRes383019
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40058 := (<-this.LoadMarkets())
            PanicOnError(retRes40058)
            var response interface{} = nil
            var marginMode interface{} = nil
            var marketType interface{} = nil
...
func  (this *BitgetCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes41728 := (<-this.LoadMarkets())
            PanicOnError(retRes41728)
            ...
            if IsTrue(paginate) {
                var limitForPagination interface{} = Ternary(IsTrue(useHistoryEndpointForPagination), maxLimitForHistoryEndpoint, maxLimitForRecentEndpoint)
                    ...
                    retRes418219 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
                    PanicOnError(retRes418219)
                    ch <- retRes418219
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes499515 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
                PanicOnError(retRes499515)
                ch <- retRes499515
                return nil
...
func  (this *BitgetCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50448 := (<-this.LoadMarkets())
            PanicOnError(retRes50448)
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) CreateUtaOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes54328 := (<-this.LoadMarkets())
            PanicOnError(retRes54328)
...
func  (this *BitgetCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes550319 :=  (<-this.CreateUtaOrders(orders, params))
...
func  (this *BitgetCore) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes56278 := (<-this.LoadMarkets())
            PanicOnError(retRes56278)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
...
func  (this *BitgetCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes58358 := (<-this.LoadMarkets())
            PanicOnError(retRes58358)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
            var response interface{} = nil
...
func  (this *BitgetCore) CancelUtaOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes59778 := (<-this.LoadMarkets())
            PanicOnError(retRes59778)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes603619 :=  (<-this.CancelUtaOrders(ids, symbol, params))
                    PanicOnError(retRes603619)
                    ch <- retRes603619
                    return nil
            }
            var marginMode interface{} = nil
...
func  (this *BitgetCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62438 := (<-this.LoadMarkets())
            PanicOnError(retRes62438)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "clientOid")
            if IsTrue(!IsEqual(clientOrderId, nil)) {
...
func  (this *BitgetCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes64278 := (<-this.LoadMarkets())
            PanicOnError(retRes64278)
            var market interface{} = nil
            var typeVar interface{} = nil
            var request interface{} = map[string]interface{} {}
            var marginMode interface{} = nil
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(uta) {
                    ...
                    retRes646219 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
                    PanicOnError(retRes646219)
                    ch <- retRes646219
                    return nil
            }
            var response interface{} = nil
...
func  (this *BitgetCore) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes68568 := (<-this.LoadMarkets())
            PanicOnError(retRes68568)
...
func  (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes689019 :=  (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
                    PanicOnError(retRes689019)
                    ch <- retRes689019
                    return nil
            }
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes691419 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes691419)
                    ch <- retRes691419
                    return nil
            }
            var response interface{} = nil
...
func  (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes719419 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
                    PanicOnError(retRes719419)
                    ch <- retRes719419
                    return nil
            }
            requestparamsVariable := this.HandleUntilOption("endTime", request, params);
...
func  (this *BitgetCore) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73168 := (<-this.LoadMarkets())
            PanicOnError(retRes73168)
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(!IsEqual(marketType, "spot")) {
                    ...
                    retRes733219 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes733219)
                    ch <- retRes733219
                    return nil
            }
            var currency interface{} = nil
...
func  (this *BitgetCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes75438 := (<-this.LoadMarkets())
            PanicOnError(retRes75438)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            requestparamsVariable := this.HandleUntilOption("endTime", request, params);
            request = GetValue(requestparamsVariable,0);
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(uta) {
                    ...
                    retRes757219 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
                    PanicOnError(retRes757219)
                    ch <- retRes757219
                    return nil
            }
            var response interface{} = nil
...
func  (this *BitgetCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77568 := (<-this.LoadMarkets())
            PanicOnError(retRes77568)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78688 := (<-this.LoadMarkets())
            PanicOnError(retRes78688)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes787219 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
                    PanicOnError(retRes787219)
                    ch <- retRes787219
                    return nil
            }
...
func  (this *BitgetCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes82858 := (<-this.LoadMarkets())
            PanicOnError(retRes82858)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
            ...
            response = (<-this.PublicUtaGetV3MarketHistoryFundRate(this.Extend(request, params)))
                ...
                if IsTrue(paginate) {
                        ...
                        retRes832423 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
                        PanicOnError(retRes832423)
                        ch <- retRes832423
                        return nil
                }
                if IsTrue(!IsEqual(limit, nil)) {
...
func  (this *BitgetCore) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83798 := (<-this.LoadMarkets())
            PanicOnError(retRes83798)
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes84698 := (<-this.LoadMarkets())
            PanicOnError(retRes84698)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                var symbol interface{} = this.SafeValue(symbols, 0)
                market = this.Market(symbol)
...
func  (this *BitgetCore) FetchFundingIntervals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes85528 := (<-this.LoadMarkets())
            PanicOnError(retRes85528)
            params = this.Extend(map[string]interface{} {
                "method": "publicMixGetV2MixMarketCurrentFundRate",
            }, params)
        
                retRes855415 :=  (<-this.FetchFundingRates(symbols, params))
                PanicOnError(retRes855415)
                ch <- retRes855415
                return nil
...
func  (this *BitgetCore) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes86618 := (<-this.LoadMarkets())
            PanicOnError(retRes86618)
            if IsTrue(IsEqual(symbol, nil)) {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes866819 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
                    PanicOnError(retRes866819)
                    ch <- retRes866819
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87638 := (<-this.LoadMarkets())
            PanicOnError(retRes87638)
...
func  (this *BitgetCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes883615 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes883615)
                ch <- retRes883615
                return nil
...
func  (this *BitgetCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes885415 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes885415)
                ch <- retRes885415
                return nil
...
func  (this *BitgetCore) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes88678 := (<-this.LoadMarkets())
            PanicOnError(retRes88678)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89408 := (<-this.LoadMarkets())
            PanicOnError(retRes89408)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90148 := (<-this.LoadMarkets())
            PanicOnError(retRes90148)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90568 := (<-this.LoadMarkets())
            PanicOnError(retRes90568)
...
func  (this *BitgetCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91098 := (<-this.LoadMarkets())
            PanicOnError(retRes91098)
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92808 := (<-this.LoadMarkets())
            PanicOnError(retRes92808)
            var currency interface{} = this.Currency(code)
            var accountsByType interface{} = this.SafeValue(this.Options, "accountsByType", map[string]interface{} {})
...
func  (this *BitgetCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94788 := (<-this.LoadMarkets())
            PanicOnError(retRes94788)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *BitgetCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95138 := (<-this.LoadMarkets())
            PanicOnError(retRes95138)
            var currency interface{} = this.Currency(code)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *BitgetCore) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95898 := (<-this.LoadMarkets())
            PanicOnError(retRes95898)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
                "repayAmount": this.CurrencyToPrecision(code, amount),
...
func  (this *BitgetCore) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96848 := (<-this.LoadMarkets())
            PanicOnError(retRes96848)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes968819 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes968819)
                    ch <- retRes968819
                    return nil
            }
            var market interface{} = nil
...
func  (this *BitgetCore) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100738 := (<-this.LoadMarkets())
            PanicOnError(retRes100738)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1007719 :=  (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes1007719)
                    ch <- retRes1007719
                    return nil
            }
            var market interface{} = nil
...
func  (this *BitgetCore) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102248 := (<-this.LoadMarkets())
            PanicOnError(retRes102248)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *BitgetCore) CloseAllPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102968 := (<-this.LoadMarkets())
            PanicOnError(retRes102968)
            var request interface{} = map[string]interface{} {}
            var productType interface{} = nil
            var uta interface{} = nil
            var response interface{} = nil
...
func  (this *BitgetCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes103578 := (<-this.LoadMarkets())
            PanicOnError(retRes103578)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes104258 := (<-this.LoadMarkets())
            PanicOnError(retRes104258)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            var productType interface{} = nil
            var uta interface{} = nil
...
func  (this *BitgetCore) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes105328 := (<-this.LoadMarkets())
            PanicOnError(retRes105328)
            var request interface{} = map[string]interface{} {
                "fromCoin": fromCode,
                "toCoin": toCode,
...
func  (this *BitgetCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes105788 := (<-this.LoadMarkets())
            PanicOnError(retRes105788)
...
func  (this *BitgetCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes106288 := (<-this.LoadMarkets())
            PanicOnError(retRes106288)
            var request interface{} = map[string]interface{} {}
            var msInDay interface{} = 86400000
            var now interface{} = this.Milliseconds()
            if IsTrue(!IsEqual(since, nil)) {
...
func  (this *BitgetCore) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes107398 := (<-this.LoadMarkets())
            PanicOnError(retRes107398)
...
func  (this *BitgetCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes108068 := (<-this.LoadMarkets())
            PanicOnError(retRes108068)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes108728 := (<-this.LoadMarkets())
            PanicOnError(retRes108728)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
