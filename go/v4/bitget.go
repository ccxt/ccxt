...
func (this *BitgetCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes518815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
	PanicOnError(retRes518815)
	ch <- retRes518815
	return nil
}
...
func (this *BitgetCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes574619 := (<-this.CreateUtaOrders(orders, params))
...
func (this *BitgetCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes587112 := (<-this.LoadMarkets())
		PanicOnError(retRes587112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{}
...
func (this *BitgetCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes609312 := (<-this.LoadMarkets())
		PanicOnError(retRes609312)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *BitgetCore) cancelUtaOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes623712 := (<-this.LoadMarkets())
		PanicOnError(retRes623712)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes629312 := (<-this.LoadMarkets())
		PanicOnError(retRes629312)
	}
	var market any = this.Market(symbol)
	var uta any = nil
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes629919 := (<-this.CancelUtaOrders(ids, symbol, params))
		PanicOnError(retRes629919)
		ch <- retRes629919
		return nil
	}
	var marginMode any = nil
...
func (this *BitgetCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes638412 := (<-this.LoadMarkets())
		PanicOnError(retRes638412)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *BitgetCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes669512 := (<-this.LoadMarkets())
		PanicOnError(retRes669512)
	}
	var market any = nil
	var typeVar any = nil
	var request any = map[string]any{}
	...
	if IsTrue(paginate) {
		...
		retRes673119 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes673119)
		ch <- retRes673119
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes709712 := (<-this.LoadMarkets())
		PanicOnError(retRes709712)
	}
...
func (this *BitgetCore) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes716319 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
		PanicOnError(retRes716319)
		ch <- retRes716319
		return nil
	}
	if IsTrue(IsEqual(this.Markets, nil)) {

		retRes716612 := (<-this.LoadMarkets())
		PanicOnError(retRes716612)
	}
	var market any = nil
	var request any = map[string]any{}
	if IsTrue(!IsEqual(symbol, nil)) {
	...
	if IsTrue(paginate) {
		...
		retRes718919 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes718919)
		ch <- retRes718919
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchUtaCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes747119 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
		PanicOnError(retRes747119)
		ch <- retRes747119
		return nil
	}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes761119 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes761119)
		ch <- retRes761119
		return nil
	}
	var currency any = nil
...
func (this *BitgetCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes782312 := (<-this.LoadMarkets())
		PanicOnError(retRes782312)
	}
	var market any = this.Market(symbol)
	var request any = map[string]any{}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
	...
	if IsTrue(paginate) {
		...
		retRes785319 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
...
func (this *BitgetCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes803812 := (<-this.LoadMarkets())
		PanicOnError(retRes803812)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes815212 := (<-this.LoadMarkets())
		PanicOnError(retRes815212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes815719 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
		PanicOnError(retRes815719)
		ch <- retRes815719
		return nil
	}
	var method any = nil
...
func (this *BitgetCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes857112 := (<-this.LoadMarkets())
		PanicOnError(retRes857112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(paginate) {
			...
			retRes861123 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
			PanicOnError(retRes861123)
			ch <- retRes861123
			return nil
		}
		if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes866712 := (<-this.LoadMarkets())
		PanicOnError(retRes866712)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes875912 := (<-this.LoadMarkets())
		PanicOnError(retRes875912)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
		var symbol any = this.SafeValue(symbols, 0)
...
func (this *BitgetCore) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes884715 := (<-this.FetchFundingRates(symbols, params))
	PanicOnError(retRes884715)
	ch <- retRes884715
	return nil
}
...
func (this *BitgetCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes895512 := (<-this.LoadMarkets())
		PanicOnError(retRes895512)
	}
	if IsTrue(IsEqual(symbol, nil)) {
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes896623 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes896623)
			ch <- retRes896623
			return nil
		}

		retRes896819 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
		PanicOnError(retRes896819)
		ch <- retRes896819
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes918315 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
	PanicOnError(retRes918315)
	ch <- retRes918315
	return nil
}
...
func (this *BitgetCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes920115 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
	PanicOnError(retRes920115)
	ch <- retRes920115
	return nil
}
...
func (this *BitgetCore) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes921512 := (<-this.LoadMarkets())
		PanicOnError(retRes921512)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes936612 := (<-this.LoadMarkets())
		PanicOnError(retRes936612)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes946512 := (<-this.LoadMarkets())
		PanicOnError(retRes946512)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes957812 := (<-this.LoadMarkets())
		PanicOnError(retRes957812)
	}
	var typeVar any = nil
...
func (this *BitgetCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes964212 := (<-this.LoadMarkets())
		PanicOnError(retRes964212)
	}
	var uta any = nil
...
func (this *BitgetCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes980512 := (<-this.LoadMarkets())
		PanicOnError(retRes980512)
	}
...
func (this *BitgetCore) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes985312 := (<-this.LoadMarkets())
		PanicOnError(retRes985312)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes989012 := (<-this.LoadMarkets())
		PanicOnError(retRes989012)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes997012 := (<-this.LoadMarkets())
		PanicOnError(retRes997012)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":        GetValue(currency, "id"),
...
func (this *BitgetCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1006712 := (<-this.LoadMarkets())
		PanicOnError(retRes1006712)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1007219 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1007219)
		ch <- retRes1007219
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1022212 := (<-this.LoadMarkets())
		PanicOnError(retRes1022212)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1034312 := (<-this.LoadMarkets())
		PanicOnError(retRes1034312)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin": GetValue(currency, "id"),
...
func (this *BitgetCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1046212 := (<-this.LoadMarkets())
		PanicOnError(retRes1046212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1046719 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1046719)
		ch <- retRes1046719
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1061512 := (<-this.LoadMarkets())
		PanicOnError(retRes1061512)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1068912 := (<-this.LoadMarkets())
		PanicOnError(retRes1068912)
	}
	var request map[string]any = map[string]any{}
	var productType any = nil
	var uta any = nil
...
func (this *BitgetCore) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1075212 := (<-this.LoadMarkets())
		PanicOnError(retRes1075212)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1093112 := (<-this.LoadMarkets())
		PanicOnError(retRes1093112)
	}
	var request map[string]any = map[string]any{
		"fromCoin":     fromCode,
		"toCoin":       toCode,
...
func (this *BitgetCore) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1097912 := (<-this.LoadMarkets())
		PanicOnError(retRes1097912)
	}
...
func (this *BitgetCore) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1103112 := (<-this.LoadMarkets())
		PanicOnError(retRes1103112)
	}
	var request map[string]any = map[string]any{}
	var msInDay any = 86400000
	var now int64 = this.Milliseconds()
...
func (this *BitgetCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1114412 := (<-this.LoadMarkets())
		PanicOnError(retRes1114412)
	}
...
func (this *BitgetCore) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1128312 := (<-this.LoadMarkets())
		PanicOnError(retRes1128312)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
