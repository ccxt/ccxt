...
func (this *BitgetCore) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes334812 := (<-this.LoadMarkets())
		PanicOnError(retRes334812)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes356012 := (<-this.LoadMarkets())
		PanicOnError(retRes356012)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes408719 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
		PanicOnError(retRes408719)
		ch <- retRes408719
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes421812 := (<-this.LoadMarkets())
		PanicOnError(retRes421812)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes426512 := (<-this.LoadMarkets())
		PanicOnError(retRes426512)
	}
	var response any = nil
	var marginMode any = nil
	var marketType any = nil
...
func (this *BitgetCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes444519 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
		PanicOnError(retRes444519)
		ch <- retRes444519
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes530815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *BitgetCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes535812 := (<-this.LoadMarkets())
		PanicOnError(retRes535812)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) createUtaOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes579212 := (<-this.LoadMarkets())
		PanicOnError(retRes579212)
	}
...
func (this *BitgetCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes586112 := (<-this.LoadMarkets())
		PanicOnError(retRes586112)
	}
	var uta any = nil
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes586619 := (<-this.CreateUtaOrders(orders, params))
		PanicOnError(retRes586619)
		ch <- retRes586619
		return nil
	}
	var ordersRequests any = []any{}
...
func (this *BitgetCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes621312 := (<-this.LoadMarkets())
		PanicOnError(retRes621312)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *BitgetCore) cancelUtaOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes635712 := (<-this.LoadMarkets())
		PanicOnError(retRes635712)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes641312 := (<-this.LoadMarkets())
		PanicOnError(retRes641312)
	}
	var market any = this.Market(symbol)
	var uta any = nil
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes641919 := (<-this.CancelUtaOrders(ids, symbol, params))
		PanicOnError(retRes641919)
		ch <- retRes641919
		return nil
	}
	var marginMode any = nil
...
func (this *BitgetCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes650412 := (<-this.LoadMarkets())
		PanicOnError(retRes650412)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *BitgetCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes662912 := (<-this.LoadMarkets())
		PanicOnError(retRes662912)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{}
	var clientOrderId any = this.SafeString2(params, "clientOrderId", "clientOid")
...
func (this *BitgetCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes681512 := (<-this.LoadMarkets())
		PanicOnError(retRes681512)
	}
	var market any = nil
	var typeVar any = nil
	var request any = map[string]any{}
	...
	if IsTrue(paginate) {
		...
		retRes685119 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
...
func (this *BitgetCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes721712 := (<-this.LoadMarkets())
		PanicOnError(retRes721712)
	}
...
func (this *BitgetCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes724812 := (<-this.LoadMarkets())
		PanicOnError(retRes724812)
	}
...
func (this *BitgetCore) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes728319 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
	...
	if IsTrue(paginate) {
		...
		retRes730919 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes730919)
		ch <- retRes730919
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchUtaCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes759119 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
		PanicOnError(retRes759119)
		ch <- retRes759119
		return nil
	}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes773119 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes773119)
		ch <- retRes773119
		return nil
	}
	var currency any = nil
...
func (this *BitgetCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes794312 := (<-this.LoadMarkets())
		PanicOnError(retRes794312)
	}
	var market any = this.Market(symbol)
	var request any = map[string]any{}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
	...
	if IsTrue(paginate) {
		...
		retRes797319 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes797319)
		ch <- retRes797319
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes815812 := (<-this.LoadMarkets())
		PanicOnError(retRes815812)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes827212 := (<-this.LoadMarkets())
		PanicOnError(retRes827212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes827719 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
...
func (this *BitgetCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes869112 := (<-this.LoadMarkets())
		PanicOnError(retRes869112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(paginate) {
			...
			retRes873123 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
			PanicOnError(retRes873123)
			ch <- retRes873123
			return nil
		}
		if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes887912 := (<-this.LoadMarkets())
		PanicOnError(retRes887912)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
		var symbol any = this.SafeValue(symbols, 0)
...
func (this *BitgetCore) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes896412 := (<-this.LoadMarkets())
		PanicOnError(retRes896412)
	}
	params = this.Extend(map[string]any{
		"method": "publicMixGetV2MixMarketCurrentFundRate",
	}, params)

	retRes896715 := (<-this.FetchFundingRates(symbols, params))
	PanicOnError(retRes896715)
	ch <- retRes896715
	return nil
}
...
func (this *BitgetCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes908623 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes908623)
			ch <- retRes908623
			return nil
		}

		retRes908819 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
		PanicOnError(retRes908819)
		ch <- retRes908819
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes922912 := (<-this.LoadMarkets())
		PanicOnError(retRes922912)
	}
...
func (this *BitgetCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes930315 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
	PanicOnError(retRes930315)
	ch <- retRes930315
	return nil
}
...
func (this *BitgetCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes932115 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
	PanicOnError(retRes932115)
	ch <- retRes932115
	return nil
}
...
func (this *BitgetCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes941012 := (<-this.LoadMarkets())
		PanicOnError(retRes941012)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes953012 := (<-this.LoadMarkets())
		PanicOnError(retRes953012)
	}
...
func (this *BitgetCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes958512 := (<-this.LoadMarkets())
		PanicOnError(retRes958512)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes969812 := (<-this.LoadMarkets())
		PanicOnError(retRes969812)
	}
	var typeVar any = nil
...
func (this *BitgetCore) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1001012 := (<-this.LoadMarkets())
		PanicOnError(retRes1001012)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1005012 := (<-this.LoadMarkets())
		PanicOnError(retRes1005012)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1009012 := (<-this.LoadMarkets())
		PanicOnError(retRes1009012)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin":        GetValue(currency, "id"),
...
func (this *BitgetCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1018712 := (<-this.LoadMarkets())
		PanicOnError(retRes1018712)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1019219 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1019219)
		ch <- retRes1019219
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1046312 := (<-this.LoadMarkets())
		PanicOnError(retRes1046312)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin": GetValue(currency, "id"),
...
func (this *BitgetCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1058212 := (<-this.LoadMarkets())
		PanicOnError(retRes1058212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1058719 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1058719)
		ch <- retRes1058719
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1073512 := (<-this.LoadMarkets())
		PanicOnError(retRes1073512)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1080912 := (<-this.LoadMarkets())
		PanicOnError(retRes1080912)
	}
	var request map[string]any = map[string]any{}
	var productType any = nil
	var uta any = nil
...
func (this *BitgetCore) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1087212 := (<-this.LoadMarkets())
		PanicOnError(retRes1087212)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1094212 := (<-this.LoadMarkets())
		PanicOnError(retRes1094212)
	}
	var request any = map[string]any{}
	var market any = nil
	var productType any = nil
...
func (this *BitgetCore) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1105112 := (<-this.LoadMarkets())
		PanicOnError(retRes1105112)
	}
	var request map[string]any = map[string]any{
		"fromCoin":     fromCode,
		"toCoin":       toCode,
...
func (this *BitgetCore) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1109912 := (<-this.LoadMarkets())
		PanicOnError(retRes1109912)
	}
...
func (this *BitgetCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1126412 := (<-this.LoadMarkets())
		PanicOnError(retRes1126412)
	}
...
func (this *BitgetCore) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1133512 := (<-this.LoadMarkets())
		PanicOnError(retRes1133512)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1140312 := (<-this.LoadMarkets())
		PanicOnError(retRes1140312)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
