...
func  (this *bitget) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                var limitForPagination interface{} = Ternary(IsTrue(useHistoryEndpointForPagination), maxLimitForHistoryEndpoint, maxLimitForRecentEndpoint)
                    ...
                    retRes349119 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
...
func  (this *bitget) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes425115 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *bitget) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50488 := (<-this.LoadMarkets())
            PanicOnError(retRes50488)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *bitget) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes52818 := (<-this.LoadMarkets())
            PanicOnError(retRes52818)
            var market interface{} = nil
            var typeVar interface{} = nil
            var request interface{} = map[string]interface{} {}
            var marginMode interface{} = nil
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(IsEqual(typeVar, "spot")) {
                    ...
                    retRes530819 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes530819)
                    ch <- retRes530819
                    return nil
            }
            var response interface{} = nil
...
func  (this *bitget) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes55778 := (<-this.LoadMarkets())
            PanicOnError(retRes55778)
...
func  (this *bitget) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes56058 := (<-this.LoadMarkets())
            PanicOnError(retRes56058)
...
func  (this *bitget) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes56338 := (<-this.LoadMarkets())
            PanicOnError(retRes56338)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes565519 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes565519)
                    ch <- retRes565519
                    return nil
            }
            var response interface{} = nil
...
func  (this *bitget) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(!IsEqual(marketType, "spot")) {
                    ...
                    retRes594719 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes594719)
                    ch <- retRes594719
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitget) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes61548 := (<-this.LoadMarkets())
            PanicOnError(retRes61548)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes616919 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes616919)
                    ch <- retRes616919
                    return nil
            }
            var response interface{} = nil
...
func  (this *bitget) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes638619 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
                    PanicOnError(retRes638619)
                    ch <- retRes638619
                    return nil
            }
...
func  (this *bitget) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes670119 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
                    PanicOnError(retRes670119)
                    ch <- retRes670119
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitget) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes67618 := (<-this.LoadMarkets())
            PanicOnError(retRes67618)
            var market interface{} = this.Market(symbol)
...
func  (this *bitget) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes69798 := (<-this.LoadMarkets())
            PanicOnError(retRes69798)
            if IsTrue(IsEqual(symbol, nil)) {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes698619 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func  (this *bitget) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70818 := (<-this.LoadMarkets())
            PanicOnError(retRes70818)
...
func  (this *bitget) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes715415 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes715415)
                ch <- retRes715415
                return nil
...
func  (this *bitget) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes717215 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes717215)
                ch <- retRes717215
                return nil
...
func  (this *bitget) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71858 := (<-this.LoadMarkets())
            PanicOnError(retRes71858)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72558 := (<-this.LoadMarkets())
            PanicOnError(retRes72558)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73068 := (<-this.LoadMarkets())
            PanicOnError(retRes73068)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73468 := (<-this.LoadMarkets())
            PanicOnError(retRes73468)
...
func  (this *bitget) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73828 := (<-this.LoadMarkets())
            PanicOnError(retRes73828)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "contract")) {
...
func  (this *bitget) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes75158 := (<-this.LoadMarkets())
            PanicOnError(retRes75158)
            var currency interface{} = this.Currency(code)
            var accountsByType interface{} = this.SafeValue(this.Options, "accountsByType", map[string]interface{} {})
...
func  (this *bitget) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77138 := (<-this.LoadMarkets())
            PanicOnError(retRes77138)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bitget) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes792319 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes792319)
                    ch <- retRes792319
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitget) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes80728 := (<-this.LoadMarkets())
            PanicOnError(retRes80728)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitget) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes82768 := (<-this.LoadMarkets())
            PanicOnError(retRes82768)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes828019 :=  (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes828019)
                    ch <- retRes828019
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitget) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes84258 := (<-this.LoadMarkets())
            PanicOnError(retRes84258)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *bitget) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes85768 := (<-this.LoadMarkets())
            PanicOnError(retRes85768)
            var until interface{} = this.SafeInteger(params, "until")
...
func  (this *bitget) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes86448 := (<-this.LoadMarkets())
            PanicOnError(retRes86448)
            var request interface{} = map[string]interface{} {
                "fromCoin": fromCode,
                "toCoin": toCode,
...
func  (this *bitget) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89588 := (<-this.LoadMarkets())
            PanicOnError(retRes89588)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
