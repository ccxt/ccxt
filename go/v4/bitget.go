...
func  (this *BitgetCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49498 := (<-this.LoadMarkets())
            PanicOnError(retRes49498)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes495715 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *BitgetCore) CreateUtaOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes53948 := (<-this.LoadMarkets())
            PanicOnError(retRes53948)
...
func  (this *BitgetCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes546519 :=  (<-this.CreateUtaOrders(orders, params))
                    PanicOnError(retRes546519)
                    ch <- retRes546519
                    return nil
            }
            var ordersRequests interface{} = []interface{}{}
...
func  (this *BitgetCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes57858 := (<-this.LoadMarkets())
            PanicOnError(retRes57858)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
            var response interface{} = nil
...
func  (this *BitgetCore) CancelUtaOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes59278 := (<-this.LoadMarkets())
            PanicOnError(retRes59278)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes598619 :=  (<-this.CancelUtaOrders(ids, symbol, params))
                    PanicOnError(retRes598619)
                    ch <- retRes598619
                    return nil
            }
            var marginMode interface{} = nil
...
func  (this *BitgetCore) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes60718 := (<-this.LoadMarkets())
            PanicOnError(retRes60718)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *BitgetCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(uta) {
                    ...
                    retRes643319 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
                    PanicOnError(retRes643319)
                    ch <- retRes643319
                    return nil
            }
            var response interface{} = nil
...
func  (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(uta) {
                    ...
                    retRes686119 :=  (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
                    PanicOnError(retRes686119)
                    ch <- retRes686119
                    return nil
            }
        
            retRes68638 := (<-this.LoadMarkets())
            PanicOnError(retRes68638)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes688519 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes688519)
                    ch <- retRes688519
                    return nil
            }
            var response interface{} = nil
...
func  (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes716519 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
                    PanicOnError(retRes716519)
                    ch <- retRes716519
                    return nil
            }
            requestparamsVariable := this.HandleUntilOption("endTime", request, params);
...
func  (this *BitgetCore) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(!IsEqual(marketType, "spot")) {
                    ...
                    retRes730319 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
                    PanicOnError(retRes730319)
                    ch <- retRes730319
                    return nil
            }
            var currency interface{} = nil
...
func  (this *BitgetCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes75148 := (<-this.LoadMarkets())
            PanicOnError(retRes75148)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            requestparamsVariable := this.HandleUntilOption("endTime", request, params);
            request = GetValue(requestparamsVariable,0);
            ...
            if IsTrue(paginate) {
                ...
                if IsTrue(uta) {
                    ...
                    retRes754319 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
                    PanicOnError(retRes754319)
                    ch <- retRes754319
                    return nil
            }
            var response interface{} = nil
...
func  (this *BitgetCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77278 := (<-this.LoadMarkets())
            PanicOnError(retRes77278)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78398 := (<-this.LoadMarkets())
            PanicOnError(retRes78398)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes784319 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
...
func  (this *BitgetCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            response = (<-this.PublicUtaGetV3MarketHistoryFundRate(this.Extend(request, params)))
                ...
                if IsTrue(paginate) {
                        ...
                        retRes829223 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
                        PanicOnError(retRes829223)
                        ch <- retRes829223
                        return nil
                }
                if IsTrue(!IsEqual(limit, nil)) {
...
func  (this *BitgetCore) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83478 := (<-this.LoadMarkets())
            PanicOnError(retRes83478)
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes84368 := (<-this.LoadMarkets())
            PanicOnError(retRes84368)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                var symbol interface{} = this.SafeValue(symbols, 0)
                market = this.Market(symbol)
...
func  (this *BitgetCore) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes859519 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
                    PanicOnError(retRes859519)
                    ch <- retRes859519
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes876315 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes876315)
                ch <- retRes876315
                return nil
...
func  (this *BitgetCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(holdSide, nil)) {
                ...
                retRes878115 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes878115)
                ch <- retRes878115
                return nil
...
func  (this *BitgetCore) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87948 := (<-this.LoadMarkets())
            PanicOnError(retRes87948)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89838 := (<-this.LoadMarkets())
            PanicOnError(retRes89838)
...
func  (this *BitgetCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90368 := (<-this.LoadMarkets())
            PanicOnError(retRes90368)
            var market interface{} = this.Market(symbol)
...
func  (this *BitgetCore) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91478 := (<-this.LoadMarkets())
            PanicOnError(retRes91478)
            var typeVar interface{} = nil
...
func  (this *BitgetCore) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95168 := (<-this.LoadMarkets())
            PanicOnError(retRes95168)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
                "repayAmount": this.CurrencyToPrecision(code, amount),
...
func  (this *BitgetCore) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96118 := (<-this.LoadMarkets())
            PanicOnError(retRes96118)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes961519 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
                    PanicOnError(retRes961519)
                    ch <- retRes961519
                    return nil
            }
            var market interface{} = nil
...
func  (this *BitgetCore) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97648 := (<-this.LoadMarkets())
            PanicOnError(retRes97648)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *BitgetCore) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98838 := (<-this.LoadMarkets())
            PanicOnError(retRes98838)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *BitgetCore) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100008 := (<-this.LoadMarkets())
            PanicOnError(retRes100008)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1000419 :=  (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
...
func  (this *BitgetCore) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes101518 := (<-this.LoadMarkets())
            PanicOnError(retRes101518)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *BitgetCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102848 := (<-this.LoadMarkets())
            PanicOnError(retRes102848)
            var market interface{} = this.Market(symbol)
            var productType interface{} = nil
            productTypeparamsVariable := this.HandleProductTypeAndParams(market, params);
            productType = GetValue(productTypeparamsVariable,0);
...
func  (this *BitgetCore) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes103528 := (<-this.LoadMarkets())
            PanicOnError(retRes103528)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            var productType interface{} = nil
            var uta interface{} = nil
...
func  (this *BitgetCore) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes104598 := (<-this.LoadMarkets())
            PanicOnError(retRes104598)
            var request interface{} = map[string]interface{} {
                "fromCoin": fromCode,
                "toCoin": toCode,
...
func  (this *BitgetCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes105058 := (<-this.LoadMarkets())
            PanicOnError(retRes105058)
