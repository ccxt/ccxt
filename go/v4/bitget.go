...
func (this *Bitget) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true)) {
		...
		retRes214212 := (<-this.LoadTimeDifferenceAsync())
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes214719 := (<-this.FetchUtaMarketsAsync(params))
		PanicOnError(retRes214719)
		ch <- retRes214719
		return nil
	}

	retRes214915 := (<-this.FetchDefaultMarketsAsync(params))
...
func (this *Bitget) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes302612 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes303423 := (<-this.FetchPaginatedCallCursorAsync("fetchDeposits", nil, since, limit, params, "orderId", "cursor", nil, 100))
			PanicOnError(retRes303423)
			ch <- retRes303423
			return nil
		}

		retRes303619 := (<-this.FetchPaginatedCallCursorAsync("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
...
func (this *Bitget) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes313912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes320612 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes321423 := (<-this.FetchPaginatedCallCursorAsync("fetchWithdrawals", nil, since, limit, params, "orderId", "cursor", nil, 100))
			PanicOnError(retRes321423)
			ch <- retRes321423
			return nil
		}

		retRes321619 := (<-this.FetchPaginatedCallCursorAsync("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
...
func (this *Bitget) ParseTransactionType(typeVar any) any {
...
func (this *Bitget) ParseTransactionStatus(status any) any {
...
func (this *Bitget) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes343212 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes351012 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes372212 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes388012 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes391512 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes424412 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes424919 := (<-this.FetchPaginatedCallCursorAsync("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
...
func (this *Bitget) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes438012 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes442712 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes459612 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes460719 := (<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
...
func (this *Bitget) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes478512 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) ParseOrderStatus(status any) any {
	var statuses map[string]any = map[string]any{
		"new":              "open",
		"init":             "open",
		"not_trigger":      "open",
...
func (this *Bitget) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes546112 := (<-this.LoadMarketsAsync())
	...
	retRes547015 := (<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *Bitget) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes552012 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) createUtaOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes595412 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes602312 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes602819 := (<-this.CreateUtaOrdersAsync(orders, params))
...
func (this *Bitget) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes637512 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) cancelUtaOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes651912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes657512 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes658119 := (<-this.CancelUtaOrdersAsync(ids, symbol, params))
...
func (this *Bitget) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes679112 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes697712 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes701319 := (<-this.FetchPaginatedCallCursorAsync("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
...
func (this *Bitget) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes741212 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes744719 := (<-this.FetchUtaCanceledAndClosedOrdersAsync(symbol, since, limit, params))
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes745012 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes747319 := (<-this.FetchPaginatedCallCursorAsync("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func (this *Bitget) fetchUtaCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes773412 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes775519 := (<-this.FetchPaginatedCallCursorAsync("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
...
func (this *Bitget) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes787812 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes789519 := (<-this.FetchPaginatedCallCursorAsync("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func (this *Bitget) ParseLedgerType(typeVar any) any {
	var types map[string]any = map[string]any{
...
func (this *Bitget) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes810712 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes813719 := (<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
...
func (this *Bitget) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes832212 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes843612 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes844119 := (<-this.FetchPaginatedCallCursorAsync("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
...
func (this *Bitget) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes885512 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(paginate) {
			...
			retRes889523 := (<-this.FetchPaginatedCallIncrementalAsync("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
...
func (this *Bitget) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes895112 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes912812 := (<-this.LoadMarketsAsync())
	...
	retRes913115 := (<-this.FetchFundingRatesAsync(symbols, params))
...
func (this *Bitget) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes923912 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes925023 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes925023)
			ch <- retRes925023
			return nil
		}

		retRes925219 := (<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func (this *Bitget) modifyMarginHelperBody(ch chan any, symbol any, amount any, typeVar any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes939312 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes946715 := (<-this.ModifyMarginHelperAsync(symbol, amount, "reduce", params))
...
func (this *Bitget) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes948515 := (<-this.ModifyMarginHelperAsync(symbol, amount, "add", params))
...
func (this *Bitget) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes949912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes957412 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes969412 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes974912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) ParseTransferStatus(status any) any {
	var statuses map[string]any = map[string]any{
		"successful": "ok",
	}
	return this.SafeString(statuses, status, status)
...
func (this *Bitget) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1008912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1013712 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1017412 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1025412 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1035112 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes1035619 := (<-this.FetchPaginatedCallCursorAsync("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
...
func (this *Bitget) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1050612 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1062712 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1074612 := (<-this.LoadMarketsAsync())
	...
	if IsTrue(paginate) {
		...
		retRes1075119 := (<-this.FetchPaginatedCallCursorAsync("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
...
func (this *Bitget) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1089912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1097312 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1103612 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1110612 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1126312 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1131512 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1142812 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1149912 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) FetchFundingIntervals(options ...FetchFundingIntervalsOptions) (FundingRates, error) {
	...
	var params *map[string]any = opts.Params
	res := <-this.FetchFundingIntervalsAsync(symbols, params)
	if IsError(res) {
		return FundingRates{}, CreateReturnError(res)
	}
	return NewFundingRates(res), nil
