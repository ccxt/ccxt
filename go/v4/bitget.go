...
func (this *BitgetCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes566312 := (<-this.LoadMarkets())
			PanicOnError(retRes566312)
		}
		var uta any = nil
		...
		if IsTrue(uta) {
			...
			retRes566819 := (<-this.CreateUtaOrders(orders, params))
...
func (this *BitgetCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes579312 := (<-this.LoadMarkets())
			PanicOnError(retRes579312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
...
func (this *BitgetCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes601112 := (<-this.LoadMarkets())
			PanicOnError(retRes601112)
		}
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *BitgetCore) CancelUtaOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes615512 := (<-this.LoadMarkets())
			PanicOnError(retRes615512)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes621112 := (<-this.LoadMarkets())
			PanicOnError(retRes621112)
		}
		var market any = this.Market(symbol)
		var uta any = nil
		...
		if IsTrue(uta) {
			...
			retRes621719 := (<-this.CancelUtaOrders(ids, symbol, params))
			PanicOnError(retRes621719)
			ch <- retRes621719
			return nil
		}
		var marginMode any = nil
...
func (this *BitgetCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes642712 := (<-this.LoadMarkets())
			PanicOnError(retRes642712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		var clientOrderId any = this.SafeString2(params, "clientOrderId", "clientOid")
...
func (this *BitgetCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes661312 := (<-this.LoadMarkets())
			PanicOnError(retRes661312)
		}
		var market any = nil
		var typeVar any = nil
		var request any = map[string]any{}
		...
		if IsTrue(paginate) {
			...
			retRes664919 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
...
func (this *BitgetCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes701512 := (<-this.LoadMarkets())
			PanicOnError(retRes701512)
		}
...
func (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(uta) {
			...
			retRes708119 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
			PanicOnError(retRes708119)
			ch <- retRes708119
			return nil
		}
		if IsTrue(IsEqual(this.Markets, nil)) {

			retRes708412 := (<-this.LoadMarkets())
			PanicOnError(retRes708412)
		}
		var market any = nil
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbol, nil)) {
		...
		if IsTrue(paginate) {
			...
			retRes710719 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes710719)
			ch <- retRes710719
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes736812 := (<-this.LoadMarkets())
			PanicOnError(retRes736812)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes738919 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes738919)
			ch <- retRes738919
			return nil
		}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes752919 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func (this *BitgetCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes777119 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes777119)
			ch <- retRes777119
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes795612 := (<-this.LoadMarkets())
			PanicOnError(retRes795612)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes807012 := (<-this.LoadMarkets())
			PanicOnError(retRes807012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes807519 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
			PanicOnError(retRes807519)
			ch <- retRes807519
			return nil
		}
		var method any = nil
...
func (this *BitgetCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes848912 := (<-this.LoadMarkets())
			PanicOnError(retRes848912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		...
		if IsTrue(uta) {
			...
			if IsTrue(paginate) {
				...
				retRes852923 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
				PanicOnError(retRes852923)
				ch <- retRes852923
				return nil
			}
			if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes858512 := (<-this.LoadMarkets())
			PanicOnError(retRes858512)
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes867712 := (<-this.LoadMarkets())
			PanicOnError(retRes867712)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbol any = this.SafeValue(symbols, 0)
...
func (this *BitgetCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes876515 := (<-this.FetchFundingRates(symbols, params))
		PanicOnError(retRes876515)
		ch <- retRes876515
		return nil
...
func (this *BitgetCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes887312 := (<-this.LoadMarkets())
			PanicOnError(retRes887312)
		}
		if IsTrue(IsEqual(symbol, nil)) {
		...
		if IsTrue(paginate) {
			if IsTrue(uta) {
				...
				retRes888423 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
				PanicOnError(retRes888423)
				ch <- retRes888423
				return nil
			}

			retRes888619 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
			PanicOnError(retRes888619)
			ch <- retRes888619
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes902712 := (<-this.LoadMarkets())
			PanicOnError(retRes902712)
		}
...
func (this *BitgetCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes910115 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes910115)
		ch <- retRes910115
		return nil
...
func (this *BitgetCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes911915 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes911915)
		ch <- retRes911915
		return nil
...
func (this *BitgetCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes913312 := (<-this.LoadMarkets())
			PanicOnError(retRes913312)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes932812 := (<-this.LoadMarkets())
			PanicOnError(retRes932812)
		}
...
func (this *BitgetCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes938312 := (<-this.LoadMarkets())
			PanicOnError(retRes938312)
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes971212 := (<-this.LoadMarkets())
			PanicOnError(retRes971212)
		}
...
func (this *BitgetCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes976012 := (<-this.LoadMarkets())
			PanicOnError(retRes976012)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes997412 := (<-this.LoadMarkets())
			PanicOnError(retRes997412)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes997919 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes997919)
			ch <- retRes997919
			return nil
		}
		var market any = nil
...
func (this *BitgetCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1012912 := (<-this.LoadMarkets())
			PanicOnError(retRes1012912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1025012 := (<-this.LoadMarkets())
			PanicOnError(retRes1025012)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin": GetValue(currency, "id"),
...
func (this *BitgetCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1036912 := (<-this.LoadMarkets())
			PanicOnError(retRes1036912)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1037419 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1037419)
			ch <- retRes1037419
			return nil
		}
		var market any = nil
...
func (this *BitgetCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1052212 := (<-this.LoadMarkets())
			PanicOnError(retRes1052212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1065912 := (<-this.LoadMarkets())
			PanicOnError(retRes1065912)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1072912 := (<-this.LoadMarkets())
			PanicOnError(retRes1072912)
		}
		var request any = map[string]any{}
		var market any = nil
		var productType any = nil
...
func (this *BitgetCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1083812 := (<-this.LoadMarkets())
			PanicOnError(retRes1083812)
		}
		var request any = map[string]any{
			"fromCoin":     fromCode,
			"toCoin":       toCode,
...
func (this *BitgetCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1088612 := (<-this.LoadMarkets())
			PanicOnError(retRes1088612)
		}
...
func (this *BitgetCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1093812 := (<-this.LoadMarkets())
			PanicOnError(retRes1093812)
		}
		var request any = map[string]any{}
		var msInDay any = 86400000
		var now any = this.Milliseconds()
...
func (this *BitgetCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1112012 := (<-this.LoadMarkets())
			PanicOnError(retRes1112012)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1118812 := (<-this.LoadMarkets())
			PanicOnError(retRes1118812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
