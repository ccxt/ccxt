...
func (this *BitgetCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes601512 := (<-this.LoadMarkets())
			PanicOnError(retRes601512)
		}
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *BitgetCore) CancelUtaOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes615912 := (<-this.LoadMarkets())
			PanicOnError(retRes615912)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes621512 := (<-this.LoadMarkets())
			PanicOnError(retRes621512)
		}
		var market any = this.Market(symbol)
		var uta any = nil
		...
		if IsTrue(uta) {
			...
			retRes622119 := (<-this.CancelUtaOrders(ids, symbol, params))
			PanicOnError(retRes622119)
			ch <- retRes622119
			return nil
		}
		var marginMode any = nil
...
func (this *BitgetCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes630612 := (<-this.LoadMarkets())
			PanicOnError(retRes630612)
		}
		var market any = this.Market(symbol)
		var marginMode any = nil
...
func (this *BitgetCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes665319 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes665319)
			ch <- retRes665319
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes705012 := (<-this.LoadMarkets())
			PanicOnError(retRes705012)
		}
...
func (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(uta) {
			...
			retRes708519 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
			PanicOnError(retRes708519)
			ch <- retRes708519
			return nil
		}
		if IsTrue(IsEqual(this.Markets, nil)) {

			retRes708812 := (<-this.LoadMarkets())
			PanicOnError(retRes708812)
		}
		var market any = nil
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbol, nil)) {
		...
		if IsTrue(paginate) {
			...
			retRes711119 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes711119)
			ch <- retRes711119
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes737212 := (<-this.LoadMarkets())
			PanicOnError(retRes737212)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes739319 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes739319)
			ch <- retRes739319
			return nil
		}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes751612 := (<-this.LoadMarkets())
			PanicOnError(retRes751612)
		}
		...
		if IsTrue(paginate) {
			...
			retRes753319 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes753319)
			ch <- retRes753319
			return nil
		}
		var currency any = nil
...
func (this *BitgetCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes774512 := (<-this.LoadMarkets())
			PanicOnError(retRes774512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
		...
		if IsTrue(paginate) {
			...
			retRes777519 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes777519)
			ch <- retRes777519
			return nil
		}
		var response any = nil
...
func (this *BitgetCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes807412 := (<-this.LoadMarkets())
			PanicOnError(retRes807412)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes807919 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
			PanicOnError(retRes807919)
			ch <- retRes807919
			return nil
		}
		var method any = nil
	...
	go func() any {
		...
		if IsTrue(uta) {
			...
			if IsTrue(paginate) {
				...
				retRes853323 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
				PanicOnError(retRes853323)
				ch <- retRes853323
				return nil
			}
			if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes858912 := (<-this.LoadMarkets())
			PanicOnError(retRes858912)
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes868112 := (<-this.LoadMarkets())
			PanicOnError(retRes868112)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbol any = this.SafeValue(symbols, 0)
...
func (this *BitgetCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes876612 := (<-this.LoadMarkets())
			PanicOnError(retRes876612)
		}
		params = this.Extend(map[string]any{
			"method": "publicMixGetV2MixMarketCurrentFundRate",
		}, params)

		retRes876915 := (<-this.FetchFundingRates(symbols, params))
		PanicOnError(retRes876915)
		ch <- retRes876915
		return nil
	...
	go func() any {
		...
		if IsTrue(paginate) {
			if IsTrue(uta) {
				...
				retRes888823 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
				PanicOnError(retRes888823)
				ch <- retRes888823
				return nil
			}

			retRes889019 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
			PanicOnError(retRes889019)
			ch <- retRes889019
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes910515 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes910515)
		ch <- retRes910515
		return nil
...
func (this *BitgetCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes912315 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes912315)
		ch <- retRes912315
		return nil
...
func (this *BitgetCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes921212 := (<-this.LoadMarkets())
			PanicOnError(retRes921212)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes928812 := (<-this.LoadMarkets())
			PanicOnError(retRes928812)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes933212 := (<-this.LoadMarkets())
			PanicOnError(retRes933212)
		}
...
func (this *BitgetCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes938712 := (<-this.LoadMarkets())
			PanicOnError(retRes938712)
		}
		var market any = this.Market(symbol)
...
func (this *BitgetCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes950012 := (<-this.LoadMarkets())
			PanicOnError(retRes950012)
		}
		var typeVar any = nil
...
func (this *BitgetCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes956212 := (<-this.LoadMarkets())
			PanicOnError(retRes956212)
		}
		var currency any = this.Currency(code)
		var accountsByType any = this.SafeValue(this.Options, "accountsByType", map[string]any{})
...
func (this *BitgetCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes988112 := (<-this.LoadMarkets())
			PanicOnError(retRes988112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":        GetValue(currency, "id"),
...
func (this *BitgetCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes998319 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes998319)
			ch <- retRes998319
			return nil
		}
		var market any = nil
...
func (this *BitgetCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1013312 := (<-this.LoadMarkets())
			PanicOnError(retRes1013312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1037312 := (<-this.LoadMarkets())
			PanicOnError(retRes1037312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1037819 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1037819)
			ch <- retRes1037819
			return nil
		}
		var market any = nil
...
func (this *BitgetCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1052612 := (<-this.LoadMarkets())
...
func (this *BitgetCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1066312 := (<-this.LoadMarkets())
			PanicOnError(retRes1066312)
		}
		var market any = this.Market(symbol)
		var productType any = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1073312 := (<-this.LoadMarkets())
			PanicOnError(retRes1073312)
		}
		var request any = map[string]any{}
		var market any = nil
		var productType any = nil
...
func (this *BitgetCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1084212 := (<-this.LoadMarkets())
			PanicOnError(retRes1084212)
		}
		var request any = map[string]any{
			"fromCoin":     fromCode,
			"toCoin":       toCode,
...
func (this *BitgetCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1089012 := (<-this.LoadMarkets())
			PanicOnError(retRes1089012)
		}
...
func (this *BitgetCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1105512 := (<-this.LoadMarkets())
			PanicOnError(retRes1105512)
		}
...
func (this *BitgetCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1119212 := (<-this.LoadMarkets())
			PanicOnError(retRes1119212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
