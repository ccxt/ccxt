...
func  (this *Bitget) HandleProductTypeAndParams(optionalArgs ...any) any  {
    ...
    if (!IsEqual(subType, nil)) && (IsEqual(market, nil)) {
        // set default only if subType is defined and market is not defined, since there is also USDC productTypes which are also linear
        // const sandboxMode = this.safeBool (this.options, 'sandboxMode', false);
        // if (sandboxMode) {
        //     defaultProductType = (subType === 'linear') ? 'SUSDT-FUTURES' : 'SCOIN-FUTURES';
        // } else {
        defaultProductType = Ternary(((IsEqual(subType, "linear"))), "USDT-FUTURES", "COIN-FUTURES")
    }
...
func  (this *Bitget) HandleUTAAndParams(params any, methodName any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchTime(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchMarkets(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true) {
            ...
            retRes214312 := (<-this.LoadTimeDifference())
        ...
        if IsEqual(uta, true) {
                ...
                retRes214819 :=  (<-this.FetchUtaMarkets(params))
                PanicOnError(retRes214819)
                ch <- retRes214819
                return nil
        }
    
            retRes215015 :=  (<-this.FetchDefaultMarkets(params))
            PanicOnError(retRes215015)
            ch <- retRes215015
            return nil
}
func  (this *Bitget) FetchDefaultMarkets(params any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchDefaultMarketsBody(ch chan any, params any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        for i := 0; IsLessThan(i, GetArrayLength(results)); i++ {
            ...
            var isBorrowable any = DerefScalar(this.SafeBool(firstData, "isBorrowable"))
            if fetchMargins && !IsEqual(isBorrowable, nil) {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(data)); j++ {
                    ...
                    var entryBorrowable any = DerefScalar(this.SafeBool(entry, "isBorrowable", true))
                    if ((entryBorrowable == true)) && EvalTruthy(this.SafeBool(entry, "isCrossBorrowable", true)) {
                        AppendToArray(&crossKeys, entrySymbol)
                    }
                    var isolatedBase any = DerefScalar(this.SafeBool(entry, "isIsolatedBaseBorrowable", true))
                    var isolatedQuote any = DerefScalar(this.SafeBool2(entry, "isIsolatedQuotedBorrowable", "isIsolatedQuoteBorrowable", true))
        ...
        for i := 0; IsLessThan(i, GetArrayLength(markets)); i++ {
            ...
            if (symbolType == nil) {
                ...
                if (symbolType != nil && *symbolType == "perpetual") {
                    ...
                    expiry = DerefScalar(this.SafeInteger(market, "deliveryTime"))
            ...
            var minCost any = nil
            if IsEqual(quote, "USDT") {
                minCost = DerefScalar(this.SafeNumber(market, "minTradeUSDT"))
            }
            var contractSize any = Ternary(contract, 1, nil)
...
func  (this *Bitget) FetchUtaMarkets(params any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchCurrencies(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) ParseCurrency(rawCurrency any) any  {
    ...
    for j := 0; IsLessThan(j, chainsLength); j++ {
        ...
        withdraw = Ternary((IsEqual(withdraw, nil)), withdrawable, (EvalTruthy(withdraw) || withdrawable))
        deposit = Ternary((IsEqual(deposit, nil)), rechargeable, (EvalTruthy(deposit) || rechargeable))
    ...
    var active bool = (IsEqual(withdraw, true)) && (IsEqual(deposit, true))
    ...
    return this.SafeCurrencyStructure(map[string]any {
        ...
        "code": code,
        "networks": networks,
        "type": Ternary(isFiat, "fiat", "crypto"),
        "name": nil,
        "active": active,
        "deposit": deposit,
        "withdraw": withdraw,
 ...
 */
func  (this *Bitget) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) ParseMarketLeverageTiers(info any, optionalArgs ...any) any  {
    ...
    for i := 0; IsLessThan(i, GetArrayLength(info)); i++ {
        ...
        var minimumNotional any = DerefScalar(this.SafeNumber2(item, "startUnit", "minTierValue"))
        if !IsEqual(minimumNotional, nil) {
            minNotional = minimumNotional
        }
        var maxNotional any = DerefScalar(this.SafeNumberN(item, []any{"endUnit", "maxBorrowableAmount", "baseMaxBorrowableAmount", "maxTierValue"}))
        var marginCurrency *string = this.SafeString2(item, "coin", "baseCoin")
        var currencyId any = Ternary(((marginCurrency != nil)), marginCurrency, this.SafeString(market, "base"))
 ...
 */
func  (this *Bitget) FetchDeposits(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
            if IsEqual(uta, true) {
                    ...
                    retRes303523 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "orderId", "cursor", nil, 100))
                    PanicOnError(retRes303523)
                    ch <- retRes303523
                    return nil
            }
    
                retRes303719 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
 ...
 */
func  (this *Bitget) Withdraw(code any, amount any, address any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/?id=transaction-structure}
 */
func  (this *Bitget) FetchWithdrawals(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
            if IsEqual(uta, true) {
                    ...
                    retRes321523 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "orderId", "cursor", nil, 100))
                    PanicOnError(retRes321523)
                    ch <- retRes321523
                    return nil
            }
    
                retRes321719 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
 ...
 */
func  (this *Bitget) FetchDepositAddress(code any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        //
        var data any = this.SafeValue(response, "data", map[string]any {})
        var bidsKey any = Ternary((IsEqual(uta, true)), "b", "bids")
        var asksKey any = Ternary((IsEqual(uta, true)), "a", "asks")
 ...
 */
func  (this *Bitget) FetchTicker(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/?id=ticker-structure}
 */
func  (this *Bitget) FetchMarkPrice(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchTickers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) ParseTrade(trade any, optionalArgs ...any) any  {
    ...
    var feeStructure any = Ternary(isFeeStructure, GetValue(feeDetail, 0), feeDetail)
    if !IsEqual(feeStructure, nil) {
        ...
        var deduction any = Ternary(IsEqual(this.SafeString(feeStructure, "deduction"), "yes"), true, false)
 ...
 */
func  (this *Bitget) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes425019 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
 ...
 */
func  (this *Bitget) FetchTradingFee(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var uta any = nil
        utaparamsVariable := (<-this.HandleUTAAndParams(params, "fetchTradingFee", false));
        uta = GetValue(utaparamsVariable,0);
        params = GetValue(utaparamsVariable,1)
        if IsEqual(uta, true) {
            var productType any = nil
 ...
 */
func  (this *Bitget) FetchTradingFees(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var uta any = nil
        utaparamsVariable := (<-this.HandleUTAAndParams(params, "fetchTradingFees", false));
        uta = GetValue(utaparamsVariable,0);
        params = GetValue(utaparamsVariable,1)
        if IsEqual(uta, true) {
            var utaMargin any = DerefScalar(this.SafeBool(params, "margin", false))
            params = this.Omit(params, "margin")
            var request map[string]any = map[string]any {}
            if (IsEqual(marketType, "spot")) {
                if (!IsEqual(marginMode, nil)) || ((utaMargin == true)) {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(rows)); i++ {
                ...
                if ((entryMarketId == nil)) || (IsEqual(this.Markets_by_id, nil)) || !(InOp(this.Markets_by_id, entryMarketId)) {
                    continue
                }
        ...
        if (IsEqual(marketType, "spot")) {
            var margin any = DerefScalar(this.SafeBool(params, "margin", false))
            params = this.Omit(params, "margin")
            if (!IsEqual(marginMode, nil)) || ((margin == true)) {
...
func  (this *Bitget) ParseOHLCV(ohlcv any, optionalArgs ...any) any  {
    ...
    market := GetArg(optionalArgs, 0, nil)
    _ = market
    var inverse any = DerefScalar(this.SafeBool(market, "inverse"))
    var volumeIndex any = Ternary((IsEqual(inverse, true)), 6, 5)
 ...
 */
func  (this *Bitget) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var useHistoryEndpoint any = DerefScalar(this.SafeBool(params, "useHistoryEndpoint", false))
        var useHistoryEndpointForPagination any = DerefScalar(this.SafeBool(params, "useHistoryEndpointForPagination", true))
        var paginate any = false
        paginateparamsVariable := this.HandleOptionAndParams(params, "fetchOHLCV", "paginate");
        paginate = GetValue(paginateparamsVariable,0);
        params = GetValue(paginateparamsVariable,1)
        if EvalTruthy(paginate) {
            var limitForPagination any = Ternary(((useHistoryEndpointForPagination == true)), maxLimitForHistoryEndpoint, maxLimitForRecentEndpoint)
    
                retRes468419 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
        ...
        if IsEqual(uta, true) {
            ...
            marketType = Ternary((IsEqual(GetValue(market, "spot"), true)), "spot", "swap")
        ...
        var key any = Ternary((IsEqual(GetValue(market, "spot"), true)), "spot", "swap")
        ...
        if (!IsEqual(calculatedStartTime, nil) && IsLessThanOrEqual(calculatedStartTime, recentEndpointBoundaryTs)) || ((useHistoryEndpoint == true)) {
 ...
 */
func  (this *Bitget) FetchBalance(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) ParseOrder(order any, optionalArgs ...any) any  {
    ...
    var marketType any = Ternary(isContractOrder, "contract", "spot")
    ...
    if (reduceOnlyRaw != nil) {
        reduceOnly = Ternary(((reduceOnlyRaw != nil && *reduceOnlyRaw == "NO")), false, true)
    }
    var price any = nil
    var average any = nil
    ...
    if (posMode != nil && *posMode == "hedge_mode") && (IsEqual(reduceOnly, true)) {
        side = Ternary((IsEqual(side, "buy")), "sell", "buy")
    }
 ...
 */
func  (this *Bitget) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        var req map[string]any = map[string]any {
            ...
            retRes554715 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) CreateUtaOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any  {
    ...
    var stopLossTriggerPrice any = DerefScalar(this.SafeNumber(params, "stopLossPrice"))
    var takeProfitTriggerPrice any = DerefScalar(this.SafeNumber(params, "takeProfitPrice"))
    ...
    var isStopLossTrigger bool = !IsEqual(stopLossTriggerPrice, nil)
    var isTakeProfitTrigger bool = !IsEqual(takeProfitTriggerPrice, nil)
    ...
    if isStopLossOrTakeProfitTrigger {
        ...
        if hasStopLoss {
            var slTriggerPrice any = DerefScalar(this.SafeNumber2(stopLoss, "triggerPrice", "stopPrice"))
            var slLimitPrice any = DerefScalar(this.SafeNumber(stopLoss, "price"))
        ...
        if hasTakeProfit {
            var tpTriggerPrice any = DerefScalar(this.SafeNumber2(takeProfit, "triggerPrice", "stopPrice"))
            var tpLimitPrice any = DerefScalar(this.SafeNumber(takeProfit, "price"))
    ...
    if (reduceOnly == true) {
        if (IsEqual(hedged, true)) || isStopLossOrTakeProfitTrigger {
            var reduceOnlyPosSide any = Ternary(((IsEqual(side, "sell"))), "long", "short")
        ...
        if IsEqual(hedged, true) {
            var posSide any = Ternary(((IsEqual(side, "buy"))), "long", "short")
...
func  (this *Bitget) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any  {
    ...
    if ((IsEqual(marketType, "swap"))) || ((IsEqual(marketType, "future"))) {
        ...
        if isTrailingPercentOrder {
            ...
            if IsEqual(hedged, true) {
                AddElementToObject(request, "holdSide", Ternary(((IsEqual(side, "sell"))), "long", "short"))
            } else {
                AddElementToObject(request, "holdSide", Ternary(((IsEqual(side, "sell"))), "buy", "sell"))
            }
        ...
        if !isStopLossOrTakeProfitTrigger {
            ...
            var marginModeRequest any = Ternary(((IsEqual(marginMode, "cross"))), "crossed", "isolated")
            ...
            if (reduceOnly == true) {
                if !IsEqual(hedged, true) {
                    ...
                    requestSide = Ternary(((IsEqual(side, "buy"))), "sell", "buy")
...
func  (this *Bitget) CreateUtaOrders(orders any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) CreateOrders(orders any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(uta, true) {
                ...
                retRes610519 :=  (<-this.CreateUtaOrders(orders, params))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        response = (<-this.PrivateUtaPostV3TradeModifyOrder(this.Extend(request, params)))
            ...
            params = this.Omit(params, "cost")
            var editMarketBuyOrderRequiresPrice any = DerefScalar(this.SafeBool(this.Options, "editMarketBuyOrderRequiresPrice", true))
            if (((editMarketBuyOrderRequiresPrice == true)) || ((cost != nil))) && isMarketOrder && (IsEqual(side, "buy")) {
                if IsEqual(price, nil) && (cost == nil) {
                    ...
                    var amountString any = this.NumberToString(amount)
                    var priceString any = this.NumberToString(price)
                    var finalCost any = Ternary(((cost == nil)), (Precise.StringMul(amountString, priceString)), cost)
        ...
        response = (<-this.PrivateMixPostV2MixOrderModifyTpslOrder(this.Extend(request, params)))
                ...
                if hasStopLoss {
                    ...
                    var slPrice any = DerefScalar(this.SafeNumber(stopLoss, "price"))
                ...
                if hasTakeProfit {
                    ...
                    var tpPrice any = DerefScalar(this.SafeNumber(takeProfit, "price"))
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) CancelOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if !((IsEqual(GetValue(market, "spot"), true)) && (IsEqual(trigger, true))) {
            AddElementToObject(request, "symbol", GetValue(market, "id"))
        }
        var uta any = nil
        ...
        uta = GetValue(utaparamsVariable,0);
        params = GetValue(utaparamsVariable,1)
        var isPlanOrder bool = (IsEqual(trigger, true)) || (IsEqual(trailing, true))
        var isContract bool = (IsEqual(GetValue(market, "swap"), true)) || (IsEqual(GetValue(market, "future"), true))
        var isContractTriggerEndpoint bool = isContract && isPlanOrder && (!IsEqual(uta, true))
        var clientOrderId *string = this.SafeString2(params, "clientOrderId", "clientOid")
        ...
        if isContractTriggerEndpoint {
            ...
            if (IsEqual(uta, true)) && (IsEqual(trigger, true)) {
                order = response
            } else {
                order = data
            }
...
func  (this *Bitget) CancelUtaOrders(ids any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) CancelOrders(ids any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(uta, true) {
                ...
                retRes665819 :=  (<-this.CancelUtaOrders(ids, symbol, params))
 ...
 */
func  (this *Bitget) CancelAllOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) FetchOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchOpenOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if !IsEqual(symbol, nil) {
            ...
            var marketType any = Ternary((InOp(market, "type")), GetValue(market, "type"), defaultType)
        ...
        if EvalTruthy(paginate) {
            ...
            if IsEqual(uta, true) {
                ...
                retRes709019 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
        ...
        var isTrigger bool = (IsEqual(trigger, true)) || planTypeDefined
        requestparamsVariable := this.HandleUntilOption("endTime", request, params);
        request = GetValue(requestparamsVariable,0);
        params = GetValue(requestparamsVariable,1)
        if !IsEqual(since, nil) {
        ...
        if (!IsEqual(uta, true)) && (((IsEqual(typeVar, "swap"))) || ((IsEqual(typeVar, "future"))) || (!IsEqual(marginMode, nil))) {
            var clientOrderId *string = this.SafeString2(params, "clientOid", "clientOrderId")
            params = this.Omit(params, "clientOrderId")
            if (clientOrderId != nil) {
                AddElementToObject(request, "clientOid", clientOrderId)
        ...
        if IsEqual(uta, true) {
            ...
            if (!IsEqual(marginMode, nil)) || (IsEqual(trigger, true)) {
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) FetchClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) FetchCanceledOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) FetchCanceledAndClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(uta, true) {
                ...
                retRes752419 :=  (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
        ...
        if EvalTruthy(paginate) {
            ...
            if (IsEqual(marketType, "spot")) {
                ...
                retRes755019 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
        ...
        if ((IsEqual(marketType, "swap"))) || ((IsEqual(marketType, "future"))) || (!IsEqual(marginMode, nil)) {
            var clientOrderId *string = this.SafeString2(params, "clientOid", "clientOrderId")
            params = this.Omit(params, "clientOrderId")
            if (clientOrderId != nil) {
                AddElementToObject(request, "clientOid", clientOrderId)
        ...
        response = (<-this.PrivateMixGetV2MixOrderOrdersPlanHistory(this.Extend(request, params)))
                    PanicOnError(response)
            } else if (IsEqual(trigger, true)) || planTypeDefined {
                var planType *string = this.SafeString(params, "planType", "normal_plan")
                AddElementToObject(request, "planType", planType)
...
func  (this *Bitget) FetchUtaCanceledAndClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchUtaCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes783219 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
 ...
 */
func  (this *Bitget) FetchLedger(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
            ...
            if (!IsEqual(marketType, "spot")) {
                ...
                retRes797219 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func  (this *Bitget) ParseLedgerEntry(item any, optionalArgs ...any) any  {
    ...
    var timestamp *int64 = this.SafeInteger(item, "cTime")
    var after any = DerefScalar(this.SafeNumber(item, "balance"))
    var fee any = DerefScalar(this.SafeNumber2(item, "fees", "fee"))
    ...
    if IsGreaterThanOrEqual(GetIndexOf(amountRaw, "-"), 0) {
        direction = "out"
    }
 ...
 */
func  (this *Bitget) FetchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        uta = GetValue(utaparamsVariable,0);
        params = GetValue(utaparamsVariable,1)
        if (!IsEqual(uta, true)) && (IsEqual(symbol, nil)) {
            panic(ArgumentsRequired(Add(this.Id, " fetchMyTrades() requires a symbol argument")))
        }
        if IsEqual(this.Markets, nil) {
    
            retRes818412 := (<-this.LoadMarkets())
        ...
        if EvalTruthy(paginate) {
            ...
            if IsEqual(uta, true) {
                ...
                retRes821419 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
        ...
        if IsEqual(uta, true) {
            ...
            ch <- this.ParseTrades(fills, market, since, limit)
            return nil
        } else if !IsEqual(marginMode, nil) {
 ...
 */
func  (this *Bitget) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
                ...
                retRes851819 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
 ...
 */
func  (this *Bitget) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ReturnPanicError(ch)
        ...
        response = (<-this.PublicUtaGetV3MarketHistoryFundRate(this.Extend(request, params)))
            ...
            if EvalTruthy(paginate) {
                    ...
                    retRes897223 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
 ...
 */
func  (this *Bitget) FetchFundingRate(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchFundingRates(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchFundingIntervals(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        params = this.Extend(map[string]any {
            ...
            retRes920815 :=  (<-this.FetchFundingRates(symbols, params))
...
func  (this *Bitget) ParseFundingRate(contract any, optionalArgs ...any) any  {
    ...
    var markPrice any = DerefScalar(this.SafeNumber(contract, "markPrice"))
    var indexPrice any = DerefScalar(this.SafeNumber(contract, "indexPrice"))
 ...
 */
func  (this *Bitget) FetchFundingHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ReturnPanicError(ch)
        ...
        if EvalTruthy(paginate) {
            if IsEqual(uta, true) {
                    ...
                    retRes932723 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
                    PanicOnError(retRes932723)
                    ch <- retRes932723
                    return nil
            }
    
                retRes932919 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func  (this *Bitget) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) ParseMarginModification(data any, optionalArgs ...any) any  {
    ...
    var status any = Ternary(((errorCode != nil && *errorCode == "00000")), "ok", "failed")
    return map[string]any {
        "info": data,
 ...
 */
func  (this *Bitget) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if (holdSide == nil) {
            ...
            retRes954415 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
 ...
 * @returns {object} a [margin structure]{@link https://docs.ccxt.com/?id=margin-structure}
 */
func  (this *Bitget) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if (holdSide == nil) {
            ...
            retRes956215 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
 ...
 */
func  (this *Bitget) FetchLeverage(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitget) ParseLeverage(leverage any, optionalArgs ...any) any  {
    ...
    var longLevKey any = Ternary(isCrossMarginMode, "crossedMarginLeverage", "isolatedLongLever")
    var shortLevKey any = Ternary(isCrossMarginMode, "crossedMarginLeverage", "isolatedShortLever")
    return map[string]any {
        "info": leverage,
        "symbol": this.SafeString(market, "symbol"),
        "marginMode": Ternary(isCrossMarginMode, "cross", "isolated"),
 ...
 */
func  (this *Bitget) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} response from the exchange
 */
func  (this *Bitget) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} response from the exchange
 */
func  (this *Bitget) SetPositionMode(hedged any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes977112 := (<-this.LoadMarkets())
            PanicOnError(retRes977112)
        }
        var posMode any = Ternary(EvalTruthy(hedged), "hedge_mode", "one_way_mode")
        var request map[string]any = map[string]any {}
        var market any = nil
        if !IsEqual(symbol, nil) {
            market = this.Market(symbol)
 ...
 */
func  (this *Bitget) FetchOpenInterest(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchTransfers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1000312 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchDepositWithdrawFees(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1016612 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a [margin loan structure]{@link https://docs.ccxt.com/?id=margin-loan-structure}
 */
func  (this *Bitget) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1025112 := (<-this.LoadMarkets())
 ...
 * @returns {object} a [margin loan structure]{@link https://docs.ccxt.com/?id=margin-loan-structure}
 */
func  (this *Bitget) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1029112 := (<-this.LoadMarkets())
 ...
 * @returns {object} a [margin loan structure]{@link https://docs.ccxt.com/?id=margin-loan-structure}
 */
func  (this *Bitget) RepayCrossMargin(code any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1033112 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchMyLiquidations(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1042812 := (<-this.LoadMarkets())
        ...
        if EvalTruthy(paginate) {
                ...
                retRes1043319 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
 ...
 */
func  (this *Bitget) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1058312 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchCrossBorrowRate(code any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1070412 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchBorrowInterest(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1082312 := (<-this.LoadMarkets())
        ...
        if EvalTruthy(paginate) {
                ...
                retRes1082819 :=  (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
...
func  (this *Bitget) ParseBorrowInterest(info any, optionalArgs ...any) any  {
    ...
    var marginMode any = Ternary(((marketId != nil)), "isolated", "cross")
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *Bitget) ClosePosition(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1097612 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) CloseAllPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1105012 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchMarginMode(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1111312 := (<-this.LoadMarkets())
...
func  (this *Bitget) ParseMarginMode(marginMode any, optionalArgs ...any) any  {
    ...
    marginType = Ternary((IsEqual(marginType, "crossed")), "cross", marginType)
    return map[string]any {
        "info": marginMode,
        "symbol": this.SafeString(market, "symbol"),
 ...
 * @returns {object[]} a list of [position structures]{@link https://docs.ccxt.com/?id=position-structure}
 */
func  (this *Bitget) FetchPositionsHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1118312 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1129212 := (<-this.LoadMarkets())
 ...
 * @returns {object} a [conversion structure]{@link https://docs.ccxt.com/?id=conversion-structure}
 */
func  (this *Bitget) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1134012 := (<-this.LoadMarkets())
 ...
 */
func  (this *Bitget) FetchConvertTradeHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1139212 := (<-this.LoadMarkets())
 ...
 * @returns {object} an associative dictionary of currencies
 */
func  (this *Bitget) FetchConvertCurrencies(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1150512 := (<-this.LoadMarkets())
 ...
 * @returns {object} a [funding rate structure]{@link https://docs.ccxt.com/?id=funding-rate-structure}
 */
func  (this *Bitget) FetchFundingInterval(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitget) FetchLongShortRatioHistory(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Bitget) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ReturnPanicError(ch)
        ...
        if IsEqual(this.Markets, nil) {
            ...
            retRes1164412 := (<-this.LoadMarkets())
...
func  (this *Bitget) Sign(path any, optionalArgs ...any) any  {
    ...
    if signed {
        ...
        if (IsEqual(method, "POST")) {
            ...
            if IsGreaterThan(GetArrayLength(ObjectKeys(params)), 0) {
                ...
                // check #21169 pr
                if IsGreaterThan(GetIndexOf(queryInner, "%24"), OpNeg(1)) {
    ...
    var sandboxMode any = DerefScalar(this.SafeBool2(this.Options, "sandboxMode", "sandbox", false))
...
//nolint
func (this *Bitget) LoadMarkets(params ...any) (map[string]MarketInterface, error) { return this.exchangeTyped.LoadMarkets(params...) }
...
func (this *Bitget) CancelAllOrdersAfter(timeout int64, options ...CancelAllOrdersAfterOptions) (map[string]any, error) {return this.exchangeTyped.CancelAllOrdersAfter(timeout, options...)}
...
func (this *Bitget) FetchAccounts(params ...any) ([]Account, error) {return this.exchangeTyped.FetchAccounts(params...)}
func (this *Bitget) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Bitget) FetchBorrowRate(code string, amount float64, options ...FetchBorrowRateOptions) (map[string]any, error) {return this.exchangeTyped.FetchBorrowRate(code, amount, options...)}
...
func (this *Bitget) FetchCrossBorrowRates(params ...any) (CrossBorrowRates, error) {return this.exchangeTyped.FetchCrossBorrowRates(params...)}
...
func (this *Bitget) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
...
func (this *Bitget) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *Bitget) FetchFreeBalance(params ...any) (Balance, error) {return this.exchangeTyped.FetchFreeBalance(params...)}
...
func (this *Bitget) FetchIsolatedBorrowRates(params ...any) (IsolatedBorrowRates, error) {return this.exchangeTyped.FetchIsolatedBorrowRates(params...)}
...
func (this *Bitget) FetchPaymentMethods(params ...any) (map[string]any, error) {return this.exchangeTyped.FetchPaymentMethods(params...)}
...
func (this *Bitget) FetchPositionMode(options ...FetchPositionModeOptions) (PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *Bitget) FetchStatus(params ...any) (Status, error) {return this.exchangeTyped.FetchStatus(params...)}
func (this *Bitget) FetchTradingLimits(options ...FetchTradingLimitsOptions) (map[string]any, error) {return this.exchangeTyped.FetchTradingLimits(options...)}
func (this *Bitget) FetchTransactionFee(code string, options ...FetchTransactionFeeOptions) (map[string]any, error) {return this.exchangeTyped.FetchTransactionFee(code, options...)}
func (this *Bitget) FetchTransactionFees(options ...FetchTransactionFeesOptions) (map[string]any, error) {return this.exchangeTyped.FetchTransactionFees(options...)}
...
func (this *Bitget) FetchBalanceWs(params ...any) (Balances, error) {return this.exchangeTyped.FetchBalanceWs(params...)}
...
func (this *Bitget) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Bitget) FetchTradingFeesWs(params ...any) (TradingFees, error) {return this.exchangeTyped.FetchTradingFeesWs(params...)}
func (this *Bitget) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
func (this *Bitget) UnWatchBidsAsks(options ...UnWatchBidsAsksOptions) (any, error) {return this.exchangeTyped.UnWatchBidsAsks(options...)}
func (this *Bitget) UnWatchMyTrades(options ...UnWatchMyTradesOptions) (any, error) {return this.exchangeTyped.UnWatchMyTrades(options...)}
func (this *Bitget) UnWatchOHLCV(symbol string, options ...UnWatchOHLCVOptions) (any, error) {return this.exchangeTyped.UnWatchOHLCV(symbol, options...)}
func (this *Bitget) UnWatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...UnWatchOHLCVForSymbolsOptions) (any, error) {return this.exchangeTyped.UnWatchOHLCVForSymbols(symbolsAndTimeframes, options...)}
func (this *Bitget) UnWatchOrderBook(symbol string, options ...UnWatchOrderBookOptions) (any, error) {return this.exchangeTyped.UnWatchOrderBook(symbol, options...)}
func (this *Bitget) UnWatchOrderBookForSymbols(symbols []string, options ...UnWatchOrderBookForSymbolsOptions) (any, error) {return this.exchangeTyped.UnWatchOrderBookForSymbols(symbols, options...)}
func (this *Bitget) UnWatchOrders(options ...UnWatchOrdersOptions) (any, error) {return this.exchangeTyped.UnWatchOrders(options...)}
func (this *Bitget) UnWatchTicker(symbol string, options ...UnWatchTickerOptions) (any, error) {return this.exchangeTyped.UnWatchTicker(symbol, options...)}
func (this *Bitget) UnWatchTickers(options ...UnWatchTickersOptions) (any, error) {return this.exchangeTyped.UnWatchTickers(options...)}
func (this *Bitget) UnWatchTrades(symbol string, options ...UnWatchTradesOptions) (any, error) {return this.exchangeTyped.UnWatchTrades(symbol, options...)}
func (this *Bitget) UnWatchTradesForSymbols(symbols []string, options ...UnWatchTradesForSymbolsOptions) (any, error) {return this.exchangeTyped.UnWatchTradesForSymbols(symbols, options...)}
func (this *Bitget) WatchBalance(params ...any) (Balances, error) {return this.exchangeTyped.WatchBalance(params...)}
