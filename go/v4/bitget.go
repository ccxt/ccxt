...
func (this *BitgetCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes188812 := (<-this.LoadTimeDifference())
			PanicOnError(retRes188812)
		}
		...
		if IsTrue(uta) {
			...
			retRes189319 := (<-this.FetchUtaMarkets(params))
			PanicOnError(retRes189319)
			ch <- retRes189319
			return nil
		} else {

			retRes189519 := (<-this.FetchDefaultMarkets(params))
...
func (this *BitgetCore) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes275119 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
			PanicOnError(retRes275119)
			ch <- retRes275119
			return nil
		}
...
func (this *BitgetCore) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes287719 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
			PanicOnError(retRes287719)
			ch <- retRes287719
			return nil
		}
		var currency interface{} = nil
...
func (this *BitgetCore) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes33118 := (<-this.LoadMarkets())
		PanicOnError(retRes33118)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes38258 := (<-this.LoadMarkets())
		PanicOnError(retRes38258)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes382919 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
			PanicOnError(retRes382919)
			ch <- retRes382919
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes418119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
...
func (this *BitgetCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes498815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
		PanicOnError(retRes498815)
		ch <- retRes498815
		return nil
...
func (this *BitgetCore) CreateUtaOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes54258 := (<-this.LoadMarkets())
		PanicOnError(retRes54258)
...
func (this *BitgetCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes549619 := (<-this.CreateUtaOrders(orders, params))
			PanicOnError(retRes549619)
			ch <- retRes549619
			return nil
		}
		var ordersRequests interface{} = []interface{}{}
...
func (this *BitgetCore) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes56208 := (<-this.LoadMarkets())
		PanicOnError(retRes56208)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{}
...
func (this *BitgetCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58288 := (<-this.LoadMarkets())
		PanicOnError(retRes58288)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
		var response interface{} = nil
...
func (this *BitgetCore) CancelUtaOrders(ids interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes59708 := (<-this.LoadMarkets())
		PanicOnError(retRes59708)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) CancelOrders(ids interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes60248 := (<-this.LoadMarkets())
		PanicOnError(retRes60248)
		var market interface{} = this.Market(symbol)
		var uta interface{} = nil
		...
		if IsTrue(uta) {
			...
			retRes602919 := (<-this.CancelUtaOrders(ids, symbol, params))
			PanicOnError(retRes602919)
			ch <- retRes602919
			return nil
		}
		var marginMode interface{} = nil
...
func (this *BitgetCore) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes61138 := (<-this.LoadMarkets())
		PanicOnError(retRes61138)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
...
func (this *BitgetCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes645519 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes645519)
			ch <- retRes645519
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes68208 := (<-this.LoadMarkets())
		PanicOnError(retRes68208)
...
func (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes688319 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
			PanicOnError(retRes688319)
			ch <- retRes688319
			return nil
		}

		retRes68858 := (<-this.LoadMarkets())
		PanicOnError(retRes68858)
		var market interface{} = nil
		var request interface{} = map[string]interface{}{}
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes690719 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes71678 := (<-this.LoadMarkets())
		PanicOnError(retRes71678)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
		...
		if IsTrue(paginate) {
			...
			retRes718719 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes718719)
			ch <- retRes718719
			return nil
		}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes73098 := (<-this.LoadMarkets())
		PanicOnError(retRes73098)
		...
		if IsTrue(paginate) {
			...
			retRes732519 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func (this *BitgetCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes75368 := (<-this.LoadMarkets())
		PanicOnError(retRes75368)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
		request = GetValue(requestparamsVariable, 0)
		...
		if IsTrue(paginate) {
			...
			retRes756519 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes756519)
			ch <- retRes756519
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes77498 := (<-this.LoadMarkets())
		PanicOnError(retRes77498)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes78618 := (<-this.LoadMarkets())
		PanicOnError(retRes78618)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes786519 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
			PanicOnError(retRes786519)
			ch <- retRes786519
			return nil
		}
...
func (this *BitgetCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes82788 := (<-this.LoadMarkets())
		PanicOnError(retRes82788)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
		...
		if IsTrue(uta) {
			...
			if IsTrue(paginate) {
				...
				retRes831723 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
				PanicOnError(retRes831723)
				ch <- retRes831723
				return nil
			}
			if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes83728 := (<-this.LoadMarkets())
		PanicOnError(retRes83728)
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchFundingRates(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes84628 := (<-this.LoadMarkets())
		PanicOnError(retRes84628)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbol interface{} = this.SafeValue(symbols, 0)
			market = this.Market(symbol)
...
func (this *BitgetCore) FetchFundingIntervals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes85458 := (<-this.LoadMarkets())
		PanicOnError(retRes85458)
		params = this.Extend(map[string]interface{}{
			"method": "publicMixGetV2MixMarketCurrentFundRate",
		}, params)

		retRes854715 := (<-this.FetchFundingRates(symbols, params))
		PanicOnError(retRes854715)
		ch <- retRes854715
		return nil
...
func (this *BitgetCore) FetchFundingHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes86548 := (<-this.LoadMarkets())
		PanicOnError(retRes86548)
		if IsTrue(IsEqual(symbol, nil)) {
		...
		if IsTrue(paginate) {
			...
			retRes866119 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func (this *BitgetCore) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes87568 := (<-this.LoadMarkets())
		PanicOnError(retRes87568)
...
func (this *BitgetCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes882915 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes882915)
		ch <- retRes882915
		return nil
...
func (this *BitgetCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes884715 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *BitgetCore) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes88608 := (<-this.LoadMarkets())
		PanicOnError(retRes88608)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes90078 := (<-this.LoadMarkets())
		PanicOnError(retRes90078)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes91028 := (<-this.LoadMarkets())
		PanicOnError(retRes91028)
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchTransfers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes92138 := (<-this.LoadMarkets())
		PanicOnError(retRes92138)
		var typeVar interface{} = nil
...
func (this *BitgetCore) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes92738 := (<-this.LoadMarkets())
		PanicOnError(retRes92738)
		var currency interface{} = this.Currency(code)
		var accountsByType interface{} = this.SafeValue(this.Options, "accountsByType", map[string]interface{}{})
...
func (this *BitgetCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94718 := (<-this.LoadMarkets())
		PanicOnError(retRes94718)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes95068 := (<-this.LoadMarkets())
		PanicOnError(retRes95068)
		var currency interface{} = this.Currency(code)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) FetchMyLiquidations(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes96778 := (<-this.LoadMarkets())
		PanicOnError(retRes96778)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes968119 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes968119)
			ch <- retRes968119
			return nil
		}
		var market interface{} = nil
...
func (this *BitgetCore) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes99498 := (<-this.LoadMarkets())
		PanicOnError(retRes99498)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin": GetValue(currency, "id"),
		}
...
func (this *BitgetCore) FetchBorrowInterest(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes100668 := (<-this.LoadMarkets())
		PanicOnError(retRes100668)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes1007019 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1007019)
			ch <- retRes1007019
			return nil
		}
		var market interface{} = nil
...
func (this *BitgetCore) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes102178 := (<-this.LoadMarkets())
		PanicOnError(retRes102178)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) CloseAllPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes102898 := (<-this.LoadMarkets())
		PanicOnError(retRes102898)
		var request interface{} = map[string]interface{}{}
		var productType interface{} = nil
		var uta interface{} = nil
		var response interface{} = nil
...
func (this *BitgetCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes103508 := (<-this.LoadMarkets())
		PanicOnError(retRes103508)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchPositionsHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes104188 := (<-this.LoadMarkets())
		PanicOnError(retRes104188)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		var productType interface{} = nil
		var uta interface{} = nil
...
func (this *BitgetCore) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes105258 := (<-this.LoadMarkets())
		PanicOnError(retRes105258)
		var request interface{} = map[string]interface{}{
			"fromCoin":     fromCode,
			"toCoin":       toCode,
...
func (this *BitgetCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes105718 := (<-this.LoadMarkets())
		PanicOnError(retRes105718)
...
func (this *BitgetCore) FetchConvertCurrencies(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes107328 := (<-this.LoadMarkets())
		PanicOnError(retRes107328)
...
func (this *BitgetCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes107998 := (<-this.LoadMarkets())
		PanicOnError(retRes107998)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchLongShortRatioHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes108658 := (<-this.LoadMarkets())
		PanicOnError(retRes108658)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
