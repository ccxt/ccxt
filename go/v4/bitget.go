...
func (this *BitgetCore) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes60998 := (<-this.LoadMarkets())
		PanicOnError(retRes60998)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
...
func (this *BitgetCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes62228 := (<-this.LoadMarkets())
		PanicOnError(retRes62228)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{}
		var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "clientOid")
		if IsTrue(!IsEqual(clientOrderId, nil)) {
...
func (this *BitgetCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes644119 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes644119)
			ch <- retRes644119
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchCanceledOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes68358 := (<-this.LoadMarkets())
		PanicOnError(retRes68358)
...
func (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes686919 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
			PanicOnError(retRes686919)
			ch <- retRes686919
			return nil
		}

		retRes68718 := (<-this.LoadMarkets())
		PanicOnError(retRes68718)
		var market interface{} = nil
		var request interface{} = map[string]interface{}{}
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes689319 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes689319)
			ch <- retRes689319
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes71538 := (<-this.LoadMarkets())
		PanicOnError(retRes71538)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
		...
		if IsTrue(paginate) {
			...
			retRes717319 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes717319)
			ch <- retRes717319
			return nil
		}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes731119 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes731119)
			ch <- retRes731119
			return nil
		}
		var currency interface{} = nil
...
func (this *BitgetCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes755119 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
...
func (this *BitgetCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes785119 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
...
func (this *BitgetCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes82648 := (<-this.LoadMarkets())
		PanicOnError(retRes82648)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
		...
		if IsTrue(uta) {
			...
			if IsTrue(paginate) {
				...
				retRes830323 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
				PanicOnError(retRes830323)
				ch <- retRes830323
				return nil
			}
			if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes83588 := (<-this.LoadMarkets())
		PanicOnError(retRes83588)
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchFundingIntervals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes85318 := (<-this.LoadMarkets())
		PanicOnError(retRes85318)
		params = this.Extend(map[string]interface{}{
			"method": "publicMixGetV2MixMarketCurrentFundRate",
		}, params)

		retRes853315 := (<-this.FetchFundingRates(symbols, params))
		PanicOnError(retRes853315)
		ch <- retRes853315
		return nil
...
func (this *BitgetCore) FetchFundingHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes864719 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
			PanicOnError(retRes864719)
			ch <- retRes864719
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes87428 := (<-this.LoadMarkets())
		PanicOnError(retRes87428)
...
func (this *BitgetCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes881515 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes881515)
		ch <- retRes881515
		return nil
...
func (this *BitgetCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes883315 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes883315)
		ch <- retRes883315
		return nil
...
func (this *BitgetCore) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes88468 := (<-this.LoadMarkets())
		PanicOnError(retRes88468)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes89938 := (<-this.LoadMarkets())
		PanicOnError(retRes89938)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes90888 := (<-this.LoadMarkets())
		PanicOnError(retRes90888)
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes92598 := (<-this.LoadMarkets())
		PanicOnError(retRes92598)
		var currency interface{} = this.Currency(code)
		var accountsByType interface{} = this.SafeValue(this.Options, "accountsByType", map[string]interface{}{})
...
func (this *BitgetCore) FetchDepositWithdrawFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94118 := (<-this.LoadMarkets())
		PanicOnError(retRes94118)
...
func (this *BitgetCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94578 := (<-this.LoadMarkets())
		PanicOnError(retRes94578)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94928 := (<-this.LoadMarkets())
		PanicOnError(retRes94928)
		var currency interface{} = this.Currency(code)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes95688 := (<-this.LoadMarkets())
		PanicOnError(retRes95688)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin":        GetValue(currency, "id"),
			"repayAmount": this.CurrencyToPrecision(code, amount),
...
func (this *BitgetCore) FetchMyLiquidations(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes96638 := (<-this.LoadMarkets())
		PanicOnError(retRes96638)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes966719 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes966719)
			ch <- retRes966719
			return nil
		}
		var market interface{} = nil
...
func (this *BitgetCore) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes98168 := (<-this.LoadMarkets())
		PanicOnError(retRes98168)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes99358 := (<-this.LoadMarkets())
		PanicOnError(retRes99358)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin": GetValue(currency, "id"),
		}
...
func (this *BitgetCore) FetchBorrowInterest(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes100528 := (<-this.LoadMarkets())
		PanicOnError(retRes100528)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes1005619 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1005619)
			ch <- retRes1005619
			return nil
		}
		var market interface{} = nil
...
func (this *BitgetCore) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes102038 := (<-this.LoadMarkets())
		PanicOnError(retRes102038)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) CloseAllPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes102758 := (<-this.LoadMarkets())
		PanicOnError(retRes102758)
		var request interface{} = map[string]interface{}{}
		var productType interface{} = nil
		var uta interface{} = nil
		var response interface{} = nil
...
func (this *BitgetCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes103368 := (<-this.LoadMarkets())
		PanicOnError(retRes103368)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes105118 := (<-this.LoadMarkets())
		PanicOnError(retRes105118)
		var request interface{} = map[string]interface{}{
			"fromCoin":     fromCode,
			"toCoin":       toCode,
...
func (this *BitgetCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes105578 := (<-this.LoadMarkets())
		PanicOnError(retRes105578)
...
func (this *BitgetCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes106078 := (<-this.LoadMarkets())
		PanicOnError(retRes106078)
		var request interface{} = map[string]interface{}{}
		var msInDay interface{} = 86400000
		var now interface{} = this.Milliseconds()
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *BitgetCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes107858 := (<-this.LoadMarkets())
		PanicOnError(retRes107858)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchLongShortRatioHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes108518 := (<-this.LoadMarkets())
		PanicOnError(retRes108518)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
