...
func (this *BitgetCore) HandleProductTypeAndParams(optionalArgs ...any) any {
	...
	if (!IsEqual(subType, nil)) && (IsEqual(market, nil)) {
		...
		// } else {
		defaultProductType = Ternary((subType == "linear"), "USDT-FUTURES", "COIN-FUTURES")
	}
...
func (this *BitgetCore) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(uta, true) {
		...
		response = (<-this.PublicUtaGetV3MarketTickers(this.Extend(request, params)))
		PanicOnError(response)
	} else if (typeVar == "spot") && (passedSubType == nil) {
...
func (this *BitgetCore) CreateUtaOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if reduceOnly == true {
		if (IsEqual(hedged, true)) || isStopLossOrTakeProfitTrigger {
			var reduceOnlyPosSide any = Ternary((side == "sell"), "long", "short")
		...
		if IsEqual(hedged, true) {
			var posSide any = Ternary((side == "buy"), "long", "short")
...
func (this *BitgetCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if (marketType == "swap") || (marketType == "future") {
		...
		if isTrailingPercentOrder {
			...
			if IsEqual(hedged, true) {
				AddElementToObject(request, "holdSide", Ternary((side == "sell"), "long", "short"))
			} else {
				AddElementToObject(request, "holdSide", Ternary((side == "sell"), "buy", "sell"))
			}
		...
		if !isStopLossOrTakeProfitTrigger {
			...
			var marginModeRequest any = Ternary((marginMode == "cross"), "crossed", "isolated")
			...
			if reduceOnly == true {
				if !IsEqual(hedged, true) {
					...
					requestSide = Ternary((side == "buy"), "sell", "buy")
...
func (this *BitgetCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if (!IsEqual(uta, true)) && ((typeVar == "swap") || (typeVar == "future") || (!IsEqual(marginMode, nil))) {
		var clientOrderId *string = this.SafeString2(params, "clientOid", "clientOrderId")
		params = this.Omit(params, "clientOrderId")
		if clientOrderId != nil {
			AddElementToObject(request, "clientOid", clientOrderId)
...
func (this *BitgetCore) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if (marketType == "swap") || (marketType == "future") || (!IsEqual(marginMode, nil)) {
		var clientOrderId *string = this.SafeString2(params, "clientOid", "clientOrderId")
		params = this.Omit(params, "clientOrderId")
		if clientOrderId != nil {
			AddElementToObject(request, "clientOid", clientOrderId)
