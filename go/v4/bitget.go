...
func (this *BitgetCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes190912 := (<-this.LoadTimeDifference())
			PanicOnError(retRes190912)
		}
		...
		if IsTrue(uta) {
			...
			retRes191419 := (<-this.FetchUtaMarkets(params))
			PanicOnError(retRes191419)
			ch <- retRes191419
			return nil
		} else {

			retRes191619 := (<-this.FetchDefaultMarkets(params))
...
func (this *BitgetCore) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes277219 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
			PanicOnError(retRes277219)
			ch <- retRes277219
			return nil
		}
...
func (this *BitgetCore) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes289819 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
...
func (this *BitgetCore) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes30508 := (<-this.LoadMarkets())
		PanicOnError(retRes30508)
		var networkCode interface{} = nil
		networkCodeparamsVariable := this.HandleNetworkCodeAndParams(params)
		networkCode = GetValue(networkCodeparamsVariable, 0)
		params = GetValue(networkCodeparamsVariable, 1)
...
func (this *BitgetCore) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes31198 := (<-this.LoadMarkets())
		PanicOnError(retRes31198)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
...
func (this *BitgetCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes38468 := (<-this.LoadMarkets())
		PanicOnError(retRes38468)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes385019 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
			PanicOnError(retRes385019)
			ch <- retRes385019
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes39808 := (<-this.LoadMarkets())
		PanicOnError(retRes39808)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) FetchTradingFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes40258 := (<-this.LoadMarkets())
		PanicOnError(retRes40258)
		var response interface{} = nil
		var marginMode interface{} = nil
		var marketType interface{} = nil
...
func (this *BitgetCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes420219 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
			PanicOnError(retRes420219)
			ch <- retRes420219
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes43718 := (<-this.LoadMarkets())
		PanicOnError(retRes43718)
		var request interface{} = map[string]interface{}{}
		var marketType interface{} = nil
		var marginMode interface{} = nil
		var response interface{} = nil
...
func (this *BitgetCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes50078 := (<-this.LoadMarkets())
		PanicOnError(retRes50078)
		var market interface{} = this.Market(symbol)
		if !IsTrue(GetValue(market, "spot")) {
		...
		retRes501515 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
		PanicOnError(retRes501515)
		ch <- retRes501515
		return nil
...
func (this *BitgetCore) CreateUtaOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes54528 := (<-this.LoadMarkets())
		PanicOnError(retRes54528)
...
func (this *BitgetCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes55198 := (<-this.LoadMarkets())
		PanicOnError(retRes55198)
		var uta interface{} = nil
		...
		if IsTrue(uta) {
			...
			retRes552319 := (<-this.CreateUtaOrders(orders, params))
			PanicOnError(retRes552319)
			ch <- retRes552319
			return nil
		}
		var ordersRequests interface{} = []interface{}{}
...
func (this *BitgetCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58558 := (<-this.LoadMarkets())
		PanicOnError(retRes58558)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
		var response interface{} = nil
...
func (this *BitgetCore) CancelOrders(ids interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes605619 := (<-this.CancelUtaOrders(ids, symbol, params))
			PanicOnError(retRes605619)
			ch <- retRes605619
			return nil
		}
		var marginMode interface{} = nil
...
func (this *BitgetCore) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes61408 := (<-this.LoadMarkets())
		PanicOnError(retRes61408)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
...
func (this *BitgetCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes648219 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes648219)
			ch <- retRes648219
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			retRes691019 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
			PanicOnError(retRes691019)
			ch <- retRes691019
			return nil
		}

		retRes69128 := (<-this.LoadMarkets())
		PanicOnError(retRes69128)
		var market interface{} = nil
		var request interface{} = map[string]interface{}{}
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes693419 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes693419)
			ch <- retRes693419
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchUtaCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes71948 := (<-this.LoadMarkets())
		PanicOnError(retRes71948)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
		...
		if IsTrue(paginate) {
			...
			retRes721419 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes721419)
			ch <- retRes721419
			return nil
		}
		requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes73368 := (<-this.LoadMarkets())
		PanicOnError(retRes73368)
		...
		if IsTrue(paginate) {
			...
			retRes735219 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
			PanicOnError(retRes735219)
			ch <- retRes735219
			return nil
		}
		var currency interface{} = nil
...
func (this *BitgetCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes759219 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
			PanicOnError(retRes759219)
			ch <- retRes759219
			return nil
		}
		var response interface{} = nil
...
func (this *BitgetCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes77768 := (<-this.LoadMarkets())
		PanicOnError(retRes77768)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes789219 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
	...
	go func() interface{} {
		...
		if IsTrue(uta) {
			...
			if IsTrue(paginate) {
				...
				retRes834423 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
				PanicOnError(retRes834423)
				ch <- retRes834423
				return nil
			}
			if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) FetchFundingIntervals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes85728 := (<-this.LoadMarkets())
		PanicOnError(retRes85728)
		params = this.Extend(map[string]interface{}{
			"method": "publicMixGetV2MixMarketCurrentFundRate",
		}, params)

		retRes857415 := (<-this.FetchFundingRates(symbols, params))
		PanicOnError(retRes857415)
		ch <- retRes857415
		return nil
...
func (this *BitgetCore) FetchFundingHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes868819 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
			PanicOnError(retRes868819)
			ch <- retRes868819
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes87838 := (<-this.LoadMarkets())
		PanicOnError(retRes87838)
...
func (this *BitgetCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes885615 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes885615)
		ch <- retRes885615
		return nil
...
func (this *BitgetCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes887415 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes887415)
		ch <- retRes887415
		return nil
...
func (this *BitgetCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes89608 := (<-this.LoadMarkets())
		PanicOnError(retRes89608)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes90768 := (<-this.LoadMarkets())
		PanicOnError(retRes90768)
...
func (this *BitgetCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes91298 := (<-this.LoadMarkets())
		PanicOnError(retRes91298)
		var market interface{} = this.Market(symbol)
...
func (this *BitgetCore) FetchTransfers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes92408 := (<-this.LoadMarkets())
		PanicOnError(retRes92408)
		var typeVar interface{} = nil
...
func (this *BitgetCore) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes93008 := (<-this.LoadMarkets())
		PanicOnError(retRes93008)
		var currency interface{} = this.Currency(code)
		var accountsByType interface{} = this.SafeValue(this.Options, "accountsByType", map[string]interface{}{})
...
func (this *BitgetCore) FetchDepositWithdrawFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94528 := (<-this.LoadMarkets())
		PanicOnError(retRes94528)
...
func (this *BitgetCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94988 := (<-this.LoadMarkets())
		PanicOnError(retRes94988)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes95338 := (<-this.LoadMarkets())
		PanicOnError(retRes95338)
		var currency interface{} = this.Currency(code)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"coin":         GetValue(currency, "id"),
...
func (this *BitgetCore) FetchMyLiquidations(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes97048 := (<-this.LoadMarkets())
		PanicOnError(retRes97048)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes970819 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes970819)
			ch <- retRes970819
			return nil
		}
		var market interface{} = nil
...
func (this *BitgetCore) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes98578 := (<-this.LoadMarkets())
		PanicOnError(retRes98578)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) FetchBorrowInterest(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes100938 := (<-this.LoadMarkets())
		PanicOnError(retRes100938)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes1009719 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
			PanicOnError(retRes1009719)
			ch <- retRes1009719
			return nil
		}
		var market interface{} = nil
...
func (this *BitgetCore) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes102448 := (<-this.LoadMarkets())
		PanicOnError(retRes102448)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BitgetCore) CloseAllPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes103168 := (<-this.LoadMarkets())
		PanicOnError(retRes103168)
		var request interface{} = map[string]interface{}{}
		var productType interface{} = nil
		var uta interface{} = nil
		var response interface{} = nil
...
func (this *BitgetCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes103778 := (<-this.LoadMarkets())
		PanicOnError(retRes103778)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
...
func (this *BitgetCore) FetchPositionsHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes104458 := (<-this.LoadMarkets())
		PanicOnError(retRes104458)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		var productType interface{} = nil
		var uta interface{} = nil
...
func (this *BitgetCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes105988 := (<-this.LoadMarkets())
		PanicOnError(retRes105988)
...
func (this *BitgetCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes106488 := (<-this.LoadMarkets())
		PanicOnError(retRes106488)
		var request interface{} = map[string]interface{}{}
		var msInDay interface{} = 86400000
		var now interface{} = this.Milliseconds()
		if IsTrue(!IsEqual(since, nil)) {
...
func (this *BitgetCore) FetchConvertCurrencies(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes107598 := (<-this.LoadMarkets())
		PanicOnError(retRes107598)
...
func (this *BitgetCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes108268 := (<-this.LoadMarkets())
		PanicOnError(retRes108268)
		var market interface{} = this.Market(symbol)
		var productType interface{} = nil
		productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
		productType = GetValue(productTypeparamsVariable, 0)
