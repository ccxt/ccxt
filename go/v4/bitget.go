...
func (this *BitgetCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes288023 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "orderId", "cursor", nil, 100))
			PanicOnError(retRes288023)
			ch <- retRes288023
			return nil
		}

		retRes288219 := (<-this.FetchPaginatedCallCursor("fetchDeposits", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
		PanicOnError(retRes288219)
		ch <- retRes288219
		return nil
	}
...
func (this *BitgetCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes306023 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "orderId", "cursor", nil, 100))
			PanicOnError(retRes306023)
			ch <- retRes306023
			return nil
		}

		retRes306219 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", nil, since, limit, params, "idLessThan", "idLessThan", nil, 100))
		PanicOnError(retRes306219)
		ch <- retRes306219
		return nil
	}
	var currency any = nil
...
func (this *BitgetCore) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes327812 := (<-this.LoadMarkets())
		PanicOnError(retRes327812)
	}
	var uta any = nil
...
func (this *BitgetCore) fetchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes372612 := (<-this.LoadMarkets())
		PanicOnError(retRes372612)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes409012 := (<-this.LoadMarkets())
		PanicOnError(retRes409012)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes409519 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "idLessThan", "idLessThan"))
		PanicOnError(retRes409519)
		ch <- retRes409519
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes445319 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, limitForPagination))
		PanicOnError(retRes445319)
		ch <- retRes445319
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes463112 := (<-this.LoadMarkets())
		PanicOnError(retRes463112)
	}
	var request map[string]any = map[string]any{}
	var marketType any = nil
	var marginMode any = nil
...
func (this *BitgetCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes530712 := (<-this.LoadMarkets())
		PanicOnError(retRes530712)
	}
	var market any = this.Market(symbol)
	if IsTrue(!IsEqual(GetValue(market, "spot"), true)) {
	...
	retRes531615 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
	PanicOnError(retRes531615)
	ch <- retRes531615
	return nil
}
...
func (this *BitgetCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes536612 := (<-this.LoadMarkets())
		PanicOnError(retRes536612)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) createUtaOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes580012 := (<-this.LoadMarkets())
		PanicOnError(retRes580012)
	}
...
func (this *BitgetCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes587419 := (<-this.CreateUtaOrders(orders, params))
...
func (this *BitgetCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes622112 := (<-this.LoadMarkets())
		PanicOnError(retRes622112)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *BitgetCore) cancelUtaOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes636512 := (<-this.LoadMarkets())
		PanicOnError(retRes636512)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes642719 := (<-this.CancelUtaOrders(ids, symbol, params))
		PanicOnError(retRes642719)
		ch <- retRes642719
		return nil
	}
	var marginMode any = nil
...
func (this *BitgetCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes663712 := (<-this.LoadMarkets())
		PanicOnError(retRes663712)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{}
	var clientOrderId any = this.SafeString2(params, "clientOrderId", "clientOid")
...
func (this *BitgetCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes685919 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes685919)
		ch <- retRes685919
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes725812 := (<-this.LoadMarkets())
		PanicOnError(retRes725812)
	}
...
func (this *BitgetCore) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		retRes729319 := (<-this.FetchUtaCanceledAndClosedOrders(symbol, since, limit, params))
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes729612 := (<-this.LoadMarkets())
		PanicOnError(retRes729612)
	}
	var market any = nil
	var request any = map[string]any{}
	if IsTrue(!IsEqual(symbol, nil)) {
	...
	if IsTrue(paginate) {
		...
		retRes731919 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, cursorReceived, "idLessThan"))
...
func (this *BitgetCore) fetchUtaCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes758012 := (<-this.LoadMarkets())
		PanicOnError(retRes758012)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
		market = this.Market(symbol)
	...
	if IsTrue(paginate) {
		...
		retRes760119 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "cursor", "cursor"))
		PanicOnError(retRes760119)
		ch <- retRes760119
		return nil
	}
	requestparamsVariable := this.HandleUntilOption("endTime", request, params)
...
func (this *BitgetCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes772412 := (<-this.LoadMarkets())
		PanicOnError(retRes772412)
	}
	...
	if IsTrue(paginate) {
		...
		retRes774119 := (<-this.FetchPaginatedCallCursor("fetchLedger", symbol, since, limit, params, cursorReceived, "idLessThan"))
		PanicOnError(retRes774119)
		ch <- retRes774119
		return nil
	}
	var currency any = nil
...
func (this *BitgetCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes798319 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, cursorReceived, cursorSent))
		PanicOnError(retRes798319)
		ch <- retRes798319
		return nil
	}
	var response any = nil
...
func (this *BitgetCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes816812 := (<-this.LoadMarkets())
		PanicOnError(retRes816812)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes828719 := (<-this.FetchPaginatedCallCursor("fetchPositions", nil, nil, nil, params, "endId", "idLessThan"))
		PanicOnError(retRes828719)
		ch <- retRes828719
		return nil
	}
	var method any = nil
...
func (this *BitgetCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes870112 := (<-this.LoadMarkets())
		PanicOnError(retRes870112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
	...
	if IsTrue(IsEqual(uta, true)) {
		...
		if IsTrue(paginate) {
			...
			retRes874123 := (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "pageNo", 100))
			PanicOnError(retRes874123)
			ch <- retRes874123
			return nil
		}
		if IsTrue(!IsEqual(limit, nil)) {
...
func (this *BitgetCore) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes879712 := (<-this.LoadMarkets())
		PanicOnError(retRes879712)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes888912 := (<-this.LoadMarkets())
		PanicOnError(retRes888912)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
		var symbol any = this.SafeValue(symbols, 0)
...
func (this *BitgetCore) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes897412 := (<-this.LoadMarkets())
		PanicOnError(retRes897412)
	}
	params = this.Extend(map[string]any{
		"method": "publicMixGetV2MixMarketCurrentFundRate",
	}, params)

	retRes897715 := (<-this.FetchFundingRates(symbols, params))
	PanicOnError(retRes897715)
	ch <- retRes897715
	return nil
}
...
func (this *BitgetCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes908512 := (<-this.LoadMarkets())
		PanicOnError(retRes908512)
	}
	if IsTrue(IsEqual(symbol, nil)) {
	...
	if IsTrue(paginate) {
		if IsTrue(IsEqual(uta, true)) {
			...
			retRes909623 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor"))
			PanicOnError(retRes909623)
			ch <- retRes909623
			return nil
		}

		retRes909819 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "endId", "idLessThan"))
...
func (this *BitgetCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes931315 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
	PanicOnError(retRes931315)
	ch <- retRes931315
	return nil
}
...
func (this *BitgetCore) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes933115 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *BitgetCore) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes934512 := (<-this.LoadMarkets())
		PanicOnError(retRes934512)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes942012 := (<-this.LoadMarkets())
		PanicOnError(retRes942012)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes949612 := (<-this.LoadMarkets())
		PanicOnError(retRes949612)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes959512 := (<-this.LoadMarkets())
		PanicOnError(retRes959512)
	}
	var market any = this.Market(symbol)
...
func (this *BitgetCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes970812 := (<-this.LoadMarkets())
		PanicOnError(retRes970812)
	}
	var typeVar any = nil
...
func (this *BitgetCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes993512 := (<-this.LoadMarkets())
		PanicOnError(retRes993512)
	}
...
func (this *BitgetCore) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1002012 := (<-this.LoadMarkets())
		PanicOnError(retRes1002012)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1006012 := (<-this.LoadMarkets())
		PanicOnError(retRes1006012)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *BitgetCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1010012 := (<-this.LoadMarkets())
...
func (this *BitgetCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1019712 := (<-this.LoadMarkets())
		PanicOnError(retRes1019712)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1020219 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1020219)
		ch <- retRes1020219
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) fetchIsolatedBorrowRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1035212 := (<-this.LoadMarkets())
		PanicOnError(retRes1035212)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1047312 := (<-this.LoadMarkets())
		PanicOnError(retRes1047312)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"coin": GetValue(currency, "id"),
...
func (this *BitgetCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1059212 := (<-this.LoadMarkets())
		PanicOnError(retRes1059212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes1059719 := (<-this.FetchPaginatedCallCursor("fetchBorrowInterest", symbol, since, limit, params, "minId", "idLessThan"))
		PanicOnError(retRes1059719)
		ch <- retRes1059719
		return nil
	}
	var market any = nil
...
func (this *BitgetCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1074512 := (<-this.LoadMarkets())
		PanicOnError(retRes1074512)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BitgetCore) closeAllPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1081912 := (<-this.LoadMarkets())
		PanicOnError(retRes1081912)
	}
	var request map[string]any = map[string]any{}
	var productType any = nil
	var uta any = nil
...
func (this *BitgetCore) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1088212 := (<-this.LoadMarkets())
		PanicOnError(retRes1088212)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1095212 := (<-this.LoadMarkets())
		PanicOnError(retRes1095212)
	}
	var request any = map[string]any{}
	var market any = nil
	var productType any = nil
...
func (this *BitgetCore) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1106112 := (<-this.LoadMarkets())
		PanicOnError(retRes1106112)
	}
	var request map[string]any = map[string]any{
		"fromCoin":     fromCode,
		"toCoin":       toCode,
...
func (this *BitgetCore) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1110912 := (<-this.LoadMarkets())
		PanicOnError(retRes1110912)
	}
...
func (this *BitgetCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1127412 := (<-this.LoadMarkets())
		PanicOnError(retRes1127412)
	}
...
func (this *BitgetCore) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1134512 := (<-this.LoadMarkets())
		PanicOnError(retRes1134512)
	}
	var market any = this.Market(symbol)
	var productType any = nil
	productTypeparamsVariable := this.HandleProductTypeAndParams(market, params)
...
func (this *BitgetCore) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes1141312 := (<-this.LoadMarkets())
		PanicOnError(retRes1141312)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
