...
func  (this *cex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes103615 :=  (<-this.FetchOrdersByStatus("closed", symbol, since, limit, params))
...
func  (this *cex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes105115 :=  (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
                PanicOnError(retRes105115)
                ch <- retRes105115
                return nil
