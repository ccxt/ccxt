...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes527309 := (<-this.LoadMarkets())
            PanicOnError(retRes527309)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814475 := (<-this.LoadMarkets())
            PanicOnError(retRes814475)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes769270 := (<-this.LoadMarkets())
            PanicOnError(retRes769270)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes864105 := (<-this.LoadMarkets())
            PanicOnError(retRes864105)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes386427 := (<-this.LoadMarkets())
            PanicOnError(retRes386427)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes557860 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes557860)
                    ch <- retRes557860
                    return nil
            }
        
            retRes890845 := (<-this.LoadMarkets())
            PanicOnError(retRes890845)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33711 := (<-this.LoadMarkets())
            PanicOnError(retRes33711)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes209184 := (<-this.LoadMarkets())
            PanicOnError(retRes209184)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes311502 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes311502)
                    ch <- retRes311502
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes306502 := (<-this.LoadMarkets())
            PanicOnError(retRes306502)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes68443 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes68443)
                ch <- retRes68443
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes823548 := (<-this.LoadMarkets())
            PanicOnError(retRes823548)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes765340 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes765340)
                    ch <- retRes765340
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes595806 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes595806)
                ch <- retRes595806
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes222799 := (<-this.LoadMarkets())
            PanicOnError(retRes222799)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes243027 := (<-this.LoadMarkets())
            PanicOnError(retRes243027)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes196265 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes196265)
                ch <- retRes196265
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes610496 := (<-this.LoadMarkets())
            PanicOnError(retRes610496)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes256011 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes256011)
                ch <- retRes256011
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes243347 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes243347)
                ch <- retRes243347
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes414721 := (<-this.LoadMarkets())
            PanicOnError(retRes414721)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes776922 := (<-this.LoadMarkets())
            PanicOnError(retRes776922)
        
            retRes191358 := (<-this.LoadAccounts())
            PanicOnError(retRes191358)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes173316 := (<-this.LoadMarkets())
            PanicOnError(retRes173316)
        
            retRes740767 := (<-this.LoadAccounts())
            PanicOnError(retRes740767)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes98605 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes98605)
                ch <- retRes98605
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes846857 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes846857)
                ch <- retRes846857
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40630 := (<-this.LoadMarkets())
            PanicOnError(retRes40630)
            var currency interface{} = this.Currency(code)
