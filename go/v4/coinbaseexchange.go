...
func (this *CoinbaseexchangeCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes110819 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
			PanicOnError(retRes110819)
			ch <- retRes110819
			return nil
		}
		if IsTrue(IsEqual(this.Markets, nil)) {
...
func (this *CoinbaseexchangeCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes124819 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
			PanicOnError(retRes124819)
			ch <- retRes124819
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *CoinbaseexchangeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes146815 := (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes146815)
		ch <- retRes146815
		return nil
...
func (this *CoinbaseexchangeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes149119 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
...
func (this *CoinbaseexchangeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes153015 := (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes153015)
		ch <- retRes153015
		return nil
...
func (this *CoinbaseexchangeCore) FetchPaymentMethods(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes168915 := (<-this.PrivateGetPaymentMethods(params))
		PanicOnError(retRes168915)
		ch <- retRes168915
		return nil
...
func (this *CoinbaseexchangeCore) FetchDepositsWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes188812 := (<-this.LoadMarkets())
			PanicOnError(retRes188812)
		}

		retRes18908 := (<-this.LoadAccounts())
...
func (this *CoinbaseexchangeCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes199615 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any{
			"type": "deposit",
		}, params)))
		PanicOnError(retRes199615)
		ch <- retRes199615
		return nil
...
func (this *CoinbaseexchangeCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes201215 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any{
			"type": "withdraw",
		}, params)))
