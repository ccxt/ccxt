...
func  (this *CoinbaseexchangeCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes109019 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes109019)
                    ch <- retRes109019
                    return nil
            }
...
func  (this *CoinbaseexchangeCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes122219 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes122219)
                    ch <- retRes122219
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *CoinbaseexchangeCore) FetchOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes143815 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes143815)
                ch <- retRes143815
                return nil
...
func  (this *CoinbaseexchangeCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes145919 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
...
func  (this *CoinbaseexchangeCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes149815 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes149815)
                ch <- retRes149815
                return nil
...
func  (this *CoinbaseexchangeCore) FetchPaymentMethods(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes165115 :=  (<-this.PrivateGetPaymentMethods(params))
...
func  (this *CoinbaseexchangeCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes195215 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes195215)
                ch <- retRes195215
                return nil
...
func  (this *CoinbaseexchangeCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes196815 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes196815)
                ch <- retRes196815
                return nil
