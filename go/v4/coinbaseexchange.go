...
func (this *CoinbaseexchangeCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes110919 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
			PanicOnError(retRes110919)
			ch <- retRes110919
			return nil
		}
		if IsTrue(IsEqual(this.Markets, nil)) {
...
func (this *CoinbaseexchangeCore) FetchTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes118012 := (<-this.LoadMarkets())
			PanicOnError(retRes118012)
		}
...
func (this *CoinbaseexchangeCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes124919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
			PanicOnError(retRes124919)
			ch <- retRes124919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *CoinbaseexchangeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes146915 := (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *CoinbaseexchangeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes149219 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
			PanicOnError(retRes149219)
			ch <- retRes149219
			return nil
		}
		var request any = map[string]any{}
...
func (this *CoinbaseexchangeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes153115 := (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *CoinbaseexchangeCore) FetchPaymentMethods(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes169015 := (<-this.PrivateGetPaymentMethods(params))
		PanicOnError(retRes169015)
		ch <- retRes169015
		return nil
...
func (this *CoinbaseexchangeCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes200015 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any{
			"type": "deposit",
		}, params)))
		PanicOnError(retRes200015)
		ch <- retRes200015
		return nil
...
func (this *CoinbaseexchangeCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes201615 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any{
			"type": "withdraw",
		}, params)))
