...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes10341 := (<-this.LoadMarkets())
            PanicOnError(retRes10341)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes368623 := (<-this.LoadMarkets())
            PanicOnError(retRes368623)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes475226 := (<-this.LoadMarkets())
            PanicOnError(retRes475226)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277698 := (<-this.LoadMarkets())
            PanicOnError(retRes277698)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes480905 := (<-this.LoadMarkets())
            PanicOnError(retRes480905)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes991119 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes991119)
                    ch <- retRes991119
                    return nil
            }
        
            retRes726258 := (<-this.LoadMarkets())
            PanicOnError(retRes726258)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes338153 := (<-this.LoadMarkets())
            PanicOnError(retRes338153)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes950668 := (<-this.LoadMarkets())
            PanicOnError(retRes950668)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes679083 := (<-this.LoadMarkets())
            PanicOnError(retRes679083)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes906018 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes906018)
                    ch <- retRes906018
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes28590 := (<-this.LoadMarkets())
            PanicOnError(retRes28590)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes809553 := (<-this.LoadMarkets())
            PanicOnError(retRes809553)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes403843 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes403843)
                ch <- retRes403843
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes165537 := (<-this.LoadMarkets())
            PanicOnError(retRes165537)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes63343 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes63343)
                    ch <- retRes63343
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes286623 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes286623)
                ch <- retRes286623
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78302 := (<-this.LoadMarkets())
            PanicOnError(retRes78302)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes836828 := (<-this.LoadMarkets())
            PanicOnError(retRes836828)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes727423 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes727423)
                ch <- retRes727423
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes145846 := (<-this.LoadMarkets())
            PanicOnError(retRes145846)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes253977 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes253977)
                ch <- retRes253977
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes143798 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes143798)
                ch <- retRes143798
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes74310 := (<-this.LoadMarkets())
            PanicOnError(retRes74310)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes595443 := (<-this.LoadMarkets())
            PanicOnError(retRes595443)
        
            retRes545590 := (<-this.LoadAccounts())
            PanicOnError(retRes545590)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes325836 := (<-this.LoadMarkets())
            PanicOnError(retRes325836)
        
            retRes183285 := (<-this.LoadAccounts())
            PanicOnError(retRes183285)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes230017 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes230017)
                ch <- retRes230017
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes932725 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes932725)
                ch <- retRes932725
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes334455 := (<-this.LoadMarkets())
            PanicOnError(retRes334455)
            var currency interface{} = this.Currency(code)
