...
func (this *CoinbaseexchangeCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes110419 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
			PanicOnError(retRes110419)
			ch <- retRes110419
			return nil
		}
		if IsTrue(IsEqual(this.Markets, nil)) {
...
func (this *CoinbaseexchangeCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes124419 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
			PanicOnError(retRes124419)
			ch <- retRes124419
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *CoinbaseexchangeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes146415 := (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes146415)
		ch <- retRes146415
		return nil
...
func (this *CoinbaseexchangeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes148719 := (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
			PanicOnError(retRes148719)
			ch <- retRes148719
			return nil
		}
		var request any = map[string]any{}
...
func (this *CoinbaseexchangeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes152615 := (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes152615)
		ch <- retRes152615
		return nil
...
func (this *CoinbaseexchangeCore) FetchPaymentMethods(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes168515 := (<-this.PrivateGetPaymentMethods(params))
		PanicOnError(retRes168515)
		ch <- retRes168515
		return nil
...
func (this *CoinbaseexchangeCore) FetchDepositsWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes188412 := (<-this.LoadMarkets())
			PanicOnError(retRes188412)
		}

		retRes18868 := (<-this.LoadAccounts())
...
func (this *CoinbaseexchangeCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes199215 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any{
			"type": "deposit",
		}, params)))
		PanicOnError(retRes199215)
		ch <- retRes199215
		return nil
...
func (this *CoinbaseexchangeCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes200815 := (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any{
			"type": "withdraw",
		}, params)))
