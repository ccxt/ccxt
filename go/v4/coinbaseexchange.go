...
func (this *Coinbaseexchange) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes113519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params, 100))))
		ch <- BoxAbsent(retRes113519)
		return nil
	}
	if this.Markets == nil {
...
func (this *Coinbaseexchange) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if since != nil {
		...
		if limit == nil {
			...
			limit = Int64PtrTyped(300) // max = 300
		} else {
			limit = Int64PtrTyped(mathMin(300, limit))
		}
		if IsEqual(until, nil) {
			...
			if this.IsRoundNumber(Mod(since, parsedTimeframeMilliseconds)) {
				request["end"] = this.Iso8601(this.Sum(Multiply((Subtract(limit, 1)), parsedTimeframeMilliseconds), since))
			} else {
				request["end"] = this.Iso8601(this.Sum(Multiply(limit, parsedTimeframeMilliseconds), since))
			}
		} else {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetProductsIdCandles(this.Extend(request, params))).Raw))
...
func (this *Coinbaseexchange) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes149415 []any = ListTyped(PanicOnError((<-this.FetchOpenOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes149415)
	return nil
}
...
func (this *Coinbaseexchange) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes151719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchOpenOrders", symbol, since, limit, params, 100))))
		ch <- BoxAbsent(retRes151719)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market map[string]any = nil
...
func (this *Coinbaseexchange) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes155615 []any = ListTyped(PanicOnError((<-this.FetchOpenOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes155615)
	return nil
}
...
func (this *Coinbaseexchange) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(typeVar, "limit") {
		...
		if IsEqual(cost, nil) {
			...
			params = MapTyped(this.Omit(params, []any{"cost", "funds"}))
		}
		if !IsEqual(cost, nil) {
...
func (this *Coinbaseexchange) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if clientOrderId == nil {
		...
		response = (<-this.PrivateDeleteOrdersId(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.PrivateDeleteOrdersClientClientOid(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
...
func (this *Coinbaseexchange) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetAccountsIdLedger(this.Extend(request, params))).Raw))
...
func (this *Coinbaseexchange) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes202615 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(map[string]any{
		"type": "deposit",
	}, params)))))
	ch <- BoxAbsent(retRes202615)
	return nil
}
...
func (this *Coinbaseexchange) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes204215 []any = ListTyped(PanicOnError((<-this.FetchDepositsWithdrawalsAsync(code, since, limit, this.Extend(map[string]any{
		"type": "withdraw",
	}, params)))))
	ch <- BoxAbsent(retRes204215)
	return nil
}
func (this *Coinbaseexchange) ParseTransactionStatus(transaction any) string {
	...
	if (!IsEqual(canceled, nil)) && (!IsEqual(canceled, nil)) {
		return "canceled"
	}
	var processed any = this.SafeValue(transaction, "processed_at")
	var completed any = this.SafeValue(transaction, "completed_at")
	if (!IsEqual(completed, nil)) && (!IsEqual(completed, nil)) {
		return "ok"
	} else if (!IsEqual(processed, nil)) && (!IsEqual(processed, nil)) {
		return "failed"
	} else {
		return "pending"
	}
