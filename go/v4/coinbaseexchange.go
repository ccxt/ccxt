...
func  (this *CoinbaseexchangeCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes108419 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
...
func  (this *CoinbaseexchangeCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes121619 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
...
func  (this *CoinbaseexchangeCore) FetchOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes143215 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes143215)
                ch <- retRes143215
                return nil
...
func  (this *CoinbaseexchangeCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes145319 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes145319)
                    ch <- retRes145319
                    return nil
            }
            var request any = map[string]any {}
...
func  (this *CoinbaseexchangeCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes149215 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes149215)
                ch <- retRes149215
                return nil
...
func  (this *CoinbaseexchangeCore) FetchPaymentMethods(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes164515 :=  (<-this.PrivateGetPaymentMethods(params))
...
func  (this *CoinbaseexchangeCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes194615 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any {
                "type": "deposit",
            }, params)))
...
func  (this *CoinbaseexchangeCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes196215 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]any {
                "type": "withdraw",
            }, params)))
