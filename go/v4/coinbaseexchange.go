...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes512547 := (<-this.LoadMarkets())
            PanicOnError(retRes512547)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes136570 := (<-this.LoadMarkets())
            PanicOnError(retRes136570)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909467 := (<-this.LoadMarkets())
            PanicOnError(retRes909467)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes656280 := (<-this.LoadMarkets())
            PanicOnError(retRes656280)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes413815 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes413815)
                    ch <- retRes413815
                    return nil
            }
        
            retRes546915 := (<-this.LoadMarkets())
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493704 := (<-this.LoadMarkets())
            PanicOnError(retRes493704)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes655853 := (<-this.LoadMarkets())
            PanicOnError(retRes655853)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes111080 := (<-this.LoadMarkets())
            PanicOnError(retRes111080)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes101168 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792913 := (<-this.LoadMarkets())
            PanicOnError(retRes792913)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes788616 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes788616)
                ch <- retRes788616
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes571164 := (<-this.LoadMarkets())
            PanicOnError(retRes571164)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes405770 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes405770)
                    ch <- retRes405770
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes567622 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes567622)
                ch <- retRes567622
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes516719 := (<-this.LoadMarkets())
            PanicOnError(retRes516719)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes480209 := (<-this.LoadMarkets())
            PanicOnError(retRes480209)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes80252 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes80252)
                ch <- retRes80252
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes481180 := (<-this.LoadMarkets())
            PanicOnError(retRes481180)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes817214 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes817214)
                ch <- retRes817214
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes976131 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes976131)
                ch <- retRes976131
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes505488 := (<-this.LoadMarkets())
            PanicOnError(retRes505488)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319293 := (<-this.LoadMarkets())
            PanicOnError(retRes319293)
        
            retRes889598 := (<-this.LoadAccounts())
            PanicOnError(retRes889598)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes562047 := (<-this.LoadMarkets())
            PanicOnError(retRes562047)
        
            retRes642426 := (<-this.LoadAccounts())
            PanicOnError(retRes642426)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes721117 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes721117)
                ch <- retRes721117
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes692253 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes692253)
                ch <- retRes692253
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes392413 := (<-this.LoadMarkets())
            PanicOnError(retRes392413)
            var currency interface{} = this.Currency(code)
