...
func  (this *deribit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes13448 := (<-this.LoadMarkets())
            PanicOnError(retRes13448)
...
func  (this *deribit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes144119 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 5000))
                    PanicOnError(retRes144119)
                    ch <- retRes144119
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *deribit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes30768 := (<-this.LoadMarkets())
            PanicOnError(retRes30768)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
                "address": address,
...
func  (this *deribit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes321319 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, eachItemDuration, this.Extend(params, map[string]interface{} {
...
func  (this *deribit) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes332619 :=  (<-this.FetchPaginatedCallCursor("fetchLiquidations", symbol, since, limit, params, "continuation", "continuation", nil))
                    PanicOnError(retRes332619)
                    ch <- retRes332619
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *deribit) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes34868 := (<-this.LoadMarkets())
            PanicOnError(retRes34868)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
