...
func (this *Deribit) SafeMarket(optionalArgs ...any) any {
	...
	_ = marketType
	var isOption bool = (!IsEqual(marketId, nil)) && ((EndsWith(marketId, "-C")) || (EndsWith(marketId, "-P")))
...
func (this *Deribit) fetchStatusBody(ch chan any, optionalArgs ...any) any {
	...
	ch <- map[string]any{
		"status":  Ternary((locked != nil && *locked == "false"), "ok", "maintenance"),
		"updated": updateTime,
		"eta":     nil,
		"url":     nil,
		"info":    response,
...
func (this *Deribit) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(instrumentsResponses)); i++ {
		...
		for k := 0; IsLessThan(k, GetArrayLength(instrumentsResult)); k++ {
			...
			var future bool = !swap && (IsGreaterThanOrEqual(GetIndexOf(kind, "future"), 0))
			if kind == nil {
				panic(ExchangeError(Add(this.Id, " method() missing kind")))
			}
			...
			if isSpot {
				...
				if option || future {
					...
					if option {
						...
						var letter string = Ternary((IsEqual(optionType, "call")), "C", "P").(string)
...
func (this *Deribit) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if liquidity != nil {
		...
		takerOrMaker = Ternary((liquidity != nil && *liquidity == "M"), "maker", "taker")
	}
...
func (this *Deribit) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response any = nil
	if (IsEqual(since, nil)) && !(InOp(request, "end_timestamp")) {
...
func (this *Deribit) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if isTrailingAmountOrder {
		...
		var triggerPrice any = Ternary((!IsEqual(stopLossPrice, nil)), stopLossPrice, takeProfitPrice)
...
func (this *Deribit) ParseTransfer(transfer any, optionalArgs ...any) any {
	...
	return map[string]any{
		...
		"fromAccount": Ternary((direction == nil || *direction != "payment"), account, nil),
		"toAccount":   Ternary((direction != nil && *direction == "payment"), account, nil),
		"timestamp":   timestamp,
		"datetime":    this.Iso8601(timestamp),
	}
}
