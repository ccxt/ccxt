...
func (this *Extended) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < len(data); i++ {
		var marketData map[string]any = SafeMapTyped(data, i)
...
func (this *Extended) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes100119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes100119)
		return nil
	}
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetUserTrades(this.Extend(params, request))).Raw))
	//
	//     {
	//         "status": "OK",
	//         "data": [
...
func (this *Extended) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes107119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "cursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes107119)
		return nil
	}
	var market map[string]any = nil
	var request map[string]any = map[string]any{}
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetUserFundingHistory(this.Extend(params, request))).Raw))
	//
	//     {
	//         "status": "OK",
	//         "data": [
...
func (this *Extended) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"candleType", "price", "until"}))
	var request map[string]any = map[string]any{
		"market":     market["id"],
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetInfoCandlesMarketCandleType(this.Extend(request, params))).Raw))
	//
	//     {
	//       "status": "OK",
	//       "data": [
...
func (this *Extended) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes133519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchFundingRateHistory", symbol, since, limit, params, "cursor", "cursor", nil, 10000))))
		ch <- BoxAbsent(retRes133519)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetInfoMarketFunding(this.Extend(request, params))).Raw))
	//
	//     {
	//       "status": "OK",
	//       "data": [
...
func (this *Extended) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PublicGetInfoMarketOpenInterests(this.Extend(request, params))).Raw))
	//
	//     {
	//       "status": "OK",
	//       "data": [
...
func (this *Extended) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes164219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchLedger", code, since, limit, params, "cursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes164219)
		return nil
	}
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetUserAssetOperations(this.Extend(request, params))).Raw))
	var data []any = SafeListTyped(response, "data")
	var pagination map[string]any = SafeMapTyped(response, "pagination")
	var cursor *string = this.SafeString(pagination, "cursor")
	var result []any = []any{}
...
func (this *Extended) ParseLedgerEntry(item any, optionalArgs ...any) any {
	...
	var ledgerCurrency map[string]any = this.SafeCurrency(code, currency)
...
func (this *Extended) fetchTransactionsBody(ch chan any, optionalArgs ...any) any {
	...
	PanicOnError((<-this.LoadMarketsAsync()))
	var paginate bool = false
	var paginateparamsVariable []any = this.HandleOptionBoolAndParams(params, "fetchTransactions", "paginate", false)
	paginate = GetValueBool(paginateparamsVariable, 0, false)
	params = MapTyped(GetValue(paginateparamsVariable, 1))
	if paginate {

		var retRes173519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchTransactions", code, since, limit, params, "cursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes173519)
		return nil
	}
	var currency map[string]any = nil
	if code != nil {
...
func (this *Extended) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes179615 []any = ListTyped(PanicOnError((<-this.FetchTransactionsAsync(code, since, limit, this.Extend(map[string]any{
		"type": "DEPOSIT",
	}, params)))))
	ch <- BoxAbsent(retRes179615)
	return nil
}
...
func (this *Extended) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes181215 []any = ListTyped(PanicOnError((<-this.FetchTransactionsAsync(code, since, limit, this.Extend(map[string]any{
		"type": "WITHDRAWAL",
	}, params)))))
	ch <- BoxAbsent(retRes181215)
	return nil
}
...
func (this *Extended) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"chainId", "network", "settlementExpiration", "nonce", "recipient", "positionId", "l2Vault", "collateralId", "resolution"}))

	response := (<-this.V1PrivatePostUserWithdrawal(this.Extend(request, params))).Raw
...
func (this *Extended) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes190119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchTransfers", code, since, limit, params, "cursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes190119)
		return nil
	}
	var currency map[string]any = nil
	if code != nil {
...
func (this *Extended) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsEqual(fromAccount, nil) {
		...
		panic(BadRequest(this.Id + " transfer() can only transfer from the authenticated account"))
	}
	...
	params = MapTyped(this.Omit(params, []any{"fromVault", "senderPositionId", "fromL2Key", "senderPublicKey", "toVault", "receiverPositionId", "toL2Key", "receiverPublicKey", "settlementExpiration", "nonce", "assetId", "collateralId", "resolution"}))

	response := (<-this.V1PrivatePostUserTransfer(this.Extend(request, params))).Raw
	PanicOnError(response)
	//
	//     {
	//         "status": "OK",
...
func (this *Extended) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var paginate bool = false
	var paginateparamsVariable []any = this.HandleOptionBoolAndParams(params, "fetchPositionsHistory", "paginate", false)
	paginate = GetValueBool(paginateparamsVariable, 0, false)
	params = MapTyped(GetValue(paginateparamsVariable, 1))
	if paginate {

		var retRes238719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchPositionsHistory", symbols, since, limit, params, "cursor", "cursor", nil, 10000))))
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetUserPositionsHistory(this.Extend(request, params))).Raw))
	//
	//     {
	//         "status": "OK",
	//         "data": [
...
func (this *Extended) GetExtendedStarkAmount(amount any, resolution any, optionalArgs ...any) any {
	var roundUp bool = GetArgBool(optionalArgs, 0, false)
	_ = roundUp
	...
	if (roundUp == true) && Precise.StringGt(precise, result) {
...
func (this *Extended) CreateWithdrawalSettlementData(address any, amountString any, currency any, account any, optionalArgs ...any) any {
	...
	if (positionId == nil) || (collateralId == nil) || (resolution == nil) || (starkKey == nil) {
		panic(BadRequest(this.Id + " withdraw() requires currency starkexId/starkexResolution, account l2Vault and account l2Key"))
	}
...
func (this *Extended) CreateTransferSettlementData(amountString any, currency any, account any, toVault any, toL2Key any, optionalArgs ...any) any {
	...
	if (fromVault == nil) || (fromL2Key == nil) || (collateralId == nil) || (resolution == nil) {
		panic(BadRequest(this.Id + " transfer() requires currency starkexId/starkexResolution, account l2Vault and account l2Key"))
	}
...
func (this *Extended) createExtendedOrderRequestBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if (syntheticId == nil) || (collateralId == nil) || (syntheticResolution == nil) || (collateralResolution == nil) {
		panic(BadRequest(this.Id + " createOrder() requires l2Config in market info"))
	}
	...
	var settlement map[string]any = MapTyped(this.CreateOrderSettlementData(isBuy, amountString, priceString, settlementParams))
	request["settlement"] = map[string]any{
	...
	if hasStopLoss || hasTakeProfit {
		...
		if hasStopLoss {
			...
			var stopLossSettlement map[string]any = MapTyped(this.CreateOrderSettlementData(!isBuy, amountString, stopLossExecutionPrice, settlementParams))
			var requestStopLoss map[string]any = map[string]any{
				...
				"settlement": map[string]any{
					"signature": map[string]any{
						"r": stopLossSettlement["r"],
						"s": stopLossSettlement["s"],
					},
					"starkKey":           starkKey,
					"collateralPosition": collateralPosition,
				},
		...
		if hasTakeProfit {
			...
			var takeProfitSettlement map[string]any = MapTyped(this.CreateOrderSettlementData(!isBuy, amountString, takeProfitExecutionPrice, settlementParams))
...
func (this *Extended) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var extendedOrderRequest map[string]any = MapTyped(PanicOnError((<-this.CreateExtendedOrderRequestAsync(symbol, typeVar, side, amount, price, requestParams))))
	var request map[string]any = MapTyped(this.SafeDict(extendedOrderRequest, "request", map[string]any{}))
...
func (this *Extended) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	var clientOrderId *string = this.SafeString2(params, "clientOrderId", "client_id")
	params = MapTyped(this.Omit(params, []any{"clientOrderIds", "client_order_ids", "clientOrderId", "client_id", "externalOrderIds", "external_order_ids", "orderIds", "order_ids", "markets", "cancelAll", "cancel_all"}))
	var request map[string]any = map[string]any{}
...
func (this *Extended) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes322419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))))
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V1PrivateGetUserOrdersHistory(this.Extend(params, request))).Raw))
	//
	//     {
	//       "status": "OK",
	//       "data": [
...
func (this *Extended) GetExtendedSignatureHex(signature any) any {
	...
	if func() int {
		...
		return strings.Index(*signatureString, "0x")
	}() == 0 {
...
func (this *Extended) Sign(path any, optionalArgs ...any) any {
	...
	if accessibility != nil && *accessibility == "private" {
		...
		if IsEqual(this.ApiKey, nil) {
			panic(AuthenticationError(this.Id + " sign() requires an apiKey for private endpoints"))
		}
...
func (this *Extended) FetchAccount(params ...any) (Account, error) {
	var res AsyncResult[Account] = AwaitResult(NewAccount, this.FetchAccountAsync(params...))
	if res.Err != nil {
...
func (this *Extended) SetLeverage(leverage int64, options ...SetLeverageOptions) (Leverage, error) {
	...
	var res AsyncResult[Leverage] = AwaitResult(NewLeverage, this.SetLeverageAsync(leverage, opts.Symbol, opts.Params))
	if res.Err != nil {
		return Leverage{}, res.Err
	}
	return res.Value, nil
...
func (this *Extended) FetchExtendedAccount(params ...any) (map[string]any, error) {
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchExtendedAccountAsync(params...))
	if res.Err != nil {
...
func (this *Extended) CreateExtendedOrderRequest(symbol string, typeVar string, side string, amount float64, options ...CreateExtendedOrderRequestOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.CreateExtendedOrderRequestAsync(symbol, typeVar, side, amount, opts.Price, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value, nil
