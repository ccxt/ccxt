...
func (this *ExtendedCore) createExtendedOrderRequestBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "spot")) && (uppercaseType != "LIMIT") {
...
func (this *ExtendedCore) Sign(path any, optionalArgs ...any) any {
	...
	if (IsEqual(method, "GET") || IsEqual(method, "DELETE") || queryPost) && EvalTruthy(GetArrayLength(ObjectKeys(query))) {
