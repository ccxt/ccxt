...
func NewArzinjaCore() *arzinja {
    p := &arzinja{}
    setDefaults(p)
    return p
}

func  (this *arzinja) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "urls": map[string]interface{} {
            ...
            "doc": []interface{}{"https://arzinja.info"},
        },
        "api": map[string]interface{} {
...
func  (this *arzinja) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
...
func  (this *arzinja) ParseMarket(market interface{}) interface{}  {
    // {
    // id: 1,
    // sell_price: 29839.1,
    // buy_price: 28965.2,
...
func  (this *arzinja) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *arzinja) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *arzinja) ParseTicker(ticker interface{}, optionalArgs ...interface{}) interface{}  {
    // {
    // id: 1,
    // sell_price: 29839.1,
    // buy_price: 28965.2,
    ...
    var bid interface{} = this.SafeFloat(ticker, "buy_price", 0)
    var ask interface{} = this.SafeFloat(ticker, "sell_price", 0)
    var last interface{} = this.SafeFloat(ticker, "sell_price", 0)
...
func  (this *arzinja) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
...
func (this *arzinja) Init(userConfig map[string]interface{}) {
