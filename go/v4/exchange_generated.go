...
func (this *BaseExchange) WatchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "watchLiquidationsForSymbols")) {
			...
			retRes348019 := (<-this.WatchLiquidationsForSymbols([]any{symbol}, since, limit, params))
			PanicOnError(retRes348019)
			ch <- retRes348019
			return nil
		}
...
func (this *BaseExchange) WatchFundingRatesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes370015 := (<-this.WatchFundingRates(symbols, params))
...
func (this *BaseExchange) Fetch2(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(this.EnableRateLimit) {
			...
			retRes610312 := (<-this.Throttle(cost))
								...
								if IsTrue(IsInstance(e, OperationFailed)) {
									if IsTrue(IsLessThan(i, retries)) {
										...
										if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
											...
											retRes614028 := (<-this.Sleep(retryDelay))
											PanicOnError(retRes614028)
										}
									} else {
										panic(e)
									}
...
func (this *BaseExchange) Request(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes615415 := (<-this.Fetch2(path, api, method, params, headers, body, config))
		PanicOnError(retRes615415)
		ch <- retRes615415
		return nil
...
func (this *BaseExchange) FetchFreeBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes637615 := (<-this.FetchPartialBalance("free", params))
		PanicOnError(retRes637615)
		ch <- retRes637615
		return nil
...
func (this *BaseExchange) FetchUsedBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes638015 := (<-this.FetchPartialBalance("used", params))
		PanicOnError(retRes638015)
		ch <- retRes638015
		return nil
...
func (this *BaseExchange) FetchTotalBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes638415 := (<-this.FetchPartialBalance("total", params))
		PanicOnError(retRes638415)
		ch <- retRes638415
		return nil
...
func (this *BaseExchange) FetchTransactionFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes639515 := (<-this.FetchTransactionFees([]any{code}, params))
		PanicOnError(retRes639515)
		ch <- retRes639515
		return nil
...
func (this *BaseExchange) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes64238 := (<-this.LoadMarkets())
		PanicOnError(retRes64238)
...
func (this *BaseExchange) FetchPositionADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPositionsADLRank")) {
			...
			retRes666112 := (<-this.LoadMarkets())
			PanicOnError(retRes666112)
...
func (this *BaseExchange) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingRates")) {
			...
			retRes748612 := (<-this.LoadMarkets())
			PanicOnError(retRes748612)
...
func (this *BaseExchange) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
			...
			retRes750612 := (<-this.LoadMarkets())
			PanicOnError(retRes750612)
...
func (this *BaseExchange) FetchMarkOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
			...
			retRes754019 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes754019)
			ch <- retRes754019
			return nil
		} else {
...
func (this *BaseExchange) FetchIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
			...
			retRes756219 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func (this *BaseExchange) FetchPremiumIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
			...
			retRes758419 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes758419)
			ch <- retRes758419
			return nil
		} else {
...
func (this *BaseExchange) FetchTransactions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
			...
			retRes779719 := <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
			PanicOnError(retRes779719)
			ch <- retRes779719
			return nil
		} else {
...

			{
				func(this *BaseExchange) (ret_ any) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes794327 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes794327)
						ch <- retRes794327
						return nil
					} else {

						retRes794527 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes794527)
						ch <- retRes794527
						return nil
					}
...
func (this *BaseExchange) LoadMarketsAndSignIn() <-chan any {
	...
	go func() any {
		...
		retRes84298 := (<-promiseAll([]any{this.LoadMarkets(), <-this.callInternal("signIn")}))
		PanicOnError(retRes84298)
		return nil
	}()
	return ch
}
...
func (this *Exchange) FetchMarkPrice(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkPrices")) {
			...
			retRes877712 := (<-this.LoadMarkets())
			PanicOnError(retRes877712)
...
func (this *Exchange) CreateLimitBuyOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes884915 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "buy", amount, price, params)
		PanicOnError(retRes884915)
		ch <- retRes884915
		return nil
...
func (this *Exchange) CreateLimitOrderWs(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes885315 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateLimitSellOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes885715 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "sell", amount, price, params)
...
func (this *Exchange) CreateMarketBuyOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes886115 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes886115)
		ch <- retRes886115
		return nil
...
func (this *Exchange) CreateMarketOrderWithCostWs(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
			...
			retRes887619 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, cost, 1, params)
			PanicOnError(retRes887619)
			ch <- retRes887619
			return nil
		}
...
func (this *Exchange) CreateMarketOrderWs(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes888215 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, price, params)
		PanicOnError(retRes888215)
		ch <- retRes888215
		return nil
...
func (this *Exchange) CreateMarketSellOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes888615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes888615)
		ch <- retRes888615
		return nil
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
			...
			retRes891419 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes891419)
			ch <- retRes891419
			return nil
		}
...
func (this *Exchange) CreatePostOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes894015 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes894015)
		ch <- retRes894015
		return nil
...
func (this *Exchange) CreateReduceOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes894815 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes894815)
		ch <- retRes894815
		return nil
...
func (this *Exchange) CreateStopLimitOrderWs(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes895615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes895615)
		ch <- retRes895615
		return nil
...
func (this *Exchange) CreateStopLossOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrderWs")) {
			...
			retRes897819 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes897819)
			ch <- retRes897819
			return nil
		}
...
func (this *Exchange) CreateStopMarketOrderWs(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes898815 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes898815)
		ch <- retRes898815
		return nil
...
func (this *Exchange) CreateStopOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes899915 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes899915)
		ch <- retRes899915
		return nil
...
func (this *Exchange) CreateTakeProfitOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
			...
			retRes902119 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes902119)
			ch <- retRes902119
			return nil
		}
...
func (this *Exchange) CreateTrailingAmountOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
			...
			retRes904919 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes904919)
			ch <- retRes904919
			return nil
		}
...
func (this *Exchange) CreateTrailingPercentOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
			...
			retRes907719 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes907719)
			ch <- retRes907719
			return nil
		}
...
func (this *Exchange) CreateTriggerOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrderWs")) {
			...
			retRes910119 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes910119)
			ch <- retRes910119
			return nil
		}
...
func (this *Exchange) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes91078 := <-this.DerivedExchange.(ICancelOrderWs).CancelOrderWs(id, symbol)
		PanicOnError(retRes91078)

		retRes910815 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes910815)
		ch <- retRes910815
		return nil
...
func (this *Exchange) FetchTickerWs(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchTickersWs")) {
			...
			retRes915312 := (<-this.LoadMarkets())
			PanicOnError(retRes915312)
...
func (this *Exchange) EditLimitBuyOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes925615 := (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
		PanicOnError(retRes925615)
		ch <- retRes925615
		return nil
...
func (this *Exchange) EditLimitSellOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes926015 := (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
...
func (this *Exchange) EditLimitOrder(id any, symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes926415 := <-this.DerivedExchange.(IEditOrder).EditOrder(id, symbol, "limit", side, amount, price, params)
...
func (this *Exchange) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes92688 := <-this.DerivedExchange.CancelOrder(id, symbol)
		PanicOnError(retRes92688)

		retRes926915 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) EditOrderWithClientOrderId(clientOrderId any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes927415 := <-this.DerivedExchange.(IEditOrder).EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
...
func (this *Exchange) WatchPositionForSymbols(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes928615 := <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
		PanicOnError(retRes928615)
		ch <- retRes928615
		return nil
...
func (this *Exchange) FetchOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes933715 := <-this.DerivedExchange.(IFetchOrder).FetchOrder("", symbol, extendedParams)
		PanicOnError(retRes933715)
		ch <- retRes933715
		return nil
...
func (this *Exchange) FetchUnifiedOrder(order any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes934815 := <-this.DerivedExchange.(IFetchOrder).FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
...
func (this *Exchange) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
			...
			retRes937819 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
			...
			retRes940619 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
			...
			retRes942319 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
			PanicOnError(retRes942319)
			ch <- retRes942319
			return nil
		}
...
func (this *Exchange) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
			...
			retRes943919 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
...
func (this *Exchange) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
			...
			retRes945519 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
...
func (this *Exchange) CreateTriggerOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrder")) {
			...
			retRes947919 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateStopLossOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrder")) {
			...
			retRes950319 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTakeProfitOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrder")) {
			...
			retRes952719 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes952719)
			ch <- retRes952719
			return nil
		}
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
			...
			retRes955719 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes955719)
			ch <- retRes955719
			return nil
		}
...
func (this *Exchange) CancelOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes958115 := <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
...
func (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes959915 := (<-this.CancelOrders([]any{}, symbol, extendedParams))
...
func (this *Exchange) CreateLimitOrder(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes965415 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateMarketOrder(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes965815 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
		PanicOnError(retRes965815)
		ch <- retRes965815
		return nil
...
func (this *Exchange) CreateLimitBuyOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes966215 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
		PanicOnError(retRes966215)
		ch <- retRes966215
		return nil
...
func (this *Exchange) CreateLimitSellOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes966615 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes966615)
		ch <- retRes966615
		return nil
...
func (this *Exchange) CreateMarketBuyOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes967015 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes967015)
		ch <- retRes967015
		return nil
...
func (this *Exchange) CreateMarketSellOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes967415 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes967415)
		ch <- retRes967415
		return nil
...
func (this *Exchange) CreatePostOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes968215 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes968215)
		ch <- retRes968215
		return nil
...
func (this *Exchange) CreateReduceOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes969015 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes969015)
		ch <- retRes969015
		return nil
...
func (this *Exchange) CreateStopOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes970115 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes970115)
		ch <- retRes970115
		return nil
...
func (this *Exchange) CreateStopLimitOrder(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes970915 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
...
func (this *Exchange) CreateStopMarketOrder(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes971715 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes971715)
		ch <- retRes971715
		return nil
