...
func (this *BaseExchange) WatchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "watchLiquidationsForSymbols")) {
			...
			retRes359619 := (<-this.WatchLiquidationsForSymbols([]any{symbol}, since, limit, params))
...
func (this *BaseExchange) WatchFundingRatesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes381915 := (<-this.WatchFundingRates(symbols, params))
		PanicOnError(retRes381915)
		ch <- retRes381915
		return nil
...
func (this *BaseExchange) Fetch2(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(this.EnableRateLimit) {
			...
			retRes633212 := (<-this.Throttle(cost))
								...
								if IsTrue(IsInstance(e, OperationFailed)) {
									if IsTrue(IsLessThan(i, retries)) {
										...
										if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
											...
											retRes636928 := (<-this.Sleep(retryDelay))
											PanicOnError(retRes636928)
										}
									} else {
										panic(e)
									}
...
func (this *BaseExchange) Request(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes638315 := (<-this.Fetch2(path, api, method, params, headers, body, config))
		PanicOnError(retRes638315)
		ch <- retRes638315
		return nil
...
func (this *BaseExchange) FetchFreeBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes663515 := (<-this.FetchPartialBalance("free", params))
		PanicOnError(retRes663515)
		ch <- retRes663515
		return nil
...
func (this *BaseExchange) FetchUsedBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes663915 := (<-this.FetchPartialBalance("used", params))
		PanicOnError(retRes663915)
		ch <- retRes663915
		return nil
...
func (this *BaseExchange) FetchTotalBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes664315 := (<-this.FetchPartialBalance("total", params))
...
func (this *BaseExchange) FetchTransactionFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes665415 := (<-this.FetchTransactionFees([]any{code}, params))
		PanicOnError(retRes665415)
		ch <- retRes665415
		return nil
...
func (this *BaseExchange) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
			...
			retRes780412 := (<-this.LoadMarkets())
			PanicOnError(retRes780412)
...
func (this *BaseExchange) FetchMarkOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
			...
			retRes783819 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func (this *BaseExchange) FetchIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
			...
			retRes786019 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes786019)
			ch <- retRes786019
			return nil
		} else {
...
func (this *BaseExchange) FetchPremiumIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
			...
			retRes788219 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes788219)
			ch <- retRes788219
			return nil
		} else {
...
func (this *BaseExchange) FetchTransactions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
			...
			retRes810819 := <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
			PanicOnError(retRes810819)
			ch <- retRes810819
			return nil
		} else {
...

			{
				func(this *BaseExchange) (ret_ any) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes826227 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes826227)
						ch <- retRes826227
						return nil
					} else {

						retRes826427 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes826427)
						ch <- retRes826427
						return nil
					}
...
func (this *BaseExchange) LoadMarketsAndSignIn() <-chan any {
	...
	go func() any {
		...
		retRes87958 := (<-promiseAll([]any{this.LoadMarkets(), <-this.callInternal("signIn")}))
		PanicOnError(retRes87958)
		return nil
	}()
	return ch
}
...
func (this *Exchange) CreateLimitBuyOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes922715 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "buy", amount, price, params)
...
func (this *Exchange) CreateLimitOrderWs(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes923115 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateLimitSellOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes923515 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes923515)
		ch <- retRes923515
		return nil
...
func (this *Exchange) CreateMarketBuyOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes923915 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes923915)
		ch <- retRes923915
		return nil
...
func (this *Exchange) CreateMarketOrderWithCostWs(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
			...
			retRes925419 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, cost, 1, params)
...
func (this *Exchange) CreateMarketOrderWs(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes926015 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, price, params)
		PanicOnError(retRes926015)
		ch <- retRes926015
		return nil
...
func (this *Exchange) CreateMarketSellOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes926415 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes926415)
		ch <- retRes926415
		return nil
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
			...
			retRes929219 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes929219)
			ch <- retRes929219
			return nil
		}
...
func (this *Exchange) CreatePostOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes931815 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes931815)
		ch <- retRes931815
		return nil
...
func (this *Exchange) CreateReduceOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes932615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopLimitOrderWs(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes933415 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, query)
...
func (this *Exchange) CreateStopLossOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrderWs")) {
			...
			retRes935619 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes935619)
			ch <- retRes935619
			return nil
		}
...
func (this *Exchange) CreateStopMarketOrderWs(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes936615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, nil, query)
...
func (this *Exchange) CreateStopOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes937715 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateTakeProfitOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
			...
			retRes939919 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes939919)
			ch <- retRes939919
			return nil
		}
...
func (this *Exchange) CreateTrailingAmountOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
			...
			retRes942719 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes942719)
			ch <- retRes942719
			return nil
		}
...
func (this *Exchange) CreateTrailingPercentOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
			...
			retRes945519 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes945519)
			ch <- retRes945519
			return nil
		}
...
func (this *Exchange) CreateTriggerOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrderWs")) {
			...
			retRes947919 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes947919)
			ch <- retRes947919
			return nil
		}
...
func (this *Exchange) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes94858 := <-this.DerivedExchange.(ICancelOrderWs).CancelOrderWs(id, symbol)
		PanicOnError(retRes94858)

		retRes948615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) EditLimitBuyOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes964115 := (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
		PanicOnError(retRes964115)
		ch <- retRes964115
		return nil
...
func (this *Exchange) EditLimitSellOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes964515 := (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
		PanicOnError(retRes964515)
		ch <- retRes964515
		return nil
...
func (this *Exchange) EditLimitOrder(id any, symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes964915 := <-this.DerivedExchange.(IEditOrder).EditOrder(id, symbol, "limit", side, amount, price, params)
		PanicOnError(retRes964915)
		ch <- retRes964915
		return nil
...
func (this *Exchange) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes96538 := <-this.DerivedExchange.CancelOrder(id, symbol)
		PanicOnError(retRes96538)

		retRes965415 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes965415)
		ch <- retRes965415
		return nil
...
func (this *Exchange) EditOrderWithClientOrderId(clientOrderId any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes965915 := <-this.DerivedExchange.(IEditOrder).EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
		PanicOnError(retRes965915)
		ch <- retRes965915
		return nil
...
func (this *Exchange) WatchPositionForSymbols(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes967115 := <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
		PanicOnError(retRes967115)
		ch <- retRes967115
		return nil
...
func (this *Exchange) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchTickers")) {
			...
			retRes968012 := (<-this.LoadMarkets())
			PanicOnError(retRes968012)
...
func (this *Exchange) FetchOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes972215 := <-this.DerivedExchange.(IFetchOrder).FetchOrder("", symbol, extendedParams)
...
func (this *Exchange) FetchUnifiedOrder(order any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes973315 := <-this.DerivedExchange.(IFetchOrder).FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
		PanicOnError(retRes973315)
		ch <- retRes973315
		return nil
...
func (this *Exchange) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
			...
			retRes976319 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes976319)
			ch <- retRes976319
			return nil
		}
...
func (this *Exchange) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
			...
			retRes979119 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
			...
			retRes980819 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
			PanicOnError(retRes980819)
			ch <- retRes980819
			return nil
		}
...
func (this *Exchange) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
			...
			retRes982419 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
			PanicOnError(retRes982419)
			ch <- retRes982419
			return nil
		}
...
func (this *Exchange) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
			...
			retRes984019 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
			PanicOnError(retRes984019)
			ch <- retRes984019
			return nil
		}
...
func (this *Exchange) CreateTriggerOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrder")) {
			...
			retRes986419 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes986419)
			ch <- retRes986419
			return nil
		}
...
func (this *Exchange) CreateStopLossOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrder")) {
			...
			retRes988819 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTakeProfitOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrder")) {
			...
			retRes991219 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes991219)
			ch <- retRes991219
			return nil
		}
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
			...
			retRes994219 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CancelOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes996615 := <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
		PanicOnError(retRes996615)
		ch <- retRes996615
		return nil
...
func (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes998415 := (<-this.CancelOrders([]any{}, symbol, extendedParams))
		PanicOnError(retRes998415)
		ch <- retRes998415
		return nil
...
func (this *Exchange) CreateLimitOrder(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1003915 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateMarketOrder(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1004315 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
...
func (this *Exchange) CreateLimitBuyOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1004715 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
...
func (this *Exchange) CreateLimitSellOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1005115 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes1005115)
		ch <- retRes1005115
		return nil
...
func (this *Exchange) CreateMarketBuyOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1005515 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
...
func (this *Exchange) CreateMarketSellOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1005915 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes1005915)
		ch <- retRes1005915
		return nil
...
func (this *Exchange) CreatePostOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1006715 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes1006715)
		ch <- retRes1006715
		return nil
...
func (this *Exchange) CreateStopOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1008615 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes1008615)
		ch <- retRes1008615
		return nil
...
func (this *Exchange) CreateStopLimitOrder(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1009415 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes1009415)
		ch <- retRes1009415
		return nil
...
func (this *Exchange) CreateStopMarketOrder(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1010215 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes1010215)
		ch <- retRes1010215
		return nil
