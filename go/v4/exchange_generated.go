...
func  (this *BaseExchange) SafeList2(dictionaryOrList any, key1 any, key2 any, optionalArgs ...any) any  {
    ...
    */
    ...
    _ = defaultValue
    var value any = this.SafeValue(dictionaryOrList, key1)
    if IsTrue(IsTrue((!IsEqual(value, nil))) && IsTrue(IsArray(value))) {
        return value
    }
    var value2 any = this.SafeValue(dictionaryOrList, key2)
    if IsTrue(IsTrue((!IsEqual(value2, nil))) && IsTrue(IsArray(value2))) {
        return value2
    }
    return defaultValue
}
...
func (this *Exchange) WatchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "watchLiquidationsForSymbols")) {
			...
			retRes351219 := (<-this.WatchLiquidationsForSymbols([]any{symbol}, since, limit, params))
			PanicOnError(retRes351219)
			ch <- retRes351219
			return nil
		}
...
func (this *Exchange) WatchFundingRatesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes377915 := (<-this.WatchFundingRates(symbols, params))
...
func (this *Exchange) PrioritizedNetworkAliases(optionalArgs ...any) any {
	/**
	 * @method
	...
	for i := 0; IsLessThan(i, GetArrayLength(keys)); i++ {
		...
		return Ternary(IsTrue((preferPrimary)), []any{primary, secondary}, []any{secondary, primary})
	}
...
func (this *Exchange) NetworkCodeToId(networkCode any, optionalArgs ...any) any {
	...
	preferredChainalternativeChainVariable := this.PrioritizedNetworkAliases(networkCode, currencyCode, false)
	preferredChain := GetValue(preferredChainalternativeChainVariable, 0)
	alternativeChain := GetValue(preferredChainalternativeChainVariable, 1)
	var networkId any = this.SafeString2(networkIdsByCodes, preferredChain, alternativeChain)
...
func (this *Exchange) NetworkIdToCode(optionalArgs ...any) any {
	...
	preferredChainalternativeChainVariable := this.PrioritizedNetworkAliases(networkCode, currencyCode, true)
	preferredChain := GetValue(preferredChainalternativeChainVariable, 0)
	alternativeChain := GetValue(preferredChainalternativeChainVariable, 1)
...
func (this *Exchange) ParseLeverageTiers(response any, optionalArgs ...any) any {
	...
	if IsTrue(IsArray(response)) {
		for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
			...
			var id any = Ternary(IsTrue((IsEqual(marketIdKey, nil))), nil, this.SafeString(item, marketIdKey))
...
func (this *Exchange) Fetch2(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(this.EnableRateLimit) {
			...
			retRes619512 := (<-this.Throttle(cost))
								...
								if IsTrue(IsInstance(e, OperationFailed)) {
									if IsTrue(IsLessThan(i, retries)) {
										...
										if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
											...
											retRes623228 := (<-this.Sleep(retryDelay))
											PanicOnError(retRes623228)
										}
									} else {
										panic(e)
									}
...
func (this *Exchange) Request(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes624615 := (<-this.Fetch2(path, api, method, params, headers, body, config))
		PanicOnError(retRes624615)
		ch <- retRes624615
		return nil
...
func (this *Exchange) EditLimitBuyOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes632515 := (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
...
func (this *Exchange) EditLimitSellOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes632915 := (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
		PanicOnError(retRes632915)
		ch <- retRes632915
		return nil
...
func (this *Exchange) EditLimitOrder(id any, symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes633315 := <-this.DerivedExchange.EditOrder(id, symbol, "limit", side, amount, price, params)
...
func (this *Exchange) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes63378 := <-this.DerivedExchange.CancelOrder(id, symbol)
		PanicOnError(retRes63378)

		retRes633815 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes633815)
		ch <- retRes633815
		return nil
...
func (this *Exchange) EditOrderWithClientOrderId(clientOrderId any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes634315 := <-this.DerivedExchange.EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
		PanicOnError(retRes634315)
		ch <- retRes634315
		return nil
...
func (this *Exchange) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes63478 := <-this.DerivedExchange.CancelOrderWs(id, symbol)
		PanicOnError(retRes63478)

		retRes634815 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes634815)
		ch <- retRes634815
		return nil
...
func (this *Exchange) WatchPositionForSymbols(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes636815 := <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
		PanicOnError(retRes636815)
		ch <- retRes636815
		return nil
...
func (this *Exchange) FetchFreeBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes655515 := (<-this.FetchPartialBalance("free", params))
		PanicOnError(retRes655515)
		ch <- retRes655515
		return nil
...
func (this *Exchange) FetchUsedBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes655915 := (<-this.FetchPartialBalance("used", params))
		PanicOnError(retRes655915)
		ch <- retRes655915
		return nil
...
func (this *Exchange) FetchTotalBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes656315 := (<-this.FetchPartialBalance("total", params))
...
func (this *Exchange) FetchTransactionFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes657415 := (<-this.FetchTransactionFees([]any{code}, params))
		PanicOnError(retRes657415)
		ch <- retRes657415
		return nil
...
func (this *Exchange) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66028 := (<-this.LoadMarkets())
		PanicOnError(retRes66028)
...
func (this *Exchange) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes66158 := (<-this.LoadMarkets())
		PanicOnError(retRes66158)
		if !IsTrue(GetValue(this.Has, "fetchBorrowRates")) {
...
func  (this *BaseExchange) ParseTickers(tickers any, optionalArgs ...any) any  {
    ...
    if IsTrue(IsArray(tickers)) {
        for i := 0; IsLessThan(i, GetArrayLength(tickers)); i++ {
			...
			retRes680912 := (<-this.LoadMarkets())
			PanicOnError(retRes680912)
...
func  (this *BaseExchange) ParseOpenInterests(response any, optionalArgs ...any) any  {
    ...
    for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
        var entry any = GetValue(response, i)
			...
			retRes682612 := (<-this.LoadMarkets())
			PanicOnError(retRes682612)
...
func  (this *BaseExchange) ParseDepositWithdrawFees(response any, optionalArgs ...any) any  {
    ...
    */
    ...
    for i := 0; IsLessThan(i, GetArrayLength(responseKeys)); i++ {
        ...
        if IsTrue(isArray) {
            currencyId = Ternary(IsTrue((IsEqual(currencyIdKey, nil))), nil, this.SafeString(dictionary, currencyIdKey))
        }
...
func  (this *BaseExchange) ParseOptionChain(response any, optionalArgs ...any) any  {
    ...
    for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
        ...
        var currency any = this.SafeCurrency(currencyId)
        var marketId any = Ternary(IsTrue((IsEqual(symbolKey, nil))), nil, this.SafeString(info, symbolKey))
...
func  (this *BaseExchange) ParseConversions(conversions any, optionalArgs ...any) any  {
    ...
    for i := 0; IsLessThan(i, GetArrayLength(conversions)); i++ {
        ...
        var fromId any = Ternary(IsTrue((IsEqual(fromCurrencyKey, nil))), nil, this.SafeString(entry, fromCurrencyKey))
        var toId any = Ternary(IsTrue((IsEqual(toCurrencyKey, nil))), nil, this.SafeString(entry, toCurrencyKey))
...
func  (this *Exchange) CreateLimitBuyOrderWs(symbol any, amount any, price any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes884315 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "buy", amount, price, params)
                PanicOnError(retRes884315)
                ch <- retRes884315
                return nil
...
func  (this *Exchange) CreateLimitOrderWs(symbol any, side any, amount any, price any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes884715 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, params)
...
func  (this *Exchange) CreateLimitSellOrderWs(symbol any, amount any, price any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes885115 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "sell", amount, price, params)
                PanicOnError(retRes885115)
                ch <- retRes885115
                return nil
...
func  (this *Exchange) CreateMarketBuyOrderWs(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes885515 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "buy", amount, nil, params)
...
func  (this *Exchange) CreateMarketOrderWithCostWs(symbol any, side any, cost any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
                    ...
                    retRes887019 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, cost, 1, params)
...
func  (this *Exchange) CreateMarketOrderWs(symbol any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes887615 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, price, params)
                PanicOnError(retRes887615)
                ch <- retRes887615
                return nil
...
func  (this *Exchange) CreateMarketSellOrderWs(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes888015 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "sell", amount, nil, params)
                PanicOnError(retRes888015)
                ch <- retRes888015
                return nil
...
func  (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
                    ...
                    retRes890819 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes890819)
                    ch <- retRes890819
                    return nil
            }
...
func  (this *Exchange) CreatePostOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes893415 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes893415)
                ch <- retRes893415
                return nil
...
func  (this *Exchange) CreateReduceOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes894215 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func  (this *Exchange) CreateStopLimitOrderWs(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes895015 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, query)
                PanicOnError(retRes895015)
                ch <- retRes895015
                return nil
...
func  (this *Exchange) CreateStopLossOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createStopLossOrderWs")) {
                    ...
                    retRes897219 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes897219)
                    ch <- retRes897219
                    return nil
            }
...
func  (this *Exchange) CreateStopMarketOrderWs(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes898215 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, nil, query)
                PanicOnError(retRes898215)
                ch <- retRes898215
                return nil
...
func  (this *Exchange) CreateStopOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes899315 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func  (this *Exchange) CreateTakeProfitOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
                    ...
                    retRes901519 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
...
func  (this *Exchange) CreateTrailingAmountOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
                    ...
                    retRes904319 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes904319)
                    ch <- retRes904319
                    return nil
            }
...
func  (this *Exchange) CreateTrailingPercentOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
                    ...
                    retRes907119 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes907119)
                    ch <- retRes907119
                    return nil
            }
...
func  (this *Exchange) CreateTriggerOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTriggerOrderWs")) {
                    ...
                    retRes909519 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes909519)
                    ch <- retRes909519
                    return nil
            }
...
func  (this *Exchange) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
            ...
            retRes91018 := <-this.DerivedExchange.(ICancelOrderWs).CancelOrderWs(id, symbol)
            PanicOnError(retRes91018)
        
                retRes910215 :=  <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
                PanicOnError(retRes910215)
                ch <- retRes910215
                return nil
...
func  (this *Exchange) FetchTickerWs(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(GetValue(this.Has, "fetchTickersWs")) {
                ...
                retRes914712 := (<-this.LoadMarkets())
                PanicOnError(retRes914712)
...
func  (this *Exchange) EditLimitBuyOrder(id any, symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes925015 :=  (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
                PanicOnError(retRes925015)
                ch <- retRes925015
                return nil
...
func  (this *Exchange) EditLimitSellOrder(id any, symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes925415 :=  (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
                PanicOnError(retRes925415)
                ch <- retRes925415
                return nil
...
func  (this *Exchange) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
            ...
            retRes92628 := <-this.DerivedExchange.CancelOrder(id, symbol)
            PanicOnError(retRes92628)
        
                retRes926315 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
                PanicOnError(retRes926315)
                ch <- retRes926315
                return nil
...
func  (this *Exchange) WatchPositionForSymbols(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes928015 :=  <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
                PanicOnError(retRes928015)
                ch <- retRes928015
                return nil
...
func (this *Exchange) FetchOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes690015 := <-this.DerivedExchange.FetchOrder("", symbol, extendedParams)
...
func (this *Exchange) FetchUnifiedOrder(order any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes691515 := <-this.DerivedExchange.FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
...
func (this *Exchange) FetchPositionADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPositionsADLRank")) {
			...
			retRes695212 := (<-this.LoadMarkets())
			PanicOnError(retRes695212)
...
func (this *Exchange) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
			...
			retRes699019 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes699019)
			ch <- retRes699019
			return nil
		}
...
func (this *Exchange) CreateTrailingAmountOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
			...
			retRes701819 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes701819)
			ch <- retRes701819
			return nil
		}
		panic(NotSupported(Add(this.Id, " createTrailingAmountOrderWs() is not supported yet")))
...
func (this *Exchange) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
			...
			retRes704619 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTrailingPercentOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
			...
			retRes707419 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes707419)
			ch <- retRes707419
			return nil
		}
		panic(NotSupported(Add(this.Id, " createTrailingPercentOrderWs() is not supported yet")))
...
func (this *Exchange) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
			...
			retRes709119 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
...
func (this *Exchange) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
			...
			retRes710719 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
...
func (this *Exchange) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
			...
			retRes712319 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
...
func (this *Exchange) CreateMarketOrderWithCostWs(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
			...
			retRes714019 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, cost, 1, params)
			PanicOnError(retRes714019)
			ch <- retRes714019
			return nil
		}
		panic(NotSupported(Add(this.Id, " createMarketOrderWithCostWs() is not supported yet")))
...
func (this *Exchange) CreateTriggerOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrder")) {
			...
			retRes716419 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTriggerOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrderWs")) {
			...
			retRes718819 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes718819)
			ch <- retRes718819
			return nil
		}
		panic(NotSupported(Add(this.Id, " createTriggerOrderWs() is not supported yet")))
...
func (this *Exchange) CreateStopLossOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrder")) {
			...
			retRes721219 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes721219)
			ch <- retRes721219
			return nil
		}
...
func (this *Exchange) CreateStopLossOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrderWs")) {
			...
			retRes723619 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes723619)
			ch <- retRes723619
			return nil
		}
		panic(NotSupported(Add(this.Id, " createStopLossOrderWs() is not supported yet")))
...
func (this *Exchange) CreateTakeProfitOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrder")) {
			...
			retRes726019 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes726019)
			ch <- retRes726019
			return nil
		}
...
func (this *Exchange) CreateTakeProfitOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
			...
			retRes728419 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes728419)
			ch <- retRes728419
			return nil
		}
		panic(NotSupported(Add(this.Id, " createTakeProfitOrderWs() is not supported yet")))
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
			...
			retRes731419 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes731419)
			ch <- retRes731419
			return nil
		}
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
			...
			retRes739419 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes739419)
			ch <- retRes739419
			return nil
		}
		panic(NotSupported(Add(this.Id, " createOrderWithTakeProfitAndStopLossWs() is not supported yet")))
...
func (this *Exchange) CancelOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes744215 := <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
		PanicOnError(retRes744215)
		ch <- retRes744215
		return nil
...
func  (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds any, optionalArgs ...any) <- chan any {
            ...
            var extendedParams any = this.Extend(params, map[string]any {
                ...
                retRes959315 :=  (<-this.CancelOrders([]any{}, symbol, extendedParams))
                PanicOnError(retRes959315)
                ch <- retRes959315
                return nil
...
func  (this *Exchange) CreateLimitOrder(symbol any, side any, amount any, price any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes964815 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
                PanicOnError(retRes964815)
                ch <- retRes964815
                return nil
...
func  (this *Exchange) CreateMarketOrder(symbol any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes965215 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
                PanicOnError(retRes965215)
                ch <- retRes965215
                return nil
...
func  (this *Exchange) CreateLimitBuyOrder(symbol any, amount any, price any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes965615 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
...
func  (this *Exchange) CreateLimitSellOrder(symbol any, amount any, price any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes966015 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
                PanicOnError(retRes966015)
                ch <- retRes966015
                return nil
...
func  (this *Exchange) CreateMarketBuyOrder(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes966415 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
                PanicOnError(retRes966415)
                ch <- retRes966415
                return nil
...
func  (this *Exchange) CreateMarketSellOrder(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes966815 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
                PanicOnError(retRes966815)
                ch <- retRes966815
                return nil
...
func  (this *Exchange) CreatePostOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes967615 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
...
func  (this *Exchange) CreateReduceOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes968415 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes968415)
                ch <- retRes968415
                return nil
...
func  (this *Exchange) CreateStopOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes969515 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes969515)
                ch <- retRes969515
                return nil
...
func  (this *Exchange) CreateStopLimitOrder(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes970315 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
                PanicOnError(retRes970315)
                ch <- retRes970315
                return nil
...
func  (this *Exchange) CreateStopMarketOrder(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <- chan any {
            ...
            var query any = this.Extend(params, map[string]any {
                ...
                retRes971115 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
                PanicOnError(retRes971115)
                ch <- retRes971115
                return nil
...
func  (this *Exchange) FetchTradingFee(symbol any, optionalArgs ...any) <- chan any {
		...
		retRes746415 := (<-this.CancelOrders([]any{}, symbol, extendedParams))
		PanicOnError(retRes746415)
		ch <- retRes746415
		return nil
...
func (this *Exchange) CreateLimitOrder(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes777615 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
		PanicOnError(retRes777615)
		ch <- retRes777615
		return nil
...
func (this *Exchange) CreateLimitOrderWs(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes778015 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, params)
		PanicOnError(retRes778015)
		ch <- retRes778015
		return nil
...
func (this *Exchange) CreateMarketOrder(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes778415 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
		PanicOnError(retRes778415)
		ch <- retRes778415
		return nil
...
func (this *Exchange) CreateMarketOrderWs(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes778815 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, price, params)
		PanicOnError(retRes778815)
		ch <- retRes778815
		return nil
...
func (this *Exchange) CreateLimitBuyOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes779215 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
		PanicOnError(retRes779215)
		ch <- retRes779215
		return nil
...
func (this *Exchange) CreateLimitBuyOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes779615 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "buy", amount, price, params)
		PanicOnError(retRes779615)
		ch <- retRes779615
		return nil
...
func (this *Exchange) CreateLimitSellOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes780015 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes780015)
		ch <- retRes780015
		return nil
...
func (this *Exchange) CreateLimitSellOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes780415 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "sell", amount, price, params)
...
func (this *Exchange) CreateMarketBuyOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes780815 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes780815)
		ch <- retRes780815
		return nil
...
func (this *Exchange) CreateMarketBuyOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes781215 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes781215)
		ch <- retRes781215
		return nil
...
func (this *Exchange) CreateMarketSellOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes781615 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes781615)
		ch <- retRes781615
		return nil
...
func (this *Exchange) CreateMarketSellOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes782015 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes782015)
		ch <- retRes782015
		return nil
...
func (this *Exchange) CreatePostOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes799015 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes799015)
		ch <- retRes799015
		return nil
...
func (this *Exchange) CreatePostOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes799815 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes799815)
		ch <- retRes799815
		return nil
...
func (this *Exchange) CreateReduceOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes800615 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes800615)
		ch <- retRes800615
		return nil
...
func (this *Exchange) CreateReduceOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes801415 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes801415)
		ch <- retRes801415
		return nil
...
func (this *Exchange) CreateStopOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes802515 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes802515)
		ch <- retRes802515
		return nil
...
func (this *Exchange) CreateStopOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes803615 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes803615)
		ch <- retRes803615
		return nil
...
func (this *Exchange) CreateStopLimitOrder(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes804415 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes804415)
		ch <- retRes804415
		return nil
...
func (this *Exchange) CreateStopLimitOrderWs(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes805215 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, query)
...
func (this *Exchange) CreateStopMarketOrder(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes806015 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes806015)
		ch <- retRes806015
		return nil
...
func (this *Exchange) CreateStopMarketOrderWs(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes806815 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes806815)
		ch <- retRes806815
		return nil
...
func (this *Exchange) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingRates")) {
			...
			retRes845212 := (<-this.LoadMarkets())
			PanicOnError(retRes845212)
...
func (this *Exchange) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
			...
			retRes847212 := (<-this.LoadMarkets())
			PanicOnError(retRes847212)
...
func (this *Exchange) FetchMarkOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
			...
			retRes850619 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func (this *Exchange) FetchIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
			...
			retRes852819 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func (this *Exchange) FetchPremiumIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
			...
			retRes855019 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes855019)
			ch <- retRes855019
			return nil
		} else {
			panic(NotSupported(Add(this.Id, " fetchPremiumIndexOHLCV () is not supported yet")))
...
func (this *Exchange) FetchTransactions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
			...
			retRes876319 := <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
			PanicOnError(retRes876319)
			ch <- retRes876319
			return nil
		} else {
			panic(NotSupported(Add(this.Id, " fetchTransactions () is not supported yet")))
...

			{
				func(this *Exchange) (ret_ any) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes890927 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes890927)
						ch <- retRes890927
						return nil
					} else {

						retRes891127 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes891127)
						ch <- retRes891127
						return nil
					}
...
func (this *Exchange) LoadMarketsAndSignIn() <-chan any {
	...
	go func() any {
		...
		retRes94108 := (<-promiseAll([]any{this.LoadMarkets(), <-this.callInternal("signIn")}))
		PanicOnError(retRes94108)
		return nil
	}()
	return ch
}
