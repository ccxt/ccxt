...
func (this *BaseExchange) WatchFundingRatesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes370215 := (<-this.WatchFundingRates(symbols, params))
...
func (this *BaseExchange) Fetch2(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(this.EnableRateLimit) {
			...
			retRes610512 := (<-this.Throttle(cost))
								...
								if IsTrue(IsInstance(e, OperationFailed)) {
									if IsTrue(IsLessThan(i, retries)) {
										...
										if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
											...
											retRes614228 := (<-this.Sleep(retryDelay))
											PanicOnError(retRes614228)
										}
									} else {
										panic(e)
									}
...
func (this *BaseExchange) Request(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes615615 := (<-this.Fetch2(path, api, method, params, headers, body, config))
...
func (this *BaseExchange) FetchFreeBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes637815 := (<-this.FetchPartialBalance("free", params))
...
func (this *BaseExchange) FetchUsedBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes638215 := (<-this.FetchPartialBalance("used", params))
...
func (this *BaseExchange) FetchTotalBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes638615 := (<-this.FetchPartialBalance("total", params))
		PanicOnError(retRes638615)
		ch <- retRes638615
		return nil
...
func (this *BaseExchange) FetchTransactionFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes639715 := (<-this.FetchTransactionFees([]any{code}, params))
...
func (this *BaseExchange) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
			...
			retRes750812 := (<-this.LoadMarkets())
			PanicOnError(retRes750812)
...
func (this *BaseExchange) FetchMarkOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
			...
			retRes754219 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes754219)
			ch <- retRes754219
			return nil
		} else {
...
func (this *BaseExchange) FetchIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
			...
			retRes756419 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func (this *BaseExchange) FetchPremiumIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
			...
			retRes758619 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes758619)
			ch <- retRes758619
			return nil
		} else {
...
func (this *BaseExchange) FetchTransactions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
			...
			retRes780419 := <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
			PanicOnError(retRes780419)
			ch <- retRes780419
			return nil
		} else {
...

			{
				func(this *BaseExchange) (ret_ any) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes795027 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes795027)
						ch <- retRes795027
						return nil
					} else {

						retRes795227 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes795227)
						ch <- retRes795227
						return nil
					}
...
func (this *BaseExchange) LoadMarketsAndSignIn() <-chan any {
	...
	go func() any {
		...
		retRes84368 := (<-promiseAll([]any{this.LoadMarkets(), <-this.callInternal("signIn")}))
...
func (this *Exchange) FetchMarkPrice(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkPrices")) {
			...
			retRes878412 := (<-this.LoadMarkets())
			PanicOnError(retRes878412)
...
func (this *Exchange) CreateLimitBuyOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes885615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "buy", amount, price, params)
...
func (this *Exchange) CreateLimitOrderWs(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes886015 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, params)
		PanicOnError(retRes886015)
		ch <- retRes886015
		return nil
...
func (this *Exchange) CreateLimitSellOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes886415 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes886415)
		ch <- retRes886415
		return nil
...
func (this *Exchange) CreateMarketBuyOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes886815 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes886815)
		ch <- retRes886815
		return nil
...
func (this *Exchange) CreateMarketOrderWithCostWs(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
			...
			retRes888319 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, cost, 1, params)
			PanicOnError(retRes888319)
			ch <- retRes888319
			return nil
		}
...
func (this *Exchange) CreateMarketOrderWs(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes888915 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, price, params)
		PanicOnError(retRes888915)
		ch <- retRes888915
		return nil
...
func (this *Exchange) CreateMarketSellOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes889315 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes889315)
		ch <- retRes889315
		return nil
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
			...
			retRes892119 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes892119)
			ch <- retRes892119
			return nil
		}
...
func (this *Exchange) CreatePostOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes894715 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateReduceOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes895515 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopLimitOrderWs(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes896315 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "limit", side, amount, price, query)
...
func (this *Exchange) CreateStopLossOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrderWs")) {
			...
			retRes898519 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes898519)
			ch <- retRes898519
			return nil
		}
...
func (this *Exchange) CreateStopMarketOrderWs(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes899515 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, "market", side, amount, nil, query)
...
func (this *Exchange) CreateStopOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes900615 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, query)
		PanicOnError(retRes900615)
		ch <- retRes900615
		return nil
...
func (this *Exchange) CreateTakeProfitOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
			...
			retRes902819 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes902819)
			ch <- retRes902819
			return nil
		}
...
func (this *Exchange) CreateTrailingAmountOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
			...
			retRes905619 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes905619)
			ch <- retRes905619
			return nil
		}
...
func (this *Exchange) CreateTrailingPercentOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
			...
			retRes908419 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes908419)
			ch <- retRes908419
			return nil
		}
...
func (this *Exchange) CreateTriggerOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrderWs")) {
			...
			retRes910819 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes910819)
			ch <- retRes910819
			return nil
		}
...
func (this *Exchange) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes91148 := <-this.DerivedExchange.(ICancelOrderWs).CancelOrderWs(id, symbol)
		PanicOnError(retRes91148)

		retRes911515 := <-this.DerivedExchange.(ICreateOrderWs).CreateOrderWs(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes911515)
		ch <- retRes911515
		return nil
...
func (this *Exchange) FetchTickerWs(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchTickersWs")) {
			...
			retRes916012 := (<-this.LoadMarkets())
			PanicOnError(retRes916012)
...
func (this *Exchange) EditLimitBuyOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes926315 := (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
...
func (this *Exchange) EditLimitSellOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes926715 := (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
		PanicOnError(retRes926715)
		ch <- retRes926715
		return nil
...
func (this *Exchange) EditLimitOrder(id any, symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes927115 := <-this.DerivedExchange.(IEditOrder).EditOrder(id, symbol, "limit", side, amount, price, params)
		PanicOnError(retRes927115)
		ch <- retRes927115
		return nil
...
func (this *Exchange) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes92758 := <-this.DerivedExchange.CancelOrder(id, symbol)
		PanicOnError(retRes92758)

		retRes927615 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes927615)
		ch <- retRes927615
		return nil
...
func (this *Exchange) EditOrderWithClientOrderId(clientOrderId any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes928115 := <-this.DerivedExchange.(IEditOrder).EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
...
func (this *Exchange) WatchPositionForSymbols(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes929315 := <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
...
func (this *Exchange) FetchOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes934415 := <-this.DerivedExchange.(IFetchOrder).FetchOrder("", symbol, extendedParams)
...
func (this *Exchange) FetchUnifiedOrder(order any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes935515 := <-this.DerivedExchange.(IFetchOrder).FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
...
func (this *Exchange) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
			...
			retRes938519 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
			...
			retRes941319 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
			...
			retRes943019 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
...
func (this *Exchange) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
			...
			retRes944619 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
...
func (this *Exchange) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
			...
			retRes946219 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
...
func (this *Exchange) CreateTriggerOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTriggerOrder")) {
			...
			retRes948619 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes948619)
			ch <- retRes948619
			return nil
		}
...
func (this *Exchange) CreateStopLossOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createStopLossOrder")) {
			...
			retRes951019 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes951019)
			ch <- retRes951019
			return nil
		}
...
func (this *Exchange) CreateTakeProfitOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrder")) {
			...
			retRes953419 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes953419)
			ch <- retRes953419
			return nil
		}
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
			...
			retRes956419 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CancelOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes958815 := <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
		PanicOnError(retRes958815)
		ch <- retRes958815
		return nil
...
func (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes960615 := (<-this.CancelOrders([]any{}, symbol, extendedParams))
		PanicOnError(retRes960615)
		ch <- retRes960615
		return nil
...
func (this *Exchange) CreateLimitOrder(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes966115 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateMarketOrder(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes966515 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
...
func (this *Exchange) CreateLimitBuyOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes966915 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
		PanicOnError(retRes966915)
		ch <- retRes966915
		return nil
...
func (this *Exchange) CreateLimitSellOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes967315 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
...
func (this *Exchange) CreateMarketBuyOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes967715 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes967715)
		ch <- retRes967715
		return nil
...
func (this *Exchange) CreateMarketSellOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes968115 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
...
func (this *Exchange) CreatePostOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes968915 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes970815 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopLimitOrder(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes971615 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes971615)
		ch <- retRes971615
		return nil
...
func (this *Exchange) CreateStopMarketOrder(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes972415 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes972415)
		ch <- retRes972415
		return nil
