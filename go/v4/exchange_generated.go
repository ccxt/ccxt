...
func  (this *Exchange) SetupStream()  {
    /**
     * @ignore
     * @method
    ...
    if IsTrue(IsEqual(this.Stream, nil)) {
        panic(ExchangeError("Stream is not initialized"))
    }
    if IsTrue(this.IsStreamingEnabled()) {
        return
    }
    AddElementToObject(this.Options, "enableStreaming", true)
    stream.Subscribe("tickers", this.StreamToSymbol("tickers"))
    stream.Subscribe("orderbooks", this.StreamToSymbol("orderbooks"))
    stream.Subscribe("orders", this.StreamToSymbol("orders"))
    stream.Subscribe("positions", this.StreamToSymbol("positions"))
    stream.Subscribe("trades", this.StreamToSymbol("trades"))
    stream.Subscribe("myTrades", this.StreamToSymbol("myTrades"))
    stream.Subscribe("ohlcvs", this.StreamOHLCVS())
    stream.Subscribe("liquidations", this.StreamToSymbol("liquidations"))
    stream.Subscribe("myLiquidations", this.StreamToSymbol("myLiquidations"))
    var options interface{} = this.SafeDict(this.Options, "streaming", map[string]interface{} {})
    var reconnect interface{} = this.SafeBool(options, "autoreconnect", true)
    if IsTrue(reconnect) {
        stream.Subscribe("errors", this.StreamReconnectOnError())
    }
}
func  (this *Exchange) StreamProduce(topic interface{}, optionalArgs ...interface{})  {
    /**
    * @ignore
    * @method
    ...
    */
    payload := GetArg(optionalArgs, 0, nil)
    _ = payload
    error := GetArg(optionalArgs, 1, nil)
    _ = error
    var stream *Stream = this.Stream
    stream.Produce(topic, payload, error)
}
func  (this *Exchange) StreamReconnect() <- chan interface{} {
        ...
        var stream *Stream = this.Stream
        var activeFunctions interface{} = stream.ActiveWatchFunctions
        var tasks interface{} = []interface{}{}
        for i := 0; IsLessThan(i, GetArrayLength(activeFunctions)); i++ {
            var activeFunction interface{} = GetValue(activeFunctions, i)
            var method interface{} = this.SafeString(activeFunction, "method")
            var args interface{} = this.SafeList(activeFunction, "args")
            var future interface{} = this.Spawn(GetValue(this, method), (args).([]interface{})...)
            AppendToArray(&tasks, future)
        }
...
func  (this *Exchange) WatchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Has, "watchLiquidationsForSymbols")) {
                    ...
                    retRes314019 :=  (<-this.WatchLiquidationsForSymbols([]interface{}{symbol}, since, limit, params))
...
func  (this *Exchange) SubscribeLiquidations(symbol interface{}, callback interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe(Add("liquidations::", symbol), callback, params)
            }
            stream.AddWatchFunction("liquidations", []interface{}{symbol, nil, nil, params})
        
                retRes316415 :=  <-this.DerivedExchange.WatchLiquidations(symbol, nil, nil, params)
...
func  (this *Exchange) UnsubscribeLiquidations(symbol interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    var stream *Stream = this.Stream
    return stream.Unsubscribe(Add("liquidations::", symbol), callback)
}
...
func  (this *Exchange) SubscribeLiquidationsForSymbols(symbols interface{}, callback interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            retRes32008 := (<-this.LoadMarkets())
            PanicOnError(retRes32008)
            symbols = this.MarketSymbols(symbols, nil, true)
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                    stream.Subscribe(Add("liquidations::", GetValue(symbols, i)), callback, params)
                }
                if IsTrue(this.IsEmpty(symbols)) {
                    stream.Subscribe("liquidations", callback, params)
                }
            }
            stream.AddWatchFunction("watchLiquidationsForSymbols", []interface{}{symbols, nil, nil, params})
        
                retRes321215 :=  (<-this.WatchLiquidationsForSymbols(symbols, nil, nil, params))
...
func  (this *Exchange) UnsubscribeLiquidationsForSymbols(symbols interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    symbols = this.MarketSymbols(symbols, nil, true)
    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
        stream.Unsubscribe(Add("liquidations::", GetValue(symbols, i)), callback)
    }
    if IsTrue(this.IsEmpty(symbols)) {
...
func  (this *Exchange) SubscribeTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            callback := GetArg(optionalArgs, 0, nil)
            _ = callback
            ...
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe(Add("trades::", symbol), callback, params)
            }
            stream.AddWatchFunction("watchTrades", []interface{}{symbol, nil, nil, params})
        
                retRes327215 :=  <-this.DerivedExchange.WatchTrades(symbol, nil, nil, params)
                PanicOnError(retRes327215)
                ch <- retRes327215
                return nil
...
func  (this *Exchange) UnsubscribeTrades(symbol interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    var stream *Stream = this.Stream
    return stream.Unsubscribe(Add("trades::", symbol), callback)
}
...
func  (this *Exchange) SubscribeTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            retRes33168 := (<-this.LoadMarkets())
            PanicOnError(retRes33168)
            symbols = this.MarketSymbols(symbols, nil, true)
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                    stream.Subscribe(Add("trades::", GetValue(symbols, i)), callback, params)
                }
                if IsTrue(this.IsEmpty(symbols)) {
                    stream.Subscribe("trades", callback, params)
                }
            }
            stream.AddWatchFunction("watchTradesForSymbols", []interface{}{symbols, nil, nil, params})
        
                retRes332815 :=  <-this.DerivedExchange.WatchTradesForSymbols(symbols, nil, nil, params)
                PanicOnError(retRes332815)
                ch <- retRes332815
                return nil
...
func  (this *Exchange) UnsubscribeTradesForSymbols(symbols interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    symbols = this.MarketSymbols(symbols, nil, true)
    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
        stream.Unsubscribe(Add("trades::", GetValue(symbols, i)), callback)
    }
    if IsTrue(this.IsEmpty(symbols)) {
...
func  (this *Exchange) SubscribeMyTradesForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            if IsTrue(!IsEqual(callback, nil)) {
                if IsTrue(this.IsEmpty(symbols)) {
                    stream.Subscribe("myTrades", callback, params)
                } else {
                    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                        stream.Subscribe(Add("myTrades::", GetValue(symbols, i)), callback, params)
                    }
                }
            }
            stream.AddWatchFunction("watchMyTradesForSymbols", []interface{}{symbols, nil, nil, params})
        
                retRes338815 :=  (<-this.WatchMyTradesForSymbols(symbols, nil, nil, params))
...
func  (this *Exchange) UnsubscribeMyTradesForSymbols(symbols interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    if IsTrue(this.IsEmpty(symbols)) {
        ...
        for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
            stream.Unsubscribe(Add("myTrades::", GetValue(symbols, i)), callback)
        }
    }
    return true
}
...
func  (this *Exchange) SubscribeOrdersForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            if IsTrue(!IsEqual(callback, nil)) {
                for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                    stream.Subscribe(Add("orders::", GetValue(symbols, i)), callback, params)
                }
                if IsTrue(this.IsEmpty(symbols)) {
                    stream.Subscribe("orders", callback, params)
                }
            }
            stream.AddWatchFunction("watchOrdersForSymbols", []interface{}{symbols, nil, nil, params})
        
                retRes344415 :=  <-this.DerivedExchange.WatchOrdersForSymbols(symbols, nil, nil, params)
...
func  (this *Exchange) UnsubscribeOrdersForSymbols(symbols interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    symbols = this.MarketSymbols(symbols, nil, true)
    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
        stream.Unsubscribe(Add("orders::", GetValue(symbols, i)), callback)
    }
    if IsTrue(this.IsEmpty(symbols)) {
...
func  (this *Exchange) SubscribeOHLCVForSymbols(symbolsAndTimeframes interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            if IsTrue(!IsEqual(callback, nil)) {
                for i := 0; IsLessThan(i, GetArrayLength(symbolsAndTimeframes)); i++ {
                    var symbol interface{} = this.Symbol(GetValue(GetValue(symbolsAndTimeframes, i), 0))
                    var timeframe interface{} = GetValue(GetValue(symbolsAndTimeframes, i), 1)
                    stream.Subscribe(Add(Add(Add(Add("ohlcvs", "::"), symbol), "::"), timeframe), callback, params)
                }
                if IsTrue(this.IsEmpty(symbolsAndTimeframes)) {
                    stream.Subscribe("ohlcvs", callback, params)
                }
            }
            stream.AddWatchFunction("watchOHLCVForSymbols", []interface{}{symbolsAndTimeframes, nil, nil, params})
        
                retRes350015 :=  <-this.DerivedExchange.WatchOHLCVForSymbols(symbolsAndTimeframes, nil, nil, params)
...
func  (this *Exchange) UnsubscribeOHLCVForSymbols(symbolsAndTimeframes interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    for i := 0; IsLessThan(i, GetArrayLength(symbolsAndTimeframes)); i++ {
        var symbol interface{} = this.Symbol(GetValue(GetValue(symbolsAndTimeframes, i), 0))
        var timeframe interface{} = GetValue(GetValue(symbolsAndTimeframes, i), 1)
        stream.Unsubscribe(Add(Add(Add("ohlcvs::", symbol), "::"), timeframe), callback)
    }
    if IsTrue(this.IsEmpty(symbolsAndTimeframes)) {
...
func  (this *Exchange) SubscribeOrderBookForSymbols(symbols interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            if IsTrue(!IsEqual(callback, nil)) {
                for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                    stream.Subscribe(Add("orderbooks::", GetValue(symbols, i)), callback, params)
                }
                if IsTrue(this.IsEmpty(symbols)) {
                    stream.Subscribe("orderbooks", callback, params)
                }
            }
            stream.AddWatchFunction("watchOrderBookForSymbols", []interface{}{symbols, nil, params})
        
                retRes356115 :=  <-this.DerivedExchange.WatchOrderBookForSymbols(symbols, nil, params)
...
func  (this *Exchange) UnsubscribeOrderBookForSymbols(symbols interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    symbols = this.MarketSymbols(symbols, nil, true)
    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
        stream.Unsubscribe(Add("orderbooks::", GetValue(symbols, i)), callback)
    }
    if IsTrue(this.IsEmpty(symbols)) {
...
func  (this *Exchange) SubscribeOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            if !IsTrue(this.IsStreamingEnabled()) {
                ...
                retRes366415 :=  (<-this.SubscribeOrderBookForSymbols([]interface{}{symbol}, callback, params))
...
func  (this *Exchange) UnsubscribeOrderBook(symbol interface{}, callback interface{}) interface{}  {
    /**
     * @method
     ...
     * @returns {boolean} true if the consumer was successfully unsubscribed, false otherwise
     */
    return this.UnsubscribeOrderBookForSymbols([]interface{}{symbol}, callback)
}
...
func  (this *Exchange) IsStreamingEnabled() interface{}  {
...
func  (this *Exchange) SubscribeOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            timeframe := GetArg(optionalArgs, 0, "1m")
            _ = timeframe
            callback := GetArg(optionalArgs, 1, nil)
            _ = callback
            params := GetArg(optionalArgs, 2, map[string]interface{} {})
            _ = params
            if !IsTrue(this.IsStreamingEnabled()) {
            ...
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe(Add(Add(Add("ohlcvs::", symbol), "::"), timeframe), callback, params)
            }
            stream.AddWatchFunction("watchOHLCV", []interface{}{symbol, timeframe, nil, nil, params})
        
                retRes540715 :=  <-this.DerivedExchange.WatchOHLCV(symbol, timeframe, nil, nil, params)
                PanicOnError(retRes540715)
                ch <- retRes540715
                return nil
...
func  (this *Exchange) UnsubscribeOHLCV(symbol interface{}, callback interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    ...
    */
    ...
    var stream *Stream = this.Stream
    symbol = this.Symbol(symbol)
    return stream.Unsubscribe(Add(Add(Add("ohlcvs::", symbol), "::"), timeframe), callback)
}
...
func  (this *Exchange) Fetch2(path interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(this.EnableRateLimit) {
                ...
                retRes618812 := (<-this.Throttle(cost))
                ...
                
                    {
                         func(this *Exchange) (ret_ interface{}) {
                		    defer func() {
                                ...
                                if IsTrue(IsLessThan(i, retries)) {
                                    ...
                                    if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
                                        ...
                                        retRes621028 := (<-this.Sleep(retryDelay))
                                        PanicOnError(retRes621028)
                                    }
                                } else {
                                    panic(e)
                                }
                		    ...
                		    // try block:
                                ...
                                retRes620123 :=  (<-this.Fetch(GetValue(request, "url"), GetValue(request, "method"), GetValue(request, "headers"), GetValue(request, "body")))
                                PanicOnError(retRes620123)
                                ch <- retRes620123
                                return nil
...
func  (this *Exchange) Request(path interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = config
                ...
                retRes622415 :=  (<-this.Fetch2(path, api, method, params, headers, body, config))
                PanicOnError(retRes622415)
                ch <- retRes622415
                return nil
...
func  (this *Exchange) EditLimitBuyOrder(id interface{}, symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes630315 :=  (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
                PanicOnError(retRes630315)
                ch <- retRes630315
                return nil
...
func  (this *Exchange) EditLimitSellOrder(id interface{}, symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes630715 :=  (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
                PanicOnError(retRes630715)
                ch <- retRes630715
                return nil
...
func  (this *Exchange) EditLimitOrder(id interface{}, symbol interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes631115 :=  <-this.DerivedExchange.EditOrder(id, symbol, "limit", side, amount, price, params)
                PanicOnError(retRes631115)
                ch <- retRes631115
                return nil
...
func  (this *Exchange) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63158 := <-this.DerivedExchange.CancelOrder(id, symbol)
            PanicOnError(retRes63158)
        
                retRes631615 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
                PanicOnError(retRes631615)
                ch <- retRes631615
                return nil
...
func  (this *Exchange) EditOrderWithClientOrderId(clientOrderId interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes632115 :=  <-this.DerivedExchange.EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
...
func  (this *Exchange) EditOrderWs(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63258 := <-this.DerivedExchange.CancelOrderWs(id, symbol)
            PanicOnError(retRes63258)
        
                retRes632615 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
                PanicOnError(retRes632615)
                ch <- retRes632615
                return nil
...
func  (this *Exchange) SubscribePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe(Add("positions::", symbol), callback, params)
            }
            stream.AddWatchFunction("watchPosition", []interface{}{symbol, nil, params})
        
                retRes636115 :=  <-this.DerivedExchange.WatchPosition(symbol, params)
                PanicOnError(retRes636115)
                ch <- retRes636115
                return nil
...
func  (this *Exchange) UnsubscribePosition(symbol interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    var stream *Stream = this.Stream
    symbol = this.Symbol(symbol)
    return stream.Unsubscribe(Add("positions::", symbol), callback)
}
...
func  (this *Exchange) SubscribePositions(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            if IsTrue(!IsEqual(callback, nil)) {
                if IsTrue(this.IsEmpty(symbols)) {
                    ...
                    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                        stream.Subscribe(Add("positions::", GetValue(symbols, i)), callback, params)
                    }
                }
            }
            stream.AddWatchFunction("watchPositions", []interface{}{symbols, nil, nil, params})
        
                retRes640215 :=  <-this.DerivedExchange.WatchPositions(symbols, nil, nil, params)
                PanicOnError(retRes640215)
                ch <- retRes640215
                return nil
...
func  (this *Exchange) UnsubscribePositions(callback interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    ...
    */
    ...
    if IsTrue(this.IsEmpty(symbols)) {
        ...
        for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
            stream.Unsubscribe(Add("positions::", GetValue(symbols, i)), callback)
        }
    }
    return true
}
func  (this *Exchange) WatchPositionForSymbols(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes643015 :=  <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
...
func  (this *Exchange) SubscribePositionForSymbols(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            _ = params
                ...
                retRes643415 :=  (<-this.SubscribePositions(symbols, callback, params))
...
func  (this *Exchange) UnsubscribePositionForSymbols(callback interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
...
func  (this *Exchange) SubscribeBalance(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe("balances", callback, params)
            }
            stream.AddWatchFunction("watchBalance", []interface{}{params})
        
                retRes664515 :=  <-this.DerivedExchange.WatchBalance(params)
...
func  (this *Exchange) UnsubscribeBalance(callback interface{}) interface{}  {
    /**
     * @method
...
func  (this *Exchange) FetchFreeBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes666915 :=  (<-this.FetchPartialBalance("free", params))
                PanicOnError(retRes666915)
                ch <- retRes666915
                return nil
...
func  (this *Exchange) FetchUsedBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes667315 :=  (<-this.FetchPartialBalance("used", params))
                PanicOnError(retRes667315)
                ch <- retRes667315
                return nil
...
func  (this *Exchange) FetchTotalBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes667715 :=  (<-this.FetchPartialBalance("total", params))
                PanicOnError(retRes667715)
                ch <- retRes667715
                return nil
...
func  (this *Exchange) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(this.Has, "fetchTransactionFees")) {
                ...
                retRes668815 :=  (<-this.FetchTransactionFees([]interface{}{code}, params))
...
func  (this *Exchange) FetchIsolatedBorrowRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes67298 := (<-this.LoadMarkets())
            PanicOnError(retRes67298)
            if !IsTrue(GetValue(this.Has, "fetchBorrowRates")) {
...
func  (this *Exchange) FetchTickerWs(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Has, "fetchTickersWs")) {
                ...
                retRes694012 := (<-this.LoadMarkets())
                PanicOnError(retRes694012)
...
func  (this *Exchange) SubscribeTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe(Add("tickers::", symbol), callback, params)
            }
            stream.AddWatchFunction("watchTicker", []interface{}{symbol, params})
        
                retRes697915 :=  <-this.DerivedExchange.WatchTicker(symbol, params)
                PanicOnError(retRes697915)
                ch <- retRes697915
                return nil
...
func  (this *Exchange) UnsubscribeTicker(symbol interface{}, callback interface{}) interface{}  {
    /**
     * @method
    ...
    var stream *Stream = this.Stream
    symbol = this.Symbol(symbol)
    return stream.Unsubscribe(Add("tickers::", symbol), callback)
}
...
func  (this *Exchange) SubscribeTickers(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            retRes70368 := (<-this.LoadMarkets())
            PanicOnError(retRes70368)
            symbols = this.MarketSymbols(symbols, nil, true)
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                if IsTrue(this.IsEmpty(symbols)) {
                    stream.Subscribe("tickers", callback, params)
                } else {
                    for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
                        stream.Subscribe(Add("tickers::", GetValue(symbols, i)), callback, params)
                    }
                }
            }
            stream.AddWatchFunction("watchTickers", []interface{}{symbols, params})
        
                retRes704915 :=  <-this.DerivedExchange.WatchTickers(symbols, params)
...
func  (this *Exchange) UnsubscribeTickers(callback interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    ...
    */
    ...
    if IsTrue(this.IsEmpty(symbols)) {
        ...
        for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
            stream.Unsubscribe(Add("tickers::", GetValue(symbols, i)), callback)
        }
    }
    return true
}
...
func  (this *Exchange) FetchOrderWithClientOrderId(clientOrderId interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes709915 :=  <-this.DerivedExchange.FetchOrder("", symbol, extendedParams)
...
func  (this *Exchange) FetchUnifiedOrder(order interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes711415 :=  <-this.DerivedExchange.FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
                PanicOnError(retRes711415)
                ch <- retRes711415
                return nil
...
func  (this *Exchange) CreateTrailingAmountOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
                    ...
                    retRes718919 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func  (this *Exchange) CreateTrailingAmountOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
                    ...
                    retRes721719 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
...
func  (this *Exchange) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
                    ...
                    retRes724519 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes724519)
                    ch <- retRes724519
                    return nil
            }
...
func  (this *Exchange) CreateTrailingPercentOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTrailingPercentOrderWs")) {
                    ...
                    retRes727319 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes727319)
                    ch <- retRes727319
                    return nil
            }
...
func  (this *Exchange) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
                    ...
                    retRes729019 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
...
func  (this *Exchange) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
                    ...
                    retRes730619 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
                    PanicOnError(retRes730619)
                    ch <- retRes730619
                    return nil
            }
...
func  (this *Exchange) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
                    ...
                    retRes732219 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
                    PanicOnError(retRes732219)
                    ch <- retRes732219
                    return nil
            }
...
func  (this *Exchange) CreateMarketOrderWithCostWs(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
                    ...
                    retRes733919 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, cost, 1, params)
                    PanicOnError(retRes733919)
                    ch <- retRes733919
                    return nil
            }
...
func  (this *Exchange) CreateTriggerOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTriggerOrder")) {
                    ...
                    retRes736319 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func  (this *Exchange) CreateTriggerOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTriggerOrderWs")) {
                    ...
                    retRes738719 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes738719)
                    ch <- retRes738719
                    return nil
            }
...
func  (this *Exchange) CreateStopLossOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createStopLossOrder")) {
                    ...
                    retRes741119 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes741119)
                    ch <- retRes741119
                    return nil
            }
...
func  (this *Exchange) CreateStopLossOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createStopLossOrderWs")) {
                    ...
                    retRes743519 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes743519)
                    ch <- retRes743519
                    return nil
            }
...
func  (this *Exchange) CreateTakeProfitOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTakeProfitOrder")) {
                    ...
                    retRes745919 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes745919)
                    ch <- retRes745919
                    return nil
            }
...
func  (this *Exchange) CreateTakeProfitOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
                    ...
                    retRes748319 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
                    PanicOnError(retRes748319)
                    ch <- retRes748319
                    return nil
            }
...
func  (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
                    ...
                    retRes751319 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func  (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
                    ...
                    retRes759319 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
...
func  (this *Exchange) CancelOrderWithClientOrderId(clientOrderId interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes762515 :=  <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
...
func  (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes764715 :=  (<-this.CancelOrders([]interface{}{}, symbol, extendedParams))
...
func  (this *Exchange) SubscribeRaw(callback interface{}, optionalArgs ...interface{})  {
    /**
    * @method
    * @name subscribeRaw
...
func  (this *Exchange) UnsubscribeRaw(callback interface{}) interface{}  {
    /**
     * @method
...
func  (this *Exchange) SubscribeErrors(callback interface{}, optionalArgs ...interface{})  {
    /**
    * @method
...
func  (this *Exchange) UnsubscribeErrors(callback interface{}) interface{}  {
    /**
     * @method
...
func  (this *Exchange) SubscribeOrders(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            if IsTrue(!IsEqual(callback, nil)) {
                if IsTrue(IsEqual(symbol, nil)) {
                    ...
                    stream.Subscribe(Add("orders::", symbol), callback, params)
                }
            }
            stream.AddWatchFunction("watchOrders", []interface{}{symbol, nil, nil, params})
        
                retRes777815 :=  <-this.DerivedExchange.WatchOrders(symbol, nil, nil, params)
                PanicOnError(retRes777815)
                ch <- retRes777815
                return nil
...
func  (this *Exchange) UnsubscribeOrders(callback interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    ...
    */
    ...
    if IsTrue(IsEqual(symbol, nil)) {
        ...
        return stream.Unsubscribe(Add("orders::", symbol), callback)
    }
}
...
func  (this *Exchange) SubscribeMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            */
            ...
            retRes78758 := (<-this.LoadMarkets())
            PanicOnError(retRes78758)
            symbol = this.Symbol(symbol)
            var stream *Stream = this.Stream
            if IsTrue(!IsEqual(callback, nil)) {
                stream.Subscribe(Add("myTrades::", symbol), callback, params)
            }
            stream.AddWatchFunction("watchMyTrades", []interface{}{symbol, nil, nil, params})
        
                retRes788215 :=  <-this.DerivedExchange.WatchMyTrades(symbol, nil, nil, params)
                PanicOnError(retRes788215)
                ch <- retRes788215
                return nil
...
func  (this *Exchange) UnsubscribeMyTrades(callback interface{}, optionalArgs ...interface{}) interface{}  {
    /**
    * @method
    ...
    */
    ...
    var stream *Stream = this.Stream
    symbol = this.Symbol(symbol)
    return stream.Unsubscribe(Add("myTrades::", symbol), callback)
}
...
func  (this *Exchange) CreateLimitOrder(symbol interface{}, side interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes809615 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
                PanicOnError(retRes809615)
                ch <- retRes809615
                return nil
...
func  (this *Exchange) CreateLimitOrderWs(symbol interface{}, side interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes810015 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, params)
                PanicOnError(retRes810015)
                ch <- retRes810015
                return nil
...
func  (this *Exchange) CreateMarketOrder(symbol interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes810415 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
                PanicOnError(retRes810415)
                ch <- retRes810415
                return nil
...
func  (this *Exchange) CreateMarketOrderWs(symbol interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes810815 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, price, params)
                PanicOnError(retRes810815)
                ch <- retRes810815
                return nil
...
func  (this *Exchange) CreateLimitBuyOrder(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes811215 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
                PanicOnError(retRes811215)
                ch <- retRes811215
                return nil
...
func  (this *Exchange) CreateLimitBuyOrderWs(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes811615 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "buy", amount, price, params)
                PanicOnError(retRes811615)
                ch <- retRes811615
                return nil
...
func  (this *Exchange) CreateLimitSellOrder(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes812015 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
                PanicOnError(retRes812015)
                ch <- retRes812015
                return nil
...
func  (this *Exchange) CreateLimitSellOrderWs(symbol interface{}, amount interface{}, price interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes812415 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "sell", amount, price, params)
                PanicOnError(retRes812415)
                ch <- retRes812415
                return nil
...
func  (this *Exchange) CreateMarketBuyOrder(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes812815 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
                PanicOnError(retRes812815)
                ch <- retRes812815
                return nil
...
func  (this *Exchange) CreateMarketBuyOrderWs(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes813215 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "market", "buy", amount, nil, params)
                PanicOnError(retRes813215)
                ch <- retRes813215
                return nil
...
func  (this *Exchange) CreateMarketSellOrder(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes813615 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
                PanicOnError(retRes813615)
                ch <- retRes813615
                return nil
...
func  (this *Exchange) CreateMarketSellOrderWs(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes814015 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "market", "sell", amount, nil, params)
                PanicOnError(retRes814015)
                ch <- retRes814015
                return nil
...
func  (this *Exchange) CreatePostOnlyOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes831015 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes831015)
                ch <- retRes831015
                return nil
...
func  (this *Exchange) CreatePostOnlyOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes831815 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes831815)
                ch <- retRes831815
                return nil
...
func  (this *Exchange) CreateReduceOnlyOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes832615 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes832615)
                ch <- retRes832615
                return nil
...
func  (this *Exchange) CreateReduceOnlyOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes833415 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes833415)
                ch <- retRes833415
                return nil
...
func  (this *Exchange) CreateStopOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes834515 :=  <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes834515)
                ch <- retRes834515
                return nil
...
func  (this *Exchange) CreateStopOrderWs(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes835615 :=  <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
                PanicOnError(retRes835615)
                ch <- retRes835615
                return nil
...
func  (this *Exchange) CreateStopLimitOrder(symbol interface{}, side interface{}, amount interface{}, price interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes836415 :=  <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
                PanicOnError(retRes836415)
                ch <- retRes836415
                return nil
...
func  (this *Exchange) CreateStopLimitOrderWs(symbol interface{}, side interface{}, amount interface{}, price interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes837215 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, query)
                PanicOnError(retRes837215)
                ch <- retRes837215
                return nil
...
func  (this *Exchange) CreateStopMarketOrder(symbol interface{}, side interface{}, amount interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes838015 :=  <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
                PanicOnError(retRes838015)
                ch <- retRes838015
                return nil
...
func  (this *Exchange) CreateStopMarketOrderWs(symbol interface{}, side interface{}, amount interface{}, triggerPrice interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var query interface{} = this.Extend(params, map[string]interface{} {
                ...
                retRes838815 :=  <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, nil, query)
                PanicOnError(retRes838815)
                ch <- retRes838815
                return nil
...
func  (this *Exchange) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Has, "fetchFundingRates")) {
                ...
                retRes877212 := (<-this.LoadMarkets())
                PanicOnError(retRes877212)
...
func  (this *Exchange) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
                ...
                retRes879212 := (<-this.LoadMarkets())
                PanicOnError(retRes879212)
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
                var request interface{} = map[string]interface{} {
                    ...
                    retRes882619 :=  <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
                var request interface{} = map[string]interface{} {
                    ...
                    retRes884819 :=  <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
                    PanicOnError(retRes884819)
                    ch <- retRes884819
                    return nil
            } else {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
                var request interface{} = map[string]interface{} {
                    ...
                    retRes887019 :=  <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func  (this *Exchange) FetchTransactions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            */
            ...
            if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
                    ...
                    retRes908019 :=  <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
                    PanicOnError(retRes908019)
                    ch <- retRes908019
                    return nil
            } else {
...
func  (this *Exchange) CreateStreamOHLCV(symbol interface{}, timeframe interface{}, data interface{}) interface{}  {
    return map[string]interface{} {
        "symbol": symbol,
        "timeframe": timeframe,
        "ohlcv": data,
                ...
                
                    {
                         func(this *Exchange) (ret_ interface{}) {
                		    ...
                		    // try block:
                                    ...
                                    retRes923427 :=  (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
                                    PanicOnError(retRes923427)
                                    ch <- retRes923427
                                    return nil
                            } else {
                
                                    retRes923627 :=  (<-this.CallDynamically(method, symbol, since, limit, params))
                                    PanicOnError(retRes923627)
                                    ch <- retRes923627
                                    return nil
                            }
...
func  (this *Exchange) LoadMarketsAndSignIn() <- chan interface{} {
        ...
        retRes97358 := (<-promiseAll([]interface{}{this.LoadMarkets(), this.SignIn()}))
        PanicOnError(retRes97358)
                return nil
            }()
            return ch
        }
