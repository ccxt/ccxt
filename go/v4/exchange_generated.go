...
func (this *BaseExchange) HandleMarketTypeAndParams(methodName any, optionalArgs ...any) []any {
	...
	if typeVar != nil {
		var paramsOmitted map[string]any = MapTyped(this.Omit(params, []any{"defaultType", "type"}))
		return []any{typeVar, paramsOmitted}
	}
	// type from market
	if market != nil {
...
func (this *BaseExchange) HandleSubTypeAndParams(methodName any, optionalArgs ...any) []any {
	...
	if subTypeInParams != nil {
		...
		var paramsOmitted map[string]any = MapTyped(this.Omit(params, []any{"subType", "defaultSubType"}))
		return []any{subType, paramsOmitted}
	} else {
