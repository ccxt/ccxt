...
func (this *Exchange) WatchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "watchLiquidationsForSymbols")) {
			...
			retRes316419 := (<-this.WatchLiquidationsForSymbols([]any{symbol}, since, limit, params))
			PanicOnError(retRes316419)
			ch <- retRes316419
			return nil
		}
...
func (this *Exchange) WatchFundingRatesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes343115 := (<-this.WatchFundingRates(symbols, params))
		PanicOnError(retRes343115)
		ch <- retRes343115
		return nil
...
func (this *Exchange) Fetch2(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(this.EnableRateLimit) {
			...
			retRes585112 := (<-this.Throttle(cost))
								...
								if IsTrue(IsInstance(e, OperationFailed)) {
									if IsTrue(IsLessThan(i, retries)) {
										...
										if IsTrue(IsTrue((!IsEqual(retryDelay, nil))) && IsTrue((!IsEqual(retryDelay, 0)))) {
											...
											retRes588828 := (<-this.Sleep(retryDelay))
											PanicOnError(retRes588828)
										}
									} else {
										panic(e)
									}
...
func (this *Exchange) Request(path any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes590215 := (<-this.Fetch2(path, api, method, params, headers, body, config))
		PanicOnError(retRes590215)
		ch <- retRes590215
		return nil
...
func (this *Exchange) EditLimitBuyOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes598115 := (<-this.EditLimitOrder(id, symbol, "buy", amount, price, params))
...
func (this *Exchange) EditLimitSellOrder(id any, symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes598515 := (<-this.EditLimitOrder(id, symbol, "sell", amount, price, params))
		PanicOnError(retRes598515)
		ch <- retRes598515
		return nil
...
func (this *Exchange) EditLimitOrder(id any, symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes598915 := <-this.DerivedExchange.EditOrder(id, symbol, "limit", side, amount, price, params)
		PanicOnError(retRes598915)
		ch <- retRes598915
		return nil
...
func (this *Exchange) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59938 := <-this.DerivedExchange.CancelOrder(id, symbol)
		PanicOnError(retRes59938)

		retRes599415 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
		PanicOnError(retRes599415)
		ch <- retRes599415
		return nil
...
func (this *Exchange) EditOrderWithClientOrderId(clientOrderId any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes599915 := <-this.DerivedExchange.EditOrder("", symbol, typeVar, side, amount, price, extendedParams)
		PanicOnError(retRes599915)
		ch <- retRes599915
		return nil
...
func (this *Exchange) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes60038 := <-this.DerivedExchange.CancelOrderWs(id, symbol)
		PanicOnError(retRes60038)

		retRes600415 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) WatchPositionForSymbols(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes602415 := <-this.DerivedExchange.WatchPositions(symbols, since, limit, params)
		PanicOnError(retRes602415)
		ch <- retRes602415
		return nil
...
func (this *Exchange) FetchFreeBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes621115 := (<-this.FetchPartialBalance("free", params))
		PanicOnError(retRes621115)
		ch <- retRes621115
		return nil
...
func (this *Exchange) FetchUsedBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes621515 := (<-this.FetchPartialBalance("used", params))
		PanicOnError(retRes621515)
		ch <- retRes621515
		return nil
...
func (this *Exchange) FetchTotalBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes621915 := (<-this.FetchPartialBalance("total", params))
...
func (this *Exchange) FetchTransactionFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes623015 := (<-this.FetchTransactionFees([]any{code}, params))
		PanicOnError(retRes623015)
		ch <- retRes623015
		return nil
...
func (this *Exchange) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchTickers")) {
			...
			retRes644812 := (<-this.LoadMarkets())
			PanicOnError(retRes644812)
...
func (this *Exchange) FetchMarkPrice(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkPrices")) {
			...
			retRes646512 := (<-this.LoadMarkets())
			PanicOnError(retRes646512)
...
func (this *Exchange) FetchTickerWs(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchTickersWs")) {
			...
			retRes648212 := (<-this.LoadMarkets())
			PanicOnError(retRes648212)
...
func (this *Exchange) FetchOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes655615 := <-this.DerivedExchange.FetchOrder("", symbol, extendedParams)
...
func (this *Exchange) FetchUnifiedOrder(order any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes657115 := <-this.DerivedExchange.FetchOrder(this.SafeString(order, "id"), this.SafeString(order, "symbol"), params)
		PanicOnError(retRes657115)
		ch <- retRes657115
		return nil
...
func (this *Exchange) CreateTrailingAmountOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrder")) {
			...
			retRes664619 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes664619)
			ch <- retRes664619
			return nil
		}
...
func (this *Exchange) CreateTrailingAmountOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingAmountOrderWs")) {
			...
			retRes667419 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes667419)
			ch <- retRes667419
			return nil
		}
...
func (this *Exchange) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTrailingPercentOrder")) {
			...
			retRes670219 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
...
func (this *Exchange) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCost")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))))) {
			...
			retRes674719 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, cost, 1, params)
...
func (this *Exchange) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketBuyOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCost"))) {
			...
			retRes676319 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", cost, 1, params)
...
func (this *Exchange) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Options, "createMarketSellOrderRequiresPrice")) || IsTrue(GetValue(this.Has, "createMarketSellOrderWithCost"))) {
			...
			retRes677919 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", cost, 1, params)
...
func (this *Exchange) CreateMarketOrderWithCostWs(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(GetValue(this.Has, "createMarketOrderWithCostWs")) || IsTrue((IsTrue(GetValue(this.Has, "createMarketBuyOrderWithCostWs")) && IsTrue(GetValue(this.Has, "createMarketSellOrderWithCostWs"))))) {
			...
			retRes679619 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, cost, 1, params)
...
func (this *Exchange) CreateTakeProfitOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrder")) {
			...
			retRes691619 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes691619)
			ch <- retRes691619
			return nil
		}
...
func (this *Exchange) CreateTakeProfitOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createTakeProfitOrderWs")) {
			...
			retRes694019 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes694019)
			ch <- retRes694019
			return nil
		}
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLoss(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLoss")) {
			...
			retRes697019 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes697019)
			ch <- retRes697019
			return nil
		}
...
func (this *Exchange) CreateOrderWithTakeProfitAndStopLossWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "createOrderWithTakeProfitAndStopLossWs")) {
			...
			retRes705019 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, params)
			PanicOnError(retRes705019)
			ch <- retRes705019
			return nil
		}
...
func (this *Exchange) CancelOrderWithClientOrderId(clientOrderId any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes709815 := <-this.DerivedExchange.CancelOrder("", symbol, extendedParams)
...
func (this *Exchange) CancelOrdersWithClientOrderIds(clientOrderIds any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes712015 := (<-this.CancelOrders([]any{}, symbol, extendedParams))
		PanicOnError(retRes712015)
		ch <- retRes712015
		return nil
...
func (this *Exchange) CreateLimitOrder(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes743215 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateLimitOrderWs(symbol any, side any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes743615 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, params)
...
func (this *Exchange) CreateMarketOrder(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes744015 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, price, params)
...
func (this *Exchange) CreateMarketOrderWs(symbol any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes744415 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, price, params)
...
func (this *Exchange) CreateLimitBuyOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes744815 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "buy", amount, price, params)
...
func (this *Exchange) CreateLimitBuyOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes745215 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "buy", amount, price, params)
...
func (this *Exchange) CreateLimitSellOrder(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes745615 := <-this.DerivedExchange.CreateOrder(symbol, "limit", "sell", amount, price, params)
...
func (this *Exchange) CreateLimitSellOrderWs(symbol any, amount any, price any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes746015 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", "sell", amount, price, params)
		PanicOnError(retRes746015)
		ch <- retRes746015
		return nil
...
func (this *Exchange) CreateMarketBuyOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes746415 := <-this.DerivedExchange.CreateOrder(symbol, "market", "buy", amount, nil, params)
...
func (this *Exchange) CreateMarketBuyOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes746815 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", "buy", amount, nil, params)
		PanicOnError(retRes746815)
		ch <- retRes746815
		return nil
...
func (this *Exchange) CreateMarketSellOrder(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes747215 := <-this.DerivedExchange.CreateOrder(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes747215)
		ch <- retRes747215
		return nil
...
func (this *Exchange) CreateMarketSellOrderWs(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes747615 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", "sell", amount, nil, params)
		PanicOnError(retRes747615)
		ch <- retRes747615
		return nil
...
func (this *Exchange) CreatePostOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes764615 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateReduceOnlyOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes766215 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateReduceOnlyOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes767015 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes768115 := <-this.DerivedExchange.CreateOrder(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes769215 := <-this.DerivedExchange.CreateOrderWs(symbol, typeVar, side, amount, price, query)
...
func (this *Exchange) CreateStopLimitOrder(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes770015 := <-this.DerivedExchange.CreateOrder(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes770015)
		ch <- retRes770015
		return nil
...
func (this *Exchange) CreateStopLimitOrderWs(symbol any, side any, amount any, price any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes770815 := <-this.DerivedExchange.CreateOrderWs(symbol, "limit", side, amount, price, query)
		PanicOnError(retRes770815)
		ch <- retRes770815
		return nil
...
func (this *Exchange) CreateStopMarketOrder(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes771615 := <-this.DerivedExchange.CreateOrder(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes771615)
		ch <- retRes771615
		return nil
...
func (this *Exchange) CreateStopMarketOrderWs(symbol any, side any, amount any, triggerPrice any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes772415 := <-this.DerivedExchange.CreateOrderWs(symbol, "market", side, amount, nil, query)
		PanicOnError(retRes772415)
		ch <- retRes772415
		return nil
...
func (this *Exchange) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchFundingIntervals")) {
			...
			retRes812812 := (<-this.LoadMarkets())
			PanicOnError(retRes812812)
...
func (this *Exchange) FetchMarkOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchMarkOHLCV")) {
			...
			retRes816219 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes816219)
			ch <- retRes816219
			return nil
		} else {
...
func (this *Exchange) FetchIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchIndexOHLCV")) {
			...
			retRes818419 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
...
func (this *Exchange) FetchPremiumIndexOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchPremiumIndexOHLCV")) {
			...
			retRes820619 := <-this.DerivedExchange.FetchOHLCV(symbol, timeframe, since, limit, this.Extend(request, params))
			PanicOnError(retRes820619)
			ch <- retRes820619
			return nil
		} else {
...
func (this *Exchange) FetchTransactions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Has, "fetchDepositsWithdrawals")) {
			...
			retRes841619 := <-this.DerivedExchange.FetchDepositsWithdrawals(code, since, limit, params)
			PanicOnError(retRes841619)
			ch <- retRes841619
			return nil
		} else {
...

			{
				func(this *Exchange) (ret_ any) {
					...
					if IsTrue(IsTrue(timeframe) && IsTrue(!IsEqual(method, "fetchFundingRateHistory"))) {
						...
						retRes856227 := (<-this.CallDynamically(method, symbol, timeframe, since, limit, params))
						PanicOnError(retRes856227)
						ch <- retRes856227
						return nil
					} else {

						retRes856427 := (<-this.CallDynamically(method, symbol, since, limit, params))
						PanicOnError(retRes856427)
						ch <- retRes856427
						return nil
					}
...
func (this *Exchange) LoadMarketsAndSignIn() <-chan any {
	...
	go func() any {
		...
		retRes90638 := (<-promiseAll([]any{this.LoadMarkets(), <-this.callInternal("signIn")}))
		PanicOnError(retRes90638)
		return nil
	}()
	return ch
}
