...
func (this *BitmexCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes107519 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
			PanicOnError(retRes107519)
			ch <- retRes107519
			return nil
		}
		var market any = nil
...
func (this *BitmexCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes112215 := (<-this.FetchOrders(symbol, since, limit, this.DeepExtend(request, params)))
...
func (this *BitmexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes115919 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
			PanicOnError(retRes115919)
			ch <- retRes115919
			return nil
		}
		var market any = nil
...
func (this *BitmexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes283615 := (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
...
func (this *BitmexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes286715 := (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
		PanicOnError(retRes286715)
		ch <- retRes286715
		return nil
...
func (this *BitmexCore) FetchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes311219 := (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
...
func (this *BitmexCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes35298 := (<-this.LoadMarkets())
		PanicOnError(retRes35298)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
			"side":     this.Capitalize(side),
