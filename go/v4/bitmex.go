...
func (this *BitmexCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes114219 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
			PanicOnError(retRes114219)
			ch <- retRes114219
			return nil
		}
		var market any = nil
...
func (this *BitmexCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes118915 := (<-this.FetchOrders(symbol, since, limit, this.DeepExtend(request, params)))
...
func (this *BitmexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes122619 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
...
func (this *BitmexCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes172619 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params))
			PanicOnError(retRes172619)
			ch <- retRes172619
			return nil
		}
...
func (this *BitmexCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes204419 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes204419)
			ch <- retRes204419
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BitmexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes290315 := (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
...
func (this *BitmexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes293415 := (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
		PanicOnError(retRes293415)
		ch <- retRes293415
		return nil
...
func (this *BitmexCore) FetchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes317919 := (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
