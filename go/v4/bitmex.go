...
func (this *BitmexCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes115019 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
			PanicOnError(retRes115019)
			ch <- retRes115019
			return nil
		}
		var market any = nil
...
func (this *BitmexCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes119715 := (<-this.FetchOrders(symbol, since, limit, this.DeepExtend(request, params)))
		PanicOnError(retRes119715)
		ch <- retRes119715
		return nil
...
func (this *BitmexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes123619 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
			PanicOnError(retRes123619)
			ch <- retRes123619
			return nil
		}
		var market any = nil
...
func (this *BitmexCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes174619 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params))
...
func (this *BitmexCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes206719 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *BitmexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes295015 := (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
...
func (this *BitmexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes298315 := (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
		PanicOnError(retRes298315)
		ch <- retRes298315
		return nil
...
func (this *BitmexCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes299812 := (<-this.LoadMarkets())
			PanicOnError(retRes299812)
		}
		var networkCode any = nil
		networkCodeparamsVariable := this.HandleNetworkCodeAndParams(params)
		networkCode = GetValue(networkCodeparamsVariable, 0)
...
func (this *BitmexCore) FetchOpenInterests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes314612 := (<-this.LoadMarkets())
			PanicOnError(retRes314612)
		}
		var request any = map[string]any{}
...
func (this *BitmexCore) FetchLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes323619 := (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
...
func (this *BitmexCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes365812 := (<-this.LoadMarkets())
			PanicOnError(retRes365812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
