...
func  (this *BitmexCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes165819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params))
                    PanicOnError(retRes165819)
                    ch <- retRes165819
                    return nil
            }
...
func  (this *BitmexCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes197619 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes197619)
                    ch <- retRes197619
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *BitmexCore) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes283415 :=  (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
                PanicOnError(retRes283415)
                ch <- retRes283415
                return nil
...
func  (this *BitmexCore) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes286515 :=  (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
...
func  (this *BitmexCore) FetchLiquidations(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes310919 :=  (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
...
func  (this *BitmexCore) FetchSettlementHistory(optionalArgs ...any) <- chan any {
            ...
            retRes34438 := (<-this.LoadMarkets())
            PanicOnError(retRes34438)
            var request any = map[string]any {}
            var market any = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
