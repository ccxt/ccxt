...
func  (this *bitmex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83747 := (<-this.LoadMarkets())
            PanicOnError(retRes83747)
...
func  (this *bitmex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes947946 := (<-this.LoadMarkets())
            PanicOnError(retRes947946)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitmex) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes558101 := (<-this.LoadMarkets())
            PanicOnError(retRes558101)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes842182 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes842182)
                    ch <- retRes842182
                    return nil
            }
...
func  (this *bitmex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes571975 :=  (<-this.FetchOrders(symbol, since, limit, this.DeepExtend(request, params)))
                PanicOnError(retRes571975)
                ch <- retRes571975
                return nil
...
func  (this *bitmex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes229239 := (<-this.LoadMarkets())
            PanicOnError(retRes229239)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes883118 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes883118)
                    ch <- retRes883118
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitmex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes428473 := (<-this.LoadMarkets())
            PanicOnError(retRes428473)
            var request interface{} = map[string]interface{} {}
            //
            //     if (since !== undefined) {
...
func  (this *bitmex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes632450 := (<-this.LoadMarkets())
            PanicOnError(retRes632450)
            var request interface{} = map[string]interface{} {
                "currency": "all",
            }
            //
...
func  (this *bitmex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319194 := (<-this.LoadMarkets())
            PanicOnError(retRes319194)
...
func  (this *bitmex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes994490 := (<-this.LoadMarkets())
            PanicOnError(retRes994490)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes663094 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params))
                    PanicOnError(retRes663094)
                    ch <- retRes663094
                    return nil
            }
...
func  (this *bitmex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes622075 := (<-this.LoadMarkets())
            PanicOnError(retRes622075)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes105776 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes105776)
                    ch <- retRes105776
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitmex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583693 := (<-this.LoadMarkets())
            PanicOnError(retRes583693)
            var market interface{} = this.Market(symbol)
...
func  (this *bitmex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes400092 := (<-this.LoadMarkets())
            PanicOnError(retRes400092)
            var request interface{} = map[string]interface{} {}
            var trailingAmount interface{} = this.SafeString2(params, "trailingAmount", "pegOffsetValue")
            var isTrailingAmountOrder interface{} = !IsEqual(trailingAmount, nil)
            if IsTrue(isTrailingAmountOrder) {
...
func  (this *bitmex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes717118 := (<-this.LoadMarkets())
            PanicOnError(retRes717118)
...
func  (this *bitmex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96969 := (<-this.LoadMarkets())
            PanicOnError(retRes96969)
            // https://github.com/ccxt/ccxt/issues/6507
            var clientOrderId interface{} = this.SafeValue2(params, "clOrdID", "clientOrderId")
            var request interface{} = map[string]interface{} {}
            if IsTrue(IsEqual(clientOrderId, nil)) {
...
func  (this *bitmex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95420 := (<-this.LoadMarkets())
            PanicOnError(retRes95420)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitmex) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272968 := (<-this.LoadMarkets())
            PanicOnError(retRes272968)
            var request interface{} = map[string]interface{} {
...
func  (this *bitmex) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes128425 := (<-this.LoadMarkets())
            PanicOnError(retRes128425)
...
func  (this *bitmex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes369460 := (<-this.LoadMarkets())
            PanicOnError(retRes369460)
...
func  (this *bitmex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes914571 := (<-this.LoadMarkets())
            PanicOnError(retRes914571)
            var currency interface{} = this.Currency(code)
...
func  (this *bitmex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272226 := (<-this.LoadMarkets())
            PanicOnError(retRes272226)
...
func  (this *bitmex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes821899 := (<-this.LoadMarkets())
            PanicOnError(retRes821899)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitmex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes138527 := (<-this.LoadMarkets())
            PanicOnError(retRes138527)
            var market interface{} = this.Market(symbol)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes799956 :=  (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
                PanicOnError(retRes799956)
                ch <- retRes799956
                return nil
...
func  (this *bitmex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes866842 := (<-this.LoadMarkets())
            PanicOnError(retRes866842)
            var market interface{} = this.Market(symbol)
            if IsTrue(IsTrue((!IsEqual(GetValue(market, "type"), "swap"))) && IsTrue((!IsEqual(GetValue(market, "type"), "future")))) {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes335165 :=  (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
                PanicOnError(retRes335165)
                ch <- retRes335165
                return nil
...
func  (this *bitmex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279917 := (<-this.LoadMarkets())
            PanicOnError(retRes279917)
            var networkCode interface{} = nil
            networkCodeparamsVariable := this.HandleNetworkCodeAndParams(params);
            networkCode = GetValue(networkCodeparamsVariable,0);
            params = GetValue(networkCodeparamsVariable,1)
...
func  (this *bitmex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes469765 := (<-this.LoadMarkets())
            PanicOnError(retRes469765)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes617416 :=  (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
                    PanicOnError(retRes617416)
                    ch <- retRes617416
                    return nil
            }
            var market interface{} = this.Market(symbol)
