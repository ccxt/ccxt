...
func (this *Bitmex) fetchCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetWalletAssets(params)).Raw))
...
func (this *Bitmex) ParseCurrency(currency any) any {
	...
	for j := 0; j < len(chains); j++ {
		...
		if isDepositEnabled != nil && *isDepositEnabled == true {
			depositEnabled = true
		}
...
func (this *Bitmex) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetInstrumentActive(params)).Raw))
...
func (this *Bitmex) ParseMarket(market any) any {
	...
	var linear any = func() any {
		if contract {
			return ((isInverse != true) && (isQuanto != true))
		}
		return nil
	}()
	...
	var position *string = this.SafeCurrencyCode(positionId)
	...
	if IsEqual(symbol, nil) {
		panic(ArgumentsRequired(this.Id + " parseMarket() requires a symbol"))
	}
...
func (this *Bitmex) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivateGetUserMargin(this.Extend(request, params))).Raw))
...
func (this *Bitmex) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, nil, nil, this.DeepExtend(filter, params)))))
...
func (this *Bitmex) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes119219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchOrders", symbol, since, limit, params, 100))))
	...
	if func() bool { _, ok := request["filter"]; return ok }() {
		request["filter"] = this.Json(request["filter"])
	}

	var response []any = ListTyped(PanicOnError((<-this.PrivateGetOrder(request)).Raw))
...
func (this *Bitmex) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes123915 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, this.DeepExtend(request, params)))))
	ch <- BoxAbsent(retRes123915)
	return nil
}
...
func (this *Bitmex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes127819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params, 100))))
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetExecutionTradeHistory(request)).Raw))
...
func (this *Bitmex) ParseLedgerEntry(item any, optionalArgs ...any) any {
	...
	var typeVar *string = this.ParseLedgerEntryType(this.SafeString(item, "transactType"))
	...
	var timestamp any = DerefScalar(this.Parse8601(this.SafeString(item, "transactTime")))
	...
	var status *string = this.ParseTransactionStatus(this.SafeString(item, "transactStatus"))
...
func (this *Bitmex) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var transactTime *int64 = this.Parse8601(this.SafeString(transaction, "transactTime"))
	var timestamp *int64 = this.Parse8601(this.SafeString(transaction, "timestamp"))
	...
	var status *string = this.SafeString(transaction, "transactStatus")
	if status != nil {
...
func (this *Bitmex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = MapTyped(GetValue(useOpenTimestampparamsVariable, 1))
	...
	if since != nil {
		...
		var startTime *string = this.Iso8601(timestamp)
...
func (this *Bitmex) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var execCost *string = this.NumberToString(this.ConvertFromRawCost(symbol, this.SafeString(trade, "execCost")))
...
func (this *Bitmex) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes211019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, params))))
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetTrade(this.Extend(request, params))).Raw))
...
func (this *Bitmex) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"reduceOnly", "postOnly"}))
	...
	if isTriggerOrder || isTrailingAmountOrder {
		...
		params = MapTyped(this.Omit(params, []any{"triggerPrice", "stopPrice", "stopPx", "triggerDirection", "trailingAmount"}))
	}
...
func (this *Bitmex) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if isTrailingAmountOrder {
		...
		request["pegOffsetValue"] = this.ParseToNumeric(trailingAmount)
		params = MapTyped(this.Omit(params, []any{"triggerDirection", "trailingAmount"}))
	}
	...
	if origClOrdID != nil {
		...
		params = MapTyped(this.Omit(params, []any{"origClOrdID", "clOrdID", "clientOrderId"}))
	} else {
		request["orderID"] = id
	}
	if amount != nil {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivatePutOrder(this.Extend(request, params))).Raw))
...
func (this *Bitmex) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetPosition(params)).Raw))
	//
	//     [
	//         {
	//             "account": 0,
...
func (this *Bitmex) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivatePostUserRequestWithdrawal(this.Extend(request, params))).Raw))
...
func (this *Bitmex) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetFunding(this.Extend(request, params))).Raw))
...
func (this *Bitmex) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if (IsLessThan(leverage, 0.01)) || (IsGreaterThan(leverage, 100)) {
		panic(BadRequest(this.Id + " leverage should be between 0.01 and 100"))
	}
	if this.Markets == nil {
...
func (this *Bitmex) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	ch <- map[string]any{
		...
		"currency": code,
		"network":  networkCode,
		"address":  strings.Replace(Replace(response, "\"", ""), "\"", "", 1),
		"tag":      nil,
	}
	return nil
}
...
func (this *Bitmex) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	var assets []any = ListTyped(PanicOnError((<-this.PublicGetWalletAssets(params)).Raw))
...
func (this *Bitmex) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var quoteSymbol *string = this.SafeCurrencyCode(quoteId)
	var baseSymbol *string = this.SafeCurrencyCode(baseId)
	...
	var openValue *float64 = this.SafeNumber(interest, "openValue")
...
func (this *Bitmex) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes328819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchLiquidations", symbol, since, limit, params))))
		ch <- BoxAbsent(retRes328819)
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Bitmex) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetSettlement(this.Extend(request, params))).Raw))
...
func (this *Bitmex) Sign(path any, optionalArgs ...any) any {
	...
	if method == "GET" {
		...
		if format != nil {
			query = Add(query, "?"+this.Urlencode(map[string]any{
				"_format": format,
			}))
	...
	if (IsEqual(api, "private")) || ((IsEqual(api, "public")) && isAuthenticated) {
		...
		if IsEqual(expires, nil) {
			panic(ExchangeError(this.Id + " sign() missing expires"))
		}
...
// nolint
func (this *Bitmex) LoadMarkets(params ...any) (map[string]MarketInterface, error) {
...
func (this *Bitmex) FetchAccounts(params ...any) ([]Account, error) {
	return this.exchangeTyped.FetchAccounts(params...)
}
func (this *Bitmex) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {
...
func (this *Bitmex) FetchBorrowRate(code string, amount float64, options ...FetchBorrowRateOptions) (map[string]any, error) {
...
func (this *Bitmex) FetchConvertCurrencies(params ...any) (Currencies, error) {
...
func (this *Bitmex) FetchCrossBorrowRates(params ...any) (CrossBorrowRates, error) {
...
func (this *Bitmex) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {
...
func (this *Bitmex) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {
	return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)
}
func (this *Bitmex) FetchFreeBalance(params ...any) (Balance, error) {
...
func (this *Bitmex) FetchIsolatedBorrowRates(params ...any) (IsolatedBorrowRates, error) {
...
func (this *Bitmex) FetchPaymentMethods(params ...any) (map[string]any, error) {
...
func (this *Bitmex) FetchTradingFees(params ...any) (TradingFees, error) {
	return this.exchangeTyped.FetchTradingFees(params...)
}
func (this *Bitmex) FetchTradingLimits(options ...FetchTradingLimitsOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchTradingLimits(options...)
}
func (this *Bitmex) FetchTransactionFee(code string, options ...FetchTransactionFeeOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchTransactionFee(code, options...)
}
func (this *Bitmex) FetchTransactionFees(options ...FetchTransactionFeesOptions) (map[string]any, error) {
...
func (this *Bitmex) SetPositionMode(hedged bool, options ...SetPositionModeOptions) (map[string]any, error) {
...
func (this *Bitmex) FetchBalanceWs(params ...any) (Balances, error) {
...
func (this *Bitmex) UnWatchMyTrades(options ...UnWatchMyTradesOptions) (any, error) {
	return this.exchangeTyped.UnWatchMyTrades(options...)
}
func (this *Bitmex) UnWatchOHLCV(symbol string, options ...UnWatchOHLCVOptions) (any, error) {
	return this.exchangeTyped.UnWatchOHLCV(symbol, options...)
}
func (this *Bitmex) UnWatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...UnWatchOHLCVForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchOHLCVForSymbols(symbolsAndTimeframes, options...)
}
func (this *Bitmex) UnWatchOrderBook(symbol string, options ...UnWatchOrderBookOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrderBook(symbol, options...)
}
func (this *Bitmex) UnWatchOrderBookForSymbols(symbols []string, options ...UnWatchOrderBookForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrderBookForSymbols(symbols, options...)
}
func (this *Bitmex) UnWatchOrders(options ...UnWatchOrdersOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrders(options...)
}
func (this *Bitmex) UnWatchTicker(symbol string, options ...UnWatchTickerOptions) (any, error) {
	return this.exchangeTyped.UnWatchTicker(symbol, options...)
}
func (this *Bitmex) UnWatchTickers(options ...UnWatchTickersOptions) (any, error) {
	return this.exchangeTyped.UnWatchTickers(options...)
}
func (this *Bitmex) UnWatchTrades(symbol string, options ...UnWatchTradesOptions) (any, error) {
	return this.exchangeTyped.UnWatchTrades(symbol, options...)
}
func (this *Bitmex) UnWatchTradesForSymbols(symbols []string, options ...UnWatchTradesForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchTradesForSymbols(symbols, options...)
}
func (this *Bitmex) WatchBalance(params ...any) (Balances, error) {
