...
func (this *BitmexCore) ParseCurrency(currency any) any {
	...
	for j := 0; IsLessThan(j, GetArrayLength(chains)); j++ {
		...
		var active bool = (EvalTruthy(isDepositEnabled) && EvalTruthy(isWithdrawEnabled))
		if EvalTruthy(isDepositEnabled) {
			depositEnabled = true
		}
		if EvalTruthy(isWithdrawEnabled) {
	...
	var currencyActive bool = EvalTruthy(currencyEnabled) || (depositEnabled || withdrawEnabled)
...
func (this *BitmexCore) AmountToPrecision(symbol any, amount any) any {
	...
	if EvalTruthy(GetValue(market, "spot")) && !EvalTruthy(oldPrecision) {
...
func (this *BitmexCore) ConvertFromRawQuantity(symbol any, rawQuantity any, optionalArgs ...any) any {
	...
	_ = currencySide
	if EvalTruthy(this.SafeValue(this.Options, "oldPrecision")) {
...
func (this *BitmexCore) ParseMarket(market any) any {
	...
	var linear any = Ternary(contract, (!EvalTruthy(isInverse) && !EvalTruthy(isQuanto)), nil)
