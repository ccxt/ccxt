 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Modetrade) CancelOrder(id string, options ...CancelOrderOptions) (map[string]interface{}, error) {
 ...
 * @returns {object} an list of [order structures]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Modetrade) CancelAllOrders(options ...CancelAllOrdersOptions) ([]map[string]interface{}, error) {
