...
func  (this *GeminiCore) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes40715 :=  (<-this.FetchCurrenciesFromWeb(params))
                PanicOnError(retRes40715)
                ch <- retRes40715
                return nil
...
func  (this *GeminiCore) ParseMarket(response interface{}) interface{}  {
    ...
    var tickSize interface{}
    var amountPrecision interface{}
    var minSize interface{}
...
func  (this *GeminiCore) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickerV1")) {
                    ...
                    retRes97819 :=  (<-this.FetchTickerV1(symbol, params))
                    PanicOnError(retRes97819)
                    ch <- retRes97819
                    return nil
            }
            if IsTrue(IsEqual(method, "fetchTickerV2")) {
        
                    retRes98119 :=  (<-this.FetchTickerV2(symbol, params))
                    PanicOnError(retRes98119)
                    ch <- retRes98119
                    return nil
            }
        
                retRes98315 :=  (<-this.FetchTickerV1AndV2(symbol, params))
                PanicOnError(retRes98315)
                ch <- retRes98315
                return nil
