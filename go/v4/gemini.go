...
func (this *GeminiCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes53115 := (<-this.FetchMarketsFromAPI(params))
	PanicOnError(retRes53115)
	ch <- retRes53115
	return nil
}
...
func (this *GeminiCore) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(method, "fetchTickerV1") {
		...
		retRes99819 := (<-this.FetchTickerV1(symbol, params))
		PanicOnError(retRes99819)
		ch <- retRes99819
		return nil
	}
	if IsEqual(method, "fetchTickerV2") {

		retRes100119 := (<-this.FetchTickerV2(symbol, params))
		PanicOnError(retRes100119)
		ch <- retRes100119
		return nil
	}

	retRes100315 := (<-this.FetchTickerV1AndV2(symbol, params))
