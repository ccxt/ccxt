...
func (this *Upbit) ParseMarket(market any) any {
	...
	quoteIdbaseIdVariable := strings.Split(*id, "-")
	...
	return this.SafeMarketStructure(map[string]any{
		...
		"linear":         nil,
		"inverse":        nil,
		"taker":          this.SafeNumber(GetValue(this.Options, "tradingFeesByQuoteCurrency"), quote, GetValue(this.Fees["trading"], "taker")),
		"maker":          this.SafeNumber(GetValue(this.Options, "tradingFeesByQuoteCurrency"), quote, GetValue(this.Fees["trading"], "maker")),
		"contractSize":   nil,
		"expiry":         nil,
		"expiryDatetime": nil,
		"strike":         nil,
...
func (this *Upbit) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(symbolsNormalized, nil) {
		...
		for i := 0; i < len(sortedQuoteIds); i++ {
...
func (this *Upbit) CalcOrderPrice(symbol any, amount any, optionalArgs ...any) any {
	...
	if cost != nil {
		...
		if IsEqual(amount, nil) {
			panic(ArgumentsRequired(this.Id + " When createMarketBuyOrderRequiresPrice is false, \"amount\" is required and should be the total quote amount to spend."))
		}
		quoteAmount = this.CostToPrecision(symbol, amount)
	}
	if quoteAmount == nil {
		panic(ArgumentsRequired(this.Id + " calcOrderPrice() could not determine quote amount"))
	}
	return quoteAmount
}
...
func (this *Upbit) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	...
	if typeVar == "limit" {
		...
		if side == "buy" {
			...
			if IsEqual(amount, nil) {
				panic(ArgumentsRequired(this.Id + " the market sell type order in createOrder() is required amount."))
			}
	...
	if customType != nil && *customType == "best" {
		...
		if side == "buy" {
			...
			if IsEqual(amount, nil) {
				panic(ArgumentsRequired(this.Id + " the best sell type order in createOrder() is required amount."))
			}
			request["volume"] = this.AmountToPrecision(symbol, amount)
		}
	}
	...
	if timeInForce != nil {
		if (timeInForce != nil && *timeInForce == "ioc") || (timeInForce != nil && *timeInForce == "fok") {
...
func (this *Upbit) FetchCurrency(code string, options ...FetchCurrencyOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchCurrencyAsync(code, opts.Params))
	if res.Err != nil {
...
func (this *Upbit) FetchCurrencyById(id string, options ...FetchCurrencyByIdOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchCurrencyByIdAsync(id, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value, nil
...
func (this *Upbit) FetchMarket(symbol string, options ...FetchMarketOptions) (MarketInterface, error) {
	...
	var res AsyncResult[MarketInterface] = AwaitResult(NewMarketInterface, this.FetchMarketAsync(symbol, opts.Params))
	if res.Err != nil {
		return MarketInterface{}, res.Err
	}
	return res.Value, nil
}
func (this *Upbit) FetchMarketById(id string, options ...FetchMarketByIdOptions) (MarketInterface, error) {
	...
	var res AsyncResult[MarketInterface] = AwaitResult(NewMarketInterface, this.FetchMarketByIdAsync(id, opts.Params))
	if res.Err != nil {
		return MarketInterface{}, res.Err
	}
	return res.Value, nil
