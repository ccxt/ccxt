 ...
 */
func  (this *P2b) FetchMarkets(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchTickers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchTicker(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchBalance(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *P2b) CancelOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchOpenOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *P2b) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {Trade[]} a list of [trade structures]{@link https://docs.ccxt.com/?id=public-trades}
 */
func  (this *P2b) FetchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *P2b) FetchClosedOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *P2b) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *P2b) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
...
func (this *P2b) FetchDepositWithdrawFee(code string, options ...FetchDepositWithdrawFeeOptions) (DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *P2b) FetchDepositWithdrawFees(options ...FetchDepositWithdrawFeesOptions) (DepositWithdrawFees, error) {return this.exchangeTyped.FetchDepositWithdrawFees(options...)}
...
func (this *P2b) FetchPositionMode(options ...FetchPositionModeOptions) (PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *P2b) FetchStatus(params ...any) (Status, error) {return this.exchangeTyped.FetchStatus(params...)}
...
func (this *P2b) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *P2b) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
