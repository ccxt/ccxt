...
func (this *Coinex) fetchContractMarketsBody(ch chan any, params any) any {
	...
	for i := 0; i < len(markets); i++ {
		...
		var leverages []any = SafeListTypedDefault(entry, "leverage", []any{})
...
func (this *Coinex) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(typeVar, "swap") {
		...
		response = MapTyped(PanicOnError((<-this.V2PublicGetFuturesMarket(params)).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.V2PublicGetSpotMarket(params)).Raw))
	}
...
func (this *Coinex) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "swap" {
		...
		var retRes189519 map[string]any = MapTyped(PanicOnError((<-this.FetchMarginBalanceAsync(params))))
		ch <- BoxAbsent(retRes189519)
		return nil
	} else {

		var retRes189719 map[string]any = MapTyped(PanicOnError((<-this.FetchSpotBalanceAsync(params))))
		ch <- BoxAbsent(retRes189719)
		return nil
	}
}
...
func (this *Coinex) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	var retRes220115 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))))
	ch <- BoxAbsent(retRes220115)
	return nil
}
func (this *Coinex) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"reduceOnly", "timeInForce", "postOnly", "stopPrice", "triggerPrice", "stopLossPrice", "takeProfitPrice"}))
...
func (this *Coinex) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if GetValue(market, "spot") == true {
		if trigger != nil && *trigger == true {
			...
			response = MapTyped(PanicOnError((<-this.V2PrivatePostSpotCancelBatchStopOrder(this.Extend(request, params))).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.V2PrivatePostSpotCancelBatchOrder(this.Extend(request, params))).Raw))
		}
	} else {
		request["market_type"] = "FUTURES"
		if trigger != nil && *trigger == true {

			response = MapTyped(PanicOnError((<-this.V2PrivatePostFuturesCancelBatchStopOrder(this.Extend(request, params))).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.V2PrivatePostFuturesCancelBatchOrder(this.Extend(request, params))).Raw))
		}
	}
	var data []any = SafeListTyped(response, "data")
	var results []any = []any{}
...
func (this *Coinex) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"stopPrice", "triggerPrice"}))
	var isTriggerOrder bool = (triggerPrice != nil)
	if isTriggerOrder {
		request["trigger_price"] = this.PriceToPrecision(symbol, triggerPrice)
...
func (this *Coinex) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var clientOrderId *string = this.SafeString2(params, "client_id", "clientOrderId")
	params = MapTyped(this.Omit(params, []any{"stop", "trigger", "clientOrderId"}))
	var response any = nil
	if clientOrderId != nil {
		request["client_id"] = clientOrderId
...
func (this *Coinex) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		response = MapTyped(PanicOnError((<-this.V2PrivatePostSpotCancelAllOrder(this.Extend(request, params))).Raw))
	}
	...
	if marketType != nil && *marketType == "swap" {
		...
		if isClosed {
			if trigger != nil && *trigger == true {
				...
				response = MapTyped(PanicOnError((<-this.V2PrivateGetFuturesFinishedStopOrder(this.Extend(request, params))).Raw))
			} else {

				response = MapTyped(PanicOnError((<-this.V2PrivateGetFuturesFinishedOrder(this.Extend(request, params))).Raw))
			}
		} else if isOpen {
			if trigger != nil && *trigger == true {

				response = MapTyped(PanicOnError((<-this.V2PrivateGetFuturesPendingStopOrder(this.Extend(request, params))).Raw))
			} else {

				response = MapTyped(PanicOnError((<-this.V2PrivateGetFuturesPendingOrder(this.Extend(request, params))).Raw))
			}
		}
	} else {
		var marginMode any = nil
		...
		if isClosed {
			if trigger != nil && *trigger == true {
				...
				response = MapTyped(PanicOnError((<-this.V2PrivateGetSpotFinishedStopOrder(this.Extend(request, params))).Raw))
			} else {
			...
			if trigger != nil && *trigger == true {
				...
				response = MapTyped(PanicOnError((<-this.V2PrivateGetSpotPendingOrder(this.Extend(request, params))).Raw))
			}
		}
	}
	var data []any = SafeListTypedDefault(response, "data", []any{})
...
func (this *Coinex) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes396515 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStatusAsync("finished", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes396515)
	return nil
}
...
func (this *Coinex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		response = MapTyped(PanicOnError((<-this.V2PrivateGetSpotUserDeals(this.Extend(request, params))).Raw))
	}
	var data []any = SafeListTypedDefault(response, "data", []any{})
...
func (this *Coinex) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(defaultMethod, "v2PrivateGetFuturesPendingPosition") {
		...
		response = MapTyped(PanicOnError((<-this.V2PrivateGetFuturesFinishedPosition(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "code": 0,
...
func (this *Coinex) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes471415 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, "add", params))))
	ch <- BoxAbsent(retRes471415)
	return nil
}
...
func (this *Coinex) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes472815 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, "reduce", params))))
...
func (this *Coinex) fetchFundingIntervalBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var retRes485715 map[string]any = MapTyped(PanicOnError((<-this.FetchFundingRateAsync(symbol, params))))
	ch <- BoxAbsent(retRes485715)
	return nil
}
...
func (this *Coinex) ParseIsolatedBorrowRate(info any, optionalArgs ...any) any {
	...
	if IsEqual(currency, GetValue(market, "baseId")) {
		baseRate = rate
	} else if IsEqual(currency, GetValue(market, "quoteId")) {
		quoteRate = rate
	}
	return map[string]any{
		"symbol":    GetValue(market, "symbol"),
