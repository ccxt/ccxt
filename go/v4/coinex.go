...
func (this *CoinexCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "swap")) {
			...
			retRes187219 := (<-this.FetchSwapBalance(params))
			PanicOnError(retRes187219)
			ch <- retRes187219
			return nil
		} else if IsTrue(IsEqual(marketType, "financial")) {

			retRes187419 := (<-this.FetchFinancialBalance(params))
			PanicOnError(retRes187419)
			ch <- retRes187419
			return nil
		} else if IsTrue(isMargin) {

			retRes187619 := (<-this.FetchMarginBalance(params))
			PanicOnError(retRes187619)
			ch <- retRes187619
			return nil
		} else {

			retRes187819 := (<-this.FetchSpotBalance(params))
...
func (this *CoinexCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes218215 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes218215)
		ch <- retRes218215
		return nil
...
func (this *CoinexCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes393815 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
		PanicOnError(retRes393815)
		ch <- retRes393815
		return nil
...
func (this *CoinexCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes395312 := (<-this.LoadMarkets())
			PanicOnError(retRes395312)
		}
...
func (this *CoinexCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes399212 := (<-this.LoadMarkets())
			PanicOnError(retRes399212)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
...
func (this *CoinexCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes424112 := (<-this.LoadMarkets())
			PanicOnError(retRes424112)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market_type": "FUTURES",
...
func (this *CoinexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes440615 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *CoinexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes445415 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
		PanicOnError(retRes445415)
		ch <- retRes445415
		return nil
...
func (this *CoinexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes468715 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes468715)
		ch <- retRes468715
		return nil
...
func (this *CoinexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes470115 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes470115)
		ch <- retRes470115
		return nil
...
func (this *CoinexCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes472012 := (<-this.LoadMarkets())
			PanicOnError(retRes472012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market":      GetValue(market, "id"),
...
func (this *CoinexCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes483015 := (<-this.FetchFundingRate(symbol, params))
...
func (this *CoinexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes503819 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
			PanicOnError(retRes503819)
			ch <- retRes503819
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes550712 := (<-this.LoadMarkets())
			PanicOnError(retRes550712)
		}
...
func (this *CoinexCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes555312 := (<-this.LoadMarkets())
			PanicOnError(retRes555312)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *CoinexCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes563912 := (<-this.LoadMarkets())
			PanicOnError(retRes563912)
		}
		var market any = this.Market(symbol)
		var currency any = this.Currency(code)
...
func (this *CoinexCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes569012 := (<-this.LoadMarkets())
			PanicOnError(retRes569012)
		}
		var market any = this.Market(symbol)
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *CoinexCore) FetchDepositWithdrawFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes575312 := (<-this.LoadMarkets())
			PanicOnError(retRes575312)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
...
func (this *CoinexCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes580812 := (<-this.LoadMarkets())
			PanicOnError(retRes580812)
		}
...
func (this *CoinexCore) FetchPositionHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes601412 := (<-this.LoadMarkets())
			PanicOnError(retRes601412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market_type": "FUTURES",
...
func (this *CoinexCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes630112 := (<-this.LoadMarkets())
			PanicOnError(retRes630112)
		}
		if IsTrue(IsEqual(symbol, nil)) {
