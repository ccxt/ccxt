...
func  (this *coinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(marketType, "swap")) {
                    ...
                    retRes184319 :=  (<-this.FetchSwapBalance(params))
                    PanicOnError(retRes184319)
                    ch <- retRes184319
                    return nil
            } else if IsTrue(IsEqual(marketType, "financial")) {
        
                    retRes184519 :=  (<-this.FetchFinancialBalance(params))
                    PanicOnError(retRes184519)
                    ch <- retRes184519
                    return nil
            } else if IsTrue(isMargin) {
        
                    retRes184719 :=  (<-this.FetchMarginBalance(params))
                    PanicOnError(retRes184719)
                    ch <- retRes184719
                    return nil
            } else {
        
                    retRes184919 :=  (<-this.FetchSpotBalance(params))
...
func  (this *coinex) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes215115 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func  (this *coinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes381415 :=  (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
                PanicOnError(retRes381415)
                ch <- retRes381415
                return nil
...
func  (this *coinex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes427015 :=  (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func  (this *coinex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes431615 :=  (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func  (this *coinex) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes43398 := (<-this.LoadMarkets())
            PanicOnError(retRes43398)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *coinex) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes454315 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes454315)
                ch <- retRes454315
                return nil
...
func  (this *coinex) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes455715 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes455715)
                ch <- retRes455715
                return nil
...
func  (this *coinex) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes468215 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes468215)
                ch <- retRes468215
                return nil
...
func  (this *coinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes47498 := (<-this.LoadMarkets())
            PanicOnError(retRes47498)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *coinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes48808 := (<-this.LoadMarkets())
            PanicOnError(retRes48808)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes488419 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
                    PanicOnError(retRes488419)
                    ch <- retRes488419
                    return nil
            }
            var market interface{} = this.Market(symbol)
