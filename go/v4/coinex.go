...
func (this *CoinexCore) FetchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes126912 := (<-this.LoadMarkets())
			PanicOnError(retRes126912)
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) FetchSpotBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes176012 := (<-this.LoadMarkets())
			PanicOnError(retRes176012)
		}
...
func (this *CoinexCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "swap")) {
			...
			retRes187619 := (<-this.FetchSwapBalance(params))
			PanicOnError(retRes187619)
			ch <- retRes187619
			return nil
		} else if IsTrue(IsEqual(marketType, "financial")) {

			retRes187819 := (<-this.FetchFinancialBalance(params))
			PanicOnError(retRes187819)
			ch <- retRes187819
			return nil
		} else if IsTrue(isMargin) {

			retRes188019 := (<-this.FetchMarginBalance(params))
			PanicOnError(retRes188019)
			ch <- retRes188019
			return nil
		} else {

			retRes188219 := (<-this.FetchSpotBalance(params))
			PanicOnError(retRes188219)
			ch <- retRes188219
			return nil
		}
...
func (this *CoinexCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes218615 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *CoinexCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes294612 := (<-this.LoadMarkets())
			PanicOnError(retRes294612)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market": GetValue(market, "id"),
...
func (this *CoinexCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes317012 := (<-this.LoadMarkets())
			PanicOnError(retRes317012)
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes394215 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
...
func (this *CoinexCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes415412 := (<-this.LoadMarkets())
			PanicOnError(retRes415412)
		}
...
func (this *CoinexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes439012 := (<-this.LoadMarkets())
			PanicOnError(retRes439012)
		}
		var market any = this.Market(symbol)
		...
		retRes441015 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *CoinexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes445815 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
		PanicOnError(retRes445815)
		ch <- retRes445815
		return nil
...
func (this *CoinexCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes454712 := (<-this.LoadMarkets())
			PanicOnError(retRes454712)
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes469115 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes469115)
		ch <- retRes469115
		return nil
...
func (this *CoinexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes470515 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes470515)
		ch <- retRes470515
		return nil
...
func (this *CoinexCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes472412 := (<-this.LoadMarkets())
			PanicOnError(retRes472412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market":      GetValue(market, "id"),
...
func (this *CoinexCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes483415 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes483415)
		ch <- retRes483415
		return nil
...
func (this *CoinexCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes490212 := (<-this.LoadMarkets())
			PanicOnError(retRes490212)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{}
		var market any = nil
...
func (this *CoinexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes504219 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
...
func (this *CoinexCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes521512 := (<-this.LoadMarkets())
			PanicOnError(retRes521512)
		}
		var currency any = this.Currency(code)
...
func (this *CoinexCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes541912 := (<-this.LoadMarkets())
			PanicOnError(retRes541912)
		}
		var request any = map[string]any{}
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
...
func (this *CoinexCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes555712 := (<-this.LoadMarkets())
			PanicOnError(retRes555712)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *CoinexCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes564312 := (<-this.LoadMarkets())
			PanicOnError(retRes564312)
		}
		var market any = this.Market(symbol)
		var currency any = this.Currency(code)
...
func (this *CoinexCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes569412 := (<-this.LoadMarkets())
			PanicOnError(retRes569412)
		}
		var market any = this.Market(symbol)
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *CoinexCore) FetchDepositWithdrawFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes575712 := (<-this.LoadMarkets())
			PanicOnError(retRes575712)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
...
func (this *CoinexCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes630512 := (<-this.LoadMarkets())
			PanicOnError(retRes630512)
		}
		if IsTrue(IsEqual(symbol, nil)) {
