...
func  (this *CoinexCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <- chan any {
            ...
            retRes44988 := (<-this.LoadMarkets())
            PanicOnError(retRes44988)
            var market any = this.Market(symbol)
...
func  (this *CoinexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes464115 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes464115)
                ch <- retRes464115
                return nil
...
func  (this *CoinexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes465515 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes465515)
                ch <- retRes465515
                return nil
...
func  (this *CoinexCore) FetchFundingInterval(symbol any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes478015 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *CoinexCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes498219 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
                    PanicOnError(retRes498219)
                    ch <- retRes498219
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *CoinexCore) FetchTransfers(optionalArgs ...any) <- chan any {
            ...
            retRes52348 := (<-this.LoadMarkets())
            PanicOnError(retRes52348)
            if IsTrue(IsEqual(code, nil)) {
...
func  (this *CoinexCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes54428 := (<-this.LoadMarkets())
            PanicOnError(retRes54428)
...
func  (this *CoinexCore) FetchLeverage(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes58678 := (<-this.LoadMarkets())
            PanicOnError(retRes58678)
            var code any = this.SafeString(params, "code")
            if IsTrue(IsEqual(code, nil)) {
...
func  (this *CoinexCore) FetchPositionHistory(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes59338 := (<-this.LoadMarkets())
            PanicOnError(retRes59338)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "market_type": "FUTURES",
                "market": GetValue(market, "id"),
