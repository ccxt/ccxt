...
func (this *CoinexCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "swap")) {
			...
			retRes188619 := (<-this.FetchSwapBalance(params))
			PanicOnError(retRes188619)
			ch <- retRes188619
			return nil
		} else if IsTrue(IsEqual(marketType, "financial")) {

			retRes188819 := (<-this.FetchFinancialBalance(params))
			PanicOnError(retRes188819)
			ch <- retRes188819
			return nil
		} else if IsTrue(isMargin) {

			retRes189019 := (<-this.FetchMarginBalance(params))
			PanicOnError(retRes189019)
			ch <- retRes189019
			return nil
		} else {

			retRes189219 := (<-this.FetchSpotBalance(params))
...
func (this *CoinexCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes219615 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes219615)
		ch <- retRes219615
		return nil
...
func (this *CoinexCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes318812 := (<-this.LoadMarkets())
			PanicOnError(retRes318812)
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes362112 := (<-this.LoadMarkets())
			PanicOnError(retRes362112)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *CoinexCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes396015 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
		PanicOnError(retRes396015)
		ch <- retRes396015
		return nil
...
func (this *CoinexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes408712 := (<-this.LoadMarkets())
			PanicOnError(retRes408712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market": GetValue(market, "id"),
...
func (this *CoinexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes440812 := (<-this.LoadMarkets())
			PanicOnError(retRes440812)
		}
		var market any = this.Market(symbol)
		...
		retRes442815 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
		PanicOnError(retRes442815)
		ch <- retRes442815
		return nil
...
func (this *CoinexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes445712 := (<-this.LoadMarkets())
			PanicOnError(retRes445712)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
		...
		retRes447615 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *CoinexCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes450012 := (<-this.LoadMarkets())
			PanicOnError(retRes450012)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *CoinexCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes456512 := (<-this.LoadMarkets())
			PanicOnError(retRes456512)
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes470915 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *CoinexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes472315 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *CoinexCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes474212 := (<-this.LoadMarkets())
			PanicOnError(retRes474212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market":      GetValue(market, "id"),
...
func (this *CoinexCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes485215 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes485215)
		ch <- retRes485215
		return nil
...
func (this *CoinexCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes492012 := (<-this.LoadMarkets())
			PanicOnError(retRes492012)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{}
		var market any = nil
...
func (this *CoinexCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes497412 := (<-this.LoadMarkets())
			PanicOnError(retRes497412)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy":        GetValue(currency, "id"),
...
func (this *CoinexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes505512 := (<-this.LoadMarkets())
			PanicOnError(retRes505512)
		}
		...
		if IsTrue(paginate) {
			...
			retRes506019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
			PanicOnError(retRes506019)
			ch <- retRes506019
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes552912 := (<-this.LoadMarkets())
			PanicOnError(retRes552912)
		}
...
func (this *CoinexCore) FetchDepositWithdrawFee(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes577512 := (<-this.LoadMarkets())
			PanicOnError(retRes577512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy": GetValue(currency, "id"),
