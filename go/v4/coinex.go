...
func (this *CoinexCore) FetchBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "swap")) {
			...
			retRes186019 := (<-this.FetchSwapBalance(params))
			PanicOnError(retRes186019)
			ch <- retRes186019
			return nil
		} else if IsTrue(IsEqual(marketType, "financial")) {

			retRes186219 := (<-this.FetchFinancialBalance(params))
			PanicOnError(retRes186219)
			ch <- retRes186219
			return nil
		} else if IsTrue(isMargin) {

			retRes186419 := (<-this.FetchMarginBalance(params))
			PanicOnError(retRes186419)
			ch <- retRes186419
			return nil
		} else {

			retRes186619 := (<-this.FetchSpotBalance(params))
...
func (this *CoinexCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes216815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes216815)
		ch <- retRes216815
		return nil
...
func (this *CoinexCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes383115 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
		PanicOnError(retRes383115)
		ch <- retRes383115
		return nil
...
func (this *CoinexCore) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes38828 := (<-this.LoadMarkets())
		PanicOnError(retRes38828)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"ccy": GetValue(currency, "id"),
		}
...
func (this *CoinexCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes40368 := (<-this.LoadMarkets())
		PanicOnError(retRes40368)
...
func (this *CoinexCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes428715 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *CoinexCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes433315 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *CoinexCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes456015 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *CoinexCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes457415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes457415)
		ch <- retRes457415
		return nil
...
func (this *CoinexCore) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes469915 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes469915)
		ch <- retRes469915
		return nil
...
func (this *CoinexCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes490119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
			PanicOnError(retRes490119)
			ch <- retRes490119
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *CoinexCore) FetchMarginAdjustmentHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes61358 := (<-this.LoadMarkets())
		PanicOnError(retRes61358)
		if IsTrue(IsEqual(symbol, nil)) {
