...
func (this *coinex) FetchBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "swap")) {
			...
			retRes184419 := (<-this.FetchSwapBalance(params))
			PanicOnError(retRes184419)
			ch <- retRes184419
			return nil
		} else if IsTrue(IsEqual(marketType, "financial")) {

			retRes184619 := (<-this.FetchFinancialBalance(params))
			PanicOnError(retRes184619)
			ch <- retRes184619
			return nil
		} else if IsTrue(isMargin) {

			retRes184819 := (<-this.FetchMarginBalance(params))
			PanicOnError(retRes184819)
			ch <- retRes184819
			return nil
		} else {

			retRes185019 := (<-this.FetchSpotBalance(params))
...
func (this *coinex) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes215215 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *coinex) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes381515 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
		PanicOnError(retRes381515)
		ch <- retRes381515
		return nil
...
func (this *coinex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes427115 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
		PanicOnError(retRes427115)
		ch <- retRes427115
		return nil
...
func (this *coinex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes42998 := (<-this.LoadMarkets())
		PanicOnError(retRes42998)
		var market interface{} = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
		...
		retRes431715 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *coinex) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes454415 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes454415)
		ch <- retRes454415
		return nil
...
func (this *coinex) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes455815 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *coinex) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes468315 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes468315)
		ch <- retRes468315
		return nil
...
func (this *coinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes48028 := (<-this.LoadMarkets())
		PanicOnError(retRes48028)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"ccy":        GetValue(currency, "id"),
			"to_address": address,
...
func (this *coinex) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes48818 := (<-this.LoadMarkets())
		PanicOnError(retRes48818)
		...
		if IsTrue(paginate) {
			...
			retRes488519 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
			PanicOnError(retRes488519)
			ch <- retRes488519
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *coinex) FetchBorrowInterest(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes53898 := (<-this.LoadMarkets())
		PanicOnError(retRes53898)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *coinex) FetchDepositWithdrawFee(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes55838 := (<-this.LoadMarkets())
		PanicOnError(retRes55838)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"ccy": GetValue(currency, "id"),
		}
