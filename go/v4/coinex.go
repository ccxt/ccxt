...
func (this *CoinexCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(marketType, "swap")) {
			...
			retRes188719 := (<-this.FetchSwapBalance(params))
			PanicOnError(retRes188719)
			ch <- retRes188719
			return nil
		} else if IsTrue(IsEqual(marketType, "financial")) {

			retRes188919 := (<-this.FetchFinancialBalance(params))
			PanicOnError(retRes188919)
			ch <- retRes188919
			return nil
		} else if IsTrue(isMargin) {

			retRes189119 := (<-this.FetchMarginBalance(params))
			PanicOnError(retRes189119)
			ch <- retRes189119
			return nil
		} else {

			retRes189319 := (<-this.FetchSpotBalance(params))
...
func (this *CoinexCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes219715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes219715)
		ch <- retRes219715
		return nil
...
func (this *CoinexCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes352712 := (<-this.LoadMarkets())
			PanicOnError(retRes352712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market":   GetValue(market, "id"),
...
func (this *CoinexCore) FetchOrdersByStatus(status any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes362212 := (<-this.LoadMarkets())
			PanicOnError(retRes362212)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *CoinexCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes396115 := (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
		PanicOnError(retRes396115)
		ch <- retRes396115
		return nil
...
func (this *CoinexCore) CreateDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes397612 := (<-this.LoadMarkets())
			PanicOnError(retRes397612)
		}
...
func (this *CoinexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes408812 := (<-this.LoadMarkets())
			PanicOnError(retRes408812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market": GetValue(market, "id"),
...
func (this *CoinexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes442915 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
...
func (this *CoinexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes447715 := (<-this.V2PrivatePostFuturesAdjustPositionLeverage(this.Extend(request, params)))
		PanicOnError(retRes447715)
		ch <- retRes447715
		return nil
...
func (this *CoinexCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes450112 := (<-this.LoadMarkets())
			PanicOnError(retRes450112)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *CoinexCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes471015 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes471015)
		ch <- retRes471015
		return nil
...
func (this *CoinexCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes472415 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes472415)
		ch <- retRes472415
		return nil
...
func (this *CoinexCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes474312 := (<-this.LoadMarkets())
			PanicOnError(retRes474312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market":      GetValue(market, "id"),
...
func (this *CoinexCore) FetchFundingInterval(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes485315 := (<-this.FetchFundingRate(symbol, params))
		PanicOnError(retRes485315)
		ch <- retRes485315
		return nil
...
func (this *CoinexCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes497512 := (<-this.LoadMarkets())
			PanicOnError(retRes497512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"ccy":        GetValue(currency, "id"),
...
func (this *CoinexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes506119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
...
func (this *CoinexCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes537712 := (<-this.LoadMarkets())
			PanicOnError(retRes537712)
		}
		var request any = map[string]any{}
...
func (this *CoinexCore) FetchIsolatedBorrowRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes553012 := (<-this.LoadMarkets())
			PanicOnError(retRes553012)
		}
...
func (this *CoinexCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes571312 := (<-this.LoadMarkets())
			PanicOnError(retRes571312)
		}
		var market any = this.Market(symbol)
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *CoinexCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes612012 := (<-this.LoadMarkets())
			PanicOnError(retRes612012)
		}
		var market any = this.Market(symbol)
...
func (this *CoinexCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes632812 := (<-this.LoadMarkets())
			PanicOnError(retRes632812)
		}
		if IsTrue(IsEqual(symbol, nil)) {
