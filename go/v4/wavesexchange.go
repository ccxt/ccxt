...
type WavesexchangeCore struct {
    Exchange

}

func NewWavesexchangeCore() *WavesexchangeCore {
    p := &WavesexchangeCore{}
    setDefaults(p)
    return p
}
...
func  (this *WavesexchangeCore) Describe() interface{}  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]interface{} {
        ...
        "options": map[string]interface{} {
            ...
            "quotes": nil,
            "createOrderDefaultExpiry": int64(2419200000),
            "wavesAddress": nil,
...
func  (this *WavesexchangeCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            defaultExpiryDeltaparamsVariable := this.HandleOptionAndParams(params, "createOrder", "defaultExpiry", this.SafeInteger(this.Options, "createOrderDefaultExpiry", int64(2419200000)));
