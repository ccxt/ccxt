...
func (this *Btcmarkets) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var tagFrom any = nil
	var fee *string = this.SafeString(transaction, "fee")
...
func (this *Btcmarkets) ParseMarket(market any) any {
	var baseId *string = this.SafeString(market, "baseAssetName")
	var quoteId *string = this.SafeString(market, "quoteAssetName")
...
func (this *Btcmarkets) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	response := (<-this.PrivateGetAccountsMeBalances(params)).Raw
	PanicOnError(response)
...
func (this *Btcmarkets) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	response := (<-this.PublicGetMarketsMarketIdOrderbook(this.Extend(request, params))).Raw
	PanicOnError(response)
	//
	//     {
	//         "marketId":"BTC-AUD",
...
func (this *Btcmarkets) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var quoteVolume *string = this.SafeString(ticker, "volumeQte24h")
	var change *string = this.SafeString(ticker, "price24h")
	var percentage *string = this.SafeString(ticker, "pricePct24h")
...
func (this *Btcmarkets) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	response := (<-this.PublicGetMarketsMarketIdTicker(this.Extend(request, params))).Raw
	PanicOnError(response)
...
func (this *Btcmarkets) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var takerOrMaker *string = this.SafeStringLower(trade, "liquidityType")
...
func (this *Btcmarkets) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	response := (<-this.PublicGetMarketsMarketIdTrades(this.Extend(request, params))).Raw
	PanicOnError(response)
...
func (this *Btcmarkets) ParseOrder(order any, optionalArgs ...any) any {
	...
	var remaining *string = this.SafeString(order, "openAmount")
...
func (this *Btcmarkets) FetchTransactionsWithMethod(method string, options ...FetchTransactionsWithMethodOptions) ([]Transaction, error) {
	...
	var res AsyncResult[[]Transaction] = AwaitResult(NewTransactionArray, this.FetchTransactionsWithMethodAsync(method, opts.Code, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
...
func (this *Btcmarkets) FetchTicker2(symbol string, options ...FetchTicker2Options) (Ticker, error) {
	...
	var res AsyncResult[Ticker] = AwaitResult(NewTicker, this.FetchTicker2Async(symbol, opts.Params))
	if res.Err != nil {
		return Ticker{}, res.Err
	}
	return res.Value, nil
