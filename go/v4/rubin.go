...
func  (this *RubinCore) Describe() any  {
    return this.DeepExtend(this.Exchange.Describe(), map[string]any {
        ...
        "urls": map[string]any {
            ...
            "doc": []any{"https://docs.rubin.trade"},
            "fees": []any{"https://docs.rubin.trade"},
 ...
 */
func  (this *RubinCore) FetchTime(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
...
func  (this *RubinCore) ParseMarket(market any) any  {
    //
    // {
    //     "clobPairId": "0",
    //     "ticker": "BTC-USD",
 ...
 */
func  (this *RubinCore) FetchMarkets(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) ParseTrade(trade any, optionalArgs ...any) any  {
    //
    // {
 ...
 */
func  (this *RubinCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) ParseOHLCV(ohlcv any, optionalArgs ...any) any  {
    //
    // {
 ...
 */
func  (this *RubinCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) HandlePublicAddress(methodName any, params any) any  {
    var userAux any = nil
...
func  (this *RubinCore) ParseOrder(order any, optionalArgs ...any) any  {
    //
    // {
...
func  (this *RubinCore) ParseOrderStatus(status any) any  {
...
func  (this *RubinCore) ParseOrderType(typeVar any) any  {
 ...
 */
func  (this *RubinCore) FetchOrder(id any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchOrders(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *RubinCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 * @returns {Order[]} a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *RubinCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) ParsePosition(position any, optionalArgs ...any) any  {
    //
    // {
    //     "market": "BTC-USD",
    //     "status": "OPEN",
 ...
 */
func  (this *RubinCore) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchPositions(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) HashMessage(message any) any  {
    return this.Hash(message, keccak, "hex")
}
func  (this *RubinCore) SignHash(hash any, privateKey any) any  {
...
func  (this *RubinCore) SignMessage(message any, privateKey any) any  {
    return this.SignHash(this.HashMessage(message), Slice(privateKey, OpNeg(64), nil))
}
func  (this *RubinCore) SignOnboardingAction() any  {
...
func  (this *RubinCore) SignRubinTx(privateKey any, message any, memo any, chainId any, account any, authenticators any, optionalArgs ...any) any  {
...
func  (this *RubinCore) RetrieveCredentials() any  {
    var credentials any = this.SafeDict(this.Options, "rubinCredentials")
    ...
    AddElementToObject(this.Options, "rubinCredentials", credentials)
    return credentials
}
func  (this *RubinCore) FetchRubinAccount() <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
        ...
        retRes12478 := (<-this.LoadV4Protos())
        PanicOnError(retRes12478)
        var rubinAccount any = this.SafeDict(this.Options, "rubinAccount")
        if IsTrue(!IsEqual(rubinAccount, nil)) {
        
            ch <- rubinAccount
            return nil
        }
        if IsTrue(IsEqual(this.WalletAddress, nil)) {
            panic(ArgumentsRequired(Add(this.Id, " fetchRubinAccount() requires the walletAddress to be set using the rit chain address eg: rit1exampleaddressxxxxxxxxxxxxxxxxxxxxxxx")))
        }
        if !IsTrue(StartsWith(this.WalletAddress, "rit")) {
            panic(ArgumentsRequired(Add(this.Id, " fetchRubinAccount() requires a valid rit chain address, starting with rit, not the l1 address.")))
        }
        var request any = map[string]any {
        ...
        AddElementToObject(this.Options, "rubinAccount", account)
...
func  (this *RubinCore) Pow(n any, m any) any  {
...
func  (this *RubinCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any  {
...
func  (this *RubinCore) CreateOrderIdFromParts(address any, subAccountNumber any, clientOrderId any, orderFlags any, clobPairId any) any  {
...
func  (this *RubinCore) FetchLatestBlockHeight(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *RubinCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            account:= (<-this.FetchRubinAccount())
            ...
            var signedTx any = this.SignRubinTx(GetValue(credentials, "privateKey"), orderRequest, "", chainName, account, nil)
            var request any = map[string]any {
                "tx": signedTx,
            }
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func  (this *RubinCore) CancelOrder(id any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            var chainName any = GetValue(this.Options, "chainName")
            var signedTx any = this.SignRubinTx(GetValue(credentials, "privateKey"), signingPayload, "", chainName, account, nil)
            var request any = map[string]any {
                "tx": signedTx,
            }
            // nodeRpcGetBroadcastTxAsync
 ...
 */
func  (this *RubinCore) CancelOrders(ids any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) ParseLedgerEntry(item any, optionalArgs ...any) any  {
    //
    // {
...
func  (this *RubinCore) ParseLedgerEntryType(typeVar any) any  {
 ...
 */
func  (this *RubinCore) FetchLedger(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) EstimateTxFee(message any, memo any, account any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            PanicOnError(txFee)
            var chainName any = GetValue(this.Options, "chainName")
            var signedTx any = this.SignRubinTx(GetValue(credentials, "privateKey"), signingPayload, "", chainName, account, nil, txFee)
            var request any = map[string]any {
                "tx": signedTx,
            }
            // nodeRpcGetBroadcastTxAsync
...
func  (this *RubinCore) ParseTransfer(transfer any, optionalArgs ...any) any  {
    //
    // {
    //     "id": "6a6075bc-7183-5fd9-bc9d-894e238aa527",
    //     "sender": {
 ...
 */
func  (this *RubinCore) FetchTransfers(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) ParseTransaction(transaction any, optionalArgs ...any) any  {
    //
    // {
    //     "id": "6a6075bc-7183-5fd9-bc9d-894e238aa527",
    //     "sender": {
 ...
 */
func  (this *RubinCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
            ...
            PanicOnError(txFee)
            var chainName any = GetValue(this.Options, "chainName")
            var signedTx any = this.SignRubinTx(GetValue(credentials, "privateKey"), signingPayload, tag, chainName, account, nil, txFee)
            var request any = map[string]any {
                "tx": signedTx,
            }
            // nodeRpcGetBroadcastTxAsync
 ...
 */
func  (this *RubinCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [transaction structures]{@link https://docs.ccxt.com/?id=transaction-structure}
 */
func  (this *RubinCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchDepositsWithdrawals(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) FetchTransactionsHelper(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchAccounts(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
 ...
 */
func  (this *RubinCore) FetchBalance(optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *RubinCore) ParseBalance(response any) any  {
...
func  (this *RubinCore) Nonce() any  {
    return Subtract(this.Milliseconds(), GetValue(this.Options, "timeDifference"))
}
func  (this *RubinCore) GetWalletAddress() any  {
    if IsTrue(IsTrue(!IsEqual(this.WalletAddress, nil)) && IsTrue(!IsEqual(this.WalletAddress, ""))) {
    ...
    if IsTrue(!IsEqual(rubinAccount, nil)) {
        // return rubinAccount;
        var wallet any = this.SafeString(rubinAccount, "address")
        if IsTrue(!IsEqual(wallet, nil)) {
            return wallet
        }
    }
    panic(ArgumentsRequired(Add(this.Id, " getWalletAddress() requires a wallet address. Set `walletAddress` or `rubinAccount` in exchange options.")))
}
func  (this *RubinCore) Sign(path any, optionalArgs ...any) any  {
...
func  (this *RubinCore) HandleErrors(httpCode any, reason any, url any, method any, headers any, body any, response any, requestHeaders any, requestBody any) any  {
    if !IsTrue(response) {
...
func  (this *RubinCore) SetSandboxMode(enable any)  {
    this.Exchange.SetSandboxMode(enable)
    // rewrite testnet parameters
    AddElementToObject(this.Options, "chainName", "ritbit-testnet")
