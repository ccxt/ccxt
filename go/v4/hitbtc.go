...
func (this *HitbtcCore) FetchDepositsWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes164415 := (<-this.FetchTransactionsHelper("DEPOSIT,WITHDRAW", code, since, limit, params))
		PanicOnError(retRes164415)
		ch <- retRes164415
		return nil
...
func (this *HitbtcCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes165915 := (<-this.FetchTransactionsHelper("DEPOSIT", code, since, limit, params))
...
func (this *HitbtcCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes167415 := (<-this.FetchTransactionsHelper("WITHDRAW", code, since, limit, params))
...
func (this *HitbtcCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes186119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *HitbtcCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes242612 := (<-this.LoadMarkets())
			PanicOnError(retRes242612)
		}
		var market any = this.Market(symbol)
		var request any = nil
		var marketType any = nil
...
func (this *HitbtcCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes274112 := (<-this.LoadMarkets())
			PanicOnError(retRes274112)
		}
		var currency any = this.Currency(code)
...
func (this *HitbtcCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes294512 := (<-this.LoadMarkets())
			PanicOnError(retRes294512)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes295019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
			PanicOnError(retRes295019)
			ch <- retRes295019
			return nil
		}
		var market any = nil
...
func (this *HitbtcCore) FetchOpenInterests(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes328812 := (<-this.LoadMarkets())
			PanicOnError(retRes328812)
		}
		var request any = map[string]any{}
		symbols = this.MarketSymbols(symbols)
...
func (this *HitbtcCore) ModifyMarginHelper(symbol any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes344512 := (<-this.LoadMarkets())
			PanicOnError(retRes344512)
		}
		var market any = this.Market(symbol)
...
func (this *HitbtcCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes356115 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
		PanicOnError(retRes356115)
		ch <- retRes356115
		return nil
...
func (this *HitbtcCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes357815 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
...
func (this *HitbtcCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes369815 := (<-this.PrivatePutFuturesAccountIsolatedSymbol(this.Extend(request, params)))
...
func (this *HitbtcCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes371212 := (<-this.LoadMarkets())
			PanicOnError(retRes371212)
		}
...
func (this *HitbtcCore) ClosePosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes381112 := (<-this.LoadMarkets())
			PanicOnError(retRes381112)
		}
		var marginMode any = nil
