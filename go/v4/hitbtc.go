...
func  (this *HitbtcCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes289619 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
                    PanicOnError(retRes289619)
                    ch <- retRes289619
                    return nil
            }
            var market any = nil
...
func  (this *HitbtcCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(!IsEqual(this.NumberToString(amount), "0")) {
                ...
                retRes349515 :=  (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
                PanicOnError(retRes349515)
                ch <- retRes349515
                return nil
...
func  (this *HitbtcCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes351215 :=  (<-this.ModifyMarginHelper(symbol, amount, "add", params))
                PanicOnError(retRes351215)
                ch <- retRes351215
                return nil
...
func  (this *HitbtcCore) FetchLeverage(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes35288 := (<-this.LoadMarkets())
            PanicOnError(retRes35288)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *HitbtcCore) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes362815 :=  (<-this.PrivatePutFuturesAccountIsolatedSymbol(this.Extend(request, params)))
