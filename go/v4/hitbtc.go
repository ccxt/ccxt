...
func (this *Hitbtc) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(account, "wallet") {
		...
		panic(BadRequest(this.Id + " fetchBalance() type parameter must be one of " + Join(keys, ", ")))
	}
...
func (this *Hitbtc) convertCurrencyNetworkBody(ch chan any, code any, amount any, fromNetwork any, toNetwork any, params any) any {
	...
	if (IsEqual(fromNetwork, nil)) || (IsEqual(toNetwork, nil)) {
		...
		panic(ArgumentsRequired(this.Id + " convertCurrencyNetwork() requires a fromNetwork parameter and a toNetwork parameter, supported networks are " + Join(keys, ", ")))
	}
	var request map[string]any = map[string]any{
