...
func (this *HitbtcCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes295419 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 1000))
			PanicOnError(retRes295419)
			ch <- retRes295419
			return nil
		}
		var market any = nil
...
func (this *HitbtcCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes356515 := (<-this.ModifyMarginHelper(symbol, amount, "reduce", params))
...
func (this *HitbtcCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes358215 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
		PanicOnError(retRes358215)
		ch <- retRes358215
		return nil
...
func (this *HitbtcCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes368212 := (<-this.LoadMarkets())
			PanicOnError(retRes368212)
		}
		...
		retRes370215 := (<-this.PrivatePutFuturesAccountIsolatedSymbol(this.Extend(request, params)))
		PanicOnError(retRes370215)
		ch <- retRes370215
		return nil
...
func (this *HitbtcCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes371612 := (<-this.LoadMarkets())
			PanicOnError(retRes371612)
		}
