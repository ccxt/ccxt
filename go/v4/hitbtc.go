...
func (this *HitbtcCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if (typeVar == "limit") || (typeVar == "stopLimit") {
...
func (this *HitbtcCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if marketType == "swap" {
		...
		PanicOnError(response)
	} else if (marketType == "margin") || (!IsEqual(marginMode, nil)) {
...
func (this *HitbtcCore) CreateOrderRequest(market any, marketType any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params := GetArg(optionalArgs, 2, map[string]any{})
	_ = params
	var isLimit bool = (typeVar == "limit")
	...
	var isPostOnly any = this.IsPostOnly((typeVar == "market"), nil, params)
	var request map[string]any = map[string]any{
		"type":     typeVar,
		"side":     side,
	...
	if isLimit || (typeVar == "stopLimit") || (typeVar == "takeProfitLimit") {
		if IsEqual(price, nil) {
	...
	} else if (typeVar == "stopLimit") || (typeVar == "stopMarket") || (typeVar == "takeProfitLimit") || (typeVar == "takeProfitMarket") {
