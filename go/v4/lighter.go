...
func (this *Lighter) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	AddElementToObject(request, "reduce_only", Ternary((reduceOnly != nil && *reduceOnly == true), 1, 0))
	...
	if hasStopLoss || hasTakeProfit {
		...
		var stopLossOrderTriggerPrice *float64 = this.SafeNumber2(stopLoss, "triggerPrice", "stopPrice")
		var stopLossOrderType *string = this.SafeString(stopLoss, "type", "limit")
		var stopLossOrderLimitPrice *float64 = this.SafeNumber2(stopLoss, "price", "stopLossPrice", stopLossOrderTriggerPrice)
		var takeProfitOrderTriggerPrice *float64 = this.SafeNumber2(takeProfit, "triggerPrice", "stopPrice")
...
func (this *Lighter) ParseCurrency(rawCurrency any) any {
	...
	var isUSDC bool = (code != nil && *code == "USDC")
	var depositMin *float64 = nil
	var withdrawMin *float64 = nil
	if isUSDC {
...
func (this *Lighter) ParsePosition(position any, optionalArgs ...any) any {
	...
	if imfStr != nil {
		var imf int64 = this.ParseToInt(imfStr)
...
func (this *Lighter) ParseOrderTimeInForce(tif any) *string {
...
func (this *Lighter) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	var fromRouteType int = Ternary((IsEqual(fromAccount, "perp")), 0, 1).(int) // 0: perp, 1: spot
	var toRouteType int = Ternary((IsEqual(toAccount, "perp")), 0, 1).(int)
...
func (this *Lighter) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if !IsEqual(side, nil) && (isMakerAsk != nil) {
		var isMaker any = Ternary((IsEqual(side, "sell")), isMakerAsk, !(isMakerAsk != nil && *isMakerAsk))
