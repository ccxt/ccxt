...
func (this *Predictfun) fetchRawTopicsByQueriesBody(ch chan any, queries any, optionalArgs ...any) any {
	...
	for i := 0; i < orphanSlugsLength; i++ {
		var orphanSlug *string = ccxt.SafeStringPtr(func() any {
		...
		if !(func() bool {
			...
			_, ok := seenSlugs[*orphanSlug]
			return ok
		}()) {
			ccxt.AddElementToObject(seenSlugs, orphanSlug, true)
			var markets any = func() any {
				if orphanSlug == nil {
					return nil
				}
				return orphanMarkets[*orphanSlug]
			}()
			...
			if (marketStatus != nil && *marketStatus == "RESOLVED") || (marketStatus != nil && *marketStatus == "SETTLED") {
				topicStatus = ccxt.SafeStringPtr("RESOLVED")
			} else if tradingStatus != nil && *tradingStatus == "OPEN" {
				topicStatus = ccxt.SafeStringPtr("OPEN")
			}
...
func (this *Predictfun) StripPriceFormatting(text any) any {
	...
	for i := 0; i < charsLength; i++ {
		...
		if ch != nil && *ch == "$" {
			...
			var nextIsDigit bool = ((i + 1) < charsLength) && (ccxt.GetIndexOf(digits, ccxt.GetValue(chars, i+1)) >= 0)
...
func (this *Predictfun) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < dataLength; i++ {
		...
		var taker map[string]any = ccxt.MapTyped(this.SafeDict(entry, "taker", map[string]any{}))
...
func (this *Predictfun) SignHash(hash any, privateKey any) any {
	...
	var signatureHex string = "0x" + r + s + v
	return strings.ToLower(signatureHex)
}
...
func (this *Predictfun) ParsePredictionPosition(position any, optionalArgs ...any) any {
	...
	var won any = nil
	var settleFraction *string = nil
	var payout any = nil
	if settled {
		won = (outcomeStatus != nil && *outcomeStatus == "WON")
		settleFraction = ccxt.SafeStringPtr(func() string {
			if won == true {
				return "1"
			}
			return "0"
...
func (this *Predictfun) approveBody(ch chan any, optionalArgs ...any) any {
	...
	if side != nil && *side == "sell" {
		...
		for i := 0; i < operatorsLength; i++ {
			...
			var approvalData *string = ccxt.SafeStringPtr(ccxt.Add(ccxt.Add("0xa22cb465", this.PadHexAddress(operatorAddress)), approvedHex))
...
func (this *Predictfun) watchOrderBookBody(ch chan any, outcome string, optionalArgs ...any) any {
	...
	var messageHash *string = ccxt.SafeStringPtr(ccxt.Add("orderbook::", outcomeHandle))
...
func (this *Predictfun) WalletEventMessageHashes(client any, optionalArgs ...any) any {
	...
	for i := 0; i < futuresLength; i++ {
		...
		if (func() int {
			...
			return strings.Index(*future, "orders::")
		}() == 0) || (func() int {
			if future == nil {
				return -1
			}
			return strings.Index(*future, "myTrades::")
		}() == 0) {
...
func (this *Predictfun) ParseWalletEventOrder(event map[string]any) any {
	...
	if (eventType != nil && *eventType == "orderAccepted") || (eventType != nil && *eventType == "orderMarketMatchPlan") || (eventType != nil && *eventType == "orderTransactionSubmitted") || (eventType != nil && *eventType == "orderTransactionFailed") {
		...
		status = ccxt.SafeStringPtr("rejected")
	} else if eventType != nil && *eventType == "orderExpired" {
		status = ccxt.SafeStringPtr("expired")
