 ...
 */
func  (this *Binance) FetchMarkets(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchRawTopics(maxTopics any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Binance) fetchRawTopicsBody(ch chan any, maxTopics any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        for true {
            ...
            var hasMore any = ccxt.DerefScalar(this.SafeBool(response, "hasMore", false))
 ...
 */
func  (this *Binance) FetchRawTopicDetail(topicId any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) CompleteRawTopics(rawTopics any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchEvents(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Binance) fetchEventsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        params := ccxt.GetArg(optionalArgs, 0, map[string]any {})
        _ = params
        var allowUnscopedFetchEvents any = ccxt.DerefScalar(this.SafeBool(this.Options, "allowUnscopedFetchEvents", false))
 ...
 * @returns {object[]} raw market topic objects with usable nested markets
 */
func  (this *Binance) FetchEventsByQuery(queries any, limit any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchEvent(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchTicker(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchTickers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchOrderBook(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchBalance(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchOpenOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Binance) FetchOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction position structures](https://docs.ccxt.com/#/?id=prediction-position-structure)
 */
func  (this *Binance) FetchPosition(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Binance) FetchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchWallet(methodName any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) FetchQuote(request any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Binance) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Binance) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Binance) CancelOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Binance) CancelOrders(ids any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Binance) FetchAllGreeks(options ...ccxt.FetchAllGreeksOptions) (ccxt.AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Binance) FetchDepositAddressesByNetwork(code string, options ...ccxt.FetchDepositAddressesByNetworkOptions) (ccxt.DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
...
func (this *Binance) FetchDepositWithdrawFee(code string, options ...ccxt.FetchDepositWithdrawFeeOptions) (ccxt.DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *Binance) FetchDepositWithdrawFees(options ...ccxt.FetchDepositWithdrawFeesOptions) (ccxt.DepositWithdrawFees, error) {return this.exchangeTyped.FetchDepositWithdrawFees(options...)}
...
func (this *Binance) FetchPositionMode(options ...ccxt.FetchPositionModeOptions) (ccxt.PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *Binance) FetchStatus(params ...any) (ccxt.Status, error) {return this.exchangeTyped.FetchStatus(params...)}
...
func (this *Binance) FetchBalanceWs(params ...any) (ccxt.Balances, error) {return this.exchangeTyped.FetchBalanceWs(params...)}
func (this *Binance) FetchDepositsWs(options ...ccxt.FetchDepositsWsOptions) ([]ccxt.Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
func (this *Binance) FetchOHLCVWs(symbol string, options ...ccxt.FetchOHLCVWsOptions) ([]ccxt.OHLCV, error) {return this.exchangeTyped.FetchOHLCVWs(symbol, options...)}
...
func (this *Binance) FetchWithdrawalsWs(options ...ccxt.FetchWithdrawalsWsOptions) ([]ccxt.Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
...
func (this *Binance) UnWatchOHLCV(symbol string, options ...ccxt.UnWatchOHLCVOptions) (any, error) {return this.exchangeTyped.UnWatchOHLCV(symbol, options...)}
func (this *Binance) UnWatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...ccxt.UnWatchOHLCVForSymbolsOptions) (any, error) {return this.exchangeTyped.UnWatchOHLCVForSymbols(symbolsAndTimeframes, options...)}
func (this *Binance) UnWatchOrderBook(symbol string, options ...ccxt.UnWatchOrderBookOptions) (any, error) {return this.exchangeTyped.UnWatchOrderBook(symbol, options...)}
func (this *Binance) UnWatchOrderBookForSymbols(symbols []string, options ...ccxt.UnWatchOrderBookForSymbolsOptions) (any, error) {return this.exchangeTyped.UnWatchOrderBookForSymbols(symbols, options...)}
...
func (this *Binance) UnWatchTicker(symbol string, options ...ccxt.UnWatchTickerOptions) (any, error) {return this.exchangeTyped.UnWatchTicker(symbol, options...)}
func (this *Binance) UnWatchTickers(options ...ccxt.UnWatchTickersOptions) (any, error) {return this.exchangeTyped.UnWatchTickers(options...)}
func (this *Binance) UnWatchTrades(symbol string, options ...ccxt.UnWatchTradesOptions) (any, error) {return this.exchangeTyped.UnWatchTrades(symbol, options...)}
func (this *Binance) UnWatchTradesForSymbols(symbols []string, options ...ccxt.UnWatchTradesForSymbolsOptions) (any, error) {return this.exchangeTyped.UnWatchTradesForSymbols(symbols, options...)}
func (this *Binance) WatchBalance(params ...any) (ccxt.Balances, error) {return this.exchangeTyped.WatchBalance(params...)}
func (this *Binance) WatchLiquidations(symbol string, options ...ccxt.WatchLiquidationsOptions) ([]ccxt.Liquidation, error) {return this.exchangeTyped.WatchLiquidations(symbol, options...)}
func (this *Binance) WatchMyLiquidations(symbol string, options ...ccxt.WatchMyLiquidationsOptions) ([]ccxt.Liquidation, error) {return this.exchangeTyped.WatchMyLiquidations(symbol, options...)}
func (this *Binance) WatchMyLiquidationsForSymbols(symbols []string, options ...ccxt.WatchMyLiquidationsForSymbolsOptions) ([]ccxt.Liquidation, error) {return this.exchangeTyped.WatchMyLiquidationsForSymbols(symbols, options...)}
...
func (this *Binance) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {return this.exchangeTyped.WatchOHLCV(symbol, options...)}
func (this *Binance) WatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...ccxt.WatchOHLCVForSymbolsOptions) (map[string]map[string][]ccxt.OHLCV, error) {return this.exchangeTyped.WatchOHLCVForSymbols(symbolsAndTimeframes, options...)}
