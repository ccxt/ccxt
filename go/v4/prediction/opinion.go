...
func (this *Opinion) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes7398 := (<-this.LoadOutcomesAsync(outcomes))
...
func (this *Opinion) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes10108 := (<-this.LoadApiKeyAsync())
	...
	var sideInt int = ccxt.Ternary((sideStr == "BUY"), 0, 1).(int)
	...
	var signatureType int = ccxt.Ternary((makerLower == walletAddressLower), 0, 2).(int)
...
func (this *Opinion) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes11078 := (<-this.LoadApiKeyAsync())
	...
	var status any = ccxt.Ternary((canceled != nil && *canceled == true), "canceled", nil)
...
func (this *Opinion) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes12128 := (<-this.LoadApiKeyAsync())
...
func (this *Opinion) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes12378 := (<-this.LoadApiKeyAsync())
...
func (this *Opinion) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes126215 := (<-this.FetchOrdersAsync(outcome, since, limit, this.Extend(request, params)))
...
func (this *Opinion) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes127915 := (<-this.FetchOrdersAsync(outcome, since, limit, this.Extend(request, params)))
...
func (this *Opinion) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes12978 := (<-this.LoadApiKeyAsync())
...
func (this *Opinion) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes14018 := (<-this.LoadApiKeyAsync())
...
func (this *Opinion) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes14548 := (<-this.LoadApiKeyAsync())
	ccxt.PanicOnError(retRes14548)
	var outcomesLength int = 0
	if !ccxt.IsEqual(outcomes, nil) {
		outcomesLength = ccxt.GetArrayLength(outcomes)

		retRes145812 := (<-this.LoadOutcomesAsync(outcomes))
		ccxt.PanicOnError(retRes145812)
	}
	var request map[string]any = map[string]any{
		"walletAddress": this.WalletAddress,
	}
...
func (this *Opinion) subscribeOpinionChannelBody(ch chan any, messageHash any, channel any, marketId any) any {
	...
	retRes16918 := (<-this.LoadApiKeyAsync())
...
func (this *Opinion) OpinionOutcomeByMarketIdSide(marketId any, outcomeSide any) any {
	...
	for i := 0; ccxt.IsLessThan(i, marketKeysLength); i++ {
		...
		if ccxt.IsEqual(this.SafeInteger(info, "marketId"), marketId) {
			...
			var index int = ccxt.Ternary((ccxt.IsEqual(outcomeSide, 2)), 1, 0).(int)
...
func (this *Opinion) watchOrderBookBody(ch chan any, outcome any, optionalArgs ...any) any {
	...
	retRes17668 := (<-this.LoadApiKeyAsync())
	...
	if isNewSubscription {
		...
		retRes177212 := (<-this.SeedOrderBookAsync(outcome, sym, limit))
		ccxt.PanicOnError(retRes177212)
	}
	var subscribeMsg map[string]any = map[string]any{
		"action":   "SUBSCRIBE",
		"channel":  channel,
...
func (this *Opinion) HandleOrder(client any, message any) {
	...
	var side string = ccxt.Ternary((sideInt != nil && *sideInt == 1), "buy", "sell").(string)
	var tradingMethod *int64 = this.SafeInteger(message, "tradingMethod")
	var typeVar string = ccxt.Ternary((tradingMethod != nil && *tradingMethod == 1), "market", "limit").(string)
