 ...
 */
func (this *Polymarket) WatchOrderBook(outcome string, options ...ccxt.WatchOrderBookOptions) (ccxt.OrderBook, error) {
...
func (this *Polymarket) CancelOrdersWithClientOrderIds(clientOrderIds []string, options ...ccxt.CancelOrdersWithClientOrderIdsOptions) ([]ccxt.Order, error) {
...
func (this *Polymarket) CancelOrderWithClientOrderId(clientOrderId string, options ...ccxt.CancelOrderWithClientOrderIdOptions) (ccxt.Order, error) {
...
func (this *Polymarket) CreateLimitBuyOrder(symbol string, amount float64, price float64, options ...ccxt.CreateLimitBuyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitBuyOrder(symbol, amount, price, options...)
}
func (this *Polymarket) CreateLimitOrder(symbol string, side string, amount float64, price float64, options ...ccxt.CreateLimitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitOrder(symbol, side, amount, price, options...)
}
func (this *Polymarket) CreateLimitSellOrder(symbol string, amount float64, price float64, options ...ccxt.CreateLimitSellOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitSellOrder(symbol, amount, price, options...)
}
func (this *Polymarket) CreateMarketBuyOrder(symbol string, amount float64, options ...ccxt.CreateMarketBuyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketBuyOrder(symbol, amount, options...)
}
func (this *Polymarket) CreateMarketOrder(symbol string, side string, amount float64, options ...ccxt.CreateMarketOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrder(symbol, side, amount, options...)
}
func (this *Polymarket) CreateMarketOrderWithCost(symbol string, side string, cost float64, options ...ccxt.CreateMarketOrderWithCostOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrderWithCost(symbol, side, cost, options...)
}
func (this *Polymarket) CreateMarketSellOrder(symbol string, amount float64, options ...ccxt.CreateMarketSellOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketSellOrder(symbol, amount, options...)
}
func (this *Polymarket) CreateMarketSellOrderWithCost(symbol string, cost float64, options ...ccxt.CreateMarketSellOrderWithCostOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketSellOrderWithCost(symbol, cost, options...)
}
func (this *Polymarket) CreateOrderWithTakeProfitAndStopLoss(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWithTakeProfitAndStopLossOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateOrderWithTakeProfitAndStopLoss(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreatePostOnlyOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreatePostOnlyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreatePostOnlyOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateReduceOnlyOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateReduceOnlyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateReduceOnlyOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateStopLimitOrder(symbol string, side string, amount float64, price float64, triggerPrice float64, options ...ccxt.CreateStopLimitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLimitOrder(symbol, side, amount, price, triggerPrice, options...)
}
func (this *Polymarket) CreateStopLossOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopLossOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLossOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateStopMarketOrder(symbol string, side string, amount float64, triggerPrice float64, options ...ccxt.CreateStopMarketOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopMarketOrder(symbol, side, amount, triggerPrice, options...)
}
func (this *Polymarket) CreateStopOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTakeProfitOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTakeProfitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTakeProfitOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTrailingAmountOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingAmountOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingAmountOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTrailingPercentOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingPercentOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingPercentOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTriggerOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTriggerOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTriggerOrder(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) EditLimitBuyOrder(id string, symbol string, amount float64, options ...ccxt.EditLimitBuyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditLimitBuyOrder(id, symbol, amount, options...)
}
func (this *Polymarket) EditLimitOrder(id string, symbol string, side string, amount float64, options ...ccxt.EditLimitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditLimitOrder(id, symbol, side, amount, options...)
}
func (this *Polymarket) EditLimitSellOrder(id string, symbol string, amount float64, options ...ccxt.EditLimitSellOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditLimitSellOrder(id, symbol, amount, options...)
}
func (this *Polymarket) EditOrder(id string, symbol string, typeVar string, side string, options ...ccxt.EditOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditOrder(id, symbol, typeVar, side, options...)
}
func (this *Polymarket) EditOrderWithClientOrderId(clientOrderId string, symbol string, typeVar string, side string, options ...ccxt.EditOrderWithClientOrderIdOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditOrderWithClientOrderId(clientOrderId, symbol, typeVar, side, options...)
}
func (this *Polymarket) EditOrders(orders []ccxt.OrderRequest, options ...ccxt.EditOrdersOptions) ([]ccxt.Order, error) {
...
func (this *Polymarket) FetchBidsAsks(options ...ccxt.FetchBidsAsksOptions) (ccxt.Tickers, error) {
...
func (this *Polymarket) FetchCanceledAndClosedOrders(options ...ccxt.FetchCanceledAndClosedOrdersOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchCanceledAndClosedOrders(options...)
}
func (this *Polymarket) FetchClosedOrders(options ...ccxt.FetchClosedOrdersOptions) ([]ccxt.Order, error) {
...
func (this *Polymarket) FetchMarkPrice(symbol string, options ...ccxt.FetchMarkPriceOptions) (ccxt.Ticker, error) {
	return this.exchangeTyped.FetchMarkPrice(symbol, options...)
}
func (this *Polymarket) FetchMarkPrices(options ...ccxt.FetchMarkPricesOptions) (ccxt.Tickers, error) {
...
func (this *Polymarket) FetchOrderWithClientOrderId(clientOrderId string, options ...ccxt.FetchOrderWithClientOrderIdOptions) (ccxt.Order, error) {
...
func (this *Polymarket) FetchOrders(options ...ccxt.FetchOrdersOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchOrders(options...)
}
func (this *Polymarket) FetchOrderStatus(id string, options ...ccxt.FetchOrderStatusOptions) (string, error) {
	return this.exchangeTyped.FetchOrderStatus(id, options...)
}
func (this *Polymarket) FetchPaymentMethods(params ...any) (map[string]any, error) {
	return this.exchangeTyped.FetchPaymentMethods(params...)
}
func (this *Polymarket) FetchPositionHistory(symbol string, options ...ccxt.FetchPositionHistoryOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionHistory(symbol, options...)
}
func (this *Polymarket) FetchPositionMode(options ...ccxt.FetchPositionModeOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchPositionMode(options...)
}
func (this *Polymarket) FetchPositionsForSymbol(symbol string, options ...ccxt.FetchPositionsForSymbolOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsForSymbol(symbol, options...)
}
func (this *Polymarket) FetchPositionsHistory(options ...ccxt.FetchPositionsHistoryOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsHistory(options...)
}
func (this *Polymarket) FetchPositionsRisk(options ...ccxt.FetchPositionsRiskOptions) ([]ccxt.Position, error) {
...
func (this *Polymarket) CancelAllOrdersWs(options ...ccxt.CancelAllOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.CancelAllOrdersWs(options...)
}
func (this *Polymarket) CancelOrdersWs(ids []string, options ...ccxt.CancelOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.CancelOrdersWs(ids, options...)
}
func (this *Polymarket) CancelOrderWs(id string, options ...ccxt.CancelOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CancelOrderWs(id, options...)
}
func (this *Polymarket) CreateLimitBuyOrderWs(symbol string, amount float64, price float64, options ...ccxt.CreateLimitBuyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitBuyOrderWs(symbol, amount, price, options...)
}
func (this *Polymarket) CreateLimitOrderWs(symbol string, side string, amount float64, price float64, options ...ccxt.CreateLimitOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitOrderWs(symbol, side, amount, price, options...)
}
func (this *Polymarket) CreateLimitSellOrderWs(symbol string, amount float64, price float64, options ...ccxt.CreateLimitSellOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitSellOrderWs(symbol, amount, price, options...)
}
func (this *Polymarket) CreateMarketBuyOrderWs(symbol string, amount float64, options ...ccxt.CreateMarketBuyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketBuyOrderWs(symbol, amount, options...)
}
func (this *Polymarket) CreateMarketOrderWithCostWs(symbol string, side string, cost float64, options ...ccxt.CreateMarketOrderWithCostWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrderWithCostWs(symbol, side, cost, options...)
}
func (this *Polymarket) CreateMarketOrderWs(symbol string, side string, amount float64, options ...ccxt.CreateMarketOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrderWs(symbol, side, amount, options...)
}
func (this *Polymarket) CreateMarketSellOrderWs(symbol string, amount float64, options ...ccxt.CreateMarketSellOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketSellOrderWs(symbol, amount, options...)
}
func (this *Polymarket) CreateOrdersWs(orders []ccxt.OrderRequest, options ...ccxt.CreateOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.CreateOrdersWs(orders, options...)
}
func (this *Polymarket) CreateOrderWithTakeProfitAndStopLossWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWithTakeProfitAndStopLossWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateOrderWithTakeProfitAndStopLossWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreatePostOnlyOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreatePostOnlyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreatePostOnlyOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateReduceOnlyOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateReduceOnlyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateReduceOnlyOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateStopLimitOrderWs(symbol string, side string, amount float64, price float64, triggerPrice float64, options ...ccxt.CreateStopLimitOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLimitOrderWs(symbol, side, amount, price, triggerPrice, options...)
}
func (this *Polymarket) CreateStopLossOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopLossOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLossOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateStopMarketOrderWs(symbol string, side string, amount float64, triggerPrice float64, options ...ccxt.CreateStopMarketOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopMarketOrderWs(symbol, side, amount, triggerPrice, options...)
}
func (this *Polymarket) CreateStopOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTakeProfitOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTakeProfitOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTakeProfitOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTrailingAmountOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingAmountOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingAmountOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTrailingPercentOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingPercentOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingPercentOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) CreateTriggerOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTriggerOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTriggerOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Polymarket) EditOrderWs(id string, symbol string, typeVar string, side string, options ...ccxt.EditOrderWsOptions) (ccxt.Order, error) {
...
func (this *Polymarket) FetchClosedOrdersWs(options ...ccxt.FetchClosedOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchClosedOrdersWs(options...)
}
func (this *Polymarket) FetchDepositsWs(options ...ccxt.FetchDepositsWsOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchDepositsWs(options...)
}
func (this *Polymarket) FetchMyTradesWs(options ...ccxt.FetchMyTradesWsOptions) ([]ccxt.Trade, error) {
...
func (this *Polymarket) FetchOpenOrdersWs(options ...ccxt.FetchOpenOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchOpenOrdersWs(options...)
}
func (this *Polymarket) FetchOrderBookWs(symbol string, options ...ccxt.FetchOrderBookWsOptions) (ccxt.OrderBook, error) {
...
func (this *Polymarket) FetchOrdersWs(options ...ccxt.FetchOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchOrdersWs(options...)
}
func (this *Polymarket) FetchOrderWs(id string, options ...ccxt.FetchOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.FetchOrderWs(id, options...)
}
func (this *Polymarket) FetchPositionsForSymbolWs(symbol string, options ...ccxt.FetchPositionsForSymbolWsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsForSymbolWs(symbol, options...)
}
func (this *Polymarket) FetchPositionsWs(options ...ccxt.FetchPositionsWsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsWs(options...)
}
func (this *Polymarket) FetchPositionWs(symbol string, options ...ccxt.FetchPositionWsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionWs(symbol, options...)
}
func (this *Polymarket) FetchTickersWs(options ...ccxt.FetchTickersWsOptions) (ccxt.Tickers, error) {
	return this.exchangeTyped.FetchTickersWs(options...)
}
func (this *Polymarket) FetchTickerWs(symbol string, options ...ccxt.FetchTickerWsOptions) (ccxt.Ticker, error) {
	return this.exchangeTyped.FetchTickerWs(symbol, options...)
}
func (this *Polymarket) FetchTradesWs(symbol string, options ...ccxt.FetchTradesWsOptions) ([]ccxt.Trade, error) {
...
func (this *Polymarket) WatchBidsAsks(options ...ccxt.WatchBidsAsksOptions) (ccxt.Tickers, error) {
...
func (this *Polymarket) WatchMarkPrice(symbol string, options ...ccxt.WatchMarkPriceOptions) (ccxt.Ticker, error) {
	return this.exchangeTyped.WatchMarkPrice(symbol, options...)
}
func (this *Polymarket) WatchMarkPrices(options ...ccxt.WatchMarkPricesOptions) (ccxt.Tickers, error) {
...
func (this *Polymarket) WatchOrderBookForSymbols(symbols []string, options ...ccxt.WatchOrderBookForSymbolsOptions) (ccxt.OrderBook, error) {
	return this.exchangeTyped.WatchOrderBookForSymbols(symbols, options...)
}
func (this *Polymarket) WatchOrdersForSymbols(symbols []string, options ...ccxt.WatchOrdersForSymbolsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.WatchOrdersForSymbols(symbols, options...)
}
func (this *Polymarket) WatchPosition(options ...ccxt.WatchPositionOptions) (ccxt.Position, error) {
	return this.exchangeTyped.WatchPosition(options...)
}
func (this *Polymarket) WatchPositions(options ...ccxt.WatchPositionsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.WatchPositions(options...)
}
func (this *Polymarket) WatchTickers(options ...ccxt.WatchTickersOptions) (ccxt.Tickers, error) {
	return this.exchangeTyped.WatchTickers(options...)
}
func (this *Polymarket) WatchTradesForSymbols(symbols []string, options ...ccxt.WatchTradesForSymbolsOptions) ([]ccxt.Trade, error) {
