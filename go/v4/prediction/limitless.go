	...
	go func() any {
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(allRaw)); i++ {
			...
			if ccxt.IsTrue(eventKey) {
				...
				retRes31316 := ccxt.GetValue(eventGroup, "markets")
				ccxt.AppendToArray(&retRes31316, m)
			}
		}
...
func (this *LimitlessCore) FetchTicker(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes8388 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(outcomes)); i++ {
			...
			retRes112212 := (<-this.LoadOutcome(ccxt.GetValue(outcomes, i)))
			ccxt.PanicOnError(retRes112212)
...
func (this *LimitlessCore) FetchTrades(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes11718 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrderBook(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12288 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOHLCV(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes13148 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14408 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes14408)
		var outcomeObj any = this.Outcome(outcome)
...
func (this *LimitlessCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14918 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes14918)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"LIVE"},
		})

		retRes149515 := (<-this.FetchOrders(outcome, since, limit, params))
		ccxt.PanicOnError(retRes149515)
		ch <- retRes149515
		return nil
...
func (this *LimitlessCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes15138 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes15138)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"MATCHED"},
		})

		retRes151715 := (<-this.FetchOrders(outcome, since, limit, params))
...
func (this *LimitlessCore) FetchOrdersByIds(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes153212 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes153212)
		}
...
func (this *LimitlessCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes167012 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes167012)
		}
...
func (this *LimitlessCore) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19788 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) Approve(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes224215 := (<-this.WaitForTransactionReceipt(rpcUrl, txHash))
		ccxt.PanicOnError(retRes224215)
		ch <- retRes224215
		return nil
...
func (this *LimitlessCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes225712 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes225712)
		}
		var request any = map[string]any{
			"order_id": id,
		}
...
func (this *LimitlessCore) Redeem(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(conditionId, nil)) {
			...
			retRes229012 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes229012)
			var outcomeObj any = this.Outcome(outcome)
...
func (this *LimitlessCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes232112 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes232112)
		}
		var request any = map[string]any{
			"orderIds": ids,
		}
...
func (this *LimitlessCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(paginate) {
			...
			retRes239619 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", outcome, since, limit, params, "nextCursor", "cursor", nil, maxLimit))
			ccxt.PanicOnError(retRes239619)
			ch <- retRes239619
			return nil
		}
		var request any = map[string]any{}
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsGreaterThan(symbolsLength, 0)) {
			for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(outcomes)); i++ {
				...
				retRes263416 := (<-this.LoadOutcome(ccxt.GetValue(outcomes, i)))
				ccxt.PanicOnError(retRes263416)
			}
		} else {

			retRes263712 := (<-this.LoadOutcomes())
			ccxt.PanicOnError(retRes263712)
		}
...
func (this *LimitlessCore) FetchEvents(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsGreaterThan(queriesLength, 0)) {
			...
			listRaw := (<-this.FetchRawActiveMarkets(params))
		...
		for i := 0; ccxt.IsLessThan(i, rawMarketsLength); i++ {
			...
			if ccxt.IsTrue(eventKey) {
				...
				var eventGroup any = ccxt.GetValue(eventGroups, eventKey)
				retRes289016 := ccxt.GetValue(eventGroup, "markets")
				ccxt.AppendToArray(&retRes289016, m)
			}
		}
		var result any = []any{}
		var eventKeys any = ccxt.ObjectKeys(eventGroups)
