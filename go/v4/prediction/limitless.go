	...
	go func() any {
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(allRaw)); i++ {
			...
			if ccxt.IsTrue(eventKey) {
				...
				retRes31416 := ccxt.GetValue(eventGroup, "markets")
				ccxt.AppendToArray(&retRes31416, m)
			}
		}
...
func (this *LimitlessCore) FetchTicker(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes8458 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes11138 := (<-this.LoadOutcomes(outcomes))
...
func (this *LimitlessCore) FetchTrades(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes11658 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrderBook(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12228 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14348 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14858 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes14858)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"LIVE"},
		})

		retRes148915 := (<-this.FetchOrders(outcome, since, limit, params))
		ccxt.PanicOnError(retRes148915)
		ch <- retRes148915
		return nil
...
func (this *LimitlessCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes151115 := (<-this.FetchOrders(outcome, since, limit, params))
...
func (this *LimitlessCore) FetchOrdersByIds(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes152612 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19728 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) Approve(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes223615 := (<-this.WaitForTransactionReceipt(rpcUrl, txHash))
...
func (this *LimitlessCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes225112 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes225112)
		}
		var request any = map[string]any{
			"order_id": id,
		}
...
func (this *LimitlessCore) Redeem(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(conditionId, nil)) {
			...
			retRes228412 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes228412)
			var outcomeObj any = this.Outcome(outcome)
...
func (this *LimitlessCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(paginate) {
			...
			retRes239019 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", outcome, since, limit, params, "nextCursor", "cursor", nil, maxLimit))
			ccxt.PanicOnError(retRes239019)
			ch <- retRes239019
			return nil
		}
		var request any = map[string]any{}
...
func (this *LimitlessCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsGreaterThan(symbolsLength, 0)) {
			...
			retRes262712 := (<-this.LoadOutcomes(outcomes))
			ccxt.PanicOnError(retRes262712)
		}
	...
	go func() any {
		...
		for i := 0; ccxt.IsLessThan(i, rawMarketsLength); i++ {
			...
			if ccxt.IsTrue(eventKey) {
				...
				var eventGroup any = ccxt.GetValue(eventGroups, eventKey)
				retRes288616 := ccxt.GetValue(eventGroup, "markets")
				ccxt.AppendToArray(&retRes288616, m)
			}
		}
		var result any = []any{}
		var eventKeys any = ccxt.ObjectKeys(eventGroups)
