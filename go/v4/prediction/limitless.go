...
func (this *Limitless) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes155915 []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.FetchOrdersAsync(outcome, since, limit, params))))
	ch <- ccxt.BoxAbsent(retRes155915)
	return nil
}
...
func (this *Limitless) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes158115 []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.FetchOrdersAsync(outcome, since, limit, params))))
	ch <- ccxt.BoxAbsent(retRes158115)
	return nil
}
...
func (this *Limitless) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	response := (<-this.LimitlessPrivateDeleteOrdersAllSlug(this.Extend(request, params))).Raw
	ccxt.PanicOnError(response)
...
func (this *Limitless) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate == true {
		...
		var retRes246319 []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", outcome, since, limit, params, "nextCursor", "cursor", nil, maxLimit))))
		ch <- ccxt.BoxAbsent(retRes246319)
		return nil
	}
	var request map[string]any = map[string]any{}
	if limit != nil {
	...
	var response map[string]any = ccxt.MapTyped(ccxt.PanicOnError((<-this.LimitlessPrivateGetPortfolioHistory(this.Extend(request, params))).Raw))
	//
	//     {
	//         "data": [
	//             {
...
func (this *Limitless) fetchRawActiveMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for true {
		...
		if categoryId != nil {
			...
			response = (<-this.LimitlessPublicGetMarketsActiveCategoryId(this.Extend(request, rest))).Raw
			ccxt.PanicOnError(response)
		} else {
