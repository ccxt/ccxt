...
func (this *Limitless) Describe() any {
 ...
 */
func (this *Limitless) ExpandGroupRows(rawRows any) any {
	var result any = []any{}
...
func (this *Limitless) ParseEvent(event any) any {
	// {
...
func (this *Limitless) ApplyScale(amount any, optionalArgs ...any) any {
...
func (this *Limitless) ParseAccount(account any) any {
...
func (this *Limitless) HashMessage(message any) any {
 ...
 */
func (this *Limitless) ParsePredictionTrade(trade any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
 ...
 */
func (this *Limitless) ParsePredictionPosition(position any, optionalArgs ...any) any {
	//
	//     {
	//         "cost": "995720",
	//         "fillPrice": "991000",
...
func (this *Limitless) Sign(path any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(access, "private")) {
		...
		var headerKey any = ccxt.Add("lmts-api", "-key") // concatenating because of the php version
...
func (this *Limitless) Init(userConfig map[string]any) {
...
func (this *Limitless) FetchOrdersByIds(ids any, options ...FetchOrdersByIdsOptions) ([]ccxt.PredictionOrder, error) {
	...
	res := <-this.FetchOrdersByIdsAsync(ids, opts.Outcome, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewPredictionOrderArray(res), nil
...
func (this *Limitless) FetchRawActiveMarkets(options ...FetchRawActiveMarketsOptions) ([]map[string]any, error) {
	...
	res := <-this.FetchRawActiveMarketsAsync(opts.Params, opts.CategoryId)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
...
func (this *Limitless) FetchRawMarketsByTags(tags []string, options ...FetchRawMarketsByTagsOptions) ([]map[string]any, error) {
	...
	res := <-this.FetchRawMarketsByTagsAsync(tags, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewMapArray(res), nil
...
func (this *Limitless) FetchDepositWithdrawFee(code string, options ...ccxt.FetchDepositWithdrawFeeOptions) (ccxt.DepositWithdrawFee, error) {
	return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)
}
func (this *Limitless) FetchDepositWithdrawFees(options ...ccxt.FetchDepositWithdrawFeesOptions) (ccxt.DepositWithdrawFees, error) {
