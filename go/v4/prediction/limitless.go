...
func  (this *LimitlessCore) ParseEvent(event any) any  {
    ...
    return this.Extend(map[string]any {
        "id": groupId,
        "slug": groupId,
        "symbol": ccxt.Ternary(ccxt.IsTrue(groupId), this.ShortenSlug(groupId), nil),
        "title": title,
 ...
 */
func  (this *LimitlessCore) FetchTicker(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *LimitlessCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ch <- this.FilterByOutcomeSinceLimit(parsedTrades, symbol, since, limit)
            return nil
 ...
 */
func  (this *LimitlessCore) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *LimitlessCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure](https://docs.ccxt.com/#/?id=order-structure)
 */
func  (this *LimitlessCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var walletFromAccount any = this.SafeString(accountInfo, "smartWallet")
            ...
            var isSmartWallet any = ccxt.IsTrue((ccxt.IsEqual(tradeWalletOption, "smartWallet"))) && ccxt.IsTrue(hasEmbedded)
...
func  (this *LimitlessCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            if ccxt.IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                    ...
                    retRes222719 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", outcome, since, limit, params, "nextCursor", "cursor", nil, maxLimit))
                    ccxt.PanicOnError(retRes222719)
                    ch <- retRes222719
                    return nil
            }
            var request any = map[string]any {}
...
func  (this *LimitlessCore) FetchEvents(optionalArgs ...any) <- chan any {
            ...
            if ccxt.IsTrue(!ccxt.IsTrue(queries) || ccxt.IsTrue(ccxt.IsEqual(queriesLength, 0))) {
                ...
                retRes266912 := (<-this.LoadMarkets())
                ccxt.PanicOnError(retRes266912)
            ...
            "markets": []any{},
                        ...
                        var eventGroup any = ccxt.GetValue(eventGroups, eventKey)
                        retRes271020 := ccxt.GetValue(eventGroup, "markets")
                        ccxt.AppendToArray(&retRes271020, m)
                    }
                }
                result = []any{}
                var eventKeys any = ccxt.ObjectKeys(eventGroups)
