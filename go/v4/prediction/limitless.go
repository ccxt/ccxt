...
func (this *Limitless) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if queriesLength > 0 {
		...
		var knownTotal any = func() any { if (totalMarketsCount != nil) { return totalMarketsCount }; return 0 }()
		...
		if ccxt.IsGreaterThanOrEqual(lastPageLength, pageSize) && ccxt.IsLessThan(allRawLength, maxMarkets) {
			for true {
				...
				var page_markets any = func() any { if (!ccxt.IsEqual(rawPageMarkets, nil)) { return rawPageMarkets }; return []any{} }()
				var pageMarketsLength int = ccxt.GetArrayLength(page_markets)
				if pageMarketsLength == 0 {
					break
				}
				for i := 0; i < ccxt.GetArrayLength(page_markets); i++ {
	...
	for i := 0; i < ccxt.GetArrayLength(expandedRaw); i++ {
		...
		var eventKey any = func() any { if ((groupId != nil) && (groupId == nil || *groupId != "")) { return this.ShortenSlug(groupId) }; return nil }()
...
func (this *Limitless) ParseMarket(raw any) any {
	...
	return map[string]any{
		"id":              slug,
		"market":          marketSymbol,
		"marketType":      func() any { if (outcomesLength > 2) { return "categorical" }; return "binary" }(),
		"executionModel":  "clob",
		"collateral":      "USDC",
		"base":            slug,
		"quote":           "USDC",
...
func (this *Limitless) ExpandGroupRows(rawRows any) any {
	var result any = []any{}
	for i := 0; i < ccxt.GetArrayLength(rawRows); i++ {
...
func (this *Limitless) ParseEvent(event any) any {
	...
	var eventSlug any = func() any { if hasGroupId { return this.ShortenSlug(groupId) }; return nil }()
	var hasEndDate bool = (endDate != nil) && (endDate == nil || *endDate != "")
	var endTimestamp any = func() any { if hasEndDate { return this.Parse8601(endDate) }; return nil }()
	var markets any = []any{}
...
func (this *Limitless) ParsePredictionTicker(ticker any, optionalArgs ...any) any {
	...
	var rawLabel any = func() any { if (!ccxt.IsEqual(market, nil)) { return this.SafeString(market, "label", this.SafeString(ccxt.GetValue(market, "info"), "outcomeLabel", "yes")) }; return "yes" }()
	...
	if !ccxt.IsEqual(book, nil) {
		...
		var yesBestBid any = func() any { if (rawBidsLength > 0) { return ccxt.GetValue(rawBids, 0) }; return nil }()
		var yesBestAsk any = func() any { if (rawAsksLength > 0) { return ccxt.GetValue(rawAsks, 0) }; return nil }()
	...
	if (lastStr == nil) && (pricesLength > 0) {
		lastStr = func() any { if (isYes) { return this.SafeString(prices, 0) }; return this.SafeString(prices, 1) }()
	}
...
func (this *Limitless) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	var promises any = []any{}
	for i := 0; i < ccxt.GetArrayLength(slugs); i++ {
...
func (this *Limitless) fetchOrderBookBody(ch chan any, outcome any, optionalArgs ...any) any {
	...
	var bidsSource any = func() any { if (isYes) { return rawBids }; return rawAsks }()
	var asksSource any = func() any { if (isYes) { return rawAsks }; return rawBids }()
	var bids any = []any{}
	var asks any = []any{}
	for bi := 0; bi < ccxt.GetArrayLength(bidsSource); bi++ {
	...
	for ai := 0; ai < ccxt.GetArrayLength(asksSource); ai++ {
...
func (this *Limitless) fetchOHLCVBody(ch chan any, outcome any, optionalArgs ...any) any {
	...
	var rawHistory any = func() any { if (!ccxt.IsEqual(rawHistoryList, nil)) { return rawHistoryList }; return []any{} }()
	...
	if rawHistoryLength > 0 {
		...
		if !ccxt.IsEqual(firstPrices, nil) {
			...
			for i := 0; i < ccxt.GetArrayLength(rawHistory); i++ {
				...
				if title == nil {
					panic(ccxt.ExchangeError(this.Id + " fetchOHLCV() missing title"))
				}
				if (outcomeLabel != nil) && (ccxt.GetIndexOf(title, outcomeLabel) >= 0) {
	...
	for i := 0; i < ccxt.GetArrayLength(history); i++ {
		...
		if ccxt.IsEqual(pointTs, nil) {
			...
			pointTs = func() any { if ((tsString != nil) && (tsString == nil || *tsString != "")) { return this.Parse8601(tsString) }; return nil }()
	...
	for i := 0; i < len(sorted); i++ {
		...
		if !(func() bool { _, ok := candles[key]; return ok }()) {
			...
			var pPriceOrZero any = func() any { if (pPrice == nil) { return 0 }; return pPrice }()
			ccxt.AddElementToObject(candle, 2, ccxt.MathMax(ccxt.GetValue(candle, 2), pPriceOrZero))
			var candleLow any = func() any { if (ccxt.IsEqual(ccxt.GetValue(candle, 3), nil)) { return pPrice }; return ccxt.GetValue(candle, 3) }()
			var pPriceOrCandleLow any = func() any { if (pPrice == nil) { return ccxt.GetValue(candle, 3) }; return pPrice }()
	...
	var result any = []any{}
	for i := 0; i < ccxt.GetArrayLength(bucketOrder); i++ {
...
func (this *Limitless) fetchOrdersByIdsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if length > 50 {
		panic(ccxt.BadRequest(this.Id + " fetchOrdersByIds can only fetch up to 50 orders at a time"))
	}
	var items any = []any{}
	for i := 0; i < length; i++ {
...
func (this *Limitless) ParsePredictionOrder(order any, optionalArgs ...any) any {
	...
	var amountKey any = func() any { if (side != nil && *side == "buy") { return "takerAmount" }; return "makerAmount" }() // todo check
...
func (this *Limitless) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var walletFromAccount any = func() any { if (usesSmartWallet) { return this.SafeString(accountInfo, "smartWallet") }; return this.SafeString(accountInfo, "account") }()
	var maker any = func() any { if (this.WalletAddress != "") { return this.WalletAddress }; return walletFromAccount }()
			...
			defer func() {
				if e := recover(); e != nil {
					...
					ret_ = func(this *Limitless) any {
						// catch block:
						panic(ccxt.InvalidAddress(this.Id + " createOrder requires a valid maker address. Set the \"maker\" parameter to a valid address or set the \"walletAddress\" property in the constructor options."))
		...
		func(this *Limitless) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					...
					ret_ = func(this *Limitless) any {
						// catch block:
						panic(ccxt.InvalidAddress(this.Id + " createOrder requires a valid signer address. Set the \"signer\" parameter to a valid address or set the \"walletAddress\" property in the constructor options."))
		...
		func(this *Limitless) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					...
					ret_ = func(this *Limitless) any {
						// catch block:
						panic(ccxt.InvalidAddress(this.Id + " createOrder requires a valid taker address. Set the \"taker\" parameter to a valid address or set the \"nullAddress\" property in the constructor options."))
	...
	var signatureType any = func() any { if isSmartWallet { return 2 }; return 0 }()
	...
	if timeInForce == nil {
		timeInForce = func() any { if isMarket { return "FOK" }; return "GTC" }()
	}
	...
	signRequest["takerAmount"] = func() any { if isMarket { return 1 }; return this.ParseToInt(this.ApplyScale(takerAmount, true)) }()
...
func (this *Limitless) redeemBody(ch chan any, optionalArgs ...any) any {
	...
	if conditionId == nil {
		panic(ccxt.ArgumentsRequired(this.Id + " redeem() could not resolve the market conditionId - pass params.conditionId (a bytes32 hex string)"))
	}
	var request map[string]any = map[string]any{
		"conditionId": conditionId,
	}
...
func (this *Limitless) ParsePredictionTrade(trade any, optionalArgs ...any) any {
	...
	var side any = func() any { if (sellIndex >= 0) { return "sell" }; return "buy" }()
	var typeVar any = nil
	var takerOrMaker any = nil
	if rawSide == nil {
		panic(ccxt.ExchangeError(this.Id + " parsePredictionTrade() missing rawSide"))
	}
	if ccxt.GetIndexOf(rawSide, "limit") >= 0 {
		typeVar = "limit"
		takerOrMaker = "maker"
		if rawSide == nil {
			panic(ccxt.ExchangeError(this.Id + " method() missing rawSide"))
		}
	} else if ccxt.GetIndexOf(rawSide, "market") >= 0 {
		typeVar = "market"
		takerOrMaker = "taker"
	}
	...
	var label any = func() any { if (outcomeIndex != nil && *outcomeIndex == 0) { return "yes" }; return "no" }()
...
func (this *Limitless) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(clob); i++ {
...
func (this *Limitless) fetchEventsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < rawMarketsLength; i++ {
		...
		if ccxt.IsEqual(m, nil) {
			panic(ccxt.ExchangeError(this.Id + " fetchEvents() missing m"))
		}
...
func (this *Limitless) fetchRawMarketsByTagsBody(ch chan any, tags any, optionalArgs ...any) any {
	...
	var wanted any = []any{}
	for i := 0; i < ccxt.GetArrayLength(tags); i++ {
	...
	for i := 0; i < categoriesLength; i++ {
		...
		for wi := 0; wi < ccxt.GetArrayLength(wanted); wi++ {
			if name == nil {
	...
	if categoryIdsLength == 0 {
		panic(ccxt.BadRequest(this.Id + " fetchEvents() could not match the requested tags to any limitless category — GET /categories lists the valid names"))
	}
	var seen map[string]any = map[string]any{}
	var allRaw any = []any{}
