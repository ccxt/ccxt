...
func (this *LimitlessCore) FetchTicker(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes8918 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes11598 := (<-this.LoadOutcomes(outcomes))
...
func (this *LimitlessCore) FetchTrades(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12118 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrderBook(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12688 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOHLCV(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes13548 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14808 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes15318 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes15318)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"LIVE"},
		})

		retRes153515 := (<-this.FetchOrders(outcome, since, limit, params))
		ccxt.PanicOnError(retRes153515)
		ch <- retRes153515
		return nil
...
func (this *LimitlessCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes15538 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes15538)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"MATCHED"},
		})

		retRes155715 := (<-this.FetchOrders(outcome, since, limit, params))
...
func (this *LimitlessCore) FetchOrdersByIds(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes157212 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes157212)
		}
...
func (this *LimitlessCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes171012 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes171012)
		}
...
func (this *LimitlessCore) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20188 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) Approve(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes228215 := (<-this.WaitForTransactionReceipt(rpcUrl, txHash))
		ccxt.PanicOnError(retRes228215)
		ch <- retRes228215
		return nil
...
func (this *LimitlessCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes229712 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes229712)
		}
		var request any = map[string]any{
			"order_id": id,
		}
...
func (this *LimitlessCore) Redeem(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(conditionId, nil)) {
			...
			retRes233012 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes233012)
			var outcomeObj any = this.Outcome(outcome)
...
func (this *LimitlessCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes236112 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes236112)
		}
		var request any = map[string]any{
			"orderIds": ids,
		}
...
func (this *LimitlessCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(paginate) {
			...
			retRes243619 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", outcome, since, limit, params, "nextCursor", "cursor", nil, maxLimit))
...
func (this *LimitlessCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsGreaterThan(symbolsLength, 0)) {
			...
			retRes267312 := (<-this.LoadOutcomes(outcomes))
			ccxt.PanicOnError(retRes267312)
		}
