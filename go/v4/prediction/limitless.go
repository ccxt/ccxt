...
func (this *LimitlessCore) FetchTrades(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12108 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOHLCV(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes13538 := (<-this.LoadOutcome(outcome))
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(sorted)); i++ {
			...
			if !ccxt.IsTrue((ccxt.InOp(candles, key))) {
				...
				ccxt.AddElementToObject(candle, 2, ccxt.MathMax(ccxt.GetValue(candle, 2), pPrice))
				ccxt.AddElementToObject(candle, 3, ccxt.MathMin(ccxt.GetValue(candle, 3), pPrice))
...
func (this *LimitlessCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes14798 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes14798)
		var outcomeObj any = this.Outcome(outcome)
...
func (this *LimitlessCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes15308 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes15308)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"LIVE"},
		})

		retRes153415 := (<-this.FetchOrders(outcome, since, limit, params))
		ccxt.PanicOnError(retRes153415)
		ch <- retRes153415
		return nil
...
func (this *LimitlessCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes15528 := (<-this.LoadOutcome(outcome))
		ccxt.PanicOnError(retRes15528)
		params = this.Extend(params, map[string]any{
			"statuses": []any{"MATCHED"},
		})

		retRes155615 := (<-this.FetchOrders(outcome, since, limit, params))
		ccxt.PanicOnError(retRes155615)
		ch <- retRes155615
		return nil
...
func (this *LimitlessCore) FetchOrdersByIds(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes157112 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes170912 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20178 := (<-this.LoadOutcome(outcome))
...
func (this *LimitlessCore) Approve(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes228115 := (<-this.WaitForTransactionReceipt(rpcUrl, txHash))
		ccxt.PanicOnError(retRes228115)
		ch <- retRes228115
		return nil
...
func (this *LimitlessCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
			...
			retRes229612 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes229612)
		}
		var request any = map[string]any{
			"order_id": id,
		}
...
func (this *LimitlessCore) Redeem(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(conditionId, nil)) {
			...
			retRes232912 := (<-this.LoadOutcome(outcome))
			ccxt.PanicOnError(retRes232912)
			var outcomeObj any = this.Outcome(outcome)
...
func (this *LimitlessCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(paginate) {
			...
			retRes243519 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", outcome, since, limit, params, "nextCursor", "cursor", nil, maxLimit))
			ccxt.PanicOnError(retRes243519)
			ch <- retRes243519
			return nil
		}
		var request any = map[string]any{}
...
func (this *LimitlessCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsGreaterThan(symbolsLength, 0)) {
			...
			retRes267212 := (<-this.LoadOutcomes(outcomes))
			ccxt.PanicOnError(retRes267212)
		}
