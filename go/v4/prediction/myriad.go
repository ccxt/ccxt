...
func (this *Myriad) fetchRawQuestionByIdBody(ch chan any, id any, optionalArgs ...any) any {
	...
	{
		func(this *Myriad) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					if e == "break" {
						return
					}
					ret_ = func(this *Myriad) any {
						// catch block:
 ...
 */
func (this *Myriad) ParsePredictionPosition(position any, optionalArgs ...any) any {
...
func (this *Myriad) SignEvmTransaction(tx any, privateKey any) any {
...
func (this *Myriad) ensureErc20AllowanceBody(ch chan any, rpcUrl any, networkId any, token any, owner any, spender any) any {
	...
	retRes8088 := (<-this.WaitForTransactionReceiptAsync(rpcUrl, approveHash))
 ...
 */
func (this *Myriad) CreateOrderAsync(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, outcome, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Myriad) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(tradingModel, "ob")) {
		...
		retRes83519 := (<-this.CreateOrderbookOrderAsync(outcome, typeVar, side, amount, price, rest))
	...
	retRes84315 := (<-this.CreateAmmOrderAsync(outcome, typeVar, side, amount, price, this.Omit(rest, []any{"enableAmm", "enableAmmOrders"})))
...
func (this *Myriad) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	retRes10028 := (<-this.LoadOutcomesAsync(orderOutcomes))
...
func (this *Myriad) editOrderBody(ch chan any, id any, outcome any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes10378 := (<-this.LoadOutcomeAsync(outcome))
	ccxt.PanicOnError(retRes10378)

	retRes10388 := (<-this.CancelOrderAsync(id, outcome, params))
	ccxt.PanicOnError(retRes10388)

	retRes103915 := (<-this.CreateOrderbookOrderAsync(outcome, typeVar, side, amount, price, params))
...
func (this *Myriad) createAmmOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(sideStr, "buy"))) && ccxt.IsTrue((!ccxt.IsEqual(tokenAddress, nil)))) && ccxt.IsTrue((!ccxt.IsEqual(skipAllowance, true)))) {
		...
		retRes110012 := (<-this.EnsureErc20AllowanceAsync(rpcUrl, networkId, tokenAddress, fromAddress, predictionMarket))
	...
	if ccxt.IsTrue(!ccxt.IsEqual(skipWaitForReceipt, true)) {
		...
		retRes110812 := (<-this.WaitForTransactionReceiptAsync(rpcUrl, txHash))
...
func (this *Myriad) createMarketBuyOrderWithCostBody(ch chan any, outcome any, cost any, optionalArgs ...any) any {
	...
	retRes112715 := (<-this.CreateOrderAsync(outcome, "market", "buy", cost, nil, request))
 ...
 */
func (this *Myriad) GetOrderResponseFromParams(id any, optionalArgs ...any) any {
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
 ...
 */
func (this *Myriad) ToOrderbookWei(value any) any {
...
func (this *Myriad) ParseOrderStatus(status any) any {
 ...
 * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func (this *Myriad) ParseAmmEventToOrder(trade any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
...
func (this *Myriad) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(requestedTradingModel, "amm")) {
		...
		retRes179419 := (<-this.FetchAmmOrdersAsync(outcome, since, limit, params))
...
func (this *Myriad) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes185515 := (<-this.FetchOrdersAsync(outcome, since, limit, this.Extend(request, params)))
...
func (this *Myriad) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes187315 := (<-this.FetchOrdersAsync(outcome, since, limit, this.Extend(request, params)))
...
func (this *Myriad) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes189115 := (<-this.FetchOrdersAsync(outcome, since, limit, this.Extend(request, params)))
...
func (this *Myriad) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	orders := (<-this.FetchOrdersAsync(outcome, since, limit, this.Extend(request, params)))
...
func (this *Myriad) FromWeiWithDecimals(hexValue any, decimals any) any {
 ...
 */
func (this *Myriad) ParseMarketToEvent(raw any, market any) any {
 ...
 */
func (this *Myriad) ParseMyriadMarket(raw any, optionalArgs ...any) any {
...
func (this *Myriad) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes28558 := (<-this.LoadOutcomesAsync(outcomes))
 ...
 */
func (this *Myriad) ParsePredictionTrade(trade any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
	var timestamp any = this.SafeTimestamp(trade, "timestamp")
	var amountStr any = this.SafeString(trade, "shares")
...
func (this *Myriad) FromWei(wei any) any {
	if ccxt.IsTrue(ccxt.IsEqual(wei, nil)) {
		return nil
	}
	return this.ParseNumber(ccxt.Precise.StringDiv(wei, "1000000000000000000"))
}
func (this *Myriad) MarketOutcomeToSymbol(networkId any, marketId any, outcomeId any) any {
...
func (this *Myriad) pongBody(ch chan any, client any, optionalArgs ...any) any {
	...
	retRes32338 := (<-client.(ccxt.ClientInterface).SendAsync("{}"))
...
func (this *Myriad) subscribeMyriadChannelBody(ch chan any, messageHash any, channel any, optionalArgs ...any) any {
	...
	retRes32398 := (<-this.ConnectCentrifugoAsync(url))
...
func (this *Myriad) HandleCentrifugoFrame(client any, msg any) {
...
func (this *Myriad) watchOrderBookBody(ch chan any, outcome any, optionalArgs ...any) any {
	...
	retRes33228 := (<-this.ConnectCentrifugoAsync(url))
	...
	if ccxt.IsTrue(isNewSubscription) {
		...
		retRes332812 := (<-this.SeedOrderBookAsync(outcome, sym, limit))
...
func (this *Myriad) HandleOrderBook(client any, data any) {
...
func (this *Myriad) HandleTrades(client any, data any) {
	var networkId any = this.SafeString(data, "networkId")
	var marketId any = this.SafeString(data, "marketId")
	var ts any = this.SafeInteger(data, "ts")
...
func (this *Myriad) watchTickerBody(ch chan any, outcome any, optionalArgs ...any) any {
	...
	retRes356615 := (<-this.SubscribeMyriadChannelAsync(messageHash, channel, params))
...
func (this *Myriad) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes35848 := (<-this.ConnectCentrifugoAsync(url))
	ccxt.PanicOnError(retRes35848)

	retRes35858 := (<-this.LoadOutcomesAsync(outcomes))
...
func (this *Myriad) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes37768 := (<-this.ConnectCentrifugoAsync(url))
	...
	if ccxt.IsTrue(isNewSubscription) {
		...
		retRes378212 := (<-this.SeedPositionBalancesAsync(trader))
...
func (this *Myriad) Init(userConfig map[string]any) {
...
func (this *Myriad) FetchRawMarketsBySearch(queries []any, options ...FetchRawMarketsBySearchOptions) ([]map[string]any, error) {
	...
	res := <-this.FetchRawMarketsBySearchAsync(queries, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
...
func (this *Myriad) FetchRawMarketsList(params ...any) ([]map[string]any, error) {
	res := <-this.FetchRawMarketsListAsync(params...)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewMapArray(res), nil
...
func (this *Myriad) FetchRawMarketById(id string, options ...FetchRawMarketByIdOptions) (map[string]any, error) {
	...
	res := <-this.FetchRawMarketByIdAsync(id, opts.Params)
	if ccxt.IsError(res) {
...
func (this *Myriad) FetchRawQuestionById(id string, options ...FetchRawQuestionByIdOptions) (map[string]any, error) {
	...
	res := <-this.FetchRawQuestionByIdAsync(id, opts.Params)
	if ccxt.IsError(res) {
		return map[string]any{}, ccxt.CreateReturnError(res)
	}
	return res.(map[string]any), nil
...
func (this *Myriad) FetchRawQuestionsBySearch(queries []string, options ...FetchRawQuestionsBySearchOptions) ([]map[string]any, error) {
	...
	res := <-this.FetchRawQuestionsBySearchAsync(queries, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewMapArray(res), nil
...
func (this *Myriad) FetchRawQuestionsList(params ...any) ([]map[string]any, error) {
	res := <-this.FetchRawQuestionsListAsync(params...)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewMapArray(res), nil
...
func (this *Myriad) FetchTradeQuote(outcome string, side string, amount float64, options ...FetchTradeQuoteOptions) (map[string]any, error) {
	...
	res := <-this.FetchTradeQuoteAsync(outcome, side, amount, opts.Params)
	if ccxt.IsError(res) {
		return map[string]any{}, ccxt.CreateReturnError(res)
	}
	return res.(map[string]any), nil
...
func (this *Myriad) CreateOrderbookOrder(outcome string, typeVar string, side string, amount float64, options ...CreateOrderbookOrderOptions) (ccxt.PredictionOrder, error) {
	...
	res := <-this.CreateOrderbookOrderAsync(outcome, typeVar, side, amount, opts.Price, opts.Params)
	if ccxt.IsError(res) {
		return ccxt.PredictionOrder{}, ccxt.CreateReturnError(res)
	}
	return ccxt.NewPredictionOrder(res), nil
...
func (this *Myriad) CreateAmmOrder(outcome string, typeVar string, side string, amount float64, options ...CreateAmmOrderOptions) (ccxt.PredictionOrder, error) {
	...
	res := <-this.CreateAmmOrderAsync(outcome, typeVar, side, amount, opts.Price, opts.Params)
	if ccxt.IsError(res) {
		return ccxt.PredictionOrder{}, ccxt.CreateReturnError(res)
	}
	return ccxt.NewPredictionOrder(res), nil
...
func (this *Myriad) FetchAmmOrders(options ...FetchAmmOrdersOptions) ([]ccxt.PredictionOrder, error) {
	...
	res := <-this.FetchAmmOrdersAsync(opts.Outcome, opts.Since, opts.Limit, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewPredictionOrderArray(res), nil
...
func (this *Myriad) FetchCanceledOrders(options ...FetchCanceledOrdersOptions) ([]ccxt.PredictionOrder, error) {
	...
	res := <-this.FetchCanceledOrdersAsync(opts.Outcome, opts.Since, opts.Limit, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewPredictionOrderArray(res), nil
...
func (this *Myriad) WatchOHLCV(outcome string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {
	...
	res := <-this.WatchOHLCVAsync(outcome, opts.Timeframe, opts.Since, opts.Limit, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewOHLCVArray(res), nil
