...
func (this *MyriadCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		for i := 0; ccxt.IsLessThan(i, ordersLength); i++ {
			...
			var outcome any = this.SafeString(o, "symbol")
...
func (this *MyriadCore) PopulateOutcomes() {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketKeys)); i++ {
		...
		for j := 0; ccxt.IsLessThan(j, ccxt.GetArrayLength(outcomesList)); j++ {
			...
			ccxt.AddElementToObject(oc, "outcome", ocSymbol)
			ccxt.AddElementToObject(oc, "outcomeId", ocId)
			ccxt.AddElementToObject(oc, "market", this.SafeString2(oc, "market", "marketSymbol"))
...
func (this *MyriadCore) ConnectCentrifugo(url any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(connectSent, nil)) {
			...
			retRes257319 := (<-this.Watch(url, "centrifugoConnected", connectMsg, "connect"))
			ccxt.PanicOnError(retRes257319)
			ch <- retRes257319
			return nil
		}
		...
		retRes258015 := (<-client.(ccxt.ClientInterface).Future("centrifugoConnected"))
		ccxt.PanicOnError(retRes258015)
...
func (this *MyriadCore) Pong(client any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes25858 := (<-client.(ccxt.ClientInterface).Send("{}"))
...
func (this *MyriadCore) SubscribeMyriadChannel(messageHash any, channel any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes25918 := (<-this.ConnectCentrifugo(url))
		ccxt.PanicOnError(retRes25918)
		var requestId any = this.RequestId(url)
		...
		retRes259415 := (<-this.Watch(url, messageHash, subscribeMsg, channel))
		ccxt.PanicOnError(retRes259415)
		ch <- retRes259415
		return nil
...
func (this *MyriadCore) WatchOrderBook(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes26758 := (<-this.ConnectCentrifugo(url))
		ccxt.PanicOnError(retRes26758)
		var client any = this.Client(url)
		...
		if ccxt.IsTrue(isNewSubscription) {
			...
			retRes268112 := (<-this.SeedOrderBook(outcome, sym, limit))
			ccxt.PanicOnError(retRes268112)
		}
		var requestId any = this.RequestId(url)
		var subscribeMsg any = map[string]any{
			"subscribe": map[string]any{
...
func (this *MyriadCore) WatchTicker(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes292215 := (<-this.SubscribeMyriadChannel(messageHash, channel, params))
		ccxt.PanicOnError(retRes292215)
		ch <- retRes292215
		return nil
...
func (this *MyriadCore) WatchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes29418 := (<-this.ConnectCentrifugo(url))
		ccxt.PanicOnError(retRes29418)
		var client any = this.Client(url)
