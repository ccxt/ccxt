...
func (this *Myriad) ParsePredictionPosition(position any, optionalArgs ...any) any {
	...
	var shares *float64 = this.SafeNumber(position, "shares")
...
func (this *Myriad) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var enableAmm *bool = this.SafeBool2(params, "enableAmm", "enableAmmOrders", this.SafeBool(this.Options, "enableAmmOrders", false))
	if enableAmm == nil || *enableAmm != true {
...
func (this *Myriad) BuildOrderbookOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var defaultTif string = ccxt.Ternary(isMarket, "FOK", "GTC").(string)
...
func (this *Myriad) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	for i := 0; ccxt.IsLessThan(i, ordersLength); i++ {
		...
		var amount *float64 = this.SafeNumber(o, "amount")
...
func (this *Myriad) createAmmOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var isCostDenominated *bool = this.SafeBool(params, "costDenominated", false)
	if (ccxt.IsEqual(sideLower, "buy")) && (isCostDenominated == nil || *isCostDenominated != true) {
...
func (this *Myriad) ToOrderbookWei(value any) any {
	var valueStr *string = this.NumberToString(value)
...
func (this *Myriad) ParsePredictionOrder(order any, optionalArgs ...any) any {
	...
	var side string = ccxt.Ternary((sideInt != nil && *sideInt == 1), "sell", "buy").(string)
...
func (this *Myriad) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var networkId *string = this.SafeStringN(fetched, []any{"networkId", "network_id"})
	if networkId == nil {
...
func (this *Myriad) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	for i := 0; ccxt.IsLessThan(i, idsLength); i++ {
		...
		var fetchedNetworkId *string = this.SafeStringN(fetched, []any{"networkId", "network_id"})
...
func (this *Myriad) ParseMyriadMarket(raw any, optionalArgs ...any) any {
	...
	var voided *bool = this.SafeBool(raw, "voided", false)
	...
	var marketResolved bool = hasResolution || (voided != nil && *voided)
	var resolvedOutcome any = nil
	var volume24h *float64 = this.SafeNumber(raw, "volume24h")
	...
	var marketExecutionModel string = ccxt.Ternary((marketTradingModel != nil && *marketTradingModel == "amm"), "amm", "clob").(string)
...
func (this *Myriad) fetchOHLCVBody(ch chan any, outcome any, optionalArgs ...any) any {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(points)); i++ {
		...
		var pointOpen *float64 = this.SafeNumber(point, "open")
		var pointPrice *float64 = this.SafeNumber(point, "price", this.SafeNumber(point, "value"))
		var pointTs *int64 = this.SafeInteger(point, "timestamp")
		if ((pointOpen != nil) || (pointPrice != nil)) && (pointTs != nil) {
...
func (this *Myriad) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	return []any{this.SafeTimestamp(ohlcv, "timestamp"), ccxt.Ternary((open != nil), open, price), ccxt.Ternary((high != nil), high, price), ccxt.Ternary((low != nil), low, price), ccxt.Ternary((close != nil), close, price), 0}
}
...
func (this *Myriad) HandleOrder(client any, data any) {
	...
	var status *string = this.ParseOrderStatus(this.SafeStringLower(data, "status"))
