...
func  (this *MyriadCore) FetchPositions(optionalArgs ...any) <- chan any {
            ...
            ch <- this.FilterByArrayPositions(result, "outcome", symbols, false)
            return nil
...
func  (this *MyriadCore) SendEvmTransaction(rpcUrl any, networkId any, fromAddress any, to any, value any, data any, gasLimit any) <- chan any {
            ...
            var signed any = this.SignEvmTransaction(tx, this.PrivateKey)
                ...
                retRes64415 :=  (<-this.EthRpc(rpcUrl, "eth_sendRawTransaction", []any{signed}))
                ccxt.PanicOnError(retRes64415)
                ch <- retRes64415
                return nil
...
func  (this *MyriadCore) EnsureErc20Allowance(rpcUrl any, networkId any, token any, owner any, spender any) <- chan any {
            ...
            retRes6728 := (<-this.WaitForTransactionReceipt(rpcUrl, approveHash))
...
func  (this *MyriadCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(tradingModel, "ob")) {
                    ...
                    retRes70119 :=  (<-this.CreateOrderbookOrder(symbol, typeVar, side, amount, price, rest))
                    ccxt.PanicOnError(retRes70119)
                    ch <- retRes70119
                    return nil
            }
            ...
            if !ccxt.IsTrue(enableAmm) {
                ...
                retRes70915 :=  (<-this.CreateAmmOrder(symbol, typeVar, side, amount, price, this.Omit(rest, []any{"enableAmm", "enableAmmOrders"})))
...
func  (this *MyriadCore) CreateOrderbookOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            params := ccxt.GetArg(optionalArgs, 1, map[string]any {})
            _ = params
            var built any = this.BuildOrderbookOrder(symbol, typeVar, side, amount, price, params)
 ...
 */
func  (this *MyriadCore) BuildOrderbookOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any  {
    price := ccxt.GetArg(optionalArgs, 0, nil)
    _ = price
    params := ccxt.GetArg(optionalArgs, 1, map[string]any {})
    _ = params
...
func  (this *MyriadCore) CreateOrders(orders any, optionalArgs ...any) <- chan any {
            ...
            for i := 0; ccxt.IsLessThan(i, ordersLength); i++ {
                ...
                var symbol any = this.SafeString(o, "symbol")
                ...
                placed:= (<-this.CreateOrderbookOrder(symbol, typeVar, side, amount, price, this.Extend(orderParams, params)))
 ...
 * @returns {object} an [order structure](https://docs.ccxt.com/#/?id=order-structure)
 */
func  (this *MyriadCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes8788 := (<-this.CancelOrder(id, symbol))
            ccxt.PanicOnError(retRes8788)
        
                retRes87915 :=  (<-this.CreateOrderbookOrder(symbol, typeVar, side, amount, price, params))
                ccxt.PanicOnError(retRes87915)
                ch <- retRes87915
                return nil
...
func  (this *MyriadCore) CreateAmmOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(sideStr, "buy"))) && ccxt.IsTrue((!ccxt.IsEqual(tokenAddress, nil)))) {
                ...
                retRes91312 := (<-this.EnsureErc20Allowance(rpcUrl, networkId, tokenAddress, fromAddress, predictionMarket))
                ccxt.PanicOnError(retRes91312)
            }
...
func  (this *MyriadCore) CancelAllOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes117915 :=  (<-this.MyriadPublicPostOrdersCancelAll(request))
...
func  (this *MyriadCore) CancelOrders(ids any, optionalArgs ...any) <- chan any {
            ...
            retRes12158 := (<-this.MyriadPublicPostOrdersCancelBatch(this.Extend(request, params)))
            ccxt.PanicOnError(retRes12158)
        
            ch <- this.ParseOrders(wrappers, nil, nil, nil)
            return nil
...
func  (this *MyriadCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes129415 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *MyriadCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes131215 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *MyriadCore) FetchCanceledOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes133015 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                ccxt.PanicOnError(retRes133015)
                ch <- retRes133015
                return nil
...
func  (this *MyriadCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            orders:= (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
            ...
            ch <- this.FilterByValueSinceLimit(trades, "outcome", symbol, since, limit, "timestamp", true)
            return nil
...
func  (this *MyriadCore) ParseMyriadMarket(raw any, optionalArgs ...any) any  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(rawOutcomes)); i++ {
        ...
        var outcomeHandle any = this.SlugToOutcomeSymbol(slugBase, slug, outcomeLabel)
...
func  (this *MyriadCore) FetchEvents(optionalArgs ...any) <- chan any {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(queriesLength, 0)) {
                ...
                ccxt.PanicOnError(retRes242712)
...
func  (this *MyriadCore) ConnectCentrifugo(url any) <- chan any {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(connectSent, nil)) {
                ...
                var connectMsg any = map[string]any {
                    ...
                    retRes257619 :=  (<-this.Watch(url, "centrifugoConnected", connectMsg, "connect"))
                    ccxt.PanicOnError(retRes257619)
                    ch <- retRes257619
                    return nil
            }
        ...
        return nil
                ...
                retRes258315 :=  (<-client.(ccxt.ClientInterface).Future("centrifugoConnected"))
                ccxt.PanicOnError(retRes258315)
...
func  (this *MyriadCore) Pong(client any, optionalArgs ...any) <- chan any {
            ...
            retRes25888 := (<-client.(ccxt.ClientInterface).Send("{}"))
            ccxt.PanicOnError(retRes25888)
                return nil
            }()
            return ch
        }
func  (this *MyriadCore) SubscribeMyriadChannel(messageHash any, channel any, optionalArgs ...any) <- chan any {
            ...
            retRes25948 := (<-this.ConnectCentrifugo(url))
            ccxt.PanicOnError(retRes25948)
            var requestId any = this.RequestId(url)
            var subscribeMsg any = map[string]any {
                ...
                retRes259715 :=  (<-this.Watch(url, messageHash, subscribeMsg, channel))
                ccxt.PanicOnError(retRes259715)
                ch <- retRes259715
                return nil
...
func  (this *MyriadCore) WatchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes26798 := (<-this.ConnectCentrifugo(url))
            ccxt.PanicOnError(retRes26798)
            var client any = this.Client(url)
            ...
            if ccxt.IsTrue(isNewSubscription) {
                ...
                retRes268512 := (<-this.SeedOrderBook(symbol, sym, limit))
                ccxt.PanicOnError(retRes268512)
            }
            var requestId any = this.RequestId(url)
            var subscribeMsg any = map[string]any {
                "subscribe": map[string]any {
...
func  (this *MyriadCore) WatchMyTrades(optionalArgs ...any) <- chan any {
            ...
            _ = params
            if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " watchMyTrades() requires a symbol (the trades channel is per-market)")))
            }
...
func  (this *MyriadCore) WatchTicker(symbol any, optionalArgs ...any) <- chan any {
            ...
            var messageHash any = ccxt.Add("ticker::", sym)
                ...
                retRes292915 :=  (<-this.SubscribeMyriadChannel(messageHash, channel, params))
                ccxt.PanicOnError(retRes292915)
                ch <- retRes292915
                return nil
...
func  (this *MyriadCore) WatchTickers(optionalArgs ...any) <- chan any {
            ...
            ccxt.PanicOnError(retRes29428)
            this.EnsureOutcomesLoaded()
            if ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) {
                panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " watchTickers() requires a list of symbols (the prices channel is per-market)")))
            }
            var symbolsLength any =     ccxt.GetArrayLength(symbols)
            var url any = this.SafeString(ccxt.GetValue(this.Urls, "api"), "ws")
        
            retRes29498 := (<-this.ConnectCentrifugo(url))
            ccxt.PanicOnError(retRes29498)
            var client any = this.Client(url)
            ...
            for i := 0; ccxt.IsLessThan(i, symbolsLength); i++ {
                ...
                var marketId any = this.SafeString(info, "marketId")
                var channel any = ccxt.Add(ccxt.Add(ccxt.Add("prices:", networkId), ":"), marketId)
                ccxt.AppendToArray(&resolvedSymbols, this.SafeOutcomeSymbol(ccxt.GetValue(symbols, i), outcomeObj))
 ...
 */
func  (this *MyriadCore) WatchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            trades:= (<-this.WatchTrades(symbol, since, limit, params))
            ccxt.PanicOnError(trades)
...
func  (this *MyriadCore) WatchOrders(optionalArgs ...any) <- chan any {
            ...
            ch <- this.FilterByValueSinceLimit(orders, "outcome", symbol, since, limit, "timestamp", true)
            return nil
...
func  (this *MyriadCore) WatchPositions(optionalArgs ...any) <- chan any {
            ...
            retRes31418 := (<-this.ConnectCentrifugo(url))
            ccxt.PanicOnError(retRes31418)
            var client any = this.Client(url)
            var isNewSubscription any = ccxt.IsEqual(this.SafeValue(client.(ccxt.ClientInterface).GetSubscriptions(), channel), nil)
            if ccxt.IsTrue(isNewSubscription) {
                ...
                retRes314712 := (<-this.SeedPositionBalances(trader))
                ccxt.PanicOnError(retRes314712)
            }
            var requestId any = this.RequestId(url)
            var subscribeMsg any = map[string]any {
                "subscribe": map[string]any {
            ...
            ch <- this.FilterByOutcomesSinceLimit(positions, symbols, since, limit, true)
            return nil
