...
func  (this *Hyperliquid) ParseOutcomeDescription(description any) any  {
    if (ccxt.IsEqual(description, nil)) || ((ccxt.IsEqual(description, ""))) {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(parts)); i++ {
        ...
        if ccxt.IsGreaterThan(colonIndex, ccxt.OpNeg(1)) {
...
func  (this *Hyperliquid) BuildOutcomeSymbol(desc any, side any, outcomeId any) any  {
    var underlying *string = this.SafeString(desc, "underlying", ccxt.Add("OUTCOME", ccxt.ToString(outcomeId)))
    ...
    var expiryDate any = ccxt.Ternary(((expiry == nil || *expiry != "")), ccxt.GetValue(ccxt.Split(expiry, "-"), 0), "")
    var label any = ccxt.Ternary(((ccxt.IsEqual(side, 0))), "YES", "NO")
    ...
    if (!ccxt.IsEqual(expiryDate, nil)) && ((!ccxt.IsEqual(expiryDate, ""))) {
...
func  (this *Hyperliquid) BuildOutcomeParentSymbol(desc any, outcomeId any, optionalArgs ...any) any  {
    ...
    if ((underlying != nil)) && ((underlying == nil || *underlying != "")) {
        var targetPrice *string = this.SafeString(desc, "targetPrice")
        var expiry *string = this.SafeString(desc, "expiry", "")
        var expiryDate any = ccxt.Ternary(((expiry == nil || *expiry != "")), ccxt.GetValue(ccxt.Split(expiry, "-"), 0), "")
        var base any = ccxt.ToUpper(underlying)
    ...
    if ((questionDescription != nil)) && ((questionDescription == nil || *questionDescription != "")) {
        ...
        if (questionClass != nil && *questionClass == "pricebucket") {
            ...
            var expiryDate any = ccxt.Ternary(((questionExpiry == nil || *questionExpiry != "")), ccxt.GetValue(ccxt.Split(questionExpiry, "-"), 0), "")
            var thresholdsRaw *string = this.SafeString(questionDesc, "priceThresholds", "")
            var indexStr *string = this.SafeString(desc, "index")
            ...
            if ((questionUnderlying != nil) && (questionUnderlying == nil || *questionUnderlying != "")) && ((thresholdsRaw == nil || *thresholdsRaw != "")) && (indexStr != nil) {
                ...
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(thresholdParts)); i++ {
                    ...
                    if ccxt.IsGreaterThan(ccxt.GetLength(trimmed), 0) {
                ...
                if ccxt.IsGreaterThan(thresholdsLength, 0) && !ccxt.IsEqual(index, nil) {
                    var bucketLabel any = nil
                    if ccxt.IsLessThanOrEqual(index, 0) {
            ...
            var isFallbackLike bool = ((rawDescription != nil && *rawDescription == "other")) || (ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(nameLower, "fallback"), 0)) || (ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(nameLower, "other"), 0))
            if ((questionUnderlying != nil) && (questionUnderlying == nil || *questionUnderlying != "")) && isFallbackLike {
    ...
    var questionName *string = this.SafeString(question, "name")
    if ((questionName != nil)) && ((questionName == nil || *questionName != "")) {
        var questionSlug any = this.ShortenSlug(questionName)
        if (!ccxt.IsEqual(questionSlug, nil)) && ((!ccxt.IsEqual(questionSlug, ""))) {
            ...
            if ccxt.InOp(genericOutcomeNames, outcomeSlug) {
                if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(outcomeSlug, "FALLBACK"), 0) {
                    outcomeSlug = "OTHER"
                } else {
                    outcomeSlug = ""
                }
            }
            if (!ccxt.IsEqual(outcomeSlug, nil)) && ((!ccxt.IsEqual(outcomeSlug, ""))) {
    ...
    if (!ccxt.IsEqual(name, nil)) && ((!ccxt.IsEqual(name, ""))) {
...
func (this *Hyperliquid) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        for qi := 0; ccxt.IsLessThan(qi, ccxt.GetArrayLength(questionsList)); qi++ {
            ...
            var fallbackOutcome *int64 = this.SafeInteger(question, "fallbackOutcome")
            ...
            for ni := 0; ccxt.IsLessThan(ni, ccxt.GetArrayLength(namedOutcomes)); ni++ {
                var namedOutcomeId *int64 = this.SafeInteger(namedOutcomes, ni)
                if (namedOutcomeId != nil) {
        ...
        var markets any = []any{}
        if ccxt.IsEqual(this.Outcomes, nil) {
            this.Outcomes = map[string]any {}
        }
        if ccxt.IsEqual(this.Outcomes_by_id, nil) {
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(outcomesList)); i++ {
            ...
            var outcomeId *int64 = this.SafeInteger(outcomeInfo, "outcome", i)
            ...
            for oi := 0; ccxt.IsLessThan(oi, ccxt.GetArrayLength(marketOutcomes)); oi++ {
                ...
                var outcomeSymbol *string = this.SafeString2(outcome, "outcome", "symbol")
                var outcomeId_ *string = this.SafeString2(outcome, "outcomeId", "id")
...
func  (this *Hyperliquid) ParseOutcomeMarket(outcomeInfo any, outcomeId any, optionalArgs ...any) any  {
    ...
    if ((expiry != nil)) && ((expiry == nil || *expiry != "")) {
        ...
        if ccxt.IsGreaterThanOrEqual(expPartsLength, 1) && (ccxt.GetLength(ccxt.GetValue(expParts, 0)) == 8) {
            var ymd any = ccxt.GetValue(expParts, 0)
            var hm any = ccxt.Ternary((ccxt.IsGreaterThanOrEqual(expPartsLength, 2)), ccxt.GetValue(expParts, 1), "0000")
    ...
    var yesLabel *string = this.SafeStringUpper(this.SafeDict(sideSpecs, 0, map[string]any {}), "name", "YES")
    var noLabel *string = this.SafeStringUpper(this.SafeDict(sideSpecs, 1, map[string]any {}), "name", "NO")
    var quoteCurrency *string = this.SafeString(this.Options, "outcomeQuoteCurrency", "USDH")
...
func  (this *Hyperliquid) CalculatePricePrecision(midPx any, szDecimals any) any  {
    if ccxt.IsLessThanOrEqual(midPx, 0) {
        return 0.0001
    }
 ...
 */
func  (this *Hyperliquid) FetchTicker(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Hyperliquid) fetchTickersBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var outcomesMap any = ccxt.Ternary((!ccxt.IsEqual(this.Outcomes, nil)), this.Outcomes, map[string]any {})
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(outcomeHandles)); i++ {
            ...
            if !ccxt.IsEqual(outcomes, nil) && !(ccxt.InOp(requestedOutcomeSymbols, outcomeHandle)) {
                continue
            }
            var outcomeObj any = this.SafeDict(outcomesMap, outcomeHandle, map[string]any {})
            var info any = this.SafeDict(outcomeObj, "info", map[string]any {})
            var coin *string = this.SafeString(info, "coinName")
            var mid any = ccxt.DerefScalar(this.SafeNumber(mids, coin))
            if ccxt.IsEqual(mid, nil) {
                continue
            }
...
func  (this *Hyperliquid) ParsePredictionTicker(raw any, optionalArgs ...any) any  {
    ...
    var bid any = ccxt.Ternary((!ccxt.IsEqual(topBid, nil)), this.SafeNumber(topBid, "px"), nil)
    var ask any = ccxt.Ternary((!ccxt.IsEqual(topAsk, nil)), this.SafeNumber(topAsk, "px"), nil)
    var bidVolume any = ccxt.Ternary((!ccxt.IsEqual(topBid, nil)), this.SafeNumber(topBid, "sz"), nil)
    var askVolume any = ccxt.Ternary((!ccxt.IsEqual(topAsk, nil)), this.SafeNumber(topAsk, "sz"), nil)
    ...
    var parentMarket any = ccxt.Ternary(((parentSymbol != nil)), this.SafeMarket(parentSymbol), nil)
    var ctx any = ccxt.Ternary((!ccxt.IsEqual(parentMarket, nil)), this.SafeDict(this.SafeDict(parentMarket, "info", map[string]any {}), "ctx", map[string]any {}), map[string]any {})
    var dayVolume any = ccxt.DerefScalar(this.SafeNumber(ctx, "dayNtlVlm"))
 ...
 */
func  (this *Hyperliquid) FetchOrderBook(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Hyperliquid) FetchOHLCV(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Hyperliquid) fetchOHLCVBody(ch chan any, outcome any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.IsEqual(since, nil) {
            ...
            var candleCount any = ccxt.Ternary((!ccxt.IsEqual(limit, nil)), limit, 100)
            ...
            if ccxt.IsLessThan(startTime, 0) {
                startTime = 0
            }
        }
        var request map[string]any = map[string]any {
...
func (this *Hyperliquid) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var balances any = this.SafeList(response, "balances", []any{})
        var allMids any = map[string]any {}
        if (!ccxt.IsString(midsResponse)) && !ccxt.IsArray(midsResponse) {
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(balances)); i++ {
            ...
            if (ccxt.GetIndexOf(coin, "+") != 0) {
                continue
            }
            var totalStr *string = this.SafeString(balance, "total")
            if ((totalStr == nil)) || ccxt.Precise.StringEq(totalStr, "0") {
                continue
            }
...
func  (this *Hyperliquid) FindOutcomeInMarket(market any, optionalArgs ...any) any  {
    ...
    var normalizedHint any = ccxt.Ternary((!ccxt.IsEqual(sideHint, nil) && (!ccxt.IsEqual(sideHint, ""))), ccxt.ToUpper(sideHint), nil)
    if !ccxt.IsEqual(normalizedHint, nil) {
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(outcomesList)); i++ {
...
func  (this *Hyperliquid) ParseOutcomeInputSideHint(outcomeInput any) any  {
    if (ccxt.IsEqual(outcomeInput, nil)) || ((ccxt.IsEqual(outcomeInput, ""))) {
        return nil
    }
    var colonIndex int = ccxt.GetIndexOf(outcomeInput, ":")
    if ccxt.IsGreaterThan(colonIndex, ccxt.OpNeg(1)) && ccxt.IsLessThan(colonIndex, ccxt.Subtract(ccxt.GetLength(outcomeInput), 1)) {
...
func  (this *Hyperliquid) ResolveOutcomeInput(outcomeInput any) any  {
    ...
    if ccxt.StartsWith(outcomeInput, "+") {
    ...
    for di := 0; ccxt.IsLessThan(di, ccxt.GetArrayLength(inputChars)); di++ {
        if ccxt.IsLessThan(ccxt.GetIndexOf(digitChars, ccxt.GetValue(inputChars, di)), 0) {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(candidates)); i++ {
        ...
        if ccxt.InOp(this.Outcomes_by_id, key) {
    ...
    if ((!ccxt.IsEqual(this.Markets, nil)) && (ccxt.InOp(this.Markets, outcomeInput))) || ((!ccxt.IsEqual(this.Markets_by_id, nil)) && (ccxt.InOp(this.Markets_by_id, outcomeInput))) {
        ...
        var sideHintOrDefault any = ccxt.Ternary((!ccxt.IsEqual(sideHint, nil)), sideHint, "YES")
        var found any = this.FindOutcomeInMarket(market, sideHintOrDefault)
        if ccxt.IsGreaterThan(ccxt.GetArrayLength(ccxt.ObjectKeys(found)), 0) {
            return found
        }
    }
 ...
 */
func  (this *Hyperliquid) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Hyperliquid) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var reduceOnly any = ccxt.DerefScalar(this.SafeBool(params, "reduceOnly", false))
        ...
        var defaultTif any = ccxt.Ternary(isMarket, "Ioc", "Gtc")
        if (postOnly == true) {
            defaultTif = "Alo"
        }
        ...
        if isMarket {
            ...
            px = ccxt.Ternary(isBuy, ccxt.Precise.StringMul(priceStr, ccxt.Precise.StringAdd("1", slippage)), ccxt.Precise.StringMul(priceStr, ccxt.Precise.StringSub("1", slippage)))
            px = this.PriceToPrecision(marketSymbol, px)
        } else {
            px = this.PriceToPrecision(marketSymbol, price)
        }
        if ccxt.IsEqual(px, nil) {
        ...
        if !ccxt.IsEqual(vaultAddress, nil) {
...
func (this *Hyperliquid) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if !ccxt.IsEqual(clientOrderId, nil) {
            var cloids any = ccxt.Ternary(ccxt.IsArray(clientOrderId), clientOrderId, []any{clientOrderId})
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(statuses)); i++ {
            ...
            var order map[string]any = map[string]any {
                "id": requestId,
                "clientOrderId": ccxt.Ternary((!ccxt.IsEqual(clientOrderId, nil)), requestId, nil),
                "info": status,
                "status": "canceled",
...
func (this *Hyperliquid) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if (clientOrderId != nil) {
            ...
            ccxt.AddElementToObject(request, "oid", ccxt.Ternary(isCloid, id, this.ParseToNumeric(id)))
        }
...
func  (this *Hyperliquid) ParsePredictionOrder(order any, optionalArgs ...any) any  {
    ...
    var resolvedMarket any = ccxt.Ternary(((marketSymbol != nil) && (marketSymbol == nil || *marketSymbol != "")), this.SafeMarket(marketSymbol, market), market)
    var sideRaw *string = this.SafeString(entry, "side")
    var side any = ccxt.Ternary(((sideRaw != nil && *sideRaw == "B")), "buy", "sell")
    ...
    var tifRaw *string = this.SafeString(entry, "tif")
    ...
    var triggerPrice any = ccxt.Ternary(isTrigger, this.SafeNumber(entry, "triggerPx"), nil)
...
func  (this *Hyperliquid) ParseOrderType(status any) any  {
    ...
    var statusLower any = ccxt.Ternary((!ccxt.IsEqual(status, nil) && (!ccxt.IsEqual(status, ""))), ccxt.ToLower(status), nil)
...
func  (this *Hyperliquid) ParseTimeInForce(timeInForce any) any  {
    ...
    var tifLower any = ccxt.Ternary((!ccxt.IsEqual(timeInForce, nil) && (!ccxt.IsEqual(timeInForce, ""))), ccxt.ToLower(timeInForce), nil)
 ...
 */
func  (this *Hyperliquid) FetchTrades(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Hyperliquid) fetchTradesBody(ch chan any, outcome any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.IsArray(response) {
            trades = response
        } else if !ccxt.IsString(response) {
...
func  (this *Hyperliquid) ParsePredictionTrade(trade any, optionalArgs ...any) any  {
    ...
    var side any = ccxt.Ternary(((rawSide != nil && *rawSide == "B")), "buy", "sell")
    var fee any = ccxt.DerefScalar(this.SafeNumber(trade, "fee"))
    ...
    var takerOrMaker any = ccxt.Ternary(crossed, "taker", "maker")
 ...
 */
func  (this *Hyperliquid) FetchEvents(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Hyperliquid) fetchEventsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(marketValues)); i++ {
            ...
            // Apply query filter
            if ccxt.IsGreaterThan(lowerQueriesLength, 0) {
                var description string = ccxt.ToLower(this.SafeString(info, "description", ""))
                var parentSymbolOrEmpty any = ccxt.Ternary(((parentSymbol != nil)), parentSymbol, "")
                ...
                for qi := 0; ccxt.IsLessThan(qi, ccxt.GetArrayLength(lowerQueries)); qi++ {
                    ...
                    for wi := 0; ccxt.IsLessThan(wi, wordsLength); wi++ {
                        ...
                        if ((!ccxt.IsEqual(word, ""))) && (ccxt.IsLessThan(ccxt.GetIndexOf(haystack, word), 0)) {
                            allWords = false
                            break
                        }
                    }
...
func  (this *Hyperliquid) ParseEvent(raw any) any  {
    ...
    var firstMarket any = ccxt.Ternary((ccxt.IsGreaterThan(marketsLength, 0)), ccxt.GetValue(markets, 0), map[string]any {})
    ...
    if ((expiryRaw != nil)) && ((expiryRaw == nil || *expiryRaw != "")) {
        ...
        if ccxt.IsGreaterThanOrEqual(partsLength, 1) && (ccxt.GetLength(ccxt.GetValue(parts, 0)) == 8) {
            var ymd any = ccxt.GetValue(parts, 0)
            var hm any = ccxt.Ternary((ccxt.IsGreaterThanOrEqual(partsLength, 2)), ccxt.GetValue(parts, 1), "0000")
            var isoStr any = ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Slice(ymd, 0, 4), "-"), ccxt.Slice(ymd, 4, 6)), "-"), ccxt.Slice(ymd, 6, 8)), "T"), ccxt.Slice(hm, 0, 2)), ":"), ccxt.Slice(hm, 2, 4)), ":00Z")
            expiryMs = this.Parse8601(isoStr)
            expiryDatetime = isoStr
        }
    ...
    var endValue any = ccxt.Ternary((!ccxt.IsEqual(expiryMs, nil)), expiryMs, firstExpiry)
...
func  (this *Hyperliquid) AmountToPrecision(outcome any, amount any) any  {
    ...
    var prec any = ccxt.DerefScalar(this.SafeNumber(this.SafeDict(market, "precision", map[string]any {}), "amount", 0.0001))
    // Convert precision to decimal places
    var decimals int = 4
    if ccxt.IsEqual(prec, nil) {
...
func  (this *Hyperliquid) ConstructPhantomAgent(hash any, optionalArgs ...any) any  {
    ...
    _ = isTestnet
    var source any = ccxt.Ternary(ccxt.EvalTruthy(isTestnet), "b", "a")
    return map[string]any {
        "source": source,
        "connectionId": hash,
    }
...
func  (this *Hyperliquid) SignL1Action(action any, nonce any, optionalArgs ...any) any  {
    ...
    var isTestnet any = ccxt.DerefScalar(this.SafeBool(this.Options, "sandboxMode", false))
...
func (this *Hyperliquid) approveBuilderFeeBody(ch chan any, builder any, maxFeeRate any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        var nonce int64 = this.Milliseconds()
        var isSandboxMode any = ccxt.DerefScalar(this.SafeBool(this.Options, "sandboxMode", false))
        var payload map[string]any = map[string]any {
            "hyperliquidChain": ccxt.Ternary(((isSandboxMode == true)), "Testnet", "Mainnet"),
...
func (this *Hyperliquid) initializeClientBody(ch chan any) any {
    ...
    var buildFee any = ccxt.DerefScalar(this.SafeBool(this.Options, "builderFee", false))
    if (buildFee != true) {
...
func  (this *Hyperliquid) HandlePublicAddress(methodName any, params any) any  {
    ...
    if !ccxt.IsEqual(user, nil) && (!ccxt.IsEqual(user, "")) {
...
func  (this *Hyperliquid) FormatVaultAddress(optionalArgs ...any) any  {
    ...
    _ = address
    if ccxt.IsEqual(address, nil) {
        return nil
    }
    var normalized any = address
    if ccxt.StartsWith(normalized, "0x") || ccxt.StartsWith(normalized, "0X") {
...
func  (this *Hyperliquid) Sign(path any, optionalArgs ...any) any  {
    ...
    _ = body
    var apiGroup any = ccxt.Ternary(ccxt.IsArray(api), ccxt.GetValue(api, 0), api)
    var sandboxMode any = ccxt.DerefScalar(this.SafeBool(this.Options, "sandboxMode", false))
    var baseUrl any = nil
    if (sandboxMode == true) {
...
func (this *Hyperliquid) FetchAllGreeks(options ...ccxt.FetchAllGreeksOptions) (ccxt.AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Hyperliquid) FetchDepositAddressesByNetwork(code string, options ...ccxt.FetchDepositAddressesByNetworkOptions) (ccxt.DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
...
func (this *Hyperliquid) FetchDepositWithdrawFee(code string, options ...ccxt.FetchDepositWithdrawFeeOptions) (ccxt.DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *Hyperliquid) FetchDepositWithdrawFees(options ...ccxt.FetchDepositWithdrawFeesOptions) (ccxt.DepositWithdrawFees, error) {return this.exchangeTyped.FetchDepositWithdrawFees(options...)}
...
func (this *Hyperliquid) FetchPositionMode(options ...ccxt.FetchPositionModeOptions) (ccxt.PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *Hyperliquid) FetchStatus(params ...any) (ccxt.Status, error) {return this.exchangeTyped.FetchStatus(params...)}
...
func (this *Hyperliquid) FetchDepositsWs(options ...ccxt.FetchDepositsWsOptions) ([]ccxt.Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Hyperliquid) FetchWithdrawalsWs(options ...ccxt.FetchWithdrawalsWsOptions) ([]ccxt.Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
...
func (this *Hyperliquid) UnWatchMyTrades(options ...ccxt.UnWatchMyTradesOptions) (any, error) {return this.exchangeTyped.UnWatchMyTrades(options...)}
func (this *Hyperliquid) UnWatchOHLCV(symbol string, options ...ccxt.UnWatchOHLCVOptions) (any, error) {return this.exchangeTyped.UnWatchOHLCV(symbol, options...)}
...
func (this *Hyperliquid) UnWatchOrderBook(symbol string, options ...ccxt.UnWatchOrderBookOptions) (any, error) {return this.exchangeTyped.UnWatchOrderBook(symbol, options...)}
...
func (this *Hyperliquid) UnWatchOrders(options ...ccxt.UnWatchOrdersOptions) (any, error) {return this.exchangeTyped.UnWatchOrders(options...)}
...
func (this *Hyperliquid) UnWatchTickers(options ...ccxt.UnWatchTickersOptions) (any, error) {return this.exchangeTyped.UnWatchTickers(options...)}
...
func (this *Hyperliquid) WatchOHLCV(symbol string, options ...ccxt.WatchOHLCVOptions) ([]ccxt.OHLCV, error) {return this.exchangeTyped.WatchOHLCV(symbol, options...)}
