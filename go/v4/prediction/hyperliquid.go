...
func (this *HyperliquidCore) ParseOutcomeDescription(description any) any {
	if (ccxt.IsEqual(description, nil)) || (description == "") {
...
func (this *HyperliquidCore) BuildOutcomeSymbol(desc any, side any, outcomeId any) any {
	...
	var label any = ccxt.Ternary((side == 0), "YES", "NO")
	...
	if (!ccxt.IsEqual(expiryDate, nil)) && (expiryDate != "") {
...
func (this *HyperliquidCore) BuildOutcomeParentSymbol(desc any, outcomeId any, optionalArgs ...any) any {
	...
	if (questionName != nil) && (questionName == nil || *questionName != "") {
		...
		if (!ccxt.IsEqual(questionSlug, nil)) && (questionSlug != "") {
			...
			if (!ccxt.IsEqual(outcomeSlug, nil)) && (outcomeSlug != "") {
...
func (this *HyperliquidCore) FindOutcomeInMarket(market any, optionalArgs ...any) any {
	...
	var normalizedHint any = ccxt.Ternary((!ccxt.IsEqual(sideHint, nil) && (sideHint != "")), ccxt.ToUpper(sideHint), nil)
...
func (this *HyperliquidCore) ParseOutcomeInputSideHint(outcomeInput any) any {
	if (ccxt.IsEqual(outcomeInput, nil)) || (outcomeInput == "") {
		return nil
	}
...
func (this *HyperliquidCore) ParseOrderType(status any) any {
	...
	var statusLower any = ccxt.Ternary((!ccxt.IsEqual(status, nil) && (status != "")), ccxt.ToLower(status), nil)
...
func (this *HyperliquidCore) ParseTimeInForce(timeInForce any) any {
	...
	var tifLower any = ccxt.Ternary((!ccxt.IsEqual(timeInForce, nil) && (timeInForce != "")), ccxt.ToLower(timeInForce), nil)
		...
		if ccxt.IsGreaterThan(lowerQueriesLength, 0) {
			...
			for qi := 0; ccxt.IsLessThan(qi, ccxt.GetArrayLength(lowerQueries)); qi++ {
				...
				for wi := 0; ccxt.IsLessThan(wi, wordsLength); wi++ {
					...
					if (word != "") && (ccxt.IsLessThan(ccxt.GetIndexOf(haystack, word), 0)) {
						allWords = false
						break
					}
				}
