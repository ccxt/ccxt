	...
	for mi := 0; ccxt.IsLessThan(mi, ccxt.GetArrayLength(rawMarkets)); mi++ {
		...
		for oi := 0; ccxt.IsLessThan(oi, ccxt.GetArrayLength(outcomeLabels)); oi++ {
			...
			ccxt.AppendToArray(&outcomes, map[string]any{
				...
				"label":          outcomeLabel,
				"price":          outcomePrice,
				"active":         (active != nil && *active == true) && (closed == nil || *closed != true),
				"winner":         winner,
		...
		var marketType string = ccxt.Ternary((ccxt.IsGreaterThan(outcomeLabelsLength, 2)), "categorical", "binary").(string)
...
func (this *Polymarket) fetchOutcomesBody(ch chan any, outcomeSymbols any) any {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(outcomeSymbols)); i++ {
		if !ccxt.EvalTruthy(this.HasOutcome(ccxt.GetValue(outcomeSymbols, i))) {
			...
			retRes96516 := (<-this.FetchOutcomeAsync(ccxt.GetValue(outcomeSymbols, i)))
...
func (this *Polymarket) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes10478 := (<-this.LoadOutcomesAsync(outcomes))
...
func (this *Polymarket) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes15458 := (<-this.LoadApiCredentialsAsync())
...
func (this *Polymarket) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes16558 := (<-this.LoadApiCredentialsAsync())
...
func (this *Polymarket) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if !ccxt.IsEqual(outcomes, nil) {
		...
		retRes170412 := (<-this.LoadOutcomesAsync(outcomes))
		ccxt.PanicOnError(retRes170412)
	}
...
func (this *Polymarket) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes18228 := (<-this.LoadApiCredentialsAsync())
...
func (this *Polymarket) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes18478 := (<-this.LoadApiCredentialsAsync())
...
func (this *Polymarket) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes19608 := (<-this.LoadApiCredentialsAsync())
	ccxt.PanicOnError(retRes19608)

	retRes19618 := (<-this.LoadOutcomeAsync(outcome))
...
func (this *Polymarket) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	retRes19818 := (<-this.LoadApiCredentialsAsync())
	...
	retRes19928 := (<-this.LoadOutcomesAsync(orderOutcomes))
...
func (this *Polymarket) BuildClobOrderBody(outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var exchangeAddress any = ccxt.Ternary((negRisk != nil && *negRisk == true), negRiskExchangeV2, exchangeV2)
...
func (this *Polymarket) createMarketBuyOrderWithCostBody(ch chan any, outcome any, cost any, optionalArgs ...any) any {
	...
	retRes220115 := (<-this.CreateOrderAsync(outcome, "market", "buy", cost, nil, request))
	ccxt.PanicOnError(retRes220115)
	ch <- retRes220115
	return nil
}
...
func (this *Polymarket) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes23418 := (<-this.LoadApiCredentialsAsync())
	...
	var status string = ccxt.Ternary((failureReason == nil), "canceled", "open").(string)
...
func (this *Polymarket) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	retRes23648 := (<-this.LoadApiCredentialsAsync())
	ccxt.PanicOnError(retRes23648)
...
func (this *Polymarket) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes23868 := (<-this.LoadApiCredentialsAsync())
	ccxt.PanicOnError(retRes23868)
...
func (this *Polymarket) ParseEvent(rawEvent any) any {
	...
	var rawActive *bool = this.SafeBool(rawEvent, "active")
	var closed *bool = this.SafeBool(rawEvent, "closed", false)
	var active any = nil
	if rawActive != nil {
		active = (rawActive != nil && *rawActive == true) && (closed == nil || *closed != true)
	}
...
func (this *Polymarket) loadApiCredentialsBody(ch chan any) any {
	...
	if !ccxt.IsEqual(this.PrivateKey, nil) {
		...
		if alreadyDerived == nil {
			...
			retRes294616 := (<-this.CreateOrDeriveApiKeyAsync())
...
func (this *Polymarket) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes32478 := (<-this.LoadApiCredentialsAsync())
	ccxt.PanicOnError(retRes32478)
...
func (this *Polymarket) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes32738 := (<-this.LoadApiCredentialsAsync())
