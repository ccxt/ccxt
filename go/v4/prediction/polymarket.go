...
func  (this *Polymarket) Describe() any  {
 ...
 */
func  (this *Polymarket) FetchMarkets(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchRawEventsBySearch(queries any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchRawEventsBySearchBody(ch chan any, queries any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var optionPageSize *int64 = this.SafeInteger(this.Options, "searchPageSize", 100)
        var pageSize *int64 = this.SafeInteger(params, "searchPageSize", optionPageSize)
        ...
        if (sort != nil && *sort == "liquidity") {
            sortParam = "liquidity"
        } else if (sort != nil && *sort == "newest") {
            sortParam = "startDate"
        }
        var status *string = this.SafeString(params, "status", "active")
        var eventsStatus any = "active"
        if ((status != nil && *status == "closed")) || ((status != nil && *status == "inactive")) {
            eventsStatus = "closed"
        ...
        for qi := 0; ccxt.IsLessThan(qi, ccxt.GetArrayLength(queries)); qi++ {
            ...
            if !ccxt.IsEqual(eventsStatus, nil) {
            ...
            if (resultLimit != nil) {
                ...
                if ccxt.IsLessThan(limitPages, totalPages) {
                    totalPages = limitPages
                }
            } else {
                var optionMaxPages *int64 = this.SafeInteger(this.Options, "maxSearchPages", 5)
                var maxSearchPages *int64 = this.SafeInteger(params, "maxSearchPages", optionMaxPages)
                if ccxt.IsLessThan(maxSearchPages, totalPages) {
...
func  (this *Polymarket) TagToSlug(tag any) any  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(chars)); i++ {
        ...
        if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(allowed, ch), 0) {
 ...
 * @returns {object[]} an array of raw gamma event objects
 */
func  (this *Polymarket) FetchRawEventsList(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchRawEventsListBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        params := ccxt.GetArg(optionalArgs, 0, map[string]any {})
        _ = params
        var pageSize *int64 = this.SafeInteger(this.Options, "eventsPageSize", 100)
        ...
        var limit *int64 = this.SafeInteger(params, "limit", this.SafeInteger(this.Options, "fetchMarketsLimit", 200))
        var maxPages float64 = ccxt.MathCeil(ccxt.Divide(limit, pageSize))
        var status *string = this.SafeString(params, "status", this.SafeString(this.Options, "defaultEventStatus", "active"))
        ...
        if ccxt.IsGreaterThan(requestedTagsLength, 1) {
            var seen map[string]any = map[string]any {}
            var unioned any = []any{}
        ...
        if ccxt.IsGreaterThan(requestedTagsLength, 0) {
        ...
        } else if ((status != nil && *status == "closed")) || ((status != nil && *status == "inactive")) {
        ...
        var firstPage any = ccxt.Ternary(ccxt.EvalTruthy((firstPageIsArray)), firstPageResponse, []any{})
        ...
        if ccxt.IsGreaterThanOrEqual(firstPageLength, pageSize) {
            var offsets any = []any{}
            ...
            for ri := 0; ccxt.IsLessThan(ri, ccxt.GetArrayLength(restPages)); ri++ {
                var page any = ccxt.Ternary((!ccxt.IsEqual(ccxt.GetValue(restPages, ri), nil)), ccxt.GetValue(restPages, ri), []any{})
...
func  (this *Polymarket) ParseEventToMarkets(event any) any  {
    ...
    for mi := 0; ccxt.IsLessThan(mi, ccxt.GetArrayLength(rawMarkets)); mi++ {
        ...
        var active any = ccxt.DerefScalar(this.SafeBool(market, "active", false))
        var closed any = ccxt.DerefScalar(this.SafeBool(market, "closed", false))
        // resolution: a closed/uma-resolved market settles each outcome price to 0 or 1
        var marketResolved bool = ((closed == true)) || (ccxt.IsEqual(this.SafeStringLower(market, "umaResolutionStatus"), "resolved"))
        ...
        var negRisk any = ccxt.DerefScalar(this.SafeBool(market, "negRisk", false))
        ...
        for oi := 0; ccxt.IsLessThan(oi, ccxt.GetArrayLength(outcomeLabels)); oi++ {
            ...
            if marketResolved && (!ccxt.IsEqual(outcomePrice, nil)) {
                ...
                } else if ccxt.IsLessThanOrEqual(outcomePrice, 0.01) {
                    winnerRaw = false
                    settleFractionRaw = 0
                }
            }
        ...
        var baseId any = ccxt.Ternary(((conditionId != nil)), conditionId, marketId)
        var marketType any = ccxt.Ternary((ccxt.IsGreaterThan(outcomeLabelsLength, 2)), "categorical", "binary")
 ...
 */
func  (this *Polymarket) FetchOutcome(outcomeSymbol any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchOutcomeBody(ch chan any, outcomeSymbol any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if (ccxt.IsLessThan(ccxt.GetIndexOf(outcomeSymbol, ":"), 0)) && (ccxt.IsEqual(this.OutcomeSearchQuery(outcomeSymbol), nil)) {
    
            response:= (<-this.GammaPublicGetMarkets(map[string]any {
        "clob_token_ids": outcomeSymbol,
    }))
            ccxt.PanicOnError(response)
            var rawMarkets any = ccxt.Ternary((!ccxt.IsEqual(response, nil)), response, []any{})
 ...
 */
func  (this *Polymarket) FetchOutcomes(outcomeSymbols any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchTicker(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchTickers(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchTickersBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var chunkSize *int64 = this.SafeInteger(this.Options, "fetchTickersBatchSize", 200)
        ...
        for ccxt.IsLessThan(startIndex, tokenIdsLength) {
            ...
            var books any = ccxt.Ternary(ccxt.EvalTruthy((booksIsArray)), booksResponse, []any{})
            var lastTradesIsArray bool = ccxt.IsArray(lastTradesResponse)
            var lastTrades any = ccxt.Ternary(ccxt.EvalTruthy((lastTradesIsArray)), lastTradesResponse, []any{})
            ...
            for li := 0; ccxt.IsLessThan(li, lastTradesLength); li++ {
                ...
                var lastTradeTokenId *string = this.SafeString(lastTradeEntry, "token_id")
                if (lastTradeTokenId != nil) {
...
func  (this *Polymarket) ParsePredictionTicker(ticker any, optionalArgs ...any) any  {
    ...
    var bestBid any = ccxt.Ternary((ccxt.IsGreaterThan(bidsLength, 0)), ccxt.GetValue(bids, ccxt.Subtract(bidsLength, 1)), nil)
    var bestAsk any = ccxt.Ternary((ccxt.IsGreaterThan(asksLength, 0)), ccxt.GetValue(asks, ccxt.Subtract(asksLength, 1)), nil)
 ...
 */
func  (this *Polymarket) FetchOrderBook(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchOHLCV(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if !ccxt.IsEqual(since, nil) {
            ...
            if !ccxt.IsEqual(limit, nil) {
                ...
                endS = ccxt.Ternary((ccxt.IsLessThan(endBound, nowS)), endBound, nowS)
            }
        } else {
            var barCount any = ccxt.Ternary((!ccxt.IsEqual(limit, nil)), limit, 100)
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(history)); i++ {
            ...
            if !(ccxt.InOp(buckets, bucketKey)) {
                ...
                if !ccxt.IsEqual(vol, nil) {
                    ...
                    ccxt.AddElementToObject(candle, 5, ccxt.Ternary((ccxt.IsEqual(prevVol, nil)), vol, this.Sum(prevVol, vol))) // volume
                }
 ...
 */
func  (this *Polymarket) FetchTime(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchStatus(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchStatusBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        ch <- map[string]any {
            "status": ccxt.Ternary(ok, "ok", "maintenance"),
            "updated": nil,
            "eta": nil,
            "url": nil,
            "info": response,
 ...
 */
func  (this *Polymarket) FetchOpenInterest(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchTradingFee(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchTradingFeeBody(ch chan any, outcome any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var rate any = ccxt.Ternary(((baseFeeBps != nil)), this.ParseNumber(ccxt.Precise.StringDiv(baseFeeBps, "10000")), nil)
 ...
 */
func  (this *Polymarket) FetchTrades(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchTradesBody(ch chan any, outcome any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        ccxt.PanicOnError(response)
        var rawTrades any = ccxt.Ternary(ccxt.IsArray(response), response, this.SafeList(response, "data", []any{}))
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(rawTrades)); i++ {
            ...
            var tradeAsset *string = this.SafeString(trade, "asset")
            if ccxt.IsEqual(tradeAsset, tokenId) {
 ...
 * @returns {object[]} a list of [prediction trade structures](https://docs.ccxt.com/#/?id=prediction-trade-structure)
 */
func  (this *Polymarket) FetchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction trade structures](https://docs.ccxt.com/#/?id=prediction-trade-structure)
 */
func  (this *Polymarket) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) ParsePredictionTrade(trade any, optionalArgs ...any) any  {
    ...
    market := ccxt.GetArg(optionalArgs, 0, nil)
    _ = market
    var id *string = this.SafeStringN(trade, []any{"transactionHash", "transaction_hash", "id"})
    ...
    var side any = ccxt.Ternary(((rawSide != nil && *rawSide == "buy") || (rawSide != nil && *rawSide == "sell")), rawSide, nil)
    var assetId *string = this.SafeString2(trade, "asset", "asset_id")
    var mkt any = ccxt.Ternary((!ccxt.IsEqual(market, nil)), market, this.SafeOutcome(assetId))
    var outcome any = this.SafeOutcomeSymbol(nil, mkt)
    var rawTakerOrMaker *string = this.SafeStringLower(trade, "trader_side")
    var takerOrMaker any = ccxt.Ternary(((rawTakerOrMaker != nil && *rawTakerOrMaker == "taker") || (rawTakerOrMaker != nil && *rawTakerOrMaker == "maker")), rawTakerOrMaker, nil)
 ...
 */
func  (this *Polymarket) FetchBalance(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Polymarket) ParseBalance(response any) any  {
    ...
    var raw *string = this.SafeString(response, "balance")
    var total any = nil
    if (raw != nil) {
 ...
 */
func  (this *Polymarket) FetchPositions(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchPosition(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchOpenOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Polymarket) ParseOrderStatus(status any) any  {
    ...
    var normalized *string = this.SafeStringLower(map[string]any {
        "status": status,
    }, "status")
 ...
 * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.createOrderBody(ch, outcome, typeVar, side, amount, optionalArgs...)
    return ch
}
func (this *Polymarket) createOrderBody(ch chan any, outcome any, typeVar any, side any, amount any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) CreateOrders(orders any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Polymarket) BuildClobOrderBody(outcome any, typeVar any, side any, amount any, optionalArgs ...any) any  {
    ...
    if ccxt.IsEqual(orderTypeStr, nil) {
        orderTypeStr = ccxt.Ternary(isMarket, "FOK", "GTC")
    }
    ...
    var negRisk any = ccxt.DerefScalar(this.SafeBool(params, "negRisk", this.SafeBool(outcomeObj, "negRisk", false)))
    ...
    var builderRaw *string = this.SafeStringLower2(params, "builder", "builderCode", this.SafeStringLower(this.Options, "builder"))
    var builderBytes32 any = bytes32Zero
    if (builderRaw != nil) {
        var builderHex any = this.Remove0xPrefix(builderRaw)
        if ccxt.IsLessThanOrEqual(ccxt.GetArrayLength(builderHex), 40) {
            var builderFeeEnabled any = ccxt.DerefScalar(this.SafeBool(this.Options, "builderFee", true))
            var feeRate any = 0
    ...
    var signer any = ccxt.Ternary(((signatureType != nil && *signatureType == 3)), funder, eoa)
    ...
    var exchangeAddress any = ccxt.Ternary(((negRisk == true)), negRiskExchangeV2, exchangeV2)
 ...
 * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) CreateMarketBuyOrderWithCost(outcome any, cost any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Polymarket) SignClobOrder(message any, exchangeAddress any, domainVersion any, sigType any) any  {
    ...
    var chainIdValue *int64 = this.SafeInteger(this.Options, "chainId", 137)
    var domainName *string = this.SafeString(this.Options, "ctfExchangeName", "Polymarket CTF Exchange")
 ...
 * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) CancelOrder(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var status any = ccxt.Ternary(((failureReason == nil)), "canceled", "open")
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) CancelOrders(ids any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) CancelAllOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) FetchEvents(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchEventsBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ((requestedEventId != nil)) || ((requestedSlug != nil)) {
            ...
            rawEvents = ccxt.Ternary(ccxt.EvalTruthy((responseIsArray)), response, []any{})
        ...
        for rei := 0; ccxt.IsLessThan(rei, ccxt.GetArrayLength(rawEvents)); rei++ {
            ...
            if (ccxtMarketsLength == 0) {
                ...
                var eventId *string = this.SafeString(rawEvent, "id")
                var rawEventSlug *string = this.SafeString(rawEvent, "slug")
 ...
 */
func  (this *Polymarket) FetchEvent(id any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) fetchEventBody(ch chan any, id any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        _ = params
        var response any = nil
        if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(id, "-"), 0) {
...
func  (this *Polymarket) ParseEvent(rawEvent any) any  {
    ...
    var createdAt *string = this.SafeString2(rawEvent, "createdAt", "created_date_iso")
    var endDate *string = this.SafeString2(rawEvent, "endDate", "end_date_iso")
    var updatedAt *string = this.SafeString2(rawEvent, "updatedAt", "last_updated_date_iso")
    var rawActive any = ccxt.DerefScalar(this.SafeBool(rawEvent, "active"))
    var closed any = ccxt.DerefScalar(this.SafeBool(rawEvent, "closed", false))
    var active any = nil
    if !ccxt.IsEqual(rawActive, nil) {
    ...
    return this.Extend(map[string]any {
        ...
        "slug": slug,
        "event": ccxt.Ternary(((slug != nil) && (slug == nil || *slug != "")), this.ShortenSlug(slug), nil),
...
func  (this *Polymarket) Sign(path any, optionalArgs ...any) any  {
    ...
    if (ccxt.IsEqual(method, "GET")) {
        ...
        for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(queryKeys)); i++ {
            if ccxt.IsArray(ccxt.GetValue(query, ccxt.GetValue(queryKeys, i))) {
                hasArrayParam = true
            }
        }
        var querystring any = ccxt.Ternary(hasArrayParam, this.UrlencodeWithArrayRepeat(query), this.Urlencode(query))
    ...
    if (ccxt.IsEqual(access, "private")) {
        ...
        if isL1Auth {
            ...
            var apiKey *string = this.SafeString(this.Options, "l2ApiKey", this.ApiKey)
            ...
            var address any = ccxt.Ternary((!ccxt.IsEqual(this.PrivateKey, nil)), this.EthChecksumAddress(this.EthGetAddressFromPrivateKey(this.PrivateKey)), this.WalletAddress)
            var timestamp string = ccxt.ToString(this.Seconds())
...
func  (this *Polymarket) EthChecksumAddress(address any) any  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(addrChars)); i++ {
        ...
        if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(upperNibbles, ccxt.GetValue(hashChars, i)), 0) {
 ...
 */
func  (this *Polymarket) DeriveApiKey(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} the api credentials { apiKey, secret, passphrase }
 */
func  (this *Polymarket) CreateApiKey(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} the api credentials { apiKey, secret, passphrase }
 */
func  (this *Polymarket) CreateOrDeriveApiKey(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) LoadApiCredentials() <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) loadApiCredentialsBody(ch chan any) any {
    ...
    var apiKey any = ccxt.Ternary((!ccxt.IsEqual(this.ApiKey, nil)), this.ApiKey, this.SafeString(this.Options, "l2ApiKey"))
    var secret any = ccxt.Ternary((!ccxt.IsEqual(this.Secret, nil)), this.Secret, this.SafeString(this.Options, "l2Secret"))
    var passphrase any = ccxt.Ternary((!ccxt.IsEqual(this.Password, nil)), this.Password, this.SafeString(this.Options, "l2Passphrase"))
    var hasL2 bool = (!ccxt.IsEqual(apiKey, nil)) && (!ccxt.IsEqual(secret, nil)) && (!ccxt.IsEqual(passphrase, nil))
    if hasL2 {
...
func  (this *Polymarket) Ping(client any) any  {
...
func  (this *Polymarket) HandleMessage(client any, message any)  {
    ...
    var events any = ccxt.Ternary(ccxt.IsArray(message), message, []any{message})
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(events)); i++ {
        ...
        if (eventType != nil && *eventType == "book") {
            this.HandleOrderBookSnapshot(client, event)
        } else if (eventType != nil && *eventType == "price_change") {
            this.HandleOrderBookDelta(client, event)
        } else if (eventType != nil && *eventType == "last_trade_price") {
            this.HandleTrade(client, event)
        } else if (eventType != nil && *eventType == "order") {
...
func  (this *Polymarket) HandleOrderBookSnapshot(client any, event any)  {
    var tokenId *string = this.SafeString(event, "asset_id")
    var outcome any = this.TokenIdToSymbol(tokenId)
    if ccxt.IsEqual(outcome, nil) {
        return
    }
    if !(ccxt.InOp(this.Orderbooks, outcome)) {
...
func  (this *Polymarket) HandleOrderBookDelta(client any, event any)  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(changes)); i++ {
        ...
        var outcome any = this.TokenIdToSymbol(tokenId)
        if (ccxt.IsEqual(outcome, nil)) || !(ccxt.InOp(this.Orderbooks, outcome)) {
            continue
        }
        var orderbook any = ccxt.GetValue(this.Orderbooks, outcome)
        ...
        var side any = ccxt.Ternary(isBuy, ccxt.GetValue(orderbook, "bids"), ccxt.GetValue(orderbook, "asks"))
 ...
 */
func  (this *Polymarket) WatchOrderBook(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) WatchTrades(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Polymarket) WatchTicker(outcome any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func (this *Polymarket) watchTickerBody(ch chan any, outcome any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if (!ccxt.IsEqual(bids, nil)) && (ccxt.IsGreaterThan(bidsLength, 0)) {
        ...
        if (!ccxt.IsEqual(asks, nil)) && (ccxt.IsGreaterThan(asksLength, 0)) {
 ...
 * @returns {object[]} a list of [prediction order structures](https://docs.ccxt.com/#/?id=prediction-order-structure)
 */
func  (this *Polymarket) WatchOrders(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [prediction trade structures](https://docs.ccxt.com/#/?id=prediction-trade-structure)
 */
func  (this *Polymarket) WatchMyTrades(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Polymarket) SubscribeUserChannel(messageHash any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Polymarket) TokenIdToSymbol(tokenId any) any  {
    if (ccxt.IsEqual(tokenId, nil)) || ((ccxt.IsEqual(tokenId, ""))) {
        return nil
    }
...
func (this *Polymarket) Init(userConfig map[string]any) {
...
func (this *Polymarket) FetchRawEventsBySearch(queries []string, options ...FetchRawEventsBySearchOptions) ([]map[string]any, error) {
    ...
    res := <- this.FetchRawEventsBySearchAsync(queries, opts.Params)
    if ccxt.IsError(res) {
        return nil, ccxt.CreateReturnError(res)
    }
...
func (this *Polymarket) FetchRawEventsList(params ...any) ([]map[string]any, error) {
    res := <- this.FetchRawEventsListAsync(params...)
    if ccxt.IsError(res) {
        return nil, ccxt.CreateReturnError(res)
    }
    return ccxt.NewMapArray(res), nil
...
func (this *Polymarket) CreateOrDeriveApiKey(params ...any) (map[string]any, error) {
    res := <- this.CreateOrDeriveApiKeyAsync(params...)
    if ccxt.IsError(res) {
        return map[string]any{}, ccxt.CreateReturnError(res)
    }
    return res.(map[string]any), nil
...
func (this *Polymarket) FetchAllGreeks(options ...ccxt.FetchAllGreeksOptions) (ccxt.AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Polymarket) FetchDepositAddressesByNetwork(code string, options ...ccxt.FetchDepositAddressesByNetworkOptions) (ccxt.DepositAddresses, error) {return this.exchangeTyped.FetchDepositAddressesByNetwork(code, options...)}
...
func (this *Polymarket) FetchDepositWithdrawFee(code string, options ...ccxt.FetchDepositWithdrawFeeOptions) (ccxt.DepositWithdrawFee, error) {return this.exchangeTyped.FetchDepositWithdrawFee(code, options...)}
func (this *Polymarket) FetchDepositWithdrawFees(options ...ccxt.FetchDepositWithdrawFeesOptions) (ccxt.DepositWithdrawFees, error) {return this.exchangeTyped.FetchDepositWithdrawFees(options...)}
...
func (this *Polymarket) FetchPositionMode(options ...ccxt.FetchPositionModeOptions) (ccxt.PositionModeInfo, error) {return this.exchangeTyped.FetchPositionMode(options...)}
...
func (this *Polymarket) FetchDepositsWs(options ...ccxt.FetchDepositsWsOptions) ([]ccxt.Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Polymarket) FetchWithdrawalsWs(options ...ccxt.FetchWithdrawalsWsOptions) ([]ccxt.Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
