...
func (this *PolymarketCore) FetchRawEventsList(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var rest any = this.Omit(params, []any{"status", "limit", "sort", "searchIn", "eventId", "slug", "query", "queries"})
		var baseRequest any = map[string]any{
			"limit":     pageSize,
			"order":     order,
			"ascending": false,
...
func (this *PolymarketCore) FetchTrades(outcome any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		ch <- this.ParseTrades(filteredTrades, nil, since, limit)
		return nil
...
func (this *PolymarketCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes12478 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes13588 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) ParsePosition(position any, optionalArgs ...any) any {
	...
	return this.SafePredictionPosition(map[string]any{
		...
		"outcome":                     ccxt.GetValue(marketData, "outcome"),
...
func (this *PolymarketCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes15248 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) CreateOrder(outcome any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes16698 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes16858 := (<-this.LoadApiCredentials())
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
			...
			var built any = this.BuildClobOrderBody(this.SafeString(o, "symbol"), this.SafeString(o, "type"), this.SafeString(o, "side"), this.SafeNumber(o, "amount"), this.SafeNumber(o, "price"), orderParams)
...
func (this *PolymarketCore) CreateMarketBuyOrderWithCost(outcome any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes183115 := (<-this.CreateOrder(outcome, "market", "buy", cost, nil, request))
		ccxt.PanicOnError(retRes183115)
		ch <- retRes183115
		return nil
...
func (this *PolymarketCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19948 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20168 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) FetchEvents(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var finalLimit any = this.SafeInteger(params, "limit")
		if ccxt.IsTrue(!ccxt.IsEqual(finalLimit, nil)) {
	...
	go func() any {
		...
		if ccxt.IsTrue(!ccxt.IsEqual(this.PrivateKey, nil)) {
			...
			if ccxt.IsTrue(ccxt.IsEqual(alreadyDerived, nil)) {
				...
				retRes252016 := (<-this.CreateOrDeriveApiKey())
				ccxt.PanicOnError(retRes252016)
			}
...
func (this *PolymarketCore) HandleOrderBookSnapshot(client any, event any) {
	...
	if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(this.Orderbooks, outcome), nil)) {
		ccxt.AddElementToObject(this.Orderbooks, outcome, this.OrderBook([]any{}))
	}
...
func (this *PolymarketCore) HandleOrderBookDelta(client any, event any) {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(changes)); i++ {
		...
		var outcome any = this.TokenIdToSymbol(tokenId)
		if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(outcome, nil)) || ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(this.Orderbooks, outcome), nil))) {
			continue
		}
		var orderbook any = ccxt.GetValue(this.Orderbooks, outcome)
...
func (this *PolymarketCore) HandleTrade(client any, event any) {
	...
	var stored any = ccxt.GetValue(this.Trades, outcome)
...
func (this *PolymarketCore) WatchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes28028 := (<-this.LoadApiCredentials())
		ccxt.PanicOnError(retRes28028)
...
func (this *PolymarketCore) WatchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes28288 := (<-this.LoadApiCredentials())
...
func (this *PolymarketCore) SubscribeUserChannel(messageHash any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes285215 := (<-this.Watch(url, messageHash, this.Extend(subscribeMsg, params), subscribeHash))
