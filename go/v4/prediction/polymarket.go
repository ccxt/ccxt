...
func  (this *PolymarketCore) FetchRawEventsBySearch(queries any, optionalArgs ...any) <- chan any {
            ...
            go func() any {
                ...
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]any {})
            _ = params
            var pageSize any = this.SafeInteger(params, "limit", 50)
...
func  (this *PolymarketCore) FetchRawEventsList(optionalArgs ...any) <- chan any {
            ...
            go func() any {
                ...
                defer ccxt.ReturnPanicError(ch)
                    params := ccxt.GetArg(optionalArgs, 0, map[string]any {})
            _ = params
            var pageSize any = this.SafeInteger(this.Options, "maxFetchEventsLimit", 500)
            ...
            var limit any = this.SafeInteger(params, "limit", this.SafeInteger(this.Options, "fetchMarketsLimit", 1000))
            ...
            var rest any = this.Omit(params, []any{"status", "limit"})
            var baseRequest any = map[string]any {
                "limit": pageSize,
                "order": "volume24hr",
                "ascending": false,
...
func  (this *PolymarketCore) ParseEventToMarkets(event any) any  {
    ...
    for mi := 0; ccxt.IsLessThan(mi, ccxt.GetArrayLength(rawMarkets)); mi++ {
        ...
        var tickSize any = this.SafeNumber(market, "minimumTickSize", 0.01)
        ...
        for oi := 0; ccxt.IsLessThan(oi, ccxt.GetArrayLength(outcomeLabels)); oi++ {
            ...
            ccxt.AppendToArray(&outcomes, map[string]any {
                "outcome": ccxt.Add(ccxt.Add(marketSymbol, ":"), ccxt.ToUpper(outcomeLabel)),
 ...
 */
func  (this *PolymarketCore) FetchTicker(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *PolymarketCore) ParseTicker(ticker any, optionalArgs ...any) any  {
    ...
    var symbol any = this.SafeOutcomeSymbol(nil, market)
 ...
 */
func  (this *PolymarketCore) FetchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ccxt.AddElementToObject(orderbook, "outcome", this.SafeString(outcomeObj, "outcome"))
            ccxt.AddElementToObject(orderbook, "outcomeId", this.SafeString(outcomeObj, "outcomeId"))
            ccxt.AddElementToObject(orderbook, "market", this.SafeString(outcomeObj, "market"))
 ...
 */
func  (this *PolymarketCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *PolymarketCore) FetchOpenInterest(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *PolymarketCore) FetchTradingFee(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            ch <- map[string]any {
                "info": response,
                "symbol": this.SafeOutcomeSymbol(nil, outcomeObj),
                "maker": rate,
                "taker": rate,
                "percentage": true,
                "tierBased": false,
 ...
 */
func  (this *PolymarketCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *PolymarketCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            retRes12108 := (<-this.LoadApiCredentials())
            ...
            ch <- this.ParseTrades(rawTrades, outcomeObj, since, limit)
            return nil
...
func  (this *PolymarketCore) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
            ...
            trades:= (<-this.FetchMyTrades(symbol, nil, nil, params))
...
func  (this *PolymarketCore) ParseTrade(trade any, optionalArgs ...any) any  {
    ...
    var symbol any = this.SafeOutcomeSymbol(nil, mkt)
...
func  (this *PolymarketCore) FetchBalance(optionalArgs ...any) <- chan any {
            ...
            retRes13228 := (<-this.LoadApiCredentials())
...
func  (this *PolymarketCore) FetchPositions(optionalArgs ...any) <- chan any {
            ...
            var parsed any = this.ParsePositions(positions, nil)
 ...
 */
func  (this *PolymarketCore) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *PolymarketCore) ParsePosition(position any, optionalArgs ...any) any  {
    ...
    return this.SafePredictionPosition(map[string]any {
        ...
        "symbol": ccxt.GetValue(marketData, "outcome"),
        "outcomeId": ccxt.GetValue(marketData, "outcomeId"),
        "market": ccxt.GetValue(marketData, "market"),
        "label": ccxt.GetValue(marketData, "label"),
        "event": ccxt.GetValue(marketData, "event"),
        "timestamp": nil,
        "datetime": nil,
        "contracts": size,
        "contractSize": 1,
...
func  (this *PolymarketCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            retRes14898 := (<-this.LoadApiCredentials())
...
func  (this *PolymarketCore) FetchOrder(id any, optionalArgs ...any) <- chan any {
            ...
            retRes15188 := (<-this.LoadApiCredentials())
            ccxt.PanicOnError(retRes15188)
            var outcome any = symbol
            if ccxt.IsTrue(!ccxt.IsEqual(outcome, nil)) {
                this.CheckEventsAndMarkets(outcome)
            } else {
...
func  (this *PolymarketCore) ParseOrder(order any, optionalArgs ...any) any  {
    ...
    return this.SafePredictionOrder(map[string]any {
        ...
        "status": status,
        "symbol": ccxt.GetValue(mkt, "outcome"),
 ...
 * @returns {object} an [order structure](https://docs.ccxt.com/#/?id=order-structure)
 */
func  (this *PolymarketCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            retRes16338 := (<-this.LoadApiCredentials())
            ccxt.PanicOnError(retRes16338)
        
            built:= (<-this.BuildClobOrderBody(symbol, typeVar, side, amount, price, params))
            ccxt.PanicOnError(built)
        
            response:= (<-this.ClobPrivatePostOrder(this.SafeDict(built, "body")))
            ccxt.PanicOnError(response)
        
            ch <- this.ParseOrder(response, this.SafeDict(built, "outcome"))
            return nil
...
func  (this *PolymarketCore) CreateOrders(orders any, optionalArgs ...any) <- chan any {
            ...
            retRes16498 := (<-this.LoadApiCredentials())
            ...
            for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(orders)); i++ {
                ...
                built:= (<-this.BuildClobOrderBody(this.SafeString(o, "symbol"), this.SafeString(o, "type"), this.SafeString(o, "side"), this.SafeNumber(o, "amount"), this.SafeNumber(o, "price"), orderParams))
                ccxt.PanicOnError(built)
            ...
            if ccxt.IsTrue(ccxt.IsArray(response)) {
                for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(response)); i++ {
                    ccxt.AppendToArray(&result, this.ParseOrder(ccxt.GetValue(response, i), ccxt.GetValue(outcomes, i)))
                }
            } else {
 ...
 */
func  (this *PolymarketCore) BuildClobOrderBody(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            if ccxt.IsTrue(ccxt.IsEqual(price, nil)) {
                ...
                orderbook:= (<-this.FetchOrderBook(outcome))
                ccxt.PanicOnError(orderbook)
                var levels any = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(sideStr, "BUY"))), this.SafeList(orderbook, "asks", []any{}), this.SafeList(orderbook, "bids", []any{}))
                var best any = this.SafeList(levels, 0)
                if ccxt.IsTrue(ccxt.IsEqual(best, nil)) {
                    panic(ccxt.ArgumentsRequired(ccxt.Add(this.Id, " createOrder() could not determine a market price; pass an explicit price")))
                }
            ...
            var tickSize any = this.SafeString(params, "tickSize")
            var negRisk any = this.SafeBool(params, "negRisk")
            if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(tickSize, nil))) || ccxt.IsTrue((ccxt.IsEqual(negRisk, nil)))) {
        
                clobMarket:= (<-this.ClobPublicGetMarketsByTokenTokenId(map[string]any {
            "token_id": tokenId,
        }))
                ccxt.PanicOnError(clobMarket)
            ...
            var rest any = this.Omit(params, []any{"signatureType", "signature_type", "funder", "maker", "orderType", "tickSize", "negRisk", "salt", "timestamp", "expiration", "cost"})
 ...
 * @returns {object} an [order structure](https://docs.ccxt.com/#/?id=order-structure)
 */
func  (this *PolymarketCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var request any = this.Extend(params, map[string]any {
                ...
                retRes180015 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, request))
...
func  (this *PolymarketCore) SignClobOrder(message any, exchangeAddress any, domainVersion any, signatureType any) any  {
    var chainId any = this.SafeInteger(this.Options, "chainId", 137)
    ...
    if ccxt.IsTrue(!ccxt.IsEqual(signatureType, 3)) {
    ...
    var appDomainData any = this.EthAbiEncode([]any{"bytes32", "bytes32", "bytes32", "uint256", "address"}, []any{domainTypeHash, nameHash, versionHash, this.ConvertToBigInt(this.NumberToString(chainId)), exchangeAddress})
    ...
    var ctLen any =     ccxt.GetLength(orderTypeString)
    ...
    var ctLenHex any = this.IntToBase16(ctLen)
...
func  (this *PolymarketCore) CancelAllOrders(optionalArgs ...any) <- chan any {
            ...
            retRes19718 := (<-this.LoadApiCredentials())
...
func  (this *PolymarketCore) FetchEvents(optionalArgs ...any) <- chan any {
            ...
            "slug": rawEventSlug,
                ...
                var eventSlug any = this.SafeString(eventForParsing, "slug", this.SafeString(rawEvent, "slug"))
                if ccxt.IsTrue(eventSlug) {
                    var eventKey any = this.ShortenSlug(eventSlug)
...
func  (this *PolymarketCore) ParseEvent(rawEvent any) any  {
    ...
    return this.Extend(map[string]any {
        ...
        "slug": slug,
        "symbol": ccxt.Ternary(ccxt.IsTrue(slug), this.ShortenSlug(slug), nil),
...
func  (this *PolymarketCore) Sign(path any, optionalArgs ...any) any  {
    ...
    var isArrayBody any = ccxt.IsArray(params)
    ...
    if ccxt.IsTrue(ccxt.IsEqual(access, "private")) {
        var isL1Auth any = ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(path, "auth/api-key"))) || ccxt.IsTrue((ccxt.IsEqual(path, "auth/derive-api-key")))) || ccxt.IsTrue((ccxt.IsEqual(path, "auth/api-keys")))
        if ccxt.IsTrue(isL1Auth) {
            ...
            var secretBytes any = this.Base64ToBinary(ccxt.Replace(ccxt.Replace(secret, "-", "+"), "_", "/"))
            ...
            signature = ccxt.Replace(ccxt.Replace(signature, "+", "-"), "/", "_")
            headers = this.Extend(headers, map[string]any {
                "POLY_ADDRESS": address,
                "POLY_API_KEY": apiKey,
...
func  (this *PolymarketCore) LoadApiCredentials() <- chan any {
        ...
        if ccxt.IsTrue(!ccxt.IsEqual(this.PrivateKey, nil)) {
            ...
            if ccxt.IsTrue(ccxt.IsEqual(alreadyDerived, nil)) {
                ...
                retRes243716 := (<-this.CreateOrDeriveApiKey())
                ccxt.PanicOnError(retRes243716)
            }
...
func  (this *PolymarketCore) HandleOrderBookSnapshot(client any, event any)  {
    ...
    var symbol any = this.TokenIdToSymbol(tokenId)
    if ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) {
        return
    }
    if ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(this.Orderbooks, symbol), nil)) {
        ccxt.AddElementToObject(this.Orderbooks, symbol, this.OrderBook([]any{}))
    }
    ...
    client.(ccxt.ClientInterface).Resolve(orderbook, ccxt.Add("orderbook::", symbol))
    client.(ccxt.ClientInterface).Resolve(orderbook, ccxt.Add("ticker::", symbol))
}
func  (this *PolymarketCore) HandleOrderBookDelta(client any, event any)  {
    ...
    for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(changes)); i++ {
        ...
        var symbol any = this.TokenIdToSymbol(tokenId)
        if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(symbol, nil)) || ccxt.IsTrue(ccxt.IsEqual(ccxt.GetValue(this.Orderbooks, symbol), nil))) {
            continue
        }
        var orderbook any = ccxt.GetValue(this.Orderbooks, symbol)
...
func  (this *PolymarketCore) HandleTrade(client any, event any)  {
    ...
    client.(ccxt.ClientInterface).Resolve(stored, ccxt.Add("trades::", symbol))
}
/**
 * @method
 ...
 */
func  (this *PolymarketCore) WatchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *PolymarketCore) WatchTrades(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *PolymarketCore) WatchTicker(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
            ...
            var market any = this.SafeOutcome(symbol)
...
func  (this *PolymarketCore) WatchOrders(optionalArgs ...any) <- chan any {
            ...
            ccxt.PanicOnError(retRes27258)
        
            retRes27268 := (<-this.LoadApiCredentials())
            ccxt.PanicOnError(retRes27268)
            ...
            ch <- this.FilterByOutcomeSinceLimit(orders, symbol, since, limit, true)
            return nil
...
func  (this *PolymarketCore) WatchMyTrades(optionalArgs ...any) <- chan any {
            ...
            ccxt.PanicOnError(retRes27528)
        
            retRes27538 := (<-this.LoadApiCredentials())
            ccxt.PanicOnError(retRes27538)
            var messageHash any = "myTrades"
            if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
                var outcomeObj any = this.Outcome(symbol)
                symbol = this.SafeString(outcomeObj, "outcome")
                messageHash = ccxt.Add("myTrades::", symbol)
            }
            ...
            ch <- this.FilterByOutcomeSinceLimit(trades, symbol, since, limit, true)
            return nil
...
func  (this *PolymarketCore) SubscribeUserChannel(messageHash any, optionalArgs ...any) <- chan any {
            ...
            var subscribeHash any = "user"
                ...
                retRes277715 :=  (<-this.Watch(url, messageHash, this.Extend(subscribeMsg, params), subscribeHash))
...
func  (this *PolymarketCore) HandleOrder(client any, event any)  {
    ...
    var symbol any = this.SafeString(parsed, "outcome")
    if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
        client.(ccxt.ClientInterface).Resolve(stored, ccxt.Add("orders::", symbol))
    }
}
func  (this *PolymarketCore) HandleMyTrade(client any, event any)  {
    ...
    var symbol any = this.SafeString(parsed, "outcome")
    if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
        client.(ccxt.ClientInterface).Resolve(stored, ccxt.Add("myTrades::", symbol))
    }
}
func  (this *PolymarketCore) TokenIdToSymbol(tokenId any) any  {
    ...
    var market any = ccxt.Ternary(ccxt.IsTrue((!ccxt.IsEqual(marketsById, nil))), ccxt.GetValue(marketsById, tokenId), nil)
    return ccxt.Ternary(ccxt.IsTrue(market), ccxt.GetValue(market, "symbol"), nil)
}
