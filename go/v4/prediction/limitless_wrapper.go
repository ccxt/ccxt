...
func (this *Limitless) CancelOrdersWithClientOrderIds(clientOrderIds []string, options ...ccxt.CancelOrdersWithClientOrderIdsOptions) ([]ccxt.Order, error) {
...
func (this *Limitless) CancelOrderWithClientOrderId(clientOrderId string, options ...ccxt.CancelOrderWithClientOrderIdOptions) (ccxt.Order, error) {
...
func (this *Limitless) CreateLimitBuyOrder(symbol string, amount float64, price float64, options ...ccxt.CreateLimitBuyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitBuyOrder(symbol, amount, price, options...)
}
func (this *Limitless) CreateLimitOrder(symbol string, side string, amount float64, price float64, options ...ccxt.CreateLimitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitOrder(symbol, side, amount, price, options...)
}
func (this *Limitless) CreateLimitSellOrder(symbol string, amount float64, price float64, options ...ccxt.CreateLimitSellOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitSellOrder(symbol, amount, price, options...)
}
func (this *Limitless) CreateMarketBuyOrder(symbol string, amount float64, options ...ccxt.CreateMarketBuyOrderOptions) (ccxt.Order, error) {
...
func (this *Limitless) CreateMarketOrder(symbol string, side string, amount float64, options ...ccxt.CreateMarketOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrder(symbol, side, amount, options...)
}
func (this *Limitless) CreateMarketOrderWithCost(symbol string, side string, cost float64, options ...ccxt.CreateMarketOrderWithCostOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrderWithCost(symbol, side, cost, options...)
}
func (this *Limitless) CreateMarketSellOrder(symbol string, amount float64, options ...ccxt.CreateMarketSellOrderOptions) (ccxt.Order, error) {
...
func (this *Limitless) CreateOrderWithTakeProfitAndStopLoss(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWithTakeProfitAndStopLossOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateOrderWithTakeProfitAndStopLoss(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreatePostOnlyOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreatePostOnlyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreatePostOnlyOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateReduceOnlyOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateReduceOnlyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateReduceOnlyOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateStopLimitOrder(symbol string, side string, amount float64, price float64, triggerPrice float64, options ...ccxt.CreateStopLimitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLimitOrder(symbol, side, amount, price, triggerPrice, options...)
}
func (this *Limitless) CreateStopLossOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopLossOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLossOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateStopMarketOrder(symbol string, side string, amount float64, triggerPrice float64, options ...ccxt.CreateStopMarketOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopMarketOrder(symbol, side, amount, triggerPrice, options...)
}
func (this *Limitless) CreateStopOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTakeProfitOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTakeProfitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTakeProfitOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTrailingAmountOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingAmountOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingAmountOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTrailingPercentOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingPercentOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingPercentOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTriggerOrder(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTriggerOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTriggerOrder(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) EditLimitBuyOrder(id string, symbol string, amount float64, options ...ccxt.EditLimitBuyOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditLimitBuyOrder(id, symbol, amount, options...)
}
func (this *Limitless) EditLimitOrder(id string, symbol string, side string, amount float64, options ...ccxt.EditLimitOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditLimitOrder(id, symbol, side, amount, options...)
}
func (this *Limitless) EditLimitSellOrder(id string, symbol string, amount float64, options ...ccxt.EditLimitSellOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditLimitSellOrder(id, symbol, amount, options...)
}
func (this *Limitless) EditOrder(id string, symbol string, typeVar string, side string, options ...ccxt.EditOrderOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditOrder(id, symbol, typeVar, side, options...)
}
func (this *Limitless) EditOrderWithClientOrderId(clientOrderId string, symbol string, typeVar string, side string, options ...ccxt.EditOrderWithClientOrderIdOptions) (ccxt.Order, error) {
	return this.exchangeTyped.EditOrderWithClientOrderId(clientOrderId, symbol, typeVar, side, options...)
}
func (this *Limitless) EditOrders(orders []ccxt.OrderRequest, options ...ccxt.EditOrdersOptions) ([]ccxt.Order, error) {
...
func (this *Limitless) FetchBidsAsks(options ...ccxt.FetchBidsAsksOptions) (ccxt.Tickers, error) {
...
func (this *Limitless) FetchCanceledAndClosedOrders(options ...ccxt.FetchCanceledAndClosedOrdersOptions) ([]ccxt.Order, error) {
...
func (this *Limitless) FetchMarkPrice(symbol string, options ...ccxt.FetchMarkPriceOptions) (ccxt.Ticker, error) {
	return this.exchangeTyped.FetchMarkPrice(symbol, options...)
}
func (this *Limitless) FetchMarkPrices(options ...ccxt.FetchMarkPricesOptions) (ccxt.Tickers, error) {
...
func (this *Limitless) FetchOrderWithClientOrderId(clientOrderId string, options ...ccxt.FetchOrderWithClientOrderIdOptions) (ccxt.Order, error) {
...
func (this *Limitless) FetchOrderStatus(id string, options ...ccxt.FetchOrderStatusOptions) (string, error) {
...
func (this *Limitless) FetchPositionHistory(symbol string, options ...ccxt.FetchPositionHistoryOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionHistory(symbol, options...)
}
func (this *Limitless) FetchPositionMode(options ...ccxt.FetchPositionModeOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchPositionMode(options...)
}
func (this *Limitless) FetchPositionsForSymbol(symbol string, options ...ccxt.FetchPositionsForSymbolOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsForSymbol(symbol, options...)
}
func (this *Limitless) FetchPositionsHistory(options ...ccxt.FetchPositionsHistoryOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsHistory(options...)
}
func (this *Limitless) FetchPositionsRisk(options ...ccxt.FetchPositionsRiskOptions) ([]ccxt.Position, error) {
...
func (this *Limitless) CancelAllOrdersWs(options ...ccxt.CancelAllOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.CancelAllOrdersWs(options...)
}
func (this *Limitless) CancelOrdersWs(ids []string, options ...ccxt.CancelOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.CancelOrdersWs(ids, options...)
}
func (this *Limitless) CancelOrderWs(id string, options ...ccxt.CancelOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CancelOrderWs(id, options...)
}
func (this *Limitless) CreateLimitBuyOrderWs(symbol string, amount float64, price float64, options ...ccxt.CreateLimitBuyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitBuyOrderWs(symbol, amount, price, options...)
}
func (this *Limitless) CreateLimitOrderWs(symbol string, side string, amount float64, price float64, options ...ccxt.CreateLimitOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitOrderWs(symbol, side, amount, price, options...)
}
func (this *Limitless) CreateLimitSellOrderWs(symbol string, amount float64, price float64, options ...ccxt.CreateLimitSellOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateLimitSellOrderWs(symbol, amount, price, options...)
}
func (this *Limitless) CreateMarketBuyOrderWs(symbol string, amount float64, options ...ccxt.CreateMarketBuyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketBuyOrderWs(symbol, amount, options...)
}
func (this *Limitless) CreateMarketOrderWithCostWs(symbol string, side string, cost float64, options ...ccxt.CreateMarketOrderWithCostWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrderWithCostWs(symbol, side, cost, options...)
}
func (this *Limitless) CreateMarketOrderWs(symbol string, side string, amount float64, options ...ccxt.CreateMarketOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketOrderWs(symbol, side, amount, options...)
}
func (this *Limitless) CreateMarketSellOrderWs(symbol string, amount float64, options ...ccxt.CreateMarketSellOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateMarketSellOrderWs(symbol, amount, options...)
}
func (this *Limitless) CreateOrdersWs(orders []ccxt.OrderRequest, options ...ccxt.CreateOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.CreateOrdersWs(orders, options...)
}
func (this *Limitless) CreateOrderWithTakeProfitAndStopLossWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWithTakeProfitAndStopLossWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateOrderWithTakeProfitAndStopLossWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreatePostOnlyOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreatePostOnlyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreatePostOnlyOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateReduceOnlyOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateReduceOnlyOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateReduceOnlyOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateStopLimitOrderWs(symbol string, side string, amount float64, price float64, triggerPrice float64, options ...ccxt.CreateStopLimitOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLimitOrderWs(symbol, side, amount, price, triggerPrice, options...)
}
func (this *Limitless) CreateStopLossOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopLossOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopLossOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateStopMarketOrderWs(symbol string, side string, amount float64, triggerPrice float64, options ...ccxt.CreateStopMarketOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopMarketOrderWs(symbol, side, amount, triggerPrice, options...)
}
func (this *Limitless) CreateStopOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateStopOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateStopOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTakeProfitOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTakeProfitOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTakeProfitOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTrailingAmountOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingAmountOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingAmountOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTrailingPercentOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTrailingPercentOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTrailingPercentOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) CreateTriggerOrderWs(symbol string, typeVar string, side string, amount float64, options ...ccxt.CreateTriggerOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.CreateTriggerOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Limitless) EditOrderWs(id string, symbol string, typeVar string, side string, options ...ccxt.EditOrderWsOptions) (ccxt.Order, error) {
...
func (this *Limitless) FetchClosedOrdersWs(options ...ccxt.FetchClosedOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchClosedOrdersWs(options...)
}
func (this *Limitless) FetchDepositsWs(options ...ccxt.FetchDepositsWsOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchDepositsWs(options...)
}
func (this *Limitless) FetchMyTradesWs(options ...ccxt.FetchMyTradesWsOptions) ([]ccxt.Trade, error) {
...
func (this *Limitless) FetchOpenOrdersWs(options ...ccxt.FetchOpenOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchOpenOrdersWs(options...)
}
func (this *Limitless) FetchOrderBookWs(symbol string, options ...ccxt.FetchOrderBookWsOptions) (ccxt.OrderBook, error) {
...
func (this *Limitless) FetchOrdersWs(options ...ccxt.FetchOrdersWsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.FetchOrdersWs(options...)
}
func (this *Limitless) FetchOrderWs(id string, options ...ccxt.FetchOrderWsOptions) (ccxt.Order, error) {
	return this.exchangeTyped.FetchOrderWs(id, options...)
}
func (this *Limitless) FetchPositionsForSymbolWs(symbol string, options ...ccxt.FetchPositionsForSymbolWsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsForSymbolWs(symbol, options...)
}
func (this *Limitless) FetchPositionsWs(options ...ccxt.FetchPositionsWsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionsWs(options...)
}
func (this *Limitless) FetchPositionWs(symbol string, options ...ccxt.FetchPositionWsOptions) ([]ccxt.Position, error) {
	return this.exchangeTyped.FetchPositionWs(symbol, options...)
}
func (this *Limitless) FetchTickersWs(options ...ccxt.FetchTickersWsOptions) (ccxt.Tickers, error) {
	return this.exchangeTyped.FetchTickersWs(options...)
}
func (this *Limitless) FetchTickerWs(symbol string, options ...ccxt.FetchTickerWsOptions) (ccxt.Ticker, error) {
	return this.exchangeTyped.FetchTickerWs(symbol, options...)
}
func (this *Limitless) FetchTradesWs(symbol string, options ...ccxt.FetchTradesWsOptions) ([]ccxt.Trade, error) {
...
func (this *Limitless) WatchBidsAsks(options ...ccxt.WatchBidsAsksOptions) (ccxt.Tickers, error) {
...
func (this *Limitless) WatchMarkPrice(symbol string, options ...ccxt.WatchMarkPriceOptions) (ccxt.Ticker, error) {
	return this.exchangeTyped.WatchMarkPrice(symbol, options...)
}
func (this *Limitless) WatchMarkPrices(options ...ccxt.WatchMarkPricesOptions) (ccxt.Tickers, error) {
...
func (this *Limitless) WatchOrderBookForSymbols(symbols []string, options ...ccxt.WatchOrderBookForSymbolsOptions) (ccxt.OrderBook, error) {
...
func (this *Limitless) WatchOrdersForSymbols(symbols []string, options ...ccxt.WatchOrdersForSymbolsOptions) ([]ccxt.Order, error) {
	return this.exchangeTyped.WatchOrdersForSymbols(symbols, options...)
}
func (this *Limitless) WatchPosition(options ...ccxt.WatchPositionOptions) (ccxt.Position, error) {
...
func (this *Limitless) WatchTradesForSymbols(symbols []string, options ...ccxt.WatchTradesForSymbolsOptions) ([]ccxt.Trade, error) {
