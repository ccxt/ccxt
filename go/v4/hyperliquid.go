...
func (this *Hyperliquid) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var interestValue map[string]any = MapTyped(this.SafeDict(interest, "info", map[string]any{}))
...
func (this *Hyperliquid) FetchHip3Markets(params ...any) ([]MarketInterface, error) {
	var res AsyncResult[[]MarketInterface] = AwaitResult(NewMarketInterfaceArray, this.FetchHip3MarketsAsync(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Hyperliquid) CancelTwapOrder(id string, options ...CancelTwapOrderOptions) (Order, error) {
	...
	var res AsyncResult[Order] = AwaitResult(NewOrder, this.CancelTwapOrderAsync(id, opts.Symbol, opts.Params))
	if res.Err != nil {
		return Order{}, res.Err
	}
	return res.Value, nil
