...
func (this *HyperliquidCore) ParseMarket(market any) any {
	...
	var pricePrecisionStr any = this.NumberToString(pricePrecision)
	var isDelisted any = DerefScalar(this.SafeBool(market, "isDelisted"))
...
func (this *HyperliquidCore) PriceToPrecision(symbol any, price any) any {
	...
	var maxDecimals any = Ternary((IsEqual(GetValue(market, "spot"), true)), 8, 6)
...
func (this *HyperliquidCore) SignL1Action(action any, nonce any, optionalArgs ...any) any {
	...
	var isTestnet any = DerefScalar(this.SafeBool(this.Options, "sandboxMode", false))
...
func (this *HyperliquidCore) approveBuilderFeeBody(ch chan any, builder any, maxFeeRate any) any {
	...
	var payload map[string]any = map[string]any{
		"hyperliquidChain": Ternary((isSandboxMode == true), "Testnet", "Mainnet"),
...
func (this *HyperliquidCore) createTwapOrderBody(ch chan any, symbol any, side any, amount any, duration any, optionalArgs ...any) any {
	...
	var randomize any = DerefScalar(this.SafeBool(params, "randomize", false))
...
func (this *HyperliquidCore) EditOrdersRequest(orders any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
		...
		var isTrigger bool = ((stopLossPrice != nil) || (takeProfitPrice != nil))
		var reduceOnly any = DerefScalar(this.SafeBool(orderParams, "reduceOnly", false))
...
func (this *HyperliquidCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var crossed any = DerefScalar(this.SafeBool(trade, "crossed"))
...
func (this *HyperliquidCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if this.InArray(fromAccount, []any{"spot", "swap", "perp"}) {
		...
		var transferPayload map[string]any = map[string]any{
			"hyperliquidChain": Ternary((IsEqual(isSandboxMode, true)), "Testnet", "Mainnet"),
