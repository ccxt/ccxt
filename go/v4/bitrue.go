...
func (this *Bitrue) ParseMarket(market any) any {
	...
	var side *int64 = this.SafeInteger(market, "side") // 1 linear, 0 inverse, undefined spot
	...
	if side == nil {
		...
		typeVar = "swap"
		isLinear = (side != nil && *side == 1)
		isInverse = (side != nil && *side == 0)
	}
	...
	var maxQuantity *float64 = this.SafeNumber(amountFilter, "maxQty")
	if maxQuantity == nil {
		maxQuantity = this.SafeNumber(market, "maxValidOrder")
	}
	var minCost *float64 = this.SafeNumber(amountFilter, "minVal")
	if minCost == nil {
...
func (this *Bitrue) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var timestamp *int64 = this.SafeTimestamp(ohlcv, "i")
	if timestamp == nil {
...
func (this *Bitrue) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var timestamp *int64 = this.SafeInteger2(trade, "ctime", "time")
	var priceString *string = this.SafeString(trade, "price")
	var amountString *string = this.SafeString(trade, "qty")
	var marketId *string = this.SafeString2(trade, "symbol", "contractName")
...
func (this *Bitrue) ParseOrder(order any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var status *string = this.ParseOrderStatus(this.SafeString2(order, "status", "orderStatus"))
...
func (this *Bitrue) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		...
		if isMarketBuyWithPrice {
			var cost *string = this.SafeString(paramsRequiresPrice, "cost")
		...
		var reduceOnly *bool = this.SafeBool2(paramsNoCost, "reduceOnly", "reduce_only")
		...
		var leverage *string = this.SafeString(paramsNoCost, "leverage", "1")
		...
		var triggerPrice *float64 = this.SafeNumber2(paramsNoClientOrderId, "triggerPrice", "stopPrice")
		if triggerPrice != nil {
			request["stopPrice"] = this.PriceToPrecision(symbol, triggerPrice)
		}
		var paramsSpot any = func() any {
			if triggerPrice != nil {
				return this.Omit(paramsNoClientOrderId, []any{"triggerPrice", "stopPrice"})
			}
...
func (this *Bitrue) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	_ = currency
	var id *string = this.SafeString2(transaction, "id", "withdrawId")
...
func (this *Bitrue) ParseTransfer(transfer any, optionalArgs ...any) any {
	...
	if transferType != nil {
		var accountSplit []string = strings.Split(*transferType, "_to_")
...
func (this *Bitrue) Sign(path string, optionalArgs ...any) any {
	...
	if access != nil && *access == "private" {
		...
		if (typeVar != nil && *typeVar == "spot") || (typeVar != nil && *typeVar == "open") {
			...
			if typeVar != nil && *typeVar == "fapi" {
				signPath = "/fapi"
			} else if typeVar != nil && *typeVar == "dapi" {
				signPath = "/dapi"
			}
			signPath = Add(Add(Add(Add(signPath, "/"), version), "/"), path)
			var signMessage any = Add(timestamp+method, signPath)
			if method == "GET" {
				var keys []string = ObjectKeys(paramsOmitted)
				var keysLength int = len(keys)
				if keysLength > 0 {
...
func (this *Bitrue) HandleErrors(code any, reason any, url any, method any, headers any, body any, response any, requestHeaders any, requestBody any) any {
	...
	var errorResponse any = func() any {
		if !IsEqual(parsedMessage, nil) {
			return parsedMessage
		}
		return response
	}()
	var message *string = this.SafeString(errorResponse, "msg")
	if message != nil {
		this.ThrowExactlyMatchedException(this.Exceptions["exact"], message, this.Id+" "+*message)
		this.ThrowBroadlyMatchedException(this.Exceptions["broad"], message, this.Id+" "+*message)
	}
	// checks against error codes
	var error *string = this.SafeString(errorResponse, "code")
	if error != nil {
