...
func (this *BitrueCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes202815 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes202815)
		ch <- retRes202815
		return nil
...
func (this *BitrueCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes263612 := (<-this.LoadMarkets())
			PanicOnError(retRes263612)
		}
...
func (this *BitrueCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes307212 := (<-this.LoadMarkets())
			PanicOnError(retRes307212)
		}
