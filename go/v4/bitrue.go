...
func (this *Bitrue) ParseMarket(market any) any {
	...
	var settle any = nil
	if isContract {
		var symbolSplit []string = func() []string {
			if id == nil {
				return nil
			}
...
func (this *Bitrue) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	if tagType != nil {
		if addressTo != nil {
			var parts []string = func() []string {
				...
				return strings.Split(*addressTo, "_")
			}()
		...
		if addressFrom != nil {
			var parts []string = func() []string {
				...
				return strings.Split(*addressFrom, "_")
			}()
	...
	if currencyId != nil {
		var parts []string = func() []string {
			...
			return strings.Split(*currencyId, "_")
		}()
...
func (this *Bitrue) ParseTransfer(transfer any, optionalArgs ...any) any {
	...
	if transferType != nil {
		var accountSplit []string = func() []string {
			if transferType == nil {
				return nil
			}
			return strings.Split(*transferType, "_to_")
		}()
