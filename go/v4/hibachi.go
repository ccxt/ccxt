...
func (this *Hibachi) HardcodedCurrencies() any {
	...
	networks[networkId] = map[string]any{
		"id":      networkId,
		"network": networkId,
		"limits": map[string]any{
...
func (this *Hibachi) ParseOrderStatus(status *string) *string {
	var uppercaseStatus *string = func() *string {
		...
		return SafeStringPtr(strings.ToUpper(*status))
	}()
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Hibachi) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Hibachi) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	var price *float64 = GetArgFloat64Ptr(optionalArgs, 0, nil)
	_ = price
