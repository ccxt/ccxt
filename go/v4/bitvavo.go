...
func (this *BitvavoCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes81719 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes81719)
			ch <- retRes81719
			return nil
		}
		var request any = map[string]any{
...
func (this *BitvavoCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes114419 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1440))
			PanicOnError(retRes114419)
			ch <- retRes114419
			return nil
		}
...
func (this *BitvavoCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes188919 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func (this *BitvavoCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes215719 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes215719)
			ch <- retRes215719
			return nil
		}
		var market any = this.Market(symbol)
