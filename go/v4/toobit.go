 ...
 */
func (this *ToobitCore) FetchTime(optionalArgs ...any) <-chan Res[*int64] {
...
func (this *ToobitCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes161219 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes161219)
			ch <- retRes161219
			return nil
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *ToobitCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes272515 := (<-this.FetchDepositsOrWithdrawalsHelper("deposits", code, since, limit, params))
...
func (this *ToobitCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes274015 := (<-this.FetchDepositsOrWithdrawalsHelper("withdrawals", code, since, limit, params))
...
func (this *ToobitCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes312712 := (<-this.LoadMarkets())
			PanicOnError(retRes312712)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
