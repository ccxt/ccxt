...
func (this *Toobit) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = SafeMapTyped(endpointparamsVariable, 1)
...
func (this *Toobit) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = SafeMapTyped(isPostOnlyparamsVariable, 1)
	if isPostOnly == true {
...
func (this *Toobit) CreateContractOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = SafeMapTyped(reduceOnlyparamsVariable, 1)
	if IsEqual(side, "buy") {
		side = func() string {
			if reduceOnly == true {
				return "BUY_CLOSE"
...
func (this *Toobit) ParseOrderStatus(status any) *string {
...
func (this *Toobit) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		params = SafeMapTyped(symbolparamsVariable, 1)
		if symbol == nil {
...
func (this *Toobit) ParseTransactionStatus(status any) *string {
	var statuses map[string]any = map[string]any{
		"2":  "pending",
		"12": "pending",
		"11": "failed",
...
func (this *Toobit) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	paramsOmitted := SafeMapTyped(networkCodeparamsOmittedVariable, 1)
