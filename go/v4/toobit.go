...
func (this *ToobitCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes273815 := (<-this.FetchDepositsOrWithdrawalsHelper("deposits", code, since, limit, params))
		PanicOnError(retRes273815)
		ch <- retRes273815
		return nil
...
func (this *ToobitCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes275315 := (<-this.FetchDepositsOrWithdrawalsHelper("withdrawals", code, since, limit, params))
		PanicOnError(retRes275315)
		ch <- retRes275315
		return nil
...
func (this *ToobitCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes303712 := (<-this.LoadMarkets())
			PanicOnError(retRes303712)
		}
		var market any = this.Market(symbol)
