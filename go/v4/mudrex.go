...
func (this *MudrexCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes99815 := (<-this.FetchOrdersByState("closed", symbol, since, limit, params))
	PanicOnError(retRes99815)
	ch <- retRes99815
	return nil
}
...
func (this *MudrexCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes101315 := (<-this.FetchOrdersByState("open", symbol, since, limit, params))
	PanicOnError(retRes101315)
	ch <- retRes101315
	return nil
}
...
func (this *MudrexCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes102815 := (<-this.FetchOrdersByState("closed", symbol, since, limit, params))
...
func (this *MudrexCore) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes126815 := (<-this.AddMargin(symbol, OpNeg(amount), params))
	PanicOnError(retRes126815)
	ch <- retRes126815
	return nil
}
