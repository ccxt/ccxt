...
func (this *Tokocrypto) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes212215 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes212215)
	return nil
}
...
func (this *Tokocrypto) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes213815 []any = ListTyped(PanicOnError((<-this.FetchOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes213815)
	return nil
}
...
func (this *Tokocrypto) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	var tag *string = this.SafeString(data, "addressTag", "")
	if GetLength(tag) == 0 {
		tag = nil
	}
