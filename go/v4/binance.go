...
func (this *Binance) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(isPortfolioMargin) || (IsEqual(typeVar, "papi")) {
		...
		params = SafeMapTyped(useV2paramsVariable, 1)
...
func (this *Binance) editOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(orders); i++ {
		...
		orderParams = SafeMapTyped(isPortfolioMarginorderParamsVariable, 1)
		if EvalTruthy(isPortfolioMargin) {
...
func (this *Binance) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	params = SafeMapTyped(stockparamsVariable, 1)
	if symbol != nil {
...
func (this *Binance) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	params = SafeMapTyped(defaultMethodparamsVariable, 1) // check if there is a key in options|params
