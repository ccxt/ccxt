...
func (this *Binance) loadLeverageBracketsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1158512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1158512)
	}
...
func (this *Binance) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1177212 := (<-this.LoadMarketsAsync())
...
func (this *Binance) fetchOptionPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1181912 := (<-this.LoadMarketsAsync())
...
func (this *Binance) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(defaultMethod, "positionRisk") {
		...
		retRes1195919 := (<-this.FetchPositionsRiskAsync(symbols, params))
		PanicOnError(retRes1195919)
		ch <- retRes1195919
		return nil
	} else if IsEqual(defaultMethod, "account") {

		retRes1196119 := (<-this.FetchAccountPositionsAsync(symbols, params))
		PanicOnError(retRes1196119)
		ch <- retRes1196119
		return nil
	} else if IsEqual(defaultMethod, "option") {

		retRes1196319 := (<-this.FetchOptionPositionsAsync(symbols, params))
		PanicOnError(retRes1196319)
		ch <- retRes1196319
		return nil
	} else {
...
func (this *Binance) fetchAccountPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1199412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1199412)
	}

	retRes119968 := (<-this.LoadLeverageBracketsAsync(false, params))
	PanicOnError(retRes119968)
	var defaultType *string = this.SafeString(this.Options, "defaultType", "future")
	var typeVar *string = this.SafeString(params, "type", defaultType)
	params = this.Omit(params, "type")
	var subType any = nil
...
func (this *Binance) fetchPositionsRiskBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1212312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1212312)
	}

	retRes121258 := (<-this.LoadLeverageBracketsAsync(false, params))
...
func (this *Binance) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1230012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1230012)
	}
	var market any = nil
	var request any = map[string]any{
		"incomeType": "FUNDING_FEE",
...
func (this *Binance) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1237012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1237012)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol":   market["id"],
...
func (this *Binance) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1243112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1243112)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol":     market["id"],
...
func (this *Binance) fetchLeveragesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1254912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1254912)
	}

	retRes125518 := (<-this.LoadLeverageBracketsAsync(false, params))
	PanicOnError(retRes125518)
	var typeVar any = nil
...
func (this *Binance) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1262612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1262612)
	}
...
func (this *Binance) fetchMySettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1267512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1267512)
	}
	var market any = func() any {
		if symbol == nil {
			return nil
...
func (this *Binance) fetchLedgerEntryBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1281612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1281612)
	}
	var typeVar any = nil
...
func (this *Binance) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1286612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1286612)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes1287119 := (<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params, nil, false))
		PanicOnError(retRes1287119)
		ch <- retRes1287119
		return nil
	}
	var typeVar any = nil
...
func (this *Binance) modifyMarginHelperBody(ch chan any, symbol any, amount any, addOrReduce any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1336412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1336412)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Binance) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes1345515 := (<-this.ModifyMarginHelperAsync(symbol, amount, 2, params))
	PanicOnError(retRes1345515)
	ch <- retRes1345515
	return nil
}
...
func (this *Binance) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	retRes1347015 := (<-this.ModifyMarginHelperAsync(symbol, amount, 1, params))
	PanicOnError(retRes1347015)
	ch <- retRes1347015
	return nil
}
...
func (this *Binance) fetchCrossBorrowRateBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1348412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1348412)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"asset": currency["id"],
...
func (this *Binance) fetchIsolatedBorrowRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1354012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1354012)
	}
	var request map[string]any = map[string]any{}
	var symbol *string = this.SafeString(params, "symbol")
	params = this.Omit(params, "symbol")
...
func (this *Binance) fetchBorrowRateHistoryBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1358712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1358712)
	}
	if limit == nil {
		limit = 93
...
func (this *Binance) createGiftCodeBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1369112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1369112)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
...
func (this *Binance) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1378912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1378912)
	}
	var isPortfolioMargin any = nil
...
func (this *Binance) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1389112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1389112)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"asset":  currency["id"],
...
func (this *Binance) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1395112 := (<-this.LoadMarketsAsync())
...
func (this *Binance) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1398612 := (<-this.LoadMarketsAsync())
...
func (this *Binance) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1402512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1402512)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
...
func (this *Binance) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1409612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1409612)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes1410119 := (<-this.FetchPaginatedCallDeterministicAsync("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
		PanicOnError(retRes1410119)
		ch <- retRes1410119
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Binance) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1416312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1416312)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{}
	if GetValue(market, "option") == true {
...
func (this *Binance) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1427212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1427212)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes1427719 := (<-this.FetchPaginatedCallIncrementalAsync("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
		PanicOnError(retRes1427719)
		ch <- retRes1427719
		return nil
	}
	var market any = nil
...
func (this *Binance) fetchGreeksBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1451612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1451612)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Binance) fetchAllGreeksBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1455412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1455412)
	}
	symbols = this.MarketSymbols(symbols, nil, true, true, true)
	var request map[string]any = map[string]any{}
	var market any = nil
...
func (this *Binance) fetchMarginModesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1469912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1469912)
	}
	var market any = nil
	if symbols != nil {
		symbols = this.MarketSymbols(symbols)
...
func (this *Binance) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1479512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1479512)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var subType any = nil
	subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params)
...
func (this *Binance) fetchOptionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1485912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1485912)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Binance) fetchMarginAdjustmentHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1495612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1495612)
	}
	if symbol == nil {
...
func (this *Binance) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1501912 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1501912)
	}
...
func (this *Binance) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1508712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1508712)
	}
	var request map[string]any = map[string]any{
		"fromAsset":  fromCode,
		"toAsset":    toCode,
...
func (this *Binance) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1512712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1512712)
	}
	var request map[string]any = map[string]any{}
	var response any = nil
...
func (this *Binance) fetchConvertTradeBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1517712 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1517712)
	}
	var request map[string]any = map[string]any{}
	var response any = nil
...
func (this *Binance) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1526212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1526212)
	}
	var request map[string]any = map[string]any{}
...
func (this *Binance) fetchFundingIntervalsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1545212 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1545212)
	}
	var market any = nil
	if symbols != nil {
		symbols = this.MarketSymbols(symbols)
...
func (this *Binance) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1550012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1550012)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	if timeframe == nil {
		timeframe = "1d"
...
func (this *Binance) fetchADLRankBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1559812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1559812)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Binance) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes1564012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes1564012)
	}
	symbols = this.MarketSymbols(symbols, nil, true, true, true)
	var market any = this.GetMarketFromSymbols(symbols)
	var subType any = nil
