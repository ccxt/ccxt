...
func (this *BinanceCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes372212 := (<-this.LoadTimeDifference())
...
func (this *BinanceCore) FetchBidsAsks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes472612 := (<-this.LoadMarkets())
			PanicOnError(retRes472612)
		}
...
func (this *BinanceCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes487412 := (<-this.LoadMarkets())
			PanicOnError(retRes487412)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var market any = this.GetMarketFromSymbols(symbols)
		var typeVar any = nil
...
func (this *BinanceCore) FetchMarkPrice(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes493912 := (<-this.LoadMarkets())
			PanicOnError(retRes493912)
		}
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *BinanceCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes509312 := (<-this.LoadMarkets())
			PanicOnError(retRes509312)
		}
		...
		if IsTrue(paginate) {
			...
			retRes509819 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *BinanceCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes552419 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *BinanceCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes600319 := (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes600319)
			ch <- retRes600319
			return nil
		} else {

			retRes600519 := (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func (this *BinanceCore) EditOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes602112 := (<-this.LoadMarkets())
			PanicOnError(retRes602112)
		}
...
func (this *BinanceCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes682812 := (<-this.LoadMarkets())
			PanicOnError(retRes682812)
		}
		var ordersRequests any = []any{}
		var orderSymbols any = []any{}
		for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func (this *BinanceCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes742815 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes745215 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes746712 := (<-this.LoadMarkets())
			PanicOnError(retRes746712)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "spot")) {
		...
		retRes747415 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
		PanicOnError(retRes747415)
		ch <- retRes747415
		return nil
...
func (this *BinanceCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes761719 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func (this *BinanceCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes795012 := (<-this.LoadMarkets())
			PanicOnError(retRes795012)
		}
		var market any = nil
		var typeVar any = nil
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes882715 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *BinanceCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes885919 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *BinanceCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes928319 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes928319)
			ch <- retRes928319
			return nil
		}
...
func (this *BinanceCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes940012 := (<-this.LoadMarkets())
			PanicOnError(retRes940012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes940519 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func (this *BinanceCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
			...
			retRes996519 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
...
func (this *BinanceCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1010112 := (<-this.LoadMarkets())
			PanicOnError(retRes1010112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *BinanceCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1029512 := (<-this.LoadMarkets())
			PanicOnError(retRes1029512)
		}
...
func (this *BinanceCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1043112 := (<-this.LoadMarkets())
			PanicOnError(retRes1043112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":    GetValue(currency, "id"),
...
func (this *BinanceCore) FetchTradingFee(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1050112 := (<-this.LoadMarkets())
			PanicOnError(retRes1050112)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1057312 := (<-this.LoadMarkets())
			PanicOnError(retRes1057312)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FuturesTransfer(code any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1077012 := (<-this.LoadMarkets())
			PanicOnError(retRes1077012)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1079912 := (<-this.LoadMarkets())
			PanicOnError(retRes1079912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1085112 := (<-this.LoadMarkets())
			PanicOnError(retRes1085112)
		}
		var request any = map[string]any{}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1085719 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1154612 := (<-this.LoadMarkets())
			PanicOnError(retRes1154612)
		}
...
func (this *BinanceCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1161412 := (<-this.LoadMarkets())
...
func (this *BinanceCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1173312 := (<-this.LoadMarkets())
			PanicOnError(retRes1173312)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchOptionPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1178012 := (<-this.LoadMarkets())
			PanicOnError(retRes1178012)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{}
		var market any = nil
...
func (this *BinanceCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
			...
			retRes1192019 := (<-this.FetchPositionsRisk(symbols, params))
			PanicOnError(retRes1192019)
			ch <- retRes1192019
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "account")) {

			retRes1192219 := (<-this.FetchAccountPositions(symbols, params))
			PanicOnError(retRes1192219)
			ch <- retRes1192219
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "option")) {

			retRes1192419 := (<-this.FetchOptionPositions(symbols, params))
...
func (this *BinanceCore) FetchAccountPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1195512 := (<-this.LoadMarkets())
			PanicOnError(retRes1195512)
		}

		retRes119578 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes119578)
		var defaultType any = this.SafeString(this.Options, "defaultType", "future")
		var typeVar any = this.SafeString(params, "type", defaultType)
		params = this.Omit(params, "type")
		var subType any = nil
...
func (this *BinanceCore) FetchPositionsRisk(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1208412 := (<-this.LoadMarkets())
			PanicOnError(retRes1208412)
		}

		retRes120868 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1226112 := (<-this.LoadMarkets())
			PanicOnError(retRes1226112)
		}
		var market any = nil
		var request any = map[string]any{
			"incomeType": "FUNDING_FEE",
...
func (this *BinanceCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1233112 := (<-this.LoadMarkets())
			PanicOnError(retRes1233112)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
...
func (this *BinanceCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1239212 := (<-this.LoadMarkets())
			PanicOnError(retRes1239212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":     GetValue(market, "id"),
...
func (this *BinanceCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1251012 := (<-this.LoadMarkets())
			PanicOnError(retRes1251012)
		}

		retRes125128 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1258712 := (<-this.LoadMarkets())
			PanicOnError(retRes1258712)
		}
...
func (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1263612 := (<-this.LoadMarkets())
			PanicOnError(retRes1263612)
		}
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedgerEntry(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1277712 := (<-this.LoadMarkets())
			PanicOnError(retRes1277712)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1282712 := (<-this.LoadMarkets())
			PanicOnError(retRes1282712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1283219 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
			PanicOnError(retRes1283219)
			ch <- retRes1283219
			return nil
		}
		var typeVar any = nil
...
func (this *BinanceCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1332512 := (<-this.LoadMarkets())
			PanicOnError(retRes1332512)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1341615 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
		PanicOnError(retRes1341615)
		ch <- retRes1341615
		return nil
...
func (this *BinanceCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1343115 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes1343115)
		ch <- retRes1343115
		return nil
...
func (this *BinanceCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1344512 := (<-this.LoadMarkets())
			PanicOnError(retRes1344512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset": GetValue(currency, "id"),
...
func (this *BinanceCore) FetchIsolatedBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1350112 := (<-this.LoadMarkets())
			PanicOnError(retRes1350112)
		}
		var request any = map[string]any{}
		var symbol any = this.SafeString(params, "symbol")
		params = this.Omit(params, "symbol")
...
func (this *BinanceCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1354812 := (<-this.LoadMarkets())
			PanicOnError(retRes1354812)
		}
		if IsTrue(IsEqual(limit, nil)) {
			limit = 93
...
func (this *BinanceCore) CreateGiftCode(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1365212 := (<-this.LoadMarkets())
			PanicOnError(retRes1365212)
		}
		var currency any = this.Currency(code)
...
func (this *BinanceCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1375012 := (<-this.LoadMarkets())
			PanicOnError(retRes1375012)
		}
		var isPortfolioMargin any = nil
...
func (this *BinanceCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1385212 := (<-this.LoadMarkets())
			PanicOnError(retRes1385212)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1391212 := (<-this.LoadMarkets())
			PanicOnError(retRes1391212)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1394712 := (<-this.LoadMarkets())
			PanicOnError(retRes1394712)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1398612 := (<-this.LoadMarkets())
			PanicOnError(retRes1398612)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1405712 := (<-this.LoadMarkets())
			PanicOnError(retRes1405712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1406219 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
			PanicOnError(retRes1406219)
			ch <- retRes1406219
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1412412 := (<-this.LoadMarkets())
			PanicOnError(retRes1412412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		if IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1423112 := (<-this.LoadMarkets())
			PanicOnError(retRes1423112)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1423619 := (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
			PanicOnError(retRes1423619)
			ch <- retRes1423619
			return nil
		}
		var market any = nil
...
func (this *BinanceCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1447512 := (<-this.LoadMarkets())
			PanicOnError(retRes1447512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1451312 := (<-this.LoadMarkets())
			PanicOnError(retRes1451312)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var request any = map[string]any{}
		var market any = nil
...
func (this *BinanceCore) FetchMarginModes(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1465812 := (<-this.LoadMarkets())
			PanicOnError(retRes1465812)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1475412 := (<-this.LoadMarkets())
			PanicOnError(retRes1475412)
		}
		var market any = this.Market(symbol)
		var subType any = nil
		subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params)
...
func (this *BinanceCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1481812 := (<-this.LoadMarkets())
			PanicOnError(retRes1481812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1491512 := (<-this.LoadMarkets())
			PanicOnError(retRes1491512)
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BinanceCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1497812 := (<-this.LoadMarkets())
			PanicOnError(retRes1497812)
		}
...
func (this *BinanceCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1504612 := (<-this.LoadMarkets())
			PanicOnError(retRes1504612)
		}
		var request any = map[string]any{
			"fromAsset":  fromCode,
			"toAsset":    toCode,
...
func (this *BinanceCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1513612 := (<-this.LoadMarkets())
			PanicOnError(retRes1513612)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1522112 := (<-this.LoadMarkets())
			PanicOnError(retRes1522112)
		}
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1541112 := (<-this.LoadMarkets())
			PanicOnError(retRes1541112)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1545912 := (<-this.LoadMarkets())
			PanicOnError(retRes1545912)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1555712 := (<-this.LoadMarkets())
			PanicOnError(retRes1555712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchPositionsADLRank(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1559912 := (<-this.LoadMarkets())
			PanicOnError(retRes1559912)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var market any = this.GetMarketFromSymbols(symbols)
		var subType any = nil
