...
func (this *BinanceCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes351112 := (<-this.LoadTimeDifference())
...
func (this *BinanceCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes479519 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
			PanicOnError(retRes479519)
			ch <- retRes479519
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes520019 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *BinanceCore) EditContractOrder(id any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes55498 := (<-this.LoadMarkets())
		PanicOnError(retRes55498)
		var market any = this.Market(symbol)
		var isPortfolioMargin any = nil
...
func (this *BinanceCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes562119 := (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes562119)
			ch <- retRes562119
			return nil
		} else {

			retRes562319 := (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func (this *BinanceCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes690415 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes692615 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes69408 := (<-this.LoadMarkets())
		PanicOnError(retRes69408)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "spot")) {
		...
		retRes694615 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BinanceCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes706719 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func (this *BinanceCore) FetchOpenOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes74358 := (<-this.LoadMarkets())
		PanicOnError(retRes74358)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BinanceCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes811615 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *BinanceCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes814419 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *BinanceCore) FetchMyDustTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes83678 := (<-this.LoadMarkets())
		PanicOnError(retRes83678)
		var request any = map[string]any{}
		if IsTrue(!IsEqual(since, nil)) {
			AddElementToObject(request, "startTime", since)
...
func (this *BinanceCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes851419 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes851419)
			ch <- retRes851419
			return nil
		}
...
func (this *BinanceCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes862719 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes862719)
			ch <- retRes862719
			return nil
		}
		var legalMoney any = this.SafeDict(this.Options, "legalMoney", map[string]any{})
...
func (this *BinanceCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
			...
			retRes917319 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
			PanicOnError(retRes917319)
			ch <- retRes917319
			return nil
		}
		var currency any = nil
...
func (this *BinanceCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes94938 := (<-this.LoadMarkets())
		PanicOnError(retRes94938)
...
func (this *BinanceCore) FetchTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes97608 := (<-this.LoadMarkets())
		PanicOnError(retRes97608)
		var typeVar any = nil
...
func (this *BinanceCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes99688 := (<-this.LoadMarkets())
		PanicOnError(retRes99688)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes100158 := (<-this.LoadMarkets())
		PanicOnError(retRes100158)
		var request any = map[string]any{}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1002019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes1002019)
			ch <- retRes1002019
			return nil
		}
...
func (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes107018 := (<-this.LoadMarkets())
		PanicOnError(retRes107018)
...
func (this *BinanceCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes107638 := (<-this.LoadMarkets())
		PanicOnError(retRes107638)
		var typeVar any = nil
...
func (this *BinanceCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes108808 := (<-this.LoadMarkets())
		PanicOnError(retRes108808)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
			...
			retRes1106019 := (<-this.FetchPositionsRisk(symbols, params))
			PanicOnError(retRes1106019)
			ch <- retRes1106019
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "account")) {

			retRes1106219 := (<-this.FetchAccountPositions(symbols, params))
			PanicOnError(retRes1106219)
			ch <- retRes1106219
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "option")) {

			retRes1106419 := (<-this.FetchOptionPositions(symbols, params))
			PanicOnError(retRes1106419)
			ch <- retRes1106419
			return nil
		} else {
...
func (this *BinanceCore) FetchAccountPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes110948 := (<-this.LoadMarkets())
		PanicOnError(retRes110948)

		retRes110958 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes110958)
		var defaultType any = this.SafeString(this.Options, "defaultType", "future")
		var typeVar any = this.SafeString(params, "type", defaultType)
		params = this.Omit(params, "type")
		var subType any = nil
...
func (this *BinanceCore) FetchPositionsRisk(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes112218 := (<-this.LoadMarkets())
		PanicOnError(retRes112218)

		retRes112228 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes113928 := (<-this.LoadMarkets())
		PanicOnError(retRes113928)
		var market any = nil
		var request any = map[string]any{
			"incomeType": "FUNDING_FEE",
		}
...
func (this *BinanceCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes114608 := (<-this.LoadMarkets())
		PanicOnError(retRes114608)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
			"leverage": leverage,
...
func (this *BinanceCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes115168 := (<-this.LoadMarkets())
		PanicOnError(retRes115168)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":     GetValue(market, "id"),
			"marginType": marginMode,
...
func (this *BinanceCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes116268 := (<-this.LoadMarkets())
		PanicOnError(retRes116268)

		retRes116278 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes117018 := (<-this.LoadMarkets())
		PanicOnError(retRes117018)
...
func (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes117488 := (<-this.LoadMarkets())
		PanicOnError(retRes117488)
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedgerEntry(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes118878 := (<-this.LoadMarkets())
		PanicOnError(retRes118878)
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes119358 := (<-this.LoadMarkets())
		PanicOnError(retRes119358)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1193919 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
			PanicOnError(retRes1193919)
			ch <- retRes1193919
			return nil
		}
		var typeVar any = nil
...
func (this *BinanceCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes124238 := (<-this.LoadMarkets())
		PanicOnError(retRes124238)
		var market any = this.Market(symbol)
...
func (this *BinanceCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1251015 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
		PanicOnError(retRes1251015)
		ch <- retRes1251015
		return nil
...
func (this *BinanceCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1252515 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes1252515)
		ch <- retRes1252515
		return nil
...
func (this *BinanceCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes125388 := (<-this.LoadMarkets())
		PanicOnError(retRes125388)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset": GetValue(currency, "id"),
		}
...
func (this *BinanceCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes126378 := (<-this.LoadMarkets())
		PanicOnError(retRes126378)
		if IsTrue(IsEqual(limit, nil)) {
			limit = 93
...
func (this *BinanceCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes129938 := (<-this.LoadMarkets())
		PanicOnError(retRes129938)
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"asset":      GetValue(currency, "id"),
...
func (this *BinanceCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130268 := (<-this.LoadMarkets())
		PanicOnError(retRes130268)
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
			"amount": this.CurrencyToPrecision(code, amount),
...
func (this *BinanceCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130638 := (<-this.LoadMarkets())
		PanicOnError(retRes130638)
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"asset":      GetValue(currency, "id"),
...
func (this *BinanceCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes131328 := (<-this.LoadMarkets())
		PanicOnError(retRes131328)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1313619 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
			PanicOnError(retRes1313619)
			ch <- retRes1313619
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes131978 := (<-this.LoadMarkets())
		PanicOnError(retRes131978)
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		if IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes133028 := (<-this.LoadMarkets())
		PanicOnError(retRes133028)
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1330619 := (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
			PanicOnError(retRes1330619)
			ch <- retRes1330619
			return nil
		}
		var market any = nil
...
func (this *BinanceCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes135378 := (<-this.LoadMarkets())
		PanicOnError(retRes135378)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BinanceCore) FetchMarginModes(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes137118 := (<-this.LoadMarkets())
		PanicOnError(retRes137118)
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
			market = this.Market(GetValue(symbols, 0))
...
func (this *BinanceCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes138648 := (<-this.LoadMarkets())
		PanicOnError(retRes138648)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes139598 := (<-this.LoadMarkets())
		PanicOnError(retRes139598)
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BinanceCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes141158 := (<-this.LoadMarkets())
		PanicOnError(retRes141158)
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes142408 := (<-this.LoadMarkets())
		PanicOnError(retRes142408)
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes145708 := (<-this.LoadMarkets())
		PanicOnError(retRes145708)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
