...
func  (this *BinanceCore) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            for i := 0; IsLessThan(i, GetArrayLength(responseCurrencies)); i++ {
                ...
                for j := 0; IsLessThan(j, GetArrayLength(networkList)); j++ {
                    ...
                    // avoid zero values, which are mostly from fiat or leveraged tokens or some abandoned coins : https://github.com/mtan11/ccxt/pull/14902#issuecomment-1271636731
...
func  (this *BinanceCore) ParseMarket(market interface{}) interface{}  {
    ...
    if IsTrue(IsTrue((IsEqual(expiry, nil))) || IsTrue((IsEqual(contractType, "PERPETUAL"))) || IsTrue((IsEqual(expiry, int64(4133404800000))))) {
        expiry = nil
        swap = true
...
func  (this *BinanceCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(!IsEqual(since, nil)) {
                ...
                // https://github.com/mtan11/ccxt/issues/8454
                //
...
func  (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {}
            var msInThirtyDays interface{} = int64(2592000000)
            var now interface{} = this.Milliseconds()
            if IsTrue(!IsEqual(since, nil)) {
                AddElementToObject(request, "startTime", since)
            } else {
