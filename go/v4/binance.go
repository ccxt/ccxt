...
func (this *BinanceCore) fetchCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	params := GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	var fetchCurrenciesEnabled any = DerefScalar(this.SafeBool(this.Options, "fetchCurrencies"))
	...
	var fetchMargins any = DerefScalar(this.SafeBool(this.Options, "fetchMargins", false))
...
func (this *BinanceCore) ParseCurrency(rawCurrency any) any {
	...
	var isFiat any = DerefScalar(this.SafeBool(entry, "isLegalMoney"))
	...
	for j := 0; IsLessThan(j, GetArrayLength(networkList)); j++ {
		...
		var withdrawFee any = DerefScalar(this.SafeNumber(networkItem, "withdrawFee"))
		var depositEnable any = DerefScalar(this.SafeBool(networkItem, "depositEnable"))
		var withdrawEnable any = DerefScalar(this.SafeBool(networkItem, "withdrawEnable"))
		if !IsEqual(networkCode, nil) {
			AddElementToObject(fees, networkCode, withdrawFee)
		}
		var isDefault any = DerefScalar(this.SafeBool(networkItem, "isDefault"))
	...
	var trading any = DerefScalar(this.SafeBool(entry, "trading"))
...
func (this *BinanceCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	var demoMode any = DerefScalar(this.SafeBool(this.Options, "enableDemoTrading", false))
...
func (this *BinanceCore) ParseMarket(market any) any {
	...
	var isMarginTradingAllowed any = DerefScalar(this.SafeBool(market, "isMarginTradingAllowed", false))
	...
	var stepSize any = DerefScalar(this.SafeNumber(market, "stepSize"))
...
func (this *BinanceCore) ParseBalanceCustom(response any, optionalArgs ...any) any {
	...
	if EvalTruthy(isPortfolioMargin) {
		...
		timestamp = DerefScalar(this.SafeInteger(response, "updateTime"))
...
func (this *BinanceCore) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(GetValue(market, "option"), true) {
		...
		var stock any = DerefScalar(this.SafeBool(market, "stock", false))
		if stock == true {

			response = (<-this.SapiGetEquityMarketQuote(this.Extend(request, params)))
			PanicOnError(response)
		} else {
			var rolling any = DerefScalar(this.SafeBool(params, "rolling", false))
...
func (this *BinanceCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	var side any = nil
	var buyerMaker any = DerefScalar(this.SafeBool2(trade, "m", "isBuyerMaker"))
...
func (this *BinanceCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var porfolioOptionsValue any = DerefScalar(this.SafeBool2(this.Options, "papi", "portfolioMargin", false))
	var isPortfolioMargin any = DerefScalar(this.SafeBool2(params, "papi", "portfolioMargin", porfolioOptionsValue))
	...
	var sor any = DerefScalar(this.SafeBool2(params, "sor", "SOR", false))
...
func (this *BinanceCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	// unified iceberg
	var icebergAmount any = DerefScalar(this.SafeNumber(params, "icebergAmount"))
...
func (this *BinanceCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	isPortfolioMargin = GetValue(isPortfolioMarginparamsVariable, 0)
	params = GetValue(isPortfolioMarginparamsVariable, 1)
	var isConditional any = DerefScalar(this.SafeBoolN(params, []any{"stop", "trigger", "conditional"}))
...
func (this *BinanceCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if !IsEqual(symbol, nil) {
		...
		var warnWithoutSymbol any = DerefScalar(this.SafeBool(GetValue(this.Options, "fetchOpenOrders"), "warnWithoutSymbol"))
		var optValue any = DerefScalar(this.SafeBool(this.Options, "warnOnFetchOpenOrdersWithoutSymbol")) // for backward compatibility
...
func (this *BinanceCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	typeVar = GetValue(typeVarparamsVariable, 0)
	params = GetValue(typeVarparamsVariable, 1)
	if (stock != true) && (!IsEqual(typeVar, "option")) && (IsEqual(symbol, nil)) {
...
func (this *BinanceCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var fiatOnly any = DerefScalar(this.SafeBool(params, "fiat", false))
...
func (this *BinanceCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var timestamp any = nil
	timestamp = DerefScalar(this.SafeInteger2(transaction, "insertTime", "createTime"))
	...
	if IsEqual(typeVar, nil) {
		...
		code = DerefScalar(this.SafeString(legalMoneyCurrenciesById, code, code))
	}
...
func (this *BinanceCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	var internal any = DerefScalar(this.SafeBool(params, "internal"))
...
func (this *BinanceCore) ParseDepositWithdrawFee(fee any, optionalArgs ...any) any {
	...
	for j := 0; IsLessThan(j, GetArrayLength(networkList)); j++ {
		...
		var isDefault any = DerefScalar(this.SafeBool(networkEntry, "isDefault"))
...
func (this *BinanceCore) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var estimatedSettlePrice any = DerefScalar(this.SafeNumber(contract, "estimatedSettlePrice"))
	var fundingRate any = DerefScalar(this.SafeNumber(contract, "lastFundingRate"))
...
func (this *BinanceCore) ParseLeverage(leverage any, optionalArgs ...any) any {
	...
	var marginModeRaw any = DerefScalar(this.SafeBool(leverage, "isolated"))
	var marginMode any = nil
...
func (this *BinanceCore) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var amount any = DerefScalar(this.SafeNumber2(interest, "sumOpenInterest", "openInterest"))
	var value any = DerefScalar(this.SafeNumber2(interest, "sumOpenInterestValue", "sumOpenInterestUsd"))
...
func (this *BinanceCore) fetchPositionModeBody(ch chan any, optionalArgs ...any) any {
	...
	//    }
	//
	var dualSidePosition any = DerefScalar(this.SafeBool(response, "dualSidePosition"))
...
func (this *BinanceCore) ParseMarginMode(marginMode any, optionalArgs ...any) any {
	...
	var marginModeRaw any = DerefScalar(this.SafeBool(marginMode, "isolated"))
...
func (this *BinanceCore) ParseADLRank(info any, optionalArgs ...any) any {
	...
	var longNum any = DerefScalar(this.SafeNumber(adlQuantile, "LONG"))
	var shortNum any = DerefScalar(this.SafeNumber(adlQuantile, "SHORT"))
	var both any = DerefScalar(this.SafeNumber(adlQuantile, "BOTH"))
	var rank any = nil
	if !IsEqual(both, nil) {
		rank = both
	} else {
