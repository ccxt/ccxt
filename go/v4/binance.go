...
func (this *Binance) EditSpotOrder(id string, symbol string, typeVar string, side string, amount float64, options ...EditSpotOrderOptions) (Order, error) {
	...
	res := AwaitResult(this.EditSpotOrderAsync(id, symbol, typeVar, side, amount, opts.Price, opts.Params))
	if res.Err != nil {
...
func (this *Binance) EditContractOrder(id string, symbol string, typeVar string, side string, amount float64, options ...EditContractOrderOptions) (Order, error) {
	...
	res := AwaitResult(this.EditContractOrderAsync(id, symbol, typeVar, side, amount, opts.Price, opts.Params))
	if res.Err != nil {
		return Order{}, res.Err
	}
	return NewOrder(res.Value), nil
...
func (this *Binance) FetchMyDustTrades(options ...FetchMyDustTradesOptions) ([]Trade, error) {
	...
	res := AwaitResult(this.FetchMyDustTradesAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return NewTradeArray(res.Value), nil
...
func (this *Binance) FetchOptionPositions(options ...FetchOptionPositionsOptions) ([]Position, error) {
	...
	res := AwaitResult(this.FetchOptionPositionsAsync(opts.Symbols, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
...
func (this *Binance) CreateGiftCode(code string, amount any, options ...CreateGiftCodeOptions) (map[string]any, error) {
	...
	res := AwaitResult(this.CreateGiftCodeAsync(code, amount, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value.(map[string]any), nil
...
func (this *Binance) FetchADLRank(symbol string, options ...FetchADLRankOptions) (ADL, error) {
	...
	res := AwaitResult(this.FetchADLRankAsync(symbol, opts.Params))
	if res.Err != nil {
		return ADL{}, res.Err
	}
