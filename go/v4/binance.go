...
func (this *BinanceCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes351712 := (<-this.LoadTimeDifference())
...
func (this *BinanceCore) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes442012 := (<-this.LoadMarkets())
			PanicOnError(retRes442012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes482419 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *BinanceCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes523119 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *BinanceCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes567812 := (<-this.LoadMarkets())
			PanicOnError(retRes567812)
		}
		var market any = this.Market(symbol)
		if IsTrue(GetValue(market, "option")) {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes568519 := (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes568519)
			ch <- retRes568519
			return nil
		} else {

			retRes568719 := (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func (this *BinanceCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes696812 := (<-this.LoadMarkets())
			PanicOnError(retRes696812)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "spot")) {
		...
		retRes697715 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes700115 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes702315 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BinanceCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes705112 := (<-this.LoadMarkets())
			PanicOnError(retRes705112)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes714312 := (<-this.LoadMarkets())
			PanicOnError(retRes714312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes714819 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func (this *BinanceCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes783812 := (<-this.LoadMarkets())
			PanicOnError(retRes783812)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes820212 := (<-this.LoadMarkets())
			PanicOnError(retRes820212)
		}
		var market any = this.Market(symbol)
		var typeVar any = this.SafeString(params, "type", GetValue(market, "type"))
		...
		retRes821315 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *BinanceCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes824319 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes824319)
			ch <- retRes824319
			return nil
		}
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchMyDustTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes846712 := (<-this.LoadMarkets())
			PanicOnError(retRes846712)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(since, nil)) {
			AddElementToObject(request, "startTime", since)
...
func (this *BinanceCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes861212 := (<-this.LoadMarkets())
			PanicOnError(retRes861212)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes861719 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
			PanicOnError(retRes861719)
			ch <- retRes861719
			return nil
		}
...
func (this *BinanceCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes873219 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes873219)
			ch <- retRes873219
			return nil
		}
		var legalMoney any = this.SafeDict(this.Options, "legalMoney", map[string]any{})
...
func (this *BinanceCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
			...
			retRes928519 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
...
func (this *BinanceCore) FetchDepositAddress(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes942112 := (<-this.LoadMarkets())
			PanicOnError(retRes942112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *BinanceCore) FetchTradingFee(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes981412 := (<-this.LoadMarkets())
			PanicOnError(retRes981412)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FuturesTransfer(code any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1006612 := (<-this.LoadMarkets())
			PanicOnError(retRes1006612)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1014412 := (<-this.LoadMarkets())
			PanicOnError(retRes1014412)
		}
		var request any = map[string]any{}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1015019 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes1015019)
			ch <- retRes1015019
			return nil
		}
...
func (this *BinanceCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1022412 := (<-this.LoadMarkets())
			PanicOnError(retRes1022412)
		}
		symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1083412 := (<-this.LoadMarkets())
			PanicOnError(retRes1083412)
		}
...
func (this *BinanceCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1089812 := (<-this.LoadMarkets())
			PanicOnError(retRes1089812)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1101712 := (<-this.LoadMarkets())
			PanicOnError(retRes1101712)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchOptionPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1106412 := (<-this.LoadMarkets())
			PanicOnError(retRes1106412)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{}
		var market any = nil
...
func (this *BinanceCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
			...
			retRes1120319 := (<-this.FetchPositionsRisk(symbols, params))
			PanicOnError(retRes1120319)
			ch <- retRes1120319
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "account")) {

			retRes1120519 := (<-this.FetchAccountPositions(symbols, params))
			PanicOnError(retRes1120519)
			ch <- retRes1120519
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "option")) {

			retRes1120719 := (<-this.FetchOptionPositions(symbols, params))
			PanicOnError(retRes1120719)
			ch <- retRes1120719
			return nil
		} else {
...
func (this *BinanceCore) FetchAccountPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1123812 := (<-this.LoadMarkets())
			PanicOnError(retRes1123812)
		}

		retRes112408 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes112408)
		var defaultType any = this.SafeString(this.Options, "defaultType", "future")
		var typeVar any = this.SafeString(params, "type", defaultType)
		params = this.Omit(params, "type")
		var subType any = nil
...
func (this *BinanceCore) FetchPositionsRisk(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1136712 := (<-this.LoadMarkets())
			PanicOnError(retRes1136712)
		}

		retRes113698 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1154012 := (<-this.LoadMarkets())
			PanicOnError(retRes1154012)
		}
		var market any = nil
		var request any = map[string]any{
			"incomeType": "FUNDING_FEE",
...
func (this *BinanceCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1161012 := (<-this.LoadMarkets())
			PanicOnError(retRes1161012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
...
func (this *BinanceCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1166812 := (<-this.LoadMarkets())
			PanicOnError(retRes1166812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":     GetValue(market, "id"),
...
func (this *BinanceCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes117828 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1185712 := (<-this.LoadMarkets())
			PanicOnError(retRes1185712)
		}
...
func (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1190612 := (<-this.LoadMarkets())
			PanicOnError(retRes1190612)
		}
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedgerEntry(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1204712 := (<-this.LoadMarkets())
			PanicOnError(retRes1204712)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1209712 := (<-this.LoadMarkets())
			PanicOnError(retRes1209712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1210219 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
			PanicOnError(retRes1210219)
			ch <- retRes1210219
			return nil
		}
		var typeVar any = nil
...
func (this *BinanceCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1267515 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
		PanicOnError(retRes1267515)
		ch <- retRes1267515
		return nil
...
func (this *BinanceCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1269015 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes1269015)
		ch <- retRes1269015
		return nil
...
func (this *BinanceCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1270412 := (<-this.LoadMarkets())
			PanicOnError(retRes1270412)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset": GetValue(currency, "id"),
...
func (this *BinanceCore) FetchIsolatedBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1276012 := (<-this.LoadMarkets())
			PanicOnError(retRes1276012)
		}
		var request any = map[string]any{}
		var symbol any = this.SafeString(params, "symbol")
		params = this.Omit(params, "symbol")
...
func (this *BinanceCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1280712 := (<-this.LoadMarkets())
			PanicOnError(retRes1280712)
		}
		if IsTrue(IsEqual(limit, nil)) {
			limit = 93
...
func (this *BinanceCore) CreateGiftCode(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1291112 := (<-this.LoadMarkets())
			PanicOnError(retRes1291112)
		}
		var currency any = this.Currency(code)
...
func (this *BinanceCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1300912 := (<-this.LoadMarkets())
			PanicOnError(retRes1300912)
		}
		var isPortfolioMargin any = nil
...
func (this *BinanceCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1311112 := (<-this.LoadMarkets())
			PanicOnError(retRes1311112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1317112 := (<-this.LoadMarkets())
			PanicOnError(retRes1317112)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1320612 := (<-this.LoadMarkets())
			PanicOnError(retRes1320612)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1324512 := (<-this.LoadMarkets())
			PanicOnError(retRes1324512)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1331612 := (<-this.LoadMarkets())
			PanicOnError(retRes1331612)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1332119 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
			PanicOnError(retRes1332119)
			ch <- retRes1332119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1338312 := (<-this.LoadMarkets())
			PanicOnError(retRes1338312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		if IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1349012 := (<-this.LoadMarkets())
		...
		if IsTrue(paginate) {
			...
			retRes1349519 := (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
			PanicOnError(retRes1349519)
			ch <- retRes1349519
			return nil
		}
		var market any = nil
...
func (this *BinanceCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1372712 := (<-this.LoadMarkets())
			PanicOnError(retRes1372712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1376512 := (<-this.LoadMarkets())
			PanicOnError(retRes1376512)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var request any = map[string]any{}
		var market any = nil
...
func (this *BinanceCore) FetchMarginModes(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1390512 := (<-this.LoadMarkets())
			PanicOnError(retRes1390512)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1400112 := (<-this.LoadMarkets())
			PanicOnError(retRes1400112)
		}
		var market any = this.Market(symbol)
		var subType any = nil
		subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params)
...
func (this *BinanceCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1406212 := (<-this.LoadMarkets())
			PanicOnError(retRes1406212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1415912 := (<-this.LoadMarkets())
			PanicOnError(retRes1415912)
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BinanceCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1421912 := (<-this.LoadMarkets())
			PanicOnError(retRes1421912)
		}
...
func (this *BinanceCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1428412 := (<-this.LoadMarkets())
			PanicOnError(retRes1428412)
		}
		var request any = map[string]any{
			"fromAsset":  fromCode,
			"toAsset":    toCode,
...
func (this *BinanceCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1432112 := (<-this.LoadMarkets())
			PanicOnError(retRes1432112)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1436812 := (<-this.LoadMarkets())
			PanicOnError(retRes1436812)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1445012 := (<-this.LoadMarkets())
			PanicOnError(retRes1445012)
		}
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1464012 := (<-this.LoadMarkets())
			PanicOnError(retRes1464012)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1468812 := (<-this.LoadMarkets())
			PanicOnError(retRes1468812)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1478612 := (<-this.LoadMarkets())
			PanicOnError(retRes1478612)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchPositionsADLRank(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1482512 := (<-this.LoadMarkets())
