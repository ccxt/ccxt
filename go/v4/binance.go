...
func (this *BinanceCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes460412 := (<-this.LoadMarkets())
			PanicOnError(retRes460412)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var market any = this.GetMarketFromSymbols(symbols)
		var typeVar any = nil
...
func (this *BinanceCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes481919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
			PanicOnError(retRes481919)
			ch <- retRes481919
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes522619 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *BinanceCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes568019 := (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes568019)
			ch <- retRes568019
			return nil
		} else {

			retRes568219 := (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func (this *BinanceCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes654212 := (<-this.LoadMarkets())
			PanicOnError(retRes654212)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes697215 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
		PanicOnError(retRes697215)
		ch <- retRes697215
		return nil
...
func (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes699615 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
		PanicOnError(retRes699615)
		ch <- retRes699615
		return nil
...
func (this *BinanceCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes701815 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BinanceCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes714319 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func (this *BinanceCore) FetchOpenOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes751812 := (<-this.LoadMarkets())
			PanicOnError(retRes751812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes783312 := (<-this.LoadMarkets())
			PanicOnError(retRes783312)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes819712 := (<-this.LoadMarkets())
			PanicOnError(retRes819712)
		}
		var market any = this.Market(symbol)
		var typeVar any = this.SafeString(params, "type", GetValue(market, "type"))
		...
		retRes820815 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes820815)
		ch <- retRes820815
		return nil
...
func (this *BinanceCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes823819 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes823819)
			ch <- retRes823819
			return nil
		}
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes861219 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *BinanceCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes872212 := (<-this.LoadMarkets())
			PanicOnError(retRes872212)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes872719 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes872719)
			ch <- retRes872719
			return nil
		}
		var legalMoney any = this.SafeDict(this.Options, "legalMoney", map[string]any{})
...
func (this *BinanceCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
			...
			retRes927719 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
...
func (this *BinanceCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1008712 := (<-this.LoadMarkets())
			PanicOnError(retRes1008712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1013612 := (<-this.LoadMarkets())
			PanicOnError(retRes1013612)
		}
		var request any = map[string]any{}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1014219 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes1014219)
			ch <- retRes1014219
			return nil
		}
...
func (this *BinanceCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1021612 := (<-this.LoadMarkets())
			PanicOnError(retRes1021612)
		}
		symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1082612 := (<-this.LoadMarkets())
			PanicOnError(retRes1082612)
		}
...
func (this *BinanceCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1100912 := (<-this.LoadMarkets())
			PanicOnError(retRes1100912)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchOptionPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1105612 := (<-this.LoadMarkets())
			PanicOnError(retRes1105612)
		}
		symbols = this.MarketSymbols(symbols)
		var request any = map[string]any{}
		var market any = nil
...
func (this *BinanceCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
			...
			retRes1119519 := (<-this.FetchPositionsRisk(symbols, params))
			PanicOnError(retRes1119519)
			ch <- retRes1119519
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "account")) {

			retRes1119719 := (<-this.FetchAccountPositions(symbols, params))
			PanicOnError(retRes1119719)
			ch <- retRes1119719
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "option")) {

			retRes1119919 := (<-this.FetchOptionPositions(symbols, params))
			PanicOnError(retRes1119919)
			ch <- retRes1119919
			return nil
		} else {
...
func (this *BinanceCore) FetchAccountPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1123012 := (<-this.LoadMarkets())
			PanicOnError(retRes1123012)
		}

		retRes112328 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchPositionsRisk(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1135912 := (<-this.LoadMarkets())
			PanicOnError(retRes1135912)
		}

		retRes113618 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes113618)
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1153212 := (<-this.LoadMarkets())
			PanicOnError(retRes1153212)
		}
		var market any = nil
		var request any = map[string]any{
			"incomeType": "FUNDING_FEE",
...
func (this *BinanceCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1160212 := (<-this.LoadMarkets())
			PanicOnError(retRes1160212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
...
func (this *BinanceCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1166012 := (<-this.LoadMarkets())
			PanicOnError(retRes1166012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":     GetValue(market, "id"),
...
func (this *BinanceCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes117748 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1184912 := (<-this.LoadMarkets())
...
func (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1189812 := (<-this.LoadMarkets())
...
func (this *BinanceCore) FetchLedgerEntry(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1203912 := (<-this.LoadMarkets())
			PanicOnError(retRes1203912)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1208912 := (<-this.LoadMarkets())
			PanicOnError(retRes1208912)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1209419 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
			PanicOnError(retRes1209419)
			ch <- retRes1209419
			return nil
		}
		var typeVar any = nil
...
func (this *BinanceCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1257912 := (<-this.LoadMarkets())
...
func (this *BinanceCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1266715 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
...
func (this *BinanceCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1268215 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes1268215)
		ch <- retRes1268215
		return nil
...
func (this *BinanceCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1269612 := (<-this.LoadMarkets())
			PanicOnError(retRes1269612)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset": GetValue(currency, "id"),
...
func (this *BinanceCore) FetchIsolatedBorrowRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1275212 := (<-this.LoadMarkets())
			PanicOnError(retRes1275212)
		}
		var request any = map[string]any{}
		var symbol any = this.SafeString(params, "symbol")
		params = this.Omit(params, "symbol")
...
func (this *BinanceCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1279912 := (<-this.LoadMarkets())
			PanicOnError(retRes1279912)
		}
		if IsTrue(IsEqual(limit, nil)) {
			limit = 93
...
func (this *BinanceCore) CreateGiftCode(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1290312 := (<-this.LoadMarkets())
			PanicOnError(retRes1290312)
		}
		var currency any = this.Currency(code)
...
func (this *BinanceCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1300112 := (<-this.LoadMarkets())
			PanicOnError(retRes1300112)
		}
		var isPortfolioMargin any = nil
...
func (this *BinanceCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1310312 := (<-this.LoadMarkets())
			PanicOnError(retRes1310312)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1316312 := (<-this.LoadMarkets())
			PanicOnError(retRes1316312)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1319812 := (<-this.LoadMarkets())
			PanicOnError(retRes1319812)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1323712 := (<-this.LoadMarkets())
			PanicOnError(retRes1323712)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1330812 := (<-this.LoadMarkets())
			PanicOnError(retRes1330812)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1331319 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
			PanicOnError(retRes1331319)
			ch <- retRes1331319
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1337512 := (<-this.LoadMarkets())
			PanicOnError(retRes1337512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		if IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1348212 := (<-this.LoadMarkets())
			PanicOnError(retRes1348212)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1348719 := (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
			PanicOnError(retRes1348719)
			ch <- retRes1348719
			return nil
		}
		var market any = nil
...
func (this *BinanceCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1371912 := (<-this.LoadMarkets())
			PanicOnError(retRes1371912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1375712 := (<-this.LoadMarkets())
			PanicOnError(retRes1375712)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var request any = map[string]any{}
		var market any = nil
...
func (this *BinanceCore) FetchMarginModes(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1389712 := (<-this.LoadMarkets())
...
func (this *BinanceCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1399312 := (<-this.LoadMarkets())
			PanicOnError(retRes1399312)
		}
		var market any = this.Market(symbol)
		var subType any = nil
		subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params)
...
func (this *BinanceCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1405412 := (<-this.LoadMarkets())
			PanicOnError(retRes1405412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1415112 := (<-this.LoadMarkets())
			PanicOnError(retRes1415112)
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BinanceCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1421112 := (<-this.LoadMarkets())
			PanicOnError(retRes1421112)
		}
...
func (this *BinanceCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1427612 := (<-this.LoadMarkets())
			PanicOnError(retRes1427612)
		}
		var request any = map[string]any{
			"fromAsset":  fromCode,
			"toAsset":    toCode,
...
func (this *BinanceCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1431312 := (<-this.LoadMarkets())
			PanicOnError(retRes1431312)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1436012 := (<-this.LoadMarkets())
			PanicOnError(retRes1436012)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1444212 := (<-this.LoadMarkets())
			PanicOnError(retRes1444212)
		}
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1463212 := (<-this.LoadMarkets())
			PanicOnError(retRes1463212)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1468012 := (<-this.LoadMarkets())
			PanicOnError(retRes1468012)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1477812 := (<-this.LoadMarkets())
			PanicOnError(retRes1477812)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchPositionsADLRank(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1481712 := (<-this.LoadMarkets())
			PanicOnError(retRes1481712)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var market any = this.GetMarketFromSymbols(symbols)
		var subType any = nil
