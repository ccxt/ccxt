...
func  (this *BinanceCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes479419 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes479419)
                    ch <- retRes479419
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *BinanceCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes519919 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes519919)
                    ch <- retRes519919
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *BinanceCore) EditContractOrder(id any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes55488 := (<-this.LoadMarkets())
            PanicOnError(retRes55488)
            var market any = this.Market(symbol)
            var isPortfolioMargin any = nil
...
func  (this *BinanceCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes562019 :=  (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
                    PanicOnError(retRes562019)
                    ch <- retRes562019
                    return nil
            } else {
        
                    retRes562219 :=  (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func  (this *BinanceCore) CreateMarketOrderWithCost(symbol any, side any, cost any, optionalArgs ...any) <- chan any {
            ...
            var req any = map[string]any {
                ...
                retRes690315 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func  (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            var req any = map[string]any {
                ...
                retRes692515 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *BinanceCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            AddElementToObject(params, "quoteOrderQty", cost)
                ...
                retRes694515 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func  (this *BinanceCore) FetchOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes706619 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func  (this *BinanceCore) FetchOrderTrades(id any, optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes811515 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes811515)
                ch <- retRes811515
                return nil
...
func  (this *BinanceCore) FetchMyTrades(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes814319 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func  (this *BinanceCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes851319 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *BinanceCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            retRes86228 := (<-this.LoadMarkets())
            PanicOnError(retRes86228)
            var paginate any = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes862619 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes862619)
                    ch <- retRes862619
                    return nil
            }
            var legalMoney any = this.SafeDict(this.Options, "legalMoney", map[string]any {})
...
func  (this *BinanceCore) FetchTransfers(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
                    ...
                    retRes917219 :=  (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
                    PanicOnError(retRes917219)
                    ch <- retRes917219
                    return nil
            }
            var currency any = nil
...
func  (this *BinanceCore) FetchTradingFee(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes96928 := (<-this.LoadMarkets())
            PanicOnError(retRes96928)
            var market any = this.Market(symbol)
...
func  (this *BinanceCore) FetchTradingFees(optionalArgs ...any) <- chan any {
            ...
            retRes97598 := (<-this.LoadMarkets())
            PanicOnError(retRes97598)
            var typeVar any = nil
...
func  (this *BinanceCore) FuturesTransfer(code any, amount any, typeVar any, optionalArgs ...any) <- chan any {
            ...
            retRes99408 := (<-this.LoadMarkets())
            PanicOnError(retRes99408)
            var currency any = this.Currency(code)
            var request any = map[string]any {
                "asset": GetValue(currency, "id"),
                "amount": amount,
...
func  (this *BinanceCore) FetchFundingRate(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes99678 := (<-this.LoadMarkets())
            PanicOnError(retRes99678)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            retRes100148 := (<-this.LoadMarkets())
            PanicOnError(retRes100148)
            var request any = map[string]any {}
            var paginate any = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1001919 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes1001919)
                    ch <- retRes1001919
                    return nil
            }
...
func  (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...any) <- chan any {
            ...
            retRes107008 := (<-this.LoadMarkets())
            PanicOnError(retRes107008)
...
func  (this *BinanceCore) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes108798 := (<-this.LoadMarkets())
            PanicOnError(retRes108798)
            var market any = this.Market(symbol)
            if !IsTrue(GetValue(market, "option")) {
...
func  (this *BinanceCore) FetchPositions(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
                    ...
                    retRes1105919 :=  (<-this.FetchPositionsRisk(symbols, params))
                    PanicOnError(retRes1105919)
                    ch <- retRes1105919
                    return nil
            } else if IsTrue(IsEqual(defaultMethod, "account")) {
        
                    retRes1106119 :=  (<-this.FetchAccountPositions(symbols, params))
                    PanicOnError(retRes1106119)
                    ch <- retRes1106119
                    return nil
            } else if IsTrue(IsEqual(defaultMethod, "option")) {
        
                    retRes1106319 :=  (<-this.FetchOptionPositions(symbols, params))
                    PanicOnError(retRes1106319)
                    ch <- retRes1106319
                    return nil
            } else {
...
func  (this *BinanceCore) FetchAccountPositions(optionalArgs ...any) <- chan any {
            ...
            retRes110938 := (<-this.LoadMarkets())
            PanicOnError(retRes110938)
        
            retRes110948 := (<-this.LoadLeverageBrackets(false, params))
...
func  (this *BinanceCore) FetchPositionsRisk(optionalArgs ...any) <- chan any {
            ...
            retRes112208 := (<-this.LoadMarkets())
            PanicOnError(retRes112208)
        
            retRes112218 := (<-this.LoadLeverageBrackets(false, params))
...
func  (this *BinanceCore) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
            ...
            retRes114598 := (<-this.LoadMarkets())
            PanicOnError(retRes114598)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
                "leverage": leverage,
...
func  (this *BinanceCore) SetMarginMode(marginMode any, optionalArgs ...any) <- chan any {
            ...
            retRes115158 := (<-this.LoadMarkets())
            PanicOnError(retRes115158)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
                "marginType": marginMode,
...
func  (this *BinanceCore) FetchLeverages(optionalArgs ...any) <- chan any {
            ...
            retRes116258 := (<-this.LoadMarkets())
            PanicOnError(retRes116258)
        
            retRes116268 := (<-this.LoadLeverageBrackets(false, params))
...
func  (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...any) <- chan any {
            ...
            retRes117478 := (<-this.LoadMarkets())
            PanicOnError(retRes117478)
            var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
            var typeVar any = nil
...
func  (this *BinanceCore) FetchLedgerEntry(id any, optionalArgs ...any) <- chan any {
            ...
            retRes118868 := (<-this.LoadMarkets())
            PanicOnError(retRes118868)
            var typeVar any = nil
...
func  (this *BinanceCore) FetchLedger(optionalArgs ...any) <- chan any {
            ...
            retRes119348 := (<-this.LoadMarkets())
            PanicOnError(retRes119348)
            var paginate any = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1193819 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
                    PanicOnError(retRes1193819)
                    ch <- retRes1193819
                    return nil
            }
            var typeVar any = nil
...
func  (this *BinanceCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes1250915 :=  (<-this.ModifyMarginHelper(symbol, amount, 2, params))
                PanicOnError(retRes1250915)
                ch <- retRes1250915
                return nil
...
func  (this *BinanceCore) AddMargin(symbol any, amount any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes1252415 :=  (<-this.ModifyMarginHelper(symbol, amount, 1, params))
                PanicOnError(retRes1252415)
                ch <- retRes1252415
                return nil
...
func  (this *BinanceCore) FetchIsolatedBorrowRates(optionalArgs ...any) <- chan any {
            ...
            retRes125918 := (<-this.LoadMarkets())
            PanicOnError(retRes125918)
            var request any = map[string]any {}
            var symbol any = this.SafeString(params, "symbol")
            params = this.Omit(params, "symbol")
            if IsTrue(!IsEqual(symbol, nil)) {
...
func  (this *BinanceCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <- chan any {
            ...
            retRes126368 := (<-this.LoadMarkets())
            PanicOnError(retRes126368)
            if IsTrue(IsEqual(limit, nil)) {
                limit = 93
...
func  (this *BinanceCore) CreateGiftCode(code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes127388 := (<-this.LoadMarkets())
            PanicOnError(retRes127388)
            var currency any = this.Currency(code)
...
func  (this *BinanceCore) FetchBorrowInterest(optionalArgs ...any) <- chan any {
            ...
            retRes128348 := (<-this.LoadMarkets())
            PanicOnError(retRes128348)
            var isPortfolioMargin any = nil
...
func  (this *BinanceCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes129348 := (<-this.LoadMarkets())
            PanicOnError(retRes129348)
            var currency any = this.Currency(code)
            var request any = map[string]any {
                "asset": GetValue(currency, "id"),
                "amount": this.CurrencyToPrecision(code, amount),
...
func  (this *BinanceCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes130628 := (<-this.LoadMarkets())
            PanicOnError(retRes130628)
            var currency any = this.Currency(code)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "asset": GetValue(currency, "id"),
...
func  (this *BinanceCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1313519 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
                    PanicOnError(retRes1313519)
                    ch <- retRes1313519
                    return nil
            }
            var market any = this.Market(symbol)
...
func  (this *BinanceCore) FetchOpenInterest(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes131968 := (<-this.LoadMarkets())
            PanicOnError(retRes131968)
            var market any = this.Market(symbol)
            var request any = map[string]any {}
            if IsTrue(GetValue(market, "option")) {
...
func  (this *BinanceCore) FetchMyLiquidations(optionalArgs ...any) <- chan any {
            ...
            retRes133018 := (<-this.LoadMarkets())
            PanicOnError(retRes133018)
            var paginate any = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1330519 :=  (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
                    PanicOnError(retRes1330519)
                    ch <- retRes1330519
                    return nil
            }
            var market any = nil
...
func  (this *BinanceCore) FetchAllGreeks(optionalArgs ...any) <- chan any {
            ...
            retRes135728 := (<-this.LoadMarkets())
            PanicOnError(retRes135728)
            symbols = this.MarketSymbols(symbols, nil, true, true, true)
            var request any = map[string]any {}
            var market any = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *BinanceCore) FetchMarginMode(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes138048 := (<-this.LoadMarkets())
            PanicOnError(retRes138048)
            var market any = this.Market(symbol)
            var subType any = nil
            subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params);
            subType = GetValue(subTypeparamsVariable,0);
...
func  (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <- chan any {
            ...
            retRes139588 := (<-this.LoadMarkets())
            PanicOnError(retRes139588)
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *BinanceCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <- chan any {
            ...
            retRes140798 := (<-this.LoadMarkets())
            PanicOnError(retRes140798)
            var request any = map[string]any {
                "fromAsset": fromCode,
                "toAsset": toCode,
                "fromAmount": amount,
...
func  (this *BinanceCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <- chan any {
            ...
            retRes141148 := (<-this.LoadMarkets())
            PanicOnError(retRes141148)
            var request any = map[string]any {}
            var response any = nil
...
func  (this *BinanceCore) FetchConvertTrade(id any, optionalArgs ...any) <- chan any {
            ...
            retRes141598 := (<-this.LoadMarkets())
            PanicOnError(retRes141598)
            var request any = map[string]any {}
            var response any = nil
...
func  (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...any) <- chan any {
            ...
            retRes142398 := (<-this.LoadMarkets())
            PanicOnError(retRes142398)
            var request any = map[string]any {}
...
func  (this *BinanceCore) FetchFundingIntervals(optionalArgs ...any) <- chan any {
            ...
            retRes144278 := (<-this.LoadMarkets())
            PanicOnError(retRes144278)
            var market any = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                symbols = this.MarketSymbols(symbols)
                market = this.Market(GetValue(symbols, 0))
...
func  (this *BinanceCore) FetchLongShortRatioHistory(optionalArgs ...any) <- chan any {
            ...
            retRes144738 := (<-this.LoadMarkets())
            PanicOnError(retRes144738)
            var market any = this.Market(symbol)
...
func  (this *BinanceCore) FetchADLRank(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes145698 := (<-this.LoadMarkets())
            PanicOnError(retRes145698)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "symbol": GetValue(market, "id"),
            }
