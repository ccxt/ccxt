...
func  (this *BinanceCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes347612 := (<-this.LoadTimeDifference())
...
func  (this *BinanceCore) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            //    }
            //
            var priceExponent interface{} = this.SafeInteger(response, "priceExponent")
            var qtyExponent interface{} = this.SafeInteger(response, "qtyExponent")
            if IsTrue(IsTrue(!IsEqual(priceExponent, nil)) && IsTrue(!IsEqual(qtyExponent, nil))) {
                var bids interface{} = this.SafeList(response, "bids", response)
                var asks interface{} = this.SafeList(response, "asks", response)
                for i := 0; IsLessThan(i, GetArrayLength(bids)); i++ {
                    AddElementToObject(bids, i, []interface{}{this.ApplyExponent(GetValue(GetValue(bids, i), "price"), priceExponent), this.ApplyExponent(GetValue(GetValue(bids, i), "qty"), qtyExponent)})
                }
                for i := 0; IsLessThan(i, GetArrayLength(asks)); i++ {
                    AddElementToObject(asks, i, []interface{}{this.ApplyExponent(GetValue(GetValue(asks, i), "price"), priceExponent), this.ApplyExponent(GetValue(GetValue(asks, i), "qty"), qtyExponent)})
                }
...
func  (this *BinanceCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes479019 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func  (this *BinanceCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes519519 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
            ...
            var isOption interface{} = this.SafeBool(market, "option", false)
            if !IsTrue(isOption) {
                if IsTrue(!IsEqual(since, nil)) {
                    AddElementToObject(request, "startTime", since)
            ...
            response = (<-this.Request("trades", "public", "GET", this.Extend(request, params), sbeHeaders, nil))
                    PanicOnError(response)
                ...
                var priceExponent interface{} = this.SafeInteger(response, "priceExponent", 0)
                var qtyExponent interface{} = this.SafeInteger(response, "qtyExponent", 0)
                var sbeTradesArray interface{} = this.SafeList(response, "trades", this.SafeList(response, "trade", this.SafeList(response, "Trade", []interface{}{})))
                ...
                if IsTrue(IsGreaterThan(GetArrayLength(sbeTradesArray), 0)) {
                    ...
                    for i := 0; IsLessThan(i, GetArrayLength(sbeTradesArray)); i++ {
                        ...
                        var priceNum interface{} = this.SafeInteger(trade, "price", 0)
                        var qtyNum interface{} = this.SafeInteger(trade, "qty", 0)
                        var quoteQtyNum interface{} = this.SafeInteger(trade, "quoteQty", 0)
                        var idNum interface{} = this.SafeString(trade, "id")
                        var timeNum interface{} = this.SafeInteger(trade, "time", 0)
                        var price interface{} = this.ApplyExponent(priceNum, priceExponent)
                        var qty interface{} = this.ApplyExponent(qtyNum, qtyExponent)
                        var quoteQty interface{} = this.ApplyExponent(quoteQtyNum, priceExponent)
            ...
            //     ]
            //
            var rawTrades interface{} = this.SafeList(response, "trades", response)
            var trades interface{} = this.ParseTrades(rawTrades, market, since, limit)
...
func  (this *BinanceCore) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(market, "spot")) {
                    ...
                    retRes567019 :=  (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
                    PanicOnError(retRes567019)
                    ch <- retRes567019
                    return nil
            } else {
        
                    retRes567219 :=  (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func  (this *BinanceCore) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes693515 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func  (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes695715 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func  (this *BinanceCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "quoteOrderQty", cost)
                ...
                retRes697715 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func  (this *BinanceCore) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes709819 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func  (this *BinanceCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes814015 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func  (this *BinanceCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes816819 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func  (this *BinanceCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes853819 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *BinanceCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes865119 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes865119)
                    ch <- retRes865119
                    return nil
            }
            var legalMoney interface{} = this.SafeDict(this.Options, "legalMoney", map[string]interface{} {})
...
func  (this *BinanceCore) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91908 := (<-this.LoadMarkets())
            PanicOnError(retRes91908)
            ...
            if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
                    ...
                    retRes919619 :=  (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
                    PanicOnError(retRes919619)
                    ch <- retRes919619
                    return nil
            }
            var currency interface{}
...
func  (this *BinanceCore) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes93318 := (<-this.LoadMarkets())
            PanicOnError(retRes93318)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *BinanceCore) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97198 := (<-this.LoadMarkets())
            PanicOnError(retRes97198)
            var market interface{} = this.Market(symbol)
...
func  (this *BinanceCore) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97868 := (<-this.LoadMarkets())
            PanicOnError(retRes97868)
            var typeVar interface{}
...
func  (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100418 := (<-this.LoadMarkets())
            PanicOnError(retRes100418)
            var request interface{} = map[string]interface{} {}
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1004619 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes1004619)
                    ch <- retRes1004619
                    return nil
            }
...
func  (this *BinanceCore) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes101198 := (<-this.LoadMarkets())
            PanicOnError(retRes101198)
            symbols = this.MarketSymbols(symbols)
...
func  (this *BinanceCore) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes107898 := (<-this.LoadMarkets())
            PanicOnError(retRes107898)
            var typeVar interface{}
...
func  (this *BinanceCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109068 := (<-this.LoadMarkets())
            PanicOnError(retRes109068)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "option")) {
...
func  (this *BinanceCore) FetchOptionPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109518 := (<-this.LoadMarkets())
            PanicOnError(retRes109518)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            var market interface{}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *BinanceCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
                    ...
                    retRes1108619 :=  (<-this.FetchPositionsRisk(symbols, params))
                    PanicOnError(retRes1108619)
                    ch <- retRes1108619
                    return nil
            } else if IsTrue(IsEqual(defaultMethod, "account")) {
        
                    retRes1108819 :=  (<-this.FetchAccountPositions(symbols, params))
                    PanicOnError(retRes1108819)
                    ch <- retRes1108819
                    return nil
            } else if IsTrue(IsEqual(defaultMethod, "option")) {
        
                    retRes1109019 :=  (<-this.FetchOptionPositions(symbols, params))
                    PanicOnError(retRes1109019)
                    ch <- retRes1109019
                    return nil
            } else {
...
func  (this *BinanceCore) FetchAccountPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes111218 := (<-this.LoadLeverageBrackets(false, params))
            PanicOnError(retRes111218)
            var defaultType interface{} = this.SafeString(this.Options, "defaultType", "future")
            var typeVar interface{} = this.SafeString(params, "type", defaultType)
            params = this.Omit(params, "type")
            var subType interface{}
...
func  (this *BinanceCore) FetchPositionsRisk(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112478 := (<-this.LoadMarkets())
            PanicOnError(retRes112478)
        
            retRes112488 := (<-this.LoadLeverageBrackets(false, params))
            PanicOnError(retRes112488)
            var request interface{} = map[string]interface{} {}
...
func  (this *BinanceCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes115428 := (<-this.LoadMarkets())
            PanicOnError(retRes115428)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "marginType": marginMode,
...
func  (this *BinanceCore) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116528 := (<-this.LoadMarkets())
            PanicOnError(retRes116528)
        
            retRes116538 := (<-this.LoadLeverageBrackets(false, params))
            PanicOnError(retRes116538)
            var typeVar interface{}
...
func  (this *BinanceCore) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117278 := (<-this.LoadMarkets())
            PanicOnError(retRes117278)
...
func  (this *BinanceCore) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes119618 := (<-this.LoadMarkets())
            PanicOnError(retRes119618)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1196519 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
...
func  (this *BinanceCore) GetSbeDecoderRegistry() interface{}  {
    ...
    return map[string]interface{} {
        "50": nil, // WebSocketResponseDecoder - TODO: implement SBE decoding
        "51": nil, // WebSocketSessionLogonResponseDecoder - TODO: implement SBE decoding
        "52": nil, // WebSocketSessionStatusResponseDecoder - TODO: implement SBE decoding
        "53": nil, // WebSocketSessionLogoutResponseDecoder - TODO: implement SBE decoding
        "54": nil, // WebSocketSessionSubscriptionsResponseDecoder - TODO: implement SBE decoding
        "100": nil, // ErrorResponseDecoder - TODO: implement SBE decoding
        "101": nil, // PingResponseDecoder - TODO: implement SBE decoding
        "102": nil, // ServerTimeResponseDecoder - TODO: implement SBE decoding
        "103": nil, // ExchangeInfoResponseDecoder - TODO: implement SBE decoding
        "105": nil, // MyFiltersResponseDecoder - TODO: implement SBE decoding
        "200": nil, // DepthResponseDecoder - TODO: implement SBE decoding
        "201": nil, // TradesResponseDecoder - TODO: implement SBE decoding
        "202": nil, // AggTradesResponseDecoder - TODO: implement SBE decoding
        "203": nil, // KlinesResponseDecoder - TODO: implement SBE decoding
        "204": nil, // AveragePriceResponseDecoder - TODO: implement SBE decoding
        "205": nil, // Ticker24hSymbolFullResponseDecoder - TODO: implement SBE decoding
        "206": nil, // Ticker24hFullResponseDecoder - TODO: implement SBE decoding
        "207": nil, // Ticker24hSymbolMiniResponseDecoder - TODO: implement SBE decoding
        "208": nil, // Ticker24hMiniResponseDecoder - TODO: implement SBE decoding
        "209": nil, // PriceTickerSymbolResponseDecoder - TODO: implement SBE decoding
        "210": nil, // PriceTickerResponseDecoder - TODO: implement SBE decoding
        "211": nil, // BookTickerSymbolResponseDecoder - TODO: implement SBE decoding
        "212": nil, // BookTickerResponseDecoder - TODO: implement SBE decoding
        "213": nil, // TickerSymbolFullResponseDecoder - TODO: implement SBE decoding
        "214": nil, // TickerFullResponseDecoder - TODO: implement SBE decoding
        "215": nil, // TickerSymbolMiniResponseDecoder - TODO: implement SBE decoding
        "216": nil, // TickerMiniResponseDecoder - TODO: implement SBE decoding
        "300": nil, // NewOrderAckResponseDecoder - TODO: implement SBE decoding
        "301": nil, // NewOrderResultResponseDecoder - TODO: implement SBE decoding
        "302": nil, // NewOrderFullResponseDecoder - TODO: implement SBE decoding
        "303": nil, // OrderTestResponseDecoder - TODO: implement SBE decoding
        "304": nil, // OrderResponseDecoder - TODO: implement SBE decoding
        "305": nil, // CancelOrderResponseDecoder - TODO: implement SBE decoding
        "306": nil, // CancelOpenOrdersResponseDecoder - TODO: implement SBE decoding
        "307": nil, // CancelReplaceOrderResponseDecoder - TODO: implement SBE decoding
        "308": nil, // OrdersResponseDecoder - TODO: implement SBE decoding
        "309": nil, // NewOrderListAckResponseDecoder - TODO: implement SBE decoding
        "310": nil, // NewOrderListResultResponseDecoder - TODO: implement SBE decoding
        "311": nil, // NewOrderListFullResponseDecoder - TODO: implement SBE decoding
        "312": nil, // CancelOrderListResponseDecoder - TODO: implement SBE decoding
        "313": nil, // OrderListResponseDecoder - TODO: implement SBE decoding
        "314": nil, // OrderListsResponseDecoder - TODO: implement SBE decoding
        "315": nil, // OrderTestWithCommissionsResponseDecoder - TODO: implement SBE decoding
        "316": nil, // OrderAmendmentsResponseDecoder - TODO: implement SBE decoding
        "317": nil, // OrderAmendKeepPriorityResponseDecoder - TODO: implement SBE decoding
        "400": nil, // AccountResponseDecoder - TODO: implement SBE decoding
        "401": nil, // AccountTradesResponseDecoder - TODO: implement SBE decoding
        "402": nil, // AccountOrderRateLimitResponseDecoder - TODO: implement SBE decoding
        "403": nil, // AccountPreventedMatchesResponseDecoder - TODO: implement SBE decoding
        "404": nil, // AccountAllocationsResponseDecoder - TODO: implement SBE decoding
        "405": nil, // AccountCommissionResponseDecoder - TODO: implement SBE decoding
        "500": nil, // UserDataStreamStartResponseDecoder - TODO: implement SBE decoding
        "501": nil, // UserDataStreamPingResponseDecoder - TODO: implement SBE decoding
        "502": nil, // UserDataStreamStopResponseDecoder - TODO: implement SBE decoding
        "503": nil, // UserDataStreamSubscribeResponseDecoder - TODO: implement SBE decoding
        "504": nil, // UserDataStreamUnsubscribeResponseDecoder - TODO: implement SBE decoding
        "505": nil, // UserDataStreamSubscribeListenTokenResponseDecoder - TODO: implement SBE decoding
    }
}
func  (this *BinanceCore) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    _ = body
    var result interface{} = this.HandleOptionAndParams(params, "sign", "useSbe", false)
...
func  (this *BinanceCore) ModifyMarginHelper(symbol interface{}, amount interface{}, addOrReduce interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes125428 := (<-this.LoadMarkets())
            PanicOnError(retRes125428)
            var market interface{} = this.Market(symbol)
...
func  (this *BinanceCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes1262915 :=  (<-this.ModifyMarginHelper(symbol, amount, 2, params))
                PanicOnError(retRes1262915)
                ch <- retRes1262915
                return nil
...
func  (this *BinanceCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes1264415 :=  (<-this.ModifyMarginHelper(symbol, amount, 1, params))
                PanicOnError(retRes1264415)
                ch <- retRes1264415
                return nil
...
func  (this *BinanceCore) FetchIsolatedBorrowRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes127118 := (<-this.LoadMarkets())
            PanicOnError(retRes127118)
            var request interface{} = map[string]interface{} {}
            var symbol interface{} = this.SafeString(params, "symbol")
            params = this.Omit(params, "symbol")
            if IsTrue(!IsEqual(symbol, nil)) {
...
func  (this *BinanceCore) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes129548 := (<-this.LoadMarkets())
            PanicOnError(retRes129548)
            var isPortfolioMargin interface{}
...
func  (this *BinanceCore) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131128 := (<-this.LoadMarkets())
            PanicOnError(retRes131128)
            var currency interface{} = this.Currency(code)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
...
func  (this *BinanceCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131458 := (<-this.LoadMarkets())
            PanicOnError(retRes131458)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "amount": this.CurrencyToPrecision(code, amount),
...
func  (this *BinanceCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131828 := (<-this.LoadMarkets())
            PanicOnError(retRes131828)
            var currency interface{} = this.Currency(code)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
...
func  (this *BinanceCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes132518 := (<-this.LoadMarkets())
            PanicOnError(retRes132518)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1325519 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
                    PanicOnError(retRes1325519)
                    ch <- retRes1325519
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *BinanceCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133168 := (<-this.LoadMarkets())
            PanicOnError(retRes133168)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            if IsTrue(GetValue(market, "option")) {
...
func  (this *BinanceCore) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes134218 := (<-this.LoadMarkets())
            PanicOnError(retRes134218)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes1342519 :=  (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
                    PanicOnError(retRes1342519)
                    ch <- retRes1342519
                    return nil
            }
            var market interface{}
...
func  (this *BinanceCore) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes136568 := (<-this.LoadMarkets())
            PanicOnError(retRes136568)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *BinanceCore) FetchAllGreeks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes136928 := (<-this.LoadMarkets())
            PanicOnError(retRes136928)
            symbols = this.MarketSymbols(symbols, nil, true, true, true)
            var request interface{} = map[string]interface{} {}
            var market interface{}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *BinanceCore) FetchMarginModes(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes138308 := (<-this.LoadMarkets())
            PanicOnError(retRes138308)
            var market interface{}
            if IsTrue(!IsEqual(symbols, nil)) {
                symbols = this.MarketSymbols(symbols)
                market = this.Market(GetValue(symbols, 0))
...
func  (this *BinanceCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes139248 := (<-this.LoadMarkets())
            PanicOnError(retRes139248)
            var market interface{} = this.Market(symbol)
            var subType interface{}
            subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params);
            subType = GetValue(subTypeparamsVariable,0);
...
func  (this *BinanceCore) FetchOption(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes139838 := (<-this.LoadMarkets())
            PanicOnError(retRes139838)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes140788 := (<-this.LoadMarkets())
            PanicOnError(retRes140788)
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *BinanceCore) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141368 := (<-this.LoadMarkets())
            PanicOnError(retRes141368)
...
func  (this *BinanceCore) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141998 := (<-this.LoadMarkets())
            PanicOnError(retRes141998)
            var request interface{} = map[string]interface{} {
                "fromAsset": fromCode,
                "toAsset": toCode,
                "fromAmount": amount,
...
func  (this *BinanceCore) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes142798 := (<-this.LoadMarkets())
            PanicOnError(retRes142798)
            var request interface{} = map[string]interface{} {}
            var response interface{}
...
func  (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes143598 := (<-this.LoadMarkets())
            PanicOnError(retRes143598)
            var request interface{} = map[string]interface{} {}
            ...
            params = this.Omit(params, "until")
            var response interface{}
            var responseQuery interface{}
            var fromCurrencyKey interface{}
            var toCurrencyKey interface{}
            if IsTrue(IsEqual(code, "BUSD")) {
                var currency interface{} = this.Currency(code)
                AddElementToObject(request, "asset", GetValue(currency, "id"))
                if IsTrue(!IsEqual(limit, nil)) {
...
func  (this *BinanceCore) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes145938 := (<-this.LoadMarkets())
            PanicOnError(retRes145938)
            var market interface{} = this.Market(symbol)
...
func  (this *BinanceCore) FetchPositionsADLRank(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes147268 := (<-this.LoadMarkets())
            PanicOnError(retRes147268)
            symbols = this.MarketSymbols(symbols, nil, true, true, true)
            var market interface{} = this.GetMarketFromSymbols(symbols)
            var subType interface{}
