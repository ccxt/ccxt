...
func (this *BinanceCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes340012 := (<-this.LoadTimeDifference())
...
func (this *BinanceCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes468419 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *BinanceCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes508919 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *BinanceCore) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes551119 := (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes551119)
			ch <- retRes551119
			return nil
		} else {

			retRes551319 := (<-this.EditContractOrder(id, symbol, typeVar, side, amount, price, params))
...
func (this *BinanceCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes62468 := (<-this.LoadMarkets())
		PanicOnError(retRes62468)
		var ordersRequests interface{} = []interface{}{}
		var orderSymbols interface{} = []interface{}{}
		for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
			var rawOrder interface{} = GetValue(orders, i)
...
func (this *BinanceCore) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes677515 := (<-this.CreateOrder(symbol, "market", side, cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes679715 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, this.Extend(req, params)))
...
func (this *BinanceCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes681715 := (<-this.CreateOrder(symbol, "market", "sell", cost, nil, params))
...
func (this *BinanceCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes68448 := (<-this.LoadMarkets())
		PanicOnError(retRes68448)
		var market interface{} = this.Market(symbol)
...
func (this *BinanceCore) FetchOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes693819 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
...
func (this *BinanceCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes798015 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes798015)
		ch <- retRes798015
		return nil
...
func (this *BinanceCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes800819 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func (this *BinanceCore) FetchDeposits(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes837819 := (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func (this *BinanceCore) FetchWithdrawals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes849119 := (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
			PanicOnError(retRes849119)
			ch <- retRes849119
			return nil
		}
		var legalMoney interface{} = this.SafeDict(this.Options, "legalMoney", map[string]interface{}{})
...
func (this *BinanceCore) FetchTransfers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
			...
			retRes903619 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
			PanicOnError(retRes903619)
			ch <- retRes903619
			return nil
		}
		var currency interface{} = nil
...
func (this *BinanceCore) FetchTradingFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes96268 := (<-this.LoadMarkets())
		PanicOnError(retRes96268)
		var typeVar interface{} = nil
...
func (this *BinanceCore) FuturesTransfer(code interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes98078 := (<-this.LoadMarkets())
		PanicOnError(retRes98078)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"asset":  GetValue(currency, "id"),
			"amount": amount,
...
func (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes98818 := (<-this.LoadMarkets())
		PanicOnError(retRes98818)
		var request interface{} = map[string]interface{}{}
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes988619 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func (this *BinanceCore) FetchFundingRates(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes99598 := (<-this.LoadMarkets())
		PanicOnError(retRes99598)
		symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes105678 := (<-this.LoadMarkets())
		PanicOnError(retRes105678)
...
func (this *BinanceCore) FetchOptionPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes107918 := (<-this.LoadMarkets())
		PanicOnError(retRes107918)
		symbols = this.MarketSymbols(symbols)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *BinanceCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
			...
			retRes1092619 := (<-this.FetchPositionsRisk(symbols, params))
			PanicOnError(retRes1092619)
			ch <- retRes1092619
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "account")) {

			retRes1092819 := (<-this.FetchAccountPositions(symbols, params))
			PanicOnError(retRes1092819)
			ch <- retRes1092819
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "option")) {

			retRes1093019 := (<-this.FetchOptionPositions(symbols, params))
...
func (this *BinanceCore) FetchPositionsRisk(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes110878 := (<-this.LoadMarkets())
		PanicOnError(retRes110878)

		retRes110888 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes110888)
		var request interface{} = map[string]interface{}{}
...
func (this *BinanceCore) FetchLeverages(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes114928 := (<-this.LoadMarkets())
		PanicOnError(retRes114928)

		retRes114938 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes114938)
		var typeVar interface{} = nil
...
func (this *BinanceCore) FetchSettlementHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes115678 := (<-this.LoadMarkets())
		PanicOnError(retRes115678)
...
func (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes116148 := (<-this.LoadMarkets())
		PanicOnError(retRes116148)
		var market interface{} = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
		var typeVar interface{} = nil
...
func (this *BinanceCore) FetchLedgerEntry(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes117538 := (<-this.LoadMarkets())
		PanicOnError(retRes117538)
		var typeVar interface{} = nil
...
func (this *BinanceCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes118018 := (<-this.LoadMarkets())
		PanicOnError(retRes118018)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes1180519 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
			PanicOnError(retRes1180519)
			ch <- retRes1180519
			return nil
		}
		var typeVar interface{} = nil
...
func (this *BinanceCore) ModifyMarginHelper(symbol interface{}, amount interface{}, addOrReduce interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes122898 := (<-this.LoadMarkets())
		PanicOnError(retRes122898)
		var market interface{} = this.Market(symbol)
...
func (this *BinanceCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes1237615 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
		PanicOnError(retRes1237615)
		ch <- retRes1237615
		return nil
...
func (this *BinanceCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes1239115 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes1239115)
		ch <- retRes1239115
		return nil
...
func (this *BinanceCore) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes124048 := (<-this.LoadMarkets())
		PanicOnError(retRes124048)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"asset": GetValue(currency, "id"),
		}
...
func (this *BinanceCore) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes125038 := (<-this.LoadMarkets())
		PanicOnError(retRes125038)
		if IsTrue(IsEqual(limit, nil)) {
			limit = 93
...
func (this *BinanceCore) CreateGiftCode(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes126058 := (<-this.LoadMarkets())
		PanicOnError(retRes126058)
		var currency interface{} = this.Currency(code)
...
func (this *BinanceCore) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes128018 := (<-this.LoadMarkets())
		PanicOnError(retRes128018)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"asset":  GetValue(currency, "id"),
			"amount": this.CurrencyToPrecision(code, amount),
...
func (this *BinanceCore) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes128598 := (<-this.LoadMarkets())
		PanicOnError(retRes128598)
		var currency interface{} = this.Currency(code)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"asset":      GetValue(currency, "id"),
...
func (this *BinanceCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes128928 := (<-this.LoadMarkets())
		PanicOnError(retRes128928)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"asset":  GetValue(currency, "id"),
			"amount": this.CurrencyToPrecision(code, amount),
...
func (this *BinanceCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes1300219 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
			PanicOnError(retRes1300219)
			ch <- retRes1300219
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *BinanceCore) FetchMyLiquidations(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes131688 := (<-this.LoadMarkets())
		PanicOnError(retRes131688)
		var paginate interface{} = false
		...
		if IsTrue(paginate) {
			...
			retRes1317219 := (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
			PanicOnError(retRes1317219)
			ch <- retRes1317219
			return nil
		}
		var market interface{} = nil
...
func (this *BinanceCore) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes134038 := (<-this.LoadMarkets())
		PanicOnError(retRes134038)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *BinanceCore) FetchAllGreeks(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes134398 := (<-this.LoadMarkets())
		PanicOnError(retRes134398)
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var request interface{} = map[string]interface{}{}
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *BinanceCore) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes136718 := (<-this.LoadMarkets())
		PanicOnError(retRes136718)
		var market interface{} = this.Market(symbol)
		var subType interface{} = nil
		subTypeparamsVariable := this.HandleSubTypeAndParams("fetchMarginMode", market, params)
		subType = GetValue(subTypeparamsVariable, 0)
...
func (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes138258 := (<-this.LoadMarkets())
		PanicOnError(retRes138258)
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BinanceCore) FetchConvertCurrencies(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes138838 := (<-this.LoadMarkets())
		PanicOnError(retRes138838)
...
func (this *BinanceCore) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes140268 := (<-this.LoadMarkets())
		PanicOnError(retRes140268)
		var request interface{} = map[string]interface{}{}
		var response interface{} = nil
...
func (this *BinanceCore) FetchFundingIntervals(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes142948 := (<-this.LoadMarkets())
		PanicOnError(retRes142948)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
			market = this.Market(GetValue(symbols, 0))
