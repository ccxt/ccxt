...
func (this *BinanceCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsTrue(paginate) && !IsTrue(internal)) {
			...
			retRes928219 := (<-this.FetchPaginatedCallDynamic("fetchTransfers", code, since, limit, params))
			PanicOnError(retRes928219)
			ch <- retRes928219
			return nil
		}
		var currency any = nil
...
func (this *BinanceCore) Withdraw(code any, amount any, address any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes974112 := (<-this.LoadMarkets())
			PanicOnError(retRes974112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":    GetValue(currency, "id"),
...
func (this *BinanceCore) FetchTradingFee(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes981112 := (<-this.LoadMarkets())
			PanicOnError(retRes981112)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchTradingFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes988012 := (<-this.LoadMarkets())
			PanicOnError(retRes988012)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FuturesTransfer(code any, amount any, typeVar any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1006312 := (<-this.LoadMarkets())
			PanicOnError(retRes1006312)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) FetchFundingRate(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1009212 := (<-this.LoadMarkets())
			PanicOnError(retRes1009212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1014112 := (<-this.LoadMarkets())
			PanicOnError(retRes1014112)
		}
		var request any = map[string]any{}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1014719 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes1014719)
			ch <- retRes1014719
			return nil
		}
...
func (this *BinanceCore) FetchFundingRates(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1022112 := (<-this.LoadMarkets())
			PanicOnError(retRes1022112)
		}
		symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) LoadLeverageBrackets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1083112 := (<-this.LoadMarkets())
			PanicOnError(retRes1083112)
		}
...
func (this *BinanceCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1089512 := (<-this.LoadMarkets())
...
func (this *BinanceCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1101412 := (<-this.LoadMarkets())
			PanicOnError(retRes1101412)
		}
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(defaultMethod, "positionRisk")) {
			...
			retRes1120019 := (<-this.FetchPositionsRisk(symbols, params))
			PanicOnError(retRes1120019)
			ch <- retRes1120019
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "account")) {

			retRes1120219 := (<-this.FetchAccountPositions(symbols, params))
			PanicOnError(retRes1120219)
			ch <- retRes1120219
			return nil
		} else if IsTrue(IsEqual(defaultMethod, "option")) {

			retRes1120419 := (<-this.FetchOptionPositions(symbols, params))
...
func (this *BinanceCore) FetchAccountPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1123512 := (<-this.LoadMarkets())
			PanicOnError(retRes1123512)
		}

		retRes112378 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes112378)
		var defaultType any = this.SafeString(this.Options, "defaultType", "future")
		var typeVar any = this.SafeString(params, "type", defaultType)
		params = this.Omit(params, "type")
		var subType any = nil
...
func (this *BinanceCore) FetchPositionsRisk(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1136412 := (<-this.LoadMarkets())
			PanicOnError(retRes1136412)
		}

		retRes113668 := (<-this.LoadLeverageBrackets(false, params))
...
func (this *BinanceCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1153712 := (<-this.LoadMarkets())
			PanicOnError(retRes1153712)
		}
		var market any = nil
		var request any = map[string]any{
			"incomeType": "FUNDING_FEE",
...
func (this *BinanceCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1160712 := (<-this.LoadMarkets())
			PanicOnError(retRes1160712)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":   GetValue(market, "id"),
...
func (this *BinanceCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1166512 := (<-this.LoadMarkets())
			PanicOnError(retRes1166512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol":     GetValue(market, "id"),
...
func (this *BinanceCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1177712 := (<-this.LoadMarkets())
			PanicOnError(retRes1177712)
		}

		retRes117798 := (<-this.LoadLeverageBrackets(false, params))
		PanicOnError(retRes117798)
		var typeVar any = nil
...
func (this *BinanceCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1185412 := (<-this.LoadMarkets())
			PanicOnError(retRes1185412)
		}
...
func (this *BinanceCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1190312 := (<-this.LoadMarkets())
			PanicOnError(retRes1190312)
		}
		var market any = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedgerEntry(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1204412 := (<-this.LoadMarkets())
			PanicOnError(retRes1204412)
		}
		var typeVar any = nil
...
func (this *BinanceCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1209412 := (<-this.LoadMarkets())
			PanicOnError(retRes1209412)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1209919 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, nil, false))
			PanicOnError(retRes1209919)
			ch <- retRes1209919
			return nil
		}
		var typeVar any = nil
...
func (this *BinanceCore) ModifyMarginHelper(symbol any, amount any, addOrReduce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1258412 := (<-this.LoadMarkets())
			PanicOnError(retRes1258412)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) ReduceMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1267215 := (<-this.ModifyMarginHelper(symbol, amount, 2, params))
		PanicOnError(retRes1267215)
		ch <- retRes1267215
		return nil
...
func (this *BinanceCore) AddMargin(symbol any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes1268715 := (<-this.ModifyMarginHelper(symbol, amount, 1, params))
		PanicOnError(retRes1268715)
		ch <- retRes1268715
		return nil
...
func (this *BinanceCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1270112 := (<-this.LoadMarkets())
			PanicOnError(retRes1270112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset": GetValue(currency, "id"),
...
func (this *BinanceCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1280412 := (<-this.LoadMarkets())
			PanicOnError(retRes1280412)
		}
		if IsTrue(IsEqual(limit, nil)) {
			limit = 93
...
func (this *BinanceCore) CreateGiftCode(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1290812 := (<-this.LoadMarkets())
			PanicOnError(retRes1290812)
		}
		var currency any = this.Currency(code)
...
func (this *BinanceCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1300612 := (<-this.LoadMarkets())
			PanicOnError(retRes1300612)
		}
		var isPortfolioMargin any = nil
...
func (this *BinanceCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1310812 := (<-this.LoadMarkets())
			PanicOnError(retRes1310812)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1316812 := (<-this.LoadMarkets())
			PanicOnError(retRes1316812)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1320312 := (<-this.LoadMarkets())
			PanicOnError(retRes1320312)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"asset":  GetValue(currency, "id"),
...
func (this *BinanceCore) BorrowIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1324212 := (<-this.LoadMarkets())
			PanicOnError(retRes1324212)
		}
		var currency any = this.Currency(code)
		var market any = this.Market(symbol)
		var request any = map[string]any{
...
func (this *BinanceCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1331312 := (<-this.LoadMarkets())
			PanicOnError(retRes1331312)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1331819 := (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 500))
			PanicOnError(retRes1331819)
			ch <- retRes1331819
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1338012 := (<-this.LoadMarkets())
			PanicOnError(retRes1338012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{}
		if IsTrue(GetValue(market, "option")) {
...
func (this *BinanceCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1348712 := (<-this.LoadMarkets())
			PanicOnError(retRes1348712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes1349219 := (<-this.FetchPaginatedCallIncremental("fetchMyLiquidations", symbol, since, limit, params, "current", 100))
			PanicOnError(retRes1349219)
			ch <- retRes1349219
			return nil
		}
		var market any = nil
...
func (this *BinanceCore) FetchGreeks(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1372412 := (<-this.LoadMarkets())
			PanicOnError(retRes1372412)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchMarginModes(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1390212 := (<-this.LoadMarkets())
			PanicOnError(retRes1390212)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchMarginAdjustmentHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1415612 := (<-this.LoadMarkets())
			PanicOnError(retRes1415612)
		}
		if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BinanceCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1421612 := (<-this.LoadMarkets())
			PanicOnError(retRes1421612)
		}
...
func (this *BinanceCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1428112 := (<-this.LoadMarkets())
			PanicOnError(retRes1428112)
		}
		var request any = map[string]any{
			"fromAsset":  fromCode,
			"toAsset":    toCode,
...
func (this *BinanceCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1431812 := (<-this.LoadMarkets())
			PanicOnError(retRes1431812)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1436512 := (<-this.LoadMarkets())
			PanicOnError(retRes1436512)
		}
		var request any = map[string]any{}
		var response any = nil
...
func (this *BinanceCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1444712 := (<-this.LoadMarkets())
			PanicOnError(retRes1444712)
		}
		var request any = map[string]any{}
...
func (this *BinanceCore) FetchFundingIntervals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1463712 := (<-this.LoadMarkets())
			PanicOnError(retRes1463712)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			symbols = this.MarketSymbols(symbols)
...
func (this *BinanceCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1468512 := (<-this.LoadMarkets())
			PanicOnError(retRes1468512)
		}
		var market any = this.Market(symbol)
...
func (this *BinanceCore) FetchADLRank(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1478312 := (<-this.LoadMarkets())
			PanicOnError(retRes1478312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BinanceCore) FetchPositionsADLRank(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes1482212 := (<-this.LoadMarkets())
			PanicOnError(retRes1482212)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
		var market any = this.GetMarketFromSymbols(symbols)
		var subType any = nil
