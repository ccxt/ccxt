 ...
 * @param {boolean} [params.paginate] default false, when true will automatically paginate by calling this endpoint multiple times. See in the docs all the [availble parameters](https://github.com/mtan11/ccxt/wiki/Manual#pagination-params)
...
func  (this *HtxCore) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = GetValue(typeVarparamsVariable,1)
            var subType interface{} = nil
            var isUnifiedAccount interface{} = nil
            var isMultiAssetMode interface{} = nil
            ...
            if IsTrue(IsTrue((IsEqual(orderType, "market"))) && IsTrue((IsEqual(side, "buy")))) {
                ...
                if IsTrue(!IsEqual(cost, nil)) {
                    ...
                    if IsTrue(IsEqual(price, nil)) {
                        ...
                        // more about it here:
                        // https://github.com/mtan11/ccxt/pull/4395
                        // https://github.com/mtan11/ccxt/issues/7611
...
func  (this *HtxCore) Sign(path interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    "hostname": this.Hostname,
        ...
        if IsTrue(IsEqual(access, "public")) {
            ...
            // sorting needs such flow exactly, before urlencoding (more at: https://github.com/mtan11/ccxt/issues/24930 )
 ...
 * @param {object} [params] extra parameters specific to the exchange API endpoint
 * @param {int} [params.until] the latest time in ms to fetch entries for
 * @param {boolean} [params.paginate] default false, when true will automatically paginate by calling this endpoint multiple times. See in the docs all the [available parameters](https://github.com/mtan11/ccxt/wiki/Manual#pagination-params)
 ...
 */
func  (this *HtxCore) FetchPositionsADLRank(optionalArgs ...interface{}) <- chan interface{} {
            ch := make(chan interface{})
            go func() interface{} {
                defer close(ch)
                defer ReturnPanicError(ch)
...
func  (this *HtxCore) ParseADLRank(info interface{}, optionalArgs ...interface{}) interface{}  {
    //
