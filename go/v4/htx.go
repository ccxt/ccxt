...
func (this *Htx) ParseCurrency(rawCurrency any) any {
	...
	var typeVar string = Ternary((assetType != nil && *assetType == "1"), "crypto", "fiat").(string)
	if code != nil {
...
func (this *Htx) fetchContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var isAlgo bool = ((trigger != nil && *trigger == true) || (stopLoss != nil && *stopLoss == true) || (takeProfit != nil && *takeProfit == true) || (IsEqual(stopLossTakeProfit, true)) || (trailing != nil && *trailing == true))
	params = this.Omit(params, []any{"stop", "stopLossTakeProfit", "trailing", "trigger", "stopLoss", "takeProfit"})
	if !IsEqual(since, nil) {
		AddElementToObject(request, "start_time", since)
	}
...
func (this *Htx) createSpotOrderRequestBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if triggerPrice == nil {
		...
		var defaultOperator string = Ternary((IsEqual(side, "sell")), "lte", "gte").(string)
...
func (this *Htx) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	//     }
	//
	if (IsEqual(this.SafeBool(market, "linear"), true)) && (trigger == nil || *trigger != true) && (!IsEqual(stopLossTakeProfit, true)) {
...
func (this *Htx) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		//     }
		//
		if (IsEqual(this.SafeBool(market, "linear"), true)) && ((trigger == nil || *trigger != true) && (trailing == nil || *trailing != true) && (!IsEqual(stopLossTakeProfit, true))) {
...
func (this *Htx) ParseBorrowInterest(info any, optionalArgs ...any) any {
	...
	_ = market
	var marketId *string = this.SafeString(info, "symbol")
	var marginMode string = Ternary((marketId == nil), "cross", "isolated").(string)
...
func (this *Htx) ParsePosition(position any, optionalArgs ...any) any {
	...
	var directionSide string = Ternary((rawSide != nil && *rawSide == "buy"), "long", "short").(string)
...
func (this *Htx) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	var posMode string = Ternary(EvalTruthy(hedged), "dual_side", "single_side").(string)
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
	}
