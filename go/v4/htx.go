...
func (this *Htx) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes733812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes733812)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
		"contract_code": market["id"],
...
func (this *Htx) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes740512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes740512)
	}
	symbols = this.MarketSymbols(symbols)
...
func (this *Htx) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes746512 := (<-this.LoadMarketsAsync())
...
func (this *Htx) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes779012 := (<-this.LoadMarketsAsync())
...
func (this *Htx) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes788612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes788612)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Htx) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes828612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes828612)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var marginMode any = nil
...
func (this *Htx) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes852312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes852312)
	}
	var paginate any = false
	...
	if paginate == true {
		...
		retRes852819 := (<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params, 500))
		PanicOnError(retRes852819)
		ch <- retRes852819
		return nil
	}
...
func (this *Htx) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes860012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes860012)
	}
...
func (this *Htx) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes868412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes868412)
	}
...
func (this *Htx) fetchOpenInterestsBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes879512 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes879512)
	}
	symbols = this.MarketSymbols(symbols)
	var market any = nil
	if symbols != nil {
...
func (this *Htx) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes887112 := (<-this.LoadMarketsAsync())
...
func (this *Htx) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes904412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes904412)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var market map[string]any = MapTyped(this.Market(symbol))
	var request map[string]any = map[string]any{
...
func (this *Htx) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes908112 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes908112)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
	var request map[string]any = map[string]any{
		"currency": currency["id"],
...
func (this *Htx) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes911612 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes911612)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
...
func (this *Htx) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes915812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes915812)
	}
	var currency map[string]any = MapTyped(this.Currency(code))
...
func (this *Htx) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes936012 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes936012)
	}
...
func (this *Htx) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes960812 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes960812)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Htx) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes975412 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes975412)
	}
	var market map[string]any = MapTyped(this.Market(symbol))
	var clientOrderId *string = this.SafeString(params, "clientOrderId")
	if GetValue(market, "contract") != true {
...
func (this *Htx) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes982312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes982312)
	}
...
func (this *Htx) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	if this.Markets == nil {
		...
		retRes986312 := (<-this.LoadMarketsAsync())
		PanicOnError(retRes986312)
	}
