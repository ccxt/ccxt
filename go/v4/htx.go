...
func (this *Htx) fetchStatusBody(ch chan any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "spot" {
		...
		response = (<-this.SpotPublicGetV2MarketStatus(params)).Raw
		...
		var subTypeparamsVariable []any = this.HandleSubTypeAndParams("fetchStatus", nil, params)
		subType = SafeStringPtr(GetValue(subTypeparamsVariable, 0))
		params = MapTyped(GetValue(subTypeparamsVariable, 1))

		response = (<-this.ContractPublicGetHeartbeat(params)).Raw
		PanicOnError(response)
		//
		//     {
		//         "status": "ok",
...
func (this *Htx) fetchTimeBody(ch chan any, optionalArgs ...any) any {
	...
	if (typeVar != nil && *typeVar == "future") || (typeVar != nil && *typeVar == "swap") {
		...
		response = (<-this.ContractPublicGetApiV1Timestamp(params)).Raw
		PanicOnError(response)
	} else {

		response = (<-this.SpotPublicGetV1CommonTimestamp(params)).Raw
		PanicOnError(response)
	}
...
func (this *Htx) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	var types any = nil
	var typesparamsVariable []any = this.HandleOptionAndParams(params, "fetchMarkets", "types", map[string]any{})
	types = GetValue(typesparamsVariable, 0)
	params = MapTyped(GetValue(typesparamsVariable, 1))
...
func (this *Htx) fetchMarketsByTypeAndSubTypeBody(ch chan any, typeVar any, subType any, optionalArgs ...any) any {
	...
	for i := 0; i < len(markets); i++ {
		...
		var minCost *float64 = this.SafeNumber(market, "min-order-value")
		var maxAmount *float64 = this.SafeNumber(market, "max-order-amt")
		var minAmount *float64 = this.SafeNumber(market, "min-order-amt")
		if contract {
			if linear == true {
...
func (this *Htx) TryGetSymbolFromFutureMarkets(symbolOrMarketId any) any {
	if (this.Markets != nil) && (InOp(this.Markets, symbolOrMarketId)) {
	...
	for i := 0; i < len(futureMarkets); i++ {
		...
		var constructedId any = func() any {
			if IsEqual(GetValue(market, "linear"), true) {
				return Add(Add(Add(Add(GetValue(market, "base"), "-"), GetValue(market, "quote")), "-"), contractSuffix)
			}
			return Add(Add(GetValue(market, "base"), "_"), contractSuffix)
		}()
...
func (this *Htx) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "linear") == true {
		...
		response = (<-this.ContractPublicGetLinearSwapExMarketDetailMerged(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if GetValue(market, "inverse") == true {
		if GetValue(market, "future") == true {
			request["symbol"] = market["id"]

			response = (<-this.ContractPublicGetMarketDetailMerged(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else if GetValue(market, "swap") == true {
			request["contract_code"] = market["id"]

			response = (<-this.ContractPublicGetSwapExMarketDetailMerged(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	} else {
		request["symbol"] = market["id"]

		response = (<-this.SpotPublicGetMarketDetailMerged(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	// spot
...
func (this *Htx) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if !isSpot || isSubTypeRequested {
		if linear {
			...
			response = (<-this.ContractPublicGetLinearSwapExMarketDetailBatchMerged(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else if inverse {
			if future {

				response = (<-this.ContractPublicGetMarketDetailBatchMerged(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if swap {

				response = (<-this.ContractPublicGetSwapExMarketDetailBatchMerged(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {
				panic(NotSupported(this.Id + " fetchTickers() you have to set params[\"type\"] to either \"swap\" or \"future\" for inverse contracts"))
			}
		} else {
			panic(NotSupported(this.Id + " fetchTickers() you have to set params[\"subType\"] to either \"linear\" or \"inverse\" for contracts"))
		}
	} else {

		response = (<-this.SpotPublicGetMarketTickers(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	// spot
...
func (this *Htx) fetchLastPricesBody(ch chan any, optionalArgs ...any) any {
	...
	params = MapTyped(GetValue(typeVarparamsVariable, 1))
	var response any = nil
	if ((IsEqual(typeVar, "swap")) || (IsEqual(typeVar, "future"))) && (subType != nil && *subType == "linear") {

		response = (<-this.ContractPublicGetLinearSwapExMarketTrade(params)).Raw
		PanicOnError(response)
	} else if (IsEqual(typeVar, "swap")) && (subType != nil && *subType == "inverse") {

		response = (<-this.ContractPublicGetSwapExMarketTrade(params)).Raw
		PanicOnError(response)
	} else if (IsEqual(typeVar, "future")) && (subType != nil && *subType == "inverse") {

		response = (<-this.ContractPublicGetMarketTrade(params)).Raw
		PanicOnError(response)
	} else {
...
func (this *Htx) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "linear") == true {
		...
		if limit != nil {
			...
			if (limit == nil || *limit != 5) && (limit == nil || *limit != 10) && (limit == nil || *limit != 20) && (limit == nil || *limit != 150) {
				panic(BadRequest(this.Id + " fetchOrderBook() limit argument must be undefined, 5, 10, 20, or 150, default is 150"))
			}
...
func (this *Htx) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if filledPoints != nil {
		if (feeCost == nil) || Precise.StringEquals(feeCost, "0") {
...
func (this *Htx) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var retRes264315 []any = ListTyped(PanicOnError((<-this.FetchSpotOrderTradesAsync(id, symbol, since, limit, params))))
	ch <- BoxAbsent(retRes264315)
	return nil
}
...
func (this *Htx) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes269219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params))))
		ch <- BoxAbsent(retRes269219)
		return nil
	}
	var market map[string]any = nil
	if symbol != nil {
	...
	if IsEqual(marketType, "spot") {
		...
		if IsEqual(this.SafeBool(market, "linear"), true) {
			...
			if IsEqual(marketType, "future") {
				...
				response = (<-this.ContractPrivatePostSwapApiV3SwapMatchresultsExact(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {
				panic(NotSupported(Add(Add(this.Id+" fetchMyTrades() does not support ", marketType), " markets")))
			}
		}
	}
	//
...
func (this *Htx) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "future") == true {
		if GetValue(market, "inverse") == true {
			...
			response = (<-this.ContractPublicGetMarketHistoryTrade(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else if GetValue(market, "linear") == true {
			request["contract_code"] = market["id"]

			response = (<-this.ContractPublicGetLinearSwapExMarketHistoryTrade(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	} else if GetValue(market, "swap") == true {
		request["contract_code"] = market["id"]
		if GetValue(market, "inverse") == true {
			...
			response = (<-this.ContractPublicGetSwapExMarketHistoryTrade(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else if GetValue(market, "linear") == true {
		...
		response = (<-this.SpotPublicGetMarketHistoryTrade(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	//     {
...
func (this *Htx) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var until any = nil
	var untilparamsVariable []any = this.HandleParamInteger(params, "until")
	...
	if GetValue(market, "contract") == true {
		...
		if priceType == nil {
			...
			if since == nil {
				...
				request["from"] = Subtract(now, Multiply(duration, (Subtract(limit, 1))))
				calcualtedEnd = now
			} else {
	...
	if GetValue(market, "future") == true {
		if GetValue(market, "inverse") == true {
			...
			if priceType != nil && *priceType == "mark" {
				...
				response = (<-this.ContractPublicGetIndexMarketHistoryMarkPriceKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if priceType != nil && *priceType == "index" {

				response = (<-this.ContractPublicGetIndexMarketHistoryIndex(this.Extend(request, params))).Raw
				PanicOnError(response)
				...
				response = (<-this.ContractPublicGetMarketHistoryKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			}
		} else if GetValue(market, "linear") == true {
			request["contract_code"] = market["id"]
			if priceType != nil && *priceType == "mark" {
				...
				response = (<-this.ContractPublicGetIndexMarketHistoryLinearSwapMarkPriceKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if priceType != nil && *priceType == "index" {
				panic(BadRequest(Add(Add(Add(Add(this.Id+" ", market["type"]), " has no api endpoint for "), priceType), " kline data")))
			} else if priceType != nil && *priceType == "premiumIndex" {

				response = (<-this.ContractPublicGetIndexMarketHistoryLinearSwapPremiumIndexKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {

				response = (<-this.ContractPublicGetLinearSwapExMarketHistoryKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			}
		}
	} else if GetValue(market, "swap") == true {
		...
		if GetValue(market, "inverse") == true {
			if priceType != nil && *priceType == "mark" {
				...
				response = (<-this.ContractPublicGetIndexMarketHistorySwapMarkPriceKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if priceType != nil && *priceType == "index" {
				panic(BadRequest(Add(Add(Add(Add(this.Id+" ", market["type"]), " has no api endpoint for "), priceType), " kline data")))
			} else if priceType != nil && *priceType == "premiumIndex" {

				response = (<-this.ContractPublicGetIndexMarketHistorySwapPremiumIndexKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {

				response = (<-this.ContractPublicGetSwapExMarketHistoryKline(this.Extend(request, params))).Raw
				PanicOnError(response)
			}
		} else if GetValue(market, "linear") == true {
			if priceType != nil && *priceType == "mark" {
		...
		if !(useHistorical == true) {
			...
			response = (<-this.SpotPublicGetMarketHistoryKline(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else {
			...
			response = (<-this.SpotPublicGetMarketHistoryCandles(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	}
	//
	...
	if (isMultiAssetMode == true) || (linear && (swap || future)) {
		...
		if margin {
			if isolated {
				...
				response = (<-this.SpotPrivateGetV1CrossMarginAccountsBalance(this.Extend(request, params))).Raw
				PanicOnError(response)
			}
		} else {
		...
		if future {
			...
			response = (<-this.ContractPrivatePostApiV1ContractAccountInfo(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else {

			response = (<-this.ContractPrivatePostSwapApiV1SwapAccountInfo(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	}
	//
...
func (this *Htx) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		if clientOrderId == nil {
			...
			params = MapTyped(this.Omit(params, []any{"client_order_id", "clientOrderId", "algo_client_order_id"}))
		}
		if IsEqual(this.SafeBool(market, "linear"), true) {
			if isAlgo == true {
			...
			if IsEqual(marketType, "future") {
				...
				response = (<-this.ContractPrivatePostApiV1ContractOrderInfo(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if IsEqual(marketType, "swap") {
				request["contract_code"] = this.SafeString(market, "id")

				response = (<-this.ContractPrivatePostSwapApiV1SwapOrderInfo(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {
				panic(NotSupported(Add(Add(this.Id+" fetchOrder() does not support ", marketType), " markets")))
			}
		}
	}
	//
...
func (this *Htx) ParseMarginBalanceHelper(balance any, code *string, result any) any {
	...
	if IsEqual(account, nil) {
		panic(ExchangeError(this.Id + " parseMarginBalanceHelper() could not resolve account"))
	}
...
func (this *Htx) fetchSpotOrdersByStatesBody(ch chan any, states any, optionalArgs ...any) any {
	...
	if method != nil && *method == "spot_private_get_v1_order_orders" {
		...
		response = (<-this.SpotPrivateGetV1OrderHistory(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
...
func (this *Htx) fetchSpotOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes397315 []any = ListTyped(PanicOnError((<-this.FetchSpotOrdersByStatesAsync("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes397315)
	return nil
}
...
func (this *Htx) fetchClosedSpotOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes397715 []any = ListTyped(PanicOnError((<-this.FetchSpotOrdersByStatesAsync("filled", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes397715)
	return nil
}
...
func (this *Htx) fetchContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	if symbol == nil {
		panic(ArgumentsRequired(this.Id + " fetchContractOrders() requires a symbol argument"))
	}
	if this.Markets == nil {
	...
	if GetValue(market, "linear") == true {
		...
		if GetValue(market, "swap") == true {
			if trigger != nil && *trigger == true {
				...
				response = (<-this.ContractPrivatePostSwapApiV1SwapTriggerHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

				response = (<-this.ContractPrivatePostSwapApiV1SwapTpslHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if trailing != nil && *trailing == true {

				response = (<-this.ContractPrivatePostSwapApiV1SwapTrackHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {

				response = (<-this.ContractPrivatePostSwapApiV3SwapHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			}
			...
			if trigger != nil && *trigger == true {
				...
				response = (<-this.ContractPrivatePostApiV1ContractTpslHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else if trailing != nil && *trailing == true {

				response = (<-this.ContractPrivatePostApiV1ContractTrackHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			} else {

				response = (<-this.ContractPrivatePostApiV3ContractHisorders(this.Extend(request, params))).Raw
				PanicOnError(response)
			}
		}
	}
...
func (this *Htx) fetchClosedContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	if symbol == nil {
		panic(ArgumentsRequired(this.Id + " fetchClosedContractOrders() requires a symbol argument"))
	}
	if this.Markets == nil {
...
func (this *Htx) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if contract && (symbol == nil) {
		panic(ArgumentsRequired(Add(Add(this.Id+" fetchOrders() requires a symbol argument for ", marketType), " orders")))
	}
	if contract {

		var retRes419919 []any = ListTyped(PanicOnError((<-this.FetchContractOrdersAsync(symbol, since, limit, params))))
		ch <- BoxAbsent(retRes419919)
		return nil
	} else {

		var retRes420119 []any = ListTyped(PanicOnError((<-this.FetchSpotOrdersAsync(symbol, since, limit, params))))
		ch <- BoxAbsent(retRes420119)
		return nil
	}
}
...
func (this *Htx) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes423019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchCanceledOrders", symbol, since, limit, params, 100))))
		ch <- BoxAbsent(retRes423019)
		return nil
	}
	var market map[string]any = nil
	if symbol != nil {
	...
	if IsEqual(marketType, "spot") {
		...
		var retRes423919 []any = ListTyped(PanicOnError((<-this.FetchSpotOrdersByStatesAsync("partial-canceled,canceled", symbol, since, limit, params))))
		ch <- BoxAbsent(retRes423919)
		return nil
	} else {
		if symbol == nil {
			panic(ArgumentsRequired(Add(Add(this.Id+" fetchCanceledOrders() requires a symbol argument for ", marketType), " orders")))
		}
		var request map[string]any = map[string]any{}
		if IsEqual(this.SafeBool(market, "linear"), true) {
			var trigger *bool = this.SafeBool2(params, "stop", "trigger")
		...
		var retRes426019 []any = ListTyped(PanicOnError((<-this.FetchContractOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
		ch <- BoxAbsent(retRes426019)
		return nil
	}
}
...
func (this *Htx) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes428919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchClosedOrders", symbol, since, limit, params, 100))))
		ch <- BoxAbsent(retRes428919)
		return nil
	}
	var market map[string]any = nil
	if symbol != nil {
	...
	if marketType != nil && *marketType == "spot" {
		...
		var retRes429819 []any = ListTyped(PanicOnError((<-this.FetchClosedSpotOrdersAsync(symbol, since, limit, params))))
		ch <- BoxAbsent(retRes429819)
		return nil
	} else {

		var retRes430019 []any = ListTyped(PanicOnError((<-this.FetchClosedContractOrdersAsync(symbol, since, limit, params))))
		ch <- BoxAbsent(retRes430019)
		return nil
	}
}
...
func (this *Htx) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	params = MapTyped(GetValue(marketTypeparamsVariable, 1))
	var subType *string = nil
	var subTypeparamsVariable []any = this.HandleSubTypeAndParams("fetchOpenOrders", market, params, "linear")
	subType = SafeStringPtr(GetValue(subTypeparamsVariable, 0))
	params = MapTyped(GetValue(subTypeparamsVariable, 1))
	var isLinear bool = (subType != nil && *subType == "linear")
	var response any = nil
	if marketType != nil && *marketType == "spot" {
		if symbol != nil {
		...
		params = MapTyped(this.Omit(params, "account-id"))
		...
		params = MapTyped(this.Omit(params, []any{"stop", "stopLossTakeProfit", "trailing", "trigger", "stopLoss", "takeProfit"}))
		if isLinear {
			if (trigger != nil && *trigger == true) || (trailing != nil && *trailing == true) || (stopLossTakeProfit != nil && *stopLossTakeProfit == true) || (stopLoss != nil && *stopLoss == true) || (takeProfit != nil && *takeProfit == true) {
				if trigger != nil && *trigger == true {
					request["type"] = "trigger"
				} else if trailing != nil && *trailing == true {
					request["type"] = "trailing_stop"
			...
			if marketType != nil && *marketType == "swap" {
				if trigger != nil && *trigger == true {
					...
					response = (<-this.ContractPrivatePostSwapApiV1SwapTriggerOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

					response = (<-this.ContractPrivatePostSwapApiV1SwapTpslOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if trailing != nil && *trailing == true {

					response = (<-this.ContractPrivatePostSwapApiV1SwapTrackOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else {

					response = (<-this.ContractPrivatePostSwapApiV1SwapOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				}
				...
				if trigger != nil && *trigger == true {
					...
					response = (<-this.ContractPrivatePostApiV1ContractTriggerOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

					response = (<-this.ContractPrivatePostApiV1ContractTpslOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if trailing != nil && *trailing == true {

					response = (<-this.ContractPrivatePostApiV1ContractTrackOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else {

					response = (<-this.ContractPrivatePostApiV1ContractOpenorders(this.Extend(request, params))).Raw
					PanicOnError(response)
				}
			}
		}
...
func (this *Htx) ParseOrder(order any, optionalArgs ...any) any {
	...
	var isLinearOrder bool = (contractCode != nil) && (market != nil) && (GetValue(market, "linear") == true) && (GetValue(market, "spot") != true)
	var typeVar any = nil
...
func (this *Htx) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	var retRes503915 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))))
	ch <- BoxAbsent(retRes503915)
	return nil
}
...
func (this *Htx) createTrailingPercentOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var retRes506515 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, typeVar, side, amount, price, params))))
	ch <- BoxAbsent(retRes506515)
	return nil
}
...
func (this *Htx) CreateContractOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var postOnly bool = false
	var postOnlyparamsVariable []any = this.HandlePostOnly((IsEqual(typeVar, "market")), (IsEqual(typeVar, "post_only")), params)
	postOnly = GetValueBool(postOnlyparamsVariable, 0, false)
	params = MapTyped(GetValue(postOnlyparamsVariable, 1))
	if postOnly == true {
		typeVar = "post_only"
	...
	var subType *string = nil
	var subTypeparamsVariable []any = this.HandleSubTypeAndParams("createOrder", market, params)
	subType = SafeStringPtr(GetValue(subTypeparamsVariable, 0))
	params = MapTyped(GetValue(subTypeparamsVariable, 1))
	var isLinear bool = (subType != nil && *subType == "linear")
	...
	if isLinear {
		...
		var stopLossTriggerPriceAttached *float64 = this.SafeNumber(stopLoss, "triggerPrice")
		var stopLossOrderPrice *float64 = this.SafeNumber(stopLoss, "price")
		var stopLossType *string = this.SafeString(stopLoss, "type")
		var takeProfitTriggerPriceAttached *float64 = this.SafeNumber(takeProfit, "triggerPrice")
	...
	var stopLossTriggerPrice *float64 = this.SafeNumber2(params, "stopLossPrice", "sl_trigger_price")
	var takeProfitTriggerPrice *float64 = this.SafeNumber2(params, "takeProfitPrice", "tp_trigger_price")
	var trailingPercent *string = this.SafeString2(params, "trailingPercent", "callback_rate")
	var trailingTriggerPrice *float64 = this.SafeNumber(params, "trailingTriggerPrice", price)
	...
	params = MapTyped(this.Omit(params, []any{"reduceOnly", "triggerPrice", "stopPrice", "stopLossPrice", "takeProfitPrice", "triggerType", "leverRate", "timeInForce", "leverage", "trailingPercent", "trailingTriggerPrice", "hedged"}))
...
func (this *Htx) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var stopLossTriggerPrice *float64 = this.SafeNumber2(params, "stopLossPrice", "sl_trigger_price")
	var takeProfitTriggerPrice *float64 = this.SafeNumber2(params, "takeProfitPrice", "tp_trigger_price")
	var trailingPercent *float64 = this.SafeNumber(params, "trailingPercent")
	var isTrailingPercentOrder bool = (trailingPercent != nil)
	var isTrigger bool = (triggerPrice != nil)
	var isStopLossTriggerOrder bool = (stopLossTriggerPrice != nil)
	var isTakeProfitTriggerOrder bool = (takeProfitTriggerPrice != nil)
	...
	if GetValue(market, "spot") == true {
		...
		if GetValue(market, "linear") == true {
			...
			if offset == nil {
				panic(ArgumentsRequired(this.Id + " createOrder () requires an extra parameter params[\"offset\"] to be set to \"open\" or \"close\" when placing orders in inverse markets"))
			}
			if GetValue(market, "swap") == true {
				if isTrigger {
...
func (this *Htx) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsEqual(this.SafeBool(market, "spot"), true) {
		...
		if IsArray(data) {
			...
			var success []any = SafeListTypedDefault(batchData, "success", []any{})
			var errors []any = SafeListTypedDefault(batchData, "errors", []any{})
...
func (this *Htx) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var request map[string]any = map[string]any{}
	var trigger *bool = this.SafeBool2(params, "stop", "trigger")
	var stopLossTakeProfit *bool = this.SafeBoolN(params, []any{"stopLossTakeProfit", "stopLoss", "takeProfit"})
	var trailing *bool = this.SafeBool(params, "trailing", false)
	params = MapTyped(this.Omit(params, []any{"stop", "stopLossTakeProfit", "trailing", "trigger", "stopLoss", "takeProfit"}))
	var response any = nil
	if IsEqual(marketType, "spot") {
		...
		if clientOrderId == nil {
			...
			request["client-order-id"] = clientOrderId
			params = MapTyped(this.Omit(params, []any{"client-order-id", "clientOrderId"}))
		...
		var clientOrderId *string = this.SafeStringN(params, []any{"client_order_id", "clientOrderId", "algo_client_order_id"})
		if !(isLinear && ((trigger != nil && *trigger == true) || (stopLossTakeProfit != nil && *stopLossTakeProfit == true) || (trailing != nil && *trailing == true))) {
			if clientOrderId == nil {
				request["order_id"] = id
			} else {
				request["client_order_id"] = clientOrderId
		...
		if isLinear {
			if (trigger != nil && *trigger == true) || (stopLossTakeProfit != nil && *stopLossTakeProfit == true) || (trailing != nil && *trailing == true) {
				var requestItem map[string]any = map[string]any{
					"contract_code": this.SafeString(market, "id"),
				}
				if clientOrderId == nil {
					requestItem["algo_id"] = id
					params = MapTyped(this.Omit(params, "algo_id"))
				} else {
			...
			if IsEqual(this.SafeBool(market, "swap"), true) {
				if trigger != nil && *trigger == true {
					...
					response = (<-this.ContractPrivatePostSwapApiV1SwapTriggerCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

					response = (<-this.ContractPrivatePostSwapApiV1SwapTpslCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if trailing != nil && *trailing == true {

					response = (<-this.ContractPrivatePostSwapApiV1SwapTrackCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else {

					response = (<-this.ContractPrivatePostSwapApiV1SwapCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				}
			} else if IsEqual(this.SafeBool(market, "future"), true) {
				if trigger != nil && *trigger == true {

					response = (<-this.ContractPrivatePostApiV1ContractTriggerCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

					response = (<-this.ContractPrivatePostApiV1ContractTpslCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if trailing != nil && *trailing == true {

					response = (<-this.ContractPrivatePostApiV1ContractTrackCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else {

					response = (<-this.ContractPrivatePostApiV1ContractCancel(this.Extend(request, params))).Raw
					PanicOnError(response)
				}
			}
		} else {
			panic(NotSupported(Add(Add(this.Id+" cancelOrder() does not support ", marketType), " markets")))
		}
	}
	//
	// spot
...
func (this *Htx) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	var trigger *bool = this.SafeBool2(params, "stop", "trigger")
	var stopLossTakeProfit *bool = this.SafeBool(params, "stopLossTakeProfit")
	params = MapTyped(this.Omit(params, []any{"stop", "stopLossTakeProfit", "trigger"}))
	var response any = nil
	if IsEqual(marketType, "spot") {
		...
		if IsEqual(clientOrderIds, nil) {
			if IsString(clientOrderIds) {
				request["order-ids"] = []any{ids}
			} else {
				request["order-ids"] = ids
			}
		} else {
			if IsString(clientOrderIds) {
				request["client-order-ids"] = []any{clientOrderIds}
			} else {
				request["client-order-ids"] = clientOrderIds
			}
			params = MapTyped(this.Omit(params, []any{"client-order-id", "client-order-ids", "clientOrderId", "clientOrderIds"}))
		}
		...
		params = MapTyped(this.Omit(params, []any{"client_order_id", "client_order_ids", "clientOrderId", "clientOrderIds"}))
		if !IsEqual(this.SafeBool(market, "linear"), true) {
			if IsEqual(clientOrderIds, nil) {
		...
		if IsEqual(this.SafeBool(market, "linear"), true) {
			if IsEqual(clientOrderIds, nil) {
				...
				if IsString(clientOrderIds) {
					request["client_order_id"] = Split(clientOrderIds, ",")
				} else {
					request["client_order_id"] = clientOrderIds
				}
			}
			...
			panic(NotSupported(Add(Add(this.Id+" cancelOrders() does not support ", marketType), " markets")))
		}
	}
	//
	// spot
...
func (this *Htx) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		var stopLossTakeProfit *bool = this.SafeBool(params, "stopLossTakeProfit")
		var trailing *bool = this.SafeBool(params, "trailing", false)
		params = MapTyped(this.Omit(params, []any{"stop", "stopLossTakeProfit", "trailing", "trigger"}))
		if IsEqual(this.SafeBool(market, "linear"), true) {
			...
			if IsEqual(this.SafeBool(market, "swap"), true) {
				if trigger != nil && *trigger == true {
					...
					response = (<-this.ContractPrivatePostSwapApiV1SwapTriggerCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

					response = (<-this.ContractPrivatePostSwapApiV1SwapTpslCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if trailing != nil && *trailing == true {

					response = (<-this.ContractPrivatePostSwapApiV1SwapTrackCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else {

					response = (<-this.ContractPrivatePostSwapApiV1SwapCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				}
			} else if IsEqual(this.SafeBool(market, "future"), true) {
				if trigger != nil && *trigger == true {

					response = (<-this.ContractPrivatePostApiV1ContractTriggerCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if stopLossTakeProfit != nil && *stopLossTakeProfit == true {

					response = (<-this.ContractPrivatePostApiV1ContractTpslCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else if trailing != nil && *trailing == true {

					response = (<-this.ContractPrivatePostApiV1ContractTrackCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				} else {

					response = (<-this.ContractPrivatePostApiV1ContractCancelall(this.Extend(request, params))).Raw
					PanicOnError(response)
				}
			}
		} else {
			panic(NotSupported(Add(Add(this.Id+" cancelAllOrders() does not support ", marketType), " markets")))
		}
		//
		//     {
		//         "status": "ok",
...
func (this *Htx) fetchWithdrawAddressesBody(ch chan any, code any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(allAddresses); i++ {
		...
		var noteMatch bool = (note == nil) || (IsEqual(GetValue(address, "note"), note))
		var networkMatch bool = (networkCode == nil) || (IsEqual(GetValue(address, "network"), networkCode))
...
func (this *Htx) ParseTransfer(transfer any, optionalArgs ...any) any {
	...
	var code *string = this.SafeCurrencyCode(currencyId, currency)
	var amount *float64 = this.SafeNumber(transfer, "amount")
...
func (this *Htx) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if fromSpot && toSpot {
		panic(BadRequest(Add(Add(Add(this.Id+" transfer () cannot make a transfer between ", fromAccount), " and "), toAccount)))
	}
	...
	if fromOrToFuturesAccount {
		...
		response = (<-this.SpotPrivatePostV1FuturesTransfer(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if fromSpot && toCross {

		response = (<-this.PrivatePostCrossMarginTransferIn(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if fromCross && toSpot {

		response = (<-this.PrivatePostCrossMarginTransferOut(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if fromSpot && toIsolated {
		request["symbol"] = toAccountId

		response = (<-this.PrivatePostDwTransferInMargin(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if fromIsolated && toSpot {
		request["symbol"] = fromAccountId

		response = (<-this.PrivatePostDwTransferOutMargin(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		if subType != nil && *subType == "linear" {
		...
		response = (<-this.V2PrivatePostAccountTransfer(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	//    {
...
func (this *Htx) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.SpotPrivateGetV5AccountUniversalTransferRecords(this.Extend(request, params))).Raw))
	//
	//     {
	//         "code": 200,
	//         "message": "Success",
...
func (this *Htx) ParseIsolatedBorrowRate(info any, optionalArgs ...any) any {
	...
	var currencies []any = SafeListTypedDefault(info, "currencies", []any{})
...
func (this *Htx) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes715319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchFundingRateHistory", symbol, since, limit, params, "current_page", "page_index", 1, 50))))
		ch <- BoxAbsent(retRes715319)
		return nil
	}
	if this.Markets == nil {
	...
	if GetValue(market, "inverse") == true {
		...
		response = (<-this.ContractPublicGetSwapApiV1SwapHistoricalFundingRate(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if GetValue(market, "linear") == true {
...
func (this *Htx) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var nextFundingRate *float64 = this.SafeNumber(contract, "estimated_rate")
...
func (this *Htx) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(subType, "linear") {
		...
		response = (<-this.ContractPublicGetSwapApiV1SwapBatchFundingRate(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		panic(NotSupported(this.Id + " fetchFundingRates() not support this market type"))
	}
...
func (this *Htx) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marginMode, "isolated") {
		...
		response = (<-this.PrivateGetCrossMarginLoanOrders(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	//    {
...
func (this *Htx) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "swap" {
		if GetValue(market, "linear") == true {
			var marginMode any = nil
			var marginModeparamsVariable []any = this.HandleMarginModeAndParams("fetchFundingHistory", params)
			marginMode = GetValue(marginModeparamsVariable, 0)
			params = MapTyped(GetValue(marginModeparamsVariable, 1))
			marginMode = func() any {
				if marginMode == nil {
			...
			response = (<-this.ContractPrivatePostSwapApiV3SwapFinancialRecordExact(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	} else {
...
func (this *Htx) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if (marketType == "future") && (GetValue(market, "inverse") == true) {
...
func (this *Htx) ParseIncome(income any, optionalArgs ...any) any {
	...
	var symbol *string = this.SafeSymbol(marketId, market)
	var amount *float64 = this.SafeNumber(income, "amount")
...
func (this *Htx) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	var subType *string = nil
	var subTypeparamsVariable []any = this.HandleSubTypeAndParams("fetchPositions", market, params, "linear")
	subType = SafeStringPtr(GetValue(subTypeparamsVariable, 0))
	params = MapTyped(GetValue(subTypeparamsVariable, 1))
	var marketType *string = nil
	...
	params = MapTyped(GetValue(marketTypeparamsVariable, 1))
	if marketType != nil && *marketType == "spot" {
		marketType = SafeStringPtr("future")
	}
	var response any = nil
	if subType != nil && *subType == "linear" {
		...
		if marketType != nil && *marketType == "future" {
			...
			response = (<-this.ContractPrivatePostApiV1ContractPositionInfo(params)).Raw
			PanicOnError(response)
		} else if marketType != nil && *marketType == "swap" {

			response = (<-this.ContractPrivatePostSwapApiV1SwapPositionInfo(params)).Raw
			PanicOnError(response)
		} else {
...
func (this *Htx) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if (GetValue(market, "future") == true) && (GetValue(market, "inverse") == true) {
		...
		if (GetValue(market, "linear") != true) && (IsEqual(marginMode, "cross")) {
	...
	var data any = this.SafeValue(response, "data")
	if GetValue(market, "linear") == true {
		var linearPosition map[string]any = MapTyped(this.SafeDict(data, 0, map[string]any{}))
...
func (this *Htx) ParseLedgerEntryType(typeVar any) *string {
...
func (this *Htx) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes852719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params, 500))))
		ch <- BoxAbsent(retRes852719)
		return nil
	}
...
func (this *Htx) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if (timeframe != "1h") && (timeframe != "4h") && (timeframe != "12h") && (timeframe != "1d") {
		panic(BadRequest(this.Id + " fetchOpenInterestHistory cannot only use the 1h, 4h, 12h and 1d timeframe"))
	}
	if this.Markets == nil {
	...
	if GetValue(market, "future") == true {
		...
		response = (<-this.ContractPublicGetApiV1ContractHisOpenInterest(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if GetValue(market, "linear") == true {
		...
		response = (<-this.ContractPublicGetLinearSwapApiV1SwapHisOpenInterest(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		request["contract_code"] = market["id"]
		// coin-m swaps

		response = (<-this.ContractPublicGetSwapApiV1SwapHisOpenInterest(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
...
func (this *Htx) fetchOpenInterestsBody(ch chan any, optionalArgs ...any) any {
	...
	var request map[string]any = map[string]any{}
	var subType *string = nil
	var subTypeparamsVariable []any = this.HandleSubTypeAndParams("fetchOpenInterests", market, params, "linear")
	subType = SafeStringPtr(GetValue(subTypeparamsVariable, 0))
	params = MapTyped(GetValue(subTypeparamsVariable, 1))
	var marketType *string = nil
	var marketTypeparamsVariable []any = this.HandleMarketTypeAndParams("fetchOpenInterests", market, params)
	marketType = SafeStringPtr(GetValue(marketTypeparamsVariable, 0))
	params = MapTyped(GetValue(marketTypeparamsVariable, 1))
	var response any = nil
	if marketType != nil && *marketType == "future" {
...
func (this *Htx) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "option") == true {
		panic(NotSupported(this.Id + " fetchOpenInterest() does not currently support option markets"))
	}
	var request map[string]any = map[string]any{
		"contract_code": market["id"],
	}
...
func (this *Htx) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var amount *float64 = this.SafeNumber(interest, "volume")
	var value *float64 = this.SafeNumber(interest, "value")
...
func (this *Htx) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		if GetValue(market, "linear") == true {
			...
			response = (<-this.ContractPublicGetSwapApiV1SwapSettlementRecords(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	} else {

		response = (<-this.ContractPublicGetApiV1ContractSettlementRecords(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	// coin-m swap
...
func (this *Htx) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var clientOrderId *string = this.SafeString(params, "clientOrderId")
	if GetValue(market, "contract") != true {
		panic(BadRequest(this.Id + " closePosition() symbol supports contract markets only"))
	}
	var request map[string]any = map[string]any{
		"contract_code": market["id"],
	}
	...
	if GetValue(market, "linear") == true {
		...
		if amount == nil {
			panic(ArgumentsRequired(this.Id + " closePosition () requires an extra argument params[\"amount\"] for inverse markets"))
		}
		request["volume"] = this.AmountToPrecision(symbol, amount)
		request["direction"] = side
		params = MapTyped(this.Omit(params, []any{"volume", "amount"}))
		if GetValue(market, "swap") == true {

			response = (<-this.ContractPrivatePostSwapApiV1SwapLightningClosePosition(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else {

			response = (<-this.ContractPrivatePostApiV1LightningClosePosition(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	}
	if GetValue(market, "linear") == true {
...
func (this *Htx) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if (!IsEqual(market, nil)) && (GetValue(market, "inverse") == true) {
...
func (this *Htx) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	var subType *string = nil
	var subTypeparamsVariable []any = this.HandleSubTypeAndParams("fetchPositionsADLRank", market, params, "linear")
	subType = SafeStringPtr(GetValue(subTypeparamsVariable, 0))
	params = MapTyped(GetValue(subTypeparamsVariable, 1))
	var marketType *string = nil
	var marketTypeparamsVariable []any = this.HandleMarketTypeAndParams("fetchPositionsADLRank", market, params)
	marketType = SafeStringPtr(GetValue(marketTypeparamsVariable, 0))
	params = MapTyped(GetValue(marketTypeparamsVariable, 1))
	if marketType != nil && *marketType == "spot" {
		marketType = SafeStringPtr("future")
...
func (this *Htx) FetchTradingLimits(options ...FetchTradingLimitsOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchTradingLimitsAsync(opts.Symbols, opts.Params))
	if res.Err != nil {
...
func (this *Htx) FetchTradingLimitsById(id string, options ...FetchTradingLimitsByIdOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchTradingLimitsByIdAsync(id, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchMarketsByTypeAndSubType(typeVar string, subType string, options ...FetchMarketsByTypeAndSubTypeOptions) ([]MarketInterface, error) {
	...
	var res AsyncResult[[]MarketInterface] = AwaitResult(NewMarketInterfaceArray, this.FetchMarketsByTypeAndSubTypeAsync(typeVar, subType, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchSpotOrderTrades(id string, options ...FetchSpotOrderTradesOptions) ([]Trade, error) {
	...
	var res AsyncResult[[]Trade] = AwaitResult(NewTradeArray, this.FetchSpotOrderTradesAsync(id, opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchAccountIdByType(typeVar string, options ...FetchAccountIdByTypeOptions) (string, error) {
	...
	var res AsyncResult[string] = AwaitResult(AssertAs[string], this.FetchAccountIdByTypeAsync(typeVar, opts.MarginMode, opts.Symbol, opts.Params))
	if res.Err != nil {
		return "", res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchSpotOrdersByStates(states string, options ...FetchSpotOrdersByStatesOptions) ([]Order, error) {
	...
	var res AsyncResult[[]Order] = AwaitResult(NewOrderArray, this.FetchSpotOrdersByStatesAsync(states, opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchSpotOrders(options ...FetchSpotOrdersOptions) ([]Order, error) {
	...
	var res AsyncResult[[]Order] = AwaitResult(NewOrderArray, this.FetchSpotOrdersAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchClosedSpotOrders(options ...FetchClosedSpotOrdersOptions) ([]Order, error) {
	...
	var res AsyncResult[[]Order] = AwaitResult(NewOrderArray, this.FetchClosedSpotOrdersAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchContractOrders(options ...FetchContractOrdersOptions) ([]Order, error) {
	...
	var res AsyncResult[[]Order] = AwaitResult(NewOrderArray, this.FetchContractOrdersAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchClosedContractOrders(options ...FetchClosedContractOrdersOptions) ([]Order, error) {
	...
	var res AsyncResult[[]Order] = AwaitResult(NewOrderArray, this.FetchClosedContractOrdersAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) CreateTrailingPercentOrder(symbol string, typeVar string, side string, amount float64, options ...CreateTrailingPercentOrderOptions) (Order, error) {
	...
	var res AsyncResult[Order] = AwaitResult(NewOrder, this.CreateTrailingPercentOrderAsync(symbol, typeVar, side, amount, opts.Price, opts.TrailingPercent, opts.TrailingTriggerPrice, opts.Params))
	if res.Err != nil {
		return Order{}, res.Err
	}
	return res.Value, nil
...
func (this *Htx) CreateSpotOrderRequest(symbol string, typeVar string, side string, amount float64, options ...CreateSpotOrderRequestOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.CreateSpotOrderRequestAsync(symbol, typeVar, side, amount, opts.Price, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchWithdrawAddresses(code string, options ...FetchWithdrawAddressesOptions) ([]DepositAddress, error) {
	...
	var res AsyncResult[[]DepositAddress] = AwaitResult(NewDepositAddressArray, this.FetchWithdrawAddressesAsync(code, opts.Note, opts.NetworkCode, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) FetchIsolatedBorrowRates(params ...any) (IsolatedBorrowRates, error) {
	var res AsyncResult[IsolatedBorrowRates] = AwaitResult(NewIsolatedBorrowRates, this.FetchIsolatedBorrowRatesAsync(params...))
	if res.Err != nil {
...
func (this *Htx) FetchPositionsADLRank(options ...FetchPositionsADLRankOptions) ([]ADL, error) {
	...
	var res AsyncResult[[]ADL] = AwaitResult(NewADLArray, this.FetchPositionsADLRankAsync(opts.Symbols, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Htx) CreateConvertTrade(id string, fromCode string, toCode string, options ...CreateConvertTradeOptions) (Conversion, error) {
	return this.exchangeTyped.CreateConvertTrade(id, fromCode, toCode, options...)
}
func (this *Htx) CreateDepositAddress(code string, options ...CreateDepositAddressOptions) (DepositAddress, error) {
	return this.exchangeTyped.CreateDepositAddress(code, options...)
}
func (this *Htx) CreateLimitBuyOrder(symbol string, amount float64, price float64, options ...CreateLimitBuyOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateLimitBuyOrder(symbol, amount, price, options...)
}
func (this *Htx) CreateLimitOrder(symbol string, side string, amount float64, price float64, options ...CreateLimitOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateLimitOrder(symbol, side, amount, price, options...)
}
func (this *Htx) CreateLimitSellOrder(symbol string, amount float64, price float64, options ...CreateLimitSellOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateLimitSellOrder(symbol, amount, price, options...)
}
func (this *Htx) CreateMarketBuyOrder(symbol string, amount float64, options ...CreateMarketBuyOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketBuyOrder(symbol, amount, options...)
}
func (this *Htx) CreateMarketOrder(symbol string, side string, amount float64, options ...CreateMarketOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketOrder(symbol, side, amount, options...)
}
func (this *Htx) CreateMarketOrderWithCost(symbol string, side string, cost float64, options ...CreateMarketOrderWithCostOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketOrderWithCost(symbol, side, cost, options...)
}
func (this *Htx) CreateMarketSellOrder(symbol string, amount float64, options ...CreateMarketSellOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketSellOrder(symbol, amount, options...)
}
func (this *Htx) CreateMarketSellOrderWithCost(symbol string, cost float64, options ...CreateMarketSellOrderWithCostOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketSellOrderWithCost(symbol, cost, options...)
}
func (this *Htx) CreateOrderWithTakeProfitAndStopLoss(symbol string, typeVar string, side string, amount float64, options ...CreateOrderWithTakeProfitAndStopLossOptions) (Order, error) {
	return this.exchangeTyped.CreateOrderWithTakeProfitAndStopLoss(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreatePostOnlyOrder(symbol string, typeVar string, side string, amount float64, options ...CreatePostOnlyOrderOptions) (Order, error) {
	return this.exchangeTyped.CreatePostOnlyOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateReduceOnlyOrder(symbol string, typeVar string, side string, amount float64, options ...CreateReduceOnlyOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateReduceOnlyOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateStopLimitOrder(symbol string, side string, amount float64, price float64, triggerPrice float64, options ...CreateStopLimitOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateStopLimitOrder(symbol, side, amount, price, triggerPrice, options...)
}
func (this *Htx) CreateStopLossOrder(symbol string, typeVar string, side string, amount float64, options ...CreateStopLossOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateStopLossOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateStopMarketOrder(symbol string, side string, amount float64, triggerPrice float64, options ...CreateStopMarketOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateStopMarketOrder(symbol, side, amount, triggerPrice, options...)
}
func (this *Htx) CreateStopOrder(symbol string, typeVar string, side string, amount float64, options ...CreateStopOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateStopOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTakeProfitOrder(symbol string, typeVar string, side string, amount float64, options ...CreateTakeProfitOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateTakeProfitOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTrailingAmountOrder(symbol string, typeVar string, side string, amount float64, options ...CreateTrailingAmountOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateTrailingAmountOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTriggerOrder(symbol string, typeVar string, side string, amount float64, options ...CreateTriggerOrderOptions) (Order, error) {
	return this.exchangeTyped.CreateTriggerOrder(symbol, typeVar, side, amount, options...)
}
func (this *Htx) EditLimitBuyOrder(id string, symbol string, amount float64, options ...EditLimitBuyOrderOptions) (Order, error) {
	return this.exchangeTyped.EditLimitBuyOrder(id, symbol, amount, options...)
}
func (this *Htx) EditLimitOrder(id string, symbol string, side string, amount float64, options ...EditLimitOrderOptions) (Order, error) {
	return this.exchangeTyped.EditLimitOrder(id, symbol, side, amount, options...)
}
func (this *Htx) EditLimitSellOrder(id string, symbol string, amount float64, options ...EditLimitSellOrderOptions) (Order, error) {
...
func (this *Htx) FetchConvertTrade(id string, options ...FetchConvertTradeOptions) (Conversion, error) {
	return this.exchangeTyped.FetchConvertTrade(id, options...)
}
func (this *Htx) FetchConvertTradeHistory(options ...FetchConvertTradeHistoryOptions) ([]Conversion, error) {
...
func (this *Htx) FetchFundingIntervals(options ...FetchFundingIntervalsOptions) (FundingRates, error) {
	return this.exchangeTyped.FetchFundingIntervals(options...)
}
func (this *Htx) FetchGreeks(symbol string, options ...FetchGreeksOptions) (Greeks, error) {
	return this.exchangeTyped.FetchGreeks(symbol, options...)
}
func (this *Htx) FetchIndexOHLCV(symbol string, options ...FetchIndexOHLCVOptions) ([]OHLCV, error) {
	return this.exchangeTyped.FetchIndexOHLCV(symbol, options...)
}
func (this *Htx) FetchIsolatedBorrowRate(symbol string, options ...FetchIsolatedBorrowRateOptions) (IsolatedBorrowRate, error) {
	return this.exchangeTyped.FetchIsolatedBorrowRate(symbol, options...)
}
func (this *Htx) FetchLedgerEntry(id string, options ...FetchLedgerEntryOptions) (LedgerEntry, error) {
	return this.exchangeTyped.FetchLedgerEntry(id, options...)
}
func (this *Htx) FetchLeverage(symbol string, options ...FetchLeverageOptions) (Leverage, error) {
	return this.exchangeTyped.FetchLeverage(symbol, options...)
}
func (this *Htx) FetchLeverages(options ...FetchLeveragesOptions) (Leverages, error) {
	return this.exchangeTyped.FetchLeverages(options...)
}
func (this *Htx) FetchLongShortRatio(symbol string, options ...FetchLongShortRatioOptions) (LongShortRatio, error) {
	return this.exchangeTyped.FetchLongShortRatio(symbol, options...)
}
func (this *Htx) FetchLongShortRatioHistory(options ...FetchLongShortRatioHistoryOptions) ([]LongShortRatio, error) {
	return this.exchangeTyped.FetchLongShortRatioHistory(options...)
}
func (this *Htx) FetchMarginAdjustmentHistory(options ...FetchMarginAdjustmentHistoryOptions) ([]MarginModification, error) {
	return this.exchangeTyped.FetchMarginAdjustmentHistory(options...)
}
func (this *Htx) FetchMarginMode(symbol string, options ...FetchMarginModeOptions) (MarginMode, error) {
	return this.exchangeTyped.FetchMarginMode(symbol, options...)
}
func (this *Htx) FetchMarginModes(options ...FetchMarginModesOptions) (MarginModes, error) {
...
func (this *Htx) FetchMarkPrices(options ...FetchMarkPricesOptions) (Tickers, error) {
	return this.exchangeTyped.FetchMarkPrices(options...)
}
func (this *Htx) FetchMyLiquidations(options ...FetchMyLiquidationsOptions) ([]Liquidation, error) {
	return this.exchangeTyped.FetchMyLiquidations(options...)
}
func (this *Htx) FetchOption(symbol string, options ...FetchOptionOptions) (Option, error) {
...
func (this *Htx) FetchPositionsHistory(options ...FetchPositionsHistoryOptions) ([]Position, error) {
	return this.exchangeTyped.FetchPositionsHistory(options...)
}
func (this *Htx) FetchPositionsRisk(options ...FetchPositionsRiskOptions) ([]Position, error) {
...
func (this *Htx) CancelOrdersWs(ids []string, options ...CancelOrdersWsOptions) ([]Order, error) {
	return this.exchangeTyped.CancelOrdersWs(ids, options...)
}
func (this *Htx) CancelOrderWs(id string, options ...CancelOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CancelOrderWs(id, options...)
}
func (this *Htx) CreateLimitBuyOrderWs(symbol string, amount float64, price float64, options ...CreateLimitBuyOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateLimitBuyOrderWs(symbol, amount, price, options...)
}
func (this *Htx) CreateLimitOrderWs(symbol string, side string, amount float64, price float64, options ...CreateLimitOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateLimitOrderWs(symbol, side, amount, price, options...)
}
func (this *Htx) CreateLimitSellOrderWs(symbol string, amount float64, price float64, options ...CreateLimitSellOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateLimitSellOrderWs(symbol, amount, price, options...)
}
func (this *Htx) CreateMarketBuyOrderWs(symbol string, amount float64, options ...CreateMarketBuyOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketBuyOrderWs(symbol, amount, options...)
}
func (this *Htx) CreateMarketOrderWithCostWs(symbol string, side string, cost float64, options ...CreateMarketOrderWithCostWsOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketOrderWithCostWs(symbol, side, cost, options...)
}
func (this *Htx) CreateMarketOrderWs(symbol string, side string, amount float64, options ...CreateMarketOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketOrderWs(symbol, side, amount, options...)
}
func (this *Htx) CreateMarketSellOrderWs(symbol string, amount float64, options ...CreateMarketSellOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateMarketSellOrderWs(symbol, amount, options...)
}
func (this *Htx) CreateOrdersWs(orders []OrderRequest, options ...CreateOrdersWsOptions) ([]Order, error) {
	return this.exchangeTyped.CreateOrdersWs(orders, options...)
}
func (this *Htx) CreateOrderWithTakeProfitAndStopLossWs(symbol string, typeVar string, side string, amount float64, options ...CreateOrderWithTakeProfitAndStopLossWsOptions) (Order, error) {
	return this.exchangeTyped.CreateOrderWithTakeProfitAndStopLossWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreatePostOnlyOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreatePostOnlyOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreatePostOnlyOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateReduceOnlyOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateReduceOnlyOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateReduceOnlyOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateStopLimitOrderWs(symbol string, side string, amount float64, price float64, triggerPrice float64, options ...CreateStopLimitOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateStopLimitOrderWs(symbol, side, amount, price, triggerPrice, options...)
}
func (this *Htx) CreateStopLossOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateStopLossOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateStopLossOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateStopMarketOrderWs(symbol string, side string, amount float64, triggerPrice float64, options ...CreateStopMarketOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateStopMarketOrderWs(symbol, side, amount, triggerPrice, options...)
}
func (this *Htx) CreateStopOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateStopOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateStopOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTakeProfitOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateTakeProfitOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateTakeProfitOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTrailingAmountOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateTrailingAmountOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateTrailingAmountOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTrailingPercentOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateTrailingPercentOrderWsOptions) (Order, error) {
	return this.exchangeTyped.CreateTrailingPercentOrderWs(symbol, typeVar, side, amount, options...)
}
func (this *Htx) CreateTriggerOrderWs(symbol string, typeVar string, side string, amount float64, options ...CreateTriggerOrderWsOptions) (Order, error) {
...
func (this *Htx) FetchOHLCVWs(symbol string, options ...FetchOHLCVWsOptions) ([]OHLCV, error) {
	return this.exchangeTyped.FetchOHLCVWs(symbol, options...)
}
func (this *Htx) FetchOpenOrdersWs(options ...FetchOpenOrdersWsOptions) ([]Order, error) {
	return this.exchangeTyped.FetchOpenOrdersWs(options...)
}
func (this *Htx) FetchOrderBookWs(symbol string, options ...FetchOrderBookWsOptions) (OrderBook, error) {
	return this.exchangeTyped.FetchOrderBookWs(symbol, options...)
}
func (this *Htx) FetchOrdersByStatusWs(status string, options ...FetchOrdersByStatusWsOptions) ([]Order, error) {
	return this.exchangeTyped.FetchOrdersByStatusWs(status, options...)
}
func (this *Htx) FetchOrdersWs(options ...FetchOrdersWsOptions) ([]Order, error) {
	return this.exchangeTyped.FetchOrdersWs(options...)
}
func (this *Htx) FetchOrderWs(id string, options ...FetchOrderWsOptions) (Order, error) {
	return this.exchangeTyped.FetchOrderWs(id, options...)
}
func (this *Htx) FetchPositionsForSymbolWs(symbol string, options ...FetchPositionsForSymbolWsOptions) ([]Position, error) {
	return this.exchangeTyped.FetchPositionsForSymbolWs(symbol, options...)
}
func (this *Htx) FetchPositionsWs(options ...FetchPositionsWsOptions) ([]Position, error) {
	return this.exchangeTyped.FetchPositionsWs(options...)
}
func (this *Htx) FetchPositionWs(symbol string, options ...FetchPositionWsOptions) ([]Position, error) {
	return this.exchangeTyped.FetchPositionWs(symbol, options...)
}
func (this *Htx) FetchTickersWs(options ...FetchTickersWsOptions) (Tickers, error) {
	return this.exchangeTyped.FetchTickersWs(options...)
}
func (this *Htx) FetchTickerWs(symbol string, options ...FetchTickerWsOptions) (Ticker, error) {
...
func (this *Htx) WatchLiquidations(symbol string, options ...WatchLiquidationsOptions) ([]Liquidation, error) {
	return this.exchangeTyped.WatchLiquidations(symbol, options...)
}
func (this *Htx) WatchMarkPrice(symbol string, options ...WatchMarkPriceOptions) (Ticker, error) {
	return this.exchangeTyped.WatchMarkPrice(symbol, options...)
}
func (this *Htx) WatchMarkPrices(options ...WatchMarkPricesOptions) (Tickers, error) {
	return this.exchangeTyped.WatchMarkPrices(options...)
}
func (this *Htx) WatchMyLiquidations(symbol string, options ...WatchMyLiquidationsOptions) ([]Liquidation, error) {
	return this.exchangeTyped.WatchMyLiquidations(symbol, options...)
}
func (this *Htx) WatchMyLiquidationsForSymbols(symbols []string, options ...WatchMyLiquidationsForSymbolsOptions) ([]Liquidation, error) {
	return this.exchangeTyped.WatchMyLiquidationsForSymbols(symbols, options...)
}
func (this *Htx) WatchMyTrades(options ...WatchMyTradesOptions) ([]Trade, error) {
	return this.exchangeTyped.WatchMyTrades(options...)
}
func (this *Htx) WatchOHLCV(symbol string, options ...WatchOHLCVOptions) ([]OHLCV, error) {
	return this.exchangeTyped.WatchOHLCV(symbol, options...)
}
func (this *Htx) WatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...WatchOHLCVForSymbolsOptions) (map[string]map[string][]OHLCV, error) {
	return this.exchangeTyped.WatchOHLCVForSymbols(symbolsAndTimeframes, options...)
}
func (this *Htx) WatchOrderBook(symbol string, options ...WatchOrderBookOptions) (OrderBook, error) {
	return this.exchangeTyped.WatchOrderBook(symbol, options...)
}
func (this *Htx) WatchOrderBookForSymbols(symbols []string, options ...WatchOrderBookForSymbolsOptions) (OrderBook, error) {
	return this.exchangeTyped.WatchOrderBookForSymbols(symbols, options...)
}
func (this *Htx) WatchOrders(options ...WatchOrdersOptions) ([]Order, error) {
	return this.exchangeTyped.WatchOrders(options...)
}
func (this *Htx) WatchOrdersForSymbols(symbols []string, options ...WatchOrdersForSymbolsOptions) ([]Order, error) {
	return this.exchangeTyped.WatchOrdersForSymbols(symbols, options...)
}
func (this *Htx) WatchPosition(options ...WatchPositionOptions) (Position, error) {
	return this.exchangeTyped.WatchPosition(options...)
}
func (this *Htx) WatchPositions(options ...WatchPositionsOptions) ([]Position, error) {
	return this.exchangeTyped.WatchPositions(options...)
}
func (this *Htx) WatchTicker(symbol string, options ...WatchTickerOptions) (Ticker, error) {
	return this.exchangeTyped.WatchTicker(symbol, options...)
}
func (this *Htx) WatchTickers(options ...WatchTickersOptions) (Tickers, error) {
	return this.exchangeTyped.WatchTickers(options...)
}
func (this *Htx) WatchTrades(symbol string, options ...WatchTradesOptions) ([]Trade, error) {
	return this.exchangeTyped.WatchTrades(symbol, options...)
}
func (this *Htx) WatchTradesForSymbols(symbols []string, options ...WatchTradesForSymbolsOptions) ([]Trade, error) {
	return this.exchangeTyped.WatchTradesForSymbols(symbols, options...)
}
func (this *Htx) WithdrawWs(code string, amount float64, address string, options ...WithdrawWsOptions) (Transaction, error) {
