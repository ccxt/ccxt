...
func  (this *HtxCore) FetchOrder(id any, optionalArgs ...any) <- chan any {
            ...
            retRes39368 := (<-this.LoadMarkets())
            PanicOnError(retRes39368)
            var market any = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *HtxCore) FetchSpotOrdersByStates(states any, optionalArgs ...any) <- chan any {
            ...
            retRes41558 := (<-this.LoadMarkets())
            PanicOnError(retRes41558)
            var market any = nil
            var request any = map[string]any {
                "states": states,
            }
...
func  (this *HtxCore) FetchSpotOrders(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes422315 :=  (<-this.FetchSpotOrdersByStates("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))
                PanicOnError(retRes422315)
                ch <- retRes422315
                return nil
...
func  (this *HtxCore) FetchClosedSpotOrders(optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes422715 :=  (<-this.FetchSpotOrdersByStates("filled,partial-canceled,canceled", symbol, since, limit, params))
...
func  (this *HtxCore) FetchClosedContractOrders(optionalArgs ...any) <- chan any {
            ...
            var request any = map[string]any {
                ...
                retRes446815 :=  (<-this.FetchContractOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *HtxCore) FetchOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(contract) {
                    ...
                    retRes450419 :=  (<-this.FetchContractOrders(symbol, since, limit, params))
                    PanicOnError(retRes450419)
                    ch <- retRes450419
                    return nil
            } else {
        
                    retRes450619 :=  (<-this.FetchSpotOrders(symbol, since, limit, params))
                    PanicOnError(retRes450619)
                    ch <- retRes450619
                    return nil
            }
...
func  (this *HtxCore) FetchClosedOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes453319 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, 100))
            ...
            if IsTrue(IsEqual(marketType, "spot")) {
                    ...
                    retRes454219 :=  (<-this.FetchClosedSpotOrders(symbol, since, limit, params))
                    PanicOnError(retRes454219)
                    ch <- retRes454219
                    return nil
            } else {
        
                    retRes454419 :=  (<-this.FetchClosedContractOrders(symbol, since, limit, params))
                    PanicOnError(retRes454419)
                    ch <- retRes454419
                    return nil
            }
...
func  (this *HtxCore) FetchOpenOrders(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(IsEqual(marketType, "spot")) {
                ...
                if IsTrue(IsEqual(accountId, nil)) {
                    ...
                    retRes458416 := (<-this.LoadAccounts())
                    PanicOnError(retRes458416)
...
func  (this *HtxCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <- chan any {
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes532815 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                PanicOnError(retRes532815)
                ch <- retRes532815
                return nil
...
func  (this *HtxCore) CreateTrailingPercentOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes535415 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes535415)
                ch <- retRes535415
                return nil
...
func  (this *HtxCore) CreateSpotOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes53738 := (<-this.LoadMarkets())
            PanicOnError(retRes53738)
        
            retRes53748 := (<-this.LoadAccounts())
            PanicOnError(retRes53748)
            var market any = this.Market(symbol)
            var marginMode any = nil
...
func  (this *HtxCore) CreateOrders(orders any, optionalArgs ...any) <- chan any {
            ...
            retRes57698 := (<-this.LoadMarkets())
            PanicOnError(retRes57698)
...
func  (this *HtxCore) CancelOrder(id any, optionalArgs ...any) <- chan any {
            ...
            retRes58978 := (<-this.LoadMarkets())
            PanicOnError(retRes58978)
            var market any = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *HtxCore) CancelOrders(ids any, optionalArgs ...any) <- chan any {
            ...
            retRes60358 := (<-this.LoadMarkets())
            PanicOnError(retRes60358)
            var market any = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *HtxCore) FetchDepositAddressesByNetwork(code any, optionalArgs ...any) <- chan any {
            ...
            retRes64448 := (<-this.LoadMarkets())
            PanicOnError(retRes64448)
...
func  (this *HtxCore) FetchDepositAddress(code any, optionalArgs ...any) <- chan any {
            ...
            retRes64788 := (<-this.LoadMarkets())
            PanicOnError(retRes64788)
            var currency any = this.Currency(code)
...
func  (this *HtxCore) FetchWithdrawAddresses(code any, optionalArgs ...any) <- chan any {
            ...
            retRes64878 := (<-this.LoadMarkets())
            PanicOnError(retRes64878)
            var currency any = this.Currency(code)
            var request any = map[string]any {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *HtxCore) FetchDeposits(optionalArgs ...any) <- chan any {
            ...
            retRes65368 := (<-this.LoadMarkets())
            PanicOnError(retRes65368)
...
func  (this *HtxCore) FetchWithdrawals(optionalArgs ...any) <- chan any {
            ...
            retRes65978 := (<-this.LoadMarkets())
            PanicOnError(retRes65978)
            var currency any = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.Currency(code)
            }
...
func  (this *HtxCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <- chan any {
            ...
            retRes68698 := (<-this.LoadMarkets())
            PanicOnError(retRes68698)
            var currency any = this.Currency(code)
            var request any = map[string]any {
                "currency": GetValue(currency, "id"),
...
func  (this *HtxCore) FetchIsolatedBorrowRates(optionalArgs ...any) <- chan any {
            ...
            retRes69478 := (<-this.LoadMarkets())
            PanicOnError(retRes69478)
...
func  (this *HtxCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes704619 :=  (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "current_page", "page_index", 1, 50))
                    PanicOnError(retRes704619)
                    ch <- retRes704619
                    return nil
            }
        
            retRes70488 := (<-this.LoadMarkets())
            PanicOnError(retRes70488)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "contract_code": GetValue(market, "id"),
            }
...
func  (this *HtxCore) FetchFundingRate(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes71788 := (<-this.LoadMarkets())
            PanicOnError(retRes71788)
            var market any = this.Market(symbol)
            var request any = map[string]any {
                "contract_code": GetValue(market, "id"),
            }
...
func  (this *HtxCore) FetchFundingRates(optionalArgs ...any) <- chan any {
            ...
            retRes72218 := (<-this.LoadMarkets())
            PanicOnError(retRes72218)
            symbols = this.MarketSymbols(symbols)
...
func  (this *HtxCore) FetchBorrowInterest(optionalArgs ...any) <- chan any {
            ...
            retRes72798 := (<-this.LoadMarkets())
            PanicOnError(retRes72798)
            var marginMode any = nil
...
func  (this *HtxCore) FetchFundingHistory(optionalArgs ...any) <- chan any {
            ...
            retRes75808 := (<-this.LoadMarkets())
            PanicOnError(retRes75808)
            var market any = this.Market(symbol)
...
func  (this *HtxCore) SetLeverage(leverage any, optionalArgs ...any) <- chan any {
            ...
            retRes76728 := (<-this.LoadMarkets())
            PanicOnError(retRes76728)
            var market any = this.Market(symbol)
...
func  (this *HtxCore) FetchPositions(optionalArgs ...any) <- chan any {
            ...
            retRes78718 := (<-this.LoadMarkets())
            PanicOnError(retRes78718)
            symbols = this.MarketSymbols(symbols)
            var market any = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *HtxCore) FetchPosition(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes80128 := (<-this.LoadMarkets())
            PanicOnError(retRes80128)
            var market any = this.Market(symbol)
            var marginMode any = nil
...
func  (this *HtxCore) FetchLedger(optionalArgs ...any) <- chan any {
            ...
            retRes83338 := (<-this.LoadMarkets())
            PanicOnError(retRes83338)
            var paginate any = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes833719 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 500))
                    PanicOnError(retRes833719)
                    ch <- retRes833719
                    return nil
            }
...
func  (this *HtxCore) FetchLeverageTiers(optionalArgs ...any) <- chan any {
            ...
            retRes84088 := (<-this.LoadMarkets())
            PanicOnError(retRes84088)
...
func  (this *HtxCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes84908 := (<-this.LoadMarkets())
            PanicOnError(retRes84908)
...
func  (this *HtxCore) FetchOpenInterests(optionalArgs ...any) <- chan any {
            ...
            retRes86008 := (<-this.LoadMarkets())
            PanicOnError(retRes86008)
            symbols = this.MarketSymbols(symbols)
            var market any = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                var symbolsLength any =         GetArrayLength(symbols)
...
func  (this *HtxCore) FetchOpenInterest(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes86978 := (<-this.LoadMarkets())
            PanicOnError(retRes86978)
            var market any = this.Market(symbol)
            if !IsTrue(GetValue(market, "contract")) {
...
func  (this *HtxCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes89088 := (<-this.LoadMarkets())
            PanicOnError(retRes89088)
            var currency any = this.Currency(code)
            var request any = map[string]any {
                "currency": GetValue(currency, "id"),
                "amount": this.CurrencyToPrecision(code, amount),
...
func  (this *HtxCore) RepayIsolatedMargin(symbol any, code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes89418 := (<-this.LoadMarkets())
            PanicOnError(retRes89418)
            var currency any = this.Currency(code)
...
func  (this *HtxCore) RepayCrossMargin(code any, amount any, optionalArgs ...any) <- chan any {
            ...
            retRes89818 := (<-this.LoadMarkets())
            PanicOnError(retRes89818)
            var currency any = this.Currency(code)
...
func  (this *HtxCore) FetchDepositWithdrawFees(optionalArgs ...any) <- chan any {
            ...
            retRes91598 := (<-this.LoadMarkets())
            PanicOnError(retRes91598)
...
func  (this *HtxCore) FetchLiquidations(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes93778 := (<-this.LoadMarkets())
            PanicOnError(retRes93778)
            var market any = this.Market(symbol)
...
func  (this *HtxCore) ClosePosition(symbol any, optionalArgs ...any) <- chan any {
            ...
            retRes94818 := (<-this.LoadMarkets())
            PanicOnError(retRes94818)
            var market any = this.Market(symbol)
            var clientOrderId any = this.SafeString(params, "clientOrderId")
            if !IsTrue(GetValue(market, "contract")) {
...
func  (this *HtxCore) SetPositionMode(hedged any, optionalArgs ...any) <- chan any {
            ...
            retRes95358 := (<-this.LoadMarkets())
            PanicOnError(retRes95358)
...
func  (this *HtxCore) FetchPositionsADLRank(optionalArgs ...any) <- chan any {
            ...
            retRes96008 := (<-this.LoadMarkets())
            PanicOnError(retRes96008)
