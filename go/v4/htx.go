...
func (this *HtxCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(keys)); i++ {
		...
		if EvalTruthy(this.SafeBool(types, key)) {
			if IsEqual(key, "spot") {
...
func (this *HtxCore) TryGetSymbolFromFutureMarkets(symbolOrMarketId any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(futureMarkets)); i++ {
		...
		var constructedId any = Ternary(EvalTruthy(GetValue(market, "linear")), Add(Add(Add(Add(GetValue(market, "base"), "-"), GetValue(market, "quote")), "-"), contractSuffix), Add(Add(GetValue(market, "base"), "_"), contractSuffix))
...
func (this *HtxCore) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "linear")) {
		...
		PanicOnError(response)
	} else if EvalTruthy(GetValue(market, "inverse")) {
		if EvalTruthy(GetValue(market, "future")) {
			AddElementToObject(request, "symbol", GetValue(market, "id"))

			response = (<-this.ContractPublicGetMarketDetailMerged(this.Extend(request, params)))
			PanicOnError(response)
		} else if EvalTruthy(GetValue(market, "swap")) {
			AddElementToObject(request, "contract_code", GetValue(market, "id"))
...
func (this *HtxCore) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if InOp(response, "tick") {
		if !EvalTruthy(GetValue(response, "tick")) {
...
func (this *HtxCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		request = GetValue(requestparamsVariable, 0)
		params = GetValue(requestparamsVariable, 1)
		if EvalTruthy(this.SafeBool(market, "linear")) {
			...
			PanicOnError(response)
		} else if EvalTruthy(this.SafeBool(market, "inverse")) {
			if !IsEqual(limit, nil) {
...
func (this *HtxCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "future")) {
		if EvalTruthy(GetValue(market, "inverse")) {
			...
			PanicOnError(response)
		} else if EvalTruthy(GetValue(market, "linear")) {
			AddElementToObject(request, "contract_code", GetValue(market, "id"))
...
func (this *HtxCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes365012 := (<-this.LoadMarkets())
		PanicOnError(retRes365012)
	}
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
	...
	if IsEqual(marketType, "spot") {
		...
		var isAlgo bool = (EvalTruthy(trigger) || EvalTruthy(stopLoss) || EvalTruthy(takeProfit) || EvalTruthy(stopLossTakeProfit) || EvalTruthy(trailing))
		...
		if EvalTruthy(this.SafeBool(market, "linear")) {
			if isAlgo {
				...
				} else if EvalTruthy(trailing) {
					AddElementToObject(request, "type", "trailing_stop")
				} else if EvalTruthy(stopLossTakeProfit) {
					AddElementToObject(request, "type", "tpsl")
				} else if EvalTruthy(stopLoss) {
					AddElementToObject(request, "type", "sl")
				} else if EvalTruthy(takeProfit) {
...
func (this *HtxCore) fetchSpotOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes394815 := (<-this.FetchSpotOrdersByStates("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))
	PanicOnError(retRes394815)
	ch <- retRes394815
	return nil
}
...
func (this *HtxCore) fetchClosedSpotOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes395215 := (<-this.FetchSpotOrdersByStates("filled", symbol, since, limit, params))
...
func (this *HtxCore) fetchContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes396012 := (<-this.LoadMarkets())
		PanicOnError(retRes396012)
	}
	var market any = this.Market(symbol)
	var request any = map[string]any{}
	var response any = nil
	...
	if EvalTruthy(GetValue(market, "linear")) {
		...
		if EvalTruthy(GetValue(market, "swap")) {
			if EvalTruthy(trigger) {
		...
		} else if EvalTruthy(GetValue(market, "future")) {
...
func (this *HtxCore) fetchClosedContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes413415 := (<-this.FetchContractOrders(symbol, since, limit, this.Extend(request, params)))
	PanicOnError(retRes413415)
	ch <- retRes413415
	return nil
}
...
func (this *HtxCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes416112 := (<-this.LoadMarkets())
		PanicOnError(retRes416112)
	}
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
	...
	if contract {
		...
		retRes417419 := (<-this.FetchContractOrders(symbol, since, limit, params))
		PanicOnError(retRes417419)
		ch <- retRes417419
		return nil
	} else {

		retRes417619 := (<-this.FetchSpotOrders(symbol, since, limit, params))
		PanicOnError(retRes417619)
		ch <- retRes417619
		return nil
	}
}
...
func (this *HtxCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes420012 := (<-this.LoadMarkets())
		PanicOnError(retRes420012)
	}
	var paginate any = false
	...
	if EvalTruthy(paginate) {
		...
		retRes420519 := (<-this.FetchPaginatedCallDynamic("fetchCanceledOrders", symbol, since, limit, params, 100))
		PanicOnError(retRes420519)
		ch <- retRes420519
		return nil
	}
	var market any = nil
	...
	if IsEqual(marketType, "spot") {
		...
		retRes421419 := (<-this.FetchSpotOrdersByStates("partial-canceled,canceled", symbol, since, limit, params))
		PanicOnError(retRes421419)
		ch <- retRes421419
		return nil
	} else {
		if IsEqual(symbol, nil) {
		...
		retRes423519 := (<-this.FetchContractOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes423519)
		ch <- retRes423519
		return nil
	}
}
...
func (this *HtxCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes426419 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, 100))
		PanicOnError(retRes426419)
		ch <- retRes426419
		return nil
	}
	var market any = nil
	...
	if IsEqual(marketType, "spot") {
		...
		retRes427319 := (<-this.FetchClosedSpotOrders(symbol, since, limit, params))
		PanicOnError(retRes427319)
		ch <- retRes427319
		return nil
	} else {

		retRes427519 := (<-this.FetchClosedContractOrders(symbol, since, limit, params))
		PanicOnError(retRes427519)
		ch <- retRes427519
		return nil
	}
}
...
func (this *HtxCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		if accountId == nil {
			...
			retRes432016 := (<-this.LoadAccounts())
			PanicOnError(retRes432016)
		...
		params = this.Omit(params, []any{"stop", "stopLossTakeProfit", "trailing", "trigger", "stopLoss", "takeProfit"})
		if isLinear {
			if EvalTruthy(trigger) || EvalTruthy(trailing) || EvalTruthy(stopLossTakeProfit) || EvalTruthy(stopLoss) || EvalTruthy(takeProfit) {
				if EvalTruthy(trigger) {
					AddElementToObject(request, "type", "trigger")
				} else if EvalTruthy(trailing) {
					AddElementToObject(request, "type", "trailing_stop")
...
func (this *HtxCore) ParseOrder(order any, optionalArgs ...any) any {
	...
	var isLinearOrder bool = (contractCode != nil) && (!IsEqual(market, nil)) && EvalTruthy(GetValue(market, "linear")) && !EvalTruthy(GetValue(market, "spot"))
	var typeVar any = nil
	if isLinearOrder {
	...
	var cost any = nil
	var amount any = nil
	if (!IsEqual(typeVar, nil)) && (IsGreaterThanOrEqual(GetIndexOf(typeVar, "market"), 0)) && (!isLinearOrder) {
...
func (this *HtxCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes501415 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
	PanicOnError(retRes501415)
	ch <- retRes501415
	return nil
}
...
func (this *HtxCore) createTrailingPercentOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes504015 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
...
func (this *HtxCore) createSpotOrderRequestBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes506612 := (<-this.LoadMarkets())
		PanicOnError(retRes506612)
	}

	retRes50688 := (<-this.LoadAccounts())
...
func (this *HtxCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes541112 := (<-this.LoadMarkets())
		PanicOnError(retRes541112)
	}
	var market any = this.Market(symbol)
	var triggerPrice any = this.SafeNumberN(params, []any{"triggerPrice", "stopPrice", "trigger_price"})
	var stopLossTriggerPrice any = this.SafeNumber2(params, "stopLossPrice", "sl_trigger_price")
...
func (this *HtxCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes558912 := (<-this.LoadMarkets())
		PanicOnError(retRes558912)
	}
	...
	var request map[string]any = map[string]any{}
	var response any = nil
	if EvalTruthy(this.SafeBool(market, "spot")) {
		...
		if EvalTruthy(this.SafeBool(market, "linear")) {
			...
			if EvalTruthy(this.SafeBool(market, "swap")) {

				response = (<-this.ContractPrivatePostSwapApiV1SwapBatchorder(request))
				PanicOnError(response)
			} else if EvalTruthy(this.SafeBool(market, "future")) {
...
func (this *HtxCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		var clientOrderId *string = this.SafeStringN(params, []any{"client_order_id", "clientOrderId", "algo_client_order_id"})
		if !(isLinear && (EvalTruthy(trigger) || EvalTruthy(stopLossTakeProfit) || EvalTruthy(trailing))) {
			if clientOrderId == nil {
				AddElementToObject(request, "order_id", id)
			} else {
				AddElementToObject(request, "client_order_id", clientOrderId)
		...
		if EvalTruthy(this.SafeBool(market, "future")) {
			AddElementToObject(request, "symbol", this.SafeString(market, "settleId"))
		} else {
			AddElementToObject(request, "contract_code", this.SafeString(market, "id"))
		}
		if isLinear {
			if EvalTruthy(trigger) || EvalTruthy(stopLossTakeProfit) || EvalTruthy(trailing) {
...
func (this *HtxCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes592612 := (<-this.LoadMarkets())
		PanicOnError(retRes592612)
	}
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
	...
	//     }
	//
	if EvalTruthy(this.SafeBool(market, "linear")) && !EvalTruthy(trigger) && !EvalTruthy(stopLossTakeProfit) {
...
func (this *HtxCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes620212 := (<-this.LoadMarkets())
		PanicOnError(retRes620212)
	}
	var market any = nil
	if !IsEqual(symbol, nil) {
		market = this.Market(symbol)
	...
	if IsEqual(marketType, "spot") {
		...
		//     }
		//
		if EvalTruthy(this.SafeBool(market, "linear")) && (!EvalTruthy(trigger) && !EvalTruthy(trailing) && !EvalTruthy(stopLossTakeProfit)) {
...
func (this *HtxCore) cancelAllOrdersAfterBody(ch chan any, timeout any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes632912 := (<-this.LoadMarkets())
		PanicOnError(retRes632912)
	}
...
func (this *HtxCore) fetchDepositAddressesByNetworkBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes638912 := (<-this.LoadMarkets())
		PanicOnError(retRes638912)
	}
...
func (this *HtxCore) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes642512 := (<-this.LoadMarkets())
		PanicOnError(retRes642512)
	}
	var currency any = this.Currency(code)
...
func (this *HtxCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes648712 := (<-this.LoadMarkets())
		PanicOnError(retRes648712)
	}
...
func (this *HtxCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes655112 := (<-this.LoadMarkets())
		PanicOnError(retRes655112)
	}
	var currency any = nil
	if !IsEqual(code, nil) {
		currency = this.Currency(code)
...
func (this *HtxCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes697312 := (<-this.LoadMarkets())
		PanicOnError(retRes697312)
	}
	var currency any = nil
	var request map[string]any = map[string]any{}
	if !IsEqual(code, nil) {
...
func (this *HtxCore) fetchIsolatedBorrowRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes702712 := (<-this.LoadMarkets())
		PanicOnError(retRes702712)
	}
...
func (this *HtxCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes712819 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "current_page", "page_index", 1, 50))
...
func (this *HtxCore) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes731212 := (<-this.LoadMarkets())
		PanicOnError(retRes731212)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"contract_code": GetValue(market, "id"),
...
func (this *HtxCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if !IsEqual(symbols, nil) {
		...
		subType = Ternary(EvalTruthy(isLinear), "linear", "inverse")
	}
	var request map[string]any = map[string]any{}
	var response any = nil
	if IsEqual(subType, "linear") {
...
func (this *HtxCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes743912 := (<-this.LoadMarkets())
		PanicOnError(retRes743912)
	}
	var marginMode any = nil
...
func (this *HtxCore) Sign(path any, optionalArgs ...any) any {
	...
	if IsString(api) {
		...
		if IsEqual(api, "private") || IsEqual(api, "v2Private") {
			...
			if (!IsEqual(query, nil)) && EvalTruthy(GetArrayLength(ObjectKeys(query))) {
		...
		if access != nil && *access == "public" {
			...
			if IsEqual(method, "POST") {
				...
				body = this.Json(bodyRequest)
				if !isArrayParams && (IsEqual(GetLength(body), 2)) {
					body = "{}"
				}
				headers = map[string]any{
					"Content-Type": "application/json",
...
func (this *HtxCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes776312 := (<-this.LoadMarkets())
		PanicOnError(retRes776312)
	}
	var market any = this.Market(symbol)
	var marketType any = nil
...
func (this *HtxCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes785912 := (<-this.LoadMarkets())
		PanicOnError(retRes785912)
	}
	var market any = this.Market(symbol)
	...
	if IsEqual(marketType, "future") && EvalTruthy(GetValue(market, "inverse")) {
		AddElementToObject(request, "symbol", GetValue(market, "settleId"))
	} else {
		AddElementToObject(request, "contract_code", GetValue(market, "id"))
	}
...
func (this *HtxCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes811912 := (<-this.LoadMarkets())
		PanicOnError(retRes811912)
	}
	symbols = this.MarketSymbols(symbols)
	var market any = nil
	if !IsEqual(symbols, nil) {
...
func (this *HtxCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes825912 := (<-this.LoadMarkets())
		PanicOnError(retRes825912)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
	...
	query := GetValue(marketTypequeryVariable, 1)
	var request map[string]any = map[string]any{}
	if EvalTruthy(GetValue(market, "future")) && EvalTruthy(GetValue(market, "inverse")) {
		AddElementToObject(request, "symbol", GetValue(market, "settleId"))
	} else {
		if !EvalTruthy(GetValue(market, "linear")) && (IsEqual(marginMode, "cross")) {
...
func (this *HtxCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(paginate) {
		...
		retRes850119 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 500))
		PanicOnError(retRes850119)
		ch <- retRes850119
		return nil
	}
...
func (this *HtxCore) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes857312 := (<-this.LoadMarkets())
		PanicOnError(retRes857312)
	}
...
func (this *HtxCore) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes865712 := (<-this.LoadMarkets())
		PanicOnError(retRes865712)
	}
...
func (this *HtxCore) fetchOpenInterestsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes876812 := (<-this.LoadMarkets())
		PanicOnError(retRes876812)
	}
	symbols = this.MarketSymbols(symbols)
	var market any = nil
	if !IsEqual(symbols, nil) {
...
func (this *HtxCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "option")) {
...
func (this *HtxCore) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes901712 := (<-this.LoadMarkets())
		PanicOnError(retRes901712)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *HtxCore) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes905412 := (<-this.LoadMarkets())
		PanicOnError(retRes905412)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"currency": GetValue(currency, "id"),
...
func (this *HtxCore) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes908912 := (<-this.LoadMarkets())
		PanicOnError(retRes908912)
	}
	var currency any = this.Currency(code)
...
func (this *HtxCore) repayCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes913112 := (<-this.LoadMarkets())
		PanicOnError(retRes913112)
	}
	var currency any = this.Currency(code)
...
func (this *HtxCore) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if !IsEqual(limit, nil) {
		if EvalTruthy(GetValue(market, "linear")) && EvalTruthy(GetValue(market, "swap")) {
			AddElementToObject(request, "limit", limit)
		} else {
			AddElementToObject(request, "page_size", limit)
		}
...
func (this *HtxCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes933312 := (<-this.LoadMarkets())
		PanicOnError(retRes933312)
	}
...
func (this *HtxCore) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes972712 := (<-this.LoadMarkets())
		PanicOnError(retRes972712)
	}
	var market any = this.Market(symbol)
	var clientOrderId *string = this.SafeString(params, "clientOrderId")
	if !EvalTruthy(GetValue(market, "contract")) {
...
func (this *HtxCore) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	if (!IsEqual(market, nil)) && EvalTruthy((GetValue(market, "inverse"))) {
...
func (this *HtxCore) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(this.Markets, nil) {
		...
		retRes983612 := (<-this.LoadMarkets())
		PanicOnError(retRes983612)
	}
