...
func (this *HtxCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsTrue(isMultiAssetMode) || IsTrue((IsTrue(linear) && IsTrue((IsTrue(swap) || IsTrue(future)))))) {
		...
		if IsTrue(margin) {
			...
			retRes341416 := (<-this.LoadAccounts())
			PanicOnError(retRes341416)
...
func (this *HtxCore) fetchSpotOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes395315 := (<-this.FetchSpotOrdersByStates("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))
	PanicOnError(retRes395315)
	ch <- retRes395315
	return nil
}
...
func (this *HtxCore) fetchClosedSpotOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes395715 := (<-this.FetchSpotOrdersByStates("filled", symbol, since, limit, params))
	PanicOnError(retRes395715)
	ch <- retRes395715
	return nil
}
...
func (this *HtxCore) fetchContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes396512 := (<-this.LoadMarkets())
		PanicOnError(retRes396512)
	}
	var market any = this.Market(symbol)
	var request any = map[string]any{}
	var response any = nil
...
func (this *HtxCore) fetchClosedContractOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes413915 := (<-this.FetchContractOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *HtxCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(contract) {
		...
		retRes417919 := (<-this.FetchContractOrders(symbol, since, limit, params))
		PanicOnError(retRes417919)
		ch <- retRes417919
		return nil
	} else {

		retRes418119 := (<-this.FetchSpotOrders(symbol, since, limit, params))
		PanicOnError(retRes418119)
		ch <- retRes418119
		return nil
	}
}
...
func (this *HtxCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes420512 := (<-this.LoadMarkets())
		PanicOnError(retRes420512)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes421019 := (<-this.FetchPaginatedCallDynamic("fetchCanceledOrders", symbol, since, limit, params, 100))
		PanicOnError(retRes421019)
		ch <- retRes421019
		return nil
	}
	var market any = nil
	...
	if IsTrue(IsEqual(marketType, "spot")) {
		...
		retRes421919 := (<-this.FetchSpotOrdersByStates("partial-canceled,canceled", symbol, since, limit, params))
		PanicOnError(retRes421919)
		ch <- retRes421919
		return nil
	} else {
		if IsTrue(IsEqual(symbol, nil)) {
		...
		retRes424019 := (<-this.FetchContractOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes424019)
		ch <- retRes424019
		return nil
	}
}
...
func (this *HtxCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes426919 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, 100))
	...
	if IsTrue(IsEqual(marketType, "spot")) {
		...
		retRes427819 := (<-this.FetchClosedSpotOrders(symbol, since, limit, params))
		PanicOnError(retRes427819)
		ch <- retRes427819
		return nil
	} else {

		retRes428019 := (<-this.FetchClosedContractOrders(symbol, since, limit, params))
		PanicOnError(retRes428019)
		ch <- retRes428019
		return nil
	}
}
...
func (this *HtxCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes430412 := (<-this.LoadMarkets())
		PanicOnError(retRes430412)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
		market = this.Market(symbol)
	...
	if IsTrue(IsEqual(marketType, "spot")) {
		...
		if IsTrue(IsEqual(accountId, nil)) {
			...
			retRes432516 := (<-this.LoadAccounts())
			PanicOnError(retRes432516)
...
func (this *HtxCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes501915 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
	PanicOnError(retRes501915)
	ch <- retRes501915
	return nil
}
...
func (this *HtxCore) createTrailingPercentOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes504515 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
	PanicOnError(retRes504515)
	ch <- retRes504515
	return nil
}
...
func (this *HtxCore) createSpotOrderRequestBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes507112 := (<-this.LoadMarkets())
		PanicOnError(retRes507112)
	}

	retRes50738 := (<-this.LoadAccounts())
	PanicOnError(retRes50738)
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *HtxCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes541612 := (<-this.LoadMarkets())
		PanicOnError(retRes541612)
	}
	var market any = this.Market(symbol)
	var triggerPrice any = this.SafeNumberN(params, []any{"triggerPrice", "stopPrice", "trigger_price"})
	var stopLossTriggerPrice any = this.SafeNumber2(params, "stopLossPrice", "sl_trigger_price")
...
func (this *HtxCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes559412 := (<-this.LoadMarkets())
		PanicOnError(retRes559412)
	}
...
func (this *HtxCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes575112 := (<-this.LoadMarkets())
		PanicOnError(retRes575112)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
		market = this.Market(symbol)
...
func (this *HtxCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes593112 := (<-this.LoadMarkets())
		PanicOnError(retRes593112)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
		market = this.Market(symbol)
...
func (this *HtxCore) fetchDepositAddressesByNetworkBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes639412 := (<-this.LoadMarkets())
		PanicOnError(retRes639412)
	}
...
func (this *HtxCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes649212 := (<-this.LoadMarkets())
		PanicOnError(retRes649212)
	}
...
func (this *HtxCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes655612 := (<-this.LoadMarkets())
		PanicOnError(retRes655612)
	}
	var currency any = nil
	if IsTrue(!IsEqual(code, nil)) {
		currency = this.Currency(code)
...
func (this *HtxCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes688412 := (<-this.LoadMarkets())
		PanicOnError(retRes688412)
	}
	var currency any = this.Currency(code)
...
func (this *HtxCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes697812 := (<-this.LoadMarkets())
		PanicOnError(retRes697812)
	}
	var currency any = nil
	var request map[string]any = map[string]any{}
	if IsTrue(!IsEqual(code, nil)) {
...
func (this *HtxCore) fetchIsolatedBorrowRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes703212 := (<-this.LoadMarkets())
		PanicOnError(retRes703212)
	}
...
func (this *HtxCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes713319 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "current_page", "page_index", 1, 50))
		PanicOnError(retRes713319)
		ch <- retRes713319
		return nil
	}
	if IsTrue(IsEqual(this.Markets, nil)) {

		retRes713612 := (<-this.LoadMarkets())
		PanicOnError(retRes713612)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"contract_code": GetValue(market, "id"),
...
func (this *HtxCore) fetchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes731712 := (<-this.LoadMarkets())
		PanicOnError(retRes731712)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"contract_code": GetValue(market, "id"),
...
func (this *HtxCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes738412 := (<-this.LoadMarkets())
		PanicOnError(retRes738412)
	}
	symbols = this.MarketSymbols(symbols)
...
func (this *HtxCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes744412 := (<-this.LoadMarkets())
		PanicOnError(retRes744412)
	}
	var marginMode any = nil
...
func (this *HtxCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes776912 := (<-this.LoadMarkets())
		PanicOnError(retRes776912)
	}
	var market any = this.Market(symbol)
	var marketType any = nil
...
func (this *HtxCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes786512 := (<-this.LoadMarkets())
		PanicOnError(retRes786512)
	}
	var market any = this.Market(symbol)
...
func (this *HtxCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes812512 := (<-this.LoadMarkets())
		PanicOnError(retRes812512)
	}
	symbols = this.MarketSymbols(symbols)
	var market any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *HtxCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes826512 := (<-this.LoadMarkets())
		PanicOnError(retRes826512)
	}
	var market any = this.Market(symbol)
	var marginMode any = nil
...
func (this *HtxCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes850212 := (<-this.LoadMarkets())
		PanicOnError(retRes850212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes850719 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 500))
		PanicOnError(retRes850719)
		ch <- retRes850719
		return nil
	}
...
func (this *HtxCore) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes857912 := (<-this.LoadMarkets())
		PanicOnError(retRes857912)
	}
...
func (this *HtxCore) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes866312 := (<-this.LoadMarkets())
		PanicOnError(retRes866312)
	}
...
func (this *HtxCore) fetchOpenInterestsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes877412 := (<-this.LoadMarkets())
		PanicOnError(retRes877412)
	}
	symbols = this.MarketSymbols(symbols)
	var market any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *HtxCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes885012 := (<-this.LoadMarkets())
		PanicOnError(retRes885012)
	}
	var market any = this.Market(symbol)
	if IsTrue(!IsEqual(GetValue(market, "contract"), true)) {
...
func (this *HtxCore) borrowIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes902312 := (<-this.LoadMarkets())
		PanicOnError(retRes902312)
	}
	var currency any = this.Currency(code)
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *HtxCore) borrowCrossMarginBody(ch chan any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes906012 := (<-this.LoadMarkets())
		PanicOnError(retRes906012)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"currency": GetValue(currency, "id"),
...
func (this *HtxCore) repayIsolatedMarginBody(ch chan any, symbol any, code any, amount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes909512 := (<-this.LoadMarkets())
		PanicOnError(retRes909512)
	}
	var currency any = this.Currency(code)
...
func (this *HtxCore) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes933912 := (<-this.LoadMarkets())
		PanicOnError(retRes933912)
	}
...
func (this *HtxCore) fetchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes958712 := (<-this.LoadMarkets())
		PanicOnError(retRes958712)
	}
	var market any = this.Market(symbol)
