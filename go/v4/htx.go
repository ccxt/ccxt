...
func (this *HtxCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes178412 := (<-this.LoadTimeDifference())
...
func (this *HtxCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes282915 := (<-this.FetchSpotOrderTrades(id, symbol, since, limit, params))
...
func (this *HtxCore) FetchMyTrades(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes287419 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
			PanicOnError(retRes287419)
			ch <- retRes287419
			return nil
		}
		var market interface{} = nil
...
func (this *HtxCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes314919 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
			PanicOnError(retRes314919)
			ch <- retRes314919
			return nil
		}
		var market interface{} = this.Market(symbol)
...
func (this *HtxCore) FetchBalance(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes35268 := (<-this.LoadMarkets())
		PanicOnError(retRes35268)
		var typeVar interface{} = nil
		...
		if IsTrue(IsTrue(spot) || IsTrue(margin)) {
			if IsTrue(margin) {
				...
				retRes355516 := (<-this.LoadAccounts())
				PanicOnError(retRes355516)
...
func (this *HtxCore) FetchSpotOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes413715 := (<-this.FetchSpotOrdersByStates("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))
		PanicOnError(retRes413715)
		ch <- retRes413715
		return nil
...
func (this *HtxCore) FetchClosedSpotOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes414115 := (<-this.FetchSpotOrdersByStates("filled,partial-canceled,canceled", symbol, since, limit, params))
		PanicOnError(retRes414115)
		ch <- retRes414115
		return nil
...
func (this *HtxCore) FetchClosedContractOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes438215 := (<-this.FetchContractOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes438215)
		ch <- retRes438215
		return nil
...
func (this *HtxCore) FetchOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(contract) {
			...
			retRes441819 := (<-this.FetchContractOrders(symbol, since, limit, params))
			PanicOnError(retRes441819)
			ch <- retRes441819
			return nil
		} else {

			retRes442019 := (<-this.FetchSpotOrders(symbol, since, limit, params))
			PanicOnError(retRes442019)
			ch <- retRes442019
			return nil
		}
...
func (this *HtxCore) FetchClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes444719 := (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params, 100))
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes445619 := (<-this.FetchClosedSpotOrders(symbol, since, limit, params))
			PanicOnError(retRes445619)
			ch <- retRes445619
			return nil
		} else {

			retRes445819 := (<-this.FetchClosedContractOrders(symbol, since, limit, params))
			PanicOnError(retRes445819)
			ch <- retRes445819
			return nil
		}
...
func (this *HtxCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes44798 := (<-this.LoadMarkets())
		PanicOnError(retRes44798)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			if IsTrue(IsEqual(accountId, nil)) {
				...
				retRes449816 := (<-this.LoadAccounts())
				PanicOnError(retRes449816)
...
func (this *HtxCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes524215 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes524215)
		ch <- retRes524215
		return nil
...
func (this *HtxCore) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes526815 := (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
		PanicOnError(retRes526815)
		ch <- retRes526815
		return nil
...
func (this *HtxCore) CreateSpotOrderRequest(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes52878 := (<-this.LoadMarkets())
		PanicOnError(retRes52878)

		retRes52888 := (<-this.LoadAccounts())
...
func (this *HtxCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes55328 := (<-this.LoadMarkets())
		PanicOnError(retRes55328)
		var market interface{} = this.Market(symbol)
		var triggerPrice interface{} = this.SafeNumberN(params, []interface{}{"triggerPrice", "stopPrice", "trigger_price"})
		var stopLossTriggerPrice interface{} = this.SafeNumber2(params, "stopLossPrice", "sl_trigger_price")
		var takeProfitTriggerPrice interface{} = this.SafeNumber2(params, "takeProfitPrice", "tp_trigger_price")
...
func (this *HtxCore) CreateOrders(orders interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes56838 := (<-this.LoadMarkets())
		PanicOnError(retRes56838)
...
func (this *HtxCore) CancelOrder(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes58118 := (<-this.LoadMarkets())
		PanicOnError(retRes58118)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
...
func (this *HtxCore) CancelOrders(ids interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes59498 := (<-this.LoadMarkets())
		PanicOnError(retRes59498)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
...
func (this *HtxCore) CancelAllOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes61738 := (<-this.LoadMarkets())
		PanicOnError(retRes61738)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		}
...
func (this *HtxCore) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes63588 := (<-this.LoadMarkets())
		PanicOnError(retRes63588)
...
func (this *HtxCore) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes63928 := (<-this.LoadMarkets())
		PanicOnError(retRes63928)
		var currency interface{} = this.Currency(code)
...
func (this *HtxCore) FetchWithdrawAddresses(code interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes64018 := (<-this.LoadMarkets())
		PanicOnError(retRes64018)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"currency": GetValue(currency, "id"),
		}
...
func (this *HtxCore) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes66908 := (<-this.LoadMarkets())
		PanicOnError(retRes66908)
		this.CheckAddress(address)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"address":  address,
...
func (this *HtxCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes696019 := (<-this.FetchPaginatedCallCursor("fetchFundingRateHistory", symbol, since, limit, params, "current_page", "page_index", 1, 50))
			PanicOnError(retRes696019)
			ch <- retRes696019
			return nil
		}

		retRes69628 := (<-this.LoadMarkets())
		PanicOnError(retRes69628)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"contract_code": GetValue(market, "id"),
		}
...
func (this *HtxCore) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes70928 := (<-this.LoadMarkets())
		PanicOnError(retRes70928)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"contract_code": GetValue(market, "id"),
		}
...
func (this *HtxCore) FetchFundingRates(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes71358 := (<-this.LoadMarkets())
		PanicOnError(retRes71358)
		symbols = this.MarketSymbols(symbols)
...
func (this *HtxCore) FetchFundingHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes74918 := (<-this.LoadMarkets())
		PanicOnError(retRes74918)
		var market interface{} = this.Market(symbol)
...
func (this *HtxCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes75838 := (<-this.LoadMarkets())
		PanicOnError(retRes75838)
		var market interface{} = this.Market(symbol)
...
func (this *HtxCore) FetchPositions(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes77828 := (<-this.LoadMarkets())
		PanicOnError(retRes77828)
		symbols = this.MarketSymbols(symbols)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *HtxCore) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes79238 := (<-this.LoadMarkets())
		PanicOnError(retRes79238)
		var market interface{} = this.Market(symbol)
		var marginMode interface{} = nil
...
func (this *HtxCore) FetchLedger(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes824819 := (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 500))
			PanicOnError(retRes824819)
			ch <- retRes824819
			return nil
		}
...
func (this *HtxCore) FetchLeverageTiers(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes83198 := (<-this.LoadMarkets())
		PanicOnError(retRes83198)
...
func (this *HtxCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes84018 := (<-this.LoadMarkets())
		PanicOnError(retRes84018)
...
func (this *HtxCore) FetchOpenInterests(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes85118 := (<-this.LoadMarkets())
		PanicOnError(retRes85118)
		symbols = this.MarketSymbols(symbols)
		var market interface{} = nil
		if IsTrue(!IsEqual(symbols, nil)) {
			var symbolsLength interface{} = GetArrayLength(symbols)
...
func (this *HtxCore) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes87848 := (<-this.LoadMarkets())
		PanicOnError(retRes87848)
		var currency interface{} = this.Currency(code)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"currency": GetValue(currency, "id"),
...
func (this *HtxCore) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes88198 := (<-this.LoadMarkets())
		PanicOnError(retRes88198)
		var currency interface{} = this.Currency(code)
		var request interface{} = map[string]interface{}{
			"currency": GetValue(currency, "id"),
			"amount":   this.CurrencyToPrecision(code, amount),
...
func (this *HtxCore) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes88528 := (<-this.LoadMarkets())
		PanicOnError(retRes88528)
		var currency interface{} = this.Currency(code)
...
func (this *HtxCore) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes88928 := (<-this.LoadMarkets())
		PanicOnError(retRes88928)
		var currency interface{} = this.Currency(code)
...
func (this *HtxCore) FetchDepositWithdrawFees(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes90708 := (<-this.LoadMarkets())
		PanicOnError(retRes90708)
...
func (this *HtxCore) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes92888 := (<-this.LoadMarkets())
		PanicOnError(retRes92888)
		var market interface{} = this.Market(symbol)
...
func (this *HtxCore) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes93928 := (<-this.LoadMarkets())
		PanicOnError(retRes93928)
		var market interface{} = this.Market(symbol)
		var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
		if !IsTrue(GetValue(market, "contract")) {
...
func (this *HtxCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes94468 := (<-this.LoadMarkets())
		PanicOnError(retRes94468)
