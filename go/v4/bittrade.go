...
func (this *BittradeCore) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes76212 := (<-this.LoadMarkets())
			PanicOnError(retRes76212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BittradeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130715 := (<-this.FetchOrdersByStates("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))
...
func (this *BittradeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes132215 := (<-this.CallDynamically(method, symbol, since, limit, params))
		PanicOnError(retRes132215)
		ch <- retRes132215
		return nil
...
func (this *BittradeCore) FetchOpenOrdersV1(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes132915 := (<-this.FetchOrdersByStates("pre-submitted,submitted,partial-filled", symbol, since, limit, params))
...
func (this *BittradeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes134315 := (<-this.FetchOrdersByStates("filled,partial-canceled,canceled", symbol, since, limit, params))
...
func (this *BittradeCore) FetchOpenOrdersV2(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(accountId, nil)) {
			...
			retRes135912 := (<-this.LoadAccounts())
...
func (this *BittradeCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes151415 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes151415)
		ch <- retRes151415
		return nil
