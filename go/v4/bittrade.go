 ...
 */
func (this *BittradeCore) FetchTime(optionalArgs ...any) <-chan Res[*int64] {
...
func (this *BittradeCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes133615 := (<-this.FetchOrdersByStates("pre-submitted,submitted,partial-filled,filled,partial-canceled,canceled", symbol, since, limit, params))
		PanicOnError(retRes133615)
		ch <- retRes133615
		return nil
...
func (this *BittradeCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes135115 := (<-this.CallDynamically(method, symbol, since, limit, params))
...
func (this *BittradeCore) FetchOpenOrdersV1(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes135815 := (<-this.FetchOrdersByStates("pre-submitted,submitted,partial-filled", symbol, since, limit, params))
...
func (this *BittradeCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes137215 := (<-this.FetchOrdersByStates("filled,partial-canceled,canceled", symbol, since, limit, params))
...
func (this *BittradeCore) FetchOpenOrdersV2(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(accountId, nil)) {
			...
			retRes138812 := (<-this.LoadAccounts())
...
func (this *BittradeCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes154315 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
