...
func (this *Bittrade) FetchOrdersByStates(states any, options ...FetchOrdersByStatesOptions) ([]Order, error) {
	...
	res := <-this.FetchOrdersByStatesAsync(states, opts.Symbol, opts.Since, opts.Limit, opts.Params)
	if IsError(res) {
		return nil, CreateReturnError(res)
	}
...
func (this *Bittrade) FetchOpenOrdersV1(options ...FetchOpenOrdersV1Options) ([]Order, error) {
	...
	res := <-this.FetchOpenOrdersV1Async(opts.Symbol, opts.Since, opts.Limit, opts.Params)
	if IsError(res) {
		return nil, CreateReturnError(res)
	}
	return NewOrderArray(res), nil
...
func (this *Bittrade) FetchOpenOrdersV2(options ...FetchOpenOrdersV2Options) ([]Order, error) {
	...
	res := <-this.FetchOpenOrdersV2Async(opts.Symbol, opts.Since, opts.Limit, opts.Params)
	if IsError(res) {
		return nil, CreateReturnError(res)
	}
	return NewOrderArray(res), nil
