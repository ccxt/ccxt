...
func (this *CoinbaseCore) ParseContractMarket(market any, feeTier any) any {
	...
	var taker any = Ternary((!IsEqual(takerFeeRate, nil) && !IsEqual(takerFeeRate, nil) && (takerFeeRate != 0)), takerFeeRate, this.ParseNumber("0.06"))
	var maker any = Ternary((!IsEqual(makerFeeRate, nil) && !IsEqual(makerFeeRate, nil) && (makerFeeRate != 0)), makerFeeRate, this.ParseNumber("0.04"))
	return this.SafeMarketStructure(map[string]any{
		"id":             id,
		"symbol":         symbol,
		"base":           base,
...
func (this *CoinbaseCore) fetchTickersV3Body(ch chan any, optionalArgs ...any) any {
	...
	if !IsEqual(marketType, nil) && (marketType != "default") {
		AddElementToObject(request, "product_type", Ternary((marketType == "swap"), "FUTURE", "SPOT"))
	}
	var response any = nil
	var usePrivate any = false
