...
func  (this *coinbase) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchAccountsV3")) {
                    ...
                    retRes463405 :=  (<-this.FetchAccountsV3(params))
                    PanicOnError(retRes463405)
                    ch <- retRes463405
                    return nil
            }
        
                retRes148603 :=  (<-this.FetchAccountsV2(params))
                PanicOnError(retRes148603)
                ch <- retRes148603
                return nil
...
func  (this *coinbase) FetchAccountsV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes237283 := (<-this.LoadMarkets())
            PanicOnError(retRes237283)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes171171 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes171171)
                    ch <- retRes171171
                    return nil
            }
...
func  (this *coinbase) FetchAccountsV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes696280 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "cursor", "cursor", nil, 250))
...
func  (this *coinbase) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(accountId, nil)) {
                ...
                retRes922134 := (<-this.LoadAccounts())
                PanicOnError(retRes922134)
...
func  (this *coinbase) FetchMySells(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes67364 := (<-this.LoadMarkets())
            PanicOnError(retRes67364)
...
func  (this *coinbase) FetchMyBuys(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348571 := (<-this.LoadMarkets())
            PanicOnError(retRes348571)
            var query interface{} = this.Omit(params, []interface{}{"account_id", "accountId"})
...
func  (this *coinbase) FetchTransactionsWithMethod(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980652 := (<-this.LoadMarkets())
            PanicOnError(retRes980652)
...
func  (this *coinbase) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes903152 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdWithdrawals", code, since, limit, params))
                PanicOnError(retRes903152)
                ch <- retRes903152
                return nil
...
func  (this *coinbase) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes288427 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdDeposits", code, since, limit, params))
                PanicOnError(retRes288427)
                ch <- retRes288427
                return nil
...
func  (this *coinbase) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes572366 := (<-this.LoadMarkets())
            PanicOnError(retRes572366)
...
func  (this *coinbase) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes640340 := (<-this.LoadTimeDifference())
                PanicOnError(retRes640340)
            }
            var method interface{} = this.SafeString(this.Options, "fetchMarkets", "fetchMarketsV3")
            if IsTrue(IsEqual(method, "fetchMarketsV3")) {
        
                    retRes537127 :=  (<-this.FetchMarketsV3(params))
                    PanicOnError(retRes537127)
                    ch <- retRes537127
                    return nil
            }
        
                retRes304132 :=  (<-this.FetchMarketsV2(params))
                PanicOnError(retRes304132)
                ch <- retRes304132
                return nil
...
func  (this *coinbase) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickersV3")) {
                    ...
                    retRes262358 :=  (<-this.FetchTickersV3(symbols, params))
                    PanicOnError(retRes262358)
                    ch <- retRes262358
                    return nil
            }
        
                retRes180125 :=  (<-this.FetchTickersV2(symbols, params))
                PanicOnError(retRes180125)
                ch <- retRes180125
                return nil
...
func  (this *coinbase) FetchTickersV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes581446 := (<-this.LoadMarkets())
            PanicOnError(retRes581446)
...
func  (this *coinbase) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickerV3")) {
                    ...
                    retRes221889 :=  (<-this.FetchTickerV3(symbol, params))
                    PanicOnError(retRes221889)
                    ch <- retRes221889
                    return nil
            }
        
                retRes912174 :=  (<-this.FetchTickerV2(symbol, params))
                PanicOnError(retRes912174)
                ch <- retRes912174
                return nil
...
func  (this *coinbase) FetchTickerV2(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes622653 := (<-this.LoadMarkets())
            PanicOnError(retRes622653)
...
func  (this *coinbase) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes296191 := (<-this.LoadMarkets())
            PanicOnError(retRes296191)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
...
func  (this *coinbase) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875470 := (<-this.LoadMarkets())
            PanicOnError(retRes875470)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes32839 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes32839)
                    ch <- retRes32839
                    return nil
            }
...
func  (this *coinbase) FindAccountId(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes495663 := (<-this.LoadMarkets())
            PanicOnError(retRes495663)
        
            retRes283061 := (<-this.LoadAccounts(false, params))
...
func  (this *coinbase) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes863533 := (<-this.LoadMarkets())
            PanicOnError(retRes863533)
            var market interface{} = this.Market(symbol)
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes402750 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                PanicOnError(retRes402750)
                ch <- retRes402750
                return nil
...
func  (this *coinbase) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes372012 := (<-this.LoadMarkets())
            PanicOnError(retRes372012)
...
func  (this *coinbase) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes805538 := (<-this.LoadMarkets())
            PanicOnError(retRes805538)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *coinbase) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes79746 := (<-this.LoadMarkets())
            PanicOnError(retRes79746)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbase) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes773948 := (<-this.LoadMarkets())
            PanicOnError(retRes773948)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes795937 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))
...
func  (this *coinbase) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes218837 := (<-this.LoadMarkets())
            PanicOnError(retRes218837)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes66753 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes66753)
                    ch <- retRes66753
                    return nil
            }
        
                retRes523130 :=  (<-this.FetchOrdersByStatus("OPEN", symbol, since, limit, params))
                PanicOnError(retRes523130)
                ch <- retRes523130
                return nil
...
func  (this *coinbase) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes274972 := (<-this.LoadMarkets())
            PanicOnError(retRes274972)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes229038 :=  (<-this.FetchPaginatedCallCursor("fetchClosedOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes229038)
                    ch <- retRes229038
                    return nil
            }
        
                retRes704162 :=  (<-this.FetchOrdersByStatus("FILLED", symbol, since, limit, params))
                PanicOnError(retRes704162)
                ch <- retRes704162
                return nil
...
func  (this *coinbase) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes119410 :=  (<-this.FetchOrdersByStatus("CANCELLED", symbol, since, limit, params))
                PanicOnError(retRes119410)
                ch <- retRes119410
                return nil
...
func  (this *coinbase) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes366652 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, Subtract(maxLimit, 1)))
                    PanicOnError(retRes366652)
                    ch <- retRes366652
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes280331 := (<-this.LoadMarkets())
            PanicOnError(retRes280331)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes242815 := (<-this.LoadMarkets())
            PanicOnError(retRes242815)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes580707 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))
                    PanicOnError(retRes580707)
                    ch <- retRes580707
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes585989 := (<-this.LoadMarkets())
            PanicOnError(retRes585989)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes855649 := (<-this.LoadMarkets())
            PanicOnError(retRes855649)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
                AddElementToObject(request, "product_ids", this.MarketIds(symbols))
...
func  (this *coinbase) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes896442 := (<-this.LoadMarkets())
            PanicOnError(retRes896442)
...
func  (this *coinbase) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes160263 := (<-this.LoadMarkets())
            PanicOnError(retRes160263)
            var currency interface{} = this.Currency(code)
            var request interface{} = nil
...
func  (this *coinbase) Deposit(code interface{}, amount interface{}, id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70703 := (<-this.LoadMarkets())
            PanicOnError(retRes70703)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDeposit(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes178779 := (<-this.LoadMarkets())
            PanicOnError(retRes178779)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDepositMethodIds(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes718505 := (<-this.LoadMarkets())
            PanicOnError(retRes718505)
...
func  (this *coinbase) FetchDepositMethodId(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes840518 := (<-this.LoadMarkets())
            PanicOnError(retRes840518)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes313518 := (<-this.LoadMarkets())
            PanicOnError(retRes313518)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes447803 := (<-this.LoadMarkets())
            PanicOnError(retRes447803)
            var request interface{} = map[string]interface{} {
                "trade_id": id,
                "from_account": fromCode,
                "to_account": toCode,
...
func  (this *coinbase) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319373 := (<-this.LoadMarkets())
            PanicOnError(retRes319373)
            if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes653665 := (<-this.LoadMarkets())
            PanicOnError(retRes653665)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24727 := (<-this.LoadMarkets())
            PanicOnError(retRes24727)
            symbols = this.MarketSymbols(symbols)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *coinbase) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24637 := (<-this.LoadMarkets())
            PanicOnError(retRes24637)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "future")) {
...
func  (this *coinbase) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes577253 := (<-this.LoadMarkets())
            PanicOnError(retRes577253)
            var typeVar interface{} = nil
