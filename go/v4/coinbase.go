...
func  (this *coinbase) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchAccountsV3")) {
                    ...
                    retRes289472 :=  (<-this.FetchAccountsV3(params))
                    PanicOnError(retRes289472)
                    ch <- retRes289472
                    return nil
            }
        
                retRes372807 :=  (<-this.FetchAccountsV2(params))
                PanicOnError(retRes372807)
                ch <- retRes372807
                return nil
...
func  (this *coinbase) FetchAccountsV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes483665 := (<-this.LoadMarkets())
            PanicOnError(retRes483665)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes753939 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes753939)
                    ch <- retRes753939
                    return nil
            }
...
func  (this *coinbase) FetchAccountsV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes287539 := (<-this.LoadMarkets())
            PanicOnError(retRes287539)
            var paginate interface{} = false
            paginateparamsVariable := this.HandleOptionAndParams(params, "fetchAccounts", "paginate");
            paginate = GetValue(paginateparamsVariable,0);
            params = GetValue(paginateparamsVariable,1)
            if IsTrue(paginate) {
                    ...
                    retRes526434 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "cursor", "cursor", nil, 250))
...
func  (this *coinbase) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(accountId, nil)) {
                ...
                retRes277605 := (<-this.LoadAccounts())
                PanicOnError(retRes277605)
...
func  (this *coinbase) FetchMySells(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes250035 := (<-this.LoadMarkets())
            PanicOnError(retRes250035)
...
func  (this *coinbase) FetchMyBuys(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795898 := (<-this.LoadMarkets())
            PanicOnError(retRes795898)
            var query interface{} = this.Omit(params, []interface{}{"account_id", "accountId"})
...
func  (this *coinbase) FetchTransactionsWithMethod(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes29441 := (<-this.LoadMarkets())
            PanicOnError(retRes29441)
...
func  (this *coinbase) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes726698 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdWithdrawals", code, since, limit, params))
                PanicOnError(retRes726698)
                ch <- retRes726698
                return nil
...
func  (this *coinbase) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes490776 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdDeposits", code, since, limit, params))
                PanicOnError(retRes490776)
                ch <- retRes490776
                return nil
...
func  (this *coinbase) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes506703 := (<-this.LoadMarkets())
            PanicOnError(retRes506703)
...
func  (this *coinbase) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes337247 := (<-this.LoadTimeDifference())
                PanicOnError(retRes337247)
            }
            var method interface{} = this.SafeString(this.Options, "fetchMarkets", "fetchMarketsV3")
            if IsTrue(IsEqual(method, "fetchMarketsV3")) {
        
                    retRes603873 :=  (<-this.FetchMarketsV3(params))
                    PanicOnError(retRes603873)
                    ch <- retRes603873
                    return nil
            }
        
                retRes867601 :=  (<-this.FetchMarketsV2(params))
                PanicOnError(retRes867601)
                ch <- retRes867601
                return nil
...
func  (this *coinbase) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickersV3")) {
                    ...
                    retRes844612 :=  (<-this.FetchTickersV3(symbols, params))
                    PanicOnError(retRes844612)
                    ch <- retRes844612
                    return nil
            }
        
                retRes895937 :=  (<-this.FetchTickersV2(symbols, params))
                PanicOnError(retRes895937)
                ch <- retRes895937
                return nil
...
func  (this *coinbase) FetchTickersV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes303777 := (<-this.LoadMarkets())
            PanicOnError(retRes303777)
...
func  (this *coinbase) FetchTickersV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes960424 := (<-this.LoadMarkets())
            PanicOnError(retRes960424)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbase) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickerV3")) {
                    ...
                    retRes999223 :=  (<-this.FetchTickerV3(symbol, params))
                    PanicOnError(retRes999223)
                    ch <- retRes999223
                    return nil
            }
        
                retRes992967 :=  (<-this.FetchTickerV2(symbol, params))
                PanicOnError(retRes992967)
                ch <- retRes992967
                return nil
...
func  (this *coinbase) FetchTickerV2(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes652513 := (<-this.LoadMarkets())
            PanicOnError(retRes652513)
...
func  (this *coinbase) FetchTickerV3(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes666699 := (<-this.LoadMarkets())
            PanicOnError(retRes666699)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes200175 := (<-this.LoadMarkets())
            PanicOnError(retRes200175)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes115994 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes115994)
                    ch <- retRes115994
                    return nil
            }
...
func  (this *coinbase) FindAccountId(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854600 := (<-this.LoadMarkets())
            PanicOnError(retRes854600)
        
            retRes719684 := (<-this.LoadAccounts(false, params))
            PanicOnError(retRes719684)
            for i := 0; IsLessThan(i, GetArrayLength(this.Accounts)); i++ {
                var account interface{} = GetValue(this.Accounts, i)
...
func  (this *coinbase) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes633301 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                PanicOnError(retRes633301)
                ch <- retRes633301
                return nil
...
func  (this *coinbase) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes420889 := (<-this.LoadMarkets())
            PanicOnError(retRes420889)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes392175 := (<-this.LoadMarkets())
            PanicOnError(retRes392175)
...
func  (this *coinbase) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes772742 := (<-this.LoadMarkets())
            PanicOnError(retRes772742)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *coinbase) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes565239 := (<-this.LoadMarkets())
            PanicOnError(retRes565239)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes175858 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))
                    PanicOnError(retRes175858)
                    ch <- retRes175858
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes572934 := (<-this.LoadMarkets())
            PanicOnError(retRes572934)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbase) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes212222 := (<-this.LoadMarkets())
            PanicOnError(retRes212222)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes408798 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes408798)
                    ch <- retRes408798
                    return nil
            }
        
                retRes187128 :=  (<-this.FetchOrdersByStatus("OPEN", symbol, since, limit, params))
                PanicOnError(retRes187128)
                ch <- retRes187128
                return nil
...
func  (this *coinbase) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes69304 := (<-this.LoadMarkets())
            PanicOnError(retRes69304)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes444543 :=  (<-this.FetchPaginatedCallCursor("fetchClosedOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes444543)
                    ch <- retRes444543
                    return nil
            }
        
                retRes449065 :=  (<-this.FetchOrdersByStatus("FILLED", symbol, since, limit, params))
                PanicOnError(retRes449065)
                ch <- retRes449065
                return nil
...
func  (this *coinbase) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes434670 :=  (<-this.FetchOrdersByStatus("CANCELLED", symbol, since, limit, params))
                PanicOnError(retRes434670)
                ch <- retRes434670
                return nil
...
func  (this *coinbase) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes327993 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, Subtract(maxLimit, 1)))
                    PanicOnError(retRes327993)
                    ch <- retRes327993
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes238318 := (<-this.LoadMarkets())
            PanicOnError(retRes238318)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes190538 := (<-this.LoadMarkets())
            PanicOnError(retRes190538)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes797147 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))
                    PanicOnError(retRes797147)
                    ch <- retRes797147
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes888376 := (<-this.LoadMarkets())
            PanicOnError(retRes888376)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes635892 := (<-this.LoadMarkets())
            PanicOnError(retRes635892)
...
func  (this *coinbase) Deposit(code interface{}, amount interface{}, id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes894563 := (<-this.LoadMarkets())
            PanicOnError(retRes894563)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDepositMethodId(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes26077 := (<-this.LoadMarkets())
            PanicOnError(retRes26077)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes771496 := (<-this.LoadMarkets())
            PanicOnError(retRes771496)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes165396 := (<-this.LoadMarkets())
            PanicOnError(retRes165396)
            if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes308733 := (<-this.LoadMarkets())
            PanicOnError(retRes308733)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes799479 := (<-this.LoadMarkets())
            PanicOnError(retRes799479)
            symbols = this.MarketSymbols(symbols)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *coinbase) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes239464 := (<-this.LoadMarkets())
            PanicOnError(retRes239464)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "future")) {
...
func  (this *coinbase) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes728703 := (<-this.LoadMarkets())
            PanicOnError(retRes728703)
            var typeVar interface{} = nil
