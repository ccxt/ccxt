...
func (this *Coinbase) fetchTimeBody(ch chan any, optionalArgs ...any) any {
	...
	if method != nil && *method == "v2PublicGetTime" {
		...
		response = (<-this.V3PublicGetBrokerageTime(params)).Raw
		PanicOnError(response)
	}
...
func (this *Coinbase) fetchAccountsV2Body(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes60019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchAccounts", nil, nil, nil, params, "next_starting_after", "starting_after", nil, 100))))
		ch <- BoxAbsent(retRes60019)
		return nil
	}
...
func (this *Coinbase) fetchAccountsV3Body(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes67119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchAccounts", nil, nil, nil, params, "cursor", "cursor", nil, 250))))
		ch <- BoxAbsent(retRes67119)
		return nil
	}
	var request map[string]any = map[string]any{
		"limit": 250,
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V3PrivateGetBrokerageAccounts(this.Extend(request, params))).Raw))
	//
	//     {
	//         "accounts": [
	//             {
	...
	if (accountsLength > 0) && (cursor != nil) && (cursor == nil || *cursor != "") {
		var lastIndex int64 = Subtract(accountsLength, 1).(int64)
		var last any = this.SafeDict(accounts, lastIndex, map[string]any{})
...
func (this *Coinbase) ParseAccount(account any) any {
	...
	return map[string]any{
		...
		"type": func() any {
			if active != nil {
				return this.SafeStringLower(parts, 1)
			}
			return typeV2
		}(),
...
func (this *Coinbase) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var currencyTypeparamsVariable []any = this.HandleOptionAndParams(params, "fetchWithdrawals", "currencyType")
	currencyType = GetValue(currencyTypeparamsVariable, 0)
	params = MapTyped(GetValue(currencyTypeparamsVariable, 1))
	...
	var retRes97615 []any = ListTyped(PanicOnError((<-this.FetchTransactionsWithMethodAsync("v2PrivateGetAccountsAccountIdWithdrawals", code, since, limit, params))))
	ch <- BoxAbsent(retRes97615)
	return nil
}
...
func (this *Coinbase) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	var currencyType any = nil
	var currencyTypeparamsVariable []any = this.HandleOptionAndParams(params, "fetchDeposits", "currencyType")
	currencyType = GetValue(currencyTypeparamsVariable, 0)
	params = MapTyped(GetValue(currencyTypeparamsVariable, 1))
	if IsEqual(currencyType, "crypto") {
	...
	var retRes99915 []any = ListTyped(PanicOnError((<-this.FetchTransactionsWithMethodAsync("v2PrivateGetAccountsAccountIdDeposits", code, since, limit, params))))
...
func (this *Coinbase) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if (priceString != nil) && (amountString != nil) {
	...
	return this.SafeTrade(map[string]any{
		...
		"type":      nil,
		"side": func() any {
			if side != nil && *side == "unknown_order_side" {
				return nil
			}
			return side
		}(),
		"takerOrMaker": func() any {
			if takerOrMaker != nil && *takerOrMaker == "unknown_liquidity_indicator" {
				return nil
			}
			return takerOrMaker
		}(),
...
func (this *Coinbase) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if method != nil && *method == "fetchMarketsV3" {
		...
		var retRes139719 []any = ListTyped(PanicOnError((<-this.FetchMarketsV3Async(params))))
		ch <- BoxAbsent(retRes139719)
		return nil
	}

	var retRes139915 []any = ListTyped(PanicOnError((<-this.FetchMarketsV2Async(params))))
...
func (this *Coinbase) fetchMarketsV3Body(ch chan any, optionalArgs ...any) any {
	...
	if usePrivate {
		spotUnresolvedPromises = append(spotUnresolvedPromises, EndpointRaw(this.V3PrivateGetBrokerageProducts(params)))
	} else {
		spotUnresolvedPromises = append(spotUnresolvedPromises, EndpointRaw(this.V3PublicGetBrokerageMarketProducts(params)))
	}
	//
	//    {
	//        products: [
	...
	if this.CheckRequiredCredentials(false) {
		spotUnresolvedPromises = append(spotUnresolvedPromises, EndpointRaw(this.V3PrivateGetBrokerageTransactionSummary(params)))
	}
	//
	//    {
...

	{
		func(this *Coinbase) (ret_ any) {
			...
			// try block:
			unresolvedContractPromises = []any{EndpointRaw(this.V3PublicGetBrokerageMarketProducts(this.Extend(params, map[string]any{
				"product_type": "FUTURE",
			}))), EndpointRaw(this.V3PublicGetBrokerageMarketProducts(this.Extend(params, map[string]any{
				"product_type":         "FUTURE",
	...
	//     }
	//
	var feeTier map[string]any = MapTyped(this.SafeDict(fees, "fee_tier", map[string]any{}))
	var expiringFeeTier map[string]any = MapTyped(this.SafeDict(expiringFees, "fee_tier", map[string]any{}))   // fee tier null?
	var perpetualFeeTier map[string]any = MapTyped(this.SafeDict(perpetualFees, "fee_tier", map[string]any{})) // fee tier null?
...
func (this *Coinbase) ParseSpotMarket(market any, feeTier map[string]any) any {
	...
	var defaultTakerFee *float64 = this.SafeNumber(this.Fees["trading"], "taker")
	var defaultMakerFee *float64 = this.SafeNumber(this.Fees["trading"], "maker")
	var takerFee any = func() any {
		if this.InArray(id, stablePairs) {
			return 0.00001
		}
		return this.SafeNumber(feeTier, "taker_fee_rate", defaultTakerFee)
	}()
	var makerFee any = func() any {
		if this.InArray(id, stablePairs) {
			return 0
		}
		return this.SafeNumber(feeTier, "maker_fee_rate", defaultMakerFee)
	}()
	return this.SafeMarketStructure(map[string]any{
		...
		"future":         false,
		"option":         false,
		"active":         (tradingDisabled == nil || *tradingDisabled != true),
		"contract":       false,
		"linear":         nil,
		"inverse":        nil,
		"taker":          takerFee,
...
func (this *Coinbase) ParseContractMarket(market any, feeTier map[string]any) any {
	...
	var expireTimestamp *int64 = this.Parse8601(contractExpire)
	var expireDateTime *string = this.Iso8601(expireTimestamp)
...
func (this *Coinbase) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if method != nil && *method == "fetchTickersV3" {
		...
		var retRes210419 map[string]any = MapTyped(PanicOnError((<-this.FetchTickersV3Async(symbols, params))))
		ch <- BoxAbsent(retRes210419)
		return nil
	}

	var retRes210615 map[string]any = MapTyped(PanicOnError((<-this.FetchTickersV2Async(symbols, params))))
	ch <- BoxAbsent(retRes210615)
	return nil
}
...
func (this *Coinbase) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if method != nil && *method == "fetchTickerV3" {
		...
		var retRes223219 map[string]any = MapTyped(PanicOnError((<-this.FetchTickerV3Async(symbol, params))))
		ch <- BoxAbsent(retRes223219)
		return nil
	}

	var retRes223415 map[string]any = MapTyped(PanicOnError((<-this.FetchTickerV2Async(symbol, params))))
	ch <- BoxAbsent(retRes223415)
	return nil
}
...
func (this *Coinbase) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var market map[string]any = GetArgMap(optionalArgs, 0, nil)
	_ = market
	var bid *float64 = this.SafeNumber(ticker, "bid")
	var ask *float64 = this.SafeNumber(ticker, "ask")
	var bidVolume *float64 = nil
	var askVolume *float64 = nil
	if InOp(ticker, "bids") {
		var bids []any = SafeListTypedDefault(ticker, "bids", []any{})
		var asks []any = SafeListTypedDefault(ticker, "asks", []any{})
...
func (this *Coinbase) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "future") {
		...
		response = (<-this.V3PrivateGetBrokerageAccounts(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		request["limit"] = 250
...
func (this *Coinbase) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes262819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))))
...
func (this *Coinbase) ParseLedgerEntry(item any, optionalArgs ...any) any {
	...
	var status *string = this.ParseLedgerEntryStatus(this.SafeString(item, "status"))
...
func (this *Coinbase) PrepareAccountRequest(optionalArgs ...any) any {
	...
	if accountId == nil {
		panic(ArgumentsRequired(this.Id + " prepareAccountRequest() method requires an account_id (or accountId) parameter"))
	}
	var request map[string]any = map[string]any{
		"account_id": accountId,
	}
...
func (this *Coinbase) prepareAccountRequestWithCurrencyCodeBody(ch chan any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"account_id", "accountId"}))
	if IsEqual(accountId, nil) {
		if code == nil {
...
func (this *Coinbase) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	var retRes305715 map[string]any = MapTyped(PanicOnError((<-this.CreateOrderAsync(symbol, "market", "buy", cost, nil, params))))
...
func (this *Coinbase) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if reduceOnly != nil && *reduceOnly == true {
		...
		var retRes310419 map[string]any = MapTyped(PanicOnError((<-this.ClosePositionAsync(symbol, side, params))))
		ch <- BoxAbsent(retRes310419)
		return nil
	}
	...
	var isStop bool = (triggerPrice != nil)
	...
	var data map[string]any = MapTyped(this.SafeDict(response, "success_response", map[string]any{}))
...
func (this *Coinbase) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	for i := 0; i < len(orders); i++ {
		var success *bool = this.SafeBool(func() any {
			if i >= 0 && i < len(orders) {
		...
		if success == nil || *success != true {
			panic(BadRequest(this.Id + " cancelOrders() has failed, check your arguments and parameters"))
		}
	}
...
func (this *Coinbase) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	//     }
	//
	var order map[string]any = MapTyped(this.SafeDict(response, "order", map[string]any{}))
...
func (this *Coinbase) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes367619 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))))
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V3PrivateGetBrokerageOrdersHistoricalBatch(this.Extend(request, params))).Raw))
	//
	//     {
	//         "orders": [
	//             {
...
func (this *Coinbase) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes384919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes384919)
		return nil
	}

	var retRes385115 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStatusAsync("OPEN", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes385115)
	return nil
}
...
func (this *Coinbase) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes387419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchClosedOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))))
		ch <- BoxAbsent(retRes387419)
		return nil
	}

	var retRes387615 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStatusAsync("FILLED", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes387615)
	return nil
}
...
func (this *Coinbase) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes389115 []any = ListTyped(PanicOnError((<-this.FetchOrdersByStatusAsync("CANCELLED", symbol, since, limit, params))))
	ch <- BoxAbsent(retRes389115)
	return nil
}
...
func (this *Coinbase) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes407519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))))
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V3PrivateGetBrokerageOrdersHistoricalFills(this.Extend(request, params))).Raw))
	//
	//     {
	//         "fills": [
	//             {
...
func (this *Coinbase) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	//     }
	//
	var data map[string]any = MapTyped(this.SafeDict(response, "pricebook", map[string]any{}))
...
func (this *Coinbase) fetchDepositMethodIdBody(ch chan any, id any, optionalArgs ...any) any {
	...
	//     }
	//
	var result map[string]any = MapTyped(this.SafeDict(response, "payment_method", map[string]any{}))
...
func (this *Coinbase) fetchConvertTradeBody(ch chan any, id any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, "toCode"))
	var request map[string]any = map[string]any{
		"trade_id":     id,
		"from_account": code,
		"to_account":   toCode,
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V3PrivateGetBrokerageConvertTradeTradeId(this.Extend(request, params))).Raw))
	var data map[string]any = MapTyped(this.SafeDict(response, "trade", map[string]any{}))
...
func (this *Coinbase) closePositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.V3PrivatePostBrokerageOrdersClosePosition(this.Extend(request, params))).Raw))
...
func (this *Coinbase) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	response := (<-this.V3PrivateGetBrokerageTransactionSummary(this.Extend(request, params))).Raw
	PanicOnError(response)
	//
	// {
	//     total_volume: '0',
...
func (this *Coinbase) ParsePortfolioDetails(portfolioData any) any {
	...
	for i := 0; i < len(spotPositions); i++ {
		...
		var positionData map[string]any = map[string]any{
			...
			"hold_amount": func() any {
				if IsGreaterThan(holdAmount, 0) {
					return holdAmount
				}
				return 0
			}(),
...
func (this *Coinbase) CreateAuthToken(seconds any, optionalArgs ...any) any {
	...
	_ = url
	var useEddsa bool = GetArgBool(optionalArgs, 2, false)
	_ = useEddsa
	var uri any = nil
	if url != nil {
...
func (this *Coinbase) FetchAccountsV2(params ...any) ([]Account, error) {
	var res AsyncResult[[]Account] = AwaitResult(NewAccountArray, this.FetchAccountsV2Async(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchAccountsV3(params ...any) ([]Account, error) {
	var res AsyncResult[[]Account] = AwaitResult(NewAccountArray, this.FetchAccountsV3Async(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchPortfolios(params ...any) ([]Account, error) {
	var res AsyncResult[[]Account] = AwaitResult(NewAccountArray, this.FetchPortfoliosAsync(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchMySells(options ...FetchMySellsOptions) ([]Trade, error) {
	...
	var res AsyncResult[[]Trade] = AwaitResult(NewTradeArray, this.FetchMySellsAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchMyBuys(options ...FetchMyBuysOptions) ([]Trade, error) {
	...
	var res AsyncResult[[]Trade] = AwaitResult(NewTradeArray, this.FetchMyBuysAsync(opts.Symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchMarketsV3(params ...any) ([]MarketInterface, error) {
	var res AsyncResult[[]MarketInterface] = AwaitResult(NewMarketInterfaceArray, this.FetchMarketsV3Async(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchCurrenciesFromCache(params ...any) (map[string]any, error) {
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchCurrenciesFromCacheAsync(params...))
	if res.Err != nil {
...
func (this *Coinbase) FetchTickersV2(options ...FetchTickersV2Options) (Tickers, error) {
	...
	var res AsyncResult[Tickers] = AwaitResult(NewTickers, this.FetchTickersV2Async(opts.Symbols, opts.Params))
	if res.Err != nil {
		return Tickers{}, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchTickersV3(options ...FetchTickersV3Options) (Tickers, error) {
	...
	var res AsyncResult[Tickers] = AwaitResult(NewTickers, this.FetchTickersV3Async(opts.Symbols, opts.Params))
	if res.Err != nil {
		return Tickers{}, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchTickerV3(symbol string, options ...FetchTickerV3Options) (Ticker, error) {
	...
	var res AsyncResult[Ticker] = AwaitResult(NewTicker, this.FetchTickerV3Async(symbol, opts.Params))
	if res.Err != nil {
		return Ticker{}, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchDepositMethodIds(params ...any) ([]map[string]any, error) {
	var res AsyncResult[[]map[string]any] = AwaitResult(NewMapArray, this.FetchDepositMethodIdsAsync(params...))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
...
func (this *Coinbase) FetchDepositMethodId(id string, options ...FetchDepositMethodIdOptions) (map[string]any, error) {
	...
	var res AsyncResult[map[string]any] = AwaitResult(AssertAs[map[string]any], this.FetchDepositMethodIdAsync(id, opts.Params))
	if res.Err != nil {
		return map[string]any{}, res.Err
	}
	return res.Value, nil
