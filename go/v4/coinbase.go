...
func (this *CoinbaseCore) FetchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchTickersV3")) {
			...
			retRes206019 := (<-this.FetchTickersV3(symbols, params))
			PanicOnError(retRes206019)
			ch <- retRes206019
			return nil
		}

		retRes206215 := (<-this.FetchTickersV2(symbols, params))
		PanicOnError(retRes206215)
		ch <- retRes206215
		return nil
...
func (this *CoinbaseCore) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(method, "fetchTickerV3")) {
			...
			retRes218819 := (<-this.FetchTickerV3(symbol, params))
			PanicOnError(retRes218819)
			ch <- retRes218819
			return nil
		}

		retRes219015 := (<-this.FetchTickerV2(symbol, params))
...
func (this *CoinbaseCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes258019 := (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))
...
func (this *CoinbaseCore) FindAccountId(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes29448 := (<-this.LoadAccounts(false, params))
...
func (this *CoinbaseCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(reduceOnly) {
			...
			retRes305519 := (<-this.ClosePosition(symbol, side, params))
...
func (this *CoinbaseCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes362719 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))
...
func (this *CoinbaseCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes380019 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
			PanicOnError(retRes380019)
			ch <- retRes380019
			return nil
		}

		retRes380215 := (<-this.FetchOrdersByStatus("OPEN", symbol, since, limit, params))
...
func (this *CoinbaseCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes382715 := (<-this.FetchOrdersByStatus("FILLED", symbol, since, limit, params))
...
func (this *CoinbaseCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes384215 := (<-this.FetchOrdersByStatus("CANCELLED", symbol, since, limit, params))
...
func (this *CoinbaseCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes387019 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, Subtract(maxLimit, 1)))
			PanicOnError(retRes387019)
			ch <- retRes387019
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *CoinbaseCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes402619 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))
...
func (this *CoinbaseCore) FetchDepositMethodIds(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes459812 := (<-this.LoadMarkets())
			PanicOnError(retRes459812)
		}
...
func (this *CoinbaseCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes469712 := (<-this.LoadMarkets())
			PanicOnError(retRes469712)
		}
		var request any = map[string]any{
