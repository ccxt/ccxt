...
func (this *BigoneCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes155115 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes155115)
		ch <- retRes155115
		return nil
...
func (this *BigoneCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes190215 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BigoneCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes192015 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes192015)
		ch <- retRes192015
		return nil
...
func (this *BigoneCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes21278 := (<-this.LoadMarkets())
		PanicOnError(retRes21278)
		var request any = map[string]any{}
