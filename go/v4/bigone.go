...
func (this *BigoneCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes157015 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
...
func (this *BigoneCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes193315 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BigoneCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes195115 := (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
