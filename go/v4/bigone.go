...
func (this *Bigone) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	_ = market
	var marketType string = Ternary((InOp(ticker, "asset_pair_name")), "spot", "swap").(string)
...
func (this *Bigone) ParseTrade(trade any, optionalArgs ...any) any {
	...
	market := GetArg(optionalArgs, 0, nil)
	_ = market
	var timestamp *int64 = this.Parse8601(this.SafeString2(trade, "created_at", "inserted_at"))
...
func (this *Bigone) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var requestSide string = Ternary(isBuy, "BID", "ASK").(string)
	...
	postOnlyparamsVariable := this.HandlePostOnly((uppercaseType == "MARKET"), (exchangeSpecificParam != nil && *exchangeSpecificParam == true), params)
...
func (this *Bigone) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var timestamp *int64 = this.Parse8601(this.SafeString(transaction, "inserted_at"))
	var updated *int64 = this.Parse8601(this.SafeString2(transaction, "updated_at", "completed_at"))
	...
	var typeVar string = Ternary((InOp(transaction, "customer_id")), "withdrawal", "deposit").(string)
