...
func  (this *AsterCore) ParsePositionRisk(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var maintenanceMarginPercentageString interface{}
    ...
    if IsTrue(IsEqual(marginMode, "cross")) {
        ...
        if !IsTrue(precisionIsUndefined) {
            if IsTrue(linear) {
                ...
                var onePlusMaintenanceMarginPercentageString interface{}
    ...
    var initialMarginPercentageString interface{}
...
func  (this *AsterCore) ParseAccountPosition(position interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var side interface{}
    var percentage interface{}
    var liquidationPriceStringRaw interface{}
