...
func (this *Bitopro) fetchOHLCVBody(ch chan any, symbol string, optionalArgs ...any) any {
	...
	if since == nil {
		...
		request["from"] = math.Floor(float64(*since) / 1000)
...
func (this *Bitopro) HandleErrors(code any, reason any, url any, method any, headers any, body string, response any, requestHeaders any, requestBody any) any {
	if response == nil {
