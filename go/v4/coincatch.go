...
func (this *CoincatchCore) FetchMarkets(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(this.SafeList(this.Options, "currencyIdsListForParseMarket"), nil)) {
			...
			retRes76412 := (<-this.FetchCurrencies())
...
func (this *CoincatchCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes229415 := (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
		PanicOnError(retRes229415)
		ch <- retRes229415
		return nil
...
func (this *CoincatchCore) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes232419 := (<-this.CreateSpotOrder(symbol, typeVar, side, amount, price, params))
			PanicOnError(retRes232419)
			ch <- retRes232419
			return nil
		} else if IsTrue(GetValue(market, "swap")) {

			retRes232619 := (<-this.CreateSwapOrder(symbol, typeVar, side, amount, price, params))
...
func (this *CoincatchCore) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(GetValue(market, "spot")) {
			...
			retRes291619 := (<-this.EditSpotOrder(id, symbol, typeVar, side, amount, price, params))
...
func (this *CoincatchCore) FetchOpenOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes315919 := (<-this.FetchOpenSpotOrders(symbol, since, limit, params))
			PanicOnError(retRes315919)
			ch <- retRes315919
			return nil
		} else if IsTrue(IsEqual(marketType, "swap")) {

			retRes316119 := (<-this.FetchOpenSwapOrders(symbol, since, limit, params))
...
func (this *CoincatchCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(IsEqual(marketType, "spot")) {
			...
			retRes343219 := (<-this.FetchCanceledAndClosedSpotOrders(symbol, since, limit, params))
			PanicOnError(retRes343219)
			ch <- retRes343219
			return nil
		} else if IsTrue(IsEqual(marketType, "swap")) {

			retRes343419 := (<-this.FetchCanceledAndClosedSwapOrders(symbol, since, limit, params))
...
func (this *CoincatchCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes448715 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *CoincatchCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes468315 := (<-this.PrivatePostApiMixV1AccountSetPositionMode(this.Extend(request, params)))
...
func (this *CoincatchCore) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes47268 := (<-this.LoadMarkets())
		PanicOnError(retRes47268)
		var market interface{} = this.Market(symbol)
		if IsTrue(!IsEqual(GetValue(market, "type"), "swap")) {
			panic(NotSupported(Add(Add(Add(Add(Add(this.Id, " "), methodName), "() is not supported for "), GetValue(market, "type")), " type of markets")))
		}
...
func (this *CoincatchCore) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes488015 := (<-this.ModifyMarginHelper(symbol, OpNeg(amount), "reduce", params))
...
func (this *CoincatchCore) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes489615 := (<-this.ModifyMarginHelper(symbol, amount, "add", params))
