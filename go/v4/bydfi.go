...
func (this *BydfiCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var numberOfCandles any = Ternary((!IsEqual(limit, nil) && !IsEqual(limit, nil) && (limit != 0)), limit, maxLimit)
	var until any = nil
...
func (this *BydfiCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var isMarketOrder bool = ((typeVar == "MARKET") || (typeVar == "STOP_MARKET") || (typeVar == "TAKE_PROFIT_MARKET") || (typeVar == "TRAILING_STOP_MARKET"))
	if isMarketOrder {
		if typeVar == "MARKET" {
			if isStopLossOrder {
				typeVar = "STOP_MARKET"
