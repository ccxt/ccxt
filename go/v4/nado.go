...
func (this *NadoCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		params = this.Omit(params, []any{"id", "stop", "trigger"})
...
func (this *NadoCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var trigger any = this.SafeBool2(params, "stop", "trigger")
		params = this.Omit(params, []any{"id", "requiredUnfilledAmount", "required_unfilled_amount", "stop", "trigger"})
...
func (this *NadoCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(trigger) {
			...
			retRes96819 := (<-this.FetchOrders(symbol, since, nil, this.Extend(params, map[string]any{
...
func (this *NadoCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(trigger) {
			...
			retRes104419 := (<-this.FetchOrders(symbol, since, nil, this.Extend(params, map[string]any{
				"status_types": []any{"triggered", "triggering", "twap_executing", "twap_completed"},
			})))
			PanicOnError(retRes104419)
			ch <- retRes104419
			return nil
		}
...
func (this *NadoCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes110915 := (<-this.FetchOrders(symbol, since, nil, this.Extend(params, map[string]any{
...
func (this *NadoCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes112915 := (<-this.FetchOrders(symbol, since, nil, this.Extend(params, map[string]any{
...
func (this *NadoCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes127515 := (<-this.QueryTransactionsByEventType("deposit_collateral", "deposit", "fetchDeposits", code, since, limit, params))
		PanicOnError(retRes127515)
		ch <- retRes127515
		return nil
...
func (this *NadoCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes129215 := (<-this.QueryTransactionsByEventType("withdraw_collateral", "withdrawal", "fetchWithdrawals", code, since, limit, params))
		PanicOnError(retRes129215)
		ch <- retRes129215
		return nil
...
func (this *NadoCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var pairsById any = this.IndexBy(pairs, "product_id")
		var assetsById any = this.IndexBy(assets, "product_id")
		...
		for i := 0; IsLessThan(i, GetArrayLength(symbols)); i++ {
			...
			AppendToArray(&markets, map[string]any{
				"id":             id,
				"lowercaseId":    nil,
				"symbol":         symbol,
				"base":           base,
...
func (this *NadoCore) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		ch <- this.SafeTicker(this.SafeDict(tickers, symbol), market)
		return nil
...
func (this *NadoCore) CreateSubaccount(walletAddress any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(walletAddress, nil)) {
		panic(ArgumentsRequired(Add(this.Id, " createOrder() requires exchange.walletAddress")))
	}
