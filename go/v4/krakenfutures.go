...
func (this *KrakenfuturesCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes73719 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 2000))
			PanicOnError(retRes73719)
			ch <- retRes73719
			return nil
		}
		var request any = map[string]any{
...
func (this *KrakenfuturesCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes82419 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes82419)
			ch <- retRes82419
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *KrakenfuturesCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes229412 := (<-this.LoadMarkets())
			PanicOnError(retRes229412)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
...
func (this *KrakenfuturesCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes267112 := (<-this.LoadMarkets())
			PanicOnError(retRes267112)
		}
		var market any = this.Market(symbol)
...
func (this *KrakenfuturesCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes300515 := (<-this.Transfer(code, amount, "future", "spot", params))
		PanicOnError(retRes300515)
		ch <- retRes300515
		return nil
...
func (this *KrakenfuturesCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes307412 := (<-this.LoadMarkets())
			PanicOnError(retRes307412)
		}
		...
		retRes308715 := (<-this.PrivatePutLeveragepreferences(this.Extend(request, params)))
...
func (this *KrakenfuturesCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes313412 := (<-this.LoadMarkets())
			PanicOnError(retRes313412)
		}
		var market any = this.Market(symbol)
		var marketIdUpper any = this.MarketId(symbol)
		if IsTrue(IsEqual(marketIdUpper, nil)) {
