...
func (this *KrakenfuturesCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes84419 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 2000))
...
func (this *KrakenfuturesCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes93119 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes93119)
			ch <- retRes93119
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *KrakenfuturesCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes283012 := (<-this.LoadMarkets())
			PanicOnError(retRes283012)
		}
		var request any = map[string]any{}
...
func (this *KrakenfuturesCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes311415 := (<-this.Transfer(code, amount, "future", "spot", params))
		PanicOnError(retRes311415)
		ch <- retRes311415
		return nil
...
func (this *KrakenfuturesCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes313212 := (<-this.LoadMarkets())
			PanicOnError(retRes313212)
		}
...
func (this *KrakenfuturesCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes319615 := (<-this.PrivatePutLeveragepreferences(this.Extend(request, params)))
...
func (this *KrakenfuturesCore) FetchLeverages(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes321012 := (<-this.LoadMarkets())
			PanicOnError(retRes321012)
		}
