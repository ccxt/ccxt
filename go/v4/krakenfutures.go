...
func (this *Krakenfutures) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes91919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, paramsPaginate, 2000))))
		ch <- BoxAbsent(retRes91919)
		return nil
	}
	...
	} else if !IsEqual(limitResolved, nil) {
		var duration int64 = this.ParseTimeframe(timeframe)
...
func (this *Krakenfutures) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes101319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchTrades", symbol, since, limit, paramsPaginate))))
		ch <- BoxAbsent(retRes101319)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{
	...
	var methodparamsMethodVariable []any = this.HandleOptionStringAndParams(paramsPaginate, "fetchTrades", "method", "historyGetMarketSymbolExecutions")
 ...
 */
func (this *Krakenfutures) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Krakenfutures) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
...
func (this *Krakenfutures) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < len(elements); i++ {
		var event map[string]any = SafeMapTyped(func() any {
			if i >= 0 && i < len(elements) {
				return DerefScalar(elements[i])
			}
			return nil
		}(), "event")
