...
func (this *KrakenfuturesCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes84519 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 2000))
			PanicOnError(retRes84519)
			ch <- retRes84519
			return nil
		}
		var request any = map[string]any{
...
func (this *KrakenfuturesCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes93219 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *KrakenfuturesCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes127712 := (<-this.LoadMarkets())
			PanicOnError(retRes127712)
		}
		var market any = this.Market(symbol)
...
func (this *KrakenfuturesCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes261712 := (<-this.LoadMarkets())
			PanicOnError(retRes261712)
		}
...
func (this *KrakenfuturesCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes300112 := (<-this.LoadMarkets())
			PanicOnError(retRes300112)
		}
		var request any = map[string]any{}
...
func (this *KrakenfuturesCore) ParsePositions(response any, optionalArgs ...any) any {
	...
	var positions any = this.SafeList(response, "openPositions", []any{})
...
func (this *KrakenfuturesCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes310412 := (<-this.LoadMarkets())
			PanicOnError(retRes310412)
		}
...
func (this *KrakenfuturesCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes328515 := (<-this.Transfer(code, amount, "future", "spot", params))
...
func (this *KrakenfuturesCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes335412 := (<-this.LoadMarkets())
			PanicOnError(retRes335412)
		}
		...
		retRes336715 := (<-this.PrivatePutLeveragepreferences(this.Extend(request, params)))
...
func (this *KrakenfuturesCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes341412 := (<-this.LoadMarkets())
			PanicOnError(retRes341412)
		}
		var market any = this.Market(symbol)
		var marketIdUpper any = this.MarketId(symbol)
		if IsTrue(IsEqual(marketIdUpper, nil)) {
