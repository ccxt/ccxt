...
func  (this *KrakenfuturesCore) FetchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes73019 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 2000))
                    PanicOnError(retRes73019)
                    ch <- retRes73019
                    return nil
            }
            var request any = map[string]any {
...
func  (this *KrakenfuturesCore) FetchTrades(symbol any, optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes81519 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
