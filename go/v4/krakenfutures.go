...
func (this *KrakenfuturesCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes73819 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 2000))
			PanicOnError(retRes73819)
			ch <- retRes73819
			return nil
		}
		var request any = map[string]any{
...
func (this *KrakenfuturesCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes82519 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
			PanicOnError(retRes82519)
			ch <- retRes82519
			return nil
		}
		var market any = this.Market(symbol)
...
func (this *KrakenfuturesCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes152712 := (<-this.LoadMarkets())
			PanicOnError(retRes152712)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *KrakenfuturesCore) TransferOut(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes300815 := (<-this.Transfer(code, amount, "future", "spot", params))
...
func (this *KrakenfuturesCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes309015 := (<-this.PrivatePutLeveragepreferences(this.Extend(request, params)))
...
func (this *KrakenfuturesCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes313712 := (<-this.LoadMarkets())
			PanicOnError(retRes313712)
		}
		var market any = this.Market(symbol)
		var marketIdUpper any = this.MarketId(symbol)
		if IsTrue(IsEqual(marketIdUpper, nil)) {
