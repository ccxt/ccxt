...
func (this *Phemex) ParseSwapMarket(market any) any {
	...
	if settle != nil && *settle == "USDT" {
		contractSize = this.ParseNumber("1")
	} else if func() int {
		if contractSizeString == nil {
			return -1
		}
		return strings.Index(*contractSizeString, " ")
	}() != OpNeg(1) {
		// "1 USD"
		// "0.005 ETH"
...
func (this *Phemex) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	var perpetualProductsV2 []any = SafeListTypedDefault(v2ProductsData, "perpProductsV2", []any{})
	products = this.ArrayConcat(products, perpetualProductsV2)
	var riskLimits any = this.SafeList(v2ProductsData, "riskLimits", []any{})
	var riskLimitsV2 []any = SafeListTypedDefault(v2ProductsData, "riskLimitsV2", []any{})
	...
	for i := 0; i < GetArrayLength(products); i++ {
		...
		if (typeVar != nil && *typeVar == "perpetual") || (typeVar != nil && *typeVar == "perpetualv2") || (typeVar != nil && *typeVar == "perpetualpilot") {
			var id *string = this.SafeString(market, "symbol")
			var riskLimitValues map[string]any = MapTyped(this.SafeDict(riskLimitsById, id, map[string]any{}))
			market = this.Extend(market, riskLimitValues)
			var v1ProductsValues map[string]any = MapTyped(this.SafeDict(v1ProductsById, id, map[string]any{}))
...
func (this *Phemex) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if (GetValue(market, "linear") == true) && isStableSettled {
		...
		response = MapTyped(PanicOnError((<-this.V2GetMdV2Orderbook(this.Extend(request, params))).Raw))
	} else {
		if (limit != nil) && (*limit <= 30) {

			response = MapTyped(PanicOnError((<-this.V1GetMdOrderbook(this.Extend(request, params))).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.V1GetMdFullbook(this.Extend(request, params))).Raw))
		}
	}
	//
	//     {
...
func (this *Phemex) ToEn(n any, scale any) any {
	...
	var stringN *string = this.NumberToString(n)
...
func (this *Phemex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if (GetValue(market, "linear") == true) || isStableSettled {
		if (until != nil) || (since != nil) {
			...
			response = MapTyped(PanicOnError((<-this.PublicGetMdV2KlineList(this.Extend(request, paramsOmitted))).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.PublicGetMdV2KlineLast(this.Extend(request, paramsOmitted))).Raw))
		}
	} else {

		response = MapTyped(PanicOnError((<-this.PublicGetMdV2Kline(this.Extend(request, paramsOmitted))).Raw))
	}
	//
	//     {
	//         "code":0,
...
func (this *Phemex) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	var open any = this.FromEp(this.SafeString(ticker, "openEp"), marketResolved)
...
func (this *Phemex) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "swap") == true {
		if (GetValue(market, "inverse") == true) || IsEqual(market["settle"], "USD") {

			response = MapTyped(PanicOnError((<-this.V1GetMdTicker24hr(this.Extend(request, params))).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.V2GetMdV2Ticker24hr(this.Extend(request, params))).Raw))
		}
	} else {

		response = MapTyped(PanicOnError((<-this.V1GetMdSpotTicker24hr(this.Extend(request, params))).Raw))
	}
	//
	// spot
	//
...
func (this *Phemex) fetchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if typeVar != nil && *typeVar == "spot" {
		...
		response = MapTyped(PanicOnError((<-this.V1GetMdSpotTicker24hrAll(query)).Raw))
	} else if (subType != nil && *subType == "inverse") || (this.SafeString(market, "settle") != nil && *this.SafeString(market, "settle") == "USD") {

		response = MapTyped(PanicOnError((<-this.V1GetMdTicker24hrAll(query)).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.V2GetMdV2Ticker24hrAll(query)).Raw))
	}
...
func (this *Phemex) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if (GetValue(market, "linear") == true) && isStableSettled {
		...
		response = MapTyped(PanicOnError((<-this.V2GetMdV2Trade(this.Extend(request, params))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.V1GetMdTrade(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "error": null,
...
func (this *Phemex) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if typeVar != nil && *typeVar == "swap" {
		var settleparamsSettleVariable []any = this.HandleOptionStringAndParams(paramsOmitted, "fetchBalance", "settle", "USDT")
		settle := GetValue(settleparamsSettleVariable, 0)
		var paramsSettle map[string]any = MapTyped(GetValue(settleparamsSettleVariable, 1))
		if (code != nil) || !IsEqual(settle, nil) {
			...
			var currency map[string]any = this.Currency(coin)
			request["currency"] = currency["id"]
			if currency["id"] == "USDT" {

				response = MapTyped(PanicOnError((<-this.PrivateGetGAccountsAccountPositions(this.Extend(request, paramsSettle))).Raw))
			} else {

				response = MapTyped(PanicOnError((<-this.PrivateGetAccountsAccountPositions(this.Extend(request, paramsSettle))).Raw))
			}
		} else {
			...
			response = MapTyped(PanicOnError((<-this.PrivateGetSpotWallets(this.Extend(request, paramsSettle))).Raw))
		}
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateGetSpotWallets(this.Extend(request, paramsOmitted))).Raw))
	}
	//
	// usdt
	//   {
...
func (this *Phemex) ParseSpotOrder(order any, optionalArgs ...any) any {
	...
	var marketResolved map[string]any = this.SafeMarket(marketId, market)
	var symbol *string = SafeStringPtr(marketResolved["symbol"])
	var price any = this.FromEp(this.SafeString(order, "priceEp"), marketResolved)
	var amount any = this.FromEv(this.SafeString(order, "baseQtyEv"), marketResolved)
	var remaining any = this.OmitZero(this.FromEv(this.SafeString(order, "leavesBaseQtyEv"), marketResolved))
	var filled any = this.FromEv(this.SafeString2(order, "cumBaseQtyEv", "cumBaseValueEv"), marketResolved)
	var cost any = this.FromEr(this.SafeString2(order, "cumQuoteValueEv", "quoteQtyEv"), marketResolved)
	var average any = this.FromEp(this.SafeString(order, "avgPriceEp"), marketResolved)
	var status *string = this.ParseOrderStatus(this.SafeString(order, "ordStatus"))
	var side *string = this.SafeStringLower(order, "side")
	var typeVar *string = this.ParseOrderType(this.SafeString(order, "ordType"))
	var timestamp *int64 = this.SafeIntegerProduct2(order, "actionTimeNs", "createTimeNs", 0.000001)
	var fee map[string]any = nil
	var feeCost any = this.FromEv(this.SafeString(order, "cumFeeEv"), marketResolved)
...
func (this *Phemex) ParseSwapOrder(order any, optionalArgs ...any) any {
	...
	var filled *float64 = this.SafeNumber2(order, "cumQty", "cumQtyRq")
	var remaining *float64 = this.SafeNumber2(order, "leavesQty", "leavesQtyRq")
...
func (this *Phemex) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	...
	var typeValue string = this.Capitalize(typeVar)
	var request map[string]any = map[string]any{
		"symbol":  market["id"],
		"side":    requestSide,
		"ordType": typeValue,
	...
	var triggerPrice *string = this.SafeStringN(paramsOmitted, []any{"stopPx", "stopPrice", "triggerPrice"})
	if triggerPrice != nil {
		if isStableSettled {
	...
	var orderParams any = this.Omit(paramsOmitted, []any{"stopPx", "stopPrice", "stopLoss", "takeProfit", "triggerPrice"})
	if GetValue(market, "spot") == true {
		var qtyType *string = this.SafeString(orderParams, "qtyType", "ByBase")
		...
		var hedged *bool = this.SafeBool(orderParams, "hedged", false)
		...
		if triggerPrice != nil {
			var triggerType *string = this.SafeString(orderParams, "triggerType", "ByMarkPrice")
			request["triggerType"] = triggerType
			// set direction & exchange specific order type
			var triggerDirectionparamsTriggerDirectionVariable []any = this.HandleParamString(orderParams, "triggerDirection")
			var triggerDirection *string = SafeStringPtr(GetValue(triggerDirectionparamsTriggerDirectionVariable, 0))
			paramsTriggerDirection := GetValue(triggerDirectionparamsTriggerDirectionVariable, 1)
		...
		if hasStopLoss || hasTakeProfit {
			if hasStopLoss {
				...
				if stopLossTriggerPriceType != nil {
					request["slTrigger"] = this.SafeString(GetValue(this.Options, "triggerPriceTypesMap"), stopLossTriggerPriceType, stopLossTriggerPriceType)
				}
			...
			if hasTakeProfit {
				...
				if takeProfitTriggerPriceType != nil {
					request["tpTrigger"] = this.SafeString(GetValue(this.Options, "triggerPriceTypesMap"), takeProfitTriggerPriceType, takeProfitTriggerPriceType)
				}
	...
	var stopLossPrice *string = this.SafeString(orderParams, "stopLossPrice")
	...
	if isStableSettled {
		...
		response = MapTyped(PanicOnError((<-this.PrivatePostGOrders(this.Extend(request, orderParams))).Raw))
	} else if GetValue(market, "contract") == true {

		response = MapTyped(PanicOnError((<-this.PrivatePostOrders(this.Extend(request, orderParams))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivatePostSpotOrders(this.Extend(request, orderParams))).Raw))
	}
	//
	// spot
	//
...
func (this *Phemex) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var triggerPrice *string = this.SafeStringN(paramsOmitted2, []any{"triggerPrice", "stopPx", "stopPrice"})
	if triggerPrice != nil {
		if isStableSettled {
			request["stopPxRp"] = this.PriceToPrecision(symbol, triggerPrice)
		} else {
	...
	if isStableSettled {
		...
		response = MapTyped(PanicOnError((<-this.PrivatePutGOrdersReplace(this.Extend(request, paramsOmitted3))).Raw))
	} else if GetValue(market, "swap") == true {

		response = MapTyped(PanicOnError((<-this.PrivatePutOrdersReplace(this.Extend(request, paramsOmitted3))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivatePutSpotOrders(this.Extend(request, paramsOmitted3))).Raw))
	}
	var data map[string]any = MapTyped(this.SafeDict(response, "data", map[string]any{}))
...
func (this *Phemex) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(market["settle"], "USDT") || IsEqual(market["settle"], "USDC") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateDeleteGOrdersCancel(this.Extend(request, paramsOmitted))).Raw))
	} else if GetValue(market, "swap") == true {

		response = MapTyped(PanicOnError((<-this.PrivateDeleteOrdersCancel(this.Extend(request, paramsOmitted))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateDeleteSpotOrders(this.Extend(request, paramsOmitted))).Raw))
	}
	var data map[string]any = MapTyped(this.SafeDict(response, "data", map[string]any{}))
...
func (this *Phemex) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(market["settle"], "USDT") || IsEqual(market["settle"], "USDC") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateDeleteGOrdersAll(this.Extend(request, paramsOmitted))).Raw))
	} else if GetValue(market, "swap") == true {

		response = MapTyped(PanicOnError((<-this.PrivateDeleteOrdersAll(this.Extend(request, paramsOmitted))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateDeleteSpotOrdersAll(this.Extend(request, paramsOmitted))).Raw))
	}
...
func (this *Phemex) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsEqual(market["settle"], "USDT") || IsEqual(market["settle"], "USDC") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateGetApiDataGFuturesOrdersByOrderId(this.Extend(request, paramsOmitted))).Raw))
	} else if GetValue(market, "spot") == true {

		response = MapTyped(PanicOnError((<-this.PrivateGetApiDataSpotsOrdersByOrderId(this.Extend(request, paramsOmitted))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateGetExchangeOrder(this.Extend(request, paramsOmitted))).Raw))
	}
...
func (this *Phemex) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(market["settle"], "USDT") || IsEqual(market["settle"], "USDC") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateGetApiDataSpotsOrders(this.Extend(request, params))).Raw))
	}
	var data any = this.SafeValue(response, "data", map[string]any{})
...

	{
		func(this *Phemex) (ret_ any) {
			...
			if IsEqual(market["settle"], "USDT") || IsEqual(market["settle"], "USDC") {
				...
				response = MapTyped(PanicOnError((<-this.PrivateGetGOrdersActiveList(this.Extend(request, params))).Raw))
			} else if GetValue(market, "swap") == true {

				response = MapTyped(PanicOnError((<-this.PrivateGetOrdersActiveList(this.Extend(request, params))).Raw))
			} else {

				response = MapTyped(PanicOnError((<-this.PrivateGetSpotOrders(this.Extend(request, params))).Raw))
			}
			return nil
		}(this)
		if chSent {
...
func (this *Phemex) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if (symbol == nil) || (this.SafeString(market, "settle") != nil && *this.SafeString(market, "settle") == "USDT") {
		...
		response = MapTyped(PanicOnError((<-this.PrivateGetExchangeSpotOrder(this.Extend(request, params))).Raw))
	}
	//
	// spot
	//
...
func (this *Phemex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if isUSDTSettled {
		...
		response = MapTyped(PanicOnError((<-this.PrivateGetExchangeOrderV2TradingList(this.Extend(request, paramsMarketType))).Raw))
	} else if typeVar != nil && *typeVar == "swap" {
		request["tradeType"] = "Trade"

		response = MapTyped(PanicOnError((<-this.PrivateGetExchangeOrderTrade(this.Extend(request, paramsMarketType))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateGetExchangeSpotOrderTrades(this.Extend(request, paramsMarketType))).Raw))
	}
	//
	// spot
	//
...
func (this *Phemex) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if firstSymbol != nil {
		...
		var settleparamsSettleVariable []any = this.HandleOptionStringAndParams(paramsOmitted, "fetchPositions", "settle", code)
	...
	var response map[string]any = nil
	if isUSDTSettled {
		var methodparamsMethodVariable []any = this.HandleOptionStringAndParams(paramsSubType, "fetchPositions", "method", "privateGetGAccountsAccountPositions")
		...
		if method != nil && *method == "privateGetGAccountsAccountPositions" {
			...
			response = MapTyped(PanicOnError((<-this.PrivateGetGAccountsAccountPositions(this.Extend(request, paramsMethod))).Raw))
		} else {

			response = MapTyped(PanicOnError((<-this.PrivateGetGAccountsPositions(this.Extend(request, paramsMethod))).Raw))
		}
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateGetAccountsAccountPositions(this.Extend(request, paramsSubType))).Raw))
	}
	//
	//     {
	//         "code":0,"msg":"",
...
func (this *Phemex) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if isStableSettled {
		...
		response = MapTyped(PanicOnError((<-this.PrivateGetApiDataGFuturesFundingFees(this.Extend(request, params))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.PrivateGetApiDataFuturesFundingFees(this.Extend(request, params))).Raw))
	}
	//
	//     {
	//         "code": 0,
...
func (this *Phemex) ParseFundingFeeToPrecision(value any, optionalArgs ...any) any {
	...
	var currency map[string]any = this.SafeCurrency(currencyCode)
...
func (this *Phemex) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	var inverse *bool = this.SafeBool(marketResolved, "inverse")
...
func (this *Phemex) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	var isCross bool = (marginModeValue == "cross")
	if this.InArray(market["settle"], []any{"USDT", "USDC"}) {
		var currentLeverage *string = this.SafeString(params, "leverage")
		if currentLeverage == nil {
			panic(ArgumentsRequired(this.Id + " setMarginMode() requires a \"leverage\" parameter for USDT markets"))
		}
		request["leverageRr"] = func() any {
			if isCross {
				return Precise.StringNeg(Precise.StringAbs(currentLeverage))
			}
...
func (this *Phemex) ParseMarketLeverageTiers(info any, optionalArgs ...any) any {
	...
	var marketResolved map[string]any = this.SafeMarket(marketId, market)
	var riskLimits any = (GetValue(marketResolved["info"], "riskLimits"))
	var tiers []any = []any{}
...
func (this *Phemex) Sign(path string, optionalArgs ...any) any {
	...
	if IsEqual(api, "private") {
		...
		var expiryString string = strconv.FormatInt(expiry, 10)
...
func (this *Phemex) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsEqual(market["settle"], "USDT") || IsEqual(market["settle"], "USDC") {
		...
		response = MapTyped(PanicOnError((<-this.PrivatePutGPositionsLeverage(this.Extend(request, params))).Raw))
	} else {
		request["leverage"] = leverage

		response = MapTyped(PanicOnError((<-this.PrivatePutPositionsLeverage(this.Extend(request, params))).Raw))
	}
...
func (this *Phemex) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if isUsdtSettled {
		customSymbol = Add(Add(".", market["id"]), "FR8H") // phemex requires a custom symbol for funding rate history
	} else {
	...
	if isUsdtSettled {
		...
		response = MapTyped(PanicOnError((<-this.V2GetApiDataPublicDataFundingRateHistory(this.Extend(requestUntil, paramsUntil))).Raw))
	} else {

		response = MapTyped(PanicOnError((<-this.V1GetApiDataPublicDataFundingRateHistory(this.Extend(requestUntil, paramsUntil))).Raw))
	}
	//
	//    {
	//        "code":"0",
...
func (this *Phemex) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivatePostPhemexWithdrawWalletsApiCreateWithdraw(this.Extend(request, paramsNetworkCode))).Raw))
	//
	//     {
	//         "code": 0,
	//         "msg": "OK",
...
func (this *Phemex) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "contract") != true {
		panic(BadRequest(this.Id + " fetchOpenInterest is only supported for contract markets."))
	}
	var request map[string]any = map[string]any{
		"symbol": market["id"],
	}
...
func (this *Phemex) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	var fromResult map[string]any = this.SafeCurrency(fromCurrencyId, fromCurrency)
...
func (this *Phemex) ParseConversion(conversion any, optionalArgs ...any) any {
	...
	var toCode *string = this.SafeCurrencyCode(toCoin, toCurrency)
...
func (this *Phemex) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	if firstSymbol != nil {
		...
		var settleparamsSettleVariable []any = this.HandleOptionStringAndParams(paramsOmitted, "fetchPositionsADLRank", "settle", code)
		settle = SafeStringPtr(GetValue(settleparamsSettleVariable, 0))
		paramsSettle = GetValue(settleparamsSettleVariable, 1)
	}
	...
	var response map[string]any = nil
	if isUSDTSettled {
		var methodparamsMethodVariable []any = this.HandleOptionStringAndParams(paramsSubType, "fetchPositionsADLRank", "method", "privateGetGAccountsAccountPositions")
		var method *string = SafeStringPtr(GetValue(methodparamsMethodVariable, 0))
		var paramsMethod map[string]any = MapTyped(GetValue(methodparamsMethodVariable, 1))
		if method != nil && *method == "privateGetGAccountsAccountPositions" {
...
// nolint
func (this *Phemex) LoadMarkets(params ...any) (map[string]MarketInterface, error) {
...
func (this *Phemex) CancelAllOrdersAfter(timeout int64, options ...CancelAllOrdersAfterOptions) (map[string]any, error) {
...
func (this *Phemex) FetchAccounts(params ...any) ([]Account, error) {
	return this.exchangeTyped.FetchAccounts(params...)
}
func (this *Phemex) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {
...
func (this *Phemex) FetchBorrowRate(code string, amount float64, options ...FetchBorrowRateOptions) (map[string]any, error) {
...
func (this *Phemex) FetchConvertCurrencies(params ...any) (Currencies, error) {
...
func (this *Phemex) FetchCrossBorrowRates(params ...any) (CrossBorrowRates, error) {
...
func (this *Phemex) FetchDepositAddressesByNetwork(code string, options ...FetchDepositAddressesByNetworkOptions) (DepositAddresses, error) {
...
func (this *Phemex) FetchIsolatedBorrowRates(params ...any) (IsolatedBorrowRates, error) {
...
func (this *Phemex) FetchTradingFees(params ...any) (TradingFees, error) {
	return this.exchangeTyped.FetchTradingFees(params...)
}
func (this *Phemex) FetchTradingLimits(options ...FetchTradingLimitsOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchTradingLimits(options...)
}
func (this *Phemex) FetchTransactionFee(code string, options ...FetchTransactionFeeOptions) (map[string]any, error) {
	return this.exchangeTyped.FetchTransactionFee(code, options...)
}
func (this *Phemex) FetchTransactionFees(options ...FetchTransactionFeesOptions) (map[string]any, error) {
...
func (this *Phemex) FetchBalanceWs(params ...any) (Balances, error) {
...
func (this *Phemex) UnWatchMyTrades(options ...UnWatchMyTradesOptions) (any, error) {
	return this.exchangeTyped.UnWatchMyTrades(options...)
}
func (this *Phemex) UnWatchOHLCV(symbol string, options ...UnWatchOHLCVOptions) (any, error) {
	return this.exchangeTyped.UnWatchOHLCV(symbol, options...)
}
func (this *Phemex) UnWatchOHLCVForSymbols(symbolsAndTimeframes [][]string, options ...UnWatchOHLCVForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchOHLCVForSymbols(symbolsAndTimeframes, options...)
}
func (this *Phemex) UnWatchOrderBook(symbol string, options ...UnWatchOrderBookOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrderBook(symbol, options...)
}
func (this *Phemex) UnWatchOrderBookForSymbols(symbols []string, options ...UnWatchOrderBookForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrderBookForSymbols(symbols, options...)
}
func (this *Phemex) UnWatchOrders(options ...UnWatchOrdersOptions) (any, error) {
	return this.exchangeTyped.UnWatchOrders(options...)
}
func (this *Phemex) UnWatchTicker(symbol string, options ...UnWatchTickerOptions) (any, error) {
	return this.exchangeTyped.UnWatchTicker(symbol, options...)
}
func (this *Phemex) UnWatchTickers(options ...UnWatchTickersOptions) (any, error) {
	return this.exchangeTyped.UnWatchTickers(options...)
}
func (this *Phemex) UnWatchTrades(symbol string, options ...UnWatchTradesOptions) (any, error) {
	return this.exchangeTyped.UnWatchTrades(symbol, options...)
}
func (this *Phemex) UnWatchTradesForSymbols(symbols []string, options ...UnWatchTradesForSymbolsOptions) (any, error) {
	return this.exchangeTyped.UnWatchTradesForSymbols(symbols, options...)
}
func (this *Phemex) WatchBalance(params ...any) (Balances, error) {
