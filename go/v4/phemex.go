...
func (this *PhemexCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes29748 := (<-this.LoadMarkets())
		PanicOnError(retRes29748)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *PhemexCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31518 := (<-this.LoadMarkets())
		PanicOnError(retRes31518)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
		}
...
func (this *PhemexCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes36328 := (<-this.LoadMarkets())
		PanicOnError(retRes36328)
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
			currency = this.Currency(code)
		}
...
func (this *PhemexCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes38168 := (<-this.LoadMarkets())
		PanicOnError(retRes38168)
...
func (this *PhemexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes44598 := (<-this.LoadMarkets())
		PanicOnError(retRes44598)
		var market any = this.Market(symbol)
		if !IsTrue(GetValue(market, "swap")) {
		...
		if IsTrue(this.InArray(GetValue(market, "settle"), []any{"USDT", "USDC"})) {
			...
			retRes447819 := (<-this.PrivatePutGPositionsLeverage(this.Extend(request, params)))
			PanicOnError(retRes447819)
			ch <- retRes447819
			return nil
		}
		...
		retRes448815 := (<-this.PrivatePutPositionsLeverage(this.Extend(request, params)))
...
func (this *PhemexCore) SetPositionMode(hedged any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes451615 := (<-this.PrivatePutGPositionsSwitchPosModeSync(this.Extend(request, params)))
		PanicOnError(retRes451615)
		ch <- retRes451615
		return nil
...
func (this *PhemexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47238 := (<-this.LoadMarkets())
		PanicOnError(retRes47238)
...
func (this *PhemexCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes48498 := (<-this.LoadMarkets())
		PanicOnError(retRes48498)
		if IsTrue(IsEqual(code, nil)) {
...
func (this *PhemexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes498119 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
...
func (this *PhemexCore) CreateConvertTrade(id any, fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes52458 := (<-this.LoadMarkets())
		PanicOnError(retRes52458)
		var fromCurrency any = this.Currency(fromCode)
		var toCurrency any = this.Currency(toCode)
		var valueScale any = this.SafeInteger(fromCurrency, "valueScale")
		var request any = map[string]any{
