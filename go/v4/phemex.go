...
func (this *PhemexCore) FetchOrders(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes32018 := (<-this.LoadMarkets())
		PanicOnError(retRes32018)
		var market interface{} = this.Market(symbol)
		var request interface{} = map[string]interface{}{
			"symbol": GetValue(market, "id"),
		}
...
func (this *PhemexCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(this.InArray(GetValue(market, "settle"), []interface{}{"USDT", "USDC"})) {
			...
			retRes439219 := (<-this.PrivatePutGPositionsLeverage(this.Extend(request, params)))
			PanicOnError(retRes439219)
			ch <- retRes439219
			return nil
		}
		...
		retRes440215 := (<-this.PrivatePutPositionsLeverage(this.Extend(request, params)))
		PanicOnError(retRes440215)
		ch <- retRes440215
		return nil
...
func (this *PhemexCore) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes443015 := (<-this.PrivatePutGPositionsSwitchPosModeSync(this.Extend(request, params)))
...
func (this *PhemexCore) FetchFundingRateHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		if IsTrue(paginate) {
			...
			retRes489419 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 100))
			PanicOnError(retRes489419)
			ch <- retRes489419
			return nil
		}
...
func (this *PhemexCore) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes49678 := (<-this.LoadMarkets())
		PanicOnError(retRes49678)
		this.CheckAddress(address)
		var currency interface{} = this.Currency(code)
...
func (this *PhemexCore) FetchConvertTradeHistory(optionalArgs ...interface{}) <-chan interface{} {
	...
	go func() interface{} {
		...
		retRes52098 := (<-this.LoadMarkets())
		PanicOnError(retRes52098)
		var request interface{} = map[string]interface{}{}
		if IsTrue(!IsEqual(code, nil)) {
