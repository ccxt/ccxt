...
func (this *PhemexCore) ParseSwapMarket(market any) any {
	...
	} else if EvalTruthy(GetIndexOf(contractSizeString, " ")) {
		// "1 USD"
		// "0.005 ETH"
...
func (this *PhemexCore) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "linear")) && isStableSettled {
...
func (this *PhemexCore) ParseOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	if (!IsEqual(market, nil)) && EvalTruthy(GetValue(market, "spot")) {
...
func (this *PhemexCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var isStableSettled bool = (IsEqual(GetValue(market, "settle"), "USDT")) || (IsEqual(GetValue(market, "settle"), "USDC"))
	var usesSpecialFromToEndpoint bool = (EvalTruthy(GetValue(market, "linear")) || isStableSettled) && ((!IsEqual(since, nil)) || (until != nil))
...
func (this *PhemexCore) fetchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "swap")) {
		if EvalTruthy(GetValue(market, "inverse")) || IsEqual(GetValue(market, "settle"), "USD") {
...
func (this *PhemexCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if EvalTruthy(GetValue(market, "spot")) {
		...
		if IsEqual(qtyType, "ByQuote") {
			...
			if EvalTruthy(GetValue(this.Options, "createOrderByQuoteRequiresPrice")) {
				if !IsEqual(price, nil) {
...
func (this *PhemexCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if (IsEqual(symbol, nil)) || (IsEqual(this.SafeString(market, "settle"), "USDT")) {
		...
		response = (<-this.PrivateGetExchangeOrderV2OrderList(this.Extend(request, params)))
		PanicOnError(response)
	} else if !IsEqual(market, nil) && EvalTruthy(GetValue(market, "swap")) {
...
func (this *PhemexCore) ParsePosition(position any, optionalArgs ...any) any {
	...
	return this.SafePosition(map[string]any{
		...
		"timestamp":                   timestamp,
		"datetime":                    this.Iso8601(timestamp),
		"marginMode":                  Ternary(EvalTruthy(isCross), "cross", "isolated"),
		"side":                        side,
...
func (this *PhemexCore) ParseMarginModification(data any, optionalArgs ...any) any {
	...
	var codeCurrency any = Ternary(EvalTruthy(inverse), "base", "quote")
	return map[string]any{
		"info":       data,
...
func (this *PhemexCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	var response any = nil
	if IsEqual(GetValue(market, "settle"), "USDT") || IsEqual(GetValue(market, "settle"), "USDC") {
		if !EvalTruthy(isHedged) && (longLeverageRr == nil) && (shortLeverageRr == nil) {
