		...
		if triggerPrice != nil {
			...
			if (triggerDirection == "ascending") || (triggerDirection == "up") {
				if IsEqual(side, "sell") {
					AddElementToObject(request, "ordType", Ternary((typeVar == "Market"), "MarketIfTouched", "LimitIfTouched"))
				} else if IsEqual(side, "buy") {
					AddElementToObject(request, "ordType", Ternary((typeVar == "Market"), "Stop", "StopLimit"))
				}
...
func (this *PhemexCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var isUSDTSettled bool = (typeVar != "spot") && ((IsEqual(symbol, nil)) || (IsEqual(this.SafeString(market, "settle"), "USDT")))
	if isUSDTSettled {
