...
func (this *BitstampCore) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
...
func (this *BitstampCore) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *BitstampCore) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	var side any = ccxt.Ternary((sideRaw != nil && *sideRaw == 0), "buy", "sell")
...
func (this *BitstampCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *BitstampCore) HandleOrders(client any, message any) {
	...
	var subscription any = ccxt.Ternary((channel == nil), nil, this.SafeValue(client.(ccxt.ClientInterface).GetSubscriptions(), channel))
...
func (this *BitstampCore) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	var side any = ccxt.Ternary((orderTypeRaw != nil && *orderTypeRaw == "1"), "sell", "buy")
	...
	var amount *string = this.SafeString(order, "amount_str")
...
func (this *BitstampCore) HandleSubscriptionStatus(client any, message any) {
	...
	if ccxt.IsGreaterThan(ccxt.GetIndexOf(channel, "order_book"), ccxt.OpNeg(1)) {
...
func (this *BitstampCore) HandleSubject(client any, message any) {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
		...
		if ccxt.IsGreaterThan(ccxt.GetIndexOf(channel, key), ccxt.OpNeg(1)) {
...
func (this *BitstampCore) authenticateBody(ch chan any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if (expiresIn == nil) || (ccxt.IsGreaterThan(time, expiresIn)) {
		...
		{
			func(this *BitstampCore) (ret_ any) {
				defer func() {
					if e := recover(); e != nil {
						if e == "break" {
							return
						}
						ret_ = func(this *BitstampCore) any {
							// catch block:
...
func (this *BitstampCore) subscribePrivateBody(ch chan any, subscription any, messageHash any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
