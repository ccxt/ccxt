...
func  (this *BitmexCore) WatchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ...
            _ = params
                ...
                retRes131315 :=  (<-this.WatchOrderBookForSymbols([]any{symbol}, limit, params))
                ccxt.PanicOnError(retRes131315)
                ch <- retRes131315
                return nil
...
func  (this *BitmexCore) WatchHeartbeat(optionalArgs ...any) <- chan any {
            ...
            var url any = ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws")
                ...
                retRes153615 :=  (<-this.Watch(url, event))
                ccxt.PanicOnError(retRes153615)
                ch <- retRes153615
                return nil
