 ...
 */
func  (this *Bitmex) WatchTickerAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/?id=ticker-structure}
 */
func  (this *Bitmex) WatchTickersAsync(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchTickersBody(ch, optionalArgs...)
    return ch
}
func (this *Bitmex) watchTickersBody(ch chan any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *Bitmex) WatchLiquidationsAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object} an array of [liquidation structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#liquidation-structure}
 */
func  (this *Bitmex) WatchLiquidationsForSymbolsAsync(symbols any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchLiquidationsForSymbolsBody(ch, symbols, optionalArgs...)
    return ch
}
func (this *Bitmex) watchLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
        since := ccxt.GetArg(optionalArgs, 0, nil)
        _ = since
 ...
 */
func  (this *Bitmex) WatchBalanceAsync(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 */
func  (this *Bitmex) WatchTradesAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchTradesBody(ch, symbol, optionalArgs...)
    return ch
}
func (this *Bitmex) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
        since := ccxt.GetArg(optionalArgs, 0, nil)
        _ = since
 ...
 */
func  (this *Bitmex) WatchPositionsAsync(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchPositionsBody(ch, optionalArgs...)
    return ch
}
func (this *Bitmex) watchPositionsBody(ch chan any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
        symbols := ccxt.GetArg(optionalArgs, 0, nil)
        _ = symbols
 ...
 */
func  (this *Bitmex) WatchOrdersAsync(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchOrdersBody(ch, optionalArgs...)
    return ch
}
func (this *Bitmex) watchOrdersBody(ch chan any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *Bitmex) WatchMyTradesAsync(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchMyTradesBody(ch, optionalArgs...)
    return ch
}
func (this *Bitmex) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
        symbol := ccxt.GetArg(optionalArgs, 0, nil)
        _ = symbol
 ...
 */
func  (this *Bitmex) WatchOrderBookAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchOrderBookBody(ch, symbol, optionalArgs...)
    return ch
}
func (this *Bitmex) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
 ...
 */
func  (this *Bitmex) WatchOrderBookForSymbolsAsync(symbols any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
 ...
 * @returns {object[]} a list of [trade structures]{@link https://docs.ccxt.com/?id=public-trades}
 */
func  (this *Bitmex) WatchTradesForSymbolsAsync(symbols any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchTradesForSymbolsBody(ch, symbols, optionalArgs...)
    return ch
}
func (this *Bitmex) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
        since := ccxt.GetArg(optionalArgs, 0, nil)
        _ = since
 ...
 */
func  (this *Bitmex) WatchOHLCVAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitmex) WatchHeartbeatAsync(optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
...
func  (this *Bitmex) HandleErrorMessage(client any, message any) any  {
    //
...
func  (this *Bitmex) HandleMessage(client any, message any)  {
    //
    //     {
    //         "info": "Welcome to the BitMEX Realtime API.",
    //         "version": "2019-11-22T00:24:37.000Z",
...
func (this *Bitmex) WatchLiquidationsForSymbols(symbols []string, options ...ccxt.WatchLiquidationsForSymbolsOptions) ([]ccxt.Liquidation, error) {
    ...
    res := <- this.WatchLiquidationsForSymbolsAsync(symbols, opts.Since, opts.Limit, opts.Params)
    if ccxt.IsError(res) {
        return nil, ccxt.CreateReturnError(res)
    }
    return ccxt.NewLiquidationArray(res), nil
...
func (this *Bitmex) WatchHeartbeat(params ...any) (map[string]any, error) {
    res := <- this.WatchHeartbeatAsync(params...)
    if ccxt.IsError(res) {
