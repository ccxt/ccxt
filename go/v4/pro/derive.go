 ...
 */
func (this *Derive) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
 ...
 */
func (this *Derive) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Derive) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Derive) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	trades := (<-this.WatchPublicAsync(topic, request, subscription))
...
func (this *Derive) watchPrivateBody(ch chan any, messageHash any, message any, subscription any) any {
	...
	retRes5078 := (<-this.AuthenticateAsync())
...
func (this *Derive) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	orders := (<-this.WatchPrivateAsync(messageHash, message, subscription))
...
func (this *Derive) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	trades := (<-this.WatchPrivateAsync(messageHash, message, subscription))
	ccxt.PanicOnError(trades)
	if ccxt.IsTrue(this.NewUpdates) {
