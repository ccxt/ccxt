...
func (this *Woo) watchPublicBody(ch chan any, messageHash any, message any) any {
	...
	var urlUid any = ccxt.Ternary((this.Uid != ""), ccxt.Add("/", this.Uid), "")
...
func (this *Woo) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes13712 := (<-this.LoadMarketsAsync())
...
func (this *Woo) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes17712 := (<-this.LoadMarketsAsync())
...
func (this *Woo) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	if maker != nil {
		takerOrMaker = ccxt.Ternary((maker != nil && *maker), "maker", "taker")
	}
...
func (this *Woo) watchPrivateBody(ch chan any, messageHash any, message any, optionalArgs ...any) any {
	...
	retRes9438 := (<-this.AuthenticateAsync(params))
...
func (this *Woo) watchPrivateMultipleBody(ch chan any, messageHashes any, message any, optionalArgs ...any) any {
	...
	retRes9548 := (<-this.AuthenticateAsync(params))
...
func (this *Woo) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var topic string = ccxt.Ternary((trigger != nil && *trigger == true), "algoexecutionreportv2", "executionreport").(string)
...
func (this *Woo) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	trades := (<-this.WatchPrivateAsync(messageHash, message))
	ccxt.PanicOnError(trades)
	if ccxt.EvalTruthy(this.NewUpdates) {
...
func (this *Woo) pongBody(ch chan any, client any, message any) any {
	...
	retRes16628 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
		"event": "pong",
	}))
