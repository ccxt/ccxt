 ...
 */
func (this *Bybit) CreateOrderWsAsync(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Bybit) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes26812 := (<-this.LoadMarketsAsync())
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Bybit) EditOrderWsAsync(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Bybit) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes35012 := (<-this.LoadMarketsAsync())
...
func (this *Bybit) unWatchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes45312 := (<-this.LoadMarketsAsync())
...
func (this *Bybit) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes64612 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes64612)
	}
	symbols = this.MarketSymbols(symbols, nil, false)
	var messageHashes any = []any{}

	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbols, 0), false, "watchBidsAsks", params))
	ccxt.PanicOnError(url)
	params = this.CleanParams(params)
	var marketIds any = this.MarketIds(symbols)
	var topics any = []any{}
...
func (this *Bybit) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbols, 0), false, "watchTrades", params))
	ccxt.PanicOnError(url)
	var topics any = []any{}
	var messageHashes any = []any{}
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
...
func (this *Bybit) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes115012 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes115012)
	}
	symbols = this.MarketSymbols(symbols, nil, false, true)

	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbols, 0), false, "unWatchTradesForSymbols", params))
	ccxt.PanicOnError(url)
	var messageHashes any = []any{}
	var topics any = []any{}
	var subMessageHashes any = []any{}
...
func (this *Bybit) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes132412 := (<-this.LoadMarketsAsync())
	...
	retRes13318 := (<-this.AuthenticateAsync(url))
...
func (this *Bybit) unWatchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes13738 := (<-this.AuthenticateAsync(url))
...
func (this *Bybit) unWatchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes17178 := (<-this.AuthenticateAsync(url))
...
func (this *Bybit) ParseWsLiquidation(liquidation any, optionalArgs ...any) any {
	//
	//     {
	//         "price": "0.03803",
	//         "side": "Buy",
...
func (this *Bybit) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes18748 := (<-this.AuthenticateAsync(url))
...
func (this *Bybit) unWatchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes190012 := (<-this.LoadMarketsAsync())
	...
	retRes19098 := (<-this.AuthenticateAsync(url))
...
func (this *Bybit) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes207612 := (<-this.LoadMarketsAsync())
	...
	retRes20888 := (<-this.AuthenticateAsync(url))
...
func (this *Bybit) watchTopicsBody(ch chan any, url any, messageHashes any, topics any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(topicsLength, messageHashesLength)) {
		for i := 0; ccxt.IsLessThan(i, topicsLength); i++ {
			var messageHash any = ccxt.GetValue(messageHashes, i)
		...
		var allSubscribed bool = true
		for i := 0; ccxt.IsLessThan(i, messageHashesLength); i++ {
			var messageHash any = ccxt.GetValue(messageHashes, i)
			if !ccxt.IsTrue((ccxt.InOp(client.(ccxt.ClientInterface).GetSubscriptions(), messageHash))) {
				allSubscribed = false
				break
	...
	var newTopicsLength int = ccxt.GetArrayLength(newTopics)
	if ccxt.IsTrue(ccxt.IsGreaterThan(newTopicsLength, 0)) {
	...
	retRes242015 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes, subscription))
...
func (this *Bybit) unWatchTopicsBody(ch chan any, url any, topic any, symbols any, messageHashes any, subMessageHashes any, topics any, optionalArgs ...any) any {
	...
	retRes243815 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes, this.Extend(subscription, subExtension)))
...
func (this *Bybit) authenticateBody(ch chan any, url any, optionalArgs ...any) any {
	...
	retRes246215 := <-future.(*ccxt.Future).Await()
			...
			defer func() {
				if error := recover(); error != nil {
					...
					ret_ = func(this *Bybit) any {
						// catch block:
						var reqId any = this.SafeString2(message, "req_id", "reqId")
						var foundSubscription bool = false
						if ccxt.IsTrue(!ccxt.IsEqual(reqId, nil)) {
						...
						if !ccxt.IsTrue(foundSubscription) {
							if ccxt.IsTrue(!ccxt.IsEqual(reqId, nil)) {
