...
func (this *Bybit) DescribeData() any {
...
func (this *Bybit) getUrlByMarketTypeBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	var accessibility string = "public"
	if isPrivate == true {
		accessibility = "private"
	}
	var methodValue string = func() string {
		if method == nil {
			return ""
		}
		return *method
...
func (this *Bybit) CleanParams(params any) any {
	var paramsOmitted any = this.Omit(params, []any{"type", "subType", "settle", "defaultSettle", "unifiedMargin"})
 ...
 */
func (this *Bybit) CreateOrderWsAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Bybit) createOrderWsBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	var request map[string]any = map[string]any{
		...
		"header": map[string]any{
			"X-BAPI-TIMESTAMP":   strconv.FormatInt(this.Milliseconds(), 10),
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Bybit) EditOrderWsAsync(id any, symbol any, typeVar string, side string, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.editOrderWsBody(ch, id, symbol, typeVar, side, optionalArgs...)
	return ch
}
func (this *Bybit) editOrderWsBody(ch chan any, id any, symbol any, typeVar string, side string, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Bybit) CancelOrderWsAsync(id any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
 ...
 */
func (this *Bybit) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Bybit) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbolsValue, 0), false, "watchTickers", params))
	ccxt.PanicOnError(url)
	var paramsValue any = this.CleanParams(params)
	...
	for i := 0; i < ccxt.GetArrayLength(marketIds); i++ {
		...
		topics = append(topics, *topic+"."+*marketId)
		messageHashes = append(messageHashes, ccxt.Add("ticker:", ccxt.GetValue(symbolsValue, i)))
	}

	var ticker map[string]any = ccxt.MapTyped(ccxt.PanicOnError((<-this.WatchTopicsAsync(url, messageHashes, topics, paramsValue))))
	if this.NewUpdates {
...
func (this *Bybit) unWatchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(marketIds); i++ {
		var marketId *string = ccxt.SafeStringPtr(ccxt.GetValue(marketIds, i))
		var symbol *string = ccxt.SafeStringPtr(ccxt.GetValue(symbolsValue, i))
		topics = append(topics, *topic+"."+*marketId)
		subMessageHashes = append(subMessageHashes, "ticker:"+*symbol)
 ...
 * @returns {object} a [ticker structure]{@link https://docs.ccxt.com/?id=ticker-structure}
 */
func (this *Bybit) UnWatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.unWatchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	var params map[string]any = ccxt.GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Bybit) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbolsValue, 0), false, "watchBidsAsks", params))
	ccxt.PanicOnError(url)
	var paramsValue any = this.CleanParams(params)
	var marketIds any = this.MarketIds(symbolsValue)
	var topics []any = []any{}
	for i := 0; i < ccxt.GetArrayLength(marketIds); i++ {
		var marketId *string = ccxt.SafeStringPtr(ccxt.GetValue(marketIds, i))
		var topic string = "orderbook.1." + *marketId
		topics = append(topics, topic)
		messageHashes = append(messageHashes, ccxt.Add("bidask:", ccxt.GetValue(symbolsValue, i)))
	}
 ...
 */
func (this *Bybit) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOHLCVBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Bybit) watchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	var firstSymbol *string = ccxt.SafeStringPtr(ccxt.GetValue(marketSymbols, 0))
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		var symbolString *string = ccxt.SafeStringPtr(market["symbol"])
		var unfiedTimeframe *string = ccxt.SafeStringPtr(func() any {
			if 1 >= 0 && 1 < len(data) {
...
func (this *Bybit) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		var timeframeId *string = this.SafeString(this.Timeframes, unfiedTimeframe, unfiedTimeframe)
		rawHashes = append(rawHashes, ccxt.Add("kline."+*timeframeId+".", market["id"]))
		subMessageHashes = append(subMessageHashes, "ohlcv::"+*symbolString+"::"+*unfiedTimeframe)
		messageHashes = append(messageHashes, "unsubscribe::ohlcv::"+*symbolString+"::"+*unfiedTimeframe)
	}
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func (this *Bybit) UnWatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.unWatchOHLCVBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) unWatchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	var timeframe string = ccxt.GetArgString(optionalArgs, 0, "1m")
	_ = timeframe
...
func (this *Bybit) ParseWsOHLCV(ohlcv any, optionalArgs ...any) any {
	//
	//     {
	//         "start": 1670363160000,
	//         "end": 1670363219999,
 ...
 */
func (this *Bybit) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Bybit) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbolsNormalized, 0), false, "watchOrderBook", params))
	ccxt.PanicOnError(url)
	var paramsValue any = this.CleanParams(params)
	...
	for i := 0; i < len(symbolsNormalized); i++ {
		...
		var topic *string = ccxt.SafeStringPtr(ccxt.Add("orderbook."+ccxt.ToString(limitResolved)+".", marketId))
		topics = append(topics, topic)
...
func (this *Bybit) unWatchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbolsNormalized, 0), false, "watchOrderBook", paramsOmitted))
	ccxt.PanicOnError(url)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/?id=order-book-structure}
 */
func (this *Bybit) UnWatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.unWatchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	var params map[string]any = ccxt.GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Bybit) HandleOrderBook(client any, message any) {
	...
	if limit != nil && *limit == "1" {
		...
		client.(ccxt.ClientInterface).Resolve(newBidsAsks, "bidask:"+*symbol)
	}
}
func (this *Bybit) HandleDelta(bookside any, delta any) {
	var bidAsk any = this.ParseOrderBookBidAsk(delta, 0, 1)
	bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func (this *Bybit) HandleDeltas(bookside any, deltas any) {
...
func (this *Bybit) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbolsNormalized, 0), false, "watchTrades", paramsValue))
	ccxt.PanicOnError(url)
	var topics []any = []any{}
	var messageHashes []any = []any{}
	for i := 0; i < len(symbolsNormalized); i++ {
		var symbol string = ccxt.GetValue(symbolsNormalized, i).(string)
		var market map[string]any = this.Market(symbol)
		var topic *string = ccxt.SafeStringPtr(ccxt.Add("publicTrade.", market["id"]))
		topics = append(topics, topic)
...
func (this *Bybit) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	url := (<-this.GetUrlByMarketTypeAsync(ccxt.GetValue(symbolsNormalized, 0), false, "unWatchTradesForSymbols", params))
	ccxt.PanicOnError(url)
	var messageHashes []any = []any{}
	var topics []any = []any{}
	var subMessageHashes []any = []any{}
	for i := 0; i < len(symbolsNormalized); i++ {
		...
		var topic *string = ccxt.SafeStringPtr(ccxt.Add("publicTrade.", market["id"]))
		topics = append(topics, topic)
		var messageHash string = "unsubscribe:trade:" + symbol
		messageHashes = append(messageHashes, messageHash)
 ...
 * @returns {any} status of the unwatch request
 */
func (this *Bybit) UnWatchTradesAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.unWatchTradesBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	var params map[string]any = ccxt.GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Bybit) loadPositionsSnapshotBody(ch chan any, client any, messageHash any) any {
	...
	var fetchFunctions []any = []any{this.FetchPositionsAsync(nil, map[string]any{
		"type":    "swap",
		"subType": "linear",
	}), this.FetchPositionsAsync(nil, map[string]any{
		"type":    "swap",
		"subType": "inverse",
	})}
 ...
 */
func (this *Bybit) WatchLiquidationsAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchLiquidationsBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bybit) watchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	var since *int64 = ccxt.GetArgInt64Ptr(optionalArgs, 0, nil)
	_ = since
...
func (this *Bybit) HandleLiquidation(client any, message map[string]any) {
	...
	if ccxt.IsArray(message["data"]) {
		...
		for i := 0; i < len(rawLiquidations); i++ {
			var rawLiquidation map[string]any = ccxt.SafeMapTyped(rawLiquidations, i)
...
func (this *Bybit) ParseWsLiquidation(liquidation map[string]any, optionalArgs ...any) any {
	//
	//     {
	//         "price": "0.03803",
	//         "side": "Buy",
	...
	var marketResolved map[string]any = this.SafeMarket(marketId, market, "", "contract")
...
func (this *Bybit) HandleBalance(client any, message map[string]any) {
	...
	if topic != nil && *topic == "wallet" {
		var data any = this.SafeValue(message, "data", map[string]any{})
		for i := 0; i < ccxt.GetArrayLength(data); i++ {
			var result map[string]any = ccxt.SafeMapTyped(data, 0)
			account = this.SafeStringLower(result, "accountType")
			rawBalances = this.ArrayConcat(rawBalances, this.SafeList(result, "coin", []any{}))
		}
		info = data
	}
...
func (this *Bybit) ParseWsBalance(balance any, optionalArgs ...any) {
	//
	// spot
	//    {
	//        "a": "USDT",
...
func (this *Bybit) watchTopicsBody(ch chan any, url any, messageHashes any, topics any, optionalArgs ...any) any {
	...
	if topicsLength == messageHashesLength {
		...
		for i := 0; i < topicsLength; i++ {
			...
			if !(ccxt.InOp(subscribedTopics, topic)) {
...
func (this *Bybit) HandleErrorMessage(client any, message any) any {
	...
	{
		ret__ := func(this *Bybit) (ret_ any) {
			defer func() {
				if error := recover(); error != nil {
					if error == "break" {
						return
					}
					ret_ = func(this *Bybit) any {
						// catch block:
						var reqId *string = this.SafeString2(message, "req_id", "reqId")
						var foundSubscription bool = false
						if reqId != nil {
						...
						if !foundSubscription {
							if reqId != nil {
								client.(ccxt.ClientInterface).Reject(error, reqId)
...
func (this *Bybit) HandleMessage(client any, message any) {
	...
	if func() int {
		...
		return strings.Index(*topic, "orderbook")
	}() >= 0 {
	...
	for i := 0; i < len(keys); i++ {
		...
		if func() int {
			...
			return strings.Index(*topic, key)
		}() >= 0 {
...
func (this *Bybit) Ping(client any) any {
	return map[string]any{
		"req_id": this.RequestId(),
		"op":     "ping",
	}
}
func (this *Bybit) HandlePong(client any, message any) any {
	//
	//   {
	//       "success": true,
	//       "ret_msg": "pong",
...
func (this *Bybit) HandleAuthenticate(client any, message any) any {
	//
	//    {
	//        "success": true,
	//        "ret_msg": '',
...
func (this *Bybit) HandleSubscriptionStatus(client any, message any) any {
	//
	//    {
	//        "topic": "kline",
	//        "event": "sub",
