...
func (this *Bybit) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		...
		var topic *string = ccxt.SafeStringPtr(ccxt.Add("orderbook."+ccxt.ToString(limit)+".", marketId))
		topics = append(topics, topic)
...
func (this *Bybit) watchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var messageHash *string = ccxt.SafeStringPtr(ccxt.Add("liquidations::", symbol))
