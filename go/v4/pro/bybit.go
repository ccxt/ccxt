...
func (this *Bybit) watchTickerBody(ch chan any, symbol string, optionalArgs ...any) any {
	...
	if (market["spot"] != true) && !ccxt.IsEqual(topic, "tickers") {
...
func (this *Bybit) watchTopicsBody(ch chan any, url any, messageHashes any, topics any, optionalArgs ...any) any {
	...
	if topicsLength == messageHashesLength {
		...
		for i := 0; i < len(subscriptionHashes); i++ {
			var existing map[string]any = ccxt.SafeMapTyped(client.(ccxt.ClientInterface).GetSubscriptions(), subscriptionHashes[i])
