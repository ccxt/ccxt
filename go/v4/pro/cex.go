...
func (this *CexCore) ParseWsOrderUpdate(order any, optionalArgs ...any) any {
	...
	var quote any = this.SafeCurrencyCode(quoteId)
	var symbol any = nil
	if !ccxt.IsEqual(base, nil) && !ccxt.IsEqual(quote, nil) {
...
func (this *CexCore) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var depth any = ccxt.Ternary((ccxt.IsEqual(limit, nil)), 0, limit)
	var subscribe map[string]any = map[string]any{
...
func (this *CexCore) HandleOHLCV(client any, message any) {
	...
	var dataLength int = ccxt.GetArrayLength(data)
	if ccxt.IsGreaterThan(dataLength, 0) {
		client.(ccxt.ClientInterface).Resolve(stored, messageHash)
	}
}
