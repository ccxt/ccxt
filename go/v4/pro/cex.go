...
func (this *Cex) ParseWsOldTrade(trade any, optionalArgs ...any) any {
	...
	_ = market
	var tradeParts any = trade
	if !ccxt.IsArray(trade) {
		tradeParts = ccxt.Split(trade, ":")
	}
	var side *string = this.SafeString(tradeParts, 0)
	var timestamp *int64 = this.SafeInteger(tradeParts, 1)
...
func (this *Cex) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if !ccxt.IsEqual(symbolsNormalized, nil) && !this.InArray(tickerSymbol, symbolsNormalized) {
...
func (this *Cex) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	if (base != nil) && (quote != nil) {
		...
		if side != nil && *side == "sell" {
			symbol = ccxt.SafeStringPtr(*quote + "/" + *base)
		}
	}
 ...
 */
func (this *Cex) CreateOrderWsAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Cex) createOrderWsBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
