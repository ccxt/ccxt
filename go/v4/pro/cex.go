...
func (this *Cex) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes718 := (<-this.AuthenticateAsync(params))
...
func (this *Cex) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(method, "private")) {
		...
		retRes28512 := (<-this.AuthenticateAsync())
...
func (this *Cex) fetchBalanceWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes4648 := (<-this.AuthenticateAsync())
...
func (this *Cex) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes4928 := (<-this.AuthenticateAsync(params))
...
func (this *Cex) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes5338 := (<-this.AuthenticateAsync(params))
...
func (this *Cex) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes9828 := (<-this.AuthenticateAsync())
...
func (this *Cex) fetchOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes12728 := (<-this.AuthenticateAsync())
...
func (this *Cex) fetchOpenOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes13098 := (<-this.AuthenticateAsync())
...
func (this *Cex) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes13468 := (<-this.AuthenticateAsync())
...
func (this *Cex) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes13898 := (<-this.AuthenticateAsync())
...
func (this *Cex) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes14238 := (<-this.AuthenticateAsync())
...
func (this *Cex) cancelOrdersWsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	retRes14598 := (<-this.AuthenticateAsync())
...
func (this *Cex) FetchTickerWs(symbol string, options ...ccxt.FetchTickerWsOptions) (ccxt.Ticker, error) {
	...
	var params = opts.Params
	res := <-this.FetchTickerWsAsync(symbol, params)
	if ccxt.IsError(res) {
		return ccxt.Ticker{}, ccxt.CreateReturnError(res)
	}
	return ccxt.NewTicker(res), nil
...
func (this *Cex) FetchOrderWs(id string, options ...ccxt.FetchOrderWsOptions) (ccxt.Order, error) {
	...
	var params = opts.Params
	res := <-this.FetchOrderWsAsync(id, symbol, params)
	if ccxt.IsError(res) {
