...
func (this *CryptocomCore) WatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes49015 := (<-this.WatchPublic(messageHash, params))
...
func (this *CryptocomCore) UnWatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes50915 := (<-this.UnWatchPublicMultiple("ticker", []any{ccxt.GetValue(market, "symbol")}, []any{messageHash}, []any{subMessageHash}, []any{subMessageHash}, params))
...
func (this *CryptocomCore) UnWatchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes57315 := (<-this.UnWatchPublicMultiple("ticker", symbols, messageHashes, subMessageHashes, subMessageHashes, params))
...
func (this *CryptocomCore) UnWatchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes77815 := (<-this.UnWatchPublicMultiple("ohlcv", []any{ccxt.GetValue(market, "symbol")}, []any{messageHash}, []any{subMessageHash}, []any{subMessageHash}, params, subExtend))
...
func (this *CryptocomCore) WatchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes9108 := (<-this.Authenticate())
		ccxt.PanicOnError(retRes9108)
...
func (this *CryptocomCore) WatchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes103715 := (<-this.WatchPrivateSubscribe(messageHash, params))
...
func (this *CryptocomCore) CreateOrderWs(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes113015 := (<-this.WatchPrivateRequest(messageHash, request))
...
func (this *CryptocomCore) EditOrderWs(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes115012)
		}
		...
		retRes115815 := (<-this.WatchPrivateRequest(messageHash, request))
		ccxt.PanicOnError(retRes115815)
		ch <- retRes115815
		return nil
...
func (this *CryptocomCore) CancelOrderWs(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes119112)
		}
		...
		retRes120115 := (<-this.WatchPrivateRequest(messageHash, request))
...
func (this *CryptocomCore) CancelAllOrdersWs(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes122715 := (<-this.WatchPrivateRequest(messageHash, request))
...
func (this *CryptocomCore) WatchPublic(messageHash any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes125315 := (<-this.Watch(url, messageHash, message, messageHash))
		ccxt.PanicOnError(retRes125315)
		ch <- retRes125315
		return nil
...
func (this *CryptocomCore) WatchPublicMultiple(messageHashes any, topics any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes126715 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes))
...
func (this *CryptocomCore) UnWatchPublicMultiple(topic any, symbols any, messageHashes any, subMessageHashes any, topics any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes128915 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes, this.Extend(subscription, subExtend)))
		ccxt.PanicOnError(retRes128915)
		ch <- retRes128915
		return nil
...
func (this *CryptocomCore) WatchPrivateRequest(nonce any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes130015 := (<-this.Watch(url, ccxt.ToString(nonce), message, true))
...
func (this *CryptocomCore) WatchPrivateSubscribe(messageHash any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes131515 := (<-this.Watch(url, messageHash, message, messageHash))
