...
func (this *Modetrade) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes47912 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes47912)
	}
	var market any = this.Market(symbol)
	symbol = ccxt.GetValue(market, "symbol")
...
func (this *Modetrade) watchPrivateBody(ch chan any, messageHash any, message any, optionalArgs ...any) any {
	...
	retRes6588 := (<-this.AuthenticateAsync(params))
...
func (this *Modetrade) watchPrivateMultipleBody(ch chan any, messageHashes any, message any, optionalArgs ...any) any {
	...
	retRes6698 := (<-this.AuthenticateAsync(params))
...
func (this *Modetrade) HandleOrderUpdate(client any, message any) {
	...
	if ccxt.IsArray(data) {
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
			...
			var tradeId any = ccxt.Ternary((tradeIdStr == nil), nil, this.OmitZero(tradeIdStr))
...
func (this *Modetrade) HandleOrder(client any, message any, topic any) {
	...
	if symbol != nil {
		...
		var order any = ccxt.Ternary((orderId == nil), nil, this.SafeDict(orders, orderId))
	...
	if topic != nil {
		...
		if splitLength == 2 {
			...
			if splitNameLength == 2 {
				...
				method = ccxt.Ternary((splitNameFirst == nil), nil, this.SafeValue(methods, splitNameFirst))
				if !ccxt.IsEqual(method, nil) {
					ccxt.CallDynamically(method, client, message)
				}
			}
