...
func (this *Kucoin) SubscribePublicUtaAsync(messageHash any, channel any, symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.subscribePublicUtaBody(ch, messageHash, channel, symbol, optionalArgs...)
	return ch
}
func (this *Kucoin) subscribePublicUtaBody(ch chan any, messageHash any, channel any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Kucoin) SubscribePrivateUtaAsync(messageHashes any, subscribeHash any, channel any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Kucoin) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		retRes35119 := (<-this.SubscribePublicUtaAsync(messageHash, channel, symbol, params))
	...
	retRes36215 := (<-this.SubscribeAsync(url, messageHash, topic, params))
...
func (this *Kucoin) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		retRes39719 := (<-this.SubscribePublicUtaAsync(utaMessageHash, "ticker", symbol, params, subscription))
		...
		retRes41319 := (<-this.UnSubscribeAsync(url, messageHash, topic, subMessageHash, params, subscription))
...
func (this *Kucoin) SubscribePublicMultipleUtaAsync(messageHashes any, channel any, symbols any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.subscribePublicMultipleUtaBody(ch, messageHashes, channel, symbols, optionalArgs...)
	return ch
}
func (this *Kucoin) subscribePublicMultipleUtaBody(ch chan any, messageHashes any, channel any, symbols any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Kucoin) WatchMultiHelperAsync(methodName any, channelName any, isFuturesChannel any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchMultiHelperBody(ch, methodName, channelName, isFuturesChannel, optionalArgs...)
	return ch
}
func (this *Kucoin) watchMultiHelperBody(ch chan any, methodName any, channelName any, isFuturesChannel any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	symbols := ccxt.GetArg(optionalArgs, 0, nil)
	_ = symbols
...
func (this *Kucoin) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		ohlcv = (<-this.SubscribePublicUtaAsync(messageHash, channel, symbol, this.Extend(extendedParams, params)))
...
func (this *Kucoin) unWatchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		retRes96519 := (<-this.SubscribePublicUtaAsync(utaMessageHash, "kline", symbol, this.Extend(extendedParams, params), subscription))
		...
		retRes98019 := (<-this.UnSubscribeAsync(url, messageHash, topic, messageHash, params, subscription))
...
func (this *Kucoin) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes113415 := (<-this.WatchTradesForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Kucoin) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes122715 := (<-this.UnSubscribeMultipleAsync(url, messageHashes, topic, messageHashes, params, subscription))
...
func (this *Kucoin) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		retRes125919 := (<-this.SubscribePublicUtaAsync(messageHash, channel, symbol, params, subscription))
		ccxt.PanicOnError(retRes125919)
		ch <- retRes125919
		return nil
	}

	retRes126115 := (<-this.UnWatchTradesForSymbolsAsync([]any{symbol}, params))
...
func (this *Kucoin) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes143515 := (<-this.WatchOrderBookForSymbolsAsync([]any{symbol}, limit, params))
...
func (this *Kucoin) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		retRes145912 := (<-this.LoadMarketsAsync())
		...
		retRes147719 := (<-this.SubscribePublicUtaAsync(messageHash, channel, symbol, params, subscription))
		ccxt.PanicOnError(retRes147719)
		ch <- retRes147719
		return nil
	}

	retRes147915 := (<-this.UnWatchOrderBookForSymbolsAsync([]any{symbol}, params))
...
func (this *Kucoin) unWatchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes160515 := (<-this.UnSubscribeMultipleAsync(url, messageHashes, topic, messageHashes, params, subscription))
...
func (this *Kucoin) ParseWsOrderStatus(status any) any {
...
func (this *Kucoin) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(uta) {
		...
		trades = (<-this.SubscribePrivateUtaAsync([]any{messageHash}, channel, channel, nil, params))
		ccxt.PanicOnError(trades)
	} else {
...
func (this *Kucoin) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes258212 := (<-this.LoadMarketsAsync())
	...
	if ccxt.IsTrue(uta) {
		...
		retRes261819 := (<-this.SubscribePrivateUtaAsync([]any{messageHash}, subscriptionHash, channel, nil, this.Extend(extendedParams, params)))
...
func (this *Kucoin) watchPositionBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes282912 := (<-this.LoadMarketsAsync())
	...
	retRes284715 := (<-this.SubscribeAsync(url, messageHash, topic, this.Extend(request, params)))
...
func (this *Kucoin) watchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes320512 := (<-this.LoadMarketsAsync())
	...
	retRes321015 := (<-this.SubscribePublicUtaAsync(messageHash, channel, symbol, params))
...
func (this *Kucoin) unWatchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes322412 := (<-this.LoadMarketsAsync())
	...
	retRes323715 := (<-this.SubscribePublicUtaAsync(unSubMessageHash, channel, symbol, params, subscription))
...
func (this *Kucoin) watchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes331512 := (<-this.LoadMarketsAsync())
	...
	retRes332015 := (<-this.SubscribePublicUtaAsync(messageHash, channel, symbol, params))
...
func (this *Kucoin) unWatchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes334715 := (<-this.SubscribePublicUtaAsync(unSubMessageHash, channel, symbol, params, subscription))
...
func (this *Kucoin) WatchPosition(options ...ccxt.WatchPositionOptions) (ccxt.Position, error) {
	...
	res := <-this.WatchPositionAsync(opts.Symbol, opts.Params)
	if ccxt.IsError(res) {
