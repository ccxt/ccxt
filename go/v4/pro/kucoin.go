...
func (this *KucoinCore) negotiateBody(ch chan any, privateChannel any, optionalArgs ...any) any {
	...
	_ = params
	var connectId any = ccxt.Ternary(ccxt.EvalTruthy(privateChannel), "private", "public")
...
func (this *KucoinCore) subscribePublicUtaBody(ch chan any, messageHash any, channel any, symbol any, optionalArgs ...any) any {
	...
	var urlType any = ccxt.Ternary(ccxt.EvalTruthy(ccxt.GetValue(market, "contract")), "futures", "spot")
	...
	if !ccxt.IsEqual(subscription, nil) {
		...
		action = ccxt.Ternary(ccxt.EvalTruthy(unsubscribe), "unsubscribe", action)
	}
	var request map[string]any = map[string]any{
		"id":        requestId,
		"action":    action,
...
func (this *KucoinCore) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	url := (<-this.Negotiate(false, isFuturesMethod))
	ccxt.PanicOnError(url)
	var method any = ccxt.Ternary(ccxt.EvalTruthy(isFuturesMethod), "/contractMarket/level2", "/market/level2")
	var optionName any = ccxt.Ternary(ccxt.EvalTruthy(isFuturesMethod), "contractMethod", "spotMethod")
...
func (this *KucoinCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.EvalTruthy(uta) {
		...
		ccxt.PanicOnError(url)
		var topic any = ccxt.Ternary(ccxt.EvalTruthy(trigger), "/spotMarket/advancedOrders", "/spotMarket/tradeOrders")
		if isFuturesMethod {
			topic = ccxt.Ternary(ccxt.EvalTruthy(trigger), "/contractMarket/advancedOrders", "/contractMarket/tradeOrders")
		}
		if ccxt.IsEqual(symbol, nil) {
...
func (this *KucoinCore) watchPositionBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.EvalTruthy(fetchPositionSnapshot) && ccxt.EvalTruthy(awaitPositionSnapshot) && ccxt.IsEqual(currentPosition, nil) {
...
func (this *KucoinCore) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.EvalTruthy(fetchPositionSnapshot) && ccxt.EvalTruthy(awaitPositionSnapshot) && ccxt.IsEqual(cache, nil) {
...
func (this *KucoinCore) SetPositionCache(client any, symbol any) {
	...
	if ccxt.EvalTruthy(fetchPositionSnapshot) {
