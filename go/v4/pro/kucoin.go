...
func (this *Kucoin) watchUtaTickersBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		...
		var market map[string]any = ccxt.MapTyped(this.Market(symbol))
		var subMessageHash any = ccxt.Add(messageHash+":", market["symbol"])
...
func (this *Kucoin) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if uta == true {
		...
		var topic any = ccxt.Add(ccxt.Add(ccxt.Add(channelName, market["id"]), "_"), period)
...
func (this *Kucoin) HandleOHLCV(client any, message map[string]any) {
	...
	var messageHash any = ccxt.Add("candles:"+*symbol+":", timeframe)
...
func (this *Kucoin) HandleUtaOHLCV(client any, message map[string]any) {
	...
	var timeframe any = this.FindTimeframe(interval)
	var messageHash any = ccxt.Add("uta:candles:"+*symbol+":", timeframe)
	ccxt.AddElementToObject(this.Ohlcvs, symbol, this.SafeDict(this.Ohlcvs, symbol, map[string]any{}))
	var stored any = this.SafeValue(ccxt.GetValue(this.Ohlcvs, symbol), timeframe)
	if ccxt.IsEqual(stored, nil) {
		var limit *int64 = this.SafeInteger(this.Options, "OHLCVLimit", 1000)
...
func (this *Kucoin) HandleUtaOrderBook(client any, message map[string]any) {
	...
	var messageHash any = ccxt.Add("uta:orderbook:"+*symbol+":depth:", depth)
...
func (this *Kucoin) watchPositionBody(ch chan any, optionalArgs ...any) any {
	...
	ccxt.PanicOnError(url)
	var market map[string]any = ccxt.MapTyped(this.Market(symbol))
	var topic any = ccxt.Add("/contract/position:", market["id"])
	var request map[string]any = map[string]any{
		"privateChannel": true,
	}
	var messageHash any = ccxt.Add("position:", market["symbol"])
	var client ccxt.ClientInterface = this.Client(url)
