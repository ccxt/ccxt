...
func (this *Kucoin) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if (isFuturesMethod || uta) && (symbolsNormalized == nil) {
...
func (this *Kucoin) HandleUtaTicker(client any, message map[string]any) {
	...
	//     }
	//
	var data map[string]any = this.SafeDictMap(message, "d", map[string]any{})
...
func (this *Kucoin) HandlePosition(client any, message map[string]any) {
	...
	var keys []string = nil
	if newPosition != nil {
		keys = make([]string, 0, len(newPosition))
		for objectKey := range newPosition {
