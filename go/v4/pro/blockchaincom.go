...
func (this *BlockchaincomCore) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
	var datetime *string = this.SafeString(order, "transactTime")
	var status *string = this.SafeString(order, "ordStatus")
...
func (this *BlockchaincomCore) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(isAuthenticated, nil) {
