...
func (this *Okx) GetUrl(channel any, optionalArgs ...any) any {
	...
	var access string = ccxt.GetArgString(optionalArgs, 0, "public")
	_ = access
...
func (this *Okx) subscribeMultipleBody(ch chan any, access any, channel any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		...
		args = append(args, this.Extend(arg, params))
		if symbols == nil {
			panic(ccxt.ArgumentsRequired(this.Id + " subscribeMultiple() symbols is required"))
		}
		messageHashes = append(messageHashes, ccxt.Add(ccxt.Add(channel, "::"), ccxt.GetValue(symbols, i)))
	}
...
func (this *Okx) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	symbols = this.MarketSymbols(symbols)
	var channel any = nil
	var channelparamsVariable []any = this.HandleOptionStringAndParams(params, "watchTrades", "channel", "trades")
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		...
		messageHashes = append(messageHashes, ccxt.Add(ccxt.Add(channel, ":"), symbol))
...
func (this *Okx) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		var symbol *string = ccxt.SafeStringPtr(ccxt.GetValue(symbols, i))
		messageHashes = append(messageHashes, ccxt.Add(ccxt.Add(ccxt.Add("unsubscribe:", channel), ":"), symbol))
		var marketId any = this.MarketId(symbol)
		var topic map[string]any = map[string]any{
			"channel": channel,
			"instId":  marketId,
...
func (this *Okx) watchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var fr map[string]any = ccxt.MapTyped(ccxt.PanicOnError((<-this.WatchFundingRatesAsync([]any{symbol}, params))))
...
func (this *Okx) watchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		var symbol *string = ccxt.SafeStringPtr(ccxt.GetValue(symbols, i))
		messageHashes = append(messageHashes, channel+":"+*symbol)
		var marketId any = this.MarketId(symbol)
		var topic map[string]any = map[string]any{
			"channel": channel,
			"instId":  marketId,
...
func (this *Okx) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var channelparamsVariable []any = this.HandleOptionStringAndParams(params, "watchTicker", "channel", "tickers")
...
func (this *Okx) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	symbols = this.MarketSymbols(symbols, nil, false)
	var channel any = nil
	var channelparamsVariable []any = this.HandleOptionStringAndParams(params, "watchTickers", "channel", "tickers")
	channel = ccxt.GetValue(channelparamsVariable, 0)
	params = ccxt.MapTyped(ccxt.GetValue(channelparamsVariable, 1))
...
func (this *Okx) watchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	_ = params
	var channel *string = nil
	var channelparamsVariable []any = this.HandleOptionStringAndParams(params, "watchMarkPrice", "channel", "mark-price")
	channel = ccxt.SafeStringPtr(ccxt.GetValue(channelparamsVariable, 0))
	params = ccxt.MapTyped(ccxt.GetValue(channelparamsVariable, 1))
	ccxt.AddElementToObject(params, "channel", channel)
	var market map[string]any = ccxt.MapTyped(this.Market(symbol))
	...
	var ticker map[string]any = ccxt.MapTyped(ccxt.PanicOnError((<-this.WatchMarkPricesAsync([]any{symbol}, params))))
...
func (this *Okx) watchMarkPricesBody(ch chan any, optionalArgs ...any) any {
	...
	symbols = this.MarketSymbols(symbols, nil, false)
	var channel any = nil
	var channelparamsVariable []any = this.HandleOptionStringAndParams(params, "watchMarkPrices", "channel", "mark-price")
	channel = ccxt.GetValue(channelparamsVariable, 0)
	params = ccxt.MapTyped(ccxt.GetValue(channelparamsVariable, 1))
...
func (this *Okx) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	symbols = this.MarketSymbols(symbols, nil, false)
	var channel any = nil
	var channelparamsVariable []any = this.HandleOptionStringAndParams(params, "watchBidsAsks", "channel", "bbo-tbt")
	channel = ccxt.GetValue(channelparamsVariable, 0)
	params = ccxt.MapTyped(ccxt.GetValue(channelparamsVariable, 1))
	var url any = this.GetUrl(channel, "public")
	var messageHashes []any = []any{}
...
func (this *Okx) ParseWsBidAsk(ticker map[string]any, optionalArgs ...any) any {
	...
	var ask *string = this.SafeString(ticker, "askPx")
	var askVolume *string = this.SafeString(ticker, "askSz")
	var bid *string = this.SafeString(ticker, "bidPx")
	var bidVolume *string = this.SafeString(ticker, "bidSz")
	if ask == nil {
		var asks []any = ccxt.SafeListTyped(ticker, "asks")
		var firstAsk []any = ccxt.SafeListTyped(asks, 0)
		ask = this.SafeString(firstAsk, 0)
		askVolume = this.SafeString(firstAsk, 1)
	}
	if bid == nil {
		var bids []any = ccxt.SafeListTyped(ticker, "bids")
		var firstBid []any = ccxt.SafeListTyped(bids, 0)
...
func (this *Okx) watchLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if typeVar == nil {
		panic(ccxt.ArgumentsRequired(this.Id + " watchLiquidationsForSymbols() type is required"))
	}
...
func (this *Okx) ParseWsMyLiquidation(liquidation any, optionalArgs ...any) any {
	...
	var market map[string]any = ccxt.GetArgMap(optionalArgs, 0, nil)
	_ = market
	var posData []any = ccxt.SafeListTyped(liquidation, "posData")
...
func (this *Okx) ParseWsLiquidation(liquidation any, optionalArgs ...any) any {
	...
	var market map[string]any = ccxt.GetArgMap(optionalArgs, 0, nil)
	_ = market
	var details []any = ccxt.SafeListTyped(liquidation, "details")
...
func (this *Okx) watchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		var sym *string = ccxt.SafeStringPtr(func() any {
			if 0 >= 0 && 0 < len(symbolAndTimeframe) {
				return ccxt.DerefScalar(symbolAndTimeframe[0])
			}
			return nil
		}())
		var tf *string = ccxt.SafeStringPtr(func() any {
...
func (this *Okx) HandleOHLCV(client any, message any) {
	...
	var market map[string]any = ccxt.MapTyped(this.SafeMarket(marketId))
	var symbol *string = ccxt.SafeStringPtr(market["symbol"])
	var interval string = strings.Replace(*channel, "candle", "", 1)
	...
	for i := 0; i < len(data); i++ {
		...
		var messageHashForMulti string = "multi:" + *channel + ":" + *symbol
...
func (this *Okx) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		var symbol *string = ccxt.SafeStringPtr(ccxt.GetValue(symbols, i))
		messageHashes = append(messageHashes, ccxt.Add(ccxt.Add(depth, ":"), symbol))
		var marketId any = this.MarketId(symbol)
		var topic map[string]any = map[string]any{
			"channel": depth,
			"instId":  marketId,
...
func (this *Okx) unWatchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		var symbol *string = ccxt.SafeStringPtr(ccxt.GetValue(symbols, i))
		subMessageHashes = append(subMessageHashes, ccxt.Add(ccxt.Add(depth, ":"), symbol))
...
func (this *Okx) HandleOrderBook(client any, message map[string]any) any {
	...
	if channel != nil && *channel == "bbo-tbt" {
		this.HandleBidAsk(client, message)
	}
	return message
}
...
func (this *Okx) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	params = ccxt.MapTyped(this.Omit(params, []any{"access"}))
	...
	if ccxt.IsEqual(authenticated, nil) {
		...
		if ccxt.InOp(params, "access") {
			request["access"] = ccxt.GetValue(params, "access")
		}
...
func (this *Okx) OrderToTrade(order any, optionalArgs ...any) any {
	var market map[string]any = ccxt.GetArgMap(optionalArgs, 0, nil)
	_ = market
	var info map[string]any = ccxt.MapTyped(this.SafeDict(order, "info", map[string]any{}))
...
func (this *Okx) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	var typeVar any = nil
	var typeVarparamsVariable []any = this.HandleOptionStringAndParams(params, "watchMyTrades", "type", "ANY")
	typeVar = ccxt.GetValue(typeVarparamsVariable, 0)
	params = ccxt.MapTyped(ccxt.GetValue(typeVarparamsVariable, 1))
	var isTrigger *bool = this.SafeBool2(params, "trigger", "stop", false)
	params = ccxt.MapTyped(this.Omit(params, []any{"trigger", "stop"}))
	if this.Markets == nil {
	...
	var marginModeparamsVariable []any = this.HandleMarginModeAndParams("watchMyTrades", params)
...
func (this *Okx) HandlePositions(client any, message map[string]any) {
	...
	for i := 0; i < len(data); i++ {
		...
		if ccxt.IsEqual(position["contracts"], 0) && ccxt.IsEqual(ccxt.GetValue(rawPosition, "posSide"), "net") {
			...
			newPositions = append(newPositions, shortPosition)
		}
...
func (this *Okx) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var typeVar any = nil
	// By default, receive order updates from any instrument type
	var typeVarparamsVariable []any = this.HandleOptionStringAndParams(params, "watchOrders", "type", "ANY")
	typeVar = ccxt.GetValue(typeVarparamsVariable, 0)
	params = ccxt.MapTyped(ccxt.GetValue(typeVarparamsVariable, 1))
	var isTrigger *bool = this.SafeBool2(params, "stop", "trigger", false)
...
func (this *Okx) HandleMyTrades(client any, message map[string]any) {
	...
	var tradesLength int = len(filteredOrders)
	if tradesLength == 0 {
		return
	}
...
func (this *Okx) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if (ordType != nil && *ordType == "trigger") || (ordType != nil && *ordType == "conditional") || (ccxt.IsEqual(typeVar, "oco")) || (ccxt.IsEqual(typeVar, "move_order_stop")) || (ccxt.IsEqual(typeVar, "iceberg")) || (ccxt.IsEqual(typeVar, "twap")) {
		panic(ccxt.BadRequest(this.Id + " createOrderWs() does not support algo trading. this.options[\"createOrderWs\"][\"op\"] must be either order or batch-order"))
	}
	if (op == nil || *op != "order") && (op == nil || *op != "batch-orders") {
		panic(ccxt.BadRequest(this.Id + " createOrderWs() does not support algo trading. this.options[\"createOrderWs\"][\"op\"] must be either order or privatePostTradeOrder or privatePostTradeOrderAlgo"))
	}
	var request map[string]any = map[string]any{
		"id":   messageHash,
		"op":   op,
...
func (this *Okx) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	var messageHash string = this.RequestId()
	var op *string = nil
	var opparamsVariable []any = this.HandleOptionStringAndParams(params, "editOrderWs", "op", "amend-order")
	op = ccxt.SafeStringPtr(ccxt.GetValue(opparamsVariable, 0))
	params = ccxt.MapTyped(ccxt.GetValue(opparamsVariable, 1))
...
func (this *Okx) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	_ = params
	if symbol == nil {
		panic(ccxt.BadRequest(this.Id + " cancelOrderWs() requires a symbol argument"))
	}
	if this.Markets == nil {
...
func (this *Okx) cancelOrdersWsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if idsLength > 20 {
		panic(ccxt.BadRequest(this.Id + " cancelOrdersWs() accepts up to 20 ids at a time"))
	}
	if symbol == nil {
		panic(ccxt.BadRequest(this.Id + " cancelOrdersWs() requires a symbol argument"))
	}
	if this.Markets == nil {
...
func (this *Okx) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	if symbol == nil {
		panic(ccxt.BadRequest(this.Id + " cancelAllOrdersWs() requires a symbol argument"))
	}
	if this.Markets == nil {
		...
		func(this *Okx) (ret_ any) {
					...
					ret_ = func(this *Okx) any {
						...
						if id == nil {
							...
							if (msg != nil) && strings.HasPrefix(*msg, "Illegal request: {") {
								var stringifiedJson string = strings.Replace(*msg, "Illegal request: ", "", 1)
			...
			if ((errorCode != nil) && (errorCode == nil || *errorCode != "")) && (errorCode == nil || *errorCode != "0") {
				...
				if messageString != nil {
					...
					var data []any = ccxt.SafeListTyped(message, "data")
					for i := 0; i < len(data); i++ {
						var d map[string]any = ccxt.SafeMapTyped(data, i)
	...
	if event != nil {
		...
		if ccxt.IsEqual(method, nil) {
			if func() int {
				...
				return strings.Index(*channel, "candle")
			}() == 0 {
...
func (this *Okx) HandleUnsubscription(client any, message map[string]any) {
	...
	} else if strings.HasPrefix(*channel, "bbo") || strings.HasPrefix(*channel, "book") {
