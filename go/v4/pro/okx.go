...
func (this *Okx) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes18115 := (<-this.WatchTradesForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Okx) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(channel, "trades-all")) {
		...
		retRes22712 := (<-this.AuthenticateAsync(map[string]any{
			"access": access,
		}))
...
func (this *Okx) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(channel, "trades-all")) {
		...
		retRes27412 := (<-this.AuthenticateAsync(map[string]any{
			"access": access,
		}))
...
func (this *Okx) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes28915 := (<-this.UnWatchTradesForSymbolsAsync([]any{symbol}, params))
...
func (this *Okx) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes46915 := (<-this.UnWatchTickersAsync([]any{symbol}, params))
...
func (this *Okx) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes63112 := (<-this.LoadMarketsAsync())
...
func (this *Okx) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes8338 := (<-this.AuthenticateAsync(map[string]any{
		"access": accessType,
	}))
...
func (this *Okx) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes101812 := (<-this.LoadMarketsAsync())
...
func (this *Okx) unWatchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes104115 := (<-this.UnWatchOHLCVForSymbolsAsync([]any{[]any{symbol, timeframe}}, params))
...
func (this *Okx) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes110712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes120015 := (<-this.WatchOrderBookForSymbolsAsync([]any{symbol}, limit, params))
...
func (this *Okx) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(depth, "books-l2-tbt"))) || ccxt.IsTrue((ccxt.IsEqual(depth, "books50-l2-tbt")))) {
		...
		retRes123612 := (<-this.AuthenticateAsync(map[string]any{
			"access": "public",
		}))
...
func (this *Okx) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes132315 := (<-this.UnWatchOrderBookForSymbolsAsync([]any{symbol}, params))
...
func (this *Okx) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes15808 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes15808)

	retRes158115 := (<-this.SubscribeAsync("private", "account", "account", nil, params))
...
func (this *Okx) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes17358 := (<-this.AuthenticateAsync(map[string]any{
		"access": access,
	}))
...
func (this *Okx) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes17848 := (<-this.AuthenticateAsync(params))
...
func (this *Okx) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes193112 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes193112)
	}
	var accessType any = ccxt.Ternary(ccxt.IsTrue((ccxt.IsEqual(isTrigger, true))), "business", "private")

	retRes19348 := (<-this.AuthenticateAsync(map[string]any{
		"access": accessType,
	}))
...
func (this *Okx) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes216912 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes216912)
	}

	retRes21718 := (<-this.AuthenticateAsync())
...
func (this *Okx) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes22518 := (<-this.AuthenticateAsync())
...
func (this *Okx) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes228712 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes228712)
	}

	retRes22898 := (<-this.AuthenticateAsync())
...
func (this *Okx) cancelOrdersWsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes233112 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes233112)
	}

	retRes23338 := (<-this.AuthenticateAsync())
...
func (this *Okx) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes23728 := (<-this.AuthenticateAsync())
...
func (this *Okx) WatchMyLiquidationsForSymbols(symbols []string, options ...ccxt.WatchMyLiquidationsForSymbolsOptions) ([]ccxt.Liquidation, error) {
	...
	var params = opts.Params
	res := <-this.WatchMyLiquidationsForSymbolsAsync(symbols, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewLiquidationArray(res), nil
