...
func (this *OkxCore) GetUrl(channel any, optionalArgs ...any) any {
	...
	var sandboxSuffix any = ccxt.Ternary(ccxt.EvalTruthy(isSandbox), "?brokerId=9999", "")
...
func (this *OkxCore) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes8578 := (<-this.Authenticate(map[string]any{
		"access": ccxt.Ternary(ccxt.EvalTruthy(isTrigger), "business", "private"),
	}))
...
func (this *OkxCore) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes17828 := (<-this.Authenticate(map[string]any{
		"access": ccxt.Ternary(ccxt.EvalTruthy(isTrigger), "business", "private"),
	}))
	ccxt.PanicOnError(retRes17828)
	var channel any = ccxt.Ternary(ccxt.EvalTruthy(isTrigger), "orders-algo", "orders")
...
func (this *OkxCore) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes182912)
	}
...
func (this *OkxCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes197812 := (<-this.LoadMarkets())
		ccxt.PanicOnError(retRes197812)
	}

	retRes19808 := (<-this.Authenticate(map[string]any{
		"access": ccxt.Ternary(ccxt.EvalTruthy(isTrigger), "business", "private"),
	}))
	ccxt.PanicOnError(retRes19808)
	var market any = nil
	if !ccxt.IsEqual(symbol, nil) {
		market = this.Market(symbol)
		symbol = ccxt.GetValue(market, "symbol")
...
func (this *OkxCore) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes221512)
	}
	...
	retRes224115 := (<-this.Watch(url, messageHash, request, messageHash))
	ccxt.PanicOnError(retRes224115)
	ch <- retRes224115
	return nil
}
...
func (this *OkxCore) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes229512)
	}

	retRes22978 := (<-this.Authenticate())
	...
	retRes231415 := (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash))
	ccxt.PanicOnError(retRes231415)
	ch <- retRes231415
	return nil
}
...
func (this *OkxCore) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes233312)
	}

	retRes23358 := (<-this.Authenticate())
	...
	retRes235515 := (<-this.Watch(url, messageHash, request, messageHash))
...
func (this *OkxCore) cancelOrdersWsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes237712)
	}

	retRes23798 := (<-this.Authenticate())
	...
	retRes239915 := (<-this.Watch(url, messageHash, this.DeepExtend(request, params), messageHash))
	ccxt.PanicOnError(retRes239915)
	ch <- retRes239915
	return nil
}
...
func (this *OkxCore) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes241612)
	}

	retRes24188 := (<-this.Authenticate())
	ccxt.PanicOnError(retRes24188)
	var market any = this.Market(symbol)
	if !ccxt.IsEqual(ccxt.GetValue(market, "type"), "option") {
	...
	retRes243315 := (<-this.Watch(url, messageHash, request, messageHash))
	ccxt.PanicOnError(retRes243315)
	ch <- retRes243315
	return nil
}
