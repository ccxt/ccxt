...
func (this *OkxCore) GetUrl(channel any, optionalArgs ...any) any {
	...
	if isBusiness || (ccxt.IsGreaterThan(ccxt.GetIndexOf(channel, "candle"), ccxt.OpNeg(1))) || (ccxt.IsEqual(channel, "orders-algo")) {
...
func (this *OkxCore) subscribeMultipleBody(ch chan any, access any, channel any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes13612 := (<-this.LoadMarkets())
		ccxt.PanicOnError(retRes13612)
	}
	...
	retRes16715 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *OkxCore) subscribeBody(ch chan any, access any, messageHash any, channel any, symbol any, optionalArgs ...any) any {
	...
	retRes18915 := (<-this.Watch(url, messageHash, request, messageHash))
...
func (this *OkxCore) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes20515 := (<-this.WatchTradesForSymbols([]any{symbol}, since, limit, params))
...
func (this *OkxCore) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes22712 := (<-this.LoadMarkets())
		ccxt.PanicOnError(retRes22712)
	}
	symbols = this.MarketSymbols(symbols)
	var channel any = nil
	...
	if ccxt.IsEqual(channel, "trades-all") {
		access = "business"

		retRes25112 := (<-this.Authenticate(map[string]any{
			"access": access,
		}))
...
func (this *OkxCore) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(channel, "trades-all") {
		...
		retRes29812 := (<-this.Authenticate(map[string]any{
			"access": access,
		}))
	...
	retRes30115 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *OkxCore) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes31315 := (<-this.UnWatchTradesForSymbols([]any{symbol}, params))
...
func (this *OkxCore) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes49315 := (<-this.UnWatchTickers([]any{symbol}, params))
...
func (this *OkxCore) unWatchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes59815 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *OkxCore) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes8578 := (<-this.Authenticate(map[string]any{
		"access": accessType,
	}))
...
func (this *OkxCore) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes104212)
	}
	symbol = this.Symbol(symbol)
...
func (this *OkxCore) unWatchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes106515 := (<-this.UnWatchOHLCVForSymbols([]any{[]any{symbol, timeframe}}, params))
	ccxt.PanicOnError(retRes106515)
	ch <- retRes106515
	return nil
}
...
func (this *OkxCore) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	retRes115415 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *OkxCore) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes124815 := (<-this.WatchOrderBookForSymbols([]any{symbol}, limit, params))
...
func (this *OkxCore) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes126412)
	}
	symbols = this.MarketSymbols(symbols)
	var depth any = nil
	...
	if !ccxt.IsEqual(limit, nil) {
		if ccxt.IsEqual(limit, 1) {
			...
			depth = "books5"
		} else if ccxt.IsEqual(limit, 50) {
			depth = "books50-l2-tbt" // Make sure you have VIP4 and above
		} else if ccxt.IsEqual(limit, 400) {
			depth = "books"
		}
	}
	if (ccxt.IsEqual(depth, "books-l2-tbt")) || (ccxt.IsEqual(depth, "books50-l2-tbt")) {
		...
		retRes128412 := (<-this.Authenticate(map[string]any{
			"access": "public",
		}))
...
func (this *OkxCore) unWatchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes132012 := (<-this.LoadMarkets())
		ccxt.PanicOnError(retRes132012)
	}
	symbols = this.MarketSymbols(symbols, nil, false)
	var depth any = nil
	depthparamsVariable := this.HandleOptionAndParams(params, "watchOrderBook", "depth", "books")
	...
	retRes135615 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
	ccxt.PanicOnError(retRes135615)
	ch <- retRes135615
	return nil
}
...
func (this *OkxCore) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes137115 := (<-this.UnWatchOrderBookForSymbols([]any{symbol}, params))
...
func (this *OkxCore) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	retRes161315 := <-future.(*ccxt.Future).Await()
	ccxt.PanicOnError(retRes161315)
	ch <- retRes161315
	return nil
}
...
func (this *OkxCore) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes162612)
	}

	retRes16288 := (<-this.Authenticate())
	ccxt.PanicOnError(retRes16288)

	retRes162915 := (<-this.Subscribe("private", "account", "account", nil, params))
...
func (this *OkxCore) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	typeVar = ccxt.GetValue(typeVarparamsVariable, 0)
	params = ccxt.GetValue(typeVarparamsVariable, 1)
	var isTrigger any = ccxt.DerefScalar(this.SafeBool2(params, "trigger", "stop", false))
	params = this.Omit(params, []any{"trigger", "stop"})
	if ccxt.IsEqual(this.Markets, nil) {

		retRes178012 := (<-this.LoadMarkets())
		ccxt.PanicOnError(retRes178012)
	}
	var access any = ccxt.Ternary((isTrigger == true), "business", "private")

	retRes17838 := (<-this.Authenticate(map[string]any{
		"access": access,
	}))
...
func (this *OkxCore) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes183012)
	}

	retRes18328 := (<-this.Authenticate(params))
...
func (this *OkxCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes197912)
	}
	var accessType any = ccxt.Ternary((ccxt.IsEqual(isTrigger, true)), "business", "private")

	retRes19828 := (<-this.Authenticate(map[string]any{
		"access": accessType,
	}))
...
func (this *OkxCore) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes221712 := (<-this.LoadMarkets())
		ccxt.PanicOnError(retRes221712)
	}

	retRes22198 := (<-this.Authenticate())
	...
	if (!ccxt.IsEqual(op, "order")) && (!ccxt.IsEqual(op, "batch-orders")) {
	...
	retRes224315 := (<-this.Watch(url, messageHash, request, messageHash))
	ccxt.PanicOnError(retRes224315)
	ch <- retRes224315
	return nil
}
...
func (this *OkxCore) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes231615 := (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash))
	ccxt.PanicOnError(retRes231615)
	ch <- retRes231615
	return nil
}
...
func (this *OkxCore) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes233512)
	}

	retRes23378 := (<-this.Authenticate())
	ccxt.PanicOnError(retRes23378)
	var url any = this.GetUrl("private", "private")
	var messageHash any = this.RequestId()
...
func (this *OkxCore) cancelOrdersWsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	retRes23818 := (<-this.Authenticate())
	ccxt.PanicOnError(retRes23818)
	var url any = this.GetUrl("private", "private")
	var messageHash any = this.RequestId()
	var args any = []any{}
	var market any = this.Market(symbol)
	...
	retRes240115 := (<-this.Watch(url, messageHash, this.DeepExtend(request, params), messageHash))
...
func (this *OkxCore) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes241812)
	}

	retRes24208 := (<-this.Authenticate())
	...
	retRes243515 := (<-this.Watch(url, messageHash, request, messageHash))
