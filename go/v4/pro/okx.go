...
func (this *Okx) GetUrl(channel any, optionalArgs ...any) any {
...
func (this *Okx) SubscribeMultipleAsync(access any, channel any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.subscribeMultipleBody(ch, access, channel, optionalArgs...)
	return ch
}
func (this *Okx) subscribeMultipleBody(ch chan any, access any, channel any, optionalArgs ...any) any {
	defer close(ch)
	...
	retRes14615 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *Okx) subscribeBody(ch chan any, access any, messageHash any, channel any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Okx) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes18415 := (<-this.WatchTradesForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Okx) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(channel, "trades-all")) {
		...
		retRes23012 := (<-this.AuthenticateAsync(map[string]any{
			"access": access,
		}))
...
func (this *Okx) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(channel, "trades-all")) {
		...
		retRes27712 := (<-this.AuthenticateAsync(map[string]any{
			"access": access,
		}))
	...
	retRes28015 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *Okx) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes29215 := (<-this.UnWatchTradesForSymbolsAsync([]any{symbol}, params))
...
func (this *Okx) watchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	fr := (<-this.WatchFundingRatesAsync([]any{symbol}, params))
...
func (this *Okx) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes47215 := (<-this.UnWatchTickersAsync([]any{symbol}, params))
...
func (this *Okx) unWatchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes57715 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *Okx) ParseWsBidAsk(ticker any, optionalArgs ...any) any {
	...
	var ask any = this.SafeString(ticker, "askPx")
	var askVolume any = this.SafeString(ticker, "askSz")
	var bid any = this.SafeString(ticker, "bidPx")
	var bidVolume any = this.SafeString(ticker, "bidSz")
	if ccxt.IsTrue(ccxt.IsEqual(ask, nil)) {
		var asks any = this.SafeList(ticker, "asks", []any{})
		var firstAsk any = this.SafeList(asks, 0, []any{})
	...
	if ccxt.IsTrue(ccxt.IsEqual(bid, nil)) {
		...
		var firstBid any = this.SafeList(bids, 0, []any{})
...
func (this *Okx) watchLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes76712 := (<-this.LoadMarketsAsync())
...
func (this *Okx) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes8728 := (<-this.AuthenticateAsync(map[string]any{
		"access": accessType,
	}))
...
func (this *Okx) ParseWsMyLiquidation(liquidation any, optionalArgs ...any) any {
	//
	//    {
	//        "pTime": "1597026383085",
	//        "eventType": "snapshot",
...
func (this *Okx) ParseWsLiquidation(liquidation any, optionalArgs ...any) any {
	//
	// public liquidation
	//    {
	//        "details": [
...
func (this *Okx) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes105712 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes105712)
	}
	symbol = this.Symbol(symbol)
...
func (this *Okx) unWatchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes108015 := (<-this.UnWatchOHLCVForSymbolsAsync([]any{[]any{symbol, timeframe}}, params))
	ccxt.PanicOnError(retRes108015)
	ch <- retRes108015
	return nil
}
...
func (this *Okx) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		ccxt.PanicOnError(retRes114612)
	}
	var topics any = []any{}
	var messageHashes any = []any{}
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbolsAndTimeframes)); i++ {
	...
	retRes116915 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *Okx) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes123915 := (<-this.WatchOrderBookForSymbolsAsync([]any{symbol}, limit, params))
	ccxt.PanicOnError(retRes123915)
	ch <- retRes123915
	return nil
}
...
func (this *Okx) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes125512 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes125512)
	}
	symbols = this.MarketSymbols(symbols)
	var depth any = nil
	...
	if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(depth, "books-l2-tbt"))) || ccxt.IsTrue((ccxt.IsEqual(depth, "books50-l2-tbt")))) {
		...
		retRes127512 := (<-this.AuthenticateAsync(map[string]any{
			"access": "public",
		}))
		ccxt.PanicOnError(retRes127512)
	}
	var topics any = []any{}
	var messageHashes any = []any{}
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(symbols)); i++ {
...
func (this *Okx) unWatchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes131112 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes131112)
	}
	symbols = this.MarketSymbols(symbols, nil, false)
	var depth any = nil
	depthparamsVariable := this.HandleOptionAndParams(params, "watchOrderBook", "depth", "books")
	...
	retRes134715 := (<-this.WatchMultiple(url, messageHashes, request, messageHashes))
...
func (this *Okx) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes136215 := (<-this.UnWatchOrderBookForSymbolsAsync([]any{symbol}, params))
...
func (this *Okx) HandleDeltas(bookside any, deltas any) {
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(deltas)); i++ {
		this.HandleDelta(bookside, ccxt.GetValue(deltas, i))
	}
}
func (this *Okx) HandleOrderBookMessage(client any, message any, orderbook any, messageHash any, optionalArgs ...any) any {
	//
	//     {
	//         "asks": [
...
func (this *Okx) HandleOrderBook(client any, message any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(action, "snapshot")) {
		...
		// channel+symbol (e.g. 'bbo-tbt:BTC/USDT' in client.(*ccxt.WSClient).Subscriptions)
	...
	if ccxt.IsTrue(ccxt.IsEqual(channel, "bbo-tbt")) {
		this.HandleBidAsk(client, message)
	}
	return message
}
...
func (this *Okx) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	retRes161215 := <-future.(*ccxt.Future).Await()
...
func (this *Okx) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		ccxt.PanicOnError(retRes162512)
	}

	retRes16278 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes16278)

	retRes162815 := (<-this.SubscribeAsync("private", "account", "account", nil, params))
	ccxt.PanicOnError(retRes162815)
	ch <- retRes162815
	return nil
}
...
func (this *Okx) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes17828 := (<-this.AuthenticateAsync(map[string]any{
		"access": access,
	}))
...
func (this *Okx) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes18318 := (<-this.AuthenticateAsync(params))
...
func (this *Okx) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes19818 := (<-this.AuthenticateAsync(map[string]any{
		"access": accessType,
	}))
 ...
 */
func (this *Okx) CreateOrderWsAsync(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Okx) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		ccxt.PanicOnError(retRes221612)
	}

	retRes22188 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes22188)
	...
	retRes224215 := (<-this.Watch(url, messageHash, request, messageHash))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Okx) EditOrderWsAsync(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.editOrderWsBody(ch, id, symbol, typeVar, side, optionalArgs...)
	return ch
}
func (this *Okx) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes229612 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes229612)
	}

	retRes22988 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes22988)
	var url any = this.GetUrl("private", "private")
	var messageHash any = this.RequestId()
	var op any = nil
	...
	retRes231515 := (<-this.Watch(url, messageHash, this.Extend(request, params), messageHash))
	ccxt.PanicOnError(retRes231515)
	ch <- retRes231515
	return nil
}
 ...
 */
func (this *Okx) CancelOrderWsAsync(id any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.cancelOrderWsBody(ch, id, optionalArgs...)
	return ch
}
func (this *Okx) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	symbol := ccxt.GetArg(optionalArgs, 0, nil)
	_ = symbol
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		ccxt.PanicOnError(retRes233412)
	}

	retRes23368 := (<-this.AuthenticateAsync())
	...
	retRes235615 := (<-this.Watch(url, messageHash, request, messageHash))
	ccxt.PanicOnError(retRes235615)
	ch <- retRes235615
	return nil
}
...
func (this *Okx) cancelOrdersWsBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes237812 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes237812)
	}

	retRes23808 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes23808)
	var url any = this.GetUrl("private", "private")
	var messageHash any = this.RequestId()
	var args any = []any{}
	var market any = this.Market(symbol)
	...
	retRes240015 := (<-this.Watch(url, messageHash, this.DeepExtend(request, params), messageHash))
	ccxt.PanicOnError(retRes240015)
	ch <- retRes240015
	return nil
}
...
func (this *Okx) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		ccxt.PanicOnError(retRes241712)
	}

	retRes24198 := (<-this.AuthenticateAsync())
	...
	retRes243415 := (<-this.Watch(url, messageHash, request, messageHash))
	ccxt.PanicOnError(retRes243415)
	ch <- retRes243415
	return nil
}
...
func (this *Okx) Ping(client any) any {
...
func (this *Okx) HandlePong(client any, message any) any {
	client.(ccxt.ClientInterface).SetLastPong(this.Milliseconds())
	return message
}
func (this *Okx) HandleErrorMessage(client any, message any) any {
	//
	...
	{
		func(this *Okx) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					if e == "break" {
						return
					}
					ret_ = func(this *Okx) any {
						// catch block:
...
func (this *Okx) HandleMessage(client any, message any) {
