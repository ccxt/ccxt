...
type RubinCore struct {
	*ccxt.RubinCore
	base *ccxt.RubinCore
}

func NewRubinCore() *RubinCore {
    p := &RubinCore{}
	base := &ccxt.RubinCore{}
	p.base = base
	p.RubinCore = base
...
func  (this *RubinCore) Describe() any  {
 ...
 */
func  (this *RubinCore) WatchTrades(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
 ...
 */
func  (this *RubinCore) UnWatchTrades(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *RubinCore) HandleTrades(client any, message any)  {
    //
    // {
    //     "type": "subscribed",
...
func  (this *RubinCore) ParseWsTrade(trade any, optionalArgs ...any) any  {
    //
    // {
 ...
 */
func  (this *RubinCore) WatchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} A dictionary of [order book structures]{@link https://docs.ccxt.com/?id=order-book-structure} indexed by market symbols
 */
func  (this *RubinCore) UnWatchOrderBook(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *RubinCore) HandleOrderBook(client any, message any)  {
    //
    // {
    //     "type": "subscribed",
...
func  (this *RubinCore) HandleDelta(bookside any, delta any)  {
 ...
 */
func  (this *RubinCore) WatchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {int[][]} A list of candles ordered as timestamp, open, high, low, close, volume
 */
func  (this *RubinCore) UnWatchOHLCV(symbol any, optionalArgs ...any) <- chan any {
            ch := make(chan any)
            go func() any {
                defer close(ch)
                defer ccxt.ReturnPanicError(ch)
...
func  (this *RubinCore) HandleOHLCV(client any, message any)  {
    //
    // {
    //     "type": "subscribed",
...
func  (this *RubinCore) HandleErrorMessage(client any, message any) any  {
    
        {
             func(this *RubinCore) (ret_ any) {
    		    defer func() {
                    if e := recover(); e != nil {
                        if e == "break" {
                            return
                        }
                        ret_ = func(this *RubinCore) any {
                            // catch block:
...
func  (this *RubinCore) HandleMessage(client any, message any)  {
...
func (this *RubinCore) Init(userConfig map[string]any) {
