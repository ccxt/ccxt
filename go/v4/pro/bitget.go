...
func (this *BitgetCore) UnWatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes17012 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes17012)
		}

		retRes17215 := (<-this.UnWatchChannel(symbol, "ticker", "ticker", "watchTicker", params))
...
func (this *BitgetCore) UnWatchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes59515 := (<-this.UnWatchChannel(symbol, channel, messageHash, "watchOHLCV", params))
...
func (this *BitgetCore) WatchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes75015 := (<-this.WatchOrderBookForSymbols([]any{symbol}, limit, params))
...
func (this *BitgetCore) UnWatchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes77615 := (<-this.UnWatchChannel(symbol, channel, "orderbook", "watchOrderBook", params))
...
func (this *BitgetCore) UnWatchChannel(symbol any, channel any, messageHashTopic any, methodName any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes80215 := (<-this.UnWatchPublic(uta, messageHash, args, params))
...
func (this *BitgetCore) HandleCheckSumError(client any, symbol any, messageHash any) <-chan any {
	...
	go func() any {
		...
		retRes9848 := (<-this.UnWatchOrderBook(symbol))
...
func (this *BitgetCore) WatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes101815 := (<-this.WatchTradesForSymbols([]any{symbol}, since, limit, params))
...
func (this *BitgetCore) WatchTradesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes104112)
		}
		symbols = this.MarketSymbols(symbols)
		var uta any = nil
...
func (this *BitgetCore) UnWatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes109715 := (<-this.UnWatchChannel(symbol, channelTopic, "trade", "watchTrades", params))
...
func (this *BitgetCore) WatchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes157912 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes157912)
		}
		var market any = nil
...
func (this *BitgetCore) WatchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes208812)
		}
		var market any = nil
...
func (this *BitgetCore) WatchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes231215 := (<-this.WatchPrivate(uta, messageHash, messageHash, args, params))
...
func (this *BitgetCore) WatchPublic(uta any, messageHash any, args any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes246515 := (<-this.Watch(url, messageHash, message, messageHash))
		ccxt.PanicOnError(retRes246515)
		ch <- retRes246515
		return nil
...
func (this *BitgetCore) UnWatchPublic(uta any, messageHash any, args any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes248615 := (<-this.Watch(url, messageHash, message, messageHash))
		ccxt.PanicOnError(retRes248615)
		ch <- retRes248615
		return nil
...
func (this *BitgetCore) WatchPublicMultiple(uta any, messageHashes any, argsArray any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes250415 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes))
		ccxt.PanicOnError(retRes250415)
		ch <- retRes250415
		return nil
...
func (this *BitgetCore) Authenticate(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes253315 := <-future.(*ccxt.Future).Await()
...
func (this *BitgetCore) WatchPrivate(uta any, messageHash any, subscriptionHash any, args any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes25498 := (<-this.Authenticate(map[string]any{
			"url": url,
		}))
		ccxt.PanicOnError(retRes25498)
		var request any = map[string]any{
			"op":   "subscribe",
			"args": []any{args},
		}
		...
		retRes255515 := (<-this.Watch(url, messageHash, message, subscriptionHash))
		ccxt.PanicOnError(retRes255515)
		ch <- retRes255515
		return nil
