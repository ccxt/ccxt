...
func (this *BitgetCore) HandleOrderBook(client any, message any) {
	...
	if incrementalBook {
		...
		if !isSnapshot && (ccxt.IsEqual(checksum, true)) && (responseChecksum != nil) {
...
func (this *BitgetCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var messageHash any = ccxt.Ternary((ccxt.IsEqual(isTrigger, true)), "triggerOrder", "order")
...
func (this *BitgetCore) watchPublicBody(ch chan any, uta any, messageHash any, args any, optionalArgs ...any) any {
	...
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	var url any = ccxt.Ternary((ccxt.IsEqual(uta, true)), ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "utaPublic"), ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "public"))
	var sandboxMode any = ccxt.DerefScalar(this.SafeBool2(this.Options, "sandboxMode", "sandbox", false))
	if sandboxMode == true {
...
func (this *BitgetCore) watchPublicMultipleBody(ch chan any, uta any, messageHashes any, argsArray any, optionalArgs ...any) any {
	...
	if sandboxMode == true {
		...
		if (instType == nil || *instType != "SCOIN-FUTURES") && (instType == nil || *instType != "SUSDT-FUTURES") && (instType == nil || *instType != "SUSDC-FUTURES") {
			url = ccxt.Ternary((ccxt.IsEqual(uta, true)), ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "demo"), "utaPublic"), ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "demo"), "public"))
		}
	}
	var request map[string]any = map[string]any{
		"op":   "subscribe",
...
func (this *BitgetCore) watchPrivateBody(ch chan any, uta any, messageHash any, subscriptionHash any, args any, optionalArgs ...any) any {
	...
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
	var url any = ccxt.Ternary((ccxt.IsEqual(uta, true)), ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "utaPrivate"), ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "private"))
	var sandboxMode any = ccxt.DerefScalar(this.SafeBool2(this.Options, "sandboxMode", "sandbox", false))
	if sandboxMode == true {
		var instType *string = this.SafeString(args, "instType")
		if (instType == nil || *instType != "SCOIN-FUTURES") && (instType == nil || *instType != "SUSDT-FUTURES") && (instType == nil || *instType != "SUSDC-FUTURES") {
