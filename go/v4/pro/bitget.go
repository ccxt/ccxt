...
func (this *Bitget) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var topicOrChannel string = ccxt.Ternary(ccxt.EvalTruthy(uta), "topic", "channel").(string)
	var symbolOrInstId string = ccxt.Ternary(ccxt.EvalTruthy(uta), "symbol", "instId").(string)
...
func (this *Bitget) ParseWsTicker(message any, optionalArgs ...any) any {
	...
	var marketType string = ccxt.Ternary((instType != nil && *instType == "spot"), "spot", "contract").(string)
...
func (this *Bitget) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes43212 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes76512 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	orderbook := (<-this.WatchPublicMultipleAsync(uta, messageHashes, topics, params))
...
func (this *Bitget) handleCheckSumErrorBody(ch chan any, client any, symbol any, messageHash any) any {
	...
	retRes9818 := (<-this.UnWatchOrderBookAsync(symbol))
...
func (this *Bitget) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var uta any = ccxt.GetValue(values, 0)
	var channelTopic string = ccxt.Ternary(ccxt.EvalTruthy(uta), "publicTrade", "trade").(string)
...
func (this *Bitget) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	var topicOrChannel string = ccxt.Ternary(ccxt.EvalTruthy(uta), "topic", "channel").(string)
	var channel string = ccxt.Ternary(ccxt.EvalTruthy(uta), "position", "positions").(string)
	ccxt.AddElementToObject(args, topicOrChannel, channel)
	if !ccxt.EvalTruthy(uta) {
	...
	newPositions := (<-this.WatchPrivateAsync(uta, messageHash, subscriptionHash, args, params))
...
func (this *Bitget) ParseWsPosition(position any, optionalArgs ...any) any {
	...
	var hedged bool = ccxt.Ternary((hedgedId != nil && *hedgedId == "hedge_mode"), true, false).(bool)
...
func (this *Bitget) HandleOrder(client any, message any) {
	...
	var messageHash string = ccxt.Ternary(isTrigger, "triggerOrder", "order").(string)
...
func (this *Bitget) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes209612 := (<-this.LoadMarketsAsync())
...
func (this *Bitget) HandleBalance(client any, message any) {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
		...
		if instType != nil && *instType == "uta" {
			...
			var freeQuery string = ccxt.Ternary((ccxt.InOp(rawBalance, "maxTransferOut")), "maxTransferOut", "available").(string)
...
func (this *Bitget) watchPrivateBody(ch chan any, uta any, messageHash any, subscriptionHash any, args any, optionalArgs ...any) any {
	...
	retRes25858 := (<-this.AuthenticateAsync(map[string]any{
		"url": url,
	}))
...
func (this *Bitget) HandleOrderBookUnSubscription(client any, message any) {
	...
	var arg any = this.SafeDict(message, "arg", map[string]any{})
	var instType *string = this.SafeStringLower(arg, "instType")
	var typeVar string = ccxt.Ternary((instType != nil && *instType == "spot"), "spot", "contract").(string)
