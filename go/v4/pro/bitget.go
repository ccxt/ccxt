...
func (this *BitgetCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ((typeVar == "spot") || (typeVar == "margin")) && (ccxt.IsEqual(symbol, nil)) {
		marketId = "default"
	}
	if (productType == nil) && (typeVar != "spot") && (ccxt.IsEqual(symbol, nil)) {
	...
	var instType any = nil
	if ccxt.IsEqual(market, nil) && (typeVar == "spot") {
		instType = "SPOT"
	} else {
	...
	if (typeVar == "spot") && (!ccxt.IsEqual(symbol, nil)) {
	...
	var instId any = ccxt.Ternary(((typeVar == "spot") || (typeVar == "margin")), marketId, "default") // different from other streams here the 'rest' id is required for spot markets, contract markets require default here
