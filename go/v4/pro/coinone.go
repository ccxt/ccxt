 ...
 */
func (this *Coinone) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Coinone) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
...
func (this *Coinone) HandleDelta(bookside any, delta any) {
 ...
 */
func (this *Coinone) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Coinone) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
 ...
 */
func (this *Coinone) WatchTradesAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Coinone) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	if !ccxt.IsEqual(isSellerMaker, nil) {
		side = func() any { if (isSellerMaker == true) { return "sell" }; return "buy" }()
	}
...
func (this *Coinone) HandleMessage(client any, message any) {
...
func (this *Coinone) Ping(client any) any {
	return map[string]any{
		"request_type": "PING",
	}
}
func (this *Coinone) HandlePong(client any, message any) any {
	//
	//     {
	//         "response_type":"PONG"
	//     }
