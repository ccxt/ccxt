...
func (this *Phemex) RequestId() int64 {
	this.LockId()
...
func (this *Phemex) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var usePerpetualApi bool = (this.SafeString(params, "settle") != nil && *this.SafeString(params, "settle") == "USDT")
	var messageHash any = ":balance"
	messageHash = func() any {
		if usePerpetualApi {
			return ccxt.Add("perpetual", messageHash)
		}
...
func (this *Phemex) HandleOHLCV(client any, message any) {
	...
	if timeframe != nil {
		var messageHash string = "kline:" + *timeframe + ":" + *symbol
	...
	if symbol == nil {
		...
		messageHash = func() any {
			if settle != nil && *settle == "USDT" {
				return (ccxt.Add(messageHash, "perpetual"))
			}
			return (ccxt.Add(messageHash, typeVar))
		}()
	}
...
func (this *Phemex) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	typeVar = ccxt.GetValue(typeVarparamsVariable, 0)
	params = ccxt.MapTyped(ccxt.GetValue(typeVarparamsVariable, 1))
	var isUSDTSettled bool = (this.SafeString(params, "settle") != nil && *this.SafeString(params, "settle") == "USDT")
	if symbol == nil {
		messageHash = func() any {
			if isUSDTSettled {
				return (ccxt.Add(messageHash, "perpetual"))
...
func (this *Phemex) HandleMessage(client any, message any) {
	...
	if (ccxt.InOp(message, "market24h")) || (ccxt.InOp(message, "spot_market24h")) || (func() int {
		if methodName == nil {
			return -1
		}
		return strings.Index(*methodName, "perp_market24h_pack_p")
	}() >= 0) {
...
func (this *Phemex) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(future, nil) {
		...
		var subscriptionHash string = strconv.FormatInt(requestId, 10)
