...
func (this *Phemex) RequestId() any {
	this.LockId()
...
func (this *Phemex) ParseSwapTicker(ticker any, optionalArgs ...any) any {
	//
	//     {
	//         "close": 442800,
	//         "fundingRate": 10000,
...
func (this *Phemex) HandleTrades(client any, message any) {
	//
	//     {
	//         "sequence": 1795484727,
	//         "symbol": "sBTCUSDT",
...
func (this *Phemex) HandleOHLCV(client any, message any) {
	//
	//     {
	//         "kline": [
 ...
 */
func (this *Phemex) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Phemex) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var name string = ccxt.Ternary(isUsdtSwap, "trade_p", "trade").(string)
 ...
 */
func (this *Phemex) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Phemex) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var settleIsUSDT bool = ccxt.IsEqual(ccxt.GetValue(market, "settle"), "USDT")
	var isUsdtSwap bool = (ccxt.IsEqual(isSwap, true)) && settleIsUSDT
	var name string = ccxt.Ternary(isUsdtSwap, "orderbook_p", "orderbook").(string)
 ...
 */
func (this *Phemex) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Phemex) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var settleIsUSDT bool = ccxt.IsEqual(ccxt.GetValue(market, "settle"), "USDT")
	var isUsdtSwap bool = (ccxt.IsEqual(isSwap, true)) && settleIsUSDT
	var name string = ccxt.Ternary(isUsdtSwap, "kline_p", "kline").(string)
	var messageHash any = ccxt.Add(ccxt.Add(ccxt.Add("kline:", timeframe), ":"), symbol)
	var method string = name + ".subscribe"
	var subscribe map[string]any = map[string]any{
		"method": method,
...
func (this *Phemex) CustomHandleDeltas(bookside any, deltas any, optionalArgs ...any) {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
...
func (this *Phemex) HandleOrderBook(client any, message any) {
	//
	//     {
	//         "book": {
	//             "asks": [
...
func (this *Phemex) HandleMessage(client any, message any) {
	...
	if (ccxt.InOp(message, "accounts")) || (ccxt.InOp(message, "accounts_p")) || (ccxt.InOp(message, "wallets")) {
		var typeVar string = ccxt.Ternary((ccxt.InOp(message, "accounts")), "swap", "spot").(string)
