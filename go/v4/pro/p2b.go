 ...
 */
func (this *P2b) SubscribeAsync(name any, messageHash any, request any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
 ...
 */
func (this *P2b) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *P2b) HandleOHLCV(client any, message map[string]any) any {
	...
	var splitMethod []string = func() []string {
		if method == nil {
			return nil
		}
...
func (this *P2b) HandleOrderBook(client any, message map[string]any) {
	...
	if isFullUpdate != nil && *isFullUpdate == true {
...
func (this *P2b) Ping(client any) any {
	/**
...
func (this *P2b) HandlePong(client any, message any) any {
	//
	//    {
	//        error: null,
	//        result: 'pong',
