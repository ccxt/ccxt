...
func (this *Weex) subscribePublicBody(ch chan any, messageHashes any, channels any, optionalArgs ...any) any {
	...
	_ = params
	var subscription map[string]any = ccxt.GetArgMap(optionalArgs, 2, map[string]any{})
	_ = subscription
...
func (this *Weex) Authenticate(url any) {
	...
	var originalHeaders map[string]any = ccxt.SafeMapTyped(ccxt.GetValue(ccxt.GetValue(this.Options, "ws"), "options"), "headers")
...
func (this *Weex) unWatchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		...
		var channelName any = ccxt.Add(ccxt.Add(market["id"], "@"), topic)
		var messageHash string = topic + "::" + *symbol
		var unSubMessageHash string = "unsubscribe::" + messageHash
		subHashes = append(subHashes, messageHash)
		channels = append(channels, channelName)
		unSubHashes = append(unSubHashes, unSubMessageHash)
	}
...
func (this *Weex) HandleTicker(client any, message any) {
	...
	var tickers []any = ccxt.SafeListTyped(message, "d")
...
func (this *Weex) HandleTrade(client any, message any) {
	...
	var data []any = ccxt.SafeListTyped(message, "d")
...
func (this *Weex) watchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		var messageHash *string = ccxt.SafeStringPtr(ccxt.Add(ccxt.Add(ccxt.Add("ohlcv::", symbolString), "::"), unifiedTimeframe))
...
func (this *Weex) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		var unSubMessageHash *string = ccxt.SafeStringPtr(ccxt.Add("unsubscribe::", messageHash))
		channels = append(channels, channel)
		subHashes = append(subHashes, messageHash)
		unSubHashes = append(unSubHashes, unSubMessageHash)
	}
...
func (this *Weex) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var trades ccxt.ArrayCacheInterface = ccxt.AsArrayCache(ccxt.PanicOnError((<-this.SubscribePrivateAsync(messageHash, subscriptionHash, channel, isContract, params))))
	if this.NewUpdates {
...
func (this *Weex) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var orders ccxt.ArrayCacheInterface = ccxt.AsArrayCache(ccxt.PanicOnError((<-this.SubscribePrivateAsync(messageHash, subscriptionHash, channel, isContract, params))))
	if this.NewUpdates {
...
func (this *Weex) HandleBalance(client any, message any) {
	...
	var balanceUpdates []any = ccxt.SafeListTyped(message, "d")
...
func (this *Weex) HandleSubscriptionStatus(client any, message any) any {
	...
	if unsubscribe != nil && *unsubscribe == true {
		...
		var subHashes []any = ccxt.SafeListTyped(subscription, "subMessageHashes")
		for i := 0; i < len(messageHashes); i++ {
