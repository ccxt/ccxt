...
func (this *Weex) subscribePublicBody(ch chan any, messageHashes any, channels any, optionalArgs ...any) any {
	...
	var typeVar string = ccxt.Ternary(ccxt.EvalTruthy(isContract), "contract", "spot").(string)
...
func (this *Weex) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	var symbol any = ccxt.Ternary((ccxt.IsEqual(market, nil)), nil, ccxt.GetValue(market, "symbol"))
	var isBuyerMaker *bool = this.SafeBool(trade, "m") // m is the isBuyerMaker flag of the REST trades, true means the taker sold
	var side any = nil
	var takerOrMaker any = nil
	if isBuyerMaker != nil {
		side = ccxt.Ternary((isBuyerMaker != nil && *isBuyerMaker), "sell", "buy")
...
func (this *Weex) unWatchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	params = ccxt.GetValue(marketTypeparamsVariable, 1)
	var isContract bool = (!ccxt.IsEqual(marketType, "spot"))
	var subHash string = ccxt.Ternary(isContract, "myContractTrades", "myTrades").(string)
...
func (this *Weex) unWatchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	params = ccxt.GetValue(marketTypeparamsVariable, 1)
	var isContract bool = (!ccxt.IsEqual(marketType, "spot"))
	var subHash string = ccxt.Ternary(isContract, "contractOrders", "orders").(string)
	var unSubHash string = "unsubscribe::" + subHash
	var channel string = "orders"
	var subscription map[string]any = map[string]any{
		"unsubscribe":      true,
...
func (this *Weex) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var urlType string = ccxt.Ternary(isContract, "contract", "spot").(string)
