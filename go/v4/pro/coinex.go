...
func (this *Coinex) HandleTicker(client any, message map[string]any) {
	...
	for i := 0; i < len(rawTickers); i++ {
		...
		var market map[string]any = this.SafeMarket(marketId, nil, nil, defaultType)
	...
	var messageHashes []any = ccxt.ArrayTyped(this.FindMessageHashes(ccxt.AsClient(client), "tickers::"))
...
func (this *Coinex) ParseWSTicker(ticker any, optionalArgs ...any) any {
	//
	//  spot
	//
	//     {
...
func (this *Coinex) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var typeVarparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("watchBalance", nil, params, "spot")
...
func (this *Coinex) ParseWsBalance(balance any, optionalArgs ...any) {
	//
	// spot
	//
	//     {
...
func (this *Coinex) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var typeVarparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("watchMyTrades", market, params, "spot")
	typeVar := ccxt.GetValue(typeVarparamsMarketTypeVariable, 0)
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(typeVarparamsMarketTypeVariable, 1))
...
func (this *Coinex) ParseWsTrade(trade any, optionalArgs ...any) any {
	//
	// spot watchTrades
	//
	//     {
	...
	if feeCost != nil {
		var feeCurrencyId *string = this.SafeString(trade, "fee_ccy", marketResolved["quote"])
		fee = map[string]any{
 ...
 */
func (this *Coinex) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Coinex) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	var params map[string]any = ccxt.GetArgMap(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Coinex) watchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	var typeVarparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams(callerMethodName, market, paramsCallerMethodName)
	var typeVar *string = ccxt.SafeStringPtr(ccxt.GetValue(typeVarparamsMarketTypeVariable, 0))
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(typeVarparamsMarketTypeVariable, 1))
	var url any = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), typeVar)
...
func (this *Coinex) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	var limitResolved any = func() any {
		if limit == nil {
			return this.SafeInteger(options, "defaultLimit", 50)
		}
		return limit
	}()
	if !this.InArray(limitResolved, limits) {
		panic(ccxt.NotSupported(this.Id + " watchOrderBookForSymbols() limit must be one of " + ccxt.Join(limits, ", ")))
	}
	...
	var aggregation *string = this.SafeString(paramsCallerMethodName, "aggregation", defaultAggregation)
	...
	var typeVarparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams(callerMethodName, market, paramsOmitted)
	var typeVar *string = ccxt.SafeStringPtr(ccxt.GetValue(typeVarparamsMarketTypeVariable, 0))
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(typeVarparamsMarketTypeVariable, 1))
 ...
 * @returns {object} an [order book structure]{@link https://docs.ccxt.com/?id=order-book-structure}
 */
func (this *Coinex) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Coinex) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Coinex) HandleDeltas(bookside any, deltas any) {
...
func (this *Coinex) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var typeVarparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("watchOrders", market, paramsOmitted, "spot")
	typeVar := ccxt.GetValue(typeVarparamsMarketTypeVariable, 0)
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(typeVarparamsMarketTypeVariable, 1))
...
func (this *Coinex) ParseWsOrder(order any, optionalArgs ...any) any {
	//
	// spot
	//
	//     {
	...
	if feeCost != nil {
		var feeCurrencyId *string = this.SafeString(order, "fee_ccy", marketResolved["quote"])
		fee = map[string]any{
			"currency": this.SafeCurrencyCode(feeCurrencyId),
			"cost":     feeCost,
		}
...
func (this *Coinex) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	var typeVarparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("watchBidsAsks", market, params)
	var typeVar *string = ccxt.SafeStringPtr(ccxt.GetValue(typeVarparamsMarketTypeVariable, 0))
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(typeVarparamsMarketTypeVariable, 1))
	var url any = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), typeVar)
...
func (this *Coinex) authenticateBody(ch chan any, typeVar any) any {
	...
	var request map[string]any = map[string]any{
		...
		"params": map[string]any{
			...
			"signed_str": strings.ToLower(hmac),
			"timestamp":  time,
		},
	}
