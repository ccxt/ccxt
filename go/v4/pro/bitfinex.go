...
func (this *Bitfinex) subscribeBody(ch chan any, channel any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(checksum, true))) && ccxt.IsTrue((ccxt.IsEqual(channel, "book")))) {
		...
		if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(sub, nil))) && ccxt.IsTrue((!ccxt.IsEqual(ccxt.GetValue(sub, "checksum"), true)))) {
			...
			retRes7116 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
				"event": "conf",
				"flags": 131072,
			}))
...
func (this *Bitfinex) subscribePrivateBody(ch chan any, messageHash any) any {
	...
	retRes1128 := (<-this.AuthenticateAsync())
 ...
 */
func (this *Bitfinex) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Bitfinex) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
...
func (this *Bitfinex) ParseWsTicker(ticker any, optionalArgs ...any) any {
	//
	//     [
	//         236.62,        // 1 BID float Price of last highest bid
	//         9.0029,        // 2 BID_SIZE float Size of the last highest bid
	...
	return this.SafeTicker(map[string]any{
		...
		"previousClose": nil,
		"change":        change,
		"percentage":    ccxt.Precise.StringMul(this.SafeString(ticker, 5), "100"),
		"average":       nil,
 ...
 */
func (this *Bitfinex) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Bitfinex) ParseWsBalance(balance any) any {
	//
	//     [
	//         "exchange",
	//         "LTC",
...
func (this *Bitfinex) ParseWsOrderStatus(status any) any {
...
func (this *Bitfinex) ParseWsOrder(order any, optionalArgs ...any) any {
	//
	//   [
	//       97084883506, // order id
	//       null,
