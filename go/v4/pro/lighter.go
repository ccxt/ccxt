...
func (this *LighterCore) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	var isMakerAsk any = ccxt.DerefScalar(this.SafeBool(trade, "is_maker_ask"))
	var side any = ccxt.Ternary((ccxt.IsEqual(isMakerAsk, true)), "buy", "sell")
...
func (this *LighterCore) HandleTrades(client any, message any) {
	...
	if ccxt.IsGreaterThan(liquidationDataLength, 0) {
...
func (this *LighterCore) ParseWsOrderTrade(trade any, optionalArgs ...any) any {
	...
	if accountIndex != nil {
		if bidAccountId == accountIndex || (bidAccountId != nil && accountIndex != nil && *bidAccountId == *accountIndex) {
			...
			takerOrMaker = ccxt.Ternary((ccxt.IsEqual(isMakerAsk, true)), "taker", "maker")
			...
			takerOrMaker = ccxt.Ternary((ccxt.IsEqual(isMakerAsk, true)), "maker", "taker")
		}
	}
	// public trades use Lighter's taker-side convention
	if ccxt.IsEqual(side, nil) {
		side = ccxt.Ternary((ccxt.IsEqual(isMakerAsk, true)), "buy", "sell")
	}
	var fee any = nil
...
func (this *LighterCore) ParseWsLiquidation(liquidation any, optionalArgs ...any) any {
	...
	var isMakerAsk any = ccxt.DerefScalar(this.SafeBool(liquidation, "is_maker_ask"))
	var side any = ccxt.Ternary((ccxt.IsEqual(isMakerAsk, true)), "buy", "sell")
...
func (this *LighterCore) HandleBalance(client any, message any) any {
	...
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "user_stats:"), 0) {
		typeVar = "swap"
	}
...
func (this *LighterCore) HandleMessage(client any, message any) {
	...
	var channel *string = this.SafeString(message, "channel", "")
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "order_book:"), 0) {
		this.HandleOrderBook(client, message)
		return
	}
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "market_stats:"), 0) {
		this.HandleTicker(client, message)
		return
	}
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "trade:"), 0) {
		this.HandleTrades(client, message)
		return
	}
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "account_all_trades:"), 0) {
		this.HandleMyTrades(client, message)
		return
	}
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "account_all_assets:"), 0) {
	...
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "account_orders:"), 0) {
		this.HandleOrders(client, message)
		return
	}
	if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channel, "account_all_orders:"), 0) {
		this.HandleOrders(client, message)
		return
	}
