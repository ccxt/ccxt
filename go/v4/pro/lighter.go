...
func (this *LighterCore) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if (ccxt.IsEqual(symbols, nil)) || (ccxt.IsEqual(symbolsLength, 0)) {
...
func (this *LighterCore) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	var side any = ccxt.Ternary(ccxt.EvalTruthy(isMakerAsk), "buy", "sell")
...
func (this *LighterCore) ParseWsOrderTrade(trade any, optionalArgs ...any) any {
	...
	if accountIndex != nil {
		if bidAccountId == accountIndex || (bidAccountId != nil && accountIndex != nil && *bidAccountId == *accountIndex) {
			...
			takerOrMaker = ccxt.Ternary(ccxt.EvalTruthy(isMakerAsk), "taker", "maker")
			...
			takerOrMaker = ccxt.Ternary(ccxt.EvalTruthy(isMakerAsk), "maker", "taker")
		}
	}
	// public trades use Lighter's taker-side convention
	if ccxt.IsEqual(side, nil) {
		side = ccxt.Ternary(ccxt.EvalTruthy(isMakerAsk), "buy", "sell")
	}
	var fee any = nil
