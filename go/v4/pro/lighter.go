...
func (this *Lighter) HandleBalance(client any, message any) any {
	...
	if ccxt.GetIndexOf(channel, "user_stats:") >= 0 {
		typeVar = "swap"
	}
...
func (this *Lighter) HandleMessage(client any, message any) {
	...
	if ccxt.GetIndexOf(channel, "market_stats:") >= 0 {
		this.HandleTicker(client, message)
		return
	}
	if ccxt.GetIndexOf(channel, "trade:") >= 0 {
		this.HandleTrades(client, message)
		return
	}
	if ccxt.GetIndexOf(channel, "account_all_trades:") >= 0 {
		this.HandleMyTrades(client, message)
		return
	}
	if ccxt.GetIndexOf(channel, "account_all_assets:") >= 0 {
	...
	if ccxt.GetIndexOf(channel, "account_orders:") >= 0 {
		this.HandleOrders(client, message)
		return
	}
	if ccxt.GetIndexOf(channel, "account_all_orders:") >= 0 {
		this.HandleOrders(client, message)
		return
	}
