...
func (this *Lighter) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var messageHash any = this.GetMessageHash("orderbook", symbolValue)
...
func (this *Lighter) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var subMessageHash any = this.GetMessageHash("orderbook", symbolValue)
...
func (this *Lighter) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var messageHash any = this.GetMessageHash("ticker", symbolValue)
...
func (this *Lighter) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var subMessageHash any = this.GetMessageHash("ticker", symbolValue)
	var messageHash *string = ccxt.SafeStringPtr(ccxt.Add("unsubscribe:", subMessageHash))
...
func (this *Lighter) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var accountIndexparamsAccountIndexVariable []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.HandleAccountIndexAsync(params, "watchMyTrades", "accountIndex", "account_index"))))
...
func (this *Lighter) unWatchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var accountIndexparamsAccountIndexVariable []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.HandleAccountIndexAsync(params, "unWatchMyTrades", "accountIndex", "account_index"))))
	accountIndex := ccxt.GetValue(accountIndexparamsAccountIndexVariable, 0)
	paramsAccountIndex := ccxt.GetValue(accountIndexparamsAccountIndexVariable, 1)
...
func (this *Lighter) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var accountIndexparamsAccountIndexVariable []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.HandleAccountIndexAsync(params, "watchOrders", "accountIndex", "account_index"))))
	accountIndex := ccxt.GetValue(accountIndexparamsAccountIndexVariable, 0)
	paramsAccountIndex := ccxt.GetValue(accountIndexparamsAccountIndexVariable, 1)
...
func (this *Lighter) unWatchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var accountIndexparamsAccountIndexVariable []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.HandleAccountIndexAsync(params, "unWatchOrders", "accountIndex", "account_index"))))
	accountIndex := ccxt.GetValue(accountIndexparamsAccountIndexVariable, 0)
	paramsAccountIndex := ccxt.GetValue(accountIndexparamsAccountIndexVariable, 1)
 ...
 */
func (this *Lighter) CreateOrderWsAsync(symbol any, typeVar string, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Lighter) createOrderWsBody(ch chan any, symbol any, typeVar string, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	var txTypetxInfoorderVariable []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.SignAndCreateOrderAsync("createOrderWs", symbol, typeVar, side, amount, price, params))))
...
func (this *Lighter) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var requestId any = this.RequestId(url)
	var messageHash *string = ccxt.SafeStringPtr(ccxt.Add("jsonapi/sendtx:", requestId))
	var txTypetxInfoVariable []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.SignAndCancelOrderAsync("cancelOrderWs", id, symbol, params))))
