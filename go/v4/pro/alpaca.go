 ...
 */
func (this *Alpaca) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
 ...
 */
func (this *Alpaca) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
 ...
 */
func (this *Alpaca) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Alpaca) HandleDelta(bookside any, delta any) {
	var bidAsk any = this.ParseOrderBookBidAsk(delta, "p", "s")
	bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func (this *Alpaca) HandleDeltas(bookside any, deltas any) {
...
func (this *Alpaca) HandleCryptoMessage(client any, message any) {
...
func (this *Alpaca) HandleTradingMessage(client any, message any) {
...
func (this *Alpaca) HandleMessage(client any, message any) {
...
func (this *Alpaca) HandleAuthenticate(client any, message any) {
	//
	// crypto
	//    {
	//        "T": "success",
	...
	panic(ccxt.AuthenticationError(this.Id + " failed to authenticate."))
}
func (this *Alpaca) HandleSubscription(client any, message any) any {
	//
	// crypto
	//    {
	//          "T": "subscription",
