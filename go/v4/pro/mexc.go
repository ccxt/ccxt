...
func (this *Mexc) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes9612 := (<-this.LoadMarketsAsync())
...
func (this *Mexc) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes21212 := (<-this.LoadMarketsAsync())
...
func (this *Mexc) HandleTickers(client any, message any) {
	...
	var messageHashPrefix any = ccxt.Ternary((ccxt.IsEqual(isSpot, true)), spotPrefix, "")
	var topic any = ccxt.Add(messageHashPrefix, "ticker")
	var result any = []any{}
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(data)); i++ {
		var entry any = ccxt.GetValue(data, i)
		var ticker any = nil
		if ccxt.IsEqual(isSpot, true) {
...
func (this *Mexc) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes43012 := (<-this.LoadMarketsAsync())
...
func (this *Mexc) watchSpotPublicBody(ch chan any, channel any, messageHash any, optionalArgs ...any) any {
	...
	var url any = ccxt.GetValue(ccxt.GetValue(ccxt.GetValue(this.Urls, "api"), "ws"), "spot")
	var method string = ccxt.Ternary((unsubscribed != nil && *unsubscribed == true), "UNSUBSCRIPTION", "SUBSCRIPTION").(string)
	var request map[string]any = map[string]any{
		"method": method,
		"params": []any{channel},
	}
...
func (this *Mexc) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(typeVar, "spot") {
		...
		trades = (<-this.WatchSpotPrivateAsync(channel, messageHash, params))
		ccxt.PanicOnError(trades)
	} else {

		trades = (<-this.WatchSwapPrivateAsync(messageHash, params))
		ccxt.PanicOnError(trades)
	}
...
func (this *Mexc) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	var side string = ccxt.Ternary((rawSide != nil && *rawSide == "1"), "buy", "sell").(string)
	...
	return this.SafeTrade(map[string]any{
		...
		"type":         nil,
		"side":         side,
		"takerOrMaker": ccxt.Ternary(((isMaker != nil) && (isMaker == nil || *isMaker != 0)), "maker", "taker"),
		"price":        priceString,
		"amount":       amountString,
...
func (this *Mexc) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(typeVar, "spot") {
		...
		orders = (<-this.WatchSpotPrivateAsync(channel, messageHash, params))
		ccxt.PanicOnError(orders)
	} else {

		orders = (<-this.WatchSwapPrivateAsync(messageHash, params))
		ccxt.PanicOnError(orders)
	}
...
func (this *Mexc) HandleBalance(client any, message any) {
	...
	var typeVar string = ccxt.Ternary((channel != nil && *channel == "spot@private.account.v3.api.pb"), "spot", "swap").(string)
