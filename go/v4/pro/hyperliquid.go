...
func (this *HyperliquidCore) UnWatchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes53715 := (<-this.Watch(url, messageHash, message, messageHash))
...
func (this *HyperliquidCore) UnWatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes73815 := (<-this.Watch(url, messageHash, message, messageHash))
...
func (this *HyperliquidCore) UnWatchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes91115 := (<-this.Watch(url, messagehash, message, messagehash))
		ccxt.PanicOnError(retRes91115)
		ch <- retRes91115
		return nil
...
func (this *HyperliquidCore) WatchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes101515 := (<-this.Watch(url, messageHash, message, topic))
...
func (this *HyperliquidCore) UnWatchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes105315 := (<-this.Watch(url, messageHash, message, messageHash))
		ccxt.PanicOnError(retRes105315)
		ch <- retRes105315
		return nil
...
func (this *HyperliquidCore) WatchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes121812)
		}
		var userAddress any = nil
...
func (this *HyperliquidCore) UnWatchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes130512)
		}
		if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(symbols, nil))) && !ccxt.IsTrue(this.IsEmpty(symbols))) {
		...
		retRes132415 := (<-this.Watch(url, messageHash, message, messageHash))
		ccxt.PanicOnError(retRes132415)
		ch <- retRes132415
		return nil
...
func (this *HyperliquidCore) WatchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes134112)
		}
		var userAddress any = nil
...
func (this *HyperliquidCore) UnWatchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes138212)
		}
		if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
		...
		retRes140115 := (<-this.Watch(url, messageHash, message, messageHash))
		ccxt.PanicOnError(retRes140115)
		ch <- retRes140115
		return nil
