...
func (this *Hyperliquid) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	orders := (<-this.CreateOrdersWsAsync([]any{order}, globalParams))
...
func (this *Hyperliquid) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var request map[string]any = map[string]any{
		...
		"subscription": map[string]any{
			"type": "l2Book",
			"coin": func() any { if (ccxt.IsEqual(ccxt.GetValue(market, "swap"), true)) { return ccxt.GetValue(market, "baseName") }; return ccxt.GetValue(market, "id") }(),
		},
	}
...
func (this *Hyperliquid) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	if side != nil {
		side = func() any { if (ccxt.IsEqual(side, "A")) { return "sell" }; return "buy" }()
	}
...
func (this *Hyperliquid) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	var topic any = func() any { if (isSpot == true) { return "spotState" }; return "clearinghouseState" }()
...
func (this *Hyperliquid) HandleErrorMessage(client any, message any) any {
	...
	if channel != nil && *channel == "error" {
		...
		if ccxt.GetIndexOf(ret_msg, "Already subscribed") >= 0 {
