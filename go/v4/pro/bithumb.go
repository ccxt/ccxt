 ...
 * @returns {object} a [ticker structure]{@link https://github.com/mtan11/ccxt/wiki/Manual#ticker-structure}
 */
 ...
 * @param {object} [params] extra parameters specific to the exchange API endpoint
 * @returns {object} A dictionary of [order book structures]{@link https://github.com/mtan11/ccxt/wiki/Manual#order-book-structure} indexed by market symbols
 */
 ...
 * @param {object} [params] extra parameters specific to the exchange API endpoint
 * @returns {object[]} a list of [trade structures]{@link https://github.com/mtan11/ccxt/wiki/Manual#public-trades}
 */
