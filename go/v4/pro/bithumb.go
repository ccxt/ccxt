...
func (this *Bithumb) pongBody(ch chan any, client any, message any) any {
	...
	if ccxt.IsTrue(!ccxt.IsEqual(ping, nil)) {
		...
		retRes4812 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
			"pong": ping,
		}))
		ccxt.PanicOnError(retRes4812)
	} else {

		retRes5012 := (<-client.(ccxt.ClientInterface).SendAsync("PONG"))
		ccxt.PanicOnError(retRes5012)
	}
	return nil
}
func (this *Bithumb) HandlePing(client any, message any) {
	this.Spawn(this.PongAsync, client, message)
}
func (this *Bithumb) HandlePong(client any, message any) {
...
func (this *Bithumb) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes7612 := (<-this.LoadMarketsAsync())
...
func (this *Bithumb) ParseWsTicker(ticker any, optionalArgs ...any) any {
	//
	//    {
	//        "symbol" : "BTC_KRW",           // 통화코드
	//        "tickType" : "24H",                 // 변동 기준시간- 30M, 1H, 12H, 24H, MID
...
func (this *Bithumb) ParseWsTrade(trade any, optionalArgs ...any) any {
	//
	// generation 1
	//
	//    {
...
func (this *Bithumb) HandleErrorMessage(client any, message any) any {
	...
	{
		ret__ := func(this *Bithumb) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					if e == "break" {
						return
					}
					ret_ = func(this *Bithumb) any {
						// catch block:
...
func (this *Bithumb) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes7878 := (<-this.AuthenticateAsync())
...
func (this *Bithumb) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes9098 := (<-this.AuthenticateAsync())
