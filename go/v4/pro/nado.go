...
func (this *Nado) watchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	var limitResolved *int64 = limit
	if this.NewUpdates {
		limitResolved = ccxt.ToGetsLimit(stored).GetLimit(resultSymbol, limit)
	}
...
func (this *Nado) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if !ccxt.IsEqual(symbolsNormalized, nil) {
		...
		if symbolsLength == 1 {
			market = this.Market(ccxt.GetValue(symbolsNormalized, 0))
 ...
 */
func (this *Nado) CreateOrderWsAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Nado) createOrderWsBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	var requestIdString *string = this.SafeString(paramsExtended, "id")
