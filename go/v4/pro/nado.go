...
func (this *Nado) RequestId() int64 {
...
func (this *Nado) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if symbols != nil {
		var symbolsLength int = ccxt.GetArrayLength(symbols)
		if symbolsLength == 1 {
			var market map[string]any = this.Market(ccxt.GetValue(symbols, 0))
 ...
 */
func (this *Nado) CreateOrderWsAsync(symbol any, typeVar string, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Nado) createOrderWsBody(ch chan any, symbol any, typeVar string, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/#/?id=order-structure}
 */
func (this *Nado) EditOrderWsAsync(id any, symbol any, typeVar string, side string, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.editOrderWsBody(ch, id, symbol, typeVar, side, optionalArgs...)
	return ch
}
func (this *Nado) editOrderWsBody(ch chan any, id any, symbol any, typeVar string, side string, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Nado) watchPrivateBody(ch chan any, streamType any, stream any, messageHash any, optionalArgs ...any) any {
	...
	var subscribeHash *string = ccxt.SafeStringPtr(ccxt.Add("subscribe:", messageHash))
	var request map[string]any = map[string]any{
		"method": "subscribe",
		"stream": this.DeepExtend(stream, params),
		"id":     id,
...
func (this *Nado) WatchExecuteRequest(requestIdString string, request map[string]any) (map[string]any, error) {
	var res ccxt.AsyncResult[map[string]any] = ccxt.AwaitResult(ccxt.AssertAs[map[string]any], this.WatchExecuteRequestAsync(requestIdString, request))
	if res.Err != nil {
