...
func (this *Hollaex) HandleBalance(client any, message any) {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(keys)); i++ {
		...
		var freeOrTotal string = ccxt.Ternary((second != nil && *second == "available"), "free", "total").(string)
...
func (this *Hollaex) HandleErrorMessage(client any, message any) any {
	...
	{
		func(this *Hollaex) (ret_ any) {
			defer func() {
				if e := recover(); e != nil {
					if e == "break" {
						return
					}
					ret_ = func(this *Hollaex) any {
						// catch block:
...
func (this *Hollaex) HandleMessage(client any, message any) {
	//
	// pong
	//
	//     { message: "pong" }
...
func (this *Hollaex) Ping(client any) any {
	// hollaex does not support built-in ws protocol-level ping-pong
	return map[string]any{
		"op": "ping",
	}
}
func (this *Hollaex) HandlePong(client any, message any) any {
