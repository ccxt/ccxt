...
func (this *WoofiproCore) watchPublicBody(ch chan any, messageHash any, message any) any {
	...
	if !ccxt.IsEqual(this.AccountId, nil) && !ccxt.IsEqual(this.AccountId, "") {
		id = this.AccountId
	}
...
func (this *WoofiproCore) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(authenticated, nil) {
		...
		if ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(secret, "ed25519:"), 0) {
...
func (this *WoofiproCore) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var topic any = ccxt.Ternary(ccxt.EvalTruthy((trigger)), "algoexecutionreport", "executionreport")
