 ...
 */
func (this *Woofipro) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Woofipro) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
 ...
 */
func (this *Woofipro) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Woofipro) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes16912 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes26112 := (<-this.LoadMarketsAsync())
 ...
 */
func (this *Woofipro) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOHLCVBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Woofipro) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes39512 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) ParseWsTrade(trade any, optionalArgs ...any) any {
	//
	//     {
	//         "symbol":"PERP_ADA_USDC",
...
func (this *Woofipro) watchPrivateBody(ch chan any, messageHash any, message any, optionalArgs ...any) any {
	...
	retRes6558 := (<-this.AuthenticateAsync(params))
...
func (this *Woofipro) watchPrivateMultipleBody(ch chan any, messageHashes any, message any, optionalArgs ...any) any {
	...
	retRes6668 := (<-this.AuthenticateAsync(params))
...
func (this *Woofipro) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes69112 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes72912 := (<-this.LoadMarketsAsync())
...
func (this *Woofipro) HandleMyTrade(client any, message any) {
	//
	// {
	//     symbol: 'PERP_XRP_USDC',
	//     clientOrderId: '',
...
func (this *Woofipro) ParseWsPosition(position any, optionalArgs ...any) any {
	//
	//     {
	//         "symbol":"PERP_ETH_USDC",
	//         "positionQty":3.1408,
...
func (this *Woofipro) HandleErrorMessage(client any, message any) any {
	//
	...
	{
		ret__ := func(this *Woofipro) (ret_ any) {
			defer func() {
				if error := recover(); error != nil {
					if error == "break" {
						return
					}
					ret_ = func(this *Woofipro) any {
						// catch block:
...
func (this *Woofipro) HandleMessage(client any, message any) {
...
func (this *Woofipro) Ping(client any) any {
...
func (this *Woofipro) pongBody(ch chan any, client any, message any) any {
	...
	retRes13838 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
		"event": "pong",
	}))
