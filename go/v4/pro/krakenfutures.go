...
func (this *Krakenfutures) subscribePrivateBody(ch chan any, name any, messageHash any, optionalArgs ...any) any {
	...
	retRes1588 := (<-this.AuthenticateAsync())
 ...
 */
func (this *Krakenfutures) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Krakenfutures) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
 ...
 */
func (this *Krakenfutures) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Krakenfutures) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	limit := ccxt.GetArg(optionalArgs, 0, nil)
	_ = limit
...
func (this *Krakenfutures) ParseWsPosition(position any, optionalArgs ...any) any {
	//
	//        {
	//            instrument: 'PF_LTCUSD',
	//            balance: 0.5,
...
func (this *Krakenfutures) ParseWsTrade(trade any, optionalArgs ...any) any {
	//
	//    {
	//        "feed": "trade",
	//        "product_id": "PI_XBTUSD",
...
func (this *Krakenfutures) ParseWsOrder(order any, optionalArgs ...any) any {
	//
	// update
	//
	//    {
...
func (this *Krakenfutures) ParseWsMyTrade(trade any, optionalArgs ...any) any {
	//
	//    {
	//        "instrument": "FI_XBTUSD_200925",
	//        "time": 1600256910739,
...
func (this *Krakenfutures) HandleErrorMessage(client any, message any) any {
	//
	//    {
	//        event: 'alert',
	...
	{
		ret__ := func(this *Krakenfutures) (ret_ any) {
			defer func() {
				if error := recover(); error != nil {
					if error == "break" {
						return
					}
					ret_ = func(this *Krakenfutures) any {
						// catch block:
...
func (this *Krakenfutures) HandleMessage(client any, message any) {
...
func (this *Krakenfutures) HandleAuthenticate(client any, message any) any {
	/**
	 * @ignore
	 * @method
	 * @see https://docs.kraken.com/exchange/api-reference/futures-websocket/challenge
