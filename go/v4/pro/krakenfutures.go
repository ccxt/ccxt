...
func (this *KrakenfuturesCore) HandlePositions(client any, message any) {
	...
	if ccxt.IsEqual(rawPositions, nil) {
...
func (this *KrakenfuturesCore) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	if !ccxt.IsEqual(isCancelled, nil) {
		...
		if ccxt.IsEqual(isCancelled, true) {
			status = "cancelled"
		}
	}
	...
	return this.SafeOrder(map[string]any{
		...
		"timeInForce":        nil,
		"postOnly":           nil,
		"side":               ccxt.Ternary((direction != nil && *direction == 0), "buy", "sell"),
...
func (this *KrakenfuturesCore) HandleBalance(client any, message any) {
	...
	if !ccxt.IsEqual(futures, nil) {
		...
		for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(futuresKeys)); i++ {
			...
			if (!ccxt.IsEqual(symbol, nil)) && (!ccxt.IsEqual(code, nil)) {
...
func (this *KrakenfuturesCore) ParseWsMyTrade(trade any, optionalArgs ...any) any {
	...
	return this.SafeTrade(map[string]any{
		...
		"type":         this.SafeString(trade, "type"),
		"side":         ccxt.Ternary((ccxt.IsEqual(isBuy, true)), "buy", "sell"),
...
func (this *KrakenfuturesCore) HandleErrorMessage(client any, message any) any {
	...
	if (errMsg != nil) && ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(errMsg, "Already subscribed"), 0) {
		return false
	}
...
func (this *KrakenfuturesCore) HandleMessage(client any, message any) {
	...
	if event != nil && *event == "challenge" {
		this.HandleAuthenticate(client, message)
	} else if event != nil && *event == "alert" {
		this.HandleErrorMessage(client, message)
	} else if event != nil && *event == "pong" {
