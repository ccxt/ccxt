 ...
 */
func (this *Apex) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Apex) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Apex) HandleDelta(bookside any, delta any) {
	var bidAsk any = this.ParseOrderBookBidAsk(delta, 0, 1)
	bookside.(ccxt.IOrderBookSide).StoreArray(bidAsk)
}
func (this *Apex) HandleDeltas(bookside any, deltas any) {
 ...
 */
func (this *Apex) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Apex) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	params := ccxt.GetArg(optionalArgs, 0, map[string]any{})
	_ = params
 ...
 */
func (this *Apex) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOHLCVBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Apex) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Apex) HandleOHLCV(client any, message any) {
	...
	var marketType string = ccxt.Ternary(isSpot, "spot", "contract").(string)
...
func (this *Apex) ParseWsOHLCV(ohlcv any, optionalArgs ...any) any {
	//
	//     {
	//         "start": 1670363160000,
	//         "end": 1670363219999,
...
func (this *Apex) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes6268 := (<-this.AuthenticateAsync(url))
...
func (this *Apex) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes6938 := (<-this.AuthenticateAsync(url))
...
func (this *Apex) SetPositionsCache(client any, optionalArgs ...any) {
	symbols := ccxt.GetArg(optionalArgs, 0, nil)
	_ = symbols
...
func (this *Apex) HandleMessage(client any, message any) {
	if ccxt.IsEqual(this.HandleErrorMessage(client, message), true) {
		return
	}
	var ret_msg *string = this.SafeString(message, "ret_msg")
	var pong *int64 = this.SafeInteger(message, "pong")
	if (ret_msg != nil && *ret_msg == "pong") || (pong != nil) {
...
func (this *Apex) Ping(client any) any {
...
func (this *Apex) pongBody(ch chan any, client any, message any) any {
...

	{
		func(this *Apex) (ret_ any) {
			...
			retRes107212 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
				"args": []any{ccxt.ToString(timeStamp)},
				"op":   "pong",
			}))
...
func (this *Apex) HandlePong(client any, message any) any {
	//
	//   {
	//       "success": true,
	//       "ret_msg": "pong",
...
func (this *Apex) HandleAuthenticate(client any, message any) any {
	//
	//    {
	//        "success": true,
	//        "ret_msg": '',
...
func NewApex(userConfig map[string]any) *Apex {
	p := newApex()
	p.Init(userConfig)
	return p
}

func (this *Apex) Init(userConfig map[string]any) {
