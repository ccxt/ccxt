...
func (this *Htx) HandleOrderBook(client any, message map[string]any) {
	...
	if !(ccxt.InOp(this.Orderbooks, symbol)) {
		...
		var sizeParts []string = strings.Split(*size, "_")
...
func (this *Htx) GetOrderChannelAndMessageHash(typeVar any, subType any, optionalArgs ...any) any {
	...
	params = ccxt.MapTyped(this.Omit(params, "orderType"))
	...
	if ccxt.IsEqual(subType, "linear") {
		...
		if marketCode != nil {
			messageHash = ccxt.Add(messageHash, "."+*marketCode)
			channel = messageHash
		} else {
...
func (this *Htx) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	if typeSide != nil {
		if func() int {
			...
			typeSideParts = strings.Split(*typeSide, "-")
...
func (this *Htx) ParseOrderTrade(trade map[string]any, optionalArgs ...any) any {
	...
	if aggressor != nil {
		takerOrMaker = ccxt.SafeStringPtr(func() string {
			if aggressor != nil && *aggressor == true {
				return "taker"
			}
			return "maker"
		}())
...
func (this *Htx) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if !ccxt.IsEqual(market, nil) {
		...
		var subTypeparamsVariable []any = this.HandleOptionStringAndParams(params, "watchPositions", "subType", subType)
...
func (this *Htx) HandlePositions(client any, message any) {
	...
	for i := 0; i < len(rawPositions); i++ {
		...
		retRes178612 := func() any {
			if marginMode == nil {
				return nil
			}
			return positionsByMarginMode[*marginMode]
		}()
		ccxt.AppendToArray(&retRes178612, position)
...
func (this *Htx) HandleBalance(client any, message any) {
	...
	if channel != nil {
		...
		if ccxt.IsEqual(subscription, nil) {
			...
			messageHash = ccxt.Add(messageHash, "."+strings.ToLower(*currencyId))
			subscription = this.SafeDict(client.(ccxt.ClientInterface).GetSubscriptions(), messageHash)
		}
...
func (this *Htx) HandleSubject(client any, message any) {
	...
	var privateParts []string = strings.Split(*ch, "#")
...
func (this *Htx) HandleMyTrade(client any, message any, optionalArgs ...any) {
	...
	//     }
	//
	var extendParams map[string]any = ccxt.GetArgMap(optionalArgs, 0, map[string]any{})
	_ = extendParams
	...
	if messageHash != nil {
		...
		if !ccxt.IsEqual(data, nil) {
			...
			if (messageHash != nil && *messageHash == "trade") && (contractCode != nil) {
				var specificMessageHash string = *messageHash + "." + strings.ToLower(*contractCode)
			...
			var tradesHash string = *messageHash + ":" + "trade"
...
func (this *Htx) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	if orderType != nil {
		orderTypeParts = strings.Split(*orderType, "-")
...
func (this *Htx) GetUrlByMarketType(typeVar any, optionalArgs ...any) any {
	...
	_ = isPrivate
	var isFeed bool = ccxt.GetArgBool(optionalArgs, 2, false)
	_ = isFeed
	var isV5 bool = ccxt.GetArgBool(optionalArgs, 3, false)
	_ = isV5
...
func (this *Htx) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	var relativePath string = strings.Replace(*url, "wss://"+*hostname, "", 1)
