 ...
 */
func (this *Htx) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchTickerBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Htx) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
 ...
 */
func (this *Htx) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOrderBookBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Htx) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Htx) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	trades = (<-this.SubscribePrivateAsync(channel, messageHash, typeVar, subType, params, subscriptionParams))
	ccxt.PanicOnError(trades)
...
func (this *Htx) GetV5LinearChannelAndMessageHash(topic any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
	params := ccxt.GetArg(optionalArgs, 1, map[string]any{})
	_ = params
...
func (this *Htx) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes99812 := (<-this.LoadMarketsAsync())
...
func (this *Htx) ParseWsOrder(order any, optionalArgs ...any) any {
	//
	// spot
	//
	//     {
...
func (this *Htx) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes159712 := (<-this.LoadMarketsAsync())
...
func (this *Htx) HandleSubscriptionStatus(client any, message any) {
	//
	//     {
	//         "id": 1583414227,
	//         "status": "ok",
...
func (this *Htx) HandleSubject(client any, message any) {
	// spot
	//     {
	//         "ch": "market.btcusdt.mbp.150",
	//         "ts": 1583472025885,
...

	{
		func(this *Htx) (ret_ any) {
			...
			if ccxt.IsTrue(!ccxt.IsEqual(ping, nil)) {
				...
				retRes236116 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
					"pong": ping,
				}))
			...
			if ccxt.IsTrue(ccxt.IsEqual(action, "ping")) {
				...
				retRes236816 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
					"action": "pong",
					"data": map[string]any{
						"ts": pingTs,
					},
			...
			if ccxt.IsTrue(ccxt.IsEqual(op, "ping")) {
				...
				retRes237416 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any{
					"op": "pong",
					"ts": pingTs,
				}))
...
func (this *Htx) HandlePing(client any, message any) {
	this.Spawn(this.PongAsync, client, message)
}
func (this *Htx) HandleAuthenticate(client any, message any) {
	//
	// spot
	//
	//     {
...
func (this *Htx) HandleErrorMessage(client any, message any) any {
	//
	//     {
	//         "action": "sub",
	//         "code": 2002,
...
func (this *Htx) HandleMessage(client any, message any) {
...
func (this *Htx) HandleMyTrade(client any, message any, optionalArgs ...any) {
	//
	// spot
	//
	//     {
...
func (this *Htx) ParseWsTrade(trade any, optionalArgs ...any) any {
	// spot private
	//
	//     {
	//         "eventType":"trade",
...
func (this *Htx) subscribePrivateBody(ch chan any, channel any, messageHash any, typeVar any, subtype any, optionalArgs ...any) any {
	...
	retRes29368 := (<-this.AuthenticateAsync(authParams))
