...
func (this *Coinbase) subscribeBody(ch chan any, name string, isPrivate any, optionalArgs ...any) any {
	...
	if ccxt.IsArray(symbol) {
		var symbols []string = this.MarketSymbols(symbol)
		...
		messageHash = ccxt.Add(ccxt.Add(messageHash, "::"), strings.Join(symbols, ","))
	} else if symbol != nil {
...
func (this *Coinbase) unSubscribeBody(ch chan any, topic string, name string, isPrivate any, optionalArgs ...any) any {
	...
	if ccxt.IsArray(symbol) {
		...
		watchMessageHash = ccxt.Add(ccxt.Add(watchMessageHash, "::"), strings.Join(symbols, ","))
		unWatchMessageHash = ccxt.Add(ccxt.Add(unWatchMessageHash, "::"), strings.Join(symbols, ","))
	} else if symbol != nil {
		market = this.Market(symbol)
