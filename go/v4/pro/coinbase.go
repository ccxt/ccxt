...
func (this *CoinbaseCore) Subscribe(name any, isPrivate any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes10115 := (<-this.Watch(url, messageHash, subscribe, messageHash))
...
func (this *CoinbaseCore) UnSubscribe(topic any, name any, isPrivate any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes11712 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes11712)
		}
...
func (this *CoinbaseCore) SubscribeMultiple(name any, isPrivate any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20115 := (<-this.WatchMultiple(url, messageHashes, subscribe, messageHashes))
...
func (this *CoinbaseCore) WatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes29812 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes29812)
		}
		var name any = "ticker"

		retRes30115 := (<-this.Subscribe(name, false, symbol, params))
...
func (this *CoinbaseCore) UnWatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31815 := (<-this.UnSubscribe("ticker", name, false, symbol))
...
func (this *CoinbaseCore) UnWatchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes35912 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes35912)
		}
		if ccxt.IsTrue(ccxt.IsEqual(symbols, nil)) {
			symbols = this.Symbols
		}

		retRes36415 := (<-this.UnSubscribeMultiple("ticker", "ticker_batch", false, symbols))
...
func (this *CoinbaseCore) WatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes54512 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes54512)
		}
...
func (this *CoinbaseCore) UnWatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes56712)
		}
		var name any = "market_trades"

		retRes57015 := (<-this.UnSubscribe("trades", name, false, symbol))
...
func (this *CoinbaseCore) UnWatchTradesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes61215 := (<-this.UnSubscribeMultiple("trades", name, false, symbols, params))
...
func (this *CoinbaseCore) UnWatchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes65215 := (<-this.UnSubscribe("orders", name, true, this.Symbol(symbol)))
		ccxt.PanicOnError(retRes65215)
		ch <- retRes65215
		return nil
...
func (this *CoinbaseCore) UnWatchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes69115 := (<-this.UnSubscribe("orderbook", name, false, symbol))
