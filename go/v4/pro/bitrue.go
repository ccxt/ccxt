...
func (this *Bitrue) ParseWsOrder(order any, optionalArgs ...any) any {
	//
	//    {
	//        "e": "ORDER",
	//        "i": 16122802798,
	...
	// 1: buy
	// 2: sell
	var side string = ccxt.Ternary((sideId != nil && *sideId == 1), "buy", "sell").(string)
...
func (this *Bitrue) WatchOrderBookAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Bitrue) FindSwapMarketByWsBaseQuote(wsBaseQuote any) any {
...
func (this *Bitrue) ConvertFromRawQuantity(symbol any, rawQuantity any) any {
...
func (this *Bitrue) ParseWsTrade(trade any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
	var symbol any = ccxt.GetValue(market, "symbol")
 ...
 */
func (this *Bitrue) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Bitrue) ParseWsOHLCV(tick any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
	var symbol any = ccxt.GetValue(market, "symbol")
 ...
 */
func (this *Bitrue) WatchTickerAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Bitrue) ParseWsTicker(tick any, market any, optionalArgs ...any) any {
	...
	var percentage any = ccxt.Ternary((rose == nil), nil, ccxt.Multiply(rose, 100))
