...
func  (this *Lbank) CheckContractMarket(market any, methodName any)  {
    ...
    if (!ccxt.IsEqual(market, nil)) && (ccxt.IsEqual(ccxt.GetValue(market, "contract"), true)) {
        panic(ccxt.NotSupported(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(this.Id, " "), methodName), "() does not support "), ccxt.GetValue(market, "type")), " markets yet")))
    }
}
/**
 * @method
...
func (this *Lbank) fetchOHLCVWsBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.IsEqual(this.Markets, nil) {
            ...
            retRes8712 := (<-this.LoadMarketsAsync())
...
func (this *Lbank) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.IsEqual(this.Markets, nil) {
            ...
            retRes12712 := (<-this.LoadMarketsAsync())
 ...
 */
func  (this *Lbank) WatchTickerAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    go this.watchTickerBody(ch, symbol, optionalArgs...)
    return ch
}
func (this *Lbank) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
    defer close(ch)
    defer ccxt.ReturnPanicError(ch)
        params := ccxt.GetArg(optionalArgs, 0, map[string]any {})
        _ = params
        if ccxt.IsEqual(this.Markets, nil) {
            ...
            retRes29312 := (<-this.LoadMarketsAsync())
...
func (this *Lbank) fetchTradesWsBody(ch chan any, symbol any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.IsEqual(this.Markets, nil) {
            ...
            retRes40412 := (<-this.LoadMarketsAsync())
...
func  (this *Lbank) ParseWsTrade(trade any, optionalArgs ...any) any  {
    ...
    var datetime any = ccxt.Ternary((!ccxt.IsEqual(timestamp, nil)), (this.Iso8601(timestamp)), (this.SafeString(trade, "TS")))
    ...
    if (secondPart != nil && *secondPart == "maker") {
        side = ccxt.Ternary((ccxt.IsEqual(side, "buy")), "sell", "buy")
    }
...
func  (this *Lbank) ParseWsOrder(order any, optionalArgs ...any) any  {
    ...
    if (rawType == nil || *rawType != "buy") && (rawType == nil || *rawType != "sell") {
        typeVar = ccxt.Ternary(((exchangeType != nil && *exchangeType == "market")), "market", "limit")
    }
...
func (this *Lbank) watchBalanceBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.IsEqual(this.Markets, nil) {
            ...
            retRes72812 := (<-this.LoadMarketsAsync())
            ccxt.PanicOnError(retRes72812)
        }
 ...
 */
func  (this *Lbank) WatchOrderBookAsync(symbol any, optionalArgs ...any) <- chan any {
    ch := make(chan any, 1)
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        var pingId *string = this.SafeString(message, "ping")
        
            {
                ...
                retRes94012 := (<-client.(ccxt.ClientInterface).SendAsync(map[string]any {
                    "action": "pong",
                    "pong": pingId,
                }))
                ccxt.PanicOnError(retRes94012)
        		    return nil
        	    }(this)
...
func (this *Lbank) authenticateBody(ch chan any, optionalArgs ...any) any {
    ...
    defer ccxt.ReturnPanicError(ch)
        ...
        if ccxt.InOp(client.(ccxt.ClientInterface).GetFutures(), messageHash) {
            ...
            retRes98812 := (<-client.(ccxt.ClientInterface).Future(messageHash))
        ...
        var future any = client.(ccxt.ClientInterface).ReusableFuture(messageHash)
        
            {
                ...
                client.(ccxt.ClientInterface).Reject(e, messageHash)
        		    ...
        		    // try block:
                            var authenticated any = this.SafeValue(client.(ccxt.ClientInterface).GetSubscriptions(), "authenticated")
        ...
        retRes10348 := <- future.(*ccxt.Future).Await()
...
func (this *Lbank) FetchTradesWs(symbol string, options ...ccxt.FetchTradesWsOptions) ([]ccxt.Trade, error) {
    ...
    res := <- this.FetchTradesWsAsync(symbol, opts.Since, opts.Limit, opts.Params)
    if ccxt.IsError(res) {
        return nil, ccxt.CreateReturnError(res)
    }
...
func (this *Lbank) FetchOrderBookWs(symbol string, options ...ccxt.FetchOrderBookWsOptions) (ccxt.OrderBook, error) {
    ...
    res := <- this.FetchOrderBookWsAsync(symbol, opts.Limit, opts.Params)
    if ccxt.IsError(res) {
