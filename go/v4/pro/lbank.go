...
func (this *Lbank) FetchTradesWs(symbol string, options ...ccxt.FetchTradesWsOptions) ([]ccxt.Trade, error) {
	...
	res := ccxt.AwaitResult(this.FetchTradesWsAsync(symbol, opts.Since, opts.Limit, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
...
func (this *Lbank) FetchOrderBookWs(symbol string, options ...ccxt.FetchOrderBookWsOptions) (ccxt.OrderBook, error) {
	...
	res := ccxt.AwaitResult(this.FetchOrderBookWsAsync(symbol, opts.Limit, opts.Params))
	if res.Err != nil {
		return ccxt.OrderBook{}, res.Err
	}
	return ccxt.NewOrderBook(res.Value), nil
}
