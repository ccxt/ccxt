...
func (this *Bingx) HandleTicker(client any, message any) {
	...
	var marketType any = func() any { if isSwap { return "swap" }; return "spot" }()
...
func (this *Bingx) ParseWsTicker(message any, optionalArgs ...any) any {
	...
	var inverse any = func() any { if (isInverse == nil) { return (ccxt.IsEqual(ccxt.GetValue(market, "inverse"), true)) }; return isInverse }()
	var baseVolumeKey any = func() any { if ccxt.EvalTruthy(inverse) { return "m" }; return "v" }()
...
func (this *Bingx) ParseWsOHLCV(ohlcv any, optionalArgs ...any) any {
	...
	var timestamp any = func() any { if isSpot { return "t" }; return "T" }()
	if ccxt.IsEqual(this.SafeBool(market, "swap"), true) {
		timestamp = func() any { if isInverse { return "t" }; return "T" }()
	}
...
func (this *Bingx) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var subscriptionHash any = func() any { if isSpot { return spotHash }; return swapHash }()
...
func (this *Bingx) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(typeVar, "swap") {
		if ccxt.IsEqual(subType, "inverse") {
			panic(ccxt.NotSupported(this.Id + " watchBalance is not supported for inverse swap markets yet"))
		}
...
func (this *Bingx) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(subType, "inverse") {
		panic(ccxt.NotSupported(this.Id + " watchPositions is not supported for inverse swap markets yet"))
	}
...
func (this *Bingx) ParseWsPosition(position any, optionalArgs ...any) any {
	...
	var collateral any = func() any { if (marginMode != nil && *marginMode == "isolated") { return this.SafeNumber(position, "iw") }; return nil }()
...
func (this *Bingx) HandleOrder(client any, message any) {
	...
	var messageHash any = func() any { if (isSpot) { return spotHash }; return swapHash }()
	client.(ccxt.ClientInterface).Resolve(stored, messageHash)
...
func (this *Bingx) HandleMessage(client any, message any) {
	...
	var dataType *string = this.SafeString(message, "dataType", "")
	if ccxt.GetIndexOf(dataType, "@depth") >= 0 {
		this.HandleOrderBook(client, message)
		return
	}
	if ccxt.GetIndexOf(dataType, "@ticker") >= 0 {
		this.HandleTicker(client, message)
		return
	}
	if ccxt.GetIndexOf(dataType, "@trade") >= 0 {
		this.HandleTrades(client, message)
		return
	}
	if ccxt.GetIndexOf(dataType, "@kline") >= 0 {
		this.HandleOHLCV(client, message)
		return
	}
	if ccxt.GetIndexOf(dataType, "executionReport") >= 0 {
		var data any = this.SafeValue(message, "data", map[string]any{})
