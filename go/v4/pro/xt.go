...
func (this *XtCore) getListenKeyBody(ch chan any, isContract any) any {
	...
	var tradeType any = ccxt.Ternary(ccxt.EvalTruthy(isContract), "contract", "spot")
...
func (this *XtCore) subscribeBody(ch chan any, name any, access any, methodName any, optionalArgs ...any) any {
	...
	var tradeType any = ccxt.Ternary(isContract, "contract", "spot")
	...
	var tail any = access
	if isContract {
		tail = ccxt.Ternary(privateAccess, "user", "market")
	}
...
func (this *XtCore) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.EvalTruthy(fetchPositionsSnapshot) && ccxt.EvalTruthy(awaitPositionsSnapshot) && ccxt.EvalTruthy(this.IsEmpty(cache)) {
...
func (this *XtCore) watchFundingRateBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var market any = this.Market(symbol)
	if !ccxt.EvalTruthy(ccxt.GetValue(market, "swap")) {
...
func (this *XtCore) HandleTicker(client any, message any) any {
	...
	if marketId != nil {
		...
		var event *string = this.SafeString(message, "event")
		var messageHashTail any = ccxt.Ternary(isSpot, "spot", "contract")
...
func (this *XtCore) HandleTickers(client any, message any) any {
	...
	var tradeType any = ccxt.Ternary((spotTest != nil), "spot", "contract")
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(messageHashes)); i++ {
		...
		if ccxt.IsGreaterThan(numTickers, 0) {
...
func (this *XtCore) HandleOHLCV(client any, message any) any {
	...
	if marketId != nil {
		...
		var tradeType any = ccxt.Ternary((ccxt.InOp(data, "q")), "spot", "contract")
...
func (this *XtCore) HandleTrade(client any, message any) any {
	...
	if marketId != nil {
		...
		var tradeType any = ccxt.Ternary((i != nil), "spot", "contract")
		var market any = this.SafeMarket(marketId, nil, nil, tradeType)
		var symbol any = ccxt.GetValue(market, "symbol")
		var event *string = this.SafeString(message, "event")
...
func (this *XtCore) ParseWsOrderTrade(trade any, optionalArgs ...any) any {
	...
	var tradeType any = ccxt.Ternary((ccxt.InOp(trade, "symbol")), "contract", "spot")
...
func (this *XtCore) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	var tradeType any = ccxt.Ternary((ccxt.InOp(order, "symbol")), "contract", "spot")
	market = this.SafeMarket(marketId, market, nil, tradeType)
...
func (this *XtCore) HandleBalance(client any, message any) {
	...
	var tradeType any = ccxt.Ternary((ccxt.InOp(data, "coin")), "contract", "spot")
...
func (this *XtCore) HandleMyTrades(client any, message any) {
	...
	if ccxt.IsEqual(tradeSymbol, nil) {
		return
	}
	var market any = this.Market(tradeSymbol)
	stored.(ccxt.Appender).Append(parsedTrade)
	var tradeType any = ccxt.Ternary(ccxt.EvalTruthy(ccxt.GetValue(market, "contract")), "contract", "spot")
...
func (this *XtCore) HandleMessage(client any, message any) {
	...
	if event != nil && *event == "pong" {
		...
		var method any = ccxt.Ternary((topic == nil), nil, this.SafeValue(methods, topic))
