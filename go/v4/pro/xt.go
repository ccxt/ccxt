...
func (this *Xt) WatchFundingRate(symbol string, options ...ccxt.WatchFundingRateOptions) (ccxt.FundingRate, error) {
	...
	res := ccxt.AwaitResult(this.WatchFundingRateAsync(symbol, opts.Params))
	if res.Err != nil {
		return ccxt.FundingRate{}, res.Err
	}
	return ccxt.NewFundingRate(res.Value), nil
}
...
func (this *Xt) UnWatchFundingRate(symbol string, options ...ccxt.UnWatchFundingRateOptions) (any, error) {
	...
	res := ccxt.AwaitResult(this.UnWatchFundingRateAsync(symbol, opts.Params))
	if res.Err != nil {
		return nil, res.Err
	}
	return res.Value, nil
