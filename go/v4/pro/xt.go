...
func (this *Xt) subscribeBody(ch chan any, name any, access any, methodName any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(privateAccess) {
		if !ccxt.IsTrue(isContract) {
			...
			ccxt.AddElementToObject(subscribe, "listenKey", (<-this.GetListenKeyAsync(isContract)))
		} else {
...
func (this *Xt) unSubscribeBody(ch chan any, messageHash any, name any, access any, methodName any, topic any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(privateAccess) {
		if !ccxt.IsTrue(isContract) {
			...
			ccxt.AddElementToObject(unsubscribe, "listenKey", (<-this.GetListenKeyAsync(isContract)))
		} else {
...
func (this *Xt) watchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes31412 := (<-this.LoadMarketsAsync())
...
func (this *Xt) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes33712 := (<-this.LoadMarketsAsync())
...
func (this *Xt) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes46812 := (<-this.LoadMarketsAsync())
...
func (this *Xt) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes49112 := (<-this.LoadMarketsAsync())
...
func (this *Xt) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes54312 := (<-this.LoadMarketsAsync())
...
func (this *Xt) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes57012 := (<-this.LoadMarketsAsync())
...
func (this *Xt) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes59812 := (<-this.LoadMarketsAsync())
...
func (this *Xt) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes62312 := (<-this.LoadMarketsAsync())
...
func (this *Xt) UnWatchFundingRate(symbol string, options ...ccxt.UnWatchFundingRateOptions) (any, error) {
	...
	res := <-this.UnWatchFundingRateAsync(symbol, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return res, nil
