...
func (this *GateCore) WatchMyLiquidations(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes167915 := (<-this.WatchMyLiquidationsForSymbols([]any{symbol}, since, limit, params))
		ccxt.PanicOnError(retRes167915)
		ch <- retRes167915
		return nil
...
func (this *GateCore) WatchMyLiquidationsForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes169712)
		}
...
func (this *GateCore) SubscribePublic(url any, messageHash any, payload any, channel any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes223215 := (<-this.Watch(url, messageHash, message, messageHash, subscription))
		ccxt.PanicOnError(retRes223215)
		ch <- retRes223215
		return nil
...
func (this *GateCore) SubscribePublicMultiple(url any, messageHashes any, payload any, channel any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes224615 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes))
		ccxt.PanicOnError(retRes224615)
		ch <- retRes224615
		return nil
...
func (this *GateCore) UnSubscribePublicMultiple(url any, topic any, symbols any, messageHashes any, subMessageHashes any, payload any, channel any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes226815 := (<-this.WatchMultiple(url, messageHashes, message, messageHashes, sub))
...
func (this *GateCore) Authenticate(url any, messageType any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(authenticated, nil)) {
			...
			retRes227819 := (<-this.RequestPrivate(url, map[string]any{}, channel, messageHash))
			ccxt.PanicOnError(retRes227819)
			ch <- retRes227819
			return nil
		}
...
func (this *GateCore) RequestPrivate(url any, reqParams any, channel any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes232115 := (<-this.Watch(url, messageHash, request, messageHash, requestId))
...
func (this *GateCore) SubscribePrivate(url any, messageHash any, payload any, channel any, params any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes236515 := (<-this.Watch(url, messageHash, message, messageHash, messageHash))
