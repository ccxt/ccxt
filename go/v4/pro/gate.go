...
func (this *Gate) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(ccxt.GetValue(market, "spot"), true) {
		...
		limit = ccxt.MathMin(limit, maxSpotLimit)
	}
	var payload any = []any{}
	var channel any = ""
	if isEuUrl {
...
func (this *Gate) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes76515 := (<-this.SubscribeWatchTickersAndBidsAsksAsync(symbols, "watchTickers", this.Extend(map[string]any{
		"method": "tickers",
	}, params)))
...
func (this *Gate) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	retRes80215 := (<-this.SubscribeWatchTickersAndBidsAsksAsync(symbols, "watchBidsAsks", this.Extend(map[string]any{
		"method": "book_ticker",
	}, params)))
...
func (this *Gate) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes95912 := (<-this.LoadMarketsAsync())
...
func (this *Gate) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes113812)
	}
	var subType any = nil
	var typeVar any = nil
...
func (this *Gate) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes123812 := (<-this.LoadMarketsAsync())
...
func (this *Gate) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		ccxt.PanicOnError(retRes137012)
	}
	var market any = nil
	symbols = this.MarketSymbols(symbols)
...
func (this *Gate) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(this.Markets, nil) {
		...
		retRes155312 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes155312)
	}
	var market any = nil
	if !ccxt.IsEqual(symbol, nil) {
