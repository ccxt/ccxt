...
func (this *Gate) fetchOpenOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes34915 []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.FetchOrdersByStatusWsAsync("open", symbol, since, limit, params))))
	ch <- ccxt.BoxAbsent(retRes34915)
	return nil
}
...
func (this *Gate) fetchClosedOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes36415 []any = ccxt.ListTyped(ccxt.PanicOnError((<-this.FetchOrdersByStatusWsAsync("finished", symbol, since, limit, params))))
...
func (this *Gate) HandleTickerAndBidAsk(objectName any, client any, message map[string]any) {
	...
	for i := 0; i < ccxt.GetArrayLength(results); i++ {
		...
		var symbol *string = ccxt.SafeStringPtr(ccxt.GetValue(parsedItem, "symbol"))
		if isTicker {
			if symbol != nil {
