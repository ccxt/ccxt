...
func (this *Gate) DescribeData() any {
 ...
 */
func (this *Gate) CreateOrderWsAsync(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Gate) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	...
	retRes1838 := (<-this.AuthenticateAsync(url, messageType))
...
func (this *Gate) createOrdersWsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	retRes2128 := (<-this.AuthenticateAsync(url, messageType))
...
func (this *Gate) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes2448 := (<-this.AuthenticateAsync(url, messageType))
	ccxt.PanicOnError(retRes2448)

	rawOrders := (<-this.RequestPrivateAsync(url, this.Extend(request, requestParams), channel))
	ccxt.PanicOnError(rawOrders)
...
func (this *Gate) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes2738 := (<-this.AuthenticateAsync(url, messageType))
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Gate) EditOrderWsAsync(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
...
func (this *Gate) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes3038 := (<-this.AuthenticateAsync(url, messageType))
...
func (this *Gate) fetchOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes3328 := (<-this.AuthenticateAsync(url, messageType))
...
func (this *Gate) fetchOpenOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes34915 := (<-this.FetchOrdersByStatusWsAsync("open", symbol, since, limit, params))
...
func (this *Gate) fetchClosedOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes36415 := (<-this.FetchOrdersByStatusWsAsync("finished", symbol, since, limit, params))
...
func (this *Gate) fetchOrdersByStatusWsBody(ch chan any, status any, optionalArgs ...any) any {
	...
	retRes3988 := (<-this.AuthenticateAsync(url, messageType))
...
func (this *Gate) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var intervalDefault string = ccxt.Ternary(isNonEuSpot, "50", "100ms").(string)
...
func (this *Gate) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes51415 := (<-this.UnSubscribePublicMultipleAsync(url, "orderbook", []any{symbol}, []any{messageHash}, []any{subMessageHash}, payload, channel, params))
...
func (this *Gate) HandleNewSpotOrderBook(client any, message any) {
	//
	//   {
	//      "channel":"spot.obu",
	//      "result":{
...
func (this *Gate) HandleOrderBook(client any, message any) {
	//
	// spot
	//
	//     {
...
func (this *Gate) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes76015 := (<-this.SubscribeWatchTickersAndBidsAsksAsync(symbols, "watchTickers", this.Extend(map[string]any{
		"method": "tickers",
	}, params)))
...
func (this *Gate) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	retRes79715 := (<-this.SubscribeWatchTickersAndBidsAsksAsync(symbols, "watchBidsAsks", this.Extend(map[string]any{
		"method": "book_ticker",
	}, params)))
...
func (this *Gate) subscribeWatchTickersAndBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	var channelNameparamsVariable []any = this.HandleOptionAndParams(params, callerMethodName, "method")
	...
	var prefix string = ccxt.Ternary(isWatchTickers, "ticker", "bidask").(string)
...
func (this *Gate) HandleTickerAndBidAsk(objectName any, client any, message any) {
	...
	var marketType string = ccxt.Ternary((rawMarketType != nil && *rawMarketType == "futures"), "contract", "spot").(string)
...
func (this *Gate) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes90315 := (<-this.WatchTradesForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Gate) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes96915 := (<-this.UnSubscribePublicMultipleAsync(url, "trades", symbols, messageHashes, subMessageHashes, marketIds, channel, params))
...
func (this *Gate) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes98115 := (<-this.UnWatchTradesForSymbolsAsync([]any{symbol}, params))
...
func (this *Gate) HandleOHLCV(client any, message any) {
	...
	var channelParts []string = ccxt.Split(channel, ".")
	var rawMarketType *string = this.SafeString(channelParts, 0)
	var marketType string = ccxt.Ternary((rawMarketType != nil && *rawMarketType == "spot"), "spot", "contract").(string)
	var result any = this.SafeValue(message, "result")
	if !ccxt.IsArray(result) {
		result = []any{result}
	}
...
func (this *Gate) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes125215 := (<-this.SubscribePrivateAsync(url, messageHash, nil, channel, params, requiresUid))
...
func (this *Gate) HandleOrder(client any, message any) {
	...
	var hashPrefix string = ccxt.Ternary(isTrigger, "triggerOrders", "orders").(string)
...
func (this *Gate) watchMyLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes169815 := (<-this.WatchMyLiquidationsForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Gate) ParseWsLiquidation(liquidation any, optionalArgs ...any) any {
	//
	// future / delivery
	//    {
	//        "entry_price": 209,
...
func (this *Gate) HandleSubscriptionStatus(client any, message any) {
	var channel *string = this.SafeString(message, "channel")
...
func (this *Gate) HandleUnSubscribe(client any, message any) {
	//
	// {
	//     "time":1725534679,
...
func (this *Gate) HandleMessage(client any, message any) {
	//
	// subscribe
	//    {
	//        "time": 1649062304,
...
func (this *Gate) GetMarketTypeByUrl(url any) any {
...
func (this *Gate) authenticateBody(ch chan any, url any, messageType any) any {
	...
	if ccxt.IsEqual(authenticated, nil) {
		...
		retRes229919 := (<-this.RequestPrivateAsync(url, map[string]any{}, channel, messageHash))
