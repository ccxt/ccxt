...
func (this *Blofin) watchOrdersForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	var channel string = ccxt.Ternary((ccxt.IsEqual(trigger, true)), "orders-algo", "orders").(string)
...
func (this *Blofin) watchMultipleWrapperBody(ch chan any, isPublic any, channelName any, callerMethodName any, optionalArgs ...any) any {
	...
	var privateOrPublic string = ccxt.Ternary(ccxt.EvalTruthy(isPublic), "public", "private").(string)
...
func (this *Blofin) WatchOrdersForSymbols(symbols []string, options ...ccxt.WatchOrdersForSymbolsOptions) ([]ccxt.Order, error) {
	...
	res := <-this.WatchOrdersForSymbolsAsync(symbols, opts.Since, opts.Limit, opts.Params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewOrderArray(res), nil
