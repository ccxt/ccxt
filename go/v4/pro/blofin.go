...
func (this *BlofinCore) watchOrdersForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	var channel any = ccxt.Ternary((ccxt.IsEqual(trigger, true)), "orders-algo", "orders")
...
func (this *BlofinCore) HandleMessage(client any, message any) {
	...
	if ccxt.IsEqual(message, "pong") {
		...
		if (ccxt.IsEqual(method, nil)) && (ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(channelName, "candle"), 0)) {
