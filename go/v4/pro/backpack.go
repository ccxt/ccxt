	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(messageHashes)); i++ {
		...
		if ccxt.IsTrue(ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(messageHash, "ticker"), 0)) {
			...
			if ccxt.IsTrue(ccxt.IsEqual(messageHash, "unsubscribe:orders")) {
				...
				if ccxt.IsTrue(ccxt.IsTrue((!ccxt.IsEqual(this.Orders, nil))) && ccxt.IsTrue((ccxt.InOp(this.Orders, symbol)))) {
...
func (this *BackpackCore) WatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19115 := (<-this.WatchPublic([]any{topic}, []any{messageHash}, params))
...
func (this *BackpackCore) UnWatchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20415 := (<-this.UnWatchTickers([]any{symbol}, params))
...
func (this *BackpackCore) WatchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes2298 := (<-this.WatchPublic(topics, messageHashes, params))
...
func (this *BackpackCore) UnWatchTickers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			retRes24412 := (<-this.LoadMarkets())
			ccxt.PanicOnError(retRes24412)
		}
		symbols = this.MarketSymbols(symbols, nil, false)
		var topics any = []any{}
		var messageHashes any = []any{}
		...
		retRes25515 := (<-this.WatchPublic(topics, messageHashes, params, true))
...
func (this *BackpackCore) WatchBidsAsks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes3548 := (<-this.WatchPublic(topics, messageHashes, params))
...
func (this *BackpackCore) UnWatchBidsAsks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes37915 := (<-this.WatchPublic(topics, messageHashes, params, true))
...
func (this *BackpackCore) UnWatchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes47115 := (<-this.UnWatchOHLCVForSymbols([]any{[]any{symbol, timeframe}}, params))
...
func (this *BackpackCore) UnWatchOHLCVForSymbols(symbolsAndTimeframes any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes54015 := (<-this.WatchPublic(topics, messageHashes, params, true))
...
func (this *BackpackCore) WatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes62415 := (<-this.WatchTradesForSymbols([]any{symbol}, since, limit, params))
...
func (this *BackpackCore) UnWatchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes63715 := (<-this.UnWatchTradesForSymbols([]any{symbol}, params))
...
func (this *BackpackCore) UnWatchTradesForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes70415 := (<-this.WatchPublic(topics, messageHashes, params, true))
...
func (this *BackpackCore) WatchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes81215 := (<-this.WatchOrderBookForSymbols([]any{symbol}, limit, params))
...
func (this *BackpackCore) UnWatchOrderBook(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes85415 := (<-this.UnWatchOrderBookForSymbols([]any{symbol}, params))
...
func (this *BackpackCore) UnWatchOrderBookForSymbols(symbols any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes88115 := (<-this.WatchPublic(topics, messageHashes, params, true))
...
func (this *BackpackCore) UnWatchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes102312)
		}
		var market any = nil
		if ccxt.IsTrue(!ccxt.IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		retRes103615 := (<-this.WatchPrivate([]any{topic}, []any{messageHash}, params, true))
		ccxt.PanicOnError(retRes103615)
		ch <- retRes103615
		return nil
...
func (this *BackpackCore) WatchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
			...
			ccxt.PanicOnError(retRes119212)
		}
		symbols = this.MarketSymbols(symbols)
		var messageHashes any = []any{}
		var topics any = []any{}
...
func (this *BackpackCore) UnWatchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes124015 := (<-this.WatchPrivate(topics, messageHashes, params, true))
