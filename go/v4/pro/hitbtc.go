...
func (this *Hitbtc) HandleOHLCV(client any, message map[string]any) any {
	...
	var splitChannel []string = strings.Split(*channel, "/")
...
func (this *Hitbtc) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	var trades []any = nil
	if tradeId != nil {
		var trade any = this.ParseWsOrderTrade(order, marketResolved)
		trades = []any{trade}
	}
 ...
 */
func (this *Hitbtc) CreateOrderWsAsync(symbol any, typeVar string, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Hitbtc) createOrderWsBody(ch chan any, symbol any, typeVar string, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Hitbtc) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var marketTypeparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("cancelOrderWs", market, params)
	var marketType *string = ccxt.SafeStringPtr(ccxt.GetValue(marketTypeparamsMarketTypeVariable, 0))
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(marketTypeparamsMarketTypeVariable, 1))
...
func (this *Hitbtc) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	var marketTypeparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("cancelAllOrdersWs", market, params)
	var marketType *string = ccxt.SafeStringPtr(ccxt.GetValue(marketTypeparamsMarketTypeVariable, 0))
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(marketTypeparamsMarketTypeVariable, 1))
...
func (this *Hitbtc) fetchOpenOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	var marketTypeparamsMarketTypeVariable []any = this.HandleMarketTypeAndParams("fetchOpenOrdersWs", market, params)
	var marketType *string = ccxt.SafeStringPtr(ccxt.GetValue(marketTypeparamsMarketTypeVariable, 0))
	var paramsMarketType map[string]any = ccxt.MapTyped(ccxt.GetValue(marketTypeparamsMarketTypeVariable, 1))
	...
	if !ccxt.IsEqual(error, nil) {

		{
			ret__ := func(this *Hitbtc) (ret_ any) {
				...
				var feedback *string = ccxt.SafeStringPtr(ccxt.Add(this.Id+" ", description))
