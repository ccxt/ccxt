...
func (this *Hitbtc) DescribeData() any {
...
func (this *Hitbtc) subscribePrivateBody(ch chan any, name any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes17512 := (<-this.LoadMarketsAsync())
		ccxt.PanicOnError(retRes17512)
	}

	retRes1778 := (<-this.AuthenticateAsync())
...
func (this *Hitbtc) tradeRequestBody(ch chan any, name any, optionalArgs ...any) any {
	...
	retRes2028 := (<-this.AuthenticateAsync())
...
func (this *Hitbtc) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	orderbook := (<-this.SubscribePublicAsync(name, "orderbooks", []any{symbol}, this.DeepExtend(request, params)))
...
func (this *Hitbtc) HandleDelta(bookside any, delta any) {
...
func (this *Hitbtc) HandleDeltas(bookside any, deltas any) {
...
func (this *Hitbtc) watchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes35412 := (<-this.LoadMarketsAsync())
...
func (this *Hitbtc) ParseWsTicker(ticker any, optionalArgs ...any) any {
	//
	//    {
	//        "t": 1614815872000,             // Timestamp in milliseconds
	//        "a": "0.031175",                // Best ask
...
func (this *Hitbtc) ParseWsBidAsk(ticker any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
	var timestamp any = this.SafeInteger(ticker, "t")
...
func (this *Hitbtc) ParseWsTrades(trades any, optionalArgs ...any) any {
	market := ccxt.GetArg(optionalArgs, 0, nil)
	_ = market
...
func (this *Hitbtc) ParseWsTrade(trade any, optionalArgs ...any) any {
	//
	//    {
 ...
 */
func (this *Hitbtc) WatchOHLCVAsync(symbol any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchOHLCVBody(ch, symbol, optionalArgs...)
	return ch
}
func (this *Hitbtc) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Hitbtc) ParseWsOHLCV(ohlcv any, optionalArgs ...any) any {
	//
	//    {
	//        "t": 1626860340000,             // Message timestamp
	//        "o": "30881.95",                // Open price
...
func (this *Hitbtc) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes111715 := (<-this.SubscribePrivateAsync(name, nil, this.Extend(request, params)))
 ...
 */
func (this *Hitbtc) CreateOrderWsAsync(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Hitbtc) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	...
	if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
		...
		retRes115319 := (<-this.TradeRequestAsync("futures_new_order", request))
		...
		retRes115519 := (<-this.TradeRequestAsync("margin_new_order", request))
		ccxt.PanicOnError(retRes115519)
		ch <- retRes115519
		return nil
	} else {

		retRes115719 := (<-this.TradeRequestAsync("spot_new_order", request))
...
func (this *Hitbtc) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes117712 := (<-this.LoadMarketsAsync())
	...
	if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
		...
		retRes119119 := (<-this.TradeRequestAsync("futures_cancel_order", request))
		ccxt.PanicOnError(retRes119119)
		ch <- retRes119119
		return nil
	} else if ccxt.IsTrue(ccxt.IsTrue((ccxt.IsEqual(marketType, "margin"))) || ccxt.IsTrue((!ccxt.IsEqual(marginMode, nil)))) {

		retRes119319 := (<-this.TradeRequestAsync("margin_cancel_order", request))
		ccxt.PanicOnError(retRes119319)
		ch <- retRes119319
		return nil
	} else {

		retRes119519 := (<-this.TradeRequestAsync("spot_cancel_order", request))
...
func (this *Hitbtc) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
		...
		retRes122819 := (<-this.TradeRequestAsync("spot_cancel_orders", params))
...
func (this *Hitbtc) fetchOpenOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes124912 := (<-this.LoadMarketsAsync())
	...
	if ccxt.IsTrue(ccxt.IsEqual(marketType, "swap")) {
		...
		retRes126419 := (<-this.TradeRequestAsync("margin_get_orders", request))
		ccxt.PanicOnError(retRes126419)
		ch <- retRes126419
		return nil
	} else {

		retRes126619 := (<-this.TradeRequestAsync("spot_get_orders", request))
...
func (this *Hitbtc) HandleOrderRequest(client any, message any) any {
	//
...
func (this *Hitbtc) HandleMessage(client any, message any) {
...
func (this *Hitbtc) HandleAuthenticate(client any, message any) any {
	//
	//    {
	//        "jsonrpc": "2.0",
	//        "result": true
...
func (this *Hitbtc) HandleError(client any, message any) any {
	//
	//    {
	//        jsonrpc: '2.0',
	//        error: {
...
func (this *Hitbtc) FetchOpenOrdersWs(options ...ccxt.FetchOpenOrdersWsOptions) ([]ccxt.Order, error) {
	...
	var params = opts.Params
	res := <-this.FetchOpenOrdersWsAsync(symbol, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewOrderArray(res), nil
