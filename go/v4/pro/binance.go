...
func (this *Binance) GetStockUnifiedSymbol(stockSymbol any, optionalArgs ...any) any {
	...
	if (parsed != nil) && (ccxt.IsGreaterThanOrEqual(ccxt.GetIndexOf(parsed, "/"), 0)) {
		return parsed
	}
...
func (this *Binance) HandleOrderBook(client any, message any) {
	...
	var marketType string = ccxt.Ternary(ccxt.EvalTruthy(isSpot), "spot", "swap").(string)
...
func (this *Binance) ParseWsTrade(trade any, optionalArgs ...any) any {
	...
	var fallbackType string = ccxt.Ternary((ccxt.InOp(trade, "ps")), "contract", "spot").(string)
...
func (this *Binance) HandleTrade(client any, message any) {
	...
	var isSpot any = this.IsSpotUrl(client)
	var marketType string = ccxt.Ternary(ccxt.EvalTruthy(isSpot), "spot", "contract").(string)
	var market any = this.SafeMarket(marketId, nil, nil, marketType)
	var symbol any = ccxt.GetValue(market, "symbol")
...
func (this *Binance) HandleOHLCV(client any, message any) {
	...
	if ccxt.IsEqual(stored, nil) {
		...
		if (symbol != nil) && !ccxt.IsEqual(unifiedTimeframe, nil) {
...
func (this *Binance) watchMultiTickerHelperBody(ch chan any, methodName any, channelName any, optionalArgs ...any) any {
	...
	if isMarkPrice && !isOptionMarkPrice {
		suffix = ccxt.Ternary((use1sFreq != nil && *use1sFreq == true), "@1s", "")
	}
...
func (this *Binance) HandleTickersAndBidsAsks(client any, message any, methodType any) {
	...
	for i := 0; ccxt.IsLessThan(i, ccxt.GetArrayLength(rawTickers)); i++ {
		...
		var isSpot any = this.IsSpotUrl(client)
		var tickerFallbackType string = ccxt.Ternary(ccxt.EvalTruthy(isSpot), "spot", "contract").(string)
...
func (this *Binance) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	var isPortfolioMarginparamsVariable []any = this.HandleOptionAndParams2(params, "authenticate", "papi", "portfolioMargin", false)
	...
	var lastAuthenticatedTime *int64 = this.SafeInteger(options, "lastAuthenticatedTime", 0)
	var refreshRateKey string = ccxt.Ternary(isStock, "stockListenKeyRefreshRate", "listenKeyRefreshRate").(string)
...
func (this *Binance) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	if (ccxt.IsEqual(typeVar, "spot")) || (ccxt.IsEqual(typeVar, "margin")) {
		...
		if ccxt.EvalTruthy(isPortfolioMargin) {
			...
			if (demoMode != nil && *demoMode == true) || ccxt.EvalTruthy(this.IsSandboxModeEnabled) {
...
func (this *Binance) HandleBalance(client any, message any) {
	...
	if event != nil && *event == "balanceUpdate" {
		...
		if (!ccxt.IsEqual(accountType, nil)) && (code != nil) && (ccxt.InOp(ccxt.GetValue(this.Balance, accountType), code)) {
...
func (this *Binance) ParseWsOrder(order any, optionalArgs ...any) any {
	...
	var marketType string = ccxt.Ternary((ccxt.InOp(order, "ps")), "contract", "spot").(string)
	var symbol *string = this.SafeSymbol(marketId, nil, nil, marketType)
