...
func (this *Binance) watchLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if this.IsEmpty(symbols) {
		...
		for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
			...
			subscriptionHashes = append(subscriptionHashes, ccxt.Add(ccxt.GetValue(market, "lowercaseId"), "@forceOrder"))
...
func (this *Binance) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	params = ccxt.SafeMapTyped(typeVarsubTypeparamsVariable, 2)
...
func (this *Binance) watchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	params = ccxt.SafeMapTyped(watchOrderBookRateparamsVariable, 1)
	var rpi any = nil
	...
	params = ccxt.SafeMapTyped(rpiparamsVariable, 1)
...
func (this *Binance) fetchOrderBookWsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = ccxt.SafeMapTyped(returnRateLimitsparamsVariable, 1)
...
func (this *Binance) HandleOrderBookSubscription(client any, message any, subscription any) {
	...
	var symbols any = this.SafeList(subscription, "symbols", []any{symbolOfSubscription}) // watchOrderBookForSymbols
	var limit *int64 = this.SafeInteger(subscription, "limit", defaultLimit)
...
func (this *Binance) watchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = ccxt.SafeMapTyped(stockparamsVariable, 1)
...
func (this *Binance) watchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	if ccxt.EvalTruthy(stock) {
		...
		for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
			...
			stockMessageHashes = append(stockMessageHashes, ccxt.Add(ccxt.Add(ccxt.Add("ohlcv::", ccxt.GetValue(stockMarket, "symbol")), "::"), stockTimeframeString))
		}
	...
	params = ccxt.SafeMapTyped(klineTypeparamsVariable, 1)
	...
	params = ccxt.SafeMapTyped(timezoneparamsVariable, 1)
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		messageHashes = append(messageHashes, ccxt.Add(ccxt.Add(ccxt.Add("ohlcv::", ccxt.GetValue(market, "symbol")), "::"), timeframeString))
	}
...
func (this *Binance) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		rawHashes = append(rawHashes, ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(marketId, "@"), klineType), "_"), interval), utcSuffix))
		subMessageHashes = append(subMessageHashes, ccxt.Add(ccxt.Add(ccxt.Add("ohlcv::", ccxt.GetValue(market, "symbol")), "::"), timeframeString))
		messageHashes = append(messageHashes, ccxt.Add(ccxt.Add(ccxt.Add("unsubscribe::ohlcv::", ccxt.GetValue(market, "symbol")), "::"), timeframeString))
	}
	var url any = ccxt.Add(ccxt.Add(this.GetWsUrl(wsUrlType, this.GetFutureWsCategory(klineType)), "/"), this.Stream(wsUrlType, "multipleOHLCV"))
	var requestId any = this.RequestId(url)
	var request map[string]any = map[string]any{
...
func (this *Binance) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	params = ccxt.SafeMapTyped(isPortfolioMarginparamsVariable, 1)
...
func (this *Binance) HandleMessage(client any, message any) {
	...
	var id *string = this.SafeString(message, "id")
	var subscriptions any = this.SafeDict(client.(ccxt.ClientInterface).GetSubscriptions(), id)
