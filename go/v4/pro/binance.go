...
func (this *Binance) watchLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes36615 := (<-this.WatchLiquidationsForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Binance) watchMyLiquidationsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes59515 := (<-this.WatchMyLiquidationsForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Binance) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	retRes6308 := (<-this.AuthenticateAsync(this.Extend(map[string]any{
		"type":    typeVar,
		"subType": subType,
	}, params)))
...
func (this *Binance) watchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes72715 := (<-this.WatchOrderBookForSymbolsAsync([]any{symbol}, limit, params))
...
func (this *Binance) unWatchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes88915 := (<-this.UnWatchOrderBookForSymbolsAsync([]any{symbol}, params))
...
func (this *Binance) fetchOrderBookWsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes90512 := (<-this.LoadMarketsAsync())
...
func (this *Binance) unWatchTradesForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes132012 := (<-this.LoadMarketsAsync())
...
func (this *Binance) unWatchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes140615 := (<-this.UnWatchTradesForSymbolsAsync([]any{symbol}, params))
...
func (this *Binance) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes142615 := (<-this.WatchTradesForSymbolsAsync([]any{symbol}, since, limit, params))
...
func (this *Binance) unWatchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes177212 := (<-this.LoadMarketsAsync())
...
func (this *Binance) unWatchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes185615 := (<-this.UnWatchOHLCVForSymbolsAsync([]any{[]any{symbol, timeframe}}, params))
...
func (this *Binance) watchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	tickers := (<-this.WatchMarkPricesAsync([]any{symbol}, this.Extend(params, map[string]any{
...
func (this *Binance) unWatchTickersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes219815 := (<-this.WatchMultiTickerHelperAsync("unWatchTickers", channelName, symbols, params, true))
...
func (this *Binance) unWatchMarkPricesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes221615 := (<-this.WatchMultiTickerHelperAsync("unWatchMarkPrices", channelName, symbols, params, true))
...
func (this *Binance) unWatchMarkPriceBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes222915 := (<-this.UnWatchMarkPricesAsync([]any{symbol}, params))
...
func (this *Binance) unWatchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	retRes224315 := (<-this.WatchMultiTickerHelperAsync("unWatchBidsAsks", "bookTicker", symbols, params, true))
...
func (this *Binance) unWatchTickerBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes226115 := (<-this.UnWatchTickersAsync([]any{symbol}, params))
...
func (this *Binance) watchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes227912 := (<-this.LoadMarketsAsync())
...
func (this *Binance) WatchMultiTickerHelperAsync(methodName any, channelName any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.watchMultiTickerHelperBody(ch, methodName, channelName, optionalArgs...)
	return ch
}
func (this *Binance) watchMultiTickerHelperBody(ch chan any, methodName any, channelName any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
	symbols := ccxt.GetArg(optionalArgs, 0, nil)
	_ = symbols
...
func (this *Binance) renewListenTokenBody(ch chan any, optionalArgs ...any) any {
	...
	retRes29908 := (<-this.EnsureUserDataStreamWsSubscribeListenTokenAsync(typeVar, renewParams))
...
func (this *Binance) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(typeVar, "spot")) {
		...
		retRes300212 := (<-this.EnsureUserDataStreamWsSubscribeSignatureAsync("spot"))
	...
	if ccxt.IsTrue(ccxt.IsTrue(ccxt.IsEqual(typeVar, "margin")) || ccxt.IsTrue(isIsolatedMargin)) {
		...
		retRes301812 := (<-this.EnsureUserDataStreamWsSubscribeListenTokenAsync("margin", marginParams))
...
func (this *Binance) fetchBalanceWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes326312 := (<-this.LoadMarketsAsync())
...
func (this *Binance) fetchPositionWsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes337015 := (<-this.FetchPositionsWsAsync([]any{symbol}, params))
...
func (this *Binance) fetchPositionsWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes338712 := (<-this.LoadMarketsAsync())
...
func (this *Binance) watchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes34918 := (<-this.AuthenticateAsync(this.Extend(map[string]any{
		"type":    typeVar,
		"subType": subType,
	}, params)))
...
func (this *Binance) ResolveAuthType(methodName any, optionalArgs ...any) any {
 ...
 */
func (this *Binance) CreateOrderWsAsync(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Binance) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
 ...
 * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
 */
func (this *Binance) EditOrderWsAsync(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.editOrderWsBody(ch, id, symbol, typeVar, side, optionalArgs...)
	return ch
}
func (this *Binance) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Binance) fetchClosedOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	orders := (<-this.FetchOrdersWsAsync(symbol, since, limit, params))
	ccxt.PanicOnError(orders)
...
func (this *Binance) watchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes49808 := (<-this.AuthenticateAsync(this.Extend(marketTypeObject, params)))
...
func (this *Binance) fetchMyTradesWsBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes524312 := (<-this.LoadMarketsAsync())
...
func (this *Binance) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsTrue(ccxt.IsEqual(this.Markets, nil)) {
		...
		retRes539612 := (<-this.LoadMarketsAsync())
	...
	retRes54138 := (<-this.AuthenticateAsync(this.Extend(map[string]any{
		"type":    typeVar,
		"subType": subType,
	}, params)))
...
func (this *Binance) WatchMyLiquidations(symbol string, options ...ccxt.WatchMyLiquidationsOptions) ([]ccxt.Liquidation, error) {
	...
	var params = opts.Params
	res := <-this.WatchMyLiquidationsAsync(symbol, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewLiquidationArray(res), nil
...
func (this *Binance) FetchPositionWs(symbol string, options ...ccxt.FetchPositionWsOptions) ([]ccxt.Position, error) {
	...
	var params = opts.Params
	res := <-this.FetchPositionWsAsync(symbol, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
...
func (this *Binance) FetchPositionsWs(options ...ccxt.FetchPositionsWsOptions) ([]ccxt.Position, error) {
	...
	var params = opts.Params
	res := <-this.FetchPositionsWsAsync(symbols, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewPositionArray(res), nil
...
func (this *Binance) FetchClosedOrdersWs(options ...ccxt.FetchClosedOrdersWsOptions) ([]ccxt.Order, error) {
	...
	var params = opts.Params
	res := <-this.FetchClosedOrdersWsAsync(symbol, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewOrderArray(res), nil
