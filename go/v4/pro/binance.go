...
func (this *Binance) HandleLiquidation(client any, message map[string]any) {
	...
	//    }
	//
	var rawLiquidation any = this.SafeDict(message, "o", map[string]any{})
...
func (this *Binance) watchMyLiquidationsForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	if !this.IsEmpty(symbols) {
		for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
			...
			messageHashes = append(messageHashes, ccxt.Add("myLiquidations::", symbol))
		}
	}
	var typeVar any = nil
	var subType any = nil
...
func (this *Binance) unWatchOrderBookForSymbolsBody(ch chan any, symbols any, optionalArgs ...any) any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbols); i++ {
		var symbol any = ccxt.GetValue(symbols, i)
		var market map[string]any = ccxt.MapTyped(this.Market(symbol))
		subMessageHashes = append(subMessageHashes, ccxt.Add("orderbook::", symbol))
		messageHashes = append(messageHashes, ccxt.Add("unsubscribe:orderbook:", symbol))
		var streamId any = market["lowercaseId"]
...
func (this *Binance) watchOHLCVForSymbolsBody(ch chan any, symbolsAndTimeframes any, optionalArgs ...any) any {
	...
	if stock {
		...
		for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
			...
			var stockTimeframeString any = func() any {
	...
	for i := 0; i < ccxt.GetArrayLength(symbolsAndTimeframes); i++ {
		...
		var marketId any = market["lowercaseId"]
		if marketId == nil {
		...
		rawHashes = append(rawHashes, ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(ccxt.Add(marketId, "@"), klineType), "_"), interval), utcSuffix))
...
func (this *Binance) fetchBalanceWsBody(ch chan any, optionalArgs ...any) any {
	...
	var subscription map[string]any = map[string]any{
		"method": func() any {
			if ccxt.IsEqual(method, "account.status") {
...
func (this *Binance) HandleStockPrice(client any, message map[string]any) {
	...
	for i := 0; i < ccxt.GetArrayLength(rates); i++ {
