 ...
 */
func (this *Bitvavo) CreateOrderWsAsync(symbol any, typeVar string, side any, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderWsBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Bitvavo) createOrderWsBody(ch chan any, symbol any, typeVar string, side any, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ccxt.ReturnPanicError(ch)
...
func (this *Bitvavo) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	var paramsOperatorId map[string]any = ccxt.MapTyped(ccxt.GetValue(operatorIdparamsOperatorIdVariable, 1))
...
func (this *Bitvavo) withdrawWsBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	tagWithdrawTag := ccxt.GetValue(tagWithdrawTagparamsWithdrawTagVariable, 0)
	var paramsWithdrawTag map[string]any = ccxt.MapTyped(ccxt.GetValue(tagWithdrawTagparamsWithdrawTagVariable, 1))
