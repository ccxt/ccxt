...
func (this *Bitvavo) watchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	trades := (<-this.WatchPublicAsync("trades", symbol, params))
...
func (this *Bitvavo) watchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes10308 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) createOrderWsBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes10818 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) editOrderWsBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes11048 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) cancelOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes11238 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) cancelAllOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes11418 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) fetchOrderWsBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes11968 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) fetchOpenOrdersWsBody(ch chan any, optionalArgs ...any) any {
	...
	orders := (<-this.WatchRequestAsync("privateGetOrdersOpen", this.Extend(request, params)))
	ccxt.PanicOnError(orders)
...
func (this *Bitvavo) withdrawWsBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	retRes13448 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) fetchWithdrawalsWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes13838 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes13838)
	var request any = this.FetchWithdrawalsRequest(code, since, limit, params)

	withdraws := (<-this.WatchRequestAsync("privateGetWithdrawalHistory", request))
...
func (this *Bitvavo) fetchOHLCVWsBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	ohlcv := (<-this.WatchRequestAsync(action, request))
	ccxt.PanicOnError(ohlcv)
...
func (this *Bitvavo) fetchDepositsWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes14508 := (<-this.AuthenticateAsync())
	ccxt.PanicOnError(retRes14508)
	var request any = this.FetchDepositsRequest(code, since, limit, params)

	deposits := (<-this.WatchRequestAsync("privateGetDepositHistory", request))
...
func (this *Bitvavo) fetchTradingFeesWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes14908 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) fetchBalanceWsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes15798 := (<-this.AuthenticateAsync())
...
func (this *Bitvavo) FetchOrdersWs(options ...ccxt.FetchOrdersWsOptions) ([]ccxt.Order, error) {
	...
	var params = opts.Params
	res := <-this.FetchOrdersWsAsync(symbol, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewOrderArray(res), nil
...
func (this *Bitvavo) FetchMyTradesWs(options ...ccxt.FetchMyTradesWsOptions) ([]ccxt.Trade, error) {
	...
	var params = opts.Params
	res := <-this.FetchMyTradesWsAsync(symbol, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewTradeArray(res), nil
...
func (this *Bitvavo) WithdrawWs(code string, amount float64, address string, options ...ccxt.WithdrawWsOptions) (ccxt.Transaction, error) {
	...
	var params = opts.Params
	res := <-this.WithdrawWsAsync(code, amount, address, tag, params)
	if ccxt.IsError(res) {
...
func (this *Bitvavo) FetchWithdrawalsWs(options ...ccxt.FetchWithdrawalsWsOptions) ([]ccxt.Transaction, error) {
	...
	var params = opts.Params
	res := <-this.FetchWithdrawalsWsAsync(code, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
...
func (this *Bitvavo) FetchOHLCVWs(symbol string, options ...ccxt.FetchOHLCVWsOptions) ([]ccxt.OHLCV, error) {
	...
	var params = opts.Params
	res := <-this.FetchOHLCVWsAsync(symbol, timeframe, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewOHLCVArray(res), nil
...
func (this *Bitvavo) FetchDepositsWs(options ...ccxt.FetchDepositsWsOptions) ([]ccxt.Transaction, error) {
	...
	var params = opts.Params
	res := <-this.FetchDepositsWsAsync(code, since, limit, params)
	if ccxt.IsError(res) {
		return nil, ccxt.CreateReturnError(res)
	}
	return ccxt.NewTransactionArray(res), nil
