...
func (this *Bitvavo) HandleBidAsk(client any, message map[string]any) {
	...
	for i := 0; i < len(tickers); i++ {
		...
		result = append(result, ticker)
		var messageHash *string = ccxt.SafeStringPtr(ccxt.Add(event+":", symbol))
		client.(ccxt.ClientInterface).Resolve(ticker, messageHash)
	}
	client.(ccxt.ClientInterface).Resolve(result, event)
}
...
func (this *Bitvavo) watchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var messageHash *string = ccxt.SafeStringPtr(ccxt.Add("order:", symbol))
	var request map[string]any = map[string]any{
		"action": "subscribe",
		"channels": []any{map[string]any{
			"name":    name,
...
func (this *Bitvavo) RequestId() int64 {
	var ts string = strconv.FormatInt(this.Milliseconds(), 10)
...
func (this *Bitvavo) authenticateBody(ch chan any, optionalArgs ...any) any {
	...
	if ccxt.IsEqual(future, nil) {
		...
		var stringTimestamp string = strconv.FormatInt(timestamp, 10)
