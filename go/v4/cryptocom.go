...
func  (this *cryptocom) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes384754 := (<-this.LoadMarkets())
            PanicOnError(retRes384754)
...
func  (this *cryptocom) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes431099 := (<-this.LoadMarkets())
            PanicOnError(retRes431099)
...
func  (this *cryptocom) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes585243 := (<-this.LoadMarkets())
            PanicOnError(retRes585243)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes617869 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes617869)
                    ch <- retRes617869
                    return nil
            }
            var market interface{} = nil
...
func  (this *cryptocom) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917196 := (<-this.LoadMarkets())
            PanicOnError(retRes917196)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes717613 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes717613)
                    ch <- retRes717613
                    return nil
            }
...
func  (this *cryptocom) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes592041 := (<-this.LoadMarkets())
            PanicOnError(retRes592041)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes763507 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes763507)
                    ch <- retRes763507
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes335886 := (<-this.LoadMarkets())
            PanicOnError(retRes335886)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes642879 := (<-this.LoadMarkets())
            PanicOnError(retRes642879)
...
func  (this *cryptocom) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes648717 := (<-this.LoadMarkets())
            PanicOnError(retRes648717)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507523 := (<-this.LoadMarkets())
            PanicOnError(retRes507523)
...
func  (this *cryptocom) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes772033 := (<-this.LoadMarkets())
            PanicOnError(retRes772033)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes139341 :=  (<-this.V1PrivatePostPrivateCancelAllOrders(this.Extend(request, params)))
                PanicOnError(retRes139341)
                ch <- retRes139341
                return nil
...
func  (this *cryptocom) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes425814 := (<-this.LoadMarkets())
            PanicOnError(retRes425814)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes459046 := (<-this.LoadMarkets())
            PanicOnError(retRes459046)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes777547 := (<-this.LoadMarkets())
            PanicOnError(retRes777547)
            var orderRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *cryptocom) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes985809 := (<-this.LoadMarkets())
            PanicOnError(retRes985809)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *cryptocom) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes458905 := (<-this.LoadMarkets())
            PanicOnError(retRes458905)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes369890 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes369890)
                    ch <- retRes369890
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *cryptocom) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes317521 := (<-this.LoadMarkets())
            PanicOnError(retRes317521)
...
func  (this *cryptocom) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621963 := (<-this.LoadMarkets())
            PanicOnError(retRes621963)
...
func  (this *cryptocom) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes609014 := (<-this.LoadMarkets())
            PanicOnError(retRes609014)
...
func  (this *cryptocom) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes783265 := (<-this.LoadMarkets())
            PanicOnError(retRes783265)
...
func  (this *cryptocom) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255359 := (<-this.LoadMarkets())
            PanicOnError(retRes255359)
            var request interface{} = map[string]interface{} {}
            var currency interface{} = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes770158 := (<-this.LoadMarkets())
            PanicOnError(retRes770158)
...
func  (this *cryptocom) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes649765 := (<-this.LoadMarkets())
            PanicOnError(retRes649765)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980892 := (<-this.LoadMarkets())
            PanicOnError(retRes980892)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes589942 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes589942)
                    ch <- retRes589942
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes596631 := (<-this.LoadMarkets())
            PanicOnError(retRes596631)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33416 := (<-this.LoadMarkets())
            PanicOnError(retRes33416)
...
func  (this *cryptocom) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568540 := (<-this.LoadMarkets())
            PanicOnError(retRes568540)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
                "type": "MARKET",
...
func  (this *cryptocom) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes254835 := (<-this.LoadMarkets())
            PanicOnError(retRes254835)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes224331 := (<-this.LoadMarkets())
            PanicOnError(retRes224331)
