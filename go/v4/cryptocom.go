...
func (this *CryptocomCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes95719 := (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
			PanicOnError(retRes95719)
			ch <- retRes95719
			return nil
		}
		var market any = nil
...
func (this *CryptocomCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes103919 := (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func (this *CryptocomCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes110119 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
...
func (this *CryptocomCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes190819 := (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
			PanicOnError(retRes190819)
			ch <- retRes190819
			return nil
		}
		var request any = map[string]any{}
...
func (this *CryptocomCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes27098 := (<-this.LoadMarkets())
		PanicOnError(retRes27098)
		var request any = map[string]any{}
		var currency any = nil
		if IsTrue(!IsEqual(code, nil)) {
			currency = this.SafeCurrency(code)
...
func (this *CryptocomCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes311419 := (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
			PanicOnError(retRes311419)
			ch <- retRes311419
			return nil
		}
		var market any = this.Market(symbol)
