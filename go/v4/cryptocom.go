...
func  (this *cryptocom) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes334256 := (<-this.LoadMarkets())
            PanicOnError(retRes334256)
...
func  (this *cryptocom) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117296 := (<-this.LoadMarkets())
            PanicOnError(retRes117296)
...
func  (this *cryptocom) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes238738 := (<-this.LoadMarkets())
            PanicOnError(retRes238738)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes579681 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes579681)
                    ch <- retRes579681
                    return nil
            }
            var market interface{} = nil
...
func  (this *cryptocom) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes355620 := (<-this.LoadMarkets())
            PanicOnError(retRes355620)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes98797 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes98797)
                    ch <- retRes98797
                    return nil
            }
...
func  (this *cryptocom) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes491960 := (<-this.LoadMarkets())
            PanicOnError(retRes491960)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes581528 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes581528)
                    ch <- retRes581528
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes517492 := (<-this.LoadMarkets())
            PanicOnError(retRes517492)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes899635 := (<-this.LoadMarkets())
            PanicOnError(retRes899635)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695806 := (<-this.LoadMarkets())
            PanicOnError(retRes695806)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes359642 := (<-this.LoadMarkets())
            PanicOnError(retRes359642)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes495412 :=  (<-this.V1PrivatePostPrivateCancelAllOrders(this.Extend(request, params)))
                PanicOnError(retRes495412)
                ch <- retRes495412
                return nil
...
func  (this *cryptocom) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes770613 := (<-this.LoadMarkets())
            PanicOnError(retRes770613)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578676 := (<-this.LoadMarkets())
            PanicOnError(retRes578676)
            var orderRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *cryptocom) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes618145 := (<-this.LoadMarkets())
            PanicOnError(retRes618145)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *cryptocom) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes391072 := (<-this.LoadMarkets())
            PanicOnError(retRes391072)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes835002 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes835002)
                    ch <- retRes835002
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *cryptocom) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153001 := (<-this.LoadMarkets())
            PanicOnError(retRes153001)
...
func  (this *cryptocom) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937065 := (<-this.LoadMarkets())
            PanicOnError(retRes937065)
...
func  (this *cryptocom) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes154 := (<-this.LoadMarkets())
            PanicOnError(retRes154)
...
func  (this *cryptocom) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes2621 := (<-this.LoadMarkets())
            PanicOnError(retRes2621)
            var currency interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes769654 := (<-this.LoadMarkets())
            PanicOnError(retRes769654)
...
func  (this *cryptocom) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes16490 := (<-this.LoadMarkets())
            PanicOnError(retRes16490)
            var request interface{} = map[string]interface{} {}
            var currency interface{} = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes5112 := (<-this.LoadMarkets())
            PanicOnError(retRes5112)
...
func  (this *cryptocom) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes228480 := (<-this.LoadMarkets())
            PanicOnError(retRes228480)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277962 := (<-this.LoadMarkets())
            PanicOnError(retRes277962)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes541205 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes541205)
                    ch <- retRes541205
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes922446 := (<-this.LoadMarkets())
            PanicOnError(retRes922446)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes487567 := (<-this.LoadMarkets())
            PanicOnError(retRes487567)
...
func  (this *cryptocom) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168293 := (<-this.LoadMarkets())
            PanicOnError(retRes168293)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
                "type": "MARKET",
...
func  (this *cryptocom) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes29527 := (<-this.LoadMarkets())
            PanicOnError(retRes29527)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes807587 := (<-this.LoadMarkets())
            PanicOnError(retRes807587)
