...
func (this *Cryptocom) fetchAccountsBody(ch chan any, optionalArgs ...any) any {
	...
	//
	var result map[string]any = SafeMapTyped(response, "result")
	var masterAccount map[string]any = this.SafeDictMap(result, "master_account", map[string]any{})
...
func (this *Cryptocom) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	if timestamp != nil {
		fundingTimestamp = Multiply(math.Ceil(float64(*timestamp)/3600000), 3600000) // end of the next hour
	}
	return map[string]any{
		"info":                     contract,
...
func (this *Cryptocom) Sign(path string, optionalArgs ...any) any {
	...
	if access != nil && *access == "public" {
		...
		var paramsKeys []string = nil
		if requestParams != nil {
			paramsKeys = make([]string, 0, len(requestParams))
			for objectKey := range requestParams {
				paramsKeys = append(paramsKeys, objectKey)
			}
		}
