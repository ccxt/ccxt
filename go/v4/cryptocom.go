...
func (this *CryptocomCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(data)); i++ {
		...
		var isLinear any = Ternary(EvalTruthy((contract)), true, nil)
		var isInverse any = Ternary(EvalTruthy((contract)), false, nil)
		AppendToArray(&result, map[string]any{
			...
			"type":           typeVar,
			"spot":           spot,
			"margin":         (EvalTruthy((marginBuyEnabled)) || EvalTruthy((marginSellEnabled))),
			"swap":           swap,
			"future":         future,
			"option":         option,
...
func (this *CryptocomCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if EvalTruthy((postOnly)) || (timeInForce != nil && *timeInForce == "PO") {
...
func (this *CryptocomCore) ParseTicker(ticker any, optionalArgs ...any) any {
	...
	return this.SafeTicker(map[string]any{
		...
		"quoteVolume":   Ternary((IsEqual(GetValue(market, "quote"), "USD")), this.SafeString(ticker, "vv"), nil),
		"info":          ticker,
	}, market)
}
...
func (this *CryptocomCore) CustomHandleMarginModeAndParams(methodName any, optionalArgs ...any) any {
	...
	if !IsEqual(marginMode, nil) {
		...
		if (defaultType != nil && *defaultType == "margin") || (IsEqual(isMargin, true)) {
			marginMode = "cross"
		}
	}
...
func (this *CryptocomCore) ParseTradingFees(response any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(this.Symbols)); i++ {
		...
		var takerFeeKey any = Ternary(EvalTruthy(isSwap), "effective_deriv_taker_rate_bps", "effective_spot_taker_rate_bps")
		var makerFeeKey any = Ternary(EvalTruthy(isSwap), "effective_deriv_maker_rate_bps", "effective_spot_maker_rate_bps")
