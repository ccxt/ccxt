...
func  (this *CryptocomCore) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes95319 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes95319)
                    ch <- retRes95319
                    return nil
            }
            var market interface{} = nil
...
func  (this *CryptocomCore) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes103519 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func  (this *CryptocomCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes109719 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes109719)
                    ch <- retRes109719
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *CryptocomCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes190419 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes190419)
                    ch <- retRes190419
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *CryptocomCore) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes20338 := (<-this.LoadMarkets())
            PanicOnError(retRes20338)
...
func  (this *CryptocomCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes311119 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
