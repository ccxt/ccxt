...
func (this *CoinsphCore) ParseCurrency(rawCurrency any) any {
	...
	var isFiat any = DerefScalar(this.SafeBool(rawCurrency, "isLegalMoney"))
	...
	return this.SafeCurrencyStructure(map[string]any{
		...
		"code":      code,
		"type":      Ternary((IsEqual(isFiat, true)), "fiat", "crypto"),
...
func (this *CoinsphCore) ParseTrade(trade any, optionalArgs ...any) any {
	...
	if feeCost != nil {
		var feeCurrencyId *string = this.SafeString(trade, "commissionAsset")
		fee = map[string]any{
			"cost":     feeCost,
			"currency": this.SafeCurrencyCode(feeCurrencyId),
		}
	}
	var isBuyer any = DerefScalar(this.SafeBool2(trade, "isBuyer", "isBuyerMaker"))
	var side any = nil
	if !IsEqual(isBuyer, nil) {
		side = Ternary((isBuyer == true), "buy", "sell")
	}
	var isMaker *string = this.SafeString(trade, "isMaker")
	var takerOrMaker any = nil
	if isMaker != nil {
		takerOrMaker = Ternary((isMaker != nil && *isMaker == "true"), "maker", "taker")
	}
...
func (this *CoinsphCore) ParseOrder(order any, optionalArgs ...any) any {
	...
	var triggerPrice any = DerefScalar(this.SafeString(order, "stopPrice"))
...
func (this *CoinsphCore) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	var warning any = DerefScalar(this.SafeBool(options, "warning", true))
	if warning == true {
	...
	var networkId any = Ternary((networkCode == nil), nil, this.NetworkCodeToId(networkCode, code))
...
func (this *CoinsphCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	timestamp = DerefScalar(this.SafeInteger2(transaction, "insertTime", "applyTime"))
	var updated any = nil
	var typeVar any = nil
	...
	var internal bool = (network != nil && *network == "Internal")
	return map[string]any{
		"info":        transaction,
		"id":          id,
		"txid":        txid,
