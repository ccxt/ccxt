...
func (this *Coinsph) fetchCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetOpenapiWalletV1ConfigGetall(params)).Raw))
...
func (this *Coinsph) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if since != nil {
		...
		if until != nil {
			...
			var endTimeByLimit any = this.Sum(since, Multiply(duration, (Subtract(limitResolved, 1))))
...
func (this *Coinsph) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PublicGetOpenapiQuoteV1Trades(this.Extend(request, params))).Raw))
...
func (this *Coinsph) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetOpenapiV1MyTrades(this.Extend(request, params))).Raw))
 ...
 */
func (this *Coinsph) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Coinsph) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	...
	if IsEqual(orderType, "STOP_LOSS") || IsEqual(orderType, "STOP_LOSS_LIMIT") || IsEqual(orderType, "TAKE_PROFIT") || IsEqual(orderType, "TAKE_PROFIT_LIMIT") {
		var triggerPrice *string = this.SafeString2(paramsType, "triggerPrice", "stopPrice")
		if triggerPrice == nil {
	...
	var paramsBase any = func() any {
		if !IsEqual(paramsQuote, nil) {
			return paramsQuote
		}
		return paramsType
	}()
	var paramsRequest any = this.Omit(paramsBase, "price", "stopPrice", "triggerPrice", "quantity", "quoteOrderQty")
...
func (this *Coinsph) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetOpenapiV1HistoryOrders(this.Extend(request, params))).Raw))
...
func (this *Coinsph) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetOpenapiWalletV1DepositHistory(this.Extend(request, params))).Raw))
...
func (this *Coinsph) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	var response []any = ListTyped(PanicOnError((<-this.PrivateGetOpenapiWalletV1WithdrawHistory(this.Extend(request, params))).Raw))
...
func (this *Coinsph) UrlEncodeQuery(optionalArgs ...any) any {
	var query map[string]any = GetArgMap(optionalArgs, 0, map[string]any{})
	_ = query
	...
	var encodedQuery string = this.Urlencode(remainingQuery)
...
func (this *Coinsph) ParseArrayParam(array any, key any) any {
	var stringifiedArray string = this.Json(array)
	stringifiedArray = strings.Replace(stringifiedArray, "[", "%5B", 1)
	stringifiedArray = strings.Replace(stringifiedArray, "]", "%5D", 1)
	var urlEncodedParam any = Add(Add(key, "="), stringifiedArray)
	return urlEncodedParam
}
func (this *Coinsph) Sign(path string, optionalArgs ...any) any {
	...
	if IsEqual(api, "private") {
		...
		var signedQuery any = this.UrlEncodeQuery(query)
		var signature string = this.Hmac(this.Encode(signedQuery), this.Encode(this.Secret), sha256)
	...
	var encodedQuery any = this.UrlEncodeQuery(query)
	if GetLength(encodedQuery) != 0 {
		url = Add(url, Add("?", encodedQuery))
	}
	return map[string]any{
		"url":     url,
		"method":  method,
