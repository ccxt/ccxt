 ...
 */
func (this *CoinsphCore) FetchTime(optionalArgs ...any) <-chan Res[*int64] {
...
func (this *CoinsphCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes124315 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes124315)
		ch <- retRes124315
		return nil
