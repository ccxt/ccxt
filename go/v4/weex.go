...
func (this *Weex) fetchTimeBody(ch chan any, optionalArgs ...any) any {
	...
	if typeVar == nil || *typeVar != "spot" {
		...
		response = (<-this.ContractGetCapiV3MarketTime(params)).Raw
		PanicOnError(response)
	} else {

		response = (<-this.PublicGetApiV3Time(params)).Raw
		PanicOnError(response)
	}
...
func (this *Weex) fetchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	if IsEqual(marketType, "spot") {
		...
		response = (<-this.PublicGetApiV3MarketTickerBookTicker(params)).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractGetCapiV3MarketTickerBookTicker(params)).Raw
		PanicOnError(response)
	}
	if !IsArray(response) {
		response = []any{response}
...
func (this *Weex) fetchOrderBookBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "spot") == true {
		...
		response = (<-this.PublicGetApiV3MarketDepth(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractGetCapiV3MarketDepth(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	//     {
...
func (this *Weex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "spot") == true {
		...
		var retRes154819 []any = ListTyped(PanicOnError((<-this.FetchSpotOHLCVAsync(symbol, timeframe, since, limit, params))))
		ch <- BoxAbsent(retRes154819)
		return nil
	} else {

		var retRes155019 []any = ListTyped(PanicOnError((<-this.FetchContractOHLCVAsync(symbol, timeframe, since, limit, params))))
		ch <- BoxAbsent(retRes155019)
		return nil
	}
}
...
func (this *Weex) fetchContractOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if historical {
		...
		response = (<-this.ContractGetCapiV3MarketHistoryKlines(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		if limit != nil {
			request["limit"] = limit
		...
		if priceType != nil && *priceType == "MARK" {
			...
			response = (<-this.ContractGetCapiV3MarketMarkPriceKlines(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else if priceType != nil && *priceType == "INDEX" {

			response = (<-this.ContractGetCapiV3MarketIndexPriceKlines(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else {

			response = (<-this.ContractGetCapiV3MarketKlines(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	}
...
func (this *Weex) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if GetValue(market, "spot") == true {
		...
		response = (<-this.PublicGetApiV3MarketTrades(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractGetCapiV3MarketTrades(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	//
	//     [
...
func (this *Weex) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes212519 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchTransfers", code, since, limit, params, maxLimit))))
...
func (this *Weex) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if GetValue(market, "contract") == true {
		...
		var retRes220119 map[string]any = MapTyped(PanicOnError((<-this.CreateContractOrderAsync(symbol, typeVar, side, amount, price, params))))
		ch <- BoxAbsent(retRes220119)
		return nil
	} else {
		var sandboxMode *bool = this.SafeBool(this.Options, "sandboxMode", false)
		if sandboxMode != nil && *sandboxMode == true {
		...
		var retRes220719 map[string]any = MapTyped(PanicOnError((<-this.CreateSpotOrderAsync(symbol, typeVar, side, amount, price, params))))
...
func (this *Weex) createContractOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if triggerPrice != nil {
		...
		response = (<-this.ContractPrivatePostCapiV3AlgoOrder(request)).Raw
		PanicOnError(response)
	} else if sandboxMode != nil && *sandboxMode == true {

		response = (<-this.ContractPrivatePostCapiV3SimOrder(request)).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivatePostCapiV3Order(request)).Raw
		PanicOnError(response)
	}
	if response == nil {
...
func (this *Weex) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if typeVar != nil && *typeVar == "spot" {
		...
		response = (<-this.PrivateDeleteApiV3Order(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if trigger != nil && *trigger == true {

		response = (<-this.ContractPrivateDeleteCapiV3AlgoOrder(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivateDeleteCapiV3Order(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	if response == nil {
		panic(NullResponse(this.Id + " parseOrder() returned empty response"))
...
func (this *Weex) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if marketType != nil && *marketType == "spot" {
		...
		response = (<-this.PrivateDeleteApiV3OpenOrders(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else if trigger != nil && *trigger == true {

		response = (<-this.ContractPrivateDeleteCapiV3AlgoOpenOrders(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivateDeleteCapiV3AllOpenOrders(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
...
func (this *Weex) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if isSpot {
		...
		response = (<-this.PrivateDeleteApiV3OrderBatch(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivateDeleteCapiV3BatchOrders(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
...
func (this *Weex) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if isSpot {
		...
		response = (<-this.PrivateGetApiV3Order(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivateGetCapiV3Order(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	if response == nil {
		panic(NullResponse(this.Id + " parseOrder() returned empty response"))
...
func (this *Weex) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes276419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchOpenOrders", symbol, since, limit, params, maxLimit))))
	...
	if isSpot {
		...
		response = (<-this.PrivateGetApiV3OpenOrders(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		if since != nil {
			AddElementToObject(request, "startTime", since)
		...
		if trigger != nil && *trigger == true {
			...
			response = (<-this.ContractPrivateGetCapiV3OpenAlgoOrders(this.Extend(request, params))).Raw
			PanicOnError(response)
		} else {
			//
			//     [
			...
			response = (<-this.ContractPrivateGetCapiV3OpenOrders(this.Extend(request, params))).Raw
			PanicOnError(response)
		}
	}
	var extendedParams map[string]any = map[string]any{
...
func (this *Weex) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes297219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchOrders", symbol, since, limit, params, maxLimit))))
...
func (this *Weex) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes304019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchCanceledAndClosedOrders", symbol, since, limit, params, maxLimit))))
	...
	if sandboxMode != nil && *sandboxMode == true {
		...
		response = (<-this.ContractPrivateGetCapiV3SimOrderHistory(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivateGetCapiV3OrderHistory(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
...
func (this *Weex) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	var retRes331715 []any = ListTyped(PanicOnError((<-this.FetchMyTradesAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes331715)
	return nil
}
...
func (this *Weex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes335219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchMyTrades", symbol, since, limit, params, maxLimit))))
	...
	if isSpot {
		...
		response = (<-this.PrivateGetApiV3MyTrades(this.Extend(request, params))).Raw
		PanicOnError(response)
	} else {
		//
		//     [
		...
		response = (<-this.ContractPrivateGetCapiV3UserTrades(this.Extend(request, params))).Raw
		PanicOnError(response)
	}
	var responseList []any = []any{}
	if response != nil {
...
func (this *Weex) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes343719 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchLedger", code, since, limit, params, maxLimit))))
		ch <- BoxAbsent(retRes343719)
		return nil
	}
...
func (this *Weex) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes361019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchFundingHistory", symbol, since, limit, params, 100))))
		ch <- BoxAbsent(retRes361019)
		return nil
	}
	var market map[string]any = nil
	var request any = map[string]any{
...
func (this *Weex) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if sandboxMode != nil && *sandboxMode == true {
		...
		response = (<-this.ContractPrivateGetCapiV3SimPositionAllPosition(params)).Raw
		PanicOnError(response)
	} else {

		response = (<-this.ContractPrivateGetCapiV3AccountPositionAllPosition(params)).Raw
		PanicOnError(response)
	}
...
func (this *Weex) fetchPositionsForSymbolBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if sandboxMode != nil && *sandboxMode == true {
		...
		var retRes374719 []any = ListTyped(PanicOnError((<-this.FetchPositionsAsync([]any{market["symbol"]}, params))))
		// the demo trading API does not provide a single-position endpoint
		ch <- BoxAbsent(retRes374719)
		return nil
	}
	var request map[string]any = map[string]any{
		"symbol": market["id"],
...
func (this *Weex) reduceMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes431115 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, 2, params))))
	ch <- BoxAbsent(retRes431115)
	return nil
}
...
func (this *Weex) addMarginBody(ch chan any, symbol any, amount any, optionalArgs ...any) any {
	...
	var retRes432615 map[string]any = MapTyped(PanicOnError((<-this.ModifyMarginHelperAsync(symbol, amount, 1, params))))
	ch <- BoxAbsent(retRes432615)
	return nil
}
