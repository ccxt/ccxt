...
func (this *Paradex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PublicGetMarketsKlines(this.Extend(request, paramsOmitted))).Raw))
	//
	//     {
	//         "results": [
	//             [
 ...
 */
func (this *Paradex) CreateOrderAsync(symbol any, typeVar string, side string, amount any, optionalArgs ...any) <-chan any {
	ch := make(chan any, 1)
	go this.createOrderBody(ch, symbol, typeVar, side, amount, optionalArgs...)
	return ch
}
func (this *Paradex) createOrderBody(ch chan any, symbol any, typeVar string, side string, amount any, optionalArgs ...any) any {
	defer close(ch)
	defer ReturnPanicError(ch)
	var price *float64 = GetArgFloat64Ptr(optionalArgs, 0, nil)
	_ = price
...
func (this *Paradex) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivateDeleteOrdersBatch(this.Extend(request, paramsOmitted))).Raw))
	//
	// {
	//     "results": [
	//         {
...
func (this *Paradex) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if clientOrderId != nil {
		...
		response = MapTyped(PanicOnError((<-this.PrivateGetOrdersByClientIdClientId(this.Extend(request, paramsOmitted))).Raw))
	} else {
		request["order_id"] = id
...
func (this *Paradex) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PublicGetFundingData(this.Extend(request, paramsOmitted))).Raw))
	//
	// {
	//     "next": "eyJmaWx0ZXIiMsIm1hcmtlciI6eyJtYXJrZXIiOiIxNjc1NjUwMDE3NDMxMTAxNjk5N=",
	//     "prev": "eyJmaWx0ZXIiOnsiTGltaXQiOjkwfSwidGltZSI6MTY4MTY3OTgzNzk3MTMwOTk1MywibWFya2VyIjp7Im1zMjExMD==",
