...
func  (this *paradex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes257604 := (<-this.LoadMarkets())
            PanicOnError(retRes257604)
...
func  (this *paradex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes739832 := (<-this.LoadMarkets())
            PanicOnError(retRes739832)
...
func  (this *paradex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes147958 := (<-this.LoadMarkets())
            PanicOnError(retRes147958)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *paradex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes435612 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
...
func  (this *paradex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes74497 := (<-this.LoadMarkets())
            PanicOnError(retRes74497)
            var market interface{} = this.Market(symbol)
...
func  (this *paradex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507529 := (<-this.AuthenticateRest())
            PanicOnError(retRes507529)
...
func  (this *paradex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255976 := (<-this.AuthenticateRest())
            PanicOnError(retRes255976)
        
            retRes515008 := (<-this.LoadMarkets())
            PanicOnError(retRes515008)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeStringN(params, []interface{}{"clOrdID", "clientOrderId", "client_order_id"})
...
func  (this *paradex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes459310 := (<-this.AuthenticateRest())
            PanicOnError(retRes459310)
        
            retRes8900 := (<-this.LoadMarkets())
            PanicOnError(retRes8900)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *paradex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes759755 := (<-this.AuthenticateRest())
            PanicOnError(retRes759755)
        
            retRes826251 := (<-this.LoadMarkets())
            PanicOnError(retRes826251)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeStringN(params, []interface{}{"clOrdID", "clientOrderId", "client_order_id"})
...
func  (this *paradex) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes288603 := (<-this.AuthenticateRest())
            PanicOnError(retRes288603)
        
            retRes733326 := (<-this.LoadMarkets())
            ...
            if IsTrue(paginate) {
                    ...
                    retRes686387 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "next", "cursor", nil, 50))
                    PanicOnError(retRes686387)
                    ch <- retRes686387
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *paradex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493558 := (<-this.AuthenticateRest())
            PanicOnError(retRes493558)
        
            retRes923892 := (<-this.LoadMarkets())
            PanicOnError(retRes923892)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *paradex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes281182 := (<-this.AuthenticateRest())
            PanicOnError(retRes281182)
        
            retRes791358 := (<-this.LoadMarkets())
            PanicOnError(retRes791358)
...
func  (this *paradex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes864790 := (<-this.AuthenticateRest())
            PanicOnError(retRes864790)
        
            retRes909060 := (<-this.LoadMarkets())
            PanicOnError(retRes909060)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes847851 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
                    PanicOnError(retRes847851)
                    ch <- retRes847851
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *paradex) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909137 := (<-this.AuthenticateRest())
            PanicOnError(retRes909137)
        
            retRes86179 := (<-this.LoadMarkets())
            PanicOnError(retRes86179)
            var market interface{} = this.Market(symbol)
...
func  (this *paradex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes385211 := (<-this.AuthenticateRest())
            PanicOnError(retRes385211)
        
            retRes396238 := (<-this.LoadMarkets())
            PanicOnError(retRes396238)
            symbols = this.MarketSymbols(symbols)
...
func  (this *paradex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes529861 := (<-this.AuthenticateRest())
...
func  (this *paradex) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes263604 := (<-this.AuthenticateRest())
            PanicOnError(retRes263604)
        
            retRes803246 := (<-this.LoadMarkets())
            PanicOnError(retRes803246)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes961120 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "next", "cursor", nil, 100))
                    PanicOnError(retRes961120)
                    ch <- retRes961120
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *paradex) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes771157 := (<-this.AuthenticateRest())
            PanicOnError(retRes771157)
        
            retRes589779 := (<-this.LoadMarkets())
            PanicOnError(retRes589779)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes642811 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next", "cursor", nil, 100))
                    PanicOnError(retRes642811)
                    ch <- retRes642811
                    return nil
            }
            var request interface{} = map[string]interface{} {}
