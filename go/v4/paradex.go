...
func (this *ParadexCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes108519 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes17018 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes17628 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18188 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18828 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19128 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19928 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20758 := (<-this.AuthenticateRest())
		...
		if IsTrue(paginate) {
			...
			retRes208019 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "next", "cursor", nil, 50))
...
func (this *ParadexCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes21538 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22078 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22528 := (<-this.AuthenticateRest())
		...
		if IsTrue(paginate) {
			...
			retRes225719 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) FetchPosition(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes23138 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes23308 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes24348 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes250319 := (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes256519 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes262719 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "next", "cursor", nil, 100))
			PanicOnError(retRes262719)
			ch <- retRes262719
			return nil
		}
		var request any = map[string]any{}
...
func (this *ParadexCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes27828 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes28298 := (<-this.AuthenticateRest())
		...
		retRes283915 := (<-this.PrivatePostAccountMarginMarket(this.Extend(request, params)))
		PanicOnError(retRes283915)
		ch <- retRes283915
		return nil
...
func (this *ParadexCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes28528 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes29098 := (<-this.AuthenticateRest())
		...
		retRes291915 := (<-this.PrivatePostAccountMarginMarket(this.Extend(request, params)))
...
func (this *ParadexCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes311519 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31948 := (<-this.LoadMarkets())
		PanicOnError(retRes31948)
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"market": GetValue(market, "id"),
		}
