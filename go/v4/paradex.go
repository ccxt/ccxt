...
func (this *Paradex) ParseMarket(market any) any {
	...
	//  }
	//
	var assetKind *string = this.SafeString(market, "asset_kind")
...
func (this *Paradex) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"until", "till", "price"}))
	if since != nil {
...
func (this *Paradex) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes122819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchTrades", symbol, since, limit, params, "next", "cursor", nil, 100))))
		ch <- retRes122819
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Paradex) authenticateRestBody(ch chan any, optionalArgs ...any) any {
	...
	if cachedToken != nil {
		var cachedExpires *int64 = this.SafeInteger(this.Options, "expires")
		if cachedExpires == nil {
			panic(ExchangeError(this.Id + " authenticateRest() missing cachedExpires"))
		}
...
func (this *Paradex) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"reduceOnly", "reduce_only", "clOrdID", "clientOrderId", "client_order_id", "postOnly", "timeInForce", "stopPrice", "triggerPrice", "stopLossPrice", "takeProfitPrice"}))
...
func (this *Paradex) signOrderRequestBody(ch chan any, request any, optionalArgs ...any) any {
	...
	if orderType == nil {
		panic(ExchangeError(this.Id + " signOrderRequest() missing orderType"))
	}
	var isMarket bool = (func() int {
		if orderType == nil {
			return -1
		}
...
func (this *Paradex) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes225419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOrders", symbol, since, limit, params, "next", "cursor", nil, 50))))
		ch <- retRes225419
		return nil
	}
	var request any = map[string]any{}
	...
	var paginationCursor *string = this.SafeString(response, "next")
	var ordersLength int = GetArrayLength(orders)
	if (paginationCursor != nil) && (ordersLength > 0) {
...
func (this *Paradex) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes243919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", symbol, since, limit, params, "next", "cursor", nil, 100))))
		ch <- retRes243919
		return nil
	}
	var request any = map[string]any{}
...
func (this *Paradex) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes269419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchDeposits", code, since, limit, params, "next", "cursor", nil, 100))))
		ch <- retRes269419
		return nil
	}
	var request any = map[string]any{}
...
func (this *Paradex) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes275819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchWithdrawals", code, since, limit, params, "next", "cursor", nil, 100))))
		ch <- retRes275819
		return nil
	}
	var request any = map[string]any{}
...
func (this *Paradex) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes282219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchTransfers", code, since, limit, params, "next", "cursor", nil, 100))))
		ch <- retRes282219
		return nil
	}
	var request any = map[string]any{}
...
func (this *Paradex) ParseGreeks(greeks any, optionalArgs ...any) any {
	...
	market = MapTyped(this.SafeMarket(marketId, market, nil, "option"))
	var symbol any = GetValue(market, "symbol")
...
func (this *Paradex) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes332419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "next", "cursor", nil, 100))))
		ch <- retRes332419
		return nil
	}
	var market map[string]any = MapTyped(this.Market(symbol))
...
func (this *Paradex) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {
	...
	res := AwaitResult(this.FetchAllGreeksAsync(opts.Symbols, opts.Params))
	if res.Err != nil {
