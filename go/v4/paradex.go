...
func (this *ParadexCore) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	// against 1.6 MB
	var target any = "ALL"
	if IsTrue(IsTrue((!IsEqual(symbols, nil))) && IsTrue((IsEqual(GetArrayLength(symbols), 1)))) {
...
func (this *ParadexCore) ParseFundingRate(contract any, optionalArgs ...any) any {
	...
	var funds bool = IsTrue(IsTrue(GetValue(market, "swap")) && IsTrue((!IsEqual(rate, nil)))) && IsTrue((!IsEqual(rate, "")))
	...
	var interval any = Ternary(IsTrue((IsTrue((IsEqual(hours, nil))) || !IsTrue(Precise.StringGt(hours, "0")))), nil, Add(hours, "h"))
	return map[string]any{
		"info":                     contract,
...
func (this *ParadexCore) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes120619 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
		PanicOnError(retRes120619)
		ch <- retRes120619
		return nil
	}
	var market any = this.Market(symbol)
...
func (this *ParadexCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	retRes18378 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	retRes19008 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) createOrdersBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	retRes19588 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) cancelOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes20248 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	retRes20568 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes21388 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes21668 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) fetchOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes22258 := (<-this.AuthenticateRest())
	...
	if IsTrue(paginate) {
		...
		retRes223219 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "next", "cursor", nil, 50))
		PanicOnError(retRes223219)
		ch <- retRes223219
		return nil
	}
	var request any = map[string]any{}
...
func (this *ParadexCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes23058 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) fetchBalanceBody(ch chan any, optionalArgs ...any) any {
	...
	retRes23618 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	retRes24108 := (<-this.AuthenticateRest())
	...
	if IsTrue(paginate) {
		...
		retRes241719 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
		PanicOnError(retRes241719)
		ch <- retRes241719
		return nil
	}
	var request any = map[string]any{}
...
func (this *ParadexCore) fetchPositionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes24738 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes24928 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes25998 := (<-this.AuthenticateRest())
	PanicOnError(retRes25998)
	if IsTrue(IsEqual(this.Markets, nil)) {

		retRes260112 := (<-this.LoadMarkets())
...
func (this *ParadexCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes26658 := (<-this.AuthenticateRest())
	...
	if IsTrue(paginate) {
		...
		retRes267219 := (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	retRes27298 := (<-this.AuthenticateRest())
	...
	if IsTrue(paginate) {
		...
		retRes273619 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes27938 := (<-this.AuthenticateRest())
	...
	if IsTrue(paginate) {
		...
		retRes280019 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) fetchMarginModeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes29558 := (<-this.AuthenticateRest())
	PanicOnError(retRes29558)
	if IsTrue(IsEqual(this.Markets, nil)) {

		retRes295712 := (<-this.LoadMarkets())
...
func (this *ParadexCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	retRes30048 := (<-this.AuthenticateRest())
	...
	retRes301615 := (<-this.PrivatePostAccountMarginMarket(this.Extend(request, params)))
...
func (this *ParadexCore) fetchLeverageBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	retRes30298 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	retRes30888 := (<-this.AuthenticateRest())
	...
	retRes310015 := (<-this.PrivatePostAccountMarginMarket(this.Extend(request, params)))
...
func (this *ParadexCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	retRes32958 := (<-this.AuthenticateRest())
	...
	if IsTrue(paginate) {
		...
		retRes330219 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "next", "cursor", nil, 100))
