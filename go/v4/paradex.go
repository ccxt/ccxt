...
func (this *ParadexCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes108419 := (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) CreateOrder(symbol any, typeVar any, side any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes17008 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) EditOrder(id any, symbol any, typeVar any, side any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes17618 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CreateOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18178 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes18818 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19118 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes19918 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20178 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes20748 := (<-this.AuthenticateRest())
		...
		if IsTrue(paginate) {
			...
			retRes207919 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "next", "cursor", nil, 50))
...
func (this *ParadexCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes21528 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchBalance(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22068 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes22518 := (<-this.AuthenticateRest())
		...
		if IsTrue(paginate) {
			...
			retRes225619 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "next", "cursor", nil, 100))
			PanicOnError(retRes225619)
			ch <- retRes225619
			return nil
		}
		var request any = map[string]any{}
...
func (this *ParadexCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes23298 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes24338 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes24978 := (<-this.AuthenticateRest())
		...
		if IsTrue(paginate) {
			...
			retRes250219 := (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "next", "cursor", nil, 100))
			PanicOnError(retRes250219)
			ch <- retRes250219
			return nil
		}
		var request any = map[string]any{}
...
func (this *ParadexCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes256419 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes262619 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "next", "cursor", nil, 100))
...
func (this *ParadexCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes27818 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) SetMarginMode(marginMode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes28288 := (<-this.AuthenticateRest())
		...
		retRes283815 := (<-this.PrivatePostAccountMarginMarket(this.Extend(request, params)))
		PanicOnError(retRes283815)
		ch <- retRes283815
		return nil
...
func (this *ParadexCore) FetchLeverage(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes28518 := (<-this.AuthenticateRest())
...
func (this *ParadexCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes291815 := (<-this.PrivatePostAccountMarginMarket(this.Extend(request, params)))
...
func (this *ParadexCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes31098 := (<-this.AuthenticateRest())
		...
		if IsTrue(paginate) {
			...
			retRes311419 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "next", "cursor", nil, 100))
