...
func  (this *BitstampCore) FetchFundingRateHistory(optionalArgs ...any) <- chan any {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes185919 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes185919)
                    ch <- retRes185919
                    return nil
            }
