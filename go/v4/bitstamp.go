...
func (this *BitstampCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(response)); i++ {
		...
		var settle any = Ternary(EvalTruthy(settleId), this.SafeCurrencyCode(settleId), nil)
...
func (this *BitstampCore) createOrderBody(ch chan any, symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if IsEqual(typeVar, "market") {
		if IsEqual(capitalizedSide, "Buy") {
...
func (this *BitstampCore) Sign(path any, optionalArgs ...any) any {
	...
	if IsEqual(api, "public") {
		...
		var authBody any = Ternary(EvalTruthy(body), body, "")
