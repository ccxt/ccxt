...
func (this *Bitstamp) ParseCurrencies(rawCurrencies any) any {
	...
	for i := 0; i < len(arr); i++ {
		...
		if (base != nil) && !(func() bool {
			...
			result[*base] = this.ConstructCurrencyObject(baseId, base, baseDescription, baseDecimals, nil, market)
		}
...
func (this *Bitstamp) GetCurrencyIdFromTransaction(transaction any) any {
	...
	var ids []string = nil
	if transactionOmitted != nil {
		ids = make([]string, 0, len(transactionOmitted))
		for objectKey := range transactionOmitted {
...
func (this *Bitstamp) fetchTradesBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	listEp1940 := (<-this.PublicGetTransactionsPair(this.Extend(request, params)))
	PanicOnError(listEp1940.Raw)
	var response []any = listEp1940.Value
...
func (this *Bitstamp) fetchTradingFeeBody(ch chan any, symbol string, optionalArgs ...any) any {
	...
	listEp2175 := (<-this.PrivatePostFeesTrading(this.Extend(request, params)))
	PanicOnError(listEp2175.Raw)
	var response []any = listEp2175.Value
	//
	//     [
	//         {
...
func (this *Bitstamp) fetchTradingFeesBody(ch chan any, optionalArgs ...any) any {
	...
	listEp2250 := (<-this.PrivatePostFeesTrading(params))
	PanicOnError(listEp2250.Raw)
	var response []any = listEp2250.Value
...
func (this *Bitstamp) fetchTransactionFeesBody(ch chan any, optionalArgs ...any) any {
	...
	listEp2297 := (<-this.PrivatePostFeesWithdrawal(params))
	PanicOnError(listEp2297.Raw)
	var response []any = listEp2297.Value
...
func (this *Bitstamp) ParseTransactionFees(response any, optionalArgs ...any) map[string]any {
	...
	if currencies != nil {
		...
		for objectKey := range currencies {
			ids = append(ids, objectKey)
		}
	}
	for i := 0; i < len(ids); i++ {
...
func (this *Bitstamp) fetchDepositWithdrawFeesBody(ch chan any, optionalArgs ...any) any {
	...
	listEp2368 := (<-this.PrivatePostFeesWithdrawal(params))
	PanicOnError(listEp2368.Raw)
	var response []any = listEp2368.Value
	//
	//     [
	//         {
	//             "currency": "btc",
...
func (this *Bitstamp) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if symbol != nil {
		...
		listEp2826 := (<-this.PrivatePostUserTransactionsPair(this.Extend(request, params)))
		PanicOnError(listEp2826.Raw)
		response = listEp2826.Value
	} else {

		listEp2829 := (<-this.PrivatePostUserTransactions(this.Extend(request, params)))
		PanicOnError(listEp2829.Raw)
		response = listEp2829.Value
	}
...
func (this *Bitstamp) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if since != nil {
		request["since_timestamp"] = math.Round(float64(*since) / 1000)
	}
...
func (this *Bitstamp) fetchDepositsWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	listEp2968 := (<-this.PrivatePostUserTransactions(this.Extend(request, params)))
	PanicOnError(listEp2968.Raw)
	var response []any = listEp2968.Value
	//
	//     [
	//         {
	//             "fee": "0.00000000",
...
func (this *Bitstamp) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	listEp3043 := (<-this.PrivatePostWithdrawalRequests(this.Extend(request, params)))
	PanicOnError(listEp3043.Raw)
	var response []any = listEp3043.Value
...
func (this *Bitstamp) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	listEp3477 := (<-this.PrivatePostUserTransactions(this.Extend(request, params)))
	PanicOnError(listEp3477.Raw)
	var response []any = listEp3477.Value
	var currency map[string]any = nil
	if code != nil {
		currency = this.Currency(code)
	}
...
func (this *Bitstamp) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	listEp3603 := (<-this.PrivatePostOpenOrdersAll(params))
	PanicOnError(listEp3603.Raw)
	var response []any = listEp3603.Value
