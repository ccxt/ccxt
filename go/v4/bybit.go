...
func  (this *BybitCore) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes149815 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
...
func  (this *BybitCore) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes179112 := (<-this.LoadTimeDifference())
...
func  (this *BybitCore) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes261015 :=  (<-this.FetchTickers(symbols, params))
...
func  (this *BybitCore) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes266119 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func  (this *BybitCore) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes290819 :=  (<-this.FetchPaginatedCallDynamic("fetchFundingRateHistory", symbol, since, limit, params, 200))
...
func  (this *BybitCore) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes396315 :=  (<-this.CreateOrder(symbol, "market", "buy", OpNeg(1), nil, this.Extend(req, params)))
...
func  (this *BybitCore) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var req interface{} = map[string]interface{} {
                ...
                retRes399015 :=  (<-this.CreateOrder(symbol, "market", "sell", OpNeg(1), nil, this.Extend(req, params)))
...
func  (this *BybitCore) FetchOrderClassic(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50238 := (<-this.LoadMarkets())
            PanicOnError(retRes50238)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *BybitCore) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes506019 :=  (<-this.FetchOrderClassic(id, symbol, params))
...
func  (this *BybitCore) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes516415 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
...
func  (this *BybitCore) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes519019 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes536719 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes536719)
                    ch <- retRes536719
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *BybitCore) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes548715 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *BybitCore) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes551315 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes551315)
                ch <- retRes551315
                return nil
...
func  (this *BybitCore) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes554019 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes565715 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func  (this *BybitCore) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes567919 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *BybitCore) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes58268 := (<-this.LoadMarkets())
            PanicOnError(retRes58268)
            var currency interface{} = this.Currency(code)
...
func  (this *BybitCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes585419 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes592319 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes610719 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *BybitCore) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes652019 :=  (<-this.FetchPaginatedCallCursor("fetchPositions", symbols, nil, nil, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes652019)
                    ch <- retRes652019
                    return nil
            }
...
func  (this *BybitCore) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes69008 := (<-this.LoadMarkets())
            PanicOnError(retRes69008)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *BybitCore) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71438 := (<-this.LoadMarkets())
            PanicOnError(retRes71438)
            var market interface{} = this.Market(symbol)
...
func  (this *BybitCore) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72098 := (<-this.LoadMarkets())
            PanicOnError(retRes72098)
            var paginate interface{} = this.SafeBool(params, "paginate")
            if IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                AddElementToObject(params, "timeframe", timeframe)
        
                    retRes721419 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes722615 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func  (this *BybitCore) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes751419 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes751419)
                    ch <- retRes751419
                    return nil
            }
            var currency interface{} = nil
...
func  (this *BybitCore) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes776015 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
                PanicOnError(retRes776015)
                ch <- retRes776015
                return nil
...
func  (this *BybitCore) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes80448 := (<-this.LoadMarkets())
            PanicOnError(retRes80448)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *BybitCore) FetchVolatilityHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81718 := (<-this.LoadMarkets())
            PanicOnError(retRes81718)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
...
func  (this *BybitCore) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes843119 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes843119)
                    ch <- retRes843119
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *BybitCore) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes855419 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *BybitCore) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes868919 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *BybitCore) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91968 := (<-this.LoadMarkets())
            PanicOnError(retRes91968)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *BybitCore) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92298 := (<-this.LoadMarkets())
            PanicOnError(retRes92298)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *BybitCore) FetchPositionsADLRank(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94838 := (<-this.LoadMarkets())
            PanicOnError(retRes94838)
            symbols = this.MarketSymbols(symbols, nil, true, true, true)
...
func  (this *BybitCore) HandleErrors(httpCode interface{}, reason interface{}, url interface{}, method interface{}, headers interface{}, body interface{}, response interface{}, requestHeaders interface{}, requestBody interface{}) interface{}  {
    ...
    if IsTrue(!IsEqual(errorCode, "0")) {
        if IsTrue(IsEqual(errorCode, "30084")) {
            // not an error
            // https://github.com/mtan11/ccxt/issues/11268
            // https://github.com/mtan11/ccxt/pull/11624
