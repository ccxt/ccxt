...
func (this *BybitCore) FetchMarkets(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
			...
			retRes189212 := (<-this.LoadTimeDifference())
...
func (this *BybitCore) FetchTicker(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var rawTicker any = this.SafeDict(tickers, 0)
...
func (this *BybitCore) FetchBidsAsks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes271815 := (<-this.FetchTickers(symbols, params))
		PanicOnError(retRes271815)
		ch <- retRes271815
		return nil
...
func (this *BybitCore) FetchOHLCV(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes277219 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *BybitCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes302319 := (<-this.FetchPaginatedCallDynamic("fetchFundingRateHistory", symbol, since, limit, params, 200))
...
func (this *BybitCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes335512 := (<-this.LoadMarkets())
			PanicOnError(retRes335512)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BybitCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes408615 := (<-this.CreateOrder(symbol, "market", "buy", OpNeg(1), nil, this.Extend(req, params)))
		PanicOnError(retRes408615)
		ch <- retRes408615
		return nil
...
func (this *BybitCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes411515 := (<-this.CreateOrder(symbol, "market", "sell", OpNeg(1), nil, this.Extend(req, params)))
		PanicOnError(retRes411515)
		ch <- retRes411515
		return nil
...
func (this *BybitCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes483412 := (<-this.LoadMarkets())
			PanicOnError(retRes483412)
		}
		var market any = this.Market(symbol)
...
func (this *BybitCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if !IsTrue(isUnifiedAccount) {
			...
			retRes520719 := (<-this.FetchOrderClassic(id, symbol, params))
			PanicOnError(retRes520719)
			ch <- retRes520719
			return nil
		}
...
func (this *BybitCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes531115 := (<-this.FetchOrdersClassic(symbol, since, limit, params))
...
func (this *BybitCore) FetchOrdersClassic(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes533919 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchOpenOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes547912 := (<-this.LoadMarkets())
			PanicOnError(retRes547912)
		}
		var request any = map[string]any{
			"orderId": id,
		}
...
func (this *BybitCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes551712 := (<-this.LoadMarkets())
			PanicOnError(retRes551712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes552219 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes564415 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BybitCore) FetchCanceledOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes567215 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes567215)
		ch <- retRes567215
		return nil
...
func (this *BybitCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes569612 := (<-this.LoadMarkets())
			PanicOnError(retRes569612)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes570119 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes581815 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func (this *BybitCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes583712 := (<-this.LoadMarkets())
			PanicOnError(retRes583712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes584219 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func (this *BybitCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes602319 := (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes609419 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes628019 := (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes669919 := (<-this.FetchPaginatedCallCursor("fetchPositions", symbols, nil, nil, params, "nextPageCursor", "cursor", nil, 200))
...
func (this *BybitCore) FetchOpenInterest(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes733312 := (<-this.LoadMarkets())
			PanicOnError(retRes733312)
		}
		var market any = this.Market(symbol)
...
func (this *BybitCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes740112 := (<-this.LoadMarkets())
			PanicOnError(retRes740112)
		}
		...
		if IsTrue(paginate) {
			...
			retRes740719 := (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
		...
		retRes741915 := (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func (this *BybitCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes745512 := (<-this.LoadMarkets())
			PanicOnError(retRes745512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin": GetValue(currency, "id"),
...
func (this *BybitCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes752812 := (<-this.LoadMarkets())
			PanicOnError(retRes752812)
		}
		var request any = map[string]any{}
...
func (this *BybitCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes757712 := (<-this.LoadMarkets())
			PanicOnError(retRes757712)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *BybitCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes765612 := (<-this.LoadMarkets())
			PanicOnError(retRes765612)
		}
...
func (this *BybitCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes771212 := (<-this.LoadMarkets())
			PanicOnError(retRes771212)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes771719 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes777112 := (<-this.LoadMarkets())
			PanicOnError(retRes777112)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":   GetValue(currency, "id"),
...
func (this *BybitCore) FetchDerivativesMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes791112 := (<-this.LoadMarkets())
			PanicOnError(retRes791112)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BybitCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes796212 := (<-this.LoadMarkets())
			PanicOnError(retRes796212)
		}
		var request any = map[string]any{}
		var market any = nil
		market = this.Market(symbol)
		...
		retRes797115 := (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
...
func (this *BybitCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes820512 := (<-this.LoadMarkets())
			PanicOnError(retRes820512)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BybitCore) FetchVolatilityHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes839312 := (<-this.LoadMarkets())
			PanicOnError(retRes839312)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"category": "option",
...
func (this *BybitCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes865512 := (<-this.LoadMarkets())
			PanicOnError(retRes865512)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes866019 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func (this *BybitCore) GetLeverageTiersPaginated(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes877612 := (<-this.LoadMarkets())
			PanicOnError(retRes877612)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes878519 := (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes878519)
			ch <- retRes878519
			return nil
		}
		var subType any = nil
...
func (this *BybitCore) ParseLeverageTiers(response any, optionalArgs ...any) any {
	...
	var filteredResults any = this.FilterByArray(response, marketIdKey, marketIds, false)
	var grouped any = this.GroupBy(filteredResults, marketIdKey)
...
func (this *BybitCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes892419 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes892419)
			ch <- retRes892419
			return nil
		}
		var request any = map[string]any{
...
func (this *BybitCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes908412 := (<-this.LoadMarkets())
			PanicOnError(retRes908412)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"category": "option",
...
func (this *BybitCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		var positions any = this.ParsePositions(rawPositions, symbols, params)
...
func (this *BybitCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes928512 := (<-this.LoadMarkets())
			PanicOnError(retRes928512)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes938512 := (<-this.LoadMarkets())
			PanicOnError(retRes938512)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes947712 := (<-this.LoadMarkets())
			PanicOnError(retRes947712)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes954312 := (<-this.LoadMarkets())
			PanicOnError(retRes954312)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(limit, nil)) {
			AddElementToObject(request, "limit", limit)
...
func (this *BybitCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes987112 := (<-this.LoadMarkets())
			PanicOnError(retRes987112)
		}
		var market any = this.Market(symbol)
