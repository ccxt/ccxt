...
func (this *BybitCore) isUnifiedEnabledBody(ch chan any, optionalArgs ...any) any {
	...
	_ = params
	var enableUnifiedMargin any = DerefScalar(this.SafeBool(this.Options, "enableUnifiedMargin"))
	var enableUnifiedAccount any = DerefScalar(this.SafeBool(this.Options, "enableUnifiedAccount"))
...
func (this *BybitCore) fetchStatusBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(list)); i++ {
		...
		if state != nil && *state == "ongoing" {
			status = "maintenance"
			eta = DerefScalar(this.SafeInteger(event, "end"))
			url = DerefScalar(this.SafeString(event, "href"))
			break
		} else if state != nil && *state == "scheduled" {
			eta = DerefScalar(this.SafeInteger(event, "begin"))
			url = DerefScalar(this.SafeString(event, "href"))
		}
	}
...
func (this *BybitCore) fetchSpotMarketsBody(ch chan any, params any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(markets)); i++ {
		...
		var quotePrecision any = DerefScalar(this.SafeNumber(lotSizeFilter, "quotePrecision"))
...
func (this *BybitCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if !IsEqual(since, nil) {
		...
		AddElementToObject(request, "start", Ternary((IsEqual(rounded, since)), since, this.Sum(rounded, duration)))
	}
	if !IsEqual(limit, nil) {
...
func (this *BybitCore) ParseFundingRate(ticker any, optionalArgs ...any) any {
	...
	var markPrice any = DerefScalar(this.SafeNumber(ticker, "markPrice"))
	var indexPrice any = DerefScalar(this.SafeNumber(ticker, "indexPrice"))
	...
	if !IsEqual(isMaker, nil) {
		...
		if !IsEqual(lastLiquidityInd, nil) {
			if (IsEqual(lastLiquidityInd, "TAKER")) || (IsEqual(lastLiquidityInd, "MAKER")) {
				...
				takerOrMaker = Ternary((IsEqual(lastLiquidityInd, "AddedLiquidity")), "maker", "taker")
			}
		}
	}
...
func (this *BybitCore) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	if (!IsEqual(GetValue(market, "spot"), true)) && (hedged == true) {
		...
		AddElementToObject(request, "positionIdx", Ternary((IsEqual(side, "buy")), 1, 2))
	}
...
func (this *BybitCore) EditOrderRequest(id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if !IsEqual(triggerPrice, nil) {
		var triggerPriceRequest any = Ternary((IsEqual(triggerPrice, "0")), triggerPrice, this.GetPrice(symbol, triggerPrice))
...
func (this *BybitCore) ParseTransaction(transaction any, optionalArgs ...any) any {
	...
	var feeCost any = DerefScalar(this.SafeNumber2(transaction, "depositFee", "withdrawFee"))
...
func (this *BybitCore) ParseLedgerEntry(item any, optionalArgs ...any) any {
	...
	if (afterString != nil) && (amountString != nil) {
		var difference any = Ternary((IsEqual(direction, "out")), amountString, Precise.StringNeg(amountString))
	...
	if IsEqual(timestamp, nil) {
		timestamp = DerefScalar(this.SafeInteger(item, "transactionTime"))
	}
...
func (this *BybitCore) ParsePosition(position any, optionalArgs ...any) any {
	...
	if IsEqual(lastUpdateTimestamp, nil) {
		lastUpdateTimestamp = DerefScalar(this.SafeInteger2(position, "updatedTime", "updatedAt"))
	}
	...
	if !IsEqual(liquidationPrice, nil) {
		if IsEqual(GetValue(market, "settle"), "USDC") {
			...
			var useMarkPrice any = DerefScalar(this.SafeBool(this.Options, "useMarkPriceForPositionCollateral", false))
...
func (this *BybitCore) setMarginModeBody(ch chan any, marginMode any, optionalArgs ...any) any {
	...
	if isUnifiedAccount {
		if IsEqual(marginMode, "isolated") {
			...
			marginMode = "REGULAR_MARGIN"
		} else if IsEqual(marginMode, "portfolio") {
...
func (this *BybitCore) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var paginate any = DerefScalar(this.SafeBool(params, "paginate"))
...
func (this *BybitCore) ParseOpenInterest(interest any, optionalArgs ...any) any {
	...
	var openInterest any = DerefScalar(this.SafeNumber2(interest, "open_interest", "openInterest"))
...
func (this *BybitCore) ParseBorrowRate(info any, optionalArgs ...any) any {
	...
	var hourlyBorrowRate any = DerefScalar(this.SafeNumber(info, "hourlyBorrowRate"))
...
func (this *BybitCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(coins)); i++ {
		...
		var disableFrom any = DerefScalar(this.SafeBool(entry, "disableFrom"))
		var disableTo any = DerefScalar(this.SafeBool(entry, "disableTo"))
