...
func (this *Bybit) fetchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes278015 map[string]any = MapTyped(PanicOnError((<-this.FetchTickersAsync(symbols, params))))
	ch <- BoxAbsent(retRes278015)
	return nil
}
...
func (this *Bybit) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes283419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDeterministicAsync("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))))
		ch <- BoxAbsent(retRes283419)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	var request map[string]any = map[string]any{
...
func (this *Bybit) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes309219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallDynamicAsync("fetchFundingRateHistory", symbol, since, limit, params, 200))))
		ch <- BoxAbsent(retRes309219)
		return nil
	}
	if limit == nil {
...
func (this *Bybit) CreateOrderRequest(symbol any, typeVar any, side any, amount any, optionalArgs ...any) any {
	...
	var amountString any = func() any {
		if !IsEqual(amount, nil) {
			return this.GetAmount(symbol, amount)
		}
		return nil
	}()
	...
	if endpointIsTradingStop {
		...
		if isStopLossOrder || isTakeProfitOrder {
			...
			params = MapTyped(this.Omit(params, []any{"stopLossLimitPrice", "takeProfitLimitPrice", "tradingStopEndpoint"}))
		}
	} else {
		...
		var postOnlyparamsVariable []any = this.HandlePostOnly(isMarket, (timeInForce != nil && *timeInForce == "postonly"), params)
	...
	if (GetValue(market, "spot") == true) && isMarketOrder && (isUTA == true) && !isMarketBuyAndCostInferable {
		...
		var createMarketBuyOrderRequiresPriceparamsVariable []any = this.HandleOptionBoolAndParams(params, "createOrder", "createMarketBuyOrderRequiresPrice", false)
	...
	if isTrailingOrder {
		...
		params = MapTyped(this.Omit(params, []any{"triggerPrice", "stopPrice", "triggerDirection"}))
		if GetValue(market, "spot") == true {
	...
	params = MapTyped(this.Omit(params, []any{"stopPrice", "timeInForce", "stopLossPrice", "takeProfitPrice", "postOnly", "clientOrderId", "triggerPrice", "stopLoss", "takeProfit", "trailingAmount", "trailingTriggerPrice", "hedged"}))
...
func (this *Bybit) EditOrderRequest(id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"stopPrice", "stopLossPrice", "takeProfitPrice", "triggerPrice", "clientOrderId", "stopLoss", "takeProfit"}))
	return request
}
...
func (this *Bybit) cancelOrdersForSymbolsBody(ch chan any, orders any, optionalArgs ...any) any {
	...
	for i := 0; i < GetArrayLength(orders); i++ {
		...
		params = MapTyped(GetValue(currentCategoryparamsVariable, 1))
...
func (this *Bybit) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if !isUnifiedAccount {
		...
		var retRes531719 map[string]any = MapTyped(PanicOnError((<-this.FetchOrderClassicAsync(id, symbol, params))))
		ch <- BoxAbsent(retRes531719)
		return nil
	}
	var acknowledge any = false
	var acknowledgeparamsVariable []any = this.HandleOptionBoolAndParams(params, "fetchOrder", "acknowledged", false)
	...
	var isTriggerparamsVariable []any = this.HandleParamBool2(params, "trigger", "stop", false)
...
func (this *Bybit) fetchOrdersClassicBody(ch chan any, optionalArgs ...any) any {
	...
	var paginate bool = false
	var paginateparamsVariable []any = this.HandleOptionBoolAndParams(params, "fetchOrdersClassic", "paginate", false)
	paginate = GetValueBool(paginateparamsVariable, 0, false)
	params = MapTyped(GetValue(paginateparamsVariable, 1))
	if paginate {

		var retRes542819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOrdersClassic", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes542819)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market any = nil
	...
	var response map[string]any = MapTyped(PanicOnError((<-this.PrivateGetV5OrderHistory(this.Extend(request, params))).Raw))
	//
	//     {
	//         "retCode": 0,
	//         "retMsg": "OK",
...
func (this *Bybit) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes561119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes561119)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market any = nil
...
func (this *Bybit) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes573315 []any = ListTyped(PanicOnError((<-this.FetchCanceledAndClosedOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes573315)
	return nil
}
...
func (this *Bybit) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var retRes576115 []any = ListTyped(PanicOnError((<-this.FetchCanceledAndClosedOrdersAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes576115)
	return nil
}
...
func (this *Bybit) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes579019 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes579019)
		return nil
	}
	var request map[string]any = map[string]any{}
	var market any = nil
...
func (this *Bybit) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	params = MapTyped(this.Omit(params, []any{"clientOrderId", "orderLinkId"}))

	var retRes590715 []any = ListTyped(PanicOnError((<-this.FetchMyTradesAsync(symbol, since, limit, this.Extend(request, params)))))
	ch <- BoxAbsent(retRes590715)
	return nil
}
...
func (this *Bybit) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes593119 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes593119)
		return nil
	}
	var request map[string]any = map[string]any{
		"execType": "Trade",
...
func (this *Bybit) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes611219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes611219)
		return nil
	}
	var request map[string]any = map[string]any{}
...
func (this *Bybit) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes618319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes618319)
		return nil
	}
	var request map[string]any = map[string]any{}
	var currency map[string]any = nil
...
func (this *Bybit) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes637219 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes637219)
		return nil
	}
	var request map[string]any = map[string]any{}
...
func (this *Bybit) withdrawBody(ch chan any, code any, amount any, address any, optionalArgs ...any) any {
	...
	var accounts []any = ListTyped(PanicOnError((<-this.IsUnifiedEnabledAsync())))
	var isUta any = GetValue(accounts, 1)
	var accountTypeparamsVariable []any = this.HandleOptionStringAndParams(params, "withdraw", "accountType")
	accountType = SafeStringPtr(GetValue(accountTypeparamsVariable, 0))
	params = MapTyped(GetValue(accountTypeparamsVariable, 1))
	if accountType == nil {
		accountType = SafeStringPtr(func() string {
			if isUta == true {
				return "UTA"
			}
			return "SPOT"
...
func (this *Bybit) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes679919 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchPositions", symbols, nil, nil, params, "nextPageCursor", "cursor", nil, 200))))
	...
	if isUnifiedAccount {
		...
		if isUsdcSettled {
			...
			if leverage == nil {
				...
				params = MapTyped(this.Omit(params, []any{"buy_leverage", "sell_leverage", "sellLeverage", "buyLeverage"}))
			} else {
				sellLeverage = leverage
				buyLeverage = leverage
				params = MapTyped(this.Omit(params, "leverage"))
			}
			var request map[string]any = map[string]any{
				"category":     typeVar,
...
func (this *Bybit) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if paginate != nil && *paginate == true {
		...
		var retRes752419 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))))
		ch <- BoxAbsent(retRes752419)
		return nil
	}
	var market map[string]any = this.Market(symbol)
	...
	var retRes753615 []any = ListTyped(PanicOnError((<-this.FetchDerivativesOpenInterestHistoryAsync(symbol, timeframe, since, limit, params))))
	ch <- BoxAbsent(retRes753615)
	return nil
}
...
func (this *Bybit) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes785819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))))
		ch <- BoxAbsent(retRes785819)
		return nil
	}
	var currency map[string]any = nil
	var request map[string]any = map[string]any{}
...
func (this *Bybit) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	var retRes811215 []any = ListTyped(PanicOnError((<-this.FetchDerivativesMarketLeverageTiersAsync(symbol, params))))
	ch <- BoxAbsent(retRes811215)
	return nil
}
...
func (this *Bybit) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes880819 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes880819)
		return nil
	}
	var request map[string]any = map[string]any{
		"execType": "BustTrade",
...
func (this *Bybit) getLeverageTiersPaginatedBody(ch chan any, optionalArgs ...any) any {
	...
	var paginate bool = false
	var paginateparamsVariable []any = this.HandleOptionBoolAndParams(params, "getLeverageTiersPaginated", "paginate", false)
	paginate = GetValueBool(paginateparamsVariable, 0, false)
	params = MapTyped(GetValue(paginateparamsVariable, 1))
	if paginate {

		var retRes893319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes893319)
		return nil
	}
	var subType *string = nil
...
func (this *Bybit) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if paginate {
		...
		var retRes907319 []any = ListTyped(PanicOnError((<-this.FetchPaginatedCallCursorAsync("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))))
		ch <- BoxAbsent(retRes907319)
		return nil
	}
	var request map[string]any = map[string]any{
		"execType": "Funding",
...
func (this *Bybit) Sign(path any, optionalArgs ...any) any {
	...
	if IsEqual(api, "public") {
		...
		if isOpenapi {
			...
			var payload *string = SafeStringPtr(Add(Add(timestamp, this.ApiKey), body))
