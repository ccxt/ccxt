...
func (this *BybitCore) FetchBorrowInterest(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes754412 := (<-this.LoadMarkets())
			PanicOnError(retRes754412)
		}
		var request any = map[string]any{}
...
func (this *BybitCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes772812 := (<-this.LoadMarkets())
			PanicOnError(retRes772812)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes773319 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes797812 := (<-this.LoadMarkets())
			PanicOnError(retRes797812)
		}
		var request any = map[string]any{}
		var market any = nil
		market = this.Market(symbol)
		...
		retRes798715 := (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
		PanicOnError(retRes798715)
		ch <- retRes798715
		return nil
...
func (this *BybitCore) FetchTradingFee(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes802212 := (<-this.LoadMarkets())
			PanicOnError(retRes802212)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BybitCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes817212 := (<-this.LoadMarkets())
			PanicOnError(retRes817212)
		}
...
func (this *BybitCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes822512 := (<-this.LoadMarkets())
			PanicOnError(retRes822512)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BybitCore) FetchMySettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes828412 := (<-this.LoadMarkets())
			PanicOnError(retRes828412)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BybitCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes854212 := (<-this.LoadMarkets())
			PanicOnError(retRes854212)
		}
...
func (this *BybitCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes867512 := (<-this.LoadMarkets())
			PanicOnError(retRes867512)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes868019 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes868019)
			ch <- retRes868019
			return nil
		}
		var request any = map[string]any{
...
func (this *BybitCore) GetLeverageTiersPaginated(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes879612 := (<-this.LoadMarkets())
			PanicOnError(retRes879612)
		}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
			market = this.Market(symbol)
		...
		if IsTrue(paginate) {
			...
			retRes880519 := (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes880519)
			ch <- retRes880519
			return nil
		}
		var subType any = nil
...
func (this *BybitCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes894519 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes894519)
			ch <- retRes894519
			return nil
		}
		var request any = map[string]any{
...
func (this *BybitCore) FetchOption(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes904012 := (<-this.LoadMarkets())
			PanicOnError(retRes904012)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"category": "option",
...
func (this *BybitCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes910512 := (<-this.LoadMarkets())
			PanicOnError(retRes910512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"category": "option",
...
func (this *BybitCore) FetchConvertCurrencies(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes931012 := (<-this.LoadMarkets())
			PanicOnError(retRes931012)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertQuote(fromCode any, toCode any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes941212 := (<-this.LoadMarkets())
			PanicOnError(retRes941212)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes950412 := (<-this.LoadMarkets())
			PanicOnError(retRes950412)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes957012 := (<-this.LoadMarkets())
			PanicOnError(retRes957012)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(limit, nil)) {
			AddElementToObject(request, "limit", limit)
...
func (this *BybitCore) FetchLongShortRatioHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes968412 := (<-this.LoadMarkets())
			PanicOnError(retRes968412)
		}
		var market any = this.Market(symbol)
		var typeVar any = nil
...
func (this *BybitCore) FetchMarginMode(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes989812 := (<-this.LoadMarkets())
			PanicOnError(retRes989812)
		}
		var market any = this.Market(symbol)
