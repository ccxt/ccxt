...
func (this *BybitCore) fetchMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(GetValue(this.Options, "adjustForTimeDifference"), true)) {
		...
		retRes194512 := (<-this.LoadTimeDifference())
...
func (this *BybitCore) fetchBidsAsksBody(ch chan any, optionalArgs ...any) any {
	...
	retRes277415 := (<-this.FetchTickers(symbols, params))
...
func (this *BybitCore) fetchOHLCVBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes282819 := (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func (this *BybitCore) fetchFundingRateHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes308719 := (<-this.FetchPaginatedCallDynamic("fetchFundingRateHistory", symbol, since, limit, params, 200))
...
func (this *BybitCore) createMarketBuyOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes415815 := (<-this.CreateOrder(symbol, "market", "buy", OpNeg(1), nil, this.Extend(req, params)))
...
func (this *BybitCore) createMarketSellOrderWithCostBody(ch chan any, symbol any, cost any, optionalArgs ...any) any {
	...
	retRes418715 := (<-this.CreateOrder(symbol, "market", "sell", OpNeg(1), nil, this.Extend(req, params)))
...
func (this *BybitCore) editOrderBody(ch chan any, id any, symbol any, typeVar any, side any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes475612 := (<-this.LoadMarkets())
		PanicOnError(retRes475612)
	}
	if IsTrue(IsEqual(symbol, nil)) {
...
func (this *BybitCore) cancelAllOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes517412 := (<-this.LoadMarkets())
		PanicOnError(retRes517412)
	}
	enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
	enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
	enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 1)
...
func (this *BybitCore) fetchOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes528912 := (<-this.LoadMarkets())
		PanicOnError(retRes528912)
	}
	enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
	enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
	enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 1)
	...
	if !IsTrue(isUnifiedAccount) {
		...
		retRes529419 := (<-this.FetchOrderClassic(id, symbol, params))
		PanicOnError(retRes529419)
		ch <- retRes529419
		return nil
	}
...
func (this *BybitCore) fetchOrdersClassicBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes540219 := (<-this.FetchPaginatedCallCursor("fetchOrdersClassic", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) fetchOpenOrderBody(ch chan any, id any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes554212 := (<-this.LoadMarkets())
		PanicOnError(retRes554212)
	}
	var request map[string]any = map[string]any{
		"orderId": id,
	}
...
func (this *BybitCore) fetchCanceledAndClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes558519 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) fetchClosedOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes570715 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BybitCore) fetchCanceledOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	retRes573515 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BybitCore) fetchOpenOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes576419 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) fetchOrderTradesBody(ch chan any, id any, optionalArgs ...any) any {
	...
	retRes588115 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
	PanicOnError(retRes588115)
	ch <- retRes588115
	return nil
}
...
func (this *BybitCore) fetchMyTradesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes590519 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func (this *BybitCore) fetchDepositAddressBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes605512 := (<-this.LoadMarkets())
		PanicOnError(retRes605512)
	}
	var currency any = this.Currency(code)
...
func (this *BybitCore) fetchDepositsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes608619 := (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
		PanicOnError(retRes608619)
		ch <- retRes608619
		return nil
	}
	var request any = map[string]any{}
...
func (this *BybitCore) fetchWithdrawalsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes615212 := (<-this.LoadMarkets())
		PanicOnError(retRes615212)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes615719 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) fetchLedgerBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes634319 := (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) fetchPositionsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes676219 := (<-this.FetchPaginatedCallCursor("fetchPositions", symbols, nil, nil, params, "nextPageCursor", "cursor", nil, 200))
...
func (this *BybitCore) setLeverageBody(ch chan any, leverage any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes724612 := (<-this.LoadMarkets())
		PanicOnError(retRes724612)
	}
	var market any = this.Market(symbol)
...
func (this *BybitCore) fetchOpenInterestBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes740312 := (<-this.LoadMarkets())
		PanicOnError(retRes740312)
	}
	var market any = this.Market(symbol)
...
func (this *BybitCore) fetchOpenInterestHistoryBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes747212 := (<-this.LoadMarkets())
		PanicOnError(retRes747212)
	}
	...
	if IsTrue(IsEqual(paginate, true)) {
		...
		retRes747819 := (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
		PanicOnError(retRes747819)
		ch <- retRes747819
		return nil
	}
	var market any = this.Market(symbol)
	...
	retRes749015 := (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func (this *BybitCore) fetchBorrowInterestBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes762312 := (<-this.LoadMarkets())
		PanicOnError(retRes762312)
	}
	var request map[string]any = map[string]any{}
...
func (this *BybitCore) transferBody(ch chan any, code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes775112 := (<-this.LoadMarkets())
		PanicOnError(retRes775112)
	}
...
func (this *BybitCore) fetchTransfersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes781219 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) fetchDerivativesMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes800612 := (<-this.LoadMarkets())
		PanicOnError(retRes800612)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BybitCore) fetchMarketLeverageTiersBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes805712 := (<-this.LoadMarkets())
		PanicOnError(retRes805712)
	}
	var request map[string]any = map[string]any{}
	var market any = nil
	market = this.Market(symbol)
	...
	retRes806615 := (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
	PanicOnError(retRes806615)
	ch <- retRes806615
	return nil
}
...
func (this *BybitCore) fetchTradingFeeBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes810112 := (<-this.LoadMarkets())
		PanicOnError(retRes810112)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"symbol": GetValue(market, "id"),
...
func (this *BybitCore) fetchSettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes830412 := (<-this.LoadMarkets())
		PanicOnError(retRes830412)
	}
	var request map[string]any = map[string]any{}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BybitCore) fetchMySettlementHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes836312 := (<-this.LoadMarkets())
		PanicOnError(retRes836312)
	}
	var request map[string]any = map[string]any{}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BybitCore) fetchVolatilityHistoryBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes849212 := (<-this.LoadMarkets())
		PanicOnError(retRes849212)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"category": "option",
...
func (this *BybitCore) fetchMyLiquidationsBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes875412 := (<-this.LoadMarkets())
		PanicOnError(retRes875412)
	}
	var paginate any = false
	...
	if IsTrue(paginate) {
		...
		retRes875919 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
		PanicOnError(retRes875919)
		ch <- retRes875919
		return nil
	}
	var request any = map[string]any{
...
func (this *BybitCore) getLeverageTiersPaginatedBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes887512 := (<-this.LoadMarkets())
		PanicOnError(retRes887512)
	}
	var market any = nil
	if IsTrue(!IsEqual(symbol, nil)) {
		market = this.Market(symbol)
	...
	if IsTrue(paginate) {
		...
		retRes888419 := (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
		PanicOnError(retRes888419)
		ch <- retRes888419
		return nil
	}
	var subType any = nil
...
func (this *BybitCore) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes891812 := (<-this.LoadMarkets())
		PanicOnError(retRes891812)
	}
	var market any = nil
	var symbol any = nil
	if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *BybitCore) fetchFundingHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(paginate) {
		...
		retRes902419 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
		PanicOnError(retRes902419)
		ch <- retRes902419
		return nil
	}
	var request any = map[string]any{
...
func (this *BybitCore) fetchOptionBody(ch chan any, symbol any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes911912 := (<-this.LoadMarkets())
		PanicOnError(retRes911912)
	}
	var market any = this.Market(symbol)
	var request map[string]any = map[string]any{
		"category": "option",
...
func (this *BybitCore) fetchOptionChainBody(ch chan any, code any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes918412 := (<-this.LoadMarkets())
		PanicOnError(retRes918412)
	}
	var currency any = this.Currency(code)
	var request map[string]any = map[string]any{
		"category": "option",
...
func (this *BybitCore) fetchPositionsHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes930512 := (<-this.LoadMarkets())
		PanicOnError(retRes930512)
	}
	var market any = nil
	var subType any = nil
...
func (this *BybitCore) fetchConvertCurrenciesBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes938912 := (<-this.LoadMarkets())
		PanicOnError(retRes938912)
	}
	var accountType any = nil
	enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
	enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) fetchConvertQuoteBody(ch chan any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes949112 := (<-this.LoadMarkets())
		PanicOnError(retRes949112)
	}
	var accountType any = nil
	enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
	enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) createConvertTradeBody(ch chan any, id any, fromCode any, toCode any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes954812 := (<-this.LoadMarkets())
		PanicOnError(retRes954812)
	}
	var request map[string]any = map[string]any{
		"quoteTxId": id,
	}
...
func (this *BybitCore) fetchConvertTradeHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes964912 := (<-this.LoadMarkets())
		PanicOnError(retRes964912)
	}
	var request map[string]any = map[string]any{}
	if IsTrue(!IsEqual(limit, nil)) {
		AddElementToObject(request, "limit", limit)
...
func (this *BybitCore) fetchLongShortRatioHistoryBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes976312 := (<-this.LoadMarkets())
		PanicOnError(retRes976312)
	}
	var market any = this.Market(symbol)
	var typeVar any = nil
...
func (this *BybitCore) fetchPositionsADLRankBody(ch chan any, optionalArgs ...any) any {
	...
	if IsTrue(IsEqual(this.Markets, nil)) {
		...
		retRes984312 := (<-this.LoadMarkets())
		PanicOnError(retRes984312)
	}
	symbols = this.MarketSymbols(symbols, nil, true, true, true)
