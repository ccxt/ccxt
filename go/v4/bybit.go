...
func (this *BybitCore) FetchFundingRateHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes303119 := (<-this.FetchPaginatedCallDynamic("fetchFundingRateHistory", symbol, since, limit, params, 200))
			PanicOnError(retRes303119)
			ch <- retRes303119
			return nil
		}
		if IsTrue(IsEqual(limit, nil)) {
...
func (this *BybitCore) FetchTrades(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes336312 := (<-this.LoadMarkets())
			PanicOnError(retRes336312)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BybitCore) CreateMarketBuyOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes409415 := (<-this.CreateOrder(symbol, "market", "buy", OpNeg(1), nil, this.Extend(req, params)))
		PanicOnError(retRes409415)
		ch <- retRes409415
		return nil
...
func (this *BybitCore) CreateMarketSellOrderWithCost(symbol any, cost any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes412315 := (<-this.CreateOrder(symbol, "market", "sell", OpNeg(1), nil, this.Extend(req, params)))
...
func (this *BybitCore) EditOrders(orders any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes471912 := (<-this.LoadMarkets())
			PanicOnError(retRes471912)
		}
		var ordersRequests any = []any{}
		var orderSymbols any = []any{}
		for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func (this *BybitCore) CancelOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes484212 := (<-this.LoadMarkets())
			PanicOnError(retRes484212)
		}
		var market any = this.Market(symbol)
...
func (this *BybitCore) CancelOrders(ids any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes487912 := (<-this.LoadMarkets())
			PanicOnError(retRes487912)
		}
		var market any = this.Market(symbol)
...
func (this *BybitCore) CancelAllOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes509512 := (<-this.LoadMarkets())
			PanicOnError(retRes509512)
		}
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
		enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 1)
...
func (this *BybitCore) FetchOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if !IsTrue(isUnifiedAccount) {
			...
			retRes521519 := (<-this.FetchOrderClassic(id, symbol, params))
			PanicOnError(retRes521519)
			ch <- retRes521519
			return nil
		}
...
func (this *BybitCore) FetchOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes531915 := (<-this.FetchOrdersClassic(symbol, since, limit, params))
...
func (this *BybitCore) FetchOrdersClassic(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes534719 := (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
			PanicOnError(retRes534719)
			ch <- retRes534719
			return nil
		}
		var request any = map[string]any{}
...
func (this *BybitCore) FetchOpenOrder(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes548712 := (<-this.LoadMarkets())
			PanicOnError(retRes548712)
		}
		var request any = map[string]any{
			"orderId": id,
		}
...
func (this *BybitCore) FetchCanceledAndClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes553019 := (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchClosedOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes565215 := (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func (this *BybitCore) FetchOpenOrders(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes570919 := (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchOrderTrades(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes582615 := (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
		PanicOnError(retRes582615)
		ch <- retRes582615
		return nil
...
func (this *BybitCore) FetchMyTrades(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes584512 := (<-this.LoadMarkets())
			PanicOnError(retRes584512)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes585019 := (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes585019)
			ch <- retRes585019
			return nil
		}
		var request any = map[string]any{
...
func (this *BybitCore) FetchDeposits(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes603119 := (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchWithdrawals(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes610219 := (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
			PanicOnError(retRes610219)
			ch <- retRes610219
			return nil
		}
		var request any = map[string]any{}
...
func (this *BybitCore) FetchLedger(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes628819 := (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) FetchPositions(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes670212 := (<-this.LoadMarkets())
			PanicOnError(retRes670212)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes670719 := (<-this.FetchPaginatedCallCursor("fetchPositions", symbols, nil, nil, params, "nextPageCursor", "cursor", nil, 200))
...
func (this *BybitCore) SetLeverage(leverage any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes719012 := (<-this.LoadMarkets())
			PanicOnError(retRes719012)
		}
		var market any = this.Market(symbol)
...
func (this *BybitCore) FetchOpenInterestHistory(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes740912 := (<-this.LoadMarkets())
			PanicOnError(retRes740912)
		}
		...
		if IsTrue(paginate) {
			...
			retRes741519 := (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
			PanicOnError(retRes741519)
			ch <- retRes741519
			return nil
		}
		var market any = this.Market(symbol)
		...
		retRes742715 := (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func (this *BybitCore) FetchCrossBorrowRate(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes746312 := (<-this.LoadMarkets())
			PanicOnError(retRes746312)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin": GetValue(currency, "id"),
...
func (this *BybitCore) FetchBorrowRateHistory(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes758512 := (<-this.LoadMarkets())
			PanicOnError(retRes758512)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
...
func (this *BybitCore) Transfer(code any, amount any, fromAccount any, toAccount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes766412 := (<-this.LoadMarkets())
			PanicOnError(retRes766412)
		}
...
func (this *BybitCore) FetchTransfers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes772012 := (<-this.LoadMarkets())
			PanicOnError(retRes772012)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes772519 := (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func (this *BybitCore) BorrowCrossMargin(code any, amount any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes777912 := (<-this.LoadMarkets())
			PanicOnError(retRes777912)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"coin":   GetValue(currency, "id"),
...
func (this *BybitCore) FetchDerivativesMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes791912 := (<-this.LoadMarkets())
			PanicOnError(retRes791912)
		}
		var market any = this.Market(symbol)
		var request any = map[string]any{
			"symbol": GetValue(market, "id"),
...
func (this *BybitCore) FetchMarketLeverageTiers(symbol any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		retRes797915 := (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
		PanicOnError(retRes797915)
		ch <- retRes797915
		return nil
...
func (this *BybitCore) FetchDepositWithdrawFees(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes816012 := (<-this.LoadMarkets())
			PanicOnError(retRes816012)
		}
...
func (this *BybitCore) FetchSettlementHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes821312 := (<-this.LoadMarkets())
			PanicOnError(retRes821312)
		}
		var request any = map[string]any{}
		var market any = nil
		if IsTrue(!IsEqual(symbol, nil)) {
...
func (this *BybitCore) FetchAllGreeks(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes853012 := (<-this.LoadMarkets())
			PanicOnError(retRes853012)
		}
...
func (this *BybitCore) FetchMyLiquidations(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes866819 := (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func (this *BybitCore) GetLeverageTiersPaginated(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(paginate) {
			...
			retRes879319 := (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes879319)
			ch <- retRes879319
			return nil
		}
		var subType any = nil
...
func (this *BybitCore) FetchLeverageTiers(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes882712 := (<-this.LoadMarkets())
			PanicOnError(retRes882712)
		}
		var market any = nil
		var symbol any = nil
		if IsTrue(!IsEqual(symbols, nil)) {
...
func (this *BybitCore) FetchFundingHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes892712 := (<-this.LoadMarkets())
			PanicOnError(retRes892712)
		}
		var paginate any = false
		...
		if IsTrue(paginate) {
			...
			retRes893219 := (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
			PanicOnError(retRes893219)
			ch <- retRes893219
			return nil
		}
		var request any = map[string]any{
...
func (this *BybitCore) FetchOptionChain(code any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes909212 := (<-this.LoadMarkets())
			PanicOnError(retRes909212)
		}
		var currency any = this.Currency(code)
		var request any = map[string]any{
			"category": "option",
...
func (this *BybitCore) FetchPositionsHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes921312 := (<-this.LoadMarkets())
			PanicOnError(retRes921312)
		}
		var market any = nil
		var subType any = nil
...
func (this *BybitCore) FetchConvertTrade(id any, optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes948512 := (<-this.LoadMarkets())
			PanicOnError(retRes948512)
		}
		var accountType any = nil
		enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled())
		enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable, 0)
...
func (this *BybitCore) FetchConvertTradeHistory(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes955112 := (<-this.LoadMarkets())
			PanicOnError(retRes955112)
		}
		var request any = map[string]any{}
		if IsTrue(!IsEqual(limit, nil)) {
			AddElementToObject(request, "limit", limit)
...
func (this *BybitCore) FetchPositionsADLRank(optionalArgs ...any) <-chan any {
	...
	go func() any {
		...
		if IsTrue(IsEqual(this.Markets, nil)) {
			...
			retRes974512 := (<-this.LoadMarkets())
			PanicOnError(retRes974512)
		}
		symbols = this.MarketSymbols(symbols, nil, true, true, true)
