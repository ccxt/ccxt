...
func (this *Kucoin) fetchStatusBody(ch chan any, optionalArgs ...any) any {
	...
	if EvalTruthy(uta) {
		...
		var defaultTradeType string = Ternary((defaultType != nil && *defaultType == "spot"), "SPOT", "FUTURES").(string)
...
func (this *Kucoin) fetchUTAMarketsBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(symbolsData)); i++ {
		...
		var isMarginable bool = Ternary((hasMargin != nil && *hasMargin == "1"), true, false).(bool)
...
func (this *Kucoin) cancelAllUtaOrdersBody(ch chan any, optionalArgs ...any) any {
	...
	var market any = this.Market(symbol)
	var isContract any = GetValue(market, "contract")
	var tradeType string = Ternary((IsEqual(isContract, true)), "FUTURES", "SPOT").(string)
	...
	var orderFilter string = Ternary((IsEqual(trigger, true)), "ADVANCED", "NORMAL").(string)
	var request map[string]any = map[string]any{
		"accountMode": "unified",
		"symbol":      GetValue(market, "id"),
		"tradeType":   tradeType,
...
func (this *Kucoin) ParseContractOrder(order any, optionalArgs ...any) any {
	...
	status = Ternary((cancelExist != nil && *cancelExist == true), "canceled", status)
	var fee any = nil
	if feeCost != nil {
		fee = map[string]any{
...
func (this *Kucoin) cancelOrdersBody(ch chan any, ids any, optionalArgs ...any) any {
	...
	if EvalTruthy(uta) {
		...
		var requestKey string = Ternary(useClientorderId, "clientOidsList", "orderIdsList").(string)
...
func (this *Kucoin) ParseMarginModification(info any, optionalArgs ...any) any {
	...
	var mode string = Ternary((IsEqual(crossMode, true)), "cross", "isolated").(string)
...
func (this *Kucoin) setPositionModeBody(ch chan any, hedged any, optionalArgs ...any) any {
	...
	var posMode string = Ternary(EvalTruthy(hedged), "1", "0").(string)
	var request map[string]any = map[string]any{
...
func (this *Kucoin) fetchLeverageTiersBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(tiers)); i++ {
		...
		if symbol != nil {
			...
			retRes1154916 := GetValue(result, symbol)
