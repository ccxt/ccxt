...
func  (this *Kucoin) ParseSpotOrUtaTicker(ticker any, optionalArgs ...any) any  {
    ...
    if (percentage != nil) {
        ...
        if EvalTruthy(this.SafeBool(market, "spot", false)) {
            percentage = Precise.StringMul(percentage, "100")
        }
    }
...
func (this *Kucoin) FetchAllGreeks(options ...FetchAllGreeksOptions) (AllGreeks, error) {return this.exchangeTyped.FetchAllGreeks(options...)}
...
func (this *Kucoin) FetchDepositsWs(options ...FetchDepositsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchDepositsWs(options...)}
...
func (this *Kucoin) FetchWithdrawalsWs(options ...FetchWithdrawalsWsOptions) ([]Transaction, error) {return this.exchangeTyped.FetchWithdrawalsWs(options...)}
