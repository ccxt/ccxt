...
func  (this *KucoinCore) FetchSpotOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            response = (<-this.PrivateGetOrderClientOrderClientOid(this.Extend(request, params)))
                ...
                // https://github.com/mtan11/ccxt/issues/7234
...
func  (this *KucoinCore) ParseSpotOrUtaTrade(trade interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    //     }
    //
    // fetchMyTrades v2 alternative format since 2019-05-21 https://github.com/mtan11/ccxt/pull/5162
    //
    //     {
    //         "symbol": "OPEN-BTC",
    //         "forceTaker":  false,
...
func  (this *KucoinCore) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = GetValue(requestparamsVariable,1)
            var response interface{} = nil
            if IsTrue(IsTrue(!IsEqual(since, nil)) && IsTrue(IsLessThan(since, int64(1550448000000)))) {
