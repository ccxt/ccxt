...
func (this *Kucoin) ParseContractTicker(ticker any, optionalArgs ...any) any {
	...
	var change any = this.SafeString(ticker, "priceChg")
	var percentage any = nil
	if IsTrue(IsTrue((IsEqual(last, nil))) || IsTrue((IsEqual(change, nil)))) {
...
func (this *Kucoin) ParseOrderTimeInForce(timeInForce any) any {
...
func (this *Kucoin) ParseOrderStatus(status any) any {
...
func (this *Kucoin) ParseTransactionStatus(status any) any {
	var statuses map[string]any = map[string]any{
		"SUCCESS":           "ok",
		"PROCESSING":        "pending",
...
func (this *Kucoin) ParseTransferStatus(status any) any {
	var statuses map[string]any = map[string]any{
		"PROCESSING": "pending",
	}
	if IsTrue(IsEqual(status, nil)) {
...
func (this *Kucoin) ParseLedgerEntryType(typeVar any) any {
	var types map[string]any = map[string]any{
...
func (this *Kucoin) ParseLedgerStatus(status any) any {
	var statuses map[string]any = map[string]any{
		"Completed": "ok",
		"Pending":   "pending",
	}
...
func (this *Kucoin) fetchFundingRatesBody(ch chan any, optionalArgs ...any) any {
	...
	for i := 0; IsLessThan(i, GetArrayLength(data)); i++ {
		...
		var isFundingIndex bool = IsTrue((!IsEqual(marketId, nil))) && IsTrue((StartsWith(marketId, ".")))
