...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes908034 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes908034)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes460093 := (<-this.LoadMarkets())
            PanicOnError(retRes460093)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes808251 := (<-this.LoadMarkets())
            PanicOnError(retRes808251)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes496967 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes496967)
                    ch <- retRes496967
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes210388 := (<-this.LoadMarkets())
            PanicOnError(retRes210388)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes247629 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes247629)
                    ch <- retRes247629
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes685755 := (<-this.LoadMarkets())
            PanicOnError(retRes685755)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes55924 := (<-this.LoadMarkets())
            PanicOnError(retRes55924)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes85909 := (<-this.LoadMarkets())
            PanicOnError(retRes85909)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes164700 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes164700)
                ch <- retRes164700
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583061 := (<-this.LoadMarkets())
            PanicOnError(retRes583061)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes734211 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes734211)
                    ch <- retRes734211
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633989 := (<-this.LoadMarkets())
            PanicOnError(retRes633989)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes107731 := (<-this.LoadMarkets())
            PanicOnError(retRes107731)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes946722 := (<-this.LoadMarkets())
            PanicOnError(retRes946722)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes976099 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes976099)
                ch <- retRes976099
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes496982 := (<-this.LoadMarkets())
            PanicOnError(retRes496982)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes690992 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes690992)
                ch <- retRes690992
                return nil
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes287034 := (<-this.LoadMarkets())
            PanicOnError(retRes287034)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes268777 := (<-this.LoadMarkets())
            PanicOnError(retRes268777)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes763174 := (<-this.LoadMarkets())
            PanicOnError(retRes763174)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes184879 := (<-this.LoadMarkets())
            PanicOnError(retRes184879)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes459708 := (<-this.LoadMarkets())
            PanicOnError(retRes459708)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903105 := (<-this.LoadMarkets())
            PanicOnError(retRes903105)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes343768 := (<-this.LoadMarkets())
            PanicOnError(retRes343768)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes343634 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes343634)
                    ch <- retRes343634
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes65527 := (<-this.LoadMarkets())
            PanicOnError(retRes65527)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes627173 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes627173)
                    ch <- retRes627173
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes531845 := (<-this.LoadMarkets())
            PanicOnError(retRes531845)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
