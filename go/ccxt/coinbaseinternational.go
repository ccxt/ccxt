...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes481033 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes481033)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes194332 := (<-this.LoadMarkets())
            PanicOnError(retRes194332)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes216858 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes216858)
                    ch <- retRes216858
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999228 := (<-this.LoadMarkets())
            PanicOnError(retRes999228)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes846758 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes846758)
                    ch <- retRes846758
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes462530 := (<-this.LoadMarkets())
            PanicOnError(retRes462530)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes671105 := (<-this.LoadMarkets())
            PanicOnError(retRes671105)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes283597 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes283597)
                ch <- retRes283597
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes642987 := (<-this.LoadMarkets())
            PanicOnError(retRes642987)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes956564 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes956564)
                    ch <- retRes956564
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518478 := (<-this.LoadMarkets())
            PanicOnError(retRes518478)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes759847 := (<-this.LoadMarkets())
            PanicOnError(retRes759847)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes104213 := (<-this.LoadMarkets())
            PanicOnError(retRes104213)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes421355 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes421355)
                ch <- retRes421355
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes652670 := (<-this.LoadMarkets())
            PanicOnError(retRes652670)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes979395 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes979395)
                ch <- retRes979395
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes47601 := (<-this.LoadMarkets())
            PanicOnError(retRes47601)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes332668 := (<-this.LoadMarkets())
            PanicOnError(retRes332668)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes822778 := (<-this.LoadMarkets())
            PanicOnError(retRes822778)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes532452 := (<-this.LoadMarkets())
            PanicOnError(retRes532452)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes623945 := (<-this.LoadMarkets())
            PanicOnError(retRes623945)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339491 := (<-this.LoadMarkets())
            PanicOnError(retRes339491)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes985397 := (<-this.LoadMarkets())
            PanicOnError(retRes985397)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes478829 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes478829)
                    ch <- retRes478829
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915567 := (<-this.LoadMarkets())
            PanicOnError(retRes915567)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes613847 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes613847)
                    ch <- retRes613847
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes688745 := (<-this.LoadMarkets())
            PanicOnError(retRes688745)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
