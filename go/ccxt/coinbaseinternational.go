...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes672863 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes672863)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes868485 := (<-this.LoadMarkets())
            PanicOnError(retRes868485)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes453565 := (<-this.LoadMarkets())
            PanicOnError(retRes453565)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes244130 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes244130)
                    ch <- retRes244130
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes466084 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes466084)
                    ch <- retRes466084
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes80853 := (<-this.LoadMarkets())
            PanicOnError(retRes80853)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes401952 := (<-this.LoadMarkets())
            PanicOnError(retRes401952)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes545327 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes545327)
                ch <- retRes545327
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes7370 := (<-this.LoadMarkets())
            PanicOnError(retRes7370)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes227278 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes227278)
                    ch <- retRes227278
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50782 := (<-this.LoadMarkets())
            PanicOnError(retRes50782)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes651655 := (<-this.LoadMarkets())
            PanicOnError(retRes651655)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes636565 := (<-this.LoadMarkets())
            PanicOnError(retRes636565)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes378227 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes378227)
                ch <- retRes378227
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727871 := (<-this.LoadMarkets())
            PanicOnError(retRes727871)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes620334 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes620334)
                ch <- retRes620334
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860767 := (<-this.LoadMarkets())
            PanicOnError(retRes860767)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes552359 := (<-this.LoadMarkets())
            PanicOnError(retRes552359)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes893432 := (<-this.LoadMarkets())
            PanicOnError(retRes893432)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes821443 := (<-this.LoadMarkets())
            PanicOnError(retRes821443)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637168 := (<-this.LoadMarkets())
            PanicOnError(retRes637168)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes958142 := (<-this.LoadMarkets())
            PanicOnError(retRes958142)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes612823 := (<-this.LoadMarkets())
            PanicOnError(retRes612823)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes701619 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860699 := (<-this.LoadMarkets())
            PanicOnError(retRes860699)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes656310 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes656310)
                    ch <- retRes656310
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes366158 := (<-this.LoadMarkets())
            PanicOnError(retRes366158)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
