...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes786892 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes786892)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes383252 := (<-this.LoadMarkets())
            PanicOnError(retRes383252)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes841387 := (<-this.LoadMarkets())
            PanicOnError(retRes841387)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes391991 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes391991)
                    ch <- retRes391991
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes442381 := (<-this.LoadMarkets())
            PanicOnError(retRes442381)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes234428 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89885 := (<-this.LoadMarkets())
            PanicOnError(retRes89885)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes759801 := (<-this.LoadMarkets())
            PanicOnError(retRes759801)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes422227 := (<-this.LoadMarkets())
            PanicOnError(retRes422227)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes546705 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes546705)
                ch <- retRes546705
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes114647 := (<-this.LoadMarkets())
            PanicOnError(retRes114647)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes257803 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes257803)
                    ch <- retRes257803
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859774 := (<-this.LoadMarkets())
            PanicOnError(retRes859774)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes374309 := (<-this.LoadMarkets())
            PanicOnError(retRes374309)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes554188 := (<-this.LoadMarkets())
            PanicOnError(retRes554188)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes593315 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277619 := (<-this.LoadMarkets())
            PanicOnError(retRes277619)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes937607 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes937607)
                ch <- retRes937607
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes66754 := (<-this.LoadMarkets())
            PanicOnError(retRes66754)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes590269 := (<-this.LoadMarkets())
            PanicOnError(retRes590269)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71410 := (<-this.LoadMarkets())
            PanicOnError(retRes71410)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283814 := (<-this.LoadMarkets())
            PanicOnError(retRes283814)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835056 := (<-this.LoadMarkets())
            PanicOnError(retRes835056)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes159073 := (<-this.LoadMarkets())
            PanicOnError(retRes159073)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes7040 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes7040)
                    ch <- retRes7040
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes539592 := (<-this.LoadMarkets())
            PanicOnError(retRes539592)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes384308 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes384308)
                    ch <- retRes384308
                    return nil
            }
            var market interface{} = nil
