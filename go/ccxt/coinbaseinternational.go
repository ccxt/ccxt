...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes87204 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes87204)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526194 := (<-this.LoadMarkets())
            PanicOnError(retRes526194)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes647832 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes647832)
                    ch <- retRes647832
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes254407 := (<-this.LoadMarkets())
            PanicOnError(retRes254407)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes225854 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909370 := (<-this.LoadMarkets())
            PanicOnError(retRes909370)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes588121 := (<-this.LoadMarkets())
            PanicOnError(retRes588121)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes127435 := (<-this.LoadMarkets())
            PanicOnError(retRes127435)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes964717 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes964717)
                ch <- retRes964717
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes231229 := (<-this.LoadMarkets())
            PanicOnError(retRes231229)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes326654 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes326654)
                    ch <- retRes326654
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes513937 := (<-this.LoadMarkets())
            PanicOnError(retRes513937)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes219939 := (<-this.LoadMarkets())
            PanicOnError(retRes219939)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "type", "WITHDRAW")
                ...
                retRes452078 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes452078)
                ch <- retRes452078
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes7127 := (<-this.LoadMarkets())
            PanicOnError(retRes7127)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes294467 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes294467)
                ch <- retRes294467
                return nil
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes640331 := (<-this.LoadMarkets())
            PanicOnError(retRes640331)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes698332 := (<-this.LoadMarkets())
            PanicOnError(retRes698332)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes563191 := (<-this.LoadMarkets())
            PanicOnError(retRes563191)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278832 := (<-this.LoadMarkets())
            PanicOnError(retRes278832)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes890932 := (<-this.LoadMarkets())
            PanicOnError(retRes890932)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes402057 := (<-this.LoadMarkets())
            PanicOnError(retRes402057)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes701279 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes701279)
                    ch <- retRes701279
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes369993 := (<-this.LoadMarkets())
            PanicOnError(retRes369993)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes417446 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes417446)
                    ch <- retRes417446
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes524369 := (<-this.LoadMarkets())
            PanicOnError(retRes524369)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
