...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes703622 := (<-this.LoadCurrencyNetworks(currencyCode))
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244238 := (<-this.LoadMarkets())
            PanicOnError(retRes244238)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes274080 := (<-this.LoadMarkets())
            PanicOnError(retRes274080)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes197669 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes545737 := (<-this.LoadMarkets())
            PanicOnError(retRes545737)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes347222 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes347222)
                    ch <- retRes347222
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes533339 := (<-this.LoadMarkets())
            PanicOnError(retRes533339)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes654441 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes654441)
                ch <- retRes654441
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes941510 := (<-this.LoadMarkets())
            PanicOnError(retRes941510)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes987053 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes987053)
                    ch <- retRes987053
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes399143 := (<-this.LoadMarkets())
            PanicOnError(retRes399143)
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes360516 := (<-this.LoadMarkets())
            PanicOnError(retRes360516)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes653137 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes653137)
                ch <- retRes653137
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes938801 := (<-this.LoadMarkets())
            PanicOnError(retRes938801)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes240640 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes240640)
                ch <- retRes240640
                return nil
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes554506 := (<-this.LoadMarkets())
            PanicOnError(retRes554506)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes35887 := (<-this.LoadMarkets())
            PanicOnError(retRes35887)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes197755 := (<-this.LoadMarkets())
            PanicOnError(retRes197755)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes598711 := (<-this.LoadMarkets())
            PanicOnError(retRes598711)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674639 := (<-this.LoadMarkets())
            PanicOnError(retRes674639)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917260 := (<-this.LoadMarkets())
            PanicOnError(retRes917260)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes907722 := (<-this.LoadMarkets())
            PanicOnError(retRes907722)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes176852 := (<-this.LoadMarkets())
            PanicOnError(retRes176852)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes419464 := (<-this.LoadMarkets())
            PanicOnError(retRes419464)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes173013 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes173013)
                    ch <- retRes173013
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes553542 := (<-this.LoadMarkets())
            PanicOnError(retRes553542)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes786342 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes786342)
                    ch <- retRes786342
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes361146 := (<-this.LoadMarkets())
            PanicOnError(retRes361146)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
