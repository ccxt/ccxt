...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes579595 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes579595)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279421 := (<-this.LoadMarkets())
            PanicOnError(retRes279421)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes897234 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes897234)
                    ch <- retRes897234
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes146959 := (<-this.LoadMarkets())
            PanicOnError(retRes146959)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes211027 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes211027)
                    ch <- retRes211027
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72460 := (<-this.LoadMarkets())
            PanicOnError(retRes72460)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes363322 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes363322)
                ch <- retRes363322
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes562037 := (<-this.LoadMarkets())
            PanicOnError(retRes562037)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes991413 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes991413)
                    ch <- retRes991413
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95658 := (<-this.LoadMarkets())
            PanicOnError(retRes95658)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes267915 := (<-this.LoadMarkets())
            PanicOnError(retRes267915)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes931502 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes931502)
                ch <- retRes931502
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860004 := (<-this.LoadMarkets())
            PanicOnError(retRes860004)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes816387 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes816387)
                ch <- retRes816387
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes342713 := (<-this.LoadMarkets())
            PanicOnError(retRes342713)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes889195 := (<-this.LoadMarkets())
            PanicOnError(retRes889195)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22900 := (<-this.LoadMarkets())
            PanicOnError(retRes22900)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes555458 := (<-this.LoadMarkets())
            PanicOnError(retRes555458)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes196860 := (<-this.LoadMarkets())
            PanicOnError(retRes196860)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes55907 := (<-this.LoadMarkets())
            PanicOnError(retRes55907)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240345 := (<-this.LoadMarkets())
            PanicOnError(retRes240345)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes177343 := (<-this.LoadMarkets())
            PanicOnError(retRes177343)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes209993 := (<-this.LoadMarkets())
            PanicOnError(retRes209993)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes370152 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes370152)
                    ch <- retRes370152
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes110908 := (<-this.LoadMarkets())
            PanicOnError(retRes110908)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes967059 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes967059)
                    ch <- retRes967059
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes722201 := (<-this.LoadMarkets())
            PanicOnError(retRes722201)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
