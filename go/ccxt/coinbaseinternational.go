...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes702858 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes702858)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes749216 := (<-this.LoadMarkets())
            PanicOnError(retRes749216)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes289687 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes289687)
                    ch <- retRes289687
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes42767 := (<-this.LoadMarkets())
            PanicOnError(retRes42767)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes541508 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes541508)
                    ch <- retRes541508
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872487 := (<-this.LoadMarkets())
            PanicOnError(retRes872487)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes212380 := (<-this.LoadMarkets())
            PanicOnError(retRes212380)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes714981 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes714981)
                ch <- retRes714981
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes758341 := (<-this.LoadMarkets())
            PanicOnError(retRes758341)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes331262 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes331262)
                    ch <- retRes331262
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes691311 := (<-this.LoadMarkets())
            PanicOnError(retRes691311)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes993893 := (<-this.LoadMarkets())
            PanicOnError(retRes993893)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980766 := (<-this.LoadMarkets())
            PanicOnError(retRes980766)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes262712 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes741270 := (<-this.LoadMarkets())
            PanicOnError(retRes741270)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes393469 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes393469)
                ch <- retRes393469
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes324165 := (<-this.LoadMarkets())
            PanicOnError(retRes324165)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes367190 := (<-this.LoadMarkets())
            PanicOnError(retRes367190)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes968766 := (<-this.LoadMarkets())
            PanicOnError(retRes968766)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240822 := (<-this.LoadMarkets())
            PanicOnError(retRes240822)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes888031 := (<-this.LoadMarkets())
            PanicOnError(retRes888031)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes138882 := (<-this.LoadMarkets())
            PanicOnError(retRes138882)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917754 := (<-this.LoadMarkets())
            PanicOnError(retRes917754)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes61326 := (<-this.LoadMarkets())
            PanicOnError(retRes61326)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes491378 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes491378)
                    ch <- retRes491378
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes976742 := (<-this.LoadMarkets())
            PanicOnError(retRes976742)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes71075 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes71075)
                    ch <- retRes71075
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674496 := (<-this.LoadMarkets())
            PanicOnError(retRes674496)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
