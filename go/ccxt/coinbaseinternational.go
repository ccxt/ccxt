...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes66063 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes66063)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638886 := (<-this.LoadMarkets())
            PanicOnError(retRes638886)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes576374 := (<-this.LoadMarkets())
            PanicOnError(retRes576374)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes115958 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes115958)
                    ch <- retRes115958
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes815840 := (<-this.LoadMarkets())
            PanicOnError(retRes815840)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes695676 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes695676)
                    ch <- retRes695676
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637501 := (<-this.LoadMarkets())
            PanicOnError(retRes637501)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes641481 := (<-this.LoadMarkets())
            PanicOnError(retRes641481)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes180820 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes180820)
                ch <- retRes180820
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937092 := (<-this.LoadMarkets())
            PanicOnError(retRes937092)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes577814 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes577814)
                    ch <- retRes577814
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909916 := (<-this.LoadMarkets())
            PanicOnError(retRes909916)
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes489208 := (<-this.LoadMarkets())
            PanicOnError(retRes489208)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes971427 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes971427)
                ch <- retRes971427
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes765977 := (<-this.LoadMarkets())
            PanicOnError(retRes765977)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes21823 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes21823)
                ch <- retRes21823
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes591600 := (<-this.LoadMarkets())
            PanicOnError(retRes591600)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes479426 := (<-this.LoadMarkets())
            PanicOnError(retRes479426)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes290508 := (<-this.LoadMarkets())
            PanicOnError(retRes290508)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes997281 := (<-this.LoadMarkets())
            PanicOnError(retRes997281)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes428532 := (<-this.LoadMarkets())
            PanicOnError(retRes428532)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes169227 := (<-this.LoadMarkets())
            PanicOnError(retRes169227)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes132871 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes333429 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes333429)
                    ch <- retRes333429
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes719481 := (<-this.LoadMarkets())
            PanicOnError(retRes719481)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
