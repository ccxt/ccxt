...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes223282 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes223282)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes210533 := (<-this.LoadMarkets())
            PanicOnError(retRes210533)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes218147 := (<-this.LoadMarkets())
            PanicOnError(retRes218147)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes92614 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes92614)
                    ch <- retRes92614
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes940144 := (<-this.LoadMarkets())
            PanicOnError(retRes940144)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes363886 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes363886)
                    ch <- retRes363886
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes785615 := (<-this.LoadMarkets())
            PanicOnError(retRes785615)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes729542 := (<-this.LoadMarkets())
            PanicOnError(retRes729542)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672885 := (<-this.LoadMarkets())
            PanicOnError(retRes672885)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes779395 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes779395)
                ch <- retRes779395
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes694307 := (<-this.LoadMarkets())
            PanicOnError(retRes694307)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes254054 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes254054)
                    ch <- retRes254054
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875858 := (<-this.LoadMarkets())
            PanicOnError(retRes875858)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes362299 := (<-this.LoadMarkets())
            PanicOnError(retRes362299)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782230 := (<-this.LoadMarkets())
            PanicOnError(retRes782230)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes129005 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes129005)
                ch <- retRes129005
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes912922 := (<-this.LoadMarkets())
            PanicOnError(retRes912922)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes590932 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes590932)
                ch <- retRes590932
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696491 := (<-this.LoadMarkets())
            PanicOnError(retRes696491)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes613553 := (<-this.LoadMarkets())
            PanicOnError(retRes613553)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes763871 := (<-this.LoadMarkets())
            PanicOnError(retRes763871)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes919643 := (<-this.LoadMarkets())
            PanicOnError(retRes919643)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes448592 := (<-this.LoadMarkets())
            PanicOnError(retRes448592)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes729713 := (<-this.LoadMarkets())
            PanicOnError(retRes729713)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes516983 := (<-this.LoadMarkets())
            PanicOnError(retRes516983)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes414821 := (<-this.LoadMarkets())
            PanicOnError(retRes414821)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes870521 := (<-this.LoadMarkets())
            PanicOnError(retRes870521)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes563327 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes563327)
                    ch <- retRes563327
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490525 := (<-this.LoadMarkets())
            PanicOnError(retRes490525)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes263029 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes263029)
                    ch <- retRes263029
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes787711 := (<-this.LoadMarkets())
            PanicOnError(retRes787711)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
