...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes116782 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes116782)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858938 := (<-this.LoadMarkets())
            PanicOnError(retRes858938)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes556805 := (<-this.LoadMarkets())
            PanicOnError(retRes556805)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes389779 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes389779)
                    ch <- retRes389779
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes482460 := (<-this.LoadMarkets())
            PanicOnError(retRes482460)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes986914 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes986914)
                    ch <- retRes986914
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes481828 := (<-this.LoadMarkets())
            PanicOnError(retRes481828)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes892790 := (<-this.LoadMarkets())
            PanicOnError(retRes892790)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes35400 := (<-this.LoadMarkets())
            PanicOnError(retRes35400)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes990884 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes990884)
                ch <- retRes990884
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87067 := (<-this.LoadMarkets())
            PanicOnError(retRes87067)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes144867 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes144867)
                    ch <- retRes144867
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes560085 := (<-this.LoadMarkets())
            PanicOnError(retRes560085)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339556 := (<-this.LoadMarkets())
            PanicOnError(retRes339556)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes596332 := (<-this.LoadMarkets())
            PanicOnError(retRes596332)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes349064 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes349064)
                ch <- retRes349064
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378466 := (<-this.LoadMarkets())
            PanicOnError(retRes378466)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes511867 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes511867)
                ch <- retRes511867
                return nil
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes766893 := (<-this.LoadMarkets())
            PanicOnError(retRes766893)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes431977 := (<-this.LoadMarkets())
            PanicOnError(retRes431977)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes773113 := (<-this.LoadMarkets())
            PanicOnError(retRes773113)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes67486 := (<-this.LoadMarkets())
            PanicOnError(retRes67486)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes251195 := (<-this.LoadMarkets())
            PanicOnError(retRes251195)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes727366 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes727366)
                    ch <- retRes727366
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes61768 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes923228 := (<-this.LoadMarkets())
            PanicOnError(retRes923228)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
