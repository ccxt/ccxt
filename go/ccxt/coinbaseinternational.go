...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes968171 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes968171)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes312042 := (<-this.LoadMarkets())
            PanicOnError(retRes312042)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes281828 := (<-this.LoadMarkets())
            PanicOnError(retRes281828)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes18144 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes18144)
                    ch <- retRes18144
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes97840 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes4490 := (<-this.LoadMarkets())
            PanicOnError(retRes4490)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733932 := (<-this.LoadMarkets())
            PanicOnError(retRes733932)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782022 := (<-this.LoadMarkets())
            PanicOnError(retRes782022)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes937339 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes937339)
                ch <- retRes937339
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes360427 := (<-this.LoadMarkets())
            PanicOnError(retRes360427)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes825894 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes825894)
                    ch <- retRes825894
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes169365 := (<-this.LoadMarkets())
            PanicOnError(retRes169365)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes861634 := (<-this.LoadMarkets())
            PanicOnError(retRes861634)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes945510 := (<-this.LoadMarkets())
            PanicOnError(retRes945510)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes289458 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes289458)
                ch <- retRes289458
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637480 := (<-this.LoadMarkets())
            PanicOnError(retRes637480)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes465762 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes465762)
                ch <- retRes465762
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes787112 := (<-this.LoadMarkets())
            PanicOnError(retRes787112)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes679078 := (<-this.LoadMarkets())
            PanicOnError(retRes679078)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes552692 := (<-this.LoadMarkets())
            PanicOnError(retRes552692)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes570847 := (<-this.LoadMarkets())
            PanicOnError(retRes570847)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90556 := (<-this.LoadMarkets())
            PanicOnError(retRes90556)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes388967 := (<-this.LoadMarkets())
            PanicOnError(retRes388967)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116171 := (<-this.LoadMarkets())
            PanicOnError(retRes116171)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes501807 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes501807)
                    ch <- retRes501807
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes17117 := (<-this.LoadMarkets())
            PanicOnError(retRes17117)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes850141 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes850141)
                    ch <- retRes850141
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbaseinternational) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes156682 := (<-this.LoadMarkets())
            PanicOnError(retRes156682)
            var currency interface{} = this.Currency(code)
            var portfolio interface{} = nil
