...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes593914 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes593914)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes704372 := (<-this.LoadMarkets())
            PanicOnError(retRes704372)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486134 := (<-this.LoadMarkets())
            PanicOnError(retRes486134)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes164500 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes164500)
                    ch <- retRes164500
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes149167 := (<-this.LoadMarkets())
            PanicOnError(retRes149167)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes841009 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes841009)
                    ch <- retRes841009
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654383 := (<-this.LoadMarkets())
            PanicOnError(retRes654383)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915730 := (<-this.LoadMarkets())
            PanicOnError(retRes915730)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858338 := (<-this.LoadMarkets())
            PanicOnError(retRes858338)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes272825 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes272825)
                ch <- retRes272825
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes993853 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes993853)
                    ch <- retRes993853
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes197223 := (<-this.LoadMarkets())
            PanicOnError(retRes197223)
...
func  (this *coinbaseinternational) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246594 := (<-this.LoadMarkets())
            PanicOnError(retRes246594)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97196 := (<-this.LoadMarkets())
            PanicOnError(retRes97196)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes69610 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes69610)
                ch <- retRes69610
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703326 := (<-this.LoadMarkets())
            PanicOnError(retRes703326)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes538039 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes538039)
                ch <- retRes538039
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes270218 := (<-this.LoadMarkets())
            PanicOnError(retRes270218)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes357095 := (<-this.LoadMarkets())
            PanicOnError(retRes357095)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87405 := (<-this.LoadMarkets())
            PanicOnError(retRes87405)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835514 := (<-this.LoadMarkets())
            PanicOnError(retRes835514)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes673648 := (<-this.LoadMarkets())
            PanicOnError(retRes673648)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes367563 := (<-this.LoadMarkets())
            PanicOnError(retRes367563)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes544068 := (<-this.LoadMarkets())
            PanicOnError(retRes544068)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes744384 := (<-this.LoadMarkets())
            PanicOnError(retRes744384)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes408277 := (<-this.LoadMarkets())
            PanicOnError(retRes408277)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes285987 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes285987)
                    ch <- retRes285987
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes769382 := (<-this.LoadMarkets())
            PanicOnError(retRes769382)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes223201 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes223201)
                    ch <- retRes223201
                    return nil
            }
            var market interface{} = nil
