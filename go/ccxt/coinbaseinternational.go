...
func  (this *coinbaseinternational) HandleNetworkIdAndParams(currencyCode interface{}, methodName interface{}, params interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(networkId, nil)) {
                ...
                retRes876609 := (<-this.LoadCurrencyNetworks(currencyCode))
                PanicOnError(retRes876609)
...
func  (this *coinbaseinternational) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes351935 := (<-this.LoadMarkets())
            PanicOnError(retRes351935)
...
func  (this *coinbaseinternational) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes258303 := (<-this.LoadMarkets())
            PanicOnError(retRes258303)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes648005 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes648005)
                    ch <- retRes648005
                    return nil
            }
...
func  (this *coinbaseinternational) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes737625 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes737625)
                    ch <- retRes737625
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes407887 := (<-this.LoadMarkets())
            PanicOnError(retRes407887)
            var request interface{} = map[string]interface{} {
                "type": "FUNDING",
            }
...
func  (this *coinbaseinternational) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81000 := (<-this.LoadMarkets())
            PanicOnError(retRes81000)
            var request interface{} = map[string]interface{} {
                "type": "INTERNAL",
            }
...
func  (this *coinbaseinternational) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes460607 := (<-this.LoadMarkets())
            PanicOnError(retRes460607)
...
func  (this *coinbaseinternational) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes363392 :=  (<-this.V1PrivatePostPortfoliosMargin(this.Extend(request, params)))
                PanicOnError(retRes363392)
                ch <- retRes363392
                return nil
...
func  (this *coinbaseinternational) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes977975 := (<-this.LoadMarkets())
            PanicOnError(retRes977975)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes563909 :=  (<-this.FetchPaginatedCallIncremental("fetchDepositsWithdrawals", code, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes563909)
                    ch <- retRes563909
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes985557 := (<-this.LoadMarkets())
            PanicOnError(retRes985557)
...
func  (this *coinbaseinternational) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes211238 := (<-this.LoadMarkets())
            PanicOnError(retRes211238)
            AddElementToObject(params, "type", "WITHDRAW")
        
                retRes808876 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes808876)
                ch <- retRes808876
                return nil
...
func  (this *coinbaseinternational) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes365279 := (<-this.LoadMarkets())
            PanicOnError(retRes365279)
            AddElementToObject(params, "type", "DEPOSIT")
        
                retRes658464 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, params))
                PanicOnError(retRes658464)
                ch <- retRes658464
                return nil
...
func  (this *coinbaseinternational) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes193207 := (<-this.LoadMarkets())
            PanicOnError(retRes193207)
            symbols = this.MarketSymbols(symbols)
...
func  (this *coinbaseinternational) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes201211 := (<-this.LoadMarkets())
            PanicOnError(retRes201211)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument": this.MarketId(symbol),
            }
...
func  (this *coinbaseinternational) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91746 := (<-this.LoadMarkets())
            PanicOnError(retRes91746)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes549007 := (<-this.LoadMarkets())
            PanicOnError(retRes549007)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "asset": GetValue(currency, "id"),
                "ammount": amount,
...
func  (this *coinbaseinternational) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes978004 := (<-this.LoadMarkets())
            PanicOnError(retRes978004)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseinternational) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes349929 := (<-this.LoadMarkets())
            PanicOnError(retRes349929)
            var portfolio interface{} = nil
...
func  (this *coinbaseinternational) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241206 := (<-this.LoadMarkets())
            PanicOnError(retRes241206)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *coinbaseinternational) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes888242 := (<-this.LoadMarkets())
            PanicOnError(retRes888242)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbaseinternational) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes598632 := (<-this.LoadMarkets())
            PanicOnError(retRes598632)
            var portfolio interface{} = nil
            ...
            if IsTrue(paginate) {
                    ...
                    retRes684010 :=  (<-this.FetchPaginatedCallIncremental("fetchOpenOrders", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes684010)
                    ch <- retRes684010
                    return nil
            }
            var page interface{} = Subtract(this.SafeInteger(params, pageKey, 1), 1)
...
func  (this *coinbaseinternational) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes818846 := (<-this.LoadMarkets())
            PanicOnError(retRes818846)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes529547 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, pageKey, maxEntriesPerRequest))
                    PanicOnError(retRes529547)
                    ch <- retRes529547
                    return nil
            }
            var market interface{} = nil
