...
func  (this *woo) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes909043 := (<-this.LoadTimeDifference())
...
func  (this *woo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes722481 := (<-this.LoadMarkets())
            PanicOnError(retRes722481)
...
func  (this *woo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes780899 := (<-this.LoadMarkets())
            PanicOnError(retRes780899)
...
func  (this *woo) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes194972 := (<-this.LoadMarkets())
            PanicOnError(retRes194972)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes597517 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes597517)
                ch <- retRes597517
                return nil
...
func  (this *woo) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes711261 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes711261)
                ch <- retRes711261
                return nil
...
func  (this *woo) CreateTrailingAmountOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes272298 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes272298)
                ch <- retRes272298
                return nil
...
func  (this *woo) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes275787 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
...
func  (this *woo) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70200 := (<-this.LoadMarkets())
            PanicOnError(retRes70200)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes920666 := (<-this.LoadMarkets())
            PanicOnError(retRes920666)
...
func  (this *woo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes387245 := (<-this.LoadMarkets())
            PanicOnError(retRes387245)
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger")
            params = this.Omit(params, []interface{}{"stop", "trigger"})
            if IsTrue(trigger) {
        
                    retRes909089 :=  (<-this.V3PrivateDeleteAlgoOrdersPending(params))
                    PanicOnError(retRes909089)
                    ch <- retRes909089
                    return nil
            }
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *woo) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes257467 := (<-this.LoadMarkets())
            PanicOnError(retRes257467)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes925106 := (<-this.LoadMarkets())
            PanicOnError(retRes925106)
...
func  (this *woo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes142395 := (<-this.LoadMarkets())
            PanicOnError(retRes142395)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes228479 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes228479)
                    ch <- retRes228479
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470563 := (<-this.LoadMarkets())
            PanicOnError(retRes470563)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes829506 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes829506)
                ch <- retRes829506
                return nil
...
func  (this *woo) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes880863 := (<-this.LoadMarkets())
            PanicOnError(retRes880863)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes314512 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func  (this *woo) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes630703 := (<-this.LoadMarkets())
            PanicOnError(retRes630703)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674032 := (<-this.LoadMarkets())
            PanicOnError(retRes674032)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes649616 := (<-this.LoadMarkets())
            PanicOnError(retRes649616)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes831450 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes831450)
                    ch <- retRes831450
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes598025 := (<-this.LoadMarkets())
            PanicOnError(retRes598025)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes611028 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes611028)
                ch <- retRes611028
                return nil
...
func  (this *woo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes754277 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes754277)
                ch <- retRes754277
                return nil
...
func  (this *woo) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes951956 := (<-this.LoadMarkets())
            PanicOnError(retRes951956)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497769 := (<-this.LoadMarkets())
            PanicOnError(retRes497769)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "amount": amount,
...
func  (this *woo) RepayMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98260 := (<-this.LoadMarkets())
            PanicOnError(retRes98260)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *woo) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882720 := (<-this.LoadMarkets())
            PanicOnError(retRes882720)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes429070 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "page", "page", 1, 500))
                    PanicOnError(retRes429070)
                    ch <- retRes429070
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes792309 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes792309)
                ch <- retRes792309
                return nil
...
func  (this *woo) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875990 := (<-this.LoadMarkets())
            PanicOnError(retRes875990)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes42532 := (<-this.LoadMarkets())
            PanicOnError(retRes42532)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes660042 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes660042)
                    ch <- retRes660042
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes471081 := (<-this.LoadMarkets())
            PanicOnError(retRes471081)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *woo) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes121267 := (<-this.LoadMarkets())
            PanicOnError(retRes121267)
            var request interface{} = map[string]interface{} {
                "leverage": leverage,
            }
            var market interface{} = nil
            ...
            if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(GetValue(market, "spot"))) {
                    ...
                    retRes487097 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                    PanicOnError(retRes487097)
                    ch <- retRes487097
                    return nil
            } else if IsTrue(GetValue(market, "swap")) {
                AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                AddElementToObject(request, "margin_mode", this.EncodeMarginMode(marginMode))
                    ...
                    retRes578003 :=  (<-this.V1PrivatePostClientFuturesLeverage(this.Extend(request, params)))
                    PanicOnError(retRes578003)
                    ch <- retRes578003
                    return nil
            } else {
                panic(NotSupported(Add(Add(Add(this.Id, " fetchLeverage() is not supported for "), GetValue(market, "type")), " markets")))
...
func  (this *woo) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes568609 :=  (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
...
func  (this *woo) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes955084 :=  (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
                PanicOnError(retRes955084)
                ch <- retRes955084
                return nil
...
func  (this *woo) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes516575 := (<-this.LoadMarkets())
            PanicOnError(retRes516575)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "adjust_token": "USDT",
                ...
                retRes214088 :=  (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
                PanicOnError(retRes214088)
                ch <- retRes214088
                return nil
...
func  (this *woo) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes365757 := (<-this.LoadMarkets())
            PanicOnError(retRes365757)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes586002 := (<-this.LoadMarkets())
            PanicOnError(retRes586002)
...
func  (this *woo) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes922127 := (<-this.LoadMarkets())
            PanicOnError(retRes922127)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633228 := (<-this.LoadMarkets())
            PanicOnError(retRes633228)
