...
func  (this *woo) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes595708 := (<-this.LoadTimeDifference())
                PanicOnError(retRes595708)
            }
...
func  (this *woo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes42181 := (<-this.LoadMarkets())
            PanicOnError(retRes42181)
...
func  (this *woo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes612633 := (<-this.LoadMarkets())
            PanicOnError(retRes612633)
...
func  (this *woo) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes458800 := (<-this.LoadMarkets())
            PanicOnError(retRes458800)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes164670 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes164670)
                ch <- retRes164670
                return nil
...
func  (this *woo) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes629746 := (<-this.LoadMarkets())
            PanicOnError(retRes629746)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketSellOrderWithCost() supports spot orders only")))
            }
        
                retRes154736 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes154736)
                ch <- retRes154736
                return nil
...
func  (this *woo) CreateTrailingAmountOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes121264 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes121264)
                ch <- retRes121264
                return nil
...
func  (this *woo) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes812602 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes812602)
                ch <- retRes812602
                return nil
...
func  (this *woo) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes714219 := (<-this.LoadMarkets())
            PanicOnError(retRes714219)
            var market interface{} = this.Market(symbol)
...
func  (this *woo) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes304181 := (<-this.LoadMarkets())
            PanicOnError(retRes304181)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes558243 := (<-this.LoadMarkets())
            PanicOnError(retRes558243)
...
func  (this *woo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes178362 := (<-this.LoadMarkets())
            PanicOnError(retRes178362)
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger")
            params = this.Omit(params, []interface{}{"stop", "trigger"})
            if IsTrue(trigger) {
        
                    retRes144268 :=  (<-this.V3PrivateDeleteAlgoOrdersPending(params))
                    PanicOnError(retRes144268)
                    ch <- retRes144268
                    return nil
            }
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *woo) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes974800 := (<-this.LoadMarkets())
            PanicOnError(retRes974800)
...
func  (this *woo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes618821 := (<-this.LoadMarkets())
            PanicOnError(retRes618821)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes716099 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes716099)
                    ch <- retRes716099
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes516240 := (<-this.LoadMarkets())
            PanicOnError(retRes516240)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes950121 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes950121)
                ch <- retRes950121
                return nil
...
func  (this *woo) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451847 := (<-this.LoadMarkets())
            PanicOnError(retRes451847)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes747748 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes747748)
                ch <- retRes747748
                return nil
...
func  (this *woo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes222517 := (<-this.LoadMarkets())
            PanicOnError(retRes222517)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woo) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes627642 := (<-this.LoadMarkets())
            PanicOnError(retRes627642)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes150702 := (<-this.LoadMarkets())
            PanicOnError(retRes150702)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes217882 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes217882)
                    ch <- retRes217882
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes721699 := (<-this.LoadMarkets())
            PanicOnError(retRes721699)
...
func  (this *woo) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97515 := (<-this.LoadMarkets())
            PanicOnError(retRes97515)
...
func  (this *woo) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes673560 := (<-this.LoadMarkets())
            PanicOnError(retRes673560)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes872169 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes872169)
                ch <- retRes872169
                return nil
...
func  (this *woo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes434216 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func  (this *woo) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes107862 := (<-this.LoadMarkets())
            PanicOnError(retRes107862)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes723510 := (<-this.LoadMarkets())
            PanicOnError(retRes723510)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "amount": amount,
...
func  (this *woo) RepayMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes873889 := (<-this.LoadMarkets())
            PanicOnError(retRes873889)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *woo) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes772820 := (<-this.LoadMarkets())
            PanicOnError(retRes772820)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes288485 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "page", "page", 1, 500))
                    PanicOnError(retRes288485)
                    ch <- retRes288485
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes695418 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes695418)
                ch <- retRes695418
                return nil
...
func  (this *woo) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes934131 := (<-this.LoadMarkets())
            PanicOnError(retRes934131)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278384 := (<-this.LoadMarkets())
            PanicOnError(retRes278384)
...
func  (this *woo) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628739 := (<-this.LoadMarkets())
            PanicOnError(retRes628739)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes319623 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
...
func  (this *woo) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes595170 := (<-this.LoadMarkets())
            PanicOnError(retRes595170)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *woo) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes863921 := (<-this.LoadMarkets())
            PanicOnError(retRes863921)
            var request interface{} = map[string]interface{} {
                "leverage": leverage,
            }
            var market interface{} = nil
            ...
            if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(GetValue(market, "spot"))) {
                    ...
                    retRes630315 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                ...
                AddElementToObject(request, "margin_mode", this.EncodeMarginMode(marginMode))
                    ...
                    retRes301790 :=  (<-this.V1PrivatePostClientFuturesLeverage(this.Extend(request, params)))
                    PanicOnError(retRes301790)
                    ch <- retRes301790
                    return nil
            } else {
                panic(NotSupported(Add(Add(Add(this.Id, " fetchLeverage() is not supported for "), GetValue(market, "type")), " markets")))
...
func  (this *woo) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes670833 :=  (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
                PanicOnError(retRes670833)
                ch <- retRes670833
                return nil
...
func  (this *woo) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes405048 :=  (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
                PanicOnError(retRes405048)
                ch <- retRes405048
                return nil
...
func  (this *woo) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes358134 := (<-this.LoadMarkets())
            PanicOnError(retRes358134)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "adjust_token": "USDT",
                ...
                retRes34935 :=  (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
                PanicOnError(retRes34935)
                ch <- retRes34935
                return nil
...
func  (this *woo) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes832373 := (<-this.LoadMarkets())
            PanicOnError(retRes832373)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes846001 := (<-this.LoadMarkets())
            PanicOnError(retRes846001)
...
func  (this *woo) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes25059 := (<-this.LoadMarkets())
            PanicOnError(retRes25059)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278760 := (<-this.LoadMarkets())
            PanicOnError(retRes278760)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
            }
...
func  (this *woo) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes735413 := (<-this.LoadMarkets())
            PanicOnError(retRes735413)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
            }
...
func  (this *woo) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937018 := (<-this.LoadMarkets())
            PanicOnError(retRes937018)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747851 := (<-this.LoadMarkets())
            PanicOnError(retRes747851)
