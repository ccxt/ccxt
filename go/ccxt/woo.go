...
func  (this *woo) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes537776 := (<-this.LoadTimeDifference())
                PanicOnError(retRes537776)
            }
...
func  (this *woo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes171644 := (<-this.LoadMarkets())
            PanicOnError(retRes171644)
...
func  (this *woo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711776 := (<-this.LoadMarkets())
            PanicOnError(retRes711776)
...
func  (this *woo) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes222429 := (<-this.LoadMarkets())
            PanicOnError(retRes222429)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes965152 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes965152)
                ch <- retRes965152
                return nil
...
func  (this *woo) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes553122 := (<-this.LoadMarkets())
            PanicOnError(retRes553122)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketSellOrderWithCost() supports spot orders only")))
            }
        
                retRes549422 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes549422)
                ch <- retRes549422
                return nil
...
func  (this *woo) CreateTrailingAmountOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes984350 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes984350)
                ch <- retRes984350
                return nil
...
func  (this *woo) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes926359 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes926359)
                ch <- retRes926359
                return nil
...
func  (this *woo) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes871379 := (<-this.LoadMarkets())
            PanicOnError(retRes871379)
            var market interface{} = this.Market(symbol)
...
func  (this *woo) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes195961 := (<-this.LoadMarkets())
            PanicOnError(retRes195961)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22864 := (<-this.LoadMarkets())
            PanicOnError(retRes22864)
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger")
            params = this.Omit(params, []interface{}{"stop", "trigger"})
            if IsTrue(trigger) {
        
                    retRes869389 :=  (<-this.V3PrivateDeleteAlgoOrdersPending(params))
                    PanicOnError(retRes869389)
                    ch <- retRes869389
                    return nil
            }
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *woo) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes736279 := (<-this.LoadMarkets())
            PanicOnError(retRes736279)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915583 := (<-this.LoadMarkets())
            PanicOnError(retRes915583)
...
func  (this *woo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes826123 := (<-this.LoadMarkets())
            PanicOnError(retRes826123)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes144209 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes144209)
                    ch <- retRes144209
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes154788 := (<-this.LoadMarkets())
            PanicOnError(retRes154788)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes604593 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
...
func  (this *woo) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes321073 := (<-this.LoadMarkets())
            PanicOnError(retRes321073)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes797628 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes797628)
                ch <- retRes797628
                return nil
...
func  (this *woo) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes559433 := (<-this.LoadMarkets())
            PanicOnError(retRes559433)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes386791 := (<-this.LoadMarkets())
            PanicOnError(retRes386791)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woo) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes943092 := (<-this.LoadMarkets())
            PanicOnError(retRes943092)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes866695 := (<-this.LoadMarkets())
            PanicOnError(retRes866695)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes487047 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes487047)
                    ch <- retRes487047
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes27885 := (<-this.LoadMarkets())
            PanicOnError(retRes27885)
...
func  (this *woo) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes412498 := (<-this.LoadMarkets())
            PanicOnError(retRes412498)
...
func  (this *woo) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909561 := (<-this.LoadMarkets())
            PanicOnError(retRes909561)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes476167 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes476167)
                ch <- retRes476167
                return nil
...
func  (this *woo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes716478 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
...
func  (this *woo) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes285921 := (<-this.LoadMarkets())
            PanicOnError(retRes285921)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes751084 := (<-this.LoadMarkets())
            PanicOnError(retRes751084)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "amount": amount,
...
func  (this *woo) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes169214 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "page", "page", 1, 500))
                    PanicOnError(retRes169214)
                    ch <- retRes169214
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes722936 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes722936)
                ch <- retRes722936
                return nil
...
func  (this *woo) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672896 := (<-this.LoadMarkets())
            PanicOnError(retRes672896)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes54051 := (<-this.LoadMarkets())
            PanicOnError(retRes54051)
...
func  (this *woo) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes351310 := (<-this.LoadMarkets())
            PanicOnError(retRes351310)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes309318 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes309318)
                    ch <- retRes309318
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes162729 := (<-this.LoadMarkets())
            PanicOnError(retRes162729)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *woo) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(GetValue(market, "spot"))) {
                    ...
                    retRes537360 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                    PanicOnError(retRes537360)
                    ch <- retRes537360
                    return nil
            } else if IsTrue(GetValue(market, "swap")) {
                AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                AddElementToObject(request, "margin_mode", this.EncodeMarginMode(marginMode))
                    ...
                    retRes449366 :=  (<-this.V1PrivatePostClientFuturesLeverage(this.Extend(request, params)))
                    PanicOnError(retRes449366)
                    ch <- retRes449366
                    return nil
            } else {
                panic(NotSupported(Add(Add(Add(this.Id, " fetchLeverage() is not supported for "), GetValue(market, "type")), " markets")))
...
func  (this *woo) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes563171 :=  (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
                PanicOnError(retRes563171)
                ch <- retRes563171
                return nil
...
func  (this *woo) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes491334 :=  (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
                PanicOnError(retRes491334)
                ch <- retRes491334
                return nil
...
func  (this *woo) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes401534 := (<-this.LoadMarkets())
            PanicOnError(retRes401534)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "adjust_token": "USDT",
                ...
                retRes569581 :=  (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
                PanicOnError(retRes569581)
                ch <- retRes569581
                return nil
...
func  (this *woo) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes817461 := (<-this.LoadMarkets())
            PanicOnError(retRes817461)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes685038 := (<-this.LoadMarkets())
            PanicOnError(retRes685038)
...
func  (this *woo) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes538568 := (<-this.LoadMarkets())
            PanicOnError(retRes538568)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
            }
...
func  (this *woo) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes516807 := (<-this.LoadMarkets())
            PanicOnError(retRes516807)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
            }
...
func  (this *woo) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes593305 := (<-this.LoadMarkets())
            PanicOnError(retRes593305)
            var request interface{} = map[string]interface{} {}
