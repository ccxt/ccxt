...
func  (this *woo) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes452794 := (<-this.LoadTimeDifference())
                PanicOnError(retRes452794)
            }
...
func  (this *woo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73554 := (<-this.LoadMarkets())
            PanicOnError(retRes73554)
...
func  (this *woo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes831257 := (<-this.LoadMarkets())
            PanicOnError(retRes831257)
...
func  (this *woo) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes19464 := (<-this.LoadMarkets())
            PanicOnError(retRes19464)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes314043 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes314043)
                ch <- retRes314043
                return nil
...
func  (this *woo) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859385 := (<-this.LoadMarkets())
            PanicOnError(retRes859385)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketSellOrderWithCost() supports spot orders only")))
            }
        
                retRes896739 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes896739)
                ch <- retRes896739
                return nil
...
func  (this *woo) CreateTrailingAmountOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes748979 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes748979)
                ch <- retRes748979
                return nil
...
func  (this *woo) CreateTrailingPercentOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(params, "trailingTriggerPrice", trailingTriggerPrice)
                ...
                retRes957633 :=  (<-this.CreateOrder(symbol, typeVar, side, amount, price, params))
                PanicOnError(retRes957633)
                ch <- retRes957633
                return nil
...
func  (this *woo) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes791656 := (<-this.LoadMarkets())
            PanicOnError(retRes791656)
            var market interface{} = this.Market(symbol)
...
func  (this *woo) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes898002 := (<-this.LoadMarkets())
            PanicOnError(retRes898002)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes878411 := (<-this.LoadMarkets())
            PanicOnError(retRes878411)
...
func  (this *woo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87644 := (<-this.LoadMarkets())
            PanicOnError(retRes87644)
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger")
            params = this.Omit(params, []interface{}{"stop", "trigger"})
            if IsTrue(trigger) {
        
                    retRes293851 :=  (<-this.V3PrivateDeleteAlgoOrdersPending(params))
                    PanicOnError(retRes293851)
                    ch <- retRes293851
                    return nil
            }
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *woo) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240166 := (<-this.LoadMarkets())
            PanicOnError(retRes240166)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882919 := (<-this.LoadMarkets())
            PanicOnError(retRes882919)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes11006 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes11006)
                    ch <- retRes11006
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes963205 := (<-this.LoadMarkets())
            PanicOnError(retRes963205)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes277527 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes277527)
                ch <- retRes277527
                return nil
...
func  (this *woo) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244992 := (<-this.LoadMarkets())
            PanicOnError(retRes244992)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes74227 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes74227)
                ch <- retRes74227
                return nil
...
func  (this *woo) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes225272 := (<-this.LoadMarkets())
            PanicOnError(retRes225272)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378378 := (<-this.LoadMarkets())
            PanicOnError(retRes378378)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woo) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525955 := (<-this.LoadMarkets())
            PanicOnError(retRes525955)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes676947 := (<-this.LoadMarkets())
            PanicOnError(retRes676947)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes758043 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes758043)
                    ch <- retRes758043
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes786522 := (<-this.LoadMarkets())
            PanicOnError(retRes786522)
...
func  (this *woo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes358466 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes358466)
                ch <- retRes358466
                return nil
...
func  (this *woo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes264943 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes264943)
                ch <- retRes264943
                return nil
...
func  (this *woo) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes159072 := (<-this.LoadMarkets())
            PanicOnError(retRes159072)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "amount": amount,
...
func  (this *woo) RepayMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes927875 := (<-this.LoadMarkets())
            PanicOnError(retRes927875)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *woo) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes892725 := (<-this.LoadMarkets())
            PanicOnError(retRes892725)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes351458 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "page", "page", 1, 500))
                    PanicOnError(retRes351458)
                    ch <- retRes351458
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes456158 :=  (<-this.FetchFundingRate(symbol, params))
...
func  (this *woo) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes503921 := (<-this.LoadMarkets())
            PanicOnError(retRes503921)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814721 := (<-this.LoadMarkets())
            PanicOnError(retRes814721)
...
func  (this *woo) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241935 := (<-this.LoadMarkets())
            PanicOnError(retRes241935)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes33631 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes33631)
                    ch <- retRes33631
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woo) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38796 := (<-this.LoadMarkets())
            PanicOnError(retRes38796)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *woo) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes774463 := (<-this.LoadMarkets())
            PanicOnError(retRes774463)
            var request interface{} = map[string]interface{} {
                "leverage": leverage,
            }
            var market interface{} = nil
            ...
            if IsTrue(IsTrue((IsEqual(symbol, nil))) || IsTrue(GetValue(market, "spot"))) {
                    ...
                    retRes191639 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                    PanicOnError(retRes191639)
                    ch <- retRes191639
                    return nil
            } else if IsTrue(GetValue(market, "swap")) {
                AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                AddElementToObject(request, "margin_mode", this.EncodeMarginMode(marginMode))
                    ...
                    retRes115340 :=  (<-this.V1PrivatePostClientFuturesLeverage(this.Extend(request, params)))
...
func  (this *woo) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes474644 :=  (<-this.ModifyMarginHelper(symbol, amount, "ADD", params))
                PanicOnError(retRes474644)
                ch <- retRes474644
                return nil
...
func  (this *woo) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes926145 :=  (<-this.ModifyMarginHelper(symbol, amount, "REDUCE", params))
                PanicOnError(retRes926145)
                ch <- retRes926145
                return nil
...
func  (this *woo) ModifyMarginHelper(symbol interface{}, amount interface{}, typeVar interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes766841 :=  (<-this.V1PrivatePostClientIsolatedMargin(this.Extend(request, params)))
                PanicOnError(retRes766841)
                ch <- retRes766841
                return nil
...
func  (this *woo) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478335 := (<-this.LoadMarkets())
            PanicOnError(retRes478335)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woo) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes106081 := (<-this.LoadMarkets())
            PanicOnError(retRes106081)
...
func  (this *woo) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes190851 := (<-this.LoadMarkets())
            PanicOnError(retRes190851)
            var request interface{} = map[string]interface{} {
...
func  (this *woo) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes324430 := (<-this.LoadMarkets())
            PanicOnError(retRes324430)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
            }
...
func  (this *woo) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes608861 := (<-this.LoadMarkets())
            PanicOnError(retRes608861)
            var request interface{} = map[string]interface{} {
                "quoteId": id,
            }
...
func  (this *woo) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583513 := (<-this.LoadMarkets())
            PanicOnError(retRes583513)
            var request interface{} = map[string]interface{} {}
