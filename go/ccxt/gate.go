...
func  (this *gate) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes330779 :=  (<-this.PrivateUnifiedPutUnifiedMode(params))
                PanicOnError(retRes330779)
                ch <- retRes330779
                return nil
...
func  (this *gate) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes690863 := (<-this.LoadTimeDifference())
                PanicOnError(retRes690863)
            }
...
func  (this *gate) FetchCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(this.CheckRequiredCredentials(false)) {
                ...
                retRes240515 := (<-this.LoadUnifiedStatus())
...
func  (this *gate) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes481861 := (<-this.LoadMarkets())
            PanicOnError(retRes481861)
...
func  (this *gate) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes936544 := (<-this.LoadMarkets())
            PanicOnError(retRes936544)
...
func  (this *gate) FetchNetworkDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes462570 := (<-this.LoadMarkets())
            PanicOnError(retRes462570)
...
func  (this *gate) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes596910 := (<-this.LoadMarkets())
            PanicOnError(retRes596910)
            var currency interface{} = this.Currency(code)
...
func  (this *gate) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes979221 := (<-this.LoadMarkets())
            PanicOnError(retRes979221)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *gate) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929744 := (<-this.LoadMarkets())
            PanicOnError(retRes929744)
...
func  (this *gate) FetchTransactionFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes916932 := (<-this.LoadMarkets())
            PanicOnError(retRes916932)
...
func  (this *gate) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes400638 := (<-this.LoadMarkets())
            PanicOnError(retRes400638)
...
func  (this *gate) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78440 := (<-this.LoadMarkets())
            PanicOnError(retRes78440)
...
func  (this *gate) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes588036 := (<-this.LoadMarkets())
            PanicOnError(retRes588036)
            var market interface{} = this.Market(symbol)
            //
            //     const request: Dict = {
...
func  (this *gate) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes900166 := (<-this.LoadMarkets())
            PanicOnError(retRes900166)
            var market interface{} = this.Market(symbol)
            requestqueryVariable := this.PrepareRequest(market, nil, params);
            request := GetValue(requestqueryVariable,0);
            query := GetValue(requestqueryVariable,1)
...
func  (this *gate) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes295570 := (<-this.LoadMarkets())
            PanicOnError(retRes295570)
            symbols = this.MarketSymbols(symbols)
...
func  (this *gate) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954754 := (<-this.LoadMarkets())
            PanicOnError(retRes954754)
        
            retRes763422 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes763422)
...
func  (this *gate) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654237 := (<-this.LoadMarkets())
            PanicOnError(retRes654237)
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes626428 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes626428)
                    ch <- retRes626428
                    return nil
            }
            if IsTrue(GetValue(market, "option")) {
        
                    retRes842610 :=  (<-this.FetchOptionOHLCV(symbol, timeframe, since, limit, params))
                    PanicOnError(retRes842610)
                    ch <- retRes842610
                    return nil
            }
...
func  (this *gate) FetchOptionOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes417988 := (<-this.LoadMarkets())
            PanicOnError(retRes417988)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {}
            requestparamsVariable := this.PrepareRequest(market, nil, params);
            request = GetValue(requestparamsVariable,0);
...
func  (this *gate) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62169 := (<-this.LoadMarkets())
            PanicOnError(retRes62169)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes811890 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes811890)
                    ch <- retRes811890
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *gate) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875140 := (<-this.LoadMarkets())
            PanicOnError(retRes875140)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes511074 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes511074)
                    ch <- retRes511074
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *gate) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes569451 := (<-this.LoadMarkets())
            PanicOnError(retRes569451)
            //
            //      [
            //          {
            //              "id":"3711449544",
...
func  (this *gate) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes499671 := (<-this.LoadMarkets())
            PanicOnError(retRes499671)
        
            retRes85565 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes85565)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes585018 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes585018)
                    ch <- retRes585018
                    return nil
            }
...
func  (this *gate) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes223070 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes223070)
                    ch <- retRes223070
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *gate) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes387407 := (<-this.LoadMarkets())
            PanicOnError(retRes387407)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes69679 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *gate) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes734710 := (<-this.LoadMarkets())
            PanicOnError(retRes734710)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
                "address": address,
...
func  (this *gate) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes17500 := (<-this.LoadMarkets())
            PanicOnError(retRes17500)
        
            retRes652882 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes652882)
            var market interface{} = this.Market(symbol)
...
func  (this *gate) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes152891 := (<-this.LoadMarkets())
            PanicOnError(retRes152891)
        
            retRes149390 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes149390)
...
func  (this *gate) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes767122 := (<-this.LoadMarkets())
            PanicOnError(retRes767122)
        
            retRes978481 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes978481)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes705943 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                PanicOnError(retRes705943)
                ch <- retRes705943
                return nil
...
func  (this *gate) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes653084 := (<-this.LoadMarkets())
            PanicOnError(retRes653084)
        
            retRes274478 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes274478)
            var market interface{} = this.Market(symbol)
...
func  (this *gate) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes181157 := (<-this.LoadMarkets())
            PanicOnError(retRes181157)
        
            retRes7114 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes7114)
            var market interface{} = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func  (this *gate) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes27552 :=  (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
                PanicOnError(retRes27552)
                ch <- retRes27552
                return nil
...
func  (this *gate) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes235696 := (<-this.LoadMarkets())
            PanicOnError(retRes235696)
        
            retRes50228 := (<-this.LoadUnifiedStatus())
            ...
            if IsTrue(!IsTrue(useHistorical) && IsTrue((IsTrue((IsTrue(IsEqual(since, nil)) && IsTrue(IsEqual(until, nil)))) || IsTrue((!IsEqual(typeVar, "swap")))))) {
                    ...
                    retRes194575 :=  (<-this.FetchOrdersByStatus("finished", symbol, since, limit, params))
                    PanicOnError(retRes194575)
                    ch <- retRes194575
                    return nil
            }
...
func  (this *gate) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes829000 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes829000)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                symbol = GetValue(market, "symbol")
...
func  (this *gate) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes447987 := (<-this.LoadMarkets())
            PanicOnError(retRes447987)
        
            retRes356673 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes356673)
            var market interface{} = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func  (this *gate) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes823452 := (<-this.LoadMarkets())
            PanicOnError(retRes823452)
        
            retRes856968 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes856968)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if IsTrue(isSpot) {
                ...
                for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
                    ...
                    retRes240266 :=  (<-this.CancelOrdersForSymbols(ordersRequests, params))
                    PanicOnError(retRes240266)
                    ch <- retRes240266
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *gate) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes642325 := (<-this.LoadMarkets())
            PanicOnError(retRes642325)
        
            retRes143665 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes143665)
            var ordersRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *gate) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589195 := (<-this.LoadMarkets())
            PanicOnError(retRes589195)
        
            retRes638803 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes638803)
            var market interface{} = Ternary(IsTrue((IsEqual(symbol, nil))), nil, this.Market(symbol))
...
func  (this *gate) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes680737 := (<-this.LoadMarkets())
            PanicOnError(retRes680737)
            var currency interface{} = this.Currency(code)
...
func  (this *gate) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835547 := (<-this.LoadMarkets())
            PanicOnError(retRes835547)
            var market interface{} = this.Market(symbol)
            requestqueryVariable := this.PrepareRequest(market, nil, params);
            request := GetValue(requestqueryVariable,0);
            query := GetValue(requestqueryVariable,1)
...
func  (this *gate) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes445010 := (<-this.LoadMarkets())
            PanicOnError(retRes445010)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "contract")) {
...
func  (this *gate) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes888012 := (<-this.LoadMarkets())
            PanicOnError(retRes888012)
            var market interface{} = nil
...
func  (this *gate) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes575759 := (<-this.LoadMarkets())
            PanicOnError(retRes575759)
...
func  (this *gate) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes209570 := (<-this.LoadMarkets())
            PanicOnError(retRes209570)
            var market interface{} = this.Market(symbol)
...
func  (this *gate) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes175920 := (<-this.LoadMarkets())
            PanicOnError(retRes175920)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *gate) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141846 := (<-this.LoadMarkets())
            PanicOnError(retRes141846)
        
            retRes443168 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes443168)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": ToUpper(GetValue(currency, "id")),
                "amount": this.CurrencyToPrecision(code, amount),
...
func  (this *gate) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes861274 := (<-this.LoadMarkets())
            PanicOnError(retRes861274)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": ToUpper(GetValue(currency, "id")),
                "amount": this.CurrencyToPrecision(code, amount),
...
func  (this *gate) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153533 := (<-this.LoadMarkets())
            PanicOnError(retRes153533)
        
            retRes670299 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes670299)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": ToUpper(GetValue(currency, "id")),
                "amount": this.CurrencyToPrecision(code, amount),
...
func  (this *gate) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes946639 := (<-this.LoadMarkets())
            PanicOnError(retRes946639)
        
            retRes78802 := (<-this.LoadUnifiedStatus())
            PanicOnError(retRes78802)
            var isUnifiedAccount interface{} = false
...
func  (this *gate) ModifyMarginHelper(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490009 := (<-this.LoadMarkets())
            PanicOnError(retRes490009)
            var market interface{} = this.Market(symbol)
            requestqueryVariable := this.PrepareRequest(market, nil, params);
            request := GetValue(requestqueryVariable,0);
            query := GetValue(requestqueryVariable,1)
...
func  (this *gate) ReduceMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes307138 :=  (<-this.ModifyMarginHelper(symbol, OpNeg(amount), params))
                PanicOnError(retRes307138)
                ch <- retRes307138
                return nil
...
func  (this *gate) AddMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes122849 :=  (<-this.ModifyMarginHelper(symbol, amount, params))
                PanicOnError(retRes122849)
                ch <- retRes122849
                return nil
...
func  (this *gate) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes852800 := (<-this.LoadMarkets())
            PanicOnError(retRes852800)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes770570 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes770570)
                    ch <- retRes770570
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *gate) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164120 := (<-this.LoadMarkets())
            PanicOnError(retRes164120)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
...
func  (this *gate) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782171 := (<-this.LoadMarkets())
            PanicOnError(retRes782171)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
...
func  (this *gate) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes135341 := (<-this.LoadMarkets())
            PanicOnError(retRes135341)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes130316 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes130316)
                    ch <- retRes130316
                    return nil
            }
            var typeVar interface{} = nil
...
func  (this *gate) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            AddElementToObject(request, "dual_mode", hedged)
                ...
                retRes131470 :=  (<-this.PrivateFuturesPostSettleDualMode(this.Extend(request, query)))
                PanicOnError(retRes131470)
                ch <- retRes131470
                return nil
...
func  (this *gate) FetchUnderlyingAssets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes936336 := (<-this.LoadMarkets())
            PanicOnError(retRes936336)
            var marketType interface{} = nil
...
func  (this *gate) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes971850 := (<-this.LoadMarkets())
            PanicOnError(retRes971850)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "swap")) {
...
func  (this *gate) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279529 := (<-this.LoadMarkets())
            PanicOnError(retRes279529)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "contract": GetValue(market, "id"),
            }
...
func  (this *gate) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes316779 := (<-this.LoadMarkets())
            PanicOnError(retRes316779)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *gate) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(side, nil)) {
                ...
                retRes405164 :=  (<-this.CreateOrder(symbol, "market", side, 0, nil, params))
                PanicOnError(retRes405164)
                ch <- retRes405164
                return nil
...
func  (this *gate) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes965496 := (<-this.LoadMarkets())
            PanicOnError(retRes965496)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
...
func  (this *gate) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes803209 := (<-this.LoadMarkets())
            PanicOnError(retRes803209)
            symbols = this.MarketSymbols(symbols)
            var response interface{} = nil
            var isUnified interface{} = this.SafeBool(params, "unified")
            params = this.Omit(params, "unified")
...
func  (this *gate) FetchOption(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes770893 := (<-this.LoadMarkets())
            PanicOnError(retRes770893)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "contract": GetValue(market, "id"),
            }
...
func  (this *gate) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes295879 := (<-this.LoadMarkets())
            PanicOnError(retRes295879)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *gate) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339428 := (<-this.LoadMarkets())
            PanicOnError(retRes339428)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                var symbolsLength interface{} =         GetArrayLength(symbols)
