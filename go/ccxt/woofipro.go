...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes890742 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes890742)
                ch <- retRes890742
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860735 := (<-this.LoadMarkets())
            PanicOnError(retRes860735)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes676441 := (<-this.LoadMarkets())
            PanicOnError(retRes676441)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes819062 := (<-this.LoadMarkets())
            PanicOnError(retRes819062)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes516432 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes516432)
                    ch <- retRes516432
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909253 := (<-this.LoadMarkets())
            PanicOnError(retRes909253)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes284578 := (<-this.LoadMarkets())
            PanicOnError(retRes284578)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes306280 := (<-this.LoadMarkets())
            PanicOnError(retRes306280)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes404027 := (<-this.LoadMarkets())
            PanicOnError(retRes404027)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes651928 := (<-this.LoadMarkets())
            PanicOnError(retRes651928)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297098 := (<-this.LoadMarkets())
            PanicOnError(retRes297098)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes914065 := (<-this.LoadMarkets())
            PanicOnError(retRes914065)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90354 := (<-this.LoadMarkets())
            PanicOnError(retRes90354)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes723673 := (<-this.LoadMarkets())
            PanicOnError(retRes723673)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes751580 := (<-this.LoadMarkets())
            PanicOnError(retRes751580)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes558847 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes558847)
                    ch <- retRes558847
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes357834 := (<-this.LoadMarkets())
            PanicOnError(retRes357834)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes772068 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes772068)
                ch <- retRes772068
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes226173 := (<-this.LoadMarkets())
            PanicOnError(retRes226173)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes885773 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes885773)
                ch <- retRes885773
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes813335 := (<-this.LoadMarkets())
            PanicOnError(retRes813335)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes323855 := (<-this.LoadMarkets())
            PanicOnError(retRes323855)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes260445 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes260445)
                    ch <- retRes260445
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes664720 := (<-this.LoadMarkets())
            PanicOnError(retRes664720)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes1536 := (<-this.LoadMarkets())
            PanicOnError(retRes1536)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes559880 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes559880)
                ch <- retRes559880
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes88628 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes88628)
                ch <- retRes88628
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes338765 := (<-this.LoadMarkets())
            PanicOnError(retRes338765)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes334856 := (<-this.LoadMarkets())
            PanicOnError(retRes334856)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes423162 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes423162)
                ch <- retRes423162
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes216301 := (<-this.LoadMarkets())
            PanicOnError(retRes216301)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403565 := (<-this.LoadMarkets())
            PanicOnError(retRes403565)
