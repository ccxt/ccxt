...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes218657 := (<-this.LoadMarkets())
            PanicOnError(retRes218657)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes231106 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes231106)
                ch <- retRes231106
                return nil
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102198 := (<-this.LoadMarkets())
            PanicOnError(retRes102198)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes143898 := (<-this.LoadMarkets())
            PanicOnError(retRes143898)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes193080 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes193080)
                    ch <- retRes193080
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes373833 := (<-this.LoadMarkets())
            PanicOnError(retRes373833)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes377737 := (<-this.LoadMarkets())
            PanicOnError(retRes377737)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860520 := (<-this.LoadMarkets())
            PanicOnError(retRes860520)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes988554 := (<-this.LoadMarkets())
            PanicOnError(retRes988554)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes56390 := (<-this.LoadMarkets())
            PanicOnError(retRes56390)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes684785 := (<-this.LoadMarkets())
            PanicOnError(retRes684785)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes540014 := (<-this.LoadMarkets())
            PanicOnError(retRes540014)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes60933 := (<-this.LoadMarkets())
            PanicOnError(retRes60933)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes417890 := (<-this.LoadMarkets())
            PanicOnError(retRes417890)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes487109 := (<-this.LoadMarkets())
            PanicOnError(retRes487109)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes665007 := (<-this.LoadMarkets())
            PanicOnError(retRes665007)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes746105 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes746105)
                    ch <- retRes746105
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes924834 := (<-this.LoadMarkets())
            PanicOnError(retRes924834)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes953948 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes953948)
                ch <- retRes953948
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes737304 := (<-this.LoadMarkets())
            PanicOnError(retRes737304)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes321077 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes321077)
                ch <- retRes321077
                return nil
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes197857 := (<-this.LoadMarkets())
            PanicOnError(retRes197857)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes742135 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes742135)
                    ch <- retRes742135
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589366 := (<-this.LoadMarkets())
            PanicOnError(retRes589366)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes754566 := (<-this.LoadMarkets())
            PanicOnError(retRes754566)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes795001 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes795001)
                ch <- retRes795001
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes647955 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes647955)
                ch <- retRes647955
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes321903 := (<-this.LoadMarkets())
            PanicOnError(retRes321903)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768105 := (<-this.LoadMarkets())
            PanicOnError(retRes768105)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes852473 := (<-this.LoadMarkets())
            PanicOnError(retRes852473)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes507748 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes507748)
                ch <- retRes507748
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes1220 := (<-this.LoadMarkets())
            PanicOnError(retRes1220)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes910744 := (<-this.LoadMarkets())
            PanicOnError(retRes910744)
