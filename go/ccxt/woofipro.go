...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858397 := (<-this.LoadMarkets())
            PanicOnError(retRes858397)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes674369 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes674369)
                ch <- retRes674369
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes363553 := (<-this.LoadMarkets())
            PanicOnError(retRes363553)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768187 := (<-this.LoadMarkets())
            PanicOnError(retRes768187)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes806769 := (<-this.LoadMarkets())
            PanicOnError(retRes806769)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes659161 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes659161)
                    ch <- retRes659161
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes338176 := (<-this.LoadMarkets())
            PanicOnError(retRes338176)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes613771 := (<-this.LoadMarkets())
            PanicOnError(retRes613771)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes166583 := (<-this.LoadMarkets())
            PanicOnError(retRes166583)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes467952 := (<-this.LoadMarkets())
            PanicOnError(retRes467952)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes718839 := (<-this.LoadMarkets())
            PanicOnError(retRes718839)
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89157 := (<-this.LoadMarkets())
            PanicOnError(retRes89157)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654844 := (<-this.LoadMarkets())
            PanicOnError(retRes654844)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes282956 := (<-this.LoadMarkets())
            PanicOnError(retRes282956)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes491873 := (<-this.LoadMarkets())
            PanicOnError(retRes491873)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes770126 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes770126)
                    ch <- retRes770126
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes467910 := (<-this.LoadMarkets())
            PanicOnError(retRes467910)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes436852 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes436852)
                ch <- retRes436852
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes678011 := (<-this.LoadMarkets())
            PanicOnError(retRes678011)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes801271 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes801271)
                ch <- retRes801271
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes514822 := (<-this.LoadMarkets())
            PanicOnError(retRes514822)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes593163 := (<-this.LoadMarkets())
            PanicOnError(retRes593163)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes692097 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes692097)
                    ch <- retRes692097
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621279 := (<-this.LoadMarkets())
            PanicOnError(retRes621279)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes712355 := (<-this.LoadMarkets())
            PanicOnError(retRes712355)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes712709 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes712709)
                ch <- retRes712709
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes876608 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes876608)
                ch <- retRes876608
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes398869 := (<-this.LoadMarkets())
            PanicOnError(retRes398869)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes471494 := (<-this.LoadMarkets())
            PanicOnError(retRes471494)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes53134 := (<-this.LoadMarkets())
            PanicOnError(retRes53134)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes104573 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes104573)
                ch <- retRes104573
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes453471 := (<-this.LoadMarkets())
            PanicOnError(retRes453471)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes8655 := (<-this.LoadMarkets())
            PanicOnError(retRes8655)
