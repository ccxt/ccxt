...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes165671 := (<-this.LoadMarkets())
            PanicOnError(retRes165671)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes472453 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes472453)
                ch <- retRes472453
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246998 := (<-this.LoadMarkets())
            PanicOnError(retRes246998)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578484 := (<-this.LoadMarkets())
            PanicOnError(retRes578484)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes415159 := (<-this.LoadMarkets())
            PanicOnError(retRes415159)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes667153 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes667153)
                    ch <- retRes667153
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes919406 := (<-this.LoadMarkets())
            PanicOnError(retRes919406)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81687 := (<-this.LoadMarkets())
            PanicOnError(retRes81687)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes381977 := (<-this.LoadMarkets())
            PanicOnError(retRes381977)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478792 := (<-this.LoadMarkets())
            PanicOnError(retRes478792)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes232017 := (<-this.LoadMarkets())
            PanicOnError(retRes232017)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628310 := (<-this.LoadMarkets())
            PanicOnError(retRes628310)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes889974 := (<-this.LoadMarkets())
            PanicOnError(retRes889974)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71423 := (<-this.LoadMarkets())
            PanicOnError(retRes71423)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes32321 := (<-this.LoadMarkets())
            PanicOnError(retRes32321)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes485862 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes485862)
                    ch <- retRes485862
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes604122 := (<-this.LoadMarkets())
            PanicOnError(retRes604122)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes156913 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes156913)
                ch <- retRes156913
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes145718 := (<-this.LoadMarkets())
            PanicOnError(retRes145718)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes500595 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes500595)
                ch <- retRes500595
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432399 := (<-this.LoadMarkets())
            PanicOnError(retRes432399)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes232322 := (<-this.LoadMarkets())
            PanicOnError(retRes232322)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes464666 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes464666)
                    ch <- retRes464666
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278041 := (<-this.LoadMarkets())
            PanicOnError(retRes278041)
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes446532 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes446532)
                ch <- retRes446532
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes29143 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes29143)
                ch <- retRes29143
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes707189 := (<-this.LoadMarkets())
            PanicOnError(retRes707189)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131834 := (<-this.LoadMarkets())
            PanicOnError(retRes131834)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578975 := (<-this.LoadMarkets())
            PanicOnError(retRes578975)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes321596 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes321596)
                ch <- retRes321596
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes436146 := (<-this.LoadMarkets())
            PanicOnError(retRes436146)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
