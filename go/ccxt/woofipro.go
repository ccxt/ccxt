...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes734620 := (<-this.LoadMarkets())
            PanicOnError(retRes734620)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes632231 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes632231)
                ch <- retRes632231
                return nil
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes921964 := (<-this.LoadMarkets())
            PanicOnError(retRes921964)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes721277 := (<-this.LoadMarkets())
            PanicOnError(retRes721277)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes349138 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes349138)
                    ch <- retRes349138
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes935439 := (<-this.LoadMarkets())
            PanicOnError(retRes935439)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes487679 := (<-this.LoadMarkets())
            PanicOnError(retRes487679)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes29555 := (<-this.LoadMarkets())
            PanicOnError(retRes29555)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes270774 := (<-this.LoadMarkets())
            PanicOnError(retRes270774)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes281932 := (<-this.LoadMarkets())
            PanicOnError(retRes281932)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes266320 := (<-this.LoadMarkets())
            PanicOnError(retRes266320)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes756236 := (<-this.LoadMarkets())
            PanicOnError(retRes756236)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes658065 := (<-this.LoadMarkets())
            PanicOnError(retRes658065)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes729759 := (<-this.LoadMarkets())
            PanicOnError(retRes729759)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909403 := (<-this.LoadMarkets())
            PanicOnError(retRes909403)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes431641 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes431641)
                    ch <- retRes431641
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes400191 := (<-this.LoadMarkets())
            PanicOnError(retRes400191)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes55173 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes55173)
                ch <- retRes55173
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes556120 := (<-this.LoadMarkets())
            PanicOnError(retRes556120)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes105677 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes105677)
                ch <- retRes105677
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes988467 := (<-this.LoadMarkets())
            PanicOnError(retRes988467)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes213913 := (<-this.LoadMarkets())
            PanicOnError(retRes213913)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes736536 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes736536)
                    ch <- retRes736536
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes110100 := (<-this.LoadMarkets())
            PanicOnError(retRes110100)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes617045 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes617045)
                ch <- retRes617045
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes395233 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes395233)
                ch <- retRes395233
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes968607 := (<-this.LoadMarkets())
            PanicOnError(retRes968607)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes554573 := (<-this.LoadMarkets())
            PanicOnError(retRes554573)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes315797 := (<-this.LoadMarkets())
            PanicOnError(retRes315797)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes61071 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes61071)
                ch <- retRes61071
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes885224 := (<-this.LoadMarkets())
            PanicOnError(retRes885224)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954410 := (<-this.LoadMarkets())
            PanicOnError(retRes954410)
