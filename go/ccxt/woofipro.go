...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913345 := (<-this.LoadMarkets())
            PanicOnError(retRes913345)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes986308 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes986308)
                ch <- retRes986308
                return nil
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes286650 := (<-this.LoadMarkets())
            PanicOnError(retRes286650)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes101973 := (<-this.LoadMarkets())
            PanicOnError(retRes101973)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes731006 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes731006)
                    ch <- retRes731006
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes780240 := (<-this.LoadMarkets())
            PanicOnError(retRes780240)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes961222 := (<-this.LoadMarkets())
            PanicOnError(retRes961222)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes146672 := (<-this.LoadMarkets())
            PanicOnError(retRes146672)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes707480 := (<-this.LoadMarkets())
            PanicOnError(retRes707480)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859488 := (<-this.LoadMarkets())
            PanicOnError(retRes859488)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes275101 := (<-this.LoadMarkets())
            PanicOnError(retRes275101)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes575104 := (<-this.LoadMarkets())
            PanicOnError(retRes575104)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes702228 := (<-this.LoadMarkets())
            PanicOnError(retRes702228)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432611 := (<-this.LoadMarkets())
            PanicOnError(retRes432611)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes790886 := (<-this.LoadMarkets())
            PanicOnError(retRes790886)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes210433 := (<-this.LoadMarkets())
            PanicOnError(retRes210433)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes566699 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes566699)
                    ch <- retRes566699
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792684 := (<-this.LoadMarkets())
            PanicOnError(retRes792684)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes319644 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes319644)
                ch <- retRes319644
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96825 := (<-this.LoadMarkets())
            PanicOnError(retRes96825)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes852462 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes852462)
                ch <- retRes852462
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272624 := (<-this.LoadMarkets())
            PanicOnError(retRes272624)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes788965 := (<-this.LoadMarkets())
            PanicOnError(retRes788965)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes229260 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes229260)
                    ch <- retRes229260
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes818998 := (<-this.LoadMarkets())
            PanicOnError(retRes818998)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872782 := (<-this.LoadMarkets())
            PanicOnError(retRes872782)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes335160 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes335160)
                ch <- retRes335160
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes344102 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes344102)
                ch <- retRes344102
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes207385 := (<-this.LoadMarkets())
            PanicOnError(retRes207385)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740494 := (<-this.LoadMarkets())
            PanicOnError(retRes740494)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes702998 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes702998)
                ch <- retRes702998
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes532501 := (<-this.LoadMarkets())
            PanicOnError(retRes532501)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375343 := (<-this.LoadMarkets())
            PanicOnError(retRes375343)
