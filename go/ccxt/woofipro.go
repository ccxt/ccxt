...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes879384 := (<-this.LoadMarkets())
            PanicOnError(retRes879384)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes334522 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes334522)
                ch <- retRes334522
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes315890 := (<-this.LoadMarkets())
            PanicOnError(retRes315890)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes605559 := (<-this.LoadMarkets())
            PanicOnError(retRes605559)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795764 := (<-this.LoadMarkets())
            PanicOnError(retRes795764)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes781359 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes781359)
                    ch <- retRes781359
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes273590 := (<-this.LoadMarkets())
            PanicOnError(retRes273590)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180836 := (<-this.LoadMarkets())
            PanicOnError(retRes180836)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33673 := (<-this.LoadMarkets())
            PanicOnError(retRes33673)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes10660 := (<-this.LoadMarkets())
            PanicOnError(retRes10660)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes864933 := (<-this.LoadMarkets())
            PanicOnError(retRes864933)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes595791 := (<-this.LoadMarkets())
            PanicOnError(retRes595791)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes676378 := (<-this.LoadMarkets())
            PanicOnError(retRes676378)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes698160 := (<-this.LoadMarkets())
            PanicOnError(retRes698160)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes58566 := (<-this.LoadMarkets())
            PanicOnError(retRes58566)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403705 := (<-this.LoadMarkets())
            PanicOnError(retRes403705)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348560 := (<-this.LoadMarkets())
            PanicOnError(retRes348560)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes289408 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes289408)
                    ch <- retRes289408
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727374 := (<-this.LoadMarkets())
            PanicOnError(retRes727374)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes194902 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes194902)
                ch <- retRes194902
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes596677 := (<-this.LoadMarkets())
            PanicOnError(retRes596677)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes309966 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes309966)
                ch <- retRes309966
                return nil
...
func  (this *woofipro) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes547457 := (<-this.LoadMarkets())
            PanicOnError(retRes547457)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes409895 := (<-this.LoadMarkets())
            PanicOnError(retRes409895)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes772685 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes772685)
                    ch <- retRes772685
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes200057 := (<-this.LoadMarkets())
            PanicOnError(retRes200057)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes656563 := (<-this.LoadMarkets())
            PanicOnError(retRes656563)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes925567 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes925567)
                ch <- retRes925567
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes782364 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes782364)
                ch <- retRes782364
                return nil
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes908735 := (<-this.LoadMarkets())
            PanicOnError(retRes908735)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96674 := (<-this.LoadMarkets())
            PanicOnError(retRes96674)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes544610 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes544610)
                ch <- retRes544610
                return nil
...
func  (this *woofipro) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes981484 := (<-this.LoadMarkets())
            PanicOnError(retRes981484)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes765238 := (<-this.LoadMarkets())
            PanicOnError(retRes765238)
