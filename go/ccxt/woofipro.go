...
func  (this *woofipro) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes479847 := (<-this.LoadMarkets())
            PanicOnError(retRes479847)
...
func  (this *woofipro) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes272989 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes272989)
                ch <- retRes272989
                return nil
...
func  (this *woofipro) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes647767 := (<-this.LoadMarkets())
            PanicOnError(retRes647767)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes159198 := (<-this.LoadMarkets())
            PanicOnError(retRes159198)
...
func  (this *woofipro) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38781 := (<-this.LoadMarkets())
            PanicOnError(retRes38781)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes700926 :=  (<-this.FetchPaginatedCallIncremental("fetchFundingRateHistory", symbol, since, limit, params, "page", 25))
                    PanicOnError(retRes700926)
                    ch <- retRes700926
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes234983 := (<-this.LoadMarkets())
            PanicOnError(retRes234983)
...
func  (this *woofipro) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes569002 := (<-this.LoadMarkets())
            PanicOnError(retRes569002)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *woofipro) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94372 := (<-this.LoadMarkets())
            PanicOnError(retRes94372)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *woofipro) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes302456 := (<-this.LoadMarkets())
            PanicOnError(retRes302456)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes122623 := (<-this.LoadMarkets())
            PanicOnError(retRes122623)
...
func  (this *woofipro) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180398 := (<-this.LoadMarkets())
            PanicOnError(retRes180398)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *woofipro) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes828858 := (<-this.LoadMarkets())
            PanicOnError(retRes828858)
...
func  (this *woofipro) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928365 := (<-this.LoadMarkets())
            PanicOnError(retRes928365)
...
func  (this *woofipro) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes61987 := (<-this.LoadMarkets())
            PanicOnError(retRes61987)
...
func  (this *woofipro) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes762684 := (<-this.LoadMarkets())
            PanicOnError(retRes762684)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *woofipro) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes572659 := (<-this.LoadMarkets())
            PanicOnError(retRes572659)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes721635 :=  (<-this.FetchPaginatedCallIncremental("fetchOrders", symbol, since, limit, params, "page", maxLimit))
                    PanicOnError(retRes721635)
                    ch <- retRes721635
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes289365 := (<-this.LoadMarkets())
            PanicOnError(retRes289365)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "INCOMPLETE",
            })
        
                retRes132217 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes132217)
                ch <- retRes132217
                return nil
...
func  (this *woofipro) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes289164 := (<-this.LoadMarkets())
            PanicOnError(retRes289164)
            var extendedParams interface{} = this.Extend(params, map[string]interface{} {
                "status": "COMPLETED",
            })
        
                retRes459432 :=  (<-this.FetchOrders(symbol, since, limit, extendedParams))
                PanicOnError(retRes459432)
                ch <- retRes459432
                return nil
...
func  (this *woofipro) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes977730 := (<-this.LoadMarkets())
            PanicOnError(retRes977730)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes947779 :=  (<-this.FetchPaginatedCallIncremental("fetchMyTrades", symbol, since, limit, params, "page", 500))
                    PanicOnError(retRes947779)
                    ch <- retRes947779
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes510029 := (<-this.LoadMarkets())
            PanicOnError(retRes510029)
...
func  (this *woofipro) GetAssetHistoryRows(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes171025 := (<-this.LoadMarkets())
            PanicOnError(retRes171025)
            var request interface{} = map[string]interface{} {}
...
func  (this *woofipro) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes817934 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes817934)
                ch <- retRes817934
                return nil
...
func  (this *woofipro) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes209517 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes209517)
                ch <- retRes209517
                return nil
...
func  (this *woofipro) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes188909 := (<-this.LoadMarkets())
            PanicOnError(retRes188909)
...
func  (this *woofipro) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes981064 := (<-this.LoadMarkets())
            PanicOnError(retRes981064)
            var market interface{} = this.Market(symbol)
...
func  (this *woofipro) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes555187 := (<-this.LoadMarkets())
            PanicOnError(retRes555187)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes292561 :=  (<-this.V1PrivatePostClientLeverage(this.Extend(request, params)))
                PanicOnError(retRes292561)
                ch <- retRes292561
                return nil
