...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes728907 := (<-this.LoadMarkets())
            PanicOnError(retRes728907)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747249 := (<-this.LoadMarkets())
            PanicOnError(retRes747249)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes113954 := (<-this.LoadMarkets())
            PanicOnError(retRes113954)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339190 := (<-this.LoadMarkets())
            PanicOnError(retRes339190)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes840339 := (<-this.LoadMarkets())
            PanicOnError(retRes840339)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes513090 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes513090)
                    ch <- retRes513090
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568986 := (<-this.LoadMarkets())
            PanicOnError(retRes568986)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes151019 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes986578 := (<-this.LoadMarkets())
            PanicOnError(retRes986578)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes859033 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes859033)
                    ch <- retRes859033
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283700 := (<-this.LoadMarkets())
            PanicOnError(retRes283700)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes456570 := (<-this.LoadMarkets())
            PanicOnError(retRes456570)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes663878 := (<-this.LoadMarkets())
            PanicOnError(retRes663878)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes312654 := (<-this.LoadMarkets())
            PanicOnError(retRes312654)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854738 := (<-this.LoadMarkets())
            PanicOnError(retRes854738)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70234 := (<-this.LoadMarkets())
            PanicOnError(retRes70234)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes731691 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes731691)
                    ch <- retRes731691
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes675000 := (<-this.LoadMarkets())
            PanicOnError(retRes675000)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes429617 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes429617)
                    ch <- retRes429617
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes558437 := (<-this.LoadMarkets())
            PanicOnError(retRes558437)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes827592 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes827592)
                    ch <- retRes827592
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes646638 := (<-this.LoadMarkets())
            PanicOnError(retRes646638)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes887519 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes887519)
                    ch <- retRes887519
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes299041 := (<-this.LoadMarkets())
            PanicOnError(retRes299041)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes546880 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes546880)
                    ch <- retRes546880
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes443436 := (<-this.LoadMarkets())
            PanicOnError(retRes443436)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes459785 := (<-this.LoadMarkets())
            PanicOnError(retRes459785)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes896698 := (<-this.LoadMarkets())
            PanicOnError(retRes896698)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes956976 := (<-this.LoadMarkets())
            PanicOnError(retRes956976)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes376459 := (<-this.LoadMarkets())
            PanicOnError(retRes376459)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes136187 := (<-this.LoadMarkets())
            PanicOnError(retRes136187)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes811486 := (<-this.LoadMarkets())
            PanicOnError(retRes811486)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes183689 := (<-this.LoadMarkets())
            PanicOnError(retRes183689)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493342 := (<-this.LoadMarkets())
            PanicOnError(retRes493342)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes796426 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes796426)
                    ch <- retRes796426
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297532 := (<-this.LoadMarkets())
            PanicOnError(retRes297532)
            var market interface{} = this.Market(symbol)
