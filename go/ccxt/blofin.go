...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes258660 := (<-this.LoadMarkets())
            PanicOnError(retRes258660)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes293723 := (<-this.LoadMarkets())
            PanicOnError(retRes293723)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes713018 := (<-this.LoadMarkets())
            PanicOnError(retRes713018)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes816517 := (<-this.LoadMarkets())
            PanicOnError(retRes816517)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes790273 := (<-this.LoadMarkets())
            PanicOnError(retRes790273)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes7105 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes7105)
                    ch <- retRes7105
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes617893 := (<-this.LoadMarkets())
            PanicOnError(retRes617893)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes759972 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes759972)
                    ch <- retRes759972
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes930968 := (<-this.LoadMarkets())
            PanicOnError(retRes930968)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes624378 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes624378)
                    ch <- retRes624378
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes253877 := (<-this.LoadMarkets())
            PanicOnError(retRes253877)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes649183 := (<-this.LoadMarkets())
            PanicOnError(retRes649183)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes998567 := (<-this.LoadMarkets())
            PanicOnError(retRes998567)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes764077 := (<-this.LoadMarkets())
            PanicOnError(retRes764077)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255117 := (<-this.LoadMarkets())
            PanicOnError(retRes255117)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes189026 := (<-this.LoadMarkets())
            PanicOnError(retRes189026)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes512422 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes512422)
                    ch <- retRes512422
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes774497 := (<-this.LoadMarkets())
            PanicOnError(retRes774497)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes49353 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes49353)
                    ch <- retRes49353
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes118220 := (<-this.LoadMarkets())
            PanicOnError(retRes118220)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes525242 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes525242)
                    ch <- retRes525242
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes188795 := (<-this.LoadMarkets())
            PanicOnError(retRes188795)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes148348 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes148348)
                    ch <- retRes148348
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes36407 := (<-this.LoadMarkets())
            PanicOnError(retRes36407)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes885352 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes885352)
                    ch <- retRes885352
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes541036 := (<-this.LoadMarkets())
            PanicOnError(retRes541036)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes74729 := (<-this.LoadMarkets())
            PanicOnError(retRes74729)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes347160 := (<-this.LoadMarkets())
            PanicOnError(retRes347160)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes479696 := (<-this.LoadMarkets())
            PanicOnError(retRes479696)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes590724 := (<-this.LoadMarkets())
            PanicOnError(retRes590724)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92970 := (<-this.LoadMarkets())
            PanicOnError(retRes92970)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes856823 := (<-this.LoadMarkets())
            PanicOnError(retRes856823)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348441 := (<-this.LoadMarkets())
            PanicOnError(retRes348441)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes355188 := (<-this.LoadMarkets())
            PanicOnError(retRes355188)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes709397 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes709397)
                    ch <- retRes709397
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes934762 := (<-this.LoadMarkets())
            PanicOnError(retRes934762)
            var market interface{} = this.Market(symbol)
