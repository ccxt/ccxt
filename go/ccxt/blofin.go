...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes52242 := (<-this.LoadMarkets())
            PanicOnError(retRes52242)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603376 := (<-this.LoadMarkets())
            PanicOnError(retRes603376)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes369659 := (<-this.LoadMarkets())
            PanicOnError(retRes369659)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes166738 := (<-this.LoadMarkets())
            PanicOnError(retRes166738)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244436 := (<-this.LoadMarkets())
            PanicOnError(retRes244436)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes559892 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes559892)
                    ch <- retRes559892
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes416930 := (<-this.LoadMarkets())
            PanicOnError(retRes416930)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes297755 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes297755)
                    ch <- retRes297755
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes952937 := (<-this.LoadMarkets())
            PanicOnError(retRes952937)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes966005 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes966005)
                    ch <- retRes966005
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38690 := (<-this.LoadMarkets())
            PanicOnError(retRes38690)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes48896 := (<-this.LoadMarkets())
            PanicOnError(retRes48896)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654751 := (<-this.LoadMarkets())
            PanicOnError(retRes654751)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes202076 := (<-this.LoadMarkets())
            PanicOnError(retRes202076)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes664290 := (<-this.LoadMarkets())
            PanicOnError(retRes664290)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes485959 := (<-this.LoadMarkets())
            PanicOnError(retRes485959)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes366497 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes366497)
                    ch <- retRes366497
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes883647 := (<-this.LoadMarkets())
            PanicOnError(retRes883647)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes974611 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes974611)
                    ch <- retRes974611
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes356603 := (<-this.LoadMarkets())
            PanicOnError(retRes356603)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes456612 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278782 := (<-this.LoadMarkets())
            PanicOnError(retRes278782)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes831290 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes831290)
                    ch <- retRes831290
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes794342 := (<-this.LoadMarkets())
            PanicOnError(retRes794342)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes510095 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes510095)
                    ch <- retRes510095
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes86506 := (<-this.LoadMarkets())
            PanicOnError(retRes86506)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes213391 := (<-this.LoadMarkets())
            PanicOnError(retRes213391)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes419876 := (<-this.LoadMarkets())
            PanicOnError(retRes419876)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes527779 := (<-this.LoadMarkets())
            PanicOnError(retRes527779)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes247945 := (<-this.LoadMarkets())
            PanicOnError(retRes247945)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes136900 := (<-this.LoadMarkets())
            PanicOnError(retRes136900)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes716371 := (<-this.LoadMarkets())
            PanicOnError(retRes716371)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes712717 := (<-this.LoadMarkets())
            PanicOnError(retRes712717)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes8797 := (<-this.LoadMarkets())
            PanicOnError(retRes8797)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes971044 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes971044)
                    ch <- retRes971044
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes362811 := (<-this.LoadMarkets())
            PanicOnError(retRes362811)
            var market interface{} = this.Market(symbol)
