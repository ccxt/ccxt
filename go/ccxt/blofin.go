...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes162858 := (<-this.LoadMarkets())
            PanicOnError(retRes162858)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes365609 := (<-this.LoadMarkets())
            PanicOnError(retRes365609)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes661765 := (<-this.LoadMarkets())
            PanicOnError(retRes661765)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes143706 := (<-this.LoadMarkets())
            PanicOnError(retRes143706)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes849737 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes849737)
                    ch <- retRes849737
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes163348 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes163348)
                    ch <- retRes163348
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes934960 := (<-this.LoadMarkets())
            PanicOnError(retRes934960)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes380972 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes380972)
                    ch <- retRes380972
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes325564 := (<-this.LoadMarkets())
            PanicOnError(retRes325564)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes370809 := (<-this.LoadMarkets())
            PanicOnError(retRes370809)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes887476 := (<-this.LoadMarkets())
            PanicOnError(retRes887476)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes519632 := (<-this.LoadMarkets())
            PanicOnError(retRes519632)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes682213 := (<-this.LoadMarkets())
            PanicOnError(retRes682213)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96244 := (<-this.LoadMarkets())
            PanicOnError(retRes96244)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes993451 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes993451)
                    ch <- retRes993451
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes885659 := (<-this.LoadMarkets())
            PanicOnError(retRes885659)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes801583 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes801583)
                    ch <- retRes801583
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes316426 := (<-this.LoadMarkets())
            PanicOnError(retRes316426)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes83282 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes83282)
                    ch <- retRes83282
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes114988 := (<-this.LoadMarkets())
            PanicOnError(retRes114988)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes103073 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes103073)
                    ch <- retRes103073
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes864092 := (<-this.LoadMarkets())
            PanicOnError(retRes864092)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes318824 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes318824)
                    ch <- retRes318824
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes841958 := (<-this.LoadMarkets())
            PanicOnError(retRes841958)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes688740 := (<-this.LoadMarkets())
            PanicOnError(retRes688740)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes725643 := (<-this.LoadMarkets())
            PanicOnError(retRes725643)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes765282 := (<-this.LoadMarkets())
            PanicOnError(retRes765282)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes682977 := (<-this.LoadMarkets())
            PanicOnError(retRes682977)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279377 := (<-this.LoadMarkets())
            PanicOnError(retRes279377)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834292 := (<-this.LoadMarkets())
            PanicOnError(retRes834292)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes47166 := (<-this.LoadMarkets())
            PanicOnError(retRes47166)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes894163 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes894163)
                    ch <- retRes894163
                    return nil
            }
            var request interface{} = map[string]interface{} {}
