...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes173957 := (<-this.LoadMarkets())
            PanicOnError(retRes173957)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes323916 := (<-this.LoadMarkets())
            PanicOnError(retRes323916)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes700781 := (<-this.LoadMarkets())
            PanicOnError(retRes700781)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes422972 := (<-this.LoadMarkets())
            PanicOnError(retRes422972)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes423248 := (<-this.LoadMarkets())
            PanicOnError(retRes423248)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes241272 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes241272)
                    ch <- retRes241272
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637944 := (<-this.LoadMarkets())
            PanicOnError(retRes637944)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes82499 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes82499)
                    ch <- retRes82499
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes332603 := (<-this.LoadMarkets())
            PanicOnError(retRes332603)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes810574 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes810574)
                    ch <- retRes810574
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes963488 := (<-this.LoadMarkets())
            PanicOnError(retRes963488)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes530742 := (<-this.LoadMarkets())
            PanicOnError(retRes530742)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378494 := (<-this.LoadMarkets())
            PanicOnError(retRes378494)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes939260 := (<-this.LoadMarkets())
            PanicOnError(retRes939260)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes449409 := (<-this.LoadMarkets())
            PanicOnError(retRes449409)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes127793 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes127793)
                    ch <- retRes127793
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes448311 := (<-this.LoadMarkets())
            PanicOnError(retRes448311)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes962282 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes962282)
                    ch <- retRes962282
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes359364 := (<-this.LoadMarkets())
            PanicOnError(retRes359364)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes648573 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes648573)
                    ch <- retRes648573
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes57196 := (<-this.LoadMarkets())
            PanicOnError(retRes57196)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes617742 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes617742)
                    ch <- retRes617742
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795874 := (<-this.LoadMarkets())
            PanicOnError(retRes795874)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes206158 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes206158)
                    ch <- retRes206158
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes611338 := (<-this.LoadMarkets())
            PanicOnError(retRes611338)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes722198 := (<-this.LoadMarkets())
            PanicOnError(retRes722198)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814449 := (<-this.LoadMarkets())
            PanicOnError(retRes814449)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes273150 := (<-this.LoadMarkets())
            PanicOnError(retRes273150)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes652755 := (<-this.LoadMarkets())
            PanicOnError(retRes652755)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes491182 := (<-this.LoadMarkets())
            PanicOnError(retRes491182)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes604898 := (<-this.LoadMarkets())
            PanicOnError(retRes604898)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297221 := (<-this.LoadMarkets())
            PanicOnError(retRes297221)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes512681 := (<-this.LoadMarkets())
            PanicOnError(retRes512681)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes745477 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes745477)
                    ch <- retRes745477
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92650 := (<-this.LoadMarkets())
            PanicOnError(retRes92650)
            var market interface{} = this.Market(symbol)
