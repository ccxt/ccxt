...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes938267 := (<-this.LoadMarkets())
            PanicOnError(retRes938267)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes466445 := (<-this.LoadMarkets())
            PanicOnError(retRes466445)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711164 := (<-this.LoadMarkets())
            PanicOnError(retRes711164)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes318350 := (<-this.LoadMarkets())
            PanicOnError(retRes318350)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49059 := (<-this.LoadMarkets())
            PanicOnError(retRes49059)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes375531 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes375531)
                    ch <- retRes375531
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes668003 := (<-this.LoadMarkets())
            PanicOnError(retRes668003)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes316479 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes316479)
                    ch <- retRes316479
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568182 := (<-this.LoadMarkets())
            PanicOnError(retRes568182)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes880891 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes880891)
                    ch <- retRes880891
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes333387 := (<-this.LoadMarkets())
            PanicOnError(retRes333387)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes311933 := (<-this.LoadMarkets())
            PanicOnError(retRes311933)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes411698 := (<-this.LoadMarkets())
            PanicOnError(retRes411698)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes916080 := (<-this.LoadMarkets())
            PanicOnError(retRes916080)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes217072 := (<-this.LoadMarkets())
            PanicOnError(retRes217072)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes31283 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes31283)
                    ch <- retRes31283
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795098 := (<-this.LoadMarkets())
            PanicOnError(retRes795098)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes728270 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes728270)
                    ch <- retRes728270
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96715 := (<-this.LoadMarkets())
            PanicOnError(retRes96715)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes686208 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes773903 := (<-this.LoadMarkets())
            PanicOnError(retRes773903)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes827836 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes827836)
                    ch <- retRes827836
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes293907 := (<-this.LoadMarkets())
            PanicOnError(retRes293907)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes106119 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes463544 := (<-this.LoadMarkets())
            PanicOnError(retRes463544)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes269544 := (<-this.LoadMarkets())
            PanicOnError(retRes269544)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes259353 := (<-this.LoadMarkets())
            PanicOnError(retRes259353)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes616829 := (<-this.LoadMarkets())
            PanicOnError(retRes616829)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes899956 := (<-this.LoadMarkets())
            PanicOnError(retRes899956)
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62235 := (<-this.LoadMarkets())
            PanicOnError(retRes62235)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes623084 := (<-this.LoadMarkets())
            PanicOnError(retRes623084)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes758613 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes758613)
                    ch <- retRes758613
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes845892 := (<-this.LoadMarkets())
            PanicOnError(retRes845892)
            var market interface{} = this.Market(symbol)
