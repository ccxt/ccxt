...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes41923 := (<-this.LoadMarkets())
            PanicOnError(retRes41923)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes335561 := (<-this.LoadMarkets())
            PanicOnError(retRes335561)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes457185 := (<-this.LoadMarkets())
            PanicOnError(retRes457185)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes963561 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes963561)
                    ch <- retRes963561
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes655975 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes655975)
                    ch <- retRes655975
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes65641 := (<-this.LoadMarkets())
            PanicOnError(retRes65641)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes926157 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes926157)
                    ch <- retRes926157
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes570843 := (<-this.LoadMarkets())
            PanicOnError(retRes570843)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes234650 := (<-this.LoadMarkets())
            PanicOnError(retRes234650)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes753205 := (<-this.LoadMarkets())
            PanicOnError(retRes753205)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes690077 := (<-this.LoadMarkets())
            PanicOnError(retRes690077)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes147648 := (<-this.LoadMarkets())
            PanicOnError(retRes147648)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes293901 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes293901)
                    ch <- retRes293901
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes912658 := (<-this.LoadMarkets())
            PanicOnError(retRes912658)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes668173 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes668173)
                    ch <- retRes668173
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes639885 := (<-this.LoadMarkets())
            PanicOnError(retRes639885)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes810736 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes921806 := (<-this.LoadMarkets())
            PanicOnError(retRes921806)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes20464 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes20464)
                    ch <- retRes20464
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes13820 := (<-this.LoadMarkets())
            PanicOnError(retRes13820)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes571085 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes571085)
                    ch <- retRes571085
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes428907 := (<-this.LoadMarkets())
            PanicOnError(retRes428907)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes536081 := (<-this.LoadMarkets())
            PanicOnError(retRes536081)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116161 := (<-this.LoadMarkets())
            PanicOnError(retRes116161)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180468 := (<-this.LoadMarkets())
            PanicOnError(retRes180468)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes635711 := (<-this.LoadMarkets())
            PanicOnError(retRes635711)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes590266 := (<-this.LoadMarkets())
            PanicOnError(retRes590266)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes3386 := (<-this.LoadMarkets())
            PanicOnError(retRes3386)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes188576 := (<-this.LoadMarkets())
            PanicOnError(retRes188576)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes2789 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes2789)
                    ch <- retRes2789
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50307 := (<-this.LoadMarkets())
            PanicOnError(retRes50307)
            var market interface{} = this.Market(symbol)
