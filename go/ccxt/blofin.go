...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518193 := (<-this.LoadMarkets())
            PanicOnError(retRes518193)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes649796 := (<-this.LoadMarkets())
            PanicOnError(retRes649796)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77865 := (<-this.LoadMarkets())
            PanicOnError(retRes77865)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes363606 := (<-this.LoadMarkets())
            PanicOnError(retRes363606)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes123697 := (<-this.LoadMarkets())
            PanicOnError(retRes123697)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes176391 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes176391)
                    ch <- retRes176391
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes326556 := (<-this.LoadMarkets())
            PanicOnError(retRes326556)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes209829 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes209829)
                    ch <- retRes209829
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240352 := (<-this.LoadMarkets())
            PanicOnError(retRes240352)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes917440 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes917440)
                    ch <- retRes917440
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703959 := (<-this.LoadMarkets())
            PanicOnError(retRes703959)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes415954 := (<-this.LoadMarkets())
            PanicOnError(retRes415954)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes905117 := (<-this.LoadMarkets())
            PanicOnError(retRes905117)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes129885 := (<-this.LoadMarkets())
            PanicOnError(retRes129885)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes55620 := (<-this.LoadMarkets())
            PanicOnError(retRes55620)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes717172 := (<-this.LoadMarkets())
            PanicOnError(retRes717172)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes292046 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes292046)
                    ch <- retRes292046
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913908 := (<-this.LoadMarkets())
            PanicOnError(retRes913908)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes453692 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes453692)
                    ch <- retRes453692
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes600443 := (<-this.LoadMarkets())
            PanicOnError(retRes600443)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes728924 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes728924)
                    ch <- retRes728924
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131468 := (<-this.LoadMarkets())
            PanicOnError(retRes131468)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes753303 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes753303)
                    ch <- retRes753303
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes620337 := (<-this.LoadMarkets())
            PanicOnError(retRes620337)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes526186 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes526186)
                    ch <- retRes526186
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes209823 := (<-this.LoadMarkets())
            PanicOnError(retRes209823)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes162244 := (<-this.LoadMarkets())
            PanicOnError(retRes162244)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes881775 := (<-this.LoadMarkets())
            PanicOnError(retRes881775)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834653 := (<-this.LoadMarkets())
            PanicOnError(retRes834653)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes868044 := (<-this.LoadMarkets())
            PanicOnError(retRes868044)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes557593 := (<-this.LoadMarkets())
            PanicOnError(retRes557593)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917529 := (<-this.LoadMarkets())
            PanicOnError(retRes917529)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes237732 := (<-this.LoadMarkets())
            PanicOnError(retRes237732)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes708043 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes708043)
                    ch <- retRes708043
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes624393 := (<-this.LoadMarkets())
            PanicOnError(retRes624393)
            var market interface{} = this.Market(symbol)
