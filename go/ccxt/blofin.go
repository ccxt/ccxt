...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes755986 := (<-this.LoadMarkets())
            PanicOnError(retRes755986)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917638 := (<-this.LoadMarkets())
            PanicOnError(retRes917638)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes864738 := (<-this.LoadMarkets())
            PanicOnError(retRes864738)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes528649 := (<-this.LoadMarkets())
            PanicOnError(retRes528649)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes463115 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes463115)
                    ch <- retRes463115
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307371 := (<-this.LoadMarkets())
            PanicOnError(retRes307371)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes779674 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes779674)
                    ch <- retRes779674
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes799171 := (<-this.LoadMarkets())
            PanicOnError(retRes799171)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes346847 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes346847)
                    ch <- retRes346847
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes849998 := (<-this.LoadMarkets())
            PanicOnError(retRes849998)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes262960 := (<-this.LoadMarkets())
            PanicOnError(retRes262960)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes623530 := (<-this.LoadMarkets())
            PanicOnError(retRes623530)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes651825 := (<-this.LoadMarkets())
            PanicOnError(retRes651825)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes103895 := (<-this.LoadMarkets())
            PanicOnError(retRes103895)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes783852 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes783852)
                    ch <- retRes783852
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes68035 := (<-this.LoadMarkets())
            PanicOnError(retRes68035)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes118792 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes118792)
                    ch <- retRes118792
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes509066 := (<-this.LoadMarkets())
            PanicOnError(retRes509066)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes35982 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes35982)
                    ch <- retRes35982
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283527 := (<-this.LoadMarkets())
            PanicOnError(retRes283527)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes138242 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes138242)
                    ch <- retRes138242
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes956770 := (<-this.LoadMarkets())
            PanicOnError(retRes956770)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes947464 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes947464)
                    ch <- retRes947464
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes942952 := (<-this.LoadMarkets())
            PanicOnError(retRes942952)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes667546 := (<-this.LoadMarkets())
            PanicOnError(retRes667546)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes466847 := (<-this.LoadMarkets())
            PanicOnError(retRes466847)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858646 := (<-this.LoadMarkets())
            PanicOnError(retRes858646)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes616769 := (<-this.LoadMarkets())
            PanicOnError(retRes616769)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38430 := (<-this.LoadMarkets())
            PanicOnError(retRes38430)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133046 := (<-this.LoadMarkets())
            PanicOnError(retRes133046)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes554964 := (<-this.LoadMarkets())
            PanicOnError(retRes554964)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes417755 := (<-this.LoadMarkets())
            PanicOnError(retRes417755)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes996822 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes269375 := (<-this.LoadMarkets())
            PanicOnError(retRes269375)
            var market interface{} = this.Market(symbol)
