...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes857472 := (<-this.LoadMarkets())
            PanicOnError(retRes857472)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes405604 := (<-this.LoadMarkets())
            PanicOnError(retRes405604)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes45193 := (<-this.LoadMarkets())
            PanicOnError(retRes45193)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes316631 := (<-this.LoadMarkets())
            PanicOnError(retRes316631)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes242422 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes242422)
                    ch <- retRes242422
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97781 := (<-this.LoadMarkets())
            PanicOnError(retRes97781)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes676705 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes676705)
                    ch <- retRes676705
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599020 := (<-this.LoadMarkets())
            PanicOnError(retRes599020)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes181981 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes181981)
                    ch <- retRes181981
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes680044 := (<-this.LoadMarkets())
            PanicOnError(retRes680044)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes216384 := (<-this.LoadMarkets())
            PanicOnError(retRes216384)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795107 := (<-this.LoadMarkets())
            PanicOnError(retRes795107)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525763 := (<-this.LoadMarkets())
            PanicOnError(retRes525763)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes206393 := (<-this.LoadMarkets())
            PanicOnError(retRes206393)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes221409 := (<-this.LoadMarkets())
            PanicOnError(retRes221409)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes20187 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes20187)
                    ch <- retRes20187
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes943697 := (<-this.LoadMarkets())
            PanicOnError(retRes943697)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes989706 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes989706)
                    ch <- retRes989706
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578363 := (<-this.LoadMarkets())
            PanicOnError(retRes578363)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes22136 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes22136)
                    ch <- retRes22136
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes494241 := (<-this.LoadMarkets())
            PanicOnError(retRes494241)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes796495 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes796495)
                    ch <- retRes796495
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes764320 := (<-this.LoadMarkets())
            PanicOnError(retRes764320)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes325962 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes325962)
                    ch <- retRes325962
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854283 := (<-this.LoadMarkets())
            PanicOnError(retRes854283)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes453011 := (<-this.LoadMarkets())
            PanicOnError(retRes453011)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes886340 := (<-this.LoadMarkets())
            PanicOnError(retRes886340)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes24442 := (<-this.LoadMarkets())
            PanicOnError(retRes24442)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes27500 := (<-this.LoadMarkets())
            PanicOnError(retRes27500)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711091 := (<-this.LoadMarkets())
            PanicOnError(retRes711091)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes439414 := (<-this.LoadMarkets())
            PanicOnError(retRes439414)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes494414 := (<-this.LoadMarkets())
            PanicOnError(retRes494414)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes293515 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes501437 := (<-this.LoadMarkets())
            PanicOnError(retRes501437)
            var market interface{} = this.Market(symbol)
