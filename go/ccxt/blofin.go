...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes456190 := (<-this.LoadMarkets())
            PanicOnError(retRes456190)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes366230 := (<-this.LoadMarkets())
            PanicOnError(retRes366230)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes75674 := (<-this.LoadMarkets())
            PanicOnError(retRes75674)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes171791 := (<-this.LoadMarkets())
            PanicOnError(retRes171791)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes282014 := (<-this.LoadMarkets())
            PanicOnError(retRes282014)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes368302 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes368302)
                    ch <- retRes368302
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999196 := (<-this.LoadMarkets())
            PanicOnError(retRes999196)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes31202 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes31202)
                    ch <- retRes31202
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes383802 := (<-this.LoadMarkets())
            PanicOnError(retRes383802)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes799835 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes799835)
                    ch <- retRes799835
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes577412 := (<-this.LoadMarkets())
            PanicOnError(retRes577412)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes974527 := (<-this.LoadMarkets())
            PanicOnError(retRes974527)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes977821 := (<-this.LoadMarkets())
            PanicOnError(retRes977821)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes363157 := (<-this.LoadMarkets())
            PanicOnError(retRes363157)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes360965 := (<-this.LoadMarkets())
            PanicOnError(retRes360965)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes266497 := (<-this.LoadMarkets())
            PanicOnError(retRes266497)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes884694 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes884694)
                    ch <- retRes884694
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes548631 := (<-this.LoadMarkets())
            PanicOnError(retRes548631)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes41294 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes41294)
                    ch <- retRes41294
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes676924 := (<-this.LoadMarkets())
            PanicOnError(retRes676924)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes736312 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes447117 := (<-this.LoadMarkets())
            PanicOnError(retRes447117)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes437041 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes437041)
                    ch <- retRes437041
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes442983 := (<-this.LoadMarkets())
            PanicOnError(retRes442983)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes274371 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes274371)
                    ch <- retRes274371
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929609 := (<-this.LoadMarkets())
            PanicOnError(retRes929609)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes709740 := (<-this.LoadMarkets())
            PanicOnError(retRes709740)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes612525 := (<-this.LoadMarkets())
            PanicOnError(retRes612525)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes836422 := (<-this.LoadMarkets())
            PanicOnError(retRes836422)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes381613 := (<-this.LoadMarkets())
            PanicOnError(retRes381613)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes714421 := (<-this.LoadMarkets())
            PanicOnError(retRes714421)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470020 := (<-this.LoadMarkets())
            PanicOnError(retRes470020)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes180317 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes180317)
                    ch <- retRes180317
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes848922 := (<-this.LoadMarkets())
            PanicOnError(retRes848922)
            var market interface{} = this.Market(symbol)
