...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279158 := (<-this.LoadMarkets())
            PanicOnError(retRes279158)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73611 := (<-this.LoadMarkets())
            PanicOnError(retRes73611)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes69054 := (<-this.LoadMarkets())
            PanicOnError(retRes69054)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes440246 := (<-this.LoadMarkets())
            PanicOnError(retRes440246)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes252100 := (<-this.LoadMarkets())
            PanicOnError(retRes252100)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes402568 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes402568)
                    ch <- retRes402568
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164818 := (<-this.LoadMarkets())
            PanicOnError(retRes164818)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes906899 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes906899)
                    ch <- retRes906899
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes224375 := (<-this.LoadMarkets())
            PanicOnError(retRes224375)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes803796 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes803796)
                    ch <- retRes803796
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes971192 := (<-this.LoadMarkets())
            PanicOnError(retRes971192)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes189989 := (<-this.LoadMarkets())
            PanicOnError(retRes189989)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes437444 := (<-this.LoadMarkets())
            PanicOnError(retRes437444)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes47364 := (<-this.LoadMarkets())
            PanicOnError(retRes47364)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes182536 := (<-this.LoadMarkets())
            PanicOnError(retRes182536)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792072 := (<-this.LoadMarkets())
            PanicOnError(retRes792072)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes403428 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes403428)
                    ch <- retRes403428
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917232 := (<-this.LoadMarkets())
            PanicOnError(retRes917232)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes479704 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes479704)
                    ch <- retRes479704
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes785556 := (<-this.LoadMarkets())
            PanicOnError(retRes785556)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes336998 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes336998)
                    ch <- retRes336998
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes174218 := (<-this.LoadMarkets())
            PanicOnError(retRes174218)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes430970 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes430970)
                    ch <- retRes430970
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes251346 := (<-this.LoadMarkets())
            PanicOnError(retRes251346)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes867700 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes867700)
                    ch <- retRes867700
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752377 := (<-this.LoadMarkets())
            PanicOnError(retRes752377)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes229517 := (<-this.LoadMarkets())
            PanicOnError(retRes229517)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63519 := (<-this.LoadMarkets())
            PanicOnError(retRes63519)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164726 := (<-this.LoadMarkets())
            PanicOnError(retRes164726)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes642599 := (<-this.LoadMarkets())
            PanicOnError(retRes642599)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes171499 := (<-this.LoadMarkets())
            PanicOnError(retRes171499)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752936 := (<-this.LoadMarkets())
            PanicOnError(retRes752936)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes495544 := (<-this.LoadMarkets())
            PanicOnError(retRes495544)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes643423 := (<-this.LoadMarkets())
            PanicOnError(retRes643423)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes878379 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes878379)
                    ch <- retRes878379
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes579703 := (<-this.LoadMarkets())
            PanicOnError(retRes579703)
            var market interface{} = this.Market(symbol)
