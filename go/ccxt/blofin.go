...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes395150 := (<-this.LoadMarkets())
            PanicOnError(retRes395150)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes352551 := (<-this.LoadMarkets())
            PanicOnError(retRes352551)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes760623 := (<-this.LoadMarkets())
            PanicOnError(retRes760623)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637511 := (<-this.LoadMarkets())
            PanicOnError(retRes637511)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814020 := (<-this.LoadMarkets())
            PanicOnError(retRes814020)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes837393 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes837393)
                    ch <- retRes837393
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes956290 := (<-this.LoadMarkets())
            PanicOnError(retRes956290)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes727881 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes727881)
                    ch <- retRes727881
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes798385 := (<-this.LoadMarkets())
            PanicOnError(retRes798385)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes367113 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes367113)
                    ch <- retRes367113
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406283 := (<-this.LoadMarkets())
            PanicOnError(retRes406283)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes965133 := (<-this.LoadMarkets())
            PanicOnError(retRes965133)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes957166 := (<-this.LoadMarkets())
            PanicOnError(retRes957166)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255844 := (<-this.LoadMarkets())
            PanicOnError(retRes255844)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes454049 := (<-this.LoadMarkets())
            PanicOnError(retRes454049)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes551094 := (<-this.LoadMarkets())
            PanicOnError(retRes551094)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes991767 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes991767)
                    ch <- retRes991767
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660108 := (<-this.LoadMarkets())
            PanicOnError(retRes660108)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes869172 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes869172)
                    ch <- retRes869172
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes301778 := (<-this.LoadMarkets())
            PanicOnError(retRes301778)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes525455 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes525455)
                    ch <- retRes525455
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674681 := (<-this.LoadMarkets())
            PanicOnError(retRes674681)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes799954 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes799954)
                    ch <- retRes799954
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes233418 := (<-this.LoadMarkets())
            PanicOnError(retRes233418)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes210673 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes210673)
                    ch <- retRes210673
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes509589 := (<-this.LoadMarkets())
            PanicOnError(retRes509589)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes281318 := (<-this.LoadMarkets())
            PanicOnError(retRes281318)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes455901 := (<-this.LoadMarkets())
            PanicOnError(retRes455901)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70511 := (<-this.LoadMarkets())
            PanicOnError(retRes70511)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes409751 := (<-this.LoadMarkets())
            PanicOnError(retRes409751)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes784125 := (<-this.LoadMarkets())
            PanicOnError(retRes784125)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes502933 := (<-this.LoadMarkets())
            PanicOnError(retRes502933)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917672 := (<-this.LoadMarkets())
            PanicOnError(retRes917672)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes25999 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes25999)
                    ch <- retRes25999
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes438021 := (<-this.LoadMarkets())
            PanicOnError(retRes438021)
            var market interface{} = this.Market(symbol)
