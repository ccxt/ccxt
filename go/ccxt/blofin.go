...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731422 := (<-this.LoadMarkets())
            PanicOnError(retRes731422)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes932838 := (<-this.LoadMarkets())
            PanicOnError(retRes932838)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes194317 := (<-this.LoadMarkets())
            PanicOnError(retRes194317)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes435196 := (<-this.LoadMarkets())
            PanicOnError(retRes435196)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes405856 := (<-this.LoadMarkets())
            PanicOnError(retRes405856)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes388520 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes388520)
                    ch <- retRes388520
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes128668 := (<-this.LoadMarkets())
            PanicOnError(retRes128668)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes103395 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes103395)
                    ch <- retRes103395
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes943912 := (<-this.LoadMarkets())
            PanicOnError(retRes943912)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes833667 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes833667)
                    ch <- retRes833667
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes693456 := (<-this.LoadMarkets())
            PanicOnError(retRes693456)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241866 := (<-this.LoadMarkets())
            PanicOnError(retRes241866)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes575035 := (<-this.LoadMarkets())
            PanicOnError(retRes575035)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes511384 := (<-this.LoadMarkets())
            PanicOnError(retRes511384)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes842657 := (<-this.LoadMarkets())
            PanicOnError(retRes842657)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes744525 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes744525)
                    ch <- retRes744525
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277732 := (<-this.LoadMarkets())
            PanicOnError(retRes277732)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes476761 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes476761)
                    ch <- retRes476761
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes520425 := (<-this.LoadMarkets())
            PanicOnError(retRes520425)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes965263 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes965263)
                    ch <- retRes965263
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes433126 := (<-this.LoadMarkets())
            PanicOnError(retRes433126)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes48566 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes48566)
                    ch <- retRes48566
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes119606 := (<-this.LoadMarkets())
            PanicOnError(retRes119606)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes744943 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes744943)
                    ch <- retRes744943
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes66685 := (<-this.LoadMarkets())
            PanicOnError(retRes66685)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes714102 := (<-this.LoadMarkets())
            PanicOnError(retRes714102)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40803 := (<-this.LoadMarkets())
            PanicOnError(retRes40803)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes410220 := (<-this.LoadMarkets())
            PanicOnError(retRes410220)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589752 := (<-this.LoadMarkets())
            PanicOnError(retRes589752)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621166 := (<-this.LoadMarkets())
            PanicOnError(retRes621166)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes227135 := (<-this.LoadMarkets())
            PanicOnError(retRes227135)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes66317 := (<-this.LoadMarkets())
            PanicOnError(retRes66317)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes438395 := (<-this.LoadMarkets())
            PanicOnError(retRes438395)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes871606 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes871606)
                    ch <- retRes871606
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes541888 := (<-this.LoadMarkets())
            PanicOnError(retRes541888)
            var market interface{} = this.Market(symbol)
