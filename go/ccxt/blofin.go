...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes618848 := (<-this.LoadMarkets())
            PanicOnError(retRes618848)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes723311 := (<-this.LoadMarkets())
            PanicOnError(retRes723311)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes523849 := (<-this.LoadMarkets())
            PanicOnError(retRes523849)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes916446 := (<-this.LoadMarkets())
            PanicOnError(retRes916446)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes559161 := (<-this.LoadMarkets())
            PanicOnError(retRes559161)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes12974 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes12974)
                    ch <- retRes12974
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406140 := (<-this.LoadMarkets())
            PanicOnError(retRes406140)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes512000 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes512000)
                    ch <- retRes512000
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes532931 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes532931)
                    ch <- retRes532931
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes317979 := (<-this.LoadMarkets())
            PanicOnError(retRes317979)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695095 := (<-this.LoadMarkets())
            PanicOnError(retRes695095)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes357485 := (<-this.LoadMarkets())
            PanicOnError(retRes357485)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes705702 := (<-this.LoadMarkets())
            PanicOnError(retRes705702)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes353137 := (<-this.LoadMarkets())
            PanicOnError(retRes353137)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes815007 := (<-this.LoadMarkets())
            PanicOnError(retRes815007)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes820999 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes820999)
                    ch <- retRes820999
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes653991 := (<-this.LoadMarkets())
            PanicOnError(retRes653991)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes691362 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes691362)
                    ch <- retRes691362
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes853635 := (<-this.LoadMarkets())
            PanicOnError(retRes853635)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes799967 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes799967)
                    ch <- retRes799967
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes310871 := (<-this.LoadMarkets())
            PanicOnError(retRes310871)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes149134 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes149134)
                    ch <- retRes149134
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375554 := (<-this.LoadMarkets())
            PanicOnError(retRes375554)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes971765 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes971765)
                    ch <- retRes971765
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes461070 := (<-this.LoadMarkets())
            PanicOnError(retRes461070)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes575606 := (<-this.LoadMarkets())
            PanicOnError(retRes575606)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478437 := (<-this.LoadMarkets())
            PanicOnError(retRes478437)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240368 := (<-this.LoadMarkets())
            PanicOnError(retRes240368)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes850754 := (<-this.LoadMarkets())
            PanicOnError(retRes850754)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes346440 := (<-this.LoadMarkets())
            PanicOnError(retRes346440)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes335303 := (<-this.LoadMarkets())
            PanicOnError(retRes335303)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes657351 := (<-this.LoadMarkets())
            PanicOnError(retRes657351)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes966137 := (<-this.LoadMarkets())
            PanicOnError(retRes966137)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes438019 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes438019)
                    ch <- retRes438019
                    return nil
            }
            var request interface{} = map[string]interface{} {}
