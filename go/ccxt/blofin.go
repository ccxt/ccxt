...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes268369 := (<-this.LoadMarkets())
            PanicOnError(retRes268369)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes513535 := (<-this.LoadMarkets())
            PanicOnError(retRes513535)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241123 := (<-this.LoadMarkets())
            PanicOnError(retRes241123)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes360788 := (<-this.LoadMarkets())
            PanicOnError(retRes360788)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes157485 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes157485)
                    ch <- retRes157485
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes88872 := (<-this.LoadMarkets())
            PanicOnError(retRes88872)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes507806 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes507806)
                    ch <- retRes507806
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes460852 := (<-this.LoadMarkets())
            PanicOnError(retRes460852)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes212816 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes212816)
                    ch <- retRes212816
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes521009 := (<-this.LoadMarkets())
            PanicOnError(retRes521009)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497086 := (<-this.LoadMarkets())
            PanicOnError(retRes497086)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes739798 := (<-this.LoadMarkets())
            PanicOnError(retRes739798)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes778437 := (<-this.LoadMarkets())
            PanicOnError(retRes778437)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes812243 := (<-this.LoadMarkets())
            PanicOnError(retRes812243)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes214832 := (<-this.LoadMarkets())
            PanicOnError(retRes214832)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes611405 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes611405)
                    ch <- retRes611405
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583241 := (<-this.LoadMarkets())
            PanicOnError(retRes583241)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes967903 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes967903)
                    ch <- retRes967903
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes298427 := (<-this.LoadMarkets())
            PanicOnError(retRes298427)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes613859 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes613859)
                    ch <- retRes613859
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50957 := (<-this.LoadMarkets())
            PanicOnError(retRes50957)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes135565 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes135565)
                    ch <- retRes135565
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes717299 := (<-this.LoadMarkets())
            PanicOnError(retRes717299)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes567821 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes567821)
                    ch <- retRes567821
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928950 := (<-this.LoadMarkets())
            PanicOnError(retRes928950)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92006 := (<-this.LoadMarkets())
            PanicOnError(retRes92006)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes823157 := (<-this.LoadMarkets())
            PanicOnError(retRes823157)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes271131 := (<-this.LoadMarkets())
            PanicOnError(retRes271131)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes386374 := (<-this.LoadMarkets())
            PanicOnError(retRes386374)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes723422 := (<-this.LoadMarkets())
            PanicOnError(retRes723422)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes830241 := (<-this.LoadMarkets())
            PanicOnError(retRes830241)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes558093 := (<-this.LoadMarkets())
            PanicOnError(retRes558093)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes922309 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes922309)
                    ch <- retRes922309
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes374650 := (<-this.LoadMarkets())
            PanicOnError(retRes374650)
            var market interface{} = this.Market(symbol)
