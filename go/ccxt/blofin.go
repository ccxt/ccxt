...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63775 := (<-this.LoadMarkets())
            PanicOnError(retRes63775)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes269739 := (<-this.LoadMarkets())
            PanicOnError(retRes269739)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes253864 := (<-this.LoadMarkets())
            PanicOnError(retRes253864)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes644093 := (<-this.LoadMarkets())
            PanicOnError(retRes644093)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes332653 := (<-this.LoadMarkets())
            PanicOnError(retRes332653)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes605116 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes605116)
                    ch <- retRes605116
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes344423 := (<-this.LoadMarkets())
            PanicOnError(retRes344423)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes127992 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes127992)
                    ch <- retRes127992
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes594570 := (<-this.LoadMarkets())
            PanicOnError(retRes594570)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes294172 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes294172)
                    ch <- retRes294172
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40514 := (<-this.LoadMarkets())
            PanicOnError(retRes40514)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486126 := (<-this.LoadMarkets())
            PanicOnError(retRes486126)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes69835 := (<-this.LoadMarkets())
            PanicOnError(retRes69835)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406761 := (<-this.LoadMarkets())
            PanicOnError(retRes406761)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes964490 := (<-this.LoadMarkets())
            PanicOnError(retRes964490)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375611 := (<-this.LoadMarkets())
            PanicOnError(retRes375611)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes714587 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes714587)
                    ch <- retRes714587
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes562408 := (<-this.LoadMarkets())
            PanicOnError(retRes562408)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes393035 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes393035)
                    ch <- retRes393035
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes934378 := (<-this.LoadMarkets())
            PanicOnError(retRes934378)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes9610 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes9610)
                    ch <- retRes9610
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes59685 := (<-this.LoadMarkets())
            PanicOnError(retRes59685)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes149833 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes149833)
                    ch <- retRes149833
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes324300 := (<-this.LoadMarkets())
            PanicOnError(retRes324300)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes551394 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes488958 := (<-this.LoadMarkets())
            PanicOnError(retRes488958)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes536813 := (<-this.LoadMarkets())
            PanicOnError(retRes536813)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes182999 := (<-this.LoadMarkets())
            PanicOnError(retRes182999)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes51245 := (<-this.LoadMarkets())
            PanicOnError(retRes51245)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes890999 := (<-this.LoadMarkets())
            PanicOnError(retRes890999)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes202064 := (<-this.LoadMarkets())
            PanicOnError(retRes202064)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes444651 := (<-this.LoadMarkets())
            PanicOnError(retRes444651)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes491843 := (<-this.LoadMarkets())
            PanicOnError(retRes491843)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes245816 := (<-this.LoadMarkets())
            PanicOnError(retRes245816)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes600100 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes600100)
                    ch <- retRes600100
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768490 := (<-this.LoadMarkets())
            PanicOnError(retRes768490)
            var market interface{} = this.Market(symbol)
