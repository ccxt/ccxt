...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes356996 := (<-this.LoadMarkets())
            PanicOnError(retRes356996)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes454593 := (<-this.LoadMarkets())
            PanicOnError(retRes454593)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987898 := (<-this.LoadMarkets())
            PanicOnError(retRes987898)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40927 := (<-this.LoadMarkets())
            PanicOnError(retRes40927)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244901 := (<-this.LoadMarkets())
            PanicOnError(retRes244901)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes263444 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes263444)
                    ch <- retRes263444
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes443128 := (<-this.LoadMarkets())
            PanicOnError(retRes443128)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes945214 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes945214)
                    ch <- retRes945214
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes604340 := (<-this.LoadMarkets())
            PanicOnError(retRes604340)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes689266 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes689266)
                    ch <- retRes689266
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes16585 := (<-this.LoadMarkets())
            PanicOnError(retRes16585)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes932873 := (<-this.LoadMarkets())
            PanicOnError(retRes932873)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes239618 := (<-this.LoadMarkets())
            PanicOnError(retRes239618)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes65840 := (<-this.LoadMarkets())
            PanicOnError(retRes65840)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes350649 := (<-this.LoadMarkets())
            PanicOnError(retRes350649)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes491425 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes491425)
                    ch <- retRes491425
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes824906 := (<-this.LoadMarkets())
            PanicOnError(retRes824906)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes208493 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes208493)
                    ch <- retRes208493
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes271974 := (<-this.LoadMarkets())
            PanicOnError(retRes271974)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes429150 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes429150)
                    ch <- retRes429150
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes119621 := (<-this.LoadMarkets())
            PanicOnError(retRes119621)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes589138 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes589138)
                    ch <- retRes589138
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes671797 := (<-this.LoadMarkets())
            PanicOnError(retRes671797)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes410540 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes410540)
                    ch <- retRes410540
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes641564 := (<-this.LoadMarkets())
            PanicOnError(retRes641564)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192331 := (<-this.LoadMarkets())
            PanicOnError(retRes192331)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes430290 := (<-this.LoadMarkets())
            PanicOnError(retRes430290)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes214340 := (<-this.LoadMarkets())
            PanicOnError(retRes214340)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes598727 := (<-this.LoadMarkets())
            PanicOnError(retRes598727)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes529451 := (<-this.LoadMarkets())
            PanicOnError(retRes529451)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes483127 := (<-this.LoadMarkets())
            PanicOnError(retRes483127)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes894837 := (<-this.LoadMarkets())
            PanicOnError(retRes894837)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes204773 := (<-this.LoadMarkets())
            PanicOnError(retRes204773)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes268500 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes268500)
                    ch <- retRes268500
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497698 := (<-this.LoadMarkets())
            PanicOnError(retRes497698)
            var market interface{} = this.Market(symbol)
