...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937284 := (<-this.LoadMarkets())
            PanicOnError(retRes937284)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes562747 := (<-this.LoadMarkets())
            PanicOnError(retRes562747)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241563 := (<-this.LoadMarkets())
            PanicOnError(retRes241563)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes945132 := (<-this.LoadMarkets())
            PanicOnError(retRes945132)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes501552 := (<-this.LoadMarkets())
            PanicOnError(retRes501552)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes746513 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes746513)
                    ch <- retRes746513
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674755 := (<-this.LoadMarkets())
            PanicOnError(retRes674755)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes566133 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes533252 := (<-this.LoadMarkets())
            PanicOnError(retRes533252)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes768325 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes768325)
                    ch <- retRes768325
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes965840 := (<-this.LoadMarkets())
            PanicOnError(retRes965840)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes551654 := (<-this.LoadMarkets())
            PanicOnError(retRes551654)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes474318 := (<-this.LoadMarkets())
            PanicOnError(retRes474318)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes274129 := (<-this.LoadMarkets())
            PanicOnError(retRes274129)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928339 := (<-this.LoadMarkets())
            PanicOnError(retRes928339)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes1485 := (<-this.LoadMarkets())
            PanicOnError(retRes1485)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes328667 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes328667)
                    ch <- retRes328667
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes625095 := (<-this.LoadMarkets())
            PanicOnError(retRes625095)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes266607 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes266607)
                    ch <- retRes266607
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes610308 := (<-this.LoadMarkets())
            PanicOnError(retRes610308)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes383651 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes383651)
                    ch <- retRes383651
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes901790 := (<-this.LoadMarkets())
            PanicOnError(retRes901790)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes64412 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes604924 := (<-this.LoadMarkets())
            PanicOnError(retRes604924)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes277360 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes277360)
                    ch <- retRes277360
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes887184 := (<-this.LoadMarkets())
            PanicOnError(retRes887184)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes600883 := (<-this.LoadMarkets())
            PanicOnError(retRes600883)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes707816 := (<-this.LoadMarkets())
            PanicOnError(retRes707816)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes856585 := (<-this.LoadMarkets())
            PanicOnError(retRes856585)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes263497 := (<-this.LoadMarkets())
            PanicOnError(retRes263497)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes839179 := (<-this.LoadMarkets())
            PanicOnError(retRes839179)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes918504 := (<-this.LoadMarkets())
            PanicOnError(retRes918504)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes462490 := (<-this.LoadMarkets())
            PanicOnError(retRes462490)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes171582 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872433 := (<-this.LoadMarkets())
            PanicOnError(retRes872433)
            var market interface{} = this.Market(symbol)
