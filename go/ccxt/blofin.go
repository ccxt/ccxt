...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes608725 := (<-this.LoadMarkets())
            PanicOnError(retRes608725)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes876535 := (<-this.LoadMarkets())
            PanicOnError(retRes876535)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes839331 := (<-this.LoadMarkets())
            PanicOnError(retRes839331)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes187543 := (<-this.LoadMarkets())
            PanicOnError(retRes187543)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49905 := (<-this.LoadMarkets())
            PanicOnError(retRes49905)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes649231 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes649231)
                    ch <- retRes649231
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes438129 := (<-this.LoadMarkets())
            PanicOnError(retRes438129)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes620105 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes620105)
                    ch <- retRes620105
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes47227 := (<-this.LoadMarkets())
            PanicOnError(retRes47227)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes148693 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes148693)
                    ch <- retRes148693
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes994693 := (<-this.LoadMarkets())
            PanicOnError(retRes994693)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes220197 := (<-this.LoadMarkets())
            PanicOnError(retRes220197)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes600195 := (<-this.LoadMarkets())
            PanicOnError(retRes600195)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes223063 := (<-this.LoadMarkets())
            PanicOnError(retRes223063)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes918665 := (<-this.LoadMarkets())
            PanicOnError(retRes918665)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes590021 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes590021)
                    ch <- retRes590021
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes582399 := (<-this.LoadMarkets())
            PanicOnError(retRes582399)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes379441 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes379441)
                    ch <- retRes379441
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes644322 := (<-this.LoadMarkets())
            PanicOnError(retRes644322)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes467251 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes467251)
                    ch <- retRes467251
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes659332 := (<-this.LoadMarkets())
            PanicOnError(retRes659332)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes195331 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes195331)
                    ch <- retRes195331
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes338767 := (<-this.LoadMarkets())
            PanicOnError(retRes338767)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes413658 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes413658)
                    ch <- retRes413658
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes537657 := (<-this.LoadMarkets())
            PanicOnError(retRes537657)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes548725 := (<-this.LoadMarkets())
            PanicOnError(retRes548725)
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes198921 := (<-this.LoadMarkets())
            PanicOnError(retRes198921)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes198138 := (<-this.LoadMarkets())
            PanicOnError(retRes198138)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes42139 := (<-this.LoadMarkets())
            PanicOnError(retRes42139)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes263451 := (<-this.LoadMarkets())
            PanicOnError(retRes263451)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes688429 := (<-this.LoadMarkets())
            PanicOnError(retRes688429)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes680706 := (<-this.LoadMarkets())
            PanicOnError(retRes680706)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes367047 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes367047)
                    ch <- retRes367047
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859575 := (<-this.LoadMarkets())
            PanicOnError(retRes859575)
            var market interface{} = this.Market(symbol)
