...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307327 := (<-this.LoadMarkets())
            PanicOnError(retRes307327)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117860 := (<-this.LoadMarkets())
            PanicOnError(retRes117860)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180926 := (<-this.LoadMarkets())
            PanicOnError(retRes180926)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes446424 := (<-this.LoadMarkets())
            PanicOnError(retRes446424)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes862760 := (<-this.LoadMarkets())
            PanicOnError(retRes862760)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes538766 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes538766)
                    ch <- retRes538766
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72595 := (<-this.LoadMarkets())
            PanicOnError(retRes72595)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes244100 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes244100)
                    ch <- retRes244100
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes83445 := (<-this.LoadMarkets())
            PanicOnError(retRes83445)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes111178 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes111178)
                    ch <- retRes111178
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486363 := (<-this.LoadMarkets())
            PanicOnError(retRes486363)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes560269 := (<-this.LoadMarkets())
            PanicOnError(retRes560269)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes500436 := (<-this.LoadMarkets())
            PanicOnError(retRes500436)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes435102 := (<-this.LoadMarkets())
            PanicOnError(retRes435102)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes234132 := (<-this.LoadMarkets())
            PanicOnError(retRes234132)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes279814 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes279814)
                    ch <- retRes279814
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703170 := (<-this.LoadMarkets())
            PanicOnError(retRes703170)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes711653 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes711653)
                    ch <- retRes711653
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes806704 := (<-this.LoadMarkets())
            PanicOnError(retRes806704)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes703332 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes703332)
                    ch <- retRes703332
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes528437 := (<-this.LoadMarkets())
            PanicOnError(retRes528437)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes259367 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes259367)
                    ch <- retRes259367
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes894684 := (<-this.LoadMarkets())
            PanicOnError(retRes894684)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes161397 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes161397)
                    ch <- retRes161397
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes158108 := (<-this.LoadMarkets())
            PanicOnError(retRes158108)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes580373 := (<-this.LoadMarkets())
            PanicOnError(retRes580373)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes449825 := (<-this.LoadMarkets())
            PanicOnError(retRes449825)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937129 := (<-this.LoadMarkets())
            PanicOnError(retRes937129)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes424268 := (<-this.LoadMarkets())
            PanicOnError(retRes424268)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes658697 := (<-this.LoadMarkets())
            PanicOnError(retRes658697)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes950911 := (<-this.LoadMarkets())
            PanicOnError(retRes950911)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes663161 := (<-this.LoadMarkets())
            PanicOnError(retRes663161)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes939079 := (<-this.LoadMarkets())
            PanicOnError(retRes939079)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes975700 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes975700)
                    ch <- retRes975700
                    return nil
            }
            var request interface{} = map[string]interface{} {}
