...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes986697 := (<-this.LoadMarkets())
            PanicOnError(retRes986697)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes484936 := (<-this.LoadMarkets())
            PanicOnError(retRes484936)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153786 := (<-this.LoadMarkets())
            PanicOnError(retRes153786)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes941379 := (<-this.LoadMarkets())
            PanicOnError(retRes941379)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes106457 := (<-this.LoadMarkets())
            PanicOnError(retRes106457)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes627813 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes627813)
                    ch <- retRes627813
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes594283 := (<-this.LoadMarkets())
            PanicOnError(retRes594283)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes72805 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes72805)
                    ch <- retRes72805
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes926831 := (<-this.LoadMarkets())
            PanicOnError(retRes926831)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes908028 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes908028)
                    ch <- retRes908028
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes275624 := (<-this.LoadMarkets())
            PanicOnError(retRes275624)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493683 := (<-this.LoadMarkets())
            PanicOnError(retRes493683)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes482247 := (<-this.LoadMarkets())
            PanicOnError(retRes482247)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814012 := (<-this.LoadMarkets())
            PanicOnError(retRes814012)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes213688 := (<-this.LoadMarkets())
            PanicOnError(retRes213688)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes280192 := (<-this.LoadMarkets())
            PanicOnError(retRes280192)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes367705 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes367705)
                    ch <- retRes367705
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes648791 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes648791)
                    ch <- retRes648791
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes919303 := (<-this.LoadMarkets())
            PanicOnError(retRes919303)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes60663 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes60663)
                    ch <- retRes60663
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes148277 := (<-this.LoadMarkets())
            PanicOnError(retRes148277)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes212800 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes212800)
                    ch <- retRes212800
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes737976 := (<-this.LoadMarkets())
            PanicOnError(retRes737976)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes213514 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes213514)
                    ch <- retRes213514
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes846268 := (<-this.LoadMarkets())
            PanicOnError(retRes846268)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes314951 := (<-this.LoadMarkets())
            PanicOnError(retRes314951)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes184803 := (<-this.LoadMarkets())
            PanicOnError(retRes184803)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes601888 := (<-this.LoadMarkets())
            PanicOnError(retRes601888)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92469 := (<-this.LoadMarkets())
            PanicOnError(retRes92469)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470134 := (<-this.LoadMarkets())
            PanicOnError(retRes470134)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes130965 := (<-this.LoadMarkets())
            PanicOnError(retRes130965)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes514663 := (<-this.LoadMarkets())
            PanicOnError(retRes514663)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583762 := (<-this.LoadMarkets())
            PanicOnError(retRes583762)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes916713 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes916713)
                    ch <- retRes916713
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860317 := (<-this.LoadMarkets())
            PanicOnError(retRes860317)
            var market interface{} = this.Market(symbol)
