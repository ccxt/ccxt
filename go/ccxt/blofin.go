...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100722 := (<-this.LoadMarkets())
            PanicOnError(retRes100722)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes778633 := (<-this.LoadMarkets())
            PanicOnError(retRes778633)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes945894 := (<-this.LoadMarkets())
            PanicOnError(retRes945894)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654776 := (<-this.LoadMarkets())
            PanicOnError(retRes654776)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes891141 := (<-this.LoadMarkets())
            PanicOnError(retRes891141)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes906488 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes906488)
                    ch <- retRes906488
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711204 := (<-this.LoadMarkets())
            PanicOnError(retRes711204)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes217609 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes217609)
                    ch <- retRes217609
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes720425 := (<-this.LoadMarkets())
            PanicOnError(retRes720425)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes521653 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes521653)
                    ch <- retRes521653
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes245668 := (<-this.LoadMarkets())
            PanicOnError(retRes245668)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes227948 := (<-this.LoadMarkets())
            PanicOnError(retRes227948)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes756692 := (<-this.LoadMarkets())
            PanicOnError(retRes756692)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes123374 := (<-this.LoadMarkets())
            PanicOnError(retRes123374)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987978 := (<-this.LoadMarkets())
            PanicOnError(retRes987978)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes76295 := (<-this.LoadMarkets())
            PanicOnError(retRes76295)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes440911 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes440911)
                    ch <- retRes440911
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164946 := (<-this.LoadMarkets())
            PanicOnError(retRes164946)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes696709 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes696709)
                    ch <- retRes696709
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes819444 := (<-this.LoadMarkets())
            PanicOnError(retRes819444)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes817956 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes817956)
                    ch <- retRes817956
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515568 := (<-this.LoadMarkets())
            PanicOnError(retRes515568)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes784264 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes784264)
                    ch <- retRes784264
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96649 := (<-this.LoadMarkets())
            PanicOnError(retRes96649)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes760468 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes760468)
                    ch <- retRes760468
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes600491 := (<-this.LoadMarkets())
            PanicOnError(retRes600491)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes503594 := (<-this.LoadMarkets())
            PanicOnError(retRes503594)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792859 := (<-this.LoadMarkets())
            PanicOnError(retRes792859)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes389767 := (<-this.LoadMarkets())
            PanicOnError(retRes389767)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes948742 := (<-this.LoadMarkets())
            PanicOnError(retRes948742)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255850 := (<-this.LoadMarkets())
            PanicOnError(retRes255850)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes186207 := (<-this.LoadMarkets())
            PanicOnError(retRes186207)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes294686 := (<-this.LoadMarkets())
            PanicOnError(retRes294686)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes529919 := (<-this.LoadMarkets())
            PanicOnError(retRes529919)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes273550 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes947423 := (<-this.LoadMarkets())
            PanicOnError(retRes947423)
            var market interface{} = this.Market(symbol)
