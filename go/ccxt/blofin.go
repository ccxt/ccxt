...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes655494 := (<-this.LoadMarkets())
            PanicOnError(retRes655494)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes543689 := (<-this.LoadMarkets())
            PanicOnError(retRes543689)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes934978 := (<-this.LoadMarkets())
            PanicOnError(retRes934978)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913789 := (<-this.LoadMarkets())
            PanicOnError(retRes913789)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes686723 := (<-this.LoadMarkets())
            PanicOnError(retRes686723)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes2273 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes2273)
                    ch <- retRes2273
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes976788 := (<-this.LoadMarkets())
            PanicOnError(retRes976788)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes19205 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes19205)
                    ch <- retRes19205
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526420 := (<-this.LoadMarkets())
            PanicOnError(retRes526420)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes848657 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes848657)
                    ch <- retRes848657
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes108625 := (<-this.LoadMarkets())
            PanicOnError(retRes108625)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes670140 := (<-this.LoadMarkets())
            PanicOnError(retRes670140)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112958 := (<-this.LoadMarkets())
            PanicOnError(retRes112958)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180402 := (<-this.LoadMarkets())
            PanicOnError(retRes180402)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes788628 := (<-this.LoadMarkets())
            PanicOnError(retRes788628)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes35521 := (<-this.LoadMarkets())
            PanicOnError(retRes35521)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes249938 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes249938)
                    ch <- retRes249938
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes867437 := (<-this.LoadMarkets())
            PanicOnError(retRes867437)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes169709 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes169709)
                    ch <- retRes169709
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes531193 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes531193)
                    ch <- retRes531193
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes736863 := (<-this.LoadMarkets())
            PanicOnError(retRes736863)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes522339 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes522339)
                    ch <- retRes522339
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes167333 := (<-this.LoadMarkets())
            PanicOnError(retRes167333)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes633970 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes633970)
                    ch <- retRes633970
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes516630 := (<-this.LoadMarkets())
            PanicOnError(retRes516630)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes212174 := (<-this.LoadMarkets())
            PanicOnError(retRes212174)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes584665 := (<-this.LoadMarkets())
            PanicOnError(retRes584665)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes57263 := (<-this.LoadMarkets())
            PanicOnError(retRes57263)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes771370 := (<-this.LoadMarkets())
            PanicOnError(retRes771370)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes118174 := (<-this.LoadMarkets())
            PanicOnError(retRes118174)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes997771 := (<-this.LoadMarkets())
            PanicOnError(retRes997771)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes474348 := (<-this.LoadMarkets())
            PanicOnError(retRes474348)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes724275 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes724275)
                    ch <- retRes724275
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes871765 := (<-this.LoadMarkets())
            PanicOnError(retRes871765)
            var market interface{} = this.Market(symbol)
