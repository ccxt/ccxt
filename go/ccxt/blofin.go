...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes355393 := (<-this.LoadMarkets())
            PanicOnError(retRes355393)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133517 := (<-this.LoadMarkets())
            PanicOnError(retRes133517)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes895970 := (<-this.LoadMarkets())
            PanicOnError(retRes895970)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes324850 := (<-this.LoadMarkets())
            PanicOnError(retRes324850)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes111490 := (<-this.LoadMarkets())
            PanicOnError(retRes111490)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes73771 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes73771)
                    ch <- retRes73771
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes932249 := (<-this.LoadMarkets())
            PanicOnError(retRes932249)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes702819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes702819)
                    ch <- retRes702819
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes43813 := (<-this.LoadMarkets())
            PanicOnError(retRes43813)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes361254 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes361254)
                    ch <- retRes361254
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278903 := (<-this.LoadMarkets())
            PanicOnError(retRes278903)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102077 := (<-this.LoadMarkets())
            PanicOnError(retRes102077)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes439342 := (<-this.LoadMarkets())
            PanicOnError(retRes439342)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes372502 := (<-this.LoadMarkets())
            PanicOnError(retRes372502)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes275594 := (<-this.LoadMarkets())
            PanicOnError(retRes275594)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes45484 := (<-this.LoadMarkets())
            PanicOnError(retRes45484)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes808466 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes808466)
                    ch <- retRes808466
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes906215 := (<-this.LoadMarkets())
            PanicOnError(retRes906215)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes610513 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes610513)
                    ch <- retRes610513
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes97579 := (<-this.LoadMarkets())
            PanicOnError(retRes97579)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes465190 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes465190)
                    ch <- retRes465190
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319761 := (<-this.LoadMarkets())
            PanicOnError(retRes319761)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes229950 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes229950)
                    ch <- retRes229950
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes488742 := (<-this.LoadMarkets())
            PanicOnError(retRes488742)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes380157 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes380157)
                    ch <- retRes380157
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740083 := (<-this.LoadMarkets())
            PanicOnError(retRes740083)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes540973 := (<-this.LoadMarkets())
            PanicOnError(retRes540973)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes155806 := (<-this.LoadMarkets())
            PanicOnError(retRes155806)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272795 := (<-this.LoadMarkets())
            PanicOnError(retRes272795)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507104 := (<-this.LoadMarkets())
            PanicOnError(retRes507104)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515792 := (<-this.LoadMarkets())
            PanicOnError(retRes515792)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes853826 := (<-this.LoadMarkets())
            PanicOnError(retRes853826)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241588 := (<-this.LoadMarkets())
            PanicOnError(retRes241588)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes132365 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes132365)
                    ch <- retRes132365
                    return nil
            }
            var request interface{} = map[string]interface{} {}
