...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes971906 := (<-this.LoadMarkets())
            PanicOnError(retRes971906)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes79865 := (<-this.LoadMarkets())
            PanicOnError(retRes79865)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733258 := (<-this.LoadMarkets())
            PanicOnError(retRes733258)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638197 := (<-this.LoadMarkets())
            PanicOnError(retRes638197)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes797944 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes797944)
                    ch <- retRes797944
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes590688 := (<-this.LoadMarkets())
            PanicOnError(retRes590688)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes976037 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes976037)
                    ch <- retRes976037
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes165918 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes165918)
                    ch <- retRes165918
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes916492 := (<-this.LoadMarkets())
            PanicOnError(retRes916492)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711105 := (<-this.LoadMarkets())
            PanicOnError(retRes711105)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes643865 := (<-this.LoadMarkets())
            PanicOnError(retRes643865)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112605 := (<-this.LoadMarkets())
            PanicOnError(retRes112605)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes522778 := (<-this.LoadMarkets())
            PanicOnError(retRes522778)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614738 := (<-this.LoadMarkets())
            PanicOnError(retRes614738)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes884370 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes884370)
                    ch <- retRes884370
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes361195 := (<-this.LoadMarkets())
            PanicOnError(retRes361195)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes671518 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes671518)
                    ch <- retRes671518
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes215007 := (<-this.LoadMarkets())
            PanicOnError(retRes215007)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes431849 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes431849)
                    ch <- retRes431849
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859644 := (<-this.LoadMarkets())
            PanicOnError(retRes859644)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes819465 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858542 := (<-this.LoadMarkets())
            PanicOnError(retRes858542)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes953448 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes953448)
                    ch <- retRes953448
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes975812 := (<-this.LoadMarkets())
            PanicOnError(retRes975812)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes880447 := (<-this.LoadMarkets())
            PanicOnError(retRes880447)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes194541 := (<-this.LoadMarkets())
            PanicOnError(retRes194541)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes197482 := (<-this.LoadMarkets())
            PanicOnError(retRes197482)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes739318 := (<-this.LoadMarkets())
            PanicOnError(retRes739318)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes804510 := (<-this.LoadMarkets())
            PanicOnError(retRes804510)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes803289 := (<-this.LoadMarkets())
            PanicOnError(retRes803289)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes303539 := (<-this.LoadMarkets())
            PanicOnError(retRes303539)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875644 := (<-this.LoadMarkets())
            PanicOnError(retRes875644)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes160318 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes160318)
                    ch <- retRes160318
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes689802 := (<-this.LoadMarkets())
            PanicOnError(retRes689802)
            var market interface{} = this.Market(symbol)
