...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes383637 := (<-this.LoadMarkets())
            PanicOnError(retRes383637)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49867 := (<-this.LoadMarkets())
            PanicOnError(retRes49867)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes190287 := (<-this.LoadMarkets())
            PanicOnError(retRes190287)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes440942 := (<-this.LoadMarkets())
            PanicOnError(retRes440942)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515687 := (<-this.LoadMarkets())
            PanicOnError(retRes515687)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes773332 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes773332)
                    ch <- retRes773332
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526248 := (<-this.LoadMarkets())
            PanicOnError(retRes526248)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes483427 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes483427)
                    ch <- retRes483427
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102702 := (<-this.LoadMarkets())
            PanicOnError(retRes102702)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes50675 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes50675)
                    ch <- retRes50675
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46069 := (<-this.LoadMarkets())
            PanicOnError(retRes46069)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes58326 := (<-this.LoadMarkets())
            PanicOnError(retRes58326)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112642 := (<-this.LoadMarkets())
            PanicOnError(retRes112642)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes585798 := (<-this.LoadMarkets())
            PanicOnError(retRes585798)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes665369 := (<-this.LoadMarkets())
            PanicOnError(retRes665369)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes464113 := (<-this.LoadMarkets())
            PanicOnError(retRes464113)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes926518 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes926518)
                    ch <- retRes926518
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes361809 := (<-this.LoadMarkets())
            PanicOnError(retRes361809)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes373409 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes373409)
                    ch <- retRes373409
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes197345 := (<-this.LoadMarkets())
            PanicOnError(retRes197345)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes164724 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes164724)
                    ch <- retRes164724
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes491454 := (<-this.LoadMarkets())
            PanicOnError(retRes491454)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes232099 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes232099)
                    ch <- retRes232099
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes226127 := (<-this.LoadMarkets())
            PanicOnError(retRes226127)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes984665 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes984665)
                    ch <- retRes984665
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes494802 := (<-this.LoadMarkets())
            PanicOnError(retRes494802)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes517011 := (<-this.LoadMarkets())
            PanicOnError(retRes517011)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes251078 := (<-this.LoadMarkets())
            PanicOnError(retRes251078)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes238280 := (<-this.LoadMarkets())
            PanicOnError(retRes238280)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes174439 := (<-this.LoadMarkets())
            PanicOnError(retRes174439)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes457567 := (<-this.LoadMarkets())
            PanicOnError(retRes457567)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes409025 := (<-this.LoadMarkets())
            PanicOnError(retRes409025)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes666182 := (<-this.LoadMarkets())
            PanicOnError(retRes666182)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes379824 := (<-this.LoadMarkets())
            PanicOnError(retRes379824)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes978894 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes978894)
                    ch <- retRes978894
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes468271 := (<-this.LoadMarkets())
            PanicOnError(retRes468271)
            var market interface{} = this.Market(symbol)
