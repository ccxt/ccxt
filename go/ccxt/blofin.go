...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes765450 := (<-this.LoadMarkets())
            PanicOnError(retRes765450)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes125478 := (<-this.LoadMarkets())
            PanicOnError(retRes125478)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes221648 := (<-this.LoadMarkets())
            PanicOnError(retRes221648)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes920638 := (<-this.LoadMarkets())
            PanicOnError(retRes920638)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes626504 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes626504)
                    ch <- retRes626504
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes325616 := (<-this.LoadMarkets())
            PanicOnError(retRes325616)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes148276 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes148276)
                    ch <- retRes148276
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81127 := (<-this.LoadMarkets())
            PanicOnError(retRes81127)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes330750 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes330750)
                    ch <- retRes330750
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes123789 := (<-this.LoadMarkets())
            PanicOnError(retRes123789)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes298318 := (<-this.LoadMarkets())
            PanicOnError(retRes298318)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes301143 := (<-this.LoadMarkets())
            PanicOnError(retRes301143)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348683 := (<-this.LoadMarkets())
            PanicOnError(retRes348683)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes287083 := (<-this.LoadMarkets())
            PanicOnError(retRes287083)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes52647 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes52647)
                    ch <- retRes52647
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes829671 := (<-this.LoadMarkets())
            PanicOnError(retRes829671)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes615683 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes615683)
                    ch <- retRes615683
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78975 := (<-this.LoadMarkets())
            PanicOnError(retRes78975)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes339538 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes339538)
                    ch <- retRes339538
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes476119 := (<-this.LoadMarkets())
            PanicOnError(retRes476119)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes915000 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes915000)
                    ch <- retRes915000
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470545 := (<-this.LoadMarkets())
            PanicOnError(retRes470545)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes136057 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes561120 := (<-this.LoadMarkets())
            PanicOnError(retRes561120)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes321858 := (<-this.LoadMarkets())
            PanicOnError(retRes321858)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102377 := (<-this.LoadMarkets())
            PanicOnError(retRes102377)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes715816 := (<-this.LoadMarkets())
            PanicOnError(retRes715816)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660608 := (<-this.LoadMarkets())
            PanicOnError(retRes660608)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes816344 := (<-this.LoadMarkets())
            PanicOnError(retRes816344)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603050 := (<-this.LoadMarkets())
            PanicOnError(retRes603050)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49717 := (<-this.LoadMarkets())
            PanicOnError(retRes49717)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes797999 := (<-this.LoadMarkets())
            PanicOnError(retRes797999)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes577038 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes577038)
                    ch <- retRes577038
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes557462 := (<-this.LoadMarkets())
            PanicOnError(retRes557462)
            var market interface{} = this.Market(symbol)
