...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes201984 := (<-this.LoadMarkets())
            PanicOnError(retRes201984)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes428047 := (<-this.LoadMarkets())
            PanicOnError(retRes428047)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes762127 := (<-this.LoadMarkets())
            PanicOnError(retRes762127)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes341491 := (<-this.LoadMarkets())
            PanicOnError(retRes341491)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes961158 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes961158)
                    ch <- retRes961158
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes664412 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589890 := (<-this.LoadMarkets())
            PanicOnError(retRes589890)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes774473 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes774473)
                    ch <- retRes774473
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes68147 := (<-this.LoadMarkets())
            PanicOnError(retRes68147)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882657 := (<-this.LoadMarkets())
            PanicOnError(retRes882657)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes600446 := (<-this.LoadMarkets())
            PanicOnError(retRes600446)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes170460 := (<-this.LoadMarkets())
            PanicOnError(retRes170460)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733609 := (<-this.LoadMarkets())
            PanicOnError(retRes733609)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes28762 := (<-this.LoadMarkets())
            PanicOnError(retRes28762)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes442368 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes402812 := (<-this.LoadMarkets())
            PanicOnError(retRes402812)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes962528 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes962528)
                    ch <- retRes962528
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes785149 := (<-this.LoadMarkets())
            PanicOnError(retRes785149)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes157896 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes157896)
                    ch <- retRes157896
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes45150 := (<-this.LoadMarkets())
            PanicOnError(retRes45150)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes98686 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240429 := (<-this.LoadMarkets())
            PanicOnError(retRes240429)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes316701 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes316701)
                    ch <- retRes316701
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes849556 := (<-this.LoadMarkets())
            PanicOnError(retRes849556)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes838260 := (<-this.LoadMarkets())
            PanicOnError(retRes838260)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915148 := (<-this.LoadMarkets())
            PanicOnError(retRes915148)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes705942 := (<-this.LoadMarkets())
            PanicOnError(retRes705942)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes938128 := (<-this.LoadMarkets())
            PanicOnError(retRes938128)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes159716 := (<-this.LoadMarkets())
            PanicOnError(retRes159716)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes952205 := (<-this.LoadMarkets())
            PanicOnError(retRes952205)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432149 := (<-this.LoadMarkets())
            PanicOnError(retRes432149)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654263 := (<-this.LoadMarkets())
            PanicOnError(retRes654263)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes17658 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987589 := (<-this.LoadMarkets())
            PanicOnError(retRes987589)
            var market interface{} = this.Market(symbol)
