...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes215189 := (<-this.LoadMarkets())
            PanicOnError(retRes215189)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes991958 := (<-this.LoadMarkets())
            PanicOnError(retRes991958)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes919320 := (<-this.LoadMarkets())
            PanicOnError(retRes919320)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes154039 := (<-this.LoadMarkets())
            PanicOnError(retRes154039)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes351658 := (<-this.LoadMarkets())
            PanicOnError(retRes351658)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes509006 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes509006)
                    ch <- retRes509006
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes110359 := (<-this.LoadMarkets())
            PanicOnError(retRes110359)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes115940 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes115940)
                    ch <- retRes115940
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes146340 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes146340)
                    ch <- retRes146340
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes263748 := (<-this.LoadMarkets())
            PanicOnError(retRes263748)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes658939 := (<-this.LoadMarkets())
            PanicOnError(retRes658939)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490243 := (<-this.LoadMarkets())
            PanicOnError(retRes490243)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes943183 := (<-this.LoadMarkets())
            PanicOnError(retRes943183)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378777 := (<-this.LoadMarkets())
            PanicOnError(retRes378777)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes163554 := (<-this.LoadMarkets())
            PanicOnError(retRes163554)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes304210 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes304210)
                    ch <- retRes304210
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954005 := (<-this.LoadMarkets())
            PanicOnError(retRes954005)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes517439 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes517439)
                    ch <- retRes517439
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes422752 := (<-this.LoadMarkets())
            PanicOnError(retRes422752)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes757318 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes757318)
                    ch <- retRes757318
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes781576 := (<-this.LoadMarkets())
            PanicOnError(retRes781576)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes819261 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes819261)
                    ch <- retRes819261
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917632 := (<-this.LoadMarkets())
            PanicOnError(retRes917632)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes698351 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes698351)
                    ch <- retRes698351
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes573345 := (<-this.LoadMarkets())
            PanicOnError(retRes573345)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes918994 := (<-this.LoadMarkets())
            PanicOnError(retRes918994)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes879996 := (<-this.LoadMarkets())
            PanicOnError(retRes879996)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272288 := (<-this.LoadMarkets())
            PanicOnError(retRes272288)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes746001 := (<-this.LoadMarkets())
            PanicOnError(retRes746001)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes248993 := (<-this.LoadMarkets())
            PanicOnError(retRes248993)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes771948 := (<-this.LoadMarkets())
            PanicOnError(retRes771948)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes485071 := (<-this.LoadMarkets())
            PanicOnError(retRes485071)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes996801 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes996801)
                    ch <- retRes996801
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes764103 := (<-this.LoadMarkets())
            PanicOnError(retRes764103)
            var market interface{} = this.Market(symbol)
