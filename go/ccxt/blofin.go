...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes362464 := (<-this.LoadMarkets())
            PanicOnError(retRes362464)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes139917 := (<-this.LoadMarkets())
            PanicOnError(retRes139917)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes790537 := (<-this.LoadMarkets())
            PanicOnError(retRes790537)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes423414 := (<-this.LoadMarkets())
            PanicOnError(retRes423414)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116684 := (<-this.LoadMarkets())
            PanicOnError(retRes116684)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes404757 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes404757)
                    ch <- retRes404757
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599508 := (<-this.LoadMarkets())
            PanicOnError(retRes599508)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes960089 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes960089)
                    ch <- retRes960089
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes708546 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes708546)
                    ch <- retRes708546
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes459283 := (<-this.LoadMarkets())
            PanicOnError(retRes459283)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes18086 := (<-this.LoadMarkets())
            PanicOnError(retRes18086)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes590936 := (<-this.LoadMarkets())
            PanicOnError(retRes590936)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes58305 := (<-this.LoadMarkets())
            PanicOnError(retRes58305)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes310328 := (<-this.LoadMarkets())
            PanicOnError(retRes310328)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164658 := (<-this.LoadMarkets())
            PanicOnError(retRes164658)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes929470 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes929470)
                    ch <- retRes929470
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes204362 := (<-this.LoadMarkets())
            PanicOnError(retRes204362)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes555389 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes555389)
                    ch <- retRes555389
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes346152 := (<-this.LoadMarkets())
            PanicOnError(retRes346152)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes385391 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348748 := (<-this.LoadMarkets())
            PanicOnError(retRes348748)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes979083 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes979083)
                    ch <- retRes979083
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes593836 := (<-this.LoadMarkets())
            PanicOnError(retRes593836)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes240171 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes240171)
                    ch <- retRes240171
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes366766 := (<-this.LoadMarkets())
            PanicOnError(retRes366766)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes617213 := (<-this.LoadMarkets())
            PanicOnError(retRes617213)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes387130 := (<-this.LoadMarkets())
            PanicOnError(retRes387130)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes440664 := (<-this.LoadMarkets())
            PanicOnError(retRes440664)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94017 := (<-this.LoadMarkets())
            PanicOnError(retRes94017)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes874988 := (<-this.LoadMarkets())
            PanicOnError(retRes874988)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes993639 := (<-this.LoadMarkets())
            PanicOnError(retRes993639)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38448 := (<-this.LoadMarkets())
            PanicOnError(retRes38448)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes384337 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes384337)
                    ch <- retRes384337
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes25324 := (<-this.LoadMarkets())
            PanicOnError(retRes25324)
            var market interface{} = this.Market(symbol)
