...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes182961 := (<-this.LoadMarkets())
            PanicOnError(retRes182961)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes922006 := (<-this.LoadMarkets())
            PanicOnError(retRes922006)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94426 := (<-this.LoadMarkets())
            PanicOnError(retRes94426)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes265684 := (<-this.LoadMarkets())
            PanicOnError(retRes265684)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes563659 := (<-this.LoadMarkets())
            PanicOnError(retRes563659)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes803885 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes803885)
                    ch <- retRes803885
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687303 := (<-this.LoadMarkets())
            PanicOnError(retRes687303)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes72867 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes72867)
                    ch <- retRes72867
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89681 := (<-this.LoadMarkets())
            PanicOnError(retRes89681)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes344694 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes344694)
                    ch <- retRes344694
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes624833 := (<-this.LoadMarkets())
            PanicOnError(retRes624833)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116787 := (<-this.LoadMarkets())
            PanicOnError(retRes116787)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes744201 := (<-this.LoadMarkets())
            PanicOnError(retRes744201)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes215003 := (<-this.LoadMarkets())
            PanicOnError(retRes215003)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes626409 := (<-this.LoadMarkets())
            PanicOnError(retRes626409)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes489877 := (<-this.LoadMarkets())
            PanicOnError(retRes489877)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes539018 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes539018)
                    ch <- retRes539018
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes976567 := (<-this.LoadMarkets())
            PanicOnError(retRes976567)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes537516 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes537516)
                    ch <- retRes537516
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes464510 := (<-this.LoadMarkets())
            PanicOnError(retRes464510)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes284508 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes284508)
                    ch <- retRes284508
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes158565 := (<-this.LoadMarkets())
            PanicOnError(retRes158565)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes306705 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes306705)
                    ch <- retRes306705
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727831 := (<-this.LoadMarkets())
            PanicOnError(retRes727831)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes555816 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes555816)
                    ch <- retRes555816
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes250687 := (<-this.LoadMarkets())
            PanicOnError(retRes250687)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes825665 := (<-this.LoadMarkets())
            PanicOnError(retRes825665)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes848477 := (<-this.LoadMarkets())
            PanicOnError(retRes848477)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834874 := (<-this.LoadMarkets())
            PanicOnError(retRes834874)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes774304 := (<-this.LoadMarkets())
            PanicOnError(retRes774304)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes410891 := (<-this.LoadMarkets())
            PanicOnError(retRes410891)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes300825 := (<-this.LoadMarkets())
            PanicOnError(retRes300825)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes517840 := (<-this.LoadMarkets())
            PanicOnError(retRes517840)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes122439 := (<-this.LoadMarkets())
            PanicOnError(retRes122439)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes180576 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes180576)
                    ch <- retRes180576
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes958312 := (<-this.LoadMarkets())
            PanicOnError(retRes958312)
            var market interface{} = this.Market(symbol)
