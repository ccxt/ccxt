...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes841953 := (<-this.LoadMarkets())
            PanicOnError(retRes841953)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22825 := (<-this.LoadMarkets())
            PanicOnError(retRes22825)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307045 := (<-this.LoadMarkets())
            PanicOnError(retRes307045)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes597898 := (<-this.LoadMarkets())
            PanicOnError(retRes597898)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes249545 := (<-this.LoadMarkets())
            PanicOnError(retRes249545)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes936880 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes936880)
                    ch <- retRes936880
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes417783 := (<-this.LoadMarkets())
            PanicOnError(retRes417783)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes772523 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes772523)
                    ch <- retRes772523
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes292824 := (<-this.LoadMarkets())
            PanicOnError(retRes292824)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes109885 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes109885)
                    ch <- retRes109885
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes709616 := (<-this.LoadMarkets())
            PanicOnError(retRes709616)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes199794 := (<-this.LoadMarkets())
            PanicOnError(retRes199794)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes441246 := (<-this.LoadMarkets())
            PanicOnError(retRes441246)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49690 := (<-this.LoadMarkets())
            PanicOnError(retRes49690)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes624823 := (<-this.LoadMarkets())
            PanicOnError(retRes624823)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes323571 := (<-this.LoadMarkets())
            PanicOnError(retRes323571)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes336317 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes336317)
                    ch <- retRes336317
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes176137 := (<-this.LoadMarkets())
            PanicOnError(retRes176137)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes826001 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes826001)
                    ch <- retRes826001
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes563406 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes563406)
                    ch <- retRes563406
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes434438 := (<-this.LoadMarkets())
            PanicOnError(retRes434438)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes345885 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes477660 := (<-this.LoadMarkets())
            PanicOnError(retRes477660)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes28030 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes28030)
                    ch <- retRes28030
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes341974 := (<-this.LoadMarkets())
            PanicOnError(retRes341974)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100870 := (<-this.LoadMarkets())
            PanicOnError(retRes100870)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes708504 := (<-this.LoadMarkets())
            PanicOnError(retRes708504)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes673455 := (<-this.LoadMarkets())
            PanicOnError(retRes673455)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes101870 := (<-this.LoadMarkets())
            PanicOnError(retRes101870)
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes634145 := (<-this.LoadMarkets())
            PanicOnError(retRes634145)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes273490 := (<-this.LoadMarkets())
            PanicOnError(retRes273490)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes332448 := (<-this.LoadMarkets())
            PanicOnError(retRes332448)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes643466 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes643466)
                    ch <- retRes643466
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes984778 := (<-this.LoadMarkets())
            PanicOnError(retRes984778)
            var market interface{} = this.Market(symbol)
