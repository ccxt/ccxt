...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes968991 := (<-this.LoadMarkets())
            PanicOnError(retRes968991)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes353288 := (<-this.LoadMarkets())
            PanicOnError(retRes353288)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes365308 := (<-this.LoadMarkets())
            PanicOnError(retRes365308)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes866026 := (<-this.LoadMarkets())
            PanicOnError(retRes866026)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes587478 := (<-this.LoadMarkets())
            PanicOnError(retRes587478)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes881560 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes881560)
                    ch <- retRes881560
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes992358 := (<-this.LoadMarkets())
            PanicOnError(retRes992358)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes75131 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes75131)
                    ch <- retRes75131
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes765067 := (<-this.LoadMarkets())
            PanicOnError(retRes765067)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes15732 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes15732)
                    ch <- retRes15732
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631672 := (<-this.LoadMarkets())
            PanicOnError(retRes631672)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes442612 := (<-this.LoadMarkets())
            PanicOnError(retRes442612)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes941082 := (<-this.LoadMarkets())
            PanicOnError(retRes941082)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes618795 := (<-this.LoadMarkets())
            PanicOnError(retRes618795)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes20999 := (<-this.LoadMarkets())
            PanicOnError(retRes20999)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes712438 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes712438)
                    ch <- retRes712438
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes635521 := (<-this.LoadMarkets())
            PanicOnError(retRes635521)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes631233 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes631233)
                    ch <- retRes631233
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes716151 := (<-this.LoadMarkets())
            PanicOnError(retRes716151)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes482223 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes482223)
                    ch <- retRes482223
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes126432 := (<-this.LoadMarkets())
            PanicOnError(retRes126432)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes321138 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes266545 := (<-this.LoadMarkets())
            PanicOnError(retRes266545)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes706944 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731961 := (<-this.LoadMarkets())
            PanicOnError(retRes731961)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes267333 := (<-this.LoadMarkets())
            PanicOnError(retRes267333)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes123336 := (<-this.LoadMarkets())
            PanicOnError(retRes123336)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes395733 := (<-this.LoadMarkets())
            PanicOnError(retRes395733)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917954 := (<-this.LoadMarkets())
            PanicOnError(retRes917954)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes45870 := (<-this.LoadMarkets())
            PanicOnError(retRes45870)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348558 := (<-this.LoadMarkets())
            PanicOnError(retRes348558)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes76554 := (<-this.LoadMarkets())
            PanicOnError(retRes76554)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes498799 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes498799)
                    ch <- retRes498799
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes452432 := (<-this.LoadMarkets())
            PanicOnError(retRes452432)
            var market interface{} = this.Market(symbol)
