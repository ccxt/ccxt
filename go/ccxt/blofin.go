...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168854 := (<-this.LoadMarkets())
            PanicOnError(retRes168854)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes719464 := (<-this.LoadMarkets())
            PanicOnError(retRes719464)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes976957 := (<-this.LoadMarkets())
            PanicOnError(retRes976957)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes826620 := (<-this.LoadMarkets())
            PanicOnError(retRes826620)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes619489 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes619489)
                    ch <- retRes619489
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes384594 := (<-this.LoadMarkets())
            PanicOnError(retRes384594)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes488209 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes488209)
                    ch <- retRes488209
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes874070 := (<-this.LoadMarkets())
            PanicOnError(retRes874070)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes417195 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes417195)
                    ch <- retRes417195
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes923478 := (<-this.LoadMarkets())
            PanicOnError(retRes923478)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes424635 := (<-this.LoadMarkets())
            PanicOnError(retRes424635)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes274173 := (<-this.LoadMarkets())
            PanicOnError(retRes274173)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes450544 := (<-this.LoadMarkets())
            PanicOnError(retRes450544)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes483473 := (<-this.LoadMarkets())
            PanicOnError(retRes483473)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes397045 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes397045)
                    ch <- retRes397045
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903250 := (<-this.LoadMarkets())
            PanicOnError(retRes903250)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes569878 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes569878)
                    ch <- retRes569878
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes618001 := (<-this.LoadMarkets())
            PanicOnError(retRes618001)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes355274 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes355274)
                    ch <- retRes355274
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes983750 := (<-this.LoadMarkets())
            PanicOnError(retRes983750)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes474958 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes474958)
                    ch <- retRes474958
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131665 := (<-this.LoadMarkets())
            PanicOnError(retRes131665)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes852874 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes852874)
                    ch <- retRes852874
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747828 := (<-this.LoadMarkets())
            PanicOnError(retRes747828)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes610645 := (<-this.LoadMarkets())
            PanicOnError(retRes610645)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes35005 := (<-this.LoadMarkets())
            PanicOnError(retRes35005)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes730363 := (<-this.LoadMarkets())
            PanicOnError(retRes730363)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860908 := (<-this.LoadMarkets())
            PanicOnError(retRes860908)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403885 := (<-this.LoadMarkets())
            PanicOnError(retRes403885)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes967130 := (<-this.LoadMarkets())
            PanicOnError(retRes967130)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes791106 := (<-this.LoadMarkets())
            PanicOnError(retRes791106)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes907454 := (<-this.LoadMarkets())
            PanicOnError(retRes907454)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes666777 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes666777)
                    ch <- retRes666777
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486511 := (<-this.LoadMarkets())
            PanicOnError(retRes486511)
            var market interface{} = this.Market(symbol)
