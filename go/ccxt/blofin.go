...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes542441 := (<-this.LoadMarkets())
            PanicOnError(retRes542441)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes847010 := (<-this.LoadMarkets())
            PanicOnError(retRes847010)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes397567 := (<-this.LoadMarkets())
            PanicOnError(retRes397567)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes21667 := (<-this.LoadMarkets())
            PanicOnError(retRes21667)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes865029 := (<-this.LoadMarkets())
            PanicOnError(retRes865029)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes984934 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes984934)
                    ch <- retRes984934
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913990 := (<-this.LoadMarkets())
            PanicOnError(retRes913990)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes219527 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes219527)
                    ch <- retRes219527
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes594290 := (<-this.LoadMarkets())
            PanicOnError(retRes594290)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes580684 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes580684)
                    ch <- retRes580684
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes647316 := (<-this.LoadMarkets())
            PanicOnError(retRes647316)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes92314 := (<-this.LoadMarkets())
            PanicOnError(retRes92314)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740098 := (<-this.LoadMarkets())
            PanicOnError(retRes740098)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94432 := (<-this.LoadMarkets())
            PanicOnError(retRes94432)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740813 := (<-this.LoadMarkets())
            PanicOnError(retRes740813)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes675350 := (<-this.LoadMarkets())
            PanicOnError(retRes675350)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes512434 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes512434)
                    ch <- retRes512434
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244630 := (<-this.LoadMarkets())
            PanicOnError(retRes244630)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes656554 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes656554)
                    ch <- retRes656554
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes455306 := (<-this.LoadMarkets())
            PanicOnError(retRes455306)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes36607 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes36607)
                    ch <- retRes36607
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes601546 := (<-this.LoadMarkets())
            PanicOnError(retRes601546)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes648352 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes648352)
                    ch <- retRes648352
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes742103 := (<-this.LoadMarkets())
            PanicOnError(retRes742103)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes473054 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes397013 := (<-this.LoadMarkets())
            PanicOnError(retRes397013)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes303513 := (<-this.LoadMarkets())
            PanicOnError(retRes303513)
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes203834 := (<-this.LoadMarkets())
            PanicOnError(retRes203834)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes797540 := (<-this.LoadMarkets())
            PanicOnError(retRes797540)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes460648 := (<-this.LoadMarkets())
            PanicOnError(retRes460648)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes288439 := (<-this.LoadMarkets())
            PanicOnError(retRes288439)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes978787 := (<-this.LoadMarkets())
            PanicOnError(retRes978787)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727936 := (<-this.LoadMarkets())
            PanicOnError(retRes727936)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes901085 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes901085)
                    ch <- retRes901085
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes290235 := (<-this.LoadMarkets())
            PanicOnError(retRes290235)
            var market interface{} = this.Market(symbol)
