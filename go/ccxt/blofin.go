...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes144971 := (<-this.LoadMarkets())
            PanicOnError(retRes144971)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes293280 := (<-this.LoadMarkets())
            PanicOnError(retRes293280)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283832 := (<-this.LoadMarkets())
            PanicOnError(retRes283832)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes369377 := (<-this.LoadMarkets())
            PanicOnError(retRes369377)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes802436 := (<-this.LoadMarkets())
            PanicOnError(retRes802436)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes847433 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes847433)
                    ch <- retRes847433
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117720 := (<-this.LoadMarkets())
            PanicOnError(retRes117720)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes999066 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes999066)
                    ch <- retRes999066
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes670257 := (<-this.LoadMarkets())
            PanicOnError(retRes670257)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes917465 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes917465)
                    ch <- retRes917465
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes609006 := (<-this.LoadMarkets())
            PanicOnError(retRes609006)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes777683 := (<-this.LoadMarkets())
            PanicOnError(retRes777683)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes684962 := (<-this.LoadMarkets())
            PanicOnError(retRes684962)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes773463 := (<-this.LoadMarkets())
            PanicOnError(retRes773463)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes575682 := (<-this.LoadMarkets())
            PanicOnError(retRes575682)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes442530 := (<-this.LoadMarkets())
            PanicOnError(retRes442530)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes887732 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes887732)
                    ch <- retRes887732
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes856515 := (<-this.LoadMarkets())
            PanicOnError(retRes856515)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes962354 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes962354)
                    ch <- retRes962354
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes717163 := (<-this.LoadMarkets())
            PanicOnError(retRes717163)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes491284 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes736016 := (<-this.LoadMarkets())
            PanicOnError(retRes736016)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes765007 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes765007)
                    ch <- retRes765007
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929817 := (<-this.LoadMarkets())
            PanicOnError(retRes929817)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes822162 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes822162)
                    ch <- retRes822162
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes198992 := (<-this.LoadMarkets())
            PanicOnError(retRes198992)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes923233 := (<-this.LoadMarkets())
            PanicOnError(retRes923233)
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes148058 := (<-this.LoadMarkets())
            PanicOnError(retRes148058)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112306 := (<-this.LoadMarkets())
            PanicOnError(retRes112306)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes812039 := (<-this.LoadMarkets())
            PanicOnError(retRes812039)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes689359 := (<-this.LoadMarkets())
            PanicOnError(retRes689359)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes900214 := (<-this.LoadMarkets())
            PanicOnError(retRes900214)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes7057 := (<-this.LoadMarkets())
            PanicOnError(retRes7057)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes59032 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes59032)
                    ch <- retRes59032
                    return nil
            }
            var request interface{} = map[string]interface{} {}
