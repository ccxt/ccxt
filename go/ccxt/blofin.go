...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes397142 := (<-this.LoadMarkets())
            PanicOnError(retRes397142)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes254964 := (<-this.LoadMarkets())
            PanicOnError(retRes254964)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes152736 := (<-this.LoadMarkets())
            PanicOnError(retRes152736)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes775676 := (<-this.LoadMarkets())
            PanicOnError(retRes775676)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes824478 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes210873 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes210873)
                    ch <- retRes210873
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes504155 := (<-this.LoadMarkets())
            PanicOnError(retRes504155)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes109242 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes109242)
                    ch <- retRes109242
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes726556 := (<-this.LoadMarkets())
            PanicOnError(retRes726556)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes170351 := (<-this.LoadMarkets())
            PanicOnError(retRes170351)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes757511 := (<-this.LoadMarkets())
            PanicOnError(retRes757511)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes9474 := (<-this.LoadMarkets())
            PanicOnError(retRes9474)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes548884 := (<-this.LoadMarkets())
            PanicOnError(retRes548884)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes228189 := (<-this.LoadMarkets())
            PanicOnError(retRes228189)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes553446 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes553446)
                    ch <- retRes553446
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes886041 := (<-this.LoadMarkets())
            PanicOnError(retRes886041)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes999463 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes999463)
                    ch <- retRes999463
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834155 := (<-this.LoadMarkets())
            PanicOnError(retRes834155)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes322628 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes322628)
                    ch <- retRes322628
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes269749 := (<-this.LoadMarkets())
            PanicOnError(retRes269749)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes562048 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes562048)
                    ch <- retRes562048
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731184 := (<-this.LoadMarkets())
            PanicOnError(retRes731184)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes516592 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes516592)
                    ch <- retRes516592
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes581049 := (<-this.LoadMarkets())
            PanicOnError(retRes581049)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes444132 := (<-this.LoadMarkets())
            PanicOnError(retRes444132)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes269908 := (<-this.LoadMarkets())
            PanicOnError(retRes269908)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928535 := (<-this.LoadMarkets())
            PanicOnError(retRes928535)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406484 := (<-this.LoadMarkets())
            PanicOnError(retRes406484)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes17372 := (<-this.LoadMarkets())
            PanicOnError(retRes17372)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117651 := (<-this.LoadMarkets())
            PanicOnError(retRes117651)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes199805 := (<-this.LoadMarkets())
            PanicOnError(retRes199805)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes25090 := (<-this.LoadMarkets())
            PanicOnError(retRes25090)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes178339 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes178339)
                    ch <- retRes178339
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882754 := (<-this.LoadMarkets())
            PanicOnError(retRes882754)
            var market interface{} = this.Market(symbol)
