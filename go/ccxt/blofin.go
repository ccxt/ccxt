...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes167349 := (<-this.LoadMarkets())
            PanicOnError(retRes167349)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes704752 := (<-this.LoadMarkets())
            PanicOnError(retRes704752)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes828902 := (<-this.LoadMarkets())
            PanicOnError(retRes828902)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes643718 := (<-this.LoadMarkets())
            PanicOnError(retRes643718)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493496 := (<-this.LoadMarkets())
            PanicOnError(retRes493496)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes358401 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes358401)
                    ch <- retRes358401
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes757051 := (<-this.LoadMarkets())
            PanicOnError(retRes757051)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes718258 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes718258)
                    ch <- retRes718258
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486269 := (<-this.LoadMarkets())
            PanicOnError(retRes486269)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes360061 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes360061)
                    ch <- retRes360061
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes238210 := (<-this.LoadMarkets())
            PanicOnError(retRes238210)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858531 := (<-this.LoadMarkets())
            PanicOnError(retRes858531)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes462452 := (<-this.LoadMarkets())
            PanicOnError(retRes462452)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes158659 := (<-this.LoadMarkets())
            PanicOnError(retRes158659)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747885 := (<-this.LoadMarkets())
            PanicOnError(retRes747885)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes996704 := (<-this.LoadMarkets())
            PanicOnError(retRes996704)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes237769 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes237769)
                    ch <- retRes237769
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes410505 := (<-this.LoadMarkets())
            PanicOnError(retRes410505)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes784319 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes499173 := (<-this.LoadMarkets())
            PanicOnError(retRes499173)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes386887 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes386887)
                    ch <- retRes386887
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes862448 := (<-this.LoadMarkets())
            PanicOnError(retRes862448)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes824393 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes824393)
                    ch <- retRes824393
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33893 := (<-this.LoadMarkets())
            PanicOnError(retRes33893)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes769136 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes769136)
                    ch <- retRes769136
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes608964 := (<-this.LoadMarkets())
            PanicOnError(retRes608964)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633702 := (<-this.LoadMarkets())
            PanicOnError(retRes633702)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes552529 := (<-this.LoadMarkets())
            PanicOnError(retRes552529)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes420189 := (<-this.LoadMarkets())
            PanicOnError(retRes420189)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes309458 := (<-this.LoadMarkets())
            PanicOnError(retRes309458)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes965104 := (<-this.LoadMarkets())
            PanicOnError(retRes965104)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes890343 := (<-this.LoadMarkets())
            PanicOnError(retRes890343)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes79692 := (<-this.LoadMarkets())
            PanicOnError(retRes79692)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes449842 := (<-this.LoadMarkets())
            PanicOnError(retRes449842)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes409383 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes409383)
                    ch <- retRes409383
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes604558 := (<-this.LoadMarkets())
            PanicOnError(retRes604558)
            var market interface{} = this.Market(symbol)
