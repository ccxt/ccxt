...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375474 := (<-this.LoadMarkets())
            PanicOnError(retRes375474)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes702886 := (<-this.LoadMarkets())
            PanicOnError(retRes702886)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes236314 := (<-this.LoadMarkets())
            PanicOnError(retRes236314)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348315 := (<-this.LoadMarkets())
            PanicOnError(retRes348315)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752658 := (<-this.LoadMarkets())
            PanicOnError(retRes752658)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes386683 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes386683)
                    ch <- retRes386683
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes139040 := (<-this.LoadMarkets())
            PanicOnError(retRes139040)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes41819 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes41819)
                    ch <- retRes41819
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814665 := (<-this.LoadMarkets())
            PanicOnError(retRes814665)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes866213 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes866213)
                    ch <- retRes866213
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes528097 := (<-this.LoadMarkets())
            PanicOnError(retRes528097)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes384852 := (<-this.LoadMarkets())
            PanicOnError(retRes384852)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes128289 := (<-this.LoadMarkets())
            PanicOnError(retRes128289)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes946123 := (<-this.LoadMarkets())
            PanicOnError(retRes946123)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes838123 := (<-this.LoadMarkets())
            PanicOnError(retRes838123)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes856847 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes856847)
                    ch <- retRes856847
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478877 := (<-this.LoadMarkets())
            PanicOnError(retRes478877)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes12165 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes12165)
                    ch <- retRes12165
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747897 := (<-this.LoadMarkets())
            PanicOnError(retRes747897)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes782972 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes782972)
                    ch <- retRes782972
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes902833 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes902833)
                    ch <- retRes902833
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes49149 := (<-this.LoadMarkets())
            PanicOnError(retRes49149)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes913367 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes913367)
                    ch <- retRes913367
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes523724 := (<-this.LoadMarkets())
            PanicOnError(retRes523724)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes189466 := (<-this.LoadMarkets())
            PanicOnError(retRes189466)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583698 := (<-this.LoadMarkets())
            PanicOnError(retRes583698)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62361 := (<-this.LoadMarkets())
            PanicOnError(retRes62361)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes981213 := (<-this.LoadMarkets())
            PanicOnError(retRes981213)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490623 := (<-this.LoadMarkets())
            PanicOnError(retRes490623)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes340568 := (<-this.LoadMarkets())
            PanicOnError(retRes340568)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319144 := (<-this.LoadMarkets())
            PanicOnError(retRes319144)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes227703 := (<-this.LoadMarkets())
            PanicOnError(retRes227703)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes197497 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes197497)
                    ch <- retRes197497
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes305287 := (<-this.LoadMarkets())
            PanicOnError(retRes305287)
            var market interface{} = this.Market(symbol)
