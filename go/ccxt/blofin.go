...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes264102 := (<-this.LoadMarkets())
            PanicOnError(retRes264102)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes863362 := (<-this.LoadMarkets())
            PanicOnError(retRes863362)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes134500 := (<-this.LoadMarkets())
            PanicOnError(retRes134500)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695627 := (<-this.LoadMarkets())
            PanicOnError(retRes695627)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes800467 := (<-this.LoadMarkets())
            PanicOnError(retRes800467)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes418802 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes22174 := (<-this.LoadMarkets())
            PanicOnError(retRes22174)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes257992 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes257992)
                    ch <- retRes257992
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518009 := (<-this.LoadMarkets())
            PanicOnError(retRes518009)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes521473 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes521473)
                    ch <- retRes521473
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858617 := (<-this.LoadMarkets())
            PanicOnError(retRes858617)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999829 := (<-this.LoadMarkets())
            PanicOnError(retRes999829)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes906775 := (<-this.LoadMarkets())
            PanicOnError(retRes906775)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes868563 := (<-this.LoadMarkets())
            PanicOnError(retRes868563)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes838536 := (<-this.LoadMarkets())
            PanicOnError(retRes838536)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes698416 := (<-this.LoadMarkets())
            PanicOnError(retRes698416)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes305519 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903641 := (<-this.LoadMarkets())
            PanicOnError(retRes903641)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes767419 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes160880 := (<-this.LoadMarkets())
            PanicOnError(retRes160880)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes789483 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes789483)
                    ch <- retRes789483
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes796572 := (<-this.LoadMarkets())
            PanicOnError(retRes796572)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes809768 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes809768)
                    ch <- retRes809768
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes567536 := (<-this.LoadMarkets())
            PanicOnError(retRes567536)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes69807 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes69807)
                    ch <- retRes69807
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes720191 := (<-this.LoadMarkets())
            PanicOnError(retRes720191)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes898516 := (<-this.LoadMarkets())
            PanicOnError(retRes898516)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes704685 := (<-this.LoadMarkets())
            PanicOnError(retRes704685)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes519585 := (<-this.LoadMarkets())
            PanicOnError(retRes519585)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes961526 := (<-this.LoadMarkets())
            PanicOnError(retRes961526)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes43023 := (<-this.LoadMarkets())
            PanicOnError(retRes43023)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes612898 := (<-this.LoadMarkets())
            PanicOnError(retRes612898)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes677131 := (<-this.LoadMarkets())
            PanicOnError(retRes677131)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes581537 := (<-this.LoadMarkets())
            PanicOnError(retRes581537)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes631769 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes631769)
                    ch <- retRes631769
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes741012 := (<-this.LoadMarkets())
            PanicOnError(retRes741012)
            var market interface{} = this.Market(symbol)
