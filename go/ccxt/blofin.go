...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes612421 := (<-this.LoadMarkets())
            PanicOnError(retRes612421)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes684347 := (<-this.LoadMarkets())
            PanicOnError(retRes684347)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660858 := (<-this.LoadMarkets())
            PanicOnError(retRes660858)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180708 := (<-this.LoadMarkets())
            PanicOnError(retRes180708)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes644654 := (<-this.LoadMarkets())
            PanicOnError(retRes644654)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes628423 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes628423)
                    ch <- retRes628423
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes871011 := (<-this.LoadMarkets())
            PanicOnError(retRes871011)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes23847 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes23847)
                    ch <- retRes23847
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes452288 := (<-this.LoadMarkets())
            PanicOnError(retRes452288)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes776048 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes776048)
                    ch <- retRes776048
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes956498 := (<-this.LoadMarkets())
            PanicOnError(retRes956498)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes114962 := (<-this.LoadMarkets())
            PanicOnError(retRes114962)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes735490 := (<-this.LoadMarkets())
            PanicOnError(retRes735490)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes911125 := (<-this.LoadMarkets())
            PanicOnError(retRes911125)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes889386 := (<-this.LoadMarkets())
            PanicOnError(retRes889386)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes20731 := (<-this.LoadMarkets())
            PanicOnError(retRes20731)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes685234 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes685234)
                    ch <- retRes685234
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes382081 := (<-this.LoadMarkets())
            PanicOnError(retRes382081)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes376297 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes376297)
                    ch <- retRes376297
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes461042 := (<-this.LoadMarkets())
            PanicOnError(retRes461042)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes497239 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes497239)
                    ch <- retRes497239
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes814128 := (<-this.LoadMarkets())
            PanicOnError(retRes814128)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes830503 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes830503)
                    ch <- retRes830503
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes358810 := (<-this.LoadMarkets())
            PanicOnError(retRes358810)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes589267 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes589267)
                    ch <- retRes589267
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes813555 := (<-this.LoadMarkets())
            PanicOnError(retRes813555)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696912 := (<-this.LoadMarkets())
            PanicOnError(retRes696912)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes684196 := (<-this.LoadMarkets())
            PanicOnError(retRes684196)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes110649 := (<-this.LoadMarkets())
            PanicOnError(retRes110649)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes667072 := (<-this.LoadMarkets())
            PanicOnError(retRes667072)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes60422 := (<-this.LoadMarkets())
            PanicOnError(retRes60422)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes151103 := (<-this.LoadMarkets())
            PanicOnError(retRes151103)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490803 := (<-this.LoadMarkets())
            PanicOnError(retRes490803)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes855233 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes855233)
                    ch <- retRes855233
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes237235 := (<-this.LoadMarkets())
            PanicOnError(retRes237235)
            var market interface{} = this.Market(symbol)
