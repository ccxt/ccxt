...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes20443 := (<-this.LoadMarkets())
            PanicOnError(retRes20443)
...
func  (this *blofin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141422 := (<-this.LoadMarkets())
            PanicOnError(retRes141422)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes3070 := (<-this.LoadMarkets())
            PanicOnError(retRes3070)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes779010 := (<-this.LoadMarkets())
            PanicOnError(retRes779010)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283273 := (<-this.LoadMarkets())
            PanicOnError(retRes283273)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes899171 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes899171)
                    ch <- retRes899171
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes858219 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes858219)
                    ch <- retRes858219
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes590853 := (<-this.LoadMarkets())
            PanicOnError(retRes590853)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes474941 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes474941)
                    ch <- retRes474941
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599930 := (<-this.LoadMarkets())
            PanicOnError(retRes599930)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes64760 := (<-this.LoadMarkets())
            PanicOnError(retRes64760)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes996826 := (<-this.LoadMarkets())
            PanicOnError(retRes996826)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339367 := (<-this.LoadMarkets())
            PanicOnError(retRes339367)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90437 := (<-this.LoadMarkets())
            PanicOnError(retRes90437)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes190549 := (<-this.LoadMarkets())
            PanicOnError(retRes190549)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes730867 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes730867)
                    ch <- retRes730867
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes127826 := (<-this.LoadMarkets())
            PanicOnError(retRes127826)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes36374 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes36374)
                    ch <- retRes36374
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes338392 := (<-this.LoadMarkets())
            PanicOnError(retRes338392)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes84348 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes914249 := (<-this.LoadMarkets())
            PanicOnError(retRes914249)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes536887 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes536887)
                    ch <- retRes536887
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307459 := (<-this.LoadMarkets())
            PanicOnError(retRes307459)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes21349 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes21349)
                    ch <- retRes21349
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes555709 := (<-this.LoadMarkets())
            PanicOnError(retRes555709)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes328874 := (<-this.LoadMarkets())
            PanicOnError(retRes328874)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes531627 := (<-this.LoadMarkets())
            PanicOnError(retRes531627)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes495881 := (<-this.LoadMarkets())
            PanicOnError(retRes495881)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes982530 := (<-this.LoadMarkets())
            PanicOnError(retRes982530)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes815917 := (<-this.LoadMarkets())
            PanicOnError(retRes815917)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740573 := (<-this.LoadMarkets())
            PanicOnError(retRes740573)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes661930 := (<-this.LoadMarkets())
            PanicOnError(retRes661930)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637911 := (<-this.LoadMarkets())
            PanicOnError(retRes637911)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes151377 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes151377)
                    ch <- retRes151377
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes370710 := (<-this.LoadMarkets())
            PanicOnError(retRes370710)
            var market interface{} = this.Market(symbol)
