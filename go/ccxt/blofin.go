...
func  (this *blofin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614142 := (<-this.LoadMarkets())
            PanicOnError(retRes614142)
...
func  (this *blofin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes686731 := (<-this.LoadMarkets())
            PanicOnError(retRes686731)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *blofin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes488984 := (<-this.LoadMarkets())
            PanicOnError(retRes488984)
...
func  (this *blofin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes888836 := (<-this.LoadMarkets())
            PanicOnError(retRes888836)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes968061 :=  (<-this.FetchPaginatedCallCursor("fetchTrades", symbol, since, limit, params, "tradeId", "after", nil, 100))
                    PanicOnError(retRes968061)
                    ch <- retRes968061
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515170 := (<-this.LoadMarkets())
            PanicOnError(retRes515170)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes713360 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 100))
                    PanicOnError(retRes713360)
                    ch <- retRes713360
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *blofin) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes788036 := (<-this.LoadMarkets())
            PanicOnError(retRes788036)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes978735 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes978735)
                    ch <- retRes978735
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchFundingRate(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153943 := (<-this.LoadMarkets())
            PanicOnError(retRes153943)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674378 := (<-this.LoadMarkets())
            PanicOnError(retRes674378)
...
func  (this *blofin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes186395 := (<-this.LoadMarkets())
            PanicOnError(retRes186395)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes205851 := (<-this.LoadMarkets())
            PanicOnError(retRes205851)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497192 := (<-this.LoadMarkets())
            PanicOnError(retRes497192)
...
func  (this *blofin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes992492 := (<-this.LoadMarkets())
            PanicOnError(retRes992492)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes209614 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes209614)
                    ch <- retRes209614
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes488181 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes488181)
                    ch <- retRes488181
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes616039 := (<-this.LoadMarkets())
            PanicOnError(retRes616039)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes857712 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
...
func  (this *blofin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes56949 := (<-this.LoadMarkets())
            PanicOnError(retRes56949)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes463071 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes463071)
                    ch <- retRes463071
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes163341 := (<-this.LoadMarkets())
            PanicOnError(retRes163341)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes987356 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes987356)
                    ch <- retRes987356
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *blofin) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes317806 := (<-this.LoadMarkets())
            PanicOnError(retRes317806)
            var market interface{} = this.Market(symbol)
...
func  (this *blofin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes436240 := (<-this.LoadMarkets())
            PanicOnError(retRes436240)
...
func  (this *blofin) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes855521 := (<-this.LoadMarkets())
            PanicOnError(retRes855521)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instId": GetValue(market, "id"),
            }
...
func  (this *blofin) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes534856 := (<-this.LoadMarkets())
            PanicOnError(retRes534856)
            symbols = this.MarketSymbols(symbols)
...
func  (this *blofin) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526820 := (<-this.LoadMarkets())
            PanicOnError(retRes526820)
...
func  (this *blofin) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes983961 := (<-this.LoadMarkets())
            PanicOnError(retRes983961)
            var marginMode interface{} = nil
...
func  (this *blofin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes643443 := (<-this.LoadMarkets())
            PanicOnError(retRes643443)
            var market interface{} = this.Market(symbol)
            var marginMode interface{} = nil
...
func  (this *blofin) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes454482 := (<-this.LoadMarkets())
            PanicOnError(retRes454482)
            var market interface{} = this.Market(symbol)
            var clientOrderId interface{} = this.SafeString(params, "clientOrderId")
            var marginMode interface{} = nil
...
func  (this *blofin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes737640 := (<-this.LoadMarkets())
            PanicOnError(retRes737640)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes473027 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *blofin) FetchMarginMode(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes602401 := (<-this.LoadMarkets())
            PanicOnError(retRes602401)
            var market interface{} = this.Market(symbol)
