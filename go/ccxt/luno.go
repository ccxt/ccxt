...
func  (this *luno) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes439899 := (<-this.LoadMarkets())
            PanicOnError(retRes439899)
...
func  (this *luno) FetchOrdersByState(state interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859220 := (<-this.LoadMarkets())
            PanicOnError(retRes859220)
            var request interface{} = map[string]interface{} {}
...
func  (this *luno) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes953956 :=  (<-this.FetchOrdersByState(nil, symbol, since, limit, params))
                PanicOnError(retRes953956)
                ch <- retRes953956
                return nil
...
func  (this *luno) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes770730 :=  (<-this.FetchOrdersByState("PENDING", symbol, since, limit, params))
                PanicOnError(retRes770730)
                ch <- retRes770730
                return nil
...
func  (this *luno) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes500324 :=  (<-this.FetchOrdersByState("COMPLETE", symbol, since, limit, params))
                PanicOnError(retRes500324)
                ch <- retRes500324
                return nil
...
func  (this *luno) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes449211 := (<-this.LoadMarkets())
            PanicOnError(retRes449211)
...
func  (this *luno) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes12796 := (<-this.LoadMarkets())
            PanicOnError(retRes12796)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486033 := (<-this.LoadMarkets())
            PanicOnError(retRes486033)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *luno) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834970 := (<-this.LoadMarkets())
            PanicOnError(retRes834970)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes629461 := (<-this.LoadMarkets())
            PanicOnError(retRes629461)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792457 := (<-this.LoadMarkets())
            PanicOnError(retRes792457)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes841895 := (<-this.LoadMarkets())
            PanicOnError(retRes841895)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *luno) FetchLedgerByEntries(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes661586 :=  (<-this.FetchLedger(code, since, limit, this.Extend(request, params)))
                PanicOnError(retRes661586)
                ch <- retRes661586
                return nil
...
func  (this *luno) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes623427 := (<-this.LoadMarkets())
            PanicOnError(retRes623427)
        
            retRes833584 := (<-this.LoadAccounts())
            PanicOnError(retRes833584)
