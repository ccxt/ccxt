...
func  (this *luno) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes290236 := (<-this.LoadMarkets())
            PanicOnError(retRes290236)
...
func  (this *luno) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes635509 := (<-this.LoadMarkets())
            PanicOnError(retRes635509)
...
func  (this *luno) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes295284 := (<-this.LoadMarkets())
            PanicOnError(retRes295284)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *luno) FetchOrdersByState(state interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes463926 := (<-this.LoadMarkets())
            PanicOnError(retRes463926)
            var request interface{} = map[string]interface{} {}
...
func  (this *luno) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes942049 :=  (<-this.FetchOrdersByState(nil, symbol, since, limit, params))
                PanicOnError(retRes942049)
                ch <- retRes942049
                return nil
...
func  (this *luno) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes770177 :=  (<-this.FetchOrdersByState("PENDING", symbol, since, limit, params))
                PanicOnError(retRes770177)
                ch <- retRes770177
                return nil
...
func  (this *luno) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes705862 :=  (<-this.FetchOrdersByState("COMPLETE", symbol, since, limit, params))
                PanicOnError(retRes705862)
                ch <- retRes705862
                return nil
...
func  (this *luno) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes169024 := (<-this.LoadMarkets())
            PanicOnError(retRes169024)
...
func  (this *luno) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980168 := (<-this.LoadMarkets())
            PanicOnError(retRes980168)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *luno) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes113721 := (<-this.LoadMarkets())
            PanicOnError(retRes113721)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes781446 := (<-this.LoadMarkets())
            PanicOnError(retRes781446)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *luno) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes608686 := (<-this.LoadMarkets())
            PanicOnError(retRes608686)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *luno) FetchLedgerByEntries(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes318646 :=  (<-this.FetchLedger(code, since, limit, this.Extend(request, params)))
...
func  (this *luno) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes881895 := (<-this.LoadMarkets())
            PanicOnError(retRes881895)
        
            retRes88848 := (<-this.LoadAccounts())
