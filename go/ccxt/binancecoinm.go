...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes824937 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes824937)
        ch <- retRes824937
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes132340 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes132340)
        ch <- retRes132340
                return nil
