...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes722243 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes722243)
        ch <- retRes722243
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes922858 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes922858)
        ch <- retRes922858
                return nil
