...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes639580 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes639580)
        ch <- retRes639580
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes858132 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes858132)
        ch <- retRes858132
                return nil
