...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes185543 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes185543)
        ch <- retRes185543
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes691132 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes691132)
        ch <- retRes691132
                return nil
