...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes866765 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes866765)
        ch <- retRes866765
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes694180 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes694180)
        ch <- retRes694180
                return nil
