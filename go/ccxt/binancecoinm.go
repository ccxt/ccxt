...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes79503 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes79503)
        ch <- retRes79503
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes891084 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes891084)
        ch <- retRes891084
                return nil
