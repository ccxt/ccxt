...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes715644 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes715644)
        ch <- retRes715644
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes318536 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes318536)
        ch <- retRes318536
                return nil
