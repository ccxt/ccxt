...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes881297 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes881297)
        ch <- retRes881297
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes52273 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes52273)
        ch <- retRes52273
                return nil
