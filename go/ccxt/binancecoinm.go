...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes611618 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes611618)
        ch <- retRes611618
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes346579 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes346579)
        ch <- retRes346579
                return nil
