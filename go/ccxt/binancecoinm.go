...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes209136 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes209136)
        ch <- retRes209136
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes778854 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes778854)
        ch <- retRes778854
                return nil
