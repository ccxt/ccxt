...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes863847 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes863847)
        ch <- retRes863847
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes167875 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes167875)
        ch <- retRes167875
                return nil
