...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes747306 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes747306)
        ch <- retRes747306
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes698188 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes698188)
        ch <- retRes698188
                return nil
