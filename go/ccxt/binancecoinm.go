...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes906143 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes906143)
        ch <- retRes906143
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes723864 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes723864)
        ch <- retRes723864
                return nil
