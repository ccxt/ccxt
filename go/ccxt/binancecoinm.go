...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes875190 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes875190)
        ch <- retRes875190
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes420662 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes420662)
        ch <- retRes420662
                return nil
