...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes45744 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes45744)
        ch <- retRes45744
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes989378 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes989378)
        ch <- retRes989378
                return nil
