...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes798787 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes798787)
        ch <- retRes798787
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes739450 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes739450)
        ch <- retRes739450
                return nil
