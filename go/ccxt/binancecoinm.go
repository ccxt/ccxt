...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes401631 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes401631)
        ch <- retRes401631
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes955414 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes955414)
        ch <- retRes955414
                return nil
