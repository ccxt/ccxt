...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes717140 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes717140)
        ch <- retRes717140
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes674536 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes674536)
        ch <- retRes674536
                return nil
