...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes285791 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes285791)
        ch <- retRes285791
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes37895 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes37895)
        ch <- retRes37895
                return nil
