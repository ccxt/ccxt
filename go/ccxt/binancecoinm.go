...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes958034 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes958034)
        ch <- retRes958034
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes372487 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes372487)
        ch <- retRes372487
                return nil
