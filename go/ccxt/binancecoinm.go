...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes88607 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes88607)
        ch <- retRes88607
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes893302 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes893302)
        ch <- retRes893302
                return nil
