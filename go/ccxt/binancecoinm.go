...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes911998 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes911998)
        ch <- retRes911998
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes846687 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes846687)
        ch <- retRes846687
                return nil
