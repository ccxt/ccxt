...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes223399 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes223399)
        ch <- retRes223399
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes309636 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes309636)
        ch <- retRes309636
                return nil
