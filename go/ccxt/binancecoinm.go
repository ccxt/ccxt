...
func  (this *binancecoinm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes650484 :=  (<-this.FuturesTransfer(code, amount, 3, params))
                PanicOnError(retRes650484)
        ch <- retRes650484
                return nil
...
func  (this *binancecoinm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes247847 :=  (<-this.FuturesTransfer(code, amount, 4, params))
                PanicOnError(retRes247847)
        ch <- retRes247847
                return nil
