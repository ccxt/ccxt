...
func  (this *coinbase) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchAccountsV3")) {
                    ...
                    retRes198055 :=  (<-this.FetchAccountsV3(params))
                    PanicOnError(retRes198055)
                    ch <- retRes198055
                    return nil
            }
        
                retRes700579 :=  (<-this.FetchAccountsV2(params))
                PanicOnError(retRes700579)
                ch <- retRes700579
                return nil
...
func  (this *coinbase) FetchAccountsV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes340302 := (<-this.LoadMarkets())
            PanicOnError(retRes340302)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes844913 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes844913)
                    ch <- retRes844913
                    return nil
            }
...
func  (this *coinbase) FetchAccountsV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes392471 := (<-this.LoadMarkets())
            PanicOnError(retRes392471)
            var paginate interface{} = false
            paginateparamsVariable := this.HandleOptionAndParams(params, "fetchAccounts", "paginate");
            paginate = GetValue(paginateparamsVariable,0);
            params = GetValue(paginateparamsVariable,1)
            if IsTrue(paginate) {
                    ...
                    retRes779337 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "cursor", "cursor", nil, 250))
                    PanicOnError(retRes779337)
                    ch <- retRes779337
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(accountId, nil)) {
                ...
                retRes883476 := (<-this.LoadAccounts())
                PanicOnError(retRes883476)
            ...
            if IsTrue(IsEqual(accountId, nil)) {
                panic(ExchangeError(Add(this.Id, " createDepositAddress() could not find the account with matching currency code, specify an `account_id` extra param")))
            }
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchMySells(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375078 := (<-this.LoadMarkets())
            PanicOnError(retRes375078)
...
func  (this *coinbase) FetchMyBuys(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes648873 := (<-this.LoadMarkets())
            PanicOnError(retRes648873)
            var query interface{} = this.Omit(params, []interface{}{"account_id", "accountId"})
...
func  (this *coinbase) FetchTransactionsWithMethod(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes334496 := (<-this.LoadMarkets())
            PanicOnError(retRes334496)
...
func  (this *coinbase) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes800385 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdWithdrawals", code, since, limit, params))
                PanicOnError(retRes800385)
                ch <- retRes800385
                return nil
...
func  (this *coinbase) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes828320 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdDeposits", code, since, limit, params))
                PanicOnError(retRes828320)
                ch <- retRes828320
                return nil
...
func  (this *coinbase) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes185730 := (<-this.LoadMarkets())
            PanicOnError(retRes185730)
...
func  (this *coinbase) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes452628 := (<-this.LoadTimeDifference())
                PanicOnError(retRes452628)
            }
            var method interface{} = this.SafeString(this.Options, "fetchMarkets", "fetchMarketsV3")
            if IsTrue(IsEqual(method, "fetchMarketsV3")) {
        
                    retRes872718 :=  (<-this.FetchMarketsV3(params))
                    PanicOnError(retRes872718)
                    ch <- retRes872718
                    return nil
            }
        
                retRes277839 :=  (<-this.FetchMarketsV2(params))
                PanicOnError(retRes277839)
                ch <- retRes277839
                return nil
...
func  (this *coinbase) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickersV3")) {
                    ...
                    retRes941581 :=  (<-this.FetchTickersV3(symbols, params))
                    PanicOnError(retRes941581)
                    ch <- retRes941581
                    return nil
            }
        
                retRes409399 :=  (<-this.FetchTickersV2(symbols, params))
                PanicOnError(retRes409399)
                ch <- retRes409399
                return nil
...
func  (this *coinbase) FetchTickersV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes252505 := (<-this.LoadMarkets())
            PanicOnError(retRes252505)
...
func  (this *coinbase) FetchTickersV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes611272 := (<-this.LoadMarkets())
            PanicOnError(retRes611272)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbase) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickerV3")) {
                    ...
                    retRes559693 :=  (<-this.FetchTickerV3(symbol, params))
                    PanicOnError(retRes559693)
                    ch <- retRes559693
                    return nil
            }
        
                retRes404828 :=  (<-this.FetchTickerV2(symbol, params))
                PanicOnError(retRes404828)
                ch <- retRes404828
                return nil
...
func  (this *coinbase) FetchTickerV2(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578405 := (<-this.LoadMarkets())
            PanicOnError(retRes578405)
...
func  (this *coinbase) FetchTickerV3(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes622131 := (<-this.LoadMarkets())
            PanicOnError(retRes622131)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes30230 := (<-this.LoadMarkets())
            PanicOnError(retRes30230)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
...
func  (this *coinbase) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes705239 := (<-this.LoadMarkets())
            PanicOnError(retRes705239)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes98116 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes98116)
                    ch <- retRes98116
                    return nil
            }
...
func  (this *coinbase) FindAccountId(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes416196 := (<-this.LoadMarkets())
            PanicOnError(retRes416196)
        
            retRes359627 := (<-this.LoadAccounts(false, params))
            PanicOnError(retRes359627)
            for i := 0; IsLessThan(i, GetArrayLength(this.Accounts)); i++ {
                var account interface{} = GetValue(this.Accounts, i)
...
func  (this *coinbase) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes532631 := (<-this.LoadMarkets())
            PanicOnError(retRes532631)
            var market interface{} = this.Market(symbol)
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes454505 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                PanicOnError(retRes454505)
                ch <- retRes454505
                return nil
...
func  (this *coinbase) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes184331 := (<-this.LoadMarkets())
            PanicOnError(retRes184331)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes802295 := (<-this.LoadMarkets())
            PanicOnError(retRes802295)
...
func  (this *coinbase) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes571247 := (<-this.LoadMarkets())
            PanicOnError(retRes571247)
...
func  (this *coinbase) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes991721 := (<-this.LoadMarkets())
            PanicOnError(retRes991721)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *coinbase) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes890685 := (<-this.LoadMarkets())
            PanicOnError(retRes890685)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbase) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes644557 := (<-this.LoadMarkets())
            PanicOnError(retRes644557)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes205964 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))
                    PanicOnError(retRes205964)
                    ch <- retRes205964
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes395503 := (<-this.LoadMarkets())
            PanicOnError(retRes395503)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbase) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes261746 := (<-this.LoadMarkets())
            PanicOnError(retRes261746)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes738482 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes738482)
                    ch <- retRes738482
                    return nil
            }
        
                retRes417507 :=  (<-this.FetchOrdersByStatus("OPEN", symbol, since, limit, params))
                PanicOnError(retRes417507)
                ch <- retRes417507
                return nil
...
func  (this *coinbase) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes407566 := (<-this.LoadMarkets())
            PanicOnError(retRes407566)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes690839 :=  (<-this.FetchPaginatedCallCursor("fetchClosedOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes690839)
                    ch <- retRes690839
                    return nil
            }
        
                retRes832762 :=  (<-this.FetchOrdersByStatus("FILLED", symbol, since, limit, params))
                PanicOnError(retRes832762)
                ch <- retRes832762
                return nil
...
func  (this *coinbase) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes607377 :=  (<-this.FetchOrdersByStatus("CANCELLED", symbol, since, limit, params))
                PanicOnError(retRes607377)
                ch <- retRes607377
                return nil
...
func  (this *coinbase) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes544503 := (<-this.LoadMarkets())
            PanicOnError(retRes544503)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes999021 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, Subtract(maxLimit, 1)))
                    PanicOnError(retRes999021)
                    ch <- retRes999021
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes586399 := (<-this.LoadMarkets())
            PanicOnError(retRes586399)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes449195 := (<-this.LoadMarkets())
            PanicOnError(retRes449195)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes940514 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))
                    PanicOnError(retRes940514)
                    ch <- retRes940514
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes796109 := (<-this.LoadMarkets())
            PanicOnError(retRes796109)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes342065 := (<-this.LoadMarkets())
            PanicOnError(retRes342065)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
                AddElementToObject(request, "product_ids", this.MarketIds(symbols))
...
func  (this *coinbase) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes947472 := (<-this.LoadMarkets())
            PanicOnError(retRes947472)
...
func  (this *coinbase) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674118 := (<-this.LoadMarkets())
            PanicOnError(retRes674118)
            var currency interface{} = this.Currency(code)
            var request interface{} = nil
            requestparamsVariable := (<-this.PrepareAccountRequestWithCurrencyCode(GetValue(currency, "code")));
            request = GetValue(requestparamsVariable,0);
            params = GetValue(requestparamsVariable,1)
...
func  (this *coinbase) ParseDepositAddress(depositAddress interface{}, optionalArgs ...interface{}) interface{}  {
    ...
    var marketId interface{} = this.SafeString(splitAddressLabel, 0)
...
func  (this *coinbase) Deposit(code interface{}, amount interface{}, id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes837222 := (<-this.LoadMarkets())
            PanicOnError(retRes837222)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDeposit(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes236248 := (<-this.LoadMarkets())
            PanicOnError(retRes236248)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDepositMethodIds(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes401224 := (<-this.LoadMarkets())
            PanicOnError(retRes401224)
...
func  (this *coinbase) FetchDepositMethodId(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768769 := (<-this.LoadMarkets())
            PanicOnError(retRes768769)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes934033 := (<-this.LoadMarkets())
            PanicOnError(retRes934033)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes276506 := (<-this.LoadMarkets())
            PanicOnError(retRes276506)
            var request interface{} = map[string]interface{} {
                "trade_id": id,
                "from_account": fromCode,
                "to_account": toCode,
...
func  (this *coinbase) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes271945 := (<-this.LoadMarkets())
            PanicOnError(retRes271945)
            if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes803051 := (<-this.LoadMarkets())
            PanicOnError(retRes803051)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes806963 := (<-this.LoadMarkets())
            PanicOnError(retRes806963)
            symbols = this.MarketSymbols(symbols)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *coinbase) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes41426 := (<-this.LoadMarkets())
            PanicOnError(retRes41426)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "future")) {
...
func  (this *coinbase) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes125454 := (<-this.LoadMarkets())
            PanicOnError(retRes125454)
            var typeVar interface{} = nil
