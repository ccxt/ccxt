...
func  (this *coinbase) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchAccountsV3")) {
                    ...
                    retRes668285 :=  (<-this.FetchAccountsV3(params))
                    PanicOnError(retRes668285)
                    ch <- retRes668285
                    return nil
            }
        
                retRes529006 :=  (<-this.FetchAccountsV2(params))
                PanicOnError(retRes529006)
                ch <- retRes529006
                return nil
...
func  (this *coinbase) FetchAccountsV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes316803 := (<-this.LoadMarkets())
            PanicOnError(retRes316803)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes57088 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "next_starting_after", "starting_after", nil, 100))
...
func  (this *coinbase) FetchAccountsV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes299283 := (<-this.LoadMarkets())
            PanicOnError(retRes299283)
            var paginate interface{} = false
            paginateparamsVariable := this.HandleOptionAndParams(params, "fetchAccounts", "paginate");
            paginate = GetValue(paginateparamsVariable,0);
            params = GetValue(paginateparamsVariable,1)
            if IsTrue(paginate) {
                    ...
                    retRes693109 :=  (<-this.FetchPaginatedCallCursor("fetchAccounts", nil, nil, nil, params, "cursor", "cursor", nil, 250))
                    PanicOnError(retRes693109)
                    ch <- retRes693109
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(accountId, nil)) {
                ...
                retRes731332 := (<-this.LoadAccounts())
                PanicOnError(retRes731332)
...
func  (this *coinbase) FetchMySells(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes157968 := (<-this.LoadMarkets())
            PanicOnError(retRes157968)
...
func  (this *coinbase) FetchMyBuys(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882213 := (<-this.LoadMarkets())
            PanicOnError(retRes882213)
            var query interface{} = this.Omit(params, []interface{}{"account_id", "accountId"})
...
func  (this *coinbase) FetchTransactionsWithMethod(method interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70692 := (<-this.LoadMarkets())
            PanicOnError(retRes70692)
...
func  (this *coinbase) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes960571 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdWithdrawals", code, since, limit, params))
                PanicOnError(retRes960571)
                ch <- retRes960571
                return nil
...
func  (this *coinbase) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(currencyType, "crypto")) {
                ...
                retRes847114 :=  (<-this.FetchTransactionsWithMethod("v2PrivateGetAccountsAccountIdDeposits", code, since, limit, params))
                PanicOnError(retRes847114)
                ch <- retRes847114
                return nil
...
func  (this *coinbase) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes586426 := (<-this.LoadMarkets())
            PanicOnError(retRes586426)
...
func  (this *coinbase) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes566604 := (<-this.LoadTimeDifference())
                PanicOnError(retRes566604)
            }
            var method interface{} = this.SafeString(this.Options, "fetchMarkets", "fetchMarketsV3")
            if IsTrue(IsEqual(method, "fetchMarketsV3")) {
        
                    retRes490248 :=  (<-this.FetchMarketsV3(params))
                    PanicOnError(retRes490248)
                    ch <- retRes490248
                    return nil
            }
        
                retRes155200 :=  (<-this.FetchMarketsV2(params))
                PanicOnError(retRes155200)
                ch <- retRes155200
                return nil
...
func  (this *coinbase) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickersV3")) {
                    ...
                    retRes347028 :=  (<-this.FetchTickersV3(symbols, params))
                    PanicOnError(retRes347028)
                    ch <- retRes347028
                    return nil
            }
        
                retRes65685 :=  (<-this.FetchTickersV2(symbols, params))
                PanicOnError(retRes65685)
                ch <- retRes65685
                return nil
...
func  (this *coinbase) FetchTickersV2(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes195410 := (<-this.LoadMarkets())
            PanicOnError(retRes195410)
...
func  (this *coinbase) FetchTickersV3(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes482908 := (<-this.LoadMarkets())
            PanicOnError(retRes482908)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbase) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(IsEqual(method, "fetchTickerV3")) {
                    ...
                    retRes707186 :=  (<-this.FetchTickerV3(symbol, params))
                    PanicOnError(retRes707186)
                    ch <- retRes707186
                    return nil
            }
        
                retRes535335 :=  (<-this.FetchTickerV2(symbol, params))
                PanicOnError(retRes535335)
                ch <- retRes535335
                return nil
...
func  (this *coinbase) FetchTickerV2(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40483 := (<-this.LoadMarkets())
            PanicOnError(retRes40483)
...
func  (this *coinbase) FetchTickerV3(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes761416 := (<-this.LoadMarkets())
            PanicOnError(retRes761416)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes765355 := (<-this.LoadMarkets())
            PanicOnError(retRes765355)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
...
func  (this *coinbase) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes248389 := (<-this.LoadMarkets())
            PanicOnError(retRes248389)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes970496 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "next_starting_after", "starting_after", nil, 100))
                    PanicOnError(retRes970496)
                    ch <- retRes970496
                    return nil
            }
...
func  (this *coinbase) FindAccountId(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490148 := (<-this.LoadMarkets())
            PanicOnError(retRes490148)
        
            retRes643074 := (<-this.LoadAccounts(false, params))
            PanicOnError(retRes643074)
            for i := 0; IsLessThan(i, GetArrayLength(this.Accounts)); i++ {
                var account interface{} = GetValue(this.Accounts, i)
...
func  (this *coinbase) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes190199 := (<-this.LoadMarkets())
            PanicOnError(retRes190199)
            var market interface{} = this.Market(symbol)
            ...
            AddElementToObject(params, "createMarketBuyOrderRequiresPrice", false)
                ...
                retRes216776 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, nil, params))
                PanicOnError(retRes216776)
                ch <- retRes216776
                return nil
...
func  (this *coinbase) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291873 := (<-this.LoadMarkets())
            PanicOnError(retRes291873)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378361 := (<-this.LoadMarkets())
            PanicOnError(retRes378361)
...
func  (this *coinbase) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes810166 := (<-this.LoadMarkets())
            PanicOnError(retRes810166)
...
func  (this *coinbase) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes477099 := (<-this.LoadMarkets())
            PanicOnError(retRes477099)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "order_id": id,
            }
...
func  (this *coinbase) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes421195 := (<-this.LoadMarkets())
            PanicOnError(retRes421195)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbase) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133364 := (<-this.LoadMarkets())
            PanicOnError(retRes133364)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes579006 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "cursor", "cursor", nil, 1000))
                    PanicOnError(retRes579006)
                    ch <- retRes579006
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes90447 := (<-this.LoadMarkets())
            PanicOnError(retRes90447)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *coinbase) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432498 := (<-this.LoadMarkets())
            PanicOnError(retRes432498)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes915873 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes915873)
                    ch <- retRes915873
                    return nil
            }
        
                retRes817620 :=  (<-this.FetchOrdersByStatus("OPEN", symbol, since, limit, params))
                PanicOnError(retRes817620)
                ch <- retRes817620
                return nil
...
func  (this *coinbase) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes437068 := (<-this.LoadMarkets())
            PanicOnError(retRes437068)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes126244 :=  (<-this.FetchPaginatedCallCursor("fetchClosedOrders", symbol, since, limit, params, "cursor", "cursor", nil, 100))
                    PanicOnError(retRes126244)
                    ch <- retRes126244
                    return nil
            }
        
                retRes43461 :=  (<-this.FetchOrdersByStatus("FILLED", symbol, since, limit, params))
                PanicOnError(retRes43461)
                ch <- retRes43461
                return nil
...
func  (this *coinbase) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes265788 :=  (<-this.FetchOrdersByStatus("CANCELLED", symbol, since, limit, params))
                PanicOnError(retRes265788)
                ch <- retRes265788
                return nil
...
func  (this *coinbase) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes698292 := (<-this.LoadMarkets())
            PanicOnError(retRes698292)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes413773 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, Subtract(maxLimit, 1)))
                    PanicOnError(retRes413773)
                    ch <- retRes413773
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687287 := (<-this.LoadMarkets())
            PanicOnError(retRes687287)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes121692 := (<-this.LoadMarkets())
            PanicOnError(retRes121692)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes87836 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "cursor", "cursor", nil, 250))
                    PanicOnError(retRes87836)
                    ch <- retRes87836
                    return nil
            }
            var market interface{} = nil
...
func  (this *coinbase) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes282720 := (<-this.LoadMarkets())
            PanicOnError(retRes282720)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "product_id": GetValue(market, "id"),
            }
...
func  (this *coinbase) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes684283 := (<-this.LoadMarkets())
            PanicOnError(retRes684283)
            symbols = this.MarketSymbols(symbols)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
                AddElementToObject(request, "product_ids", this.MarketIds(symbols))
...
func  (this *coinbase) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes718107 := (<-this.LoadMarkets())
            PanicOnError(retRes718107)
...
func  (this *coinbase) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109831 := (<-this.LoadMarkets())
            PanicOnError(retRes109831)
            var currency interface{} = this.Currency(code)
            var request interface{} = nil
...
func  (this *coinbase) Deposit(code interface{}, amount interface{}, id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes247150 := (<-this.LoadMarkets())
            PanicOnError(retRes247150)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDeposit(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes128072 := (<-this.LoadMarkets())
            PanicOnError(retRes128072)
            var accountId interface{} = this.SafeString2(params, "account_id", "accountId")
            params = this.Omit(params, []interface{}{"account_id", "accountId"})
            if IsTrue(IsEqual(accountId, nil)) {
                if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) FetchDepositMethodIds(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes483864 := (<-this.LoadMarkets())
            PanicOnError(retRes483864)
...
func  (this *coinbase) FetchDepositMethodId(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614403 := (<-this.LoadMarkets())
            PanicOnError(retRes614403)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes295331 := (<-this.LoadMarkets())
            PanicOnError(retRes295331)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbase) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes237951 := (<-this.LoadMarkets())
            PanicOnError(retRes237951)
            var request interface{} = map[string]interface{} {
                "trade_id": id,
                "from_account": fromCode,
                "to_account": toCode,
...
func  (this *coinbase) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696784 := (<-this.LoadMarkets())
            PanicOnError(retRes696784)
            if IsTrue(IsEqual(code, nil)) {
...
func  (this *coinbase) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes840519 := (<-this.LoadMarkets())
            PanicOnError(retRes840519)
            var market interface{} = this.Market(symbol)
...
func  (this *coinbase) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78694 := (<-this.LoadMarkets())
            PanicOnError(retRes78694)
            symbols = this.MarketSymbols(symbols)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *coinbase) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes527726 := (<-this.LoadMarkets())
            PanicOnError(retRes527726)
            var market interface{} = this.Market(symbol)
            var response interface{} = nil
            if IsTrue(GetValue(market, "future")) {
...
func  (this *coinbase) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes870150 := (<-this.LoadMarkets())
            PanicOnError(retRes870150)
            var typeVar interface{} = nil
