...
func  (this *kucoin) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes824997 := (<-this.LoadTimeDifference())
                PanicOnError(retRes824997)
            }
...
func  (this *kucoin) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes778161 := (<-this.LoadMarkets())
            PanicOnError(retRes778161)
...
func  (this *kucoin) FetchDepositWithdrawFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes899655 := (<-this.LoadMarkets())
            PanicOnError(retRes899655)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchMarkPrices(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes904594 := (<-this.LoadMarkets())
            PanicOnError(retRes904594)
            symbols = this.MarketSymbols(symbols)
...
func  (this *kucoin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71484 := (<-this.LoadMarkets())
            PanicOnError(retRes71484)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes365151 := (<-this.LoadMarkets())
            PanicOnError(retRes365151)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes284827 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1500))
                    PanicOnError(retRes284827)
                    ch <- retRes284827
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes629176 := (<-this.LoadMarkets())
            PanicOnError(retRes629176)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes761020 := (<-this.LoadMarkets())
            PanicOnError(retRes761020)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes874610 := (<-this.LoadMarkets())
            PanicOnError(retRes874610)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes521708 := (<-this.LoadMarkets())
            PanicOnError(retRes521708)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes746695 := (<-this.LoadMarkets())
            PanicOnError(retRes746695)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297828 := (<-this.LoadMarkets())
            PanicOnError(retRes297828)
            AddElementToObject(params, "cost", cost)
        
                retRes739578 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
                PanicOnError(retRes739578)
                ch <- retRes739578
                return nil
...
func  (this *kucoin) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes397431 := (<-this.LoadMarkets())
            PanicOnError(retRes397431)
        
                retRes157206 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
                PanicOnError(retRes157206)
                ch <- retRes157206
                return nil
...
func  (this *kucoin) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes780244 := (<-this.LoadMarkets())
            PanicOnError(retRes780244)
        
                retRes6901 :=  (<-this.CreateMarketOrderWithCost(symbol, "sell", cost, params))
                PanicOnError(retRes6901)
                ch <- retRes6901
                return nil
...
func  (this *kucoin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes582341 := (<-this.LoadMarkets())
            PanicOnError(retRes582341)
...
func  (this *kucoin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703824 := (<-this.LoadMarkets())
            PanicOnError(retRes703824)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
...
func  (this *kucoin) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes452929 := (<-this.LoadMarkets())
            PanicOnError(retRes452929)
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes47649 := (<-this.LoadMarkets())
            PanicOnError(retRes47649)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes616074 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes616074)
                    ch <- retRes616074
                    return nil
            }
        
                retRes624644 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
                PanicOnError(retRes624644)
                ch <- retRes624644
                return nil
...
func  (this *kucoin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes567475 := (<-this.LoadMarkets())
            PanicOnError(retRes567475)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes102027 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes102027)
                    ch <- retRes102027
                    return nil
            }
        
                retRes623126 :=  (<-this.FetchOrdersByStatus("active", symbol, since, limit, params))
...
func  (this *kucoin) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451431 := (<-this.LoadMarkets())
            PanicOnError(retRes451431)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger", false)
            var hf interface{} = nil
...
func  (this *kucoin) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes828007 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes828007)
                ch <- retRes828007
                return nil
...
func  (this *kucoin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes549754 := (<-this.LoadMarkets())
            PanicOnError(retRes549754)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes859886 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes859886)
                    ch <- retRes859886
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727887 := (<-this.LoadMarkets())
            PanicOnError(retRes727887)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes494019 := (<-this.LoadMarkets())
            PanicOnError(retRes494019)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *kucoin) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes234224 := (<-this.LoadMarkets())
            PanicOnError(retRes234224)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378137 := (<-this.LoadMarkets())
            PanicOnError(retRes378137)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes696497 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes696497)
                    ch <- retRes696497
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733228 := (<-this.LoadMarkets())
            PanicOnError(retRes733228)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes835650 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes835650)
                    ch <- retRes835650
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes691610 := (<-this.LoadMarkets())
            PanicOnError(retRes691610)
...
func  (this *kucoin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes240264 := (<-this.LoadMarkets())
            PanicOnError(retRes240264)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes721785 := (<-this.LoadMarkets())
            PanicOnError(retRes721785)
        
            retRes74953 := (<-this.LoadAccounts())
            PanicOnError(retRes74953)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes314324 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes314324)
                    ch <- retRes314324
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes593559 := (<-this.LoadMarkets())
            PanicOnError(retRes593559)
            var marginMode interface{} = nil
...
func  (this *kucoin) FetchBorrowRateHistories(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes443610 := (<-this.LoadMarkets())
            PanicOnError(retRes443610)
...
func  (this *kucoin) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes817411 := (<-this.LoadMarkets())
            PanicOnError(retRes817411)
            var marginResult interface{} = this.HandleMarginModeAndParams("fetchBorrowRateHistories", params)
            var marginMode interface{} = this.SafeString(marginResult, 0, "cross")
            var isIsolated interface{} =     (IsEqual(marginMode, "isolated")) // true-isolated, false-cross
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478668 := (<-this.LoadMarkets())
            PanicOnError(retRes478668)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes655682 := (<-this.LoadMarkets())
            PanicOnError(retRes655682)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes907832 := (<-this.LoadMarkets())
            PanicOnError(retRes907832)
            var market interface{} = nil
            ...
            AddElementToObject(request, "isIsolated", (IsEqual(marginMode, "isolated")))
                ...
                retRes830539 :=  (<-this.PrivatePostPositionUpdateUserLeverage(this.Extend(request, params)))
                PanicOnError(retRes830539)
                ch <- retRes830539
                return nil
