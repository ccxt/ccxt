...
func  (this *kucoin) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes995486 := (<-this.LoadTimeDifference())
                PanicOnError(retRes995486)
            }
...
func  (this *kucoin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180623 := (<-this.LoadMarkets())
            PanicOnError(retRes180623)
...
func  (this *kucoin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes655628 := (<-this.LoadMarkets())
            PanicOnError(retRes655628)
...
func  (this *kucoin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes266523 := (<-this.LoadMarkets())
            PanicOnError(retRes266523)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes423686 := (<-this.LoadMarkets())
            PanicOnError(retRes423686)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes350896 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1500))
                    PanicOnError(retRes350896)
                    ch <- retRes350896
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes698685 := (<-this.LoadMarkets())
            PanicOnError(retRes698685)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes866527 := (<-this.LoadMarkets())
            PanicOnError(retRes866527)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes817993 := (<-this.LoadMarkets())
            PanicOnError(retRes817993)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes670645 := (<-this.LoadMarkets())
            PanicOnError(retRes670645)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes564661 := (<-this.LoadMarkets())
            PanicOnError(retRes564661)
            AddElementToObject(params, "cost", cost)
        
                retRes294994 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
                PanicOnError(retRes294994)
                ch <- retRes294994
                return nil
...
func  (this *kucoin) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631746 := (<-this.LoadMarkets())
            PanicOnError(retRes631746)
        
                retRes683878 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
                PanicOnError(retRes683878)
                ch <- retRes683878
                return nil
...
func  (this *kucoin) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes953720 := (<-this.LoadMarkets())
            PanicOnError(retRes953720)
        
                retRes91617 :=  (<-this.CreateMarketOrderWithCost(symbol, "sell", cost, params))
...
func  (this *kucoin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes48313 := (<-this.LoadMarkets())
            PanicOnError(retRes48313)
...
func  (this *kucoin) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes465757 := (<-this.LoadMarkets())
            PanicOnError(retRes465757)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes681607 := (<-this.LoadMarkets())
            PanicOnError(retRes681607)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
...
func  (this *kucoin) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes311462 := (<-this.LoadMarkets())
            PanicOnError(retRes311462)
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987543 := (<-this.LoadMarkets())
            PanicOnError(retRes987543)
...
func  (this *kucoin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes316317 := (<-this.LoadMarkets())
            PanicOnError(retRes316317)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes622935 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes622935)
                    ch <- retRes622935
                    return nil
            }
        
                retRes309712 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
...
func  (this *kucoin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109694 := (<-this.LoadMarkets())
            PanicOnError(retRes109694)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes409196 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes409196)
                    ch <- retRes409196
                    return nil
            }
        
                retRes439490 :=  (<-this.FetchOrdersByStatus("active", symbol, since, limit, params))
...
func  (this *kucoin) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes693367 := (<-this.LoadMarkets())
            PanicOnError(retRes693367)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger", false)
            var hf interface{} = nil
...
func  (this *kucoin) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes799609 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes799609)
                ch <- retRes799609
                return nil
...
func  (this *kucoin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes820386 := (<-this.LoadMarkets())
            PanicOnError(retRes820386)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes725434 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes725434)
                    ch <- retRes725434
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes305254 := (<-this.LoadMarkets())
            PanicOnError(retRes305254)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687903 := (<-this.LoadMarkets())
            PanicOnError(retRes687903)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes697224 := (<-this.LoadMarkets())
            PanicOnError(retRes697224)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes876742 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes876742)
                    ch <- retRes876742
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes566664 := (<-this.LoadMarkets())
            PanicOnError(retRes566664)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes195640 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes195640)
                    ch <- retRes195640
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes458506 := (<-this.LoadMarkets())
            PanicOnError(retRes458506)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278495 := (<-this.LoadMarkets())
            PanicOnError(retRes278495)
        
            retRes774810 := (<-this.LoadAccounts())
            PanicOnError(retRes774810)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes683269 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes683269)
                    ch <- retRes683269
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes41024 := (<-this.LoadMarkets())
            PanicOnError(retRes41024)
            var marginMode interface{} = nil
...
func  (this *kucoin) FetchBorrowRateHistories(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731203 := (<-this.LoadMarkets())
            PanicOnError(retRes731203)
...
func  (this *kucoin) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes579082 := (<-this.LoadMarkets())
            PanicOnError(retRes579082)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes407032 := (<-this.LoadMarkets())
            PanicOnError(retRes407032)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
                "size": this.CurrencyToPrecision(code, amount),
...
func  (this *kucoin) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes558986 := (<-this.LoadMarkets())
            PanicOnError(retRes558986)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes456407 := (<-this.LoadMarkets())
            PanicOnError(retRes456407)
...
func  (this *kucoin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes105581 := (<-this.LoadMarkets())
            PanicOnError(retRes105581)
            var market interface{} = nil
            ...
            AddElementToObject(request, "isIsolated", (IsEqual(marginMode, "isolated")))
                ...
                retRes591223 :=  (<-this.PrivatePostPositionUpdateUserLeverage(this.Extend(request, params)))
                PanicOnError(retRes591223)
                ch <- retRes591223
                return nil
