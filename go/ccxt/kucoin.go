...
func  (this *kucoin) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes536865 := (<-this.LoadTimeDifference())
                PanicOnError(retRes536865)
            }
...
func  (this *kucoin) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes760967 := (<-this.LoadMarkets())
            PanicOnError(retRes760967)
...
func  (this *kucoin) FetchDepositWithdrawFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes884096 := (<-this.LoadMarkets())
            PanicOnError(retRes884096)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchMarkPrices(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672424 := (<-this.LoadMarkets())
            PanicOnError(retRes672424)
            symbols = this.MarketSymbols(symbols)
...
func  (this *kucoin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes796108 := (<-this.LoadMarkets())
            PanicOnError(retRes796108)
...
func  (this *kucoin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes844784 := (<-this.LoadMarkets())
            PanicOnError(retRes844784)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes342021 := (<-this.LoadMarkets())
            PanicOnError(retRes342021)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes288207 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1500))
                    PanicOnError(retRes288207)
                    ch <- retRes288207
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes493344 := (<-this.LoadMarkets())
            PanicOnError(retRes493344)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621049 := (<-this.LoadMarkets())
            PanicOnError(retRes621049)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes354481 := (<-this.LoadMarkets())
            PanicOnError(retRes354481)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes120032 := (<-this.LoadMarkets())
            PanicOnError(retRes120032)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727436 := (<-this.LoadMarkets())
            PanicOnError(retRes727436)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes438338 := (<-this.LoadMarkets())
            PanicOnError(retRes438338)
            AddElementToObject(params, "cost", cost)
        
                retRes324716 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
                PanicOnError(retRes324716)
                ch <- retRes324716
                return nil
...
func  (this *kucoin) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes446463 := (<-this.LoadMarkets())
            PanicOnError(retRes446463)
        
                retRes42790 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
                PanicOnError(retRes42790)
                ch <- retRes42790
                return nil
...
func  (this *kucoin) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854748 := (<-this.LoadMarkets())
            PanicOnError(retRes854748)
        
                retRes976986 :=  (<-this.CreateMarketOrderWithCost(symbol, "sell", cost, params))
                PanicOnError(retRes976986)
                ch <- retRes976986
                return nil
...
func  (this *kucoin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696164 := (<-this.LoadMarkets())
            PanicOnError(retRes696164)
...
func  (this *kucoin) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes729736 := (<-this.LoadMarkets())
            PanicOnError(retRes729736)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672803 := (<-this.LoadMarkets())
            PanicOnError(retRes672803)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
...
func  (this *kucoin) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes619962 := (<-this.LoadMarkets())
            PanicOnError(retRes619962)
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768835 := (<-this.LoadMarkets())
            PanicOnError(retRes768835)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes32211 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes32211)
                    ch <- retRes32211
                    return nil
            }
        
                retRes440395 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
                PanicOnError(retRes440395)
                ch <- retRes440395
                return nil
...
func  (this *kucoin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes701298 := (<-this.LoadMarkets())
            PanicOnError(retRes701298)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes30384 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes30384)
                    ch <- retRes30384
                    return nil
            }
        
                retRes468934 :=  (<-this.FetchOrdersByStatus("active", symbol, since, limit, params))
                PanicOnError(retRes468934)
                ch <- retRes468934
                return nil
...
func  (this *kucoin) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes444720 := (<-this.LoadMarkets())
            PanicOnError(retRes444720)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger", false)
            var hf interface{} = nil
...
func  (this *kucoin) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes696815 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
...
func  (this *kucoin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes278791 := (<-this.LoadMarkets())
            PanicOnError(retRes278791)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes978266 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes978266)
                    ch <- retRes978266
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes86787 := (<-this.LoadMarkets())
            PanicOnError(retRes86787)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes311192 := (<-this.LoadMarkets())
            PanicOnError(retRes311192)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *kucoin) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes591966 := (<-this.LoadMarkets())
            PanicOnError(retRes591966)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727261 := (<-this.LoadMarkets())
            PanicOnError(retRes727261)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes705198 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes705198)
                    ch <- retRes705198
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782270 := (<-this.LoadMarkets())
            PanicOnError(retRes782270)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes102123 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes102123)
                    ch <- retRes102123
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes144453 := (<-this.LoadMarkets())
            PanicOnError(retRes144453)
...
func  (this *kucoin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes757966 := (<-this.LoadMarkets())
            PanicOnError(retRes757966)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432088 := (<-this.LoadMarkets())
            PanicOnError(retRes432088)
        
            retRes826020 := (<-this.LoadAccounts())
            PanicOnError(retRes826020)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes285392 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes285392)
                    ch <- retRes285392
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes797858 := (<-this.LoadMarkets())
            PanicOnError(retRes797858)
            var marginMode interface{} = nil
...
func  (this *kucoin) FetchBorrowRateHistories(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes751109 := (<-this.LoadMarkets())
            PanicOnError(retRes751109)
...
func  (this *kucoin) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes748992 := (<-this.LoadMarkets())
            PanicOnError(retRes748992)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes447267 := (<-this.LoadMarkets())
            PanicOnError(retRes447267)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes325629 := (<-this.LoadMarkets())
            PanicOnError(retRes325629)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
                "size": this.CurrencyToPrecision(code, amount),
...
func  (this *kucoin) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes374857 := (<-this.LoadMarkets())
            PanicOnError(retRes374857)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834103 := (<-this.LoadMarkets())
            PanicOnError(retRes834103)
...
func  (this *kucoin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599609 := (<-this.LoadMarkets())
            PanicOnError(retRes599609)
            var market interface{} = nil
            ...
            AddElementToObject(request, "isIsolated", (IsEqual(marginMode, "isolated")))
                ...
                retRes512 :=  (<-this.PrivatePostPositionUpdateUserLeverage(this.Extend(request, params)))
