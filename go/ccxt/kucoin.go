...
func  (this *kucoin) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes96965 := (<-this.LoadTimeDifference())
                PanicOnError(retRes96965)
            }
...
func  (this *kucoin) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes289294 := (<-this.LoadMarkets())
            PanicOnError(retRes289294)
...
func  (this *kucoin) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes132587 := (<-this.LoadMarkets())
            PanicOnError(retRes132587)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes202353 := (<-this.LoadMarkets())
            PanicOnError(retRes202353)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes238006 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1500))
                    PanicOnError(retRes238006)
                    ch <- retRes238006
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes734043 := (<-this.LoadMarkets())
            PanicOnError(retRes734043)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes562975 := (<-this.LoadMarkets())
            PanicOnError(retRes562975)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes19319 := (<-this.LoadMarkets())
            PanicOnError(retRes19319)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes242305 := (<-this.LoadMarkets())
            PanicOnError(retRes242305)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660256 := (<-this.LoadMarkets())
            PanicOnError(retRes660256)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes582697 := (<-this.LoadMarkets())
            PanicOnError(retRes582697)
            AddElementToObject(params, "cost", cost)
        
                retRes605267 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
                PanicOnError(retRes605267)
                ch <- retRes605267
                return nil
...
func  (this *kucoin) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes904391 := (<-this.LoadMarkets())
            PanicOnError(retRes904391)
        
                retRes475707 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
                PanicOnError(retRes475707)
                ch <- retRes475707
                return nil
...
func  (this *kucoin) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133642 := (<-this.LoadMarkets())
            PanicOnError(retRes133642)
        
                retRes825395 :=  (<-this.CreateMarketOrderWithCost(symbol, "sell", cost, params))
                PanicOnError(retRes825395)
                ch <- retRes825395
                return nil
...
func  (this *kucoin) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164127 := (<-this.LoadMarkets())
            PanicOnError(retRes164127)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903440 := (<-this.LoadMarkets())
            PanicOnError(retRes903440)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
...
func  (this *kucoin) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes336750 := (<-this.LoadMarkets())
            PanicOnError(retRes336750)
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes441277 := (<-this.LoadMarkets())
            PanicOnError(retRes441277)
...
func  (this *kucoin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes256624 := (<-this.LoadMarkets())
            PanicOnError(retRes256624)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes767589 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes767589)
                    ch <- retRes767589
                    return nil
            }
        
                retRes689347 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
                PanicOnError(retRes689347)
                ch <- retRes689347
                return nil
...
func  (this *kucoin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes351604 := (<-this.LoadMarkets())
            PanicOnError(retRes351604)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes820711 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes820711)
                    ch <- retRes820711
                    return nil
            }
        
                retRes785766 :=  (<-this.FetchOrdersByStatus("active", symbol, since, limit, params))
                PanicOnError(retRes785766)
                ch <- retRes785766
                return nil
...
func  (this *kucoin) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes883280 := (<-this.LoadMarkets())
            PanicOnError(retRes883280)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
            var trigger interface{} = this.SafeBool2(params, "stop", "trigger", false)
            var hf interface{} = nil
...
func  (this *kucoin) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes3418 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes3418)
                ch <- retRes3418
                return nil
...
func  (this *kucoin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes413293 := (<-this.LoadMarkets())
            PanicOnError(retRes413293)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes218607 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes218607)
                    ch <- retRes218607
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes883272 := (<-this.LoadMarkets())
            PanicOnError(retRes883272)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes367455 := (<-this.LoadMarkets())
            PanicOnError(retRes367455)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *kucoin) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes519611 := (<-this.LoadMarkets())
            PanicOnError(retRes519611)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes802417 := (<-this.LoadMarkets())
            PanicOnError(retRes802417)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes637032 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes637032)
                    ch <- retRes637032
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes701144 := (<-this.LoadMarkets())
            PanicOnError(retRes701144)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes321994 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
...
func  (this *kucoin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes725496 := (<-this.LoadMarkets())
            PanicOnError(retRes725496)
...
func  (this *kucoin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432025 := (<-this.LoadMarkets())
            PanicOnError(retRes432025)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes944226 := (<-this.LoadMarkets())
            PanicOnError(retRes944226)
        
            retRes562310 := (<-this.LoadAccounts())
            PanicOnError(retRes562310)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes163082 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes163082)
                    ch <- retRes163082
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBorrowRateHistories(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96206 := (<-this.LoadMarkets())
            PanicOnError(retRes96206)
...
func  (this *kucoin) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes870092 := (<-this.LoadMarkets())
            PanicOnError(retRes870092)
            var marginResult interface{} = this.HandleMarginModeAndParams("fetchBorrowRateHistories", params)
            var marginMode interface{} = this.SafeString(marginResult, 0, "cross")
            var isIsolated interface{} =     (IsEqual(marginMode, "isolated")) // true-isolated, false-cross
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes522712 := (<-this.LoadMarkets())
            PanicOnError(retRes522712)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660779 := (<-this.LoadMarkets())
            PanicOnError(retRes660779)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes289278 := (<-this.LoadMarkets())
            PanicOnError(retRes289278)
...
func  (this *kucoin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes25384 := (<-this.LoadMarkets())
            PanicOnError(retRes25384)
            var market interface{} = nil
            ...
            AddElementToObject(request, "isIsolated", (IsEqual(marginMode, "isolated")))
                ...
                retRes386205 :=  (<-this.PrivatePostPositionUpdateUserLeverage(this.Extend(request, params)))
                PanicOnError(retRes386205)
                ch <- retRes386205
                return nil
