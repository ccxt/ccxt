...
func  (this *kucoin) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes253119 := (<-this.LoadTimeDifference())
...
func  (this *kucoin) FetchTransactionFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes912462 := (<-this.LoadMarkets())
            PanicOnError(retRes912462)
...
func  (this *kucoin) FetchDepositWithdrawFee(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes911940 := (<-this.LoadMarkets())
            PanicOnError(retRes911940)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes226761 := (<-this.LoadMarkets())
            PanicOnError(retRes226761)
...
func  (this *kucoin) FetchMarkPrices(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes662930 := (<-this.LoadMarkets())
            PanicOnError(retRes662930)
            symbols = this.MarketSymbols(symbols)
...
func  (this *kucoin) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628195 := (<-this.LoadMarkets())
            PanicOnError(retRes628195)
...
func  (this *kucoin) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes772270 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1500))
                    PanicOnError(retRes772270)
                    ch <- retRes772270
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes832280 := (<-this.LoadMarkets())
            PanicOnError(retRes832280)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes647492 := (<-this.LoadMarkets())
            PanicOnError(retRes647492)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
            }
...
func  (this *kucoin) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes353998 := (<-this.LoadMarkets())
            PanicOnError(retRes353998)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes622856 := (<-this.LoadMarkets())
            PanicOnError(retRes622856)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoin) CreateMarketOrderWithCost(symbol interface{}, side interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes335904 := (<-this.LoadMarkets())
            PanicOnError(retRes335904)
            AddElementToObject(params, "cost", cost)
        
                retRes357469 :=  (<-this.CreateOrder(symbol, "market", side, cost, nil, params))
                PanicOnError(retRes357469)
                ch <- retRes357469
                return nil
...
func  (this *kucoin) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes997396 := (<-this.LoadMarkets())
            PanicOnError(retRes997396)
        
                retRes304235 :=  (<-this.CreateMarketOrderWithCost(symbol, "buy", cost, params))
                PanicOnError(retRes304235)
                ch <- retRes304235
                return nil
...
func  (this *kucoin) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes411107 := (<-this.LoadMarkets())
            PanicOnError(retRes411107)
        
                retRes706824 :=  (<-this.CreateMarketOrderWithCost(symbol, "sell", cost, params))
                PanicOnError(retRes706824)
                ch <- retRes706824
                return nil
...
func  (this *kucoin) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes334532 := (<-this.LoadMarkets())
            PanicOnError(retRes334532)
...
func  (this *kucoin) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes169931 := (<-this.LoadMarkets())
            PanicOnError(retRes169931)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153670 := (<-this.LoadMarkets())
            PanicOnError(retRes153670)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOid", "clientOrderId")
...
func  (this *kucoin) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes288254 := (<-this.LoadMarkets())
            PanicOnError(retRes288254)
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes926333 := (<-this.LoadMarkets())
            PanicOnError(retRes926333)
...
func  (this *kucoin) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes581214 := (<-this.LoadMarkets())
            PanicOnError(retRes581214)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes9364 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes9364)
                    ch <- retRes9364
                    return nil
            }
        
                retRes782055 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
                PanicOnError(retRes782055)
                ch <- retRes782055
                return nil
...
func  (this *kucoin) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes167915 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes167915)
                    ch <- retRes167915
                    return nil
            }
        
                retRes329655 :=  (<-this.FetchOrdersByStatus("active", symbol, since, limit, params))
                PanicOnError(retRes329655)
                ch <- retRes329655
                return nil
...
func  (this *kucoin) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes936845 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes936845)
                ch <- retRes936845
                return nil
...
func  (this *kucoin) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes88235 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes88235)
                    ch <- retRes88235
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes819013 := (<-this.LoadMarkets())
            PanicOnError(retRes819013)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoin) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes155517 := (<-this.LoadMarkets())
            PanicOnError(retRes155517)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *kucoin) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes708357 := (<-this.LoadMarkets())
            PanicOnError(retRes708357)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes720526 := (<-this.LoadMarkets())
            PanicOnError(retRes720526)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes807921 :=  (<-this.FetchPaginatedCallDynamic("fetchDeposits", code, since, limit, params))
                    PanicOnError(retRes807921)
                    ch <- retRes807921
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687548 := (<-this.LoadMarkets())
            PanicOnError(retRes687548)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes319590 :=  (<-this.FetchPaginatedCallDynamic("fetchWithdrawals", code, since, limit, params))
                    PanicOnError(retRes319590)
                    ch <- retRes319590
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes986102 := (<-this.LoadMarkets())
            PanicOnError(retRes986102)
...
func  (this *kucoin) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes624089 := (<-this.LoadMarkets())
            PanicOnError(retRes624089)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoin) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes574824 := (<-this.LoadMarkets())
            PanicOnError(retRes574824)
        
            retRes961045 := (<-this.LoadAccounts())
            PanicOnError(retRes961045)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes815182 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params))
                    PanicOnError(retRes815182)
                    ch <- retRes815182
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoin) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes724832 := (<-this.LoadMarkets())
            PanicOnError(retRes724832)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) BorrowIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes184968 := (<-this.LoadMarkets())
            PanicOnError(retRes184968)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes38730 := (<-this.LoadMarkets())
            PanicOnError(retRes38730)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
                "size": this.CurrencyToPrecision(code, amount),
...
func  (this *kucoin) RepayIsolatedMargin(symbol interface{}, code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes935056 := (<-this.LoadMarkets())
            PanicOnError(retRes935056)
            var market interface{} = this.Market(symbol)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "currency": GetValue(currency, "id"),
...
func  (this *kucoin) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes441001 := (<-this.LoadMarkets())
            PanicOnError(retRes441001)
...
func  (this *kucoin) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568779 := (<-this.LoadMarkets())
            PanicOnError(retRes568779)
            var market interface{} = nil
            ...
            AddElementToObject(request, "isIsolated", (IsEqual(marginMode, "isolated")))
                ...
                retRes968336 :=  (<-this.PrivatePostPositionUpdateUserLeverage(this.Extend(request, params)))
                PanicOnError(retRes968336)
                ch <- retRes968336
                return nil
