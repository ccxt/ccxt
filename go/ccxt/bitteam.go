...
func  (this *bitteam) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes396906 := (<-this.LoadMarkets())
            PanicOnError(retRes396906)
...
func  (this *bitteam) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes732984 := (<-this.LoadMarkets())
            PanicOnError(retRes732984)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitteam) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255606 := (<-this.LoadMarkets())
            PanicOnError(retRes255606)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
            var market interface{} = nil
...
func  (this *bitteam) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes128238 := (<-this.LoadMarkets())
            PanicOnError(retRes128238)
            var request interface{} = map[string]interface{} {
                "type": "active",
            }
        
                retRes791359 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes791359)
                ch <- retRes791359
                return nil
...
func  (this *bitteam) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes177229 := (<-this.LoadMarkets())
            PanicOnError(retRes177229)
            var request interface{} = map[string]interface{} {
                "type": "closed",
            }
        
                retRes708401 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes708401)
                ch <- retRes708401
                return nil
...
func  (this *bitteam) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes666052 := (<-this.LoadMarkets())
            PanicOnError(retRes666052)
            var request interface{} = map[string]interface{} {
                "type": "cancelled",
            }
        
                retRes407824 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes407824)
                ch <- retRes407824
                return nil
...
func  (this *bitteam) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403869 := (<-this.LoadMarkets())
            PanicOnError(retRes403869)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitteam) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes865545 := (<-this.LoadMarkets())
            PanicOnError(retRes865545)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *bitteam) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes989658 := (<-this.LoadMarkets())
            PanicOnError(retRes989658)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitteam) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes548386 := (<-this.LoadMarkets())
            PanicOnError(retRes548386)
...
func  (this *bitteam) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes529098 := (<-this.LoadMarkets())
            PanicOnError(retRes529098)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitteam) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes193044 := (<-this.LoadMarkets())
            PanicOnError(retRes193044)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *bitteam) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes951574 := (<-this.LoadMarkets())
            PanicOnError(retRes951574)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitteam) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes836902 := (<-this.LoadMarkets())
            PanicOnError(retRes836902)
