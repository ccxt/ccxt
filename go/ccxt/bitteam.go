...
func  (this *bitteam) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes170058 := (<-this.LoadMarkets())
            PanicOnError(retRes170058)
...
func  (this *bitteam) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes436746 := (<-this.LoadMarkets())
            PanicOnError(retRes436746)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitteam) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes569133 := (<-this.LoadMarkets())
            PanicOnError(retRes569133)
...
func  (this *bitteam) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes785540 := (<-this.LoadMarkets())
            PanicOnError(retRes785540)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
            var market interface{} = nil
...
func  (this *bitteam) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes688021 := (<-this.LoadMarkets())
            PanicOnError(retRes688021)
            var request interface{} = map[string]interface{} {
                "type": "active",
            }
        
                retRes915917 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes915917)
                ch <- retRes915917
                return nil
...
func  (this *bitteam) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes798327 := (<-this.LoadMarkets())
            PanicOnError(retRes798327)
            var request interface{} = map[string]interface{} {
                "type": "closed",
            }
        
                retRes670632 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes670632)
                ch <- retRes670632
                return nil
...
func  (this *bitteam) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes489176 := (<-this.LoadMarkets())
            PanicOnError(retRes489176)
            var request interface{} = map[string]interface{} {
                "type": "cancelled",
            }
        
                retRes17433 :=  (<-this.FetchOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes17433)
                ch <- retRes17433
                return nil
...
func  (this *bitteam) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes468443 := (<-this.LoadMarkets())
            PanicOnError(retRes468443)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitteam) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525392 := (<-this.LoadMarkets())
            PanicOnError(retRes525392)
            var request interface{} = map[string]interface{} {
                "id": id,
            }
...
func  (this *bitteam) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes662348 := (<-this.LoadMarkets())
            PanicOnError(retRes662348)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitteam) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes495724 := (<-this.LoadMarkets())
            PanicOnError(retRes495724)
...
func  (this *bitteam) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711739 := (<-this.LoadMarkets())
            PanicOnError(retRes711739)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitteam) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes807523 := (<-this.LoadMarkets())
            PanicOnError(retRes807523)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "pair": GetValue(market, "id"),
            }
...
func  (this *bitteam) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes264642 := (<-this.LoadMarkets())
            PanicOnError(retRes264642)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitteam) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes152943 := (<-this.LoadMarkets())
            PanicOnError(retRes152943)
