...
func  (this *kucoinfutures) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283324 := (<-this.LoadMarkets())
            PanicOnError(retRes283324)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes39009 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 200))
                    PanicOnError(retRes39009)
                    ch <- retRes39009
                    return nil
            }
...
func  (this *kucoinfutures) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497298 := (<-this.LoadMarkets())
            PanicOnError(retRes497298)
...
func  (this *kucoinfutures) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes7957 := (<-this.LoadMarkets())
            PanicOnError(retRes7957)
...
func  (this *kucoinfutures) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes737965 := (<-this.LoadMarkets())
            PanicOnError(retRes737965)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) FetchMarkPrice(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes994427 := (<-this.LoadMarkets())
            PanicOnError(retRes994427)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes452131 := (<-this.LoadMarkets())
            PanicOnError(retRes452131)
...
func  (this *kucoinfutures) FetchBidsAsks(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes634884 :=  (<-this.FetchTickers(symbols, this.Extend(request, params)))
                PanicOnError(retRes634884)
                ch <- retRes634884
                return nil
...
func  (this *kucoinfutures) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes4367 := (<-this.LoadMarkets())
            PanicOnError(retRes4367)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes243720 := (<-this.LoadMarkets())
            PanicOnError(retRes243720)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782908 := (<-this.LoadMarkets())
            PanicOnError(retRes782908)
...
func  (this *kucoinfutures) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes550226 := (<-this.LoadMarkets())
            PanicOnError(retRes550226)
            if IsTrue(IsEqual(limit, nil)) {
                limit = 200
            }
            var request interface{} = map[string]interface{} {
...
func  (this *kucoinfutures) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes211504 := (<-this.LoadMarkets())
            PanicOnError(retRes211504)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoinfutures) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes756716 := (<-this.LoadMarkets())
            PanicOnError(retRes756716)
...
func  (this *kucoinfutures) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes157118 := (<-this.LoadMarkets())
            PanicOnError(retRes157118)
...
func  (this *kucoinfutures) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes759634 := (<-this.LoadMarkets())
            PanicOnError(retRes759634)
...
func  (this *kucoinfutures) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes546171 := (<-this.LoadMarkets())
            PanicOnError(retRes546171)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
...
func  (this *kucoinfutures) FetchOrdersByStatus(status interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes563110 := (<-this.LoadMarkets())
            PanicOnError(retRes563110)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes706499 :=  (<-this.FetchPaginatedCallDynamic("fetchOrdersByStatus", symbol, since, limit, params))
                    PanicOnError(retRes706499)
                    ch <- retRes706499
                    return nil
            }
...
func  (this *kucoinfutures) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348788 := (<-this.LoadMarkets())
            PanicOnError(retRes348788)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes863294 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes863294)
                    ch <- retRes863294
                    return nil
            }
        
                retRes173905 :=  (<-this.FetchOrdersByStatus("done", symbol, since, limit, params))
                PanicOnError(retRes173905)
                ch <- retRes173905
                return nil
...
func  (this *kucoinfutures) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89213 := (<-this.LoadMarkets())
            PanicOnError(retRes89213)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes758392 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params))
                    PanicOnError(retRes758392)
                    ch <- retRes758392
                    return nil
            }
        
                retRes881921 :=  (<-this.FetchOrdersByStatus("open", symbol, since, limit, params))
                PanicOnError(retRes881921)
                ch <- retRes881921
                return nil
...
func  (this *kucoinfutures) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes602847 := (<-this.LoadMarkets())
            PanicOnError(retRes602847)
            var request interface{} = map[string]interface{} {}
            var response interface{} = nil
...
func  (this *kucoinfutures) FetchFundingInterval(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes211002 :=  (<-this.FetchFundingRate(symbol, params))
                PanicOnError(retRes211002)
                ch <- retRes211002
                return nil
...
func  (this *kucoinfutures) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192655 := (<-this.LoadMarkets())
            PanicOnError(retRes192655)
...
func  (this *kucoinfutures) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes391683 := (<-this.LoadMarkets())
            PanicOnError(retRes391683)
            var currency interface{} = this.Currency(code)
...
func  (this *kucoinfutures) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes505269 := (<-this.LoadMarkets())
            PanicOnError(retRes505269)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes147024 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes147024)
                    ch <- retRes147024
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoinfutures) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes743129 := (<-this.LoadMarkets())
            PanicOnError(retRes743129)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *kucoinfutures) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes251139 := (<-this.LoadMarkets())
            PanicOnError(retRes251139)
            var request interface{} = map[string]interface{} {}
...
func  (this *kucoinfutures) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes270472 := (<-this.LoadMarkets())
            PanicOnError(retRes270472)
            var request interface{} = map[string]interface{} {}
            var currency interface{} = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.Currency(code)
...
func  (this *kucoinfutures) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes296123 := (<-this.LoadMarkets())
            PanicOnError(retRes296123)
            var market interface{} = this.Market(symbol)
...
func  (this *kucoinfutures) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes259368 := (<-this.LoadMarkets())
            PanicOnError(retRes259368)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *kucoinfutures) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes170875 := (<-this.LoadMarkets())
            PanicOnError(retRes170875)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
...
func  (this *kucoinfutures) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes627617 := (<-this.LoadMarkets())
            PanicOnError(retRes627617)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
