...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes477588 := (<-this.LoadMarkets())
            PanicOnError(retRes477588)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes434382 := (<-this.LoadMarkets())
            PanicOnError(retRes434382)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628629 := (<-this.LoadMarkets())
            PanicOnError(retRes628629)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307854 := (<-this.LoadMarkets())
            PanicOnError(retRes307854)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168569 := (<-this.LoadMarkets())
            PanicOnError(retRes168569)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes484548 := (<-this.LoadMarkets())
            PanicOnError(retRes484548)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes399516 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes399516)
                    ch <- retRes399516
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes803218 := (<-this.LoadMarkets())
            PanicOnError(retRes803218)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes331440 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes331440)
                    ch <- retRes331440
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes252314 := (<-this.LoadMarkets())
            PanicOnError(retRes252314)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603875 := (<-this.LoadMarkets())
            PanicOnError(retRes603875)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes619254 := (<-this.LoadMarkets())
            PanicOnError(retRes619254)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes730181 := (<-this.LoadMarkets())
            PanicOnError(retRes730181)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes377473 := (<-this.LoadMarkets())
            PanicOnError(retRes377473)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes514477 := (<-this.LoadMarkets())
            PanicOnError(retRes514477)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes917249 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes917249)
                    ch <- retRes917249
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes781460 := (<-this.LoadMarkets())
            PanicOnError(retRes781460)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes288325 := (<-this.LoadMarkets())
            PanicOnError(retRes288325)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes959644 := (<-this.LoadMarkets())
            PanicOnError(retRes959644)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes471662 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes471662)
                ch <- retRes471662
                return nil
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes182907 := (<-this.LoadMarkets())
            PanicOnError(retRes182907)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903305 := (<-this.LoadMarkets())
            PanicOnError(retRes903305)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes123283 := (<-this.LoadMarkets())
            PanicOnError(retRes123283)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes536869 := (<-this.LoadMarkets())
            PanicOnError(retRes536869)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes813203 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes813203)
                    ch <- retRes813203
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes3679 := (<-this.LoadMarkets())
            PanicOnError(retRes3679)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes347181 := (<-this.LoadMarkets())
            PanicOnError(retRes347181)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes916969 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes916969)
                    ch <- retRes916969
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes396049 := (<-this.LoadMarkets())
            PanicOnError(retRes396049)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes177070 := (<-this.LoadMarkets())
            PanicOnError(retRes177070)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes208991 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes208991)
                    ch <- retRes208991
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes499361 := (<-this.LoadMarkets())
            PanicOnError(retRes499361)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes640872 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes640872)
                    ch <- retRes640872
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes783697 := (<-this.LoadMarkets())
            PanicOnError(retRes783697)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes380139 := (<-this.LoadMarkets())
            PanicOnError(retRes380139)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes729649 := (<-this.LoadMarkets())
            PanicOnError(retRes729649)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
