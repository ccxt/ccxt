...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes108383 := (<-this.LoadMarkets())
            PanicOnError(retRes108383)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes152475 := (<-this.LoadMarkets())
            PanicOnError(retRes152475)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes352950 := (<-this.LoadMarkets())
            PanicOnError(retRes352950)
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes224237 := (<-this.LoadMarkets())
            PanicOnError(retRes224237)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes135466 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes135466)
                    ch <- retRes135466
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes84931 := (<-this.LoadMarkets())
            PanicOnError(retRes84931)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes933909 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes933909)
                    ch <- retRes933909
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes257735 := (<-this.LoadMarkets())
            PanicOnError(retRes257735)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96967 := (<-this.LoadMarkets())
            PanicOnError(retRes96967)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246826 := (<-this.LoadMarkets())
            PanicOnError(retRes246826)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133374 := (<-this.LoadMarkets())
            PanicOnError(retRes133374)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291981 := (<-this.LoadMarkets())
            PanicOnError(retRes291981)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706935 := (<-this.LoadMarkets())
            PanicOnError(retRes706935)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes118078 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes930598 := (<-this.LoadMarkets())
            PanicOnError(retRes930598)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes553431 := (<-this.LoadMarkets())
            PanicOnError(retRes553431)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633716 := (<-this.LoadMarkets())
            PanicOnError(retRes633716)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes652005 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes652005)
                ch <- retRes652005
                return nil
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes387022 := (<-this.LoadMarkets())
            PanicOnError(retRes387022)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes749358 := (<-this.LoadMarkets())
            PanicOnError(retRes749358)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116594 := (<-this.LoadMarkets())
            PanicOnError(retRes116594)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes147174 := (<-this.LoadMarkets())
            PanicOnError(retRes147174)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes385020 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes385020)
                    ch <- retRes385020
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes303143 := (<-this.LoadMarkets())
            PanicOnError(retRes303143)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes495745 := (<-this.LoadMarkets())
            PanicOnError(retRes495745)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes165861 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes165861)
                    ch <- retRes165861
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes509093 := (<-this.LoadMarkets())
            PanicOnError(retRes509093)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes677601 := (<-this.LoadMarkets())
            PanicOnError(retRes677601)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913434 := (<-this.LoadMarkets())
            PanicOnError(retRes913434)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes553072 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes553072)
                    ch <- retRes553072
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes204130 := (<-this.LoadMarkets())
            PanicOnError(retRes204130)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes58412 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes58412)
                    ch <- retRes58412
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525537 := (<-this.LoadMarkets())
            PanicOnError(retRes525537)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes118979 := (<-this.LoadMarkets())
            PanicOnError(retRes118979)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307552 := (<-this.LoadMarkets())
            PanicOnError(retRes307552)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
