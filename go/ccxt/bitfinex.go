...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes576297 := (<-this.LoadMarkets())
            PanicOnError(retRes576297)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes988481 := (<-this.LoadMarkets())
            PanicOnError(retRes988481)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes214680 := (<-this.LoadMarkets())
            PanicOnError(retRes214680)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes855262 := (<-this.LoadMarkets())
            PanicOnError(retRes855262)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes467359 := (<-this.LoadMarkets())
            PanicOnError(retRes467359)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes985460 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes985460)
                    ch <- retRes985460
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes955704 := (<-this.LoadMarkets())
            PanicOnError(retRes955704)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes465842 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes465842)
                    ch <- retRes465842
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes520716 := (<-this.LoadMarkets())
            PanicOnError(retRes520716)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246158 := (<-this.LoadMarkets())
            PanicOnError(retRes246158)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes342371 := (<-this.LoadMarkets())
            PanicOnError(retRes342371)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes940981 := (<-this.LoadMarkets())
            PanicOnError(retRes940981)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes313021 := (<-this.LoadMarkets())
            PanicOnError(retRes313021)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes941475 := (<-this.LoadMarkets())
            PanicOnError(retRes941475)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109977 := (<-this.LoadMarkets())
            PanicOnError(retRes109977)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes616549 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706152 := (<-this.LoadMarkets())
            PanicOnError(retRes706152)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes718133 := (<-this.LoadMarkets())
            PanicOnError(retRes718133)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes704525 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes704525)
                ch <- retRes704525
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599513 := (<-this.LoadMarkets())
            PanicOnError(retRes599513)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117736 := (<-this.LoadMarkets())
            PanicOnError(retRes117736)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes261355 := (<-this.LoadMarkets())
            PanicOnError(retRes261355)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes383748 := (<-this.LoadMarkets())
            PanicOnError(retRes383748)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes840825 := (<-this.LoadMarkets())
            PanicOnError(retRes840825)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes412525 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes412525)
                    ch <- retRes412525
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes714961 := (<-this.LoadMarkets())
            PanicOnError(retRes714961)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes659853 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes659853)
                    ch <- retRes659853
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes143113 := (<-this.LoadMarkets())
            PanicOnError(retRes143113)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117501 := (<-this.LoadMarkets())
            PanicOnError(retRes117501)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes941249 := (<-this.LoadMarkets())
            PanicOnError(retRes941249)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes714535 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes714535)
                    ch <- retRes714535
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes766155 := (<-this.LoadMarkets())
            PanicOnError(retRes766155)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes670139 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes670139)
                    ch <- retRes670139
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes812885 := (<-this.LoadMarkets())
            PanicOnError(retRes812885)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660351 := (<-this.LoadMarkets())
            PanicOnError(retRes660351)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes467566 := (<-this.LoadMarkets())
            PanicOnError(retRes467566)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
