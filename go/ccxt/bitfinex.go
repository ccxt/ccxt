...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes918975 := (<-this.LoadMarkets())
            PanicOnError(retRes918975)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes35426 := (<-this.LoadMarkets())
            PanicOnError(retRes35426)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes809742 := (<-this.LoadMarkets())
            PanicOnError(retRes809742)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes815832 := (<-this.LoadMarkets())
            PanicOnError(retRes815832)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes107278 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes107278)
                    ch <- retRes107278
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes317489 := (<-this.LoadMarkets())
            PanicOnError(retRes317489)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes763603 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes763603)
                    ch <- retRes763603
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes380980 := (<-this.LoadMarkets())
            PanicOnError(retRes380980)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes852407 := (<-this.LoadMarkets())
            PanicOnError(retRes852407)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes474029 := (<-this.LoadMarkets())
            PanicOnError(retRes474029)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes666148 := (<-this.LoadMarkets())
            PanicOnError(retRes666148)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes460000 := (<-this.LoadMarkets())
            PanicOnError(retRes460000)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes641199 := (<-this.LoadMarkets())
            PanicOnError(retRes641199)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes9232 := (<-this.LoadMarkets())
            PanicOnError(retRes9232)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes421509 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes421509)
                    ch <- retRes421509
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes569300 := (<-this.LoadMarkets())
            PanicOnError(retRes569300)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes738989 := (<-this.LoadMarkets())
            PanicOnError(retRes738989)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes945895 := (<-this.LoadMarkets())
            PanicOnError(retRes945895)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes577450 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes647324 := (<-this.LoadMarkets())
            PanicOnError(retRes647324)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes302380 := (<-this.LoadMarkets())
            PanicOnError(retRes302380)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes10799 := (<-this.LoadMarkets())
            PanicOnError(retRes10799)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes921013 := (<-this.LoadMarkets())
            PanicOnError(retRes921013)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes260104 := (<-this.LoadMarkets())
            PanicOnError(retRes260104)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes683871 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes683871)
                    ch <- retRes683871
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes883461 := (<-this.LoadMarkets())
            PanicOnError(retRes883461)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes443922 := (<-this.LoadMarkets())
            PanicOnError(retRes443922)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes153416 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes153416)
                    ch <- retRes153416
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes161583 := (<-this.LoadMarkets())
            PanicOnError(retRes161583)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes261622 := (<-this.LoadMarkets())
            PanicOnError(retRes261622)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes870073 := (<-this.LoadMarkets())
            PanicOnError(retRes870073)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes364415 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes364415)
                    ch <- retRes364415
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes221967 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes221967)
                    ch <- retRes221967
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes849509 := (<-this.LoadMarkets())
            PanicOnError(retRes849509)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes253283 := (<-this.LoadMarkets())
            PanicOnError(retRes253283)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860637 := (<-this.LoadMarkets())
            PanicOnError(retRes860637)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
