...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes121851 := (<-this.LoadMarkets())
            PanicOnError(retRes121851)
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291406 := (<-this.LoadMarkets())
            PanicOnError(retRes291406)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915116 := (<-this.LoadMarkets())
            PanicOnError(retRes915116)
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes354324 := (<-this.LoadMarkets())
            PanicOnError(retRes354324)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes603638 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes603638)
                    ch <- retRes603638
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes261906 := (<-this.LoadMarkets())
            PanicOnError(retRes261906)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes42016 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes42016)
                    ch <- retRes42016
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180401 := (<-this.LoadMarkets())
            PanicOnError(retRes180401)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882716 := (<-this.LoadMarkets())
            PanicOnError(retRes882716)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes118764 := (<-this.LoadMarkets())
            PanicOnError(retRes118764)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes986454 := (<-this.LoadMarkets())
            PanicOnError(retRes986454)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes878364 := (<-this.LoadMarkets())
            PanicOnError(retRes878364)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes874755 := (<-this.LoadMarkets())
            PanicOnError(retRes874755)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes269687 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes269687)
                    ch <- retRes269687
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes178351 := (<-this.LoadMarkets())
            PanicOnError(retRes178351)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes860269 := (<-this.LoadMarkets())
            PanicOnError(retRes860269)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672873 := (<-this.LoadMarkets())
            PanicOnError(retRes672873)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes255915 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes255915)
                ch <- retRes255915
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes376439 := (<-this.LoadMarkets())
            PanicOnError(retRes376439)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes472951 := (<-this.LoadMarkets())
            PanicOnError(retRes472951)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes68525 := (<-this.LoadMarkets())
            PanicOnError(retRes68525)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes457456 := (<-this.LoadMarkets())
            PanicOnError(retRes457456)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes227514 := (<-this.LoadMarkets())
            PanicOnError(retRes227514)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes384335 := (<-this.LoadMarkets())
            PanicOnError(retRes384335)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes654015 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes801001 := (<-this.LoadMarkets())
            PanicOnError(retRes801001)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244329 := (<-this.LoadMarkets())
            PanicOnError(retRes244329)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes774650 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes774650)
                    ch <- retRes774650
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768783 := (<-this.LoadMarkets())
            PanicOnError(retRes768783)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731982 := (<-this.LoadMarkets())
            PanicOnError(retRes731982)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes784440 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes784440)
                    ch <- retRes784440
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes203118 := (<-this.LoadMarkets())
            PanicOnError(retRes203118)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes269554 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes269554)
                    ch <- retRes269554
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95249 := (<-this.LoadMarkets())
            PanicOnError(retRes95249)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes910544 := (<-this.LoadMarkets())
            PanicOnError(retRes910544)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes264833 := (<-this.LoadMarkets())
            PanicOnError(retRes264833)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
