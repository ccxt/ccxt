...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes962110 := (<-this.LoadMarkets())
            PanicOnError(retRes962110)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696569 := (<-this.LoadMarkets())
            PanicOnError(retRes696569)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478187 := (<-this.LoadMarkets())
            PanicOnError(retRes478187)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes564031 := (<-this.LoadMarkets())
            PanicOnError(retRes564031)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes211461 := (<-this.LoadMarkets())
            PanicOnError(retRes211461)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes862058 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes862058)
                    ch <- retRes862058
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes616561 := (<-this.LoadMarkets())
            PanicOnError(retRes616561)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes819823 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes819823)
                    ch <- retRes819823
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes333697 := (<-this.LoadMarkets())
            PanicOnError(retRes333697)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes537514 := (<-this.LoadMarkets())
            PanicOnError(retRes537514)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913959 := (<-this.LoadMarkets())
            PanicOnError(retRes913959)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes594086 := (<-this.LoadMarkets())
            PanicOnError(retRes594086)
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes23949 := (<-this.LoadMarkets())
            PanicOnError(retRes23949)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes119831 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes119831)
                    ch <- retRes119831
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes990304 := (<-this.LoadMarkets())
            PanicOnError(retRes990304)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes846153 := (<-this.LoadMarkets())
            PanicOnError(retRes846153)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835382 := (<-this.LoadMarkets())
            PanicOnError(retRes835382)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes794591 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes794591)
                ch <- retRes794591
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297761 := (<-this.LoadMarkets())
            PanicOnError(retRes297761)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes732444 := (<-this.LoadMarkets())
            PanicOnError(retRes732444)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes329424 := (<-this.LoadMarkets())
            PanicOnError(retRes329424)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241094 := (<-this.LoadMarkets())
            PanicOnError(retRes241094)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes469431 := (<-this.LoadMarkets())
            PanicOnError(retRes469431)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes828404 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes828404)
                    ch <- retRes828404
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes500168 := (<-this.LoadMarkets())
            PanicOnError(retRes500168)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes137220 := (<-this.LoadMarkets())
            PanicOnError(retRes137220)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes999997 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes999997)
                    ch <- retRes999997
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes574301 := (<-this.LoadMarkets())
            PanicOnError(retRes574301)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes74434 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes74434)
                    ch <- retRes74434
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes481567 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes481567)
                    ch <- retRes481567
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes809018 := (<-this.LoadMarkets())
            PanicOnError(retRes809018)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes341684 := (<-this.LoadMarkets())
            PanicOnError(retRes341684)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
