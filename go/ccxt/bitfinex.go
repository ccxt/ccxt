...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes300129 := (<-this.LoadMarkets())
            PanicOnError(retRes300129)
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes212523 := (<-this.LoadMarkets())
            PanicOnError(retRes212523)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes569474 := (<-this.LoadMarkets())
            PanicOnError(retRes569474)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999933 := (<-this.LoadMarkets())
            PanicOnError(retRes999933)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes869008 := (<-this.LoadMarkets())
            PanicOnError(retRes869008)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes234837 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes234837)
                    ch <- retRes234837
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes506645 := (<-this.LoadMarkets())
            PanicOnError(retRes506645)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes401954 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes401954)
                    ch <- retRes401954
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes214720 := (<-this.LoadMarkets())
            PanicOnError(retRes214720)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes679988 := (<-this.LoadMarkets())
            PanicOnError(retRes679988)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638655 := (<-this.LoadMarkets())
            PanicOnError(retRes638655)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526504 := (<-this.LoadMarkets())
            PanicOnError(retRes526504)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes468529 := (<-this.LoadMarkets())
            PanicOnError(retRes468529)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes79089 := (<-this.LoadMarkets())
            PanicOnError(retRes79089)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes510008 := (<-this.LoadMarkets())
            PanicOnError(retRes510008)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes517239 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes517239)
                    ch <- retRes517239
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78197 := (<-this.LoadMarkets())
            PanicOnError(retRes78197)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes31883 := (<-this.LoadMarkets())
            PanicOnError(retRes31883)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes360308 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes360308)
                ch <- retRes360308
                return nil
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes642390 := (<-this.LoadMarkets())
            PanicOnError(retRes642390)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes400489 := (<-this.LoadMarkets())
            PanicOnError(retRes400489)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes577721 := (<-this.LoadMarkets())
            PanicOnError(retRes577721)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes393906 := (<-this.LoadMarkets())
            PanicOnError(retRes393906)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes309977 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes309977)
                    ch <- retRes309977
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes326336 := (<-this.LoadMarkets())
            PanicOnError(retRes326336)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes664114 := (<-this.LoadMarkets())
            PanicOnError(retRes664114)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes372775 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes372775)
                    ch <- retRes372775
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes842440 := (<-this.LoadMarkets())
            PanicOnError(retRes842440)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987684 := (<-this.LoadMarkets())
            PanicOnError(retRes987684)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes453464 := (<-this.LoadMarkets())
            PanicOnError(retRes453464)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes701046 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes701046)
                    ch <- retRes701046
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes13183 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes13183)
                    ch <- retRes13183
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes755613 := (<-this.LoadMarkets())
            PanicOnError(retRes755613)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614913 := (<-this.LoadMarkets())
            PanicOnError(retRes614913)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes995243 := (<-this.LoadMarkets())
            PanicOnError(retRes995243)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
