...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes888555 := (<-this.LoadMarkets())
            PanicOnError(retRes888555)
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes159235 := (<-this.LoadMarkets())
            PanicOnError(retRes159235)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272984 := (<-this.LoadMarkets())
            PanicOnError(retRes272984)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706881 := (<-this.LoadMarkets())
            PanicOnError(retRes706881)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes570498 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes570498)
                    ch <- retRes570498
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes9566 := (<-this.LoadMarkets())
            PanicOnError(retRes9566)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes804336 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes804336)
                    ch <- retRes804336
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes505743 := (<-this.LoadMarkets())
            PanicOnError(retRes505743)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180489 := (<-this.LoadMarkets())
            PanicOnError(retRes180489)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes661501 := (<-this.LoadMarkets())
            PanicOnError(retRes661501)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes991581 := (<-this.LoadMarkets())
            PanicOnError(retRes991581)
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes392721 := (<-this.LoadMarkets())
            PanicOnError(retRes392721)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes808685 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes808685)
                    ch <- retRes808685
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes268188 := (<-this.LoadMarkets())
            PanicOnError(retRes268188)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes366485 := (<-this.LoadMarkets())
            PanicOnError(retRes366485)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes921110 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes921110)
                ch <- retRes921110
                return nil
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes445056 := (<-this.LoadMarkets())
            PanicOnError(retRes445056)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes725309 := (<-this.LoadMarkets())
            PanicOnError(retRes725309)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes597616 := (<-this.LoadMarkets())
            PanicOnError(retRes597616)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192677 := (<-this.LoadMarkets())
            PanicOnError(retRes192677)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes127529 := (<-this.LoadMarkets())
            PanicOnError(retRes127529)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes541434 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes541434)
                    ch <- retRes541434
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes911465 := (<-this.LoadMarkets())
            PanicOnError(retRes911465)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes542547 := (<-this.LoadMarkets())
            PanicOnError(retRes542547)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes279616 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes279616)
                    ch <- retRes279616
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50211 := (<-this.LoadMarkets())
            PanicOnError(retRes50211)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633056 := (<-this.LoadMarkets())
            PanicOnError(retRes633056)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes32749 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes32749)
                    ch <- retRes32749
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes824205 := (<-this.LoadMarkets())
            PanicOnError(retRes824205)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes596150 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes596150)
                    ch <- retRes596150
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695469 := (<-this.LoadMarkets())
            PanicOnError(retRes695469)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes930517 := (<-this.LoadMarkets())
            PanicOnError(retRes930517)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes177670 := (<-this.LoadMarkets())
            PanicOnError(retRes177670)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
