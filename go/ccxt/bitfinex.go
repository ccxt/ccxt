...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes402088 := (<-this.LoadMarkets())
            PanicOnError(retRes402088)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes81239 := (<-this.LoadMarkets())
            PanicOnError(retRes81239)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes624785 := (<-this.LoadMarkets())
            PanicOnError(retRes624785)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes430768 := (<-this.LoadMarkets())
            PanicOnError(retRes430768)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes239036 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes239036)
                    ch <- retRes239036
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915465 := (<-this.LoadMarkets())
            PanicOnError(retRes915465)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes930175 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes930175)
                    ch <- retRes930175
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes379297 := (<-this.LoadMarkets())
            PanicOnError(retRes379297)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes904167 := (<-this.LoadMarkets())
            PanicOnError(retRes904167)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes964728 := (<-this.LoadMarkets())
            PanicOnError(retRes964728)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes372745 := (<-this.LoadMarkets())
            PanicOnError(retRes372745)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes322680 := (<-this.LoadMarkets())
            PanicOnError(retRes322680)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes574867 := (<-this.LoadMarkets())
            PanicOnError(retRes574867)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes492915 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes492915)
                    ch <- retRes492915
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes204869 := (<-this.LoadMarkets())
            PanicOnError(retRes204869)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes328452 := (<-this.LoadMarkets())
            PanicOnError(retRes328452)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507713 := (<-this.LoadMarkets())
            PanicOnError(retRes507713)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes408215 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes408215)
                ch <- retRes408215
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes155428 := (<-this.LoadMarkets())
            PanicOnError(retRes155428)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999542 := (<-this.LoadMarkets())
            PanicOnError(retRes999542)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes796930 := (<-this.LoadMarkets())
            PanicOnError(retRes796930)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes273297 := (<-this.LoadMarkets())
            PanicOnError(retRes273297)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes61167 := (<-this.LoadMarkets())
            PanicOnError(retRes61167)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes579117 := (<-this.LoadMarkets())
            PanicOnError(retRes579117)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes708291 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes708291)
                    ch <- retRes708291
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858873 := (<-this.LoadMarkets())
            PanicOnError(retRes858873)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes750763 := (<-this.LoadMarkets())
            PanicOnError(retRes750763)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes174729 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes123033 := (<-this.LoadMarkets())
            PanicOnError(retRes123033)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279894 := (<-this.LoadMarkets())
            PanicOnError(retRes279894)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes977368 := (<-this.LoadMarkets())
            PanicOnError(retRes977368)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes459993 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes459993)
                    ch <- retRes459993
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes720185 := (<-this.LoadMarkets())
            PanicOnError(retRes720185)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes704449 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes704449)
                    ch <- retRes704449
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes840580 := (<-this.LoadMarkets())
            PanicOnError(retRes840580)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes502436 := (<-this.LoadMarkets())
            PanicOnError(retRes502436)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes10510 := (<-this.LoadMarkets())
            PanicOnError(retRes10510)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
