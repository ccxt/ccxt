...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706656 := (<-this.LoadMarkets())
            PanicOnError(retRes706656)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes686790 := (<-this.LoadMarkets())
            PanicOnError(retRes686790)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes617473 := (<-this.LoadMarkets())
            PanicOnError(retRes617473)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes806101 := (<-this.LoadMarkets())
            PanicOnError(retRes806101)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes756675 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes756675)
                    ch <- retRes756675
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes906376 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes906376)
                    ch <- retRes906376
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes572152 := (<-this.LoadMarkets())
            PanicOnError(retRes572152)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497595 := (<-this.LoadMarkets())
            PanicOnError(retRes497595)
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578256 := (<-this.LoadMarkets())
            PanicOnError(retRes578256)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes522868 := (<-this.LoadMarkets())
            PanicOnError(retRes522868)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes103331 := (<-this.LoadMarkets())
            PanicOnError(retRes103331)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes128273 := (<-this.LoadMarkets())
            PanicOnError(retRes128273)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes500542 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes500542)
                    ch <- retRes500542
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes317514 := (<-this.LoadMarkets())
            PanicOnError(retRes317514)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes984647 := (<-this.LoadMarkets())
            PanicOnError(retRes984647)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes71571 := (<-this.LoadMarkets())
            PanicOnError(retRes71571)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes725442 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes725442)
                ch <- retRes725442
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes300586 := (<-this.LoadMarkets())
            PanicOnError(retRes300586)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes208259 := (<-this.LoadMarkets())
            PanicOnError(retRes208259)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes701131 := (<-this.LoadMarkets())
            PanicOnError(retRes701131)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes237907 := (<-this.LoadMarkets())
            PanicOnError(retRes237907)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes975161 := (<-this.LoadMarkets())
            PanicOnError(retRes975161)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes134204 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes134204)
                    ch <- retRes134204
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes616985 := (<-this.LoadMarkets())
            PanicOnError(retRes616985)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192945 := (<-this.LoadMarkets())
            PanicOnError(retRes192945)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes951960 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes951960)
                    ch <- retRes951960
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes152473 := (<-this.LoadMarkets())
            PanicOnError(retRes152473)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes254389 := (<-this.LoadMarkets())
            PanicOnError(retRes254389)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes720516 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes720516)
                    ch <- retRes720516
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes358021 := (<-this.LoadMarkets())
            PanicOnError(retRes358021)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes288775 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes288775)
                    ch <- retRes288775
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes371498 := (<-this.LoadMarkets())
            PanicOnError(retRes371498)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes947105 := (<-this.LoadMarkets())
            PanicOnError(retRes947105)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes867245 := (<-this.LoadMarkets())
            PanicOnError(retRes867245)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
