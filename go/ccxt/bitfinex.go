...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes289521 := (<-this.LoadMarkets())
            PanicOnError(retRes289521)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87341 := (<-this.LoadMarkets())
            PanicOnError(retRes87341)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes787789 := (<-this.LoadMarkets())
            PanicOnError(retRes787789)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507251 := (<-this.LoadMarkets())
            PanicOnError(retRes507251)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes397061 := (<-this.LoadMarkets())
            PanicOnError(retRes397061)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes249740 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes249740)
                    ch <- retRes249740
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes684687 := (<-this.LoadMarkets())
            PanicOnError(retRes684687)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes596177 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes596177)
                    ch <- retRes596177
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes205953 := (<-this.LoadMarkets())
            PanicOnError(retRes205953)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes560233 := (<-this.LoadMarkets())
            PanicOnError(retRes560233)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes851450 := (<-this.LoadMarkets())
            PanicOnError(retRes851450)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes704420 := (<-this.LoadMarkets())
            PanicOnError(retRes704420)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes306882 := (<-this.LoadMarkets())
            PanicOnError(retRes306882)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731433 := (<-this.LoadMarkets())
            PanicOnError(retRes731433)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes642542 := (<-this.LoadMarkets())
            PanicOnError(retRes642542)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes964683 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes964683)
                    ch <- retRes964683
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes215337 := (<-this.LoadMarkets())
            PanicOnError(retRes215337)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes419003 := (<-this.LoadMarkets())
            PanicOnError(retRes419003)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes788212 := (<-this.LoadMarkets())
            PanicOnError(retRes788212)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes572938 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes572938)
                ch <- retRes572938
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes851100 := (<-this.LoadMarkets())
            PanicOnError(retRes851100)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes773796 := (<-this.LoadMarkets())
            PanicOnError(retRes773796)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes108806 := (<-this.LoadMarkets())
            PanicOnError(retRes108806)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes746634 := (<-this.LoadMarkets())
            PanicOnError(retRes746634)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes863008 := (<-this.LoadMarkets())
            PanicOnError(retRes863008)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes606458 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes606458)
                    ch <- retRes606458
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929993 := (<-this.LoadMarkets())
            PanicOnError(retRes929993)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes499220 := (<-this.LoadMarkets())
            PanicOnError(retRes499220)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes390639 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes390639)
                    ch <- retRes390639
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33651 := (<-this.LoadMarkets())
            PanicOnError(retRes33651)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes57644 := (<-this.LoadMarkets())
            PanicOnError(retRes57644)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes887816 := (<-this.LoadMarkets())
            PanicOnError(retRes887816)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes16101 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes16101)
                    ch <- retRes16101
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes978707 := (<-this.LoadMarkets())
            PanicOnError(retRes978707)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes987861 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes987861)
                    ch <- retRes987861
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes465696 := (<-this.LoadMarkets())
            PanicOnError(retRes465696)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes267609 := (<-this.LoadMarkets())
            PanicOnError(retRes267609)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518120 := (<-this.LoadMarkets())
            PanicOnError(retRes518120)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
