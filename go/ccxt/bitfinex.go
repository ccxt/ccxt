...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638159 := (<-this.LoadMarkets())
            PanicOnError(retRes638159)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes221084 := (<-this.LoadMarkets())
            PanicOnError(retRes221084)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes537181 := (<-this.LoadMarkets())
            PanicOnError(retRes537181)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes536009 := (<-this.LoadMarkets())
            PanicOnError(retRes536009)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes683485 := (<-this.LoadMarkets())
            PanicOnError(retRes683485)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes983010 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes983010)
                    ch <- retRes983010
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403998 := (<-this.LoadMarkets())
            PanicOnError(retRes403998)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes873605 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes873605)
                    ch <- retRes873605
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes681756 := (<-this.LoadMarkets())
            PanicOnError(retRes681756)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes780728 := (<-this.LoadMarkets())
            PanicOnError(retRes780728)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes236956 := (<-this.LoadMarkets())
            PanicOnError(retRes236956)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes148892 := (<-this.LoadMarkets())
            PanicOnError(retRes148892)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes436265 := (<-this.LoadMarkets())
            PanicOnError(retRes436265)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929592 := (<-this.LoadMarkets())
            PanicOnError(retRes929592)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes911560 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes911560)
                    ch <- retRes911560
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes546264 := (<-this.LoadMarkets())
            PanicOnError(retRes546264)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes132622 := (<-this.LoadMarkets())
            PanicOnError(retRes132622)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes575141 := (<-this.LoadMarkets())
            PanicOnError(retRes575141)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes723573 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes723573)
                ch <- retRes723573
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes946216 := (<-this.LoadMarkets())
            PanicOnError(retRes946216)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes383576 := (<-this.LoadMarkets())
            PanicOnError(retRes383576)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes461800 := (<-this.LoadMarkets())
            PanicOnError(retRes461800)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes395047 := (<-this.LoadMarkets())
            PanicOnError(retRes395047)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes922796 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes922796)
                    ch <- retRes922796
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes697840 := (<-this.LoadMarkets())
            PanicOnError(retRes697840)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes893165 := (<-this.LoadMarkets())
            PanicOnError(retRes893165)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes33450 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes33450)
                    ch <- retRes33450
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes798692 := (<-this.LoadMarkets())
            PanicOnError(retRes798692)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes962023 := (<-this.LoadMarkets())
            PanicOnError(retRes962023)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes563972 := (<-this.LoadMarkets())
            PanicOnError(retRes563972)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes691352 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes691352)
                    ch <- retRes691352
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes922425 := (<-this.LoadMarkets())
            PanicOnError(retRes922425)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes823955 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes823955)
                    ch <- retRes823955
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518758 := (<-this.LoadMarkets())
            PanicOnError(retRes518758)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes953542 := (<-this.LoadMarkets())
            PanicOnError(retRes953542)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes270926 := (<-this.LoadMarkets())
            PanicOnError(retRes270926)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
