...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes911762 := (<-this.LoadMarkets())
            PanicOnError(retRes911762)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes857249 := (<-this.LoadMarkets())
            PanicOnError(retRes857249)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73862 := (<-this.LoadMarkets())
            PanicOnError(retRes73862)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes298074 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes298074)
                    ch <- retRes298074
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes460399 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes460399)
                    ch <- retRes460399
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes743160 := (<-this.LoadMarkets())
            PanicOnError(retRes743160)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes68125 := (<-this.LoadMarkets())
            PanicOnError(retRes68125)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes75246 := (<-this.LoadMarkets())
            PanicOnError(retRes75246)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478938 := (<-this.LoadMarkets())
            PanicOnError(retRes478938)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes539295 := (<-this.LoadMarkets())
            PanicOnError(retRes539295)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes786591 := (<-this.LoadMarkets())
            PanicOnError(retRes786591)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes796086 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes796086)
                    ch <- retRes796086
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733631 := (<-this.LoadMarkets())
            PanicOnError(retRes733631)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62832 := (<-this.LoadMarkets())
            PanicOnError(retRes62832)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes632624 := (<-this.LoadMarkets())
            PanicOnError(retRes632624)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes832615 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes198570 := (<-this.LoadMarkets())
            PanicOnError(retRes198570)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes560285 := (<-this.LoadMarkets())
            PanicOnError(retRes560285)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes354389 := (<-this.LoadMarkets())
            PanicOnError(retRes354389)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77702 := (<-this.LoadMarkets())
            PanicOnError(retRes77702)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes475791 := (<-this.LoadMarkets())
            PanicOnError(retRes475791)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes540210 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes540210)
                    ch <- retRes540210
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes666201 := (<-this.LoadMarkets())
            PanicOnError(retRes666201)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes746532 := (<-this.LoadMarkets())
            PanicOnError(retRes746532)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes957945 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes957945)
                    ch <- retRes957945
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733578 := (<-this.LoadMarkets())
            PanicOnError(retRes733578)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes660430 := (<-this.LoadMarkets())
            PanicOnError(retRes660430)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes716162 := (<-this.LoadMarkets())
            PanicOnError(retRes716162)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes228596 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes102397 := (<-this.LoadMarkets())
            PanicOnError(retRes102397)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes302045 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes302045)
                    ch <- retRes302045
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283041 := (<-this.LoadMarkets())
            PanicOnError(retRes283041)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes591461 := (<-this.LoadMarkets())
            PanicOnError(retRes591461)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes763047 := (<-this.LoadMarkets())
            PanicOnError(retRes763047)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
