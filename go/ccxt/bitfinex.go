...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes156389 := (<-this.LoadMarkets())
            PanicOnError(retRes156389)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes899204 := (<-this.LoadMarkets())
            PanicOnError(retRes899204)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes781771 := (<-this.LoadMarkets())
            PanicOnError(retRes781771)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes440728 := (<-this.LoadMarkets())
            PanicOnError(retRes440728)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes887291 := (<-this.LoadMarkets())
            PanicOnError(retRes887291)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes16515 := (<-this.LoadMarkets())
            PanicOnError(retRes16515)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes506311 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes506311)
                    ch <- retRes506311
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes845291 := (<-this.LoadMarkets())
            PanicOnError(retRes845291)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes681784 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes681784)
                    ch <- retRes681784
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes697694 := (<-this.LoadMarkets())
            PanicOnError(retRes697694)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98197 := (<-this.LoadMarkets())
            PanicOnError(retRes98197)
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes562539 := (<-this.LoadMarkets())
            PanicOnError(retRes562539)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes925788 := (<-this.LoadMarkets())
            PanicOnError(retRes925788)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes732798 := (<-this.LoadMarkets())
            PanicOnError(retRes732798)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes953628 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes953628)
                    ch <- retRes953628
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283005 := (<-this.LoadMarkets())
            PanicOnError(retRes283005)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes913179 := (<-this.LoadMarkets())
            PanicOnError(retRes913179)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes871316 := (<-this.LoadMarkets())
            PanicOnError(retRes871316)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes661375 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes661375)
                ch <- retRes661375
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes66611 := (<-this.LoadMarkets())
            PanicOnError(retRes66611)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589601 := (<-this.LoadMarkets())
            PanicOnError(retRes589601)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes721429 := (<-this.LoadMarkets())
            PanicOnError(retRes721429)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes294662 := (<-this.LoadMarkets())
            PanicOnError(retRes294662)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes784085 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes784085)
                    ch <- retRes784085
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes659782 := (<-this.LoadMarkets())
            PanicOnError(retRes659782)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes13624 := (<-this.LoadMarkets())
            PanicOnError(retRes13624)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes33629 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes33629)
                    ch <- retRes33629
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes803526 := (<-this.LoadMarkets())
            PanicOnError(retRes803526)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes119857 := (<-this.LoadMarkets())
            PanicOnError(retRes119857)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes957972 := (<-this.LoadMarkets())
            PanicOnError(retRes957972)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes533288 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes533288)
                    ch <- retRes533288
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes598756 := (<-this.LoadMarkets())
            PanicOnError(retRes598756)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes980527 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes980527)
                    ch <- retRes980527
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes529686 := (<-this.LoadMarkets())
            PanicOnError(retRes529686)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes434175 := (<-this.LoadMarkets())
            PanicOnError(retRes434175)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes303878 := (<-this.LoadMarkets())
            PanicOnError(retRes303878)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
