...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes491681 := (<-this.LoadMarkets())
            PanicOnError(retRes491681)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes159715 := (<-this.LoadMarkets())
            PanicOnError(retRes159715)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes446766 := (<-this.LoadMarkets())
            PanicOnError(retRes446766)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes17177 := (<-this.LoadMarkets())
            PanicOnError(retRes17177)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451307 := (<-this.LoadMarkets())
            PanicOnError(retRes451307)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes307887 := (<-this.LoadMarkets())
            PanicOnError(retRes307887)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes114009 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes114009)
                    ch <- retRes114009
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes372809 := (<-this.LoadMarkets())
            PanicOnError(retRes372809)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes540754 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes540754)
                    ch <- retRes540754
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes320524 := (<-this.LoadMarkets())
            PanicOnError(retRes320524)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes818251 := (<-this.LoadMarkets())
            PanicOnError(retRes818251)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes736598 := (<-this.LoadMarkets())
            PanicOnError(retRes736598)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255668 := (<-this.LoadMarkets())
            PanicOnError(retRes255668)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes137238 := (<-this.LoadMarkets())
            PanicOnError(retRes137238)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes844831 := (<-this.LoadMarkets())
            PanicOnError(retRes844831)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes940865 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes940865)
                    ch <- retRes940865
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes620230 := (<-this.LoadMarkets())
            PanicOnError(retRes620230)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes444094 := (<-this.LoadMarkets())
            PanicOnError(retRes444094)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes488996 := (<-this.LoadMarkets())
            PanicOnError(retRes488996)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes241443 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes241443)
                ch <- retRes241443
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes458121 := (<-this.LoadMarkets())
            PanicOnError(retRes458121)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes417081 := (<-this.LoadMarkets())
            PanicOnError(retRes417081)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes850007 := (<-this.LoadMarkets())
            PanicOnError(retRes850007)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes462321 := (<-this.LoadMarkets())
            PanicOnError(retRes462321)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes284044 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes284044)
                    ch <- retRes284044
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes629714 := (<-this.LoadMarkets())
            PanicOnError(retRes629714)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes497033 := (<-this.LoadMarkets())
            PanicOnError(retRes497033)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes481719 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes687771 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes687771)
                    ch <- retRes687771
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes295702 := (<-this.LoadMarkets())
            PanicOnError(retRes295702)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes465080 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes465080)
                    ch <- retRes465080
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes754532 := (<-this.LoadMarkets())
            PanicOnError(retRes754532)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes283388 := (<-this.LoadMarkets())
            PanicOnError(retRes283388)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes779686 := (<-this.LoadMarkets())
            PanicOnError(retRes779686)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
