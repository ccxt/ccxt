...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes248286 := (<-this.LoadMarkets())
            PanicOnError(retRes248286)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes513857 := (<-this.LoadMarkets())
            PanicOnError(retRes513857)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes447718 := (<-this.LoadMarkets())
            PanicOnError(retRes447718)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes804355 := (<-this.LoadMarkets())
            PanicOnError(retRes804355)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes531618 := (<-this.LoadMarkets())
            PanicOnError(retRes531618)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes579435 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes579435)
                    ch <- retRes579435
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes830693 := (<-this.LoadMarkets())
            PanicOnError(retRes830693)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes859697 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes859697)
                    ch <- retRes859697
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes96727 := (<-this.LoadMarkets())
            PanicOnError(retRes96727)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes716247 := (<-this.LoadMarkets())
            PanicOnError(retRes716247)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes915678 := (<-this.LoadMarkets())
            PanicOnError(retRes915678)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes798079 := (<-this.LoadMarkets())
            PanicOnError(retRes798079)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631917 := (<-this.LoadMarkets())
            PanicOnError(retRes631917)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes845972 := (<-this.LoadMarkets())
            PanicOnError(retRes845972)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451868 := (<-this.LoadMarkets())
            PanicOnError(retRes451868)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes965008 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes965008)
                    ch <- retRes965008
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes514507 := (<-this.LoadMarkets())
            PanicOnError(retRes514507)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes641222 := (<-this.LoadMarkets())
            PanicOnError(retRes641222)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes574218 := (<-this.LoadMarkets())
            PanicOnError(retRes574218)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes315364 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes315364)
                ch <- retRes315364
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes312426 := (<-this.LoadMarkets())
            PanicOnError(retRes312426)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes594656 := (<-this.LoadMarkets())
            PanicOnError(retRes594656)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50993 := (<-this.LoadMarkets())
            PanicOnError(retRes50993)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes600399 := (<-this.LoadMarkets())
            PanicOnError(retRes600399)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes527656 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes527656)
                    ch <- retRes527656
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes900466 := (<-this.LoadMarkets())
            PanicOnError(retRes900466)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes233449 := (<-this.LoadMarkets())
            PanicOnError(retRes233449)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes212491 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes212491)
                    ch <- retRes212491
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes50436 := (<-this.LoadMarkets())
            PanicOnError(retRes50436)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes388493 := (<-this.LoadMarkets())
            PanicOnError(retRes388493)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747925 := (<-this.LoadMarkets())
            PanicOnError(retRes747925)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes587868 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes587868)
                    ch <- retRes587868
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes260319 := (<-this.LoadMarkets())
            PanicOnError(retRes260319)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes349777 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes349777)
                    ch <- retRes349777
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes608333 := (<-this.LoadMarkets())
            PanicOnError(retRes608333)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
