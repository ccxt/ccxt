...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes256523 := (<-this.LoadMarkets())
            PanicOnError(retRes256523)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes627109 := (<-this.LoadMarkets())
            PanicOnError(retRes627109)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631048 := (<-this.LoadMarkets())
            PanicOnError(retRes631048)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes181454 := (<-this.LoadMarkets())
            PanicOnError(retRes181454)
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872852 := (<-this.LoadMarkets())
            PanicOnError(retRes872852)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes604771 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes604771)
                    ch <- retRes604771
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes225364 := (<-this.LoadMarkets())
            PanicOnError(retRes225364)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes738961 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes738961)
                    ch <- retRes738961
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes675777 := (<-this.LoadMarkets())
            PanicOnError(retRes675777)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes232736 := (<-this.LoadMarkets())
            PanicOnError(retRes232736)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928393 := (<-this.LoadMarkets())
            PanicOnError(retRes928393)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes248404 := (<-this.LoadMarkets())
            PanicOnError(retRes248404)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes259808 := (<-this.LoadMarkets())
            PanicOnError(retRes259808)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes531530 := (<-this.LoadMarkets())
            PanicOnError(retRes531530)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes422689 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes422689)
                    ch <- retRes422689
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes891103 := (<-this.LoadMarkets())
            PanicOnError(retRes891103)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526257 := (<-this.LoadMarkets())
            PanicOnError(retRes526257)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes809347 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes809347)
                ch <- retRes809347
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes17134 := (<-this.LoadMarkets())
            PanicOnError(retRes17134)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes793095 := (<-this.LoadMarkets())
            PanicOnError(retRes793095)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes198593 := (<-this.LoadMarkets())
            PanicOnError(retRes198593)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes436523 := (<-this.LoadMarkets())
            PanicOnError(retRes436523)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes630145 := (<-this.LoadMarkets())
            PanicOnError(retRes630145)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes94684 := (<-this.LoadMarkets())
            PanicOnError(retRes94684)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes732352 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes732352)
                    ch <- retRes732352
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes620982 := (<-this.LoadMarkets())
            PanicOnError(retRes620982)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes444914 := (<-this.LoadMarkets())
            PanicOnError(retRes444914)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes850932 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes850932)
                    ch <- retRes850932
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes882027 := (<-this.LoadMarkets())
            PanicOnError(retRes882027)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes244148 := (<-this.LoadMarkets())
            PanicOnError(retRes244148)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes690816 := (<-this.LoadMarkets())
            PanicOnError(retRes690816)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes130592 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes130592)
                    ch <- retRes130592
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes772189 := (<-this.LoadMarkets())
            PanicOnError(retRes772189)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes48249 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes48249)
                    ch <- retRes48249
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706685 := (<-this.LoadMarkets())
            PanicOnError(retRes706685)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes288431 := (<-this.LoadMarkets())
            PanicOnError(retRes288431)
            var request interface{} = map[string]interface{} {
