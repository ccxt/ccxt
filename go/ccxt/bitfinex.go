...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes867352 := (<-this.LoadMarkets())
            PanicOnError(retRes867352)
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes565776 := (<-this.LoadMarkets())
            PanicOnError(retRes565776)
...
func  (this *bitfinex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes165204 := (<-this.LoadMarkets())
            PanicOnError(retRes165204)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes681431 := (<-this.LoadMarkets())
            PanicOnError(retRes681431)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes372119 := (<-this.LoadMarkets())
            PanicOnError(retRes372119)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes683956 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes683956)
                    ch <- retRes683956
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes560086 := (<-this.LoadMarkets())
            PanicOnError(retRes560086)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes119343 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes119343)
                    ch <- retRes119343
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes266390 := (<-this.LoadMarkets())
            PanicOnError(retRes266390)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes522570 := (<-this.LoadMarkets())
            PanicOnError(retRes522570)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes421380 := (<-this.LoadMarkets())
            PanicOnError(retRes421380)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes388417 := (<-this.LoadMarkets())
            PanicOnError(retRes388417)
...
func  (this *bitfinex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes300988 := (<-this.LoadMarkets())
            PanicOnError(retRes300988)
            for i := 0; IsLessThan(i, GetArrayLength(ids)); i++ {
...
func  (this *bitfinex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes848871 := (<-this.LoadMarkets())
            PanicOnError(retRes848871)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes328806 := (<-this.LoadMarkets())
            PanicOnError(retRes328806)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes5884 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes5884)
                    ch <- retRes5884
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes806604 := (<-this.LoadMarkets())
            PanicOnError(retRes806604)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507712 := (<-this.LoadMarkets())
            PanicOnError(retRes507712)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes205022 := (<-this.LoadMarkets())
            PanicOnError(retRes205022)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes15085 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes15085)
                ch <- retRes15085
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes904046 := (<-this.LoadMarkets())
            PanicOnError(retRes904046)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes76255 := (<-this.LoadMarkets())
            PanicOnError(retRes76255)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes541686 := (<-this.LoadMarkets())
            PanicOnError(retRes541686)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes756218 := (<-this.LoadMarkets())
            PanicOnError(retRes756218)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes797263 := (<-this.LoadMarkets())
            PanicOnError(retRes797263)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes177232 := (<-this.LoadMarkets())
            PanicOnError(retRes177232)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes191299 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes191299)
                    ch <- retRes191299
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752303 := (<-this.LoadMarkets())
            PanicOnError(retRes752303)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes977503 := (<-this.LoadMarkets())
            PanicOnError(retRes977503)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes9463 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes9463)
                    ch <- retRes9463
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes329407 := (<-this.LoadMarkets())
            PanicOnError(retRes329407)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes681959 := (<-this.LoadMarkets())
            PanicOnError(retRes681959)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes269072 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes269072)
                    ch <- retRes269072
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes977131 := (<-this.LoadMarkets())
            PanicOnError(retRes977131)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes27931 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes27931)
                    ch <- retRes27931
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes355520 := (<-this.LoadMarkets())
            PanicOnError(retRes355520)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes747892 := (<-this.LoadMarkets())
            PanicOnError(retRes747892)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes396447 := (<-this.LoadMarkets())
            PanicOnError(retRes396447)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
