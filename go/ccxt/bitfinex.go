...
func  (this *bitfinex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277426 := (<-this.LoadMarkets())
            PanicOnError(retRes277426)
...
func  (this *bitfinex) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes91521 := (<-this.LoadMarkets())
            PanicOnError(retRes91521)
            var accountsByType interface{} = this.SafeValue(this.Options, "v2AccountsByType", map[string]interface{} {})
...
func  (this *bitfinex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes149274 := (<-this.LoadMarkets())
            PanicOnError(retRes149274)
...
func  (this *bitfinex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes969122 := (<-this.LoadMarkets())
            PanicOnError(retRes969122)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitfinex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes248005 := (<-this.LoadMarkets())
            PanicOnError(retRes248005)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes179401 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params, 10000))
                    PanicOnError(retRes179401)
                    ch <- retRes179401
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795870 := (<-this.LoadMarkets())
            PanicOnError(retRes795870)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes561899 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 10000))
                    PanicOnError(retRes561899)
                    ch <- retRes561899
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes944839 := (<-this.LoadMarkets())
            PanicOnError(retRes944839)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes165683 := (<-this.LoadMarkets())
            PanicOnError(retRes165683)
            var request interface{} = map[string]interface{} {
                "all": 1,
            }
...
func  (this *bitfinex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes522075 := (<-this.LoadMarkets())
            PanicOnError(retRes522075)
...
func  (this *bitfinex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes89836 := (<-this.LoadMarkets())
            PanicOnError(retRes89836)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes10525 :=  (<-this.FetchPaginatedCallDynamic("fetchClosedOrders", symbol, since, limit, params))
                    PanicOnError(retRes10525)
                    ch <- retRes10525
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bitfinex) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes371035 := (<-this.LoadMarkets())
            PanicOnError(retRes371035)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740698 := (<-this.LoadMarkets())
            PanicOnError(retRes740698)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes412124 := (<-this.LoadMarkets())
            PanicOnError(retRes412124)
            var request interface{} = map[string]interface{} {
                "op_renew": 1,
            }
        
                retRes743779 :=  (<-this.FetchDepositAddress(code, this.Extend(request, params)))
                PanicOnError(retRes743779)
                ch <- retRes743779
                return nil
...
func  (this *bitfinex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes968289 := (<-this.LoadMarkets())
            PanicOnError(retRes968289)
            var currency interface{} = this.Currency(code)
...
func  (this *bitfinex) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes230790 := (<-this.LoadMarkets())
            PanicOnError(retRes230790)
...
func  (this *bitfinex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes217775 := (<-this.LoadMarkets())
            PanicOnError(retRes217775)
            var currency interface{} = this.Currency(code)
            // if not provided explicitly we will try to match using the currency name
            var network interface{} = this.SafeString(params, "network", code)
...
func  (this *bitfinex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77002 := (<-this.LoadMarkets())
            PanicOnError(retRes77002)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes58095 :=  (<-this.FetchPaginatedCallDynamic("fetchLedger", code, since, limit, params, 2500))
                    PanicOnError(retRes58095)
                    ch <- retRes58095
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bitfinex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes121725 := (<-this.LoadMarkets())
            PanicOnError(retRes121725)
...
func  (this *bitfinex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes290850 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes290850)
                    ch <- retRes290850
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchOpenInterests(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes914320 := (<-this.LoadMarkets())
            PanicOnError(retRes914320)
            symbols = this.MarketSymbols(symbols)
...
func  (this *bitfinex) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes648418 := (<-this.LoadMarkets())
            PanicOnError(retRes648418)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitfinex) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes194825 := (<-this.LoadMarkets())
            PanicOnError(retRes194825)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes969950 :=  (<-this.FetchPaginatedCallDeterministic("fetchOpenInterestHistory", symbol, since, limit, "8h", params, 5000))
                    PanicOnError(retRes969950)
                    ch <- retRes969950
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes389879 := (<-this.LoadMarkets())
            PanicOnError(retRes389879)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes195867 :=  (<-this.FetchPaginatedCallDeterministic("fetchLiquidations", symbol, since, limit, "8h", params, 500))
                    PanicOnError(retRes195867)
                    ch <- retRes195867
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) SetMargin(symbol interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes881385 := (<-this.LoadMarkets())
            PanicOnError(retRes881385)
            var market interface{} = this.Market(symbol)
...
func  (this *bitfinex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes561131 := (<-this.LoadMarkets())
            PanicOnError(retRes561131)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
