...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes633006 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes633006)
        ch <- retRes633006
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes679404 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes679404)
        ch <- retRes679404
                return nil
