...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes897718 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes897718)
        ch <- retRes897718
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes723797 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes723797)
        ch <- retRes723797
                return nil
