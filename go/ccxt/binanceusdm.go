...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes485418 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes485418)
        ch <- retRes485418
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes520273 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes520273)
        ch <- retRes520273
                return nil
