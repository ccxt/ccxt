...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes215486 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes215486)
        ch <- retRes215486
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes321851 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes321851)
        ch <- retRes321851
                return nil
