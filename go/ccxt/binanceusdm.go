...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes29676 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes29676)
        ch <- retRes29676
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes342732 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes342732)
        ch <- retRes342732
                return nil
