...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes619987 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes619987)
        ch <- retRes619987
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes134206 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes134206)
        ch <- retRes134206
                return nil
