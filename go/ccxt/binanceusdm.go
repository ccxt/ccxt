...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes767382 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes767382)
        ch <- retRes767382
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes169051 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes169051)
        ch <- retRes169051
                return nil
