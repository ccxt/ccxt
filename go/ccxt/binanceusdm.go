...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes433042 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes433042)
        ch <- retRes433042
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes853603 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes853603)
        ch <- retRes853603
                return nil
