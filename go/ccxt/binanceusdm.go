...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes2304 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes2304)
        ch <- retRes2304
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes526302 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes526302)
        ch <- retRes526302
                return nil
