...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes952572 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes952572)
        ch <- retRes952572
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes511945 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes511945)
        ch <- retRes511945
                return nil
