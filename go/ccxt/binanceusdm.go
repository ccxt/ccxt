...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes999282 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes999282)
        ch <- retRes999282
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes105160 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes105160)
        ch <- retRes105160
                return nil
