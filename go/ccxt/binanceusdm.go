...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes828186 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes828186)
        ch <- retRes828186
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes687063 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes687063)
        ch <- retRes687063
                return nil
