...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes257580 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes257580)
        ch <- retRes257580
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes572805 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes572805)
        ch <- retRes572805
                return nil
