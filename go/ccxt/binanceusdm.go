...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes447656 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes447656)
        ch <- retRes447656
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes29249 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes29249)
        ch <- retRes29249
                return nil
