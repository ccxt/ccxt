...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes341264 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes341264)
        ch <- retRes341264
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes282856 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes282856)
        ch <- retRes282856
                return nil
