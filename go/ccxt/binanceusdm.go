...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes927059 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes927059)
        ch <- retRes927059
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes505581 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes505581)
        ch <- retRes505581
                return nil
