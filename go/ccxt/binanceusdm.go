...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes166361 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes166361)
        ch <- retRes166361
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes562869 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes562869)
        ch <- retRes562869
                return nil
