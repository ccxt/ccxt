...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes613434 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes613434)
        ch <- retRes613434
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes79761 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes79761)
        ch <- retRes79761
                return nil
