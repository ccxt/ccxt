...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes39461 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes39461)
        ch <- retRes39461
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes533386 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes533386)
        ch <- retRes533386
                return nil
