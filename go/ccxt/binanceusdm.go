...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes202623 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes202623)
        ch <- retRes202623
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes81019 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes81019)
        ch <- retRes81019
                return nil
