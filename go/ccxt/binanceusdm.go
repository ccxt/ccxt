...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes676166 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes676166)
        ch <- retRes676166
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes283396 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes283396)
        ch <- retRes283396
                return nil
