...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes439244 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes439244)
        ch <- retRes439244
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes838608 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes838608)
        ch <- retRes838608
                return nil
