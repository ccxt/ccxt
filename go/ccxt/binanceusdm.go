...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes56885 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes56885)
        ch <- retRes56885
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes455554 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes455554)
        ch <- retRes455554
                return nil
