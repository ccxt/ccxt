...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes200089 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes200089)
        ch <- retRes200089
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes698355 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes698355)
        ch <- retRes698355
                return nil
