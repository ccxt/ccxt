...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes384406 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes384406)
        ch <- retRes384406
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes748127 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes748127)
        ch <- retRes748127
                return nil
