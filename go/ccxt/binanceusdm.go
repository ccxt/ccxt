...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes466054 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes466054)
        ch <- retRes466054
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes457621 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes457621)
        ch <- retRes457621
                return nil
