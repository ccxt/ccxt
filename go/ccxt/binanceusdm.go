...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes601005 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes601005)
        ch <- retRes601005
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes561910 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes561910)
        ch <- retRes561910
                return nil
