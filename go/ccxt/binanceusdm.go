...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes264703 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes264703)
        ch <- retRes264703
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes898717 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes898717)
        ch <- retRes898717
                return nil
