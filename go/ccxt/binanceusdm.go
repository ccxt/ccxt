...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes515927 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes515927)
        ch <- retRes515927
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes636642 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes636642)
        ch <- retRes636642
                return nil
