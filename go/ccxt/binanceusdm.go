...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes237063 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes237063)
        ch <- retRes237063
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes274139 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes274139)
        ch <- retRes274139
                return nil
