...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes611878 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes611878)
        ch <- retRes611878
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes109371 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes109371)
        ch <- retRes109371
                return nil
