...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes769816 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes769816)
        ch <- retRes769816
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes449420 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes449420)
        ch <- retRes449420
                return nil
