...
func  (this *binanceusdm) TransferIn(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes926199 :=  (<-this.FuturesTransfer(code, amount, 1, params))
                PanicOnError(retRes926199)
        ch <- retRes926199
                return nil
...
func  (this *binanceusdm) TransferOut(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes268392 :=  (<-this.FuturesTransfer(code, amount, 2, params))
                PanicOnError(retRes268392)
        ch <- retRes268392
                return nil
