...
func  (this *bitmex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes891585 := (<-this.LoadMarkets())
            PanicOnError(retRes891585)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitmex) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes878625 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes878625)
                    ch <- retRes878625
                    return nil
            }
...
func  (this *bitmex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes439625 :=  (<-this.FetchOrders(symbol, since, limit, this.DeepExtend(request, params)))
                PanicOnError(retRes439625)
                ch <- retRes439625
                return nil
...
func  (this *bitmex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes310665 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes310665)
                    ch <- retRes310665
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitmex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168160 := (<-this.LoadMarkets())
            PanicOnError(retRes168160)
            var request interface{} = map[string]interface{} {}
            //
            //     if (since !== undefined) {
...
func  (this *bitmex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes225222 := (<-this.LoadMarkets())
            PanicOnError(retRes225222)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitmex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706946 := (<-this.LoadMarkets())
            PanicOnError(retRes706946)
...
func  (this *bitmex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes782665 := (<-this.LoadMarkets())
            PanicOnError(retRes782665)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes243106 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params))
                    PanicOnError(retRes243106)
                    ch <- retRes243106
                    return nil
            }
...
func  (this *bitmex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes64829 := (<-this.LoadMarkets())
            PanicOnError(retRes64829)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes148244 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes148244)
                    ch <- retRes148244
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitmex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153189 := (<-this.LoadMarkets())
            PanicOnError(retRes153189)
            var market interface{} = this.Market(symbol)
...
func  (this *bitmex) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319940 := (<-this.LoadMarkets())
            PanicOnError(retRes319940)
            var request interface{} = map[string]interface{} {}
            var trailingAmount interface{} = this.SafeString2(params, "trailingAmount", "pegOffsetValue")
            var isTrailingAmountOrder interface{} = !IsEqual(trailingAmount, nil)
            if IsTrue(isTrailingAmountOrder) {
...
func  (this *bitmex) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes629785 := (<-this.LoadMarkets())
            PanicOnError(retRes629785)
...
func  (this *bitmex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes270720 := (<-this.LoadMarkets())
            PanicOnError(retRes270720)
            // https://github.com/ccxt/ccxt/issues/6507
            var clientOrderId interface{} = this.SafeValue2(params, "clOrdID", "clientOrderId")
            var request interface{} = map[string]interface{} {}
            if IsTrue(IsEqual(clientOrderId, nil)) {
...
func  (this *bitmex) FetchLeverages(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes744454 := (<-this.LoadMarkets())
            PanicOnError(retRes744454)
...
func  (this *bitmex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes66722 := (<-this.LoadMarkets())
            PanicOnError(retRes66722)
...
func  (this *bitmex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes416404 := (<-this.LoadMarkets())
            PanicOnError(retRes416404)
...
func  (this *bitmex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes807109 := (<-this.LoadMarkets())
            PanicOnError(retRes807109)
            var market interface{} = this.Market(symbol)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes480535 :=  (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
                PanicOnError(retRes480535)
                ch <- retRes480535
                return nil
...
func  (this *bitmex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes891574 := (<-this.LoadMarkets())
            PanicOnError(retRes891574)
            var market interface{} = this.Market(symbol)
            if IsTrue(IsTrue((!IsEqual(GetValue(market, "type"), "swap"))) && IsTrue((!IsEqual(GetValue(market, "type"), "future")))) {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes652634 :=  (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
                PanicOnError(retRes652634)
                ch <- retRes652634
                return nil
...
func  (this *bitmex) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes653027 := (<-this.LoadMarkets())
            PanicOnError(retRes653027)
            var networkCode interface{} = nil
            networkCodeparamsVariable := this.HandleNetworkCodeAndParams(params);
            networkCode = GetValue(networkCodeparamsVariable,0);
            params = GetValue(networkCodeparamsVariable,1)
...
func  (this *bitmex) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes190282 := (<-this.LoadMarkets())
            PanicOnError(retRes190282)
...
func  (this *bitmex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes790909 := (<-this.LoadMarkets())
            PanicOnError(retRes790909)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes575690 :=  (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
                    PanicOnError(retRes575690)
                    ch <- retRes575690
                    return nil
            }
            var market interface{} = this.Market(symbol)
