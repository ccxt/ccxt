...
func  (this *bitmex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes455111 := (<-this.LoadMarkets())
            PanicOnError(retRes455111)
...
func  (this *bitmex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589144 := (<-this.LoadMarkets())
            PanicOnError(retRes589144)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bitmex) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes1771 := (<-this.LoadMarkets())
            PanicOnError(retRes1771)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes329076 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes329076)
                    ch <- retRes329076
                    return nil
            }
...
func  (this *bitmex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes693404 :=  (<-this.FetchOrders(symbol, since, limit, this.DeepExtend(request, params)))
                PanicOnError(retRes693404)
                ch <- retRes693404
                return nil
...
func  (this *bitmex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes13990 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes13990)
                    ch <- retRes13990
                    return nil
            }
            var market interface{} = nil
...
func  (this *bitmex) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes848752 := (<-this.LoadMarkets())
            PanicOnError(retRes848752)
            var request interface{} = map[string]interface{} {}
            //
            //     if (since !== undefined) {
...
func  (this *bitmex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes536923 := (<-this.LoadMarkets())
            PanicOnError(retRes536923)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bitmex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291638 := (<-this.LoadMarkets())
            PanicOnError(retRes291638)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes145602 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params))
                    PanicOnError(retRes145602)
                    ch <- retRes145602
                    return nil
            }
...
func  (this *bitmex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes738035 := (<-this.LoadMarkets())
            PanicOnError(retRes738035)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes666185 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes666185)
                    ch <- retRes666185
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitmex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes565907 := (<-this.LoadMarkets())
            PanicOnError(retRes565907)
            var market interface{} = this.Market(symbol)
...
func  (this *bitmex) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525323 := (<-this.LoadMarkets())
            PanicOnError(retRes525323)
            // https://github.com/ccxt/ccxt/issues/6507
            var clientOrderId interface{} = this.SafeValue2(params, "clOrdID", "clientOrderId")
            var request interface{} = map[string]interface{} {}
            if IsTrue(IsEqual(clientOrderId, nil)) {
...
func  (this *bitmex) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes540417 := (<-this.LoadMarkets())
            PanicOnError(retRes540417)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitmex) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes585953 := (<-this.LoadMarkets())
            PanicOnError(retRes585953)
            var request interface{} = map[string]interface{} {
...
func  (this *bitmex) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141699 := (<-this.LoadMarkets())
            PanicOnError(retRes141699)
...
func  (this *bitmex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes268776 := (<-this.LoadMarkets())
            PanicOnError(retRes268776)
            var currency interface{} = this.Currency(code)
...
func  (this *bitmex) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes526122 := (<-this.LoadMarkets())
            PanicOnError(retRes526122)
...
func  (this *bitmex) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes227338 := (<-this.LoadMarkets())
            PanicOnError(retRes227338)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
...
func  (this *bitmex) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes786610 := (<-this.LoadMarkets())
            PanicOnError(retRes786610)
            var market interface{} = this.Market(symbol)
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes722140 :=  (<-this.PrivatePostPositionLeverage(this.Extend(request, params)))
                PanicOnError(retRes722140)
                ch <- retRes722140
                return nil
...
func  (this *bitmex) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes944122 := (<-this.LoadMarkets())
            PanicOnError(retRes944122)
            var market interface{} = this.Market(symbol)
            if IsTrue(IsTrue((!IsEqual(GetValue(market, "type"), "swap"))) && IsTrue((!IsEqual(GetValue(market, "type"), "future")))) {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes592360 :=  (<-this.PrivatePostPositionIsolate(this.Extend(request, params)))
...
func  (this *bitmex) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes523952 := (<-this.LoadMarkets())
            PanicOnError(retRes523952)
...
func  (this *bitmex) FetchLiquidations(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603653 := (<-this.LoadMarkets())
            PanicOnError(retRes603653)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes934530 :=  (<-this.FetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, params))
