...
func  (this *idex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes3204 := (<-this.LoadMarkets())
            PanicOnError(retRes3204)
            var market interface{} = this.Market(symbol)
...
func  (this *idex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes504728 := (<-this.LoadMarkets())
            PanicOnError(retRes504728)
            // [
            //   {
            //     "market": "DIL-ETH",
            //     "time": 1598367493008,
...
func  (this *idex) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes286743 := (<-this.LoadMarkets())
            PanicOnError(retRes286743)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
                "interval": timeframe,
...
func  (this *idex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703192 := (<-this.LoadMarkets())
            PanicOnError(retRes703192)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *idex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes502818 := (<-this.LoadMarkets())
            PanicOnError(retRes502818)
...
func  (this *idex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes108875 := (<-this.LoadMarkets())
            PanicOnError(retRes108875)
            ...
            {		ret__ := func(this *idex) (ret_ interface{}) {
            		defer func() {
                        ...
                        retRes674679 := (<-this.AssociateWallet(walletAddress))
                        PanicOnError(retRes674679)
...
func  (this *idex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            {		ret__ := func(this *idex) (ret_ interface{}) {
            		defer func() {
                        ...
                        retRes334444 := (<-this.AssociateWallet(walletAddress))
                        PanicOnError(retRes334444)
...
func  (this *idex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes424729 :=  (<-this.FetchOrdersHelper(symbol, nil, nil, this.Extend(request, params)))
                PanicOnError(retRes424729)
                ch <- retRes424729
                return nil
...
func  (this *idex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes225650 :=  (<-this.FetchOrdersHelper(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes225650)
                ch <- retRes225650
                return nil
...
func  (this *idex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes393990 :=  (<-this.FetchOrdersHelper(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes393990)
                ch <- retRes393990
                return nil
...
func  (this *idex) FetchOrdersHelper(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes9291 := (<-this.LoadMarkets())
            PanicOnError(retRes9291)
            var request interface{} = map[string]interface{} {
                "nonce": this.Uuidv1(),
                "wallet": this.WalletAddress,
            }
...
func  (this *idex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes567772 := (<-this.LoadMarkets())
            PanicOnError(retRes567772)
...
func  (this *idex) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes834228 := (<-this.LoadMarkets())
            PanicOnError(retRes834228)
            var nonce interface{} = this.Uuidv1()
...
func  (this *idex) FetchDeposit(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes143590 := (<-this.LoadMarkets())
            PanicOnError(retRes143590)
            var nonce interface{} = this.Uuidv1()
            var request interface{} = map[string]interface{} {
                "nonce": nonce,
                "wallet": this.WalletAddress,
...
func  (this *idex) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Extend(map[string]interface{} {
                ...
                retRes962425 :=  (<-this.FetchTransactionsHelper(code, since, limit, params))
                PanicOnError(retRes962425)
                ch <- retRes962425
                return nil
...
func  (this *idex) FetchWithdrawal(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes262828 := (<-this.LoadMarkets())
            PanicOnError(retRes262828)
            var nonce interface{} = this.Uuidv1()
            var request interface{} = map[string]interface{} {
                "nonce": nonce,
                "wallet": this.WalletAddress,
...
func  (this *idex) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Extend(map[string]interface{} {
                ...
                retRes515800 :=  (<-this.FetchTransactionsHelper(code, since, limit, params))
                PanicOnError(retRes515800)
                ch <- retRes515800
                return nil
...
func  (this *idex) FetchTransactionsHelper(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes543860 := (<-this.LoadMarkets())
            PanicOnError(retRes543860)
            var nonce interface{} = this.Uuidv1()
            var request interface{} = map[string]interface{} {
                "nonce": nonce,
                "wallet": this.WalletAddress,
