...
func  (this *idex) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes430299 := (<-this.LoadMarkets())
            PanicOnError(retRes430299)
            var market interface{} = this.Market(symbol)
...
func  (this *idex) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes925320 := (<-this.LoadMarkets())
            PanicOnError(retRes925320)
            // [
            //   {
            //     "market": "DIL-ETH",
            //     "time": 1598367493008,
...
func  (this *idex) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes30562 := (<-this.LoadMarkets())
            PanicOnError(retRes30562)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *idex) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes636196 := (<-this.LoadMarkets())
            PanicOnError(retRes636196)
...
func  (this *idex) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes633925 := (<-this.LoadMarkets())
            PanicOnError(retRes633925)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
                "level": 2,
...
func  (this *idex) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes401557 := (<-this.LoadMarkets())
            PanicOnError(retRes401557)
            ...
            {		ret__ := func(this *idex) (ret_ interface{}) {
            		defer func() {
                        ...
                        retRes500187 := (<-this.AssociateWallet(walletAddress))
                        PanicOnError(retRes500187)
...
func  (this *idex) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes66744 := (<-this.LoadMarkets())
            PanicOnError(retRes66744)
            ...
            {		ret__ := func(this *idex) (ret_ interface{}) {
            		defer func() {
                        ...
                        retRes219857 := (<-this.AssociateWallet(walletAddress))
...
func  (this *idex) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes562773 :=  (<-this.FetchOrdersHelper(symbol, nil, nil, this.Extend(request, params)))
                PanicOnError(retRes562773)
                ch <- retRes562773
                return nil
...
func  (this *idex) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes717710 :=  (<-this.FetchOrdersHelper(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes717710)
                ch <- retRes717710
                return nil
...
func  (this *idex) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes959529 :=  (<-this.FetchOrdersHelper(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes959529)
                ch <- retRes959529
                return nil
...
func  (this *idex) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes233869 := (<-this.LoadMarkets())
            PanicOnError(retRes233869)
...
func  (this *idex) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Extend(map[string]interface{} {
                ...
                retRes193178 :=  (<-this.FetchTransactionsHelper(code, since, limit, params))
                PanicOnError(retRes193178)
                ch <- retRes193178
                return nil
...
func  (this *idex) FetchWithdrawal(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes298967 := (<-this.LoadMarkets())
            PanicOnError(retRes298967)
            var nonce interface{} = this.Uuidv1()
            var request interface{} = map[string]interface{} {
                "nonce": nonce,
                "wallet": this.WalletAddress,
...
func  (this *idex) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Extend(map[string]interface{} {
                ...
                retRes638772 :=  (<-this.FetchTransactionsHelper(code, since, limit, params))
                PanicOnError(retRes638772)
                ch <- retRes638772
                return nil
...
func  (this *idex) FetchTransactionsHelper(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954473 := (<-this.LoadMarkets())
            PanicOnError(retRes954473)
            var nonce interface{} = this.Uuidv1()
            var request interface{} = map[string]interface{} {
                "nonce": nonce,
                "wallet": this.WalletAddress,
