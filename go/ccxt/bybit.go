...
func  (this *bybit) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes575073 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
                PanicOnError(retRes575073)
                ch <- retRes575073
                return nil
...
func  (this *bybit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes781213 := (<-this.LoadTimeDifference())
...
func  (this *bybit) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes363761 := (<-this.LoadMarkets())
            PanicOnError(retRes363761)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637195 := (<-this.LoadMarkets())
            PanicOnError(retRes637195)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes95571 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes95571)
                    ch <- retRes95571
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes453071 := (<-this.LoadMarkets())
            PanicOnError(retRes453071)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *bybit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes284613 := (<-this.LoadMarkets())
            PanicOnError(retRes284613)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes721364 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
                    PanicOnError(retRes721364)
                    ch <- retRes721364
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *bybit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes647570 := (<-this.LoadMarkets())
            PanicOnError(retRes647570)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes873456 := (<-this.LoadMarkets())
            PanicOnError(retRes873456)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes423837 := (<-this.LoadMarkets())
            PanicOnError(retRes423837)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes801892 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
...
func  (this *bybit) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes737368 := (<-this.LoadMarkets())
            PanicOnError(retRes737368)
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes855780 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes855780)
                ch <- retRes855780
                return nil
...
func  (this *bybit) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes483000 := (<-this.LoadMarkets())
            PanicOnError(retRes483000)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740703 := (<-this.LoadMarkets())
            PanicOnError(retRes740703)
...
func  (this *bybit) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98876 := (<-this.LoadMarkets())
            PanicOnError(retRes98876)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes13670 := (<-this.LoadMarkets())
            PanicOnError(retRes13670)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes676002 := (<-this.LoadMarkets())
            PanicOnError(retRes676002)
...
func  (this *bybit) FetchOrderClassic(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes785122 := (<-this.LoadMarkets())
            PanicOnError(retRes785122)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *bybit) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes579606 := (<-this.LoadMarkets())
            PanicOnError(retRes579606)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes483470 :=  (<-this.FetchOrderClassic(id, symbol, params))
                    PanicOnError(retRes483470)
                    ch <- retRes483470
                    return nil
            }
...
func  (this *bybit) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes75749 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
...
func  (this *bybit) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes431568 := (<-this.LoadMarkets())
            PanicOnError(retRes431568)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes725511 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes824755 := (<-this.LoadMarkets())
            PanicOnError(retRes824755)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858516 := (<-this.LoadMarkets())
            PanicOnError(retRes858516)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes937437 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes938800 := (<-this.LoadMarkets())
            PanicOnError(retRes938800)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Filled",
            }
        
                retRes12433 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *bybit) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes129054 := (<-this.LoadMarkets())
            PanicOnError(retRes129054)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes775291 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *bybit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525964 := (<-this.LoadMarkets())
            PanicOnError(retRes525964)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes681922 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes681922)
                    ch <- retRes681922
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes187807 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes187807)
                ch <- retRes187807
                return nil
...
func  (this *bybit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835176 := (<-this.LoadMarkets())
            PanicOnError(retRes835176)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes83103 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes83103)
                    ch <- retRes83103
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes184921 := (<-this.LoadMarkets())
            PanicOnError(retRes184921)
...
func  (this *bybit) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes113316 := (<-this.LoadMarkets())
            PanicOnError(retRes113316)
            var currency interface{} = this.Currency(code)
...
func  (this *bybit) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes504622 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes504622)
                    ch <- retRes504622
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes15521 := (<-this.LoadMarkets())
            PanicOnError(retRes15521)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes334366 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes334366)
                    ch <- retRes334366
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168059 := (<-this.LoadMarkets())
            PanicOnError(retRes168059)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes164098 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes871450 := (<-this.LoadMarkets())
            PanicOnError(retRes871450)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes852452 := (<-this.LoadMarkets())
            PanicOnError(retRes852452)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes16089 := (<-this.LoadMarkets())
            PanicOnError(retRes16089)
...
func  (this *bybit) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes505513 := (<-this.LoadMarkets())
            PanicOnError(retRes505513)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes775579 := (<-this.LoadMarkets())
            PanicOnError(retRes775579)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes939738 := (<-this.LoadMarkets())
            PanicOnError(retRes939738)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes994761 := (<-this.LoadMarkets())
            PanicOnError(retRes994761)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *bybit) FetchDerivativesOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes823139 := (<-this.LoadMarkets())
            PanicOnError(retRes823139)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes794704 := (<-this.LoadMarkets())
            PanicOnError(retRes794704)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes901784 := (<-this.LoadMarkets())
            PanicOnError(retRes901784)
            var paginate interface{} = this.SafeBool(params, "paginate")
            if IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                AddElementToObject(params, "timeframe", timeframe)
        
                    retRes360567 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes360567)
                    ch <- retRes360567
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes36254 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func  (this *bybit) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes86551 := (<-this.LoadMarkets())
            PanicOnError(retRes86551)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bybit) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes619286 := (<-this.LoadMarkets())
            PanicOnError(retRes619286)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes193461 := (<-this.LoadMarkets())
            PanicOnError(retRes193461)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes528869 := (<-this.LoadMarkets())
            PanicOnError(retRes528869)
...
func  (this *bybit) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes473474 := (<-this.LoadMarkets())
            PanicOnError(retRes473474)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes125007 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes125007)
                    ch <- retRes125007
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bybit) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes824310 := (<-this.LoadMarkets())
            PanicOnError(retRes824310)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614308 := (<-this.LoadMarkets())
            PanicOnError(retRes614308)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes864072 := (<-this.LoadMarkets())
            PanicOnError(retRes864072)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            market = this.Market(symbol)
            if IsTrue(IsTrue(GetValue(market, "spot")) || IsTrue(GetValue(market, "option"))) {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes669467 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
                PanicOnError(retRes669467)
                ch <- retRes669467
                return nil
...
func  (this *bybit) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes32524 := (<-this.LoadMarkets())
            PanicOnError(retRes32524)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes946441 := (<-this.LoadMarkets())
            PanicOnError(retRes946441)
...
func  (this *bybit) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes339162 := (<-this.LoadMarkets())
            PanicOnError(retRes339162)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes755523 := (<-this.LoadMarkets())
            PanicOnError(retRes755523)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes41531 := (<-this.LoadMarkets())
            PanicOnError(retRes41531)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "category": "option",
...
func  (this *bybit) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes377865 := (<-this.LoadMarkets())
            PanicOnError(retRes377865)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes217549 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes217549)
                    ch <- retRes217549
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes114236 := (<-this.LoadMarkets())
            PanicOnError(retRes114236)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if IsTrue(paginate) {
                    ...
                    retRes489483 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *bybit) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes511894 := (<-this.LoadMarkets())
            PanicOnError(retRes511894)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes651981 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes651981)
                    ch <- retRes651981
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOption(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes95046 := (<-this.LoadMarkets())
            PanicOnError(retRes95046)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "symbol": GetValue(market, "id"),
...
func  (this *bybit) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes939986 := (<-this.LoadMarkets())
            PanicOnError(retRes939986)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "baseCoin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes318919 := (<-this.LoadMarkets())
            PanicOnError(retRes318919)
            var market interface{} = nil
            var subType interface{} = nil
...
func  (this *bybit) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes429148 := (<-this.LoadMarkets())
            PanicOnError(retRes429148)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes226969 := (<-this.LoadMarkets())
            PanicOnError(retRes226969)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes463187 := (<-this.LoadMarkets())
            PanicOnError(retRes463187)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *bybit) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes425474 := (<-this.LoadMarkets())
            PanicOnError(retRes425474)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes862711 := (<-this.LoadMarkets())
            PanicOnError(retRes862711)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", limit)
            }
...
func  (this *bybit) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes884026 := (<-this.LoadMarkets())
            PanicOnError(retRes884026)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
