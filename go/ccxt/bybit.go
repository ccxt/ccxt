...
func  (this *bybit) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes18591 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
                PanicOnError(retRes18591)
                ch <- retRes18591
                return nil
...
func  (this *bybit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes975352 := (<-this.LoadTimeDifference())
                PanicOnError(retRes975352)
            }
...
func  (this *bybit) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes524559 := (<-this.LoadMarkets())
            PanicOnError(retRes524559)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes78009 := (<-this.LoadMarkets())
            PanicOnError(retRes78009)
...
func  (this *bybit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes351338 := (<-this.LoadMarkets())
            PanicOnError(retRes351338)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes310449 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes310449)
                    ch <- retRes310449
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes209239 := (<-this.LoadMarkets())
            PanicOnError(retRes209239)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *bybit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes876626 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
                    PanicOnError(retRes876626)
                    ch <- retRes876626
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *bybit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes403671 := (<-this.LoadMarkets())
            PanicOnError(retRes403671)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes732977 := (<-this.LoadMarkets())
            PanicOnError(retRes732977)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes969471 := (<-this.LoadMarkets())
            PanicOnError(retRes969471)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes945139 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes945139)
                ch <- retRes945139
                return nil
...
func  (this *bybit) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes416825 := (<-this.LoadMarkets())
            PanicOnError(retRes416825)
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes894061 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes894061)
                ch <- retRes894061
                return nil
...
func  (this *bybit) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes884886 := (<-this.LoadMarkets())
            PanicOnError(retRes884886)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes770694 := (<-this.LoadMarkets())
            PanicOnError(retRes770694)
...
func  (this *bybit) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes368088 := (<-this.LoadMarkets())
            PanicOnError(retRes368088)
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *bybit) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes500900 := (<-this.LoadMarkets())
            PanicOnError(retRes500900)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes530129 := (<-this.LoadMarkets())
            PanicOnError(retRes530129)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes364154 := (<-this.LoadMarkets())
            PanicOnError(retRes364154)
...
func  (this *bybit) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes347400 := (<-this.LoadMarkets())
            PanicOnError(retRes347400)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) FetchOrderClassic(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes755150 := (<-this.LoadMarkets())
            PanicOnError(retRes755150)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *bybit) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes706362 := (<-this.LoadMarkets())
            PanicOnError(retRes706362)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes219481 :=  (<-this.FetchOrderClassic(id, symbol, params))
                    PanicOnError(retRes219481)
                    ch <- retRes219481
                    return nil
            }
...
func  (this *bybit) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes216025 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
                PanicOnError(retRes216025)
                ch <- retRes216025
                return nil
...
func  (this *bybit) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes2901 := (<-this.LoadMarkets())
            PanicOnError(retRes2901)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes369790 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes369790)
                    ch <- retRes369790
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes989097 := (<-this.LoadMarkets())
            PanicOnError(retRes989097)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes707339 := (<-this.LoadMarkets())
            PanicOnError(retRes707339)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929403 := (<-this.LoadMarkets())
            PanicOnError(retRes929403)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes496484 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes496484)
                    ch <- retRes496484
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes528347 := (<-this.LoadMarkets())
            PanicOnError(retRes528347)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Filled",
            }
        
                retRes191468 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes191468)
                ch <- retRes191468
                return nil
...
func  (this *bybit) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes963915 := (<-this.LoadMarkets())
            PanicOnError(retRes963915)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes539407 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes539407)
                ch <- retRes539407
                return nil
...
func  (this *bybit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes312201 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes312201)
                    ch <- retRes312201
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes804796 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes804796)
                ch <- retRes804796
                return nil
...
func  (this *bybit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes671693 := (<-this.LoadMarkets())
            PanicOnError(retRes671693)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes967411 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes967411)
                    ch <- retRes967411
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes563626 := (<-this.LoadMarkets())
            PanicOnError(retRes563626)
            var currency interface{} = this.Currency(code)
...
func  (this *bybit) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes116667 := (<-this.LoadMarkets())
            PanicOnError(retRes116667)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes853997 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes853997)
                    ch <- retRes853997
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes201603 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes201603)
                    ch <- retRes201603
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes730195 := (<-this.LoadMarkets())
            PanicOnError(retRes730195)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes258357 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980106 := (<-this.LoadMarkets())
            PanicOnError(retRes980106)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes453814 := (<-this.LoadMarkets())
            PanicOnError(retRes453814)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes584372 := (<-this.LoadMarkets())
            PanicOnError(retRes584372)
...
func  (this *bybit) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes663105 := (<-this.LoadMarkets())
            PanicOnError(retRes663105)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes907810 := (<-this.LoadMarkets())
            PanicOnError(retRes907810)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes579892 := (<-this.LoadMarkets())
            PanicOnError(retRes579892)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792543 := (<-this.LoadMarkets())
            PanicOnError(retRes792543)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *bybit) FetchDerivativesOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes166603 := (<-this.LoadMarkets())
            PanicOnError(retRes166603)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes723629 := (<-this.LoadMarkets())
            PanicOnError(retRes723629)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes419118 := (<-this.LoadMarkets())
            PanicOnError(retRes419118)
            var paginate interface{} = this.SafeBool(params, "paginate")
            if IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                AddElementToObject(params, "timeframe", timeframe)
        
                    retRes910140 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes910140)
                    ch <- retRes910140
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes963245 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
                PanicOnError(retRes963245)
                ch <- retRes963245
                return nil
...
func  (this *bybit) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes710412 := (<-this.LoadMarkets())
            PanicOnError(retRes710412)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bybit) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406706 := (<-this.LoadMarkets())
            PanicOnError(retRes406706)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes173673 := (<-this.LoadMarkets())
            PanicOnError(retRes173673)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes730022 := (<-this.LoadMarkets())
            PanicOnError(retRes730022)
...
func  (this *bybit) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes541110 := (<-this.LoadMarkets())
            PanicOnError(retRes541110)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes972466 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes972466)
                    ch <- retRes972466
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bybit) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875635 := (<-this.LoadMarkets())
            PanicOnError(retRes875635)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes804314 := (<-this.LoadMarkets())
            PanicOnError(retRes804314)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchDerivativesMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes182122 := (<-this.LoadMarkets())
            PanicOnError(retRes182122)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes176078 := (<-this.LoadMarkets())
            PanicOnError(retRes176078)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            market = this.Market(symbol)
            if IsTrue(IsTrue(GetValue(market, "spot")) || IsTrue(GetValue(market, "option"))) {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes231333 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
                PanicOnError(retRes231333)
                ch <- retRes231333
                return nil
...
func  (this *bybit) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153644 := (<-this.LoadMarkets())
            PanicOnError(retRes153644)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes398250 := (<-this.LoadMarkets())
            PanicOnError(retRes398250)
...
func  (this *bybit) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes62284 := (<-this.LoadMarkets())
            PanicOnError(retRes62284)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes772193 := (<-this.LoadMarkets())
            PanicOnError(retRes772193)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchVolatilityHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes808287 := (<-this.LoadMarkets())
            PanicOnError(retRes808287)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
...
func  (this *bybit) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes791975 := (<-this.LoadMarkets())
            PanicOnError(retRes791975)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "category": "option",
...
func  (this *bybit) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes926488 := (<-this.LoadMarkets())
            PanicOnError(retRes926488)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes42662 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes42662)
                    ch <- retRes42662
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507075 := (<-this.LoadMarkets())
            PanicOnError(retRes507075)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if IsTrue(paginate) {
                    ...
                    retRes534100 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes534100)
                    ch <- retRes534100
                    return nil
            }
            var subType interface{} = nil
...
func  (this *bybit) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes478085 := (<-this.LoadMarkets())
            PanicOnError(retRes478085)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes946608 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes946608)
                    ch <- retRes946608
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909924 := (<-this.LoadMarkets())
            PanicOnError(retRes909924)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "baseCoin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes216428 := (<-this.LoadMarkets())
            PanicOnError(retRes216428)
            var market interface{} = nil
            var subType interface{} = nil
...
func  (this *bybit) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes429690 := (<-this.LoadMarkets())
            PanicOnError(retRes429690)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *bybit) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes879077 := (<-this.LoadMarkets())
            PanicOnError(retRes879077)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes532926 := (<-this.LoadMarkets())
            PanicOnError(retRes532926)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", limit)
            }
...
func  (this *bybit) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes609310 := (<-this.LoadMarkets())
            PanicOnError(retRes609310)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
