...
func  (this *bybit) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes154998 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
...
func  (this *bybit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes139170 := (<-this.LoadTimeDifference())
                PanicOnError(retRes139170)
            }
...
func  (this *bybit) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes597479 := (<-this.LoadMarkets())
            PanicOnError(retRes597479)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes772288 := (<-this.LoadMarkets())
            PanicOnError(retRes772288)
...
func  (this *bybit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes314701 := (<-this.LoadMarkets())
            PanicOnError(retRes314701)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes637167 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
...
func  (this *bybit) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes308771 := (<-this.LoadMarkets())
            PanicOnError(retRes308771)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *bybit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes621483 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
                    PanicOnError(retRes621483)
                    ch <- retRes621483
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *bybit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes584231 := (<-this.LoadMarkets())
            PanicOnError(retRes584231)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes153556 := (<-this.LoadMarkets())
            PanicOnError(retRes153556)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes370634 := (<-this.LoadMarkets())
            PanicOnError(retRes370634)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes932395 := (<-this.LoadMarkets())
            PanicOnError(retRes932395)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes595389 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
...
func  (this *bybit) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes51116 := (<-this.LoadMarkets())
            PanicOnError(retRes51116)
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes705674 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes705674)
                ch <- retRes705674
                return nil
...
func  (this *bybit) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes983537 := (<-this.LoadMarkets())
            PanicOnError(retRes983537)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes727931 := (<-this.LoadMarkets())
            PanicOnError(retRes727931)
...
func  (this *bybit) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes135645 := (<-this.LoadMarkets())
            PanicOnError(retRes135645)
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *bybit) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112384 := (<-this.LoadMarkets())
            PanicOnError(retRes112384)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes213575 := (<-this.LoadMarkets())
            PanicOnError(retRes213575)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes588785 := (<-this.LoadMarkets())
            PanicOnError(retRes588785)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859773 := (<-this.LoadMarkets())
            PanicOnError(retRes859773)
...
func  (this *bybit) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes844737 := (<-this.LoadMarkets())
            PanicOnError(retRes844737)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) FetchOrderClassic(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109373 := (<-this.LoadMarkets())
            PanicOnError(retRes109373)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *bybit) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes381944 := (<-this.LoadMarkets())
            PanicOnError(retRes381944)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes982935 :=  (<-this.FetchOrderClassic(id, symbol, params))
                    PanicOnError(retRes982935)
                    ch <- retRes982935
                    return nil
            }
...
func  (this *bybit) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes72238 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
...
func  (this *bybit) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes191958 := (<-this.LoadMarkets())
            PanicOnError(retRes191958)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes535472 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes535472)
                    ch <- retRes535472
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes126266 := (<-this.LoadMarkets())
            PanicOnError(retRes126266)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes686726 := (<-this.LoadMarkets())
            PanicOnError(retRes686726)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes357757 := (<-this.LoadMarkets())
            PanicOnError(retRes357757)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes533512 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes533512)
                    ch <- retRes533512
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes400373 := (<-this.LoadMarkets())
            PanicOnError(retRes400373)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Filled",
            }
        
                retRes660766 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes660766)
                ch <- retRes660766
                return nil
...
func  (this *bybit) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes674282 := (<-this.LoadMarkets())
            PanicOnError(retRes674282)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes150368 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *bybit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621304 := (<-this.LoadMarkets())
            PanicOnError(retRes621304)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes458680 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes458680)
                    ch <- retRes458680
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes47609 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes47609)
                ch <- retRes47609
                return nil
...
func  (this *bybit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes953738 := (<-this.LoadMarkets())
            PanicOnError(retRes953738)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes310909 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes310909)
                    ch <- retRes310909
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes930954 := (<-this.LoadMarkets())
            PanicOnError(retRes930954)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes825624 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes492981 := (<-this.LoadMarkets())
            PanicOnError(retRes492981)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes709132 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes709132)
                    ch <- retRes709132
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes456494 := (<-this.LoadMarkets())
            PanicOnError(retRes456494)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes672693 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes672693)
                    ch <- retRes672693
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes957926 := (<-this.LoadMarkets())
            PanicOnError(retRes957926)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes965632 := (<-this.LoadMarkets())
            PanicOnError(retRes965632)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes348714 := (<-this.LoadMarkets())
            PanicOnError(retRes348714)
...
func  (this *bybit) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes177641 := (<-this.LoadMarkets())
            PanicOnError(retRes177641)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes382702 := (<-this.LoadMarkets())
            PanicOnError(retRes382702)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes617832 := (<-this.LoadMarkets())
            PanicOnError(retRes617832)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes796605 := (<-this.LoadMarkets())
            PanicOnError(retRes796605)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes8501 := (<-this.LoadMarkets())
            PanicOnError(retRes8501)
            var paginate interface{} = this.SafeBool(params, "paginate")
            if IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                AddElementToObject(params, "timeframe", timeframe)
        
                    retRes438131 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes438131)
                    ch <- retRes438131
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes422874 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
                PanicOnError(retRes422874)
                ch <- retRes422874
                return nil
...
func  (this *bybit) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687440 := (<-this.LoadMarkets())
            PanicOnError(retRes687440)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bybit) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903809 := (<-this.LoadMarkets())
            PanicOnError(retRes903809)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes147102 := (<-this.LoadMarkets())
            PanicOnError(retRes147102)
...
func  (this *bybit) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes512332 := (<-this.LoadMarkets())
            PanicOnError(retRes512332)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes719532 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes719532)
                    ch <- retRes719532
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bybit) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes579094 := (<-this.LoadMarkets())
            PanicOnError(retRes579094)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291233 := (<-this.LoadMarkets())
            PanicOnError(retRes291233)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes800207 := (<-this.LoadMarkets())
            PanicOnError(retRes800207)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            market = this.Market(symbol)
            if IsTrue(IsTrue(GetValue(market, "spot")) || IsTrue(GetValue(market, "option"))) {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes919347 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
                PanicOnError(retRes919347)
                ch <- retRes919347
                return nil
...
func  (this *bybit) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes5280 := (<-this.LoadMarkets())
            PanicOnError(retRes5280)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603691 := (<-this.LoadMarkets())
            PanicOnError(retRes603691)
            var typeVar interface{} = nil
...
func  (this *bybit) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes550166 := (<-this.LoadMarkets())
            PanicOnError(retRes550166)
...
func  (this *bybit) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes980067 := (<-this.LoadMarkets())
            PanicOnError(retRes980067)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes73743 := (<-this.LoadMarkets())
            PanicOnError(retRes73743)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchVolatilityHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes827117 := (<-this.LoadMarkets())
            PanicOnError(retRes827117)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
...
func  (this *bybit) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes729516 := (<-this.LoadMarkets())
            PanicOnError(retRes729516)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes947164 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes947164)
                    ch <- retRes947164
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes618657 := (<-this.LoadMarkets())
            PanicOnError(retRes618657)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if IsTrue(paginate) {
                    ...
                    retRes403646 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes403646)
                    ch <- retRes403646
                    return nil
            }
            var subType interface{} = nil
...
func  (this *bybit) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes318539 := (<-this.LoadMarkets())
            PanicOnError(retRes318539)
            var market interface{} = nil
            var symbol interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                market = this.Market(GetValue(symbols, 0))
...
func  (this *bybit) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes42684 := (<-this.LoadMarkets())
            PanicOnError(retRes42684)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes599739 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes599739)
                    ch <- retRes599739
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291432 := (<-this.LoadMarkets())
            PanicOnError(retRes291432)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "baseCoin": GetValue(currency, "id"),
...
func  (this *bybit) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes174205 := (<-this.LoadMarkets())
            PanicOnError(retRes174205)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes700590 := (<-this.LoadMarkets())
            PanicOnError(retRes700590)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes268072 := (<-this.LoadMarkets())
            PanicOnError(retRes268072)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *bybit) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes643649 := (<-this.LoadMarkets())
            PanicOnError(retRes643649)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes921075 := (<-this.LoadMarkets())
            PanicOnError(retRes921075)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", limit)
            }
...
func  (this *bybit) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470230 := (<-this.LoadMarkets())
            PanicOnError(retRes470230)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
