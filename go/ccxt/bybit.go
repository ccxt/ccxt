...
func  (this *bybit) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes412768 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
                PanicOnError(retRes412768)
                ch <- retRes412768
                return nil
...
func  (this *bybit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes707068 := (<-this.LoadTimeDifference())
                PanicOnError(retRes707068)
            }
...
func  (this *bybit) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes137572 := (<-this.LoadMarkets())
            PanicOnError(retRes137572)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes791658 := (<-this.LoadMarkets())
            PanicOnError(retRes791658)
...
func  (this *bybit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes534799 := (<-this.LoadMarkets())
            PanicOnError(retRes534799)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes168835 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes168835)
                    ch <- retRes168835
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes654158 := (<-this.LoadMarkets())
            PanicOnError(retRes654158)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *bybit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes891120 := (<-this.LoadMarkets())
            PanicOnError(retRes891120)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes297762 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
                    PanicOnError(retRes297762)
                    ch <- retRes297762
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *bybit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes34293 := (<-this.LoadMarkets())
            PanicOnError(retRes34293)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes119483 := (<-this.LoadMarkets())
            PanicOnError(retRes119483)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854962 := (<-this.LoadMarkets())
            PanicOnError(retRes854962)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes417270 := (<-this.LoadMarkets())
            PanicOnError(retRes417270)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes30150 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes30150)
                ch <- retRes30150
                return nil
...
func  (this *bybit) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486547 := (<-this.LoadMarkets())
            PanicOnError(retRes486547)
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes995080 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
...
func  (this *bybit) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes87350 := (<-this.LoadMarkets())
            PanicOnError(retRes87350)
...
func  (this *bybit) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes592309 := (<-this.LoadMarkets())
            PanicOnError(retRes592309)
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *bybit) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes336345 := (<-this.LoadMarkets())
            PanicOnError(retRes336345)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes880365 := (<-this.LoadMarkets())
            PanicOnError(retRes880365)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes761501 := (<-this.LoadMarkets())
            PanicOnError(retRes761501)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes880733 := (<-this.LoadMarkets())
            PanicOnError(retRes880733)
...
func  (this *bybit) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes172451 := (<-this.LoadMarkets())
            PanicOnError(retRes172451)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) FetchOrderClassic(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes311695 := (<-this.LoadMarkets())
            PanicOnError(retRes311695)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *bybit) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297853 := (<-this.LoadMarkets())
            PanicOnError(retRes297853)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes205620 :=  (<-this.FetchOrderClassic(id, symbol, params))
                    PanicOnError(retRes205620)
                    ch <- retRes205620
                    return nil
            }
...
func  (this *bybit) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes217723 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
                PanicOnError(retRes217723)
                ch <- retRes217723
                return nil
...
func  (this *bybit) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes387781 := (<-this.LoadMarkets())
            PanicOnError(retRes387781)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes568173 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes568173)
                    ch <- retRes568173
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes931696 := (<-this.LoadMarkets())
            PanicOnError(retRes931696)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes675715 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes904316 := (<-this.LoadMarkets())
            PanicOnError(retRes904316)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Filled",
            }
        
                retRes110936 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes110936)
                ch <- retRes110936
                return nil
...
func  (this *bybit) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696550 := (<-this.LoadMarkets())
            PanicOnError(retRes696550)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes722702 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes722702)
                ch <- retRes722702
                return nil
...
func  (this *bybit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes412934 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes412934)
                    ch <- retRes412934
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes177147 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes177147)
                ch <- retRes177147
                return nil
...
func  (this *bybit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes825072 := (<-this.LoadMarkets())
            PanicOnError(retRes825072)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes408536 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes408536)
                    ch <- retRes408536
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes994669 := (<-this.LoadMarkets())
            PanicOnError(retRes994669)
...
func  (this *bybit) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes139225 := (<-this.LoadMarkets())
            PanicOnError(retRes139225)
            var currency interface{} = this.Currency(code)
...
func  (this *bybit) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes105243 := (<-this.LoadMarkets())
            PanicOnError(retRes105243)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes107782 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes107782)
                    ch <- retRes107782
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes582440 := (<-this.LoadMarkets())
            PanicOnError(retRes582440)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes500913 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes589582 := (<-this.LoadMarkets())
            PanicOnError(retRes589582)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes869896 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes869896)
                    ch <- retRes869896
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes869649 := (<-this.LoadMarkets())
            PanicOnError(retRes869649)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes745123 := (<-this.LoadMarkets())
            PanicOnError(retRes745123)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes573664 := (<-this.LoadMarkets())
            PanicOnError(retRes573664)
...
func  (this *bybit) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes441845 := (<-this.LoadMarkets())
            PanicOnError(retRes441845)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes276100 := (<-this.LoadMarkets())
            PanicOnError(retRes276100)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes82994 := (<-this.LoadMarkets())
            PanicOnError(retRes82994)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *bybit) FetchDerivativesOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes204435 := (<-this.LoadMarkets())
            PanicOnError(retRes204435)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes496036 := (<-this.LoadMarkets())
            PanicOnError(retRes496036)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                ...
                AddElementToObject(params, "timeframe", timeframe)
                    ...
                    retRes17820 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes719212 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
...
func  (this *bybit) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes809008 := (<-this.LoadMarkets())
            PanicOnError(retRes809008)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bybit) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes12984 := (<-this.LoadMarkets())
            PanicOnError(retRes12984)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes797199 := (<-this.LoadMarkets())
            PanicOnError(retRes797199)
...
func  (this *bybit) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes878106 := (<-this.LoadMarkets())
            PanicOnError(retRes878106)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes622275 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes622275)
                    ch <- retRes622275
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bybit) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes399656 := (<-this.LoadMarkets())
            PanicOnError(retRes399656)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchDerivativesMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes61396 := (<-this.LoadMarkets())
            PanicOnError(retRes61396)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes471899 := (<-this.LoadMarkets())
            PanicOnError(retRes471899)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            market = this.Market(symbol)
            if IsTrue(IsTrue(GetValue(market, "spot")) || IsTrue(GetValue(market, "option"))) {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes168508 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
                PanicOnError(retRes168508)
                ch <- retRes168508
                return nil
...
func  (this *bybit) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes464523 := (<-this.LoadMarkets())
            PanicOnError(retRes464523)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes484858 := (<-this.LoadMarkets())
            PanicOnError(retRes484858)
...
func  (this *bybit) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes637849 := (<-this.LoadMarkets())
            PanicOnError(retRes637849)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes224983 := (<-this.LoadMarkets())
            PanicOnError(retRes224983)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchVolatilityHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes850109 := (<-this.LoadMarkets())
            PanicOnError(retRes850109)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
...
func  (this *bybit) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes299251 := (<-this.LoadMarkets())
            PanicOnError(retRes299251)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "category": "option",
...
func  (this *bybit) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes189217 := (<-this.LoadMarkets())
            PanicOnError(retRes189217)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes771617 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes771617)
                    ch <- retRes771617
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes774215 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *bybit) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes696377 := (<-this.LoadMarkets())
            PanicOnError(retRes696377)
            var market interface{} = nil
            var symbol interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                market = this.Market(GetValue(symbols, 0))
...
func  (this *bybit) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes763150 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes763150)
                    ch <- retRes763150
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes663135 := (<-this.LoadMarkets())
            PanicOnError(retRes663135)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "baseCoin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes619064 := (<-this.LoadMarkets())
            PanicOnError(retRes619064)
            var market interface{} = nil
            var subType interface{} = nil
...
func  (this *bybit) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes496120 := (<-this.LoadMarkets())
            PanicOnError(retRes496120)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes5096 := (<-this.LoadMarkets())
            PanicOnError(retRes5096)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes916519 := (<-this.LoadMarkets())
            PanicOnError(retRes916519)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *bybit) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954137 := (<-this.LoadMarkets())
            PanicOnError(retRes954137)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes451360 := (<-this.LoadMarkets())
            PanicOnError(retRes451360)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", limit)
            }
...
func  (this *bybit) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes530276 := (<-this.LoadMarkets())
            PanicOnError(retRes530276)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
