...
func  (this *bybit) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes901105 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
...
func  (this *bybit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes799657 := (<-this.LoadTimeDifference())
                PanicOnError(retRes799657)
            }
...
func  (this *bybit) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes194721 := (<-this.LoadMarkets())
            PanicOnError(retRes194721)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes179785 := (<-this.LoadMarkets())
            PanicOnError(retRes179785)
...
func  (this *bybit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695493 := (<-this.LoadMarkets())
            PanicOnError(retRes695493)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes715580 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes715580)
                    ch <- retRes715580
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes815792 := (<-this.LoadMarkets())
            PanicOnError(retRes815792)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *bybit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes132849 := (<-this.LoadMarkets())
            PanicOnError(retRes132849)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes404364 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
                    PanicOnError(retRes404364)
                    ch <- retRes404364
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *bybit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes331097 := (<-this.LoadMarkets())
            PanicOnError(retRes331097)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes992191 := (<-this.LoadMarkets())
            PanicOnError(retRes992191)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes134687 := (<-this.LoadMarkets())
            PanicOnError(retRes134687)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes231611 := (<-this.LoadMarkets())
            PanicOnError(retRes231611)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes478459 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes478459)
                ch <- retRes478459
                return nil
...
func  (this *bybit) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63763 := (<-this.LoadMarkets())
            PanicOnError(retRes63763)
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes283061 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
                PanicOnError(retRes283061)
                ch <- retRes283061
                return nil
...
func  (this *bybit) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes908706 := (<-this.LoadMarkets())
            PanicOnError(retRes908706)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes145125 := (<-this.LoadMarkets())
            PanicOnError(retRes145125)
...
func  (this *bybit) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes14199 := (<-this.LoadMarkets())
            PanicOnError(retRes14199)
            if IsTrue(IsEqual(symbol, nil)) {
...
func  (this *bybit) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes358913 := (<-this.LoadMarkets())
            PanicOnError(retRes358913)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes558396 := (<-this.LoadMarkets())
            PanicOnError(retRes558396)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes319736 := (<-this.LoadMarkets())
            PanicOnError(retRes319736)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes488367 := (<-this.LoadMarkets())
            PanicOnError(retRes488367)
...
func  (this *bybit) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes909943 := (<-this.LoadMarkets())
            PanicOnError(retRes909943)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes371501 :=  (<-this.FetchOrderClassic(id, symbol, params))
...
func  (this *bybit) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes143888 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
                PanicOnError(retRes143888)
                ch <- retRes143888
                return nil
...
func  (this *bybit) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277929 := (<-this.LoadMarkets())
            PanicOnError(retRes277929)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes342962 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes342962)
                    ch <- retRes342962
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes651561 := (<-this.LoadMarkets())
            PanicOnError(retRes651561)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes578960 := (<-this.LoadMarkets())
            PanicOnError(retRes578960)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes134530 := (<-this.LoadMarkets())
            PanicOnError(retRes134530)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes955108 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes955108)
                    ch <- retRes955108
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes265964 := (<-this.LoadMarkets())
            PanicOnError(retRes265964)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Filled",
            }
        
                retRes663054 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes663054)
                ch <- retRes663054
                return nil
...
func  (this *bybit) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes499177 := (<-this.LoadMarkets())
            PanicOnError(retRes499177)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes166795 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *bybit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes320973 := (<-this.LoadMarkets())
            PanicOnError(retRes320973)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes170315 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes170315)
                    ch <- retRes170315
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes479610 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes479610)
                ch <- retRes479610
                return nil
...
func  (this *bybit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes358335 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes358335)
                    ch <- retRes358335
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246674 := (<-this.LoadMarkets())
            PanicOnError(retRes246674)
...
func  (this *bybit) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917637 := (<-this.LoadMarkets())
            PanicOnError(retRes917637)
            var currency interface{} = this.Currency(code)
...
func  (this *bybit) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954691 := (<-this.LoadMarkets())
            PanicOnError(retRes954691)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes839322 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes839322)
                    ch <- retRes839322
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes178273 := (<-this.LoadMarkets())
            PanicOnError(retRes178273)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes749486 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes749486)
                    ch <- retRes749486
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711295 := (<-this.LoadMarkets())
            PanicOnError(retRes711295)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes277386 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes277386)
                    ch <- retRes277386
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621759 := (<-this.LoadMarkets())
            PanicOnError(retRes621759)
            this.CheckAddress(address)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes98674 := (<-this.LoadMarkets())
            PanicOnError(retRes98674)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes261857 := (<-this.LoadMarkets())
            PanicOnError(retRes261857)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetMarginMode(marginMode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672133 := (<-this.LoadMarkets())
            PanicOnError(retRes672133)
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
            var isUnifiedAccount interface{} =     (IsTrue(enableUnifiedMargin) || IsTrue(enableUnifiedAccount))
...
func  (this *bybit) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486100 := (<-this.LoadMarkets())
            PanicOnError(retRes486100)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes512706 := (<-this.LoadMarkets())
            PanicOnError(retRes512706)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *bybit) FetchDerivativesOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes631190 := (<-this.LoadMarkets())
            PanicOnError(retRes631190)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes577384 := (<-this.LoadMarkets())
            PanicOnError(retRes577384)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                ...
                AddElementToObject(params, "timeframe", timeframe)
                    ...
                    retRes384214 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes384214)
                    ch <- retRes384214
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes933697 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
                PanicOnError(retRes933697)
                ch <- retRes933697
                return nil
...
func  (this *bybit) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes185366 := (<-this.LoadMarkets())
            PanicOnError(retRes185366)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bybit) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes799606 := (<-this.LoadMarkets())
            PanicOnError(retRes799606)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes298593 := (<-this.LoadMarkets())
            PanicOnError(retRes298593)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes75165 := (<-this.LoadMarkets())
            PanicOnError(retRes75165)
...
func  (this *bybit) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes375341 := (<-this.LoadMarkets())
            PanicOnError(retRes375341)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes541106 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes541106)
                    ch <- retRes541106
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bybit) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes945322 := (<-this.LoadMarkets())
            PanicOnError(retRes945322)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) RepayCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes835523 := (<-this.LoadMarkets())
            PanicOnError(retRes835523)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchDerivativesMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes914654 := (<-this.LoadMarkets())
            PanicOnError(retRes914654)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes222395 := (<-this.LoadMarkets())
            PanicOnError(retRes222395)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            market = this.Market(symbol)
            if IsTrue(IsTrue(GetValue(market, "spot")) || IsTrue(GetValue(market, "option"))) {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes396411 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
                PanicOnError(retRes396411)
                ch <- retRes396411
                return nil
...
func  (this *bybit) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes763939 := (<-this.LoadMarkets())
            PanicOnError(retRes763939)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes435333 := (<-this.LoadMarkets())
            PanicOnError(retRes435333)
            var typeVar interface{} = nil
...
func  (this *bybit) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes196817 := (<-this.LoadMarkets())
            PanicOnError(retRes196817)
...
func  (this *bybit) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes218860 := (<-this.LoadMarkets())
            PanicOnError(retRes218860)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchMySettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes829454 := (<-this.LoadMarkets())
            PanicOnError(retRes829454)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchGreeks(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes407046 := (<-this.LoadMarkets())
            PanicOnError(retRes407046)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
                "category": "option",
...
func  (this *bybit) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes431887 := (<-this.LoadMarkets())
            PanicOnError(retRes431887)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes439880 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *bybit) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes172308 := (<-this.LoadMarkets())
            PanicOnError(retRes172308)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if IsTrue(paginate) {
                    ...
                    retRes427537 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *bybit) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes669099 := (<-this.LoadMarkets())
            PanicOnError(retRes669099)
            var market interface{} = nil
            var symbol interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                market = this.Market(GetValue(symbols, 0))
...
func  (this *bybit) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes53015 := (<-this.LoadMarkets())
            PanicOnError(retRes53015)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes813963 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes813963)
                    ch <- retRes813963
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOption(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes730655 := (<-this.LoadMarkets())
            PanicOnError(retRes730655)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "symbol": GetValue(market, "id"),
...
func  (this *bybit) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568475 := (<-this.LoadMarkets())
            PanicOnError(retRes568475)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "baseCoin": GetValue(currency, "id"),
...
func  (this *bybit) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes777365 := (<-this.LoadMarkets())
            PanicOnError(retRes777365)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes991097 := (<-this.LoadMarkets())
            PanicOnError(retRes991097)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *bybit) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes833794 := (<-this.LoadMarkets())
            PanicOnError(retRes833794)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes327037 := (<-this.LoadMarkets())
            PanicOnError(retRes327037)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", limit)
            }
...
func  (this *bybit) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes615274 := (<-this.LoadMarkets())
            PanicOnError(retRes615274)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
