...
func  (this *bybit) UpgradeUnifiedTradeAccount(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes60546 :=  (<-this.PrivatePostV5AccountUpgradeToUta(params))
                PanicOnError(retRes60546)
                ch <- retRes60546
                return nil
...
func  (this *bybit) FetchMarkets(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(GetValue(this.Options, "adjustForTimeDifference")) {
                ...
                retRes282217 := (<-this.LoadTimeDifference())
                PanicOnError(retRes282217)
            }
...
func  (this *bybit) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes306645 := (<-this.LoadMarkets())
            PanicOnError(retRes306645)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes597690 := (<-this.LoadMarkets())
            PanicOnError(retRes597690)
...
func  (this *bybit) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes273538 := (<-this.LoadMarkets())
            PanicOnError(retRes273538)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes285455 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1000))
                    PanicOnError(retRes285455)
                    ch <- retRes285455
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchFundingRates(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672193 := (<-this.LoadMarkets())
            PanicOnError(retRes672193)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbols, nil)) {
...
func  (this *bybit) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes486742 := (<-this.LoadMarkets())
            PanicOnError(retRes486742)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes497245 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params, 200))
                    PanicOnError(retRes497245)
                    ch <- retRes497245
                    return nil
            }
            if IsTrue(IsEqual(limit, nil)) {
...
func  (this *bybit) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes827046 := (<-this.LoadMarkets())
            PanicOnError(retRes827046)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes602097 := (<-this.LoadMarkets())
            PanicOnError(retRes602097)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes341990 := (<-this.LoadMarkets())
            PanicOnError(retRes341990)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) CreateMarketBuyOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes582268 := (<-this.LoadMarkets())
            PanicOnError(retRes582268)
            var market interface{} = this.Market(symbol)
            if !IsTrue(GetValue(market, "spot")) {
                panic(NotSupported(Add(this.Id, " createMarketBuyOrderWithCost() supports spot orders only")))
            }
        
                retRes813573 :=  (<-this.CreateOrder(symbol, "market", "buy", cost, 1, params))
                PanicOnError(retRes813573)
                ch <- retRes813573
                return nil
...
func  (this *bybit) CreateMarketSellOrderWithCost(symbol interface{}, cost interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes714400 := (<-this.LoadMarkets())
            PanicOnError(retRes714400)
            ...
            if !IsTrue(GetValue(market, "spot")) {
                ...
                retRes79218 :=  (<-this.CreateOrder(symbol, "market", "sell", cost, 1, params))
...
func  (this *bybit) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes976606 := (<-this.LoadMarkets())
            PanicOnError(retRes976606)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes125900 := (<-this.LoadMarkets())
            PanicOnError(retRes125900)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) CancelAllOrdersAfter(timeout interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes704288 := (<-this.LoadMarkets())
            PanicOnError(retRes704288)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes424820 := (<-this.LoadMarkets())
            PanicOnError(retRes424820)
...
func  (this *bybit) FetchOrderClassic(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes653170 := (<-this.LoadMarkets())
            PanicOnError(retRes653170)
            var market interface{} = this.Market(symbol)
            if IsTrue(GetValue(market, "spot")) {
...
func  (this *bybit) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if !IsTrue(isUnifiedAccount) {
                    ...
                    retRes590425 :=  (<-this.FetchOrderClassic(id, symbol, params))
                    PanicOnError(retRes590425)
                    ch <- retRes590425
                    return nil
            }
...
func  (this *bybit) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(enableUnifiedAccount) {
                ...
                retRes387314 :=  (<-this.FetchOrdersClassic(symbol, since, limit, params))
                PanicOnError(retRes387314)
                ch <- retRes387314
                return nil
...
func  (this *bybit) FetchOrdersClassic(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes836285 := (<-this.LoadMarkets())
            PanicOnError(retRes836285)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes508563 :=  (<-this.FetchPaginatedCallCursor("fetchOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
...
func  (this *bybit) FetchClosedOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes428746 := (<-this.LoadMarkets())
            PanicOnError(retRes428746)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchOpenOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes346070 := (<-this.LoadMarkets())
            PanicOnError(retRes346070)
            var request interface{} = map[string]interface{} {
                "orderId": id,
            }
...
func  (this *bybit) FetchCanceledAndClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes514815 := (<-this.LoadMarkets())
            PanicOnError(retRes514815)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes302938 :=  (<-this.FetchPaginatedCallCursor("fetchCanceledAndClosedOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes302938)
                    ch <- retRes302938
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695171 := (<-this.LoadMarkets())
            PanicOnError(retRes695171)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Filled",
            }
        
                retRes672768 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes672768)
                ch <- retRes672768
                return nil
...
func  (this *bybit) FetchCanceledOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes315244 := (<-this.LoadMarkets())
            PanicOnError(retRes315244)
            var request interface{} = map[string]interface{} {
                "orderStatus": "Cancelled",
            }
        
                retRes297609 :=  (<-this.FetchCanceledAndClosedOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes297609)
                ch <- retRes297609
                return nil
...
func  (this *bybit) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes314289 := (<-this.LoadMarkets())
            PanicOnError(retRes314289)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes38701 :=  (<-this.FetchPaginatedCallCursor("fetchOpenOrders", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes38701)
                    ch <- retRes38701
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            params = this.Omit(params, []interface{}{"clientOrderId", "orderLinkId"})
                ...
                retRes519446 :=  (<-this.FetchMyTrades(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes519446)
                ch <- retRes519446
                return nil
...
func  (this *bybit) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes907090 := (<-this.LoadMarkets())
            PanicOnError(retRes907090)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes407643 :=  (<-this.FetchPaginatedCallCursor("fetchMyTrades", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes407643)
                    ch <- retRes407643
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes822271 := (<-this.LoadMarkets())
            PanicOnError(retRes822271)
...
func  (this *bybit) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes3924 := (<-this.LoadMarkets())
            PanicOnError(retRes3924)
            var currency interface{} = this.Currency(code)
...
func  (this *bybit) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes243562 := (<-this.LoadMarkets())
            PanicOnError(retRes243562)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes765401 :=  (<-this.FetchPaginatedCallCursor("fetchDeposits", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes765401)
                    ch <- retRes765401
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes301839 := (<-this.LoadMarkets())
            PanicOnError(retRes301839)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes528351 :=  (<-this.FetchPaginatedCallCursor("fetchWithdrawals", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes528351)
                    ch <- retRes528351
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246070 := (<-this.LoadMarkets())
            PanicOnError(retRes246070)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes600928 :=  (<-this.FetchPaginatedCallCursor("fetchLedger", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes600928)
                    ch <- retRes600928
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchLeverage(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes309840 := (<-this.LoadMarkets())
            PanicOnError(retRes309840)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetLeverage(leverage interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes601251 := (<-this.LoadMarkets())
            PanicOnError(retRes601251)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) SetPositionMode(hedged interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes950683 := (<-this.LoadMarkets())
            PanicOnError(retRes950683)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *bybit) FetchDerivativesOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752826 := (<-this.LoadMarkets())
            PanicOnError(retRes752826)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterest(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes549402 := (<-this.LoadMarkets())
            PanicOnError(retRes549402)
            var market interface{} = this.Market(symbol)
...
func  (this *bybit) FetchOpenInterestHistory(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes632188 := (<-this.LoadMarkets())
            PanicOnError(retRes632188)
            var paginate interface{} = this.SafeBool(params, "paginate")
            if IsTrue(paginate) {
                params = this.Omit(params, "paginate")
                AddElementToObject(params, "timeframe", timeframe)
        
                    retRes137147 :=  (<-this.FetchPaginatedCallCursor("fetchOpenInterestHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 200))
                    PanicOnError(retRes137147)
                    ch <- retRes137147
                    return nil
            }
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(!IsEqual(limit, nil)) {
                ...
                retRes414211 :=  (<-this.FetchDerivativesOpenInterestHistory(symbol, timeframe, since, limit, params))
                PanicOnError(retRes414211)
                ch <- retRes414211
                return nil
...
func  (this *bybit) FetchCrossBorrowRate(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes327004 := (<-this.LoadMarkets())
            PanicOnError(retRes327004)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
            }
...
func  (this *bybit) FetchBorrowInterest(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes446640 := (<-this.LoadMarkets())
            PanicOnError(retRes446640)
            var request interface{} = map[string]interface{} {}
...
func  (this *bybit) FetchBorrowRateHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes874342 := (<-this.LoadMarkets())
            PanicOnError(retRes874342)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) Transfer(code interface{}, amount interface{}, fromAccount interface{}, toAccount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes294957 := (<-this.LoadMarkets())
            PanicOnError(retRes294957)
...
func  (this *bybit) FetchTransfers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes719364 :=  (<-this.FetchPaginatedCallCursor("fetchTransfers", code, since, limit, params, "nextPageCursor", "cursor", nil, 50))
                    PanicOnError(retRes719364)
                    ch <- retRes719364
                    return nil
            }
            var currency interface{} = nil
...
func  (this *bybit) BorrowCrossMargin(code interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes69224 := (<-this.LoadMarkets())
            PanicOnError(retRes69224)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "coin": GetValue(currency, "id"),
...
func  (this *bybit) FetchDerivativesMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes364489 := (<-this.LoadMarkets())
            PanicOnError(retRes364489)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "symbol": GetValue(market, "id"),
            }
...
func  (this *bybit) FetchMarketLeverageTiers(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes122272 := (<-this.LoadMarkets())
            PanicOnError(retRes122272)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            market = this.Market(symbol)
            if IsTrue(IsTrue(GetValue(market, "spot")) || IsTrue(GetValue(market, "option"))) {
            ...
            AddElementToObject(request, "symbol", GetValue(market, "id"))
                ...
                retRes642961 :=  (<-this.FetchDerivativesMarketLeverageTiers(symbol, params))
...
func  (this *bybit) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes634563 := (<-this.LoadMarkets())
            PanicOnError(retRes634563)
            var typeVar interface{} = nil
...
func  (this *bybit) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes538603 := (<-this.LoadMarkets())
            PanicOnError(retRes538603)
...
func  (this *bybit) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes502893 := (<-this.LoadMarkets())
            PanicOnError(retRes502893)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bybit) FetchVolatilityHistory(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes20643 := (<-this.LoadMarkets())
            PanicOnError(retRes20643)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
...
func  (this *bybit) FetchMyLiquidations(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes759074 := (<-this.LoadMarkets())
            PanicOnError(retRes759074)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes899415 :=  (<-this.FetchPaginatedCallCursor("fetchMyLiquidations", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *bybit) GetLeverageTiersPaginated(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes450590 := (<-this.LoadMarkets())
            PanicOnError(retRes450590)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
            ...
            if IsTrue(paginate) {
                    ...
                    retRes556512 :=  (<-this.FetchPaginatedCallCursor("getLeverageTiersPaginated", symbol, nil, nil, params, "nextPageCursor", "cursor", nil, 100))
...
func  (this *bybit) FetchLeverageTiers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes287686 := (<-this.LoadMarkets())
            PanicOnError(retRes287686)
            var market interface{} = nil
            var symbol interface{} = nil
            if IsTrue(!IsEqual(symbols, nil)) {
                market = this.Market(GetValue(symbols, 0))
...
func  (this *bybit) FetchFundingHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes41611 :=  (<-this.FetchPaginatedCallCursor("fetchFundingHistory", symbol, since, limit, params, "nextPageCursor", "cursor", nil, 100))
                    PanicOnError(retRes41611)
                    ch <- retRes41611
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bybit) FetchOption(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes149597 := (<-this.LoadMarkets())
            PanicOnError(retRes149597)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "symbol": GetValue(market, "id"),
...
func  (this *bybit) FetchOptionChain(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470287 := (<-this.LoadMarkets())
            PanicOnError(retRes470287)
            var currency interface{} = this.Currency(code)
            var request interface{} = map[string]interface{} {
                "category": "option",
                "baseCoin": GetValue(currency, "id"),
...
func  (this *bybit) FetchPositionsHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes595758 := (<-this.LoadMarkets())
            PanicOnError(retRes595758)
            var market interface{} = nil
            var subType interface{} = nil
...
func  (this *bybit) FetchConvertCurrencies(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes941877 := (<-this.LoadMarkets())
            PanicOnError(retRes941877)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertQuote(fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes400242 := (<-this.LoadMarkets())
            PanicOnError(retRes400242)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) CreateConvertTrade(id interface{}, fromCode interface{}, toCode interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes179062 := (<-this.LoadMarkets())
            PanicOnError(retRes179062)
            var request interface{} = map[string]interface{} {
                "quoteTxId": id,
            }
...
func  (this *bybit) FetchConvertTrade(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141021 := (<-this.LoadMarkets())
            PanicOnError(retRes141021)
            var accountType interface{} = nil
            enableUnifiedMarginenableUnifiedAccountVariable := (<-this.IsUnifiedEnabled());
            enableUnifiedMargin := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,0);
            enableUnifiedAccount := GetValue(enableUnifiedMarginenableUnifiedAccountVariable,1)
...
func  (this *bybit) FetchConvertTradeHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes215798 := (<-this.LoadMarkets())
            PanicOnError(retRes215798)
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(limit, nil)) {
                AddElementToObject(request, "limit", limit)
            }
...
func  (this *bybit) FetchLongShortRatioHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes492402 := (<-this.LoadMarkets())
            PanicOnError(retRes492402)
            var market interface{} = this.Market(symbol)
            var typeVar interface{} = nil
