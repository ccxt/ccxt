...
func  (this *cryptocom) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes617031 := (<-this.LoadMarkets())
            PanicOnError(retRes617031)
...
func  (this *cryptocom) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes188507 := (<-this.LoadMarkets())
            PanicOnError(retRes188507)
...
func  (this *cryptocom) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515618 := (<-this.LoadMarkets())
            PanicOnError(retRes515618)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes240192 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes240192)
                    ch <- retRes240192
                    return nil
            }
            var market interface{} = nil
...
func  (this *cryptocom) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes450644 := (<-this.LoadMarkets())
            PanicOnError(retRes450644)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes699716 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes699716)
                    ch <- retRes699716
                    return nil
            }
...
func  (this *cryptocom) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes382574 := (<-this.LoadMarkets())
            PanicOnError(retRes382574)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes269366 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes269366)
                    ch <- retRes269366
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes302283 := (<-this.LoadMarkets())
            PanicOnError(retRes302283)
...
func  (this *cryptocom) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes865289 := (<-this.LoadMarkets())
            PanicOnError(retRes865289)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes137197 := (<-this.LoadMarkets())
            PanicOnError(retRes137197)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes982967 := (<-this.LoadMarkets())
            PanicOnError(retRes982967)
...
func  (this *cryptocom) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes682475 := (<-this.LoadMarkets())
            PanicOnError(retRes682475)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes816855 :=  (<-this.V1PrivatePostPrivateCancelAllOrders(this.Extend(request, params)))
                PanicOnError(retRes816855)
                ch <- retRes816855
                return nil
...
func  (this *cryptocom) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes983224 := (<-this.LoadMarkets())
            PanicOnError(retRes983224)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes231770 := (<-this.LoadMarkets())
            PanicOnError(retRes231770)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes475397 := (<-this.LoadMarkets())
            PanicOnError(retRes475397)
            var orderRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *cryptocom) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes535868 := (<-this.LoadMarkets())
            PanicOnError(retRes535868)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes275183 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
...
func  (this *cryptocom) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes626760 := (<-this.LoadMarkets())
            PanicOnError(retRes626760)
...
func  (this *cryptocom) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117437 := (<-this.LoadMarkets())
            PanicOnError(retRes117437)
...
func  (this *cryptocom) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes672726 := (<-this.LoadMarkets())
            PanicOnError(retRes672726)
            var currency interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes737609 := (<-this.LoadMarkets())
            PanicOnError(retRes737609)
...
func  (this *cryptocom) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes33235 := (<-this.LoadMarkets())
            PanicOnError(retRes33235)
            var request interface{} = map[string]interface{} {}
            var currency interface{} = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes951791 := (<-this.LoadMarkets())
            PanicOnError(retRes951791)
...
func  (this *cryptocom) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638472 := (<-this.LoadMarkets())
            PanicOnError(retRes638472)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes776572 := (<-this.LoadMarkets())
            PanicOnError(retRes776572)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes36399 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes36399)
                    ch <- retRes36399
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes77696 := (<-this.LoadMarkets())
            PanicOnError(retRes77696)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes844175 := (<-this.LoadMarkets())
            PanicOnError(retRes844175)
...
func  (this *cryptocom) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes527492 := (<-this.LoadMarkets())
            PanicOnError(retRes527492)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
                "type": "MARKET",
...
func  (this *cryptocom) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes663987 := (<-this.LoadMarkets())
            PanicOnError(retRes663987)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes235886 := (<-this.LoadMarkets())
            PanicOnError(retRes235886)
