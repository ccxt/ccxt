...
func  (this *cryptocom) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes430807 := (<-this.LoadMarkets())
            PanicOnError(retRes430807)
...
func  (this *cryptocom) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes36733 := (<-this.LoadMarkets())
            PanicOnError(retRes36733)
...
func  (this *cryptocom) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes133687 := (<-this.LoadMarkets())
            PanicOnError(retRes133687)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes198518 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes198518)
                    ch <- retRes198518
                    return nil
            }
            var market interface{} = nil
...
func  (this *cryptocom) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes685893 := (<-this.LoadMarkets())
            PanicOnError(retRes685893)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes867367 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes867367)
                    ch <- retRes867367
                    return nil
            }
...
func  (this *cryptocom) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes181025 := (<-this.LoadMarkets())
            PanicOnError(retRes181025)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes345662 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes345662)
                    ch <- retRes345662
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406874 := (<-this.LoadMarkets())
            PanicOnError(retRes406874)
...
func  (this *cryptocom) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes249439 := (<-this.LoadMarkets())
            PanicOnError(retRes249439)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes695116 := (<-this.LoadMarkets())
            PanicOnError(retRes695116)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes385911 := (<-this.LoadMarkets())
            PanicOnError(retRes385911)
...
func  (this *cryptocom) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes554714 := (<-this.LoadMarkets())
            PanicOnError(retRes554714)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes536248 :=  (<-this.V1PrivatePostPrivateCancelAllOrders(this.Extend(request, params)))
                PanicOnError(retRes536248)
                ch <- retRes536248
                return nil
...
func  (this *cryptocom) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes858632 := (<-this.LoadMarkets())
            PanicOnError(retRes858632)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes928693 := (<-this.LoadMarkets())
            PanicOnError(retRes928693)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes576131 := (<-this.LoadMarkets())
            PanicOnError(retRes576131)
            var orderRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *cryptocom) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes126252 := (<-this.LoadMarkets())
            PanicOnError(retRes126252)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *cryptocom) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes691884 := (<-this.LoadMarkets())
            PanicOnError(retRes691884)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes33221 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes33221)
                    ch <- retRes33221
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *cryptocom) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes101133 := (<-this.LoadMarkets())
            PanicOnError(retRes101133)
...
func  (this *cryptocom) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes329806 := (<-this.LoadMarkets())
            PanicOnError(retRes329806)
...
func  (this *cryptocom) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes74852 := (<-this.LoadMarkets())
            PanicOnError(retRes74852)
...
func  (this *cryptocom) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes105874 := (<-this.LoadMarkets())
            PanicOnError(retRes105874)
            var currency interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes749007 := (<-this.LoadMarkets())
            PanicOnError(retRes749007)
...
func  (this *cryptocom) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes264837 := (<-this.LoadMarkets())
            PanicOnError(retRes264837)
            var request interface{} = map[string]interface{} {}
            var currency interface{} = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes638517 := (<-this.LoadMarkets())
            PanicOnError(retRes638517)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987906 := (<-this.LoadMarkets())
            PanicOnError(retRes987906)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes200014 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes200014)
                    ch <- retRes200014
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes280565 := (<-this.LoadMarkets())
            PanicOnError(retRes280565)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes565831 := (<-this.LoadMarkets())
            PanicOnError(retRes565831)
...
func  (this *cryptocom) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes951349 := (<-this.LoadMarkets())
            PanicOnError(retRes951349)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
                "type": "MARKET",
...
func  (this *cryptocom) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes917884 := (<-this.LoadMarkets())
            PanicOnError(retRes917884)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes621557 := (<-this.LoadMarkets())
            PanicOnError(retRes621557)
