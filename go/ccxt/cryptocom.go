...
func  (this *cryptocom) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes925099 := (<-this.LoadMarkets())
            PanicOnError(retRes925099)
...
func  (this *cryptocom) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes829986 := (<-this.LoadMarkets())
            PanicOnError(retRes829986)
...
func  (this *cryptocom) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes321814 := (<-this.LoadMarkets())
            PanicOnError(retRes321814)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes473923 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes473923)
                    ch <- retRes473923
                    return nil
            }
            var market interface{} = nil
...
func  (this *cryptocom) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes63486 := (<-this.LoadMarkets())
            PanicOnError(retRes63486)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes29274 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes29274)
                    ch <- retRes29274
                    return nil
            }
...
func  (this *cryptocom) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes999063 := (<-this.LoadMarkets())
            PanicOnError(retRes999063)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes196369 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes196369)
                    ch <- retRes196369
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes175674 := (<-this.LoadMarkets())
            PanicOnError(retRes175674)
...
func  (this *cryptocom) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes230041 := (<-this.LoadMarkets())
            PanicOnError(retRes230041)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes515819 := (<-this.LoadMarkets())
            PanicOnError(retRes515819)
...
func  (this *cryptocom) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes587099 := (<-this.LoadMarkets())
            PanicOnError(retRes587099)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes739343 :=  (<-this.V1PrivatePostPrivateCancelAllOrders(this.Extend(request, params)))
                PanicOnError(retRes739343)
                ch <- retRes739343
                return nil
...
func  (this *cryptocom) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes937216 := (<-this.LoadMarkets())
            PanicOnError(retRes937216)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes180813 := (<-this.LoadMarkets())
            PanicOnError(retRes180813)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes712649 := (<-this.LoadMarkets())
            PanicOnError(retRes712649)
            var orderRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *cryptocom) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes519713 := (<-this.LoadMarkets())
            PanicOnError(retRes519713)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *cryptocom) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes777436 := (<-this.LoadMarkets())
            PanicOnError(retRes777436)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes154920 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes154920)
                    ch <- retRes154920
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *cryptocom) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes968436 := (<-this.LoadMarkets())
            PanicOnError(retRes968436)
...
func  (this *cryptocom) FetchDepositAddressesByNetwork(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes282144 := (<-this.LoadMarkets())
            PanicOnError(retRes282144)
...
func  (this *cryptocom) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes397538 := (<-this.LoadMarkets())
            PanicOnError(retRes397538)
...
func  (this *cryptocom) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes141248 := (<-this.LoadMarkets())
            PanicOnError(retRes141248)
            var currency interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes950313 := (<-this.LoadMarkets())
            PanicOnError(retRes950313)
...
func  (this *cryptocom) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes449070 := (<-this.LoadMarkets())
            PanicOnError(retRes449070)
...
func  (this *cryptocom) FetchSettlementHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes233243 := (<-this.LoadMarkets())
            PanicOnError(retRes233243)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes968358 := (<-this.LoadMarkets())
            PanicOnError(retRes968358)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes76885 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
...
func  (this *cryptocom) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes19310 := (<-this.LoadMarkets())
            PanicOnError(retRes19310)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes668453 := (<-this.LoadMarkets())
            PanicOnError(retRes668453)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
                "type": "MARKET",
...
func  (this *cryptocom) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes273324 := (<-this.LoadMarkets())
            PanicOnError(retRes273324)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes635971 := (<-this.LoadMarkets())
            PanicOnError(retRes635971)
