...
func  (this *cryptocom) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes6492 := (<-this.LoadMarkets())
            PanicOnError(retRes6492)
...
func  (this *cryptocom) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes436136 := (<-this.LoadMarkets())
            PanicOnError(retRes436136)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes765387 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes765387)
                    ch <- retRes765387
                    return nil
            }
            var market interface{} = nil
...
func  (this *cryptocom) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes272946 := (<-this.LoadMarkets())
            PanicOnError(retRes272946)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes739489 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
...
func  (this *cryptocom) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes441174 := (<-this.LoadMarkets())
            PanicOnError(retRes441174)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes893637 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes893637)
                    ch <- retRes893637
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes176562 := (<-this.LoadMarkets())
            PanicOnError(retRes176562)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes818628 := (<-this.LoadMarkets())
            PanicOnError(retRes818628)
...
func  (this *cryptocom) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes673421 := (<-this.LoadMarkets())
            PanicOnError(retRes673421)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes2085 := (<-this.LoadMarkets())
            PanicOnError(retRes2085)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CreateOrders(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes109358 := (<-this.LoadMarkets())
            PanicOnError(retRes109358)
...
func  (this *cryptocom) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes145431 := (<-this.LoadMarkets())
            PanicOnError(retRes145431)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes130749 :=  (<-this.V1PrivatePostPrivateCancelAllOrders(this.Extend(request, params)))
                PanicOnError(retRes130749)
                ch <- retRes130749
                return nil
...
func  (this *cryptocom) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes607343 := (<-this.LoadMarkets())
            PanicOnError(retRes607343)
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
            }
...
func  (this *cryptocom) CancelOrders(ids interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes665137 := (<-this.LoadMarkets())
            PanicOnError(retRes665137)
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) CancelOrdersForSymbols(orders interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes794866 := (<-this.LoadMarkets())
            PanicOnError(retRes794866)
            var orderRequests interface{} = []interface{}{}
            for i := 0; IsLessThan(i, GetArrayLength(orders)); i++ {
...
func  (this *cryptocom) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes641469 := (<-this.LoadMarkets())
            PanicOnError(retRes641469)
            var market interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *cryptocom) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes997947 := (<-this.LoadMarkets())
            PanicOnError(retRes997947)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes958323 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes958323)
                    ch <- retRes958323
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *cryptocom) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes965548 := (<-this.LoadMarkets())
            PanicOnError(retRes965548)
...
func  (this *cryptocom) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes391033 := (<-this.LoadMarkets())
            PanicOnError(retRes391033)
...
func  (this *cryptocom) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes532661 := (<-this.LoadMarkets())
            PanicOnError(retRes532661)
            var currency interface{} = nil
            var request interface{} = map[string]interface{} {}
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes208113 := (<-this.LoadMarkets())
            PanicOnError(retRes208113)
...
func  (this *cryptocom) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes454276 := (<-this.LoadMarkets())
            PanicOnError(retRes454276)
            var request interface{} = map[string]interface{} {}
            var currency interface{} = nil
            if IsTrue(!IsEqual(code, nil)) {
                currency = this.SafeCurrency(code)
...
func  (this *cryptocom) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes664179 := (<-this.LoadMarkets())
            PanicOnError(retRes664179)
...
func  (this *cryptocom) FetchFundingRateHistory(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes625910 := (<-this.LoadMarkets())
            PanicOnError(retRes625910)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes318835 :=  (<-this.FetchPaginatedCallDeterministic("fetchFundingRateHistory", symbol, since, limit, "8h", params))
                    PanicOnError(retRes318835)
                    ch <- retRes318835
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *cryptocom) FetchPosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes419087 := (<-this.LoadMarkets())
            PanicOnError(retRes419087)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchPositions(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes783300 := (<-this.LoadMarkets())
            PanicOnError(retRes783300)
...
func  (this *cryptocom) ClosePosition(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes470800 := (<-this.LoadMarkets())
            PanicOnError(retRes470800)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
                "type": "MARKET",
...
func  (this *cryptocom) FetchTradingFee(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes788498 := (<-this.LoadMarkets())
            PanicOnError(retRes788498)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "instrument_name": GetValue(market, "id"),
            }
...
func  (this *cryptocom) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes933263 := (<-this.LoadMarkets())
            PanicOnError(retRes933263)
