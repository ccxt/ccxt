...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes546767 := (<-this.LoadMarkets())
            PanicOnError(retRes546767)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes79702 := (<-this.LoadMarkets())
            PanicOnError(retRes79702)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes549833 := (<-this.LoadMarkets())
            PanicOnError(retRes549833)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes179023 := (<-this.LoadMarkets())
            PanicOnError(retRes179023)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628566 := (<-this.LoadMarkets())
            PanicOnError(retRes628566)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes620647 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes620647)
                    ch <- retRes620647
                    return nil
            }
        
            retRes53837 := (<-this.LoadMarkets())
            PanicOnError(retRes53837)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes218420 := (<-this.LoadMarkets())
            PanicOnError(retRes218420)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes743749 := (<-this.LoadMarkets())
            PanicOnError(retRes743749)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes311056 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes311056)
                    ch <- retRes311056
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes754217 := (<-this.LoadMarkets())
            PanicOnError(retRes754217)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes350811 := (<-this.LoadMarkets())
            PanicOnError(retRes350811)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes708274 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes708274)
                ch <- retRes708274
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes406350 := (<-this.LoadMarkets())
            PanicOnError(retRes406350)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes471655 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes471655)
                    ch <- retRes471655
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes288742 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes288742)
                ch <- retRes288742
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes4353 := (<-this.LoadMarkets())
            PanicOnError(retRes4353)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes728361 := (<-this.LoadMarkets())
            PanicOnError(retRes728361)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes76426 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes76426)
                ch <- retRes76426
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes434097 := (<-this.LoadMarkets())
            PanicOnError(retRes434097)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes765862 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes765862)
                ch <- retRes765862
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes699065 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes699065)
                ch <- retRes699065
                return nil
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes291359 := (<-this.LoadMarkets())
            PanicOnError(retRes291359)
        
            retRes486243 := (<-this.LoadAccounts())
            PanicOnError(retRes486243)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes681442 := (<-this.LoadMarkets())
            PanicOnError(retRes681442)
        
            retRes559724 := (<-this.LoadAccounts())
            PanicOnError(retRes559724)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes260250 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes260250)
                ch <- retRes260250
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes372194 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes372194)
                ch <- retRes372194
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes632267 := (<-this.LoadMarkets())
            PanicOnError(retRes632267)
            var currency interface{} = this.Currency(code)
