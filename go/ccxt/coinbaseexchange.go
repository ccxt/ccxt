...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes253969 := (<-this.LoadMarkets())
            PanicOnError(retRes253969)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes476415 := (<-this.LoadMarkets())
            PanicOnError(retRes476415)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes388735 := (<-this.LoadMarkets())
            PanicOnError(retRes388735)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes482770 := (<-this.LoadMarkets())
            PanicOnError(retRes482770)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes705872 := (<-this.LoadMarkets())
            PanicOnError(retRes705872)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes654394 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes654394)
                    ch <- retRes654394
                    return nil
            }
        
            retRes747316 := (<-this.LoadMarkets())
            PanicOnError(retRes747316)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes297991 := (<-this.LoadMarkets())
            PanicOnError(retRes297991)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes520691 := (<-this.LoadMarkets())
            PanicOnError(retRes520691)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168608 := (<-this.LoadMarkets())
            PanicOnError(retRes168608)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes213033 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes213033)
                    ch <- retRes213033
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes342671 := (<-this.LoadMarkets())
            PanicOnError(retRes342671)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes322229 := (<-this.LoadMarkets())
            PanicOnError(retRes322229)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes67329 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes67329)
                ch <- retRes67329
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes870447 := (<-this.LoadMarkets())
            PanicOnError(retRes870447)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes735125 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes735125)
                    ch <- retRes735125
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes900153 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes900153)
                ch <- retRes900153
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes100202 := (<-this.LoadMarkets())
            PanicOnError(retRes100202)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes901267 := (<-this.LoadMarkets())
            PanicOnError(retRes901267)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes280833 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes280833)
                ch <- retRes280833
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854625 := (<-this.LoadMarkets())
            PanicOnError(retRes854625)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes704415 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes704415)
                ch <- retRes704415
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes184379 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes184379)
                ch <- retRes184379
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes151813 := (<-this.LoadMarkets())
            PanicOnError(retRes151813)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes308298 := (<-this.LoadMarkets())
            PanicOnError(retRes308298)
        
            retRes941482 := (<-this.LoadAccounts())
            PanicOnError(retRes941482)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes193157 := (<-this.LoadMarkets())
            PanicOnError(retRes193157)
        
            retRes540872 := (<-this.LoadAccounts())
            PanicOnError(retRes540872)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes4357 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes4357)
                ch <- retRes4357
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes643652 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes643652)
                ch <- retRes643652
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes46892 := (<-this.LoadMarkets())
            PanicOnError(retRes46892)
            var currency interface{} = this.Currency(code)
