...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes996056 := (<-this.LoadMarkets())
            PanicOnError(retRes996056)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes333786 := (<-this.LoadMarkets())
            PanicOnError(retRes333786)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes740751 := (<-this.LoadMarkets())
            PanicOnError(retRes740751)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes227785 := (<-this.LoadMarkets())
            PanicOnError(retRes227785)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes107785 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes107785)
                    ch <- retRes107785
                    return nil
            }
        
            retRes578100 := (<-this.LoadMarkets())
            PanicOnError(retRes578100)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes582328 := (<-this.LoadMarkets())
            PanicOnError(retRes582328)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes624724 := (<-this.LoadMarkets())
            PanicOnError(retRes624724)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes859520 := (<-this.LoadMarkets())
            PanicOnError(retRes859520)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes301950 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes301950)
                    ch <- retRes301950
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes646210 := (<-this.LoadMarkets())
            PanicOnError(retRes646210)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes603567 := (<-this.LoadMarkets())
            PanicOnError(retRes603567)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes743532 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes743532)
                ch <- retRes743532
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes987001 := (<-this.LoadMarkets())
            PanicOnError(retRes987001)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes826114 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes826114)
                    ch <- retRes826114
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes348963 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes795481 := (<-this.LoadMarkets())
            PanicOnError(retRes795481)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes704690 := (<-this.LoadMarkets())
            PanicOnError(retRes704690)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes797550 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes797550)
                ch <- retRes797550
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes404394 := (<-this.LoadMarkets())
            PanicOnError(retRes404394)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes882905 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes882905)
                ch <- retRes882905
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes60031 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes60031)
                ch <- retRes60031
                return nil
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes610824 := (<-this.LoadMarkets())
            PanicOnError(retRes610824)
        
            retRes103689 := (<-this.LoadAccounts())
            PanicOnError(retRes103689)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes151667 := (<-this.LoadMarkets())
            PanicOnError(retRes151667)
        
            retRes802091 := (<-this.LoadAccounts())
            PanicOnError(retRes802091)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes122085 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes122085)
                ch <- retRes122085
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes527932 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes527932)
                ch <- retRes527932
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes715176 := (<-this.LoadMarkets())
            PanicOnError(retRes715176)
            var currency interface{} = this.Currency(code)
