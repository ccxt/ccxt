...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes525369 := (<-this.LoadMarkets())
            PanicOnError(retRes525369)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes543836 := (<-this.LoadMarkets())
            PanicOnError(retRes543836)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes326634 := (<-this.LoadMarkets())
            PanicOnError(retRes326634)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes577375 := (<-this.LoadMarkets())
            PanicOnError(retRes577375)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes979008 := (<-this.LoadMarkets())
            PanicOnError(retRes979008)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes519036 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes519036)
                    ch <- retRes519036
                    return nil
            }
        
            retRes887438 := (<-this.LoadMarkets())
            PanicOnError(retRes887438)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes817610 := (<-this.LoadMarkets())
            PanicOnError(retRes817610)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes263274 := (<-this.LoadMarkets())
            PanicOnError(retRes263274)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes903580 := (<-this.LoadMarkets())
            PanicOnError(retRes903580)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes722139 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes722139)
                    ch <- retRes722139
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes667027 := (<-this.LoadMarkets())
            PanicOnError(retRes667027)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes805867 := (<-this.LoadMarkets())
            PanicOnError(retRes805867)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes771426 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes771426)
                ch <- retRes771426
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes216305 := (<-this.LoadMarkets())
            PanicOnError(retRes216305)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes392566 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes392566)
                    ch <- retRes392566
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes730507 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes730507)
                ch <- retRes730507
                return nil
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes664655 := (<-this.LoadMarkets())
            PanicOnError(retRes664655)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes914203 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes914203)
                ch <- retRes914203
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes725769 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes725769)
                ch <- retRes725769
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes910843 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes910843)
                ch <- retRes910843
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes792701 := (<-this.LoadMarkets())
            PanicOnError(retRes792701)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes72773 := (<-this.LoadMarkets())
            PanicOnError(retRes72773)
        
            retRes285813 := (<-this.LoadAccounts())
            PanicOnError(retRes285813)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes300225 := (<-this.LoadMarkets())
            PanicOnError(retRes300225)
        
            retRes250883 := (<-this.LoadAccounts())
            PanicOnError(retRes250883)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes675586 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes675586)
                ch <- retRes675586
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes334404 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes334404)
                ch <- retRes334404
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes929720 := (<-this.LoadMarkets())
            PanicOnError(retRes929720)
            var currency interface{} = this.Currency(code)
