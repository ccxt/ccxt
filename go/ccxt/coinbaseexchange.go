...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes983079 := (<-this.LoadMarkets())
            PanicOnError(retRes983079)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes328264 := (<-this.LoadMarkets())
            PanicOnError(retRes328264)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes546371 := (<-this.LoadMarkets())
            PanicOnError(retRes546371)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes768249 := (<-this.LoadMarkets())
            PanicOnError(retRes768249)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes305014 := (<-this.LoadMarkets())
            PanicOnError(retRes305014)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes568216 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes568216)
                    ch <- retRes568216
                    return nil
            }
        
            retRes537315 := (<-this.LoadMarkets())
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes572668 := (<-this.LoadMarkets())
            PanicOnError(retRes572668)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599736 := (<-this.LoadMarkets())
            PanicOnError(retRes599736)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes60508 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes409845 := (<-this.LoadMarkets())
            PanicOnError(retRes409845)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes342066 := (<-this.LoadMarkets())
            PanicOnError(retRes342066)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes318646 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes318646)
                ch <- retRes318646
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes788200 := (<-this.LoadMarkets())
            PanicOnError(retRes788200)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes466701 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes466701)
                    ch <- retRes466701
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes987667 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes987667)
                ch <- retRes987667
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes309298 := (<-this.LoadMarkets())
            PanicOnError(retRes309298)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes151554 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes151554)
                ch <- retRes151554
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes599111 := (<-this.LoadMarkets())
            PanicOnError(retRes599111)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes951724 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes951724)
                ch <- retRes951724
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes801705 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes801705)
                ch <- retRes801705
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes266989 := (<-this.LoadMarkets())
            PanicOnError(retRes266989)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703730 := (<-this.LoadMarkets())
            PanicOnError(retRes703730)
        
            retRes304240 := (<-this.LoadAccounts())
            PanicOnError(retRes304240)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854816 := (<-this.LoadMarkets())
            PanicOnError(retRes854816)
        
            retRes490170 := (<-this.LoadAccounts())
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes121886 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes121886)
                ch <- retRes121886
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes677048 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes677048)
                ch <- retRes677048
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes158149 := (<-this.LoadMarkets())
            PanicOnError(retRes158149)
            var currency interface{} = this.Currency(code)
