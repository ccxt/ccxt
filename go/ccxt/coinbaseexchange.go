...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes412811 := (<-this.LoadMarkets())
            PanicOnError(retRes412811)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes246967 := (<-this.LoadMarkets())
            PanicOnError(retRes246967)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes312855 := (<-this.LoadMarkets())
            PanicOnError(retRes312855)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes896168 := (<-this.LoadMarkets())
            PanicOnError(retRes896168)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes652064 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes652064)
                    ch <- retRes652064
                    return nil
            }
        
            retRes603065 := (<-this.LoadMarkets())
            PanicOnError(retRes603065)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes443950 := (<-this.LoadMarkets())
            PanicOnError(retRes443950)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes120614 := (<-this.LoadMarkets())
            PanicOnError(retRes120614)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes28730 := (<-this.LoadMarkets())
            PanicOnError(retRes28730)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes659432 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes659432)
                    ch <- retRes659432
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes936706 := (<-this.LoadMarkets())
            PanicOnError(retRes936706)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes32833 := (<-this.LoadMarkets())
            PanicOnError(retRes32833)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes281968 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes281968)
                ch <- retRes281968
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes438253 := (<-this.LoadMarkets())
            PanicOnError(retRes438253)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes815948 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes815948)
                    ch <- retRes815948
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes171584 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes171584)
                ch <- retRes171584
                return nil
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes341078 := (<-this.LoadMarkets())
            PanicOnError(retRes341078)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes422262 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes422262)
                ch <- retRes422262
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes995248 := (<-this.LoadMarkets())
            PanicOnError(retRes995248)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes874687 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes486338 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes486338)
                ch <- retRes486338
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes175973 := (<-this.LoadMarkets())
            PanicOnError(retRes175973)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378762 := (<-this.LoadMarkets())
            PanicOnError(retRes378762)
        
            retRes920459 := (<-this.LoadAccounts())
            PanicOnError(retRes920459)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes392817 := (<-this.LoadMarkets())
            PanicOnError(retRes392817)
        
            retRes61763 := (<-this.LoadAccounts())
            PanicOnError(retRes61763)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes32344 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes32344)
                ch <- retRes32344
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes513900 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes513900)
                ch <- retRes513900
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes705029 := (<-this.LoadMarkets())
            PanicOnError(retRes705029)
            var currency interface{} = this.Currency(code)
