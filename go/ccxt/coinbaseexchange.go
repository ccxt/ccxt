...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes440607 := (<-this.LoadMarkets())
            PanicOnError(retRes440607)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes112900 := (<-this.LoadMarkets())
            PanicOnError(retRes112900)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes719581 := (<-this.LoadMarkets())
            PanicOnError(retRes719581)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255468 := (<-this.LoadMarkets())
            PanicOnError(retRes255468)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes733256 := (<-this.LoadMarkets())
            PanicOnError(retRes733256)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes769692 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes769692)
                    ch <- retRes769692
                    return nil
            }
        
            retRes381867 := (<-this.LoadMarkets())
            PanicOnError(retRes381867)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes360391 := (<-this.LoadMarkets())
            PanicOnError(retRes360391)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes914960 := (<-this.LoadMarkets())
            PanicOnError(retRes914960)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes131803 := (<-this.LoadMarkets())
            PanicOnError(retRes131803)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes846681 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes846681)
                    ch <- retRes846681
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes171721 := (<-this.LoadMarkets())
            PanicOnError(retRes171721)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes939828 := (<-this.LoadMarkets())
            PanicOnError(retRes939828)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes419395 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes419395)
                ch <- retRes419395
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes893944 := (<-this.LoadMarkets())
            PanicOnError(retRes893944)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes433706 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes433706)
                    ch <- retRes433706
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes147117 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes147117)
                ch <- retRes147117
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes605530 := (<-this.LoadMarkets())
            PanicOnError(retRes605530)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164201 := (<-this.LoadMarkets())
            PanicOnError(retRes164201)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes393957 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes393957)
                ch <- retRes393957
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes405353 := (<-this.LoadMarkets())
            PanicOnError(retRes405353)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes919653 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes919653)
                ch <- retRes919653
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes361900 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes361900)
                ch <- retRes361900
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954330 := (<-this.LoadMarkets())
            PanicOnError(retRes954330)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes119780 := (<-this.LoadMarkets())
            PanicOnError(retRes119780)
        
            retRes985966 := (<-this.LoadAccounts())
            PanicOnError(retRes985966)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes605772 := (<-this.LoadMarkets())
            PanicOnError(retRes605772)
        
            retRes702485 := (<-this.LoadAccounts())
            PanicOnError(retRes702485)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes153565 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes153565)
                ch <- retRes153565
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes786255 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes786255)
                ch <- retRes786255
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes583918 := (<-this.LoadMarkets())
            PanicOnError(retRes583918)
            var currency interface{} = this.Currency(code)
