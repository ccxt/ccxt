...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes352873 := (<-this.LoadMarkets())
            PanicOnError(retRes352873)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes827892 := (<-this.LoadMarkets())
            PanicOnError(retRes827892)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes881378 := (<-this.LoadMarkets())
            PanicOnError(retRes881378)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes752153 := (<-this.LoadMarkets())
            PanicOnError(retRes752153)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes779592 := (<-this.LoadMarkets())
            PanicOnError(retRes779592)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes737695 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes737695)
                    ch <- retRes737695
                    return nil
            }
        
            retRes372088 := (<-this.LoadMarkets())
            PanicOnError(retRes372088)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes614184 := (<-this.LoadMarkets())
            PanicOnError(retRes614184)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes556979 := (<-this.LoadMarkets())
            PanicOnError(retRes556979)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes324276 := (<-this.LoadMarkets())
            PanicOnError(retRes324276)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes954033 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes225749 := (<-this.LoadMarkets())
            PanicOnError(retRes225749)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes702252 := (<-this.LoadMarkets())
            PanicOnError(retRes702252)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes35051 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes35051)
                ch <- retRes35051
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes70283 := (<-this.LoadMarkets())
            PanicOnError(retRes70283)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes351047 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes351047)
                    ch <- retRes351047
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes947079 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes947079)
                ch <- retRes947079
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes875661 := (<-this.LoadMarkets())
            PanicOnError(retRes875661)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes289508 := (<-this.LoadMarkets())
            PanicOnError(retRes289508)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes72380 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes72380)
                ch <- retRes72380
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes655324 := (<-this.LoadMarkets())
            PanicOnError(retRes655324)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes314935 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes314935)
                ch <- retRes314935
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes496497 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes496497)
                ch <- retRes496497
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes957175 := (<-this.LoadMarkets())
            PanicOnError(retRes957175)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes628650 := (<-this.LoadMarkets())
            PanicOnError(retRes628650)
        
            retRes304483 := (<-this.LoadAccounts())
            PanicOnError(retRes304483)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes723636 := (<-this.LoadMarkets())
            PanicOnError(retRes723636)
        
            retRes584363 := (<-this.LoadAccounts())
            PanicOnError(retRes584363)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes712280 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes712280)
                ch <- retRes712280
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes392479 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes392479)
                ch <- retRes392479
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes505885 := (<-this.LoadMarkets())
            PanicOnError(retRes505885)
            var currency interface{} = this.Currency(code)
