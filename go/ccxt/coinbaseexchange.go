...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes147729 := (<-this.LoadMarkets())
            PanicOnError(retRes147729)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes332323 := (<-this.LoadMarkets())
            PanicOnError(retRes332323)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes770038 := (<-this.LoadMarkets())
            PanicOnError(retRes770038)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes507762 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes507762)
                    ch <- retRes507762
                    return nil
            }
        
            retRes948611 := (<-this.LoadMarkets())
            PanicOnError(retRes948611)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes594228 := (<-this.LoadMarkets())
            PanicOnError(retRes594228)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes247464 := (<-this.LoadMarkets())
            PanicOnError(retRes247464)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes587528 := (<-this.LoadMarkets())
            PanicOnError(retRes587528)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes289124 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes289124)
                    ch <- retRes289124
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes80484 := (<-this.LoadMarkets())
            PanicOnError(retRes80484)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes518475 := (<-this.LoadMarkets())
            PanicOnError(retRes518475)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes436492 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes436492)
                ch <- retRes436492
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes843815 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes843815)
                    ch <- retRes843815
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes120149 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes120149)
                ch <- retRes120149
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes507498 := (<-this.LoadMarkets())
            PanicOnError(retRes507498)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes555860 := (<-this.LoadMarkets())
            PanicOnError(retRes555860)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes298717 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes298717)
                ch <- retRes298717
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes170079 := (<-this.LoadMarkets())
            PanicOnError(retRes170079)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes585279 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes585279)
                ch <- retRes585279
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes897092 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes897092)
                ch <- retRes897092
                return nil
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes82025 := (<-this.LoadMarkets())
            PanicOnError(retRes82025)
        
            retRes465629 := (<-this.LoadAccounts())
            PanicOnError(retRes465629)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes255255 := (<-this.LoadMarkets())
            PanicOnError(retRes255255)
        
            retRes374036 := (<-this.LoadAccounts())
            PanicOnError(retRes374036)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes404815 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes235804 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes235804)
                ch <- retRes235804
                return nil
