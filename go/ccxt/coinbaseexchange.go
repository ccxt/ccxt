...
func  (this *coinbaseexchange) FetchAccounts(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes390426 := (<-this.LoadMarkets())
            PanicOnError(retRes390426)
...
func  (this *coinbaseexchange) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes121334 := (<-this.LoadMarkets())
            PanicOnError(retRes121334)
...
func  (this *coinbaseexchange) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes202833 := (<-this.LoadMarkets())
            PanicOnError(retRes202833)
...
func  (this *coinbaseexchange) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes314368 := (<-this.LoadMarkets())
            PanicOnError(retRes314368)
...
func  (this *coinbaseexchange) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes172902 := (<-this.LoadMarkets())
            PanicOnError(retRes172902)
...
func  (this *coinbaseexchange) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            if IsTrue(paginate) {
                    ...
                    retRes807446 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params, 100))
                    PanicOnError(retRes807446)
                    ch <- retRes807446
                    return nil
            }
        
            retRes907745 := (<-this.LoadMarkets())
            PanicOnError(retRes907745)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
...
func  (this *coinbaseexchange) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes279128 := (<-this.LoadMarkets())
            PanicOnError(retRes279128)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "id": GetValue(market, "id"),
            }
...
func  (this *coinbaseexchange) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes857180 := (<-this.LoadMarkets())
            PanicOnError(retRes857180)
...
func  (this *coinbaseexchange) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes241583 := (<-this.LoadMarkets())
            PanicOnError(retRes241583)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes84655 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 300))
                    PanicOnError(retRes84655)
                    ch <- retRes84655
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *coinbaseexchange) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes739229 := (<-this.LoadMarkets())
            PanicOnError(retRes739229)
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchOrderTrades(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117646 := (<-this.LoadMarkets())
            PanicOnError(retRes117646)
...
func  (this *coinbaseexchange) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes500612 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes500612)
                ch <- retRes500612
                return nil
...
func  (this *coinbaseexchange) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes612517 := (<-this.LoadMarkets())
            PanicOnError(retRes612517)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes568559 :=  (<-this.FetchPaginatedCallDynamic("fetchOpenOrders", symbol, since, limit, params, 100))
                    PanicOnError(retRes568559)
                    ch <- retRes568559
                    return nil
            }
            var request interface{} = map[string]interface{} {}
...
func  (this *coinbaseexchange) FetchClosedOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            var request interface{} = map[string]interface{} {
                ...
                retRes221221 :=  (<-this.FetchOpenOrders(symbol, since, limit, this.Extend(request, params)))
                PanicOnError(retRes221221)
                ch <- retRes221221
                return nil
...
func  (this *coinbaseexchange) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes164674 := (<-this.LoadMarkets())
            PanicOnError(retRes164674)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "type": typeVar,
                "side": side,
...
func  (this *coinbaseexchange) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes292295 := (<-this.LoadMarkets())
            PanicOnError(retRes292295)
            var request interface{} = map[string]interface{} {}
            var clientOrderId interface{} = this.SafeString2(params, "clientOrderId", "client_oid")
            var method interface{} = nil
            if IsTrue(IsEqual(clientOrderId, nil)) {
            ...
            if IsTrue(!IsEqual(symbol, nil)) {
                ...
                retRes152722 :=  (<-this.callDynamically(method, this.Extend(request, params)))
                PanicOnError(retRes152722)
                ch <- retRes152722
                return nil
...
func  (this *coinbaseexchange) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes171238 := (<-this.LoadMarkets())
            PanicOnError(retRes171238)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
                ...
                retRes999451 :=  (<-this.PrivateDeleteOrders(this.Extend(request, params)))
                PanicOnError(retRes999451)
                ch <- retRes999451
                return nil
...
func  (this *coinbaseexchange) FetchPaymentMethods(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes717321 :=  (<-this.PrivateGetPaymentMethods(params))
                PanicOnError(retRes717321)
                ch <- retRes717321
                return nil
...
func  (this *coinbaseexchange) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes277450 := (<-this.LoadMarkets())
            PanicOnError(retRes277450)
...
func  (this *coinbaseexchange) FetchLedger(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes872064 := (<-this.LoadMarkets())
            PanicOnError(retRes872064)
        
            retRes451105 := (<-this.LoadAccounts())
            PanicOnError(retRes451105)
            var currency interface{} = this.Currency(code)
...
func  (this *coinbaseexchange) FetchDepositsWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes617263 := (<-this.LoadMarkets())
            PanicOnError(retRes617263)
        
            retRes205137 := (<-this.LoadAccounts())
            PanicOnError(retRes205137)
...
func  (this *coinbaseexchange) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes846172 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "deposit",
            }, params)))
                PanicOnError(retRes846172)
                ch <- retRes846172
                return nil
...
func  (this *coinbaseexchange) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            _ = params
                ...
                retRes434541 :=  (<-this.FetchDepositsWithdrawals(code, since, limit, this.Extend(map[string]interface{} {
                "type": "withdraw",
            }, params)))
                PanicOnError(retRes434541)
                ch <- retRes434541
                return nil
...
func  (this *coinbaseexchange) CreateDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes900352 := (<-this.LoadMarkets())
            PanicOnError(retRes900352)
            var currency interface{} = this.Currency(code)
