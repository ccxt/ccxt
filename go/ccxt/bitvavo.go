...
func  (this *bitvavo) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes247826 := (<-this.LoadMarkets())
            PanicOnError(retRes247826)
...
func  (this *bitvavo) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes302825 := (<-this.LoadMarkets())
            PanicOnError(retRes302825)
...
func  (this *bitvavo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes378413 := (<-this.LoadMarkets())
            PanicOnError(retRes378413)
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes341195 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes341195)
                    ch <- retRes341195
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bitvavo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes401497 := (<-this.LoadMarkets())
            PanicOnError(retRes401497)
...
func  (this *bitvavo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes315410 := (<-this.LoadMarkets())
            PanicOnError(retRes315410)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes777468 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1440))
                    PanicOnError(retRes777468)
                    ch <- retRes777468
                    return nil
            }
...
func  (this *bitvavo) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes836044 := (<-this.LoadMarkets())
            PanicOnError(retRes836044)
...
func  (this *bitvavo) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes333014 := (<-this.LoadMarkets())
            PanicOnError(retRes333014)
...
func  (this *bitvavo) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes517589 := (<-this.LoadMarkets())
            PanicOnError(retRes517589)
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes639877 := (<-this.LoadMarkets())
            PanicOnError(retRes639877)
            var request interface{} = map[string]interface{} {}
...
func  (this *bitvavo) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes527342 := (<-this.LoadMarkets())
            PanicOnError(retRes527342)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *bitvavo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes815043 := (<-this.LoadMarkets())
            PanicOnError(retRes815043)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes737495 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes737495)
                    ch <- retRes737495
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes854009 := (<-this.LoadMarkets())
            PanicOnError(retRes854009)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitvavo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes208452 := (<-this.LoadMarkets())
            PanicOnError(retRes208452)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes459320 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes459320)
                    ch <- retRes459320
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes675401 := (<-this.LoadMarkets())
            PanicOnError(retRes675401)
...
func  (this *bitvavo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes568856 := (<-this.LoadMarkets())
            PanicOnError(retRes568856)
...
func  (this *bitvavo) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes811578 := (<-this.LoadMarkets())
            PanicOnError(retRes811578)
