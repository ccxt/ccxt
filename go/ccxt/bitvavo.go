...
func  (this *bitvavo) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes711130 := (<-this.LoadMarkets())
            PanicOnError(retRes711130)
...
func  (this *bitvavo) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes703617 := (<-this.LoadMarkets())
            PanicOnError(retRes703617)
...
func  (this *bitvavo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes156881 := (<-this.LoadMarkets())
            PanicOnError(retRes156881)
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes637449 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes637449)
                    ch <- retRes637449
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bitvavo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes40787 := (<-this.LoadMarkets())
            PanicOnError(retRes40787)
...
func  (this *bitvavo) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes731618 := (<-this.LoadMarkets())
            PanicOnError(retRes731618)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *bitvavo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes629359 := (<-this.LoadMarkets())
            PanicOnError(retRes629359)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes444263 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1440))
                    PanicOnError(retRes444263)
                    ch <- retRes444263
                    return nil
            }
...
func  (this *bitvavo) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes646932 := (<-this.LoadMarkets())
            PanicOnError(retRes646932)
...
func  (this *bitvavo) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes149631 := (<-this.LoadMarkets())
            PanicOnError(retRes149631)
...
func  (this *bitvavo) CreateOrder(symbol interface{}, typeVar interface{}, side interface{}, amount interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes401856 := (<-this.LoadMarkets())
            PanicOnError(retRes401856)
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes57211 := (<-this.LoadMarkets())
            PanicOnError(retRes57211)
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes350534 := (<-this.LoadMarkets())
            PanicOnError(retRes350534)
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes219286 := (<-this.LoadMarkets())
            PanicOnError(retRes219286)
            var request interface{} = map[string]interface{} {}
...
func  (this *bitvavo) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes687128 := (<-this.LoadMarkets())
            PanicOnError(retRes687128)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *bitvavo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes271763 := (<-this.LoadMarkets())
            PanicOnError(retRes271763)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes625645 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes625645)
                    ch <- retRes625645
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes742292 := (<-this.LoadMarkets())
            PanicOnError(retRes742292)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitvavo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes11962 := (<-this.LoadMarkets())
            PanicOnError(retRes11962)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes356102 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes356102)
                    ch <- retRes356102
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) Withdraw(code interface{}, amount interface{}, address interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes201698 := (<-this.LoadMarkets())
            PanicOnError(retRes201698)
            var currency interface{} = this.Currency(code)
...
func  (this *bitvavo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes481827 := (<-this.LoadMarkets())
            PanicOnError(retRes481827)
...
func  (this *bitvavo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes372383 := (<-this.LoadMarkets())
            PanicOnError(retRes372383)
...
func  (this *bitvavo) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes202118 := (<-this.LoadMarkets())
            PanicOnError(retRes202118)
