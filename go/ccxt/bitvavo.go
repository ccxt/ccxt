...
func  (this *bitvavo) FetchTicker(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes130280 := (<-this.LoadMarkets())
            PanicOnError(retRes130280)
...
func  (this *bitvavo) FetchTickers(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes639434 := (<-this.LoadMarkets())
            PanicOnError(retRes639434)
...
func  (this *bitvavo) FetchTrades(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes677012 := (<-this.LoadMarkets())
            PanicOnError(retRes677012)
            var market interface{} = this.Market(symbol)
            ...
            if IsTrue(paginate) {
                    ...
                    retRes498576 :=  (<-this.FetchPaginatedCallDynamic("fetchTrades", symbol, since, limit, params))
                    PanicOnError(retRes498576)
                    ch <- retRes498576
                    return nil
            }
            var request interface{} = map[string]interface{} {
...
func  (this *bitvavo) FetchTradingFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes954920 := (<-this.LoadMarkets())
            PanicOnError(retRes954920)
...
func  (this *bitvavo) FetchOrderBook(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes931465 := (<-this.LoadMarkets())
            PanicOnError(retRes931465)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *bitvavo) FetchOHLCV(symbol interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes820817 := (<-this.LoadMarkets())
            PanicOnError(retRes820817)
            var market interface{} = this.Market(symbol)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes380593 :=  (<-this.FetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit, timeframe, params, 1440))
                    PanicOnError(retRes380593)
                    ch <- retRes380593
                    return nil
            }
...
func  (this *bitvavo) FetchBalance(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes168026 := (<-this.LoadMarkets())
            PanicOnError(retRes168026)
...
func  (this *bitvavo) FetchDepositAddress(code interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes490873 := (<-this.LoadMarkets())
            PanicOnError(retRes490873)
...
func  (this *bitvavo) EditOrder(id interface{}, symbol interface{}, typeVar interface{}, side interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes84730 := (<-this.LoadMarkets())
            PanicOnError(retRes84730)
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) CancelOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes452745 := (<-this.LoadMarkets())
            PanicOnError(retRes452745)
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) CancelAllOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes821528 := (<-this.LoadMarkets())
            PanicOnError(retRes821528)
            var request interface{} = map[string]interface{} {}
...
func  (this *bitvavo) FetchOrder(id interface{}, optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes432759 := (<-this.LoadMarkets())
            PanicOnError(retRes432759)
            var market interface{} = this.Market(symbol)
            var request interface{} = map[string]interface{} {
                "market": GetValue(market, "id"),
            }
...
func  (this *bitvavo) FetchOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes340129 := (<-this.LoadMarkets())
            PanicOnError(retRes340129)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes611184 :=  (<-this.FetchPaginatedCallDynamic("fetchOrders", symbol, since, limit, params))
                    PanicOnError(retRes611184)
                    ch <- retRes611184
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) FetchOpenOrders(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes576983 := (<-this.LoadMarkets())
            PanicOnError(retRes576983)
            var request interface{} = map[string]interface{} {}
            var market interface{} = nil
            if IsTrue(!IsEqual(symbol, nil)) {
                market = this.Market(symbol)
...
func  (this *bitvavo) FetchMyTrades(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes265199 := (<-this.LoadMarkets())
            PanicOnError(retRes265199)
            var paginate interface{} = false
            ...
            if IsTrue(paginate) {
                    ...
                    retRes663815 :=  (<-this.FetchPaginatedCallDynamic("fetchMyTrades", symbol, since, limit, params))
                    PanicOnError(retRes663815)
                    ch <- retRes663815
                    return nil
            }
            var market interface{} = this.Market(symbol)
...
func  (this *bitvavo) FetchWithdrawals(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes456332 := (<-this.LoadMarkets())
            PanicOnError(retRes456332)
...
func  (this *bitvavo) FetchDeposits(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes117913 := (<-this.LoadMarkets())
            PanicOnError(retRes117913)
...
func  (this *bitvavo) FetchDepositWithdrawFees(optionalArgs ...interface{}) <- chan interface{} {
            ...
            retRes192269 := (<-this.LoadMarkets())
            PanicOnError(retRes192269)
