...
public partial class binanceWs { public binanceWs(object args = null) : base(args) { } }
public partial class binanceWs : binance
{
    ...
    public async virtual Task keepAliveListenKey(object parameters = null)
    {
        ...
        object clients = new List<object>(((Dictionary<string, ccxt.Exchange.WebSocketClient>)this.clients).Values);
        object listenKeyRefreshRate = this.safeInteger(this.options, "listenKeyRefreshRate", 1200000);
    ...
    public virtual void handleBalance(WebSocketClient client, object message)
    {
        ...
        object subscriptions = new List<object>(((Dictionary<string,object>)((WebSocketClient)client).subscriptions).Keys);
