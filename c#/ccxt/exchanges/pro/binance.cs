...
public partial class binance
{
    ...
    public virtual object requestId(object url)
    {
        ...
        ((Dictionary<string, object>)getValue(this.options, "requestId"))[(string)url] = newValue;
        return newValue;
    }

    public virtual object stream(object type, object subscriptionHash)
    {
        ...
        if (isTrue(isEqual(stream, null)))
        {
            ...
            ((Dictionary<string, object>)this.options)["streamIndex"] = streamIndex;
            stream = this.numberToString(normalizedIndex);
            ((Dictionary<string, object>)getValue(this.options, "streamBySubscriptionsHash"))[(string)subscriptionHash] = stream;
        }
        return stream;
    }
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ...
            else
            {
                ...
                {
                    throw new ExchangeError((string)add(this.id, " watchOrderBook limit argument must be less than or equal to 5000"));
                }
            }
        }
        ...
        object request = new Dictionary<string, object>() {
            { "method", "SUBSCRIBE" },
            { "params", new List<object>() {add(add(add(messageHash, "@"), watchOrderBookRate), "ms")} },
            { "id", requestId },
        };
        ...
        return (orderbook as ccxt.OrderBook).limit();
    }
    ...
    public async override Task<object> watchOrderBookForSymbols(object symbols, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object name = "depth";
        object messageHash = add("multipleOrderbook::", String.Join(",", ((List<object>)symbols).ToArray()));
        object url = add(add(getValue(getValue(getValue(this.urls, "api"), "ws"), type), "/"), this.stream(type, "multipleOrderbook"));
        object requestId = this.requestId(url);
        object watchOrderBookRate = this.safeString(this.options, "watchOrderBookRate", "100");
        ...
        for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
        {
            ...
            object market = this.market(symbol);
            object symbolHash = add(add(add(add(add(getValue(market, "lowercaseId"), "@"), name), "@"), watchOrderBookRate), "ms");
    ...
    public async virtual Task fetchOrderBookSnapshot(WebSocketClient client, object message, object subscription)
    {
        ...
        try
        {
            ...
            (orderbook as ccxt.OrderBook).reset(snapshot);
            // unroll the accumulated deltas
            object messages = (orderbook as ccxt.OrderBook).cache;
            ...
            ((Dictionary<string, object>)this.orderbooks)[(string)symbol] = orderbook;
    ...
    public override void handleDelta(object bookside, object delta)
    {
        ...
        (bookside as OrderBookSide).store(price, amount);
    }
    ...
    public virtual object handleOrderBookMessage(WebSocketClient client, object message, object orderbook)
    {
        ...
        ((Dictionary<string, object>)orderbook)["nonce"] = u;
        object timestamp = this.safeInteger(message, "E");
        ((Dictionary<string, object>)orderbook)["timestamp"] = timestamp;
        ((Dictionary<string, object>)orderbook)["datetime"] = this.iso8601(timestamp);
        return orderbook;
    }
    ...
    public virtual void handleOrderBook(WebSocketClient client, object message)
    {
        ...
        {
            // 2. Buffer the events you receive from the stream.
            ((List<object>)(orderbook as ccxt.OrderBook).cache).Add(message);
        }
        else
        {
            try
                    ...
                    if (isTrue(isGreaterThan(u, getValue(orderbook, "nonce"))))
                    {
                        ...
                        if (isTrue(conditional))
                        {
                            ...
                            if (isTrue(isLessThan(nonce, getValue(orderbook, "nonce"))))
                            {
                                ...
                                this.resolvePromiseIfMessagehashMatches(client as WebSocketClient, "multipleOrderbook::", symbol, orderbook);
                            }
                        }
                        else
                        {
    ...
    public virtual void handleOrderBookSubscription(WebSocketClient client, object message, object subscription)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)this.orderbooks)[(string)symbol] = this.orderBook(new Dictionary<string, object>() { }, limit);
    ...
    public virtual object handleSubscriptionStatus(WebSocketClient client, object message)
    {
        ...
        {
            (method as MethodInfo).Invoke(this, new object[] { client, message, subscription });
        }
        return message;
    }
    ...
    public async override Task<object> watchTradesForSymbols(object symbols, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
        {
            ...
            ((List<object>)subParams).Add(currentMessageHash);
        }
        object messageHash = add("multipleTrades::", String.Join(",", ((List<object>)symbols).ToArray()));
        ...
        object trades = await this.watch(url, messageHash, this.extend(request, query), messageHash, subscribe);
    ...
    public async override Task<object> watchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object options = this.safeValue(this.options, "watchTrades", new Dictionary<string, object>() { });
        object name = this.safeString(options, "name", "trade");
        object messageHash = add(add(getValue(market, "lowercaseId"), "@"), name);
        object type = getValue(market, "type");
        if (isTrue(getValue(market, "contract")))
    ...
    public virtual void handleTrade(WebSocketClient client, object message)
    {
        ...
        ((Dictionary<string, object>)this.trades)[(string)symbol] = tradesArray;
        callDynamically(client as WebSocketClient, "resolve", new object[] { tradesArray, messageHash });
        // watchTradesForSymbols part
        this.resolvePromiseIfMessagehashMatches(client as WebSocketClient, "multipleTrades::", symbol, tradesArray);
    }
    ...
    public async override Task<object> watchOHLCVForSymbols(object symbolsAndTimeframes, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object name = this.safeString(parameters, "name", nameOption);
        parameters = this.omit(parameters, "name");
        object firstMarket = this.market(getValue(getValue(symbolsAndTimeframes, 0), 0));
        object type = getValue(firstMarket, "type");
        if (isTrue(getValue(firstMarket, "contract")))
        {
            type = ((bool)isTrue(getValue(firstMarket, "linear"))) ? "future" : "delivery";
        ...
        for (object i = 0; isLessThan(i, getArrayLength(symbolsAndTimeframes)); postFixIncrement(ref i))
        {
            ...
            object symbolString = getValue(data, 0);
            object timeframeString = getValue(data, 1);
            ...
            object topic = add(add(add(add(marketId, "@"), name), "_"), interval);
            ((List<object>)subParams).Add(topic);
            ((List<object>)hashes).Add(add(add(symbolString, "#"), timeframeString));
        }
        object messageHash = add("multipleOHLCV::", String.Join(",", ((List<object>)hashes).ToArray()));
        object url = add(add(getValue(getValue(getValue(this.urls, "api"), "ws"), type), "/"), this.stream(type, messageHash));
        object requestId = this.requestId(url);
        object request = new Dictionary<string, object>() {
            { "method", "SUBSCRIBE" },
        ...
        var symboltimeframestoredVariable = await this.watch(url, messageHash, this.extend(request, parameters), messageHash, subscribe);
        var symbol = ((List<object>)symboltimeframestoredVariable)[0];
        var timeframe = ((List<object>)symboltimeframestoredVariable)[1];
        var stored = ((List<object>)symboltimeframestoredVariable)[2];
        if (isTrue(this.newUpdates))
        {
    ...
    public virtual void handleOHLCV(WebSocketClient client, object message)
    {
        ...
        object marketType = ((bool)isTrue((isSpot))) ? "spot" : "contract";
        object symbol = this.safeSymbol(marketId, null, null, marketType);
        ((Dictionary<string, object>)this.ohlcvs)[(string)symbol] = this.safeValue(this.ohlcvs, symbol, new Dictionary<string, object>() { });
        object stored = this.safeValue(getValue(this.ohlcvs, symbol), timeframe);
        if (isTrue(isEqual(stored, null)))
        {
            object limit = this.safeInteger(this.options, "OHLCVLimit", 1000);
            stored = new ArrayCacheByTimestamp(limit);
            ((Dictionary<string, object>)getValue(this.ohlcvs, symbol))[(string)timeframe] = stored;
        }
        callDynamically(stored, "append", new object[] { parsed });
        callDynamically(client as WebSocketClient, "resolve", new object[] { stored, messageHash });
        // watchOHLCVForSymbols part
        this.resolveMultipleOHLCV(client as WebSocketClient, "multipleOHLCV::", symbol, timeframe, stored);
    }
    ...
    public async override Task<object> watchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            messageHash = add("tickers::", String.Join(",", ((List<object>)symbols).ToArray()));
        }
        if (isTrue(isEqual(name, "bookTicker")))
        {
            ...
            {
                ((List<object>)wsParams).Add(add(((string)getValue(marketIds, i)).ToLower(), "@bookTicker"));
            }
        }
        else
        {
    ...
    public virtual object parseWsTicker(object message, object marketType)
    {
        ...
        object marketId = this.safeString(message, "s");
        object symbol = this.safeSymbol(marketId, null, null, marketType);
        object last = this.safeFloat(message, "c");
    ...
    public virtual void handleTicker(WebSocketClient client, object message)
    {
        ...
        ((Dictionary<string, object>)this.tickers)[(string)symbol] = result;
    ...
    public virtual void handleTickers(WebSocketClient client, object message)
    {
        ...
        if (isTrue((message.GetType().IsGenericType && message.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
            rawTickers = message;
        }
        else
        ...
        for (object i = 0; isLessThan(i, getArrayLength(messageHashes)); postFixIncrement(ref i))
        {
            ...
            object tickersSymbols = new List<object>(((Dictionary<string, object>)tickers).Keys);
    ...
    public virtual object signParams(object parameters = null)
    {
        ...
        {
            ((Dictionary<string, object>)parameters)["recvWindow"] = defaultRecvWindow;
        }
        object recvWindow = this.safeInteger(parameters, "recvWindow");
        if (isTrue(!isEqual(recvWindow, null)))
        {
            ((Dictionary<string, object>)parameters)["recvWindow"] = recvWindow;
        }
        ...
        ((Dictionary<string, object>)extendedParams)["signature"] = signature;
    ...
    public async virtual Task authenticate(object parameters = null)
    {
        ...
        {
            object method = "publicPostUserDataStream";
            if (isTrue(isEqual(type, "future")))
            {
            ...
            ((Dictionary<string, object>)this.options)[(string)type] = this.extend(options, new Dictionary<string, object>() {
    ...
    public async virtual Task keepAliveListenKey(object parameters = null)
    {
        ...
        catch (Exception error)
        {
            ...
            object messageHashes = new List<object>(((Dictionary<string, object>)client.futures).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(messageHashes)); postFixIncrement(ref i))
            {
                object messageHash = getValue(messageHashes, i);
        ...
        var clients = new List<object>(((Dictionary<string, object>)this.clients).Values);
        object listenKeyRefreshRate = this.safeInteger(this.options, "listenKeyRefreshRate", 1200000);
        for (object i = 0; isLessThan(i, getArrayLength(clients)); postFixIncrement(ref i))
        {
            var client = getValue(clients, i);
            object subscriptionKeys = new List<object>(((Dictionary<string, object>)((object)client).subscriptions).Keys);
    ...
    {
        if (isTrue(inOp(client.subscriptions, type)))
        {
            return;
        }
        object options = this.safeValue(this.options, "watchBalance");
        object fetchBalanceSnapshot = this.safeValue(options, "fetchBalanceSnapshot", false);
        ...
        {
            ((Dictionary<string, object>)this.balance)[(string)type] = new Dictionary<string, object>() { };
        }
    }
    ...
    public async virtual Task loadBalanceSnapshot(WebSocketClient client, object messageHash, object type)
    {
        ...
        ((Dictionary<string, object>)this.balance)[(string)type] = this.extend(response, this.safeValue(this.balance, type, new Dictionary<string, object>() { }));
        // don't remove the future from the .futures cache
        object future = getValue(client.futures, messageHash);
    ...
    public async override Task<object> watchBalance(object parameters = null)
    {
        ...
        */
        ...
        object options = this.safeValue(this.options, "watchBalance");
        object fetchBalanceSnapshot = this.safeValue(options, "fetchBalanceSnapshot", false);
        object awaitBalanceSnapshot = this.safeValue(options, "awaitBalanceSnapshot", true);
    ...
    public virtual void handleBalance(WebSocketClient client, object message)
    {
        ...
        object subscriptions = new List<object>(((Dictionary<string, object>)client.subscriptions).Keys);
        ...
        {
            ((Dictionary<string, object>)this.balance)[(string)accountType] = new Dictionary<string, object>() { };
        }
        ((Dictionary<string, object>)getValue(this.balance, accountType))["info"] = message;
        object eventVar = this.safeString(message, "e");
        if (isTrue(isEqual(eventVar, "balanceUpdate")))
        {
            ...
            if (isTrue(inOp(getValue(this.balance, accountType), code)))
            {
                ...
                if (isTrue(!((previousValue).GetType() == typeof(string))))
                {
                    previousValue = this.numberToString(previousValue);
                }
                ((Dictionary<string, object>)account)["free"] = Precise.stringAdd(previousValue, delta);
            }
            else
            {
                ((Dictionary<string, object>)account)["free"] = delta;
            }
            ((Dictionary<string, object>)getValue(this.balance, accountType))[(string)code] = account;
        }
        else
        {
            ...
            for (object i = 0; isLessThan(i, getArrayLength(B)); postFixIncrement(ref i))
            {
                ...
                object code = this.safeCurrencyCode(currencyId);
                object account = this.account();
                ((Dictionary<string, object>)account)["free"] = this.safeString(entry, "f");
                ((Dictionary<string, object>)account)["used"] = this.safeString(entry, "l");
                ((Dictionary<string, object>)account)["total"] = this.safeString(entry, wallet);
                ((Dictionary<string, object>)getValue(this.balance, accountType))[(string)code] = account;
            }
        }
        object timestamp = this.safeInteger(message, "E");
        ((Dictionary<string, object>)getValue(this.balance, accountType))["timestamp"] = timestamp;
        ((Dictionary<string, object>)getValue(this.balance, accountType))["datetime"] = this.iso8601(timestamp);
        ((Dictionary<string, object>)this.balance)[(string)accountType] = this.safeBalance(getValue(this.balance, accountType));
    ...
    public async override Task<object> cancelOrderWs(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)payload)["origClientOrderId"] = clientOrderId;
        }
        else
        {
            ((Dictionary<string, object>)payload)["orderId"] = this.parseToInt(id);
        }
    ...
    public async override Task<object> fetchOpenOrdersWs(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ((Dictionary<string, object>)payload)["symbol"] = this.marketId(symbol);
        }
        object message = new Dictionary<string, object>() {
            { "id", messageHash },
    ...
    public override object parseWsOrder(object order, object market = null)
    {
        ...
        object trades = null;
        var clientOrderId = this.safeString(order, "C");
    ...
    public async override Task<object> watchPositions(object symbols = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (!isTrue(this.isEmpty(symbols)))
        {
            ...
            messageHash = add("::", String.Join(",", ((List<object>)symbols).ToArray()));
        }
        object type = this.handleMarketTypeAndParams("watchPositions", market, parameters);
    ...
    public virtual void setPositionsCache(WebSocketClient client, object type, object symbols = null)
    {
        ...
        {
            ((Dictionary<string, object>)this.positions)[(string)type] = new ArrayCacheBySymbolBySide();
        }
    }
    ...
    public virtual void handlePositions(WebSocketClient client, object message)
    {
        ...
        {
            ((Dictionary<string, object>)this.positions)[(string)accountType] = new ArrayCacheBySymbolBySide();
        }
        ...
        for (object i = 0; isLessThan(i, getArrayLength(rawPositions)); postFixIncrement(ref i))
        {
            ...
            object timestamp = this.safeInteger(message, "E");
            ((Dictionary<string, object>)position)["timestamp"] = timestamp;
            ((Dictionary<string, object>)position)["datetime"] = this.iso8601(timestamp);
    ...
    public async override Task<object> fetchMyTradesWs(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)payload)["startTime"] = since;
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)payload)["limit"] = limit;
        }
                    ...
                    if (isTrue(!isEqual(order, null)))
                    {
                        ...
                        if (!isTrue(this.isEmpty(fees)))
                        {
                            ...
                            for (object i = 0; isLessThan(i, getArrayLength(fees)); postFixIncrement(ref i))
                            {
                                ...
                                if (isTrue(isEqual(getValue(orderFee, "currency"), getValue(tradeFee, "currency"))))
                                {
                                    ...
                                    ((Dictionary<string, object>)getValue(getValue(order, "fees"), i))["cost"] = parseFloat(this.currencyToPrecision(getValue(tradeFee, "currency"), feeCost));
                            ...
                            {
                                ((List<object>)getValue(order, "fees")).Add(tradeFee);
                            }
                        }
                        else if (isTrue(!isEqual(fee, null)))
                        {
                            if (isTrue(isEqual(getValue(fee, "currency"), getValue(tradeFee, "currency"))))
                            {
                                ...
                                ((Dictionary<string, object>)getValue(order, "fee"))["cost"] = parseFloat(this.currencyToPrecision(getValue(tradeFee, "currency"), feeCost));
                            }
                            else if (isTrue(isEqual(getValue(fee, "currency"), null)))
                            {
                                ((Dictionary<string, object>)order)["fee"] = tradeFee;
                            }
                            else
                            {
                                ((Dictionary<string, object>)order)["fees"] = new List<object>() { fee, tradeFee };
                                ((Dictionary<string, object>)order)["fee"] = null;
                            }
                        }
                        else
                        {
                        ...
                        ((Dictionary<string, object>)order)["trades"] = orderTrades;
                    }
                }
            }
    ...
    public virtual void handleOrder(WebSocketClient client, object message)
    {
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            if (isTrue(!isEqual(order, null)))
            {
                ...
                {
                    ((Dictionary<string, object>)parsed)["fee"] = fee;
                }
                object fees = this.safeValue(order, "fees");
                if (isTrue(!isEqual(fees, null)))
                {
                    ((Dictionary<string, object>)parsed)["fees"] = fees;
                }
                ((Dictionary<string, object>)parsed)["trades"] = this.safeValue(order, "trades");
                object timestamp = this.safeInteger(parsed, "timestamp");
                if (isTrue(isEqual(timestamp, null)))
                {
                    ((Dictionary<string, object>)parsed)["timestamp"] = this.safeInteger(order, "timestamp");
                    ((Dictionary<string, object>)parsed)["datetime"] = this.safeString(order, "datetime");
                }
            }
    ...
    public virtual void handleWsError(WebSocketClient client, object message)
    {
        ...
        catch (Exception e)
        {
            ...
            object subscriptionKeys = new List<object>(((Dictionary<string, object>)client.subscriptions).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(subscriptionKeys)); postFixIncrement(ref i))
            {
                ...
                object subscriptionId = this.safeString(getValue(client.subscriptions, subscriptionHash), "id");
    ...
    public override void handleMessage(WebSocketClient client, object message)
    {
        ...
        if (isTrue(!isEqual(method, null)))
        {
            (method as MethodInfo).Invoke(this, new object[] { client, message });
            return;
        }
        // handle other APIs
