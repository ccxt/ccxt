...
public partial class binanceWs : binance
{
    ...
    public async virtual Task keepAliveListenKey(object parameters = null)
    {
        ...
        } catch(Exception error)
        {
            ...
            object messageHashes = new List<object>(((Dictionary<string, ccxt.Exchange.Future>)client.futures).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(messageHashes)); postFixIncrement(ref i))
            {
                object messageHash = getValue(messageHashes, i);
        ...
        var clients = new List<object>(((Dictionary<string, ccxt.Exchange.WebSocketClient>)this.clients).Values);
        object listenKeyRefreshRate = this.safeInteger(this.options, "listenKeyRefreshRate", 1200000);
        for (object i = 0; isLessThan(i, getArrayLength(clients)); postFixIncrement(ref i))
        {
            var client = getValue(clients, i);
            object subscriptionKeys = new List<object>(((Dictionary<string,object>)((WebSocketClient)client).subscriptions).Keys);
