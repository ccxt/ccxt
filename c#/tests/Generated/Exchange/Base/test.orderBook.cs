...
{
    public static void testOrderBook(Exchange exchange, object method, object entry, object symbol)
    {
        ...
        object emptyNotAllowedFor = new List<object>() {"bids", "asks"};
        ...
        //
        object bids = getValue(entry, "bids");
        ...
        for (object i = 0; isLessThan(i, bidsLength); postFixIncrement(ref i))
        {
            ...
            testSharedMethods.assertGreater(exchange, method, getValue(bids, i), 0, "0");
            testSharedMethods.assertGreater(exchange, method, getValue(bids, i), 1, "0");
        }
        object asks = getValue(entry, "asks");
        ...
        for (object i = 0; isLessThan(i, asksLength); postFixIncrement(ref i))
        {
            ...
            testSharedMethods.assertGreater(exchange, method, getValue(asks, i), 0, "0");
            testSharedMethods.assertGreater(exchange, method, getValue(asks, i), 1, "0");
        }
