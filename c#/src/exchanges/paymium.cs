...
partial class paymium : Exchange
{
        ...
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "api", new Dictionary<string, object>() {
                { "public", new Dictionary<string, object>() {
                    { "get", new List<object>() {"countries", "data/{currency}/ticker", "data/{currency}/trades", "data/{currency}/depth", "bitcoin_charts/{id}/trades", "bitcoin_charts/{id}/depth"} },
                } },
    ...
    public virtual object parseBalance(object response)
    {
        ...
        object currencies = new List<string>(((Dictionary<string,object>)this.currencies).Keys);
