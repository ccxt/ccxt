...
partial class coinex : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        object coins = new List<string>(((Dictionary<string,object>)data).Keys);
        ...
        for (object i = 0; isLessThan(i, getArrayLength(coins)); postFixIncrement(ref i))
        {
            ...
            object precision = this.parseNumber(this.parsePrecision(this.safeString(currency, "withdrawal_precision")));
            ...
            ((Dictionary<string, object>)networks)[(string)networkId] = network;
            ((Dictionary<string, object>)getValue(result, code))["networks"] = networks;
        }
        return result;
    }
    ...
    public async override Task<object> fetchTicker(object symbol, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(getValue(market, "swap"))) ? "perpetualPublicGetMarketTicker" : "publicGetMarketTicker";
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue((isEqual(marketType, "swap")))) ? "perpetualPublicGetMarketTickerAll" : "publicGetMarketTickerAll";
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)ticker)["symbol"] = symbol;
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(getValue(market, "swap"))) ? "perpetualPublicGetMarketDepth" : "publicGetMarketDepth";
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        // Spot
        //
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(getValue(market, "swap"))) ? "perpetualPublicGetMarketDeals" : "publicGetMarketDeals";
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        // Spot and Swap
        //
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(this.symbols)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)result)[(string)symbol] = this.parseTradingFee(fee, market);
        }
        return result;
    }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(getValue(market, "swap"))) ? "perpetualPublicGetMarketKline" : "publicGetMarketKline";
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        // Spot
        //
    ...
    public async virtual Task<object> fetchMarginBalance(object parameters = null)
    {
        ...
        ((Dictionary<string, object>)sellAccount)["free"] = this.safeString(free, "sell_type");
        ((Dictionary<string, object>)sellAccount)["total"] = this.safeString(total, "sell_type");
        object sellDebt = this.safeString(loan, "sell_type");
        object sellInterest = this.safeString(interest, "sell_type");
        ((Dictionary<string, object>)sellAccount)["debt"] = Precise.stringAdd(sellDebt, sellInterest);
        ((Dictionary<string, object>)result)[(string)sellCurrencyCode] = sellAccount;
        //
        ...
        ((Dictionary<string, object>)buyAccount)["free"] = this.safeString(free, "buy_type");
        ((Dictionary<string, object>)buyAccount)["total"] = this.safeString(total, "buy_type");
        object buyDebt = this.safeString(loan, "buy_type");
        object buyInterest = this.safeString(interest, "buy_type");
        ((Dictionary<string, object>)buyAccount)["debt"] = Precise.stringAdd(buyDebt, buyInterest);
        ((Dictionary<string, object>)result)[(string)buyCurrencyCode] = buyAccount;
        //
    ...
    public async virtual Task<object> fetchSwapBalance(object parameters = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["free"] = this.safeString(balance, "available");
            ((Dictionary<string, object>)account)["used"] = this.safeString(balance, "frozen");
            ((Dictionary<string, object>)account)["total"] = this.safeString(balance, "balance_total");
            ((Dictionary<string, object>)result)[(string)code] = account;
        }
        return this.safeBalance(result);
    }
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object costString = this.safeString(order, "deal_money");
        object amountString = this.safeString(order, "amount");
        object filledString = this.safeString(order, "deal_amount");
        object averageString = this.safeString(order, "avg_price");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(swap))
        {
            ...
            {
                ((Dictionary<string, object>)request)["stop_type"] = this.safeInteger(parameters, "stop_type", 1); // 1: triggered by the latest transaction, 2: mark price, 3: index price
                ...
                ((Dictionary<string, object>)request)["position_id"] = positionId;
            ...
            {
                method = add("perpetualPrivatePostOrderPut", this.capitalize(type));
                side = ((bool) isTrue((isEqual(side, "buy")))) ? 2 : 1;
                ...
                if (isTrue(isTrue((!isEqual(type, "market"))) || isTrue((!isEqual(stopPrice, null)))))
                {
                    if (isTrue(postOnly))
                    {
                        ((Dictionary<string, object>)request)["option"] = 1;
                    } else if (isTrue(!isEqual(timeInForceRaw, null)))
                    {
                        ...
                        ((Dictionary<string, object>)request)["effect_type"] = timeInForce; // exchange takes 'IOC' and 'FOK'
                    }
                }
        ...
        {
            method = add("privatePostOrder", this.capitalize(type));
            ...
            if (isTrue(isTrue((isEqual(type, "market"))) && isTrue((isEqual(side, "buy")))))
            {
                if (isTrue(getValue(this.options, "createMarketBuyOrderRequiresPrice")))
                {
                    ...
                    } else
                    {
                        ...
                        object costString = Precise.stringMul(amountString, priceString);
                        object costNumber = this.parseNumber(costString);
                        ((Dictionary<string, object>)request)["amount"] = this.costToPrecision(symbol, costNumber);
                    }
                } else
                {
            ...
            if (isTrue(isTrue((!isEqual(type, "market"))) || isTrue((!isEqual(stopPrice, null)))))
            {
                ...
                if (isTrue(isTrue((!isEqual(timeInForceRaw, null))) || isTrue(postOnly)))
                {
                    ...
                    if (isTrue(postOnly))
                    {
                        ((Dictionary<string, object>)request)["option"] = "MAKER_ONLY";
                    } else
                    {
                        if (isTrue(!isEqual(timeInForceRaw, null)))
                        {
                            ((Dictionary<string, object>)request)["option"] = timeInForceRaw; // exchange takes 'IOC' and 'FOK'
                        }
                    }
                }
            }
        ...
        object defaultType = this.safeString(this.options, "defaultType");
        if (isTrue(isEqual(defaultType, "margin")))
        {
            ...
            ((Dictionary<string, object>)request)["account_id"] = accountId;
        }
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)request)[(string)idRequest] = id;
        object method = ((bool) isTrue(swap)) ? "perpetualPrivatePostOrderCancel" : "privateDeleteOrderPending";
        if (isTrue(stop))
        {
            if (isTrue(swap))
            {
        ...
        object query = this.omit(parameters, new List<object>() {"stop", "account_id"});
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(symbol, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " cancellAllOrders() requires a symbol argument")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(swap))
        {
            method = ((bool) isTrue(stop)) ? "perpetualPrivateGetOrderStopStatus" : "perpetualPrivateGetOrderStatus";
        } else
        {
    ...
    public async virtual Task<object> fetchOrdersByStatus(object status, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        if (isTrue(isEqual(marketType, "swap")))
        {
            ...
            method = add("perpetualPrivateGetOrder", this.capitalize(status));
            if (isTrue(stop))
            {
            ...
            ((Dictionary<string, object>)request)["offset"] = 0;
        } else
        {
            method = add("privateGetOrder", this.capitalize(status));
            if (isTrue(stop))
            {
                method = add("privateGetOrderStop", this.capitalize(status));
            }
            ((Dictionary<string, object>)request)["page"] = 1;
        }
        object accountId = this.safeInteger(parameters, "account_id");
        object defaultType = this.safeString(this.options, "defaultType");
        if (isTrue(isEqual(defaultType, "margin")))
    ...
    public async override Task<object> createDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("network"))))
        {
            object network = this.safeString(parameters, "network");
            parameters = this.omit(parameters, "network");
            ((Dictionary<string, object>)request)["smart_contract_name"] = network;
        }
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        object network = this.safeString(parameters, "network");
        parameters = this.omit(parameters, "network");
        object networksKeys = new List<string>(((Dictionary<string,object>)networks).Keys);
        ...
        if (isTrue(isTrue(!isEqual(networks, null)) && isTrue(isGreaterThan(numOfNetworks, 1))))
        {
            ...
            if (!isTrue((((Dictionary<string,object>)networks).ContainsKey(toStringOrNull(network)))))
            {
        ...
        object fillResponseFromRequest = this.safeValue(options, "fillResponseFromRequest", true);
        if (isTrue(fillResponseFromRequest))
        {
            ((Dictionary<string, object>)depositAddress)["network"] = this.safeNetworkCode(network, currency);
        }
    ...
    {
        object networks = this.safeValue(currency, "networks", new Dictionary<string, object>() {});
        object networksCodes = new List<string>(((Dictionary<string,object>)networks).Keys);
    ...
    public override object parseDepositAddress(object depositAddress, object currency = null)
    {
        ...
        object parts = ((string)coinAddress).Split((string)":").ToList<object>();
        object address = null;
        object tag = null;
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(swap))
        {
            ...
            if (isTrue(isEqual(side, null)))
            {
                throw new ArgumentsRequired ((string)add(this.id, " fetchMyTrades() requires a side parameter for swap markets")) ;
            }
    ...
    public async override Task<object> fetchPositions(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((List<object>)result).Add(this.parsePosition(getValue(position, i), market));
        }
    ...
    public override object parsePosition(object position, object market = null)
    {
        ...
        object contractSize = this.safeString(position, "amount");
    ...
    public async override Task<object> setLeverage(object leverage, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object defaultMarginMode = this.safeString2(this.options, "defaultMarginMode", "marginMode");
        object defaultPositionType = null;
        if (isTrue(isEqual(defaultMarginMode, "isolated")))
        {
            defaultPositionType = 1;
        } else if (isTrue(isEqual(defaultMarginMode, "cross")))
        {
            defaultPositionType = 2;
        }
        object positionType = this.safeInteger(parameters, "position_type", defaultPositionType);
        if (isTrue(isEqual(positionType, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " setLeverage() requires a position_type parameter that will transfer margin to the specified trading pair")) ;
        }
        object market = this.market(symbol);
        object maxLeverage = this.safeInteger(getValue(getValue(market, "limits"), "leverage"), "max", 100);
        if (isTrue(!isEqual(getValue(market, "type"), "swap")))
        ...
        if (isTrue(isTrue((isLessThan(leverage, 3))) || isTrue((isGreaterThan(leverage, maxLeverage)))))
        {
            throw new BadRequest ((string)add(add(add(add(this.id, " setLeverage() leverage should be between 3 and "), ((object)maxLeverage).ToString()), " for "), symbol)) ;
        }
        object request = new Dictionary<string, object>() {
            { "market", getValue(market, "id") },
            { "leverage", ((object)leverage).ToString() },
    ...
    public override object parseLeverageTiers(object response, object symbols = null, object marketIdKey = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            {
                ((Dictionary<string, object>)tiers)[(string)symbol] = this.parseMarketLeverageTiers(getValue(response, marketId), market);
            }
        }
        return tiers;
    }
    ...
    public async override Task<object> fetchFundingRate(object symbol, object parameters = null)
    {
        ...
        */
        ...
        object timestamp = this.safeInteger(data, "date");
        ((Dictionary<string, object>)ticker)["timestamp"] = timestamp; // avoid changing parseFundingRate signature
    ...
    public override object parseFundingRate(object contract, object market = null)
    {
        ...
        object fundingTimestamp = multiply(Math.Round((double)fundingHour), 3600000);
        return new Dictionary<string, object>() {
            { "info", contract },
            { "symbol", this.safeSymbol(null, market) },
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(isEqual(getIndexOf(marketId, "_"), -1)))
            {
                ...
                ((List<object>)result).Add(this.parseFundingRate(ticker, marketInner));
            }
        }
        return this.filterByArray(result, "symbol", symbols);
    }
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        object type = ((bool) isTrue((((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("coin_withdraw_id"))))) ? "withdrawal" : "deposit";
    ...
    public async override Task<object> transfer(object code, object amount, object fromAccount, object toAccount, object parameters = null)
    {
        ...
        */
        ...
        object method = "privatePostContractBalanceTransfer";
        if (isTrue(isTrue((isEqual(fromAccount, "spot"))) && isTrue((isEqual(toAccount, "swap")))))
        {
            ((Dictionary<string, object>)request)["transfer_side"] = "in"; // 'in' spot to swap, 'out' swap to spot
        } else if (isTrue(isTrue((isEqual(fromAccount, "swap"))) && isTrue((isEqual(toAccount, "spot")))))
        {
            ((Dictionary<string, object>)request)["transfer_side"] = "out"; // 'in' spot to swap, 'out' swap to spot
        } else
        {
            ...
            ((Dictionary<string, object>)request)["from_account"] = parseInt(fromId);
            ((Dictionary<string, object>)request)["to_account"] = parseInt(toId);
    ...
    public async virtual Task<object> fetchTransfers(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["page"] = page;
        }
        ...
        object defaultType = this.safeString(this.options, "defaultType");
        object method = ((bool) isTrue((isEqual(defaultType, "margin")))) ? "privateGetMarginTransferHistory" : "privateGetContractTransferHistory";
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        // Swap
        //
    ...
    public virtual object parseBorrowRate(object info, object currency = null)
    {
        ...
        object baseCurrencyData = this.safeValue(info, currency, new Dictionary<string, object>() {});
        return new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchBorrowRate(object code, object parameters = null)
    {
        ...
        */
        ...
        //
        object data = this.safeValue(response, "data", new Dictionary<string, object>() {});
        return this.parseBorrowRate(data, getValue(market, "base"));
    }
    ...
    public async override Task<object> fetchBorrowRates(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(data)); postFixIncrement(ref i))
        {
            ...
            object symbol = this.safeString(entry, "market");
            object market = this.safeMarket(symbol, null, null, "spot");
            object currencyData = this.safeValue(entry, getValue(market, "base"));
            ((List<object>)rates).Add(new Dictionary<string, object>() {
    ...
    public async virtual Task<object> repayMargin(object code, object amount, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object loanId = this.safeInteger(parameters, "loan_id");
    ...
    public async override Task<object> fetchDepositWithdrawFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(codes, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["coin_type"] = this.safeValue(codes, 0);
            }
        }
    ...
    public override object parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            object splitEntry = ((string)entry).Split((string)"-").ToList<object>();
            ...
            if (isTrue(isTrue((isEqual(codes, null))) || isTrue((this.inArray(code, codes)))))
            {
                ...
                ((Dictionary<string, object>)getValue(getValue(depositWithdrawFees, code), "info"))[(string)entry] = feeInfo;
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isTrue(isEqual(api, "perpetualPrivate")) || isTrue(isEqual(url, "https://api.coinex.com/perpetual/v1/market/user_deals"))))
        {
    ...
    public override object handleErrors(object httpCode, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        {
            object responseCodes = new Dictionary<string, object>() {
            ...
            object ErrorClass = this.safeValue(responseCodes, code, typeof(ExchangeError));
            throwDynamicException((string)ErrorClass, getValue(response, "message"));return null;
        }
        return null;
    }
}
