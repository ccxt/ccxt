...
partial class coinex : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        object coins = new List<object>(((Dictionary<string,object>)data).Keys);
        ...
        if (isTrue(swap))
        {
            ...
            } else
            {
                ...
                if (isTrue(!isEqual(stopPrice, null)))
                {
                    ...
                    ((Dictionary<string, object>)request)["side"] = requestSide;
    ...
    {
        object networks = this.safeValue(currency, "networks", new Dictionary<string, object>() {});
        object networksCodes = new List<object>(((Dictionary<string,object>)networks).Keys);
