...
partial class bitpanda : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "urls", new Dictionary<string, object>() {
                ...
                { "doc", new List<object>() {"https://developers.bitpanda.com/exchange/"} },
    ...
    public virtual object parseFeeTiers(object feeTiers, object market = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(feeTiers)); postFixIncrement(ref i))
        {
            ...
            ((List<object>)makerFees).Add(new List<object>() {volume, this.parseNumber(maker)});
            ((List<object>)takerFees).Add(new List<object>() {volume, this.parseNumber(taker)});
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        var periodunitVariable = ((string)periodUnit).Split((string)"/").ToList<object>();
        var period = ((List<object>) periodunitVariable)[0];
        var unit = ((List<object>) periodunitVariable)[1];
        object durationInSeconds = this.parseTimeframe(timeframe);
        object duration = multiply(durationInSeconds, 1000);
        if (isTrue(isEqual(limit, null)))
        {
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["to"] = this.iso8601(now);
            ((Dictionary<string, object>)request)["from"] = this.iso8601(subtract(now, multiply(limit, duration)));
        } else
        {
            ((Dictionary<string, object>)request)["from"] = this.iso8601(since);
            ((Dictionary<string, object>)request)["to"] = this.iso8601(this.sum(since, multiply(limit, duration)));
        }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["from"] = this.iso8601(since);
            ((Dictionary<string, object>)request)["to"] = this.iso8601(this.sum(since, 14400000));
        }
    ...
    public async override Task<object> fetchDeposits(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(code, null)))
        {
            ...
            ((Dictionary<string, object>)request)["currency_code"] = getValue(currency, "id");
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["max_page_size"] = limit;
        }
        if (isTrue(!isEqual(since, null)))
        {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            {
                ((Dictionary<string, object>)recipient)["destination_tag"] = tag;
            }
            ((Dictionary<string, object>)request)["recipient"] = recipient;
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(uppercaseType, "STOP")))
        {
            object triggerPrice = this.safeNumber(parameters, "trigger_price");
            if (isTrue(isEqual(triggerPrice, null)))
            {
                throw new ArgumentsRequired ((string)add(add(add(this.id, " createOrder() requires a trigger_price param for "), type), " orders")) ;
            }
            ((Dictionary<string, object>)request)["trigger_price"] = this.priceToPrecision(symbol, triggerPrice);
            parameters = this.omit(parameters, "trigger_price");
        }
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object market = this.market(symbol);
            ((Dictionary<string, object>)request)["instrument_code"] = getValue(market, "id");
        }
