...
partial class latoken : Exchange
{
        ...
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "exceptions", new Dictionary<string, object>() {
                ...
                { "broad", new Dictionary<string, object>() {
                    ...
                    { "API keys are not available for FROZEN user", typeof(AccountSuspended) },
                } },
            } },
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            object parts = ((string)currencyType).Split((string)"_").ToList<object>();
            object numParts = getArrayLength(parts);
            object lastPart = this.safeValue(parts, subtract(numParts, 1));
            object type = ((string)lastPart).ToLower();
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(balances)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["used"] = this.safeString(balance, "blocked");
            ((Dictionary<string, object>)result)[(string)code] = account;
        }
        ((Dictionary<string, object>)result)["timestamp"] = maxTimestamp;
        ((Dictionary<string, object>)result)["datetime"] = this.iso8601(maxTimestamp);
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object request = new Dictionary<string, object>() {};
        object method = "privateGetAuthTrade";
        object market = null;
        if (isTrue(!isEqual(symbol, null)))
        {
            market = this.market(symbol);
            ((Dictionary<string, object>)request)["currency"] = getValue(market, "baseId");
            ((Dictionary<string, object>)request)["quote"] = getValue(market, "quoteId");
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        {
            object parts = ((string)orderSide).Split((string)"_").ToList<object>();
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.privateGetAuthOrderPairCurrencyQuoteActive(this.extend(request, parameters));
        //
        //     [
        //         {
        //             "id":"a76bd262-3560-4bfb-98ac-1cedd394f4fc",
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object request = new Dictionary<string, object>() {};
        object method = "privateGetAuthOrder";
        object market = null;
        if (isTrue(!isEqual(symbol, null)))
        {
            market = this.market(symbol);
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.privateGetAuthOrderGetOrderId(this.extend(request, parameters));
        //
        //     {
        //         "id":"a76bd262-3560-4bfb-98ac-1cedd394f4fc",
        //         "status":"ORDER_STATUS_PLACED",
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)request)["timestamp"] = this.seconds();
        object response = await this.privatePostAuthOrderPlace(this.extend(request, parameters));
        //
        //     {
        //         "orderId":"1563460093.134037.704945@0370:2",
        //         "cliOrdId":"",
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.privatePostAuthOrderCancel(this.extend(request, parameters));
        //
        //     {
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object request = new Dictionary<string, object>() {};
        object method = "privatePostAuthOrderCancelAll";
        object market = null;
        if (isTrue(!isEqual(symbol, null)))
        {
            market = this.market(symbol);
