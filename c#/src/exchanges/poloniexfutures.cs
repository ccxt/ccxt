...
partial class poloniexfutures : Exchange
{
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(stopPrice))
        {
            ...
            ((Dictionary<string, object>)request)["stopPriceType"] = stopPriceType;
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(stop)) ? "privateDeleteStopOrders" : "privateDeleteOrders";
    ...
    public async virtual Task<object> fetchOrdersByStatus(object status, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (!isTrue(stop))
        {
            ((Dictionary<string, object>)request)["status"] = ((bool) isTrue(isEqual(status, "open"))) ? "active" : "done";
        ...
        object method = ((bool) isTrue(stop)) ? "privateGetStopOrders" : "privateGetOrders";
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        //    {
        //        "code": "200000",
        ...
        for (object i = 0; isLessThan(i, ordersLength); postFixIncrement(ref i))
        {
            ...
            {
                ((List<object>)result).Add(getValue(orders, i));
            }
        }
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        if (isTrue(((Dictionary<string,object>)order).ContainsKey(toStringOrNull("cancelledOrderIds"))))
        {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        url = add(url, tail);
        object query = this.omit(parameters, path);
        object queryLength = getArrayLength(new List<string>(((Dictionary<string,object>)query).Keys));
