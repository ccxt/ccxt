...
partial class bit2c : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "markets", new Dictionary<string, object>() {
                { "BTC/NIS", new Dictionary<string, object>() {
                    { "id", "BtcNis" },
                    { "symbol", "BTC/NIS" },
                    { "base", "BTC" },
                    { "quote", "NIS" },
                ...
                { "ETH/NIS", new Dictionary<string, object>() {
                    { "id", "EthNis" },
                    { "symbol", "ETH/NIS" },
                    { "base", "ETH" },
                    { "quote", "NIS" },
                ...
                { "LTC/NIS", new Dictionary<string, object>() {
                    { "id", "LtcNis" },
                    { "symbol", "LTC/NIS" },
                    { "base", "LTC" },
                    { "quote", "NIS" },
                ...
                { "USDC/NIS", new Dictionary<string, object>() {
                    { "id", "UsdcNis" },
                    { "symbol", "USDC/NIS" },
                    { "base", "USDC" },
                    { "quote", "NIS" },
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(codes)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(((Dictionary<string,object>)response).ContainsKey(toStringOrNull(uppercase))))
            {
                ((Dictionary<string, object>)account)["free"] = this.safeString(response, add("AVAILABLE_", uppercase));
                ((Dictionary<string, object>)account)["total"] = this.safeString(response, uppercase);
            }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["date"] = this.parseToInt(since);
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // max 100000
        }
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        object keys = new List<string>(((Dictionary<string,object>)fees).Keys);
        object result = new Dictionary<string, object>() {};
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            ((Dictionary<string, object>)request)["Total"] = multiply(amount, price);
            ((Dictionary<string, object>)request)["IsBid"] = (isEqual(side, "buy"));
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        if (isTrue(((Dictionary<string,object>)order).ContainsKey(toStringOrNull("NewOrder"))))
        {
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["take"] = limit;
        }
        ((Dictionary<string, object>)request)["take"] = limit;
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["toTime"] = this.yyyymmdd(this.milliseconds(), ".");
            ((Dictionary<string, object>)request)["fromTime"] = this.yyyymmdd(since, ".");
        }
        if (isTrue(!isEqual(symbol, null)))
        {
    ...
    {
        object newString = "";
        object strParts = ((string)str).Split((string)",").ToList<object>();
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        if (isTrue(!isEqual(reference, null)))
        {
            ...
            object reference_parts = ((string)reference).Split((string)"|").ToList<object>(); // reference contains 'pair|orderId_by_taker|orderId_by_maker'
