...
partial class mercado : Exchange
{
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(((Dictionary<string,object>)balances).ContainsKey(toStringOrNull(currencyId))))
            {
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(type, "limit")))
        {
            ...
            ((Dictionary<string, object>)request)["quantity"] = this.amountToPrecision(getValue(market, "symbol"), amount);
        } else
        {
            ...
            if (isTrue(isEqual(side, "buy")))
            {
                ...
                ((Dictionary<string, object>)request)["cost"] = this.priceToPrecision(getValue(market, "symbol"), multiply(amount, price));
            } else
            {
                ((Dictionary<string, object>)request)["quantity"] = this.amountToPrecision(getValue(market, "symbol"), amount);
            }
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object side = null;
        if (isTrue(((Dictionary<string,object>)order).ContainsKey(toStringOrNull("order_type"))))
        {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object account_ref = (((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("account_ref")));
        ...
        {
            object tx_fee = (((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("tx_fee")));
            if (!isTrue(tx_fee))
            {
            ...
            if (isTrue(isEqual(code, "XRP")))
            {
                ...
                {
                    if (!isTrue((((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("destination_tag")))))
                    {
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["from"] = this.parseToInt(divide(since, 1000));
            ((Dictionary<string, object>)request)["to"] = this.sum(getValue(request, "from"), multiply(limit, this.parseTimeframe(timeframe)));
        } else
        {
            ((Dictionary<string, object>)request)["to"] = this.seconds();
            ((Dictionary<string, object>)request)["from"] = subtract(getValue(request, "to"), (multiply(limit, this.parseTimeframe(timeframe))));
        }
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        return ((object)this.filterBySymbolSinceLimit(trades, getValue(market, "symbol"), since, limit));
    }
    ...
    public virtual object ordersToTrades(object orders)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(orders)); postFixIncrement(ref i))
        {
            ...
            {
                ((List<object>)result).Add(getValue(trades, y));
            }
        }
        return result;
    }
