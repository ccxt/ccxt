...
partial class bitfinex : Exchange
{
    ...
    public async override Task<object> fetchTransactionFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        object ids = new List<string>(((Dictionary<string,object>)fees).Keys);
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(this.symbols)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(((Dictionary<string,object>)fiat).ContainsKey(toStringOrNull(getValue(market, "quote")))))
            {
                ((Dictionary<string, object>)fee)["maker"] = makerFee2Fiat;
                ((Dictionary<string, object>)fee)["taker"] = takerFee2Fiat;
            } else if (isTrue(getValue(market, "contract")))
            {
                ((Dictionary<string, object>)fee)["maker"] = makerFee2Deriv;
                ((Dictionary<string, object>)fee)["taker"] = takerFee2Deriv;
            } else
            {
                ((Dictionary<string, object>)fee)["maker"] = makerFee;
                ((Dictionary<string, object>)fee)["taker"] = takerFee;
            }
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(details)); postFixIncrement(ref i))
        {
            ...
            {
                baseId = ((string)id).Substring((int)0, (int)3);
                quoteId = ((string)id).Substring((int)3, (int)6);
            }
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(accountType, null)))
        {
            ...
            throw new ExchangeError ((string)add(add(this.id, " fetchBalance() type parameter must be one of "), String.Join(", ", keys))) ;
        }
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            object isDerivativeCode = isEqual(((string)currencyId).Substring((int)start), "f0");
    ...
    public virtual object convertDerivativesId(object currencyId, object type)
    {
        ...
        {
            currencyId = ((string)currencyId).Substring((int)0, (int)start);
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object fee = null;
        if (isTrue(((Dictionary<string,object>)trade).ContainsKey(toStringOrNull("fee_amount"))))
        {
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["price"] = ((object)this.nonce()).ToString();
        } else
        {
        ...
        if (isTrue(postOnly))
        {
            ((Dictionary<string, object>)request)["is_postonly"] = true;
        }
    ...
    public async override Task<object> editOrder(object id, object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        {
            ((Dictionary<string, object>)order)["price"] = this.priceToPrecision(symbol, price);
        }
        if (isTrue(!isEqual(amount, null)))
        {
            ((Dictionary<string, object>)order)["amount"] = this.numberToString(amount);
        }
        if (isTrue(!isEqual(symbol, null)))
        {
            ((Dictionary<string, object>)order)["symbol"] = this.marketId(symbol);
        }
        if (isTrue(!isEqual(side, null)))
        {
            ((Dictionary<string, object>)order)["side"] = side;
        }
        if (isTrue(!isEqual(type, null)))
        {
            ((Dictionary<string, object>)order)["type"] = this.safeString(getValue(this.options, "orderTypes"), type, type);
        }
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        if (isTrue(exchange))
        {
            object parts = ((string)getValue(order, "type")).Split((string)" ").ToList<object>();
    ...
    public virtual object getCurrencyName(object code)
    {
        ...
        if (isTrue(((Dictionary<string,object>)getValue(this.options, "currencyNames")).ContainsKey(toStringOrNull(code))))
        {
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        object tag = null;
        if (isTrue(((Dictionary<string,object>)response).ContainsKey(toStringOrNull("address_pool"))))
        {
            tag = address;
    ...
    public async override Task<object> fetchTransactions(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(currencyId, null)))
        {
            ...
            {
                throw new ArgumentsRequired ((string)add(this.id, " fetchTransactions() requires a currency `code` argument or a `currency` parameter")) ;
            } else
            {
        ...
        ((Dictionary<string, object>)query)["currency"] = currencyId;
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)query)["since"] = this.parseToInt(divide(since, 1000));
        }
        ...
        */
        ...
        if (isTrue(isEqual(id, 0)))
        {
            if (isTrue(!isEqual(errorMessage, null)))
            {
                ...
                throwDynamicException((string)ExceptionClass, add(add(this.id, " "), message));return null;
            }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object signature = this.hmac(payload, secret, sha384);
