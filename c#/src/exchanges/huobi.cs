...
partial class huobi : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object keys = new List<string>(((Dictionary<string,object>)types).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            ...
            {
                object subKeys = new List<string>(((Dictionary<string,object>)value).Keys);
    ...
    public async virtual Task<object> fetchOrderTrades(object id, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        return await this.callAsync(method, id);
    }
    ...
    public override object networkIdToCode(object networkId, object currencyCode = null)
    {
        ...
        object keys = new List<string>(((Dictionary<string,object>)getValue(this.options, "networkNamesByChainIds")).Keys);
    ...
    public override object networkCodeToId(object networkCode, object currencyCode = null)
    {
        ...
        object keys = new List<string>(((Dictionary<string,object>)getValue(this.options, "networkChainIdsByNames")).Keys);
        object keysLength = getArrayLength(keys);
        if (isTrue(isEqual(keysLength, 0)))
        {
        ...
        */
        ...
        if (isTrue(isEqual(marketType, "spot")))
        {
            ...
            if (isTrue(isEqual(clientOrderIds, null)))
            {
                ...
                {
                    ((Dictionary<string, object>)request)["order-ids"] = String.Join(",", ids);
                }
            } else
            {
                if (isTrue(((clientOrderIds).GetType() == typeof(string))))
                ...
                {
                    ((Dictionary<string, object>)request)["client-order-ids"] = String.Join(",", clientOrderIds);
                }
        ...
        } else
        {
            ...
            if (isTrue(isEqual(clientOrderIds, null)))
            {
                ((Dictionary<string, object>)request)["order_id"] = String.Join(",", ids);
            } else
            {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(((api).GetType() == typeof(string))))
        {
            ...
            if (isTrue(isTrue(isEqual(api, "private")) || isTrue(isEqual(api, "v2Private"))))
            {
                ...
                object payload = String.Join("\n", new List<object>() {method, this.hostname, url, auth}); // eslint-disable-line quotes
    ...
    { "hostname", this.hostname },
        ...
        } else
        {
            ...
            if (isTrue(!((hostnames).GetType() == typeof(string))))
            {
                ...
                if (isTrue(isTrue((!((hostname).GetType() == typeof(string)))) && isTrue((!isEqual(levelTwoNestedPath, null)))))
                {
            ...
            } else if (isTrue(isEqual(access, "private")))
            {
                ...
                // unfortunately, PHP demands double quotes for the escaped newline symbol
                object payload = String.Join("\n", new List<object>() {method, hostname, url, auth}); // eslint-disable-line quotes
                object signature = this.hmac(this.encode(payload), this.encode(this.secret), sha256, "base64");
                auth = add(auth, add("&", this.urlencode(new Dictionary<string, object>() {
    { "Signature", signature },
})));
