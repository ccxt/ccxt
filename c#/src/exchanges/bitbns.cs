...
partial class bitbns : Exchange
{
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 100, max 5000, see https://github.com/binance-exchange/binance-official-api-docs/blob/master/rest-api.md#order-book
        }
    ...
    public virtual object parseBalance(object response)
    {
        ...
        object keys = new List<string>(((Dictionary<string,object>)data).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            object key = getValue(keys, i);
            object parts = ((string)key).Split((string)"availableorder").ToList<object>();
            ...
            if (isTrue(isGreaterThan(numParts, 1)))
            {
                ...
                ((Dictionary<string, object>)account)["free"] = this.safeString(data, key);
                ((Dictionary<string, object>)account)["used"] = this.safeString(data, add("inorder", currencyId));
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object amount = this.safeString2(order, "amount", "btc");
        object filled = this.safeString(order, "filled");
        object remaining = this.safeString(order, "remaining");
        object average = this.safeString(order, "avg_cost");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            throw new ExchangeError ((string)add(this.id, " allows limit and market orders only")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object request = new Dictionary<string, object>() {
        ...
        {
            ((Dictionary<string, object>)request)["rate"] = this.priceToPrecision(symbol, price);
        } else if (isTrue(isEqual(type, "market")))
        {
            method = "v1PostPlaceMarketOrderQntySymbol";
            ((Dictionary<string, object>)request)["market"] = getValue(market, "quoteId");
        } else
        {
            throw new ExchangeError ((string)add(this.id, " allows limit and market orders only")) ;
        }
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object quoteSide = ((bool) isTrue((isEqual(getValue(market, "quoteId"), "USDT")))) ? "usdtcancelOrder" : "cancelOrder";
        object request = new Dictionary<string, object>() {
            { "entry_id", id },
            { "symbol", getValue(market, "uppercaseId") },
            { "side", quoteSide },
        };
        object response = await this.v2PostCancel(this.extend(request, parameters));
        return this.parseOrder(response, market);
    }
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object quoteSide = ((bool) isTrue((isEqual(getValue(market, "quoteId"), "USDT")))) ? "usdtListOpenOrders" : "listOpenOrders";
        object request = new Dictionary<string, object>() {
            { "symbol", getValue(market, "uppercaseId") },
            { "side", quoteSide },
            { "page", 0 },
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        } else if (isTrue(isEqual(method, "POST")))
        {
            ...
            object signature = this.hmac(payload, this.encode(this.secret), sha512);
            ((Dictionary<string, object>)headers)["X-BITBNS-PAYLOAD"] = payload;
            ((Dictionary<string, object>)headers)["X-BITBNS-SIGNATURE"] = signature;
