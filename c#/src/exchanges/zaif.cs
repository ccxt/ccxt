...
partial class zaif : Exchange
{
        ...
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "options", new Dictionary<string, object>() {
                { "fees", new Dictionary<string, object>() {
                    ...
                    { "BCH/BTC", new Dictionary<string, object>() {
                        { "maker", this.parseNumber("0") },
                        { "taker", this.parseNumber("0.003") },
                    } },
                    { "PEPECASH/JPY", new Dictionary<string, object>() {
                        { "maker", this.parseNumber("0") },
                        { "taker", this.parseNumber("0.0001") },
                    } },
                    { "PEPECASH/BT", new Dictionary<string, object>() {
                        { "maker", this.parseNumber("0") },
                        { "taker", this.parseNumber("0.0001") },
                    } },
                } },
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(markets)); postFixIncrement(ref i))
        {
            ...
            object fees = this.safeValue(getValue(this.options, "fees"), symbol, getValue(this.fees, "trading"));
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["free"] = balance;
            ((Dictionary<string, object>)account)["total"] = balance;
            if (isTrue(!isEqual(deposit, null)))
            {
                if (isTrue(((Dictionary<string,object>)deposit).ContainsKey(toStringOrNull(currencyId))))
                {
                    ((Dictionary<string, object>)account)["total"] = this.safeString(deposit, currencyId);
                }
            }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(numTrades, 1)))
        {
            ...
            if (!isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)firstTrade).Keys))))
            {
