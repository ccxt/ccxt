...
partial class bitso : Exchange
{
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(markets)); postFixIncrement(ref i))
        {
            ...
            for (object j = 0; isLessThan(j, getArrayLength(feeTiers)); postFixIncrement(ref j))
            {
                ...
                ((List<object>)takerFees).Add(new List<object>() {volume, takerFee});
                ((List<object>)makerFees).Add(new List<object>() {volume, makerFee});
            ...
            ((Dictionary<string, object>)fee)["tiers"] = tiers;
            ...
            ((List<object>)result).Add(this.extend(new Dictionary<string, object>() {
                { "id", id },
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ...
            if (isTrue(!isEqual(limit, null)))
            {
                ...
                ((Dictionary<string, object>)request)["end"] = this.sum(since, multiply(multiply(duration, limit), 1000));
            }
        } else if (isTrue(!isEqual(limit, null)))
        {
            object now = this.milliseconds();
            ((Dictionary<string, object>)request)["end"] = now;
            ((Dictionary<string, object>)request)["start"] = subtract(now, multiply(multiply(this.parseTimeframe(timeframe), 1000), limit));
        }
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object side = this.safeString2(trade, "side", "maker_side");
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object markerInParams = (((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("marker")));
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        {
            object parts = ((string)address).Split((string)"?dt=").ToList<object>();
    ...
    public async override Task<object> fetchTransactionFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        object currencyIds = new List<string>(((Dictionary<string,object>)withdrawalFees).Keys);
    ...
    public override object parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(depositResponse)); postFixIncrement(ref i))
        {
            ...
            object code = this.safeCurrencyCode(currencyId);
            if (isTrue(isTrue((isEqual(codes, null))) || isTrue((((Dictionary<string,object>)codes).ContainsKey(toStringOrNull(code))))))
            {
                ((Dictionary<string, object>)result)[(string)code] = new Dictionary<string, object>() {
        ...
        object withdrawalKeys = new List<string>(((Dictionary<string,object>)withdrawalResponse).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(withdrawalKeys)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(isTrue((isEqual(codes, null))) || isTrue((((Dictionary<string,object>)codes).ContainsKey(toStringOrNull(code))))))
            {
                ...
                ((Dictionary<string, object>)getValue(getValue(result, code), "withdraw"))["fee"] = withdrawFee;
                ((Dictionary<string, object>)getValue(getValue(result, code), "info"))[(string)code] = withdrawFee;
            }
        }
        return result;
    }
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        object currency = this.currency(code);
        object method = ((bool) isTrue((((Dictionary<string,object>)methods).ContainsKey(toStringOrNull(code))))) ? getValue(methods, code) : null;
        ...
        object response = await this.callAsync(classMethod, this.extend(request, parameters));
        //
        //     {
        //         "success": true,
        //         "payload": [
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object request = String.Join("", new List<object>() {nonce, method, endpoint});
            if (isTrue(isTrue(!isEqual(method, "GET")) && isTrue(!isEqual(method, "DELETE"))))
            {
                if (isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)query).Keys))))
                {
