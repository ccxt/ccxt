...
partial class bitso : Exchange
{
    ...
    public async virtual Task<object> cancelOrders(object ids, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object oids = String.Join(",", ((List<object>)ids).ToArray());
        object request = new Dictionary<string, object>() {
            { "oids", oids },
        };
    ...
    public async override Task<object> fetchTransactionFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        object currencyIds = new List<object>(((Dictionary<string,object>)withdrawalFees).Keys);
    ...
    public override object parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        object withdrawalKeys = new List<object>(((Dictionary<string,object>)withdrawalResponse).Keys);
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object request = String.Join("", ((List<object>)new List<object>() {nonce, method, endpoint}).ToArray());
            if (isTrue(isTrue(!isEqual(method, "GET")) && isTrue(!isEqual(method, "DELETE"))))
            {
                if (isTrue(getArrayLength(new List<object>(((Dictionary<string,object>)query).Keys))))
                {
