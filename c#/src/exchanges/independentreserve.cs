...
partial class independentreserve : Exchange
{
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            market = this.market(symbol);
            ((Dictionary<string, object>)request)["primaryCurrencyCode"] = getValue(market, "baseId");
            ((Dictionary<string, object>)request)["secondaryCurrencyCode"] = getValue(market, "quoteId");
        }
        if (isTrue(isEqual(limit, null)))
        {
            limit = 50;
        }
        ((Dictionary<string, object>)request)["pageIndex"] = 1;
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)fees)[(string)code] = new Dictionary<string, object>() {
                { "info", fee },
                { "fee", tradingFee },
            };
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object capitalizedOrderType = this.capitalize(type);
        object method = add(add("privatePostPlace", capitalizedOrderType), "Order");
        object orderType = capitalizedOrderType;
        ...
        ((Dictionary<string, object>)request)["volume"] = amount;
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        } else
        {
            ...
            for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
            {
                ...
                ((List<object>)auth).Add(add(add(key, "="), value));
            }
            object message = String.Join(",", auth);
            ...
            ((Dictionary<string, object>)query)["apiKey"] = this.apiKey;
            ((Dictionary<string, object>)query)["nonce"] = nonce;
            ((Dictionary<string, object>)query)["signature"] = ((string)signature).ToUpper();
            for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
            {
                object key = getValue(keys, i);
                ((Dictionary<string, object>)query)[(string)key] = getValue(parameters, key);
            }
