...
partial class mexc : Exchange
{
    ...
    public async override Task<object> fetchStatus(object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(marketType, "spot")))
        {
            ...
            //     {}
            //
            status = ((bool) isTrue(getArrayLength(new List<object>(((Dictionary<string,object>)response).Keys)))) ? this.json(response) : "ok";
    ...
    public virtual object safeNetwork(object networkId)
    {
        ...
        networkId = String.Join("", ((List<object>)parts).ToArray());
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(getValue(market, "spot")))
        {
            ...
            trades = await ((Task<object>)callDynamically(this, method, new object[] { this.extend(request, parameters) }));
        } else if (isTrue(getValue(market, "swap")))
        {
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(getValue(market, "spot")))
        {
            ...
            data = await ((Task<object>)callDynamically(this, method, new object[] { this.extend(request, query) }));
        } else if (isTrue(getValue(market, "swap")))
        {
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(marketType, "spot")))
        {
            ...
            object response = await ((Task<object>)callDynamically(this, method, new object[] { this.extend(request, queryInner) }));
            //
            // spot
            //
            //     [
    ...
    public async virtual Task<object> fetchOrdersByIds(object ids, object symbol = null, object parameters = null)
    {
        ...
        {
            ((Dictionary<string, object>)request)["order_ids"] = String.Join(",", ((List<object>)ids).ToArray());
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(marketType, "spot")))
        {
            ...
            data = await ((Task<object>)callDynamically(this, method, new object[] { this.extend(requestInner, query) }));
        } else
        {
            ...
            method = this.safeString(query, "method", method);
            object response = await ((Task<object>)callDynamically(this, method, new object[] { new List<object>() {id} })); // the request cannot be changed or extended. This is the only way to send.
            //
            //     {
            //         "success": true,
            //         "code": "0",
        ...
        */
        ...
        if (isTrue(isTrue(isTrue((!isEqual(marginMode, null))) || isTrue((isMargin))) || isTrue((isEqual(marketType, "margin")))))
        {
            ...
            if (isTrue(isEqual(symbol, null)))
            {
                ...
                if (isTrue(!isEqual(symbols, null)))
                {
                    parsedSymbols = String.Join(",", ((List<object>)this.marketIds(symbols)).ToArray());
                }
            } else
            {
                object market = this.market(symbol);
    ...
    public async override Task<object> transfer(object code, object amount, object fromAccount, object toAccount, object parameters = null)
    {
        ...
        */
        ...
        {
            object keys = new List<object>(((Dictionary<string,object>)accounts).Keys);
            throw new ExchangeError ((string)add(add(this.id, " fromAccount must be one of "), String.Join(", ", ((List<object>)keys).ToArray()))) ;
        }
        if (isTrue(isEqual(toId, null)))
        {
            object keys = new List<object>(((Dictionary<string,object>)accounts).Keys);
            throw new ExchangeError ((string)add(add(this.id, " toAccount must be one of "), String.Join(", ", ((List<object>)keys).ToArray()))) ;
        }
        object request = new Dictionary<string, object>() {
