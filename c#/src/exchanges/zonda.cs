...
partial class zonda : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "urls", new Dictionary<string, object>() {
                ...
                { "doc", new List<object>() {"https://docs.zonda.exchange/", "https://github.com/BitBayNet/API"} },
            ...
            { "api", new Dictionary<string, object>() {
                ...
                { "v1_01Private", new Dictionary<string, object>() {
                    ...
                    { "post", new List<object>() {"trading/offer/{symbol}", "trading/stop/offer/{symbol}", "trading/config/{symbol}", "balances/BITBAY/balance", "balances/BITBAY/balance/transfer/{source}/{destination}", "fiat_cantor/exchange"} },
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object keys = new List<string>(((Dictionary<string,object>)items).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            object id = getValue(keys, i);
            object item = getValue(items, id);
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(symbol))
        {
            ...
            ((Dictionary<string, object>)request)["markets"] = markets;
        }
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(balances)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["used"] = this.safeString(balance, "lockedFunds");
            ((Dictionary<string, object>)account)["free"] = this.safeString(balance, "availableFunds");
    ...
    public override object parseTicker(object ticker, object market = null)
    {
        ...
        //       }
        //
        object open = this.safeString(ticker, "r24h");
        object high = this.safeString(ticker, "h");
        object low = this.safeString(ticker, "l");
        object volume = this.safeString(ticker, "v");
        object marketId = this.safeString(ticker, "m");
    ...
    public async override Task<object> fetchTicker(object symbol, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.v1_01PublicGetTradingStatsSymbol(this.extend(request, parameters));
        //
        //     {
        //       status: 'Ok',
        //       stats: {
        ...
        //     }
        //
        object stats = this.safeValue(response, "stats");
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object response = await this.v1_01PublicGetTradingStats(parameters);
        //
        //     {
        //         status: 'Ok',
        //         items: {
    ...
    public async virtual Task<object> fetchLedger(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(code, null)))
        {
            ...
            ((List<object>)balanceCurrencies).Add(getValue(currency, "id"));
        }
        object request = new Dictionary<string, object>() {
        ...
        {
            ((Dictionary<string, object>)request)["fromTime"] = since;
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["to"] = this.milliseconds();
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["fromTime"] = subtract(since, 1); // result does not include exactly `since` time therefore decrease by 1
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default - 10, max - 300
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(isStopOrder)) ? "v1_01PrivatePostTradingStopOfferSymbol" : "v1_01PrivatePostTradingOfferSymbol";
        if (isTrue(isTrue(isLimitOrder) || isTrue(isStopLimit)))
        {
            ((Dictionary<string, object>)request)["rate"] = this.priceToPrecision(symbol, price);
            ((Dictionary<string, object>)request)["mode"] = ((bool) isTrue(isStopLimit)) ? "stop-limit" : "limit";
        } else if (isTrue(isTrue(isMarketOrder) || isTrue(isStopMarket)))
        {
            ((Dictionary<string, object>)request)["mode"] = ((bool) isTrue(isStopMarket)) ? "stop-market" : "market";
        } else
        {
        ...
        if (isTrue(isStopOrder))
        {
            ...
            ((Dictionary<string, object>)request)["stopRate"] = this.priceToPrecision(symbol, stopLossPrice);
        }
        ...
        object completed = this.safeValue(response, "completed", false);
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            {
                address = add(address, add("?dt=", ((object)tag).ToString()));
            }
            ((Dictionary<string, object>)request)["address"] = address;
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        //     {
    ...
    public override object handleErrors(object httpCode, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        } else if (isTrue(((Dictionary<string,object>)response).ContainsKey(toStringOrNull("status"))))
        {
            //
