...
partial class oceanex : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(markets)); postFixIncrement(ref i))
        {
            ...
            var baseIdquoteIdVariable = ((string)name).Split((string)"/").ToList<object>();
    ...
    public async virtual Task<object> fetchOrderBooks(object symbols = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(data)); postFixIncrement(ref i))
        {
            ...
            object timestamp = this.safeTimestamp(orderbook, "timestamp");
            ((Dictionary<string, object>)result)[(string)symbol] = this.parseOrderBook(orderbook, symbol, timestamp);
        }
        return result;
    }
    ...
    public async virtual Task<object> createOrders(object symbol, object orders, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object market = this.market(symbol);
        ...
        object response = await this.privatePostOrdersMulti(this.extend(request, parameters));
