...
partial class lykke : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencies)); postFixIncrement(ref i))
        {
            ...
            object type = this.safeString(currency, "type");
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["depth"] = limit; // default 0
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)query)["price"] = parseFloat(this.priceToPrecision(getValue(market, "symbol"), price));
        }
        object method = add("privatePostOrders", this.capitalize(type));
        object result = await this.callAsync(method, this.extend(query, parameters));
        //
        // market
        //
        //         {
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            ((Dictionary<string, object>)request)["assetPairId"] = getValue(market, "id");
        }
        //
        //     {
        //         "payload":null,
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["take"] = limit; // How many maximum items have to be returned, max 1000 default 100.
        }
        if (isTrue(!isEqual(symbol, null)))
        {
            market = this.market(symbol);
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        if (isTrue(((transaction).GetType() == typeof(string))))
        {
            id = transaction;
        } else
        {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["destinationAddressExtension"] = tag;
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        } else if (isTrue(isEqual(api, "private")))
        {
            ...
            ((Dictionary<string, object>)headers)["Authorization"] = add("Bearer ", this.apiKey);
            ...
            {
                ((Dictionary<string, object>)headers)["X-Request-ID"] = this.uuid();
            }
        }
        return new Dictionary<string, object>() {
            { "url", url },
