...
partial class hollaex : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object keys = new List<string>(((Dictionary<string,object>)pairs).Keys);
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        object keys = new List<string>(((Dictionary<string,object>)coins).Keys);
    ...
    public async virtual Task<object> fetchOrderBooks(object symbols = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)result)[(string)symbol] = this.parseOrderBook(getValue(response, marketId), symbol, timestamp);
        }
        return result;
    }
    ...
    public override object parseTickers(object response, object symbols = null, object parameters = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)result)[(string)symbol] = this.extend(this.parseTicker(ticker, market), parameters);
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["to"] = end;
        ...
        } else
        {
            ...
            } else
            {
                ...
                ((Dictionary<string, object>)request)["from"] = start;
                ((Dictionary<string, object>)request)["to"] = this.sum(start, multiply(duration, limit));
            }
        }
    ...
    public override object parseOHLCV(object response, object market = null)
    {
        //
        //     {
        //         "time":"2020-03-02T20:00:00.000Z",
        ...
        //     }
        //
        return new List<object> {this.parse8601(this.safeString(response, "time")), this.safeNumber(response, "open"), this.safeNumber(response, "high"), this.safeNumber(response, "low"), this.safeNumber(response, "close"), this.safeNumber(response, "volume")};
    }
    ...
    public virtual object parseBalance(object response)
    {
        ...
        object currencyIds = new List<string>(((Dictionary<string,object>)this.currencies_by_id).Keys);
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object postOnly = this.safeValue(meta, "post_only", false);
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        object exchangeSpecificParam = this.safeValue(meta, "post_only", false);
        ...
        if (!isTrue(isMarketOrder))
        {
            ...
            ((Dictionary<string, object>)request)["price"] = this.normalizeNumberIfNeeded(convertedPrice);
        }
        if (isTrue(!isEqual(stopPrice, null)))
        {
            ((Dictionary<string, object>)request)["stop"] = this.normalizeNumberIfNeeded(parseFloat(this.priceToPrecision(symbol, stopPrice)));
        }
        if (isTrue(postOnly))
        {
            ((Dictionary<string, object>)request)["meta"] = new Dictionary<string, object>() {
                { "post_only", true },
            };
        }
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        object networkId = this.safeStringLower2(networks, network, code, network);
        object request = new Dictionary<string, object>() {
    ...
    {
        if (isTrue(isEqual(mod(number, 1), 0)))
        {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object defaultExpires = this.safeInteger2(this.options, "api-expires", "expires", parseInt(((object)(divide(this.timeout, 1000))).ToString()));
            ...
            ((Dictionary<string, object>)headers)["api-signature"] = signature;
        }
        return new Dictionary<string, object>() {
            { "url", url },
            { "method", method },
