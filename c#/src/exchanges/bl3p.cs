...
partial class bl3p : Exchange
{
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(codes)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["free"] = this.safeString(available, "value");
            ((Dictionary<string, object>)account)["total"] = this.safeString(balance, "value");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)order)["price_int"] = parseInt(Precise.stringMul(priceString, "100000.0"));
        }
