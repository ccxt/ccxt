...
partial class ascendex : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        object ids = new List<string>(((Dictionary<string,object>)dataById).Keys);
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isGreaterThan(numAddresses, 1)))
        {
            ...
            {
                object chainNames = new List<string>(((Dictionary<string,object>)addressesByChainName).Keys);
                object chains = String.Join(", ", chainNames);
