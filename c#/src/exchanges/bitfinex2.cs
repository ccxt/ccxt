...
partial class bitfinex2 : Exchange
{
    ...
    {
        return (((Dictionary<string,object>)getValue(this.options, "fiat")).ContainsKey(toStringOrNull(code)));
    }
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(markets)); postFixIncrement(ref i))
        {
            ...
            object splitBase = ((string)bs).Split((string)"F0").ToList<object>();
            object splitQuote = ((string)quote).Split((string)"F0").ToList<object>();
            ...
            object margin = false;
            if (isTrue(this.inArray(id, marginIds)))
            {
                margin = true;
            }
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        object config = String.Join(",", labels);
        ...
        for (object i = 0; isLessThan(i, getArrayLength(ids)); postFixIncrement(ref i))
        {
            ...
            object type = this.safeString(pool, 1);
            ...
            object keysNetworks = new List<string>(((Dictionary<string,object>)networks).Keys);
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(isTrue((isEqual(accountType, type))) && isTrue(derivativeCondition)))
            {
                ...
                ((Dictionary<string, object>)account)["total"] = this.safeString(balance, 2);
                ((Dictionary<string, object>)account)["free"] = this.safeString(balance, 4);
    ...
    public async override Task<object> transfer(object code, object amount, object fromAccount, object toAccount, object parameters = null)
    {
        ...
        */
        ...
        {
            object keys = new List<string>(((Dictionary<string,object>)accountsByType).Keys);
            throw new ArgumentsRequired ((string)add(add(this.id, " transfer() fromAccount must be one of "), String.Join(", ", keys))) ;
        }
        object toId = this.safeString(accountsByType, toAccount);
        if (isTrue(isEqual(toId, null)))
        {
            object keys = new List<string>(((Dictionary<string,object>)accountsByType).Keys);
            throw new ArgumentsRequired ((string)add(add(this.id, " transfer() toAccount must be one of "), String.Join(", ", keys))) ;
        }
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["len"] = limit; // 25 or 100
        }
        ...
        for (object i = 0; isLessThan(i, getArrayLength(orderbook)); postFixIncrement(ref i))
        {
            ...
            ((List<object>)getValue(result, side)).Add(new List<object>() {price, this.parseNumber(amount)});
        }
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            ...
            ((Dictionary<string, object>)request)["symbols"] = String.Join(",", ids);
        } else
        {
            ((Dictionary<string, object>)request)["symbols"] = "ALL";
        }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 120, max 5000
        }
        ((Dictionary<string, object>)request)["sort"] = sort;
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            since = subtract(this.milliseconds(), multiply(multiply(duration, limit), 1000));
        }
        object request = new Dictionary<string, object>() {
            { "symbol", getValue(market, "id") },
    ...
    public virtual object parseOrderStatus(object status)
    {
        ...
        object parts = ((string)status).Split((string)" ").ToList<object>();
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        {
            object parts = ((string)statusString).Split((string)" @ ").ToList<object>();
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        object postOnlyParam = this.safeValue(parameters, "postOnly", false);
        ...
        parameters = this.omit(parameters, new List<object>() {"triggerPrice", "stopPrice", "timeInForce", "postOnly", "reduceOnly", "price_aux_limit"});
        ...
        object stopLimit = (isTrue((isEqual(orderType, "EXCHANGE STOP LIMIT"))) || isTrue((isTrue((isEqual(orderType, "EXCHANGE LIMIT"))) && isTrue((!isEqual(stopPrice, null))))));
        object exchangeStop = (isEqual(orderType, "EXCHANGE STOP"));
        object exchangeMarket = (isEqual(orderType, "EXCHANGE MARKET"));
        object stopMarket = (isTrue(exchangeStop) || isTrue((isTrue(exchangeMarket) && isTrue((!isEqual(stopPrice, null))))));
        object ioc = (isTrue((isEqual(orderType, "EXCHANGE IOC"))) || isTrue((isEqual(timeInForce, "IOC"))));
        object fok = (isTrue((isEqual(orderType, "EXCHANGE FOK"))) || isTrue((isEqual(timeInForce, "FOK"))));
        ...
        if (isTrue(isTrue((isTrue(ioc) || isTrue(fok))) && isTrue(exchangeMarket)))
        {
            throw new InvalidOrder ((string)add(this.id, " createOrder() does not allow market IOC and FOK orders")) ;
        }
        if (isTrue(isTrue(isTrue((!isEqual(orderType, "MARKET"))) && isTrue((!isTrue(exchangeMarket)))) && isTrue((!isTrue(exchangeStop)))))
        {
            ((Dictionary<string, object>)request)["price"] = this.priceToPrecision(symbol, price);
        }
        if (isTrue(isTrue(stopLimit) || isTrue(stopMarket)))
        {
            ...
            if (isTrue(stopMarket))
            {
                ((Dictionary<string, object>)request)["type"] = "EXCHANGE STOP";
            } else if (isTrue(stopLimit))
            {
                ((Dictionary<string, object>)request)["type"] = "EXCHANGE STOP LIMIT";
                ((Dictionary<string, object>)request)["price_aux_limit"] = this.priceToPrecision(symbol, price);
            }
        }
        if (isTrue(ioc))
        {
            ((Dictionary<string, object>)request)["type"] = "EXCHANGE IOC";
        } else if (isTrue(fok))
        {
            ((Dictionary<string, object>)request)["type"] = "EXCHANGE FOK";
        }
        ...
        {
            ((Dictionary<string, object>)request)["flags"] = flags;
        }
        if (isTrue(!isEqual(clientOrderId, null)))
        {
            ((Dictionary<string, object>)request)["cid"] = clientOrderId;
            parameters = this.omit(parameters, new List<object>() {"cid", "clientOrderId"});
        }
        object response = await this.privatePostAuthWOrderSubmit(this.extend(request, parameters));
        //
        //      [
    ...
    public async override Task<object> fetchClosedOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 25, max 2500
        }
        object market = null;
        object response = null;
        if (isTrue(isEqual(symbol, null)))
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 25, max 1000
        }
        object method = "privatePostAuthRTradesHist";
        if (isTrue(!isEqual(symbol, null)))
        {
            market = this.market(symbol);
            ((Dictionary<string, object>)request)["symbol"] = getValue(market, "id");
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(this.symbols)); postFixIncrement(ref i))
        {
            ...
            {
                ((Dictionary<string, object>)fee)["maker"] = makerFeeFiat;
                ((Dictionary<string, object>)fee)["taker"] = takerFeeFiat;
            } else if (isTrue(getValue(market, "contract")))
            {
                ((Dictionary<string, object>)fee)["maker"] = makerFeeDeriv;
                ((Dictionary<string, object>)fee)["taker"] = takerFeeDeriv;
            } else
            {
    ...
    public async override Task<object> fetchTransactions(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object request = new Dictionary<string, object>() {};
        object method = "privatePostAuthRMovementsHist";
        if (isTrue(!isEqual(code, null)))
        {
            currency = this.currency(code);
            ((Dictionary<string, object>)request)["currency"] = getValue(currency, "uppercaseId");
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // max 1000
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        //     [
    ...
    public override object handleErrors(object statusCode, object statusText, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(isEqual(statusCode, 500)))
        {
            ...
            object errorCode = this.numberToString(getValue(response, 1));
            object errorText = getValue(response, 2);
    ...
    public override object parseLedgerEntry(object item, object currency = null)
    {
        ...
        {
            object parts = ((string)description).Split((string)" @ ").ToList<object>();
    ...
    public async virtual Task<object> fetchLedger(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object currency = null;
        object request = new Dictionary<string, object>() {};
        object method = "privatePostAuthRLedgersHist";
        if (isTrue(!isEqual(code, null)))
        {
            currency = this.currency(code);
            ((Dictionary<string, object>)request)["currency"] = getValue(currency, "uppercaseId");
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // max 2500
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        //     [
