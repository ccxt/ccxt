...
partial class bitfinex2 : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        object config = String.Join(",", ((List<object>)labels).ToArray());
        ...
        for (object i = 0; isLessThan(i, getArrayLength(ids)); postFixIncrement(ref i))
        {
            ...
            object keysNetworks = new List<object>(((Dictionary<string,object>)networks).Keys);
    ...
    public async override Task<object> transfer(object code, object amount, object fromAccount, object toAccount, object parameters = null)
    {
        ...
        */
        ...
        {
            object keys = new List<object>(((Dictionary<string,object>)accountsByType).Keys);
            throw new ArgumentsRequired ((string)add(add(this.id, " transfer() fromAccount must be one of "), String.Join(", ", ((List<object>)keys).ToArray()))) ;
        }
        object toId = this.safeString(accountsByType, toAccount);
        if (isTrue(isEqual(toId, null)))
        {
            object keys = new List<object>(((Dictionary<string,object>)accountsByType).Keys);
            throw new ArgumentsRequired ((string)add(add(this.id, " transfer() toAccount must be one of "), String.Join(", ", ((List<object>)keys).ToArray()))) ;
        }
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            ...
            ((Dictionary<string, object>)request)["symbols"] = String.Join(",", ((List<object>)ids).ToArray());
        } else
        {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["fee_deduct"] = 1;
        }
