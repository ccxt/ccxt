...
partial class hitbtc3 : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        object currencies = new List<string>(((Dictionary<string,object>)response).Keys);
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            throw new BadRequest ((string)add(add(this.id, " fetchBalance() type parameter must be one of "), String.Join(", ", keys))) ;
        }
        //
        //     [
        //       {
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            ...
            object delimited = String.Join(",", marketIds);
    ...
    public async virtual Task<object> fetchOrderBooks(object symbols = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            ...
            ((Dictionary<string, object>)request)["symbols"] = String.Join(",", marketIdsInner);
        }
        if (isTrue(!isEqual(limit, null)))
        {
    ...
    public async virtual Task<object> convertCurrencyNetwork(object code, object amount, object fromNetwork, object toNetwork, object parameters)
    {
        ...
        {
            object keys = new List<string>(((Dictionary<string,object>)networks).Keys);
            throw new ArgumentsRequired ((string)add(add(this.id, " convertCurrencyNetwork() requires a fromNetwork parameter and a toNetwork parameter, supported networks are "), String.Join(", ", keys))) ;
        }
        object request = new Dictionary<string, object>() {
    ...
    public async virtual Task<object> fetchFundingRateHistory(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        //    }
        //
        object contracts = new List<string>(((Dictionary<string,object>)response).Keys);
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object payloadString = String.Join("", payload);
