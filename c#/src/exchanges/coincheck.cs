...
partial class coincheck : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "markets", new Dictionary<string, object>() {
                ...
                { "ETC/JPY", new Dictionary<string, object>() {
                    { "id", "etc_jpy" },
                    { "symbol", "ETC/JPY" },
                    { "base", "ETC" },
                    { "quote", "JPY" },
                ...
                { "FCT/JPY", new Dictionary<string, object>() {
                    { "id", "fct_jpy" },
                    { "symbol", "FCT/JPY" },
                    { "base", "FCT" },
                    { "quote", "JPY" },
                ...
                { "MONA/JPY", new Dictionary<string, object>() {
                    { "id", "mona_jpy" },
                    { "symbol", "MONA/JPY" },
                    { "base", "MONA" },
                    { "quote", "JPY" },
                ...
                { "ETC/BTC", new Dictionary<string, object>() {
                    { "id", "etc_btc" },
                    { "symbol", "ETC/BTC" },
                    { "base", "ETC" },
                    { "quote", "BTC" },
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(codes)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(((Dictionary<string,object>)response).ContainsKey(toStringOrNull(currencyId))))
            {
                object account = this.account();
                object reserved = add(currencyId, "_reserved");
                ((Dictionary<string, object>)account)["free"] = this.safeString(response, currencyId);
                ((Dictionary<string, object>)account)["used"] = this.safeString(response, reserved);
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((List<object>)result).Add(this.extend(getValue(parsedOrders, i), new Dictionary<string, object>() {
                { "status", "open" },
            }));
        }
        return result;
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object fee = null;
        object orderId = null;
        if (isTrue(((Dictionary<string,object>)trade).ContainsKey(toStringOrNull("liquidity"))))
        {
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(type, "market")))
        {
            ...
            ((Dictionary<string, object>)request)["order_type"] = order_type;
            object prefix = ((bool) isTrue((isEqual(side, "buy")))) ? (add(order_type, "_")) : "";
            ((Dictionary<string, object>)request)[(string)add(prefix, "amount")] = amount;
        } else
        {
            ((Dictionary<string, object>)request)["order_type"] = side;
            ((Dictionary<string, object>)request)["rate"] = price;
