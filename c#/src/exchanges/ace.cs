...
partial class ace : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            object baseCode = this.safeCurrencyCode(bs);
            object quote = this.safeString(market, "quote");
            object quoteCode = this.safeCurrencyCode(quote);
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        object pairs = new List<string>(((Dictionary<string,object>)response).Keys);
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object side = null;
        object tradeSide = this.safeNumber(trade, "buyOrSell");
    ...
    public async virtual Task<object> fetchOrderTrades(object id, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        //
        object data = this.safeValue(response, "attachment");
        object trades = this.safeValue(data, "trades");
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["quoteCurrencyId"] = getValue(market, "quoteId");
            ((Dictionary<string, object>)request)["baseCurrencyId"] = getValue(market, "baseId");
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["size"] = limit; // default 10, max 500
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object dataKeys = new List<string>(((Dictionary<string,object>)data).Keys);
            object sortedDataKeys = this.sortBy(dataKeys, 0);
            ...
            ((Dictionary<string, object>)data)["signKey"] = signature;
            headers = new Dictionary<string, object>() {
    ...
    public override object handleErrors(object code, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(isGreaterThan(status, 200)))
        {
            ...
            this.throwBroadlyMatchedException(getValue(this.exceptions, "broad"), status, feedback);
        }
        return null;
    }
}
