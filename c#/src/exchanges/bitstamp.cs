...
partial class bitstamp : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            var bsquoteVariable = ((string)name).Split((string)"/").ToList<object>();
            ...
            object parts = ((string)minimumOrder).Split((string)" ").ToList<object>();
    ...
    public async virtual Task<object> fetchMarketsFromCache(object parameters = null)
    {
        ...
        if (isTrue(isTrue((isEqual(timestamp, null))) || isTrue((isGreaterThan((subtract(now, timestamp)), expires)))))
        {
            ...
            ((Dictionary<string, object>)this.options)["fetchMarkets"] = this.extend(options, new Dictionary<string, object>() {
                { "response", response },
                { "timestamp", now },
            });
        }
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            var baseDescriptionquoteDescriptionVariable = ((string)description).Split((string)" / ").ToList<object>();
            var baseDescription = ((List<object>) baseDescriptionquoteDescriptionVariable)[0];
            var quoteDescription = ((List<object>) baseDescriptionquoteDescriptionVariable)[1];
            object minimumOrder = this.safeString(market, "minimum_order");
            object parts = ((string)minimumOrder).Split((string)" ").ToList<object>();
            object cost = getValue(parts, 0);
            if (!isTrue((((Dictionary<string,object>)result).ContainsKey(toStringOrNull(bs)))))
            {
                object baseDecimals = this.safeInteger(market, "base_decimals");
                ((Dictionary<string, object>)result)[(string)bs] = this.constructCurrencyObject(baseId, bs, baseDescription, baseDecimals, null, market);
            }
            if (!isTrue((((Dictionary<string,object>)result).ContainsKey(toStringOrNull(quote)))))
            {
                object counterDecimals = this.safeInteger(market, "counter_decimals");
                ((Dictionary<string, object>)result)[(string)quote] = this.constructCurrencyObject(quoteId, quote, quoteDescription, counterDecimals, this.parseNumber(cost), market);
            }
        }
        return result;
    }
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)orderbook)["nonce"] = microtimestamp;
        return orderbook;
    }
    ...
    public virtual object getCurrencyIdFromTransaction(object transaction)
    {
        ...
        object ids = new List<string>(((Dictionary<string,object>)transaction).Keys);
    ...
    public virtual object getMarketFromTrade(object trade)
    {
        ...
        object currencyIds = new List<string>(((Dictionary<string,object>)trade).Keys);
        ...
        if (isTrue(isEqual(numCurrencyIds, 2)))
        {
            ...
            if (isTrue(((Dictionary<string,object>)this.markets_by_id).ContainsKey(toStringOrNull(marketId))))
            {
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        {
            object keys = new List<string>(((Dictionary<string,object>)trade).Keys);
        ...
        if (isTrue(((Dictionary<string,object>)trade).ContainsKey(toStringOrNull("id"))))
        {
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(limit, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["limit"] = 1000; // we need to specify an allowed amount of `limit` if no `since` is set and there is no default limit by exchange
            } else
            {
                limit = 1000;
        ...
        } else
        {
            ...
            ((Dictionary<string, object>)request)["limit"] = mathMin(limit, 1000); // min 1, max 1000
        }
    ...
    public virtual object parseTransactionFees(object response, object codes = null)
    {
        ...
        {
            object id = getValue(ids, i);
            object currencyId = getValue(((string)id).Split((string)"_").ToList<object>(), 0);
            ...
            {
                ((Dictionary<string, object>)getValue(getValue(result, code), "info"))[(string)id] = this.safeNumber(response, id);
            }
            if (isTrue(isGreaterThanOrEqual(getIndexOf(id, "_withdrawal_fee"), 0)))
            {
                ((Dictionary<string, object>)getValue(result, code))["withdraw"] = this.safeNumber(response, id);
            }
        }
        return result;
    }
    ...
    public override object parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(ids)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(isGreaterThanOrEqual(getIndexOf(id, "_available"), 0)))
            {
                ((Dictionary<string, object>)result)[(string)code] = this.depositWithdrawFee(new Dictionary<string, object>() {});
            }
            if (isTrue(isGreaterThanOrEqual(getIndexOf(id, "_withdrawal_fee"), 0)))
            {
                ((Dictionary<string, object>)getValue(getValue(result, code), "withdraw"))["fee"] = dictValue;
            }
            object resultValue = this.safeValue(result, code);
            if (isTrue(!isEqual(resultValue, null)))
            {
                ((Dictionary<string, object>)getValue(getValue(result, code), "info"))[(string)id] = dictValue;
            }
        }
        return result;
    }
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object market = null;
        object request = new Dictionary<string, object>() {};
        object method = "privatePostCancelAllOrders";
    ...
    public async override Task<object> fetchWithdrawals(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["timedelta"] = subtract(this.milliseconds(), since);
        } else
        {
            ((Dictionary<string, object>)request)["timedelta"] = 50000000; // use max bitstamp approved value
        }
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        object amount = null;
        if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("amount"))))
        {
        ...
        object status = "ok";
        if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("status"))))
        {
            status = this.parseTransactionStatus(this.safeString(transaction, "status"));
        }
        object type = null;
        if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("type"))))
        {
    ...
    public override object parseLedgerEntry(object item, object currency = null)
    {
        ...
        if (isTrue(isEqual(type, "trade")))
        {
            ...
            object market = null;
            object keys = new List<string>(((Dictionary<string,object>)item).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
            {
        ...
        } else
        {
            ...
            if (isTrue(((Dictionary<string,object>)item).ContainsKey(toStringOrNull("amount"))))
            {
                object amount = this.safeString(item, "amount");
                direction = ((bool) isTrue(Precise.stringGt(amount, "0"))) ? "in" : "out";
            } else if (isTrue(isTrue((((Dictionary<string,object>)parsedTransaction).ContainsKey(toStringOrNull("currency")))) && isTrue(!isEqual(getValue(parsedTransaction, "currency"), null))))
            {
        ...
        */
        ...
        if (!isTrue(this.isFiat(code)))
        {
            ...
            } else if (isTrue(isTrue(isEqual(code, "XLM")) || isTrue(isEqual(code, "HBAR"))))
            {
                if (isTrue(!isEqual(tag, null)))
                {
                    ((Dictionary<string, object>)request)["memo_id"] = tag;
                }
            }
        ...
        } else
        {
            ...
            currency = this.currency(code);
            ((Dictionary<string, object>)request)["iban"] = address;
            ((Dictionary<string, object>)request)["account_currency"] = getValue(currency, "id");
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        ...
        } else
        {
            ...
            if (isTrue(isEqual(method, "POST")))
            {
                if (isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)query).Keys))))
                {
                    ...
                    ((Dictionary<string, object>)headers)["Content-Type"] = contentType;
                } else
                {
            ...
            ((Dictionary<string, object>)headers)["X-Auth-Signature"] = signature;
        }
        return new Dictionary<string, object>() {
            { "url", url },
            { "method", method },
    ...
    public override object handleErrors(object httpCode, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(isTrue((isEqual(status, "error"))) || isTrue((!isEqual(error, null)))))
        {
            ...
            if (isTrue(((error).GetType() == typeof(string))))
            {
                ((List<object>)errors).Add(error);
            } else if (isTrue(!isEqual(error, null)))
            {
                object keys = new List<string>(((Dictionary<string,object>)error).Keys);
                for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
                {
                    object key = getValue(keys, i);
                    object value = this.safeValue(error, key);
                    if (isTrue((value.GetType().IsGenericType && value.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
                    {
            ...
            if (isTrue(((reasonInner).GetType() == typeof(string))))
            {
            ...
            } else
            {
                ...
                {
                    ((List<object>)errors).Add(getValue(all, i));
                }
            }
