...
partial class bitstamp : Exchange
{
    ...
    public virtual object getCurrencyIdFromTransaction(object transaction)
    {
        ...
        object ids = new List<object>(((Dictionary<string,object>)transaction).Keys);
    ...
    public virtual object getMarketFromTrade(object trade)
    {
        ...
        object currencyIds = new List<object>(((Dictionary<string,object>)trade).Keys);
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        {
            object keys = new List<object>(((Dictionary<string,object>)trade).Keys);
    ...
    public override object parseLedgerEntry(object item, object currency = null)
    {
        ...
        if (isTrue(isEqual(type, "trade")))
        {
            ...
            object market = null;
            object keys = new List<object>(((Dictionary<string,object>)item).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
            {
    ...
    public override object handleErrors(object httpCode, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(isTrue((isEqual(status, "error"))) || isTrue((!isEqual(error, null)))))
        {
            ...
            {
                object keys = new List<object>(((Dictionary<string,object>)error).Keys);
                for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
                {
