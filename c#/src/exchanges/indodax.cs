...
partial class indodax : Exchange
{
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        if (isTrue(!isEqual(market, null)))
        {
            ...
            if (isTrue(isTrue((isEqual(getValue(market, "quoteId"), "idr"))) && isTrue((((Dictionary<string,object>)order).ContainsKey(toStringOrNull("order_rp"))))))
            {
                quoteId = "rp";
            }
            if (isTrue(isTrue((isEqual(getValue(market, "baseId"), "idr"))) && isTrue((((Dictionary<string,object>)order).ContainsKey(toStringOrNull("remain_rp"))))))
            {
                baseId = "rp";
            }
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchOrder() requires a symbol")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object request = new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object marketIds = new List<string>(((Dictionary<string,object>)rawOrders).Keys);
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)[(string)getValue(market, "quoteId")] = multiply(amount, price);
        } else
        {
            ((Dictionary<string, object>)request)[(string)getValue(market, "baseId")] = amount;
        }
        ((Dictionary<string, object>)request)[(string)currency] = amount;
    ...
    public async override Task<object> fetchTransactions(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object startTime = ((string)this.iso8601(since)).Substring((int)0, (int)10);
            ((Dictionary<string, object>)request)["start"] = startTime;
            ((Dictionary<string, object>)request)["end"] = ((string)this.iso8601(this.milliseconds())).Substring((int)0, (int)10);
        }
        ...
        {
            object keys = new List<string>(((Dictionary<string,object>)withdraw).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
            {
                object key = getValue(keys, i);
                transactions = this.arrayConcat(transactions, getValue(withdraw, key));
            }
            keys = new List<string>(((Dictionary<string,object>)deposit).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
            {
                object key = getValue(keys, i);
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(tag))
        {
            ((Dictionary<string, object>)request)["withdraw_memo"] = tag;
        }
    ...
    public override object handleErrors(object code, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(!isTrue((((Dictionary<string,object>)response).ContainsKey(toStringOrNull("success")))) && isTrue(isEqual(error, ""))))
        {
        ...
        if (isTrue(isEqual(this.safeInteger(response, "success", 0), 1)))
        {
            ...
            if (!isTrue((((Dictionary<string,object>)response).ContainsKey(toStringOrNull("return")))))
            {
