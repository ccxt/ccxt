...
partial class whitebit : Exchange
{
    ...
    public async override Task<object> fetchTransactionFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        //      }
        //
        object currenciesIds = new List<object>(((Dictionary<string,object>)response).Keys);
    ...
    public override object parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        object currencyIds = new List<object>(((Dictionary<string,object>)response).Keys);
    ...
    {
        object balanceKeys = new List<object>(((Dictionary<string,object>)response).Keys);
        object result = new Dictionary<string, object>() {};
        ...
        if (isTrue(!isEqual(response, null)))
        {
            ...
            if (isTrue(isTrue(hasErrorStatus) || isTrue(!isEqual(codeNew, null))))
            {
                ...
                } else
                {
                    ...
                    {
                        object errorKey = getValue(new List<object>(((Dictionary<string,object>)errorObject).Keys), 0);
