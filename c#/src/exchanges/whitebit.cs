...
partial class whitebit : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "api", new Dictionary<string, object>() {
                ...
                { "v4", new Dictionary<string, object>() {
                    { "public", new Dictionary<string, object>() {
                        { "get", new List<object>() {"assets", "collateral/markets", "fee", "orderbook/{market}", "ticker", "trades/{market}", "time", "ping", "markets"} },
                    } },
                    { "private", new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(ids)); postFixIncrement(ref i))
        {
            ...
            object canDeposit = this.safeValue(currency, "can_deposit", true);
            object canWithdraw = this.safeValue(currency, "can_withdraw", true);
    ...
    public async override Task<object> fetchTransactionFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        //      }
        //
        object currenciesIds = new List<string>(((Dictionary<string,object>)response).Keys);
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currenciesIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)withdrawFees)[(string)code] = this.safeString(withdraw, "fixed");
            object deposit = this.safeValue(data, "deposit", new Dictionary<string, object>() {});
            ((Dictionary<string, object>)depositFees)[(string)code] = this.safeString(deposit, "fixed");
        }
    ...
    public override object parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        object currencyIds = new List<string>(((Dictionary<string,object>)response).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(isTrue((isEqual(codes, null))) || isTrue((this.inArray(code, codes)))))
            {
                ...
                if (isTrue(!isEqual(networkId, null)))
                {
                    ...
                    networkId = ((string)networkId).Substring((int)1, (int)subtract(networkLength, 1));
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["depth"] = limit; // default = 50, maximum = 100
        }
        ...
        //      }
        //
        object timestamp = this.parseNumber(Precise.stringMul(this.safeString(response, "timestamp"), "1000"));
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            return ((object)this.filterBySinceLimit(results, since, limit, "timestamp", tail));
        }
    }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ...
            object end = this.sum(start, multiply(duration, limit));
            ((Dictionary<string, object>)request)["start"] = start;
            ((Dictionary<string, object>)request)["end"] = end;
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = mathMin(limit, 1440);
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(clientOrderId, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["clientOrderId"] = add(brokerId, this.uuid16());
            }
        } else
        {
        ...
        {
            ((Dictionary<string, object>)request)["activation_price"] = this.priceToPrecision(symbol, stopPrice);
    ...
    {
        object balanceKeys = new List<string>(((Dictionary<string,object>)response).Keys);
        object result = new Dictionary<string, object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(balanceKeys)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(isTrue(((balance).GetType() == typeof(Dictionary<string, object>))) && isTrue(!isEqual(balance, null))))
            {
                ...
                ((Dictionary<string, object>)account)["total"] = this.safeString(balance, "main_balance");
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = mathMin(limit, 100);
        }
    ...
    public async override Task<object> fetchClosedOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = mathMin(limit, 100); // default 50 max 100
        }
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            for (object j = 0; isLessThan(j, getArrayLength(orders)); postFixIncrement(ref j))
            {
                ...
                ((List<object>)results).Add(this.extend(order, new Dictionary<string, object>() {
                    { "status", "closed" },
                }));
            }
        }
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        object method = "v4PrivatePostMainAccountAddress";
        if (isTrue(this.isFiat(code)))
        {
            method = "v4PrivatePostMainAccountFiatDepositUrl";
            object provider = this.safeNumber(parameters, "provider");
            ...
            ((Dictionary<string, object>)request)["provider"] = provider;
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)request)["uniqueId"] = uniqueId;
    ...
    public async virtual Task<object> fetchDeposit(object id, object code = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(code, null)))
        {
            ...
            ((Dictionary<string, object>)request)["ticker"] = getValue(currency, "id");
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(accessibility, "private")))
        {
            ...
            object signature = this.hmac(payload, secret, sha512);
        ...
        if (isTrue(!isEqual(response, null)))
        {
            ...
            if (isTrue(isTrue(hasErrorStatus) || isTrue(!isEqual(codeNew, null))))
            {
                ...
                } else
                {
                    ...
                    {
                        object errorKey = getValue(new List<string>(((Dictionary<string,object>)errorObject).Keys), 0);
