...
partial class tokocrypto : Exchange
{
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(list)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(((Dictionary<string,object>)filtersByType).ContainsKey(toStringOrNull("PRICE_FILTER"))))
            {
                ...
                ((Dictionary<string, object>)getValue(entry, "precision"))["price"] = this.precisionFromString(tickSize);
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.binanceGetDepth(this.extend(request, parameters));
        //
        // future
        //
        //     {
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object defaultMethod = "binanceGetTicker24hr";
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["symbol"] = add(getValue(market, "baseId"), getValue(market, "quoteId"));
        }
        ...
        object response = await this.binanceGetKlines(this.extend(request, parameters));
        //
        //     [
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["side"] = 1;
        }
        if (isTrue(isEqual(clientOrderId, null)))
        {
            ...
            if (isTrue(!isEqual(broker, null)))
            {
                ...
                {
                    ((Dictionary<string, object>)request)["clientId"] = add(brokerId, this.uuid22());
                }
            }
        } else
        {
            ((Dictionary<string, object>)request)["clientId"] = clientOrderId;
        }
        ...
        if (isTrue(isEqual(uppercaseType, "MARKET")))
        {
            ...
            {
                object quoteOrderQtyInner = this.safeValue2(parameters, "quoteOrderQty", "cost");
                object precision = getValue(getValue(market, "precision"), "price");
                if (isTrue(!isEqual(quoteOrderQtyInner, null)))
                {
                    ((Dictionary<string, object>)request)["quoteOrderQty"] = this.decimalToPrecision(quoteOrderQtyInner, TRUNCATE, precision, this.precisionMode);
                    parameters = this.omit(parameters, new List<object>() {"quoteOrderQty", "cost"});
                } else if (isTrue(!isEqual(price, null)))
                {
                    ((Dictionary<string, object>)request)["quoteOrderQty"] = this.decimalToPrecision(multiply(amount, price), TRUNCATE, precision, this.precisionMode);
                } else
                {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["network"] = ((string)networkId).ToUpper();
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        method ??= "GET";
        parameters ??= new Dictionary<string, object>();
        if (!isTrue((((Dictionary<string,object>)getValue(getValue(this.urls, "api"), "rest")).ContainsKey(toStringOrNull(api)))))
        {
