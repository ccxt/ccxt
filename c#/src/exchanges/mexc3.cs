...
partial class mexc3 : Exchange
{
    ...
    public async override Task<object> fetchDeposits(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(rawNetwork, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchDeposits() requires a network parameter when the currency is specified")) ;
        }
        ...
        ((Dictionary<string, object>)request)["coin"] = add(add(getValue(currency, "id"), "-"), rawNetwork);
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["startTime"] = since;
        }
