...
partial class ndax : Exchange
{
    ...
    public async virtual Task<object> signIn(object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)this.options)["sessionToken"] = sessionToken;
            return response;
        }
        ...
        if (isTrue(!isEqual(pending2faToken, null)))
        {
            ...
            ((Dictionary<string, object>)this.options)["pending2faToken"] = pending2faToken;
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            object type = this.safeString(currency, "ProductType");
    ...
    public override object parseOrderBook(object orderbook, object symbol, object timestamp = null, object bidsKey = null, object asksKey = null, object priceKey = null, object amountKey = null)
    {
        bidsKey ??= "bids";
        asksKey ??= "asks";
        priceKey ??= 6;
        ...
        for (object i = 0; isLessThan(i, getArrayLength(orderbook)); postFixIncrement(ref i))
        {
            ...
            ((List<object>)getValue(result, side)).Add(bidask);
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["FromDate"] = this.ymdhms(subtract(now, multiply(multiply(duration, limit), 1000)));
                ((Dictionary<string, object>)request)["ToDate"] = this.ymdhms(now);
            }
        } else
        {
            ((Dictionary<string, object>)request)["FromDate"] = this.ymdhms(since);
            if (isTrue(isEqual(limit, null)))
            {
                ((Dictionary<string, object>)request)["ToDate"] = this.ymdhms(now);
            } else
            {
                ((Dictionary<string, object>)request)["ToDate"] = this.ymdhms(this.sum(since, multiply(multiply(duration, limit), 1000)));
            }
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["LimitPrice"] = parseFloat(this.priceToPrecision(symbol, price));
        }
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            ((Dictionary<string, object>)request)["InstrumentId"] = getValue(market, "id");
        }
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["StartTimeStamp"] = this.parseToInt(divide(since, 1000));
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["Depth"] = limit;
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object market = this.market(symbol);
            ((Dictionary<string, object>)request)["IntrumentId"] = getValue(market, "id");
        }
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(clientOrderId, null)))
        {
            ((Dictionary<string, object>)request)["ClOrderId"] = clientOrderId;
        } else
        {
            ((Dictionary<string, object>)request)["OrderId"] = parseInt(id);
        }
    ...
    public override object parseDepositAddress(object depositAddress, object currency = null)
    {
        ...
        object parts = ((string)lastString).Split((string)"?memo=").ToList<object>();
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("DepositId"))))
        {
            ...
            type = "deposit";
        } else if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("WithdrawId"))))
        {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)withdrawTemplate)["ExternalAddress"] = address;
        if (isTrue(!isEqual(tag, null)))
        {
            if (isTrue(((Dictionary<string,object>)withdrawTemplate).ContainsKey(toStringOrNull("Memo"))))
            {
                ((Dictionary<string, object>)withdrawTemplate)["Memo"] = tag;
            }
        }
