...
partial class xt : Exchange
{
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        parameters ??= new Dictionary<string, object>();
        object response = await this.publicSpotGetWalletSupportCurrency(parameters);
        //
        //     {
        //         "rc": 0,
        //         "mc": "SUCCESS",
        ...
        for (object i = 0; isLessThan(i, getArrayLength(data)); postFixIncrement(ref i))
        {
            ...
            object rawNetworks = this.safeValue(entry, "supportChains", new List<object>() {});
    ...
    public virtual object parseMarket(object market)
    {
        ...
        object isActive = isTrue((isEqual(state, "ONLINE"))) || isTrue((isEqual(state, "0")));
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            if (isTrue(!isEqual(limit, null)))
            {
                ((Dictionary<string, object>)request)["level"] = mathMin(limit, 50);
            } else
            {
                ((Dictionary<string, object>)request)["level"] = 50;
            }
            if (isTrue(getValue(market, "linear")))
            {
    ...
    public override object parseTicker(object ticker, object market = null)
    {
        ...
        {
            marketType = ((bool) isTrue(isTrue((((Dictionary<string,object>)ticker).ContainsKey(toStringOrNull("cv")))) || isTrue((((Dictionary<string,object>)ticker).ContainsKey(toStringOrNull("aq")))))) ? "spot" : "contract";
        }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            if (isTrue(!isEqual(limit, null)))
            {
                ((Dictionary<string, object>)request)["num"] = limit;
            }
            if (isTrue(getValue(market, "linear")))
            {
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            ((Dictionary<string, object>)request)["bizType"] = marginOrSpotRequest;
            if (isTrue(!isEqual(limit, null)))
            {
                ((Dictionary<string, object>)request)["limit"] = limit;
            }
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        if (isTrue(isEqual(marketType, null)))
        {
            marketType = ((bool) isTrue(isTrue((((Dictionary<string,object>)trade).ContainsKey(toStringOrNull("b")))) || isTrue((((Dictionary<string,object>)trade).ContainsKey(toStringOrNull("bizType")))))) ? "spot" : "contract";
        }
        market = this.safeMarket(marketId, market, "_", marketType);
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["used"] = used;
            ...
            if (isTrue(isEqual(side, "buy")))
            {
                ...
                if (isTrue(createMarketBuyOrderRequiresPrice))
                {
                    ...
                    } else
                    {
                        ...
                        ((Dictionary<string, object>)request)["quoteQty"] = this.costToPrecision(symbol, cost);
                    }
                } else
                {
                    ((Dictionary<string, object>)request)["quoteQty"] = this.amountToPrecision(symbol, amount);
                }
            }
        } else
        {
    ...
    public async virtual Task<object> createContractOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object convertContractsToAmount = Precise.stringDiv(this.numberToString(amount), this.numberToString(getValue(market, "contractSize")));
        object request = new Dictionary<string, object>() {
            { "symbol", getValue(market, "id") },
        ...
        if (isTrue(isEqual(side, "buy")))
        {
            ...
            ((Dictionary<string, object>)request)["positionSide"] = requestType;
        } else
        {
        ...
        if (isTrue(isTrigger))
        {
            ((Dictionary<string, object>)request)["timeInForce"] = this.safeStringUpper(parameters, "timeInForce", "GTC");
            ((Dictionary<string, object>)request)["triggerPriceType"] = this.safeString(parameters, "triggerPriceType", "LATEST_PRICE");
            ((Dictionary<string, object>)request)["orderSide"] = ((string)side).ToUpper();
            ...
            ((Dictionary<string, object>)request)["entrustType"] = entrustType;
        ...
        } else if (isTrue(isTrue(isStopLoss) || isTrue(isTakeProfit)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["triggerStopPrice"] = this.priceToPrecision(symbol, stopLoss);
            } else
            {
                ((Dictionary<string, object>)request)["triggerProfitPrice"] = this.priceToPrecision(symbol, takeProfit);
            }
        ...
        {
            ((Dictionary<string, object>)request)["orderSide"] = ((string)side).ToUpper();
            ((Dictionary<string, object>)request)["orderType"] = ((string)type).ToUpper();
            if (isTrue(getValue(market, "linear")))
            {
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(stop))
        {
            ((Dictionary<string, object>)request)["entrustId"] = this.convertToBigInt(id);
        } else if (isTrue(stopLossTakeProfit))
        {
            ((Dictionary<string, object>)request)["profitId"] = this.convertToBigInt(id);
        } else
        {
            ((Dictionary<string, object>)request)["orderId"] = this.convertToBigInt(id);
        }
        if (isTrue(stop))
        {
    ...
    public async virtual Task<object> fetchOrdersByStatus(object status, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        if (isTrue(isEqual(status, "open")))
        {
            ...
            {
                ((Dictionary<string, object>)request)["state"] = "NOT_TRIGGERED";
            } else if (isTrue(!isEqual(subType, null)))
            {
                ((Dictionary<string, object>)request)["state"] = "NEW";
            }
        } else if (isTrue(isEqual(status, "closed")))
        {
            if (isTrue(isTrue(stop) || isTrue(stopLossTakeProfit)))
            {
                ((Dictionary<string, object>)request)["state"] = "TRIGGERED";
            } else
            {
        ...
        } else if (isTrue(isEqual(status, "canceled")))
        {
            if (isTrue(isTrue(stop) || isTrue(stopLossTakeProfit)))
            {
                ((Dictionary<string, object>)request)["state"] = "USER_REVOCATION";
            } else
            {
        ...
        {
            ((Dictionary<string, object>)request)["state"] = status;
        }
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object marketType = ((bool) isTrue(isTrue((((Dictionary<string,object>)order).ContainsKey(toStringOrNull("result")))) || isTrue((((Dictionary<string,object>)order).ContainsKey(toStringOrNull("positionSide")))))) ? "contract" : "spot";
    ...
    public async override Task<object> fetchDeposits(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 10, max 200
        }
    ...
    public async override Task<object> fetchPositions(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            throw new BadRequest ((string)add(this.id, " fetchPositions() only supports the symbols argument as undefined")) ;
        }
        object subType = null;
        ...
        return this.filterByArray(result, "symbol", null, false);
    }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        object payload = null;
        if (isTrue(isEqual(endpoint, "spot")))
        {
            if (isTrue(signed))
            {
        ...
        if (isTrue(signed))
        {
            ...
            object recvWindow = this.safeString(parameters, "recvWindow", defaultRecvWindow);
            ...
            {
                ((Dictionary<string, object>)body)["clientMedia"] = "CCXT";
            }
            ...
            if (isTrue(isEqual(endpoint, "spot")))
            {
                payloadString = add(add(add(add(add("xt-validate-algorithms=HmacSHA256&xt-validate-appkey=", this.apiKey), "&xt-validate-recvwindow="), recvWindow), "&xt-validate-timestamp="), timestamp);
                ...
                ((Dictionary<string, object>)headers)["xt-validate-algorithms"] = "HmacSHA256";
                ((Dictionary<string, object>)headers)["xt-validate-recvwindow"] = recvWindow;
            } else
            {
                payloadString = add(add(add("xt-validate-appkey=", this.apiKey), "&xt-validate-timestamp="), timestamp);
            ...
            ((Dictionary<string, object>)headers)["xt-validate-appkey"] = this.apiKey;
            ((Dictionary<string, object>)headers)["xt-validate-timestamp"] = timestamp;
            ((Dictionary<string, object>)headers)["xt-validate-signature"] = signature;
        } else
        {
            if (isTrue(urlencoded))
            {
