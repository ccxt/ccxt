...
partial class currencycom : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(markets)); postFixIncrement(ref i))
        {
            ...
            object type = this.safeString(market, "marketType");
            object spot = (isEqual(type, "SPOT"));
            object futures = false;
            object swap = (isEqual(type, "LEVERAGE"));
            object margin = swap; // as we decided to set
            if (isTrue(swap))
            {
    ...
    public async override Task<object> fetchAccounts(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(accounts)); postFixIncrement(ref i))
        {
            ...
            object accountId = this.safeInteger(account, "accountId");
    ...
    public virtual object parseBalance(object response, object type = null)
    {
        //
        //     {
        //         "makerCommission":0.20,
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 100, max 1000, valid limits 5, 10, 20, 50, 100, 500, 1000, 5000
        }
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        } else if (isTrue(((Dictionary<string,object>)trade).ContainsKey(toStringOrNull("isBuyer"))))
        {
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            {
                ((Dictionary<string, object>)request)["type"] = "STOP";
                ((Dictionary<string, object>)request)["price"] = this.priceToPrecision(symbol, price);
