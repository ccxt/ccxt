...
partial class huobijp : Exchange
{
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object fee = null;
        object feeCost = this.safeNumber(trade, "filled-fees");
        object feeCurrency = this.safeCurrencyCode(this.safeString(trade, "fee-currency"));
        object filledPoints = this.safeNumber(trade, "filled-points");
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["size"] = limit; // 1-100 orders, default is 100
        }
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencies)); postFixIncrement(ref i))
        {
            ...
            object visible = this.safeValue(currency, "visible", false);
        ...
        if (isTrue(isTrue((isEqual(type, "market"))) && isTrue((isEqual(side, "buy")))))
        {
            if (isTrue(getValue(this.options, "createMarketBuyOrderRequiresPrice")))
            {
                ...
                } else
                {
                    ...
                    object baseAmount = Precise.stringMul(amountString, priceString);
                    ((Dictionary<string, object>)request)["amount"] = this.costToPrecision(symbol, baseAmount);
                }
            } else
            {
    ...
    public virtual object safeNetwork(object networkId)
    {
        ...
        {
            networkId = ((string)networkId).Substring((int)0, (int)lastCharacterIndex);
        }
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(network, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["chain"] = add(getValue(currency, "id"), network);
            } else
            {
                ((Dictionary<string, object>)request)["chain"] = add(network, getValue(currency, "id"));
            }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isTrue(isEqual(api, "private")) || isTrue(isEqual(api, "v2Private"))))
        {
            ...
            object payload = String.Join("\n", new List<object>() {method, this.hostname, url, auth});
