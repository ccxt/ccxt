...
partial class deribit : Exchange
{
    ...
    public virtual object parseBalance(object balance)
    {
        ...
        ((Dictionary<string, object>)account)["free"] = this.safeString(balance, "available_funds");
        ((Dictionary<string, object>)account)["used"] = this.safeString(balance, "maintenance_margin");
        ((Dictionary<string, object>)account)["total"] = this.safeString(balance, "equity");
        ((Dictionary<string, object>)result)[(string)currencyCode] = account;
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["start_timestamp"] = subtract(now, multiply(multiply((subtract(limit, 1)), duration), 1000));
            ((Dictionary<string, object>)request)["end_timestamp"] = now;
        } else
        {
            ...
            {
                ((Dictionary<string, object>)request)["end_timestamp"] = this.sum(since, multiply(multiply(limit, duration), 1000));
            }
        }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue((isEqual(since, null)))) ? "publicGetGetLastTradesByInstrument" : "publicGetGetLastTradesByInstrumentAndTime";
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["start_timestamp"] = since;
        }
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(this.symbols)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)parsedFees)[(string)symbol] = fee;
        }
        return parsedFees;
    }
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)orderbook)["nonce"] = nonce;
        return orderbook;
    }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        } else if (isTrue(isEqual(getValue(market, "settle"), "USDC")))
        {
            amount = this.amountToPrecision(symbol, amount);
        } else
        {
        ...
        {
            ((Dictionary<string, object>)request)["type"] = "limit";
            ((Dictionary<string, object>)request)["price"] = this.priceToPrecision(symbol, price);
        } else
        {
            ((Dictionary<string, object>)request)["type"] = "market";
        }
        if (isTrue(isStopOrder))
        {
            ...
            ((Dictionary<string, object>)request)["trigger"] = "last_price"; // required
            if (isTrue(isStopLossOrder))
            {
                if (isTrue(isMarketOrder))
                {
                    // stop_market (sell only)
                    ((Dictionary<string, object>)request)["type"] = "stop_market";
                } else
                {
            ...
            } else
            {
                if (isTrue(isMarketOrder))
                {
                    ...
                    ((Dictionary<string, object>)request)["type"] = "take_market";
                } else
                {
                    // take_limit (buy only)
                    ((Dictionary<string, object>)request)["type"] = "take_limit";
                }
            }
        }
        ...
        if (isTrue(postOnly))
        {
            ...
            ((Dictionary<string, object>)request)["reject_post_only"] = true;
        }
        if (isTrue(!isEqual(timeInForce, null)))
        {
            if (isTrue(isEqual(timeInForce, "GTC")))
            {
                ((Dictionary<string, object>)request)["time_in_force"] = "good_til_cancelled";
            }
        ...
        object method = add("privateGet", this.capitalize(side));
        parameters = this.omit(parameters, new List<object>() {"timeInForce", "stopLossPrice", "takeProfitPrice", "postOnly", "reduceOnly"});
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        //     {
        //         "jsonrpc": "2.0",
        ...
        object trades = this.safeValue(result, "trades", new List<object>() {});
        ((Dictionary<string, object>)order)["trades"] = trades;
    ...
    public async override Task<object> fetchPositions(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        } else if (isTrue(((symbols).GetType() == typeof(string))))
        {
            code = symbols;
    ...
    public async virtual Task<object> fetchHistoricalVolatility(object code, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object currency = this.currency(code);
        ...
        //     }
        //
        object volatilityResult = this.safeValue(response, "result", new Dictionary<string, object>() {});
        object result = new List<object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(volatilityResult)); postFixIncrement(ref i))
        {
            ...
            object volatility = this.safeNumber(getValue(volatilityResult, i), 1);
            ((List<object>)result).Add(new Dictionary<string, object>() {
                { "info", response },
                { "timestamp", timestamp },
                { "datetime", this.iso8601(timestamp) },
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["tfa"] = totp(this.twofa);
        }
