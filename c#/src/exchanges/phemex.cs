...
partial class phemex : Exchange
{
    ...
    public virtual object parseSafeNumber(object value = null)
    {
        ...
        object parts = ((string)value).Split((string)",").ToList<object>();
        value = String.Join("", parts);
        parts = ((string)value).Split((string)" ").ToList<object>();
    ...
    public virtual object parseSwapMarket(object market)
    {
        ...
        if (isTrue(getIndexOf(contractSizeString, " ")))
        {
            // "1 USD"
            // "0.005 ETH"
            object parts = ((string)contractSizeString).Split((string)" ").ToList<object>();
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object v2Products = await this.publicGetCfgV2Products(parameters);
        //
        //     {
        //         "code":0,
        //         "msg":"OK",
    ...
    public virtual object customParseOrderBook(object orderbook, object symbol, object timestamp = null, object bidsKey = null, object asksKey = null, object priceKey = null, object amountKey = null, object market = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(sides)); postFixIncrement(ref i))
        {
            ...
            {
                ((List<object>)orders).Add(this.customParseBidAsk(getValue(bidasks, k), priceKey, amountKey, market));
            }
            ((Dictionary<string, object>)result)[(string)side] = orders;
        }
        ((Dictionary<string, object>)result)[(string)bidsKey] = this.sortBy(getValue(result, bidsKey), 0, true);
        ((Dictionary<string, object>)result)[(string)asksKey] = this.sortBy(getValue(result, asksKey), 0);
        return result;
    }
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "v1GetMdOrderbook";
        ...
        ((Dictionary<string, object>)orderbook)["nonce"] = this.safeInteger(result, "sequence");
        return ((object)orderbook);
    }

    public virtual object toEn(object n, object scale)
    {
        object stringN = ((object)n).ToString();
        ...
        object floatValue = parseFloat(stringValue);
        object floatString = ((object)floatValue).ToString();
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object possibleLimitValues = new List<object>() {5, 10, 50, 100, 500, 1000};
        object maxLimit = 1000; // maximum limit, we shouldn't sent request of more than it
        ...
        {
            since = this.parseToInt(divide(since, 1000));
            ((Dictionary<string, object>)request)["from"] = since;
            // time ranges ending in the future are not accepted
            // https://github.com/ccxt/ccxt/issues/8050
            ((Dictionary<string, object>)request)["to"] = mathMin(now, this.sum(since, multiply(duration, limit)));
        } else
        {
            if (!isTrue(this.inArray(limit, possibleLimitValues)))
            {
                limit = 100;
            }
            ((Dictionary<string, object>)request)["limit"] = limit;
        }
        object method = "publicGetMdKline";
        if (isTrue(isTrue(getValue(market, "linear")) || isTrue(isEqual(getValue(market, "settle"), "USDT"))))
        {
    ...
    public override object parseTicker(object ticker, object market = null)
    {
        ...
        object quoteVolume = this.fromEv(this.safeString2(ticker, "turnoverEv", "turnoverRv"), market);
    ...
    public async override Task<object> fetchTicker(object symbol, object parameters = null)
    {
        ...
        */
        ...
        object method = "v1GetMdSpotTicker24hr";
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        if (isTrue((trade.GetType().IsGenericType && trade.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
            ...
            if (isTrue(((getValue(trade, subtract(tradeLength, 2))).GetType() == typeof(int) || (getValue(trade, subtract(tradeLength, 2))).GetType() == typeof(float) || (getValue(trade, subtract(tradeLength, 2))).GetType() == typeof(double))))
            {
    ...
    public virtual object parseSwapBalance(object response)
    {
        ...
        ((Dictionary<string, object>)account)["total"] = ((bool) isTrue(needsConversion)) ? this.fromEn(accountBalanceEv, valueScale) : accountBalanceEv;
        ((Dictionary<string, object>)account)["used"] = ((bool) isTrue(needsConversion)) ? this.fromEn(totalUsedBalanceEv, valueScale) : totalUsedBalanceEv;
        ((Dictionary<string, object>)result)[(string)code] = account;
        return this.safeBalance(result);
    }
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        object method = "privateGetSpotWallets";
        object request = new Dictionary<string, object>() {};
        if (isTrue(isEqual(type, "swap")))
        {
            object code = this.safeString(parameters, "code");
            object settle = null;
                        var settleparametersVariable = this.handleOptionAndParams(parameters, "fetchBalance", "settle");
        ...
        parameters = this.omit(parameters, new List<object>() {"type", "code"});
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        // usdt
        //   {
    ...
    public virtual object parseSpotOrder(object order, object market = null)
    {
        ...
        object cost = this.fromEv(this.safeString2(order, "cumQuoteValueEv", "quoteQtyEv"), market);
        ...
        object stopPrice = this.parseNumber(this.omitZero(this.fromEp(this.safeString(order, "stopPxEp", market))));
    ...
    public virtual object parseSwapOrder(object order, object market = null)
    {
        ...
        object timeInForce = this.parseTimeInForce(this.safeString(order, "timeInForce"));
        object stopPrice = this.safeNumber2(order, "stopPx", "stopPxRp");
        object postOnly = (isEqual(timeInForce, "PO"));
    ...
    {
        object isSwap = this.safeValue(market, "swap", false);
        object hasPnl = (((Dictionary<string,object>)order).ContainsKey(toStringOrNull("closedPnl")));
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(stopPrice, null)))
        {
            if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
            {
                ((Dictionary<string, object>)request)["stopPxRp"] = this.priceToPrecision(symbol, stopPrice);
            } else
            {
                ((Dictionary<string, object>)request)["stopPxEp"] = this.toEp(stopPrice, market);
            }
        }
        ...
        if (isTrue(getValue(market, "spot")))
        {
            ...
            ((Dictionary<string, object>)request)["qtyType"] = qtyType;
            if (isTrue(isEqual(qtyType, "ByQuote")))
            {
                ...
                object costString = ((object)cost).ToString();
                ((Dictionary<string, object>)request)["quoteQtyEv"] = this.toEv(costString, market);
            } else
            {
                object amountString = ((object)amount).ToString();
                ((Dictionary<string, object>)request)["baseQtyEv"] = this.toEv(amountString, market);
            }
        } else if (isTrue(getValue(market, "swap")))
        {
            ...
            ((Dictionary<string, object>)request)["posSide"] = posSide;
            if (isTrue(!isEqual(reduceOnly, null)))
            {
                ((Dictionary<string, object>)request)["reduceOnly"] = reduceOnly;
            }
            if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
            {
                ((Dictionary<string, object>)request)["orderQtyRq"] = amount;
            } else
            {
                ((Dictionary<string, object>)request)["orderQty"] = parseInt(amount);
            }
            if (isTrue(!isEqual(stopPrice, null)))
            {
        ...
        if (isTrue(isTrue(isTrue((isEqual(type, "Limit"))) || isTrue((isEqual(type, "StopLimit")))) || isTrue((isEqual(type, "LimitIfTouched")))))
        {
            if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
            {
                ((Dictionary<string, object>)request)["priceRp"] = this.priceToPrecision(symbol, price);
            } else
            {
                object priceString = this.numberToString(price);
                ((Dictionary<string, object>)request)["priceEp"] = this.toEp(priceString, market);
            }
        }
        ...
        if (isTrue(!isEqual(takeProfitPrice, null)))
        {
            if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
            {
                ((Dictionary<string, object>)request)["takeProfitRp"] = this.priceToPrecision(symbol, takeProfitPrice);
            } else
            {
                ((Dictionary<string, object>)request)["takeProfitEp"] = this.toEp(takeProfitPrice, market);
            }
        ...
        if (isTrue(!isEqual(stopLossPrice, null)))
        {
            if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
            {
                ((Dictionary<string, object>)request)["stopLossRp"] = this.priceToPrecision(symbol, stopLossPrice);
            } else
            {
                ((Dictionary<string, object>)request)["stopLossEp"] = this.toEp(stopLossPrice, market);
            }
            parameters = this.omit(parameters, "stopLossPrice");
        }
        object method = "privatePostSpotOrders";
        if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
        {
    ...
    public async override Task<object> editOrder(object id, object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(price, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["priceRp"] = this.priceToPrecision(getValue(market, "symbol"), price);
            } else
            {
                ((Dictionary<string, object>)request)["priceEp"] = this.toEp(price, market);
            }
        }
        ...
        {
            ((Dictionary<string, object>)request)["baseQtyEV"] = finalQty;
        } else if (isTrue(!isEqual(amount, null)))
        {
            if (isTrue(isUSDTSettled))
            {
                ((Dictionary<string, object>)request)["baseQtyEV"] = this.amountToPrecision(getValue(market, "symbol"), amount);
            } else
            {
                ((Dictionary<string, object>)request)["baseQtyEV"] = this.toEv(amount, market);
            }
        }
        object stopPrice = this.safeString2(parameters, "stopPx", "stopPrice");
        if (isTrue(!isEqual(stopPrice, null)))
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "privateDeleteSpotOrders";
        if (isTrue(getValue(market, "inverse")))
        {
            method = "privateDeleteOrdersCancel";
        } else if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
        {
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object request = new Dictionary<string, object>() {};
        object market = this.market(symbol);
        object method = "privateDeleteSpotOrdersAll";
        if (isTrue(getValue(market, "inverse")))
        {
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(getValue(market, "spot"))) ? "privateGetSpotOrdersActive" : "privateGetExchangeOrder";
        object request = new Dictionary<string, object>() {
            { "symbol", getValue(market, "id") },
        };
        object clientOrderId = this.safeString2(parameters, "clientOrderId", "clOrdID");
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "privateGetSpotOrders";
        if (isTrue(getValue(market, "inverse")))
        {
            method = "privateGetExchangeOrderList";
        } else if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
        {
            ((Dictionary<string, object>)request)["currency"] = getValue(market, "settle");
    ...
    public async override Task<object> fetchClosedOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "privateGetExchangeSpotOrder";
        if (isTrue(getValue(market, "inverse")))
        {
            method = "privateGetExchangeOrderList";
        } else if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object method = "privateGetExchangeSpotOrderTrades";
        if (isTrue(getValue(market, "swap")))
        {
        ...
        if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
        {
            ((Dictionary<string, object>)request)["currency"] = "USDT";
        ...
        if (isTrue(isTrue(getValue(market, "swap")) && isTrue((!isEqual(limit, null)))))
        {
            ((Dictionary<string, object>)request)["limit"] = limit;
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        ...
        //
        object data = this.safeValue(response, "data", new Dictionary<string, object>() {});
        if (isTrue(!isEqual(method, "privateGetExchangeOrderV2TradingList")))
        {
            object rows = this.safeValue(data, "rows", new List<object>() {});
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["chainName"] = getValue(currency, "id");
        } else
        {
            ((Dictionary<string, object>)request)["chainName"] = network;
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        object timestamp = this.safeInteger2(transaction, "createdAt", "submitedAt");
    ...
    public async override Task<object> fetchPositions(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        object subType = null;
        object method = "privateGetAccountsAccountPositions";
    ...
    public override object parsePosition(object position, object market = null)
    {
        ...
        object leverage = this.safeNumber2(position, "leverage", "leverageRr");
    ...
    public async virtual Task<object> fetchFundingHistory(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "privateGetApiDataFuturesFundingFees";
        if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
        {
    ...
    public async virtual Task<object> setPositionMode(object hedged, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(hedged))
        {
            ((Dictionary<string, object>)request)["targetPosMode"] = "Hedged";
        } else
        {
            ((Dictionary<string, object>)request)["targetPosMode"] = "OneWay";
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            ((Dictionary<string, object>)headers)["x-phemex-request-signature"] = this.hmac(this.encode(auth), this.encode(this.secret), sha256);
        }
    ...
    public async override Task<object> setLeverage(object leverage, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "privatePutPositionsLeverage";
        if (isTrue(isEqual(getValue(market, "settle"), "USDT")))
        {
            method = "privatePutGPositionsLeverage";
            ((Dictionary<string, object>)request)["leverageRr"] = leverage;
        } else
        {
    ...
    public override object parseTransfer(object transfer, object currency = null)
    {
        ...
        object amountTransfered = this.fromEv(amountEv, currency);
