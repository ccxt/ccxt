...
partial class upbit : Exchange
{
    ...
    public async virtual Task<object> fetchCurrencyById(object id, object parameters = null)
    {
        ...
        object maxOnetimeWithdrawal = this.safeNumber(withdrawLimits, "onetime");
        object maxDailyWithdrawal = this.safeNumber(withdrawLimits, "daily", maxOnetimeWithdrawal);
        object remainingDailyWithdrawal = this.safeNumber(withdrawLimits, "remaining_daily", maxDailyWithdrawal);
        object maxWithdrawLimit = null;
        if (isTrue(isGreaterThan(remainingDailyWithdrawal, 0)))
        {
    ...
    public async virtual Task<object> fetchMarketById(object id, object parameters = null)
    {
        ...
        object bidFee = this.safeNumber(response, "bid_fee");
        object askFee = this.safeNumber(response, "ask_fee");
        object fee = mathMax(bidFee, askFee);
        return new Dictionary<string, object>() {
            { "id", marketId },
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            var quoteIdbaseIdVariable = ((string)id).Split((string)"-").ToList<object>();
            var quoteId = ((List<object>) quoteIdbaseIdVariable)[0];
            var baseId = ((List<object>) quoteIdbaseIdVariable)[1];
            object bs = this.safeCurrencyCode(baseId);
            object quote = this.safeCurrencyCode(quoteId);
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "publicGetCandlesTimeframe";
        if (isTrue(isEqual(timeframeValue, "minutes")))
        {
            object numMinutes = Math.Round((double)divide(timeframePeriod, 60));
            ((Dictionary<string, object>)request)["unit"] = numMinutes;
            method = add(method, "Unit");
        }
        if (isTrue(!isEqual(since, null)))
        {
            // convert `since` to `to` value
            ((Dictionary<string, object>)request)["to"] = this.iso8601(this.sum(since, multiply(multiply(timeframePeriod, limit), 1000)));
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(type, "limit")))
        {
            ...
            ((Dictionary<string, object>)request)["ord_type"] = type;
        } else if (isTrue(isEqual(type, "market")))
        {
            if (isTrue(isEqual(side, "buy")))
            {
                ((Dictionary<string, object>)request)["ord_type"] = "price";
                ((Dictionary<string, object>)request)["price"] = this.priceToPrecision(symbol, amount);
            } else if (isTrue(isEqual(side, "sell")))
            {
                ((Dictionary<string, object>)request)["ord_type"] = type;
                ((Dictionary<string, object>)request)["volume"] = this.amountToPrecision(symbol, amount);
        ...
        {
            ((Dictionary<string, object>)request)["identifier"] = clientOrderId;
        }
    ...
    public async override Task<object> fetchDeposits(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default is 100
        }
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object amount = this.safeNumber(order, "volume");
        object remaining = this.safeNumber(order, "remaining_volume");
        object filled = this.safeNumber(order, "executed_volume");
        object cost = null;
        ...
        object average = null;
        object fee = null;
        object feeCost = this.safeNumber(order, "paid_fee");
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        object method = "privatePostWithdraws";
        if (isTrue(!isEqual(code, "KRW")))
        {
            method = add(method, "Coin");
            ((Dictionary<string, object>)request)["currency"] = getValue(currency, "id");
            ((Dictionary<string, object>)request)["address"] = address;
            if (isTrue(!isEqual(tag, null)))
            {
                ((Dictionary<string, object>)request)["secondary_address"] = tag;
            }
        } else
        {
            method = add(method, "Krw");
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        //
        //     {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            if (isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)query).Keys))))
            {
                ...
                ((Dictionary<string, object>)request)["query_hash"] = hash;
                ((Dictionary<string, object>)request)["query_hash_alg"] = "SHA512";
            }
