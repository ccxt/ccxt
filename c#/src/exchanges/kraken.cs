...
partial class kraken : Exchange
{
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbols, null)))
        {
            ...
            ((Dictionary<string, object>)request)["pair"] = String.Join(",", marketIds);
        }
    ...
    public async virtual Task<object> fetchLedger(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object keys = new List<string>(((Dictionary<string,object>)ledger).Keys);
    ...
    public async virtual Task<object> fetchLedgerEntriesByIds(object ids, object code = null, object parameters = null)
    {
        ...
        object keys = new List<string>(((Dictionary<string,object>)result).Keys);
        object items = new List<object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            object key = getValue(keys, i);
    ...
    public async virtual Task<object> fetchOrderTrades(object id, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        for (object j = 0; isLessThan(j, numBatches); postFixIncrement(ref j))
        {
            ...
            object ids = new List<string>(((Dictionary<string,object>)rawTrades).Keys);
            for (object i = 0; isLessThan(i, getArrayLength(ids)); postFixIncrement(ref i))
            {
