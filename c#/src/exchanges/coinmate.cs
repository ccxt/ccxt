...
partial class coinmate : Exchange
{
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object allowedCurrencies = new List<object>(((Dictionary<string,object>)methods).Keys);
            throw new ExchangeError ((string)add(add(this.id, " withdraw() only allows withdrawing the following currencies: "), String.Join(", ", ((List<object>)allowedCurrencies).ToArray()))) ;
        }
        object request = new Dictionary<string, object>() {
