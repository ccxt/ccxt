...
partial class coinmate : Exchange
{
    ...
    public async override Task<object> fetchTransactions(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["timestampFrom"] = since;
        }
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        object tag = this.safeString(transaction, "destinationTag");
        object currencyId = this.safeString(transaction, "amountCurrency");
        object code = this.safeCurrencyCode(currencyId, currency);
        object type = this.safeStringLower(transaction, "transferType");
        object status = this.parseTransactionStatus(this.safeString(transaction, "transferStatus"));
        object id = this.safeString2(transaction, "transactionId", "id");
        object network = this.safeString(transaction, "walletType");
        return new Dictionary<string, object>() {
            { "id", id },
            { "timestamp", timestamp },
            { "datetime", this.iso8601(timestamp) },
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object allowedCurrencies = new List<string>(((Dictionary<string,object>)methods).Keys);
            throw new ExchangeError ((string)add(add(this.id, " withdraw() only allows withdrawing the following currencies: "), String.Join(", ", allowedCurrencies))) ;
        }
        object request = new Dictionary<string, object>() {
        ...
        {
            ((Dictionary<string, object>)request)["destinationTag"] = tag;
        }
        ...
        {
            ((Dictionary<string, object>)transaction)["amount"] = amount;
            ((Dictionary<string, object>)transaction)["currency"] = code;
            ((Dictionary<string, object>)transaction)["address"] = address;
            ((Dictionary<string, object>)transaction)["tag"] = tag;
            ((Dictionary<string, object>)transaction)["type"] = "withdrawal";
            ((Dictionary<string, object>)transaction)["status"] = "pending";
        }
        return transaction;
    }
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object market = this.market(symbol);
            ((Dictionary<string, object>)request)["currencyPair"] = getValue(market, "id");
        }
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["timestampFrom"] = since;
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(type, "market")))
        {
            ...
            {
                ((Dictionary<string, object>)request)["total"] = this.amountToPrecision(symbol, amount); // amount in fiat
            } else
            {
                ((Dictionary<string, object>)request)["amount"] = this.amountToPrecision(symbol, amount); // amount in fiat
            }
            method = add(method, "Instant");
        } else
        {
            ((Dictionary<string, object>)request)["amount"] = this.amountToPrecision(symbol, amount); // amount in crypto
