...
partial class btcturk : Exchange
{
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["last"] = limit;
        }
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ...
            if (isTrue(!isEqual(since, null)))
            {
                ...
                ((Dictionary<string, object>)request)["to"] = mathMin(getValue(request, "to"), to);
            } else
            {
                ((Dictionary<string, object>)request)["from"] = subtract(this.parseToInt(divide(until, 1000)), limitSeconds);
            }
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("clientOrderId"))))
        {
            ((Dictionary<string, object>)request)["newClientOrderId"] = getValue(parameters, "clientOrderId");
        } else if (!isTrue((((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("newClientOrderId")))))
        {
            ((Dictionary<string, object>)request)["newClientOrderId"] = this.uuid();
        }
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            ((Dictionary<string, object>)request)["pairSymbol"] = getValue(market, "id");
        }
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["startTime"] = (Math.Floor(Double.Parse((divide(since, 1000)).ToString())));
        }
