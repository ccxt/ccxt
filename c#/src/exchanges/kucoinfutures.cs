...
partial class kucoinfutures : kucoin
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "api", new Dictionary<string, object>() {
                ...
                { "webFront", new Dictionary<string, object>() {
                    { "get", new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)request)["to"] = endAt;
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["limit"] = 20;
        }
    ...
    public async virtual Task fetchL3OrderBook(object symbol, object limit = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
    ...
    public async virtual Task<object> fetchFundingHistory(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ...
            ((Dictionary<string, object>)request)["maxCount"] = limit;
        }
    ...
    public override object parsePosition(object position, object market = null)
    {
        ...
        object timestamp = this.safeNumber(position, "currentTimestamp");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(stopPrice))
        {
            ((Dictionary<string, object>)request)["stop"] = ((bool) isTrue((isEqual(side, "buy")))) ? "up" : "down";
            ((Dictionary<string, object>)request)["stopPrice"] = this.priceToPrecision(symbol, stopPrice);
            ((Dictionary<string, object>)request)["stopPriceType"] = "MP";
        } else if (isTrue(isTrue(isStopLoss) || isTrue(isTakeProfit)))
        {
            if (isTrue(isStopLoss))
            {
                ((Dictionary<string, object>)request)["stop"] = ((bool) isTrue((isEqual(side, "buy")))) ? "up" : "down";
                ((Dictionary<string, object>)request)["stopPrice"] = this.priceToPrecision(symbol, stopLossPrice);
            } else
            {
                ((Dictionary<string, object>)request)["stop"] = ((bool) isTrue((isEqual(side, "buy")))) ? "down" : "up";
                ((Dictionary<string, object>)request)["stopPrice"] = this.priceToPrecision(symbol, takeProfitPrice);
            }
        ...
        object response = await this.futuresPrivatePostOrders(this.extend(request, parameters));
        //
        //    {
        //        code: "200000",
        //        data: {
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.futuresPrivateDeleteOrdersOrderId(this.extend(request, parameters));
        //
        //   {
        //       code: "200000",
        //       data: {
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object method = ((bool) isTrue(stop)) ? "futuresPrivateDeleteStopOrders" : "futuresPrivateDeleteOrders";
    ...
    public async override Task<object> fetchOrdersByStatus(object status, object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        parameters = this.omit(parameters, new List<object>() {"stop", "until", "till"});
        ...
        object method = ((bool) isTrue(stop)) ? "futuresPrivateGetStopOrders" : "futuresPrivateGetOrders";
        object response = await this.callAsync(method, this.extend(request, parameters));
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object request = new Dictionary<string, object>() {};
        object method = "futuresPrivateGetOrdersOrderId";
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        object cost = Precise.stringDiv(rawCost, leverage);
        object average = null;
        ...
        // bool
        object isActive = this.safeValue(order, "isActive", false);
    ...
    public async override Task<object> fetchFundingRate(object symbol, object parameters = null)
    {
        ...
        */
        ...
        //
        object data = this.safeValue(response, "data");
        object fundingTimestamp = this.safeNumber(data, "timePoint");
    ...
    public virtual object parseBalance(object response)
    {
        ...
        ((Dictionary<string, object>)account)["free"] = this.safeString(data, "availableBalance");
        ((Dictionary<string, object>)account)["total"] = this.safeString(data, "accountEquity");
    ...
    public async virtual Task<object> fetchFundingRateHistory(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.webFrontGetContractSymbolFundingRates(this.extend(request, parameters));
        //
        //    {
        //        success: true,
        //        code: '200',
        ...
        //
        object data = this.safeValue(response, "data");
        object dataList = this.safeValue(data, "dataList");
    ...
    {
        object timestamp = this.safeNumber(info, "timePoint");
