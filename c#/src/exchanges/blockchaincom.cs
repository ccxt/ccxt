...
partial class blockchaincom : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object marketIds = new List<string>(((Dictionary<string,object>)markets).Keys);
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(stopPrice, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["ordType"] = "STOP";
            } else if (isTrue(isEqual(uppercaseOrderType, "LIMIT")))
            {
                ((Dictionary<string, object>)request)["ordType"] = "STOPLIMIT";
            }
        }
        ...
        {
            ((Dictionary<string, object>)request)["stopPx"] = this.priceToPrecision(symbol, stopPrice);
        }
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            ((Dictionary<string, object>)request)["symbol"] = marketId;
        }
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)result)["currency"] = getValue(currency, "code");
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        } else if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("withdrawalId"))))
        {
            type = "withdrawal";
    ...
    public async virtual Task<object> fetchWithdrawalWhitelist(object parameters = null)
    {
        ...
        */
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object response = await this.privateGetWhitelist();
        object result = new List<object>() {};
    ...
    public async virtual Task<object> fetchWithdrawalWhitelistByCurrency(object code, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object currency = this.currency(code);
        ...
        object response = await this.privateGetWhitelistCurrency(this.extend(request, parameters));
        object result = new List<object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            object entry = getValue(response, i);
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(balances)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["total"] = this.safeString(entry, "balance");
