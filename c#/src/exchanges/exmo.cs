...
partial class exmo : Exchange
{
    ...
    public async virtual Task<object> modifyMarginHelper(object symbol, object amount, object type, object parameters = null)
    {
        ...
        {
            ((Dictionary<string, object>)margin)["type"] = type;
            ((Dictionary<string, object>)margin)["amount"] = amount;
        }
        return margin;
    }
    ...
    public virtual object parseFixedFloatValue(object input)
    {
        ...
        object parts = ((string)input).Split((string)" ").ToList<object>();
    ...
    public async override Task<object> fetchTransactionFees(object codes = null, object parameters = null)
    {
        ...
        */
        ...
        //
        object result = new Dictionary<string, object>() {};
        object cryptoListKeys = new List<string>(((Dictionary<string,object>)cryptoList).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(cryptoListKeys)); postFixIncrement(ref i))
        {
            ...
            for (object j = 0; isLessThan(j, getArrayLength(providers)); postFixIncrement(ref j))
            {
                ...
                ((Dictionary<string, object>)getValue(result, code))[(string)typeInner] = fee;
            }
            ((Dictionary<string, object>)getValue(result, code))["info"] = providers;
        }
        // cache them for later use
        ((Dictionary<string, object>)this.options)["transactionFees"] = result;
        return result;
    }
    ...
    public override object parseDepositWithdrawFee(object fee, object currency = null)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(fee)); postFixIncrement(ref i))
        {
            ...
            {
                splitCommissionDesc = ((string)commissionDesc).Split((string)"%").ToList<object>();
            ...
            ((Dictionary<string, object>)getValue(getValue(result, "networks"), networkCode))[(string)type] = new Dictionary<string, object>() {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencyList)); postFixIncrement(ref i))
        {
            ...
            } else
            {
                for (object j = 0; isLessThan(j, getArrayLength(providers)); postFixIncrement(ref j))
                {
                    object provider = getValue(providers, j);
                    object typeInner = this.safeString(provider, "type");
                    object minValue = this.safeNumber(provider, "min");
                    object maxValue = this.safeNumber(provider, "max");
                    if (isTrue(isEqual(maxValue, 0)))
                    {
                        maxValue = null;
                    }
                    ...
                    {
                        active = true;
                        if (isTrue(isTrue((isEqual(getValue(getValue(limits, typeInner), "min"), null))) || isTrue((isLessThan(minValue, getValue(getValue(limits, typeInner), "min"))))))
                        {
                            ((Dictionary<string, object>)getValue(limits, typeInner))["min"] = minValue;
                            ((Dictionary<string, object>)getValue(limits, typeInner))["max"] = maxValue;
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            ...
            var baseIdquoteIdVariable = ((string)symbol).Split((string)"/").ToList<object>();
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["from"] = subtract(subtract(this.parseToInt(divide(now, 1000)), multiply(limit, duration)), 1);
            ((Dictionary<string, object>)request)["to"] = this.parseToInt(divide(now, 1000));
        } else
        {
            ((Dictionary<string, object>)request)["from"] = subtract(this.parseToInt(divide(since, 1000)), 1);
            if (isTrue(isEqual(limit, null)))
            {
                ((Dictionary<string, object>)request)["to"] = this.parseToInt(divide(now, 1000));
            } else
            {
                ...
                ((Dictionary<string, object>)request)["to"] = this.parseToInt(divide(to, 1000));
            }
        }
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            if (isTrue(((Dictionary<string,object>)free).ContainsKey(toStringOrNull(currencyId))))
            {
                ((Dictionary<string, object>)account)["free"] = this.safeString(free, currencyId);
            }
            if (isTrue(((Dictionary<string,object>)used).ContainsKey(toStringOrNull(currencyId))))
            {
    ...
    public async virtual Task<object> fetchOrderBooks(object symbols = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)result)[(string)symbol] = this.parseOrderBook(getValue(response, marketId), symbol, null, "bid", "ask");
        }
        return result;
    }
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object symbol = getValue(market, "symbol");
        object takerOrMaker = this.safeString(trade, "exec_type");
        object fee = null;
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchMyTrades() requires a symbol argument (a single symbol or an array)")) ;
        }
        await this.loadMarkets();
        object pair = null;
        object market = null;
        if (isTrue((symbol.GetType().IsGenericType && symbol.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
            object numSymbols = getArrayLength(symbol);
            if (isTrue(isLessThan(numSymbols, 1)))
            {
                throw new ArgumentsRequired ((string)add(this.id, " fetchMyTrades() requires a non-empty symbol array")) ;
            }
            object marketIds = this.marketIds(symbol);
            pair = String.Join(",", marketIds);
        } else
        {
        ...
        object response = await this.privatePostUserTrades(this.extend(request, parameters));
        object result = new List<object>() {};
        object marketIdsInner = new List<string>(((Dictionary<string,object>)response).Keys);
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        await this.loadMarkets();
        object market = this.market(symbol);
        object prefix = ((bool) isTrue((isEqual(type, "market")))) ? (add(type, "_")) : "";
        object orderType = add(prefix, side);
        object orderPrice = price;
        ...
        object request = new Dictionary<string, object>() {
            ...
            { "type", orderType },
            { "price", this.priceToPrecision(getValue(market, "symbol"), orderPrice) },
        };
        object method = "privatePostOrderCreate";
        ...
        if (isTrue(!isEqual(clientOrderId, null)))
        {
            ...
            {
                ((Dictionary<string, object>)request)["client_id"] = clientOrderId;
            }
            parameters = this.omit(parameters, new List<object>() {"client_id", "clientOrderId"});
        }
        if (isTrue(isTrue(isTrue((isEqual(type, "stop"))) || isTrue((isEqual(type, "stop_limit")))) || isTrue((isEqual(type, "trailing_stop")))))
        {
            ...
            {
                parameters = this.omit(parameters, new List<object>() {"stopPrice", "stop_price"});
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.privatePostUserOpenOrders(parameters);
        object marketIds = new List<string>(((Dictionary<string,object>)response).Keys);
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            object parsedOrders = this.parseOrders(getValue(response, marketId), market, since, limit, parameters);
    ...
    public override object parseOrder(object order, object market = null)
    {
        ...
        if (isTrue(((Dictionary<string,object>)order).ContainsKey(toStringOrNull("pair"))))
        {
            marketId = getValue(order, "pair");
        } else if (isTrue(isTrue((((Dictionary<string,object>)order).ContainsKey(toStringOrNull("in_currency")))) && isTrue((((Dictionary<string,object>)order).ContainsKey(toStringOrNull("out_currency"))))))
        {
    ...
    public async virtual Task<object> fetchCanceledOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.privatePostUserCancelledOrders(this.extend(request, parameters));
        //
        //     [{
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        {
            object addressAndTag = ((string)depositAddress).Split((string)",").ToList<object>();
    ...
    public virtual object getMarketFromTrades(object trades)
    {
        ...
        object symbols = new List<string>(((Dictionary<string,object>)tradesBySymbol).Keys);
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["invoice"] = tag;
        }
        ...
        if (isTrue(!isEqual(network, null)))
        {
            ((Dictionary<string, object>)request)["transport"] = network;
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        } else if (isTrue(isEqual(type, "withdrawal")))
        {
            ...
            {
                object parts = ((string)address).Split((string)":").ToList<object>();
        ...
        if (!isTrue(getValue(getValue(this.fees, "transaction"), "percentage")))
        {
            ...
            if (isTrue(!isEqual(feeCost, null)))
            {
                ...
                ((Dictionary<string, object>)fee)["cost"] = this.parseNumber(feeCost);
    ...
    public async override Task<object> fetchTransactions(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["date"] = this.parseToInt(divide(since, 1000));
        }
    ...
    public async override Task<object> fetchWithdrawals(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default: 100, maximum: 100
        }
        if (isTrue(!isEqual(code, null)))
        {
            currency = this.currency(code);
    ...
    public override object handleErrors(object httpCode, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(isTrue((((Dictionary<string,object>)response).ContainsKey(toStringOrNull("result")))) || isTrue((((Dictionary<string,object>)response).ContainsKey(toStringOrNull("errmsg"))))))
        {
            //
            //     {"result":false,"error":"Error 50052: Insufficient funds"}
            //     {"s":"error","errmsg":"strconv.ParseInt: parsing \"\": invalid syntax"}
            //
            object success = this.safeValue(response, "result", false);
            ...
            if (!isTrue(success))
            {
                ...
                object errorParts = ((string)message).Split((string)":").ToList<object>();
                object numParts = getArrayLength(errorParts);
                if (isTrue(isGreaterThan(numParts, 1)))
                {
                    object errorSubParts = ((string)getValue(errorParts, 0)).Split((string)" ").ToList<object>();
