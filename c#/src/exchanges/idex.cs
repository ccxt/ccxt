...
partial class idex : Exchange
{
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        {
            object allOptions = new List<object>(((Dictionary<string,object>)timeInForceEnums).Keys);
            object asString = String.Join(", ", ((List<object>)allOptions).ToArray());
        ...
        {
            object allOptions = new List<object>(((Dictionary<string,object>)selfTradePreventionEnums).Keys);
            object asString = String.Join(", ", ((List<object>)allOptions).ToArray());
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        object keys = new List<object>(((Dictionary<string,object>)parameters).Keys);
