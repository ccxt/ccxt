...
partial class idex : Exchange
{
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["total"] = this.safeString(entry, "quantity");
            ((Dictionary<string, object>)account)["free"] = this.safeString(entry, "availableForTrade");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(type, "market")))
        {
            ((Dictionary<string, object>)getValue(request, "parameters"))["timeInForce"] = timeInForce;
        }
        if (isTrue(limitOrder))
        {
        ...
        if (isTrue(!isEqual(clientOrderId, null)))
        {
            ((Dictionary<string, object>)getValue(request, "parameters"))["clientOrderId"] = clientOrderId;
        }
        // {
        //   market: 'DIL-ETH',
        //   orderId: '7cdc8e90-eb7d-11ea-9e60-4118569f6e63',
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(market, null)))
        {
            ...
            ((Dictionary<string, object>)getValue(request, "parameters"))["market"] = getValue(market, "id");
        }
        object binary = this.binaryConcatArray(byteArray);
        object hash = this.hash(binary, keccak, "hex");
        object signature = this.signMessageString(hash, this.privateKey);
        ((Dictionary<string, object>)request)["signature"] = signature;
    ...
    public async override Task<object> fetchDeposits(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        return this.fetchTransactionsHelper(code, since, limit, parameters);
    }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        {
            ((Dictionary<string, object>)headers)["IDEX-API-Key"] = this.apiKey;
        }
        if (isTrue(isEqual(api, "private")))
        {
            ...
            ((Dictionary<string, object>)headers)["IDEX-HMAC-Signature"] = this.hmac(this.encode(payload), this.encode(this.secret), sha256, "hex");
        }
        return new Dictionary<string, object>() {
            { "url", url },
            { "method", method },
