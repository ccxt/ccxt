...
partial class bitopro : Exchange
{
        ...
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "api", new Dictionary<string, object>() {
                { "public", new Dictionary<string, object>() {
                    { "get", new List<object>() {"order-book/{pair}", "tickers", "tickers/{pair}", "trades/{pair}", "provisioning/currencies", "provisioning/trading-pairs", "provisioning/limitations-and-fees", "trading-history/{pair}"} },
                } },
                { "private", new Dictionary<string, object>() {
                    { "get", new List<object>() {"accounts/balance", "orders/history", "orders/all/{pair}", "orders/trades/{pair}", "orders/{pair}/{orderId}", "wallet/withdraw/{currency}/{serial}", "wallet/withdraw/{currency}/id/{id}", "wallet/depositHistory/{currency}", "wallet/withdrawHistory/{currency}"} },
                    { "post", new List<object>() {"orders/{pair}", "orders/batch", "wallet/withdraw/{currency}"} },
                    { "put", new List<object>() {"orders"} },
                    { "delete", new List<object>() {"orders/{pair}/{id}", "orders/all", "orders/{pair}"} },
                } },
            } },
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["from"] = subtract(getValue(request, "to"), (multiply(limit, timeframeInSeconds)));
        } else
        {
            ...
            ((Dictionary<string, object>)request)["from"] = (Math.Floor(Double.Parse((divide(since, 1000)).ToString())));
            ((Dictionary<string, object>)request)["to"] = this.sum(getValue(request, "from"), multiply(limit, timeframeInSeconds));
        }
    ...
    public virtual object insertMissingCandles(object candles, object distance, object since, object limit)
    {
        ...
        while (isTrue((isLessThan(resultLength, limit))) && isTrue((isLessThan(i, candleLength))))
        {
            ...
            } else
            {
                ...
                ((List<object>)copy)[(int)0] = timestamp;
                // set open, high, low to close
                ((List<object>)copy)[(int)1] = getValue(copy, 4);
                ((List<object>)copy)[(int)2] = getValue(copy, 4);
                ((List<object>)copy)[(int)3] = getValue(copy, 4);
                ((List<object>)copy)[(int)5] = this.parseNumber("0");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(orderType, "STOP_LIMIT")))
        {
            ...
            {
                ((Dictionary<string, object>)request)["condition"] = condition;
            }
        }
        object postOnly = this.isPostOnly(isEqual(orderType, "MARKET"), null, parameters);
        if (isTrue(postOnly))
        {
            ((Dictionary<string, object>)request)["timeInForce"] = "POST_ONLY";
        }
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            throw new ArgumentsRequired ((string)add(this.id, " cancelOrder() requires the symbol argument")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object request = new Dictionary<string, object>() {
    ...
    public async virtual Task<object> cancelOrders(object ids, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object request = new Dictionary<string, object>() {};
        ((Dictionary<string, object>)request)[(string)id] = ids;
    ...
    public async override Task<object> cancelAllOrders(object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object method = this.safeString(this.options, "privateDeleteOrdersPair", "privateDeleteOrdersAll");
        if (isTrue(!isEqual(symbol, null)))
        {
            object market = this.market(symbol);
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(symbol, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchOrder() requires the symbol argument")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object request = new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(symbol, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchOrders() requires the symbol argument")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object request = new Dictionary<string, object>() {
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["startTimestamp"] = since;
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit;
    ...
    public override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        object request = new Dictionary<string, object>() {
            { "statusKind", "OPEN" },
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(symbol, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchMyTrades() requires the symbol argument")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object request = new Dictionary<string, object>() {
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("network"))))
        {
            ...
            ((Dictionary<string, object>)request)["protocol"] = networkId;
        }
        if (isTrue(!isEqual(tag, null)))
        {
            ((Dictionary<string, object>)request)["message"] = tag;
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        ((Dictionary<string, object>)headers)["X-BITOPRO-API"] = "ccxt";
        if (isTrue(isEqual(api, "private")))
        {
            ...
            if (isTrue(isTrue(isEqual(method, "POST")) || isTrue(isEqual(method, "PUT"))))
            {
                ...
                object signature = this.hmac(payload, this.encode(this.secret), sha384);
                ((Dictionary<string, object>)headers)["X-BITOPRO-APIKEY"] = this.apiKey;
                ((Dictionary<string, object>)headers)["X-BITOPRO-PAYLOAD"] = payload;
                ((Dictionary<string, object>)headers)["X-BITOPRO-SIGNATURE"] = signature;
