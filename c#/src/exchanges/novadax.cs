...
partial class novadax : Exchange
{
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 10, max 20
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["from"] = subtract(now, multiply(limit, duration));
            ((Dictionary<string, object>)request)["to"] = now;
        } else
        {
            object startFrom = this.parseToInt(divide(since, 1000));
            ((Dictionary<string, object>)request)["from"] = startFrom;
            ((Dictionary<string, object>)request)["to"] = this.sum(startFrom, multiply(limit, duration));
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            ((Dictionary<string, object>)request)["operator"] = this.safeString(parameters, "operator", defaultOperator);
        ...
        } else if (isTrue(isTrue((isEqual(uppercaseType, "MARKET"))) || isTrue((isEqual(uppercaseType, "STOP_MARKET")))))
        {
            ...
            {
                object value = this.safeNumber(parameters, "value");
                ...
                {
                    value = ((bool) isTrue((isEqual(value, null)))) ? amount : value;
                }
                ((Dictionary<string, object>)request)["value"] = this.costToPrecision(symbol, value);
            }
        }
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["fromTimestamp"] = since;
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        } else if (isTrue(isEqual(api, "private")))
        {
            ...
            ((Dictionary<string, object>)headers)["X-Nova-Signature"] = this.hmac(this.encode(auth), this.encode(this.secret), sha256);
        }
        return new Dictionary<string, object>() {
            { "url", url },
            { "method", method },
