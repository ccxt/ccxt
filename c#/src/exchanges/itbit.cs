...
partial class itbit : Exchange
{
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isTrue(isEqual(method, "GET")) && isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)query).Keys)))))
        {
            url = add(url, add("?", this.urlencode(query)));
        }
        if (isTrue(isTrue(isEqual(method, "POST")) && isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)query).Keys)))))
        {
