...
partial class coinspot : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "markets", new Dictionary<string, object>() {
                { "ADA/AUD", new Dictionary<string, object>() {
                    { "id", "ada" },
                    { "symbol", "ADA/AUD" },
                    { "base", "ADA" },
                    { "quote", "AUD" },
                ...
                { "BTC/AUD", new Dictionary<string, object>() {
                    { "id", "btc" },
                    { "symbol", "BTC/AUD" },
                    { "base", "BTC" },
                    { "quote", "AUD" },
                ...
                { "ETH/AUD", new Dictionary<string, object>() {
                    { "id", "eth" },
                    { "symbol", "ETH/AUD" },
                    { "base", "ETH" },
                    { "quote", "AUD" },
                ...
                { "XRP/AUD", new Dictionary<string, object>() {
                    { "id", "xrp" },
                    { "symbol", "XRP/AUD" },
                    { "base", "XRP" },
                    { "quote", "AUD" },
                ...
                { "LTC/AUD", new Dictionary<string, object>() {
                    { "id", "ltc" },
                    { "symbol", "LTC/AUD" },
                    { "base", "LTC" },
                    { "quote", "AUD" },
                ...
                { "DOGE/AUD", new Dictionary<string, object>() {
                    { "id", "doge" },
                    { "symbol", "DOGE/AUD" },
                    { "base", "DOGE" },
                    { "quote", "AUD" },
                ...
                { "RFOX/AUD", new Dictionary<string, object>() {
                    { "id", "rfox" },
                    { "symbol", "RFOX/AUD" },
                    { "base", "RFOX" },
                    { "quote", "AUD" },
                ...
                { "POWR/AUD", new Dictionary<string, object>() {
                    { "id", "powr" },
                    { "symbol", "POWR/AUD" },
                    { "base", "POWR" },
                    { "quote", "AUD" },
                ...
                { "NEO/AUD", new Dictionary<string, object>() {
                    { "id", "neo" },
                    { "symbol", "NEO/AUD" },
                    { "base", "NEO" },
                    { "quote", "AUD" },
                ...
                { "TRX/AUD", new Dictionary<string, object>() {
                    { "id", "trx" },
                    { "symbol", "TRX/AUD" },
                    { "base", "TRX" },
                    { "quote", "AUD" },
                ...
                { "EOS/AUD", new Dictionary<string, object>() {
                    { "id", "eos" },
                    { "symbol", "EOS/AUD" },
                    { "base", "EOS" },
                    { "quote", "AUD" },
                ...
                { "XLM/AUD", new Dictionary<string, object>() {
                    { "id", "xlm" },
                    { "symbol", "XLM/AUD" },
                    { "base", "XLM" },
                    { "quote", "AUD" },
                ...
                { "RHOC/AUD", new Dictionary<string, object>() {
                    { "id", "rhoc" },
                    { "symbol", "RHOC/AUD" },
                    { "base", "RHOC" },
                    { "quote", "AUD" },
                ...
                { "GAS/AUD", new Dictionary<string, object>() {
                    { "id", "gas" },
                    { "symbol", "GAS/AUD" },
                    { "base", "GAS" },
                    { "quote", "AUD" },
    ...
    public virtual object parseBalance(object response)
    {
        ...
        if (isTrue((balances.GetType().IsGenericType && balances.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
            for (object i = 0; isLessThan(i, getArrayLength(balances)); postFixIncrement(ref i))
            {
                object currencies = getValue(balances, i);
                object currencyIds = new List<string>(((Dictionary<string,object>)currencies).Keys);
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        object result = new Dictionary<string, object>() {};
        object prices = this.safeValue(response, "prices");
        object ids = new List<string>(((Dictionary<string,object>)prices).Keys);
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        object costString = this.safeNumber(trade, "total");
        object timestamp = this.safeInteger(trade, "solddate");
