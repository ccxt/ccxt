...
partial class bithumb : Exchange
{
        ...
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "api", new Dictionary<string, object>() {
                { "public", new Dictionary<string, object>() {
                    { "get", new List<object>() {"ticker/{currency}", "ticker/all", "ticker/ALL_BTC", "ticker/ALL_KRW", "orderbook/{currency}", "orderbook/all", "transaction_history/{currency}", "transaction_history/all", "candlestick/{currency}/{interval}"} },
                } },
                { "private", new Dictionary<string, object>() {
                    { "post", new List<object>() {"info/account", "info/balance", "info/wallet_address", "info/ticker", "info/orders", "info/user_transactions", "info/order_detail", "trade/place", "trade/cancel", "trade/btc_withdrawal", "trade/krw_deposit", "trade/krw_withdrawal", "trade/market_buy", "trade/market_sell"} },
                } },
            } },
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object quotes = new List<string>(((Dictionary<string,object>)quoteCurrencies).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(quotes)); postFixIncrement(ref i))
        {
            ...
            for (object j = 0; isLessThan(j, getArrayLength(currencyIds)); postFixIncrement(ref j))
            {
                ...
                object active = true;
                if (isTrue((market.GetType().IsGenericType && market.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
                {
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(codes)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["total"] = this.safeString(balances, add("total_", lowerCurrencyId));
            ((Dictionary<string, object>)account)["used"] = this.safeString(balances, add("in_use_", lowerCurrencyId));
            ((Dictionary<string, object>)account)["free"] = this.safeString(balances, add("available_", lowerCurrencyId));
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object request = new Dictionary<string, object>() {
            { "currency", add(add(getValue(market, "base"), "_"), getValue(market, "quote")) },
        };
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["count"] = limit; // default 30, max 30
        }
        object response = await this.publicGetOrderbookCurrency(this.extend(request, parameters));
        //
        //     {
        //         "status":"0000",
        //         "data":{
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(quotes)); postFixIncrement(ref i))
        {
            ...
            object currencyIds = new List<string>(((Dictionary<string,object>)tickers).Keys);
            for (object j = 0; isLessThan(j, getArrayLength(currencyIds)); postFixIncrement(ref j))
            {
                object currencyId = getValue(currencyIds, j);
                ...
                ((Dictionary<string, object>)ticker)["date"] = timestamp;
    ...
    public async override Task<object> fetchTicker(object symbol, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.publicGetTickerCurrency(this.extend(request, parameters));
        //
        //     {
        //         "status":"0000",
        //         "data":{
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.publicGetCandlestickCurrencyInterval(this.extend(request, parameters));
        //
        //     {
        //         'status': '0000',
        //         'data': {
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        {
            object parts = ((string)transactionDatetime).Split((string)" ").ToList<object>();
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["count"] = limit; // default 20, max 100
        }
        object response = await this.publicGetTransactionHistoryCurrency(this.extend(request, parameters));
        //
        //     {
        //         "status":"0000",
        //         "data":[
    ...
    public override Task<object> cancelUnifiedOrder(object order, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        object request = new Dictionary<string, object>() {
            { "side", getValue(order, "side") },
        };
        return this.cancelOrder(getValue(order, "id"), getValue(order, "symbol"), this.extend(request, parameters));
    }
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isTrue(isTrue(isTrue(isEqual(currency, "XRP")) || isTrue(isEqual(currency, "XMR"))) || isTrue(isEqual(currency, "EOS"))) || isTrue(isEqual(currency, "STEEM"))))
        {
