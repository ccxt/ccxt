...
partial class btcmarkets : Exchange
{
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        {
            object addressParts = ((string)address).Split((string)"?dt=").ToList<object>();
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default is 10, max 200
        }
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)orderbook)["nonce"] = this.safeInteger(response, "snapshotId");
        return orderbook;
    }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)request)["type"] = this.safeString(orderTypes, lowercaseType, type);
    ...
    public async virtual Task<object> cancelOrders(object ids, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((List<object>)ids)[(int)i] = parseInt(getValue(ids, i));
        }
        object request = new Dictionary<string, object>() {
            { "ids", ids },
        };
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            ((Dictionary<string, object>)request)["marketId"] = getValue(market, "id");
        }
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["after"] = since;
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(code, "AUD")))
        {
            ...
            ((Dictionary<string, object>)request)["toAddress"] = address;
        }
        if (isTrue(!isEqual(tag, null)))
        {
            ((Dictionary<string, object>)request)["toAddress"] = add(add(address, "?dt="), tag);
        }
