...
partial class yobit : Exchange
{
    ...
    public virtual object parseBalance(object response)
    {
        ...
        object currencyIds = new List<string>(((Dictionary<string,object>)this.extend(free, total)).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(currencyIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["total"] = this.safeString(total, currencyId);
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        object result = new Dictionary<string, object>() {};
        object keys = new List<string>(((Dictionary<string,object>)tickers).Keys);
    ...
    public async override Task<object> fetchTradingFees(object parameters = null)
    {
        ...
        */
        ...
        object marketIds = new List<string>(((Dictionary<string,object>)pairs).Keys);
        object result = new Dictionary<string, object>() {};
    ...
    public async override Task<object> fetchOpenOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(symbol, null)))
        {
            ...
            ((Dictionary<string, object>)request)["pair"] = getValue(marketInner, "id");
        }
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object ids = new List<string>(((Dictionary<string,object>)trades).Keys);
        object result = new List<object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(ids)); postFixIncrement(ref i))
        {
            object id = getValue(ids, i);
