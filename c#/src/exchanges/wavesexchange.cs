...
partial class wavesexchange : Exchange
{
        ...
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "api", new Dictionary<string, object>() {
                { "matcher", new Dictionary<string, object>() {
                    ...
                    { "post", new List<object>() {"matcher/orderbook", "matcher/orderbook/market", "matcher/orderbook/cancel", "matcher/orderbook/{baseId}/{quoteId}/cancel", "matcher/orderbook/{amountAsset}/{priceAsset}/calculateFee", "matcher/debug/saveSnapshots", "matcher/orders/{address}/cancel", "matcher/orders/cancel/{orderId}"} },
            ...
            { "currencies", new Dictionary<string, object>() {
                { "WX", new Dictionary<string, object>() {
    ...
    {
        ((Dictionary<string, object>)this.options)["messagePrefix"] = ((bool) isTrue(enabled)) ? "T" : "W";
    ...
    public async virtual Task<object> customCalculateFee(object symbol, object type, object side, object amount, object price, object takerOrMaker = null, object parameters = null)
    {
        ...
        //     }
        //  }
        object isDiscountFee = this.safeValue(parameters, "isDiscountFee", false);
        object mode = null;
    ...
    public async virtual Task<object> getQuotes()
    {
        ...
        } else
        {
            ...
            {
                ((Dictionary<string, object>)quotes)[(string)getValue(priceAssets, i)] = true;
            }
            ((Dictionary<string, object>)this.options)["quotes"] = quotes;
            return quotes;
        }
    }
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            var bsquoteVariable = ((string)marketId).Split((string)"/").ToList<object>();
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        object response = await this.matcherGetMatcherOrderbookAmountAssetPriceAsset(request);
    ...
    public virtual object parseOrderBookSide(object bookSide, object market = null, object limit = null)
    {
        ...
        object amountPrecision = Math.Pow((double)10, (double)getValue(precision, "amount"));
        object difference = subtract(getValue(precision, "amount"), getValue(precision, "price"));
        object pricePrecision = Math.Pow((double)10, (double)subtract(wavesPrecision, difference));
        object result = new List<object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(bookSide)); postFixIncrement(ref i))
        {
            object entry = getValue(bookSide, i);
            object price = divide(this.safeInteger(entry, "price", 0), pricePrecision);
            object amount = divide(this.safeInteger(entry, "amount", 0), amountPrecision);
            if (isTrue(isTrue((!isEqual(limit, null))) && isTrue((isGreaterThan(i, limit)))))
            {
                break;
            }
            ((List<object>)result).Add(new List<object>() {price, amount});
        }
        return result;
    }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isTrue((isEqual(api, "private"))) || isTrue((isEqual(api, "forward")))))
        {
            ...
            {
                ((Dictionary<string, object>)headers)["Authorization"] = add("Bearer ", accessToken);
            }
    ...
    public async virtual Task<object> signIn(object parameters = null)
    {
        ...
        */
        ...
        if (!isTrue(this.safeString(this.options, "accessToken")))
        {
            ...
            object clientId = "waves.exchange";
            ...
            object signature = eddsa(payload, hexKey, ed25519);
            ...
            ((Dictionary<string, object>)this.options)["accessToken"] = this.safeString(response, "access_token");
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["timeStart"] = ((object)timeStart).ToString();
        } else
        {
            ((Dictionary<string, object>)request)["timeStart"] = ((object)since).ToString();
            object timeEnd = this.sum(since, multiply(duration, limit));
            ((Dictionary<string, object>)request)["timeEnd"] = ((object)timeEnd).ToString();
        }
        ...
        for (object i = 0; isLessThan(i, getArrayLength(result)); postFixIncrement(ref i))
        {
            ...
            {
                ((List<object>)entry)[(int)1] = lastClose;
                ((List<object>)entry)[(int)2] = lastClose;
                ((List<object>)entry)[(int)3] = lastClose;
                ((List<object>)entry)[(int)4] = lastClose;
                ((List<object>)result)[(int)j] = entry;
            }
    ...
    public virtual object filterFutureCandles(object ohlcvs)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(ohlcvs)); postFixIncrement(ref i))
        {
            ...
            ((List<object>)result).Add(getValue(ohlcvs, i));
        }
        return result;
    }
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(items)); postFixIncrement(ref i))
        {
            ...
            for (object j = 0; isLessThan(j, getArrayLength(innerCurrencies)); postFixIncrement(ref j))
            {
                ...
                ((Dictionary<string, object>)currencies)[(string)currencyCode] = true;
                if (!isTrue((((Dictionary<string,object>)networksByCurrency).ContainsKey(toStringOrNull(currencyCode)))))
                {
                    ((Dictionary<string, object>)networksByCurrency)[(string)currencyCode] = new Dictionary<string, object>() {};
                }
                ((Dictionary<string, object>)getValue(networksByCurrency, currencyCode))[(string)currencyId] = true;
            }
        }
        if (!isTrue((((Dictionary<string,object>)currencies).ContainsKey(toStringOrNull(code)))))
        {
            object codes = new List<string>(((Dictionary<string,object>)currencies).Keys);
            throw new ExchangeError ((string)add(add(add(add(this.id, " fetchDepositAddress() "), code), " not supported. Currency code must be one of "), String.Join(", ", codes))) ;
        }
        ...
        } else
        {
            ...
            if (!isTrue((((Dictionary<string,object>)supportedNetworks).ContainsKey(toStringOrNull(network)))))
            {
                object supportedNetworkKeys = new List<string>(((Dictionary<string,object>)supportedNetworks).Keys);
                throw new ExchangeError ((string)add(add(add(add(add(add(this.id, " "), network), " network "), code), " deposit address not supported. Network must be one of "), String.Join(", ", supportedNetworkKeys))) ;
            }
        ...
        object unifiedNetwork = this.safeString(reverseNetworks, networkId, networkId);
    ...
    public async virtual Task<object> getMatcherPublicKey()
    {
        ...
        } else
        {
            ...
            ((Dictionary<string, object>)this.options)["matcherPublicKey"] = ((string)response).Substring((int)1, (int)subtract(getArrayLength(response), 1));
    ...
    public virtual object customPriceToPrecision(object symbol, object price)
    {
        ...
        object wavesPrecision = this.safeInteger(this.options, "wavesPrecision", 8);
        object difference = subtract(getValue(getValue(market, "precision"), "amount"), getValue(getValue(market, "precision"), "price"));
        return this.parseToInt(parseFloat(this.toPrecision(price, subtract(wavesPrecision, difference))));
    }

    public virtual object customAmountToPrecision(object symbol, object amount)
    {
        return this.parseToInt(parseFloat(this.toPrecision(amount, getValue(getValue(getValue(this.markets, symbol), "precision"), "amount"))));
    }

    public override object currencyToPrecision(object code, object amount, object networkCode = null)
    {
        return this.parseToInt(parseFloat(this.toPrecision(amount, getValue(getValue(this.currencies, code), "precision"))));
    }
    ...
    public virtual object safeGetDynamic(object settings)
    {
        ...
        if (isTrue(((Dictionary<string,object>)orderFee).ContainsKey(toStringOrNull("dynamic"))))
        {
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        object orderType = ((bool) isTrue((isEqual(side, "buy")))) ? 0 : 1;
        object timestamp = this.milliseconds();
        ...
        //     }
        //  }
        object bs = this.safeValue(matcherFees, "base");
        ...
        if (isTrue(isTrue((((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("feeAsset")))) || isTrue((((Dictionary<string,object>)this.options).ContainsKey(toStringOrNull("feeAsset"))))))
        {
        ...
        if (isTrue(!isEqual(matcherFeeAssetId, null)))
        {
            ...
            if (isTrue(isTrue((((Dictionary<string,object>)balances).ContainsKey(toStringOrNull(matcherFeeAsset)))) && isTrue((isGreaterThanOrEqual(getValue(getValue(balances, matcherFeeAsset), "free"), floatMatcherFee)))))
            {
        ...
        if (isTrue(isEqual(matcherFeeAssetId, null)))
        {
            ...
            if (isTrue(isTrue((((Dictionary<string,object>)balances).ContainsKey(toStringOrNull(baseFeeAsset)))) && isTrue((isGreaterThanOrEqual(getValue(getValue(balances, baseFeeAsset), "free"), floatBaseMatcherFee)))))
            {
            ...
            } else
            {
                ...
                if (isTrue(isTrue((((Dictionary<string,object>)balances).ContainsKey(toStringOrNull(discountFeeAsset)))) && isTrue((isGreaterThanOrEqual(getValue(getValue(balances, discountFeeAsset), "free"), floatDiscountMatcherFee)))))
                {
        ...
        amount = this.customAmountToPrecision(symbol, amount);
        price = this.customPriceToPrecision(symbol, price);
        object byteArray = new List<object> {this.numberToBE(3, 1), this.base58ToBinary(this.apiKey), this.base58ToBinary(matcherPublicKey), this.getAssetBytes(getValue(market, "baseId")), this.getAssetBytes(getValue(market, "quoteId")), this.numberToBE(orderType, 1), this.numberToBE(price, 8), this.numberToBE(amount, 8), this.numberToBE(timestamp, 8), this.numberToBE(expiration, 8), this.numberToBE(matcherFee, 8), this.getAssetBytes(matcherFeeAssetId)};
        object binary = this.binaryConcatArray(byteArray);
        object signature = eddsa(this.binaryToBase16(binary), this.binaryToBase16(this.base58ToBinary(this.secret)), ed25519);
        ...
        {
            ((Dictionary<string, object>)body)["matcherFeeAssetId"] = matcherFeeAssetId;
        }
        //
        //     {
        //         "success":true,
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        object signature = eddsa(this.binaryToBase16(binary), hexSecret, ed25519);
        object request = new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchOrders(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(symbol, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchOrders() requires symbol argument")) ;
        }
        await this.loadMarkets();
        object market = this.market(symbol);
        object timestamp = this.milliseconds();
    ...
    public async virtual Task<object> getWavesAddress()
    {
        ...
        if (isTrue(isEqual(cachedAddreess, null)))
        {
            ...
            ((Dictionary<string, object>)this.options)["wavesAddress"] = this.safeString(response, "address");
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(balances)); postFixIncrement(ref i))
        {
            ...
            {
                ((List<object>)assetIds).Add(currencyId);
                ((List<object>)nonStandardBalances).Add(balance);
            ...
            if (isTrue(((Dictionary<string,object>)this.currencies_by_id).ContainsKey(toStringOrNull(currencyId))))
            {
                ...
                ((Dictionary<string, object>)result)[(string)code] = this.account();
                ((Dictionary<string, object>)getValue(result, code))["total"] = this.fromPrecision(balance, decimals);
            }
        }
        ...
        // { WAVES: 200300000 }
        object reservedKeys = new List<string>(((Dictionary<string,object>)reservedBalance).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(reservedKeys)); postFixIncrement(ref i))
        {
            ...
            {
                ((Dictionary<string, object>)getValue(result, code))["used"] = this.currencyFromPrecision(code, amount);
            } else
            {
                ((Dictionary<string, object>)getValue(result, code))["used"] = amount;
            }
        }
        ...
        //   "balance": 909085978
        // }
        ((Dictionary<string, object>)result)["WAVES"] = this.safeValue(result, "WAVES", new Dictionary<string, object>() {});
        ((Dictionary<string, object>)getValue(result, "WAVES"))["total"] = this.currencyFromPrecision("WAVES", this.safeString(wavesTotal, "balance"));
        object codes = new List<string>(((Dictionary<string,object>)result).Keys);
        for (object i = 0; isLessThan(i, getArrayLength(codes)); postFixIncrement(ref i))
        {
            object code = getValue(codes, i);
            if (isTrue(isEqual(this.safeValue(getValue(result, code), "used"), null)))
            {
                ((Dictionary<string, object>)getValue(result, code))["used"] = "0";
            }
        }
    ...
    public async override Task<object> fetchMyTrades(object symbol = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            market = this.market(symbol);
            ((Dictionary<string, object>)request)["amountAsset"] = getValue(market, "baseId");
            ((Dictionary<string, object>)request)["priceAsset"] = getValue(market, "quoteId");
        }
    ...
    public override object handleErrors(object code, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        if (isTrue(!isEqual(Exception, null)))
        {
            ...
            throwDynamicException((string)Exception, add(add(this.id, " "), messageInner));return null;
        }
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(hexChars)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)set)[(string)key] = true;
        }
        object isErc20 = true;
