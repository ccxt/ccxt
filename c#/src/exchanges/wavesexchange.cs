...
partial class wavesexchange : Exchange
{
    ...
    public async override Task<object> fetchDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        {
            object codes = new List<object>(((Dictionary<string,object>)currencies).Keys);
            throw new ExchangeError ((string)add(add(add(add(this.id, " fetchDepositAddress() "), code), " not supported. Currency code must be one of "), String.Join(", ", ((List<object>)codes).ToArray()))) ;
        }
        ...
        } else
        {
            ...
            {
                object supportedNetworkKeys = new List<object>(((Dictionary<string,object>)supportedNetworks).Keys);
                throw new ExchangeError ((string)add(add(add(add(add(add(this.id, " "), network), " network "), code), " deposit address not supported. Network must be one of "), String.Join(", ", ((List<object>)supportedNetworkKeys).ToArray()))) ;
            }
    ...
    public async override Task<object> fetchBalance(object parameters = null)
    {
        ...
        */
        ...
        // { WAVES: 200300000 }
        object reservedKeys = new List<object>(((Dictionary<string,object>)reservedBalance).Keys);
        ...
        object codes = new List<object>(((Dictionary<string,object>)result).Keys);
