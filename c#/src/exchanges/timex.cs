...
partial class timex : Exchange
{
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        {
            ((List<object>)result).Add(this.parseMarket(getValue(response, i)));
        }
        return result;
    }
    ...
    public async override Task<object> fetchCurrencies(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            ((List<object>)result).Add(this.parseCurrency(currency));
        }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["size"] = limit; // default is 100
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["from"] = this.iso8601(since);
            ((Dictionary<string, object>)request)["till"] = this.iso8601(this.sum(since, multiply(multiply(this.sum(limit, 1), duration), 1000)));
        } else
        {
            object now = this.milliseconds();
            ((Dictionary<string, object>)request)["till"] = this.iso8601(now);
            ((Dictionary<string, object>)request)["from"] = this.iso8601(subtract(subtract(now, multiply(multiply(limit, duration), 1000)), 1));
        }
    ...
    public virtual object parseBalance(object response)
    {
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)account)["used"] = this.safeString(balance, "lockedBalance");
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isTrue((isEqual(uppercaseType, "LIMIT"))) || isTrue((isEqual(uppercaseType, "POST_ONLY")))))
        {
            ...
            {
                ((Dictionary<string, object>)request)["expireTime"] = expireTime;
            } else if (isTrue(!isEqual(expireIn, null)))
            {
                ((Dictionary<string, object>)request)["expireIn"] = expireIn;
            } else
            {
        ...
        {
            ((Dictionary<string, object>)request)["price"] = 0;
        }
    ...
    public async override Task<object> editOrder(object id, object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        //     }
        //
        if (isTrue(((Dictionary<string,object>)response).ContainsKey(toStringOrNull("unchangedOrders"))))
        {
    ...
    public virtual object parseMarket(object market)
    {
        ...
        object minCost = this.safeString(market, "quoteMinSize");
        return new Dictionary<string, object>() {
            { "id", id },
    ...
    public virtual object parseCurrency(object currency)
    {
        ...
        if (isTrue(isTrue((!isEqual(feeString, null))) && isTrue((!isEqual(tradeDecimals, null)))))
        {
            ...
            {
                object whole = ((string)feeString).Substring((int)0, (int)dotIndex);
                object fraction = ((string)feeString).Substring((int)prefixUnaryNeg(ref dotIndex));
