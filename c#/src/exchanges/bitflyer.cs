...
partial class bitflyer : Exchange
{
    ...
    {
        object day = ((string)expiry).Substring((int)0, (int)2);
        object monthName = ((string)expiry).Substring((int)2, (int)5);
        object year = ((string)expiry).Substring((int)5, (int)9);
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(markets)); postFixIncrement(ref i))
        {
            ...
            object currencies = ((string)id).Split((string)"_").ToList<object>();
            ...
            } else if (isTrue(future))
            {
                ...
                if (isTrue(isEqual(alias, null)))
                {
                    ...
                    object expiryDate = ((string)id).Substring((int)-9);
                    expiry = this.parseExpiryDate(expiryDate);
                } else
                {
                    object splitAlias = ((string)alias).Split((string)"_").ToList<object>();
                    object currencyIds = this.safeString(splitAlias, 0);
                    baseId = ((string)currencyIds).Substring((int)0, (int)-3);
                    quoteId = ((string)currencyIds).Substring((int)-3);
                    object splitId = ((string)id).Split((string)currencyIds).ToList<object>();
    ...
    public override object parseTrade(object trade, object market = null)
    {
        ...
        if (isTrue(!isEqual(side, null)))
        {
            ...
            if (isTrue(((Dictionary<string,object>)trade).ContainsKey(toStringOrNull(idInner))))
            {
    ...
    public async override Task<object> fetchOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(((Dictionary<string,object>)ordersById).ContainsKey(toStringOrNull(id))))
        {
    ...
    public async override Task<object> fetchDeposits(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["count"] = limit; // default 100
        }
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        if (isTrue(((Dictionary<string,object>)transaction).ContainsKey(toStringOrNull("fee"))))
        {
            ...
            object additionalFee = this.safeNumber(transaction, "additional_fee");
            fee = new Dictionary<string, object>() {
                { "currency", code },
                { "cost", add(feeCost, additionalFee) },
            };
        } else
        {
            type = "deposit";
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            object auth = String.Join("", new List<object>() {nonce, method, request});
            if (isTrue(getArrayLength(new List<string>(((Dictionary<string,object>)parameters).Keys))))
            {
                if (isTrue(!isEqual(method, "GET")))
                {
