...
partial class coinbasepro : Exchange
{
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        ((Dictionary<string, object>)orderbook)["nonce"] = this.safeInteger(response, "sequence");
        return orderbook;
    }
    ...
    public override object parseTicker(object ticker, object market = null)
    {
        ...
        if (isTrue((ticker.GetType().IsGenericType && ticker.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
    ...
    public async override Task<object> fetchTickers(object symbols = null, object parameters = null)
    {
        ...
        */
        ...
        for (object i = 0; isLessThan(i, getArrayLength(marketIds)); postFixIncrement(ref i))
        {
            ...
            ((Dictionary<string, object>)result)[(string)symbol] = this.parseTicker(first, market);
        }
    ...
    public async override Task<object> fetchOHLCV(object symbol, object timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        {
            ((Dictionary<string, object>)request)["granularity"] = parsedTimeframe;
        } else
        {
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ...
            ((Dictionary<string, object>)request)["end"] = this.iso8601(this.sum(multiply(multiply((subtract(limit, 1)), parsedTimeframe), 1000), since));
        }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        */
        ...
        parameters = this.omit(parameters, new List<object>() {"timeInForce", "time_in_force", "stopPrice", "stop_price", "clientOrderId", "client_oid", "postOnly", "post_only"});
        ...
        } else if (isTrue(isEqual(type, "market")))
        {
            ...
            if (isTrue(!isEqual(cost, null)))
            {
                ((Dictionary<string, object>)request)["funds"] = this.costToPrecision(symbol, cost);
            } else
            {
                ((Dictionary<string, object>)request)["size"] = this.amountToPrecision(symbol, amount);
            }
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        */
        ...
        {
            market = this.market(symbol);
            ((Dictionary<string, object>)request)["product_id"] = getValue(market, "symbol"); // the request will be more performant if you include it
        }
    ...
    public async virtual Task<object> deposit(object code, object amount, object address, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        object method = "privatePostDeposits";
        if (isTrue(((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("payment_method_id"))))
        {
            // deposit from a payment_method, like a bank account
            method = add(method, "PaymentMethod");
        } else if (isTrue(((Dictionary<string,object>)parameters).ContainsKey(toStringOrNull("coinbase_account_id"))))
        {
            // deposit into Coinbase Pro account from a Coinbase account
            method = add(method, "CoinbaseAccount");
        } else
        {
            throw new NotSupported ((string)add(this.id, " deposit() requires one of `coinbase_account_id` or `payment_method_id` extra params")) ;
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        if (!isTrue(response))
        {
            throw new ExchangeError ((string)add(add(this.id, " deposit() error: "), this.json(response))) ;
        }
        return new Dictionary<string, object>() {
            { "info", response },
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        */
        ...
        } else
        {
            ...
            ((Dictionary<string, object>)request)["crypto_address"] = address;
            if (isTrue(!isEqual(tag, null)))
            {
                ((Dictionary<string, object>)request)["destination_tag"] = tag;
            }
        }
        object response = await this.callAsync(method, this.extend(request, parameters));
        if (!isTrue(response))
    ...
    public async virtual Task<object> fetchLedger(object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(!isEqual(since, null)))
        {
            ((Dictionary<string, object>)request)["start_date"] = this.iso8601(since);
        }
        if (isTrue(!isEqual(limit, null)))
        {
            ((Dictionary<string, object>)request)["limit"] = limit; // default 100
        ...
        for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ((Dictionary<string, object>)getValue(response, i))["currency"] = code;
        }
        ...
        */
        ...
        if (isTrue(isEqual(id, null)))
        {
            if (isTrue(!isEqual(code, null)))
            {
                ...
                if (isTrue(isEqual(account, null)))
                {
                    throw new ExchangeError ((string)add(add(this.id, " fetchTransactions() could not find account id for "), code)) ;
                }
                id = getValue(account, "id");
            }
        }
        ...
        if (isTrue(isEqual(id, null)))
        {
            ...
            for (object i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
            {
                ...
                ((Dictionary<string, object>)getValue(response, i))["currency"] = codeInner;
            }
        } else
        {
    ...
    public async override Task<object> createDepositAddress(object code, object parameters = null)
    {
        ...
        */
        ...
        if (isTrue(isEqual(accounts, null)))
        {
            ...
            ((Dictionary<string, object>)this.options)["coinbaseAccounts"] = accounts; // cache it
            ((Dictionary<string, object>)this.options)["coinbaseAccountsByCurrencyId"] = this.indexBy(accounts, "currency");
        }
