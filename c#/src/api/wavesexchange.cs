...
public partial class wavesexchange : Exchange
{
    ...
    public async Task<object> matcherGetMatcherOrderbookAmountAssetPriceAsset(object parameters = null)
    {
        return await this.callAsync("matcherGetMatcherOrderbookAmountAssetPriceAsset", parameters);
    }
    ...
    public async Task<object> matcherGetMatcherOrderbookBaseIdQuoteIdTradeableBalanceAddress(object parameters = null)
    {
        return await this.callAsync("matcherGetMatcherOrderbookBaseIdQuoteIdTradeableBalanceAddress", parameters);
    }
    ...
    public async Task<object> matcherPostMatcherOrderbookAmountAssetPriceAssetCalculateFee(object parameters = null)
    {
        return await this.callAsync("matcherPostMatcherOrderbookAmountAssetPriceAssetCalculateFee", parameters);
    }
