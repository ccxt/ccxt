...
public partial class coinex : Exchange
{
    ...
    public async Task<object> perpetualPublicGetMarketUserDeals(object parameters = null)
    {
        return await this.callAsync("perpetualPublicGetMarketUserDeals", parameters);
    }
