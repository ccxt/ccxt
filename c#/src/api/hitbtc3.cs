...
public partial class hitbtc3 : Exchange
{
    ...
    public async Task<object> privateGetWalletCryptoCheckOffchainAvailable(object parameters = null)
    {
        return await this.callAsync("privateGetWalletCryptoCheckOffchainAvailable", parameters);
    }
    ...
    public async Task<object> privateDeleteFuturesPositionIsolatedSymbol(object parameters = null)
    {
        return await this.callAsync("privateDeleteFuturesPositionIsolatedSymbol", parameters);
    }
