...
public class CryptoTests : BaseTest
{
    ...
    public void TestCrypto()
    {
        ...
        // ---------------------------------------------------------------------------------------------------------------------
        Assert.True(isEqual(hash(encode(""), sha256, "hex"), "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
        Assert.True(isEqual(hash(encode("cheese"), sha256, "hex"), "873ac9ffea4dd04fa719e8920cd6938f0c23cd678af330939cff53c3d2855f34"));
        Assert.True(isEqual(hash(encode(""), md5, "hex"), "d41d8cd98f00b204e9800998ecf8427e"));
        Assert.True(isEqual(hash(encode("sexyfish"), md5, "hex"), "c8a35464aa9d5683585786f44d5889f8"));
        Assert.True(isEqual(hash(encode(""), sha1, "hex"), "da39a3ee5e6b4b0d3255bfef95601890afd80709"));
        Assert.True(isEqual(hash(encode("nutella"), sha1, "hex"), "b3d60a34b744159793c483b067c56d8affc5111a"));
        Assert.True(isEqual(hmac(encode("hello"), encode("there"), sha256, "hex"), "551e1c1ecbce0fe9b643745a376584a6289f5f43a46861b315fac9edc8d52a26"));
        Assert.True(isEqual(hmac(encode("a message"), encode("a secret"), md5, "hex"), "0bfa503bdbc7358185fcd49b4869e23d"));
        // ---------------------------------------------------------------------------------------------------------------------
        object privateKey = "1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a";
        Assert.True(equals(ecdsa("1a", privateKey, secp256k1, sha256), new Dictionary<string, object>() {
        ...
        Assert.True(equals(ecdsa(privateKey, privateKey, secp256k1, null), new Dictionary<string, object>() {
        ...
        // ---------------------------------------------------------------------------------------------------------------------
        //
        // Assert.True (exchange.hashMessage (privateKey) === '0x59ea5d98c3500c3729f95cf98aa91663f498518cc401360df2912742c232207f');
        //
        // Assert.True (equals (exchange.signHash ('0x59ea5d98c3500c3729f95cf98aa91663f498518cc401360df2912742c232207f', privateKey), {
        ...
        // }));
        //
        // Assert.True (equals (exchange.signMessage (privateKey, privateKey), {
        //     'r': '0x6f684aa41c02da83dac3039d8805ddbe79a03b1297e247c7742cab8dfc19d341',
        //     's': '0x62473881674550563cb028ff40a7846fd53620ddf40a20cc1003b8484a109a4a',
        //     'v': 27
        // }));
