...
async function main() {
    ...
    const active = markets.filter((m) => m['active'] && (m['outcomes'] || []).length >= 1);
    if (active.length === 0) {
    ...
    try {
        ...
        console.log('orderbook: n/a (' + e.constructor.name + ')');
    }
    ...
    try {
        ...
        console.log('orders:      n/a (' + e.constructor.name + ')');
    }
    try {
        ...
        console.log('myTrades:    n/a (' + e.constructor.name + ')');
    }
    try {
        ...
        console.log('settlements: n/a (' + e.constructor.name + ')');
    }
}
main();
