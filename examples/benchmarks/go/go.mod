// Standalone module so the benchmark lives under examples/ without being part
// of the published go/ module. It builds against the checkout in ../../../go.
module ccxtbench

go 1.25.0

require github.com/ccxt/ccxt/go/v4 v4.5.75
...
replace github.com/ccxt/ccxt/go => ../../../go
