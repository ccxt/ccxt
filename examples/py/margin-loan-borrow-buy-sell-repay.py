...
def example():
    ...
    'type': 'spot',
            ...
            if balance_spot[collateral_coin]['free'] < needed_collateral_amount:
                ...
                exchange.transfer(collateral_coin, needed_collateral_amount, 'spot', margin_mode, {
    'symbol': symbol,
    ...
    order = exchange.create_order(symbol, order_type, order_side, amount_to_trade, limit_price, {
    'marginMode': margin_mode,
})
    ...
    'marginMode': margin_mode,
        ...
        repay_result = exchange.repay_margin(borrow_coin, amount_to_repay_back, symbol, {
    'marginMode': margin_mode,
})
        print('finished.')
