...
export type TSStatement = TSClassDeclaration | TSInterfaceDeclaration | TSTypeDeclaration | TSFunctionDeclaration | TSVariableDeclaration | TSExportStatement | TSReturnStatement | TSIfStatement | TSSwitchStatement | TSForStatement | TSForOfStatement | TSForInStatement | TSWhileStatement | TSTryStatement | TSThrowStatement | TSBlockStatement | TSExpressionStatement | TSBreakStatement | TSContinueStatement;
...
export type TSClassMember = TSPropertyDeclaration | TSMethodDeclaration | TSConstructor | TSGetter | TSSetter;
...
export type TSType = TSPrimitiveType | TSArrayType | TSObjectType | TSUnionType | TSIntersectionType | TSGenericType | TSFunctionType | TSTupleType | TSLiteralType | TSKeyofType | TSTypeReference;
...
export type TSExpression = TSLiteral | TSIdentifier | TSBinaryExpression | TSUnaryExpression | TSCallExpression | TSMemberExpression | TSObjectExpression | TSArrayExpression | TSArrowFunction | TSConditionalExpression | TSAwaitExpression | TSNewExpression | TSTemplateLiteral | TSAsExpression | TSAssignmentExpression | TSSpreadElement | TSThisExpression | TSParenExpression;
...
export type TSBodyStatement = TSReturnStatement | TSIfStatement | TSSwitchStatement | TSForStatement | TSForOfStatement | TSForInStatement | TSWhileStatement | TSTryStatement | TSThrowStatement | TSBlockStatement | TSExpressionStatement | TSVariableDeclaration | TSBreakStatement | TSContinueStatement;
