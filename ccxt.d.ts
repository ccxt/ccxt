declare module 'ccxt' {
    ...
    export class Exchange {
        ...
        fetchOrderBook (market: string, limit: number = undefined, params?: any): Promise<OrderBook>;
        fetchTicker (market: string): Promise<Ticker>;
        fetchTickers (): Promise<Tickers>;
        fetchTrades (symbol: string, since: number = undefined, limit: number = undefined, params?: {}): Promise<Trade[]>;
        fetchOHLCV? (symbol: string, timeframe: string, since: number = undefined, limit: number = undefined, params: any = {}): Promise<OHLCV[]>;
        fetchOrders (symbol?: string, since: number = undefined, limit: number = undefined, params?: {}): Promise<Order[]>;
        fetchOpenOrders (symbol?: string, since: number = undefined, limit: number = undefined, params?: {}): Promise<Order[]>;
