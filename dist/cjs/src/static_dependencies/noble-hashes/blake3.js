...
var _blake2 = require('./_blake2.js');
...
class BLAKE3 extends _blake2.BLAKE2 {
    constructor(opts = {}, flags = 0) {
        ...
        this.bufferOut = utils.u8(this.bufferOut32);
    }
    // Unused
    get() {
        return [];
    ...
    b2Compress(counter, flags, buf, bufPos = 0) {
        ...
        const { h, l } = _u64["default"].fromBig(BigInt(counter), true);
        // prettier-ignore
        const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = blake2s.compress(SIGMA, bufPos, buf, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], blake2s.IV[0], blake2s.IV[1], blake2s.IV[2], blake2s.IV[3], h, l, pos, flags);
        s[0] = v0 ^ v8;
        s[1] = v1 ^ v9;
        s[2] = v2 ^ v10;
        s[3] = v3 ^ v11;
    ...
    b2CompressOut() {
        ...
        const { h, l } = _u64["default"].fromBig(BigInt(this.chunkOut++));
        // prettier-ignore
        const { v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12, v13, v14, v15 } = blake2s.compress(SIGMA, 0, buffer32, 7, s[0], s[1], s[2], s[3], s[4], s[5], s[6], s[7], blake2s.IV[0], blake2s.IV[1], blake2s.IV[2], blake2s.IV[3], l, h, pos, flags);
        out32[0] = v0 ^ v8;
        out32[1] = v1 ^ v9;
        out32[2] = v2 ^ v10;
        out32[3] = v3 ^ v11;
 ...
 */
const blake3 = utils.wrapConstructorWithOpts((opts) => new BLAKE3(opts));
