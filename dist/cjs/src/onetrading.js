...
class onetrading extends onetrading$1["default"] {
    ...
    async fetchPrivateTradingFees(params = {}) {
        ...
        spotMakerFee = Precise["default"].stringDiv(spotMakerFee, '100');
        spotTakerFee = Precise["default"].stringDiv(spotTakerFee, '100');
        ...
        futuresMakerFee = Precise["default"].stringDiv(futuresMakerFee, '100');
