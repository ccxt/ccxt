...
var astralx$1 = require('./abstract/astralx.js');
 ...
 * @augments Exchange
 */
class astralx extends astralx$1["default"] {
    describe() {
    ...
    async fetchBalance(params = {}) {
        ...
        for (let i = 0; i < currencyIds.length; i++) {
            ...
            let used = Precise["default"].stringAdd(orderMargin, positionMargin);
            // 如果used为0，则强制计算used = total - free
            if (Precise["default"].stringEquals(used, '0')) {
                used = Precise["default"].stringSub(total, availableMargin);
            }
            account['used'] = used;
            account['total'] = total;
            result[code] = account;
    ...
    sign(path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'private') {
            ...
            const signature = this.hmac(this.encode(this.urlencode(query)), this.encode(this.secret), sha256.sha256);
