...
var zebpayspot$1 = require('./abstract/zebpayspot.js');
 ...
 * @augments Exchange
 */
class zebpayspot extends zebpayspot$1 {
    describe() {
    ...
    async fetchTradingFee(symbol, params = {}) {
        ...
        return {
            ...
            'percentage': this.safeBool(first, 'percentage'),
            'tierBased': undefined,
        };
    }
    /**
    ...
    sign(path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'public') {
            ...
            if (method === 'GET' || method === 'DELETE') {
                ...
                signature = this.hmac(queryString, this.secret, sha256.sha256, 'hex');
                url += '?' + queryString;
            }
            else {
                ...
                signature = this.hmac(body, this.secret, sha256.sha256, 'hex');
            }
            headers = {
