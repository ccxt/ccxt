 ...
 */
class PredictionExchange extends Exchange["default"] {
    constructor() {
        super(...arguments);
    ...
    requireEventQuery(params = {}) {
        ...
        if ((query === undefined) && (queries.length === 0) && (tags.length === 0) && (eventId === undefined) && (slug === undefined)) {
            throw new errors.ArgumentsRequired(this.id + ' fetchEvents() requires at least one of query, queries, tags, eventId or slug to scope the search');
        }
        return undefined;
    }
    ...
    outcome(outcomeSymbol) {
        ...
        throw new errors.BadSymbol(this.id + ' does not have outcome symbol ' + outcomeSymbol);
    }
    ...
    slugToMarketId(eventSlug, marketSlug, outcome) {
