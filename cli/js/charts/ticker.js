...
async function plotTicker(exchangeNames, symbol, args) {
    spinner.start();
...
async function renderTicker(screen, exchange, symbol, box, name) {
    try {
        while (true) {
            ...
            const { last, percentage, change, open, high, low, baseVolume, quoteVolume, bid, ask, vwap, average, previousClose, indexPrice, markPrice, bidVolume, askVolume, datetime, } = ticker;
