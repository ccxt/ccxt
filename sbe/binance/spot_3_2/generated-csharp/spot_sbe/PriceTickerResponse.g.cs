...
namespace Spot_sbe
{
    public sealed partial class PriceTickerResponse
    {
        public const ushort BlockLength = (ushort)0;
        public const ushort TemplateId = (ushort)210;
        ...
        private readonly PriceTickerResponse _parentMessage;
        ...
        public PriceTickerResponse WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public PriceTickerResponse WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public PriceTickerResponse WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public PriceTickerResponse WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public sealed partial class TickersGroup
        {
            ...
            private PriceTickerResponse _parentMessage;
            private DirectBuffer _buffer;
            ...
            public void WrapForDecode(PriceTickerResponse parentMessage, DirectBuffer buffer, int actingVersion)
            {
            ...
            public void WrapForEncode(PriceTickerResponse parentMessage, DirectBuffer buffer, int count)
            {
            ...
            public const int SbeBlockLength = 9;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append(PriceTickerResponse.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(PriceTickerResponse.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != PriceTickerResponse.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(PriceTickerResponse.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != PriceTickerResponse.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(PriceTickerResponse.BlockLength);
            builder.Append("):");
