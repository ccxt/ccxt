...
namespace Spot_sbe
{
    public sealed partial class TickerSymbolMiniResponse
    {
        public const ushort BlockLength = (ushort)106;
        public const ushort TemplateId = (ushort)215;
        ...
        private readonly TickerSymbolMiniResponse _parentMessage;
        ...
        public TickerSymbolMiniResponse()
        {
            _parentMessage = this;
        }

        public TickerSymbolMiniResponse WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public TickerSymbolMiniResponse WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public TickerSymbolMiniResponse WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public TickerSymbolMiniResponse WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public override string ToString()
        {
            ...
            var m = new TickerSymbolMiniResponse();
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[TickerSymbolMiniResponse](sbeTemplateId=");
            builder.Append(TickerSymbolMiniResponse.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(TickerSymbolMiniResponse.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != TickerSymbolMiniResponse.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(TickerSymbolMiniResponse.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != TickerSymbolMiniResponse.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(TickerSymbolMiniResponse.BlockLength);
            builder.Append("):");
