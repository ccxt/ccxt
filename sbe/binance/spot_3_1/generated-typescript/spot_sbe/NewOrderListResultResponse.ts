...
export class NewOrderListResultResponseDecoder {
  ...
  private static readonly TEMPLATE_ID = 310;
  ...
  decode(buffer: ArrayBuffer, offset: number = 0): NewOrderListResultResponse {
    ...
    pos = offset + NewOrderListResultResponseDecoder.BLOCK_LENGTH;
  ...
  static getBlockLength(): number {
    return NewOrderListResultResponseDecoder.BLOCK_LENGTH;
  }

  static getTemplateId(): number {
    return NewOrderListResultResponseDecoder.TEMPLATE_ID;
  }

  static getSchemaId(): number {
    return NewOrderListResultResponseDecoder.SCHEMA_ID;
  }

  static getSchemaVersion(): number {
    return NewOrderListResultResponseDecoder.SCHEMA_VERSION;
  }
}
