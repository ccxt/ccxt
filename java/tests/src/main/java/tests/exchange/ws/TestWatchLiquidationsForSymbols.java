...
public class TestWatchLiquidationsForSymbols extends BaseTest {
    public java.util.concurrent.CompletableFuture<Object> testWatchLiquidationsForSymbols(Exchange exchange, Object skippedProperties, Object symbol)
    {
        ...
        while (Helpers.isLessThan(now, ends))
        {
            try
            {
                response = ((java.util.concurrent.CompletableFuture<Object>)Helpers.callDynamically(exchange, "watchLiquidationsForSymbols", new Object[]{new java.util.ArrayList<Object>(java.util.Arrays.asList(symbol))})).join();
