...
public class TestWatchPositions extends BaseTest {
    public CompletableFuture<Object> testWatchPositions(Exchange exchange, Object skippedProperties, Object symbol)
    {
        ...
        while (Helpers.isLessThan(now, ends))
        {
            ...
            {
                Assert(Helpers.isArray(positionsForSymbols), ((((exchange.id + " ") + method) + " must return an array, returned ") + exchange.json(positionsForSymbols)));
