...
public class TestWatchBidsAsks extends BaseTest {
    ...
    public CompletableFuture<Object> testWatchBidsAsksHelper(Exchange exchange, Object skippedProperties, Object argSymbols2, Object... optionalArgs)
    {
        ...
        while ((Helpers.isLessThan(now, ends)) && !Boolean.TRUE.equals(idle))
        {
            ...
            try
            {
                response = ((CompletableFuture<Object>)Helpers.callDynamically(exchange, "watchBidsAsks", new Object[]{Helpers.toStringListArg(argSymbols), Helpers.toMapArg(argParams)})).join();
            } catch(Exception e)
            {
