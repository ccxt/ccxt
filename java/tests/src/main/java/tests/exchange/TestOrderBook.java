...
public class TestOrderBook extends BaseTest {
    public static void testOrderBook(BaseExchange exchange, Object skippedProperties, Object method, Object orderbook, Object symbol)
    {
        ...
        Map<String, Object> format = new HashMap<String, Object>() {{
            put( "symbol", "ETH/BTC" );
            put( "asks", new ArrayList<Object>(Arrays.asList(new ArrayList<Object>(Arrays.asList(exchange.parseNumber("1.24"), exchange.parseNumber("0.453"))), new ArrayList<Object>(Arrays.asList(exchange.parseNumber("1.25"), exchange.parseNumber("0.157"))))) );
            put( "bids", new ArrayList<Object>(Arrays.asList(new ArrayList<Object>(Arrays.asList(exchange.parseNumber("1.23"), exchange.parseNumber("0.123"))), new ArrayList<Object>(Arrays.asList(exchange.parseNumber("1.22"), exchange.parseNumber("0.543"))))) );
