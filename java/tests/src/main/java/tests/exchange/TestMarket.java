...
public class TestMarket extends BaseTest {
    public static void testMarket(BaseExchange exchange, Object skippedProperties, Object method, Object market)
    {
        ...
        // check precisions
        Object precisionKeys = Helpers.objectKeys(((Map<String, Object>)market).get("precision"));
        ...
        // check limits
        Object limitsKeys = Helpers.objectKeys(((Map<String, Object>)market).get("limits"));
