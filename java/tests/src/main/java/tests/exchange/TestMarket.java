...
public class TestMarket extends BaseTest {
    public static void testMarket(BaseExchange exchange, Object skippedProperties, Object method, Object market)
    {
        ...
        // check precisions
        List<Object> precisionKeys = Helpers.objectKeys(((Map<String, Object>)market).get("precision"));
        ...
        // check limits
        List<Object> limitsKeys = Helpers.objectKeys(((Map<String, Object>)market).get("limits"));
