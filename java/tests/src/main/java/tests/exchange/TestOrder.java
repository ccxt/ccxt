...
public class TestOrder extends BaseTest {
    public static void testOrder(BaseExchange exchange, Object skippedProperties, Object method, Object entry, Object symbol, Object now)
    {
        ...
        java.util.List<String> emptyAllowedFor = new java.util.ArrayList<String>(java.util.Arrays.asList("clientOrderId", "stopPrice", "trades", "timestamp", "datetime", "lastTradeTimestamp", "average", "type", "timeInForce", "postOnly", "side", "price", "amount", "cost", "filled", "remaining", "status", "fee")); // there are exchanges that return only order id, so we don't need to strictly requite all props to be set.
