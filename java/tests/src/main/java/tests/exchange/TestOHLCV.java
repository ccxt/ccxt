...
public class TestOHLCV extends BaseTest {
    ...
    {
        java.util.List<Object> format = new java.util.ArrayList<Object>(java.util.Arrays.asList(1638230400000L, exchange.parseNumber("0.123"), exchange.parseNumber("0.125"), exchange.parseNumber("0.121"), exchange.parseNumber("0.122"), exchange.parseNumber("123.456")));
