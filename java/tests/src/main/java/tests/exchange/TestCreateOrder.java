...
public class TestCreateOrder extends BaseTest {
    ...
    public Object tcoGetMinimumAmountForLimitPrice(BaseExchange exchange, Object market, Object price, Object... optionalArgs)
    {
        ...
        } else
        {
            ...
            {
                amountPrecision = Helpers.divide(1, Math.pow(Double.parseDouble(Helpers.toString(10)), Double.parseDouble(Helpers.toString(amountPrecision)))); // this converts DECIMAL_PRECISION into TICK_SIZE
            }
        }
