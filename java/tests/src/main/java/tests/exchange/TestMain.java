...
public class TestMain extends BaseTest
{
    ...
    public void checkIfSpecificTestIsChosen(Object methodArgv)
    {
        ...
        {
            java.util.List<String> testFileNames = (java.util.List<String>)(java.util.List) Helpers.objectKeys(this.testFiles);
            java.util.List<Object> possibleMethodNames = (java.util.List<Object>) Helpers.split(methodArgv, ","); // i.e. `test.ts binance fetchBalance,fetchDeposits`
    ...
    public java.util.concurrent.CompletableFuture<Object> importFiles(BaseExchange exchange)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<Object> properties = Helpers.objectKeys(exchange.has);
    ...
    public void loadCredentialsFromEnv(BaseExchange exchange)
    {
        ...
        java.util.List<String> objkeys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(reqCreds);
    ...
    public void expandSettings(BaseExchange exchange)
    {
        ...
        {
            java.util.List<String> settingKeys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(exchangeSettings);
    ...
    public java.util.concurrent.CompletableFuture<Object> testMethod(Object methodName2, BaseExchange exchange, Object args, Object isPublic)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Boolean isLoadMarkets = (Helpers.isEqual(methodName, "loadMarkets"));
            Boolean isFetchCurrencies = (Helpers.isEqual(methodName, "fetchCurrencies"));
            Boolean isProxyTest = (Helpers.isEqual(methodName, this.proxyTestFileName));
            Boolean isConstructorTest = (Helpers.isEqual(methodName, "afterConstruct"));
            Boolean isFeatureTest = (Helpers.isEqual(methodName, "features"));
            ...
            Boolean supportedByExchange = Helpers.isTrue(Helpers.isTrue((Helpers.inOp(exchange.has, methodName))) && Helpers.isTrue((!Helpers.isEqual(Helpers.GetValue(exchange.has, methodName), null)))) && Helpers.isTrue((!Helpers.isEqual(Helpers.GetValue(exchange.has, methodName), false)));
    ...
    public Object getSkips(BaseExchange exchange, Object methodName)
    {
        ...
        java.util.List<Object> methodNames = new java.util.ArrayList<Object>(java.util.Arrays.asList(methodName, Helpers.add(Helpers.add(methodName, "."), this.ext)));
        ...
        java.util.List<String> objectNames = (java.util.List<String>)(java.util.List) Helpers.objectKeys(objectSkips);
    ...
    public java.util.concurrent.CompletableFuture<Object> runTests(BaseExchange exchange, Object tests, Object isPublicTest)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<String> testNames = (java.util.List<String>)(java.util.List) Helpers.objectKeys(tests);
            ...
            {
                String errorsString = String.join((String)", ", (java.util.List<String>)failedMethods);
    ...
    public Object getValidSymbol(BaseExchange exchange, Object... optionalArgs)
    {
        ...
        java.util.List<String> codes = new java.util.ArrayList<String>(java.util.Arrays.asList("BTC", "ETH", "XRP", "LTC", "BNB", "DASH", "DOGE", "ETC", "TRX", "USDT", "USDC", "USD", "GUSD", "EUR", "TUSD", "CNY", "JPY", "BRL"));
        java.util.List<Object> spotSymbols = new java.util.ArrayList<Object>(java.util.Arrays.asList("BTC/USDT", "BTC/USDC", "BTC/USD", "BTC/CNY", "BTC/EUR", "BTC/AUD", "BTC/BRL", "BTC/JPY", "ETH/USDT", "ETH/USDC", "ETH/USD", "ETH/CNY", "ETH/EUR", "ETH/AUD", "ETH/BRL", "ETH/JPY", "EUR/USDT", "EUR/USD", "EUR/USDC", "USDT/EUR", "USD/EUR", "USDC/EUR", "BTC/ETH", "ETH/BTC"));
        java.util.List<Object> swapSymbols = new java.util.ArrayList<Object>(java.util.Arrays.asList("BTC/USDT:USDT", "BTC/USD:USDT", "BTC/USDC:USDC", "BTC/USD:USDC", "BTC/USD:USD", "ETH/USDT:USDT", "ETH/USD:USDT", "ETH/USDC:USDC", "ETH/USD:USDC", "ETH/USD:USD", "BTC/USD:BTC", "ETH/USD:ETH"));
        java.util.List<Object> targetSymbols = ((Helpers.isTrue(spot))) ? spotSymbols : swapSymbols;
        ...
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(codes)); i++)
            {
                ...
                java.util.List<String> symbolsArrayForCurrentCode = (java.util.List<String>)(java.util.List) Helpers.objectKeys(indexedMkts);
                Integer symbolsLength = Helpers.getArrayLength(symbolsArrayForCurrentCode);
        ...
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            ...
            java.util.List<Object> activeSymbols = new java.util.ArrayList<Object>(java.util.Arrays.asList());
        ...
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            java.util.List<Object> values = Helpers.objectValues(currentTypeMarkets);
            Integer valuesLength = Helpers.getArrayLength(values);
    ...
    public java.util.concurrent.CompletableFuture<Object> getMostActiveSymbols(BaseExchange exchange, Object defaultSymbols)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<String> tickerSymbols = (java.util.List<String>)(java.util.List) Helpers.objectKeys(tickers);
            ...
            java.util.List<Object> result = new java.util.ArrayList<Object>(java.util.Arrays.asList(exchange.safeString(Helpers.GetValue(ranked, 0), "symbol")));
    ...
    public java.util.concurrent.CompletableFuture<Object> testExchange(BaseExchange exchange, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Boolean hasSpot = Helpers.isTrue((!Helpers.isEqual(Helpers.GetValue(exchange.has, "spot"), null))) && Helpers.isTrue((!Helpers.isEqual(Helpers.GetValue(exchange.has, "spot"), false)));
            Boolean hasSwap = Helpers.isTrue((!Helpers.isEqual(Helpers.GetValue(exchange.has, "swap"), null))) && Helpers.isTrue((!Helpers.isEqual(Helpers.GetValue(exchange.has, "swap"), false)));
            ...
            } else
            {
                if (Helpers.isTrue(hasSpot))
                {
                    ...
                    {
                        String secondarySymbol = Helpers.replace((String)primarySymbol, (String)"BTC", (String)"ETH"); // this should work any exchange
                ...
                if (Helpers.isTrue(hasSwap))
                {
                    ...
                    if (Helpers.isTrue(!Helpers.isEqual(primarySymbol, null)))
                    {
                        String secondarySymbol = Helpers.replaceAll((String)primarySymbol, (String)"BTC", (String)"ETH"); // this should work any exchange
    ...
    public java.util.concurrent.CompletableFuture<Object> runPredictionTests(BaseExchange exchange)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(outcomeSymbol, null)))
            {
                ...
                java.util.List<String> pinnedKeys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(exchange.markets);
            ...
            if (!Helpers.isTrue(this.wsTests))
            {
                try
                {
                    ...
                    if (Helpers.isTrue(Helpers.isEqual(eventQuery, null)))
                    {
                        ...
                        String lowerPart = ((String)marketPart).toLowerCase();
                        String dedashed = Helpers.replaceAll((String)lowerPart, (String)"-", (String)" ");
                    ...
                    java.util.List<Object> scopesToTest = new java.util.ArrayList<Object>(java.util.Arrays.asList());
                    ...
                    Integer scopesToTestLength = Helpers.getArrayLength(scopesToTest);
    ...
    public Object AssertPredictionEvent(BaseExchange exchange, Object eventVar)
    {
        ...
        Assert(!Helpers.isEqual(markets, null), Helpers.add(Helpers.add(exchange.id, " event missing markets"), logText));
        Integer marketsLength = Helpers.getArrayLength(markets);
        Assert(Helpers.isEqual(exchange.safeString(eventVar, "symbol"), null), Helpers.add(Helpers.add(exchange.id, " event must not carry the deprecated symbol key"), logText));
        for (var i = 0; Helpers.isLessThan(i, marketsLength); i++)
        {
            ...
            Assert(!Helpers.isEqual(outcomes, null), Helpers.add(Helpers.add(exchange.id, " event market missing outcomes"), logText));
            Integer outcomesLength = Helpers.getArrayLength(outcomes);
            for (var j = 0; Helpers.isLessThan(j, outcomesLength); j++)
            {
                Assert(Helpers.isEqual(exchange.safeString(Helpers.GetValue(outcomes, j), "symbol"), null), Helpers.add(Helpers.add(exchange.id, " event outcome must not carry the deprecated symbol key"), logText));
            }
        }
        ...
        Assert(!Helpers.isEqual(info, null), Helpers.add(Helpers.add(exchange.id, " event missing info"), logText));
        return true;
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> testPredictionCreateCancelOrder(BaseExchange exchange, Object outcome)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Boolean canCancel = Helpers.isTrue((Helpers.isEqual(exchange.safeBool(exchange.has, "cancelOrder", false), true))) || Helpers.isTrue((Helpers.isEqual(exchange.safeBool(exchange.has, "cancelAllOrders", false), true)));
    ...
    public java.util.concurrent.CompletableFuture<Object> testReturnResponseHeaders(Exchange exchange)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<String> headersKeys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(headers);
            Assert(Helpers.isGreaterThan(Helpers.getArrayLength(headersKeys), 0), "Response headers should not be empty");
            java.util.List<Object> headerValues = Helpers.objectValues(headers);
    ...
    public Object loadStaticData(Object folder, Object... optionalArgs)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(files)); i++)
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(file, "prediction")))
            {
                continue;
            }
            String exchangeName = Helpers.replace((String)file, (String)".json", (String)"");
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(urlParts)); i++)
        {
            if (Helpers.isTrue(Helpers.isGreaterThan(i, 2)))
            {
                ...
                if (Helpers.isTrue(Helpers.isGreaterThan(Helpers.getIndexOf(current, "?"), Helpers.opNeg(1))))
                {
                    ...
                    java.util.List<Object> currentParts = (java.util.List<Object>) Helpers.split(current, "?");
                    res = Helpers.add(res, "/");
    ...
    {
        java.util.Map<String, Object> result = new java.util.HashMap<String, Object>() {{}};
        java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(url, "&");
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(parts)); i++)
        {
            String part = (String) Helpers.GetValue(parts, i);
            java.util.List<Object> keyValue = (java.util.List<Object>) Helpers.split(part, "=");
            Integer keysLength = Helpers.getArrayLength(keyValue);
    ...
    public Object countSignificantKeys(BaseExchange exchange, Object target, Object otherKeys)
    {
        ...
        java.util.List<String> keys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(target);
        Object count = 0;
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
        {
            Object key = Helpers.GetValue(keys, i);
    ...
    public Object AssertNewAndStoredOutputInner(BaseExchange exchange, Object skipKeys, Object newOutput, Object storedOutput, Object... optionalArgs)
    {
        ...
        {
            java.util.List<String> storedOutputKeys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(storedOutput);
            java.util.List<String> newOutputKeys = (java.util.List<String>)(java.util.List) Helpers.objectKeys(newOutput);
        ...
        {
            Integer storedArrayLength = Helpers.getArrayLength(storedOutput);
            Integer newArrayLength = Helpers.getArrayLength(newOutput);
        ...
        } else
        {
            ...
            } else
            {
                ...
                Boolean isComputedUndefined = (Helpers.isEqual(sanitizedNewOutput, null));
                Boolean isStoredUndefined = (Helpers.isEqual(sanitizedStoredOutput, null));
                Boolean shouldBeSame = Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(isComputedBool, isStoredBool))) && Helpers.isTrue((Helpers.isEqual(isComputedString, isStoredString)))) && Helpers.isTrue((Helpers.isEqual(isComputedUndefined, isStoredUndefined)));
    ...
    public Object AssertStaticRequestOutput(BaseExchange exchange, Object type, Object skipKeys, Object storedUrl, Object requestUrl, Object storedOutput, Object newOutput)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(storedOutput, null))) && Helpers.isTrue((Helpers.isEqual(newOutput, null)))))
        {
            ...
            {
                java.util.List<Object> storedUrlParts = (java.util.List<Object>) Helpers.split(storedUrl, "?");
                java.util.List<Object> newUrlParts = (java.util.List<Object>) Helpers.split(requestUrl, "?");
    ...
    public Object sanitizeDataInput(Object input)
    {
        ...
        java.util.List<Object> newInput = new java.util.ArrayList<Object>(java.util.Arrays.asList());
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                ...
                if (Helpers.isTrue(!Helpers.isEqual(expectedResults, null)))
                {
                    ...
                    // buried on top of
                    java.util.List<Object> promises = new java.util.ArrayList<Object>(java.util.Arrays.asList(this.injectWsMessages(exchange, url, messages, true), this.watchAndAssertSequence(exchange, url, method, input, skipKeys, expectedResults)));
                ...
                } else
                {
                    ...
                    java.util.List<Object> promises = new java.util.ArrayList<Object>(java.util.Arrays.asList(callExchangeMethodDynamically(exchange, method, input), this.injectWsMessages(exchange, url, messages)));
                    Object results = (Helpers.promiseAll(promises)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> testExchangeWsStatically(Object exchangeName, Object exchangeData, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<String> methodsNames = (java.util.List<String>)(java.util.List) Helpers.objectKeys(methods);
    ...
    put( "code", "USDC" );
        ...
        if (Helpers.isTrue(!Helpers.isEqual(predictionEvents, null)))
        {
            java.util.List<Object> eventMarkets = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(predictionEvents)); i++)
            {
                ...
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(evMarkets)); j++)
                {
                    ...
                    Assert(!Helpers.isEqual(exchange.safeString(evMarket, "market"), null), Helpers.add(exchangeName, " static events fixture: market row missing the unified market handle"));
                    Assert(Helpers.isEqual(exchange.safeString(evMarket, "symbol"), null), Helpers.add(exchangeName, " static events fixture: market row must not carry the deprecated symbol key"));
                    ((java.util.List<Object>)eventMarkets).add(evMarket);
                }
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> runStaticTests(Object type2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<String> exchanges = (java.util.List<String>)(java.util.List) Helpers.objectKeys(staticData);
    ...
    public java.util.concurrent.CompletableFuture<Object> testBinance()
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                java.util.List<Object> orders = new java.util.ArrayList<Object>(java.util.Arrays.asList(new java.util.HashMap<String, Object>() {{
