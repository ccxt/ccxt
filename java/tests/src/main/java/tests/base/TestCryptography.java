...
public class TestCryptography extends BaseTest {
        ...
        public void testCryptography()
        {
            ...
            // ---------------------------------------------------------------------------------------------------------------------
            Assert(Helpers.isEqual(hash(encode(""), sha256(), "hex"), "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
            Assert(Helpers.isEqual(hash(encode("cheese"), sha256(), "hex"), "873ac9ffea4dd04fa719e8920cd6938f0c23cd678af330939cff53c3d2855f34"));
            Assert(Helpers.isEqual(hash(encode(""), md5(), "hex"), "d41d8cd98f00b204e9800998ecf8427e"));
            Assert(Helpers.isEqual(hash(encode("sexyfish"), md5(), "hex"), "c8a35464aa9d5683585786f44d5889f8"));
            Assert(Helpers.isEqual(hash(encode(""), sha1(), "hex"), "da39a3ee5e6b4b0d3255bfef95601890afd80709"));
            Assert(Helpers.isEqual(hash(encode("nutella"), sha1(), "hex"), "b3d60a34b744159793c483b067c56d8affc5111a"));
            ...
            Assert(equals(ecdsa(privateKey, privateKey, secp256k1(), null), new java.util.HashMap<String, Object>() {{
