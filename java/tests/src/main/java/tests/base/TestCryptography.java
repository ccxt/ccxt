...
public class TestCryptography extends BaseTest {
        ...
        public void testCryptography()
        {
            ...
            // ---------------------------------------------------------------------------------------------------------------------
            Assert(java.util.Objects.equals(hash(encode(""), sha256(), "hex"), "e3b0c44298fc1c149afbf4c8996fb92427ae41e4649b934ca495991b7852b855"));
            Assert(java.util.Objects.equals(hash(encode("cheese"), sha256(), "hex"), "873ac9ffea4dd04fa719e8920cd6938f0c23cd678af330939cff53c3d2855f34"));
            Assert(java.util.Objects.equals(hash(encode(""), md5(), "hex"), "d41d8cd98f00b204e9800998ecf8427e"));
            Assert(java.util.Objects.equals(hash(encode("sexyfish"), md5(), "hex"), "c8a35464aa9d5683585786f44d5889f8"));
            Assert(java.util.Objects.equals(hash(encode(""), sha1(), "hex"), "da39a3ee5e6b4b0d3255bfef95601890afd80709"));
            Assert(java.util.Objects.equals(hash(encode("nutella"), sha1(), "hex"), "b3d60a34b744159793c483b067c56d8affc5111a"));
            Assert(java.util.Objects.equals(hmac(encode("hello"), encode("there"), sha256(), "hex"), "551e1c1ecbce0fe9b643745a376584a6289f5f43a46861b315fac9edc8d52a26"));
            Assert(java.util.Objects.equals(hmac(encode("a message"), encode("a secret"), md5(), "hex"), "0bfa503bdbc7358185fcd49b4869e23d"));
            // ---------------------------------------------------------------------------------------------------------------------
            String privateKey = "1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a1a";
            Assert(equals(ecdsa("1a", privateKey, secp256k1(), sha256()), new HashMap<String, Object>() {{
            ...
            Assert(equals(ecdsa(privateKey, privateKey, secp256k1(), null), new HashMap<String, Object>() {{
                put( "r", "b84a36a6fbabd5277ede578448b93d48e70b38efb5b15b1d4e2a298accf938b1" );
                put( "s", "66ebfb8221cda925526e699a59cd221bb4cc84bdc563024b1802c4d9e1d8bbe9" );
                put( "v", 1 );
            }}));
            // ---------------------------------------------------------------------------------------------------------------------
            //
