...
public class BitvavoCore extends io.github.ccxt.exchanges.Bitvavo
{
   ...
   public BitvavoCore (Object options) {
    ...
    public void handleTrade(Client client, Object message)
    {
        ...
        //     }
        //
        String marketId = (String) this.safeString(message, "market");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId, null, "-");
    ...
    public void handleFetchOHLCV(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "requestId");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBookSnapshot(Client client, Object message, Object subscription)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String marketId = (String) this.safeString2(subscription, "marketId", "market", this.safeString(message, "market"));
    ...
    public void handleOrderBookSnapshot(Client client, Object message)
    {
        ...
        String marketId = (String) this.safeString(response, "market");
    ...
    public void handleOrderBookSubscriptions(Client client, Object message, Object marketIds)
    {
        ...
        {
            String marketId = (String) this.safeString(marketIds, i);
            String symbol = (String) this.safeSymbol(marketId, null, "-");
            Object messageHash = Helpers.add(Helpers.add(name, "@"), marketId);
    ...
    public Object handleUnsubscriptionStatus(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(keys)); i++)
        {
            ...
            String subHash = (String) Helpers.replace((String)key, (String)"unsubscribe:", (String)"");
    ...
    {
        Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
        String symbol = (String) this.safeString(parameters, "market", "");
    ...
    {
        Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
        String orderId = (String) this.safeString(parameters, "orderId");
    ...
    public Object handleErrorMessage(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "requestId", buildMessage);
