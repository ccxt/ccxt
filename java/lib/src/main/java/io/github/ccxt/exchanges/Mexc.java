   ...
   public Mexc (Object options) {
    ...
    public CompletableFuture<Order> createMarketSellOrderWithCost(String symbol, Object cost, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            return (this.createOrder(symbol, "market", "sell", (Object)(0), (Object)(null), (Object)(this.extend(req, parameters)))).join();
        }).thenApply(Order::new);
...
final String finalRiskIncrVol = riskIncrVol;
     ...
     * @returns {object[]} a list of [position structures]{@link https://docs.ccxt.com/?id=position-structure}
     */
    public CompletableFuture<List<Position>> fetchPositionsHistory(List<String> symbols2, Long since, Long limit2, Map<String, Object> parameters)
    {
        final List<String> symbols3 = symbols2;
        final Long limit3 = limit2;
        return BaseExchange.supplyAsync(() -> {
