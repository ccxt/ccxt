   ...
   public KucoinCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> negotiate(Object privateChannel2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String connectId = ((Helpers.isTrue((Helpers.isEqual(privateChannel, true))))) ? "private" : "public";
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTicker(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(uta))
            {
                ...
                String utaMessageHash = Helpers.add("unsubscribe:", subMessageHash);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchUtaTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) "uta:ticker";
            java.util.List<Object> messageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String subMessageHash = Helpers.add(Helpers.add(Helpers.add("candles:", symbol), ":"), timeframe);
            if (Helpers.isTrue(uta))
            {
                subMessageHash = Helpers.add("uta:", subMessageHash);
                Helpers.addElementToObject(subscription, "subMessageHashes", new java.util.ArrayList<Object>(java.util.Arrays.asList(subMessageHash)));
    ...
    public void handleTrade(Client client, Object message)
    {
        ...
        String marketId = (String) this.safeString(data, "symbol");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        java.util.Map<String, Object> trade = this.parseTrade(data, market);
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOrderBook(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(uta))
            {
                ...
                String subMessageHash = Helpers.add(Helpers.add(Helpers.add("uta:orderbook:", symbol), ":depth:"), depth);
                String messageHash = (String) Helpers.add("unsubscribe:", subMessageHash);
                String channel = "obu";
                final Object finalSymbol = symbol;
                Object subscription = new java.util.HashMap<String, Object>() {{
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            } else
            {
                ...
                String topic = ((Helpers.isTrue((Helpers.isEqual(trigger, true))))) ? "/spotMarket/advancedOrders" : "/spotMarket/tradeOrders";
                if (Helpers.isTrue(isFuturesMethod))
                {
    ...
    public void handleOrder(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(rawType, "match"))) && Helpers.isTrue((!Helpers.isEqual(matchPrice, null)))) && Helpers.isTrue((!Helpers.isEqual(matchSize, null)))))
        {
            ...
            String filledString = (String) this.numberToString(Helpers.GetValue(parsed, "filled"));
    ...
    public void handleUtaOrder(Client client, Object message)
    {
        ...
        Helpers.callDynamically(cachedOrders, "append", new Object[]{parsed});
        String messageHash = (String) "uta:orders";
        Object symbolSpecificMessageHash = Helpers.add(Helpers.add(messageHash, ":"), symbol);
        client.resolve(cachedOrders, symbolSpecificMessageHash);
    ...
    public void handleUtaMyTrade(Client client, Object message)
    {
        ...
        Helpers.callDynamically(cache, "append", new Object[]{trade});
        String messageHash = (String) "uta:myTrades";
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPosition(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            String topic = Helpers.add("/contract/position:", Helpers.GetValue(market, "id"));
            java.util.Map<String, Object> request = new java.util.HashMap<String, Object>() {{
                put( "privateChannel", true );
            }};
    ...
    public Object getCurrentPosition(Object symbol)
    {
        ...
        java.util.List<Object> values = Helpers.objectValues(symbolCache);
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchFundingRate(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String unSubMessageHash = Helpers.add("unsubscribe:", subMessageHash);
            final Object finalSymbol = symbol;
            Object subscription = new java.util.HashMap<String, Object>() {{
                put( "symbols", new java.util.ArrayList<Object>(java.util.Arrays.asList(finalSymbol)) );
