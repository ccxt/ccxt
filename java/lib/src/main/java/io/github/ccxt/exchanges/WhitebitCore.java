   ...
   public WhitebitCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTransactionFees(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //      }
            //
            java.util.List<Object> currenciesIds = Helpers.objectKeys(response);
    ...
    public Object parseDepositWithdrawFees(Object response, Object... optionalArgs)
    {
        ...
        java.util.List<Object> currencyIds = Helpers.objectKeys(response);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTradingLimits(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<Object> marketIds = Helpers.objectKeys(markets);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchFundingLimits(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            //
            java.util.Map<String, Object> result = new java.util.HashMap<String, Object>() {{}};
            java.util.List<Object> currencyKeys = Helpers.objectKeys(currenciesData);
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencyKeys)); i++)
            {
                ...
                Object feeData = null;
                java.util.List<Object> feeKeys = Helpers.objectKeys(feesData);
        ...
        if (Helpers.isTrue(!Helpers.isEqual(response, null)))
        {
            ...
            if (Helpers.isTrue(Helpers.isTrue(hasErrorStatus) || Helpers.isTrue(!Helpers.isEqual(codeNew, null))))
            {
                ...
                } else
                {
                    ...
                    java.util.List<Object> errorKeys = Helpers.objectKeys(errorObject);
            ...
            if (Helpers.isTrue(!Helpers.isEqual(success, true)))
            {
                ...
                java.util.List<Object> errKeys = Helpers.objectKeys(errMsg);
