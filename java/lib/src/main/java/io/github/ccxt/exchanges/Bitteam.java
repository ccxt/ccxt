   ...
   public Bitteam (Object options) {
    ...
    public Object handleErrors(Object code, Object reason, Object url, Object method, Object headers, Object body, Object response, Object requestHeaders, Object requestBody)
    {
        ...
        if (!Helpers.isEqual(code, 200))
        {
            ...
            {
                if ((Helpers.isGreaterThanOrEqual(((String)url).indexOf("/ccxt/order/"), 0)) && (java.util.Objects.equals(method, "GET")))
                {
                ...
                if (Helpers.isGreaterThanOrEqual(((String)url).indexOf("/cmc/orderbook/"), 0))
                {
