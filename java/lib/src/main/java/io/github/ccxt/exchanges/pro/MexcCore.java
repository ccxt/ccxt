   ...
   public MexcCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String firstSymbol = (String) this.safeString(symbols, 0);
            Object market = null;
    ...
    public void handleTickers(Client client, Object message)
    {
        ...
        //     }
        //
        java.util.List<Object> data = (java.util.List<Object>) this.safeList2(message, "data", "d", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        String channel = (String) this.safeString(message, "c", "");
    ...
    public Object parseWsTicker(Object ticker, Object... optionalArgs)
    {
        ...
        String price = (String) this.safeString(ticker, "p");
    ...
    public void handleBidAsk(Client client, Object message)
    {
        ...
        String symbol = (String) this.safeString(parsedTicker, "symbol");
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            return;
        }
    ...
    {
        Object market = Helpers.getArg(optionalArgs, 0, null);
        java.util.Map<String, Object> data = (java.util.Map<String, Object>) this.safeDict(ticker, "d");
        String marketId = (String) this.safeString(ticker, "s");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String timeframeId = (String) this.safeString(timeframes, timeframe);
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.inOp(message, "publicSpotKline")))
        {
            ...
            java.util.Map<String, Object> data = (java.util.Map<String, Object>) this.safeDict(message, "publicSpotKline", new java.util.HashMap<String, Object>() {{}});
            String timeframeId = (String) this.safeString(data, "interval");
        ...
        } else
        {
            ...
            String timeframeId = (String) this.safeString2(rawOhlcv, "i", "interval");
            Object timeframes = this.safeValue(this.options, "timeframes", new java.util.HashMap<String, Object>() {{}});
    ...
    public void handleOrderBookSubscription(Client client, Object message)
    {
        ...
        //
        String msg = (String) this.safeString(message, "msg", "");
        java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(msg, "@");
        String marketId = (String) this.safeString(parts, 2);
    ...
    public void handleDelta(Object orderbook, Object delta)
    {
        ...
        java.util.List<Object> asks = (java.util.List<Object>) this.safeList(delta, "asks", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        java.util.List<Object> bids = (java.util.List<Object>) this.safeList(delta, "bids", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public void handleTrades(Client client, Object message)
    {
        ...
        java.util.List<Object> trades = (java.util.List<Object>) this.safeList2(d, "deals", "dealsList", new java.util.ArrayList<Object>(java.util.Arrays.asList(d)));
        if (Helpers.isTrue(Helpers.isEqual(d, null)))
        {
            trades = (java.util.List<Object>) this.safeList(message, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        }
    ...
    public void handleMyTrade(Client client, Object message, Object... optionalArgs)
    {
        ...
        String futuresMarketId = (String) this.safeString(data, "symbol");
        String marketId = (String) this.safeString2(message, "s", "symbol", futuresMarketId);
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object symbol = Helpers.GetValue(market, "symbol");
        Object trade = null;
        if (Helpers.isTrue(Helpers.isEqual(Helpers.GetValue(market, "spot"), true)))
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        String tradeId = (String) this.safeString2(trade, "t", "tradeId");
        if (Helpers.isTrue(Helpers.isEqual(timestamp, null)))
        {
            timestamp = (Long) this.safeInteger(trade, "t");
            tradeId = null;
        }
        String priceString = (String) this.safeString2(trade, "p", "price");
        String amountString = (String) this.safeString2(trade, "v", "quantity");
        String rawSide = (String) this.safeString2(trade, "S", "tradeType");
        String side = ((Helpers.isTrue((Helpers.isEqual(rawSide, "1"))))) ? "buy" : "sell";
        Long isMaker = this.safeInteger(trade, "m");
        String feeAmount = (String) this.safeString2(trade, "n", "feeAmount");
        String feeCurrencyId = (String) this.safeString2(trade, "N", "feeCurrency");
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        String side = (String) this.safeString(order, "tradeType");
        String status = (String) this.safeString2(order, "status", "state");
        String type = (String) this.safeString(order, "orderType");
        Object fee = null;
        String feeCurrency = (String) this.safeString(order, "N");
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        String currencyId = (String) this.safeString2(data, "currency", "vcoinName");
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchFundingRate(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            String messageHash = (String) Helpers.add("unsubscribe:fundingRate:", Helpers.GetValue(market, "symbol"));
            Object url = null;
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object timeframes = this.safeValue(this.options, "timeframes", new java.util.HashMap<String, Object>() {{}});
            String timeframeId = (String) this.safeString(timeframes, timeframe);
            String messageHash = (String) Helpers.add(Helpers.add(Helpers.add("unsubscribe:candles:", symbol), ":"), timeframe);
            Object url = null;
            if (Helpers.isTrue(Helpers.isEqual(Helpers.GetValue(market, "spot"), true)))
            {
                url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "spot");
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTrades(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            symbol = Helpers.GetValue(market, "symbol");
            String messageHash = (String) Helpers.add("unsubscribe:trades:", symbol);
            Object url = null;
            if (Helpers.isTrue(Helpers.isEqual(Helpers.GetValue(market, "spot"), true)))
            {
                url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "spot");
    ...
    public void handleUnsubscriptions(Client client, Object messageHashes)
    {
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(messageHashes)); i++)
        {
            ...
            String subMessageHash = (String) Helpers.replace((String)messageHash, (String)"unsubscribe:", (String)"");
            this.cleanUnsubscription(client, subMessageHash, messageHash);
            if (Helpers.isTrue(Helpers.isGreaterThanOrEqual(Helpers.getIndexOf(messageHash, "ticker"), 0)))
            {
                String symbol = (String) Helpers.replace((String)messageHash, (String)"unsubscribe:ticker:", (String)"");
            ...
            {
                String symbol = (String) Helpers.replace((String)messageHash, (String)"unsubscribe:bidask:", (String)"");
            ...
            {
                String symbol = (String) Helpers.replace((String)messageHash, (String)"unsubscribe:orderbook:", (String)"");
                if (Helpers.isTrue(Helpers.inOp(this.orderbooks, symbol)))
                {
            ...
            {
                String symbol = (String) Helpers.replace((String)messageHash, (String)"unsubscribe:trades:", (String)"");
            ...
            {
                String symbol = (String) Helpers.replace((String)messageHash, (String)"unsubscribe:fundingRate:", (String)"");
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object subscriptionHash, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) "authenticate:listenKey";
    ...
    public void handleSubscriptionStatus(Client client, Object message)
    {
        ...
        {
            java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(msg, "@");
            String channel = (String) this.safeString(parts, 1);
    ...
    public Object handleProtobufMessage(Client client, Object message)
    {
        ...
        String channelId = (String) this.safeString(channelParts, 1);
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        String c = (String) this.safeString(message, "c");
        Object channel = null;
