...
/**
 * Typed wrapper for independentreserve. Extends IndependentreserveCore with typed method overloads.
 */
public class Independentreserve extends IndependentreserveCore {
