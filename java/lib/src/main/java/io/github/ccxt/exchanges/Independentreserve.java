...
public class Independentreserve extends IndependentreserveApi
{
   ...
   public Independentreserve (Object options) {
    ...
    public Object parseTicker(Object ticker, Map<String, Object> market)
    {
        ...
        Map<String, Object> marketResolved = (Map<String, Object>) this.safeMarket(defaultMarketId, market, "/", (String) null);
    ...
    public CompletableFuture<List<Order>> fetchOpenOrders(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                market = (Map<String, Object>) this.market(symbol);
                request.put("primaryCurrencyCode", ((Map<String, Object>)market).get("baseId"));
                request.put("secondaryCurrencyCode", ((Map<String, Object>)market).get("quoteId"));
            }
            Object limitResolved = (((java.util.Objects.equals(limit, null)))) ? 50 : limit;
    ...
    public CompletableFuture<List<Trade>> fetchMyTrades(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object limitResolved = (((java.util.Objects.equals(java.util.Objects.requireNonNullElse(limit, 50L), null)))) ? 50 : java.util.Objects.requireNonNullElse(limit, 50L);
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "pageIndex", pageIndex );
                put( "pageSize", limitResolved );
            }};
    ...
    public CompletableFuture<Order> createOrder(Object symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> request = Helpers.newMap(
                "primaryCurrencyCode", ((Map<String, Object>)market).get("baseId"),
                "secondaryCurrencyCode", ((Map<String, Object>)market).get("quoteId"),
                "orderType", orderType
            );
