   ...
   public Latoken (Object options) {
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new HashMap<String, Object>() {{
            ...
            put( "urls", new HashMap<String, Object>() {{
                ...
                put( "doc", new ArrayList<Object>(Arrays.asList("https://api.latoken.com")) );
            ...
            put( "api", new HashMap<String, Object>() {{
                put( "public", new HashMap<String, Object>() {{
                    put( "get", new HashMap<String, Object>() {{
                        put( "book/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "chart/week", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "chart/week/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "currency", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "currency/available", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "currency/quotes", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "currency/{currency}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "pair", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "pair/available", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "ticker", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "ticker/{base}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "time", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "trade/history/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "trade/fee/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "trade/feeLevels", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "transaction/bindings", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                    }} );
                }} );
                put( "private", new HashMap<String, Object>() {{
                    put( "get", new HashMap<String, Object>() {{
                        put( "auth/account", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/account/currency/{currency}/{type}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/account/filtered", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/active", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/getOrder/{id}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/pair/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/pair/{currency}/{quote}/active", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/getOrder/{id}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/pair/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/pair/{currency}/{quote}/active", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/trade", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/trade/pair/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/trade/fee/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/bindings", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/bindings/{currency}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/{id}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transfer", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                    }} );
                    put( "post", new HashMap<String, Object>() {{
                        put( "auth/order/cancel", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/cancelAll", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/cancelAll/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/cancelBulk", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/place", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/order/placeBulk", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/spot/deposit", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/spot/withdraw", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/cancel", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/cancelAll", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/cancelAll/{currency}/{quote}", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/stopOrder/place", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/depositAddress", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/withdraw", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/withdraw/cancel", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/withdraw/confirm", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transaction/withdraw/resendCode", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transfer/email", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transfer/id", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                        put( "auth/transfer/phone", new HashMap<String, Object>() {{
                            put( "cost", 1 );
                        }} );
                    }} );
                }} );
            ...
            put( "options", new HashMap<String, Object>() {{
                ...
                put( "fetchTradingFee", new HashMap<String, Object>() {{
    ...
    public CompletableFuture<Object> fetchMarkets(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> response = (this.publicGetPair(parameters)).join();
            //
            //     [
            //         {
            ...
            for (var i = 0; i < ((List<?>)rawMarkets).size(); i++)
            {
                ...
                Map<String, Object> baseCurrency = (Map<String, Object>) this.safeDict(currenciesById, baseId, (Object) null);
                Map<String, Object> quoteCurrency = (Map<String, Object>) this.safeDict(currenciesById, quoteId, (Object) null);
                Map<String, Object> baseCurrencyInfo = (Map<String, Object>) this.safeDict(baseCurrency, "info", (Object) null);
                Map<String, Object> quoteCurrencyInfo = (Map<String, Object>) this.safeDict(quoteCurrency, "info", (Object) null);
                if (!java.util.Objects.equals(baseCurrencyInfo, null) && !java.util.Objects.equals(quoteCurrencyInfo, null))
                {
                    String base = this.safeCurrencyCode(this.safeString(baseCurrencyInfo, "tag"), (Map<String, Object>) null);
                    String quote = this.safeCurrencyCode(this.safeString(quoteCurrencyInfo, "tag"), (Map<String, Object>) null);
                    ...
                    ((List<Object>)result).add(Helpers.newMap(
                        ...
                        "future", false,
                        "option", false,
                        "active", (java.util.Objects.equals(status, "PAIR_STATUS_ACTIVE")),
                        "contract", false,
                        "linear", null,
                        "inverse", null,
                        "contractSize", null,
                        ...
                        "precision", new HashMap<String, Object>() {{
                            put( "amount", Latoken.this.safeNumber(market, "quantityTick", (Object) null) );
                            put( "price", Latoken.this.safeNumber(market, "priceTick", (Object) null) );
                        }},
                        "limits", new HashMap<String, Object>() {{
                            ...
                            put( "amount", new HashMap<String, Object>() {{
                                put( "min", Latoken.this.safeNumber(market, "minOrderQuantity", (Object) null) );
                                put( "max", null );
                            }} );
                            ...
                            put( "cost", new HashMap<String, Object>() {{
                                put( "min", Latoken.this.safeNumber(market, ("minOrderCost" + capitalizedQuote), (Object) null) );
                                put( "max", Latoken.this.safeNumber(market, ("maxOrderCost" + capitalizedQuote), (Object) null) );
                            }} );
                        }},
    ...
    public CompletableFuture<Object> fetchCurrencies(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> response = (this.publicGetCurrency(parameters)).join();
            //
            //     [
            //         {
    ...
    public Object parseCurrency(Object currency)
    {
        ...
        String code = this.safeCurrencyCode(tag, (Map<String, Object>) null);
        String currencyType = this.safeString(currency, "type");
        Boolean isCrypto = (java.util.Objects.equals(currencyType, "CURRENCY_TYPE_CRYPTO") || java.util.Objects.equals(currencyType, "CURRENCY_TYPE_IEO"));
        return this.safeCurrencyStructure(new HashMap<String, Object>() {{
            ...
            put( "deposit", null );
            put( "withdraw", null );
            put( "fee", Latoken.this.safeNumber(currency, "fee", (Object) null) );
            put( "precision", Latoken.this.parseNumber(Latoken.this.parsePrecision(Latoken.this.safeString(currency, "decimals"))) );
            put( "limits", new HashMap<String, Object>() {{
                put( "amount", new HashMap<String, Object>() {{
                    put( "min", Latoken.this.safeNumber(currency, "minTransferAmount", (Object) null) );
                    put( "max", null );
                }} );
    ...
    public CompletableFuture<Balances> fetchBalance(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> response = (this.privateGetAuthAccount(parameters)).join();
            //
            //     [
            //         {
            ...
            for (var i = 0; i < ((List<?>)balances).size(); i++)
            {
                ...
                {
                    if (java.util.Objects.equals(maxTimestamp, null))
                    {
            ...
            result.put("datetime", this.iso8601(maxTimestamp));
    ...
    public CompletableFuture<OrderBook> fetchOrderBook(Object symbol, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.publicGetBookCurrencyQuote(this.extend(request, parameters))).join();
            //
            //     {
            //         "ask":[
            ...
            return this.parseOrderBook(filtered, symbol, (Long) null, "bid", "ask", "price", "quantity", 2);
    ...
    public Object parseTrade(Object trade, Map<String, Object> market)
    {
        ...
        Boolean makerBuyer = (Boolean) this.safeBool(trade, "makerBuyer", (Object) null);
        String side = this.safeString(trade, "direction");
        if (java.util.Objects.equals(side, null))
        {
            side = (((java.util.Objects.equals(makerBuyer, true)))) ? "sell" : "buy";
        } else
        {
            if (java.util.Objects.equals(side, "TRADE_DIRECTION_BUY"))
            {
                side = "buy";
            } else if (java.util.Objects.equals(side, "TRADE_DIRECTION_SELL"))
            {
                side = "sell";
            }
        }
    ...
    public CompletableFuture<Object> fetchPublicTradingFee(String symbol, Map<String, Object> parameters)
    {
    ...
    public CompletableFuture<Object> fetchPrivateTradingFee(String symbol, Map<String, Object> parameters)
    {
    ...
    public Object parseOrder(Object order, Map<String, Object> market)
    {
        ...
        String base = this.safeCurrencyCode(baseId, (Map<String, Object>) null);
        String quote = this.safeCurrencyCode(quoteId, (Map<String, Object>) null);
        Boolean hasBaseAndQuote = (!java.util.Objects.equals(base, null)) && (!java.util.Objects.equals(quote, null));
        String symbol = null;
        if (Boolean.TRUE.equals(hasBaseAndQuote))
        {
            symbol = ((base + "/") + quote);
        }
        ...
        if (!java.util.Objects.equals(orderSide, null))
        {
            ...
            side = this.safeStringLower(parts, (((long) partsLength) - 1L));
        }
    ...
    public CompletableFuture<List<Order>> fetchOpenOrders(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                response = (this.privateGetAuthStopOrderPairCurrencyQuoteActive(this.extend(request, paramsOmitted))).join();
            } else
            {
                response = (this.privateGetAuthOrderPairCurrencyQuoteActive(this.extend(request, paramsOmitted))).join();
            }
            //
            //     [
            //         {
    ...
    public CompletableFuture<List<Order>> fetchOrders(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(symbol, null))
            {
                ...
                {
                    response = (this.privateGetAuthOrderPairCurrencyQuote(this.extend(request, paramsOmitted))).join();
                }
            } else
            {
                if (java.util.Objects.equals(isTrigger, true))
                {
                    response = (this.privateGetAuthStopOrder(this.extend(request, paramsOmitted))).join();
                } else
                {
                    response = (this.privateGetAuthOrder(this.extend(request, paramsOmitted))).join();
                }
            }
            //
            //     [
    ...
    public CompletableFuture<Order> fetchOrder(Object id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (java.util.Objects.equals(isTrigger, true))
            {
                response = (this.privateGetAuthStopOrderGetOrderId(this.extend(request, paramsOmitted))).join();
            } else
            {
                response = (this.privateGetAuthOrderGetOrderId(this.extend(request, paramsOmitted))).join();
            }
            //
            //     {
            //         "id":"a76bd262-3560-4bfb-98ac-1cedd394f4fc",
    ...
    public CompletableFuture<Order> createOrder(Object symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> paramsOmitted = (Map<String, Object>) this.omit(parameters, new ArrayList<Object>(Arrays.asList("triggerPrice", "stopPrice")));
            Map<String, Object> response = null;
            if (!java.util.Objects.equals(triggerPrice, null))
            {
                request.put("stopPrice", this.priceToPrecision(symbol, triggerPrice));
                response = (this.privatePostAuthStopOrderPlace(this.extend(request, paramsOmitted))).join();
            } else
            {
                response = (this.privatePostAuthOrderPlace(this.extend(request, paramsOmitted))).join();
            }
            //
            //    {
            //        "baseCurrency": "f7dac554-8139-4ff6-841f-0e586a5984a0",
    ...
    public CompletableFuture<Order> cancelOrder(Object id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (java.util.Objects.equals(isTrigger, true))
            {
                response = (this.privatePostAuthStopOrderCancel(this.extend(request, paramsOmitted))).join();
            } else
            {
                response = (this.privatePostAuthOrderCancel(this.extend(request, paramsOmitted))).join();
            }
            //
            //     {
    ...
    public CompletableFuture<List<Order>> cancelAllOrders(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(symbol, null))
            {
                ...
                {
                    response = (this.privatePostAuthOrderCancelAllCurrencyQuote(this.extend(request, paramsOmitted))).join();
                }
            } else
            {
                if (java.util.Objects.equals(isTrigger, true))
                {
                    response = (this.privatePostAuthStopOrderCancelAll(this.extend(request, paramsOmitted))).join();
                } else
                {
                    response = (this.privatePostAuthOrderCancelAll(this.extend(request, paramsOmitted))).join();
                }
            }
            //
            //     {
    ...
    public CompletableFuture<List<Transaction>> fetchTransactions(String code, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> request = new HashMap<String, Object>() {{}};
            Map<String, Object> response = (this.privateGetAuthTransaction(this.extend(request, parameters))).join();
            //
            //     {
            //         "hasNext":false,
            //         "content":[
            ...
            return this.parseTransactions(content, Helpers.toMapArg(currency), since, limit, new HashMap<String, Object>() {{}});
    ...
    public CompletableFuture<List<TransferEntry>> fetchTransfers(String code, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateGetAuthTransfer(parameters)).join();
            //
            //     {
            //         "hasNext": true,
            //         "content": [
    ...
    public Object parseTransfer(Object transfer, Map<String, Object> currency)
    {
        ...
        return new HashMap<String, Object>() {{
            ...
            put( "amount", Latoken.this.safeNumber(transfer, "transferringFunds", (Object) null) );
    ...
    public Object sign(Object path, Object api, Object method, Object parameters, Object headers, String body)
    {
        ...
        if (java.util.Objects.equals(java.util.Objects.requireNonNullElse(api, "public"), "private"))
        {
            ...
            String auth = ((java.util.Objects.requireNonNullElse(method, "GET") + request) + urlencodedQuery);
