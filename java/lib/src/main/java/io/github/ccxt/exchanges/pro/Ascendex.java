...
/**
 * Typed WS wrapper for ascendex. Extends AscendexCore with typed watch method overloads.
 * REST typed methods (fetchTicker, createOrder, etc.) are inherited from the typed REST class.
 */
public class Ascendex extends AscendexCore {

    public Ascendex() {
        super();
    }

    public Ascendex(Object options) {
        super(options);
    }
