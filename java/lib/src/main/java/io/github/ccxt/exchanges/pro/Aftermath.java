...
/**
 * Typed WS wrapper for aftermath. Extends AftermathCore with typed watch method overloads.
 * REST typed methods (fetchTicker, createOrder, etc.) are inherited from the typed REST class.
 */
public class Aftermath extends AftermathCore {

    public Aftermath() {
        super();
    }

    public Aftermath(Object options) {
        super(options);
    }
