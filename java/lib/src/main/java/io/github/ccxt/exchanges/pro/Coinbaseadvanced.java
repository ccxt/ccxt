...
/**
 * Typed WS wrapper for coinbaseadvanced. Extends CoinbaseadvancedCore with typed watch method overloads.
 * REST typed methods (fetchTicker, createOrder, etc.) are inherited from the typed REST class.
 */
public class Coinbaseadvanced extends CoinbaseadvancedCore {

    public Coinbaseadvanced() {
        super();
    }

    public Coinbaseadvanced(Object options) {
        super(options);
    }
