...
public class CoinsphCore extends CoinsphApi
{
   ...
   public CoinsphCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "id", id );
        put( "name", CoinsphCore.this.safeString(entry, "name") );
        put( "code", code );
        put( "type", ((Helpers.isTrue(isFiat))) ? "fiat" : "crypto" );
        put( "precision", CoinsphCore.this.parseNumber(CoinsphCore.this.parsePrecision(CoinsphCore.this.safeString(entry, "transferPrecision"))) );
        put( "info", entry );
        put( "active", null );
        put( "deposit", CoinsphCore.this.safeBool(entry, "depositAllEnable") );
        put( "withdraw", CoinsphCore.this.safeBool(entry, "withdrawAllEnable") );
