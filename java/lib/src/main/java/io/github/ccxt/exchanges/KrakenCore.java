...
public class KrakenCore extends KrakenApi
{
   ...
   public KrakenCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(since, null)))
            {
                ...
                Long timeFrameInSeconds = (Long) Helpers.multiply(parsedTimeframe, 60);
    ...
    public java.util.Map<String, Object> parseOrder(Object order, Object... optionalArgs)
    {
        ...
        Long timestamp = (Long) this.safeTimestamp(order, "opentm");
...
final Object finalId = id;
    ...
    public Object orderRequest(Object method, Object symbol, Object type, Object request, Object amount, Object... optionalArgs)
    {
        ...
        Boolean isLimitOrder = Helpers.isTrue((!Helpers.isEqual(type, null))) && Helpers.isTrue(((String)type).endsWith(((String)"limit"))); // supporting limit, stop-loss-limit, take-profit-limit, etc
    ...
    public java.util.Map<String, Object> parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        Long timestamp = (Long) this.safeTimestamp(transaction, "time");
