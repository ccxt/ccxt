...
import io.github.ccxt.api.RubinApi;
...
public class RubinCore extends RubinApi
{
   public RubinCore () {
       super();
   }

   public RubinCore (Object options) {
       super(options);
   }
    ...
    public Object describe()
    {
        return this.deepExtend(super.describe(), new java.util.HashMap<String, Object>() {{
            ...
            put( "urls", new java.util.HashMap<String, Object>() {{
                put( "logo", "https://storage.yandexcloud.net/ritbit-static/rubin/logo-xl.png" );
                put( "api", new java.util.HashMap<String, Object>() {{
                    put( "indexer", "https://indexer.mainnet.rubin.trade/v4" );
                    put( "nodeRpc", "https://rpc.mainnet.rubin.trade" );
                    put( "nodeRest", "https://rest.mainnet.rubin.trade" );
                }} );
                put( "test", new java.util.HashMap<String, Object>() {{
                    put( "indexer", "https://indexer.testnet.rubin.trade/v4" );
                    put( "nodeRpc", "https://rpc.testnet.rubin.trade" );
                    put( "nodeRest", "https://rest.testnet.rubin.trade" );
                }} );
                put( "www", "https://rubin.trade" );
                put( "doc", new java.util.ArrayList<Object>(java.util.Arrays.asList("https://docs.rubin.trade")) );
                put( "fees", new java.util.ArrayList<Object>(java.util.Arrays.asList("https://docs.rubin.trade")) );
                put( "referral", "https://rubin.trade?ref=ccxt" );
            }} );
            put( "api", new java.util.HashMap<String, Object>() {{
                ...
                put( "nodeRest", new java.util.HashMap<String, Object>() {{
                    put( "get", new java.util.HashMap<String, Object>() {{
                        put( "cosmos/auth/v1beta1/account_info/{rubinAddress}", 1 );
                    }} );
            ...
            put( "fees", new java.util.HashMap<String, Object>() {{
                put( "trading", new java.util.HashMap<String, Object>() {{
                    put( "tierBased", true );
                    put( "percentage", true );
                    put( "maker", RubinCore.this.parseNumber("0.0001") );
                    put( "taker", RubinCore.this.parseNumber("0.0005") );
                }} );
            }} );
            ...
            put( "options", new java.util.HashMap<String, Object>() {{
                put( "mnemonic", null );
                put( "chainName", "ritbit-mainnet" );
                put( "txExtensionTypeUrl", "/ritbit.accountplus.TxExtension" );
                put( "chainId", 1 );
    ...
    public Object parseMarket(Object market)
    {
        ...
        return this.safeMarketStructure(new java.util.HashMap<String, Object>() {{
            put( "id", RubinCore.this.safeString(market, "ticker") );
            put( "symbol", symbol );
            put( "base", finalBase );
            put( "quote", quote );
            put( "settle", settle );
            ...
            put( "contractSize", RubinCore.this.parseNumber("1") );
            put( "linear", true );
            put( "inverse", false );
            put( "taker", null );
            put( "maker", null );
            ...
            put( "precision", new java.util.HashMap<String, Object>() {{
                put( "amount", RubinCore.this.parseNumber(amountPrecisionStr) );
                put( "price", RubinCore.this.parseNumber(pricePrecisionStr) );
            }} );
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        return this.safeTrade(new java.util.HashMap<String, Object>() {{
            ...
            put( "datetime", RubinCore.this.iso8601(timestamp) );
            put( "symbol", symbol );
            put( "side", side );
            put( "price", price );
            put( "amount", amount );
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object request = new java.util.HashMap<String, Object>() {{
                put( "market", Helpers.GetValue(market, "id") );
                put( "resolution", RubinCore.this.safeString(RubinCore.this.timeframes, timeframe, timeframe) );
            }};
            if (Helpers.isTrue(!Helpers.isEqual(limit, null)))
            {
                Helpers.addElementToObject(request, "limit", Helpers.mathMin(limit, 1000));
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rows)); i++)
            {
                ...
                ((java.util.List<Object>)rates).add(new java.util.HashMap<String, Object>() {{
                    put( "info", entry );
                    put( "symbol", RubinCore.this.safeSymbol(marketId, market) );
                    put( "fundingRate", RubinCore.this.safeNumber(entry, "rate") );
                    put( "timestamp", timestamp );
                    put( "datetime", RubinCore.this.iso8601(timestamp) );
                }});
            }
    ...
    public Object parseOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.safeOrder(new java.util.HashMap<String, Object>() {{
            put( "info", order );
            put( "id", RubinCore.this.safeString(order, "id") );
            put( "clientOrderId", RubinCore.this.safeString(order, "clientId") );
            put( "timestamp", timestamp );
            put( "datetime", RubinCore.this.iso8601(timestamp) );
            ...
            put( "postOnly", RubinCore.this.safeBool(order, "postOnly") );
            put( "reduceOnly", RubinCore.this.safeBool(order, "reduceOnly") );
            put( "side", side );
            put( "price", price );
    ...
    public Object parsePosition(Object position, Object... optionalArgs)
    {
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            ...
            put( "id", null );
            put( "symbol", symbol );
            put( "entryPrice", RubinCore.this.safeNumber(position, "entryPrice") );
            put( "markPrice", null );
            put( "notional", null );
            put( "collateral", null );
            put( "unrealizedPnl", RubinCore.this.safeNumber(position, "unrealizedPnl") );
            put( "side", finalSide );
            put( "contracts", RubinCore.this.parseNumber(finalQuantity) );
    ...
    public Object signHash(Object hash, Object privateKey)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "v", RubinCore.this.sum(27, Helpers.GetValue(signature, "v")) );
        }};
    }
    ...
    public Object signRubinTx(Object privateKey, Object message, Object memo, Object chainId, Object account, Object authenticators, Object... optionalArgs)
    {
        ...
        return this.encodeV4TxRaw(signDoc, Helpers.add(Helpers.GetValue(signature, "r"), Helpers.GetValue(signature, "s")));
    }

    public Object retrieveCredentials()
    {
        Object credentials = this.safeDict(this.options, "rubinCredentials");
        ...
        Helpers.addElementToObject(this.options, "rubinCredentials", credentials);
        return credentials;
    }

    public java.util.concurrent.CompletableFuture<Object> fetchRubinAccount()
    {

        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {

            // required in js
            (this.loadV4Protos()).join();
            Object rubinAccount = this.safeDict(this.options, "rubinAccount");
            if (Helpers.isTrue(!Helpers.isEqual(rubinAccount, null)))
            {
                return rubinAccount;
            }
            if (Helpers.isTrue(Helpers.isEqual(this.walletAddress, null)))
            {
                throw new ArgumentsRequired((String)Helpers.add(this.id, " fetchRubinAccount() requires the walletAddress to be set using the rit chain address eg: rit1exampleaddressxxxxxxxxxxxxxxxxxxxxxxx")) ;
            }
            if (!Helpers.isTrue(((String)this.walletAddress).startsWith(((String)"rit"))))
            {
                throw new ArgumentsRequired((String)Helpers.add(this.id, " fetchRubinAccount() requires a valid rit chain address, starting with rit, not the l1 address.")) ;
            }
            Object request = new java.util.HashMap<String, Object>() {{
                put( "rubinAddress", RubinCore.this.walletAddress );
            }};
            //
            // {
            //     "info": {
            ...
            // }
            //
            Object response = (this.nodeRestGetCosmosAuthV1beta1AccountInfoRubinAddress(request)).join();
        ...
        put( "key", Helpers.GetValue(Helpers.GetValue(account, "pub_key"), "key") );
            ...
            Helpers.addElementToObject(this.options, "rubinAccount", account);
            return account;
        });
            ...
            put( "order", new java.util.HashMap<String, Object>() {{
                put( "orderId", new java.util.HashMap<String, Object>() {{
                    put( "subaccountId", new java.util.HashMap<String, Object>() {{
                        put( "owner", RubinCore.this.getWalletAddress() );
                ...
                put( "side", sideNumber );
                put( "quantums", RubinCore.this.toV4Long(quantums) );
                put( "subticks", RubinCore.this.toV4Long(subticks) );
                ...
                put( "conditionalOrderTriggerSubticks", RubinCore.this.toV4Long(finalConditionalOrderTriggerSubticks) );
                put( "orderRouterAddress", RubinCore.this.safeString(RubinCore.this.options, "routerAddress") );
            }} );
        }};
        Object signingPayload = new java.util.HashMap<String, Object>() {{
            put( "typeUrl", "/ritbit.clob.MsgPlaceOrder" );
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object account = (this.fetchRubinAccount()).join();
            ...
            Object signedTx = this.signRubinTx(Helpers.GetValue(credentials, "privateKey"), orderRequest, "", chainName, account, null);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "tx", signedTx );
            }};
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrder(Object id2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object signingPayload = new java.util.HashMap<String, Object>() {{
                put( "typeUrl", "/ritbit.clob.MsgCancelOrder" );
                put( "value", cancelPayload );
            }};
            Object chainName = Helpers.GetValue(this.options, "chainName");
            Object signedTx = this.signRubinTx(Helpers.GetValue(credentials, "privateKey"), signingPayload, "", chainName, account, null);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "tx", signedTx );
            }};
            // nodeRpcGetBroadcastTxAsync
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrders(Object ids, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object signingPayload = new java.util.HashMap<String, Object>() {{
                put( "typeUrl", "/ritbit.clob.MsgBatchCancel" );
                put( "value", cancelPayload );
            }};
            Object chainName = Helpers.GetValue(this.options, "chainName");
            Object signedTx = this.signRubinTx(Helpers.GetValue(credentials, "privateKey"), signingPayload, "", chainName, account, null);
    ...
    public Object parseLedgerEntry(Object item, Object... optionalArgs)
    {
        ...
        return this.safeLedgerEntry(new java.util.HashMap<String, Object>() {{
            put( "info", item );
            put( "id", RubinCore.this.safeString(item, "id") );
            put( "direction", finalDirection );
            put( "account", RubinCore.this.safeString(sender, "address") );
            put( "referenceAccount", RubinCore.this.safeString(recipient, "address") );
            put( "referenceId", RubinCore.this.safeString(item, "transactionHash") );
            put( "type", RubinCore.this.parseLedgerEntryType(finalType) );
            put( "currency", code );
            put( "amount", RubinCore.this.parseNumber(amount) );
            put( "timestamp", timestamp );
            put( "datetime", RubinCore.this.iso8601(timestamp) );
            put( "before", null );
            put( "after", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> estimateTxFee(Object message, Object memo, Object account)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object txBytes = this.encodeV4TxForSimulation(message, memo, Helpers.GetValue(account, "sequence"), Helpers.GetValue(account, "pub_key"));
            Object request = new java.util.HashMap<String, Object>() {{
                put( "txBytes", txBytes );
            }};
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(fromAccount, "main")))
            {
                ...
                payload = new java.util.HashMap<String, Object>() {{
                    put( "sender", RubinCore.this.getWalletAddress() );
                ...
                signingPayload = new java.util.HashMap<String, Object>() {{
                    put( "typeUrl", "/ritbit.sending.MsgDepositToSubaccount" );
            ...
            } else
            {
                ...
                signingPayload = new java.util.HashMap<String, Object>() {{
                    put( "typeUrl", "/ritbit.sending.MsgCreateTransfer" );
                    put( "value", finalPayload_2 );
                }};
            }
            Object txFee = (this.estimateTxFee(signingPayload, "", account)).join();
            Object chainName = Helpers.GetValue(this.options, "chainName");
            Object signedTx = this.signRubinTx(Helpers.GetValue(credentials, "privateKey"), signingPayload, "", chainName, account, null, txFee);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "tx", signedTx );
            }};
            // nodeRpcGetBroadcastTxAsync
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "tagTo", null );
            put( "tagFrom", null );
            put( "type", RubinCore.this.safeStringLower(transaction, "type") );
            put( "amount", amount );
            put( "currency", code );
            put( "status", null );
            put( "updated", null );
    ...
    public java.util.concurrent.CompletableFuture<Object> withdraw(Object code2, Object amount, Object address, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object signingPayload = new java.util.HashMap<String, Object>() {{
                put( "typeUrl", "/ritbit.sending.MsgWithdrawFromSubaccount" );
                put( "value", payload );
            }};
            Object txFee = (this.estimateTxFee(signingPayload, tag, account)).join();
            Object chainName = Helpers.GetValue(this.options, "chainName");
            Object signedTx = this.signRubinTx(Helpers.GetValue(credentials, "privateKey"), signingPayload, tag, chainName, account, null, txFee);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "tx", signedTx );
            }};
            // nodeRpcGetBroadcastTxAsync
    ...
    public Object getWalletAddress()
    {
        ...
        {
            // return rubinAccount;
            Object wallet = this.safeString(rubinAccount, "address");
            if (Helpers.isTrue(!Helpers.isEqual(wallet, null)))
            {
                return wallet;
            }
        }
        throw new ArgumentsRequired((String)Helpers.add(this.id, " getWalletAddress() requires a wallet address. Set `walletAddress` or `rubinAccount` in exchange options.")) ;
    }
    ...
    public void setSandboxMode(Object enable)
    {
        ...
        Helpers.addElementToObject(this.options, "chainName", "ritbit-testnet");
