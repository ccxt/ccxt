...
public class Bitbns extends BitbnsApi
{
   ...
   public Bitbns (Object options) {
    ...
    public CompletableFuture<List<Order>> fetchOpenOrders(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "symbol", ((Map<String, Object>)market).get("uppercaseId") );
                put( "page", 0 );
                put( "side", (((java.util.Objects.equals(finalIsTrigger, true)))) ? (Helpers.add(finalQuoteSide, "StopOrders")) : (Helpers.add(finalQuoteSide, "Orders")) );
            }};
    ...
    public Object parseTrade(Object trade, Object... optionalArgs)
    {
        ...
        if (!java.util.Objects.equals(side, null))
        {
            if (Helpers.isGreaterThanOrEqual(((String)side).indexOf("buy"), 0))
            {
                side = "buy";
            } else if (Helpers.isGreaterThanOrEqual(((String)side).indexOf("sell"), 0))
            {
                side = "sell";
            }
        }
    ...
    public Object parseTransaction(Object transaction, Object... optionalArgs)
    {
        ...
        {
            if (Helpers.isGreaterThanOrEqual(((String)type).indexOf("deposit"), 0))
            {
                type = "deposit";
                status = "ok";
            } else if (Helpers.isGreaterThanOrEqual(((String)type).indexOf("withdraw"), 0) || Helpers.isGreaterThanOrEqual(((String)expTime).indexOf("withdraw"), 0))
            {
                type = "withdrawal";
            }
        }
