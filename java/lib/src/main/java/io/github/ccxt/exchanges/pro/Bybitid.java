...
public class Bybitid extends io.github.ccxt.exchanges.Bybitid
{
   public Bybitid () {
       super();
   }
                ...
                put( "api", new HashMap<String, Object>() {{
                    put( "ws", new HashMap<String, Object>() {{
                        ...
                        put( "private", new HashMap<String, Object>() {{
                            ...
                            put( "trade", "wss://stream.{hostname}/v5/trade" );
                        }} );
                    }} );
                }} );
                put( "test", new HashMap<String, Object>() {{
                    put( "ws", new HashMap<String, Object>() {{
                        ...
                        put( "private", new HashMap<String, Object>() {{
                            ...
                            put( "trade", "wss://stream-testnet.{hostname}/v5/trade" );
                        }} );
                    }} );
                }} );
                put( "demotrading", new HashMap<String, Object>() {{
                    put( "ws", new HashMap<String, Object>() {{
                        ...
                        put( "private", new HashMap<String, Object>() {{
                            ...
                            put( "trade", "wss://stream-demo.{hostname}/v5/trade" );
                        }} );
                    }} );
                }} );
            }} );
