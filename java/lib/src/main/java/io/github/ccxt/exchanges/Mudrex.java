   ...
   public Mudrex (Object options) {
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object assetPair = Helpers.add(Helpers.add(((Map<String, Object>)market).get("baseId"), "/"), ((Map<String, Object>)market).get("quoteId"));
    ...
    public CompletableFuture<Tickers> fetchTickers(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object rows = ((Helpers.isTrue((data instanceof List)))) ? data : this.safeList(data, "items", new ArrayList<Object>(Arrays.asList()));
    ...
    public CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            while (java.util.Objects.equals(paging, true))
            {
                ...
                if ((data instanceof Map) && !Helpers.isTrue((data instanceof List)))
                {
