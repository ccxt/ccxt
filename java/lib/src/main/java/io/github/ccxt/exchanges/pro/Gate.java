...
public class Gate extends io.github.ccxt.exchanges.Gate
{
   ...
   public Gate (Object options) {
    ...
    public void handleNewSpotOrderBook(Client client, Object message)
    {
        ...
        List<Object> marketIdParts = (List<Object>) Helpers.split(marketIdWithPrefix, ".");
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(result)); i++)
        {
            ...
            List<Object> parts = (List<Object>) Helpers.split(subscription, "_");
    ...
    public Object getMarketTypeByUrl(Object url)
    {
        ...
        List<Object> keys = Helpers.objectKeys(findBy);
        for (var i = 0; i < ((List<?>)keys).size(); i++)
        {
