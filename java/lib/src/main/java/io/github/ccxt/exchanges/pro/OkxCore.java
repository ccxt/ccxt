    ...
    public Object handleOrderBookMessage(Client client, Object message, Object orderbook, Object messageHash, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(checksum))
        {
            ...
            for (var i = 0; Helpers.isLessThan(i, 25); i++)
            {
                ...
                {
                    ((java.util.List<Object>)payloadArray).add(this.numberToString(Helpers.GetValue(Helpers.GetValue(storedBids, i), 0)));
                    ((java.util.List<Object>)payloadArray).add(this.numberToString(Helpers.GetValue(Helpers.GetValue(storedBids, i), 1)));
                }
                if (Helpers.isTrue(Helpers.isLessThan(i, asksLength)))
                {
                    ((java.util.List<Object>)payloadArray).add(this.numberToString(Helpers.GetValue(Helpers.GetValue(storedAsks, i), 0)));
                    ((java.util.List<Object>)payloadArray).add(this.numberToString(Helpers.GetValue(Helpers.GetValue(storedAsks, i), 1)));
                }
            }
            ...
            Object error = null;
            if (Helpers.isTrue(Helpers.isTrue(!Helpers.isEqual(prevSeqId, Helpers.opNeg(1))) && Helpers.isTrue(!Helpers.isEqual(nonce, prevSeqId))))
            {
            ...
            {
                error = new ChecksumError(Helpers.add(Helpers.add(this.id, " "), this.orderbookChecksumMessage(symbol)));
            }
