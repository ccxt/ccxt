...
public class Zebpay extends ZebpayApi
{
   ...
   public Zebpay (Object options) {
    ...
    public Object parseCurrency(Object rawCurrency)
    {
        ...
        for (var j = 0; j < ((List<?>)chains).size(); j++)
        {
            ...
            if (!java.util.Objects.equals(networkCode, null))
            {
                ...
                final String finalMinNetworkDepositString = minNetworkDepositString;
    ...
    put( "limits", new HashMap<String, Object>() {{
        ...
        final String finalMinWithdrawFeeString = minWithdrawFeeString;
        final String finalMinWithdrawString = minWithdrawString;
        final String finalMinDepositString = minDepositString;
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(Object symbol, Object timeframe, Long since2, Long limit2, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            parameters = (Map<String, Object>) this.omit(parameters, new ArrayList<Object>(Arrays.asList("until", "endtime", "endTime", "interval", "startTime")));
            Map<String, Object> response = null;
            if (java.util.Objects.equals(((Map<String, Object>)market).get("spot"), true))
            {
                if (java.util.Objects.equals(limit, null))
                ...
                parameters = (Map<String, Object>) this.omit(parameters, "priceType");
    ...
    public Object orderRequest(Object symbol, Object type, Object amount, Map<String, Object> request, Object price, Map<String, Object> parameters)
    {
        ...
        parameters = (Map<String, Object>) (this.omit(parameters, new ArrayList<Object>(Arrays.asList("stopLossPrice", "cost", "timeInForce", "clientOrderId"))));
        ...
        if (java.util.Objects.equals(upperCaseType, "MARKET"))
        {
            ...
            request.put("quoteOrderAmount", this.costToPrecision(symbol, quoteOrderQty));
        } else
        {
            if (!java.util.Objects.equals(triggerPrice, null))
            {
                request.put("stopLossPrice", this.priceToPrecision(symbol, triggerPrice));
            }
    ...
    {
        return this.orderRequest(symbol, type, amount, request, optionalArgs != null && optionalArgs.length > 0 ? optionalArgs[0] : null, Helpers.getArgMap(optionalArgs, 1, new HashMap<String, Object>() {{}}));
    }
    ...
    public Object sign(Object path, Object api, Object method, Object parameters, Object headers, String body)
    {
        ...
        if (java.util.Objects.equals(access, "public"))
        {
            ...
            } else
            {
                ...
                {
                    url = (url + ("?" + this.urlencode(new HashMap<String, Object>() {{
    put( "priceType", priceType );
}})));
                }
                body = (String) (Helpers.json(parameters));
