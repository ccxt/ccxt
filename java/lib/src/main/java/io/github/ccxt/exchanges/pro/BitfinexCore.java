   ...
   public BitfinexCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> unSubscribe(Object channel2, Object topic, Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) Helpers.add(Helpers.add(Helpers.add("unsubscribe:", channel), ":"), marketId);
            String unSubTopic = Helpers.add(Helpers.add(Helpers.add(Helpers.add("unsubscribe", ":"), topic), ":"), symbol);
            String channelId = (String) this.safeString(client.subscriptions, unSubTopic);
            java.util.Map<String, Object> request = new java.util.HashMap<String, Object>() {{
                put( "event", "unsubscribe" );
                put( "chanId", channelId );
            }};
            String unSubChanMsg = Helpers.add("unsubscribe:", channelId);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String key = Helpers.add(Helpers.add(Helpers.add("trade:", interval), ":"), Helpers.GetValue(market, "id"));
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.GetValue(Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws"), "public");
            Client client = this.client(url);
            String subId = Helpers.add(Helpers.add(Helpers.add("unsubscribe:trade:", interval), ":"), Helpers.GetValue(market, "id")); // trade here because we use the key
            String channelId = (String) this.safeString(client.subscriptions, subId);
            java.util.Map<String, Object> request = new java.util.HashMap<String, Object>() {{
                put( "event", "unsubscribe" );
                put( "chanId", channelId );
            }};
    ...
    public void handleOHLCV(Client client, Object message, Object subscription)
    {
        ...
        String key = (String) this.safeString(subscription, "key", "");
        java.util.List<Object> keyParts = (java.util.List<Object>) Helpers.split(key, ":");
        String interval = (String) this.safeString(keyParts, 1);
        Object marketId = key;
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) "myTrade";
    ...
    public void handleTrades(Client client, Object message, Object subscription)
    {
        ...
        //
        Object channel = this.safeValue(subscription, "channel");
        String marketId = (String) this.safeString(subscription, "symbol");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object messageHash = Helpers.add(Helpers.add(channel, ":"), marketId);
        ...
        {
            // initial snapshot
            java.util.List<Object> trades = (java.util.List<Object>) this.safeList(message, 1, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        {
            // update
            String type = (String) this.safeString(message, 1);
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        String type = (String) this.safeString(trade, 6);
        ...
        String price = (String) this.safeString(trade, priceKey);
        String amountString = (String) this.safeString(trade, amountKey);
        ...
        String feeValue = (String) this.safeString(trade, 9);
        Object fee = null;
        if (Helpers.isTrue(!Helpers.isEqual(feeValue, null)))
        {
            String currencyId = (String) this.safeString(trade, 10);
    ...
    public Object parseWsTicker(Object ticker, Object... optionalArgs)
    {
        ...
        Object symbol = Helpers.GetValue(market, "symbol");
        String last = (String) this.safeString(ticker, 6);
        String change = (String) this.safeString(ticker, 4);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String prec = (String) this.safeString(options, "prec", "P0");
            String freq = (String) this.safeString(options, "freq", "F0");
            java.util.Map<String, Object> request = new java.util.HashMap<String, Object>() {{
                put( "prec", prec );
                put( "freq", freq );
            }};
    ...
    public void handleOrderBook(Client client, Object message, Object subscription)
    {
        ...
        String channel = "book";
        Object messageHash = Helpers.add(Helpers.add(channel, ":"), marketId);
        String prec = (String) this.safeString(subscription, "prec", "P0");
        ...
        if (!Helpers.isTrue((Helpers.inOp(this.orderbooks, symbol))))
        {
            ...
            if (Helpers.isTrue(isRaw))
            {
                ...
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(deltas)); i++)
                {
                    ...
                    String idString = (String) this.safeString(delta, 0);
        ...
        } else
        {
            ...
            if (Helpers.isTrue(isRaw))
            {
                String price = (String) this.safeString(deltas, 1);
                ...
                String idString = (String) this.safeString(deltas, 0);
            ...
            {
                String amount = (String) this.safeString(deltas, 2);
                String counter = (String) this.safeString(deltas, 1);
                String price = (String) this.safeString(deltas, 0);
    ...
    public void handleChecksum(Client client, Object message, Object subscription)
    {
        ...
        String channel = "book";
        Object messageHash = Helpers.add(Helpers.add(channel, ":"), marketId);
        io.github.ccxt.ws.WsOrderBook book = (io.github.ccxt.ws.WsOrderBook) this.safeValue(this.orderbooks, symbol);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String balanceType = (String) this.safeString(parameters, "wallet", "exchange"); // exchange, margin
            parameters = this.omit(parameters, "wallet");
            String messageHash = (String) Helpers.add("balance:", balanceType);
    ...
    public void handleBalance(Client client, Object message, Object subscription)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
        {
            ...
            String currencyId = (String) this.safeString(rawBalance, 1);
            String code = (String) this.safeCurrencyCode(currencyId);
            Object balance = this.parseWsBalance(rawBalance);
            String balanceType = (String) this.safeString(rawBalance, 0);
            java.util.Map<String, Object> oldBalance = (java.util.Map<String, Object>) this.safeDict(this.balance, balanceType, new java.util.HashMap<String, Object>() {{}});
    ...
    public Object parseWsBalance(Object balance)
    {
        ...
        //     ]
        //
        String totalBalance = (String) this.safeString(balance, 2);
        String availableBalance = (String) this.safeString(balance, 4);
    ...
    public Object handleUnsubscriptionStatus(Client client, Object message)
    {
        ...
        // }
        //
        String channelId = (String) this.safeString(message, "chanId");
        Object unSubChannel = Helpers.add("unsubscribe:", channelId);
        String subMessageHash = (String) this.safeString(client.subscriptions, unSubChannel);
        java.util.Map<String, Object> subscription = (java.util.Map<String, Object>) this.safeDict(client.subscriptions, Helpers.add("unsubscribe:", subMessageHash));
    ...
    public Object handleSubscriptionStatus(Client client, Object message)
    {
        ...
        String unifiedChannel = (String) this.safeString(mappings, this.safeString(message, "channel"));
        if (Helpers.isTrue(Helpers.inOp(message, "key")))
        {
            // handle ohlcv differently because the message is different
            String key = (String) this.safeString(message, "key");
            String subKeyId = Helpers.add("unsubscribe:", key);
        ...
        } else
        {
            ...
            {
                String subId = Helpers.add(Helpers.add(Helpers.add("unsubscribe:", unifiedChannel), ":"), symbol);
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(authenticated, null)))
            {
                ...
                String payload = Helpers.add("AUTH", String.valueOf(nonce));
    ...
    public void handleOrders(Client client, Object message, Object subscription)
    {
        ...
        //    ]
        //
        java.util.List<Object> data = (java.util.List<Object>) this.safeList(message, 2, new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        String messageType = (String) this.safeString(message, 1);
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String id = (String) this.safeString(order, 0);
        String clientOrderId = (String) this.safeString(order, 1);
        String marketId = (String) this.safeString(order, 3);
        String symbol = (String) this.safeSymbol(marketId);
        market = this.safeMarket(symbol);
        String amount = (String) this.safeString(order, 7);
        String side = "buy";
        ...
        String type = (String) this.safeString(order, 8, "");
        if (Helpers.isTrue(Helpers.isGreaterThan(Helpers.getIndexOf(type, "LIMIT"), Helpers.opNeg(1))))
        {
            type = "limit";
        } else if (Helpers.isTrue(Helpers.isGreaterThan(Helpers.getIndexOf(type, "MARKET"), Helpers.opNeg(1))))
        ...
        String rawState = (String) this.safeString(order, 13, "");
        java.util.List<Object> stateParts = (java.util.List<Object>) Helpers.split(rawState, " ");
        String trimmedStatus = (String) this.safeString(stateParts, 0);
        String status = (String) this.parseWsOrderStatus(trimmedStatus);
        String price = (String) this.safeString(order, 16);
        Long timestamp = (Long) this.safeInteger2(order, 5, 4);
        String average = (String) this.safeString(order, 17);
    ...
    {
        String channelId = (String) this.safeString(message, 0);
        //
        //     [
        //         1231,
        //         "hb",
        ...
        if (Helpers.isTrue(Helpers.isArray(message)))
        {
            ...
            String channel = (String) this.safeString(subscription, "channel");
            String name = (String) this.safeString(message, 1);
