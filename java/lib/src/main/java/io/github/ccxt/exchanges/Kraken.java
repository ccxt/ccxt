   ...
   public Kraken (Object options) {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)keys).size(); i++)
            {
                ...
                ((List<Object>)result).add(Helpers.newMap(
                    ...
                    "type", "spot",
                    "spot", spot,
                    "margin", (Helpers.isGreaterThan(leverageBuyLength, 0)),
                    "swap", false,
                    "future", false,
                    "option", false,
                    "active", isActive,
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(Object symbol, Object timeframe, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                return (this.fetchPaginatedCallDeterministic("fetchOHLCV", Helpers.toStringArg(symbol), since, limit, Helpers.toStringArg(java.util.Objects.requireNonNullElse(timeframe, "1m")), Helpers.toMapArg(paramsPaginate), Helpers.toLongOrNull(720))).join();
            }
            Map<String, Object> market = (Map<String, Object>) this.market(symbol);
    ...
    public Object getDelistedMarketById(Object id)
    {
        ...
        Object market = this.safeValue(((Map<String, Object>)this.options).get("delistedMarketsById"), id);
    ...
    public CompletableFuture<Transaction> withdraw(String code, Object amount, String address, String tag, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> paramsWithdrawTag = (Map<String, Object>) Helpers.GetValue(tagAndParams, 1);
