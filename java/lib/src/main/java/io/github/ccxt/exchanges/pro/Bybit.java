   ...
   public Bybit (Object options) {
    ...
    public CompletableFuture<Object> getUrlByMarketType(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object method = optionalArgs != null && optionalArgs.length > 2 ? optionalArgs[2] : null;
    ...
    public CompletableFuture<Order> createOrderWs(String symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            return (this.watch((String) (url), (String) (requestId), request, requestId, true)).join();
        }).thenApply(Order::new);
    ...
    public CompletableFuture<Tickers> watchTickers(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            symbols = (List<String>)(this.marketSymbols(symbols, (String) (null), false));
    ...
    public CompletableFuture<Object> watchOHLCVForSymbols(Object symbolsAndTimeframes, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)symbolsAndTimeframes).size(); i++)
            {
                ...
                Map<String, Object> market = (Map<String, Object>) this.market((String) ((data == null || 0 >= ((List<?>)data).size() ? null : ((List<?>)data).get(0))));
    ...
    public void handleMyTrades(Client client, Map<String, Object> message)
    {
        ...
        for (var i = 0; i < ((List<?>)data).size(); i++)
        {
            ...
            } else
            {
                ...
                parsed = this.parseTrade((Map<String, Object>) (rawTrade));
            }
    ...
    public void handleOrder(Client client, Map<String, Object> message)
    {
        ...
        {
            Map<String, Object> parsed = (Map<String, Object>) this.parseOrder((Map<String, Object>) (Helpers.GetValue(rawOrders, i)));
            // if (isSpot) {
    ...
    public CompletableFuture<Object> unWatchTopics(Object url, Object topic, Object symbols, Object messageHashes, Object subMessageHashes, Object topics, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object parameters = optionalArgs != null && optionalArgs.length > 0 ? optionalArgs[0] : new HashMap<String, Object>() {{}};
            Object subExtension = optionalArgs != null && optionalArgs.length > 1 ? optionalArgs[1] : new HashMap<String, Object>() {{}};
            Object reqId = this.requestId();
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "op", "unsubscribe" );
                put( "req_id", reqId );
