...
public class Coinex extends CoinexApi
{
   ...
   public Coinex (Object options) {
    ...
    public Object parseCurrency(Map<String, Object> coin)
    {
    ...
    public Object parseTicker(Map<String, Object> ticker, Object... optionalArgs)
    {
        ...
        String marketType = (((ticker.containsKey("mark_price")))) ? "swap" : "spot";
    ...
    public CompletableFuture<OrderBook> fetchOrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            return this.parseOrderBook(depth, (String) (symbol), timestamp);
    ...
    public Object createOrderRequest(String symbol, String type, String side, Object amount, Object... optionalArgs)
    {
        ...
        if (java.util.Objects.equals(swap, true))
        {
            ...
            if ((!java.util.Objects.equals(stopLossPrice, null) && !java.util.Objects.equals(stopLossPrice, "")) || (!java.util.Objects.equals(takeProfitPrice, null) && !java.util.Objects.equals(takeProfitPrice, "")))
            {
                ...
                {
                    ((Map<String, Object>)request).put("stop_loss_price", this.priceToPrecision((String) (symbol), stopLossPrice));
                ...
                {
                    ((Map<String, Object>)request).put("take_profit_price", this.priceToPrecision((String) (symbol), takeProfitPrice));
            ...
            if ((java.util.Objects.equals(type, "market")) && (java.util.Objects.equals(side, "buy")))
            {
                ...
                if (Boolean.TRUE.equals(createMarketBuyOrderRequiresPrice))
                {
                    ...
                    } else
                    {
                        ...
                        ((Map<String, Object>)request).put("amount", this.costToPrecision((String) (symbol), costRequest));
                    }
                } else
                {
                    ((Map<String, Object>)request).put("amount", this.costToPrecision((String) (symbol), amount));
                }
            } else
            {
                ((Map<String, Object>)request).put("amount", this.amountToPrecision((String) (symbol), amount));
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)data).size(); i++)
            {
                ...
                if ((java.util.Objects.equals(((Map<String, Object>)market).get("spot"), true)) && !Boolean.TRUE.equals(isTriggerOrder))
                {
                    ...
                    order = this.parseOrder((Map<String, Object>) (entry), market);
                } else
                {
                    ((Map<String, Object>)innerData).put("status", status);
                    order = this.parseOrder((Map<String, Object>) (innerData), market);
                }
    ...
    public CompletableFuture<List<Order>> cancelOrders(Object ids, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)data).size(); i++)
            {
                ...
                Map<String, Object> order = (Map<String, Object>) this.parseOrder((Map<String, Object>) (item), market);
                ((List<Object>)results).add(order);
            }
            return results;
        }).thenApply(res -> ((List<?>) res).stream().map(Order::new).collect(Collectors.toList()));
    ...
    public CompletableFuture<List<Order>> editOrders(Object orders, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            orderSymbols = this.marketSymbols(orderSymbols, (String) (null), false, true, true);
            ...
            for (var i = 0; i < ((List<?>)data).size(); i++)
            {
                ...
                Map<String, Object> item = (Map<String, Object>) this.safeDict(entry, "data", new HashMap<String, Object>() {{}});
                Map<String, Object> order = (Map<String, Object>) this.parseOrder((Map<String, Object>) (item));
    ...
    public CompletableFuture<Position> fetchPosition(Object symbol, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            //
            List<Object> data = (List<Object>) this.safeList(response, "data", new ArrayList<Object>(Arrays.asList()));
            return this.parsePosition((Map<String, Object>) ((data == null || 0 >= ((List<?>)data).size() ? null : ((List<?>)data).get(0))), market);
...
final Object finalI = i;
    ...
    public CompletableFuture<Object> modifyMarginHelper(String symbol, Object amount, String addOrReduce2, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> market = (Map<String, Object>) this.market((String) (symbol));
            Object rawAmount = this.amountToPrecision((String) (symbol), amount);
    ...
    public CompletableFuture<TransferEntry> transfer(String code, Object amount, Object fromAccount2, Object toAccount2, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            return this.extend(this.parseTransfer((Map<String, Object>) (response), currency), new HashMap<String, Object>() {{
    ...
    public CompletableFuture<IsolatedBorrowRate> fetchIsolatedBorrowRate(String symbol, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            //
            Map<String, Object> data = (Map<String, Object>) this.safeDict(response, "data", new HashMap<String, Object>() {{}});
            return this.parseIsolatedBorrowRate((Map<String, Object>) (data), market);
