...
public class Bitmex extends BitmexApi
{
   ...
   public Bitmex (Object options) {
    ...
    public Object convertFromRawQuantity(String symbol, String rawQuantity, String currencySide)
    {
    ...
    {
        return this.convertFromRawQuantity(symbol, rawQuantity, Helpers.getArgString(optionalArgs, 0, "base"));
    }
    ...
    public Object parseMarket(Object market)
    {
        ...
        Boolean linear = ((Boolean.TRUE.equals(contract))) ? ((!java.util.Objects.equals(isInverse, true)) && (!java.util.Objects.equals(isQuanto, true))) : null;
    ...
    public CompletableFuture<Order> fetchOrder(Object id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Order> response = (this.fetchOrders((Object)(symbol), (Object)(null), (Object)(null), (Object)(this.deepExtend(filter, parameters)))).join();
            Integer numResults = ((List<?>)response).size();
    ...
    public CompletableFuture<Order> createOrder(Object symbol, String type2, String side2, Object amount, Object price, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            parameters = (Map<String, Object>) this.omit(parameters, new ArrayList<Object>(Arrays.asList("reduceOnly", "postOnly")));
            ...
            Integer execInstLength = ((List<?>)execInstructions).size();
            ...
            if (Boolean.TRUE.equals(isTriggerOrder) || Boolean.TRUE.equals(isTrailingAmountOrder))
            {
                ...
                parameters = (Map<String, Object>) this.omit(parameters, new ArrayList<Object>(Arrays.asList("triggerPrice", "stopPrice", "stopPx", "triggerDirection", "trailingAmount")));
            }
    ...
    public CompletableFuture<Order> editOrder(String id, String symbol, String type2, String side2, Object amount2, Object price2, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (Boolean.TRUE.equals(isTrailingAmountOrder))
            {
                ...
                ((Map<String, Object>)request).put("pegOffsetValue", this.parseToNumeric(trailingAmount));
                parameters = (Map<String, Object>) this.omit(parameters, new ArrayList<Object>(Arrays.asList("triggerDirection", "trailingAmount")));
            }
            ...
            if (!java.util.Objects.equals(origClOrdID, null))
            {
                ...
                parameters = (Map<String, Object>) this.omit(parameters, new ArrayList<Object>(Arrays.asList("origClOrdID", "clOrdID", "clientOrderId")));
            } else
            {
    ...
    public CompletableFuture<Leverages> fetchLeverages(List<String> symbols, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Position> leverages = (this.fetchPositions((Object)(symbols), (Object)(parameters))).join();
    ...
    public CompletableFuture<List<FundingRateHistory>> fetchFundingRateHistory(String symbol2, Long since2, Long limit2, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                List<Object> splitSymbol = new ArrayList<Object>(Arrays.asList(((String)symbol).split(java.util.regex.Pattern.quote(":"))));
                Integer splitSymbolLength = ((List<?>)splitSymbol).size();
    ...
    public CompletableFuture<Object> setMarginMode(String marginMode2, String symbol2, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Boolean enabled = (((java.util.Objects.equals(marginMode, "cross")))) ? false : true;
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "symbol", ((Map<String, Object>)market).get("id") );
                put( "enabled", enabled );
            }};
    ...
    public Object parseDepositWithdrawFee(Object fee, Map<String, Object> currency)
    {
        ...
        Integer networksLength = ((List<?>)networks).size();
        Map<String, Object> result = new HashMap<String, Object>() {{
            put( "info", fee );
            put( "withdraw", new HashMap<String, Object>() {{
                put( "fee", null );
    ...
    public Object parseSettlements(Object settlements, Map<String, Object> market, Long since, Long limit)
    {
    ...
    {
        return this.parseSettlements(settlements, Helpers.getArgMap(optionalArgs, 0, null), Helpers.getArgLong(optionalArgs, 1, null), Helpers.getArgLong(optionalArgs, 2, null));
    }
