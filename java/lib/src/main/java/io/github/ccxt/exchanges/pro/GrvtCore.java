...
public class GrvtCore extends io.github.ccxt.exchanges.Grvt
{
   ...
   public GrvtCore (Object options) {
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        String channel = (String) this.safeString(message, "stream");
    ...
    public void handleTicker(Client client, Object message)
    {
        ...
        //    }
        //
        java.util.Map<String, Object> data = (java.util.Map<String, Object>) this.safeDict(message, "feed", new java.util.HashMap<String, Object>() {{}});
        String selector = (String) this.safeString(message, "selector", "");
        java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(selector, "@");
        String marketId = (String) this.safeString(parts, 0);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCVForSymbols(Object symbolsAndTimeframes, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbolsAndTimeframes)); i++)
            {
                ...
                String symbolString = (String) this.safeString(data, 0);
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        String timeframeId = (String) Helpers.replace((String)secondPart, (String)"-TRADE", (String)"");
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                String accountId = (String) this.safeString(this.options, "AuthAccountId");
                String cookieValue = (String) this.safeString(this.options, "AuthCookieValue");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String subAccountId = (String) this.getSubAccountId(parameters);
            java.util.List<Object> messageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            java.util.List<Object> rawHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
    ...
    public void handlePosition(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> data = (java.util.Map<String, Object>) this.safeDict(message, "feed");
    ...
    public Object handleErrorMessage(Client client, Object response)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(errorCode, null)))
        {
            ...
            String message = (String) this.safeString(error, "message");
