   ...
   public DeriveCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String topic = Helpers.add(Helpers.add(Helpers.add("orderbook.", Helpers.GetValue(market, "id")), ".10."), this.numberToString(limit));
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> data = (java.util.Map<String, Object>) this.safeDict(parameters, "data", new java.util.HashMap<String, Object>() {{}});
        String marketId = (String) this.safeString(data, "instrument_name");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object symbol = Helpers.GetValue(market, "symbol");
        String topic = (String) this.safeString(parameters, "channel");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            String topic = Helpers.add(Helpers.add("ticker_slim.", Helpers.GetValue(market, "id")), ".100"); // the venue deprecated the fat ticker channel in favor of ticker_slim
            Object request = new java.util.HashMap<String, Object>() {{
                put( "method", "subscribe" );
                put( "params", new java.util.HashMap<String, Object>() {{
                    put( "channels", new java.util.ArrayList<Object>(java.util.Arrays.asList(topic)) );
    ...
    public Object handleTicker(Client client, Object message)
    {
        ...
        //
        java.util.Map<String, Object> parameters = (java.util.Map<String, Object>) this.safeDict(message, "params");
        java.util.Map<String, Object> rawData = (java.util.Map<String, Object>) this.safeDict(parameters, "data");
        java.util.Map<String, Object> data = (java.util.Map<String, Object>) this.safeDict(rawData, "instrument_ticker", new java.util.HashMap<String, Object>() {{}});
        String topic = (String) this.safeString(parameters, "channel");
        java.util.Map<String, Object> ticker = null;
        if (Helpers.isTrue(Helpers.isTrue(!Helpers.isEqual(topic, null)) && Helpers.isTrue(((String)topic).startsWith(((String)"ticker_slim")))))
        {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
            java.util.Map<String, Object> stats = (java.util.Map<String, Object>) this.safeDict(data, "stats", new java.util.HashMap<String, Object>() {{}});
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTrades(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHah = Helpers.add("unwatch", topic);
            Object request = new java.util.HashMap<String, Object>() {{
                put( "method", "unsubscribe" );
                put( "params", new java.util.HashMap<String, Object>() {{
                    put( "channels", new java.util.ArrayList<Object>(java.util.Arrays.asList(topic)) );
    ...
    public void handleOrderBookUnSubscription(Client client, Object topic)
    {
        ...
        String marketId = (String) this.safeString(parsedTopic, 1);
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object symbol = Helpers.GetValue(market, "symbol");
        if (Helpers.isTrue(Helpers.inOp(this.orderbooks, symbol)))
        {
    ...
    public Object handleUnSubscribe(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> status = (java.util.Map<String, Object>) this.safeDict(result, "status");
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(authenticated, null)))
            {
                ...
                String deriveWalletAddress = (String) this.safeString(this.options, "deriveWalletAddress");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String topic = Helpers.add(this.numberToString(subaccountId), ".orders");
    ...
    public void handleOrder(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> parameters = (java.util.Map<String, Object>) this.safeDict(message, "params");
        String topic = (String) this.safeString(parameters, "channel");
        java.util.List<Object> rawOrders = (java.util.List<Object>) this.safeList(parameters, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawOrders)); i++)
        {
            Object data = Helpers.GetValue(rawOrders, i);
            java.util.Map<String, Object> parsed = this.parseOrder(data);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            subaccountId = ((java.util.List<Object>) subaccountIdparametersVariable).get(0);
            parameters = ((java.util.List<Object>) subaccountIdparametersVariable).get(1);
            String topic = Helpers.add(this.numberToString(subaccountId), ".trades");
            String messageHash = topic;
            if (Helpers.isTrue(!Helpers.isEqual(symbol, null)))
            {
                java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
    ...
    public void handleMyTrade(Client client, Object message)
    {
        ...
        java.util.List<Object> rawTrades = (java.util.List<Object>) this.safeList(parameters, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public Object handleErrorMessage(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> errorMessage = (java.util.Map<String, Object>) this.safeDict(message, "error");
        String errorCode = (String) this.safeString(errorMessage, "code");
        try
        {
    ...
    public void handleAuth(Client client, Object message)
    {
        ...
        //
        String messageHash = (String) "authenticated";
        java.util.List<Object> ids = (java.util.List<Object>) this.safeList(message, "result", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
