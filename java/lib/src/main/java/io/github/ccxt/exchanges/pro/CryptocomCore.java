...
public class CryptocomCore extends io.github.ccxt.exchanges.Cryptocom
{
   ...
   public CryptocomCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
            {
                ...
                String currentTopic = Helpers.add(Helpers.add(Helpers.add(Helpers.add("book", "."), Helpers.GetValue(market, "id")), "."), String.valueOf(limit));
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        //    }
        //
        String marketId = (String) this.safeString(message, "instrument_name");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
            {
                Object symbol = Helpers.GetValue(symbols, i);
                java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
                String currentTopic = Helpers.add(Helpers.add("trade", "."), Helpers.GetValue(market, "id"));
                ((java.util.List<Object>)topics).add(currentTopic);
            }
    ...
    public void handleTrades(Client client, Object message)
    {
        ...
        String marketId = (String) this.safeString(message, "instrument_name");
        String symbolSpecificMessageHash = (String) this.safeString(message, "subscription");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object symbol = Helpers.GetValue(market, "symbol");
        ...
        String channelReplaced = (String) Helpers.replace((String)channel, (String)Helpers.add(".", marketId), (String)"");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) "user.trade";
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTicker(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            String subMessageHash = Helpers.add(Helpers.add("ticker", "."), Helpers.GetValue(market, "id"));
    ...
    public void handleTicker(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "subscription");
        String marketId = (String) this.safeString(message, "instrument_name");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        java.util.List<Object> data = (java.util.List<Object>) this.safeList(message, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public Object parseWsTicker(Object ticker, Object... optionalArgs)
    {
        ...
        String marketId = (String) this.safeString(ticker, "i");
        market = this.safeMarket(marketId, market, "_");
        String quote = (String) this.safeString(market, "quote");
        String last = (String) this.safeString(ticker, "a");
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            symbol = Helpers.GetValue(market, "symbol");
            String interval = (String) this.safeString(this.timeframes, timeframe, timeframe);
            String subMessageHash = Helpers.add(Helpers.add(Helpers.add(Helpers.add("candlestick", "."), interval), "."), Helpers.GetValue(market, "id"));
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object symbol = Helpers.GetValue(market, "symbol");
        String interval = (String) this.safeString(message, "interval");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) "user.order";
            messageHash = ((Helpers.isTrue((!Helpers.isEqual(market, null))))) ? (Helpers.add(Helpers.add(messageHash, "."), Helpers.GetValue(market, "id"))) : messageHash;
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(positionBalances)); i++)
        {
            ...
            String currencyId = (String) this.safeString(balance, "instrument_name");
        ...
        String messageHashRequest = (String) this.safeString(message, "id");
    ...
    public void handleSubscribe(Client client, Object message)
    {
        ...
        String channel = (String) this.safeString(result, "channel");
