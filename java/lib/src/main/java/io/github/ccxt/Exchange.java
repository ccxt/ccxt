...
public Object describe()
    {
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "httpExceptions", new java.util.HashMap<String, Object>() {{
                put( "422", ExchangeError );
                put( "418", DDoSProtection );
                put( "429", RateLimitExceeded );
                put( "404", ExchangeNotAvailable );
                put( "409", ExchangeNotAvailable );
                put( "410", ExchangeNotAvailable );
                put( "451", ExchangeNotAvailable );
                put( "500", ExchangeNotAvailable );
                put( "501", ExchangeNotAvailable );
                put( "502", ExchangeNotAvailable );
                put( "520", ExchangeNotAvailable );
                put( "521", ExchangeNotAvailable );
                put( "522", ExchangeNotAvailable );
                put( "525", ExchangeNotAvailable );
                put( "526", ExchangeNotAvailable );
                put( "400", ExchangeNotAvailable );
                put( "403", ExchangeNotAvailable );
                put( "405", ExchangeNotAvailable );
                put( "503", ExchangeNotAvailable );
                put( "530", ExchangeNotAvailable );
                put( "408", RequestTimeout );
                put( "504", RequestTimeout );
                put( "401", AuthenticationError );
                put( "407", AuthenticationError );
                put( "511", AuthenticationError );
            }} );
    ...
    public Object safeNumberOmitZero(Object obj, Object key, Object... optionalArgs)
    {
        ...
        return ((Helpers.isTrue((Helpers.isEqual(final, null))))) ? defaultValue : final;
    }
    ...
    public Object safeLedgerEntry(Object entry, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            put( "id", this.safeString(entry, "id") );
            put( "timestamp", timestamp );
            put( "datetime", this.iso8601(timestamp) );
            put( "direction", direction );
            put( "account", this.safeString(entry, "account") );
            put( "referenceId", this.safeString(entry, "referenceId") );
            put( "referenceAccount", this.safeString(entry, "referenceAccount") );
            put( "type", this.safeString(entry, "type") );
            put( "currency", Helpers.GetValue(currency, "code") );
            put( "amount", this.parseNumber(amount) );
            put( "before", this.parseNumber(before) );
            put( "after", this.parseNumber(after) );
            put( "status", this.safeString(entry, "status") );
            put( "fee", fee );
            put( "info", info );
        }};
    }
    ...
    public Object setMarkets(Object markets, Object... optionalArgs)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketValues)); i++)
        {
            ...
            Object market = this.deepExtend(this.safeMarketStructure(), new java.util.HashMap<String, Object>() {{
                put( "precision", this.precision );
                put( "limits", this.limits );
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(values)); i++)
            {
                ...
                if (Helpers.isTrue(Helpers.inOp(market, "base")))
                {
                    Object currency = this.safeCurrencyStructure(new java.util.HashMap<String, Object>() {{
                        put( "id", this.safeString2(market, "baseId", "base") );
                        put( "numericId", this.safeInteger(market, "baseNumericId") );
                        put( "code", this.safeString(market, "base") );
                        put( "precision", this.safeValue2(marketPrecision, "base", "amount", defaultCurrencyPrecision) );
                    }});
                ...
                {
                    Object currency = this.safeCurrencyStructure(new java.util.HashMap<String, Object>() {{
                        put( "id", this.safeString2(market, "quoteId", "quote") );
                        put( "numericId", this.safeInteger(market, "quoteNumericId") );
                        put( "code", this.safeString(market, "quote") );
                        put( "precision", this.safeValue2(marketPrecision, "quote", "price", defaultCurrencyPrecision) );
                    }});
    ...
    public Object safeOrder(Object order, Object... optionalArgs)
    {
        ...
        return this.extend(order, new java.util.HashMap<String, Object>() {{
            put( "id", this.safeString(order, "id") );
            put( "clientOrderId", this.safeString(order, "clientOrderId") );
            put( "timestamp", timestamp );
            put( "datetime", datetime );
            put( "symbol", symbol );
            put( "type", this.safeString(order, "type") );
            put( "side", side );
            put( "lastTradeTimestamp", lastTradeTimeTimestamp );
            put( "lastUpdateTimestamp", lastUpdateTimestamp );
            put( "price", this.parseNumber(price) );
            put( "amount", this.parseNumber(amount) );
            put( "cost", this.parseNumber(cost) );
            put( "average", this.parseNumber(average) );
            put( "filled", this.parseNumber(filled) );
            put( "remaining", this.parseNumber(remaining) );
            put( "timeInForce", timeInForce );
            put( "postOnly", postOnly );
            put( "trades", trades );
            put( "reduceOnly", this.safeValue(order, "reduceOnly") );
            put( "stopPrice", triggerPrice );
            put( "triggerPrice", triggerPrice );
            put( "takeProfitPrice", takeProfitPrice );
            put( "stopLossPrice", stopLossPrice );
            put( "status", status );
            put( "fee", this.safeValue(order, "fee") );
        }});
    }
    ...
    public Object calculateFeeWithRate(Object symbol, Object type, Object side, Object amount, Object price, Object... optionalArgs)
    {
        ...
        return new java.util.HashMap<String, Object>() {{
            ...
            put( "rate", this.parseNumber(rate) );
            put( "cost", this.parseNumber(cost) );
        }};
    }
    ...
    public Object safeTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return this.extend(ticker, new java.util.HashMap<String, Object>() {{
            put( "bid", this.parseNumber(this.omitZero(this.safeString(ticker, "bid"))) );
            put( "bidVolume", this.safeNumber(ticker, "bidVolume") );
            put( "ask", this.parseNumber(this.omitZero(this.safeString(ticker, "ask"))) );
            put( "askVolume", this.safeNumber(ticker, "askVolume") );
            put( "high", this.parseNumber(this.omitZero(this.safeString(ticker, "high"))) );
            put( "low", this.parseNumber(this.omitZero(this.safeString(ticker, "low"))) );
            put( "open", this.parseNumber(this.omitZero(open)) );
            put( "close", closeParsed );
            put( "last", closeParsed );
            put( "change", this.parseNumber(change) );
            put( "percentage", this.parseNumber(percentage) );
            put( "average", this.parseNumber(average) );
            put( "vwap", this.parseNumber(vwap) );
            put( "baseVolume", this.parseNumber(baseVolume) );
            put( "quoteVolume", this.parseNumber(quoteVolume) );
            put( "previousClose", this.safeNumber(ticker, "previousClose") );
            put( "indexPrice", this.safeNumber(ticker, "indexPrice") );
            put( "markPrice", this.safeNumber(ticker, "markPrice") );
        }});
    }
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchL2OrderBook(Object symbol, Object... optionalArgs)
    {
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return this.extend(orderbook, new java.util.HashMap<String, Object>() {{
                put( "asks", this.sortBy(this.aggregate(Helpers.GetValue(orderbook, "asks")), 0) );
                put( "bids", this.sortBy(this.aggregate(Helpers.GetValue(orderbook, "bids")), 0, true) );
            }});
        });
    ...
    public Object selectNetworkKeyFromNetworks(Object currencyCode, Object networkCode, Object indexedNetworkEntries, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(networkCode, null)))
        {
            ...
            } else
            {
                ...
                {
                    throw new NotSupported(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(Helpers.add(this.id, " - "), networkIdOrCode), " network was not found for "), currencyCode), ", use one of "), String.join((String)", ", (java.util.List<String>)availableNetworkIds))) ;
                }
            }
        } else
        {
            ...
            } else
            {
                ...
                throw new NotSupported(Helpers.add(Helpers.add(this.id, " - can not determine the default network, please pass param[\"network\"] one from : "), String.join((String)", ", (java.util.List<String>)availableNetworkIds))) ;
            }
        }
    ...
    public Object parseOrderBook(Object orderbook, Object symbol, Object... optionalArgs)
    {
        ...
        return ((Object)new java.util.HashMap<String, Object>() {{
            put( "symbol", symbol );
            put( "bids", this.sortBy(bids, 0, true) );
            put( "asks", this.sortBy(asks, 0) );
            put( "timestamp", timestamp );
            put( "datetime", this.iso8601(timestamp) );
            put( "nonce", null );
        }});
    ...
    public Object buildOHLCVC(Object trades, Object... optionalArgs)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, oldest); i++)
        {
            ...
            Object isFirstCandle = Helpers.isEqual(candle, -(1));
            ...
            } else
            {
                ...
                Helpers.addElementToObject(Helpers.GetValue(ohlcvs, candle), i_high, mathMax(Helpers.GetValue(Helpers.GetValue(ohlcvs, candle), i_high), price));
                Helpers.addElementToObject(Helpers.GetValue(ohlcvs, candle), i_low, mathMin(Helpers.GetValue(Helpers.GetValue(ohlcvs, candle), i_low), price));
    ...
    public void throwExactlyMatchedException(Object exact, Object str, Object message)
    {
        ...
        {
            throwDynamicException(Helpers.GetValue(exact, str), message);
        }
    }
    ...
    public void throwBroadlyMatchedException(Object broad, Object str, Object message)
    {
        ...
        {
            throwDynamicException(Helpers.GetValue(broad, broadKey), message);
        }
    }
    ...
    public Object safeOpenInterest(Object interest, Object... optionalArgs)
    {
        ...
        return this.extend(interest, new java.util.HashMap<String, Object>() {{
            put( "symbol", symbol );
            put( "baseVolume", this.safeNumber(interest, "baseVolume") );
            put( "quoteVolume", this.safeNumber(interest, "quoteVolume") );
            put( "openInterestAmount", this.safeNumber(interest, "openInterestAmount") );
            put( "openInterestValue", this.safeNumber(interest, "openInterestValue") );
            put( "timestamp", this.safeInteger(interest, "timestamp") );
            put( "datetime", this.safeString(interest, "datetime") );
            put( "info", this.safeValue(interest, "info") );
        }});
    }
    ...
    public void cleanUnsubscription(Object client, Object subHash, Object unsubHash, Object... optionalArgs)
    {
    ...
    public void cleanCache(Object subscription)
    {
        ...
        } else
        {
            ...
            } else if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(topic, "positions")) && Helpers.isTrue((!Helpers.isEqual(this.positions, null)))))
            {
                ...
                {
                    Object client = Helpers.GetValue(clients, i);
