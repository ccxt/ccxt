...
public class Aster extends AsterApi
{
   ...
   public Aster (Object options) {
    ...
    public Map<String, Object> createOrderRequest(String symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        List<Object> tifAndParams = (List<Object>) this.handleOptionStringAndParams(parameters, "createOrder", "timeInForce", (String) null);
        ...
        {
            request.put("timeInForce", ((List<Object>)tifAndParams).get(0));
        }
        Object paramsTif = parameters;
        if (Boolean.TRUE.equals(tifIsMissing))
        {
            paramsTif = ((List<Object>)tifAndParams).get(1);
        }
        Object requestParams = this.omit(paramsTif, new ArrayList<Object>(Arrays.asList("newClientOrderId", "clientOrderId", "stopPrice", "triggerPrice", "trailingTriggerPrice", "trailingPercent", "trailingDelta", "stopPrice", "stopLossPrice", "takeProfitPrice")));
    ...
    public CompletableFuture<List<FundingHistory>> fetchFundingHistory(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(limit, null))
            {
                ((Map<String, Object>)requestUntil).put("limit", Helpers.mathMin(limit, 1000)); // max 1000
            }
