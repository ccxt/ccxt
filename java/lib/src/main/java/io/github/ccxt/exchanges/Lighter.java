...
public class Lighter extends LighterApi
{
   ...
   public Lighter (Object options) {
    ...
    public CompletableFuture<Object> loadAccount(Object chainId, Object privateKey2, Object apiKeyIndex2, Object accountIndex2, Map<String, Object> parameters2)
    {
    ...
    public CompletableFuture<Object> loadAccount(Object chainId, Object privateKey, Object apiKeyIndex, Object accountIndex, Object... optionalArgs)
    {
    ...
    public Object createOrderRequest(String symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        {
            ((Map<String, Object>)request).put("nonce", nonce);
        }
        ((Map<String, Object>)request).put("api_key_index", apiKeyIndex);
        ((Map<String, Object>)request).put("account_index", this.parseToInt(accountIndex));
        ...
        {
            ((Map<String, Object>)request).put("is_ask", 0);
        } else
        {
        ...
        ((Map<String, Object>)request).put("time_in_force", timeInForceNum);
        ((Map<String, Object>)request).put("reduce_only", (((java.util.Objects.equals(reduceOnly, true)))) ? 1 : 0);
        ((Map<String, Object>)request).put("client_order_index", clientOrderId);
        ...
        if (Boolean.TRUE.equals(this.safeBool(this.options, "builderFee", true)))
        {
            ...
            ((Map<String, Object>)request).put("integrator_maker_fee", ((Map<String, Object>)this.options).get("integratorMakerFee"));
        }
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            } else
            {
                ...
                if (Boolean.TRUE.equals(this.safeBool(this.options, "builderFee", true)))
                {
                    ...
                    ((Map<String, Object>)signingPayload).put("integrator_maker_fee", ((Map<String, Object>)order).get("integrator_maker_fee"));
                }
    ...
    public CompletableFuture<Order> editOrder(String id, String symbol, Object type, Object side, Object amount, Object price, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (Boolean.TRUE.equals(this.safeBool(this.options, "builderFee", true)))
            {
                ...
                ((Map<String, Object>)signRaw).put("integrator_maker_fee", ((Map<String, Object>)this.options).get("integratorMakerFee"));
            }
    ...
    public CompletableFuture<Object> fetchMarkets(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)markets).size(); i++)
            {
                ...
                Object amountPrecision = (((java.util.Objects.equals(amountDecimals, null)))) ? null : this.parseNumber(this.parsePrecision(amountDecimals));
            ...
            for (var i = 0; i < ((List<?>)accounts).size(); i++)
            {
                ...
                if (java.util.Objects.equals(type, "spot"))
                {
                    ...
                    for (var j = 0; j < ((List<?>)assets).size(); j++)
                    {
                        ...
                        {
                            ((Map<String, Object>)result).put((String)code, balance);
                        }
                    }
                } else
                {
     ...
     */
    public CompletableFuture<TransferEntry> transfer(String code, Object amount2, Object fromAccount2, Object toAccount2, Map<String, Object> parameters2)
    {
     ...
     */
    public CompletableFuture<Transaction> withdraw(String code, Object amount2, Object address, String tag, Map<String, Object> parameters2)
    {
        final Object amount3 = amount2;
        final Map<String, Object> parameters3 = parameters2;
        return BaseExchange.supplyAsync(() -> {
     ...
     * @returns {object} response from the exchange
     */
    public CompletableFuture<Object> setMarginMode(Object marginMode2, String symbol, Map<String, Object> parameters2)
    {
    ...
    public CompletableFuture<Object> signAndCancelOrder(Object method, Object id2, String symbol2, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                ((Map<String, Object>)signRaw).put("order_index", this.parseToInt(clientOrderId));
            } else if (!java.util.Objects.equals(id, null))
            {
                ((Map<String, Object>)signRaw).put("order_index", this.parseToInt(id));
            } else
            {
    ...
    public CompletableFuture<Object> signAndCancelOrder(Object method, Object id, Object... optionalArgs)
    {
