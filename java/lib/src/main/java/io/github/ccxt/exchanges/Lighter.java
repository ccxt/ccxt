...
public class Lighter extends LighterApi
{
   ...
   public Lighter (Object options) {
    ...
    public CompletableFuture<Object> loadAccount(Object chainId, Object privateKey, Object apiKeyIndex, Object accountIndex, Map<String, Object> parameters)
    {
    ...
    public CompletableFuture<Boolean> preLoadLighterLibrary(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            signer = (this.loadAccount(((Map<String, Object>)this.options).get("chainId"), this.getLighterPrivateKey(strAccountIndex, strApiKeyIndex), strApiKeyIndex, strAccountIndex, new HashMap<String, Object>() {{}})).join();
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (java.util.Objects.equals(accountIndex, null))
            {
                ...
                if ((subAccounts instanceof List))
                {
                    ...
                    accountIndex = ((Map<String, Object>)account).get("index");
    ...
    public CompletableFuture<Object> createSubAccount(Object name, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            String strAccountIndex = this.numberToString(accountIndex);
            String strApiKeyIndex = this.numberToString(apiKeyIndex);
            Object signer = (this.loadAccount(((Map<String, Object>)this.options).get("chainId"), this.getLighterPrivateKey(strAccountIndex, strApiKeyIndex), strApiKeyIndex, strAccountIndex, Helpers.toMapArg(paramsAccountIndex))).join();
    ...
    public String pow(Object n, Object m)
    {
        ...
        if (Helpers.isGreaterThan(c, 100))
        {
    ...
    public CompletableFuture<Object> signAndCreateOrder(Object method, String symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            String strAccountIndex = this.numberToString(accountIndex);
            String strApiKeyIndex = this.numberToString(apiKeyIndex);
            Object signer = (this.loadAccount(((Map<String, Object>)this.options).get("chainId"), this.getLighterPrivateKey(strAccountIndex, strApiKeyIndex), strApiKeyIndex, strAccountIndex, Helpers.toMapArg(paramsGroupingType))).join();
            ...
            Object txType = null;
            Object txInfo = null;
            if (Helpers.isLessThan(totalOrderRequests, 2))
            {
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(Object symbol, Object timeframe, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            } else
            {
                ...
                if (!java.util.Objects.equals(limit, null))
                {
                    startTs = Helpers.subtract(endTs, Helpers.multiply((((long) this.parseTimeframe(java.util.Objects.requireNonNullElse(timeframe, "1h"))) * 1000L), limit));
                } else
                {
    ...
    public CompletableFuture<List<Order>> fetchOpenOrders(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            String strAccountIndex = this.numberToString(accountIndex);
            String strApiKeyIndex = this.numberToString(apiKeyIndex);
            (this.loadAccount(((Map<String, Object>)this.options).get("chainId"), this.getLighterPrivateKey(strAccountIndex, strApiKeyIndex), strApiKeyIndex, strAccountIndex, Helpers.toMapArg(paramsApiKeyIndex))).join();
            Map<String, Object> market = (Map<String, Object>) this.market(symbol);
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "market_id", ((Map<String, Object>)market).get("id") );
                put( "account_index", accountIndex );
    ...
    public CompletableFuture<TransferEntry> transfer(String code, Object amount, String fromAccount, String toAccount, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            String strAccountIndex = this.numberToString(accountIndex);
            String strApiKeyIndex = this.numberToString(apiKeyIndex);
            Object signer = (this.loadAccount(((Map<String, Object>)this.options).get("chainId"), this.getLighterPrivateKey(strAccountIndex, strApiKeyIndex), strApiKeyIndex, strAccountIndex, Helpers.toMapArg(paramsToAccountIndex))).join();
    ...
    public CompletableFuture<Object> signAndCancelOrder(Object method, Object id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            String strAccountIndex = this.numberToString(accountIndex);
            String strApiKeyIndex = this.numberToString(apiKeyIndex);
            Object signer = (this.loadAccount(((Map<String, Object>)this.options).get("chainId"), this.getLighterPrivateKey(strAccountIndex, strApiKeyIndex), strApiKeyIndex, strAccountIndex, Helpers.toMapArg(paramsOmitted))).join();
            Long nonce = (this.fetchNonce(accountIndex, apiKeyIndex, Helpers.toMapArg(paramsOmitted))).join();
            Map<String, Object> signRaw = new HashMap<String, Object>() {{
                put( "market_index", Lighter.this.parseToInt(((Map<String, Object>)market).get("id")) );
                put( "nonce", nonce );
