...
public class CoinbaseexchangeCore extends CoinbaseexchangeApi
{
   ...
   public CoinbaseexchangeCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "name", name );
        put( "active", Helpers.isEqual(CoinbaseexchangeCore.this.safeString(currency, "status"), "online") );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        put( "precision", CoinbaseexchangeCore.this.safeNumber(currency, "max_precision") );
        put( "limits", new java.util.HashMap<String, Object>() {{
