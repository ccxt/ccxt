...
public class CexCore extends io.github.ccxt.exchanges.Cex
{
   ...
   public CexCore (Object options) {
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> freeBalance = (java.util.Map<String, Object>) this.safeDict(data, "balance", new java.util.HashMap<String, Object>() {{}});
        ...
        String messageHash = (String) this.safeString(message, "oid");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTrades(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String currentSymbol = (String) this.safeString(Helpers.GetValue(this.options, "watchTrades"), "symbol");
            ...
            Object url = Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws");
            String messageHash = (String) "trades";
    ...
    public Object parseWsOldTrade(Object trade, Object... optionalArgs)
    {
        ...
        String side = (String) this.safeString(trade, 0);
        Long timestamp = this.safeInteger(trade, 1);
        String amount = (String) this.safeString(trade, 2);
        String price = (String) this.safeString(trade, 3);
        String id = (String) this.safeString(trade, 4);
    ...
    public void handleTradesInner(Client client, Object message)
    {
        ...
        String symbol = (String) this.safeString(Helpers.GetValue(this.options, "watchTrades"), "symbol");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String method = (String) this.safeString(parameters, "method", "private"); // default to private because the specified ticker is received quicker
    ...
    public Object parseWsTicker(Object ticker, Object... optionalArgs)
    {
        ...
        String baseId = (String) this.safeString(ticker, "symbol1");
        if (Helpers.isTrue(Helpers.isEqual(baseId, null)))
        {
            baseId = this.safeString(pair, 0);
        }
        String quoteId = (String) this.safeString(ticker, "symbol2");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object url = Helpers.GetValue(Helpers.GetValue(this.urls, "api"), "ws");
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            String messageHash = (String) Helpers.add("myTrades:", Helpers.GetValue(market, "symbol"));
    ...
    public void handleTransaction(Client client, Object message)
    {
        ...
        String symbol2 = (String) this.safeString(data, "symbol2");
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String side = (String) this.safeString(trade, "type");
        String price = (String) this.safeString(trade, "price");
        String datetime = (String) this.safeString(trade, "time");
        String baseId = (String) this.safeString(trade, "symbol");
        String quoteId = (String) this.safeString(trade, "symbol2");
        String base = (String) this.safeCurrencyCode(baseId);
        String quote = (String) this.safeCurrencyCode(quoteId);
        Object symbol = Helpers.add(Helpers.add(base, "/"), quote);
        ...
        String fee = (String) this.safeString(trade, "fee_amount");
    ...
    public void handleOrderUpdate(Client client, Object message)
    {
        ...
        String orderId = (String) this.safeString2(data, "id", "order");
        Object remains = this.safeString(data, "remains");
        String baseId = (String) this.safeString(data, "symbol");
        String quoteId = (String) this.safeString(data, "symbol2");
    ...
    public Object parseWsOrderUpdate(Object order, Object... optionalArgs)
    {
        ...
        String remainsPrecision = (String) this.safeString(order, "remains");
        ...
        String amount = (String) this.safeString(order, "amount");
        if (!Helpers.isTrue(isTransaction))
        {
            if (Helpers.isTrue(Helpers.isEqual(market, null)))
            {
        ...
        String baseId = (String) this.safeString(order, "symbol");
        String quoteId = (String) this.safeString(order, "symbol2");
    ...
    public void handleOrdersSnapshot(Client client, Object message)
    {
        ...
        //     }
        //
        String symbol = (String) this.safeString(message, "oid"); // symbol is set as requestId in watchOrders
        java.util.List<Object> rawOrders = (java.util.List<Object>) this.safeList(message, "data", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public void handleOrderBookSnapshot(Client client, Object message)
    {
        ...
        //
        Object data = this.safeValue(message, "data", new java.util.HashMap<String, Object>() {{}});
        String pair = (String) this.safeString(data, "pair");
    ...
    public Object pairToSymbol(Object pair)
    {
        ...
        String baseId = (String) this.safeString(parts, 0);
        String quoteId = (String) this.safeString(parts, 1);
        String base = (String) this.safeCurrencyCode(baseId);
        String quote = (String) this.safeCurrencyCode(quoteId);
        Object symbol = Helpers.add(Helpers.add(base, "/"), quote);
        return symbol;
    ...
    public void handleInitOHLCV(Client client, Object message)
    {
        ...
        //     }
        //
        String pair = (String) this.safeString(message, "pair");
        if (Helpers.isTrue(Helpers.isEqual(pair, null)))
        {
            return;
        }
    ...
    public Object handleErrorMessage(Client client, Object message)
    {
        ...
        {
            Object data = this.safeValue(message, "data", new java.util.HashMap<String, Object>() {{}});
            String error = (String) this.safeString(data, "error");
    ...
    {
        String ok = (String) this.safeString(message, "ok");
