...
public class Grvt extends GrvtApi
{
   public Grvt () {
       super();
   }
   ...
   public Grvt (Object options) {
    ...
    public Object describe()
    {
        ...
        return this.deepExtend(super.describe(), new HashMap<String, Object>() {{
            ...
            put( "urls", new HashMap<String, Object>() {{
                ...
                put( "doc", new ArrayList<Object>(Arrays.asList("https://api-docs.grvt.io/")) );
                put( "fees", "https://help.grvt.io/en/articles/9614699-how-does-grvt-s-fee-model-work" );
            }} );
            put( "api", new HashMap<String, Object>() {{
                put( "privateEdge", new HashMap<String, Object>() {{
                    put( "get", new HashMap<String, Object>() {{
                        put( "api/v1/deposit/addresses", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "api/v1/bridge/withdrawal-info", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "api/v1/bridge/withdrawal-status", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "api/v1/referral/epochs", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "api/v1/referral/points", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "api/v1/referral/data", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "api/v1/referral/indirect_data", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                    }} );
                    put( "post", new HashMap<String, Object>() {{
                        put( "auth/api_key/login", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "auth/wallet/login", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "auth/builder/authorize", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "api/v1/deposit/generate-address", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "api/v1/bridge/withdrawal-quote", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "api/v1/bridge/withdraw", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                    }} );
                }} );
                put( "publicMarket", new HashMap<String, Object>() {{
                    put( "post", new HashMap<String, Object>() {{
                        put( "full/v1/instrument", new HashMap<String, Object>() {{
                            put( "cost", 4 );
                        }} );
                        put( "full/v1/all_instruments", new HashMap<String, Object>() {{
                            put( "cost", 4 );
                        }} );
                        put( "full/v1/instruments", new HashMap<String, Object>() {{
                            put( "cost", 4 );
                        }} );
                        put( "full/v1/currency", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/margin_rules", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/mini", new HashMap<String, Object>() {{
                            put( "cost", 4 );
                        }} );
                        put( "full/v1/ticker", new HashMap<String, Object>() {{
                            put( "cost", 4 );
                        }} );
                        put( "full/v1/book", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/trade", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/trade_history", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/kline", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/funding", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/supported_assets", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                        put( "full/v1/get_all_collateral_asset_info", new HashMap<String, Object>() {{
                            put( "cost", 12 );
                        }} );
                    }} );
                }} );
                put( "privateTrading", new HashMap<String, Object>() {{
                    put( "post", new HashMap<String, Object>() {{
                        put( "full/v1/create_order", new HashMap<String, Object>() {{
                            put( "cost", 5 );
                        }} );
                        put( "full/v1/cancel_order", new HashMap<String, Object>() {{
                            put( "cost", 5 );
                        }} );
                        put( "full/v1/cancel_on_disconnect", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "full/v1/cancel_all_orders", new HashMap<String, Object>() {{
                            put( "cost", 50 );
                        }} );
                        put( "full/v1/order", new HashMap<String, Object>() {{
                            put( "cost", rlOrders );
                        }} );
                        put( "full/v1/order_history", new HashMap<String, Object>() {{
                            put( "cost", rlOrders );
                        }} );
                        put( "full/v1/open_orders", new HashMap<String, Object>() {{
                            put( "cost", rlOrders );
                        }} );
                        put( "full/v1/fill_history", new HashMap<String, Object>() {{
                            put( "cost", rlOrders );
                        }} );
                        put( "full/v1/positions", new HashMap<String, Object>() {{
                            put( "cost", rlOrders );
                        }} );
                        put( "full/v1/funding_payment_history", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/get_sub_accounts", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/account_summary", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/account_history", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/aggregated_account_summary", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/funding_account_summary", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/transfer", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "full/v1/deposit_history", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "full/v1/transfer_history", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "full/v1/withdrawal", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "full/v1/withdrawal_history", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                        put( "full/v1/add_position_margin", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/get_position_margin_limits", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/set_position_config", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/set_initial_leverage", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/get_all_initial_leverage", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/set_derisk_mm_ratio", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_burn_tokens", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_invest", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_investor_summary", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_redeem", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_redeem_cancel", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_view_redemption_queue", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/vault_manager_investor_history", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/authorize_builder", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/get_authorized_builders", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/builder_fill_history", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/create_rfq", new HashMap<String, Object>() {{
                            put( "cost", 5 );
                        }} );
                        put( "full/v1/cancel_rfq", new HashMap<String, Object>() {{
                            put( "cost", 5 );
                        }} );
                        put( "full/v1/ecn_from_broker", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v2/bulk_orders", new HashMap<String, Object>() {{
                            put( "cost", 50 );
                        }} );
                        put( "full/v1/position_history", new HashMap<String, Object>() {{
                            put( "cost", rlOrders );
                        }} );
                        put( "full/v1/interest_payment_history", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/get_collateral_preference", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/spot_account_summary", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/set_indicative_prices", new HashMap<String, Object>() {{
                            put( "cost", rlOthers );
                        }} );
                        put( "full/v1/withdrawal_fee", new HashMap<String, Object>() {{
                            put( "cost", 100 );
                        }} );
                    }} );
                }} );
    ...
    put( "type", "int64" );
                ...
                put( "OrderLeg", new ArrayList<Object>(Arrays.asList(new HashMap<String, Object>() {{
    put( "name", "assetID" );
    put( "type", "uint256" );
}}, new HashMap<String, Object>() {{
    ...
    put( "type", "bool" );
            ...
            put( "EIP712_ORDER_WITH_BUILDER_TYPE", new HashMap<String, Object>() {{
                put( "OrderWithBuilderFee", new ArrayList<Object>(Arrays.asList(new HashMap<String, Object>() {{
    put( "name", "subAccountID" );
    put( "type", "uint64" );
}}, new HashMap<String, Object>() {{
    put( "name", "isMarket" );
    ...
    put( "type", "bool" );
            ...
            put( "EIP712_TRANSFER_TYPE", new HashMap<String, Object>() {{
                put( "Transfer", new ArrayList<Object>(Arrays.asList(new HashMap<String, Object>() {{
    ...
    put( "type", "int64" );
            ...
            put( "EIP712_WITHDRAWAL_TYPE", new HashMap<String, Object>() {{
                put( "Withdrawal", new ArrayList<Object>(Arrays.asList(new HashMap<String, Object>() {{
    put( "name", "fromAccount" );
    put( "type", "address" );
}}, new HashMap<String, Object>() {{
    ...
    put( "type", "int64" );
            ...
            put( "EIP712_BUILDER_APPROVAL_TYPE", new HashMap<String, Object>() {{
                put( "AuthorizeBuilder", new ArrayList<Object>(Arrays.asList(new HashMap<String, Object>() {{
    ...
    put( "type", "int64" );
            ...
            put( "EIP712_WALLETLOGIN_TYPE", new HashMap<String, Object>() {{
                put( "WalletLogin", new ArrayList<Object>(Arrays.asList(new HashMap<String, Object>() {{
    put( "name", "signer" );
    put( "type", "address" );
}}, new HashMap<String, Object>() {{
    put( "name", "nonce" );
    ...
    public CompletableFuture<Object> signIn(Object parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            (this.signInWithPrivateKey(Helpers.toMapArg(parameters))).join();
    ...
    public CompletableFuture<Map<String, Object>> signInWithApiKey(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "api_key", Grvt.this.apiKey );
            }};
            Map<String, Object> response = (this.privateEdgePostAuthApiKeyLogin(this.extend(request, parameters))).join();
            //
            //    {
            //        "location": "",
            //        "status": "success"
    ...
    public CompletableFuture<Map<String, Object>> signInWithPrivateKey(Map<String, Object> parameters)
    {
    ...
    public CompletableFuture<Object> initializeClient(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            // }
            //
            Map<String, Object> currentBuilders = (Map<String, Object>) this.safeDict(results, 0, (Object) null);
            ...
            } else
            {
                try
                {
                    ...
                    Object request = new HashMap<String, Object>() {{
                        ...
                        put( "builder_account_id", Grvt.this.safeString(Grvt.this.options, "builder") );
                        put( "max_futures_fee_rate", Grvt.this.safeString(Grvt.this.options, "builderRate") );
                    ...
                    // }
                    //
                    Map<String, Object> authResult = (Map<String, Object>) this.safeDict(authResponse, "result", (Object) null);
                    Boolean ack = (Boolean) this.safeBool(authResult, "ack", (Object) null);
        ...
        return Helpers.newMap(
            ...
            "limits", new HashMap<String, Object>() {{
                ...
                put( "amount", new HashMap<String, Object>() {{
                    put( "min", Grvt.this.safeNumber(market, "min_size", (Object) null) );
                    put( "max", Grvt.this.safeNumber(market, "max_position_size", (Object) null) );
                }} );
    ...
    public CompletableFuture<Object> fetchCurrencies(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.publicMarketPostFullV1Currency(request)).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public Object parseCurrency(Object rawCurrency)
    {
        ...
        return this.safeCurrencyStructure(new HashMap<String, Object>() {{
            ...
            put( "withdraw", null );
            put( "fee", null );
            put( "precision", Grvt.this.parseNumber(Grvt.this.parsePrecision(Grvt.this.safeString(rawCurrency, "balance_decimals"))) );
    ...
    public CompletableFuture<Ticker> fetchTicker(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.publicMarketPostFullV1Ticker(this.extend(request, parameters))).join();
            //
            //    {
            //        "result": {
    ...
    public Object parseTicker(Object ticker, Map<String, Object> market)
    {
        ...
        return this.safeTicker(new HashMap<String, Object>() {{
            put( "info", ticker );
            put( "symbol", Grvt.this.safeSymbol(marketId, market, (String) null, (String) null) );
            put( "timestamp", timestamp );
            put( "datetime", Grvt.this.iso8601(timestamp) );
            put( "open", Grvt.this.safeString(ticker, "open_price") );
            put( "high", Grvt.this.safeString(ticker, "high_price") );
            put( "low", Grvt.this.safeString(ticker, "low_price") );
            put( "last", Grvt.this.safeString(ticker, "last_price") );
            put( "bid", Grvt.this.safeString(ticker, "best_bid_price") );
            put( "bidVolume", Grvt.this.safeString(ticker, "best_bid_size") );
            put( "ask", Grvt.this.safeString(ticker, "best_ask_price") );
            put( "askVolume", Grvt.this.safeString(ticker, "best_ask_size") );
            put( "change", null );
            put( "percentage", null );
            put( "baseVolume", Grvt.this.safeString(ticker, "buy_volume_24h_b") );
            put( "quoteVolume", Grvt.this.safeString(ticker, "buy_volume_24h_q") );
            put( "markPrice", Grvt.this.safeString(ticker, "mark_price") );
            put( "indexPrice", Grvt.this.safeString(ticker, "index_price") );
            put( "vwap", null );
            put( "average", null );
    ...
    public CompletableFuture<OrderBook> fetchOrderBook(Object symbol, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (Helpers.isLessThanOrEqual(limitResolved, 500))
            {
                request.put("depth", this.findNearestCeiling(new ArrayList<Object>(Arrays.asList(10, 50, 100, 500)), limitResolved));
            }
    ...
    public CompletableFuture<List<Trade>> fetchTrades(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> requestUntilOptionStringparamsUntilOptionStringVariable = (List<Object>) this.handleUntilOptionString("end_time", (Map<String, Object>) (request), parameters, 1000000);
            ...
            {
                ((Map<String, Object>)requestUntilOptionString).put("start_time", this.numberToString((since * 1000000L)));
            }
            Map<String, Object> response = (this.publicMarketPostFullV1TradeHistory(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(String symbol, String timeframe, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "instrument", market.get("id") );
                put( "interval", Grvt.this.safeString(Grvt.this.timeframes, java.util.Objects.requireNonNullElse(timeframe, "1m"), java.util.Objects.requireNonNullElse(timeframe, "1m")) );
            }};
            Map<String, Object> priceTypeMap = new HashMap<String, Object>() {{
                put( "last", "TRADE" );
                put( "mark", "MARK" );
                put( "index", "INDEX" );
            }};
            String selectedPriceType = this.safeString(paramsPaginate, "priceType", "last");
            request.put("type", this.safeString(priceTypeMap, selectedPriceType));
            if (!java.util.Objects.equals(limit, null))
            {
                request.put("limit", Math.min(limit, 1000));
            }
            ...
            Map<String, Object> response = (this.publicMarketPostFullV1Kline(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public Object parseOHLCV(Object ohlcv, Map<String, Object> market)
    {
        ...
        //            }
        //
        return new ArrayList<Object>(Arrays.asList(this.safeIntegerProduct(ohlcv, "open_time", 0.000001), this.safeNumber(ohlcv, "open", (Object) null), this.safeNumber(ohlcv, "high", (Object) null), this.safeNumber(ohlcv, "low", (Object) null), this.safeNumber(ohlcv, "close", (Object) null), this.safeNumber(ohlcv, "volume_b", (Object) null)));
    }
    ...
    public CompletableFuture<List<FundingRateHistory>> fetchFundingRateHistory(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.publicMarketPostFullV1Funding(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public Object parseFundingRateHistory(Object rawItem, Map<String, Object> market)
    {
        //
        //            {
        //                "instrument": "BTC_USDT_Perp",
        ...
        return new HashMap<String, Object>() {{
            put( "info", rawItem );
            put( "symbol", Grvt.this.safeSymbol(marketId, market, (String) null, (String) null) );
            put( "fundingRate", Grvt.this.parseNumber(Precise.stringDiv(rate, "100")) );
            put( "timestamp", ts );
            put( "datetime", Grvt.this.iso8601(ts) );
        }};
    }

    public String getSubAccountId(Map<String, Object> parameters)
    {
        Object subAccountId = ((List<Object>)this.handleOptionAndParams(parameters, "getSubAccountId", "accountId", (Object) null)).get(0);
    ...
    public CompletableFuture<Balances> fetchBalance(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1AccountSummary(this.extend(request, parameters))).join();
            //
            //    {
            //        "result": {
    ...
    public CompletableFuture<List<Transaction>> fetchDeposits(String code, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(code, null))
            {
                ...
                request.put("currency", new ArrayList<Object>(Arrays.asList(currency.get("code"))));
            }
            if (!java.util.Objects.equals(limit, null))
            {
                request.put("limit", Math.min(limit, 1000));
    ...
    public CompletableFuture<Object> internalFetchTransfers(Map<String, Object> req, Map<String, Object> currency, Long since, Long limit)
    {

        return BaseExchange.supplyAsync(() -> {

            Map<String, Object> response = (this.privateTradingPostFullV1TransferHistory(req)).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public Object parseTransaction(Map<String, Object> transaction, Map<String, Object> currency)
    {
        ...
        if (transaction.containsKey("transfer_metadata"))
        {
            ...
            if (!java.util.Objects.equals(metaData, null))
            {
                ...
                if (java.util.Objects.equals(direction, "withdrawal"))
                {
                    addressTo = this.safeString(parsedMeta, "endpoint");
                } else if (java.util.Objects.equals(direction, "deposit"))
                {
    ...
    public CompletableFuture<List<TransferEntry>> fetchTransfers(String code, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1TransferHistory(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public Object filterTransfersByType(Object transfers, Object transferType, Boolean onlyMainAccount)
    {
        ...
        for (var i = 0; i < Helpers.getArrayLength(transfers); i++)
        {
            ...
            if ((java.util.Objects.requireNonNullElse(onlyMainAccount, true) && java.util.Objects.equals(this.safeString(transfer, "fromAccount"), "0") && java.util.Objects.equals(this.safeString(transfer, "toAccount"), "0")) || (!java.util.Objects.requireNonNullElse(onlyMainAccount, true) && (!java.util.Objects.equals(this.safeString(transfer, "fromAccount"), "0") || !java.util.Objects.equals(this.safeString(transfer, "toAccount"), "0"))))
            {
                ...
                if (java.util.Objects.equals(direction, transferType))
                {
                    ((List<Object>)matchedResults).add(transfer);
                } else
                {
                    ((List<Object>)nonMatchedResults).add(transfer);
                }
            }
        }
        return new ArrayList<Object>(Arrays.asList(matchedResults, nonMatchedResults));
    }
    ...
    public CompletableFuture<TransferEntry> transfer(String code, Object amount, String fromAccount, String toAccount, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Boolean isInternal = this.inArray(fromAccount, new ArrayList<Object>(Arrays.asList("trading", "funding"))) && this.inArray(toAccount, new ArrayList<Object>(Arrays.asList("trading", "funding")));
            Object fromSubAccount = fromAccount;
            Object toSubAccount = toAccount;
            ...
            if (Boolean.TRUE.equals(isInternal))
            {
                ...
                fromSubAccount = (((java.util.Objects.equals(fromAccount, "trading")))) ? tradingAccountId : fundingAccountId;
                toSubAccount = (((java.util.Objects.equals(toAccount, "trading")))) ? tradingAccountId : fundingAccountId;
            ...
            Object request = Helpers.newMap(
                ...
                "num_tokens", this.currencyToPrecision((String) (code), amount, (String) null),
            ...
            try
            {
                response = (this.privateTradingPostFullV1Transfer(this.extend(request, paramsFundingAccountId))).join();
            } catch(Exception error)
            {
                Object msg = this.exceptionMessage(error, true);
                Boolean isFromFundingAccount = java.util.Objects.equals(fromSubAccount, "funding");
    ...
    public Object parseTransfer(Object transfer, Map<String, Object> currency)
    {
        ...
        return new HashMap<String, Object>() {{
            put( "info", transfer );
            put( "id", Grvt.this.safeString(transfer, "tx_id") );
            put( "timestamp", timestamp );
            put( "datetime", Grvt.this.iso8601(timestamp) );
            put( "currency", code );
            put( "amount", Grvt.this.safeNumber(transfer, "amount", (Object) null) );
            put( "fromAccount", Grvt.this.safeString(transfer, "from_sub_account_id") );
            put( "toAccount", Grvt.this.safeString(transfer, "to_sub_account_id") );
            put( "status", null );
        }};
    }
    ...
    public CompletableFuture<Boolean> loadAccountInfos()
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(this.safeString(this.options, "userMainAccountId"), null))
            {
                return false;
            }
            List<Object> promises = new ArrayList<Object>(Arrays.asList());
            ((List<Object>)promises).add(this.privateTradingPostFullV1AggregatedAccountSummary());
            //
            //     {
            //         "result": {
    ...
    public CompletableFuture<Order> createOrder(String symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            var stopLossPrice = ((List<Object>) triggerPricestopLossPricetakeProfitPriceparamsTriggerPricesVariable).get(1);
            var takeProfitPrice = ((List<Object>) triggerPricestopLossPricetakeProfitPriceparamsTriggerPricesVariable).get(2);
            var paramsTriggerPrices = ((List<Object>) triggerPricestopLossPricetakeProfitPriceparamsTriggerPricesVariable).get(3);
            ...
            if (Boolean.TRUE.equals(isTriggerOrder))
            {
                ...
                } else if (!java.util.Objects.equals(stopLossPrice, null))
                {
                ...
                Helpers.addElementToObject(orderRequest.get("metadata"), "trigger", Helpers.newMap(
        ...
        "tpsl", Helpers.newMap(
            ...
            if (Boolean.TRUE.equals(isTriggerOrder))
            {
                paramsTrigger = this.omit(paramsTriggerPrices, new ArrayList<Object>(Arrays.asList("triggerDirection", "triggerPriceType", "closePosition")));
            }
            String eipType = "EIP712_ORDER_TYPE";
            Object builderFee = this.safeBool(paramsTrigger, "builderFee", this.safeBool(this.options, "builderFee", true));
            if (java.util.Objects.equals(builderFee, true))
            {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1CreateOrder(this.extend(request, paramsOmitted))).join();
            //
            //    {
            //        "result": {
            //            "order_id": "0x00",
    ...
    public Object eipMessageForOrder(Map<String, Object> order, String structureType)
    {
        ...
        for (var i = 0; i < ((List<?>)orderLegs).size(); i++)
        {
            ...
            Map<String, Object> market = this.market(((Map<String, Object>)leg).get("instrument"));
            Object bigInt10 = this.convertToBigIntCustom("10");
            Object precisionValue = this.precisionFromString(this.safeString(market.get("precision"), "base"));
            ...
            Map<String, Object> legOrder = new HashMap<String, Object>() {{
                put( "assetID", Helpers.GetValue(market.get("info"), "instrument_hash") );
        ...
        Map<String, Object> returnValue = new HashMap<String, Object>() {{
            put( "subAccountID", order.get("sub_account_id") );
            put( "isMarket", order.get("is_market") );
            put( "timeInForce", Grvt.this.timeInForceToInt((String) (order.get("time_in_force"))) );
            put( "postOnly", order.get("post_only") );
            put( "reduceOnly", order.get("reduce_only") );
            put( "legs", legs );
            put( "nonce", Helpers.GetValue(order.get("signature"), "nonce") );
            put( "expiration", Helpers.GetValue(order.get("signature"), "expiration") );
        }};
        ...
        {
            returnValue.put("builder", order.get("builder"));
            returnValue.put("builderFee", this.parseToInt(Helpers.multiply(this.convertToBigIntCustom(this.feeAmountMultiplier()), Helpers.parseFloat(order.get("builder_fee"))))); // the order is matter for Multiply in go, b must be float64 otherwise the value would be 0
        }
        return returnValue;
    }
    ...
    public CompletableFuture<List<Trade>> fetchMyTrades(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(symbol, null))
            {
                ...
                ((List<Object>)request.get("base")).add(market.get("baseId"));
                request.put("quote", new ArrayList<Object>(Arrays.asList()));
                ((List<Object>)request.get("quote")).add(market.get("quoteId"));
            }
            if (!java.util.Objects.equals(limit, null))
            {
                request.put("limit", Math.min(limit, 1000));
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1FillHistory(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public CompletableFuture<List<Position>> fetchPositions(List<String> symbols, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1Positions(this.extend(request, parameters))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public CompletableFuture<Leverages> fetchLeverages(List<String> symbols, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1GetAllInitialLeverage(this.extend(request, parameters))).join();
            //
            //    {
            //        "results": [
            //            {
            ...
            return this.parseLeverages(results, symbols, (String) null, (Object) null);
    ...
    public CompletableFuture<Object> setLeverage(Object leverage, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "sub_account_id", Grvt.this.getSubAccountId((Map<String, Object>) (parameters)) );
                put( "instrument", market.get("id") );
                put( "leverage", Grvt.this.numberToString(leverage) );
            }};
            Map<String, Object> response = (this.privateTradingPostFullV1SetInitialLeverage(this.extend(request, parameters))).join();
            //
            //    {
            //        "success": true
            //    }
    ...
    public Object parseMarginMode(Map<String, Object> marginMode, Map<String, Object> market)
    {
        ...
        return new HashMap<String, Object>() {{
            put( "info", marginMode );
            put( "symbol", Grvt.this.safeSymbol(marketId, market, (String) null, (String) null) );
            put( "marginMode", Grvt.this.safeStringLower(marginMode, "margin_type") );
        }};
    }
    ...
    public CompletableFuture<List<FundingHistory>> fetchFundingHistory(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1FundingPaymentHistory(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public Object parseIncome(Map<String, Object> income, Map<String, Object> market)
    {
        ...
        return new HashMap<String, Object>() {{
            put( "info", income );
            put( "symbol", Grvt.this.safeSymbol(marketId, market, (String) null, (String) null) );
            put( "code", Grvt.this.safeCurrencyCode(currencyId, (Map<String, Object>) null) );
            put( "timestamp", timestamp );
            put( "datetime", Grvt.this.iso8601(timestamp) );
            put( "id", Grvt.this.safeString(income, "tx_id") );
            put( "amount", Grvt.this.safeNumber(income, "amount", (Object) null) );
        }};
    }
    ...
    public CompletableFuture<List<Order>> fetchOrders(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1OrderHistory(this.extend(requestUntilOptionString, paramsUntilOptionString))).join();
            //
            //    {
            //        "result": [
            //            {
    ...
    public CompletableFuture<List<Order>> fetchOpenOrders(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> response = (this.privateTradingPostFullV1OpenOrders(this.extend(request, parameters))).join();
            //
            //    {
            //        "result": [
            //            {
            ...
            //
            List<Object> result = (List<Object>) this.safeList(response, "result", new ArrayList<Object>(Arrays.asList()));
            return this.parseOrders(result, (Map<String, Object>) null, since, limit, new HashMap<String, Object>() {{}});
        }).thenApply(res -> ((List<?>) res).stream().map(Order::new).collect(Collectors.toList()));
    ...
    public Object parseOrder(Object order, Map<String, Object> market)
    {
        ...
        Boolean isMarket = (Boolean) this.safeBool(order, "is_market", (Object) null);
        String orderType = "limit";
        if (java.util.Objects.equals(isMarket, true))
        {
            orderType = "market";
        }
        Boolean isPostOnly = (Boolean) this.safeBool(order, "post_only", (Object) null);
        Boolean isReduceOnly = (Boolean) this.safeBool(order, "reduce_only", (Object) null);
        ...
        Map<String, Object> firstLeg = (Map<String, Object>) this.safeDict(legs, primaryOrderIndex, (Object) null);
        String legMarketId = this.safeString(firstLeg, "instrument");
        Object marketResolved = (((!java.util.Objects.equals(firstLeg, null)))) ? this.safeMarket(legMarketId, market, (String) null, (String) null) : market;
    ...
    public CompletableFuture<List<Order>> cancelAllOrders(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            //
            Map<String, Object> result = (Map<String, Object>) this.safeDict(response, "result", new HashMap<String, Object>() {{}});
            return this.parseOrders(new ArrayList<Object>(Arrays.asList(result)), (Map<String, Object>) null, (Long) null, (Long) null, new HashMap<String, Object>() {{}});
        }).thenApply(res -> ((List<?>) res).stream().map(Order::new).collect(Collectors.toList()));
    ...
    public CompletableFuture<Order> cancelOrder(String id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            (this.loadMarketsAndSignIn()).join();
            String subAccoubntId = this.getSubAccountId((Map<String, Object>) (parameters));
            Map<String, Object> request = new HashMap<String, Object>() {{
    ...
    public Map<String, Object> createSignedRequest(Map<String, Object> request, Object structureType, Object currencyObj, String signerAddress)
    {
        ...
        {
            messageData = this.eipMessageForOrder((Map<String, Object>) (request), (String) (structureType));
        } else if (java.util.Objects.equals(structureType, "EIP712_BUILDER_APPROVAL_TYPE"))
        {
    ...
    public Object handleUntilOptionString(Object key, Map<String, Object> request, Map<String, Object> parameters, Object multiplier)
    {
        ...
        {
            request.put((String)key, this.numberToString(this.parseToInt(Helpers.multiply(until, java.util.Objects.requireNonNullElse(multiplier, 1)))));
            return new ArrayList<Object>(Arrays.asList(request, this.omit(parameters, new ArrayList<Object>(Arrays.asList("until", "till")))));
        }
    ...
    public Object sign(Object path, Object api, Object method, Object parameters, Object headers, String body)
    {
        ...
        Boolean isPrivate = ((String)java.util.Objects.requireNonNullElse(api, "public")).startsWith("private");
        if (java.util.Objects.equals(isPrivate, true))
        {
            this.checkRequiredCredentials(true);
            if (!java.util.Objects.equals(queryString, ""))
            {
                requestPath = (Helpers.add(requestPath, "?") + queryString);
            }
            requestHeaders = new HashMap<String, Object>() {{
                put( "Content-Type", "application/json" );
            }};
            if ((java.util.Objects.equals(((String)requestPath).endsWith("auth/api_key/login"), true)) || (java.util.Objects.equals(((String)requestPath).endsWith("auth/wallet/login"), true)))
            {
                ((Map<String, Object>)requestHeaders).put("Cookie", "rm=true;");
            } else
            {
                ...
                if (java.util.Objects.equals(cookieValue, null) || java.util.Objects.equals(accountId, null))
                {
                    throw new AuthenticationError((this.id + " : at first, you need to authenticate with exchange using signIn() method.")) ;
                }
                ((Map<String, Object>)requestHeaders).put("Cookie", cookieValue);
