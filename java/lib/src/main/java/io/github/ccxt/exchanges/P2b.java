...
public class P2b extends P2bApi
{
   ...
   public P2b (Object options) {
    ...
    public Object parseMarket(Object market)
    {
        ...
        String base = ((String)this.safeCurrencyCode(baseId, (Map<String, Object>) null));
        String quote = ((String)this.safeCurrencyCode(quoteId, (Map<String, Object>) null));
    ...
    {
        Object url = Helpers.add(Helpers.add(Helpers.GetValue(((Map<String, Object>)this.urls).get("api"), java.util.Objects.requireNonNullElse(api, "public")), "/"), this.implodeParams(path, parameters));
