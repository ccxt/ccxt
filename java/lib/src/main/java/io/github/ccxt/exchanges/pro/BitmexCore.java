   ...
   public BitmexCore (Object options) {
    ...
    public Object handleTicker(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
        {
            ...
            String marketId = (String) this.safeString(update, "symbol");
    ...
    public void handleLiquidation(Client client, Object message)
    {
        ...
        java.util.List<String> symbols = (java.util.List<String>)(java.util.List) Helpers.objectKeys(liquidationsBySymbol);
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
        {
            Object symbol = Helpers.GetValue(symbols, i);
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "table");
    ...
    public void handleTrades(Client client, Object message)
    {
        ...
        java.util.List<String> marketIds = (java.util.List<String>)(java.util.List) Helpers.objectKeys(dataByMarketIds);
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(authenticated, null)))
            {
                ...
                String payload = Helpers.add(Helpers.add("GET", "/realtime"), String.valueOf(timestamp));
    ...
    public void handlePositions(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawPositions)); i++)
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(side, null)))
            {
                ...
                java.util.List<String> cachedSides = (java.util.List<String>)(java.util.List) Helpers.objectKeys(cachedBySide);
    ...
    public void handleOrders(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isGreaterThan(dataLength, 0)))
        {
            ...
            for (var i = 0; Helpers.isLessThan(i, dataLength); i++)
            {
                ...
                String orderId = (String) this.safeString(currentOrder, "orderID");
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        //     }
        //
        String table = (String) this.safeString(message, "table");
        String interval = (String) Helpers.replace((String)((String)table), (String)"tradeBin", (String)"");
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(candles)); i++)
        {
            ...
            String marketId = (String) this.safeString(candle, "symbol");
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
            Object symbol = Helpers.GetValue(market, "symbol");
            Object messageHash = Helpers.add(Helpers.add(table, ":"), Helpers.GetValue(market, "id"));
            java.util.List<Object> result = new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.subtract(this.parseToInt(this.parse8601(this.safeString(candle, "timestamp"))), Helpers.multiply(duration, 1000)), null, this.safeFloat(candle, "high"), this.safeFloat(candle, "low"), this.safeFloat(candle, "close"), this.safeFloat(candle, "volume")));
        ...
        java.util.List<String> messageHashes = (java.util.List<String>)(java.util.List) Helpers.objectKeys(results);
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(messageHashes)); i++)
        {
            Object messageHash = Helpers.GetValue(messageHashes, i);
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(action, "partial")))
        {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                String id = (String) this.safeString(Helpers.GetValue(data, i), "id");
                String side = (String) this.safeString(Helpers.GetValue(data, i), "side");
                ...
                String datetime = (String) this.safeString(Helpers.GetValue(data, i), "timestamp");
        ...
        {
            java.util.Map<String, Object> numUpdatesByMarketId = new java.util.HashMap<String, Object>() {{}};
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
            ...
            java.util.List<String> marketIds = (java.util.List<String>)(java.util.List) Helpers.objectKeys(numUpdatesByMarketId);
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(marketIds)); i++)
            {
                Object marketId = Helpers.GetValue(marketIds, i);
                java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
