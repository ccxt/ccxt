   ...
   public Deribit (Object options) {
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(Object symbol, Object timeframe, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                return (this.fetchPaginatedCallDeterministic("fetchOHLCV", Helpers.toStringArg(symbol), since, limit, Helpers.toStringArg(java.util.Objects.requireNonNullElse(timeframe, "1m")), Helpers.toMapArg(paramsPaginate), Helpers.toLongOrNull(5000))).join();
            }
            Map<String, Object> market = (Map<String, Object>) this.market(symbol);
            Map<String, Object> request = new HashMap<String, Object>() {{
                put( "instrument_name", ((Map<String, Object>)market).get("id") );
            ...
            Object sinceResolved = (((java.util.Objects.equals(since, null)))) ? null : Helpers.mathMax(Helpers.subtract(since, 1), 0);
            ...
            } else
            {
                ...
                {
                    request.put("end_timestamp", this.sum(sinceResolved, Helpers.multiply(Helpers.multiply(limit, duration), 1000)));
                }
            }
    ...
    public CompletableFuture<List<FundingRateHistory>> fetchFundingRateHistory(String symbol, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object time = (((java.util.Objects.equals(since, null)))) ? now : Helpers.add(since, month);
            Map<String, Object> request = Helpers.newMap(
                "instrument_name", ((Map<String, Object>)market).get("id"),
            ...
            if (Boolean.TRUE.equals(isPaginationCall))
            {
                ...
                Object maxUntil = this.sum(sinceResolved, Helpers.multiply(limit, duration));
