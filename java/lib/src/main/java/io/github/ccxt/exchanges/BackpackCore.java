   ...
   public BackpackCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object currecy = Helpers.GetValue(response, i);
                Object currencyId = this.safeString(currecy, "symbol");
                Object code = this.safeCurrencyCode(currencyId);
                Object networks = this.safeList(currecy, "tokens", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        put( "precision", null );
        put( "type", "crypto" );
        put( "name", BackpackCore.this.safeString(currecy, "displayName") );
