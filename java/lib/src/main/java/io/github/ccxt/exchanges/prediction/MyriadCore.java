...
public class MyriadCore extends MyriadApi
{
   ...
   public MyriadCore (Object options) {
    ...
    public Object signEvmTransaction(Object tx, Object privateKey)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual((Helpers.mod(Helpers.getArrayLength(rHex), 2)), 0)))
        {
            rHex = Helpers.add("0", rHex);
        }
        if (Helpers.isTrue(!Helpers.isEqual((Helpers.mod(Helpers.getArrayLength(sHex), 2)), 0)))
        {
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrders(Object orders, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                ((java.util.List<Object>)orderOutcomes).add(this.safeString(Helpers.GetValue(orders, i), "outcome"));
            }
    ...
    public java.util.concurrent.CompletableFuture<Object> createAmmOrder(Object outcome, Object type, Object side2, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(sideLower, "buy"))) && !Helpers.isTrue(isCostDenominated)))
            {
            ...
            Object quoteParams = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("rpcUrl", "rpc", "token", "tokenAddress", "gasLimit", "costDenominated")));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchEvents(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            } else
            {
                ...
                rawMarkets = (this.fetchRawMarketsBySearch(tagQueries, rest)).join();
            }
