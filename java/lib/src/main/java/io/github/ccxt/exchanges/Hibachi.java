   ...
   public Hibachi (Object options) {
    ...
    public CompletableFuture<OrderBook> fetchOrderBook(Object symbol, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            formattedResponse.put("ask", this.safeList(this.safeDict(response, "ask"), "levels"));
            formattedResponse.put("bid", this.safeList(this.safeDict(response, "bid"), "levels"));
            // {
            //     "ask": {
            //         "endPrice": "3512.63",
            //         "levels": [
     ...
     */
    public CompletableFuture<List<OHLCV>> fetchOHLCV(String symbol, Object timeframe2, Long since2, Long limit, Map<String, Object> parameters2)
    {
