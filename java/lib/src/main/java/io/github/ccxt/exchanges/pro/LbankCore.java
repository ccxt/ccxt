   ...
   public LbankCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCVWs(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String timeframeId = (String) this.safeString(timeframes, timeframe, timeframe);
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        //      }
        //
        String marketId = (String) this.safeString(message, "pair");
        ...
        if (Helpers.isTrue(!Helpers.isEqual(records, null)))
        {
            ...
            String timeframeId = (String) this.safeString(message, "kbar");
        ...
        } else
        {
            ...
            String timeframeId = (String) this.safeString(rawOHLCV, "slot");
            String datetime = (String) this.safeString(rawOHLCV, "t");
    ...
    public Object parseWsTicker(Object ticker, Object... optionalArgs)
    {
        ...
        String marketId = (String) this.safeString(ticker, "pair");
        String symbol = (String) this.safeSymbol(marketId, market);
        String datetime = (String) this.safeString(ticker, "TS");
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        String rawSide = (String) this.safeString2(trade, "direction", 3);
        java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(((String)rawSide), "_");
        String firstPart = (String) this.safeString(parts, 0);
        String secondPart = (String) this.safeString(parts, 1);
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        String rawType = (String) this.safeString(orderUpdate, "type", "");
        java.util.List<Object> typeParts = (java.util.List<Object>) Helpers.split(rawType, "_");
        String side = (String) this.safeString(typeParts, 0);
        String exchangeType = (String) this.safeString(typeParts, 1);
        String type = null;
        ...
        String marketId = (String) this.safeString(order, "pair");
        String symbol = (String) this.safeSymbol(marketId, market, "_");
        Long timestamp = this.safeInteger(orderUpdate, "updateTime");
        String status = (String) this.safeString(orderUpdate, "orderStatus");
        String orderAmount = (String) this.safeString(orderUpdate, "orderAmt");
        Object cost = null;
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        String datetime = (String) this.iso8601(timestamp);
        ...
        String currencyId = (String) this.safeString(data, "assetCode");
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        String datetime = (String) this.safeString(message, "TS");
    ...
    public java.util.concurrent.CompletableFuture<Object> handlePing(Client client, Object message)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String pingId = (String) this.safeString(message, "ping");
            try
            {
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        String type = (String) this.safeString2(message, "type", "action");
        ...
        put( "expires", LbankCore.this.sum(now, 3300000) );
                ...
                } else
                {
                    ...
                    if (Helpers.isTrue(Helpers.isLessThan(expires, now)))
                    {
                        ...
                        //    {"result": "true"}
                        //
                        String result = (String) this.safeString(response, "result");
                        if (Helpers.isTrue(!Helpers.isEqual(result, "true")))
                        {
