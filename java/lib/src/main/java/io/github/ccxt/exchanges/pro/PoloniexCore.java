   ...
   public PoloniexCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String timestamp = (String) this.numberToString(this.milliseconds());
            ...
            if (Helpers.isTrue(Helpers.isEqual(future, null)))
            {
                ...
                String requestString = Helpers.add(Helpers.add(Helpers.add("GET\n", accessPath), "\nsignTimestamp="), timestamp);
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(uppercaseType, "MARKET"))) && Helpers.isTrue((Helpers.isEqual(uppercaseSide, "BUY")))))
            {
                ...
                } else if (Helpers.isTrue(createMarketBuyOrderRequiresPrice))
                {
                    ...
                    {
                        String amountString = (String) this.numberToString(amount);
            ...
            if (Helpers.isTrue(!Helpers.isEqual(marketId, null)))
            {
                ...
                } else
                {
                    ...
                    for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(previousOrderTrades)); j++)
                    {
                        ...
                        String cost = (String) this.numberToString(Helpers.GetValue(previousOrderTrade, "cost"));
                        String amount = (String) this.numberToString(Helpers.GetValue(previousOrderTrade, "amount"));
                    ...
                    {
                        String tradeAmount = (String) this.numberToString(Helpers.GetValue(trade, "amount"));
                        String previousOrderFilled = (String) this.numberToString(Helpers.GetValue(previousOrder, "filled"));
                        ...
                        {
                            String previousOrderAmount = (String) this.numberToString(Helpers.GetValue(previousOrder, "amount"));
