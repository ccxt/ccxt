...
final Object finalPointFee = pointFee;
    ...
    public Map<String, Object> editOrderRequest(Object id, String symbol, Object type, Object side, Object amount, Object price, Map<String, Object> parameters)
    {
        Map<String, Object> market = (Map<String, Object>) this.market(symbol);
    ...
    public Map<String, Object> editOrderRequest(Object id, String symbol, Object type, Object side, Object... optionalArgs)
    {
    ...
    public CompletableFuture<Order> editOrder(String id, String symbol, Object type, Object side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            (this.loadUnifiedStatus()).join();
            Map<String, Object> market = (Map<String, Object>) this.market(symbol);
            Map<String, Object> extendedRequest = this.editOrderRequest(id, (String) (symbol), type, side, amount, price, parameters);
            Map<String, Object> response = null;
            if (java.util.Objects.equals(((Map<String, Object>)market).get("spot"), true))
            {
...
final Object finalRebate = rebate;
    ...
    public CompletableFuture<List<Order>> fetchClosedOrders(String symbol2, Long since2, Long limit2, Map<String, Object> parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            useHistorical = Boolean.TRUE.equals(((List<Object>) useHistoricalparametersVariable).get(0));
