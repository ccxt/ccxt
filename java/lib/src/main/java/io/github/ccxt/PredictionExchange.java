    ...
    public java.util.concurrent.CompletableFuture<Object> fetchL2OrderBook(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            return this.extend(orderbook, new java.util.HashMap<String, Object>() {{
                put( "asks", PredictionExchange.this.sortBy(PredictionExchange.this.aggregate(Helpers.GetValue(orderbook, "asks")), 0) );
                put( "bids", PredictionExchange.this.sortBy(PredictionExchange.this.aggregate(Helpers.GetValue(orderbook, "bids")), 0, true) );
            }});
        });
