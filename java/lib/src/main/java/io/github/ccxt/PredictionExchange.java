    ...
    public CompletableFuture<Object> loadOutcomes(Object outcomes, Object reload, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(outcomes, null))
            {
                ...
                if ((Helpers.isGreaterThan(missingLength, 0)) && (java.util.Objects.equals(loadAll, true)) && !Boolean.TRUE.equals(wasWarm) && !Helpers.isTrue(java.util.Objects.requireNonNullElse(reload, false)))
                {
