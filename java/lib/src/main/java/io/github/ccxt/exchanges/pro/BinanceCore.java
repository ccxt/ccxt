...
public class BinanceCore extends io.github.ccxt.exchanges.Binance
{
   ...
   public BinanceCore (Object options) {
    ...
    public Object stream(Object type, Object subscriptionHash, Object... optionalArgs)
    {
        ...
        String stream = (String) this.safeString(streamBySubscriptionsHash, subscriptionHash);
    ...
    public Object getWsUrl(Object type, Object category)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(type, "future")))
        {
            ...
            //     return baseUrl;
            // }
            java.util.List<Object> baseUrlSplit = (java.util.List<Object>) Helpers.split(baseUrl, "://");
            Integer baseUrlSplitLength = Helpers.getArrayLength(baseUrlSplit);
    ...
    public Object getStockTickerFromSymbol(Object symbol)
    {
        ...
        String base = (String) this.safeString2(market, "base", "id");
     ...
     */
    public java.util.concurrent.CompletableFuture<Object> watchStockMarketStream(Object streams, Object messageHashes, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object query = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("stock", "name", "callerMethodName", "type", "subType", "symbol", "timeframe")));
    ...
    public java.util.concurrent.CompletableFuture<Object> watchLiquidationsForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<Object> subscriptionHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            ...
            Integer numSubscriptions = Helpers.getArrayLength(subscriptionHashes);
    ...
    public void handleLiquidation(Client client, Object message)
    {
        ...
        String marketId = (String) this.safeString(rawLiquidation, "s");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId, null, "", "contract");
    ...
    public Object parseWsLiquidation(Object liquidation, Object... optionalArgs)
    {
        ...
        String marketId = (String) this.safeString(liquidation, "s");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyLiquidationsForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.List<Object> messageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList("myLiquidations"));
            if (!Helpers.isTrue(this.isEmpty(symbols)))
            {
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
                {
    ...
    public void handleMyLiquidation(Client client, Object message)
    {
        ...
        //    }
        //
        String orderType = (String) this.safeString(message, "o");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Integer messageHashesLength = Helpers.getArrayLength(messageHashes);
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOrderBookForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String watchOrderBookRate = (String) this.safeString(this.options, "watchOrderBookRate", "100");
            java.util.List<Object> subParams = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            java.util.List<Object> subMessageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            java.util.List<Object> messageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
            {
                Object symbol = Helpers.GetValue(symbols, i);
            ...
            Integer messageHashesLength = Helpers.getArrayLength(subMessageHashes);
    ...
    public void handleOrderBookSubscription(Client client, Object message, Object subscription)
    {
        ...
        String symbolOfSubscription = (String) this.safeString(subscription, "symbol"); // watchOrderBook
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTradesForSymbols(Object symbols2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(isOption, true)))
            {
                ...
                java.util.Map<String, Object> seenUnderlyings = new java.util.HashMap<String, Object>() {{}};
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
                {
                    Object symbol = Helpers.GetValue(symbols, i);
                    java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
                    ...
                    if (!Helpers.isTrue((Helpers.inOp(seenUnderlyings, underlying))))
                    {
                        ...
                        ((java.util.List<Object>)subParams).add(Helpers.add(underlying, "@optionTrade"));
                    }
                }
            } else
            {
            ...
            Integer subParamsLength = Helpers.getArrayLength(subParams);
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String executionType = (String) this.safeString(trade, "x");
        Boolean isTradeExecution = (Helpers.isEqual(executionType, "TRADE"));
        if (!Helpers.isTrue(isTradeExecution))
        {
            return this.parseTrade(trade, market);
        }
        String id = (String) this.safeString2(trade, "t", "a");
        Long timestamp = this.safeInteger(trade, "T");
        String price = (String) this.safeString2(trade, "L", "p");
        String amount = (String) this.safeString(trade, "q");
        if (Helpers.isTrue(isTradeExecution))
        {
            amount = this.safeString(trade, "l", amount);
        }
        String cost = (String) this.safeString(trade, "Y");
        ...
        String orderId = (String) this.safeString(trade, "i");
        ...
        Object fee = null;
        String feeCost = (String) this.safeString(trade, "n");
        if (Helpers.isTrue(!Helpers.isEqual(feeCost, null)))
        {
            String feeCurrencyId = (String) this.safeString(trade, "N");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCVForSymbols(Object symbolsAndTimeframes, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(stock))
            {
                ...
                Object stockMessageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbolsAndTimeframes)); i++)
                {
                    ...
                    String stockSymbolString = (String) this.symbol(Helpers.GetValue(stockSymAndTf, 0));
                    java.util.Map<String, Object> stockMarket = (java.util.Map<String, Object>) this.market(stockSymbolString);
                    String stockTicker = (String) this.safeString2(stockMarket, "base", "id");
                    ...
                    String stockInterval = (String) this.safeString(this.timeframes, stockTimeframeString, stockTimeframeString);
                ...
                var stockSymbol = ((java.util.List<Object>) stockSymbolstockTimeframestockCandlesVariable).get(0);
                var stockTimeframe = ((java.util.List<Object>) stockSymbolstockTimeframestockCandlesVariable).get(1);
                var stockCandles = ((java.util.List<Object>) stockSymbolstockTimeframestockCandlesVariable).get(2);
                if (Helpers.isTrue(this.newUpdates))
                {
            ...
            java.util.Map<String, Object> firstMarket = (java.util.Map<String, Object>) this.market(Helpers.GetValue(marketSymbols, 0));
            Object type = Helpers.GetValue(firstMarket, "type");
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbolsAndTimeframes)); i++)
            {
                ...
                String interval = (String) this.safeString(this.timeframes, timeframeString, timeframeString);
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> eventMap = new java.util.HashMap<String, Object>() {{
        ...
        String marketId = (String) this.safeString2(kline, "s", "ps");
        if (Helpers.isTrue(Helpers.isEqual(eventVar, "indexPriceKline")))
        {
            // indexPriceKline doesn't have the _PERP suffix
            marketId = this.safeString(message, "ps");
        }
        String interval = (String) this.safeString(kline, "i");
        // use a reverse lookup in a static map instead
        Object unifiedTimeframe = this.findTimeframe(interval);
        java.util.List<Object> parsed = new java.util.ArrayList<Object>(java.util.Arrays.asList(this.safeInteger(kline, "t"), this.safeFloat(kline, "o"), this.safeFloat(kline, "h"), this.safeFloat(kline, "l"), this.safeFloat(kline, "c"), this.safeFloat(kline, "v")));
        // resolve the market from the transport url — an ambiguous id like
        // BTCUSDT maps to both the spot and the linear swap market
        Object isSpot = this.isSpotUrl(client);
        String marketType = ((Helpers.isTrue(isSpot))) ? "spot" : "contract";
    ...
    public void handleFetchOHLCV(Client client, Object message)
    {
        ...
        //    }
        //
        java.util.List<Object> result = (java.util.List<Object>) this.safeList(message, "result");
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(stock))
            {
                ...
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
                {
                    ...
                    ((java.util.List<Object>)stockStreams).add(Helpers.add(stockTicker, "@quote"));
                    ((java.util.List<Object>)stockMessageHashes).add(Helpers.add("stock:quote:", Helpers.GetValue(symbols, i)));
                }
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMultiTickerHelper(Object methodName, Object channelName2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String userDefaultType = (String) this.safeString(this.options, "defaultType");
            ...
            java.util.List<Object> messageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            java.util.List<Object> unsubscribeMessageHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            String suffix = "";
            ...
            if (Helpers.isTrue(!Helpers.isEqual(symbols, null)))
            {
                ...
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(symbols)); i++)
                {
                    ...
                    if (Helpers.isTrue(isOptionMarkPrice))
                    {
                        ...
                        {
                            Helpers.addElementToObject(seenUnderlyings, underlying, true);
                            ((java.util.List<Object>)subscriptionArgs).add(Helpers.add(underlying, "@optionMarkPrice"));
                        }
                    } else if (Helpers.isTrue(isOptionTicker))
                    {
                        ...
                        String marketId = (String) this.safeString(market, "id", "");
                        java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(marketId, "-");
                        String expiryDate = (String) this.safeString(parts, 1);
                        String baseIdLower = (String)this.safeStringLower(market, "baseId", "");
                        String quoteIdLower = (String)this.safeStringLower(market, "quoteId", "");
                        Object underlying = Helpers.add(Helpers.add(baseIdLower, ""), quoteIdLower);
                        ...
                        if (!Helpers.isTrue((Helpers.inOp(seenUnderlyings, subscriptionArg))))
                        {
                            ...
                            ((java.util.List<Object>)subscriptionArgs).add(subscriptionArg);
                        }
                    } else
                    {
                        Object streamId = Helpers.GetValue(market, "lowercaseId");
                        ((java.util.List<Object>)subscriptionArgs).add(Helpers.add(Helpers.add(Helpers.add(streamId, "@"), channelName), suffix));
                    }
                }
            } else
            {
                if (Helpers.isTrue(Helpers.isEqual(marketType, "option")))
                {
                    ...
                    if (Helpers.isTrue(isOptionTicker))
                    {
                        ...
                        String expirationDate = (String) this.safeString(parameters, "expirationDate");
            ...
            java.util.List<Object> hashes = messageHashes;
            java.util.Map<String, Object> subscription = new java.util.HashMap<String, Object>() {{
                put( "id", requestId );
            }};
            if (Helpers.isTrue(isUnsubscribe))
            ...
            java.util.List<Object> waitHashes = hashes;
            if (Helpers.isTrue(Helpers.isTrue(isOptionMarkPrice) && !Helpers.isTrue(isUnsubscribe)))
            {
                waitHashes = new java.util.ArrayList<Object>(java.util.Arrays.asList(Helpers.add(Helpers.add(unifiedPrefix, "s:"), channelName)));
            }
    ...
    public Object parseWsTicker(Object message, Object marketType)
    {
        ...
        //      }
        //
        String marketId = (String) this.safeString2(message, "s", "symbol");
        String symbol = (String) this.safeSymbol(marketId, null, null, marketType);
        String eventVar = (String) this.safeString(message, "e", "bookTicker");
        ...
        if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(eventVar, "markPriceUpdate")) || Helpers.isTrue(Helpers.isEqual(eventVar, "markPrice"))))
        {
            ...
            return this.safeTicker(new java.util.HashMap<String, Object>() {{
                ...
                put( "info", message );
                put( "markPrice", BinanceCore.this.safeString2(message, "mp", "p") );
        ...
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId, null, null, marketType);
        String last = (String) this.safeString2(message, "c", "price");
        ...
        String quoteVolume = (String) this.safeString(message, "q");
        if (Helpers.isTrue(Helpers.isEqual(Helpers.GetValue(market, "inverse"), true)))
        {
            Object contracts = baseVolume;
            baseVolume = quoteVolume;
            String weightedAverage = (String) this.safeString(message, "w");
    ...
    public void handleTickersAndBidsAsks(Client client, Object message, Object methodType)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawTickers)); i++)
        {
            ...
            String eventVar = (String) this.safeString(ticker, "e");
            if (Helpers.isTrue(isBidAsk))
            {
            ...
            String tickerMarketId = (String) this.safeString(ticker, "s");
        ...
        Integer length = Helpers.getArrayLength(resolvedMessageHashes);
    ...
    public java.util.concurrent.CompletableFuture<Object> ensureUserDataStreamWsSubscribeListenToken(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> options = (java.util.Map<String, Object>) this.safeDict(this.options, marketType, new java.util.HashMap<String, Object>() {{}});
            ...
            if (Helpers.isTrue(Helpers.isGreaterThan(Helpers.subtract(time, lastAuthenticatedTime), delay)))
            {
                ...
                try
                {
                    ...
                    String symbol = (String) this.safeString(parameters, "symbol");
                    ...
                    java.util.Map<String, Object> response = (this.sapiPostUserListenToken(request)).join();
                    String listenToken = (String) this.safeString(response, "token");
    ...
    public java.util.concurrent.CompletableFuture<Object> renewListenToken(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> options = (java.util.Map<String, Object>) this.safeDict(this.options, type, new java.util.HashMap<String, Object>() {{}});
            String symbol = (String) this.safeString(options, "symbol");
    ...
    public java.util.concurrent.CompletableFuture<Object> keepAliveListenKey(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
            String type = (String) this.safeString2(this.options, "defaultType", "authenticate", "spot");
            ...
            Boolean isStock = (Helpers.isEqual(type, "stock"));
            Object options = this.safeValue(this.options, type, new java.util.HashMap<String, Object>() {{}});
            String listenKey = (String) this.safeString(options, "listenKey");
            if (Helpers.isTrue(Helpers.isEqual(listenKey, null)))
            {
        ...
        put( "lastAuthenticatedTime", time );
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(clients)); i++)
            {
                ...
                java.util.Map<String, Object> clientSubscriptions = (java.util.Map<String, Object>) this.safeDict(client, "subscriptions", new java.util.HashMap<String, Object>() {{}});
    ...
    public java.util.concurrent.CompletableFuture<Object> loadBalanceSnapshot(Client client, Object messageHash2, Object type2, Object isPortfolioMargin2)
    {
    ...
    public void handlePositionsWs(Client client, Object message)
    {
        ...
        java.util.List<Object> positions = new java.util.ArrayList<Object>(java.util.Arrays.asList());
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(result)); i++)
        {
            ...
            String entryPrice = (String) this.safeString(parsed, "entryPrice");
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        //    }
        //
        String wallet = (String) this.safeString(this.options, "wallet", "wb"); // cw for cross wallet
        ...
        {
            String currencyId = (String) this.safeString(message, "a");
            String code = (String) this.safeCurrencyCode(currencyId);
            Object account = this.account();
            String delta = (String) this.safeString(message, "d");
        ...
        } else
        {
            ...
            java.util.List<Object> B = (java.util.List<Object>) this.safeList(message, "B");
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(B)); i++)
            {
                ...
                String currencyId = (String) this.safeString(entry, "a");
                String code = (String) this.safeCurrencyCode(currencyId);
                Object account = this.account();
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrderWs(Object symbol, Object type, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String triggerPrice = (String) this.safeString2(parameters, "triggerPrice", "stopPrice");
            String stopLossPrice = (String) this.safeString(parameters, "stopLossPrice", triggerPrice);
            String takeProfitPrice = (String) this.safeString(parameters, "takeProfitPrice");
            String trailingDelta = (String) this.safeString(parameters, "trailingDelta");
            String trailingPercent = (String) this.safeStringN(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("trailingPercent", "callbackRate", "trailingDelta")));
    ...
    public void handleOrdersWs(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "id");
        java.util.List<Object> result = (java.util.List<Object>) this.safeList(message, "result", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        java.util.List<java.util.Map<String, Object>> orders = this.parseOrders(result);
    ...
    public void handleEditOrderWs(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "id");
        java.util.Map<String, Object> result = (java.util.Map<String, Object>) this.safeDict(message, "result", new java.util.HashMap<String, Object>() {{}});
        java.util.Map<String, Object> newSpotOrder = (java.util.Map<String, Object>) this.safeDict(result, "newOrderResponse");
        Object order = null;
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrderWs(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String clientOrderId = (String) this.safeStringN(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("clientAlgoId", "origClientOrderId", "clientOrderId")));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderWs(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String clientOrderId = (String) this.safeString2(parameters, "origClientOrderId", "clientOrderId");
            if (Helpers.isTrue(!Helpers.isEqual(clientOrderId, null)))
            {
                Helpers.addElementToObject(payload, "origClientOrderId", clientOrderId);
            } else
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(stock))
            {
                ...
                java.util.Map<String, Object> stockOptions = (java.util.Map<String, Object>) this.safeDict(this.options, "stock", new java.util.HashMap<String, Object>() {{}});
                String stockListenKey = (String) this.safeString(stockOptions, "listenKey");
                ...
                java.util.Map<String, Object> stockRequest = new java.util.HashMap<String, Object>() {{
                    put( "method", "SUBSCRIBE" );
                    put( "params", new java.util.ArrayList<Object>(java.util.Arrays.asList(stockStreamName)) );
                    put( "id", stockRequestId );
                }};
                Object stockQuery = this.omit(parameters, new java.util.ArrayList<Object>(java.util.Arrays.asList("stock", "name", "callerMethodName", "type", "subType", "symbol", "timeframe")));
                java.util.Map<String, Object> stockSubscribe = new java.util.HashMap<String, Object>() {{
                    put( "id", stockRequestId );
                }};
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String eventVar = (String) this.safeString(order, "e");
        if (Helpers.isTrue(Helpers.isEqual(eventVar, "orderReport")))
        {
            String baseAssetCode = (String) this.safeString(order, "b");
            ...
            String stockQuote = (String) this.safeString(order, "q", "USDC");
            ...
            String stockStatus = (String) this.safeString(statuses, stockRawStatus, stockRawStatus);
            String stockAmount = (String) this.safeString(order, "Q");
            String stockFilled = (String) this.safeString(order, "fq");
            ...
            return this.safeOrder(new java.util.HashMap<String, Object>() {{
                ...
                put( "id", BinanceCore.this.safeString(order, "i") );
                put( "timestamp", stockTimestamp );
                put( "datetime", BinanceCore.this.iso8601(stockTimestamp) );
                put( "lastUpdateTimestamp", stockLastUpdateTimestamp );
                put( "type", BinanceCore.this.parseOrderTypeByMarket(BinanceCore.this.safeStringLower(order, "o"), "spot") );
                ...
                put( "cost", BinanceCore.this.safeString(order, "FN") );
                put( "average", null );
        ...
        String executionType = (String) this.safeString(order, "x");
        ...
        Object fee = null;
        String feeCost = (String) this.safeString(order, "n");
        ...
        String rawStatus = (String) this.safeString(order, "X");
        String status = (String) this.parseOrderStatus(rawStatus);
        String clientOrderId = (String) this.safeString2(order, "C", "caid");
        ...
        String stopPrice = (String) this.safeStringN(order, new java.util.ArrayList<Object>(java.util.Arrays.asList("P", "sp", "tp")));
        String timeInForce = (String) this.safeString(order, "f");
    ...
    public void handleStockPrice(Client client, Object message)
    {
        ...
        //     }
        //
        java.util.List<Object> rates = (java.util.List<Object>) this.safeList(message, "rates", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        {
            java.util.Map<String, Object> rate = (java.util.Map<String, Object>) this.safeDict(rates, i, new java.util.HashMap<String, Object>() {{}});
            String stockSymbol = (String) this.safeString(rate, "s");
            ...
            final Object finalSymbol = symbol;
            java.util.Map<String, Object> parsed = this.safeTicker(new java.util.HashMap<String, Object>() {{
                put( "symbol", finalSymbol );
                put( "timestamp", timestamp );
                put( "datetime", BinanceCore.this.iso8601(timestamp) );
                put( "last", BinanceCore.this.safeString(rate, "p") );
                put( "close", BinanceCore.this.safeString(rate, "p") );
                put( "previousClose", BinanceCore.this.safeString(rate, "pc") );
                put( "info", rate );
            }});
    ...
    {
        String stockSymbol = (String) this.safeString(message, "s");
        Object symbol = this.getStockUnifiedSymbol(stockSymbol, "USDC");
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            return;
        ...
        java.util.Map<String, Object> parsed = this.safeTicker(new java.util.HashMap<String, Object>() {{
            ...
            put( "timestamp", timestamp );
            put( "datetime", BinanceCore.this.iso8601(timestamp) );
            put( "bid", BinanceCore.this.safeString(message, "bp") );
            put( "ask", BinanceCore.this.safeString(message, "ap") );
            put( "bidVolume", BinanceCore.this.safeString(message, "bs") );
            put( "askVolume", BinanceCore.this.safeString(message, "as") );
            put( "info", message );
        }});
    ...
    public void handleOptionsOrderUpdate(Client client, Object message)
    {
        ...
        //     }
        //
        java.util.List<Object> orders = (java.util.List<Object>) this.safeList(message, "o", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(orders)); i++)
        {
            Object order = Helpers.GetValue(orders, i);
            java.util.List<Object> fills = (java.util.List<Object>) this.safeList(order, "fi", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            String rawQty = (String) this.safeString(order, "q", "0");
            String side = "BUY";
            ...
            java.util.Map<String, Object> normalizedOrder = new java.util.HashMap<String, Object>() {{
                put( "s", BinanceCore.this.safeString(order, "s") );
                put( "i", BinanceCore.this.safeString(order, "oid") );
                put( "c", BinanceCore.this.safeString(order, "c") );
                put( "S", finalSide );
                put( "o", BinanceCore.this.safeString(order, "oty") );
                put( "f", BinanceCore.this.safeString(order, "tif") );
                put( "q", absQty );
                put( "p", BinanceCore.this.safeString(order, "p") );
                put( "X", BinanceCore.this.safeString(order, "S") );
                put( "x", finalExecutionType );
                put( "z", BinanceCore.this.safeString(order, "e") );
                put( "Z", BinanceCore.this.safeString(order, "ec") );
                put( "n", BinanceCore.this.safeString(order, "f") );
                put( "T", BinanceCore.this.safeInteger(order, "t") );
                put( "O", BinanceCore.this.safeInteger(order, "T") );
            }};
            ...
            for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(fills)); j++)
            {
                ...
                java.util.Map<String, Object> normalizedTrade = new java.util.HashMap<String, Object>() {{
                    put( "x", "TRADE" );
                    put( "s", BinanceCore.this.safeString(order, "s") );
                    put( "t", BinanceCore.this.safeString(fill, "t") );
                    put( "L", BinanceCore.this.safeString(fill, "p") );
                    put( "l", BinanceCore.this.safeString(fill, "q") );
                    put( "T", BinanceCore.this.safeInteger(fill, "T") );
                    put( "m", isMaker );
                    put( "n", BinanceCore.this.safeString(fill, "f") );
                    put( "i", BinanceCore.this.safeString(order, "oid") );
                    put( "S", finalSide );
                    put( "o", BinanceCore.this.safeString(order, "oty") );
                }};
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPositions(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> marketTypeObject = new java.util.HashMap<String, Object>() {{}};
    ...
    public java.util.concurrent.CompletableFuture<Object> loadPositionsSnapshot(Client client, Object messageHash2, Object type2, Object isPortfolioMargin2)
    {
        final Object messageHash3 = messageHash2;
        final Object type3 = type2;
        final Object isPortfolioMargin3 = isPortfolioMargin2;
    ...
    public void handlePositions(Client client, Object message)
    {
        ...
        java.util.List<Object> rawPositions = (java.util.List<Object>) this.safeList(data, "P", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public Object parseWsOptionsPosition(Object position, Object... optionalArgs)
    {
        ...
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String marketId = (String) this.safeString(position, "s");
        String contracts = (String) this.safeString(position, "c");
        ...
        return this.safePosition(new java.util.HashMap<String, Object>() {{
            put( "info", position );
            put( "id", null );
            put( "symbol", BinanceCore.this.safeSymbol(marketId, market, null, "option") );
            put( "notional", BinanceCore.this.safeString(position, "p") );
            put( "marginMode", null );
            put( "liquidationPrice", null );
            put( "entryPrice", BinanceCore.this.safeNumber(position, "a") );
    ...
    public void handleTradesWs(Client client, Object message)
    {
        ...
        String messageHash = (String) this.safeString(message, "id");
        java.util.List<Object> result = (java.util.List<Object>) this.safeList(message, "result", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        java.util.List<java.util.Map<String, Object>> trades = this.parseTrades(result);
    ...
    {
        String messageHash = (String) "myTrades";
        String executionType = (String) this.safeString(message, "x");
        if (Helpers.isTrue(Helpers.isEqual(executionType, "TRADE")))
        {
            Object trade = this.parseWsTrade(message);
            String orderId = (String) this.safeString(trade, "order");
            ...
            if (Helpers.isTrue(Helpers.isTrue(Helpers.isTrue(!Helpers.isEqual(orderId, null)) && Helpers.isTrue(!Helpers.isEqual(tradeFee, null))) && Helpers.isTrue(!Helpers.isEqual(symbol, null))))
            {
                ...
                if (Helpers.isTrue(!Helpers.isEqual(cachedOrders, null)))
                {
                    ...
                    if (Helpers.isTrue(!Helpers.isEqual(order, null)))
                    {
                        ...
                        java.util.List<Object> orderTrades = (java.util.List<Object>) this.safeList(order, "trades", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public void handleOptionsAccountUpdate(Client client, Object message)
    {
        ...
        java.util.List<Object> B = (java.util.List<Object>) this.safeList(message, "B", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(B)); i++)
        {
            Object entry = Helpers.GetValue(B, i);
            String currencyId = (String) this.safeString(entry, "a");
        ...
        Object cache = Helpers.GetValue(this.positions, accountType);
        java.util.List<Object> P = (java.util.List<Object>) this.safeList(message, "P", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        java.util.List<Object> newPositions = new java.util.ArrayList<Object>(java.util.Arrays.asList());
    ...
    public void handleWsError(Client client, Object message)
    {
        ...
        try
        {
            this.handleErrors(codeValue, ((String)msg), client.url, "", new java.util.HashMap<String, Object>() {{}}, this.json(error), error, new java.util.HashMap<String, Object>() {{}}, new java.util.HashMap<String, Object>() {{}});
        } catch(Exception e)
        {
            rejected = true;
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(subscriptionKeys)); i++)
            {
                ...
                String subscriptionId = (String) this.safeString(Helpers.GetValue(client.subscriptions, subscriptionHash), "id");
                String subscription = (String) this.safeString(Helpers.GetValue(client.subscriptions, subscriptionHash), "subscription");
        ...
        String codeString = (String) this.safeString(error, "code");
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        String streamWrapper = (String) this.safeString(message, "stream");
        if (Helpers.isTrue(!Helpers.isEqual(streamWrapper, null)))
        {
            message = this.safeDict(message, "data", message);
        }
        // handle WebSocketAPI
        java.util.Map<String, Object> eventMsg = (java.util.Map<String, Object>) this.safeDict(message, "event");
        if (Helpers.isTrue(!Helpers.isEqual(eventMsg, null)))
        {
            message = eventMsg;
        }
        // handle combined stream wrapper payloads
        java.util.Map<String, Object> eventData = (java.util.Map<String, Object>) this.safeDict(message, "data");
        ...
        if (Helpers.isTrue(Helpers.isEqual(method, null)))
        {
            String requestId = (String) this.safeString(message, "id");
