    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
            {
                ...
                Object chains = this.safeList(currency, "blockChain", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        put( "type", null );
        put( "margin", null );
        put( "name", AscendexCore.this.safeString(currency, "assetName") );
        put( "active", null );
        put( "deposit", null );
        put( "withdraw", null );
        put( "fee", null );
        ...
        put( "limits", new java.util.HashMap<String, Object>() {{
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", AscendexCore.this.safeNumber(currency, "minWithdrawalAmt") );
                put( "max", null );
            }} );
        }} );
