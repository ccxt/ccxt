...
public class WooCore extends io.github.ccxt.exchanges.Woo
{
   ...
   public WooCore (Object options) {
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        String method = (String) this.safeString(Helpers.split(topic, "@"), 1);
        if (Helpers.isTrue(Helpers.isEqual(method, "orderbookupdate")))
        {
    ...
    public void handleOrderBookSubscription(Client client, Object message, Object subscription)
    {
        Long defaultLimit = this.safeInteger(this.options, "watchOrderBookLimit", 1000);
        Long limit = this.safeInteger(subscription, "limit", defaultLimit);
        String symbol = (String) this.safeString(subscription, "symbol"); // watchOrderBook
    ...
    public void handleBidAsk(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
        {
            java.util.Map<String, Object> ticker = (java.util.Map<String, Object>) this.safeDict(data, i);
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String orderId = (String) this.safeString2(order, "orderId", "algoOrderId");
        ...
        String filled = (String) this.safeString2(order, "totalExecutedQuantity", "executed");
        String rawStatus = (String) this.safeString2(order, "status", "algoStatus");
        String status = (String) this.parseOrderStatus(rawStatus);
        Object trades = null;
        String clientOrderId = (String) this.safeString(order, "clientOrderId");
        String triggerPrice = (String) this.safeString(order, "triggerPrice");
    ...
    public void handlePositions(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> rawPositions = (java.util.Map<String, Object>) this.safeDict(data, "positions", new java.util.HashMap<String, Object>() {{}});
    ...
    public void handleUnSubscription(Client client, Object message)
    {
        ...
        //     }
        //
        String subscribeHash = (String) this.safeString(message, "data");
        String unsubscribeHash = Helpers.add("unsubscribe::", subscribeHash);
        java.util.Map<String, Object> subscription = (java.util.Map<String, Object>) this.safeDict(client.subscriptions, unsubscribeHash, new java.util.HashMap<String, Object>() {{}});
        ...
        java.util.List<Object> unsubMessageHashes = (java.util.List<Object>) this.safeList(subscription, "unsubMessageHashes", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
