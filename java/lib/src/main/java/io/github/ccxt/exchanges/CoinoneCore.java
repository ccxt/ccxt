    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(currencies)); i++)
            {
                ...
                Object isWithdrawEnabled = Helpers.isEqual(this.safeString(entry, "withdraw_status", ""), "normal");
                Object isDepositEnabled = Helpers.isEqual(this.safeString(entry, "deposit_status", ""), "normal");
        ...
        put( "code", finalCode );
        put( "info", entry );
        put( "name", CoinoneCore.this.safeString(entry, "name") );
        put( "active", null );
        put( "deposit", isDepositEnabled );
        put( "withdraw", isWithdrawEnabled );
        put( "fee", CoinoneCore.this.safeNumber(entry, "withdrawal_fee") );
        put( "precision", CoinoneCore.this.parseNumber(CoinoneCore.this.parsePrecision(CoinoneCore.this.safeString(entry, "max_precision"))) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            ...
            put( "withdraw", new java.util.HashMap<String, Object>() {{
                put( "min", CoinoneCore.this.safeNumber(entry, "withdrawal_min_amount") );
                put( "max", null );
            }} );
        }} );
