   ...
   public Grvt (Object options) {
    ...
    public void handleOrderBook(Client client, Map<String, Object> message)
    {
        ...
        } else
        {
            ...
            this.handleDeltasWithKeys(Helpers.GetValue(orderbook, "asks"), asks, "price", "size", 2);
            this.handleDeltasWithKeys(Helpers.GetValue(orderbook, "bids"), bids, "price", "size", 2);
