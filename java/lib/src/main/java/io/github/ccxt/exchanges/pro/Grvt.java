...
public class Grvt extends io.github.ccxt.exchanges.Grvt
{
   ...
   public Grvt (Object options) {
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        if (java.util.Objects.equals(methodName, "subscribe"))
        {
    ...
    public CompletableFuture<Object> subscribeMultiple(Object messageHashes, Object request, Object rawHashes, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            return (this.watchMultiple(Helpers.GetValue(((Map<String, Object>)((Map<String, Object>)this.urls).get("api")).get("ws"), apiPart), messageHashes, payload, rawHashes, null)).join();
        });
    ...
    public void handleTicker(Client client, Object message)
    {
        ...
        List<Object> parts = (List<Object>) Helpers.split(selector, "@");
    ...
    public CompletableFuture<Object> watchOHLCVForSymbols(Object symbolsAndTimeframes, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)symbolsAndTimeframes).size(); i++)
            {
                ...
                ((List<Object>)rawHashes).add((Helpers.add(Helpers.add(marketId, "@"), timeframeId) + "-TRADE"));
    ...
    public CompletableFuture<List<Trade>> watchMyTrades(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                Map<String, Object> market = (Map<String, Object>) this.market(symbol);
                ((List<Object>)rawHashes).add(Helpers.add((subAccountId + "-"), ((Map<String, Object>)market).get("id")));
    ...
    public void handleMyTrade(Client client, Object message)
    {
        ...
        client.resolve(this.myTrades, Helpers.add("myTrades::", ((Map<String, Object>)trade).get("symbol")));
