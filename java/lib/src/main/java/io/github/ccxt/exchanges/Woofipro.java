...
public class Woofipro extends WoofiproApi
{
   ...
   public Woofipro (Object options) {
    ...
    public CompletableFuture<Object> fetchCurrencies(Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            for (var i = 0; i < ((List<?>)tokenRows).size(); i++)
            {
                ...
                result.put((String)((Map<String, Object>)parsed).get("code"), parsed);
            }
            return result;
        });
    ...
    public CompletableFuture<Object> getAssetHistoryRows(String code2, Long since2, Long limit2, Object parameters2)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(code, null))
            {
                ...
                request.put("balance_token", ((Map<String, Object>)currency).get("id"));
            }
            if (!java.util.Objects.equals(since, null))
            {
                request.put("start_t", since);
     ...
     */
    public CompletableFuture<MarginModes> fetchMarginModes(List<String> symbols2, Map<String, Object> parameters)
    {
        final List<String> symbols3 = symbols2;
        return BaseExchange.supplyAsync(() -> {
            List<String> symbols = symbols3;
    ...
    public CompletableFuture<MarginMode> fetchMarginMode(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> market = (Map<String, Object>) this.market(symbol);
            MarginModes marginModes = (this.fetchMarginModes((Object)(new ArrayList<Object>(Arrays.asList(((Map<String, Object>)market).get("symbol")))), (Object)(parameters))).join();
     ...
     */
    public CompletableFuture<Object> modifyMarginHelper(String symbol, Object amount, Object type2, Map<String, Object> parameters)
    {
