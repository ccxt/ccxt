...
public class AsterCore extends io.github.ccxt.exchanges.Aster
{
   ...
   public AsterCore (Object options) {
    ...
    public Object parseWsTicker(Object message, Object marketType)
    {
        ...
        Object part = Helpers.split(eventVar, "@");
        ...
        if (Helpers.isTrue(Helpers.isEqual(channel, "markPriceUpdate")))
        {
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        Object methods = new java.util.HashMap<String, Object>() {{
            ...
            put( "depth5", "handleOrderBook");
            put( "depth10", "handleOrderBook");
            put( "depth20", "handleOrderBook");
            put( "kline", "handleOHLCV");
            put( "markPrice", "handleTicker");
