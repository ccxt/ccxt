   ...
   public HtxCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String topic = (String) this.safeString(options, "name", "market.{marketId}.detail");
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTicker(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String topic = "ticker";
            java.util.Map<String, Object> options = (java.util.Map<String, Object>) this.safeDict(this.options, "watchTicker", new java.util.HashMap<String, Object>() {{}});
            String channel = (String) this.safeString(options, "name", "market.{marketId}.detail");
    ...
    public Object handleTicker(Client client, Object message)
    {
        ...
        String ch = (String) this.safeString(message, "ch");
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchTrades(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String channel = (String) this.safeString(options, "name", "market.{marketId}.trade.detail");
            Object subMessageHash = this.implodeParams(channel, new java.util.HashMap<String, Object>() {{
                put( "marketId", Helpers.GetValue(market, "id") );
            }});
            return (this.unsubscribePublic(market, subMessageHash, topic, parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchOHLCV(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object market = this.market(symbol);
            String interval = (String) this.safeString(this.timeframes, timeframe, timeframe);
            String subMessageHash = Helpers.add(Helpers.add(Helpers.add("market.", Helpers.GetValue(market, "id")), ".kline."), interval);
            String topic = "ohlcv";
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId);
        Object symbol = Helpers.GetValue(market, "symbol");
        String interval = (String) this.safeString(parts, 3);
    ...
    public void handleOrderBookMessage(Client client, Object message)
    {
        ...
        String eventVar = (String) this.safeString(tick, "event");
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        //     }
        //
        String messageHash = (String) this.safeString(message, "ch");
        ...
        {
            String size = (String) this.safeString(parts, 3);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            } else
            {
                ...
                String orderMessageHash = (String) this.safeString(channelAndMessageHash, 1);
    ...
    public Object getOrderChannelAndMessageHash(Object type, Object subType, Object... optionalArgs)
    {
        ...
        Object messageHash = null;
        Object channel = null;
        String orderType = (String) this.safeString(this.options, "orderType", "orders"); // orders or matchOrders
        ...
        if (Helpers.isTrue(Helpers.isEqual(subType, "linear")))
        {
            ...
            String marginMode = (String) this.safeString(parameters, "margin", "cross");
    ...
    public void handleOrder(Client client, Object message)
    {
        ...
        //     }
        //
        String messageHash = (String) this.safeString2(message, "ch", "topic");
        Object data = this.safeValue(message, "data");
        String marketId = (String) this.safeString(message, "contract_code");
        ...
        {
            // spot updates
            String eventType = (String) this.safeString(data, "eventType");
            if (Helpers.isTrue(Helpers.isEqual(eventType, "trade")))
            {
                ...
                String orderId = (String) this.safeString(parsedTrade, "order");
                java.util.List<Object> trades = new java.util.ArrayList<Object>(java.util.Arrays.asList(parsedTrade));
                String status = (String) this.parseOrderStatus(this.safeString2(data, "orderStatus", "status", "closed"));
                String filled = (String) this.safeString(data, "execAmt");
                String remaining = (String) this.safeString(data, "remainAmt");
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        String marketId = (String) this.safeString2(order, "contract_code", "symbol");
        market = this.safeMarket(marketId, market);
        String symbol = (String) this.safeSymbol(marketId, market);
        String amount = (String) this.safeString2(order, "orderSize", "volume");
        String status = (String) this.parseOrderStatus(this.safeStringN(order, new java.util.ArrayList<Object>(java.util.Arrays.asList("orderStatus", "state", "status"))));
        String id = (String) this.safeString2(order, "orderId", "order_id");
        String clientOrderId = (String) this.safeString2(order, "clientOrderId", "client_order_id");
        String price = (String) this.safeString2(order, "orderPrice", "price");
        String filled = (String) this.safeString2(order, "execAmt", "trade_volume");
        String typeSide = (String) this.safeString(order, "type");
        String feeCost = (String) this.safeString(order, "fee");
        Object fee = null;
        if (Helpers.isTrue(!Helpers.isEqual(feeCost, null)))
        {
            String feeCurrencyId = (String) this.safeString2(order, "fee_asset", "fee_currency");
        ...
        String avgPrice = (String) this.safeString(order, "trade_avg_price");
        ...
        String cost = (String) this.safeString2(order, "orderValue", "trade_turnover");
    ...
    public Object parseOrderTrade(Object trade, Object... optionalArgs)
    {
        ...
        String price = (String) this.safeString(trade, "tradePrice");
        String amount = (String) this.safeString(trade, "tradeVolume");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(type, "spot")))
            {
                String mode = (String) this.safeString2(this.options, "watchBalance", "mode", "2");
                mode = this.safeString(parameters, "mode", mode);
            ...
            } else
            {
                ...
                String currency = (String) this.safeString(parameters, "currency");
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        //     }
        //
        String channel = (String) this.safeString(message, "ch");
        ...
        } else
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(topic, "account")))
            {
                ...
                for (var i = 0; Helpers.isLessThan(i, detailsLength); i++)
                {
                    ...
                    String currencyId = (String) this.safeString(detail, "currency");
                    String code = (String) this.safeCurrencyCode(currencyId);
                    if (Helpers.isTrue(Helpers.isEqual(code, null)))
                    {
                        continue;
            ...
            if (Helpers.isTrue(Helpers.isEqual(subscription, null)))
            {
                ...
                String currencyId = (String) this.safeString2(first, "margin_asset", "symbol");
            ...
            String subType = (String) this.safeString(subscription, "subType");
            if (Helpers.isTrue(Helpers.isEqual(topic, "accounts_unify")))
            {
                ...
                //     "isolated_swap": []
                // }
                String marginAsset = (String) this.safeString(first, "margin_asset");
                String code = (String) this.safeCurrencyCode(marginAsset);
                String marginFrozen = (String) this.safeString(first, "margin_frozen");
            ...
            {
                String margin = (String) this.safeString(subscription, "margin");
                if (Helpers.isTrue(Helpers.isEqual(margin, "cross")))
                {
                    ...
                    String currencyId = (String) this.safeString2(first, "margin_asset", "margin_account");
                    String code = (String) this.safeCurrencyCode(currencyId);
                    if (Helpers.isTrue(!Helpers.isEqual(code, null)))
                    {
                        Object account = this.account();
                ...
                } else
                {
                    ...
                    for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
                    {
                        ...
                        String currencyId = (String) this.safeString2(isolatedBalance, "margin_asset", "symbol");
                        String code = (String) this.safeCurrencyCode(currencyId);
                        if (Helpers.isTrue(!Helpers.isEqual(code, null)))
                        {
                            Helpers.addElementToObject(this.balance, code, account);
            ...
            } else
            {
                ...
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
                {
                    ...
                    String currencyId = (String) this.safeString(balance, "symbol");
                    String code = (String) this.safeCurrencyCode(currencyId);
                    Object account = this.account();
    ...
    public void handleSubject(Client client, Object message)
    {
        ...
        Object ch = this.safeValue(message, "ch", "");
        java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(ch, ".");
        String type = (String) this.safeString(parts, 0);
        if (Helpers.isTrue(Helpers.isEqual(type, "market")))
        {
            String methodName = (String) this.safeString(parts, 2);
        ...
        String privateType = (String) this.safeString(privateParts, 0, "");
        ...
        String op = (String) this.safeString(message, "op");
    ...
    public java.util.concurrent.CompletableFuture<Object> pong(Client client, Object message)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            try
            {
                ...
                String action = (String) this.safeString(message, "action");
    ...
    public Object handleErrorMessage(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(Helpers.isEqual(status, "error")))
        {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(subscription, null)))
            {
                String errorCode = (String) this.safeString(message, "err-code");
                try
                {
        ...
        String code = (String) this.safeString2(message, "code", "err-code");
    ...
    public void handleMyTrade(Client client, Object message, Object... optionalArgs)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(messageHash, null)))
        {
            ...
            if (Helpers.isTrue(!Helpers.isEqual(data, null)))
            {
                String contractCode = (String) this.safeString(message, "contract_code");
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String marketId = (String) this.safeString2(trade, "symbol", "contract_code");
        market = this.safeMarket(marketId, market);
        String symbol = (String) this.safeString(market, "symbol");
        String side = (String) this.safeStringN(trade, new java.util.ArrayList<Object>(java.util.Arrays.asList("side", "orderSide", "direction")));
        String tradeId = (String) this.safeStringN(trade, new java.util.ArrayList<Object>(java.util.Arrays.asList("tradeId", "trade_id", "id")));
        String price = (String) this.safeString2(trade, "tradePrice", "trade_price");
        String amount = (String) this.safeString2(trade, "tradeVolume", "trade_volume");
        String order = (String) this.safeString2(trade, "orderId", "order_id");
        ...
        String orderType = (String) this.safeString2(trade, "orderType", "type");
        Object aggressor = this.safeValue(trade, "aggressor");
    ...
    public Object getUrlByMarketType(Object type, Object... optionalArgs)
    {
        ...
        String api = (String) this.safeString(this.options, "api", "api");
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String hostname = (String) this.safeString(parameters, "hostname");
            String type = (String) this.safeString(parameters, "type");
            ...
            String relativePath = (String) Helpers.replace((String)url, (String)Helpers.add("wss://", hostname), (String)"");
