...
public class KalshiCore extends KalshiApi
{
   ...
   public KalshiCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMarkets(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isGreaterThan(queriesLength, 0)))
            {
                ...
                {
                    java.util.List<Object> eventMarkets = (java.util.List<Object>) this.safeList(Helpers.GetValue(events, ei), "markets", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            ...
            String status = (String) this.safeString(rest, "status", "open");
            while (true)
            {
                ...
                java.util.Map<String, Object> response = (this.kalshiPublicGetMarkets(this.extend(request, rest))).join();
                java.util.List<Object> rawMarkets = (java.util.List<Object>) this.safeList(response, "markets", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
                ...
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawMarkets)); i++)
                {
                    ...
                    String eventTicker = (String) this.safeString(raw, "event_ticker");
                    String eventTitle = (String) this.safeString(raw, "title", eventTicker);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOutcome(Object outcomeSymbol)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isLessThan(Helpers.getIndexOf(outcomeSymbol, ":"), 0)))
            {
                ...
                String suffix = (String) Helpers.slice(outcomeSymbol, Helpers.subtract(symbolLength, 3), null);
                ...
                if (Helpers.isTrue(!Helpers.isEqual(response, null)))
                {
                    ...
                    java.util.Map<String, Object> parsed = this.parseMarket(rawMarket);
            ...
            } else
            {
                ...
                String marketPart = (String) this.safeString(handleParts, 0, "");
                java.util.List<Object> parts = (java.util.List<Object>) Helpers.split(marketPart, "_");
                String seriesTicker = (String) this.safeString(parts, 0);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOutcomes(Object outcomeSymbols)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            while (Helpers.isLessThan(startIndex, tickersLength))
            {
                ...
                for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawMarkets)); i++)
                {
                    java.util.Map<String, Object> parsed = this.parseMarket(Helpers.GetValue(rawMarkets, i));
                    if (Helpers.isTrue(Helpers.isEqual(parsed, null)))
                    {
    ...
    public Object calculateFee(String symbol, String type, String side, Object amount, Object price, Object... optionalArgs)
    {
        ...
        String amountStr = (String) this.numberToString(amount);
    ...
    public java.util.Map<String, Object> parseMarket(Object raw)
    {
        ...
        // }
        String ticker = (String) this.safeString(raw, "ticker");
        String eventTicker = (String) this.safeString(raw, "event_ticker");
        String subtitle = (String) this.safeString(raw, "subtitle", this.safeString(raw, "title"));
        // markets use status 'active' while events use 'open'
        String status = (String) this.safeString(raw, "status");
        ...
        String endDate = (String) this.safeString(raw, "expiration_time");
        ...
        java.util.List<Object> priceRanges = (java.util.List<Object>) this.safeList(raw, "price_ranges", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        java.util.Map<String, Object> firstRange = (java.util.Map<String, Object>) this.safeDict(priceRanges, 0, new java.util.HashMap<String, Object>() {{}});
        String stepDollars = (String) this.safeString(firstRange, "step");
...
final Object finalOi = oi;
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTicker(Object outcome, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String ticker = (String) this.safeString(Helpers.GetValue(outcomeObj, "info"), "ticker");
            java.util.Map<String, Object> request = new java.util.HashMap<String, Object>() {{
                put( "ticker", ticker );
            }};
            java.util.Map<String, Object> response = (this.kalshiPublicGetMarketsTicker(this.extend(request, parameters))).join();
            //
            //     {
            //         "market": {
            //             "can_close_early": true,
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchStatus(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
            java.util.Map<String, Object> response = (this.kalshiPublicGetExchangeStatus(parameters)).join();
            //
    ...
    public Object parsePredictionTicker(Object raw, Object... optionalArgs)
    {
        ...
        String outcome = (String) this.safeString(outcomeObj, "outcome");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> outcomesByTicker = new java.util.HashMap<String, Object>() {{}};
            java.util.List<Object> tickers = new java.util.ArrayList<Object>(java.util.Arrays.asList());
            ...
            while (Helpers.isLessThan(startIndex, tickersLength))
            {
                ...
                {
                    Object raw = Helpers.GetValue(rawMarkets, i);
                    String marketTicker = (String) this.safeString(raw, "ticker");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrderBook(Object outcome, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object outcomeObj = this.outcome(outcome);
            String ticker = (String) this.safeString(Helpers.GetValue(outcomeObj, "info"), "ticker");
            Boolean isNo = Helpers.isEqual(Helpers.GetValue(outcomeObj, "label"), "NO");
            java.util.Map<String, Object> request = new java.util.HashMap<String, Object>() {{
                put( "ticker", ticker );
            }};
            java.util.Map<String, Object> response = (this.kalshiPublicGetMarketsTickerOrderbook(this.extend(request, parameters))).join();
            //
            //     {
            //         "orderbook_fp": {
            //             "no_dollars": [
            ...
            java.util.List<Object> rawYes = (java.util.List<Object>) this.safeList(book, "yes_dollars", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            java.util.List<Object> rawNo = (java.util.List<Object>) this.safeList(book, "no_dollars", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOHLCV(Object outcome, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object outcomeObj = this.outcome(outcome);
            String ticker = (String) this.safeString(Helpers.GetValue(outcomeObj, "info"), "ticker");
            String seriesTicker = (String) this.safeString(Helpers.GetValue(outcomeObj, "info"), "seriesTicker", ticker);
            ...
            int tf = this.parseTimeframe(timeframe);
            ...
            java.util.Map<String, Object> response = (this.kalshiPublicGetSeriesSeriesTickerMarketsTickerCandlesticks(this.extend(request, parameters))).join();
            //
            //     {
            //         "candlesticks": [
            //             {
            ...
            //     }
            //
            java.util.List<Object> candles = (java.util.List<Object>) this.safeList(response, "candlesticks", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(candles)); i++)
            {
                ...
                java.util.Map<String, Object> priceObj = (java.util.Map<String, Object>) this.safeDict(candle, "price", new java.util.HashMap<String, Object>() {{}});
    ...
    public Object parseOHLCV(Object ohlcv, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        java.util.Map<String, Object> price = (java.util.Map<String, Object>) this.safeDict(ohlcv, "price", new java.util.HashMap<String, Object>() {{}});
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchTrades(String outcome, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPublicGetMarketsTrades(this.extend(request, parameters))).join();
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(trades)); i++)
            {
                ...
                String tradeTicker = (String) this.safeString2(trade, "ticker", "market_ticker");
    ...
    {
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String id = (String) this.safeString(trade, "trade_id");
        ...
        Object marketAny = market;
        Object outcomeObj = this.safeOutcome(this.safeString(marketAny, "outcome"), marketAny);
        java.util.Map<String, Object> marketInfo = (java.util.Map<String, Object>) this.safeDict(outcomeObj, "info", new java.util.HashMap<String, Object>() {{}});
        String requestedOutcomeLabel = (String)this.safeStringLower(outcomeObj, "label", this.safeStringLower(marketInfo, "outcomeLabel"));
        String outcomeSymbol = (String) this.safeString(outcomeObj, "outcome");
        String outcomeId = (String) this.safeString2(outcomeObj, "outcomeId", "id");
        String side = null;
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivateGetPortfolioFills(this.extend(request, parameters))).join();
    ...
    {
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String id = (String) this.safeString2(fill, "fill_id", "trade_id");
        String orderId = (String) this.safeString(fill, "order_id");
        String ticker = (String) this.safeString2(fill, "ticker", "market_ticker");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
            java.util.Map<String, Object> response = (this.kalshiPrivateGetPortfolioBalance(parameters)).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchPositions(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivateGetPortfolioPositions(parameters)).join();
            java.util.List<Object> positions = (java.util.List<Object>) this.safeList(response, "market_positions", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(outcomes)); i++)
            {
                ...
                String marketTicker = (String) this.safeString(outcomeInfo, "ticker");
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(parsed)); i++)
            {
                ...
                java.util.Map<String, Object> positionInfo = (java.util.Map<String, Object>) this.safeDict(position, "info", new java.util.HashMap<String, Object>() {{}});
                String positionTicker = (String) this.safeString(positionInfo, "ticker");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchSettlements(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivateGetPortfolioSettlements(this.extend(request, parameters))).join();
            java.util.List<Object> rawSettlements = (java.util.List<Object>) this.safeList(response, "settlements", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    {
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String ticker = (String) this.safeString(settlement, "ticker");
        ...
        Boolean tickerMissing = (Helpers.isEqual(ticker, null));
        Boolean useHeldYesTicker = (Helpers.isTrue(heldYes) || Helpers.isTrue(tickerMissing));
    ...
    {
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String ticker = (String) this.safeString(position, "ticker");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOpenOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivateGetPortfolioOrders(this.extend(request, parameters))).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchClosedOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(orders)); i++)
            {
                ...
                String status = (String) this.safeString(order, "status");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchOrder(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivateGetPortfolioOrdersOrderId(this.extend(new java.util.HashMap<String, Object>() {{
                put( "order_id", id );
            }}, parameters))).join();
    ...
    public Object parsePredictionOrder(Object order, Object... optionalArgs)
    {
        ...
        String ticker = (String) this.safeString(order, "ticker");
        ...
        Boolean labelIsNo = (Helpers.isEqual(this.safeStringUpper(mkt, "label"), "NO"));
    ...
    public java.util.concurrent.CompletableFuture<Object> createOrder(Object outcome, Object type2, Object side2, Object amount2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivatePostPortfolioEventsOrders(this.extend(request, parameters))).join();
     ...
     * @returns {object} a [prediction order structure](https://docs.ccxt.com/#/?id=prediction-order-structure)
     */
    public java.util.concurrent.CompletableFuture<Object> editOrder(String id, Object outcome, Object type, Object side, Object... optionalArgs)
    {
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelOrder(Object id, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPrivateDeletePortfolioEventsOrdersOrderId(this.extend(new java.util.HashMap<String, Object>() {{
                put( "order_id", id );
            }}, parameters))).join();
    ...
    public java.util.concurrent.CompletableFuture<Object> cancelAllOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> restingResponse = (this.kalshiPrivateGetPortfolioOrders(request)).join();
            java.util.List<Object> restingOrders = (java.util.List<Object>) this.safeList(restingResponse, "orders", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
            ...
            for (var i = 0; Helpers.isLessThan(i, restingOrdersLength); i++)
            {
                ...
                String orderId = (String) this.safeString(restingOrder, "order_id");
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchEvents(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String requestedStatus = (String) this.safeString(parameters, "status", this.safeString(this.options, "defaultEventStatus", "open"));
            String status = null;
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchEventsByQuery(Object queries, Object limit2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var qi = 0; Helpers.isLessThan(qi, queriesLength); qi++)
            {
                ...
                java.util.Map<String, Object> searchResponse = (this.electionsPublicGetSearchSeries(new java.util.HashMap<String, Object>() {{
                    put( "query", Helpers.GetValue(queries, finalQi) );
                    put( "order_by", "querymatch" );
                    put( "page_size", pageSize );
                }})).join();
                java.util.List<Object> page = (java.util.List<Object>) this.safeList(searchResponse, "current_page", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
                Integer pageLength = Helpers.getArrayLength(page);
                for (var pi = 0; Helpers.isLessThan(pi, pageLength); pi++)
                {
                    String et = (String) this.safeString(Helpers.GetValue(page, pi), "event_ticker");
                    if (Helpers.isTrue(!Helpers.isEqual(et, null)))
                    {
                        String already = (String) this.safeString(seen, et);
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchRawEventByTicker(Object ticker, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> response = (this.kalshiPublicGetEventsEventTicker(this.extend(request, parameters))).join();
            Object fullEvent = this.safeDict(response, "event", response);
            java.util.List<Object> nestedMarkets = (java.util.List<Object>) this.safeList(fullEvent, "markets");
    ...
    public java.util.concurrent.CompletableFuture<Object> resolveEventSeriesTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var ti = 0; Helpers.isLessThan(ti, tagsLength); ti++)
            {
                ...
                java.util.Map<String, Object> seriesResponse = (this.kalshiPublicGetSeries(new java.util.HashMap<String, Object>() {{
                    put( "tags", Helpers.GetValue(tags, finalTi) );
                }})).join();
                java.util.List<Object> seriesList = (java.util.List<Object>) this.safeList(seriesResponse, "series", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
                Integer seriesListLength = Helpers.getArrayLength(seriesList);
                for (var si = 0; Helpers.isLessThan(si, seriesListLength); si++)
                {
                    String st = (String) this.safeString(Helpers.GetValue(seriesList, si), "ticker");
            ...
            String category = (String) this.safeString(parameters, "category");
            ...
            String seriesParam = (String) this.safeString(parameters, "series_ticker");
            ...
            for (var ci = 0; Helpers.isLessThan(ci, collectedLength); ci++)
            {
                ...
                String already = (String) this.safeString(seen, st);
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            for (var si = 0; Helpers.isLessThan(si, seriesTickersLength); si++)
            {
                ...
                for (var page = 0; Helpers.isLessThan(page, maxPages); page++)
                {
                    ...
                    java.util.Map<String, Object> response = (this.kalshiPublicGetEvents(this.extend(request, rest))).join();
                    java.util.List<Object> pageEvents = (java.util.List<Object>) this.safeList(response, "events", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
    ...
    public Object parseEvent(Object rawEvent)
    {
        ...
        //         "title": "Will Trump balance the budget?"
        // }
        java.util.List<Object> rawMarkets = (java.util.List<Object>) this.safeList(rawEvent, "markets", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawMarkets)); i++)
        {
            ...
            String marketStatus = (String) this.safeString(rawMarket, "status");
            if (Helpers.isTrue(Helpers.isEqual(marketStatus, "active")))
            {
                anyActive = true;
            }
            String marketResult = (String) this.safeString(rawMarket, "result");
            Boolean marketResolved = Helpers.isTrue((Helpers.isEqual(marketStatus, "settled"))) || Helpers.isTrue((Helpers.isTrue((!Helpers.isEqual(marketResult, null))) && Helpers.isTrue((!Helpers.isEqual(marketResult, "")))));
        ...
        String ticker = (String) this.safeString(rawEvent, "event_ticker");
        String title = (String) this.safeString(rawEvent, "title");
        Boolean hasTitle = Helpers.isTrue((!Helpers.isEqual(title, null))) && Helpers.isTrue((!Helpers.isEqual(title, "")));
    ...
    public Object sign(Object path, Object... optionalArgs)
    {
        ...
        String baseUrl = (String) this.safeString(baseUrls, apiGroup, Helpers.GetValue(baseUrls, "kalshi"));
        ...
        if (Helpers.isTrue(Helpers.isEqual(access, "private")))
        {
            ...
            String versionPrefix = (String) Helpers.slice(baseUrl, tradeApiIndex, null);
