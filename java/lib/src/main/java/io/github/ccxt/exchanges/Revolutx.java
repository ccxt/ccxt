...
public class Revolutx extends RevolutxApi
{
   ...
   public Revolutx (Object options) {
    ...
    public Object parseCurrency(Object currency)
    {
        ...
        Object precision = (((!java.util.Objects.equals(scale, null)))) ? Math.pow(Double.parseDouble(Helpers.toString(10)), Double.parseDouble(Helpers.toString(Helpers.opNeg(scale)))) : null;
        return new HashMap<String, Object>() {{
            put( "info", currency );
            put( "id", id );
            put( "code", code );
