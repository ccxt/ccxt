...
public class Revolutx extends RevolutxApi
{
   ...
   public Revolutx (Object options) {
    ...
    public Object parseCurrency(Object currency)
    {
        ...
        Object precision = (((!java.util.Objects.equals(scale, null)))) ? Helpers.mathPow(Double.parseDouble(Helpers.toString(10)), Double.parseDouble(Helpers.toString(Helpers.opNeg(scale)))) : null;
        return new HashMap<String, Object>() {{
            put( "info", currency );
            put( "id", id );
            put( "code", code );
    ...
    public CompletableFuture<Balances> fetchBalance(Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            //     ]
            //
            Object data = ((Helpers.isTrue((response instanceof List)))) ? response : this.safeList(response, "data", new ArrayList<Object>(Arrays.asList()));
            Map<String, Object> result = new HashMap<String, Object>() {{
                put( "info", response );
            }};
            for (var i = 0; i < ((List<?>)data).size(); i++)
    ...
    public CompletableFuture<Order> createOrder(Object symbol, Object type2, Object side, Object amount, Object... optionalArgs)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object orderData = ((Helpers.isTrue((data instanceof List)))) ? this.safeDict(data, 0, new HashMap<String, Object>() {{}}) : this.safeDict(response, "data", new HashMap<String, Object>() {{}});
