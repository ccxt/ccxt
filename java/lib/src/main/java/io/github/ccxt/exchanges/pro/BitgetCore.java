...
public class BitgetCore extends io.github.ccxt.exchanges.Bitget
{
   ...
   public BitgetCore (Object options) {
    ...
    public Object getInstType(Object methodName, Object market, Object... optionalArgs)
    {
        ...
        {
            java.util.List<Object> instTypeparametersVariable = (java.util.List<Object>) this.handleProductTypeAndParams(null, parameters);
        ...
        {
            java.util.List<Object> instTypeparametersVariable = (java.util.List<Object>) this.handleProductTypeAndParams(market, parameters);
            instType = ((java.util.List<Object>) instTypeparametersVariable).get(0);
            parameters = ((java.util.List<Object>) instTypeparametersVariable).get(1);
        } else
        {
        ...
        java.util.List<Object> instypeAuxparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, methodName, "instType", instType);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object instType = null;
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchTicker", "uta", false);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTickers(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object instType = null;
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchTickers", "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
    ...
    public Object parseWsTicker(Object message, Object... optionalArgs)
    {
        ...
        String utaMarketId = (String) this.safeString(arg, "symbol");
        String marketId = (String) this.safeString(ticker, "instId", utaMarketId);
        market = this.safeMarket(marketId, market, null, marketType);
        String close = (String) this.safeString2(ticker, "lastPr", "lastPrice");
        String changeCoefficient = (String) this.safeString2(ticker, "price24hPcnt", "change24h");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBidsAsks(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object instType = null;
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchBidsAsks", "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOHLCV(Object symbol2, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String interval = (String) this.safeString(timeframes, timeframe);
            String messageHash = (String) null;
            Object instType = null;
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchOHLCV", "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
    ...
    public void handleOHLCV(Client client, Object message)
    {
        ...
        String instType = (String)this.safeStringLower(arg, "instType");
        String marketType = ((Helpers.isTrue((Helpers.isEqual(instType, "spot"))))) ? "spot" : "contract";
        String marketId = (String) this.safeString2(arg, "instId", "symbol");
        ...
        String channel = (String) this.safeString2(arg, "channel", "topic", "");
    ...
    public java.util.concurrent.CompletableFuture<Object> unWatchChannel(Object symbol, Object channel, Object messageHashTopic, String methodName, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.market(symbol);
            String messageHash = (String) Helpers.add(Helpers.add(Helpers.add("unsubscribe:", messageHashTopic), ":"), Helpers.GetValue(market, "symbol"));
            Object instType = null;
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, methodName, "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(incrementalBook))
        {
            ...
            if (!Helpers.isTrue((Helpers.inOp(this.orderbooks, symbol))))
            {
                ...
                io.github.ccxt.ws.WsOrderBook.CountedOrderBook ob = this.countedOrderBook(new java.util.HashMap<String, Object>() {{}});
        ...
        {
            io.github.ccxt.ws.WsOrderBook orderbook = this.orderBook(new java.util.HashMap<String, Object>() {{}});
            String bidsKey = "bids";
            String asksKey = "asks";
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String instId = (String) this.safeString2(trade, "symbol", "instId");
        String posMode = (String) this.safeString(trade, "posMode");
        String category = (String) this.safeString(trade, "category");
        ...
        {
            String feeCurrencyId = (String) this.safeString(first, "feeCoin");
    ...
    public void handlePositions(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawPositions)); i++)
        {
            ...
            String marketId = (String) this.safeString2(rawPosition, "instId", "symbol");
    ...
    public Object parseWsPosition(Object position, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String marketId = (String) this.safeString2(position, "instId", "symbol");
        String marginModeId = (String) this.safeString(position, "marginMode");
        Object marginMode = this.getSupportedMapping(marginModeId, new java.util.HashMap<String, Object>() {{
            put( "crossed", "cross" );
            put( "isolated", "isolated" );
        }});
        String hedgedId = (String) this.safeString2(position, "posMode", "holdMode");
        ...
        String percentageDecimal = (String) this.safeString2(position, "unrealizedPLR", "profitRate");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchOrders(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String messageHash = (String) (((Helpers.isTrue((Helpers.isEqual(isTrigger, true))))) ? "triggerOrder" : "order");
            ...
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchOrders", "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
            String productType = (String) this.safeString(parameters, "productType");
            Object type = null;
    ...
    public void handleOrder(Client client, Object message)
    {
        ...
        String channel = (String) this.safeString2(arg, "channel", "topic", "");
        String instType = (String)this.safeStringLower(arg, "instType");
        String argInstId = (String) this.safeString(arg, "instId");
        ...
        String messageHash = (String) (((Helpers.isTrue(isTrigger))) ? "triggerOrder" : "order");
        java.util.Map<String, Object> marketSymbols = new java.util.HashMap<String, Object>() {{}};
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
        {
            Object order = Helpers.GetValue(data, i);
            String marketId = (String) this.safeString2(order, "instId", "symbol", argInstId);
            java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(marketId, null, null, marketType);
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        String category = (String)this.safeStringLower(order, "category");
        ...
        String marketId = (String) this.safeString2(order, "instId", "symbol");
        market = this.safeMarket(marketId, market);
        Long timestamp = (Long) this.safeInteger2(order, "cTime", "createdTime");
        Object symbol = Helpers.GetValue(market, "symbol");
        String rawStatus = (String) this.safeString2(order, "status", "orderStatus");
        ...
        String feeAmount = (String) this.safeString(fee, "fee");
        Object feeObject = null;
        if (Helpers.isTrue(!Helpers.isEqual(feeAmount, null)))
        {
            String feeCurrency = (String) this.safeString(fee, "feeCoin");
        ...
        String avgPriceString = (String)this.safeStringLowerN(order, new java.util.ArrayList<Object>(java.util.Arrays.asList("priceAvg", "fillPrice", "avgPrice")));
        Object avgPrice = ((Helpers.isTrue((Helpers.isEqual(avgPriceString, null))))) ? null : this.omitZero(avgPriceString);
        String side = (String) this.safeString(order, "side");
        ...
        String totalFilled = (String) this.safeString2(order, "accBaseVolume", "cumExecQty");
        if (Helpers.isTrue(isSpot))
        {
            ...
            {
                String partialFillAmount = (String) this.safeString(order, "baseVolume");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchMyTrades(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object instType = null;
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchMyTrades", "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
            if (Helpers.isTrue(Helpers.isTrue(Helpers.isEqual(market, null)) && Helpers.isTrue(Helpers.isEqual(type, "spot"))))
            {
            ...
            String subscriptionHash = Helpers.add("fill:", instType);
            final Object finalInstType = instType;
            Object args = new java.util.HashMap<String, Object>() {{
                put( "instType", finalInstType );
            }};
    ...
    public void handleMyTrades(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, length); i++)
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(instType, "uta")))
            {
                ...
                String category = (String)this.safeStringLower(trade, "category");
                String marketType = "contract";
                if (Helpers.isTrue(Helpers.isTrue((Helpers.isEqual(category, "spot"))) || Helpers.isTrue((Helpers.isEqual(category, "margin")))))
                {
                    marketType = "spot";
                }
                String marketId = (String) this.safeString2(trade, "instId", "symbol");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchBalance(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            Object parameters = Helpers.getArg(optionalArgs, 0, new java.util.HashMap<String, Object>() {{}});
            Object uta = null;
            java.util.List<Object> utaparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchBalance", "uta", false);
            uta = ((java.util.List<Object>) utaparametersVariable).get(0);
            parameters = ((java.util.List<Object>) utaparametersVariable).get(1);
            Object type = null;
            ...
            parameters = ((java.util.List<Object>) typeparametersVariable).get(1);
            Object marginMode = null;
            java.util.List<Object> marginModeparametersVariable = (java.util.List<Object>) this.handleMarginModeAndParams("watchBalance", parameters);
            marginMode = ((java.util.List<Object>) marginModeparametersVariable).get(0);
            parameters = ((java.util.List<Object>) marginModeparametersVariable).get(1);
            Object instType = null;
            ...
            java.util.List<Object> instTypeparametersVariable = (java.util.List<Object>) this.handleOptionAndParams(parameters, "watchBalance", "instType", instType);
            instType = ((java.util.List<Object>) instTypeparametersVariable).get(0);
            parameters = ((java.util.List<Object>) instTypeparametersVariable).get(1);
            if (Helpers.isTrue(uta))
            {
            ...
            String messageHash = (String) Helpers.add("balance:", instTypeLower);
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(data)); i++)
        {
            ...
            if (Helpers.isTrue(Helpers.isEqual(instType, "uta")))
            {
                ...
                for (var j = 0; Helpers.isLessThan(j, Helpers.getArrayLength(coins)); j++)
                {
                    ...
                    String currencyId = (String) this.safeString(entry, "coin");
                    ...
                    String borrow = (String) this.safeString(entry, "borrow");
                    String debts = (String) this.safeString(entry, "debts");
            ...
            {
                String currencyId = (String) this.safeString2(rawBalance, "coin", "marginCoin");
                String code = (String) this.safeCurrencyCode(currencyId);
                Object account = this.account();
                if (Helpers.isTrue(Helpers.isTrue((!Helpers.isEqual(code, null))) && Helpers.isTrue((Helpers.inOp(this.balance, code)))))
                {
                ...
                String borrow = (String) this.safeString(rawBalance, "borrow");
                if (Helpers.isTrue(!Helpers.isEqual(borrow, null)))
                {
                    String interest = (String) this.safeString(rawBalance, "interest");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPublic(Object uta2, Object messageHash, Object args, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                String instType = (String) this.safeString(args, "instType");
    ...
    public java.util.concurrent.CompletableFuture<Object> watchPublicMultiple(Object uta2, Object messageHashes, Object argsArray, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            if (Helpers.isTrue(Helpers.isEqual(sandboxMode, true)))
            {
                ...
                String instType = (String) this.safeString(argsArrayFirst, "instType");
                if (Helpers.isTrue(Helpers.isTrue(Helpers.isTrue((!Helpers.isEqual(instType, "SCOIN-FUTURES"))) && Helpers.isTrue((!Helpers.isEqual(instType, "SUSDT-FUTURES")))) && Helpers.isTrue((!Helpers.isEqual(instType, "SUSDC-FUTURES")))))
                {
    ...
    public void handleOrderBookUnSubscription(Client client, Object message)
    {
        ...
        String instId = (String) this.safeString2(arg, "instId", "symbol");
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(instId, null, null, type);
        Object symbol = Helpers.GetValue(market, "symbol");
        String messageHash = (String) Helpers.add("unsubscribe:orderbook:", Helpers.GetValue(market, "symbol"));
    ...
    public void handleTradesUnSubscription(Client client, Object message)
    {
        ...
        java.util.Map<String, Object> market = (java.util.Map<String, Object>) this.safeMarket(instId, null, null, type);
        Object symbol = Helpers.GetValue(market, "symbol");
        String messageHash = (String) Helpers.add("unsubscribe:trade:", Helpers.GetValue(market, "symbol"));
