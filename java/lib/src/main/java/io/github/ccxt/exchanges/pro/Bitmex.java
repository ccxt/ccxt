   ...
   public Bitmex (Object options) {
    ...
    public CompletableFuture<Tickers> watchTickers(List<String> symbols2, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                ((List<Object>)rawSubscriptions).add(name);
                ((List<Object>)messageHashes).add("alltickers");
            }
     ...
     * @returns {object} an array of [liquidation structures]{@link https://github.com/ccxt/ccxt/wiki/Manual#liquidation-structure}
     */
    public CompletableFuture<List<Liquidation>> watchLiquidationsForSymbols(Object symbols2, Long since, Long limit, Map<String, Object> parameters)
    {
    ...
    public CompletableFuture<List<Order>> watchOrders(String symbol2, Long since, Long limit2, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> orders = (this.<List<Object>>watch(url, messageHash, request, subscriptionHash, null)).join();
            if (this.newUpdates)
            {
    ...
    public CompletableFuture<List<Trade>> watchMyTrades(String symbol2, Long since, Long limit2, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> trades = (this.<List<Object>>watch(url, messageHash, request, subscriptionHash, null)).join();
            if (this.newUpdates)
            {
    ...
    public void handleMyTrades(Client client, Map<String, Object> message)
    {
        ...
        String messageHash = this.safeString(message, "table");
        List<Object> data = (List<Object>) this.safeList(message, "data", new ArrayList<Object>(Arrays.asList()));
        Map<String,Object> dataByExecType = this.groupBy(data, "execType");
        List<Object> rawTrades = (List<Object>) this.safeList(dataByExecType, "Trade", new ArrayList<Object>(Arrays.asList()));
        List<Object> trades = this.parseTrades(rawTrades);
        ...
        for (var i = 0; i < ((List<?>)keys).size(); i++)
        {
            client.resolve(stored, Helpers.add((messageHash + ":"), (keys == null || i < 0 || i >= keys.size() ? null : keys.get(i))));
        }
    }
    ...
    public CompletableFuture<OrderBook> watchOrderBookForSymbols(Object symbols2, Long limit2, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            } else if (Helpers.isEqual(limit, 25))
            {
                table = "orderBookL2_25";
            } else if (Helpers.isEqual(limit, 10))
            {
                table = "orderBookL10";
            } else
            {
            ...
            io.github.ccxt.ws.WsOrderBook orderbook = (this.<io.github.ccxt.ws.WsOrderBook>watchMultiple(url, messageHashes, this.deepExtend(request, parameters), topics, null)).join();
    ...
    public CompletableFuture<List<Trade>> watchTradesForSymbols(Object symbols2, Long since, Long limit2, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> trades = (this.<List<Object>>watchMultiple(url, messageHashes, this.deepExtend(request, parameters), topics, null)).join();
            if (this.newUpdates)
            {
    ...
    public void handleOrderBook(Client client, Map<String, Object> message)
    {
        ...
        String table = this.safeString(message, "table");
        if (java.util.Objects.equals(table, null))
        {
        ...
        if (java.util.Objects.equals(action, "partial"))
        {
            ...
            Map<String, Object> market = (Map<String, Object>) this.safeMarket(marketId);
            String symbol = (String) ((Map<String, Object>)market).get("symbol");
            if (java.util.Objects.equals(table, "orderBookL2"))
            {
                Helpers.addElementToObject(this.orderbooks, symbol, this.indexedOrderBook());
            } else if (java.util.Objects.equals(table, "orderBookL2_25"))
            {
                Helpers.addElementToObject(this.orderbooks, symbol, this.indexedOrderBook(new HashMap<String, Object>() {{}}, 25));
            } else if (java.util.Objects.equals(table, "orderBook10"))
            {
    ...
    public Boolean handleErrorMessage(Client client, Object message)
    {
        ...
        if (!java.util.Objects.equals(error, null))
        {
            ...
            List<Object> args = (List<Object>) this.safeList(request, "args", new ArrayList<Object>(Arrays.asList()));
            Integer numArgs = ((List<?>)args).size();
