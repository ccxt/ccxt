   ...
   public BithumbCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> watchTicker(Object symbol, Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            String tickTypes = (String) this.safeString(parameters, "tickTypes", "24H");
    ...
    public void handleTicker(Client client, Object message)
    {
        ...
        String marketId = (String) this.safeString2(tickerMessage, "symbol", "code");
    ...
    public Object parseWsTicker(Object ticker, Object... optionalArgs)
    {
        ...
        String code = (String) this.safeString(ticker, "code");
    ...
    public void handleOrderBook(Client client, Object message)
    {
        ...
        if (Helpers.isTrue(!Helpers.isEqual(content, null)))
        {
            ...
            String legacyMarketId = (String) this.safeString(first, "symbol");
            ...
            String legacyMessageHash = Helpers.add(Helpers.add("orderbook", ":"), legacySymbol);
            client.resolve(legacyOrderbook, legacyMessageHash);
            return;
        }
        String marketId = (String) this.safeString(message, "code");
        String symbol = (String) this.safeSymbol(marketId, null, "-");
        if (Helpers.isTrue(Helpers.isEqual(symbol, null)))
        {
            return;
        }
        String streamType = (String) this.safeString(message, "stream_type");
    ...
    public void handleDelta(Object orderbook, Object delta)
    {
        ...
        //    }
        //
        String sideId = (String) this.safeString(delta, "orderType");
    ...
    public void handleTrades(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(rawTrades)); i++)
        {
            ...
            String marketId = (String) this.safeString2(rawTrade, "symbol", "code");
            if (Helpers.isTrue(Helpers.isEqual(marketId, null)))
            {
                continue;
            }
            String code = (String) this.safeString(rawTrade, "code");
            ...
            String symbol = (String) this.safeString(parsed, "symbol", fallbackSymbol);
    ...
    public Object parseWsTrade(Object trade, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String marketCode = (String) this.safeString(trade, "code");
        ...
        String datetime = (String) this.safeString(trade, "contDtm");
        ...
        String sideId = (String) this.safeString(trade, "buySellGb");
    ...
    public Object handleErrorMessage(Client client, Object message)
    {
        ...
        {
            String errorName = (String) this.safeString(error, "name", "Error");
        ...
        String errorCode = (String) this.safeString(message, "status");
        try
        {
            ...
            {
                String msg = (String) this.safeString(message, "resmsg");
    ...
    public void handleBalance(Client client, Object message)
    {
        ...
        for (var i = 0; Helpers.isLessThan(i, Helpers.getArrayLength(assets)); i++)
        {
            ...
            String currencyId = (String) this.safeString(asset, "currency");
    ...
    public java.util.concurrent.CompletableFuture<Object> authenticate(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            java.util.Map<String, Object> wsOptions = (java.util.Map<String, Object>) this.safeDict(this.options, "ws", new java.util.HashMap<String, Object>() {{}});
            String authenticated = (String) this.safeString(wsOptions, "token");
    ...
    public Object parseWsOrder(Object order, Object... optionalArgs)
    {
        ...
        //
        Object market = Helpers.getArg(optionalArgs, 0, null);
        String marketId = (String) this.safeString(order, "code");
        String symbol = (String) this.safeSymbol(marketId, market, "-");
        Long timestamp = this.safeInteger(order, "order_timestamp");
        String sideId = (String) this.safeString(order, "ask_bid");
        ...
        String stateId = (String) this.safeString(order, "state");
        String status = null;
        ...
        String price = (String) this.safeString2(order, "price", "order_price");
        String amount = (String) this.safeString2(order, "volume", "order_quantity");
        String remaining = (String) this.safeString(order, "remaining_volume");
        String filled = (String) this.safeString(order, "executed_volume");
        String cost = (String) this.safeString(order, "executed_funds");
        String feeCost = (String) this.safeString(order, "paid_fee");
        Object fee = null;
        if (Helpers.isTrue(!Helpers.isEqual(feeCost, null)))
        {
            java.util.Map<String, Object> marketForFee = (java.util.Map<String, Object>) this.safeMarket(marketId, market);
            String feeCurrency = (String) this.safeString(marketForFee, "quote");
    ...
    public void handleMessage(Client client, Object message)
    {
        ...
        String status = (String) this.safeString(message, "status");
        ...
        String topic = (String) this.safeString(message, "type");
