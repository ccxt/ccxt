...
public class Okx extends OkxApi
{
   ...
   public Okx (Object options) {
    ...
    public Object parseOHLCV(Object ohlcv, Map<String, Object> market)
    {
        ...
        String type = (String) Helpers.GetValue(res, 0);
    ...
    public CompletableFuture<List<OHLCV>> fetchOHLCV(Object symbol, Object timeframe, Long since, Long limit, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (Boolean.TRUE.equals(paginate))
            {
                return (this.fetchPaginatedCallDeterministic("fetchOHLCV", Helpers.toStringArg(symbol), since, limit, Helpers.toStringArg(java.util.Objects.requireNonNullElse(timeframe, "1m")), Helpers.toMapArg(paramsPaginate), Helpers.toLongOrNull(200))).join();
            }
            ...
            Object limitResolved = (((java.util.Objects.equals(limit, null)))) ? 100 : Helpers.mathMin(limit, requestMaxLimit);
    ...
    public CompletableFuture<TradingFeeInterface> fetchTradingFee(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                request.put("uly", Helpers.add((((Map<String, Object>)market).get("baseId") + "-"), ((Map<String, Object>)market).get("quoteId")));
            } else
            {
    ...
    public CompletableFuture<Transaction> withdraw(String code, Object amount, String address, String tag, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object paramsOmitted = (((!java.util.Objects.equals(network, null)))) ? this.omit(paramsWithdrawTag, "network") : paramsWithdrawTag;
            String fee = this.safeString(paramsOmitted, "fee");
            ...
            Object query = this.omit(paramsOmitted, new ArrayList<Object>(Arrays.asList("fee")));
    ...
    public CompletableFuture<Leverage> fetchLeverage(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> marginModeOptionparamsMarginModeVariable = (List<Object>) this.handleMarginModeAndParams("fetchLeverage", parameters, (String) null);
            String marginModeOption = (String) ((List<Object>) marginModeOptionparamsMarginModeVariable).get(0);
            Map<String, Object> paramsMarginMode = (Map<String, Object>) ((List<Object>) marginModeOptionparamsMarginModeVariable).get(1);
            // cross as default marginMode
            String marginMode = (((java.util.Objects.equals(marginModeOption, null)))) ? this.safeString(paramsMarginMode, "mgnMode", "cross") : marginModeOption;
            ...
            if (!java.util.Objects.equals(symbol, null))
            {
                ...
                if (java.util.Objects.equals(((Map<String, Object>)market).get("contract"), true))
                {
                    if (java.util.Objects.equals(((Map<String, Object>)market).get("linear"), true))
                    {
                        ...
                        request.put("ccy", ((Map<String, Object>)market).get("quoteId"));
                    } else
                    {
                        request.put("ctType", "inverse");
                        request.put("ccy", ((Map<String, Object>)market).get("baseId"));
                    }
                }
            }
    ...
    public CompletableFuture<Object> setLeverage(Object leverage, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Map<String, Object> market = (Map<String, Object>) this.market(symbol);
            List<Object> marginModeOptionparamsMarginModeVariable = (List<Object>) this.handleMarginModeAndParams("setLeverage", parameters, (String) null);
            String marginModeOption = (String) ((List<Object>) marginModeOptionparamsMarginModeVariable).get(0);
            Map<String, Object> paramsMarginMode = (Map<String, Object>) ((List<Object>) marginModeOptionparamsMarginModeVariable).get(1);
            // cross as default marginMode
            String marginMode = (((java.util.Objects.equals(marginModeOption, null)))) ? this.safeString(paramsMarginMode, "mgnMode", "cross") : marginModeOption;
    ...
    public CompletableFuture<List<LeverageTier>> fetchMarketLeverageTiers(String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            List<Object> marginModeOptionparamsMarginModeVariable = (List<Object>) this.handleMarginModeAndParams("fetchMarketLeverageTiers", parameters, (String) null);
            String marginModeOption = (String) ((List<Object>) marginModeOptionparamsMarginModeVariable).get(0);
            Map<String, Object> paramsMarginMode = (Map<String, Object>) ((List<Object>) marginModeOptionparamsMarginModeVariable).get(1);
            // cross as default marginMode
            String marginMode = (((java.util.Objects.equals(marginModeOption, null)))) ? this.safeString(paramsMarginMode, "tdMode", "cross") : marginModeOption;
            Map<String, Object> request = Helpers.newMap(
                "instType", type,
                "tdMode", marginMode,
                "uly", uly
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (!java.util.Objects.equals(symbolsNormalized, null))
            {
                if (Helpers.isEqual(symbolsLength, 1))
                {
                    ...
                    request.put("instFamily", Helpers.GetValue(((Map<String, Object>)market).get("info"), "instFamily"));
