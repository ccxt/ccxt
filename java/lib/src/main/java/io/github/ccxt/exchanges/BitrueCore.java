   ...
   public BitrueCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        return java.util.concurrent.CompletableFuture.supplyAsync(() -> {
            ...
            {
                Object currency = Helpers.GetValue(coins, i);
                Object id = this.safeString(currency, "coin");
                Object name = this.safeString(currency, "coinFulName");
                Object code = this.safeCurrencyCode(id);
                Object networkDetails = this.safeList(currency, "chainDetail", new java.util.ArrayList<Object>(java.util.Arrays.asList()));
