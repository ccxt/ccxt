...
public class CoinmetroCore extends CoinmetroApi
{
   ...
   public CoinmetroCore (Object options) {
    ...
    public java.util.concurrent.CompletableFuture<Object> fetchCurrencies(Object... optionalArgs)
    {
        ...
        put( "type", finalType );
        put( "info", currency );
        put( "active", CoinmetroCore.this.safeBool(currency, "canTrade") );
        put( "deposit", CoinmetroCore.this.safeBool(currency, "canDeposit") );
        put( "withdraw", CoinmetroCore.this.safeBool(currency, "canWithdraw") );
        put( "fee", null );
        put( "precision", CoinmetroCore.this.parseNumber(CoinmetroCore.this.parsePrecision(finalPrecisionDigits)) );
        put( "limits", new java.util.HashMap<String, Object>() {{
            put( "amount", new java.util.HashMap<String, Object>() {{
                put( "min", CoinmetroCore.this.safeNumber(currency, "minQty") );
                put( "max", null );
            }} );
