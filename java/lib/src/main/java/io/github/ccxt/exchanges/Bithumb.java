   ...
   public Bithumb (Object options) {
    ...
    public CompletableFuture<Tickers> fetchTickers(List<String> symbols, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            if (Helpers.isEqual(generation, 2))
            {
                ...
                {
                    Map<String, Object> market = (Map<String, Object>) this.market((symbolsForMarketIds == null || i < 0 || i >= symbolsForMarketIds.size() ? null : symbolsForMarketIds.get(i)));
    ...
    public CompletableFuture<Order> fetchOrder(Object id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object paramsOmitted = this.omit(paramsGeneration, "twap");
            Map<String, Object> request = new HashMap<String, Object>() {{}};
            Map<String, Object> response = null;
            Map<String, Object> data = null;
            if (Helpers.isEqual(generation, 2))
    ...
    public CompletableFuture<Order> cancelOrder(Object id, String symbol, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Boolean useClientOrderId = (Helpers.isEqual(generation, 2)) && (!java.util.Objects.equals(clientOrderId, null));
            ...
            } else
            {
                ...
                String side = null;
                if (java.util.Objects.equals(Helpers.GetValue(paramsRequest, "side"), "buy"))
                {
                    side = "bid";
                } else
                {
    ...
    public CompletableFuture<Transaction> withdraw(String code, Object amount, String address, String tag, Map<String, Object> parameters)
    {
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            Object paramsNetwork = this.omit(paramsWithdrawTag, "network");
            Map<String, Object> currency = (Map<String, Object>) this.currency((String) (code));
            Map<String, Object> request = new HashMap<String, Object>() {{}};
            Map<String, Object> response = null;
    ...
    public Object sign(Object path, Object api, Object method, Object parameters, Object headers, String body)
    {
        ...
        String url = (this.implodeHostname(Helpers.GetValue(((Map<String, Object>)this.urls).get("api"), java.util.Objects.requireNonNullElse(api, "public"))) + endpoint);
