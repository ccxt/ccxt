...
public class Bithumb extends BithumbApi
{
   ...
   public Bithumb (Object options) {
    ...
    public Object createOrderRequest(Object symbol, String type, String side, Object amount, Object price, Map<String, Object> parameters)
    {
        ...
        } else
        {
            ...
            if (java.util.Objects.equals(side, "buy"))
            {
                ...
                ((Map<String, Object>)request).put("price", this.priceToPrecision(symbol, cost));
            } else
            {
                ((Map<String, Object>)request).put("volume", this.amountToPrecision(symbol, amount));
                typeRequest = "market";
     ...
     * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
     */
    public CompletableFuture<Order> createTwapOrder(String symbol, String side2, Object amount2, Object duration, Map<String, Object> parameters2)
    {
        final String side3 = side2;
        ...
        return BaseExchange.supplyAsync(() -> {
            ...
            {
                ((Map<String, Object>)request).put("volume", this.amountToPrecision(symbol, amount)); // required for sale
            }
            String sideRequest = null;
            if (java.util.Objects.equals(side, "buy"))
            {
