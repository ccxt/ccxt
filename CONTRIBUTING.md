...
- Add test to `runPrivateTests` or `runPublicTests` to [ts/src/test/tests.exchange.ts](ts/src/test/tests.exchange.ts#L354) or for ccxt.pro endpoints to [ts/src/pro/test/tests.exchange.ts](ts/src/pro/test/tests.exchange.ts#L121)
