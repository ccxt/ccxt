...
// native md5 somehow provides different results for same file on travis-vs-local
function md5_native(content) {
    return crypto.createHash('md5').update(content).digest("hex");
}
function md5_custom(str){
