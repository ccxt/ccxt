...
//
// Typed wrapper for cryptomus.
//
// Owns a `Box<CryptomusCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::cryptomus::CryptomusCore;
use crate::types::*;
...
pub struct Cryptomus {
    ...
    core: Box<CryptomusCore>,
}

impl Cryptomus {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(CryptomusCore::new(config)) }
    }

    pub fn from_core(core: CryptomusCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut CryptomusCore {
        &mut self.core
    }
...
impl std::ops::Deref for Cryptomus {
    type Target = CryptomusCore;
...
impl crate::typed::TypedExchange for Cryptomus {
