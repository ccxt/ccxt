...
//
// Typed wrapper for xt.
//
// Owns a `Box<XtCore>` and exposes the unified CCXT API
...
impl Xt {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(XtCore::new(config)) }
    }

    pub fn from_core(core: XtCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut XtCore {
        &mut self.core
    }
