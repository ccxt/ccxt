...
//
// Typed wrapper for kucoinfutures.
//
// Owns a `Box<KucoinfuturesCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::kucoinfutures::KucoinfuturesCore;
use crate::types::*;
...
pub struct Kucoinfutures {
    ...
    core: Box<KucoinfuturesCore>,
}

impl Kucoinfutures {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(KucoinfuturesCore::new(config)) }
    }

    pub fn from_core(core: KucoinfuturesCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut KucoinfuturesCore {
        &mut self.core
    }
...
impl std::ops::Deref for Kucoinfutures {
    type Target = KucoinfuturesCore;
...
impl crate::typed::TypedExchange for Kucoinfutures {
