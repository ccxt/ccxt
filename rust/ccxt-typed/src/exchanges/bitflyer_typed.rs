...
//
// Typed wrapper for bitflyer.
//
// Owns a `Box<BitflyerCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::bitflyer::BitflyerCore;
use crate::types::*;
...
pub struct Bitflyer {
    ...
    core: Box<BitflyerCore>,
}

impl Bitflyer {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(BitflyerCore::new(config)) }
    }

    pub fn from_core(core: BitflyerCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BitflyerCore {
        &mut self.core
    }
...
impl std::ops::Deref for Bitflyer {
    type Target = BitflyerCore;
...
impl crate::typed::TypedExchange for Bitflyer {
