...
//
// Typed wrapper for zebpay.
//
// Owns a `Box<ZebpayCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::zebpay::ZebpayCore;
use crate::types::*;
...
impl Zebpay {
    pub fn new(config: Option<Value>) -> Self {
        Self { core: Box::new(ZebpayCore::new(config)) }
    }

    pub fn from_core(core: ZebpayCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut ZebpayCore {
        &mut self.core
    }
...
impl std::ops::Deref for Zebpay {
    type Target = ZebpayCore;
...
impl crate::typed::TypedExchange for Zebpay {
