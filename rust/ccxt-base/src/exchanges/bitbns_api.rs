...
impl BitbnsCore {
    ...
    pub async fn www_get_order_fetch_markets(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_order_fetch_markets".into()), optional_args).await
    }
    ...
    pub async fn www_get_order_fetch_tickers(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_order_fetch_tickers".into()), optional_args).await
    }
    ...
    pub async fn www_get_order_fetch_orderbook(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_order_fetch_orderbook".into()), optional_args).await
    }
    ...
    pub async fn www_get_order_get_ticker_with_volume(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_order_get_ticker_with_volume".into()), optional_args).await
    }
    ...
    pub async fn www_get_exchange_data_ohlc(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_exchange_data_ohlc".into()), optional_args).await
    }
    ...
    pub async fn www_get_exchange_data_order_book(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_exchange_data_order_book".into()), optional_args).await
    }
    ...
    pub async fn www_get_exchange_data_tradedetails(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("www_get_exchange_data_tradedetails".into()), optional_args).await
    }
    ...
    pub async fn v1_get_platform_status(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_get_platform_status".into()), optional_args).await
    }
    ...
    pub async fn v1_get_tickers(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_get_tickers".into()), optional_args).await
    }
    ...
    pub async fn v1_get_orderbook_sell_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_get_orderbook_sell_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_get_orderbook_buy_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_get_orderbook_buy_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_current_coin_balance_everything(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_current_coin_balance_everything".into()), optional_args).await
    }
    ...
    pub async fn v1_post_get_api_usage_status_usage(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_get_api_usage_status_usage".into()), optional_args).await
    }
    ...
    pub async fn v1_post_get_order_socket_token_usage(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_get_order_socket_token_usage".into()), optional_args).await
    }
    ...
    pub async fn v1_post_current_coin_balance_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_current_coin_balance_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_order_status_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_order_status_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_deposit_history_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_deposit_history_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_withdraw_history_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_withdraw_history_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_withdraw_history_all_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_withdraw_history_all_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_deposit_history_all_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_deposit_history_all_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_user_history_new(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_user_history_new".into()), optional_args).await
    }
    ...
    pub async fn v1_post_list_open_orders_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_list_open_orders_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_list_open_orders_other_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_list_open_orders_other_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_list_open_stop_orders_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_list_open_stop_orders_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_get_coin_address_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_get_coin_address_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_place_sell_order_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_place_sell_order_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_place_sell_order_other_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_place_sell_order_other_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_place_buy_order_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_place_buy_order_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_place_buy_order_other_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_place_buy_order_other_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_buy_stop_loss_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_buy_stop_loss_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_sell_stop_loss_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_sell_stop_loss_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_cancel_order_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_cancel_order_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_cancel_order_other_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_cancel_order_other_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_cancel_stop_loss_order_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_cancel_stop_loss_order_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_list_executed_orders_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_list_executed_orders_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_place_market_order_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_place_market_order_symbol".into()), optional_args).await
    }
    ...
    pub async fn v1_post_place_market_order_qnty_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v1_post_place_market_order_qnty_symbol".into()), optional_args).await
    }
    ...
    pub async fn v2_post_orders(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_post_orders".into()), optional_args).await
    }
    ...
    pub async fn v2_post_cancel(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_post_cancel".into()), optional_args).await
    }
    ...
    pub async fn v2_post_getordersnew(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_post_getordersnew".into()), optional_args).await
    }
    ...
    pub async fn v2_post_margin_orders(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_post_margin_orders".into()), optional_args).await
    }
