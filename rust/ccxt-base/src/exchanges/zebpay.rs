 ...
 */
    ...
    m
        ...
        let mut types: Value = self.safe_list_k(fetchMarketsOptions.clone(), "types", &[defaultMarkets.clone()]);
        {
            ...
            while { if !__for_first_1124 { i = add(&i, &Value::Int(1)); } __for_first_1124 = false; is_less_than(&i, &get_array_length(&types)) } {
 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        let mut withdraw: Value = Value::Bool(false);
        {
            ...
            while { if !__for_first_1125 { j = add(&j, &Value::Int(1)); } __for_first_1125 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1126 { i = add(&i, &Value::Int(1)); } __for_first_1126 = false; is_less_than(&i, &get_array_length(&fees)) } {
 ...
 */
    ...
    m
        ...
        let mut markets: Value = self.safe_list_k(data.clone(), "symbols", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1127 { i = add(&i, &Value::Int(1)); } __for_first_1127 = false; is_less_than(&i, &get_array_length(&markets)) } {
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        let mut currencyList: Value = self.safe_list_k(response.clone(), "data", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1129 { i = add(&i, &Value::Int(1)); } __for_first_1129 = false; is_less_than(&i, &get_array_length(&currencyList)) } {
