 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("active".to_string(), Value::Bool((!is_equal(&self.safe_bool_k(rawCurrency.clone(), "IsDisabled", &[]), &Value::Bool(true)))));
 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("future".to_string(), Value::Bool(false));
        m.insert("option".to_string(), Value::Bool(false));
        m.insert("active".to_string(), Value::Bool((is_true(&sessionRunning) && is_true(&(!is_equal(&isDisable, &Value::Bool(true)))))));
    ...
    pub fn parse_order_book(&self, mut orderbook: Value, mut symbol: Value, optional_args: &[Value]) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_984 { i = add(&i, &Value::Int(1)); } __for_first_984 = false; is_less_than(&i, &get_array_length(&orderbook)) } {
 ...
 */
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        if is_true(&Value::Bool(is_array(&trade))) {
            ...
            side = ternary(is_true(&(is_equal(&takerSide, &Value::Bool(true)))), Value::Str("sell".to_string()), Value::Str("buy".to_string()));
 ...
 */
    ...
    m
        ...
        if is_true(&(is_equal(&self.login, &Value::Null))) || is_true(&(is_equal(&self.login, &Value::Str("".to_string())))) {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_985 { i = add(&i, &Value::Int(1)); } __for_first_985 = false; is_less_than(&i, &get_array_length(&response)) } {
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_986 { i = add(&i, &Value::Int(1)); } __for_first_986 = false; is_less_than(&i, &get_array_length(&response)) } {
