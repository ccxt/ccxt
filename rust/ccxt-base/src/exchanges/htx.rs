 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_746 { i = add(&i, &Value::Int(1)); } __for_first_746 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut keys: Value = object_keys(&types);
        {
            ...
            while { if !__for_first_747 { i = add(&i, &Value::Int(1)); } __for_first_747 = false; is_less_than(&i, &get_array_length(&keys)) } {
        ...
        promises = promise_all(&promises).await;
        {
            ...
            while { if !__for_first_748 { i = add(&i, &Value::Int(1)); } __for_first_748 = false; is_less_than(&i, &get_array_length(&promises)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_749 { i = add(&i, &Value::Int(1)); } __for_first_749 = false; is_less_than(&i, &get_array_length(&markets)) } {
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_750 { i = add(&i, &Value::Int(1)); } __for_first_750 = false; is_less_than(&i, &get_array_length(&futureMarkets)) } {
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            let mut trades: Value = self.safe_value_k(get_value(&data, &i), "data", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_751 { j = add(&j, &Value::Int(1)); } __for_first_751 = false; is_less_than(&j, &get_array_length(&trades)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_753 { i = add(&i, &Value::Int(1)); } __for_first_753 = false; is_less_than(&i, &get_array_length(&accounts)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_754 { j = add(&j, &Value::Int(1)); } __for_first_754 = false; is_less_than(&j, &get_array_length(&chains)) } {
    ...
    m
        ...
        if is_true(&isMultiAssetMode) || is_true(&(is_true(&linear) && is_true(&(is_true(&swap) || is_true(&future))))) {
            let mut details: Value = self.safe_list_k(data.clone(), "details", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_755 { i = add(&i, &Value::Int(1)); } __for_first_755 = false; is_less_than(&i, &get_array_length(&details)) } {
            ...
            if is_true(&isolated) {
                {
                    ...
                    while { if !__for_first_757 { i = add(&i, &Value::Int(1)); } __for_first_757 = false; is_less_than(&i, &get_array_length(&data)) } {
                    ...
                    });
                    {
                        ...
                        while { if !__for_first_756 { j = add(&j, &Value::Int(1)); } __for_first_756 = false; is_less_than(&j, &get_array_length(&balances)) } {
        ...
        }  else if is_true(&inverse) {
            {
                ...
                while { if !__for_first_759 { i = add(&i, &Value::Int(1)); } __for_first_759 = false; is_less_than(&i, &get_array_length(&data)) } {
        ...
        if is_equal(&marketType, &Value::Str("spot".to_string())) {
            ...
            if is_equal(&accountId, &Value::Null) {
                ...
                self.load_accounts(&[]).await;
                {
                    ...
                    while { if !__for_first_760 { i = add(&i, &Value::Int(1)); } __for_first_760 = false; is_less_than(&i, &get_array_length(&self.accounts)) } {
 ...
 */
    ...
    m
        ...
        let mut marginMode: Value = Value::Null;
        {
            ...
            while { if !__for_first_761 { i = add(&i, &Value::Int(1)); } __for_first_761 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_763 { i = add(&i, &Value::Int(1)); } __for_first_763 = false; is_less_than(&i, &get_array_length(&success)) } {
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_764 { i = add(&i, &Value::Int(1)); } __for_first_764 = false; is_less_than(&i, &get_array_length(&failed)) } {
 ...
 */
    ...
    m
        ...
        let mut addresses: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_765 { i = add(&i, &Value::Int(1)); } __for_first_765 = false; is_less_than(&i, &get_array_length(&allAddresses)) } {
    ...
    m
        ...
        if is_true(&get_value(&market, &Value::Str("linear".to_string()))) {
            ...
            let mut result: Value = self.safe_value_k(data.clone(), "data", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_767 { i = add(&i, &Value::Int(1)); } __for_first_767 = false; is_less_than(&i, &get_array_length(&result)) } {
 ...
 */
    ...
    m
                ...
                if is_true(&(!is_equal(&query, &Value::Null))) && is_true(&get_array_length(&object_keys(&query))) {
        ...
        if is_true(&get_value(&market, &Value::Str("future".to_string()))) && is_true(&get_value(&market, &Value::Str("inverse".to_string()))) {
            {
                ...
                while { if !__for_first_769 { i = add(&i, &Value::Int(1)); } __for_first_769 = false; is_less_than(&i, &get_array_length(&positions)) } {
 ...
 */
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        let mut brackets: Value = self.safe_list_k(info.clone(), "list", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_771 { i = add(&i, &Value::Int(1)); } __for_first_771 = false; is_less_than(&i, &get_array_length(&brackets)) } {
            ...
            let mut ladders: Value = self.safe_list_k(item.clone(), "ladders", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_770 { k = add(&k, &Value::Int(1)); } __for_first_770 = false; is_less_than(&k, &get_array_length(&ladders)) } {
 ...
 */
    ...
    pub fn parse_deposit_withdraw_fee(&self, mut fee: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = self.deposit_withdraw_fee(fee.clone());
        {
            ...
            while { if !__for_first_772 { j = add(&j, &Value::Int(1)); } __for_first_772 = false; is_less_than(&j, &get_array_length(&chains)) } {
            let mut chainEntry: Value = get_value(&chains, &j);
            let mut chainEntry: Value = get_value(&chains, &j);
    ...
    pub fn parse_settlements(&self, mut settlements: Value, mut market: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_774 { i = add(&i, &Value::Int(1)); } __for_first_774 = false; is_less_than(&i, &get_array_length(&settlements)) } {
            ...
            if is_true(&get_value(&market, &Value::Str("linear".to_string()))) {
                ...
                });
                {
                    ...
                    while { if !__for_first_773 { j = add(&j, &Value::Int(1)); } __for_first_773 = false; is_less_than(&j, &get_array_length(&list)) } {
