 ...
 */
    ...
    m
        ...
        let mut url: Value = Value::Null;
        {
            ...
            while { if !__for_first_475 { i = add(&i, &Value::Int(1)); } __for_first_475 = false; is_less_than(&i, &get_array_length(&list)) } {
 ...
 */
    ...
    pub fn parse_currency(&self, mut currency: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_476 { j = add(&j, &Value::Int(1)); } __for_first_476 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_478 { i = add(&i, &Value::Int(1)); } __for_first_478 = false; is_less_than(&i, &get_array_length(&types)) } {
    ...
    m
                ...
                let mut optionsCurrencies: Value = self.safe_list_k(fetchMarketsOptions.clone(), "options", &[Value::List(vec![Value::Str("BTC".to_string()), Value::Str("ETH".to_string()), Value::Str("SOL".to_string())])]);
                {
                    ...
                    while { if !__for_first_477 { j = add(&j, &Value::Int(1)); } __for_first_477 = false; is_less_than(&j, &get_array_length(&optionsCurrencies)) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_479 { i = add(&i, &Value::Int(1)); } __for_first_479 = false; is_less_than(&i, &get_array_length(&promises)) } {
    ...
    m
        ...
        let mut makerFee: Value = self.parse_number(Value::Str("0.001".to_string()), &[]);
        {
            ...
            while { if !__for_first_480 { i = add(&i, &Value::Int(1)); } __for_first_480 = false; is_less_than(&i, &get_array_length(&markets)) } {
    ...
    m
        ...
        let mut category: Value = self.safe_string_k(data.clone(), "category", &[]);
        {
            ...
            while { if !__for_first_481 { i = add(&i, &Value::Int(1)); } __for_first_481 = false; is_less_than(&i, &get_array_length(&markets)) } {
            let mut market: Value = get_value(&markets, &i);
            let mut market: Value = get_value(&markets, &i);
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_482 { i = add(&i, &Value::Int(1)); } __for_first_482 = false; is_less_than(&i, &get_array_length(&markets)) } {
            let mut market: Value = get_value(&markets, &i);
            let mut market: Value = get_value(&markets, &i);
            let mut id: Value = self.safe_string_k(market.clone(), "symbol", &[]);
            let mut baseId: Value = self.safe_string_k(market.clone(), "baseCoin", &[]);
    ...
    m
        ...
        if !is_equal(&symbols, &Value::Null) {
            ...
            let mut currentType: Value = Value::Null;
            {
                ...
                while { if !__for_first_483 { i = add(&i, &Value::Int(1)); } __for_first_483 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut timestamp: Value = self.safe_integer_k(response.clone(), "time", &[]);
        {
            ...
            while { if !__for_first_484 { i = add(&i, &Value::Int(1)); } __for_first_484 = false; is_less_than(&i, &get_array_length(&tickerList)) } {
 ...
 */
    ...
    m
        ...
        let mut resultList: Value = self.safe_list_k(result.clone(), "list", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_485 { i = add(&i, &Value::Int(1)); } __for_first_485 = false; is_less_than(&i, &get_array_length(&resultList)) } {
    ...
    m
        ...
        if is_equal(&currencyList, &Value::Null) {
        ...
        }  else {
            {
                ...
                while { if !__for_first_487 { i = add(&i, &Value::Int(1)); } __for_first_487 = false; is_less_than(&i, &get_array_length(&currencyList)) } {
                ...
                if is_equal(&accountType, &Value::Str("UNIFIED".to_string())) || is_equal(&accountType, &Value::Str("CONTRACT".to_string())) || is_equal(&accountType, &Value::Str("SPOT".to_string())) {
                    let mut coins: Value = self.safe_list_k(entry.clone(), "coin", &[Value::List(vec![])]);
                    {
                        ...
                        while { if !__for_first_486 { j = add(&j, &Value::Int(1)); } __for_first_486 = false; is_less_than(&j, &get_array_length(&coins)) } {
                        let mut account: Value = self.account();
 ...
 */
    ...
    m
        ...
        let mut orderSymbols: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_488 { i = add(&i, &Value::Int(1)); } __for_first_488 = false; is_less_than(&i, &get_array_length(&orders)) } {
    ...
    m
        ...
        let mut codes: Value = self.safe_list_k(retInfo.clone(), "list", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_489 { i = add(&i, &Value::Int(1)); } __for_first_489 = false; is_less_than(&i, &get_array_length(&codes)) } {
 ...
 */
    ...
    m
        ...
        params = self.omit(params.clone(), Value::List(vec![Value::Str("clientOrderIds".to_string()), Value::Str("clientOids".to_string())]), &[]);
        {
            ...
            while { if !__for_first_492 { i = add(&i, &Value::Int(1)); } __for_first_492 = false; is_less_than(&i, &get_array_length(&clientOrderIds)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_496 { i = add(&i, &Value::Int(1)); } __for_first_496 = false; is_less_than(&i, &get_array_length(&fees)) } {
        ...
        if !is_equal(&chainsLength, &Value::Int(0)) {
            {
                ...
                while { if !__for_first_497 { i = add(&i, &Value::Int(1)); } __for_first_497 = false; is_less_than(&i, &chainsLength) } {
 ...
 */
    ...
    pub fn parse_settlements(&self, mut settlements: Value, mut market: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_498 { i = add(&i, &Value::Int(1)); } __for_first_498 = false; is_less_than(&i, &get_array_length(&settlements)) } {
 ...
 */
    ...
    pub fn parse_volatility_history(&self, mut volatility: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_499 { i = add(&i, &Value::Int(1)); } __for_first_499 = false; is_less_than(&i, &get_array_length(&volatility)) } {
 ...
 */
    ...
    pub fn parse_leverage_tiers(&self, mut response: Value, optional_args: &[Value]) -> Value {
        ...
        let mut keys: Value = object_keys(&grouped);
        {
            ...
            while { if !__for_first_501 { i = add(&i, &Value::Int(1)); } __for_first_501 = false; is_less_than(&i, &get_array_length(&keys)) } {
            ...
            let mut entry: Value = get_value(&grouped, &marketId);
            {
                ...
                while { if !__for_first_500 { j = add(&j, &Value::Int(1)); } __for_first_500 = false; is_less_than(&j, &get_array_length(&entry)) } {
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        let mut tiers: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_502 { i = add(&i, &Value::Int(1)); } __for_first_502 = false; is_less_than(&i, &get_array_length(&info)) } {
 ...
 */
    ...
    m
        ...
        let mut coins: Value = self.safe_list_k(data.clone(), "coins", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_503 { i = add(&i, &Value::Int(1)); } __for_first_503 = false; is_less_than(&i, &get_array_length(&coins)) } {
