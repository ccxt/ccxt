 ...
 */
    ...
    pub fn get_closest_limit(&self, mut limit: Value) -> Value {
        ...
        let mut result: Value = Value::Int(1000);
        {
            ...
            while { if !__for_first_492 { i = add(&i, &Value::Int(1)); } __for_first_492 = false; is_less_than(&i, &get_array_length(&limits)) } {
            if is_equal(&limit, &Value::Null) {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_495 { i = add(&i, &Value::Int(1)); } __for_first_495 = false; is_less_than(&i, &get_array_length(&response)) } {
