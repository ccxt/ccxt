...
impl ZaifCore {
    ...
    pub async fn public_get_depth_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_depth_pair".into()), optional_args).await
    }
    ...
    pub async fn public_get_currencies_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_currencies_pair".into()), optional_args).await
    }
    ...
    pub async fn public_get_currencies_all(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_currencies_all".into()), optional_args).await
    }
    ...
    pub async fn public_get_currency_pairs_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_currency_pairs_pair".into()), optional_args).await
    }
    ...
    pub async fn public_get_currency_pairs_all(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_currency_pairs_all".into()), optional_args).await
    }
    ...
    pub async fn public_get_last_price_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_last_price_pair".into()), optional_args).await
    }
    ...
    pub async fn public_get_ticker_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_ticker_pair".into()), optional_args).await
    }
    ...
    pub async fn public_get_vasp_info_vasp_master_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_vasp_info_vasp_master_id".into()), optional_args).await
    }
    ...
    pub async fn public_get_country_info_code(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_country_info_code".into()), optional_args).await
    }
    ...
    pub async fn public_get_corp_type_id_info_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("public_get_corp_type_id_info_id".into()), optional_args).await
    }
    ...
    pub async fn private_post_active_orders(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_active_orders".into()), optional_args).await
    }
    ...
    pub async fn private_post_deposit_history(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_deposit_history".into()), optional_args).await
    }
    ...
    pub async fn private_post_get_id_info(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_get_id_info".into()), optional_args).await
    }
    ...
    pub async fn private_post_get_info(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_get_info".into()), optional_args).await
    }
    ...
    pub async fn private_post_get_info2(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_get_info2".into()), optional_args).await
    }
    ...
    pub async fn private_post_get_personal_info(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_get_personal_info".into()), optional_args).await
    }
    ...
    pub async fn private_post_trade(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_trade".into()), optional_args).await
    }
    ...
    pub async fn private_post_trade_history(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_trade_history".into()), optional_args).await
    }
    ...
    pub async fn private_post_withdraw_history(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("private_post_withdraw_history".into()), optional_args).await
    }
    ...
    pub async fn ecapi_post_create_invoice(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("ecapi_post_create_invoice".into()), optional_args).await
    }
    ...
    pub async fn ecapi_post_get_invoice(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("ecapi_post_get_invoice".into()), optional_args).await
    }
    ...
    pub async fn ecapi_post_get_invoice_ids_by_order_number(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("ecapi_post_get_invoice_ids_by_order_number".into()), optional_args).await
    }
    ...
    pub async fn ecapi_post_cancel_invoice(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("ecapi_post_cancel_invoice".into()), optional_args).await
    }
    ...
    pub async fn tlapi_post_get_positions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("tlapi_post_get_positions".into()), optional_args).await
    }
    ...
    pub async fn tlapi_post_position_history(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("tlapi_post_position_history".into()), optional_args).await
    }
    ...
    pub async fn tlapi_post_active_positions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("tlapi_post_active_positions".into()), optional_args).await
    }
    ...
    pub async fn tlapi_post_create_position(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("tlapi_post_create_position".into()), optional_args).await
    }
    ...
    pub async fn tlapi_post_change_position(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("tlapi_post_change_position".into()), optional_args).await
    }
    ...
    pub async fn tlapi_post_cancel_position(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("tlapi_post_cancel_position".into()), optional_args).await
    }
    ...
    pub async fn fapi_get_groups_group_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("fapi_get_groups_group_id".into()), optional_args).await
    }
    ...
    pub async fn fapi_get_last_price_group_id_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("fapi_get_last_price_group_id_pair".into()), optional_args).await
    }
    ...
    pub async fn fapi_get_ticker_group_id_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("fapi_get_ticker_group_id_pair".into()), optional_args).await
    }
    ...
    pub async fn fapi_get_trades_group_id_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("fapi_get_trades_group_id_pair".into()), optional_args).await
    }
    ...
    pub async fn fapi_get_depth_group_id_pair(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("fapi_get_depth_group_id_pair".into()), optional_args).await
    }
