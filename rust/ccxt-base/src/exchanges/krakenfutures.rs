 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_843 { i = add(&i, &Value::Int(1)); } __for_first_843 = false; is_less_than(&i, &get_array_length(&instruments)) } {
    ...
    m
        ...
        let mut currencies: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_844 { i = add(&i, &Value::Int(1)); } __for_first_844 = false; is_less_than(&i, &get_array_length(&settlementCurrencies)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_845 { i = add(&i, &Value::Int(1)); } __for_first_845 = false; is_less_than(&i, &get_array_length(&feeSchedules)) } {
        ...
        let mut symbols: Value = self.symbols.clone();
        {
            ...
            while { if !__for_first_846 { i = add(&i, &Value::Int(1)); } __for_first_846 = false; is_less_than(&i, &get_array_length(&symbols)) } {
    ...
    pub fn parse_trading_fee(&self, mut fee: Value, optional_args: &[Value]) -> Value {
        ...
        let mut takerFee: Value = Value::Null;
        {
            ...
            while { if !__for_first_847 { i = add(&i, &Value::Int(1)); } __for_first_847 = false; is_less_than(&i, &get_array_length(&tiers)) } {
    ...
    m
        ...
        if is_true(&isFullHistoryEndpoint) {
            ...
            let mut length: Value = get_array_length(&elements);
            {
                ...
                while { if !__for_first_848 { i = add(&i, &Value::Int(1)); } __for_first_848 = false; is_less_than(&i, &length) } {
 ...
 */
    ...
    m
        ...
        let mut ordersRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_849 { i = add(&i, &Value::Int(1)); } __for_first_849 = false; is_less_than(&i, &get_array_length(&orders)) } {
        ...
        if is_greater_than(&clientOrderIdsLength, &Value::Int(0)) {
            {
                ...
                while { if !__for_first_850 { i = add(&i, &Value::Int(1)); } __for_first_850 = false; is_less_than(&i, &get_array_length(&clientOrderIds)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_852 { i = add(&i, &Value::Int(1)); } __for_first_852 = false; is_less_than(&i, &get_array_length(&orderEvents)) } {
    ...
    m
        ...
        if is_true(&orderEventsLength) {
            let mut executions: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_855 { i = add(&i, &Value::Int(1)); } __for_first_855 = false; is_less_than(&i, &get_array_length(&orderEvents)) } {
        ...
        if is_greater_than(&tradesLength, &Value::Int(0)) {
            let mut vwapSum: Value = Value::Str("0.0".to_string());
            {
                ...
                while { if !__for_first_856 { i = add(&i, &Value::Int(1)); } __for_first_856 = false; is_less_than(&i, &get_array_length(&trades)) } {
 ...
 */
    ...
    m
        ...
        let mut rows: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_857 { i = add(&i, &Value::Int(1)); } __for_first_857 = false; is_less_than(&i, &get_array_length(&logs)) } {
