 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_842 { i = add(&i, &Value::Int(1)); } __for_first_842 = false; is_less_than(&i, &get_array_length(&instruments)) } {
    ...
    m
        ...
        let mut currencies: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_843 { i = add(&i, &Value::Int(1)); } __for_first_843 = false; is_less_than(&i, &get_array_length(&settlementCurrencies)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_844 { i = add(&i, &Value::Int(1)); } __for_first_844 = false; is_less_than(&i, &get_array_length(&feeSchedules)) } {
        ...
        let mut symbols: Value = self.symbols.clone();
        {
            ...
            while { if !__for_first_845 { i = add(&i, &Value::Int(1)); } __for_first_845 = false; is_less_than(&i, &get_array_length(&symbols)) } {
    ...
    pub fn parse_trading_fee(&self, mut fee: Value, optional_args: &[Value]) -> Value {
        ...
        let mut takerFee: Value = Value::Null;
        {
            ...
            while { if !__for_first_846 { i = add(&i, &Value::Int(1)); } __for_first_846 = false; is_less_than(&i, &get_array_length(&tiers)) } {
    ...
    m
        ...
        if is_true(&isFullHistoryEndpoint) {
            ...
            let mut length: Value = get_array_length(&elements);
            {
                ...
                while { if !__for_first_847 { i = add(&i, &Value::Int(1)); } __for_first_847 = false; is_less_than(&i, &length) } {
 ...
 */
    ...
    m
        ...
        let mut ordersRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_848 { i = add(&i, &Value::Int(1)); } __for_first_848 = false; is_less_than(&i, &get_array_length(&orders)) } {
        ...
        if is_greater_than(&clientOrderIdsLength, &Value::Int(0)) {
            {
                ...
                while { if !__for_first_849 { i = add(&i, &Value::Int(1)); } __for_first_849 = false; is_less_than(&i, &get_array_length(&clientOrderIds)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_851 { i = add(&i, &Value::Int(1)); } __for_first_851 = false; is_less_than(&i, &get_array_length(&orderEvents)) } {
 ...
 */
    ...
    m
        ...
        let mut closedOrders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_852 { i = add(&i, &Value::Int(1)); } __for_first_852 = false; is_less_than(&i, &get_array_length(&allOrders)) } {
 ...
 */
    ...
    m
        ...
        let mut canceledAndRejected: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_853 { i = add(&i, &Value::Int(1)); } __for_first_853 = false; is_less_than(&i, &get_array_length(&allOrders)) } {
            let mut order: Value = get_value(&allOrders, &i);
            let mut order: Value = get_value(&allOrders, &i);
            let mut event: Value = self.safe_dict_k(order.clone(), "event", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    ...
    m
        ...
        if is_true(&orderEventsLength) {
            let mut executions: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_854 { i = add(&i, &Value::Int(1)); } __for_first_854 = false; is_less_than(&i, &get_array_length(&orderEvents)) } {
        ...
        if is_greater_than(&tradesLength, &Value::Int(0)) {
            let mut vwapSum: Value = Value::Str("0.0".to_string());
            {
                ...
                while { if !__for_first_855 { i = add(&i, &Value::Int(1)); } __for_first_855 = false; is_less_than(&i, &get_array_length(&trades)) } {
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.history_get_account_log(&[__ws_arg_15]).await;
        //
        //    {
        ...
        let mut rows: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_856 { i = add(&i, &Value::Int(1)); } __for_first_856 = false; is_less_than(&i, &get_array_length(&logs)) } {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        let mut currencyIds: Value = object_keys(&balances);
        {
            ...
            while { if !__for_first_857 { i = add(&i, &Value::Int(1)); } __for_first_857 = false; is_less_than(&i, &get_array_length(&currencyIds)) } {
 ...
 */
    ...
    m
        ...
        let mut fundingRates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_858 { i = add(&i, &Value::Int(1)); } __for_first_858 = false; is_less_than(&i, &get_array_length(&tickers)) } {
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.public_get_historicalfundingrates(&[__ws_arg_16]).await;
        //
        //    {
        //        "rates": [
        //          {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_859 { i = add(&i, &Value::Int(1)); } __for_first_859 = false; is_less_than(&i, &get_array_length(&rates)) } {
 ...
 */
    ...
    m
        ...
        if is_equal(&positions, &Value::Null) {
            panic!("{}", crate::exchange_errors::exchange_error(add(&self.id, &Value::Str(" fetchPositions() returned a response without an \"openPositions\" list".to_string()))));
        }
        {
                        let mut i: Value = Value::Int(0);
            let mut __for_first_860: bool = true;
            while { if !__for_first_860 { i = add(&i, &Value::Int(1)); } __for_first_860 = false; is_less_than(&i, &get_array_length(&positions)) } {
 ...
 */
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_861 { i = add(&i, &Value::Int(1)); } __for_first_861 = false; is_less_than(&i, &get_array_length(&marginLevels)) } {
 ...
 */
    ...
    m
        ...
        if is_equal(&toAccount, &Value::Str("spot".to_string())) {
            ...
            response = self.private_post_withdrawal(&[__ws_arg_17]).await;
        }  else {
            ...
            response = self.private_post_transfer(&[__ws_arg_18]).await;
        }
        //
        //    {
        //        "result": "success",
 ...
 */
    ...
    m
        ...
        return self.private_put_leveragepreferences(&[__ws_arg_19]).await;
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.private_get_leveragepreferences(&[__ws_arg_20]).await;
        //
        //     {
        //         "result": "success",
