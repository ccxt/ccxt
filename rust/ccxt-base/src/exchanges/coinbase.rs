 ...
 */
    ...
    m
        ...
        let mut delimiter: Value = Value::Str("-".into());
        {
            ...
            if let Value::Dict(__d) = &mut result { std::sync::Arc::make_mut(__d).insert(crate::runtime::stringify_param(&symbol), self.parse_ticker(get_value(&rates, &baseId), &[market])); }
        }
        }
