 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_911 { i = add(&i, &Value::Int(1)); } __for_first_911 = false; is_less_than(&i, &get_array_length(&rawCurrency)) } {
 ...
 */
    ...
    m
        ...
        let mut markets: Value = self.safe_value_k(response.clone(), "markets", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_912 { i = add(&i, &Value::Int(1)); } __for_first_912 = false; is_less_than(&i, &get_array_length(&markets)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_913 { i = add(&i, &Value::Int(1)); } __for_first_913 = false; is_less_than(&i, &get_array_length(&wallets)) } {
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_914 { i = add(&i, &Value::Int(1)); } __for_first_914 = false; is_less_than(&i, &get_array_length(&wallets)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_915 { i = add(&i, &Value::Int(1)); } __for_first_915 = false; is_less_than(&i, &get_array_length(&ids)) } {
