 ...
 */
    ...
    m
        ...
        let mut currencyIds: Value = object_keys(&tokensById);
        {
            ...
            while { if !__for_first_1091 { i = add(&i, &Value::Int(1)); } __for_first_1091 = false; is_less_than(&i, &get_array_length(&currencyIds)) } {
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_1092 { j = add(&j, &Value::Int(1)); } __for_first_1092 = false; is_less_than(&j, &get_array_length(&keys)) } {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        let mut balances: Value = self.safe_list_k(response.clone(), "holding", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1093 { i = add(&i, &Value::Int(1)); } __for_first_1093 = false; is_less_than(&i, &get_array_length(&balances)) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1094 { i = add(&i, &Value::Int(1)); } __for_first_1094 = false; is_less_than(&i, &get_array_length(&rows)) } {
 ...
 */
    ...
    pub fn parse_leverage(&self, mut leverage: Value, optional_args: &[Value]) -> Value {
        ...
        let mut details: Value = self.safe_list_k(leverage.clone(), "details", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1095 { i = add(&i, &Value::Int(1)); } __for_first_1095 = false; is_less_than(&i, &get_array_length(&details)) } {
 ...
 */
    ...
    m
        ...
        let mut data: Value = self.safe_list_k(response.clone(), "rows", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1096 { i = add(&i, &Value::Int(1)); } __for_first_1096 = false; is_less_than(&i, &get_array_length(&data)) } {
 ...
 */
    ...
    pub fn default_network_code_for_currency(&self, mut code: Value) -> Value {
        ...
        let mut networkKeys: Value = object_keys(&networks);
        {
            ...
            while { if !__for_first_1097 { i = add(&i, &Value::Int(1)); } __for_first_1097 = false; is_less_than(&i, &get_array_length(&networkKeys)) } {
