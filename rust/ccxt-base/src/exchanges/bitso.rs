 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_400 { i = add(&i, &Value::Int(1)); } __for_first_400 = false; is_less_than(&i, &get_array_length(&markets)) } {
            ...
            let mut makerFees: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_399 { j = add(&j, &Value::Int(1)); } __for_first_399 = false; is_less_than(&j, &get_array_length(&feeTiers)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_402 { i = add(&i, &Value::Int(1)); } __for_first_402 = false; is_less_than(&i, &get_array_length(&fees)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_403 { i = add(&i, &Value::Int(1)); } __for_first_403 = false; is_less_than(&i, &get_array_length(&payload)) } {
 ...
 */
    ...
    m
        ...
        let mut depositFees: Value = self.safe_list_k(payload.clone(), "deposit_fees", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_405 { i = add(&i, &Value::Int(1)); } __for_first_405 = false; is_less_than(&i, &get_array_length(&depositFees)) } {
    ...
    m
        ...
        let mut currencyIds: Value = object_keys(&withdrawalFees);
        {
            ...
            while { if !__for_first_406 { i = add(&i, &Value::Int(1)); } __for_first_406 = false; is_less_than(&i, &get_array_length(&currencyIds)) } {
 ...
 */
    ...
    pub fn parse_deposit_withdraw_fees(&self, mut response: Value, optional_args: &[Value]) -> Value {
        ...
        let mut withdrawalResponse: Value = self.safe_value_k(response.clone(), "withdrawal_fees", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_407 { i = add(&i, &Value::Int(1)); } __for_first_407 = false; is_less_than(&i, &get_array_length(&depositResponse)) } {
    ...
    m
        ...
        let mut withdrawalKeys: Value = object_keys(&withdrawalResponse);
        {
            ...
            while { if !__for_first_408 { i = add(&i, &Value::Int(1)); } __for_first_408 = false; is_less_than(&i, &get_array_length(&withdrawalKeys)) } {
