 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1087 { i = add(&i, &Value::Int(1)); } __for_first_1087 = false; is_less_than(&i, &get_array_length(&coins)) } {
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        let mut rawNetworks: Value = self.safe_list_k(rawCurrency.clone(), "chainTypes", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1088 { j = add(&j, &Value::Int(1)); } __for_first_1088 = false; is_less_than(&j, &get_array_length(&rawNetworks)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1089 { i = add(&i, &Value::Int(1)); } __for_first_1089 = false; is_less_than(&i, &get_array_length(&all)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_1092 { i = add(&i, &Value::Int(1)); } __for_first_1092 = false; is_less_than(&i, &get_array_length(&responseList)) } {
