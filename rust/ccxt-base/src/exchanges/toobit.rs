 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1078 { i = add(&i, &Value::Int(1)); } __for_first_1078 = false; is_less_than(&i, &get_array_length(&coins)) } {
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        let mut rawNetworks: Value = self.safe_list_k(rawCurrency.clone(), "chainTypes", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1079 { j = add(&j, &Value::Int(1)); } __for_first_1079 = false; is_less_than(&j, &get_array_length(&rawNetworks)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1080 { i = add(&i, &Value::Int(1)); } __for_first_1080 = false; is_less_than(&i, &get_array_length(&all)) } {
 ...
 */
    ...
    m
        ...
        let mut results: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1081 { i = add(&i, &Value::Int(1)); } __for_first_1081 = false; is_less_than(&i, &get_array_length(&tickers)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_1083 { i = add(&i, &Value::Int(1)); } __for_first_1083 = false; is_less_than(&i, &get_array_length(&responseList)) } {
