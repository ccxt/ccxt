 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_307 { i = add(&i, &Value::Int(1)); } __for_first_307 = false; is_less_than(&i, &get_array_length(&pairs)) } {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        let mut assets: Value = self.safe_value_k(data.clone(), "assets", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_308 { i = add(&i, &Value::Int(1)); } __for_first_308 = false; is_less_than(&i, &get_array_length(&assets)) } {
