...
impl DeribitCore {
    ...
    pub fn safe_market(&self, optional_args: &[Value]) -> Value {
        ...
        let mut isOption: bool = is_true(&(marketId != Value::Null)) && ((ends_with(&marketId, &Value::Str("-C".into()))) || (ends_with(&marketId, &Value::Str("-P".into()))));
 ...
 */
    ...
    m
        ...
        let mut options: Value = self.safe_dict(self.options.clone(), methodName.clone(), &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
        let mut code: Value = self.safe_string_k(options.clone(), "code", &[defaultCode.clone()]);
        return self.safe_string_k(params.clone(), "code", &[code.clone()]);
 ...
 */
    ...
    m
        ...
        return Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("status".to_string(), (if is_true(&(locked.as_deref() == Some("false"))) { Value::Str("ok".into()) } else { Value::Str("maintenance".into()) }));
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            let mut instrumentsResult: Value = self.safe_list_k(get_value(&instrumentsResponses, &i), "result", &[Value::from(vec![])]);
            {
                ...
                if is_true(&isSpot) {
                    ...
                    if is_true(&option) || is_true(&future) {
                        ...
                        if is_true(&option) {
                            ...
                            let mut letter: Value = (if is_true(&(optionType.as_str() == Some("call"))) { Value::Str("C".into()) } else { Value::Str("P".into()) });
    ...
    pub fn parse_balance(&self, mut balance: Value) -> Value {
        ...
        }
        {
            ...
            if let Value::Dict(__d) = &mut account { std::sync::Arc::make_mut(__d).insert("total".to_string(), self.safe_string_k(data.clone(), "equity", &[])); }
 ...
 */
    ...
    m
        ...
        if (code != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("currency".to_string(), self.currency_id(code.clone())); }
        }
 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("quoteVolume".to_string(), self.safe_string2(stats.clone(), Value::Str("volume_notional".into()), Value::Str("volume_usd".into()), &[]));
    ...
    m
        ...
        if (type_var != Value::Null) {
            ...
            if (requestType != Value::Null) {
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("kind".to_string(), requestType.clone()); }
            }
        }
 ...
 */
    ...
    m
        ...
        if (since == Value::Null) {
            ...
            if (limit == Value::Null) {
                ...
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("end_timestamp".to_string(), self.sum(&[since.clone(), (match (&((match (&(limit), &(duration)) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null })), &(Value::Int(1000))) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null })])); }
            }
        }
        ...
        let mut ohlcvs: Value = self.convert_trading_view_to_ohlcv(result.clone(), &[Value::Str("ticks".into()), Value::Str("open".into()), Value::Str("high".into()), Value::Str("low".into()), Value::Str("close".into()), Value::Str("volume".into()), Value::Bool(true)]);
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        if (liquidity.is_some()) {
            ...
            takerOrMaker = (if is_true(&(liquidity.as_deref() == Some("M"))) { Value::Str("maker".into()) } else { Value::Str("taker".into()) });
        }
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("count".to_string(), crate::runtime::Math::min(&limit, &Value::Int(1000))); } // default 10
        }
 ...
 */
    ...
    m
        ...
        let mut orderbook: Value = self.parse_order_book(result.clone(), market.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null), &[timestamp.clone()]);
 ...
 */
    ...
    m
        ...
        if isTrailingAmountOrder {
            ...
            if isStopLossOrder {
                ...
                if is_true(&isMarketOrder) {
                    ...
                    if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("type".to_string(), Value::Str("take_market".into())); }
                }  else {
                    // take_limit (buy only)
                    if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("type".to_string(), Value::Str("take_limit".into())); }
                }
            }
        }
        if is_equal(&reduceOnly, &Value::Bool(true)) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("reduce_only".to_string(), Value::Bool(true)); }
        }
        if is_true(&postOnly) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("post_only".to_string(), Value::Bool(true)); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("reject_post_only".to_string(), Value::Bool(true)); }
        }
        if (timeInForce.is_some()) {
            if (timeInForce.as_deref() == Some("GTC")) {
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("time_in_force".to_string(), Value::Str("good_til_cancelled".into())); }
            }
        ...
        let mut response: Value = Value::Null;
        if (self.capitalize(side.clone()).as_str() == Some("Buy")) {
    ...
    m
        ...
        let mut trades: Value = self.safe_list_k(result, "trades", &[Value::from(vec![])]);
        add_element_to_object(&mut order, &Value::Str("trades".into()), trades.clone());
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("count".to_string(), Value::Int(1000)); } // max value
        }
        if (symbol == Value::Null) {
 ...
 */
    ...
    m
        ...
        let mut market: Value = Value::Null;
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("count".to_string(), limit.clone()); } // default 10
        }
        let mut response: Value = Value::Null;
        if (symbol == Value::Null) {
 ...
 */
    ...
    pub fn parse_position(&self, mut position: Value, optional_args: &[Value]) -> Value {
        ...
        side = (if is_true(&(side.as_str() == Some("buy"))) { Value::Str("long".into()) } else { Value::Str("short".into()) });
 ...
 */
    ...
    pub fn parse_volatility_history(&self, mut volatility: Value) -> Value {
        ...
        //     }
        //
        let mut volatilityResult: Value = self.safe_list_k(volatility.clone(), "result", &[Value::from(vec![])]);
        let mut result: Value = Value::from(vec![]);
        {
                        let mut i: Value = Value::Int(0);
 ...
 */
    ...
    m
            ...
            method = self.safe_string_k(transferOptions.clone(), "method", &[Value::Str("privateGetSubmitTransferToSubaccount".into())]);
        }
        let mut response: Value = Value::Null;
 ...
 */
    ...
    m
        ...
        if (self.twofa.clone() != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("tfa".to_string(), totp(self.twofa.clone())); }
        }
 ...
 */
    ...
    m
        ...
        if is_true(&paginate) {
            ...
            return self.fetch_paginated_call_deterministic(Value::Str("fetchFundingRateHistory".into()), &[symbol.clone(), since.clone(), limit.clone(), eachItemDuration.clone(), paginationParams.clone(), maxEntriesPerRequest.clone()]).await;
        }
        let mut duration: Value = (match (&(self.parse_timeframe(eachItemDuration.clone())), &(Value::Int(1000))) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null });
        let mut time: Value = self.milliseconds();
        ...
        if is_true(&(matches!(&params, Value::Dict(__d) if __d.contains_key("isDeribitPaginationCall")))) {
            ...
            { let __be_tmp = crate::runtime::Math::min(&crate::value::get_value_k(&request, "end_timestamp"), &maxUntil); if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("end_timestamp".to_string(), __be_tmp); } };
        }
 ...
 */
    ...
    m
        ...
        if (since != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("search_start_timestamp".to_string(), since.clone()); }
        }
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("count".to_string(), limit.clone()); }
        }
    ...
    pub fn add_pagination_cursor_to_result(&self, mut cursor: Value, mut data: Value) -> Value {
        if (cursor != Value::Null) {
            ...
            if dataLength.as_f64().unwrap_or(f64::NAN) > ((0i64) as f64) {
                ...
                add_element_to_object(&mut last, &Value::Str("continuation".into()), cursor.clone());
 ...
 */
    ...
    m
        ...
        //
        let mut result: Value = self.safe_list_k(response, "result", &[Value::from(vec![])]);
        return self.parse_option_chain(result.clone(), &[Value::Str("base_currency".into()), Value::Str("instrument_name".into())]);
