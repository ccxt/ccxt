 ...
 */
    ...
    m
        ...
        return Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("status".to_string(), (if is_true(&(locked.as_str() == Some("false"))) { Value::Str("ok".to_string()) } else { Value::Str("maintenance".to_string()) }));
 ...
 */
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        if (liquidity != Value::Null) {
            ...
            takerOrMaker = (if is_true(&(liquidity.as_str() == Some("M"))) { Value::Str("maker".to_string()) } else { Value::Str("taker".to_string()) });
        }
 ...
 */
    ...
    m
        ...
        let mut response: Value = Value::Null;
        if is_true(&(since == Value::Null)) && !(in_op(&request, &Value::Str("end_timestamp".to_string()))) {
