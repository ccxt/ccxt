 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1105 { i = add(&i, &Value::Int(1)); } __for_first_1105 = false; is_less_than(&i, &get_array_length(&currenciesIds)) } {
 ...
 */
    ...
    pub fn parse_deposit_withdraw_fees(&self, mut response: Value, optional_args: &[Value]) -> Value {
        ...
        let mut currencyIds: Value = object_keys(&response);
        {
            ...
            while { if !__for_first_1106 { i = add(&i, &Value::Int(1)); } __for_first_1106 = false; is_less_than(&i, &get_array_length(&currencyIds)) } {
    ...
    m
        ...
        let mut depositWithdrawCodes: Value = object_keys(&depositWithdrawFees);
        {
            ...
            while { if !__for_first_1107 { i = add(&i, &Value::Int(1)); } __for_first_1107 = false; is_less_than(&i, &get_array_length(&depositWithdrawCodes)) } {
 ...
 */
    ...
    m
        ...
        let mut symbols: Value = self.symbols.clone();
        {
            ...
            while { if !__for_first_1108 { i = add(&i, &Value::Int(1)); } __for_first_1108 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut marketIds: Value = object_keys(&markets);
        {
            ...
            while { if !__for_first_1110 { i = add(&i, &Value::Int(1)); } __for_first_1110 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
            ...
            if !is_equal(&symbols, &Value::Null) {
                let mut symbolFound: bool = false;
                {
                    ...
                    while { if !__for_first_1109 { j = add(&j, &Value::Int(1)); } __for_first_1109 = false; is_less_than(&j, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut currencyKeys: Value = object_keys(&currenciesData);
        {
            ...
            while { if !__for_first_1112 { i = add(&i, &Value::Int(1)); } __for_first_1112 = false; is_less_than(&i, &get_array_length(&currencyKeys)) } {
            ...
            let mut feeKeys: Value = object_keys(&feesData);
            {
                ...
                while { if !__for_first_1111 { j = add(&j, &Value::Int(1)); } __for_first_1111 = false; is_less_than(&j, &get_array_length(&feeKeys)) } {
        ...
        if is_equal(&checkActive, &Value::Bool(true)) {
            let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
                ...
                let mut orders: Value = self.to_array(response.clone());
                {
                    ...
                    while { if !__for_first_1113 { i = add(&i, &Value::Int(1)); } __for_first_1113 = false; is_less_than(&i, &get_array_length(&orders)) } {
            ...
            let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
                ...
                let mut marketIds: Value = object_keys(&response);
                {
                    ...
                    let mut marketOrders: Value = self.safe_list(response.clone(), marketId.clone(), &[Value::List(vec![])]);
                    {
                        ...
                        while { if !__for_first_1114 { j = add(&j, &Value::Int(1)); } __for_first_1114 = false; is_less_than(&j, &get_array_length(&marketOrders)) } {
 ...
 */
    ...
    m
        ...
        if !is_equal(&symbols, &Value::Null) {
            {
                ...
                while { if !__for_first_1116 { i = add(&i, &Value::Int(1)); } __for_first_1116 = false; is_less_than(&i, &get_array_length(&symbols)) } {
                let mut symbol: Value = get_value(&symbols, &i);
                let mut symbol: Value = get_value(&symbols, &i);
                let mut market: Value = self.market(symbol.clone());
        ...
        });
        {
            ...
            while { if !__for_first_1117 { i = add(&i, &Value::Int(1)); } __for_first_1117 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
            let mut marketId: Value = get_value(&marketIds, &i);
            let mut marketId: Value = get_value(&marketIds, &i);
    ...
    m
        ...
        if is_true(&Value::Bool(is_array(&response))) {
            ...
            let mut keys: Value = object_keys(&response);
            {
                ...
                while { if !__for_first_1118 { i = add(&i, &Value::Int(1)); } __for_first_1118 = false; is_less_than(&i, &get_array_length(&keys)) } {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_1119 { i = add(&i, &Value::Int(1)); } __for_first_1119 = false; is_less_than(&i, &get_array_length(&balanceKeys)) } {
 ...
 */
    ...
    m
        ...
        let mut results: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1121 { i = add(&i, &Value::Int(1)); } __for_first_1121 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
            let mut marketId: Value = get_value(&marketIds, &i);
            let mut marketId: Value = get_value(&marketIds, &i);
            let mut marketNew: Value = self.safe_market(&[marketId.clone(), Value::Null, Value::Str("_".to_string())]);
            let mut orders: Value = self.safe_list(response.clone(), marketId.clone(), &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_1120 { j = add(&j, &Value::Int(1)); } __for_first_1120 = false; is_less_than(&j, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        let mut subAccounts: Value = self.safe_list_k(response.clone(), "data", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1122 { i = add(&i, &Value::Int(1)); } __for_first_1122 = false; is_less_than(&i, &get_array_length(&subAccounts)) } {
 ...
 */
    ...
    pub fn parse_funding_histories(&self, mut contracts: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1123 { i = add(&i, &Value::Int(1)); } __for_first_1123 = false; is_less_than(&i, &get_array_length(&contracts)) } {
