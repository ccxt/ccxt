        ...
        if !is_equal(&fullName, &Value::Null) && !is_equal(&name, &Value::Null) {
            ...
            if is_true(&isWrapped) {
                ...
                let mut nameWithoutU: Value = Value::Str("".to_string());
                {
                    ...
                    while { if !__for_first_787 { j = add(&j, &Value::Int(1)); } __for_first_787 = false; is_less_than(&j, &get_array_length(&parts)) } {
 ...
 */
    ...
    m
        ...
        let mut rawPromises: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_788 { i = add(&i, &Value::Int(1)); } __for_first_788 = false; is_less_than(&i, &get_array_length(&types)) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_789 { i = add(&i, &Value::Int(1)); } __for_first_789 = false; is_less_than(&i, &get_array_length(&promises)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_790 { i = add(&i, &Value::Int(1)); } __for_first_790 = false; is_less_than(&i, &get_array_length(&fetchDexes)) } {
    ...
    m
        ...
        if is_greater_than(&userProvidedDexesLength, &Value::Int(0)) {
            ...
            let mut fetchDexesLength: Value = get_array_length(&fetchDexes);
            {
                ...
                while { if !__for_first_791 { i = add(&i, &Value::Int(1)); } __for_first_791 = false; is_less_than(&i, &maxLimit) } {
    ...
    m
        ...
        let mut rawPromises: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_792 { i = add(&i, &Value::Int(1)); } __for_first_792 = false; is_less_than(&i, &get_array_length(&fetchDexesList)) } {
            let mut request: Value = Value::Map({
                let mut m = indexmap::IndexMap::new();
    ...
    m
        ...
        let mut markets: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_794 { i = add(&i, &Value::Int(1)); } __for_first_794 = false; is_less_than(&i, &get_array_length(&promises)) } {
    ...
    m
            ...
            let mut result: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_793 { j = add(&j, &Value::Int(1)); } __for_first_793 = false; is_less_than(&j, &get_array_length(&universe)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_795 { i = add(&i, &Value::Int(1)); } __for_first_795 = false; is_less_than(&i, &get_array_length(&universe)) } {
 ...
 */
    ...
    m
        ...
        let mut markets: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_796 { i = add(&i, &Value::Int(1)); } __for_first_796 = false; is_less_than(&i, &get_array_length(&meta)) } {
    ...
    m
        ...
        if !is_equal(&balances, &Value::Null) {
            ...
            });
            {
                ...
                while { if !__for_first_797 { i = add(&i, &Value::Int(1)); } __for_first_797 = false; is_less_than(&i, &get_array_length(&balances)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_798 { i = add(&i, &Value::Int(1)); } __for_first_798 = false; is_less_than(&i, &get_array_length(&response)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_799 { i = add(&i, &Value::Int(1)); } __for_first_799 = false; is_less_than(&i, &get_array_length(&universe)) } {
 ...
 */
    ...
    m
        ...
        let mut ordersToBeParsed: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_800 { i = add(&i, &Value::Int(1)); } __for_first_800 = false; is_less_than(&i, &get_array_length(&statuses)) } {
    ...
    m
        ...
        let mut isTrigger: Value = Value::Bool(is_true(&(!is_equal(&stopLossPrice, &Value::Null))) || is_true(&(!is_equal(&takeProfitPrice, &Value::Null))));
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_804 { i = add(&i, &Value::Int(1)); } __for_first_804 = false; is_less_than(&i, &get_array_length(&statuses)) } {
    ...
    m
        ...
        if !is_equal(&clientOrderId, &Value::Null) {
            ...
            add_element_to_object(&mut cancelAction, &Value::Str("type".to_string()), Value::Str("cancelByCloid".to_string()));
            {
                ...
                while { if !__for_first_805 { i = add(&i, &Value::Int(1)); } __for_first_805 = false; is_less_than(&i, &get_array_length(&clientOrderId)) } {
 ...
 */
    ...
    m
        ...
        let mut cancelByCloid: Value = Value::Bool(false);
        {
            ...
            while { if !__for_first_807 { i = add(&i, &Value::Int(1)); } __for_first_807 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        let mut hasClientOrderId: Value = Value::Bool(false);
        {
            ...
            while { if !__for_first_808 { i = add(&i, &Value::Int(1)); } __for_first_808 = false; is_less_than(&i, &get_array_length(&orders)) } {
            let mut rawOrder: Value = get_value(&orders, &i);
            let mut rawOrder: Value = get_value(&orders, &i);
            let mut orderParams: Value = self.safe_dict_k(rawOrder.clone(), "params", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_811 { i = add(&i, &Value::Int(1)); } __for_first_811 = false; is_less_than(&i, &get_array_length(&fundings)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_812 { i = add(&i, &Value::Int(1)); } __for_first_812 = false; is_less_than(&i, &get_array_length(&rawOrders)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_813 { i = add(&i, &Value::Int(1)); } __for_first_813 = false; is_less_than(&i, &get_array_length(&historicalOrders)) } {
 ...
 */
    ...
    pub fn get_dex_from_symbols(&self, mut methodName: Value, optional_args: &[Value]) -> Value {
        ...
        let mut dexName: Value = Value::Null;
        {
            ...
            while { if !__for_first_814 { i = add(&i, &Value::Int(1)); } __for_first_814 = false; is_less_than(&i, &symbolsLength) } {
            if is_equal(&dexName, &Value::Null) {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_815 { i = add(&i, &Value::Int(1)); } __for_first_815 = false; is_less_than(&i, &get_array_length(&data)) } {
        ...
        if !is_equal(&vaultAddress, &Value::Null) {
            {
                ...
                while { if !__for_first_816 { i = add(&i, &Value::Int(1)); } __for_first_816 = false; is_less_than(&i, &get_array_length(&records)) } {
        ...
        if !is_equal(&vaultAddress, &Value::Null) {
            {
                ...
                while { if !__for_first_817 { i = add(&i, &Value::Int(1)); } __for_first_817 = false; is_less_than(&i, &get_array_length(&records)) } {
                let mut record: Value = get_value(&records, &i);
                let mut record: Value = get_value(&records, &i);
 ...
 */
    ...
    m
            ...
            let mut statuses: Value = self.safe_list_k(data.clone(), "statuses", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_819 { i = add(&i, &Value::Int(1)); } __for_first_819 = false; is_less_than(&i, &get_array_length(&statuses)) } {
