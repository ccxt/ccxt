...
impl CoinbaseCore {
    ...
    pub async fn v2_public_get_currencies_crypto(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_public_get_currencies_crypto".into()), optional_args).await
    }
    ...
    pub async fn v2_public_get_exchange_rates(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_public_get_exchange_rates".into()), optional_args).await
    }
    ...
    pub async fn v2_public_get_users_user_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_public_get_users_user_id".into()), optional_args).await
    }
    ...
    pub async fn v2_public_get_prices_symbol_buy(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_public_get_prices_symbol_buy".into()), optional_args).await
    }
    ...
    pub async fn v2_public_get_prices_symbol_sell(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_public_get_prices_symbol_sell".into()), optional_args).await
    }
    ...
    pub async fn v2_public_get_prices_symbol_spot(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_public_get_prices_symbol_spot".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_addresses(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_addresses".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_addresses_address_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_addresses_address_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_addresses_address_id_transactions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_addresses_address_id_transactions".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_transactions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_transactions".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_transactions_transaction_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_transactions_transaction_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_buys(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_buys".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_buys_buy_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_buys_buy_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_sells(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_sells".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_sells_sell_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_sells_sell_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_deposits(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_deposits".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_deposits_deposit_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_deposits_deposit_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_withdrawals(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_withdrawals".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_accounts_account_id_withdrawals_withdrawal_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_accounts_account_id_withdrawals_withdrawal_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_payment_methods(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_payment_methods".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_payment_methods_payment_method_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_payment_methods_payment_method_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_user(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_user".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_user_auth(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_user_auth".into()), optional_args).await
    }
    ...
    pub async fn v2_private_get_subscriptions_coinbase_one(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_get_subscriptions_coinbase_one".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_primary(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_primary".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_addresses(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_addresses".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_transactions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_transactions".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_transactions_transaction_id_complete(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_transactions_transaction_id_complete".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_transactions_transaction_id_resend(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_transactions_transaction_id_resend".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_buys(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_buys".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_buys_buy_id_commit(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_buys_buy_id_commit".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_sells(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_sells".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_sells_sell_id_commit(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_sells_sell_id_commit".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_deposits(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_deposits".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_deposits_deposit_id_commit(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_deposits_deposit_id_commit".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_withdrawals(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_withdrawals".into()), optional_args).await
    }
    ...
    pub async fn v2_private_post_accounts_account_id_withdrawals_withdrawal_id_commit(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_post_accounts_account_id_withdrawals_withdrawal_id_commit".into()), optional_args).await
    }
    ...
    pub async fn v2_private_put_accounts_account_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_put_accounts_account_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_put_user(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_put_user".into()), optional_args).await
    }
    ...
    pub async fn v2_private_delete_accounts_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_delete_accounts_id".into()), optional_args).await
    }
    ...
    pub async fn v2_private_delete_accounts_account_id_transactions_transaction_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v2_private_delete_accounts_account_id_transactions_transaction_id".into()), optional_args).await
    }
    ...
    pub async fn v3_public_get_brokerage_time(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_public_get_brokerage_time".into()), optional_args).await
    }
    ...
    pub async fn v3_public_get_brokerage_market_product_book(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_public_get_brokerage_market_product_book".into()), optional_args).await
    }
    ...
    pub async fn v3_public_get_brokerage_market_products(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_public_get_brokerage_market_products".into()), optional_args).await
    }
    ...
    pub async fn v3_public_get_brokerage_market_products_product_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_public_get_brokerage_market_products_product_id".into()), optional_args).await
    }
    ...
    pub async fn v3_public_get_brokerage_market_products_product_id_candles(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_public_get_brokerage_market_products_product_id_candles".into()), optional_args).await
    }
    ...
    pub async fn v3_public_get_brokerage_market_products_product_id_ticker(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_public_get_brokerage_market_products_product_id_ticker".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_accounts(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_accounts".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_accounts_account_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_accounts_account_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_orders_historical_batch(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_orders_historical_batch".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_orders_historical_fills(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_orders_historical_fills".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_orders_historical_order_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_orders_historical_order_id".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_products(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_products".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_products_product_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_products_product_id".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_products_product_id_candles(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_products_product_id_candles".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_products_product_id_ticker(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_products_product_id_ticker".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_best_bid_ask(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_best_bid_ask".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_product_book(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_product_book".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_transaction_summary(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_transaction_summary".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_portfolios(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_portfolios".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_portfolios_portfolio_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_portfolios_portfolio_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_convert_trade_trade_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_convert_trade_trade_id".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_cfm_balance_summary(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_cfm_balance_summary".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_cfm_positions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_cfm_positions".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_cfm_positions_product_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_cfm_positions_product_id".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_cfm_sweeps(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_cfm_sweeps".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_cfm_intraday_current_margin_window(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_cfm_intraday_current_margin_window".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_cfm_intraday_margin_setting(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_cfm_intraday_margin_setting".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_intx_balances_portfolio_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_intx_balances_portfolio_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_intx_portfolio_portfolio_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_intx_portfolio_portfolio_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_intx_positions_portfolio_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_intx_positions_portfolio_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_intx_positions_portfolio_uuid_symbol(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_intx_positions_portfolio_uuid_symbol".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_payment_methods(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_payment_methods".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_payment_methods_payment_method_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_payment_methods_payment_method_id".into()), optional_args).await
    }
    ...
    pub async fn v3_private_get_brokerage_key_permissions(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_get_brokerage_key_permissions".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_orders(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_orders".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_orders_batch_cancel(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_orders_batch_cancel".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_orders_edit(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_orders_edit".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_orders_edit_preview(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_orders_edit_preview".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_orders_preview(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_orders_preview".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_portfolios(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_portfolios".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_portfolios_move_funds(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_portfolios_move_funds".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_convert_quote(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_convert_quote".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_convert_trade_trade_id(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_convert_trade_trade_id".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_cfm_sweeps_schedule(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_cfm_sweeps_schedule".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_cfm_intraday_margin_setting(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_cfm_intraday_margin_setting".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_intx_allocate(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_intx_allocate".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_intx_multi_asset_collateral(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_intx_multi_asset_collateral".into()), optional_args).await
    }
    ...
    pub async fn v3_private_post_brokerage_orders_close_position(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_post_brokerage_orders_close_position".into()), optional_args).await
    }
    ...
    pub async fn v3_private_put_brokerage_portfolios_portfolio_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_put_brokerage_portfolios_portfolio_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_delete_brokerage_portfolios_portfolio_uuid(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_delete_brokerage_portfolios_portfolio_uuid".into()), optional_args).await
    }
    ...
    pub async fn v3_private_delete_brokerage_cfm_sweeps(&mut self, optional_args: &[Value]) -> Value {
        self.call_method(Value::Str("v3_private_delete_brokerage_cfm_sweeps".into()), optional_args).await
    }
