 ...
 */
    ...
    m
            ...
            if (in_op(&filtersByType, &Value::Str("PRICE_FILTER".to_string()))) {
    ...
    m
            ...
            if (in_op(&filtersByType, &Value::Str("LOT_SIZE".to_string()))) {
    ...
    m
            ...
            if (in_op(&filtersByType, &Value::Str("MARKET_LOT_SIZE".to_string()))) {
    ...
    m
            ...
            if (in_op(&filtersByType, &Value::Str("MIN_NOTIONAL".to_string()))) {
 ...
 */
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        }  else if (in_op(&trade, &Value::Str("side".to_string()))) {
            side = self.safe_string_lower(trade.clone(), Value::Str("side".to_string()), &[]);
        }  else {
            if (in_op(&trade, &Value::Str("isBuyer".to_string()))) {
        ...
        if (in_op(&trade, &Value::Str("isMaker".to_string()))) {
        ...
        if (in_op(&trade, &Value::Str("maker".to_string()))) {
 ...
 */
    ...
    m
        ...
        let mut response: Value = Value::Null;
        if is_true(&(method.as_str() == Some("binanceGetAggTrades"))) && is_true(&(since != Value::Null)) {
 ...
 */
    ...
    m
        ...
        return Value::Bool(is_true(&(symbolType != Value::Null)) && is_true(&(symbolType.as_str() != Some("1"))));
 ...
 */
    ...
    pub fn parse_transaction(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        if is_true(&(txid != Value::Null)) && is_true(&(get_index_of(&txid, &Value::Str("Internal transfer ".to_string())).as_f64().unwrap_or(f64::NAN) >= Value::Int(0).as_f64().unwrap_or(f64::NAN))) {
 ...
 */
    ...
    m
        ...
        if userDataStream {
            ...
            }  else if is_true(&(path.as_str() == Some("batchOrders"))) || (is_greater_than_or_equal(&get_index_of(&path, &Value::Str("sub-account".to_string())), &Value::Int(0))) || is_true(&(path.as_str() == Some("capital/withdraw/apply"))) || (is_greater_than_or_equal(&get_index_of(&path, &Value::Str("staking".to_string())), &Value::Int(0))) {
