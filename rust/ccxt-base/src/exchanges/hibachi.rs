 ...
 */
    ...
    m
        ...
        let mut symbols: Value = self.symbols.clone();
        {
            ...
            while { if !__for_first_715 { i = add(&i, &Value::Int(1)); } __for_first_715 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut requestOrders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_716 { i = add(&i, &Value::Int(1)); } __for_first_716 = false; is_less_than(&i, &get_array_length(&orders)) } {
    ...
    m
        ...
        let mut responseOrders: Value = self.safe_list_k(response.clone(), "orders", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_717 { i = add(&i, &Value::Int(1)); } __for_first_717 = false; is_less_than(&i, &get_array_length(&responseOrders)) } {
 ...
 */
    ...
    m
        ...
        let mut requestOrders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_718 { i = add(&i, &Value::Int(1)); } __for_first_718 = false; is_less_than(&i, &get_array_length(&orders)) } {
            let mut rawOrder: Value = get_value(&orders, &i);
            let mut rawOrder: Value = get_value(&orders, &i);
    ...
    m
        ...
        let mut responseOrders: Value = self.safe_list_k(response.clone(), "orders", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_719 { i = add(&i, &Value::Int(1)); } __for_first_719 = false; is_less_than(&i, &get_array_length(&responseOrders)) } {
            let mut responseOrder: Value = get_value(&responseOrders, &i);
            let mut responseOrder: Value = get_value(&responseOrders, &i);
            append_to_array(&mut ret, self.safe_order(Value::Map({
    let mut m = indexmap::IndexMap::new();
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_720 { i = add(&i, &Value::Int(1)); } __for_first_720 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    pub fn parse_settlements(&self, mut settlements: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_722 { i = add(&i, &Value::Int(1)); } __for_first_722 = false; is_less_than(&i, &get_array_length(&settlements)) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_723 { i = add(&i, &Value::Int(1)); } __for_first_723 = false; is_less_than(&i, &get_array_length(&data)) } {
