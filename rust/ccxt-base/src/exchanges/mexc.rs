 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        let mut chains: Value = self.safe_list_k(rawCurrency.clone(), "networkList", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_935 { j = add(&j, &Value::Int(1)); } __for_first_935 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_936 { i = add(&i, &Value::Int(1)); } __for_first_936 = false; is_less_than(&i, &get_array_length(&data)) } {
        ...
        if is_equal(&marketType, &Value::Str("margin".to_string())) {
            {
                ...
                while { if !__for_first_940 { i = add(&i, &Value::Int(1)); } __for_first_940 = false; is_less_than(&i, &get_array_length(&wallet)) } {
        ...
        }  else if is_equal(&marketType, &Value::Str("swap".to_string())) {
            {
                ...
                while { if !__for_first_941 { i = add(&i, &Value::Int(1)); } __for_first_941 = false; is_less_than(&i, &get_array_length(&wallet)) } {
                let mut entry: Value = get_value(&wallet, &i);
                let mut entry: Value = get_value(&wallet, &i);
        ...
        }  else {
            {
                ...
                while { if !__for_first_942 { i = add(&i, &Value::Int(1)); } __for_first_942 = false; is_less_than(&i, &get_array_length(&wallet)) } {
                let mut entry: Value = get_value(&wallet, &i);
                let mut entry: Value = get_value(&wallet, &i);
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_943 { i = add(&i, &Value::Int(1)); } __for_first_943 = false; is_less_than(&i, &get_array_length(&resultList)) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_944 { i = add(&i, &Value::Int(1)); } __for_first_944 = false; is_less_than(&i, &get_array_length(&result)) } {
 ...
 */
    ...
    pub fn parse_transaction_fee(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_946 { j = add(&j, &Value::Int(1)); } __for_first_946 = false; is_less_than(&j, &get_array_length(&networkList)) } {
 ...
 */
    ...
    pub fn parse_deposit_withdraw_fee(&self, mut fee: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = self.deposit_withdraw_fee(fee.clone());
        {
            ...
            while { if !__for_first_947 { j = add(&j, &Value::Int(1)); } __for_first_947 = false; is_less_than(&j, &get_array_length(&networkList)) } {
            let mut networkEntry: Value = get_value(&networkList, &j);
            let mut networkEntry: Value = get_value(&networkList, &j);
            let mut networkId: Value = self.safe_string_k(networkEntry.clone(), "network", &[]);
 ...
 */
    ...
    pub fn parse_leverage(&self, mut leverage: Value, optional_args: &[Value]) -> Value {
        ...
        let mut shortLeverage: Value = Value::Null;
        {
            ...
            while { if !__for_first_948 { i = add(&i, &Value::Int(1)); } __for_first_948 = false; is_less_than(&i, &get_array_length(&leverage)) } {
