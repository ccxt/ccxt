 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        let mut chains: Value = self.safe_value_k(rawCurrency.clone(), "networkList", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_920 { j = add(&j, &Value::Int(1)); } __for_first_920 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_921 { i = add(&i, &Value::Int(1)); } __for_first_921 = false; is_less_than(&i, &get_array_length(&data)) } {
 ...
 */
    ...
    m
        ...
        let mut symbol: Value = Value::Null;
        {
            ...
            while { if !__for_first_923 { i = add(&i, &Value::Int(1)); } __for_first_923 = false; is_less_than(&i, &get_array_length(&orders)) } {
    ...
    pub fn custom_parse_balance(&self, mut response: Value, mut marketType: Value) -> Value {
        ...
        if is_equal(&marketType, &Value::Str("margin".to_string())) {
        ...
        }  else if is_equal(&marketType, &Value::Str("swap".to_string())) {
            {
                ...
                while { if !__for_first_926 { i = add(&i, &Value::Int(1)); } __for_first_926 = false; is_less_than(&i, &get_array_length(&wallet)) } {
                let mut entry: Value = get_value(&wallet, &i);
                let mut entry: Value = get_value(&wallet, &i);
        ...
        }  else {
            {
                ...
                while { if !__for_first_927 { i = add(&i, &Value::Int(1)); } __for_first_927 = false; is_less_than(&i, &get_array_length(&wallet)) } {
                let mut entry: Value = get_value(&wallet, &i);
                let mut entry: Value = get_value(&wallet, &i);
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_928 { i = add(&i, &Value::Int(1)); } __for_first_928 = false; is_less_than(&i, &get_array_length(&resultList)) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_929 { i = add(&i, &Value::Int(1)); } __for_first_929 = false; is_less_than(&i, &get_array_length(&result)) } {
 ...
 */
    ...
    pub fn parse_transaction_fee(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_931 { j = add(&j, &Value::Int(1)); } __for_first_931 = false; is_less_than(&j, &get_array_length(&networkList)) } {
 ...
 */
    ...
    pub fn parse_deposit_withdraw_fee(&self, mut fee: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = self.deposit_withdraw_fee(fee.clone());
        {
            ...
            while { if !__for_first_932 { j = add(&j, &Value::Int(1)); } __for_first_932 = false; is_less_than(&j, &get_array_length(&networkList)) } {
            let mut networkEntry: Value = get_value(&networkList, &j);
            let mut networkEntry: Value = get_value(&networkList, &j);
            let mut networkId: Value = self.safe_string_k(networkEntry.clone(), "network", &[]);
