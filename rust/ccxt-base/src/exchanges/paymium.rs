...
impl crate::exchange::DerivedExchange for PaymiumCore {
    ...
    fn parse_trade(&self, trade: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on PaymiumCore.
        PaymiumCore::parse_trade(self, trade, &[market])
    }
    ...
    fn parse_deposit_address(&self, depositAddress: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on PaymiumCore.
        PaymiumCore::parse_deposit_address(self, depositAddress, &[currency])
    }
    fn parse_transfer(&self, transfer: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on PaymiumCore.
        PaymiumCore::parse_transfer(self, transfer, &[currency])
    }
...
impl crate::exchange_generated::ExchangeBase for PaymiumCore {
...
impl PaymiumCore {
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("countries".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
    ...
    m
        ...
        m.insert("data/{currency}/ticker".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("data/{currency}/trades".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("data/{currency}/depth".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("bitcoin_charts/{id}/trades".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("bitcoin_charts/{id}/depth".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("user/addresses".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("user/addresses/{address}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("user/orders/{uuid}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("user/price_alerts".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("merchant/get_payment/{uuid}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("user/email_transfers".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("user/payment_requests".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("merchant/create_payment".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("user/orders/{uuid}/cancel".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("user/price_alerts/{id}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.private_get_user(&[params]).await;
 ...
 */
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        let mut amountField: Value = Value::Str(format!("{}{}", Value::Str("traded_".into()), to_lower(&get_value(&marketResolved, &Value::Str("base".into())))).into());
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.private_post_user_addresses(&[params]).await;
 ...
 */
    ...
    m
        ...
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("address".to_string(), code);
            m
        });
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.private_get_user_addresses(&[params]).await;
        return self.parse_deposit_addresses(response, &[codes, Value::Bool(false)]);
 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("info".to_string(), response.clone());
        m.insert("id".to_string(), self.safe_string_k(response, "uuid", &[]));
    m
}), &[market]);
 ...
 */
    ...
    m
        ...
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                ...
                m.insert("email".to_string(), toAccount);
            m
        });
    ...
    pub fn parse_transfer(&self, mut transfer: Value, optional_args: &[Value]) -> Value {
        ...
        let mut timetstamp: Value = self.parse_date(updatedAt, &[]);
        let mut accountOperations: Value = self.safe_list_k(transfer.clone(), "account_operations", &[]);
        let mut firstOperation: Value = self.safe_dict(accountOperations, Value::Int(0), &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("datetime".to_string(), self.iso8601(timetstamp));
        m.insert("currency".to_string(), self.safe_currency_code(currencyId, &[currency]));
        m.insert("amount".to_string(), self.safe_number_k(transfer, "amount", &[]));
        m.insert("fromAccount".to_string(), Value::Null);
        m.insert("toAccount".to_string(), self.safe_string_k(firstOperation, "address", &[]));
    ...
    m
        ...
        let mut baseUrl: Value = self.urls.as_map().and_then(|__m| __m.get("api")).cloned().unwrap_or(Value::Null).as_map().and_then(|__m| __m.get("rest")).cloned().unwrap_or(Value::Null);
        let mut url: Value = Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", baseUrl, Value::Str("/".into())).into()), self.version.clone()).into()), Value::Str("/".into())).into()), self.implode_params(path.clone(), params.clone())).into());
        ...
        if (api.as_str() == Some("public")) {
            ...
            let mut hasQuery: bool = ((object_keys(&query).len() as i64) as f64) > ((0i64) as f64);
            let mut signedBody: Value = body.clone();
            if (method.as_str() == Some("POST")) && hasQuery {
                signedBody = json_stringify(&query);
            }
            if (method.as_str() == Some("POST")) {
                if hasQuery {
                    auth = Value::Str(format!("{}{}", auth, signedBody).into());
                ...
                if hasQuery {
                    let mut queryString: Value = self.urlencode(query, &[]);
            ...
            if let Value::Dict(__d) = &mut signedHeaders { std::sync::Arc::make_mut(__d).insert("Api-Signature".into(), self.hmac(self.encode(auth), self.encode(self.secret.clone()), Value::Str("sha256".into()), &[])); }
            return Value::Map({
    let mut m = indexmap::IndexMap::new();
