 ...
 */
    ...
    pub fn parse_markets(&self, mut markets: Value) -> Value {
        ...
        let mut fees: Value = self.fees.clone();
        {
            ...
            while { if !__for_first_435 { i = add(&i, &Value::Int(1)); } __for_first_435 = false; is_less_than(&i, &get_array_length(&markets)) } {
 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        let mut minWithdraw: Value = self.safe_number_k(rawCurrency.clone(), "withdrawalMinAmount", &[]);
        {
            ...
            while { if !__for_first_436 { j = add(&j, &Value::Int(1)); } __for_first_436 = false; is_less_than(&j, &get_array_length(&networksArray)) } {
 ...
 */
    ...
    pub fn parse_trading_fees(&self, mut fees: Value, optional_args: &[Value]) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_437 { i = add(&i, &Value::Int(1)); } __for_first_437 = false; is_less_than(&i, &get_array_length(&self.symbols)) } {
