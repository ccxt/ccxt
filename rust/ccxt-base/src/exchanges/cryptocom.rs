...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn parse_currency(&self, mut currency: Value) -> Value {
        ...
        let mut chains: Value = self.safe_list_k(currency.clone(), "network_list", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_589 { j = add(&j, &Value::Int(1)); } __for_first_589 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_591 { i = add(&i, &Value::Int(1)); } __for_first_591 = false; is_less_than(&i, &get_array_length(&positionBalances)) } {
 ...
 */
    ...
    m
        ...
        let mut orderRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_593 { i = add(&i, &Value::Int(1)); } __for_first_593 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_595 { i = add(&i, &Value::Int(1)); } __for_first_595 = false; is_less_than(&i, &addressesLength) } {
    ...
    m
        ...
        if !is_equal(&execInst, &Value::Null) {
            postOnly = Value::Bool(false);
            {
                ...
                while { if !__for_first_596 { i = add(&i, &Value::Int(1)); } __for_first_596 = false; is_less_than(&i, &get_array_length(&execInst)) } {
        ...
        if !is_equal(&networkList, &Value::Null) {
            {
                ...
                while { if !__for_first_597 { i = add(&i, &Value::Int(1)); } __for_first_597 = false; is_less_than(&i, &networkListLength) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_599 { i = add(&i, &Value::Int(1)); } __for_first_599 = false; is_less_than(&i, &get_array_length(&data)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_600 { i = add(&i, &Value::Int(1)); } __for_first_600 = false; is_less_than(&i, &get_array_length(&positions)) } {
    ...
    pub fn params_to_string(&self, mut object: Value, mut level: Value) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_602 { i = add(&i, &Value::Int(1)); } __for_first_602 = false; is_less_than(&i, &get_array_length(&paramsKeys)) } {
            ...
            if is_equal(&value, &Value::Str("undefined".to_string())) {
            ...
            }  else if is_true(&Value::Bool(is_array(&value))) {
                {
                    ...
                    while { if !__for_first_601 { j = add(&j, &Value::Int(1)); } __for_first_601 = false; is_less_than(&j, &get_array_length(&value)) } {
 ...
 */
    ...
    pub fn parse_trading_fees(&self, mut response: Value) -> Value {
        ...
        add_element_to_object(&mut result, &Value::Str("info".to_string()), response.clone());
        {
            ...
            while { if !__for_first_603 { i = add(&i, &Value::Int(1)); } __for_first_603 = false; is_less_than(&i, &get_array_length(&self.symbols)) } {
