 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            let mut expiry: Value = (if is_true(&(expiryString != Value::Null)) { crate::runtime::parse_int(&expiryString) } else { Value::Null });
 ...
 */
    ...
    pub fn parse_order(&self, mut order: Value, optional_args: &[Value]) -> Value {
        ...
        if is_true(&(code != Value::Null)) && is_true(&(code.as_f64() != Some(0.0))) {
    ...
    pub fn parse_transaction(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        if (in_op(&transaction, &Value::Str("client_wid".to_string()))) {
