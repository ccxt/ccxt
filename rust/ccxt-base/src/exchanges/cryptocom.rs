...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn parse_currency(&self, mut currency: Value) -> Value {
        ...
        let mut chains: Value = self.safe_list_k(currency.clone(), "network_list", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_590 { j = add(&j, &Value::Int(1)); } __for_first_590 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            let mut isLinear: Value = ternary(is_true(&(is_equal(&contract, &Value::Bool(true)))), Value::Bool(true), Value::Null);
            let mut isInverse: Value = ternary(is_true(&(is_equal(&contract, &Value::Bool(true)))), Value::Bool(false), Value::Null);
            append_to_array(&mut result, Value::Map({
                let mut m = indexmap::IndexMap::new();
                    ...
                    m.insert("margin".to_string(), Value::Bool((is_true(&(is_equal(&marginBuyEnabled, &Value::Bool(true)))) || is_true(&(is_equal(&marginSellEnabled, &Value::Bool(true)))))));
 ...
 */
    ...
    m
        ...
        if is_true(&(!is_equal(&limit, &Value::Null))) && is_true(&(!is_equal(&limit, &Value::Int(0)))) {
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_592 { i = add(&i, &Value::Int(1)); } __for_first_592 = false; is_less_than(&i, &get_array_length(&positionBalances)) } {
 ...
 */
    ...
    m
        ...
        if is_true(&(is_equal(&postOnly, &Value::Bool(true)))) || is_true(&(is_equal(&timeInForce, &Value::Str("PO".to_string())))) {
 ...
 */
    ...
    m
        ...
        let mut ordersRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_593 { i = add(&i, &Value::Int(1)); } __for_first_593 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        let mut orderRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_594 { i = add(&i, &Value::Int(1)); } __for_first_594 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    m
        ...
        let mut orderRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_595 { i = add(&i, &Value::Int(1)); } __for_first_595 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_596 { i = add(&i, &Value::Int(1)); } __for_first_596 = false; is_less_than(&i, &addressesLength) } {
    ...
    m
        ...
        if !is_equal(&execInst, &Value::Null) {
            postOnly = Value::Bool(false);
            {
                ...
                while { if !__for_first_597 { i = add(&i, &Value::Int(1)); } __for_first_597 = false; is_less_than(&i, &get_array_length(&execInst)) } {
        ...
        if !is_equal(&networkList, &Value::Null) {
            {
                ...
                while { if !__for_first_598 { i = add(&i, &Value::Int(1)); } __for_first_598 = false; is_less_than(&i, &networkListLength) } {
 ...
 */
    ...
    pub fn parse_settlements(&self, mut settlements: Value, mut market: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_599 { i = add(&i, &Value::Int(1)); } __for_first_599 = false; is_less_than(&i, &get_array_length(&settlements)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_601 { i = add(&i, &Value::Int(1)); } __for_first_601 = false; is_less_than(&i, &get_array_length(&positions)) } {
    ...
    pub fn params_to_string(&self, mut object: Value, mut level: Value) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_603 { i = add(&i, &Value::Int(1)); } __for_first_603 = false; is_less_than(&i, &get_array_length(&paramsKeys)) } {
            ...
            if is_equal(&value, &Value::Str("undefined".to_string())) {
            ...
            }  else if is_true(&Value::Bool(is_array(&value))) {
                {
                    ...
                    while { if !__for_first_602 { j = add(&j, &Value::Int(1)); } __for_first_602 = false; is_less_than(&j, &get_array_length(&value)) } {
 ...
 */
    ...
    pub fn parse_trading_fees(&self, mut response: Value) -> Value {
        ...
        add_element_to_object(&mut result, &Value::Str("info".to_string()), response.clone());
        {
            ...
            while { if !__for_first_604 { i = add(&i, &Value::Int(1)); } __for_first_604 = false; is_less_than(&i, &get_array_length(&self.symbols)) } {
            let mut symbol: Value = get_value(&self.symbols, &i);
            let mut market: Value = self.market(symbol.clone());
            let mut isSwap: Value = get_value(&market, &Value::Str("swap".to_string()));
            let mut takerFeeKey: Value = ternary(is_true(&(is_equal(&isSwap, &Value::Bool(true)))), Value::Str("effective_deriv_taker_rate_bps".to_string()), Value::Str("effective_spot_taker_rate_bps".to_string()));
            let mut makerFeeKey: Value = ternary(is_true(&(is_equal(&isSwap, &Value::Bool(true)))), Value::Str("effective_deriv_maker_rate_bps".to_string()), Value::Str("effective_spot_maker_rate_bps".to_string()));
