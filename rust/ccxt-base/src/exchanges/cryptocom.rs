...
impl crate::exchange::DerivedExchange for CryptocomCore {
    fn nonce(&self, ) -> crate::Value {
        ...
        CryptocomCore::nonce(self, )
    }
    fn parse_ticker(&self, ticker: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_ticker(self, ticker, &[market])
    }
    fn parse_trade(&self, trade: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_trade(self, trade, &[market])
    }
    fn parse_order(&self, order: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_order(self, order, &[market])
    }
    fn parse_ohlcv(&self, ohlcv: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_ohlcv(self, ohlcv, &[market])
    }
    ...
    fn parse_position(&self, position: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_position(self, position, &[market])
    }
    fn parse_funding_rate(&self, rate: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_funding_rate(self, rate, &[market])
    }
    fn parse_ledger_entry(&self, entry: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_ledger_entry(self, entry, &[currency])
    }
    ...
    fn parse_transaction(&self, transaction: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_transaction(self, transaction, &[currency])
    }
    fn parse_deposit_withdraw_fee(&self, fee: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::parse_deposit_withdraw_fee(self, fee, &[currency])
    }
    fn sign(&self, path: crate::Value, api: crate::Value, method: crate::Value, params: crate::Value, headers: crate::Value, body: crate::Value) -> crate::Value {
        // Forward to the inherent method on CryptocomCore.
        CryptocomCore::sign(self, path, &[api, method, params, headers, body])
    }
        ...
        -> std::pin::Pin<Box<dyn std::future::Future<Output = crate::Value> + Send + 'a>>
    {
        Box::pin(async move {
            match method {
                ...
                "create_advanced_order_request" => self.create_advanced_order_request(args.get(0).cloned().unwrap_or(crate::Value::Null), args.get(1).cloned().unwrap_or(crate::Value::Null), args.get(2).cloned().unwrap_or(crate::Value::Null), args.get(3).cloned().unwrap_or(crate::Value::Null), &args[4.min(args.len())..]),
                ...
                "custom_handle_margin_mode_and_params" => self.custom_handle_margin_mode_and_params(args.get(0).cloned().unwrap_or(crate::Value::Null), &args[1.min(args.len())..]),
                ...
                "edit_order_request" => self.edit_order_request(args.get(0).cloned().unwrap_or(crate::Value::Null), args.get(1).cloned().unwrap_or(crate::Value::Null), args.get(2).cloned().unwrap_or(crate::Value::Null), &args[3.min(args.len())..]),
...
impl CryptocomCore {
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("id".to_string(), Value::Str("cryptocom".into()));
        m.insert("name".to_string(), Value::Str("Crypto.com".into()));
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("logo".to_string(), Value::Str("https://user-images.githubusercontent.com/1294454/147792121-38ed5e36-c229-48d6-b49a-48d05fc19ed4.jpeg".into()));
        m.insert("test".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("v1".to_string(), Value::Str("https://uat-api.3ona.co/exchange/v1".into()));
        m.insert("v2".to_string(), Value::Str("https://uat-api.3ona.co/v2".into()));
        m.insert("derivatives".to_string(), Value::Str("https://uat-api.3ona.co/v2".into()));
    m
}));
        m.insert("api".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("base".to_string(), Value::Str("https://api.crypto.com".into()));
        m.insert("v1".to_string(), Value::Str("https://api.crypto.com/exchange/v1".into()));
        m.insert("v2".to_string(), Value::Str("https://api.crypto.com/v2".into()));
        m.insert("derivatives".to_string(), Value::Str("https://deriv-api.crypto.com/v1".into()));
    m
}));
        m.insert("www".to_string(), Value::Str("https://crypto.com/".into()));
        m.insert("referral".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("url".to_string(), Value::Str("https://crypto.com/exch/kdacthrnxt".into()));
        m.insert("discount".to_string(), Value::Float(0.75));
    m
}));
        m.insert("doc".to_string(), Value::from(vec![Value::Str("https://exchange-docs.crypto.com/exchange/v1/rest-ws/index.html".into()), Value::Str("https://exchange-docs.crypto.com/spot/index.html".into()), Value::Str("https://exchange-docs.crypto.com/derivatives/index.html".into())]));
        m.insert("fees".to_string(), Value::Str("https://crypto.com/exchange/document/fees-limits".into()));
    m
}));
        m.insert("api".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), (match ((Value::Int(10)).as_f64(), (Value::Int(3)).as_f64()) { (Some(x), Some(y)) if y != 0.0 => Value::Float(x / y), _ => Value::Null }));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), (match ((Value::Int(4)).as_f64(), (Value::Int(3)).as_f64()) { (Some(x), Some(y)) if y != 0.0 => Value::Float(x / y), _ => Value::Null }));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), (match ((Value::Int(1)).as_f64(), (Value::Int(3)).as_f64()) { (Some(x), Some(y)) if y != 0.0 => Value::Float(x / y), _ => Value::Null }));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("derivatives".to_string(), Value::Str("DERIVATIVES".into()));
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("ARBITRUM".to_string(), Value::Str("ARB".into()));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("USD_STABLE_COIN".to_string(), Value::Str("USDC".into()));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("219".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("306".to_string(), Value::Str("InsufficientFunds".into()).clone());
        m.insert("314".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("315".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("325".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("415".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("10001".to_string(), Value::Str("ExchangeError".into()).clone());
        m.insert("10002".to_string(), Value::Str("PermissionDenied".into()).clone());
        m.insert("10003".to_string(), Value::Str("PermissionDenied".into()).clone());
        m.insert("10004".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("10005".to_string(), Value::Str("PermissionDenied".into()).clone());
        m.insert("10006".to_string(), Value::Str("DDoSProtection".into()).clone());
        m.insert("10007".to_string(), Value::Str("InvalidNonce".into()).clone());
        m.insert("10008".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("10009".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("20001".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("20002".to_string(), Value::Str("InsufficientFunds".into()).clone());
        m.insert("20005".to_string(), Value::Str("AccountNotEnabled".into()).clone());
        m.insert("30003".to_string(), Value::Str("BadSymbol".into()).clone());
        m.insert("30004".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("30005".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("30006".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30007".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30008".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30009".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30010".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("30013".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30014".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30016".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30017".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30023".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30024".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("30025".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("40001".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40002".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40003".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40004".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40005".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40006".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40007".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40101".to_string(), Value::Str("AuthenticationError".into()).clone());
        m.insert("40102".to_string(), Value::Str("InvalidNonce".into()).clone());
        ...
        m.insert("40107".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("40401".to_string(), Value::Str("OrderNotFound".into()).clone());
        m.insert("40801".to_string(), Value::Str("RequestTimeout".into()).clone());
        m.insert("42901".to_string(), Value::Str("RateLimitExceeded".into()).clone());
        m.insert("43005".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("43003".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("43004".to_string(), Value::Str("InvalidOrder".into()).clone());
        m.insert("43012".to_string(), Value::Str("BadRequest".into()).clone());
        m.insert("50001".to_string(), Value::Str("ExchangeError".into()).clone());
        m.insert("9010001".to_string(), Value::Str("OnMaintenance".into()).clone());
    m
}));
 ...
 */
    ...
    m
        ...
        let mut skipFetchCurrenciesparamsSkipFetchCurrenciesVariable = self.handle_option_bool_and_params(params, Value::Str("fetchCurrencies".into()), Value::Str("skipFetchCurrencies".into()), &[Value::Bool(false)]);
        let mut skipFetchCurrencies: Value = skipFetchCurrenciesparamsSkipFetchCurrenciesVariable.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null);
        let mut paramsSkipFetchCurrencies: Value = skipFetchCurrenciesparamsSkipFetchCurrenciesVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
    ...
    m
        ...
        let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
            response = self.v1_private_post_private_get_currency_networks(&[paramsSkipFetchCurrencies]).await;
         #[allow(unreachable_code)] { Value::Null }})).await;
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
            let mut erString: Value = self.exception_message(e.clone(), &[]);
            if Value::Int(erString.as_str().and_then(|__s| __s.find("SYS_ERROR")).map(|__i| __i as i64).unwrap_or(-1)).as_f64().unwrap_or(f64::NAN) >= ((0i64) as f64) {
                return Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
});
        ...
        //    }
        //
        let mut resultData: Value = self.safe_dict_k(response, "result", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
        let mut currencyMap: Value = self.safe_dict_k(resultData, "currency_map", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
        let mut enhancedArray: Value = self.add_key_in_array_items(currencyMap, Value::Str("_coin_id".into()));
    ...
    pub fn parse_currency(&self, mut currency: Value) -> Value {
        ...
        let mut chains: Value = self.safe_list_k(currency.clone(), "network_list", &[Value::from(vec![])]);
        {
                        let mut j: Value = Value::Int(0);
            let mut __for_first_586: bool = true;
            while { if !__for_first_586 { j = (match (&(j), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_586 = false; j.as_f64().unwrap_or(f64::NAN) < ((chains.len() as i64) as f64) } {
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("name".to_string(), self.safe_string_k(currency, "full_name", &[]));
        m.insert("active".to_string(), Value::Null);
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.v1_public_get_public_get_instruments(&[params]).await;
        //
        //     {
        //         "id": 1,
        ...
        //     }
        //
        let mut resultResponse: Value = self.safe_dict_k(response, "result", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
        let mut data: Value = self.safe_list_k(resultResponse, "data", &[Value::from(vec![])]);
        let mut result: Value = Value::from(vec![]);
        {
            ...
            let mut settleId: Value = (if matches!(&spot, Value::Bool(true)) { Value::Null } else { quoteId.clone() });
            ...
            let mut expiry: Value = (if (expiryString != Value::Null) { (match &expiryString { Value::Str(__parse_s) => __parse_s.trim().parse::<i64>().map(Value::Int).unwrap_or(Value::Null), Value::Int(__parse_n) => Value::Int(*__parse_n), Value::Float(__parse_f) => Value::Int(*__parse_f as i64), _ => Value::Null }) } else { Value::Null });
            ...
            if (inst_type.as_deref() == Some("CCY_PAIR")) {
                ...
                symbol = Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", symbol, Value::Str(":".into())).into()), quote).into()), Value::Str("-".into())).into()), self.yymmdd(expiry.clone(), &[])).into());
                contract = Value::Bool(true);
            }  else if (inst_type.as_deref() == Some("WARRANT")) {
                type_var = Value::Str("option".into());
                let mut symbolOptionType: Value = (if (optionType.as_str() == Some("call")) { Value::Str("C".into()) } else { Value::Str("P".into()) });
                symbol = Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", symbol, Value::Str(":".into())).into()), quote).into()), Value::Str("-".into())).into()), self.yymmdd(expiry.clone(), &[])).into()), Value::Str("-".into())).into()), strike).into()), Value::Str("-".into())).into()), symbolOptionType).into());
                contract = Value::Bool(true);
            }
            let mut isLinear: Value = (if (contract.as_bool() == Some(true)) { Value::Bool(true) } else { Value::Null });
            let mut isInverse: Value = (if (contract.as_bool() == Some(true)) { Value::Bool(false) } else { Value::Null });
            append_to_array(&mut result, Value::Map({
                let mut m = indexmap::IndexMap::new();
                    ...
                    m.insert("margin".to_string(), (Value::Bool((marginBuyEnabled.as_bool() == Some(true)) || (marginSellEnabled.as_bool() == Some(true)))));
        ...
        if (symbols != Value::Null) {
            ...
            if (matches!(&symbols, Value::Arr(_))) {
                ...
                if symbolsLength > ((1i64) as f64) {
                    panic!("{}", crate::exchange_errors::bad_request(format!("{}{}", self.id.clone(), Value::Str(" fetchTickers() symbols argument cannot contain more than 1 symbol".into()))));
                }
 ...
 */
    ...
    m
        ...
        let mut orders: Value = self.safe_list_k(data, "data", &[Value::from(vec![])]);
 ...
 */
    ...
    m
        ...
        if (since != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("start_ts".into(), since.clone()); }
        }
        if (limit != Value::Null) {
        ...
        let mut paramsOmitted: Value = self.omit(paramsPaginate, Value::from(vec![Value::Str("until".into())]), &[]);
        if (until != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("end_ts".into(), until); }
        }
    ...
    m
        ...
        let mut trades: Value = self.safe_list_k(result, "data", &[Value::from(vec![])]);
 ...
 */
    ...
    m
        ...
        let mut paramsPaginate: Value = paginateparamsPaginateVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
        if is_true(&paginate) {
            return self.fetch_paginated_call_deterministic(Value::Str("fetchOHLCV".into()), &[symbol.clone(), since.clone(), limit.clone(), timeframe.clone(), paramsPaginate.clone(), Value::Int(300)]).await;
        }
        let mut market: Value = self.market(symbol);
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
        ...
        if (limit != Value::Null) && (limit.as_f64().unwrap_or(f64::NAN) > ((300i64) as f64)) {
            limitResolved = Value::Int(300);
        }
        if (limitResolved != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("count".into(), limitResolved.clone()); }
        }
        let mut now: Value = self.microseconds();
        let mut duration: Value = self.parse_timeframe(timeframe.clone());
        let mut until: Value = self.safe_integer_k(paramsPaginate.clone(), "until", &[now]);
        let mut paramsOmitted: Value = self.omit(paramsPaginate, Value::from(vec![Value::Str("until".into())]), &[]);
        if (since != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("start_ts".into(), (match (&(since), &((match (&(duration), &(Value::Int(1000))) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null }))) { (Value::Int(x), Value::Int(y)) => Value::Int(x - y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 - *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x - *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x - y), _ => Value::Null })); }
            if (limitResolved != Value::Null) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("end_ts".into(), self.sum(&[since.clone(), (match (&((match (&(duration), &(limitResolved)) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null })), &(Value::Int(1000))) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null })])); }
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("end_ts".into(), until.clone()); }
            }
        }  else {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("end_ts".into(), until); }
        }
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) && (limit.as_f64() != Some(0.0)) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("depth".into(), crate::runtime::Math::min(&limit, &Value::Int(50))); }; // max 50
        }
    ...
    m
        ...
        let mut data: Value = self.safe_list_k(result, "data", &[Value::from(vec![])]);
        let mut orderBook: Value = self.safe_dict(data, Value::Int(0), &[]);
    ...
    m
        ...
        let mut data: Value = self.safe_list_k(responseResult, "data", &[Value::from(vec![])]);
        ...
        });
        {
            ...
            while { if !__for_first_588 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_588 = false; i.as_f64().unwrap_or(f64::NAN) < ((positionBalances.len() as i64) as f64) } {
            ...
            if let Value::Dict(__d) = &mut account { std::sync::Arc::make_mut(__d).insert("used".into(), self.safe_string_k(balance, "reserved_qty", &[])); }
            if (code != Value::Null) {
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.v1_private_post_private_user_balance(&[params]).await;
 ...
 */
    ...
    m
        ...
        if (uppercaseType.as_str() == Some("LIMIT")) || (uppercaseType.as_str() == Some("STOP_LIMIT")) || (uppercaseType.as_str() == Some("TAKE_PROFIT_LIMIT")) {
        ...
        let mut broker: Value = self.safe_string_k(self.options.clone(), "broker", &[Value::Str("CCXT".into())]);
        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("broker_id".into(), broker); }
        let mut marketTypeparamsMarketTypeVariable = self.handle_market_type_and_params(Value::Str("createOrder".into()), &[market, params]);
        ...
        let mut marginModeparamsValueVariable = self.custom_handle_margin_mode_and_params(Value::Str("createOrder".into()), &[paramsMarketType]);
        let mut marginMode: Value = marginModeparamsValueVariable.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null);
        let mut paramsValue: Value = marginModeparamsValueVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
        if (marketType.as_str() == Some("margin")) || (marginMode != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("spot_margin".into(), Value::Str("MARGIN".into())); }
        }  else if (marketType.as_str() == Some("spot")) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("spot_margin".into(), Value::Str("SPOT".into())); }
        }
        let mut timeInForce: Value = self.safe_string_upper2(paramsValue.clone(), Value::Str("timeInForce".into()), Value::Str("time_in_force".into()), &[]);
        if (timeInForce != Value::Null) {
            if (timeInForce.as_str() == Some("GTC")) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("time_in_force".into(), Value::Str("GOOD_TILL_CANCEL".into())); }
        ...
        let mut postOnly: Value = self.safe_bool_k(paramsValue.clone(), "postOnly", &[Value::Bool(false)]);
        if (postOnly.as_bool() == Some(true)) || (timeInForce.as_str() == Some("PO")) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("exec_inst".into(), Value::from(vec![Value::Str("POST_ONLY".into())])); }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("time_in_force".into(), Value::Str("GOOD_TILL_CANCEL".into())); }
        }
        let mut triggerPrice: Value = self.safe_string_n(paramsValue.clone(), Value::from(vec![Value::Str("stopPrice".into()), Value::Str("triggerPrice".into()), Value::Str("ref_price".into())]), &[]);
        let mut stopLossPrice: Value = self.safe_number_k(paramsValue.clone(), "stopLossPrice", &[]);
        let mut takeProfitPrice: Value = self.safe_number_k(paramsValue.clone(), "takeProfitPrice", &[]);
        ...
        if isTrigger {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("ref_price".into(), self.price_to_precision(symbol.clone(), triggerPrice.clone())); }
            ...
            if (uppercaseType.as_str() == Some("LIMIT")) || (uppercaseType.as_str() == Some("STOP_LIMIT")) || (uppercaseType.as_str() == Some("TAKE_PROFIT_LIMIT")) {
                ...
                if (side.as_str() == Some("buy")) {
                    if is_true(&crate::precise::Precise::stringLt(&priceString, &triggerPrice)) {
                        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("TAKE_PROFIT".into())); }
                    }  else {
                        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("STOP_LOSS".into())); }
                    }
                }  else {
                    if is_true(&crate::precise::Precise::stringLt(&priceString, &triggerPrice)) {
                        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("STOP_LOSS".into())); }
            ...
            if (uppercaseType.as_str() == Some("LIMIT")) || (uppercaseType.as_str() == Some("STOP_LIMIT")) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("STOP_LIMIT".into())); }
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("STOP_LOSS".into())); }
            }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("ref_price".into(), self.price_to_precision(symbol.clone(), stopLossPrice)); }
        }  else if isTakeProfitTrigger {
            if (uppercaseType.as_str() == Some("LIMIT")) || (uppercaseType.as_str() == Some("TAKE_PROFIT_LIMIT")) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("TAKE_PROFIT_LIMIT".into())); }
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), Value::Str("TAKE_PROFIT".into())); }
            }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("ref_price".into(), self.price_to_precision(symbol, takeProfitPrice)); }
        }  else {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("type".into(), uppercaseType); }
        }
        let mut paramsOmitted: Value = self.omit(paramsValue, Value::from(vec![Value::Str("postOnly".into()), Value::Str("clientOrderId".into()), Value::Str("timeInForce".into()), Value::Str("stopPrice".into()), Value::Str("triggerPrice".into()), Value::Str("stopLossPrice".into()), Value::Str("takeProfitPrice".into())]), &[]);
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.v1_private_post_private_create_order(&[request]).await;
        //
        //     {
        //         "id": 1686804664362,
 ...
 */
    ...
    m
            ...
            let mut orderRequest: Value = self.create_advanced_order_request(marketId, type_var, side, amount, &[price, orderParams]);
            append_to_array(&mut ordersRequests, orderRequest);
        }
        }
        let mut contigency: Value = self.safe_string_k(params.clone(), "contingency_type", &[Value::Str("LIST".into())]);
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("contingency_type".to_string(), contigency);
                m.insert("order_list".to_string(), ordersRequests);
            m
        });
        ...
        //   }
        //
        let mut result: Value = self.safe_value_k(response, "result", &[Value::from(vec![])]);
        let mut listId: Value = self.safe_string_k(result.clone(), "list_id", &[]);
        if (listId != Value::Null) {
            let mut ocoOrders: Value = Value::from(vec![Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("order_id".to_string(), listId);
    m
})]);
    ...
    m
        ...
        let mut broker: Value = self.safe_string_k(self.options.clone(), "broker", &[Value::Str("CCXT".into())]);
        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("broker_id".into(), broker); }
        let mut timeInForce: Value = self.safe_string_upper2(params.clone(), Value::Str("timeInForce".into()), Value::Str("time_in_force".into()), &[]);
        if (timeInForce != Value::Null) {
            if (timeInForce.as_str() == Some("GTC")) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("time_in_force".into(), Value::Str("GOOD_TILL_CANCEL".into())); }
            }  else if (timeInForce.as_str() == Some("IOC")) {
        ...
        let mut triggerPrice: Value = self.safe_string_n(params.clone(), Value::from(vec![Value::Str("stopPrice".into()), Value::Str("triggerPrice".into()), Value::Str("ref_price".into())]), &[]);
        ...
        let mut isMarketBuy: bool = (side.as_str() == Some("buy")) && ((uppercaseType.as_str() == Some("MARKET")) || (uppercaseType.as_str() == Some("STOP_LOSS")) || (uppercaseType.as_str() == Some("TAKE_PROFIT")));
        let mut paramsMarketBuy: Value = params.clone();
        if isMarketBuy {
            // use createmarketBuy logic here
            let mut quoteAmount: Value = Value::Null;
            let mut createMarketBuyOrderRequiresPriceparamsCreateMarketBuyVariable = self.handle_option_bool_and_params(params, Value::Str("createOrder".into()), Value::Str("createMarketBuyOrderRequiresPrice".into()), &[Value::Bool(true)]);
            let mut createMarketBuyOrderRequiresPrice: Value = createMarketBuyOrderRequiresPriceparamsCreateMarketBuyVariable.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null);
            let mut paramsCreateMarketBuy: Value = createMarketBuyOrderRequiresPriceparamsCreateMarketBuyVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
            let mut cost: Value = self.safe_number2(paramsCreateMarketBuy.clone(), Value::Str("cost".into()), Value::Str("notional".into()), &[]);
            paramsMarketBuy = self.omit(paramsCreateMarketBuy, Value::Str("cost".into()), &[]);
            if (cost != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("notional".into(), quoteAmount); }
        }  else {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("quantity".into(), self.amount_to_precision(symbol, amount)); }
        }
        let mut paramsOmitted: Value = self.omit(paramsMarketBuy, Value::from(vec![Value::Str("postOnly".into()), Value::Str("clientOrderId".into()), Value::Str("timeInForce".into()), Value::Str("stopPrice".into()), Value::Str("triggerPrice".into()), Value::Str("stopLossPrice".into()), Value::Str("takeProfitPrice".into())]), &[]);
        return self.extend(request, &[paramsOmitted]);
 ...
 */
    ...
    m
        ...
        let mut request: Value = self.edit_order_request(id, symbol, amount, &[price, params]);
        let mut response: Value = self.v1_private_post_private_amend_order(&[request]).await;
        let mut result: Value = self.safe_dict_k(response, "result", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
    ...
    m
        ...
        if (id != Value::Null) {
            ...
            let mut originalClientOrderId: Value = self.safe_string2(params.clone(), Value::Str("orig_client_oid".into()), Value::Str("clientOrderId".into()), &[]);
            if (originalClientOrderId == Value::Null) {
                panic!("{}", crate::exchange_errors::arguments_required(format!("{}{}", self.id.clone(), Value::Str(" editOrder() requires an id argument or orig_client_oid parameter".into()))));
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("orig_client_oid".into(), originalClientOrderId); }
            }
        }
        let mut paramsOmitted: Value = (if (id == Value::Null) { self.omit(params.clone(), Value::from(vec![Value::Str("orig_client_oid".into()), Value::Str("clientOrderId".into())]), &[]) } else { params });
        if (amount == Value::Null) || (price == Value::Null) {
            panic!("{}", crate::exchange_errors::arguments_required(format!("{}{}", self.id.clone(), Value::Str(" editOrder() requires both amount and price arguments. If you do not want to change the amount or price, you should pass the original values".into()))));
        }
        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("new_quantity".into(), self.amount_to_precision(symbol.clone(), amount)); }
        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("new_price".into(), self.price_to_precision(symbol, price)); }
        return self.extend(request, &[paramsOmitted]);
 ...
 */
    ...
    m
        ...
        let mut market: Value = self.market(symbol);
        let mut orderRequests: Value = Value::from(vec![]);
        {
                        let mut i: Value = Value::Int(0);
            ...
            append_to_array(&mut orderRequests, order);
        }
        }
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("contingency_type".to_string(), Value::Str("LIST".into()));
                m.insert("order_list".to_string(), orderRequests);
            m
        });
        ...
        return self.parse_orders(result, &[market, Value::Null, Value::Null, params]);
 ...
 */
    ...
    m
        ...
        let mut orderRequests: Value = Value::from(vec![]);
        {
            ...
            while { if !__for_first_591 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_591 = false; i.as_f64().unwrap_or(f64::NAN) < ((orders.len() as i64) as f64) } {
            ...
            append_to_array(&mut orderRequests, orderItem);
        }
        }
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
        ...
        let mut result: Value = self.safe_list_k(response, "result", &[Value::from(vec![])]);
        return self.parse_orders(result, &[Value::Null, Value::Null, Value::Null, params]);
 ...
 */
    ...
    m
        ...
        let mut paramsPaginate: Value = paginateparamsPaginateVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
        if is_true(&paginate) {
            return self.fetch_paginated_call_dynamic(Value::Str("fetchMyTrades".into()), &[symbol.clone(), since.clone(), limit.clone(), paramsPaginate.clone(), Value::Int(100)]).await;
        }
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
            m
    ...
    pub fn parse_address(&self, mut addressString: Value) -> Value {
        ...
        if get_index_of(&addressString, &Value::Str("?".into())).as_f64().unwrap_or(f64::NAN) > ((0i64) as f64) {
            { let __destr_tmp = split(&addressString, &Value::Str("?".into())); address = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); rawTag = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
            let mut splitted: Value = split(&rawTag, &Value::Str("=".into()));
            tag = splitted.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
        }  else {
            address = addressString;
        }
        return Value::from(vec![address, tag]);
 ...
 */
    ...
    m
        ...
        if (tagWithdrawTag != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("address_tag".into(), tagWithdrawTag); }
        }
        ...
        if (networkId != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("network_id".into(), networkId); }
        }
 ...
 */
    ...
    m
        ...
        let mut addresses: Value = self.safe_list_k(data, "deposit_address_list", &[Value::from(vec![])]);
        let mut addressesLength: f64 = ((addresses.len() as i64) as f64);
        if (addressesLength == 0.0) {
            panic!("{}", crate::exchange_errors::exchange_error(format!("{}{}", self.id.clone(), Value::Str(" fetchDepositAddressesByNetwork() generating address...".into()))));
        }
        let mut result: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
            m
        });
        {
            ...
            while { if !__for_first_592 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_592 = false; i.as_f64().unwrap_or(f64::NAN) < addressesLength } {
            ...
            let mut responseCode: Value = self.safe_currency_code(currencyId, &[]);
            let mut addresstagVariable = self.parse_address(addressString);
            let mut address: Value = addresstagVariable.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null);
            let mut tag: Value = addresstagVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
            self.check_address(&[address.clone()]);
            let mut networkId: Value = self.safe_string_k(value.clone(), "network", &[]);
            let mut network: Value = self.network_id_to_code(&[networkId, responseCode.clone()]);
            if (network != Value::Null) {
                if let Value::Dict(__d) = &mut result { std::sync::Arc::make_mut(__d).insert(crate::runtime::stringify_param(&network), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("info".to_string(), value);
        m.insert("currency".to_string(), responseCode);
        m.insert("network".to_string(), network.clone());
        m.insert("address".to_string(), address);
 ...
 */
    ...
    m
        ...
        let mut paramsOmitted: Value = self.omit(params, Value::from(vec![Value::Str("network".into())]), &[]);
        let mut depositAddressesRaw: Value = self.fetch_deposit_addresses_by_network(code, &[paramsOmitted]).await;
 ...
 */
    ...
    m
        ...
        let mut depositList: Value = self.safe_list_k(data, "deposit_list", &[Value::from(vec![])]);
 ...
 */
    ...
    m
        ...
        let mut withdrawalList: Value = self.safe_list_k(data, "withdrawal_list", &[Value::from(vec![])]);
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("quoteVolume".to_string(), (if (marketResolved.as_map().and_then(|__m| __m.get("quote")).cloned().unwrap_or(Value::Null).as_str() == Some("USD")) { self.safe_string_k(ticker.clone(), "vv", &[]) } else { Value::Null }));
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        //     }
        //
        let mut timestamp: Value = self.safe_integer2(trade.clone(), Value::Str("t".into()), Value::Str("create_time".into()), &[]);
        let mut marketId: Value = self.safe_string2(trade.clone(), Value::Str("i".into()), Value::Str("instrument_name".into()), &[]);
        let mut marketResolved: Value = self.safe_market(&[marketId, market, Value::Str("_".into())]);
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("id".to_string(), self.safe_string2(trade.clone(), Value::Str("d".into()), Value::Str("trade_id".into()), &[]));
        m.insert("timestamp".to_string(), timestamp.clone());
        m.insert("datetime".to_string(), self.iso8601(timestamp));
        m.insert("symbol".to_string(), marketResolved.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null));
    ...
    pub fn parse_time_in_force(&self, mut timeInForce: Value) -> Value {
        let mut timeInForces: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("GOOD_TILL_CANCEL".to_string(), Value::Str("GTC".into()));
    ...
    m
        ...
        if (execInst != Value::Null) {
            postOnly = Value::Bool(false);
            {
                ...
                while { if !__for_first_593 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_593 = false; i.as_f64().unwrap_or(f64::NAN) < ((execInst.len() as i64) as f64) } {
                let mut inst: Option<String> = self.safe_string(execInst.clone(), i.clone(), &[]).as_str().map(str::to_owned);
                if (inst.as_deref() == Some("POST_ONLY")) {
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("currency".to_string(), self.safe_currency_code(feeCurrency, &[]));
        m.insert("cost".to_string(), self.safe_number_k(order, "cumulative_fee", &[]));
    m
}));
    ...
    pub fn parse_transaction(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        if (matches!(&transaction, Value::Dict(__d) if __d.contains_key("client_wid"))) {
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("comment".to_string(), self.safe_string_k(transaction, "client_wid", &[]));
    ...
    m
        ...
        let mut paramsOmitted: Value = self.omit(params, Value::Str("margin".into()), &[]);
        let mut marginMode: Value = Value::Null;
        let mut paramsMarginMode: Value = Value::Null;
        { let __destr_tmp = self.handle_margin_mode_and_params(methodName, &[paramsOmitted]); marginMode = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); paramsMarginMode = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
    ...
    pub fn parse_deposit_withdraw_fee(&self, mut fee: Value, optional_args: &[Value]) -> Value {
        ...
        //    }
        //
        let mut networkList: Value = self.safe_list_k(fee.clone(), "network_list", &[Value::from(vec![])]);
        let mut networkListLength: f64 = ((networkList.len() as i64) as f64);
        let mut result: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
        ...
        if (networkList != Value::Null) {
            {
                ...
                while { if !__for_first_594 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_594 = false; i.as_f64().unwrap_or(f64::NAN) < networkListLength } {
                let mut networkInfo: Value = self.safe_dict(networkList.clone(), i.clone(), &[]);
    ...
    m
                ...
                if (networkListLength == 1.0) {
                    add_element_to_object(get_value_mut(&mut result, &Value::Str("withdraw".into())), &Value::Str("fee".into()), self.safe_number_k(networkInfo, "withdrawal_fee", &[]));
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.v1_private_post_private_get_currency_networks(&[params]).await;
        let mut data: Value = self.safe_dict_k(response, "result", &[]);
        let mut currencyMap: Value = self.safe_list_k(data, "currency_map", &[]);
        return self.parse_deposit_withdraw_fees(currencyMap, &[codes, Value::Str("full_name".into())]);
 ...
 */
    ...
    m
        ...
        let mut ledger: Value = self.safe_list_k(result, "data", &[Value::from(vec![])]);
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("type".to_string(), self.parse_ledger_entry_type(self.safe_string_k(item, "journal_type", &[])).map(|__s| Value::Str(__s.into())).unwrap_or(Value::Null));
        m.insert("currency".to_string(), code);
    ...
    pub fn parse_ledger_entry_type(&self, mut type_var: Value) -> Option<String> {
        let mut ledgerType: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                ...
                m.insert("TRADE_FEE".to_string(), Value::Str("fee".into()));
                m.insert("WITHDRAW_FEE".to_string(), Value::Str("fee".into()));
                m.insert("WITHDRAW".to_string(), Value::Str("withdrawal".into()));
                m.insert("DEPOSIT".to_string(), Value::Str("deposit".into()));
                m.insert("ROLLBACK_WITHDRAW".to_string(), Value::Str("rollback".into()));
                m.insert("ROLLBACK_DEPOSIT".to_string(), Value::Str("rollback".into()));
                m.insert("FUNDING".to_string(), Value::Str("fee".into()));
                m.insert("REALIZED_PNL".to_string(), Value::Str("trade".into()));
                m.insert("INSURANCE_FUND".to_string(), Value::Str("insurance".into()));
                m.insert("SOCIALIZED_LOSS".to_string(), Value::Str("trade".into()));
                m.insert("LIQUIDATION_FEE".to_string(), Value::Str("fee".into()));
                m.insert("SESSION_RESET".to_string(), Value::Str("reset".into()));
                m.insert("ADJUSTMENT".to_string(), Value::Str("adjustment".into()));
                m.insert("SESSION_SETTLE".to_string(), Value::Str("settlement".into()));
                m.insert("UNCOVERED_LOSS".to_string(), Value::Str("trade".into()));
                m.insert("ADMIN_ADJUSTMENT".to_string(), Value::Str("adjustment".into()));
                m.insert("DELIST".to_string(), Value::Str("delist".into()));
                m.insert("SETTLEMENT_FEE".to_string(), Value::Str("fee".into()));
                m.insert("AUTO_CONVERSION".to_string(), Value::Str("conversion".into()));
                m.insert("MANUAL_CONVERSION".to_string(), Value::Str("conversion".into()));
            m
        });
 ...
 */
    ...
    m
        ...
        let mut accounts: Value = self.safe_list_k(result, "sub_account_list", &[Value::from(vec![])]);
        append_to_array(&mut accounts, masterAccount);
 ...
 */
    ...
    m
        ...
        { let __destr_tmp = self.handle_market_type_and_params(Value::Str("fetchSettlementHistory".into()), &[market.clone(), params]); type_var = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); paramsMarketType = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        self.check_required_argument(Value::Str("fetchSettlementHistory".into()), type_var.clone(), Value::Str("type".into()), &[Value::from(vec![Value::Str("future".into()), Value::Str("option".into()), Value::Str("WARRANT".into()), Value::Str("FUTURE".into())])]);
        if (type_var.as_str() == Some("option")) {
            type_var = Value::Str("WARRANT".into());
        }
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("price".to_string(), self.safe_number_k(settlement, "v", &[]));
        m.insert("timestamp".to_string(), timestamp.clone());
        m.insert("datetime".to_string(), self.iso8601(timestamp));
    m
});
    ...
    pub fn parse_settlements(&self, mut settlements: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = Value::from(vec![]);
        {
            ...
            while { if !__for_first_595 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_595 = false; i.as_f64().unwrap_or(f64::NAN) < ((settlements.len() as i64) as f64) } {
 ...
 */
    ...
    m
        ...
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("instrument_name".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null));
                m.insert("valuation_type".to_string(), Value::Str("estimated_funding_rate".into()));
    ...
    pub fn parse_funding_rate(&self, mut contract: Value, optional_args: &[Value]) -> Value {
        ...
        if (timestamp != Value::Null) {
            fundingTimestamp = (match (&(math_ceil(&(match ((timestamp).as_f64(), (Value::Int(3600000)).as_f64()) { (Some(x), Some(y)) if y != 0.0 => Value::Float(x / y), _ => Value::Null }))), &(Value::Int(3600000))) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null }); // end of the next hour
        }
        return Value::Map({
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("timestamp".to_string(), timestamp.clone());
        m.insert("datetime".to_string(), self.iso8601(timestamp));
        m.insert("fundingRate".to_string(), self.safe_number_k(contract, "v", &[]));
 ...
 */
    ...
    m
        ...
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("instrument_name".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null));
                m.insert("valuation_type".to_string(), Value::Str("funding_hist".into()));
            m
        });
        if (since != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("start_ts".into(), since.clone()); }
    ...
    m
        ...
        let mut marketId: Value = self.safe_string_k(result, "instrument_name", &[]);
        let mut rates: Value = Value::from(vec![]);
        {
                        let mut i: Value = Value::Int(0);
            let mut __for_first_596: bool = true;
            while { if !__for_first_596 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_596 = false; i.as_f64().unwrap_or(f64::NAN) < ((data.len() as i64) as f64) } {
            ...
            append_to_array(&mut rates, Value::Map({
                let mut m = indexmap::IndexMap::new();
                    ...
                    m.insert("fundingRate".to_string(), self.safe_number_k(entry, "v", &[]));
                    m.insert("timestamp".to_string(), timestamp.clone());
                    m.insert("datetime".to_string(), self.iso8601(timestamp));
                m
            }));
 ...
 */
    ...
    m
        ...
        let mut data: Value = self.safe_list_k(result, "data", &[Value::from(vec![])]);
        return self.parse_position(self.safe_dict(data, Value::Int(0), &[]), &[market]);
 ...
 */
    ...
    m
        ...
        let mut positions: Value = self.safe_list_k(responseResult, "data", &[Value::from(vec![])]);
        let mut result: Value = Value::from(vec![]);
        {
                        let mut i: Value = Value::Int(0);
            let mut __for_first_597: bool = true;
            while { if !__for_first_597 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_597 = false; i.as_f64().unwrap_or(f64::NAN) < ((positions.len() as i64) as f64) } {
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("contracts".to_string(), self.parse_number(crate::precise::Precise::stringAbs(&amount), &[]));
        ...
        m.insert("unrealizedPnl".to_string(), self.safe_number_k(position, "open_position_pnl", &[]));
    ...
    pub fn params_to_string(&self, mut object: Value, mut level: Value) -> Value {
        let mut maxLevel: f64 = ((3i64) as f64);
        if level.as_f64().unwrap_or(f64::NAN) >= maxLevel {
            return to_string_val(&object);
        }
        if matches!(&object, Value::Str(_)) {
            return object;
        }
        let mut returnString: Value = Value::Str("".into());
        let mut paramsKeys: Value = Value::Null;
        if (matches!(&object, Value::Arr(_))) {
        ...
        }
        {
            ...
            while { if !__for_first_599 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_599 = false; i.as_f64().unwrap_or(f64::NAN) < ((paramsKeys.len() as i64) as f64) } {
            let mut key: Value = paramsKeys.as_array().and_then(|__arr| match &i { Value::Int(__n) => __arr.get(*__n as usize), Value::Str(__s) => __s.parse::<usize>().ok().and_then(|__n| __arr.get(__n)), _ => None }).cloned().unwrap_or(Value::Null);
            returnString = Value::Str(format!("{}{}", returnString, key).into());
            let mut value: Value = get_value(&object, &key);
            let mut value: Value = get_value(&object, &key);
            if (value.as_str() == Some("undefined")) {
                returnString = Value::Str(format!("{}{}", returnString, Value::Str("null".into())).into());
            }  else if (matches!(&value, Value::Arr(_))) {
                {
                                        let mut j: Value = Value::Int(0);
                    let mut __for_first_598: bool = true;
                    while { if !__for_first_598 { j = (match (&(j), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_598 = false; j.as_f64().unwrap_or(f64::NAN) < ((value.len() as i64) as f64) } {
                    returnString = Value::Str(format!("{}{}", returnString, self.params_to_string(value.as_array().and_then(|__arr| match &j { Value::Int(__n) => __arr.get(*__n as usize), Value::Str(__s) => __s.parse::<usize>().ok().and_then(|__n| __arr.get(__n)), _ => None }).cloned().unwrap_or(Value::Null), (match (&(level), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }))).into());
                }
                }
            }  else {
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.v1_private_post_private_get_fee_rate(&[params]).await;
        //
        //   {
        //       "id": 1,
    ...
    pub fn parse_trading_fees(&self, mut response: Value) -> Value {
        ...
        if let Value::Dict(__d) = &mut result { std::sync::Arc::make_mut(__d).insert("info".into(), response.clone()); }
        {
                        let mut i: Value = Value::Int(0);
            let mut __for_first_600: bool = true;
            while { if !__for_first_600 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_600 = false; i.as_f64().unwrap_or(f64::NAN) < ((self.symbols.len() as i64) as f64) } {
            ...
            let mut takerFeeKey: Value = Value::Str("effective_spot_taker_rate_bps".into());
            if (isSwap.as_bool() == Some(true)) {
                takerFeeKey = Value::Str("effective_deriv_taker_rate_bps".into());
            }
            let mut makerFeeKey: Value = Value::Str("effective_spot_maker_rate_bps".into());
            if (isSwap.as_bool() == Some(true)) {
                makerFeeKey = Value::Str("effective_deriv_maker_rate_bps".into());
            }
            let mut tradingFee: Value = Value::Map({
                let mut m = indexmap::IndexMap::new();
                    m.insert("info".to_string(), response.clone());
                    m.insert("symbol".to_string(), symbol.clone());
                    m.insert("maker".to_string(), self.parse_number(crate::precise::Precise::stringDiv(&self.safe_string(response.clone(), makerFeeKey, &[]), &Value::Str("10000".into())), &[]));
                    m.insert("taker".to_string(), self.parse_number(crate::precise::Precise::stringDiv(&self.safe_string(response.clone(), takerFeeKey, &[]), &Value::Str("10000".into())), &[]));
                    m.insert("percentage".to_string(), Value::Null);
                    m.insert("tierBased".to_string(), Value::Null);
                m
            });
            if let Value::Dict(__d) = &mut result { std::sync::Arc::make_mut(__d).insert(crate::runtime::stringify_param(&symbol), tradingFee); }
        }
        }
        return result;
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("symbol".to_string(), symbol);
        m.insert("maker".to_string(), self.parse_number(crate::precise::Precise::stringDiv(&self.safe_string_k(fee.clone(), "effective_maker_rate_bps", &[]), &Value::Str("10000".into())), &[]));
        m.insert("taker".to_string(), self.parse_number(crate::precise::Precise::stringDiv(&self.safe_string_k(fee, "effective_taker_rate_bps", &[]), &Value::Str("10000".into())), &[]));
        m.insert("percentage".to_string(), Value::Null);
        m.insert("tierBased".to_string(), Value::Null);
    m
});
    ...
    m
        ...
        let mut access: Option<String> = self.safe_string(api, Value::Int(1), &[]).as_str().map(str::to_owned);
        let mut apiUrl: Value = self.safe_string(self.urls.as_map().and_then(|__m| __m.get("api")).cloned().unwrap_or(Value::Null), type_var, &[]);
        ...
        if (access.as_deref() == Some("public")) {
            ...
            if (paramsKeysLength == 0.0) {
                let mut paramsString: Value = Value::Str("{}".into());
                let mut arrayString: Value = Value::Str("[]".into());
                requestBody = replace_str(&requestBody, &arrayString, &paramsString);
            }
