 ...
 */
    ...
    m
        ...
        if (symbols != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("symbols".to_string(), ids.clone()); }
        }
    ...
    m
        ...
        if (orderType.as_str() == Some("LIMIT")) || (orderType.as_str() == Some("STOP_LOSS_LIMIT")) || (orderType.as_str() == Some("TAKE_PROFIT_LIMIT")) || (orderType.as_str() == Some("LIMIT_MAKER")) {
            ...
            if (orderType.as_str() != Some("LIMIT_MAKER")) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("timeInForce".to_string(), self.safe_string_k(options.clone(), "timeInForce", &[Value::Str("GTC".to_string())])); }
            }
 ...
 */
    ...
    m
        ...
        if (tag != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("withdrawOrderId".to_string(), tag.clone()); }
        }
