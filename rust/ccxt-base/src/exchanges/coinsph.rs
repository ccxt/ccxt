 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_563 { j = add(&j, &Value::Int(1)); } __for_first_563 = false; is_less_than(&j, &get_array_length(&networkList)) } {
    ...
    m
        ...
        if is_true(&(Value::Bool(in_op(&config, &Value::Str("noSymbol".to_string()))))) && !is_true(&(Value::Bool(in_op(&params, &Value::Str("symbol".to_string()))))) {
            ...
            let mut byNumberOfSymbols: Value = self.safe_list_k(config.clone(), "byNumberOfSymbols", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_564 { i = add(&i, &Value::Int(1)); } __for_first_564 = false; is_less_than(&i, &get_array_length(&byNumberOfSymbols)) } {
            ...
            let mut byLimit: Value = self.safe_list_k(config.clone(), "byLimit", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_565 { i = add(&i, &Value::Int(1)); } __for_first_565 = false; is_less_than(&i, &get_array_length(&byLimit)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_566 { i = add(&i, &Value::Int(1)); } __for_first_566 = false; is_less_than(&i, &get_array_length(&markets)) } {
    ...
    m
        ...
        if !is_equal(&symbols, &Value::Null) {
            let mut ids: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_567 { i = add(&i, &Value::Int(1)); } __for_first_567 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_568 { i = add(&i, &Value::Int(1)); } __for_first_568 = false; is_less_than(&i, &get_array_length(&balances)) } {
 ...
 */
    ...
    m
        ...
        let mut fees: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_569 { i = add(&i, &Value::Int(1)); } __for_first_569 = false; is_less_than(&i, &get_array_length(&fees)) } {
