...
impl crate::exchange::DerivedExchange for DigifinexCore {
    fn parse_ticker(&self, ticker: crate::Value, market: crate::Value) -> crate::Value {
        ...
        DigifinexCore::parse_ticker(self, ticker, &[market.clone()])
    }
    fn parse_trade(&self, trade: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_trade(self, trade, &[market.clone()])
    }
    fn parse_order(&self, order: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_order(self, order, &[market.clone()])
    }
    fn parse_ohlcv(&self, ohlcv: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_ohlcv(self, ohlcv, &[market.clone()])
    }
    ...
    fn parse_position(&self, position: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_position(self, position, &[market.clone()])
    }
    fn parse_funding_rate(&self, rate: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_funding_rate(self, rate, &[market.clone()])
    }
    fn parse_deposit_address(&self, depositAddress: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_deposit_address(self, depositAddress, &[currency.clone()])
    }
    fn parse_ledger_entry(&self, entry: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_ledger_entry(self, entry, &[currency.clone()])
    }
    fn parse_transfer(&self, transfer: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_transfer(self, transfer, &[currency.clone()])
    }
    ...
    fn parse_margin_modification(&self, data: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_margin_modification(self, data, &[market.clone()])
    }
    fn parse_transaction(&self, transaction: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_transaction(self, transaction, &[currency.clone()])
    }
    fn parse_borrow_interest(&self, info: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_borrow_interest(self, info, &[market.clone()])
    }
    fn parse_income(&self, info: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_income(self, info, &[market.clone()])
    }
    fn parse_borrow_rate(&self, info: crate::Value, currency: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_borrow_rate(self, info, &[currency.clone()])
    }
    fn parse_market_leverage_tiers(&self, info: crate::Value, market: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::parse_market_leverage_tiers(self, info, &[market.clone()])
    }
    fn sign(&self, path: crate::Value, api: crate::Value, method: crate::Value, params: crate::Value, headers: crate::Value, body: crate::Value) -> crate::Value {
        // Forward to the inherent method on DigifinexCore.
        DigifinexCore::sign(self, path, &[api.clone(), method.clone(), params.clone(), headers.clone(), body.clone()])
    }
 ...
 */
    ...
    m
        ...
        let mut groupedById: Value = self.group_by(data.clone(), Value::Str("currency".into()), &[]);
 ...
 */
    ...
    m
        ...
        let mut method: Option<String> = self.safe_string_k(options.clone(), "method", &[Value::Str("fetch_markets_v2".into())]).as_str().map(str::to_owned);
    ...
    m
        ...
        let mut result: Value = Value::from(vec![]);
        {
            ...
            let mut type_var: Value = (if is_true(&(defaultType.as_deref() == Some("margin"))) { Value::Str("margin".into()) } else { Value::Str("spot".into()) });
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            let mut total: Value = self.safe_string2(balance.clone(), Value::Str("total".into()), Value::Str("equity".into()), &[]);
 ...
 */
    ...
    m
        ...
        let mut marginModequeryVariable = self.handle_margin_mode_and_params(Value::Str("fetchBalance".into()), &[params.clone()]);
        let mut marginMode: Value = marginModequeryVariable.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null);
        let mut query: Value = marginModequeryVariable.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null);
        ...
        //     }
        //
        let mut balanceRequest: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { Value::Str("data".into()) } else { Value::Str("list".into()) });
 ...
 */
    ...
    m
        ...
        let mut marketTypequeryVariable = self.handle_market_type_and_params(Value::Str("fetchOrderBook".into()), &[market.clone(), params.clone()]);
        ...
        if (marketType.as_str() == Some("swap")) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("instrument_id".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null)); }
 ...
 */
    ...
    pub fn parse_ticker(&self, mut ticker: Value, optional_args: &[Value]) -> Value {
        ...
        let mut marketType: Value = (if is_true(&(indexPrice != Value::Null)) { Value::Str("contract".into()) } else { Value::Str("spot".into()) });
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        if (market.as_map().and_then(|__m| __m.get("type")).cloned().unwrap_or(Value::Null).as_str() == Some("swap")) {
            ...
            if (orderType.is_some()) {
                type_var = (if is_true(&(orderType.as_deref() == Some("0"))) { Value::Str("limit".into()) } else { Value::Null });
            }
            ...
            if is_true(&(side.as_str() == Some("1"))) || is_true(&(direction.as_deref() == Some("1"))) {
                // side = 'open long';
                side = Value::Str("buy".into());
            }  else if is_true(&(side.as_str() == Some("2"))) || is_true(&(direction.as_deref() == Some("2"))) {
                // side = 'open short';
                side = Value::Str("sell".into());
            }  else if is_true(&(side.as_str() == Some("3"))) || is_true(&(direction.as_deref() == Some("3"))) {
                // side = 'close long';
                side = Value::Str("sell".into());
            }  else if is_true(&(side.as_str() == Some("4"))) || is_true(&(direction.as_deref() == Some("4"))) {
                // side = 'close short';
                side = Value::Str("buy".into());
            }
        }  else {
            ...
            takerOrMaker = (if is_true(&(isMaker.as_bool() == Some(true))) { Value::Str("maker".into()) } else { Value::Str("taker".into()) });
        }
 ...
 */
    ...
    m
        ...
        let mut status: Value = (if is_true(&(code == Some(0))) { Value::Str("ok".into()) } else { Value::Str("maintenance".into()) });
        return Value::Map({
    let mut m = indexmap::IndexMap::new();
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("limit".to_string(), (if is_true(&(market.as_map().and_then(|__m| __m.get("swap")).cloned().unwrap_or(Value::Null).as_bool() == Some(true))) { crate::runtime::Math::min(&limit, &Value::Int(100)) } else { limit.clone() })); }
        }
        let mut response: Value = Value::Null;
        if (market.as_map().and_then(|__m| __m.get("swap")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("instrument_id".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null)); }
 ...
 */
    ...
    m
        ...
        if (market.as_map().and_then(|__m| __m.get("swap")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("symbol".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null)); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("period".to_string(), self.safe_string(self.timeframes.clone(), timeframe.clone(), &[timeframe.clone()])); }
            let mut startTime: Value = since.clone();
            let mut duration: Value = self.parse_timeframe(timeframe.clone());
            if (startTime == Value::Null) {
                if is_true(&(limit != Value::Null)) || is_true(&(until != Value::Null)) {
                    let mut endTime: Value = (if is_true(&(until != Value::Null)) { until.clone() } else { self.milliseconds() });
                    let mut startLimit: Value = (if is_true(&(limit != Value::Null)) { limit.clone() } else { Value::Int(200) });
                ...
                if is_true(&(limit != Value::Null)) || is_true(&(until != Value::Null)) {
                    if (until != Value::Null) {
                        ...
                        if (limit != Value::Null) {
                            ...
                            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("end_time".to_string(), crate::runtime::Math::min(&endByLimit, &endByUntil)); }
                        }  else {
                            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("end_time".to_string(), endByUntil.clone()); }
                        }
                    }  else {
                        if (limit == Value::Null) {
                            panic!("{}", crate::exchange_errors::arguments_required(format!("{}{}", self.id.clone(), Value::Str(" fetchOHLCV() requires a limit argument".into()))));
                        }
                        if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("end_time".to_string(), self.sum(&[startTime.clone(), (match (&(limit), &(duration)) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null })])); }
                    }
                }
            }
 ...
 */
    ...
    m
        ...
        if (market.as_map().and_then(|__m| __m.get("swap")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("market".to_string(), (if is_true(&(marginMode != Value::Null)) { Value::Str("margin".into()) } else { Value::Str("spot".into()) })); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("symbol".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null)); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("list".to_string(), json_stringify(&ordersRequests)); }
        ...
        let mut result: Value = Value::from(vec![]);
        {
            ...
            add_element_to_object(&mut individualOrder, &Value::Str("order_id".into()), get_value(&data, &i));
            add_element_to_object(&mut individualOrder, &Value::Str("instrument_id".into()), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null));
            add_element_to_object(&mut individualOrder, &Value::Str("amount".into()), self.safe_number_k(rawOrder.clone(), "amount", &[]));
            add_element_to_object(&mut individualOrder, &Value::Str("price".into()), self.safe_number_k(rawOrder, "price", &[]));
    ...
    m
        ...
        if swap {
            ...
            if (side.as_str() == Some("buy")) {
                let mut requestType: Value = (if is_true(&(reduceOnly.as_bool() == Some(true))) { Value::Int(4) } else { Value::Int(1) });
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("type".to_string(), requestType.clone()); }
            }  else {
                let mut requestType: Value = (if is_true(&(reduceOnly.as_bool() == Some(true))) { Value::Int(3) } else { Value::Int(2) });
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("type".to_string(), requestType.clone()); }
            }
            if isLimitOrder {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("size".to_string(), amount.clone()); } // swap orders require the amount to be the number of contracts
            params = self.omit(params.clone(), Value::from(vec![Value::Str("reduceOnly".into()), Value::Str("timeInForce".into())]), &[]);
        }  else {
            postOnlyParsed = (if is_true(&(postOnly.as_bool() == Some(true))) { Value::Int(1) } else { Value::Int(2) });
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("market".to_string(), marketType.clone()); }
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("type".to_string(), Value::Str(format!("{}{}", side, suffix).into())); }
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("amount".to_string(), quantity.clone()); }
        }
        if is_true(&postOnly) {
            if is_true(&(postOnlyParsed != Value::Null)) && is_true(&(postOnlyParsed.as_f64() != Some(0.0))) {
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("post_only".to_string(), postOnlyParsed.clone()); }
            }  else {
 ...
 */
    ...
    m
        ...
        if (marketType.as_str() == Some("swap")) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("instrument_id".to_string(), self.safe_string_k(market.clone(), "id", &[])); }
        }  else {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("market".to_string(), marketType.clone()); }
        }
        ...
        //     }
        //
        if is_true(&(marketType.as_str() == Some("spot"))) || is_true(&(marketType.as_str() == Some("margin"))) {
    ...
    pub fn parse_order(&self, mut order: Value, optional_args: &[Value]) -> Value {
        ...
        if (market.as_map().and_then(|__m| __m.get("type")).cloned().unwrap_or(Value::Null).as_str() == Some("swap")) {
            ...
            if (orderType != Value::Null) {
                if is_true(&(orderType.as_f64() == Some(9.0))) || is_true(&(orderType.as_f64() == Some(10.0))) || is_true(&(orderType.as_f64() == Some(11.0))) || is_true(&(orderType.as_f64() == Some(12.0))) || is_true(&(orderType.as_f64() == Some(15.0))) {
                    timeInForce = Value::Str("FOK".into());
                }  else if is_true(&(orderType.as_f64() == Some(1.0))) || is_true(&(orderType.as_f64() == Some(2.0))) || is_true(&(orderType.as_f64() == Some(3.0))) || is_true(&(orderType.as_f64() == Some(4.0))) || is_true(&(orderType.as_f64() == Some(13.0))) {
                    timeInForce = Value::Str("IOC".into());
                }  else if is_true(&(orderType.as_f64() == Some(6.0))) || is_true(&(orderType.as_f64() == Some(7.0))) || is_true(&(orderType.as_f64() == Some(8.0))) || is_true(&(orderType.as_f64() == Some(14.0))) {
                    timeInForce = Value::Str("GTC".into());
                }
                if is_true(&(orderType.as_f64() == Some(0.0))) || is_true(&(orderType.as_f64() == Some(1.0))) || is_true(&(orderType.as_f64() == Some(4.0))) || is_true(&(orderType.as_f64() == Some(5.0))) || is_true(&(orderType.as_f64() == Some(9.0))) || is_true(&(orderType.as_f64() == Some(10.0))) {
                    type_var = Value::Str("limit".into());
                }  else {
 ...
 */
    ...
    m
        ...
        if swap {
            if (since != Value::Null) {
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("start_timestamp".to_string(), since.clone()); }
            }
            if (limit != Value::Null) {
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("limit".to_string(), limit.clone()); }
            }
 ...
 */
    ...
    m
        ...
        if (marketType.as_str() == Some("swap")) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("market".to_string(), marketType.clone()); }
            if (since != Value::Null) {
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("start_time".to_string(), self.parse_to_int((match ((since).as_f64(), (Value::Int(1000)).as_f64()) { (Some(x), Some(y)) if y != 0.0 => Value::Float(x / y), _ => Value::Null }))); } // default 3 days from now, max 30 days
            }
        }
        if (market != Value::Null) {
            let mut marketIdRequest: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { Value::Str("instrument_id".into()) } else { Value::Str("symbol".into()) });
            add_element_to_object(&mut request, &marketIdRequest, market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null));
        }
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("limit".to_string(), limit.clone()); }
 ...
 */
    ...
    m
        ...
        let mut response: Value = Value::Null;
        if is_true(&(marginMode != Value::Null)) || is_true(&(marketType.as_str() == Some("margin"))) {
            marketType = Value::Str("margin".into());
        ...
        let mut order: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { data.clone() } else { self.safe_value(data.clone(), Value::Int(0), &[]) });
        if (order == Value::Null) {
 ...
 */
    ...
    m
        ...
        //     }
        //
        let mut responseRequest: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { Value::Str("data".into()) } else { Value::Str("list".into()) });
 ...
 */
    ...
    m
        ...
        let mut currencyIdRequest: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { Value::Str("currency".into()) } else { Value::Str("currency_mark".into()) });
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("size".to_string(), crate::runtime::Math::min(&Value::Int(500), &limit)); }
        }
        let mut response: Value = Value::Null;
 ...
 */
    ...
    m
        ...
        return self.fetch_transactions_by_type(Value::Str("deposit".into()), &[code.clone(), since.clone(), limit.clone(), params.clone()]).await;
 ...
 */
    ...
    m
        ...
        return self.fetch_transactions_by_type(Value::Str("withdrawal".into()), &[code.clone(), since.clone(), limit.clone(), params.clone()]).await;
 ...
 */
    ...
    m
        ...
        if fromSwap || toSwap {
            if is_true(&(fromId.as_str() != Some("1"))) && is_true(&(toId.as_str() != Some("1"))) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("type".to_string(), (if toSwap { Value::Int(1) } else { Value::Int(2) })); } // 1 = spot to swap, 2 = swap to spot
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("currency".to_string(), currencyId.clone()); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("transfer_amount".to_string(), amountString.clone()); }
            //
            //     {
            //         "code": 0,
            //         "data": {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("currency_mark".to_string(), currencyId.clone()); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("num".to_string(), amountString.clone()); }
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("from".to_string(), fromId.clone()); } // 1 = SPOT, 2 = MARGIN, 3 = OTC
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("to".to_string(), toId.clone()); } // 1 = SPOT, 2 = MARGIN, 3 = OTC
            //
            //     {
            //         "code": 0
            //     }
 ...
 */
    ...
    pub fn parse_borrow_interest(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        let mut currency: Value = (if is_true(&(market == Value::Null)) { Value::Null } else { market.as_map().and_then(|__m| __m.get("base")).cloned().unwrap_or(Value::Null) });
        let mut symbol: Value = self.safe_symbol(marketId.clone(), &[market.clone()]);
        return Value::Map({
    let mut m = indexmap::IndexMap::new();
 ...
 */
    ...
    m
        ...
        //     }
        //
        let mut positionRequest: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { Value::Str("data".into()) } else { Value::Str("positions".into()) });
 ...
 */
    ...
    m
        ...
        //     }
        //
        let mut dataRequest: Value = (if is_true(&(marketType.as_str() == Some("swap"))) { Value::Str("data".into()) } else { Value::Str("positions".into()) });
    ...
    pub fn parse_position(&self, mut position: Value, optional_args: &[Value]) -> Value {
        ...
        if (marginMode != Value::Null) {
            marginMode = (if is_true(&(marginMode.as_str() == Some("crossed"))) { Value::Str("cross".into()) } else { Value::Str("isolated".into()) });
        }  else {
 ...
 */
    ...
    m
        ...
        let mut marginMode: Value = self.safe_string_lower2(params.clone(), Value::Str("marginMode".into()), Value::Str("defaultMarginMode".into()), &[defaultMarginMode.clone()]);
        if (marginMode != Value::Null) {
            marginMode = (if is_true(&(marginMode.as_str() == Some("cross"))) { Value::Str("crossed".into()) } else { Value::Str("isolated".into()) });
 ...
 */
    ...
    m
        ...
        if (code != Value::Null) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("currency".to_string(), self.safe_string_k(currency.clone(), "id", &[])); }
        }
        if (since != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("start_timestamp".to_string(), since.clone()); }
        }
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("limit".to_string(), limit.clone()); } // default 20 max 100
        }
 ...
 */
    ...
    m
        ...
        let mut data: Value = self.safe_list_k(response.clone(), "data", &[Value::from(vec![])]);
        symbols = self.market_symbols(&[symbols.clone()]);
        return self.parse_leverage_tiers(data.clone(), &[symbols.clone(), Value::Str("instrument_id".into())]);
 ...
 */
    ...
    m
        ...
        //
        let mut code: Option<i64> = self.safe_integer_k(response.clone(), "code", &[]).as_i64();
        let mut status: Value = (if is_true(&(code == Some(0))) { Value::Str("ok".into()) } else { Value::Str("failed".into()) });
        let mut data: Value = self.safe_dict_k(response.clone(), "data", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
 ...
 */
    ...
    m
        ...
        if (symbol != Value::Null) {
            ...
            add_element_to_object(&mut request, &Value::Str("instrument_id".into()), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null));
        }
        if (limit != Value::Null) {
            add_element_to_object(&mut request, &Value::Str("limit".into()), limit.clone());
        }
        if (since != Value::Null) {
            add_element_to_object(&mut request, &Value::Str("start_timestamp".into()), since.clone());
        }
 ...
 */
    ...
    m
        ...
        let mut pathPart: Value = (if is_true(&(endpoint.as_str() == Some("spot"))) { Value::Str("/v3".into()) } else { Value::Str("/swap/v2".into()) });
        ...
        if signed && is_true(&(pathPart.as_str() == Some("/swap/v2"))) && is_true(&(method.as_str() == Some("POST"))) {
        ...
        if signed {
            ...
            if (pathPart.as_str() == Some("/swap/v2")) {
                ...
                if (method.as_str() == Some("GET")) {
                    if is_true(&(urlencoded != Value::Null)) && is_true(&(urlencoded.as_str() != Some(""))) {
    ...
    pub fn handle_errors(&self, mut statusCode: Value, mut statusText: Value, mut url: Value, mut method: Value, mut responseHeaders: Value, mut responseBody: Value, mut response: Value, mut requestHeaders: Value, mut requestBody: Value) -> Value {
        ...
        if is_true(&(code.as_str() == Some("0"))) || is_true(&(code.as_str() == Some("200"))) {
            return Value::Null;
        }
        ...
        let mut unknownError: Value = Value::from(vec![Value::Str("ExchangeError".into()), feedback.clone()]);
