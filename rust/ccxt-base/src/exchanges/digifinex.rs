 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_622 { j = add(&j, &Value::Int(1)); } __for_first_622 = false; is_less_than(&j, &get_array_length(&networkEntries)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_624 { i = add(&i, &Value::Int(1)); } __for_first_624 = false; is_less_than(&i, &get_array_length(&markets)) } {
 ...
 */
    ...
    m
        ...
        let mut date: Value = self.safe_integer_k(response.clone(), "date", &[]);
        {
            ...
            while { if !__for_first_626 { i = add(&i, &Value::Int(1)); } __for_first_626 = false; is_less_than(&i, &get_array_length(&tickers)) } {
 ...
 */
    ...
    m
        ...
        let mut marginMode: Value = Value::Null;
        {
            ...
            while { if !__for_first_627 { i = add(&i, &Value::Int(1)); } __for_first_627 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    pub fn parse_cancel_orders(&self, mut response: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_629 { i = add(&i, &Value::Int(1)); } __for_first_629 = false; is_less_than(&i, &get_array_length(&success)) } {
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_630 { i = add(&i, &Value::Int(1)); } __for_first_630 = false; is_less_than(&i, &get_array_length(&error)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::Null;
        {
            ...
            while { if !__for_first_631 { i = add(&i, &Value::Int(1)); } __for_first_631 = false; is_less_than(&i, &get_array_length(&data)) } {
 ...
 */
    ...
    pub fn parse_borrow_rates(&self, mut info: Value, mut codeKey: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_632 { i = add(&i, &Value::Int(1)); } __for_first_632 = false; is_less_than(&i, &get_array_length(&info)) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_633 { i = add(&i, &Value::Int(1)); } __for_first_633 = false; is_less_than(&i, &get_array_length(&result)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_634 { i = add(&i, &Value::Int(1)); } __for_first_634 = false; is_less_than(&i, &get_array_length(&positions)) } {
 ...
 */
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        })]);
        {
            ...
            while { if !__for_first_635 { i = add(&i, &Value::Int(1)); } __for_first_635 = false; is_less_than(&i, &get_array_length(&brackets)) } {
 ...
 */
    ...
    m
        ...
        let mut depositWithdrawCodes: Value = object_keys(&depositWithdrawFees);
        {
            ...
            while { if !__for_first_637 { i = add(&i, &Value::Int(1)); } __for_first_637 = false; is_less_than(&i, &get_array_length(&depositWithdrawCodes)) } {
