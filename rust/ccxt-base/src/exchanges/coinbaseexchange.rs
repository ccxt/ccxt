 ...
 */
    ...
    m
        ...
        let mut supportedNetworks: Value = self.safe_list_k(rawCurrency.clone(), "supported_networks", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_531 { j = add(&j, &Value::Int(1)); } __for_first_531 = false; is_less_than(&j, &get_array_length(&supportedNetworks)) } {
 ...
 */
    ...
    m
        ...
        let mut rawMarkets: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_532 { i = add(&i, &Value::Int(1)); } __for_first_532 = false; is_less_than(&i, &get_array_length(&rawMarkets)) } {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_533 { i = add(&i, &Value::Int(1)); } __for_first_533 = false; is_less_than(&i, &get_array_length(&response)) } {
 ...
 */
    ...
    m
        ...
        let mut delimiter: Value = Value::Str("-".to_string());
        {
            ...
            while { if !__for_first_534 { i = add(&i, &Value::Int(1)); } __for_first_534 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
 ...
 */
    ...
    m
        ...
        if is_equal(&method, &Value::Str("publicGetProductsIdStats".to_string())) {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_535 { i = add(&i, &Value::Int(1)); } __for_first_535 = false; is_less_than(&i, &get_array_length(&self.symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut entries: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_536 { i = add(&i, &Value::Int(1)); } __for_first_536 = false; is_less_than(&i, &get_array_length(&entries)) } {
 ...
 */
    ...
    pub fn parse_transaction_status(&self, mut transaction: Value) -> Value {
        ...
        if is_true(&(!is_equal(&canceled, &Value::Null))) && is_true(&(!is_equal(&canceled, &Value::Null))) {
        ...
        if is_true(&(!is_equal(&completed, &Value::Null))) && is_true(&(!is_equal(&completed, &Value::Null))) {
            return Value::Str("ok".to_string());
        }  else if is_true(&(!is_equal(&processed, &Value::Null))) && is_true(&(!is_equal(&processed, &Value::Null))) {
