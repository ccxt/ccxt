...
impl AlpacaCore {
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("get".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("v2/account".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("v2/orders/{order_id}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/positions".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/positions/{symbol_or_asset_id}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/account/portfolio/history".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/watchlists".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/watchlists/{watchlist_id}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/watchlists:by_name".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("v2/account/activities".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/account/activities/{activity_type}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/calendar".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/clock".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/assets".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/assets/{symbol_or_asset_id}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/corporate_actions/announcements/{id}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/corporate_actions/announcements".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/wallets".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("v2/watchlists/{watchlist_id}/{symbol}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("get".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("v1beta3/crypto/{loc}/bars".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/latest/bars".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/latest/orderbooks".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/latest/quotes".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/latest/trades".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/quotes".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/snapshots".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta3/crypto/{loc}/trades".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
    ...
    m
        ...
        m.insert("v1beta1/forex/latest/rates".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta1/forex/rates".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta1/logos/{symbol}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta1/news".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta1/screener/stocks/most-actives".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v1beta1/screener/{market_type}/movers".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/auctions".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/bars".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/bars/latest".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/meta/conditions/{ticktype}".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/meta/exchanges".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/quotes".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/quotes/latest".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/snapshots".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/trades".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/trades/latest".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/auctions".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/bars".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/bars/latest".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/quotes".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/quotes/latest".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/snapshot".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/trades".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
        m.insert("v2/stocks/{symbol}/trades/latest".to_string(), Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("cost".to_string(), Value::Int(1));
    m
}));
 ...
 */
    ...
    m
            ...
            let mut symbolTrade: Value = self.safe_dict(trades.clone(), marketId.clone(), &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
 ...
 */
    ...
    m
        ...
        return self.parse_order_book(rawOrderbook.clone(), market.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null), &[timestamp.clone(), Value::Str("b".into()), Value::Str("a".into()), Value::Str("p".into()), Value::Str("s".into())]);
 ...
 */
    ...
    m
                    ...
                    pageToken = self.safe_string_k(response.clone(), "next_page_token", &[]);
                }
                }
            }
    ...
    m
            ...
            let mut bar: Value = self.safe_dict(bars.clone(), marketId.clone(), &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]);
    ...
    pub fn parse_ohlcv(&self, mut ohlcv: Value, optional_args: &[Value]) -> Value {
        ...
        return Value::from(vec![timestamp.clone(), self.safe_number_k(ohlcv.clone(), "o", &[]), self.safe_number_k(ohlcv.clone(), "h", &[]), self.safe_number_k(ohlcv.clone(), "l", &[]), self.safe_number_k(ohlcv.clone(), "c", &[]), self.safe_number_k(ohlcv, "v", &[])]);
 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("quoteVolume".to_string(), crate::precise::Precise::stringMul(&self.safe_string_k(dailyBar.clone(), "v", &[]), &self.safe_string_k(dailyBar.clone(), "vw", &[])));
    m
}), &[market.clone()]);
 ...
 */
    ...
    m
        ...
        let __ws_arg_8 = self.extend(req, &[params.clone()]);
        return self.create_order(symbol.clone(), Value::Str("market".into()), side.clone(), Value::Int(0), &[Value::Null, __ws_arg_8]).await;
 ...
 */
    ...
    m
        ...
        let __ws_arg_9 = self.extend(req, &[params.clone()]);
        return self.create_order(symbol.clone(), Value::Str("market".into()), Value::Str("buy".into()), Value::Int(0), &[Value::Null, __ws_arg_9]).await;
 ...
 */
    ...
    m
        ...
        let __ws_arg_10 = self.extend(req, &[params.clone()]);
        return self.create_order(symbol.clone(), Value::Str("market".into()), Value::Str("sell".into()), cost.clone(), &[Value::Null, __ws_arg_10]).await;
 ...
 */
    ...
    m
        ...
        if (cost != Value::Null) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("notional".to_string(), self.cost_to_precision(symbol.clone(), cost.clone())); }
        }  else {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("qty".to_string(), self.amount_to_precision(symbol.clone(), amount.clone())); }
        }
        ...
        if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("time_in_force".to_string(), defaultTIF.clone()); }
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.trader_private_delete_v2_orders_order_id(&[__ws_arg_12]).await;
 ...
 */
    ...
    m
        ...
        let mut order: Value = self.trader_private_get_v2_orders_order_id(&[__ws_arg_13]).await;
 ...
 */
    ...
    m
        ...
        if (until != Value::Null) {
            params = self.omit(params.clone(), Value::Str("until".into()), &[]);
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("until".to_string(), self.iso8601(until.clone())); }
        }
        if (since != Value::Null) {
            ...
            if (direction.is_none()) {
                ...
                if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("direction".to_string(), Value::Str("asc".into())); }
            }
        }
        if (limit != Value::Null) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("limit".to_string(), limit.clone()); }
 ...
 */
    ...
    m
        ...
        return self.fetch_orders(&[symbol.clone(), since.clone(), limit.clone(), __ws_arg_16]).await;
 ...
 */
    ...
    m
        ...
        if (until != Value::Null) {
            params = self.omit(params.clone(), Value::Str("until".into()), &[]);
            add_element_to_object(&mut request, &Value::Str("until".into()), self.iso8601(until.clone()));
        }
        if (since != Value::Null) {
            add_element_to_object(&mut request, &Value::Str("after".into()), self.iso8601(since.clone()));
        }
        if (limit != Value::Null) {
 ...
 */
    ...
    m
        ...
        let mut response: Value = self.trader_private_get_v2_wallets(&[__ws_arg_19]).await;
 ...
 */
    ...
    pub async fn fetch_transactions_helper(&mut self, mut type_var: Value, mut code: Value, mut since: Value, mut limit: Value, mut params: Value) -> Value {
        ...
        if (sandboxMode) {
            ...
            let mut activities: Value = self.trader_private_get_v2_account_activities(&[__ws_arg_21]).await;
            //
            //     [
            //         {
            ...
            }
            {
                ...
                let mut isIncoming: bool = is_true(&(activityType.as_deref() == Some("CSD"))) || (is_true(&(activityType.as_deref() == Some("TRANS"))) && !is_true(&crate::precise::Precise::stringLt(&amount, &Value::Str("0".into()))));
 ...
 */
    ...
    m
        ...
        return self.fetch_transactions_helper(Value::Str("BOTH".into()), code.clone(), since.clone(), limit.clone(), params.clone()).await;
 ...
 */
    ...
    m
        ...
        return self.fetch_transactions_helper(Value::Str("INCOMING".into()), code.clone(), since.clone(), limit.clone(), params.clone()).await;
 ...
 */
    ...
    m
        ...
        return self.fetch_transactions_helper(Value::Str("OUTGOING".into()), code.clone(), since.clone(), limit.clone(), params.clone()).await;
    ...
    pub fn parse_transaction(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        //     }
        //
        let mut activityType: Value = self.safe_string_k(transaction.clone(), "activity_type", &[]);
        ...
        if (activityType != Value::Null) {
            ...
            let mut isIncoming: bool = is_true(&(activityType.as_str() == Some("CSD"))) || (is_true(&(activityType.as_str() == Some("TRANS"))) && !is_true(&crate::precise::Precise::stringLt(&netAmount, &Value::Str("0".into()))));
            ...
            comment = activityType.clone();
            internal = (Value::Bool(activityType.as_str() != Some("TRANS")));
        }  else {
            txid = self.safe_string_k(transaction.clone(), "tx_hash", &[]);
            datetime = self.safe_string_k(transaction.clone(), "created_at", &[]);
            timestamp = self.parse8601(datetime.clone());
            network = self.safe_string_k(transaction.clone(), "chain", &[]);
            address = self.safe_string_k(transaction.clone(), "to_address", &[]);
            addressTo = self.safe_string_k(transaction.clone(), "to_address", &[]);
            addressFrom = self.safe_string_k(transaction.clone(), "from_address", &[]);
            type_var = self.parse_transaction_type(self.safe_string_k(transaction.clone(), "direction", &[]));
 ...
 */
    ...
    m
        ...
        let mut account: Value = self.trader_private_get_v2_account(&[params.clone()]).await;
        let mut positions: Value = self.trader_private_get_v2_positions(&[]).await;
        //
        //     {
        ...
        let mut response: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                ...
                m.insert("positions".to_string(), positions.clone());
            m
        });
    ...
    m
        ...
        if (code != Value::Null) {
            ...
            add_element_to_object(&mut result, &code, cashAccount.clone());
        }
        {
                        let mut i: Value = Value::Int(0);
            ...
            if is_true(&(positionCode != Value::Null)) && !(in_op(&result, &positionCode)) {
                ...
                add_element_to_object(&mut positionAccount, &Value::Str("total".into()), self.safe_string_k(position.clone(), "qty", &[]));
                add_element_to_object(&mut result, &positionCode, positionAccount.clone());
            }
        }
        }
