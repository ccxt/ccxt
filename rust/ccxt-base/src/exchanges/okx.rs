 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_969 { i = add(&i, &Value::Int(1)); } __for_first_969 = false; is_less_than(&i, &get_array_length(&types)) } {
        ...
        promises = promise_all(&promises).await;
        {
            ...
            while { if !__for_first_970 { i = add(&i, &Value::Int(1)); } __for_first_970 = false; is_less_than(&i, &get_array_length(&promises)) } {
    ...
    m
        ...
        if is_equal(&type_var, &Value::Str("option".to_string())) {
            ...
            let mut promises: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_971 { i = add(&i, &Value::Int(1)); } __for_first_971 = false; is_less_than(&i, &get_array_length(&optionsUnderlying)) } {
            ...
            let mut markets: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_972 { i = add(&i, &Value::Int(1)); } __for_first_972 = false; is_less_than(&i, &get_array_length(&promisesResult)) } {
    ...
    m
        ...
        let mut marketsWithoutTest: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_973 { i = add(&i, &Value::Int(1)); } __for_first_973 = false; is_less_than(&i, &get_array_length(&dataResponse)) } {
 ...
 */
    ...
    m
        ...
        let mut chainsLength: Value = get_array_length(&chains);
        {
            ...
            while { if !__for_first_974 { j = add(&j, &Value::Int(1)); } __for_first_974 = false; is_less_than(&j, &chainsLength) } {
 ...
 */
    ...
    m
        ...
        let mut details: Value = self.safe_list_k(first.clone(), "details", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_976 { i = add(&i, &Value::Int(1)); } __for_first_976 = false; is_less_than(&i, &get_array_length(&details)) } {
 ...
 */
    ...
    m
        ...
        let mut ordersRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_978 { i = add(&i, &Value::Int(1)); } __for_first_978 = false; is_less_than(&i, &get_array_length(&orders)) } {
    ...
    m
        ...
        if is_equal(&clientOrderIds, &Value::Null) {
            ...
            if !is_equal(&algoIds, &Value::Null) {
                {
                    ...
                    while { if !__for_first_979 { i = add(&i, &Value::Int(1)); } __for_first_979 = false; is_less_than(&i, &get_array_length(&algoIds)) } {
            ...
            }
            {
                ...
                while { if !__for_first_980 { i = add(&i, &Value::Int(1)); } __for_first_980 = false; is_less_than(&i, &get_array_length(&ids)) } {
        ...
        }  else {
            {
                ...
                while { if !__for_first_981 { i = add(&i, &Value::Int(1)); } __for_first_981 = false; is_less_than(&i, &get_array_length(&clientOrderIds)) } {
                if is_true(&trailing) || is_true(&trigger) {
                    append_to_array(&mut request, Value::Map({
                        let mut m = indexmap::IndexMap::new();
                            m.insert("instId".to_string(), get_value(&market, &Value::Str("id".to_string())));
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_982 { i = add(&i, &Value::Int(1)); } __for_first_982 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    pub fn parse_leverage(&self, mut leverage: Value, optional_args: &[Value]) -> Value {
        ...
        let mut shortLeverage: Value = Value::Null;
        {
            ...
            while { if !__for_first_983 { i = add(&i, &Value::Int(1)); } __for_first_983 = false; is_less_than(&i, &get_array_length(&leverage)) } {
 ...
 */
    ...
    m
        ...
        if !is_equal(&symbols, &Value::Null) {
            let mut marketIds: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_984 { i = add(&i, &Value::Int(1)); } __for_first_984 = false; is_less_than(&i, &get_array_length(&symbols)) } {
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_985 { i = add(&i, &Value::Int(1)); } __for_first_985 = false; is_less_than(&i, &get_array_length(&positions)) } {
                ...
                if is_true(&Value::Bool(is_array(&params))) {
                    {
                        ...
                        while { if !__for_first_986 { i = add(&i, &Value::Int(1)); } __for_first_986 = false; is_less_than(&i, &get_array_length(&params)) } {
 ...
 */
    ...
    pub fn parse_borrow_rate_histories(&self, mut response: Value, mut codes: Value, mut since: Value, mut limit: Value) -> Value {
        ...
        let mut keys: Value = object_keys(&borrowRateHistories);
        {
            ...
            while { if !__for_first_991 { i = add(&i, &Value::Int(1)); } __for_first_991 = false; is_less_than(&i, &get_array_length(&keys)) } {
 ...
 */
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        let mut tiers: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_992 { i = add(&i, &Value::Int(1)); } __for_first_992 = false; is_less_than(&i, &get_array_length(&info)) } {
 ...
 */
    ...
    m
        ...
        let mut depositWithdrawCodes: Value = object_keys(&depositWithdrawFees);
        {
            ...
            while { if !__for_first_994 { i = add(&i, &Value::Int(1)); } __for_first_994 = false; is_less_than(&i, &get_array_length(&depositWithdrawCodes)) } {
 ...
 */
    ...
    pub fn parse_settlements(&self, mut settlements: Value, mut market: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_996 { i = add(&i, &Value::Int(1)); } __for_first_996 = false; is_less_than(&i, &get_array_length(&settlements)) } {
            ...
            let mut details: Value = self.safe_list_k(entry.clone(), "details", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_995 { j = add(&j, &Value::Int(1)); } __for_first_995 = false; is_less_than(&j, &get_array_length(&details)) } {
