 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_213 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_213 = false; i.as_f64().unwrap_or(f64::NAN) < ((currenciesData.len() as i64) as f64) } {
    ...
    m
            ...
            });
            {
                ...
                while { if !__for_first_212 { j = (match (&(j), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_212 = false; j.as_f64().unwrap_or(f64::NAN) < ((rawNetworks.len() as i64) as f64) } {
 ...
 */
    ...
    pub fn parse_markets(&self, mut markets: Value) -> Value {
        let mut result: Value = Value::from(vec![]);
        {
            ...
            while { if !__for_first_214 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_214 = false; i.as_f64().unwrap_or(f64::NAN) < get_array_length(&markets).as_f64().unwrap_or(f64::NAN) } {
 ...
 */
    ...
    m
        ...
        if (since != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("startTime".to_string(), (match (&(math_ceil(&(match ((since).as_f64(), (duration).as_f64()) { (Some(x), Some(y)) if y != 0.0 => Value::Float(x / y), _ => Value::Null }))), &(duration)) { (Value::Int(x), Value::Int(y)) => Value::Int(x * y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 * *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x * *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x * y), _ => Value::Null })); }
        }
        if (limit != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("limit".to_string(), Value::Int(1000)); }
        }
        ...
        //     }
        //
        let mut ohlcvs: Value = self.safe_list_k(response.clone(), "result", &[Value::from(vec![])]);
        return self.parse_ohlc_vs(ohlcvs, &[market, timeframe, since, limit.clone()]);
 ...
 */
    ...
    m
        ...
        if (market.as_map().and_then(|__m| __m.get("spot")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            ...
            if (limit != Value::Null) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("level".to_string(), crate::runtime::Math::min(&limit, &Value::Int(50))); }
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("level".to_string(), Value::Int(50)); }
            }
            if (market.as_map().and_then(|__m| __m.get("linear")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
    ...
    m
        ...
        let mut swapOb: Value = self.parse_order_book(orderBook.clone(), symbol.clone(), &[timestamp.clone(), Value::Str("b".into()), Value::Str("a".into())]);
        add_element_to_object(&mut swapOb, &Value::Str("nonce".into()), self.safe_integer2(orderBook.clone(), Value::Str("u".into()), Value::Str("lastUpdateId".into()), &[]));
        return swapOb;
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_216 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_216 = false; i.as_f64().unwrap_or(f64::NAN) < ((tickers.len() as i64) as f64) } {
 ...
 */
    ...
    m
        ...
        let mut type_var: Value = Value::Null;
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_market_type_and_params(Value::Str("fetchBidsAsks".into()), &[market.clone(), params.clone()]); type_var = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchBidsAsks".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        ...
        });
        {
            ...
            while { if !__for_first_217 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_217 = false; i.as_f64().unwrap_or(f64::NAN) < ((tickers.len() as i64) as f64) } {
 ...
 */
    ...
    m
        ...
        if (market.as_map().and_then(|__m| __m.get("spot")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            ...
            if (limit != Value::Null) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("num".to_string(), crate::runtime::Math::min(&limit, &Value::Int(1000))); }
            }
            if (market.as_map().and_then(|__m| __m.get("linear")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
        ...
        //     }
        //
        let mut trades: Value = self.safe_list_k(response.clone(), "result", &[Value::from(vec![])]);
        return self.parse_trades(trades, &[market.clone()]);
 ...
 */
    ...
    m
        ...
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchMyTrades".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        market = self.safe_market(&[marketId, market.clone(), Value::Str("_".into()), marketType.clone()]);
        ...
        if (marketType.as_str() == Some("spot")) {
            ...
            if (quantity == Value::Null) {
                amount = crate::precise::Precise::stringMul(&self.safe_string_k(trade.clone(), "a", &[]), &self.number_to_string(market.as_map().and_then(|__m| __m.get("contractSize")).cloned().unwrap_or(Value::Null)));
            }  else {
                amount = crate::precise::Precise::stringMul(&quantity, &self.number_to_string(market.as_map().and_then(|__m| __m.get("contractSize")).cloned().unwrap_or(Value::Null)));
            }
        }
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_218 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_218 = false; i.as_f64().unwrap_or(f64::NAN) < get_array_length(&response).as_f64().unwrap_or(f64::NAN) } {
 ...
 */
    ...
    m
        ...
        return self.create_order(symbol.clone(), Value::Str("market".into()), Value::Str("buy".into()), cost, &[Value::Int(1), params.clone()]).await;
 ...
 */
    ...
    m
            ...
            if (side.as_str() == Some("buy")) {
                ...
                if (createMarketBuyOrderRequiresPrice.as_bool() == Some(true)) {
                    if (price == Value::Null) && (cost == Value::Null) {
                        ...
                        if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("quoteQty".to_string(), self.cost_to_precision(symbol.clone(), costCalculated)); }
                    }
                }  else {
                    let mut amountCost: Value = (if (cost != Value::Null) { cost } else { amount.clone() });
                    if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("quoteQty".to_string(), self.cost_to_precision(symbol.clone(), amountCost)); }
                }
            }
        }  else {
        ...
        params = self.omit(params.clone(), Value::from(vec![Value::Str("timeInForce".into()), Value::Str("postOnly".into())]), &[]);
    ...
    m
        ...
        if (side.as_str() == Some("buy")) {
            let mut requestType: Value = (if (reduceOnly.as_bool() == Some(true)) { Value::Str("SHORT".into()) } else { Value::Str("LONG".into()) });
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("positionSide".to_string(), requestType.clone()); }
        }  else {
            let mut requestType: Value = (if (reduceOnly.as_bool() == Some(true)) { Value::Str("LONG".into()) } else { Value::Str("SHORT".into()) });
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("positionSide".to_string(), requestType); }
        }
        ...
        if isTrailing {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("orderSide".to_string(), to_upper(&side)); }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("triggerPriceType".to_string(), self.safe_string_k(params.clone(), "triggerPriceType", &[Value::Str("LATEST_PRICE".into())])); }
            let mut marginMode: Value = Value::Null;
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("positionType".to_string(), (if (marginMode.as_str() == Some("isolated")) { Value::Str("ISOLATED".into()) } else { Value::Str("CROSSED".into()) })); }
            if (trailingPercent != Value::Null) {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("callback".to_string(), Value::Str("PROPORTION".into())); }
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("callbackVal".to_string(), self.parse_to_numeric(crate::precise::Precise::stringDiv(&trailingPercent, &Value::Str("100".into())))); }
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("callback".to_string(), Value::Str("FIXED".into())); }
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("callbackVal".to_string(), self.parse_to_numeric(trailingAmount)); }
            }
            ...
            params = self.omit(params.clone(), Value::from(vec![Value::Str("trailingPercent".into()), Value::Str("trailingAmount".into()), Value::Str("trailingTriggerPrice".into())]), &[]);
            if (market.as_map().and_then(|__m| __m.get("linear")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("timeInForce".to_string(), (if (timeInForce == Value::Null) { Value::Str("GTC".into()) } else { timeInForce })); }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("triggerPriceType".to_string(), self.safe_string_k(params.clone(), "triggerPriceType", &[Value::Str("LATEST_PRICE".into())])); }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("orderSide".to_string(), to_upper(&side)); }
            ...
            let mut entrustType: Value = (if (type_var.as_str() == Some("market")) { Value::Str("STOP_MARKET".into()) } else { Value::Str("STOP".into()) });
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("entrustType".to_string(), entrustType); }
            ...
            if isStopLoss {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("triggerStopPrice".to_string(), self.price_to_precision(symbol.clone(), stopLoss.clone())); }
            }  else {
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("triggerProfitPrice".to_string(), self.price_to_precision(symbol.clone(), takeProfit.clone())); }
            }
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("orderSide".to_string(), to_upper(&side)); }
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("orderType".to_string(), to_upper(&type_var)); }
            if (market.as_map().and_then(|__m| __m.get("linear")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        let mut response: Value = Value::Null;
        { let __destr_tmp = self.handle_market_type_and_params(Value::Str("fetchOrder".into()), &[market.clone(), params.clone()]); type_var = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchOrder".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        ...
        if (trigger.as_bool() == Some(true)) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("entrustId".to_string(), id.clone()); }
        }  else if (stopLossTakeProfit.as_bool() == Some(true)) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("profitId".to_string(), id.clone()); }
        }  else if (trailing.as_bool() == Some(true)) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("trackId".to_string(), id.clone()); }
        }  else {
        ...
        if (trigger.as_bool() == Some(true)) {
            ...
            params = self.omit(params.clone(), Value::Str("stopLossTakeProfit".into()), &[]);
            if (subType.as_str() == Some("inverse")) {
            ...
            params = self.omit(params.clone(), Value::Str("trailing".into()), &[]);
            if (subType.as_str() == Some("inverse")) {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        let mut response: Value = Value::Null;
        { let __destr_tmp = self.handle_market_type_and_params(Value::Str("fetchOrders".into()), &[market.clone(), params.clone()]); type_var = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchOrders".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut trigger: Value = self.safe_bool2(params.clone(), Value::Str("trigger".into()), Value::Str("stop".into()), &[]);
        let mut trailing: Value = self.safe_bool_k(params.clone(), "trailing", &[]);
        if (trailing.as_bool() == Some(true)) {
            let mut isContract: bool = (subType != Value::Null) || (type_var.as_str() == Some("swap")) || (type_var.as_str() == Some("future"));
        ...
        if (trigger.as_bool() == Some(true)) {
            ...
            let mut marginMode: Value = Value::Null;
            { let __destr_tmp = self.handle_margin_mode_and_params(Value::Str("fetchOrders".into()), &[params.clone()]); marginMode = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
            let mut marginOrSpotRequest: Value = (if (marginMode != Value::Null) { Value::Str("LEVER".into()) } else { Value::Str("SPOT".into()) });
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("bizType".to_string(), marginOrSpotRequest); }
    ...
    m
        ...
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchOrdersByStatus".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        ...
        if (resultDict != Value::Null) {
            ...
            orders = self.safe_list_k(response.clone(), "result", &[Value::from(vec![])]);
        }
        if (trailing.as_bool() == Some(true)) {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        let mut response: Value = Value::Null;
        { let __destr_tmp = self.handle_market_type_and_params(Value::Str("cancelOrder".into()), &[market.clone(), params.clone()]); type_var = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        ...
        let mut order: Value = (if isContractResponse { response.clone() } else { self.safe_dict_k(response.clone(), "result", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]) });
        return self.parse_order(order, &[market.clone()]);
 ...
 */
    ...
    m
        ...
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("cancelAllOrders".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut trigger: Value = self.safe_bool2(params.clone(), Value::Str("trigger".into()), Value::Str("stop".into()), &[]);
        let mut stopLossTakeProfit: Value = self.safe_bool_k(params.clone(), "stopLossTakeProfit", &[]);
        let mut trailing: Value = self.safe_bool_k(params.clone(), "trailing", &[]);
        if (trailing.as_bool() == Some(true)) {
        ...
        return Value::from(vec![self.safe_order(response.clone(), &[])]);
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("cancelOrders".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
    ...
    pub fn parse_order(&self, mut order: Value, optional_args: &[Value]) -> Value {
        ...
        let mut amount: Value = (if (marketType.as_str() == Some("spot")) { quantity.clone() } else { crate::precise::Precise::stringMul(&self.number_to_string(quantity), &self.number_to_string(market.as_map().and_then(|__m| __m.get("contractSize")).cloned().unwrap_or(Value::Null))) });
        let mut filledQuantity: Value = self.safe_number_k(order.clone(), "executedQty", &[]);
        let mut filled: Value = (if (marketType.as_str() == Some("spot")) { filledQuantity.clone() } else { crate::precise::Precise::stringMul(&self.number_to_string(filledQuantity), &self.number_to_string(market.as_map().and_then(|__m| __m.get("contractSize")).cloned().unwrap_or(Value::Null))) });
 ...
 */
    ...
    m
        ...
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchLedger".into()), &[Value::Null, params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        return self.parse_ledger(ledger, &[currency, since.clone(), limit.clone()]);
    ...
    pub fn parse_ledger_entry(&self, mut item: Value, optional_args: &[Value]) -> Value {
        ...
        let mut direction: Value = (if (side.as_deref() == Some("ADD")) { Value::Str("in".into()) } else { Value::Str("out".into()) });
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("limit".to_string(), limit.clone()); }; // default 10, max 200
        }
    ...
    m
        ...
        return self.parse_transactions(deposits, &[currency, since.clone(), limit.clone(), params.clone()]);
 ...
 */
    ...
    m
        ...
        return self.parse_transactions(withdrawals, &[currency, since.clone(), limit.clone(), params.clone()]);
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("setLeverage".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
 ...
 */
    ...
    m
        ...
        return self.modify_margin_helper(symbol.clone(), amount.clone(), Value::Str("SUB".into()), &[params.clone()]).await;
    ...
    m
        ...
        let mut positionSide: Value = self.safe_string_k(params.clone(), "positionSide", &[]);
        let mut methodName: Value = (if (addOrReduce.as_str() == Some("ADD")) { Value::Str("addMargin".into()) } else { Value::Str("reduceMargin".into()) });
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("modifyMarginHelper".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchLeverageTiers".into()), &[Value::Null, params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
        ...
        //     }
        //
        let mut data: Value = self.safe_list_k(response.clone(), "result", &[Value::from(vec![])]);
        symbols = self.market_symbols(&[symbols.clone()]);
    ...
    pub fn parse_leverage_tiers(&self, mut response: Value, optional_args: &[Value]) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_219 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_219 = false; i.as_f64().unwrap_or(f64::NAN) < get_array_length(&response).as_f64().unwrap_or(f64::NAN) } {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchMarketLeverageTiers".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        return self.parse_market_leverage_tiers(data, &[market.clone()]);
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        let mut brackets: Value = self.safe_list_k(info.clone(), "leverageBrackets", &[Value::from(vec![])]);
        {
            ...
            while { if !__for_first_220 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_220 = false; i.as_f64().unwrap_or(f64::NAN) < ((brackets.len() as i64) as f64) } {
            ...
            append_to_array(&mut tiers, Value::Map({
                let mut m = indexmap::IndexMap::new();
                    ...
                    m.insert("symbol".to_string(), self.safe_symbol(marketId, &[market.clone(), Value::Str("_".into()), Value::Str("contract".into())]));
 ...
 */
    ...
    m
        ...
        if is_true(&paginate) {
            return self.fetch_paginated_call_cursor(Value::Str("fetchFundingRateHistory".into()), &[symbol.clone(), since.clone(), limit.clone(), params.clone(), Value::Str("id".into()), Value::Str("id".into()), Value::Int(1), Value::Int(200)]).await;
        }
        let mut market: Value = self.market(symbol.clone());
        ...
        if (limit != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("limit".to_string(), Value::Int(200)); }; // max
        }
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchFundingRateHistory".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        let mut rates: Value = Value::from(vec![]);
        {
            ...
            while { if !__for_first_221 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_221 = false; i.as_f64().unwrap_or(f64::NAN) < ((items.len() as i64) as f64) } {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchFundingRate".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        return self.parse_funding_rate(result, &[market.clone()]);
    ...
    pub fn parse_funding_rate(&self, mut contract: Value, optional_args: &[Value]) -> Value {
        ...
        let mut symbol: Value = self.safe_symbol(marketId, &[market.clone(), Value::Str("_".into()), Value::Str("swap".into())]);
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchOpenInterest".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        return self.parse_open_interest(result, &[market.clone()]);
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchTradingFee".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        return self.parse_trading_fee(result, &[market.clone()]);
 ...
 */
    ...
    m
        ...
        self.load_markets(&[]).await;
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchTradingFees".into()), &[Value::Null, params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut isInverse: bool = subType.as_str() == Some("inverse");
        let mut response: Value = Value::Null;
        if isInverse {
            response = self.private_inverse_get_future_user_v1_user_step_rate(&[params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchFundingHistory".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        return self.filter_by_since_limit(sorted, &[since.clone(), limit.clone()]);
 ...
 */
    pub fn index_position_break_list(&self, mut breakList: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_224 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_224 = false; i.as_f64().unwrap_or(f64::NAN) < ((breakList.len() as i64) as f64) } {
            ...
            add_element_to_object(&mut breakBySymbolSide, &key, breakEntry);
        }
        }
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchPosition".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        ...
        //     }
        //
        let mut positions: Value = self.safe_list_k(response.clone(), "result", &[Value::from(vec![])]);
        let mut breakBySymbolSide: Value = self.index_position_break_list(self.safe_list_k(breakResponse, "result", &[Value::from(vec![])]));
        {
            ...
            while { if !__for_first_225 { i = (match (&(i), &(Value::Int(1))) { (Value::Int(x), Value::Int(y)) => Value::Int(x + y), (Value::Int(x), Value::Float(y)) => Value::Float(*x as f64 + *y), (Value::Float(x), Value::Int(y)) => Value::Float(*x + *y as f64), (Value::Float(x), Value::Float(y)) => Value::Float(x + y), _ => Value::Null }); } __for_first_225 = false; i.as_f64().unwrap_or(f64::NAN) < ((positions.len() as i64) as f64) } {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchPositions".into()), &[Value::Null, params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut promisesUnresolved: Value = Value::from(vec![]);
        if (subType.as_str() == Some("inverse")) {
 ...
 */
    ...
    m
        ...
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("fetchPositionsHistory".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        let mut items: Value = self.safe_list_k(result.clone(), "items", &[Value::from(vec![])]);
        let mut positions: Value = self.parse_positions(items, &[symbols]);
        return self.filter_by_since_limit(positions, &[since.clone(), limit.clone()]);
    ...
    pub fn parse_position(&self, mut position: Value, optional_args: &[Value]) -> Value {
        ...
        let mut symbol: Value = self.safe_symbol(marketId, &[market.clone(), Value::Null, Value::Str("contract".into())]);
        ...
        let mut marginMode: Value = (if (isCross) { Value::Str("cross".into()) } else { Value::Str("isolated".into()) });
 ...
 */
    ...
    m
        ...
        let mut amountString: Value = self.currency_to_precision(code, amount.clone(), &[]);
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
 ...
 */
    ...
    m
        ...
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("positionType".to_string(), marginMode);
                m.insert("positionSide".to_string(), posSide);
                m.insert("symbol".to_string(), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null));
            m
        });
        let mut subType: Value = Value::Null;
        { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("setMarginMode".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut response: Value = Value::Null;
        if (subType.as_str() == Some("inverse")) {
    ...
    m
        ...
        if (market.as_map().and_then(|__m| __m.get("swap")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) {
            if isStopLoss {
                ...
                if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("origQty".to_string(), self.amount_to_precision(symbol.clone(), amount.clone())); }
            }
            let mut subType: Value = Value::Null;
            { let __destr_tmp = self.handle_sub_type_and_params(Value::Str("editOrder".into()), &[market.clone(), params.clone()]); subType = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
            if (subType.as_str() == Some("inverse")) {
                if isStopLoss || isTakeProfit {
        ...
        let mut result: Value = (if (market.as_map().and_then(|__m| __m.get("swap")).cloned().unwrap_or(Value::Null).as_bool() == Some(true)) { response.clone() } else { self.safe_dict_k(response.clone(), "result", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
})]) });
        ...
        if signed {
            ...
            if (payload.as_str() == Some("/v4/order")) || (payload.as_str() == Some("/future/trade/v1/order/create")) || (payload.as_str() == Some("/future/trade/v1/entrust/create-plan")) || (payload.as_str() == Some("/future/trade/v1/entrust/create-profit")) || (payload.as_str() == Some("/future/trade/v1/order/create-batch")) {
                ...
                if Value::Int(payload.as_str().and_then(|__s| __s.find("future")).map(|__i| __i as i64).unwrap_or(-1)).as_f64().unwrap_or(f64::NAN) > ((-1i64) as f64) {
                    add_element_to_object(&mut body, &Value::Str("clientMedia".into()), id.clone());
                    if (body == Value::Null) {
                        panic!("{}", crate::exchange_errors::null_response(format!("{}{}", self.id.clone(), Value::Str(" sign() returned empty body".into()))));
                    }
                }  else {
                    add_element_to_object(&mut body, &Value::Str("media".into()), id.clone());
                }
            }
            ...
            if (endpoint.as_str() == Some("spot")) || (endpoint.as_str() == Some("user")) {
                ...
                if isUndefinedBody {
                    if (urlencoded.as_str() != Some("")) {
                        ...
                        payloadString = Value::Str(format!("{}{}", payloadString, Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str("#".into()), method).into()), Value::Str("#".into())).into()), payload).into()), Value::Str("#".into())).into()), self.rawencode(self.keysort(query.clone(), &[]), &[])).into())).into());
                    }  else {
                    ...
                    payloadString = Value::Str(format!("{}{}", payloadString, add(&Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str("#".into()), method).into()), Value::Str("#".into())).into()), payload).into()), Value::Str("#".into())).into()), &body)).into());
                }
                add_element_to_object(&mut headers, &Value::Str("xt-validate-algorithms".into()), Value::Str("HmacSHA256".into()));
                add_element_to_object(&mut headers, &Value::Str("xt-validate-recvwindow".into()), recvWindow.clone());
            }  else {
                ...
                if (method.as_str() == Some("GET")) {
                    ...
                    payloadString = Value::Str(format!("{}{}", payloadString, add(&Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str("#".into()), payload).into()), Value::Str("#".into())).into()), &body)).into());
                }
            }
            let mut signature: Value = self.hmac(self.encode(payloadString.clone()), self.encode(self.secret.clone()), Value::Str("sha256".into()), &[]);
            add_element_to_object(&mut headers, &Value::Str("xt-validate-appkey".into()), self.apiKey.clone());
            add_element_to_object(&mut headers, &Value::Str("xt-validate-timestamp".into()), timestamp.clone());
            add_element_to_object(&mut headers, &Value::Str("xt-validate-signature".into()), signature);
        }  else {
            if (urlencoded.as_str() != Some("")) {
                url = Value::Str(format!("{}{}", url, Value::Str(format!("{}{}", Value::Str("?".into()), urlencoded).into())).into());
            }
