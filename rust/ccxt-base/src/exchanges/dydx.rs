 ...
 */
    ...
    pub fn pow(&self, mut n: Value, mut m: Value) -> Value {
        ...
        let mut c: Value = self.parse_to_int(m.clone());
        {
            ...
            while { if !__for_first_656 { i = add(&i, &Value::Int(1)); } __for_first_656 = false; is_less_than(&i, &c) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_657 { i = add(&i, &Value::Int(1)); } __for_first_657 = false; is_less_than(&i, &get_array_length(&rows)) } {
