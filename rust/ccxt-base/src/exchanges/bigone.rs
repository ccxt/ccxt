 ...
 */
    ...
    pub fn parse_ticker(&self, mut ticker: Value, optional_args: &[Value]) -> Value {
        ...
        //    }
        //
        let mut marketType: Value = (if (in_op(&ticker, &Value::Str("asset_pair_name".to_string()))) { Value::Str("spot".to_string()) } else { Value::Str("swap".to_string()) });
 ...
 */
    ...
    pub fn parse_transaction(&self, mut transaction: Value, optional_args: &[Value]) -> Value {
        ...
        let mut type_var: Value = (if (in_op(&transaction, &Value::Str("customer_id".to_string()))) { Value::Str("withdrawal".to_string()) } else { Value::Str("deposit".to_string()) });
