 ...
 */
    ...
    m
        ...
        let mut types: Value = self.safe_list_k(fetchMarketsOptions.clone(), "types", &[Value::List(vec![Value::Str("spot".to_string()), Value::Str("swap".to_string()), Value::Str("future".to_string()), Value::Str("option".to_string())])]);
        {
            ...
            while { if !__for_first_674 { i = add(&i, &Value::Int(1)); } __for_first_674 = false; is_less_than(&i, &get_array_length(&types)) } {
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_675 { i = add(&i, &Value::Int(1)); } __for_first_675 = false; is_less_than(&i, &get_array_length(&spotMarketsResponse)) } {
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_677 { c = add(&c, &Value::Int(1)); } __for_first_677 = false; is_less_than(&c, &get_array_length(&swapSettlementCurrencies)) } {
            ...
            let mut response: Value = self.public_futures_get_settle_contracts(&[__ws_arg_0]).await;
            {
                ...
                while { if !__for_first_676 { i = add(&i, &Value::Int(1)); } __for_first_676 = false; is_less_than(&i, &get_array_length(&response)) } {
    ...
    m
        ...
        let mut futureSettlementCurrencies: Value = self.get_settlement_currencies(Value::Str("future".to_string()), Value::Str("fetchMarkets".to_string()));
        {
            ...
            while { if !__for_first_679 { c = add(&c, &Value::Int(1)); } __for_first_679 = false; is_less_than(&c, &get_array_length(&futureSettlementCurrencies)) } {
    ...
    m
        ...
        let mut underlyings: Value = self.fetch_option_underlyings().await;
        {
            ...
            while { if !__for_first_681 { i = add(&i, &Value::Int(1)); } __for_first_681 = false; is_less_than(&i, &get_array_length(&underlyings)) } {
            ...
            let mut response: Value = self.public_options_get_contracts(&[query.clone()]).await;
            {
                ...
                while { if !__for_first_680 { j = add(&j, &Value::Int(1)); } __for_first_680 = false; is_less_than(&j, &get_array_length(&response)) } {
    ...
    pub async fn fetch_option_underlyings(&mut self) -> Value {
        ...
        let mut underlyings: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_682 { i = add(&i, &Value::Int(1)); } __for_first_682 = false; is_less_than(&i, &get_array_length(&underlyingsResponse)) } {
 ...
 */
    ...
    pub fn parse_currency(&self, mut rawCurrency: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_683 { j = add(&j, &Value::Int(1)); } __for_first_683 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_684 { i = add(&i, &Value::Int(1)); } __for_first_684 = false; is_less_than(&i, &get_array_length(&addresses)) } {
 ...
 */
    ...
    pub fn parse_trading_fees(&self, mut response: Value) -> Value {
        ...
        let mut symbols: Value = self.symbols.clone();
        {
            ...
            while { if !__for_first_685 { i = add(&i, &Value::Int(1)); } __for_first_685 = false; is_less_than(&i, &get_array_length(&symbols)) } {
    ...
    m
            ...
            if is_equal(&withdrawFixOnChains, &Value::Null) {
                ...
                let mut networkIds: Value = object_keys(&withdrawFixOnChains);
                {
                    ...
                    while { if !__for_first_686 { j = add(&j, &Value::Int(1)); } __for_first_686 = false; is_less_than(&j, &get_array_length(&networkIds)) } {
    ...
    m
        ...
        if !is_equal(&withdrawFixOnChains, &Value::Null) {
            let mut chainKeys: Value = object_keys(&withdrawFixOnChains);
            {
                ...
                while { if !__for_first_688 { i = add(&i, &Value::Int(1)); } __for_first_688 = false; is_less_than(&i, &get_array_length(&chainKeys)) } {
    ...
    m
        ...
        if is_true(&Value::Bool(in_op(&data, &Value::Str("balances".to_string())))) {
            ...
            let mut keys: Value = object_keys(&balances);
            {
                ...
                while { if !__for_first_691 { i = add(&i, &Value::Int(1)); } __for_first_691 = false; is_less_than(&i, &get_array_length(&keys)) } {
        ...
        }
        {
            ...
            while { if !__for_first_692 { i = add(&i, &Value::Int(1)); } __for_first_692 = false; is_less_than(&i, &get_array_length(&data)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_694 { i = add(&i, &Value::Int(1)); } __for_first_694 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        let mut openSpotOrders: Value = Value::Bool(is_true(&spot) && is_true(&openStatus) && is_true(&(!is_equal(&trigger, &Value::Bool(true)))));
        let mut response: Value = Value::Null;
        if is_true(&spot) {
            if !is_equal(&trigger, &Value::Bool(true)) {
    ...
    m
        ...
        if is_true(&isSpot) {
            let mut ordersRequests: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_696 { i = add(&i, &Value::Int(1)); } __for_first_696 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    m
        ...
        let mut ordersRequests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_698 { i = add(&i, &Value::Int(1)); } __for_first_698 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    pub fn parse_market_leverage_tiers(&self, mut info: Value, optional_args: &[Value]) -> Value {
        ...
        let mut tiers: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_699 { i = add(&i, &Value::Int(1)); } __for_first_699 = false; is_less_than(&i, &get_array_length(&info)) } {
    ...
    m
        ...
        if is_true(&containsSettle) && is_true(&(is_equal(&Value::Bool(ends_with(&path, &Value::Str("batch_cancel_orders".to_string()))), &Value::Bool(true)))) {
            ...
            let mut anyParams: Value = self.to_array(params.clone());
            {
                ...
                while { if !__for_first_700 { i = add(&i, &Value::Int(1)); } __for_first_700 = false; is_less_than(&i, &get_array_length(&anyParams)) } {
 ...
 */
    ...
    pub fn parse_settlements(&self, mut settlements: Value, mut market: Value) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_701 { i = add(&i, &Value::Int(1)); } __for_first_701 = false; is_less_than(&i, &get_array_length(&settlements)) } {
 ...
 */
    ...
    m
        ...
        let mut underlyings: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_702 { i = add(&i, &Value::Int(1)); } __for_first_702 = false; is_less_than(&i, &get_array_length(&response)) } {
