 ...
 */
    ...
    pub fn parse_currency(&self, mut currency: Value) -> Value {
        ...
        let mut precision: Value = self.parse_number(precisionString.clone(), &[]);
        {
            ...
            while { if !__for_first_366 { j = add(&j, &Value::Int(1)); } __for_first_366 = false; is_less_than(&j, &get_array_length(&chains)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_368 { i = add(&i, &Value::Int(1)); } __for_first_368 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        let mut rawTickers: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_369 { i = add(&i, &Value::Int(1)); } __for_first_369 = false; is_less_than(&i, &get_array_length(&rawTickers)) } {
 ...
 */
    ...
    m
        ...
        let mut rawItems: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_371 { i = add(&i, &Value::Int(1)); } __for_first_371 = false; is_less_than(&i, &get_array_length(&rawItems)) } {
    ...
    m
        ...
        if !is_equal(&networksLength, &Value::Int(0)) {
            ...
            let mut precision: Value = self.parse_precision(&[scale.clone()]);
            {
                ...
                while { if !__for_first_372 { i = add(&i, &Value::Int(1)); } __for_first_372 = false; is_less_than(&i, &networksLength) } {
 ...
 */
    ...
    pub fn parse_settlements(&self, mut settlements: Value, optional_args: &[Value]) -> Value {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_373 { i = add(&i, &Value::Int(1)); } __for_first_373 = false; is_less_than(&i, &get_array_length(&settlements)) } {
