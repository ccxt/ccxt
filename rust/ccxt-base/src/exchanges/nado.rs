 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_948 { i = add(&i, &Value::Int(1)); } __for_first_948 = false; is_less_than(&i, &get_array_length(&cancelledOrders)) } {
 ...
 */
    ...
    m
        ...
        let mut productIds: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_949 { i = add(&i, &Value::Int(1)); } __for_first_949 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    m
        ...
        let mut trades: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_951 { i = add(&i, &Value::Int(1)); } __for_first_951 = false; is_less_than(&i, &get_array_length(&matches)) } {
 ...
 */
    ...
    m
        ...
        let mut transactions: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_953 { i = add(&i, &Value::Int(1)); } __for_first_953 = false; is_less_than(&i, &get_array_length(&events)) } {
            ...
            });
            {
                ...
                while { if !__for_first_952 { j = add(&j, &Value::Int(1)); } __for_first_952 = false; is_less_than(&j, &get_array_length(&txs)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_955 { i = add(&i, &Value::Int(1)); } __for_first_955 = false; is_less_than(&i, &get_array_length(&positions)) } {
    ...
    m
            ...
            });
            {
                ...
                while { if !__for_first_954 { j = add(&j, &Value::Int(1)); } __for_first_954 = false; is_less_than(&j, &get_array_length(&products)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_956 { i = add(&i, &Value::Int(1)); } __for_first_956 = false; is_less_than(&i, &get_array_length(&pairs)) } {
        ...
        });
        {
            ...
            while { if !__for_first_958 { i = add(&i, &Value::Int(1)); } __for_first_958 = false; is_less_than(&i, &get_array_length(&assets)) } {
            let mut rawAsset: Value = get_value(&assets, &i);
            let mut rawAsset: Value = get_value(&assets, &i);
        ...
        let mut markets: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_959 { i = add(&i, &Value::Int(1)); } __for_first_959 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut assets: Value = self.to_array(response.clone());
        {
            ...
            while { if !__for_first_960 { i = add(&i, &Value::Int(1)); } __for_first_960 = false; is_less_than(&i, &get_array_length(&assets)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_961 { i = add(&i, &Value::Int(1)); } __for_first_961 = false; is_less_than(&i, &get_array_length(&fundingPayments)) } {
 ...
 */
    ...
    m
        ...
        let mut interests: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_963 { i = add(&i, &Value::Int(1)); } __for_first_963 = false; is_less_than(&i, &get_array_length(&tickers)) } {
            let mut ticker: Value = get_value(&tickers, &i);
            let mut ticker: Value = get_value(&tickers, &i);
