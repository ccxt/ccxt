 ...
 */
    ...
    m
        ...
        return Value::Map({
    let mut m = indexmap::IndexMap::new();
        m.insert("status".to_string(), (if (statusRaw.as_deref() == Some("online")) { Value::Str("ok".to_string()) } else { Value::Str("maintenance".to_string()) }));
 ...
 */
    ...
    m
        ...
        if (limit != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("count".to_string(), limit.clone()); }; // 100
        }
 ...
 */
    ...
    m
        ...
        if (symbols != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("pair".to_string(), join(&marketIds, &Value::Str(",".to_string()))); }
        }
 ...
 */
    ...
    m
        ...
        if (until != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("end".to_string(), self.parse_to_int(crate::precise::Precise::stringAdd(&untilDivided, &Value::Str("1".to_string())))); }
        }
    ...
    pub fn parse_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        if (matches!(&trade, Value::Arr(_))) {
            ...
            side = (if (trade.as_array().and_then(|__arr| __arr.get(3)).cloned().unwrap_or(Value::Null).as_str() == Some("s")) { Value::Str("sell".to_string()) } else { Value::Str("buy".to_string()) });
            type_var = (if (trade.as_array().and_then(|__arr| __arr.get(4)).cloned().unwrap_or(Value::Null).as_str() == Some("l")) { Value::Str("limit".to_string()) } else { Value::Str("market".to_string()) });
 ...
 */
    ...
    m
        ...
        if (price != Value::Null) && ((ends_with(&price, &Value::Str("%".to_string()))) || is_true(&crate::precise::Precise::stringEquals(&price, &Value::Str("0.00000".to_string()))) || is_true(&crate::precise::Precise::stringEquals(&price, &Value::Str("0".to_string())))) {
        ...
        if (id == Value::Null) || (starts_with(&id, &Value::Str("[".to_string()))) {
    ...
    m
        ...
        if is_true(&self.in_array(typeParsed.clone(), Value::from(vec![Value::Str("stop loss".to_string()), Value::Str("take profit".to_string())]))) {
            typeParsed = (if (price == Value::Null) { Value::Str("market".to_string()) } else { Value::Str("limit".to_string()) });
        }
    ...
    m
        ...
        let mut isLimitOrder: bool = (type_var != Value::Null) && (ends_with(&type_var, &Value::Str("limit".to_string()))); // supporting limit, stop-loss-limit, take-profit-limit, etc
        ...
        if isMarketOrder && ((cost != Value::Null) || isViqcOrder) {
            ...
            let mut extendedOflags: Value = (if (flags != Value::Null) { Value::Str(format!("{}{}", flags, Value::Str(",viqc".to_string()))) } else { Value::Str("viqc".to_string()) });
        ...
        if isStopLossOrTakeProfitTrigger {
            ...
            let mut trailingAmountString: Value = (if (trailingAmount != Value::Null) { Value::Str(format!("{}{}", Value::Str("+".to_string()), trailingAmount)) } else { Value::Null }); // must use + for this
    ...
    m
        ...
        if (postOnly.as_bool() == Some(true)) {
            let mut extendedPostFlags: Value = (if (flags != Value::Null) { Value::Str(format!("{}{}", flags, Value::Str(",post".to_string()))) } else { Value::Str("post".to_string()) });
 ...
 */
    ...
    m
        ...
        if (clientOrderId != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("userref".to_string(), clientOrderId.clone()); }
 ...
 */
    ...
    m
        ...
        if (userref != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("userref".to_string(), userref.clone()); }
            params = self.omit(params.clone(), Value::Str("userref".to_string()), &[]);
        }
        let mut clientOrderId: Value = self.safe_string_k(params.clone(), "clientOrderId", &[]);
        if (clientOrderId != Value::Null) {
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("cl_ord_id".to_string(), clientOrderId.clone()); }
 ...
 */
    ...
    m
        ...
        if (since != Value::Null) {
            ...
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("start".to_string(), crate::precise::Precise::stringDiv(&sinceString, &Value::Str("1000".to_string()))); }
        }
        let mut until: Value = self.safe_string2(params.clone(), Value::Str("until".to_string()), Value::Str("till".to_string()), &[]);
        if (until != Value::Null) {
            params = self.omit(params.clone(), Value::from(vec![Value::Str("until".to_string()), Value::Str("till".to_string())]), &[]);
            let mut untilDivided: Value = crate::precise::Precise::stringDiv(&until, &Value::Str("1000".to_string()));
            if let Value::Dict(__d) = &mut request { std::sync::Arc::make_mut(__d).insert("end".to_string(), crate::precise::Precise::stringAdd(&untilDivided, &Value::Str("1".to_string()))); }
        }
            ...
            if (network != Value::Null) {
                {
                    ...
                    let mut entry: Value = self.safe_string(depositMethods.as_array().and_then(|__arr| match &i { Value::Int(__n) => __arr.get(*__n as usize), Value::Str(__s) => __s.parse::<usize>().ok().and_then(|__n| __arr.get(__n)), _ => None }).cloned().unwrap_or(Value::Null), Value::Str("method".to_string()), &[]);
                    if (entry == Value::Null) {
 ...
 */
    ...
    pub fn parse_position(&self, mut position: Value, optional_args: &[Value]) -> Value {
        ...
        let mut side: Value = (if (rawSide.as_deref() == Some("buy")) { Value::Str("long".to_string()) } else { Value::Str("short".to_string()) });
