 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_940 { i = add(&i, &Value::Int(1)); } __for_first_940 = false; is_less_than(&i, &get_array_length(&rows)) } {
    ...
    m
        ...
        while is_equal(&paging, &Value::Bool(true)) {
            ...
            }
            {
                ...
                while { if !__for_first_941 { i = add(&i, &Value::Int(1)); } __for_first_941 = false; is_less_than(&i, &numItems) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_942 { i = add(&i, &Value::Int(1)); } __for_first_942 = false; is_less_than(&i, &get_array_length(&aggregated)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_943 { i = add(&i, &Value::Int(1)); } __for_first_943 = false; is_less_than(&i, &get_array_length(&rows)) } {
 ...
 */
    ...
    m
        ...
        let mut outPos: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_944 { i = add(&i, &Value::Int(1)); } __for_first_944 = false; is_less_than(&i, &get_array_length(&rows)) } {
    ...
    m
        ...
        if is_equal(&positionId, &Value::Null) {
            ...
            let mut positions: Value = self.fetch_positions(&[Value::List(vec![symbol.clone()]), params.clone()]).await;
            {
                ...
                while { if !__for_first_945 { i = add(&i, &Value::Int(1)); } __for_first_945 = false; is_less_than(&i, &get_array_length(&positions)) } {
    ...
    m
        ...
        if is_equal(&positionId, &Value::Null) {
            let mut positions: Value = self.fetch_positions(&[Value::List(vec![symbol.clone()]), params.clone()]).await;
            {
                ...
                while { if !__for_first_946 { i = add(&i, &Value::Int(1)); } __for_first_946 = false; is_less_than(&i, &get_array_length(&positions)) } {
                let mut p: Value = get_value(&positions, &i);
                let mut p: Value = get_value(&positions, &i);
