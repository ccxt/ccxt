 ...
 */
    ...
    m
        ...
        if is_true(&(Value::Bool(userLimit != Value::Null))) && is_true(&(flatMarketsLength > userLimit.as_f64().unwrap_or(f64::NAN))) {
 ...
 */
    ...
    m
        ...
        let mut isSlug: bool = get_index_of(&id, &Value::Str("-".to_string())).as_f64().unwrap_or(f64::NAN) >= ((0i64) as f64);
