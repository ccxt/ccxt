 ...
 */
    ...
    m
            ...
            let mut total: Value = self.safe_integer_k(result.clone(), "total", &[]);
            {
                ...
                while { if !__for_first_1336 { i = add(&i, &Value::Int(1)); } __for_first_1336 = false; is_less_than(&i, &rawMarketsLength) } {
                ...
                if is_equal(&marketType, &Value::Int(1)) {
                    ...
                    let mut childMarketsLength: Value = get_array_length(&childMarkets);
                    {
                        ...
                        while { if !__for_first_1335 { ci = add(&ci, &Value::Int(1)); } __for_first_1335 = false; is_less_than(&ci, &childMarketsLength) } {
 ...
 */
    pub fn parse_opinion_market(&self, mut raw: Value, optional_args: &[Value]) -> Value {
        ...
        let mut resolvedOutcome: Value = Value::Null;
        {
            ...
            while { if !__for_first_1337 { i = add(&i, &Value::Int(1)); } __for_first_1337 = false; is_less_than(&i, &get_array_length(&outcomeLabels)) } {
 ...
 */
    ...
    m
            ...
            fetchedRawCount = self.sum(&[fetchedRawCount.clone(), pageEventsLength.clone()]);
            {
                ...
                while { if !__for_first_1338 { i = add(&i, &Value::Int(1)); } __for_first_1338 = false; is_less_than(&i, &pageEventsLength) } {
        ...
        }
        {
            ...
            while { if !__for_first_1340 { i = add(&i, &Value::Int(1)); } __for_first_1340 = false; is_less_than(&i, &rawEventsLength) } {
            ...
            let mut eventMarketsLength: Value = get_array_length(&eventMarkets);
            {
                ...
                while { if !__for_first_1339 { mi = add(&mi, &Value::Int(1)); } __for_first_1339 = false; is_less_than(&mi, &eventMarketsLength) } {
 ...
 */
    pub fn parse_event(&self, mut rawEvent: Value) -> Value {
        ...
        let mut marketsList: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1341 { i = add(&i, &Value::Int(1)); } __for_first_1341 = false; is_less_than(&i, &rawChildrenLength) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1343 { i = add(&i, &Value::Int(1)); } __for_first_1343 = false; is_less_than(&i, &outcomesLength) } {
            let mut outcomeObj: Value = self.outcome(get_value(&outcomes, &i));
 ...
 */
    ...
    m
        ...
        let mut historyLength: Value = get_array_length(&history);
        {
            ...
            while { if !__for_first_1344 { i = add(&i, &Value::Int(1)); } __for_first_1344 = false; is_less_than(&i, &historyLength) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1345 { i = add(&i, &Value::Int(1)); } __for_first_1345 = false; is_less_than(&i, &listLength) } {
 ...
 */
    ...
    pub fn opinion_order_raw_amounts(&self, mut isMarket: Value, mut side: Value, mut amount: Value, mut price: Value, mut decimals: Value) -> Value {
        let mut decimalsStr: Value = Value::Str("1".to_string());
        {
            ...
            while { if !__for_first_1346 { i = add(&i, &Value::Int(1)); } __for_first_1346 = false; is_less_than(&i, &decimals) } {
 ...
 */
    ...
    m
        ...
        let mut tradesLength: Value = get_array_length(&trades);
        {
            ...
            while { if !__for_first_1347 { i = add(&i, &Value::Int(1)); } __for_first_1347 = false; is_less_than(&i, &tradesLength) } {
 ...
 */
    ...
    m
        ...
        let mut rawBalancesLength: Value = get_array_length(&rawBalances);
        {
            ...
            while { if !__for_first_1348 { i = add(&i, &Value::Int(1)); } __for_first_1348 = false; is_less_than(&i, &rawBalancesLength) } {
 ...
 */
    ...
    m
        ...
        let mut balancesLength: Value = get_array_length(&balances);
        {
            ...
            while { if !__for_first_1349 { i = add(&i, &Value::Int(1)); } __for_first_1349 = false; is_less_than(&i, &balancesLength) } {
 ...
 */
    ...
    m
        ...
        let mut outcomesList: Value = ternary(is_true(&(is_equal(&outcomes, &Value::Null))), Value::List(vec![]), outcomes.clone());
        {
            ...
            while { if !__for_first_1350 { i = add(&i, &Value::Int(1)); } __for_first_1350 = false; is_less_than(&i, &get_array_length(&outcomesList)) } {
        ...
        let mut filtered: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1351 { i = add(&i, &Value::Int(1)); } __for_first_1351 = false; is_less_than(&i, &get_array_length(&parsed)) } {
 ...
 */
    pub fn opinion_outcome_by_market_id_side(&self, mut marketId: Value, mut outcomeSide: Value) -> Value {
        ...
        let mut marketKeysLength: Value = get_array_length(&marketKeys);
        {
            ...
            while { if !__for_first_1352 { i = add(&i, &Value::Int(1)); } __for_first_1352 = false; is_less_than(&i, &marketKeysLength) } {
