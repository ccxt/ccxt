    ...
    m
        ...
        if is_greater_than(&queriesLength, &Value::Int(0)) {
            ...
            let mut queryMarkets: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_1132 { ei = add(&ei, &Value::Int(1)); } __for_first_1132 = false; is_less_than(&ei, &eventsLength) } {
    ...
    m
        ...
        while is_true(&Value::Bool(true)) {
            ...
            let mut pageTopicsLength: Value = get_array_length(&pageTopics);
            {
                ...
                while { if !__for_first_1135 { i = add(&i, &Value::Int(1)); } __for_first_1135 = false; is_less_than(&i, &pageTopicsLength) } {
            ...
            if !is_true(&hasMore) || is_true(&(is_less_than(&pageTopicsLength, &reqLimit))) {
                break;
            }
 ...
 */
    pub async fn complete_raw_topics(&mut self, mut rawTopics: Value) -> Value {
        ...
        let mut rawTopicsLength: Value = get_array_length(&rawTopics);
        {
            ...
            while { if !__for_first_1136 { i = add(&i, &Value::Int(1)); } __for_first_1136 = false; is_less_than(&i, &rawTopicsLength) } {
 ...
 */
    ...
    m
        ...
        let mut allQueries: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1137 { i = add(&i, &Value::Int(1)); } __for_first_1137 = false; is_less_than(&i, &get_array_length(&queries)) } {
        ...
        }
        {
            ...
            while { if !__for_first_1138 { i = add(&i, &Value::Int(1)); } __for_first_1138 = false; is_less_than(&i, &tagsLength) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1140 { i = add(&i, &Value::Int(1)); } __for_first_1140 = false; is_less_than(&i, &rawTopicsLength) } {
            let mut parsedEvent: Value = self.parse_event(get_value(&rawTopics, &i));
            ...
            let mut parsedMarketsLength: Value = get_array_length(&parsedMarkets);
            {
                ...
                while { if !__for_first_1139 { mi = add(&mi, &Value::Int(1)); } __for_first_1139 = false; is_less_than(&mi, &parsedMarketsLength) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_1142 { qi = add(&qi, &Value::Int(1)); } __for_first_1142 = false; is_less_than(&qi, &queriesLength) } {
            let mut request: Value = Value::Map({
                let mut m = indexmap::IndexMap::new();
            ...
            let mut responseLength: Value = get_array_length(&response);
            {
                ...
                while { if !__for_first_1141 { i = add(&i, &Value::Int(1)); } __for_first_1141 = false; is_less_than(&i, &responseLength) } {
 ...
 */
    pub fn parse_event(&self, mut rawTopic: Value) -> Value {
        ...
        let mut rawMarketsLength: Value = get_array_length(&rawMarkets);
        {
            ...
            while { if !__for_first_1143 { i = add(&i, &Value::Int(1)); } __for_first_1143 = false; is_less_than(&i, &rawMarketsLength) } {
 ...
 */
    pub fn parse_topic_market(&self, mut rawMarket: Value, mut rawTopic: Value) -> Value {
        ...
        let mut rawOutcomesLength: Value = get_array_length(&rawOutcomes);
        {
            ...
            while { if !__for_first_1144 { oi = add(&oi, &Value::Int(1)); } __for_first_1144 = false; is_less_than(&oi, &rawOutcomesLength) } {
 ...
 */
    ...
    m
        ...
        let mut outcomesLength: Value = get_array_length(&outcomes);
        {
            ...
            while { if !__for_first_1145 { i = add(&i, &Value::Int(1)); } __for_first_1145 = false; is_less_than(&i, &outcomesLength) } {
 ...
 */
    ...
    m
        ...
        let mut balances: Value = self.safe_list_k(response.clone(), "items", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_1146 { i = add(&i, &Value::Int(1)); } __for_first_1146 = false; is_less_than(&i, &get_array_length(&balances)) } {
 ...
 */
    ...
    m
        ...
        if !is_equal(&outcomes, &Value::Null) {
            {
                ...
                while { if !__for_first_1147 { i = add(&i, &Value::Int(1)); } __for_first_1147 = false; is_less_than(&i, &get_array_length(&outcomes)) } {
        ...
        let mut positionsLength: Value = get_array_length(&positions);
        {
            ...
            while { if !__for_first_1148 { i = add(&i, &Value::Int(1)); } __for_first_1148 = false; is_less_than(&i, &positionsLength) } {
 ...
 */
    ...
    m
        ...
        let mut walletLength: Value = get_array_length(&wallets);
        {
            ...
            while { if !__for_first_1149 { i = add(&i, &Value::Int(1)); } __for_first_1149 = false; is_less_than(&i, &walletLength) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1150 { i = add(&i, &Value::Int(1)); } __for_first_1150 = false; is_less_than(&i, &get_array_length(&ids)) } {
        ...
        if is_greater_than(&failedOrdersLength, &Value::Int(0)) {
            let mut failedDetails: Value = Value::Str("".to_string());
            {
                ...
                while { if !__for_first_1151 { i = add(&i, &Value::Int(1)); } __for_first_1151 = false; is_less_than(&i, &failedOrdersLength) } {
        ...
        let mut canceledOrdersLength: Value = get_array_length(&canceledOrders);
        {
            ...
            while { if !__for_first_1152 { i = add(&i, &Value::Int(1)); } __for_first_1152 = false; is_less_than(&i, &canceledOrdersLength) } {
