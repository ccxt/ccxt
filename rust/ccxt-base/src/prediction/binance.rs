 ...
 */
    ...
    m
        ...
        if is_true(&(Value::Bool(limit != Value::Null))) && is_true(&(collectedLength > limit.as_f64().unwrap_or(f64::NAN))) {
 ...
 */
    ...
    m
        ...
        if is_true(&(Value::Bool(prec != Value::Null))) && is_true(&(prec.as_f64().unwrap_or(f64::NAN) > ((0i64) as f64))) {
