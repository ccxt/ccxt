 ...
 */
    ...
    m
        ...
        let mut rawMarkets: Value = Value::List(vec![]);
        {
            ...
            let mut found: Value = (if is_true(&(foundList != Value::Null)) { foundList.clone() } else { Value::List(vec![]) });
            {
 ...
 */
    ...
    m
        ...
        while is_true(&(true)) {
            ...
            let mut rawMarkets: Value = (if is_true(&(rawMarketsList != Value::Null)) { rawMarketsList.clone() } else { Value::List(vec![]) });
 ...
 */
    ...
    m
        ...
        while is_true(&(true)) {
            ...
            let mut rawQuestions: Value = (if is_true(&(rawQuestionsList != Value::Null)) { rawQuestionsList.clone() } else { Value::List(vec![]) });
 ...
 */
    ...
    m
        ...
        let mut side: Value = (if is_true(&(sideInt.as_f64() == Some(1.0))) { Value::Str("sell".to_string()) } else { Value::Str("buy".to_string()) });
 ...
 */
    ...
    m
        ...
        if is_true(&(requestedStatus.as_str() == Some("open"))) || is_true(&(requestedStatus.as_str() == Some("cancelled"))) || is_true(&(requestedStatus.as_str() == Some("canceled"))) || is_true(&(requestedStatus.as_str() == Some("expired"))) {
    ...
    m
        ...
        let mut rowsLength: Value = Value::Int(rows.len() as i64);
        {
            ...
            if is_true(&(action.as_str() != Some("buy"))) && is_true(&(action.as_str() != Some("sell"))) {
                continue;
            }
 ...
 */
    ...
    m
        ...
        let mut marketExecutionModel: Value = (if is_true(&(marketTradingModel.as_str() == Some("amm"))) { Value::Str("amm".to_string()) } else { Value::Str("clob".to_string()) });
 ...
 */
    ...
    m
        ...
        let mut points: Value = (if is_true(&(pointsList != Value::Null)) { pointsList.clone() } else { Value::List(vec![]) });
    ...
    m
        ...
        let mut usablePoints: Value = Value::List(vec![]);
        {
            ...
            if (is_true(&(pointOpen != Value::Null)) || is_true(&(pointPrice != Value::Null))) && is_true(&(pointTs != Value::Null)) {
 ...
 */
    ...
    m
        ...
        let mut rows: Value = (if is_true(&(rowsList != Value::Null)) { rowsList.clone() } else { Value::List(vec![]) });
        let mut trades: Value = Value::List(vec![]);
        {
                        let mut i: Value = Value::Int(0);
 ...
 */
    ...
    m
            ...
            if is_true(&(evMarketsLength.as_f64().unwrap_or(f64::NAN) > Value::Int(0).as_f64().unwrap_or(f64::NAN))) && is_true(&(filteredMarketsLength.as_f64() == Some(0.0))) {
                continue;
            }
 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("event".to_string(), (if is_true(&((questionSlug != Value::Null) && (questionSlug.as_str() != Some("")))) { __ws_arg_33 } else { Value::Null }));
        ...
        m.insert("end".to_string(), (if is_true(&((endDate != Value::Null) && (endDate.as_str() != Some("")))) { __ws_arg_46 } else { Value::Null }));
        m.insert("endDatetime".to_string(), endDate.clone());
 ...
 */
    ...
    pub fn handle_order_book(&self, mut client: Value, mut data: Value) {
        ...
        });
        {
            ...
            let mut bookSide: Value = (if is_true(&(sideStr.as_str() == Some("bid"))) { get_value(&orderbook, &Value::Str("bids".to_string())) } else { get_value(&orderbook, &Value::Str("asks".to_string())) });
 ...
 */
    ...
    pub fn wallet_address_or_undefined(&self) -> Value {
        ...
        if is_true(&(self.walletAddress.clone() != Value::Null)) && is_true(&(Value::Int(self.walletAddress.len() as i64).as_f64().unwrap_or(f64::NAN) > Value::Int(0).as_f64().unwrap_or(f64::NAN))) {
 ...
 */
    ...
    pub fn wallet_address_from_keys(&self) -> Value {
        ...
        let mut hasWallet: bool = is_true(&(address != Value::Null)) && is_true(&(Value::Int(self.walletAddress.len() as i64).as_f64().unwrap_or(f64::NAN) > Value::Int(0).as_f64().unwrap_or(f64::NAN)));
        if !hasWallet {
            if (self.privateKey.clone() == Value::Null) {
