 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1264 { i = add(&i, &Value::Int(1)); } __for_first_1264 = false; is_less_than(&i, &get_array_length(&rawMarkets)) } {
 ...
 */
    ...
    m
        ...
        let mut rawMarkets: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1266 { i = add(&i, &Value::Int(1)); } __for_first_1266 = false; is_less_than(&i, &get_array_length(&queries)) } {
            ...
            let mut found: Value = ternary(is_true(&(!is_equal(&foundList, &Value::Null))), foundList.clone(), Value::List(vec![]));
            {
                ...
                while { if !__for_first_1265 { j = add(&j, &Value::Int(1)); } __for_first_1265 = false; is_less_than(&j, &get_array_length(&found)) } {
    ...
    m
        ...
        while is_true(&Value::Bool(true)) {
            ...
            }
            {
                ...
                while { if !__for_first_1267 { i = add(&i, &Value::Int(1)); } __for_first_1267 = false; is_less_than(&i, &rawMarketsLength) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
            ...
            let mut idLower: Value = to_lower(&id);
            {
                ...
                while { if !__for_first_1268 { i = add(&i, &Value::Int(1)); } __for_first_1268 = false; is_less_than(&i, &questionsLength) } {
 ...
 */
    ...
    m
        ...
        let mut rawQuestions: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1270 { i = add(&i, &Value::Int(1)); } __for_first_1270 = false; is_less_than(&i, &get_array_length(&queries)) } {
            let mut q: Value = get_value(&queries, &i);
            let mut q: Value = get_value(&queries, &i);
            ...
            let mut found: Value = ternary(is_true(&(!is_equal(&foundList, &Value::Null))), foundList.clone(), Value::List(vec![]));
            {
                ...
                while { if !__for_first_1269 { j = add(&j, &Value::Int(1)); } __for_first_1269 = false; is_less_than(&j, &get_array_length(&found)) } {
                let mut raw: Value = get_value(&found, &j);
                let mut raw: Value = get_value(&found, &j);
    ...
    m
        ...
        while is_true(&Value::Bool(true)) {
            ...
            }
            {
                ...
                while { if !__for_first_1271 { i = add(&i, &Value::Int(1)); } __for_first_1271 = false; is_less_than(&i, &rawQuestionsLength) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1272 { i = add(&i, &Value::Int(1)); } __for_first_1272 = false; is_less_than(&i, &get_array_length(&data)) } {
 ...
 */
    ...
    pub fn sign_evm_transaction(&self, mut tx: Value, mut privateKey: Value) -> Value {
        ...
        let mut signedFields: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1273 { i = add(&i, &Value::Int(1)); } __for_first_1273 = false; is_less_than(&i, &get_array_length(&fields)) } {
 ...
 */
    ...
    m
        ...
        let mut orderOutcomes: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1274 { i = add(&i, &Value::Int(1)); } __for_first_1274 = false; is_less_than(&i, &ordersLength) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1275 { i = add(&i, &Value::Int(1)); } __for_first_1275 = false; is_less_than(&i, &ordersLength) } {
    ...
    m
        ...
        if !is_equal(&orderResponses, &Value::Null) {
            let mut responsesLength: Value = get_array_length(&orderResponses);
            {
                ...
                while { if !__for_first_1276 { i = add(&i, &Value::Int(1)); } __for_first_1276 = false; is_less_than(&i, &responsesLength) } {
 ...
 */
    ...
    m
        ...
        let mut rowsLength: Value = get_array_length(&rows);
        {
            ...
            while { if !__for_first_1277 { i = add(&i, &Value::Int(1)); } __for_first_1277 = false; is_less_than(&i, &rowsLength) } {
 ...
 */
    ...
    m
        ...
        let mut networkId: Value = self.safe_string_k(self.options.clone(), "defaultNetworkId", &[Value::Str("56".to_string())]);
        {
            ...
            while { if !__for_first_1278 { i = add(&i, &Value::Int(1)); } __for_first_1278 = false; is_less_than(&i, &idsLength) } {
 ...
 */
    ...
    m
        ...
        let mut ordersLength: Value = get_array_length(&orders);
        {
            ...
            while { if !__for_first_1279 { i = add(&i, &Value::Int(1)); } __for_first_1279 = false; is_less_than(&i, &ordersLength) } {
 ...
 */
    ...
    pub fn hex_to_decimal_string(&self, mut hexValue: Value) -> Value {
        ...
        let mut result: Value = Value::Str("0".to_string());
        {
            ...
            while { if !__for_first_1280 { i = add(&i, &Value::Int(1)); } __for_first_1280 = false; is_less_than(&i, &n) } {
    ...
    pub fn from_wei_with_decimals(&self, mut hexValue: Value, mut decimals: Value) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_1281 { i = add(&i, &Value::Int(1)); } __for_first_1281 = false; is_less_than(&i, &decimals) } {
 ...
 */
    ...
    m
        ...
        let mut outcomes: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1282 { i = add(&i, &Value::Int(1)); } __for_first_1282 = false; is_less_than(&i, &get_array_length(&rawOutcomes)) } {
 ...
 */
    pub fn parse_prediction_ticker(&self, mut raw: Value, optional_args: &[Value]) -> Value {
        ...
        let mut change: Value = Value::Null;
        {
            ...
            while { if !__for_first_1283 { i = add(&i, &Value::Int(1)); } __for_first_1283 = false; is_less_than(&i, &get_array_length(&outcomes)) } {
 ...
 */
    ...
    m
        ...
        let mut price: Value = Value::Null;
        {
            ...
            while { if !__for_first_1284 { i = add(&i, &Value::Int(1)); } __for_first_1284 = false; is_less_than(&i, &get_array_length(&outcomes)) } {
            let mut o: Value = get_value(&outcomes, &i);
            let mut o: Value = get_value(&outcomes, &i);
            if is_equal(&self.safe_string_k(o.clone(), "outcomeId", &[self.safe_string(o.clone(), Value::Str("id".to_string()), &[])]), &outcomeId) {
                price = self.safe_number_k(o.clone(), "price", &[]);
 ...
 */
    pub fn parse_wei_order_book(&self, mut response: Value, mut outcome: Value) -> Value {
        ...
        let mut bids: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1285 { i = add(&i, &Value::Int(1)); } __for_first_1285 = false; is_less_than(&i, &get_array_length(&rawBids)) } {
        ...
        let mut asks: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1286 { i = add(&i, &Value::Int(1)); } __for_first_1286 = false; is_less_than(&i, &get_array_length(&rawAsks)) } {
 ...
 */
    ...
    m
        ...
        let mut selectedOutcome: Value = Value::Null;
        {
            ...
            while { if !__for_first_1287 { i = add(&i, &Value::Int(1)); } __for_first_1287 = false; is_less_than(&i, &get_array_length(&outcomes)) } {
        ...
        if !is_equal(&chartsList, &Value::Null) {
            {
                ...
                while { if !__for_first_1288 { i = add(&i, &Value::Int(1)); } __for_first_1288 = false; is_less_than(&i, &get_array_length(&chartsList)) } {
    ...
    m
        ...
        let mut usablePoints: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1289 { i = add(&i, &Value::Int(1)); } __for_first_1289 = false; is_less_than(&i, &get_array_length(&points)) } {
 ...
 */
    ...
    m
        ...
        let mut marketKeys: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1290 { i = add(&i, &Value::Int(1)); } __for_first_1290 = false; is_less_than(&i, &get_array_length(&outcomes)) } {
    ...
    m
        ...
        let mut responses: Value = promise_all(&promises).await;
        {
            ...
            while { if !__for_first_1293 { i = add(&i, &Value::Int(1)); } __for_first_1293 = false; is_less_than(&i, &get_array_length(&marketKeys)) } {
            let mut key: Value = get_value(&marketKeys, &i);
            let mut key: Value = get_value(&marketKeys, &i);
            ...
            let mut grouped: Value = get_value(&outcomesByMarket, &key);
            {
                ...
                while { if !__for_first_1292 { j = add(&j, &Value::Int(1)); } __for_first_1292 = false; is_less_than(&j, &get_array_length(&grouped)) } {
 ...
 */
    ...
    m
        ...
        let mut trades: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1294 { i = add(&i, &Value::Int(1)); } __for_first_1294 = false; is_less_than(&i, &get_array_length(&rows)) } {
            let mut row: Value = get_value(&rows, &i);
            let mut row: Value = get_value(&rows, &i);
 ...
 */
    ...
    m
        ...
        if is_greater_than(&queriesLength, &Value::Int(0)) {
            ...
            if is_equal(&requestedTagsLength, &Value::Int(0)) {
                ...
                let mut tagQueries: Value = Value::List(vec![]);
                {
                    ...
                    while { if !__for_first_1295 { i = add(&i, &Value::Int(1)); } __for_first_1295 = false; is_less_than(&i, &requestedTagsLength) } {
        ...
        let mut rawQuestionsLength: Value = get_array_length(&rawQuestions);
        {
            ...
            let mut filteredMarkets: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_1296 { j = add(&j, &Value::Int(1)); } __for_first_1296 = false; is_less_than(&j, &evMarketsLength) } {
    ...
    m
        ...
        let mut rawMarketsLength: Value = get_array_length(&rawMarkets);
        {
            ...
            while { if !__for_first_1298 { i = add(&i, &Value::Int(1)); } __for_first_1298 = false; is_less_than(&i, &rawMarketsLength) } {
            let mut raw: Value = get_value(&rawMarkets, &i);
            let mut raw: Value = get_value(&rawMarkets, &i);
            let mut m: Value = self.parse_myriad_market(raw.clone(), &[]);
            let mut marketHandle: Value = self.safe_string_k(m.clone(), "market", &[]);
    ...
    pub fn handle_message(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_string(&message) {
            ...
            let mut linesLength: Value = get_array_length(&lines);
            {
                ...
                while { if !__for_first_1300 { i = add(&i, &Value::Int(1)); } __for_first_1300 = false; is_less_than(&i, &linesLength) } {
 ...
 */
    ...
    pub fn handle_order_book(&self, mut client: Value, mut data: Value) {
        ...
        });
        {
            ...
            while { if !__for_first_1301 { i = add(&i, &Value::Int(1)); } __for_first_1301 = false; is_less_than(&i, &changesLength) } {
        ...
        let mut updatedLength: Value = get_array_length(&updatedSymbols);
        {
            ...
            while { if !__for_first_1302 { k = add(&k, &Value::Int(1)); } __for_first_1302 = false; is_less_than(&k, &updatedLength) } {
    ...
    m
        ...
        if !is_equal(&myWallet, &Value::Null) {
            ...
            let mut makersLength: Value = get_array_length(&makers);
            {
                ...
                while { if !__for_first_1303 { i = add(&i, &Value::Int(1)); } __for_first_1303 = false; is_less_than(&i, &makersLength) } {
    ...
    m
            ...
            if is_greater_than(&myLegsLength, &Value::Int(0)) {
                ...
                let mut myStored: Value = self.myTrades.clone();
                {
                    ...
                    while { if !__for_first_1304 { k = add(&k, &Value::Int(1)); } __for_first_1304 = false; is_less_than(&k, &myLegsLength) } {
 ...
 */
    ...
    m
        ...
        let mut resolvedSymbols: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1305 { i = add(&i, &Value::Int(1)); } __for_first_1305 = false; is_less_than(&i, &symbolsLength) } {
            let mut outcomeObj: Value = self.outcome(get_value(&outcomes, &i));
            let mut info: Value = self.safe_dict_k(outcomeObj.clone(), "info", &[Value::Map({
    let mut m = indexmap::IndexMap::new();
    m
 ...
 */
    ...
    m
        ...
        let mut ohlcvcLength: Value = get_array_length(&ohlcvc);
        {
            ...
            while { if !__for_first_1306 { i = add(&i, &Value::Int(1)); } __for_first_1306 = false; is_less_than(&i, &ohlcvcLength) } {
    ...
    pub fn handle_ticker(&mut self, mut client: Value, mut data: Value) {
        ...
        }
        {
            ...
            while { if !__for_first_1307 { i = add(&i, &Value::Int(1)); } __for_first_1307 = false; is_less_than(&i, &outcomesLength) } {
            let mut oc: Value = get_value(&outcomes, &i);
            let mut oc: Value = get_value(&outcomes, &i);
 ...
 */
    ...
    m
        ...
        let mut positionsLength: Value = get_array_length(&positions);
        {
            ...
            while { if !__for_first_1308 { i = add(&i, &Value::Int(1)); } __for_first_1308 = false; is_less_than(&i, &positionsLength) } {
