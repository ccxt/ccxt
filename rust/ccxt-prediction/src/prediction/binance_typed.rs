...
//
// Typed wrapper for binance.
//
// Owns a `Box<BinanceCore>` and exposes the unified CCXT API
...
use crate::Params;
use crate::Config;
use crate::prediction::binance::BinanceCore;
use crate::types::*;
...
impl Binance {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BinanceCore {
        &mut self.core
    }
...
impl crate::typed::TypedExchange for Binance {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Binance::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Binance::markets(self) }
}
