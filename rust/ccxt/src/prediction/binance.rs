    ...
    m
        ...
        if is_greater_than(&queriesLength, &Value::Int(0)) {
            ...
            let mut queryMarkets: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_1109 { ei = add(&ei, &Value::Int(1)); } __for_first_1109 = false; is_less_than(&ei, &eventsLength) } {
                ...
                let mut eventMarketsLength: Value = get_array_length(&eventMarkets);
                {
                    ...
                    while { if !__for_first_1108 { mi = add(&mi, &Value::Int(1)); } __for_first_1108 = false; is_less_than(&mi, &eventMarketsLength) } {
        ...
        let mut rawTopicsLength: Value = get_array_length(&rawTopics);
        {
            ...
            while { if !__for_first_1111 { i = add(&i, &Value::Int(1)); } __for_first_1111 = false; is_less_than(&i, &rawTopicsLength) } {
            ...
            let mut eventMarketsLength: Value = get_array_length(&eventMarkets);
            {
                ...
                while { if !__for_first_1110 { mi = add(&mi, &Value::Int(1)); } __for_first_1110 = false; is_less_than(&mi, &eventMarketsLength) } {
    ...
    m
        ...
        while is_true(&Value::Bool(true)) {
            ...
            let mut pageTopicsLength: Value = get_array_length(&pageTopics);
            {
                ...
                while { if !__for_first_1112 { i = add(&i, &Value::Int(1)); } __for_first_1112 = false; is_less_than(&i, &pageTopicsLength) } {
 ...
 */
    pub async fn complete_raw_topics(&mut self, mut rawTopics: Value) -> Value {
        ...
        let mut rawTopicsLength: Value = get_array_length(&rawTopics);
        {
            ...
            while { if !__for_first_1113 { i = add(&i, &Value::Int(1)); } __for_first_1113 = false; is_less_than(&i, &rawTopicsLength) } {
 ...
 */
    ...
    m
        ...
        let mut allQueries: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1114 { i = add(&i, &Value::Int(1)); } __for_first_1114 = false; is_less_than(&i, &get_array_length(&queries)) } {
        ...
        }
        {
            ...
            while { if !__for_first_1115 { i = add(&i, &Value::Int(1)); } __for_first_1115 = false; is_less_than(&i, &tagsLength) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1117 { i = add(&i, &Value::Int(1)); } __for_first_1117 = false; is_less_than(&i, &rawTopicsLength) } {
            let mut parsedEvent: Value = self.parse_event(get_value(&rawTopics, &i));
            ...
            let mut parsedMarketsLength: Value = get_array_length(&parsedMarkets);
            {
                ...
                while { if !__for_first_1116 { mi = add(&mi, &Value::Int(1)); } __for_first_1116 = false; is_less_than(&mi, &parsedMarketsLength) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_1119 { qi = add(&qi, &Value::Int(1)); } __for_first_1119 = false; is_less_than(&qi, &queriesLength) } {
            let mut request: Value = Value::Map({
                let mut m = indexmap::IndexMap::new();
            ...
            let mut responseLength: Value = get_array_length(&response);
            {
                ...
                while { if !__for_first_1118 { i = add(&i, &Value::Int(1)); } __for_first_1118 = false; is_less_than(&i, &responseLength) } {
 ...
 */
    pub fn parse_event(&self, mut rawTopic: Value) -> Value {
        ...
        let mut rawMarketsLength: Value = get_array_length(&rawMarkets);
        {
            ...
            while { if !__for_first_1120 { i = add(&i, &Value::Int(1)); } __for_first_1120 = false; is_less_than(&i, &rawMarketsLength) } {
 ...
 */
    pub fn parse_topic_market(&self, mut rawMarket: Value, mut rawTopic: Value) -> Value {
        ...
        let mut rawOutcomesLength: Value = get_array_length(&rawOutcomes);
        {
            ...
            while { if !__for_first_1121 { oi = add(&oi, &Value::Int(1)); } __for_first_1121 = false; is_less_than(&oi, &rawOutcomesLength) } {
 ...
 */
    ...
    m
        ...
        let mut outcomesLength: Value = get_array_length(&outcomes);
        {
            ...
            while { if !__for_first_1122 { i = add(&i, &Value::Int(1)); } __for_first_1122 = false; is_less_than(&i, &outcomesLength) } {
 ...
 */
    ...
    m
        ...
        if !is_equal(&outcomes, &Value::Null) {
            {
                ...
                while { if !__for_first_1124 { i = add(&i, &Value::Int(1)); } __for_first_1124 = false; is_less_than(&i, &get_array_length(&outcomes)) } {
        ...
        let mut positionsLength: Value = get_array_length(&positions);
        {
            ...
            while { if !__for_first_1125 { i = add(&i, &Value::Int(1)); } __for_first_1125 = false; is_less_than(&i, &positionsLength) } {
 ...
 */
    ...
    m
        ...
        let mut walletLength: Value = get_array_length(&wallets);
        {
            ...
            while { if !__for_first_1126 { i = add(&i, &Value::Int(1)); } __for_first_1126 = false; is_less_than(&i, &walletLength) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_1127 { i = add(&i, &Value::Int(1)); } __for_first_1127 = false; is_less_than(&i, &get_array_length(&ids)) } {
        ...
        if is_greater_than(&failedOrdersLength, &Value::Int(0)) {
            let mut failedDetails: Value = Value::Str("".to_string());
            {
                ...
                while { if !__for_first_1128 { i = add(&i, &Value::Int(1)); } __for_first_1128 = false; is_less_than(&i, &failedOrdersLength) } {
        ...
        let mut canceledOrdersLength: Value = get_array_length(&canceledOrders);
        {
            ...
            while { if !__for_first_1129 { i = add(&i, &Value::Int(1)); } __for_first_1129 = false; is_less_than(&i, &canceledOrdersLength) } {
