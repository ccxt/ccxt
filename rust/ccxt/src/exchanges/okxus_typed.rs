...
impl Okxus {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(OkxusCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Okxus {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Okxus::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Okxus::markets(self) }
}
