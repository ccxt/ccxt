...
impl Coinbase {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(CoinbaseCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Coinbase {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Coinbase::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Coinbase::markets(self) }
}
