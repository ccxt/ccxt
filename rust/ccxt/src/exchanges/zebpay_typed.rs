...
impl Zebpay {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(ZebpayCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Zebpay {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Zebpay::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Zebpay::markets(self) }
}
