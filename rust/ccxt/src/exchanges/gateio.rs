...
impl GateioCore {
    ...
    pub fn init(&mut self) {
        ...
        let described = GateioCore::describe(self);
    ...
    pub fn bind(&mut self) {
        ...
        self.exchange.bind_call_async(core_ptr, GateioCore::__call_dynamic_dispatch);
    }
...
impl crate::exchange::DerivedExchange for GateioCore {
...
impl std::ops::Deref for GateioCore {
    type Target = crate::exchanges::gate::GateCore;
    fn deref(&self) -> &Self::Target { &self.parent }
}

impl std::ops::DerefMut for GateioCore {
...
impl GateioCore {
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("id".to_string(), Value::Str("gateio".to_string()));
