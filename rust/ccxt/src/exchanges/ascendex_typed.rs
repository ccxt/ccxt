...
//
// Typed wrapper for ascendex.
//
// Owns a `Box<AscendexCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::ascendex::AscendexCore;
use crate::types::*;

pub struct Ascendex {
    pub core: Box<AscendexCore>,
}

impl Ascendex {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(AscendexCore::new(config));
    ...
    pub fn from_core(core: AscendexCore) -> Self {
...
impl std::ops::Deref for Ascendex {
    type Target = AscendexCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Ascendex {
