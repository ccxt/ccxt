...
impl Cryptomus {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(CryptomusCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Cryptomus {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Cryptomus::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Cryptomus::markets(self) }
}
