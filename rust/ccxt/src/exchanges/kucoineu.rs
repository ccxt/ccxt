...
impl KucoineuCore {
    ...
    m
        ...
        m.insert("www".to_string(), Value::Str("https://www.kucoin.com/en-eu".to_string()));
        m.insert("doc".to_string(), Value::List(vec![Value::Str("https://www.kucoin.com/en-eu/docs-new".to_string())]));
    m
}));
