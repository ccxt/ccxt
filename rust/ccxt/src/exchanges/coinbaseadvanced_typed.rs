...
//
// Typed wrapper for coinbaseadvanced.
//
// Owns a `Box<CoinbaseadvancedCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::coinbaseadvanced::CoinbaseadvancedCore;
use crate::types::*;

pub struct Coinbaseadvanced {
    pub core: Box<CoinbaseadvancedCore>,
}

impl Coinbaseadvanced {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(CoinbaseadvancedCore::new(config));
    ...
    pub fn from_core(core: CoinbaseadvancedCore) -> Self {
...
impl std::ops::Deref for Coinbaseadvanced {
    type Target = CoinbaseadvancedCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Coinbaseadvanced {
