...
//
// Typed wrapper for yobit.
//
// Owns a `Box<YobitCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::yobit::YobitCore;
use crate::types::*;

pub struct Yobit {
    pub core: Box<YobitCore>,
}

impl Yobit {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(YobitCore::new(config));
    ...
    pub fn from_core(core: YobitCore) -> Self {
...
impl std::ops::Deref for Yobit {
    type Target = YobitCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Yobit {
