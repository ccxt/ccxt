...
impl Coinex {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(CoinexCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Coinex {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Coinex::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Coinex::markets(self) }
}
