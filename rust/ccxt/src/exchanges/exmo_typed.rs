...
//
// Typed wrapper for exmo.
//
// Owns a `Box<ExmoCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::exmo::ExmoCore;
use crate::types::*;
...
pub struct Exmo {
    ...
    core: std::pin::Pin<Box<ExmoCore>>,
}

impl Exmo {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::pin(ExmoCore::new(config));
    ...
    pub fn from_core(core: ExmoCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut ExmoCore {
...
impl std::ops::Deref for Exmo {
    type Target = ExmoCore;
