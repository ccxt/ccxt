...
//
// Typed wrapper for aftermath.
//
// Owns a `Box<AftermathCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::aftermath::AftermathCore;
use crate::types::*;

pub struct Aftermath {
    pub core: Box<AftermathCore>,
}

impl Aftermath {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(AftermathCore::new(config));
    ...
    pub fn from_core(core: AftermathCore) -> Self {
...
impl std::ops::Deref for Aftermath {
    type Target = AftermathCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Aftermath {
