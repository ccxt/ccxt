...
impl Tokocrypto {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(TokocryptoCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Tokocrypto {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Tokocrypto::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Tokocrypto::markets(self) }
}
