 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_311 { i = add(&i, &Value::Int(1)); } __for_first_311 = false; is_less_than(&i, &get_array_length(&markets)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_312 { i = add(&i, &Value::Int(1)); } __for_first_312 = false; is_less_than(&i, &get_array_length(&get_value(&indexed, &Value::Str("networks".to_string())))) } {
    ...
    pub fn parse_currencies_custom(&self, mut ids: Value, mut indexed: Value, mut indexedNetworks: Value) -> Value {
        let mut allowedIds: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_313 { i = add(&i, &Value::Int(1)); } __for_first_313 = false; is_less_than(&i, &get_array_length(&ids)) } {
        ...
        let mut arr: Value = self.to_array(allowedIds.clone());
        {
            ...
            while { if !__for_first_314 { i = add(&i, &Value::Int(1)); } __for_first_314 = false; is_less_than(&i, &get_array_length(&arr)) } {
    ...
    pub fn parse_currency_custom(&self, mut id: Value, mut indexed: Value, mut indexedNetworks: Value) -> Value {
        ...
        let mut networkIds: Value = self.safe_list(indexedNetworks.clone(), id.clone(), &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_315 { j = add(&j, &Value::Int(1)); } __for_first_315 = false; is_less_than(&j, &get_array_length(&networkIds)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_316 { i = add(&i, &Value::Int(1)); } __for_first_316 = false; is_less_than(&i, &get_array_length(&balances)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = self.to_array(orderbook.clone());
        {
            ...
            while { if !__for_first_317 { i = add(&i, &Value::Int(1)); } __for_first_317 = false; is_less_than(&i, &get_array_length(&orders)) } {
 ...
 */
    ...
    m
        ...
        let mut tradesList: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_318 { i = add(&i, &Value::Int(1)); } __for_first_318 = false; is_less_than(&i, &get_array_length(&trades)) } {
        ...
        if !is_equal(&flags, &Value::Null) {
            {
                ...
                while { if !__for_first_319 { i = add(&i, &Value::Int(1)); } __for_first_319 = false; is_less_than(&i, &get_array_length(&flags)) } {
 ...
 */
    ...
    m
        ...
        let mut numericIds: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_323 { i = add(&i, &Value::Int(1)); } __for_first_323 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    m
        ...
        let mut takerFeeDeriv: Value = self.safe_number(takerData.clone(), Value::Int(5), &[]);
        {
            ...
            while { if !__for_first_329 { i = add(&i, &Value::Int(1)); } __for_first_329 = false; is_less_than(&i, &get_array_length(&self.symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut rates: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_332 { i = add(&i, &Value::Int(1)); } __for_first_332 = false; is_less_than(&i, &get_array_length(&rawRatesData)) } {
        ...
        let mut ratesLength: Value = get_array_length(&rawRates);
        {
            ...
            while { if !__for_first_333 { i = add(&i, &Value::Int(1)); } __for_first_333 = false; is_less_than(&i, &ratesLength) } {
