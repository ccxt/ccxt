        ...
        if !is_equal(&fullName, &Value::Null) && !is_equal(&name, &Value::Null) {
            ...
            if is_true(&isWrapped) {
                ...
                let mut nameWithoutU: Value = Value::Str("".to_string());
                {
                    ...
                    while { if !__for_first_755 { j = add(&j, &Value::Int(1)); } __for_first_755 = false; is_less_than(&j, &get_array_length(&parts)) } {
 ...
 */
    ...
    m
        ...
        let mut rawPromises: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_756 { i = add(&i, &Value::Int(1)); } __for_first_756 = false; is_less_than(&i, &get_array_length(&types)) } {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_757 { i = add(&i, &Value::Int(1)); } __for_first_757 = false; is_less_than(&i, &get_array_length(&promises)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_758 { i = add(&i, &Value::Int(1)); } __for_first_758 = false; is_less_than(&i, &get_array_length(&fetchDexes)) } {
    ...
    m
        ...
        if is_greater_than(&userProvidedDexesLength, &Value::Int(0)) {
            ...
            let mut fetchDexesLength: Value = get_array_length(&fetchDexes);
            {
                ...
                while { if !__for_first_759 { i = add(&i, &Value::Int(1)); } __for_first_759 = false; is_less_than(&i, &maxLimit) } {
    ...
    m
        ...
        let mut rawPromises: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_760 { i = add(&i, &Value::Int(1)); } __for_first_760 = false; is_less_than(&i, &get_array_length(&fetchDexesList)) } {
            let mut request: Value = Value::Map({
                let mut m = indexmap::IndexMap::new();
    ...
    m
            ...
            let mut result: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_761 { j = add(&j, &Value::Int(1)); } __for_first_761 = false; is_less_than(&j, &get_array_length(&universe)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_763 { i = add(&i, &Value::Int(1)); } __for_first_763 = false; is_less_than(&i, &get_array_length(&universe)) } {
 ...
 */
    ...
    m
        ...
        let mut markets: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_764 { i = add(&i, &Value::Int(1)); } __for_first_764 = false; is_less_than(&i, &get_array_length(&meta)) } {
    ...
    m
        ...
        if !is_equal(&balances, &Value::Null) {
            ...
            });
            {
                ...
                while { if !__for_first_765 { i = add(&i, &Value::Int(1)); } __for_first_765 = false; is_less_than(&i, &get_array_length(&balances)) } {
 ...
 */
    ...
    m
        ...
        });
        {
            ...
            while { if !__for_first_766 { i = add(&i, &Value::Int(1)); } __for_first_766 = false; is_less_than(&i, &get_array_length(&response)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_767 { i = add(&i, &Value::Int(1)); } __for_first_767 = false; is_less_than(&i, &get_array_length(&universe)) } {
 ...
 */
    ...
    m
        ...
        let mut ordersToBeParsed: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_768 { i = add(&i, &Value::Int(1)); } __for_first_768 = false; is_less_than(&i, &get_array_length(&statuses)) } {
 ...
 */
    ...
    m
        ...
        let mut orders: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_772 { i = add(&i, &Value::Int(1)); } __for_first_772 = false; is_less_than(&i, &get_array_length(&statuses)) } {
    ...
    m
        ...
        if !is_equal(&clientOrderId, &Value::Null) {
            ...
            add_element_to_object(&mut cancelAction, &Value::Str("type".to_string()), Value::Str("cancelByCloid".to_string()));
            {
                ...
                while { if !__for_first_773 { i = add(&i, &Value::Int(1)); } __for_first_773 = false; is_less_than(&i, &get_array_length(&clientOrderId)) } {
            ...
            add_element_to_object(&mut cancelAction, &Value::Str("type".to_string()), Value::Str("cancel".to_string()));
            {
                ...
                while { if !__for_first_774 { i = add(&i, &Value::Int(1)); } __for_first_774 = false; is_less_than(&i, &get_array_length(&ids)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_779 { i = add(&i, &Value::Int(1)); } __for_first_779 = false; is_less_than(&i, &get_array_length(&fundings)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_780 { i = add(&i, &Value::Int(1)); } __for_first_780 = false; is_less_than(&i, &get_array_length(&rawOrders)) } {
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_781 { i = add(&i, &Value::Int(1)); } __for_first_781 = false; is_less_than(&i, &get_array_length(&historicalOrders)) } {
 ...
 */
    ...
    pub fn get_dex_from_symbols(&self, mut methodName: Value, optional_args: &[Value]) -> Value {
        ...
        let mut dexName: Value = Value::Null;
        {
            ...
            while { if !__for_first_782 { i = add(&i, &Value::Int(1)); } __for_first_782 = false; is_less_than(&i, &symbolsLength) } {
            if is_equal(&dexName, &Value::Null) {
        ...
        if !is_equal(&vaultAddress, &Value::Null) {
            {
                ...
                while { if !__for_first_784 { i = add(&i, &Value::Int(1)); } __for_first_784 = false; is_less_than(&i, &get_array_length(&records)) } {
        ...
        if !is_equal(&vaultAddress, &Value::Null) {
            {
                ...
                while { if !__for_first_785 { i = add(&i, &Value::Int(1)); } __for_first_785 = false; is_less_than(&i, &get_array_length(&records)) } {
                let mut record: Value = get_value(&records, &i);
                let mut record: Value = get_value(&records, &i);
 ...
 */
    ...
    pub fn extract_type_from_delta(&self, optional_args: &[Value]) -> Value {
        ...
        let mut records: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_786 { i = add(&i, &Value::Int(1)); } __for_first_786 = false; is_less_than(&i, &get_array_length(&data)) } {
