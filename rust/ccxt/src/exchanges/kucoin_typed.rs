...
impl Kucoin {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(KucoinCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Kucoin {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Kucoin::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Kucoin::markets(self) }
}
