...
//
// Typed wrapper for bitmart.
//
// Owns a `Box<BitmartCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::bitmart::BitmartCore;
use crate::types::*;
...
pub struct Bitmart {
    ...
    core: std::pin::Pin<Box<BitmartCore>>,
}

impl Bitmart {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::pin(BitmartCore::new(config));
    ...
    pub fn from_core(core: BitmartCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut BitmartCore {
...
impl std::ops::Deref for Bitmart {
    type Target = BitmartCore;
