...
//
// Typed wrapper for gateio.
//
// Owns a `Box<GateioCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::gateio::GateioCore;
use crate::types::*;

pub struct Gateio {
    pub core: Box<GateioCore>,
}

impl Gateio {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(GateioCore::new(config));
    ...
    pub fn from_core(core: GateioCore) -> Self {
...
impl std::ops::Deref for Gateio {
    type Target = GateioCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Gateio {
