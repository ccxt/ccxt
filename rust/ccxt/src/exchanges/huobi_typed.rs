...
//
// Typed wrapper for huobi.
//
// Owns a `Box<HuobiCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::huobi::HuobiCore;
use crate::types::*;

pub struct Huobi {
    pub core: Box<HuobiCore>,
}

impl Huobi {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(HuobiCore::new(config));
    ...
    pub fn from_core(core: HuobiCore) -> Self {
...
impl std::ops::Deref for Huobi {
    type Target = HuobiCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Huobi {
