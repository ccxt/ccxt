...
impl Zaif {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(ZaifCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Zaif {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Zaif::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Zaif::markets(self) }
}
