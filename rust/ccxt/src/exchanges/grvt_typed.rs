...
impl Grvt {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(GrvtCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Grvt {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Grvt::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Grvt::markets(self) }
}
