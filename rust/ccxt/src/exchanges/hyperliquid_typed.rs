...
use crate::Value;
use crate::exchanges::hyperliquid::HyperliquidCore;
use crate::types::*;

pub struct Hyperliquid {
    pub core: Box<HyperliquidCore>,
}

impl Hyperliquid {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(HyperliquidCore::new(config));
...
impl std::ops::DerefMut for Hyperliquid {
