...
//
// Typed wrapper for oxfun.
//
// Owns a `Box<OxfunCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::oxfun::OxfunCore;
use crate::types::*;

pub struct Oxfun {
    pub core: Box<OxfunCore>,
}

impl Oxfun {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(OxfunCore::new(config));
    ...
    pub fn from_core(core: OxfunCore) -> Self {
...
impl std::ops::Deref for Oxfun {
    type Target = OxfunCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Oxfun {
