...
impl Gateeu {
    ...
    pub async fn fetch_currencies(&mut self, params: Value) -> crate::Result<Currencies> {
        let v = crate::runtime::call_typed(self.core_mut().call_dynamic("fetch_currencies", vec![params])).await?;
    ...
    pub async fn fetch_markets(&mut self, params: Value) -> crate::Result<Vec<Market>> {
        let v = crate::runtime::call_typed(self.core_mut().call_dynamic("fetch_markets", vec![params])).await?;
