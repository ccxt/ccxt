...
impl Bitflyer {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(BitflyerCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Bitflyer {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Bitflyer::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Bitflyer::markets(self) }
}
