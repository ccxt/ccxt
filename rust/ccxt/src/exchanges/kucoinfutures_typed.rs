...
impl Kucoinfutures {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(KucoinfuturesCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Kucoinfutures {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Kucoinfutures::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Kucoinfutures::markets(self) }
}
