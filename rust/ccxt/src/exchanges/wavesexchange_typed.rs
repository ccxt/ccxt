...
//
// Typed wrapper for wavesexchange.
//
// Owns a `Box<WavesexchangeCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::wavesexchange::WavesexchangeCore;
use crate::types::*;

pub struct Wavesexchange {
    pub core: Box<WavesexchangeCore>,
}

impl Wavesexchange {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(WavesexchangeCore::new(config));
    ...
    pub fn from_core(core: WavesexchangeCore) -> Self {
...
impl std::ops::Deref for Wavesexchange {
    type Target = WavesexchangeCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Wavesexchange {
