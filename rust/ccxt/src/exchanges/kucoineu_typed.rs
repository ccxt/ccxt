...
//
// Typed wrapper for kucoineu.
//
// Owns a `Box<KucoineuCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::kucoineu::KucoineuCore;
use crate::types::*;
...
pub struct Kucoineu {
    ...
    core: std::pin::Pin<Box<KucoineuCore>>,
}

impl Kucoineu {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::pin(KucoineuCore::new(config));
    ...
    pub fn from_core(core: KucoineuCore) -> Self {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut KucoineuCore {
...
impl std::ops::Deref for Kucoineu {
    type Target = KucoineuCore;
