 ...
 */
    ...
    pub fn get_closest_limit(&self, mut limit: Value) -> Value {
        ...
        let mut result: Value = Value::Int(1000);
        {
            ...
            while { if !__for_first_472 { i = add(&i, &Value::Int(1)); } __for_first_472 = false; is_less_than(&i, &get_array_length(&limits)) } {
            if is_equal(&limit, &Value::Null) {
 ...
 */
    ...
    pub fn parse_balance(&self, mut response: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_475 { i = add(&i, &Value::Int(1)); } __for_first_475 = false; is_less_than(&i, &get_array_length(&response)) } {
