...
//
// Typed wrapper for novadax.
//
// Owns a `Box<NovadaxCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::novadax::NovadaxCore;
use crate::types::*;

pub struct Novadax {
    pub core: Box<NovadaxCore>,
}

impl Novadax {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(NovadaxCore::new(config));
    ...
    pub fn from_core(core: NovadaxCore) -> Self {
...
impl std::ops::Deref for Novadax {
    type Target = NovadaxCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Novadax {
