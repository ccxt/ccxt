...
//
// Typed wrapper for coinmetro.
//
// Owns a `Box<CoinmetroCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::coinmetro::CoinmetroCore;
use crate::types::*;

pub struct Coinmetro {
    pub core: Box<CoinmetroCore>,
}

impl Coinmetro {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(CoinmetroCore::new(config));
    ...
    pub fn from_core(core: CoinmetroCore) -> Self {
...
impl std::ops::Deref for Coinmetro {
    type Target = CoinmetroCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Coinmetro {
