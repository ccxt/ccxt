...
//
// Typed wrapper for arkham.
//
// Owns a `Box<ArkhamCore>` and exposes the unified CCXT API
...
use crate::Value;
use crate::exchanges::arkham::ArkhamCore;
use crate::types::*;

pub struct Arkham {
    pub core: Box<ArkhamCore>,
}

impl Arkham {
    pub fn new(config: Option<Value>) -> Self {
        let mut core = Box::new(ArkhamCore::new(config));
    ...
    pub fn from_core(core: ArkhamCore) -> Self {
...
impl std::ops::Deref for Arkham {
    type Target = ArkhamCore;
    fn deref(&self) -> &Self::Target { &*self.core }
}

impl std::ops::DerefMut for Arkham {
