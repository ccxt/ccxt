...
impl Weex {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(WeexCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Weex {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Weex::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Weex::markets(self) }
}
