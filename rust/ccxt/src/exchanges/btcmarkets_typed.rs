...
impl Btcmarkets {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(BtcmarketsCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Btcmarkets {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Btcmarkets::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Btcmarkets::markets(self) }
}
