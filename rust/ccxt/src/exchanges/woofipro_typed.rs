...
impl Woofipro {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(WoofiproCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Woofipro {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Woofipro::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Woofipro::markets(self) }
}
