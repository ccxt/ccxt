...
impl GeminiCore {
    ...
    m
        ...
        m.insert("hostname".to_string(), Value::Str("api.gemini.com".to_string()));
 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("symbols".to_string(), Value::List(vec![to_upper(&get_value(&market, &Value::Str("id".to_string())))]));
    m
})]));
            m
        });
