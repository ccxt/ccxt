...
impl crate::exchange_generated::ExchangeBase for BitmartCore {
 ...
 */
    ...
    pub fn parse_ws_order(&self, mut order: Value, optional_args: &[Value]) -> Value {
        ...
        if is_true(&isSpot) {
            ...
            let mut status: Value = self.parent.parse_order_status_by_type(get_value(&market, &Value::Str("type".to_string())), rawState.clone());
