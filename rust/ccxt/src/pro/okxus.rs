...
pub struct OkxusCore {
    pub parent: crate::pro::okx::OkxCore,
}

impl OkxusCore {
    pub fn new(config: Option<crate::Value>) -> Self {
        let mut s = Self { parent: crate::pro::okx::OkxCore::new(config) };
        s.init();
        s
    }
    ...
    pub fn init(&mut self) {
        ...
        let described = OkxusCore::describe(self);
    ...
    pub fn bind(&mut self) {
        ...
        self.exchange.bind_call_async(core_ptr, OkxusCore::__call_dynamic_dispatch);
    }
...
impl crate::exchange::DerivedExchange for OkxusCore {
...
impl std::ops::Deref for OkxusCore {
    type Target = crate::pro::okx::OkxCore;
    fn deref(&self) -> &Self::Target { &self.parent }
}

impl std::ops::DerefMut for OkxusCore {
