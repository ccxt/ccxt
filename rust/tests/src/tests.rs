...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
            ...
            if is_greater_than_or_equal(&get_array_length(&possibleMethodNames), &Value::Int(1)) {
                {
                    ...
                    while { if !__for_first_1492 { i = add(&i, &Value::Int(1)); } __for_first_1492 = false; is_less_than(&i, &get_array_length(&testFileNames)) } {
                    let mut testFileName: Value = get_value(&testFileNames, &i);
                    {
                                                let mut j: Value = Value::Int(0);
                        let mut __for_first_1491: bool = true;
                        while { if !__for_first_1491 { j = add(&j, &Value::Int(1)); } __for_first_1491 = false; is_less_than(&j, &get_array_length(&possibleMethodNames)) } {
    ...
    pub fn load_credentials_from_env(&self, mut exchange: Value) {
        ...
        let mut objkeys: Value = object_keys(&reqCreds);
        {
            ...
            while { if !__for_first_1493 { i = add(&i, &Value::Int(1)); } __for_first_1493 = false; is_less_than(&i, &get_array_length(&objkeys)) } {
    ...
    pub fn expand_settings(&mut self, mut exchange: Value) {
        ...
        if !is_equal(&exchangeSettings, &Value::Null) {
            let mut settingKeys: Value = object_keys(&exchangeSettings);
            {
                ...
                while { if !__for_first_1494 { i = add(&i, &Value::Int(1)); } __for_first_1494 = false; is_less_than(&i, &get_array_length(&settingKeys)) } {
        ...
        if is_greater_than(&missingSpace, &Value::Int(0)) {
            {
                ...
                while { if !__for_first_1495 { i = add(&i, &Value::Int(1)); } __for_first_1495 = false; is_less_than(&i, &missingSpace) } {
    ...
    pub fn get_skips(&self, mut exchange: Value, mut methodName: Value) -> Value {
        ...
        let mut methodNames: Value = Value::List(vec![methodName.clone(), add(&add(&methodName, &Value::Str(".".to_string())), &self.ext)]);
        {
            ...
            while { if !__for_first_1496 { i = add(&i, &Value::Int(1)); } __for_first_1496 = false; is_less_than(&i, &get_array_length(&methodNames)) } {
        ...
        let mut objectNames: Value = object_keys(&objectSkips);
        {
            ...
            while { if !__for_first_1497 { i = add(&i, &Value::Int(1)); } __for_first_1497 = false; is_less_than(&i, &get_array_length(&objectNames)) } {
    ...
    pub async fn test_safe(&mut self, mut methodName: Value, mut exchange: Value, optional_args: &[Value]) -> Value {
        ...
        let mut argsStringified: Value = exchange.json(args.clone()); // args.join() breaks when we provide a list of symbols or multidimensional array; "args.to_string()" breaks bcz of "array to string conversion"
        {
            ...
            while { if !__for_first_1498 { i = add(&i, &Value::Int(1)); } __for_first_1498 = false; is_less_than(&i, &maxRetries) } {
            let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
...
match _try_result { Ok(__try_ok) => { if !matches!(__try_ok, Value::Null) { return __try_ok; } return Value::Null; } Err(_try_err) => { let ex: Value = panic_to_value(_try_err); 
    ...
    pub async fn run_tests(&mut self, mut exchange: Value, mut tests: Value, mut isPublicTest: Value) -> Value {
        ...
        let mut promises: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1499 { i = add(&i, &Value::Int(1)); } __for_first_1499 = false; is_less_than(&i, &get_array_length(&testNames)) } {
    ...
    pub fn get_test_symbol(&self, mut exchange: Value, mut isSpot: Value, mut symbols: Value) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_1501 { i = add(&i, &Value::Int(1)); } __for_first_1501 = false; is_less_than(&i, &get_array_length(&symbols)) } {
    ...
    pub fn get_exchange_code(&self, mut exchange: Value, optional_args: &[Value]) -> Value {
        ...
        let mut code: Value = get_value(&codes, &Value::Int(0));
        {
            ...
            while { if !__for_first_1502 { i = add(&i, &Value::Int(1)); } __for_first_1502 = false; is_less_than(&i, &get_array_length(&codes)) } {
    ...
    pub fn get_markets_from_exchange(&self, mut exchange: Value, optional_args: &[Value]) -> Value {
        ...
        let mut keys: Value = object_keys(&markets);
        {
            ...
            while { if !__for_first_1503 { i = add(&i, &Value::Int(1)); } __for_first_1503 = false; is_less_than(&i, &get_array_length(&keys)) } {
    ...
    pub fn get_valid_symbol(&self, mut exchange: Value, optional_args: &[Value]) -> Value {
        ...
        if is_equal(&symbol, &Value::Null) {
            ...
            let mut activeSymbols: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_1505 { i = add(&i, &Value::Int(1)); } __for_first_1505 = false; is_less_than(&i, &get_array_length(&activeMarkets)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
        ...
        let mut tickerSymbols: Value = object_keys(&tickers);
        {
            ...
            while { if !__for_first_1506 { i = add(&i, &Value::Int(1)); } __for_first_1506 = false; is_less_than(&i, &get_array_length(&tickerSymbols)) } {
    ...
    pub async fn run_prediction_tests(&mut self, mut exchange: Value) -> Value {
        ...
        if !is_equal(&outcomeSymbol, &Value::Null) {
            ...
            let mut pinnedKeys: Value = object_keys(&get_value(&exchange, &Value::Str("markets".to_string())));
            {
                ...
                while { if !__for_first_1508 { i = add(&i, &Value::Int(1)); } __for_first_1508 = false; is_less_than(&i, &get_array_length(&pinnedKeys)) } {
                ...
                let mut pinnedOutcomes: Value = exchange.safe_list(pinnedMarket.clone(), Value::Str("outcomes".to_string()), &[Value::List(vec![])]);
                {
                    ...
                    while { if !__for_first_1507 { j = add(&j, &Value::Int(1)); } __for_first_1507 = false; is_less_than(&j, &get_array_length(&pinnedOutcomes)) } {
        ...
        if is_equal(&outcomeSymbol, &Value::Null) {
            let mut marketKeys: Value = object_keys(&get_value(&exchange, &Value::Str("markets".to_string())));
            {
                ...
                while { if !__for_first_1509 { i = add(&i, &Value::Int(1)); } __for_first_1509 = false; is_less_than(&i, &get_array_length(&marketKeys)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
                ...
                let mut extraScopesLength: Value = get_array_length(&extraScopes);
                {
                    ...
                    while { if !__for_first_1510 { si = add(&si, &Value::Int(1)); } __for_first_1510 = false; is_less_than(&si, &extraScopesLength) } {
                ...
                let mut scopesToTestLength: Value = get_array_length(&scopesToTest);
                {
                    ...
                    while { if !__for_first_1511 { sj = add(&sj, &Value::Int(1)); } __for_first_1511 = false; is_less_than(&sj, &scopesToTestLength) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn assert_prediction_events(&self, mut exchange: Value, mut events: Value) -> Value {
        ...
        let mut eventsLength: Value = get_array_length(&events);
        {
            ...
            while { if !__for_first_1512 { i = add(&i, &Value::Int(1)); } __for_first_1512 = false; is_less_than(&i, &eventsLength) } {
    ...
    pub fn assert_prediction_event(&self, mut exchange: Value, mut event: Value) -> Value {
        ...
        assert(Value::Bool(is_equal(&exchange.safe_string(event.clone(), Value::Str("symbol".to_string()), &[]), &Value::Null)), &[add(&add(&get_value(&exchange, &Value::Str("id".to_string())), &Value::Str(" event must not carry the deprecated symbol key".to_string())), &logText)]);
        {
            ...
            while { if !__for_first_1514 { i = add(&i, &Value::Int(1)); } __for_first_1514 = false; is_less_than(&i, &marketsLength) } {
            ...
            let mut outcomesLength: Value = get_array_length(&outcomes);
            {
                ...
                while { if !__for_first_1513 { j = add(&j, &Value::Int(1)); } __for_first_1513 = false; is_less_than(&j, &outcomesLength) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub async fn test_proxies(&mut self, mut exchange: Value) -> Value {
        ...
        let mut exceptionMessageString: Value = Value::Null;
        {
            ...
            while { if !__for_first_1515 { j = add(&j, &Value::Int(1)); } __for_first_1515 = false; is_less_than(&j, &maxRetries) } {
            let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
...
match _try_result { Ok(__try_ok) => { if !matches!(__try_ok, Value::Null) { return __try_ok; } return Value::Null; } Err(_try_err) => { let e: Value = panic_to_value(_try_err); 
    ...
    pub fn load_static_data(&self, mut folder: Value, optional_args: &[Value]) -> Value {
        ...
        let mut files: Value = ioDirRead(folder.clone());
        {
            ...
            while { if !__for_first_1516 { i = add(&i, &Value::Int(1)); } __for_first_1516 = false; is_less_than(&i, &get_array_length(&files)) } {
    ...
    pub fn remove_hostnamefrom_url(&self, mut url: Value) -> Value {
        ...
        let mut res: Value = Value::Str("".to_string());
        {
            ...
            while { if !__for_first_1517 { i = add(&i, &Value::Int(1)); } __for_first_1517 = false; is_less_than(&i, &get_array_length(&urlParts)) } {
    ...
    pub fn urlencoded_to_dict(&self, mut url: Value) -> Value {
        ...
        let mut parts: Value = split(&url, &Value::Str("&".to_string()));
        {
            ...
            while { if !__for_first_1518 { i = add(&i, &Value::Int(1)); } __for_first_1518 = false; is_less_than(&i, &get_array_length(&parts)) } {
    ...
    pub fn is_vacant_value(&self, mut exchange: Value, mut value: Value) -> Value {
        ...
        if is_true(&Value::Bool(is_array(&value))) {
            {
                ...
                while { if !__for_first_1519 { i = add(&i, &Value::Int(1)); } __for_first_1519 = false; is_less_than(&i, &get_array_length(&value)) } {
        ...
        if is_true(&exchange.is_dictionary(value.clone())) {
            let mut keys: Value = object_keys(&value);
            {
                ...
                while { if !__for_first_1520 { i = add(&i, &Value::Int(1)); } __for_first_1520 = false; is_less_than(&i, &get_array_length(&keys)) } {
    ...
    pub fn assert_new_and_stored_output_inner(&self, mut exchange: Value, mut skipKeys: Value, mut newOutput: Value, mut storedOutput: Value, optional_args: &[Value]) -> Value {
        ...
        if is_true(&exchange.is_dictionary(storedOutput.clone())) && is_true(&exchange.is_dictionary(newOutput.clone())) {
            ...
            self.assert_static_error(Value::Bool(is_equal(&storedKeysLength, &newKeysLength)), Value::Str("output length mismatch".to_string()), storedOutput.clone(), newOutput.clone(), &[]);
            {
                ...
                while { if !__for_first_1522 { i = add(&i, &Value::Int(1)); } __for_first_1522 = false; is_less_than(&i, &get_array_length(&storedOutputKeys)) } {
            ...
            self.assert_static_error(Value::Bool(is_equal(&storedArrayLength, &newArrayLength)), Value::Str("output length mismatch".to_string()), storedOutput.clone(), newOutput.clone(), &[]);
            {
                ...
                while { if !__for_first_1523 { i = add(&i, &Value::Int(1)); } __for_first_1523 = false; is_less_than(&i, &get_array_length(&storedOutput)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn sanitize_data_input(&self, mut input: Value) -> Value {
        ...
        let mut newInput: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_1524 { i = add(&i, &Value::Int(1)); } __for_first_1524 = false; is_less_than(&i, &get_array_length(&input)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    m
                ...
                let mut storedHeaderKeys: Value = object_keys(&storedHeaders);
                {
                    ...
                    while { if !__for_first_1525 { i = add(&i, &Value::Int(1)); } __for_first_1525 = false; is_less_than(&i, &get_array_length(&storedHeaderKeys)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub async fn inject_ws_messages(&mut self, mut exchange: Value, mut url: Value, mut messages: Value, optional_args: &[Value]) -> Value {
        let mut sequential = get_arg(optional_args, 0, Value::Bool(false));
        {
            ...
            while { if !__for_first_1526 { i = add(&i, &Value::Int(1)); } __for_first_1526 = false; is_less_than(&i, &get_array_length(&messages)) } {
        ...
        let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
            {
                ...
                while { if !__for_first_1527 { i = add(&i, &Value::Int(1)); } __for_first_1527 = false; is_less_than(&i, &get_array_length(&expectedResults)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn assert_ws_sent_messages(&self, mut exchange: Value, mut url: Value, mut data: Value) {
        ...
        assert(Value::Bool(is_equal(&sentLength, &expectedLength)), &[add(&add(&add(&add(&add(&Value::Str("sent ws messages count mismatch: sent ".to_string()), &to_string_val(&sentLength)), &Value::Str(", expected ".to_string())), &to_string_val(&expectedLength)), &Value::Str(" ".to_string())), &jsonStringify(sentMessages.clone()))]);
        {
            ...
            while { if !__for_first_1528 { i = add(&i, &Value::Int(1)); } __for_first_1528 = false; is_less_than(&i, &expectedLength) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    m
        ...
        let mut methodsNames: Value = object_keys(&methods);
        {
            ...
            while { if !__for_first_1530 { i = add(&i, &Value::Int(1)); } __for_first_1530 = false; is_less_than(&i, &get_array_length(&methodsNames)) } {
            ...
            let mut results: Value = get_value(&methods, &method);
            {
                ...
                while { if !__for_first_1529 { j = add(&j, &Value::Int(1)); } __for_first_1529 = false; is_less_than(&j, &get_array_length(&results)) } {
    ...
    m
        ...
        if !is_equal(&predictionEvents, &Value::Null) {
            let mut eventMarkets: Value = Value::List(vec![]);
            {
                ...
                while { if !__for_first_1532 { i = add(&i, &Value::Int(1)); } __for_first_1532 = false; is_less_than(&i, &get_array_length(&predictionEvents)) } {
                let mut evMarkets: Value = exchange.safe_list(get_value(&predictionEvents, &i), Value::Str("markets".to_string()), &[Value::List(vec![])]);
                {
                    ...
                    while { if !__for_first_1531 { j = add(&j, &Value::Int(1)); } __for_first_1531 = false; is_less_than(&j, &get_array_length(&evMarkets)) } {
    ...
    pub async fn test_exchange_request_statically(&mut self, mut exchangeName: Value, mut exchangeData: Value, optional_args: &[Value]) -> Value {
        ...
        let mut methodsNames: Value = object_keys(&methods);
        {
            ...
            while { if !__for_first_1534 { i = add(&i, &Value::Int(1)); } __for_first_1534 = false; is_less_than(&i, &get_array_length(&methodsNames)) } {
            let mut method: Value = get_value(&methodsNames, &i);
            let mut results: Value = get_value(&methods, &method);
            {
                                let mut j: Value = Value::Int(0);
                let mut __for_first_1533: bool = true;
                while { if !__for_first_1533 { j = add(&j, &Value::Int(1)); } __for_first_1533 = false; is_less_than(&j, &get_array_length(&results)) } {
                let mut result: Value = get_value(&results, &j);
    ...
    pub async fn run_static_tests(&mut self, mut type_var: Value, optional_args: &[Value]) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_1538 { i = add(&i, &Value::Int(1)); } __for_first_1538 = false; is_less_than(&i, &get_array_length(&exchanges)) } {
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
        ...
        let mut batchOrders: Value = get_value(&createOrdersRequest, &Value::Str("batchOrders".to_string()));
        {
            ...
            while { if !__for_first_1539 { i = add(&i, &Value::Int(1)); } __for_first_1539 = false; is_less_than(&i, &get_array_length(&batchOrders)) } {
