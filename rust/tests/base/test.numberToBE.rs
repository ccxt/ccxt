...
pub fn testNumberToBE() {
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(resultBase64.as_str() == expectedBase64.as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result2.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary2.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result3.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary3.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result4.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary4.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result5.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary5.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result6.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary6.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result7.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary7.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result8.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary8.clone(), &[]).as_str()))));
    ...
    assert!(ccxt::runtime::is_true(&(Value::Bool(exchange.binary_to_base64(result9.clone(), &[]).as_str() == exchange.binary_to_base64(expectedBinary9.clone(), &[]).as_str()))));
    // @SKIP_END_GO
