...
pub fn testNumberToBE() {
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result1.clone()), &padding1))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&resultBase64, &expectedBase64))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result2.clone()), &Value::Int(1)))));
    let mut expectedBinary2: Value = exchange.base16_to_binary(Value::Str("00".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result2.clone()), &exchange.binary_to_base64(expectedBinary2.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result3.clone()), &Value::Int(1)))));
    let mut expectedBinary3: Value = exchange.base16_to_binary(Value::Str("01".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result3.clone()), &exchange.binary_to_base64(expectedBinary3.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result4.clone()), &Value::Int(1)))));
    let mut expectedBinary4: Value = exchange.base16_to_binary(Value::Str("ff".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result4.clone()), &exchange.binary_to_base64(expectedBinary4.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result5.clone()), &Value::Int(2)))));
    let mut expectedBinary5: Value = exchange.base16_to_binary(Value::Str("0100".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result5.clone()), &exchange.binary_to_base64(expectedBinary5.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result6.clone()), &Value::Int(4)))));
    let mut expectedBinary6: Value = exchange.base16_to_binary(Value::Str("00000001".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result6.clone()), &exchange.binary_to_base64(expectedBinary6.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result7.clone()), &Value::Int(8)))));
    let mut expectedBinary7: Value = exchange.base16_to_binary(Value::Str("0000000000000000".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result7.clone()), &exchange.binary_to_base64(expectedBinary7.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result8.clone()), &Value::Int(4)))));
    let mut expectedBinary8: Value = exchange.base16_to_binary(Value::Str("ffffffff".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result8.clone()), &exchange.binary_to_base64(expectedBinary8.clone())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_length(result9.clone()), &Value::Int(4)))));
    let mut expectedBinary9: Value = exchange.base16_to_binary(Value::Str("01020304".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base64(result9.clone()), &exchange.binary_to_base64(expectedBinary9.clone())))));
    // @SKIP_END_GO
