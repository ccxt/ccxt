...
pub fn testBase58ToBinary() {
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base58(binary1.clone()), &b58_1))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_base58(binary7.clone()), &b58_7))));
    // @SKIP_END_GO
