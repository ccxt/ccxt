...
pub fn testClone() {
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&simpleClone, &Value::Str("x".to_string())), &Value::Int(1)))));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&simpleClone, &Value::Str("y".to_string())), &Value::Str("hello".to_string())))));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&simpleClone, &Value::Str("z".to_string())), &Value::Null))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&simpleOrig, &Value::Str("x".to_string())), &Value::Int(1)))));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&simpleOrig, &Value::Str("y".to_string())), &Value::Str("hello".to_string())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&simpleClone, &Value::Str("x".to_string())), &Value::Int(999)))));
    // -------------------------------------------------------------------------
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&nestedOrig, &Value::Str("top".to_string())), &Value::Str("original".to_string())))));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&nestedClone, &Value::Str("top".to_string())), &Value::Str("cloned".to_string())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_array_length(&object_keys(&emptyClone)), &Value::Int(0)))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&emptyClone, &Value::Str("newKey".to_string())), &Value::Str("injected".to_string())))));
    // -------------------------------------------------------------------------
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&undefClone, &Value::Str("present".to_string())), &Value::Str("yes".to_string())))));
    assert!(ccxt::runtime::is_true(&(Value::Bool(in_op(&undefClone, &Value::Str("absent".to_string()))))));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&undefClone, &Value::Str("absent".to_string())), &Value::Null))));
    // mutate clone – original untouched
    add_element_to_object(&mut undefClone, &Value::Str("present".to_string()), Value::Str("no".to_string()));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&withUndef, &Value::Str("present".to_string())), &Value::Str("yes".to_string())))));
    // -------------------------------------------------------------------------
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&masterOrig, &Value::Str("a".to_string())), &Value::Int(1)))));
    assert!(ccxt::runtime::is_true(&(!is_true(&(Value::Bool(in_op(&masterOrig, &Value::Str("d".to_string()))))))));
    // second independent clone from the still-pristine original
    let mut clone2: Value = exchange.clone(masterOrig.clone());
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&clone2, &Value::Str("a".to_string())), &Value::Int(1)))));
    assert!(ccxt::runtime::is_true(&(!is_true(&(Value::Bool(in_op(&clone2, &Value::Str("d".to_string()))))))));
    // mutate clone2 differently
    add_element_to_object(&mut clone2, &Value::Str("b".to_string()), Value::Int(200));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&clone1, &Value::Str("b".to_string())), &Value::Int(2)))));
    assert!(ccxt::runtime::is_true(&(is_equal(&get_value(&masterOrig, &Value::Str("b".to_string())), &Value::Int(2)))));
}