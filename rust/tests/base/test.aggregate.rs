...
pub fn testAggregate() {
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("aggregate".to_string()).clone(), exchange.aggregate(Value::from(vec![])).clone(), Value::from(vec![]).clone()]);
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result1.clone(), Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.51)]), Value::from(vec![Value::Float(101.5), Value::Float(2.01)])]).clone()]);
    // Test 2: With extra fields (should be ignored)
    let mut result2: Value = exchange.aggregate(Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.01), Value::Str("extra".to_string())]), Value::from(vec![Value::Float(101.5), Value::Float(2.01), Value::Str("data".to_string()), Value::Str("more".to_string())])]));
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result2.clone(), Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.01)]), Value::from(vec![Value::Float(101.5), Value::Float(2.01)])]).clone()]);
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result3.clone(), Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.01)]), Value::from(vec![Value::Float(102.4), Value::Float(2.01)])]).clone()]);
    // Test 4: Empty array
    let mut result4: Value = exchange.aggregate(Value::from(vec![]));
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result4.clone(), Value::from(vec![]).clone()]);
    // Test 5: Single entry
    let mut result5: Value = exchange.aggregate(Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.01)])]));
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result5.clone(), Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.01)])]).clone()]);
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result6.clone(), Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(1.02)])]).clone()]);
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result7.clone(), Value::from(vec![]).clone()]);
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result9.clone(), Value::from(vec![Value::from(vec![Value::Float(100.5), Value::Float(3.08)]), Value::from(vec![Value::Float(101.5), Value::Float(1.05)])]).clone()]);
    ...
    crate::tests_support::shared::assert_deep_equal(&exchange.clone_self(), &[Value::Null.clone(), Value::Str("testAggregate".to_string()).clone(), result10.clone(), Value::from(vec![Value::from(vec![Value::Float(100.2), Value::Float(3.08)])]).clone()]);
    // @SKIP_END_GO
