...
pub fn testBinaryConcat() {
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_string(result1.clone()), &Value::Str("hello world".to_string())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_string(result2.clone()), &Value::Str("foobarbaz".to_string())))));
    ...
    assert!(ccxt::runtime::is_true(&(is_equal(&exchange.binary_to_string(result3.clone()), &Value::Str("hello world".to_string())))));
}