...
pub fn testWsCache() {
    ...
    let mut cacheSymbolId5 = ArrayCacheBySymbolById::new(Value::Int(5));
    {
        ...
        while { if !__for_first_1414 { i = add(&i, &Value::Int(1)); } __for_first_1414 = false; is_less_than(&i, &Value::Int(11)) } {
...
})])))));
    {
        ...
        while { if !__for_first_1415 { i = add(&i, &Value::Int(1)); } __for_first_1415 = false; is_less_than(&i, &Value::Int(11)) } {
        cacheSymbolId5.append(Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("symbol".to_string(), Value::Str("BTC/USDT".to_string()));
                m.insert("id".to_string(), to_string_val(&i));
...
})])))));
    {
        ...
        while { if !__for_first_1416 { i = add(&i, &Value::Int(1)); } __for_first_1416 = false; is_less_than(&i, &Value::Int(33)) } {
        cacheSymbolId5.append(Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("symbol".to_string(), Value::Str("BTC/USDT".to_string()));
                m.insert("id".to_string(), to_string_val(&i));
    ...
    initialLength = Value::Int(5);
    {
        ...
        while { if !__for_first_1419 { i = add(&i, &Value::Int(1)); } __for_first_1419 = false; is_less_than(&i, &initialLength) } {
    ...
    appendItemsLength = Value::Int(3);
    {
        ...
        while { if !__for_first_1420 { i = add(&i, &Value::Int(1)); } __for_first_1420 = false; is_less_than(&i, &appendItemsLength) } {
    ...
    let mut cacheTimestampLimited = ArrayCacheByTimestamp::new(Value::Int(3));
    {
        ...
        while { if !__for_first_1423 { i = add(&i, &Value::Int(1)); } __for_first_1423 = false; is_less_than(&i, &Value::Int(7)) } {
    ...
    let mut cacheEvictBuckets = ArrayCacheBySymbolById::new(Value::Int(3));
    {
        ...
        while { if !__for_first_1424 { i = add(&i, &Value::Int(1)); } __for_first_1424 = false; is_less_than(&i, &Value::Int(10)) } {
