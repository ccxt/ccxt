...
pub fn testWsCache() {
...
})])))));
    {
        ...
        while { if !__for_first_1420 { i = add(&i, &Value::Int(1)); } __for_first_1420 = false; is_less_than(&i, &Value::Int(11)) } {
        cacheSymbolId5.append(Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("symbol".to_string(), Value::Str("BTC/USDT".to_string()));
                m.insert("id".to_string(), to_string_val(&i));
...
})])))));
    {
        ...
        while { if !__for_first_1421 { i = add(&i, &Value::Int(1)); } __for_first_1421 = false; is_less_than(&i, &Value::Int(33)) } {
        cacheSymbolId5.append(Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("symbol".to_string(), Value::Str("BTC/USDT".to_string()));
                m.insert("id".to_string(), to_string_val(&i));
    ...
    let mut initialLength: Value = Value::Int(5);
    {
        ...
        while { if !__for_first_1422 { i = add(&i, &Value::Int(1)); } __for_first_1422 = false; is_less_than(&i, &initialLength) } {
    ...
    let mut appendItemsLength: Value = Value::Int(3);
    {
        ...
        while { if !__for_first_1423 { i = add(&i, &Value::Int(1)); } __for_first_1423 = false; is_less_than(&i, &appendItemsLength) } {
    ...
    initialLength = Value::Int(5);
    {
        ...
        while { if !__for_first_1424 { i = add(&i, &Value::Int(1)); } __for_first_1424 = false; is_less_than(&i, &initialLength) } {
    ...
    appendItemsLength = Value::Int(3);
    {
        ...
        while { if !__for_first_1425 { i = add(&i, &Value::Int(1)); } __for_first_1425 = false; is_less_than(&i, &appendItemsLength) } {
    ...
    initialLength = Value::Int(5);
    {
        ...
        while { if !__for_first_1426 { i = add(&i, &Value::Int(1)); } __for_first_1426 = false; is_less_than(&i, &initialLength) } {
    ...
    appendItemsLength = Value::Int(3);
    {
        ...
        while { if !__for_first_1427 { i = add(&i, &Value::Int(1)); } __for_first_1427 = false; is_less_than(&i, &appendItemsLength) } {
    ...
    let mut cacheTimestampLimited = ArrayCacheByTimestamp::new(Value::Int(3));
    {
        ...
        while { if !__for_first_1428 { i = add(&i, &Value::Int(1)); } __for_first_1428 = false; is_less_than(&i, &Value::Int(7)) } {
    ...
    let mut cacheEvictBuckets = ArrayCacheBySymbolById::new(Value::Int(3));
    {
        ...
        while { if !__for_first_1429 { i = add(&i, &Value::Int(1)); } __for_first_1429 = false; is_less_than(&i, &Value::Int(10)) } {
