...
impl BybitidCore {
    ...
    m
        ...
        m.insert("trade".to_string(), Value::Str("wss://stream.{hostname}/v5/trade".into()));
    m
}));
    m
}));
    ...
    m
        ...
        m.insert("trade".to_string(), Value::Str("wss://stream-testnet.{hostname}/v5/trade".into()));
    m
}));
    m
}));
    ...
    m
        ...
        m.insert("trade".to_string(), Value::Str("wss://stream-demo.{hostname}/v5/trade".into()));
    m
}));
    m
}));
