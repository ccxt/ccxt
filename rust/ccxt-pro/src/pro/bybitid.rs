...
impl BybitidCore {
    ...
    pub fn init(&mut self) {
        let described = BybitidCore::describe(self);
...
impl crate::exchange::DerivedExchange for BybitidCore {
...
impl crate::exchange_generated::ExchangeBase for BybitidCore {
...
impl BybitidCore {
    pub fn describe(&self) -> Value {
        ...
        let mut restInstance = crate::exchanges::bybitid::BybitidCore::new(None);
    ...
    m
        ...
        m.insert("trade".to_string(), Value::Str("wss://stream.{hostname}/v5/trade".to_string()));
    m
}));
    m
}));
    ...
    m
        ...
        m.insert("trade".to_string(), Value::Str("wss://stream-testnet.{hostname}/v5/trade".to_string()));
    m
}));
    m
}));
    ...
    m
        ...
        m.insert("trade".to_string(), Value::Str("wss://stream-demo.{hostname}/v5/trade".to_string()));
    m
}));
    m
}));
