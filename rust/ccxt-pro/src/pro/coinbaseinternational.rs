    ...
    m
        ...
        if symbolsLength > ((1i64) as f64) {
            ...
            productIds = marketIds;
            {
                ...
                append_to_array(&mut messageHashes, Value::Str(format!("{}{}", Value::Str(format!("{}{}", name, Value::Str("::".to_string()))), get_value(&parsedSymbols, &i))));
            }
            }
        }  else if (symbolsLength == 1.0) {
            market = self.market(symbols.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null));
            messageHash = Value::Str(format!("{}{}", Value::Str(format!("{}{}", name, Value::Str("::".to_string()))), market.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null)));
        ...
        let mut signature: Value = self.hmac(self.encode(auth), self.base64_to_binary(self.secret.clone(), &[]), Value::Str("sha256".to_string()), &[Value::Str("base64".to_string())]);
        ...
        if (productIds != Value::Null) {
            add_element_to_object(&mut subscribe, &Value::Str("product_ids".to_string()), productIds);
        }
        if symbolsLength > ((1i64) as f64) {
 ...
 */
    ...
    m
        ...
        return self.subscribe(Value::Str("RISK".to_string()), &[Value::from(vec![symbol]), params]).await;
 ...
 */
    ...
    m
        ...
        let mut fundingRate: Value = self.subscribe_multiple(Value::Str("RISK".to_string()), &[symbols.clone(), params]).await;
        ...
        return self.filter_by_array(self.fundingRates.clone(), Value::Str("symbol".to_string()), &[symbols]);
 ...
 */
    ...
    m
        ...
        { let __destr_tmp = self.handle_option_and_params(params.clone(), Value::Str("watchTicker".to_string()), Value::Str("channel".to_string()), &[Value::Str("LEVEL1".to_string())]); channel = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
 ...
 */
    ...
    pub fn handle_instrument(&self, mut client: Value, mut message: Value) {
        ...
        client.resolve(&[ticker.clone(), Value::Str(format!("{}{}", Value::Str(format!("{}{}", channel, Value::Str("::".to_string()))), ticker.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null)))]);
}
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("quoteVolume".to_string(), self.safe_string2(ticker, Value::Str("total_24_hour_volume".to_string()), Value::Str("total24_hour_volume".to_string()), &[]));
    m
}), &[]);
 ...
 */
    ...
    m
        ...
        let mut trades: Value = self.subscribe_multiple(Value::Str("MATCH".to_string()), &[symbols, params]).await;
        if is_true(&self.newUpdates) {
    ...
    pub fn handle_trade(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        client.resolve(&[tradesArray, Value::Str(format!("{}{}", Value::Str(format!("{}{}", channel, Value::Str("::".to_string()))), trade.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null)))]);
        return message;
 ...
 */
    ...
    m
        ...
        return self.subscribe_multiple(Value::Str("LEVEL2".to_string()), &[symbols, params]).await;
    ...
    m
        ...
        add_element_to_object(&mut orderbook, &Value::Str("nonce".to_string()), self.safe_integer_k(message, "sequence", &[]));
        add_element_to_object(&mut orderbook, &Value::Str("datetime".to_string()), datetime.clone());
        add_element_to_object(&mut orderbook, &Value::Str("timestamp".to_string()), self.parse8601(datetime));
        add_element_to_object(&mut self.orderbooks, &symbol, orderbook.clone());
        client.resolve(&[orderbook, Value::Str(format!("{}{}", Value::Str(format!("{}{}", channel, Value::Str("::".to_string()))), symbol))]);
}
    ...
    pub fn handle_funding_rate(&mut self, mut client: Value, mut message: Value) {
        ...
        client.resolve(&[fundingRate.clone(), Value::Str(format!("{}{}", Value::Str(format!("{}{}", channel, Value::Str("::".to_string()))), fundingRate.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null)))]);
}
    ...
    pub fn handle_error_message(&self, mut client: Value, mut message: Value) -> Value {
        ...
        let _try_result = std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
            let mut feedback: Value = Value::Str(format!("{}{}", Value::Str(format!("{}{}", Value::Str(format!("{}{}", self.id.clone(), Value::Str(" ".to_string()))), errMsg)), reason));
