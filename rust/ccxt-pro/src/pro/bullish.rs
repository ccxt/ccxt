 ...
 */
    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut tradesArray: Value = get_value(&self.trades, &symbol);
        {
            ...
            while { if !__for_first_195 { i = add(&i, &Value::Int(1)); } __for_first_195 = false; is_less_than(&i, &get_array_length(&trades)) } {
 ...
 */
    ...
    pub fn separate_bids_or_asks(&self, mut entry: Value) -> Value {
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_196 { i = add(&i, &Value::Int(1)); } __for_first_196 = false; is_less_than(&i, &get_array_length(&entry)) } {
    ...
    pub fn handle_orders(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_greater_than(&numRawOrders, &Value::Int(0)) {
            ...
            });
            {
                ...
                while { if !__for_first_197 { i = add(&i, &Value::Int(1)); } __for_first_197 = false; is_less_than(&i, &get_array_length(&rawOrders)) } {
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_greater_than(&numRawTrades, &Value::Int(0)) {
            ...
            });
            {
                ...
                while { if !__for_first_199 { i = add(&i, &Value::Int(1)); } __for_first_199 = false; is_less_than(&i, &get_array_length(&rawTrades)) } {
            ...
            let mut keys: Value = object_keys(&symbols);
            {
                ...
                while { if !__for_first_200 { i = add(&i, &Value::Int(1)); } __for_first_200 = false; is_less_than(&i, &get_array_length(&keys)) } {
                let mut hashSymbol: Value = get_value(&keys, &i);
                let mut hashSymbol: Value = get_value(&keys, &i);
                let mut symbolMessageHash: Value = add(&add(&messageHash, &Value::Str("::".to_string())), &hashSymbol);
 ...
 */
    ...
    pub fn handle_positions(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut newPositions: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_201 { i = add(&i, &Value::Int(1)); } __for_first_201 = false; is_less_than(&i, &get_array_length(&rawPositions)) } {
        ...
        let mut messageHashes: Value = self.find_message_hashes(client.clone(), Value::Str("positions::".to_string()));
        {
            ...
            while { if !__for_first_202 { i = add(&i, &Value::Int(1)); } __for_first_202 = false; is_less_than(&i, &get_array_length(&messageHashes)) } {
