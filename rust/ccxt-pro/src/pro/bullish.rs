 ...
 */
    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut tradesArray: Value = get_value(&self.trades, &symbol);
        {
            ...
            while { if !__for_first_191 { i = add(&i, &Value::Int(1)); } __for_first_191 = false; is_less_than(&i, &get_array_length(&trades)) } {
 ...
 */
    ...
    pub fn separate_bids_or_asks(&self, mut entry: Value) -> Value {
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_192 { i = add(&i, &Value::Int(1)); } __for_first_192 = false; is_less_than(&i, &get_array_length(&entry)) } {
    ...
    pub fn handle_orders(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_greater_than(&numRawOrders, &Value::Int(0)) {
            ...
            });
            {
                ...
                while { if !__for_first_193 { i = add(&i, &Value::Int(1)); } __for_first_193 = false; is_less_than(&i, &get_array_length(&rawOrders)) } {
            ...
            let mut keys: Value = object_keys(&symbols);
            {
                ...
                while { if !__for_first_194 { i = add(&i, &Value::Int(1)); } __for_first_194 = false; is_less_than(&i, &get_array_length(&keys)) } {
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_greater_than(&numRawTrades, &Value::Int(0)) {
            ...
            });
            {
                ...
                while { if !__for_first_195 { i = add(&i, &Value::Int(1)); } __for_first_195 = false; is_less_than(&i, &get_array_length(&rawTrades)) } {
 ...
 */
    ...
    pub fn handle_positions(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut newPositions: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_197 { i = add(&i, &Value::Int(1)); } __for_first_197 = false; is_less_than(&i, &get_array_length(&rawPositions)) } {
        ...
        let mut messageHashes: Value = self.find_message_hashes(client.clone(), Value::Str("positions::".to_string()));
        {
            ...
            while { if !__for_first_198 { i = add(&i, &Value::Int(1)); } __for_first_198 = false; is_less_than(&i, &get_array_length(&messageHashes)) } {
