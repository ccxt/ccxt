...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn get_cache_index(&self, mut orderbook: Value, mut cache: Value) -> Value {
        ...
        let mut firstDeltaNonce: Value = self.safe_integer2(firstDelta.clone(), Value::Str("i".into()), Value::Str("u".into()), &[]);
        ...
        }
        {
            ...
            let mut delta: Value = get_value(&cache, &i);
            let mut deltaNonce: Value = self.safe_integer2(delta.clone(), Value::Str("i".into()), Value::Str("u".into()), &[]);
 ...
 */
    ...
    m
        ...
        let mut subscribe: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("method".to_string(), (if is_true(&isContract) { Value::Str("SUBSCRIBE".into()) } else { Value::Str("subscribe".into()) }));
                m.insert("id".to_string(), id.clone());
            m
        });
        if privateAccess {
            if !is_true(&isContract) {
                add_element_to_object(&mut subscribe, &Value::Str("params".into()), Value::from(vec![name.clone()]));
                add_element_to_object(&mut subscribe, &Value::Str("listenKey".into()), self.get_listen_key(isContract.clone()).await);
            }  else {
                ...
                add_element_to_object(&mut subscribe, &Value::Str("params".into()), Value::from(vec![param.clone()]));
            }
        }  else {
            add_element_to_object(&mut subscribe, &Value::Str("params".into()), Value::from(vec![name.clone()]));
        }
 ...
 */
    ...
    m
        ...
        let mut unsubscribe: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("method".to_string(), (if is_true(&isContract) { Value::Str("UNSUBSCRIBE".into()) } else { Value::Str("unsubscribe".into()) }));
                m.insert("id".to_string(), id.clone());
            m
        });
        if privateAccess {
            if !is_true(&isContract) {
                add_element_to_object(&mut unsubscribe, &Value::Str("params".into()), Value::from(vec![name.clone()]));
                add_element_to_object(&mut unsubscribe, &Value::Str("listenKey".into()), self.get_listen_key(isContract.clone()).await);
            }  else {
                let mut listenKey: Value = self.get_listen_key(isContract.clone()).await;
                let mut param: Value = add(&Value::Str(format!("{}{}", name, Value::Str("@".into())).into()), &listenKey);
                add_element_to_object(&mut unsubscribe, &Value::Str("params".into()), Value::from(vec![param.clone()]));
            }
        }  else {
            add_element_to_object(&mut unsubscribe, &Value::Str("params".into()), Value::from(vec![name.clone()]));
        }
        ...
        let __ws_arg_1 = self.extend(subscription, &[subscriptionParams.clone()]);
 ...
 */
    ...
    m
        ...
        let mut defaultMethod: Value = self.safe_string_k(options.clone(), "method", &[Value::Str("ticker".into())]);
        ...
        return self.subscribe(name.clone(), Value::Str("public".into()), Value::Str("watchTicker".into()), &[market.clone(), Value::Null, params.clone()]).await;
 ...
 */
    ...
    m
        ...
        return self.un_subscribe(messageHash.clone(), name.clone(), Value::Str("public".into()), Value::Str("unWatchTicker".into()), defaultMethod.clone(), &[market.clone(), Value::Null, params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut defaultMethod: Value = self.safe_string_k(options.clone(), "method", &[Value::Str("tickers".into())]);
        ...
        let mut tickers: Value = self.subscribe(name.clone(), Value::Str("public".into()), Value::Str("watchTickers".into()), &[market.clone(), symbols.clone(), params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("unsubscribe::".into()), name).into());
        let mut tickers: Value = self.un_subscribe(messageHash.clone(), name.clone(), Value::Str("public".into()), Value::Str("unWatchTickers".into()), Value::Str("ticker".into()), &[Value::Null, symbols.clone(), params.clone()]).await;
        if is_true(&self.newUpdates) {
            return tickers;
        }
        return self.filter_by_array(self.tickers.clone(), Value::Str("symbol".into()), &[symbols.clone()]);
 ...
 */
    ...
    m
        ...
        let mut ohlcv: Value = self.subscribe(name.clone(), Value::Str("public".into()), Value::Str("watchOHLCV".into()), &[market.clone(), Value::Null, params.clone()]).await;
        if is_true(&self.newUpdates) {
 ...
 */
    ...
    m
        ...
        return self.un_subscribe(messageHash.clone(), name.clone(), Value::Str("public".into()), Value::Str("unWatchOHLCV".into()), Value::Str("ohlcv".into()), &[market.clone(), Value::from(vec![symbol.clone()]), params.clone(), Value::Map({
    let mut m = indexmap::IndexMap::new();
 ...
 */
    ...
    m
        ...
        let mut trades: Value = self.subscribe(name.clone(), Value::Str("public".into()), Value::Str("watchTrades".into()), &[market.clone(), Value::Null, params.clone()]).await;
        if is_true(&self.newUpdates) {
 ...
 */
    ...
    m
        ...
        let mut name: Value = Value::Str(format!("{}{}", Value::Str("trade@".into()), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null)).into());
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("unsubscribe::".into()), name).into());
        return self.un_subscribe(messageHash.clone(), name.clone(), Value::Str("public".into()), Value::Str("unWatchTrades".into()), Value::Str("trades".into()), &[market.clone(), Value::from(vec![symbol.clone()]), params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut orderbook: Value = self.subscribe(name.clone(), Value::Str("public".into()), Value::Str("watchOrderBook".into()), &[market.clone(), Value::Null, params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("unsubscribe::".into()), name).into());
        return self.un_subscribe(messageHash.clone(), name.clone(), Value::Str("public".into()), Value::Str("unWatchOrderBook".into()), Value::Str("orderbook".into()), &[market.clone(), Value::from(vec![symbol.clone()]), params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut orders: Value = self.subscribe(name.clone(), Value::Str("private".into()), Value::Str("watchOrders".into()), &[market.clone(), Value::Null, params.clone()]).await;
        if is_true(&self.newUpdates) {
 ...
 */
    ...
    m
        ...
        let mut trades: Value = self.subscribe(name.clone(), Value::Str("private".into()), Value::Str("watchMyTrades".into()), &[market.clone(), Value::Null, params.clone()]).await;
        if is_true(&self.newUpdates) {
            limit = trades.get_limit(symbol.clone(), limit.clone());
        }
        return self.filter_by_since_limit(trades.clone(), &[since.clone(), limit.clone(), Value::Str("timestamp".into())]);
 ...
 */
    ...
    m
        ...
        return self.subscribe(name.clone(), Value::Str("private".into()), Value::Str("watchBalance".into()), &[Value::Null, Value::Null, params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut newPositions: Value = self.subscribe(name.clone(), Value::Str("private".into()), Value::Str("watchPositions".into()), &[Value::Null, Value::Null, params.clone()]).await;
        if is_true(&self.newUpdates) {
            return newPositions;
        }
 ...
 */
    ...
    m
        ...
        return self.subscribe(name.clone(), Value::Str("public".into()), Value::Str("watchFundingRate".into()), &[market.clone(), Value::Null, params.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut name: Value = Value::Str(format!("{}{}", Value::Str("fund_rate@".into()), market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null)).into());
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("unsubscribe::".into()), name).into());
        return self.un_subscribe(messageHash.clone(), name.clone(), Value::Str("public".into()), Value::Str("unWatchFundingRate".into()), Value::Str("fund_rate".into()), &[market.clone(), Value::Null, params.clone()]).await;
    ...
    pub fn handle_funding_rate(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if (marketId != Value::Null) {
            ...
            add_element_to_object(&mut fundingRate, &Value::Str("datetime".into()), self.iso8601(timestamp.clone()));
    ...
    pub async fn load_positions_snapshot(&mut self, mut client: Value, mut messageHash: Value) -> Value {
        ...
        if (in_op(&get_value(&client, &Value::Str("futures".into())), &messageHash)) {
            ...
            client.resolve(&[cache.clone(), Value::Str("position::contract".into())]);
        }
    ...
    pub fn handle_position(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut messageHashes: Value = self.find_message_hashes(client.clone(), Value::Str("position::contract".into()));
        {
            ...
            let mut positions: Value = self.filter_by_array(Value::from(vec![position.clone()]), Value::Str("symbol".into()), &[symbols.clone(), Value::Bool(false)]);
            if !is_true(&self.is_empty(positions.clone())) {
                client.resolve(&[positions.clone(), messageHash.clone()]);
            }
        }
        }
        client.resolve(&[Value::from(vec![position.clone()]), Value::Str("position::contract".into())]);
}
    ...
    pub fn handle_tickers(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        let mut spotTest: Option<String> = self.safe_string2(firstTicker.clone(), Value::Str("cv".into()), Value::Str("aq".into()), &[]).as_str().map(str::to_owned);
        let mut tradeType: Value = (if is_true(&(spotTest.is_some())) { Value::Str("spot".into()) } else { Value::Str("contract".into()) });
        ...
        let mut messageHashStart: Value = Value::Str(format!("{}{}", Value::Str(format!("{}{}", self.safe_string_k(message.clone(), "topic", &[]), Value::Str("::".into())).into()), tradeType).into());
    ...
    pub fn handle_ohlcv(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if (marketId != Value::Null) {
            ...
            let mut tradeType: Value = (if is_true(&(matches!(&data, Value::Dict(__d) if __d.contains_key("q")))) { Value::Str("spot".into()) } else { Value::Str("contract".into()) });
    ...
    pub fn handle_trade(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if (marketId != Value::Null) {
            ...
            let mut tradeType: Value = (if is_true(&(i.is_some())) { Value::Str("spot".into()) } else { Value::Str("contract".into()) });
            let mut market: Value = self.safe_market(&[marketId.clone(), Value::Null, Value::Null, tradeType.clone()]);
            let mut symbol: Value = market.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null);
            let mut event: Value = self.safe_string_k(message.clone(), "event", &[]);
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut marketId: Value = self.safe_string_k(data.clone(), "s", &[]);
        if (marketId != Value::Null) {
            let mut event: Value = self.safe_string_k(message.clone(), "event", &[Value::Str("".into())]);
            let mut splitEvent: Value = split(&event, &Value::Str(",".into()));
            event = self.safe_string(splitEvent.clone(), Value::Int(0), &[Value::Str("".into())]);
    ...
    m
            ...
            let mut timestamp: Value = self.safe_integer_k(data.clone(), "t", &[]);
            add_element_to_object(&mut orderbook, &Value::Str("nonce".into()), self.safe_integer2(data.clone(), Value::Str("i".into()), Value::Str("u".into()), &[]));
    ...
    pub fn parse_ws_order_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        let mut tradeType: Value = (if is_true(&(matches!(&trade, Value::Dict(__d) if __d.contains_key("symbol")))) { Value::Str("contract".into()) } else { Value::Str("spot".into()) });
    ...
    pub fn parse_ws_order(&self, mut order: Value, optional_args: &[Value]) -> Value {
        ...
        let mut tradeType: Value = (if is_true(&(matches!(&order, Value::Dict(__d) if __d.contains_key("symbol")))) { Value::Str("contract".into()) } else { Value::Str("spot".into()) });
        market = self.safe_market(&[marketId.clone(), market.clone(), Value::Null, tradeType.clone()]);
    ...
    pub fn handle_order(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if (marketId != Value::Null) {
            ...
            client.resolve(&[orders.clone(), Value::Str(format!("{}{}", Value::Str("order::".into()), tradeType).into())]);
        }
        return message;
    ...
    pub fn handle_balance(&mut self, mut client: Value, mut message: Value) {
        ...
        if let Value::Dict(__d) = &mut account { std::sync::Arc::make_mut(__d).insert("total".to_string(), self.safe_string2(data.clone(), Value::Str("b".into()), Value::Str("walletBalance".into()), &[])); }
        if (code != Value::Null) {
            add_element_to_object(&mut self.balance, &code, account.clone());
        }
        { let __t = self.safe_balance(self.balance.clone()); self.balance = __t; }
        let mut tradeType: Value = (if is_true(&(matches!(&data, Value::Dict(__d) if __d.contains_key("coin")))) { Value::Str("contract".into()) } else { Value::Str("spot".into()) });
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut tradeType: Value = (if is_true(&(market.as_map().and_then(|__m| __m.get("contract")).cloned().unwrap_or(Value::Null).as_bool() == Some(true))) { Value::Str("contract".into()) } else { Value::Str("spot".into()) });
        client.resolve(&[stored.clone(), Value::Str(format!("{}{}", Value::Str("trade::".into()), tradeType).into())]);
}
