 ...
 */
    ...
    pub fn handle_bid_asks(&self, mut bookSide: Value, mut bidAsks: Value) {
        {
            ...
            while { if !__for_first_156 { i = add(&i, &Value::Int(1)); } __for_first_156 = false; is_less_than(&i, &get_array_length(&bidAsks)) } {
    ...
    pub fn get_cache_index(&self, mut orderbook: Value, mut deltas: Value) -> Value {
        ...
        }
        {
            ...
            while { if !__for_first_157 { i = add(&i, &Value::Int(1)); } __for_first_157 = false; is_less_than(&i, &get_array_length(&deltas)) } {
 ...
 */
    ...
    pub fn handle_subject(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut keys: Value = object_keys(&methods);
        {
            ...
            while { if !__for_first_158 { i = add(&i, &Value::Int(1)); } __for_first_158 = false; is_less_than(&i, &get_array_length(&keys)) } {
