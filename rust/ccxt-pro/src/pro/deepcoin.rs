...
impl DeepcoinCore {
    ...
    pub fn create_public_request(&self, mut market: Value, mut requestId: Value, mut topicID: Value, optional_args: &[Value]) -> Value {
        ...
        if (crate::value::get_value_k(&market, "type").as_str() == Some("swap")) {
            marketId = Value::Str(format!("{}{}", self.safe_string_k(market.clone(), "baseId", &[Value::Str("".into())]), self.safe_string_k(market.clone(), "quoteId", &[Value::Str("".into())])).into()); // swap markets use symbol without slash
        }
    ...
    m
        ...
        return self.watch(url.clone(), messageHash.clone(), &[Value::Null, Value::Str("private".into()), params.clone()]).await;
    ...
    m
        ...
        let _try_result = futures::FutureExt::catch_unwind(std::panic::AssertUnwindSafe(async {
            ...
            if (response != Value::Null) {
                ...
                listenKeyExpiryTimestamp = self.safe_timestamp(data.clone(), Value::Str("expire_time".into()), &[]);
 ...
 */
    ...
    m
        ...
        return self.watch_public(market.clone(), messageHash.clone(), Value::Str("7".into()), &[params.clone()]).await;
 ...
 */
    ...
    m
        ...
        return self.un_watch_public(market.clone(), messageHash.clone(), Value::Str("7".into()), &[params.clone(), subscription.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut trades: Value = self.watch_public(market.clone(), messageHash.clone(), Value::Str("2".into()), &[params.clone()]).await;
 ...
 */
    ...
    m
        ...
        return self.un_watch_public(market.clone(), messageHash.clone(), Value::Str("2".into()), &[params.clone(), subscription.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut ohlcv: Value = self.watch_public(market.clone(), messageHash.clone(), Value::Str("11".into()), &[params.clone(), suffix.clone()]).await;
        if is_true(&self.newUpdates) {
 ...
 */
    ...
    m
        ...
        return self.un_watch_public(market.clone(), messageHash.clone(), Value::Str("11".into()), &[params.clone(), subscription.clone(), suffix.clone()]).await;
 ...
 */
    ...
    m
        ...
        let mut orderbook: Value = self.watch_public(market.clone(), messageHash.clone(), Value::Str("25".into()), &[params.clone(), suffix.clone()]).await;
 ...
 */
    ...
    m
        ...
        return self.un_watch_public(market.clone(), messageHash.clone(), Value::Str("25".into()), &[params.clone(), subscription.clone(), suffix.clone()]).await;
    ...
    m
        ...
        return Value::from(vec![Value::Str(format!("{}{}", Value::Str("_".into()), aggregation).into()), params.clone()]);
    ...
    pub fn handle_order_book_snapshot(&self, mut client: Value, mut message: Value) {
        ...
        });
        {
            ...
            if (side.as_deref() == Some("0")) {
                ...
                // ask
                crate::runtime::append_to_object_array(&mut orderedEntries, &Value::Str("asks".into()), Value::from(vec![price.clone(), volume.clone()]));
            }
        }
        }
 ...
 */
    ...
    m
        ...
        let mut url: Value = Value::Str(format!("{}{}", add(&crate::value::get_value_k(&self.urls.as_map().and_then(|__m| __m.get("api")).cloned().unwrap_or(Value::Null).as_map().and_then(|__m| __m.get("ws")).cloned().unwrap_or(Value::Null), "private"), &Value::Str("?listenKey=".into())), listenKey).into());
        let mut positions: Value = self.watch_multiple(url.clone(), messageHashes.clone(), &[params.clone(), Value::from(vec![Value::Str("private".into())])]).await;
        if is_true(&self.newUpdates) {
            return positions;
        }
    ...
    pub fn handle_subscription_status(&mut self, mut client: Value, mut message: Value) {
        ...
        if (action.as_deref() == Some("0")) {
            ...
            let mut unsubsciption: Value = self.safe_dict(get_value(&client, &Value::Str("subscriptions".into())), unsubHash.clone(), &[Value::Map({
                let mut m = indexmap::IndexMap::new();
                m
