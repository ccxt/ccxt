 ...
 */
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("type".to_string(), self.parent.parse_order_type(self.safe_string_lower(order.clone(), Value::Str("o".into()), &[])).map(|__s| Value::Str(__s.into())).unwrap_or(Value::Null));
