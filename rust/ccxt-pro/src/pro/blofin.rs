 ...
 */
    ...
    m
        ...
        let mut args: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_185 { i = add(&i, &Value::Int(1)); } __for_first_185 = false; is_less_than(&i, &get_array_length(&symbolsList)) } {
        ...
        if is_greater_than(&symbolsLength, &Value::Int(0)) {
            {
                ...
                while { if !__for_first_190 { i = add(&i, &Value::Int(1)); } __for_first_190 = false; is_less_than(&i, &get_array_length(&symbols)) } {
