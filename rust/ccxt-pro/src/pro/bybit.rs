...
impl BybitCore {
    ...
    m
        ...
        if is_true(&isPrivate) {
            ...
            if is_true(&isUsdcSettled) && (isUnifiedMargin.as_bool() != Some(true)) && (isUnifiedAccount.as_bool() != Some(true)) {
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        }
        {
            ...
            if spot && !executionFast {
                ...
                if (execTypes != Value::Null) && !is_true(&self.in_array(execType.clone(), execTypes.clone())) {
                    continue;
                }
 ...
 */
    ...
    pub fn handle_liquidation(&mut self, mut client: Value, mut message: Value) {
        ...
        //     }
        //
        if (matches!(&crate::value::get_value_k(&message, "data"), Value::Arr(_))) {
