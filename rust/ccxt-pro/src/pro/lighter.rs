...
impl LighterCore {
    ...
    pub fn handle_order_book_message(&self, mut client: Value, mut message: Value, mut orderbook: Value) -> Value {
        ...
        add_element_to_object(&mut orderbook, &Value::Str("nonce".into()), self.safe_integer_k(data.clone(), "offset", &[]));
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        if (type_var.as_deref() == Some("subscribed/order_book")) {
            let mut parsed: Value = self.parse_order_book(data.clone(), symbol.clone(), &[timestamp.clone(), Value::Str("bids".into()), Value::Str("asks".into()), Value::Str("price".into()), Value::Str("size".into())]);
            add_element_to_object(&mut parsed, &Value::Str("nonce".into()), self.safe_integer_k(data.clone(), "offset", &[]));
 ...
 */
    ...
    m
        ...
        let mut messageHash: Value = self.get_message_hash(Value::Str("ticker".into()), &[symbol.clone()]);
    ...
    m
        ...
        if is_true(&(symbols == Value::Null)) || is_true(&(symbolsLength.as_f64() == Some(0.0))) {
        ...
        }  else {
            {
                ...
                let mut symbol: Value = get_value(&symbols, &i);
                append_to_array(&mut messageHashes, self.get_message_hash(Value::Str("ticker".into()), &[symbol.clone()]));
            }
            }
        }
 ...
 */
    ...
    pub fn parse_ws_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        let mut side: Value = (if is_true(&(isMakerAsk.as_bool() == Some(true))) { Value::Str("buy".into()) } else { Value::Str("sell".into()) });
    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut messageHash: Value = self.get_message_hash(Value::Str("trade".into()), &[symbol.clone()]);
    ...
    pub fn parse_ws_order_trade(&self, mut trade: Value, optional_args: &[Value]) -> Value {
        ...
        if (accountIndex != Value::Null) {
            if (bidAccountId.as_f64() == accountIndex.as_f64()) {
                ...
                takerOrMaker = (if is_true(&(isMakerAsk.as_bool() == Some(true))) { Value::Str("taker".into()) } else { Value::Str("maker".into()) });
            }  else if (askAccountId.as_f64() == accountIndex.as_f64()) {
                side = Value::Str("sell".into());
                order = self.safe_string_k(trade.clone(), "ask_id", &[]);
                takerOrMaker = (if is_true(&(isMakerAsk.as_bool() == Some(true))) { Value::Str("maker".into()) } else { Value::Str("taker".into()) });
            }
        }
        // public trades use Lighter's taker-side convention
        if (side == Value::Null) {
            side = (if is_true(&(isMakerAsk.as_bool() == Some(true))) { Value::Str("buy".into()) } else { Value::Str("sell".into()) });
        }
        ...
        if (takerOrMaker != Value::Null) {
            ...
            let mut feeRate: Value = (if is_true(&(feeRateRaw != Value::Null)) { crate::precise::Precise::stringDiv(&feeRateRaw, &Value::Str("1000000".into())) } else { Value::Str("0".into()) });
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        let mut messageHash: Value = self.get_message_hash(Value::Str("myTrades".into()), &[]);
        {
            ...
            let mut tradesLength: Value = Value::Int(trades.len() as i64);
            {
                ...
                if (symbol != Value::Null) {
                    let mut symbolSpecificMessageHash: Value = self.get_message_hash(Value::Str("myTrades".into()), &[symbol.clone()]);
 ...
 */
    ...
    m
        ...
        let mut request: Value = Value::Map({
            let mut m = indexmap::IndexMap::new();
                m.insert("channel".to_string(), Value::Str(format!("{}{}", Value::Str("account_all_trades/".into()), self.number_to_string(accountIndex.clone())).into()));
            m
        });
 ...
 */
    ...
    pub fn handle_liquidation(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut messageHash: Value = self.get_message_hash(Value::Str("liquidations".into()), &[symbol.clone()]);
        client.resolve(&[stored.clone(), messageHash.clone()]);
}
 ...
 */
    ...
    m
        ...
        { let __destr_tmp = self.handle_param_string(params.clone(), Value::Str("type".into()), &[defaultType.clone()]); type_var = __destr_tmp.as_array().and_then(|__arr| __arr.get(0)).cloned().unwrap_or(Value::Null); params = __destr_tmp.as_array().and_then(|__arr| __arr.get(1)).cloned().unwrap_or(Value::Null); }
        let mut accountIndex: Value = Value::Null;
        ...
        if (type_var.as_str() == Some("spot")) {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("channel".to_string(), Value::Str(format!("{}{}", Value::Str("account_all_assets/".into()), self.number_to_string(accountIndex.clone())).into())); }
            let __ws_arg_14 = self.extend(request.clone(), &[params.clone()]);
            return self.subscribe_private(messageHash.clone(), &[__ws_arg_14]).await;
        }  else {
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("channel".to_string(), Value::Str(format!("{}{}", Value::Str("user_stats/".into()), self.number_to_string(accountIndex.clone())).into())); }
    ...
    pub fn handle_balance(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        if (type_var.as_str() == Some("spot")) {
            ...
            let mut assetIds: Value = object_keys(&assets);
            {
                ...
                add_element_to_object(&mut account, &Value::Str("total".into()), self.safe_string_k(asset.clone(), "balance", &[]));
                if (code != Value::Null) {
            ...
            add_element_to_object(&mut account, &Value::Str("info".into()), stats.clone());
            add_element_to_object(&mut balance, &Value::Str("USDC".into()), account.clone());
        }
        let mut timestamp: Value = self.safe_integer_k(message.clone(), "timestamp", &[]);
        add_element_to_object(&mut balance, &Value::Str("timestamp".into()), timestamp.clone());
        add_element_to_object(&mut balance, &Value::Str("datetime".into()), self.iso8601(timestamp.clone()));
 ...
 */
    ...
    m
        ...
        if (symbol != Value::Null) {
            ...
            if let Value::Dict(__d12) = &mut request { std::sync::Arc::make_mut(__d12).insert("channel".to_string(), Value::Str(format!("{}{}", Value::Str("account_all_orders/".into()), self.number_to_string(accountIndex.clone())).into())); }
        }
 ...
 */
    ...
    pub fn request_id(&self, mut url: Value) -> Value {
        ...
        return self.number_to_string(newValue.clone());
 ...
 */
    ...
    m
        ...
        let mut txTypetxInfoordermarketVariable = self.parent.sign_and_create_order(Value::Str("createOrderWs".into()), symbol.clone(), type_var.clone(), side.clone(), amount.clone(), &[price.clone(), params.clone()]).await;
        ...
        let mut parsedTx: Value = self.parse_json_value(txInfo.clone());
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("tx_info".to_string(), parsedTx.clone());
    m
}));
            m
        });
        ...
        return self.parse_order(self.deep_extend(rawMessage.clone(), &[order.clone()]), &[market.clone()]);
 ...
 */
    ...
    m
        ...
        let mut requestId: Value = self.request_id(url.clone());
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("jsonapi/sendtx:".into()), requestId).into());
        let mut txTypetxInfomarketVariable = self.parent.sign_and_cancel_order(Value::Str("cancelOrderWs".into()), id.clone(), &[symbol.clone(), params.clone()]).await;
    ...
    m
        ...
        let mut rawMessage: Value = self.watch(url.clone(), messageHash.clone(), &[message.clone(), messageHash.clone(), subscription.clone()]).await;
        return self.parse_order(rawMessage.clone(), &[market.clone()]);
 ...
 */
    ...
    m
        ...
        let mut requestId: Value = self.request_id(url.clone());
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("jsonapi/sendtx:".into()), requestId).into());
        let mut txTypetxInfoVariable = self.parent.sign_and_cancel_all_orders(Value::Str("cancelAllOrdersWs".into()), &[symbol.clone(), params.clone()]).await;
    ...
    pub fn handle_ws_sendtx_api(&self, mut client: Value, mut message: Value) {
        ...
        client.resolve(&[message.clone(), Value::Str(format!("{}{}", Value::Str("jsonapi/sendtx:".into()), id).into())]);
}
    ...
    pub fn handle_orders(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        let mut messageHash: Value = self.get_message_hash(Value::Str("orders".into()), &[]);
        {
            ...
            let mut orders: Value = self.safe_list(data.clone(), marketId.clone(), &[Value::from(vec![])]);
            {
                ...
                if (symbol != Value::Null) {
                    let mut symbolSpecificMessageHash: Value = self.get_message_hash(Value::Str("orders".into()), &[symbol.clone()]);
                    client.resolve(&[stored.clone(), symbolSpecificMessageHash.clone()]);
                }
            }
            }
...
if let Err(_try_err) = _try_result { let e: Value = panic_to_value(_try_err);
    ...
    pub fn handle_my_trades_un_subscription(&mut self, mut client: Value) {
        ...
        self.clean_unsubscription(client.clone(), Value::Str("myTrades".into()), messageHash.clone(), &[Value::Bool(true)]);
    ...
    pub fn handle_orders_un_subscription(&mut self, mut client: Value, mut marketId: Value) {
        let mut symbol: Value = self.safe_symbol(marketId.clone(), &[]);
        let mut subMessageHash: Value = self.get_message_hash(Value::Str("orders".into()), &[symbol.clone()]);
        let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("unsubscribe:".into()), subMessageHash).into());
        self.clean_unsubscription(client.clone(), subMessageHash.clone(), messageHash.clone(), &[]);
}
