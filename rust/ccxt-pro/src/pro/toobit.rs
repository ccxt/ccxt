 ...
 */
    ...
    m
        ...
        if (subscriptionHash == Value::Null) || (matches!((&get_value(&client, &Value::Str("subscriptions".into())), &subscriptionHash), (Value::Dict(__d), Value::Str(__k)) if __d.contains_key(__k.as_ref()))) {
            return;
        }
