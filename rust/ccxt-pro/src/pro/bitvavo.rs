 ...
 */
    ...
    pub fn handle_ticker(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_163 { i = add(&i, &Value::Int(1)); } __for_first_163 = false; is_less_than(&i, &get_array_length(&tickers)) } {
 ...
 */
    ...
    pub fn handle_bid_ask(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_164 { i = add(&i, &Value::Int(1)); } __for_first_164 = false; is_less_than(&i, &get_array_length(&tickers)) } {
            let mut data: Value = get_value(&tickers, &i);
            let mut data: Value = get_value(&tickers, &i);
 ...
 */
    ...
    m
        ...
        }
        {
            ...
            while { if !__for_first_167 { i = add(&i, &Value::Int(1)); } __for_first_167 = false; is_less_than(&i, &get_array_length(&candles)) } {
 ...
 */
    ...
    m
        ...
        let mut intervals: Value = object_keys(&marketIdsByInterval);
        {
            ...
            while { if !__for_first_169 { i = add(&i, &Value::Int(1)); } __for_first_169 = false; is_less_than(&i, &get_array_length(&intervals)) } {
 ...
 */
    ...
    pub fn handle_deltas(&self, mut bookside: Value, mut deltas: Value) {
        {
            ...
            while { if !__for_first_174 { i = add(&i, &Value::Int(1)); } __for_first_174 = false; is_less_than(&i, &get_array_length(&deltas)) } {
    ...
    pub fn handle_order_book_snapshot(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut messages: Value = get_value(&orderbook, &Value::Str("cache".to_string()));
        {
            ...
            while { if !__for_first_175 { i = add(&i, &Value::Int(1)); } __for_first_175 = false; is_less_than(&i, &get_array_length(&messages)) } {
    ...
    pub fn handle_order_book_subscriptions(&mut self, mut client: Value, mut message: Value, mut marketIds: Value) {
        let mut name: Value = Value::Str("book".to_string());
        {
            ...
            while { if !__for_first_176 { i = add(&i, &Value::Int(1)); } __for_first_176 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
    ...
    m
        ...
        let mut unsubHashes: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_177 { i = add(&i, &Value::Int(1)); } __for_first_177 = false; is_less_than(&i, &get_array_length(&subMessageHashes)) } {
 ...
 */
    ...
    pub fn handle_subscription_status(&mut self, mut client: Value, mut message: Value) -> Value {
        ...
        let mut names: Value = object_keys(&subscriptions);
        {
            ...
            while { if !__for_first_179 { i = add(&i, &Value::Int(1)); } __for_first_179 = false; is_less_than(&i, &get_array_length(&names)) } {
