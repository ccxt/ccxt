 ...
 */
    ...
    pub fn handle_delta(&self, mut orderbook: Value, mut delta: Value) {
        ...
        if (change != Value::Null) {
            ...
            let mut type_var: Value = (if is_true(&(side.as_str() == Some("buy"))) { Value::Str("bids".to_string()) } else { Value::Str("asks".to_string()) });
 ...
 */
    ...
    pub fn handle_order(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_true(&(rawType.as_str() == Some("match"))) && is_true(&(matchPrice != Value::Null)) && is_true(&(matchSize != Value::Null)) {
