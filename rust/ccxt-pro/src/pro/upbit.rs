...
impl UpbitCore {
    ...
    m
        ...
        let mut channelKeys: Value = object_keys(&subscriptions);
        {
            ...
            while { if !__for_first_621 { i = add(&i, &Value::Int(1)); } __for_first_621 = false; is_less_than(&i, &get_array_length(&channelKeys)) } {
 ...
 */
    ...
    m
})]);
        {
            ...
            while { if !__for_first_624 { i = add(&i, &Value::Int(1)); } __for_first_624 = false; is_less_than(&i, &get_array_length(&requests)) } {
