    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        if !is_equal(&trades, &Value::Null) {
            ...
            }
            {
                ...
                while { if !__for_first_352 { i = add(&i, &Value::Int(1)); } __for_first_352 = false; is_less_than(&i, &get_array_length(&trades)) } {
    ...
    pub fn handle_trades_for_multidata(&mut self, mut client: Value, mut trades: Value, mut timestamp: Value) {
        if !is_equal(&trades, &Value::Null) {
            ...
            });
            {
                ...
                while { if !__for_first_353 { i = add(&i, &Value::Int(1)); } __for_first_353 = false; is_less_than(&i, &get_array_length(&trades)) } {
            ...
            let mut symbols: Value = object_keys(&storesForSymbols);
            {
                ...
                while { if !__for_first_354 { i = add(&i, &Value::Int(1)); } __for_first_354 = false; is_less_than(&i, &get_array_length(&symbols)) } {
 ...
 */
    ...
    m
        ...
        let mut changesLength: Value = get_array_length(&changes);
        {
            ...
            while { if !__for_first_355 { i = add(&i, &Value::Int(1)); } __for_first_355 = false; is_less_than(&i, &changesLength) } {
 ...
 */
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut orderbook: Value = get_value(&self.orderbooks, &symbol);
        {
            ...
            while { if !__for_first_356 { i = add(&i, &Value::Int(1)); } __for_first_356 = false; is_less_than(&i, &get_array_length(&changes)) } {
 ...
 */
    ...
    m
        ...
        let mut messageHash: Value = add(&Value::Str("bidsasks:".to_string()), &symbol);
        {
            ...
            while { if !__for_first_357 { i = add(&i, &Value::Int(1)); } __for_first_357 = false; is_less_than(&i, &get_array_length(&rawBidAskChanges)) } {
    ...
    pub fn handle_order_book_for_multidata(&mut self, mut client: Value, mut rawOrderBookChanges: Value, mut timestamp: Value, mut nonce: Value) {
        ...
        let mut asks: Value = get_value(&orderbook, &Value::Str("asks".to_string()));
        {
            ...
            while { if !__for_first_359 { i = add(&i, &Value::Int(1)); } __for_first_359 = false; is_less_than(&i, &get_array_length(&rawOrderBookChanges)) } {
 ...
 */
    ...
    pub fn handle_order(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut orders: Value = self.orders.clone();
        {
            ...
            while { if !__for_first_360 { i = add(&i, &Value::Int(1)); } __for_first_360 = false; is_less_than(&i, &get_array_length(&message)) } {
    ...
    pub fn handle_message(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_equal(&type_var, &Value::Str("update".to_string())) {
            ...
            let mut eventsLength: Value = get_array_length(&events);
            {
                ...
                while { if !__for_first_361 { i = add(&i, &Value::Int(1)); } __for_first_361 = false; is_less_than(&i, &get_array_length(&events)) } {
