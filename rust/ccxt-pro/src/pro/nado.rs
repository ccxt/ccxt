 ...
 */
    ...
    m
        ...
        let mut subscriptionParams: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_504 { i = add(&i, &Value::Int(1)); } __for_first_504 = false; is_less_than(&i, &get_array_length(&symbolsAndTimeframes)) } {
 ...
 */
    ...
    m
        ...
        let mut result: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_506 { i = add(&i, &Value::Int(1)); } __for_first_506 = false; is_less_than(&i, &get_array_length(&cancelledOrders)) } {
 ...
 */
    ...
    m
        ...
        let mut client: Value = self.client(&[url.clone()]);
        {
            ...
            while { if !__for_first_508 { i = add(&i, &Value::Int(1)); } __for_first_508 = false; is_less_than(&i, &get_array_length(&messageHashes)) } {
    ...
    pub fn parse_ws_all_bids_asks(&self, mut message: Value) -> Value {
        ...
        });
        {
            ...
            while { if !__for_first_510 { i = add(&i, &Value::Int(1)); } __for_first_510 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_true(&(!is_equal(&maxTimestamp, &Value::Null))) && is_true(&(!is_equal(&lastMaxTimestamp, &Value::Null))) && is_true(&(!is_equal(&maxTimestamp, &lastMaxTimestamp))) {
            let mut subscriptions: Value = object_keys(&get_value(&client, &Value::Str("subscriptions".to_string())));
            {
                ...
                while { if !__for_first_512 { i = add(&i, &Value::Int(1)); } __for_first_512 = false; is_less_than(&i, &get_array_length(&subscriptions)) } {
