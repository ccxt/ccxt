 ...
 */
    ...
    pub fn handle_balance(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut spotBalances: Value = self.safe_list_k(data.clone(), "spotBalances", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_318 { i = add(&i, &Value::Int(1)); } __for_first_318 = false; is_less_than(&i, &get_array_length(&spotBalances)) } {
 ...
 */
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        }
        {
            ...
            while { if !__for_first_319 { i = add(&i, &Value::Int(1)); } __for_first_319 = false; is_less_than(&i, &get_array_length(&rawTrades)) } {
        ...
        let mut keys: Value = object_keys(&symbols);
        {
            ...
            while { if !__for_first_320 { i = add(&i, &Value::Int(1)); } __for_first_320 = false; is_less_than(&i, &get_array_length(&keys)) } {
        ...
        let mut subscriptions: Value = object_keys(&get_value(&client, &Value::Str("subscriptions".to_string())));
        {
            ...
            while { if !__for_first_321 { i = add(&i, &Value::Int(1)); } __for_first_321 = false; is_less_than(&i, &get_array_length(&subscriptions)) } {
 ...
 */
    ...
    pub fn handle_positions(&mut self, mut client: Value, mut message: Value) {
        ...
        }
        {
            ...
            while { if !__for_first_322 { i = add(&i, &Value::Int(1)); } __for_first_322 = false; is_less_than(&i, &get_array_length(&rawPositions)) } {
        ...
        let mut messageHashes: Value = self.find_message_hashes(client.clone(), Value::Str("positions::".to_string()));
        {
            ...
            while { if !__for_first_323 { i = add(&i, &Value::Int(1)); } __for_first_323 = false; is_less_than(&i, &get_array_length(&messageHashes)) } {
    ...
    pub fn handle_orders(&mut self, mut client: Value, mut message: Value) {
        ...
        }
        {
            ...
            while { if !__for_first_324 { i = add(&i, &Value::Int(1)); } __for_first_324 = false; is_less_than(&i, &get_array_length(&rawOrders)) } {
        ...
        let mut keys: Value = object_keys(&symbols);
        {
            ...
            while { if !__for_first_325 { i = add(&i, &Value::Int(1)); } __for_first_325 = false; is_less_than(&i, &get_array_length(&keys)) } {
        ...
        let mut subscriptions: Value = object_keys(&get_value(&client, &Value::Str("subscriptions".to_string())));
        {
            ...
            while { if !__for_first_326 { i = add(&i, &Value::Int(1)); } __for_first_326 = false; is_less_than(&i, &get_array_length(&subscriptions)) } {
            let mut messageHash: Value = get_value(&subscriptions, &i);
            let mut messageHash: Value = get_value(&subscriptions, &i);
 ...
 */
    ...
    m
        ...
        let mut data: Value = self.safe_list_k(message.clone(), "data", &[Value::List(vec![])]);
        {
            ...
            while { if !__for_first_328 { i = add(&i, &Value::Int(1)); } __for_first_328 = false; is_less_than(&i, &get_array_length(&data)) } {
