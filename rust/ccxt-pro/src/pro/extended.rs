 ...
 */
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut type_var: Option<String> = self.safe_string_k(message.clone(), "type", &[self.safe_string(data.clone(), Value::Str("t".to_string()), &[])]).as_str().map(str::to_owned);
 ...
 */
    ...
    pub fn handle_my_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut keys: Value = object_keys(&symbols);
        {
            ...
            let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("myTrades:".to_string()), keys.as_array().and_then(|__arr| match &i { Value::Int(__n) => __arr.get(*__n as usize), Value::Str(__s) => __s.parse::<usize>().ok().and_then(|__n| __arr.get(__n)), _ => None }).cloned().unwrap_or(Value::Null)));
 ...
 */
    ...
    pub fn handle_orders(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut keys: Value = object_keys(&symbols);
        {
            ...
            let mut messageHash: Value = Value::Str(format!("{}{}", Value::Str("orders:".to_string()), keys.as_array().and_then(|__arr| match &i { Value::Int(__n) => __arr.get(*__n as usize), Value::Str(__s) => __s.parse::<usize>().ok().and_then(|__n| __arr.get(__n)), _ => None }).cloned().unwrap_or(Value::Null)));
 ...
 */
    ...
    pub fn handle_ohlcv(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut cacheKey: Value = (if (candleType.as_str() == Some("trades")) { timeframe.clone() } else { Value::Str(format!("{}{}", Value::Str(format!("{}{}", timeframe, Value::Str(":".to_string()))), candleType)) });
    ...
    pub fn handle_message(&mut self, mut client: Value, mut message: Value) {
        ...
        if (matches!(&data, Value::Arr(_))) {
            ...
            let mut side: Option<String> = self.safe_string_k(first.clone(), "S", &[]).as_str().map(str::to_owned);
            if (side.is_some()) {
            ...
            if (type_var.as_deref() == Some("ORDER")) || (in_op(&data, &Value::Str("orders".to_string()))) {
                self.handle_orders(client.clone(), message.clone());
                isAccountUpdate = true;
            }
            if (type_var.as_deref() == Some("TRADE")) || (in_op(&data, &Value::Str("trades".to_string()))) {
                self.handle_my_trades(client.clone(), message.clone());
                isAccountUpdate = true;
            }
            if (type_var.as_deref() == Some("POSITION")) || (in_op(&data, &Value::Str("positions".to_string()))) {
                self.handle_positions(client.clone(), message.clone());
                isAccountUpdate = true;
            }
            if (type_var.as_deref() == Some("BALANCE")) || (in_op(&data, &Value::Str("balance".to_string()))) || (in_op(&data, &Value::Str("spotBalances".to_string()))) {
