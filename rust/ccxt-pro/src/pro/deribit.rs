 ...
 */
    ...
    m
        ...
        let mut trades: Value = self.watch_multiple_wrapper(Value::Str("trades".into()), interval.clone(), &[symbols.clone(), params.clone()]).await;
        if is_true(&self.newUpdates) {
 ...
 */
    ...
    m
        ...
        let mut orderbook: Value = self.watch_multiple_wrapper(Value::Str("book".into()), descriptor.clone(), &[symbols.clone(), params.clone()]).await;
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        self.handle_deltas(get_value(&storedOrderBook, &Value::Str("asks".into())), asks.clone());
        self.handle_deltas(get_value(&storedOrderBook, &Value::Str("bids".into())), bids.clone());
    ...
    pub fn clean_order_book(&self, mut data: Value) -> Value {
        ...
        add_element_to_object(&mut data, &Value::Str("bids".into()), cleanedBids.clone());
        add_element_to_object(&mut data, &Value::Str("asks".into()), cleanedAsks.clone());
        return data;
 ...
 */
    ...
    m
        ...
        let mut symboltimeframecandlesVariable = self.watch_multiple_wrapper(Value::Str("chart.trades".into()), Value::Null, &[symbolsAndTimeframes.clone(), params.clone()]).await;
