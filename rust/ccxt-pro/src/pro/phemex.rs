...
impl PhemexCore {
    ...
    pub fn handle_ticker(&mut self, mut client: Value, mut message: Value) {
        ...
        }
        {
            ...
            while { if !__for_first_581 { i = add(&i, &Value::Int(1)); } __for_first_581 = false; is_less_than(&i, &get_array_length(&tickers)) } {
 ...
 */
    ...
    pub fn handle_balance(&mut self, mut type_var: Value, mut client: Value, mut message: Value) {
        ...
        add_element_to_object(&mut self.balance, &Value::Str("info".to_string()), message.clone());
        {
            ...
            while { if !__for_first_582 { i = add(&i, &Value::Int(1)); } __for_first_582 = false; is_less_than(&i, &get_array_length(&message)) } {
    ...
    m
            ...
            }
            {
                ...
                while { if !__for_first_584 { i = add(&i, &Value::Int(1)); } __for_first_584 = false; is_less_than(&i, &get_array_length(&ohlcvs)) } {
 ...
 */
    ...
    pub fn custom_handle_deltas(&self, mut bookside: Value, mut deltas: Value, optional_args: &[Value]) {
        let mut market = get_arg(optional_args, 0, Value::Null);
        {
            ...
            while { if !__for_first_586 { i = add(&i, &Value::Int(1)); } __for_first_586 = false; is_less_than(&i, &get_array_length(&deltas)) } {
 ...
 */
    ...
    pub fn handle_my_trades(&self, mut client: Value, mut message: Value) {
        ...
        let mut type_var: Value = Value::Null;
        {
            ...
            while { if !__for_first_587 { i = add(&i, &Value::Int(1)); } __for_first_587 = false; is_less_than(&i, &get_array_length(&message)) } {
        ...
        let mut keys: Value = object_keys(&marketIds);
        {
            ...
            while { if !__for_first_588 { i = add(&i, &Value::Int(1)); } __for_first_588 = false; is_less_than(&i, &get_array_length(&keys)) } {
    ...
    pub fn handle_orders(&mut self, mut client: Value, mut message: Value) {
        ...
        if is_true(&(Value::Bool(in_op(&message, &Value::Str("closed".to_string()))))) || is_true(&(Value::Bool(in_op(&message, &Value::Str("fills".to_string()))))) || is_true(&(Value::Bool(in_op(&message, &Value::Str("open".to_string()))))) {
            ...
            trades = self.safe_value_k(message.clone(), "fills", &[Value::List(vec![])]);
            {
                ...
                while { if !__for_first_589 { i = add(&i, &Value::Int(1)); } __for_first_589 = false; is_less_than(&i, &get_array_length(&orders)) } {
            ...
            }
            {
                ...
                while { if !__for_first_590 { i = add(&i, &Value::Int(1)); } __for_first_590 = false; is_less_than(&i, &get_array_length(&message)) } {
        ...
        let mut stored: Value = self.orders.clone();
        {
            ...
            while { if !__for_first_591 { i = add(&i, &Value::Int(1)); } __for_first_591 = false; is_less_than(&i, &get_array_length(&parsedOrders)) } {
        ...
        let mut keys: Value = object_keys(&marketIds);
        {
            ...
            while { if !__for_first_592 { i = add(&i, &Value::Int(1)); } __for_first_592 = false; is_less_than(&i, &get_array_length(&keys)) } {
