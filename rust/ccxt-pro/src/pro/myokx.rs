...
impl MyokxCore {
    ...
    pub fn init(&mut self) {
        ...
        let described = MyokxCore::describe(self);
...
impl crate::exchange::DerivedExchange for MyokxCore {
...
impl crate::exchange_generated::ExchangeBase for MyokxCore {
...
impl MyokxCore {
    ...
    let mut m = indexmap::IndexMap::new();
        ...
        m.insert("ws".to_string(), Value::Str("wss://wseea.okx.com:8443/ws/v5".to_string()));
    m
}));
    ...
    let mut m = indexmap::IndexMap::new();
        m.insert("ws".to_string(), Value::Str("wss://wseeapap.okx.com:8443/ws/v5".to_string()));
    m
}));
    m
}));
