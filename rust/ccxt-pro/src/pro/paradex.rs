 ...
 */
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut inserts: Value = self.safe_list_k(data.clone(), "inserts", &[]);
        {
            ...
            while { if !__for_first_577 { i = add(&i, &Value::Int(1)); } __for_first_577 = false; is_less_than(&i, &get_array_length(&inserts)) } {
        ...
        if !is_equal(&symbols, &Value::Null) && is_true(&Value::Bool(is_array(&symbols))) {
            {
                ...
                while { if !__for_first_578 { i = add(&i, &Value::Int(1)); } __for_first_578 = false; is_less_than(&i, &get_array_length(&symbols)) } {
