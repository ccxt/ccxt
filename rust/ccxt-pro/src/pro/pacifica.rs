 ...
 */
    ...
    m
        ...
        let mut ordersToReturn: Value = Value::List(vec![]);
        {
            ...
            while { if !__for_first_568 { i = add(&i, &Value::Int(1)); } __for_first_568 = false; is_less_than(&i, &get_array_length(&results)) } {
 ...
 */
    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut trades: Value = get_value(&self.trades, &symbol);
        {
            ...
            while { if !__for_first_572 { i = add(&i, &Value::Int(1)); } __for_first_572 = false; is_less_than(&i, &get_array_length(&entry)) } {
