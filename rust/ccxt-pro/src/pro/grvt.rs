 ...
 */
    ...
    pub fn handle_ticker(&mut self, mut client: Value, mut message: Value) {
        ...
        client.resolve(&[ticker.clone(), Value::Str(format!("{}{}", Value::Str("ticker::".into()), symbol).into())]);
}
 ...
 */
    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        client.resolve(&[stored.clone(), Value::Str(format!("{}{}", Value::Str("trade::".into()), symbol).into())]);
}
 ...
 */
    ...
    m
        ...
        let mut messageHashes: Value = Value::from(vec![]);
        {
            ...
            let mut marketId: Value = market.as_map().and_then(|__m| __m.get("id")).cloned().unwrap_or(Value::Null);
            let mut unfiedTimeframe: Value = self.safe_string(data.clone(), Value::Int(1), &[Value::Str("1".into())]);
    ...
    pub fn handle_ohlcv(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut market: Value = self.safe_market(&[marketId.clone()]);
        let mut symbol: Value = market.as_map().and_then(|__m| __m.get("symbol")).cloned().unwrap_or(Value::Null);
        let mut secondPart: Value = self.safe_string(parts.clone(), Value::Int(1), &[Value::Str("".into())]);
 ...
 */
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        if isSnapshotChannel || isSnapshotMessage {
            ...
            self.handle_deltas_with_keys(get_value(&orderbook, &Value::Str("asks".into())), asks.clone(), &[Value::Str("price".into()), Value::Str("size".into())]);
            self.handle_deltas_with_keys(get_value(&orderbook, &Value::Str("bids".into())), bids.clone(), &[Value::Str("price".into()), Value::Str("size".into())]);
        ...
        add_element_to_object(&mut orderbook, &Value::Str("nonce".into()), sequenceNumber.clone());
