 ...
 */
    ...
    m
            ...
            let mut keys: Value = object_keys(&self.timeframes);
            {
                ...
                while { if !__for_first_526 { j = add(&j, &Value::Int(1)); } __for_first_526 = false; is_less_than(&j, &get_array_length(&keys)) } {
        ...
        let mut marketIds: Value = object_keys(&updates);
        {
            ...
            while { if !__for_first_529 { i = add(&i, &Value::Int(1)); } __for_first_529 = false; is_less_than(&i, &get_array_length(&marketIds)) } {
            ...
            let mut timeframes: Value = object_keys(&get_value(&updates, &marketId));
            {
                ...
                while { if !__for_first_528 { j = add(&j, &Value::Int(1)); } __for_first_528 = false; is_less_than(&j, &get_array_length(&timeframes)) } {
 ...
 */
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut nonce: Value = Value::Null;
        {
            ...
            while { if !__for_first_530 { i = add(&i, &Value::Int(1)); } __for_first_530 = false; is_less_than(&i, &get_array_length(&payload)) } {
