 ...
 */
    ...
    pub fn handle_trades(&mut self, mut client: Value, mut message: Value) {
        ...
        });
        {
            ...
            while { if !__for_first_516 { i = add(&i, &Value::Int(1)); } __for_first_516 = false; is_less_than(&i, &get_array_length(&payload)) } {
 ...
 */
    ...
    pub fn handle_ohlcv(&mut self, mut client: Value, mut message: Value) {
        ...
        });
        {
            ...
            while { if !__for_first_519 { i = add(&i, &Value::Int(1)); } __for_first_519 = false; is_less_than(&i, &get_array_length(&payload)) } {
    ...
    m
            ...
            let mut keys: Value = object_keys(&self.timeframes);
            {
                ...
                while { if !__for_first_518 { j = add(&j, &Value::Int(1)); } __for_first_518 = false; is_less_than(&j, &get_array_length(&keys)) } {
        ...
        let mut marketIds: Value = object_keys(&updates);
        {
            ...
            let mut timeframes: Value = object_keys(&get_value(&updates, &marketId));
            {
                ...
                while { if !__for_first_520 { j = add(&j, &Value::Int(1)); } __for_first_520 = false; is_less_than(&j, &get_array_length(&timeframes)) } {
 ...
 */
    ...
    pub fn handle_order_book(&mut self, mut client: Value, mut message: Value) {
        ...
        let mut nonce: Value = Value::Null;
        {
            ...
            while { if !__for_first_522 { i = add(&i, &Value::Int(1)); } __for_first_522 = false; is_less_than(&i, &get_array_length(&payload)) } {
