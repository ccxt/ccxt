...
impl Cex {
    ...
    #[inline]
    fn core_mut(&mut self) -> &mut CexCore {
        &mut self.core
    }
...
impl crate::typed::TypedExchange for Cex {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Cex::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Cex::markets(self) }
}
