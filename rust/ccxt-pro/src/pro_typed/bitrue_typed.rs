...
impl Bitrue {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(BitrueCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Bitrue {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Bitrue::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Bitrue::markets(self) }
}
