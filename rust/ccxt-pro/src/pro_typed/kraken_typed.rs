...
impl Kraken {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(KrakenCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Kraken {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Kraken::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Kraken::markets(self) }
}
