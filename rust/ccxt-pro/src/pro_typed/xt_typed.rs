...
impl Xt {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(XtCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Xt {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Xt::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Xt::markets(self) }
}
