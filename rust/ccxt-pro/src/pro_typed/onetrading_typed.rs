...
impl Onetrading {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(OnetradingCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Onetrading {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Onetrading::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Onetrading::markets(self) }
}
