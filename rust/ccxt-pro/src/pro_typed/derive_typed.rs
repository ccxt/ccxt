...
impl Derive {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(DeriveCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Derive {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Derive::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Derive::markets(self) }
}
