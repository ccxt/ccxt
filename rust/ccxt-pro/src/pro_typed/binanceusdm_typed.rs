...
impl Binanceusdm {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(BinanceusdmCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Binanceusdm {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Binanceusdm::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Binanceusdm::markets(self) }
}
