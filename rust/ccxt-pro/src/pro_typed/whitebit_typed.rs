...
impl Whitebit {
    ...
    pub fn with_config(config: Config) -> Self {
        Self { core: Box::new(WhitebitCore::new(config.into_option())) }
    }
...
impl crate::typed::TypedExchange for Whitebit {
    ...
    fn market(&self, symbol: &str) -> crate::Result<Market> { Whitebit::market(self, symbol) }

    fn markets(&self) -> Vec<Market> { Whitebit::markets(self) }
}
