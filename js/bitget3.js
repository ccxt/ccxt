...
module.exports = class bitget3 extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'exceptions': {
                ...
                'exact': {
                    ...
                    '40752': ExchangeError, // {"code":"40752","msg":"The contract business is disabled, if you have any questions, please contact customer service","requestTime":1643901708095,"data":null}
                    ...
                    '40017': ExchangeError, // {"code":"40017","msg":"Parameter verification failed,Number of ordersRange error","requestTime":1643901683652,"data":null}
                ...
                'broad': {
                    ...
                    'order info  not found': ExchangeError,
                },
            },
    ...
    parseTicker (ticker, market = undefined) {
        ...
        const baseVolume = this.safeNumber2 (ticker, 'amount', 'base_volume');
        const quoteVolume = this.safeNumber2 (ticker, 'vol', 'volume_24');
