    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                ...
                'v3': {
                    // Кол-во запросов
                    // На текущий момент количество запросов к API ограничено:
                    // для публичных запросов - 60 запросов в минуту на все эндпоинты;
                    // для приватных запросов - 600 запросов в минуту на все эндпоинты и 100 запросов в минуту на создание \ удаление ордеров;
                    // для Pro аккаунтов - 1200 запросов в минуту на все эндпоинты.
                    'public': {
                        'get': {
                            'timestamp': 1,
                            'currencies': 1,
