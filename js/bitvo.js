...
module.exports = class bitvo extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                'logo': 'https://bitvo.com/wp-content/themes/bitvo/resources/assets/images/logo.png',
                'api': {
                    'public': 'https://apibitvoprod.alphapoint.com:8443/AP',
                    'private': 'https://apibitvoprod.alphapoint.com:8443/AP',
                },
                'www': 'https://bitvo.com',
                'doc': [
                    'https://alphapoint.github.io/slate',
                ],
                'fees': 'https://bitvo.com/fees',
            },
            'api': {
                'public': {
                    'get': [
