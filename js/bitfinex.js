...
module.exports = class bitfinex extends Exchange {
            ...
            'features': {
                ...
                'transfer': {
                    'spot': {
                        'supported': true,
                        'availableMethods': [ ],
                        'requiredParams': [ 'code', 'amount', 'fromaccount', 'toaccount' ],
                        'emulated': false,
                        'authenticated': true,
                    },
                    'margin': {
                ...
                'createOrder': {
                    'spot': {
                        'supported': true,
                        'availableMethods': [ ],
                        'requiredParams': [ 'symbol', 'type', 'side', 'amount' ],
                        'emulated': false,
                        'authenticated': true,
                    },
                    'margin': {
                ...
                'fetchOHLCV': {
                    'spot': {
                        ...
                        'requiredParams': [ 'symbol' ],
                        'emulated': false,
                        'authenticated': v2getcandlestradetimeframesymbolhist,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'withdraw': {
                    'spot': {
                        'supported': true,
                        'availableMethods': [ ],
                        'requiredParams': [ 'code', 'amount', 'address' ],
                        'emulated': false,
                        'authenticated': true,
                    },
                    'margin': {
    ...
    async fetchTransactionFees (codes = undefined, params = {}) {
         ...
         * @param {[str]|undefined} codes not used by bitfinex2 fetchTransactionFees ()
    ...
    async cancelOrder (id, symbol = undefined, params = {}) {
         ...
         * @param {str|undefined} symbol not used by bitfinex cancelOrder ()
         * @param {dict} params extra parameters specific to the bitfinex api endpoint
         * @returns {dict} An [order structure]{@link https://docs.ccxt.com/en/latest/manual.html#order-structure}
         */
        await this.loadMarkets ();
