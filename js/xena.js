...
module.exports = class xena extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'name': 'Xena Exchange',
            'countries': [ 'VC', 'UK' ],
            // 200 per second (order cancellations) => rateLimit = 1000ms / 200 = 5ms between requests
            // 100 per second (candles) => cost = 200 / 100 = 2
            // 50 per second (new orders, heartbeat, Dom ie: market data ) => cost = 200 / 50 = 4
            // 15 per second (snapshot requests: balances, active orders and trade history, positions) => cost = 200 / 15 = 13.3333333
            'rateLimit': 5,
            'has': {
                'CORS': undefined,
                'spot': false,
            ...
            'api': {
                'public': {
                    'get': {
                        'common/currencies': 4,
                        'common/instruments': 4,
                        'common/features': 4,
                        'common/commissions': 4,
                        'common/news': 4,
                        'market-data/candles/{marketId}/{timeframe}': 2,
                        'market-data/market-watch': 4,
                        'market-data/dom/{symbol}': 4,
                        'market-data/candles/{symbol}/{timeframe}': 2,
                        'market-data/trades/{symbol}': 4,
                        'market-data/server-time': 4,
                        'market-data/v2/candles/{symbol}/{timeframe}': 2,
                        'market-data/v2/trades/{symbol}': 4,
                        'market-data/v2/dom/{symbol}/': 4,
                        'market-data/v2/server-time': 4,
                    },
                },
                'private': {
                    'get': {
                        'trading/accounts/{accountId}/order': 13.333,
                        'trading/accounts/{accountId}/active-orders': 13.333,
                        'trading/accounts/{accountId}/last-order-statuses': 13.333,
                        'trading/accounts/{accountId}/positions': 13.333,
                        'trading/accounts/{accountId}/positions-history': 13.333,
                        'trading/accounts/{accountId}/margin-requirements': 13.333,
                        'trading/accounts': 13.333,
                        'trading/accounts/{accountId}/balance': 13.333,
                        'trading/accounts/{accountId}/trade-history': 13.333,
                        // 'trading/accounts/{accountId}/trade-history?symbol=BTC/USDT&client_order_id=EMBB8Veke&trade_id=22013.33343254': 13.333,
                        'transfers/accounts': 13.333,
                        'transfers/accounts/{accountId}': 13.333,
                        'transfers/accounts/{accountId}/deposit-address/{currency}': 13.333,
                        'transfers/accounts/{accountId}/deposits': 13.333,
                        'transfers/accounts/{accountId}/trusted-addresses': 13.333,
                        'transfers/accounts/{accountId}/withdrawals': 13.333,
                        'transfers/accounts/{accountId}/balance-history': 13.333,
                        // 'transfers/accounts/{accountId}/balance-history?currency={currency}&from={time}&to={time}&kind={kind}&kind={kind}': 13.333,
                        // 'transfers/accounts/{accountId}/balance-history?page={page}&limit={limit}': 13.333,
                        // 'transfers/accounts/{accountId}/balance-history?txid=3e13.333db982c4eed2d6355e276c5bae01a52a27c9cef61574b0e8c67ee05fc26ccf': 13.333,
                    },
                    'post': {
                        'trading/order/new': 4,
                        'trading/order/heartbeat': 4,
                        'trading/order/cancel': 1,
                        'trading/order/mass-cancel': 1,
                        'trading/order/replace': 4,
                        'trading/position/maintenance': 4,
                        'transfers/accounts/{accountId}/withdrawals': 4,
                        'transfers/accounts/{accountId}/deposit-address/{currency}': 4,
                    },
                },
            },
            'fees': {
