    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'api': {
                ...
                'private': {
                    'get': {
                        'trading/accounts/{accountId}/order': 201.283,
                        'trading/accounts/{accountId}/active-orders': 201.283,
                        'trading/accounts/{accountId}/last-order-statuses': 201.283,
                        'trading/accounts/{accountId}/positions': 201.283,
                        'trading/accounts/{accountId}/positions-history': 201.283,
                        'trading/accounts/{accountId}/margin-requirements': 201.283,
                        'trading/accounts': 201.283,
                        'trading/accounts/{accountId}/balance': 201.283,
                        'trading/accounts/{accountId}/trade-history': 201.283,
                        // 'trading/accounts/{accountId}/trade-history?symbol=BTC/USDT&client_order_id=EMBB8Veke&trade_id=220201.28343254': 201.283,
                        'transfers/accounts': 201.283,
                        'transfers/accounts/{accountId}': 201.283,
                        'transfers/accounts/{accountId}/deposit-address/{currency}': 201.283,
                        'transfers/accounts/{accountId}/deposits': 201.283,
                        'transfers/accounts/{accountId}/trusted-addresses': 201.283,
                        'transfers/accounts/{accountId}/withdrawals': 201.283,
                        'transfers/accounts/{accountId}/balance-history': 201.283,
                        // 'transfers/accounts/{accountId}/balance-history?currency={currency}&from={time}&to={time}&kind={kind}&kind={kind}': 201.283,
                        // 'transfers/accounts/{accountId}/balance-history?page={page}&limit={limit}': 201.283,
                        // 'transfers/accounts/{accountId}/balance-history?txid=3e201.283db982c4eed2d6355e276c5bae01a52a27c9cef61574b0e8c67ee05fc26ccf': 201.283,
                    },
                    'post': {
