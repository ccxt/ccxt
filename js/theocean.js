        ...
        return this.deepExtend (super.describe (), {
            ...
            'exceptions': {
                ...
                'broad': {
                    ...
                    'Fillable amount under minimum': InvalidOrder, // {"message":"Intent validation failed.","errors":[{"message":"Fillable amount under minimum WETH trade size.","type":"paramQuoteTokenAmount"}]}
                    'Fillable amount over maximum': InvalidOrder, // {"message":"Intent validation failed.","errors":[{"message":"Fillable amount over maximum TUSD trade size.","type":"paramQuoteTokenAmount"}]}
                },
            },
            'options': {
