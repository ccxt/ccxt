...
module.exports = class delta extends Exchange {
    ...
    async fetchLeverageTiers (symbol = undefined, params = {}) {
        ...
        for (let i = 0; i < symbols.length; i++) {
            ...
            //            contract_unit_currency: 'BTC',
            //            contract_type: 'perpetual_futures',
            //            launch_time: '2020-04-04T14:49:18Z',
            ...
            //            notional_type: 'vanilla',
            //            auction_finish_time: null,
            //            default_leverage: '10.000000000000000000', // *
            //            short_description: 'Bitcoin Perp Futures',
            //            spot_index: {
            //                config: {
            //                    impact_size: {
            ...
            //                  10, 25, 50, 100
            //                ], // *
            //                price_clubbing_values: [ 0.5, 1, 2.5, 5, 10, 25 ],
            //                show_bracket_orders: false,
            //                sort_priority: '1',
            //                tags: []
            //            },
            ...
            //            liquidation_penalty_factor: '0.2',
            //            underlying_asset: {
            //                base_withdrawal_fee: '0.000500000000000000',
            //                deposit_status: 'enabled',
            //                id: '2',
            //                interest_credit: false,
            //                interest_slabs: null,
            //                kyc_deposit_limit: '10.000000000000000000',
            //                kyc_withdrawal_limit: '0.500000000000000000',
            ...
            if (market['contract']) {
                ...
                while (Precise.stringLt (floor, maxVol)) {
                    ...
                    tiers.push ({
                        ...
                        'maintenanceMarginRate': this.parseNumber (maintenanceMargin),
                        'maxLeverage': this.parseNumber (Precise.stringDiv ('1', initialMargin)),
                        'info': info,
                    });
                    maintenanceMargin = Precise.stringAdd (maintenanceMargin, riskIncrMmr);
                    initialMargin = Precise.stringAdd (initialMargin, riskIncrImr);
                    floor = cap;
                }
