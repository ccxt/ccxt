...
module.exports = class mexc extends Exchange {
    ...
    async fetchContractMarkets (params = {}) {
        ...
        //                 "amountScale":4, // base currency precision
        //                 "priceUnit":0.5,
    ...
    async createSwapOrder (symbol, type, side, amount, price = undefined, params = {}) {
        ...
        if ((side !== 1) && (side !== 2) && (side !== 3) && (side !== 4)) {
            throw new InvalidOrder (this.id + ' createSwapOrder () "side" argument must be 1 open long, 2 close short, 3 open short or 4 close long');
        }
        const request = {
            'symbol': market['id'],
