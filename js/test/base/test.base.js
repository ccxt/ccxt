...
function testExchangeConfigExtension () {
    ...
    const precision = { 'amount': this.parseNumber ('0.001') }
    ...
    deepEqual (exchange.markets['ETH/BTC'].precision, { 'price': this.parseNumber ('0.000001'), 'amount': this.parseNumber ('0.001') })
