...
assert (decimalToPrecision ('0.00000000', TRUNCATE, 9, DECIMAL_PLACES, PAD_WITH_ZERO) === '0.00000000');
assert (decimalToPrecision ('0.00000001', TRUNCATE, 9, DECIMAL_PLACES, PAD_WITH_ZERO) === '0.00000001');
