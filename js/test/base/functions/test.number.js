...
assert (Precise.stringEquals (Precise.stringMin ('1.0000', '2'), '1'));
assert (Precise.stringEquals (Precise.stringMin ('2', '1.2345'), '1.2345'));
assert (Precise.stringEquals (Precise.stringMin ('3.1415', '-2'), '-2'));
assert (Precise.stringEquals (Precise.stringMin ('-3.1415', '-2'), '-3.1415'));
assert (Precise.stringEquals (Precise.stringMin ('0.000', '-0.0'), '0'));

assert (Precise.stringEquals (Precise.stringMax ('1.0000', '2'), '2'));
assert (Precise.stringEquals (Precise.stringMax ('2', '1.2345'), '2'));
assert (Precise.stringEquals (Precise.stringMax ('3.1415', '-2'), '3.1415'));
assert (Precise.stringEquals (Precise.stringMax ('-3.1415', '-2'), '-2'));
assert (Precise.stringEquals (Precise.stringMax ('0.000', '-0.0'), '0'));
