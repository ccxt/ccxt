...
const functions = require ('ccxt/js/base/functions.js')
...
const {
    ...
    , DDoSProtection
    , RequestTimeout
    , ExchangeNotAvailable } = require ('ccxt/js/base/errors.js')

process.exit ()

const { TRUNCATE, ROUND, DECIMAL_PLACES } = functions.precisionConstants

const defaultFetch = typeof (fetch) === "undefined" ? require ('ccxt/js/static_dependencies/fetch-ponyfill/fetch-node') ().fetch : fetch
...
module.exports = class Exchange {
    ...
    describe () {
        return {
            ...
            'orderBooks': {}, // managed by websocket code
