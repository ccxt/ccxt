...
module.exports = class Exchange {
    ...
    calculateFee (symbol, type, side, amount, price, takerOrMaker = 'taker', params = {}) {
        if (type === 'market' && takerOrMaker === 'taker') {
            throw new ArgumentsRequired (this.id + ' calculateFee() - you have provided incompatible arguments - "market" type order can not be "taker". Change either the "type" or the "takerOrMaker" argument to calculate the fee');
        }
