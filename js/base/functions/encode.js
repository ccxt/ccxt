...
module.exports =
    ...
    , urlencode: (object, format = 'indices') => qs.stringify (object, { arrayFormat: format })
    , rawencode: (object, format = 'indices') => qs.stringify (object, { encode: false, arrayFormat: format })
