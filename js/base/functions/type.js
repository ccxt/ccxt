...
module.exports = {
    ...
    , safeIntegerDivide:  (o, k, $divisor, $default, n = asInteger (prop (o, k))) => (isNumber (n)          ? parseInt (n / $divisor)   : $default)
    ...
    , safeIntegerDivide2:  (o, k1, k2, $factor, $default, n = asInteger (prop2 (o, k1, k2))) => (isNumber (n)          ? parseInt (n / $divisor)   : $default)
