...
module.exports = {
    ...
    , safeTimestamp:      (o, k,          $default, n = asInteger (prop (o, k))) => (isNumber (n)          ? parseInt (parseFloat (n) * 1000) : $default)
    ...
    , safeTimestamp2:      (o, k1, k2,          $default, n = asInteger (prop2 (o, k1, k2))) => (isNumber (n)          ? parseInt (parseFloat (n) * 1000) : $default)
