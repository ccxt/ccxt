...
module.exports = class stex extends Exchange {
            ...
            'features': {
                ...
                'fetchTradingFee': {
                    'spot': {
                        ...
                        'requiredParams': [ 'symbol' ],
                        'emulated': false,
                        'authenticated': tradinggetfeescurrencypairid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchBalance': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': profilegetwallets,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'createOrder': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': tradingpostorderscurrencypairid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchOrder': {
                    'spot': {
                        ...
                        'requiredParams': [ 'id' ],
                        'emulated': false,
                        'authenticated': tradinggetorderorderid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchClosedOrder': {
                    'spot': {
                        ...
                        'requiredParams': [ 'id' ],
                        'emulated': false,
                        'authenticated': reportsgetordersorderid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'cancelOrder': {
                    'spot': {
                        ...
                        'requiredParams': [ 'id' ],
                        'emulated': false,
                        'authenticated': tradingdeleteorderorderid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchMyTrades': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': reportsgettradescurrencypairid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'createDepositAddress': {
                    'spot': {
                        ...
                        'requiredParams': [ 'code' ],
                        'emulated': false,
                        'authenticated': profilepostwalletscurrencyid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchDepositAddress': {
                    'spot': {
                        ...
                        'requiredParams': [ 'code' ],
                        'emulated': false,
                        'authenticated': profilegetwalletswalletid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchDeposit': {
                    'spot': {
                        ...
                        'requiredParams': [ 'id' ],
                        'emulated': false,
                        'authenticated': profilegetdepositsid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchDeposits': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': profilegetdeposits,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchWithdrawal': {
                    'spot': {
                        ...
                        'requiredParams': [ 'id' ],
                        'emulated': false,
                        'authenticated': profilegetwithdrawalsid,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchWithdrawals': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': profilegetwithdrawals,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'withdraw': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': profilepostwithdraw,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
    ...
    async cancelOrder (id, symbol = undefined, params = {}) {
         ...
         * @param {str} id order id
         * @param {str|undefined} symbol not used by stex cancelOrder ()
         * @param {dict} params extra parameters specific to the stex api endpoint
         * @returns {dict} An [order structure]{@link https://docs.ccxt.com/en/latest/manual.html#order-structure}
         */
        await this.loadMarkets ();
    ...
    async fetchDeposit (id, code = undefined, params = {}) {
         ...
         * @param {str|undefined} code not used by stex fetchDeposit ()
         * @param {dict} params extra parameters specific to the stex api endpoint
    ...
    async fetchWithdrawal (id, code = undefined, params = {}) {
         ...
         * @param {str|undefined} code not used by stex.fetchWithdrawal
         * @param {dict} params extra parameters specific to the stex api endpoint
         * @returns {dict} a [transaction structure]{@link https://docs.ccxt.com/en/latest/manual.html#transaction-structure}
         */
        await this.loadMarkets ();
