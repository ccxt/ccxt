...
module.exports = class kucoinfutures extends kucoin {
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {}) {
         ...
         * @param {boolean} params.reduceOnly A mark to reduce the position size only. Set to false by default. Need to set the position size when reduceOnly is true.
         ...
         * @param {boolean} params.closeOrder set to true to close position
         * @param {boolean} params.forceHold A mark to forcely hold the funds for an order, even though it's an order to reduce the position size. This helps the order stay on the order book and not get canceled when the position size changes. Set to false by default.
