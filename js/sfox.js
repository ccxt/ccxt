...
module.exports = class sfox extends Exchange {
  describe() {
    ...
    // fetchTrades (symbol, since, limi, params = {}) {}
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {}) {
      ...
      if (side === 'sell') {
        const order = await this.privatePostOrdersSell (this.extend (request, params));
      } else {
        const order = await this.privatePostOrdersBuy (this.extend (request, params));
      }
