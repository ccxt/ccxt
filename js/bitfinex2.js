...
module.exports = class bitfinex2 extends Exchange {
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {}) {
         ...
         * @param {number} params.flags additional order parameters: 4096 (Post Only), 1024 (Reduce Only), 16384 (OCO), 64 (Hidden), 512 (Close), 524288 (No Var Rates)
         * @param {number} params.lev leverage for a derivative order, supported by derivative symbol orders only. The value should be between 1 and 100 inclusive.
