...
module.exports = class bitrecife extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'hostname': 'exchange.bitrecife.com.br',
            'urls': {
                'logo': 'https://exchange.bitrecife.com.br/config/assets/logo-login.svg',
                'api': {
                    'v3Private': 'https://{hostname}/api/v3/private',
                    'v3Public': 'https://{hostname}/api/v3/public',
                },
                'www': ['https://exchange.bitrecife.com.br'],
                'doc': [
                    'https://app.swaggerhub.com/apis-docs/bleu/white-label/3.0.0',
                ],
                'fees': 'https://exchange.bitrecife.com.br/fees/',
            },
            'api': {
                'v3Public': {
                    'get': [
        ...
        // https://exchange.bitrecife.com.br/api/v3/public/tradingview/symbols?symbol=ETH_BTC
        // https://exchange.bitrecife.com.br/api/v3/public/tradingview/config
        // https://exchange.bitrecife.com.br/api/v3/public/tradingview/time
        // https://exchange.bitrecife.com.br/api/v3/private/getcloseorders?market=ETH_BTC
        // https://exchange.bitrecife.com.br/config contains the fees
    }
