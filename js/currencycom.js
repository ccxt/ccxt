            ...
            'api': { // rate-limits described at: https://currency.com/api-get-started
                ...
                'private': {
                    'get': {
                        ...
                        'v1/deposits': 10,
                        'v2/deposits': 10,
                        'v1/depositAddress': 10,
                        'v2/depositAddress': 10,
                        'v1/ledger': 10,
                        'v2/ledger': 10,
                        'v1/leverageSettings': 10,
                        'v2/leverageSettings': 10,
                        'v1/myTrades': 10,
                        'v2/myTrades': 10,
                        'v1/openOrders': 10,
                        'v2/openOrders': 10,
                        'v1/tradingPositions': 10,
                        'v2/tradingPositions': 10,
                        'v1/tradingPositionsHistory': 10,
                        'v2/tradingPositionsHistory': 10,
                        'v1/transactions': 10,
                        'v2/transactions': 10,
                        'v1/withdrawals': 10,
                        'v2/withdrawals': 10,
                    ...
                    'post': {
                        'v1/order': 10,
                        'v2/order': 10,
                        'v1/updateTradingPosition': 10,
                        'v2/updateTradingPosition': 10,
                        'v1/updateTradingOrder': 10,
                        'v2/updateTradingOrder': 10,
                        'v1/closeTradingPosition': 10,
                        'v2/closeTradingPosition': 10,
                    },
                    'delete': {
                        'v1/order': 10,
                        'v2/order': 10,
