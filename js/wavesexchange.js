            ...
            'features': {
                ...
                'fetchOrderBook': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': matchergetmatcherorderbookamountassetpriceasset,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'createOrder': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': matcherpostmatcherorderbookmarket,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'cancelOrder': {
                    'spot': {
                        ...
                        'requiredParams': [ 'id' ],
                        'emulated': false,
                        'authenticated': forwardpostmatcherorderswavesaddresscancel,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchOpenOrders': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': forwardgetmatcherordersaddress,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'fetchBalance': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': nodegetaddressesbalanceaddress,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
                ...
                'withdraw': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': nodeposttransactionsbroadcast,
                    },
                    'margin': {
                        'supported': false,
                        'availableMethods': [ ],
