...
const { ExchangeError, ArgumentsRequired, ExchangeNotAvailable, AuthenticationError, InvalidOrder, InvalidAddress, InsufficientFunds, OrderNotFound, PermissionDenied, BadRequest } = require ('./base/errors');
...
module.exports = class newtonxchange extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'www': 'https://www.newtonxchange.pro',
                'fees': 'https://www.newtonxchange.pro/cms/tradingfee',
            },
            'api': {
                'public': {
                    'get': [
            ...
            'exceptions': {
                ...
                '23': ArgumentsRequired, // Lack of parameters of numbers of transaction
                '24': ArgumentsRequired, // Lack of parameters of transaction price
                '100001': ExchangeError, // System is abnormal
                '100002': ExchangeNotAvailable, // Update System
                '100004': ArgumentsRequired, // {"code":"100004","msg":"request parameter illegal","data":null}
                ...
                '110003': PermissionDenied, // fund password error
                '110004': PermissionDenied, // fund password error
    ...
    async fetchOrders (symbol = undefined, since = undefined, limit = undefined, params = {}) {
        return await this.fetchOrdersWithMethod ('privateGetAllOrder', symbol, since, limit, params);
    }

    async fetchOpenOrders (symbol = undefined, since = undefined, limit = undefined, params = {}) {
        return await this.fetchOrdersWithMethod ('privateGetNewOrder', symbol, since, limit, params);
    }
