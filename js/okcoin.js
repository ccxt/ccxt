...
module.exports = class okcoin extends Exchange {
            ...
            'features': {
                ...
                'fetchMarkets': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': fetchmarketsbytype,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'fetchDepositAddress': {
                    'spot': {
                        ...
                        'requiredParams': [ 'code' ],
                        'emulated': false,
                        'authenticated': accountgetdepositaddress,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'transfer': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': accountposttransfer,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'withdraw': {
                    'spot': {
                        ...
                        'emulated': false,
                        'authenticated': accountpostwithdrawal,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
    ...
    async fetchPositions (symbols = undefined, params = {}) {
         ...
         * @param {[str]|undefined} symbols not used by okcoin fetchPositions
         * @param {dict} params extra parameters specific to the okcoin api endpoint
