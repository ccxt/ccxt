...
import type { Balances, Bool, Currency, CurrencyInterface, Greeks, Int, Market, MarketInterface, NullableDict, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Position, Leverage, MarginMode, Num, Option, MarginModification, Currencies, Dict, Dictionary, OpenInterest, int, LedgerEntry, FundingRate, FundingRates, DepositAddress, ADL, Status } from './base/types.js';
/**
 * @class delta
 * @augments Exchange
 */
export default class delta extends Exchange {
    ...
    loadMarkets(reload?: Bool, params?: Dict): Promise<Dictionary<Market>>;
    ...
    sign(path: any, api?: any, method?: Str, params?: Dict, headers?: NullableDict, body?: any): Dict;
