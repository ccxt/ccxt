...
export const getTotalBalanceFromOutputs = (outputs) => outputs.reduce((prev, cur) => prev.plus(BigNumber(cur.amount)), BigNumber('0'));
export const encodeScript = (threshold) => {
 ...
 * */
export const buildMultiSigsTransaction = (transaction) => {
    if (transaction.version !== TxVersion)
