...
export default class coinmate extends Exchange {
    ...
    parseTransaction(transaction: NullableDict, currency?: Currency): Transaction;
    /**
     * @method
    ...
    nonce(): number;
    sign(path: any, api?: any, method?: string, params?: Dict, headers?: NullableDict, body?: any): Dict;
