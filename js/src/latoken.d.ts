...
export default class latoken extends Exchange {
    ...
    fetchPublicTradingFee(symbol: string, params?: Dict): Promise<TradingFeeInterface>;
    fetchPrivateTradingFee(symbol: string, params?: Dict): Promise<TradingFeeInterface>;
    /**
     * @method
