...
import type { Balances, Currency, CurrencyInterface, Currencies, Int, Market, Order, OrderBook, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, OHLCV, Num, Account, TradingFeeInterface, Dict, int, LedgerEntry, DepositAddress, NullableDict, DepositWithdrawFee } from './base/types.js';
/**
 * @class luno
 * @augments Exchange
 */
export default class luno extends Exchange {
    ...
    fetchOrdersByState(state: Str, symbol?: Str, since?: Int, limit?: Int, params?: Dict): Promise<Order[]>;
    /**
     * @method
    ...
    fetchLedgerByEntries(code?: Str, entry?: any, limit?: Int, params?: Dict): Promise<LedgerEntry[]>;
    /**
     * @method
    ...
    parseLedgerEntry(entry: Dict, currency?: Currency): LedgerEntry;
    /**
     * @method
    ...
    sign(path: any, api?: any, method?: Str, params?: Dict, headers?: NullableDict, body?: Str): Dict;
