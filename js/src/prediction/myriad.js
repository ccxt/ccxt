...
export default class myriad extends Exchange {
     ...
     */
    async fetchTradeQuote(symbol, side, amount, params = {}) {
     ...
     * @returns {object} an [order structure](https://docs.ccxt.com/#/?id=order-structure)
     */
    async createOrderbookOrder(symbol, type, side, amount, price = undefined, params = {}) {
        ...
        const outcomeObj = this.outcome(symbol);
        return this.parseOrder(wrapper, outcomeObj);
    }
    /**
     * @ignore
     * @method
     ...
     */
    buildOrderbookOrder(symbol, type, side, amount, price = undefined, params = {}) {
     ...
     * @returns {object} an [order structure](https://docs.ccxt.com/#/?id=order-structure)
     */
    async createAmmOrder(symbol, type, side, amount, price = undefined, params = {}) {
        if (this.privateKey === undefined) {
    ...
    async fetchTradingFee(symbol, params = {}) {
        ...
        return {
            'info': response,
            'symbol': this.safeSymbol(undefined, outcomeObj),
     ...
     * @returns {object} an [order book structure](https://docs.ccxt.com/#/?id=order-book-structure)
     */
    parseWeiOrderBook(response, symbol) {
