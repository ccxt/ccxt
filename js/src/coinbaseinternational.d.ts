...
import type { Int, Num, OrderSide, OrderType, Order, Trade, Ticker, Str, Transaction, Balances, Tickers, Strings, Market, Currency, CurrencyInterface, TransferEntry, Position, FundingRateHistory, Currencies, Dict, NullableDict, int, OHLCV, DepositAddress, MarginModification, Account, FundingHistory } from './base/types.js';
/**
...
export default class coinbaseinternational extends Exchange {
    describe(): any;
    handlePortfolioAndParams(methodName: string, params?: Dict): Promise<[Str, Dict]>;
    handleNetworkIdAndParams(currencyCode: string, methodName: string, params?: Dict): Promise<[Str, Dict]>;
    /**
     * @method
    ...
    loadCurrencyNetworks(code: string, params?: Dict): Promise<boolean>;
