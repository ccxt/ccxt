...
import { AuthenticationError, ExchangeError, ArgumentsRequired, PermissionDenied, InvalidOrder, OrderNotFound, InsufficientFunds, BadRequest, RateLimitExceeded, InvalidNonce, NotSupported, InvalidAddress } from './base/errors.js';
...
export default class bybit extends Exchange {
    ...
    async createContractOrder(symbol, type, side, amount, price = undefined, params = {}) {
        ...
        const request = {
            'symbol': market['id'],
            'side': this.capitalize(side),
            'order_type': this.capitalize(lowerCaseType),
            'time_in_force': 'GoodTillCancel',
            'qty': amount,
