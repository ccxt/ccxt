...
import type { Balances, Currency, Dict, Int, Market, NullableDict, Num, OHLCV, Order, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, Transaction, int, List } from './base/types.js';
/**
 * @class mercado
 * @augments Exchange
 */
