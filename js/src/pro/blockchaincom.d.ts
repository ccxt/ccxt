...
export default class blockchaincom extends blockchaincomRest {
    ...
    parseWsUpdatedTicker(ticker: any, lastTicker?: undefined, market?: undefined): import("../base/types.js").Ticker;
    ...
    parseCountedBidAsk(bidAsk: any, priceKey?: IndexType, amountKey?: IndexType, countKey?: IndexType): import("../base/types.js").Num[];
    parseCountedBidsAsks(bidasks: any, priceKey?: IndexType, amountKey?: IndexType, countKey?: IndexType): never[];
