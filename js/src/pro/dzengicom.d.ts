import dzengicomRest from '../dzengicom.js';
import type { Int, OrderBook, Trade, Ticker, OHLCV, Balances } from '../base/types.js';
import Client from '../base/ws/Client.js';
export default class dzengicom extends dzengicomRest {
    describe(): any;
    ping(client: Client): {
        destination: string;
        correlationId: any;
