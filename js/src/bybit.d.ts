...
export default class bybit extends Exchange {
     ...
     * @returns {any} nothing
     */
    upgradeUnifiedTradeAccount(params?: Dict): Promise<any>;
     ...
     */
    fetchOpenInterestHistory(symbol: string, timeframe?: Str, since?: Int, limit?: Int, params?: Dict): Promise<OpenInterest[]>;
