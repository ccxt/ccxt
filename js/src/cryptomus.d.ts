...
import type { Balances, Currencies, Dict, int, Int, Market, Num, Order, OrderBook, OrderType, OrderSide, Str, Strings, Ticker, Tickers, Trade, TradingFees, CurrencyInterface, List, NullableDict } from './base/types.js';
/**
 * @class cryptomus
 * @augments Exchange
 */
