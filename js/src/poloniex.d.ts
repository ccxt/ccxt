...
import type { TransferEntry, Int, Leverage, OrderSide, OrderType, OHLCV, Trade, OrderBook, Order, Balances, Str, MarginModification, Transaction, Ticker, Tickers, Market, Strings, Currency, CurrencyInterface, Num, Currencies, TradingFees, Dict, int, DepositAddress, Position, NullableDict, List, DepositWithdrawFees, PositionModeInfo } from './base/types.js';
/**
 * @class poloniex
 * @augments Exchange
 */
export default class poloniex extends Exchange {
    ...
    orderRequest(symbol: string, type: OrderType, side: OrderSide, amount: Num, request: Dict, price?: Num, params?: Dict): [Dict, Dict];
    /**
     * @method
    ...
    fetchOrderStatus(id: string, symbol?: Str, params?: Dict): Promise<"closed" | "open">;
    /**
     * @method
    ...
    parseDepositAddressSpecial(response: Dict, currency: CurrencyInterface, networkEntry: Dict): DepositAddress;
    /**
     * @method
    ...
    fetchTransactionsHelper(code?: Str, since?: Int, limit?: Int, params?: Dict): Promise<Dict>;
    /**
     * @method
    ...
    parseDepositWithdrawFees(response: Dict, codes?: Strings, currencyIdKey?: Str): Dict;
