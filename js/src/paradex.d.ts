...
export default class paradex extends Exchange {
    ...
    parseOHLCV(ohlcv: List, market?: Market): OHLCV;
    /**
     * @method
     ...
     */
    fetchOpenInterest(symbol: string, params?: Dict): Promise<import("./base/types.js").OpenInterest>;
    parseOpenInterest(interest: Dict, market?: Market): import("./base/types.js").OpenInterest;
    ...
    parseBalance(response: List): Balances;
    /**
     * @method
    ...
    parseLiquidation(liquidation: Dict, market?: Market): Liquidation;
    /**
     * @method
