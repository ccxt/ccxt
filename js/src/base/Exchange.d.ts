...
export declare class BaseExchange {
     ...
     */
    getDispatcherOptions(isPlainAgent?: boolean): Dict;
    /**
     * @ignore
     * @method
    ...
    filterByLimit(array: Dict[], limit?: Int, key?: IndexType, fromStart?: boolean): any;
    ...
    safeNumberOmitZero(obj: object, key: NullableIndexType, defaultValue?: Num): Num;
    safeIntegerOmitZero(obj: object, key: NullableIndexType, defaultValue?: Int): Int;
    afterConstruct(): void;
    ...
    parseOrders(orders: Dict | Dict[] | undefined, market?: Market, since?: Int, limit?: Int, params?: {}): Order[];
    ...
    parsePositions(positions: Dict | List, symbols?: Strings, params?: {}): Position[];
    parseADLRank(info: Dict, market?: Market): ADL;
    parseADLRanks(ranks: Dict | List, symbols?: Strings, params?: {}): ADL[];
    parseAccounts(accounts: Dict | List, params?: {}): Account[];
    parseTradesHelper(isWs: boolean, trades: Dict | List, market?: Market, since?: Int, limit?: Int, params?: {}): Trade[];
    ...
    parseTransactions(transactions: Dict | List, currency?: Currency, since?: Int, limit?: Int, params?: {}): Transaction[];
    parseTransfers(transfers: Dict | List, currency?: Currency, since?: Int, limit?: Int, params?: {}): TransferEntry[];
    ...
    parseConversions(conversions: Dict | List, code?: Str, fromCurrencyKey?: Str, toCurrencyKey?: Str, since?: Int, limit?: Int, params?: {}): Conversion[];
