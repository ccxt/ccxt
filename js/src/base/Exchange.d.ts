...
export default class Exchange {
    ...
    safeString: (o: any, k: IndexType, $default?: string | undefined) => Str;
    safeString2: (o: any, k1: IndexType, k2: IndexType, $default?: string | undefined) => Str;
    safeFloat: (o: any, k: IndexType, $default?: number | undefined) => number;
    safeFloat2: (o: any, k1: IndexType, k2: IndexType, $default?: number | undefined) => number;
    seconds: () => number;
    milliseconds: () => number;
    binaryToBase16: (data: Uint8Array) => string;
    numberToBE: (n: number, padding: number) => Uint8Array;
    base16ToBinary: (str: string) => Uint8Array;
    iso8601: (timestamp: any) => string | undefined;
    omit: (x: any, ...args: any[]) => any;
    isJsonEncodedObject: (object: any) => boolean;
    safeInteger: (o: any, k: IndexType, $default?: number | undefined) => Int;
    sum: (...xs: any[]) => any;
    omitZero: typeof functions.omitZero;
    implodeParams: (string: any, params: any) => any;
    extractParams: (string: any) => never[];
    ...
    safeInteger2: (o: any, k1: IndexType, k2: IndexType, $default?: number | undefined) => Int;
    safeStringLower: (o: any, k: IndexType, $default?: string | undefined) => Str;
    parse8601: (x: any) => number | undefined;
    yyyymmdd: (timestamp: any, infix?: string) => string;
    safeStringUpper: (o: any, k: IndexType, $default?: string | undefined) => Str;
    safeTimestamp: (o: any, k: IndexType, $default?: number | undefined) => number | undefined;
    ...
    uuid22: (a?: any) => string;
    safeIntegerProduct2: (o: any, k1: IndexType, k2: IndexType, $factor: number, $default?: number | undefined) => Int;
    safeIntegerProduct: (o: any, k: IndexType, $factor: number, $default?: number | undefined) => Int;
    binaryToBase58: (data: Uint8Array) => string;
    base58ToBinary: (str: string) => Uint8Array;
    base64ToBinary: (str: string) => Uint8Array;
    safeTimestamp2: (o: any, k1: IndexType, k2: IndexType, $default?: any) => Int;
    rawencode: (object: any) => string;
    keysort: (x: any, out?: {}) => {};
    inArray: (needle: any, haystack: any) => any;
    safeStringLower2: (o: any, k1: IndexType, k2: IndexType, $default?: string | undefined) => Str;
    safeStringUpper2: (o: any, k1: IndexType, k2: IndexType, $default?: string | undefined) => Str;
    isEmpty: (object: any) => boolean;
    ordered: (x: any) => any;
    filterBy: (x: any, k: any, value?: undefined, out?: never[]) => never[];
    uuid16: (a?: any) => string;
    ...
    safeFloatN: (o: any, k: IndexType[], $default?: number | undefined) => number;
    safeIntegerN: (o: any, k: IndexType[], $default?: number | undefined) => Int;
    safeIntegerProductN: (o: any, k: IndexType[], $factor: number, $default?: number | undefined) => Int;
    safeTimestampN: (o: any, k: IndexType[], $default?: number | undefined) => Int;
    safeValueN: (o: any, k: IndexType[], $default?: any) => any;
    safeStringN: (o: any, k: IndexType[], $default?: string | undefined) => Str;
    safeStringLowerN: (o: any, k: IndexType[], $default?: string | undefined) => Str;
    safeStringUpperN: (o: any, k: IndexType[], $default?: string | undefined) => Str;
    urlencodeNested: (object: any) => string;
    parseDate: (x: any) => number | undefined;
    ...
    defineRestApi(api: any, methodName: any, paths?: never[]): void;
    log(...args: any[]): void;
    fetch(url: any, method?: string, headers?: any, body?: any): Promise<any>;
    parseJson(jsonString: any): any;
    getResponseHeaders(response: any): {};
    handleRestResponse(response: any, url: any, method?: string, requestHeaders?: undefined, requestBody?: undefined): any;
    ...
    watch(url: any, messageHash: any, message?: undefined, subscribeHash?: undefined, subscription?: undefined): any;
    onConnected(client: any, message?: undefined): void;
    onError(client: any, error: any): void;
    onClose(client: any, error: any): void;
    close(): Promise<never[]>;
    loadOrderBook(client: any, messageHash: any, symbol: any, limit?: undefined, params?: {}): Promise<void>;
    convertToBigInt(value: string): bigint;
    stringToCharsArray(value: any): any;
    valueIsDefined(value: any): boolean;
    arraySlice(array: any, first: any, second?: undefined): any;
    getProperty(obj: any, property: any, defaultValue?: undefined): any;
    ...
    filterByValueSinceLimit(array: object[], field: IndexType, value?: undefined, since?: Int, limit?: Int, key?: string, tail?: boolean): any;
    ...
    fetchRestOrderBookSafe(symbol: any, limit?: undefined, params?: {}): Promise<OrderBook | undefined>;
    ...
    setMarkets(markets: any, currencies?: undefined): Dictionary<any>;
    ...
    reduceFeesByCurrency(fees: any): never[];
    safeTicker(ticker: object, market?: Market): Ticker;
    fetchOHLCV(symbol: string, timeframe?: string, since?: Int, limit?: Int, params?: {}): Promise<OHLCV[]>;
    watchOHLCV(symbol: string, timeframe?: string, since?: Int, limit?: Int, params?: {}): Promise<OHLCV[]>;
    convertTradingViewToOHLCV(ohlcvs: any, timestamp?: string, open?: string, high?: string, low?: string, close?: string, volume?: string, ms?: boolean): never[];
    ...
    fetchWebEndpoint(method: any, endpointMethod: any, returnAsJson: any, startRegex?: undefined, endRegex?: undefined): Promise<any>;
    ...
    parseBidsAsks(bidasks: any, priceKey?: IndexType, amountKey?: IndexType): never[];
    fetchL2OrderBook(symbol: string, limit?: Int, params?: {}): Promise<any>;
    filterBySymbol(objects: any, symbol?: string): any;
    parseOHLCV(ohlcv: any, market?: Market): OHLCV;
    networkCodeToId(networkCode: any, currencyCode?: undefined): Str;
    networkIdToCode(networkId: any, currencyCode?: undefined): Str;
    handleNetworkCodeAndParams(params: any): any[];
    defaultNetworkCode(currencyCode: any): undefined;
    selectNetworkCodeFromUnifiedNetworks(currencyCode: any, networkCode: any, indexedNetworkEntries: any): undefined;
    selectNetworkIdFromRawNetworks(currencyCode: any, networkCode: any, indexedNetworkEntries: any): undefined;
    selectNetworkKeyFromNetworks(currencyCode: any, networkCode: any, indexedNetworkEntries: any, isIndexedByUnifiedNetworkCode?: boolean): undefined;
    safeNumber2(dictionary: any, key1: any, key2: any, d?: undefined): number;
    ...
    parseLeverageTiers(response: any, symbols?: string[], marketIdKey?: undefined): {};
    ...
    parseAccounts(accounts: any, params?: {}): never[];
    ...
    filterByArray(objects: any, key: IndexType, values?: undefined, indexed?: boolean): any;
    ...
    loadAccounts(reload?: boolean, params?: {}): Promise<undefined>;
    buildOHLCVC(trades: Trade[], timeframe?: string, since?: number, limit?: number): OHLCVC[];
    parseTradingViewOHLCV(ohlcvs: any, market?: undefined, timeframe?: string, since?: Int, limit?: Int): OHLCV[];
    editLimitBuyOrder(id: any, symbol: any, amount: any, price?: undefined, params?: {}): Promise<Order>;
    editLimitSellOrder(id: any, symbol: any, amount: any, price?: undefined, params?: {}): Promise<Order>;
    editLimitOrder(id: any, symbol: any, side: any, amount: any, price?: undefined, params?: {}): Promise<Order>;
    ...
    parseBidAsk(bidask: any, priceKey?: IndexType, amountKey?: IndexType): Num[];
    ...
    handleOptionAndParams(params: any, methodName: any, optionName: any, defaultValue?: undefined): any[];
    handleOption(methodName: any, optionName: any, defaultValue?: undefined): any;
    handleMarketTypeAndParams(methodName: string, market?: Market, params?: {}): any;
    handleSubTypeAndParams(methodName: any, market?: undefined, params?: {}, defaultValue?: undefined): ({} | undefined)[];
    handleMarginModeAndParams(methodName: any, params?: {}, defaultValue?: undefined): any[];
    ...
    account(): Account;
    commonCurrencyCode(currency: string): Str;
    ...
    createMarketOrder(symbol: string, side: OrderSide, amount: any, price?: undefined, params?: {}): Promise<Order>;
    ...
    currencyToPrecision(code: string, fee: any, networkCode?: undefined): any;
    ...
    createStopOrder(symbol: string, type: OrderType, side: OrderSide, amount: any, price?: undefined, stopPrice?: undefined, params?: {}): Promise<Order>;
    ...
    filterByCurrencySinceLimit(array: any, code?: undefined, since?: Int, limit?: Int, tail?: boolean): any;
    ...
    parseBorrowInterests(response: any, market?: Market): never[];
    parseFundingRateHistories(response: any, market?: undefined, since?: Int, limit?: Int): FundingRateHistory[];
    ...
    parseOpenInterests(response: any, market?: undefined, since?: Int, limit?: Int): OpenInterest[];
    ...
    checkRequiredArgument(methodName: any, argument: any, argumentName: any, options?: never[]): void;
    checkRequiredMarginArgument(methodName: string, symbol: string, marginMode: string): void;
    parseDepositWithdrawFees(response: any, codes?: string[], currencyIdKey?: undefined): any;
    parseDepositWithdrawFee(fee: any, currency?: Currency): any;
    depositWithdrawFee(info: any): any;
    assignDefaultDepositWithdrawFees(fee: any, currency?: undefined): any;
    parseIncome(info: any, market?: Market): void;
    parseIncomes(incomes: any, market?: undefined, since?: Int, limit?: Int): FundingHistory[];
    getMarketFromSymbols(symbols?: string[]): MarketInterface | undefined;
    parseWsOHLCVs(ohlcvs: object[], market?: any, timeframe?: string, since?: Int, limit?: Int): never[];
    fetchTransactions(code?: string, since?: Int, limit?: Int, params?: {}): Promise<any>;
    filterByArrayPositions(objects: any, key: IndexType, values?: undefined, indexed?: boolean): Position[];
    filterByArrayTickers(objects: any, key: IndexType, values?: undefined, indexed?: boolean): Dictionary<Ticker>;
    ...
    fetchPaginatedCallDeterministic(method: string, symbol?: string, since?: Int, limit?: Int, timeframe?: string, params?: {}, maxEntriesPerRequest?: undefined): Promise<any>;
    fetchPaginatedCallCursor(method: string, symbol?: string, since?: undefined, limit?: undefined, params?: {}, cursorReceived?: undefined, cursorSent?: undefined, cursorIncrement?: undefined, maxEntriesPerRequest?: undefined): Promise<any>;
    fetchPaginatedCallIncremental(method: string, symbol?: string, since?: undefined, limit?: undefined, params?: {}, pageKey?: undefined, maxEntriesPerRequest?: undefined): Promise<any>;
    ...
    parseLiquidations(liquidations: any, market?: undefined, since?: Int, limit?: Int): Liquidation[];
