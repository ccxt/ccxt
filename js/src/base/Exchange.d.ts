...
export declare class BaseExchange {
    ...
    fetchMarketsWs(params?: Dict): Promise<Market[]>;
    ...
    lockId(): undefined;
    unlockId(): undefined;
    lockLastNonce(): undefined;
    unlockLastNonce(): undefined;
    ...
    cleanUnsubscription(client: Client, subHash: Str, unsubHash: Str, subHashIsPrefix?: boolean): void;
...
export default class Exchange extends BaseExchange {
    ...
    loadOrderBook(client: Client, messageHash: string, symbol: string, limit?: Int, params?: Dict): Promise<void>;
