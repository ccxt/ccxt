...
import { Market, Trade, Ticker, OHLCV, Order, OrderBook, Balance, Balances, Dictionary, DepositAddressResponse, Currency, MinMax, IndexType, IntegerType, OrderType, OrderSide } from './types';
...
export default class Exchange {
    ...
    filterBySinceLimit(array: object[], since?: number, limit?: IntegerType, key?: IndexType, tail?: boolean): any;
    filterByValueSinceLimit(array: object[], field: IndexType, value?: any, since?: number, limit?: IntegerType, key?: string, tail?: boolean): any;
    ...
    fetchTrades(symbol: string, since?: number, limit?: IntegerType, params?: {}): Promise<Trade[]>;
    watchTrades(symbol: string, since?: number, limit?: IntegerType, params?: {}): Promise<Trade[]>;
    fetchDepositAddresses(codes?: string[], params?: {}): Promise<any>;
    fetchOrderBook(symbol: any, limit?: IntegerType, params?: {}): Promise<OrderBook>;
    watchOrderBook(symbol: any, limit?: IntegerType, params?: {}): Promise<OrderBook>;
    ...
    parseOrders(orders: object, market?: object, since?: number, limit?: IntegerType, params?: {}): Order[];
    ...
    fetchOHLCV(symbol: string, timeframe?: string, since?: number, limit?: IntegerType, params?: {}): Promise<OHLCV[]>;
    watchOHLCV(symbol: string, timeframe?: string, since?: number, limit?: IntegerType, params?: {}): Promise<OHLCV[]>;
    ...
    fetchL2OrderBook(symbol: string, limit?: IntegerType, params?: {}): Promise<any>;
    ...
    parseOHLCVs(ohlcvs: object[], market?: any, timeframe?: string, since?: number, limit?: IntegerType): OHLCV[];
    ...
    parseTrades(trades: any, market?: object, since?: number, limit?: IntegerType, params?: {}): Trade[];
    parseTransactions(transactions: any, currency?: string, since?: number, limit?: IntegerType, params?: {}): any;
    parseTransfers(transfers: any, currency?: string, since?: number, limit?: IntegerType, params?: {}): any;
    parseLedger(data: any, currency?: string, since?: number, limit?: IntegerType, params?: {}): any;
    nonce(): number;
    ...
    fetchOHLCVC(symbol: any, timeframe?: string, since?: any, limit?: IntegerType, params?: {}): Promise<import("./types").OHLCVC[]>;
    parseTradingViewOHLCV(ohlcvs: any, market?: any, timeframe?: string, since?: number, limit?: IntegerType): OHLCV[];
    ...
    createOrder(symbol: any, type: OrderType, side: OrderSide, amount: any, price?: any, params?: {}): Promise<Order>;
    cancelOrder(id: any, symbol?: string, params?: {}): Promise<any>;
    cancelAllOrders(symbol?: string, params?: {}): Promise<any>;
    cancelUnifiedOrder(order: any, params?: {}): Promise<any>;
    fetchOrders(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<Order[]>;
    watchOrders(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<Order[]>;
    fetchOpenOrders(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<Order[]>;
    fetchClosedOrders(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<Order[]>;
    fetchMyTrades(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<Trade[]>;
    watchMyTrades(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<Trade[]>;
    fetchTransactions(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<any>;
    fetchDeposits(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<any>;
    fetchWithdrawals(symbol?: string, since?: number, limit?: IntegerType, params?: {}): Promise<any>;
    ...
    filterBySymbolSinceLimit(array: any, symbol?: string, since?: number, limit?: IntegerType, tail?: boolean): any;
    filterByCurrencySinceLimit(array: any, code?: any, since?: number, limit?: IntegerType, tail?: boolean): any;
    ...
    parseFundingRateHistories(response: any, market?: any, since?: number, limit?: IntegerType): any;
    ...
    parseOpenInterests(response: any, market?: any, since?: number, limit?: IntegerType): any;
    fetchFundingRate(symbol: any, params?: {}): Promise<any>;
    fetchMarkOHLCV(symbol: any, timeframe?: string, since?: number, limit?: IntegerType, params?: {}): Promise<OHLCV[]>;
    fetchIndexOHLCV(symbol: string, timeframe?: string, since?: number, limit?: IntegerType, params?: {}): Promise<OHLCV[]>;
    fetchPremiumIndexOHLCV(symbol: string, timeframe?: string, since?: number, limit?: IntegerType, params?: {}): Promise<OHLCV[]>;
