...
export default class Exchange {
    ...
    safeValue: (o: import("./types").implicitReturnType, k: string | number, $default?: any) => any;
    safeValue2: (o: import("./types").implicitReturnType, k1: string | number, k2: string | number, $default?: any) => any;
    safeString: (o: import("./types").implicitReturnType, k: string | number, $default?: string) => string;
    safeString2: (o: import("./types").implicitReturnType, k1: string | number, k2: string | number, $default?: string) => string;
    safeFloat: (o: import("./types").implicitReturnType, k: string | number, $default?: number) => number;
    ...
    safeInteger: (o: import("./types").implicitReturnType, k: string | number, $default?: number) => number;
    sum: (...xs: any[]) => any;
    ...
    safeStringLower: (o: import("./types").implicitReturnType, k: string | number, $default?: string) => string;
    ...
    safeStringLower2: (o: import("./types").implicitReturnType, k1: string | number, k2: string | number, $default?: string) => string;
    ...
    safeIntegerN: (o: import("./types").implicitReturnType, k: (string | number)[], $default?: number) => number;
    safeIntegerProductN: (o: import("./types").implicitReturnType, k: (string | number)[], $factor: number, $default?: number) => number;
    safeTimestampN: (o: import("./types").implicitReturnType, k: (string | number)[], $default?: number) => number;
    safeValueN: (o: import("./types").implicitReturnType, k: (string | number)[], $default?: any) => any;
    safeStringN: (o: import("./types").implicitReturnType, k: (string | number)[], $default?: string) => string;
    safeStringLowerN: (o: import("./types").implicitReturnType, k: (string | number)[], $default?: string) => string;
    safeStringUpperN: (o: import("./types").implicitReturnType, k: (string | number)[], $default?: string) => string;
