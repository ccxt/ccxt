...
declare function numberToString(x: number | string): string;
...
declare function precisionFromString(str: string | undefined): number;
declare const decimalToPrecision: (x: string | number | undefined, roundingMode: number, numPrecisionDigits: any, countingMode?: number, paddingMode?: number) => string;
declare function omitZero(stringNumber: string | undefined): string | undefined;
