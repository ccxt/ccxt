...
export class BaseExchange {
    ...
    async getZKContractSignatureObj(seed, params = {}) {
        ...
        const tx_builder = new zklink.ContractBuilder(accountId, 0, slotId, nonce, (pairId === undefined) ? 0 : pairId, Precise.stringMul(this.safeString(params, 'size') || '0', '1e18') || '0', Precise.stringMul(this.safeString(params, 'price') || '0', '1e18') || '0', this.safeString(params, 'direction') === 'BUY', parseInt(Precise.stringMul(this.safeString(params, 'makerFeeRate', '0'), '10000') || '0'), parseInt(Precise.stringMul(this.safeString(params, 'takerFeeRate', '0'), '10000') || '0'), false);
