...
export default class Exchange {
    ...
    getKeepAlive() {
        var _a, _b;
        return (_b = (_a = this.streaming) === null || _a === void 0 ? void 0 : _a.keepAlive) !== null && _b !== void 0 ? _b : 30000;
    }
    getMaxPingPongMisses() {
        var _a, _b;
        return (_b = (_a = this.streaming) === null || _a === void 0 ? void 0 : _a.getMaxPingPongMisses) !== null && _b !== void 0 ? _b : 2;
    }
    getTokenBucket() {
    ...
    getInflate() {
        var _a, _b;
        return !!((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.ws) === null || _b === void 0 ? void 0 : _b.inflate);
    }
    getGunzip() {
        var _a, _b;
        return !!((_b = (_a = this.options) === null || _a === void 0 ? void 0 : _a.ws) === null || _b === void 0 ? void 0 : _b.gunzip);
    }
    /* eslint-enable */
    // ------------------------------------------------------------------------
    // ########################################################################
