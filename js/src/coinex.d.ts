...
import type { Balances, Currency, CurrencyInterface, FundingHistory, FundingRateHistory, Int, Market, OHLCV, Order, OrderSide, OrderType, Str, Strings, Ticker, Tickers, Trade, Transaction, OrderRequest, TransferEntry, Leverage, Num, MarginModification, TradingFeeInterface, Currencies, TradingFees, Position, IsolatedBorrowRate, Dict, NullableDict, LeverageTiers, LeverageTier, int, FundingRate, FundingRates, DepositAddress, BorrowInterest, DepositWithdrawFee, DepositWithdrawFees, MarginLoan, OrderBook } from './base/types.js';
/**
 * @class coinex
 * @augments Exchange
 */
export default class coinex extends Exchange {
    ...
    fetchMarginBalance(params?: Dict): Promise<Balances>;
    fetchSpotBalance(params?: Dict): Promise<Balances>;
    fetchSwapBalance(params?: Dict): Promise<Balances>;
    fetchFinancialBalance(params?: Dict): Promise<Balances>;
    /**
     * @method
