...
declare const ProxyError: typeof import("../base/errors.js").ProxyError;
...
declare const proxyTestFileName = "proxies";
...
declare function getTestName(str: any): any;
...
declare function importTestFile(filePath: any): Promise<any>;
