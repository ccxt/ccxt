...
declare function getCliArgValue(arg: any): any;
declare const EXT: string;
declare const LANG = "JS";
declare const ENV_VARS: any;
...
declare function ioFileExists(path: any): any;
declare function ioFileRead(path: any, decode?: boolean): any;
declare function ioDirRead(path: any): any;
...
declare function getRootDir(): any;
declare function getEnvVars(): any;
