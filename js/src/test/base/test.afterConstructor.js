...
function helperTestProperties() {
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'userAgents') !== undefined);
    for (let i = 0; i < keys.length; i++) {
        const key = keys[i];
        const userAgent = testSharedMethods.exchangeProp(exchange, 'userAgents')[key];
    ...
    // credentials
    //
    assert(testSharedMethods.exchangeProp(exchange, 'apiKey') === undefined, 'apiKey should be empty string');
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'privateKey') === undefined, 'privateKey should be empty string');
    assert(testSharedMethods.exchangeProp(exchange, 'walletAddress') === undefined, 'walletAddress should be empty string');
    ...
    testSharedMethods.assertDeepEqual(exchange, {}, 'requiredCredentials', testSharedMethods.exchangeProp(exchange, 'requiredCredentials'), requiredCredentials);
    //
    // proxies
    //
    assert(exchange.proxy === undefined, 'proxy should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'proxyUrl') === undefined, 'proxyUrl should be undefined');
    assert(exchange.proxy_url === undefined, 'proxy_url should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'proxyUrlCallback') === undefined, 'proxyUrlCallback should be undefined');
    assert(exchange.proxy_url_callback === undefined, 'proxy_url_callback should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'httpProxy') === undefined, 'httpProxy should be undefined');
    assert(exchange.http_proxy === undefined, 'http_proxy should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'httpProxyCallback') === undefined, 'httpProxyCallback should be undefined');
    assert(exchange.http_proxy_callback === undefined, 'http_proxy_callback should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'httpsProxy') === undefined, 'httpsProxy should be undefined');
    assert(exchange.https_proxy === undefined, 'https_proxy should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'httpsProxyCallback') === undefined, 'httpsProxyCallback should be undefined');
    assert(exchange.https_proxy_callback === undefined, 'https_proxy_callback should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'socksProxy') === undefined, 'socksProxy should be undefined');
    assert(exchange.socks_proxy === undefined, 'socks_proxy should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'socksProxyCallback') === undefined, 'socksProxyCallback should be undefined');
    assert(exchange.socks_proxy_callback === undefined, 'socks_proxy_callback should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'wsProxy') === undefined, 'wsProxy should be undefined');
    assert(exchange.ws_proxy === undefined, 'ws_proxy should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'wssProxy') === undefined, 'wssProxy should be undefined');
    assert(exchange.wss_proxy === undefined, 'wss_proxy should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'wsSocksProxy') === undefined, 'wsSocksProxy should be undefined');
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'returnResponseHeaders') === false, 'returnResponseHeaders should be false');
    //
    // common props
    //
    // @SKIP_START_GO
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'minFundingAddressLength') >= 1, 'minFundingAddressLength should be >= 1');
    assert(testSharedMethods.exchangeProp(exchange, 'isSandboxModeEnabled') === false, 'isSandboxModeEnabled should be false');
    assert(testSharedMethods.exchangeProp(exchange, 'enableRateLimit') === true, 'enableRateLimit should be true');
    assert(testSharedMethods.exchangeProp(exchange, 'rateLimiterAlgorithm') === 'leakyBucket', 'rateLimiterAlgorithm should be "leakyBucket"');
    assert(testSharedMethods.exchangeProp(exchange, 'rateLimit') === 2000, 'rateLimit should be 2000');
    ...
    assert((Object.keys(testSharedMethods.exchangeProp(exchange, 'httpExceptions'))).length === httpExceptionKeys.length, 'httpExceptions should have ' + (httpExceptionKeys.length).toString() + ' keys');
    const limits = {
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'rollingWindowSize') === 60000, 'rollingWindowSize should be 60000');
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'precisionMode') === undefined || testSharedMethods.exchangeProp(exchange, 'precisionMode') === 4, 'precisionMode should be undefined or 4');
    assert(testSharedMethods.exchangeProp(exchange, 'paddingMode') === undefined || testSharedMethods.exchangeProp(exchange, 'paddingMode') === 5, 'paddingMode should be undefined or 5');
    testSharedMethods.assertDeepEqual(exchange, {}, 'headers', exchange.headers, {});
    // assert (exchange.origin === '*');
    assert(testSharedMethods.exchangeProp(exchange, 'substituteCommonCurrencyCodes') === true, 'substituteCommonCurrencyCodes should be true');
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'reduceFees') === true, 'reduceFees should be true');
    const fees = {
        'trading': {
            'tierBased': undefined,
    ...
    assert(testSharedMethods.exchangeProp(exchange, 'baseCurrencies') === undefined, 'baseCurrencies should be undefined');
    assert(testSharedMethods.exchangeProp(exchange, 'quoteCurrencies') === undefined, 'quoteCurrencies should be undefined');
