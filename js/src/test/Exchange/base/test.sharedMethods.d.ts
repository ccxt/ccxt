...
declare function logTemplate(exchange: Exchange, method: Str, entry: object | undefined): string;
declare function isTemporaryFailure(e: any): boolean;
declare function assertType(exchange: Exchange, skippedProperties: object, entry: object, key: string | number, format: object): boolean | undefined;
declare function assertStructure(exchange: Exchange, skippedProperties: object, method: string, entry: object, format: any[] | object, emptyAllowedFor?: any[] | undefined, deep?: boolean): void;
...
declare function assertGreaterOrEqual(exchange: Exchange, skippedProperties: object, method: Str, entry: object, key: string | number, compareTo: Str, allowNull?: boolean): void;
...
declare function assertLessOrEqual(exchange: Exchange, skippedProperties: object, method: Str, entry: object, key: string | number, compareTo: Str, allowNull?: boolean): void;
...
declare function assertInArray(exchange: Exchange, skippedProperties: object, method: string, entry: object | undefined, key: string | number, expectedArray: any[], allowNull?: boolean): void;
