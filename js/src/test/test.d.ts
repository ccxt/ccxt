...
export default class testMainClass extends baseMainTestClass {
    ...
    testSafe(methodName: any, exchange: any, args?: never[], isPublic?: boolean): Promise<boolean | undefined>;
    runPublicTests(exchange: any, symbol: any): Promise<void>;
    loadExchange(exchange: any): Promise<boolean>;
    getTestSymbol(exchange: any, isSpot: any, symbols: any): undefined;
    getExchangeCode(exchange: any, codes?: undefined): any;
    getMarketsFromExchange(exchange: any, spot?: boolean): {};
    getValidSymbol(exchange: any, spot?: boolean): undefined;
    testExchange(exchange: any, providedSymbol?: undefined): Promise<void>;
    ...
    sanitizeDataInput(input: any): never[] | undefined;
    ...
    runStaticResponseTests(exchangeName?: undefined, test?: undefined): Promise<void>;
