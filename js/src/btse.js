...
export default class btse extends Exchange {
    ...
    encodeTriggerPriceType(priceType) {
        const priceTypes = {
            'last': 'LAST_PRICE',
            'mark': 'MARK_PRICE',
            'index': 'INDEX_PRICE',
    ...
    async fetchOpenOrders(symbol = undefined, since = undefined, limit = undefined, params = {}) {
        ...
        const rows = this.safeList(response, 'data', response);
    ...
    async requestWalletHistoryRows(methodName, historyTypes, code = undefined, since = undefined, limit = undefined, params = {}) {
        ...
        //     }
        //
        const rawRows = this.safeList(response, 'data', response);
    ...
    parseLedgerEntryDirection(type) {
        const directions = {
            'Deposit': 'in',
            'Withdraw': 'out',
            'Transfer_Out': 'out',
