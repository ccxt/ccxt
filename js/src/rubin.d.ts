...
export default class rubin extends Exchange {
    ...
    signRubinTx(privateKey: string, message: any, memo: string, chainId: string, account: any, authenticators: any, fee?: any): string;
    retrieveCredentials(): any;
    fetchRubinAccount(): Promise<import("./base/types.js").Dictionary<any>>;
