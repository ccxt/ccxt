...
import type { TransferEntry, Balances, Currency, Int, Market, OrderBook, OrderSide, OrderType, Str, Ticker, Trade, Num, Dict, Strings, int, DepositAddress, NullableDict, Order } from './base/types.js';
/**
 * @class paymium
 * @augments Exchange
 */
