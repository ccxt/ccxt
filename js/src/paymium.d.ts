...
export default class paymium extends Exchange {
     ...
     */
    createOrder(symbol: string, type: OrderType, side: OrderSide, amount: number, price?: Num, params?: Dict): Promise<import("./base/types.js").Order>;
    /**
     * @method
     ...
     * @returns {object} An [order structure]{@link https://docs.ccxt.com/?id=order-structure}
     */
    cancelOrder(id: string, symbol?: Str, params?: Dict): Promise<import("./base/types.js").Order>;
    /**
     * @method
