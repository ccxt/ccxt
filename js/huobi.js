                ...
                'spot': {
                    ...
                    'private': {
                        'get': {
                            ...
                            'v1/account/accounts/{account-id}/balance': 1,
                            'v2/account/valuation': 1,
                            'v2/account/asset-valuation': 1,
                            'v1/account/history': 1,
                            'v2/account/ledger': 1,
                            'v2/point/account': 1,
                            ...
                            'v1/subuser/aggregate-balance': 1,
                            'v1/account/accounts/{sub-uid}': 1,
                            // Trading
                            'v1/order/openOrders': 1,
                            'v1/order/orders/{order-id}': 1,
                            'v1/order/orders/getClientOrder': 1,
                            'v1/order/orders/{order-id}/matchresults': 1,
                            'v1/order/orders': 1,
                            'v1/order/history': 1,
                        ...
                        'post': {
                            ...
                            'v1/subuser/transfer': 1,
                            // Trading
                            'v1/order/orders/place': 1,
                            'v1/order/batch-orders': 1,
                            'v1/order/orders/{order-id}/submitcancel': 1,
                            'v1/order/orders/submitCancelClientOrder': 1,
                            'v1/order/orders/batchCancelOpenOrders': 1,
                            'v1/order/orders/batchcancel': 1,
                            ...
                            // Margin Loan (Cross/Isolated)
                            'v2/account/repayment': 1,
                            'v1/dw/transfer-in/margin': 1,
                            'v1/dw/transfer-out/margin': 1,
                            'v1/margin/orders': 1,
                            'v1/margin/orders/{order-id}/repay': 1,
                            ...
                            'v2/etp/creation': 1,
                            'v2/etp/redemption': 1,
                            'v2/etp/{transactId}/cancel': 1,
                            'v2/etp/batch-cancel': 1,
                        },
                    },
                },
                'contract': {
