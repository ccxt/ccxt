            ...
            'features': {
                ...
                'fetchTradingLimits': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': fetchtradinglimitsbyid,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'fetchTicker': {
                    'spot': {
                        ...
                        'requiredParams': [ 'symbol' ],
                        'emulated': false,
                        'authenticated': marketgetdetailmerged,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'fetchTickers': {
                    'spot': {
                        ...
                        'requiredParams': [ ],
                        'emulated': false,
                        'authenticated': marketgettickers,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'fetchTrades': {
                    'spot': {
                        ...
                        'requiredParams': [ 'symbol' ],
                        'emulated': false,
                        'authenticated': marketgethistorytrade,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
                ...
                'fetchOHLCV': {
                    'spot': {
                        ...
                        'requiredParams': [ 'symbol' ],
                        'emulated': false,
                        'authenticated': marketgethistorykline,
                    },
                    'margin': {
                        'supported': undefined,
                        'availableMethods': [ ],
