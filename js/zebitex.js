...
module.exports = class zebitex extends Exchange {
    describe () {
    ...
    async fetchMarkets (params = {}) {
        ...
        const request = {};
        const markets = await this.publicGetOrdersTickers (this.extend (request, params));
