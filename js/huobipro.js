...
module.exports = class huobipro extends Exchange {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'hostname': 'api.huobi.pro', // api.testnet.huobi.pro, api.hbdm.com (swaps), api.hbdm.vn (swpas)
            'pro': true,
            'has': {
                'cancelOrder': true,
                'CORS': false,
            ...
            'urls': {
                ...
                'api': {
                    ...
                    'v1PublicCoinMarginedSwap': 'https://{hostname}',
                    'v1PrivateCoinMarginedSwap': 'https://{hostname}',
                    'v1PublicUSDTMarginedSwap': 'https://{hostname}',
                    'v1PrivateUSDTMarginedSwap': 'https://{hostname}',
                },
                'www': 'https://www.huobi.com',
                'referral': 'https://www.huobi.com/en-us/topic/invited/?invite_code=rwrd3',
                'doc': [
                    'https://huobiapi.github.io/docs/spot/v1/cn/',
                    'https://huobiapi.github.io/docs/coin_margined_swap/v1/en/#api-list',
                    'https://huobiapi.github.io/docs/usdt_swap/v1/en/#api-list',
                ],
                'fees': 'https://www.huobi.com/about/fee/',
            },
            'api': {
                'v1PublicUSDTMarginedSwap': {
                    'get': [
                ...
                'v1PublicCoinMarginedSwap': {
                    'get': [
                        ...
                        'index/market/history/swap_premium_index_kline',
                        'index/market/history/swap_basis',
                    ],
                },
                'v1PrivateCoinMarginedSwap': {
                    'get': [
                    ...
                    'post': [
                        ...
                        'swap-api/v1/swap_user_settlement_records',
                        ...
                        'swap-api/v1/swap_trigger_order',
                        'swap-api/v1/swap_trigger_cancel',
                        ...
                        'swap-api/v1/swap_tpsl_order',
                        'swap-api/v1/swap_tpsl_cancel',
                        'swap-api/v1/swap_tpsl_cancelall',
                        'swap-api/v1/swap_tpsl_openorders',
                        'swap-api/v1/swap_tpsl_hisorders',
    ...
    sign (path, api = 'public', method = 'GET', params = {}, headers = undefined, body = undefined) {
        ...
        if (api === 'private' || api === 'v2Private' || api === 'v1PrivateCoinMarginedSwap' || api === 'v1PrivateUSDTMarginedSwap') {
