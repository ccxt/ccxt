...
module.exports = class bitvavo extends Exchange {
    ...
    async createOrder (symbol, type, side, amount, price = undefined, params = {}) {
         ...
         * @param {number} params.triggerPrice The price at which a trigger order is triggered at
         * @param {boolean} params.postOnly If true, the order will only be posted to the order book and not executed immediately
         * @param {number} params.stopLossPrice The price at which a stop loss order is triggered at
         * @param {number} params.takeProfitPrice The price at which a take profit order is triggered at
         ...
         * @param {boolean} params.disableMarketProtection don't cancel if the next fill price is 10% worse than the best fill price
         * @param {boolean} params.responseRequired Set this to 'false' when only an acknowledgement of success or failure is required, this is faster.
