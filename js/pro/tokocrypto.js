...
const tokocryptoRest = require ('../tokocrypto.js');
...
module.exports = class tokocrypto extends tokocryptoRest {
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                'api': {
                    'ws': {
                        'spot': 'wss://stream.binance.com/ws', // wss://stream-cloud.binanceru.net/ws , wss://www.tokocrypto.com/ws
                    },
                },
            },
            'options': {
    ...
    async watchOrderBook (symbol, limit = undefined, params = {}) {
        ...
        // https://github.com/tokocrypto-exchange/tokocrypto-official-api-docs/blob/master/web-socket-streams.md#partial-book-depth-streams        // <symbol>@depth<levels>@100ms or <symbol>@depth<levels> (1000ms)
        ...
        //
        // spot/margin
        // https://tokocrypto-docs.github.io/apidocs/spot/en/#how-to-manage-a-local-order-book-correctly
        //
        // 1. Open a stream to wss://stream.tokocrypto.com:9443/ws/bnbbtc@depth.
        // 2. Buffer the events you receive from the stream.
        // 3. Get a depth snapshot from https://www.tokocrypto.com/api/v1/depth?symbol=BNBBTC&limit=1000 .
        ...
        //
        // futures
        // https://tokocrypto-docs.github.io/apidocs/futures/en/#how-to-manage-a-local-order-book-correctly
        //
        // 1. Open a stream to wss://fstream.tokocrypto.com/stream?streams=btcusdt@depth.
        // 2. Buffer the events you receive from the stream. For same price, latest received update covers the previous one.
        // 3. Get a depth snapshot from https://fapi.tokocrypto.com/fapi/v1/depth?symbol=BTCUSDT&limit=1000 .
        // 4. Drop any event where u is < lastUpdateId in the snapshot.
    ...
    handleOrderBook (client, message) {
        ...
        if (orderbook === undefined) {
            ...
            //
            // Sometimes tokocrypto sends the first delta before the subscription
    ...
    parseTrade (trade, market = undefined) {
        ...
        //         M: true           // tokocrypto docs say it should be ignored
        //     }
        //
        //     {
    ...
    async authenticate (params = {}) {
        ...
        if (time - lastAuthenticatedTime > delay) {
            ...
            //     }
            //
            const listenKey = this.safeString (response, 'data');
            if (listenKey === undefined) {
                throw new AuthenticationError (this.id + ' failed to authenticate');
            }
            this.options[type] = this.extend (options, {
                'listenKey': listenKey,
                'lastAuthenticatedTime': this.safeInteger (response, 'timestamp'),
            });
    ...
    async keepAliveListenKey (params = {}) {
        // https://tokocrypto-docs.github.io/apidocs/spot/en/#listen-key-spot
        let type = this.safeString2 (this.options, 'defaultType', 'authenticate', 'spot');
        type = this.safeString (params, 'type', type);
        const options = this.safeValue (this.options, type, {});
