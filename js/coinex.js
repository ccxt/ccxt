            ...
            'api': {
                'public': {
                    'get': [
                        ...
                        'common/asset/config',
                        'common/maintain/info',
                        'common/temp-maintain/info',
                        'margin/market',
                        'market/info',
                        'market/list',
                        'market/ticker',
                ...
                'private': {
                    'get': [
                        ...
                        'order/stop/finished',
                        'order/stop/pending',
                        'order/user/trade/fee',
                        'order/market/trade/info',
                        'sub_account/balance',
                    ...
                    'post': [
                        ...
                        'sub_account/register',
                        'sub_account/unfrozen',
                        'sub_account/frozen',
                        'sub_account/auth/api',
                    ],
                    'put': [
                        'balance/deposit/address/{coin_type}',
                        'sub_account/auth/api/{user_auth_id}',
