...
module.exports = class idex extends Exchange {
    ...
    async fetchMarkets (params = {}) {
        ...
        for (let i = 0; i < response.length; i++) {
            ...
            const basePrecision = this.safeTickSize (entry, 'baseAssetPrecision');
            const quotePrecision = this.safeTickSize (entry, 'quoteAssetPrecision');
    ...
    async fetchCurrencies (params = {}) {
        ...
        for (let i = 0; i < response.length; i++) {
            ...
            result[code] = {
                ...
                'withdraw': undefined,
                'fee': undefined,
                'precision': this.safeTickSize (entry, 'exchangeDecimals'),
                'limits': {
