    ...
    describe () {
        return this.deepExtend (super.describe (), {
            ...
            'urls': {
                ...
                'api': {
                    'public': process.env.POD_NAMESPACE === 'prod' ? 'https://priv-api.bitstamp.net/api' : 'https://www.bitstamp.net/api',
                    'private': process.env.POD_NAMESPACE === 'prod' ? 'https://priv-api.bitstamp.net/api' : 'https://www.bitstamp.net/api',
                },
