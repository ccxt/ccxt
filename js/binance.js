            ...
            'api': {
                'sapi': {
                    'get': {
                        ...
                        'asset/get-funding-asset': { 'weight': 1 },
                        ...
                        'margin/maxBorrowable': { 'weight': 1 },
                        'margin/maxTransferable': { 'weight': 1 },
                        ...
                        'sub-account/futures/accountSummary': { 'weight': 1 },
                        ...
                        'sub-account/spotSummary': { 'weight': 1 },
                        ...
                        'mining/worker/detail': { 'weight': 1 },
                        'mining/worker/list': { 'weight': 1 },
                        'mining/payment/list': { 'weight': 1 },
                        'mining/statistics/user/status': { 'weight': 1 },
                        'mining/statistics/user/list': { 'weight': 1 },
                        'bswap/pools': { 'weight': 1 },
                        'bswap/liquidity': { 'weight': 1 },
                        'bswap/liquidityOps': { 'weight': 1 },
                        'bswap/quote': { 'weight': 1 },
                        'bswap/swap': { 'weight': 1 },
                    ...
                    'post': {
                        ...
                        'sub-account/universalTransfer': { 'weight': 1 },
                        'managed-subaccount/deposit': { 'weight': 1 },
                        'managed-subaccount/withdraw': { 'weight': 1 },
                        ...
                        'bswap/liquidityAdd': { 'weight': 1 },
                        'bswap/liquidityRemove': { 'weight': 1 },
                        'bswap/swap': { 'weight': 1 },
                ...
                'dapiPublic': {
                    'get': {
                        ...
                        'depth': { 'weight': 1 },
                        'trades': { 'weight': 1 },
                        'historicalTrades': { 'weight': 1 },
                        'aggTrades': { 'weight': 1 },
                        'premiumIndex': { 'weight': 1 },
                        'fundingRate': { 'weight': 1 },
                        'klines': { 'weight': 1 },
                        'continuousKlines': { 'weight': 1 },
                        'indexPriceKlines': { 'weight': 1 },
                        'markPriceKlines': { 'weight': 1 },
                        'ticker/24hr': { 'weight': 1 },
                        'ticker/price': { 'weight': 1 },
                        'ticker/bookTicker': { 'weight': 1 },
                ...
                'dapiPrivate': {
                    'get': {
                        ...
                        'forceOrders': { 'weight': 1 },
                        'adlQuantile': { 'weight': 1 },
                    },
                    'post': {
                        'positionSide/dual': { 'weight': 1 },
                        'order': { 'weight': 1 },
                        'batchOrders': { 'weight': 1 },
                        'countdownCancelAll': { 'weight': 1 },
                        'leverage': { 'weight': 1 },
                        'marginType': { 'weight': 1 },
                ...
                'private': {
                    'get': {
                        'allOrderList': { 'weight': 1 },
                        'openOrderList': { 'weight': 1 },
                        'orderList': { 'weight': 1 },
                        'order': { 'weight': 1 },
                        'openOrders': { 'weight': 1 },
                        'allOrders': { 'weight': 1 },
