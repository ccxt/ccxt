            ...
            'api': {
                ...
                'sapi': {
                    'get': {
                        ...
                        'asset/assetDetail': { 'weight': 1 },
                        'asset/tradeFee': { 'weight': 1 },
                        'margin/loan': { 'weight': 1 },
                        'margin/repay': { 'weight': 1 },
                        'margin/account': { 'weight': 1 },
                        'margin/transfer': { 'weight': 1 },
                        'margin/interestHistory': { 'weight': 1 },
                        'margin/forceLiquidationRec': { 'weight': 1 },
                        'margin/order': { 'weight': 1 },
                        'margin/openOrders': { 'weight': 1 },
                        'margin/allOrders': { 'weight': 1 },
                        'margin/myTrades': { 'weight': 1 },
                        'margin/maxBorrowable': { 'weight': 5 },
                        'margin/maxTransferable': { 'weight': 5 },
                        'margin/isolated/transfer': { 'weight': 1 },
                        'margin/isolated/account': { 'weight': 1 },
                        'margin/isolated/pair': { 'weight': 1 },
                        'margin/isolated/allPairs': { 'weight': 1 },
                        'margin/interestRateHistory': { 'weight': 1 },
                        'fiatpayment/query/deposit/history': { 'weight': 1 },
                        'fiatpayment/query/withdraw/history': { 'weight': 1 },
                        'futures/transfer': { 'weight': 5 },
                        'futures/loan/borrow/history': { 'weight': 1 },
                        'futures/loan/repay/history': { 'weight': 1 },
                        'futures/loan/wallet': { 'weight': 1 },
                        'futures/loan/configs': { 'weight': 1 },
                        'futures/loan/calcAdjustLevel': { 'weight': 1 },
                        ...
                        'capital/deposit/subHisrec': { 'weight': 1 },
                        'capital/withdraw/history': { 'weight': 1 },
                        'bnbBurn': { 'weight': 1 },
                        'sub-account/assets': { 'weight': 1 },
                        'sub-account/futures/account': { 'weight': 1 },
                        'sub-account/futures/accountSummary': { 'weight': 20 },
                        'sub-account/futures/positionRisk': { 'weight': 1 },
                        'sub-account/futures/internalTransfer': { 'weight': 1 },
                        'sub-account/list': { 'weight': 1 },
                        'sub-account/margin/account': { 'weight': 1 },
                        'sub-account/margin/accountSummary': { 'weight': 1 },
                        'sub-account/spotSummary': { 'weight': 5 },
                        'sub-account/status': { 'weight': 1 },
                        ...
                        'lending/daily/token/position': { 'weight': 1 },
                        'lending/union/account': { 'weight': 1 },
                        'lending/union/purchaseRecord': { 'weight': 1 },
                        'lending/union/redemptionRecord': { 'weight': 1 },
                        ...
                        'mining/worker/list': { 'weight': 5 },
                        'mining/payment/list': { 'weight': 5 },
                        'mining/payment/other': { 'weight': 5 },
                        'mining/hash-transfer/config/details/list': { 'weight': 5 },
                        'mining/hash-transfer/profit/details': { 'weight': 5 },
                        'mining/hash-transfer/config': { 'weight': 5 },
                        'mining/hash-transfer/config/cancel': { 'weight': 5 },
                        ...
                        'apiReferral/rebate/recentRecord': { 'weight': 1 },
                        ...
                        'broker/subAccountApi/commission/coinFutures': { 'weight': 1 },
                        'broker/info': { 'weight': 1 },
                        'broker/transfer': { 'weight': 1 },
                        'broker/transfer/futures': { 'weight': 1 },
                        'broker/rebate/recentRecord': { 'weight': 1 },
                        'broker/rebate/historicalRecord': { 'weight': 1 },
                        'broker/subAccount/bnbBurn/status': { 'weight': 1 },
                        'broker/subAccount/depositHist': { 'weight': 1 },
                        'broker/subAccount/spotSummary': { 'weight': 1 },
                        'broker/subAccount/marginSummary': { 'weight': 1 },
                        'broker/subAccount/futuresSummary': { 'weight': 1 },
                    ...
                    'post': {
                        'asset/dust': { 'weight': 1 },
                        'asset/transfer': { 'weight': 1 },
                        'get-funding-asset': { 'weight': 1 },
                        'account/disableFastWithdrawSwitch': { 'weight': 1 },
                        'account/enableFastWithdrawSwitch': { 'weight': 1 },
                        'capital/withdraw/apply': { 'weight': 1 },
                        'margin/transfer': { 'weight': 1 },
                        'margin/loan': { 'weight': 1 },
                        'margin/repay': { 'weight': 1 },
                        'margin/order': { 'weight': 1 },
                        ...
                        'margin/isolated/transfer': { 'weight': 1 },
                        'bnbBurn': { 'weight': 1 },
                        'sub-account/margin/transfer': { 'weight': 1 },
                        'sub-account/margin/enable': { 'weight': 1 },
                        'sub-account/futures/enable': { 'weight': 1 },
                        'sub-account/futures/transfer': { 'weight': 1 },
                        'sub-account/futures/internalTransfer': { 'weight': 1 },
                        'sub-account/transfer/subToSub': { 'weight': 1 },
                        'sub-account/transfer/subToMaster': { 'weight': 1 },
                        'sub-account/universalTransfer': { 'weight': 1 },
                        'userDataStream': { 'weight': 1 },
                        'userDataStream/isolated': { 'weight': 1 },
                        'futures/transfer': { 'weight': 1 },
                        'futures/loan/borrow': { 'weight': 1 },
                        'futures/loan/repay': { 'weight': 1 },
                        ...
                        'apiReferral/kickback/historicalRecord': { 'weight': 1 },
                        'broker/subAccount': { 'weight': 1 },
                        'broker/subAccount/margin': { 'weight': 1 },
                        'broker/subAccount/futures': { 'weight': 1 },
                        'broker/subAccountApi': { 'weight': 1 },
                        'broker/subAccountApi/permission': { 'weight': 1 },
                        'broker/subAccountApi/commission': { 'weight': 1 },
                        'broker/subAccountApi/commission/futures': { 'weight': 1 },
                        'broker/subAccountApi/commission/coinFutures': { 'weight': 1 },
                        'broker/transfer': { 'weight': 1 },
                        'broker/transfer/futures': { 'weight': 1 },
                        'broker/rebate/historicalRecord': { 'weight': 1 },
                        'broker/subAccount/bnbBurn/spot': { 'weight': 1 },
                        'broker/subAccount/bnbBurn/marginInterest': { 'weight': 1 },
                        'broker/subAccount/blvt': { 'weight': 1 },
                        'broker/subAccountApi/ipRestriction': { 'weight': 1 },
                        'broker/subAccountApi/ipRestriction/ipList': { 'weight': 1 },
                        'broker/universalTransfer': { 'weight': 1 },
                        'broker/subAccountApi/permission/universalTransfer': { 'weight': 1 },
                        'broker/subAccountApi/permission/vanillaOptions': { 'weight': 1 },
                    },
                    'put': {
                        'userDataStream': { 'weight': 1 },
                        'userDataStream/isolated': { 'weight': 1 },
                ...
                'wapi': {
                    'post': {
                        'withdraw': { 'weight': 1 },
                        'sub-account/transfer': { 'weight': 1 },
                    },
                    'get': {
                        'depositHistory': { 'weight': 1 },
                        'withdrawHistory': { 'weight': 1 },
                        'depositAddress': { 'weight': 1 },
                        'accountStatus': { 'weight': 1 },
                        'systemStatus': { 'weight': 1 },
                        'apiTradingStatus': { 'weight': 1 },
                        'userAssetDribbletLog': { 'weight': 1 },
                        'tradeFee': { 'weight': 1 },
                        'assetDetail': { 'weight': 1 },
                        'sub-account/list': { 'weight': 1 },
                        'sub-account/transfer/history': { 'weight': 1 },
                        'sub-account/assets': { 'weight': 1 },
                    },
                },
                'dapiPublic': {
                    'get': {
                        'ping': { 'weight': 1 },
                        'time': { 'weight': 1 },
                        'exchangeInfo': { 'weight': 10 },
                        'depth': { 'weight': 2, 'byLimit': [ [ 50, 2 ], [ 100, 5 ], [ 500, 10 ], [ 1000, 20 ] ] },
                        'trades': { 'weight': 1 },
                        ...
                        'ticker/price': { 'weight': 1, 'noSymbol': 2 },
                ...
                'dapiData': {
                    'get': {
                        'openInterestHist': { 'weight': 1 },
                        'topLongShortAccountRatio': { 'weight': 1 },
                        'topLongShortPositionRatio': { 'weight': 1 },
                        'globalLongShortAccountRatio': { 'weight': 1 },
                        'takerBuySellVol': { 'weight': 1 },
                        'basis': { 'weight': 1 },
                    },
                },
                'dapiPrivate': {
                    'get': {
                        'positionSide/dual': { 'weight': 30 },
                        'order': { 'weight': 1 },
                        'openOrder': { 'weight': 1 },
                        'openOrders': { 'weight': 1, 'noSymbol': 5 },
                        'allOrders': { 'weight': 20, 'noSymbol': 40 },
                        'balance': { 'weight': 1 },
                        'account': { 'weight': 5 },
                        'positionMargin/history': { 'weight': 1 },
                        'positionRisk': { 'weight': 1 },
                        'userTrades': { 'weight': 20, 'noSymbol': 40 },
                        'income': { 'weight': 20 },
                        'leverageBracket': { 'weight': 1 },
                        'forceOrders': { 'weight': 20, 'noSymbol': 50 },
                        'adlQuantile': { 'weight': 5 },
                    ...
                    'delete': {
                        'order': { 'weight': 1 },
                        'allOpenOrders': { 'weight': 1 },
                        'batchOrders': { 'weight': 1 },
                        'listenKey': { 'weight': 1 },
                    },
                },
                'dapiPrivateV2': {
                ...
                'fapiPrivate': {
                    'get': {
                        ...
                        'allOrders': { 'weight': 5 },
                        'openOrder': { 'weight': 1 },
                        'openOrders': { 'weight': 1, 'noSymbol': 40 },
                        'order': { 'weight': 1 },
                        'account': { 'weight': 5 },
                        'balance': { 'weight': 5 },
                        'leverageBracket': { 'weight': 1 },
                        ...
                        'apiReferral/customization': { 'weight': 1 },
                        'apiReferral/userCustomization': { 'weight': 1 },
                        'apiReferral/traderNum': { 'weight': 1 },
                        'apiReferral/overview': { 'weight': 1 },
                        'apiReferral/tradeVol': { 'weight': 1 },
                        'apiReferral/rebateVol': { 'weight': 1 },
                        'apiReferral/traderSummary': { 'weight': 1 },
                        'adlQuantile': { 'weight': 5 },
                    },
                    'post': {
                        'batchOrders': { 'weight': 5 },
                ...
                'public': {
                    'get': {
                        'ping': { 'weight': 1 },
                        'time': { 'weight': 1 },
                        'depth': { 'weight': 1, 'byLimit': [ [ 100, 1 ], [ 500, 5 ], [ 1000, 10 ], [ 5000, 50] ] },
                        'trades': { 'weight': 1 },
                        'aggTrades': { 'weight': 1 },
                        'historicalTrades': { 'weight': 5 },
                        'klines': { 'weight': 1 },
                        'ticker/24hr': { 'weight': 1, 'noSymbol': 40 },
                        'ticker/price': { 'weight': 1, 'noSymbol': 2 },
                        'ticker/bookTicker': { 'weight': 1, 'noSymbol': 2 },
