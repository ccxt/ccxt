...
class btce extends Market {
    ...
    public function fetch_ticker ($product) {
        ...
        return array (
            ...
            'bid' => $ticker['buy'] ? $ticker['buy'] : null,
            'ask' => $ticker['sell'] ? $ticker['sell'] : null,
            'vwap' => null,
            'open' => null,
            'close' => null,
            'first' => null,
