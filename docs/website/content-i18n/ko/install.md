...
[**crates.io**의 Rust용 ccxt](https://crates.io/crates/ccxt) ([docs.rs](https://docs.rs/ccxt))
...
전체 예제 목록은 [examples/rust/](https://github.com/ccxt/ccxt/tree/master/examples/rust)를 참조하세요.
