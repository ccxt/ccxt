...
// (JavaScript / Python / PHP / C# / Go / Java / Rust) with click-to-copy.
...
const LANGS: { id: string; label: string; cmd: string; prompt?: string }[] = [
  ...
  // ccxt = REST venues; ccxt-pro (WebSocket) is a separate crate, added only if you stream.
  // Both are async and expect a Tokio runtime, hence the tokio/full feature.
  { id: 'rust', label: 'Rust', cmd: 'cargo add ccxt tokio --features tokio/full' },
];
