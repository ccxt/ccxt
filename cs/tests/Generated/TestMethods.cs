...
public partial class testMainClass
{
    ...
    public virtual void expandSettings(BaseExchange exchange)
    {
        ...
        if (isTrue(!isEqual(exchangeSettings, null)))
        {
            ...
            for (object i = 0; isLessThan(i, getArrayLength(settingKeys)); postFixIncrement(ref i))
            {
                ...
                object settingIsEmpty = isTrue(isTrue(isTrue(isTrue((isEqual(settingValue, null))) || isTrue((isEqual(settingValue, null)))) || isTrue((isEqual(settingValue, "")))) || isTrue((isEqual(settingValue, false)))) || isTrue((isEqual(settingValue, 0)));
    ...
    public async virtual Task<object> testMethod(object methodName, BaseExchange exchange, object args, object isPublic)
    {
        ...
        object supportedByExchange = isTrue(isTrue((inOp(exchange.has, methodName))) && isTrue((!isEqual(getValue(exchange.has, methodName), null)))) && isTrue((!isEqual(getValue(exchange.has, methodName), false)));
    ...
    public async virtual Task<object> testExchange(BaseExchange exchange, object providedSymbol = null)
    {
        ...
        object hasSpot = isTrue((!isEqual(getValue(exchange.has, "spot"), null))) && isTrue((!isEqual(getValue(exchange.has, "spot"), false)));
        object hasSwap = isTrue((!isEqual(getValue(exchange.has, "swap"), null))) && isTrue((!isEqual(getValue(exchange.has, "swap"), false)));
    ...
    public async virtual Task<object> runPredictionTests(BaseExchange exchange)
    {
        ...
        if (!isTrue(this.wsTests))
        {
            try
            {
                ...
                object extraScopesLength = getArrayLength(extraScopes);
                for (object si = 0; isLessThan(si, extraScopesLength); postFixIncrement(ref si))
                {
                    ((IList<object>)scopesToTest).Add(getValue(extraScopes, si));
                }
                object scopesToTestLength = getArrayLength(scopesToTest);
                for (object sj = 0; isLessThan(sj, scopesToTestLength); postFixIncrement(ref sj))
                {
                    ...
                    object scopedListLength = getArrayLength(scopedList);
    ...
    { "limit", 1 },
                    ...
                    object limitedListLength = getArrayLength(limitedList);
    ...
    public async virtual Task<object> testPredictionCreateCancelOrder(BaseExchange exchange, object outcome)
    {
        ...
        object canCancel = isTrue((isEqual(exchange.safeBool(exchange.has, "cancelOrder", false), true))) || isTrue((isEqual(exchange.safeBool(exchange.has, "cancelAllOrders", false), true)));
        if (!isTrue(canCancel))
        {
    ...
    public virtual object countSignificantKeys(BaseExchange exchange, object target, object otherKeys)
    {
        ...
        object keys = new List<object>(((IDictionary<string,object>)target).Keys);
        object count = 0;
        for (object i = 0; isLessThan(i, getArrayLength(keys)); postFixIncrement(ref i))
        {
            object key = getValue(keys, i);
