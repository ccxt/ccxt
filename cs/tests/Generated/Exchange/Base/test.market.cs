...
public partial class testMainClass : BaseTest
{
    public static void testMarket(BaseExchange exchange, object skippedProperties, object method, object market)
    {
        ...
        bool isIndex = (!isEqual(index, null)) && isTrue(index);
        ...
        bool isQuanto = (!isEqual(quanto, null)) && isTrue(quanto);
        ...
        if (!(inOp(skippedProperties, "marginModes")))
        {
            ...
            assert(marginModes.ContainsKey("cross"), add("marginModes should have \"cross\" key", logText));
            assert(marginModes.ContainsKey("isolated"), add("marginModes should have \"isolated\" key", logText));
