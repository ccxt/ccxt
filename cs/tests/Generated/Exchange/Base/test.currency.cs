...
public partial class testMainClass : BaseTest
{
    public static void testCurrency(BaseExchange exchange, object skippedProperties, object method, object entry)
    {
        ...
        object isNative = isTrue(isTrue((!isEqual(getValue(exchange.has, "fetchCurrencies"), null))) && isTrue((!isEqual(getValue(exchange.has, "fetchCurrencies"), false)))) && isTrue((!isEqual(getValue(exchange.has, "fetchCurrencies"), "emulated")));
