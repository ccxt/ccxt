...
public partial class BaseTest
{
        ...
        public void helperTestProperties()
        {
            ...
            Assert((((new List<object>(((IDictionary<string,object>)exchangeProp(exchange, "httpExceptions")).Keys))).Count == (httpExceptionKeys?.Count ?? 0)), add(add("httpExceptions should have ", ((object)((httpExceptionKeys?.Count ?? 0))).ToString()), " keys"));
