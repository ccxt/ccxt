...
public partial class BaseTest
{
        ...
        // ----------------------------------------------------------------------------
            ...
            for (int i = 1; i < 11; postFixIncrement(ref i))
            {
            ...
            for (int i = 30; i < 33; postFixIncrement(ref i))
            {
                cacheSymbolId5.append(new Dictionary<string, object>() {
                    { "symbol", "BTC/USDT" },
                    { "id", ((object)i).ToString() },
        ...
        // ----------------------------------------------------------------------------
            ...
            int initialLength = 5;
            for (int i = 0; i < initialLength; postFixIncrement(ref i))
            {
        ...
        // ----------------------------------------------------------------------------
            ...
            for (int i = 0; i < appendItemsLength; postFixIncrement(ref i))
            {
        ...
        // ----------------------------------------------------------------------------
            ...
            for (int i = 1; i < 7; postFixIncrement(ref i))
            {
