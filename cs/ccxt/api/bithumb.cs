...
public partial class bithumb : Exchange
{
    ...
    public async Task<object> v2publicGetMarketAll (object parameters = null)
    {
        return await this.callAsync ("v2publicGetMarketAll",parameters);
    }
    ...
    public async Task<object> v2publicGetOrderbook (object parameters = null)
    {
        return await this.callAsync ("v2publicGetOrderbook",parameters);
    }

    public async Task<object> v2publicGetTradesTicks (object parameters = null)
    {
        return await this.callAsync ("v2publicGetTradesTicks",parameters);
    }

    public async Task<object> v2publicGetCandlesMinutesUnit (object parameters = null)
    {
        return await this.callAsync ("v2publicGetCandlesMinutesUnit",parameters);
    }

    public async Task<object> v2publicGetCandlesInterval (object parameters = null)
    {
        return await this.callAsync ("v2publicGetCandlesInterval",parameters);
    }

    public async Task<object> v2publicGetCandlestickMarketInterval (object parameters = null)
    {
        return await this.callAsync ("v2publicGetCandlestickMarketInterval",parameters);
    }
    ...
    public async Task<object> v2privateGetOrdersChance (object parameters = null)
    {
        return await this.callAsync ("v2privateGetOrdersChance",parameters);
    }

    public async Task<object> v2privateGetOrder (object parameters = null)
    {
        return await this.callAsync ("v2privateGetOrder",parameters);
    }

    public async Task<object> v2privateGetOrders (object parameters = null)
    {
        return await this.callAsync ("v2privateGetOrders",parameters);
    }

    public async Task<object> v2privatePostOrders (object parameters = null)
    {
        return await this.callAsync ("v2privatePostOrders",parameters);
    }

    public async Task<object> v2privateDeleteOrder (object parameters = null)
    {
        return await this.callAsync ("v2privateDeleteOrder",parameters);
    }
