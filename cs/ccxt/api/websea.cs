...
public partial class websea : Exchange
{
    ...
    public async Task<object> privateGetOpenApiContractHistoryList (object parameters = null)
    {
        return await this.callAsync ("privateGetOpenApiContractHistoryList",parameters);
    }
