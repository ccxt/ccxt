...
public partial class btcbox
{
    ...
    public async Task<List<ccxt.Order>> FetchOrdersByType(object type, string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchOrdersByType(type, symbol, since, limit, parameters);
        return res;
    }
    /// <summary>
