...
public partial class mercado
{
    ...
    public async Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = "15m", Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
