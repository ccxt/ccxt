...
public partial class okx
{
    ...
    /// </remarks>
    /// <returns> <term>undefined</term> undefined.</returns>
    public async Task<List<OpenInterest>> FetchOpenInterestHistory(string symbol, string timeframe = "1d", Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
