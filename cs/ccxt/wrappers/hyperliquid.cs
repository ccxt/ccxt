...
public partial class hyperliquid
{
    ...
    /// </remarks>
    /// <returns> <term>object[]</term> an array of objects representing market data.</returns>
    public async Task<List<ccxt.MarketInterface>> FetchHip3Markets(Dictionary<string, object> parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>object[]</term> an array of objects representing market data.</returns>
    public async Task<List<ccxt.MarketInterface>> FetchSwapMarkets(object parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>object[]</term> an array of objects representing market data.</returns>
    public async Task<List<ccxt.MarketInterface>> FetchSpotMarkets(object parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>object</term> An [order structure]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<ccxt.Order> CancelTwapOrder(string id, string symbol = null, Dictionary<string, object> parameters = null)
    {
