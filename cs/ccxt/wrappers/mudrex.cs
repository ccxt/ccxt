...
public partial class mudrex
{
    ...
    /// </remarks>
    /// <returns> <term>int[][]</term> A list of candles ordered as timestamp, open, high, low, close, volume.</returns>
    public async Task<List<OHLCV>> FetchMarkOHLCV(string symbol, string timeframe = "1m", Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<Order>> FetchOrdersByState(string state, string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
