...
public partial class mudrex
{
    ...
    public async Task<List<ccxt.Order>> FetchOrdersByState(string state, string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
