...
public partial class gemini
{
    ...
    public async Task<ccxt.Ticker> FetchTickerV1(string symbol, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<ccxt.Ticker> FetchTickerV1AndV2(string symbol, Dictionary<string, object> parameters = null)
    {
