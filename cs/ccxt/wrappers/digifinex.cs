...
public partial class digifinex
{
    ...
    public async Task<List<Transaction>> FetchTransactionsByType(object type, string code = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
