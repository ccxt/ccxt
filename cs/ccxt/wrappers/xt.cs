...
public partial class xt
{
    ...
    public async Task<ccxt.Order> CreateSpotOrder(string symbol, string type, object side, object amount, double? price = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.createSpotOrder(symbol, type, side, amount, price, parameters);
        return res;
    }
    public async Task<ccxt.Order> CreateContractOrder(string symbol, object type, object side, object amount, double? price = null, Dictionary<string, object> parameters = null)
    {
