...
public partial class bitflyer
{
    ...
    /// </remarks>
    /// <returns> <term>Order[]</term> a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<List<Order>> FetchOpenOrders(string symbol = null, Int64? since = null, Int64 limit = 100, Dictionary<string, object> parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>Order[]</term> a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<List<Order>> FetchClosedOrders(string symbol = null, Int64? since = null, Int64 limit = 100, Dictionary<string, object> parameters = null)
    {
