...
public partial class bitso
{
    ...
    public async Task<List<Trade>> FetchMyTrades(string symbol = null, Int64? since = null, Int64 limit = 25, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<Order>> FetchOpenOrders(string symbol = null, Int64? since = null, Int64 limit = 25, Dictionary<string, object> parameters = null)
    {
