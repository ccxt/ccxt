...
public partial class lbank
{
    ...
    public async Task<ccxt.Order> FetchOrderSupplement(string id, string symbol = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchOrderSupplement(id, symbol, parameters);
        return res;
    }
    public async Task<ccxt.Order> FetchOrderDefault(string id, string symbol = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<ccxt.DepositAddress> FetchDepositAddressDefault(string code, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchDepositAddressDefault(code, parameters);
        return res;
    }
    public async Task<ccxt.DepositAddress> FetchDepositAddressSupplement(string code, Dictionary<string, object> parameters = null)
    {
