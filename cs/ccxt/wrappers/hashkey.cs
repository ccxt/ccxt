...
public partial class hashkey
{
    ...
    /// </remarks>
    /// <returns> <term>object</term> an [order structure]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<ccxt.Order> CreateSwapOrder(string symbol, string type, string side, double amount, double? price = null, Dictionary<string, object> parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>Order[]</term> a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<List<ccxt.Order>> FetchOpenSpotOrders(string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>Order[]</term> a list of [order structures]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<List<ccxt.Order>> FetchOpenSwapOrders(string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
