...
public partial class phemex
{
    ...
    /// <description>
    /// string : the chain name to fetch the deposit address e.g. ETH, TRX, EOS, SOL, etc.
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// <description>
    /// string : *USDT contracts only* 'privateGetGAccountsAccountPositions' or 'privateGetGAccountsPositions' default is 'privateGetGAccountsAccountPositions'
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://phemex-docs.github.io/#query-closed-positions"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    ...
    public async Task<List<Position>> FetchPositionHistory(string symbol, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://phemex-docs.github.io/#query-account-positions"/>  <br/>
    /// See <see href="https://phemex-docs.github.io/#query-trading-account-and-positions"/>  <br/>
    /// See <see href="https://phemex-docs.github.io/#query-account-positions-with-unrealized-pnl"/>  <br/>
    /// <list type="table">
    /// <item>
    ...
    /// <term>params.code</term>
    /// <description>
    /// string : the currency code to fetch ranks for, USD, BTC or USDT, USDT is the default
    /// </description>
    /// </item>
    /// <item>
    /// <term>params.method</term>
