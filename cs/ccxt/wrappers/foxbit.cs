...
public partial class foxbit
{
    ...
    public async Task<List<ccxt.Order>> FetchOrdersByStatus(string status, string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
