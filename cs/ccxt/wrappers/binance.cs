...
public partial class binance
{
    ...
    public async Task<ccxt.Order> EditSpotOrder(string id, string symbol, string type, string side, double amount, double? price = null, Dictionary<string, object> parameters = null)
    {
    ...
    /// </remarks>
    /// <returns> <term>object</term> an [order structure]{@link https://docs.ccxt.com/?id=order-structure}.</returns>
    public async Task<ccxt.Order> EditContractOrder(string id, string symbol, string type, string side, double amount, double? price = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<ccxt.Position>> FetchOptionPositions(List<String> symbols = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<ccxt.Position>> FetchAccountPositions(List<String> symbols = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<ccxt.OpenInterest>> FetchOpenInterestHistory(string symbol, string timeframe = "5m", Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://developers.binance.com/docs/derivatives/usds-margined-futures/market-data/rest-api/ADL-Risk"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://developers.binance.com/docs/derivatives/usds-margined-futures/trade/rest-api/Position-ADL-Quantile-Estimation"/>  <br/>
    /// See <see href="https://developers.binance.com/docs/derivatives/coin-margined-futures/trade/rest-api/Position-ADL-Quantile-Estimation"/>  <br/>
    /// See <see href="https://developers.binance.com/docs/derivatives/portfolio-margin/trade/UM-Position-ADL-Quantile-Estimation"/>  <br/>
    /// See <see href="https://developers.binance.com/docs/derivatives/portfolio-margin/trade/CM-Position-ADL-Quantile-Estimation"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// <term>params.portfolioMargin</term>
    /// <description>
    /// boolean : set to true for the portfolio margin account
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    /// <returns> <term>object[]</term> an array of [auto de leverage structure]{@link https://docs.ccxt.com/?id=auto-de-leverage-structure}.</returns>
