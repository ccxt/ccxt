...
public partial class binance
{
    ...
    public async Task<List<Dictionary<string, object>>> FetchMarkets(Dictionary<string, object> parameters = null)
    {
        ...
        return ((List<object>)res).Select(item => (item as Dictionary<string, object>)).ToList();
    }
    ...
    public Dictionary<string, object> EditSpotOrderRequest(string id, object symbol, object type, object side, object amount, object price = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<Order>> CancelOrders(List<float> ids, string symbol = null, Dictionary<string, object> parameters = null)
    {
    ...
    /// See <see href="https://binance-docs.github.io/apidocs/spot/en/#isolated-margin-account-transfer-margin"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
