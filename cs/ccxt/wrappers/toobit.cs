...
public partial class toobit
{
    ...
    public async Task<List<ccxt.Transaction>> FetchDepositsOrWithdrawalsHelper(object type, object code, object since, object limit, Dictionary<string, object> parameters = null)
    {
