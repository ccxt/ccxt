...
public partial class htx
{
    ...
    public async Task<List<ccxt.Trade>> FetchSpotOrderTrades(string id, string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
    ...
    public async Task<List<ccxt.Order>> FetchSpotOrdersByStates(object states, string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchSpotOrdersByStates(states, symbol, since, limit, parameters);
        return res;
    }
    public async Task<List<ccxt.Order>> FetchSpotOrders(string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchSpotOrders(symbol, since, limit, parameters);
        return res;
    }
    public async Task<List<ccxt.Order>> FetchClosedSpotOrders(string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchClosedSpotOrders(symbol, since, limit, parameters);
        return res;
    }
    public async Task<List<ccxt.Order>> FetchContractOrders(string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
        var res = await this.fetchContractOrders(symbol, since, limit, parameters);
        return res;
    }
    public async Task<List<ccxt.Order>> FetchClosedContractOrders(string symbol = null, Int64? since = null, Int64? limit = null, Dictionary<string, object> parameters = null)
    {
