...
public partial class bingx
{
    ...
    public async Task<List<ccxt.MarketInterface>> FetchSpotMarkets(object parameters)
    {
        var res = await this.fetchSpotMarkets(parameters);
        return res;
    }
    public async Task<List<ccxt.MarketInterface>> FetchSwapMarkets(object parameters)
    {
        var res = await this.fetchSwapMarkets(parameters);
        return res;
    }
    public async Task<List<ccxt.MarketInterface>> FetchInverseSwapMarkets(object parameters)
    {
