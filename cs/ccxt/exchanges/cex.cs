...
public partial class cex : Exchange
{
    ...
    {
        parameters ??= new Dictionary<string, object>();
        Dictionary<string, object> response = await this.publicPostGetPairsInfo(parameters);
        //
        //    {
        //        "ok": "ok",
        //        "data": [
    ...
    {
        parameters ??= new Dictionary<string, object>();
        Dictionary<string, object> response = await this.publicPostGetServerTime(parameters);
        //
        //    {
        //        "ok": "ok",
        //        "data": {
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if ((dataType == null))
        {
            throw new ArgumentsRequired (add(this.id, " fetchOHLCV requires a parameter \"dataType\" to be either \"bestBid\" or \"bestAsk\"")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
    ...
    public async override Task<ccxt.TradingFees> FetchTradingFees(object parameters = null)
    {
        ...
        Dictionary<string, object> response = await this.privatePostGetMyCurrentFee(parameters);
        //
        //    {
        //        "ok": "ok",
        //        "data": {
        ...
        //
        IDictionary<string, object> data = this.safeDict(response, "data", new Dictionary<string, object>() {});
        IDictionary<string, object> fees = this.safeDict(data, "tradingFee", new Dictionary<string, object>() {});
    ...
    public virtual Dictionary<string, object> parseTradingFees(object response, object useKeyAsId = null)
    {
        ...
        for (int i = 0; isLessThan(i, keys.Count); postFixIncrement(ref i))
        {
            ...
            {
                result[(string)GetValue(parsed, "symbol")] = parsed;
            }
        }
    ...
    public async override Task<List<ccxt.Account>> FetchAccounts(object parameters = null)
    {
        ...
        //
        IDictionary<string, object> data = this.safeDict(response, "data", new Dictionary<string, object>() {});
        IDictionary<string, object> balances = this.safeDict(data, "balancesPerAccounts", new Dictionary<string, object>() {});
        IList<object> arrays = this.toArray(balances);
        return ccxt.BaseExchange.ToAccountList(this.parseAccounts(arrays, parameters));
    }
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        accountName = (string)accountNameparametersVariable[0];
        parameters = accountNameparametersVariable[1]; // default is empty string
        string? method = null;
    ...
    public async override Task<ccxt.Order> CreateOrder(string symbol, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        if ((accountId == null))
        {
            throw new ArgumentsRequired (add(this.id, " createOrder() : API trading is now allowed from main account, set params[\"accountId\"] or .options[\"createOrder\"][\"accountId\"] to the name of your sub-account")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
        ...
        triggerPrice = (string)triggerPriceparametersVariable[0];
        parameters = triggerPriceparametersVariable[1];
    ...
    public async override Task<ccxt.Order> CancelOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "orderId", parseInt(id) },
            { "cancelRequestId", add("c_", (this.milliseconds()).ToString()) },
            { "timestamp", this.milliseconds() },
        };
    ...
    public async override Task<List<ccxt.Order>> CancelAllOrders(string symbol = null, object parameters = null)
    {
        ...
        Dictionary<string, object> response = await this.privatePostDoCancelAllOrders(parameters);
        //
        //    {
        //        "ok": "ok",
        //        "data": {
    ...
    public async virtual Task<ccxt.TransferEntry> TransferBetweenSubAccounts(string code, object amount, string fromAccount, string toAccount, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        if (isEqual(this.markets, null))
        {
        ...
        Dictionary<string, object> response = await this.privatePostDoMyInternalTransfer(this.extend(request, parameters));
        //
        //    {
        //        "ok": "ok",
        //        "data": {
    ...
    public async override Task<ccxt.DepositAddress> FetchDepositAddress(string code, object parameters = null)
    {
        ...
        if ((accountId == null))
        {
            throw new ArgumentsRequired (add(this.id, " fetchDepositAddress() : main account is not allowed to fetch deposit address from api, set params[\"accountId\"] or .options[\"createOrder\"][\"accountId\"] to the name of your sub-account")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
    ...
    public override Dictionary<string, object> parseDepositAddress(object depositAddress, Dictionary<string, object> currency = null)
    {
        ...
        return new Dictionary<string, object>() {
            ...
            { "network", this.networkIdToCode(this.safeString(depositAddress, "blockchain"), getValue(currencyVar, "code")) },
            { "address", address },
            { "tag", null },
        };
    }
    ...
    public override object handleErrors(object code, string reason, string url, string method, object headers, object body, object response, Dictionary<string, object> requestHeaders, object requestBody)
    {
        ...
        if (isEqual(response, null))
        {
            ...
            {
                throw new NullResponse (add(this.id, " returned empty response")) ;
            ...
            {
                throw new NullResponse (add(add(this.id, " returned unparsed response: "), body)) ;
            }
        }
        ...
        if (getIndexOf(url, "do_my_new_order") >= 0)
        {
            ...
            if ((rejectReason != null))
            {
                ...
                throw new ExchangeError (add(add(this.id, " createOrder() "), rejectReason)) ;
            }
        }
        return null;
    }
