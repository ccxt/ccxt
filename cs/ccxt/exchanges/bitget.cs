...
public partial class bitget : Exchange
{
    ...
    public async override Task<ccxt.TradingFees> FetchTradingFees(object parameters = null)
    {
        ...
        if (isEqual(uta, true))
        {
            ...
            {
                throw new NotSupported ((string)(add((this.id + " does not support "), marketType) + " market")) ;
            }
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        {
            marketType = ((bool) (isEqual(getValue(market, "spot"), true))) ? "spot" : "swap";
        ...
        string key = ((bool) (isEqual(getValue(market, "spot"), true))) ? "spot" : "swap";
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchBalance() does not support "), marketType) + " accounts")) ;
        }
        // spot
        //
        //     {
    ...
    public virtual object createOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " createOrder() does not support "), marketType) + " orders")) ;
        }
        return this.extend(request, parameters);
    }
