...
public partial class bitget : Exchange
{
    ...
    public override object parseCurrency(object rawCurrency)
    {
        ...
        object active = isTrue((isEqual(withdraw, true))) && isTrue((isEqual(deposit, true)));
    ...
    public async override Task<object> fetchOrderBook(string symbol, Int64? limit = null, object parameters = null)
    {
        ...
        //
        object data = this.safeValue(response, "data", new Dictionary<string, object>() {});
        object bidsKey = ((bool) isTrue((isEqual(uta, true)))) ? "b" : "bids";
        object asksKey = ((bool) isTrue((isEqual(uta, true)))) ? "a" : "asks";
    ...
    public override object parseOHLCV(object ohlcv, object market = null)
    {
        ...
        object volumeIndex = ((bool) isTrue((isEqual(inverse, true)))) ? 6 : 5;
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        object key = ((bool) isTrue((isEqual(getValue(market, "spot"), true)))) ? "spot" : "swap";
    ...
    public async override Task<ccxt.Order> CancelOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        uta = ((IList<object>)utaparametersVariable)[0];
        parameters = ((IList<object>)utaparametersVariable)[1];
        object isPlanOrder = isTrue((isEqual(trigger, true))) || isTrue((isEqual(trailing, true)));
        object isContract = isTrue((isEqual(getValue(market, "swap"), true))) || isTrue((isEqual(getValue(market, "future"), true)));
        object isContractTriggerEndpoint = isTrue(isTrue(isContract) && isTrue(isPlanOrder)) && isTrue((!isEqual(uta, true)));
        object clientOrderId = this.safeString2(parameters, "clientOrderId", "clientOid");
    ...
    public async override Task<object> cancelOrders(object ids, string symbol = null, object parameters = null)
    {
        ...
        if (isTrue(isEqual(uta, true)))
        {
            return ccxt.BaseExchange.FromOrderList(await this.CancelUtaOrders(ids,((string)symbol), parameters));
        }
        object marginMode = null;
    ...
    public async override Task<List<ccxt.Order>> FetchOpenOrders(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        object isTrigger = isTrue((isEqual(trigger, true))) || isTrue(planTypeDefined);
        var requestparametersVariable = this.handleUntilOption("endTime", request, parameters);
        request = ((IList<object>)requestparametersVariable)[0];
        parameters = ((IList<object>)requestparametersVariable)[1];
        if (isTrue(!isEqual(sinceVar, null)))
