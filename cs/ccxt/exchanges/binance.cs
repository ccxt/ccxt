...
public partial class binance : Exchange
{
    ...
    public async override Task<ccxt.Tickers> FetchBidsAsks(object symbols = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchBidsAsks() does not support "), type) + " markets yet")) ;
        }
        if (!((response is IList<object>) || (response.GetType().IsGenericType && response.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
    ...
    public async override Task<ccxt.Tickers> FetchTickers(object symbols = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchTickers() does not support "), type) + " markets yet")) ;
        }
        return ccxt.BaseExchange.ToTickers(this.parseTickers(response, symbols));
    }
    ...
    public async override Task<ccxt.Ticker> FetchMarkPrice(string symbol, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchMarkPrice() does not support "), type) + " markets yet")) ;
        }
        if (((response is IList<object>) || (response.GetType().IsGenericType && response.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
    ...
    public async override Task<ccxt.Tickers> FetchMarkPrices(object symbols = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchMarkPrices() does not support "), type) + " markets yet")) ;
        }
        return ccxt.BaseExchange.ToTickers(this.parseTickers(response, symbols));
    }
    ...
    public virtual object createOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        } else if (isStopLoss)
        {
            ...
            if (isMarketOrder)
            {
                ...
                uppercaseType = ((bool) (isEqual(getValue(market, "contract"), true))) ? "STOP_MARKET" : "STOP_LOSS";
            } else if (isLimitOrder)
            {
                uppercaseType = ((bool) (isEqual(getValue(market, "contract"), true))) ? "STOP" : "STOP_LOSS_LIMIT";
            }
        } else if (isTakeProfit)
        {
            ...
            if (isMarketOrder)
            {
                ...
                uppercaseType = ((bool) (isEqual(getValue(market, "contract"), true))) ? "TAKE_PROFIT_MARKET" : "TAKE_PROFIT";
            } else if (isLimitOrder)
            {
                uppercaseType = ((bool) (isEqual(getValue(market, "contract"), true))) ? "TAKE_PROFIT" : "TAKE_PROFIT_LIMIT";
            }
        }
        if (isEqual(getValue(market, "option"), true))
        {
        ...
        if ((clientOrderId == null))
        {
            ...
            string defaultId = ((bool) (isEqual(getValue(market, "contract"), true))) ? "x-xcKtGhcu" : "x-TKT5PX2F";
    ...
    public async override Task<ccxt.TradingFees> FetchTradingFees(object parameters = null)
    {
        ...
        throw new NotSupported ((string)(add((this.id + " fetchTradingFees() is not supported for "), type) + " markets")) ;
    }
    ...
    public virtual object getExceptionsByUrl(object url, object exactOrBroad)
    {
        ...
        string? marketType = null;
        object hostname = ((bool) (!isEqual(this.hostname, null))) ? this.hostname : "binance.com";
        if (((string)url).StartsWith(((string)(add("https://api.", hostname) + "/"))) || ((string)url).StartsWith(((string)"https://demo-api")) || ((string)url).StartsWith(((string)"https://testnet.binance.vision")))
        {
            marketType = "spot";
        } else if (((string)url).StartsWith(((string)(add("https://dapi.", hostname) + "/"))) || ((string)url).StartsWith(((string)"https://demo-dapi")) || ((string)url).StartsWith(((string)"https://testnet.binancefuture.com/dapi")))
        {
            marketType = "inverse";
        } else if (((string)url).StartsWith(((string)(add("https://fapi.", hostname) + "/"))) || ((string)url).StartsWith(((string)"https://demo-fapi")) || ((string)url).StartsWith(((string)"https://testnet.binancefuture.com/fapi")))
        {
            marketType = "linear";
        } else if (((string)url).StartsWith(((string)(add("https://eapi.", hostname) + "/"))))
        {
            marketType = "option";
        } else if (((string)url).StartsWith(((string)(add("https://papi.", hostname) + "/"))))
        {
    ...
    public async override Task<List<ccxt.OpenInterest>> FetchOpenInterestHistory(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        string symbolKey = ((bool) (isEqual(getValue(market, "linear"), true))) ? "symbol" : "pair";
    ...
    public async override Task<List<ccxt.Liquidation>> FetchMyLiquidations(object symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if ((market != null))
        {
            string symbolKey = ((bool) (isEqual(getValue(market, "spot"), true))) ? "isolatedSymbol" : "symbol";
            if (!isTrue(isPortfolioMargin))
            {
                ((IDictionary<string,object>)request)[(string)symbolKey] = getValue(market, "id");
            }
