...
public partial class binance : Exchange
{
    ...
    {
        parameters ??= new Dictionary<string, object>();
        object originalUseSbe = this.safeBool(this.options, "useSbe", false);
        if (isTrue(originalUseSbe))
        {
            ((IDictionary<string,object>)this.options)["useSbe"] = false;
        }
        ...
        if (isTrue(originalUseSbe))
        {
            ((IDictionary<string,object>)this.options)["useSbe"] = true;
        }
    ...
    public async override Task<object> fetchOrderBook(object symbol, object limit = null, object parameters = null)
    {
        ...
        //    }
        //
        object priceExponent = this.safeInteger(response, "priceExponent");
        ...
        if (isTrue(isTrue(!isEqual(priceExponent, null)) && isTrue(!isEqual(qtyExponent, null))))
        {
            ...
            {
                ((List<object>)asks)[Convert.ToInt32(i)] = new List<object> {this.applyExponent(getValue(getValue(asks, i), "price"), priceExponent), this.applyExponent(getValue(getValue(asks, i), "qty"), qtyExponent)};
            }
    ...
    public async override Task<object> fetchTrades(object symbol, object since = null, object limit = null, object parameters = null)
    {
        ...
        object isOption = this.safeBool(market, "option", false);
        if (!isTrue(isOption))
        {
            if (isTrue(!isEqual(since, null)))
            {
        ...
        object response = null;
        if (isTrue(isTrue(useSbe) && isTrue(getValue(market, "spot"))))
        {
            // Use SBE for spot trades endpoint /api/v3/trades
            object sbeHeaders = new Dictionary<string, object>() {
                { "Accept", "application/sbe" },
                { "X-MBX-SBE", add(add(sbeSchemaId, ":"), sbeSchemaVersion) },
            };
            ...
            response = await this.request("trades", "public", "GET", this.extend(request, parameters), sbeHeaders, null);
            ...
            object priceExponent = this.safeInteger(response, "priceExponent", 0);
            object qtyExponent = this.safeInteger(response, "qtyExponent", 0);
            object sbeTradesArray = this.safeList(response, "trades", this.safeList(response, "trade", this.safeList(response, "Trade", new List<object>() {})));
            // Check if we got SBE trades data
            if (isTrue(isGreaterThan(getArrayLength(sbeTradesArray), 0)))
            {
                ...
                for (object i = 0; isLessThan(i, getArrayLength(sbeTradesArray)); postFixIncrement(ref i))
                {
                    object trade = getValue(sbeTradesArray, i);
                    // safeInteger now handles BigInt values from SBE
                    object priceNum = this.safeInteger(trade, "price", 0);
                    object qtyNum = this.safeInteger(trade, "qty", 0);
                    object quoteQtyNum = this.safeInteger(trade, "quoteQty", 0);
                    object idNum = this.safeString(trade, "id");
                    object timeNum = this.safeInteger(trade, "time", 0);
                    object price = this.applyExponent(priceNum, priceExponent);
                    object qty = this.applyExponent(qtyNum, qtyExponent);
                    object quoteQty = this.applyExponent(quoteQtyNum, priceExponent);
                    object timestamp = (Math.Floor(Double.Parse((divide(timeNum, 1000)).ToString()))); // microseconds to milliseconds
                    ((IList<object>)normalizedTrades).Add(new Dictionary<string, object>() {
                        { "id", ((object)idNum).ToString() },
                        { "price", ((object)price).ToString() },
                        { "qty", ((object)qty).ToString() },
                        { "quoteQty", ((object)quoteQty).ToString() },
                        { "time", timestamp },
                        { "isBuyerMaker", isEqual(this.safeInteger(trade, "isBuyerMaker"), 1) },
    ...
    public override object getSbeDecoderRegistry()
    {
        // Registry mapping template IDs to decoder classes
        return new Dictionary<string, object>() {
            { "50", typeof(WebSocketResponse) },
            { "51", typeof(WebSocketSessionLogonResponse) },
            { "52", typeof(WebSocketSessionStatusResponse) },
            { "53", typeof(WebSocketSessionLogoutResponse) },
            { "54", typeof(WebSocketSessionSubscriptionsResponse) },
            { "100", typeof(ErrorResponse) },
            { "101", typeof(PingResponse) },
            { "102", typeof(ServerTimeResponse) },
            { "103", typeof(ExchangeInfoResponse) },
            { "105", typeof(MyFiltersResponse) },
            { "200", typeof(DepthResponse) },
            { "201", typeof(TradesResponse) },
            { "202", typeof(AggTradesResponse) },
            { "203", typeof(KlinesResponse) },
            { "204", typeof(AveragePriceResponse) },
            { "205", typeof(Ticker24hSymbolFullResponse) },
            { "206", typeof(Ticker24hFullResponse) },
            { "207", typeof(Ticker24hSymbolMiniResponse) },
            { "208", typeof(Ticker24hMiniResponse) },
            { "209", typeof(PriceTickerSymbolResponse) },
            { "210", typeof(PriceTickerResponse) },
            { "211", typeof(BookTickerSymbolResponse) },
            { "212", typeof(BookTickerResponse) },
            { "213", typeof(TickerSymbolFullResponse) },
            { "214", typeof(TickerFullResponse) },
            { "215", typeof(TickerSymbolMiniResponse) },
            { "216", typeof(TickerMiniResponse) },
            { "300", typeof(NewOrderAckResponse) },
            { "301", typeof(NewOrderResultResponse) },
            { "302", typeof(NewOrderFullResponse) },
            { "303", typeof(OrderTestResponse) },
            { "304", typeof(OrderResponse) },
            { "305", typeof(CancelOrderResponse) },
            { "306", typeof(CancelOpenOrdersResponse) },
            { "307", typeof(CancelReplaceOrderResponse) },
            { "308", typeof(OrdersResponse) },
            { "309", typeof(NewOrderListAckResponse) },
            { "310", typeof(NewOrderListResultResponse) },
            { "311", typeof(NewOrderListFullResponse) },
            { "312", typeof(CancelOrderListResponse) },
            { "313", typeof(OrderListResponse) },
            { "314", typeof(OrderListsResponse) },
            { "315", typeof(OrderTestWithCommissionsResponse) },
            { "316", typeof(OrderAmendmentsResponse) },
            { "317", typeof(OrderAmendKeepPriorityResponse) },
            { "400", typeof(AccountResponse) },
            { "401", typeof(AccountTradesResponse) },
            { "402", typeof(AccountOrderRateLimitResponse) },
            { "403", typeof(AccountPreventedMatchesResponse) },
            { "404", typeof(AccountAllocationsResponse) },
            { "405", typeof(AccountCommissionResponse) },
            { "500", typeof(UserDataStreamStartResponse) },
            { "501", typeof(UserDataStreamPingResponse) },
            { "502", typeof(UserDataStreamStopResponse) },
            { "503", typeof(UserDataStreamSubscribeResponse) },
            { "504", typeof(UserDataStreamUnsubscribeResponse) },
            { "505", typeof(UserDataStreamSubscribeListenTokenResponse) },
        };
    }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        method ??= "GET";
        parameters ??= new Dictionary<string, object>();
        object result = this.handleOptionAndParams(parameters, "sign", "useSbe", false);
        object useSbe = getValue(result, 0);
        parameters = getValue(result, 1);
        result = this.handleOptionAndParams(parameters, "sign", "sbeSchemaId", 3);
        object sbeSchemaId = getValue(result, 0);
        parameters = getValue(result, 1);
        result = this.handleOptionAndParams(parameters, "sign", "sbeSchemaVersion", 1);
        object sbeSchemaVersion = getValue(result, 0);
        parameters = getValue(result, 1);
        ...
        if (isTrue(isGreaterThan(getIndexOf(url, "testnet.binance.vision"), -1)))
        {
        ...
        if (isTrue(isTrue(isTrue(isTrue(useSbe) && isTrue(!isEqual(sbeSchemaId, null))) && isTrue(!isEqual(sbeSchemaVersion, null))) && isTrue(isSpotApi)))
        {
            ...
            ((IDictionary<string,object>)headers)["Accept"] = "application/sbe";
            ((IDictionary<string,object>)headers)["X-MBX-SBE"] = add(add(sbeSchemaId, ":"), sbeSchemaVersion);
        }
        return new Dictionary<string, object>() {
            { "url", url },
            { "method", method },
