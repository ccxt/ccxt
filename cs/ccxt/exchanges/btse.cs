...
public partial class btse : Exchange
{
    ...
    public override object parseBalance(object response)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            if ((assets != null))
            {
                ...
                for (int j = 0; j < inUse.Count; postFixIncrement(ref j))
                {
    ...
    public async override Task<ccxt.LeverageTiers> FetchLeverageTiers(object symbols = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(data); postFixIncrement(ref i))
        {
            ...
            if ((symbols == null) || this.inArray(symbol, symbols))
            {
                ...
                for (int j = 0; j < levels.Count; postFixIncrement(ref j))
                {
    ...
    public async override Task<List<ccxt.Order>> CancelAllOrders(string symbol = null, object parameters = null)
    {
        ...
        if (isEqual(marketType, "spot"))
        {
            ...
            ((IDictionary<string,object>)request)["symbol"] = ((bool) ((market != null))) ? getValue(market, "id") : "ALL";
    ...
    public async virtual Task<object> requestWalletHistoryRows(object methodName, object historyTypes, string code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        for (int i = 0; i < typesList.Count; postFixIncrement(ref i))
        {
        ...
        List<object> rows = new List<object>() {};
        for (int i = 0; i < rawRows.Count; postFixIncrement(ref i))
        {
