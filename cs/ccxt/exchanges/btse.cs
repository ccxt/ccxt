...
public partial class btse : Exchange
{
    ...
    public override object parseBalance(object response)
    {
        ...
        object totals = new Dictionary<string, object>() {};
        object frees = new Dictionary<string, object>() {};
        object useds = new Dictionary<string, object>() {};
    ...
    public override object parseTicker(object ticker, object market = null)
    {
        ...
        if (isTrue(isTrue(isTrue((!isEqual(baseVolume, null))) && isTrue((!isEqual(market, null)))) && isTrue(getValue(market, "contract"))))
        {
            ...
            object contractSizeString = this.numberToString(getValue(market, "contractSize"));
    ...
    public async override Task<List<ccxt.Trade>> fetchOrderTrades(string id, string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        return ccxt.BaseExchange.ToTradeList(await this.fetchMyTrades(((string)symbol),ccxt.BaseExchange.ToInt64Arg(since),ccxt.BaseExchange.ToInt64Arg(limit), parameters));
    }
     ...
     * @returns {object} an [order structure]{@link https://docs.ccxt.com/?id=order-structure}
     */
    public async virtual Task<object> createContractOrder(object symbol, object type, object side, object amount, double? price = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        await this.loadMarkets();
        object market = this.market(symbol);
    ...
    public async override Task<ccxt.Order> editOrder(string id, string symbol, string type, string side, double? amount = null, double? price = null, object parameters = null)
    {
        ...
        if (isTrue(isTrue(isTrue(isTrue((isEqual(amount, null))) && isTrue((isEqual(price, null)))) && isTrue((isEqual(triggerPrice, null)))) && !isTrue(isSlide)))
        {
    ...
    public async virtual Task<object> requestWalletHistoryRows(object methodName, object historyTypes, object code = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        object allowed = new Dictionary<string, object>() {};
    ...
    public async override Task<object> setMarginMode(string marginMode, string symbol = null, object parameters = null)
    {
        ...
        } else if (isTrue(isTrue((inOp(parameters, "hedged"))) && isTrue((!isTrue(hedged)))))
        {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isTrue(isEqual(api, "private")))
        {
            ...
            if (isTrue(((string)path).StartsWith(((string)"public-api/"))))
            {
                signPath = add("/", path);
            } else
            {
