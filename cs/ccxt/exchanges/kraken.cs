...
public partial class kraken : Exchange
{
    ...
    public async override Task<ccxt.Order> EditOrder(string id, string symbol, string type, string side, double? amount = null, double? price = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " editOrder() does not support "), (market.ContainsKey("type") ? market["type"] : null)) + " orders, only spot orders are accepted")) ;
        }
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "txid", id },
        };
    ...
    public async virtual Task<List<ccxt.Order>> FetchOrdersByIds(object ids, string symbol = null, object parameters = null)
    {
        ...
        for (int i = 0; i < orderIds.Count; postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.DepositAddress> FetchDepositAddress(string code, object parameters = null)
    {
        ...
        if ((depositMethod == null))
        {
            ...
            if ((network != null))
            {
                ...
                for (int i = 0; i < getArrayLength(depositMethods); postFixIncrement(ref i))
                {
