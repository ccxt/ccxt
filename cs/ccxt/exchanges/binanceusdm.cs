...
public partial class binanceusdm : binance
{
    ...
    public async virtual Task<ccxt.TransferEntry> TransferIn(string code, object amount, object parameters = null)
    {
        ...
        return ccxt.BaseExchange.ToTransferEntry(await this.futuresTransfer(((string)code), amount, 1, parameters));
    }
    ...
    public async virtual Task<ccxt.TransferEntry> TransferOut(string code, object amount, object parameters = null)
    {
        ...
        parameters ??= new Dictionary<string, object>();
        return ccxt.BaseExchange.ToTransferEntry(await this.futuresTransfer(((string)code), amount, 2, parameters));
    }
}
