...
public partial class gemini : ccxt.gemini
{
    ...
    public async override Task<List<ccxt.Trade>> WatchTrades(string symbol, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if ((marketId == null))
        {
            throw new ArgumentsRequired (add(this.id, " watchTrades() marketId is required")) ;
        }
    ...
    public async override Task<ccxt.pro.IOrderBook> WatchOrderBook(string symbol, Int64? limit = null, object parameters = null)
    {
        ...
        if ((marketId == null))
        {
            throw new ArgumentsRequired (add(this.id, " watchOrderBook() marketId is required")) ;
        }
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "type", "subscribe" },
            { "subscriptions", new List<object>() {new Dictionary<string, object>() {
    ...
    public override void handleMessage(WebSocketClient client, object message)
    {
        ...
        if (type == "update")
        {
            ...
            if (isGreaterThan(lengthBa, 0))
            {
                this.handleBidsAsksForMultidata(client, bidaskItems, ts, eventId);
            }
            int lengthOb = orderBookItems.Count;
            if (isGreaterThan(lengthOb, 0))
            {
                this.handleOrderBookForMultidata(client, orderBookItems, ts, eventId);
            }
            int lengthTrades = collectedEventsOfTrades.Count;
            if (isGreaterThan(lengthTrades, 0))
            {
    ...
    public async virtual Task authenticate(object parameters = null)
    {
        ...
        int endIndex = (isGreaterThanOrEqual(urlParamsIndex, 0)) ? urlParamsIndex : urlLength;
