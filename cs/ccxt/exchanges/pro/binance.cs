...
public partial class binance : ccxt.binance
{
    ...
    public async override Task<Dictionary<string, Dictionary<string, List<ccxt.OHLCV>>>> WatchOHLCVForSymbols(object symbolsAndTimeframes, object since = null, object limit = null, object parameters = null)
    {
        ...
        if (isTrue(stock))
        {
            ...
            for (int i = 0; i < getArrayLength(symbolsAndTimeframes); i++)
            {
                ...
                ((IList<object>)stockMessageHashes).Add(((("ohlcv::" + (getValue(stockMarket, "symbol"))) + "::") + (stockTimeframeString)));
            }
    ...
    public virtual void handleTickersAndBidsAsks(WebSocketClient client, object message, object methodType)
    {
        ...
        for (int i = 0; i < getArrayLength(rawTickers); i++)
        {
            ...
            int numTickerMarkets = ((bool) ((tickerMarketsByIdList == null))) ? 0 : getArrayLength(tickerMarketsByIdList);
            ...
            object tickerMarketById = ((bool) (isEqual(numTickerMarkets, 1))) ? this.safeValue(tickerMarketsByIdList, 0) : null;
            bool isSpot = this.isSpotUrl(client);
