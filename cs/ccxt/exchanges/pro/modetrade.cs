...
public partial class modetrade : ccxt.modetrade
{
    ...
    public async virtual Task<object> watchPublic(object messageHash, object message)
    {
        ...
        object url = add(add(getValue(getValue((((IDictionary<string, object>)this.urls).ContainsKey("api") ? ((IDictionary<string, object>)this.urls)["api"] : null), "ws"), "public"), "/"), id);
    ...
    public virtual void handleOHLCV(WebSocketClient client, object message)
    {
        ...
        (client as WebSocketClient).resolve(ohlcvCache, topic);
    }
    ...
    public async virtual Task<object> authenticate(object parameters = null)
    {
        ...
        object url = add(add(getValue(getValue((((IDictionary<string, object>)this.urls).ContainsKey("api") ? ((IDictionary<string, object>)this.urls)["api"] : null), "ws"), "private"), "/"), this.accountId);
    ...
    public virtual void handleOrderUpdate(WebSocketClient client, object message)
    {
        ...
        if (((data is IList<object>) || (data.GetType().IsGenericType && data.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>)))))
        {
            ...
            for (int i = 0; i < getArrayLength(data); i++)
            {
                ...
                object tradeId = ((bool) ((tradeIdStr == null))) ? null : this.omitZero(tradeIdStr);
                if ((tradeId != null))
                {
        ...
        if ((topic != null))
        {
            ...
            if ((splitLength == 2))
            {
                ...
                if ((splitNameLength == 2))
                {
                    ...
                    method = ((bool) ((splitNameFirst == null))) ? null : this.safeValue(methods, splitNameFirst);
                    if ((method != null))
                    {
                        DynamicInvoker.InvokeMethod(method, new object[] { client, message});
                    }
