...
public partial class kucoin : ccxt.kucoin
{
    ...
    public async virtual Task<object> subscribePublicUta(object messageHash, object channel, object symbol, object parameters = null, object subscription = null)
    {
        ...
        string urlType = ((bool) (isEqual((market.ContainsKey("contract") ? market["contract"] : null), true))) ? "futures" : "spot";
    ...
    public async virtual Task<ccxt.Tickers> WatchUtaTickers(object symbols = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(symbols); postFixIncrement(ref i))
        {
            ...
            Dictionary<string, object> market = this.market(symbol);
            string subMessageHash = add((messageHash + ":"), (market.ContainsKey("symbol") ? market["symbol"] : null));
    ...
    public virtual void handleUtaTicker(WebSocketClient client, object message)
    {
        ...
        ((IDictionary<string,object>)this.tickers)[(string)(market.ContainsKey("symbol") ? market["symbol"] : null)] = ticker;
        string messageHash = add("uta:ticker:", (market.ContainsKey("symbol") ? market["symbol"] : null));
        (client as WebSocketClient).resolve(ticker, messageHash);
    }
    ...
    public async override Task<List<ccxt.OHLCV>> WatchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            object topic = add(add(add(channelName, (market.ContainsKey("id") ? market["id"] : null)), "_"), period);
    ...
    public async override Task<object> unWatchOHLCV(object symbol, string timeframe = null, object parameters = null)
    {
        ...
        string subMessageHash = add((add("candles:", symbol) + ":"), timeframeVar);
        if (isTrue(uta))
        {
            subMessageHash = ("uta:" + subMessageHash);
            ((IDictionary<string,object>)subscription)["subMessageHashes"] = new List<object>() {subMessageHash};
    ...
    public async override Task<ccxt.pro.IOrderBook> WatchOrderBook(string symbol, Int64? limit = null, object parameters = null)
    {
        ...
        if (isTrue(uta))
        {
            ...
            string messageHash = add((add("uta:orderbook:", symbolVar) + ":depth:"), depth);
            string channel = "obu";
            Dictionary<string, object> subscription = new Dictionary<string, object>() {};
    ...
    public async override Task<object> unWatchOrderBook(object symbol, object parameters = null)
    {
        ...
        if (isTrue(uta))
        {
            ...
            string subMessageHash = add((add("uta:orderbook:", symbol) + ":depth:"), depth);
            string messageHash = ("unsubscribe:" + subMessageHash);
            string channel = "obu";
            Dictionary<string, object> subscription = new Dictionary<string, object>() {
                { "messageHashes", new List<object>() {messageHash} },
    ...
    public virtual void handleMyTrade(WebSocketClient client, object message)
    {
        ...
        string symbolSpecificMessageHash = add((messageHash + ":"), getValue(parsed, "symbol"));
    ...
    public async override Task<ccxt.Position> WatchPosition(string symbol = null, object parameters = null)
    {
        ...
        Dictionary<string, object> market = this.market(symbol);
        string topic = add("/contract/position:", (market.ContainsKey("id") ? market["id"] : null));
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "privateChannel", true },
        };
        string messageHash = add("position:", (market.ContainsKey("symbol") ? market["symbol"] : null));
        var client = this.client(url);
    ...
    public async virtual Task loadPositionSnapshot(WebSocketClient client, object messageHash, object symbol)
    {
        ...
        if (inOp(client.futures, messageHash))
        {
            var future = getValue(client.futures, messageHash);
            (future as Future).resolve(cache);
            (client as WebSocketClient).resolve(position, add("position:", symbol));
        }
    }
