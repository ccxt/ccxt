...
{
    public async Task<Dictionary<string, object>> WatchPrivateMultiple(object messageHashes, object subscribeHashes, object args, Dictionary<string, object> parameters = null)
    {
        var res = await this.watchPrivateMultiple(messageHashes, subscribeHashes, args, parameters);
        return ((Dictionary<string, object>)res);
    }
    public async Task<Dictionary<string, object>> WatchPublicMultiple(object messageHashes, object subscribeHashes, object argsArray, Dictionary<string, object> parameters = null)
    {
        var res = await this.watchPublicMultiple(messageHashes, subscribeHashes, argsArray, parameters);
        return ((Dictionary<string, object>)res);
    }
    /// <summary>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/spot/#tickers-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// <description>
    /// string : the type of the instrument to fetch the ticker for, 'SP' for spot markets, 'MC' for futures markets (default is 'SP')
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/mix/#tickers-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/spot/#candlesticks-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    /// int : timestamp in ms of the earliest candle to fetch (not including)
    /// </description>
    /// </item>
    /// <item>
    /// <term>limit</term>
    /// <description>
    /// int : the maximum amount of candles to fetch (not including)
    /// </description>
    /// </item>
    /// <item>
    /// <term>params</term>
    ...
    /// <term>params.instType</term>
    /// <description>
    /// bool : the type of the instrument to fetch the OHLCV data for, 'SP' for spot markets, 'MC' for futures markets (default is 'SP')
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/spot/#depth-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>limit</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/spot/#trades-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/spot/#account-channel"/>  <br/>
    /// See <see href="https://coincatch.github.io/github.io/en/mix/#account-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>params</term>
    /// <description>
    ...
    /// <description>
    /// str : 'spot' or 'swap' (default is 'spot')
    /// </description>
    /// </item>
    /// <item>
    /// <term>params.instType</term>
    /// <description>
    /// string : *swap only* 'umcbl' or 'dmcbl' (default is 'umcbl')
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/spot/#order-channel"/>  <br/>
    /// See <see href="https://coincatch.github.io/github.io/en/mix/#order-channel"/>  <br/>
    /// See <see href="https://coincatch.github.io/github.io/en/mix/#plan-order-channel"/>  <br/>
    /// <list type="table">
    /// <item>
    /// <term>since</term>
    /// <description>
    ...
    /// <description>
    /// bool : *swap only* whether to watch trigger orders (default is false)
    /// </description>
    /// </item>
    /// </list>
    /// </remarks>
    ...
    /// </summary>
    /// <remarks>
    /// See <see href="https://coincatch.github.io/github.io/en/mix/#positions-channel"/>  <br/>
    /// <list type="table">
    /// </list>
    /// </remarks>
