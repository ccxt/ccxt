...
public partial class bitfinex : ccxt.bitfinex
{
    ...
    public async virtual Task<object> unSubscribe(object channel, object topic, object symbol, object parameters = null)
    {
        ...
        string messageHash = ((add("unsubscribe:", channel) + ":") + marketId);
        string unSubTopic = add((add(("unsubscribe" + ":"), topic) + ":"), symbol);
    ...
    public async override Task<List<ccxt.OHLCV>> WatchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        string key = add((("trade:" + interval) + ":"), (market.ContainsKey("id") ? market["id"] : null));
        string messageHash = add((((channel + ":") + interval) + ":"), (market.ContainsKey("id") ? market["id"] : null));
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "event", "subscribe" },
            { "channel", channel },
            { "key", key },
    ...
    public async override Task<object> unWatchOHLCV(object symbol, string timeframe = null, object parameters = null)
    {
        ...
        string? interval = this.safeString(this.timeframes, timeframeVar, timeframeVar);
        string channel = "candles";
        string subMessageHash = add((((channel + ":") + interval) + ":"), (market.ContainsKey("id") ? market["id"] : null));
        string messageHash = ("unsubscribe:" + subMessageHash);
        string? url = ((string)getValue(getValue(getValue(this.urls, "api"), "ws"), "public"));
        var client = this.client(url);
        string subId = add((("unsubscribe:trade:" + interval) + ":"), (market.ContainsKey("id") ? market["id"] : null)); // trade here because we use the key
    ...
    public virtual void handleMyTrade(WebSocketClient client, object message, object subscription = null)
    {
        ...
        (client as WebSocketClient).resolve(tradesArray, name);
    ...
    public override object parseWsTrade(object trade, object market = null)
    {
        ...
        int priceKey = ((bool) isPublic) ? 3 : 5;
        int amountKey = ((bool) isPublic) ? 2 : 4;
        ...
        string? orderId = ((bool) (!isPublic)) ? this.safeString(trade, 3) : null;
        ...
        {
            takerOrMaker = ((bool) (isEqual(maker, -1))) ? "taker" : "maker";
        }
    ...
    public virtual void handleOrderBook(WebSocketClient client, object message, object subscription)
    {
        ...
        if (!(inOp(this.orderbooks, symbol)))
        {
            ...
            if (isRaw)
            {
                ...
                for (int i = 0; isLessThan(i, getArrayLength(deltas)); postFixIncrement(ref i))
                {
                    ...
                    object size = ((bool) (isLessThan(delta2, 0))) ? prefixUnaryNeg(ref delta2) : delta2;
                    string side = ((bool) (isLessThan(delta2, 0))) ? "asks" : "bids";
            ...
            } else
            {
                ...
                for (int i = 0; isLessThan(i, getArrayLength(deltas)); postFixIncrement(ref i))
                {
                    ...
                    object size = ((bool) (isLessThan(amount, 0))) ? prefixUnaryNeg(ref amount) : amount;
                    string side = ((bool) (isLessThan(amount, 0))) ? "asks" : "bids";
                    object bookside = getValue(orderbook, side);
        ...
        } else
        {
            ...
            if (isRaw)
            {
                ...
                object size = ((bool) (isLessThan(deltas2, 0))) ? prefixUnaryNeg(ref deltas2) : deltas2;
    ...
    public virtual void handleBalance(WebSocketClient client, object message, object subscription)
    {
        ...
        for (int i = 0; i < getArrayLength(data); postFixIncrement(ref i))
        {
            ...
            string? code = this.safeCurrencyCode(currencyId);
            Dictionary<string, object> balance = ((Dictionary<string, object>)this.parseWsBalance(rawBalance));
    ...
    public virtual bool handleUnsubscriptionStatus(WebSocketClient client, object message)
    {
        ...
        IDictionary<string, object> subscription = this.safeDict(((WebSocketClient)client).subscriptions, ("unsubscribe:" + subMessageHash));
