...
public partial class kraken : ccxt.kraken
{
    ...
    public virtual void handleCancelOrder(WebSocketClient client, Dictionary<string, object> message)
    {
        ...
        callDynamically(client, "resolve", new object[] {message, reqId});
    }
    ...
    public async override Task<List<ccxt.OHLCV>> WatchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        string? url = ((string)getValue(getValue(getValue(this.urls, "api"), "ws"), "publicV2"));
        Int64 requestId = ((Int64)this.requestId());
    ...
    public virtual void handleHeartbeat(WebSocketClient client, Dictionary<string, object> message)
    {
        ...
        callDynamically(client, "resolve", new object[] {message, eventVar});
    }
    ...
    public virtual void handleOrderBook(WebSocketClient client, Dictionary<string, object> message)
    {
        ...
        } else
        {
            ...
            for (int i = 0; isLessThan(i, keys.Count); postFixIncrement(ref i))
            {
                ...
                if (isGreaterThan(deltasLength, 0))
                {
    ...
    public async virtual Task<string?> authenticate(object parameters = null)
    {
        ...
        if (((subscription == null)) || (((subscription != null)) && isLessThanOrEqual((add(start, expires)), now)))
        {
            ...
            try
            {
                ...
                callDynamically(client, "resolve", new object[] {token, messageHash});
            } catch(Exception e)
            {
    ...
    public virtual void handleMyTrades(WebSocketClient client, Dictionary<string, object> message, object subscription = null)
    {
        ...
        int allTradesLength = allTrades.Count;
        if (isGreaterThan(allTradesLength, 0))
        {
            ...
            for (int i = 0; isLessThan(i, allTrades.Count); postFixIncrement(ref i))
            {
    ...
    public virtual void handleOrders(WebSocketClient client, Dictionary<string, object> message, object subscription = null)
    {
        ...
        int allOrdersLength = allOrders.Count;
        if (isGreaterThan(allOrdersLength, 0))
        {
            ...
            Dictionary<string, object> symbols = new Dictionary<string, object>() {};
            for (int i = 0; isLessThan(i, allOrders.Count); postFixIncrement(ref i))
            {
    ...
    public virtual void handleBalance(WebSocketClient client, Dictionary<string, object> message)
    {
        ...
        callDynamically(client, "resolve", new object[] {getValue(this.balance, type), channel});
    }
