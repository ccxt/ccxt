...
public partial class bybit : ccxt.bybit
{
    ...
    public async override Task<ccxt.Order> CreateOrderWs(string symbol, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        string? url = ((string)getValue(getValue(getValue(getValue(this.urls, "api"), "ws"), "private"), "trade"));
    ...
    public async override Task<ccxt.Ticker> WatchTicker(string symbol, object parameters = null)
    {
        ...
        string? url = await this.getUrlByMarketType(symbolVar, false, "watchTicker", parameters);
    ...
    public async override Task<ccxt.Tickers> WatchBidsAsks(object symbols = null, object parameters = null)
    {
        ...
        symbols = this.marketSymbols(symbols, null, false);
        List<object> messageHashes = new List<object>() {};
        string? url = await this.getUrlByMarketType(getValue(symbols, 0), false, "watchBidsAsks", parameters);
        parameters = this.cleanParams(parameters);
        IList<object> marketIds = this.marketIds(symbols);
        List<object> topics = new List<object>() {};
        for (int i = 0; isLessThan(i, marketIds?.Count ?? 0); postFixIncrement(ref i))
    ...
    public async override Task<ccxt.pro.IOrderBook> WatchOrderBookForSymbols(object symbols, Int64? limit = null, object parameters = null)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
        {
            ...
            string topic = add(add(add("orderbook.", ((object)limitVar).ToString()), "."), marketId);
            ((IList<object>)topics).Add(topic);
    ...
    public async override Task<object> unWatchOrderBookForSymbols(IList<object> symbols, object parameters = null)
    {
        ...
        } else
        {
            ...
            limit = (isEqual(GetValue(firstMarket, "spot"), true)) ? 50 : 500;
        }
        channel = add(channel, limit.ToString());
        List<object> subMessageHashes = new List<object>() {};
        List<object> messageHashes = new List<object>() {};
        List<object> topics = new List<object>() {};
    ...
    public async override Task<List<ccxt.Trade>> WatchTradesForSymbols(object symbols, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        parameters = this.cleanParams(parameters);
        string? url = await this.getUrlByMarketType(getValue(symbols, 0), false, "watchTrades", parameters);
        List<object> topics = new List<object>() {};
        List<object> messageHashes = new List<object>() {};
        for (int i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
        {
    ...
    public async override Task<List<ccxt.Trade>> WatchMyTrades(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        string? url = await this.getUrlByMarketType(symbolVar, true, method, parameters);
        await this.authenticate(url);
        ...
        executionFast = executionFastparametersVariable[0];
    ...
    public async virtual Task<object> watchTopics(object url, object messageHashes, object topics, object parameters = null)
    {
        ...
        } else
        {
            ...
            {
                IDictionary<string, object> existing = this.safeDict(client.subscriptions, getValue(subscriptionHashes, i), new Dictionary<string, object>() {});
