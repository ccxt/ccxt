...
public partial class bybit : ccxt.bybit
{
    ...
    public async override Task<Dictionary<string, Dictionary<string, List<ccxt.OHLCV>>>> WatchOHLCVForSymbols(object symbolsAndTimeframes, object since = null, object limit = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(symbolsAndTimeframes); postFixIncrement(ref i))
        {
            ...
            ((IList<object>)rawHashes).Add(add((("kline." + timeframeId) + "."), getValue(market, "id")));
            ((IList<object>)messageHashes).Add(add((add("ohlcv::", symbolString) + "::"), unfiedTimeframe));
        }
    ...
    public async override Task<object> unWatchOHLCVForSymbols(object symbolsAndTimeframes, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(symbolsAndTimeframes); postFixIncrement(ref i))
        {
            ...
            string? timeframeId = this.safeString(this.timeframes, unfiedTimeframe, unfiedTimeframe);
            ((IList<object>)rawHashes).Add(add((("kline." + timeframeId) + "."), getValue(market, "id")));
            ((IList<object>)subMessageHashes).Add(add((add("ohlcv::", symbolString) + "::"), unfiedTimeframe));
            ((IList<object>)messageHashes).Add(add((add("unsubscribe::ohlcv::", symbolString) + "::"), unfiedTimeframe));
        }
    ...
    public async override Task<ccxt.pro.IOrderBook> WatchOrderBookForSymbols(object symbols, Int64? limit = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            {
                throw new BadRequest ((string)((add((this.id + " watchOrderBookForSymbols(): for "), getValue(market, "type")) + " markets limit can be one of: ") + this.json(selectedLimits))) ;
            }
        }
        List<object> topics = new List<object>() {};
        List<object> messageHashes = new List<object>() {};
    ...
    public async override Task<object> unWatchOrderBookForSymbols(object symbols, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(symbols); postFixIncrement(ref i))
        {
            ...
            object topic = add((channel + "."), marketId);
    ...
    public virtual void handleOrderBook(WebSocketClient client, object message)
    {
        ...
        if (isEqual(limit, "1"))
        {
            object bidask = this.parseWsBidAsk(this.getOrderBook(this.orderbooks, symbol), market);
            ...
            (client as WebSocketClient).resolve(newBidsAsks, add("bidask:", symbol));
        }
    }
