...
public partial class deepcoin : ccxt.deepcoin
{
    ...
    public async virtual Task<object> unWatchPublic(object market, object messageHash, object topicID, object parameters = null, object subscription = null, object suffix = null)
    {
        ...
        {
            throw new BadRequest ((string)add((this.id + " no subscription for "), messageHash)) ;
        }
    ...
    public virtual object orderBookSuffix(object market, object methodName, object parameters = null)
    {
        ...
        if ((aggregation == null))
        {
            ...
            {
                throw new BadRequest ((string)(((add((this.id + " "), methodName) + "() requires a params[\"aggregation\"] price level for ") + symbol) + " because the market has no price precision")) ;
            }
