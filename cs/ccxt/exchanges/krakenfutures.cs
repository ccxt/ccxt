...
public partial class krakenfutures : Exchange
{
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(settlementCurrencies)); i++)
        {
    ...
    public override Dictionary<string, object> parseTrade(object trade, object market = null)
    {
        ...
        return this.safeTrade(new Dictionary<string, object>() {
            ...
            { "price", price },
            { "amount", ((bool) ((linear == true))) ? amount : null },
            { "cost", cost },
            { "fee", fee },
        });
    }
    ...
    public override Dictionary<string, object> parseOrder(object order, object market = null)
    {
        ...
        {
            string? whichPrice = ((bool) ((average != null))) ? average : price;
            if ((whichPrice != null))
            {
                if (isEqual(getValue(market, "linear"), true))
                {
    ...
    public override object parseMarketLeverageTiers(object info, object market = null)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(marginLevels)); i++)
        {
