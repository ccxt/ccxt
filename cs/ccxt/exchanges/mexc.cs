...
public partial class mexc : Exchange
{
    ...
    public async override Task<ccxt.Status> FetchStatus(object parameters = null)
    {
        ...
        if (isEqual(marketType, "spot"))
        {
            ...
            status = ((bool) (length > 0)) ? this.json(response) : "ok";
        } else if (isEqual(marketType, "swap"))
        {
            ...
            status = ((bool) success) ? "ok" : this.json(response);
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        Dictionary<string, object> market = this.market(symbol);
        int maxLimit = ((bool) ((((market.ContainsKey("spot") ? market["spot"] : null) as bool?) == true))) ? 500 : 2000; // docs say 1000 for spot, but in practice it's 500
    ...
    public async virtual Task<ccxt.Order> CreateSwapOrder(object market, object type, object side, object amount, object price = null, object marginMode = null, object parameters = null)
    {
        ...
        if ((hedged == true))
        {
            if ((reduceOnly == true))
            {
                ...
                sideInteger = ((bool) (isEqual(side, "buy"))) ? 4 : 2; // close short, close long
            } else
            {
                sideInteger = ((bool) (isEqual(side, "buy"))) ? 1 : 3;
            }
        ...
        } else
        {
            if ((reduceOnly == true))
            {
                sideInteger = ((bool) (isEqual(side, "buy"))) ? 2 : 4;
    ...
    public async override Task<ccxt.DepositAddress> FetchDepositAddress(string code, object parameters = null)
    {
        ...
        if ((network != null))
        {
            ...
            result = ((bool) ((netCode == null))) ? null : this.safeDict(addressStructures, netCode);
        } else
        {
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        string type = ((bool) ((id == null))) ? "deposit" : "withdrawal";
    ...
    public override Dictionary<string, object> parsePosition(object position, object market = null)
    {
        ...
        string side = ((bool) ((rawSide == "1"))) ? "long" : "short";
        string? openType = this.safeString(position, "margin_mode");
        string marginType = ((bool) ((openType == "1"))) ? "isolated" : "cross";
    ...
    public override object parseTransfer(object transfer, object currency = null)
    {
        ...
        string? datetime = ((bool) (!isEqual(timestamp, null))) ? this.iso8601(timestamp) : null;
        ...
        {
            accountFrom = ((bool) ((direction == "IN"))) ? "MAIN" : "CONTRACT";
            accountTo = ((bool) ((direction == "IN"))) ? "CONTRACT" : "MAIN";
        } else
        {
    ...
    public override object parseLeverage(object leverage, object market = null)
    {
        ...
        for (int i = 0; i < getArrayLength(leverage); i++)
        {
            ...
            marginMode = ((bool) ((openType == 1))) ? "isolated" : "cross";
        }
        return new Dictionary<string, object>() {
            { "info", leverage },
    ...
    public async override Task<Dictionary<string, object>> SetMarginMode(string marginMode, string symbol = null, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "leverage", leverage },
            { "openType", ((bool) ((marginModeLower == "isolated"))) ? 1 : 2 },
        };
        if ((symbol != null))
        {
            ((IDictionary<string,object>)request)["symbol"] = (market.ContainsKey("id") ? market["id"] : null);
        ...
        if ((direction != null))
        {
            ((IDictionary<string,object>)request)["positionType"] = ((bool) ((direction == "short"))) ? 2 : 1;
        }
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if ((section == "spot") || (section == "broker"))
        {
            if ((section == "broker"))
            {
                url = add(add(getValue(getValue((((IDictionary<string, object>)this.urls).ContainsKey("api") ? ((IDictionary<string, object>)this.urls)["api"] : null), section), ((string)access)), "/"), path);
            } else
            {
                url = add(add(add(add(getValue(getValue((((IDictionary<string, object>)this.urls).ContainsKey("api") ? ((IDictionary<string, object>)this.urls)["api"] : null), section), ((string)access)), "/api/"), this.version), "/"), path);
            }
        ...
        {
            url = add(add(getValue(getValue((((IDictionary<string, object>)this.urls).ContainsKey("api") ? ((IDictionary<string, object>)this.urls)["api"] : null), section), ((string)access)), "/"), this.implodeParams(path, parameters));
