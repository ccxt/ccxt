...
public partial class dydx : Exchange
{
    ...
    {
        var encodedTxsignDocVariable = this.encodeV4TxForSigning(message, memo, chainId, account, authenticators, fee);
        ...
        return this.encodeV4TxRaw(signDoc, add(getValue(signature, "r"), getValue(signature, "s")));
    }
    ...
    {
        object txBytes = this.encodeV4TxForSimulation(message, memo, getValue(account, "sequence"), getValue(account, "pub_key"));
        object request = new Dictionary<string, object>() {
            { "txBytes", txBytes },
        };
