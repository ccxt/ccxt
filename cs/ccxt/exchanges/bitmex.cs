...
public partial class bitmex : Exchange
{
            ...
            { "api", new Dictionary<string, object>() {
                { "public", new Dictionary<string, object>() {
                    { "get", new Dictionary<string, object>() {
                        ...
                        { "announcement/urgent", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "chat", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "chat/channels", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "chat/connected", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "chat/pinned", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "instrument/active", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "instrument/activeAndIndices", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "instrument/activeIntervals", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "instrument/compositeIndex", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "instrument/indices", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "instrument/usdVolume", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "insurance", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "leaderboard", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "liquidation", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "orderBook/L2", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "porl/nonce", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "quote", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "quote/bucketed", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "schema", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "schema/websocketHelp", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "stats/history", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "stats/historyUSD", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "trade", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "trade/bucketed", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                ...
                { "private", new Dictionary<string, object>() {
                    { "get", new Dictionary<string, object>() {
                        ...
                        { "execution/tradeHistory", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "globalNotification", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "porl/snapshots", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "user/affiliateStatus", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/checkReferralCode", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/commission", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/csa", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "user/getWalletTransferAccounts", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "user/quoteValueRatio", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/staking", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/staking/instruments", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "user/wallet", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/walletHistory", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/walletSummary", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "userAffiliates", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                    ...
                    { "post", new Dictionary<string, object>() {
                        ...
                        { "guild/archive", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "guild/join", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "guild/kick", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "guild/leave", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "order/cancelAllAfter", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "position/leverage", new Dictionary<string, object>() {
                            { "cost", 1 },
                        } },
                        { "position/riskLimit", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "user/cancelWithdrawal", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/communicationToken", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/confirmEmail", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        ...
                        { "user/requestWithdrawal", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/unstakingRequests", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
                        { "user/updateSubaccount", new Dictionary<string, object>() {
                            { "cost", 5 },
                        } },
    ...
    public async override Task<IDictionary<string, object>> fetchCurrencies(object parameters = null)
    {
        ...
        List<object> response = await this.publicGetWalletAssets(parameters);
        //
        //    {
        //        "XBt": {
        //            "asset": "XBT",
    ...
    public override Dictionary<string, object> parseCurrency(object currency)
    {
        ...
        List<object> chains = this.safeList(currency, "networks", new List<object>() {});
        ...
        for (int j = 0; j < chains.Count; postFixIncrement(ref j))
        {
            ...
            bool active = (((isDepositEnabled == true)) && ((isWithdrawEnabled == true)));
        ...
        bool isCrypto = (this.safeString(currency, "currencyType") == "Crypto");
    ...
    public override string? amountToPrecision(object symbol, object amount)
    {
        ...
        if ((isEqual((market.ContainsKey("spot") ? market["spot"] : null), true)) && (!isEqual(oldPrecision, true)))
        {
    ...
    {
        parameters ??= new Dictionary<string, object>();
        List<object> response = await this.publicGetInstrumentActive(parameters);
        //
        //  [
        //    {
        //        "symbol": "LTCUSDT",
    ...
    public override Dictionary<string, object> parseMarket(object market)
    {
        ...
        bool? linear = ((bool) contract) ? ((!isEqual(isInverse, true)) && (!isEqual(isQuanto, true))) : null;
        string? status = this.safeString(market, "state");
        bool active = (status == "Open"); // Open, Settled, Unlisted
        Int64? expiry = null;
        ...
        bool positionIsQuote = ((position == quote));
        ...
        if ((symbol == null))
        {
            throw new ArgumentsRequired ((string)(this.id + " parseMarket() requires a symbol")) ;
        }
        return this.safeMarketStructure(new Dictionary<string, object>() {
            ...
            { "limits", new Dictionary<string, object>() {
                { "leverage", new Dictionary<string, object>() {
                    { "min", ((bool) contract) ? this.parseNumber("1") : null },
                    { "max", ((bool) contract) ? maxLeverage : null },
                } },
                { "amount", new Dictionary<string, object>() {
                    { "min", null },
                    { "max", ((bool) positionIsQuote) ? null : maxOrderQty },
                } },
                ...
                { "cost", new Dictionary<string, object>() {
                    { "min", null },
                    { "max", ((bool) positionIsQuote) ? maxOrderQty : null },
                } },
            } },
            { "created", null },
            { "info", market },
    ...
    public override object parseBalance(object response)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            ((IDictionary<string,object>)account)["free"] = this.convertToRealAmount(((string)code), free);
            ((IDictionary<string,object>)account)["total"] = this.convertToRealAmount(((string)code), total);
            if ((code != null))
            {
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        Dictionary<string, object> response = await this.privateGetUserMargin(this.extend(request, parameters));
        //
        //     [
        //         {
        //             "account":1455728,
    ...
    public async override Task<ccxt.OrderBook> FetchOrderBook(string symbol, Int64? limit = null, object parameters = null)
    {
        ...
        List<object> response = await this.publicGetOrderBookL2(this.extend(request, parameters));
        Dictionary<string, object> result = new Dictionary<string, object>() {
            { "symbol", symbol },
    ...
    public async override Task<ccxt.Order> FetchOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        object response = ccxt.BaseExchange.FromOrderList(await this.FetchOrders(((string)symbol),ccxt.BaseExchange.ToInt64Arg(null),ccxt.BaseExchange.ToInt64Arg(null), this.deepExtend(filter, parameters)));
    ...
    public async override Task<List<ccxt.Order>> FetchOpenOrders(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        return await this.FetchOrders(((string)symbol),ccxt.BaseExchange.ToInt64Arg(since),ccxt.BaseExchange.ToInt64Arg(limit), this.deepExtend(request, parameters));
    }
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        Int64? transactTime = this.parse8601(this.safeString(transaction, "transactTime"));
        Int64? timestamp = this.parse8601(this.safeString(transaction, "timestamp"));
    ...
    public async override Task<ccxt.Tickers> FetchTickers(object symbols = null, object parameters = null)
    {
        ...
        List<object> response = await this.publicGetInstrumentActiveAndIndices(parameters);
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (isTrue(paginate))
        {
            return ccxt.BaseExchange.ToOHLCVList(await this.fetchPaginatedCallDeterministic("fetchOHLCV", symbol, since, limit,((string)timeframeVar), parameters));
        }
        // send JSON key/value pairs, such as {"key": "value"}
        // filter by individual fields and do advanced queries on timestamps
        // let filter: Dict = { 'key': 'value' };
        // send a bare series (e.g. XBU) to nearest expiring contract in that series
        // you can also send a timeframeVar, e.g. XBU:monthly
        ...
        IList<object> useOpenTimestampparametersVariable = (IList<object>)this.handleOptionAndParams(parameters, "fetchOHLCV", "useOpenTimestamp", true);
        ...
        List<object> response = await this.publicGetTradeBucketed(this.extend(request, parameters));
        //
        //     [
        ...
        //     ]
        //
        IList<object> result = this.parseOHLCVs(this.toArray(response), market,((string)timeframeVar), since, limit);
        if (isTrue(useOpenTimestamp))
        {
    ...
    public override Dictionary<string, object> parseOrder(object order, object market = null)
    {
        ...
        Int64? timestamp = this.parse8601(this.safeString(order, "timestamp"));
    ...
    public async override Task<List<ccxt.Trade>> FetchTrades(string symbol, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        List<object> response = await this.publicGetTrade(this.extend(request, parameters));
        //
        //     [
        //         {
        //             "timestamp": "2018-08-28T00:00:02.735Z",
    ...
    public async override Task<ccxt.Order> CreateOrder(string symbol, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        if ((reduceOnly != null))
        {
            if ((!isEqual((market.ContainsKey("swap") ? market["swap"] : null), true)) && (!isEqual((market.ContainsKey("future") ? market["future"] : null), true)))
            {
                throw new InvalidOrder ((string)(add((this.id + " createOrder() does not support reduceOnly for "), (market.ContainsKey("type") ? market["type"] : null)) + " orders, reduceOnly orders are supported for swap and future markets only")) ;
            }
        }
        ...
        if (isTriggerOrder || isTrailingAmountOrder)
        {
            ...
            } else
            {
                ...
                {
                    throw new ArgumentsRequired ((string)(((this.id + " createOrder() requires a triggerPrice parameter for the ") + orderType) + " order type")) ;
                }
    ...
    public async override Task<ccxt.Order> EditOrder(string id, string symbol, string type, string side, double? amount = null, double? price = null, object parameters = null)
    {
        ...
        Dictionary<string, object> response = await this.privatePutOrder(this.extend(request, parameters));
    ...
    public async override Task<Dictionary<string, object>> CancelAllOrdersAfter(object timeout, object parameters = null)
    {
        ...
        Dictionary<string, object> response = await this.privatePostOrderCancelAllAfter(this.extend(request, parameters));
        //
        //     {
    ...
    public async override Task<List<ccxt.Position>> FetchPositions(object symbols = null, object parameters = null)
    {
        ...
        List<object> response = await this.privateGetPosition(parameters);
        //
        //     [
        //         {
        //             "account": 0,
    ...
    public override Dictionary<string, object> parsePosition(object position, object market = null)
    {
        ...
        {
            if (isEqual(getValue(homeNotional, 0), "-"))
            {
                side = "short";
            } else
            {
    ...
    public async override Task<ccxt.FundingRates> FetchFundingRates(object symbols = null, object parameters = null)
    {
        ...
        return ccxt.BaseExchange.ToFundingRates(this.filterByArray(result, "symbol", symbols));
    }
    ...
    public async override Task<List<ccxt.FundingRateHistory>> FetchFundingRateHistory(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        } else if (!isEqual(symbolVar, null))
        {
        ...
        List<object> response = await this.publicGetFunding(this.extend(request, parameters));
        //
        //    [
        //        {
    ...
    public async override Task<Dictionary<string, object>> SetLeverage(object leverage, string symbol = null, object parameters = null)
    {
        ...
        {
            throw new BadRequest ((string)(this.id + " leverage should be between 0.01 and 100")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
        ...
        Dictionary<string, object> market = this.market(symbol);
        if (!isEqual((market.ContainsKey("type") ? market["type"] : null), "swap") && !isEqual((market.ContainsKey("type") ? market["type"] : null), "future"))
        {
        ...
        return ccxt.BaseExchange.ToDict(await this.privatePostPositionLeverage(this.extend(request, parameters)));
    }
    ...
    public async override Task<Dictionary<string, object>> SetMarginMode(string marginMode, string symbol = null, object parameters = null)
    {
        ...
        return ccxt.BaseExchange.ToDict(await this.privatePostPositionIsolate(this.extend(request, parameters)));
    }
    ...
    public async override Task<ccxt.DepositAddress> FetchDepositAddress(string code, object parameters = null)
    {
        ...
        //
        return ccxt.BaseExchange.ToDepositAddress(new Dictionary<string, object>() {             { "info", response },             { "currency", code },             { "network", networkCode },             { "address", ((string)((string)response).Replace((string)"\"", (string)"")).Replace((string)"\"", (string)"") },             { "tag", null },         });
    }
    ...
    public override object parseDepositWithdrawFee(object fee, object currency = null)
    {
        ...
        int networksLength = networks.Count;
        Dictionary<string, object> result = new Dictionary<string, object>() {
            { "info", fee },
            { "withdraw", new Dictionary<string, object>() {
                { "fee", null },
    ...
    public async override Task<ccxt.DepositWithdrawFees> FetchDepositWithdrawFees(object codes = null, object parameters = null)
    {
        ...
        List<object> assets = await this.publicGetWalletAssets(parameters);
        //
        //    [
        //        {
        //            "asset": "XBT",
        ...
        //    ]
        //
        return ccxt.BaseExchange.ToDepositWithdrawFees(this.parseDepositWithdrawFees(assets, codes, "asset"));
    }
    ...
    public async override Task<List<ccxt.Liquidation>> FetchLiquidations(string symbol, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (isTrue(paginate))
        {
            return ccxt.BaseExchange.ToLiquidationList(await this.fetchPaginatedCallDynamic("fetchLiquidations", symbol, since, limit, parameters));
        }
        Dictionary<string, object> market = this.market(symbol);
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "symbol", (market.ContainsKey("id") ? market["id"] : null) },
        ...
        List<object> response = await this.publicGetLiquidation(this.extend(request, parameters));
        //
        //     [
        //         {
        //             "orderID": "string",
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchSettlementHistory(object symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        List<object> response = await this.publicGetSettlement(this.extend(request, parameters));
        //
        //    [
        //        {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        } else
        {
            ...
            if ((format != null))
            {
                query = query + ("?" + this.urlencode(new Dictionary<string, object>() {
    { "_format", format },
}));
        ...
        if (isEqual(api, "private") || (isEqual(api, "public") && isTrue(isAuthenticated)))
        {
            ...
            Int64? apiExpires = this.safeInteger(this.options, "api-expires"); // backwards compatibility
            ...
            {
                throw new ExchangeError ((string)(this.id + " sign() missing expires")) ;
            }
            string stringExpires = ((object)expires).ToString();
