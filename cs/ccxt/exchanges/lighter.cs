...
public partial class lighter : Exchange
{
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(markets); postFixIncrement(ref i))
        {
            ...
            string quoteId = "USDC";
            string? settleId = ((bool) (isEqual(type, "swap"))) ? "USDC" : null;
            ...
            ((IList<object>)result).Add(new Dictionary<string, object>() {
                ...
                { "linear", ((bool) (isEqual(type, "swap"))) ? true : null },
                { "inverse", ((bool) (isEqual(type, "swap"))) ? false : null },
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        {
            url = add(add(add((this.implodeHostname(getValue(getValue(this.urls, "api"), api)) + "/api/"), this.version), "/"), path);
        }
