...
public partial class mudrex : Exchange
{
    ...
    public async override Task<ccxt.Order> CreateOrder(string symbol, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            ...
            { "order_type", (isEqual(side, "buy")) ? "LONG" : "SHORT" },
            { "trigger_type", (isEqual(type, "market")) ? "MARKET" : "LIMIT" },
    ...
    public async override Task<List<ccxt.Trade>> FetchMyTrades(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        for (int i = 0; isLessThan(i, allRows.Count); postFixIncrement(ref i))
        {
        ...
        for (int i = 0; isLessThan(i, transactions.Count); postFixIncrement(ref i))
        {
            object rebate = null;
            for (int j = 0; isLessThan(j, rebateKeys.Count); postFixIncrement(ref j))
            {
