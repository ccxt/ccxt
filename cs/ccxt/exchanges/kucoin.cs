...
public partial class kucoin : Exchange
{
    ...
    public async override Task<ccxt.Status> FetchStatus(object parameters = null)
    {
        ...
        if (isTrue(uta))
        {
            ...
            string defaultTradeType = ((bool) ((defaultType == "spot"))) ? "SPOT" : "FUTURES";
        ...
        return ccxt.BaseExchange.ToStatus(new Dictionary<string, object>() {             { "status", ((bool) ((status == "open"))) ? "ok" : "maintenance" },             { "updated", null },             { "eta", null },             { "url", null },             { "info", response },         });
    }
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        List<object> symbolsData = ((bool) fetchSpotMarkets) ? this.safeList(getValue(responses, 0), "data", new List<object>() {}) : new List<object>() {};
        object crossIndex = 0;
        ...
        IDictionary<string, object> crossData = ((bool) ((requestMarginables == true))) ? this.safeDict(getValue(responses, crossIndex), "data", new Dictionary<string, object>() {}) : new Dictionary<string, object>() {};
    ...
    public async virtual Task<List<ccxt.MarketInterface>> FetchUTAMarkets(object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(symbolsData); postFixIncrement(ref i))
        {
            ...
            bool isMarginable = ((bool) ((hasMargin == "1"))) ? true : false;
    ...
    public override object parseDepositWithdrawFee(object fee, object currency = null)
    {
        ...
        if (inOp(fee, "chains"))
        {
            ...
            for (int i = 0; i < chains.Count; postFixIncrement(ref i))
            {
    ...
    public override object parseOHLCV(object ohlcv, object market = null)
    {
        ...
        if ((timestampString != null) && ((string)timestampString).Length <= 10)
        {
    ...
    public async override Task<ccxt.Order> CreateOrder(string symbol, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)add((this.id + " createOrder() does not support market "), (market.ContainsKey("type") ? market["type"] : null))) ;
        }
    }
    ...
    public virtual Dictionary<string, object> createSpotOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        if (isTriggerOrder)
        {
            ...
            } else if (((stopLossPrice != null)) || ((takeProfitPrice != null)))
            {
                ...
                {
                    ((IDictionary<string,object>)request)["stop"] = ((bool) (isEqual(side, "buy"))) ? "loss" : "entry";
    ...
    public virtual Dictionary<string, object> createContractOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        } else if (((stopLossPrice != null)) || ((takeProfitPrice != null)))
        {
            ...
            {
                ((IDictionary<string,object>)request)["stop"] = ((bool) (isEqual(side, "buy"))) ? "down" : "up";
                ((IDictionary<string,object>)request)["stopPrice"] = this.priceToPrecision(symbol, takeProfitPrice);
            }
    ...
    public virtual Dictionary<string, object> createUtaOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        if (isEqual(isContract, true))
        {
            if (!isUnified)
            {
                ...
                if (isEqual(hedged, true))
                {
                    string positionSide = ((bool) (isEqual(side, "buy"))) ? "LONG" : "SHORT";
                    if ((reduceOnly == true))
                    {
                        positionSide = ((bool) (isEqual(positionSide, "LONG"))) ? "SHORT" : "LONG";
                    }
        ...
        if ((triggerPrice != null))
        {
            ...
            ((IDictionary<string,object>)request)["triggerDirection"] = ((bool) ((triggerDirection == "ascending"))) ? "UP" : "DOWN";
        ...
        } else if (((stopLossPrice != null)) || ((takeProfitPrice != null)))
        {
            ...
            {
                ((IDictionary<string,object>)request)["triggerDirection"] = ((bool) (isEqual(side, "buy"))) ? "DOWN" : "UP";
    ...
    public async virtual Task<List<ccxt.Order>> CancelAllUtaOrders(object symbol = null, object parameters = null)
    {
        ...
        Dictionary<string, object> market = this.market(symbol);
        object isContract = (market.ContainsKey("contract") ? market["contract"] : null);
        string tradeType = ((bool) (isEqual(isContract, true))) ? "FUTURES" : "SPOT";
        ...
        string orderFilter = ((bool) (isEqual(trigger, true))) ? "ADVANCED" : "NORMAL";
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "accountMode", "unified" },
            { "symbol", (market.ContainsKey("id") ? market["id"] : null) },
            { "tradeType", tradeType },
    ...
    public async virtual Task<ccxt.Order> FetchContractOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        //     }
        //
        Dictionary<string, object> market = ((bool) (!isEqual(symbol, null))) ? this.market(symbol) : null;
        IDictionary<string, object> responseData = this.safeDict(response, "data", new Dictionary<string, object>() {});
        return ccxt.BaseExchange.ToOrder(this.parseOrder(responseData, market));
    }
    ...
    public virtual string? handleTradeType(object isContractMarket = null, object marginMode = null, object isUnified = null, object parameters = null)
    {
        ...
        if ((tradeType == null))
        {
            ...
            {
                tradeType = "FUTURES";
            } else if (!isEqual(marginMode, null))
            {
    ...
    public async virtual Task<List<ccxt.Trade>> FetchMySpotTrades(object symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        {
            hf = true;
            ((IDictionary<string,object>)request)["tradeType"] = ((bool) ((marginMode == null))) ? null : this.safeString(getValue(this.options, "marginModes"), marginMode, marginMode);
        }
        if ((isEqual(hf, true)) && isEqual(symbol, null))
        {
    ...
    public virtual object parseSpotOrUtaTrade(object trade, object market = null)
    {
        ...
        if ((feeCostString != null))
        {
            ...
            if ((feeCurrency == null))
            {
                feeCurrency = ((bool) ((side == "sell"))) ? getValue(market, "quote") : getValue(market, "base");
            }
            fee = new Dictionary<string, object>() {
                { "cost", feeCostString },
                { "currency", feeCurrency },
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        hf = (bool?)((IList<object>)hfparametersVariable)[0];
        parameters = ((IList<object>)hfparametersVariable)[1];
        if ((isEqual(hf, true)) && (!isEqual(type, "main")))
        {
            type = "trade_hf";
        }
        object marginMode = null;
        ...
        marginMode = ((IList<object>)marginModeparametersVariable)[0];
        parameters = ((IList<object>)marginModeparametersVariable)[1];
        bool isolated = (isEqual(marginMode, "isolated")) || (isEqual(type, "isolated"));
        bool cross = (isEqual(marginMode, "cross")) || (isEqual(type, "margin"));
        if (isolated)
        {
            if ((currency != null))
            {
    ...
    public async virtual Task<ccxt.Balances> FetchUtaBalance(object parameters = null)
    {
        ...
        if (isIsolated)
        {
            for (int i = 0; i < accounts.Count; postFixIncrement(ref i))
            {
                ...
                for (int j = 0; j < currencies.Count; postFixIncrement(ref j))
                {
    ...
    public async virtual Task<ccxt.TransferEntry> TransferUta(string code, object amount, string fromAccount, string toAccount, object parameters = null)
    {
        ...
        List<object> exchangeIds = ((bool) (isEqual(this.ids, null))) ? new List<object>() {} : this.ids;
    ...
    public override object parseTransfer(object transfer, object currency = null)
    {
        ...
        string? accountFrom = ((bool) ((accountFromRaw == null))) ? null : this.safeString(accountsByType, accountFromRaw, accountFromRaw);
        string? accountTo = ((bool) ((accountToRaw == null))) ? null : this.safeString(accountsByType, accountToRaw, accountToRaw);
        return new Dictionary<string, object>() {
    ...
    public override object parseLedgerEntry(object item, object currency = null)
    {
        ...
        object feeCost = ((bool) ((feeCostString == null))) ? null : this.omitZero(feeCostString);
    ...
    public async override Task<List<ccxt.LedgerEntry>> FetchLedger(string code = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        {
            marginMode = ((bool) ((marginMode == null))) ? "cross" : marginMode; // default to cross margin for UTA if margin is requested but marginMode is not specified
            requestedType = marginMode;
        }
        IDictionary<string, object> accountsByType = this.safeDict(this.options, "accountsByType");
        if (isTrue(uta))
        ...
        {
            maxLimit = 200;
        } else if (isEqual(type, "contract"))
        {
            maxLimit = 50;
        } else if (isTrue(uta))
        {
            if ((isEqual(type, "UNIFIED")) || (isEqual(type, "SPOT")))
            {
                maxLimit = 200;
            } else if (isEqual(type, "FUTURES"))
            {
                maxLimit = 100;
            }
        }
    ...
    public async override Task<List<ccxt.BorrowInterest>> FetchBorrowInterest(string code = null, object symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        //
        IDictionary<string, object> data = this.safeDict(response, "data", new Dictionary<string, object>() {});
        List<object> assets = ((bool) (isEqual(marginMode, "isolated"))) ? this.safeList(data, "assets", new List<object>() {}) : this.safeList(data, "accounts", new List<object>() {});
    ...
    public async override Task<Dictionary<string, object>> SetLeverage(object leverage, string symbol = null, object parameters = null)
    {
        ...
        marketType = (string)((IList<object>)marketTypeparametersVariable)[0];
        parameters = ((IList<object>)marketTypeparametersVariable)[1];
        if ((!isEqual(symbol, null)) || ((!isEqual(marketType, "spot")) && (!isEqual(marketType, "margin"))))
        {
            if (isEqual(symbol, null))
            {
    ...
    public async override Task<List<ccxt.Order>> CancelOrders(object ids, string symbol = null, object parameters = null)
    {
        ...
        {
            string requestKey = ((bool) useClientorderId) ? "clientOidsList" : "orderIdsList";
    ...
    public async override Task<object> reduceMargin(string symbol, object amount, object parameters = null)
    {
        ...
        return new Dictionary<string, object>() {
            ...
            { "status", ((bool) ((responseCode == "200000"))) ? "ok" : null },
            { "timestamp", null },
            { "datetime", null },
        };
    }
    ...
    public override object parseMarginMode(object marginMode, object market = null)
    {
        ...
        marginType = ((bool) (isEqual(marginType, "ISOLATED"))) ? "isolated" : "cross";
        return new Dictionary<string, object>() {
            { "info", marginMode },
            { "symbol", this.safeString(market, "symbol") },
    ...
    public async override Task<ccxt.LeverageTiers> FetchLeverageTiers(object symbols = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(tiers); postFixIncrement(ref i))
        {
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        if (isPrivate || isFuturePrivate || isBroker || isEarn || isUtaPrivate)
        {
            ...
            partner = ((bool) isFuturePartner) ? this.safeValue(partner, "future", partner) : this.safeValue(partner, "spot", partner);
