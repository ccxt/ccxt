...
public partial class kucoin : Exchange
{
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        object crossData = ((bool) ((requestMarginables == true))) ? this.safeDict(getValue(responses, crossIndex), "data", new Dictionary<string, object>() {}) : new Dictionary<string, object>() {};
    ...
    public async virtual Task<ccxt.TransferEntry> TransferUta(string code, object amount, string fromAccount, string toAccount, object parameters = null)
    {
        ...
        object exchangeIds = ((bool) (isEqual(this.ids, null))) ? new List<object>() {} : this.ids;
