...
public partial class xt : Exchange
{
    ...
    public async override Task<ccxt.Order> CancelOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        object order = ((bool) isContractResponse) ? response : this.safeDict(response, "result", new Dictionary<string, object>() {});
        return ccxt.BaseExchange.ToOrder(this.parseOrder(order, market));
    }
    ...
    public async override Task<ccxt.Order> EditOrder(string id, string symbol, string type, string side, double? amount = null, double? price = null, object parameters = null)
    {
        ...
        object result = ((bool) (isEqual(getValue(market, "swap"), true))) ? response : this.safeDict(response, "result", new Dictionary<string, object>() {});
