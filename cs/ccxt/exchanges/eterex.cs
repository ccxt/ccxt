...
public partial class eterex : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "urls", new Dictionary<string, object>() {
                ...
                { "doc", new List<object>() {"https://eterex.com"} },
            } },
            { "api", new Dictionary<string, object>() {
    ...
    public async override Task<object> fetchMarkets(object parameters = null)
    {
        ...
        */
        ...
        object response = await this.publicGetAdRates(parameters);
    ...
    public override object parseTicker(object ticker, object market = null)
    {
        ...
        object high = this.safeFloat(ticker, "sell_price", 0);
        object low = this.safeFloat(ticker, "buy_price", 0);
        object bid = this.safeFloat(ticker, "sell_price", 0);
        object ask = this.safeFloat(ticker, "buy_price", 0);
        object last = this.safeFloat(ticker, "buy_price", 0);
        object quoteVolume = this.safeFloat(ticker, "24h_volume", 0);
