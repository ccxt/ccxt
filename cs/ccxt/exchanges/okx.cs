...
public partial class okx : Exchange
{
    ...
    public override Dictionary<string, object> createExpiredOptionMarket(object symbol)
    {
        ...
        object datetime = ((bool) ((expiry == null))) ? null : this.convertExpireDate(expiry);
    ...
    public async override Task<ccxt.Transaction> Withdraw(string code, double amount, string address, string tag = null, object parameters = null)
    {
        ...
        if ((fee == null))
        {
            ...
            object targetNetwork = ((bool) ((networkCodeResolved == null))) ? new Dictionary<string, object>() {} : this.safeDict(getValue(currency, "networks"), networkCodeResolved, new Dictionary<string, object>() {});
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        object url = (this.implodeHostname(getValue(getValue(this.urls, "api"), "rest")) + request);
