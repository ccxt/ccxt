...
public partial class rubin : Exchange
{
    public override object describe()
    {
        return this.deepExtend(base.describe(), new Dictionary<string, object>() {
            ...
            { "urls", new Dictionary<string, object>() {
                ...
                { "doc", new List<object>() {"https://docs.rubin.trade"} },
                { "fees", new List<object>() {"https://docs.rubin.trade"} },
    ...
    public virtual object signOnboardingAction()
    {
        ...
        object messageTypes = new Dictionary<string, object>() {
            { "Rubin", new List<object>() {new Dictionary<string, object>() {
    { "name", "action" },
    { "type", "string" },
}} },
        };
    ...
    public virtual object signRubinTx(object privateKey, object message, object memo, object chainId, object account, object authenticators, object fee = null)
    {
    ...
    public virtual object retrieveCredentials()
    {
        ...
        ((IDictionary<string,object>)this.options)["rubinCredentials"] = credentials;
        return credentials;
    }

    public async virtual Task<object> fetchRubinAccount()
    {
        // required in js
        await this.loadV4Protos();
        object rubinAccount = this.safeDict(this.options, "rubinAccount");
        if (isTrue(!isEqual(rubinAccount, null)))
        {
            return rubinAccount;
        }
        if (isTrue(isEqual(this.walletAddress, null)))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchRubinAccount() requires the walletAddress to be set using the rit chain address eg: rit1exampleaddressxxxxxxxxxxxxxxxxxxxxxxx")) ;
        }
        if (!isTrue(((string)this.walletAddress).StartsWith(((string)"rit"))))
        {
            throw new ArgumentsRequired ((string)add(this.id, " fetchRubinAccount() requires a valid rit chain address, starting with rit, not the l1 address.")) ;
        }
        object request = new Dictionary<string, object>() {
        ...
        // }
        //
        object response = await this.nodeRestGetCosmosAuthV1beta1AccountInfoRubinAddress(request);
        ...
        ((IDictionary<string,object>)this.options)["rubinAccount"] = account;
        return account;
    }
    ...
    public async override Task<object> createOrder(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        object account = await this.fetchRubinAccount();
        ...
        object signedTx = this.signRubinTx(getValue(credentials, "privateKey"), orderRequest, "", chainName, account, null);
        object request = new Dictionary<string, object>() {
            { "tx", signedTx },
        };
    ...
    public async override Task<object> cancelOrder(object id, object symbol = null, object parameters = null)
    {
        ...
        object chainName = getValue(this.options, "chainName");
        object signedTx = this.signRubinTx(getValue(credentials, "privateKey"), signingPayload, "", chainName, account, null);
        object request = new Dictionary<string, object>() {
            { "tx", signedTx },
        };
        // nodeRpcGetBroadcastTxAsync
    ...
    public async override Task<object> transfer(object code, object amount, object fromAccount, object toAccount, object parameters = null)
    {
        ...
        object chainName = getValue(this.options, "chainName");
        object signedTx = this.signRubinTx(getValue(credentials, "privateKey"), signingPayload, "", chainName, account, null, txFee);
        object request = new Dictionary<string, object>() {
            { "tx", signedTx },
        };
        // nodeRpcGetBroadcastTxAsync
    ...
    public async override Task<object> withdraw(object code, object amount, object address, object tag = null, object parameters = null)
    {
        ...
        object chainName = getValue(this.options, "chainName");
        object signedTx = this.signRubinTx(getValue(credentials, "privateKey"), signingPayload, tag, chainName, account, null, txFee);
        object request = new Dictionary<string, object>() {
            { "tx", signedTx },
        };
        // nodeRpcGetBroadcastTxAsync
    ...
    public virtual object getWalletAddress()
    {
        ...
        throw new ArgumentsRequired ((string)add(this.id, " getWalletAddress() requires a wallet address. Set `walletAddress` or `rubinAccount` in exchange options.")) ;
    }
    ...
    public override void setSandboxMode(object enable)
    {
        ...
        ((IDictionary<string,object>)this.options)["chainName"] = "ritbit-testnet";
