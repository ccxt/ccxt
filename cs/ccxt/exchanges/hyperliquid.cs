...
public partial class hyperliquid : Exchange
{
    ...
    public override Dictionary<string, object> market(object symbol)
    {
        ...
        if ((!isEqual(symbol, null)) && !(inOp(this.markets, symbol)))
        {
            ...
            if (spotCurrencyMapping.ContainsKey(((string)baseName)))
            {
                ...
                string newSymbol = add(add(this.safeCurrencyCode(unifiedBaseName), "/"), quote);
    ...
    public override Dictionary<string, object> parseCurrency(object rawCurrency)
    {
        ...
        {
            bool isWrapped = ((string)fullName).StartsWith("Unit ") && ((string)name).StartsWith("U");
            if (isWrapped)
            {
                List<object> parts = name.Split(new [] {"U"}, StringSplitOptions.None).ToList<object>();
                object nameWithoutU = "";
                for (int j = 0; isLessThan(j, parts.Count); postFixIncrement(ref j))
                {
    ...
    public async virtual Task<List<ccxt.MarketInterface>> FetchHip3Markets(object parameters = null)
    {
        ...
        for (object i = 1; isLessThan(i, getArrayLength(fetchDexes)); postFixIncrement(ref i))
        {
            ...
            perpDexesOffset[(string)getValue(dex, "name")] = offset;
        }
        ...
        if (isGreaterThan(userProvidedDexesLength, 0))
        {
            if (isGreaterThan(userProvidedDexesLength, 0))
            {
        ...
        List<object> rawPromises = new List<object>() {};
        for (int i = 0; isLessThan(i, fetchDexesList.Count); postFixIncrement(ref i))
        {
            Dictionary<string, object> request = new Dictionary<string, object>() {
        ...
        for (int i = 0; isLessThan(i, promises?.Count ?? 0); postFixIncrement(ref i))
        {
            ...
            for (int j = 0; isLessThan(j, universe.Count); postFixIncrement(ref j))
            {
                ...
                if (cachedCurrencies.ContainsKey(((string)collateralToken)))
                {
                    ...
                    string? hip3Code = ((safeCode == null)) ? name : safeCode.Replace((string)":", (string)"-");
    ...
    public virtual object calculatePricePrecision(object price, object amountPrecision, object maxDecimals)
    {
        ...
        } else
        {
            ...
            object significantDigits = mathMax(5, integerPart.Length);
    ...
    public async virtual Task<List<ccxt.MarketInterface>> FetchSpotMarkets(object parameters = null)
    {
        ...
        List<object> markets = new List<object>() {};
        for (int i = 0; isLessThan(i, meta.Count); postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        if ((balances != null))
        {
            ...
            for (int i = 0; isLessThan(i, balances.Count); postFixIncrement(ref i))
            {
                ...
                string? code = ((isSpot == true)) ? this.updateSpotCurrencyCode(((string)unifiedCode)) : unifiedCode;
    ...
    public async override Task<ccxt.OrderBook> FetchOrderBook(string symbol, Int64? limit = null, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "type", "l2Book" },
            { "coin", (isEqual(GetValue(market, "swap"), true)) ? this.safeString(market, "baseName") : GetValue(market, "id") },
        };
        object response = await this.publicPostInfo(this.extend(request, parameters));
        //
        //     {
    ...
    public async override Task<ccxt.Tickers> FetchTickers(IList<object> symbols = null, object parameters = null)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(response)); postFixIncrement(ref i))
        {
            ...
            result[(string)((string)symbol)] = ticker;
        }
    ...
    public async virtual Task<List<object>> isUnifiedEnabled(object method, object address = null, object shouldRefresh = null, object parameters = null)
    {
        ...
        enableUnifiedMargin = enableUnifiedMarginparametersVariable[0];
        parameters = enableUnifiedMarginparametersVariable[1];
    ...
    public async override Task<ccxt.Order> CreateTwapOrder(string symbol, string side, double amount, object duration, object parameters = null)
    {
        ...
        vaultAddress = vaultAddressparametersVariable[0];
        ...
        */
        ...
        if (hasClientOrderId)
        {
            for (int i = 0; isLessThan(i, getArrayLength(orders)); postFixIncrement(ref i))
            {
                ...
                if ((clientOrderId == null))
                {
                    throw new ArgumentsRequired (add(this.id, " createOrders() all orders must have clientOrderId if at least one has a clientOrderId")) ;
                }
            }
        }
    ...
    public async virtual Task<ccxt.Order> CancelTwapOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        if (isEqual(symbol, null))
        {
            throw new ArgumentsRequired (add(this.id, " cancelTwapOrder() requires a symbol argument")) ;
        }
        Dictionary<string, object> market = this.market(symbol);
        object vaultAddress = null;
    ...
    public async override Task<List<ccxt.Order>> CancelOrdersForSymbols(object orders, object parameters = null)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(orders)); postFixIncrement(ref i))
        {
            ...
            if ((symbol == null))
            {
                throw new ArgumentsRequired (add(this.id, " cancelOrdersForSymbols() requires a symbol argument in each order")) ;
            }
            if ((id != null) && cancelByCloid)
            {
                throw new BadRequest (add(this.id, " cancelOrdersForSymbols() all orders must have either id or clientOrderId")) ;
            }
    ...
    public virtual Dictionary<string, object> editOrdersRequest(object orders, object parameters = null)
    {
        ...
        if (hasClientOrderId)
        {
            for (int i = 0; isLessThan(i, getArrayLength(orders)); postFixIncrement(ref i))
            {
                ...
                if ((clientOrderId == null))
                {
                    throw new ArgumentsRequired (add(this.id, " editOrders() all orders must have clientOrderId if at least one has a clientOrderId")) ;
                }
            }
        }
        parameters = this.omit(parameters, new List<object>() {"slippage", "clientOrderId", "client_id", "slippage", "triggerPrice", "stopPrice", "stopLossPrice", "takeProfitPrice", "timeInForce"});
    ...
    public async override Task<List<ccxt.FundingRateHistory>> FetchFundingRateHistory(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        {
            object maxLimit = (isEqual(limit, null)) ? 500 : limit;
    ...
    public virtual string? getDexFromHip3Symbol(IDictionary<string, object> market)
    {
        ...
        if (isGreaterThan(partsLength, 1))
        {
    ...
    public virtual string? getDexFromSymbols(object methodName, object symbols = null)
    {
        ...
        for (int i = 0; isLessThan(i, symbolsLength); postFixIncrement(ref i))
        {
            ...
            } else
            {
                ...
                {
                    throw new NotSupported (add(add(add(this.id, " "), methodName), " only supports fetching positions for one DEX at a time for HIP3 markets")) ;
                }
            }
        }
        return dexName;
    ...
    public override Dictionary<string, object> parsePosition(object position, IDictionary<string, object> market = null)
    {
        ...
        if ((size != null))
        {
            side = isTrue(Precise.stringGt(rawSize, "0")) ? "long" : "short";
    ...
    public async override Task<Dictionary<string, object>> SetMarginMode(string marginMode, string symbol = null, object parameters = null)
    {
        ...
        if ((vaultAddress != null))
        {
            if (((string)vaultAddress).StartsWith("0x"))
            {
    ...
    public async override Task<ccxt.TransferEntry> Transfer(string code, double amount, string fromAccount, string toAccount, object parameters = null)
    {
        ...
        if (this.inArray(fromAccount, new List<object>() {"spot", "swap", "perp"}))
        {
            ...
            {
                throw new NotSupported (add(this.id, " transfer() only support spot <> swap transfer")) ;
            }
        ...
        {
            throw new NotSupported (add(this.id, " transfer() only support main <> subaccount transfer")) ;
        }
        ...
        parameters = this.omit(parameters, "type");
        bool isUsdc = (isEqual(code, null)) || ((code.ToUpper() == "USDC"));
        ...
        } else
        {
            ...
            if (isEqual(code, null))
            {
                throw new ArgumentsRequired (add(this.id, " transfer() requires a currency code for spot sub-account transfers")) ;
            }
    ...
    public async override Task<List<ccxt.Transaction>> FetchDeposits(string code = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (!isEqual(until, null))
        {
            if (isEqual(since, null))
            {
                throw new ArgumentsRequired (add(this.id, " fetchDeposits requires since while until is set")) ;
            }
            request["endTime"] = until;
            parameters = this.omit(parameters, new List<object>() {"until"});
        }
        ...
        if ((vaultAddress != null))
        {
            for (int i = 0; isLessThan(i, records?.Count ?? 0); postFixIncrement(ref i))
            {
    ...
    public virtual List<object> handlePublicAddress(object methodName, object parameters)
    {
        ...
        throw new ArgumentsRequired (add(add(add(this.id, " "), methodName), "() requires a user parameter inside 'params' or the wallet address set")) ;
    }
    ...
    public override object handleErrors(object code, string reason, string url, string method, object headers, object body, object response, Dictionary<string, object> requestHeaders, object requestBody)
    {
        ...
        {
            throw new OrderNotFound (add(add(this.id, " "), body)) ;
        } else if ((error != null))
        {
            message = error;
        } else
