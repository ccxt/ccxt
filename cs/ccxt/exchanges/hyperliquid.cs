...
public partial class hyperliquid : Exchange
{
    ...
    public async override Task<ccxt.OrderBook> FetchOrderBook(string symbol, Int64? limit = null, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "type", "l2Book" },
            { "coin", ((bool) (isEqual((market.ContainsKey("swap") ? market["swap"] : null), true))) ? this.safeString(market, "baseName") : (market.ContainsKey("id") ? market["id"] : null) },
        };
        object response = await this.publicPostInfo(this.extend(request, parameters));
        //
        //     {
    ...
    public override string? priceToPrecision(object symbol, object price)
    {
        ...
        object maxDecimals = ((bool) (isEqual((market.ContainsKey("spot") ? market["spot"] : null), true))) ? 8 : 6;
    ...
    public async override Task<List<ccxt.Order>> CancelOrdersForSymbols(object orders, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(orders); postFixIncrement(ref i))
        {
            ...
            ((IDictionary<string,object>)cancelObj)[(string)assetKey] = this.parseToNumeric((market.ContainsKey("baseId") ? market["baseId"] : null));
    ...
    public virtual List<object> handlePublicAddress(object methodName, object parameters)
    {
        ...
        throw new ArgumentsRequired ((string)(add((this.id + " "), methodName) + "() requires a user parameter inside 'params' or the wallet address set")) ;
    }
    ...
    public override object handleErrors(object code, object reason, object url, object method, object headers, object body, object response, object requestHeaders, object requestBody)
    {
        ...
        {
            throw new OrderNotFound ((string)add((this.id + " "), body)) ;
        } else if ((error != null))
        {
            message = error;
        } else
