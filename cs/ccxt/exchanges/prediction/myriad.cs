...
public partial class myriad : PredictionExchange
{
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchRawMarketsBySearch(object queries, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(queries); postFixIncrement(ref i))
        {
            ...
            object foundList = ((bool) (responseIsArray)) ? response : this.safeList(response, "data", new List<object>() {});
            object found = ((bool) ((foundList != null))) ? foundList : new List<object>() {};
            for (int j = 0; j < getArrayLength(found); postFixIncrement(ref j))
            {
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchRawMarketsList(object parameters = null)
    {
        ...
        while (true)
        {
            ...
            bool responseIsArray = ((response is IList<object>) || (response.GetType().IsGenericType && response.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>))));
            object rawMarketsList = ((bool) (responseIsArray)) ? response : this.safeList(response, "data", new List<object>() {});
            object rawMarkets = ((bool) ((rawMarketsList != null))) ? rawMarketsList : new List<object>() {};
    ...
    public async virtual Task<Dictionary<string, object>> FetchRawQuestionById(object id, object parameters = null)
    {
        ...
        } catch(Exception e)
        {
            ...
            for (int i = 0; i < questionsLength; postFixIncrement(ref i))
            {
                ...
                if (((((string)qId).ToLower() == idLower)) || ((((string)qSlug).ToLower() == idLower)) || ((((string)qTitle).ToLower() == idLower)) || (((qHandle != null)) && ((((string)qHandle).ToLower() == idLower))))
                {
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchRawQuestionsList(object parameters = null)
    {
        ...
        while (true)
        {
            ...
            bool responseIsArray = ((response is IList<object>) || (response.GetType().IsGenericType && response.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>))));
            object rawQuestionsList = ((bool) (responseIsArray)) ? response : this.safeList(response, "data", new List<object>() {});
            object rawQuestions = ((bool) ((rawQuestionsList != null))) ? rawQuestionsList : new List<object>() {};
    ...
    public async override Task<List<ccxt.PredictionPosition>> FetchPositions(object outcomes = null, object parameters = null)
    {
        ...
        if ((address == null))
        {
            throw new ArgumentsRequired ((string)(this.id + " fetchPositions() requires a walletAddress or an address parameter")) ;
        }
     ...
     */
    public virtual Dictionary<string, object> parseTradeQuote(object quote, object market = null)
    {
        //
        //     {
        //         "value": 10,
    ...
    public async override Task<ccxt.PredictionOrder> CreateOrder(string outcome, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        if ((enableAmm != true))
        {
            throw new NotSupported ((string)(this.id + " createOrder() only supports the gasless order book; this market uses the on-chain AMM (needs native gas and is unverified) — pass params.enableAmm=true to opt in")) ;
        }
        return await this.CreateAmmOrder(((string)outcome),((string)type),((string)side),ccxt.BaseExchange.ToDoubleArgRequired(amount),ccxt.BaseExchange.ToDoubleArg(price), this.omit(rest, new List<object>() {"enableAmm", "enableAmmOrders"}));
    }
    ...
    public async virtual Task<ccxt.PredictionOrder> CreateOrderbookOrder(string outcome, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        string? sideStr = ((bool) (isEqual(side, null))) ? null : ((string)((string)side)).ToLower();
        string typeStr = ((bool) (isEqual(type, null))) ? "limit" : ((string)type).ToLower();
    ...
    public virtual Dictionary<string, object> buildOrderbookOrder(object outcome, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        {
            throw new ArgumentsRequired ((string)(this.id + " createOrder() requires a privateKey to sign the order")) ;
        }
        IDictionary<string, object> outcomeObj = this.outcome(outcome);
        IDictionary<string, object> info = this.safeDict(outcomeObj, "info", new Dictionary<string, object>() {});
    ...
    public async override Task<List<ccxt.PredictionOrder>> CreateOrders(object orders, object parameters = null)
    {
        ...
        for (int i = 0; i < ordersLength; postFixIncrement(ref i))
        {
    ...
    public async virtual Task<ccxt.PredictionOrder> CreateAmmOrder(string outcome, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        parameters ??= new Dictionary<string, object>();
        string? sideLower = ((bool) (!isEqual(side, null))) ? ((string)((string)side)).ToLower() : null;
        ...
        if (isEqual(this.privateKey, null))
        {
            throw new ArgumentsRequired ((string)(this.id + " createOrder() requires a privateKey to sign the on-chain transaction")) ;
        }
        await this.loadOutcome(outcome);
        IDictionary<string, object> outcomeObj = this.outcome(outcome);
        IDictionary<string, object> info = this.safeDict(outcomeObj, "info", new Dictionary<string, object>() {});
        ...
        if ((chainConfig == null))
        {
            throw new NotSupported ((string)((this.id + " createOrder() has no on-chain config for network ") + networkId)) ;
        }
    ...
    public override Dictionary<string, object> parsePredictionOrder(object order, object market = null)
    {
        ...
        string side = ((bool) ((sideInt == 1))) ? "sell" : "buy";
        ...
        double? amount = ((bool) ((amountWei == null))) ? null : this.parseNumber(Precise.stringDiv(amountWei, "1000000000000000000"));
        double? price = ((bool) ((priceWei == null))) ? null : this.parseNumber(Precise.stringDiv(priceWei, "1000000000000000000"));
        double? filled = ((bool) ((filledWei == null))) ? null : this.parseNumber(Precise.stringDiv(filledWei, "1000000000000000000"));
        ...
        string? outcome = ((bool) (isEqual(market, null))) ? null : this.safeString(market, "outcome");
        ...
        return ((Dictionary<string, object>)((object)(this.safePredictionOrder(new Dictionary<string, object>() {
            ...
            { "type", ((bool) isMarketTif) ? "market" : "limit" },
            { "timeInForce", tif },
            { "postOnly", ((tif == "PO")) },
            { "side", side },
            { "price", price },
    ...
    public async virtual Task<List<ccxt.PredictionOrder>> FetchAmmOrders(string outcome = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if ((trader == null))
        {
            throw new ArgumentsRequired ((string)(this.id + " fetchOrders() for AMM history requires a trader address or wallet/privateKey")) ;
        }
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "address", trader },
        };
        ...
        if (!isEqual(outcome, null))
        {
            ...
            IDictionary<string, object> info = this.safeDict(outcomeObj, "info", new Dictionary<string, object>() {});
            ((IDictionary<string,object>)request)["market_id"] = this.safeString(info, "marketId");
        ...
        for (int i = 0; i < rowsLength; postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.PredictionOrder> CancelOrder(string id, string outcome = null, object parameters = null)
    {
        ...
        if (isEqual(this.privateKey, null))
        {
            throw new ArgumentsRequired ((string)(this.id + " cancelOrder() requires a privateKey to sign the cancellation")) ;
        }
    ...
    public async override Task<List<ccxt.PredictionOrder>> CancelOrders(object ids, string outcome = null, object parameters = null)
    {
        ...
        if (isEqual(this.privateKey, null))
        {
            throw new ArgumentsRequired ((string)(this.id + " cancelOrders() requires a privateKey to sign the cancellations")) ;
        }
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        if ((token == null))
        {
            throw new NotSupported ((string)((this.id + " fetchBalance() has no collateral token configured for network ") + networkId)) ;
        }
    ...
    public virtual string? fromWeiWithDecimals(object hexValue, object decimals)
    {
        ...
        {
            throw new ExchangeError ((string)(this.id + " fromWeiWithDecimals() missing decimals")) ;
        }
    ...
    public virtual Dictionary<string, object> parseMarketToEvent(object raw, object market)
    {
        ...
        return new Dictionary<string, object>() {
            ...
            { "end", ((bool) ((endDate != null))) ? this.parse8601(endDate) : null },
            { "endDatetime", endDate },
            { "lastUpdatedAt", null },
    ...
    public override Dictionary<string, object> parsePredictionTicker(object raw, object market = null)
    {
        ...
        //     }
        //
        string? outcomeId = ((bool) (!isEqual(market, null) && !isEqual(market, null))) ? this.safeString(getValue(market, "info"), "outcomeId") : null;
        ...
        if ((!isEqual(price, null)) && (!isEqual(change, null)))
        {
            ...
            {
                throw new ExchangeError ((string)(this.id + " method() missing previousClose")) ;
            }
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string outcome, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if ((chartsList != null))
        {
            for (int i = 0; i < chartsList.Count; postFixIncrement(ref i))
            {
        ...
        return ccxt.BaseExchange.ToOHLCVList(this.parseOHLCVs(usablePoints, outcomeObj,((string)timeframeVar), since, limit));
    }
    ...
    public override object parseOHLCV(object ohlcv, object market = null)
    {
        ...
        return new List<object> {this.safeTimestamp(ohlcv, "timestamp"), ((bool) (!isEqual(open, null))) ? open : price, ((bool) (!isEqual(high, null))) ? high : price, ((bool) (!isEqual(low, null))) ? low : price, ((bool) (!isEqual(close, null))) ? close : price, 0};
    }
    ...
    public async override Task<List<ccxt.PredictionTrade>> FetchTrades(string outcome, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        //
        bool responseIsArray = ((response is IList<object>) || (response.GetType().IsGenericType && response.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>))));
        object rowsList = ((bool) (responseIsArray)) ? response : this.safeList(response, "data", new List<object>() {});
        object rows = ((bool) ((rowsList != null))) ? rowsList : new List<object>() {};
        List<object> trades = new List<object>() {};
    ...
    public async override Task<List<ccxt.PredictionEvent>> FetchEvents(object parameters = null)
    {
        ...
        } else
        {
            ...
            } else
            {
                ...
                for (int i = 0; i < requestedTagsLength; postFixIncrement(ref i))
                {
        ...
        for (int i = 0; i < rawQuestionsLength; postFixIncrement(ref i))
        {
            ...
            for (int j = 0; j < evMarketsLength; postFixIncrement(ref j))
            {
                ...
                if ((marketHandle != null))
                {
                    ...
                    ((IDictionary<string,object>)seenMarketHandles)[(string)marketHandle] = true;
    ...
    public virtual object parseEvent(object rawEvent)
    {
        ...
        return ((object)this.extend(rawEvent, new Dictionary<string, object>() {
            ...
            { "slug", questionSlug },
            { "event", ((bool) ((questionSlug != null) && (questionSlug != ""))) ? this.shortenSlug(questionSlug) : null },
            ...
            { "end", ((bool) ((endDate != null) && (endDate != ""))) ? this.parse8601(endDate) : null },
            { "endDatetime", endDate },
    ...
    public override void handleMessage(WebSocketClient client, object message)
    {
        ...
        if ((message is string))
        {
            ...
            for (int i = 0; i < linesLength; postFixIncrement(ref i))
            {
    ...
    public virtual void handleOrderBook(WebSocketClient client, object data)
    {
        ...
        for (int i = 0; i < changesLength; postFixIncrement(ref i))
        {
            ...
            object bookSide = ((bool) ((sideStr == "bid"))) ? getValue(orderbook, "bids") : getValue(orderbook, "asks");
        ...
        for (int k = 0; k < updatedLength; postFixIncrement(ref k))
        {
            string? sym = ((string)getValue(updatedSymbols, k));
            (client as WebSocketClient).resolve(this.getOrderBook(this.orderbooks, sym), ("orderbook::" + sym));
        }
    }
    ...
    public async override Task<List<ccxt.Trade>> WatchMyTrades(string outcome = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (isEqual(outcome, null))
        {
            throw new ArgumentsRequired ((string)(this.id + " watchMyTrades() requires a outcome (the trades channel is per-market)")) ;
        }
        IDictionary<string, object> outcomeObj = ((IDictionary<string, object>)await this.loadOutcome(outcome));
        IDictionary<string, object> info = this.safeDict(outcomeObj, "info", new Dictionary<string, object>() {});
        string? networkId = this.safeString(info, "networkId");
    ...
    public virtual void handleTrades(WebSocketClient client, object data)
    {
        ...
        IDictionary<string, object> outcomeObj = ((IDictionary<string, object>)this.safeOutcome(sym));
        ...
        if ((myWallet != null))
        {
            ...
            for (int i = 0; i < makersLength; postFixIncrement(ref i))
            {
                ...
                if (isEqual(makerTrader, myWallet))
                {
                    ...
                    IDictionary<string, object> makerOutcomeObj = ((IDictionary<string, object>)this.safeOutcome(makerSym));
            ...
            if (myLegsLength > 0)
            {
                ...
                for (int k = 0; k < myLegsLength; postFixIncrement(ref k))
                {
                    callDynamically(myStored, "append", new object[] {getValue(myLegs, k)});
                }
                (client as WebSocketClient).resolve(myStored, "myTrades");
            }
        }
    }
    ...
    public virtual void handleTicker(WebSocketClient client, object data)
    {
        ...
        for (int i = 0; i < outcomesLength; postFixIncrement(ref i))
        {
            object oc = getValue(outcomes, i);
    ...
    public async virtual Task seedPositionBalances(object trader)
    {
        ...
        for (int i = 0; i < positionsLength; postFixIncrement(ref i))
        {
    ...
    public virtual void handlePosition(WebSocketClient client, object data)
    {
        ...
        callDynamically(stored, "append", new object[] {parsed});
        (client as WebSocketClient).resolve(stored, "positions");
    }
    ...
    public virtual string walletAddressFromKeys()
    {
        ...
        if (!hasWallet)
        {
            if (isEqual(this.privateKey, null))
            {
                throw new ArgumentsRequired ((string)(this.id + " requires a walletAddress or privateKey to watch private channels")) ;
            }
