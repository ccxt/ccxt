...
public partial class kalshi : PredictionExchange
{
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        if (isGreaterThan(queriesLength, 0))
        {
            ...
            List<object> events = ((List<object>)ccxt.BaseExchange.FromPredictionEventList(await this.FetchEvents(eventParams)));
    ...
    public async override Task<Dictionary<string, object>> FetchOutcomes(object outcomeSymbols)
    {
        ...
        int tickersLength = tickers.Count;
        object startIndex = 0;
    ...
    public override Dictionary<string, object> parsePredictionTicker(object raw, object market = null)
    {
        ...
        string? outcomeLabel = (!isEqual(market, null) && !isEqual(market, null)) ? this.safeString(market, "label", this.safeString(getValue(market, "info"), "outcomeLabel", "YES")) : "YES";
        ...
        if (isNo)
        {
            bid = noBid;
            ask = noAsk;
            close = (!isEqual(last, null)) ? this.parseNumber(Precise.stringSub("1", this.numberToString(last))) : null;
        } else
        {
            bid = yesBid;
            ask = yesAsk;
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string outcome, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            object candlesCount = (!isEqual(limit, null)) ? limit : defaultLimit;
            request["end_ts"] = now;
    ...
    public async override Task<List<ccxt.PredictionPosition>> FetchPositions(object outcomes = null, object parameters = null)
    {
        ...
        if (isGreaterThan(outcomesLength, 0))
        {
            await this.loadOutcomes(outcomes);
        }
    ...
    public async override Task<List<ccxt.PredictionOrder>> FetchClosedOrders(string outcome = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        parameters ??= new Dictionary<string, object>();
        List<object> orders = ((List<object>)ccxt.BaseExchange.FromPredictionOrderList(await this.FetchOrders(((string)outcome),ccxt.BaseExchange.ToInt64Arg(null),ccxt.BaseExchange.ToInt64Arg(null), parameters)));
        List<object> result = new List<object>() {};
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchEventsByQuery(object queries, Int64 limit, object rest = null)
    {
        ...
        int eventTickersLength = eventTickers.Count;
        for (int ei = 0; isLessThan(ei, eventTickersLength); postFixIncrement(ref ei))
        {
            int collectedLength = rawEvents.Count;
    ...
    public async virtual Task<object> resolveEventSeriesTickers(object parameters = null)
    {
        ...
        int collectedLength = collected.Count;
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchSeriesEvents(object seriesTickers, object status, Int64 limit, object rest = null)
    {
        ...
        for (int si = 0; isLessThan(si, seriesTickersLength); postFixIncrement(ref si))
        {
            ...
            for (int page = 0; isLessThan(page, maxPages); postFixIncrement(ref page))
            {
                ...
                if (!isEqual(limit, null))
                {
                    object remaining = subtract(limit, rawEvents.Count);
                ...
                cursor = this.safeString(response, "cursor");
                int collectedAfterPage = rawEvents.Count;
    ...
    public virtual Dictionary<string, object> parseEvent(object rawEvent)
    {
        ...
        int marketsCount = marketsList.Count;
        bool? active = null;
        if (isGreaterThan(marketsCount, 0))
        {
            active = anyActive;
        }
        bool? resolved = this.safeBool(rawEvent, "resolved");
        if ((isEqual(resolved, null)) && (isGreaterThan(marketsCount, 0)))
        {
