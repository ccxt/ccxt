...
public partial class limitless : PredictionExchange
{
    ...
    public async virtual Task<List<ccxt.PredictionOrder>> CancelAllOrders(string outcome = null, object parameters = null)
    {
        ...
        if ((outcome != null))
        {
            ...
            request["slug"] = this.safeString((outcomeObj != null && ((IDictionary<string, object>)outcomeObj).ContainsKey("info") ? ((IDictionary<string, object>)outcomeObj)["info"] : null), "slug");
        } else if ((slug == null))
        {
