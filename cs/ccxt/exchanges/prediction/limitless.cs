...
public partial class limitless : PredictionExchange
{
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        if (queriesLength > 0)
        {
            ...
            for (int i = 0; i < getArrayLength(queries); postFixIncrement(ref i))
            {
                ...
                for (int j = 0; j < found.Count; postFixIncrement(ref j))
                {
        ...
        } else
        {
            ...
            Int64? knownTotal = ((bool) (!isEqual(totalMarketsCount, null))) ? totalMarketsCount : 0;
            ...
            for (int j = 0; j < length; postFixIncrement(ref j))
            {
            ...
            if (isGreaterThanOrEqual(lastPageLength, pageSize) && isLessThan(allRawLength, maxMarkets))
            {
                while (true)
                {
                    ...
                    List<object> page_markets = ((bool) ((rawPageMarkets != null))) ? rawPageMarkets : new List<object>() {};
                    int pageMarketsLength = getArrayLength(page_markets);
                    if ((pageMarketsLength == 0))
                    {
                        break;
                    }
                    for (int i = 0; i < getArrayLength(page_markets); postFixIncrement(ref i))
                    {
        ...
        for (int i = 0; i < getArrayLength(expandedRaw); postFixIncrement(ref i))
        {
        ...
        for (int i = 0; i < eventKeys.Count; postFixIncrement(ref i))
        {
    ...
    public override Dictionary<string, object> parseMarket(object raw)
    {
        ...
        for (int i = 0; i < tokenEntries.Count; postFixIncrement(ref i))
        {
        ...
        return ccxt.BaseExchange.ToDict(new Dictionary<string, object>() {
            { "id", slug },
            { "market", marketSymbol },
            { "marketType", ((bool) (outcomesLength > 2)) ? "categorical" : "binary" },
            { "executionModel", "clob" },
            { "collateral", "USDC" },
            { "base", slug },
            { "quote", "USDC" },
    ...
    public virtual List<object> expandGroupRows(object rawRows)
    {
        ...
        for (int i = 0; i < getArrayLength(rawRows); postFixIncrement(ref i))
        {
            ...
            if (((rowType == "group")) && ((nestedMarkets != null)))
            {
                ...
                for (int j = 0; j < nestedMarketsLength; postFixIncrement(ref j))
                {
    ...
    public virtual object parseEvent(object eventVar)
    {
        ...
        string? eventSlug = ((bool) hasGroupId) ? this.shortenSlug(groupId) : null;
        bool hasEndDate = ((endDate != null)) && ((endDate != ""));
        Int64? endTimestamp = ((bool) hasEndDate) ? this.parse8601(endDate) : null;
        List<object> markets = new List<object>() {};
        ...
        for (int i = 0; i < rawMarkets.Count; postFixIncrement(ref i))
        {
    ...
    public override Dictionary<string, object> parsePredictionTicker(object ticker, object market = null)
    {
        ...
        {
            lastStr = ((bool) (isYes)) ? this.safeString(prices, 0) : this.safeString(prices, 1);
        }
    ...
    public async override Task<ccxt.PredictionTickers> FetchTickers(object outcomes = null, object parameters = null)
    {
        ...
        List<object> promises = new List<object>() {};
        for (int i = 0; i < getArrayLength(slugs); postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.PredictionOrderBook> FetchOrderBook(string outcome, Int64? limit = null, object parameters = null)
    {
        ...
        List<object> bidsSource = ((bool) (isYes)) ? rawBids : rawAsks;
        List<object> asksSource = ((bool) (isYes)) ? rawAsks : rawBids;
        List<object> bids = new List<object>() {};
        List<object> asks = new List<object>() {};
        for (int bi = 0; bi < getArrayLength(bidsSource); postFixIncrement(ref bi))
        {
        ...
        for (int ai = 0; ai < getArrayLength(asksSource); postFixIncrement(ref ai))
        {
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string outcome, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        List<object> rawHistory = ((bool) ((rawHistoryList != null))) ? rawHistoryList : new List<object>() {};
        ...
        if (rawHistoryLength > 0)
        {
            ...
            if ((firstPrices != null))
            {
                ...
                for (int i = 0; i < getArrayLength(rawHistory); postFixIncrement(ref i))
                {
        ...
        for (int i = 0; i < getArrayLength(history); postFixIncrement(ref i))
        {
            ...
            if (isEqual(pointTs, null))
            {
                ...
                pointTs = ((bool) ((tsString != null) && (tsString != ""))) ? this.parse8601(tsString) : null;
        ...
        for (int i = 0; i < getArrayLength(sorted); postFixIncrement(ref i))
        {
            ...
            } else
            {
                ...
                object pPriceOrCandleLow = ((bool) (isEqual(pPrice, null))) ? getValue(candle, 3) : pPrice;
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(bucketOrder); postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.PredictionOrder> CreateOrder(string outcome, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        string? walletFromAccount = ((bool) (usesSmartWallet)) ? this.safeString(accountInfo, "smartWallet") : this.safeString(accountInfo, "account");
        object maker = ((bool) (!isEqual(this.walletAddress, ""))) ? this.walletAddress : walletFromAccount;
        ...
        object signatureType = ((bool) isSmartWallet) ? 2 : 0;
        ...
        ((IDictionary<string,object>)signRequest)["takerAmount"] = ((bool) isMarket) ? 1 : this.parseToInt(this.applyScale(takerAmount, true));
    ...
    public override Dictionary<string, object> parsePredictionTrade(object trade, object market = null)
    {
        ...
        string label = ((bool) ((outcomeIndex == 0))) ? "yes" : "no";
    ...
    public virtual object getOutcomeBySlugAndLabel(object slug, object label, object market = null)
    {
        ...
        for (int i = 0; i < outcomes.Count; postFixIncrement(ref i))
        {
    ...
    public async override Task<List<ccxt.PredictionPosition>> FetchPositions(object outcomes = null, object parameters = null)
    {
        ...
        for (int i = 0; i < clob.Count; postFixIncrement(ref i))
        {
            IDictionary<string, object> entry = this.safeDict(clob, i);
            for (int j = 0; j < getArrayLength(labels); postFixIncrement(ref j))
            {
    ...
    public async override Task<List<ccxt.PredictionEvent>> FetchEvents(object parameters = null)
    {
        ...
        } else
        {
            ...
            for (int i = 0; i < listRawLength; postFixIncrement(ref i))
            {
        ...
        for (int i = 0; i < eventKeysLength; postFixIncrement(ref i))
        {
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchRawMarketsByTags(object tags, object parameters = null)
    {
        ...
        for (int i = 0; i < categoriesLength; postFixIncrement(ref i))
        {
        ...
        Dictionary<string, object> seen = new Dictionary<string, object>() {};
        List<object> allRaw = new List<object>() {};
        for (int ci = 0; ci < categoryIdsLength; postFixIncrement(ref ci))
        {
            ...
            for (int mi = 0; mi < categoryMarketsLength; postFixIncrement(ref mi))
            {
