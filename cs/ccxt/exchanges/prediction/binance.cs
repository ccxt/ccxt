...
public partial class binance : PredictionExchange
{
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        for (int i = 0; i < rawTopicsLength; postFixIncrement(ref i))
        {
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchRawTopics(object maxTopics, object rest = null)
    {
        ...
        while (true)
        {
            ...
            for (int i = 0; i < pageTopicsLength; postFixIncrement(ref i))
            {
    ...
    public async override Task<List<ccxt.PredictionEvent>> FetchEvents(object parameters = null)
    {
        ...
        for (int i = 0; i < tagsLength; postFixIncrement(ref i))
        {
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchEventsByQuery(object queries, Int64 limit, object rest = null)
    {
        ...
        for (int qi = 0; qi < queriesLength; postFixIncrement(ref qi))
        {
            ...
            for (int i = 0; i < responseLength; postFixIncrement(ref i))
            {
    ...
    public virtual object parseEvent(object rawTopic)
    {
        ...
        return new Dictionary<string, object>() {
            { "id", topicId },
            { "slug", slug },
            { "event", ((bool) ((slug != null))) ? this.shortenSlug(slug) : null },
            { "title", title },
    ...
    public virtual object parseTopicMarket(object rawMarket, object rawTopic)
    {
        ...
        for (int oi = 0; oi < rawOutcomesLength; postFixIncrement(ref oi))
        {
    ...
    public async virtual Task<Dictionary<string, object>> FetchWallet(object methodName, object parameters = null)
    {
        ...
        for (int i = 0; i < walletLength; postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.PredictionOrder> CreateOrder(string outcome, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        if ((accountType == null))
        {
            throw new ArgumentsRequired ((string)(this.id + " createOrder requires accountType (SPOT, FUNDING)")) ;
        }
    ...
    public async override Task<List<ccxt.PredictionOrder>> CancelOrders(object ids, string outcome = null, object parameters = null)
    {
        ...
        if (failedOrdersLength > 0)
        {
            ...
            for (int i = 0; i < failedOrdersLength; postFixIncrement(ref i))
            {
        ...
        for (int i = 0; i < canceledOrdersLength; postFixIncrement(ref i))
        {
