...
public partial class hyperliquid : PredictionExchange
{
    ...
    public virtual object buildOutcomeSymbol(object desc, object side, object outcomeId)
    {
        ...
        object expiryDate = ((bool) ((expiry != ""))) ? getValue(((string)expiry).Split(new [] {((string)"-")}, StringSplitOptions.None).ToList<object>(), 0) : "";
        string label = ((bool) (isEqual(side, 0))) ? "YES" : "NO";
    ...
    public virtual object buildOutcomeParentSymbol(object desc, object outcomeId, object name = null, object question = null)
    {
        ...
        if (((questionDescription != null)) && ((questionDescription != "")))
        {
            ...
            if ((questionClass == "pricebucket"))
            {
                ...
                object expiryDate = ((bool) ((questionExpiry != ""))) ? getValue(((string)questionExpiry).Split(new [] {((string)"-")}, StringSplitOptions.None).ToList<object>(), 0) : "";
                ...
                if (((questionUnderlying != null) && (questionUnderlying != "")) && ((thresholdsRaw != "")) && (indexStr != null))
                {
                    ...
                    for (int i = 0; i < thresholdParts.Count; postFixIncrement(ref i))
                    {
    ...
    public async override Task<List<ccxt.MarketInterface>> FetchMarkets(object parameters = null)
    {
        ...
        for (int qi = 0; qi < questionsList.Count; postFixIncrement(ref qi))
        {
            ...
            for (int ni = 0; ni < namedOutcomes.Count; postFixIncrement(ref ni))
            {
        ...
        for (int i = 0; i < outcomesList.Count; postFixIncrement(ref i))
        {
            ...
            for (int oi = 0; oi < marketOutcomes.Count; postFixIncrement(ref oi))
            {
    ...
    public virtual object parseOutcomeMarket(object outcomeInfo, object outcomeId, object question = null)
    {
        ...
        if (((expiry != null)) && ((expiry != "")))
        {
            ...
            if (expPartsLength >= 1 && (((string)getValue(expParts, 0)).Length == 8))
            {
                ...
                object isoStr = (((((((((slice(ymd, 0, 4) + "-") + slice(ymd, 4, 6)) + "-") + slice(ymd, 6, 8)) + "T") + slice(hm, 0, 2)) + ":") + slice(hm, 2, 4)) + ":00Z");
    ...
    public async override Task<ccxt.PredictionTickers> FetchTickers(object outcomes = null, object parameters = null)
    {
        ...
        object outcomesMap = ((bool) (!isEqual(this.outcomes, null))) ? this.outcomes : new Dictionary<string, object>() {};
        List<object> outcomeHandles = new List<object>(((IDictionary<string,object>)outcomesMap).Keys);
        for (int i = 0; i < outcomeHandles.Count; postFixIncrement(ref i))
        {
    ...
    public override Dictionary<string, object> parsePredictionTicker(object raw, object market = null)
    {
        ...
        double? bid = ((bool) ((topBid != null))) ? this.safeNumber(topBid, "px") : null;
        double? ask = ((bool) ((topAsk != null))) ? this.safeNumber(topAsk, "px") : null;
        double? bidVolume = ((bool) ((topBid != null))) ? this.safeNumber(topBid, "sz") : null;
        double? askVolume = ((bool) ((topAsk != null))) ? this.safeNumber(topAsk, "sz") : null;
        ...
        Dictionary<string, object> parentMarket = ((bool) ((parentSymbol != null))) ? this.safeMarket(parentSymbol) : null;
        object ctx = ((bool) ((parentMarket != null))) ? this.safeDict(this.safeDict(parentMarket, "info", new Dictionary<string, object>() {}), "ctx", new Dictionary<string, object>() {}) : new Dictionary<string, object>() {};
    ...
    public virtual object findOutcomeInMarket(object market, object sideHint = null)
    {
        ...
        string? normalizedHint = ((bool) (!isEqual(sideHint, null) && !isEqual(sideHint, ""))) ? ((string)sideHint).ToUpper() : null;
    ...
    public virtual object resolveOutcomeInput(object outcomeInput)
    {
        ...
        if (((!isEqual(this.markets, null)) && (inOp(this.markets, outcomeInput))) || ((!isEqual(this.markets_by_id, null)) && (inOp(this.markets_by_id, outcomeInput))))
        {
            ...
            string? sideHintOrDefault = ((bool) ((sideHint != null))) ? sideHint : "YES";
    ...
    public async override Task<ccxt.PredictionOrder> CreateOrder(string outcome, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        string defaultTif = ((bool) isMarket) ? "Ioc" : "Gtc";
        if ((postOnly == true))
        {
            defaultTif = "Alo";
        }
        ...
        if (isMarket)
        {
            ...
            px = ((bool) isBuy) ? Precise.stringMul(priceStr, Precise.stringAdd("1", slippage)) : Precise.stringMul(priceStr, Precise.stringSub("1", slippage));
    ...
    public async override Task<List<ccxt.PredictionOrder>> CancelOrders(object ids, string outcome = null, object parameters = null)
    {
        ...
        if ((clientOrderId != null))
        {
            object cloids = ((bool) ((clientOrderId is IList<object>) || (clientOrderId.GetType().IsGenericType && clientOrderId.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>))))) ? clientOrderId : new List<object>() {clientOrderId};
            ((IDictionary<string,object>)cancelAction)["type"] = "cancelByCloid";
            for (int i = 0; i < getArrayLength(cloids); postFixIncrement(ref i))
            {
        ...
        for (int i = 0; i < statuses.Count; postFixIncrement(ref i))
        {
            ...
            Dictionary<string, object> order = new Dictionary<string, object>() {
                { "id", requestId },
                { "clientOrderId", ((bool) ((clientOrderId != null))) ? requestId : null },
                { "info", status },
                { "status", "canceled" },
    ...
    public async virtual Task<ccxt.PredictionOrder> FetchOrder(string id, string outcome = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            ((IDictionary<string,object>)request)["oid"] = ((bool) isCloid) ? id : this.parseToNumeric(id);
        }
        object response = await this.publicPostInfo(this.extend(request, parameters));
    ...
    public override Dictionary<string, object> parsePredictionOrder(object order, object market = null)
    {
        ...
        object resolvedMarket = ((bool) ((marketSymbol != null) && (marketSymbol != ""))) ? this.safeMarket(marketSymbol, market) : market;
        string? sideRaw = this.safeString(entry, "side");
        string side = ((bool) ((sideRaw == "B"))) ? "buy" : "sell";
    ...
    public virtual string? parseOrderType(object status)
    {
        ...
        string? statusLower = ((bool) (!isEqual(status, null) && !isEqual(status, ""))) ? ((string)status).ToLower() : null;
    ...
    public virtual string? parseTimeInForce(object timeInForce)
    {
        ...
        string? tifLower = ((bool) (!isEqual(timeInForce, null) && !isEqual(timeInForce, ""))) ? ((string)timeInForce).ToLower() : null;
    ...
    public override Dictionary<string, object> parsePredictionTrade(object trade, object market = null)
    {
        ...
        string side = ((bool) ((rawSide == "B"))) ? "buy" : "sell";
        ...
        string takerOrMaker = ((bool) crossed) ? "taker" : "maker";
    ...
    public async override Task<List<ccxt.PredictionEvent>> FetchEvents(object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(marketValues); postFixIncrement(ref i))
        {
            ...
            if (lowerQueriesLength > 0)
            {
                ...
                string? parentSymbolOrEmpty = ((bool) ((parentSymbol != null))) ? parentSymbol : "";
                ...
                object haystack = ((description + " ") + symLower);
                bool matches = false;
                for (int qi = 0; qi < getArrayLength(lowerQueries); postFixIncrement(ref qi))
                {
                    ...
                    bool allWords = true;
                    for (int wi = 0; wi < wordsLength; postFixIncrement(ref wi))
                    {
        ...
        for (int gi = 0; gi < groupKeys.Count; postFixIncrement(ref gi))
        {
    ...
    public virtual object parseEvent(object raw)
    {
        ...
        Int64? endValue = ((bool) (!isEqual(expiryMs, null))) ? expiryMs : firstExpiry;
    ...
    public override object sign(object path, object api = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        method ??= "POST";
        parameters ??= new Dictionary<string, object>();
        object apiGroup = ((bool) ((api is IList<object>) || (api.GetType().IsGenericType && api.GetType().GetGenericTypeDefinition().IsAssignableFrom(typeof(List<>))))) ? getValue(api, 0) : api;
