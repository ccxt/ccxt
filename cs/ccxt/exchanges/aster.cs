...
public partial class aster : Exchange
{
    ...
    public override Dictionary<string, object> parseMarket(object market)
    {
        ...
        double? amountPrecision = ((bool) ((filterLotSize != null))) ? this.safeNumber(filterLotSize, "stepSize") : this.parseNumber(this.parsePrecision(this.safeString(market, "quantityPrecision")));
    ...
    public override Dictionary<string, object> parseOrder(object order, object market = null)
    {
        ...
        string defaultType = ((bool) ((positionSide != null))) ? "swap" : "spot";
    ...
    public async override Task<List<ccxt.Order>> CreateOrders(object orders, object parameters = null)
    {
        ...
        if (isEqual((market.ContainsKey("spot") ? market["spot"] : null), true))
        {
            throw new NotSupported ((string)(add((this.id + " createOrders() does not support "), (market.ContainsKey("type") ? market["type"] : null)) + " orders")) ;
        }
        Dictionary<string, object> request = new Dictionary<string, object>() {
    ...
    public virtual Dictionary<string, object> createOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        if (((this.safeBool(this.options, "builderFee") == true)) && (isEqual((market.ContainsKey("swap") ? market["swap"] : null), true)))
        {
    ...
    public override object parseMarginModification(object data, object market = null)
    {
        ...
        return new Dictionary<string, object>() {
            { "info", data },
            { "symbol", getValue(market, "symbol") },
            { "type", ((bool) ((rawType == 1))) ? "add" : "reduce" },
            { "marginMode", "isolated" },
            { "amount", this.safeNumber(data, "amount") },
            { "code", this.safeString(data, "asset") },
            { "total", null },
            { "status", ((bool) (success || noErrorCode)) ? "ok" : "failed" },
            { "timestamp", timestamp },
            { "datetime", this.iso8601(timestamp) },
        };
    }
    ...
    public virtual object parsePositionRisk(object position, object market = null)
    {
        ...
        collateralString = ((bool) ((collateralString == null))) ? "0" : collateralString;
    ...
    public virtual List<object> parseAccountPositions(object account, object filterClosed = null)
    {
        ...
        for (int i = 0; i < positions.Count; postFixIncrement(ref i))
        {
            ...
            object code = ((bool) (isEqual((market.ContainsKey("linear") ? market["linear"] : null), true))) ? (market.ContainsKey("quote") ? market["quote"] : null) : (market.ContainsKey("base") ? market["base"] : null);
    ...
    public virtual Dictionary<string, object> parseAccountPosition(object position, object market = null)
    {
        ...
        string? symbol = this.safeString(market, "symbol");
        string? leverageString = this.safeString(position, "leverage");
        object leverage = ((bool) ((leverageString != null))) ? parseInt(leverageString) : null;
