...
public partial class htx : Exchange
{
    ...
    public async override Task<ccxt.LastPrices> FetchLastPrices(object symbols = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchLastPrices() does not support "), type) + " markets yet")) ;
        }
        object tick = this.safeValue(response, "tick", new Dictionary<string, object>() {});
    ...
    public async override Task<List<ccxt.Trade>> FetchMyTrades(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            } else if ((this.safeBool(market, "inverse") == true))
            {
                ...
                {
                    throw new NotSupported ((string)(add((this.id + " fetchMyTrades() does not support "), marketType) + " markets")) ;
                }
            }
        }
        //
    ...
    public async override Task<ccxt.Order> FetchOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            } else if ((this.safeBool(market, "inverse") == true))
            {
                ...
                {
                    throw new NotSupported ((string)(add((this.id + " fetchOrder() does not support "), marketType) + " markets")) ;
                }
            }
        }
        //
    ...
    public async override Task<List<ccxt.Order>> FetchOrders(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        {
            throw new ArgumentsRequired ((string)(add((this.id + " fetchOrders() requires a symbol argument for "), marketType) + " orders")) ;
        }
        if (contract)
        {
    ...
    public async override Task<List<ccxt.Order>> FetchCanceledOrders(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        } else
        {
            if (isEqual(symbol, null))
            {
                throw new ArgumentsRequired ((string)(add((this.id + " fetchCanceledOrders() requires a symbol argument for "), marketType) + " orders")) ;
            }
            Dictionary<string, object> request = new Dictionary<string, object>() {};
            if ((this.safeBool(market, "linear") == true))
            {
    ...
    public async override Task<ccxt.Order> CancelOrder(string id, string symbol = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            {
                throw new NotSupported ((string)(add((this.id + " cancelOrder() does not support "), marketType) + " markets")) ;
            }
        }
        //
        // spot
    ...
    public async override Task<List<ccxt.Order>> CancelOrders(object ids, string symbol = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            {
                throw new NotSupported ((string)(add((this.id + " cancelOrders() does not support "), marketType) + " markets")) ;
            }
        }
        //
        // spot
    ...
    public async override Task<List<ccxt.Order>> CancelAllOrders(string symbol = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            {
                throw new NotSupported ((string)(add((this.id + " cancelAllOrders() does not support "), marketType) + " markets")) ;
            }
            //
            //     {
            //         "status": "ok",
