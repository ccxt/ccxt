...
public partial class htx : Exchange
{
    ...
    public async override Task<ccxt.Status> FetchStatus(object parameters = null)
    {
        ...
        if (isEqual(marketType, "spot"))
        {
            ...
            status = ((bool) ((marketStatus == 1))) ? "ok" : "maintenance";
        ...
        } else
        {
            ...
            status = ((bool) ((heartbeat == 1))) ? "ok" : "maintenance";
    ...
    public virtual object tryGetSymbolFromFutureMarkets(object symbolOrMarketId)
    {
        ...
        for (int i = 0; i < getArrayLength(futureMarkets); postFixIncrement(ref i))
        {
            ...
            object constructedId = ((bool) (isEqual(getValue(market, "linear"), true))) ? add(add(add(add(getValue(market, "base"), "-"), getValue(market, "quote")), "-"), contractSuffix) : add(add(getValue(market, "base"), "_"), contractSuffix);
    ...
    public async override Task<ccxt.Ticker> FetchTicker(string symbol, object parameters = null)
    {
        ...
        {
            if (isEqual((market.ContainsKey("future") ? market["future"] : null), true))
            {
    ...
    public async override Task<ccxt.LastPrices> FetchLastPrices(object symbols = null, object parameters = null)
    {
        ...
        parameters = ((IList<object>)typeparametersVariable)[1];
        Dictionary<string, object> response = null;
        if (((isEqual(type, "swap")) || (isEqual(type, "future"))) && (isEqual(subType, "linear")))
        {
            response = await this.contractPublicGetLinearSwapExMarketTrade(parameters);
        } else if ((isEqual(type, "swap")) && (isEqual(subType, "inverse")))
        {
            response = await this.contractPublicGetSwapExMarketTrade(parameters);
        } else if ((isEqual(type, "future")) && (isEqual(subType, "inverse")))
        {
    ...
    public async override Task<List<ccxt.Trade>> FetchTrades(string symbol, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (isEqual((market.ContainsKey("future") ? market["future"] : null), true))
        {
            ...
            } else if (isEqual((market.ContainsKey("linear") ? market["linear"] : null), true))
            {
                ((IDictionary<string,object>)request)["contract_code"] = (market.ContainsKey("id") ? market["id"] : null);
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (isEqual((market.ContainsKey("contract") ? market["contract"] : null), true))
        {
            ...
            if ((priceType == null))
            {
                ...
                ((IDictionary<string,object>)request)["to"] = ((bool) (!isEqual(untilSeconds, null))) ? untilSeconds : calcualtedEnd;
            }
        }
        Dictionary<string, object> response = null;
        if (isEqual((market.ContainsKey("future") ? market["future"] : null), true))
        {
            if (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true))
            {
                ...
                {
                    throw new BadRequest ((string)(((add((this.id + " "), (market.ContainsKey("type") ? market["type"] : null)) + " has no api endpoint for ") + priceType) + " kline data")) ;
                } else
                {
    ...
    public override Dictionary<string, object> parseCurrency(object rawCurrency)
    {
        ...
        string type = ((bool) ((assetType == "1"))) ? "crypto" : "fiat";
        if ((code != null))
        {
    ...
    public async override Task<ccxt.Balances> FetchBalance(object parameters = null)
    {
        ...
        bool margin = (isEqual(type, "margin")) || (spot && (cross || isolated));
        Dictionary<string, object> response = null;
    ...
    public async override Task<List<ccxt.Order>> FetchOrders(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        marketType = (string)((IList<object>)marketTypeparametersVariable)[0];
        parameters = ((IList<object>)marketTypeparametersVariable)[1];
        bool contract = (isEqual(marketType, "swap")) || (isEqual(marketType, "future"));
    ...
    public async override Task<List<ccxt.Order>> FetchOpenOrders(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (isEqual(marketType, "spot"))
        {
            ...
            if ((accountId == null))
            {
                ...
                await this.loadAccounts();
                for (int i = 0; i < getArrayLength(this.accounts); postFixIncrement(ref i))
                {
    ...
    public override Dictionary<string, object> parseOrder(object order, object market = null)
    {
        ...
        if (((feeCost != null)) && ((feeCost != "0")) && ((feeCost != "0.0")))
        {
            ...
            {
                feeCurrency = ((bool) (isEqual(side, "sell"))) ? getValue(market, "quote") : getValue(market, "base");
            }
            fee = new Dictionary<string, object>() {
                { "cost", feeCost },
                { "currency", feeCurrency },
        ...
        } else
        {
            ...
            {
                reduceOnly = ((bool) ((reduceOnlyInteger == 0))) ? false : true;
            }
        }
    ...
    public async virtual Task<Dictionary<string, object>> CreateSpotOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        {
            string defaultOperator = ((bool) (isEqual(side, "sell"))) ? "lte" : "gte";
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchWithdrawAddresses(string code, object note = null, object networkCode = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(allAddresses); postFixIncrement(ref i))
        {
    ...
    public async override Task<ccxt.TransferEntry> Transfer(string code, double amount, string fromAccount, string toAccount, object parameters = null)
    {
        ...
        } else
        {
            ...
            ((IDictionary<string,object>)request)["from"] = ((bool) fromSpot) ? "spot" : fromAccountId;
            ((IDictionary<string,object>)request)["to"] = ((bool) toSpot) ? "spot" : toAccountId;
    ...
    public async override Task<ccxt.FundingRates> FetchFundingRates(object symbols = null, object parameters = null)
    {
        ...
        if (!isEqual(symbols, null))
        {
            ...
            subType = ((bool) (isEqual(isLinear, true))) ? "linear" : "inverse";
        }
        Dictionary<string, object> request = new Dictionary<string, object>() {};
        Dictionary<string, object> response = null;
        if (isEqual(subType, "linear"))
    ...
    public override object parseBorrowInterest(object info, object market = null)
    {
        ...
        //
        string? marketId = this.safeString(info, "symbol");
        string marginMode = ((bool) ((marketId == null))) ? "cross" : "isolated";
    ...
    public async override Task<Dictionary<string, object>> SetLeverage(object leverage, string symbol = null, object parameters = null)
    {
        ...
        if (isEqual(marketType, "future") && (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true)))
        {
            ((IDictionary<string,object>)request)["symbol"] = (market.ContainsKey("settleId") ? market["settleId"] : null);
        } else
        {
    ...
    public override Dictionary<string, object> parsePosition(object position, object market = null)
    {
        ...
        string directionSide = ((bool) ((rawSide == "buy"))) ? "long" : "short";
    ...
    public async override Task<ccxt.Position> FetchPosition(string symbol, object parameters = null)
    {
        ...
        var query = ((IList<object>) marketTypequeryVariable)[1];
        Dictionary<string, object> request = new Dictionary<string, object>() {};
        if ((isEqual((market.ContainsKey("future") ? market["future"] : null), true)) && (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true)))
        {
            ((IDictionary<string,object>)request)["symbol"] = (market.ContainsKey("settleId") ? market["settleId"] : null);
        } else
        {
            if ((!isEqual((market.ContainsKey("linear") ? market["linear"] : null), true)) && (isEqual(marginMode, "cross")))
            {
    ...
    public async override Task<ccxt.OpenInterest> FetchOpenInterest(string symbol, object parameters = null)
    {
        ...
        if (isEqual((market.ContainsKey("option") ? market["option"] : null), true))
        {
    ...
    public async virtual Task<List<Dictionary<string, object>>> FetchSettlementHistory(object symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (!isEqual(limit, null))
        {
            if ((isEqual((market.ContainsKey("linear") ? market["linear"] : null), true)) && (isEqual((market.ContainsKey("swap") ? market["swap"] : null), true)))
            {
                ((IDictionary<string,object>)request)["limit"] = limit;
            } else
            {
    ...
    public async override Task<List<ccxt.Liquidation>> FetchLiquidations(string symbol, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        {
            throw new NotSupported ((string)(add((this.id + " fetchLiquidations() does not support "), (market.ContainsKey("type") ? market["type"] : null)) + " orders")) ;
        }
        //
        //     {
        //         "code": 200,
    ...
    public async override Task<Dictionary<string, object>> SetPositionMode(object hedged, string symbol = null, object parameters = null)
    {
        ...
        if (((market != null)) && (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true)))
        {
