...
public partial class bitvavo : Exchange
{
    ...
    public virtual Dictionary<string, object> createOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        if (isStopLoss)
        {
            ...
            ((IDictionary<string,object>)request)["orderType"] = ((bool) isMarketOrder) ? "stopLoss" : "stopLossLimit";
        } else if (isTakeProfit)
        {
            ...
            ((IDictionary<string,object>)request)["orderType"] = ((bool) isMarketOrder) ? "takeProfit" : "takeProfitLimit";
        }
    ...
    public async override Task<Dictionary<string, object>> CancelAllOrdersAfter(object timeout, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            ...
            { "expiryAfterSeconds", ((bool) (isGreaterThan(timeout, 0))) ? this.parseToInt(divide(timeout, 1000)) : 0 },
        };
