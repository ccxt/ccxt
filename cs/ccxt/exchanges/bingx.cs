...
public partial class bingx : Exchange
{
    ...
    public override Dictionary<string, object> parseMarket(object market)
    {
        ...
        if (swap)
        {
            contractSize = ((bool) (checkIsInverse)) ? inverseContractSize : this.parseNumber("1");
        }
        bool isActive = false;
        ...
        bool? isInverse = ((bool) (spot)) ? null : checkIsInverse;
        bool? isLinear = ((bool) (spot)) ? null : checkIsLinear;
    ...
    public async override Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        int maxLimit = ((bool) (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true))) ? 1000 : 1440;
        ...
        } else if ((isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true)) && (!isEqual(since, null)))
        {
    ...
    public override Dictionary<string, object> parseTrade(object trade, object market = null)
    {
        ...
        {
            takeOrMaker = ((bool) isMakerSide) ? "maker" : "taker";
        }
        ...
        if ((side == null))
        {
            if ((!isEqual(isBuyerMaker, null)) || (!isEqual(m, null)))
            {
                side = ((bool) isMakerSide) ? "sell" : "buy";
                takeOrMaker = "taker";
            }
        }
    ...
    public async override Task<List<ccxt.FundingHistory>> FetchFundingHistory(object symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        subType = ((IList<object>)subTypeparametersVariable)[0];
        parameters = ((IList<object>)subTypeparametersVariable)[1];
        bool isInverse = ((bool) ((market != null))) ? (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true)) : (isEqual(subType, "inverse"));
        if (isTrue(isInverse))
        {
    ...
    public override object parseOpenInterest(object interest, object market = null)
    {
        ...
        double? openInterestAmount = ((bool) isInverse) ? openInterest : null;
        double? openInterestValue = ((bool) isInverse) ? null : openInterest;
    ...
    public override Dictionary<string, object> parseTicker(object ticker, object market = null)
    {
        ...
        string type = ((bool) ((lastQty == null))) ? "spot" : "swap";
    ...
    public virtual Dictionary<string, object> createOrderRequest(object symbol, object type, object side, object amount, object price = null, object parameters = null)
    {
        ...
        if ((isEqual((market.ContainsKey("contract") ? market["contract"] : null), true)) && ((cost != null)))
        {
        ...
        string exchangeClientOrderId = ((bool) isSpot) ? "newClientOrderId" : "clientOrderID";
        ...
        if (isSpot)
        {
            ...
            {
                string? stopTakePrice = ((bool) ((stopLossPrice != null))) ? stopLossPrice : takeProfitPrice;
                if (isEqual(type, "LIMIT"))
                {
        ...
        } else
        {
            if (isTwapOrder)
            {
                Dictionary<string, object> twapRequest = new Dictionary<string, object>() {
                    ...
                    { "positionSide", ((bool) (isEqual(side, "buy"))) ? "LONG" : "SHORT" },
    ...
    public async override Task<ccxt.Order> CreateOrder(string symbol, string type, string side, double amount, double? price = null, object parameters = null)
    {
        ...
        if (isTrue(test) && ((!isEqual((market.ContainsKey("swap") ? market["swap"] : null), true)) || (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true))))
        {
    ...
    public override Dictionary<string, object> parseOrder(object order, object market = null)
    {
        ...
        if (((feeCurrencyCode == null)))
        {
            ...
            {
                feeCurrencyCode = ((bool) (isEqual(getValue(market, "inverse"), true))) ? getValue(market, "settle") : getValue(market, "quote");
            }
        }
    ...
    public async override Task<Dictionary<string, object>> CancelAllOrdersAfter(object timeout, object parameters = null)
    {
        ...
        Dictionary<string, object> request = new Dictionary<string, object>() {
            { "type", ((bool) (isActive)) ? "ACTIVATE" : "CLOSE" },
            { "timeOut", ((bool) (isActive)) ? (this.parseToInt(divide(timeout, 1000))) : 0 },
        };
        object response = null;
        string? type = null;
    ...
    public override object parseTransaction(object transaction, object currency = null)
    {
        ...
        string type = ((bool) ((rawType == "0"))) ? "deposit" : "withdrawal";
        return new Dictionary<string, object>() {
            { "info", transaction },
            { "id", id },
    ...
    public async override Task<List<ccxt.Trade>> FetchMyTrades(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        } else
        {
            ...
            if (!isEqual(since, null))
            {
                string startTimeReq = ((bool) (isEqual((market.ContainsKey("spot") ? market["spot"] : null), true))) ? "startTime" : "startTs";
            ...
            if (!isEqual(until, null))
            {
                string endTimeReq = ((bool) (isEqual((market.ContainsKey("spot") ? market["spot"] : null), true))) ? "endTime" : "endTs";
    ...
    public async override Task<object> closePosition(string symbol, string side = null, object parameters = null)
    {
        ...
        if ((positionId != null))
        {
            if ((!isEqual((market.ContainsKey("swap") ? market["swap"] : null), true)) || (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true)))
            {
    ...
    public async override Task<ccxt.PositionModeInfo> FetchPositionMode(string symbol = null, object parameters = null)
    {
        ...
        subType = ((IList<object>)subTypeparametersVariable)[0];
        parameters = ((IList<object>)subTypeparametersVariable)[1];
        if ((isEqual(subType, "inverse")) || (((market != null)) && (isEqual((market.ContainsKey("inverse") ? market["inverse"] : null), true))))
        {
    ...
    public virtual object parseTradingFee(object fee, object market = null)
    {
        ...
        //     }
        //
        object symbol = ((bool) (!isEqual(market, null))) ? getValue(market, "symbol") : null;
        return new Dictionary<string, object>() {
            { "info", fee },
            { "symbol", symbol },
    ...
    public override object sign(object path, object section = null, object method = null, object parameters = null, object headers = null, object body = null)
    {
        ...
        } else if (isEqual(access, "private"))
        {
            ...
            object encodeRequestSafe = ((bool) ((encodeRequest == null))) ? "" : encodeRequest;
