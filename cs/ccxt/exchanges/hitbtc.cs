...
public partial class hitbtc : Exchange
{
    ...
    public virtual object createOrderRequest(IDictionary<string, object> market, object marketType, object type, object side, object amount, object price = null, object marginMode = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
    ...
    public async override Task<ccxt.TransferEntry> Transfer(string code, double amount, string fromAccount, string toAccount, object parameters = null)
    {
        ...
        fromAccountVar = fromAccountVar.ToLower();
        toAccountVar = toAccountVar.ToLower();
    ...
    public async override Task<List<ccxt.FundingRateHistory>> FetchFundingRateHistory(string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        for (int i = 0; isLessThan(i, contracts.Count); postFixIncrement(ref i))
        {
            ...
            for (int j = 0; isLessThan(j, fundingRateData.Count); postFixIncrement(ref j))
            {
