...
public partial class zebpay : Exchange
{
    ...
    public override Dictionary<string, object> parseCurrency(object rawCurrency)
    {
        ...
        for (int j = 0; j < chains.Count; postFixIncrement(ref j))
        {
            ...
            deposit = ((bool) (depositAllowed)) ? depositAllowed : deposit;
            bool withdrawAllowed = (this.safeBool(chain, "isWithdrawEnabled") == true);
            withdraw = ((bool) (withdrawAllowed)) ? withdrawAllowed : withdraw;
            string? withdrawFeeString = this.safeString(chain, "withdrawalFee");
            if ((withdrawFeeString != null))
            {
                minWithdrawFeeString = ((bool) ((minWithdrawFeeString == null))) ? withdrawFeeString : Precise.stringMin(withdrawFeeString, minWithdrawFeeString);
            }
            string? minNetworkWithdrawString = this.safeString(chain, "withdrawalMinSize");
            if ((minNetworkWithdrawString != null))
            {
                minWithdrawString = ((bool) ((minWithdrawString == null))) ? minNetworkWithdrawString : Precise.stringMin(minNetworkWithdrawString, minWithdrawString);
            }
            string? minNetworkDepositString = this.safeString(chain, "depositMinSize");
            if ((minNetworkDepositString != null))
            {
                minDepositString = ((bool) ((minDepositString == null))) ? minNetworkDepositString : Precise.stringMin(minNetworkDepositString, minDepositString);
            }
            if ((networkCode != null))
            {
    ...
    public async override Task<ccxt.Tickers> FetchTickers(object symbols = null, object parameters = null)
    {
        ...
        if (!isEqual(type, "spot"))
        {
            throw new NotSupported ((string)(add((this.id + " fetchTickers() does not support "), type) + " markets")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
    ...
    public async override Task<List<ccxt.Trade>> FetchOrderTrades(string id, string symbol = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        if (!isEqual(type, "spot"))
        {
            throw new NotSupported ((string)(add((this.id + " fetchOrderTrades() does not support "), type) + " markets")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
    ...
    public async override Task<List<ccxt.Order>> CancelAllOrders(string symbol = null, object parameters = null)
    {
        ...
        if (!isEqual(type, "spot"))
        {
            throw new NotSupported ((string)(add((this.id + " cancelAllOrders() does not support "), type) + " markets")) ;
        }
        if (isEqual(this.markets, null))
        {
            await this.loadMarkets();
