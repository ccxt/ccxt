...
public partial class BaseExchange
{
    ...
    public virtual List<object> arraysConcat(object arraysOfArrays)
    {
        ...
        for (int i = 0; i < getArrayLength(arraysOfArrays); postFixIncrement(ref i))
        {
    ...
    {
        bool proxyAgentIsSet = (!isEqual(proxyAgentSet, null)) && (!isEqual(proxyAgentSet, null)) && (!isEqual(proxyAgentSet, ""));
        bool proxyUrlIsSet = (!isEqual(proxyUrlSet, null)) && (!isEqual(proxyUrlSet, null)) && (!isEqual(proxyUrlSet, ""));
    ...
    public virtual IList<object> filterBySinceLimit(object array, object since = null, object limit = null, object key = null, object tail = null)
    {
        ...
        if (sinceIsDefined)
        {
            ...
            for (int i = 0; isLessThan(i, getArrayLength(parsedArray)); postFixIncrement(ref i))
            {
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "watchLiquidationsForSymbols"), null) && ((getValue(this.has, "watchLiquidationsForSymbols") as bool?) != false))
        {
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "watchMyLiquidationsForSymbols"), null) && ((getValue(this.has, "watchMyLiquidationsForSymbols") as bool?) != false))
        {
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchMarginModes"), null) && ((getValue(this.has, "fetchMarginModes") as bool?) != false))
        {
    ...
    public virtual Dictionary<string, object> parseCurrencies(object rawCurrencies)
    {
        ...
        {
            Dictionary<string, object> parsed = this.parseCurrency(getValue(arr, i));
            if ((parsed == null))
            {
                continue;
            }
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchLeverages"), null) && ((getValue(this.has, "fetchLeverages") as bool?) != false))
        {
    ...
    {
        if (isEqual(this.rateLimit, null) || (!isEqual(this.id, null) && isEqual(this.rateLimit, -1)))
        {
        ...
        Dictionary<string, object> existingBucket = ((bool) (isEqual(this.tokenBucket, null))) ? new Dictionary<string, object>() {} : this.tokenBucket;
    ...
    public virtual void featuresGenerator()
    {
        ...
        for (int i = 0; i < getArrayLength(unifiedMarketTypes); postFixIncrement(ref i))
        {
            string? marketType = ((string)getValue(unifiedMarketTypes, i));
    ...
    {
        object featuresObj = ((bool) (!isEqual(subType, null))) ? getValue(getValue(initialFeatures, ((string)marketType)), subType) : getValue(initialFeatures, ((string)marketType));
    ...
    public virtual object featureValueByType(object marketType, object subType, object methodName = null, object paramName = null, object defaultValue = null)
    {
        ...
        if (isEqual(methodName, null))
        {
            return ((bool) (!isEqual(defaultValue, null))) ? defaultValue : methodsContainer;
        }
    ...
    public virtual object setMarkets(object markets, object currencies = null)
    {
        ...
        for (int i = 0; i < getArrayLength(marketValues); postFixIncrement(ref i))
        {
            ...
            for (int j = 0; j < valueKeys.Count; postFixIncrement(ref j))
            {
                string? valueKey = ((string)getValue(valueKeys, j));
        ...
        } else
        {
            ...
            for (int i = 0; i < getArrayLength(values); postFixIncrement(ref i))
            {
            ...
            for (int i = 0; i < codes.Count; postFixIncrement(ref i))
            {
                ...
                for (int j = 1; j < getArrayLength(groupedCurrenciesCode); postFixIncrement(ref j))
                {
    ...
    public virtual BaseExchange setMarketsFromExchange(BaseExchange sourceExchange)
    {
        ...
        for (int i = 0; i < getArrayLength(sourceExchangeHelpers); postFixIncrement(ref i))
        {
    ...
    public virtual Dictionary<string, object> safeOrder(object order, object market = null)
    {
        ...
        if (shouldParseFees)
        {
            ...
            for (int i = 0; i < reducedLength; postFixIncrement(ref i))
            {
        ...
        for (int i = 0; i < getArrayLength(trades); postFixIncrement(ref i))
        {
            ...
            for (int j = 0; j < getArrayLength(entryFees); postFixIncrement(ref j))
            {
    ...
    public async virtual Task<List<ccxt.OHLCV>> FetchOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        parameters ??= new Dictionary<string, object>();
        string message = "";
        if (!isEqual(getValue(this.has, "fetchTrades"), null) && ((getValue(this.has, "fetchTrades") as bool?) != false))
        {
    ...
    public async virtual Task<List<ccxt.OHLCV>> FetchOHLCVWs(string symbol, string timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        parameters ??= new Dictionary<string, object>();
        string message = "";
        if (!isEqual(getValue(this.has, "fetchTradesWs"), null) && ((getValue(this.has, "fetchTradesWs") as bool?) != false))
        {
            message = ". If you want to build OHLCV candles from trade executions data, visit https://github.com/ccxt/ccxt/tree/master/examples/ and see \"build-ohlcv-bars\" file";
        }
    ...
    public virtual List<object> convertTradingViewToOHLCV(object ohlcvs, object timestamp = null, object open = null, object high = null, object low = null, object close = null, object volume = null, object ms = null)
    {
        ...
        for (int i = 0; i < getArrayLength(timestamps); postFixIncrement(ref i))
        {
    ...
    public virtual IList<object> filterByKey(object objects, object key, object value = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; isLessThan(i, getArrayLength(objects)); postFixIncrement(ref i))
        {
    ...
    public virtual object prioritizedNetworkAliases(object networkCode = null, object currencyCode = null, object allowDefault = null)
    {
        ...
        */
        ...
        for (int i = 0; i < keys.Count; postFixIncrement(ref i))
        {
            ...
            } else if (!isEqual(currencyCode, null))
            {
    ...
    public virtual object networkCodeToId(object networkCode, object currencyCode = null)
    {
        ...
        for (int i = 0; i < getArrayLength(currenciesToCheck); postFixIncrement(ref i))
        {
    ...
    public virtual object parseLeverageTiers(object response, object symbols = null, object marketIdKey = null)
    {
        ...
        bool noSymbols = (isEqual(symbols, null)) || (isEqual(symbolsLength, 0));
    ...
    public async virtual Task<object> loadTradingLimits(object symbols = null, object reload = null, object parameters = null)
    {
        reload ??= false;
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchTradingLimits"), null) && ((getValue(this.has, "fetchTradingLimits") as bool?) != false))
        {
    ...
    public virtual object parsePositions(object positions, object symbols = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(positionsArray); postFixIncrement(ref i))
        {
    ...
    public virtual object parseADLRanks(object ranks, object symbols = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(ranksArray); postFixIncrement(ref i))
        {
    ...
    public virtual List<object> parseAccounts(object accounts, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(accountsArray); postFixIncrement(ref i))
        {
    ...
    public virtual IList<object> parseTransactions(object transactions, object currency = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(transactionsArray); postFixIncrement(ref i))
        {
        ...
        object code = ((bool) (!isEqual(currency, null))) ? getValue(currency, "code") : null;
    ...
    public virtual object parseTransfers(object transfers, object currency = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(transfersArray); postFixIncrement(ref i))
        {
    ...
    public virtual IList<object> parseLedger(object data, object currency = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(arrayData); postFixIncrement(ref i))
        {
            ...
            {
                for (int j = 0; j < getArrayLength(itemOrItems); postFixIncrement(ref j))
                {
    ...
    public virtual object filterByArray(object objects, object key, object values = null, object indexed = null)
    {
        ...
        if ((isEqual(values, null)) || (isEqual(values, null)) || (isEqual(values, false)) || (isEqual(values, 0)) || (isEqual(values, "")))
        {
    ...
    public virtual Dictionary<string, object> safeCurrency(object currencyId, object currency = null)
    {
        ...
        if ((!isEqual(currencyId, null)) && (!isEqual(this.currencies_by_id, null)) && (inOp(this.currencies_by_id, currencyId)) && (!isEqual(getValue(this.currencies_by_id, currencyId), null)))
        {
    ...
    public virtual Dictionary<string, object> safeMarket(object marketId = null, object market = null, object delimiter = null, object marketType = null)
    {
        if (!isEqual(marketId, null))
        {
            ...
            } else if (!isEqual(delimiter, null) && !isEqual(delimiter, ""))
            {
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (isEqual(getValue(this.has, "fetchTransactionFees"), null) || ((getValue(this.has, "fetchTransactionFees") as bool?) == false))
        {
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (isEqual(getValue(this.has, "fetchDepositWithdrawFees"), null) || ((getValue(this.has, "fetchDepositWithdrawFees") as bool?) == false))
        {
    ...
    public async virtual Task<ccxt.CrossBorrowRate> FetchCrossBorrowRate(string code, object parameters = null)
    {
        ...
        if (isEqual(getValue(this.has, "fetchBorrowRates"), null) || ((getValue(this.has, "fetchBorrowRates") as bool?) == false))
        {
    ...
    public async virtual Task<ccxt.ADL> FetchPositionADLRank(string symbol, object parameters = null)
    {
        ...
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchPositionsADLRank"), null) && ((getValue(this.has, "fetchPositionsADLRank") as bool?) != false))
        {
            await this.loadMarkets();
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchDepositAddresses"), null) && ((getValue(this.has, "fetchDepositAddresses") as bool?) != false))
        {
        ...
        } else if (!isEqual(getValue(this.has, "fetchDepositAddressesByNetwork"), null) && ((getValue(this.has, "fetchDepositAddressesByNetwork") as bool?) != false))
        {
    ...
    public virtual object mergeBalanceAccount(object result, string code, object account)
    {
        ...
        {
            string? field = ((string)getValue(fields, i));
    ...
    public virtual bool isLeveragedCurrency(object currencyCode, object checkBaseCoin = null, object existingCurrencies = null)
    {
        ...
        for (int i = 0; i < getArrayLength(leverageSuffixes); postFixIncrement(ref i))
        {
    ...
    public virtual string? parsePrecision(object precision)
    {
        ...
        if (isGreaterThan(precisionNumber, 0))
        {
            ...
            for (int i = 0; isLessThan(i, subtract(precisionNumber, 1)); postFixIncrement(ref i))
            {
        ...
        } else
        {
            ...
            for (int i = 0; isLessThan(i, subtract(multiply(precisionNumber, -1), 1)); postFixIncrement(ref i))
            {
                parsedPrecision = (parsedPrecision + "0");
            }
    ...
    {
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchLeverageTiers"), null) && ((getValue(this.has, "fetchLeverageTiers") as bool?) != false))
        {
            Dictionary<string, object> market = this.market(symbol);
    ...
    public virtual object parseLastPrices(object pricesData, object symbols = null, object parameters = null)
    {
        ...
        {
            for (int i = 0; i < getArrayLength(pricesData); postFixIncrement(ref i))
            {
    ...
    public virtual List<object> handleTriggerDirectionAndParams(object parameters, object exchangeSpecificKey = null, object allowEmpty = null)
    {
        ...
        */
        ...
        bool exchangeSpecificDefined = (!isEqual(exchangeSpecificKey, null)) && (inOp(parameters, exchangeSpecificKey));
    ...
    public async virtual Task<ccxt.FundingRate> FetchFundingRate(string symbol, object parameters = null)
    {
        object symbolVar = symbol;
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchFundingRates"), null) && ((getValue(this.has, "fetchFundingRates") as bool?) != false))
        {
            await this.loadMarkets();
            Dictionary<string, object> market = this.market(symbolVar);
            symbolVar = getValue(market, "symbol");
    ...
    public async virtual Task<ccxt.FundingRate> FetchFundingInterval(string symbol, object parameters = null)
    {
        object symbolVar = symbol;
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchFundingIntervals"), null) && ((getValue(this.has, "fetchFundingIntervals") as bool?) != false))
        {
            await this.loadMarkets();
            Dictionary<string, object> market = this.market(symbolVar);
            symbolVar = getValue(market, "symbol");
    ...
    public async virtual Task<List<ccxt.OHLCV>> FetchMarkOHLCV(string symbol, string timeframe = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        */
        timeframeVar ??= "1m";
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchMarkOHLCV"), null) && ((getValue(this.has, "fetchMarkOHLCV") as bool?) != false))
        {
    ...
    public async virtual Task<List<ccxt.OHLCV>> FetchIndexOHLCV(string symbol, string timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        timeframeVar ??= "1m";
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchIndexOHLCV"), null) && ((getValue(this.has, "fetchIndexOHLCV") as bool?) != false))
        {
            Dictionary<string, object> request = new Dictionary<string, object>() {
                { "price", "index" },
            };
    ...
    public async virtual Task<List<ccxt.OHLCV>> FetchPremiumIndexOHLCV(string symbol, string timeframe = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        */
        timeframeVar ??= "1m";
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchPremiumIndexOHLCV"), null) && ((getValue(this.has, "fetchPremiumIndexOHLCV") as bool?) != false))
        {
            Dictionary<string, object> request = new Dictionary<string, object>() {
                { "price", "premiumIndex" },
            };
    ...
    public virtual Dictionary<string, object> parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        for (int i = 0; isLessThan(i, getArrayLength(responseKeys)); postFixIncrement(ref i))
        {
            ...
            if (isArray)
            {
                currencyId = ((bool) (isEqual(currencyIdKey, null))) ? null : this.safeString(dictionary, currencyIdKey);
            }
    ...
    public virtual object parseIncomes(object incomes, object market = null, object since = null, object limit = null)
    {
         ...
         */
        List<object> result = new List<object>() {};
        for (int i = 0; isLessThan(i, getArrayLength(incomes)); postFixIncrement(ref i))
        {
    ...
    public async virtual Task<List<ccxt.Transaction>> FetchTransactions(string code = null, Int64? since = null, Int64? limit = null, object parameters = null)
    {
        ...
        */
        parameters ??= new Dictionary<string, object>();
        if (!isEqual(getValue(this.has, "fetchDepositsWithdrawals"), null) && ((getValue(this.has, "fetchDepositsWithdrawals") as bool?) != false))
        {
    ...
    public async virtual Task<object> safeDeterministicCall(object method, object symbol = null, object since = null, object limit = null, string timeframe = null, object parameters = null)
    {
        ...
        while (isLessThanOrEqual(errors, maxRetries))
        {
            try
            {
                if ((!isEqual(timeframe, null) && !isEqual(timeframe, "")) && !isEqual(method, "fetchFundingRateHistory"))
                {
        ...
        while (isLessThan(i, maxCalls))
        {
            try
            {
                ...
                for (object j = 0; isLessThan(j, responseLength); postFixIncrement(ref j))
                {
                    ...
                    object cursor = ((bool) (isEqual(cursorReceived, null))) ? null : this.safeValue(info, cursorReceived);
                    if ((cursor != null))
                    {
                        cursorValue = cursor;
                        break;
    ...
    public virtual IList<object> parseLiquidations(object liquidations, object market = null, object since = null, object limit = null)
    {
         ...
         */
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(liquidations); postFixIncrement(ref i))
        {
    ...
    public virtual object parseAllGreeks(object greeks, object symbols = null, object parameters = null)
    {
        ...
        {
            for (int i = 0; i < getArrayLength(greeks); postFixIncrement(ref i))
            {
    ...
    public virtual Dictionary<string, object> parseOptionChain(object response, object currencyKey = null, object symbolKey = null)
    {
        ...
        for (int i = 0; i < getArrayLength(response); postFixIncrement(ref i))
        {
            ...
            string? currencyId = ((bool) (isEqual(currencyKey, null))) ? null : this.safeString(info, currencyKey);
            Dictionary<string, object> currency = this.safeCurrency(currencyId);
    ...
    public virtual object parseConversions(object conversions, string code = null, object fromCurrencyKey = null, object toCurrencyKey = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        for (int i = 0; i < getArrayLength(conversionsArray); postFixIncrement(ref i))
        {
            object entry = getValue(conversionsArray, i);
            string? fromId = ((bool) (isEqual(fromCurrencyKey, null))) ? null : this.safeString(entry, fromCurrencyKey);
            string? toId = ((bool) (isEqual(toCurrencyKey, null))) ? null : this.safeString(entry, toCurrencyKey);
            if ((fromId != null))
            {
    ...
    public virtual void cleanUnsubscription(WebSocketClient client, object subHash, object unsubHash, object subHashIsPrefix = null)
    {
        ...
        if ((!isEqual(unsubHash, null)) && (inOp(client.subscriptions, unsubHash)))
        {
            ((IDictionary<string,object>)client.subscriptions).Remove((string)unsubHash);
        }
        if (!isTrue(subHashIsPrefix))
        {
            if ((!isEqual(subHash, null)) && (inOp(client.subscriptions, subHash)))
            {
        ...
        } else
        {
            ...
            for (int i = 0; i < clientSubscriptions.Count; postFixIncrement(ref i))
            {
            ...
            for (int i = 0; i < clientFutures.Count; postFixIncrement(ref i))
            {
    ...
    public virtual void cleanCache(object subscription)
    {
        ...
        if ((topic == "ohlcv"))
        {
            ...
            for (int i = 0; i < getArrayLength(symbolsAndTimeframes); postFixIncrement(ref i))
            {
                ...
                if ((!isEqual(this.ohlcvs, null)) && (((IDictionary<string, object>)this.ohlcvs).ContainsKey(symbol)))
                {
        ...
        {
            if ((topic == "myTrades") && (!isEqual(this.myTrades, null)))
            {
                this.myTrades = null;
            } else if ((topic == "orders") && (!isEqual(this.orders, null)))
            {
                this.orders = null;
            } else if ((topic == "positions") && (!isEqual(this.positions, null)))
            {
                this.positions = null;
            ...
            } else if ((topic == "bidsasks") && (!isEqual(this.bidsasks, null)))
            {
                ...
                for (int i = 0; i < bidsaskSymbols.Count; postFixIncrement(ref i))
                {
