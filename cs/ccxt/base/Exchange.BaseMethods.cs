...
public partial class BaseExchange
{
    ...
    public virtual IList<object> filterBySinceLimit(object array, object since = null, object limit = null, object key = null, object tail = null)
    {
        ...
        if (sinceIsDefined)
        {
            ...
            for (int i = 0; i < getArrayLength(parsedArray); postFixIncrement(ref i))
            {
            ...
            if (isArray && (tradesLength > 0))
            {
                ...
                for (int i = 0; i < getArrayLength(trades); postFixIncrement(ref i))
                {
                    ...
                    if (shouldParseFees)
                    {
                        ...
                        if ((tradeFees != null))
                        {
                            for (int j = 0; j < getArrayLength(tradeFees); postFixIncrement(ref j))
                            {
    ...
    public virtual IList<object> filterByKey(object objects, object key, object value = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(objects); postFixIncrement(ref i))
        {
    ...
    public virtual List<object> getListFromObjectValues(object objects, object key)
    {
        ...
        List<object> results = new List<object>() {};
        for (int i = 0; i < getArrayLength(newArray); postFixIncrement(ref i))
        {
    ...
    public virtual Dictionary<string, object> parseDepositWithdrawFees(object response, object codes = null, object currencyIdKey = null)
    {
        ...
        for (int i = 0; i < getArrayLength(responseKeys); postFixIncrement(ref i))
        {
    ...
    public virtual object parseIncomes(object incomes, object market = null, object since = null, object limit = null)
    {
         ...
         */
        List<object> result = new List<object>() {};
        for (int i = 0; i < getArrayLength(incomes); postFixIncrement(ref i))
        {
