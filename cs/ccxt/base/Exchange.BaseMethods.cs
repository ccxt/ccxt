...
public partial class Exchange
{
    ...
    public virtual void setupStream()
    {
        /**
         * @ignore
         * @method
         ...
         */
        ccxt.pro.Stream stream = this.stream;
        if (isTrue(isEqual(this.stream, null)))
        {
            throw new ExchangeError ((string)"Stream is not initialized") ;
        }
        if (isTrue(this.isStreamingEnabled()))
        {
            return;
        }
        ((IDictionary<string,object>)this.options)["enableStreaming"] = true;
        ...
        object options = this.safeDict(this.options, "streaming", new Dictionary<string, object>() {});
        object reconnect = this.safeBool(options, "autoreconnect", true);
        if (isTrue(reconnect))
        {
    ...
    public virtual void streamProduce(object topic, object payload = null, object error = null)
    {
        /**
         * @ignore
         * @method
    ...
    public async virtual Task<object> streamReconnect()
    {
        /**
         * @ignore
         * @method
        ...
        ccxt.pro.Stream stream = this.stream;
        object activeFunctions = stream.activeWatchFunctions;
        object tasks = new List<object>() {};
        for (object i = 0; isLessThan(i, getArrayLength(activeFunctions)); postFixIncrement(ref i))
        {
            object activeFunction = getValue(activeFunctions, i);
            object method = this.safeString(activeFunction, "method");
            object args = this.safeList(activeFunction, "args");
            object future = this.spawn(getValue(this, method), new object[] {args});
            ((IList<object>)tasks).Add(future);
        }
    ...
    public async virtual Task<object> subscribeLiquidations(object symbol, object callback, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        ccxt.pro.Stream stream = this.stream;
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe(add("liquidations::", symbol), callback, parameters);
        }
        stream.addWatchFunction("liquidations", new List<object>() {symbol, null, null, parameters});
        return await this.watchLiquidations(symbol, null, null, parameters);
    }

    public virtual object unsubscribeLiquidations(object symbol, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeLiquidationsForSymbols(object symbols, object callback, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            ...
            {
                stream.subscribe(add("liquidations::", getValue(symbols, i)), callback, parameters);
            }
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("liquidations", callback, parameters);
            }
        }
        stream.addWatchFunction("watchLiquidationsForSymbols", new List<object>() {symbols, null, null, parameters});
        return await this.watchLiquidationsForSymbols(symbols, null, null, parameters);
    }

    public virtual object unsubscribeLiquidationsForSymbols(object symbols, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeTrades(object symbol, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe(add("trades::", symbol), callback, parameters);
        }
        stream.addWatchFunction("watchTrades", new List<object>() {symbol, null, null, parameters});
        return await this.watchTrades(symbol, null, null, parameters);
    }

    public virtual object unsubscribeTrades(object symbol, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeTradesForSymbols(object symbols, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
            {
                stream.subscribe(add("trades::", getValue(symbols, i)), callback, parameters);
            }
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("trades", callback, parameters);
            }
        }
        stream.addWatchFunction("watchTradesForSymbols", new List<object>() {symbols, null, null, parameters});
        return await this.watchTradesForSymbols(symbols, null, null, parameters);
    }

    public virtual object unsubscribeTradesForSymbols(object symbols, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeMyTradesForSymbols(object symbols, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("myTrades", callback, parameters);
            } else
            {
                for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
                {
                    stream.subscribe(add("myTrades::", getValue(symbols, i)), callback, parameters);
                }
            }
        }
        stream.addWatchFunction("watchMyTradesForSymbols", new List<object>() {symbols, null, null, parameters});
        return await this.watchMyTradesForSymbols(symbols, null, null, parameters);
    }

    public virtual object unsubscribeMyTradesForSymbols(object symbols, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeOrdersForSymbols(object symbols, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
            {
                stream.subscribe(add("orders::", getValue(symbols, i)), callback, parameters);
            }
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("orders", callback, parameters);
            }
        }
        stream.addWatchFunction("watchOrdersForSymbols", new List<object>() {symbols, null, null, parameters});
        return await this.watchOrdersForSymbols(symbols, null, null, parameters);
    }

    public virtual object unsubscribeOrdersForSymbols(object symbols, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeOHLCVForSymbols(object symbolsAndTimeframes, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            ...
            {
                object symbol = this.symbol(getValue(getValue(symbolsAndTimeframes, i), 0));
                object timeframe = getValue(getValue(symbolsAndTimeframes, i), 1);
                stream.subscribe(add(add(add(add("ohlcvs", "::"), symbol), "::"), timeframe), callback, parameters);
            }
            if (isTrue(this.isEmpty(symbolsAndTimeframes)))
            {
                stream.subscribe("ohlcvs", callback, parameters);
            }
        }
        stream.addWatchFunction("watchOHLCVForSymbols", new List<object>() {symbolsAndTimeframes, null, null, parameters});
        return await this.watchOHLCVForSymbols(symbolsAndTimeframes, null, null, parameters);
    }

    public virtual object unsubscribeOHLCVForSymbols(object symbolsAndTimeframes, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeOrderBookForSymbols(object symbols, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
            {
                stream.subscribe(add("orderbooks::", getValue(symbols, i)), callback, parameters);
            }
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("orderbooks", callback, parameters);
            }
        }
        stream.addWatchFunction("watchOrderBookForSymbols", new List<object>() {symbols, null, parameters});
        return await this.watchOrderBookForSymbols(symbols, null, parameters);
    }

    public virtual object unsubscribeOrderBookForSymbols(object symbols, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeOrderBook(object symbol, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        return await this.subscribeOrderBookForSymbols(new List<object>() {symbol}, callback, parameters);
    }

    public virtual object unsubscribeOrderBook(object symbol, object callback)
    {
        /**
         * @method
         ...
         * @returns {boolean} true if the consumer was successfully unsubscribed, false otherwise
         */
        return this.unsubscribeOrderBookForSymbols(new List<object>() {symbol}, callback);
    }
    ...
    public virtual object isStreamingEnabled()
    {
    ...
    public async virtual Task<object> subscribeOHLCV(object symbol, object timeframe = null, object callback = null, object parameters = null)
    {
        /**
        * @method
        * @name subscribeOHLCV
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe(add(add(add("ohlcvs::", symbol), "::"), timeframe), callback, parameters);
        }
        stream.addWatchFunction("watchOHLCV", new List<object>() {symbol, timeframe, null, null, parameters});
        return await this.watchOHLCV(symbol, timeframe, null, null, parameters);
    }

    public virtual object unsubscribeOHLCV(object symbol, object callback, object timeframe = null)
    {
        /**
        * @method
    ...
    public async virtual Task<object> subscribePosition(object symbol, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe(add("positions::", symbol), callback, parameters);
        }
        stream.addWatchFunction("watchPosition", new List<object>() {symbol, null, parameters});
        return await this.watchPosition(symbol, parameters);
    }

    public virtual object unsubscribePosition(object symbol, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribePositions(object symbols = null, object callback = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        if (!isTrue(this.isStreamingEnabled()))
        {
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("positions", callback, parameters);
            } else
            {
                for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
                {
                    stream.subscribe(add("positions::", getValue(symbols, i)), callback, parameters);
                }
            }
        }
        stream.addWatchFunction("watchPositions", new List<object>() {symbols, null, null, parameters});
        return await this.watchPositions(symbols, null, null, parameters);
    }

    public virtual object unsubscribePositions(object callback, object symbols = null)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribePositionForSymbols(object symbols = null, object callback = null, object parameters = null)
    {
        parameters ??= new Dictionary<string, object>();
        return await this.subscribePositions(symbols, callback, parameters);
    }

    public virtual object unsubscribePositionForSymbols(object callback, object symbols = null)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeBalance(object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe("balances", callback, parameters);
        }
        stream.addWatchFunction("watchBalance", new List<object>() {parameters});
        return await this.watchBalance(parameters);
    }

    public virtual object unsubscribeBalance(object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeTicker(object symbol, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe(add("tickers::", symbol), callback, parameters);
        }
        stream.addWatchFunction("watchTicker", new List<object>() {symbol, parameters});
        return await this.watchTicker(symbol, parameters);
    }

    public virtual object unsubscribeTicker(object symbol, object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeTickers(object symbols = null, object callback = null, object parameters = null)
    {
        /**
        * @method
        * @name subscribeTicker
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            if (isTrue(this.isEmpty(symbols)))
            {
                stream.subscribe("tickers", callback, parameters);
            } else
            {
                for (object i = 0; isLessThan(i, getArrayLength(symbols)); postFixIncrement(ref i))
                {
                    stream.subscribe(add("tickers::", getValue(symbols, i)), callback, parameters);
                }
            }
        }
        stream.addWatchFunction("watchTickers", new List<object>() {symbols, parameters});
        return await this.watchTickers(symbols, parameters);
    }

    public virtual object unsubscribeTickers(object callback, object symbols = null)
    {
        /**
         * @method
    ...
    public virtual void subscribeRaw(object callback, object parameters = null)
    {
        /**
        * @method
        * @name subscribeRaw
        ...
        */
        ...
        ccxt.pro.Stream stream = this.stream;
        stream.subscribe("raw", callback, parameters);
    }

    public virtual object unsubscribeRaw(object callback)
    {
        /**
         * @method
    ...
    public virtual void subscribeErrors(object callback, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        ccxt.pro.Stream stream = this.stream;
        stream.subscribe("errors", callback, parameters);
    }

    public virtual object unsubscribeErrors(object callback)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeOrders(object symbol = null, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            ...
            {
                stream.subscribe(add("orders::", symbol), callback, parameters);
            }
        }
        stream.addWatchFunction("watchOrders", new List<object>() {symbol, null, null, parameters});
        return await this.watchOrders(symbol, null, null, parameters);
    }

    public virtual object unsubscribeOrders(object callback, object symbol = null)
    {
        /**
         * @method
    ...
    public async virtual Task<object> subscribeMyTrades(object symbol = null, object callback = null, object parameters = null)
    {
        /**
        * @method
        ...
        */
        ...
        if (isTrue(!isEqual(callback, null)))
        {
            stream.subscribe(add("myTrades::", symbol), callback, parameters);
        }
        stream.addWatchFunction("watchMyTrades", new List<object>() {symbol, null, null, parameters});
        return await this.watchMyTrades(symbol, null, null, parameters);
    }

    public virtual object unsubscribeMyTrades(object callback, object symbol = null)
    {
        /**
         * @method
    ...
    public virtual object createStreamOHLCV(object symbol, object timeframe, object data)
    {
        return new Dictionary<string, object>() {
            { "symbol", symbol },
            { "timeframe", timeframe },
