...
public partial class BaseExchange
{
    ...
    public virtual void featuresGenerator()
    {
        ...
        for (int i = 0; i < (unifiedMarketTypes?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual object setMarkets(object markets, object currencies = null)
    {
        ...
        } else
        {
            ...
            for (int i = 0; i < (values?.Count ?? 0); postFixIncrement(ref i))
            {
            ...
            for (int i = 0; i < codes.Count; postFixIncrement(ref i))
            {
                ...
                for (int j = 1; j < (groupedCurrenciesCode?.Count ?? 0); postFixIncrement(ref j))
                {
    ...
    public virtual BaseExchange setMarketsFromExchange(BaseExchange sourceExchange)
    {
        ...
        for (int i = 0; i < (sourceExchangeHelpers?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual Dictionary<string, object> safeOrder(object order, object market = null)
    {
        ...
        for (int i = 0; i < getArrayLength(trades); postFixIncrement(ref i))
        {
            ...
            for (int j = 0; j < (entryFees?.Count ?? 0); postFixIncrement(ref j))
            {
    ...
    public virtual List<object> convertTradingViewToOHLCV(object ohlcvs, object timestamp = null, object open = null, object high = null, object low = null, object close = null, object volume = null, object ms = null)
    {
        ...
        for (int i = 0; i < (timestamps?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual object networkCodeToId(object networkCode, object currencyCode = null)
    {
        ...
        for (int i = 0; i < (currenciesToCheck?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual object parsePositions(object positions, object symbols = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < (positionsArray?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual object parseADLRanks(object ranks, object symbols = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < (ranksArray?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual List<object> parseAccounts(object accounts, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < (accountsArray?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual IList<object> parseTransactions(object transactions, object currency = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < (transactionsArray?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual object parseTransfers(object transfers, object currency = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        List<object> result = new List<object>() {};
        for (int i = 0; i < (transfersArray?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual IList<object> parseLedger(object data, object currency = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        for (int i = 0; i < (arrayData?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual bool isLeveragedCurrency(object currencyCode, object checkBaseCoin = null, object existingCurrencies = null)
    {
        ...
        for (int i = 0; i < (leverageSuffixes?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual object parseConversions(object conversions, string code = null, object fromCurrencyKey = null, object toCurrencyKey = null, object since = null, object limit = null, object parameters = null)
    {
        ...
        for (int i = 0; i < (conversionsArray?.Count ?? 0); postFixIncrement(ref i))
        {
    ...
    public virtual void cleanCache(object subscription)
    {
        ...
        if ((topic == "ohlcv"))
        {
            ...
            for (int i = 0; i < (symbolsAndTimeframes?.Count ?? 0); postFixIncrement(ref i))
            {
