...
{
    public sealed partial class Ticker24hMiniResponse
    {
        public const ushort BlockLength = (ushort)0;
        public const ushort TemplateId = (ushort)208;
        ...
        private readonly Ticker24hMiniResponse _parentMessage;
        ...
        public Ticker24hMiniResponse()
        {
            _parentMessage = this;
        }

        public Ticker24hMiniResponse WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public Ticker24hMiniResponse WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public Ticker24hMiniResponse WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public Ticker24hMiniResponse WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public sealed partial class TickersGroup
        {
            ...
            private Ticker24hMiniResponse _parentMessage;
            private DirectBuffer _buffer;
            ...
            public void WrapForDecode(Ticker24hMiniResponse parentMessage, DirectBuffer buffer, int actingVersion)
            {
            ...
            public void WrapForEncode(Ticker24hMiniResponse parentMessage, DirectBuffer buffer, int count)
            {
            ...
            public const int SbeBlockLength = 106;
        ...
        public override string ToString()
        {
            ...
            var m = new Ticker24hMiniResponse();
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append(Ticker24hMiniResponse.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(Ticker24hMiniResponse.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != Ticker24hMiniResponse.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(Ticker24hMiniResponse.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != Ticker24hMiniResponse.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(Ticker24hMiniResponse.BlockLength);
            builder.Append("):");
