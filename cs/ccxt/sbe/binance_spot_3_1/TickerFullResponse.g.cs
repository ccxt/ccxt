...
{
    public sealed partial class TickerFullResponse
    {
        public const ushort BlockLength = (ushort)0;
        public const ushort TemplateId = (ushort)214;
        ...
        private readonly TickerFullResponse _parentMessage;
        ...
        public TickerFullResponse()
        {
            _parentMessage = this;
        }

        public TickerFullResponse WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public TickerFullResponse WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public TickerFullResponse WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public TickerFullResponse WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public sealed partial class TickersGroup
        {
            ...
            private TickerFullResponse _parentMessage;
            private DirectBuffer _buffer;
            ...
            public void WrapForDecode(TickerFullResponse parentMessage, DirectBuffer buffer, int actingVersion)
            {
            ...
            public void WrapForEncode(TickerFullResponse parentMessage, DirectBuffer buffer, int count)
            {
            ...
            public const int SbeBlockLength = 126;
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append("[TickerFullResponse](sbeTemplateId=");
            builder.Append(TickerFullResponse.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(TickerFullResponse.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != TickerFullResponse.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(TickerFullResponse.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != TickerFullResponse.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(TickerFullResponse.BlockLength);
            builder.Append("):");
