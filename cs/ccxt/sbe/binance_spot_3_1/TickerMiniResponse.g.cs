...
{
    public sealed partial class TickerMiniResponse
    {
        public const ushort BlockLength = (ushort)0;
        public const ushort TemplateId = (ushort)216;
        ...
        private readonly TickerMiniResponse _parentMessage;
        ...
        public TickerMiniResponse()
        {
            _parentMessage = this;
        }

        public TickerMiniResponse WrapForEncode(DirectBuffer buffer, int offset)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public TickerMiniResponse WrapForEncodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerEncoder)
        {
        ...
        public TickerMiniResponse WrapForDecode(DirectBuffer buffer, int offset, int actingBlockLength, int actingVersion)
        {
            _buffer = buffer;
            _offset = offset;
        ...
        public TickerMiniResponse WrapForDecodeAndApplyHeader(DirectBuffer buffer, int offset, MessageHeader headerDecoder)
        {
        ...
        public sealed partial class TickersGroup
        {
            ...
            private TickerMiniResponse _parentMessage;
            private DirectBuffer _buffer;
            ...
            public void WrapForDecode(TickerMiniResponse parentMessage, DirectBuffer buffer, int actingVersion)
            {
            ...
            public void WrapForEncode(TickerMiniResponse parentMessage, DirectBuffer buffer, int count)
            {
        ...
        internal void BuildString(StringBuilder builder)
        {
            ...
            builder.Append(TickerMiniResponse.TemplateId);
            builder.Append("|sbeSchemaId=");
            builder.Append(TickerMiniResponse.SchemaId);
            builder.Append("|sbeSchemaVersion=");
            if (_parentMessage._actingVersion != TickerMiniResponse.SchemaVersion)
            {
                builder.Append(_parentMessage._actingVersion);
                builder.Append('/');
            }
            builder.Append(TickerMiniResponse.SchemaVersion);
            builder.Append("|sbeBlockLength=");
            if (_actingBlockLength != TickerMiniResponse.BlockLength)
            {
                builder.Append(_actingBlockLength);
                builder.Append('/');
            }
            builder.Append(TickerMiniResponse.BlockLength);
            builder.Append("):");
