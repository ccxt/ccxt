Every endpoint in `binanceusdm`'s `api` definition is exposed as an **implicit method** — a thin, generated wrapper around the raw exchange endpoint. Use these for exchange-specific functionality the [CCXT API](/docs/exchanges/binanceusdm) does not cover.
...
const response = await binanceusdm.sapiGetCopyTradingFuturesUserStatus (params);
```
...
response = binanceusdm.sapi_get_copytrading_futures_userstatus(params)
```

#### **PHP**

```php
$binanceusdm = new \ccxt\binanceusdm();
$response = $binanceusdm->sapi_get_copytrading_futures_userstatus($params);
```
...
```csharp
using ccxt;
var binanceusdm = new Binanceusdm();
var response = await binanceusdm.sapiGetCopyTradingFuturesUserStatus(parameters);
```

#### **Go**

```go
binanceusdm := ccxt.NewBinanceusdm(nil)
response := <-binanceusdm.SapiGetCopyTradingFuturesUserStatus(params)
```
...
📚 **Official binanceusdm API documentation:** [binance-docs.github.io](https://binance-docs.github.io/apidocs/futures/en/) · [binance-docs.github.io](https://binance-docs.github.io/apidocs/spot/en) · [developers.binance.com](https://developers.binance.com/en)

> 792 implicit endpoints across 20 access groups.

## sapi

**Base URL**: `https://api.binance.com/sapi/v1`
...
| `sapiGetSystemStatus` | GET | `system/status` | 0.1 |
...
| `sapiGetCapitalDepositHisrec` | GET | `capital/deposit/hisrec` | 0.1 |
...
| `sapiGetCapitalWithdrawHistory` | GET | `capital/withdraw/history` | 2 |
...
| `sapiGetSubAccountSpotSummary` | GET | `sub-account/spotSummary` | 0.1 |
...
| `sapiPostCapitalWithdrawApply` | POST | `capital/withdraw/apply` | 4.0002 |
...
**Base URL**: `https://api.binance.com/sapi/v2`
...
**Base URL**: `https://api.binance.com/sapi/v3`

| Method | HTTP | Endpoint | Cost |
| --- | --- | --- | --- |
| `sapiV3GetSubAccountAssets` | GET | `sub-account/assets` | 0.40002 |
...
| Method | HTTP | Endpoint | Cost |
| --- | --- | --- | --- |
| `publicGetPing` | GET | `ping` | 0.2 |
| `publicGetTime` | GET | `time` | 0.2 |
| `publicGetDepth` | GET | `depth` | 1 |
| `publicGetTrades` | GET | `trades` | 2 |
| `publicGetAggTrades` | GET | `aggTrades` | 0.4 |
| `publicGetHistoricalTrades` | GET | `historicalTrades` | 2 |
| `publicGetKlines` | GET | `klines` | 0.4 |
| `publicGetUiKlines` | GET | `uiKlines` | 0.4 |
| `publicGetTicker24hr` | GET | `ticker/24hr` | 0.4 |
| `publicGetTicker` | GET | `ticker` | 0.4 |
...
| Method | HTTP | Endpoint | Cost |
| --- | --- | --- | --- |
| `privateGetAllOrderList` | GET | `allOrderList` | 4 |
| `privateGetOpenOrderList` | GET | `openOrderList` | 1.2 |
| `privateGetOrderList` | GET | `orderList` | 0.8 |
| `privateGetOrder` | GET | `order` | 0.8 |
| `privateGetOpenOrders` | GET | `openOrders` | 1.2 |
| `privateGetAllOrders` | GET | `allOrders` | 4 |
| `privateGetAccount` | GET | `account` | 4 |
| `privateGetMyTrades` | GET | `myTrades` | 4 |
| `privateGetRateLimitOrder` | GET | `rateLimit/order` | 8 |
| `privateGetMyPreventedMatches` | GET | `myPreventedMatches` | 4 |
| `privateGetMyAllocations` | GET | `myAllocations` | 4 |
| `privateGetAccountCommission` | GET | `account/commission` | 4 |
| `privatePostOrderOco` | POST | `order/oco` | 0.2 |
...
| `privatePostOrder` | POST | `order` | 0.2 |
| `privatePostOrderCancelReplace` | POST | `order/cancelReplace` | 0.2 |
| `privatePostOrderTest` | POST | `order/test` | 0.2 |
| `privateDeleteOpenOrders` | DELETE | `openOrders` | 0.2 |
| `privateDeleteOrderList` | DELETE | `orderList` | 0.2 |
| `privateDeleteOrder` | DELETE | `order` | 0.2 |
