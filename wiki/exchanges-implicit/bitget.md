...
| `publicUtaGetV3MarketRiskReserveAll` | GET | `v3/market/risk-reserve-all` | 6.6667 |
| `publicUtaGetV3MarketRiskReserveHour` | GET | `v3/market/risk-reserve-hour` | 1 |
| `publicUtaGetV3MarketScoreWeights` | GET | `v3/market/score-weights` | 4 |
| `publicUtaGetV3MarketFeeGroup` | GET | `v3/market/fee-group` | 4 |
| `publicUtaGetV3MarketCashDividendRecords` | GET | `v3/market/cash-dividend-records` | 2 |
| `publicUtaGetV3MarketSplitRecords` | GET | `v3/market/split-records` | 4 |
| `publicUtaGetV3MarketLiquidations` | GET | `v3/market/liquidations` | 4 |
| `publicUtaGetV3MarketRpiOrderbook` | GET | `v3/market/rpi-orderbook` | 2 |
| `publicUtaGetV3MarketRpiSymbols` | GET | `v3/market/rpi-symbols` | 2 |
| `publicUtaGetV3MarketSpotWhaleFlow` | GET | `v3/market/spot-whale-flow` | 20 |
| `publicUtaGetV3MarketSpotFundFlow` | GET | `v3/market/spot-fund-flow` | 20 |
| `publicUtaGetV3MarketSpotNetFlow` | GET | `v3/market/spot-net-flow` | 20 |
| `publicUtaGetV3MarketMarginLongShort` | GET | `v3/market/margin-long-short` | 20 |
| `publicUtaGetV3MarketMarginLoanGrowth` | GET | `v3/market/margin-loan-growth` | 20 |
| `publicUtaGetV3MarketMarginIsolatedBorrow` | GET | `v3/market/margin-isolated-borrow` | 20 |
| `publicUtaGetV3MarketFuturesActiveBuySell` | GET | `v3/market/futures-active-buy-sell` | 20 |
| `publicUtaGetV3MarketFuturesLongShort` | GET | `v3/market/futures-long-short` | 20 |
| `publicUtaGetV3MarketFuturesPositionLongShort` | GET | `v3/market/futures-position-long-short` | 20 |
| `publicUtaGetV3MarketFuturesAccountLongShort` | GET | `v3/market/futures-account-long-short` | 20 |
| `publicUtaGetV3RealityMarketStockInfo` | GET | `v3/reality/market/stock-info` | 20 |
| `publicUtaGetV3RealityMarketStates` | GET | `v3/reality/market/states` | 20 |
| `publicUtaGetV3RealityMarketCalendar` | GET | `v3/reality/market/calendar` | 20 |
| `publicUtaGetV3RealityMarketCompanyOverview` | GET | `v3/reality/market/company-overview` | 20 |
| `publicUtaGetV3RealityMarketValuationIndicators` | GET | `v3/reality/market/valuation-indicators` | 20 |
| `publicUtaGetV3RealityMarketEarningsForecast` | GET | `v3/reality/market/earnings-forecast` | 20 |
| `publicUtaGetV3RealityMarketSuspensionResumptionInfo` | GET | `v3/reality/market/suspension-resumption-info` | 20 |
| `publicUtaGetV3RealityMarketDividends` | GET | `v3/reality/market/dividends` | 20 |
| `publicUtaGetV3RealityMarketShareCapitalChange` | GET | `v3/reality/market/share-capital-change` | 20 |
| `publicUtaGetV3RealityMarketInnerTrades` | GET | `v3/reality/market/inner-trades` | 20 |
| `publicUtaGetV3RealityMarketExecutiveShareholdings` | GET | `v3/reality/market/executive-shareholdings` | 20 |
| `publicUtaGetV3RealityMarketShareholdDetail` | GET | `v3/reality/market/sharehold-detail` | 20 |
| `publicUtaGetV3AccountCustomCollateralCoins` | GET | `v3/account/custom-collateral-coins` | 2 |
...
| `privateUserPostV2UserCreateAgentSubaccount` | POST | `v2/user/create-agent-subaccount` | 20 |
...
| `privateBrokerGetV2BrokerSubCustomerList` | GET | `v2/broker/sub-customer-list` | 2 |
| `privateBrokerGetV2BrokerAgentCommission` | GET | `v2/broker/agent-commission` | 2 |
| `privateBrokerGetV2BrokerCustomerCommissions` | GET | `v2/broker/customer-commissions` | 2 |
| `privateBrokerGetV2BrokerCustomerKycResult` | GET | `v2/broker/customer-kyc-result` | 2 |
| `privateBrokerGetV2BrokerOrderCommission` | GET | `v2/broker/order-commission` | 1 |
| `privateBrokerGetV2BrokerRebateInfo` | GET | `v2/broker/rebate-info` | 1 |
| `privateBrokerGetV2BrokerTotalCommission` | GET | `v2/broker/total-commission` | 1 |
...
| `privateBrokerPostV2BrokerCustomerAsset` | POST | `v2/broker/customer-asset` | 2 |
| `privateBrokerPostV2BrokerCustomerDeposit` | POST | `v2/broker/customer-deposit` | 2 |
| `privateBrokerPostV2BrokerCustomerList` | POST | `v2/broker/customer-list` | 2 |
| `privateBrokerPostV2BrokerCustomerTradeVolume` | POST | `v2/broker/customer-trade-volume` | 2 |
...
| `privateEarnGetV2EarnEliteProduct` | GET | `v2/earn/elite/product` | 4 |
| `privateEarnGetV2EarnEliteAssets` | GET | `v2/earn/elite/assets` | 4 |
| `privateEarnGetV2EarnEliteRecords` | GET | `v2/earn/elite/records` | 4 |
| `privateEarnGetV2EarnEliteSubscribeInfo` | GET | `v2/earn/elite/subscribe-info` | 4 |
| `privateEarnGetV2EarnEliteSubscribeResult` | GET | `v2/earn/elite/subscribe-result` | 4 |
| `privateEarnGetV2EarnEliteRedeemInfo` | GET | `v2/earn/elite/redeem-info` | 4 |
...
| `privateEarnPostV2EarnEliteSubscribe` | POST | `v2/earn/elite/subscribe` | 4 |
| `privateEarnPostV2EarnEliteRedeem` | POST | `v2/earn/elite/redeem` | 4 |
...
| `privateUtaGetV3AccountInfo` | GET | `v3/account/info` | 4 |
| `privateUtaGetV3AccountAllFeeRate` | GET | `v3/account/all-fee-rate` | 6.6667 |
| `privateUtaGetV3AccountDeltaInfo` | GET | `v3/account/delta-info` | 1 |
| `privateUtaGetV3AccountWithdrawAddress` | GET | `v3/account/withdraw-address` | 20 |
| `privateUtaGetV3AccountMaxWithdrawal` | GET | `v3/account/max-withdrawal` | 2 |
| `privateUtaGetV3AccountMovePositionHistory` | GET | `v3/account/move-position-history` | 4 |
| `privateUtaGetV3AccountCollateralType` | GET | `v3/account/collateral-type` | 2 |
| `privateUtaGetV3AccountPreSetLeverage` | GET | `v3/account/pre-set-leverage` | 2 |
| `privateUtaGetV3AccountEligibleSymbols` | GET | `v3/account/eligible-symbols` | 2 |
| `privateUtaGetV3AccountEligibleMarginTier` | GET | `v3/account/eligible-margin-tier` | 2 |
| `privateUtaGetV3AccountEligibleLoanInfo` | GET | `v3/account/eligible-loan-info` | 2 |
| `privateUtaGetV3AccountEligibleDiscountRate` | GET | `v3/account/eligible-discount-rate` | 1 |
| `privateUtaGetV3AccountFundingFinancialRecords` | GET | `v3/account/funding-financial-records` | 2 |
| `privateUtaGetV3AccountRealityOrderbook` | GET | `v3/account/reality-orderbook` | 2 |
| `privateUtaGetV3AccountRealityFills` | GET | `v3/account/reality-fills` | 2 |
| `privateUtaGetV3CopyFuturesTradingPairs` | GET | `v3/copy/futures/trading-pairs` | 4 |
| `privateUtaGetV3CopyFuturesPositionSummary` | GET | `v3/copy/futures/position-summary` | 4 |
| `privateUtaGetV3CopyFuturesMaxTransferable` | GET | `v3/copy/futures/max-transferable` | 20 |
| `privateUtaGetV3CopyFuturesTransferRecord` | GET | `v3/copy/futures/transfer-record` | 20 |
| `privateUtaGetV3CopyFuturesCurrentFollower` | GET | `v3/copy/futures/current-follower` | 20 |
| `privateUtaGetV3CopyFuturesHistoryFollower` | GET | `v3/copy/futures/history-follower` | 20 |
| `privateUtaGetV3CopyFuturesProfitSummary` | GET | `v3/copy/futures/profit-summary` | 20 |
| `privateUtaGetV3CopyFuturesProfitDetails` | GET | `v3/copy/futures/profit-details` | 20 |
| `privateUtaGetV3ConvertSmallAssets` | GET | `v3/convert/small-assets` | 2 |
| `privateUtaGetV3ConvertSmallAssetsHistory` | GET | `v3/convert/small-assets-history` | 2 |
| `privateUtaGetV3EarnEliteProduct` | GET | `v3/earn/elite-product` | 4 |
| `privateUtaGetV3EarnEliteAssets` | GET | `v3/earn/elite-assets` | 4 |
| `privateUtaGetV3EarnEliteSubscribeInfo` | GET | `v3/earn/elite-subscribe-info` | 4 |
| `privateUtaGetV3EarnEliteRecords` | GET | `v3/earn/elite-records` | 4 |
| `privateUtaGetV3EarnEliteSubscribeResult` | GET | `v3/earn/elite-subscribe-result` | 4 |
| `privateUtaGetV3EarnEliteRedeemInfo` | GET | `v3/earn/elite-redeem-info` | 4 |
| `privateUtaGetV3TradeLoanData` | GET | `v3/trade/loan-data` | 2 |
| `privateUtaGetV3TradeStrategySubOrders` | GET | `v3/trade/strategy-sub-orders` | 2 |
| `privateUtaGetV3TradeGridBotDetail` | GET | `v3/trade/grid/bot-detail` | 2 |
| `privateUtaGetV3TradeGridListDetails` | GET | `v3/trade/grid/list-details` | 20 |
| `privateUtaGetV3TradeGridNeutralBotDetail` | GET | `v3/trade/grid/neutral-bot-detail` | 2 |
| `privateUtaGetV3TradeGridNeutralListDetails` | GET | `v3/trade/grid/neutral-list-details` | 20 |
| `privateUtaGetV3UserRateLimitQuota` | GET | `v3/user/rate-limit-quota` | 2 |
| `privateUtaGetV3StockplusMarketOptionQuote` | GET | `v3/stockplus/market/option-quote` | 2 |
| `privateUtaGetV3StockplusMarketOptionChainInfo` | GET | `v3/stockplus/market/option-chain-info` | 2 |
| `privateUtaGetV3StockplusMarketOptionExpiryDate` | GET | `v3/stockplus/market/option-expiry-date` | 2 |
| `privateUtaGetV3StockplusMarketOptionVolume` | GET | `v3/stockplus/market/option-volume` | 2 |
| `privateUtaGetV3StockplusMarketDepth` | GET | `v3/stockplus/market/depth` | 2 |
| `privateUtaGetV3StockplusMarketStatic` | GET | `v3/stockplus/market/static` | 2 |
| `privateUtaGetV3StockplusMarketQuote` | GET | `v3/stockplus/market/quote` | 2 |
| `privateUtaGetV3StockplusMarketTrade` | GET | `v3/stockplus/market/trade` | 2 |
| `privateUtaGetV3StockplusMarketIntraday` | GET | `v3/stockplus/market/intraday` | 2 |
| `privateUtaGetV3StockplusMarketHistoryCandlestick` | GET | `v3/stockplus/market/history-candlestick` | 2 |
| `privateUtaGetV3StockplusMarketCandlestick` | GET | `v3/stockplus/market/candlestick` | 2 |
| `privateUtaGetV3StockplusTradeTodayOrders` | GET | `v3/stockplus/trade/today-orders` | 20 |
| `privateUtaGetV3StockplusTradeHistoryOrders` | GET | `v3/stockplus/trade/history-orders` | 20 |
| `privateUtaGetV3StockplusTradeOrderDetail` | GET | `v3/stockplus/trade/order-detail` | 20 |
| `privateUtaGetV3StockplusTradeTodayExecutions` | GET | `v3/stockplus/trade/today-executions` | 20 |
| `privateUtaGetV3StockplusTradeHistoryExecutions` | GET | `v3/stockplus/trade/history-executions` | 20 |
| `privateUtaGetV3StockplusAssetAccount` | GET | `v3/stockplus/asset/account` | 2 |
| `privateUtaGetV3StockplusAssetCashFlow` | GET | `v3/stockplus/asset/cash-flow` | 2 |
| `privateUtaGetV3StockplusAssetStockPosition` | GET | `v3/stockplus/asset/stock-position` | 2 |
| `privateUtaGetV3StockplusAssetTransferRecords` | GET | `v3/stockplus/asset/transfer-records` | 2 |
| `privateUtaGetV3P2pAdList` | GET | `v3/p2p/ad-list` | 2 |
| `privateUtaGetV3P2pAdInfo` | GET | `v3/p2p/ad-info` | 2 |
| `privateUtaGetV3P2pAdLimit` | GET | `v3/p2p/ad-limit` | 2 |
| `privateUtaGetV3P2pMyAds` | GET | `v3/p2p/my-ads` | 2 |
| `privateUtaGetV3P2pPendingOrders` | GET | `v3/p2p/pending-orders` | 2 |
| `privateUtaGetV3P2pAllOrders` | GET | `v3/p2p/all-orders` | 2 |
| `privateUtaGetV3P2pOrderInfo` | GET | `v3/p2p/order-info` | 2 |
| `privateUtaGetV3P2pUserInfo` | GET | `v3/p2p/user-info` | 2 |
| `privateUtaGetV3P2pCurrencies` | GET | `v3/p2p/currencies` | 2 |
| `privateUtaGetV3P2pPayMethod` | GET | `v3/p2p/pay-method` | 2 |
| `privateUtaGetV3P2pBalance` | GET | `v3/p2p/balance` | 2 |
| `privateUtaGetV3P2pExchangeRate` | GET | `v3/p2p/exchange-rate` | 2 |
...
| `privateUtaPostV3AccountMovePositions` | POST | `v3/account/move-positions` | 20 |
| `privateUtaPostV3AccountCancelWithdrawal` | POST | `v3/account/cancel-withdrawal` | 20 |
| `privateUtaPostV3AccountSetMargin` | POST | `v3/account/set-margin` | 2 |
| `privateUtaPostV3AccountSetCollateralType` | POST | `v3/account/set-collateral-type` | 10 |
| `privateUtaPostV3CopyFuturesTransfer` | POST | `v3/copy/futures/transfer` | 20 |
| `privateUtaPostV3ConvertSmallAssetsTrade` | POST | `v3/convert/small-assets-trade` | 2 |
| `privateUtaPostV3EarnEliteSubscribe` | POST | `v3/earn/elite-subscribe` | 4 |
| `privateUtaPostV3EarnEliteRedeem` | POST | `v3/earn/elite-redeem` | 4 |
| `privateUtaPostV3TradePlaceRealityOrder` | POST | `v3/trade/place-reality-order` | 2 |
| `privateUtaPostV3TradeCancelRealityOrder` | POST | `v3/trade/cancel-reality-order` | 2 |
| `privateUtaPostV3TradeGridValidate` | POST | `v3/trade/grid/validate` | 20 |
| `privateUtaPostV3TradeGridCreateBot` | POST | `v3/trade/grid/create-bot` | 20 |
| `privateUtaPostV3TradeGridModifyBot` | POST | `v3/trade/grid/modify-bot` | 20 |
| `privateUtaPostV3TradeGridModifyGridInterval` | POST | `v3/trade/grid/modify-grid-interval` | 20 |
| `privateUtaPostV3TradeGridAddInvestment` | POST | `v3/trade/grid/add-investment` | 20 |
| `privateUtaPostV3TradeGridCloseBot` | POST | `v3/trade/grid/close-bot` | 20 |
| `privateUtaPostV3TradeGridValidateNeutral` | POST | `v3/trade/grid/validate-neutral` | 20 |
| `privateUtaPostV3TradeGridCreateNeutralBot` | POST | `v3/trade/grid/create-neutral-bot` | 20 |
| `privateUtaPostV3TradeGridModifyNeutralBot` | POST | `v3/trade/grid/modify-neutral-bot` | 20 |
| `privateUtaPostV3TradeGridModifyNeutralGridInterval` | POST | `v3/trade/grid/modify-neutral-grid-interval` | 20 |
| `privateUtaPostV3UserSetRateLimitQuota` | POST | `v3/user/set-rate-limit-quota` | 4 |
| `privateUtaPostV3UserSubAccountAgentCreate` | POST | `v3/user/sub-account/agent-create` | 20 |
| `privateUtaPostV3StockplusTradePlaceOrder` | POST | `v3/stockplus/trade/place-order` | 20 |
| `privateUtaPostV3StockplusTradeCancelOrder` | POST | `v3/stockplus/trade/cancel-order` | 20 |
| `privateUtaPostV3StockplusTradeModifyOrder` | POST | `v3/stockplus/trade/modify-order` | 20 |
| `privateUtaPostV3StockplusAssetTransfer` | POST | `v3/stockplus/asset/transfer` | 4 |
| `privateUtaPostV3P2pAdCreate` | POST | `v3/p2p/ad-create` | 2 |
| `privateUtaPostV3P2pAdUpdate` | POST | `v3/p2p/ad-update` | 2 |
| `privateUtaPostV3P2pAdOperate` | POST | `v3/p2p/ad-operate` | 2 |
| `privateUtaPostV3P2pFeeSimulate` | POST | `v3/p2p/fee-simulate` | 2 |
| `privateUtaPostV3P2pOrderPay` | POST | `v3/p2p/order-pay` | 2 |
| `privateUtaPostV3P2pOrderRelease` | POST | `v3/p2p/order-release` | 2 |
