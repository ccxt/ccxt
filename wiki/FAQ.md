# Frequently Asked Questions
  ...
  Yes, we can (unless anybody else does it at first). But it all boils down to time and management needed for implementing all accumulated feature requests, we have tasks queue depending priorities.

  Moreover, this is an open-source library, intended to be developed by the community & users. Your contributions, PRs and commits are welcome: https://github.com/ccxt/ccxt/blob/master/CONTRIBUTING.md#how-to-contribute-code.

  We don't give promises or estimates on the free open-source work. The answer will always remain the same: _as soon as we can_. If you wish to speed it up, feel free to reach out to us via info@ccxt.trade.
  ...
  Again, answered in the above paragraph.
