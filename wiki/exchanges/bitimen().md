...
<a name="bitimen" id="bitimen"></a>

## bitimen{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>bitimen</code>](#bitimen)  
...
```javascript
bitimen.fetchTickers (symbols[, params])
```
...
```javascript
bitimen.fetchTicker (symbol[, params])
```
...
```javascript
bitimen.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
bitimen.fetchOrderBooks (symbols[, limit, params])
```
