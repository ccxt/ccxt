...
<a name="bittrex" id="bittrex"></a>

## bittrex{docsify-ignore}
**Kind**: global class  
...
* [fetchPendingDeposits](#fetchpendingdeposits)
...
**Kind**: instance method of [<code>bittrex</code>](#bittrex)  
...
### fetchPendingDeposits{docsify-ignore}
...
### fetchPendingWithdrawals{docsify-ignore}
...
```javascript
bittrex.watchOrders (symbol[, since, limit, params])
```
...
```javascript
bittrex.watchTicker (symbol[, params])
```
...
```javascript
bittrex.watchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
bittrex.watchTrades (symbol[, since, limit, params])
```
...
```javascript
bittrex.watchMyTrades (symbol[, since, limit, params])
```
...
```javascript
bittrex.watchOrderBook (symbol[, limit, params])
```
