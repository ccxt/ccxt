...
<a name="bitir" id="bitir"></a>

## bitir{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>bitir</code>](#bitir)  
...
```javascript
bitir.fetchTickers (symbols[, params])
```
...
```javascript
bitir.fetchTicker (symbol[, params])
```
...
```javascript
bitir.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
bitir.fetchOrderBooks (symbols[, limit, params])
```
