...
<a name="hitobit" id="hitobit"></a>

## hitobit{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>hitobit</code>](#hitobit)  
...
```javascript
hitobit.fetchTickers (symbols[, params])
```
...
```javascript
hitobit.fetchTicker (symbol[, params])
```
...
```javascript
hitobit.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
hitobit.fetchOrderBooks (symbols[, limit, params])
```
