...
```javascript
cexc.loadMigrationStatus (force, [undefined])
```
...
```javascript
cexc.fetchCurrencies (params, [undefined])
```
...
```javascript
cexc.fetchTransactionFee (code, params[])
```
...
```javascript
cexc.fetchDepositWithdrawFee (code[, params])
```
...
```javascript
cexc.fetchTickers (symbols[, params])
```
...
```javascript
cexc.fetchMarkPrices ([symbols, params])
```
...
```javascript
cexc.fetchTicker (symbol[, params])
```
...
```javascript
cexc.fetchMarkPrice (symbol[, params])
```
...
```javascript
cexc.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
cexc.createDepositAddress (code[, params])
```
...
```javascript
cexc.fetchDepositAddress (code[, params])
```
...
```javascript
cexc.fetchDepositAddressesByNetwork (code[, params])
```
...
```javascript
cexc.fetchOrderBook (symbol[, limit, params])
```
...
```javascript
cexc.createOrder (symbol, type, side, amount[, price, params])
```
...
```javascript
cexc.createMarketOrderWithCost (symbol, side, cost[, params])
```
...
```javascript
cexc.createMarketBuyOrderWithCost (symbol, cost[, params])
```
...
```javascript
cexc.createMarketSellOrderWithCost (symbol, cost[, params])
```
...
```javascript
cexc.createOrders (orders[, params])
```
...
```javascript
cexc.editOrder (id, symbol, type, side, amount[, price, params])
```
...
```javascript
cexc.cancelOrder (id, symbol[, params])
```
...
```javascript
cexc.cancelAllOrders (symbol[, params])
```
...
```javascript
cexc.fetchOrdersByStatus (status, symbol[, since, limit, params])
```
...
```javascript
cexc.fetchClosedOrders (symbol[, since, limit, params])
```
...
```javascript
cexc.fetchOpenOrders (symbol[, since, limit, params])
```
...
```javascript
cexc.fetchOrder (id, symbol[, params])
```
...
```javascript
cexc.fetchOrderTrades (id, symbol[, since, limit, params])
```
...
```javascript
cexc.fetchMyTrades (symbol[, since, limit, params])
```
...
```javascript
cexc.fetchTrades (symbol[, since, limit, params])
```
...
```javascript
cexc.fetchTradingFee (symbol[, params])
```
...
```javascript
cexc.withdraw (code, amount, address, tag[, params])
```
...
```javascript
cexc.fetchDeposits (code[, since, limit, params])
```
...
```javascript
cexc.fetchWithdrawals (code[, since, limit, params])
```
...
```javascript
cexc.transfer (code, amount, fromAccount, toAccount[, params])
```
...
```javascript
cexc.fetchLedger ([code, since, limit, params])
```
...
```javascript
cexc.fetchBorrowInterest ([code, symbol, since, limit, params])
```
...
```javascript
cexc.fetchBorrowRateHistories (codes[, since, limit, params])
```
...
```javascript
cexc.fetchBorrowRateHistory (code[, since, limit, params])
```
...
```javascript
cexc.borrowCrossMargin (code, amount[, params])
```
...
```javascript
cexc.borrowIsolatedMargin (symbol, code, amount[, params])
```
...
```javascript
cexc.repayCrossMargin (code, amount[, params])
```
...
```javascript
cexc.repayIsolatedMargin (symbol, code, amount[, params])
```
...
```javascript
cexc.fetchDepositWithdrawFees (codes[, params])
```
...
```javascript
cexc.setLeverage ([leverage, symbol, params])
```
...
```javascript
cexc.fetchFundingRate (symbol[, params])
```
...
```javascript
cexc.fetchFundingRateHistory (symbol[, since, limit, params])
```
...
```javascript
cexc.fetchTransfers ([code, since, limit, params])
```
...
```javascript
cexc.watchTicker (symbol[, params])
```
...
```javascript
cexc.unWatchTicker (symbol[, params])
```
...
```javascript
cexc.watchTickers (symbols[, params])
```
...
```javascript
cexc.watchBidsAsks (symbols[, params])
```
...
```javascript
cexc.watchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
cexc.unWatchOHLCV (symbol, timeframe[, params])
```
...
```javascript
cexc.watchTrades (symbol[, since, limit, params])
```
...
```javascript
cexc.watchTradesForSymbols (symbols[, since, limit, params])
```
...
```javascript
cexc.unWatchTradesForSymbols (symbols[, params])
```
...
```javascript
cexc.unWatchTrades (symbol[, params])
```
...
```javascript
cexc.watchOrderBook (symbol[, limit, params])
```
...
```javascript
cexc.unWatchOrderBook (symbol[, params])
```
...
```javascript
cexc.watchOrderBookForSymbols (symbols[, limit, params])
```
...
```javascript
cexc.unWatchOrderBookForSymbols (symbols[, params])
```
...
```javascript
cexc.watchOrders (symbol[, since, limit, params])
```
...
```javascript
cexc.watchMyTrades (symbol[, since, limit, params])
```
