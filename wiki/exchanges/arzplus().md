...
<a name="arzplus" id="arzplus"></a>

## arzplus{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>arzplus</code>](#arzplus)  
...
```javascript
arzplus.fetchTickers (symbols[, params])
```
...
```javascript
arzplus.fetchTicker (symbol[, params])
```
...
```javascript
arzplus.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
arzplus.fetchOrderBooks (symbols[, limit, params])
```
