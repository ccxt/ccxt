...
<a name="bitpin" id="bitpin"></a>

## bitpin{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>bitpin</code>](#bitpin)  
...
```javascript
bitpin.fetchTickers (symbols[, params])
```
...
```javascript
bitpin.fetchTicker (symbol[, params])
```
...
```javascript
bitpin.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
bitpin.fetchOrderBooks (symbols[, limit, params])
```
