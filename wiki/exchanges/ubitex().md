...
<a name="ubitex" id="ubitex"></a>

## ubitex{docsify-ignore}
**Kind**: global class  
...
**Kind**: instance method of [<code>ubitex</code>](#ubitex)  
...
```javascript
ubitex.fetchTickers (symbols[, params])
```
...
```javascript
ubitex.fetchTicker (symbol[, params])
```
...
```javascript
ubitex.fetchOHLCV (symbol, timeframe[, since, limit, params])
```
...
```javascript
ubitex.fetchOrderBooks (symbols[, limit, params])
```
