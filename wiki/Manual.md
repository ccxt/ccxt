...
- `baseId`. An exchange-specific id of the base currency for this market. Can be any string, literally. This is communicated to an exchange using the language the exchange understands.
