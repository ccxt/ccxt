...
|----------|------------|-------------------------------|
| params   | No         | Params to override in request |

### Response
| Property      | Always | Description                                                                                   |
|---------------|--------|-----------------------------------------------------------------------------------------------|
| info          | Yes    | Response from exchange                                                                        |
| timestamp     | No     | Time of request in ms                                                                         |
| datetime      | No     | timestamp in ISO8601                                                                          |
| free          | No     | balance free to use for each currenc. ``` { CURRENCY_CODE_1: 0, CURRENCY_CODE_2: 0, ... } ``` |
| used          | No     | balance used in each currency  ``` { CURRENCY_CODE_1: 0, CURRENCY_CODE_2: 0, ... } ```        |
