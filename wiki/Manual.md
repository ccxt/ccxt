...
- `DRK → DASH`: `DASH` was Darkcoin then became Dash ([read more](https://minergate.com/blog/dashcoin-and-dash/)). On November 15 2018 Bitcoin Cash forked the second time, so, now there is `BCHABC` and `BCHSV`...
