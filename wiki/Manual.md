...
You may set the value of `exchange.withdraw ('USDT', 100, 'TVJ1fwyJ1a8JbtUxZ8Km95sDFN9jhLxJ2D', { 'network': 'TRX' })` in order to withdraw USDT on the tron chain, or 'BSC' to withdraw USDT on binance smart chain. In the table above BSC and BEP20 are equivalent aliases so it doesnt matter which one you use as they both will achieve the same effect.
