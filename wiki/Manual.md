...
* To ensure exchange supports this functionality, check `exchange.features` or use helper method `exchange.featureValue('swap', 'linear', 'createOrder', 'triggerPrice')` (should return `true`).
...
* To ensure exchange supports this functionality, check `exchange.features` or use helper method `exchange.featureValue('swap', 'linear', 'createOrder', 'stopLossPrice')` (should return `true`).
