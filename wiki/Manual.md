...
2) Your current IP address (check [IPv4](https://api.ipify.org/) or [IPv6](https://api64.ipify.org/)) is added into API-KEY's whitelisted IP addresses. If you are setting proxy options in your ccxt snippet, consider that too.
