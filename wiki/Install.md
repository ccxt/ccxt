...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@3.0.79/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@3.0.79/dist/ccxt.browser.js
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@3.0.79/dist/ccxt.browser.js"></script>
```
