...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@2.7.58/dist/ccxt.browser.js
* unpkg: https://unpkg.com/ccxt@2.7.58/dist/ccxt.browser.js
...
```HTML
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@2.7.58/dist/ccxt.browser.js"></script>
```
