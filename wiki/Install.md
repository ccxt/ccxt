...
* jsDelivr: https://cdn.jsdelivr.net/npm/ccxt@4.5.58/dist/ccxt.browser.min.js
* unpkg: https://unpkg.com/ccxt@4.5.58/dist/ccxt.browser.min.js
...
```html
<script type="text/javascript" src="https://cdn.jsdelivr.net/npm/ccxt@4.5.58/dist/ccxt.browser.min.js"></script>
```
