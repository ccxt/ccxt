...
If your application is not very critical to the above, you can still subscribe to OHLCV streams, if the underlying exchange supports them, as shown below:
